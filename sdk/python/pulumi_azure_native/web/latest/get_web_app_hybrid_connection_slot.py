...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppHybridConnectionSlot'.""", DeprecationWarning)
...
def get_web_app_hybrid_connection_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_hybrid_connection_slot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppHybridConnectionSlot'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebAppHybridConnectionSlot', __args__, opts=opts, typ=GetWebAppHybridConnectionSlotResult).value
