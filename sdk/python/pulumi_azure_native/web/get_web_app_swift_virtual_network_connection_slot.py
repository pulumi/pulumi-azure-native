...
def get_web_app_swift_virtual_network_connection_slot(name: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will get a gateway for the production slot's Virtual Network.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_web_app_swift_virtual_network_connection_slot_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getWebAppSwiftVirtualNetworkConnectionSlot', __args__, opts=opts, typ=GetWebAppSwiftVirtualNetworkConnectionSlotResult)
