...
def get_web_app_slot(name: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of the deployment slot. By default, this API returns the production slot.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_web_app_slot_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getWebAppSlot', __args__, opts=opts, typ=GetWebAppSlotResult)
