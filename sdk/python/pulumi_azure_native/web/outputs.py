...
@pulumi.output_type
class AiGatewayPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "aiGatewayId":
            suggest = "ai_gateway_id"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AiGatewayPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AiGatewayPropertiesResponse.__key_warning(key)
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str ai_gateway_id: The description of the resource.
        """
