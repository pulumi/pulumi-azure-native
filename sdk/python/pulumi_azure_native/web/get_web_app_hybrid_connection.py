...
class GetWebAppHybridConnectionResult:
    ...
    def relay_arm_uri(self) -> Optional[builtins.str]:
        """
    ...
    def relay_name(self) -> Optional[builtins.str]:
        """
    ...
    def send_key_name(self) -> Optional[builtins.str]:
        """
    ...
    def send_key_value(self) -> Optional[builtins.str]:
        """
    ...
    def service_bus_suffix(self) -> Optional[builtins.str]:
        """
...
def get_web_app_hybrid_connection(name: Optional[builtins.str] = None,
...
def get_web_app_hybrid_connection_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getWebAppHybridConnection', __args__, opts=opts, typ=GetWebAppHybridConnectionResult)
