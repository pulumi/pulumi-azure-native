...
class GetWebAppSwiftVirtualNetworkConnectionResult:
    ...
    def swift_supported(self) -> Optional[builtins.bool]:
        """
...
def get_web_app_swift_virtual_network_connection(name: Optional[builtins.str] = None,
...
def get_web_app_swift_virtual_network_connection_output(name: Optional[pulumi.Input[builtins.str]] = None,
