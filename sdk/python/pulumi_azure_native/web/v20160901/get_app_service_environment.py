...
warnings.warn("""azure-native:web/v20160901:AppServiceEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20190801:AppServiceEnvironment to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_app_service_environment(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app_service_environment is deprecated: azure-native:web/v20160901:AppServiceEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20190801:AppServiceEnvironment to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
