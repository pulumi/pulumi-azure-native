...
def get_app_service_environment(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20160901:getAppServiceEnvironment', __args__, opts=opts, typ=GetAppServiceEnvironmentResult).value

    return AwaitableGetAppServiceEnvironmentResult(
        allowed_multi_sizes=pulumi.get(__ret__, 'allowed_multi_sizes'),
        allowed_worker_sizes=pulumi.get(__ret__, 'allowed_worker_sizes'),
        api_management_account_id=pulumi.get(__ret__, 'api_management_account_id'),
        cluster_settings=pulumi.get(__ret__, 'cluster_settings'),
        database_edition=pulumi.get(__ret__, 'database_edition'),
        database_service_objective=pulumi.get(__ret__, 'database_service_objective'),
        default_front_end_scale_factor=pulumi.get(__ret__, 'default_front_end_scale_factor'),
        dns_suffix=pulumi.get(__ret__, 'dns_suffix'),
        dynamic_cache_enabled=pulumi.get(__ret__, 'dynamic_cache_enabled'),
        environment_capacities=pulumi.get(__ret__, 'environment_capacities'),
        environment_is_healthy=pulumi.get(__ret__, 'environment_is_healthy'),
        environment_status=pulumi.get(__ret__, 'environment_status'),
        ...
        last_action_result=pulumi.get(__ret__, 'last_action_result'),
        ...
        network_access_control_list=pulumi.get(__ret__, 'network_access_control_list'),
        ...
        upgrade_domains=pulumi.get(__ret__, 'upgrade_domains'),
        user_whitelisted_ip_ranges=pulumi.get(__ret__, 'user_whitelisted_ip_ranges'),
        vip_mappings=pulumi.get(__ret__, 'vip_mappings'),
...
def get_app_service_environment_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20160901:getAppServiceEnvironment', __args__, opts=opts, typ=GetAppServiceEnvironmentResult)
