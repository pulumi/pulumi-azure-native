...
class WebAppSourceControlSlotArgs:
    ...
    def _configure(
        ...
        if git_hub_action_configuration is None and 'gitHubActionConfiguration' in kwargs:
...
class WebAppSourceControlSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            git_hub_action_configuration = _utilities.configure(git_hub_action_configuration, GitHubActionConfigurationArgs, True)
