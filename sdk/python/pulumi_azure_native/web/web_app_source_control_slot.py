...
class WebAppSourceControlSlotArgs:
    def __init__(__self__, *,
                 ...
                 deployment_rollback_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 git_hub_action_configuration: Optional[pulumi.Input['GitHubActionConfigurationArgs']] = None,
                 is_git_hub_action: Optional[pulumi.Input[builtins.bool]] = None,
                 is_manual_integration: Optional[pulumi.Input[builtins.bool]] = None,
                 is_mercurial: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] slot: Name of the deployment slot. If a slot is not specified, the API will update the source control configuration for the production slot.
        :param pulumi.Input[builtins.str] branch: Name of branch to use for deployment.
        :param pulumi.Input[builtins.bool] deployment_rollback_enabled: <code>true</code> to enable deployment rollback; otherwise, <code>false</code>.
        ...
        :param pulumi.Input[builtins.bool] is_git_hub_action: <code>true</code> if this is deployed via GitHub action.
        :param pulumi.Input[builtins.bool] is_manual_integration: <code>true</code> to limit to manual integration; <code>false</code> to enable continuous integration (which configures webhooks into online repos like GitHub).
        :param pulumi.Input[builtins.bool] is_mercurial: <code>true</code> for a Mercurial repository; <code>false</code> for a Git repository.
        :param pulumi.Input[builtins.str] kind: Kind of resource.
        :param pulumi.Input[builtins.str] repo_url: Repository or source control URL.
        """
    ...
    def deployment_rollback_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def deployment_rollback_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_git_hub_action(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_git_hub_action(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_git_hub_action", value)

    @property
    @pulumi.getter(name="isManualIntegration")
    def is_manual_integration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_manual_integration(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_manual_integration", value)

    @property
    @pulumi.getter(name="isMercurial")
    def is_mercurial(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_mercurial.setter
    def is_mercurial(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WebAppSourceControlSlot(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deploymentRollbackEnabled")
    def deployment_rollback_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        <code>true</code> to enable deployment rollback; otherwise, <code>false</code>.
        """
        return pulumi.get(self, "deployment_rollback_enabled")
    ...
    @property
    @pulumi.getter(name="isGitHubAction")
    def is_git_hub_action(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        <code>true</code> if this is deployed via GitHub action.
        """
        return pulumi.get(self, "is_git_hub_action")
    ...
    @property
    @pulumi.getter(name="isManualIntegration")
    def is_manual_integration(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        <code>true</code> to limit to manual integration; <code>false</code> to enable continuous integration (which configures webhooks into online repos like GitHub).
        """
        return pulumi.get(self, "is_manual_integration")
    ...
    @property
    @pulumi.getter(name="isMercurial")
    def is_mercurial(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        <code>true</code> for a Mercurial repository; <code>false</code> for a Git repository.
        """
        return pulumi.get(self, "is_mercurial")
    ...
    @property
    @pulumi.getter(name="repoUrl")
    def repo_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Repository or source control URL.
        """
        return pulumi.get(self, "repo_url")
