...
def list_web_app_metadata(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220901:listWebAppMetadata', __args__, opts=opts, typ=ListWebAppMetadataResult).value
...
def list_web_app_metadata_output(name: Optional[pulumi.Input[str]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListWebAppMetadataResult]:
    """
    Description for Gets the metadata of an app.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20220901:listWebAppMetadata', __args__, opts=opts, typ=ListWebAppMetadataResult)
    return __ret__.apply(lambda __response__: ListWebAppMetadataResult(
