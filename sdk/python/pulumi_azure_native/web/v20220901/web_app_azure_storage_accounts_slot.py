...
class WebAppAzureStorageAccountsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppAzureStorageAccountsSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppAzureStorageAccountsSlot, __self__).__init__(
            'azure-native:web/v20220901:WebAppAzureStorageAccountsSlot',
            resource_name,
            __props__,
            opts)
