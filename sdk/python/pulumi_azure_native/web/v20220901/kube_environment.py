...
class KubeEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20210101:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20210115:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20210201:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20210301:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20220301:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20230101:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20231201:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20240401:KubeEnvironment"), pulumi.Alias(type_="azure-native:web:KubeEnvironment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KubeEnvironment, __self__).__init__(
            'azure-native:web/v20220901:KubeEnvironment',
            resource_name,
            __props__,
            opts)
