...
class WebAppPrivateEndpointConnectionSlotArgs:
    def __init__(__self__, *,
        ...
        """
        WebAppPrivateEndpointConnectionSlotArgs._configure(
...
class WebAppPrivateEndpointConnectionSlot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WebAppPrivateEndpointConnectionSlotArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if private_link_service_connection_state is not None and not isinstance(private_link_service_connection_state, PrivateLinkConnectionStateArgs):
                ...
                PrivateLinkConnectionStateArgs._configure(_setter, **private_link_service_connection_state)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppPrivateEndpointConnectionSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppPrivateEndpointConnectionSlot, __self__).__init__(
            'azure-native:web/v20220901:WebAppPrivateEndpointConnectionSlot',
            resource_name,
            __props__,
            opts)
