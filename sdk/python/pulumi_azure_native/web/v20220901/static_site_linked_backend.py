...
class StaticSiteLinkedBackend(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        static_site_linked_backend = azure_native.web.v20220901.StaticSiteLinkedBackend("staticSiteLinkedBackend",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:StaticSiteLinkedBackend"), pulumi.Alias(type_="azure-native:web/v20220301:StaticSiteLinkedBackend")])
