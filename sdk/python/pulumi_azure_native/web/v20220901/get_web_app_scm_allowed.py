...
def get_web_app_scm_allowed(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220901:getWebAppScmAllowed', __args__, opts=opts, typ=GetWebAppScmAllowedResult).value
...
def get_web_app_scm_allowed_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20220901:getWebAppScmAllowed', __args__, opts=opts, typ=GetWebAppScmAllowedResult)
