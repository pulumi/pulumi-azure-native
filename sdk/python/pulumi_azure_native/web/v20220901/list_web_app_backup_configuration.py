...
def list_web_app_backup_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220901:listWebAppBackupConfiguration', __args__, opts=opts, typ=ListWebAppBackupConfigurationResult).value
...
def list_web_app_backup_configuration_output(name: Optional[pulumi.Input[str]] = None,
                                             ...
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListWebAppBackupConfigurationResult]:
    """
    Description for Gets the backup configuration of an app.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20220901:listWebAppBackupConfiguration', __args__, opts=opts, typ=ListWebAppBackupConfigurationResult)
    return __ret__.apply(lambda __response__: ListWebAppBackupConfigurationResult(
