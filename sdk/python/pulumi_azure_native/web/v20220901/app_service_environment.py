...
class AppServiceEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(custom_dns_suffix_configuration, CustomDnsSuffixConfigurationArgs):
            ...
            if not isinstance(networking_configuration, AseV3NetworkingConfigurationArgs):
