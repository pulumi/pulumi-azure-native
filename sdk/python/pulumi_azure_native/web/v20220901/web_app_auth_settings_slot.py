...
class WebAppAuthSettingsSlot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import azure-native:web/v20220901:WebAppAuthSettingsSlot myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/authsettings 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(WebAppAuthSettingsSlot, __self__).__init__(
            'azure-native:web/v20220901:WebAppAuthSettingsSlot',
            resource_name,
            __props__,
            opts)
