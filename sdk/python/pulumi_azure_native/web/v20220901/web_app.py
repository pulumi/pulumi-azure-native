...
class WebApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cloning_info, CloningInfoArgs):
            ...
            if not isinstance(hosting_environment_profile, HostingEnvironmentProfileArgs):
            ...
            if not isinstance(site_config, SiteConfigArgs):
