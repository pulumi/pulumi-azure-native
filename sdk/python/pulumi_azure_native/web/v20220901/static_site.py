...
class StaticSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(build_properties, StaticSiteBuildPropertiesArgs):
            ...
            if not isinstance(sku, SkuDescriptionArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
            ...
            if not isinstance(template_properties, StaticSiteTemplateOptionsArgs):
