...
class StaticSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        static_site = azure_native.web.v20220901.StaticSite("staticSite",
            branch="master",
            build_properties=azure_native.web.v20220901.StaticSiteBuildPropertiesArgs(
                api_location="api",
            ...
            sku=azure_native.web.v20220901.SkuDescriptionArgs(
                name="Basic",
                tier="Basic",
            ))
