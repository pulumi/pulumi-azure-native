...
class WebAppPremierAddOnArgs:
    def __init__(__self__, *,
        ...
        """
        WebAppPremierAddOnArgs._configure(
    ...
    def _configure(
        ...
        if marketplace_offer is None and 'marketplaceOffer' in kwargs:
            marketplace_offer = kwargs['marketplaceOffer']
        if marketplace_publisher is None and 'marketplacePublisher' in kwargs:
            marketplace_publisher = kwargs['marketplacePublisher']
        if premier_add_on_name is None and 'premierAddOnName' in kwargs:
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WebAppPremierAddOnArgs._configure(_setter, **kwargs)
