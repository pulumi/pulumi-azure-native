...
class StaticSiteUserProvidedFunctionAppForStaticSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        static_site_user_provided_function_app_for_static_site = azure_native.web.v20220901.StaticSiteUserProvidedFunctionAppForStaticSite("staticSiteUserProvidedFunctionAppForStaticSite",
