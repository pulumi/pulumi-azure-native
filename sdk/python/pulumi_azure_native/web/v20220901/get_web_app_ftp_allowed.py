...
def get_web_app_ftp_allowed(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220901:getWebAppFtpAllowed', __args__, opts=opts, typ=GetWebAppFtpAllowedResult).value
...
def get_web_app_ftp_allowed_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20220901:getWebAppFtpAllowed', __args__, opts=opts, typ=GetWebAppFtpAllowedResult)
