...
def list_static_site_secrets(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220901:listStaticSiteSecrets', __args__, opts=opts, typ=ListStaticSiteSecretsResult).value
...
def list_static_site_secrets_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20220901:listStaticSiteSecrets', __args__, opts=opts, typ=ListStaticSiteSecretsResult)
