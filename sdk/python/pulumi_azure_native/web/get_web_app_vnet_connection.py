...
class GetWebAppVnetConnectionResult:
    ...
    def cert_blob(self) -> Optional[builtins.str]:
        """
    ...
    def cert_thumbprint(self) -> builtins.str:
        """
    ...
    def dns_servers(self) -> Optional[builtins.str]:
        """
    ...
    def is_swift(self) -> Optional[builtins.bool]:
        """
    ...
    def vnet_resource_id(self) -> Optional[builtins.str]:
        """
...
def get_web_app_vnet_connection(name: Optional[builtins.str] = None,
    ...
    :param builtins.str vnet_name: Name of the virtual network.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_web_app_vnet_connection_output(name: Optional[pulumi.Input[builtins.str]] = None,
