...
def list_web_app_function_keys_slot(function_name: Optional[builtins.str] = None,
...
def list_web_app_function_keys_slot_output(function_name: Optional[pulumi.Input[builtins.str]] = None,
