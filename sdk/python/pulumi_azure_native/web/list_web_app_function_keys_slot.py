...
def list_web_app_function_keys_slot(function_name: Optional[_builtins.str] = None,
...
def list_web_app_function_keys_slot_output(function_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listWebAppFunctionKeysSlot', __args__, opts=opts, typ=ListWebAppFunctionKeysSlotResult)
