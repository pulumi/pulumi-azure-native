...
def get_web_app_site_extension_slot(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str slot: Name of the deployment slot. If a slot is not specified, the API uses the production slot.
    """
    __args__ = dict()
    __args__['name'] = name
