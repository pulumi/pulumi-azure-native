...
def list_web_app_function_keys(function_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210201:listWebAppFunctionKeys', __args__, opts=opts, typ=ListWebAppFunctionKeysResult).value
...
def list_web_app_function_keys_output(function_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210201:listWebAppFunctionKeys', __args__, opts=opts, typ=ListWebAppFunctionKeysResult)
