...
def get_web_app_function(function_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_function is deprecated: azure-native:web/v20210201:WebAppFunction is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppFunction to guarantee forwards compatibility.""")
    __args__ = dict()
