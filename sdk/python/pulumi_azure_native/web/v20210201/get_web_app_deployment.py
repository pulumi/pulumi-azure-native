...
def get_web_app_deployment(id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_deployment is deprecated: azure-native:web/v20210201:WebAppDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDeployment to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210201:getWebAppDeployment', __args__, opts=opts, typ=GetWebAppDeploymentResult).value
