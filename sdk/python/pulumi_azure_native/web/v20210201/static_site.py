...
class StaticSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        static_site = azure_native.web.v20210201.StaticSite("staticSite",
            branch="master",
            build_properties=azure_native.web.v20210201.StaticSiteBuildPropertiesArgs(
                api_location="api",
            ...
            sku=azure_native.web.v20210201.SkuDescriptionArgs(
                name="Basic",
                tier="Basic",
            ))
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:StaticSite"), pulumi.Alias(type_="azure-native:web/v20190801:StaticSite"), pulumi.Alias(type_="azure-native:web/v20200601:StaticSite"), pulumi.Alias(type_="azure-native:web/v20200901:StaticSite"), pulumi.Alias(type_="azure-native:web/v20201001:StaticSite"), pulumi.Alias(type_="azure-native:web/v20201201:StaticSite"), pulumi.Alias(type_="azure-native:web/v20210101:StaticSite"), pulumi.Alias(type_="azure-native:web/v20210115:StaticSite"), pulumi.Alias(type_="azure-native:web/v20210301:StaticSite"), pulumi.Alias(type_="azure-native:web/v20220301:StaticSite"), pulumi.Alias(type_="azure-native:web/v20220901:StaticSite")])
