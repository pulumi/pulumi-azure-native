...
warnings.warn("""azure-native:web/v20210201:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAuthSettingsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAuthSettingsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WebAppAuthSettingsSlot, __self__).__init__(
            'azure-native:web/v20210201:WebAppAuthSettingsSlot',
            resource_name,
            __props__,
            opts)
