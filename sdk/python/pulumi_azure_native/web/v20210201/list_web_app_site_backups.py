...
def list_web_app_site_backups(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210201:listWebAppSiteBackups', __args__, opts=opts, typ=ListWebAppSiteBackupsResult).value
...
def list_web_app_site_backups_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210201:listWebAppSiteBackups', __args__, opts=opts, typ=ListWebAppSiteBackupsResult)
