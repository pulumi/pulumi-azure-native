...
warnings.warn("""azure-native:web/v20210201:WebAppSitePushSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettingsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSitePushSettingsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags_requiring_auth: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSitePushSettingsSlot is deprecated: azure-native:web/v20210201:WebAppSitePushSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettingsSlot to guarantee forwards compatibility.""")
