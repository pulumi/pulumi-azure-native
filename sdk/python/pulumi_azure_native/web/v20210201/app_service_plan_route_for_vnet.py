...
warnings.warn("""azure-native:web/v20210201:AppServicePlanRouteForVnet is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlanRouteForVnet to guarantee forwards compatibility.""", DeprecationWarning)
