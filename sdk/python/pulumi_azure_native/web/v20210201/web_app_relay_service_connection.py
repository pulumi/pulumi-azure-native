...
warnings.warn("""azure-native:web/v20210201:WebAppRelayServiceConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppRelayServiceConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppRelayServiceConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppRelayServiceConnection is deprecated: azure-native:web/v20210201:WebAppRelayServiceConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppRelayServiceConnection to guarantee forwards compatibility.""")
