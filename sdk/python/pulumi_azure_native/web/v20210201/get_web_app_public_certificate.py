...
warnings.warn("""azure-native:web/v20210201:WebAppPublicCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppPublicCertificate to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_public_certificate(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_public_certificate is deprecated: azure-native:web/v20210201:WebAppPublicCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppPublicCertificate to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
