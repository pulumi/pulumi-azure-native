...
class StaticSitePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20210201:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20201201:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20201201:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210101:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20210101:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210115:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20210115:StaticSitePrivateEndpointConnection")])
