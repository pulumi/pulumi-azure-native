...
def get_static_site_custom_domain(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site_custom_domain is deprecated: azure-native:web/v20210201:StaticSiteCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSiteCustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
