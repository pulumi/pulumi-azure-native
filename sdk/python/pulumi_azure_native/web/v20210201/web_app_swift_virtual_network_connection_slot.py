...
class WebAppSwiftVirtualNetworkConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 swift_supported: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSwiftVirtualNetworkConnectionSlot is deprecated: azure-native:web/v20210201:WebAppSwiftVirtualNetworkConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSwiftVirtualNetworkConnectionSlot to guarantee forwards compatibility.""")
