...
warnings.warn("""azure-native:web/v20210201:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppInstanceFunctionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppInstanceFunctionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 test_data_href: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppInstanceFunctionSlot is deprecated: azure-native:web/v20210201:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppInstanceFunctionSlot to guarantee forwards compatibility.""")
