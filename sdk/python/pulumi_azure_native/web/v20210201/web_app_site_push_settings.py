...
warnings.warn("""azure-native:web/v20210201:WebAppSitePushSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettings to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSitePushSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags_requiring_auth: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSitePushSettings is deprecated: azure-native:web/v20210201:WebAppSitePushSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettings to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppSitePushSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSitePushSettings, __self__).__init__(
            'azure-native:web/v20210201:WebAppSitePushSettings',
            resource_name,
            __props__,
            opts)
