...
warnings.warn("""azure-native:web/v20210201:AppServicePlan is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.""", DeprecationWarning)
...
class AppServicePlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zone_redundant: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""AppServicePlan is deprecated: azure-native:web/v20210201:AppServicePlan is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.""")
