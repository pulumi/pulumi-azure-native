...
warnings.warn("""azure-native:web/v20210201:WebAppHybridConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHybridConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppHybridConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_bus_suffix: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppHybridConnection is deprecated: azure-native:web/v20210201:WebAppHybridConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHybridConnection to guarantee forwards compatibility.""")
        ...
        super(WebAppHybridConnection, __self__).__init__(
            'azure-native:web/v20210201:WebAppHybridConnection',
            resource_name,
            __props__,
            opts)
