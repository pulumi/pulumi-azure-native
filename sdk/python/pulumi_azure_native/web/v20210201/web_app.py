...
warnings.warn("""azure-native:web/v20210201:WebApp is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebApp to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebApp is deprecated: azure-native:web/v20210201:WebApp is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebApp to guarantee forwards compatibility.""")
