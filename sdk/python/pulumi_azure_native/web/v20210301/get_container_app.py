...
def get_container_app(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_app is deprecated: azure-native:web/v20210301:ContainerApp is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:ContainerApp to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
