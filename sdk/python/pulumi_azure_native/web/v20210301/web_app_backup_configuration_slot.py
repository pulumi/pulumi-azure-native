...
warnings.warn("""azure-native:web/v20210301:WebAppBackupConfigurationSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppBackupConfigurationSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppBackupConfigurationSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_account_url: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppBackupConfigurationSlot is deprecated: azure-native:web/v20210301:WebAppBackupConfigurationSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppBackupConfigurationSlot to guarantee forwards compatibility.""")
        ...
        super(WebAppBackupConfigurationSlot, __self__).__init__(
            'azure-native:web/v20210301:WebAppBackupConfigurationSlot',
            resource_name,
            __props__,
            opts)
