...
def get_web_app_vnet_connection_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_vnet_connection_slot is deprecated: azure-native:web/v20210301:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppVnetConnectionSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210301:getWebAppVnetConnectionSlot', __args__, opts=opts, typ=GetWebAppVnetConnectionSlotResult).value
