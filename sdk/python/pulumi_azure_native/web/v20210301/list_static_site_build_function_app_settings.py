...
def list_static_site_build_function_app_settings(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210301:listStaticSiteBuildFunctionAppSettings', __args__, opts=opts, typ=ListStaticSiteBuildFunctionAppSettingsResult).value
...
def list_static_site_build_function_app_settings_output(environment_name: Optional[pulumi.Input[str]] = None,
                                                        ...
                                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListStaticSiteBuildFunctionAppSettingsResult]:
    """
    Gets the application settings of a static site build.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210301:listStaticSiteBuildFunctionAppSettings', __args__, opts=opts, typ=ListStaticSiteBuildFunctionAppSettingsResult)
    return __ret__.apply(lambda __response__: ListStaticSiteBuildFunctionAppSettingsResult(
