...
warnings.warn("""azure-native:web/v20210301:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPublicCertificate to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppPublicCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppPublicCertificate is deprecated: azure-native:web/v20210301:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPublicCertificate to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppPublicCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppPublicCertificate, __self__).__init__(
            'azure-native:web/v20210301:WebAppPublicCertificate',
            resource_name,
            __props__,
            opts)
