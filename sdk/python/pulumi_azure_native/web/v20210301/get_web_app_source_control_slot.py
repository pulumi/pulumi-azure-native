...
warnings.warn("""azure-native:web/v20210301:WebAppSourceControlSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSourceControlSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_source_control_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_source_control_slot is deprecated: azure-native:web/v20210301:WebAppSourceControlSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSourceControlSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    __args__['slot'] = slot
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210301:getWebAppSourceControlSlot', __args__, opts=opts, typ=GetWebAppSourceControlSlotResult).value
