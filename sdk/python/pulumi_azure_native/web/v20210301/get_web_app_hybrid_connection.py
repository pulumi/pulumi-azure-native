...
warnings.warn("""azure-native:web/v20210301:WebAppHybridConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHybridConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_hybrid_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_hybrid_connection is deprecated: azure-native:web/v20210301:WebAppHybridConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHybridConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
