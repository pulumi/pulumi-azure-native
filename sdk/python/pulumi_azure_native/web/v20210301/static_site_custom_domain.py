...
class StaticSiteCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 validation_method: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StaticSiteCustomDomain is deprecated: azure-native:web/v20210301:StaticSiteCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSiteCustomDomain to guarantee forwards compatibility.""")
