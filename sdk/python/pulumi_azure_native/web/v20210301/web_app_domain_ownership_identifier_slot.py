...
class WebAppDomainOwnershipIdentifierSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppDomainOwnershipIdentifierSlot is deprecated: azure-native:web/v20210301:WebAppDomainOwnershipIdentifierSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDomainOwnershipIdentifierSlot to guarantee forwards compatibility.""")
        ...
        super(WebAppDomainOwnershipIdentifierSlot, __self__).__init__(
            'azure-native:web/v20210301:WebAppDomainOwnershipIdentifierSlot',
            resource_name,
            __props__,
            opts)
