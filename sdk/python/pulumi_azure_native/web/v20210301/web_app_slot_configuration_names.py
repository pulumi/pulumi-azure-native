...
warnings.warn("""azure-native:web/v20210301:WebAppSlotConfigurationNames is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSlotConfigurationNames to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSlotConfigurationNames(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSlotConfigurationNames is deprecated: azure-native:web/v20210301:WebAppSlotConfigurationNames is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSlotConfigurationNames to guarantee forwards compatibility.""")
