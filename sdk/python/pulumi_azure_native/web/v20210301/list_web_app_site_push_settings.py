...
def list_web_app_site_push_settings(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210301:listWebAppSitePushSettings', __args__, opts=opts, typ=ListWebAppSitePushSettingsResult).value
...
def list_web_app_site_push_settings_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210301:listWebAppSitePushSettings', __args__, opts=opts, typ=ListWebAppSitePushSettingsResult)
