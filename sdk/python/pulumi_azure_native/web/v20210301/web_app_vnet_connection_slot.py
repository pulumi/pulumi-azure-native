...
warnings.warn("""azure-native:web/v20210301:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppVnetConnectionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppVnetConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vnet_resource_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppVnetConnectionSlot is deprecated: azure-native:web/v20210301:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppVnetConnectionSlot to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppVnetConnectionSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppVnetConnectionSlot, __self__).__init__(
            'azure-native:web/v20210301:WebAppVnetConnectionSlot',
            resource_name,
            __props__,
            opts)
