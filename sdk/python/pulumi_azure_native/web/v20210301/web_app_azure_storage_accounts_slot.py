...
warnings.warn("""azure-native:web/v20210301:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAzureStorageAccountsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WebAppAzureStorageAccountsSlot, __self__).__init__(
            'azure-native:web/v20210301:WebAppAzureStorageAccountsSlot',
            resource_name,
            __props__,
            opts)
