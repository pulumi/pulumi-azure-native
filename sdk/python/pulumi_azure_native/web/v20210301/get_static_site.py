...
def get_static_site(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site is deprecated: azure-native:web/v20210301:StaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSite to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210301:getStaticSite', __args__, opts=opts, typ=GetStaticSiteResult).value
