...
warnings.warn("""azure-native:web/v20210301:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSiteExtensionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_site_extension_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_site_extension_slot is deprecated: azure-native:web/v20210301:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSiteExtensionSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
