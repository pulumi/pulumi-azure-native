...
def list_web_app_metadata_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210301:listWebAppMetadataSlot', __args__, opts=opts, typ=ListWebAppMetadataSlotResult).value
...
def list_web_app_metadata_slot_output(name: Optional[pulumi.Input[str]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListWebAppMetadataSlotResult]:
    """
    Gets the metadata of an app.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210301:listWebAppMetadataSlot', __args__, opts=opts, typ=ListWebAppMetadataSlotResult)
    return __ret__.apply(lambda __response__: ListWebAppMetadataSlotResult(
