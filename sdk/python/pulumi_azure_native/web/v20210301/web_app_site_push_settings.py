...
warnings.warn("""azure-native:web/v20210301:WebAppSitePushSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettings to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSitePushSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WebAppSitePushSettings, __self__).__init__(
            'azure-native:web/v20210301:WebAppSitePushSettings',
            resource_name,
            __props__,
            opts)
