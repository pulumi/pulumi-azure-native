...
def get_web_app_public_certificate(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_public_certificate is deprecated: azure-native:web/v20210301:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPublicCertificate to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['publicCertificateName'] = public_certificate_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210301:getWebAppPublicCertificate', __args__, opts=opts, typ=GetWebAppPublicCertificateResult).value
