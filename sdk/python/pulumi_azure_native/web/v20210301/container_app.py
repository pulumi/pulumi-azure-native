...
warnings.warn("""azure-native:web/v20210301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:ContainerApp to guarantee forwards compatibility.""", DeprecationWarning)
...
class ContainerApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20220301:ContainerApp"), pulumi.Alias(type_="azure-native:web/v20220901:ContainerApp")])
