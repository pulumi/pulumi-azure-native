...
class ContainerApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20210301:ContainerApp"), pulumi.Alias(type_="azure-native:web:ContainerApp"), pulumi.Alias(type_="azure-nextgen:web:ContainerApp")])
