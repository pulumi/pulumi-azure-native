...
warnings.warn("""azure-native:web/v20210301:WebAppApplicationSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppApplicationSettingsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppApplicationSettingsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WebAppApplicationSettingsSlot, __self__).__init__(
            'azure-native:web/v20210301:WebAppApplicationSettingsSlot',
            resource_name,
            __props__,
            opts)
