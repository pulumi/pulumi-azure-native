...
warnings.warn("""azure-native:web/v20210301:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppConnectionStringsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppConnectionStringsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppConnectionStringsSlot is deprecated: azure-native:web/v20210301:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppConnectionStringsSlot to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppConnectionStringsSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppConnectionStringsSlot, __self__).__init__(
            'azure-native:web/v20210301:WebAppConnectionStringsSlot',
            resource_name,
            __props__,
            opts)
