...
class WebAppAuthSettingsV2(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20201001:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native_web_v20200601:web:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native_web_v20200901:web:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native_web_v20201001:web:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native_web_v20201201:web:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native_web_v20210101:web:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native_web_v20210115:web:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native_web_v20210201:web:WebAppAuthSettingsV2")])
