...
class StaticSitePrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: Private IPAddresses mapped to the remote private endpoint
        :param pulumi.Input[builtins.str] kind: Kind of resource.
        :param pulumi.Input[builtins.str] private_endpoint_connection_name: Name of the private endpoint connection.
