...
class StaticSitePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20220901:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20230101:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20231201:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20240401:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20201201:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20210101:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20210115:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20210201:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20210301:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20220301:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20220901:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20230101:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20231201:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native_web_v20240401:web:StaticSitePrivateEndpointConnection")])
