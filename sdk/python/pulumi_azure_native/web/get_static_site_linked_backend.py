...
def get_static_site_linked_backend(linked_backend_name: Optional[_builtins.str] = None,
...
def get_static_site_linked_backend_output(linked_backend_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
