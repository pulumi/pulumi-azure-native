...
class WebAppPrivateEndpointConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20220901:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20230101:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20231201:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20240401:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20201201:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20210101:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20210115:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20210201:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20210301:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20220301:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20220901:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20230101:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20231201:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native_web_v20240401:web:WebAppPrivateEndpointConnectionSlot")])
