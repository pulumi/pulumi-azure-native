...
class WebAppDeploymentSlotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] slot: Name of the deployment slot. If a slot is not specified, the API gets a deployment for the production slot.
    ...
    @_builtins.property
    @pulumi.getter
    def deployer(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @deployer.setter
    def deployer(self, value: pulumi.Input[Optional[_builtins.str]]):
