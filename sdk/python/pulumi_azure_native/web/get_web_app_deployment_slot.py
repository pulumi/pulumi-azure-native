...
def get_web_app_deployment_slot(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str slot: Name of the deployment slot. If a slot is not specified, the API gets a deployment for the production slot.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_web_app_deployment_slot_output(id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
