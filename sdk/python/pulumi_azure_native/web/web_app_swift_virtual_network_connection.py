...
class WebAppSwiftVirtualNetworkConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20181101:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppSwiftVirtualNetworkConnection")])
