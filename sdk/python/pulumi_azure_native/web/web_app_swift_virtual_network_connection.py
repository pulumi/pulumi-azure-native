...
class WebAppSwiftVirtualNetworkConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        WebAppSwiftVirtualNetworkConnectionArgs._configure(
    ...
    def _configure(
        ...
        if swift_supported is None and 'swiftSupported' in kwargs:
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WebAppSwiftVirtualNetworkConnectionArgs._configure(_setter, **kwargs)
