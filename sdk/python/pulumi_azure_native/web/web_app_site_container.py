...
class WebAppSiteContainerArgs:
    ...
    @is_main.setter
    def is_main(self, value: pulumi.Input[_builtins.bool]):
...
class WebAppSiteContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20231201:WebAppSiteContainer"), pulumi.Alias(type_="azure-native:web/v20240401:WebAppSiteContainer"), pulumi.Alias(type_="azure-native:web/v20241101:WebAppSiteContainer")])
