...
def get_web_app_vnet_connection_slot(name: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will get the named virtual network for the production slot.
...
def get_web_app_vnet_connection_slot_output(name: Optional[pulumi.Input[builtins.str]] = None,
