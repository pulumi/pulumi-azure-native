...
warnings.warn("""azure-native:web/v20200601:WebAppDeploymentSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDeploymentSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppDeploymentSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 status: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppDeploymentSlot is deprecated: azure-native:web/v20200601:WebAppDeploymentSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDeploymentSlot to guarantee forwards compatibility.""")
