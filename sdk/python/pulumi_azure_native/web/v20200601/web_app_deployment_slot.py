...
warnings.warn("""azure-native:web/v20200601:WebAppDeploymentSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppDeploymentSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppDeploymentSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 status: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppDeploymentSlot is deprecated: azure-native:web/v20200601:WebAppDeploymentSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppDeploymentSlot to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppDeploymentSlot")])
