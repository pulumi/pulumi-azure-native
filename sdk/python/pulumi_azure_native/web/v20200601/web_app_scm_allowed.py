...
class WebAppScmAllowed(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20190801:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppScmAllowed"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppScmAllowed")])
