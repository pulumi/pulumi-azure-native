...
warnings.warn("""azure-native:web/v20200601:StaticSite is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:StaticSite to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_static_site(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site is deprecated: azure-native:web/v20200601:StaticSite is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:StaticSite to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
