...
warnings.warn("""azure-native:web/v20200601:WebAppSwiftVirtualNetworkConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnection to guarantee forwards compatibility.""", DeprecationWarning)
