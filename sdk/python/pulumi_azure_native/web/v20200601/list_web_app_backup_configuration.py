...
def list_web_app_backup_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200601:listWebAppBackupConfiguration', __args__, opts=opts, typ=ListWebAppBackupConfigurationResult).value
...
def list_web_app_backup_configuration_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20200601:listWebAppBackupConfiguration', __args__, opts=opts, typ=ListWebAppBackupConfigurationResult)
