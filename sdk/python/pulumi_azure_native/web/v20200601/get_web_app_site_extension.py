...
warnings.warn("""azure-native:web/v20200601:WebAppSiteExtension is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSiteExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_site_extension(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_site_extension is deprecated: azure-native:web/v20200601:WebAppSiteExtension is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSiteExtension to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
