...
class WebAppConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/latest:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppConfiguration, __self__).__init__(
            'azure-native:web/v20200601:WebAppConfiguration',
            resource_name,
            __props__,
            opts)
