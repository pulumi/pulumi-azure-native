...
def get_app_service_environment(name: Optional[str] = None,
    ...
    return AwaitableGetAppServiceEnvironmentResult(
        ...
        ssl_cert_key_vault_id=pulumi.get(__ret__, 'ssl_cert_key_vault_id'),
        ssl_cert_key_vault_secret_name=pulumi.get(__ret__, 'ssl_cert_key_vault_secret_name'),
...
def get_app_service_environment_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20200601:getAppServiceEnvironment', __args__, opts=opts, typ=GetAppServiceEnvironmentResult)
