...
warnings.warn("""azure-native:web/v20200601:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAzureStorageAccountsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppAzureStorageAccountsSlot is deprecated: azure-native:web/v20200601:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppAzureStorageAccountsSlot")])
