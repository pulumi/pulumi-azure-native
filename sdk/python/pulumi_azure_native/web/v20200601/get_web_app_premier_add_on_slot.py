...
def get_web_app_premier_add_on_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_premier_add_on_slot is deprecated: azure-native:web/v20200601:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOnSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
