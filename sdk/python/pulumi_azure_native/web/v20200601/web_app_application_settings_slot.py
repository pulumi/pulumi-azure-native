...
class WebAppApplicationSettingsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppApplicationSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppApplicationSettingsSlot")])
