...
def list_web_app_host_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200601:listWebAppHostKeys', __args__, opts=opts, typ=ListWebAppHostKeysResult).value
...
def list_web_app_host_keys_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20200601:listWebAppHostKeys', __args__, opts=opts, typ=ListWebAppHostKeysResult)
