...
def get_web_app_host_name_binding_slot(host_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_host_name_binding_slot is deprecated: azure-native:web/v20200601:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHostNameBindingSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200601:getWebAppHostNameBindingSlot', __args__, opts=opts, typ=GetWebAppHostNameBindingSlotResult).value
