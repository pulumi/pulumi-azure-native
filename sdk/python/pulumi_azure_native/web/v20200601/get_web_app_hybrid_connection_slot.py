...
warnings.warn("""azure-native:web/v20200601:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHybridConnectionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_hybrid_connection_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_hybrid_connection_slot is deprecated: azure-native:web/v20200601:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHybridConnectionSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200601:getWebAppHybridConnectionSlot', __args__, opts=opts, typ=GetWebAppHybridConnectionSlotResult).value
