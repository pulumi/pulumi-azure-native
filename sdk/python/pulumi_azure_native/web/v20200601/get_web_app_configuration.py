...
def get_web_app_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200601:getWebAppConfiguration', __args__, opts=opts, typ=GetWebAppConfigurationResult).value
