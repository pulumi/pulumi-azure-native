...
class AppServiceEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 worker_pools: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WorkerPoolArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""AppServiceEnvironment is deprecated: azure-native:web/v20200601:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:AppServiceEnvironment to guarantee forwards compatibility.""")
