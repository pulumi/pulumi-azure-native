...
warnings.warn("""azure-native:web/v20200601:WebAppFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppFunction to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_function(function_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_function is deprecated: azure-native:web/v20200601:WebAppFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppFunction to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['functionName'] = function_name
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200601:getWebAppFunction', __args__, opts=opts, typ=GetWebAppFunctionResult).value
