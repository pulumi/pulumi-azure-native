...
def list_web_app_function_keys_slot(function_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200601:listWebAppFunctionKeysSlot', __args__, opts=opts, typ=ListWebAppFunctionKeysSlotResult).value
...
def list_web_app_function_keys_slot_output(function_name: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListWebAppFunctionKeysSlotResult]:
    """
    Get function keys for a function in a web site, or a deployment slot.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20200601:listWebAppFunctionKeysSlot', __args__, opts=opts, typ=ListWebAppFunctionKeysSlotResult)
