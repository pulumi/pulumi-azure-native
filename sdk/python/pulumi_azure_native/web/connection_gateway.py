...
class ConnectionGatewayArgs:
    def __init__(__self__, *,
        ...
        """
        ConnectionGatewayArgs._configure(
    ...
    def _configure(
        ...
        if 'connectionGatewayName' in kwargs:
            connection_gateway_name = kwargs['connectionGatewayName']
        if 'subscriptionId' in kwargs:
            subscription_id = kwargs['subscriptionId']

        _setter("resource_group_name", resource_group_name)
        if connection_gateway_name is not None:
            _setter("connection_gateway_name", connection_gateway_name)
    ...
    def connection_gateway_name(self) -> Optional[pulumi.Input[str]]:
        """
...
class ConnectionGateway(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ConnectionGatewayArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ConnectionGatewayDefinitionPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ConnectionGatewayDefinitionPropertiesArgs._configure(_setter, **properties)
