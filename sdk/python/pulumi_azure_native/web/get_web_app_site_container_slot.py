...
def get_web_app_site_container_slot(container_name: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will get the Site Container for the production slot.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:getWebAppSiteContainerSlot', __args__, opts=opts, typ=GetWebAppSiteContainerSlotResult).value
...
def get_web_app_site_container_slot_output(container_name: Optional[pulumi.Input[builtins.str]] = None,
