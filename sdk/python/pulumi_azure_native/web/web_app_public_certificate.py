...
class WebAppPublicCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20160801:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppPublicCertificate"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppPublicCertificate")])
