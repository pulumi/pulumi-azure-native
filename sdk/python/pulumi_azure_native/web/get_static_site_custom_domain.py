...
def get_static_site_custom_domain(domain_name: Optional[_builtins.str] = None,
...
def get_static_site_custom_domain_output(domain_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
