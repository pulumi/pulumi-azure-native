...
warnings.warn("""azure-native:web/v20220301:AppServicePlanRouteForVnet is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlanRouteForVnet to guarantee forwards compatibility.""", DeprecationWarning)
...
class AppServicePlanRouteForVnet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vnet_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AppServicePlanRouteForVnet is deprecated: azure-native:web/v20220301:AppServicePlanRouteForVnet is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlanRouteForVnet to guarantee forwards compatibility.""")
