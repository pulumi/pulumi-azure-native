...
def get_web_app_host_name_binding(host_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_host_name_binding is deprecated: azure-native:web/v20220301:WebAppHostNameBinding is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHostNameBinding to guarantee forwards compatibility.""")
    __args__ = dict()
