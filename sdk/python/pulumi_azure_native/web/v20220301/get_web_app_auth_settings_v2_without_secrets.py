...
def get_web_app_auth_settings_v2_without_secrets(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220301:getWebAppAuthSettingsV2WithoutSecrets', __args__, opts=opts, typ=GetWebAppAuthSettingsV2WithoutSecretsResult).value
...
def get_web_app_auth_settings_v2_without_secrets_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20220301:getWebAppAuthSettingsV2WithoutSecrets', __args__, opts=opts, typ=GetWebAppAuthSettingsV2WithoutSecretsResult)
