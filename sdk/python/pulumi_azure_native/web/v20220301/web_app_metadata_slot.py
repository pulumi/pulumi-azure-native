...
warnings.warn("""azure-native:web/v20220301:WebAppMetadataSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppMetadataSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppMetadataSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppMetadataSlot is deprecated: azure-native:web/v20220301:WebAppMetadataSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppMetadataSlot to guarantee forwards compatibility.""")
