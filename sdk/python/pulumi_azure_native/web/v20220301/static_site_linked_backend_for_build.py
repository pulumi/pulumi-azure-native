...
class StaticSiteLinkedBackendForBuild(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StaticSiteLinkedBackendForBuild is deprecated: azure-native:web/v20220301:StaticSiteLinkedBackendForBuild is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSiteLinkedBackendForBuild to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:StaticSiteLinkedBackendForBuild"), pulumi.Alias(type_="azure-native:web/v20220901:StaticSiteLinkedBackendForBuild")])
