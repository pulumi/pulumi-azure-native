...
def get_web_app_deployment_slot(id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_deployment_slot is deprecated: azure-native:web/v20220301:WebAppDeploymentSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDeploymentSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220301:getWebAppDeploymentSlot', __args__, opts=opts, typ=GetWebAppDeploymentSlotResult).value
