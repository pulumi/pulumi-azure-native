...
def get_web_app_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220301:getWebAppSlot', __args__, opts=opts, typ=GetWebAppSlotResult).value
...
def get_web_app_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20220301:getWebAppSlot', __args__, opts=opts, typ=GetWebAppSlotResult)
