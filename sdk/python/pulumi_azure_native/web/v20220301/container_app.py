...
warnings.warn("""azure-native:web/v20220301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least \"\" to guarantee forwards compatibility.""", DeprecationWarning)
...
class ContainerApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 template: Optional[pulumi.Input[pulumi.InputType['TemplateArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ContainerApp is deprecated: azure-native:web/v20220301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least "" to guarantee forwards compatibility.""")
