...
warnings.warn("""azure-native:web/v20220301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:ContainerApp to guarantee forwards compatibility.""", DeprecationWarning)
...
class ContainerApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 template: Optional[pulumi.Input[pulumi.InputType['TemplateArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ContainerApp is deprecated: azure-native:web/v20220301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:ContainerApp to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20210301:ContainerApp"), pulumi.Alias(type_="azure-native:web/v20220901:ContainerApp")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerApp, __self__).__init__(
            'azure-native:web/v20220301:ContainerApp',
            resource_name,
            __props__,
            opts)
