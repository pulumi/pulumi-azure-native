...
def get_web_app_premier_add_on_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_premier_add_on_slot is deprecated: azure-native:web/v20220301:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppPremierAddOnSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220301:getWebAppPremierAddOnSlot', __args__, opts=opts, typ=GetWebAppPremierAddOnSlotResult).value
