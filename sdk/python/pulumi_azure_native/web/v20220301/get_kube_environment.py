...
warnings.warn("""azure-native:web/v20220301:KubeEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:KubeEnvironment to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_kube_environment(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_kube_environment is deprecated: azure-native:web/v20220301:KubeEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:KubeEnvironment to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
