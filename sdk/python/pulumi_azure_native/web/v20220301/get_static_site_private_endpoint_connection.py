...
warnings.warn("""azure-native:web/v20220301:StaticSitePrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSitePrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_static_site_private_endpoint_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site_private_endpoint_connection is deprecated: azure-native:web/v20220301:StaticSitePrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSitePrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
