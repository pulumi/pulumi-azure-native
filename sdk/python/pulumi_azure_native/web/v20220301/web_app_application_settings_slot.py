...
warnings.warn("""azure-native:web/v20220301:WebAppApplicationSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppApplicationSettingsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppApplicationSettingsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppApplicationSettingsSlot is deprecated: azure-native:web/v20220301:WebAppApplicationSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppApplicationSettingsSlot to guarantee forwards compatibility.""")
