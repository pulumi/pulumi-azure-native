...
warnings.warn("""azure-native:web/v20220301:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHostNameBindingSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppHostNameBindingSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 thumbprint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppHostNameBindingSlot is deprecated: azure-native:web/v20220301:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHostNameBindingSlot to guarantee forwards compatibility.""")
