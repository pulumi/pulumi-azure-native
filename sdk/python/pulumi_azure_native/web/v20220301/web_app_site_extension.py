...
warnings.warn("""azure-native:web/v20220301:WebAppSiteExtension is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSiteExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSiteExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 site_extension_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSiteExtension is deprecated: azure-native:web/v20220301:WebAppSiteExtension is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSiteExtension to guarantee forwards compatibility.""")
