...
def get_static_site_user_provided_function_app_for_static_site(function_app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site_user_provided_function_app_for_static_site is deprecated: azure-native:web/v20220301:StaticSiteUserProvidedFunctionAppForStaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSiteUserProvidedFunctionAppForStaticSite to guarantee forwards compatibility.""")
    __args__ = dict()
