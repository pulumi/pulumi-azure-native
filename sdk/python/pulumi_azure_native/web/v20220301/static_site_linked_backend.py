...
class StaticSiteLinkedBackend(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:StaticSiteLinkedBackend"), pulumi.Alias(type_="azure-native:web/v20220901:StaticSiteLinkedBackend"), pulumi.Alias(type_="azure-native:web/v20230101:StaticSiteLinkedBackend"), pulumi.Alias(type_="azure-native:web/v20231201:StaticSiteLinkedBackend"), pulumi.Alias(type_="azure-native:web/v20240401:StaticSiteLinkedBackend")])
