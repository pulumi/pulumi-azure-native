...
warnings.warn("""azure-native:web/v20220301:WebAppSourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSourceControl to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSourceControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSourceControl is deprecated: azure-native:web/v20220301:WebAppSourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSourceControl to guarantee forwards compatibility.""")
