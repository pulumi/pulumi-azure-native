...
warnings.warn("""azure-native:web/v20220301:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSiteExtensionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSiteExtensionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSiteExtensionSlot is deprecated: azure-native:web/v20220301:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSiteExtensionSlot to guarantee forwards compatibility.""")
