...
warnings.warn("""azure-native:web/v20220301:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppRelayServiceConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WebAppRelayServiceConnectionSlot, __self__).__init__(
            'azure-native:web/v20220301:WebAppRelayServiceConnectionSlot',
            resource_name,
            __props__,
            opts)
