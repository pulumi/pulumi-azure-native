...
warnings.warn("""azure-native:web/v20220301:StaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSite to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetStaticSiteResult:
    ...
    """
    def __init__(__self__, allow_config_file_updates=None, branch=None, build_properties=None, content_distribution_endpoint=None, custom_domains=None, default_hostname=None, enterprise_grade_cdn_status=None, id=None, identity=None, key_vault_reference_identity=None, kind=None, linked_backends=None, location=None, name=None, private_endpoint_connections=None, provider=None, public_network_access=None, repository_token=None, repository_url=None, sku=None, staging_environment_policy=None, tags=None, template_properties=None, type=None, user_provided_function_apps=None):
...
def get_static_site(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site is deprecated: azure-native:web/v20220301:StaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSite to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20220301:getStaticSite', __args__, opts=opts, typ=GetStaticSiteResult).value
