...
def get_web_app_site_extension(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20231201:getWebAppSiteExtension', __args__, opts=opts, typ=GetWebAppSiteExtensionResult).value
...
def get_web_app_site_extension_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['siteExtensionId'] = site_extension_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20231201:getWebAppSiteExtension', __args__, opts=opts, typ=GetWebAppSiteExtensionResult)
