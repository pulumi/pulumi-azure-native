...
def list_container_app_secrets(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20231201:listContainerAppSecrets', __args__, opts=opts, typ=ListContainerAppSecretsResult).value
...
def list_container_app_secrets_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20231201:listContainerAppSecrets', __args__, opts=opts, typ=ListContainerAppSecretsResult)
