...
def list_static_site_app_settings(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20231201:listStaticSiteAppSettings', __args__, opts=opts, typ=ListStaticSiteAppSettingsResult).value
...
def list_static_site_app_settings_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20231201:listStaticSiteAppSettings', __args__, opts=opts, typ=ListStaticSiteAppSettingsResult)
