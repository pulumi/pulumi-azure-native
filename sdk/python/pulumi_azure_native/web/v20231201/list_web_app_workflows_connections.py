...
def list_web_app_workflows_connections(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20231201:listWebAppWorkflowsConnections', __args__, opts=opts, typ=ListWebAppWorkflowsConnectionsResult).value
