...
class WebAppSiteContainerSlotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] slot: Name of the deployment slot. If a slot is not specified, the API will create the container for the production slot.
...
class WebAppSiteContainerSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppSiteContainerSlot"), pulumi.Alias(type_="azure-native:web/v20240401:WebAppSiteContainerSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSiteContainerSlot, __self__).__init__(
            'azure-native:web/v20231201:WebAppSiteContainerSlot',
            resource_name,
            __props__,
            opts)
