...
class StaticSiteCustomDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_name: The custom domain to create.
        :param pulumi.Input[builtins.str] kind: Kind of resource.
        :param pulumi.Input[builtins.str] validation_method: Validation method for adding a custom domain
        """
