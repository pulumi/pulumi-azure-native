...
def list_app_service_plan_hybrid_connection_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20190801:listAppServicePlanHybridConnectionKeys', __args__, opts=opts, typ=ListAppServicePlanHybridConnectionKeysResult).value
...
def list_app_service_plan_hybrid_connection_keys_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20190801:listAppServicePlanHybridConnectionKeys', __args__, opts=opts, typ=ListAppServicePlanHybridConnectionKeysResult)
