...
class AwaitableGetWebAppConfigurationResult(GetWebAppConfigurationResult):
    ...
    def __await__(self):
        ...
        return GetWebAppConfigurationResult(
            acr_use_managed_identity_creds=self.acr_use_managed_identity_creds,
            acr_user_managed_identity_id=self.acr_user_managed_identity_id,
...
def get_web_app_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20190801:getWebAppConfiguration', __args__, opts=opts, typ=GetWebAppConfigurationResult).value

    return AwaitableGetWebAppConfigurationResult(
        acr_use_managed_identity_creds=__ret__.acr_use_managed_identity_creds,
        acr_user_managed_identity_id=__ret__.acr_user_managed_identity_id,
