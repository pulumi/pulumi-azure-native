...
def get_web_app_hybrid_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_hybrid_connection is deprecated: azure-native:web/v20190801:WebAppHybridConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHybridConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20190801:getWebAppHybridConnection', __args__, opts=opts, typ=GetWebAppHybridConnectionResult).value
