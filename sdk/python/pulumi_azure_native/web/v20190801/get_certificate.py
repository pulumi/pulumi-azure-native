...
def get_certificate(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: azure-native:web/v20190801:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:Certificate to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20190801:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
