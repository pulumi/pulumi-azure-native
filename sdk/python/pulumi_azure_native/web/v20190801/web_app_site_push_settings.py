...
warnings.warn("""azure-native:web/v20190801:WebAppSitePushSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSitePushSettings to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSitePushSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags_requiring_auth: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSitePushSettings is deprecated: azure-native:web/v20190801:WebAppSitePushSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSitePushSettings to guarantee forwards compatibility.""")
