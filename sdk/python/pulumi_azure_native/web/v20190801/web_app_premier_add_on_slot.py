...
class WebAppPremierAddOnSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vendor: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppPremierAddOnSlot is deprecated: azure-native:web/v20190801:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPremierAddOnSlot to guarantee forwards compatibility.""")
        ...
        super(WebAppPremierAddOnSlot, __self__).__init__(
            'azure-native:web/v20190801:WebAppPremierAddOnSlot',
            resource_name,
            __props__,
            opts)
