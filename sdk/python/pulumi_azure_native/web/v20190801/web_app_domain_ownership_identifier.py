...
class WebAppDomainOwnershipIdentifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppDomainOwnershipIdentifier is deprecated: azure-native:web/v20190801:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.""")
