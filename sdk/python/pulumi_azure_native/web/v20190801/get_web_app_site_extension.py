...
def get_web_app_site_extension(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_site_extension is deprecated: azure-native:web/v20190801:WebAppSiteExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSiteExtension to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    __args__['siteExtensionId'] = site_extension_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20190801:getWebAppSiteExtension', __args__, opts=opts, typ=GetWebAppSiteExtensionResult).value
