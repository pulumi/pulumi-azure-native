...
warnings.warn("""azure-native:web/v20190801:WebApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebApp to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""WebApp is deprecated: azure-native:web/v20190801:WebApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebApp to guarantee forwards compatibility.""")
