...
class AppServicePlanRouteForVnetArgs:
    def __init__(__self__, *,
                 ...
                 end_address: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input[builtins.str]] = None,
                 route_name: Optional[pulumi.Input[builtins.str]] = None,
                 route_type: Optional[pulumi.Input[Union[builtins.str, 'RouteType']]] = None,
                 start_address: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] vnet_name: Name of the Virtual Network.
        :param pulumi.Input[builtins.str] end_address: The ending address for this route. If the start address is specified in CIDR notation, this must be omitted.
        :param pulumi.Input[builtins.str] kind: Kind of resource.
        :param pulumi.Input[builtins.str] route_name: Name of the Virtual Network route.
        :param pulumi.Input[Union[builtins.str, 'RouteType']] route_type: The type of route this is:
               DEFAULT - By default, every app has routes to the local address ranges specified by RFC1918
               INHERITED - Routes inherited from the real Virtual Network routes
               STATIC - Static route set on the app only
               
               These values will be used for syncing an app's routes with those from a Virtual Network.
        :param pulumi.Input[builtins.str] start_address: The starting address for this route. This may also include a CIDR notation, in which case the end address must not be specified.
        """
    ...
    def end_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @end_address.setter
    def end_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def route_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'RouteType']]]:
        """
    ...
    @route_type.setter
    def route_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'RouteType']]]):
        pulumi.set(self, "route_type", value)

    @property
    @pulumi.getter(name="startAddress")
    def start_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def start_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AppServicePlanRouteForVnet(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="endAddress")
    def end_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ending address for this route. If the start address is specified in CIDR notation, this must be omitted.
        """
        return pulumi.get(self, "end_address")
    ...
    @property
    @pulumi.getter(name="routeType")
    def route_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of route this is:
        DEFAULT - By default, every app has routes to the local address ranges specified by RFC1918
        INHERITED - Routes inherited from the real Virtual Network routes
    ...
    @property
    @pulumi.getter(name="startAddress")
    def start_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The starting address for this route. This may also include a CIDR notation, in which case the end address must not be specified.
        """
        return pulumi.get(self, "start_address")
