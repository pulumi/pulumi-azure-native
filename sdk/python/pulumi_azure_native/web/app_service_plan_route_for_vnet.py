...
class AppServicePlanRouteForVnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] start_address: The starting address for this route. This may also include a CIDR notation, in which case the end address must not be specified.
        """
