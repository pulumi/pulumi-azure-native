...
class SiteDeploymentSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SiteDeploymentSlot is deprecated: Version v20150801 will be removed in the next major version of the provider. Upgrade to version v20150801preview or later.""")
        if opts is None:
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20160801:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20180201:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20181101:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20190801:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20200601:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20200901:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20201001:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20201201:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20210101:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20210115:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20210201:SiteDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20210301:SiteDeploymentSlot")])
