...
class ServerFarmRouteForVnet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web/latest:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web/latest:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web/v20160901:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web/v20160901:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web/v20180201:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web/v20180201:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web/v20190801:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web/v20190801:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web/v20200601:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web/v20200601:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web/v20200901:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web/v20200901:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web/v20201001:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web/v20201001:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-native:web/v20201201:ServerFarmRouteForVnet"), pulumi.Alias(type_="azure-nextgen:web/v20201201:ServerFarmRouteForVnet")])
