...
__all__ = [
    ...
    'list_site_metadata_slot_output',
]
...
def list_site_metadata_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20150801:listSiteMetadataSlot', __args__, opts=opts, typ=ListSiteMetadataSlotResult).value
...
@_utilities.lift_output_func(list_site_metadata_slot)
def list_site_metadata_slot_output(name: Optional[pulumi.Input[str]] = None,
                                   resource_group_name: Optional[pulumi.Input[str]] = None,
                                   slot: Optional[pulumi.Input[str]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ListSiteMetadataSlotResult]:
    """
    String dictionary resource
