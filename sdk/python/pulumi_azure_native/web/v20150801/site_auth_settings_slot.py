...
class SiteAuthSettingsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20160801:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20180201:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20200601:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20200901:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20201001:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20210101:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20210115:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20210201:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20210301:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20220301:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-native:web/v20220901:SiteAuthSettingsSlot")])
