...
__all__ = [
    'GetSiteVNETConnectionSlotResult',
    'AwaitableGetSiteVNETConnectionSlotResult',
    'get_site_vnet_connection_slot',
    'get_site_vnet_connection_slot_output',
]
...
def get_site_vnet_connection_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_site_vnet_connection_slot is deprecated: Version v20150801 will be removed in the next major version of the provider. Upgrade to version v20150801preview or later.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20150801:getSiteVNETConnectionSlot', __args__, opts=opts, typ=GetSiteVNETConnectionSlotResult).value
...
@_utilities.lift_output_func(get_site_vnet_connection_slot)
def get_site_vnet_connection_slot_output(name: Optional[pulumi.Input[str]] = None,
                                         resource_group_name: Optional[pulumi.Input[str]] = None,
                                         slot: Optional[pulumi.Input[str]] = None,
                                         vnet_name: Optional[pulumi.Input[str]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSiteVNETConnectionSlotResult]:
    """
    VNETInfo contract. This contract is public and is a stripped down version of VNETInfoInternal
