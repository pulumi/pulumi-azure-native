...
class SiteRelayServiceConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20160801:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20180201:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20181101:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20190801:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20200601:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20200901:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20201001:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20201201:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20210101:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20210115:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20210201:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20210301:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20220301:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20220901:SiteRelayServiceConnection")])
