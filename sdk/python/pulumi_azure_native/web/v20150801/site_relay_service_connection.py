...
__all__ = ['SiteRelayServiceConnectionArgs', 'SiteRelayServiceConnection']

@pulumi.input_type
class SiteRelayServiceConnectionArgs:
...
class SiteRelayServiceConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SiteRelayServiceConnectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SiteRelayServiceConnectionArgs.__new__(SiteRelayServiceConnectionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20160801:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20180201:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20181101:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20190801:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20200601:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20200901:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20201001:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20201201:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20201201:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20210101:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20210101:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20210115:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20210115:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-native:web/v20210201:SiteRelayServiceConnection"), pulumi.Alias(type_="azure-nextgen:web/v20210201:SiteRelayServiceConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteRelayServiceConnection, __self__).__init__(
            'azure-native:web/v20150801:SiteRelayServiceConnection',
            resource_name,
            __props__,
            opts)
