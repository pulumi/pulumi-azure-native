...
class Site(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:Site"), pulumi.Alias(type_="azure-native:web:Site"), pulumi.Alias(type_="azure-nextgen:web:Site"), pulumi.Alias(type_="azure-native:web/v20160801:Site"), pulumi.Alias(type_="azure-nextgen:web/v20160801:Site"), pulumi.Alias(type_="azure-native:web/v20180201:Site"), pulumi.Alias(type_="azure-nextgen:web/v20180201:Site"), pulumi.Alias(type_="azure-native:web/v20181101:Site"), pulumi.Alias(type_="azure-nextgen:web/v20181101:Site"), pulumi.Alias(type_="azure-native:web/v20190801:Site"), pulumi.Alias(type_="azure-nextgen:web/v20190801:Site"), pulumi.Alias(type_="azure-native:web/v20200601:Site"), pulumi.Alias(type_="azure-nextgen:web/v20200601:Site"), pulumi.Alias(type_="azure-native:web/v20200901:Site"), pulumi.Alias(type_="azure-nextgen:web/v20200901:Site"), pulumi.Alias(type_="azure-native:web/v20201001:Site"), pulumi.Alias(type_="azure-nextgen:web/v20201001:Site"), pulumi.Alias(type_="azure-native:web/v20201201:Site"), pulumi.Alias(type_="azure-nextgen:web/v20201201:Site"), pulumi.Alias(type_="azure-native:web/v20210101:Site"), pulumi.Alias(type_="azure-nextgen:web/v20210101:Site"), pulumi.Alias(type_="azure-native:web/v20210115:Site"), pulumi.Alias(type_="azure-nextgen:web/v20210115:Site"), pulumi.Alias(type_="azure-native:web/v20210201:Site"), pulumi.Alias(type_="azure-nextgen:web/v20210201:Site")])
