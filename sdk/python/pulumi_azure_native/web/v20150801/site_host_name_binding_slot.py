...
class SiteHostNameBindingSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20160801:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20180201:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20181101:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20190801:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20200601:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20200901:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20201001:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20201201:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20210101:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20210115:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20210201:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20210301:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20220301:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20220901:SiteHostNameBindingSlot")])
