...
class SiteSourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SiteSourceControlArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SiteSourceControlArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SiteSourceControl is deprecated: Version 2015-08-01 will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20160801:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20180201:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20181101:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20190801:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20200601:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20200901:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20201001:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20201201:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20210101:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20210115:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20210201:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20210301:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20220301:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20220901:SiteSourceControl")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteSourceControl, __self__).__init__(
            'azure-native:web/v20150801:SiteSourceControl',
            resource_name,
            __props__,
            opts)
