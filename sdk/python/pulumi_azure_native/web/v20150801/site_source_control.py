...
class SiteSourceControl(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteSourceControl"), pulumi.Alias(type_="azure-native:web:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/latest:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20160801:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20180201:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20181101:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20190801:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20200601:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20200901:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteSourceControl"), pulumi.Alias(type_="azure-native:web/v20201001:SiteSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteSourceControl")])
