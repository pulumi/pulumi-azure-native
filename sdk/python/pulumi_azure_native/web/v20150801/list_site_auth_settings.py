...
@pulumi.output_type
class ListSiteAuthSettingsResult:
    """
...
class AwaitableListSiteAuthSettingsResult(ListSiteAuthSettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListSiteAuthSettingsResult(
...
def list_site_auth_settings(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20150801:listSiteAuthSettings', __args__, opts=opts, typ=ListSiteAuthSettingsResult).value

    return AwaitableListSiteAuthSettingsResult(
