...
def get_site_instance_deployment_slot(id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_site_instance_deployment_slot is deprecated: Version v20150801 will be removed in the next major version of the provider. Upgrade to version v20150801preview or later.""")
    __args__ = dict()
    __args__['id'] = id
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20150801:getSiteInstanceDeploymentSlot', __args__, opts=opts, typ=GetSiteInstanceDeploymentSlotResult).value
...
@_utilities.lift_output_func(get_site_instance_deployment_slot)
def get_site_instance_deployment_slot_output(id: Optional[pulumi.Input[str]] = None,
                                             instance_id: Optional[pulumi.Input[str]] = None,
                                             name: Optional[pulumi.Input[str]] = None,
                                             resource_group_name: Optional[pulumi.Input[str]] = None,
                                             slot: Optional[pulumi.Input[str]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSiteInstanceDeploymentSlotResult]:
    """
    Represents user credentials used for publishing activity
