...
class SiteInstanceDeploymentSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azure-native:web:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azure-native:web/latest:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteInstanceDeploymentSlot")])
