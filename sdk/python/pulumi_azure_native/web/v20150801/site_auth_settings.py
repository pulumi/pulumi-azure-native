...
class SiteAuthSettings(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/latest:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/v20160801:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/v20180201:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/v20181101:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/v20190801:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/v20200601:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/v20200901:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/v20201001:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteAuthSettings"), pulumi.Alias(type_="azure-native:web/v20201201:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20201201:SiteAuthSettings")])
