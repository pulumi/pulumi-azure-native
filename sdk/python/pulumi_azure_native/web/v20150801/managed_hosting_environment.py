...
class ManagedHostingEnvironment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:ManagedHostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web:ManagedHostingEnvironment"), pulumi.Alias(type_="azure-native:web/latest:ManagedHostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/latest:ManagedHostingEnvironment")])
