...
class SiteSlot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SiteSlotArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SiteSlotArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20160801:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20180201:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20181101:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20190801:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20200601:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20200901:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20201001:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20201201:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20210101:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20210115:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20210201:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20210301:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20220301:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20220901:SiteSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteSlot, __self__).__init__(
            'azure-native:web/v20150801:SiteSlot',
            resource_name,
            __props__,
            opts)
