...
class SiteSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteSlot"), pulumi.Alias(type_="azure-native:web:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web:SiteSlot"), pulumi.Alias(type_="azure-native:web/latest:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20160801:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20180201:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20181101:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20190801:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20200601:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20200901:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteSlot"), pulumi.Alias(type_="azure-native:web/v20201001:SiteSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteSlot")])
