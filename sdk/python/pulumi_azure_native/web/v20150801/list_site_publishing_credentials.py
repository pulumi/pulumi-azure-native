...
def list_site_publishing_credentials(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20150801:listSitePublishingCredentials', __args__, opts=opts, typ=ListSitePublishingCredentialsResult).value
