...
def get_site_deployment_slot(id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_site_deployment_slot is deprecated: Version v20150801 will be removed in the next major version of the provider. Upgrade to version v20150801preview or later.""")
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20150801:getSiteDeploymentSlot', __args__, opts=opts, typ=GetSiteDeploymentSlotResult).value
