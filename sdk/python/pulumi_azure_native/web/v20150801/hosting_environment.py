...
class HostingEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:HostingEnvironment"), pulumi.Alias(type_="azure-native:web:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20160901:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20160901:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20180201:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20180201:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20190801:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20190801:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20200601:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20200601:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20200901:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20200901:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20201001:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20201001:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20201201:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20201201:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20210101:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20210101:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20210115:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20210115:HostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20210201:HostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20210201:HostingEnvironment")])
