...
class HostingEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 worker_pools: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WorkerPoolArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""HostingEnvironment is deprecated: Version v20150801 will be removed in the next major version of the provider. Upgrade to version v20150801preview or later.""")
        if opts is None:
