...
def get_connection_gateway(connection_gateway_name: Optional[_builtins.str] = None,
...
def get_connection_gateway_output(connection_gateway_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
