...
def list_web_app_backup_configuration(name: Optional[builtins.str] = None,
...
def list_web_app_backup_configuration_output(name: Optional[pulumi.Input[builtins.str]] = None,
