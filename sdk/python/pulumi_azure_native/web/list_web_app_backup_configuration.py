...
def list_web_app_backup_configuration(name: Optional[_builtins.str] = None,
...
def list_web_app_backup_configuration_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listWebAppBackupConfiguration', __args__, opts=opts, typ=ListWebAppBackupConfigurationResult)
