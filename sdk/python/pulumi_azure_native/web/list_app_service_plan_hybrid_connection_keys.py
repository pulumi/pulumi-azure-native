...
def list_app_service_plan_hybrid_connection_keys(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str namespace_name: The name of the Service Bus namespace.
    :param _builtins.str relay_name: The name of the Service Bus relay.
...
def list_app_service_plan_hybrid_connection_keys_output(name: Optional[pulumi.Input[_builtins.str]] = None,
