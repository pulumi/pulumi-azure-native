...
def list_static_site_build_function_app_settings(environment_name: Optional[builtins.str] = None,
...
def list_static_site_build_function_app_settings_output(environment_name: Optional[pulumi.Input[builtins.str]] = None,
