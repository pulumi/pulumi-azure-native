...
class GetWebAppDiagnosticLogsConfigurationSlotResult:
    ...
    """
    def __init__(__self__, application_logs=None, azure_api_version=None, detailed_error_messages=None, failed_requests_tracing=None, http_logs=None, id=None, kind=None, name=None, system_data=None, type=None):
...
def get_web_app_diagnostic_logs_configuration_slot(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will get the logging configuration for the production slot.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_web_app_diagnostic_logs_configuration_slot_output(name: Optional[pulumi.Input[_builtins.str]] = None,
