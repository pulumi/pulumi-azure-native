...
class WebAppApplicationSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] properties: Settings.
        """
