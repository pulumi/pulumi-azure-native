...
class WebAppAuthSettingsArgs:
    def __init__(__self__, *,
                 ...
                 aad_claims_authorization: Optional[pulumi.Input[builtins.str]] = None,
                 additional_login_params: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 auth_file_path: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 facebook_app_secret: Optional[pulumi.Input[builtins.str]] = None,
                 facebook_app_secret_setting_name: Optional[pulumi.Input[builtins.str]] = None,
                 facebook_o_auth_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 git_hub_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 git_hub_client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 git_hub_client_secret_setting_name: Optional[pulumi.Input[builtins.str]] = None,
                 git_hub_o_auth_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 google_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 google_client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 google_client_secret_setting_name: Optional[pulumi.Input[builtins.str]] = None,
                 google_o_auth_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 is_auth_from_file: Optional[pulumi.Input[builtins.str]] = None,
                 issuer: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input[builtins.str]] = None,
                 microsoft_account_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 microsoft_account_client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 microsoft_account_client_secret_setting_name: Optional[pulumi.Input[builtins.str]] = None,
                 microsoft_account_o_auth_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 token_store_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 twitter_consumer_key: Optional[pulumi.Input[builtins.str]] = None,
                 twitter_consumer_secret: Optional[pulumi.Input[builtins.str]] = None,
                 twitter_consumer_secret_setting_name: Optional[pulumi.Input[builtins.str]] = None,
                 unauthenticated_client_action: Optional[pulumi.Input['UnauthenticatedClientAction']] = None,
                 validate_issuer: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] aad_claims_authorization: Gets a JSON string containing the Azure AD Acl settings.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_login_params: Login parameters to send to the OpenID Connect authorization endpoint when
               a user logs in. Each parameter must be in the form "key=value".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_audiences: Allowed audience values to consider when validating JSON Web Tokens issued by 
        ...
        :param pulumi.Input[builtins.str] auth_file_path: The path of the config file containing auth settings.
        ...
        :param pulumi.Input[builtins.str] client_secret: The Client Secret of this relying party application (in Azure Active Directory, this is also referred to as the Key).
        ...
        :param pulumi.Input[builtins.str] config_version: The ConfigVersion of the Authentication / Authorization feature in use for the current app.
        ...
        :param pulumi.Input[builtins.str] facebook_app_id: The App ID of the Facebook app used for login.
               This setting is required for enabling Facebook Login.
               Facebook Login documentation: https://developers.facebook.com/docs/facebook-login
        :param pulumi.Input[builtins.str] facebook_app_secret: The App Secret of the Facebook app used for Facebook Login.
               This setting is required for enabling Facebook Login.
               Facebook Login documentation: https://developers.facebook.com/docs/facebook-login
        :param pulumi.Input[builtins.str] facebook_app_secret_setting_name: The app setting name that contains the app secret used for Facebook Login.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] facebook_o_auth_scopes: The OAuth 2.0 scopes that will be requested as part of Facebook Login authentication.
               This setting is optional.
               Facebook Login documentation: https://developers.facebook.com/docs/facebook-login
        :param pulumi.Input[builtins.str] git_hub_client_id: The Client Id of the GitHub app used for login.
               This setting is required for enabling Github login
        :param pulumi.Input[builtins.str] git_hub_client_secret: The Client Secret of the GitHub app used for Github Login.
               This setting is required for enabling Github login.
        :param pulumi.Input[builtins.str] git_hub_client_secret_setting_name: The app setting name that contains the client secret of the Github
               app used for GitHub Login.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] git_hub_o_auth_scopes: The OAuth 2.0 scopes that will be requested as part of GitHub Login authentication.
               This setting is optional
        :param pulumi.Input[builtins.str] google_client_id: The OpenID Connect Client ID for the Google web application.
               This setting is required for enabling Google Sign-In.
               Google Sign-In documentation: https://developers.google.com/identity/sign-in/web/
        :param pulumi.Input[builtins.str] google_client_secret: The client secret associated with the Google web application.
               This setting is required for enabling Google Sign-In.
               Google Sign-In documentation: https://developers.google.com/identity/sign-in/web/
        :param pulumi.Input[builtins.str] google_client_secret_setting_name: The app setting name that contains the client secret associated with 
               the Google web application.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] google_o_auth_scopes: The OAuth 2.0 scopes that will be requested as part of Google Sign-In authentication.
               This setting is optional. If not specified, "openid", "profile", and "email" are used as default scopes.
               Google Sign-In documentation: https://developers.google.com/identity/sign-in/web/
        :param pulumi.Input[builtins.str] is_auth_from_file: "true" if the auth config settings should be read from a file,
               "false" otherwise
        :param pulumi.Input[builtins.str] issuer: The OpenID Connect Issuer URI that represents the entity which issues access tokens for this application.
               When using Azure Active Directory, this value is the URI of the directory tenant, e.g. `https://sts.windows.net/{tenant-guid}/`.
               This URI is a case-sensitive identifier for the token issuer.
               More information on OpenID Connect Discovery: http://openid.net/specs/openid-connect-discovery-1_0.html
        :param pulumi.Input[builtins.str] kind: Kind of resource.
        :param pulumi.Input[builtins.str] microsoft_account_client_id: The OAuth 2.0 client ID that was created for the app used for authentication.
               This setting is required for enabling Microsoft Account authentication.
               Microsoft Account OAuth documentation: https://dev.onedrive.com/auth/msa_oauth.htm
        :param pulumi.Input[builtins.str] microsoft_account_client_secret: The OAuth 2.0 client secret that was created for the app used for authentication.
               This setting is required for enabling Microsoft Account authentication.
               Microsoft Account OAuth documentation: https://dev.onedrive.com/auth/msa_oauth.htm
        :param pulumi.Input[builtins.str] microsoft_account_client_secret_setting_name: The app setting name containing the OAuth 2.0 client secret that was created for the
               app used for authentication.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] microsoft_account_o_auth_scopes: The OAuth 2.0 scopes that will be requested as part of Microsoft Account authentication.
        ...
        :param pulumi.Input[builtins.bool] token_store_enabled: <code>true</code> to durably store platform-specific security tokens that are obtained during login flows; otherwise, <code>false</code>.
                The default is <code>false</code>.
        :param pulumi.Input[builtins.str] twitter_consumer_key: The OAuth 1.0a consumer key of the Twitter application used for sign-in.
               This setting is required for enabling Twitter Sign-In.
               Twitter Sign-In documentation: https://dev.twitter.com/web/sign-in
        :param pulumi.Input[builtins.str] twitter_consumer_secret: The OAuth 1.0a consumer secret of the Twitter application used for sign-in.
               This setting is required for enabling Twitter Sign-In.
               Twitter Sign-In documentation: https://dev.twitter.com/web/sign-in
        :param pulumi.Input[builtins.str] twitter_consumer_secret_setting_name: The app setting name that contains the OAuth 1.0a consumer secret of the Twitter
        ...
        :param pulumi.Input[builtins.bool] validate_issuer: Gets a value indicating whether the issuer should be a valid HTTPS url and be validated as such.
        """
    ...
    def aad_claims_authorization(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aad_claims_authorization(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aad_claims_authorization", value)

    @property
    @pulumi.getter(name="additionalLoginParams")
    def additional_login_params(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def additional_login_params(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def auth_file_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auth_file_path(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def facebook_app_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def facebook_app_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "facebook_app_secret", value)

    @property
    @pulumi.getter(name="facebookAppSecretSettingName")
    def facebook_app_secret_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def facebook_app_secret_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "facebook_app_secret_setting_name", value)

    @property
    @pulumi.getter(name="facebookOAuthScopes")
    def facebook_o_auth_scopes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def facebook_o_auth_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "facebook_o_auth_scopes", value)

    @property
    @pulumi.getter(name="gitHubClientId")
    def git_hub_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def git_hub_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "git_hub_client_id", value)

    @property
    @pulumi.getter(name="gitHubClientSecret")
    def git_hub_client_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def git_hub_client_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "git_hub_client_secret", value)

    @property
    @pulumi.getter(name="gitHubClientSecretSettingName")
    def git_hub_client_secret_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def git_hub_client_secret_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "git_hub_client_secret_setting_name", value)

    @property
    @pulumi.getter(name="gitHubOAuthScopes")
    def git_hub_o_auth_scopes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def git_hub_o_auth_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def google_client_secret_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def google_client_secret_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "google_client_secret_setting_name", value)

    @property
    @pulumi.getter(name="googleOAuthScopes")
    def google_o_auth_scopes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def google_o_auth_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "google_o_auth_scopes", value)

    @property
    @pulumi.getter(name="isAuthFromFile")
    def is_auth_from_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def is_auth_from_file(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def microsoft_account_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def microsoft_account_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "microsoft_account_client_id", value)

    @property
    @pulumi.getter(name="microsoftAccountClientSecret")
    def microsoft_account_client_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def microsoft_account_client_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "microsoft_account_client_secret", value)

    @property
    @pulumi.getter(name="microsoftAccountClientSecretSettingName")
    def microsoft_account_client_secret_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def microsoft_account_client_secret_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "microsoft_account_client_secret_setting_name", value)

    @property
    @pulumi.getter(name="microsoftAccountOAuthScopes")
    def microsoft_account_o_auth_scopes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def microsoft_account_o_auth_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def token_store_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def token_store_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "token_store_enabled", value)

    @property
    @pulumi.getter(name="twitterConsumerKey")
    def twitter_consumer_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def twitter_consumer_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "twitter_consumer_key", value)

    @property
    @pulumi.getter(name="twitterConsumerSecret")
    def twitter_consumer_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def twitter_consumer_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "twitter_consumer_secret", value)

    @property
    @pulumi.getter(name="twitterConsumerSecretSettingName")
    def twitter_consumer_secret_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def twitter_consumer_secret_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def validate_issuer(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def validate_issuer(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WebAppAuthSettings(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="aadClaimsAuthorization")
    def aad_claims_authorization(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Gets a JSON string containing the Azure AD Acl settings.
        """
        return pulumi.get(self, "aad_claims_authorization")
    ...
    @property
    @pulumi.getter(name="additionalLoginParams")
    def additional_login_params(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Login parameters to send to the OpenID Connect authorization endpoint when
        a user logs in. Each parameter must be in the form "key=value".
        """
    ...
    @property
    @pulumi.getter(name="allowedAudiences")
    def allowed_audiences(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Allowed audience values to consider when validating JSON Web Tokens issued by 
        Azure Active Directory. Note that the <code>ClientID</code> value is always considered an
        allowed audience, regardless of this setting.
    ...
    @property
    @pulumi.getter(name="allowedExternalRedirectUrls")
    def allowed_external_redirect_urls(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        External URLs that can be redirected to as part of logging in or logging out of the app. Note that the query string part of the URL is ignored.
        This is an advanced setting typically only needed by Windows Store application backends.
        Note that URLs within the current domain are always implicitly allowed.
    ...
    @property
    @pulumi.getter(name="authFilePath")
    def auth_file_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The path of the config file containing auth settings.
        If the path is relative, base will the site's root directory.
        """
    ...
    @property
    @pulumi.getter(name="clientSecretCertificateThumbprint")
    def client_secret_certificate_thumbprint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An alternative to the client secret, that is the thumbprint of a certificate used for signing purposes. This property acts as
        a replacement for the Client Secret. It is also optional.
        """
    ...
    @property
    @pulumi.getter(name="clientSecretSettingName")
    def client_secret_setting_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The app setting name that contains the client secret of the relying party application.
        """
        return pulumi.get(self, "client_secret_setting_name")
    ...
    @property
    @pulumi.getter(name="configVersion")
    def config_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ConfigVersion of the Authentication / Authorization feature in use for the current app.
        The setting in this value can control the behavior of the control plane for Authentication / Authorization.
        """
    ...
    @property
    @pulumi.getter(name="defaultProvider")
    def default_provider(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default authentication provider to use when multiple providers are configured.
        This setting is only needed if multiple providers are configured and the unauthenticated client
        action is set to "RedirectToLoginPage".
    ...
    @property
    @pulumi.getter(name="facebookAppSecret")
    def facebook_app_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The App Secret of the Facebook app used for Facebook Login.
        This setting is required for enabling Facebook Login.
        Facebook Login documentation: https://developers.facebook.com/docs/facebook-login
    ...
    @property
    @pulumi.getter(name="facebookAppSecretSettingName")
    def facebook_app_secret_setting_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The app setting name that contains the app secret used for Facebook Login.
        """
        return pulumi.get(self, "facebook_app_secret_setting_name")
    ...
    @property
    @pulumi.getter(name="facebookOAuthScopes")
    def facebook_o_auth_scopes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The OAuth 2.0 scopes that will be requested as part of Facebook Login authentication.
        This setting is optional.
        Facebook Login documentation: https://developers.facebook.com/docs/facebook-login
    ...
    @property
    @pulumi.getter(name="gitHubClientId")
    def git_hub_client_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Client Id of the GitHub app used for login.
        This setting is required for enabling Github login
        """
    ...
    @property
    @pulumi.getter(name="gitHubClientSecret")
    def git_hub_client_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Client Secret of the GitHub app used for Github Login.
        This setting is required for enabling Github login.
        """
    ...
    @property
    @pulumi.getter(name="gitHubClientSecretSettingName")
    def git_hub_client_secret_setting_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The app setting name that contains the client secret of the Github
        app used for GitHub Login.
        """
    ...
    @property
    @pulumi.getter(name="gitHubOAuthScopes")
    def git_hub_o_auth_scopes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The OAuth 2.0 scopes that will be requested as part of GitHub Login authentication.
        This setting is optional
        """
    ...
    @property
    @pulumi.getter(name="googleClientSecret")
    def google_client_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The client secret associated with the Google web application.
        This setting is required for enabling Google Sign-In.
        Google Sign-In documentation: https://developers.google.com/identity/sign-in/web/
    ...
    @property
    @pulumi.getter(name="googleClientSecretSettingName")
    def google_client_secret_setting_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The app setting name that contains the client secret associated with 
        the Google web application.
        """
    ...
    @property
    @pulumi.getter(name="googleOAuthScopes")
    def google_o_auth_scopes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The OAuth 2.0 scopes that will be requested as part of Google Sign-In authentication.
        This setting is optional. If not specified, "openid", "profile", and "email" are used as default scopes.
        Google Sign-In documentation: https://developers.google.com/identity/sign-in/web/
    ...
    @property
    @pulumi.getter(name="isAuthFromFile")
    def is_auth_from_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        "true" if the auth config settings should be read from a file,
        "false" otherwise
        """
    ...
    @property
    @pulumi.getter(name="microsoftAccountClientId")
    def microsoft_account_client_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OAuth 2.0 client ID that was created for the app used for authentication.
        This setting is required for enabling Microsoft Account authentication.
        Microsoft Account OAuth documentation: https://dev.onedrive.com/auth/msa_oauth.htm
    ...
    @property
    @pulumi.getter(name="microsoftAccountClientSecret")
    def microsoft_account_client_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OAuth 2.0 client secret that was created for the app used for authentication.
        This setting is required for enabling Microsoft Account authentication.
        Microsoft Account OAuth documentation: https://dev.onedrive.com/auth/msa_oauth.htm
    ...
    @property
    @pulumi.getter(name="microsoftAccountClientSecretSettingName")
    def microsoft_account_client_secret_setting_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The app setting name containing the OAuth 2.0 client secret that was created for the
        app used for authentication.
        """
    ...
    @property
    @pulumi.getter(name="microsoftAccountOAuthScopes")
    def microsoft_account_o_auth_scopes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The OAuth 2.0 scopes that will be requested as part of Microsoft Account authentication.
        This setting is optional. If not specified, "wl.basic" is used as the default scope.
        Microsoft Account Scopes and permissions documentation: https://msdn.microsoft.com/en-us/library/dn631845.aspx
    ...
    @property
    @pulumi.getter(name="tokenRefreshExtensionHours")
    def token_refresh_extension_hours(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The number of hours after session token expiration that a session token can be used to
        call the token refresh API. The default is 72 hours.
        """
    ...
    @property
    @pulumi.getter(name="tokenStoreEnabled")
    def token_store_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        <code>true</code> to durably store platform-specific security tokens that are obtained during login flows; otherwise, <code>false</code>.
         The default is <code>false</code>.
        """
    ...
    @property
    @pulumi.getter(name="twitterConsumerKey")
    def twitter_consumer_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OAuth 1.0a consumer key of the Twitter application used for sign-in.
        This setting is required for enabling Twitter Sign-In.
        Twitter Sign-In documentation: https://dev.twitter.com/web/sign-in
    ...
    @property
    @pulumi.getter(name="twitterConsumerSecret")
    def twitter_consumer_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OAuth 1.0a consumer secret of the Twitter application used for sign-in.
        This setting is required for enabling Twitter Sign-In.
        Twitter Sign-In documentation: https://dev.twitter.com/web/sign-in
    ...
    @property
    @pulumi.getter(name="twitterConsumerSecretSettingName")
    def twitter_consumer_secret_setting_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The app setting name that contains the OAuth 1.0a consumer secret of the Twitter
        application used for sign-in.
        """
    ...
    @property
    @pulumi.getter(name="unauthenticatedClientAction")
    def unauthenticated_client_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The action to take when an unauthenticated client attempts to access the app.
        """
        return pulumi.get(self, "unauthenticated_client_action")
    ...
    @property
    @pulumi.getter(name="validateIssuer")
    def validate_issuer(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Gets a value indicating whether the issuer should be a valid HTTPS url and be validated as such.
        """
        return pulumi.get(self, "validate_issuer")
