...
class GetWebAppScmAllowedSlotResult:
    ...
    """
    def __init__(__self__, allow=None, azure_api_version=None, id=None, kind=None, name=None, system_data=None, type=None):
...
def get_web_app_scm_allowed_slot(name: Optional[_builtins.str] = None,
...
def get_web_app_scm_allowed_slot_output(name: Optional[pulumi.Input[_builtins.str]] = None,
