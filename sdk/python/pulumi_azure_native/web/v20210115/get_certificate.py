...
warnings.warn("""azure-native:web/v20210115:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:Certificate to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_certificate(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: azure-native:web/v20210115:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:Certificate to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
