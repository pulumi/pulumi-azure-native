...
warnings.warn("""azure-native:web/v20210115:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAuthSettingsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAuthSettingsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 validate_issuer: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppAuthSettingsSlot is deprecated: azure-native:web/v20210115:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAuthSettingsSlot to guarantee forwards compatibility.""")
        ...
        super(WebAppAuthSettingsSlot, __self__).__init__(
            'azure-native:web/v20210115:WebAppAuthSettingsSlot',
            resource_name,
            __props__,
            opts)
