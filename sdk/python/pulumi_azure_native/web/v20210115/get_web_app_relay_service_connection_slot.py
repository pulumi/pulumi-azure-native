...
def get_web_app_relay_service_connection_slot(entity_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_relay_service_connection_slot is deprecated: azure-native:web/v20210115:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210115:getWebAppRelayServiceConnectionSlot', __args__, opts=opts, typ=GetWebAppRelayServiceConnectionSlotResult).value
