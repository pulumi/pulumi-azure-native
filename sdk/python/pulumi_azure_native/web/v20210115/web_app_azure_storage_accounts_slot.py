...
warnings.warn("""azure-native:web/v20210115:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.""", DeprecationWarning)
