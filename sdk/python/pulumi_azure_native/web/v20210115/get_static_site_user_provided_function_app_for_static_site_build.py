...
warnings.warn("""azure-native:web/v20210115:StaticSiteUserProvidedFunctionAppForStaticSiteBuild is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSiteUserProvidedFunctionAppForStaticSiteBuild to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_static_site_user_provided_function_app_for_static_site_build(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site_user_provided_function_app_for_static_site_build is deprecated: azure-native:web/v20210115:StaticSiteUserProvidedFunctionAppForStaticSiteBuild is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSiteUserProvidedFunctionAppForStaticSiteBuild to guarantee forwards compatibility.""")
    __args__ = dict()
