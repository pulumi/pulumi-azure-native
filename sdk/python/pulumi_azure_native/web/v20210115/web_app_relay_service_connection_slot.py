...
warnings.warn("""azure-native:web/v20210115:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppRelayServiceConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppRelayServiceConnectionSlot is deprecated: azure-native:web/v20210115:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.""")
