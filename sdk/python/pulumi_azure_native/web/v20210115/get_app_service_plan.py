...
warnings.warn("""azure-native:web/v20210115:AppServicePlan is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_app_service_plan(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app_service_plan is deprecated: azure-native:web/v20210115:AppServicePlan is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
