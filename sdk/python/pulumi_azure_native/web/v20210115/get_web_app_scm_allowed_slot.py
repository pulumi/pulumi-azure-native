...
def get_web_app_scm_allowed_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210115:getWebAppScmAllowedSlot', __args__, opts=opts, typ=GetWebAppScmAllowedSlotResult).value
...
def get_web_app_scm_allowed_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['slot'] = slot
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210115:getWebAppScmAllowedSlot', __args__, opts=opts, typ=GetWebAppScmAllowedSlotResult)
