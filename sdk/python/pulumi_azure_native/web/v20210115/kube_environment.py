...
class KubeEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20210115:KubeEnvironment"), pulumi.Alias(type_="azure-native:web:KubeEnvironment"), pulumi.Alias(type_="azure-nextgen:web:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20210101:KubeEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20210101:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20210201:KubeEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20210201:KubeEnvironment")])
