...
warnings.warn("""azure-native:web/v20210115:WebAppRelayServiceConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppRelayServiceConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_relay_service_connection(entity_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_relay_service_connection is deprecated: azure-native:web/v20210115:WebAppRelayServiceConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppRelayServiceConnection to guarantee forwards compatibility.""")
    __args__ = dict()
