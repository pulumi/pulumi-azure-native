...
warnings.warn("""azure-native:web/v20210115:WebAppAuthSettingsV2Slot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:WebAppAuthSettingsV2Slot to guarantee forwards compatibility.""", DeprecationWarning)
