...
warnings.warn("""azure-native:web/v20210115:StaticSiteCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSiteCustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
class StaticSiteCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 validation_method: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StaticSiteCustomDomain is deprecated: azure-native:web/v20210115:StaticSiteCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSiteCustomDomain to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20201201:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20210101:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20210201:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20210301:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20220301:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20220901:StaticSiteCustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StaticSiteCustomDomain, __self__).__init__(
            'azure-native:web/v20210115:StaticSiteCustomDomain',
            resource_name,
            __props__,
            opts)
