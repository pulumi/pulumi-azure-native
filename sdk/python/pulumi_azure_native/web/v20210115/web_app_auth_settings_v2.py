...
warnings.warn("""azure-native:web/v20210115:WebAppAuthSettingsV2 is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:WebAppAuthSettingsV2 to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAuthSettingsV2(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppAuthSettingsV2 is deprecated: azure-native:web/v20210115:WebAppAuthSettingsV2 is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:WebAppAuthSettingsV2 to guarantee forwards compatibility.""")
