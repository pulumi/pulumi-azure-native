...
class WebAppHybridConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppHybridConnectionSlot is deprecated: azure-native:web/v20210115:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHybridConnectionSlot to guarantee forwards compatibility.""")
