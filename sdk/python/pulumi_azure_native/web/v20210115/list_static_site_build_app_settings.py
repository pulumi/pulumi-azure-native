...
def list_static_site_build_app_settings(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210115:listStaticSiteBuildAppSettings', __args__, opts=opts, typ=ListStaticSiteBuildAppSettingsResult).value
...
def list_static_site_build_app_settings_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210115:listStaticSiteBuildAppSettings', __args__, opts=opts, typ=ListStaticSiteBuildAppSettingsResult)
