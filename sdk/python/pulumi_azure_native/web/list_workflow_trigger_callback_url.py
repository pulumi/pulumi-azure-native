...
def list_workflow_trigger_callback_url(name: Optional[builtins.str] = None,
...
def list_workflow_trigger_callback_url_output(name: Optional[pulumi.Input[builtins.str]] = None,
