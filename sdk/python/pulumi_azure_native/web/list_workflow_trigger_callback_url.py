...
def list_workflow_trigger_callback_url(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:listWorkflowTriggerCallbackUrl', __args__, opts=opts, typ=ListWorkflowTriggerCallbackUrlResult).value
...
def list_workflow_trigger_callback_url_output(name: Optional[pulumi.Input[_builtins.str]] = None,
