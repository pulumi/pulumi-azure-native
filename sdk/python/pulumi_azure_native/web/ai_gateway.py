...
class AiGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the AI gateway
...
@pulumi.type_token("azure-native:web:AiGateway")
class AiGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AiGateway':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AiGatewayPropertiesResponse']:
        """
