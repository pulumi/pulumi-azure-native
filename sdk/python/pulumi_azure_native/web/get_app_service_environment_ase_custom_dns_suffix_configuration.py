...
def get_app_service_environment_ase_custom_dns_suffix_configuration(name: Optional[builtins.str] = None,
...
def get_app_service_environment_ase_custom_dns_suffix_configuration_output(name: Optional[pulumi.Input[builtins.str]] = None,
