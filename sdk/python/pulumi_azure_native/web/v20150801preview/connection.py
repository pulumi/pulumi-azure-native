...
class Connection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801preview:Connection"), pulumi.Alias(type_="azure-native:web:Connection"), pulumi.Alias(type_="azure-nextgen:web:Connection"), pulumi.Alias(type_="azure-native:web/latest:Connection"), pulumi.Alias(type_="azure-nextgen:web/latest:Connection"), pulumi.Alias(type_="azure-native:web/v20160601:Connection"), pulumi.Alias(type_="azure-nextgen:web/v20160601:Connection")])
