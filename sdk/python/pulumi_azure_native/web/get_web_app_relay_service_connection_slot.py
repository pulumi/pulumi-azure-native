...
def get_web_app_relay_service_connection_slot(entity_name: Optional[_builtins.str] = None,
...
def get_web_app_relay_service_connection_slot_output(entity_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
