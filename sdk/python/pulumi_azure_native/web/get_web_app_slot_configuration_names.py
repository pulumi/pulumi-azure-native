...
class GetWebAppSlotConfigurationNamesResult:
    ...
    """
    def __init__(__self__, app_setting_names=None, azure_api_version=None, azure_storage_config_names=None, connection_string_names=None, id=None, kind=None, name=None, system_data=None, type=None):
...
def get_web_app_slot_configuration_names(name: Optional[_builtins.str] = None,
