...
def get_web_app_source_control_slot(name: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will get the source control configuration for the production slot.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_web_app_source_control_slot_output(name: Optional[pulumi.Input[builtins.str]] = None,
