...
def list_web_app_sync_function_triggers(name: Optional[builtins.str] = None,
...
def list_web_app_sync_function_triggers_output(name: Optional[pulumi.Input[builtins.str]] = None,
