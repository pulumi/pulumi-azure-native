...
def list_web_app_sync_function_triggers(name: Optional[_builtins.str] = None,
...
def list_web_app_sync_function_triggers_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listWebAppSyncFunctionTriggers', __args__, opts=opts, typ=ListWebAppSyncFunctionTriggersResult)
