...
def list_static_site_app_settings(name: Optional[_builtins.str] = None,
...
def list_static_site_app_settings_output(name: Optional[pulumi.Input[_builtins.str]] = None,
