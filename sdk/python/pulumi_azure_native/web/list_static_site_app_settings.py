...
def list_static_site_app_settings(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:listStaticSiteAppSettings', __args__, opts=opts, typ=ListStaticSiteAppSettingsResult).value
...
@_utilities.lift_output_func(list_static_site_app_settings)
