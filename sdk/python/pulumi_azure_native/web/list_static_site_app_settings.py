...
def list_static_site_app_settings(name: Optional[builtins.str] = None,
...
def list_static_site_app_settings_output(name: Optional[pulumi.Input[builtins.str]] = None,
