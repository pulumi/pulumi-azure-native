...
class WebAppAuthSettingsV2(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20200601:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20230101:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20231201:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web/v20240401:WebAppAuthSettingsV2"), pulumi.Alias(type_="azure-native:web:WebAppAuthSettingsV2")])
