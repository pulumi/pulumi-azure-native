...
class WebAppDiagnosticLogsConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(application_logs, ApplicationLogsConfigArgs):
            ...
            if not isinstance(detailed_error_messages, EnabledConfigArgs):
            ...
            if not isinstance(failed_requests_tracing, EnabledConfigArgs):
            ...
            if not isinstance(http_logs, HttpLogsConfigArgs):
