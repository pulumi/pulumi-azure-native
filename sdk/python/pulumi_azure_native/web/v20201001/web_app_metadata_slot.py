...
class WebAppMetadataSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppMetadataSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppMetadataSlot")])
