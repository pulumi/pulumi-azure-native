...
class WebAppVnetConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppVnetConnection"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppVnetConnection")])
