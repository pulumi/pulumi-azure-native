...
class WebAppSitePushSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppSitePushSettings"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppSitePushSettings")])
