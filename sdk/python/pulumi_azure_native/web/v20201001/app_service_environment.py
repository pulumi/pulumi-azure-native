...
class AppServiceEnvironmentArgs:
    ...
    def _configure(
        ...
        if 'workerPools' in kwargs:
            worker_pools = kwargs['workerPools']
        if 'apiManagementAccountId' in kwargs:
        ...
        if 'dynamicCacheEnabled' in kwargs:
        ...
        if 'vnetResourceGroupName' in kwargs:
            vnet_resource_group_name = kwargs['vnetResourceGroupName']
        if 'vnetSubnetName' in kwargs:
