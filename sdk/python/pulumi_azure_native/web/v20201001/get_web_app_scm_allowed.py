...
def get_web_app_scm_allowed(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20201001:getWebAppScmAllowed', __args__, opts=opts, typ=GetWebAppScmAllowedResult).value
...
def get_web_app_scm_allowed_output(name: Optional[pulumi.Input[str]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWebAppScmAllowedResult]:
    """
    Returns whether Scm basic auth is allowed on the site or not.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20201001:getWebAppScmAllowed', __args__, opts=opts, typ=GetWebAppScmAllowedResult)
    return __ret__.apply(lambda __response__: GetWebAppScmAllowedResult(
