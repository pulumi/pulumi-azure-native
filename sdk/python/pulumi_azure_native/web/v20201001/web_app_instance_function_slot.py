...
class WebAppInstanceFunctionSlotArgs:
    def __init__(__self__, *,
        ...
        """
        WebAppInstanceFunctionSlotArgs._configure(
    ...
    def _configure(
        ...
        if config_href is None and 'configHref' in kwargs:
        ...
        if invoke_url_template is None and 'invokeUrlTemplate' in kwargs:
            invoke_url_template = kwargs['invokeUrlTemplate']
        if is_disabled is None and 'isDisabled' in kwargs:
            is_disabled = kwargs['isDisabled']
        if script_href is None and 'scriptHref' in kwargs:
            script_href = kwargs['scriptHref']
        if script_root_path_href is None and 'scriptRootPathHref' in kwargs:
            script_root_path_href = kwargs['scriptRootPathHref']
        if secrets_file_href is None and 'secretsFileHref' in kwargs:
            secrets_file_href = kwargs['secretsFileHref']
        if test_data is None and 'testData' in kwargs:
            test_data = kwargs['testData']
        if test_data_href is None and 'testDataHref' in kwargs:
            test_data_href = kwargs['testDataHref']
        ...
        if invoke_url_template is not None:
            _setter("invoke_url_template", invoke_url_template)
        ...
        if test_data_href is not None:
            _setter("test_data_href", test_data_href)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WebAppInstanceFunctionSlotArgs._configure(_setter, **kwargs)
