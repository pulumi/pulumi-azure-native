...
class WebAppAuthSettingsSlotArgs:
    ...
    def _configure(
        ...
        if 'aadClaimsAuthorization' in kwargs:
        ...
        if 'twitterConsumerKey' in kwargs:
            twitter_consumer_key = kwargs['twitterConsumerKey']
        if 'twitterConsumerSecret' in kwargs:
            twitter_consumer_secret = kwargs['twitterConsumerSecret']
        if 'twitterConsumerSecretSettingName' in kwargs:
