...
class WebAppAuthSettingsSlotArgs:
    ...
    def _configure(
        ...
        if aad_claims_authorization is None and 'aadClaimsAuthorization' in kwargs:
            aad_claims_authorization = kwargs['aadClaimsAuthorization']
        ...
        if auth_file_path is None and 'authFilePath' in kwargs:
            auth_file_path = kwargs['authFilePath']
        ...
        if facebook_app_id is None and 'facebookAppId' in kwargs:
            facebook_app_id = kwargs['facebookAppId']
        if facebook_app_secret is None and 'facebookAppSecret' in kwargs:
            facebook_app_secret = kwargs['facebookAppSecret']
        if facebook_app_secret_setting_name is None and 'facebookAppSecretSettingName' in kwargs:
            facebook_app_secret_setting_name = kwargs['facebookAppSecretSettingName']
        if facebook_o_auth_scopes is None and 'facebookOAuthScopes' in kwargs:
            facebook_o_auth_scopes = kwargs['facebookOAuthScopes']
        if git_hub_client_id is None and 'gitHubClientId' in kwargs:
            git_hub_client_id = kwargs['gitHubClientId']
        if git_hub_client_secret is None and 'gitHubClientSecret' in kwargs:
            git_hub_client_secret = kwargs['gitHubClientSecret']
        if git_hub_client_secret_setting_name is None and 'gitHubClientSecretSettingName' in kwargs:
            git_hub_client_secret_setting_name = kwargs['gitHubClientSecretSettingName']
        if git_hub_o_auth_scopes is None and 'gitHubOAuthScopes' in kwargs:
            git_hub_o_auth_scopes = kwargs['gitHubOAuthScopes']
        if google_client_id is None and 'googleClientId' in kwargs:
            google_client_id = kwargs['googleClientId']
        if google_client_secret is None and 'googleClientSecret' in kwargs:
            google_client_secret = kwargs['googleClientSecret']
        if google_client_secret_setting_name is None and 'googleClientSecretSettingName' in kwargs:
            google_client_secret_setting_name = kwargs['googleClientSecretSettingName']
        if google_o_auth_scopes is None and 'googleOAuthScopes' in kwargs:
            google_o_auth_scopes = kwargs['googleOAuthScopes']
        if is_auth_from_file is None and 'isAuthFromFile' in kwargs:
            is_auth_from_file = kwargs['isAuthFromFile']
        if microsoft_account_client_id is None and 'microsoftAccountClientId' in kwargs:
            microsoft_account_client_id = kwargs['microsoftAccountClientId']
        if microsoft_account_client_secret is None and 'microsoftAccountClientSecret' in kwargs:
            microsoft_account_client_secret = kwargs['microsoftAccountClientSecret']
        if microsoft_account_client_secret_setting_name is None and 'microsoftAccountClientSecretSettingName' in kwargs:
            microsoft_account_client_secret_setting_name = kwargs['microsoftAccountClientSecretSettingName']
        if microsoft_account_o_auth_scopes is None and 'microsoftAccountOAuthScopes' in kwargs:
            microsoft_account_o_auth_scopes = kwargs['microsoftAccountOAuthScopes']
        ...
        if twitter_consumer_key is None and 'twitterConsumerKey' in kwargs:
            twitter_consumer_key = kwargs['twitterConsumerKey']
        if twitter_consumer_secret is None and 'twitterConsumerSecret' in kwargs:
            twitter_consumer_secret = kwargs['twitterConsumerSecret']
        if twitter_consumer_secret_setting_name is None and 'twitterConsumerSecretSettingName' in kwargs:
            twitter_consumer_secret_setting_name = kwargs['twitterConsumerSecretSettingName']
        ...
        if validate_issuer is None and 'validateIssuer' in kwargs:
            validate_issuer = kwargs['validateIssuer']
