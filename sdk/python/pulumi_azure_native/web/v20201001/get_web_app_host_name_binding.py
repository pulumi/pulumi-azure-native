...
def get_web_app_host_name_binding(host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20201001:getWebAppHostNameBinding', __args__, opts=opts, typ=GetWebAppHostNameBindingResult).value
...
def get_web_app_host_name_binding_output(host_name: Optional[pulumi.Input[str]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWebAppHostNameBindingResult]:
    """
    Get the named hostname binding for an app (or deployment slot, if specified).
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20201001:getWebAppHostNameBinding', __args__, opts=opts, typ=GetWebAppHostNameBindingResult)
