...
def get_app_service_environment(name: Optional[_builtins.str] = None,
...
def get_app_service_environment_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
