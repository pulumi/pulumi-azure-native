...
def get_web_app_hybrid_connection_slot(name: Optional[builtins.str] = None,
...
def get_web_app_hybrid_connection_slot_output(name: Optional[pulumi.Input[builtins.str]] = None,
