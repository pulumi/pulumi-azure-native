...
class GetStaticSiteUserProvidedFunctionAppForStaticSiteBuildResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, created_on=None, function_app_region=None, function_app_resource_id=None, id=None, kind=None, name=None, system_data=None, type=None):
...
def get_static_site_user_provided_function_app_for_static_site_build(environment_name: Optional[_builtins.str] = None,
                                                                     function_app_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str function_app_name: Name of the function app registered with the static site build.
