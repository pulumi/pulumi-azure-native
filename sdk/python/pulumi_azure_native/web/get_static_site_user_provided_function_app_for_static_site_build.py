...
def get_static_site_user_provided_function_app_for_static_site_build(environment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str environment_name: The stage site identifier.
    :param builtins.str function_app_name: Name of the function app registered with the static site build.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:getStaticSiteUserProvidedFunctionAppForStaticSiteBuild', __args__, opts=opts, typ=GetStaticSiteUserProvidedFunctionAppForStaticSiteBuildResult).value
...
def get_static_site_user_provided_function_app_for_static_site_build_output(environment_name: Optional[pulumi.Input[builtins.str]] = None,
                                                                            function_app_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getStaticSiteUserProvidedFunctionAppForStaticSiteBuild', __args__, opts=opts, typ=GetStaticSiteUserProvidedFunctionAppForStaticSiteBuildResult)
