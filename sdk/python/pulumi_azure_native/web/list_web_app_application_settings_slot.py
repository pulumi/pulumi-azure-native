...
def list_web_app_application_settings_slot(name: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will get the application settings for the production slot.
    """
    __args__ = dict()
    __args__['name'] = name
...
def list_web_app_application_settings_slot_output(name: Optional[pulumi.Input[builtins.str]] = None,
