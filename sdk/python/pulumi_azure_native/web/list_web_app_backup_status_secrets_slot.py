...
def list_web_app_backup_status_secrets_slot(backup_id: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of web app slot. If not specified then will default to production slot.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:listWebAppBackupStatusSecretsSlot', __args__, opts=opts, typ=ListWebAppBackupStatusSecretsSlotResult).value
...
def list_web_app_backup_status_secrets_slot_output(backup_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listWebAppBackupStatusSecretsSlot', __args__, opts=opts, typ=ListWebAppBackupStatusSecretsSlotResult)
