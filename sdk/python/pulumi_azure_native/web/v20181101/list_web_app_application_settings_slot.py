...
def list_web_app_application_settings_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20181101:listWebAppApplicationSettingsSlot', __args__, opts=opts, typ=ListWebAppApplicationSettingsSlotResult).value
...
def list_web_app_application_settings_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20181101:listWebAppApplicationSettingsSlot', __args__, opts=opts, typ=ListWebAppApplicationSettingsSlotResult)
