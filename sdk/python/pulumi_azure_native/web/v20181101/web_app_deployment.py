...
warnings.warn("""azure-native:web/v20181101:WebAppDeployment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDeployment to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 status: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppDeployment is deprecated: azure-native:web/v20181101:WebAppDeployment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDeployment to guarantee forwards compatibility.""")
