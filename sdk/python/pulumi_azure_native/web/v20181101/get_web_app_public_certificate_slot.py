...
def get_web_app_public_certificate_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_public_certificate_slot is deprecated: azure-native:web/v20181101:WebAppPublicCertificateSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPublicCertificateSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
