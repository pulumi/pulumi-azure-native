...
class WebAppInstanceFunctionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 test_data: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppInstanceFunctionSlot is deprecated: azure-native:web/v20181101:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppInstanceFunctionSlot to guarantee forwards compatibility.""")
