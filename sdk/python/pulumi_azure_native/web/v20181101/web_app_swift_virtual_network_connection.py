...
class WebAppSwiftVirtualNetworkConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 swift_supported: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSwiftVirtualNetworkConnection is deprecated: azure-native:web/v20181101:WebAppSwiftVirtualNetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnection to guarantee forwards compatibility.""")
