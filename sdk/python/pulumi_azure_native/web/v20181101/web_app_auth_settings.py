...
warnings.warn("""azure-native:web/v20181101:WebAppAuthSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppAuthSettings to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAuthSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 validate_issuer: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppAuthSettings is deprecated: azure-native:web/v20181101:WebAppAuthSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppAuthSettings to guarantee forwards compatibility.""")
