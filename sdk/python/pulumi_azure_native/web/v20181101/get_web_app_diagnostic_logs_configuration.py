...
warnings.warn("""azure-native:web/v20181101:WebAppDiagnosticLogsConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDiagnosticLogsConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_diagnostic_logs_configuration(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_diagnostic_logs_configuration is deprecated: azure-native:web/v20181101:WebAppDiagnosticLogsConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDiagnosticLogsConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
