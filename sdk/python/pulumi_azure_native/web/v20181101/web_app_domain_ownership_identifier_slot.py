...
class WebAppDomainOwnershipIdentifierSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppDomainOwnershipIdentifierSlot")])
