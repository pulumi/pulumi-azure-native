...
class WebAppDomainOwnershipIdentifierSlotArgs:
    def __init__(__self__, *,
        ...
        """
        WebAppDomainOwnershipIdentifierSlotArgs._configure(
    ...
    def _configure(
        ...
        if domain_ownership_identifier_name is None and 'domainOwnershipIdentifierName' in kwargs:
            domain_ownership_identifier_name = kwargs['domainOwnershipIdentifierName']

        _setter("name", name)
        _setter("resource_group_name", resource_group_name)
        _setter("slot", slot)
        if domain_ownership_identifier_name is not None:
            _setter("domain_ownership_identifier_name", domain_ownership_identifier_name)
        if id is not None:
            _setter("id", id)
        if kind is not None:
            _setter("kind", kind)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WebAppDomainOwnershipIdentifierSlotArgs._configure(_setter, **kwargs)
