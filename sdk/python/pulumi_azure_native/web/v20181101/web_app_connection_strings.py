...
warnings.warn("""azure-native:web/v20181101:WebAppConnectionStrings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppConnectionStrings to guarantee forwards compatibility.""", DeprecationWarning)
