...
warnings.warn("""azure-native:web/v20181101:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_relay_service_connection_slot(entity_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_relay_service_connection_slot is deprecated: azure-native:web/v20181101:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.""")
    __args__ = dict()
