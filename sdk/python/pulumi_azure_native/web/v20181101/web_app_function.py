...
warnings.warn("""azure-native:web/v20181101:WebAppFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppFunction to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppFunction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 test_data: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppFunction is deprecated: azure-native:web/v20181101:WebAppFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppFunction to guarantee forwards compatibility.""")
