...
warnings.warn("""azure-native:web/v20181101:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAzureStorageAccountsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppAzureStorageAccountsSlot is deprecated: azure-native:web/v20181101:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.""")
