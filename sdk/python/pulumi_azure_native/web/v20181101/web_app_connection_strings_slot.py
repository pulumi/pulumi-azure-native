...
warnings.warn("""azure-native:web/v20181101:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppConnectionStringsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppConnectionStringsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppConnectionStringsSlot is deprecated: azure-native:web/v20181101:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppConnectionStringsSlot to guarantee forwards compatibility.""")
