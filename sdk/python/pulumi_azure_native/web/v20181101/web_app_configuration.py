...
class WebAppConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 azure_storage_accounts: Optional[pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['AzureStorageInfoValueArgs']]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['AzureStorageInfoValueArgs']]]] azure_storage_accounts: User-provided Azure storage accounts.
        ...
        if opts.id is None:
            ...
            __props__['azure_storage_accounts'] = azure_storage_accounts
            ...
            __props__['reserved_instance_count'] = reserved_instance_count
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/latest:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppConfiguration"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppConfiguration"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppConfiguration, __self__).__init__(
            'azure-native:web/v20181101:WebAppConfiguration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__["azure_storage_accounts"] = None
        ...
        __props__["reserved_instance_count"] = None
    ...
    def azure_storage_accounts(self) -> pulumi.Output[Optional[Mapping[str, 'outputs.AzureStorageInfoValueResponse']]]:
        """
    ...
    def reserved_instance_count(self) -> pulumi.Output[Optional[int]]:
        """
