...
warnings.warn("""azure-native:web/v20181101:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPremierAddOnSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppPremierAddOnSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WebAppPremierAddOnSlot, __self__).__init__(
            'azure-native:web/v20181101:WebAppPremierAddOnSlot',
            resource_name,
            __props__,
            opts)
