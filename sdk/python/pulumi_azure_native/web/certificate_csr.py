...
class CertificateCsr(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:CertificateCsr"), pulumi.Alias(type_="azure-native:web/latest:CertificateCsr"), pulumi.Alias(type_="azure-nextgen:web/latest:CertificateCsr"), pulumi.Alias(type_="azure-native:web/v20150801:CertificateCsr"), pulumi.Alias(type_="azure-nextgen:web/v20150801:CertificateCsr")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CertificateCsr, __self__).__init__(
            'azure-native:web:CertificateCsr',
            resource_name,
            __props__,
            opts)
