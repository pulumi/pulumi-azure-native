...
def list_web_app_function_secrets(function_name: Optional[_builtins.str] = None,
...
def list_web_app_function_secrets_output(function_name: Optional[pulumi.Input[_builtins.str]] = None,
