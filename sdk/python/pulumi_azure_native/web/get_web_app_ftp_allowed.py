...
def get_web_app_ftp_allowed(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:getWebAppFtpAllowed', __args__, opts=opts, typ=GetWebAppFtpAllowedResult).value
...
def get_web_app_ftp_allowed_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getWebAppFtpAllowed', __args__, opts=opts, typ=GetWebAppFtpAllowedResult)
