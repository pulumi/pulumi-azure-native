...
class ConnectionGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connection_gateway = azure_native.web.v20160601.ConnectionGateway("connectionGateway",
            connection_gateway_name="test123",
            properties=azure_native.web.v20160601.ConnectionGatewayDefinitionResponsePropertiesArgs(
                backend_uri="https://WABI-WEST-US-redirect.analysis.windows.net",
                connection_gateway_installation=azure_native.web.v20160601.ConnectionGatewayReferenceArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:ConnectionGateway")])
