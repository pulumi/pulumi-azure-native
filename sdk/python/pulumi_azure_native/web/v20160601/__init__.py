...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:web/v20160601:Connection":
                return Connection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160601:ConnectionGateway":
                return ConnectionGateway(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160601:CustomApi":
    ...
    pulumi.runtime.register_resource_module("azure-native", "web/v20160601", _module_instance)
