...
class AppServiceEnvironmentAseCustomDnsSuffixConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="certificateUrl")
    def certificate_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL referencing the Azure Key Vault certificate secret that should be used as the default SSL/TLS certificate for sites with the custom domain suffix.
        """
        return pulumi.get(self, "certificate_url")
    ...
    @property
    @pulumi.getter(name="dnsSuffix")
    def dns_suffix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default custom domain suffix to use for all sites deployed on the ASE.
        """
        return pulumi.get(self, "dns_suffix")
    ...
    @property
    @pulumi.getter(name="keyVaultReferenceIdentity")
    def key_vault_reference_identity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user-assigned identity to use for resolving the key vault certificate reference. If not specified, the system-assigned ASE identity will be used if available.
        """
        return pulumi.get(self, "key_vault_reference_identity")
    ...
    def provisioning_details(self) -> pulumi.Output[builtins.str]:
