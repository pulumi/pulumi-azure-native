...
def list_web_app_metadata_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20201201:listWebAppMetadataSlot', __args__, opts=opts, typ=ListWebAppMetadataSlotResult).value
...
def list_web_app_metadata_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20201201:listWebAppMetadataSlot', __args__, opts=opts, typ=ListWebAppMetadataSlotResult)
