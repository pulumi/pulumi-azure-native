...
def list_web_app_site_push_settings_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20201201:listWebAppSitePushSettingsSlot', __args__, opts=opts, typ=ListWebAppSitePushSettingsSlotResult).value
...
def list_web_app_site_push_settings_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20201201:listWebAppSitePushSettingsSlot', __args__, opts=opts, typ=ListWebAppSitePushSettingsSlotResult)
