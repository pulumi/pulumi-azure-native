...
class WebAppBackupConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppBackupConfiguration"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppBackupConfiguration")])
