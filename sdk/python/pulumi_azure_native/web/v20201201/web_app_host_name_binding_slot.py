...
class WebAppHostNameBindingSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppHostNameBindingSlot")])
