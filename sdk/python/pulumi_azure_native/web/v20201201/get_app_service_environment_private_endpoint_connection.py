...
def get_app_service_environment_private_endpoint_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app_service_environment_private_endpoint_connection is deprecated: azure-native:web/v20201201:AppServiceEnvironmentPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServiceEnvironmentPrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['privateEndpointConnectionName'] = private_endpoint_connection_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20201201:getAppServiceEnvironmentPrivateEndpointConnection', __args__, opts=opts, typ=GetAppServiceEnvironmentPrivateEndpointConnectionResult).value
