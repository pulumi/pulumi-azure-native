...
class WebAppPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_app_private_endpoint_connection = azure_native.web.v20201201.WebAppPrivateEndpointConnection("webAppPrivateEndpointConnection",
            name="testSite",
