...
class StaticSitePrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20201201:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/latest:StaticSitePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/latest:StaticSitePrivateEndpointConnection")])
