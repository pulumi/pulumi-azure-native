...
class AppServiceEnvironmentPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20201201:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210101:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20210101:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210115:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20210115:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection")])
