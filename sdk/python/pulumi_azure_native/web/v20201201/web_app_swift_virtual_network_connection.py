...
warnings.warn("""azure-native:web/v20201201:WebAppSwiftVirtualNetworkConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSwiftVirtualNetworkConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppSwiftVirtualNetworkConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 swift_supported: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSwiftVirtualNetworkConnection is deprecated: azure-native:web/v20201201:WebAppSwiftVirtualNetworkConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSwiftVirtualNetworkConnection to guarantee forwards compatibility.""")
