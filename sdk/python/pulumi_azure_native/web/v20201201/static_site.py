...
class StaticSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        static_site = azure_native.web.v20201201.StaticSite("staticSite",
            branch="master",
            build_properties=azure_native.web.v20201201.StaticSiteBuildPropertiesArgs(
                api_location="api",
            ...
            sku=azure_native.web.v20201201.SkuDescriptionArgs(
                name="Basic",
                tier="Basic",
            ))
        ...
        ```sh
        $ pulumi import azure-native:web/v20201201:StaticSite testStaticSite0 /subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/rg/providers/Microsoft.Web/staticSites/testStaticSite0 
        ```
