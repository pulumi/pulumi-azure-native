...
def get_static_site_private_endpoint_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site_private_endpoint_connection is deprecated: azure-native:web/v20201201:StaticSitePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSitePrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
