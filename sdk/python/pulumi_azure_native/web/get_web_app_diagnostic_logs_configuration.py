...
def get_web_app_diagnostic_logs_configuration(name: Optional[builtins.str] = None,
...
def get_web_app_diagnostic_logs_configuration_output(name: Optional[pulumi.Input[builtins.str]] = None,
