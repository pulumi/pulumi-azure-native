...
def list_web_app_publishing_credentials_slot(name: Optional[_builtins.str] = None,
...
def list_web_app_publishing_credentials_slot_output(name: pulumi.Input[Optional[_builtins.str]] = None,
