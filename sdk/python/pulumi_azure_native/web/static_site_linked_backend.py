...
class StaticSiteLinkedBackendArgs:
    def __init__(__self__, *,
        ...
        """
        StaticSiteLinkedBackendArgs._configure(
    ...
    def _configure(
        ...
        if 'linkedBackendName' in kwargs:
...
class StaticSiteLinkedBackend(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            StaticSiteLinkedBackendArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20220301:StaticSiteLinkedBackend"), pulumi.Alias(type_="azure-native:web/v20220901:StaticSiteLinkedBackend")])
