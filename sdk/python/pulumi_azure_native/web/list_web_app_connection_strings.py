...
def list_web_app_connection_strings(name: Optional[_builtins.str] = None,
...
def list_web_app_connection_strings_output(name: Optional[pulumi.Input[_builtins.str]] = None,
