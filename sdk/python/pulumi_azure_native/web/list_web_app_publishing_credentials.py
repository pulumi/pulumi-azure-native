...
def list_web_app_publishing_credentials(name: Optional[builtins.str] = None,
...
def list_web_app_publishing_credentials_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listWebAppPublishingCredentials', __args__, opts=opts, typ=ListWebAppPublishingCredentialsResult)
