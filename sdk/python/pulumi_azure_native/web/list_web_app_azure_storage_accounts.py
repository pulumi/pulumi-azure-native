...
def list_web_app_azure_storage_accounts(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:listWebAppAzureStorageAccounts', __args__, opts=opts, typ=ListWebAppAzureStorageAccountsResult).value
...
def list_web_app_azure_storage_accounts_output(name: Optional[pulumi.Input[_builtins.str]] = None,
                                               resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListWebAppAzureStorageAccountsResult]:
    """
    Description for Gets the Azure storage account configurations of an app.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listWebAppAzureStorageAccounts', __args__, opts=opts, typ=ListWebAppAzureStorageAccountsResult)
    return __ret__.apply(lambda __response__: ListWebAppAzureStorageAccountsResult(
