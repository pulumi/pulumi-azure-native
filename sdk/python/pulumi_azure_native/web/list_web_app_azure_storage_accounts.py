...
def list_web_app_azure_storage_accounts(name: Optional[builtins.str] = None,
...
def list_web_app_azure_storage_accounts_output(name: Optional[pulumi.Input[builtins.str]] = None,
