...
class GetKubeEnvironmentResult:
    ...
    def internal_load_balancer_enabled(self) -> Optional[builtins.bool]:
        """
...
def get_kube_environment(name: Optional[builtins.str] = None,
...
def get_kube_environment_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getKubeEnvironment', __args__, opts=opts, typ=GetKubeEnvironmentResult)
