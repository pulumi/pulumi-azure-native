...
def get_site_certificate_slot(certificate_name: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will create a binding for the production slot.
    """
    __args__ = dict()
...
def get_site_certificate_slot_output(certificate_name: Optional[pulumi.Input[builtins.str]] = None,
