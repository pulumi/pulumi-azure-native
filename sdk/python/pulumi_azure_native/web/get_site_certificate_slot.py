...
def get_site_certificate_slot(certificate_name: Optional[_builtins.str] = None,
                              name: Optional[_builtins.str] = None,
                              resource_group_name: Optional[_builtins.str] = None,
                              slot: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSiteCertificateSlotResult:
    """
    SSL certificate for an app.
    ...
    :param _builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will create a binding for the production slot.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:getSiteCertificateSlot', __args__, opts=opts, typ=GetSiteCertificateSlotResult).value

    return AwaitableGetSiteCertificateSlotResult(
...
def get_site_certificate_slot_output(certificate_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getSiteCertificateSlot', __args__, opts=opts, typ=GetSiteCertificateSlotResult)
    return __ret__.apply(lambda __response__: GetSiteCertificateSlotResult(
