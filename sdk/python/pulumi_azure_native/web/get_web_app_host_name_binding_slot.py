...
class GetWebAppHostNameBindingSlotResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, azure_resource_name=None, azure_resource_type=None, custom_host_name_dns_record_type=None, domain_id=None, host_name_type=None, id=None, kind=None, name=None, site_name=None, ssl_state=None, system_data=None, thumbprint=None, type=None, virtual_ip=None):
