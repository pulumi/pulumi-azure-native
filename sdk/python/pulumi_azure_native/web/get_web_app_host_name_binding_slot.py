...
def get_web_app_host_name_binding_slot(host_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str host_name: Hostname in the hostname binding.
    ...
    :param _builtins.str slot: Name of the deployment slot. If a slot is not specified, the API the named binding for the production slot.
    """
    __args__ = dict()
