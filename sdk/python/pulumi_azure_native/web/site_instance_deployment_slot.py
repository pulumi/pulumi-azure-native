...
class SiteInstanceDeploymentSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azure-native:web/latest:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20150801:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteInstanceDeploymentSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteInstanceDeploymentSlot, __self__).__init__(
            'azure-native:web:SiteInstanceDeploymentSlot',
            resource_name,
            __props__,
            opts)
