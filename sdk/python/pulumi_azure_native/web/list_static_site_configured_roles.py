...
def list_static_site_configured_roles(name: Optional[_builtins.str] = None,
...
def list_static_site_configured_roles_output(name: Optional[pulumi.Input[_builtins.str]] = None,
