...
def list_web_app_workflows_connections(name: Optional[_builtins.str] = None,
...
def list_web_app_workflows_connections_output(name: pulumi.Input[Optional[_builtins.str]] = None,
