...
warnings.warn("""azure-native:web/v20180201:WebAppPublicCertificateSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPublicCertificateSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppPublicCertificateSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppPublicCertificateSlot is deprecated: azure-native:web/v20180201:WebAppPublicCertificateSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPublicCertificateSlot to guarantee forwards compatibility.""")
