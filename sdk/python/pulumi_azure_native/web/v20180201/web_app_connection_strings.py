...
warnings.warn("""azure-native:web/v20180201:WebAppConnectionStrings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppConnectionStrings to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppConnectionStrings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppConnectionStrings is deprecated: azure-native:web/v20180201:WebAppConnectionStrings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppConnectionStrings to guarantee forwards compatibility.""")
