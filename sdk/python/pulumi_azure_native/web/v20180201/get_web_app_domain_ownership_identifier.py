...
warnings.warn("""azure-native:web/v20180201:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20181101:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_domain_ownership_identifier(domain_ownership_identifier_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_domain_ownership_identifier is deprecated: azure-native:web/v20180201:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20181101:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.""")
    __args__ = dict()
