...
warnings.warn("""azure-native:web/v20180201:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppHostNameBindingSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_host_name_binding_slot(host_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_host_name_binding_slot is deprecated: azure-native:web/v20180201:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppHostNameBindingSlot to guarantee forwards compatibility.""")
    __args__ = dict()
