...
warnings.warn("""azure-native:web/v20180201:WebAppSwiftVirtualNetworkConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnectionSlot to guarantee forwards compatibility.""", DeprecationWarning)
