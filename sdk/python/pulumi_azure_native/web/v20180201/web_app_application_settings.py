...
warnings.warn("""azure-native:web/v20180201:WebAppApplicationSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppApplicationSettings to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppApplicationSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppApplicationSettings is deprecated: azure-native:web/v20180201:WebAppApplicationSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppApplicationSettings to guarantee forwards compatibility.""")
