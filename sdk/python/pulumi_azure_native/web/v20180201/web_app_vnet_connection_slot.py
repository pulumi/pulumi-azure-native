...
warnings.warn("""azure-native:web/v20180201:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppVnetConnectionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppVnetConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vnet_resource_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppVnetConnectionSlot is deprecated: azure-native:web/v20180201:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppVnetConnectionSlot to guarantee forwards compatibility.""")
