...
warnings.warn("""azure-native:web/v20180201:WebApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20181101:WebApp to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app is deprecated: azure-native:web/v20180201:WebApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20181101:WebApp to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20180201:getWebApp', __args__, opts=opts, typ=GetWebAppResult).value
    ...
    return AwaitableGetWebAppResult(
        ...
        geo_distributions=__ret__.geo_distributions,
