...
def get_web_app_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20180201:getWebApp', __args__, opts=opts, typ=GetWebAppResult)
    return __ret__.apply(lambda __response__: GetWebAppResult(
        ...
        geo_distributions=pulumi.get(__response__, 'geo_distributions'),
