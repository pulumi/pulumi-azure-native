...
warnings.warn("""azure-native:web/v20180201:WebAppVnetConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppVnetConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_vnet_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_vnet_connection is deprecated: azure-native:web/v20180201:WebAppVnetConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppVnetConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    __args__['vnetName'] = vnet_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20180201:getWebAppVnetConnection', __args__, opts=opts, typ=GetWebAppVnetConnectionResult).value
