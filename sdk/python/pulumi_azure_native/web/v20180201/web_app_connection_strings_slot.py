...
warnings.warn("""azure-native:web/v20180201:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppConnectionStringsSlot to guarantee forwards compatibility.""", DeprecationWarning)
