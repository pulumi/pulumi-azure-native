...
warnings.warn("""azure-native:web/v20180201:WebAppDomainOwnershipIdentifierSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20181101:WebAppDomainOwnershipIdentifierSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_domain_ownership_identifier_slot(domain_ownership_identifier_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_domain_ownership_identifier_slot is deprecated: azure-native:web/v20180201:WebAppDomainOwnershipIdentifierSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20181101:WebAppDomainOwnershipIdentifierSlot to guarantee forwards compatibility.""")
    __args__ = dict()
