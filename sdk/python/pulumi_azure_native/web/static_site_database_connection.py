...
class StaticSiteDatabaseConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20220901:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20230101:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20231201:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20240401:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20241101:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20250301:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20250501:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20260301preview:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20260315:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20260715:StaticSiteDatabaseConnection")])
