...
class ManagedHostingEnvironment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:ManagedHostingEnvironment"), pulumi.Alias(type_="azure-native:web/latest:ManagedHostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/latest:ManagedHostingEnvironment"), pulumi.Alias(type_="azure-native:web/v20150801:ManagedHostingEnvironment"), pulumi.Alias(type_="azure-nextgen:web/v20150801:ManagedHostingEnvironment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedHostingEnvironment, __self__).__init__(
            'azure-native:web:ManagedHostingEnvironment',
            resource_name,
            __props__,
            opts)
