...
class StaticSiteBuildDatabaseConnectionArgs:
    ...
    def connection_identity(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def connection_identity(self, value: pulumi.Input[Optional[_builtins.str]]):
