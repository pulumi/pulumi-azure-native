...
def list_web_app_auth_settings_slot(name: Optional[builtins.str] = None,
...
def list_web_app_auth_settings_slot_output(name: Optional[pulumi.Input[builtins.str]] = None,
