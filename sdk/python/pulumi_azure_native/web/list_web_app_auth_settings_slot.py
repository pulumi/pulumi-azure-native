...
def list_web_app_auth_settings_slot(name: Optional[_builtins.str] = None,
...
def list_web_app_auth_settings_slot_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listWebAppAuthSettingsSlot', __args__, opts=opts, typ=ListWebAppAuthSettingsSlotResult)
