...
def list_static_site_secrets(name: Optional[_builtins.str] = None,
...
def list_static_site_secrets_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listStaticSiteSecrets', __args__, opts=opts, typ=ListStaticSiteSecretsResult)
