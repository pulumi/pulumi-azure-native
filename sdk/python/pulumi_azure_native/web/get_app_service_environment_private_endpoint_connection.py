...
def get_app_service_environment_private_endpoint_connection(name: Optional[builtins.str] = None,
...
def get_app_service_environment_private_endpoint_connection_output(name: Optional[pulumi.Input[builtins.str]] = None,
