...
class GetAppServiceEnvironmentPrivateEndpointConnectionResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, ip_addresses=None, kind=None, name=None, private_endpoint=None, private_link_service_connection_state=None, provisioning_state=None, system_data=None, type=None):
...
def get_app_service_environment_private_endpoint_connection(name: Optional[_builtins.str] = None,
...
def get_app_service_environment_private_endpoint_connection_output(name: Optional[pulumi.Input[_builtins.str]] = None,
