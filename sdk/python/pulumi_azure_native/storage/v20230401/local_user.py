...
class LocalUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20210801:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20210901:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20220501:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20220901:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20230101:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20230501:LocalUser"), pulumi.Alias(type_="azure-native:storage:LocalUser")])
