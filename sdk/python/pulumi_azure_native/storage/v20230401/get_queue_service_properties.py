...
def get_queue_service_properties(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20230401:getQueueServiceProperties', __args__, opts=opts, typ=GetQueueServicePropertiesResult).value
...
def get_queue_service_properties_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20230401:getQueueServiceProperties', __args__, opts=opts, typ=GetQueueServicePropertiesResult)
