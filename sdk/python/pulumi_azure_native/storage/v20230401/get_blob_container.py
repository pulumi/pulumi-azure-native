...
def get_blob_container(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20230401:getBlobContainer', __args__, opts=opts, typ=GetBlobContainerResult).value
...
def get_blob_container_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20230401:getBlobContainer', __args__, opts=opts, typ=GetBlobContainerResult)
