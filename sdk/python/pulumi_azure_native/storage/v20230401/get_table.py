...
def get_table(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20230401:getTable', __args__, opts=opts, typ=GetTableResult).value
...
def get_table_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['tableName'] = table_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20230401:getTable', __args__, opts=opts, typ=GetTableResult)
