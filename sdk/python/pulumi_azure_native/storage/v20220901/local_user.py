...
class LocalUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20210801:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20210901:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20220501:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20230101:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20230401:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20230501:LocalUser")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LocalUser, __self__).__init__(
            'azure-native:storage/v20220901:LocalUser',
            resource_name,
            __props__,
            opts)
