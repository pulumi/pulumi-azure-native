...
class LocalUserArgs:
    ...
    def _configure(
        ...
        if 'hasSharedKey' in kwargs:
            has_shared_key = kwargs['hasSharedKey']
        if 'hasSshKey' in kwargs:
            has_ssh_key = kwargs['hasSshKey']
        if 'hasSshPassword' in kwargs:
...
class LocalUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20210801:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20210901:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20220501:LocalUser"), pulumi.Alias(type_="azure-native:storage/v20230101:LocalUser")])
