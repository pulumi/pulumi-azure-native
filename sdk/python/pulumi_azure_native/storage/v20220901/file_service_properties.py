...
class FileServiceProperties(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        file_service_properties = azure_native.storage.v20220901.FileServiceProperties("fileServiceProperties",
        ...
        file_service_properties = azure_native.storage.v20220901.FileServiceProperties("fileServiceProperties",
            account_name="sto8607",
            file_services_name="default",
            protocol_settings=azure_native.storage.v20220901.ProtocolSettingsResponseArgs(
                smb={
                    "multichannel": azure_native.storage.v20220901.MultichannelArgs(
                        enabled=True,
                    ),
                },
            ),
        ...
        file_service_properties = azure_native.storage.v20220901.FileServiceProperties("fileServiceProperties",
            ...
            file_services_name="default",
            protocol_settings=azure_native.storage.v20220901.ProtocolSettingsResponseArgs(
                smb=azure_native.storage.v20220901.SmbSettingArgs(
