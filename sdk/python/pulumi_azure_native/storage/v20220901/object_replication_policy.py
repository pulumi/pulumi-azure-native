...
class ObjectReplicationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        object_replication_policy = azure_native.storage.v20220901.ObjectReplicationPolicy("objectReplicationPolicy",
            account_name="dst112",
            ...
            rules=[{
                ...
                "filters": azure_native.storage.v20220901.ObjectReplicationPolicyFilterArgs(
                    prefix_match=[
                        "blobA",
                        "blobB",
                    ],
