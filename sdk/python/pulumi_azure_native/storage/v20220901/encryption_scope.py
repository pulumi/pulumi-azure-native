...
class EncryptionScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if key_vault_properties is not None and not isinstance(key_vault_properties, EncryptionScopeKeyVaultPropertiesArgs):
                key_vault_properties = key_vault_properties or {}
                def _setter(key, value):
                    key_vault_properties[key] = value
                EncryptionScopeKeyVaultPropertiesArgs._configure(_setter, **key_vault_properties)
