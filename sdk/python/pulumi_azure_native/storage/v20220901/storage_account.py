...
class StorageAccountArgs:
    ...
    def _configure(
        ...
        if 'azureFilesIdentityBasedAuthentication' in kwargs:
...
class StorageAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if azure_files_identity_based_authentication is not None and not isinstance(azure_files_identity_based_authentication, AzureFilesIdentityBasedAuthenticationArgs):
            ...
            if custom_domain is not None and not isinstance(custom_domain, CustomDomainArgs):
            ...
            if immutable_storage_with_versioning is not None and not isinstance(immutable_storage_with_versioning, ImmutableStorageAccountArgs):
            ...
            if key_policy is not None and not isinstance(key_policy, KeyPolicyArgs):
            ...
            if network_rule_set is not None and not isinstance(network_rule_set, NetworkRuleSetArgs):
            ...
            if routing_preference is not None and not isinstance(routing_preference, RoutingPreferenceArgs):
            ...
            if sas_policy is not None and not isinstance(sas_policy, SasPolicyArgs):
