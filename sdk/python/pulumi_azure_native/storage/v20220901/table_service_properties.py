...
class TableServicePropertiesArgs:
    ...
    def _configure(
        ...
        if table_service_name is None and 'tableServiceName' in kwargs:
            table_service_name = kwargs['tableServiceName']
