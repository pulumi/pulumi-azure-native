...
class AccessPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expiry_time: Expiry time of the access policy
        :param builtins.str permission: List of abbreviated permissions.
        :param builtins.str start_time: Start time of the access policy
        """
...
class AccountImmutabilityPolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_protected_append_writes: Optional[builtins.bool] = None,
                 immutability_period_since_creation_in_days: Optional[builtins.int] = None,
                 state: Optional[builtins.str] = None):
        """
        This defines account-level immutability policy properties.
        :param builtins.bool allow_protected_append_writes: This property can only be changed for disabled and unlocked time-based retention policies. When enabled, new blocks can be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted.
        :param builtins.int immutability_period_since_creation_in_days: The immutability period for the blobs in the container since the policy creation, in days.
        :param builtins.str state: The ImmutabilityPolicy state defines the mode of the policy. Disabled state disables the policy, Unlocked state allows increase and decrease of immutability retention time and also allows toggling allowProtectedAppendWrites property, Locked state only allows the increase of the immutability retention time. A policy can only be created in a Disabled or Unlocked state and can be toggled between the two states. Only a policy in an Unlocked state can transition to a Locked state which cannot be reverted.
        """
    ...
    def allow_protected_append_writes(self) -> Optional[builtins.bool]:
        """
    ...
    def immutability_period_since_creation_in_days(self) -> Optional[builtins.int]:
        """
...
class ActiveDirectoryPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 azure_storage_sid: Optional[builtins.str] = None,
                 domain_sid: Optional[builtins.str] = None,
                 forest_name: Optional[builtins.str] = None,
                 net_bios_domain_name: Optional[builtins.str] = None,
                 sam_account_name: Optional[builtins.str] = None):
        """
        Settings properties for Active Directory (AD).
        ...
        :param builtins.str account_type: Specifies the Active Directory account type for Azure Storage.
        :param builtins.str azure_storage_sid: Specifies the security identifier (SID) for Azure Storage.
        :param builtins.str domain_sid: Specifies the security identifier (SID).
        :param builtins.str forest_name: Specifies the Active Directory forest to get.
        :param builtins.str net_bios_domain_name: Specifies the NetBIOS domain name.
        :param builtins.str sam_account_name: Specifies the Active Directory SAMAccountName for Azure Storage.
        """
    ...
    def azure_storage_sid(self) -> Optional[builtins.str]:
        """
    ...
    def net_bios_domain_name(self) -> Optional[builtins.str]:
        """
    ...
    def sam_account_name(self) -> Optional[builtins.str]:
        """
...
class AzureFilesIdentityBasedAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 default_share_permission: Optional[builtins.str] = None):
        """
        Settings for Azure Files identity based authentication.
        :param builtins.str directory_service_options: Indicates the directory service used. Note that this enum may be extended in the future.
        ...
        :param builtins.str default_share_permission: Default share permission for users using Kerberos authentication if RBAC role is not assigned.
        """
    ...
    def directory_service_options(self) -> builtins.str:
        """
    ...
    def default_share_permission(self) -> Optional[builtins.str]:
        """
...
class BlobInventoryCreationTimeResponse(dict):
    ...
    def __init__(__self__, *,
                 last_n_days: Optional[builtins.int] = None):
        """
        This property defines the creation time based filtering condition. Blob Inventory schema parameter 'Creation-Time' is mandatory with this filter.
        :param builtins.int last_n_days: When set the policy filters the objects that are created in the last N days. Where N is an integer value between 1 to 36500.
        """
    ...
    def last_n_days(self) -> Optional[builtins.int]:
        """
...
class BlobInventoryPolicyDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object that defines the blob inventory rule.
        :param builtins.str format: This is a required field, it specifies the format for the inventory files.
        :param builtins.str object_type: This is a required field. This field specifies the scope of the inventory created either at the blob or container level.
        :param builtins.str schedule: This is a required field. This field is used to schedule an inventory formation.
        :param Sequence[builtins.str] schema_fields: This is a required field. This field specifies the fields and properties of the object to be included in the inventory. The Schema field value 'Name' is always required. The valid values for this field for the 'Blob' definition.objectType include 'Name, Creation-Time, Last-Modified, Content-Length, Content-MD5, BlobType, AccessTier, AccessTierChangeTime, AccessTierInferred, Tags, Expiry-Time, hdi_isfolder, Owner, Group, Permissions, Acl, Snapshot, VersionId, IsCurrentVersion, Metadata, LastAccessTime, Tags, Etag, ContentType, ContentEncoding, ContentLanguage, ContentCRC64, CacheControl, ContentDisposition, LeaseStatus, LeaseState, LeaseDuration, ServerEncrypted, Deleted, DeletionId, DeletedTime, RemainingRetentionDays, ImmutabilityPolicyUntilDate, ImmutabilityPolicyMode, LegalHold, CopyId, CopyStatus, CopySource, CopyProgress, CopyCompletionTime, CopyStatusDescription, CustomerProvidedKeySha256, RehydratePriority, ArchiveStatus, XmsBlobSequenceNumber, EncryptionScope, IncrementalCopy, TagCount'. For Blob object type schema field value 'DeletedTime' is applicable only for Hns enabled accounts. The valid values for 'Container' definition.objectType include 'Name, Last-Modified, Metadata, LeaseStatus, LeaseState, LeaseDuration, PublicAccess, HasImmutabilityPolicy, HasLegalHold, Etag, DefaultEncryptionScope, DenyEncryptionScopeOverride, ImmutableStorageWithVersioningEnabled, Deleted, Version, DeletedTime, RemainingRetentionDays'. Schema field values 'Expiry-Time, hdi_isfolder, Owner, Group, Permissions, Acl, DeletionId' are valid only for Hns enabled accounts.Schema field values 'Tags, TagCount' are only valid for Non-Hns accounts.
...
class BlobInventoryPolicyFilterResponse(dict):
    ...
    def __init__(__self__, *,
                 blob_types: Optional[Sequence[builtins.str]] = None,
                 creation_time: Optional['outputs.BlobInventoryCreationTimeResponse'] = None,
                 exclude_prefix: Optional[Sequence[builtins.str]] = None,
                 ...
                 prefix_match: Optional[Sequence[builtins.str]] = None):
        """
        An object that defines the blob inventory rule filter conditions. For 'Blob' definition.objectType all filter properties are applicable, 'blobTypes' is required and others are optional. For 'Container' definition.objectType only prefixMatch is applicable and is optional.
        :param Sequence[builtins.str] blob_types: An array of predefined enum values. Valid values include blockBlob, appendBlob, pageBlob. Hns accounts does not support pageBlobs. This field is required when definition.objectType property is set to 'Blob'.
        ...
        :param Sequence[builtins.str] exclude_prefix: An array of strings with maximum 10 blob prefixes to be excluded from the inventory.
        :param builtins.bool include_blob_versions: Includes blob versions in blob inventory when value is set to true. The definition.schemaFields values 'VersionId and IsCurrentVersion' are required if this property is set to true, else they must be excluded.
        :param builtins.bool include_deleted: For 'Container' definition.objectType the definition.schemaFields must include 'Deleted, Version, DeletedTime and RemainingRetentionDays'. For 'Blob' definition.objectType and HNS enabled storage accounts the definition.schemaFields must include 'DeletionId, Deleted, DeletedTime and RemainingRetentionDays' and for Hns disabled accounts the definition.schemaFields must include 'Deleted and RemainingRetentionDays', else it must be excluded.
        :param builtins.bool include_snapshots: Includes blob snapshots in blob inventory when value is set to true. The definition.schemaFields value 'Snapshot' is required if this property is set to true, else it must be excluded.
        :param Sequence[builtins.str] prefix_match: An array of strings with maximum 10 blob prefixes to be included in the inventory.
        """
    ...
    def blob_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def exclude_prefix(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def prefix_match(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BlobInventoryPolicyRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str destination: Container name where blob inventory files are stored. Must be pre-created.
        :param builtins.bool enabled: Rule is enabled when set to true.
        :param builtins.str name: A rule name can contain any combination of alpha numeric characters. Rule name is case-sensitive. It must be unique within a policy.
        """
...
class BlobInventoryPolicySchemaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The storage account blob inventory policy rules.
        :param builtins.str destination: Deprecated Property from API version 2021-04-01 onwards, the required destination container name must be specified at the rule level 'policy.rule.destination'
        :param builtins.bool enabled: Policy is enabled if set to true.
        ...
        :param builtins.str type: The valid value is Inventory
        """
        pulumi.set(__self__, "destination", destination)
        pulumi.set(__self__, "enabled", enabled)
...
class BlobRestoreParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_to_restore: builtins.str):
        """
        Blob restore parameters
        :param Sequence['BlobRestoreRangeResponse'] blob_ranges: Blob ranges to restore.
        :param builtins.str time_to_restore: Restore blob to the specified time.
        """
    ...
    def time_to_restore(self) -> builtins.str:
        """
...
class BlobRestoreRangeResponse(dict):
    ...
    def __init__(__self__, *,
                 end_range: builtins.str,
                 start_range: builtins.str):
        """
        Blob range
        :param builtins.str end_range: Blob end range. This is exclusive. Empty means account end.
        :param builtins.str start_range: Blob start range. This is inclusive. Empty means account start.
        """
    ...
    def end_range(self) -> builtins.str:
        """
    ...
    def start_range(self) -> builtins.str:
        """
...
class BlobRestoreStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 restore_id: builtins.str,
                 status: builtins.str):
        """
        Blob restore status.
        :param builtins.str failure_reason: Failure reason when blob restore is failed.
        :param 'BlobRestoreParametersResponse' parameters: Blob restore request parameters.
        :param builtins.str restore_id: Id for tracking blob restore request.
        :param builtins.str status: The status of blob restore progress. Possible values are: - InProgress: Indicates that blob restore is ongoing. - Complete: Indicates that blob restore has been completed successfully. - Failed: Indicates that blob restore is failed.
        """
    ...
    def restore_id(self) -> builtins.str:
        """
...
class ChangeFeedResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The blob service properties for change feed events.
        :param builtins.bool enabled: Indicates whether change feed event logging is enabled for the Blob service.
        :param builtins.int retention_in_days: Indicates the duration of changeFeed retention in days. Minimum value is 1 day and maximum value is 146000 days (400 years). A null value indicates an infinite retention of the change feed.
        """
...
class CorsRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies a CORS rule for the Blob service.
        :param Sequence[builtins.str] allowed_headers: Required if CorsRule element is present. A list of headers allowed to be part of the cross-origin request.
        :param Sequence[builtins.str] allowed_methods: Required if CorsRule element is present. A list of HTTP methods that are allowed to be executed by the origin.
        ...
        :param Sequence[builtins.str] exposed_headers: Required if CorsRule element is present. A list of response headers to expose to CORS clients.
        :param builtins.int max_age_in_seconds: Required if CorsRule element is present. The number of seconds that the client/browser should cache a preflight response.
        """
...
class CustomDomainResponse(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 use_sub_domain_name: Optional[builtins.bool] = None):
        """
        The custom domain assigned to this storage account. This can be set via Update.
        :param builtins.str name: Gets or sets the custom domain name assigned to the storage account. Name is the CNAME source.
        :param builtins.bool use_sub_domain_name: Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.
        """
        pulumi.set(__self__, "name", name)
    ...
    def use_sub_domain_name(self) -> Optional[builtins.bool]:
        """
...
class DateAfterCreationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 days_after_last_tier_change_greater_than: Optional[builtins.float] = None):
        """
        Object to define snapshot and version action conditions.
        :param builtins.float days_after_creation_greater_than: Value indicating the age in days after creation
        :param builtins.float days_after_last_tier_change_greater_than: Value indicating the age in days after last blob tier change time. This property is only applicable for tierToArchive actions and requires daysAfterCreationGreaterThan to be set for snapshots and blob version based actions. The blob will be archived if both the conditions are satisfied.
        """
    ...
    def days_after_creation_greater_than(self) -> builtins.float:
        """
    ...
    def days_after_last_tier_change_greater_than(self) -> Optional[builtins.float]:
        """
...
class DateAfterModificationResponse(dict):
    ...
    def __init__(__self__, *,
                 days_after_creation_greater_than: Optional[builtins.float] = None,
                 days_after_last_access_time_greater_than: Optional[builtins.float] = None,
                 days_after_last_tier_change_greater_than: Optional[builtins.float] = None,
                 days_after_modification_greater_than: Optional[builtins.float] = None):
        """
        Object to define the base blob action conditions. Properties daysAfterModificationGreaterThan, daysAfterLastAccessTimeGreaterThan and daysAfterCreationGreaterThan are mutually exclusive. The daysAfterLastTierChangeGreaterThan property is only applicable for tierToArchive actions which requires daysAfterModificationGreaterThan to be set, also it cannot be used in conjunction with daysAfterLastAccessTimeGreaterThan or daysAfterCreationGreaterThan.
        :param builtins.float days_after_creation_greater_than: Value indicating the age in days after blob creation.
        :param builtins.float days_after_last_access_time_greater_than: Value indicating the age in days after last blob access. This property can only be used in conjunction with last access time tracking policy
        :param builtins.float days_after_last_tier_change_greater_than: Value indicating the age in days after last blob tier change time. This property is only applicable for tierToArchive actions and requires daysAfterModificationGreaterThan to be set for baseBlobs based actions. The blob will be archived if both the conditions are satisfied.
        :param builtins.float days_after_modification_greater_than: Value indicating the age in days after last modification
        """
    ...
    @property
    @pulumi.getter(name="daysAfterCreationGreaterThan")
    def days_after_creation_greater_than(self) -> Optional[builtins.float]:
        """
    ...
    def days_after_last_access_time_greater_than(self) -> Optional[builtins.float]:
        """
    ...
    def days_after_modification_greater_than(self) -> Optional[builtins.float]:
        """
...
class DeleteRetentionPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_permanent_delete: Optional[builtins.bool] = None,
                 days: Optional[builtins.int] = None,
                 enabled: Optional[builtins.bool] = None):
        """
        The service properties for soft delete.
        :param builtins.bool allow_permanent_delete: This property when set to true allows deletion of the soft deleted blob versions and snapshots. This property cannot be used blob restore policy. This property only applies to blob service and does not apply to containers or file share.
        :param builtins.int days: Indicates the number of days that the deleted item should be retained. The minimum specified value can be 1 and the maximum value can be 365.
        :param builtins.bool enabled: Indicates whether DeleteRetentionPolicy is enabled.
        """
    ...
    def allow_permanent_delete(self) -> Optional[builtins.bool]:
        """
...
class EncryptionIdentityResponse(dict):
    ...
    def __init__(__self__, *,
                 encryption_federated_identity_client_id: Optional[builtins.str] = None,
                 encryption_user_assigned_identity: Optional[builtins.str] = None):
        """
        Encryption identity for the storage account.
        :param builtins.str encryption_federated_identity_client_id: ClientId of the multi-tenant application to be used in conjunction with the user-assigned identity for cross-tenant customer-managed-keys server-side encryption on the storage account.
        :param builtins.str encryption_user_assigned_identity: Resource identifier of the UserAssigned identity to be associated with server-side encryption on the storage account.
        """
    ...
    def encryption_federated_identity_client_id(self) -> Optional[builtins.str]:
        """
    ...
    def encryption_user_assigned_identity(self) -> Optional[builtins.str]:
        """
...
class EncryptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key_source: The encryption keySource (provider). Possible values (case-insensitive):  Microsoft.Storage, Microsoft.Keyvault
        :param 'KeyVaultPropertiesResponse' key_vault_properties: Properties provided by key vault.
        :param builtins.bool require_infrastructure_encryption: A boolean indicating whether or not the service applies a secondary layer of encryption with platform managed keys for data at rest.
...
class EncryptionScopeKeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 current_versioned_key_identifier: builtins.str,
                 last_key_rotation_timestamp: builtins.str,
                 key_uri: Optional[builtins.str] = None):
        """
        The key vault properties for the encryption scope. This is a required field if encryption scope 'source' attribute is set to 'Microsoft.KeyVault'.
        :param builtins.str current_versioned_key_identifier: The object identifier of the current versioned Key Vault Key in use.
        :param builtins.str last_key_rotation_timestamp: Timestamp of last rotation of the Key Vault Key.
        :param builtins.str key_uri: The object identifier for a key vault key object. When applied, the encryption scope will use the key referenced by the identifier to enable customer-managed key support on this encryption scope.
        """
    ...
    def current_versioned_key_identifier(self) -> builtins.str:
        """
...
class EncryptionServiceResponse(dict):
    ...
    def __init__(__self__, *,
                 last_enabled_time: builtins.str,
                 enabled: Optional[builtins.bool] = None,
                 key_type: Optional[builtins.str] = None):
        """
        A service that allows server-side encryption to be used.
        :param builtins.str last_enabled_time: Gets a rough estimate of the date/time when the encryption was last enabled by the user. Data is encrypted at rest by default today and cannot be disabled.
        :param builtins.bool enabled: A boolean indicating whether or not the service encrypts the data as it is stored. Encryption at rest is enabled by default today and cannot be disabled.
        :param builtins.str key_type: Encryption key type to be used for the encryption service. 'Account' key type implies that an account-scoped encryption key will be used. 'Service' key type implies that a default service key is used.
        """
    ...
    def last_enabled_time(self) -> builtins.str:
        """
...
class EndpointsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The URIs that are used to perform a retrieval of a public blob, queue, table, web or dfs object.
        :param builtins.str blob: Gets the blob endpoint.
        :param builtins.str dfs: Gets the dfs endpoint.
        :param builtins.str file: Gets the file endpoint.
        :param builtins.str queue: Gets the queue endpoint.
        :param builtins.str table: Gets the table endpoint.
        :param builtins.str web: Gets the web endpoint.
...
class ExecutionTargetResponse(dict):
    ...
    def __init__(__self__, *,
                 exclude_prefix: Optional[Sequence[builtins.str]] = None,
                 prefix: Optional[Sequence[builtins.str]] = None):
        """
        Target helps provide filter parameters for the objects in the storage account and forms the execution context for the storage task
        :param Sequence[builtins.str] exclude_prefix: List of object prefixes to be excluded from task execution. If there is a conflict between include and exclude prefixes, the exclude prefix will be the determining factor
        :param Sequence[builtins.str] prefix: Required list of object prefixes to be included for task execution
        """
        if exclude_prefix is not None:
            pulumi.set(__self__, "exclude_prefix", exclude_prefix)
    ...
    @property
    @pulumi.getter
    def prefix(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ExecutionTriggerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: The trigger type of the storage task assignment execution
        """
        pulumi.set(__self__, "parameters", parameters)
        pulumi.set(__self__, "type", type)
...
class FileSharePropertiesResponseFileSharePaidBursting(dict):
    ...
    def __init__(__self__, *,
                 paid_bursting_enabled: Optional[builtins.bool] = None,
                 paid_bursting_max_bandwidth_mibps: Optional[builtins.int] = None,
                 paid_bursting_max_iops: Optional[builtins.int] = None):
        """
        File Share Paid Bursting properties.
        :param builtins.bool paid_bursting_enabled: Indicates whether paid bursting is enabled for the share. This property is only for file shares created under Files Provisioned v1 SSD account type.
        :param builtins.int paid_bursting_max_bandwidth_mibps: The maximum paid bursting bandwidth for the share, in mebibytes per second. This property is only for file shares created under Files Provisioned v1 SSD account type. The maximum allowed value is 10340 which is the maximum allowed bandwidth for a share.
        :param builtins.int paid_bursting_max_iops: The maximum paid bursting IOPS for the share. This property is only for file shares created under Files Provisioned v1 SSD account type. The maximum allowed value is 102400 which is the maximum allowed IOPS for a share.
        """
    ...
    def paid_bursting_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def paid_bursting_max_bandwidth_mibps(self) -> Optional[builtins.int]:
        """
    ...
    def paid_bursting_max_iops(self) -> Optional[builtins.int]:
        """
...
class GeoReplicationStatsResponse(dict):
    ...
    def __init__(__self__, *,
                 can_failover: builtins.bool,
                 can_planned_failover: builtins.bool,
                 last_sync_time: builtins.str,
                 post_failover_redundancy: builtins.str,
                 post_planned_failover_redundancy: builtins.str,
                 status: builtins.str):
        """
        Statistics related to replication for storage account's Blob, Table, Queue and File services. It is only available when geo-redundant replication is enabled for the storage account.
        :param builtins.bool can_failover: A boolean flag which indicates whether or not account failover is supported for the account.
        :param builtins.bool can_planned_failover: A boolean flag which indicates whether or not planned account failover is supported for the account.
        :param builtins.str last_sync_time: All primary writes preceding this UTC date/time value are guaranteed to be available for read operations. Primary writes following this point in time may or may not be available for reads. Element may be default value if value of LastSyncTime is not available, this can happen if secondary is offline or we are in bootstrap.
        :param builtins.str post_failover_redundancy: The redundancy type of the account after an account failover is performed.
        :param builtins.str post_planned_failover_redundancy: The redundancy type of the account after a planned account failover is performed.
        :param builtins.str status: The status of the secondary location. Possible values are: - Live: Indicates that the secondary location is active and operational. - Bootstrap: Indicates initial synchronization from the primary location to the secondary location is in progress.This typically occurs when replication is first enabled. - Unavailable: Indicates that the secondary location is temporarily unavailable.
        """
    ...
    def can_failover(self) -> builtins.bool:
        """
    ...
    def can_planned_failover(self) -> builtins.bool:
        """
    ...
    def post_failover_redundancy(self) -> builtins.str:
        """
    ...
    def post_planned_failover_redundancy(self) -> builtins.str:
        """
...
class IPRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 i_p_address_or_range: builtins.str,
                 action: Optional[builtins.str] = None):
        """
        IP rule with specific IP or IP range in CIDR format.
        :param builtins.str i_p_address_or_range: Specifies the IP or IP range in CIDR format. Only IPV4 address is allowed.
        :param builtins.str action: The action of IP ACL rule.
        """
    ...
    def i_p_address_or_range(self) -> builtins.str:
        """
...
class ImmutabilityPolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allow_protected_append_writes: Optional[builtins.bool] = None,
                 allow_protected_append_writes_all: Optional[builtins.bool] = None,
                 immutability_period_since_creation_in_days: Optional[builtins.int] = None):
        """
        The properties of an ImmutabilityPolicy of a blob container.
        :param builtins.str etag: ImmutabilityPolicy Etag.
        :param builtins.str state: The ImmutabilityPolicy state of a blob container, possible values include: Locked and Unlocked.
        :param Sequence['UpdateHistoryPropertyResponse'] update_history: The ImmutabilityPolicy update history of the blob container.
        :param builtins.bool allow_protected_append_writes: This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API.
        :param builtins.bool allow_protected_append_writes_all: This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to both 'Append and Bock Blobs' while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API. The 'allowProtectedAppendWrites' and 'allowProtectedAppendWritesAll' properties are mutually exclusive.
        :param builtins.int immutability_period_since_creation_in_days: The immutability period for the blobs in the container since the policy creation, in days.
        """
    ...
    def allow_protected_append_writes_all(self) -> Optional[builtins.bool]:
        """
        This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to both 'Append and Bock Blobs' while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API. The 'allowProtectedAppendWrites' and 'allowProtectedAppendWritesAll' properties are mutually exclusive.
        """
...
class ImmutableStorageAccountResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        This property enables and defines account-level immutability. Enabling the feature auto-enables Blob Versioning.
        :param builtins.bool enabled: A boolean flag which enables account-level immutability. All the containers under such an account have object-level immutability enabled by default.
...
class ImmutableStorageWithVersioningResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Object level immutability properties of the container.
        :param builtins.str migration_state: This property denotes the container level immutability to object level immutability migration state.
        :param builtins.str time_stamp: Returns the date and time the object level immutability was enabled.
        :param builtins.bool enabled: This is an immutable property, when set to true it enables object level immutability at the container level.
        """
...
class KeyPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        KeyPolicy assigned to the storage account.
        :param builtins.int key_expiration_period_in_days: The key expiration period in days.
        """
    ...
    def key_expiration_period_in_days(self) -> builtins.int:
        """
...
class KeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of key vault.
        :param builtins.str current_versioned_key_expiration_timestamp: This is a read only property that represents the expiration time of the current version of the customer managed key used for encryption.
        :param builtins.str current_versioned_key_identifier: The object identifier of the current versioned Key Vault Key in use.
        :param builtins.str last_key_rotation_timestamp: Timestamp of last rotation of the Key Vault Key.
        :param builtins.str key_name: The name of KeyVault key.
        :param builtins.str key_vault_uri: The Uri of KeyVault.
        :param builtins.str key_version: The version of KeyVault key.
        """
...
class LastAccessTimeTrackingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 blob_type: Optional[Sequence[builtins.str]] = None,
                 name: Optional[builtins.str] = None,
                 tracking_granularity_in_days: Optional[builtins.int] = None):
        """
        The blob service properties for Last access time based tracking policy.
        :param builtins.bool enable: When set to true last access time based tracking is enabled.
        :param Sequence[builtins.str] blob_type: An array of predefined supported blob types. Only blockBlob is the supported value. This field is currently read only
        :param builtins.str name: Name of the policy. The valid value is AccessTimeTracking. This field is currently read only
        :param builtins.int tracking_granularity_in_days: The field specifies blob object tracking granularity in days, typically how often the blob object should be tracked.This field is currently read only with value as 1
        """
    ...
    def blob_type(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def tracking_granularity_in_days(self) -> Optional[builtins.int]:
        """
...
class LegalHoldPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The LegalHold property of a blob container.
        :param builtins.bool has_legal_hold: The hasLegalHold public property is set to true by SRP if there are at least one existing tag. The hasLegalHold public property is set to false by SRP if all existing legal hold tags are cleared out. There can be a maximum of 1000 blob containers with hasLegalHold=true for a given account.
    ...
    def has_legal_hold(self) -> builtins.bool:
        """
...
class ManagementPolicyBaseBlobResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_auto_tier_to_hot_from_cool: Optional[builtins.bool] = None,
        ...
        :param builtins.bool enable_auto_tier_to_hot_from_cool: This property enables auto tiering of a blob from cool to hot on a blob access. This property requires tierToCool.daysAfterLastAccessTimeGreaterThan.
    ...
    def enable_auto_tier_to_hot_from_cool(self) -> Optional[builtins.bool]:
        """
...
class ManagementPolicyFilterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Filters limit rule actions to a subset of blobs within the storage account. If multiple filters are defined, a logical AND is performed on all filters. 
        :param Sequence[builtins.str] blob_types: An array of predefined enum values. Currently blockBlob supports all tiering and delete actions. Only delete actions are supported for appendBlob.
        ...
        :param Sequence[builtins.str] prefix_match: An array of strings for prefixes to be match.
        """
        pulumi.set(__self__, "blob_types", blob_types)
...
class ManagementPolicyRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: A rule name can contain any combination of alpha numeric characters. Rule name is case-sensitive. It must be unique within a policy.
        :param builtins.str type: The valid value is Lifecycle
        :param builtins.bool enabled: Rule is enabled if set to true.
        """
        pulumi.set(__self__, "definition", definition)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class MultichannelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Multichannel setting. Applies to Premium FileStorage only.
        :param builtins.bool enabled: Indicates whether multichannel is enabled
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class NetworkRuleSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Network rule set
        :param builtins.str default_action: Specifies the default action of allow or deny when no other rules match.
        :param builtins.str bypass: Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Possible values are any combination of Logging|Metrics|AzureServices (For example, "Logging, Metrics"), or None to bypass none of those traffics.
...
class ObjectReplicationPolicyFilterResponse(dict):
    ...
    def __init__(__self__, *,
                 min_creation_time: Optional[builtins.str] = None,
                 prefix_match: Optional[Sequence[builtins.str]] = None):
        """
        Filters limit replication to a subset of blobs within the storage account. A logical OR is performed on values in the filter. If multiple filters are defined, a logical AND is performed on all filters.
        :param builtins.str min_creation_time: Blobs created after the time will be replicated to the destination. It must be in datetime format 'yyyy-MM-ddTHH:mm:ssZ'. Example: 2020-02-19T16:05:00Z
        :param Sequence[builtins.str] prefix_match: Optional. Filters the results to replicate only blobs whose names begin with the specified prefix.
        """
    ...
    def min_creation_time(self) -> Optional[builtins.str]:
        """
...
class ObjectReplicationPolicyPropertiesResponseMetrics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Optional. The object replication policy metrics feature options.
        :param builtins.bool enabled: Indicates whether object replication metrics feature is enabled for the policy.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ObjectReplicationPolicyRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The replication policy rule between two containers.
        :param builtins.str destination_container: Required. Destination container name.
        :param builtins.str source_container: Required. Source container name.
        :param 'ObjectReplicationPolicyFilterResponse' filters: Optional. An object that defines the filter set.
        :param builtins.str rule_id: Rule Id is auto-generated for each new rule on destination account. It is required for put policy on source account.
        """
    ...
    def destination_container(self) -> builtins.str:
        """
...
class PermissionScopeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str permissions: The permissions for the local user. Possible values include: Read (r), Write (w), Delete (d), List (l), Create (c), Modify Ownership (o), and Modify Permissions (p).
        :param builtins.str resource_name: The name of resource, normally the container name or the file share name, used by the local user.
        :param builtins.str service: The service used by the local user, e.g. blob, file.
        """
...
class PrivateLinkServiceConnectionStateResponse(dict):
    ...
    def __init__(__self__, *,
                 action_required: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 status: Optional[builtins.str] = None):
        """
        A collection of information about the state of the connection between service consumer and provider.
        :param builtins.str action_required: A message indicating if changes on the service provider require any updates on the consumer.
    ...
    def action_required(self) -> Optional[builtins.str]:
        """
...
class ProtectedAppendWritesHistoryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Protected append writes history setting for the blob container with Legal holds.
        :param builtins.str timestamp: Returns the date and time the tag was added.
        :param builtins.bool allow_protected_append_writes_all: When enabled, new blocks can be written to both 'Append and Bock Blobs' while maintaining legal hold protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted.
        """
...
class RestorePolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 last_enabled_time: builtins.str,
                 min_restore_time: builtins.str,
                 days: Optional[builtins.int] = None):
        """
        The blob service properties for blob restore policy
        :param builtins.bool enabled: Blob restore is enabled if set to true.
        :param builtins.str last_enabled_time: Deprecated in favor of minRestoreTime property.
        :param builtins.str min_restore_time: Returns the minimum date and time that the restore can be started.
        :param builtins.int days: how long this blob can be restored. It should be great than zero and less than DeleteRetentionPolicy.days.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "last_enabled_time", last_enabled_time)
    ...
    def min_restore_time(self) -> builtins.str:
        """
...
class RoutingPreferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 routing_choice: Optional[builtins.str] = None):
        """
        Routing preference defines the type of network, either microsoft or internet routing to be used to deliver the user data, the default option is microsoft routing
        :param builtins.bool publish_internet_endpoints: A boolean flag which indicates whether internet routing storage endpoints are to be published
        :param builtins.bool publish_microsoft_endpoints: A boolean flag which indicates whether microsoft routing storage endpoints are to be published
        :param builtins.str routing_choice: Routing Choice defines the kind of network routing opted by the user.
        """
    ...
    def routing_choice(self) -> Optional[builtins.str]:
        """
...
class SasPolicyResponse(dict):
    ...
    def sas_expiration_period(self) -> builtins.str:
        """
...
class SignedIdentifierResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str id: An unique identifier of the stored access policy.
        """
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The SKU of the storage account.
        :param builtins.str name: The SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.
...
class SmbSettingResponse(dict):
    ...
    def __init__(__self__, *,
                 authentication_methods: Optional[builtins.str] = None,
                 channel_encryption: Optional[builtins.str] = None,
                 kerberos_ticket_encryption: Optional[builtins.str] = None,
                 multichannel: Optional['outputs.MultichannelResponse'] = None,
                 versions: Optional[builtins.str] = None):
        """
        Setting for SMB protocol
        :param builtins.str authentication_methods: SMB authentication methods supported by server. Valid values are NTLMv2, Kerberos. Should be passed as a string with delimiter ';'.
        :param builtins.str channel_encryption: SMB channel encryption supported by server. Valid values are AES-128-CCM, AES-128-GCM, AES-256-GCM. Should be passed as a string with delimiter ';'.
        :param builtins.str kerberos_ticket_encryption: Kerberos ticket encryption supported by server. Valid values are RC4-HMAC, AES-256. Should be passed as a string with delimiter ';'
        :param 'MultichannelResponse' multichannel: Multichannel setting. Applies to Premium FileStorage only.
        :param builtins.str versions: SMB protocol versions supported by server. Valid values are SMB2.1, SMB3.0, SMB3.1.1. Should be passed as a string with delimiter ';'.
        """
    ...
    def authentication_methods(self) -> Optional[builtins.str]:
        """
    ...
    def channel_encryption(self) -> Optional[builtins.str]:
        """
    ...
    def kerberos_ticket_encryption(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def versions(self) -> Optional[builtins.str]:
        """
...
class SshPublicKeyResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: Optional. It is used to store the function/usage of the key
        :param builtins.str key: Ssh public key base64 encoded. The format should be: '<keyType> <keyData>', e.g. ssh-rsa AAAABBBB
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if key is not None:
...
class StorageAccountSkuConversionStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sku_conversion_status: builtins.str,
                 start_time: builtins.str,
                 target_sku_name: Optional[builtins.str] = None):
        """
        This defines the sku conversion status object for asynchronous sku conversions.
        :param builtins.str end_time: This property represents the sku conversion end time.
        :param builtins.str sku_conversion_status: This property indicates the current sku conversion status.
        :param builtins.str start_time: This property represents the sku conversion start time.
        :param builtins.str target_sku_name: This property represents the target sku name to which the account sku is being converted asynchronously.
        """
    ...
    def sku_conversion_status(self) -> builtins.str:
        """
    ...
    def target_sku_name(self) -> Optional[builtins.str]:
        """
...
class StorageTaskAssignmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of the storage task assignment.
        :param builtins.str description: Text that describes the purpose of the storage task assignment
        :param builtins.bool enabled: Whether the storage task assignment is enabled or not
        :param 'StorageTaskAssignmentExecutionContextResponse' execution_context: The storage task assignment execution context
        :param builtins.str provisioning_state: Represents the provisioning state of the storage task assignment.
        :param 'StorageTaskAssignmentReportResponse' report: The storage task assignment report
        :param builtins.str task_id: Id of the corresponding storage task
...
class StorageTaskAssignmentReportResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The storage task assignment report
        :param builtins.str prefix: The container prefix for the location of storage task assignment report
        """
        pulumi.set(__self__, "prefix", prefix)
...
class StorageTaskReportPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 object_failed_count: builtins.str,
                 objects_operated_on_count: builtins.str,
                 objects_succeeded_count: builtins.str,
                 objects_targeted_count: builtins.str,
                 run_result: builtins.str,
                 run_status_enum: builtins.str,
                 run_status_error: builtins.str,
                 start_time: builtins.str,
                 storage_account_id: builtins.str,
                 summary_report_path: builtins.str,
                 task_assignment_id: builtins.str,
                 task_id: builtins.str,
                 task_version: builtins.str):
        """
        Storage task execution report for a run instance.
        :param builtins.str finish_time: End time of the run instance. Filter options such as startTime gt '2023-06-26T20:51:24.4494016Z' and other comparison operators can be used as described for DateTime properties in https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators
        :param builtins.str object_failed_count: Total number of objects where task operation failed when was attempted. Filter options such as objectFailedCount eq 0 and other comparison operators can be used as described for Numerical properties in https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators
        :param builtins.str objects_operated_on_count: Total number of objects that meet the storage tasks condition and were operated upon. Filter options such as objectsOperatedOnCount ge 100 and other comparison operators can be used as described for Numerical properties in https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators
        :param builtins.str objects_succeeded_count: Total number of objects where task operation succeeded when was attempted.Filter options such as objectsSucceededCount gt 150 and other comparison operators can be used as described for Numerical properties in https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators
        :param builtins.str objects_targeted_count: Total number of objects that meet the condition as defined in the storage task assignment execution context. Filter options such as objectsTargetedCount gt 50 and other comparison operators can be used as described for Numerical properties in https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators
        :param builtins.str run_result: Represents the overall result of the execution for the run instance
        :param builtins.str run_status_enum: Represents the status of the execution.
        :param builtins.str run_status_error: Well known Azure Storage error code that represents the error encountered during execution of the run instance.
        :param builtins.str start_time: Start time of the run instance. Filter options such as startTime gt '2023-06-26T20:51:24.4494016Z' and other comparison operators can be used as described for DateTime properties in https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators
        :param builtins.str storage_account_id: Represents the Storage Account Id where the storage task definition was applied and executed.
        :param builtins.str summary_report_path: Full path to the verbose report stored in the reporting container as specified in the assignment execution context for the storage account. 
        :param builtins.str task_assignment_id: Represents the Storage Task Assignment Id associated with the storage task that provided an execution context.
        :param builtins.str task_id: Storage Task Arm Id.
        :param builtins.str task_version: Storage Task Version
        """
    ...
    def object_failed_count(self) -> builtins.str:
        """
    ...
    def objects_operated_on_count(self) -> builtins.str:
        """
    ...
    def objects_succeeded_count(self) -> builtins.str:
        """
        Total number of objects where task operation succeeded when was attempted.Filter options such as objectsSucceededCount gt 150 and other comparison operators can be used as described for Numerical properties in https://learn.microsoft.com/rest/api/storageservices/querying-tables-and-entities#supported-comparison-operators
        """
    ...
    def objects_targeted_count(self) -> builtins.str:
        """
    ...
    def run_result(self) -> builtins.str:
        """
    ...
    def run_status_enum(self) -> builtins.str:
        """
    ...
    def run_status_error(self) -> builtins.str:
        """
    ...
    def summary_report_path(self) -> builtins.str:
        """
    ...
    def task_assignment_id(self) -> builtins.str:
        """
    ...
    def task_version(self) -> builtins.str:
        """
...
class TableAccessPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Table Access Policy Properties Object.
        :param builtins.str permission: Required. List of abbreviated permissions. Supported permission values include 'r','a','u','d'
        :param builtins.str expiry_time: Expiry time of the access policy
        :param builtins.str start_time: Start time of the access policy
        """
        pulumi.set(__self__, "permission", permission)
...
class TableSignedIdentifierResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Object to set Table Access Policy.
        :param builtins.str id: unique-64-character-value of the stored access policy.
...
class TagFilterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Blob index tag based filtering for blob objects
        :param builtins.str name: This is the filter tag name, it can have 1 - 128 characters
        :param builtins.str op: This is the comparison operator which is used for object comparison and filtering. Only == (equality operator) is currently supported
        :param builtins.str value: This is the filter tag value field used for tag based filtering, it can have 0 - 256 characters
        """
        pulumi.set(__self__, "name", name)
...
class TagPropertyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A tag of the LegalHold of a blob container.
        :param builtins.str object_identifier: Returns the Object ID of the user who added the tag.
        :param builtins.str tag: The tag value.
        :param builtins.str tenant_id: Returns the Tenant ID that issued the token for the user who added the tag.
        :param builtins.str timestamp: Returns the date and time the tag was added.
        :param builtins.str upn: Returns the User Principal Name of the user who added the tag.
        """
...
class TriggerParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 end_by: Optional[builtins.str] = None,
                 interval: Optional[builtins.int] = None,
                 interval_unit: Optional[builtins.str] = None,
                 start_from: Optional[builtins.str] = None,
                 start_on: Optional[builtins.str] = None):
        """
        The trigger parameters update for the storage task assignment execution
        :param builtins.str end_by: When to end task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'
        :param builtins.int interval: Run interval of task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'
        :param builtins.str interval_unit: Run interval unit of task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'
        :param builtins.str start_from: When to start task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'
        :param builtins.str start_on: When to start task execution. This is an optional field when ExecutionTrigger.properties.type is 'RunOnce'; this property should not be present when ExecutionTrigger.properties.type is 'OnSchedule'
        """
    ...
    def end_by(self) -> Optional[builtins.str]:
        """
...
class UpdateHistoryPropertyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        An update history of the ImmutabilityPolicy of a blob container.
        :param builtins.int immutability_period_since_creation_in_days: The immutability period for the blobs in the container since the policy creation, in days.
        :param builtins.str object_identifier: Returns the Object ID of the user who updated the ImmutabilityPolicy.
        :param builtins.str tenant_id: Returns the Tenant ID that issued the token for the user who updated the ImmutabilityPolicy.
        :param builtins.str timestamp: Returns the date and time the ImmutabilityPolicy was updated.
        :param builtins.str update: The ImmutabilityPolicy update type of a blob container, possible values include: put, lock and extend.
        :param builtins.str upn: Returns the User Principal Name of the user who updated the ImmutabilityPolicy.
        :param builtins.bool allow_protected_append_writes: This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API.
        :param builtins.bool allow_protected_append_writes_all: This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to both 'Append and Bock Blobs' while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API. The 'allowProtectedAppendWrites' and 'allowProtectedAppendWritesAll' properties are mutually exclusive.
        """
        pulumi.set(__self__, "immutability_period_since_creation_in_days", immutability_period_since_creation_in_days)
    ...
    @property
    @pulumi.getter(name="immutabilityPeriodSinceCreationInDays")
    def immutability_period_since_creation_in_days(self) -> builtins.int:
        """
        The immutability period for the blobs in the container since the policy creation, in days.
        """
        return pulumi.get(self, "immutability_period_since_creation_in_days")
...
class UserAssignedIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        UserAssignedIdentity for the resource.
        :param builtins.str client_id: The client ID of the identity.
...
class VirtualNetworkRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 virtual_network_resource_id: builtins.str,
                 action: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None):
        """
        Virtual Network rule.
        :param builtins.str virtual_network_resource_id: Resource ID of a subnet, for example: /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
        :param builtins.str action: The action of virtual network rule.
    ...
    def virtual_network_resource_id(self) -> builtins.str:
        """
