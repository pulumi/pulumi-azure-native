...
class AccessPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str permission: List of abbreviated permissions.
...
class AccountImmutabilityPolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_protected_append_writes: Optional[_builtins.bool] = None,
...
class ActiveDirectoryPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 azure_storage_sid: Optional[_builtins.str] = None,
                 domain_sid: Optional[_builtins.str] = None,
                 forest_name: Optional[_builtins.str] = None,
                 net_bios_domain_name: Optional[_builtins.str] = None,
        ...
        :param _builtins.str azure_storage_sid: Specifies the security identifier (SID) for Azure Storage.
        :param _builtins.str domain_sid: Specifies the security identifier (SID).
        :param _builtins.str forest_name: Specifies the Active Directory forest to get.
        :param _builtins.str net_bios_domain_name: Specifies the NetBIOS domain name.
        :param _builtins.str sam_account_name: Specifies the Active Directory SAMAccountName for Azure Storage.
        """
...
class BlobInventoryPolicyFilterResponse(dict):
    ...
    def __init__(__self__, *,
                 blob_types: Optional[Sequence[_builtins.str]] = None,
                 creation_time: Optional['outputs.BlobInventoryCreationTimeResponse'] = None,
                 exclude_prefix: Optional[Sequence[_builtins.str]] = None,
        ...
        :param _builtins.bool include_blob_versions: Includes blob versions in blob inventory when value is set to true. The definition.schemaFields values 'VersionId and IsCurrentVersion' are required if this property is set to true, else they must be excluded.
        :param _builtins.bool include_deleted: For 'Container' definition.objectType the definition.schemaFields must include 'Deleted, Version, DeletedTime and RemainingRetentionDays'. For 'Blob' definition.objectType and HNS enabled storage accounts the definition.schemaFields must include 'DeletionId, Deleted, DeletedTime and RemainingRetentionDays' and for Hns disabled accounts the definition.schemaFields must include 'Deleted and RemainingRetentionDays', else it must be excluded.
        :param _builtins.bool include_snapshots: Includes blob snapshots in blob inventory when value is set to true. The definition.schemaFields value 'Snapshot' is required if this property is set to true, else it must be excluded.
        :param Sequence[_builtins.str] prefix_match: An array of strings with maximum 10 blob prefixes to be included in the inventory.
        """
...
class BlobInventoryPolicySchemaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The valid value is Inventory
        """
        pulumi.set(__self__, "destination", destination)
        pulumi.set(__self__, "enabled", enabled)
...
class BlobRestoreStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str status: The status of blob restore progress. Possible values are: - InProgress: Indicates that blob restore is ongoing. - Complete: Indicates that blob restore has been completed successfully. - Failed: Indicates that blob restore is failed.
        """
...
class CorsRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] exposed_headers: Required if CorsRule element is present. A list of response headers to expose to CORS clients.
        :param _builtins.int max_age_in_seconds: Required if CorsRule element is present. The number of seconds that the client/browser should cache a preflight response.
        """
...
class DateAfterModificationResponse(dict):
    ...
    def __init__(__self__, *,
                 days_after_creation_greater_than: Optional[_builtins.float] = None,
                 days_after_last_access_time_greater_than: Optional[_builtins.float] = None,
                 days_after_last_tier_change_greater_than: Optional[_builtins.float] = None,
        ...
        :param _builtins.float days_after_modification_greater_than: Value indicating the age in days after last modification
        """
...
class DeleteRetentionPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_permanent_delete: Optional[_builtins.bool] = None,
...
class EncryptionIdentityResponse(dict):
    ...
    def __init__(__self__, *,
                 encryption_federated_identity_client_id: Optional[_builtins.str] = None,
...
class EncryptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool require_infrastructure_encryption: A boolean indicating whether or not the service applies a secondary layer of encryption with platform managed keys for data at rest.
...
class EndpointsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str queue: Gets the queue endpoint.
        :param _builtins.str table: Gets the table endpoint.
        :param _builtins.str web: Gets the web endpoint.
...
class FileSharePropertiesResponseFileSharePaidBursting(dict):
    ...
    def __init__(__self__, *,
                 paid_bursting_enabled: Optional[_builtins.bool] = None,
                 paid_bursting_max_bandwidth_mibps: Optional[_builtins.int] = None,
...
class GeoReplicationStatsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str post_failover_redundancy: The redundancy type of the account after an account failover is performed.
        :param _builtins.str post_planned_failover_redundancy: The redundancy type of the account after a planned account failover is performed.
        :param _builtins.str status: The status of the secondary location. Possible values are: - Live: Indicates that the secondary location is active and operational. - Bootstrap: Indicates initial synchronization from the primary location to the secondary location is in progress.This typically occurs when replication is first enabled. - Unavailable: Indicates that the secondary location is temporarily unavailable.
        """
...
class ImmutabilityPolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool allow_protected_append_writes: This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API.
        :param _builtins.bool allow_protected_append_writes_all: This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to both 'Append and Bock Blobs' while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API. The 'allowProtectedAppendWrites' and 'allowProtectedAppendWritesAll' properties are mutually exclusive.
        :param _builtins.int immutability_period_since_creation_in_days: The immutability period for the blobs in the container since the policy creation, in days.
        """
...
class KeyCreationTimeResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key2: Optional[_builtins.str] = None):
        """
        Storage account keys creation time.
        """
        if key1 is not None:
...
class LastAccessTimeTrackingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 blob_type: Optional[Sequence[_builtins.str]] = None,
                 name: Optional[_builtins.str] = None,
        ...
        :param _builtins.int tracking_granularity_in_days: The field specifies blob object tracking granularity in days, typically how often the blob object should be tracked.This field is currently read only with value as 1
        """
...
class ManagementPolicyBaseBlobResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_auto_tier_to_hot_from_cool: Optional[_builtins.bool] = None,
...
class ManagementPolicyRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool enabled: Rule is enabled if set to true.
        """
        pulumi.set(__self__, "definition", definition)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ObjectReplicationPolicyFilterResponse(dict):
    ...
    def __init__(__self__, *,
                 min_creation_time: Optional[_builtins.str] = None,
                 prefix_match: Optional[Sequence[_builtins.str]] = None):
        """
        Filters limit replication to a subset of blobs within the storage account. A logical OR is performed on values in the filter. If multiple filters are defined, a logical AND is performed on all filters.
...
class ObjectReplicationPolicyRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str rule_id: Rule Id is auto-generated for each new rule on destination account. It is required for put policy on source account.
        """
...
class PermissionScopeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str permissions: The permissions for the local user. Possible values include: Read (r), Write (w), Delete (d), List (l), Create (c), Modify Ownership (o), and Modify Permissions (p).
        :param _builtins.str resource_name: The name of resource, normally the container name or the file share name, used by the local user.
        :param _builtins.str service: The service used by the local user, e.g. blob, file.
        """
...
class PrivateLinkServiceConnectionStateResponse(dict):
    ...
    def __init__(__self__, *,
                 action_required: Optional[_builtins.str] = None,
...
class RestorePolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int days: how long this blob can be restored. It should be great than zero and less than DeleteRetentionPolicy.days.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "last_enabled_time", last_enabled_time)
...
class SignedIdentifierResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str id: An unique identifier of the stored access policy.
        """
...
class SmbSettingResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 channel_encryption: Optional[_builtins.str] = None,
                 kerberos_ticket_encryption: Optional[_builtins.str] = None,
        ...
        :param _builtins.str versions: SMB protocol versions supported by server. Valid values are SMB2.1, SMB3.0, SMB3.1.1. Should be passed as a string with delimiter ';'.
        """
...
class SshPublicKeyResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str description: Optional. It is used to store the function/usage of the key
        :param _builtins.str key: Ssh public key base64 encoded. The format should be: '<keyType> <keyData>', e.g. ssh-rsa AAAABBBB
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if key is not None:
...
class StorageAccountSkuConversionStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str target_sku_name: This property represents the target sku name to which the account sku is being converted asynchronously.
        """
...
class StorageTaskAssignmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: Represents the provisioning state of the storage task assignment.
        :param 'StorageTaskAssignmentReportResponse' report: The storage task assignment report
        :param _builtins.str task_id: Id of the corresponding storage task
...
class TagPropertyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str timestamp: Returns the date and time the tag was added.
        :param _builtins.str upn: Returns the User Principal Name of the user who added the tag.
        """
...
class TriggerParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str start_from: When to start task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'
        :param _builtins.str start_on: When to start task execution. This is a required field when ExecutionTrigger.properties.type is 'RunOnce'; this property should not be present when ExecutionTrigger.properties.type is 'OnSchedule'
        """
...
class UpdateHistoryPropertyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str timestamp: Returns the date and time the ImmutabilityPolicy was updated.
        :param _builtins.str update: The ImmutabilityPolicy update type of a blob container, possible values include: put, lock and extend.
        :param _builtins.str upn: Returns the User Principal Name of the user who updated the ImmutabilityPolicy.
        :param _builtins.bool allow_protected_append_writes: This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API.
        :param _builtins.bool allow_protected_append_writes_all: This property can only be changed for unlocked time-based retention policies. When enabled, new blocks can be written to both 'Append and Bock Blobs' while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API. The 'allowProtectedAppendWrites' and 'allowProtectedAppendWritesAll' properties are mutually exclusive.
        """
        pulumi.set(__self__, "immutability_period_since_creation_in_days", immutability_period_since_creation_in_days)
