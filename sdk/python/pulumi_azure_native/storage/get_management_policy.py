...
def get_management_policy(account_name: Optional[_builtins.str] = None,
                          management_policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str management_policy_name: The name of the Storage Account Management Policy. It should always be 'default'
...
def get_management_policy_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
                                 management_policy_name: pulumi.Input[Optional[_builtins.str]] = None,
