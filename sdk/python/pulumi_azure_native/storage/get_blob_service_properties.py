...
class GetBlobServicePropertiesResult:
    ...
    def automatic_snapshot_policy_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_versioning_enabled(self) -> Optional[builtins.bool]:
        """
...
def get_blob_service_properties(account_name: Optional[builtins.str] = None,
                                blob_services_name: Optional[builtins.str] = None,
    ...
    :param builtins.str blob_services_name: The name of the blob Service within the specified storage account. Blob Service Name must be 'default'
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage:getBlobServiceProperties', __args__, opts=opts, typ=GetBlobServicePropertiesResult).value
...
def get_blob_service_properties_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
                                       blob_services_name: Optional[pulumi.Input[builtins.str]] = None,
