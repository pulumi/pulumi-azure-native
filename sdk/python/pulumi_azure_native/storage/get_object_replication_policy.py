...
def get_object_replication_policy(account_name: Optional[_builtins.str] = None,
                                  object_replication_policy_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str object_replication_policy_id: For the destination account, provide the value 'default'. Configure the policy on the destination account first. For the source account, provide the value of the policy ID that is returned when you download the policy that was defined on the destination account. The policy is downloaded as a JSON file.
