...
class FileServiceProperties(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if protocol_settings is not None and not isinstance(protocol_settings, ProtocolSettingsArgs):
                protocol_settings = protocol_settings or {}
                def _setter(key, value):
                    protocol_settings[key] = value
                ProtocolSettingsArgs._configure(_setter, **protocol_settings)
            __props__.__dict__["protocol_settings"] = protocol_settings
            if resource_group_name is None and not opts.urn:
                raise TypeError("Missing required property 'resource_group_name'")
            __props__.__dict__["resource_group_name"] = resource_group_name
            if share_delete_retention_policy is not None and not isinstance(share_delete_retention_policy, DeleteRetentionPolicyArgs):
                share_delete_retention_policy = share_delete_retention_policy or {}
                def _setter(key, value):
                    share_delete_retention_policy[key] = value
                DeleteRetentionPolicyArgs._configure(_setter, **share_delete_retention_policy)
