...
class GetObjectReplicationPolicyResult:
    ...
    """
    def __init__(__self__, destination_account=None, enabled_time=None, id=None, metrics=None, name=None, policy_id=None, rules=None, source_account=None, type=None):
...
def get_object_replication_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20240101:getObjectReplicationPolicy', __args__, opts=opts, typ=GetObjectReplicationPolicyResult).value
...
def get_object_replication_policy_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20240101:getObjectReplicationPolicy', __args__, opts=opts, typ=GetObjectReplicationPolicyResult)
