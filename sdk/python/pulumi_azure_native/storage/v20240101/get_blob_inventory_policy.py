...
def get_blob_inventory_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20240101:getBlobInventoryPolicy', __args__, opts=opts, typ=GetBlobInventoryPolicyResult).value
...
def get_blob_inventory_policy_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20240101:getBlobInventoryPolicy', __args__, opts=opts, typ=GetBlobInventoryPolicyResult)
