...
def get_local_user(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20240101:getLocalUser', __args__, opts=opts, typ=GetLocalUserResult).value
...
def get_local_user_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20240101:getLocalUser', __args__, opts=opts, typ=GetLocalUserResult)
