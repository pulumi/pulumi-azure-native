...
class StorageTaskAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20230501:StorageTaskAssignment"), pulumi.Alias(type_="azure-native:storage:StorageTaskAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageTaskAssignment, __self__).__init__(
            'azure-native:storage/v20240101:StorageTaskAssignment',
            resource_name,
            __props__,
            opts)
