...
class LocalUserArgs:
    def __init__(__self__, *,
                 ...
                 allow_acl_authorization: Optional[pulumi.Input[builtins.bool]] = None,
                 extended_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 group_id: Optional[pulumi.Input[builtins.int]] = None,
                 has_shared_key: Optional[pulumi.Input[builtins.bool]] = None,
                 has_ssh_key: Optional[pulumi.Input[builtins.bool]] = None,
                 has_ssh_password: Optional[pulumi.Input[builtins.bool]] = None,
                 home_directory: Optional[pulumi.Input[builtins.str]] = None,
                 is_nf_sv3_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_acl_authorization: Indicates whether ACL authorization is allowed for this user. Set it to false to disallow using ACL authorization.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] extended_groups: Supplementary group membership. Only applicable for local users enabled for NFSv3 access.
        :param pulumi.Input[builtins.int] group_id: An identifier for associating a group of users.
        :param pulumi.Input[builtins.bool] has_shared_key: Indicates whether shared key exists. Set it to false to remove existing shared key.
        :param pulumi.Input[builtins.bool] has_ssh_key: Indicates whether ssh key exists. Set it to false to remove existing SSH key.
        :param pulumi.Input[builtins.bool] has_ssh_password: Indicates whether ssh password exists. Set it to false to remove existing SSH password.
        :param pulumi.Input[builtins.str] home_directory: Optional, local user home directory.
        :param pulumi.Input[builtins.bool] is_nf_sv3_enabled: Indicates if the local user is enabled for access with NFSv3 protocol.
        ...
        :param pulumi.Input[builtins.str] username: The name of local user. The username must contain lowercase letters and numbers only. It must be unique only within the storage account.
        """
    ...
    def allow_acl_authorization(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_acl_authorization(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_acl_authorization", value)

    @property
    @pulumi.getter(name="extendedGroups")
    def extended_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    def extended_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
    ...
    def has_shared_key(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def has_shared_key(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_shared_key", value)

    @property
    @pulumi.getter(name="hasSshKey")
    def has_ssh_key(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @has_ssh_key.setter
    def has_ssh_key(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_ssh_key", value)

    @property
    @pulumi.getter(name="hasSshPassword")
    def has_ssh_password(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def has_ssh_password(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_ssh_password", value)

    @property
    @pulumi.getter(name="homeDirectory")
    def home_directory(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def home_directory(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "home_directory", value)

    @property
    @pulumi.getter(name="isNFSv3Enabled")
    def is_nf_sv3_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_nf_sv3_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LocalUser(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowAclAuthorization")
    def allow_acl_authorization(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether ACL authorization is allowed for this user. Set it to false to disallow using ACL authorization.
        """
        return pulumi.get(self, "allow_acl_authorization")
    ...
    @property
    @pulumi.getter(name="extendedGroups")
    def extended_groups(self) -> pulumi.Output[Optional[Sequence[builtins.int]]]:
        """
        Supplementary group membership. Only applicable for local users enabled for NFSv3 access.
        """
        return pulumi.get(self, "extended_groups")
    ...
    @property
    @pulumi.getter(name="hasSharedKey")
    def has_shared_key(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether shared key exists. Set it to false to remove existing shared key.
        """
        return pulumi.get(self, "has_shared_key")
    ...
    @property
    @pulumi.getter(name="hasSshKey")
    def has_ssh_key(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether ssh key exists. Set it to false to remove existing SSH key.
        """
        return pulumi.get(self, "has_ssh_key")
    ...
    @property
    @pulumi.getter(name="hasSshPassword")
    def has_ssh_password(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether ssh password exists. Set it to false to remove existing SSH password.
        """
        return pulumi.get(self, "has_ssh_password")
    ...
    @property
    @pulumi.getter(name="homeDirectory")
    def home_directory(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional, local user home directory.
        """
        return pulumi.get(self, "home_directory")
    ...
    @property
    @pulumi.getter(name="isNFSv3Enabled")
    def is_nf_sv3_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates if the local user is enabled for access with NFSv3 protocol.
        """
        return pulumi.get(self, "is_nf_sv3_enabled")
