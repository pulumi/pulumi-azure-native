...
class LocalUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] has_shared_key: Indicates whether shared key exists. Set it to false to remove existing shared key.
        :param pulumi.Input[_builtins.bool] has_ssh_key: Indicates whether ssh key exists. Set it to false to remove existing SSH key.
        :param pulumi.Input[_builtins.bool] has_ssh_password: Indicates whether ssh password exists. Set it to false to remove existing SSH password.
        :param pulumi.Input[_builtins.str] home_directory: Optional, local user home directory.
