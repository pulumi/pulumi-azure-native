...
class BlobContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if immutable_storage_with_versioning is not None and not isinstance(immutable_storage_with_versioning, ImmutableStorageWithVersioningArgs):
