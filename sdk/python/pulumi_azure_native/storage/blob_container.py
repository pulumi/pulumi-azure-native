...
class BlobContainerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_nfs_v3_root_squash: Enable NFSv3 root squash on blob container.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: A name-value pair to associate with the container as metadata.
...
class BlobContainer(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="denyEncryptionScopeOverride")
    def deny_encryption_scope_override(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Block override of encryption scope from the container default.
        """
        return pulumi.get(self, "deny_encryption_scope_override")
