...
class BlobInventoryCreationTimeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        BlobInventoryCreationTimeResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if last_n_days is None and 'lastNDays' in kwargs:
            last_n_days = kwargs['lastNDays']

        if last_n_days is not None:
            _setter("last_n_days", last_n_days)
...
class GeoReplicationStatsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        GeoReplicationStatsResponse._configure(
            ...
            can_planned_failover=can_planned_failover,
            last_sync_time=last_sync_time,
            post_failover_redundancy=post_failover_redundancy,
            post_planned_failover_redundancy=post_planned_failover_redundancy,
            status=status,
        )
    @staticmethod
    def _configure(
             ...
             can_planned_failover: Optional[bool] = None,
             last_sync_time: Optional[str] = None,
             post_failover_redundancy: Optional[str] = None,
             post_planned_failover_redundancy: Optional[str] = None,
             status: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        ...
        if can_planned_failover is None and 'canPlannedFailover' in kwargs:
            can_planned_failover = kwargs['canPlannedFailover']
        if can_planned_failover is None:
            raise TypeError("Missing 'can_planned_failover' argument")
        ...
        if post_failover_redundancy is None and 'postFailoverRedundancy' in kwargs:
            post_failover_redundancy = kwargs['postFailoverRedundancy']
        if post_failover_redundancy is None:
            raise TypeError("Missing 'post_failover_redundancy' argument")
        if post_planned_failover_redundancy is None and 'postPlannedFailoverRedundancy' in kwargs:
            post_planned_failover_redundancy = kwargs['postPlannedFailoverRedundancy']
        if post_planned_failover_redundancy is None:
            raise TypeError("Missing 'post_planned_failover_redundancy' argument")
        if status is None:
            raise TypeError("Missing 'status' argument")

        _setter("can_failover", can_failover)
        _setter("can_planned_failover", can_planned_failover)
        _setter("last_sync_time", last_sync_time)
        _setter("post_failover_redundancy", post_failover_redundancy)
        _setter("post_planned_failover_redundancy", post_planned_failover_redundancy)
        _setter("status", status)
