...
def get_table_service_properties(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20230101:getTableServiceProperties', __args__, opts=opts, typ=GetTableServicePropertiesResult).value
...
def get_table_service_properties_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['tableServiceName'] = table_service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20230101:getTableServiceProperties', __args__, opts=opts, typ=GetTableServicePropertiesResult)
