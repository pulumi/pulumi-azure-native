...
azure-native:storage/v20161201:StorageAccount is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20181101:StorageAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetStorageAccountResult:
    ...
    The storage account.
    """
    def __init__(__self__, access_tier=None, creation_time=None, custom_domain=None, enable_https_traffic_only=None, encryption=None, id=None, kind=None, last_geo_failover_time=None, location=None, name=None, primary_endpoints=None, primary_location=None, provisioning_state=None, secondary_endpoints=None, secondary_location=None, sku=None, status_of_primary=None, status_of_secondary=None, tags=None, type=None):
...
def get_storage_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_account is deprecated: Version 2016-12-01 will be removed in v2 of the provider.
azure-native:storage/v20161201:StorageAccount is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20181101:StorageAccount to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20161201:getStorageAccount', __args__, opts=opts, typ=GetStorageAccountResult).value
