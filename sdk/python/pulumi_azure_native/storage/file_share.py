...
class FileShareArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: A name-value pair to associate with the share as metadata.
...
class FileShare(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20190401:FileShare"), pulumi.Alias(type_="azure-native:storage/v20190601:FileShare"), pulumi.Alias(type_="azure-native:storage/v20200801preview:FileShare"), pulumi.Alias(type_="azure-native:storage/v20210101:FileShare"), pulumi.Alias(type_="azure-native:storage/v20210201:FileShare"), pulumi.Alias(type_="azure-native:storage/v20210401:FileShare"), pulumi.Alias(type_="azure-native:storage/v20210601:FileShare"), pulumi.Alias(type_="azure-native:storage/v20210801:FileShare"), pulumi.Alias(type_="azure-native:storage/v20210901:FileShare"), pulumi.Alias(type_="azure-native:storage/v20220501:FileShare"), pulumi.Alias(type_="azure-native:storage/v20220901:FileShare"), pulumi.Alias(type_="azure-native:storage/v20230101:FileShare"), pulumi.Alias(type_="azure-native:storage/v20230401:FileShare"), pulumi.Alias(type_="azure-native:storage/v20230501:FileShare"), pulumi.Alias(type_="azure-native:storage/v20240101:FileShare"), pulumi.Alias(type_="azure-native:storage/v20250101:FileShare"), pulumi.Alias(type_="azure-native:storage/v20250601:FileShare"), pulumi.Alias(type_="azure-native:storage/v20250801:FileShare"), pulumi.Alias(type_="azure-native:storage/v20260401:FileShare")])
