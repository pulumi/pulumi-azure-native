...
class FileShare(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20220901:FileShare"), pulumi.Alias(type_="azure-native:storage/v20230101:FileShare"), pulumi.Alias(type_="azure-native:storage/v20230401:FileShare"), pulumi.Alias(type_="azure-native:storage/v20230501:FileShare"), pulumi.Alias(type_="azure-native_storage_v20190401:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20190601:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20200801preview:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20210101:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20210201:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20210401:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20210601:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20210801:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20210901:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20220501:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20220901:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20230101:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20230401:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20230501:storage:FileShare"), pulumi.Alias(type_="azure-native_storage_v20240101:storage:FileShare")])
