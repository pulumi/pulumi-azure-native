...
def get_storage_task_assignment(account_name: Optional[builtins.str] = None,
                                resource_group_name: Optional[builtins.str] = None,
                                storage_task_assignment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str storage_task_assignment_name: The name of the storage task assignment within the specified resource group. Storage task assignment names must be between 3 and 24 characters in length and use numbers and lower-case letters only.
    """
    __args__ = dict()
...
def get_storage_task_assignment_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
                                       resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                       storage_task_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
