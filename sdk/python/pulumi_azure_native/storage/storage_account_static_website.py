...
class StorageAccountStaticWebsiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] index_document: The webpage that Azure Storage serves for requests to the root of a website or any sub-folder. For example, 'index.html'. The value is case-sensitive.
        """
