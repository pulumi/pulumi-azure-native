...
def list_storage_account_sas(account_name: Optional[_builtins.str] = None,
                             ...
                             resource_types: Optional[Union[_builtins.str, 'SignedResourceTypes']] = None,
                             services: Optional[Union[_builtins.str, 'Services']] = None,
    ...
    :param Union[_builtins.str, 'Permissions'] permissions: The signed permissions for the account SAS. Possible values include: Read (r), Write (w), Delete (d), List (l), Add (a), Create (c), Update (u) and Process (p).
    ...
    :param Union[_builtins.str, 'SignedResourceTypes'] resource_types: The signed resource types that are accessible with the account SAS. Service (s): Access to service-level APIs; Container (c): Access to container-level APIs; Object (o): Access to object-level APIs for blobs, queue messages, table entities, and files.
    :param Union[_builtins.str, 'Services'] services: The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
