...
def list_storage_account_service_sas(account_name: Optional[_builtins.str] = None,
                                     cache_control: Optional[_builtins.str] = None,
                                     canonicalized_resource: Optional[_builtins.str] = None,
                                     ...
                                     i_p_address_or_range: Optional[_builtins.str] = None,
                                     identifier: Optional[_builtins.str] = None,
                                     key_to_sign: Optional[_builtins.str] = None,
                                     partition_key_end: Optional[_builtins.str] = None,
                                     partition_key_start: Optional[_builtins.str] = None,
                                     permissions: Optional[Union[_builtins.str, 'Permissions']] = None,
                                     protocols: Optional['HttpProtocol'] = None,
                                     resource: Optional[Union[_builtins.str, 'SignedResource']] = None,
                                     resource_group_name: Optional[_builtins.str] = None,
                                     row_key_end: Optional[_builtins.str] = None,
                                     row_key_start: Optional[_builtins.str] = None,
                                     shared_access_expiry_time: Optional[_builtins.str] = None,
                                     shared_access_start_time: Optional[_builtins.str] = None,
    ...
    :param _builtins.str content_disposition: The response header override for content disposition.
    :param _builtins.str content_encoding: The response header override for content encoding.
    :param _builtins.str content_language: The response header override for content language.
    :param _builtins.str content_type: The response header override for content type.
    :param _builtins.str i_p_address_or_range: An IP address or a range of IP addresses from which to accept requests.
    :param _builtins.str identifier: A unique value up to 64 characters in length that correlates to an access policy specified for the container, queue, or table.
    :param _builtins.str key_to_sign: The key to sign the account SAS token with.
    :param _builtins.str partition_key_end: The end of partition key.
    :param _builtins.str partition_key_start: The start of partition key.
    :param Union[_builtins.str, 'Permissions'] permissions: The signed permissions for the service SAS. Possible values include: Read (r), Write (w), Delete (d), List (l), Add (a), Create (c), Update (u) and Process (p).
    :param 'HttpProtocol' protocols: The protocol permitted for a request made with the account SAS.
    :param Union[_builtins.str, 'SignedResource'] resource: The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
    ...
    :param _builtins.str row_key_end: The end of row key.
    :param _builtins.str row_key_start: The start of row key.
    :param _builtins.str shared_access_expiry_time: The time at which the shared access signature becomes invalid.
    :param _builtins.str shared_access_start_time: The time at which the SAS becomes valid.
    """
    __args__ = dict()
