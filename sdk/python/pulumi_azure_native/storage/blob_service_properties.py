...
class BlobServicePropertiesArgs:
    ...
    def _configure(
        ...
        if 'isVersioningEnabled' in kwargs:
            is_versioning_enabled = kwargs['isVersioningEnabled']
        if 'lastAccessTimeTrackingPolicy' in kwargs:
...
class BlobServiceProperties(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if change_feed is not None and not isinstance(change_feed, ChangeFeedArgs):
            ...
            if container_delete_retention_policy is not None and not isinstance(container_delete_retention_policy, DeleteRetentionPolicyArgs):
            ...
            if delete_retention_policy is not None and not isinstance(delete_retention_policy, DeleteRetentionPolicyArgs):
            ...
            if last_access_time_tracking_policy is not None and not isinstance(last_access_time_tracking_policy, LastAccessTimeTrackingPolicyArgs):
            ...
            if restore_policy is not None and not isinstance(restore_policy, RestorePolicyPropertiesArgs):
