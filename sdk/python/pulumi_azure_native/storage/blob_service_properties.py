...
class BlobServicePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 automatic_snapshot_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 is_versioning_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] automatic_snapshot_policy_enabled: Deprecated in favor of isVersioningEnabled property.
        :param pulumi.Input[builtins.str] blob_services_name: The name of the blob Service within the specified storage account. Blob Service Name must be 'default'
        ...
        :param pulumi.Input[builtins.str] default_service_version: DefaultServiceVersion indicates the default version to use for requests to the Blob service if an incoming request’s version is not specified. Possible values include version 2008-10-27 and all more recent versions.
        :param pulumi.Input['DeleteRetentionPolicyArgs'] delete_retention_policy: The blob service properties for blob soft delete.
        :param pulumi.Input[builtins.bool] is_versioning_enabled: Versioning is enabled if set to true.
    ...
    def automatic_snapshot_policy_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def automatic_snapshot_policy_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "automatic_snapshot_policy_enabled", value)

    @property
    @pulumi.getter(name="blobServicesName")
    def blob_services_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def blob_services_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_versioning_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_versioning_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BlobServiceProperties(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="automaticSnapshotPolicyEnabled")
    def automatic_snapshot_policy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Deprecated in favor of isVersioningEnabled property.
        """
        return pulumi.get(self, "automatic_snapshot_policy_enabled")
    ...
    @property
    @pulumi.getter(name="defaultServiceVersion")
    def default_service_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        DefaultServiceVersion indicates the default version to use for requests to the Blob service if an incoming request’s version is not specified. Possible values include version 2008-10-27 and all more recent versions.
        """
        return pulumi.get(self, "default_service_version")
    ...
    @property
    @pulumi.getter(name="isVersioningEnabled")
    def is_versioning_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Versioning is enabled if set to true.
        """
        return pulumi.get(self, "is_versioning_enabled")
