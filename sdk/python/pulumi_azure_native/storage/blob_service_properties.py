...
class BlobServicePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] default_service_version: DefaultServiceVersion indicates the default version to use for requests to the Blob service if an incoming request’s version is not specified. Possible values include version 2008-10-27 and all more recent versions.
        :param pulumi.Input['DeleteRetentionPolicyArgs'] delete_retention_policy: The blob service properties for blob soft delete.
        :param pulumi.Input[_builtins.bool] is_versioning_enabled: Versioning is enabled if set to true.
