...
class BlobInventoryPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] account_name: The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.
        :param pulumi.Input[str] blob_inventory_policy_name: The name of the storage account blob inventory policy. It should always be 'default'
        :param pulumi.Input[Union['BlobInventoryPolicySchemaArgs', 'BlobInventoryPolicySchemaArgsDict']] policy: The storage account blob inventory policy object. It is composed of policy rules.
        :param pulumi.Input[str] resource_group_name: The name of the resource group within the user's subscription. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20220901:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20230101:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20230401:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20230501:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20190601:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20200801preview:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20210101:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20210201:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20210401:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20210601:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20210801:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20210901:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20220501:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20220901:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20230101:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20230401:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20230501:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native_storage_v20240101:storage:BlobInventoryPolicy")])
