...
def get_blob_container_immutability_policy(account_name: Optional[_builtins.str] = None,
                                           container_name: Optional[_builtins.str] = None,
                                           immutability_policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str immutability_policy_name: The name of the blob container immutabilityPolicy within the specified storage account. ImmutabilityPolicy Name must be 'default'
