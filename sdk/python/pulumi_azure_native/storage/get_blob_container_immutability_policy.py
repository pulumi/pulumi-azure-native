...
def get_blob_container_immutability_policy(account_name: Optional[builtins.str] = None,
                                           container_name: Optional[builtins.str] = None,
                                           immutability_policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str immutability_policy_name: The name of the blob container immutabilityPolicy within the specified storage account. ImmutabilityPolicy Name must be 'default'
...
def get_blob_container_immutability_policy_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
