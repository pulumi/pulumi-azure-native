...
warnings.warn("""azure-native:storage/v20210901:LocalUser is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:LocalUser to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_local_user(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_local_user is deprecated: azure-native:storage/v20210901:LocalUser is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:LocalUser to guarantee forwards compatibility.""")
    __args__ = dict()
