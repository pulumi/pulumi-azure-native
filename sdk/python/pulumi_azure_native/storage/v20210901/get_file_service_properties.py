...
def get_file_service_properties(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_service_properties is deprecated: azure-native:storage/v20210901:FileServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileServiceProperties to guarantee forwards compatibility.""")
    __args__ = dict()
