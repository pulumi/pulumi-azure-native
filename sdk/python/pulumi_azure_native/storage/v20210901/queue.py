...
warnings.warn("""azure-native:storage/v20210901:Queue is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:Queue to guarantee forwards compatibility.""", DeprecationWarning)
...
class Queue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Queue is deprecated: azure-native:storage/v20210901:Queue is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:Queue to guarantee forwards compatibility.""")
