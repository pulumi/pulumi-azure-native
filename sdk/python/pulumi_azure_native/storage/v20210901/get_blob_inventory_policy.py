...
warnings.warn("""azure-native:storage/v20210901:BlobInventoryPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobInventoryPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_blob_inventory_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_inventory_policy is deprecated: azure-native:storage/v20210901:BlobInventoryPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobInventoryPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['blobInventoryPolicyName'] = blob_inventory_policy_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210901:getBlobInventoryPolicy', __args__, opts=opts, typ=GetBlobInventoryPolicyResult).value
