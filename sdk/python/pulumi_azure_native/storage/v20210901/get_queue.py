...
def get_queue(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_queue is deprecated: azure-native:storage/v20210901:Queue is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:Queue to guarantee forwards compatibility.""")
    __args__ = dict()
