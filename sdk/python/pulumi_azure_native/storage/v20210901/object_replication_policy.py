...
class ObjectReplicationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source_account: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ObjectReplicationPolicy is deprecated: azure-native:storage/v20210901:ObjectReplicationPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:ObjectReplicationPolicy to guarantee forwards compatibility.""")
