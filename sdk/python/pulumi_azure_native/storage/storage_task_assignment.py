...
class StorageTaskAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] storage_task_assignment_name: The name of the storage task assignment within the specified resource group. Storage task assignment names must be between 3 and 24 characters in length and use numbers and lower-case letters only.
        """
    ...
    def storage_task_assignment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_task_assignment_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StorageTaskAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20230501:StorageTaskAssignment"), pulumi.Alias(type_="azure-native:storage/v20240101:StorageTaskAssignment"), pulumi.Alias(type_="azure-native:storage/v20250101:StorageTaskAssignment")])
