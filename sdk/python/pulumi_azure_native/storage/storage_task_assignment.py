...
class StorageTaskAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] storage_task_assignment_name: The name of the storage task assignment within the specified resource group. Storage task assignment names must be between 3 and 24 characters in length and use numbers and lower-case letters only.
        """
