...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:listStorageAccountSAS'.""", DeprecationWarning)
...
def list_storage_account_sas(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:listStorageAccountSAS', __args__, opts=opts, typ=ListStorageAccountSASResult).value
