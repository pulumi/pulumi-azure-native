...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getQueue'.""", DeprecationWarning)
...
def get_queue(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_queue is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getQueue'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:getQueue', __args__, opts=opts, typ=GetQueueResult).value
