...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getStorageAccount'.""", DeprecationWarning)
...
def get_storage_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:getStorageAccount', __args__, opts=opts, typ=GetStorageAccountResult).value
