...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getBlobContainer'.""", DeprecationWarning)
...
def get_blob_container(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_container is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getBlobContainer'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:getBlobContainer', __args__, opts=opts, typ=GetBlobContainerResult).value
