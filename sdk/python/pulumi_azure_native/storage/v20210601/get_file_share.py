...
def get_file_share(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_share is deprecated: azure-native:storage/v20210601:FileShare is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210601:getFileShare', __args__, opts=opts, typ=GetFileShareResult).value
