...
warnings.warn("""azure-native:storage/v20210601:BlobContainerImmutabilityPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobContainerImmutabilityPolicy to guarantee forwards compatibility.""", DeprecationWarning)
