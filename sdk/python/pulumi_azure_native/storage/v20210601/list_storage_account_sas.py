...
def list_storage_account_sas(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210601:listStorageAccountSAS', __args__, opts=opts, typ=ListStorageAccountSASResult).value
...
def list_storage_account_sas_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20210601:listStorageAccountSAS', __args__, opts=opts, typ=ListStorageAccountSASResult)
