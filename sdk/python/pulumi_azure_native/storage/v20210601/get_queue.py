...
warnings.warn("""azure-native:storage/v20210601:Queue is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:Queue to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_queue(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_queue is deprecated: azure-native:storage/v20210601:Queue is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:Queue to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['queueName'] = queue_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210601:getQueue', __args__, opts=opts, typ=GetQueueResult).value
