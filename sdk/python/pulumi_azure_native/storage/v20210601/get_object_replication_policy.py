...
def get_object_replication_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_object_replication_policy is deprecated: azure-native:storage/v20210601:ObjectReplicationPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:ObjectReplicationPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
