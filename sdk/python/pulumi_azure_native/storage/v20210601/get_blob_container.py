...
def get_blob_container(account_name: Optional[str] = None,
    ...
    return AwaitableGetBlobContainerResult(
        ...
        deny_encryption_scope_override=pulumi.get(__ret__, 'deny_encryption_scope_override'),
        enable_nfs_v3_all_squash=pulumi.get(__ret__, 'enable_nfs_v3_all_squash'),
        enable_nfs_v3_root_squash=pulumi.get(__ret__, 'enable_nfs_v3_root_squash'),
        ...
        immutability_policy=pulumi.get(__ret__, 'immutability_policy'),
...
def get_blob_container_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20210601:getBlobContainer', __args__, opts=opts, typ=GetBlobContainerResult)
