...
def get_table(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_table is deprecated: azure-native:storage/v20210601:Table is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:Table to guarantee forwards compatibility.""")
    __args__ = dict()
