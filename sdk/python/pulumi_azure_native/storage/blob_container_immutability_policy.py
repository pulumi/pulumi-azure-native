...
class BlobContainerImmutabilityPolicyArgs:
    ...
    def _configure(
        ...
        if 'allowProtectedAppendWritesAll' in kwargs:
        ...
        if 'immutabilityPolicyName' in kwargs:
