...
def get_file_share(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210201:getFileShare', __args__, opts=opts, typ=GetFileShareResult).value
...
def get_file_share_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20210201:getFileShare', __args__, opts=opts, typ=GetFileShareResult)
