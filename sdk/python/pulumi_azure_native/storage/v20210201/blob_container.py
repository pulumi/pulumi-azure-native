...
class BlobContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blob_container = azure_native.storage.v20210201.BlobContainer("blobContainer",
            account_name="sto328",
