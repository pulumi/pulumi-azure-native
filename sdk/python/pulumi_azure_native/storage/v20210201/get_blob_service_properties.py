...
warnings.warn("""azure-native:storage/v20210201:BlobServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobServiceProperties to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_blob_service_properties(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_service_properties is deprecated: azure-native:storage/v20210201:BlobServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobServiceProperties to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['blobServicesName'] = blob_services_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210201:getBlobServiceProperties', __args__, opts=opts, typ=GetBlobServicePropertiesResult).value
