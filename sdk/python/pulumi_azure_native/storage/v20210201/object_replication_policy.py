...
class ObjectReplicationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        object_replication_policy = azure_native.storage.v20210201.ObjectReplicationPolicy("objectReplicationPolicy",
            account_name="dst112",
            ...
            rules=[{
                ...
                "filters": azure_native.storage.v20210201.ObjectReplicationPolicyFilterArgs(
                    prefix_match=[
                        "blobA",
                        "blobB",
                    ],
        ...
        ```sh
        $ pulumi import azure-native:storage/v20210201:ObjectReplicationPolicy 2a20bb73-5717-4635-985a-5d4cf777438f /subscriptions/{subscription-id}/resourceGroups/res7687/providers/Microsoft.Storage/storageAccounts/src1122/objectReplicationPolicies/2a20bb73-5717-4635-985a-5d4cf777438f 
        ```
