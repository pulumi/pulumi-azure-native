...
warnings.warn("""azure-native:storage/v20210201:ObjectReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:ObjectReplicationPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ObjectReplicationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source_account: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ObjectReplicationPolicy is deprecated: azure-native:storage/v20210201:ObjectReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:ObjectReplicationPolicy to guarantee forwards compatibility.""")
