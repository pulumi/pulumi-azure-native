...
class ObjectReplicationPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage/v20210201:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-native:storage:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:storage:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-native:storage/latest:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:storage/latest:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-native:storage/v20190601:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:storage/v20190601:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-native:storage/v20200801preview:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-native:storage/v20210101:ObjectReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:storage/v20210101:ObjectReplicationPolicy")])
