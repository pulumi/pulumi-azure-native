...
class BlobServiceProperties(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blob_service_properties = azure_native.storage.v20210201.BlobServiceProperties("blobServiceProperties",
            account_name="sto8607",
            blob_services_name="default",
            last_access_time_tracking_policy=azure_native.storage.v20210201.LastAccessTimeTrackingPolicyResponseArgs(
                blob_type=["blockBlob"],
                enable=True,
        ...
        blob_service_properties = azure_native.storage.v20210201.BlobServiceProperties("blobServiceProperties",
            account_name="sto8607",
            blob_services_name="default",
            change_feed=azure_native.storage.v20210201.ChangeFeedArgs(
                enabled=True,
                retention_in_days=7,
            ),
            ...
            delete_retention_policy=azure_native.storage.v20210201.DeleteRetentionPolicyArgs(
                days=300,
                enabled=True,
            ),
