...
def get_file_share(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20230501:getFileShare', __args__, opts=opts, typ=GetFileShareResult).value
...
def get_file_share_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['shareName'] = share_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20230501:getFileShare', __args__, opts=opts, typ=GetFileShareResult)
