...
class Table(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20190601:Table"), pulumi.Alias(type_="azure-native:storage/v20200801preview:Table"), pulumi.Alias(type_="azure-native:storage/v20210101:Table"), pulumi.Alias(type_="azure-native:storage/v20210201:Table"), pulumi.Alias(type_="azure-native:storage/v20210401:Table"), pulumi.Alias(type_="azure-native:storage/v20210601:Table"), pulumi.Alias(type_="azure-native:storage/v20210801:Table"), pulumi.Alias(type_="azure-native:storage/v20210901:Table"), pulumi.Alias(type_="azure-native:storage/v20220501:Table"), pulumi.Alias(type_="azure-native:storage/v20220901:Table"), pulumi.Alias(type_="azure-native:storage/v20230101:Table"), pulumi.Alias(type_="azure-native:storage/v20230401:Table"), pulumi.Alias(type_="azure-native:storage/v20240101:Table"), pulumi.Alias(type_="azure-native:storage:Table")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Table, __self__).__init__(
            'azure-native:storage/v20230501:Table',
            resource_name,
            __props__,
            opts)
