...
warnings.warn("""azure-native:storage/v20210801:FileShare is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_file_share(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_share is deprecated: azure-native:storage/v20210801:FileShare is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.""")
    __args__ = dict()
