...
def list_storage_account_service_sas(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210801:listStorageAccountServiceSAS', __args__, opts=opts, typ=ListStorageAccountServiceSASResult).value
...
def list_storage_account_service_sas_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20210801:listStorageAccountServiceSAS', __args__, opts=opts, typ=ListStorageAccountServiceSASResult)
