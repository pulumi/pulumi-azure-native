...
class BlobInventoryPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20190601:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20200801preview:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20210101:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20210201:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20210401:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20210601:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20210901:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20220501:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20220901:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20230101:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20230401:BlobInventoryPolicy"), pulumi.Alias(type_="azure-native:storage/v20230501:BlobInventoryPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlobInventoryPolicy, __self__).__init__(
            'azure-native:storage/v20210801:BlobInventoryPolicy',
            resource_name,
            __props__,
            opts)
