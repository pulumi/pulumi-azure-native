...
class GetBlobContainerResult:
    ...
    def default_encryption_scope(self) -> Optional[builtins.str]:
        """
    ...
    def deny_encryption_scope_override(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_nfs_v3_all_squash(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_nfs_v3_root_squash(self) -> Optional[builtins.bool]:
        """
    ...
    def has_immutability_policy(self) -> builtins.bool:
        """
    ...
    def public_access(self) -> Optional[builtins.str]:
        """
...
def get_blob_container(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str container_name: The name of the blob container within the specified storage account. Blob container names must be between 3 and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must be immediately preceded and followed by a letter or number.
...
def get_blob_container_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
