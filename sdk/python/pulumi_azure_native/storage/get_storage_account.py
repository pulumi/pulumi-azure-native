...
class GetStorageAccountResult:
    ...
    def account_migration_in_progress(self) -> builtins.bool:
        """
    ...
    def allow_cross_tenant_replication(self) -> Optional[builtins.bool]:
        """
    ...
    def allow_shared_key_access(self) -> Optional[builtins.bool]:
        """
    ...
    def allowed_copy_scope(self) -> Optional[builtins.str]:
        """
    ...
    def default_to_o_auth_authentication(self) -> Optional[builtins.bool]:
        """
    ...
    def dns_endpoint_type(self) -> Optional[builtins.str]:
        """
    ...
    def enable_extended_groups(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_https_traffic_only(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_nfs_v3(self) -> Optional[builtins.bool]:
        """
    ...
    def failover_in_progress(self) -> builtins.bool:
        """
    ...
    def is_hns_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_local_user_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_sftp_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_sku_conversion_blocked(self) -> builtins.bool:
        """
    ...
    def large_file_shares_state(self) -> Optional[builtins.str]:
        """
    ...
    def last_geo_failover_time(self) -> builtins.str:
        """
    ...
    def status_of_primary(self) -> builtins.str:
        """
    ...
    def status_of_secondary(self) -> builtins.str:
        """
...
def get_storage_account(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str expand: May be used to expand the properties within account's properties. By default, data is not included when fetching properties. Currently we only support geoReplicationStats and blobRestoreStatus.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage:getStorageAccount', __args__, opts=opts, typ=GetStorageAccountResult).value
...
def get_storage_account_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
