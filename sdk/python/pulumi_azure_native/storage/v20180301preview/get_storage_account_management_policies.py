...
__all__ = [
    ...
    'get_storage_account_management_policies_output',
]
...
def get_storage_account_management_policies(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_account_management_policies is deprecated: Version v20180301preview will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20180301preview:getStorageAccountManagementPolicies', __args__, opts=opts, typ=GetStorageAccountManagementPoliciesResult).value
...
@_utilities.lift_output_func(get_storage_account_management_policies)
def get_storage_account_management_policies_output(account_name: Optional[pulumi.Input[str]] = None,
