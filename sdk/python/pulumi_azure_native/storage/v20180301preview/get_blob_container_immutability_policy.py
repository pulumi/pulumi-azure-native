...
def get_blob_container_immutability_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_container_immutability_policy is deprecated: Version v20180301preview will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
