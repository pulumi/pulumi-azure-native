...
def get_storage_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_account is deprecated: Version v20180301preview will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
