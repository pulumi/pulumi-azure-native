...
azure-native:storage/v20160101:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20181101:StorageAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_storage_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_account is deprecated: Version 2016-01-01 will be removed in v2 of the provider.
azure-native:storage/v20160101:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20181101:StorageAccount to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20160101:getStorageAccount', __args__, opts=opts, typ=GetStorageAccountResult).value
