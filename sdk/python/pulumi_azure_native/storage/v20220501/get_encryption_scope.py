...
def get_encryption_scope(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_encryption_scope is deprecated: azure-native:storage/v20220501:EncryptionScope is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:EncryptionScope to guarantee forwards compatibility.""")
    __args__ = dict()
