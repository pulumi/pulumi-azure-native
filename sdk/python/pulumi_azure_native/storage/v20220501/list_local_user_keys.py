...
def list_local_user_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20220501:listLocalUserKeys', __args__, opts=opts, typ=ListLocalUserKeysResult).value
...
def list_local_user_keys_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage/v20220501:listLocalUserKeys', __args__, opts=opts, typ=ListLocalUserKeysResult)
