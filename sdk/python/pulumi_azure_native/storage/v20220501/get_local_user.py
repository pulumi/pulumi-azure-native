...
def get_local_user(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_local_user is deprecated: azure-native:storage/v20220501:LocalUser is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:LocalUser to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['username'] = username
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20220501:getLocalUser', __args__, opts=opts, typ=GetLocalUserResult).value
