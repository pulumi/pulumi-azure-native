...
warnings.warn("""azure-native:storage/v20220501:LocalUser is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:LocalUser to guarantee forwards compatibility.""", DeprecationWarning)
...
class LocalUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 username: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""LocalUser is deprecated: azure-native:storage/v20220501:LocalUser is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:LocalUser to guarantee forwards compatibility.""")
