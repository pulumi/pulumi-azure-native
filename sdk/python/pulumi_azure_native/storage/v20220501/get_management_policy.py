...
warnings.warn("""azure-native:storage/v20220501:ManagementPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:ManagementPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_management_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_management_policy is deprecated: azure-native:storage/v20220501:ManagementPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:ManagementPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
