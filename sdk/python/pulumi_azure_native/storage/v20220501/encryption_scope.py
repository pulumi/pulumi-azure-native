...
warnings.warn("""azure-native:storage/v20220501:EncryptionScope is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:EncryptionScope to guarantee forwards compatibility.""", DeprecationWarning)
...
class EncryptionScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 state: Optional[pulumi.Input[Union[str, 'EncryptionScopeState']]] = None,
                 __props__=None):
        pulumi.log.warn("""EncryptionScope is deprecated: azure-native:storage/v20220501:EncryptionScope is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:EncryptionScope to guarantee forwards compatibility.""")
