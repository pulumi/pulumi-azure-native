...
class BlobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] blob_name: The name of the storage blob. Must be unique within the storage container the blob is located. If this property is not specified it will be set to the name of the resource.
        :param pulumi.Input[_builtins.str] content_md5: The MD5 sum of the blob contents, base64-encoded. Cannot be defined if blob type is Append.
        :param pulumi.Input[_builtins.str] content_type: The content type of the storage blob. Defaults to `application/octet-stream`.
