...
class BlobArgs:
    def __init__(__self__, *,
                 ...
                 blob_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] account_name: Specifies the storage account in which to create the storage container.
        :param pulumi.Input[builtins.str] container_name: The name of the storage container in which this blob should be created.
        ...
        :param pulumi.Input[builtins.str] blob_name: The name of the storage blob. Must be unique within the storage container the blob is located. If this property is not specified it will be set to the name of the resource.
        :param pulumi.Input[builtins.str] content_md5: The MD5 sum of the blob contents, base64-encoded. Cannot be defined if blob type is Append.
        :param pulumi.Input[builtins.str] content_type: The content type of the storage blob. Defaults to `application/octet-stream`.
    ...
    def blob_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @blob_name.setter
    def blob_name(self, value: Optional[pulumi.Input[builtins.str]]):
