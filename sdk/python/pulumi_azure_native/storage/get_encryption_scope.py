...
class GetEncryptionScopeResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, creation_time=None, id=None, key_vault_properties=None, last_modified_time=None, name=None, require_infrastructure_encryption=None, source=None, state=None, type=None):
...
def get_encryption_scope(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str encryption_scope_name: The name of the encryption scope within the specified storage account. Encryption scope names must be between 3 and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must be immediately preceded and followed by a letter or number.
...
def get_encryption_scope_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage:getEncryptionScope', __args__, opts=opts, typ=GetEncryptionScopeResult)
