...
def get_queue_service_properties(account_name: Optional[builtins.str] = None,
                                 queue_service_name: Optional[builtins.str] = None,
    ...
    :param builtins.str queue_service_name: The name of the Queue Service within the specified storage account. Queue Service Name must be 'default'
...
def get_queue_service_properties_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
                                        queue_service_name: Optional[pulumi.Input[builtins.str]] = None,
