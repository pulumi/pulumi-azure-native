...
def get_queue_service_properties(account_name: Optional[_builtins.str] = None,
                                 queue_service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str queue_service_name: The name of the Queue Service within the specified storage account. Queue Service Name must be 'default'
...
def get_queue_service_properties_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
                                        queue_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
