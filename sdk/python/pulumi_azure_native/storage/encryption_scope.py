...
class EncryptionScopeArgs:
    def __init__(__self__, *,
                 ...
                 source: Optional[pulumi.Input[Union[builtins.str, 'EncryptionScopeSource']]] = None,
        ...
        :param pulumi.Input[builtins.str] encryption_scope_name: The name of the encryption scope within the specified storage account. Encryption scope names must be between 3 and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must be immediately preceded and followed by a letter or number.
        ...
        :param pulumi.Input[Union[builtins.str, 'EncryptionScopeSource']] source: The provider for the encryption scope. Possible values (case-insensitive):  Microsoft.Storage, Microsoft.KeyVault.
        :param pulumi.Input[Union[builtins.str, 'EncryptionScopeState']] state: The state of the encryption scope. Possible values (case-insensitive):  Enabled, Disabled.
        """
    ...
    @property
    @pulumi.getter
    def source(self) -> Optional[pulumi.Input[Union[builtins.str, 'EncryptionScopeSource']]]:
        """
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input[Union[builtins.str, 'EncryptionScopeSource']]]):
...
class EncryptionScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20190601:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20200801preview:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20210101:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20210201:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20210401:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20210601:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20210801:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20210901:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20220501:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20220901:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20230101:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20230401:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20230501:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20240101:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20250101:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20250601:EncryptionScope")])
    ...
    @property
    @pulumi.getter(name="requireInfrastructureEncryption")
    def require_infrastructure_encryption(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean indicating whether or not the service applies a secondary layer of encryption with platform managed keys for data at rest.
        """
        return pulumi.get(self, "require_infrastructure_encryption")
