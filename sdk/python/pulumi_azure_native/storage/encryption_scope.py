...
class EncryptionScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20220901:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20230101:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20230401:EncryptionScope"), pulumi.Alias(type_="azure-native:storage/v20230501:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20190601:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20200801preview:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20210101:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20210201:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20210401:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20210601:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20210801:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20210901:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20220501:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20220901:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20230101:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20230401:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20230501:storage:EncryptionScope"), pulumi.Alias(type_="azure-native_storage_v20240101:storage:EncryptionScope")])
