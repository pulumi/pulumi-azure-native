...
def get_management_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_management_policy is deprecated: Version v20181101 will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20181101:getManagementPolicy', __args__, opts=opts, typ=GetManagementPolicyResult).value
