...
def get_local_user(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str username: The name of local user. The username must contain lowercase letters and numbers only. It must be unique only within the storage account.
    """
    __args__ = dict()
...
def get_local_user_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
