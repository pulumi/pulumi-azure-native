...
class GetLocalUserResult:
    ...
    def allow_acl_authorization(self) -> Optional[builtins.bool]:
        """
    ...
    def extended_groups(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    def has_shared_key(self) -> Optional[builtins.bool]:
        """
    ...
    def has_ssh_key(self) -> Optional[builtins.bool]:
        """
    ...
    def has_ssh_password(self) -> Optional[builtins.bool]:
        """
    ...
    def is_nf_sv3_enabled(self) -> Optional[builtins.bool]:
        """
...
def get_local_user(account_name: Optional[builtins.str] = None,
...
def get_local_user_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage:getLocalUser', __args__, opts=opts, typ=GetLocalUserResult)
