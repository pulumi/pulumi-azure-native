...
class ConnectorArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['StorageConnectorPropertiesArgs'],
        ...
        :param pulumi.Input['StorageConnectorPropertiesArgs'] properties: The properties of the Storage Connector.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] connector_name: The name of the Storage Connector.
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input['StorageConnectorPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['StorageConnectorPropertiesArgs']):
...
@pulumi.type_token("azure-native:storage:Connector")
class Connector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 connector_name: Optional[pulumi.Input[_builtins.str]] = None,
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['StorageConnectorPropertiesArgs', 'StorageConnectorPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] connector_name: The name of the Storage Connector.
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['StorageConnectorPropertiesArgs', 'StorageConnectorPropertiesArgsDict']] properties: The properties of the Storage Connector.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage/v20250801:Connector"), pulumi.Alias(type_="azure-native:storage/v20260401:Connector")])
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StorageConnectorPropertiesResponse']:
        """
        The properties of the Storage Connector.
        """
        return pulumi.get(self, "properties")
