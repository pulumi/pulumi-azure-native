...
def get_file_service_properties(account_name: Optional[builtins.str] = None,
                                file_services_name: Optional[builtins.str] = None,
    ...
    :param builtins.str file_services_name: The name of the file Service within the specified storage account. File Service Name must be "default"
...
def get_file_service_properties_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
                                       file_services_name: Optional[pulumi.Input[builtins.str]] = None,
