...
warnings.warn("""azure-native:storage/v20210401:BlobServiceProperties is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobServiceProperties to guarantee forwards compatibility.""", DeprecationWarning)
...
class BlobServiceProperties(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 restore_policy: Optional[pulumi.Input[pulumi.InputType['RestorePolicyPropertiesArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""BlobServiceProperties is deprecated: azure-native:storage/v20210401:BlobServiceProperties is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobServiceProperties to guarantee forwards compatibility.""")
