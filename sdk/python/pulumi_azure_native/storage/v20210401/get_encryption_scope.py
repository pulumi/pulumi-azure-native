...
def get_encryption_scope(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_encryption_scope is deprecated: azure-native:storage/v20210401:EncryptionScope is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:EncryptionScope to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['encryptionScopeName'] = encryption_scope_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210401:getEncryptionScope', __args__, opts=opts, typ=GetEncryptionScopeResult).value
