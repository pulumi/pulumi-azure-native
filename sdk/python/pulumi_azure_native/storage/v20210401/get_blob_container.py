...
def get_blob_container(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_container is deprecated: azure-native:storage/v20210401:BlobContainer is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobContainer to guarantee forwards compatibility.""")
    __args__ = dict()
