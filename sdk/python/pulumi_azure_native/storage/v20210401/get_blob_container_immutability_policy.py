...
warnings.warn("""azure-native:storage/v20210401:BlobContainerImmutabilityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobContainerImmutabilityPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_blob_container_immutability_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210401:getBlobContainerImmutabilityPolicy', __args__, opts=opts, typ=GetBlobContainerImmutabilityPolicyResult).value
