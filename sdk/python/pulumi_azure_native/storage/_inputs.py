...
class AccessPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] expiry_time: Expiry time of the access policy
        :param pulumi.Input[builtins.str] permission: List of abbreviated permissions.
        :param pulumi.Input[builtins.str] start_time: Start time of the access policy
        """
...
if not MYPY:
    class AccountImmutabilityPolicyPropertiesArgsDict(TypedDict):
        ...
        """
        allow_protected_append_writes: NotRequired[pulumi.Input[builtins.bool]]
        """
        This property can only be changed for disabled and unlocked time-based retention policies. When enabled, new blocks can be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted.
        """
        immutability_period_since_creation_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
        The immutability period for the blobs in the container since the policy creation, in days.
        """
        state: NotRequired[pulumi.Input[Union[builtins.str, 'AccountImmutabilityPolicyState']]]
        """
...
class AccountImmutabilityPolicyPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'AccountImmutabilityPolicyState']]] = None):
        """
        This defines account-level immutability policy properties.
        :param pulumi.Input[builtins.bool] allow_protected_append_writes: This property can only be changed for disabled and unlocked time-based retention policies. When enabled, new blocks can be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted.
        ...
        :param pulumi.Input[Union[builtins.str, 'AccountImmutabilityPolicyState']] state: The ImmutabilityPolicy state defines the mode of the policy. Disabled state disables the policy, Unlocked state allows increase and decrease of immutability retention time and also allows toggling allowProtectedAppendWrites property, Locked state only allows the increase of the immutability retention time. A policy can only be created in a Disabled or Unlocked state and can be toggled between the two states. Only a policy in an Unlocked state can transition to a Locked state which cannot be reverted.
        """
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input[Union[builtins.str, 'AccountImmutabilityPolicyState']]]:
        """
        The ImmutabilityPolicy state defines the mode of the policy. Disabled state disables the policy, Unlocked state allows increase and decrease of immutability retention time and also allows toggling allowProtectedAppendWrites property, Locked state only allows the increase of the immutability retention time. A policy can only be created in a Disabled or Unlocked state and can be toggled between the two states. Only a policy in an Unlocked state can transition to a Locked state which cannot be reverted.
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[builtins.str, 'AccountImmutabilityPolicyState']]]):
...
if not MYPY:
    class ActiveDirectoryPropertiesArgsDict(TypedDict):
        ...
        """
        account_type: NotRequired[pulumi.Input[Union[builtins.str, 'AccountType']]]
        """
        Specifies the Active Directory account type for Azure Storage.
        """
        azure_storage_sid: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        net_bios_domain_name: NotRequired[pulumi.Input[builtins.str]]
        """
        Specifies the NetBIOS domain name.
        """
        sam_account_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ActiveDirectoryPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 azure_storage_sid: Optional[pulumi.Input[builtins.str]] = None,
                 domain_sid: Optional[pulumi.Input[builtins.str]] = None,
                 forest_name: Optional[pulumi.Input[builtins.str]] = None,
                 net_bios_domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 sam_account_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Settings properties for Active Directory (AD).
        ...
        :param pulumi.Input[Union[builtins.str, 'AccountType']] account_type: Specifies the Active Directory account type for Azure Storage.
        :param pulumi.Input[builtins.str] azure_storage_sid: Specifies the security identifier (SID) for Azure Storage.
        :param pulumi.Input[builtins.str] domain_sid: Specifies the security identifier (SID).
        :param pulumi.Input[builtins.str] forest_name: Specifies the Active Directory forest to get.
        :param pulumi.Input[builtins.str] net_bios_domain_name: Specifies the NetBIOS domain name.
        :param pulumi.Input[builtins.str] sam_account_name: Specifies the Active Directory SAMAccountName for Azure Storage.
        """
    ...
    def account_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'AccountType']]]:
        """
        Specifies the Active Directory account type for Azure Storage.
        """
    ...
    @account_type.setter
    def account_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'AccountType']]]):
        pulumi.set(self, "account_type", value)

    @property
    @pulumi.getter(name="azureStorageSid")
    def azure_storage_sid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the security identifier (SID) for Azure Storage.
        """
    ...
    def azure_storage_sid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def net_bios_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the NetBIOS domain name.
        """
    ...
    def net_bios_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "net_bios_domain_name", value)

    @property
    @pulumi.getter(name="samAccountName")
    def sam_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Active Directory SAMAccountName for Azure Storage.
        """
    ...
    def sam_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AzureFilesIdentityBasedAuthenticationArgsDict(TypedDict):
        ...
        """
        directory_service_options: pulumi.Input[Union[builtins.str, 'DirectoryServiceOptions']]
        """
        ...
        """
        default_share_permission: NotRequired[pulumi.Input[Union[builtins.str, 'DefaultSharePermission']]]
        """
...
class AzureFilesIdentityBasedAuthenticationArgs:
    def __init__(__self__, *,
                 ...
                 default_share_permission: Optional[pulumi.Input[Union[builtins.str, 'DefaultSharePermission']]] = None):
        """
        Settings for Azure Files identity based authentication.
        :param pulumi.Input[Union[builtins.str, 'DirectoryServiceOptions']] directory_service_options: Indicates the directory service used. Note that this enum may be extended in the future.
        ...
        :param pulumi.Input[Union[builtins.str, 'DefaultSharePermission']] default_share_permission: Default share permission for users using Kerberos authentication if RBAC role is not assigned.
        """
    ...
    def directory_service_options(self) -> pulumi.Input[Union[builtins.str, 'DirectoryServiceOptions']]:
        """
        Indicates the directory service used. Note that this enum may be extended in the future.
        """
    ...
    def directory_service_options(self, value: pulumi.Input[Union[builtins.str, 'DirectoryServiceOptions']]):
    ...
    def default_share_permission(self) -> Optional[pulumi.Input[Union[builtins.str, 'DefaultSharePermission']]]:
        """
        Default share permission for users using Kerberos authentication if RBAC role is not assigned.
        """
    ...
    def default_share_permission(self, value: Optional[pulumi.Input[Union[builtins.str, 'DefaultSharePermission']]]):
...
if not MYPY:
    class BlobInventoryCreationTimeArgsDict(TypedDict):
        ...
        """
        last_n_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class BlobInventoryCreationTimeArgs:
    def __init__(__self__, *,
                 last_n_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        This property defines the creation time based filtering condition. Blob Inventory schema parameter 'Creation-Time' is mandatory with this filter.
        :param pulumi.Input[builtins.int] last_n_days: When set the policy filters the objects that are created in the last N days. Where N is an integer value between 1 to 36500.
        """
    ...
    def last_n_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        When set the policy filters the objects that are created in the last N days. Where N is an integer value between 1 to 36500.
        """
    ...
    @last_n_days.setter
    def last_n_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class BlobInventoryPolicyDefinitionArgsDict(TypedDict):
        ...
        """
        object_type: pulumi.Input[Union[builtins.str, 'ObjectType']]
        """
        This is a required field. This field specifies the scope of the inventory created either at the blob or container level.
        """
        schedule: pulumi.Input[Union[builtins.str, 'Schedule']]
        """
...
class BlobInventoryPolicyDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        An object that defines the blob inventory rule.
        :param pulumi.Input[Union[builtins.str, 'Format']] format: This is a required field, it specifies the format for the inventory files.
        :param pulumi.Input[Union[builtins.str, 'ObjectType']] object_type: This is a required field. This field specifies the scope of the inventory created either at the blob or container level.
        :param pulumi.Input[Union[builtins.str, 'Schedule']] schedule: This is a required field. This field is used to schedule an inventory formation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schema_fields: This is a required field. This field specifies the fields and properties of the object to be included in the inventory. The Schema field value 'Name' is always required. The valid values for this field for the 'Blob' definition.objectType include 'Name, Creation-Time, Last-Modified, Content-Length, Content-MD5, BlobType, AccessTier, AccessTierChangeTime, AccessTierInferred, Tags, Expiry-Time, hdi_isfolder, Owner, Group, Permissions, Acl, Snapshot, VersionId, IsCurrentVersion, Metadata, LastAccessTime, Tags, Etag, ContentType, ContentEncoding, ContentLanguage, ContentCRC64, CacheControl, ContentDisposition, LeaseStatus, LeaseState, LeaseDuration, ServerEncrypted, Deleted, DeletionId, DeletedTime, RemainingRetentionDays, ImmutabilityPolicyUntilDate, ImmutabilityPolicyMode, LegalHold, CopyId, CopyStatus, CopySource, CopyProgress, CopyCompletionTime, CopyStatusDescription, CustomerProvidedKeySha256, RehydratePriority, ArchiveStatus, XmsBlobSequenceNumber, EncryptionScope, IncrementalCopy, TagCount'. For Blob object type schema field value 'DeletedTime' is applicable only for Hns enabled accounts. The valid values for 'Container' definition.objectType include 'Name, Last-Modified, Metadata, LeaseStatus, LeaseState, LeaseDuration, PublicAccess, HasImmutabilityPolicy, HasLegalHold, Etag, DefaultEncryptionScope, DenyEncryptionScopeOverride, ImmutableStorageWithVersioningEnabled, Deleted, Version, DeletedTime, RemainingRetentionDays'. Schema field values 'Expiry-Time, hdi_isfolder, Owner, Group, Permissions, Acl, DeletionId' are valid only for Hns enabled accounts.Schema field values 'Tags, TagCount' are only valid for Non-Hns accounts.
    ...
    def object_type(self) -> pulumi.Input[Union[builtins.str, 'ObjectType']]:
        """
        This is a required field. This field specifies the scope of the inventory created either at the blob or container level.
        """
    ...
    @object_type.setter
    def object_type(self, value: pulumi.Input[Union[builtins.str, 'ObjectType']]):
        pulumi.set(self, "object_type", value)

    @property
    @pulumi.getter
    def schedule(self) -> pulumi.Input[Union[builtins.str, 'Schedule']]:
        """
        This is a required field. This field is used to schedule an inventory formation.
        """
    ...
    @schedule.setter
    def schedule(self, value: pulumi.Input[Union[builtins.str, 'Schedule']]):
...
if not MYPY:
    class BlobInventoryPolicyFilterArgsDict(TypedDict):
        ...
        """
        blob_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        exclude_prefix: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        prefix_match: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BlobInventoryPolicyFilterArgs:
    def __init__(__self__, *,
                 blob_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 creation_time: Optional[pulumi.Input['BlobInventoryCreationTimeArgs']] = None,
                 exclude_prefix: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 prefix_match: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        An object that defines the blob inventory rule filter conditions. For 'Blob' definition.objectType all filter properties are applicable, 'blobTypes' is required and others are optional. For 'Container' definition.objectType only prefixMatch is applicable and is optional.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] blob_types: An array of predefined enum values. Valid values include blockBlob, appendBlob, pageBlob. Hns accounts does not support pageBlobs. This field is required when definition.objectType property is set to 'Blob'.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_prefix: An array of strings with maximum 10 blob prefixes to be excluded from the inventory.
        :param pulumi.Input[builtins.bool] include_blob_versions: Includes blob versions in blob inventory when value is set to true. The definition.schemaFields values 'VersionId and IsCurrentVersion' are required if this property is set to true, else they must be excluded.
        :param pulumi.Input[builtins.bool] include_deleted: For 'Container' definition.objectType the definition.schemaFields must include 'Deleted, Version, DeletedTime and RemainingRetentionDays'. For 'Blob' definition.objectType and HNS enabled storage accounts the definition.schemaFields must include 'DeletionId, Deleted, DeletedTime and RemainingRetentionDays' and for Hns disabled accounts the definition.schemaFields must include 'Deleted and RemainingRetentionDays', else it must be excluded.
        :param pulumi.Input[builtins.bool] include_snapshots: Includes blob snapshots in blob inventory when value is set to true. The definition.schemaFields value 'Snapshot' is required if this property is set to true, else it must be excluded.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefix_match: An array of strings with maximum 10 blob prefixes to be included in the inventory.
        """
    ...
    def blob_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of predefined enum values. Valid values include blockBlob, appendBlob, pageBlob. Hns accounts does not support pageBlobs. This field is required when definition.objectType property is set to 'Blob'.
        """
    ...
    @blob_types.setter
    def blob_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def exclude_prefix(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of strings with maximum 10 blob prefixes to be excluded from the inventory.
        """
    ...
    def exclude_prefix(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def prefix_match(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of strings with maximum 10 blob prefixes to be included in the inventory.
        """
    ...
    @prefix_match.setter
    def prefix_match(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class BlobInventoryPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination: Container name where blob inventory files are stored. Must be pre-created.
        :param pulumi.Input[builtins.bool] enabled: Rule is enabled when set to true.
        :param pulumi.Input[builtins.str] name: A rule name can contain any combination of alpha numeric characters. Rule name is case-sensitive. It must be unique within a policy.
        """
...
if not MYPY:
    class BlobInventoryPolicySchemaArgsDict(TypedDict):
        ...
        """
        type: pulumi.Input[Union[builtins.str, 'InventoryRuleType']]
        """
...
class BlobInventoryPolicySchemaArgs:
    def __init__(__self__, *,
        ...
        """
        The storage account blob inventory policy rules.
        :param pulumi.Input[builtins.bool] enabled: Policy is enabled if set to true.
        ...
        :param pulumi.Input[Union[builtins.str, 'InventoryRuleType']] type: The valid value is Inventory
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[builtins.str, 'InventoryRuleType']]:
        """
        The valid value is Inventory
        """
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[builtins.str, 'InventoryRuleType']]):
...
class ChangeFeedArgs:
    def __init__(__self__, *,
        ...
        """
        The blob service properties for change feed events.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether change feed event logging is enabled for the Blob service.
        :param pulumi.Input[builtins.int] retention_in_days: Indicates the duration of changeFeed retention in days. Minimum value is 1 day and maximum value is 146000 days (400 years). A null value indicates an infinite retention of the change feed.
        """
...
if not MYPY:
    class CorsRuleArgsDict(TypedDict):
        ...
        """
        allowed_methods: pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AllowedMethods']]]]
        """
...
class CorsRuleArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies a CORS rule for the Blob service.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_headers: Required if CorsRule element is present. A list of headers allowed to be part of the cross-origin request.
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AllowedMethods']]]] allowed_methods: Required if CorsRule element is present. A list of HTTP methods that are allowed to be executed by the origin.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exposed_headers: Required if CorsRule element is present. A list of response headers to expose to CORS clients.
        :param pulumi.Input[builtins.int] max_age_in_seconds: Required if CorsRule element is present. The number of seconds that the client/browser should cache a preflight response.
        """
    ...
    def allowed_methods(self) -> pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AllowedMethods']]]]:
        """
        Required if CorsRule element is present. A list of HTTP methods that are allowed to be executed by the origin.
        """
    ...
    def allowed_methods(self, value: pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AllowedMethods']]]]):
...
if not MYPY:
    class CustomDomainArgsDict(TypedDict):
        ...
        """
        use_sub_domain_name: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CustomDomainArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 use_sub_domain_name: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The custom domain assigned to this storage account. This can be set via Update.
        :param pulumi.Input[builtins.str] name: Gets or sets the custom domain name assigned to the storage account. Name is the CNAME source.
        :param pulumi.Input[builtins.bool] use_sub_domain_name: Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.
        """
        pulumi.set(__self__, "name", name)
    ...
    def use_sub_domain_name(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates.
        """
    ...
    def use_sub_domain_name(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class DateAfterCreationArgsDict(TypedDict):
        ...
        """
        days_after_creation_greater_than: pulumi.Input[builtins.float]
        """
        Value indicating the age in days after creation
        """
        days_after_last_tier_change_greater_than: NotRequired[pulumi.Input[builtins.float]]
        """
...
class DateAfterCreationArgs:
    def __init__(__self__, *,
                 days_after_creation_greater_than: pulumi.Input[builtins.float],
                 days_after_last_tier_change_greater_than: Optional[pulumi.Input[builtins.float]] = None):
        """
        Object to define snapshot and version action conditions.
        :param pulumi.Input[builtins.float] days_after_creation_greater_than: Value indicating the age in days after creation
        :param pulumi.Input[builtins.float] days_after_last_tier_change_greater_than: Value indicating the age in days after last blob tier change time. This property is only applicable for tierToArchive actions and requires daysAfterCreationGreaterThan to be set for snapshots and blob version based actions. The blob will be archived if both the conditions are satisfied.
        """
    ...
    def days_after_creation_greater_than(self) -> pulumi.Input[builtins.float]:
        """
        Value indicating the age in days after creation
        """
    ...
    def days_after_creation_greater_than(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "days_after_creation_greater_than", value)

    @property
    @pulumi.getter(name="daysAfterLastTierChangeGreaterThan")
    def days_after_last_tier_change_greater_than(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Value indicating the age in days after last blob tier change time. This property is only applicable for tierToArchive actions and requires daysAfterCreationGreaterThan to be set for snapshots and blob version based actions. The blob will be archived if both the conditions are satisfied.
        """
    ...
    def days_after_last_tier_change_greater_than(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class DateAfterModificationArgsDict(TypedDict):
        ...
        """
        days_after_creation_greater_than: NotRequired[pulumi.Input[builtins.float]]
        """
        Value indicating the age in days after blob creation.
        """
        days_after_last_access_time_greater_than: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        days_after_modification_greater_than: NotRequired[pulumi.Input[builtins.float]]
        """
...
class DateAfterModificationArgs:
    def __init__(__self__, *,
                 days_after_creation_greater_than: Optional[pulumi.Input[builtins.float]] = None,
                 days_after_last_access_time_greater_than: Optional[pulumi.Input[builtins.float]] = None,
                 days_after_last_tier_change_greater_than: Optional[pulumi.Input[builtins.float]] = None,
                 days_after_modification_greater_than: Optional[pulumi.Input[builtins.float]] = None):
        """
        Object to define the base blob action conditions. Properties daysAfterModificationGreaterThan, daysAfterLastAccessTimeGreaterThan and daysAfterCreationGreaterThan are mutually exclusive. The daysAfterLastTierChangeGreaterThan property is only applicable for tierToArchive actions which requires daysAfterModificationGreaterThan to be set, also it cannot be used in conjunction with daysAfterLastAccessTimeGreaterThan or daysAfterCreationGreaterThan.
        :param pulumi.Input[builtins.float] days_after_creation_greater_than: Value indicating the age in days after blob creation.
        :param pulumi.Input[builtins.float] days_after_last_access_time_greater_than: Value indicating the age in days after last blob access. This property can only be used in conjunction with last access time tracking policy
        :param pulumi.Input[builtins.float] days_after_last_tier_change_greater_than: Value indicating the age in days after last blob tier change time. This property is only applicable for tierToArchive actions and requires daysAfterModificationGreaterThan to be set for baseBlobs based actions. The blob will be archived if both the conditions are satisfied.
        :param pulumi.Input[builtins.float] days_after_modification_greater_than: Value indicating the age in days after last modification
        """
    ...
    @property
    @pulumi.getter(name="daysAfterCreationGreaterThan")
    def days_after_creation_greater_than(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Value indicating the age in days after blob creation.
        """
        return pulumi.get(self, "days_after_creation_greater_than")
    ...
    @days_after_creation_greater_than.setter
    def days_after_creation_greater_than(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "days_after_creation_greater_than", value)

    @property
    @pulumi.getter(name="daysAfterLastAccessTimeGreaterThan")
    def days_after_last_access_time_greater_than(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Value indicating the age in days after last blob access. This property can only be used in conjunction with last access time tracking policy
        """
    ...
    def days_after_last_access_time_greater_than(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def days_after_modification_greater_than(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Value indicating the age in days after last modification
        """
    ...
    def days_after_modification_greater_than(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class DeleteRetentionPolicyArgsDict(TypedDict):
        ...
        """
        allow_permanent_delete: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DeleteRetentionPolicyArgs:
    def __init__(__self__, *,
                 allow_permanent_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 days: Optional[pulumi.Input[builtins.int]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The service properties for soft delete.
        :param pulumi.Input[builtins.bool] allow_permanent_delete: This property when set to true allows deletion of the soft deleted blob versions and snapshots. This property cannot be used blob restore policy. This property only applies to blob service and does not apply to containers or file share.
        :param pulumi.Input[builtins.int] days: Indicates the number of days that the deleted item should be retained. The minimum specified value can be 1 and the maximum value can be 365.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether DeleteRetentionPolicy is enabled.
        """
    ...
    def allow_permanent_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This property when set to true allows deletion of the soft deleted blob versions and snapshots. This property cannot be used blob restore policy. This property only applies to blob service and does not apply to containers or file share.
        """
    ...
    def allow_permanent_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class EncryptionIdentityArgsDict(TypedDict):
        ...
        """
        encryption_federated_identity_client_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ClientId of the multi-tenant application to be used in conjunction with the user-assigned identity for cross-tenant customer-managed-keys server-side encryption on the storage account.
        """
        encryption_user_assigned_identity: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EncryptionIdentityArgs:
    def __init__(__self__, *,
                 encryption_federated_identity_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_user_assigned_identity: Optional[pulumi.Input[builtins.str]] = None):
        """
        Encryption identity for the storage account.
        :param pulumi.Input[builtins.str] encryption_federated_identity_client_id: ClientId of the multi-tenant application to be used in conjunction with the user-assigned identity for cross-tenant customer-managed-keys server-side encryption on the storage account.
        :param pulumi.Input[builtins.str] encryption_user_assigned_identity: Resource identifier of the UserAssigned identity to be associated with server-side encryption on the storage account.
        """
    ...
    def encryption_federated_identity_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ClientId of the multi-tenant application to be used in conjunction with the user-assigned identity for cross-tenant customer-managed-keys server-side encryption on the storage account.
        """
    ...
    def encryption_federated_identity_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "encryption_federated_identity_client_id", value)

    @property
    @pulumi.getter(name="encryptionUserAssignedIdentity")
    def encryption_user_assigned_identity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource identifier of the UserAssigned identity to be associated with server-side encryption on the storage account.
        """
    ...
    def encryption_user_assigned_identity(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EncryptionScopeKeyVaultPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The key vault properties for the encryption scope. This is a required field if encryption scope 'source' attribute is set to 'Microsoft.KeyVault'.
        :param pulumi.Input[builtins.str] key_uri: The object identifier for a key vault key object. When applied, the encryption scope will use the key referenced by the identifier to enable customer-managed key support on this encryption scope.
        """
...
if not MYPY:
    class EncryptionServiceArgsDict(TypedDict):
        ...
        """
        key_type: NotRequired[pulumi.Input[Union[builtins.str, 'KeyType']]]
        """
...
class EncryptionServiceArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 key_type: Optional[pulumi.Input[Union[builtins.str, 'KeyType']]] = None):
        """
        A service that allows server-side encryption to be used.
        :param pulumi.Input[builtins.bool] enabled: A boolean indicating whether or not the service encrypts the data as it is stored. Encryption at rest is enabled by default today and cannot be disabled.
        :param pulumi.Input[Union[builtins.str, 'KeyType']] key_type: Encryption key type to be used for the encryption service. 'Account' key type implies that an account-scoped encryption key will be used. 'Service' key type implies that a default service key is used.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def key_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'KeyType']]]:
        """
        Encryption key type to be used for the encryption service. 'Account' key type implies that an account-scoped encryption key will be used. 'Service' key type implies that a default service key is used.
        """
    ...
    @key_type.setter
    def key_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'KeyType']]]):
...
class EncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'KeySource']] key_source: The encryption keySource (provider). Possible values (case-insensitive):  Microsoft.Storage, Microsoft.Keyvault
        :param pulumi.Input['KeyVaultPropertiesArgs'] key_vault_properties: Properties provided by key vault.
        :param pulumi.Input[builtins.bool] require_infrastructure_encryption: A boolean indicating whether or not the service applies a secondary layer of encryption with platform managed keys for data at rest.
...
if not MYPY:
    class ExecutionTargetArgsDict(TypedDict):
        ...
        """
        prefix: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ExecutionTargetArgs:
    def __init__(__self__, *,
                 exclude_prefix: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 prefix: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Target helps provide filter parameters for the objects in the storage account and forms the execution context for the storage task
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_prefix: List of object prefixes to be excluded from task execution. If there is a conflict between include and exclude prefixes, the exclude prefix will be the determining factor
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefix: Required list of object prefixes to be included for task execution
        """
        if exclude_prefix is not None:
            pulumi.set(__self__, "exclude_prefix", exclude_prefix)
    ...
    @property
    @pulumi.getter
    def prefix(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Required list of object prefixes to be included for task execution
        """
    ...
    @prefix.setter
    def prefix(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class FileSharePropertiesFileSharePaidBurstingArgsDict(TypedDict):
        ...
        """
        paid_bursting_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        paid_bursting_max_bandwidth_mibps: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        paid_bursting_max_iops: NotRequired[pulumi.Input[builtins.int]]
        """
...
class FileSharePropertiesFileSharePaidBurstingArgs:
    def __init__(__self__, *,
                 paid_bursting_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 paid_bursting_max_bandwidth_mibps: Optional[pulumi.Input[builtins.int]] = None,
                 paid_bursting_max_iops: Optional[pulumi.Input[builtins.int]] = None):
        """
        File Share Paid Bursting properties.
        :param pulumi.Input[builtins.bool] paid_bursting_enabled: Indicates whether paid bursting is enabled for the share. This property is only for file shares created under Files Provisioned v1 SSD account type.
        :param pulumi.Input[builtins.int] paid_bursting_max_bandwidth_mibps: The maximum paid bursting bandwidth for the share, in mebibytes per second. This property is only for file shares created under Files Provisioned v1 SSD account type. The maximum allowed value is 10340 which is the maximum allowed bandwidth for a share.
        :param pulumi.Input[builtins.int] paid_bursting_max_iops: The maximum paid bursting IOPS for the share. This property is only for file shares created under Files Provisioned v1 SSD account type. The maximum allowed value is 102400 which is the maximum allowed IOPS for a share.
        """
    ...
    def paid_bursting_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether paid bursting is enabled for the share. This property is only for file shares created under Files Provisioned v1 SSD account type.
        """
    ...
    def paid_bursting_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "paid_bursting_enabled", value)

    @property
    @pulumi.getter(name="paidBurstingMaxBandwidthMibps")
    def paid_bursting_max_bandwidth_mibps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum paid bursting bandwidth for the share, in mebibytes per second. This property is only for file shares created under Files Provisioned v1 SSD account type. The maximum allowed value is 10340 which is the maximum allowed bandwidth for a share.
        """
    ...
    def paid_bursting_max_bandwidth_mibps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "paid_bursting_max_bandwidth_mibps", value)

    @property
    @pulumi.getter(name="paidBurstingMaxIops")
    def paid_bursting_max_iops(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum paid bursting IOPS for the share. This property is only for file shares created under Files Provisioned v1 SSD account type. The maximum allowed value is 102400 which is the maximum allowed IOPS for a share.
        """
    ...
    def paid_bursting_max_iops(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ImmutableStorageAccountArgs:
    def __init__(__self__, *,
        ...
        """
        This property enables and defines account-level immutability. Enabling the feature auto-enables Blob Versioning.
        :param pulumi.Input[builtins.bool] enabled: A boolean flag which enables account-level immutability. All the containers under such an account have object-level immutability enabled by default.
...
class ImmutableStorageWithVersioningArgs:
    def __init__(__self__, *,
        ...
        """
        Object level immutability properties of the container.
        :param pulumi.Input[builtins.bool] enabled: This is an immutable property, when set to true it enables object level immutability at the container level.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class KeyPolicyArgsDict(TypedDict):
        ...
        """
        key_expiration_period_in_days: pulumi.Input[builtins.int]
        """
...
class KeyPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        KeyPolicy assigned to the storage account.
        :param pulumi.Input[builtins.int] key_expiration_period_in_days: The key expiration period in days.
        """
    ...
    def key_expiration_period_in_days(self) -> pulumi.Input[builtins.int]:
        """
        The key expiration period in days.
        """
    ...
    def key_expiration_period_in_days(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class LastAccessTimeTrackingPolicyArgsDict(TypedDict):
        ...
        """
        blob_type: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        An array of predefined supported blob types. Only blockBlob is the supported value. This field is currently read only
        """
        name: NotRequired[pulumi.Input[Union[builtins.str, 'Name']]]
        """
        Name of the policy. The valid value is AccessTimeTracking. This field is currently read only
        """
        tracking_granularity_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class LastAccessTimeTrackingPolicyArgs:
    def __init__(__self__, *,
                 enable: pulumi.Input[builtins.bool],
                 blob_type: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[Union[builtins.str, 'Name']]] = None,
                 tracking_granularity_in_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        The blob service properties for Last access time based tracking policy.
        :param pulumi.Input[builtins.bool] enable: When set to true last access time based tracking is enabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] blob_type: An array of predefined supported blob types. Only blockBlob is the supported value. This field is currently read only
        :param pulumi.Input[Union[builtins.str, 'Name']] name: Name of the policy. The valid value is AccessTimeTracking. This field is currently read only
        :param pulumi.Input[builtins.int] tracking_granularity_in_days: The field specifies blob object tracking granularity in days, typically how often the blob object should be tracked.This field is currently read only with value as 1
        """
    ...
    def blob_type(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of predefined supported blob types. Only blockBlob is the supported value. This field is currently read only
        """
    ...
    @blob_type.setter
    def blob_type(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "blob_type", value)

    @property
    @pulumi.getter
    def name(self) -> Optional[pulumi.Input[Union[builtins.str, 'Name']]]:
        """
        Name of the policy. The valid value is AccessTimeTracking. This field is currently read only
        """
        return pulumi.get(self, "name")
    ...
    @name.setter
    def name(self, value: Optional[pulumi.Input[Union[builtins.str, 'Name']]]):
        pulumi.set(self, "name", value)

    @property
    @pulumi.getter(name="trackingGranularityInDays")
    def tracking_granularity_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The field specifies blob object tracking granularity in days, typically how often the blob object should be tracked.This field is currently read only with value as 1
        """
    ...
    def tracking_granularity_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ManagementPolicyBaseBlobArgsDict(TypedDict):
        ...
        """
        enable_auto_tier_to_hot_from_cool: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ManagementPolicyBaseBlobArgs:
    def __init__(__self__, *,
                 ...
                 enable_auto_tier_to_hot_from_cool: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_auto_tier_to_hot_from_cool: This property enables auto tiering of a blob from cool to hot on a blob access. This property requires tierToCool.daysAfterLastAccessTimeGreaterThan.
    ...
    def enable_auto_tier_to_hot_from_cool(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This property enables auto tiering of a blob from cool to hot on a blob access. This property requires tierToCool.daysAfterLastAccessTimeGreaterThan.
        """
    ...
    def enable_auto_tier_to_hot_from_cool(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ManagementPolicyFilterArgs:
    def __init__(__self__, *,
        ...
        """
        Filters limit rule actions to a subset of blobs within the storage account. If multiple filters are defined, a logical AND is performed on all filters. 
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] blob_types: An array of predefined enum values. Currently blockBlob supports all tiering and delete actions. Only delete actions are supported for appendBlob.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefix_match: An array of strings for prefixes to be match.
        """
        pulumi.set(__self__, "blob_types", blob_types)
...
if not MYPY:
    class ManagementPolicyRuleArgsDict(TypedDict):
        ...
        A rule name can contain any combination of alpha numeric characters. Rule name is case-sensitive. It must be unique within a policy.
        """
        type: pulumi.Input[Union[builtins.str, 'RuleType']]
        """
...
class ManagementPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: A rule name can contain any combination of alpha numeric characters. Rule name is case-sensitive. It must be unique within a policy.
        :param pulumi.Input[Union[builtins.str, 'RuleType']] type: The valid value is Lifecycle
        :param pulumi.Input[builtins.bool] enabled: Rule is enabled if set to true.
        """
        pulumi.set(__self__, "definition", definition)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[builtins.str, 'RuleType']]:
        """
        The valid value is Lifecycle
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[builtins.str, 'RuleType']]):
        pulumi.set(self, "type", value)
...
class MultichannelArgs:
    def __init__(__self__, *,
        ...
        """
        Multichannel setting. Applies to Premium FileStorage only.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether multichannel is enabled
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class NetworkRuleSetArgsDict(TypedDict):
        ...
        """
        bypass: NotRequired[pulumi.Input[Union[builtins.str, 'Bypass']]]
        """
...
class NetworkRuleSetArgs:
    def __init__(__self__, *,
                 ...
                 bypass: Optional[pulumi.Input[Union[builtins.str, 'Bypass']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'Bypass']] bypass: Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Possible values are any combination of Logging|Metrics|AzureServices (For example, "Logging, Metrics"), or None to bypass none of those traffics.
    ...
    @property
    @pulumi.getter
    def bypass(self) -> Optional[pulumi.Input[Union[builtins.str, 'Bypass']]]:
        """
        Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Possible values are any combination of Logging|Metrics|AzureServices (For example, "Logging, Metrics"), or None to bypass none of those traffics.
        """
    ...
    @bypass.setter
    def bypass(self, value: Optional[pulumi.Input[Union[builtins.str, 'Bypass']]]):
...
if not MYPY:
    class ObjectReplicationPolicyFilterArgsDict(TypedDict):
        ...
        """
        min_creation_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ObjectReplicationPolicyFilterArgs:
    def __init__(__self__, *,
                 min_creation_time: Optional[pulumi.Input[builtins.str]] = None,
                 prefix_match: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Filters limit replication to a subset of blobs within the storage account. A logical OR is performed on values in the filter. If multiple filters are defined, a logical AND is performed on all filters.
        :param pulumi.Input[builtins.str] min_creation_time: Blobs created after the time will be replicated to the destination. It must be in datetime format 'yyyy-MM-ddTHH:mm:ssZ'. Example: 2020-02-19T16:05:00Z
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefix_match: Optional. Filters the results to replicate only blobs whose names begin with the specified prefix.
        """
    ...
    def min_creation_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Blobs created after the time will be replicated to the destination. It must be in datetime format 'yyyy-MM-ddTHH:mm:ssZ'. Example: 2020-02-19T16:05:00Z
        """
    ...
    def min_creation_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ObjectReplicationPolicyPropertiesMetricsArgs:
    def __init__(__self__, *,
        ...
        """
        Optional. The object replication policy metrics feature options.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether object replication metrics feature is enabled for the policy.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class ObjectReplicationPolicyRuleArgsDict(TypedDict):
        ...
        """
        destination_container: pulumi.Input[builtins.str]
        """
        Required. Destination container name.
        """
        source_container: pulumi.Input[builtins.str]
        """
...
class ObjectReplicationPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        """
        The replication policy rule between two containers.
        :param pulumi.Input[builtins.str] destination_container: Required. Destination container name.
        :param pulumi.Input[builtins.str] source_container: Required. Source container name.
        :param pulumi.Input['ObjectReplicationPolicyFilterArgs'] filters: Optional. An object that defines the filter set.
        :param pulumi.Input[builtins.str] rule_id: Rule Id is auto-generated for each new rule on destination account. It is required for put policy on source account.
        """
    ...
    def destination_container(self) -> pulumi.Input[builtins.str]:
        """
        Required. Destination container name.
        """
    ...
    def destination_container(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_container", value)

    @property
    @pulumi.getter(name="sourceContainer")
    def source_container(self) -> pulumi.Input[builtins.str]:
        """
        Required. Source container name.
        """
    ...
    def source_container(self, value: pulumi.Input[builtins.str]):
...
class PermissionScopeArgs:
    def __init__(__self__, *,
                 ...
                 service: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] permissions: The permissions for the local user. Possible values include: Read (r), Write (w), Delete (d), List (l), Create (c), Modify Ownership (o), and Modify Permissions (p).
        :param pulumi.Input[builtins.str] resource_name: The name of resource, normally the container name or the file share name, used by the local user.
        :param pulumi.Input[builtins.str] service: The service used by the local user, e.g. blob, file.
        """
...
if not MYPY:
    class PrivateLinkServiceConnectionStateArgsDict(TypedDict):
        ...
        """
        action_required: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PrivateLinkServiceConnectionStateArgs:
    def __init__(__self__, *,
                 action_required: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[Union[builtins.str, 'PrivateEndpointServiceConnectionStatus']]] = None):
        """
        A collection of information about the state of the connection between service consumer and provider.
        :param pulumi.Input[builtins.str] action_required: A message indicating if changes on the service provider require any updates on the consumer.
    ...
    def action_required(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A message indicating if changes on the service provider require any updates on the consumer.
        """
    ...
    def action_required(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RestorePolicyPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The blob service properties for blob restore policy
        :param pulumi.Input[builtins.bool] enabled: Blob restore is enabled if set to true.
        :param pulumi.Input[builtins.int] days: how long this blob can be restored. It should be great than zero and less than DeleteRetentionPolicy.days.
        """
        pulumi.set(__self__, "enabled", enabled)
        if days is not None:
            pulumi.set(__self__, "days", days)
...
if not MYPY:
    class RoutingPreferenceArgsDict(TypedDict):
        ...
        """
        routing_choice: NotRequired[pulumi.Input[Union[builtins.str, 'RoutingChoice']]]
        """
...
class RoutingPreferenceArgs:
    def __init__(__self__, *,
                 ...
                 routing_choice: Optional[pulumi.Input[Union[builtins.str, 'RoutingChoice']]] = None):
        """
        Routing preference defines the type of network, either microsoft or internet routing to be used to deliver the user data, the default option is microsoft routing
        :param pulumi.Input[builtins.bool] publish_internet_endpoints: A boolean flag which indicates whether internet routing storage endpoints are to be published
        :param pulumi.Input[builtins.bool] publish_microsoft_endpoints: A boolean flag which indicates whether microsoft routing storage endpoints are to be published
        :param pulumi.Input[Union[builtins.str, 'RoutingChoice']] routing_choice: Routing Choice defines the kind of network routing opted by the user.
        """
    ...
    def routing_choice(self) -> Optional[pulumi.Input[Union[builtins.str, 'RoutingChoice']]]:
        """
        Routing Choice defines the kind of network routing opted by the user.
        """
    ...
    def routing_choice(self, value: Optional[pulumi.Input[Union[builtins.str, 'RoutingChoice']]]):
...
if not MYPY:
    class SasPolicyArgsDict(TypedDict):
        ...
        """
        expiration_action: pulumi.Input[Union[builtins.str, 'ExpirationAction']]
        """
        The SAS Expiration Action defines the action to be performed when sasPolicy.sasExpirationPeriod is violated. The 'Log' action can be used for audit purposes and the 'Block' action can be used to block and deny the usage of SAS tokens that do not adhere to the sas policy expiration period.
        """
        sas_expiration_period: pulumi.Input[builtins.str]
        """
...
class SasPolicyArgs:
    def __init__(__self__, *,
                 expiration_action: Optional[pulumi.Input[Union[builtins.str, 'ExpirationAction']]] = None,
                 sas_expiration_period: pulumi.Input[builtins.str]):
        """
        SasPolicy assigned to the storage account.
        :param pulumi.Input[Union[builtins.str, 'ExpirationAction']] expiration_action: The SAS Expiration Action defines the action to be performed when sasPolicy.sasExpirationPeriod is violated. The 'Log' action can be used for audit purposes and the 'Block' action can be used to block and deny the usage of SAS tokens that do not adhere to the sas policy expiration period.
        :param pulumi.Input[builtins.str] sas_expiration_period: The SAS expiration period, DD.HH:MM:SS.
        """
    ...
    def expiration_action(self) -> pulumi.Input[Union[builtins.str, 'ExpirationAction']]:
        """
        The SAS Expiration Action defines the action to be performed when sasPolicy.sasExpirationPeriod is violated. The 'Log' action can be used for audit purposes and the 'Block' action can be used to block and deny the usage of SAS tokens that do not adhere to the sas policy expiration period.
        """
    ...
    def expiration_action(self, value: pulumi.Input[Union[builtins.str, 'ExpirationAction']]):
        pulumi.set(self, "expiration_action", value)

    @property
    @pulumi.getter(name="sasExpirationPeriod")
    def sas_expiration_period(self) -> pulumi.Input[builtins.str]:
        """
        The SAS expiration period, DD.HH:MM:SS.
        """
    ...
    def sas_expiration_period(self, value: pulumi.Input[builtins.str]):
...
class SignedIdentifierArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] id: An unique identifier of the stored access policy.
        """
...
class SkuArgs:
    def __init__(__self__, *,
        ...
        """
        The SKU of the storage account.
        :param pulumi.Input[Union[builtins.str, 'SkuName']] name: The SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class SmbSettingArgsDict(TypedDict):
        ...
        Setting for SMB protocol
        """
        authentication_methods: NotRequired[pulumi.Input[builtins.str]]
        """
        SMB authentication methods supported by server. Valid values are NTLMv2, Kerberos. Should be passed as a string with delimiter ';'.
        """
        channel_encryption: NotRequired[pulumi.Input[builtins.str]]
        """
        SMB channel encryption supported by server. Valid values are AES-128-CCM, AES-128-GCM, AES-256-GCM. Should be passed as a string with delimiter ';'.
        """
        kerberos_ticket_encryption: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Multichannel setting. Applies to Premium FileStorage only.
        """
        versions: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SmbSettingArgs:
    def __init__(__self__, *,
                 authentication_methods: Optional[pulumi.Input[builtins.str]] = None,
                 channel_encryption: Optional[pulumi.Input[builtins.str]] = None,
                 kerberos_ticket_encryption: Optional[pulumi.Input[builtins.str]] = None,
                 multichannel: Optional[pulumi.Input['MultichannelArgs']] = None,
                 versions: Optional[pulumi.Input[builtins.str]] = None):
        """
        Setting for SMB protocol
        :param pulumi.Input[builtins.str] authentication_methods: SMB authentication methods supported by server. Valid values are NTLMv2, Kerberos. Should be passed as a string with delimiter ';'.
        :param pulumi.Input[builtins.str] channel_encryption: SMB channel encryption supported by server. Valid values are AES-128-CCM, AES-128-GCM, AES-256-GCM. Should be passed as a string with delimiter ';'.
        :param pulumi.Input[builtins.str] kerberos_ticket_encryption: Kerberos ticket encryption supported by server. Valid values are RC4-HMAC, AES-256. Should be passed as a string with delimiter ';'
        :param pulumi.Input['MultichannelArgs'] multichannel: Multichannel setting. Applies to Premium FileStorage only.
        :param pulumi.Input[builtins.str] versions: SMB protocol versions supported by server. Valid values are SMB2.1, SMB3.0, SMB3.1.1. Should be passed as a string with delimiter ';'.
        """
    ...
    def authentication_methods(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SMB authentication methods supported by server. Valid values are NTLMv2, Kerberos. Should be passed as a string with delimiter ';'.
        """
    ...
    def authentication_methods(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authentication_methods", value)

    @property
    @pulumi.getter(name="channelEncryption")
    def channel_encryption(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SMB channel encryption supported by server. Valid values are AES-128-CCM, AES-128-GCM, AES-256-GCM. Should be passed as a string with delimiter ';'.
        """
    ...
    def channel_encryption(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "channel_encryption", value)

    @property
    @pulumi.getter(name="kerberosTicketEncryption")
    def kerberos_ticket_encryption(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Kerberos ticket encryption supported by server. Valid values are RC4-HMAC, AES-256. Should be passed as a string with delimiter ';'
        """
    ...
    def kerberos_ticket_encryption(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def versions(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SMB protocol versions supported by server. Valid values are SMB2.1, SMB3.0, SMB3.1.1. Should be passed as a string with delimiter ';'.
        """
    ...
    @versions.setter
    def versions(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SshPublicKeyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] description: Optional. It is used to store the function/usage of the key
        :param pulumi.Input[builtins.str] key: Ssh public key base64 encoded. The format should be: '<keyType> <keyData>', e.g. ssh-rsa AAAABBBB
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if key is not None:
...
class StorageTaskAssignmentPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Properties of the storage task assignment.
        :param pulumi.Input[builtins.str] description: Text that describes the purpose of the storage task assignment
        :param pulumi.Input[builtins.bool] enabled: Whether the storage task assignment is enabled or not
        ...
        :param pulumi.Input[builtins.str] task_id: Id of the corresponding storage task
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "enabled", enabled)
...
class StorageTaskAssignmentReportArgs:
    def __init__(__self__, *,
        ...
        """
        The storage task assignment report
        :param pulumi.Input[builtins.str] prefix: The container prefix for the location of storage task assignment report
        """
        pulumi.set(__self__, "prefix", prefix)
...
class TableAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        Table Access Policy Properties Object.
        :param pulumi.Input[builtins.str] permission: Required. List of abbreviated permissions. Supported permission values include 'r','a','u','d'
        :param pulumi.Input[builtins.str] expiry_time: Expiry time of the access policy
        :param pulumi.Input[builtins.str] start_time: Start time of the access policy
        """
        pulumi.set(__self__, "permission", permission)
...
class TableSignedIdentifierArgs:
    def __init__(__self__, *,
        ...
        """
        Object to set Table Access Policy.
        :param pulumi.Input[builtins.str] id: unique-64-character-value of the stored access policy.
...
class TagFilterArgs:
    def __init__(__self__, *,
        ...
        """
        Blob index tag based filtering for blob objects
        :param pulumi.Input[builtins.str] name: This is the filter tag name, it can have 1 - 128 characters
        :param pulumi.Input[builtins.str] op: This is the comparison operator which is used for object comparison and filtering. Only == (equality operator) is currently supported
        :param pulumi.Input[builtins.str] value: This is the filter tag value field used for tag based filtering, it can have 0 - 256 characters
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class TriggerParametersArgsDict(TypedDict):
        ...
        """
        end_by: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        start_from: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TriggerParametersArgs:
    def __init__(__self__, *,
                 end_by: Optional[pulumi.Input[builtins.str]] = None,
                 interval: Optional[pulumi.Input[builtins.int]] = None,
                 interval_unit: Optional[pulumi.Input['IntervalUnit']] = None,
                 start_from: Optional[pulumi.Input[builtins.str]] = None,
                 start_on: Optional[pulumi.Input[builtins.str]] = None):
        """
        The trigger parameters update for the storage task assignment execution
        :param pulumi.Input[builtins.str] end_by: When to end task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'
    ...
    def end_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When to end task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'
        """
    ...
    @end_by.setter
    def end_by(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def start_from(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When to start task execution. This is a required field when ExecutionTrigger.properties.type is 'OnSchedule'; this property should not be present when ExecutionTrigger.properties.type is 'RunOnce'
        """
    ...
    @start_from.setter
    def start_from(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class VirtualNetworkRuleArgsDict(TypedDict):
        ...
        """
        virtual_network_resource_id: pulumi.Input[builtins.str]
        """
...
class VirtualNetworkRuleArgs:
    def __init__(__self__, *,
        ...
        """
        Virtual Network rule.
        :param pulumi.Input[builtins.str] virtual_network_resource_id: Resource ID of a subnet, for example: /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
        :param pulumi.Input['Action'] action: The action of virtual network rule.
        :param pulumi.Input[Union[builtins.str, 'State']] state: Gets the state of virtual network rule.
        """
    ...
    def virtual_network_resource_id(self) -> pulumi.Input[builtins.str]:
        """
        Resource ID of a subnet, for example: /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
        """
    ...
    def virtual_network_resource_id(self, value: pulumi.Input[builtins.str]):
