...
class GetConnectorResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.StorageConnectorPropertiesResponse':
        """
...
def get_connector(account_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage:getConnector', __args__, opts=opts, typ=GetConnectorResult).value
...
def get_connector_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storage:getConnector', __args__, opts=opts, typ=GetConnectorResult)
