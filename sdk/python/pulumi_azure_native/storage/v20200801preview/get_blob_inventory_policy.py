...
def get_blob_inventory_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_inventory_policy is deprecated: Version v20200801preview will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20200801preview:getBlobInventoryPolicy', __args__, opts=opts, typ=GetBlobInventoryPolicyResult).value
