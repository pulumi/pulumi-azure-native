...
azure-native:storage/v20200801preview:ManagementPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:ManagementPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_management_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_management_policy is deprecated: Version 2020-08-01-preview will be removed in v2 of the provider.
azure-native:storage/v20200801preview:ManagementPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:ManagementPolicy to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20200801preview:getManagementPolicy', __args__, opts=opts, typ=GetManagementPolicyResult).value
