...
def get_encryption_scope(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_encryption_scope is deprecated: Version v20200801preview will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
