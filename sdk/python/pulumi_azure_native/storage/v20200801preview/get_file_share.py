...
def get_file_share(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_share is deprecated: Version v20200801preview will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20200801preview:getFileShare', __args__, opts=opts, typ=GetFileShareResult).value
