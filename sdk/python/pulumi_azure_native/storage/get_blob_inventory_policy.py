...
def get_blob_inventory_policy(account_name: Optional[_builtins.str] = None,
                              blob_inventory_policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str blob_inventory_policy_name: The name of the storage account blob inventory policy. It should always be 'default'
...
def get_blob_inventory_policy_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
                                     blob_inventory_policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
