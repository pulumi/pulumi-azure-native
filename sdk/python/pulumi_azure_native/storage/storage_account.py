...
class StorageAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        storage_account = azure_native.storage.StorageAccount("storageAccount",
            ...
            key_policy=azure_native.storage.KeyPolicyResponseArgs(
            ...
            sas_policy=azure_native.storage.SasPolicyResponseArgs(
        ...
        storage_account = azure_native.storage.StorageAccount("storageAccount",
            ...
            identity=azure_native.storage.IdentityResponseArgs(
                type="UserAssigned",
