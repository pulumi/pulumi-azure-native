...
class StorageAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'AllowedCopyScope']] allowed_copy_scope: Restrict copy to and from Storage Accounts within an AAD tenant or with Private Links to the same VNet.
        ...
        :param pulumi.Input[_builtins.bool] default_to_o_auth_authentication: A boolean flag which indicates whether the default authentication is OAuth or not. The default interpretation is false for this property.
        :param pulumi.Input[Union[_builtins.str, 'DnsEndpointType']] dns_endpoint_type: Allows you to specify the type of endpoint. Set this to AzureDNSZone to create a large number of accounts in a single subscription, which creates accounts in an Azure DNS Zone and the endpoint URL will have an alphanumeric DNS Zone identifier.
        :param pulumi.Input[_builtins.bool] enable_extended_groups: Enables extended group support with local users feature, if set to true
        :param pulumi.Input[_builtins.bool] enable_https_traffic_only: Allows https traffic only to storage service if sets to true. The default value is true since API version 2019-04-01.
        :param pulumi.Input[_builtins.bool] enable_nfs_v3: NFS 3.0 protocol support enabled if set to true.
        ...
        :param pulumi.Input[_builtins.bool] is_hns_enabled: Account HierarchicalNamespace enabled if sets to true.
        :param pulumi.Input[_builtins.bool] is_local_user_enabled: Enables local users feature, if set to true
        :param pulumi.Input[_builtins.bool] is_sftp_enabled: Enables Secure File Transfer Protocol, if set to true
