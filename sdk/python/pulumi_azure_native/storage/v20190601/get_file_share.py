...
azure-native:storage/v20190601:FileShare is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_file_share(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_share is deprecated: Version 2019-06-01 will be removed in v2 of the provider.
azure-native:storage/v20190601:FileShare is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20190601:getFileShare', __args__, opts=opts, typ=GetFileShareResult).value
