...
def get_file_share(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_share is deprecated: Version v20190601 will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
