...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:storage/v20190601:BlobContainer":
                return BlobContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:BlobContainerImmutabilityPolicy":
                return BlobContainerImmutabilityPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:BlobInventoryPolicy":
                return BlobInventoryPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:BlobServiceProperties":
                return BlobServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:EncryptionScope":
                return EncryptionScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:FileServiceProperties":
                return FileServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:FileShare":
                return FileShare(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:ManagementPolicy":
                return ManagementPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:ObjectReplicationPolicy":
                return ObjectReplicationPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:Queue":
                return Queue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:QueueServiceProperties":
                return QueueServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:StorageAccount":
                return StorageAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:Table":
                return Table(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20190601:TableServiceProperties":
    ...
    pulumi.runtime.register_resource_module("azure-native", "storage/v20190601", _module_instance)
