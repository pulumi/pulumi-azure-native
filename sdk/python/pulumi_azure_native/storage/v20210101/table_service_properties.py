...
class TableServiceProperties(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 table_service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TableServiceProperties is deprecated: azure-native:storage/v20210101:TableServiceProperties is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:TableServiceProperties to guarantee forwards compatibility.""")
