...
def get_blob_container_immutability_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_container_immutability_policy is deprecated: Version v20210101 will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210101:getBlobContainerImmutabilityPolicy', __args__, opts=opts, typ=GetBlobContainerImmutabilityPolicyResult).value
