...
def get_blob_container(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_container is deprecated: azure-native:storage/v20210101:BlobContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobContainer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['containerName'] = container_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storage/v20210101:getBlobContainer', __args__, opts=opts, typ=GetBlobContainerResult).value
