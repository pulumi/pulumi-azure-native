...
class FileServiceProperties(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 share_delete_retention_policy: Optional[pulumi.Input[pulumi.InputType['DeleteRetentionPolicyArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""FileServiceProperties is deprecated: azure-native:storage/v20210101:FileServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileServiceProperties to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storage:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20190401:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20190601:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20200801preview:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210201:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210401:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210601:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210801:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210901:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20220501:FileServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20220901:FileServiceProperties")])
