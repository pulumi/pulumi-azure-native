...
def get_queue_service_properties(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_queue_service_properties is deprecated: azure-native:storage/v20210101:QueueServiceProperties is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:QueueServiceProperties to guarantee forwards compatibility.""")
    __args__ = dict()
