...
def get_blob_service_properties(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_service_properties is deprecated: Version v20210101 will be removed in the next major version of the provider. Upgrade to version v20210201 or later.""")
    __args__ = dict()
