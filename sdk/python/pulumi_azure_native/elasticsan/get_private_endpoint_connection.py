...
def get_private_endpoint_connection(elastic_san_name: Optional[_builtins.str] = None,
...
def get_private_endpoint_connection_output(elastic_san_name: Optional[pulumi.Input[_builtins.str]] = None,
