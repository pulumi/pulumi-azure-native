...
class VolumeArgs:
    ...
    @size_gi_b.setter
    def size_gi_b(self, value: pulumi.Input[_builtins.float]):
...
class Volume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan/v20211120preview:Volume"), pulumi.Alias(type_="azure-native:elasticsan/v20221201preview:Volume"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:Volume"), pulumi.Alias(type_="azure-native:elasticsan/v20240501:Volume"), pulumi.Alias(type_="azure-native:elasticsan/v20240601preview:Volume"), pulumi.Alias(type_="azure-native:elasticsan/v20240701preview:Volume"), pulumi.Alias(type_="azure-native:elasticsan/v20250901:Volume"), pulumi.Alias(type_="azure-native:elasticsan/v20260401preview:Volume")])
