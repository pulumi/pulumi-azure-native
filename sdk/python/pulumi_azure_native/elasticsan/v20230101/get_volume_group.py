...
class GetVolumeGroupResult:
    ...
    """
    def __init__(__self__, encryption=None, encryption_properties=None, id=None, identity=None, name=None, network_acls=None, private_endpoint_connections=None, protocol_type=None, provisioning_state=None, system_data=None, type=None):
...
def get_volume_group(elastic_san_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elasticsan/v20230101:getVolumeGroup', __args__, opts=opts, typ=GetVolumeGroupResult).value
