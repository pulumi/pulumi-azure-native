...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan/v20221201preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:elasticsan/v20240501:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:elasticsan/v20240601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:elasticsan:PrivateEndpointConnection")])
