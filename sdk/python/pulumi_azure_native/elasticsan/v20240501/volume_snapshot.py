...
class VolumeSnapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['SnapshotCreationDataArgs', 'SnapshotCreationDataArgsDict']] creation_data: Data used when creating a volume snapshot.
        :param pulumi.Input[str] elastic_san_name: The name of the ElasticSan.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] snapshot_name: The name of the volume snapshot within the given volume group.
        :param pulumi.Input[str] volume_group_name: The name of the VolumeGroup.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan:VolumeSnapshot"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:VolumeSnapshot"), pulumi.Alias(type_="azure-native:elasticsan/v20240601preview:VolumeSnapshot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VolumeSnapshot, __self__).__init__(
            'azure-native:elasticsan/v20240501:VolumeSnapshot',
            resource_name,
            __props__,
            opts)
