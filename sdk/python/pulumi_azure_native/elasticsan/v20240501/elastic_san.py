...
class ElasticSan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan/v20211120preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20221201preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20240601preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan:ElasticSan")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ElasticSan, __self__).__init__(
            'azure-native:elasticsan/v20240501:ElasticSan',
            resource_name,
            __props__,
            opts)
