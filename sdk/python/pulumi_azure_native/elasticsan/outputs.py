...
class EncryptionIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Encryption identity for the volume group.
        :param builtins.str encryption_user_assigned_identity: Resource identifier of the UserAssigned identity to be associated with server-side encryption on the volume group.
        """
...
class IscsiTargetInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Iscsi target information
        :param builtins.str provisioning_state: State of the operation on the resource.
        ...
        :param builtins.str status: Operational status of the iSCSI Target.
        """
...
class ManagedByInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Parent resource information.
        :param builtins.str resource_id: Resource ID of the resource managing the volume, this is a restricted field and can only be set for internal use.
        """
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str provisioning_state: Provisioning State of Private Endpoint connection resource
        ...
        :param Sequence[builtins.str] group_ids:  List of resources private endpoint is mapped
...
class SnapshotCreationDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Data used when creating a volume snapshot.
        :param builtins.str source_id: Fully qualified resource ID of the volume. E.g. "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}/volumes/{volumeName}"
        """
...
class SourceCreationDataResponse(dict):
    ...
    def __init__(__self__, *,
                 create_source: Optional[builtins.str] = None,
                 source_id: Optional[builtins.str] = None):
        """
        Data source used when creating the volume.
        :param builtins.str create_source: This enumerates the possible sources of a volume creation.
        :param builtins.str source_id: Fully qualified resource ID for the resource. E.g. "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"
        """
    ...
    def create_source(self) -> Optional[builtins.str]:
        """
