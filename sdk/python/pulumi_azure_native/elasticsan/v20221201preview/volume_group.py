...
class VolumeGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan:VolumeGroup"), pulumi.Alias(type_="azure-native:elasticsan/v20211120preview:VolumeGroup"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:VolumeGroup")])
