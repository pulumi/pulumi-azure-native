...
def get_elastic_san(elastic_san_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elasticsan/v20221201preview:getElasticSan', __args__, opts=opts, typ=GetElasticSanResult).value
...
def get_elastic_san_output(elastic_san_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:elasticsan/v20221201preview:getElasticSan', __args__, opts=opts, typ=GetElasticSanResult)
