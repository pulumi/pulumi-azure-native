...
class ElasticSan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20211120preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20240501:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20240601preview:ElasticSan")])
