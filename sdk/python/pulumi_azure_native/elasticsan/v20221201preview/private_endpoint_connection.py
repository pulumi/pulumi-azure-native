...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:PrivateEndpointConnection")])
