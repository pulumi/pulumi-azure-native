...
def get_volume_group(elastic_san_name: Optional[_builtins.str] = None,
...
def get_volume_group_output(elastic_san_name: Optional[pulumi.Input[_builtins.str]] = None,
