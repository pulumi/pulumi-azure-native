...
class GetVolumeGroupResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, encryption=None, encryption_properties=None, enforce_data_integrity_check_for_iscsi=None, id=None, identity=None, name=None, network_acls=None, private_endpoint_connections=None, protocol_type=None, provisioning_state=None, system_data=None, type=None):
    ...
    def enforce_data_integrity_check_for_iscsi(self) -> Optional[builtins.bool]:
        """
...
def get_volume_group(elastic_san_name: Optional[builtins.str] = None,
...
def get_volume_group_output(elastic_san_name: Optional[pulumi.Input[builtins.str]] = None,
