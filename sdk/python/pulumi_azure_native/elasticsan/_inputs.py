...
class EncryptionIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        Encryption identity for the volume group.
        :param pulumi.Input[builtins.str] encryption_user_assigned_identity: Resource identifier of the UserAssigned identity to be associated with server-side encryption on the volume group.
        """
...
class IdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input['UserAssignedIdentityArgs']]] user_assigned_identities: Gets or sets a list of key value pairs that describe the set of User Assigned identities that will be used with this volume group. The key is the ARM resource identifier of the identity.
        """
...
class ManagedByInfoArgs:
    def __init__(__self__, *,
        ...
        """
        Parent resource information.
        :param pulumi.Input[builtins.str] resource_id: Resource ID of the resource managing the volume, this is a restricted field and can only be set for internal use.
        """
...
class SkuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'SkuTier']] tier: The sku tier.
        """
...
class SnapshotCreationDataArgs:
    def __init__(__self__, *,
        ...
        """
        Data used when creating a volume snapshot.
        :param pulumi.Input[builtins.str] source_id: Fully qualified resource ID of the volume. E.g. "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}/volumes/{volumeName}"
        """
...
if not MYPY:
    class SourceCreationDataArgsDict(TypedDict):
        ...
        """
        create_source: NotRequired[pulumi.Input[Union[builtins.str, 'VolumeCreateOption']]]
        """
...
class SourceCreationDataArgs:
    def __init__(__self__, *,
                 create_source: Optional[pulumi.Input[Union[builtins.str, 'VolumeCreateOption']]] = None,
                 source_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Data source used when creating the volume.
        :param pulumi.Input[Union[builtins.str, 'VolumeCreateOption']] create_source: This enumerates the possible sources of a volume creation.
        :param pulumi.Input[builtins.str] source_id: Fully qualified resource ID for the resource. E.g. "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"
        """
    ...
    def create_source(self) -> Optional[pulumi.Input[Union[builtins.str, 'VolumeCreateOption']]]:
        """
        This enumerates the possible sources of a volume creation.
        """
    ...
    def create_source(self, value: Optional[pulumi.Input[Union[builtins.str, 'VolumeCreateOption']]]):
...
class VirtualNetworkRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'Action']] action: The action of virtual network rule.
        """
