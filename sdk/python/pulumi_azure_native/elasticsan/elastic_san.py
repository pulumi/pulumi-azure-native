...
class ElasticSan(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 base_size_ti_b: Optional[pulumi.Input[_builtins.float]] = None,
                 elastic_san_name: Optional[pulumi.Input[_builtins.str]] = None,
                 extended_capacity_size_ti_b: Optional[pulumi.Input[_builtins.float]] = None,
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 public_network_access: Optional[pulumi.Input[Union[_builtins.str, 'PublicNetworkAccess']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan/v20211120preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20221201preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20240501:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20240601preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20240701preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20250901:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20260401preview:ElasticSan")])
