...
class GetElasticSanResult:
    ...
    """
    def __init__(__self__, auto_scale_properties=None, availability_zones=None, base_size_ti_b=None, extended_capacity_size_ti_b=None, id=None, location=None, name=None, private_endpoint_connections=None, provisioning_state=None, public_network_access=None, sku=None, system_data=None, tags=None, total_iops=None, total_m_bps=None, total_size_ti_b=None, total_volume_size_gi_b=None, type=None, volume_group_count=None):
        if auto_scale_properties and not isinstance(auto_scale_properties, dict):
            raise TypeError("Expected argument 'auto_scale_properties' to be a dict")
...
class AwaitableGetElasticSanResult(GetElasticSanResult):
    ...
    def __await__(self):
        ...
        return GetElasticSanResult(
            auto_scale_properties=self.auto_scale_properties,
...
def get_elastic_san(elastic_san_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elasticsan/v20240601preview:getElasticSan', __args__, opts=opts, typ=GetElasticSanResult).value

    return AwaitableGetElasticSanResult(
        auto_scale_properties=pulumi.get(__ret__, 'auto_scale_properties'),
...
def get_elastic_san_output(elastic_san_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:elasticsan/v20240601preview:getElasticSan', __args__, opts=opts, typ=GetElasticSanResult)
    return __ret__.apply(lambda __response__: GetElasticSanResult(
        auto_scale_properties=pulumi.get(__response__, 'auto_scale_properties'),
