...
class ElasticSanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AutoScalePropertiesArgs'] auto_scale_properties: Auto Scale Properties for Elastic San Appliance.
...
class ElasticSan(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_scale_properties: Optional[pulumi.Input[Union['AutoScalePropertiesArgs', 'AutoScalePropertiesArgsDict']]] = None,
                 availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
        ...
        :param pulumi.Input[Union['AutoScalePropertiesArgs', 'AutoScalePropertiesArgsDict']] auto_scale_properties: Auto Scale Properties for Elastic San Appliance.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] availability_zones: Logical zone for Elastic San resource; example: ["1"].
        :param pulumi.Input[float] base_size_ti_b: Base size of the Elastic San appliance in TiB.
        :param pulumi.Input[str] elastic_san_name: The name of the ElasticSan.
        :param pulumi.Input[float] extended_capacity_size_ti_b: Extended size of the Elastic San appliance in TiB.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["auto_scale_properties"] = auto_scale_properties
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan/v20211120preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20221201preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20240501:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan:ElasticSan")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ElasticSan, __self__).__init__(
            'azure-native:elasticsan/v20240601preview:ElasticSan',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["auto_scale_properties"] = None
    ...
    @property
    @pulumi.getter(name="autoScaleProperties")
    def auto_scale_properties(self) -> pulumi.Output[Optional['outputs.AutoScalePropertiesResponse']]:
        """
        Auto Scale Properties for Elastic San Appliance.
        """
        return pulumi.get(self, "auto_scale_properties")
