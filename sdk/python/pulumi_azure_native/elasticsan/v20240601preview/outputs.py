...
class AutoScalePropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "scaleUpProperties":
            suggest = "scale_up_properties"
    ...
    def __init__(__self__, *,
                 scale_up_properties: Optional['outputs.ScaleUpPropertiesResponse'] = None):
        """
        The auto scale settings on Elastic San Appliance.
        :param 'ScaleUpPropertiesResponse' scale_up_properties: Scale up settings on Elastic San Appliance.
        """
    ...
    def scale_up_properties(self) -> Optional['outputs.ScaleUpPropertiesResponse']:
        """
...
@pulumi.output_type
class ScaleUpPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "autoScalePolicyEnforcement":
            suggest = "auto_scale_policy_enforcement"
        elif key == "capacityUnitScaleUpLimitTiB":
            suggest = "capacity_unit_scale_up_limit_ti_b"
        elif key == "increaseCapacityUnitByTiB":
            suggest = "increase_capacity_unit_by_ti_b"
        elif key == "unusedSizeTiB":
            suggest = "unused_size_ti_b"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ScaleUpPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ScaleUpPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 auto_scale_policy_enforcement: Optional[str] = None,
                 capacity_unit_scale_up_limit_ti_b: Optional[float] = None,
                 increase_capacity_unit_by_ti_b: Optional[float] = None,
                 unused_size_ti_b: Optional[float] = None):
        """
        Scale up properties on Elastic San Appliance.
        :param str auto_scale_policy_enforcement: Enable or Disable scale up setting on Elastic San Appliance.
        :param float capacity_unit_scale_up_limit_ti_b: Maximum scale up size on Elastic San appliance in TiB.
        :param float increase_capacity_unit_by_ti_b: Unit to increase Capacity Unit on Elastic San appliance in TiB.
        :param float unused_size_ti_b: Unused size on Elastic San appliance in TiB.
        """
    ...
    def auto_scale_policy_enforcement(self) -> Optional[str]:
        """
    ...
    def capacity_unit_scale_up_limit_ti_b(self) -> Optional[float]:
        """
    ...
    def increase_capacity_unit_by_ti_b(self) -> Optional[float]:
        """
    ...
    def unused_size_ti_b(self) -> Optional[float]:
        """
