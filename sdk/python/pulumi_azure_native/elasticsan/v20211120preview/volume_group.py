...
class VolumeGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan:VolumeGroup"), pulumi.Alias(type_="azure-native:elasticsan/v20221201preview:VolumeGroup"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:VolumeGroup"), pulumi.Alias(type_="azure-native:elasticsan/v20240501:VolumeGroup"), pulumi.Alias(type_="azure-native:elasticsan/v20240601preview:VolumeGroup")])
