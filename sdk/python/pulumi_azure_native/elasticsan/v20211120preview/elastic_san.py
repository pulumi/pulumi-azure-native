...
class ElasticSanArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if base_size_ti_b is None and 'baseSizeTiB' in kwargs:
            base_size_ti_b = kwargs['baseSizeTiB']
        if base_size_ti_b is None:
            raise TypeError("Missing 'base_size_ti_b' argument")
        if extended_capacity_size_ti_b is None and 'extendedCapacitySizeTiB' in kwargs:
            extended_capacity_size_ti_b = kwargs['extendedCapacitySizeTiB']
        if extended_capacity_size_ti_b is None:
            raise TypeError("Missing 'extended_capacity_size_ti_b' argument")
...
class ElasticSan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20221201preview:ElasticSan"), pulumi.Alias(type_="azure-native:elasticsan/v20230101:ElasticSan")])
