...
class VolumeSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] snapshot_name: The name of the volume snapshot within the given volume group.
        """
...
class VolumeSnapshot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elasticsan/v20230101:VolumeSnapshot"), pulumi.Alias(type_="azure-native:elasticsan/v20240501:VolumeSnapshot"), pulumi.Alias(type_="azure-native:elasticsan/v20240601preview:VolumeSnapshot"), pulumi.Alias(type_="azure-native:elasticsan/v20240701preview:VolumeSnapshot"), pulumi.Alias(type_="azure-native:elasticsan/v20250901:VolumeSnapshot"), pulumi.Alias(type_="azure-native:elasticsan/v20260401preview:VolumeSnapshot")])
