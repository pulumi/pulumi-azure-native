...
def get_iot_dps_resource(provisioning_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_dps_resource is deprecated: azure-native:devices/v20211015:IotDpsResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20230301preview:IotDpsResource to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['provisioningServiceName'] = provisioning_service_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devices/v20211015:getIotDpsResource', __args__, opts=opts, typ=GetIotDpsResourceResult).value
