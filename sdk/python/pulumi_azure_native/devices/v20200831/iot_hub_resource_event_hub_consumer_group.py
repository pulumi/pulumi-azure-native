...
class IotHubResourceEventHubConsumerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_hub_resource_event_hub_consumer_group = azure_native.devices.v20200831.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup",
            event_hub_endpoint_name="events",
            name="test",
            properties=azure_native.devices.v20200831.EventHubConsumerGroupNameArgs(
                name="test",
            ),
        ...
        ```sh
        $ pulumi import azure-native:devices/v20200831:IotHubResourceEventHubConsumerGroup test /subscriptions/cmd-sub-1/resourceGroups/cmd-rg-1/providers/Microsoft.Devices/IotHubs/test-hub-2/eventHubEndpoints/events/ConsumerGroups/%24Default 
        ```
