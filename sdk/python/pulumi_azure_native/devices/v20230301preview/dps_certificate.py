...
class DpsCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dps_certificate = azure_native.devices.v20230301preview.DpsCertificate("dpsCertificate",
            certificate_name="cert",
            properties=azure_native.devices.v20230301preview.CertificatePropertiesArgs(
                certificate="MA==",
            ),
