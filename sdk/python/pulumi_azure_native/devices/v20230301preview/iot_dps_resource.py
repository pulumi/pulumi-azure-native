...
class IotDpsResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_dps_resource = azure_native.devices.v20230301preview.IotDpsResource("iotDpsResource",
            location="East US",
            properties=azure_native.devices.v20230301preview.IotDpsPropertiesDescriptionArgs(
                enable_data_residency=False,
            ),
            provisioning_service_name="myFirstProvisioningService",
            resource_group_name="myResourceGroup",
            sku=azure_native.devices.v20230301preview.IotDpsSkuInfoArgs(
                capacity=1,
                name="S1",
            ),
            tags={})
        ...
        iot_dps_resource = azure_native.devices.v20230301preview.IotDpsResource("iotDpsResource",
            identity=azure_native.devices.v20230301preview.ManagedServiceIdentityResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        super(IotDpsResource, __self__).__init__(
            'azure-native:devices/v20230301preview:IotDpsResource',
            resource_name,
            __props__,
            opts)
