...
def get_iot_dps_resource(provisioning_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_dps_resource is deprecated: Version v20170821preview will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
