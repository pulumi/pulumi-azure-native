...
warnings.warn("""azure-native:devices/v20221212:IotDpsResourcePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20230301preview:IotDpsResourcePrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class IotDpsResourcePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(IotDpsResourcePrivateEndpointConnection, __self__).__init__(
            'azure-native:devices/v20221212:IotDpsResourcePrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
