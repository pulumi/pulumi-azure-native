...
warnings.warn("""azure-native:devices/v20210701:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:devices/v20220430preview:Certificate to guarantee forwards compatibility.""", DeprecationWarning)
...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Certificate is deprecated: azure-native:devices/v20210701:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:devices/v20220430preview:Certificate to guarantee forwards compatibility.""")
