...
warnings.warn("""Version 2017-01-19 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_iot_hub_resource(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_resource is deprecated: Version 2017-01-19 will be removed in v2 of the provider.""")
    __args__ = dict()
