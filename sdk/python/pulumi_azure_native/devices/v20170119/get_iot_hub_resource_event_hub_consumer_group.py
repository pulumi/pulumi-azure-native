...
def get_iot_hub_resource_event_hub_consumer_group(event_hub_endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_resource_event_hub_consumer_group is deprecated: Version v20170119 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
