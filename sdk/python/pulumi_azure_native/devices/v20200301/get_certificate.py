...
warnings.warn("""azure-native:devices/v20200301:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:devices/v20200401:Certificate to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_certificate(certificate_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: azure-native:devices/v20200301:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:devices/v20200401:Certificate to guarantee forwards compatibility.""")
    __args__ = dict()
