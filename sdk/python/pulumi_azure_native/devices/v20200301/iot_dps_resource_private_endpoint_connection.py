...
class IotDpsResourcePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_dps_resource_private_endpoint_connection = azure_native.devices.v20200301.IotDpsResourcePrivateEndpointConnection("iotDpsResourcePrivateEndpointConnection",
            private_endpoint_connection_name="myPrivateEndpointConnection",
            properties=azure_native.devices.v20200301.PrivateEndpointConnectionPropertiesResponseArgs(
                private_link_service_connection_state=azure_native.devices.v20200301.PrivateLinkServiceConnectionStateArgs(
