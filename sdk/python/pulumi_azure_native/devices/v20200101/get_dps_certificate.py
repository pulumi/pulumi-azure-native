...
def get_dps_certificate(certificate_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dps_certificate is deprecated: Version v20200101 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
