...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:devices/v20171115:DpsCertificate":
                return DpsCertificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20171115:IotDpsResource":
    ...
    pulumi.runtime.register_resource_module("azure-native", "devices/v20171115", _module_instance)
