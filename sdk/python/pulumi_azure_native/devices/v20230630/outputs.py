...
class RoutingCosmosDBSqlApiPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties related to a cosmos DB sql container endpoint.
        :param str container_name: The name of the cosmos DB sql container in the cosmos DB database.
        ...
        :param str id: Id of the cosmos DB sql container endpoint
        ...
        :param str authentication_type: Method used to authenticate against the cosmos DB sql container endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing cosmos DB container endpoint.
        :param str partition_key_name: The name of the partition key associated with this cosmos DB sql container if one exists. This is an optional parameter.
...
class RoutingEndpointsResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "cosmosDBSqlContainers":
            suggest = "cosmos_db_sql_containers"
        elif key == "eventHubs":
            suggest = "event_hubs"
    ...
    def __init__(__self__, *,
                 cosmos_db_sql_containers: Optional[Sequence['outputs.RoutingCosmosDBSqlApiPropertiesResponse']] = None,
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'cosmosDBSqlContainers' in kwargs:
    ...
    def cosmos_db_sql_containers(self) -> Optional[Sequence['outputs.RoutingCosmosDBSqlApiPropertiesResponse']]:
        """
