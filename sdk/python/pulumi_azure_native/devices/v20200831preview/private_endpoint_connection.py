...
warnings.warn("""Version 2020-08-31-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: Version 2020-08-31-preview will be removed in v2 of the provider.""")
