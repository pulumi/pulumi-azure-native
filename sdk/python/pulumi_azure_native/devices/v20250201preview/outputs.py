...
class IotHubDefinitionDescriptionResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "selectedUserAssignedIdentityResourceId":
            suggest = "selected_user_assigned_identity_resource_id"
    ...
    def __init__(__self__, *,
        ...
        :param str authentication_type: IotHub MI authentication type: KeyBased, UserAssigned, SystemAssigned.
        :param str connection_string: Connection string of the IoT hub.
        :param str selected_user_assigned_identity_resource_id: The selected user-assigned identity resource Id associated with IoT Hub. This is required when authenticationType is UserAssigned.
        """
        ...
        if selected_user_assigned_identity_resource_id is not None:
            pulumi.set(__self__, "selected_user_assigned_identity_resource_id", selected_user_assigned_identity_resource_id)
    ...
    def selected_user_assigned_identity_resource_id(self) -> Optional[str]:
        """
        ...
        """
        return pulumi.get(self, "selected_user_assigned_identity_resource_id")
