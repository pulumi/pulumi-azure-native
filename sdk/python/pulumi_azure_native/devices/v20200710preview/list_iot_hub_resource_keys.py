...
def list_iot_hub_resource_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/v20200710preview:listIotHubResourceKeys', __args__, opts=opts, typ=ListIotHubResourceKeysResult).value
...
def list_iot_hub_resource_keys_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devices/v20200710preview:listIotHubResourceKeys', __args__, opts=opts, typ=ListIotHubResourceKeysResult)
