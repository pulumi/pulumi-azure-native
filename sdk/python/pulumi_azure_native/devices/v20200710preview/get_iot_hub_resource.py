...
def get_iot_hub_resource(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_resource is deprecated: azure-native:devices/v20200710preview:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20221115preview:IotHubResource to guarantee forwards compatibility.""")
    __args__ = dict()
