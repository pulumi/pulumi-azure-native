...
azure-native:devices/v20180401:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:IotHubResource to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_iot_hub_resource(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_resource is deprecated: Version 2018-04-01 will be removed in v2 of the provider.
