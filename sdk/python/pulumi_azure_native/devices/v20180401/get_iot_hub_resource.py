...
def get_iot_hub_resource(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_resource is deprecated: Version v20180401 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
