...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devices:IotDpsResourcePrivateEndpointConnection'.""", DeprecationWarning)
...
class IotDpsResourcePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devices/latest:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:devices:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200301:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:devices/v20200301:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IotDpsResourcePrivateEndpointConnection, __self__).__init__(
            'azure-native:devices/latest:IotDpsResourcePrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
