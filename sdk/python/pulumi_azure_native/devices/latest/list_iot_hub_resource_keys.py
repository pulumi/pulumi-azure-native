...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:listIotHubResourceKeys'.""", DeprecationWarning)
...
def list_iot_hub_resource_keys(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_iot_hub_resource_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:listIotHubResourceKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/latest:listIotHubResourceKeys', __args__, opts=opts, typ=ListIotHubResourceKeysResult).value
