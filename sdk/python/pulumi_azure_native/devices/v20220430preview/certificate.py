...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        certificate = azure_native.devices.v20220430preview.Certificate("certificate",
            certificate_name="cert",
            properties=azure_native.devices.v20220430preview.CertificatePropertiesArgs(
                certificate="############################################",
            ),
