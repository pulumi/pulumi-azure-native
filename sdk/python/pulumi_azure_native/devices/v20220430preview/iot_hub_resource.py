...
class IotHubResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_hub_resource = azure_native.devices.v20220430preview.IotHubResource("iotHubResource",
            location="centraluseuap",
            properties=azure_native.devices.v20220430preview.IotHubPropertiesResponseArgs(
                cloud_to_device={
                    "defaultTtlAsIso8601": "PT1H",
                    "feedback": azure_native.devices.v20220430preview.FeedbackPropertiesArgs(
                ...
                event_hub_endpoints={
                    "events": azure_native.devices.v20220430preview.EventHubPropertiesArgs(
                        partition_count=2,
                ...
                ip_filter_rules=[],
                messaging_endpoints={
                    "fileNotifications": azure_native.devices.v20220430preview.MessagingEndpointPropertiesArgs(
                        lock_duration_as_iso8601="PT1M",
                        max_delivery_count=10,
                        ttl_as_iso8601="PT1H",
                    ),
                ...
                network_rule_sets={
                    ...
                    "defaultAction": "Deny",
                    "ipRules": [
                        azure_native.devices.v20220430preview.NetworkRuleSetIpRuleArgs(
                            action="Allow",
                            filter_name="rule1",
                ...
                root_certificate=azure_native.devices.v20220430preview.RootCertificatePropertiesArgs(
                ...
                routing={
                    ...
                    "fallbackRoute": azure_native.devices.v20220430preview.FallbackRoutePropertiesArgs(
                        condition="true",
                ...
                storage_endpoints={
                    "$default": azure_native.devices.v20220430preview.StorageEndpointPropertiesArgs(
                        connection_string="",
                        container_name="",
            ...
            sku=azure_native.devices.v20220430preview.IotHubSkuInfoArgs(
                capacity=1,
                name="S1",
            ),
            tags={})
        ...
        ```sh
        $ pulumi import azure-native:devices/v20220430preview:IotHubResource testHub /subscriptions/ae24ff83-d2ca-4fc8-9717-05dae4bba489/resourceGroups/myResourceGroup/providers/Microsoft.Devices/IotHubs/testHub 
        ```
