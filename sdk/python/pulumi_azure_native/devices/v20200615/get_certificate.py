...
warnings.warn("""Version 2020-06-15 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_certificate(certificate_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: Version 2020-06-15 will be removed in v2 of the provider.""")
    __args__ = dict()
