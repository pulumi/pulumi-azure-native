...
def get_dps_certificate(certificate_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dps_certificate is deprecated: azure-native:devices/v20220205:DpsCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20230301preview:DpsCertificate to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/v20220205:getDpsCertificate', __args__, opts=opts, typ=GetDpsCertificateResult).value
