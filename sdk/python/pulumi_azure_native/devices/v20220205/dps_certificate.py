...
warnings.warn("""azure-native:devices/v20220205:DpsCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20230301preview:DpsCertificate to guarantee forwards compatibility.""", DeprecationWarning)
...
class DpsCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DpsCertificate is deprecated: azure-native:devices/v20220205:DpsCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20230301preview:DpsCertificate to guarantee forwards compatibility.""")
