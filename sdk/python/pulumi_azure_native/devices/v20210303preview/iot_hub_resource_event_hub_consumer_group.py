...
class IotHubResourceEventHubConsumerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_hub_resource_event_hub_consumer_group = azure_native.devices.v20210303preview.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup",
            event_hub_endpoint_name="events",
            name="test",
            properties=azure_native.devices.v20210303preview.EventHubConsumerGroupNameArgs(
                name="test",
            ),
