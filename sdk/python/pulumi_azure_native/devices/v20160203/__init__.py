...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:devices/v20160203:IotHubResource":
                return IotHubResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20160203:IotHubResourceEventHubConsumerGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "devices/v20160203", _module_instance)
