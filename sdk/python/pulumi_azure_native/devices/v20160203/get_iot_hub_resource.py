...
azure-native:devices/v20160203:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20170701:IotHubResource to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_iot_hub_resource(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_resource is deprecated: Version 2016-02-03 will be removed in v2 of the provider.
azure-native:devices/v20160203:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20170701:IotHubResource to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/v20160203:getIotHubResource', __args__, opts=opts, typ=GetIotHubResourceResult).value
