...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.devices.v20221115preview.PrivateEndpointConnection("privateEndpointConnection",
            private_endpoint_connection_name="myPrivateEndpointConnection",
            properties=azure_native.devices.v20221115preview.PrivateEndpointConnectionPropertiesResponseArgs(
                private_link_service_connection_state=azure_native.devices.v20221115preview.PrivateLinkServiceConnectionStateArgs(
