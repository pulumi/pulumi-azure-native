...
class IotHubResourceEventHubConsumerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_hub_resource_event_hub_consumer_group = azure_native.devices.v20221115preview.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup",
            event_hub_endpoint_name="events",
            name="test",
            properties=azure_native.devices.v20221115preview.EventHubConsumerGroupNameArgs(
                name="test",
            ),
    ...
    def _internal_init(__self__,
        ...
        super(IotHubResourceEventHubConsumerGroup, __self__).__init__(
            'azure-native:devices/v20221115preview:IotHubResourceEventHubConsumerGroup',
            resource_name,
            __props__,
            opts)
