...
warnings.warn("""azure-native:devices/v20210201preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: azure-native:devices/v20210201preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:PrivateEndpointConnection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devices:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200401:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200615:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200710preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200801:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200831:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200831preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20210303preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20210331:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20210701:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20210701preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20210702:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20210702preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20220430preview:PrivateEndpointConnection")])
