...
warnings.warn("""azure-native:devices/v20210702:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:Certificate to guarantee forwards compatibility.""", DeprecationWarning)
...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] certificate_name: The name of the certificate
        :param pulumi.Input[pulumi.InputType['CertificatePropertiesArgs']] properties: The description of an X509 CA Certificate.
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the IoT hub.
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Certificate is deprecated: azure-native:devices/v20210702:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:Certificate to guarantee forwards compatibility.""")
