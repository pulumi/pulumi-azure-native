...
def get_entity(entity_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudhealth:getEntity', __args__, opts=opts, typ=GetEntityResult).value
...
def get_entity_output(entity_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudhealth:getEntity', __args__, opts=opts, typ=GetEntityResult)
