...
def get_authentication_setting(authentication_setting_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudhealth:getAuthenticationSetting', __args__, opts=opts, typ=GetAuthenticationSettingResult).value
...
def get_authentication_setting_output(authentication_setting_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudhealth:getAuthenticationSetting', __args__, opts=opts, typ=GetAuthenticationSettingResult)
