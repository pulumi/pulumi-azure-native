...
class Relationship(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudhealth/v20250501preview:Relationship"), pulumi.Alias(type_="azure-native:cloudhealth/v20260101preview:Relationship"), pulumi.Alias(type_="azure-native:cloudhealth/v20260501preview:Relationship")])
