...
class HealthModelArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['HealthModelPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['HealthModelPropertiesArgs']]):
...
class HealthModel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['HealthModelPropertiesArgs', 'HealthModelPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['HealthModelPropertiesArgs', 'HealthModelPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(HealthModelArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = HealthModelArgs.__new__(HealthModelArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudhealth/v20250501preview:HealthModel"), pulumi.Alias(type_="azure-native:cloudhealth/v20260101preview:HealthModel"), pulumi.Alias(type_="azure-native:cloudhealth/v20260501preview:HealthModel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HealthModel, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'HealthModel':
        """
        ...
        __props__.__dict__["type"] = None
        return HealthModel(resource_name, opts=opts, __props__=__props__)
