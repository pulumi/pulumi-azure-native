...
class HealthModelArgs:
    ...
    def health_model_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def health_model_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HealthModel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudhealth/v20250501preview:HealthModel")])
