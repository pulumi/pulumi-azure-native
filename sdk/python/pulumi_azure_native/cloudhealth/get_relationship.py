...
def get_relationship(health_model_name: Optional[_builtins.str] = None,
...
def get_relationship_output(health_model_name: Optional[pulumi.Input[_builtins.str]] = None,
