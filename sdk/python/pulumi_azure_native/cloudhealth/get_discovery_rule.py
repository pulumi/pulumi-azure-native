...
class GetDiscoveryRuleResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.DiscoveryRulePropertiesResponse':
        """
...
def get_discovery_rule(discovery_rule_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudhealth:getDiscoveryRule', __args__, opts=opts, typ=GetDiscoveryRuleResult).value
...
def get_discovery_rule_output(discovery_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudhealth:getDiscoveryRule', __args__, opts=opts, typ=GetDiscoveryRuleResult)
