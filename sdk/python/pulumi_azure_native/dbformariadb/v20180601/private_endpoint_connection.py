...
warnings.warn("""azure-native:dbformariadb/v20180601:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformariadb/v20180601privatepreview:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformariadb:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601privatepreview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:dbformariadb/v20180601:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
