...
class Configuration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformariadb/v20180601preview:Configuration"), pulumi.Alias(type_="azure-native:dbformariadb:Configuration")])
