...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_rule is deprecated: azure-native:dbformariadb/v20180601:FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformariadb/v20180601preview:FirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
