...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_rule = azure_native.dbformariadb.v20180601preview.VirtualNetworkRule("virtualNetworkRule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformariadb:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601:VirtualNetworkRule")])
