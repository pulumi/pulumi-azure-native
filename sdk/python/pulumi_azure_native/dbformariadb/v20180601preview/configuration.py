...
class Configuration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration = azure_native.dbformariadb.v20180601preview.Configuration("configuration",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformariadb:Configuration"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601:Configuration")])
