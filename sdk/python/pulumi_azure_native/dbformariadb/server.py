...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformariadb:Server"), pulumi.Alias(type_="azure-native:dbformariadb/latest:Server"), pulumi.Alias(type_="azure-nextgen:dbformariadb/latest:Server"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601:Server"), pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601:Server"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601preview:Server"), pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601preview:Server")])
