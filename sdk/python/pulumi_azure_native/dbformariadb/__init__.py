...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:dbformariadb:Configuration":
                return Configuration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformariadb:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformariadb:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformariadb:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformariadb:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformariadb:VirtualNetworkRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "dbformariadb", _module_instance)
