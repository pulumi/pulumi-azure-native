...
class FirewallRule(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:dbformariadb:FirewallRule"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformariadb/v20180601:FirewallRule"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601preview:FirewallRule")])
