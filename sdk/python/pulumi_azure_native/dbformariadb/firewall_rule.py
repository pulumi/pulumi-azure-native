...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformariadb/v20180601:FirewallRule"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601preview:FirewallRule"), pulumi.Alias(type_="azure-native_dbformariadb_v20180601:dbformariadb:FirewallRule"), pulumi.Alias(type_="azure-native_dbformariadb_v20180601preview:dbformariadb:FirewallRule")])
