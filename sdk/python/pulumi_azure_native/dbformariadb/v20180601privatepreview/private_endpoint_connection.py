...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.dbformariadb.v20180601privatepreview.PrivateEndpointConnection("privateEndpointConnection",
            private_endpoint_connection_name="private-endpoint-connection-name",
            private_link_service_connection_state=azure_native.dbformariadb.v20180601privatepreview.PrivateLinkServiceConnectionStatePropertyResponseArgs(
        ...
        ```sh
        $ pulumi import azure-native:dbformariadb/v20180601privatepreview:PrivateEndpointConnection private-endpoint-connection-name /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.DBforMariaDB/servers/test-svr/privateEndpointConnections/private-endpoint-connection-name 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformariadb:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:dbformariadb/v20180601privatepreview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
