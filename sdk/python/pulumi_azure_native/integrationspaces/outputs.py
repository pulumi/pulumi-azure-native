...
class BusinessProcessDevelopmentArtifactPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str description: The description of the business process.
...
class BusinessProcessIdentifierResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of business process identifier.
        :param builtins.str property_name: The property name of the business process identifier.
        :param builtins.str property_type: The property type of the business process identifier.
        """
...
class BusinessProcessMappingItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of business process mapping.
        :param builtins.str logic_app_resource_id: The logic app resource id.
        :param builtins.str operation_name: The operation name.
        :param builtins.str operation_type: The mapping item operation type of the business process.
        :param builtins.str workflow_name: The workflow name within the logic app.
        """
...
class BusinessProcessReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The business process reference.
        :param builtins.str name: The business process name.
        :param builtins.str version: The business process version.
        """
        if name is not None:
...
class BusinessProcessStageResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 stages_before: Optional[Sequence[builtins.str]] = None):
        """
        The properties of business process stage.
        :param builtins.str description: The description of the business stage.
        :param Mapping[str, builtins.str] properties: The properties within the properties of the business process stage.
        :param Sequence[builtins.str] stages_before: The property to keep track of stages before current in the business process stage.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    def stages_before(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SaveOrGetBusinessProcessDevelopmentArtifactResponseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The business process development artifact save or get response.
        :param builtins.str name: The name of the business process development artifact.
...
class TrackingCorrelationContextResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The tracking correlation context.
        :param builtins.str operation_name: The operation name for correlation context.
        :param builtins.str operation_type: The operation type for correlation context.
        :param builtins.str property_name: The name of the correlation property.
        :param builtins.str value: The template expression for correlation context property value.
        """
        if operation_name is not None:
            pulumi.set(__self__, "operation_name", operation_name)
        if operation_type is not None:
...
class TrackingDataStoreResponse(dict):
    ...
    def __init__(__self__, *,
                 data_store_ingestion_uri: Optional[builtins.str] = None,
                 data_store_resource_id: Optional[builtins.str] = None,
                 data_store_uri: Optional[builtins.str] = None,
                 database_name: Optional[builtins.str] = None):
        """
        The properties of tracking data store.
        :param builtins.str data_store_ingestion_uri: The data store ingestion URI.
        :param builtins.str data_store_resource_id: The data store resource id.
        :param builtins.str data_store_uri: The data store URI.
    ...
    def data_store_ingestion_uri(self) -> Optional[builtins.str]:
        """
    ...
    def data_store_resource_id(self) -> Optional[builtins.str]:
        """
    ...
    def data_store_uri(self) -> Optional[builtins.str]:
        """
        The data store URI.
        """
...
class TrackingProfileDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str schema: The tracking definition schema uri.
