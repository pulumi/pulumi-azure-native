...
class BusinessProcessMappingItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str workflow_name: The workflow name within the logic app.
        """
...
class SaveOrGetBusinessProcessDevelopmentArtifactResponseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param '_commontypesv3.SystemDataResponse' system_data: The system data of the business process development artifact.
...
class TrackingCorrelationContextResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str value: The template expression for correlation context property value.
        """
        if operation_name is not None:
            pulumi.set(__self__, "operation_name", operation_name)
        if operation_type is not None:
...
class TrackingDataStoreResponse(dict):
    ...
    def __init__(__self__, *,
                 data_store_ingestion_uri: Optional[_builtins.str] = None,
                 data_store_resource_id: Optional[_builtins.str] = None,
                 data_store_uri: Optional[_builtins.str] = None,
