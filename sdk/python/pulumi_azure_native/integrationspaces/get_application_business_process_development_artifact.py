...
def get_application_business_process_development_artifact(application_name: Optional[builtins.str] = None,
...
def get_application_business_process_development_artifact_output(application_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:integrationspaces:getApplicationBusinessProcessDevelopmentArtifact', __args__, opts=opts, typ=GetApplicationBusinessProcessDevelopmentArtifactResult)
