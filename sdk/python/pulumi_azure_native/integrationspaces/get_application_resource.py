...
def get_application_resource(application_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_name: The name of the application resource.
...
def get_application_resource_output(application_name: Optional[pulumi.Input[builtins.str]] = None,
