...
def list_application_business_process_development_artifacts(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:integrationspaces/v20231114preview:listApplicationBusinessProcessDevelopmentArtifacts', __args__, opts=opts, typ=ListApplicationBusinessProcessDevelopmentArtifactsResult).value
