...
def get_application_resource(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:integrationspaces/v20231114preview:getApplicationResource', __args__, opts=opts, typ=GetApplicationResourceResult).value
