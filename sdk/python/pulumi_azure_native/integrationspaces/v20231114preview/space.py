...
class Space(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:integrationspaces:Space")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Space, __self__).__init__(
            'azure-native:integrationspaces/v20231114preview:Space',
            resource_name,
            __props__,
            opts)
