...
def get_application_business_process_development_artifact(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:integrationspaces/v20231114preview:getApplicationBusinessProcessDevelopmentArtifact', __args__, opts=opts, typ=GetApplicationBusinessProcessDevelopmentArtifactResult).value
...
def get_application_business_process_development_artifact_output(application_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['spaceName'] = space_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:integrationspaces/v20231114preview:getApplicationBusinessProcessDevelopmentArtifact', __args__, opts=opts, typ=GetApplicationBusinessProcessDevelopmentArtifactResult)
    return __ret__.apply(lambda __response__: GetApplicationBusinessProcessDevelopmentArtifactResult(
