...
def get_business_process(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:integrationspaces/v20231114preview:getBusinessProcess', __args__, opts=opts, typ=GetBusinessProcessResult).value
...
def get_business_process_output(application_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['spaceName'] = space_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:integrationspaces/v20231114preview:getBusinessProcess', __args__, opts=opts, typ=GetBusinessProcessResult)
