...
class InfrastructureResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] resource_id: The id of the infrastructure resource.
        :param pulumi.Input[str] resource_type: The type of the infrastructure resource.
    ...
    def infrastructure_resource_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def infrastructure_resource_name(self, value: Optional[pulumi.Input[str]]):
...
class InfrastructureResource(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InfrastructureResourceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:integrationspaces:InfrastructureResource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(InfrastructureResource, __self__).__init__(
            'azure-native:integrationspaces/v20231114preview:InfrastructureResource',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'InfrastructureResource':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return InfrastructureResource(resource_name, opts=opts, __props__=__props__)
