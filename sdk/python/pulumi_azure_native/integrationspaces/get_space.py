...
def get_space(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:integrationspaces:getSpace', __args__, opts=opts, typ=GetSpaceResult).value
...
def get_space_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
