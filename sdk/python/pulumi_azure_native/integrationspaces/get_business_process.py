...
def get_business_process(application_name: Optional[_builtins.str] = None,
                         business_process_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str business_process_name: The name of the business process
