...
class ApplicationResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_id: The Arm id of the application resource.
        :param pulumi.Input[builtins.str] resource_type: The type of the application resource.
        :param pulumi.Input[builtins.str] space_name: The name of the space
        :param pulumi.Input[builtins.str] resource_kind: The kind of the application resource.
        :param pulumi.Input[builtins.str] resource_name: The name of the application resource.
        """
...
class ApplicationResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] resource_id: The Arm id of the application resource.
        :param pulumi.Input[builtins.str] resource_kind: The kind of the application resource.
        :param pulumi.Input[builtins.str] resource_name_: The name of the application resource.
        :param pulumi.Input[builtins.str] resource_type: The type of the application resource.
        :param pulumi.Input[builtins.str] space_name: The name of the space
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:integrationspaces/v20231114preview:ApplicationResource")])
    ...
    @property
    @pulumi.getter(name="resourceKind")
    def resource_kind(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The kind of the application resource.
        """
        return pulumi.get(self, "resource_kind")
