...
class InfrastructureResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:integrationspaces/v20231114preview:InfrastructureResource"), pulumi.Alias(type_="azure-native_integrationspaces_v20231114preview:integrationspaces:InfrastructureResource")])
