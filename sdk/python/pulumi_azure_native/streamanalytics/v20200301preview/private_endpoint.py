...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 private_endpoint_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['PrivateEndpointPropertiesArgs', 'PrivateEndpointPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] cluster_name: The name of the cluster.
        :param pulumi.Input[str] private_endpoint_name: The name of the private endpoint.
        :param pulumi.Input[Union['PrivateEndpointPropertiesArgs', 'PrivateEndpointPropertiesArgsDict']] properties: The properties associated with a private endpoint.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:streamanalytics/v20200301:PrivateEndpoint"), pulumi.Alias(type_="azure-native:streamanalytics:PrivateEndpoint")])
