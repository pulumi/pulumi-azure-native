...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cluster = azure_native.streamanalytics.v20200301preview.Cluster("cluster",
            cluster_name="An Example Cluster",
            location="North US",
            resource_group_name="sjrg",
            sku=azure_native.streamanalytics.v20200301preview.ClusterSkuArgs(
                capacity=48,
                name="Default",
            ),
            tags={
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:streamanalytics:Cluster"), pulumi.Alias(type_="azure-native:streamanalytics/v20200301:Cluster")])
