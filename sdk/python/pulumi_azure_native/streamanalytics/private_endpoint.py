...
class PrivateEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:streamanalytics/v20200301preview:PrivateEndpoint"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20200301preview:PrivateEndpoint")])
