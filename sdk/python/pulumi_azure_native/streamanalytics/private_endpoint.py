...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:streamanalytics/v20200301:PrivateEndpoint"), pulumi.Alias(type_="azure-native:streamanalytics/v20200301preview:PrivateEndpoint"), pulumi.Alias(type_="azure-native_streamanalytics_v20200301:streamanalytics:PrivateEndpoint"), pulumi.Alias(type_="azure-native_streamanalytics_v20200301preview:streamanalytics:PrivateEndpoint")])
