...
class BlobOutputDataSourceArgs:
    ...
    def _configure(
        ...
        if 'authenticationMode' in kwargs:
            authentication_mode = kwargs['authenticationMode']
        if 'blobPathPrefix' in kwargs:
            blob_path_prefix = kwargs['blobPathPrefix']
        if 'blobWriteMode' in kwargs:
...
class CustomClrSerializationArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'serializationClassName' in kwargs:
            serialization_class_name = kwargs['serializationClassName']
        if 'serializationDllPath' in kwargs:
...
class DocumentDbOutputDataSourceArgs:
    ...
    def _configure(
        ...
        if 'authenticationMode' in kwargs:
            authentication_mode = kwargs['authenticationMode']
        if 'collectionNamePattern' in kwargs:
...
class ExternalArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'refreshConfiguration' in kwargs:
...
class FunctionInputArgs:
    ...
    def _configure(
        ...
        if 'dataType' in kwargs:
            data_type = kwargs['dataType']
        if 'isConfigurationParameter' in kwargs:
...
class OutputWatermarkPropertiesArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'maxWatermarkDifferenceAcrossPartitions' in kwargs:
...
class TransformationArgs:
    ...
    def _configure(
        ...
        if 'validStreamingUnits' in kwargs:
