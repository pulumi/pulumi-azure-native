...
class Output(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 time_window: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Output is deprecated: azure-native:streamanalytics/v20170401preview:Output is being removed in the next major version of this provider. Upgrade to at least azure-native:streamanalytics/v20211001preview:Output to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:streamanalytics:Output"), pulumi.Alias(type_="azure-native:streamanalytics/v20160301:Output"), pulumi.Alias(type_="azure-native:streamanalytics/v20200301:Output"), pulumi.Alias(type_="azure-native:streamanalytics/v20211001preview:Output")])
