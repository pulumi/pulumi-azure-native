...
warnings.warn("""Version 2017-04-01-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
class Input(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Input is deprecated: Version 2017-04-01-preview will be removed in v2 of the provider.""")
