...
def get_streaming_job(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:streamanalytics/v20170401preview:getStreamingJob', __args__, opts=opts, typ=GetStreamingJobResult).value
...
def get_streaming_job_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:streamanalytics/v20170401preview:getStreamingJob', __args__, opts=opts, typ=GetStreamingJobResult)
