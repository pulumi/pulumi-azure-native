...
class StreamingJobArgs:
    def __init__(__self__, *,
                 ...
                 sku: Optional[pulumi.Input['StreamingJobSkuArgs']] = None,
        ...
        :param pulumi.Input['StreamingJobSkuArgs'] sku: Describes the SKU of the streaming job. Required on PUT (CreateOrReplace) requests.
    ...
    @property
    @pulumi.getter
    def sku(self) -> Optional[pulumi.Input['StreamingJobSkuArgs']]:
        """
    ...
    @sku.setter
    def sku(self, value: Optional[pulumi.Input['StreamingJobSkuArgs']]):
...
class StreamingJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        streaming_job = azure_native.streamanalytics.v20170401preview.StreamingJob("streamingJob",
            ...
            functions=[],
            inputs=[azure_native.streamanalytics.v20170401preview.InputArgs(
                name="inputtest",
                properties=azure_native.streamanalytics.v20170401preview.StreamInputPropertiesArgs(
                    datasource=azure_native.streamanalytics.v20170401preview.BlobStreamInputDataSourceArgs(
                        container="containerName",
                        path_pattern="",
                        storage_accounts=[azure_native.streamanalytics.v20170401preview.StorageAccountArgs(
                            account_key="yourAccountKey==",
                            account_name="yourAccountName",
                        )],
                        type="Microsoft.Storage/Blob",
                    ),
                    serialization=azure_native.streamanalytics.v20170401preview.JsonSerializationArgs(
                        encoding="UTF8",
                        type="Json",
                    ),
                    type="Stream",
            ...
            outputs=[azure_native.streamanalytics.v20170401preview.OutputArgs(
                datasource=azure_native.streamanalytics.v20170401preview.AzureSqlDatabaseOutputDataSourceArgs(
            ...
            sku=azure_native.streamanalytics.v20170401preview.StreamingJobSkuArgs(
                name="Standard",
            ),
            tags={
                "key1": "value1",
            ...
            transformation=azure_native.streamanalytics.v20170401preview.TransformationArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:streamanalytics:StreamingJob"), pulumi.Alias(type_="azure-native:streamanalytics/v20160301:StreamingJob"), pulumi.Alias(type_="azure-native:streamanalytics/v20200301:StreamingJob"), pulumi.Alias(type_="azure-native:streamanalytics/v20211001preview:StreamingJob")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StreamingJob, __self__).__init__(
            'azure-native:streamanalytics/v20170401preview:StreamingJob',
            resource_name,
            __props__,
            opts)
