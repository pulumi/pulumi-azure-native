...
class StreamingJobArgs:
    ...
    def _configure(
        ...
        if job_storage_account is None and 'jobStorageAccount' in kwargs:
        ...
        if output_start_mode is None and 'outputStartMode' in kwargs:
            output_start_mode = kwargs['outputStartMode']
        if output_start_time is None and 'outputStartTime' in kwargs:
...
class StreamingJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            cluster = _utilities.configure(cluster, ClusterInfoArgs, True)
            ...
            externals = _utilities.configure(externals, ExternalArgs, True)
            ...
            job_storage_account = _utilities.configure(job_storage_account, JobStorageAccountArgs, True)
            ...
            sku = _utilities.configure(sku, StreamingJobSkuArgs, True)
            __props__.__dict__["sku"] = sku
            __props__.__dict__["tags"] = tags
            transformation = _utilities.configure(transformation, TransformationArgs, True)
