...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:streamanalytics/latest:Function":
                return Function(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:streamanalytics/latest:Input":
                return Input(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:streamanalytics/latest:Output":
                return Output(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:streamanalytics/latest:StreamingJob":
    ...
    pulumi.runtime.register_resource_module("azure-native", "streamanalytics/latest", _module_instance)
