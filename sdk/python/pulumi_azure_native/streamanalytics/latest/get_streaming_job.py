...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:streamanalytics:getStreamingJob'.""", DeprecationWarning)
...
def get_streaming_job(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_streaming_job is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:streamanalytics:getStreamingJob'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:streamanalytics/latest:getStreamingJob', __args__, opts=opts, typ=GetStreamingJobResult).value
