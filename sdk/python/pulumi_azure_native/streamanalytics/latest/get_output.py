...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:streamanalytics:getOutput'.""", DeprecationWarning)
...
def get_output(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:streamanalytics/latest:getOutput', __args__, opts=opts, typ=GetOutputResult).value
