...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:streamanalytics:Input'.""", DeprecationWarning)
...
class Input(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""Input is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:streamanalytics:Input'.""")
