...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:streamanalytics:Function'.""", DeprecationWarning)
...
class Function(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:streamanalytics/latest:Function"), pulumi.Alias(type_="azure-native:streamanalytics:Function"), pulumi.Alias(type_="azure-nextgen:streamanalytics:Function"), pulumi.Alias(type_="azure-native:streamanalytics/v20160301:Function"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20160301:Function"), pulumi.Alias(type_="azure-native:streamanalytics/v20170401preview:Function"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20170401preview:Function")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Function, __self__).__init__(
            'azure-native:streamanalytics/latest:Function',
            resource_name,
            __props__,
            opts)
