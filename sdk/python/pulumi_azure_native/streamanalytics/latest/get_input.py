...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:streamanalytics:getInput'.""", DeprecationWarning)
...
def get_input(input_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:streamanalytics/latest:getInput', __args__, opts=opts, typ=GetInputResult).value
