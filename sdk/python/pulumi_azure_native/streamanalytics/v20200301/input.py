...
warnings.warn("""azure-native:streamanalytics/v20200301:Input is being removed in the next major version of this provider. Please upgrade to azure-native:streamanalytics/v20211001preview:Input to guarantee forwards compatibility.""", DeprecationWarning)
