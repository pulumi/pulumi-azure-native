...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint = azure_native.streamanalytics.v20200301.PrivateEndpoint("privateEndpoint",
            cluster_name="testcluster",
            manual_private_link_service_connections=[azure_native.streamanalytics.v20200301.PrivateLinkServiceConnectionArgs(
