...
def get_output(job_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_output is deprecated: azure-native:streamanalytics/v20200301:Output is being removed in the next major version of this provider. Upgrade to at least azure-native:streamanalytics/v20211001preview:Output to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['jobName'] = job_name
    __args__['outputName'] = output_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:streamanalytics/v20200301:getOutput', __args__, opts=opts, typ=GetOutputResult).value
