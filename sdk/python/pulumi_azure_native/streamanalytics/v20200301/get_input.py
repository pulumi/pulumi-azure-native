...
def get_input(input_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_input is deprecated: azure-native:streamanalytics/v20200301:Input is being removed in the next major version of this provider. Upgrade to at least azure-native:streamanalytics/v20211001preview:Input to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['inputName'] = input_name
    __args__['jobName'] = job_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:streamanalytics/v20200301:getInput', __args__, opts=opts, typ=GetInputResult).value
