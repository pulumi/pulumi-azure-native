...
def get_input(input_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:streamanalytics/v20160301:getInput', __args__, opts=opts, typ=GetInputResult).value
...
def get_input_output(input_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:streamanalytics/v20160301:getInput', __args__, opts=opts, typ=GetInputResult)
