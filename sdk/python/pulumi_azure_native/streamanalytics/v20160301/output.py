...
class Output(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 datasource: Optional[pulumi.Input[Union[Union['AzureDataLakeStoreOutputDataSourceArgs', 'AzureDataLakeStoreOutputDataSourceArgsDict'], Union['AzureSqlDatabaseOutputDataSourceArgs', 'AzureSqlDatabaseOutputDataSourceArgsDict'], Union['AzureTableOutputDataSourceArgs', 'AzureTableOutputDataSourceArgsDict'], Union['BlobOutputDataSourceArgs', 'BlobOutputDataSourceArgsDict'], Union['DocumentDbOutputDataSourceArgs', 'DocumentDbOutputDataSourceArgsDict'], Union['EventHubOutputDataSourceArgs', 'EventHubOutputDataSourceArgsDict'], Union['PowerBIOutputDataSourceArgs', 'PowerBIOutputDataSourceArgsDict'], Union['ServiceBusQueueOutputDataSourceArgs', 'ServiceBusQueueOutputDataSourceArgsDict'], Union['ServiceBusTopicOutputDataSourceArgs', 'ServiceBusTopicOutputDataSourceArgsDict']]]] = None,
                 job_name: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 output_name: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 serialization: Optional[pulumi.Input[Union[Union['AvroSerializationArgs', 'AvroSerializationArgsDict'], Union['CsvSerializationArgs', 'CsvSerializationArgsDict'], Union['JsonSerializationArgs', 'JsonSerializationArgsDict']]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union[Union['AzureDataLakeStoreOutputDataSourceArgs', 'AzureDataLakeStoreOutputDataSourceArgsDict'], Union['AzureSqlDatabaseOutputDataSourceArgs', 'AzureSqlDatabaseOutputDataSourceArgsDict'], Union['AzureTableOutputDataSourceArgs', 'AzureTableOutputDataSourceArgsDict'], Union['BlobOutputDataSourceArgs', 'BlobOutputDataSourceArgsDict'], Union['DocumentDbOutputDataSourceArgs', 'DocumentDbOutputDataSourceArgsDict'], Union['EventHubOutputDataSourceArgs', 'EventHubOutputDataSourceArgsDict'], Union['PowerBIOutputDataSourceArgs', 'PowerBIOutputDataSourceArgsDict'], Union['ServiceBusQueueOutputDataSourceArgs', 'ServiceBusQueueOutputDataSourceArgsDict'], Union['ServiceBusTopicOutputDataSourceArgs', 'ServiceBusTopicOutputDataSourceArgsDict']]] datasource: Describes the data source that output will be written to. Required on PUT (CreateOrReplace) requests.
        :param pulumi.Input[str] job_name: The name of the streaming job.
        :param pulumi.Input[str] name: Resource name
        :param pulumi.Input[str] output_name: The name of the output.
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[Union[Union['AvroSerializationArgs', 'AvroSerializationArgsDict'], Union['CsvSerializationArgs', 'CsvSerializationArgsDict'], Union['JsonSerializationArgs', 'JsonSerializationArgsDict']]] serialization: Describes how data from an input is serialized or how data is serialized when written to an output. Required on PUT (CreateOrReplace) requests.
        """
        ...
    @overload
    def __init__(__self__,
