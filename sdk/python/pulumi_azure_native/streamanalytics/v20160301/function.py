...
class Function(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['ScalarFunctionPropertiesArgs', 'ScalarFunctionPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] job_name: The name of the streaming job.
        :param pulumi.Input[str] name: Resource name
        :param pulumi.Input[Union['ScalarFunctionPropertiesArgs', 'ScalarFunctionPropertiesArgsDict']] properties: The properties that are associated with a function.
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        """
        ...
    @overload
