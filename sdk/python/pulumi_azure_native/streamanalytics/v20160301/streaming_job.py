...
class StreamingJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        streaming_job = azure_native.streamanalytics.v20160301.StreamingJob("streamingJob",
            ...
            functions=[],
            inputs=[azure_native.streamanalytics.v20160301.InputArgs(
                name="inputtest",
            ...
            outputs=[azure_native.streamanalytics.v20160301.OutputArgs(
            ...
            sku=azure_native.streamanalytics.v20160301.SkuArgs(
                name="Standard",
            ),
            tags={
                "key1": "value1",
            ...
            transformation=azure_native.streamanalytics.v20160301.TransformationArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:streamanalytics:StreamingJob"), pulumi.Alias(type_="azure-native:streamanalytics/v20170401preview:StreamingJob"), pulumi.Alias(type_="azure-native:streamanalytics/v20200301:StreamingJob"), pulumi.Alias(type_="azure-native:streamanalytics/v20211001preview:StreamingJob")])
