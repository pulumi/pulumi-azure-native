...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:streamanalytics:Cluster"), pulumi.Alias(type_="azure-native:streamanalytics/v20200301preview:Cluster"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20200301preview:Cluster")])
