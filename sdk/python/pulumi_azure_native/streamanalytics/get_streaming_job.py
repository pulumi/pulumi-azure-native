...
class GetStreamingJobResult:
    ...
    def compatibility_level(self) -> Optional[builtins.str]:
        """
    ...
    def content_storage_policy(self) -> Optional[builtins.str]:
        """
    ...
    def data_locale(self) -> Optional[builtins.str]:
        """
    ...
    def events_late_arrival_max_delay_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def events_out_of_order_max_delay_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def events_out_of_order_policy(self) -> Optional[builtins.str]:
        """
    ...
    def last_output_event_time(self) -> builtins.str:
        """
    ...
    def output_error_policy(self) -> Optional[builtins.str]:
        """
    ...
    def output_start_mode(self) -> Optional[builtins.str]:
        """
    ...
    def output_start_time(self) -> Optional[builtins.str]:
        """
...
def get_streaming_job(expand: Optional[builtins.str] = None,
    ...
    :param builtins.str expand: The $expand OData query parameter. This is a comma-separated list of additional streaming job properties to include in the response, beyond the default set returned when this parameter is absent. The default set is all streaming job properties other than 'inputs', 'transformation', 'outputs', and 'functions'.
...
def get_streaming_job_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
