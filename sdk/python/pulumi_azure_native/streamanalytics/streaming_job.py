...
class StreamingJobArgs:
    def __init__(__self__, *,
                 ...
                 compatibility_level: Optional[pulumi.Input[Union[builtins.str, 'CompatibilityLevel']]] = None,
                 content_storage_policy: Optional[pulumi.Input[Union[builtins.str, 'ContentStoragePolicy']]] = None,
                 ...
                 events_out_of_order_policy: Optional[pulumi.Input[Union[builtins.str, 'EventsOutOfOrderPolicy']]] = None,
                 ...
                 job_type: Optional[pulumi.Input[Union[builtins.str, 'JobType']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 output_error_policy: Optional[pulumi.Input[Union[builtins.str, 'OutputErrorPolicy']]] = None,
                 output_start_mode: Optional[pulumi.Input[Union[builtins.str, 'OutputStartMode']]] = None,
                 output_start_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'CompatibilityLevel']] compatibility_level: Controls certain runtime behaviors of the streaming job.
        :param pulumi.Input[Union[builtins.str, 'ContentStoragePolicy']] content_storage_policy: Valid values are JobStorageAccount and SystemAccount. If set to JobStorageAccount, this requires the user to also specify jobStorageAccount property. .
        :param pulumi.Input[builtins.str] data_locale: The data locale of the stream analytics job. Value should be the name of a supported .NET Culture from the set https://msdn.microsoft.com/en-us/library/system.globalization.culturetypes(v=vs.110).aspx. Defaults to 'en-US' if none specified.
        :param pulumi.Input[builtins.int] events_late_arrival_max_delay_in_seconds: The maximum tolerable delay in seconds where events arriving late could be included.  Supported range is -1 to 1814399 (20.23:59:59 days) and -1 is used to specify wait indefinitely. If the property is absent, it is interpreted to have a value of -1.
        :param pulumi.Input[builtins.int] events_out_of_order_max_delay_in_seconds: The maximum tolerable delay in seconds where out-of-order events can be adjusted to be back in order.
        :param pulumi.Input[Union[builtins.str, 'EventsOutOfOrderPolicy']] events_out_of_order_policy: Indicates the policy to apply to events that arrive out of order in the input event stream.
        ...
        :param pulumi.Input[Union[builtins.str, 'JobType']] job_type: Describes the type of the job. Valid modes are `Cloud` and 'Edge'.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union[builtins.str, 'OutputErrorPolicy']] output_error_policy: Indicates the policy to apply to events that arrive at the output and cannot be written to the external storage due to being malformed (missing column values, column values of wrong type or size).
        :param pulumi.Input[Union[builtins.str, 'OutputStartMode']] output_start_mode: This property should only be utilized when it is desired that the job be started immediately upon creation. Value may be JobStartTime, CustomTime, or LastOutputEventTime to indicate whether the starting point of the output event stream should start whenever the job is started, start at a custom user time stamp specified via the outputStartTime property, or start from the last event output time.
        :param pulumi.Input[builtins.str] output_start_time: Value is either an ISO-8601 formatted time stamp that indicates the starting point of the output event stream, or null to indicate that the output event stream will start whenever the streaming job is started. This property must have a value if outputStartMode is set to CustomTime.
    ...
    def compatibility_level(self) -> Optional[pulumi.Input[Union[builtins.str, 'CompatibilityLevel']]]:
        """
    ...
    def compatibility_level(self, value: Optional[pulumi.Input[Union[builtins.str, 'CompatibilityLevel']]]):
        pulumi.set(self, "compatibility_level", value)

    @property
    @pulumi.getter(name="contentStoragePolicy")
    def content_storage_policy(self) -> Optional[pulumi.Input[Union[builtins.str, 'ContentStoragePolicy']]]:
        """
    ...
    def content_storage_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'ContentStoragePolicy']]]):
    ...
    def events_out_of_order_policy(self) -> Optional[pulumi.Input[Union[builtins.str, 'EventsOutOfOrderPolicy']]]:
        """
    ...
    def events_out_of_order_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'EventsOutOfOrderPolicy']]]):
    ...
    def job_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'JobType']]]:
        """
    ...
    @job_type.setter
    def job_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'JobType']]]):
    ...
    def output_error_policy(self) -> Optional[pulumi.Input[Union[builtins.str, 'OutputErrorPolicy']]]:
        """
    ...
    def output_error_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'OutputErrorPolicy']]]):
        pulumi.set(self, "output_error_policy", value)

    @property
    @pulumi.getter(name="outputStartMode")
    def output_start_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'OutputStartMode']]]:
        """
    ...
    def output_start_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'OutputStartMode']]]):
        pulumi.set(self, "output_start_mode", value)

    @property
    @pulumi.getter(name="outputStartTime")
    def output_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def output_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StreamingJob(pulumi.CustomResource):
    ...
    def job_state(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def last_output_event_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="outputStartMode")
    def output_start_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This property should only be utilized when it is desired that the job be started immediately upon creation. Value may be JobStartTime, CustomTime, or LastOutputEventTime to indicate whether the starting point of the output event stream should start whenever the job is started, start at a custom user time stamp specified via the outputStartTime property, or start from the last event output time.
        """
        return pulumi.get(self, "output_start_mode")
    ...
    @property
    @pulumi.getter(name="outputStartTime")
    def output_start_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Value is either an ISO-8601 formatted time stamp that indicates the starting point of the output event stream, or null to indicate that the output event stream will start whenever the streaming job is started. This property must have a value if outputStartMode is set to CustomTime.
        """
        return pulumi.get(self, "output_start_time")
