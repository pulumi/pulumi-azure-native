...
class AgentApplication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:AgentApplication"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:AgentApplication"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:AgentApplication"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:AgentApplication"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:AgentApplication"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:AgentApplication"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:AgentApplication")])
