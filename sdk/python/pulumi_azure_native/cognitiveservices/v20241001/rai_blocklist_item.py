...
class RaiBlocklistItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:RaiBlocklistItem"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:RaiBlocklistItem"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:RaiBlocklistItem"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:RaiBlocklistItem")])
