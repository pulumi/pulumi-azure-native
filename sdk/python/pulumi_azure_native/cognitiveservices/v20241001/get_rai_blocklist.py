...
def get_rai_blocklist(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20241001:getRaiBlocklist', __args__, opts=opts, typ=GetRaiBlocklistResult).value
...
def get_rai_blocklist_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20241001:getRaiBlocklist', __args__, opts=opts, typ=GetRaiBlocklistResult)
