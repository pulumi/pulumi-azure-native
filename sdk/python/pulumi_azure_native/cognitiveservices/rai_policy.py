...
class RaiPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250601:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250701preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250901:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260701:RaiPolicy")])
