...
class RaiPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:RaiPolicy")])
