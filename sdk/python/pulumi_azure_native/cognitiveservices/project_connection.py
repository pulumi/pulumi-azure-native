...
class ProjectConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250601:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250701preview:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250901:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:ProjectConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260701:ProjectConnection")])
