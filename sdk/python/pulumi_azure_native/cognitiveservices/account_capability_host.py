...
class AccountCapabilityHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 capability_host_name: pulumi.Input[Optional[_builtins.str]] = None,
                 capability_host_properties: pulumi.Input[Optional[Union['CapabilityHostArgs', 'CapabilityHostArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250601:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250701preview:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250901:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:AccountCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260701:AccountCapabilityHost")])
