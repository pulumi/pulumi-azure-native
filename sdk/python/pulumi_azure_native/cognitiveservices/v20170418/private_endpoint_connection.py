...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.cognitiveservices.v20170418.PrivateEndpointConnection("privateEndpointConnection",
            account_name="sto9699",
            private_endpoint_connection_name="{privateEndpointConnectionName}",
            properties=azure_native.cognitiveservices.v20170418.PrivateEndpointConnectionPropertiesResponseArgs(
                private_link_service_connection_state=azure_native.cognitiveservices.v20170418.PrivateLinkServiceConnectionStateArgs(
