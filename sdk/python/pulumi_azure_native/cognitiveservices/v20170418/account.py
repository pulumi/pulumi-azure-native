...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        account = azure_native.cognitiveservices.v20170418.Account("account",
            account_name="testCreate1",
            identity=azure_native.cognitiveservices.v20170418.IdentityArgs(
                type=azure_native.cognitiveservices/v20170418.IdentityType.SYSTEM_ASSIGNED,
            ),
            kind="Emotion",
            location="West US",
            properties=azure_native.cognitiveservices.v20170418.CognitiveServicesAccountPropertiesResponseArgs(
                encryption={
                    "keySource": "Microsoft.KeyVault",
                    "keyVaultProperties": azure_native.cognitiveservices.v20170418.KeyVaultPropertiesArgs(
                        key_name="KeyName",
                        key_vault_uri="https://pltfrmscrts-use-pc-dev.vault.azure.net/",
                        key_version="891CF236-D241-4738-9462-D506AF493DFA",
                    ),
                },
                user_owned_storage=[azure_native.cognitiveservices.v20170418.UserOwnedStorageArgs(
            ...
            sku=azure_native.cognitiveservices.v20170418.SkuResponseArgs(
                name="S0",
            ))
        ...
        account = azure_native.cognitiveservices.v20170418.Account("account",
            ...
            location="West US",
            properties=azure_native.cognitiveservices.v20170418.CognitiveServicesAccountPropertiesArgs(),
            resource_group_name="myResourceGroup",
            sku=azure_native.cognitiveservices.v20170418.SkuResponseArgs(
                name="S0",
            ))
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20160201preview:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20210430:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20211001:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20220301:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20221001:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20221201:Account")])
