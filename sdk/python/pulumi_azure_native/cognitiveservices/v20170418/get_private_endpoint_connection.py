...
warnings.warn("""Version 2017-04-18 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_private_endpoint_connection(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connection is deprecated: Version 2017-04-18 will be removed in v2 of the provider.""")
    __args__ = dict()
