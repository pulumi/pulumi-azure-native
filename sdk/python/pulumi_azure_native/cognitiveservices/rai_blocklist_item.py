...
class RaiBlocklistItemArgs:
    ...
    def _configure(
        ...
        if rai_blocklist_name is None:
            raise TypeError("Missing 'rai_blocklist_name' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if rai_blocklist_item_name is None and 'raiBlocklistItemName' in kwargs:
...
class RaiBlocklistItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, RaiBlocklistItemPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:RaiBlocklistItem")])
