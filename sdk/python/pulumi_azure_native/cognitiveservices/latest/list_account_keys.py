...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cognitiveservices:listAccountKeys'.""", DeprecationWarning)
...
def list_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/latest:listAccountKeys', __args__, opts=opts, typ=ListAccountKeysResult).value
