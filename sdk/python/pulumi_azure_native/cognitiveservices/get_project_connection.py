...
def get_project_connection(account_name: Optional[_builtins.str] = None,
...
def get_project_connection_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
