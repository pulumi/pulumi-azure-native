...
def get_commitment_plan(account_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices:getCommitmentPlan', __args__, opts=opts, typ=GetCommitmentPlanResult).value
...
def get_commitment_plan_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices:getCommitmentPlan', __args__, opts=opts, typ=GetCommitmentPlanResult)
