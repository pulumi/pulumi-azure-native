...
def get_shared_commitment_plan(commitment_plan_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20221201:getSharedCommitmentPlan', __args__, opts=opts, typ=GetSharedCommitmentPlanResult).value
...
def get_shared_commitment_plan_output(commitment_plan_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20221201:getSharedCommitmentPlan', __args__, opts=opts, typ=GetSharedCommitmentPlanResult)
