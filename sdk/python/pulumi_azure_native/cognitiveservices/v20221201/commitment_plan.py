...
class CommitmentPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CommitmentPlan is deprecated: azure-native:cognitiveservices/v20221201:CommitmentPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:cognitiveservices/v20230501:CommitmentPlan to guarantee forwards compatibility.""")
        ...
        super(CommitmentPlan, __self__).__init__(
            'azure-native:cognitiveservices/v20221201:CommitmentPlan',
            resource_name,
            __props__,
            opts)
