...
warnings.warn("""azure-native:cognitiveservices/v20221201:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:cognitiveservices/v20230501:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20170418:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20210430:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20211001:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20220301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20221001:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:cognitiveservices/v20221201:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
