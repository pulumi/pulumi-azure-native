...
class CommitmentPlanAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        commitment_plan_association = azure_native.cognitiveservices.v20221201.CommitmentPlanAssociation("commitmentPlanAssociation",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:CommitmentPlanAssociation")])
