...
class RaiToolLabelArgs:
    def __init__(__self__, *,
                 ...
                 rai_tool_connection_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] rai_tool_connection_name: The name of the Rai Tool Label
    ...
    def rai_tool_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rai_tool_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RaiToolLabel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] account_name: The name of Cognitive Services account.
        :param pulumi.Input[Union['RaiToolLabelPropertiesArgs', 'RaiToolLabelPropertiesArgsDict']] properties: Properties of the RAI Tool Label.
        :param pulumi.Input[builtins.str] rai_tool_connection_name: The name of the Rai Tool Label
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RaiToolLabelArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RaiToolLabelArgs.__new__(RaiToolLabelArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:RaiToolLabel")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RaiToolLabel':
        """
        ...
        __props__.__dict__["type"] = None
        return RaiToolLabel(resource_name, opts=opts, __props__=__props__)
