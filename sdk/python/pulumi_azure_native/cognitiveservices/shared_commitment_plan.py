...
class SharedCommitmentPlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kind: The Kind of the resource.
    ...
    def commitment_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def commitment_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
