...
class SharedCommitmentPlanArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['CommitmentPlanPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['CommitmentPlanPropertiesArgs']]):
...
@pulumi.type_token("azure-native:cognitiveservices:SharedCommitmentPlan")
class SharedCommitmentPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kind: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['CommitmentPlanPropertiesArgs', 'CommitmentPlanPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20221201:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20230501:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250601:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250701preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250901:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260701:SharedCommitmentPlan")])
