...
class CognitiveServicesAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CognitiveServicesAccount is deprecated: Version v20160201preview will be removed in the next major version of the provider. Upgrade to version v20170418 or later.""")
        if opts is None:
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:CognitiveServicesAccount"), pulumi.Alias(type_="azure-native:cognitiveservices/v20170418:CognitiveServicesAccount"), pulumi.Alias(type_="azure-native:cognitiveservices/v20210430:CognitiveServicesAccount"), pulumi.Alias(type_="azure-native:cognitiveservices/v20211001:CognitiveServicesAccount"), pulumi.Alias(type_="azure-native:cognitiveservices/v20220301:CognitiveServicesAccount")])
