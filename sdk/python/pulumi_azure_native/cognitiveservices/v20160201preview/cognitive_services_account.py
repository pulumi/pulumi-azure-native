...
class CognitiveServicesAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:CognitiveServicesAccount"), pulumi.Alias(type_="azure-nextgen:cognitiveservices:CognitiveServicesAccount"), pulumi.Alias(type_="azure-native:cognitiveservices/latest:CognitiveServicesAccount"), pulumi.Alias(type_="azure-nextgen:cognitiveservices/latest:CognitiveServicesAccount"), pulumi.Alias(type_="azure-native:cognitiveservices/v20170418:CognitiveServicesAccount"), pulumi.Alias(type_="azure-nextgen:cognitiveservices/v20170418:CognitiveServicesAccount")])
