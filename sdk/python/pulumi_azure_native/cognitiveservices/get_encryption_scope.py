...
def get_encryption_scope(account_name: Optional[_builtins.str] = None,
                         encryption_scope_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str encryption_scope_name: The name of the encryptionScope associated with the Cognitive Services Account
