...
def get_encryption_scope(account_name: Optional[builtins.str] = None,
                         encryption_scope_name: Optional[builtins.str] = None,
    ...
    :param builtins.str encryption_scope_name: The name of the encryptionScope associated with the Cognitive Services Account
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices:getEncryptionScope', __args__, opts=opts, typ=GetEncryptionScopeResult).value
...
def get_encryption_scope_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
