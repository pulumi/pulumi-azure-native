...
def get_account_capability_host(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20250401preview:getAccountCapabilityHost', __args__, opts=opts, typ=GetAccountCapabilityHostResult).value
...
def get_account_capability_host_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20250401preview:getAccountCapabilityHost', __args__, opts=opts, typ=GetAccountCapabilityHostResult)
