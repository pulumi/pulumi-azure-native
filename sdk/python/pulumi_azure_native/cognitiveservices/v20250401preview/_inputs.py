...
class RaiPolicyPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'RaiPolicyMode']] mode: Rai policy mode. The enum value mapping is as below: Default = 0, Deferred=1, Blocking=2, Asynchronous_filter =3. Please use 'Asynchronous_filter' after 2025-04-01-preview. It is the same as 'Deferred' in previous version.
        """
...
class UserOwnedAmlWorkspaceArgs:
    def __init__(__self__, *,
        ...
        """
        The user owned AML account for Cognitive Services account.
        :param pulumi.Input[str] identity_client_id: Identity Client id of a AML account resource.
        :param pulumi.Input[str] resource_id: Full resource id of a AML account resource.
        """
        if identity_client_id is not None:
            pulumi.set(__self__, "identity_client_id", identity_client_id)
        if resource_id is not None:
