...
def get_rai_blocklist(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20250401preview:getRaiBlocklist', __args__, opts=opts, typ=GetRaiBlocklistResult).value
...
def get_rai_blocklist_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20250401preview:getRaiBlocklist', __args__, opts=opts, typ=GetRaiBlocklistResult)
