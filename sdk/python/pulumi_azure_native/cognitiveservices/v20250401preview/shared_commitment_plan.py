...
class SharedCommitmentPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20221201:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20230501:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices:SharedCommitmentPlan")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SharedCommitmentPlan, __self__).__init__(
            'azure-native:cognitiveservices/v20250401preview:SharedCommitmentPlan',
            resource_name,
            __props__,
            opts)
