...
def get_project_connection(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20250401preview:getProjectConnection', __args__, opts=opts, typ=GetProjectConnectionResult).value
...
def get_project_connection_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20250401preview:getProjectConnection', __args__, opts=opts, typ=GetProjectConnectionResult)
