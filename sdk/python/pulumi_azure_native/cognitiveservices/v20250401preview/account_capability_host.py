...
class AccountCapabilityHostArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] capability_host_name: The name of the capability host associated with the Cognitive Services Resource
        """
    ...
    def capability_host_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def capability_host_name(self, value: Optional[pulumi.Input[str]]):
