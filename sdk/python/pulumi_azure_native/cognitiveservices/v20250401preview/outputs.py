...
class RaiPolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str mode: Rai policy mode. The enum value mapping is as below: Default = 0, Deferred=1, Blocking=2, Asynchronous_filter =3. Please use 'Asynchronous_filter' after 2025-04-01-preview. It is the same as 'Deferred' in previous version.
        """
        pulumi.set(__self__, "type", type)
