...
class ProjectCapabilityHost(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:ProjectCapabilityHost")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProjectCapabilityHost, __self__).__init__(
            'azure-native:cognitiveservices/v20250401preview:ProjectCapabilityHost',
            resource_name,
            __props__,
            opts)
