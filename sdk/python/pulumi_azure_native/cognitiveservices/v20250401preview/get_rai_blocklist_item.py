...
def get_rai_blocklist_item(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20250401preview:getRaiBlocklistItem', __args__, opts=opts, typ=GetRaiBlocklistItemResult).value
...
def get_rai_blocklist_item_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20250401preview:getRaiBlocklistItem', __args__, opts=opts, typ=GetRaiBlocklistItemResult)
