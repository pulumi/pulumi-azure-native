...
def get_commitment_plan_association(commitment_plan_association_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20250401preview:getCommitmentPlanAssociation', __args__, opts=opts, typ=GetCommitmentPlanAssociationResult).value
...
def get_commitment_plan_association_output(commitment_plan_association_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20250401preview:getCommitmentPlanAssociation', __args__, opts=opts, typ=GetCommitmentPlanAssociationResult)
