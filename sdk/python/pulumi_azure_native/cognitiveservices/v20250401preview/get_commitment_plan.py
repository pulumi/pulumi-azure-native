...
def get_commitment_plan(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20250401preview:getCommitmentPlan', __args__, opts=opts, typ=GetCommitmentPlanResult).value
...
def get_commitment_plan_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20250401preview:getCommitmentPlan', __args__, opts=opts, typ=GetCommitmentPlanResult)
