...
class ProjectConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] project_name: The name of Cognitive Services account's project.
...
class ProjectConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:ProjectConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProjectConnection, __self__).__init__(
            'azure-native:cognitiveservices/v20250401preview:ProjectConnection',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ProjectConnection':
        """
