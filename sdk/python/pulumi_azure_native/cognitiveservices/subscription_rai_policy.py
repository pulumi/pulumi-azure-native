...
@pulumi.type_token("azure-native:cognitiveservices:SubscriptionRaiPolicy")
class SubscriptionRaiPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SubscriptionRaiPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:SubscriptionRaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:SubscriptionRaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:SubscriptionRaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:SubscriptionRaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:SubscriptionRaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:SubscriptionRaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:SubscriptionRaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260701:SubscriptionRaiPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SubscriptionRaiPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SubscriptionRaiPolicy':
        """
        ...
        __props__.__dict__["type"] = None
        return SubscriptionRaiPolicy(resource_name, opts=opts, __props__=__props__)
