...
class Project(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250601:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250701preview:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250901:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:Project"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260701:Project")])
