...
def get_rai_blocklist(account_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices:getRaiBlocklist', __args__, opts=opts, typ=GetRaiBlocklistResult).value
...
def get_rai_blocklist_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
