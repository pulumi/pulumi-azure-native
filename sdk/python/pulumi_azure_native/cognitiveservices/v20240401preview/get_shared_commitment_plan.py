...
def get_shared_commitment_plan(commitment_plan_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20240401preview:getSharedCommitmentPlan', __args__, opts=opts, typ=GetSharedCommitmentPlanResult).value
...
def get_shared_commitment_plan_output(commitment_plan_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20240401preview:getSharedCommitmentPlan', __args__, opts=opts, typ=GetSharedCommitmentPlanResult)
    return __ret__.apply(lambda __response__: GetSharedCommitmentPlanResult(
