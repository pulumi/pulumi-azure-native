...
class EncryptionScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 encryption_scope_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['EncryptionScopePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] account_name: The name of Cognitive Services account.
        :param pulumi.Input[str] encryption_scope_name: The name of the encryptionScope associated with the Cognitive Services Account
        :param pulumi.Input[pulumi.InputType['EncryptionScopePropertiesArgs']] properties: Properties of Cognitive Services EncryptionScope.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:EncryptionScope"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:EncryptionScope")])
