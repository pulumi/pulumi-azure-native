...
class EncryptionScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:EncryptionScope"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:EncryptionScope"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:EncryptionScope")])
