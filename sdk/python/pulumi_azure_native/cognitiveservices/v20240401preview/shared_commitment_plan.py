...
class SharedCommitmentPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20221201:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20230501:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:SharedCommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:SharedCommitmentPlan")])
