...
__all__ = [
    ...
    'AwaitableGetRaiBlocklistResult',
    'get_rai_blocklist',
    'get_rai_blocklist_output',
]

@pulumi.output_type
class GetRaiBlocklistResult:
    """
...
class AwaitableGetRaiBlocklistResult(GetRaiBlocklistResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRaiBlocklistResult(
            etag=self.etag,
            id=self.id,
            name=self.name,
...
def get_rai_blocklist(account_name: Optional[str] = None,
                      rai_blocklist_name: Optional[str] = None,
                      resource_group_name: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRaiBlocklistResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20240401preview:getRaiBlocklist', __args__, opts=opts, typ=GetRaiBlocklistResult).value

    return AwaitableGetRaiBlocklistResult(
...
def get_rai_blocklist_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20240401preview:getRaiBlocklist', __args__, opts=opts, typ=GetRaiBlocklistResult)
