...
class RaiBlocklist(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:RaiBlocklist")])
