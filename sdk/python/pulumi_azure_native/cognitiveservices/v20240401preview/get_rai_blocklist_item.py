...
def get_rai_blocklist_item(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20240401preview:getRaiBlocklistItem', __args__, opts=opts, typ=GetRaiBlocklistItemResult).value
