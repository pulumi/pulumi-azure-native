...
def get_commitment_plan(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_commitment_plan is deprecated: azure-native:cognitiveservices/v20220301:CommitmentPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:cognitiveservices/v20230501:CommitmentPlan to guarantee forwards compatibility.""")
    __args__ = dict()
