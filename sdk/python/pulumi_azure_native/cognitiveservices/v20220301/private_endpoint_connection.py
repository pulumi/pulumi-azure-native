...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:cognitiveservices/v20220301:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
