...
class RaiBlocklist(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] account_name: The name of Cognitive Services account.
        :param pulumi.Input[pulumi.InputType['RaiBlocklistPropertiesArgs']] properties: Properties of Cognitive Services RaiBlocklist.
        :param pulumi.Input[str] rai_blocklist_name: The name of the RaiBlocklist associated with the Cognitive Services Account
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RaiBlocklistArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, RaiBlocklistPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                RaiBlocklistPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:RaiBlocklist")])
