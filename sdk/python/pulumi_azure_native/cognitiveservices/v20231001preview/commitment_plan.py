...
class CommitmentPlanArgs:
    ...
    def _configure(
        ...
        if 'commitmentPlanName' in kwargs:
...
class CommitmentPlan(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CommitmentPlanArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, CommitmentPlanPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                CommitmentPlanPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:CommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20211001:CommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20220301:CommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20221001:CommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20221201:CommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20230501:CommitmentPlan")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CommitmentPlan, __self__).__init__(
            'azure-native:cognitiveservices/v20231001preview:CommitmentPlan',
            resource_name,
            __props__,
            opts)
