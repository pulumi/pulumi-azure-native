...
class RaiBlocklistItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:RaiBlocklistItem"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:RaiBlocklistItem"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:RaiBlocklistItem"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:RaiBlocklistItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RaiBlocklistItem, __self__).__init__(
            'azure-native:cognitiveservices/v20231001preview:RaiBlocklistItem',
            resource_name,
            __props__,
            opts)
