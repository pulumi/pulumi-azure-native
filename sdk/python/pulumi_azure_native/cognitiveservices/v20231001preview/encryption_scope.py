...
class EncryptionScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:EncryptionScope"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:EncryptionScope"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:EncryptionScope"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:EncryptionScope"), pulumi.Alias(type_="azure-native:cognitiveservices:EncryptionScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EncryptionScope, __self__).__init__(
            'azure-native:cognitiveservices/v20231001preview:EncryptionScope',
            resource_name,
            __props__,
            opts)
