...
class RaiPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:RaiPolicy"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:RaiPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RaiPolicy, __self__).__init__(
            'azure-native:cognitiveservices/v20240601preview:RaiPolicy',
            resource_name,
            __props__,
            opts)
