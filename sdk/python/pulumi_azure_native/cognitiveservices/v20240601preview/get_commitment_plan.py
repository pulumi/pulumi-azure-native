...
def get_commitment_plan(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20240601preview:getCommitmentPlan', __args__, opts=opts, typ=GetCommitmentPlanResult).value
...
def get_commitment_plan_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20240601preview:getCommitmentPlan', __args__, opts=opts, typ=GetCommitmentPlanResult)
