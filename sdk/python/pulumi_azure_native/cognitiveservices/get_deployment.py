...
def get_deployment(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str deployment_name: The name of the deployment associated with the Cognitive Services Account
...
def get_deployment_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
