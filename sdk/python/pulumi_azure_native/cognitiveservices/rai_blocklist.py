...
class RaiBlocklistArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['RaiBlocklistPropertiesArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['RaiBlocklistPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['RaiBlocklistPropertiesArgs']]):
...
class RaiBlocklist(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250601:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250701preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250901:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:RaiBlocklist"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260701:RaiBlocklist")])
