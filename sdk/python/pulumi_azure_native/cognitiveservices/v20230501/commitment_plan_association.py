...
class CommitmentPlanAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20221201:CommitmentPlanAssociation"), pulumi.Alias(type_="azure-native:cognitiveservices/v20231001preview:CommitmentPlanAssociation"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240401preview:CommitmentPlanAssociation"), pulumi.Alias(type_="azure-native:cognitiveservices/v20240601preview:CommitmentPlanAssociation"), pulumi.Alias(type_="azure-native:cognitiveservices/v20241001:CommitmentPlanAssociation"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:CommitmentPlanAssociation"), pulumi.Alias(type_="azure-native:cognitiveservices:CommitmentPlanAssociation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CommitmentPlanAssociation, __self__).__init__(
            'azure-native:cognitiveservices/v20230501:CommitmentPlanAssociation',
            resource_name,
            __props__,
            opts)
