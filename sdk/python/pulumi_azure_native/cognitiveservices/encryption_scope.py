...
class EncryptionScopeArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['EncryptionScopePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['EncryptionScopePropertiesArgs']]):
...
class EncryptionScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 encryption_scope_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['EncryptionScopePropertiesArgs', 'EncryptionScopePropertiesArgsDict']]] = None,
