...
def get_shared_commitment_plan(commitment_plan_name: Optional[builtins.str] = None,
...
def get_shared_commitment_plan_output(commitment_plan_name: Optional[pulumi.Input[builtins.str]] = None,
