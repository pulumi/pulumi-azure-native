...
class CommitmentPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        commitment_plan = azure_native.cognitiveservices.v20221001.CommitmentPlan("commitmentPlan",
            account_name="accountName",
            commitment_plan_name="commitmentPlanName",
            properties=azure_native.cognitiveservices.v20221001.CommitmentPlanPropertiesResponseArgs(
                auto_renew=True,
                current=azure_native.cognitiveservices.v20221001.CommitmentPeriodArgs(
                    tier="T1",
                ),
                hosting_model="Web",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20211001:CommitmentPlan"), pulumi.Alias(type_="azure-native:cognitiveservices/v20220301:CommitmentPlan")])
