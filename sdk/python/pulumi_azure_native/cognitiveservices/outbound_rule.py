...
class OutboundRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] managed_network_name: Name of the managedNetwork associated with the cognitive services account. Only 'default' is supported.
        ...
        :param pulumi.Input[builtins.str] rule_name: Name of the cognitive services account managed network outbound rule
        """
