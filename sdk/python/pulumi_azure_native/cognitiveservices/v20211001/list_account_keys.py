...
def list_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices/v20211001:listAccountKeys', __args__, opts=opts, typ=ListAccountKeysResult).value
...
def list_account_keys_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices/v20211001:listAccountKeys', __args__, opts=opts, typ=ListAccountKeysResult)
