...
class Deployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices:Deployment"), pulumi.Alias(type_="azure-native:cognitiveservices/v20220301:Deployment"), pulumi.Alias(type_="azure-native:cognitiveservices/v20221001:Deployment")])
