...
def get_outbound_rule(account_name: Optional[_builtins.str] = None,
                      managed_network_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str managed_network_name: Name of the managedNetwork associated with the cognitive services account. Only 'default' is supported.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str rule_name: Name of the cognitive services account managed network outbound rule
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cognitiveservices:getOutboundRule', __args__, opts=opts, typ=GetOutboundRuleResult).value
...
def get_outbound_rule_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cognitiveservices:getOutboundRule', __args__, opts=opts, typ=GetOutboundRuleResult)
