...
class ProjectCapabilityHost(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250601:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250701preview:ProjectCapabilityHost")])
