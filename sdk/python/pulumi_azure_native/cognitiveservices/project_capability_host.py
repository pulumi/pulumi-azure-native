...
class ProjectCapabilityHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 capability_host_name: pulumi.Input[Optional[_builtins.str]] = None,
                 project_capability_host_properties: pulumi.Input[Optional[Union['ProjectCapabilityHostArgs', 'ProjectCapabilityHostArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cognitiveservices/v20250401preview:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250601:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250701preview:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20250901:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251001preview:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20251201:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260115preview:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260301:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260315preview:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260501:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260515preview:ProjectCapabilityHost"), pulumi.Alias(type_="azure-native:cognitiveservices/v20260701:ProjectCapabilityHost")])
