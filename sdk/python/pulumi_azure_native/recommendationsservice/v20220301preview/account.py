...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recommendationsservice/v20220201:Account"), pulumi.Alias(type_="azure-native:recommendationsservice:Account")])
