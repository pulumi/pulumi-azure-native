...
def get_modeling(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recommendationsservice/v20220301preview:getModeling', __args__, opts=opts, typ=GetModelingResult).value
...
def get_modeling_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recommendationsservice/v20220301preview:getModeling', __args__, opts=opts, typ=GetModelingResult)
