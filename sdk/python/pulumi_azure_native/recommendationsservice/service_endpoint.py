...
class ServiceEndpointArgs:
    ...
    def _configure(
        ...
        if 'serviceEndpointName' in kwargs:
...
class ServiceEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['ServiceEndpointResourcePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] account_name: The name of the RecommendationsService Account resource.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[pulumi.InputType['ServiceEndpointResourcePropertiesArgs']] properties: ServiceEndpoint resource properties.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] service_endpoint_name: The name of the ServiceEndpoint resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ServiceEndpointArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ServiceEndpointResourcePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ServiceEndpointResourcePropertiesArgs._configure(_setter, **properties)
