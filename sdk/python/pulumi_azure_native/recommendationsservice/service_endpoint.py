...
class ServiceEndpointArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ServiceEndpointResourcePropertiesArgs']]:
        """
...
class ServiceEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ServiceEndpointResourcePropertiesArgs', 'ServiceEndpointResourcePropertiesArgsDict']]] = None,
