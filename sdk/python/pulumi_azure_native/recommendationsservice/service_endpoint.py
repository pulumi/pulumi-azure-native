...
class ServiceEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_endpoint_name: The name of the ServiceEndpoint resource.
...
@pulumi.type_token("azure-native:recommendationsservice:ServiceEndpoint")
