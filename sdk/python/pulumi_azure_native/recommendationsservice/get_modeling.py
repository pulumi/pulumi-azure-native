...
def get_modeling(account_name: Optional[_builtins.str] = None,
                 modeling_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str account_name: The name of the RecommendationsService Account resource.
    :param _builtins.str modeling_name: The name of the Modeling resource.
...
def get_modeling_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
                        modeling_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recommendationsservice:getModeling', __args__, opts=opts, typ=GetModelingResult)
    return __ret__.apply(lambda __response__: GetModelingResult(
