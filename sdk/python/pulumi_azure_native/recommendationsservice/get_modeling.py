...
def get_modeling(account_name: Optional[builtins.str] = None,
                 modeling_name: Optional[builtins.str] = None,
    ...
    :param builtins.str account_name: The name of the RecommendationsService Account resource.
    :param builtins.str modeling_name: The name of the Modeling resource.
...
def get_modeling_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
                        modeling_name: Optional[pulumi.Input[builtins.str]] = None,
