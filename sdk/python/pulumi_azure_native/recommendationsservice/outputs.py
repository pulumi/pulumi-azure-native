...
class AccountResourceResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 reports_connection_string: Optional[builtins.str] = None):
        """
        Account resource properties.
        :param builtins.str provisioning_state: The resource provisioning state.
        :param builtins.str configuration: Account configuration. This can only be set at RecommendationsService Account creation.
        ...
        :param builtins.str reports_connection_string: Connection string to write Accounts reports to.
        """
    ...
    def reports_connection_string(self) -> Optional[builtins.str]:
        """
...
class CorsRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CORS details.
        :param Sequence[builtins.str] allowed_origins: The origin domains that are permitted to make a request against the service via CORS.
        :param Sequence[builtins.str] allowed_headers: The request headers that the origin domain may specify on the CORS request.
        :param Sequence[builtins.str] allowed_methods: The methods (HTTP request verbs) that the origin domain may use for a CORS request.
        :param Sequence[builtins.str] exposed_headers: The response headers to expose to CORS clients.
        :param builtins.int max_age_in_seconds: The number of seconds that the client/browser should cache a preflight response.
        """
...
class EndpointAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Service endpoints authentication details.
        :param builtins.str aad_tenant_id: AAD tenant ID.
        :param builtins.str principal_id: AAD principal ID.
        :param builtins.str principal_type: AAD principal type.
        """
...
class ModelingInputDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration to raw CDM data to be used as Modeling resource input.
        :param builtins.str connection_string: Connection string to raw input data.
        """
...
class ModelingResourceResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 provisioning_state: builtins.str,
                 features: Optional[builtins.str] = None,
        ...
        Modeling resource properties.
        :param builtins.str provisioning_state: The resource provisioning state.
        :param builtins.str features: Modeling features controls the set of supported scenarios\\models being computed. This can only be set at Modeling creation.
        :param builtins.str frequency: Modeling frequency controls the modeling compute frequency.
        :param 'ModelingInputDataResponse' input_data: The configuration to raw CDM data to be used as Modeling resource input.
        :param builtins.str size: Modeling size controls the maximum supported input data size.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
    ...
    @property
    @pulumi.getter
    def features(self) -> Optional[builtins.str]:
        """
...
class ServiceEndpointResourceResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 paired_location: builtins.str,
                 provisioning_state: builtins.str,
                 url: builtins.str,
                 pre_allocated_capacity: Optional[builtins.int] = None):
        """
        ServiceEndpoint resource properties.
        :param builtins.str paired_location: The paired location that will be used by this ServiceEndpoint.
        :param builtins.str provisioning_state: The resource provisioning state.
        :param builtins.str url: The URL where the ServiceEndpoint API is accessible at.
        :param builtins.int pre_allocated_capacity: ServiceEndpoint pre-allocated capacity controls the maximum requests-per-second allowed for that endpoint. Only applicable when Account configuration is Capacity.
        """
    ...
    def paired_location(self) -> builtins.str:
        """
    ...
    def pre_allocated_capacity(self) -> Optional[builtins.int]:
        """
