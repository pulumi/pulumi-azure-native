...
class AccountResourceResponseProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str reports_connection_string: Connection string to write Accounts reports to.
        """
...
class CorsRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] exposed_headers: The response headers to expose to CORS clients.
        :param _builtins.int max_age_in_seconds: The number of seconds that the client/browser should cache a preflight response.
        """
...
class ModelingResourceResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 provisioning_state: _builtins.str,
                 features: Optional[_builtins.str] = None,
        ...
        :param _builtins.str size: Modeling size controls the maximum supported input data size.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
...
class ServiceEndpointResourceResponseProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int pre_allocated_capacity: ServiceEndpoint pre-allocated capacity controls the maximum requests-per-second allowed for that endpoint. Only applicable when Account configuration is Capacity.
        """
