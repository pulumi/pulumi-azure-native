...
warnings.warn("""azure-native:recommendationsservice/v20220201:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:recommendationsservice/v20220301preview:Account to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_account is deprecated: azure-native:recommendationsservice/v20220201:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:recommendationsservice/v20220301preview:Account to guarantee forwards compatibility.""")
    __args__ = dict()
