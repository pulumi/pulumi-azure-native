...
def get_service_endpoint(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recommendationsservice/v20220201:getServiceEndpoint', __args__, opts=opts, typ=GetServiceEndpointResult).value
...
def get_service_endpoint_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceEndpointName'] = service_endpoint_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recommendationsservice/v20220201:getServiceEndpoint', __args__, opts=opts, typ=GetServiceEndpointResult)
    return __ret__.apply(lambda __response__: GetServiceEndpointResult(
