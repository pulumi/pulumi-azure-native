...
def get_service_endpoint(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_endpoint_name: The name of the ServiceEndpoint resource.
    """
    __args__ = dict()
...
def get_service_endpoint_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recommendationsservice:getServiceEndpoint', __args__, opts=opts, typ=GetServiceEndpointResult)
