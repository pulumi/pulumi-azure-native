...
def get_service_endpoint(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str service_endpoint_name: The name of the ServiceEndpoint resource.
    """
    __args__ = dict()
...
def get_service_endpoint_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
