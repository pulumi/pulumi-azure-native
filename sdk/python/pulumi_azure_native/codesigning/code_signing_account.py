...
class CodeSigningAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:codesigning/v20240205preview:CodeSigningAccount"), pulumi.Alias(type_="azure-native:codesigning/v20240930preview:CodeSigningAccount"), pulumi.Alias(type_="azure-native_codesigning_v20240205preview:codesigning:CodeSigningAccount"), pulumi.Alias(type_="azure-native_codesigning_v20240930preview:codesigning:CodeSigningAccount")])
