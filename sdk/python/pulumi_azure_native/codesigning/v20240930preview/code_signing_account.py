...
class CodeSigningAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CodeSigningAccountArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:codesigning:CodeSigningAccount"), pulumi.Alias(type_="azure-native:codesigning/v20240205preview:CodeSigningAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CodeSigningAccount, __self__).__init__(
            'azure-native:codesigning/v20240930preview:CodeSigningAccount',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CodeSigningAccount':
        """
        ...
        __props__.__dict__["type"] = None
        return CodeSigningAccount(resource_name, opts=opts, __props__=__props__)
