...
class CertificateProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:codesigning:CertificateProfile"), pulumi.Alias(type_="azure-native:codesigning/v20240205preview:CertificateProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CertificateProfile, __self__).__init__(
            'azure-native:codesigning/v20240930preview:CertificateProfile',
            resource_name,
            __props__,
            opts)
