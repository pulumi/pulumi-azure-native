...
def get_code_signing_account(account_name: Optional[_builtins.str] = None,
...
def get_code_signing_account_output(account_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
