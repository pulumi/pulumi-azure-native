...
class CodeSigningAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:codesigning:CodeSigningAccount"), pulumi.Alias(type_="azure-native:codesigning/v20240930preview:CodeSigningAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CodeSigningAccount, __self__).__init__(
            'azure-native:codesigning/v20240205preview:CodeSigningAccount',
            resource_name,
            __props__,
            opts)
