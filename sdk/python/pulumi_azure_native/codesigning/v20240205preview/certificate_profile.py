...
class CertificateProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:codesigning/v20240930preview:CertificateProfile"), pulumi.Alias(type_="azure-native:codesigning:CertificateProfile")])
