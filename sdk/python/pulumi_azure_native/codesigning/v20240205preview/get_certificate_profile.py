...
def get_certificate_profile(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:codesigning/v20240205preview:getCertificateProfile', __args__, opts=opts, typ=GetCertificateProfileResult).value
...
def get_certificate_profile_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:codesigning/v20240205preview:getCertificateProfile', __args__, opts=opts, typ=GetCertificateProfileResult)
