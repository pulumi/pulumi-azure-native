...
class DataPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_pool = azure_native.autonomousdevelopmentplatform.v20210201preview.DataPool("dataPool",
            account_name="sampleacct",
            data_pool_name="sampledp",
            locations=[{
                "encryption": azure_native.autonomousdevelopmentplatform.v20210201preview.DataPoolEncryptionArgs(
                    key_name="key1",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:autonomousdevelopmentplatform:DataPool"), pulumi.Alias(type_="azure-native:autonomousdevelopmentplatform/v20200701preview:DataPool"), pulumi.Alias(type_="azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool")])
