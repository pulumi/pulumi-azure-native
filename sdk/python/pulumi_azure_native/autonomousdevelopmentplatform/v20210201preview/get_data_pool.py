...
warnings.warn("""azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_data_pool(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_pool is deprecated: azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['dataPoolName'] = data_pool_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:autonomousdevelopmentplatform/v20210201preview:getDataPool', __args__, opts=opts, typ=GetDataPoolResult).value
