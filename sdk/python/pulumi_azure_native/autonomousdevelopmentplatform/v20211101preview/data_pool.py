...
class DataPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:autonomousdevelopmentplatform:DataPool"), pulumi.Alias(type_="azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool")])
