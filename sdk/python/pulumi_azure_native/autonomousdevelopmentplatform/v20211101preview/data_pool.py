...
class DataPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_pool = azure_native.autonomousdevelopmentplatform.v20211101preview.DataPool("dataPool",
            account_name="sampleacct",
            data_pool_name="sampledp",
            locations=[{
                "encryption": azure_native.autonomousdevelopmentplatform.v20211101preview.DataPoolEncryptionArgs(
                    key_name="key1",
        ...
        ```sh
        $ pulumi import azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool dp1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.AutonomousDevelopmentPlatform/accounts/adp1/dataPools/dp1 
        ```
