...
def get_data_pool(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:autonomousdevelopmentplatform/v20211101preview:getDataPool', __args__, opts=opts, typ=GetDataPoolResult).value
...
def get_data_pool_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:autonomousdevelopmentplatform/v20211101preview:getDataPool', __args__, opts=opts, typ=GetDataPoolResult)
