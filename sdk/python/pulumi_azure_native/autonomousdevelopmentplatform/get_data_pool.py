...
def get_data_pool_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:autonomousdevelopmentplatform:getDataPool', __args__, opts=opts, typ=GetDataPoolResult)
    return __ret__.apply(lambda __response__: GetDataPoolResult(
        data_pool_id=pulumi.get(__response__, 'data_pool_id'),
