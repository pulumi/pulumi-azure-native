...
class OperationalizationCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if app_insights is not None and not isinstance(app_insights, AppInsightsPropertiesArgs):
                app_insights = app_insights or {}
                def _setter(key, value):
                    app_insights[key] = value
                AppInsightsPropertiesArgs._configure(_setter, **app_insights)
            __props__.__dict__["app_insights"] = app_insights
            __props__.__dict__["cluster_name"] = cluster_name
            if cluster_type is None and not opts.urn:
                raise TypeError("Missing required property 'cluster_type'")
            __props__.__dict__["cluster_type"] = cluster_type
            if container_registry is not None and not isinstance(container_registry, ContainerRegistryPropertiesArgs):
                container_registry = container_registry or {}
                def _setter(key, value):
                    container_registry[key] = value
                ContainerRegistryPropertiesArgs._configure(_setter, **container_registry)
            __props__.__dict__["container_registry"] = container_registry
            if container_service is not None and not isinstance(container_service, AcsClusterPropertiesArgs):
                container_service = container_service or {}
                def _setter(key, value):
                    container_service[key] = value
                AcsClusterPropertiesArgs._configure(_setter, **container_service)
            __props__.__dict__["container_service"] = container_service
            __props__.__dict__["description"] = description
            if global_service_configuration is not None and not isinstance(global_service_configuration, GlobalServiceConfigurationArgs):
                global_service_configuration = global_service_configuration or {}
                def _setter(key, value):
                    global_service_configuration[key] = value
                GlobalServiceConfigurationArgs._configure(_setter, **global_service_configuration)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningcompute/v20170601preview:OperationalizationCluster"), pulumi.Alias(type_="azure-native:machinelearningcompute/v20170801preview:OperationalizationCluster")])
