...
class OperationalizationCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        operationalization_cluster = azure_native.machinelearningcompute.v20170601preview.OperationalizationCluster("operationalizationCluster",
            cluster_name="myCluster",
            cluster_type="ACS",
            container_service=azure_native.machinelearningcompute.v20170601preview.AcsClusterPropertiesArgs(
                orchestrator_properties=azure_native.machinelearningcompute.v20170601preview.KubernetesClusterPropertiesArgs(
                    service_principal=azure_native.machinelearningcompute.v20170601preview.ServicePrincipalPropertiesArgs(
            ...
            global_service_configuration=azure_native.machinelearningcompute.v20170601preview.GlobalServiceConfigurationResponseArgs(
                ssl=azure_native.machinelearningcompute.v20170601preview.SslConfigurationArgs(
