...
class AcsClusterPropertiesArgs:
    ...
    def orchestrator_properties(self) -> pulumi.Input['KubernetesClusterPropertiesArgs']:
        """
    ...
    def orchestrator_properties(self, value: pulumi.Input['KubernetesClusterPropertiesArgs']):
...
@pulumi.input_type
class AppInsightsCredentialsArgs:
    def __init__(__self__, *,
                 api_key: Optional[pulumi.Input[str]] = None,
                 app_id: Optional[pulumi.Input[str]] = None):
        """
        AppInsights credentials.
        :param pulumi.Input[str] api_key: The AppInsights API key. This is not returned in response of GET/PUT on the resource.. To see this please call listKeys API.
        :param pulumi.Input[str] app_id: The AppInsights application ID.
        """
...
class KubernetesClusterPropertiesArgs:
    def __init__(__self__, *,
                 service_principal: pulumi.Input['ServicePrincipalPropertiesArgs']):
        """
    ...
    def service_principal(self) -> pulumi.Input['ServicePrincipalPropertiesArgs']:
        """
    ...
    def service_principal(self, value: pulumi.Input['ServicePrincipalPropertiesArgs']):
