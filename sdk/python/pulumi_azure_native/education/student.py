...
class Student(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if budget is not None and not isinstance(budget, AmountArgs):
                budget = budget or {}
                def _setter(key, value):
                    budget[key] = value
                AmountArgs._configure(_setter, **budget)
