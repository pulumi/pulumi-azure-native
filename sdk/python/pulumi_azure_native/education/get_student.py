...
def get_student(billing_account_name: Optional[_builtins.str] = None,
                billing_profile_name: Optional[_builtins.str] = None,
                invoice_section_name: Optional[_builtins.str] = None,
                student_alias: Optional[_builtins.str] = None,
    ...
    :param _builtins.str student_alias: Student alias.
    """
    __args__ = dict()
...
def get_student_output(billing_account_name: pulumi.Input[Optional[_builtins.str]] = None,
                       ...
                       student_alias: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
