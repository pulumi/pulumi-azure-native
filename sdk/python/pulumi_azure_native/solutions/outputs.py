...
class ApplicationJitAccessPolicyResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             jit_access_enabled: Optional[bool] = None,
             jit_approval_mode: Optional[str] = None,
             jit_approvers: Optional[Sequence['outputs.JitApproverDefinitionResponse']] = None,
             maximum_jit_access_duration: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
...
class ApplicationNotificationPolicyResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             notification_endpoints: Optional[Sequence['outputs.ApplicationNotificationEndpointResponse']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class ApplicationPackageSupportUrlsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if government_cloud is None and 'governmentCloud' in kwargs:
            government_cloud = kwargs['governmentCloud']
        if public_azure is None and 'publicAzure' in kwargs:
            public_azure = kwargs['publicAzure']
...
class ManagedIdentityTokenResponse(dict):
    ...
    def _configure(
        ...
        if authorization_audience is None and 'authorizationAudience' in kwargs:
            authorization_audience = kwargs['authorizationAudience']
