...
class ApplicationJitAccessPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 jit_approval_mode: Optional[_builtins.str] = None,
        ...
        :param _builtins.str maximum_jit_access_duration: The maximum duration JIT access is granted. This is an ISO8601 time period value.
        """
...
class ApplicationPackageSupportUrlsResponse(dict):
    ...
    def __init__(__self__, *,
                 government_cloud: Optional[_builtins.str] = None,
...
class ManagedIdentityTokenResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 authorization_audience: Optional[_builtins.str] = None,
                 expires_in: Optional[_builtins.str] = None,
        ...
        :param _builtins.str expires_on: The timespan when the access token expires. This is represented as the number of seconds from epoch.
        :param _builtins.str not_before: The timespan when the access token takes effect. This is represented as the number of seconds from epoch.
        :param _builtins.str resource_id: The Azure resource ID for the issued token. This is either the managed application ID or the user-assigned identity ID.
        :param _builtins.str token_type: The type of the token.
        """
