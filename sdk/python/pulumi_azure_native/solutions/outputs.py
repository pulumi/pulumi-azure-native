...
class ApplicationJitAccessPolicyResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'jitAccessEnabled' in kwargs:
            jit_access_enabled = kwargs['jitAccessEnabled']
        if 'jitApprovalMode' in kwargs:
            jit_approval_mode = kwargs['jitApprovalMode']
        if 'jitApprovers' in kwargs:
            jit_approvers = kwargs['jitApprovers']
        if 'maximumJitAccessDuration' in kwargs:
...
class ApplicationPackageLockingPolicyDefinitionResponse(dict):
    ...
    def _configure(
        ...
        if 'allowedDataActions' in kwargs:
...
class ApplicationPackageSupportUrlsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'governmentCloud' in kwargs:
            government_cloud = kwargs['governmentCloud']
        if 'publicAzure' in kwargs:
...
class ManagedIdentityTokenResponse(dict):
    ...
    def _configure(
        ...
        if 'authorizationAudience' in kwargs:
