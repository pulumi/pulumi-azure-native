...
def get_application_definition(application_definition_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str application_definition_name: The name of the managed application definition.
...
def get_application_definition_output(application_definition_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
