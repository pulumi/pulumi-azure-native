...
def list_application_tokens(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20200821preview:listApplicationTokens', __args__, opts=opts, typ=ListApplicationTokensResult).value
...
def list_application_tokens_output(application_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:solutions/v20200821preview:listApplicationTokens', __args__, opts=opts, typ=ListApplicationTokensResult)
