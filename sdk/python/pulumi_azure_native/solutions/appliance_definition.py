...
class ApplianceDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:solutions/v20160901preview:ApplianceDefinition"), pulumi.Alias(type_="azure-native:solutions/v20170901:ApplianceDefinition"), pulumi.Alias(type_="azure-native:solutions/v20180601:ApplianceDefinition"), pulumi.Alias(type_="azure-native:solutions/v20190701:ApplianceDefinition"), pulumi.Alias(type_="azure-native:solutions/v20200821preview:ApplianceDefinition"), pulumi.Alias(type_="azure-native:solutions/v20210701:ApplianceDefinition")])
