...
def list_application_allowed_upgrade_plans(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20190701:listApplicationAllowedUpgradePlans', __args__, opts=opts, typ=ListApplicationAllowedUpgradePlansResult).value
...
def list_application_allowed_upgrade_plans_output(application_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:solutions/v20190701:listApplicationAllowedUpgradePlans', __args__, opts=opts, typ=ListApplicationAllowedUpgradePlansResult)
