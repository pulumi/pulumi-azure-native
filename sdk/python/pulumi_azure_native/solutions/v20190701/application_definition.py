...
class ApplicationDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_definition = azure_native.solutions.v20190701.ApplicationDefinition("applicationDefinition",
            ...
            location="East US 2",
            lock_level=azure_native.solutions/v20190701.ApplicationLockLevel.NONE,
        ...
        ```sh
        $ pulumi import azure-native:solutions/v20190701:ApplicationDefinition myManagedApplicationDef /subscriptions/subid/resourceGroups/rg/providers/Microsoft.Solutions/applicationDefinitions/myManagedApplicationDef 
        ```
