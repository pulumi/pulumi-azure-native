...
def list_application_tokens(application_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] user_assigned_identities: The user assigned identities.
    """
    __args__ = dict()
