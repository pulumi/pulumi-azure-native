...
warnings.warn("""azure-native:solutions/v20210201preview:ApplicationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:ApplicationDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApplicationDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ApplicationDefinition, __self__).__init__(
            'azure-native:solutions/v20210201preview:ApplicationDefinition',
            resource_name,
            __props__,
            opts)
