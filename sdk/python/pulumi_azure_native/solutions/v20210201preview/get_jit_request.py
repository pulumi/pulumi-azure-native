...
warnings.warn("""azure-native:solutions/v20210201preview:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_jit_request(jit_request_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_jit_request is deprecated: azure-native:solutions/v20210201preview:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.""")
    __args__ = dict()
