...
def get_application(application_name: Optional[str] = None,
    ...
    return AwaitableGetApplicationResult(
        ...
        jit_access_policy=pulumi.get(__ret__, 'jit_access_policy'),
        ...
        management_mode=pulumi.get(__ret__, 'management_mode'),
        ...
        support_urls=pulumi.get(__ret__, 'support_urls'),
...
def get_application_output(application_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:solutions/v20210201preview:getApplication', __args__, opts=opts, typ=GetApplicationResult)
