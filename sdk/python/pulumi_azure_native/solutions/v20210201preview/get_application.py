...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: azure-native:solutions/v20210201preview:Application is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:Application to guarantee forwards compatibility.""")
    __args__ = dict()
