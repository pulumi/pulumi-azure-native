...
class ApplicationDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ApplicationDefinition is deprecated: Version 2018-09-01-preview will be removed in v2 of the provider.""")
        ...
        super(ApplicationDefinition, __self__).__init__(
            'azure-native:solutions/v20180901preview:ApplicationDefinition',
            resource_name,
            __props__,
            opts)
