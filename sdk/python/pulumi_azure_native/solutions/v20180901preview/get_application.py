...
azure-native:solutions/v20180901preview:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:Application to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version 2018-09-01-preview will be removed in v2 of the provider.
azure-native:solutions/v20180901preview:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:Application to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20180901preview:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
