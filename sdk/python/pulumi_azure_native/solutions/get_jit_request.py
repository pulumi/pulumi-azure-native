...
class GetJitRequestResult:
    ...
    def application_resource_id(self) -> builtins.str:
        """
    ...
    def jit_request_state(self) -> builtins.str:
        """
...
def get_jit_request(jit_request_name: Optional[builtins.str] = None,
    ...
    :param builtins.str jit_request_name: The name of the JIT request.
...
def get_jit_request_output(jit_request_name: Optional[pulumi.Input[builtins.str]] = None,
