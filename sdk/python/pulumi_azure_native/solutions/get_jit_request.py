...
def get_jit_request(jit_request_name: Optional[_builtins.str] = None,
...
def get_jit_request_output(jit_request_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
