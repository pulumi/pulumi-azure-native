...
warnings.warn("""Version v20170901 will be removed in the next major version of the provider. Upgrade to version v20190701 or later.""", DeprecationWarning)
...
class GetApplicationResult:
    ...
    """
    def __init__(__self__, application_definition_id=None, id=None, identity=None, kind=None, location=None, managed_by=None, managed_resource_group_id=None, name=None, outputs=None, parameters=None, plan=None, provisioning_state=None, sku=None, tags=None, type=None, ui_definition_uri=None):
...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version v20170901 will be removed in the next major version of the provider. Upgrade to version v20190701 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20170901:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
