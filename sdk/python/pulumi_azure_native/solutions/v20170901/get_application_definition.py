...
azure-native:solutions/v20170901:ApplicationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20171201:ApplicationDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application_definition(application_definition_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_definition is deprecated: Version 2017-09-01 will be removed in v2 of the provider.
azure-native:solutions/v20170901:ApplicationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20171201:ApplicationDefinition to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20170901:getApplicationDefinition', __args__, opts=opts, typ=GetApplicationDefinitionResult).value
