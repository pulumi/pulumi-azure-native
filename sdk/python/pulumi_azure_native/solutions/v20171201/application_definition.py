...
class ApplicationDefinitionArgs:
    def __init__(__self__, *,
                 properties: pulumi.Input['ApplicationDefinitionPropertiesArgs'],
        ...
        :param pulumi.Input['ApplicationDefinitionPropertiesArgs'] properties: The managed application definition properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['ApplicationDefinitionPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['ApplicationDefinitionPropertiesArgs']):
...
class ApplicationDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 managed_by: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['ApplicationDefinitionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] location: Resource location
        :param pulumi.Input[str] managed_by: ID of the resource that manages this resource.
        :param pulumi.Input[pulumi.InputType['ApplicationDefinitionPropertiesArgs']] properties: The managed application definition properties.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:solutions:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20160901preview:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20170901:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20180201:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20180301:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20180601:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20180901preview:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20190701:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20200821preview:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20210201preview:ApplicationDefinition"), pulumi.Alias(type_="azure-native:solutions/v20210701:ApplicationDefinition")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationDefinition, __self__).__init__(
            'azure-native:solutions/v20171201:ApplicationDefinition',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ApplicationDefinitionPropertiesResponse']:
        """
        The managed application definition properties.
        """
        return pulumi.get(self, "properties")
