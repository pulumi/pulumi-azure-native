...
class ApplicationDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_definition = azure_native.solutions.v20171201.ApplicationDefinition("applicationDefinition",
            application_definition_name="myManagedApplicationDef",
            authorizations=[azure_native.solutions.v20171201.ApplicationProviderAuthorizationArgs(
            ...
            location="East US 2",
            lock_level=azure_native.solutions/v20171201.ApplicationLockLevel.NONE,
