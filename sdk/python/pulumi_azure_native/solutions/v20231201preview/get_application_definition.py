...
def get_application_definition(application_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20231201preview:getApplicationDefinition', __args__, opts=opts, typ=GetApplicationDefinitionResult).value
