...
def list_application_allowed_upgrade_plans(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20231201preview:listApplicationAllowedUpgradePlans', __args__, opts=opts, typ=ListApplicationAllowedUpgradePlansResult).value
