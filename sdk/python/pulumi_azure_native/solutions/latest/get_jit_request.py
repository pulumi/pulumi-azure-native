...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:solutions:getJitRequest'.""", DeprecationWarning)
...
def get_jit_request(jit_request_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/latest:getJitRequest', __args__, opts=opts, typ=GetJitRequestResult).value
