...
azure-native:solutions/v20180601:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:solutions/v20180601:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""JitRequest is deprecated: Version 2018-06-01 will be removed in v2 of the provider.
azure-native:solutions/v20180601:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:solutions:JitRequest"), pulumi.Alias(type_="azure-native:solutions/v20180301:JitRequest"), pulumi.Alias(type_="azure-native:solutions/v20180901preview:JitRequest"), pulumi.Alias(type_="azure-native:solutions/v20190701:JitRequest"), pulumi.Alias(type_="azure-native:solutions/v20200821preview:JitRequest"), pulumi.Alias(type_="azure-native:solutions/v20210201preview:JitRequest"), pulumi.Alias(type_="azure-native:solutions/v20210701:JitRequest")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(JitRequest, __self__).__init__(
            'azure-native:solutions/v20180601:JitRequest',
            resource_name,
            __props__,
            opts)
