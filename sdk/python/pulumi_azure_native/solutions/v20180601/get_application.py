...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version v20180601 will be removed in the next major version of the provider. Upgrade to version v20190701 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20180601:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
