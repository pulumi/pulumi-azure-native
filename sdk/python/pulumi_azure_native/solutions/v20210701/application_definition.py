...
class ApplicationDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(deployment_policy, ApplicationDeploymentPolicyArgs):
            ...
            if not isinstance(locking_policy, ApplicationPackageLockingPolicyDefinitionArgs):
            ...
            if not isinstance(management_policy, ApplicationManagementPolicyArgs):
            ...
            if not isinstance(notification_policy, ApplicationNotificationPolicyArgs):
