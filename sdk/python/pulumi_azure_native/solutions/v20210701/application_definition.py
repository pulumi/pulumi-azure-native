...
class ApplicationDefinitionArgs:
    ...
    def _configure(
        ...
        if application_definition_name is None and 'applicationDefinitionName' in kwargs:
        ...
        if deployment_policy is None and 'deploymentPolicy' in kwargs:
            deployment_policy = kwargs['deploymentPolicy']
        if display_name is None and 'displayName' in kwargs:
            display_name = kwargs['displayName']
        if is_enabled is None and 'isEnabled' in kwargs:
            is_enabled = kwargs['isEnabled']
        if locking_policy is None and 'lockingPolicy' in kwargs:
        ...
        if management_policy is None and 'managementPolicy' in kwargs:
...
class ApplicationDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            deployment_policy = _utilities.configure(deployment_policy, ApplicationDeploymentPolicyArgs, True)
            ...
            locking_policy = _utilities.configure(locking_policy, ApplicationPackageLockingPolicyDefinitionArgs, True)
            __props__.__dict__["locking_policy"] = locking_policy
            __props__.__dict__["main_template"] = main_template
            __props__.__dict__["managed_by"] = managed_by
            management_policy = _utilities.configure(management_policy, ApplicationManagementPolicyArgs, True)
            __props__.__dict__["management_policy"] = management_policy
            notification_policy = _utilities.configure(notification_policy, ApplicationNotificationPolicyArgs, True)
