...
class Appliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:solutions/v20160901preview:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20170901:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20171201:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20180201:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20180301:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20180601:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20180901preview:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20190701:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20200821preview:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20210201preview:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20210701:Appliance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Appliance, __self__).__init__(
            'azure-native:solutions:Appliance',
            resource_name,
            __props__,
            opts)
