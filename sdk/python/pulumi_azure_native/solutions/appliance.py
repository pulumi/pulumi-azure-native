...
class Appliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:solutions/v20160901preview:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20170901:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20180601:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20190701:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20200821preview:Appliance"), pulumi.Alias(type_="azure-native:solutions/v20210701:Appliance")])
