...
class ApplicationDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The managed application definition description.
        :param pulumi.Input[_builtins.str] display_name: The managed application definition display name.
        :param pulumi.Input[_builtins.bool] is_enabled: A value indicating whether the package is enabled or not.
        ...
        :param pulumi.Input[_builtins.str] package_file_uri: The managed application definition package file Uri. Use this element
