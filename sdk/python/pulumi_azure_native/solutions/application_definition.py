...
class ApplicationDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 application_definition_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] application_definition_name: The name of the managed application definition.
        ...
        :param pulumi.Input[builtins.str] description: The managed application definition description.
        :param pulumi.Input[builtins.str] display_name: The managed application definition display name.
        :param pulumi.Input[builtins.bool] is_enabled: A value indicating whether the package is enabled or not.
        ...
        :param pulumi.Input[builtins.str] package_file_uri: The managed application definition package file Uri. Use this element
        ...
        :param pulumi.Input[builtins.str] storage_account_id: The storage account id for bring your own storage scenario.
    ...
    def application_definition_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_definition_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApplicationDefinition(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:solutions:ApplicationDefinition"
