...
def get_application_definition(application_definition_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_definition is deprecated: Version 2018-03-01 will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['applicationDefinitionName'] = application_definition_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20180301:getApplicationDefinition', __args__, opts=opts, typ=GetApplicationDefinitionResult).value
