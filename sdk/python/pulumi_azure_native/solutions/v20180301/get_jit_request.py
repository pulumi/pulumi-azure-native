...
azure-native:solutions/v20180301:JitRequest is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_jit_request(jit_request_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_jit_request is deprecated: Version 2018-03-01 will be removed in v2 of the provider.
azure-native:solutions/v20180301:JitRequest is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['jitRequestName'] = jit_request_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20180301:getJitRequest', __args__, opts=opts, typ=GetJitRequestResult).value
