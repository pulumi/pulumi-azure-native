...
azure-native:solutions/v20180201:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20180601:Application to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetApplicationResult:
    ...
    """
    def __init__(__self__, application_definition_id=None, artifacts=None, authorizations=None, billing_details=None, created_by=None, customer_support=None, id=None, identity=None, kind=None, location=None, managed_by=None, managed_resource_group_id=None, name=None, outputs=None, parameters=None, plan=None, provisioning_state=None, publisher_package_id=None, publisher_tenant_id=None, sku=None, support_urls=None, tags=None, type=None, updated_by=None):
...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version 2018-02-01 will be removed in v2 of the provider.
azure-native:solutions/v20180201:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20180601:Application to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions/v20180201:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
