...
class GetApplicationResult:
    ...
    def application_definition_id(self) -> Optional[builtins.str]:
        """
    ...
    def managed_resource_group_id(self) -> Optional[builtins.str]:
        """
    ...
    def management_mode(self) -> builtins.str:
        """
    ...
    def publisher_tenant_id(self) -> builtins.str:
        """
...
def get_application(application_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:solutions:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
...
def get_application_output(application_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:solutions:getApplication', __args__, opts=opts, typ=GetApplicationResult)
