...
class JitRequest(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:solutions:JitRequest"), pulumi.Alias(type_="azure-native:solutions/latest:JitRequest"), pulumi.Alias(type_="azure-nextgen:solutions/latest:JitRequest"), pulumi.Alias(type_="azure-native:solutions/v20190701:JitRequest"), pulumi.Alias(type_="azure-nextgen:solutions/v20190701:JitRequest"), pulumi.Alias(type_="azure-native:solutions/v20200821preview:JitRequest"), pulumi.Alias(type_="azure-nextgen:solutions/v20200821preview:JitRequest")])
    ...
    def get(resource_name: str,
        ...
        __props__["application_resource_id"] = None
        __props__["created_by"] = None
        __props__["jit_authorization_policies"] = None
        __props__["jit_request_state"] = None
        __props__["jit_scheduling_policy"] = None
