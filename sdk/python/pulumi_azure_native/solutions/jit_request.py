...
class JitRequestArgs:
    ...
    def _configure(
             ...
             jit_authorization_policies: Optional[pulumi.Input[Sequence[pulumi.Input['JitAuthorizationPoliciesArgs']]]] = None,
             jit_scheduling_policy: Optional[pulumi.Input['JitSchedulingPolicyArgs']] = None,
             ...
             **kwargs):
        if application_resource_id is None and 'applicationResourceId' in kwargs:
            application_resource_id = kwargs['applicationResourceId']
        if application_resource_id is None:
            raise TypeError("Missing 'application_resource_id' argument")
        if jit_authorization_policies is None and 'jitAuthorizationPolicies' in kwargs:
            jit_authorization_policies = kwargs['jitAuthorizationPolicies']
        if jit_authorization_policies is None:
            raise TypeError("Missing 'jit_authorization_policies' argument")
        if jit_scheduling_policy is None and 'jitSchedulingPolicy' in kwargs:
            jit_scheduling_policy = kwargs['jitSchedulingPolicy']
        if jit_scheduling_policy is None:
            raise TypeError("Missing 'jit_scheduling_policy' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if jit_request_name is None and 'jitRequestName' in kwargs:
            jit_request_name = kwargs['jitRequestName']
...
class JitRequest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            jit_scheduling_policy = _utilities.configure(jit_scheduling_policy, JitSchedulingPolicyArgs, True)
