...
class RegistrationAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registration_assignment = azure_native.managedservices.v20221001.RegistrationAssignment("registrationAssignment",
            properties=azure_native.managedservices.v20221001.RegistrationAssignmentPropertiesResponseArgs(
