...
def get_registration_definition(registration_definition_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registration_definition is deprecated: Version 2019-04-01-preview will be removed in v2 of the provider.
azure-native:managedservices/v20190401preview:RegistrationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:managedservices/v20221001:RegistrationDefinition to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managedservices/v20190401preview:getRegistrationDefinition', __args__, opts=opts, typ=GetRegistrationDefinitionResult).value
