...
warnings.warn("""azure-native:managedservices/v20220101preview:RegistrationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:managedservices/v20221001:RegistrationDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_registration_definition(registration_definition_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registration_definition is deprecated: azure-native:managedservices/v20220101preview:RegistrationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:managedservices/v20221001:RegistrationDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
