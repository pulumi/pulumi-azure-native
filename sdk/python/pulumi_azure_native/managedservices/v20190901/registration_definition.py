...
class RegistrationDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['PlanArgs', 'PlanArgsDict']] plan: Plan details for the managed services.
        :param pulumi.Input[Union['RegistrationDefinitionPropertiesArgs', 'RegistrationDefinitionPropertiesArgsDict']] properties: Properties of a registration definition.
        :param pulumi.Input[str] registration_definition_id: Guid of the registration definition.
        :param pulumi.Input[str] scope: Scope of the resource.
        """
        ...
