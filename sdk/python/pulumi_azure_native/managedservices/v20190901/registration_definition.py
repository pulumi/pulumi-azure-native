...
class RegistrationDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registration_definition = azure_native.managedservices.v20190901.RegistrationDefinition("registrationDefinition",
            plan=azure_native.managedservices.v20190901.PlanResponseArgs(
                name="addesai-plan",
                product="test",
                publisher="marketplace-test",
                version="1.0.0",
            ),
            properties=azure_native.managedservices.v20190901.RegistrationDefinitionPropertiesResponseArgs(
                authorizations=[
                    {
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managedservices:RegistrationDefinition"), pulumi.Alias(type_="azure-native:managedservices/v20180601preview:RegistrationDefinition"), pulumi.Alias(type_="azure-native:managedservices/v20190401preview:RegistrationDefinition"), pulumi.Alias(type_="azure-native:managedservices/v20190601:RegistrationDefinition"), pulumi.Alias(type_="azure-native:managedservices/v20200201preview:RegistrationDefinition"), pulumi.Alias(type_="azure-native:managedservices/v20220101preview:RegistrationDefinition"), pulumi.Alias(type_="azure-native:managedservices/v20221001:RegistrationDefinition")])
