...
def get_registration_definition(registration_definition_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managedservices/v20190901:getRegistrationDefinition', __args__, opts=opts, typ=GetRegistrationDefinitionResult).value
...
def get_registration_definition_output(registration_definition_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managedservices/v20190901:getRegistrationDefinition', __args__, opts=opts, typ=GetRegistrationDefinitionResult)
