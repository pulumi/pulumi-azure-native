...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:managedservices/v20190901:RegistrationAssignment":
                return RegistrationAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:managedservices/v20190901:RegistrationDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-native", "managedservices/v20190901", _module_instance)
