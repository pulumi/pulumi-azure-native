...
class GetRegistrationDefinitionResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, name=None, plan=None, properties=None, system_data=None, type=None):
...
def get_registration_definition(registration_definition_id: Optional[builtins.str] = None,
    ...
    :param builtins.str registration_definition_id: The GUID of the registration definition.
...
def get_registration_definition_output(registration_definition_id: Optional[pulumi.Input[builtins.str]] = None,
