...
if not MYPY:
    class AuthorizationArgsDict(TypedDict):
        ...
        """
        delegated_role_definition_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        principal_id_display_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AuthorizationArgs:
    def __init__(__self__, *,
                 principal_id: pulumi.Input[builtins.str],
                 role_definition_id: pulumi.Input[builtins.str],
                 delegated_role_definition_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 principal_id_display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The Azure Active Directory principal identifier and Azure built-in role that describes the access the principal will receive on the delegated resource in the managed tenant.
        :param pulumi.Input[builtins.str] principal_id: The identifier of the Azure Active Directory principal.
        :param pulumi.Input[builtins.str] role_definition_id: The identifier of the Azure built-in role that defines the permissions that the Azure Active Directory principal will have on the projected scope.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] delegated_role_definition_ids: The delegatedRoleDefinitionIds field is required when the roleDefinitionId refers to the User Access Administrator Role. It is the list of role definition ids which define all the permissions that the user in the authorization can assign to other principals.
        :param pulumi.Input[builtins.str] principal_id_display_name: The display name of the Azure Active Directory principal.
        """
    ...
    def delegated_role_definition_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The delegatedRoleDefinitionIds field is required when the roleDefinitionId refers to the User Access Administrator Role. It is the list of role definition ids which define all the permissions that the user in the authorization can assign to other principals.
        """
    ...
    def delegated_role_definition_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "delegated_role_definition_ids", value)

    @property
    @pulumi.getter(name="principalIdDisplayName")
    def principal_id_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The display name of the Azure Active Directory principal.
        """
    ...
    def principal_id_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class JustInTimeAccessPolicyArgsDict(TypedDict):
        ...
        """
        multi_factor_auth_provider: pulumi.Input[Union[builtins.str, 'MultiFactorAuthProvider']]
        """
        ...
        """
        maximum_activation_duration: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JustInTimeAccessPolicyArgs:
    def __init__(__self__, *,
                 multi_factor_auth_provider: Optional[pulumi.Input[Union[builtins.str, 'MultiFactorAuthProvider']]] = None,
                 managed_by_tenant_approvers: Optional[pulumi.Input[Sequence[pulumi.Input['EligibleApproverArgs']]]] = None,
                 maximum_activation_duration: Optional[pulumi.Input[builtins.str]] = None):
        """
        Just-in-time access policy setting.
        :param pulumi.Input[Union[builtins.str, 'MultiFactorAuthProvider']] multi_factor_auth_provider: The multi-factor authorization provider to be used for just-in-time access requests.
        ...
        :param pulumi.Input[builtins.str] maximum_activation_duration: The maximum access duration in ISO 8601 format for just-in-time access requests.
        """
    ...
    def multi_factor_auth_provider(self) -> pulumi.Input[Union[builtins.str, 'MultiFactorAuthProvider']]:
        """
        The multi-factor authorization provider to be used for just-in-time access requests.
        """
    ...
    def multi_factor_auth_provider(self, value: pulumi.Input[Union[builtins.str, 'MultiFactorAuthProvider']]):
    ...
    def maximum_activation_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum access duration in ISO 8601 format for just-in-time access requests.
        """
    ...
    def maximum_activation_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PlanArgs:
    def __init__(__self__, *,
        ...
        """
        The details for the Managed Services offer’s plan in Azure Marketplace.
        :param pulumi.Input[builtins.str] name: Azure Marketplace plan name.
        :param pulumi.Input[builtins.str] product: Azure Marketplace product code.
        :param pulumi.Input[builtins.str] publisher: Azure Marketplace publisher ID.
        :param pulumi.Input[builtins.str] version: Azure Marketplace plan's version.
        """
...
if not MYPY:
    class RegistrationAssignmentPropertiesArgsDict(TypedDict):
        ...
        """
        registration_definition_id: pulumi.Input[builtins.str]
        """
...
class RegistrationAssignmentPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The properties of the registration assignment.
        :param pulumi.Input[builtins.str] registration_definition_id: The fully qualified path of the registration definition.
        """
        pulumi.set(__self__, "registration_definition_id", registration_definition_id)

    @property
    @pulumi.getter(name="registrationDefinitionId")
    def registration_definition_id(self) -> pulumi.Input[builtins.str]:
        """
        The fully qualified path of the registration definition.
        """
    ...
    def registration_definition_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class RegistrationDefinitionPropertiesArgsDict(TypedDict):
        ...
        """
        managed_by_tenant_id: pulumi.Input[builtins.str]
        """
        ...
        """
        registration_definition_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RegistrationDefinitionPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 registration_definition_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The properties of a registration definition.
        ...
        :param pulumi.Input[builtins.str] managed_by_tenant_id: The identifier of the managedBy tenant.
        :param pulumi.Input[builtins.str] description: The description of the registration definition.
        ...
        :param pulumi.Input[builtins.str] registration_definition_name: The name of the registration definition.
        """
    ...
    def managed_by_tenant_id(self) -> pulumi.Input[builtins.str]:
        """
        The identifier of the managedBy tenant.
        """
    ...
    def managed_by_tenant_id(self, value: pulumi.Input[builtins.str]):
    ...
    def registration_definition_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the registration definition.
        """
    ...
    def registration_definition_name(self, value: Optional[pulumi.Input[builtins.str]]):
