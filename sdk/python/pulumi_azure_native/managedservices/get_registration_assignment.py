...
def get_registration_assignment(expand_registration_definition: Optional[_builtins.bool] = None,
                                registration_assignment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool expand_registration_definition: The flag indicating whether to return the registration definition details along with the registration assignment details.
    :param _builtins.str registration_assignment_id: The GUID of the registration assignment.
...
def get_registration_assignment_output(expand_registration_definition: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                       registration_assignment_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
