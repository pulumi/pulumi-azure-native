...
class RegistrationAssignmentArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'registrationAssignmentId' in kwargs:
...
class RegistrationAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, RegistrationAssignmentPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                RegistrationAssignmentPropertiesArgs._configure(_setter, **properties)
