...
class RegistrationAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managedservices/v20221001:RegistrationAssignment"), pulumi.Alias(type_="azure-native_managedservices_v20180601preview:managedservices:RegistrationAssignment"), pulumi.Alias(type_="azure-native_managedservices_v20190401preview:managedservices:RegistrationAssignment"), pulumi.Alias(type_="azure-native_managedservices_v20190601:managedservices:RegistrationAssignment"), pulumi.Alias(type_="azure-native_managedservices_v20190901:managedservices:RegistrationAssignment"), pulumi.Alias(type_="azure-native_managedservices_v20200201preview:managedservices:RegistrationAssignment"), pulumi.Alias(type_="azure-native_managedservices_v20220101preview:managedservices:RegistrationAssignment"), pulumi.Alias(type_="azure-native_managedservices_v20221001:managedservices:RegistrationAssignment")])
