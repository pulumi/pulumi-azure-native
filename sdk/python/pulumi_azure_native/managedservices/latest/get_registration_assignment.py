...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:managedservices:getRegistrationAssignment'.""", DeprecationWarning)
...
def get_registration_assignment(expand_registration_definition: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managedservices/latest:getRegistrationAssignment', __args__, opts=opts, typ=GetRegistrationAssignmentResult).value
