...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:managedservices/latest:RegistrationAssignment":
                return RegistrationAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:managedservices/latest:RegistrationDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-native", "managedservices/latest", _module_instance)
