...
def get_registration_definition(registration_definition_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registration_definition is deprecated: Version v20190601 will be removed in the next major version of the provider. Upgrade to version v20190901 or later.""")
    __args__ = dict()
