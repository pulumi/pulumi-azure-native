...
def get_registration_assignment(expand_registration_definition: Optional[bool] = None,
    ...
    """
    pulumi.log.warn("""get_registration_assignment is deprecated: Version v20190601 will be removed in the next major version of the provider. Upgrade to version v20190901 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managedservices/v20190601:getRegistrationAssignment', __args__, opts=opts, typ=GetRegistrationAssignmentResult).value
