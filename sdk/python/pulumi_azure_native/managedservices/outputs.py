...
class PlanResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str version: Azure Marketplace plan's version.
        """
...
class RegistrationAssignmentPropertiesResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 managed_by_tenant_name: Optional[_builtins.str] = None,
                 managee_tenant_id: Optional[_builtins.str] = None,
                 managee_tenant_name: Optional[_builtins.str] = None,
        ...
        :param _builtins.str managee_tenant_id: The identifier of the managed tenant.
        :param _builtins.str managee_tenant_name: The name of the managed tenant.
        :param _builtins.str provisioning_state: The current provisioning state of the registration definition.
        :param _builtins.str registration_definition_name: The name of the registration definition.
        """
...
class RegistrationAssignmentPropertiesResponseRegistrationDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param '_commontypesv3.SystemDataResponse' system_data: The metadata for the registration definition resource.
        :param _builtins.str type: The type of the Azure resource (Microsoft.ManagedServices/registrationDefinitions).
