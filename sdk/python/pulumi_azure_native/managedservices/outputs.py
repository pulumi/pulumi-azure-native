...
class AuthorizationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 delegated_role_definition_ids: Optional[Sequence[builtins.str]] = None,
                 principal_id_display_name: Optional[builtins.str] = None):
        """
        The Azure Active Directory principal identifier and Azure built-in role that describes the access the principal will receive on the delegated resource in the managed tenant.
        :param builtins.str principal_id: The identifier of the Azure Active Directory principal.
        :param builtins.str role_definition_id: The identifier of the Azure built-in role that defines the permissions that the Azure Active Directory principal will have on the projected scope.
        :param Sequence[builtins.str] delegated_role_definition_ids: The delegatedRoleDefinitionIds field is required when the roleDefinitionId refers to the User Access Administrator Role. It is the list of role definition ids which define all the permissions that the user in the authorization can assign to other principals.
        :param builtins.str principal_id_display_name: The display name of the Azure Active Directory principal.
        """
    ...
    def delegated_role_definition_ids(self) -> Optional[Sequence[builtins.str]]:
        """
        The delegatedRoleDefinitionIds field is required when the roleDefinitionId refers to the User Access Administrator Role. It is the list of role definition ids which define all the permissions that the user in the authorization can assign to other principals.
        """
    ...
    def principal_id_display_name(self) -> Optional[builtins.str]:
        """
...
class JustInTimeAccessPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 multi_factor_auth_provider: Optional[builtins.str] = None,
                 managed_by_tenant_approvers: Optional[Sequence['outputs.EligibleApproverResponse']] = None,
                 maximum_activation_duration: Optional[builtins.str] = None):
        """
        Just-in-time access policy setting.
        :param builtins.str multi_factor_auth_provider: The multi-factor authorization provider to be used for just-in-time access requests.
        ...
        :param builtins.str maximum_activation_duration: The maximum access duration in ISO 8601 format for just-in-time access requests.
        """
    ...
    def maximum_activation_duration(self) -> Optional[builtins.str]:
        """
...
class PlanResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The details for the Managed Services offer’s plan in Azure Marketplace.
        :param builtins.str name: Azure Marketplace plan name.
        :param builtins.str product: Azure Marketplace product code.
        :param builtins.str publisher: Azure Marketplace publisher ID.
        :param builtins.str version: Azure Marketplace plan's version.
        """
...
class RegistrationAssignmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 registration_definition_id: builtins.str):
        """
        The properties of the registration assignment.
        :param builtins.str provisioning_state: The current provisioning state of the registration assignment.
        ...
        :param builtins.str registration_definition_id: The fully qualified path of the registration definition.
        """
    ...
    def registration_definition_id(self) -> builtins.str:
        """
...
class RegistrationAssignmentPropertiesResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 managed_by_tenant_name: Optional[builtins.str] = None,
                 managee_tenant_id: Optional[builtins.str] = None,
                 managee_tenant_name: Optional[builtins.str] = None,
                 provisioning_state: Optional[builtins.str] = None,
                 registration_definition_name: Optional[builtins.str] = None):
        """
        The properties of the registration definition associated with the registration assignment.
        ...
        :param builtins.str description: The description of the registration definition.
        ...
        :param builtins.str managed_by_tenant_id: The identifier of the managedBy tenant.
        :param builtins.str managed_by_tenant_name: The name of the managedBy tenant.
        :param builtins.str managee_tenant_id: The identifier of the managed tenant.
        :param builtins.str managee_tenant_name: The name of the managed tenant.
        :param builtins.str provisioning_state: The current provisioning state of the registration definition.
        :param builtins.str registration_definition_name: The name of the registration definition.
        """
    ...
    def managed_by_tenant_name(self) -> Optional[builtins.str]:
        """
    ...
    def managee_tenant_id(self) -> Optional[builtins.str]:
        """
    ...
    def managee_tenant_name(self) -> Optional[builtins.str]:
        """
    ...
    def registration_definition_name(self) -> Optional[builtins.str]:
        """
...
class RegistrationAssignmentPropertiesResponseRegistrationDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The registration definition associated with the registration assignment.
        :param builtins.str id: The fully qualified path of the registration definition.
        :param builtins.str name: The name of the registration definition.
        :param 'SystemDataResponse' system_data: The metadata for the registration definition resource.
        :param builtins.str type: The type of the Azure resource (Microsoft.ManagedServices/registrationDefinitions).
...
class RegistrationDefinitionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 managed_by_tenant_id: builtins.str,
                 managed_by_tenant_name: builtins.str,
                 managee_tenant_id: builtins.str,
                 managee_tenant_name: builtins.str,
                 provisioning_state: builtins.str,
                 description: Optional[builtins.str] = None,
                 eligible_authorizations: Optional[Sequence['outputs.EligibleAuthorizationResponse']] = None,
                 registration_definition_name: Optional[builtins.str] = None):
    ...
    @property
    @pulumi.getter(name="managedByTenantId")
    def managed_by_tenant_id(self) -> builtins.str:
        """
        The identifier of the managedBy tenant.
        """
        return pulumi.get(self, "managed_by_tenant_id")
    ...
    @property
    @pulumi.getter(name="managedByTenantName")
    def managed_by_tenant_name(self) -> builtins.str:
        """
        The name of the managedBy tenant.
        """
        return pulumi.get(self, "managed_by_tenant_name")
    ...
    @property
    @pulumi.getter(name="manageeTenantId")
    def managee_tenant_id(self) -> builtins.str:
        """
        The identifier of the managed tenant.
        """
        return pulumi.get(self, "managee_tenant_id")
    ...
    @property
    @pulumi.getter(name="manageeTenantName")
    def managee_tenant_name(self) -> builtins.str:
        """
        The name of the managed tenant.
        """
        return pulumi.get(self, "managee_tenant_name")
