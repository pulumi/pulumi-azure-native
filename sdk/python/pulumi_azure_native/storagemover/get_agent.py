...
def get_agent(agent_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str agent_name: The name of the Agent resource.
...
def get_agent_output(agent_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
