...
class JobDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20220701preview:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20230301:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20230701preview:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20240701:JobDefinition")])
