...
class StorageMover(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            StorageMoverArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20220701preview:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20230301:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20230701preview:StorageMover")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageMover, __self__).__init__(
            'azure-native:storagemover/v20231001:StorageMover',
            resource_name,
            __props__,
            opts)
