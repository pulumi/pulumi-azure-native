...
class StorageMover(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20220701preview:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20230701preview:StorageMover")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageMover, __self__).__init__(
            'azure-native:storagemover/v20230301:StorageMover',
            resource_name,
            __props__,
            opts)
