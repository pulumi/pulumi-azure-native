...
class Endpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover/v20220701preview:Endpoint"), pulumi.Alias(type_="azure-native:storagemover/v20230701preview:Endpoint"), pulumi.Alias(type_="azure-native:storagemover/v20231001:Endpoint"), pulumi.Alias(type_="azure-native:storagemover/v20240701:Endpoint"), pulumi.Alias(type_="azure-native:storagemover:Endpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Endpoint, __self__).__init__(
            'azure-native:storagemover/v20230301:Endpoint',
            resource_name,
            __props__,
            opts)
