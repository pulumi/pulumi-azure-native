...
class Endpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        endpoint = azure_native.storagemover.v20230301.Endpoint("endpoint",
            endpoint_name="examples-endpointName",
            properties=azure_native.storagemover.v20230301.AzureStorageBlobContainerEndpointPropertiesArgs(
