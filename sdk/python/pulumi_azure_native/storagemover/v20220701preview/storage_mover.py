...
class StorageMover(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20230301:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20230701preview:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20231001:StorageMover"), pulumi.Alias(type_="azure-native:storagemover/v20240701:StorageMover")])
