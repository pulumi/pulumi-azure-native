...
class Agent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        agent = azure_native.storagemover.v20220701preview.Agent("agent",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover:Agent"), pulumi.Alias(type_="azure-native:storagemover/v20230301:Agent")])
