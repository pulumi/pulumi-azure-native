...
class Endpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover/v20230301:Endpoint"), pulumi.Alias(type_="azure-native:storagemover/v20230701preview:Endpoint"), pulumi.Alias(type_="azure-native:storagemover/v20231001:Endpoint"), pulumi.Alias(type_="azure-native:storagemover/v20240701:Endpoint"), pulumi.Alias(type_="azure-native_storagemover_v20220701preview:storagemover:Endpoint"), pulumi.Alias(type_="azure-native_storagemover_v20230301:storagemover:Endpoint"), pulumi.Alias(type_="azure-native_storagemover_v20230701preview:storagemover:Endpoint"), pulumi.Alias(type_="azure-native_storagemover_v20231001:storagemover:Endpoint"), pulumi.Alias(type_="azure-native_storagemover_v20240701:storagemover:Endpoint")])
