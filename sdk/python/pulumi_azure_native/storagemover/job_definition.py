...
class JobDefinitionArgs:
    def __init__(__self__, *,
                 copy_mode: pulumi.Input[Union[builtins.str, 'CopyMode']],
                 ...
                 source_subpath: Optional[pulumi.Input[builtins.str]] = None,
                 target_subpath: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a JobDefinition resource.
        :param pulumi.Input[Union[builtins.str, 'CopyMode']] copy_mode: Strategy to use for copy.
        :param pulumi.Input[builtins.str] project_name: The name of the Project resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] source_name: The name of the source Endpoint.
        :param pulumi.Input[builtins.str] storage_mover_name: The name of the Storage Mover resource.
        :param pulumi.Input[builtins.str] target_name: The name of the target Endpoint.
        :param pulumi.Input[builtins.str] agent_name: Name of the Agent to assign for new Job Runs of this Job Definition.
        :param pulumi.Input[builtins.str] description: A description for the Job Definition.
        :param pulumi.Input[builtins.str] job_definition_name: The name of the Job Definition resource.
        :param pulumi.Input[builtins.str] source_subpath: The subpath to use when reading from the source Endpoint.
        :param pulumi.Input[builtins.str] target_subpath: The subpath to use when writing to the target Endpoint.
        """
    ...
    def copy_mode(self) -> pulumi.Input[Union[builtins.str, 'CopyMode']]:
        """
    ...
    @copy_mode.setter
    def copy_mode(self, value: pulumi.Input[Union[builtins.str, 'CopyMode']]):
    ...
    def job_definition_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def job_definition_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "job_definition_name", value)

    @property
    @pulumi.getter(name="sourceSubpath")
    def source_subpath(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_subpath(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_subpath", value)

    @property
    @pulumi.getter(name="targetSubpath")
    def target_subpath(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_subpath(self, value: Optional[pulumi.Input[builtins.str]]):
...
class JobDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 agent_name: Optional[pulumi.Input[builtins.str]] = None,
                 copy_mode: Optional[pulumi.Input[Union[builtins.str, 'CopyMode']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 job_definition_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover/v20220701preview:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20230301:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20230701preview:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20231001:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20240701:JobDefinition")])
    ...
    @property
    @pulumi.getter(name="agentName")
    def agent_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the Agent to assign for new Job Runs of this Job Definition.
        """
        return pulumi.get(self, "agent_name")
    ...
    def agent_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="copyMode")
    def copy_mode(self) -> pulumi.Output[builtins.str]:
        """
        Strategy to use for copy.
        """
        return pulumi.get(self, "copy_mode")
    ...
    def latest_job_run_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def latest_job_run_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def latest_job_run_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="sourceSubpath")
    def source_subpath(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The subpath to use when reading from the source Endpoint.
        """
        return pulumi.get(self, "source_subpath")
    ...
    @property
    @pulumi.getter(name="targetSubpath")
    def target_subpath(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The subpath to use when writing to the target Endpoint.
        """
        return pulumi.get(self, "target_subpath")
