...
class JobDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] agent_name: Name of the agent to assign for new job runs of this definition.
    ...
    def copy_mode(self) -> Optional[pulumi.Input[Union[str, 'CopyMode']]]:
        """
    ...
    @copy_mode.setter
    def copy_mode(self, value: Optional[pulumi.Input[Union[str, 'CopyMode']]]):
...
class JobDefinition(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="copyMode")
    def copy_mode(self) -> pulumi.Output[Optional[str]]:
        """
        Strategy to use for copy.
        """
        return pulumi.get(self, "copy_mode")
