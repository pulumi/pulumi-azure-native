...
class JobDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover/v20230301:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20230701preview:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20231001:JobDefinition"), pulumi.Alias(type_="azure-native:storagemover/v20240701:JobDefinition"), pulumi.Alias(type_="azure-native_storagemover_v20220701preview:storagemover:JobDefinition"), pulumi.Alias(type_="azure-native_storagemover_v20230301:storagemover:JobDefinition"), pulumi.Alias(type_="azure-native_storagemover_v20230701preview:storagemover:JobDefinition"), pulumi.Alias(type_="azure-native_storagemover_v20231001:storagemover:JobDefinition"), pulumi.Alias(type_="azure-native_storagemover_v20240701:storagemover:JobDefinition")])
