...
class StorageMoverArgs:
    ...
    def storage_mover_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_mover_name(self, value: Optional[pulumi.Input[builtins.str]]):
