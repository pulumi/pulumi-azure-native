...
class AgentArgs:
    def __init__(__self__, *,
                 arc_resource_id: pulumi.Input[builtins.str],
                 arc_vm_uuid: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] arc_resource_id: The fully qualified resource ID of the Hybrid Compute resource for the Agent.
        :param pulumi.Input[builtins.str] arc_vm_uuid: The VM UUID of the Hybrid Compute resource for the Agent.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] storage_mover_name: The name of the Storage Mover resource.
        :param pulumi.Input[builtins.str] agent_name: The name of the Agent resource.
        :param pulumi.Input[builtins.str] description: A description for the Agent.
    ...
    def arc_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def arc_resource_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "arc_resource_id", value)

    @property
    @pulumi.getter(name="arcVmUuid")
    def arc_vm_uuid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @arc_vm_uuid.setter
    def arc_vm_uuid(self, value: pulumi.Input[builtins.str]):
...
class Agent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 agent_name: Optional[pulumi.Input[builtins.str]] = None,
                 arc_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 arc_vm_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def agent_status(self) -> pulumi.Output[builtins.str]:
        """
        The Agent status.
        """
    ...
    @property
    @pulumi.getter(name="arcResourceId")
    def arc_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The fully qualified resource ID of the Hybrid Compute resource for the Agent.
        """
        return pulumi.get(self, "arc_resource_id")
    ...
    @property
    @pulumi.getter(name="arcVmUuid")
    def arc_vm_uuid(self) -> pulumi.Output[builtins.str]:
        """
        The VM UUID of the Hybrid Compute resource for the Agent.
        """
        return pulumi.get(self, "arc_vm_uuid")
    ...
    def last_status_update(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def local_ip_address(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def memory_in_mb(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def number_of_cores(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def uptime_in_seconds(self) -> pulumi.Output[builtins.float]:
        """
