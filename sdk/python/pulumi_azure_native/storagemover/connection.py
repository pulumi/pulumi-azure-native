...
class Connection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] connection_name: The name of the Connection resource.
        :param pulumi.Input[Union['ConnectionPropertiesArgs', 'ConnectionPropertiesArgsDict']] properties: Connection properties.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] storage_mover_name: The name of the Storage Mover resource.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagemover/v20250801:Connection")])
