...
def get_project(project_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagemover:getProject', __args__, opts=opts, typ=GetProjectResult).value
...
def get_project_output(project_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagemover:getProject', __args__, opts=opts, typ=GetProjectResult)
