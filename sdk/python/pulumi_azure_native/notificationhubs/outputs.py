...
class ApnsCredentialResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 apns_certificate: Optional[_builtins.str] = None,
        ...
        :param _builtins.str app_name: Gets or sets the name of the application
        :param _builtins.str certificate_key: Gets or sets the certificate key.
        :param _builtins.str key_id: Gets or sets a 10-character key identifier (kid) key, obtained from
               your developer account
        :param _builtins.str thumbprint: Gets or sets the APNS certificate Thumbprint
        :param _builtins.str token: Gets or sets provider Authentication Token, obtained through your
               developer account
        """
...
class PrivateEndpointConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: State of Private Endpoint Connection.
        """
...
class SharedAccessAuthorizationRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str key_name: Gets a string that describes the authorization rule.
        :param _builtins.str modified_time: Gets the last modified time for this rule
        :param _builtins.int revision: Gets the revision number for the rule
        :param Sequence[_builtins.str] rights: Gets or sets the rights associated with the rule.
        :param _builtins.str primary_key: Gets a base64-encoded 256-bit primary key for signing and
               validating the SAS token.
        :param _builtins.str secondary_key: Gets a base64-encoded 256-bit primary key for signing and
               validating the SAS token.
        """
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str size: Gets or sets the Sku size
        :param _builtins.str tier: Gets or sets the tier of particular sku
        """
        pulumi.set(__self__, "name", name)
...
class WnsCredentialResponse(dict):
    ...
    def __init__(__self__, *,
                 certificate_key: Optional[_builtins.str] = None,
                 package_sid: Optional[_builtins.str] = None,
                 secret_key: Optional[_builtins.str] = None,
                 windows_live_endpoint: Optional[_builtins.str] = None,
        ...
        :param _builtins.str windows_live_endpoint: Gets or sets the Windows Live endpoint.
        :param _builtins.str wns_certificate: Gets or sets the WNS Certificate.
        """
        if certificate_key is not None:
            pulumi.set(__self__, "certificate_key", certificate_key)
