...
def get_notification_hub(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_notification_hub is deprecated: Version v20160301 will be removed in the next major version of the provider. Upgrade to version v20170401 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:notificationhubs/v20160301:getNotificationHub', __args__, opts=opts, typ=GetNotificationHubResult).value
