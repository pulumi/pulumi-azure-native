...
class NamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'OperationProvisioningState']] provisioning_state: Defines values for OperationProvisioningState.
        :param pulumi.Input[Union[_builtins.str, 'PublicNetworkAccess']] public_network_access: Type of public network access.
        :param pulumi.Input[Union[_builtins.str, 'ReplicationRegion']] replication_region: Allowed replication region
        :param pulumi.Input[_builtins.str] scale_unit: Gets or sets scaleUnit where the namespace gets created
        :param pulumi.Input[Union[_builtins.str, 'NamespaceStatus']] status: Namespace status.
