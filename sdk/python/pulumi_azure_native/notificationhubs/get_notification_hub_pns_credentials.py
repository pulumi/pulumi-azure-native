...
def get_notification_hub_pns_credentials(namespace_name: Optional[builtins.str] = None,
...
def get_notification_hub_pns_credentials_output(namespace_name: Optional[pulumi.Input[builtins.str]] = None,
