...
class NotificationHubAuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] namespace_name: The namespace name.
        :param pulumi.Input[str] notification_hub_name: The notification hub name.
        :param pulumi.Input[Union['SharedAccessAuthorizationRulePropertiesArgs', 'SharedAccessAuthorizationRulePropertiesArgsDict']] properties: Properties of the Namespace AuthorizationRules.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:notificationhubs:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-native:notificationhubs/v20160301:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-native:notificationhubs/v20230101preview:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-native:notificationhubs/v20230901:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-native:notificationhubs/v20231001preview:NotificationHubAuthorizationRule")])
