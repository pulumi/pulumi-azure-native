...
def get_namespace_pns_credentials(namespace_name: Optional[_builtins.str] = None,
...
def get_namespace_pns_credentials_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:notificationhubs:getNamespacePnsCredentials', __args__, opts=opts, typ=GetNamespacePnsCredentialsResult)
    return __ret__.apply(lambda __response__: GetNamespacePnsCredentialsResult(
