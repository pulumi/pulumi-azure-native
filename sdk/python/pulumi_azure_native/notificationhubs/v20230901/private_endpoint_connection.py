...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:notificationhubs/v20230101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:notificationhubs/v20231001preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:notificationhubs:PrivateEndpointConnection")])
