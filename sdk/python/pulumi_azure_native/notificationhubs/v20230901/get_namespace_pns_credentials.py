...
def get_namespace_pns_credentials(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:notificationhubs/v20230901:getNamespacePnsCredentials', __args__, opts=opts, typ=GetNamespacePnsCredentialsResult).value
...
def get_namespace_pns_credentials_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:notificationhubs/v20230901:getNamespacePnsCredentials', __args__, opts=opts, typ=GetNamespacePnsCredentialsResult)
