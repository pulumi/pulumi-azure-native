...
if not MYPY:
    class AdmCredentialArgsDict(TypedDict):
        ...
        """
        auth_token_url: pulumi.Input[builtins.str]
        """
...
class AdmCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        Description of a NotificationHub AdmCredential.
        :param pulumi.Input[builtins.str] auth_token_url: Gets or sets the URL of the authorization token.
        :param pulumi.Input[builtins.str] client_id: Gets or sets the client identifier.
        :param pulumi.Input[builtins.str] client_secret: Gets or sets the credential secret access key.
        """
    ...
    def auth_token_url(self) -> pulumi.Input[builtins.str]:
        """
        Gets or sets the URL of the authorization token.
        """
    ...
    def auth_token_url(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ApnsCredentialArgsDict(TypedDict):
        ...
        """
        apns_certificate: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        certificate_key: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApnsCredentialArgs:
    def __init__(__self__, *,
                 endpoint: pulumi.Input[builtins.str],
                 apns_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 app_id: Optional[pulumi.Input[builtins.str]] = None,
                 app_name: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_key: Optional[pulumi.Input[builtins.str]] = None,
                 key_id: Optional[pulumi.Input[builtins.str]] = None,
                 thumbprint: Optional[pulumi.Input[builtins.str]] = None,
                 token: Optional[pulumi.Input[builtins.str]] = None):
        """
        Description of a NotificationHub ApnsCredential.
        :param pulumi.Input[builtins.str] endpoint: Gets or sets the endpoint of this credential.
        :param pulumi.Input[builtins.str] apns_certificate: Gets or sets the APNS certificate.
        :param pulumi.Input[builtins.str] app_id: Gets or sets the issuer (iss) registered claim key, whose value is
               your 10-character Team ID, obtained from your developer account
        :param pulumi.Input[builtins.str] app_name: Gets or sets the name of the application
        :param pulumi.Input[builtins.str] certificate_key: Gets or sets the certificate key.
        :param pulumi.Input[builtins.str] key_id: Gets or sets a 10-character key identifier (kid) key, obtained from
               your developer account
        :param pulumi.Input[builtins.str] thumbprint: Gets or sets the APNS certificate Thumbprint
        :param pulumi.Input[builtins.str] token: Gets or sets provider Authentication Token, obtained through your
               developer account
        """
    ...
    def apns_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Gets or sets the APNS certificate.
        """
    ...
    def apns_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def certificate_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Gets or sets the certificate key.
        """
    ...
    def certificate_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BaiduCredentialArgsDict(TypedDict):
        ...
        """
        baidu_api_key: pulumi.Input[builtins.str]
        """
        Gets or sets baidu Api Key.
        """
        baidu_end_point: pulumi.Input[builtins.str]
        """
        Gets or sets baidu Endpoint.
        """
        baidu_secret_key: pulumi.Input[builtins.str]
        """
...
class BaiduCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        Description of a NotificationHub BaiduCredential.
        :param pulumi.Input[builtins.str] baidu_api_key: Gets or sets baidu Api Key.
        :param pulumi.Input[builtins.str] baidu_end_point: Gets or sets baidu Endpoint.
        :param pulumi.Input[builtins.str] baidu_secret_key: Gets or sets baidu Secret Key
        """
    ...
    def baidu_api_key(self) -> pulumi.Input[builtins.str]:
        """
        Gets or sets baidu Api Key.
        """
    ...
    def baidu_api_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "baidu_api_key", value)

    @property
    @pulumi.getter(name="baiduEndPoint")
    def baidu_end_point(self) -> pulumi.Input[builtins.str]:
        """
        Gets or sets baidu Endpoint.
        """
    ...
    def baidu_end_point(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "baidu_end_point", value)

    @property
    @pulumi.getter(name="baiduSecretKey")
    def baidu_secret_key(self) -> pulumi.Input[builtins.str]:
        """
        Gets or sets baidu Secret Key
        """
    ...
    def baidu_secret_key(self, value: pulumi.Input[builtins.str]):
...
class BrowserCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        Description of a NotificationHub BrowserCredential.
        :param pulumi.Input[builtins.str] subject: Gets or sets web push subject.
        :param pulumi.Input[builtins.str] vapid_private_key: Gets or sets VAPID private key.
        :param pulumi.Input[builtins.str] vapid_public_key: Gets or sets VAPID public key.
        """
...
class FcmV1CredentialArgs:
    def __init__(__self__, *,
        ...
        """
        Description of a NotificationHub FcmV1Credential.
        :param pulumi.Input[builtins.str] client_email: Gets or sets client email.
        :param pulumi.Input[builtins.str] private_key: Gets or sets private key.
        :param pulumi.Input[builtins.str] project_id: Gets or sets project id.
        """
...
if not MYPY:
    class GcmCredentialArgsDict(TypedDict):
        ...
        """
        google_api_key: pulumi.Input[builtins.str]
        """
        Gets or sets the Google API key.
        """
        gcm_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GcmCredentialArgs:
    def __init__(__self__, *,
                 google_api_key: pulumi.Input[builtins.str],
                 gcm_endpoint: Optional[pulumi.Input[builtins.str]] = None):
        """
        Description of a NotificationHub GcmCredential.
        :param pulumi.Input[builtins.str] google_api_key: Gets or sets the Google API key.
        :param pulumi.Input[builtins.str] gcm_endpoint: Gets or sets the GCM endpoint.
        """
    ...
    def google_api_key(self) -> pulumi.Input[builtins.str]:
        """
        Gets or sets the Google API key.
        """
    ...
    def google_api_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "google_api_key", value)

    @property
    @pulumi.getter(name="gcmEndpoint")
    def gcm_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Gets or sets the GCM endpoint.
        """
    ...
    @gcm_endpoint.setter
    def gcm_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IpRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AccessRights']]]] rights: List of access rights.
        """
...
if not MYPY:
    class MpnsCredentialArgsDict(TypedDict):
        ...
        """
        certificate_key: pulumi.Input[builtins.str]
        """
        Gets or sets the certificate key for this credential.
        """
        mpns_certificate: pulumi.Input[builtins.str]
        """
...
class MpnsCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        Description of a NotificationHub MpnsCredential.
        :param pulumi.Input[builtins.str] certificate_key: Gets or sets the certificate key for this credential.
        :param pulumi.Input[builtins.str] mpns_certificate: Gets or sets the MPNS certificate.
        :param pulumi.Input[builtins.str] thumbprint: Gets or sets the MPNS certificate Thumbprint
        """
        pulumi.set(__self__, "certificate_key", certificate_key)
    ...
    @property
    @pulumi.getter(name="certificateKey")
    def certificate_key(self) -> pulumi.Input[builtins.str]:
        """
        Gets or sets the certificate key for this credential.
        """
        return pulumi.get(self, "certificate_key")
    ...
    @certificate_key.setter
    def certificate_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "certificate_key", value)

    @property
    @pulumi.getter(name="mpnsCertificate")
    def mpns_certificate(self) -> pulumi.Input[builtins.str]:
        """
        Gets or sets the MPNS certificate.
        """
    ...
    def mpns_certificate(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class PrivateEndpointConnectionPropertiesArgsDict(TypedDict):
        ...
        """
        provisioning_state: NotRequired[pulumi.Input[Union[builtins.str, 'PrivateEndpointConnectionProvisioningState']]]
        """
...
class PrivateEndpointConnectionPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 provisioning_state: Optional[pulumi.Input[Union[builtins.str, 'PrivateEndpointConnectionProvisioningState']]] = None):
        """
        Private Endpoint Connection properties.
        ...
        :param pulumi.Input[Union[builtins.str, 'PrivateEndpointConnectionProvisioningState']] provisioning_state: State of Private Endpoint Connection.
        """
    ...
    def provisioning_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'PrivateEndpointConnectionProvisioningState']]]:
        """
        State of Private Endpoint Connection.
        """
    ...
    def provisioning_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'PrivateEndpointConnectionProvisioningState']]]):
...
class RemotePrivateLinkServiceConnectionStateArgs:
    def __init__(__self__, *,
        ...
        """
        State of the Private Link Service connection.
        :param pulumi.Input[Union[builtins.str, 'PrivateLinkConnectionStatus']] status: State of Private Link Connection.
        """
...
class SkuArgs:
    def __init__(__self__, *,
        ...
        """
        The Sku description for a namespace
        :param pulumi.Input[Union[builtins.str, 'SkuName']] name: Namespace SKU name.
        :param pulumi.Input[builtins.int] capacity: Gets or sets the capacity of the resource
        :param pulumi.Input[builtins.str] family: Gets or sets the Sku Family
        :param pulumi.Input[builtins.str] size: Gets or sets the Sku size
        :param pulumi.Input[builtins.str] tier: Gets or sets the tier of particular sku
        """
...
if not MYPY:
    class WnsCredentialArgsDict(TypedDict):
        ...
        """
        package_sid: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        windows_live_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
        Gets or sets the Windows Live endpoint.
        """
        wns_certificate: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WnsCredentialArgs:
    def __init__(__self__, *,
                 certificate_key: Optional[pulumi.Input[builtins.str]] = None,
                 package_sid: Optional[pulumi.Input[builtins.str]] = None,
                 secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 windows_live_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 wns_certificate: Optional[pulumi.Input[builtins.str]] = None):
        """
        Description of a NotificationHub WnsCredential.
        :param pulumi.Input[builtins.str] certificate_key: Ges or sets the WNS Certificate Key.
        :param pulumi.Input[builtins.str] package_sid: Gets or sets the package ID for this credential.
        :param pulumi.Input[builtins.str] secret_key: Gets or sets the secret key.
        :param pulumi.Input[builtins.str] windows_live_endpoint: Gets or sets the Windows Live endpoint.
        :param pulumi.Input[builtins.str] wns_certificate: Gets or sets the WNS Certificate.
        """
        if certificate_key is not None:
            pulumi.set(__self__, "certificate_key", certificate_key)
    ...
    def package_sid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Gets or sets the package ID for this credential.
        """
    ...
    @package_sid.setter
    def package_sid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def windows_live_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Gets or sets the Windows Live endpoint.
        """
    ...
    def windows_live_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "windows_live_endpoint", value)

    @property
    @pulumi.getter(name="wnsCertificate")
    def wns_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Gets or sets the WNS Certificate.
        """
    ...
    def wns_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
...
class XiaomiCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        Description of a NotificationHub XiaomiCredential.
        :param pulumi.Input[builtins.str] app_secret: Gets or sets app secret.
        :param pulumi.Input[builtins.str] endpoint: Gets or sets xiaomi service endpoint.
        """
