...
def get_notification_hub(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:notificationhubs/v20230101preview:getNotificationHub', __args__, opts=opts, typ=GetNotificationHubResult).value
...
def get_notification_hub_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:notificationhubs/v20230101preview:getNotificationHub', __args__, opts=opts, typ=GetNotificationHubResult)
