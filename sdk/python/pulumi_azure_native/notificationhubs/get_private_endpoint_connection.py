...
def get_private_endpoint_connection(namespace_name: Optional[builtins.str] = None,
    ...
    :param builtins.str private_endpoint_connection_name: Private Endpoint Connection Name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:notificationhubs:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
...
def get_private_endpoint_connection_output(namespace_name: Optional[pulumi.Input[builtins.str]] = None,
