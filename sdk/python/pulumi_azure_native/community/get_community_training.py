...
def get_community_training(community_training_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str community_training_name: The name of the Community Training Resource
...
def get_community_training_output(community_training_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
