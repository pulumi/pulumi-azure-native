...
class CommunityTrainingArgs:
    def __init__(__self__, *,
                 disaster_recovery_enabled: pulumi.Input[builtins.bool],
                 identity_configuration: pulumi.Input['IdentityConfigurationPropertiesArgs'],
                 portal_admin_email_address: pulumi.Input[builtins.str],
                 portal_name: pulumi.Input[builtins.str],
                 portal_owner_email_address: pulumi.Input[builtins.str],
                 portal_owner_organization_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 zone_redundancy_enabled: pulumi.Input[builtins.bool],
                 community_training_name: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 sku: Optional[pulumi.Input['SkuArgs']] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a CommunityTraining resource.
        :param pulumi.Input[builtins.bool] disaster_recovery_enabled: To indicate whether the Community Training instance has Disaster Recovery enabled
        ...
        :param pulumi.Input[builtins.str] portal_admin_email_address: The email address of the portal admin
        :param pulumi.Input[builtins.str] portal_name: The portal name (website name) of the Community Training instance
        :param pulumi.Input[builtins.str] portal_owner_email_address: The email address of the portal owner. Will be used as the primary contact
        :param pulumi.Input[builtins.str] portal_owner_organization_name: The organization name of the portal owner
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.bool] zone_redundancy_enabled: To indicate whether the Community Training instance has Zone Redundancy enabled
        :param pulumi.Input[builtins.str] community_training_name: The name of the Community Training Resource
    ...
    def disaster_recovery_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def disaster_recovery_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def portal_admin_email_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def portal_admin_email_address(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "portal_admin_email_address", value)

    @property
    @pulumi.getter(name="portalName")
    def portal_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @portal_name.setter
    def portal_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "portal_name", value)

    @property
    @pulumi.getter(name="portalOwnerEmailAddress")
    def portal_owner_email_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def portal_owner_email_address(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "portal_owner_email_address", value)

    @property
    @pulumi.getter(name="portalOwnerOrganizationName")
    def portal_owner_organization_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def portal_owner_organization_name(self, value: pulumi.Input[builtins.str]):
    ...
    def zone_redundancy_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def zone_redundancy_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "zone_redundancy_enabled", value)

    @property
    @pulumi.getter(name="communityTrainingName")
    def community_training_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def community_training_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CommunityTraining(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 community_training_name: Optional[pulumi.Input[builtins.str]] = None,
                 disaster_recovery_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 portal_admin_email_address: Optional[pulumi.Input[builtins.str]] = None,
                 portal_name: Optional[pulumi.Input[builtins.str]] = None,
                 portal_owner_email_address: Optional[pulumi.Input[builtins.str]] = None,
                 portal_owner_organization_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="disasterRecoveryEnabled")
    def disaster_recovery_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        To indicate whether the Community Training instance has Disaster Recovery enabled
        """
        return pulumi.get(self, "disaster_recovery_enabled")
    ...
    @property
    @pulumi.getter(name="portalAdminEmailAddress")
    def portal_admin_email_address(self) -> pulumi.Output[builtins.str]:
        """
        The email address of the portal admin
        """
        return pulumi.get(self, "portal_admin_email_address")
    ...
    @property
    @pulumi.getter(name="portalOwnerEmailAddress")
    def portal_owner_email_address(self) -> pulumi.Output[builtins.str]:
        """
        The email address of the portal owner. Will be used as the primary contact
        """
        return pulumi.get(self, "portal_owner_email_address")
    ...
    @property
    @pulumi.getter(name="portalOwnerOrganizationName")
    def portal_owner_organization_name(self) -> pulumi.Output[builtins.str]:
        """
        The organization name of the portal owner
        """
        return pulumi.get(self, "portal_owner_organization_name")
    ...
    @property
    @pulumi.getter(name="zoneRedundancyEnabled")
    def zone_redundancy_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        To indicate whether the Community Training instance has Zone Redundancy enabled
        """
        return pulumi.get(self, "zone_redundancy_enabled")
