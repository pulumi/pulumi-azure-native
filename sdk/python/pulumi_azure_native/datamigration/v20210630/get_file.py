...
def get_file(file_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file is deprecated: azure-native:datamigration/v20210630:File is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:File to guarantee forwards compatibility.""")
    __args__ = dict()
