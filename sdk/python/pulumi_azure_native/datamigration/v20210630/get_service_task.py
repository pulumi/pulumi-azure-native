...
def get_service_task(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_task is deprecated: azure-native:datamigration/v20210630:ServiceTask is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:ServiceTask to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20210630:getServiceTask', __args__, opts=opts, typ=GetServiceTaskResult).value
