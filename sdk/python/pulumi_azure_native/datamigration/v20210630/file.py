...
class File(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datamigration/v20210630:File"), pulumi.Alias(type_="azure-native:datamigration:File"), pulumi.Alias(type_="azure-nextgen:datamigration:File"), pulumi.Alias(type_="azure-native:datamigration/v20180715preview:File"), pulumi.Alias(type_="azure-nextgen:datamigration/v20180715preview:File")])
