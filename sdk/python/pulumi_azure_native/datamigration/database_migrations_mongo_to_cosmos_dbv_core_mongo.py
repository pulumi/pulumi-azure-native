...
class DatabaseMigrationsMongoToCosmosDbvCoreMongo(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbvCoreMongo"), pulumi.Alias(type_="azure-native:datamigration/v20250315preview:DatabaseMigrationsMongoToCosmosDbvCoreMongo"), pulumi.Alias(type_="azure-native:datamigration/v20250630:DatabaseMigrationsMongoToCosmosDbvCoreMongo"), pulumi.Alias(type_="azure-native:datamigration/v20250901preview:DatabaseMigrationsMongoToCosmosDbvCoreMongo")])
