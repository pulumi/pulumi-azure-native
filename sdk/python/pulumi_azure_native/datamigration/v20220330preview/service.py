...
class ServiceArgs:
    ...
    def _configure(
        ...
        if auto_stop_delay is None and 'autoStopDelay' in kwargs:
            auto_stop_delay = kwargs['autoStopDelay']
        if delete_resources_on_stop is None and 'deleteResourcesOnStop' in kwargs:
            delete_resources_on_stop = kwargs['deleteResourcesOnStop']
        ...
        if virtual_subnet_id is None and 'virtualSubnetId' in kwargs:
            virtual_subnet_id = kwargs['virtualSubnetId']
