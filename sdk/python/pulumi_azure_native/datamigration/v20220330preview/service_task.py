...
class ServiceTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service_task = azure_native.datamigration.v20220330preview.ServiceTask("serviceTask",
            group_name="DmsSdkRg",
            properties={
                "input": azure_native.datamigration.v20220330preview.MongoDbConnectionInfoArgs(
                    server_version="NA",
                ),
