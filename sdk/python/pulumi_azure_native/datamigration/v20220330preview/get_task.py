...
def get_task(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20220330preview:getTask', __args__, opts=opts, typ=GetTaskResult).value
...
def get_task_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['taskName'] = task_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20220330preview:getTask', __args__, opts=opts, typ=GetTaskResult)
