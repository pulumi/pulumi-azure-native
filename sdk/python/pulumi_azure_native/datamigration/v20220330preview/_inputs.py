...
class AzureActiveDirectoryAppArgs:
    ...
    def _configure(
        ...
        if 'ignoreAzurePermissions' in kwargs:
...
class ConnectToSourceSqlServerTaskInputArgs:
    ...
    def _configure(
        ...
        if 'encryptedKeyForSecureFields' in kwargs:
...
class ConnectToTargetSqlDbTaskInputArgs:
    ...
    def _configure(
        ...
        if 'targetConnectionInfo' in kwargs:
            target_connection_info = kwargs['targetConnectionInfo']
        if 'queryObjectCounts' in kwargs:
...
class MigrateSqlServerSqlMISyncTaskInputArgs:
    ...
    def _configure(
        ...
        if 'backupFileShare' in kwargs:
            backup_file_share = kwargs['backupFileShare']
        if 'numberOfParallelDatabaseMigrations' in kwargs:
