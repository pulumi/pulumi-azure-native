...
class SqlMigrationServiceArgs:
    def __init__(__self__, *,
        ...
        """
        SqlMigrationServiceArgs._configure(
    ...
    def _configure(
        ...
        if sql_migration_service_name is None and 'sqlMigrationServiceName' in kwargs:
            sql_migration_service_name = kwargs['sqlMigrationServiceName']

        _setter("resource_group_name", resource_group_name)
        if location is not None:
            _setter("location", location)
        if sql_migration_service_name is not None:
            _setter("sql_migration_service_name", sql_migration_service_name)
        if tags is not None:
            _setter("tags", tags)
...
class SqlMigrationService(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SqlMigrationServiceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration:SqlMigrationService"), pulumi.Alias(type_="azure-native:datamigration/v20211030preview:SqlMigrationService"), pulumi.Alias(type_="azure-native:datamigration/v20220130preview:SqlMigrationService")])
