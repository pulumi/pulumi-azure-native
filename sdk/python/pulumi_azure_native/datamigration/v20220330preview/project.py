...
class ProjectArgs:
    ...
    def _configure(
        ...
        if azure_authentication_info is None and 'azureAuthenticationInfo' in kwargs:
            azure_authentication_info = kwargs['azureAuthenticationInfo']
...
class Project(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            azure_authentication_info = _utilities.configure(azure_authentication_info, AzureActiveDirectoryAppArgs, True)
        ...
        super(Project, __self__).__init__(
            'azure-native:datamigration/v20220330preview:Project',
            resource_name,
            __props__,
            opts)
