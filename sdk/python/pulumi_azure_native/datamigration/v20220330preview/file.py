...
class File(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        file = azure_native.datamigration.v20220330preview.File("file",
            file_name="x114d023d8",
            group_name="DmsSdkRg",
            project_name="DmsSdkProject",
            properties=azure_native.datamigration.v20220330preview.ProjectFilePropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        super(File, __self__).__init__(
            'azure-native:datamigration/v20220330preview:File',
            resource_name,
            __props__,
            opts)
