...
class DatabaseMigrationsSqlMiArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['DatabaseMigrationPropertiesSqlMiArgs']] = None,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['DatabaseMigrationPropertiesSqlMiArgs']]):
...
class DatabaseMigrationsSqlMi(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['DatabaseMigrationPropertiesSqlMiArgs', 'DatabaseMigrationPropertiesSqlMiArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['DatabaseMigrationPropertiesSqlMiArgs', 'DatabaseMigrationPropertiesSqlMiArgsDict']] properties: Database Migration Resource properties for SQL Managed Instance.
        :param pulumi.Input[builtins.str] resource_group_name: Name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[builtins.str] target_db_name: The name of the target database.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseMigrationsSqlMiArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseMigrationsSqlMiArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseMigrationsSqlMiArgs.__new__(DatabaseMigrationsSqlMiArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration/v20250630:DatabaseMigrationsSqlMi"), pulumi.Alias(type_="azure-native:datamigration/v20250901preview:DatabaseMigrationsSqlMi")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseMigrationsSqlMi, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DatabaseMigrationsSqlMi':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return DatabaseMigrationsSqlMi(resource_name, opts=opts, __props__=__props__)
