...
def get_project(group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_project is deprecated: Version v20180315preview will be removed in the next major version of the provider. Upgrade to version v20180419 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20180315preview:getProject', __args__, opts=opts, typ=GetProjectResult).value
