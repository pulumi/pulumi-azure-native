...
def get_service(group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: Version v20180315preview will be removed in the next major version of the provider. Upgrade to version v20180419 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20180315preview:getService', __args__, opts=opts, typ=GetServiceResult).value
