...
def get_database_migrations_mongo_to_cosmos_db_ru_mongo(migration_name: Optional[builtins.str] = None,
    ...
    :param builtins.str target_resource_name: The name of the target resource/account.
    """
    __args__ = dict()
...
def get_database_migrations_mongo_to_cosmos_db_ru_mongo_output(migration_name: Optional[pulumi.Input[builtins.str]] = None,
