...
def get_service_task(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_task is deprecated: azure-native:datamigration/v20211030preview:ServiceTask is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:ServiceTask to guarantee forwards compatibility.""")
    __args__ = dict()
