...
warnings.warn("""azure-native:datamigration/v20211030preview:ServiceTask is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:ServiceTask to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServiceTask(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 task_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServiceTask is deprecated: azure-native:datamigration/v20211030preview:ServiceTask is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:ServiceTask to guarantee forwards compatibility.""")
