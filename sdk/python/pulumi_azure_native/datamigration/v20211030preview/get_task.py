...
warnings.warn("""azure-native:datamigration/v20211030preview:Task is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:Task to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_task(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_task is deprecated: azure-native:datamigration/v20211030preview:Task is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:Task to guarantee forwards compatibility.""")
    __args__ = dict()
