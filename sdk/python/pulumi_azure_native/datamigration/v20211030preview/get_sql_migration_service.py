...
def get_sql_migration_service_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20211030preview:getSqlMigrationService', __args__, opts=opts, typ=GetSqlMigrationServiceResult)
