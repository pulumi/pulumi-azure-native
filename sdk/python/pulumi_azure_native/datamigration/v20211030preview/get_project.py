...
class GetProjectResult:
    ...
    A project resource
    """
    def __init__(__self__, azure_authentication_info=None, creation_time=None, databases_info=None, e_tag=None, id=None, location=None, name=None, provisioning_state=None, source_connection_info=None, source_platform=None, system_data=None, tags=None, target_connection_info=None, target_platform=None, type=None):
        if azure_authentication_info and not isinstance(azure_authentication_info, str):
            raise TypeError("Expected argument 'azure_authentication_info' to be a str")
    ...
    def azure_authentication_info(self) -> Optional[str]:
        """
...
def get_project(group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20211030preview:getProject', __args__, opts=opts, typ=GetProjectResult).value
