...
def get_file(file_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file is deprecated: azure-native:datamigration/v20220130preview:File is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:File to guarantee forwards compatibility.""")
    __args__ = dict()
