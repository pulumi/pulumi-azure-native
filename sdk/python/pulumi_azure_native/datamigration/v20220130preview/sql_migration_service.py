...
class SqlMigrationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration:SqlMigrationService"), pulumi.Alias(type_="azure-native:datamigration/v20211030preview:SqlMigrationService"), pulumi.Alias(type_="azure-native:datamigration/v20220330preview:SqlMigrationService"), pulumi.Alias(type_="azure-native:datamigration/v20230715preview:SqlMigrationService")])
