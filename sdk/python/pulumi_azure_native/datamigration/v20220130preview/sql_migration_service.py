...
class SqlMigrationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlMigrationService is deprecated: azure-native:datamigration/v20220130preview:SqlMigrationService is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:SqlMigrationService to guarantee forwards compatibility.""")
