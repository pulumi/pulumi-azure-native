...
warnings.warn("""azure-native:datamigration/v20220130preview:SqlMigrationService is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:SqlMigrationService to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_migration_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_migration_service is deprecated: azure-native:datamigration/v20220130preview:SqlMigrationService is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:SqlMigrationService to guarantee forwards compatibility.""")
    __args__ = dict()
