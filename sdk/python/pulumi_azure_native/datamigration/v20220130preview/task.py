...
warnings.warn("""azure-native:datamigration/v20220130preview:Task is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:Task to guarantee forwards compatibility.""", DeprecationWarning)
