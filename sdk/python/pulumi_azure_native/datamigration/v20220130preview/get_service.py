...
warnings.warn("""azure-native:datamigration/v20220130preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:Service to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_service(group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: azure-native:datamigration/v20220130preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:Service to guarantee forwards compatibility.""")
    __args__ = dict()
