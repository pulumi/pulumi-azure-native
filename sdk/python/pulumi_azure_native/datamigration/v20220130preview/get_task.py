...
def get_task(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_task is deprecated: azure-native:datamigration/v20220130preview:Task is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:Task to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20220130preview:getTask', __args__, opts=opts, typ=GetTaskResult).value
