...
def get_task(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_task is deprecated: azure-native:datamigration/v20220130preview:Task is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:Task to guarantee forwards compatibility.""")
    __args__ = dict()
