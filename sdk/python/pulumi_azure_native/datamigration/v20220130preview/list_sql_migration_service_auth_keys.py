...
def list_sql_migration_service_auth_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20220130preview:listSqlMigrationServiceAuthKeys', __args__, opts=opts, typ=ListSqlMigrationServiceAuthKeysResult).value
...
def list_sql_migration_service_auth_keys_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20220130preview:listSqlMigrationServiceAuthKeys', __args__, opts=opts, typ=ListSqlMigrationServiceAuthKeysResult)
