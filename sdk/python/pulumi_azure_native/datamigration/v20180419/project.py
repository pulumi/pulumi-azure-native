...
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 source_connection_info: Optional[pulumi.Input[Union[Union['MiSqlConnectionInfoArgs', 'MiSqlConnectionInfoArgsDict'], Union['MySqlConnectionInfoArgs', 'MySqlConnectionInfoArgsDict'], Union['PostgreSqlConnectionInfoArgs', 'PostgreSqlConnectionInfoArgsDict'], Union['SqlConnectionInfoArgs', 'SqlConnectionInfoArgsDict']]]] = None,
                 source_platform: Optional[pulumi.Input[Union[str, 'ProjectSourcePlatform']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 target_connection_info: Optional[pulumi.Input[Union[Union['MiSqlConnectionInfoArgs', 'MiSqlConnectionInfoArgsDict'], Union['MySqlConnectionInfoArgs', 'MySqlConnectionInfoArgsDict'], Union['PostgreSqlConnectionInfoArgs', 'PostgreSqlConnectionInfoArgsDict'], Union['SqlConnectionInfoArgs', 'SqlConnectionInfoArgsDict']]]] = None,
        ...
        :param pulumi.Input[str] project_name: Name of the project
        :param pulumi.Input[str] service_name: Name of the service
        :param pulumi.Input[Union[Union['MiSqlConnectionInfoArgs', 'MiSqlConnectionInfoArgsDict'], Union['MySqlConnectionInfoArgs', 'MySqlConnectionInfoArgsDict'], Union['PostgreSqlConnectionInfoArgs', 'PostgreSqlConnectionInfoArgsDict'], Union['SqlConnectionInfoArgs', 'SqlConnectionInfoArgsDict']]] source_connection_info: Information for connecting to source
        :param pulumi.Input[Union[str, 'ProjectSourcePlatform']] source_platform: Source platform for the project
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration:Project"), pulumi.Alias(type_="azure-native:datamigration/v20171115preview:Project"), pulumi.Alias(type_="azure-native:datamigration/v20180315preview:Project"), pulumi.Alias(type_="azure-native:datamigration/v20180331preview:Project"), pulumi.Alias(type_="azure-native:datamigration/v20180715preview:Project"), pulumi.Alias(type_="azure-native:datamigration/v20210630:Project"), pulumi.Alias(type_="azure-native:datamigration/v20211030preview:Project"), pulumi.Alias(type_="azure-native:datamigration/v20220130preview:Project"), pulumi.Alias(type_="azure-native:datamigration/v20220330preview:Project"), pulumi.Alias(type_="azure-native:datamigration/v20230715preview:Project")])
