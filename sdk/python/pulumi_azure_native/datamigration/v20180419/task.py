...
class Task(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        task = azure_native.datamigration.v20180419.Task("task",
            group_name="DmsSdkRg",
            project_name="DmsSdkProject",
            properties=azure_native.datamigration.v20180419.ConnectToTargetSqlDbTaskPropertiesArgs(
                input=azure_native.datamigration.v20180419.ConnectToTargetSqlDbTaskInputArgs(
                    target_connection_info=azure_native.datamigration.v20180419.SqlConnectionInfoArgs(
