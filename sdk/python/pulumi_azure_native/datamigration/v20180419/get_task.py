...
def get_task(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20180419:getTask', __args__, opts=opts, typ=GetTaskResult).value
...
def get_task_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20180419:getTask', __args__, opts=opts, typ=GetTaskResult)
