...
def get_file(file_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str file_name: Name of the File
...
def get_file_output(file_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
