...
warnings.warn("""azure-native:datamigration/v20180715preview:File is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:File to guarantee forwards compatibility.""", DeprecationWarning)
...
class File(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration:File"), pulumi.Alias(type_="azure-native:datamigration/v20210630:File"), pulumi.Alias(type_="azure-native:datamigration/v20211030preview:File"), pulumi.Alias(type_="azure-native:datamigration/v20220130preview:File"), pulumi.Alias(type_="azure-native:datamigration/v20220330preview:File")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(File, __self__).__init__(
            'azure-native:datamigration/v20180715preview:File',
            resource_name,
            __props__,
            opts)
