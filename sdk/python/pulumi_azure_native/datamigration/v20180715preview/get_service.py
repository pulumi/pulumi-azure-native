...
def get_service(group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: azure-native:datamigration/v20180715preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20210630:Service to guarantee forwards compatibility.""")
    __args__ = dict()
