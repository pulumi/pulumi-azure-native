...
class Task(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 task_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Task is deprecated: azure-native:datamigration/v20180715preview:Task is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:Task to guarantee forwards compatibility.""")
