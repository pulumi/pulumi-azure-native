...
warnings.warn("""azure-native:datamigration/v20180715preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20210630:Service to guarantee forwards compatibility.""", DeprecationWarning)
...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Service is deprecated: azure-native:datamigration/v20180715preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20210630:Service to guarantee forwards compatibility.""")
