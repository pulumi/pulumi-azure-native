...
class ProjectArgs:
    ...
    def source_platform(self, value: pulumi.Input[Union[_builtins.str, 'ProjectSourcePlatform']]):
    ...
    def target_platform(self, value: pulumi.Input[Union[_builtins.str, 'ProjectTargetPlatform']]):
