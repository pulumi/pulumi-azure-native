...
class DatabaseMigrationsMongoToCosmosDbRUMongo(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbRUMongo"), pulumi.Alias(type_="azure-native_datamigration_v20230715preview:datamigration:DatabaseMigrationsMongoToCosmosDbRUMongo")])
