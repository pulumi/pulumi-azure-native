...
class DatabaseMigrationsMongoToCosmosDbRUMongoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kind: Expected value is 'MongoToCosmosDbMongo'.
        ...
        :param pulumi.Input[_builtins.str] scope: Resource Id of the target resource.
