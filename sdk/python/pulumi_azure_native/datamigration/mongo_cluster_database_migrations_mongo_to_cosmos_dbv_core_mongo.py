...
__all__ = ['MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs', 'MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo']

@pulumi.input_type
class MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs:
...
class MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Database Migration Resource for Mongo to CosmosDb.
        Azure REST API version: 2023-07-15-preview.
        ...
        :param str resource_name: The name of the resource.
        :param MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs.__new__(MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbvCoreMongo"), pulumi.Alias(type_="azure-native:datamigration/v20230715preview:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo"), pulumi.Alias(type_="azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbvCoreMongo")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo, __self__).__init__(
            'azure-native:datamigration:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo':
        """
        ...
        __props__.__dict__["type"] = None
        return MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(resource_name, opts=opts, __props__=__props__)
