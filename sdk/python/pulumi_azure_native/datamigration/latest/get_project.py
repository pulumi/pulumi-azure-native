...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datamigration:getProject'.""", DeprecationWarning)
...
def get_project(group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/latest:getProject', __args__, opts=opts, typ=GetProjectResult).value
