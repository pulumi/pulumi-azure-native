...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datamigration:getTask'.""", DeprecationWarning)
...
def get_task(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/latest:getTask', __args__, opts=opts, typ=GetTaskResult).value
