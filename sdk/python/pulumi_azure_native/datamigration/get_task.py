...
def get_task(expand: Optional[builtins.str] = None,
...
def get_task_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration:getTask', __args__, opts=opts, typ=GetTaskResult)
