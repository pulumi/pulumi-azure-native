...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:datamigration:File":
                return File(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datamigration:Project":
    ...
    pulumi.runtime.register_resource_module("azure-native", "datamigration", _module_instance)
