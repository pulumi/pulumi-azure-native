...
def get_migration_service(migration_service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str migration_service_name: Name of the Migration Service.
...
def get_migration_service_output(migration_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration:getMigrationService', __args__, opts=opts, typ=GetMigrationServiceResult)
    return __ret__.apply(lambda __response__: GetMigrationServiceResult(
