...
class AzureActiveDirectoryAppResponse(dict):
    ...
    def __init__(__self__, *,
                 app_key: Optional[builtins.str] = None,
                 application_id: Optional[builtins.str] = None,
                 ignore_azure_permissions: Optional[builtins.bool] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        Azure Active Directory Application
        :param builtins.str app_key: Key used to authenticate to the Azure Active Directory Application
        :param builtins.str application_id: Application ID of the Azure Active Directory Application
        :param builtins.bool ignore_azure_permissions: Ignore checking azure permissions on the AAD app
        :param builtins.str tenant_id: Tenant id of the customer
        """
    ...
    def ignore_azure_permissions(self) -> Optional[builtins.bool]:
        """
...
class BackupFileInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 family_sequence_number: Optional[builtins.int] = None,
                 file_location: Optional[builtins.str] = None,
                 status: Optional[builtins.str] = None):
        """
        Information of the backup file
        :param builtins.int family_sequence_number: Sequence number of the backup file in the backup set
        :param builtins.str file_location: Location of the backup file in shared folder
        :param builtins.str status: Status of the backup file during migration
        """
    ...
    def family_sequence_number(self) -> Optional[builtins.int]:
        """
    ...
    def file_location(self) -> Optional[builtins.str]:
        """
...
class BackupSetInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 backup_finished_date: Optional[builtins.str] = None,
                 backup_set_id: Optional[builtins.str] = None,
                 backup_start_date: Optional[builtins.str] = None,
                 backup_type: Optional[builtins.str] = None,
                 database_name: Optional[builtins.str] = None,
                 first_lsn: Optional[builtins.str] = None,
                 is_backup_restored: Optional[builtins.bool] = None,
                 last_lsn: Optional[builtins.str] = None,
                 last_modified_time: Optional[builtins.str] = None,
                 list_of_backup_files: Optional[Sequence['outputs.BackupFileInfoResponse']] = None):
        """
        Information of backup set
        :param builtins.str backup_finished_date: Date and time that the backup operation finished
        :param builtins.str backup_set_id: Id for the set of backup files
        :param builtins.str backup_start_date: Date and time that the backup operation began
        :param builtins.str backup_type: Enum of the different backup types
        :param builtins.str database_name: Name of the database to which the backup set belongs
        :param builtins.str first_lsn: First log sequence number of the backup file
        :param builtins.bool is_backup_restored: Whether the backup set is restored or not
        :param builtins.str last_lsn: Last log sequence number of the backup file
        :param builtins.str last_modified_time: Last modified time of the backup file in share location
    ...
    def backup_finished_date(self) -> Optional[builtins.str]:
        """
    ...
    def backup_set_id(self) -> Optional[builtins.str]:
        """
    ...
    def backup_start_date(self) -> Optional[builtins.str]:
        """
    ...
    def first_lsn(self) -> Optional[builtins.str]:
        """
    ...
    def is_backup_restored(self) -> Optional[builtins.bool]:
        """
    ...
    def last_lsn(self) -> Optional[builtins.str]:
        """
...
class BlobShareResponse(dict):
    ...
    def __init__(__self__, *,
                 sas_uri: Optional[builtins.str] = None):
        """
        Blob container storage information.
        :param builtins.str sas_uri: SAS URI of Azure Storage Account Container.
        """
    ...
    def sas_uri(self) -> Optional[builtins.str]:
        """
...
class ConnectToMongoDbTaskPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 client_data: Optional[Mapping[str, builtins.str]] = None,
        ...
        :param builtins.str state: The state of the task. This is ignored if submitted.
        :param builtins.str task_type: Task type.
               Expected value is 'Connect.MongoDb'.
        :param Mapping[str, builtins.str] client_data: Key value pairs of client data to attach meta data information to task
    ...
    def client_data(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ConnectToSourceMySqlTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 check_permissions_group: Optional[builtins.str] = None,
                 is_offline_migration: Optional[builtins.bool] = None,
        ...
        :param builtins.str check_permissions_group: Permission group for validations
        :param builtins.bool is_offline_migration: Flag for whether or not the migration is offline
        :param builtins.str target_platform: Target Platform for the migration
        """
    ...
    def check_permissions_group(self) -> Optional[builtins.str]:
        """
    ...
    def is_offline_migration(self) -> Optional[builtins.bool]:
        """
...
class ConnectToSourceNonSqlTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_server_brand_version: builtins.str,
                 validation_errors: Sequence['outputs.ReportableExceptionResponse']):
        """
        Output for connect to MySQL type source
        :param Sequence[builtins.str] databases: List of databases on the server
        :param builtins.str id: Result identifier
        :param 'ServerPropertiesResponse' server_properties: Server properties
        :param builtins.str source_server_brand_version: Server brand version
    ...
    def source_server_brand_version(self) -> builtins.str:
        """
...
class ConnectToSourceOracleSyncTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
                 databases: Sequence[builtins.str],
                 source_server_brand_version: builtins.str,
                 source_server_version: builtins.str,
                 validation_errors: Sequence['outputs.ReportableExceptionResponse']):
        """
        Output for the task that validates Oracle database connection
        :param Sequence[builtins.str] databases: List of schemas on source server
        :param builtins.str source_server_brand_version: Source server brand version
        :param builtins.str source_server_version: Version of the source server
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors associated with the task
        """
        pulumi.set(__self__, "databases", databases)
        pulumi.set(__self__, "source_server_brand_version", source_server_brand_version)
    ...
    def source_server_version(self) -> builtins.str:
        """
...
class ConnectToSourcePostgreSqlSyncTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Output for the task that validates connection to PostgreSQL and source server requirements
        :param Sequence[builtins.str] databases: List of databases on source server
        :param builtins.str id: Result identifier
        :param builtins.str source_server_brand_version: Source server brand version
        :param builtins.str source_server_version: Version of the source server
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors associated with the task
...
class ConnectToSourceSqlServerTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 check_permissions_group: Optional[builtins.str] = None,
                 collect_agent_jobs: Optional[builtins.bool] = None,
                 collect_databases: Optional[builtins.bool] = None,
                 collect_logins: Optional[builtins.bool] = None,
                 collect_tde_certificate_info: Optional[builtins.bool] = None,
                 encrypted_key_for_secure_fields: Optional[builtins.str] = None,
                 validate_ssis_catalog_only: Optional[builtins.bool] = None):
        """
        Input for the task that validates connection to SQL Server and also validates source server requirements
        :param 'SqlConnectionInfoResponse' source_connection_info: Connection information for Source SQL Server
        :param builtins.str check_permissions_group: Permission group for validations
        :param builtins.bool collect_agent_jobs: Flag for whether to collect agent jobs from source server.
        :param builtins.bool collect_databases: Flag for whether to collect databases from source server.
        :param builtins.bool collect_logins: Flag for whether to collect logins from source server.
        :param builtins.bool collect_tde_certificate_info: Flag for whether to collect TDE Certificate names from source server.
        :param builtins.str encrypted_key_for_secure_fields: encrypted key for secure fields
        :param builtins.bool validate_ssis_catalog_only: Flag for whether to validate SSIS catalog is reachable on the source server.
        """
        pulumi.set(__self__, "source_connection_info", source_connection_info)
        if check_permissions_group is not None:
            pulumi.set(__self__, "check_permissions_group", check_permissions_group)
    ...
    def collect_agent_jobs(self) -> Optional[builtins.bool]:
        """
    ...
    def collect_databases(self) -> Optional[builtins.bool]:
        """
    ...
    def collect_logins(self) -> Optional[builtins.bool]:
        """
    ...
    def collect_tde_certificate_info(self) -> Optional[builtins.bool]:
        """
    ...
    def encrypted_key_for_secure_fields(self) -> Optional[builtins.str]:
        """
    ...
    def validate_ssis_catalog_only(self) -> Optional[builtins.bool]:
        """
...
class ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 job_category: builtins.str,
                 job_owner: builtins.str,
                 last_executed_on: builtins.str,
        ...
        Agent Job level output for the task that validates connection to SQL Server and also validates source server requirements
        :param builtins.str id: Result identifier
        :param builtins.bool is_enabled: The state of the original Agent Job.
        :param builtins.str job_category: The type of Agent Job.
        :param builtins.str job_owner: The owner of the Agent Job
        :param builtins.str last_executed_on: UTC Date and time when the Agent Job was last executed.
        :param 'MigrationEligibilityInfoResponse' migration_eligibility: Information about eligibility of agent job for migration.
        :param builtins.str name: Agent Job name
        :param builtins.str result_type: Type of result - database level or task level
    ...
    def job_category(self) -> builtins.str:
        """
    ...
    def last_executed_on(self) -> builtins.str:
        """
...
class ConnectToSourceSqlServerTaskOutputDatabaseLevelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Database level output for the task that validates connection to SQL Server and also validates source server requirements
        :param builtins.str compatibility_level: SQL Server compatibility level of database
        :param Sequence['DatabaseFileInfoResponse'] database_files: The list of database files
        :param builtins.str database_state: State of the database
        :param builtins.str id: Result identifier
        :param builtins.str name: Database name
        :param builtins.str result_type: Type of result - database level or task level
               Expected value is 'DatabaseLevelOutput'.
        :param builtins.float size_mb: Size of the file in megabytes
        """
    ...
    def database_state(self) -> builtins.str:
        """
...
class ConnectToSourceSqlServerTaskOutputLoginLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 is_enabled: builtins.bool,
                 login_type: builtins.str,
                 migration_eligibility: 'outputs.MigrationEligibilityInfoResponse',
                 name: builtins.str,
                 result_type: builtins.str):
        """
        Login level output for the task that validates connection to SQL Server and also validates source server requirements
        :param builtins.str default_database: The default database for the login.
        :param builtins.str id: Result identifier
        :param builtins.bool is_enabled: The state of the login.
        :param builtins.str login_type: The type of login.
        :param 'MigrationEligibilityInfoResponse' migration_eligibility: Information about eligibility of login for migration.
        :param builtins.str name: Login name.
        :param builtins.str result_type: Type of result - database level or task level
    ...
    def login_type(self) -> builtins.str:
        """
        The type of login.
        """
...
class ConnectToSourceSqlServerTaskOutputTaskLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 agent_jobs: Mapping[str, builtins.str],
                 database_tde_certificate_mapping: Mapping[str, builtins.str],
                 databases: Mapping[str, builtins.str],
                 id: builtins.str,
                 logins: Mapping[str, builtins.str],
                 result_type: builtins.str,
                 source_server_brand_version: builtins.str,
                 source_server_version: builtins.str,
                 validation_errors: Sequence['outputs.ReportableExceptionResponse']):
        """
        Task level output for the task that validates connection to SQL Server and also validates source server requirements
        :param Mapping[str, builtins.str] agent_jobs: Source agent jobs as a map from agent job name to id.
        :param Mapping[str, builtins.str] database_tde_certificate_mapping: Mapping from database name to TDE certificate name, if applicable
        :param Mapping[str, builtins.str] databases: Source databases as a map from database name to database id
        :param builtins.str id: Result identifier
        :param Mapping[str, builtins.str] logins: Source logins as a map from login name to login id.
        :param builtins.str result_type: Type of result - database level or task level
               Expected value is 'TaskLevelOutput'.
        :param builtins.str source_server_brand_version: Source server brand version
        :param builtins.str source_server_version: Source server version
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors
        """
    ...
    def agent_jobs(self) -> Mapping[str, builtins.str]:
        """
    ...
    def database_tde_certificate_mapping(self) -> Mapping[str, builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def logins(self) -> Mapping[str, builtins.str]:
        """
...
class ConnectToTargetAzureDbForMySqlTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_server_brand_version: builtins.str,
                 validation_errors: Sequence['outputs.ReportableExceptionResponse']):
        """
        Output for the task that validates connection to Azure Database for MySQL and target server requirements
        :param Sequence[builtins.str] databases: List of databases on target server
        :param builtins.str id: Result identifier
        :param builtins.str server_version: Version of the target server
        :param builtins.str target_server_brand_version: Target server brand version
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors associated with the task
        """
        pulumi.set(__self__, "databases", databases)
        pulumi.set(__self__, "id", id)
    ...
    def target_server_brand_version(self) -> builtins.str:
        """
...
class ConnectToTargetAzureDbForPostgreSqlSyncTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 target_server_brand_version: builtins.str,
                 target_server_version: builtins.str,
                 validation_errors: Sequence['outputs.ReportableExceptionResponse']):
        """
        Output for the task that validates connection to Azure Database for PostgreSQL and target server requirements
        :param Sequence[builtins.str] databases: List of databases on target server
        :param builtins.str id: Result identifier
        :param builtins.str target_server_brand_version: Target server brand version
        :param builtins.str target_server_version: Version of the target server
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors associated with the task
        """
        pulumi.set(__self__, "databases", databases)
        pulumi.set(__self__, "id", id)
    ...
    def target_server_version(self) -> builtins.str:
        """
        Version of the target server
        """
...
class ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutputResponseDatabaseSchemaMap(dict):
    def __init__(__self__, *,
                 ...
                 schemas: Optional[Sequence[builtins.str]] = None):
    ...
    @property
    @pulumi.getter
    def schemas(self) -> Optional[Sequence[builtins.str]]:
...
class ConnectToTargetSqlDbTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 query_object_counts: Optional[builtins.bool] = None):
        """
        Input for the task that validates connection to SQL DB and target server requirements
        :param 'SqlConnectionInfoResponse' target_connection_info: Connection information for target SQL DB
        :param builtins.bool query_object_counts: Boolean flag indicating whether to query object counts for each database on the target server
        """
        pulumi.set(__self__, "target_connection_info", target_connection_info)
    ...
    def query_object_counts(self) -> Optional[builtins.bool]:
        """
...
class ConnectToTargetSqlDbTaskPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] client_data: Key value pairs of client data to attach meta data information to task
        :param builtins.str created_on: DateTime in UTC when the task was created
...
class ConnectToTargetSqlMISyncTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Output for the task that validates connection to Azure SQL Database Managed Instance.
        :param builtins.str target_server_brand_version: Target server brand version
        :param builtins.str target_server_version: Target server version
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors
        """
        pulumi.set(__self__, "target_server_brand_version", target_server_brand_version)
        pulumi.set(__self__, "target_server_version", target_server_version)
...
class ConnectToTargetSqlMITaskInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool collect_agent_jobs: Flag for whether to collect agent jobs from target SQL MI server.
        :param builtins.bool collect_logins: Flag for whether to collect logins from target SQL MI server.
        :param builtins.bool validate_ssis_catalog_only: Flag for whether to validate SSIS catalog is reachable on the target SQL MI server.
        """
        pulumi.set(__self__, "target_connection_info", target_connection_info)
        if collect_agent_jobs is None:
...
class ConnectToTargetSqlMITaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
                 agent_jobs: Sequence[builtins.str],
                 id: builtins.str,
                 logins: Sequence[builtins.str],
                 target_server_brand_version: builtins.str,
                 target_server_version: builtins.str,
                 validation_errors: Sequence['outputs.ReportableExceptionResponse']):
        """
        Output for the task that validates connection to Azure SQL Database Managed Instance.
        :param Sequence[builtins.str] agent_jobs: List of agent jobs on the target server.
        :param builtins.str id: Result identifier
        :param Sequence[builtins.str] logins: List of logins on the target server.
        :param builtins.str target_server_brand_version: Target server brand version
        :param builtins.str target_server_version: Target server version
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors
        """
    ...
    @property
    @pulumi.getter(name="agentJobs")
    def agent_jobs(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def logins(self) -> Sequence[builtins.str]:
        """
...
class CopyProgressDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str parallel_copy_type: Type of parallel copy (Dynamic range, Physical partition, none).
        :param builtins.float rows_copied: Rows Copied
        :param builtins.float rows_read: Rows read
        :param builtins.str status: Status of the Copy activity (InProgress, Succeeded, Failed, Canceled).
        :param builtins.str table_name: Table Name
        :param builtins.int used_parallel_copies: The degree of parallelization.
        """
    ...
    def copy_start(self) -> builtins.str:
        """
        Copy Start
        """
    ...
    def parallel_copy_type(self) -> builtins.str:
        """
    ...
    def used_parallel_copies(self) -> builtins.int:
        """
...
class DataIntegrityValidationResultResponse(dict):
    ...
    def __init__(__self__, *,
                 failed_objects: Optional[Mapping[str, builtins.str]] = None,
                 validation_errors: Optional['outputs.ValidationErrorResponse'] = None):
        """
        Results for checksum based Data Integrity validation results
        :param Mapping[str, builtins.str] failed_objects: List of failed table names of source and target pair
    ...
    def failed_objects(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class DatabaseBackupInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 backup_files: Sequence[builtins.str],
                 backup_finish_date: builtins.str,
                 backup_type: builtins.str,
                 database_name: builtins.str,
                 family_count: builtins.int,
                 is_compressed: builtins.bool,
                 is_damaged: builtins.bool,
                 position: builtins.int):
        """
        Information about backup files when existing backup mode is used.
        :param Sequence[builtins.str] backup_files: The list of backup files for the current database.
        :param builtins.str backup_finish_date: Date and time when the backup operation finished.
        :param builtins.str backup_type: Backup Type.
        :param builtins.str database_name: Database name.
        :param builtins.int family_count: Number of files in the backup set.
        :param builtins.bool is_compressed: Whether the backup set is compressed
        :param builtins.bool is_damaged: Database was damaged when backed up, but the backup operation was requested to continue despite errors.
        :param builtins.int position: Position of current database backup in the file.
        """
    ...
    def backup_files(self) -> Sequence[builtins.str]:
        """
    ...
    def is_damaged(self) -> builtins.bool:
        """
...
class DatabaseFileInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 logical_name: Optional[builtins.str] = None,
                 physical_full_name: Optional[builtins.str] = None,
                 restore_full_name: Optional[builtins.str] = None,
                 size_mb: Optional[builtins.float] = None):
        """
        Database file specific information
        :param builtins.str database_name: Name of the database
        :param builtins.str file_type: Database file type
        :param builtins.str id: Unique identifier for database file
        :param builtins.str logical_name: Logical name of the file
        :param builtins.str physical_full_name: Operating-system full path of the file
        :param builtins.str restore_full_name: Suggested full path of the file for restoring
        :param builtins.float size_mb: Size of the file in megabytes
        """
        if database_name is not None:
            pulumi.set(__self__, "database_name", database_name)
    ...
    def logical_name(self) -> Optional[builtins.str]:
        """
    ...
    def physical_full_name(self) -> Optional[builtins.str]:
        """
    ...
    def restore_full_name(self) -> Optional[builtins.str]:
        """
...
class DatabaseInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Project Database Details
        :param builtins.str source_database_name: Name of the database
        """
...
class DatabaseMigrationPropertiesSqlDbResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 table_list: Optional[Sequence[builtins.str]] = None,
        ...
        :param Sequence[builtins.str] table_list: List of tables to copy.
    ...
    def table_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
class FileShareResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        File share information with Path, Username, and Password.
        :param builtins.str path: The folder path for this share.
        :param builtins.str password: Password credential used to connect to the share location.
        :param builtins.str user_name: User name credential to connect to the share location
        """
...
class GetTdeCertificatesSqlTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
                 base64_encoded_certificates: Mapping[str, Sequence[builtins.str]],
                 validation_errors: Sequence['outputs.ReportableExceptionResponse']):
        """
        Output of the task that gets TDE certificates in Base64 encoded format.
        :param Mapping[str, Sequence[builtins.str]] base64_encoded_certificates: Mapping from certificate name to base 64 encoded format.
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors
        """
    ...
    def base64_encoded_certificates(self) -> Mapping[str, Sequence[builtins.str]]:
        """
...
class GetUserTablesMySqlTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 selected_databases: Sequence[builtins.str]):
        """
        Input for the task that collects user tables for the given list of databases
        :param 'MySqlConnectionInfoResponse' connection_info: Connection information for SQL Server
        :param Sequence[builtins.str] selected_databases: List of database names to collect tables for
        """
        pulumi.set(__self__, "connection_info", connection_info)
    ...
    def selected_databases(self) -> Sequence[builtins.str]:
        """
...
class GetUserTablesOracleTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 selected_schemas: Sequence[builtins.str]):
        """
        Input for the task that gets the list of tables contained within a provided list of Oracle schemas.
        :param 'OracleConnectionInfoResponse' connection_info: Information for connecting to Oracle source
        :param Sequence[builtins.str] selected_schemas: List of Oracle schemas for which to collect tables
        """
        pulumi.set(__self__, "connection_info", connection_info)
    ...
    def selected_schemas(self) -> Sequence[builtins.str]:
        """
...
class GetUserTablesOracleTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Output for the task that gets the list of tables contained within a provided list of Oracle schemas.
        :param builtins.str schema_name: The schema this result is for
...
class GetUserTablesPostgreSqlTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] selected_databases: List of PostgreSQL databases for which to collect tables
        """
        pulumi.set(__self__, "connection_info", connection_info)
        pulumi.set(__self__, "selected_databases", selected_databases)
...
class GetUserTablesPostgreSqlTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Output for the task that gets the list of tables for a provided list of PostgreSQL databases.
        :param builtins.str database_name: The database this result is for
...
class GetUserTablesSqlSyncTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 selected_source_databases: Sequence[builtins.str],
                 selected_target_databases: Sequence[builtins.str],
                 source_connection_info: 'outputs.SqlConnectionInfoResponse',
                 target_connection_info: 'outputs.SqlConnectionInfoResponse'):
        """
        Input for the task that collects user tables for the given list of databases
        :param Sequence[builtins.str] selected_source_databases: List of source database names to collect tables for
        :param Sequence[builtins.str] selected_target_databases: List of target database names to collect tables for
    ...
    def selected_source_databases(self) -> Sequence[builtins.str]:
        """
    ...
    def selected_target_databases(self) -> Sequence[builtins.str]:
        """
...
class GetUserTablesSqlSyncTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 table_validation_errors: Mapping[str, Sequence[builtins.str]],
                 validation_errors: Sequence['outputs.ReportableExceptionResponse']):
        """
        Output of the task that collects user tables for the given list of databases
        ...
        :param Mapping[str, Sequence[builtins.str]] table_validation_errors: Mapping from database name to list of validation errors
        :param Sequence['ReportableExceptionResponse'] validation_errors: Validation errors
        """
    ...
    def table_validation_errors(self) -> Mapping[str, Sequence[builtins.str]]:
        """
...
class MiSqlConnectionInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 managed_instance_resource_id: builtins.str,
                 type: builtins.str,
                 password: Optional[builtins.str] = None,
                 user_name: Optional[builtins.str] = None):
        """
        Properties required to create a connection to Azure SQL database Managed instance
        :param builtins.str managed_instance_resource_id: Resource id for Azure SQL database Managed instance
        :param builtins.str type: Type of connection info
               Expected value is 'MiSqlConnectionInfo'.
        :param builtins.str password: Password credential.
    ...
    def managed_instance_resource_id(self) -> builtins.str:
        """
...
class MigrateMISyncCompleteCommandInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Input for command that completes online migration for an Azure SQL Database Managed Instance.
        :param builtins.str source_database_name: Name of managed instance database
        """
        pulumi.set(__self__, "source_database_name", source_database_name)
...
class MigrateMISyncCompleteCommandPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties for the command that completes online migration for an Azure SQL Database Managed Instance.
        :param builtins.str command_type: Command type.
        ...
        :param builtins.str state: The state of the command. This is ignored if submitted.
...
class MigrateMySqlAzureDbForMySqlOfflineDatabaseInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 table_map: Optional[Mapping[str, builtins.str]] = None,
                 target_database_name: Optional[builtins.str] = None):
        """
        Database specific information for offline MySQL to Azure Database for MySQL migration task inputs
        :param builtins.str name: Name of the database
        :param Mapping[str, builtins.str] table_map: Mapping of source to target tables
        :param builtins.str target_database_name: Name of target database. Note: Target database will be truncated before starting migration.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
    ...
    def table_map(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def target_database_name(self) -> Optional[builtins.str]:
        """
...
class MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_connection_info: 'outputs.MySqlConnectionInfoResponse',
                 encrypted_key_for_secure_fields: Optional[builtins.str] = None,
                 make_source_server_read_only: Optional[builtins.bool] = None,
                 optional_agent_settings: Optional[Mapping[str, builtins.str]] = None,
        ...
        :param builtins.str encrypted_key_for_secure_fields: encrypted key for secure fields
        :param builtins.bool make_source_server_read_only: Setting to set the source server read only
        :param Mapping[str, builtins.str] optional_agent_settings: Optional parameters for fine tuning the data transfer rate during migration
        :param builtins.str started_on: Parameter to specify when the migration started
        """
        pulumi.set(__self__, "selected_databases", selected_databases)
        pulumi.set(__self__, "source_connection_info", source_connection_info)
        pulumi.set(__self__, "target_connection_info", target_connection_info)
    ...
    def make_source_server_read_only(self) -> Optional[builtins.bool]:
        """
    ...
    def optional_agent_settings(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class MigrateMySqlAzureDbForMySqlOfflineTaskOutputDatabaseLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 database_name: builtins.str,
                 ended_on: builtins.str,
                 error_count: builtins.float,
                 error_prefix: builtins.str,
                 exceptions_and_warnings: Sequence['outputs.ReportableExceptionResponse'],
                 id: builtins.str,
                 last_storage_update: builtins.str,
                 message: builtins.str,
                 number_of_objects: builtins.float,
                 number_of_objects_completed: builtins.float,
        ...
        :param builtins.str database_name: Name of the database
        :param builtins.str ended_on: Migration end time
        :param builtins.float error_count: Number of database/object errors.
        :param builtins.str error_prefix: Wildcard string prefix to use for querying all errors of the item
        :param Sequence['ReportableExceptionResponse'] exceptions_and_warnings: Migration exceptions and warnings.
        :param builtins.str id: Result identifier
        :param builtins.str last_storage_update: Last time the storage was updated
        :param builtins.str message: Migration progress message
        :param builtins.float number_of_objects: Number of objects
        :param builtins.float number_of_objects_completed: Number of successfully completed objects
        :param Mapping[str, 'DataItemMigrationSummaryResultResponse'] object_summary: Summary of object results in the migration
        :param builtins.str result_prefix: Wildcard string prefix to use for querying all sub-tem results of the item
        :param builtins.str result_type: Result type
               Expected value is 'DatabaseLevelOutput'.
        :param builtins.str stage: Migration stage that this database is in
        :param builtins.str started_on: Migration start time
        :param builtins.str state: Current state of migration
        :param builtins.str status_message: Status message
        """
    ...
    def error_count(self) -> builtins.float:
        """
    ...
    def last_storage_update(self) -> builtins.str:
        """
    ...
    def number_of_objects(self) -> builtins.float:
        """
        Number of objects
        """
    ...
    def number_of_objects_completed(self) -> builtins.float:
        """
...
class MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 duration_in_seconds: builtins.float,
                 ended_on: builtins.str,
                 exceptions_and_warnings: Sequence['outputs.ReportableExceptionResponse'],
                 id: builtins.str,
                 last_storage_update: builtins.str,
                 ...
                 target_server_brand_version: builtins.str,
                 target_server_version: builtins.str,
                 databases: Optional[Mapping[str, builtins.str]] = None,
        ...
        :param builtins.float duration_in_seconds: Duration of task execution in seconds.
        :param builtins.str ended_on: Migration end time
        :param Sequence['ReportableExceptionResponse'] exceptions_and_warnings: Migration exceptions and warnings.
        :param builtins.str id: Result identifier
        :param builtins.str last_storage_update: Last time the storage was updated
        ...
        :param builtins.str source_server_version: Source server version
        :param builtins.str started_on: Migration start time
        :param builtins.str status: Current status of migration
        :param builtins.str status_message: Migration status message
        :param builtins.str target_server_brand_version: Target server brand version
        :param builtins.str target_server_version: Target server version
        :param Mapping[str, builtins.str] databases: Selected databases as a map from database name to database id
    ...
    def duration_in_seconds(self) -> builtins.float:
        """
    ...
    @property
    @pulumi.getter
    def databases(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class MigrateMySqlAzureDbForMySqlOfflineTaskOutputTableLevelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.float items_count: Number of items
        :param builtins.str last_storage_update: Last time the storage was updated
        :param builtins.str object_name: Name of the item
        :param builtins.str result_prefix: Wildcard string prefix to use for querying all sub-tem results of the item
        :param builtins.str result_type: Result type
...
class MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_cloneable: Optional[builtins.bool] = None,
                 task_id: Optional[builtins.str] = None):
        """
        Properties for the task that migrates MySQL databases to Azure Database for MySQL for offline migrations
        :param Sequence[Union['MigrateMISyncCompleteCommandPropertiesResponse', 'MigrateSyncCompleteCommandPropertiesResponse']] commands: Array of command properties.
        ...
        :param builtins.bool is_cloneable: whether the task can be cloned or not
        :param builtins.str task_id: Task id 
        """
        pulumi.set(__self__, "commands", commands)
        pulumi.set(__self__, "errors", errors)
    ...
    def is_cloneable(self) -> Optional[builtins.bool]:
        """
...
class MigrateMySqlAzureDbForMySqlSyncDatabaseInputResponse(dict):
    ...
    def __init__(__self__, *,
                 migration_setting: Optional[Mapping[str, builtins.str]] = None,
                 name: Optional[builtins.str] = None,
                 source_setting: Optional[Mapping[str, builtins.str]] = None,
                 table_map: Optional[Mapping[str, builtins.str]] = None,
                 target_database_name: Optional[builtins.str] = None,
                 target_setting: Optional[Mapping[str, builtins.str]] = None):
        """
        Database specific information for MySQL to Azure Database for MySQL migration task inputs
        :param Mapping[str, builtins.str] migration_setting: Migration settings which tune the migration behavior
        :param builtins.str name: Name of the database
        :param Mapping[str, builtins.str] source_setting: Source settings to tune source endpoint migration behavior
        :param Mapping[str, builtins.str] table_map: Mapping of source to target tables
        :param builtins.str target_database_name: Name of target database. Note: Target database will be truncated before starting migration.
        :param Mapping[str, builtins.str] target_setting: Target settings to tune target endpoint migration behavior
        """
    ...
    def migration_setting(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def source_setting(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def target_setting(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 applied_changes: builtins.float,
                 cdc_delete_counter: builtins.float,
                 cdc_insert_counter: builtins.float,
                 cdc_update_counter: builtins.float,
                 database_name: builtins.str,
                 ended_on: builtins.str,
                 full_load_completed_tables: builtins.float,
                 full_load_errored_tables: builtins.float,
                 full_load_loading_tables: builtins.float,
                 full_load_queued_tables: builtins.float,
                 id: builtins.str,
                 incoming_changes: builtins.float,
                 initialization_completed: builtins.bool,
                 latency: builtins.float,
                 migration_state: builtins.str,
                 result_type: builtins.str,
                 started_on: builtins.str):
        """
        :param builtins.float applied_changes: Number of applied changes
        :param builtins.float cdc_delete_counter: Number of cdc deletes
        :param builtins.float cdc_insert_counter: Number of cdc inserts
        :param builtins.float cdc_update_counter: Number of cdc updates
        :param builtins.str database_name: Name of the database
        :param builtins.str ended_on: Migration end time
        :param builtins.float full_load_completed_tables: Number of tables completed in full load
        :param builtins.float full_load_errored_tables: Number of tables errored in full load
        :param builtins.float full_load_loading_tables: Number of tables loading in full load
        :param builtins.float full_load_queued_tables: Number of tables queued in full load
        :param builtins.str id: Result identifier
        :param builtins.float incoming_changes: Number of incoming changes
        :param builtins.bool initialization_completed: Indicates if initial load (full load) has been completed
        :param builtins.float latency: CDC apply latency
        :param builtins.str migration_state: Migration state that this database is in
        :param builtins.str result_type: Result type
               Expected value is 'DatabaseLevelOutput'.
        :param builtins.str started_on: Migration start time
        """
    ...
    def applied_changes(self) -> builtins.float:
        """
    ...
    def cdc_delete_counter(self) -> builtins.float:
        """
    ...
    def cdc_insert_counter(self) -> builtins.float:
        """
    ...
    def cdc_update_counter(self) -> builtins.float:
        """
    ...
    def full_load_completed_tables(self) -> builtins.float:
        """
    ...
    def full_load_errored_tables(self) -> builtins.float:
        """
    ...
    def full_load_loading_tables(self) -> builtins.float:
        """
    ...
    def full_load_queued_tables(self) -> builtins.float:
        """
    ...
    def incoming_changes(self) -> builtins.float:
        """
    ...
    def initialization_completed(self) -> builtins.bool:
        """
...
class MigrateMySqlAzureDbForMySqlSyncTaskOutputMigrationLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 result_type: builtins.str,
                 source_server: builtins.str,
                 source_server_version: builtins.str,
                 started_on: builtins.str,
                 target_server: builtins.str,
                 target_server_version: builtins.str):
        """
        :param builtins.str ended_on: Migration end time
        :param builtins.str id: Result identifier
        :param builtins.str result_type: Result type
               Expected value is 'MigrationLevelOutput'.
        :param builtins.str source_server: Source server name
        :param builtins.str source_server_version: Source server version
        :param builtins.str started_on: Migration start time
        :param builtins.str target_server: Target server name
        :param builtins.str target_server_version: Target server version
        """
        pulumi.set(__self__, "ended_on", ended_on)
        pulumi.set(__self__, "id", id)
    ...
    def source_server(self) -> builtins.str:
        """
        Source server name
        """
    ...
    def target_server(self) -> builtins.str:
        """
        Target server name
        """
...
class MigrateMySqlAzureDbForMySqlSyncTaskOutputTableLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 cdc_delete_counter: builtins.str,
                 cdc_insert_counter: builtins.str,
                 cdc_update_counter: builtins.str,
                 data_errors_counter: builtins.float,
                 database_name: builtins.str,
                 full_load_ended_on: builtins.str,
                 full_load_est_finish_time: builtins.str,
                 full_load_started_on: builtins.str,
                 full_load_total_rows: builtins.float,
                 id: builtins.str,
                 last_modified_time: builtins.str,
                 result_type: builtins.str,
                 state: builtins.str,
                 table_name: builtins.str,
                 total_changes_applied: builtins.float):
        """
        :param builtins.str cdc_delete_counter: Number of applied deletes
        :param builtins.str cdc_insert_counter: Number of applied inserts
        :param builtins.str cdc_update_counter: Number of applied updates
        :param builtins.float data_errors_counter: Number of data errors occurred
        :param builtins.str database_name: Name of the database
        :param builtins.str full_load_ended_on: Full load end time
        :param builtins.str full_load_est_finish_time: Estimate to finish full load
        :param builtins.str full_load_started_on: Full load start time
        :param builtins.float full_load_total_rows: Number of rows applied in full load
        :param builtins.str id: Result identifier
        :param builtins.str last_modified_time: Last modified time on target
        :param builtins.str result_type: Result type
               Expected value is 'TableLevelOutput'.
        :param builtins.str state: Current state of the table migration
        :param builtins.str table_name: Name of the table
        :param builtins.float total_changes_applied: Total number of applied changes
        """
        pulumi.set(__self__, "cdc_delete_counter", cdc_delete_counter)
        pulumi.set(__self__, "cdc_insert_counter", cdc_insert_counter)
        pulumi.set(__self__, "cdc_update_counter", cdc_update_counter)
    ...
    @property
    @pulumi.getter(name="cdcDeleteCounter")
    def cdc_delete_counter(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="cdcInsertCounter")
    def cdc_insert_counter(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="cdcUpdateCounter")
    def cdc_update_counter(self) -> builtins.str:
        """
    ...
    def data_errors_counter(self) -> builtins.float:
        """
    ...
    def full_load_ended_on(self) -> builtins.str:
        """
        Full load end time
        """
    ...
    def full_load_est_finish_time(self) -> builtins.str:
        """
    ...
    def full_load_started_on(self) -> builtins.str:
        """
    ...
    def full_load_total_rows(self) -> builtins.float:
        """
    ...
    def total_changes_applied(self) -> builtins.float:
        """
...
class MigrateOracleAzureDbPostgreSqlSyncDatabaseInputResponse(dict):
    ...
    def __init__(__self__, *,
                 case_manipulation: Optional[builtins.str] = None,
                 migration_setting: Optional[Mapping[str, builtins.str]] = None,
                 name: Optional[builtins.str] = None,
        ...
        """
        Database specific information for Oracle to Azure Database for PostgreSQL migration task inputs
        :param builtins.str case_manipulation: How to handle object name casing: either Preserve or ToLower
        :param Mapping[str, builtins.str] migration_setting: Migration settings which tune the migration behavior
        :param builtins.str name: Name of the migration pipeline
        :param builtins.str schema_name: Name of the source schema
        :param Mapping[str, builtins.str] source_setting: Source settings to tune source endpoint migration behavior
        :param Mapping[str, builtins.str] table_map: Mapping of source to target tables
        :param builtins.str target_database_name: Name of target database. Note: Target database will be truncated before starting migration.
        :param Mapping[str, builtins.str] target_setting: Target settings to tune target endpoint migration behavior
    ...
    def case_manipulation(self) -> Optional[builtins.str]:
        """
...
class MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 total_changes_applied: builtins.float):
        """
        :param builtins.float cdc_delete_counter: Number of applied deletes
        :param builtins.float cdc_insert_counter: Number of applied inserts
        :param builtins.float cdc_update_counter: Number of applied updates
        :param builtins.float data_errors_counter: Number of data errors occurred
        :param builtins.str database_name: Name of the database
        :param builtins.str full_load_ended_on: Full load end time
        :param builtins.str full_load_est_finish_time: Estimate to finish full load
...
class MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Selected tables for the migration
        :param builtins.str name: Name of the table to migrate
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputMigrationLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 result_type: builtins.str,
                 source_server: builtins.str,
                 source_server_type: builtins.str,
                 source_server_version: builtins.str,
                 started_on: builtins.str,
                 state: builtins.str,
                 target_server: builtins.str,
                 target_server_type: builtins.str,
                 target_server_version: builtins.str,
                 database_count: Optional[builtins.float] = None):
        """
        :param builtins.str ended_on: Migration end time
        :param builtins.str id: Result identifier
        :param builtins.str result_type: Result type
               Expected value is 'MigrationLevelOutput'.
        :param builtins.str source_server: Source server name
        :param builtins.str source_server_type: Source server type.
        :param builtins.str source_server_version: Source server version
        :param builtins.str started_on: Migration start time
        :param builtins.str state: Migration status
        :param builtins.str target_server: Target server name
        :param builtins.str target_server_type: Target server type.
        :param builtins.str target_server_version: Target server version
        :param builtins.float database_count: Number of databases to include
        """
        pulumi.set(__self__, "ended_on", ended_on)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "result_type", 'MigrationLevelOutput')
    ...
    def source_server_type(self) -> builtins.str:
        """
        Source server type.
        """
    ...
    def target_server_type(self) -> builtins.str:
        """
        Target server type.
        """
    ...
    def database_count(self) -> Optional[builtins.float]:
        """
...
class MigrateSqlServerSqlDbDatabaseInputResponse(dict):
    ...
    def __init__(__self__, *,
                 id: Optional[builtins.str] = None,
                 make_source_db_read_only: Optional[builtins.bool] = None,
                 name: Optional[builtins.str] = None,
        ...
        :param builtins.bool make_source_db_read_only: Whether to set database read only before migration
        :param builtins.str name: Name of the database
    ...
    def make_source_db_read_only(self) -> Optional[builtins.bool]:
        """
...
class MigrateSqlServerSqlDbSyncDatabaseInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Database specific information for SQL to Azure SQL DB sync migration task inputs
        :param builtins.str id: Unique identifier for database
        :param Mapping[str, builtins.str] migration_setting: Migration settings which tune the migration behavior
        :param builtins.str name: Name of database
        :param builtins.str schema_name: Schema name to be migrated
        :param Mapping[str, builtins.str] source_setting: Source settings to tune source endpoint migration behavior
        :param Mapping[str, builtins.str] table_map: Mapping of source to target tables
        :param builtins.str target_database_name: Target database name
        :param Mapping[str, builtins.str] target_setting: Target settings to tune target endpoint migration behavior
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class MigrateSqlServerSqlDbSyncTaskOutputMigrationLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_server_version: builtins.str):
        """
        :param builtins.int database_count: Count of databases
        :param builtins.str ended_on: Migration end time
        :param builtins.str id: Result identifier
        :param builtins.str result_type: Result type
               Expected value is 'MigrationLevelOutput'.
    ...
    @property
    @pulumi.getter(name="databaseCount")
    def database_count(self) -> builtins.int:
        """
        Count of databases
        """
        return pulumi.get(self, "database_count")
...
class MigrateSqlServerSqlDbTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SqlConnectionInfoResponse' target_connection_info: Information for connecting to target
        :param builtins.str encrypted_key_for_secure_fields: encrypted key for secure fields
        :param builtins.str started_on: Date and time relative to UTC when the migration was started on
...
class MigrateSqlServerSqlDbTaskOutputDatabaseLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 status_message: builtins.str):
        """
        :param builtins.str database_name: Name of the item
        :param builtins.str ended_on: Migration end time
        :param builtins.float error_count: Number of database/object errors.
        :param builtins.str error_prefix: Wildcard string prefix to use for querying all errors of the item
        :param Sequence['ReportableExceptionResponse'] exceptions_and_warnings: Migration exceptions and warnings.
...
class MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str ended_on: Validation end time
        :param builtins.str id: Result identifier
        :param builtins.str migration_id: Migration Identifier
        ...
        :param builtins.str source_database_name: Name of the source database
        :param builtins.str started_on: Validation start time
        :param builtins.str status: Current status of validation at the database level
        :param builtins.str target_database_name: Name of the target database
        """
...
class MigrateSqlServerSqlDbTaskOutputValidationResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: Migration validation result identifier
        :param builtins.str migration_id: Migration Identifier
        :param builtins.str result_type: Result type
               Expected value is 'MigrationValidationOutput'.
        :param builtins.str status: Current status of validation at the migration level. Status from the database validation result status will be aggregated here.
...
class MigrateSqlServerSqlMIDatabaseInputResponse(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 restore_database_name: builtins.str,
                 backup_file_paths: Optional[Sequence[builtins.str]] = None,
                 backup_file_share: Optional['outputs.FileShareResponse'] = None,
                 id: Optional[builtins.str] = None):
        """
        Database specific information for SQL to Azure SQL DB Managed Instance migration task inputs
        :param builtins.str name: Name of the database
        :param builtins.str restore_database_name: Name of the database at destination
        :param Sequence[builtins.str] backup_file_paths: The list of backup files to be used in case of existing backups.
    ...
    def restore_database_name(self) -> builtins.str:
        """
    ...
    def backup_file_paths(self) -> Optional[Sequence[builtins.str]]:
        """
...
class MigrateSqlServerSqlMISyncTaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_connection_info: 'outputs.MiSqlConnectionInfoResponse',
                 backup_file_share: Optional['outputs.FileShareResponse'] = None,
                 number_of_parallel_database_migrations: Optional[builtins.float] = None):
        """
        Input for task that migrates SQL Server databases to Azure SQL Database Managed Instance online scenario.
        :param 'AzureActiveDirectoryAppResponse' azure_app: Azure Active Directory Application the DMS (classic) instance will use to connect to the target instance of Azure SQL Database Managed Instance and the Azure Storage Account
        :param Sequence['MigrateSqlServerSqlMIDatabaseInputResponse'] selected_databases: Databases to migrate
        :param 'SqlConnectionInfoResponse' source_connection_info: Connection information for source SQL Server
        :param builtins.str storage_resource_id: Fully qualified resourceId of storage
        :param 'MiSqlConnectionInfoResponse' target_connection_info: Connection information for Azure SQL Database Managed Instance
        :param 'FileShareResponse' backup_file_share: Backup file share information for all selected databases.
        :param builtins.float number_of_parallel_database_migrations: Number of database migrations to start in parallel
        """
        pulumi.set(__self__, "azure_app", azure_app)
        pulumi.set(__self__, "selected_databases", selected_databases)
        pulumi.set(__self__, "source_connection_info", source_connection_info)
    ...
    def number_of_parallel_database_migrations(self) -> Optional[builtins.float]:
        """
...
class MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str container_name: Name of container created in the Azure Storage account where backups are copied to
        :param builtins.str ended_on: Database migration end time
        :param builtins.str error_prefix: prefix string to use for querying errors for this database
        :param Sequence['ReportableExceptionResponse'] exceptions_and_warnings: Migration exceptions and warnings
        ...
        :param builtins.str migration_state: Current state of database
        :param builtins.str result_type: Result type
               Expected value is 'DatabaseLevelOutput'.
        :param builtins.str source_database_name: Name of the database
        :param builtins.str started_on: Database migration start time
...
class MigrateSqlServerSqlMISyncTaskOutputMigrationLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 database_count: builtins.int,
                 database_error_count: builtins.int,
                 ended_on: builtins.str,
                 id: builtins.str,
                 result_type: builtins.str,
                 source_server_brand_version: builtins.str,
                 ...
                 state: builtins.str,
                 target_server_brand_version: builtins.str,
                 target_server_name: builtins.str,
                 target_server_version: builtins.str):
        """
        :param builtins.int database_count: Count of databases
        :param builtins.int database_error_count: Number of database level errors
        :param builtins.str ended_on: Migration end time
        :param builtins.str id: Result identifier
        :param builtins.str result_type: Result type
               Expected value is 'MigrationLevelOutput'.
        :param builtins.str source_server_brand_version: Source server brand version
        :param builtins.str source_server_name: Source server name
        :param builtins.str source_server_version: Source server version
        :param builtins.str started_on: Migration start time
        :param builtins.str state: Current state of migration
        :param builtins.str target_server_brand_version: Target server brand version
        :param builtins.str target_server_name: Target server name
        :param builtins.str target_server_version: Target server version
        """
        pulumi.set(__self__, "database_count", database_count)
    ...
    def database_error_count(self) -> builtins.int:
        """
    ...
    def target_server_name(self) -> builtins.str:
        """
        Target server name
        """
...
class MigrateSqlServerSqlMITaskInputResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_connection_info: 'outputs.SqlConnectionInfoResponse',
                 target_connection_info: 'outputs.SqlConnectionInfoResponse',
                 aad_domain_name: Optional[builtins.str] = None,
                 backup_file_share: Optional['outputs.FileShareResponse'] = None,
                 backup_mode: Optional[builtins.str] = None,
                 encrypted_key_for_secure_fields: Optional[builtins.str] = None,
                 selected_agent_jobs: Optional[Sequence[builtins.str]] = None,
                 selected_logins: Optional[Sequence[builtins.str]] = None,
                 started_on: Optional[builtins.str] = None):
        """
        Input for task that migrates SQL Server databases to Azure SQL Database Managed Instance.
        ...
        :param 'SqlConnectionInfoResponse' source_connection_info: Information for connecting to source
        :param 'SqlConnectionInfoResponse' target_connection_info: Information for connecting to target
        :param builtins.str aad_domain_name: Azure Active Directory domain name in the format of 'contoso.com' for federated Azure AD or 'contoso.onmicrosoft.com' for managed domain, required if and only if Windows logins are selected
        :param 'FileShareResponse' backup_file_share: Backup file share information for all selected databases.
        :param builtins.str backup_mode: Backup Mode to specify whether to use existing backup or create new backup. If using existing backups, backup file paths are required to be provided in selectedDatabases.
        :param builtins.str encrypted_key_for_secure_fields: encrypted key for secure fields
        :param Sequence[builtins.str] selected_agent_jobs: Agent Jobs to migrate.
        :param Sequence[builtins.str] selected_logins: Logins to migrate.
        :param builtins.str started_on: Date and time relative to UTC when the migration was started on
        """
    ...
    def aad_domain_name(self) -> Optional[builtins.str]:
        """
    ...
    def selected_agent_jobs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def selected_logins(self) -> Optional[Sequence[builtins.str]]:
        """
        Logins to migrate.
        """
...
class MigrateSqlServerSqlMITaskOutputDatabaseLevelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str result_type: Result type
               Expected value is 'DatabaseLevelOutput'.
        :param builtins.float size_mb: Size of the database in megabytes
        :param builtins.str stage: Current stage of migration
        :param builtins.str started_on: Migration start time
        :param builtins.str state: Current state of migration
        """
        pulumi.set(__self__, "database_name", database_name)
...
class MigrateSqlServerSqlMITaskOutputLoginLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 state: builtins.str):
        """
        :param builtins.str ended_on: Login migration end time
        :param Sequence['ReportableExceptionResponse'] exceptions_and_warnings: Login migration errors and warnings per login
        :param builtins.str id: Result identifier
        :param builtins.str login_name: Login name.
        :param builtins.str message: Login migration progress message
        :param builtins.str result_type: Result type
               Expected value is 'LoginLevelOutput'.
        :param builtins.str stage: Current stage of login
        :param builtins.str started_on: Login migration start time
        :param builtins.str state: Current state of login
        """
        pulumi.set(__self__, "ended_on", ended_on)
        pulumi.set(__self__, "exceptions_and_warnings", exceptions_and_warnings)
        pulumi.set(__self__, "id", id)
...
class MigrateSqlServerSqlMITaskOutputMigrationLevelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_server_version: builtins.str):
        """
        :param Mapping[str, builtins.str] agent_jobs: Selected agent jobs as a map from name to id
        :param Mapping[str, builtins.str] databases: Selected databases as a map from database name to database id
        :param builtins.str ended_on: Migration end time
        :param Sequence['ReportableExceptionResponse'] exceptions_and_warnings: Migration exceptions and warnings.
        :param builtins.str id: Result identifier
        :param Mapping[str, builtins.str] logins: Selected logins as a map from name to id
        :param builtins.str message: Migration progress message
...
class MigrateSqlServerSqlMITaskPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_cloneable: Optional[builtins.bool] = None,
                 parent_task_id: Optional[builtins.str] = None,
                 task_id: Optional[builtins.str] = None):
        """
        Properties for task that migrates SQL Server databases to Azure SQL Database Managed Instance
        :param Sequence[Union['MigrateMISyncCompleteCommandPropertiesResponse', 'MigrateSyncCompleteCommandPropertiesResponse']] commands: Array of command properties.
        ...
        :param builtins.bool is_cloneable: whether the task can be cloned or not
        :param builtins.str parent_task_id: parent task id
        :param builtins.str task_id: task id
        """
        pulumi.set(__self__, "commands", commands)
        pulumi.set(__self__, "errors", errors)
    ...
    def parent_task_id(self) -> Optional[builtins.str]:
        """
        parent task id
        """
...
class MigrateSsisTaskOutputMigrationLevelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str source_server_brand_version: Source server brand version
        :param builtins.str source_server_version: Source server version
        :param builtins.str stage: Stage of SSIS migration.
        :param builtins.str started_on: Migration start time
        :param builtins.str status: Current status of migration
        :param builtins.str target_server_brand_version: Target server brand version
        :param builtins.str target_server_version: Target server version
...
class MigrateSsisTaskOutputProjectLevelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str ended_on: Migration end time
        :param Sequence['ReportableExceptionResponse'] exceptions_and_warnings: Migration exceptions and warnings
        :param builtins.str folder_name: Name of the folder
        :param builtins.str id: Result identifier
        :param builtins.str message: Migration progress message
...
class MigrateSyncCompleteCommandInputResponse(dict):
    ...
    def __init__(__self__, *,
                 database_name: builtins.str,
                 commit_time_stamp: Optional[builtins.str] = None):
        """
        Input for command that completes sync migration for a database.
        :param builtins.str database_name: Name of database
        :param builtins.str commit_time_stamp: Time stamp to complete
        """
        pulumi.set(__self__, "database_name", database_name)
    ...
    def commit_time_stamp(self) -> Optional[builtins.str]:
        """
...
class MigrationEligibilityInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 is_eligible_for_migration: builtins.bool,
                 validation_messages: Sequence[builtins.str]):
        """
        Information about migration eligibility of a server object
        :param builtins.bool is_eligible_for_migration: Whether object is eligible for migration or not.
        :param Sequence[builtins.str] validation_messages: Information about eligibility failure for the server object.
        """
    ...
    def is_eligible_for_migration(self) -> builtins.bool:
        """
    ...
    def validation_messages(self) -> Sequence[builtins.str]:
        """
...
class MigrationReportResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Migration validation report result, contains the url for downloading the generated report.
        :param builtins.str id: Migration validation result identifier
        :param builtins.str report_url: The url of the report.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
    ...
    def report_url(self) -> Optional[builtins.str]:
        """
...
class MigrationValidationOptionsResponse(dict):
    ...
    def __init__(__self__, *,
                 enable_data_integrity_validation: Optional[builtins.bool] = None,
                 enable_query_analysis_validation: Optional[builtins.bool] = None,
                 enable_schema_validation: Optional[builtins.bool] = None):
        """
        Types of validations to run after the migration
        :param builtins.bool enable_data_integrity_validation: Allows to perform a checksum based data integrity validation between source and target for the selected database / tables .
        :param builtins.bool enable_query_analysis_validation: Allows to perform a quick and intelligent query analysis by retrieving queries from the source database and executes them in the target. The result will have execution statistics for executions in source and target databases for the extracted queries.
        :param builtins.bool enable_schema_validation: Allows to compare the schema information between source and target.
        """
    ...
    def enable_data_integrity_validation(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_query_analysis_validation(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_schema_validation(self) -> Optional[builtins.bool]:
        """
...
class MongoConnectionInformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Mongo Connection
        :param builtins.str host: Host of mongo connection.
        :param builtins.int port: Port of mongo connection.
        """
        if host is not None:
...
class MongoDbClusterInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 supports_sharding: builtins.bool,
                 type: builtins.str,
                 version: builtins.str):
        """
        Describes a MongoDB data source
        :param Sequence['MongoDbDatabaseInfoResponse'] databases: A list of non-system databases in the cluster
        :param builtins.bool supports_sharding: Whether the cluster supports sharded collections
        :param builtins.str type: The type of data source
        :param builtins.str version: The version of the data source in the form x.y.z (e.g. 3.6.7). Not used if Type is BlobContainer.
        """
        pulumi.set(__self__, "databases", databases)
    ...
    def supports_sharding(self) -> builtins.bool:
        """
...
class MongoDbCollectionInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 average_document_size: builtins.float,
                 data_size: builtins.float,
                 database_name: builtins.str,
                 document_count: builtins.float,
                 is_capped: builtins.bool,
                 is_system_collection: builtins.bool,
                 is_view: builtins.bool,
                 name: builtins.str,
                 qualified_name: builtins.str,
                 supports_sharding: builtins.bool,
                 shard_key: Optional['outputs.MongoDbShardKeyInfoResponse'] = None,
                 view_of: Optional[builtins.str] = None):
        """
        Describes a supported collection within a MongoDB database
        :param builtins.float average_document_size: The average document size, or -1 if the average size is unknown
        :param builtins.float data_size: The estimated total data size, in bytes, or -1 if the size is unknown.
        :param builtins.str database_name: The name of the database containing the collection
        :param builtins.float document_count: The estimated total number of documents, or -1 if the document count is unknown
        :param builtins.bool is_capped: Whether the collection is a capped collection (i.e. whether it has a fixed size and acts like a circular buffer)
        :param builtins.bool is_system_collection: Whether the collection is system collection
        :param builtins.bool is_view: Whether the collection is a view of another collection
        :param builtins.str name: The unqualified name of the database or collection
        :param builtins.str qualified_name: The qualified name of the database or collection. For a collection, this is the database-qualified name.
        :param builtins.bool supports_sharding: Whether the database has sharding enabled. Note that the migration task will enable sharding on the target if necessary.
        :param 'MongoDbShardKeyInfoResponse' shard_key: The shard key on the collection, or null if the collection is not sharded
        :param builtins.str view_of: The name of the collection that this is a view of, if IsView is true
        """
    ...
    def average_document_size(self) -> builtins.float:
        """
    ...
    def data_size(self) -> builtins.float:
        """
    ...
    def document_count(self) -> builtins.float:
        """
    ...
    def is_system_collection(self) -> builtins.bool:
        """
    ...
    def is_view(self) -> builtins.bool:
        """
    ...
    def view_of(self) -> Optional[builtins.str]:
        """
...
class MongoDbCollectionProgressResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 documents_copied: builtins.float,
                 elapsed_time: builtins.str,
                 errors: Mapping[str, 'outputs.MongoDbErrorResponse'],
                 events_pending: builtins.float,
                 events_replayed: builtins.float,
                 result_type: builtins.str,
                 state: builtins.str,
                 total_bytes: builtins.float,
                 total_documents: builtins.float,
                 last_event_time: Optional[builtins.str] = None,
                 last_replay_time: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 qualified_name: Optional[builtins.str] = None):
        """
        Describes the progress of a collection
        :param builtins.float bytes_copied: The number of document bytes copied during the Copying stage
        :param builtins.float documents_copied: The number of documents copied during the Copying stage
        :param builtins.str elapsed_time: The elapsed time in the format [ddd.]hh:mm:ss[.fffffff] (i.e. TimeSpan format)
        ...
        :param builtins.float events_pending: The number of oplog events awaiting replay
        :param builtins.float events_replayed: The number of oplog events replayed so far
        :param builtins.str result_type: The type of progress object
               Expected value is 'Collection'.
        :param builtins.float total_bytes: The total number of document bytes on the source at the beginning of the Copying stage, or -1 if the total size was unknown
        :param builtins.float total_documents: The total number of documents on the source at the beginning of the Copying stage, or -1 if the total count was unknown
        :param builtins.str last_event_time: The timestamp of the last oplog event received, or null if no oplog event has been received yet
        :param builtins.str last_replay_time: The timestamp of the last oplog event replayed, or null if no oplog event has been replayed yet
        :param builtins.str name: The name of the progress object. For a collection, this is the unqualified collection name. For a database, this is the database name. For the overall migration, this is null.
        :param builtins.str qualified_name: The qualified name of the progress object. For a collection, this is the database-qualified name. For a database, this is the database name. For the overall migration, this is null.
        """
    ...
    def documents_copied(self) -> builtins.float:
        """
    ...
    def elapsed_time(self) -> builtins.str:
        """
    ...
    def events_pending(self) -> builtins.float:
        """
    ...
    def events_replayed(self) -> builtins.float:
        """
    ...
    def total_documents(self) -> builtins.float:
        """
    ...
    def last_event_time(self) -> Optional[builtins.str]:
        """
    ...
    def last_replay_time(self) -> Optional[builtins.str]:
        """
...
class MongoDbCollectionSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_rus: Optional[builtins.int] = None):
        """
        Describes how an individual MongoDB collection should be migrated
        :param builtins.bool can_delete: Whether the migrator is allowed to drop the target collection in the course of performing a migration. The default is true.
        :param 'MongoDbShardKeySettingResponse' shard_key: Describes a MongoDB shard key
        :param builtins.int target_rus: The RUs that should be configured on a CosmosDB target, or null to use the default. This has no effect on non-CosmosDB targets.
        """
    ...
    def target_rus(self) -> Optional[builtins.int]:
        """
...
class MongoDbConnectionInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str,
                 additional_settings: Optional[builtins.str] = None,
                 authentication: Optional[builtins.str] = None,
                 data_source: Optional[builtins.str] = None,
                 encrypt_connection: Optional[builtins.bool] = None,
                 enforce_ssl: Optional[builtins.bool] = None,
                 password: Optional[builtins.str] = None,
                 port: Optional[builtins.int] = None,
                 server_brand_version: Optional[builtins.str] = None,
                 server_name: Optional[builtins.str] = None,
                 server_version: Optional[builtins.str] = None,
                 trust_server_certificate: Optional[builtins.bool] = None,
                 user_name: Optional[builtins.str] = None):
        """
        Describes a connection to a MongoDB data source
        :param builtins.str connection_string: A MongoDB connection string or blob container URL. The user name and password can be specified here or in the userName and password properties
        :param builtins.str type: Type of connection info
               Expected value is 'MongoDbConnectionInfo'.
        :param builtins.str additional_settings: Additional connection settings
        :param builtins.str authentication: Authentication type to use for connection
        :param builtins.str data_source: Data source 
        :param builtins.bool encrypt_connection: Whether to encrypt the connection
        :param builtins.str password: Password credential.
        :param builtins.int port: port for server
        :param builtins.str server_brand_version: server brand version
        :param builtins.str server_name: name of the server
        :param builtins.str server_version: server version
        :param builtins.bool trust_server_certificate: Whether to trust the server certificate
        :param builtins.str user_name: User name
        """
    ...
    def enforce_ssl(self) -> Optional[builtins.bool]:
...
class MongoDbDatabaseSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int target_rus: The RUs that should be configured on a CosmosDB target, or null to use the default, or 0 if throughput should not be provisioned for the database. This has no effect on non-CosmosDB targets.
        """
        pulumi.set(__self__, "collections", collections)
        if target_rus is not None:
            pulumi.set(__self__, "target_rus", target_rus)
...
class MongoDbErrorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes an error or warning that occurred during a MongoDB migration
        :param builtins.str code: The non-localized, machine-readable code that describes the error or warning
        :param builtins.int count: The number of times the error or warning has occurred
        :param builtins.str message: The localized, human-readable message that describes the error or warning
        :param builtins.str type: The type of error or warning
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
...
class MongoDbMigrationSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 boost_rus: Optional[builtins.int] = None,
        ...
        :param builtins.int boost_rus: The RU limit on a CosmosDB target that collections will be temporarily increased to (if lower) during the initial copy of a migration, from 10,000 to 1,000,000, or 0 to use the default boost (which is generally the maximum), or null to not boost the RUs. This setting has no effect on non-CosmosDB targets.
        :param builtins.str replication: Describes how changes will be replicated from the source to the target. The default is OneTime.
    ...
    def boost_rus(self) -> Optional[builtins.int]:
        """
...
class MongoDbShardKeyFieldResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str order: The field ordering
        """
        pulumi.set(__self__, "name", name)
...
class MongoDbShardKeyInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_unique: Whether the shard key is unique
        """
...
class MongoDbShardKeySettingResponse(dict):
    ...
    def __init__(__self__, *,
                 fields: Sequence['outputs.MongoDbShardKeyFieldResponse'],
                 is_unique: Optional[builtins.bool] = None):
        """
        Describes a MongoDB shard key
        :param Sequence['MongoDbShardKeyFieldResponse'] fields: The fields within the shard key
        :param builtins.bool is_unique: Whether the shard key is unique
    ...
    @property
    @pulumi.getter(name="isUnique")
    def is_unique(self) -> Optional[builtins.bool]:
        """
        Whether the shard key is unique
        """
        return pulumi.get(self, "is_unique")
...
class MongoDbThrottlingSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 min_free_cpu: Optional[builtins.int] = None,
                 min_free_memory_mb: Optional[builtins.int] = None):
        """
        Specifies resource limits for the migration
        :param builtins.int max_parallelism: The maximum number of work items (e.g. collection copies) that will be processed in parallel
        :param builtins.int min_free_cpu: The percentage of CPU time that the migrator will try to avoid using, from 0 to 100
        :param builtins.int min_free_memory_mb: The number of megabytes of RAM that the migrator will try to avoid using
        """
    ...
    def min_free_cpu(self) -> Optional[builtins.int]:
        """
    ...
    def min_free_memory_mb(self) -> Optional[builtins.int]:
        """
...
class MongoMigrationCollectionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_collection: Optional[builtins.str] = None,
                 source_database: Optional[builtins.str] = None,
                 target_collection: Optional[builtins.str] = None,
                 target_database: Optional[builtins.str] = None):
        """
        Mongo source and target database and collection details.
        :param 'MongoMigrationProgressDetailsResponse' migration_progress_details: Detailed migration status. Not included by default.
        :param builtins.str source_collection: Source collection name.
        :param builtins.str source_database: Source database name.
        :param builtins.str target_collection: Target collection name.
        :param builtins.str target_database: Target database name.
        """
    ...
    def source_collection(self) -> Optional[builtins.str]:
        """
    ...
    def source_database(self) -> Optional[builtins.str]:
        """
    ...
    def target_collection(self) -> Optional[builtins.str]:
        """
    ...
    def target_database(self) -> Optional[builtins.str]:
        """
        Target database name.
        """
...
class MongoMigrationProgressDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 migration_error: builtins.str,
                 migration_status: builtins.str,
                 processed_document_count: builtins.float,
                 source_document_count: builtins.float):
        """
        Detailed status of collection migration.
        :param builtins.int duration_in_seconds: Migration duration
        :param builtins.str migration_error: Migration Error
        :param builtins.str migration_status: Migration Status
        :param builtins.float processed_document_count: Processed Document Count
        :param builtins.float source_document_count: Source Document Count
        """
        pulumi.set(__self__, "duration_in_seconds", duration_in_seconds)
    ...
    def migration_error(self) -> builtins.str:
        """
        Migration Error
        """
    ...
    def processed_document_count(self) -> builtins.float:
        """
    ...
    def source_document_count(self) -> builtins.float:
        """
...
class NodeMonitoringDataResponse(dict):
    def __init__(__self__, *,
                 ...
                 available_memory_in_mb: builtins.int,
                 concurrent_jobs_limit: builtins.int,
                 concurrent_jobs_running: builtins.int,
                 cpu_utilization: builtins.int,
                 max_concurrent_jobs: builtins.int,
                 node_name: builtins.str,
                 received_bytes: builtins.float,
                 sent_bytes: builtins.float):
        """
        :param Mapping[str, Any] additional_properties:  Unmatched properties from the message are deserialized in this collection.
        :param builtins.int available_memory_in_mb: Available memory (MB) on the integration runtime node.
        :param builtins.int concurrent_jobs_limit: Maximum concurrent jobs on the integration runtime node.
        :param builtins.int concurrent_jobs_running: The number of jobs currently running on the integration runtime node.
        :param builtins.int cpu_utilization: CPU percentage on the integration runtime node.
        ...
        :param builtins.float received_bytes: Received bytes on the integration runtime node.
        :param builtins.float sent_bytes: Sent bytes on the integration runtime node.
        """
    ...
    def available_memory_in_mb(self) -> builtins.int:
        """
    ...
    def concurrent_jobs_running(self) -> builtins.int:
        """
    ...
    def cpu_utilization(self) -> builtins.int:
        """
    ...
    def received_bytes(self) -> builtins.float:
        """
    ...
    def sent_bytes(self) -> builtins.float:
        """
...
class ODataErrorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Error information in OData format.
        :param builtins.str code: The machine-readable description of the error, such as 'InvalidRequest' or 'InternalServerError'
        :param Sequence['ODataErrorResponse'] details: Inner errors that caused this error
        :param builtins.str message: The human-readable description of the error
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
...
class OracleConnectionInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information for connecting to Oracle server
        :param builtins.str data_source: EZConnect or TNSName connection string.
        :param builtins.str type: Type of connection info
...
class OrphanedUserInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information of orphaned users on the SQL server database.
        :param builtins.str database_name: Parent database of the user
        :param builtins.str name: Name of the orphaned user
        """
        if database_name is not None:
            pulumi.set(__self__, "database_name", database_name)
        if name is not None:
...
class SqlConnectionInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information for connecting to SQL database server
        :param builtins.str data_source: Data source in the format Protocol:MachineName\\SQLServerInstanceName,PortNumber
        :param builtins.str type: Type of connection info
        ...
        :param builtins.bool encrypt_connection: Whether to encrypt the connection
        :param builtins.str password: Password credential.
        :param builtins.str platform: Server platform type for connection
        :param builtins.int port: Port for Server
        :param builtins.str resource_id: Represents the ID of an HTTP resource represented by an Azure resource provider.
        :param builtins.str server_brand_version: server brand version
        :param builtins.str server_name: name of the server
        :param builtins.str server_version: server version
        :param builtins.bool trust_server_certificate: Whether to trust the server certificate
...
class SqlConnectionInformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Source SQL Connection
        :param builtins.str authentication: Authentication type.
        :param builtins.str data_source: Data source.
        :param builtins.bool encrypt_connection: Whether to encrypt connection or not.
        :param builtins.str password: Password to connect to source SQL.
        :param builtins.bool trust_server_certificate: Whether to trust server certificate or not.
        :param builtins.str user_name: User name to connect to source SQL.
        """
        if authentication is not None:
            pulumi.set(__self__, "authentication", authentication)
        if data_source is not None:
...
class SqlDbMigrationStatusDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 migration_state: builtins.str,
                 sql_data_copy_errors: Sequence[builtins.str]):
        """
        Detailed status of current Sql Db migration.
        ...
        :param Sequence[builtins.str] sql_data_copy_errors: Sql Data Copy errors, if any.
        """
    ...
    def sql_data_copy_errors(self) -> Sequence[builtins.str]:
        """
...
class SsisMigrationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 environment_overwrite_option: Optional[builtins.str] = None,
                 project_overwrite_option: Optional[builtins.str] = None,
                 ssis_store_type: Optional[builtins.str] = None):
        """
        SSIS migration info with SSIS store type, overwrite policy.
        :param builtins.str environment_overwrite_option: The overwrite option for the SSIS environment migration
        :param builtins.str project_overwrite_option: The overwrite option for the SSIS project migration
        :param builtins.str ssis_store_type: The SSIS store type of source, only SSIS catalog is supported now in DMS (classic)
        """
    ...
    def environment_overwrite_option(self) -> Optional[builtins.str]:
        """
    ...
    def project_overwrite_option(self) -> Optional[builtins.str]:
        """
    ...
    def ssis_store_type(self) -> Optional[builtins.str]:
        """
...
class StartMigrationScenarioServerRoleResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Server role migration result
        :param Sequence['ReportableExceptionResponse'] exceptions_and_warnings: Migration exceptions and warnings.
        :param builtins.str name: Name of server role.
        :param builtins.str state: Current state of migration
        """
        pulumi.set(__self__, "exceptions_and_warnings", exceptions_and_warnings)
        pulumi.set(__self__, "name", name)
...
class SyncMigrationDatabaseErrorEventResponse(dict):
    ...
    def __init__(__self__, *,
                 event_text: builtins.str,
                 event_type_string: builtins.str,
                 timestamp_string: builtins.str):
        """
        Database migration errors for online migration
        :param builtins.str event_text: Event text.
        :param builtins.str event_type_string: Event type.
        :param builtins.str timestamp_string: String value of timestamp.
        """
    ...
    def event_text(self) -> builtins.str:
        """
        Event text.
        """
    ...
    def event_type_string(self) -> builtins.str:
        """
        Event type.
        """
    ...
    def timestamp_string(self) -> builtins.str:
        """
...
class ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Output for task that validates migration input for Azure SQL Database Managed Instance online migration
        :param builtins.str id: Database identifier
        :param builtins.str name: Name of database
...
class ValidateMigrationInputSqlServerSqlMITaskInputResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SqlConnectionInfoResponse' target_connection_info: Information for connecting to target
        :param 'FileShareResponse' backup_file_share: Backup file share information for all selected databases.
        :param builtins.str backup_mode: Backup Mode to specify whether to use existing backup or create new backup.
        :param Sequence[builtins.str] selected_logins: Logins to migrate
        """
        pulumi.set(__self__, "backup_blob_share", backup_blob_share)
        pulumi.set(__self__, "selected_databases", selected_databases)
...
class ValidationErrorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Description about the errors happen while performing migration validation
        :param builtins.str severity: Severity of the error
        :param builtins.str text: Error Text
        """
...
class WaitStatisticsResponse(dict):
    ...
    def __init__(__self__, *,
                 wait_count: Optional[builtins.float] = None,
                 wait_time_ms: Optional[builtins.float] = None,
                 wait_type: Optional[builtins.str] = None):
        """
        Wait statistics gathered during query batch execution
        :param builtins.float wait_count: Total no. of waits
        :param builtins.float wait_time_ms: Total wait time in millisecond(s) 
        :param builtins.str wait_type: Type of the Wait
        """
    ...
    def wait_count(self) -> Optional[builtins.float]:
        """
        Total no. of waits
        """
    ...
    def wait_time_ms(self) -> Optional[builtins.float]:
        """
    ...
    def wait_type(self) -> Optional[builtins.str]:
        """
        Type of the Wait
        """
