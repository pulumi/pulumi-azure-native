...
def get_mongo_cluster_database_migrations_mongo_to_cosmos_dbv_core_mongo(migration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration:getMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo', __args__, opts=opts, typ=GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult).value
...
def get_mongo_cluster_database_migrations_mongo_to_cosmos_dbv_core_mongo_output(migration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration:getMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo', __args__, opts=opts, typ=GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult)
