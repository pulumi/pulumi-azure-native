...
__all__ = [
    ...
    'get_database_migrations_mongo_to_cosmos_dbv_core_mongo',
    'get_database_migrations_mongo_to_cosmos_dbv_core_mongo_output',
]
...
def get_database_migrations_mongo_to_cosmos_dbv_core_mongo(migration_name: Optional[str] = None,
                                                           ...
                                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20230715preview:getDatabaseMigrationsMongoToCosmosDbvCoreMongo', __args__, opts=opts, typ=GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult).value
...
def get_database_migrations_mongo_to_cosmos_dbv_core_mongo_output(migration_name: Optional[pulumi.Input[str]] = None,
                                                                  ...
                                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult]:
    """
    Get Database Migration resource.
    ...
    __args__['targetResourceName'] = target_resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20230715preview:getDatabaseMigrationsMongoToCosmosDbvCoreMongo', __args__, opts=opts, typ=GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult)
