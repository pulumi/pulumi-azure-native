...
class MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbvCoreMongo"), pulumi.Alias(type_="azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbvCoreMongo"), pulumi.Alias(type_="azure-native:datamigration:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo, __self__).__init__(
            'azure-native:datamigration/v20230715preview:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo',
            resource_name,
            __props__,
            opts)
