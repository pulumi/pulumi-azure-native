...
def get_file(file_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20230715preview:getFile', __args__, opts=opts, typ=GetFileResult).value
...
def get_file_output(file_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20230715preview:getFile', __args__, opts=opts, typ=GetFileResult)
