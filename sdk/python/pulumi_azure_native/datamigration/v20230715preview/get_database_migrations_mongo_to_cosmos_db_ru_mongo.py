...
def get_database_migrations_mongo_to_cosmos_db_ru_mongo(migration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20230715preview:getDatabaseMigrationsMongoToCosmosDbRUMongo', __args__, opts=opts, typ=GetDatabaseMigrationsMongoToCosmosDbRUMongoResult).value
...
def get_database_migrations_mongo_to_cosmos_db_ru_mongo_output(migration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['targetResourceName'] = target_resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20230715preview:getDatabaseMigrationsMongoToCosmosDbRUMongo', __args__, opts=opts, typ=GetDatabaseMigrationsMongoToCosmosDbRUMongoResult)
