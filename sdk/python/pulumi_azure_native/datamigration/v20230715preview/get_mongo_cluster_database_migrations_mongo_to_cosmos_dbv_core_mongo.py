...
__all__ = [
    'GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult',
    'AwaitableGetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult',
    'get_mongo_cluster_database_migrations_mongo_to_cosmos_dbv_core_mongo',
    'get_mongo_cluster_database_migrations_mongo_to_cosmos_dbv_core_mongo_output',
]

@pulumi.output_type
class GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult:
    """
...
class AwaitableGetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult(GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult(
...
def get_mongo_cluster_database_migrations_mongo_to_cosmos_dbv_core_mongo(migration_name: Optional[str] = None,
                                                                         resource_group_name: Optional[str] = None,
                                                                         target_resource_name: Optional[str] = None,
                                                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20230715preview:getMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo', __args__, opts=opts, typ=GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult).value

    return AwaitableGetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult(
...
def get_mongo_cluster_database_migrations_mongo_to_cosmos_dbv_core_mongo_output(migration_name: Optional[pulumi.Input[str]] = None,
                                                                                resource_group_name: Optional[pulumi.Input[str]] = None,
                                                                                target_resource_name: Optional[pulumi.Input[str]] = None,
                                                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult]:
    """
    Get Database Migration resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20230715preview:getMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo', __args__, opts=opts, typ=GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult)
    return __ret__.apply(lambda __response__: GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult(
