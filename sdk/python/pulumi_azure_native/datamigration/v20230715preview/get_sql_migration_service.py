...
def get_sql_migration_service(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/v20230715preview:getSqlMigrationService', __args__, opts=opts, typ=GetSqlMigrationServiceResult).value
...
def get_sql_migration_service_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sqlMigrationServiceName'] = sql_migration_service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datamigration/v20230715preview:getSqlMigrationService', __args__, opts=opts, typ=GetSqlMigrationServiceResult)
