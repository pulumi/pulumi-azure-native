...
class AzureBlobDefinitionArgsDict(TypedDict):
    ...
    """
    managed_identity: NotRequired[pulumi.Input[Optional['ManagedIdentityDefinitionArgs']]]
    """
    ...
    """
    service_principal: NotRequired[pulumi.Input[Optional['ServicePrincipalDefinitionArgs']]]
    """
...
class GitRepositoryDefinitionArgsDict(TypedDict):
    ...
    Name of a local secret on the Kubernetes cluster to use as the authentication secret rather than the managed or user-provided configuration secrets.
    """
    repository_ref: NotRequired[pulumi.Input[Optional['RepositoryRefDefinitionArgs']]]
    """
...
class KustomizationDefinitionArgsDict(TypedDict):
    ...
    """
    post_build: NotRequired[pulumi.Input[Optional['PostBuildDefinitionArgs']]]
    """
...
class PostBuildDefinitionArgsDict(TypedDict):
    ...
    """
    substitute_from: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SubstituteFromDefinitionArgs']]]]]
    """
...
class ScopeArgsDict(TypedDict):
    ...
    """
    cluster: NotRequired[pulumi.Input[Optional['ScopeClusterArgs']]]
    """
    Specifies that the scope of the extension is Cluster
    """
    namespace: NotRequired[pulumi.Input[Optional['ScopeNamespaceArgs']]]
    """
    Specifies that the scope of the extension is Namespace
    """
