...
def get_flux_configuration(cluster_name: Optional[str] = None,
    ...
    :param str cluster_resource_name: The Kubernetes cluster resource name - i.e. managedClusters, connectedClusters, provisionedClusters, appliances.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/v20241101:getFluxConfiguration', __args__, opts=opts, typ=GetFluxConfigurationResult).value
...
def get_flux_configuration_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetesconfiguration/v20241101:getFluxConfiguration', __args__, opts=opts, typ=GetFluxConfigurationResult)
    return __ret__.apply(lambda __response__: GetFluxConfigurationResult(
        ...
        oci_repository=pulumi.get(__response__, 'oci_repository'),
