...
warnings.warn("""azure-native:kubernetesconfiguration/v20211101preview:SourceControlConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_source_control_configuration(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_source_control_configuration is deprecated: azure-native:kubernetesconfiguration/v20211101preview:SourceControlConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/v20211101preview:getSourceControlConfiguration', __args__, opts=opts, typ=GetSourceControlConfigurationResult).value
