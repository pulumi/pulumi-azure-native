...
class SourceControlConfigurationArgs:
    ...
    def _configure(
        ...
        if 'sourceControlConfigurationName' in kwargs:
            source_control_configuration_name = kwargs['sourceControlConfigurationName']
        if 'sshKnownHostsContents' in kwargs:
...
class SourceControlConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if helm_operator_properties is not None and not isinstance(helm_operator_properties, HelmOperatorPropertiesArgs):
        ...
        super(SourceControlConfiguration, __self__).__init__(
            'azure-native:kubernetesconfiguration/v20230501:SourceControlConfiguration',
            resource_name,
            __props__,
            opts)
