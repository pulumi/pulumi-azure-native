...
class FluxConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        flux_configuration = azure_native.kubernetesconfiguration.v20221101.FluxConfiguration("fluxConfiguration",
            cluster_name="clusterName1",
            cluster_resource_name="connectedClusters",
            cluster_rp="Microsoft.Kubernetes",
            flux_configuration_name="srs-fluxconfig",
            git_repository=azure_native.kubernetesconfiguration.v20221101.GitRepositoryDefinitionResponseArgs(
                https_ca_cert="ZXhhbXBsZWNlcnRpZmljYXRl",
                repository_ref=azure_native.kubernetesconfiguration.v20221101.RepositoryRefDefinitionArgs(
                    branch="master",
                ),
            ...
            kustomizations={
                "srs-kustomization1": azure_native.kubernetesconfiguration.v20221101.KustomizationDefinitionArgs(
                    depends_on=[],
                    path="./test/path",
                    sync_interval_in_seconds=600,
                    timeout_in_seconds=600,
                ),
                "srs-kustomization2": azure_native.kubernetesconfiguration.v20221101.KustomizationDefinitionArgs(
        ...
        flux_configuration = azure_native.kubernetesconfiguration.v20221101.FluxConfiguration("fluxConfiguration",
            bucket=azure_native.kubernetesconfiguration.v20221101.BucketDefinitionArgs(
