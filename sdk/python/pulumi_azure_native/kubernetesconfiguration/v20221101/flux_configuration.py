...
warnings.warn("""azure-native:kubernetesconfiguration/v20221101:FluxConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:FluxConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class FluxConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 suspend: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""FluxConfiguration is deprecated: azure-native:kubernetesconfiguration/v20221101:FluxConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:FluxConfiguration to guarantee forwards compatibility.""")
        ...
        super(FluxConfiguration, __self__).__init__(
            'azure-native:kubernetesconfiguration/v20221101:FluxConfiguration',
            resource_name,
            __props__,
            opts)
