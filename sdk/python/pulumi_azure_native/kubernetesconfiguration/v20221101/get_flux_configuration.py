...
def get_flux_configuration(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_flux_configuration is deprecated: azure-native:kubernetesconfiguration/v20221101:FluxConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:FluxConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/v20221101:getFluxConfiguration', __args__, opts=opts, typ=GetFluxConfigurationResult).value
