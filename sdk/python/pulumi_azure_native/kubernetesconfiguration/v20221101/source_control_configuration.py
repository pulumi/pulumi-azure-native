...
class SourceControlConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        source_control_configuration = azure_native.kubernetesconfiguration.v20221101.SourceControlConfiguration("sourceControlConfiguration",
            ...
            helm_operator_properties=azure_native.kubernetesconfiguration.v20221101.HelmOperatorPropertiesArgs(
