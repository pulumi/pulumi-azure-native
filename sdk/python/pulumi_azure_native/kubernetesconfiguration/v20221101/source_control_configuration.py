...
warnings.warn("""azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:SourceControlConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class SourceControlConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 ssh_known_hosts_contents: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SourceControlConfiguration is deprecated: azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:SourceControlConfiguration to guarantee forwards compatibility.""")
        ...
        super(SourceControlConfiguration, __self__).__init__(
            'azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration',
            resource_name,
            __props__,
            opts)
