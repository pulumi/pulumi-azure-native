...
def get_extension(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/v20221101:getExtension', __args__, opts=opts, typ=GetExtensionResult).value
...
def get_extension_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetesconfiguration/v20221101:getExtension', __args__, opts=opts, typ=GetExtensionResult)
