...
class Extension(pulumi.CustomResource):
    ...
    def error_info(self) -> pulumi.Output[Optional['outputs.ErrorDetailResponse']]:
        """
        The error detail.
        """
