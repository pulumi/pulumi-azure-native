...
def get_flux_configuration(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_flux_configuration is deprecated: azure-native:kubernetesconfiguration/v20220301:FluxConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:FluxConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
