...
warnings.warn("""azure-native:kubernetesconfiguration/v20220301:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20220402preview:Extension to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_extension(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_extension is deprecated: azure-native:kubernetesconfiguration/v20220301:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20220402preview:Extension to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/v20220301:getExtension', __args__, opts=opts, typ=GetExtensionResult).value
