...
def get_source_control_configuration(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/v20220101preview:getSourceControlConfiguration', __args__, opts=opts, typ=GetSourceControlConfigurationResult).value
...
def get_source_control_configuration_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetesconfiguration/v20220101preview:getSourceControlConfiguration', __args__, opts=opts, typ=GetSourceControlConfigurationResult)
