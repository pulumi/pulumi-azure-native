...
class GetFluxConfigurationResult:
    ...
    """
    def __init__(__self__, bucket=None, compliance_state=None, configuration_protected_settings=None, error_message=None, git_repository=None, id=None, kustomizations=None, last_source_updated_at=None, last_source_updated_commit_id=None, name=None, namespace=None, provisioning_state=None, repository_public_key=None, scope=None, source_kind=None, statuses=None, suspend=None, system_data=None, type=None):
        ...
        if last_source_updated_at and not isinstance(last_source_updated_at, str):
            raise TypeError("Expected argument 'last_source_updated_at' to be a str")
        pulumi.set(__self__, "last_source_updated_at", last_source_updated_at)
        if last_source_updated_commit_id and not isinstance(last_source_updated_commit_id, str):
            raise TypeError("Expected argument 'last_source_updated_commit_id' to be a str")
        pulumi.set(__self__, "last_source_updated_commit_id", last_source_updated_commit_id)
    ...
    def last_source_updated_at(self) -> str:
        """
    ...
    def last_source_updated_commit_id(self) -> str:
        """
...
class AwaitableGetFluxConfigurationResult(GetFluxConfigurationResult):
    ...
    def __await__(self):
        ...
        return GetFluxConfigurationResult(
            ...
            last_source_updated_at=self.last_source_updated_at,
            last_source_updated_commit_id=self.last_source_updated_commit_id,
            name=self.name,
...
def get_flux_configuration(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/v20220101preview:getFluxConfiguration', __args__, opts=opts, typ=GetFluxConfigurationResult).value
    ...
    return AwaitableGetFluxConfigurationResult(
        ...
        last_source_updated_at=pulumi.get(__ret__, 'last_source_updated_at'),
        last_source_updated_commit_id=pulumi.get(__ret__, 'last_source_updated_commit_id'),
...
def get_flux_configuration_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetesconfiguration/v20220101preview:getFluxConfiguration', __args__, opts=opts, typ=GetFluxConfigurationResult)
    return __ret__.apply(lambda __response__: GetFluxConfigurationResult(
        ...
        last_source_updated_at=pulumi.get(__response__, 'last_source_updated_at'),
        last_source_updated_commit_id=pulumi.get(__response__, 'last_source_updated_commit_id'),
