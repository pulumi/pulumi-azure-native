...
class GetPrivateLinkScopeResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.KubernetesConfigurationPrivateLinkScopePropertiesResponse':
        """
...
def get_private_link_scope(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration:getPrivateLinkScope', __args__, opts=opts, typ=GetPrivateLinkScopeResult).value
...
def get_private_link_scope_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetesconfiguration:getPrivateLinkScope', __args__, opts=opts, typ=GetPrivateLinkScopeResult)
