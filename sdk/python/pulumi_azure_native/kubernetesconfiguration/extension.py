...
class ExtensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] version: User-specified version of the extension for this extension to 'pin'. To use 'version', autoUpgradeMinorVersion must be 'false'.
        """
