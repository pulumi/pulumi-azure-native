...
def get_private_link_scope(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/v20220402preview:getPrivateLinkScope', __args__, opts=opts, typ=GetPrivateLinkScopeResult).value
...
def get_private_link_scope_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scopeName'] = scope_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetesconfiguration/v20220402preview:getPrivateLinkScope', __args__, opts=opts, typ=GetPrivateLinkScopeResult)
