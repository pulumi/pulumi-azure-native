...
class ExtensionArgs:
    ...
    def _configure(
        ...
        if aks_assigned_identity is None and 'aksAssignedIdentity' in kwargs:
...
class Extension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            aks_assigned_identity = _utilities.configure(aks_assigned_identity, ExtensionAksAssignedIdentityArgs, True)
