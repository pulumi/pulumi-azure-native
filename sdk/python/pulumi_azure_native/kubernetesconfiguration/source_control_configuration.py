...
class SourceControlConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 enable_helm_operator: Optional[pulumi.Input[builtins.bool]] = None,
                 helm_operator_properties: Optional[pulumi.Input['HelmOperatorPropertiesArgs']] = None,
                 operator_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 operator_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 operator_params: Optional[pulumi.Input[builtins.str]] = None,
                 operator_scope: Optional[pulumi.Input[Union[builtins.str, 'OperatorScopeType']]] = None,
                 operator_type: Optional[pulumi.Input[Union[builtins.str, 'OperatorType']]] = None,
                 ...
                 ssh_known_hosts_contents: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] configuration_protected_settings: Name-value pairs of protected configuration settings for the configuration
        :param pulumi.Input[builtins.bool] enable_helm_operator: Option to enable Helm Operator for this git configuration.
        :param pulumi.Input['HelmOperatorPropertiesArgs'] helm_operator_properties: Properties for Helm operator.
        :param pulumi.Input[builtins.str] operator_instance_name: Instance name of the operator - identifying the specific configuration.
        :param pulumi.Input[builtins.str] operator_namespace: The namespace to which this operator is installed to. Maximum of 253 lower case alphanumeric characters, hyphen and period only.
        :param pulumi.Input[builtins.str] operator_params: Any Parameters for the Operator instance in string format.
        :param pulumi.Input[Union[builtins.str, 'OperatorScopeType']] operator_scope: Scope at which the operator will be installed.
        :param pulumi.Input[Union[builtins.str, 'OperatorType']] operator_type: Type of the operator
        :param pulumi.Input[builtins.str] repository_url: Url of the SourceControl Repository.
        :param pulumi.Input[builtins.str] source_control_configuration_name: Name of the Source Control Configuration.
        :param pulumi.Input[builtins.str] ssh_known_hosts_contents: Base64-encoded known_hosts contents containing public SSH keys required to access private Git instances
        """
    ...
    def enable_helm_operator(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_helm_operator(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def operator_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operator_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "operator_instance_name", value)

    @property
    @pulumi.getter(name="operatorNamespace")
    def operator_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operator_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "operator_namespace", value)

    @property
    @pulumi.getter(name="operatorParams")
    def operator_params(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operator_params(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "operator_params", value)

    @property
    @pulumi.getter(name="operatorScope")
    def operator_scope(self) -> Optional[pulumi.Input[Union[builtins.str, 'OperatorScopeType']]]:
        """
    ...
    def operator_scope(self, value: Optional[pulumi.Input[Union[builtins.str, 'OperatorScopeType']]]):
        pulumi.set(self, "operator_scope", value)

    @property
    @pulumi.getter(name="operatorType")
    def operator_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'OperatorType']]]:
        """
    ...
    def operator_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'OperatorType']]]):
    ...
    def source_control_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_control_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_control_configuration_name", value)

    @property
    @pulumi.getter(name="sshKnownHostsContents")
    def ssh_known_hosts_contents(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ssh_known_hosts_contents(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SourceControlConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableHelmOperator")
    def enable_helm_operator(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Option to enable Helm Operator for this git configuration.
        """
        return pulumi.get(self, "enable_helm_operator")
    ...
    @property
    @pulumi.getter(name="operatorInstanceName")
    def operator_instance_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Instance name of the operator - identifying the specific configuration.
        """
        return pulumi.get(self, "operator_instance_name")
    ...
    @property
    @pulumi.getter(name="operatorNamespace")
    def operator_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The namespace to which this operator is installed to. Maximum of 253 lower case alphanumeric characters, hyphen and period only.
        """
        return pulumi.get(self, "operator_namespace")
    ...
    @property
    @pulumi.getter(name="operatorParams")
    def operator_params(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Any Parameters for the Operator instance in string format.
        """
        return pulumi.get(self, "operator_params")
    ...
    @property
    @pulumi.getter(name="operatorScope")
    def operator_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Scope at which the operator will be installed.
        """
        return pulumi.get(self, "operator_scope")
    ...
    @property
    @pulumi.getter(name="sshKnownHostsContents")
    def ssh_known_hosts_contents(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Base64-encoded known_hosts contents containing public SSH keys required to access private Git instances
        """
        return pulumi.get(self, "ssh_known_hosts_contents")
