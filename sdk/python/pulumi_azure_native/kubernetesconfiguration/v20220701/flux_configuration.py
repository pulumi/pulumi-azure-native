...
warnings.warn("""azure-native:kubernetesconfiguration/v20220701:FluxConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kubernetesconfiguration/v20221101:FluxConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class FluxConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 suspend: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""FluxConfiguration is deprecated: azure-native:kubernetesconfiguration/v20220701:FluxConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kubernetesconfiguration/v20221101:FluxConfiguration to guarantee forwards compatibility.""")
