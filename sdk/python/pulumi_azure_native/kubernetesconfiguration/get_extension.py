...
class GetExtensionResult:
    ...
    def configuration_settings(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def custom_location_settings(self) -> Mapping[str, builtins.str]:
        """
    ...
    def package_uri(self) -> builtins.str:
        """
    ...
    def release_train(self) -> Optional[builtins.str]:
        """
...
def get_extension(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str extension_name: Name of the Extension.
...
def get_extension_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
