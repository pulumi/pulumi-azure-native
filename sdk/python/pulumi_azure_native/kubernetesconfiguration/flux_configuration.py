...
class FluxConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 reconciliation_wait_duration: Optional[pulumi.Input[builtins.str]] = None,
                 scope: Optional[pulumi.Input[Union[builtins.str, 'ScopeType']]] = None,
                 source_kind: Optional[pulumi.Input[Union[builtins.str, 'SourceKindType']]] = None,
                 suspend: Optional[pulumi.Input[builtins.bool]] = None,
                 wait_for_reconciliation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] configuration_protected_settings: Key-value pairs of protected configuration settings for the configuration
        :param pulumi.Input[builtins.str] flux_configuration_name: Name of the Flux Configuration.
        ...
        :param pulumi.Input[builtins.str] namespace: The namespace to which this configuration is installed to. Maximum of 253 lower case alphanumeric characters, hyphen and period only.
        :param pulumi.Input[builtins.str] reconciliation_wait_duration: Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D
        :param pulumi.Input[Union[builtins.str, 'ScopeType']] scope: Scope at which the operator will be installed.
        :param pulumi.Input[Union[builtins.str, 'SourceKindType']] source_kind: Source Kind to pull the configuration data from.
        :param pulumi.Input[builtins.bool] suspend: Whether this configuration should suspend its reconciliation of its kustomizations and sources.
        :param pulumi.Input[builtins.bool] wait_for_reconciliation: Whether flux configuration deployment should wait for cluster to reconcile the kustomizations.
        """
    ...
    def flux_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def flux_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reconciliation_wait_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reconciliation_wait_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reconciliation_wait_duration", value)

    @property
    @pulumi.getter
    def scope(self) -> Optional[pulumi.Input[Union[builtins.str, 'ScopeType']]]:
        """
    ...
    @scope.setter
    def scope(self, value: Optional[pulumi.Input[Union[builtins.str, 'ScopeType']]]):
        pulumi.set(self, "scope", value)

    @property
    @pulumi.getter(name="sourceKind")
    def source_kind(self) -> Optional[pulumi.Input[Union[builtins.str, 'SourceKindType']]]:
        """
    ...
    @source_kind.setter
    def source_kind(self, value: Optional[pulumi.Input[Union[builtins.str, 'SourceKindType']]]):
    ...
    def wait_for_reconciliation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def wait_for_reconciliation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class FluxConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['BucketDefinitionArgs', 'BucketDefinitionArgsDict']] bucket: Parameters to reconcile to the Bucket source kind type.
        :param pulumi.Input[builtins.str] cluster_name: The name of the kubernetes cluster.
        :param pulumi.Input[builtins.str] cluster_resource_name: The Kubernetes cluster resource name - i.e. managedClusters, connectedClusters, provisionedClusters.
        :param pulumi.Input[builtins.str] cluster_rp: The Kubernetes cluster RP - i.e. Microsoft.ContainerService, Microsoft.Kubernetes, Microsoft.HybridContainerService.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] configuration_protected_settings: Key-value pairs of protected configuration settings for the configuration
    ...
    def compliance_state(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="reconciliationWaitDuration")
    def reconciliation_wait_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D
        """
        return pulumi.get(self, "reconciliation_wait_duration")
    ...
    def repository_public_key(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="sourceKind")
    def source_kind(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Source Kind to pull the configuration data from.
        """
        return pulumi.get(self, "source_kind")
    ...
    def source_synced_commit_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def source_updated_at(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def status_updated_at(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def suspend(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether this configuration should suspend its reconciliation of its kustomizations and sources.
        """
        return pulumi.get(self, "suspend")
    ...
    @property
    @pulumi.getter(name="waitForReconciliation")
    def wait_for_reconciliation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether flux configuration deployment should wait for cluster to reconcile the kustomizations.
        """
        return pulumi.get(self, "wait_for_reconciliation")
