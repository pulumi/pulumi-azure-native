...
class FluxConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] reconciliation_wait_duration: Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D
        :param pulumi.Input[Union[_builtins.str, 'ScopeType']] scope: Scope at which the operator will be installed.
        :param pulumi.Input[Union[_builtins.str, 'SourceKindType']] source_kind: Source Kind to pull the configuration data from.
        :param pulumi.Input[_builtins.bool] suspend: Whether this configuration should suspend its reconciliation of its kustomizations and sources.
        :param pulumi.Input[_builtins.bool] wait_for_reconciliation: Whether flux configuration deployment should wait for cluster to reconcile the kustomizations.
        """
...
class FluxConfiguration(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="reconciliationWaitDuration")
    def reconciliation_wait_duration(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D
        """
        return pulumi.get(self, "reconciliation_wait_duration")
