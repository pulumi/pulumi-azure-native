...
class ComplianceStatusResponse(dict):
    ...
    def _configure(
        ...
        if 'lastConfigApplied' in kwargs:
            last_config_applied = kwargs['lastConfigApplied']
        if 'messageLevel' in kwargs:
            message_level = kwargs['messageLevel']
...
class KubernetesConfigurationPrivateLinkScopePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        KubernetesConfigurationPrivateLinkScopePropertiesResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class ObjectStatusDefinitionResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'appliedBy' in kwargs:
            applied_by = kwargs['appliedBy']
        if 'complianceState' in kwargs:
            compliance_state = kwargs['complianceState']
        if 'helmReleaseProperties' in kwargs:
            helm_release_properties = kwargs['helmReleaseProperties']
        if 'statusConditions' in kwargs:
