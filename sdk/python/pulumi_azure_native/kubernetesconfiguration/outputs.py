...
class AzureBlobDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 local_auth_ref: Optional[_builtins.str] = None,
                 ...
                 sync_interval_in_seconds: Optional[_builtins.float] = None,
        ...
        :param _builtins.str sas_token: The Shared Access token to access the storage container
        :param 'ServicePrincipalDefinitionResponse' service_principal: Parameters to authenticate using Service Principal.
        :param _builtins.float sync_interval_in_seconds: The interval at which to re-reconcile the cluster Azure Blob source with the remote.
        :param _builtins.float timeout_in_seconds: The maximum time to attempt to reconcile the cluster Azure Blob source with the remote.
        :param _builtins.str url: The URL to sync for the flux configuration Azure Blob storage account.
        """
...
class BucketDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str local_auth_ref: Name of a local secret on the Kubernetes cluster to use as the authentication secret rather than the managed or user-provided configuration secrets.
        :param _builtins.float sync_interval_in_seconds: The interval at which to re-reconcile the cluster bucket source with the remote.
        :param _builtins.float timeout_in_seconds: The maximum time to attempt to reconcile the cluster bucket source with the remote.
        :param _builtins.str url: The URL to sync for the flux configuration S3 bucket.
        """
...
class ComplianceStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_config_applied: Optional[_builtins.str] = None,
        ...
        :param _builtins.str message_level: Level of the message.
        """
...
class ExtensionStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str message: Detailed message of the status from the Extension.
        :param _builtins.str time: DateLiteral (per ISO8601) noting the time of installation status.
        """
        if code is not None:
...
class GitRepositoryDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str ssh_known_hosts: Base64-encoded known_hosts value containing public SSH keys required to access private git repositories over SSH
        :param _builtins.float sync_interval_in_seconds: The interval at which to re-reconcile the cluster git repository source with the remote.
        :param _builtins.float timeout_in_seconds: The maximum time to attempt to reconcile the cluster git repository source with the remote.
        :param _builtins.str url: The URL to sync for the flux configuration git repository.
        """
...
class HelmReleasePropertiesDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 failure_count: Optional[_builtins.float] = None,
                 helm_chart_ref: Optional['outputs.ObjectReferenceDefinitionResponse'] = None,
                 install_failure_count: Optional[_builtins.float] = None,
                 last_revision_applied: Optional[_builtins.float] = None,
        ...
        :param _builtins.float last_revision_applied: The revision number of the last released object change
        :param _builtins.float upgrade_failure_count: Number of times that the HelmRelease failed to upgrade
        """
...
class KubernetesConfigurationPrivateLinkScopePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_endpoint_connections: Sequence['_commontypesv3.outputs.PrivateEndpointConnectionResponse'],
                 private_link_scope_id: _builtins.str,
        ...
        :param Sequence['_commontypesv3.PrivateEndpointConnectionResponse'] private_endpoint_connections: The collection of associated Private Endpoint Connections.
        ...
        :param _builtins.str public_network_access: Indicates whether machines associated with the private link scope can also use public Azure Arc service endpoints.
        """
    ...
    def private_endpoint_connections(self) -> Sequence['_commontypesv3.outputs.PrivateEndpointConnectionResponse']:
        """
...
class KustomizationDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 prune: Optional[_builtins.bool] = None,
                 retry_interval_in_seconds: Optional[_builtins.float] = None,
                 sync_interval_in_seconds: Optional[_builtins.float] = None,
                 timeout_in_seconds: Optional[_builtins.float] = None,
        ...
        :param _builtins.str path: The path in the source reference to reconcile on the cluster.
        :param 'PostBuildDefinitionResponse' post_build: Used for variable substitution for this Kustomization after kustomize build.
        :param _builtins.bool prune: Enable/disable garbage collections of Kubernetes objects created by this Kustomization.
        :param _builtins.float retry_interval_in_seconds: The interval at which to re-reconcile the Kustomization on the cluster in the event of failure on reconciliation.
        :param _builtins.float sync_interval_in_seconds: The interval at which to re-reconcile the Kustomization on the cluster.
        :param _builtins.float timeout_in_seconds: The maximum time to attempt to reconcile the Kustomization on the cluster.
        :param _builtins.bool wait: Enable/disable health check for all Kubernetes objects created by this Kustomization.
        """
...
class ObjectStatusConditionDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str status: Status of the Kubernetes object condition type
        :param _builtins.str type: Object status condition type for this object
        """
...
class ObjectStatusDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str kind: Kind of the applied object
        :param _builtins.str name: Name of the applied object
        :param _builtins.str namespace: Namespace of the applied object
...
class RepositoryRefDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str tag: The git repository tag name to checkout. This takes precedence over branch.
        """
...
class ServicePrincipalDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str tenant_id: The tenant Id for authenticating a Service Principal
        """
