...
class PrivateLinkScopeArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['KubernetesConfigurationPrivateLinkScopePropertiesArgs']] = None,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['KubernetesConfigurationPrivateLinkScopePropertiesArgs']]):
...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['KubernetesConfigurationPrivateLinkScopePropertiesArgs', 'KubernetesConfigurationPrivateLinkScopePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['KubernetesConfigurationPrivateLinkScopePropertiesArgs', 'KubernetesConfigurationPrivateLinkScopePropertiesArgsDict']] properties: Properties that define a Azure Arc PrivateLinkScope resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] scope_name: The name of the Azure Arc PrivateLinkScope resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kubernetesconfiguration/v20220402preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:kubernetesconfiguration:PrivateLinkScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkScope, __self__).__init__(
            'azure-native:kubernetesconfiguration/v20241101preview:PrivateLinkScope',
            resource_name,
            __props__,
            opts)
