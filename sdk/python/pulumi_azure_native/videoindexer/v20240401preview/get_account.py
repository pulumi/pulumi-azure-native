...
class GetAccountResult:
    ...
    """
    def __init__(__self__, account_id=None, account_name=None, id=None, identity=None, location=None, name=None, open_ai_services=None, provisioning_state=None, storage_services=None, system_data=None, tags=None, tenant_id=None, total_seconds_indexed=None, type=None):
...
def get_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:videoindexer/v20240401preview:getAccount', __args__, opts=opts, typ=GetAccountResult).value
...
def get_account_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:videoindexer/v20240401preview:getAccount', __args__, opts=opts, typ=GetAccountResult)
