...
__all__ = [
    ...
    'OpenAiServicesForPutRequestResponse',
...
@pulumi.output_type
class OpenAiServicesForPutRequestResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in OpenAiServicesForPutRequestResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        OpenAiServicesForPutRequestResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        The openAi services details
        :param str resource_id: The openAi services resource id
