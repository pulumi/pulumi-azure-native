...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The account's data-plane ID. This can be set only when connecting an existing classic account
...
class Account(pulumi.CustomResource):
    ...
    def total_seconds_indexed(self) -> pulumi.Output[builtins.int]:
        """
