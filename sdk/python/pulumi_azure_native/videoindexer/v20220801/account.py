...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:videoindexer:Account"), pulumi.Alias(type_="azure-native:videoindexer/v20211018preview:Account")])
