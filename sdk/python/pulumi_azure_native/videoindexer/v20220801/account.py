...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        account = azure_native.videoindexer.v20220801.Account("account",
            account_name="contosto-videoanalyzer",
            identity=azure_native.videoindexer.v20220801.ManagedServiceIdentityResponseArgs(
                type="UserAssigned",
            ...
            media_services=azure_native.videoindexer.v20220801.MediaServicesForPutRequestArgs(
