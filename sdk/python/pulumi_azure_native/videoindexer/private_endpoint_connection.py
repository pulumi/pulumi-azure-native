...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_name: The name of the Azure Video Indexer account.
...
@pulumi.type_token("azure-native:videoindexer:PrivateEndpointConnection")
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:videoindexer/v20240601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:videoindexer/v20250401:PrivateEndpointConnection")])
