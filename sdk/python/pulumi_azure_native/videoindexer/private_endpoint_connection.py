...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:videoindexer/v20240601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_videoindexer_v20240601preview:videoindexer:PrivateEndpointConnection")])
