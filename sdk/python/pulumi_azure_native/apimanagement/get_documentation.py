...
def get_documentation(documentation_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str documentation_id: Documentation identifier. Must be unique in the current API Management service instance.
...
def get_documentation_output(documentation_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
