...
def get_workspace_tag_api_link(api_link_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str api_link_id: Tag-API link identifier. Must be unique in the current API Management service instance.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getWorkspaceTagApiLink', __args__, opts=opts, typ=GetWorkspaceTagApiLinkResult).value
...
def get_workspace_tag_api_link_output(api_link_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
