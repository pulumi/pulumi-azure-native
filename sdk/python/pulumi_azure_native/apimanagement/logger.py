...
class LoggerArgs:
    def __init__(__self__, *,
                 logger_type: pulumi.Input[Union[builtins.str, 'LoggerType']],
                 resource_group_name: pulumi.Input[builtins.str],
                 service_name: pulumi.Input[builtins.str],
                 credentials: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 is_buffered: Optional[pulumi.Input[builtins.bool]] = None,
                 logger_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Logger resource.
        :param pulumi.Input[Union[builtins.str, 'LoggerType']] logger_type: Logger type.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] service_name: The name of the API Management service.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] credentials: The name and SendRule connection string of the event hub for azureEventHub logger.
               Instrumentation key for applicationInsights logger.
        :param pulumi.Input[builtins.str] description: Logger description.
        :param pulumi.Input[builtins.bool] is_buffered: Whether records are buffered in the logger before publishing. Default is assumed to be true.
        :param pulumi.Input[builtins.str] logger_id: Logger identifier. Must be unique in the API Management service instance.
        :param pulumi.Input[builtins.str] resource_id: Azure Resource Id of a log target (either Azure Event Hub resource or Azure Application Insights resource).
        """
    ...
    def logger_type(self) -> pulumi.Input[Union[builtins.str, 'LoggerType']]:
        """
        Logger type.
        """
    ...
    @logger_type.setter
    def logger_type(self, value: pulumi.Input[Union[builtins.str, 'LoggerType']]):
    ...
    @property
    @pulumi.getter
    def credentials(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    @credentials.setter
    def credentials(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def is_buffered(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_buffered.setter
    def is_buffered(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_buffered", value)

    @property
    @pulumi.getter(name="loggerId")
    def logger_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @logger_id.setter
    def logger_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:apimanagement:Logger")
class Logger(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 is_buffered: Optional[pulumi.Input[builtins.bool]] = None,
                 logger_id: Optional[pulumi.Input[builtins.str]] = None,
                 logger_type: Optional[pulumi.Input[Union[builtins.str, 'LoggerType']]] = None,
    ...
    @property
    @pulumi.getter
    def credentials(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        The name and SendRule connection string of the event hub for azureEventHub logger.
        Instrumentation key for applicationInsights logger.
        """
    ...
    @property
    @pulumi.getter(name="isBuffered")
    def is_buffered(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether records are buffered in the logger before publishing. Default is assumed to be true.
        """
        return pulumi.get(self, "is_buffered")
    ...
    @property
    @pulumi.getter(name="loggerType")
    def logger_type(self) -> pulumi.Output[builtins.str]:
        """
        Logger type.
        """
        return pulumi.get(self, "logger_type")
