...
def get_workspace_backend(backend_id: Optional[_builtins.str] = None,
...
def get_workspace_backend_output(backend_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
