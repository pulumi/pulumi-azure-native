...
class ProductGroupLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ProductGroupLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ProductGroupLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:ProductGroupLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ProductGroupLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ProductGroupLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:ProductGroupLink"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:ProductGroupLink")])
