...
class ApiIssueCommentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] text: Comment text.
        :param pulumi.Input[builtins.str] user_id: A resource identifier for the user who left the comment.
        :param pulumi.Input[builtins.str] comment_id: Comment identifier within an Issue. Must be unique in the current Issue.
        :param pulumi.Input[builtins.str] created_date: Date and time when the comment was created.
        """
    ...
    def comment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @comment_id.setter
    def comment_id(self, value: Optional[pulumi.Input[builtins.str]]):
