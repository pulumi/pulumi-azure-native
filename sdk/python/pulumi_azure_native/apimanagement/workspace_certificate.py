...
class WorkspaceCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceCertificate"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceCertificate"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceCertificate"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:WorkspaceCertificate"), pulumi.Alias(type_="azure-native:apimanagement/v20250301preview:WorkspaceCertificate"), pulumi.Alias(type_="azure-native:apimanagement/v20250901preview:WorkspaceCertificate")])
