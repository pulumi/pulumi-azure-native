...
def list_open_id_connect_provider_secrets(opid: Optional[builtins.str] = None,
...
def list_open_id_connect_provider_secrets_output(opid: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:listOpenIdConnectProviderSecrets', __args__, opts=opts, typ=ListOpenIdConnectProviderSecretsResult)
