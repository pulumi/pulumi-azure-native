...
class GatewayHostnameConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] tls10_enabled: Specifies if TLS 1.0 is supported
