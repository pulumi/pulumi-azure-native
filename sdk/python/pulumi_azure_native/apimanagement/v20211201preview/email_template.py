...
warnings.warn("""azure-native:apimanagement/v20211201preview:EmailTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:EmailTemplate to guarantee forwards compatibility.""", DeprecationWarning)
...
class EmailTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 title: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""EmailTemplate is deprecated: azure-native:apimanagement/v20211201preview:EmailTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:EmailTemplate to guarantee forwards compatibility.""")
