...
warnings.warn("""azure-native:apimanagement/v20211201preview:PolicyFragment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:PolicyFragment to guarantee forwards compatibility.""", DeprecationWarning)
...
class PolicyFragment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:PolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:PolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:PolicyFragment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PolicyFragment, __self__).__init__(
            'azure-native:apimanagement/v20211201preview:PolicyFragment',
            resource_name,
            __props__,
            opts)
