...
warnings.warn("""azure-native:apimanagement/v20211201preview:Product is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Product to guarantee forwards compatibility.""", DeprecationWarning)
...
class Product(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 terms: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Product is deprecated: azure-native:apimanagement/v20211201preview:Product is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Product to guarantee forwards compatibility.""")
