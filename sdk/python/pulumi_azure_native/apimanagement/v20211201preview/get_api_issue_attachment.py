...
def get_api_issue_attachment_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20211201preview:getApiIssueAttachment', __args__, opts=opts, typ=GetApiIssueAttachmentResult)
