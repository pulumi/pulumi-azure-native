...
warnings.warn("""azure-native:apimanagement/v20211201preview:Gateway is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Gateway to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_gateway(gateway_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway is deprecated: azure-native:apimanagement/v20211201preview:Gateway is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Gateway to guarantee forwards compatibility.""")
    __args__ = dict()
