...
def get_user(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user is deprecated: azure-native:apimanagement/v20211201preview:User is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:User to guarantee forwards compatibility.""")
    __args__ = dict()
