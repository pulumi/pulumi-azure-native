...
warnings.warn("""azure-native:apimanagement/v20211201preview:ApiIssueComment is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiIssueComment to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiIssueComment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiIssueComment is deprecated: azure-native:apimanagement/v20211201preview:ApiIssueComment is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiIssueComment to guarantee forwards compatibility.""")
