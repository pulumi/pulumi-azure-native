...
warnings.warn("""azure-native:apimanagement/v20211201preview:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiIssue to guarantee forwards compatibility.""", DeprecationWarning)
