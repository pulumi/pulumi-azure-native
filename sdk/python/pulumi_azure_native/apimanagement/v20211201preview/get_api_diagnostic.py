...
warnings.warn("""azure-native:apimanagement/v20211201preview:ApiDiagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiDiagnostic to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_diagnostic(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_diagnostic is deprecated: azure-native:apimanagement/v20211201preview:ApiDiagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiDiagnostic to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20211201preview:getApiDiagnostic', __args__, opts=opts, typ=GetApiDiagnosticResult).value
