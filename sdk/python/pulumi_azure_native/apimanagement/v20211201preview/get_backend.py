...
warnings.warn("""azure-native:apimanagement/v20211201preview:Backend is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Backend to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_backend(backend_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backend is deprecated: azure-native:apimanagement/v20211201preview:Backend is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Backend to guarantee forwards compatibility.""")
    __args__ = dict()
