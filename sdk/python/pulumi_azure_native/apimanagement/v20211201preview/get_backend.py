...
warnings.warn("""azure-native:apimanagement/v20211201preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Backend to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_backend(backend_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backend is deprecated: azure-native:apimanagement/v20211201preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Backend to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['backendId'] = backend_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20211201preview:getBackend', __args__, opts=opts, typ=GetBackendResult).value
