...
warnings.warn("""azure-native:apimanagement/v20211201preview:IdentityProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:IdentityProvider to guarantee forwards compatibility.""", DeprecationWarning)
...
class IdentityProvider(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[Union[str, 'IdentityProviderType']]] = None,
                 __props__=None):
        pulumi.log.warn("""IdentityProvider is deprecated: azure-native:apimanagement/v20211201preview:IdentityProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:IdentityProvider to guarantee forwards compatibility.""")
