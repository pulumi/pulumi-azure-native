...
class ApiVersionSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 versioning_scheme: Optional[pulumi.Input[Union[str, 'VersioningScheme']]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiVersionSet is deprecated: azure-native:apimanagement/v20211201preview:ApiVersionSet is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiVersionSet to guarantee forwards compatibility.""")
