...
class ApiIssueAttachment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 title: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiIssueAttachment is deprecated: azure-native:apimanagement/v20211201preview:ApiIssueAttachment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssueAttachment to guarantee forwards compatibility.""")
