...
warnings.warn("""azure-native:apimanagement/v20211201preview:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Certificate to guarantee forwards compatibility.""", DeprecationWarning)
...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Certificate is deprecated: azure-native:apimanagement/v20211201preview:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Certificate to guarantee forwards compatibility.""")
