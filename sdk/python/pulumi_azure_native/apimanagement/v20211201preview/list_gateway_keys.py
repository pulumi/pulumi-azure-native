...
def list_gateway_keys(gateway_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20211201preview:listGatewayKeys', __args__, opts=opts, typ=ListGatewayKeysResult).value
...
def list_gateway_keys_output(gateway_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20211201preview:listGatewayKeys', __args__, opts=opts, typ=ListGatewayKeysResult)
