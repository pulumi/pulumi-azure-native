...
class WorkspaceTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: Tag name.
...
@pulumi.type_token("azure-native:apimanagement:WorkspaceTag")
