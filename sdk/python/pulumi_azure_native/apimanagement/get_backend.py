...
def get_backend(backend_id: Optional[builtins.str] = None,
    ...
    :param builtins.str backend_id: Identifier of the Backend entity. Must be unique in the current API Management service instance.
...
def get_backend_output(backend_id: Optional[pulumi.Input[builtins.str]] = None,
