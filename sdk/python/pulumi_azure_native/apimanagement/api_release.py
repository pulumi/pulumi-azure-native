...
class ApiReleaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: Identifier of the API the release belongs to.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] service_name: The name of the API Management service.
        :param pulumi.Input[builtins.str] notes: Release Notes
        :param pulumi.Input[builtins.str] release_id: Release identifier within an API. Must be unique in the current API Management service instance.
        """
...
class ApiRelease(pulumi.CustomResource):
    ...
    def updated_date_time(self) -> pulumi.Output[builtins.str]:
        """
