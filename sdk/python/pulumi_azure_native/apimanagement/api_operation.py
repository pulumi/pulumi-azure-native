...
class ApiOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Operation Name.
        :param pulumi.Input[builtins.str] method: A Valid HTTP Operation Method. Typical Http Methods like GET, PUT, POST but not limited by only them.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] service_name: The name of the API Management service.
        :param pulumi.Input[builtins.str] url_template: Relative URL template identifying the target resource for this operation. May include parameters. Example: /customers/{cid}/orders/{oid}/?date={date}
        :param pulumi.Input[builtins.str] description: Description of the operation. May include HTML formatting tags.
        :param pulumi.Input[builtins.str] operation_id: Operation identifier within an API. Must be unique in the current API Management service instance.
        :param pulumi.Input[builtins.str] policies: Operation Policies
...
class ApiOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 url_template: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="urlTemplate")
    def url_template(self) -> pulumi.Output[builtins.str]:
        """
        Relative URL template identifying the target resource for this operation. May include parameters. Example: /customers/{cid}/orders/{oid}/?date={date}
        """
        return pulumi.get(self, "url_template")
