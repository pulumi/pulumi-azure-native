...
def list_workspace_subscription_secrets(resource_group_name: Optional[builtins.str] = None,
...
def list_workspace_subscription_secrets_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
