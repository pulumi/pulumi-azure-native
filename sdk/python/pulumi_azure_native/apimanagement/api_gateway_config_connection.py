...
class ApiGatewayConfigConnectionArgs:
    def __init__(__self__, *,
                 ...
                 config_connection_name: Optional[pulumi.Input[_builtins.str]] = None,
