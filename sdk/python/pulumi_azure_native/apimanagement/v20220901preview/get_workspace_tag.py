...
__all__ = [
    ...
    'AwaitableGetWorkspaceTagResult',
    'get_workspace_tag',
    'get_workspace_tag_output',
]
...
class AwaitableGetWorkspaceTagResult(GetWorkspaceTagResult):
...
def get_workspace_tag_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20220901preview:getWorkspaceTag', __args__, opts=opts, typ=GetWorkspaceTagResult)
