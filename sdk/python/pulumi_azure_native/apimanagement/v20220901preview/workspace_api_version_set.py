...
class WorkspaceApiVersionSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApiVersionSet"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceApiVersionSet"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceApiVersionSet"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApiVersionSet"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApiVersionSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceApiVersionSet, __self__).__init__(
            'azure-native:apimanagement/v20220901preview:WorkspaceApiVersionSet',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WorkspaceApiVersionSet':
        """
