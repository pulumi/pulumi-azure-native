...
class NamedValueArgs:
    ...
    def _configure(
        ...
        if named_value_id is None and 'namedValueId' in kwargs:
            named_value_id = kwargs['namedValueId']
        ...
        if named_value_id is not None:
            _setter("named_value_id", named_value_id)
...
class NamedValue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            key_vault = _utilities.configure(key_vault, KeyVaultContractCreatePropertiesArgs, True)
