...
class Documentation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:Documentation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Documentation, __self__).__init__(
            'azure-native:apimanagement/v20220901preview:Documentation',
            resource_name,
            __props__,
            opts)
