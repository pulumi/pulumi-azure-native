...
class ProductWiki(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220801:ProductWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ProductWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:ProductWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ProductWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ProductWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:ProductWiki"), pulumi.Alias(type_="azure-native:apimanagement:ProductWiki")])
