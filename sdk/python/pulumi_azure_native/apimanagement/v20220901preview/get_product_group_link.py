...
def get_product_group_link(group_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220901preview:getProductGroupLink', __args__, opts=opts, typ=GetProductGroupLinkResult).value
...
def get_product_group_link_output(group_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20220901preview:getProductGroupLink', __args__, opts=opts, typ=GetProductGroupLinkResult)
