...
def get_graph_ql_api_resolver(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220901preview:getGraphQLApiResolver', __args__, opts=opts, typ=GetGraphQLApiResolverResult).value
