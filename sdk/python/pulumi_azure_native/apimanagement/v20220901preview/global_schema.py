...
class GlobalSchema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20210801:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement:GlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement:Schema")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GlobalSchema, __self__).__init__(
            'azure-native:apimanagement/v20220901preview:GlobalSchema',
            resource_name,
            __props__,
            opts)
