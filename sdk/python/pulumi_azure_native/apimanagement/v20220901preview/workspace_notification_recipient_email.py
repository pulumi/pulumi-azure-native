...
class WorkspaceNotificationRecipientEmail(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement:WorkspaceNotificationRecipientEmail")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceNotificationRecipientEmail, __self__).__init__(
            'azure-native:apimanagement/v20220901preview:WorkspaceNotificationRecipientEmail',
            resource_name,
            __props__,
            opts)
