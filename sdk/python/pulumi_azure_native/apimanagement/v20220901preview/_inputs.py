...
class BackendCircuitBreakerArgs:
    def __init__(__self__, *,
        ...
        """
        BackendCircuitBreakerArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            rules=rules,
        )
    @staticmethod
...
class CircuitBreakerFailureConditionArgs:
    def __init__(__self__, *,
        ...
        """
        CircuitBreakerFailureConditionArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            count=count,
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if error_reasons is None and 'errorReasons' in kwargs:
            error_reasons = kwargs['errorReasons']
        if status_code_ranges is None and 'statusCodeRanges' in kwargs:
...
class CircuitBreakerRuleArgs:
    def __init__(__self__, *,
        ...
        """
        CircuitBreakerRuleArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if failure_condition is None and 'failureCondition' in kwargs:
            failure_condition = kwargs['failureCondition']
        if trip_duration is None and 'tripDuration' in kwargs:
...
class FailureStatusCodeRangeArgs:
    def __init__(__self__, *,
        ...
        """
        FailureStatusCodeRangeArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            max=max,
            min=min,
        )
