...
def get_authorization_server(authsid: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220901preview:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult).value
