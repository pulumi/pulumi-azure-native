...
class WorkspaceGroupUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceGroupUser")])
