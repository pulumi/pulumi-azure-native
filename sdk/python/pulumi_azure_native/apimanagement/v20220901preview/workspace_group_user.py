...
class WorkspaceGroupUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceGroupUser")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceGroupUser, __self__).__init__(
            'azure-native:apimanagement/v20220901preview:WorkspaceGroupUser',
            resource_name,
            __props__,
            opts)
