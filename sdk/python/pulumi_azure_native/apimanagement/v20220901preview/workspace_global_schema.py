...
class WorkspaceGlobalSchema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement:WorkspaceGlobalSchema")])
