...
class BackendArgs:
    ...
    def _configure(
        ...
        if 'circuitBreaker' in kwargs:
            circuit_breaker = kwargs['circuitBreaker']
        ...
        if circuit_breaker is not None:
            _setter("circuit_breaker", circuit_breaker)
...
class Backend(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if circuit_breaker is not None and not isinstance(circuit_breaker, BackendCircuitBreakerArgs):
                circuit_breaker = circuit_breaker or {}
                def _setter(key, value):
                    circuit_breaker[key] = value
                BackendCircuitBreakerArgs._configure(_setter, **circuit_breaker)
