...
class TagApiLinkArgs:
    ...
    def _configure(
        ...
        if api_link_id is None and 'apiLinkId' in kwargs:
            api_link_id = kwargs['apiLinkId']
        ...
        if api_link_id is not None:
            _setter("api_link_id", api_link_id)
...
class TagApiLink(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            TagApiLinkArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:TagApiLink")])
