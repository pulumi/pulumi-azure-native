...
class TagApiLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement:TagApiLink")])
