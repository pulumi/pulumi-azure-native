...
def get_product_api_link(api_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220901preview:getProductApiLink', __args__, opts=opts, typ=GetProductApiLinkResult).value
...
def get_product_api_link_output(api_link_id: Optional[pulumi.Input[str]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetProductApiLinkResult]:
    """
    Gets the API link for the product.
