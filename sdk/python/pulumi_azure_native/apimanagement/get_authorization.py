...
def get_authorization(authorization_id: Optional[_builtins.str] = None,
...
def get_authorization_output(authorization_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
