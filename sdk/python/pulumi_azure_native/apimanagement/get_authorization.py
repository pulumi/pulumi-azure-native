...
class GetAuthorizationResult:
    ...
    def o_auth2_grant_type(self) -> Optional[builtins.str]:
        """
...
def get_authorization(authorization_id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getAuthorization', __args__, opts=opts, typ=GetAuthorizationResult).value
...
def get_authorization_output(authorization_id: Optional[pulumi.Input[builtins.str]] = None,
