...
def get_workspace_api_operation(api_id: Optional[_builtins.str] = None,
...
def get_workspace_api_operation_output(api_id: Optional[pulumi.Input[_builtins.str]] = None,
