...
def get_workspace_product(product_id: Optional[_builtins.str] = None,
...
def get_workspace_product_output(product_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
