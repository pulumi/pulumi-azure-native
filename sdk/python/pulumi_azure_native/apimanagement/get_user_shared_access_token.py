...
def get_user_shared_access_token(expiry: Optional[_builtins.str] = None,
    ...
    :param _builtins.str user_id: User identifier. Must be unique in the current API Management service instance.
    """
    __args__ = dict()
