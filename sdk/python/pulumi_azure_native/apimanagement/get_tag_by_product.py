...
def get_tag_by_product(product_id: Optional[builtins.str] = None,
...
def get_tag_by_product_output(product_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getTagByProduct', __args__, opts=opts, typ=GetTagByProductResult)
