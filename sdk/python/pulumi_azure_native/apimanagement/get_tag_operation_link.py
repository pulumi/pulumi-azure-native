...
def get_tag_operation_link(operation_link_id: Optional[builtins.str] = None,
...
def get_tag_operation_link_output(operation_link_id: Optional[pulumi.Input[builtins.str]] = None,
