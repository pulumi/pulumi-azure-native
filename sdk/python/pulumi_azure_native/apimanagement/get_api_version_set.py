...
def get_api_version_set(resource_group_name: Optional[builtins.str] = None,
...
def get_api_version_set_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
