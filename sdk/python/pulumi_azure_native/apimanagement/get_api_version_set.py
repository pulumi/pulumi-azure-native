...
def get_api_version_set(resource_group_name: Optional[_builtins.str] = None,
...
def get_api_version_set_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getApiVersionSet', __args__, opts=opts, typ=GetApiVersionSetResult)
