...
class GetApiResult:
    ...
    API details.
    """
    def __init__(__self__, api_revision=None, api_type=None, api_version=None, api_version_set=None, api_version_set_id=None, authentication_settings=None, description=None, display_name=None, id=None, is_current=None, is_online=None, name=None, path=None, protocols=None, service_url=None, subscription_key_parameter_names=None, type=None):
    ...
    def api_version_set(self) -> Optional['outputs.ApiVersionSetContractResponse']:
        """
...
def get_api(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20170301:getApi', __args__, opts=opts, typ=GetApiResult).value
...
def get_api_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20170301:getApi', __args__, opts=opts, typ=GetApiResult)
