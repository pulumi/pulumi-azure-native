...
def get_tag_by_api(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_by_api is deprecated: azure-native:apimanagement/v20170301:TagByApi is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByApi to guarantee forwards compatibility.""")
    __args__ = dict()
