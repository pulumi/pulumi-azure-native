...
warnings.warn("""azure-native:apimanagement/v20170301:TagByOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByOperation to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_tag_by_operation(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_by_operation is deprecated: azure-native:apimanagement/v20170301:TagByOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByOperation to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20170301:getTagByOperation', __args__, opts=opts, typ=GetTagByOperationResult).value
