...
def get_authorization_server(authsid: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization_server is deprecated: azure-native:apimanagement/v20170301:AuthorizationServer is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:AuthorizationServer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['authsid'] = authsid
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20170301:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult).value
