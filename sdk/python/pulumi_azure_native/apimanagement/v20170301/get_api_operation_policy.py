...
def get_api_operation_policy(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_operation_policy is deprecated: azure-native:apimanagement/v20170301:ApiOperationPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:ApiOperationPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
