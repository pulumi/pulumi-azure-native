...
def get_api_version_set(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_version_set is deprecated: azure-native:apimanagement/v20170301:ApiVersionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiVersionSet to guarantee forwards compatibility.""")
    __args__ = dict()
