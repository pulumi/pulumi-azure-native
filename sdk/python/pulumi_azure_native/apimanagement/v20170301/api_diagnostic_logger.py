...
class ApiDiagnosticLogger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:ApiDiagnosticLogger")])
