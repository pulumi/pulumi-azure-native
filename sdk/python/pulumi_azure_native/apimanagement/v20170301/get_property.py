...
def get_property(prop_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_property is deprecated: azure-native:apimanagement/v20170301:Property is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:Property to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['propId'] = prop_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20170301:getProperty', __args__, opts=opts, typ=GetPropertyResult).value
