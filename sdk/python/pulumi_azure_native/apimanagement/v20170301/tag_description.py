...
warnings.warn("""azure-native:apimanagement/v20170301:TagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180601preview:TagDescription to guarantee forwards compatibility.""", DeprecationWarning)
...
class TagDescription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tag_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TagDescription is deprecated: azure-native:apimanagement/v20170301:TagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180601preview:TagDescription to guarantee forwards compatibility.""")
