...
warnings.warn("""azure-native:apimanagement/v20170301:Subscription is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180101:Subscription to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_subscription(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subscription is deprecated: azure-native:apimanagement/v20170301:Subscription is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180101:Subscription to guarantee forwards compatibility.""")
    __args__ = dict()
