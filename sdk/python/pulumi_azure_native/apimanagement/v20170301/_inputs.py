...
class LoggerSamplingContractArgs:
    ...
    def _configure(
        ...
        if 'movingAverageRatio' in kwargs:
            moving_average_ratio = kwargs['movingAverageRatio']
        if 'percentageDecreaseTimeout' in kwargs:
            percentage_decrease_timeout = kwargs['percentageDecreaseTimeout']
        if 'percentageIncreaseTimeout' in kwargs:
