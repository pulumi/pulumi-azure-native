...
warnings.warn("""azure-native:apimanagement/v20170301:Policy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:Policy to guarantee forwards compatibility.""", DeprecationWarning)
...
class Policy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Policy is deprecated: azure-native:apimanagement/v20170301:Policy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:Policy to guarantee forwards compatibility.""")
