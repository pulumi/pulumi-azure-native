...
warnings.warn("""azure-native:apimanagement/v20170301:Diagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180101:Diagnostic to guarantee forwards compatibility.""", DeprecationWarning)
...
class Diagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Diagnostic is deprecated: azure-native:apimanagement/v20170301:Diagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180101:Diagnostic to guarantee forwards compatibility.""")
