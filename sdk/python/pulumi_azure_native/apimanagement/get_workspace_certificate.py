...
def get_workspace_certificate(certificate_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_id: Identifier of the certificate entity. Must be unique in the current API Management service instance.
...
def get_workspace_certificate_output(certificate_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
