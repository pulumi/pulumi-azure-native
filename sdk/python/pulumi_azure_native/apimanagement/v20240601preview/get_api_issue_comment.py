...
def get_api_issue_comment(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getApiIssueComment', __args__, opts=opts, typ=GetApiIssueCommentResult).value
...
def get_api_issue_comment_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getApiIssueComment', __args__, opts=opts, typ=GetApiIssueCommentResult)
