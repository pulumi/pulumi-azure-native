...
def get_product_api_link(api_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getProductApiLink', __args__, opts=opts, typ=GetProductApiLinkResult).value
...
def get_product_api_link_output(api_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getProductApiLink', __args__, opts=opts, typ=GetProductApiLinkResult)
