...
class WorkspaceSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement:WorkspaceSubscription")])
