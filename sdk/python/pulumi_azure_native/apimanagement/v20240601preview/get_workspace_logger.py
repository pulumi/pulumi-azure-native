...
__all__ = [
    ...
    'AwaitableGetWorkspaceLoggerResult',
    'get_workspace_logger',
    'get_workspace_logger_output',
]
...
class AwaitableGetWorkspaceLoggerResult(GetWorkspaceLoggerResult):
...
def get_workspace_logger(logger_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceLogger', __args__, opts=opts, typ=GetWorkspaceLoggerResult).value

    return AwaitableGetWorkspaceLoggerResult(
...
def get_workspace_logger_output(logger_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceLogger', __args__, opts=opts, typ=GetWorkspaceLoggerResult)
