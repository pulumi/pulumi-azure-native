...
def get_api_issue(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getApiIssue', __args__, opts=opts, typ=GetApiIssueResult).value
...
def get_api_issue_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getApiIssue', __args__, opts=opts, typ=GetApiIssueResult)
