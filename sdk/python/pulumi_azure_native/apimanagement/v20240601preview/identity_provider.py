...
class IdentityProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] certificate_id: Certificate full resource ID used in external Identity Provider
