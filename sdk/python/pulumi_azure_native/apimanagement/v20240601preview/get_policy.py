...
def get_policy(format: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(format: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
