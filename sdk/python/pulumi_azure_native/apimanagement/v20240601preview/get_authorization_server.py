...
def get_authorization_server(authsid: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult).value
...
def get_authorization_server_output(authsid: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult)
