...
class WorkspaceDiagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceDiagnostic"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceDiagnostic"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceDiagnostic")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceDiagnostic, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:WorkspaceDiagnostic',
            resource_name,
            __props__,
            opts)
