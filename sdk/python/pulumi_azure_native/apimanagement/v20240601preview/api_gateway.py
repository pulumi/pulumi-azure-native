...
class ApiGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ApiGateway")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiGateway, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:ApiGateway',
            resource_name,
            __props__,
            opts)
