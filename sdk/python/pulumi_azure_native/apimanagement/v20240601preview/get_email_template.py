...
def get_email_template(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getEmailTemplate', __args__, opts=opts, typ=GetEmailTemplateResult).value
...
def get_email_template_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getEmailTemplate', __args__, opts=opts, typ=GetEmailTemplateResult)
