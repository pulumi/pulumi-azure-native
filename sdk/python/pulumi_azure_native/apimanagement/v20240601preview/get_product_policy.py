...
def get_product_policy(format: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getProductPolicy', __args__, opts=opts, typ=GetProductPolicyResult).value
...
def get_product_policy_output(format: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getProductPolicy', __args__, opts=opts, typ=GetProductPolicyResult)
