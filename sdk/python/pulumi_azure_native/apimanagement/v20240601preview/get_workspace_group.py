...
def get_workspace_group(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceGroup', __args__, opts=opts, typ=GetWorkspaceGroupResult).value
...
def get_workspace_group_output(group_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceGroup', __args__, opts=opts, typ=GetWorkspaceGroupResult)
