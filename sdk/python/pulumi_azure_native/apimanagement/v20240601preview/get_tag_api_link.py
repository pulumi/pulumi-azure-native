...
def get_tag_api_link(api_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getTagApiLink', __args__, opts=opts, typ=GetTagApiLinkResult).value

    return AwaitableGetTagApiLinkResult(
...
def get_tag_api_link_output(api_link_id: Optional[pulumi.Input[str]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTagApiLinkResult]:
    """
    Gets the API link for the tag.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getTagApiLink', __args__, opts=opts, typ=GetTagApiLinkResult)
    return __ret__.apply(lambda __response__: GetTagApiLinkResult(
