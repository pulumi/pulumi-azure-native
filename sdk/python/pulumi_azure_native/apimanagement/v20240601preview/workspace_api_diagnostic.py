...
class WorkspaceApiDiagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApiDiagnostic"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApiDiagnostic"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApiDiagnostic")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceApiDiagnostic, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:WorkspaceApiDiagnostic',
            resource_name,
            __props__,
            opts)
