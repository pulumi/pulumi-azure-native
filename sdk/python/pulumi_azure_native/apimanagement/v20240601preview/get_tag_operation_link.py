...
def get_tag_operation_link(operation_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getTagOperationLink', __args__, opts=opts, typ=GetTagOperationLinkResult).value
...
def get_tag_operation_link_output(operation_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getTagOperationLink', __args__, opts=opts, typ=GetTagOperationLinkResult)
