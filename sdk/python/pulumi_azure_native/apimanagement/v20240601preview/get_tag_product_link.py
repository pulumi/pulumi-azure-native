...
def get_tag_product_link(product_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getTagProductLink', __args__, opts=opts, typ=GetTagProductLinkResult).value
...
def get_tag_product_link_output(product_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getTagProductLink', __args__, opts=opts, typ=GetTagProductLinkResult)
