...
class WorkspaceBackend(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceBackend"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceBackend"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceBackend")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceBackend, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:WorkspaceBackend',
            resource_name,
            __props__,
            opts)
