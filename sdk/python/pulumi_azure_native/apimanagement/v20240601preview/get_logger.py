...
def get_logger(logger_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getLogger', __args__, opts=opts, typ=GetLoggerResult).value
...
def get_logger_output(logger_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getLogger', __args__, opts=opts, typ=GetLoggerResult)
