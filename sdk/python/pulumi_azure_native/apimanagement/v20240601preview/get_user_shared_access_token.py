...
def get_user_shared_access_token(expiry: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getUserSharedAccessToken', __args__, opts=opts, typ=GetUserSharedAccessTokenResult).value
...
def get_user_shared_access_token_output(expiry: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getUserSharedAccessToken', __args__, opts=opts, typ=GetUserSharedAccessTokenResult)
