...
class ApiGatewayConfigConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:ApiGatewayConfigConnection"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ApiGatewayConfigConnection"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ApiGatewayConfigConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiGatewayConfigConnection, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:ApiGatewayConfigConnection',
            resource_name,
            __props__,
            opts)
