...
def get_global_schema(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getGlobalSchema', __args__, opts=opts, typ=GetGlobalSchemaResult).value
...
def get_global_schema_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getGlobalSchema', __args__, opts=opts, typ=GetGlobalSchemaResult)
