...
class WorkspaceTagOperationLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement:WorkspaceTagOperationLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceTagOperationLink, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:WorkspaceTagOperationLink',
            resource_name,
            __props__,
            opts)
