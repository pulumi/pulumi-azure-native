...
def get_workspace_tag(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceTag', __args__, opts=opts, typ=GetWorkspaceTagResult).value
...
def get_workspace_tag_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceTag', __args__, opts=opts, typ=GetWorkspaceTagResult)
