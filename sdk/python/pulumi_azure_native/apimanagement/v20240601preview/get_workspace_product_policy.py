...
__all__ = [
    ...
    'AwaitableGetWorkspaceProductPolicyResult',
    'get_workspace_product_policy',
    'get_workspace_product_policy_output',
]
...
def get_workspace_product_policy(format: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceProductPolicy', __args__, opts=opts, typ=GetWorkspaceProductPolicyResult).value
...
def get_workspace_product_policy_output(format: Optional[pulumi.Input[Optional[str]]] = None,
                                        policy_id: Optional[pulumi.Input[str]] = None,
                                        product_id: Optional[pulumi.Input[str]] = None,
                                        resource_group_name: Optional[pulumi.Input[str]] = None,
                                        service_name: Optional[pulumi.Input[str]] = None,
                                        workspace_id: Optional[pulumi.Input[str]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWorkspaceProductPolicyResult]:
    """
    Get the policy configuration at the Product level.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceProductPolicy', __args__, opts=opts, typ=GetWorkspaceProductPolicyResult)
