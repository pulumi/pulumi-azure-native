...
def get_workspace_certificate(certificate_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceCertificate', __args__, opts=opts, typ=GetWorkspaceCertificateResult).value
...
def get_workspace_certificate_output(certificate_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceCertificate', __args__, opts=opts, typ=GetWorkspaceCertificateResult)
