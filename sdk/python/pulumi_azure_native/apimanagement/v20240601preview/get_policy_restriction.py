...
def get_policy_restriction(policy_restriction_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getPolicyRestriction', __args__, opts=opts, typ=GetPolicyRestrictionResult).value
