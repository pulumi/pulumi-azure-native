...
def get_documentation(documentation_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getDocumentation', __args__, opts=opts, typ=GetDocumentationResult).value
...
def get_documentation_output(documentation_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getDocumentation', __args__, opts=opts, typ=GetDocumentationResult)
