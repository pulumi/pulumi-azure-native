...
def get_workspace_api_policy(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceApiPolicy', __args__, opts=opts, typ=GetWorkspaceApiPolicyResult).value
...
def get_workspace_api_policy_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceApiPolicy', __args__, opts=opts, typ=GetWorkspaceApiPolicyResult)
