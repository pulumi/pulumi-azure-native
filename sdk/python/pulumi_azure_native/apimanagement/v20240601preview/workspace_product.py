...
class WorkspaceProduct(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement:WorkspaceProduct")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceProduct, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:WorkspaceProduct',
            resource_name,
            __props__,
            opts)
