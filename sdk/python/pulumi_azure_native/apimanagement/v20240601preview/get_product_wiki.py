...
__all__ = [
    ...
    'AwaitableGetProductWikiResult',
    'get_product_wiki',
    'get_product_wiki_output',
]
...
class AwaitableGetProductWikiResult(GetProductWikiResult):
...
def get_product_wiki(product_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getProductWiki', __args__, opts=opts, typ=GetProductWikiResult).value
...
def get_product_wiki_output(product_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getProductWiki', __args__, opts=opts, typ=GetProductWikiResult)
