...
class WorkspaceApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApi")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceApi, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:WorkspaceApi',
            resource_name,
            __props__,
            opts)
