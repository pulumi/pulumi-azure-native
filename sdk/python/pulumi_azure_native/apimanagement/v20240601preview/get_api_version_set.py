...
def get_api_version_set(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getApiVersionSet', __args__, opts=opts, typ=GetApiVersionSetResult).value
...
def get_api_version_set_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getApiVersionSet', __args__, opts=opts, typ=GetApiVersionSetResult)
