...
def get_workspace_backend(backend_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceBackend', __args__, opts=opts, typ=GetWorkspaceBackendResult).value
...
def get_workspace_backend_output(backend_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceBackend', __args__, opts=opts, typ=GetWorkspaceBackendResult)
