...
def get_graph_ql_api_resolver_policy(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getGraphQLApiResolverPolicy', __args__, opts=opts, typ=GetGraphQLApiResolverPolicyResult).value
...
def get_graph_ql_api_resolver_policy_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getGraphQLApiResolverPolicy', __args__, opts=opts, typ=GetGraphQLApiResolverPolicyResult)
