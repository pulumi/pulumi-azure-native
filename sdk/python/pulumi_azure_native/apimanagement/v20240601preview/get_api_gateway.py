...
def get_api_gateway(gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getApiGateway', __args__, opts=opts, typ=GetApiGatewayResult).value
...
def get_api_gateway_output(gateway_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getApiGateway', __args__, opts=opts, typ=GetApiGatewayResult)
