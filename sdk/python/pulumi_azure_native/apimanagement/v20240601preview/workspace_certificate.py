...
class WorkspaceCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceCertificate"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceCertificate"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceCertificate, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:WorkspaceCertificate',
            resource_name,
            __props__,
            opts)
