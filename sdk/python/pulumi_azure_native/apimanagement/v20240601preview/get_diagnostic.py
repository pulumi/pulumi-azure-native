...
def get_diagnostic(diagnostic_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getDiagnostic', __args__, opts=opts, typ=GetDiagnosticResult).value
...
def get_diagnostic_output(diagnostic_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getDiagnostic', __args__, opts=opts, typ=GetDiagnosticResult)
