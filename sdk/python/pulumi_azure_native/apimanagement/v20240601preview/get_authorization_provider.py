...
def get_authorization_provider(authorization_provider_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getAuthorizationProvider', __args__, opts=opts, typ=GetAuthorizationProviderResult).value
...
def get_authorization_provider_output(authorization_provider_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getAuthorizationProvider', __args__, opts=opts, typ=GetAuthorizationProviderResult)
