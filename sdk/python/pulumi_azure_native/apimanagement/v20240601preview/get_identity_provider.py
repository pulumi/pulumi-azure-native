...
class GetIdentityProviderResult:
    ...
    """
    def __init__(__self__, allowed_tenants=None, authority=None, certificate_id=None, client_id=None, client_library=None, client_secret=None, id=None, name=None, password_reset_policy_name=None, profile_editing_policy_name=None, signin_policy_name=None, signin_tenant=None, signup_policy_name=None, type=None):
...
def get_identity_provider(identity_provider_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getIdentityProvider', __args__, opts=opts, typ=GetIdentityProviderResult).value
...
def get_identity_provider_output(identity_provider_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getIdentityProvider', __args__, opts=opts, typ=GetIdentityProviderResult)
