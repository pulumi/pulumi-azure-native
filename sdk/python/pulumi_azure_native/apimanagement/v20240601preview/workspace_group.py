...
class WorkspaceGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceGroup, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:WorkspaceGroup',
            resource_name,
            __props__,
            opts)
