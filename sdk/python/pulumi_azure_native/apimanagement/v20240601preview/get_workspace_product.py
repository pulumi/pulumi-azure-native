...
def get_workspace_product(product_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceProduct', __args__, opts=opts, typ=GetWorkspaceProductResult).value
...
def get_workspace_product_output(product_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceProduct', __args__, opts=opts, typ=GetWorkspaceProductResult)
