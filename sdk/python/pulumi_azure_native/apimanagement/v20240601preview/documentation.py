...
class Documentation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220801:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:Documentation"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:Documentation"), pulumi.Alias(type_="azure-native:apimanagement:Documentation")])
