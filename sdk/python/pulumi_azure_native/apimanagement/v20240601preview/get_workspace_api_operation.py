...
def get_workspace_api_operation(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceApiOperation', __args__, opts=opts, typ=GetWorkspaceApiOperationResult).value
...
def get_workspace_api_operation_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceApiOperation', __args__, opts=opts, typ=GetWorkspaceApiOperationResult)
