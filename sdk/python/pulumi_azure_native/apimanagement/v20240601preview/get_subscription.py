...
def get_subscription(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult).value
...
def get_subscription_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult)
