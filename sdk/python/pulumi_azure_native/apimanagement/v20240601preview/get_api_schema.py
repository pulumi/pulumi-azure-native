...
def get_api_schema(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getApiSchema', __args__, opts=opts, typ=GetApiSchemaResult).value
...
def get_api_schema_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getApiSchema', __args__, opts=opts, typ=GetApiSchemaResult)
