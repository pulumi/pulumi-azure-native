...
def get_api_gateway_config_connection(config_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getApiGatewayConfigConnection', __args__, opts=opts, typ=GetApiGatewayConfigConnectionResult).value
