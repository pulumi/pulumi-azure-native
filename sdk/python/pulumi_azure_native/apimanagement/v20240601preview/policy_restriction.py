...
class PolicyRestriction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement:PolicyRestriction")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PolicyRestriction, __self__).__init__(
            'azure-native:apimanagement/v20240601preview:PolicyRestriction',
            resource_name,
            __props__,
            opts)
