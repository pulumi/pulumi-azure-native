...
class GetWorkspaceDiagnosticResult:
    ...
    Diagnostic details.
    """
    def __init__(__self__, always_log=None, backend=None, frontend=None, http_correlation_protocol=None, id=None, large_language_model=None, log_client_ip=None, logger_id=None, metrics=None, name=None, operation_name_format=None, sampling=None, type=None, verbosity=None):
...
def get_workspace_diagnostic(diagnostic_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240601preview:getWorkspaceDiagnostic', __args__, opts=opts, typ=GetWorkspaceDiagnosticResult).value
...
def get_workspace_diagnostic_output(diagnostic_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240601preview:getWorkspaceDiagnostic', __args__, opts=opts, typ=GetWorkspaceDiagnosticResult)
