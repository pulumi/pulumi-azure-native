...
def get_workspace_subscription(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getWorkspaceSubscription', __args__, opts=opts, typ=GetWorkspaceSubscriptionResult).value
...
def get_workspace_subscription_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
