...
class ApiManagementServiceArgs:
    ...
    def _configure(
        ...
        if addresser_email is None and 'addresserEmail' in kwargs:
            addresser_email = kwargs['addresserEmail']
...
class ApiManagementService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            vpnconfiguration = _utilities.configure(vpnconfiguration, VirtualNetworkConfigurationArgs, True)
