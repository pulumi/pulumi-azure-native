...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:apimanagement/v20161010:ApiManagementService":
    ...
    pulumi.runtime.register_resource_module("azure-native", "apimanagement/v20161010", _module_instance)
