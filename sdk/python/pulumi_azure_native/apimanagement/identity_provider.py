...
class IdentityProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] signin_tenant: The TenantId to use instead of Common when logging into Active Directory
        :param pulumi.Input[_builtins.str] signup_policy_name: Signup Policy Name. Only applies to AAD B2C Identity Provider.
        :param pulumi.Input[Union[_builtins.str, 'IdentityProviderType']] type: Identity Provider Type identifier.
        """
