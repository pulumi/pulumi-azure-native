...
class ApiGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20250301preview:ApiGateway")])
