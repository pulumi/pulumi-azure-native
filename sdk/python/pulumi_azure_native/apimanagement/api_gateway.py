...
class ApiGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] gateway_name: The name of the API Management gateway.
        :param pulumi.Input[builtins.str] location: Resource location.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[Union[builtins.str, 'VirtualNetworkType']] virtual_network_type: The type of VPN in which API Management gateway needs to be configured in. 
        """
...
class ApiGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:ApiGateway"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:ApiGateway")])
