...
class OpenIdConnectProviderArgs:
    def __init__(__self__, *,
                 ...
                 metadata_endpoint: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 service_name: pulumi.Input[builtins.str],
                 client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 opid: Optional[pulumi.Input[builtins.str]] = None,
                 use_in_api_documentation: Optional[pulumi.Input[builtins.bool]] = None,
                 use_in_test_console: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a OpenIdConnectProvider resource.
        :param pulumi.Input[builtins.str] client_id: Client ID of developer console which is the client application.
        :param pulumi.Input[builtins.str] display_name: User-friendly OpenID Connect Provider name.
        :param pulumi.Input[builtins.str] metadata_endpoint: Metadata endpoint URI.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] service_name: The name of the API Management service.
        :param pulumi.Input[builtins.str] client_secret: Client Secret of developer console which is the client application.
        :param pulumi.Input[builtins.str] description: User-friendly description of OpenID Connect Provider.
        :param pulumi.Input[builtins.str] opid: Identifier of the OpenID Connect Provider.
        :param pulumi.Input[builtins.bool] use_in_api_documentation: If true, the Open ID Connect provider will be used in the API documentation in the developer portal. False by default if no value is provided.
        :param pulumi.Input[builtins.bool] use_in_test_console: If true, the Open ID Connect provider may be used in the developer portal test console. True by default if no value is provided.
        """
    ...
    def metadata_endpoint(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def metadata_endpoint(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def opid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @opid.setter
    def opid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opid", value)

    @property
    @pulumi.getter(name="useInApiDocumentation")
    def use_in_api_documentation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_in_api_documentation(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_in_api_documentation", value)

    @property
    @pulumi.getter(name="useInTestConsole")
    def use_in_test_console(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_in_test_console(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class OpenIdConnectProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 metadata_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 opid: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="metadataEndpoint")
    def metadata_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        Metadata endpoint URI.
        """
        return pulumi.get(self, "metadata_endpoint")
    ...
    @property
    @pulumi.getter(name="useInApiDocumentation")
    def use_in_api_documentation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, the Open ID Connect provider will be used in the API documentation in the developer portal. False by default if no value is provided.
        """
        return pulumi.get(self, "use_in_api_documentation")
    ...
    @property
    @pulumi.getter(name="useInTestConsole")
    def use_in_test_console(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, the Open ID Connect provider may be used in the developer portal test console. True by default if no value is provided.
        """
        return pulumi.get(self, "use_in_test_console")
