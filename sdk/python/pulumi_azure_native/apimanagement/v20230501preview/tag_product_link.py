...
class TagProductLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:TagProductLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagProductLink, __self__).__init__(
            'azure-native:apimanagement/v20230501preview:TagProductLink',
            resource_name,
            __props__,
            opts)
