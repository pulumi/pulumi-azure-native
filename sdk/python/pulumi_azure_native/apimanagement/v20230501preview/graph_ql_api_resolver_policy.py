...
class GraphQLApiResolverPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220801:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement:GraphQLApiResolverPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GraphQLApiResolverPolicy, __self__).__init__(
            'azure-native:apimanagement/v20230501preview:GraphQLApiResolverPolicy',
            resource_name,
            __props__,
            opts)
