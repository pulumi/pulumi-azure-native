...
class GraphQLApiResolverPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:GraphQLApiResolverPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:GraphQLApiResolverPolicy")])
