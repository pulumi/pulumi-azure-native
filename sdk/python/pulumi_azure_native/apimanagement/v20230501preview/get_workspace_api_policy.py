...
class AwaitableGetWorkspaceApiPolicyResult(GetWorkspaceApiPolicyResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetWorkspaceApiPolicyResult(
            format=self.format,
            id=self.id,
            name=self.name,
            type=self.type,
...
def get_workspace_api_policy(api_id: Optional[str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWorkspaceApiPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:getWorkspaceApiPolicy', __args__, opts=opts, typ=GetWorkspaceApiPolicyResult).value
...
def get_workspace_api_policy_output(api_id: Optional[pulumi.Input[str]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWorkspaceApiPolicyResult]:
    """
    Get the policy configuration at the API level.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230501preview:getWorkspaceApiPolicy', __args__, opts=opts, typ=GetWorkspaceApiPolicyResult)
    return __ret__.apply(lambda __response__: GetWorkspaceApiPolicyResult(
