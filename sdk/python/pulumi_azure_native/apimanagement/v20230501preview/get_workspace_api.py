...
def get_workspace_api(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:getWorkspaceApi', __args__, opts=opts, typ=GetWorkspaceApiResult).value
...
def get_workspace_api_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230501preview:getWorkspaceApi', __args__, opts=opts, typ=GetWorkspaceApiResult)
