...
def list_tenant_access_secrets(access_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:listTenantAccessSecrets', __args__, opts=opts, typ=ListTenantAccessSecretsResult).value
...
def list_tenant_access_secrets_output(access_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230501preview:listTenantAccessSecrets', __args__, opts=opts, typ=ListTenantAccessSecretsResult)
