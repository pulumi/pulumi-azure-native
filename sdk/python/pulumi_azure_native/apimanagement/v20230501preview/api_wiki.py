...
class ApiWiki(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:ApiWiki")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiWiki, __self__).__init__(
            'azure-native:apimanagement/v20230501preview:ApiWiki',
            resource_name,
            __props__,
            opts)
