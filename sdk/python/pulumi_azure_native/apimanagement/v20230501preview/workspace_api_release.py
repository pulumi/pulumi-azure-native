...
class WorkspaceApiRelease(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApiRelease"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApiRelease"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceApiRelease"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApiRelease"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApiRelease")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceApiRelease, __self__).__init__(
            'azure-native:apimanagement/v20230501preview:WorkspaceApiRelease',
            resource_name,
            __props__,
            opts)
