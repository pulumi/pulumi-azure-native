...
class GetGlobalSchemaResult:
    ...
    """
    def __init__(__self__, description=None, id=None, name=None, provisioning_state=None, schema_type=None, type=None, value=None):
...
def get_global_schema(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:getGlobalSchema', __args__, opts=opts, typ=GetGlobalSchemaResult).value
...
def get_global_schema_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                             ...
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGlobalSchemaResult]:
    """
    Gets the details of the Schema specified by its identifier.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230501preview:getGlobalSchema', __args__, opts=opts, typ=GetGlobalSchemaResult)
