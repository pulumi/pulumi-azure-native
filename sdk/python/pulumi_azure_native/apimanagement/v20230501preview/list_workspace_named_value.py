...
def list_workspace_named_value(named_value_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:listWorkspaceNamedValue', __args__, opts=opts, typ=ListWorkspaceNamedValueResult).value
...
def list_workspace_named_value_output(named_value_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230501preview:listWorkspaceNamedValue', __args__, opts=opts, typ=ListWorkspaceNamedValueResult)
