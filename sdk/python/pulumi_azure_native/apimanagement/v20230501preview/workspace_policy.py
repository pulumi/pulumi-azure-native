...
class WorkspacePolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspacePolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspacePolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspacePolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspacePolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspacePolicy"), pulumi.Alias(type_="azure-native:apimanagement:WorkspacePolicy")])
