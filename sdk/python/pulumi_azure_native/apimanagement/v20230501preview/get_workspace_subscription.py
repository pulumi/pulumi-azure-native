...
def get_workspace_subscription(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:getWorkspaceSubscription', __args__, opts=opts, typ=GetWorkspaceSubscriptionResult).value
