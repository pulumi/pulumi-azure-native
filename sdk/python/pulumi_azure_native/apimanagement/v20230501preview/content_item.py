...
class ContentItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20191201:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20210101preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20210801:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement:ContentItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContentItem, __self__).__init__(
            'azure-native:apimanagement/v20230501preview:ContentItem',
            resource_name,
            __props__,
            opts)
