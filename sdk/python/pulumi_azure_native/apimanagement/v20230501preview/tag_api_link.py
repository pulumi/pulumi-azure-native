...
class TagApiLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:TagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:TagApiLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagApiLink, __self__).__init__(
            'azure-native:apimanagement/v20230501preview:TagApiLink',
            resource_name,
            __props__,
            opts)
