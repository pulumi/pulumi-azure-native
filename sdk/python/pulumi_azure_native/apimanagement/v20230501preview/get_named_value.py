...
def get_named_value(named_value_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:getNamedValue', __args__, opts=opts, typ=GetNamedValueResult).value
...
def get_named_value_output(named_value_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230501preview:getNamedValue', __args__, opts=opts, typ=GetNamedValueResult)
