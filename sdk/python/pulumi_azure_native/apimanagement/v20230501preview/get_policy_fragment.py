...
def get_policy_fragment(format: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:getPolicyFragment', __args__, opts=opts, typ=GetPolicyFragmentResult).value
...
def get_policy_fragment_output(format: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230501preview:getPolicyFragment', __args__, opts=opts, typ=GetPolicyFragmentResult)
