...
def get_tag_by_api(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230501preview:getTagByApi', __args__, opts=opts, typ=GetTagByApiResult).value
...
def get_tag_by_api_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['tagId'] = tag_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230501preview:getTagByApi', __args__, opts=opts, typ=GetTagByApiResult)
