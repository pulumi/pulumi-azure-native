...
class WorkspaceProductApiLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceProductApiLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceProductApiLink, __self__).__init__(
            'azure-native:apimanagement/v20230501preview:WorkspaceProductApiLink',
            resource_name,
            __props__,
            opts)
