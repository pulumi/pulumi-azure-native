...
class WorkspaceApiOperationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApiOperationPolicy")])
