...
class WorkspaceApiArgs:
    def __init__(__self__, *,
                 ...
                 api_revision: Optional[pulumi.Input[builtins.str]] = None,
                 api_revision_description: Optional[pulumi.Input[builtins.str]] = None,
                 api_type: Optional[pulumi.Input[Union[builtins.str, 'ApiType']]] = None,
                 api_version: Optional[pulumi.Input[builtins.str]] = None,
                 api_version_description: Optional[pulumi.Input[builtins.str]] = None,
                 api_version_set: Optional[pulumi.Input['ApiVersionSetContractDetailsArgs']] = None,
                 api_version_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 format: Optional[pulumi.Input[Union[builtins.str, 'ContentFormat']]] = None,
                 is_current: Optional[pulumi.Input[builtins.bool]] = None,
                 license: Optional[pulumi.Input['ApiLicenseInformationArgs']] = None,
                 protocols: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'Protocol']]]]] = None,
                 service_url: Optional[pulumi.Input[builtins.str]] = None,
                 soap_api_type: Optional[pulumi.Input[Union[builtins.str, 'SoapApiType']]] = None,
                 ...
                 translate_required_query_parameters_conduct: Optional[pulumi.Input[Union[builtins.str, 'TranslateRequiredQueryParametersConduct']]] = None,
        ...
        :param pulumi.Input[builtins.str] path: Relative URL uniquely identifying this API and all of its resource paths within the API Management service instance. It is appended to the API endpoint base URL specified during the service instance creation to form a public URL for this API.
        ...
        :param pulumi.Input[builtins.str] api_revision: Describes the revision of the API. If no value is provided, default revision 1 is created
        :param pulumi.Input[builtins.str] api_revision_description: Description of the API Revision.
        :param pulumi.Input[Union[builtins.str, 'ApiType']] api_type: Type of API.
        :param pulumi.Input[builtins.str] api_version: Indicates the version identifier of the API if the API is versioned
        :param pulumi.Input[builtins.str] api_version_description: Description of the API Version.
        :param pulumi.Input['ApiVersionSetContractDetailsArgs'] api_version_set: Version set details
        :param pulumi.Input[builtins.str] api_version_set_id: A resource identifier for the related ApiVersionSet.
        ...
        :param pulumi.Input[builtins.str] description: Description of the API. May include HTML formatting tags.
        :param pulumi.Input[builtins.str] display_name: API name. Must be 1 to 300 characters long.
        :param pulumi.Input[Union[builtins.str, 'ContentFormat']] format: Format of the Content in which the API is getting imported.
        :param pulumi.Input[builtins.bool] is_current: Indicates if API revision is current api revision.
        :param pulumi.Input['ApiLicenseInformationArgs'] license: License information for the API.
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'Protocol']]]] protocols: Describes on which protocols the operations in this API can be invoked.
        :param pulumi.Input[builtins.str] service_url: Absolute URL of the backend service implementing this API. Cannot be more than 2000 characters long.
        :param pulumi.Input[Union[builtins.str, 'SoapApiType']] soap_api_type: Type of API to create. 
                * `http` creates a REST API 
                * `soap` creates a SOAP pass-through API  
                * `websocket` creates websocket API 
                * `graphql` creates GraphQL API.
        :param pulumi.Input[builtins.str] source_api_id: API identifier of the source API.
        ...
        :param pulumi.Input[builtins.bool] subscription_required: Specifies whether an API or Product subscription is required for accessing the API.
        :param pulumi.Input[builtins.str] terms_of_service_url:  A URL to the Terms of Service for the API. MUST be in the format of a URL.
        :param pulumi.Input[Union[builtins.str, 'TranslateRequiredQueryParametersConduct']] translate_required_query_parameters_conduct: Strategy of translating required query parameters to template ones. By default has value 'template'. Possible values: 'template', 'query'
        :param pulumi.Input[builtins.str] value: Content value when Importing an API.
    ...
    def api_revision(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @api_revision.setter
    def api_revision(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_revision", value)

    @property
    @pulumi.getter(name="apiRevisionDescription")
    def api_revision_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_revision_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def api_version_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_version_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def api_version_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_version_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def format(self) -> Optional[pulumi.Input[Union[builtins.str, 'ContentFormat']]]:
        """
    ...
    @format.setter
    def format(self, value: Optional[pulumi.Input[Union[builtins.str, 'ContentFormat']]]):
        pulumi.set(self, "format", value)

    @property
    @pulumi.getter(name="isCurrent")
    def is_current(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_current.setter
    def is_current(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def protocols(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'Protocol']]]]]:
        """
    ...
    @protocols.setter
    def protocols(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'Protocol']]]]]):
    ...
    def soap_api_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'SoapApiType']]]:
        """
    ...
    def soap_api_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'SoapApiType']]]):
    ...
    def translate_required_query_parameters_conduct(self) -> Optional[pulumi.Input[Union[builtins.str, 'TranslateRequiredQueryParametersConduct']]]:
        """
    ...
    def translate_required_query_parameters_conduct(self, value: Optional[pulumi.Input[Union[builtins.str, 'TranslateRequiredQueryParametersConduct']]]):
...
class WorkspaceApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:WorkspaceApi")])
    ...
    @property
    @pulumi.getter(name="apiRevision")
    def api_revision(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Describes the revision of the API. If no value is provided, default revision 1 is created
        """
        return pulumi.get(self, "api_revision")
    ...
    @property
    @pulumi.getter(name="apiRevisionDescription")
    def api_revision_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Description of the API Revision.
        """
        return pulumi.get(self, "api_revision_description")
    ...
    @property
    @pulumi.getter(name="apiVersionDescription")
    def api_version_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Description of the API Version.
        """
        return pulumi.get(self, "api_version_description")
    ...
    @property
    @pulumi.getter(name="apiVersionSetId")
    def api_version_set_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A resource identifier for the related ApiVersionSet.
        """
        return pulumi.get(self, "api_version_set_id")
    ...
    @property
    @pulumi.getter(name="isCurrent")
    def is_current(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates if API revision is current api revision.
        """
        return pulumi.get(self, "is_current")
    ...
    def is_online(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter(name="sourceApiId")
    def source_api_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        API identifier of the source API.
        """
        return pulumi.get(self, "source_api_id")
