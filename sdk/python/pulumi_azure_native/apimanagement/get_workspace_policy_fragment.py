...
def get_workspace_policy_fragment(format: Optional[_builtins.str] = None,
...
def get_workspace_policy_fragment_output(format: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
