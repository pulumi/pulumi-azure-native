...
__all__ = ['ProductApiLinkArgs', 'ProductApiLink']
...
class ProductApiLinkArgs:
    def __init__(__self__, *,
                 ...
                 api_link_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ProductApiLink resource.
        :param pulumi.Input[builtins.str] api_id: Full resource Id of an API.
        ...
        :param pulumi.Input[builtins.str] api_link_id: Product-API link identifier. Must be unique in the current API Management service instance.
        """
    ...
    def api_link_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @api_link_id.setter
    def api_link_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ProductApiLink(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProductApiLinkArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProductApiLinkArgs.__new__(ProductApiLinkArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:ProductApiLink")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ProductApiLink':
        """
        ...
        __props__.__dict__["name"] = None
        __props__.__dict__["type"] = None
        return ProductApiLink(resource_name, opts=opts, __props__=__props__)
