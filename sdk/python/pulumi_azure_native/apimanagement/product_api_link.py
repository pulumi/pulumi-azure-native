...
class ProductApiLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ProductApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ProductApiLink")])
