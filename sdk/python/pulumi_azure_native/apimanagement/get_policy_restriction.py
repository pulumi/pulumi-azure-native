...
def get_policy_restriction(policy_restriction_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str policy_restriction_id: Policy restrictions after an entity level
...
def get_policy_restriction_output(policy_restriction_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
