...
def get_workspace_named_value(named_value_id: Optional[_builtins.str] = None,
...
def get_workspace_named_value_output(named_value_id: pulumi.Input[Optional[_builtins.str]] = None,
