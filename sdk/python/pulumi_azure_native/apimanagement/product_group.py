...
class ProductGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_id: Group identifier. Must be unique in the current API Management service instance.
        """
...
@pulumi.type_token("azure-native:apimanagement:ProductGroup")
