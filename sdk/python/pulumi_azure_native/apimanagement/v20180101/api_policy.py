...
warnings.warn("""azure-native:apimanagement/v20180101:ApiPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:ApiPolicy to guarantee forwards compatibility.""", DeprecationWarning)
