...
warnings.warn("""azure-native:apimanagement/v20180101:Policy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180601preview:Policy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_policy(policy_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy is deprecated: azure-native:apimanagement/v20180101:Policy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180601preview:Policy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['policyId'] = policy_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20180101:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
