...
warnings.warn("""azure-native:apimanagement/v20180101:ProductApi is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:ProductApi to guarantee forwards compatibility.""", DeprecationWarning)
...
class ProductApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ProductApi is deprecated: azure-native:apimanagement/v20180101:ProductApi is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:ProductApi to guarantee forwards compatibility.""")
