...
warnings.warn("""azure-native:apimanagement/v20180101:Property is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:Property to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_property(prop_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_property is deprecated: azure-native:apimanagement/v20180101:Property is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:Property to guarantee forwards compatibility.""")
    __args__ = dict()
