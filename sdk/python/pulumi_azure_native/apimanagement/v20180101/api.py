...
warnings.warn("""azure-native:apimanagement/v20180101:Api is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:Api to guarantee forwards compatibility.""", DeprecationWarning)
...
class Api(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 wsdl_selector: Optional[pulumi.Input[pulumi.InputType['ApiCreateOrUpdatePropertiesWsdlSelectorArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Api is deprecated: azure-native:apimanagement/v20180101:Api is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:Api to guarantee forwards compatibility.""")
