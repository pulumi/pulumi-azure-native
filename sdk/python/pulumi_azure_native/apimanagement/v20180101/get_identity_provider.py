...
def get_identity_provider(identity_provider_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_identity_provider is deprecated: azure-native:apimanagement/v20180101:IdentityProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:IdentityProvider to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['identityProviderName'] = identity_provider_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20180101:getIdentityProvider', __args__, opts=opts, typ=GetIdentityProviderResult).value
