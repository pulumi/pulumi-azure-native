...
warnings.warn("""azure-native:apimanagement/v20180101:ProductPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:ProductPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_product_policy(policy_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_product_policy is deprecated: azure-native:apimanagement/v20180101:ProductPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:ProductPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
