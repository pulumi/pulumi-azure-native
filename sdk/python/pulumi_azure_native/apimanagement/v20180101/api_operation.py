...
warnings.warn("""azure-native:apimanagement/v20180101:ApiOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperation to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 url_template: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiOperation is deprecated: azure-native:apimanagement/v20180101:ApiOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperation to guarantee forwards compatibility.""")
