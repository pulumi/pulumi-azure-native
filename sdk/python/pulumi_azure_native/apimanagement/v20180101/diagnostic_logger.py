...
class DiagnosticLogger(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:DiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement:DiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/latest:DiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:DiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:DiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:DiagnosticLogger")])
