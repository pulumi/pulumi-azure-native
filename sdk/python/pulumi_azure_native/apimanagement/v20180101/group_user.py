...
class GroupUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:GroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:GroupUser")])
