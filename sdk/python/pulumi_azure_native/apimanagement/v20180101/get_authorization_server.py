...
def get_authorization_server(authsid: Optional[str] = None,
    ...
    return AwaitableGetAuthorizationServerResult(
        ...
        client_registration_endpoint=pulumi.get(__ret__, 'client_registration_endpoint'),
        client_secret=pulumi.get(__ret__, 'client_secret'),
        default_scope=pulumi.get(__ret__, 'default_scope'),
        ...
        support_state=pulumi.get(__ret__, 'support_state'),
        token_body_parameters=pulumi.get(__ret__, 'token_body_parameters'),
...
def get_authorization_server_output(authsid: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20180101:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult)
