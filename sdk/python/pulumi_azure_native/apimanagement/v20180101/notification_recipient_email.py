...
warnings.warn("""azure-native:apimanagement/v20180101:NotificationRecipientEmail is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NotificationRecipientEmail to guarantee forwards compatibility.""", DeprecationWarning)
...
class NotificationRecipientEmail(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""NotificationRecipientEmail is deprecated: azure-native:apimanagement/v20180101:NotificationRecipientEmail is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NotificationRecipientEmail to guarantee forwards compatibility.""")
