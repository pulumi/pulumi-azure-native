...
class ApiDiagnosticLogger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        api_diagnostic_logger = azure_native.apimanagement.v20180101.ApiDiagnosticLogger("apiDiagnosticLogger",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20170301:ApiDiagnosticLogger")])
