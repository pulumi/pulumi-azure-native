...
def get_workspace_product_api_link(api_link_id: Optional[builtins.str] = None,
...
def get_workspace_product_api_link_output(api_link_id: Optional[pulumi.Input[builtins.str]] = None,
