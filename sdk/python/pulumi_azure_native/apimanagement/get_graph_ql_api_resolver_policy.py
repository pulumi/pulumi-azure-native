...
def get_graph_ql_api_resolver_policy(api_id: Optional[builtins.str] = None,
...
def get_graph_ql_api_resolver_policy_output(api_id: Optional[pulumi.Input[builtins.str]] = None,
