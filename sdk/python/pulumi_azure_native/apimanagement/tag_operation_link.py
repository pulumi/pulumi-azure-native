...
class TagOperationLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:TagOperationLink"), pulumi.Alias(type_="azure-native_apimanagement_v20220901preview:apimanagement:TagOperationLink"), pulumi.Alias(type_="azure-native_apimanagement_v20230301preview:apimanagement:TagOperationLink"), pulumi.Alias(type_="azure-native_apimanagement_v20230501preview:apimanagement:TagOperationLink"), pulumi.Alias(type_="azure-native_apimanagement_v20230901preview:apimanagement:TagOperationLink"), pulumi.Alias(type_="azure-native_apimanagement_v20240501:apimanagement:TagOperationLink"), pulumi.Alias(type_="azure-native_apimanagement_v20240601preview:apimanagement:TagOperationLink")])
