...
def get_api_operation_policy(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_operation_policy is deprecated: azure-native:apimanagement/v20190101:ApiOperationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperationPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20190101:getApiOperationPolicy', __args__, opts=opts, typ=GetApiOperationPolicyResult).value
