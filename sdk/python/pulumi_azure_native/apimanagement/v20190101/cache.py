...
warnings.warn("""azure-native:apimanagement/v20190101:Cache is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20191201preview:Cache to guarantee forwards compatibility.""", DeprecationWarning)
...
class Cache(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Cache is deprecated: azure-native:apimanagement/v20190101:Cache is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20191201preview:Cache to guarantee forwards compatibility.""")
