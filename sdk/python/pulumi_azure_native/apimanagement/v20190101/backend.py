...
warnings.warn("""azure-native:apimanagement/v20190101:Backend is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Backend to guarantee forwards compatibility.""", DeprecationWarning)
...
class Backend(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 url: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Backend is deprecated: azure-native:apimanagement/v20190101:Backend is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Backend to guarantee forwards compatibility.""")
