...
class EmailTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 title: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""EmailTemplate is deprecated: azure-native:apimanagement/v20190101:EmailTemplate is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:EmailTemplate to guarantee forwards compatibility.""")
