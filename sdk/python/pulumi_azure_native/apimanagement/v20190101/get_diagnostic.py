...
def get_diagnostic(diagnostic_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20190101:getDiagnostic', __args__, opts=opts, typ=GetDiagnosticResult).value
...
def get_diagnostic_output(diagnostic_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20190101:getDiagnostic', __args__, opts=opts, typ=GetDiagnosticResult)
    return __ret__.apply(lambda __response__: GetDiagnosticResult(
        always_log=pulumi.get(__response__, 'always_log'),
        backend=pulumi.get(__response__, 'backend'),
        enable_http_correlation_headers=pulumi.get(__response__, 'enable_http_correlation_headers'),
