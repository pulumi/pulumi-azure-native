...
warnings.warn("""azure-native:apimanagement/v20190101:User is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:User to guarantee forwards compatibility.""", DeprecationWarning)
...
class User(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""User is deprecated: azure-native:apimanagement/v20190101:User is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:User to guarantee forwards compatibility.""")
