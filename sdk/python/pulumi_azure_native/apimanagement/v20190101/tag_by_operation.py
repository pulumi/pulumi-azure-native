...
class TagByOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20210101preview:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20210101preview:TagByOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:TagByOperation"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20210401preview:TagByOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagByOperation, __self__).__init__(
            'azure-native:apimanagement/v20190101:TagByOperation',
            resource_name,
            __props__,
            opts)
