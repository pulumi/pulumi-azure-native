...
def get_tag_by_operation(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_by_operation is deprecated: azure-native:apimanagement/v20190101:TagByOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.""")
    __args__ = dict()
