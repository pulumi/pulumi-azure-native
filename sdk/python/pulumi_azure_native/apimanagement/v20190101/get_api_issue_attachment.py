...
def get_api_issue_attachment(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_issue_attachment is deprecated: azure-native:apimanagement/v20190101:ApiIssueAttachment is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiIssueAttachment to guarantee forwards compatibility.""")
    __args__ = dict()
