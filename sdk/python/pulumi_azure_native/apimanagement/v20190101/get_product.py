...
warnings.warn("""azure-native:apimanagement/v20190101:Product is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Product to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_product(product_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_product is deprecated: azure-native:apimanagement/v20190101:Product is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Product to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['productId'] = product_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20190101:getProduct', __args__, opts=opts, typ=GetProductResult).value
