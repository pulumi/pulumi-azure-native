...
warnings.warn("""azure-native:apimanagement/v20190101:Product is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Product to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_product(product_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_product is deprecated: azure-native:apimanagement/v20190101:Product is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Product to guarantee forwards compatibility.""")
    __args__ = dict()
