...
def list_policy_fragment_references(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230301preview:listPolicyFragmentReferences', __args__, opts=opts, typ=ListPolicyFragmentReferencesResult).value
...
def list_policy_fragment_references_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['top'] = top
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230301preview:listPolicyFragmentReferences', __args__, opts=opts, typ=ListPolicyFragmentReferencesResult)
