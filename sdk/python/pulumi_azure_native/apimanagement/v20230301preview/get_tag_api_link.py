...
def get_tag_api_link(api_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230301preview:getTagApiLink', __args__, opts=opts, typ=GetTagApiLinkResult).value
...
def get_tag_api_link_output(api_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['tagId'] = tag_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230301preview:getTagApiLink', __args__, opts=opts, typ=GetTagApiLinkResult)
