...
class WorkspaceApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(api_version_set, ApiVersionSetContractDetailsArgs):
            ...
            if not isinstance(contact, ApiContactInformationArgs):
                contact = contact or {}
                def _setter(key, value):
                    contact[key] = value
            ...
            if not isinstance(license, ApiLicenseInformationArgs):
                license = license or {}
                def _setter(key, value):
                    license[key] = value
