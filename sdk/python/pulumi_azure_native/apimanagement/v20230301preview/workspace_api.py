...
class WorkspaceApiArgs:
    def __init__(__self__, *,
        ...
        if translate_required_query_parameters_conduct is not None:
            pulumi.set(__self__, "translate_required_query_parameters_conduct", translate_required_query_parameters_conduct)
...
class WorkspaceApi(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 contact: Optional[pulumi.Input[Union['ApiContactInformationArgs', 'ApiContactInformationArgsDict']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 format: Optional[pulumi.Input[Union[str, 'ContentFormat']]] = None,
                 is_current: Optional[pulumi.Input[bool]] = None,
                 license: Optional[pulumi.Input[Union['ApiLicenseInformationArgs', 'ApiLicenseInformationArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceApi")])
