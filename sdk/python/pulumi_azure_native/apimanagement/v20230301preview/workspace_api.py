...
class WorkspaceApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApi"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApi")])
