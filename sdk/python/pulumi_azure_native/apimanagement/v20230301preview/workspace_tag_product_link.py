...
class WorkspaceTagProductLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceTagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceTagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceTagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceTagProductLink")])
