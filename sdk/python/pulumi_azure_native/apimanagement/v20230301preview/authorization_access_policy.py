...
class AuthorizationAccessPolicyArgs:
    ...
    def _configure(
        ...
        if authorization_id is None:
            raise TypeError("Missing 'authorization_id' argument")
        ...
        if authorization_access_policy_id is None and 'authorizationAccessPolicyId' in kwargs:
...
class AuthorizationAccessPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:AuthorizationAccessPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:AuthorizationAccessPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:AuthorizationAccessPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:AuthorizationAccessPolicy")])
