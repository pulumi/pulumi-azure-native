...
def get_content_type(content_type_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230301preview:getContentType', __args__, opts=opts, typ=GetContentTypeResult).value
...
def get_content_type_output(content_type_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230301preview:getContentType', __args__, opts=opts, typ=GetContentTypeResult)
