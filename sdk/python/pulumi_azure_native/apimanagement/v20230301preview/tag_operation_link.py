...
class TagOperationLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:TagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:TagOperationLink")])
