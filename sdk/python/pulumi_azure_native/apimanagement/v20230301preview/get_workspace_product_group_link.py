...
def get_workspace_product_group_link(group_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230301preview:getWorkspaceProductGroupLink', __args__, opts=opts, typ=GetWorkspaceProductGroupLinkResult).value
...
def get_workspace_product_group_link_output(group_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230301preview:getWorkspaceProductGroupLink', __args__, opts=opts, typ=GetWorkspaceProductGroupLinkResult)
