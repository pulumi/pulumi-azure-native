...
def get_workspace_group(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230301preview:getWorkspaceGroup', __args__, opts=opts, typ=GetWorkspaceGroupResult).value
...
def get_workspace_group_output(group_id: Optional[pulumi.Input[str]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWorkspaceGroupResult]:
    """
    Gets the details of the group specified by its identifier.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230301preview:getWorkspaceGroup', __args__, opts=opts, typ=GetWorkspaceGroupResult)
    return __ret__.apply(lambda __response__: GetWorkspaceGroupResult(
