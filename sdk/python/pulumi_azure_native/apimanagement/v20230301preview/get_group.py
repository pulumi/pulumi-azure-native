...
def get_group(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230301preview:getGroup', __args__, opts=opts, typ=GetGroupResult).value
...
def get_group_output(group_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230301preview:getGroup', __args__, opts=opts, typ=GetGroupResult)
