...
class TagProductLink(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TagProductLinkArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TagProductLinkArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TagProductLinkArgs.__new__(TagProductLinkArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:TagProductLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagProductLink, __self__).__init__(
            'azure-native:apimanagement/v20230301preview:TagProductLink',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TagProductLink':
        """
        ...
        __props__.__dict__["type"] = None
        return TagProductLink(resource_name, opts=opts, __props__=__props__)
