...
class ApiManagementService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(api_version_constraint, ApiVersionConstraintArgs):
            ...
            if not isinstance(configuration_api, ConfigurationApiArgs):
            ...
            if not isinstance(identity, ApiManagementServiceIdentityArgs):
