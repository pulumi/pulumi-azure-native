...
class ApiManagementService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if configuration_api is not None and not isinstance(configuration_api, ConfigurationApiArgs):
                configuration_api = configuration_api or {}
                def _setter(key, value):
                    configuration_api[key] = value
                ConfigurationApiArgs._configure(_setter, **configuration_api)
