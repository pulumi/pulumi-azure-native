...
class ApiManagementServiceArgs:
    ...
    def _configure(
        ...
        if api_version_constraint is None and 'apiVersionConstraint' in kwargs:
            api_version_constraint = kwargs['apiVersionConstraint']
        if configuration_api is None and 'configurationApi' in kwargs:
            configuration_api = kwargs['configurationApi']
        if custom_properties is None and 'customProperties' in kwargs:
            custom_properties = kwargs['customProperties']
        if developer_portal_status is None and 'developerPortalStatus' in kwargs:
            developer_portal_status = kwargs['developerPortalStatus']
        if disable_gateway is None and 'disableGateway' in kwargs:
            disable_gateway = kwargs['disableGateway']
        if enable_client_certificate is None and 'enableClientCertificate' in kwargs:
            enable_client_certificate = kwargs['enableClientCertificate']
        if hostname_configurations is None and 'hostnameConfigurations' in kwargs:
            hostname_configurations = kwargs['hostnameConfigurations']
        if legacy_portal_status is None and 'legacyPortalStatus' in kwargs:
            legacy_portal_status = kwargs['legacyPortalStatus']
        ...
        if configuration_api is not None:
            _setter("configuration_api", configuration_api)
        ...
        if developer_portal_status is not None:
            _setter("developer_portal_status", developer_portal_status)
        ...
        if legacy_portal_status is not None:
            _setter("legacy_portal_status", legacy_portal_status)
...
class ApiManagementService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            api_version_constraint = _utilities.configure(api_version_constraint, ApiVersionConstraintArgs, True)
            __props__.__dict__["api_version_constraint"] = api_version_constraint
            __props__.__dict__["certificates"] = certificates
            configuration_api = _utilities.configure(configuration_api, ConfigurationApiArgs, True)
            ...
            identity = _utilities.configure(identity, ApiManagementServiceIdentityArgs, True)
            ...
            sku = _utilities.configure(sku, ApiManagementServiceSkuPropertiesArgs, True)
        ...
        super(ApiManagementService, __self__).__init__(
            'azure-native:apimanagement/v20230301preview:ApiManagementService',
            resource_name,
            __props__,
            opts)
