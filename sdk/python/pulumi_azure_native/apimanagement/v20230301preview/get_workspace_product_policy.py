...
def get_workspace_product_policy(format: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230301preview:getWorkspaceProductPolicy', __args__, opts=opts, typ=GetWorkspaceProductPolicyResult).value
...
def get_workspace_product_policy_output(format: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230301preview:getWorkspaceProductPolicy', __args__, opts=opts, typ=GetWorkspaceProductPolicyResult)
