...
class WorkspaceGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceGroup"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceGroup")])
