...
class WorkspaceApiOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApiOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceApiOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApiOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceApiOperation"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceApiOperation"), pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApiOperation")])
