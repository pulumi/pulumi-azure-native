...
class GroupArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def type(self) -> pulumi.Input[Optional['GroupType']]:
        """
        Group type.
        """
    ...
    @type.setter
    def type(self, value: pulumi.Input[Optional['GroupType']]):
