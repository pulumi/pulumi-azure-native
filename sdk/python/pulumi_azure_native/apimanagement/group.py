...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Group name.
        ...
        :param pulumi.Input[builtins.str] external_id: Identifier of the external groups, this property contains the id of the group from the external identity provider, e.g. for Azure Active Directory `aad://<tenant>.onmicrosoft.com/groups/<group object id>`; otherwise the value is null.
