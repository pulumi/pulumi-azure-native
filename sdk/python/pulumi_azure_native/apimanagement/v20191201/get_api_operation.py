...
warnings.warn("""azure-native:apimanagement/v20191201:ApiOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiOperation to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_operation(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_operation is deprecated: azure-native:apimanagement/v20191201:ApiOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiOperation to guarantee forwards compatibility.""")
    __args__ = dict()
