...
def get_authorization_server(authsid: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization_server is deprecated: azure-native:apimanagement/v20191201:AuthorizationServer is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:AuthorizationServer to guarantee forwards compatibility.""")
    __args__ = dict()
