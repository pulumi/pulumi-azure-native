...
def get_api_issue(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_issue is deprecated: azure-native:apimanagement/v20191201:ApiIssue is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiIssue to guarantee forwards compatibility.""")
    __args__ = dict()
