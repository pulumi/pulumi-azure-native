...
warnings.warn("""azure-native:apimanagement/v20191201:Logger is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20191201preview:Logger to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_logger(logger_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_logger is deprecated: azure-native:apimanagement/v20191201:Logger is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20191201preview:Logger to guarantee forwards compatibility.""")
    __args__ = dict()
