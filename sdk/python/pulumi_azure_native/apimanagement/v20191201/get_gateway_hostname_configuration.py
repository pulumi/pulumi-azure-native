...
def get_gateway_hostname_configuration(gateway_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway_hostname_configuration is deprecated: azure-native:apimanagement/v20191201:GatewayHostnameConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayHostnameConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20191201:getGatewayHostnameConfiguration', __args__, opts=opts, typ=GetGatewayHostnameConfigurationResult).value
