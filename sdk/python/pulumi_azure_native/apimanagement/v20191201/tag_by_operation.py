...
warnings.warn("""azure-native:apimanagement/v20191201:TagByOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.""", DeprecationWarning)
...
class TagByOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tag_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TagByOperation is deprecated: azure-native:apimanagement/v20191201:TagByOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.""")
