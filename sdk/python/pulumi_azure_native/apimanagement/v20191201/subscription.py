...
class Subscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 state: Optional[pulumi.Input['SubscriptionState']] = None,
                 __props__=None):
        pulumi.log.warn("""Subscription is deprecated: azure-native:apimanagement/v20191201:Subscription is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Subscription to guarantee forwards compatibility.""")
