...
def get_api_issue_comment(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_issue_comment is deprecated: azure-native:apimanagement/v20191201:ApiIssueComment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiIssueComment to guarantee forwards compatibility.""")
    __args__ = dict()
