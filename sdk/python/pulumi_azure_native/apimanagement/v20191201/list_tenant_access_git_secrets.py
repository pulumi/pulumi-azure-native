...
def list_tenant_access_git_secrets(access_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20191201:listTenantAccessGitSecrets', __args__, opts=opts, typ=ListTenantAccessGitSecretsResult).value
...
def list_tenant_access_git_secrets_output(access_name: Optional[pulumi.Input[str]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListTenantAccessGitSecretsResult]:
    """
    Gets the Git access configuration for the tenant.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20191201:listTenantAccessGitSecrets', __args__, opts=opts, typ=ListTenantAccessGitSecretsResult)
    return __ret__.apply(lambda __response__: ListTenantAccessGitSecretsResult(
