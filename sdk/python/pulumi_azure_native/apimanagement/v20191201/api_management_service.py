...
warnings.warn("""azure-native:apimanagement/v20191201:ApiManagementService is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiManagementService to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiManagementService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_type: Optional[pulumi.Input[Union[str, 'VirtualNetworkType']]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiManagementService is deprecated: azure-native:apimanagement/v20191201:ApiManagementService is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiManagementService to guarantee forwards compatibility.""")
