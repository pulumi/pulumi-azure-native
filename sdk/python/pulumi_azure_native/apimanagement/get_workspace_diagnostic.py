...
def get_workspace_diagnostic(diagnostic_id: Optional[builtins.str] = None,
...
def get_workspace_diagnostic_output(diagnostic_id: Optional[pulumi.Input[builtins.str]] = None,
