...
def get_workspace_diagnostic(diagnostic_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str diagnostic_id: Diagnostic identifier. Must be unique in the current API Management service instance.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getWorkspaceDiagnostic', __args__, opts=opts, typ=GetWorkspaceDiagnosticResult).value
...
def get_workspace_diagnostic_output(diagnostic_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
