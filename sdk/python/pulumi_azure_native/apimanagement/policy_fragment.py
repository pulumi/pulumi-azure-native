...
class PolicyFragment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:PolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:PolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:PolicyFragment")])
