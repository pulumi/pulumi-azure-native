...
class AuthorizationServerArgs:
    def __init__(__self__, *,
                 ...
                 grant_types: pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'GrantType']]]],
                 resource_group_name: pulumi.Input[builtins.str],
                 service_name: pulumi.Input[builtins.str],
                 authorization_methods: Optional[pulumi.Input[Sequence[pulumi.Input['AuthorizationMethod']]]] = None,
                 authsid: Optional[pulumi.Input[builtins.str]] = None,
                 bearer_token_sending_methods: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'BearerTokenSendingMethod']]]]] = None,
                 client_authentication_method: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ClientAuthenticationMethod']]]]] = None,
        ...
        :param pulumi.Input[builtins.str] authorization_endpoint: OAuth authorization endpoint. See http://tools.ietf.org/html/rfc6749#section-3.2.
        :param pulumi.Input[builtins.str] client_id: Client or app id registered with this authorization server.
        :param pulumi.Input[builtins.str] client_registration_endpoint: Optional reference to a page where client or app registration for this authorization server is performed. Contains absolute URL to entity being referenced.
        :param pulumi.Input[builtins.str] display_name: User-friendly authorization server name.
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'GrantType']]]] grant_types: Form of an authorization grant, which the client uses to request the access token.
        ...
        :param pulumi.Input[builtins.str] authsid: Identifier of the authorization server.
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'BearerTokenSendingMethod']]]] bearer_token_sending_methods: Specifies the mechanism by which access token is passed to the API. 
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ClientAuthenticationMethod']]]] client_authentication_method: Method of authentication supported by the token endpoint of this authorization server. Possible values are Basic and/or Body. When Body is specified, client credentials and other parameters are passed within the request body in the application/x-www-form-urlencoded format.
        :param pulumi.Input[builtins.str] client_secret: Client or app secret registered with this authorization server. This property will not be filled on 'GET' operations! Use '/listSecrets' POST request to get the value.
        :param pulumi.Input[builtins.str] default_scope: Access token scope that is going to be requested by default. Can be overridden at the API level. Should be provided in the form of a string containing space-delimited values.
        :param pulumi.Input[builtins.str] description: Description of the authorization server. Can contain HTML formatting tags.
        :param pulumi.Input[builtins.str] resource_owner_password: Can be optionally specified when resource owner password grant type is supported by this authorization server. Default resource owner password.
        :param pulumi.Input[builtins.str] resource_owner_username: Can be optionally specified when resource owner password grant type is supported by this authorization server. Default resource owner username.
        :param pulumi.Input[builtins.bool] support_state: If true, authorization server will include state parameter from the authorization request to its response. Client may use state parameter to raise protocol security.
        ...
        :param pulumi.Input[builtins.str] token_endpoint: OAuth token endpoint. Contains absolute URI to entity being referenced.
        :param pulumi.Input[builtins.bool] use_in_api_documentation: If true, the authorization server will be used in the API documentation in the developer portal. False by default if no value is provided.
        :param pulumi.Input[builtins.bool] use_in_test_console: If true, the authorization server may be used in the developer portal test console. True by default if no value is provided.
        """
    ...
    def grant_types(self) -> pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'GrantType']]]]:
        """
    ...
    @grant_types.setter
    def grant_types(self, value: pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'GrantType']]]]):
    ...
    @property
    @pulumi.getter
    def authsid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @authsid.setter
    def authsid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authsid", value)

    @property
    @pulumi.getter(name="bearerTokenSendingMethods")
    def bearer_token_sending_methods(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'BearerTokenSendingMethod']]]]]:
        """
    ...
    def bearer_token_sending_methods(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'BearerTokenSendingMethod']]]]]):
        pulumi.set(self, "bearer_token_sending_methods", value)

    @property
    @pulumi.getter(name="clientAuthenticationMethod")
    def client_authentication_method(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ClientAuthenticationMethod']]]]]:
        """
    ...
    def client_authentication_method(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ClientAuthenticationMethod']]]]]):
...
class AuthorizationServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 grant_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'GrantType']]]]] = None,
    ...
    @property
    @pulumi.getter(name="authorizationMethods")
    def authorization_methods(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        HTTP verbs supported by the authorization endpoint. GET must be always present. POST is optional.
        """
        return pulumi.get(self, "authorization_methods")
    ...
    @property
    @pulumi.getter(name="clientAuthenticationMethod")
    def client_authentication_method(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Method of authentication supported by the token endpoint of this authorization server. Possible values are Basic and/or Body. When Body is specified, client credentials and other parameters are passed within the request body in the application/x-www-form-urlencoded format.
        """
        return pulumi.get(self, "client_authentication_method")
