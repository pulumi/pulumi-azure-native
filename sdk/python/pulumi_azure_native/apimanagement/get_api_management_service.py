...
def get_api_management_service(resource_group_name: Optional[_builtins.str] = None,
...
def get_api_management_service_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
