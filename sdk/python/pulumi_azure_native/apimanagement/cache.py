...
class CacheArgs:
    def __init__(__self__, *,
                 ...
                 use_from_location: pulumi.Input[builtins.str],
                 cache_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 resource_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Cache resource.
        :param pulumi.Input[builtins.str] connection_string: Runtime connection string to cache
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] service_name: The name of the API Management service.
        :param pulumi.Input[builtins.str] use_from_location: Location identifier to use cache from (should be either 'default' or valid Azure region identifier)
        :param pulumi.Input[builtins.str] cache_id: Identifier of the Cache entity. Cache identifier (should be either 'default' or valid Azure region identifier).
        :param pulumi.Input[builtins.str] description: Cache description
        :param pulumi.Input[builtins.str] resource_id: Original uri of entity in external system cache points to
        """
    ...
    def use_from_location(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def use_from_location(self, value: pulumi.Input[builtins.str]):
...
class Cache(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 use_from_location: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
        Cache details.
    ...
    @property
    @pulumi.getter(name="useFromLocation")
    def use_from_location(self) -> pulumi.Output[builtins.str]:
        """
        Location identifier to use cache from (should be either 'default' or valid Azure region identifier)
        """
        return pulumi.get(self, "use_from_location")
