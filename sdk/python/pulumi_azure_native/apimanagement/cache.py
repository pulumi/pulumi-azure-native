...
class CacheArgs:
    ...
    def _configure(
        ...
        if use_from_location is None and 'useFromLocation' in kwargs:
            use_from_location = kwargs['useFromLocation']
        if use_from_location is None:
            raise TypeError("Missing 'use_from_location' argument")
