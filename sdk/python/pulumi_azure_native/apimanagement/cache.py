...
class Cache(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 use_from_location: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        Cache details.
