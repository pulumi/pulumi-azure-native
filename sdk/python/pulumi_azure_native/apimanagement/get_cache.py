...
def get_cache(cache_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cache_id: Identifier of the Cache entity. Cache identifier (should be either 'default' or valid Azure region identifier).
...
def get_cache_output(cache_id: pulumi.Input[Optional[_builtins.str]] = None,
