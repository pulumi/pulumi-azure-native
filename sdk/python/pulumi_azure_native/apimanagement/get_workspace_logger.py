...
def get_workspace_logger(logger_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getWorkspaceLogger', __args__, opts=opts, typ=GetWorkspaceLoggerResult).value
...
def get_workspace_logger_output(logger_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getWorkspaceLogger', __args__, opts=opts, typ=GetWorkspaceLoggerResult)
