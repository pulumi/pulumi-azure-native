...
class ApiIssueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: A resource identifier for the API the issue was created for.
        :param pulumi.Input[builtins.str] description: Text describing the issue.
        ...
        :param pulumi.Input[builtins.str] user_id: A resource identifier for the user created the issue.
        :param pulumi.Input[builtins.str] created_date: Date and time when the issue was created.
        :param pulumi.Input[builtins.str] issue_id: Issue identifier. Must be unique in the current API Management service instance.
        :param pulumi.Input[Union[builtins.str, 'State']] state: Status of the issue.
        """
    ...
    def issue_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @issue_id.setter
    def issue_id(self, value: Optional[pulumi.Input[builtins.str]]):
