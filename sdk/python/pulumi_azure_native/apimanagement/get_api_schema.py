...
def get_api_schema(api_id: Optional[builtins.str] = None,
...
def get_api_schema_output(api_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getApiSchema', __args__, opts=opts, typ=GetApiSchemaResult)
