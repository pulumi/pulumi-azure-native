...
warnings.warn("""azure-native:apimanagement/v20210801:ProductPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ProductPolicy to guarantee forwards compatibility.""", DeprecationWarning)
