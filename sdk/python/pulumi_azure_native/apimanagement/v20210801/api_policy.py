...
warnings.warn("""azure-native:apimanagement/v20210801:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiPolicy is deprecated: azure-native:apimanagement/v20210801:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiPolicy to guarantee forwards compatibility.""")
