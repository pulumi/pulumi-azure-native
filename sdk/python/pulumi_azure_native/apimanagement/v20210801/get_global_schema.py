...
def get_global_schema(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_global_schema is deprecated: azure-native:apimanagement/v20210801:GlobalSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GlobalSchema to guarantee forwards compatibility.""")
    __args__ = dict()
