...
warnings.warn("""azure-native:apimanagement/v20210801:EmailTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:EmailTemplate to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_email_template(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_email_template is deprecated: azure-native:apimanagement/v20210801:EmailTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:EmailTemplate to guarantee forwards compatibility.""")
    __args__ = dict()
