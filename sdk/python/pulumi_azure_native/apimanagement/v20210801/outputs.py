...
class ApiManagementServicePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_endpoint_connections: Optional[Sequence['outputs.RemotePrivateEndpointConnectionWrapperResponse']] = None,
                 public_ip_address_id: Optional[str] = None,
        ...
        :param str platform_version: Compute Platform Version running the service in this location.
        ...
        :param Sequence['RemotePrivateEndpointConnectionWrapperResponse'] private_endpoint_connections: List of Private Endpoint Connections of this service.
        :param str public_ip_address_id: Public Standard SKU IP V4 based IP address to be associated with Virtual Network deployed service in the region. Supported only for Developer and Premium SKU being deployed in Virtual Network.
        :param str public_network_access: Whether or not public endpoint access is allowed for this API Management service.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default value is 'Enabled'
