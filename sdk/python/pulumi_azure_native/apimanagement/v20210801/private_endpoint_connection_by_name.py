...
warnings.warn("""azure-native:apimanagement/v20210801:PrivateEndpointConnectionByName is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:PrivateEndpointConnectionByName to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnectionByName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(PrivateEndpointConnectionByName, __self__).__init__(
            'azure-native:apimanagement/v20210801:PrivateEndpointConnectionByName',
            resource_name,
            __props__,
            opts)
