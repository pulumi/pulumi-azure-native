...
def list_named_value(named_value_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20210801:listNamedValue', __args__, opts=opts, typ=ListNamedValueResult).value
...
def list_named_value_output(named_value_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20210801:listNamedValue', __args__, opts=opts, typ=ListNamedValueResult)
