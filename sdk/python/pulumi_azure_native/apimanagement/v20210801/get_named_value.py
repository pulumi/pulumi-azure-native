...
warnings.warn("""azure-native:apimanagement/v20210801:NamedValue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:NamedValue to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_named_value(named_value_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_named_value is deprecated: azure-native:apimanagement/v20210801:NamedValue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:NamedValue to guarantee forwards compatibility.""")
    __args__ = dict()
