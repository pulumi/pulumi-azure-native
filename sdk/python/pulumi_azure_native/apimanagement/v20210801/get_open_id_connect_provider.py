...
def get_open_id_connect_provider(opid: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_id_connect_provider is deprecated: azure-native:apimanagement/v20210801:OpenIdConnectProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:OpenIdConnectProvider to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['opid'] = opid
