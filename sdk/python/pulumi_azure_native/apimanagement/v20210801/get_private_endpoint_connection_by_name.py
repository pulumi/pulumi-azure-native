...
def get_private_endpoint_connection_by_name(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connection_by_name is deprecated: azure-native:apimanagement/v20210801:PrivateEndpointConnectionByName is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:PrivateEndpointConnectionByName to guarantee forwards compatibility.""")
    __args__ = dict()
