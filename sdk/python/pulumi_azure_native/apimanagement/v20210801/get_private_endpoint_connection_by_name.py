...
def get_private_endpoint_connection_by_name(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connection_by_name is deprecated: azure-native:apimanagement/v20210801:PrivateEndpointConnectionByName is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:PrivateEndpointConnectionByName to guarantee forwards compatibility.""")
    __args__ = dict()
