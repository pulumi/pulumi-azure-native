...
warnings.warn("""azure-native:apimanagement/v20210801:TagByOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_tag_by_operation(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_by_operation is deprecated: azure-native:apimanagement/v20210801:TagByOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.""")
    __args__ = dict()
