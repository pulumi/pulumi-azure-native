...
class AuthorizationServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 token_endpoint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AuthorizationServer is deprecated: azure-native:apimanagement/v20210801:AuthorizationServer is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:AuthorizationServer to guarantee forwards compatibility.""")
        ...
        super(AuthorizationServer, __self__).__init__(
            'azure-native:apimanagement/v20210801:AuthorizationServer',
            resource_name,
            __props__,
            opts)
