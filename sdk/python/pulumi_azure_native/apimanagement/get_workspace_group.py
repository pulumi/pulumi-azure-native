...
def get_workspace_group(group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str group_id: Group identifier. Must be unique in the current API Management service instance.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getWorkspaceGroup', __args__, opts=opts, typ=GetWorkspaceGroupResult).value
...
def get_workspace_group_output(group_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getWorkspaceGroup', __args__, opts=opts, typ=GetWorkspaceGroupResult)
