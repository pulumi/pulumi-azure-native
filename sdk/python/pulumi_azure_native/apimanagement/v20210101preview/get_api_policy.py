...
def get_api_policy(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_policy is deprecated: azure-native:apimanagement/v20210101preview:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
