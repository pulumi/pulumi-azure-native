...
def get_diagnostic(diagnostic_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_diagnostic is deprecated: azure-native:apimanagement/v20210101preview:Diagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Diagnostic to guarantee forwards compatibility.""")
    __args__ = dict()
