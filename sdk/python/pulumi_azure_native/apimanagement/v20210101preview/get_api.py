...
warnings.warn("""azure-native:apimanagement/v20210101preview:Api is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Api to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api is deprecated: azure-native:apimanagement/v20210101preview:Api is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Api to guarantee forwards compatibility.""")
    __args__ = dict()
