...
warnings.warn("""azure-native:apimanagement/v20210101preview:ProductGroup is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ProductGroup to guarantee forwards compatibility.""", DeprecationWarning)
