...
warnings.warn("""azure-native:apimanagement/v20210101preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Backend to guarantee forwards compatibility.""", DeprecationWarning)
