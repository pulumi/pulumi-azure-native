...
warnings.warn("""azure-native:apimanagement/v20210101preview:NotificationRecipientEmail is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:NotificationRecipientEmail to guarantee forwards compatibility.""", DeprecationWarning)
