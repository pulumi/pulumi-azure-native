...
class GetGatewayHostnameConfigurationResult:
    ...
    def tls10_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def tls11_enabled(self) -> Optional[builtins.bool]:
        """
...
def get_gateway_hostname_configuration(gateway_id: Optional[builtins.str] = None,
                                       hc_id: Optional[builtins.str] = None,
    ...
    :param builtins.str hc_id: Gateway hostname configuration identifier. Must be unique in the scope of parent Gateway entity.
...
def get_gateway_hostname_configuration_output(gateway_id: Optional[pulumi.Input[builtins.str]] = None,
