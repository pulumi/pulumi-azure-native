...
warnings.warn("""azure-native:apimanagement/v20191201preview:ApiSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiSchema to guarantee forwards compatibility.""", DeprecationWarning)
