...
class ApiTagDescription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tag_description_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiTagDescription is deprecated: azure-native:apimanagement/v20191201preview:ApiTagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiTagDescription to guarantee forwards compatibility.""")
