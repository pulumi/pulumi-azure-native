...
def get_api_diagnostic(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_diagnostic is deprecated: azure-native:apimanagement/v20191201preview:ApiDiagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiDiagnostic to guarantee forwards compatibility.""")
    __args__ = dict()
