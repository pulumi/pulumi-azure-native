...
def get_api_operation_policy_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20191201preview:getApiOperationPolicy', __args__, opts=opts, typ=GetApiOperationPolicyResult)
