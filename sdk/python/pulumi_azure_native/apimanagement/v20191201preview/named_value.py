...
warnings.warn("""azure-native:apimanagement/v20191201preview:NamedValue is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NamedValue to guarantee forwards compatibility.""", DeprecationWarning)
