...
warnings.warn("""azure-native:apimanagement/v20191201preview:GatewayApiEntityTag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayApiEntityTag to guarantee forwards compatibility.""", DeprecationWarning)
...
class GatewayApiEntityTag(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""GatewayApiEntityTag is deprecated: azure-native:apimanagement/v20191201preview:GatewayApiEntityTag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayApiEntityTag to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20210101preview:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20210801:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:GatewayApiEntityTag"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:GatewayApiEntityTag")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GatewayApiEntityTag, __self__).__init__(
            'azure-native:apimanagement/v20191201preview:GatewayApiEntityTag',
            resource_name,
            __props__,
            opts)
