...
warnings.warn("""azure-native:apimanagement/v20191201preview:ProductApi is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ProductApi to guarantee forwards compatibility.""", DeprecationWarning)
