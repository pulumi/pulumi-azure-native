...
def get_email_template(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_email_template is deprecated: azure-native:apimanagement/v20191201preview:EmailTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:EmailTemplate to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    __args__['templateName'] = template_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20191201preview:getEmailTemplate', __args__, opts=opts, typ=GetEmailTemplateResult).value
