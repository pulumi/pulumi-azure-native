...
warnings.warn("""azure-native:apimanagement/v20191201preview:Api is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20201201:Api to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api is deprecated: azure-native:apimanagement/v20191201preview:Api is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20201201:Api to guarantee forwards compatibility.""")
    __args__ = dict()
