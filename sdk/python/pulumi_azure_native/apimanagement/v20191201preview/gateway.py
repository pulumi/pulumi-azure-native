...
class Gateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Gateway is deprecated: azure-native:apimanagement/v20191201preview:Gateway is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Gateway to guarantee forwards compatibility.""")
