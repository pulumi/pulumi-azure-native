...
warnings.warn("""azure-native:apimanagement/v20191201preview:NotificationRecipientEmail is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:NotificationRecipientEmail to guarantee forwards compatibility.""", DeprecationWarning)
