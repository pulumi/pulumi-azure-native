...
def get_api_operation(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_operation is deprecated: azure-native:apimanagement/v20191201preview:ApiOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperation to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20191201preview:getApiOperation', __args__, opts=opts, typ=GetApiOperationResult).value
