...
class AuthorizationServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 token_endpoint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AuthorizationServer is deprecated: azure-native:apimanagement/v20191201preview:AuthorizationServer is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:AuthorizationServer to guarantee forwards compatibility.""")
