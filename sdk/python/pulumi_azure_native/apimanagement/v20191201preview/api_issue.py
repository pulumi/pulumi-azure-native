...
warnings.warn("""azure-native:apimanagement/v20191201preview:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiIssue to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiIssue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiIssue is deprecated: azure-native:apimanagement/v20191201preview:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiIssue to guarantee forwards compatibility.""")
