...
class ApiIssueAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 issue_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] content: An HTTP link or Base64-encoded binary data.
        :param pulumi.Input[builtins.str] content_format: Either 'link' if content is provided via an HTTP link or the MIME type of the Base64-encoded binary data provided in the 'content' property.
        ...
        :param pulumi.Input[builtins.str] title: Filename by which the binary data will be saved.
        :param pulumi.Input[builtins.str] attachment_id: Attachment identifier within an Issue. Must be unique in the current Issue.
        """
    ...
    def issue_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @issue_id.setter
    def issue_id(self, value: pulumi.Input[builtins.str]):
