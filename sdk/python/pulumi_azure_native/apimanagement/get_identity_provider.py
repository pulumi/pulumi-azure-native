...
def get_identity_provider(identity_provider_name: Optional[_builtins.str] = None,
...
def get_identity_provider_output(identity_provider_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
