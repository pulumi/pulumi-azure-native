...
class GetIdentityProviderResult:
    ...
    def allowed_tenants(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def client_library(self) -> Optional[builtins.str]:
        """
    ...
    def password_reset_policy_name(self) -> Optional[builtins.str]:
        """
    ...
    def profile_editing_policy_name(self) -> Optional[builtins.str]:
        """
    ...
    def signin_policy_name(self) -> Optional[builtins.str]:
        """
    ...
    def signin_tenant(self) -> Optional[builtins.str]:
        """
    ...
    def signup_policy_name(self) -> Optional[builtins.str]:
        """
...
def get_identity_provider(identity_provider_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getIdentityProvider', __args__, opts=opts, typ=GetIdentityProviderResult).value
...
def get_identity_provider_output(identity_provider_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getIdentityProvider', __args__, opts=opts, typ=GetIdentityProviderResult)
