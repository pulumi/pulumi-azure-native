...
def get_api_management_service_sso_token(resource_group_name: Optional[builtins.str] = None,
...
def get_api_management_service_sso_token_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
