...
def list_policy_fragment_references(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.int skip: Number of records to skip.
    :param _builtins.int top: Number of records to return.
    """
    __args__ = dict()
    __args__['id'] = id
