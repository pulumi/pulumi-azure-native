...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 app_type: Optional[pulumi.Input[Union[builtins.str, 'AppType']]] = None,
                 confirmation: Optional[pulumi.Input[Union[builtins.str, 'Confirmation']]] = None,
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'UserState']]] = None,
                 user_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a User resource.
        :param pulumi.Input[builtins.str] email: Email address. Must not be empty and must be unique within the service instance.
        ...
        :param pulumi.Input[Union[builtins.str, 'AppType']] app_type: Determines the type of application which send the create user request. Default is legacy portal.
        :param pulumi.Input[Union[builtins.str, 'Confirmation']] confirmation: Determines the type of confirmation e-mail that will be sent to the newly created user.
        :param pulumi.Input[Sequence[pulumi.Input['UserIdentityContractArgs']]] identities: Collection of user identities.
        :param pulumi.Input[builtins.str] note: Optional note about a user set by the administrator.
        :param pulumi.Input[builtins.bool] notify: Send an Email notification to the User.
        :param pulumi.Input[builtins.str] password: User Password. If no value is provided, a default password is generated.
        :param pulumi.Input[Union[builtins.str, 'UserState']] state: Account state. Specifies whether the user is active or not. Blocked users are unable to sign into the developer portal or call any APIs of subscribed products. Default state is Active.
    ...
    def app_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'AppType']]]:
        """
    ...
    @app_type.setter
    def app_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'AppType']]]):
        pulumi.set(self, "app_type", value)

    @property
    @pulumi.getter
    def confirmation(self) -> Optional[pulumi.Input[Union[builtins.str, 'Confirmation']]]:
        """
    ...
    @confirmation.setter
    def confirmation(self, value: Optional[pulumi.Input[Union[builtins.str, 'Confirmation']]]):
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input[Union[builtins.str, 'UserState']]]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[builtins.str, 'UserState']]]):
...
class User(pulumi.CustomResource):
    ...
    def registration_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
