...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: Email address. Must not be empty and must be unique within the service instance.
        ...
        :param pulumi.Input[_builtins.str] note: Optional note about a user set by the administrator.
