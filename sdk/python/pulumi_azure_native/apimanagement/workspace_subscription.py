...
class WorkspaceSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceSubscription"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceSubscription"), pulumi.Alias(type_="azure-native_apimanagement_v20220901preview:apimanagement:WorkspaceSubscription"), pulumi.Alias(type_="azure-native_apimanagement_v20230301preview:apimanagement:WorkspaceSubscription"), pulumi.Alias(type_="azure-native_apimanagement_v20230501preview:apimanagement:WorkspaceSubscription"), pulumi.Alias(type_="azure-native_apimanagement_v20230901preview:apimanagement:WorkspaceSubscription"), pulumi.Alias(type_="azure-native_apimanagement_v20240501:apimanagement:WorkspaceSubscription"), pulumi.Alias(type_="azure-native_apimanagement_v20240601preview:apimanagement:WorkspaceSubscription")])
