...
def get_api_issue_comment(api_id: Optional[_builtins.str] = None,
                          comment_id: Optional[_builtins.str] = None,
...
def get_api_issue_comment_output(api_id: pulumi.Input[Optional[_builtins.str]] = None,
                                 comment_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
