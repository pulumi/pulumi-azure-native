...
class SubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Subscription name.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] scope: Scope like /products/{productId} or /apis or /apis/{apiId}.
        :param pulumi.Input[builtins.str] service_name: The name of the API Management service.
        :param pulumi.Input[builtins.bool] allow_tracing: Determines whether tracing can be enabled
        :param pulumi.Input[builtins.str] app_type: Determines the type of application which send the create user request. Default is legacy publisher portal.
        :param pulumi.Input[builtins.bool] notify: Notify change in Subscription State. 
                - If false, do not send any email notification for change of state of subscription 
                - If true, send email notification of change of state of subscription 
        :param pulumi.Input[builtins.str] owner_id: User (user id path) for whom subscription is being created in form /users/{userId}
        :param pulumi.Input[builtins.str] primary_key: Primary subscription key. If not specified during request key will be generated automatically.
        :param pulumi.Input[builtins.str] secondary_key: Secondary subscription key. If not specified during request key will be generated automatically.
        :param pulumi.Input[builtins.str] sid: Subscription entity Identifier. The entity represents the association between a user and a product in API Management.
...
class Subscription(pulumi.CustomResource):
    ...
    def notification_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="primaryKey")
    def primary_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="secondaryKey")
    def secondary_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def state_comment(self) -> pulumi.Output[Optional[builtins.str]]:
        """
