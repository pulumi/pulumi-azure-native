...
def get_workspace_api_policy(api_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getWorkspaceApiPolicy', __args__, opts=opts, typ=GetWorkspaceApiPolicyResult).value
...
def get_workspace_api_policy_output(api_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getWorkspaceApiPolicy', __args__, opts=opts, typ=GetWorkspaceApiPolicyResult)
