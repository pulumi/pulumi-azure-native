...
def get_api_issue_attachment(api_id: Optional[_builtins.str] = None,
                             attachment_id: Optional[_builtins.str] = None,
                             issue_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str attachment_id: Attachment identifier within an Issue. Must be unique in the current Issue.
...
def get_api_issue_attachment_output(api_id: pulumi.Input[Optional[_builtins.str]] = None,
                                    attachment_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
