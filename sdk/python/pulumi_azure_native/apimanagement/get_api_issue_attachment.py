...
def get_api_issue_attachment(api_id: Optional[builtins.str] = None,
    ...
    :param builtins.str attachment_id: Attachment identifier within an Issue. Must be unique in the current Issue.
...
def get_api_issue_attachment_output(api_id: Optional[pulumi.Input[builtins.str]] = None,
