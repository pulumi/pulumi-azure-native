...
class NotificationRecipientEmail(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        notification_recipient_email = azure_native.apimanagement.v20201201.NotificationRecipientEmail("notificationRecipientEmail",
        ...
        ```sh
        $ pulumi import azure-native:apimanagement/v20201201:NotificationRecipientEmail foobar@live.com /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/notifications/RequestPublisherNotificationMessage/recipientEmails/foobar@live.com 
        ```
