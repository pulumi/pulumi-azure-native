...
class ProductApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ProductApi")])
