...
class ProductGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        product_group = azure_native.apimanagement.v20201201.ProductGroup("productGroup",
