...
def list_tenant_access_secrets_output(access_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20201201:listTenantAccessSecrets', __args__, opts=opts, typ=ListTenantAccessSecretsResult)
