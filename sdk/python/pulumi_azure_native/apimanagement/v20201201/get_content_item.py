...
def get_content_item(content_item_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_content_item is deprecated: azure-native:apimanagement/v20201201:ContentItem is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ContentItem to guarantee forwards compatibility.""")
    __args__ = dict()
