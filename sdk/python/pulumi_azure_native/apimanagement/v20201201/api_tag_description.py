...
class ApiTagDescription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        api_tag_description = azure_native.apimanagement.v20201201.ApiTagDescription("apiTagDescription",
