...
class Diagnostic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        diagnostic = azure_native.apimanagement.v20201201.Diagnostic("diagnostic",
