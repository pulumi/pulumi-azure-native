...
warnings.warn("""azure-native:apimanagement/v20201201:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssue to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_issue(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_issue is deprecated: azure-native:apimanagement/v20201201:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssue to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20201201:getApiIssue', __args__, opts=opts, typ=GetApiIssueResult).value
