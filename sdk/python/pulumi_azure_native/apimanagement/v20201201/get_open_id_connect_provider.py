...
def get_open_id_connect_provider_output(opid: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20201201:getOpenIdConnectProvider', __args__, opts=opts, typ=GetOpenIdConnectProviderResult)
