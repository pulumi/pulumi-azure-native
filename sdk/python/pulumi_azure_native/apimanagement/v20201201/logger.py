...
class Logger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        logger = azure_native.apimanagement.v20201201.Logger("logger",
            credentials={
