...
class GatewayApiEntityTag(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gateway_api_entity_tag = azure_native.apimanagement.v20201201.GatewayApiEntityTag("gatewayApiEntityTag",
            api_id="echo-api",
            gateway_id="gw1",
            provisioning_state=azure_native.apimanagement/v20201201.ProvisioningState.CREATED,
