...
warnings.warn("""azure-native:apimanagement/v20201201:ContentType is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ContentType to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_content_type(content_type_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_content_type is deprecated: azure-native:apimanagement/v20201201:ContentType is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ContentType to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['contentTypeId'] = content_type_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20201201:getContentType', __args__, opts=opts, typ=GetContentTypeResult).value
