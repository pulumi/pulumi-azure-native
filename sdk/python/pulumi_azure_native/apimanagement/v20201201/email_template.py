...
class EmailTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        email_template = azure_native.apimanagement.v20201201.EmailTemplate("emailTemplate",
