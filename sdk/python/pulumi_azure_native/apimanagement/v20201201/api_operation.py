...
class ApiOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        api_operation = azure_native.apimanagement.v20201201.ApiOperation("apiOperation",
            api_id="PetStoreTemplate2",
            description="This can only be done by the logged in user.",
            display_name="createUser2",
            method="POST",
            operation_id="newoperations",
            request=azure_native.apimanagement.v20201201.RequestContractResponseArgs(
                description="Created user object",
                headers=[],
                query_parameters=[],
                representations=[azure_native.apimanagement.v20201201.RepresentationContractArgs(
            ...
            responses=[{
                ...
                "headers": [],
                "representations": [
                    azure_native.apimanagement.v20201201.RepresentationContractArgs(
