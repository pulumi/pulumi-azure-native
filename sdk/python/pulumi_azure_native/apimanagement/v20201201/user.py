...
class User(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        user = azure_native.apimanagement.v20201201.User("user",
            confirmation="signup",
