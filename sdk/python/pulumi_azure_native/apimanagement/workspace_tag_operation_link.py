...
class WorkspaceTagOperationLinkArgs:
    def __init__(__self__, *,
                 ...
                 operation_link_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WorkspaceTagOperationLink resource.
        :param pulumi.Input[builtins.str] operation_id: Full resource Id of an API operation.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] service_name: The name of the API Management service.
        :param pulumi.Input[builtins.str] tag_id: Tag identifier. Must be unique in the current API Management service instance.
        ...
        :param pulumi.Input[builtins.str] operation_link_id: Tag-operation link identifier. Must be unique in the current API Management service instance.
        """
    ...
    def operation_link_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operation_link_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "operation_link_id", value)


@pulumi.type_token("azure-native:apimanagement:WorkspaceTagOperationLink")
class WorkspaceTagOperationLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceTagOperationLink"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:WorkspaceTagOperationLink")])
