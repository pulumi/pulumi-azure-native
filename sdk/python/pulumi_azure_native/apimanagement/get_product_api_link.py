...
def get_product_api_link(api_link_id: Optional[_builtins.str] = None,
...
def get_product_api_link_output(api_link_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
