...
def get_named_value(named_value_id: Optional[_builtins.str] = None,
...
def get_named_value_output(named_value_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getNamedValue', __args__, opts=opts, typ=GetNamedValueResult)
