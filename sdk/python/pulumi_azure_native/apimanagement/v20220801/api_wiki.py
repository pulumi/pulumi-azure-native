...
class ApiWiki(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ApiWiki")])
