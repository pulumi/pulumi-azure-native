...
class AuthorizationAccessPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        authorization_access_policy = azure_native.apimanagement.v20220801.AuthorizationAccessPolicy("authorizationAccessPolicy",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:AuthorizationAccessPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:AuthorizationAccessPolicy")])
