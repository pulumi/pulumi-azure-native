...
def get_graph_ql_api_resolver(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_graph_ql_api_resolver is deprecated: azure-native:apimanagement/v20220801:GraphQLApiResolver is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GraphQLApiResolver to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220801:getGraphQLApiResolver', __args__, opts=opts, typ=GetGraphQLApiResolverResult).value
