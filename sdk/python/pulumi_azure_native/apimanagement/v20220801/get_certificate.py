...
def get_certificate(certificate_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: azure-native:apimanagement/v20220801:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Certificate to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['certificateId'] = certificate_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220801:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
