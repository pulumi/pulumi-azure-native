...
def get_group(group_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_group is deprecated: azure-native:apimanagement/v20220801:Group is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Group to guarantee forwards compatibility.""")
    __args__ = dict()
