...
class GraphQLApiResolverPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        graph_ql_api_resolver_policy = azure_native.apimanagement.v20220801.GraphQLApiResolverPolicy("graphQLApiResolverPolicy",
        ...
        ```sh
        $ pulumi import azure-native:apimanagement/v20220801:GraphQLApiResolverPolicy policy /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/apis/5600b57e7e8880006a040001/resolvers/5600b57e7e8880006a080001/policies/policy 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:GraphQLApiResolverPolicy")])
