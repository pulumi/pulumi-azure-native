...
def get_cache(cache_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cache is deprecated: azure-native:apimanagement/v20220801:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Cache to guarantee forwards compatibility.""")
    __args__ = dict()
