...
class Backend(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        backend = azure_native.apimanagement.v20220801.Backend("backend",
            backend_id="proxybackend",
            credentials=azure_native.apimanagement.v20220801.BackendCredentialsContractArgs(
                authorization=azure_native.apimanagement.v20220801.BackendAuthorizationHeaderCredentialsArgs(
                    parameter="opensesma",
                    scheme="Basic",
                ),
                header={
            ...
            protocol="http",
            proxy=azure_native.apimanagement.v20220801.BackendProxyContractResponseArgs(
                password="<password>",
            ...
            tls=azure_native.apimanagement.v20220801.BackendTlsPropertiesArgs(
        ...
        backend = azure_native.apimanagement.v20220801.Backend("backend",
            ...
            properties=azure_native.apimanagement.v20220801.BackendPropertiesResponseArgs(
                service_fabric_cluster={
                    ...
                    "serverX509Names": [azure_native.apimanagement.v20220801.X509CertificateNameArgs(
        ...
        ```sh
        $ pulumi import azure-native:apimanagement/v20220801:Backend sfbackend /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/backends/sfbackend 
        ```
