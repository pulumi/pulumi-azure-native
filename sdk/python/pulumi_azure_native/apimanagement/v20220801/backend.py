...
class Backend(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if credentials is not None and not isinstance(credentials, BackendCredentialsContractArgs):
            ...
            if properties is not None and not isinstance(properties, BackendPropertiesArgs):
            ...
            if proxy is not None and not isinstance(proxy, BackendProxyContractArgs):
                proxy = proxy or {}
                def _setter(key, value):
                    proxy[key] = value
            ...
            if tls is not None and not isinstance(tls, BackendTlsPropertiesArgs):
                tls = tls or {}
                def _setter(key, value):
                    tls[key] = value
