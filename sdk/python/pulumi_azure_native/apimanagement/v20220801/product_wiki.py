...
class ProductWiki(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        product_wiki = azure_native.apimanagement.v20220801.ProductWiki("productWiki",
            documents=[
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:ProductWiki")])
