...
class AuthorizationServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        authorization_server = azure_native.apimanagement.v20220801.AuthorizationServer("authorizationServer",
            authorization_endpoint="https://www.contoso.com/oauth2/auth",
            authorization_methods=[azure_native.apimanagement/v20220801.AuthorizationMethod.GET],
