...
class Authorization(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        authorization = azure_native.apimanagement.v20220801.Authorization("authorization",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:Authorization"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:Authorization")])
