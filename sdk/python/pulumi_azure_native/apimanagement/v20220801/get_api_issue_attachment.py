...
warnings.warn("""azure-native:apimanagement/v20220801:ApiIssueAttachment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssueAttachment to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_issue_attachment(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_issue_attachment is deprecated: azure-native:apimanagement/v20220801:ApiIssueAttachment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssueAttachment to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220801:getApiIssueAttachment', __args__, opts=opts, typ=GetApiIssueAttachmentResult).value
