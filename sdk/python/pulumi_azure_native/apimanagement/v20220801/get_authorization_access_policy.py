...
def get_authorization_access_policy(authorization_access_policy_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization_access_policy is deprecated: azure-native:apimanagement/v20220801:AuthorizationAccessPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:AuthorizationAccessPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
