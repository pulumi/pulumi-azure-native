...
class Gateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gateway = azure_native.apimanagement.v20220801.Gateway("gateway",
            description="my gateway 1",
            gateway_id="gw1",
            location_data=azure_native.apimanagement.v20220801.ResourceLocationDataContractResponseArgs(
                name="my location",
            ),
