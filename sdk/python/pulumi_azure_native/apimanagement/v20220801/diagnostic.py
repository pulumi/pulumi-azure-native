...
class Diagnostic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        diagnostic = azure_native.apimanagement.v20220801.Diagnostic("diagnostic",
            always_log="allErrors",
            backend=azure_native.apimanagement.v20220801.PipelineDiagnosticSettingsResponseArgs(
                request={
                    "body": azure_native.apimanagement.v20220801.BodyDiagnosticSettingsArgs(
                        bytes=512,
                    ),
            ...
            frontend=azure_native.apimanagement.v20220801.PipelineDiagnosticSettingsResponseArgs(
                request={
                    "body": azure_native.apimanagement.v20220801.BodyDiagnosticSettingsArgs(
                        bytes=512,
                    ),
            ...
            sampling=azure_native.apimanagement.v20220801.SamplingSettingsArgs(
                percentage=50,
                sampling_type="fixed",
            ),
        ...
        ```sh
        $ pulumi import azure-native:apimanagement/v20220801:Diagnostic applicationinsights /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/diagnostics/applicationinsights 
        ```
