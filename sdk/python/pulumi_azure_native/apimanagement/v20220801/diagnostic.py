...
class DiagnosticArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if logger_id is None and 'loggerId' in kwargs:
            logger_id = kwargs['loggerId']
        if logger_id is None:
            raise TypeError("Missing 'logger_id' argument")
        ...
        if always_log is None and 'alwaysLog' in kwargs:
...
class Diagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            backend = _utilities.configure(backend, PipelineDiagnosticSettingsArgs, True)
            __props__.__dict__["backend"] = backend
            __props__.__dict__["diagnostic_id"] = diagnostic_id
            frontend = _utilities.configure(frontend, PipelineDiagnosticSettingsArgs, True)
            ...
            sampling = _utilities.configure(sampling, SamplingSettingsArgs, True)
