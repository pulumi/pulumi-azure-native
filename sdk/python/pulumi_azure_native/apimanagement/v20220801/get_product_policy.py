...
def get_product_policy(format: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_product_policy is deprecated: azure-native:apimanagement/v20220801:ProductPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ProductPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220801:getProductPolicy', __args__, opts=opts, typ=GetProductPolicyResult).value
