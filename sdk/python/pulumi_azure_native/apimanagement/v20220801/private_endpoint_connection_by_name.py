...
class PrivateEndpointConnectionByName(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection_by_name = azure_native.apimanagement.v20220801.PrivateEndpointConnectionByName("privateEndpointConnectionByName",
            ...
            properties=azure_native.apimanagement.v20220801.PrivateEndpointConnectionRequestPropertiesArgs(
                private_link_service_connection_state=azure_native.apimanagement.v20220801.PrivateLinkServiceConnectionStateArgs(
