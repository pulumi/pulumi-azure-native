...
def get_api_release(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_release is deprecated: azure-native:apimanagement/v20220801:ApiRelease is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiRelease to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220801:getApiRelease', __args__, opts=opts, typ=GetApiReleaseResult).value
