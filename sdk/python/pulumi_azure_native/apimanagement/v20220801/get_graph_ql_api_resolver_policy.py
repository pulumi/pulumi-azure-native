...
def get_graph_ql_api_resolver_policy(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_graph_ql_api_resolver_policy is deprecated: azure-native:apimanagement/v20220801:GraphQLApiResolverPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GraphQLApiResolverPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220801:getGraphQLApiResolverPolicy', __args__, opts=opts, typ=GetGraphQLApiResolverPolicyResult).value
