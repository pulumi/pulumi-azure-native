...
def get_content_item(content_item_id: Optional[_builtins.str] = None,
                     content_type_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str content_item_id: Content item identifier.
...
def get_content_item_output(content_item_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
