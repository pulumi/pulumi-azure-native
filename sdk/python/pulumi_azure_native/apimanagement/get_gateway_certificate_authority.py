...
def get_gateway_certificate_authority(certificate_id: Optional[_builtins.str] = None,
...
def get_gateway_certificate_authority_output(certificate_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
