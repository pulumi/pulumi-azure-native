...
def list_workspace_named_value(named_value_id: Optional[_builtins.str] = None,
...
def list_workspace_named_value_output(named_value_id: Optional[pulumi.Input[_builtins.str]] = None,
