...
def get_email_template(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getEmailTemplate', __args__, opts=opts, typ=GetEmailTemplateResult).value
...
def get_email_template_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['templateName'] = template_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getEmailTemplate', __args__, opts=opts, typ=GetEmailTemplateResult)
