...
def get_tag(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getTag', __args__, opts=opts, typ=GetTagResult).value
...
def get_tag_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['tagId'] = tag_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getTag', __args__, opts=opts, typ=GetTagResult)
