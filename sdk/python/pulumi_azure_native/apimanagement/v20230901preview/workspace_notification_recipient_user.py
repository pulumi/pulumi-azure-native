...
class WorkspaceNotificationRecipientUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceNotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceNotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceNotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceNotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceNotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement:WorkspaceNotificationRecipientUser")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceNotificationRecipientUser, __self__).__init__(
            'azure-native:apimanagement/v20230901preview:WorkspaceNotificationRecipientUser',
            resource_name,
            __props__,
            opts)
