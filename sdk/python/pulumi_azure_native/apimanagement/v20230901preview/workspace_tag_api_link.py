...
class WorkspaceTagApiLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceTagApiLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceTagApiLink, __self__).__init__(
            'azure-native:apimanagement/v20230901preview:WorkspaceTagApiLink',
            resource_name,
            __props__,
            opts)
