...
def get_authorization_server(authsid: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult).value
...
def get_authorization_server_output(authsid: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult)
