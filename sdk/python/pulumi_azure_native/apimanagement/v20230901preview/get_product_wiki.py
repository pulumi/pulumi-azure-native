...
def get_product_wiki(product_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getProductWiki', __args__, opts=opts, typ=GetProductWikiResult).value
...
def get_product_wiki_output(product_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getProductWiki', __args__, opts=opts, typ=GetProductWikiResult)
