...
def get_subscription(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult).value
...
def get_subscription_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sid'] = sid
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult)
