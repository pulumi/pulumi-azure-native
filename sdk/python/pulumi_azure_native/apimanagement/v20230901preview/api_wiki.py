...
class ApiWiki(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 documents: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WikiDocumentationContractArgs']]]]] = None,
        ...
        :param pulumi.Input[str] api_id: API identifier. Must be unique in the current API Management service instance.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WikiDocumentationContractArgs']]]] documents: Collection wiki documents included into this wiki.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] service_name: The name of the API Management service.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ApiWiki"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:ApiWiki")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiWiki, __self__).__init__(
            'azure-native:apimanagement/v20230901preview:ApiWiki',
            resource_name,
            __props__,
            opts)
