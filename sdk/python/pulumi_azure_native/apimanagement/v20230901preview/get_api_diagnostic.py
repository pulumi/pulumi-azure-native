...
def get_api_diagnostic(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getApiDiagnostic', __args__, opts=opts, typ=GetApiDiagnosticResult).value
...
def get_api_diagnostic_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getApiDiagnostic', __args__, opts=opts, typ=GetApiDiagnosticResult)
