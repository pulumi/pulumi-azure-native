...
class WorkspacePolicyFragment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspacePolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspacePolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspacePolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspacePolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspacePolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspacePolicyFragment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspacePolicyFragment, __self__).__init__(
            'azure-native:apimanagement/v20230901preview:WorkspacePolicyFragment',
            resource_name,
            __props__,
            opts)
