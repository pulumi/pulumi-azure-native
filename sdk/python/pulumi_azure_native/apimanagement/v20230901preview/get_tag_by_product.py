...
def get_tag_by_product(product_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getTagByProduct', __args__, opts=opts, typ=GetTagByProductResult).value
...
def get_tag_by_product_output(product_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['tagId'] = tag_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getTagByProduct', __args__, opts=opts, typ=GetTagByProductResult)
