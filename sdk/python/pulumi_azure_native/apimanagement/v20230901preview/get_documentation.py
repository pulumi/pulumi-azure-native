...
def get_documentation(documentation_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getDocumentation', __args__, opts=opts, typ=GetDocumentationResult).value
...
def get_documentation_output(documentation_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getDocumentation', __args__, opts=opts, typ=GetDocumentationResult)
