...
def get_workspace_api_diagnostic(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getWorkspaceApiDiagnostic', __args__, opts=opts, typ=GetWorkspaceApiDiagnosticResult).value
...
def get_workspace_api_diagnostic_output(api_id: Optional[pulumi.Input[str]] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWorkspaceApiDiagnosticResult]:
    """
    Gets the details of the Diagnostic for an API specified by its identifier.
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getWorkspaceApiDiagnostic', __args__, opts=opts, typ=GetWorkspaceApiDiagnosticResult)
