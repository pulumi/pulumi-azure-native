...
class WorkspaceGroupUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceGroupUser"), pulumi.Alias(type_="azure-native:apimanagement:WorkspaceGroupUser")])
