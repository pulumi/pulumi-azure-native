...
class WorkspaceProductPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceProductPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceProductPolicy, __self__).__init__(
            'azure-native:apimanagement/v20230901preview:WorkspaceProductPolicy',
            resource_name,
            __props__,
            opts)
