...
def get_workspace_api_operation_policy(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getWorkspaceApiOperationPolicy', __args__, opts=opts, typ=GetWorkspaceApiOperationPolicyResult).value
...
def get_workspace_api_operation_policy_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getWorkspaceApiOperationPolicy', __args__, opts=opts, typ=GetWorkspaceApiOperationPolicyResult)
