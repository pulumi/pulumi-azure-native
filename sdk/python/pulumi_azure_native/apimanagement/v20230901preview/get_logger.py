...
def get_logger(logger_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20230901preview:getLogger', __args__, opts=opts, typ=GetLoggerResult).value
...
def get_logger_output(logger_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20230901preview:getLogger', __args__, opts=opts, typ=GetLoggerResult)
