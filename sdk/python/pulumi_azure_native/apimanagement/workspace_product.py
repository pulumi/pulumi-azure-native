...
class WorkspaceProduct(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceProduct"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceProduct"), pulumi.Alias(type_="azure-native_apimanagement_v20220901preview:apimanagement:WorkspaceProduct"), pulumi.Alias(type_="azure-native_apimanagement_v20230301preview:apimanagement:WorkspaceProduct"), pulumi.Alias(type_="azure-native_apimanagement_v20230501preview:apimanagement:WorkspaceProduct"), pulumi.Alias(type_="azure-native_apimanagement_v20230901preview:apimanagement:WorkspaceProduct"), pulumi.Alias(type_="azure-native_apimanagement_v20240501:apimanagement:WorkspaceProduct"), pulumi.Alias(type_="azure-native_apimanagement_v20240601preview:apimanagement:WorkspaceProduct")])
