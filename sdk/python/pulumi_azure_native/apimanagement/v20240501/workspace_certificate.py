...
class WorkspaceCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceCertificate"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceCertificate")])
