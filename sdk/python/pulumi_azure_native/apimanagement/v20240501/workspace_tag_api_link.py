...
class WorkspaceTagApiLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceTagApiLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceTagApiLink")])
