...
def get_workspace_tag_api_link(api_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getWorkspaceTagApiLink', __args__, opts=opts, typ=GetWorkspaceTagApiLinkResult).value
...
def get_workspace_tag_api_link_output(api_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getWorkspaceTagApiLink', __args__, opts=opts, typ=GetWorkspaceTagApiLinkResult)
