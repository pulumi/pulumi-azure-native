...
class WorkspaceLogger(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkspaceLoggerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkspaceLoggerArgs.__new__(WorkspaceLoggerArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceLogger"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceLogger"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceLogger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceLogger, __self__).__init__(
            'azure-native:apimanagement/v20240501:WorkspaceLogger',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WorkspaceLogger':
        """
        ...
        __props__.__dict__["type"] = None
        return WorkspaceLogger(resource_name, opts=opts, __props__=__props__)
