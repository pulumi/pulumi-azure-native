...
def get_tag_product_link(product_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getTagProductLink', __args__, opts=opts, typ=GetTagProductLinkResult).value
...
def get_tag_product_link_output(product_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['tagId'] = tag_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getTagProductLink', __args__, opts=opts, typ=GetTagProductLinkResult)
