...
class WorkspaceApiSchema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceApiSchema")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceApiSchema, __self__).__init__(
            'azure-native:apimanagement/v20240501:WorkspaceApiSchema',
            resource_name,
            __props__,
            opts)
