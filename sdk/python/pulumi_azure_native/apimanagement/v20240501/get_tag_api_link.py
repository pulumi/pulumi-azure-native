...
def get_tag_api_link(api_link_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getTagApiLink', __args__, opts=opts, typ=GetTagApiLinkResult).value
...
def get_tag_api_link_output(api_link_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getTagApiLink', __args__, opts=opts, typ=GetTagApiLinkResult)
