...
def get_workspace_backend(backend_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getWorkspaceBackend', __args__, opts=opts, typ=GetWorkspaceBackendResult).value
...
def get_workspace_backend_output(backend_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getWorkspaceBackend', __args__, opts=opts, typ=GetWorkspaceBackendResult)
