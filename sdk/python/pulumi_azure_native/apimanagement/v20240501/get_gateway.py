...
def get_gateway(gateway_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getGateway', __args__, opts=opts, typ=GetGatewayResult).value
...
def get_gateway_output(gateway_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getGateway', __args__, opts=opts, typ=GetGatewayResult)
