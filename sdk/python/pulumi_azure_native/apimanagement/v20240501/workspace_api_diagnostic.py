...
class WorkspaceApiDiagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApiDiagnostic"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApiDiagnostic"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceApiDiagnostic")])
