...
def get_private_endpoint_connection_by_name(private_endpoint_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getPrivateEndpointConnectionByName', __args__, opts=opts, typ=GetPrivateEndpointConnectionByNameResult).value
...
def get_private_endpoint_connection_by_name_output(private_endpoint_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getPrivateEndpointConnectionByName', __args__, opts=opts, typ=GetPrivateEndpointConnectionByNameResult)
