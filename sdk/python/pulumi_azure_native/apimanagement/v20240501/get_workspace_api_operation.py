...
def get_workspace_api_operation(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getWorkspaceApiOperation', __args__, opts=opts, typ=GetWorkspaceApiOperationResult).value
