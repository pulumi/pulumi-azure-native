...
def get_user(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getUser', __args__, opts=opts, typ=GetUserResult).value
...
def get_user_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['userId'] = user_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getUser', __args__, opts=opts, typ=GetUserResult)
