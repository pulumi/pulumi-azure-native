...
def get_workspace_product(product_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getWorkspaceProduct', __args__, opts=opts, typ=GetWorkspaceProductResult).value
...
def get_workspace_product_output(product_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceId'] = workspace_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getWorkspaceProduct', __args__, opts=opts, typ=GetWorkspaceProductResult)
