...
class WorkspaceApiVersionSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceApiVersionSet"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceApiVersionSet"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceApiVersionSet"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceApiVersionSet"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceApiVersionSet")])
