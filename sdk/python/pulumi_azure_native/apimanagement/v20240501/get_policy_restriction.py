...
def get_policy_restriction(policy_restriction_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20240501:getPolicyRestriction', __args__, opts=opts, typ=GetPolicyRestrictionResult).value
...
def get_policy_restriction_output(policy_restriction_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20240501:getPolicyRestriction', __args__, opts=opts, typ=GetPolicyRestrictionResult)
