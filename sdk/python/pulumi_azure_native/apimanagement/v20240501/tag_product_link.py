...
class TagProductLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:TagProductLink"), pulumi.Alias(type_="azure-native:apimanagement:TagProductLink")])
