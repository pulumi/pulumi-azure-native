...
class WorkspaceNotificationRecipientEmail(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkspaceNotificationRecipientEmailArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceNotificationRecipientEmail"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceNotificationRecipientEmail")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceNotificationRecipientEmail, __self__).__init__(
            'azure-native:apimanagement/v20240501:WorkspaceNotificationRecipientEmail',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WorkspaceNotificationRecipientEmail':
        """
        ...
        __props__.__dict__["name"] = None
        __props__.__dict__["type"] = None
        return WorkspaceNotificationRecipientEmail(resource_name, opts=opts, __props__=__props__)
