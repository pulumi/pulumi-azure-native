...
def list_workspace_policy_fragment_references(id: Optional[_builtins.str] = None,
...
def list_workspace_policy_fragment_references_output(id: Optional[pulumi.Input[_builtins.str]] = None,
