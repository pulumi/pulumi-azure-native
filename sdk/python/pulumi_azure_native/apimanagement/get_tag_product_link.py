...
def get_tag_product_link(product_link_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str product_link_id: Tag-product link identifier. Must be unique in the current API Management service instance.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str service_name: The name of the API Management service.
    :param _builtins.str tag_id: Tag identifier. Must be unique in the current API Management service instance.
    """
    __args__ = dict()
...
def get_tag_product_link_output(product_link_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
