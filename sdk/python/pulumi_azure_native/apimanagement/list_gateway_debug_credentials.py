...
def list_gateway_debug_credentials(api_id: Optional[_builtins.str] = None,
                                   credentials_expire_after: Optional[_builtins.str] = None,
                                   gateway_id: Optional[_builtins.str] = None,
                                   purposes: Optional[Sequence[Union[_builtins.str, 'GatewayListDebugCredentialsContractPurpose']]] = None,
    ...
    :param _builtins.str api_id: Full resource Id of an API.
    :param _builtins.str credentials_expire_after: Credentials expiration in ISO8601 format. Maximum duration of the credentials is PT1H. When property is not specified, them value PT1H is used.
    ...
    :param Sequence[Union[_builtins.str, 'GatewayListDebugCredentialsContractPurpose']] purposes: Purposes of debug credential.
