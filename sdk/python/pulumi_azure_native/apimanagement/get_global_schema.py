...
def get_global_schema(resource_group_name: Optional[builtins.str] = None,
...
def get_global_schema_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
