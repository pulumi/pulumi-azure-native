...
warnings.warn("""azure-native:apimanagement/v20180601preview:Diagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:Diagnostic to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_diagnostic(diagnostic_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_diagnostic is deprecated: azure-native:apimanagement/v20180601preview:Diagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:Diagnostic to guarantee forwards compatibility.""")
    __args__ = dict()
