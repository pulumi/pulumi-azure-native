...
class ApiManagementService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_type: Optional[pulumi.Input[Union[str, 'VirtualNetworkType']]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiManagementService is deprecated: azure-native:apimanagement/v20180601preview:ApiManagementService is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiManagementService to guarantee forwards compatibility.""")
