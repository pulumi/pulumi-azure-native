...
class ApiOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 url_template: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiOperation is deprecated: azure-native:apimanagement/v20180601preview:ApiOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiOperation to guarantee forwards compatibility.""")
