...
warnings.warn("""azure-native:apimanagement/v20180601preview:ApiRelease is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiRelease to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiRelease(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiRelease is deprecated: azure-native:apimanagement/v20180601preview:ApiRelease is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiRelease to guarantee forwards compatibility.""")
