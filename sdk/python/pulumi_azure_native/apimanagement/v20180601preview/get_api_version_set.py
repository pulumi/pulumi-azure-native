...
warnings.warn("""azure-native:apimanagement/v20180601preview:ApiVersionSet is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiVersionSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_version_set(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_version_set is deprecated: azure-native:apimanagement/v20180601preview:ApiVersionSet is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiVersionSet to guarantee forwards compatibility.""")
    __args__ = dict()
