...
class TagDescription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:TagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:TagDescription")])
