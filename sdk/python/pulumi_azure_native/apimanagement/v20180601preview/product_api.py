...
class ProductApi(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        product_api = azure_native.apimanagement.v20180601preview.ProductApi("productApi",
            api_id="echo-api",
