...
class AuthenticationSettingsContractArgs:
    ...
    def _configure(
        ...
        if subscription_key_required is None and 'subscriptionKeyRequired' in kwargs:
            subscription_key_required = kwargs['subscriptionKeyRequired']
        ...
        if subscription_key_required is not None:
            _setter("subscription_key_required", subscription_key_required)
