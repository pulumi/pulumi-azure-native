...
warnings.warn("""azure-native:apimanagement/v20180601preview:TagByProduct is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:TagByProduct to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_tag_by_product(product_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_by_product is deprecated: azure-native:apimanagement/v20180601preview:TagByProduct is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:TagByProduct to guarantee forwards compatibility.""")
    __args__ = dict()
