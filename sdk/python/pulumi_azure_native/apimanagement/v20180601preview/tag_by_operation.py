...
warnings.warn("""azure-native:apimanagement/v20180601preview:TagByOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.""", DeprecationWarning)
