...
warnings.warn("""azure-native:apimanagement/v20180601preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:User to guarantee forwards compatibility.""", DeprecationWarning)
