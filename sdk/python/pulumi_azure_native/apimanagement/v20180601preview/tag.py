...
warnings.warn("""azure-native:apimanagement/v20180601preview:Tag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Tag to guarantee forwards compatibility.""", DeprecationWarning)
