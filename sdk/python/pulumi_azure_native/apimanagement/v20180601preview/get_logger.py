...
warnings.warn("""azure-native:apimanagement/v20180601preview:Logger is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20191201preview:Logger to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_logger(logger_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_logger is deprecated: azure-native:apimanagement/v20180601preview:Logger is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20191201preview:Logger to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['loggerId'] = logger_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20180601preview:getLogger', __args__, opts=opts, typ=GetLoggerResult).value
