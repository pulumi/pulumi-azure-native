...
warnings.warn("""azure-native:apimanagement/v20180601preview:Group is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Group to guarantee forwards compatibility.""", DeprecationWarning)
...
class Group(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input['GroupType']] = None,
                 __props__=None):
        pulumi.log.warn("""Group is deprecated: azure-native:apimanagement/v20180601preview:Group is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Group to guarantee forwards compatibility.""")
