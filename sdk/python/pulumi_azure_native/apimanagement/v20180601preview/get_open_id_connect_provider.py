...
warnings.warn("""azure-native:apimanagement/v20180601preview:OpenIdConnectProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:OpenIdConnectProvider to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_open_id_connect_provider(opid: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_id_connect_provider is deprecated: azure-native:apimanagement/v20180601preview:OpenIdConnectProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:OpenIdConnectProvider to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['opid'] = opid
