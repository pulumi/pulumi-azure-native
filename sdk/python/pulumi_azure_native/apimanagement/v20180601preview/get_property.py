...
def get_property(prop_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20180601preview:getProperty', __args__, opts=opts, typ=GetPropertyResult).value
...
def get_property_output(prop_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20180601preview:getProperty', __args__, opts=opts, typ=GetPropertyResult)
