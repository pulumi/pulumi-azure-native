...
warnings.warn("""azure-native:apimanagement/v20180601preview:NotificationRecipientUser is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NotificationRecipientUser to guarantee forwards compatibility.""", DeprecationWarning)
