...
warnings.warn("""azure-native:apimanagement/v20180601preview:ApiDiagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20190101:ApiDiagnostic to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiDiagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiDiagnostic is deprecated: azure-native:apimanagement/v20180601preview:ApiDiagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20190101:ApiDiagnostic to guarantee forwards compatibility.""")
