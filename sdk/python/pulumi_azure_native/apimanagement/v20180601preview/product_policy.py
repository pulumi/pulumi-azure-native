...
class ProductPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        product_policy = azure_native.apimanagement.v20180601preview.ProductPolicy("productPolicy",
            content_format="xml",
