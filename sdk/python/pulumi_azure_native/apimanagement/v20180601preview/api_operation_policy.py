...
class ApiOperationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        api_operation_policy = azure_native.apimanagement.v20180601preview.ApiOperationPolicy("apiOperationPolicy",
