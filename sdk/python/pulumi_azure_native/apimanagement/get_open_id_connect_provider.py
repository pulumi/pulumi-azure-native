...
def get_open_id_connect_provider(opid: Optional[_builtins.str] = None,
...
def get_open_id_connect_provider_output(opid: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
