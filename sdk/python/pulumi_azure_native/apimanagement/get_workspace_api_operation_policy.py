...
def get_workspace_api_operation_policy(api_id: Optional[builtins.str] = None,
...
def get_workspace_api_operation_policy_output(api_id: Optional[pulumi.Input[builtins.str]] = None,
