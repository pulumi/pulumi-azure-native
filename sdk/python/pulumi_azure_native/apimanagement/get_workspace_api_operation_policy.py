...
def get_workspace_api_operation_policy(api_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getWorkspaceApiOperationPolicy', __args__, opts=opts, typ=GetWorkspaceApiOperationPolicyResult).value
...
def get_workspace_api_operation_policy_output(api_id: Optional[pulumi.Input[_builtins.str]] = None,
