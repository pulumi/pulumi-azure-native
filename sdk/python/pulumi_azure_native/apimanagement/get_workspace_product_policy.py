...
def get_workspace_product_policy(format: Optional[builtins.str] = None,
...
def get_workspace_product_policy_output(format: Optional[pulumi.Input[Optional[builtins.str]]] = None,
