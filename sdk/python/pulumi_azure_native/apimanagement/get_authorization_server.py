...
def get_authorization_server(authsid: Optional[_builtins.str] = None,
...
def get_authorization_server_output(authsid: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
