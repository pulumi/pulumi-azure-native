...
class GetAuthorizationServerResult:
    ...
    def authorization_methods(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def client_authentication_method(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def default_scope(self) -> Optional[builtins.str]:
        """
    ...
    def grant_types(self) -> Sequence[builtins.str]:
        """
    ...
    def support_state(self) -> Optional[builtins.bool]:
        """
...
def get_authorization_server(authsid: Optional[builtins.str] = None,
...
def get_authorization_server_output(authsid: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult)
