...
warnings.warn("""azure-native:apimanagement/v20200601preview:TagByProduct is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByProduct to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_tag_by_product(product_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_by_product is deprecated: azure-native:apimanagement/v20200601preview:TagByProduct is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByProduct to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20200601preview:getTagByProduct', __args__, opts=opts, typ=GetTagByProductResult).value
