...
warnings.warn("""azure-native:apimanagement/v20200601preview:TagByProduct is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByProduct to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_tag_by_product(product_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_by_product is deprecated: azure-native:apimanagement/v20200601preview:TagByProduct is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByProduct to guarantee forwards compatibility.""")
    __args__ = dict()
