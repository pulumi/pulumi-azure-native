...
warnings.warn("""azure-native:apimanagement/v20200601preview:ApiSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiSchema to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_schema(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_schema is deprecated: azure-native:apimanagement/v20200601preview:ApiSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiSchema to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20200601preview:getApiSchema', __args__, opts=opts, typ=GetApiSchemaResult).value
