...
def get_identity_provider(identity_provider_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_identity_provider is deprecated: azure-native:apimanagement/v20200601preview:IdentityProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:IdentityProvider to guarantee forwards compatibility.""")
    __args__ = dict()
