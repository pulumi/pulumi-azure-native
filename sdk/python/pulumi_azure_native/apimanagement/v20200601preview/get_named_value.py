...
def get_named_value(named_value_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_named_value is deprecated: azure-native:apimanagement/v20200601preview:NamedValue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:NamedValue to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['namedValueId'] = named_value_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20200601preview:getNamedValue', __args__, opts=opts, typ=GetNamedValueResult).value
