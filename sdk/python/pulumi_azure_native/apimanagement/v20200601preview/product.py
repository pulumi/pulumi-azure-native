...
class Product(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 terms: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Product is deprecated: azure-native:apimanagement/v20200601preview:Product is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Product to guarantee forwards compatibility.""")
