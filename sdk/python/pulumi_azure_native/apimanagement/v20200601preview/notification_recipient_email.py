...
warnings.warn("""azure-native:apimanagement/v20200601preview:NotificationRecipientEmail is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NotificationRecipientEmail to guarantee forwards compatibility.""", DeprecationWarning)
