...
warnings.warn("""azure-native:apimanagement/v20200601preview:Diagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Diagnostic to guarantee forwards compatibility.""", DeprecationWarning)
...
class Diagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 verbosity: Optional[pulumi.Input[Union[str, 'Verbosity']]] = None,
                 __props__=None):
        pulumi.log.warn("""Diagnostic is deprecated: azure-native:apimanagement/v20200601preview:Diagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Diagnostic to guarantee forwards compatibility.""")
