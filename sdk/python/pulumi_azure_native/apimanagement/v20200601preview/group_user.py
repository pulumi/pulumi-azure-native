...
warnings.warn("""azure-native:apimanagement/v20200601preview:GroupUser is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GroupUser to guarantee forwards compatibility.""", DeprecationWarning)
...
class GroupUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""GroupUser is deprecated: azure-native:apimanagement/v20200601preview:GroupUser is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GroupUser to guarantee forwards compatibility.""")
