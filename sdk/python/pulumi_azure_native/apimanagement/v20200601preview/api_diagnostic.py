...
warnings.warn("""azure-native:apimanagement/v20200601preview:ApiDiagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiDiagnostic to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiDiagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 verbosity: Optional[pulumi.Input[Union[str, 'Verbosity']]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiDiagnostic is deprecated: azure-native:apimanagement/v20200601preview:ApiDiagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiDiagnostic to guarantee forwards compatibility.""")
