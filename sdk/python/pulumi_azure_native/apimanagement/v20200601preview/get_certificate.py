...
warnings.warn("""azure-native:apimanagement/v20200601preview:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Certificate to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_certificate(certificate_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: azure-native:apimanagement/v20200601preview:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Certificate to guarantee forwards compatibility.""")
    __args__ = dict()
