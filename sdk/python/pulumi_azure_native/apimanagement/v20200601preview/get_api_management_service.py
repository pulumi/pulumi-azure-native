...
def get_api_management_service_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20200601preview:getApiManagementService', __args__, opts=opts, typ=GetApiManagementServiceResult)
