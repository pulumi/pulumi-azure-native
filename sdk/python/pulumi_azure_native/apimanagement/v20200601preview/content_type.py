...
warnings.warn("""azure-native:apimanagement/v20200601preview:ContentType is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ContentType to guarantee forwards compatibility.""", DeprecationWarning)
...
class ContentType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ContentType is deprecated: azure-native:apimanagement/v20200601preview:ContentType is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ContentType to guarantee forwards compatibility.""")
