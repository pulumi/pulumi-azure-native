...
def get_gateway_certificate_authority(certificate_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway_certificate_authority is deprecated: azure-native:apimanagement/v20200601preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GatewayCertificateAuthority to guarantee forwards compatibility.""")
    __args__ = dict()
