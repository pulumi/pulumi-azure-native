...
class ContentItemArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if content_type_id is None and 'contentTypeId' in kwargs:
            content_type_id = kwargs['contentTypeId']
        if content_type_id is None:
            raise TypeError("Missing 'content_type_id' argument")
        ...
        if content_item_id is None and 'contentItemId' in kwargs:
            content_item_id = kwargs['contentItemId']
