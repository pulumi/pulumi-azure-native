...
class ContentItemArgs:
    def __init__(__self__, *,
                 content_type_id: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 service_name: pulumi.Input[builtins.str],
                 content_item_id: Optional[pulumi.Input[builtins.str]] = None,
                 properties: Optional[Any] = None):
        """
        The set of arguments for constructing a ContentItem resource.
        :param pulumi.Input[builtins.str] content_type_id: Content type identifier.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] service_name: The name of the API Management service.
        :param pulumi.Input[builtins.str] content_item_id: Content item identifier.
    ...
    def content_type_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def content_type_id(self, value: pulumi.Input[builtins.str]):
    ...
    def content_item_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_item_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContentItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20191201:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20210101preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20210801:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:ContentItem")])
