...
def get_api_issue_output(api_id: Optional[pulumi.Input[_builtins.str]] = None,
                         expand_comments_attachments: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
