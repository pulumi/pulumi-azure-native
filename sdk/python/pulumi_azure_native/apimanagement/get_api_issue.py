...
def get_api_issue(api_id: Optional[_builtins.str] = None,
                  expand_comments_attachments: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool expand_comments_attachments: Expand the comment attachments. 
...
def get_api_issue_output(api_id: pulumi.Input[Optional[_builtins.str]] = None,
                         expand_comments_attachments: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                         issue_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
