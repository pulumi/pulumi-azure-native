...
def get_product_group_link(group_link_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str group_link_id: Product-Group link identifier. Must be unique in the current API Management service instance.
...
def get_product_group_link_output(group_link_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
