...
def list_tenant_access_secrets(access_name: Optional[builtins.str] = None,
...
def list_tenant_access_secrets_output(access_name: Optional[pulumi.Input[builtins.str]] = None,
