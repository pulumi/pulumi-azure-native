...
def get_api_gateway_config_connection(config_connection_name: Optional[_builtins.str] = None,
...
def get_api_gateway_config_connection_output(config_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
