...
def get_workspace_product_group_link(group_link_id: Optional[_builtins.str] = None,
...
def get_workspace_product_group_link_output(group_link_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
