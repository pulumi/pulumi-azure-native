...
def get_workspace_product_group_link(group_link_id: Optional[builtins.str] = None,
...
def get_workspace_product_group_link_output(group_link_id: Optional[pulumi.Input[builtins.str]] = None,
