...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:Property'.""", DeprecationWarning)
...
class Property(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/latest:Property"), pulumi.Alias(type_="azure-native:apimanagement:Property"), pulumi.Alias(type_="azure-nextgen:apimanagement:Property"), pulumi.Alias(type_="azure-native:apimanagement/v20160707:Property"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20160707:Property"), pulumi.Alias(type_="azure-native:apimanagement/v20161010:Property"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20161010:Property"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:Property"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:Property"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:Property"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:Property"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:Property"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:Property"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:Property"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:Property")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Property, __self__).__init__(
            'azure-native:apimanagement/latest:Property',
            resource_name,
            __props__,
            opts)
