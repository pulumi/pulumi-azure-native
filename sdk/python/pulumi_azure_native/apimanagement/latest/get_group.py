...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getGroup'.""", DeprecationWarning)
...
def get_group(group_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_group is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getGroup'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getGroup', __args__, opts=opts, typ=GetGroupResult).value
