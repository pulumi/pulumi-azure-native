...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getBackend'.""", DeprecationWarning)
...
def get_backend(backend_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getBackend', __args__, opts=opts, typ=GetBackendResult).value
