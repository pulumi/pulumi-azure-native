...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:apimanagement/latest:Api":
                return Api(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiDiagnostic":
                return ApiDiagnostic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiDiagnosticLogger":
                return ApiDiagnosticLogger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiIssue":
                return ApiIssue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiIssueAttachment":
                return ApiIssueAttachment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiIssueComment":
                return ApiIssueComment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiManagementService":
                return ApiManagementService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiOperation":
                return ApiOperation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiOperationPolicy":
                return ApiOperationPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiPolicy":
                return ApiPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiRelease":
                return ApiRelease(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiSchema":
                return ApiSchema(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiTagDescription":
                return ApiTagDescription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ApiVersionSet":
                return ApiVersionSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:AuthorizationServer":
                return AuthorizationServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Backend":
                return Backend(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Cache":
                return Cache(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ContentItem":
                return ContentItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ContentType":
                return ContentType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Diagnostic":
                return Diagnostic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:DiagnosticLogger":
                return DiagnosticLogger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:EmailTemplate":
                return EmailTemplate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Gateway":
            ...
            elif typ == "azure-native:apimanagement/latest:GroupUser":
                return GroupUser(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:IdentityProvider":
                return IdentityProvider(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Logger":
                return Logger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:NamedValue":
                return NamedValue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:NotificationRecipientEmail":
                return NotificationRecipientEmail(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:NotificationRecipientUser":
                return NotificationRecipientUser(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:OpenIdConnectProvider":
                return OpenIdConnectProvider(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Policy":
                return Policy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Product":
                return Product(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ProductApi":
                return ProductApi(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ProductGroup":
                return ProductGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:ProductPolicy":
                return ProductPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Property":
                return Property(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Subscription":
                return Subscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:Tag":
                return Tag(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:TagByApi":
                return TagByApi(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:TagByOperation":
                return TagByOperation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:TagByProduct":
                return TagByProduct(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:apimanagement/latest:User":
    ...
    pulumi.runtime.register_resource_module("azure-native", "apimanagement/latest", _module_instance)
