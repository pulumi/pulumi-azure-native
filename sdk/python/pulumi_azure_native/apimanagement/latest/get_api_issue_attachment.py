...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiIssueAttachment'.""", DeprecationWarning)
...
def get_api_issue_attachment(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_issue_attachment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiIssueAttachment'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getApiIssueAttachment', __args__, opts=opts, typ=GetApiIssueAttachmentResult).value
