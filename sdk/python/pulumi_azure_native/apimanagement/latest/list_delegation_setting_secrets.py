...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:listDelegationSettingSecrets'.""", DeprecationWarning)
...
def list_delegation_setting_secrets(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_delegation_setting_secrets is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:listDelegationSettingSecrets'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:listDelegationSettingSecrets', __args__, opts=opts, typ=ListDelegationSettingSecretsResult).value
