...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:listTenantAccessSecrets'.""", DeprecationWarning)
...
def list_tenant_access_secrets(access_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_tenant_access_secrets is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:listTenantAccessSecrets'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:listTenantAccessSecrets', __args__, opts=opts, typ=ListTenantAccessSecretsResult).value
