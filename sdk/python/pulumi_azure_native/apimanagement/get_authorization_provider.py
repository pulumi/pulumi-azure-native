...
def get_authorization_provider(authorization_provider_id: Optional[_builtins.str] = None,
...
def get_authorization_provider_output(authorization_provider_id: pulumi.Input[Optional[_builtins.str]] = None,
