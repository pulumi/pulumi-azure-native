...
warnings.warn("""azure-native:apimanagement/v20210401preview:OpenIdConnectProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:OpenIdConnectProvider to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_open_id_connect_provider(opid: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_id_connect_provider is deprecated: azure-native:apimanagement/v20210401preview:OpenIdConnectProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:OpenIdConnectProvider to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['opid'] = opid
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20210401preview:getOpenIdConnectProvider', __args__, opts=opts, typ=GetOpenIdConnectProviderResult).value
