...
warnings.warn("""azure-native:apimanagement/v20210401preview:ContentItem is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ContentItem to guarantee forwards compatibility.""", DeprecationWarning)
...
class ContentItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ContentItem is deprecated: azure-native:apimanagement/v20210401preview:ContentItem is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ContentItem to guarantee forwards compatibility.""")
