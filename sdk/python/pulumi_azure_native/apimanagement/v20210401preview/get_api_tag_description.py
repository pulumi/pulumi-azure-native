...
def get_api_tag_description(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_tag_description is deprecated: azure-native:apimanagement/v20210401preview:ApiTagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiTagDescription to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20210401preview:getApiTagDescription', __args__, opts=opts, typ=GetApiTagDescriptionResult).value
