...
warnings.warn("""azure-native:apimanagement/v20210401preview:NotificationRecipientUser is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:NotificationRecipientUser to guarantee forwards compatibility.""", DeprecationWarning)
