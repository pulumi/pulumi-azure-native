...
warnings.warn("""azure-native:apimanagement/v20210401preview:ApiManagementService is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiManagementService to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_management_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_management_service is deprecated: azure-native:apimanagement/v20210401preview:ApiManagementService is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiManagementService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20210401preview:getApiManagementService', __args__, opts=opts, typ=GetApiManagementServiceResult).value
