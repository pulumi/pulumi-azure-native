...
class ApiPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiPolicy is deprecated: azure-native:apimanagement/v20210401preview:ApiPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiPolicy to guarantee forwards compatibility.""")
