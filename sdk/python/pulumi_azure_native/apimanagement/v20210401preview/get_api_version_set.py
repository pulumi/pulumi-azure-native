...
warnings.warn("""azure-native:apimanagement/v20210401preview:ApiVersionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiVersionSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_version_set(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_version_set is deprecated: azure-native:apimanagement/v20210401preview:ApiVersionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiVersionSet to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    __args__['versionSetId'] = version_set_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20210401preview:getApiVersionSet', __args__, opts=opts, typ=GetApiVersionSetResult).value
