...
warnings.warn("""azure-native:apimanagement/v20210401preview:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_policy(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_policy is deprecated: azure-native:apimanagement/v20210401preview:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20210401preview:getApiPolicy', __args__, opts=opts, typ=GetApiPolicyResult).value
