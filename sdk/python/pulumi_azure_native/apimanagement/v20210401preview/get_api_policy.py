...
warnings.warn("""azure-native:apimanagement/v20210401preview:ApiPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_policy(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_policy is deprecated: azure-native:apimanagement/v20210401preview:ApiPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
