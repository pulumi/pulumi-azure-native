...
warnings.warn("""azure-native:apimanagement/v20210401preview:Cache is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Cache to guarantee forwards compatibility.""", DeprecationWarning)
...
class Cache(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 use_from_location: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Cache is deprecated: azure-native:apimanagement/v20210401preview:Cache is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Cache to guarantee forwards compatibility.""")
