...
warnings.warn("""azure-native:apimanagement/v20210401preview:ApiSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiSchema to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiSchema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiSchema is deprecated: azure-native:apimanagement/v20210401preview:ApiSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiSchema to guarantee forwards compatibility.""")
