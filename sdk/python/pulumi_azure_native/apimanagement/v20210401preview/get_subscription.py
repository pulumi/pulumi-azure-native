...
def get_subscription(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subscription is deprecated: azure-native:apimanagement/v20210401preview:Subscription is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Subscription to guarantee forwards compatibility.""")
    __args__ = dict()
