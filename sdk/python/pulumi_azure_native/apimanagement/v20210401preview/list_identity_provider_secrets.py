...
def list_identity_provider_secrets(identity_provider_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20210401preview:listIdentityProviderSecrets', __args__, opts=opts, typ=ListIdentityProviderSecretsResult).value
...
def list_identity_provider_secrets_output(identity_provider_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20210401preview:listIdentityProviderSecrets', __args__, opts=opts, typ=ListIdentityProviderSecretsResult)
