...
def get_backend(backend_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backend is deprecated: azure-native:apimanagement/v20210401preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Backend to guarantee forwards compatibility.""")
    __args__ = dict()
