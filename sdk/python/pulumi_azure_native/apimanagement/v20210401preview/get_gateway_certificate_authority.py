...
warnings.warn("""azure-native:apimanagement/v20210401preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayCertificateAuthority to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_gateway_certificate_authority(certificate_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway_certificate_authority is deprecated: azure-native:apimanagement/v20210401preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayCertificateAuthority to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20210401preview:getGatewayCertificateAuthority', __args__, opts=opts, typ=GetGatewayCertificateAuthorityResult).value
