...
def get_cache(cache_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cache is deprecated: azure-native:apimanagement/v20210401preview:Cache is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Cache to guarantee forwards compatibility.""")
    __args__ = dict()
