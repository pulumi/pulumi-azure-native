...
class Schema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20210801:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20220401preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:Schema"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement:Schema")])
