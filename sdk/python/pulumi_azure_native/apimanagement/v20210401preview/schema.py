...
class Schema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20210401preview:Schema"), pulumi.Alias(type_="azure-native:apimanagement:Schema"), pulumi.Alias(type_="azure-nextgen:apimanagement:Schema")])
