...
warnings.warn("""azure-native:apimanagement/v20210401preview:Logger is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Logger to guarantee forwards compatibility.""", DeprecationWarning)
...
class Logger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Logger is deprecated: azure-native:apimanagement/v20210401preview:Logger is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Logger to guarantee forwards compatibility.""")
