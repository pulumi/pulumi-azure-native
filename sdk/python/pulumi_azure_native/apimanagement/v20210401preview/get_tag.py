...
warnings.warn("""azure-native:apimanagement/v20210401preview:Tag is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Tag to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_tag(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag is deprecated: azure-native:apimanagement/v20210401preview:Tag is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Tag to guarantee forwards compatibility.""")
    __args__ = dict()
