...
class WorkspaceGlobalSchema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230301preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native_apimanagement_v20220901preview:apimanagement:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native_apimanagement_v20230301preview:apimanagement:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native_apimanagement_v20230501preview:apimanagement:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native_apimanagement_v20230901preview:apimanagement:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native_apimanagement_v20240501:apimanagement:WorkspaceGlobalSchema"), pulumi.Alias(type_="azure-native_apimanagement_v20240601preview:apimanagement:WorkspaceGlobalSchema")])
