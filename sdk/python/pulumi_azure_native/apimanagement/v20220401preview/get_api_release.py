...
warnings.warn("""azure-native:apimanagement/v20220401preview:ApiRelease is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiRelease to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_release(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_release is deprecated: azure-native:apimanagement/v20220401preview:ApiRelease is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiRelease to guarantee forwards compatibility.""")
    __args__ = dict()
