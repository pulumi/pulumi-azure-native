...
def get_authorization_server_output(authsid: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20220401preview:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult)
