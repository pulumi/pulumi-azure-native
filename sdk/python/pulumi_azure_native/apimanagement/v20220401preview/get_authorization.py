...
warnings.warn("""azure-native:apimanagement/v20220401preview:Authorization is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Authorization to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_authorization(authorization_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization is deprecated: azure-native:apimanagement/v20220401preview:Authorization is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Authorization to guarantee forwards compatibility.""")
    __args__ = dict()
