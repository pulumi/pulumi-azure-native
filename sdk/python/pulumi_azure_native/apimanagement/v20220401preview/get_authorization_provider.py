...
warnings.warn("""azure-native:apimanagement/v20220401preview:AuthorizationProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:AuthorizationProvider to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_authorization_provider(authorization_provider_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization_provider is deprecated: azure-native:apimanagement/v20220401preview:AuthorizationProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:AuthorizationProvider to guarantee forwards compatibility.""")
    __args__ = dict()
