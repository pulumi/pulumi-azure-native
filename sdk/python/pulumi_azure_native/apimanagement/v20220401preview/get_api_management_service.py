...
def get_api_management_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_management_service is deprecated: azure-native:apimanagement/v20220401preview:ApiManagementService is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiManagementService to guarantee forwards compatibility.""")
    __args__ = dict()
