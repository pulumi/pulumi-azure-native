...
warnings.warn("""azure-native:apimanagement/v20220401preview:Subscription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Subscription to guarantee forwards compatibility.""", DeprecationWarning)
...
class Subscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 state: Optional[pulumi.Input['SubscriptionState']] = None,
                 __props__=None):
        pulumi.log.warn("""Subscription is deprecated: azure-native:apimanagement/v20220401preview:Subscription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Subscription to guarantee forwards compatibility.""")
