...
warnings.warn("""azure-native:apimanagement/v20220401preview:PolicyFragment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:PolicyFragment to guarantee forwards compatibility.""", DeprecationWarning)
...
class PolicyFragment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PolicyFragment is deprecated: azure-native:apimanagement/v20220401preview:PolicyFragment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:PolicyFragment to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement:PolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:PolicyFragment"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:PolicyFragment")])
