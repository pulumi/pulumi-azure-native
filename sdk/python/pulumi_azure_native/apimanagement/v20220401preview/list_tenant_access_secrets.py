...
def list_tenant_access_secrets(access_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220401preview:listTenantAccessSecrets', __args__, opts=opts, typ=ListTenantAccessSecretsResult).value
...
def list_tenant_access_secrets_output(access_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20220401preview:listTenantAccessSecrets', __args__, opts=opts, typ=ListTenantAccessSecretsResult)
