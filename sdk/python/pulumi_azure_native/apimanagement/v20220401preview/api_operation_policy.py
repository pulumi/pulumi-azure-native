...
warnings.warn("""azure-native:apimanagement/v20220401preview:ApiOperationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperationPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiOperationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiOperationPolicy is deprecated: azure-native:apimanagement/v20220401preview:ApiOperationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperationPolicy to guarantee forwards compatibility.""")
        ...
        super(ApiOperationPolicy, __self__).__init__(
            'azure-native:apimanagement/v20220401preview:ApiOperationPolicy',
            resource_name,
            __props__,
            opts)
