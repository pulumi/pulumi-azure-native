...
__all__ = [
    ...
    'SchemaDocumentPropertiesResponse',
...
@pulumi.output_type
class SchemaDocumentPropertiesResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        :param str value: Json escaped string defining the document representing the Schema. Used for schemas other than Swagger/OpenAPI.
        """
