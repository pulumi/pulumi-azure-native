...
class ApiDiagnostic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 verbosity: Optional[pulumi.Input[Union[str, 'Verbosity']]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiDiagnostic is deprecated: azure-native:apimanagement/v20220401preview:ApiDiagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiDiagnostic to guarantee forwards compatibility.""")
