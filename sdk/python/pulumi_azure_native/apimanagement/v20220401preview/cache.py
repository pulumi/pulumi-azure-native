...
warnings.warn("""azure-native:apimanagement/v20220401preview:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Cache to guarantee forwards compatibility.""", DeprecationWarning)
