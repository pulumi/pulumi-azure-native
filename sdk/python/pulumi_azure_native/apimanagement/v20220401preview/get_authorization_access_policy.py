...
warnings.warn("""azure-native:apimanagement/v20220401preview:AuthorizationAccessPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:AuthorizationAccessPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_authorization_access_policy(authorization_access_policy_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization_access_policy is deprecated: azure-native:apimanagement/v20220401preview:AuthorizationAccessPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:AuthorizationAccessPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220401preview:getAuthorizationAccessPolicy', __args__, opts=opts, typ=GetAuthorizationAccessPolicyResult).value
