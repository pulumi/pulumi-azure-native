...
def get_policy_fragment(format: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_fragment is deprecated: azure-native:apimanagement/v20220401preview:PolicyFragment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:PolicyFragment to guarantee forwards compatibility.""")
    __args__ = dict()
