...
warnings.warn("""azure-native:apimanagement/v20220401preview:ContentType is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ContentType to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_content_type(content_type_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_content_type is deprecated: azure-native:apimanagement/v20220401preview:ContentType is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ContentType to guarantee forwards compatibility.""")
    __args__ = dict()
