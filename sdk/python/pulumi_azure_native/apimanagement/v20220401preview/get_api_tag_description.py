...
def get_api_tag_description_output(api_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:apimanagement/v20220401preview:getApiTagDescription', __args__, opts=opts, typ=GetApiTagDescriptionResult)
