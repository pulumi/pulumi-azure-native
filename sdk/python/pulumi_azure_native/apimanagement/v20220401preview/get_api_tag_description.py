...
warnings.warn("""azure-native:apimanagement/v20220401preview:ApiTagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiTagDescription to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_tag_description(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_tag_description is deprecated: azure-native:apimanagement/v20220401preview:ApiTagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiTagDescription to guarantee forwards compatibility.""")
    __args__ = dict()
