...
warnings.warn("""azure-native:apimanagement/v20220401preview:NotificationRecipientUser is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NotificationRecipientUser to guarantee forwards compatibility.""", DeprecationWarning)
...
class NotificationRecipientUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""NotificationRecipientUser is deprecated: azure-native:apimanagement/v20220401preview:NotificationRecipientUser is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NotificationRecipientUser to guarantee forwards compatibility.""")
