...
warnings.warn("""azure-native:apimanagement/v20220401preview:GlobalSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GlobalSchema to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_global_schema(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_global_schema is deprecated: azure-native:apimanagement/v20220401preview:GlobalSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GlobalSchema to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['schemaId'] = schema_id
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/v20220401preview:getGlobalSchema', __args__, opts=opts, typ=GetGlobalSchemaResult).value
