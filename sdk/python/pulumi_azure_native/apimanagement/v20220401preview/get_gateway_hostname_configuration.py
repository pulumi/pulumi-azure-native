...
def get_gateway_hostname_configuration(gateway_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway_hostname_configuration is deprecated: azure-native:apimanagement/v20220401preview:GatewayHostnameConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:GatewayHostnameConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
