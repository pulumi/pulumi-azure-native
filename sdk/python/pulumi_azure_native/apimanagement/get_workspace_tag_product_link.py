...
def get_workspace_tag_product_link(product_link_id: Optional[_builtins.str] = None,
...
def get_workspace_tag_product_link_output(product_link_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
