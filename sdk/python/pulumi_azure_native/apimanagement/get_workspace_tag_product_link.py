...
def get_workspace_tag_product_link(product_link_id: Optional[builtins.str] = None,
...
def get_workspace_tag_product_link_output(product_link_id: Optional[pulumi.Input[builtins.str]] = None,
