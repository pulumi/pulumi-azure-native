...
class PolicyRestriction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:PolicyRestriction"), pulumi.Alias(type_="azure-native_apimanagement_v20230501preview:apimanagement:PolicyRestriction"), pulumi.Alias(type_="azure-native_apimanagement_v20230901preview:apimanagement:PolicyRestriction"), pulumi.Alias(type_="azure-native_apimanagement_v20240501:apimanagement:PolicyRestriction"), pulumi.Alias(type_="azure-native_apimanagement_v20240601preview:apimanagement:PolicyRestriction")])
