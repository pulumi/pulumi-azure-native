...
class PolicyRestrictionArgs:
    def __init__(__self__, *,
                 ...
                 policy_restriction_id: Optional[pulumi.Input[builtins.str]] = None,
                 require_base: Optional[pulumi.Input[Union[builtins.str, 'PolicyRestrictionRequireBase']]] = None,
        ...
        :param pulumi.Input[builtins.str] policy_restriction_id: Policy restrictions after an entity level
        :param pulumi.Input[Union[builtins.str, 'PolicyRestrictionRequireBase']] require_base: Indicates if base policy should be enforced for the policy document.
        :param pulumi.Input[builtins.str] scope: Path to the policy document.
        """
    ...
    def policy_restriction_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_restriction_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "policy_restriction_id", value)

    @property
    @pulumi.getter(name="requireBase")
    def require_base(self) -> Optional[pulumi.Input[Union[builtins.str, 'PolicyRestrictionRequireBase']]]:
        """
    ...
    @require_base.setter
    def require_base(self, value: Optional[pulumi.Input[Union[builtins.str, 'PolicyRestrictionRequireBase']]]):
...
class PolicyRestriction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230501preview:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:PolicyRestriction"), pulumi.Alias(type_="azure-native:apimanagement/v20241001preview:PolicyRestriction")])
    ...
    @property
    @pulumi.getter(name="requireBase")
    def require_base(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates if base policy should be enforced for the policy document.
        """
        return pulumi.get(self, "require_base")
