...
class EmailTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] body: Email Template Body. This should be a valid XDocument
        :param pulumi.Input[builtins.str] description: Description of the Email Template.
        ...
        :param pulumi.Input[builtins.str] subject: Subject of the Template.
        :param pulumi.Input[builtins.str] template_name: Email Template Name Identifier.
        :param pulumi.Input[builtins.str] title: Title of the Template.
        """
