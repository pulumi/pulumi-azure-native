...
class EmailTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20170301:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20210401preview:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20211201preview:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20220801:EmailTemplate"), pulumi.Alias(type_="azure-native:apimanagement/v20220901preview:EmailTemplate")])
