...
def get_workspace_tag(resource_group_name: Optional[builtins.str] = None,
...
def get_workspace_tag_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
