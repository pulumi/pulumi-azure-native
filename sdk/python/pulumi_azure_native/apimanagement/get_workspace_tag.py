...
def get_workspace_tag(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement:getWorkspaceTag', __args__, opts=opts, typ=GetWorkspaceTagResult).value
...
def get_workspace_tag_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
