...
class WorkspaceBackend(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apimanagement/v20230901preview:WorkspaceBackend"), pulumi.Alias(type_="azure-native:apimanagement/v20240501:WorkspaceBackend"), pulumi.Alias(type_="azure-native:apimanagement/v20240601preview:WorkspaceBackend"), pulumi.Alias(type_="azure-native_apimanagement_v20230901preview:apimanagement:WorkspaceBackend"), pulumi.Alias(type_="azure-native_apimanagement_v20240501:apimanagement:WorkspaceBackend"), pulumi.Alias(type_="azure-native_apimanagement_v20240601preview:apimanagement:WorkspaceBackend")])
