...
class DiskPoolArgs:
    def __init__(__self__, *,
                 ...
                 additional_capabilities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] subnet_id: Azure Resource ID of a Subnet for the Disk Pool.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_capabilities: List of additional capabilities for a Disk Pool.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Logical zone for Disk Pool resource; example: ["1"].
    ...
    def additional_capabilities(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def additional_capabilities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def disk_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disk_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DiskPool(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="additionalCapabilities")
    def additional_capabilities(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
