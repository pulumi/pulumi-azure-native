...
class DiskPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagepool/v20200315preview:DiskPool"), pulumi.Alias(type_="azure-native:storagepool/v20210801:DiskPool"), pulumi.Alias(type_="azure-native_storagepool_v20200315preview:storagepool:DiskPool"), pulumi.Alias(type_="azure-native_storagepool_v20210401preview:storagepool:DiskPool"), pulumi.Alias(type_="azure-native_storagepool_v20210801:storagepool:DiskPool")])
