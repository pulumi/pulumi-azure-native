...
class AclResponse(dict):
    ...
    def __init__(__self__, *,
                 initiator_iqn: builtins.str,
                 mapped_luns: Sequence[builtins.str]):
        """
        Access Control List (ACL) for an iSCSI Target; defines LUN masking policy
        :param builtins.str initiator_iqn: iSCSI initiator IQN (iSCSI Qualified Name); example: "iqn.2005-03.org.iscsi:client".
        :param Sequence[builtins.str] mapped_luns: List of LUN names mapped to the ACL.
        """
    ...
    def initiator_iqn(self) -> builtins.str:
        """
    ...
    def mapped_luns(self) -> Sequence[builtins.str]:
        """
...
class DiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Azure Managed Disk to attach to the Disk Pool.
        :param builtins.str id: Unique Azure Resource ID of the Managed Disk.
        """
...
class IscsiLunResponse(dict):
    ...
    def __init__(__self__, *,
                 lun: builtins.int,
                 managed_disk_azure_resource_id: builtins.str,
                 name: builtins.str):
        """
        LUN to expose the Azure Managed Disk.
        :param builtins.int lun: Specifies the Logical Unit Number of the iSCSI LUN.
        :param builtins.str managed_disk_azure_resource_id: Azure Resource ID of the Managed Disk.
        :param builtins.str name: User defined name for iSCSI LUN; example: "lun0"
        """
    ...
    def managed_disk_azure_resource_id(self) -> builtins.str:
        """
