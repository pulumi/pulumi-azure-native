...
def get_iscsi_target(disk_pool_name: Optional[_builtins.str] = None,
                     iscsi_target_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str iscsi_target_name: The name of the iSCSI Target.
...
def get_iscsi_target_output(disk_pool_name: pulumi.Input[Optional[_builtins.str]] = None,
                            iscsi_target_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
