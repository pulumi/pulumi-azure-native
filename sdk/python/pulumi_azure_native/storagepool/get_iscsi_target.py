...
class GetIscsiTargetResult:
    ...
    @property
    @pulumi.getter
    def sessions(self) -> Sequence[builtins.str]:
        """
...
def get_iscsi_target(disk_pool_name: Optional[builtins.str] = None,
                     iscsi_target_name: Optional[builtins.str] = None,
    ...
    :param builtins.str iscsi_target_name: The name of the iSCSI Target.
...
def get_iscsi_target_output(disk_pool_name: Optional[pulumi.Input[builtins.str]] = None,
