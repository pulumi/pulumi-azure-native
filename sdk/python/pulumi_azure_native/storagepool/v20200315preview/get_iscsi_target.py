...
warnings.warn("""Version 2020-03-15-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_iscsi_target(disk_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iscsi_target is deprecated: Version 2020-03-15-preview will be removed in v2 of the provider.""")
    __args__ = dict()
