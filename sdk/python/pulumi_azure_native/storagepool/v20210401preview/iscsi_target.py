...
class IscsiTarget(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_iqn: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""IscsiTarget is deprecated: azure-native:storagepool/v20210401preview:IscsiTarget is being removed in the next major version of this provider. Upgrade to at least azure-native:storagepool/v20210801:IscsiTarget to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagepool:IscsiTarget"), pulumi.Alias(type_="azure-native:storagepool/v20200315preview:IscsiTarget"), pulumi.Alias(type_="azure-native:storagepool/v20210801:IscsiTarget")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IscsiTarget, __self__).__init__(
            'azure-native:storagepool/v20210401preview:IscsiTarget',
            resource_name,
            __props__,
            opts)
