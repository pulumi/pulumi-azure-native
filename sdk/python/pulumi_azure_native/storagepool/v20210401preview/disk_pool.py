...
class DiskPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DiskPool is deprecated: azure-native:storagepool/v20210401preview:DiskPool is being removed in the next major version of this provider. Please upgrade to azure-native:storagepool/v20210801:DiskPool to guarantee forwards compatibility.""")
