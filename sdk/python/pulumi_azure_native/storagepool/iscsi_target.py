...
class IscsiTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_iqn: iSCSI Target IQN (iSCSI Qualified Name); example: "iqn.2005-03.org.iscsi:server".
        """
    ...
    @acl_mode.setter
    def acl_mode(self, value: pulumi.Input[Union[_builtins.str, 'IscsiTargetAclMode']]):
