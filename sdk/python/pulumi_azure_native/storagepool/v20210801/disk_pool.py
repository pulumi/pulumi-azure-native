...
class DiskPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        disk_pool = azure_native.storagepool.v20210801.DiskPool("diskPool",
            ...
            sku=azure_native.storagepool.v20210801.SkuArgs(
                name="Basic_V1",
                tier="Basic",
            ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagepool:DiskPool"), pulumi.Alias(type_="azure-native:storagepool/v20200315preview:DiskPool"), pulumi.Alias(type_="azure-native:storagepool/v20210401preview:DiskPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiskPool, __self__).__init__(
            'azure-native:storagepool/v20210801:DiskPool',
            resource_name,
            __props__,
            opts)
