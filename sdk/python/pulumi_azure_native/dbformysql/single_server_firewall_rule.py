...
class SingleServerFirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] start_ip_address: The start IP address of the server firewall rule. Must be IPv4 format.
        :param pulumi.Input[_builtins.str] firewall_rule_name: The name of the server firewall rule.
        """
...
class SingleServerFirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SingleServerFirewallRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SingleServerFirewallRuleArgs.__new__(SingleServerFirewallRuleArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:SingleServerFirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:SingleServerFirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:SingleServerFirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerFirewallRule, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SingleServerFirewallRule':
        """
        ...
        __props__.__dict__["type"] = None
        return SingleServerFirewallRule(resource_name, opts=opts, __props__=__props__)
