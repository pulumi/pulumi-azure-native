...
def get_azure_ad_administrator_output(administrator_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20211201preview:getAzureADAdministrator', __args__, opts=opts, typ=GetAzureADAdministratorResult)
