...
warnings.warn("""azure-native:dbformysql/v20211201preview:Server is being removed in the next major version of this provider. Please upgrade to azure-native:dbformysql/v20220101:Server to guarantee forwards compatibility.""", DeprecationWarning)
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 version: Optional[pulumi.Input[Union[str, 'ServerVersion']]] = None,
                 __props__=None):
        pulumi.log.warn("""Server is deprecated: azure-native:dbformysql/v20211201preview:Server is being removed in the next major version of this provider. Please upgrade to azure-native:dbformysql/v20220101:Server to guarantee forwards compatibility.""")
