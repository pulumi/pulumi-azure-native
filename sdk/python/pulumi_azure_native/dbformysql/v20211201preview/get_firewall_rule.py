...
warnings.warn("""azure-native:dbformysql/v20211201preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:dbformysql/v20220101:FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_rule is deprecated: azure-native:dbformysql/v20211201preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:dbformysql/v20220101:FirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
