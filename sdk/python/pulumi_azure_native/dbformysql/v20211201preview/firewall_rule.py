...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20200701preview:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20200701privatepreview:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20210501:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20210501preview:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20220101:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20230601preview:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20230630:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20231230:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:dbformysql/v20211201preview:FirewallRule',
            resource_name,
            __props__,
            opts)
