...
class ConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] current_value: Current value of the configuration.
        :param pulumi.Input[Union[_builtins.str, 'ConfigurationSource']] source: Source of the configuration.
