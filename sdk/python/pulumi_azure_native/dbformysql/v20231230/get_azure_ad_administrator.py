...
def get_azure_ad_administrator(administrator_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20231230:getAzureADAdministrator', __args__, opts=opts, typ=GetAzureADAdministratorResult).value
...
def get_azure_ad_administrator_output(administrator_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20231230:getAzureADAdministrator', __args__, opts=opts, typ=GetAzureADAdministratorResult)
