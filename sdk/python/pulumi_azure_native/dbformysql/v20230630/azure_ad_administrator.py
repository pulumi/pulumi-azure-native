...
class AzureADAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20211201preview:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20220101:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20230601preview:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20231230:AzureADAdministrator")])
