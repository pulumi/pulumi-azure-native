...
class SingleServerServerAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:ServerAdministrator"), pulumi.Alias(type_="azure-native_dbformysql_v20171201:dbformysql:SingleServerServerAdministrator"), pulumi.Alias(type_="azure-native_dbformysql_v20171201preview:dbformysql:SingleServerServerAdministrator"), pulumi.Alias(type_="azure-native_dbformysql_v20180601privatepreview:dbformysql:SingleServerServerAdministrator")])
