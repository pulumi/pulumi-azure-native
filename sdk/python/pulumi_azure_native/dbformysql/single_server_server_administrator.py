...
class SingleServerServerAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:SingleServerServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:SingleServerServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:SingleServerServerAdministrator")])
