...
class GetServerResult:
    ...
    Represents a server.
    """
    def __init__(__self__, administrator_login=None, availability_zone=None, backup=None, data_encryption=None, database_port=None, full_version=None, fully_qualified_domain_name=None, high_availability=None, id=None, identity=None, import_source_properties=None, location=None, maintenance_policy=None, maintenance_window=None, name=None, network=None, private_endpoint_connections=None, replica_capacity=None, replication_role=None, sku=None, source_server_resource_id=None, state=None, storage=None, system_data=None, tags=None, type=None, version=None):
        ...
        if full_version and not isinstance(full_version, str):
            raise TypeError("Expected argument 'full_version' to be a str")
...
def get_server(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20241001preview:getServer', __args__, opts=opts, typ=GetServerResult).value
    ...
    return AwaitableGetServerResult(
        ...
        full_version=pulumi.get(__ret__, 'full_version'),
...
def get_server_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20241001preview:getServer', __args__, opts=opts, typ=GetServerResult)
    return __ret__.apply(lambda __response__: GetServerResult(
        ...
        full_version=pulumi.get(__response__, 'full_version'),
