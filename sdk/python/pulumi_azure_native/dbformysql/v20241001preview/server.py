...
class ServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] database_port: The server database port. Can only be specified when the server is being created.
        :param pulumi.Input[str] full_version: Major version and actual engine version
        ...
        :param pulumi.Input['MaintenancePolicyArgs'] maintenance_policy: Maintenance policy of a server.
        :param pulumi.Input['MaintenanceWindowArgs'] maintenance_window: Maintenance window of a server. Known issue: cannot be set during server creation or updated with other properties during server update; must be updated separately.
        ...
        :param pulumi.Input[Union[str, 'ServerVersion']] version: Major version of MySQL. 8.0.21 stands for MySQL 8.0, 5.7.44 stands for MySQL 5.7
        """
...
class Server(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['MaintenancePolicyArgs', 'MaintenancePolicyArgsDict']] maintenance_policy: Maintenance policy of a server.
        :param pulumi.Input[Union['MaintenanceWindowArgs', 'MaintenanceWindowArgsDict']] maintenance_window: Maintenance window of a server. Known issue: cannot be set during server creation or updated with other properties during server update; must be updated separately.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["database_port"] = database_port
            __props__.__dict__["full_version"] = full_version
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20200701preview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20200701privatepreview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20210501:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20210501preview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20211201preview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20220101:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20220930preview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20230601preview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20230630:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20231001preview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20231201preview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20231230:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20240201preview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20240601preview:Server"), pulumi.Alias(type_="azure-native:dbformysql:Server")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Server, __self__).__init__(
            'azure-native:dbformysql/v20241001preview:Server',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["database_port"] = None
        __props__.__dict__["full_version"] = None
        __props__.__dict__["fully_qualified_domain_name"] = None
    ...
    @property
    @pulumi.getter(name="databasePort")
    def database_port(self) -> pulumi.Output[Optional[int]]:
        """
        The server database port. Can only be specified when the server is being created.
        """
        return pulumi.get(self, "database_port")
    ...
    @property
    @pulumi.getter(name="fullVersion")
    def full_version(self) -> pulumi.Output[Optional[str]]:
        """
        Major version and actual engine version
        """
        return pulumi.get(self, "full_version")
    ...
    @property
    @pulumi.getter(name="maintenancePolicy")
    def maintenance_policy(self) -> pulumi.Output[Optional['outputs.MaintenancePolicyResponse']]:
        """
        Maintenance policy of a server.
        """
        return pulumi.get(self, "maintenance_policy")
