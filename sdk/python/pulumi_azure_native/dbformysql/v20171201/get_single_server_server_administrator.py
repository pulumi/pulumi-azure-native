...
def get_single_server_server_administrator(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20171201:getSingleServerServerAdministrator', __args__, opts=opts, typ=GetSingleServerServerAdministratorResult).value
...
def get_single_server_server_administrator_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20171201:getSingleServerServerAdministrator', __args__, opts=opts, typ=GetSingleServerServerAdministratorResult)
