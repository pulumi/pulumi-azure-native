...
class SingleServer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SingleServerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SingleServerArgs.__new__(SingleServerArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:SingleServer"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:SingleServer"), pulumi.Alias(type_="azure-native:dbformysql:SingleServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServer, __self__).__init__(
            'azure-native:dbformysql/v20171201:SingleServer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SingleServer':
        """
        ...
        __props__.__dict__["user_visible_state"] = None
        __props__.__dict__["version"] = None
        return SingleServer(resource_name, opts=opts, __props__=__props__)
