...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbformysql:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:VirtualNetworkRule")])
