...
warnings.warn("""azure-native:dbformysql/v20171201:VirtualNetworkRule is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20180601privatepreview:VirtualNetworkRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:VirtualNetworkRule")])
