...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:dbformysql/v20171201:Configuration":
                return Configuration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformysql/v20171201:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformysql/v20171201:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformysql/v20171201:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformysql/v20171201:ServerAdministrator":
                return ServerAdministrator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbformysql/v20171201:VirtualNetworkRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "dbformysql/v20171201", _module_instance)
