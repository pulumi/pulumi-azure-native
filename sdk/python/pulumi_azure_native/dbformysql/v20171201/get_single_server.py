...
def get_single_server(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20171201:getSingleServer', __args__, opts=opts, typ=GetSingleServerResult).value
...
def get_single_server_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20171201:getSingleServer', __args__, opts=opts, typ=GetSingleServerResult)
