...
class ServerAdministrator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_administrator = azure_native.dbformysql.v20171201.ServerAdministrator("serverAdministrator",
        ...
        ```sh
        $ pulumi import azure-native:dbformysql/v20171201:ServerAdministrator activeDirectory /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/providers/Microsoft.DBforMySQL/servers/mysqltestsvc4/administrators/activeDirectory 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:ServerAdministrator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerAdministrator, __self__).__init__(
            'azure-native:dbformysql/v20171201:ServerAdministrator',
            resource_name,
            __props__,
            opts)
