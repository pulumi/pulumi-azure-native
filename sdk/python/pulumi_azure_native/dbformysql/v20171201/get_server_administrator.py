...
def get_server_administrator(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20171201:getServerAdministrator', __args__, opts=opts, typ=GetServerAdministratorResult).value
...
def get_server_administrator_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetServerAdministratorResult]:
    """
    Gets information about a AAD server administrator.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20171201:getServerAdministrator', __args__, opts=opts, typ=GetServerAdministratorResult)
    return __ret__.apply(lambda __response__: GetServerAdministratorResult(
