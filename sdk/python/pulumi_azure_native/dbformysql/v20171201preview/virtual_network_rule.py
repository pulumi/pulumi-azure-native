...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_rule = azure_native.dbformysql.v20171201preview.VirtualNetworkRule("virtualNetworkRule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:VirtualNetworkRule")])
