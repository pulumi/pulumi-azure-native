...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_rule is deprecated: azure-native:dbformysql/v20171201preview:FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220101:FirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['firewallRuleName'] = firewall_rule_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20171201preview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
