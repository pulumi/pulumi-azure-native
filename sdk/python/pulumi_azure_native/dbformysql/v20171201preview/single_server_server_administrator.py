...
class SingleServerServerAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:SingleServerServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:SingleServerServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:SingleServerServerAdministrator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerServerAdministrator, __self__).__init__(
            'azure-native:dbformysql/v20171201preview:SingleServerServerAdministrator',
            resource_name,
            __props__,
            opts)
