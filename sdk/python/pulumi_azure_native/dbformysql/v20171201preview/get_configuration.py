...
warnings.warn("""azure-native:dbformysql/v20171201preview:Configuration is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20200701privatepreview:Configuration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_configuration(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration is deprecated: azure-native:dbformysql/v20171201preview:Configuration is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20200701privatepreview:Configuration to guarantee forwards compatibility.""")
    __args__ = dict()
