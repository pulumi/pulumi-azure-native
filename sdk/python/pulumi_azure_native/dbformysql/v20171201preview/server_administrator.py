...
class ServerAdministrator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_administrator = azure_native.dbformysql.v20171201preview.ServerAdministrator("serverAdministrator",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:ServerAdministrator")])
