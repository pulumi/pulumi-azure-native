...
class SingleServerFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:SingleServerFirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:SingleServerFirewallRule"), pulumi.Alias(type_="azure-native:dbformysql:SingleServerFirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerFirewallRule, __self__).__init__(
            'azure-native:dbformysql/v20180601privatepreview:SingleServerFirewallRule',
            resource_name,
            __props__,
            opts)
