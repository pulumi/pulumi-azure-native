...
class SingleServerVirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:SingleServerVirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:SingleServerVirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql:SingleServerVirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerVirtualNetworkRule, __self__).__init__(
            'azure-native:dbformysql/v20180601privatepreview:SingleServerVirtualNetworkRule',
            resource_name,
            __props__,
            opts)
