...
class Server(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server = azure_native.dbformysql.v20180601privatepreview.Server("server",
            location="brazilsouth",
            properties=azure_native.dbformysql.v20180601privatepreview.ServerPropertiesForRestoreArgs(
            ...
            sku=azure_native.dbformysql.v20180601privatepreview.SkuResponseArgs(
                capacity=2,
                family="Gen5",
                name="GP_Gen5_2",
                tier="GeneralPurpose",
        ...
        server = azure_native.dbformysql.v20180601privatepreview.Server("server",
            location="westus",
            properties=azure_native.dbformysql.v20180601privatepreview.ServerPropertiesForDefaultCreateArgs(
                administrator_login="cloudsa",
                administrator_login_password="<administratorLoginPassword>",
                create_mode="Default",
                ssl_enforcement=azure_native.dbformysql/v20180601privatepreview.SslEnforcementEnum.ENABLED,
                storage_profile=azure_native.dbformysql.v20180601privatepreview.StorageProfileArgs(
        ...
        server = azure_native.dbformysql.v20180601privatepreview.Server("server",
            location="westus",
            properties=azure_native.dbformysql.v20180601privatepreview.ServerPropertiesForReplicaArgs(
                create_mode="Replica",
        ...
        server = azure_native.dbformysql.v20180601privatepreview.Server("server",
            location="westus",
            properties=azure_native.dbformysql.v20180601privatepreview.ServerPropertiesForGeoRestoreArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:Server")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Server, __self__).__init__(
            'azure-native:dbformysql/v20180601privatepreview:Server',
            resource_name,
            __props__,
            opts)
