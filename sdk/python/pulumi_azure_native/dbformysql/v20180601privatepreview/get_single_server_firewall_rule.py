...
def get_single_server_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20180601privatepreview:getSingleServerFirewallRule', __args__, opts=opts, typ=GetSingleServerFirewallRuleResult).value
...
def get_single_server_firewall_rule_output(firewall_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20180601privatepreview:getSingleServerFirewallRule', __args__, opts=opts, typ=GetSingleServerFirewallRuleResult)
