...
if not MYPY:
    class MaintenancePolicyArgsDict(TypedDict):
        ...
        """
        patch_strategy: NotRequired[pulumi.Input[Union[str, 'PatchStrategy']]]
        """
...
class MaintenancePolicyArgs:
    def __init__(__self__, *,
                 patch_strategy: Optional[pulumi.Input[Union[str, 'PatchStrategy']]] = None):
        """
        Maintenance policy of a server.
        :param pulumi.Input[Union[str, 'PatchStrategy']] patch_strategy: The patch strategy of this server
        """
    ...
    def patch_strategy(self) -> Optional[pulumi.Input[Union[str, 'PatchStrategy']]]:
        """
        The patch strategy of this server
        """
    ...
    def patch_strategy(self, value: Optional[pulumi.Input[Union[str, 'PatchStrategy']]]):
        pulumi.set(self, "patch_strategy", value)
