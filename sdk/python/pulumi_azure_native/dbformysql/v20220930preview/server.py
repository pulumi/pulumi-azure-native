...
class Server(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server = azure_native.dbformysql.v20220930preview.Server("server",
            administrator_login="cloudsa",
            administrator_login_password="your_password",
            availability_zone="1",
            backup=azure_native.dbformysql.v20220930preview.BackupArgs(
                backup_retention_days=7,
                geo_redundant_backup="Disabled",
            ),
            create_mode="Default",
            high_availability=azure_native.dbformysql.v20220930preview.HighAvailabilityArgs(
                mode="ZoneRedundant",
            ...
            sku=azure_native.dbformysql.v20220930preview.SkuResponseArgs(
                name="Standard_D2ds_v4",
                tier="GeneralPurpose",
            ),
            storage=azure_native.dbformysql.v20220930preview.StorageArgs(
                auto_grow="Disabled",
                iops=600,
                storage_size_gb=100,
            ),
        ...
        server = azure_native.dbformysql.v20220930preview.Server("server",
            ...
            create_mode="Default",
            data_encryption=azure_native.dbformysql.v20220930preview.DataEncryptionArgs(
                ...
                type=azure_native.dbformysql/v20220930preview.DataEncryptionType.AZURE_KEY_VAULT,
            ),
            high_availability=azure_native.dbformysql.v20220930preview.HighAvailabilityArgs(
                mode="ZoneRedundant",
                standby_availability_zone="3",
            ),
            identity=azure_native.dbformysql.v20220930preview.IdentityArgs(
                type="UserAssigned",
