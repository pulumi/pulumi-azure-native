...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20230630:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbformysql:PrivateEndpointConnection")])
