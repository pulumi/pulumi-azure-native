...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20220101:Database"), pulumi.Alias(type_="azure-native:dbformysql/v20230601preview:Database"), pulumi.Alias(type_="azure-native:dbformysql/v20230630:Database"), pulumi.Alias(type_="azure-native:dbformysql/v20231230:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20200701preview:dbformysql:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20200701privatepreview:dbformysql:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20210501:dbformysql:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20210501preview:dbformysql:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20211201preview:dbformysql:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20220101:dbformysql:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20230601preview:dbformysql:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20230630:dbformysql:Database"), pulumi.Alias(type_="azure-native_dbformysql_v20231230:dbformysql:Database")])
