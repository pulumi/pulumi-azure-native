...
class BackupResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str geo_redundant_backup: Whether or not geo redundant backup is enabled.
        """
...
class DataEncryptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str primary_user_assigned_identity_id: Primary user identity resource id
        :param _builtins.str type: The key type, AzureKeyVault for enable cmk, SystemManaged for disable cmk.
        """
...
class ImportSourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 data_dir_path: Optional[_builtins.str] = None,
...
class MaintenanceWindowResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int start_minute: start minute for maintenance window
        """
...
class NetworkResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_dns_zone_resource_id: Optional[_builtins.str] = None,
...
class StorageResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auto_io_scaling: Optional[_builtins.str] = None,
                 iops: Optional[_builtins.int] = None,
                 log_on_disk: Optional[_builtins.str] = None,
        ...
        :param _builtins.int iops: Storage IOPS for a server.
        :param _builtins.str log_on_disk: Enable Log On Disk or not.
        :param _builtins.str storage_redundancy: The redundant type of the server storage. The parameter is used for server creation.
        :param _builtins.int storage_size_gb: Max storage size allowed for a server.
        """
