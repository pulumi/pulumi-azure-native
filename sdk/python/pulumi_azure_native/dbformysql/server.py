...
class ServerArgs:
    def __init__(__self__, *,
                 ...
                 replication_role: Optional[pulumi.Input[Union[builtins.str, 'ReplicationRole']]] = None,
                 ...
                 source_server_resource_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] administrator_login_password: The password of the administrator login (required for server creation).
        :param pulumi.Input[builtins.str] availability_zone: availability Zone information of the server.
        :param pulumi.Input['BackupArgs'] backup: Backup related properties of a server.
        :param pulumi.Input[Union[builtins.str, 'CreateMode']] create_mode: The mode to create a new MySQL server.
        ...
        :param pulumi.Input[Union[builtins.str, 'ReplicationRole']] replication_role: The replication role.
        ...
        :param pulumi.Input[builtins.str] source_server_resource_id: The source MySQL server id.
    ...
    def replication_role(self) -> Optional[pulumi.Input[Union[builtins.str, 'ReplicationRole']]]:
        """
    ...
    def replication_role(self, value: Optional[pulumi.Input[Union[builtins.str, 'ReplicationRole']]]):
    ...
    def source_server_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_server_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Server(pulumi.CustomResource):
    ...
    def replica_capacity(self) -> pulumi.Output[builtins.int]:
        """
    ...
    @property
    @pulumi.getter(name="sourceServerResourceId")
    def source_server_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The source MySQL server id.
        """
        return pulumi.get(self, "source_server_resource_id")
