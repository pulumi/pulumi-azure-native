...
class ServerKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_key = azure_native.dbformysql.v20200701privatepreview.ServerKey("serverKey",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20200701preview:ServerKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerKey, __self__).__init__(
            'azure-native:dbformysql/v20200701privatepreview:ServerKey',
            resource_name,
            __props__,
            opts)
