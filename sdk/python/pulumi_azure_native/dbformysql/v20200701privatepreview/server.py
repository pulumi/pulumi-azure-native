...
class Server(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server = azure_native.dbformysql.v20200701privatepreview.Server("server",
            ...
            sku=azure_native.dbformysql.v20200701privatepreview.SkuResponseArgs(
                name="Standard_D14_v2",
                tier="GeneralPurpose",
            ),
            ssl_enforcement="Enabled",
            storage_profile=azure_native.dbformysql.v20200701privatepreview.StorageProfileArgs(
