...
class ServerArgs:
    ...
    def _configure(
        ...
        if 'delegatedSubnetArguments' in kwargs:
            delegated_subnet_arguments = kwargs['delegatedSubnetArguments']
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if delegated_subnet_arguments is not None and not isinstance(delegated_subnet_arguments, DelegatedSubnetArgumentsArgs):
                delegated_subnet_arguments = delegated_subnet_arguments or {}
                def _setter(key, value):
                    delegated_subnet_arguments[key] = value
                DelegatedSubnetArgumentsArgs._configure(_setter, **delegated_subnet_arguments)
