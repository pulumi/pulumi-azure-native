...
class ServerArgs:
    ...
    def _configure(
        ...
        if delegated_subnet_arguments is None and 'delegatedSubnetArguments' in kwargs:
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            delegated_subnet_arguments = _utilities.configure(delegated_subnet_arguments, DelegatedSubnetArgumentsArgs, True)
