...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/latest:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:FirewallRule")])
