...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if private_dns_zone_arguments is not None and not isinstance(private_dns_zone_arguments, PrivateDnsZoneArgumentsArgs):
                private_dns_zone_arguments = private_dns_zone_arguments or {}
                def _setter(key, value):
                    private_dns_zone_arguments[key] = value
                PrivateDnsZoneArgumentsArgs._configure(_setter, **private_dns_zone_arguments)
