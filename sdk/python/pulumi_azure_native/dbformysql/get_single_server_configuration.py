...
def get_single_server_configuration(configuration_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql:getSingleServerConfiguration', __args__, opts=opts, typ=GetSingleServerConfigurationResult).value
...
def get_single_server_configuration_output(configuration_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql:getSingleServerConfiguration', __args__, opts=opts, typ=GetSingleServerConfigurationResult)
