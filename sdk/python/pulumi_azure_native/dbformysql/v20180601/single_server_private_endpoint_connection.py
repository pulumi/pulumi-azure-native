...
class SingleServerPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:SingleServerPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbformysql:SingleServerPrivateEndpointConnection")])
