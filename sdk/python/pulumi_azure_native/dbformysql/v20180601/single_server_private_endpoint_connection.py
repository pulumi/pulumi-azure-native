...
class SingleServerPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:SingleServerPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbformysql:SingleServerPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerPrivateEndpointConnection, __self__).__init__(
            'azure-native:dbformysql/v20180601:SingleServerPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
