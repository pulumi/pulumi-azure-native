...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20220930preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbformysql/v20230630:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_dbformysql_v20220930preview:dbformysql:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_dbformysql_v20230630:dbformysql:PrivateEndpointConnection")])
