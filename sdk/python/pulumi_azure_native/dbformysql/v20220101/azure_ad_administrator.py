...
class AzureADAdministrator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        azure_ad_administrator = azure_native.dbformysql.v20220101.AzureADAdministrator("azureADAdministrator",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20211201preview:AzureADAdministrator")])
