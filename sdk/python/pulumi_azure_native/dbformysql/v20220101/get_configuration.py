...
def get_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20220101:getConfiguration', __args__, opts=opts, typ=GetConfigurationResult).value
...
def get_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20220101:getConfiguration', __args__, opts=opts, typ=GetConfigurationResult)
