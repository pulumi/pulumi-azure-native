...
warnings.warn("""azure-native:dbformysql/v20210501preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220930preview:Server to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetServerResult:
    ...
    Represents a server.
    """
    def __init__(__self__, administrator_login=None, availability_zone=None, backup=None, fully_qualified_domain_name=None, high_availability=None, id=None, identity=None, location=None, maintenance_window=None, name=None, network=None, replica_capacity=None, replication_role=None, sku=None, source_server_resource_id=None, state=None, storage=None, system_data=None, tags=None, type=None, version=None):
...
def get_server(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server is deprecated: azure-native:dbformysql/v20210501preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220930preview:Server to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20210501preview:getServer', __args__, opts=opts, typ=GetServerResult).value
