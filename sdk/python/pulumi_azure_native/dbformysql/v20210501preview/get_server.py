...
warnings.warn("""azure-native:dbformysql/v20210501preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220101:Server to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server is deprecated: azure-native:dbformysql/v20210501preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220101:Server to guarantee forwards compatibility.""")
    __args__ = dict()
