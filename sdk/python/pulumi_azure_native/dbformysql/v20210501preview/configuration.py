...
warnings.warn("""azure-native:dbformysql/v20210501preview:Configuration is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220101:Configuration to guarantee forwards compatibility.""", DeprecationWarning)
...
class Configuration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Configuration is deprecated: azure-native:dbformysql/v20210501preview:Configuration is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220101:Configuration to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20200701preview:Configuration"), pulumi.Alias(type_="azure-native:dbformysql/v20200701privatepreview:Configuration"), pulumi.Alias(type_="azure-native:dbformysql/v20210501:Configuration"), pulumi.Alias(type_="azure-native:dbformysql/v20211201preview:Configuration"), pulumi.Alias(type_="azure-native:dbformysql/v20220101:Configuration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Configuration, __self__).__init__(
            'azure-native:dbformysql/v20210501preview:Configuration',
            resource_name,
            __props__,
            opts)
