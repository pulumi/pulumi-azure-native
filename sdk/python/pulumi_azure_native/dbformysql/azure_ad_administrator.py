...
class AzureADAdministratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] administrator_name: The name of the Azure AD Administrator.
        :param pulumi.Input[Union[_builtins.str, 'AdministratorType']] administrator_type: Type of the sever administrator.
        :param pulumi.Input[_builtins.str] identity_resource_id: The resource id of the identity used for AAD Authentication.
...
class AzureADAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20211201preview:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20220101:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20230601preview:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20230630:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20231230:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20241201preview:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20241230:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20250601preview:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20251201preview:AzureADAdministrator")])
