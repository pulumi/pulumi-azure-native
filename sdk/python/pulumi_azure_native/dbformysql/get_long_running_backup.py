...
def get_long_running_backup(backup_name: Optional[_builtins.str] = None,
...
def get_long_running_backup_output(backup_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
