...
class AzureADAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20211201preview:AzureADAdministrator"), pulumi.Alias(type_="azure-native:dbformysql/v20220101:AzureADAdministrator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AzureADAdministrator, __self__).__init__(
            'azure-native:dbformysql/v20230601preview:AzureADAdministrator',
            resource_name,
            __props__,
            opts)
