...
class ServerArgs:
    ...
    def _configure(
        ...
        if 'importSourceProperties' in kwargs:
            import_source_properties = kwargs['importSourceProperties']
        ...
        if import_source_properties is not None:
            _setter("import_source_properties", import_source_properties)
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if identity is not None and not isinstance(identity, MySQLServerIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                MySQLServerIdentityArgs._configure(_setter, **identity)
            __props__.__dict__["identity"] = identity
            if import_source_properties is not None and not isinstance(import_source_properties, ImportSourcePropertiesArgs):
                import_source_properties = import_source_properties or {}
                def _setter(key, value):
                    import_source_properties[key] = value
                ImportSourcePropertiesArgs._configure(_setter, **import_source_properties)
            ...
            if sku is not None and not isinstance(sku, MySQLServerSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
                MySQLServerSkuArgs._configure(_setter, **sku)
