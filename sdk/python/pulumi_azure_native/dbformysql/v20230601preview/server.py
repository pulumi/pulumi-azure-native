...
class ServerArgs:
    ...
    def _configure(
        ...
        if import_source_properties is None and 'importSourceProperties' in kwargs:
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            identity = _utilities.configure(identity, MySQLServerIdentityArgs, True)
            __props__.__dict__["identity"] = identity
            import_source_properties = _utilities.configure(import_source_properties, ImportSourcePropertiesArgs, True)
            ...
            sku = _utilities.configure(sku, MySQLServerSkuArgs, True)
