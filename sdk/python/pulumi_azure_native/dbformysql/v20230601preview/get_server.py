...
def get_server(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/v20230601preview:getServer', __args__, opts=opts, typ=GetServerResult).value
...
def get_server_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbformysql/v20230601preview:getServer', __args__, opts=opts, typ=GetServerResult)
