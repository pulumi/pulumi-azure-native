...
class ImportSourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        ImportSourcePropertiesArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if data_dir_path is None and 'dataDirPath' in kwargs:
...
class MySQLServerIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        MySQLServerIdentityArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            type=type,
...
class MySQLServerSkuArgs:
    ...
    def _configure(
             ...
             tier: Optional[pulumi.Input[Union[str, 'ServerSkuTier']]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if name is None:
