...
def get_single_server_firewall_rule(firewall_rule_name: Optional[builtins.str] = None,
...
def get_single_server_firewall_rule_output(firewall_rule_name: Optional[pulumi.Input[builtins.str]] = None,
