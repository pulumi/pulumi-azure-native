...
class ServerKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbformysql:ServerKey"), pulumi.Alias(type_="azure-native:dbformysql/latest:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:ServerKey"), pulumi.Alias(type_="azure-native:dbformysql/v20200101:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20200101:ServerKey")])
