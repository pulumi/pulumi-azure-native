...
class SingleServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:Server"), pulumi.Alias(type_="azure-native_dbformysql_v20171201:dbformysql:SingleServer"), pulumi.Alias(type_="azure-native_dbformysql_v20171201preview:dbformysql:SingleServer"), pulumi.Alias(type_="azure-native_dbformysql_v20180601privatepreview:dbformysql:SingleServer")])
