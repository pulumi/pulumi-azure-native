...
class SingleServer(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:dbformysql:SingleServer"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbformysql/v20171201:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:SingleServer"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:SingleServer"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20180601privatepreview:SingleServer")])
    ...
    def byok_enforcement(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def infrastructure_encryption(self) -> pulumi.Output[Optional[builtins.str]]:
        """
