...
def get_component(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_component is deprecated: azure-native:insights/v20180501preview:Component is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20200202:Component to guarantee forwards compatibility.""")
    __args__ = dict()
