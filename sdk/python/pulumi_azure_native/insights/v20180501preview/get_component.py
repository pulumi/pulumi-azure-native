...
warnings.warn("""azure-native:insights/v20180501preview:Component is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20200202:Component to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_component(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_component is deprecated: azure-native:insights/v20180501preview:Component is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20200202:Component to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20180501preview:getComponent', __args__, opts=opts, typ=GetComponentResult).value
