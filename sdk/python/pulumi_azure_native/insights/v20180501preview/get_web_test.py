...
warnings.warn("""azure-native:insights/v20180501preview:WebTest is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20201005preview:WebTest to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_test(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_test is deprecated: azure-native:insights/v20180501preview:WebTest is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20201005preview:WebTest to guarantee forwards compatibility.""")
    __args__ = dict()
