...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20191017preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights:PrivateLinkScope"), pulumi.Alias(type_="azure-nextgen:insights:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights/v20210701preview:PrivateLinkScope"), pulumi.Alias(type_="azure-nextgen:insights/v20210701preview:PrivateLinkScope")])
