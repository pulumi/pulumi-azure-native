...
warnings.warn("""azure-native:insights/v20180617preview:Workbook is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20210308:Workbook to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetWorkbookResult:
    ...
    """
    def __init__(__self__, category=None, display_name=None, id=None, kind=None, location=None, name=None, serialized_data=None, source_id=None, tags=None, time_modified=None, type=None, user_id=None, version=None):
...
def get_workbook(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workbook is deprecated: azure-native:insights/v20180617preview:Workbook is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20210308:Workbook to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20180617preview:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult).value
