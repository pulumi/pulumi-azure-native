...
def get_workbook(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workbook is deprecated: azure-native:insights/v20180617preview:Workbook is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20210308:Workbook to guarantee forwards compatibility.""")
    __args__ = dict()
