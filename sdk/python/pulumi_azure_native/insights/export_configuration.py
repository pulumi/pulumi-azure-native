...
class ExportConfigurationArgs:
    ...
    def _configure(
        ...
        if 'destinationAccountId' in kwargs:
        ...
        if 'destinationStorageLocationId' in kwargs:
            destination_storage_location_id = kwargs['destinationStorageLocationId']
        if 'destinationStorageSubscriptionId' in kwargs:
