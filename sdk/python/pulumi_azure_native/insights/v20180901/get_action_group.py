...
def get_action_group(action_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_action_group is deprecated: azure-native:insights/v20180901:ActionGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20230101:ActionGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['actionGroupName'] = action_group_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20180901:getActionGroup', __args__, opts=opts, typ=GetActionGroupResult).value
