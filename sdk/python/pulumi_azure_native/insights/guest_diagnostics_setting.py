...
class GuestDiagnosticsSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20180601preview:GuestDiagnosticsSetting"), pulumi.Alias(type_="azure-native:insights/v20180601preview:guestDiagnosticsSetting"), pulumi.Alias(type_="azure-native:insights:guestDiagnosticsSetting")])
