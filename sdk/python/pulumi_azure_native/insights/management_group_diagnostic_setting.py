...
class ManagementGroupDiagnosticSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:ManagementGroupDiagnosticSetting"), pulumi.Alias(type_="azure-native:insights/v20200101preview:ManagementGroupDiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:insights/v20200101preview:ManagementGroupDiagnosticSetting"), pulumi.Alias(type_="azure-native:insights/v20210501preview:ManagementGroupDiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:insights/v20210501preview:ManagementGroupDiagnosticSetting")])
