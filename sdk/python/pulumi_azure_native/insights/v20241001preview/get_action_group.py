...
def get_action_group(action_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20241001preview:getActionGroup', __args__, opts=opts, typ=GetActionGroupResult).value
...
def get_action_group_output(action_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:insights/v20241001preview:getActionGroup', __args__, opts=opts, typ=GetActionGroupResult)
