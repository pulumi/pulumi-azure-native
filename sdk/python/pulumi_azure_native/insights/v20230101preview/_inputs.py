...
class AlertRuleAllOfConditionArgs:
    def __init__(__self__, *,
        ...
        """
        AlertRuleAllOfConditionArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            all_of=all_of,
        )
    @staticmethod
    def _configure(
             _setter: Callable[[Any, Any], None],
             all_of: Optional[pulumi.Input[Sequence[pulumi.Input['AlertRuleAnyOfOrLeafConditionArgs']]]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class AlertRuleAnyOfOrLeafConditionArgs:
    def __init__(__self__, *,
        ...
        """
        AlertRuleAnyOfOrLeafConditionArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            any_of=any_of,
...
class AlertRuleLeafConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] field: The name of the Activity Log event's field that this condition will examine.
               The possible values for this field are (case-insensitive): 'resourceId', 'category', 'caller', 'level', 'operationName', 'resourceGroup', 'resourceProvider', 'status', 'subStatus', 'resourceType', or anything beginning with 'properties'.
        """
        AlertRuleLeafConditionArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            contains_any=contains_any,
            equals=equals,
            field=field,
