...
class ExportConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:ExportConfiguration"), pulumi.Alias(type_="azure-nextgen:insights:ExportConfiguration"), pulumi.Alias(type_="azure-native:insights/latest:ExportConfiguration"), pulumi.Alias(type_="azure-nextgen:insights/latest:ExportConfiguration")])
