...
class WorkbookArgs:
    ...
    def _configure(
        ...
        if shared_type_kind is None and 'sharedTypeKind' in kwargs:
            shared_type_kind = kwargs['sharedTypeKind']
        if user_id is None and 'userId' in kwargs:
            user_id = kwargs['userId']
        if user_id is None:
            raise TypeError("Missing 'user_id' argument")
        if workbook_id is None and 'workbookId' in kwargs:
            workbook_id = kwargs['workbookId']
        if workbook_id is None:
            raise TypeError("Missing 'workbook_id' argument")
