...
class ComponentCurrentBillingFeature(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-nextgen:insights:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-native:insights/latest:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-nextgen:insights/latest:ComponentCurrentBillingFeature")])
