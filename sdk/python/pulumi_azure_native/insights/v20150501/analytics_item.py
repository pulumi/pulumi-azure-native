...
class AnalyticsItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20150501:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights:AnalyticsItem"), pulumi.Alias(type_="azure-nextgen:insights:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights/latest:AnalyticsItem"), pulumi.Alias(type_="azure-nextgen:insights/latest:AnalyticsItem")])
