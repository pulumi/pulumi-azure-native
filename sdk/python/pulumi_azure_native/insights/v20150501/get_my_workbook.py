...
def get_my_workbook(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20150501:getMyWorkbook', __args__, opts=opts, typ=GetMyWorkbookResult).value
...
def get_my_workbook_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:insights/v20150501:getMyWorkbook', __args__, opts=opts, typ=GetMyWorkbookResult)
