...
class FavoriteArgs:
    ...
    def _configure(
        ...
        if favorite_id is None and 'favoriteId' in kwargs:
            favorite_id = kwargs['favoriteId']
        if favorite_type is None and 'favoriteType' in kwargs:
            favorite_type = kwargs['favoriteType']
        if is_generated_from_template is None and 'isGeneratedFromTemplate' in kwargs:
