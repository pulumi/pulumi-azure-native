...
class Favorite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:Favorite"), pulumi.Alias(type_="azure-nextgen:insights:Favorite"), pulumi.Alias(type_="azure-native:insights/latest:Favorite"), pulumi.Alias(type_="azure-nextgen:insights/latest:Favorite")])
