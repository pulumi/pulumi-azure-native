...
class ProactiveDetectionConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 rule_definitions: Optional[pulumi.Input[Union['ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgs', 'ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgsDict']]] = None,
                 send_emails_to_subscription_owners: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgs', 'ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgsDict']] rule_definitions: Static definitions of the ProactiveDetection configuration rule (same values for all components).
        :param pulumi.Input[bool] send_emails_to_subscription_owners: A flag that indicated whether notifications on this rule should be sent to subscription owners
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:ProactiveDetectionConfiguration"), pulumi.Alias(type_="azure-native:insights/v20180501preview:ProactiveDetectionConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProactiveDetectionConfiguration, __self__).__init__(
            'azure-native:insights/v20150501:ProactiveDetectionConfiguration',
            resource_name,
            __props__,
            opts)
