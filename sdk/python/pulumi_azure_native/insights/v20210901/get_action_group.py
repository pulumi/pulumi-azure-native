...
warnings.warn("""azure-native:insights/v20210901:ActionGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20230101:ActionGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_action_group(action_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_action_group is deprecated: azure-native:insights/v20210901:ActionGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20230101:ActionGroup to guarantee forwards compatibility.""")
    __args__ = dict()
