...
class AutoscaleSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        autoscale_setting = azure_native.insights.v20150401.AutoscaleSetting("autoscaleSetting",
            autoscale_setting_name="MySetting",
            enabled=True,
            location="West US",
            notifications=[{
                "email": azure_native.insights.v20150401.EmailNotificationArgs(
                    custom_emails=[
                        "gu@ms.com",
                        "ge@ns.net",
                    ],
                ...
                "operation": azure_native.insights/v20150401.OperationType.SCALE,
                "webhooks": [azure_native.insights.v20150401.WebhookNotificationArgs(
                    properties={},
            ...
            profiles=[
                {
                    "capacity": azure_native.insights.v20150401.ScaleCapacityArgs(
                        default="1",
                        maximum="10",
                        minimum="1",
                    ),
                    "fixedDate": azure_native.insights.v20150401.TimeWindowArgs(
                    ...
                    "rules": [
                        {
                            "metricTrigger": azure_native.insights.v20150401.MetricTriggerArgs(
                                ...
                                operator=azure_native.insights/v20150401.ComparisonOperationType.GREATER_THAN,
                                statistic=azure_native.insights/v20150401.MetricStatisticType.AVERAGE,
                                threshold=10,
                                time_aggregation=azure_native.insights/v20150401.TimeAggregationType.AVERAGE,
                                time_grain="PT1M",
                                time_window="PT5M",
                            ),
                            "scaleAction": azure_native.insights.v20150401.ScaleActionArgs(
                                cooldown="PT5M",
                                direction=azure_native.insights/v20150401.ScaleDirection.INCREASE,
                                type=azure_native.insights/v20150401.ScaleType.CHANGE_COUNT,
                                value="1",
                            ),
                        },
                        {
                            ...
                            "scaleAction": azure_native.insights.v20150401.ScaleActionArgs(
                                cooldown="PT6M",
                                direction=azure_native.insights/v20150401.ScaleDirection.DECREASE,
                                type=azure_native.insights/v20150401.ScaleType.CHANGE_COUNT,
                                value="2",
                            ),
                        },
                ...
                },
                {
                    ...
                    "name": "saludos",
                    "recurrence": azure_native.insights.v20150401.RecurrenceArgs(
                        frequency=azure_native.insights/v20150401.RecurrenceFrequency.WEEK,
                        schedule=azure_native.insights.v20150401.RecurrentScheduleArgs(
                            days=["1"],
                            hours=[5],
                            minutes=[15],
                            time_zone="UTC",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:AutoscaleSetting"), pulumi.Alias(type_="azure-native:insights/v20140401:AutoscaleSetting"), pulumi.Alias(type_="azure-native:insights/v20210501preview:AutoscaleSetting"), pulumi.Alias(type_="azure-native:insights/v20221001:AutoscaleSetting")])
