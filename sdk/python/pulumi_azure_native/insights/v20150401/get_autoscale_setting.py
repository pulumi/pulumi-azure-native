...
warnings.warn("""azure-native:insights/v20150401:AutoscaleSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20221001:AutoscaleSetting to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_autoscale_setting(autoscale_setting_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_autoscale_setting is deprecated: azure-native:insights/v20150401:AutoscaleSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20221001:AutoscaleSetting to guarantee forwards compatibility.""")
    __args__ = dict()
