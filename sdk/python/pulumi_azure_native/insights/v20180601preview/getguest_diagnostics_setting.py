...
def getguest_diagnostics_setting(diagnostic_settings_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20180601preview:getguestDiagnosticsSetting', __args__, opts=opts, typ=GetguestDiagnosticsSettingResult).value
