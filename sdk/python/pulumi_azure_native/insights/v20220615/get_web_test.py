...
def get_web_test(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20220615:getWebTest', __args__, opts=opts, typ=GetWebTestResult).value
...
def get_web_test_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['webTestName'] = web_test_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:insights/v20220615:getWebTest', __args__, opts=opts, typ=GetWebTestResult)
