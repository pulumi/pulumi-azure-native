...
class WebTest(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_test = azure_native.insights.v20220615.WebTest("webTest",
            configuration=azure_native.insights.v20220615.WebTestPropertiesConfigurationArgs(
            ...
            locations=[azure_native.insights.v20220615.WebTestGeolocationArgs(
            ...
            timeout=120,
            web_test_kind=azure_native.insights/v20220615.WebTestKind.PING,
        ...
        web_test = azure_native.insights.v20220615.WebTest("webTest",
            ...
            request=azure_native.insights.v20220615.WebTestPropertiesResponseRequestArgs(
                headers=[
                    azure_native.insights.v20220615.HeaderFieldArgs(
            ...
            synthetic_monitor_id="my-webtest-my-component",
            timeout=120,
            validation_rules=azure_native.insights.v20220615.WebTestPropertiesValidationRulesArgs(
                s_sl_cert_remaining_lifetime_check=100,
                s_sl_check=True,
            ),
            web_test_kind=azure_native.insights/v20220615.WebTestKind.STANDARD,
            web_test_name="my-webtest-my-component")
        ...
        web_test = azure_native.insights.v20220615.WebTest("webTest",
            ...
            location="South Central US",
            locations=[
                azure_native.insights.v20220615.WebTestGeolocationArgs(
                    location="us-fl-mia-edge",
                ),
                azure_native.insights.v20220615.WebTestGeolocationArgs(
