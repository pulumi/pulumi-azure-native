...
class ScheduledQueryRuleArgs:
    def __init__(__self__, *,
                 properties: pulumi.Input['ScheduledQueryRulePropertiesArgs'],
        ...
        :param pulumi.Input['ScheduledQueryRulePropertiesArgs'] properties: The rule properties of the resource.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['ScheduledQueryRulePropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['ScheduledQueryRulePropertiesArgs']):
...
class ScheduledQueryRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kind: Optional[pulumi.Input[Union[str, 'Kind']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['ScheduledQueryRulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[Union[str, 'Kind']] kind: Indicates the type of scheduled query rule. The default is LogAlert.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[pulumi.InputType['ScheduledQueryRulePropertiesArgs']] properties: The rule properties of the resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] rule_name: The name of the rule.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20180416:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20200501preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20210201preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20210801:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20220801preview:ScheduledQueryRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScheduledQueryRule, __self__).__init__(
            'azure-native:insights/v20220615:ScheduledQueryRule',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ScheduledQueryRulePropertiesResponse']:
        """
        The rule properties of the resource.
        """
        return pulumi.get(self, "properties")
