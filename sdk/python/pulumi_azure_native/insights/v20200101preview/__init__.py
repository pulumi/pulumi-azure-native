...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:insights/v20200101preview:ManagementGroupDiagnosticSetting":
    ...
    pulumi.runtime.register_resource_module("azure-native", "insights/v20200101preview", _module_instance)
