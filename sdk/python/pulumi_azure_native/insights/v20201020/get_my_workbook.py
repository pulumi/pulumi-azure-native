...
warnings.warn("""azure-native:insights/v20201020:MyWorkbook is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20210308:MyWorkbook to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_my_workbook(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_my_workbook is deprecated: azure-native:insights/v20201020:MyWorkbook is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20210308:MyWorkbook to guarantee forwards compatibility.""")
    __args__ = dict()
