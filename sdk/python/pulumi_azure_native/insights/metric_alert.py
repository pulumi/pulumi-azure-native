...
class MetricAlert(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/latest:MetricAlert"), pulumi.Alias(type_="azure-nextgen:insights/latest:MetricAlert"), pulumi.Alias(type_="azure-native:insights/v20180301:MetricAlert"), pulumi.Alias(type_="azure-nextgen:insights/v20180301:MetricAlert")])
