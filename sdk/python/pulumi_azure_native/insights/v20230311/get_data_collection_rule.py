...
def get_data_collection_rule(data_collection_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20230311:getDataCollectionRule', __args__, opts=opts, typ=GetDataCollectionRuleResult).value
...
def get_data_collection_rule_output(data_collection_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:insights/v20230311:getDataCollectionRule', __args__, opts=opts, typ=GetDataCollectionRuleResult)
