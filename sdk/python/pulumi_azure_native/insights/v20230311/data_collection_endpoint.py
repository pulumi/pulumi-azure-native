...
class DataCollectionEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:DataCollectionEndpoint"), pulumi.Alias(type_="azure-native:insights/v20210401:DataCollectionEndpoint"), pulumi.Alias(type_="azure-native:insights/v20210901preview:DataCollectionEndpoint"), pulumi.Alias(type_="azure-native:insights/v20220601:DataCollectionEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataCollectionEndpoint, __self__).__init__(
            'azure-native:insights/v20230311:DataCollectionEndpoint',
            resource_name,
            __props__,
            opts)
