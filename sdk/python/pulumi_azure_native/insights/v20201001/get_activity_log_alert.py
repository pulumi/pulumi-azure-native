...
def get_activity_log_alert(activity_log_alert_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20201001:getActivityLogAlert', __args__, opts=opts, typ=GetActivityLogAlertResult).value
...
def get_activity_log_alert_output(activity_log_alert_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:insights/v20201001:getActivityLogAlert', __args__, opts=opts, typ=GetActivityLogAlertResult)
