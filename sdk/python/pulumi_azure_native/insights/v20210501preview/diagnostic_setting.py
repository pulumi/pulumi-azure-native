...
class DiagnosticSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20210501preview:DiagnosticSetting"), pulumi.Alias(type_="azure-native:insights:DiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:insights:DiagnosticSetting"), pulumi.Alias(type_="azure-native:insights/v20170501preview:DiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:insights/v20170501preview:DiagnosticSetting")])
