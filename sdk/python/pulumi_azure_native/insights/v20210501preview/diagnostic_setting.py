...
class DiagnosticSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        diagnostic_setting = azure_native.insights.v20210501preview.DiagnosticSetting("diagnosticSetting",
            ...
            logs=[{
                ...
                "enabled": True,
                "retentionPolicy": azure_native.insights.v20210501preview.RetentionPolicyArgs(
                    days=0,
                    enabled=False,
                ),
            }],
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20170501preview:DiagnosticSetting")])
