...
class SubscriptionDiagnosticSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        subscription_diagnostic_setting = azure_native.insights.v20210501preview.SubscriptionDiagnosticSetting("subscriptionDiagnosticSetting",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20170501preview:SubscriptionDiagnosticSetting")])
