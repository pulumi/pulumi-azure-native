...
class ManagementGroupDiagnosticSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        management_group_diagnostic_setting = azure_native.insights.v20210501preview.ManagementGroupDiagnosticSetting("managementGroupDiagnosticSetting",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20200101preview:ManagementGroupDiagnosticSetting")])
