...
class ManagementGroupDiagnosticSettingArgs:
    def __init__(__self__, *,
        ...
        """
        ManagementGroupDiagnosticSettingArgs._configure(
...
class ManagementGroupDiagnosticSetting(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ManagementGroupDiagnosticSettingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:ManagementGroupDiagnosticSetting"), pulumi.Alias(type_="azure-native:insights/v20200101preview:ManagementGroupDiagnosticSetting")])
