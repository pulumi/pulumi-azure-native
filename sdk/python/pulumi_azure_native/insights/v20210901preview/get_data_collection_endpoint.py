...
def get_data_collection_endpoint_output(data_collection_endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:insights/v20210901preview:getDataCollectionEndpoint', __args__, opts=opts, typ=GetDataCollectionEndpointResult)
