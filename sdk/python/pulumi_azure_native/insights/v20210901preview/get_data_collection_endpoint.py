...
warnings.warn("""azure-native:insights/v20210901preview:DataCollectionEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220601:DataCollectionEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_data_collection_endpoint(data_collection_endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_collection_endpoint is deprecated: azure-native:insights/v20210901preview:DataCollectionEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220601:DataCollectionEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
