...
class GetDataCollectionRuleResult:
    ...
    """
    def __init__(__self__, data_collection_endpoint_id=None, data_flows=None, data_sources=None, description=None, destinations=None, etag=None, id=None, immutable_id=None, kind=None, location=None, metadata=None, name=None, provisioning_state=None, stream_declarations=None, system_data=None, tags=None, type=None):
...
def get_data_collection_rule(data_collection_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_collection_rule is deprecated: azure-native:insights/v20210901preview:DataCollectionRule is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20220601:DataCollectionRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dataCollectionRuleName'] = data_collection_rule_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20210901preview:getDataCollectionRule', __args__, opts=opts, typ=GetDataCollectionRuleResult).value
