...
class DataCollectionEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_collection_endpoint = azure_native.insights.v20210901preview.DataCollectionEndpoint("dataCollectionEndpoint",
            data_collection_endpoint_name="myCollectionEndpoint",
            location="eastus",
            network_acls=azure_native.insights.v20210901preview.DataCollectionEndpointNetworkAclsArgs(
        ...
        ```sh
        $ pulumi import azure-native:insights/v20210901preview:DataCollectionEndpoint myCollectionEndpoint /subscriptions/703362b3-f278-4e4b-9179-c76eaf41ffc2/resourceGroups/myResourceGroup/providers/Microsoft.Insights/dataCollectionEndpoints/myCollectionEndpoint 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:DataCollectionEndpoint"), pulumi.Alias(type_="azure-native:insights/v20210401:DataCollectionEndpoint"), pulumi.Alias(type_="azure-native:insights/v20220601:DataCollectionEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataCollectionEndpoint, __self__).__init__(
            'azure-native:insights/v20210901preview:DataCollectionEndpoint',
            resource_name,
            __props__,
            opts)
