...
def get_alert_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_alert_rule is deprecated: Version v20140401 will be removed in the next major version of the provider. Upgrade to version v20150401 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20140401:getAlertRule', __args__, opts=opts, typ=GetAlertRuleResult).value
