...
class WorkbookTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workbook_template = azure_native.insights.v20201120.WorkbookTemplate("workbookTemplate",
            author="Contoso",
            galleries=[azure_native.insights.v20201120.WorkbookTemplateGalleryArgs(
                category="Failures",
