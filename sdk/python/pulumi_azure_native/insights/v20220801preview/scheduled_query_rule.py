...
class ScheduledQueryRuleArgs:
    ...
    def _configure(
        ...
        if 'checkWorkspaceAlertsStorageConfigured' in kwargs:
        ...
        if 'muteActionsDuration' in kwargs:
            mute_actions_duration = kwargs['muteActionsDuration']
        if 'overrideQueryTimeRange' in kwargs:
        ...
        if 'ruleResolveConfiguration' in kwargs:
...
class ScheduledQueryRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if actions is not None and not isinstance(actions, ActionsArgs):
                actions = actions or {}
                def _setter(key, value):
                    actions[key] = value
                ActionsArgs._configure(_setter, **actions)
            ...
            if criteria is not None and not isinstance(criteria, ScheduledQueryRuleCriteriaArgs):
                criteria = criteria or {}
                def _setter(key, value):
                    criteria[key] = value
                ScheduledQueryRuleCriteriaArgs._configure(_setter, **criteria)
            ...
            if rule_resolve_configuration is not None and not isinstance(rule_resolve_configuration, RuleResolveConfigurationArgs):
                rule_resolve_configuration = rule_resolve_configuration or {}
                def _setter(key, value):
                    rule_resolve_configuration[key] = value
                RuleResolveConfigurationArgs._configure(_setter, **rule_resolve_configuration)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20180416:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20200501preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20210201preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20210801:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20220615:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20230315preview:ScheduledQueryRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScheduledQueryRule, __self__).__init__(
            'azure-native:insights/v20220801preview:ScheduledQueryRule',
            resource_name,
            __props__,
            opts)
