...
class ScheduledQueryRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(actions, ActionsArgs):
                actions = actions or {}
                def _setter(key, value):
                    actions[key] = value
            ...
            if not isinstance(criteria, ScheduledQueryRuleCriteriaArgs):
            ...
            if not isinstance(rule_resolve_configuration, RuleResolveConfigurationArgs):
