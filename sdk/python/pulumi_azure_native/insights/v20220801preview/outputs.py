...
class ScheduledQueryRulePropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "ruleResolveConfiguration":
            suggest = "rule_resolve_configuration"
    ...
    def __init__(__self__, *,
                 ...
                 rule_resolve_configuration: Optional['outputs.RuleResolveConfigurationResponse'] = None,
        ...
        :param str public_network_access: This determines if traffic is allowed over public network. By default it is enabled.
        :param 'RuleResolveConfigurationResponse' rule_resolve_configuration: Defines the configuration for resolving fired alerts. Relevant only for rules of the kind LogAlert.
