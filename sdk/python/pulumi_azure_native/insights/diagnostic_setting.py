...
class DiagnosticSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:DiagnosticSetting"), pulumi.Alias(type_="azure-native:insights/v20170501preview:DiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:insights/v20170501preview:DiagnosticSetting")])
