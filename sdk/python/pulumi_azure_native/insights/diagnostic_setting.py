...
class DiagnosticSettingArgs:
    ...
    def _configure(
        ...
        if event_hub_authorization_rule_id is None and 'eventHubAuthorizationRuleId' in kwargs:
        ...
        if marketplace_partner_id is None and 'marketplacePartnerId' in kwargs:
