...
class AlertingActionArgs:
    ...
    def _configure(
             ...
             trigger: Optional[pulumi.Input['TriggerConditionArgs']] = None,
             azns_action: Optional[pulumi.Input['AzNsActionGroupArgs']] = None,
             throttling_in_min: Optional[pulumi.Input[int]] = None,
...
class LogToMetricActionArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             criteria: Optional[pulumi.Input[Sequence[pulumi.Input['CriteriaArgs']]]] = None,
             odata_type: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if criteria is None:
...
class ScheduleArgs:
    ...
    def _configure(
             ...
             time_window_in_minutes: Optional[pulumi.Input[int]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
