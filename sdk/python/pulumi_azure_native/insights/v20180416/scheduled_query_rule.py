...
class ScheduledQueryRuleArgs:
    ...
    def _configure(
             ...
             action: Optional[pulumi.Input[Union['AlertingActionArgs', 'LogToMetricActionArgs']]] = None,
...
class ScheduledQueryRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            schedule = _utilities.configure(schedule, ScheduleArgs, True)
            __props__.__dict__["schedule"] = schedule
            source = _utilities.configure(source, SourceArgs, True)
