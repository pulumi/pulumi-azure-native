...
class DataCollectionRuleArgs:
    ...
    def _configure(
        ...
        if data_collection_rule_name is None and 'dataCollectionRuleName' in kwargs:
...
class DataCollectionRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            identity = _utilities.configure(identity, DataCollectionRuleResourceIdentityArgs, True)
