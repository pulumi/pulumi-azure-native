...
class DataCollectionRuleArgs:
    ...
    def _configure(
        ...
        if data_collection_rule_name is not None:
            _setter("data_collection_rule_name", data_collection_rule_name)
...
class DataCollectionRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(data_sources, DataCollectionRuleDataSourcesArgs):
            ...
            if not isinstance(destinations, DataCollectionRuleDestinationsArgs):
                destinations = destinations or {}
                def _setter(key, value):
                    destinations[key] = value
                DataCollectionRuleDestinationsArgs._configure(_setter, **destinations)
            __props__.__dict__["destinations"] = destinations
            if not isinstance(identity, DataCollectionRuleResourceIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                DataCollectionRuleResourceIdentityArgs._configure(_setter, **identity)
