...
class WebTestArgs:
    ...
    def web_test_kind(self) -> pulumi.Input['WebTestKindEnum']:
        """
    ...
    def web_test_kind(self, value: pulumi.Input['WebTestKindEnum']):
...
class WebTest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if configuration is not None and not isinstance(configuration, WebTestPropertiesConfigurationArgs):
                configuration = configuration or {}
                def _setter(key, value):
                    configuration[key] = value
                WebTestPropertiesConfigurationArgs._configure(_setter, **configuration)
            ...
            if request is not None and not isinstance(request, WebTestPropertiesRequestArgs):
                request = request or {}
                def _setter(key, value):
                    request[key] = value
                WebTestPropertiesRequestArgs._configure(_setter, **request)
            ...
            if validation_rules is not None and not isinstance(validation_rules, WebTestPropertiesValidationRulesArgs):
                validation_rules = validation_rules or {}
                def _setter(key, value):
                    validation_rules[key] = value
                WebTestPropertiesValidationRulesArgs._configure(_setter, **validation_rules)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:WebTest"), pulumi.Alias(type_="azure-native:insights/v20150501:WebTest"), pulumi.Alias(type_="azure-native:insights/v20180501preview:WebTest"), pulumi.Alias(type_="azure-native:insights/v20220615:WebTest")])
