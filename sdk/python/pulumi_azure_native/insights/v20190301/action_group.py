...
class ActionGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:ActionGroup"), pulumi.Alias(type_="azure-native:insights/v20170401:ActionGroup"), pulumi.Alias(type_="azure-native:insights/v20180301:ActionGroup"), pulumi.Alias(type_="azure-native:insights/v20180901:ActionGroup"), pulumi.Alias(type_="azure-native:insights/v20190601:ActionGroup"), pulumi.Alias(type_="azure-native:insights/v20210901:ActionGroup"), pulumi.Alias(type_="azure-native:insights/v20220401:ActionGroup"), pulumi.Alias(type_="azure-native:insights/v20220601:ActionGroup"), pulumi.Alias(type_="azure-native:insights/v20230101:ActionGroup")])
