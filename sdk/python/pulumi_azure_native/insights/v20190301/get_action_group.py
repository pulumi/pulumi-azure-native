...
def get_action_group(action_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_action_group is deprecated: azure-native:insights/v20190301:ActionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20230101:ActionGroup to guarantee forwards compatibility.""")
    __args__ = dict()
