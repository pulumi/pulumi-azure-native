...
class PrivateLinkScopedResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20210701preview:PrivateLinkScopedResource"), pulumi.Alias(type_="azure-native:insights:PrivateLinkScopedResource"), pulumi.Alias(type_="azure-nextgen:insights:PrivateLinkScopedResource"), pulumi.Alias(type_="azure-native:insights/v20191017preview:PrivateLinkScopedResource"), pulumi.Alias(type_="azure-nextgen:insights/v20191017preview:PrivateLinkScopedResource")])
