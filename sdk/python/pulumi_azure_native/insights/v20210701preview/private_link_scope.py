...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20191017preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights/v20210901:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights/v20230601preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights:PrivateLinkScope")])
