...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_scope = azure_native.insights.v20210701preview.PrivateLinkScope("privateLinkScope",
            access_mode_settings=azure_native.insights.v20210701preview.AccessModeSettingsResponseArgs(
                exclusions=[],
        ...
        ```sh
        $ pulumi import azure-native:insights/v20210701preview:PrivateLinkScope my-privatelinkscope /subscriptions/86dc51d3-92ed-4d7e-947a-775ea79b4919/resourceGroups/my-resource-group/providers/microsoft.insights/privateLinkScopes/my-privatelinkscope 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20191017preview:PrivateLinkScope")])
