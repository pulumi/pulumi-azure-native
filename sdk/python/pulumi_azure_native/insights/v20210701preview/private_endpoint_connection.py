...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20210701preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:insights:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:insights:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:insights/v20191017preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:insights/v20191017preview:PrivateEndpointConnection")])
