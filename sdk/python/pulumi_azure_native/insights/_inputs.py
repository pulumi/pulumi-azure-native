...
class ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesRuleDefinitionsArgs:
    def __init__(__self__, *,
        ...
        """
        ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesRuleDefinitionsArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class AutoscaleNotificationArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             operation: Optional[pulumi.Input['OperationType']] = None,
             email: Optional[pulumi.Input['EmailNotificationArgs']] = None,
             webhooks: Optional[pulumi.Input[Sequence[pulumi.Input['WebhookNotificationArgs']]]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class AutoscaleProfileArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             capacity: Optional[pulumi.Input['ScaleCapacityArgs']] = None,
             name: Optional[pulumi.Input[str]] = None,
...
class DynamicMetricCriteriaArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             alert_sensitivity: Optional[pulumi.Input[Union[str, 'DynamicThresholdSensitivity']]] = None,
             criterion_type: Optional[pulumi.Input[str]] = None,
             failing_periods: Optional[pulumi.Input['DynamicThresholdFailingPeriodsArgs']] = None,
             metric_name: Optional[pulumi.Input[str]] = None,
             name: Optional[pulumi.Input[str]] = None,
             operator: Optional[pulumi.Input[Union[str, 'DynamicThresholdOperator']]] = None,
             time_aggregation: Optional[pulumi.Input[Union[str, 'AggregationTypeEnum']]] = None,
             dimensions: Optional[pulumi.Input[Sequence[pulumi.Input['MetricDimensionArgs']]]] = None,
             ignore_data_before: Optional[pulumi.Input[str]] = None,
             metric_namespace: Optional[pulumi.Input[str]] = None,
             skip_metric_validation: Optional[pulumi.Input[bool]] = None,
...
class MetricTriggerArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             metric_name: Optional[pulumi.Input[str]] = None,
             metric_resource_uri: Optional[pulumi.Input[str]] = None,
             operator: Optional[pulumi.Input['ComparisonOperationType']] = None,
             statistic: Optional[pulumi.Input['MetricStatisticType']] = None,
             threshold: Optional[pulumi.Input[float]] = None,
             time_aggregation: Optional[pulumi.Input['TimeAggregationType']] = None,
             time_grain: Optional[pulumi.Input[str]] = None,
...
class PredictiveAutoscalePolicyArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             scale_mode: Optional[pulumi.Input['PredictiveAutoscalePolicyScaleMode']] = None,
             scale_look_ahead_time: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class RecurrenceArgs:
    ...
    def _configure(
             ...
             schedule: Optional[pulumi.Input['RecurrentScheduleArgs']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class ScaleActionArgs:
    ...
    def _configure(
             ...
             direction: Optional[pulumi.Input['ScaleDirection']] = None,
             type: Optional[pulumi.Input['ScaleType']] = None,
             value: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if cooldown is None:
...
class ScaleRuleMetricDimensionArgs:
    ...
    def _configure(
             ...
             operator: Optional[pulumi.Input[Union[str, 'ScaleRuleMetricDimensionOperationType']]] = None,
             values: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class ScaleRuleArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             metric_trigger: Optional[pulumi.Input['MetricTriggerArgs']] = None,
             scale_action: Optional[pulumi.Input['ScaleActionArgs']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class WebtestLocationAvailabilityCriteriaArgs:
    ...
    def _configure(
             ...
             failed_location_count: Optional[pulumi.Input[float]] = None,
             odata_type: Optional[pulumi.Input[str]] = None,
