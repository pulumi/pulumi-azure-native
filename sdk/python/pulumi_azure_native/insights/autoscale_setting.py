...
class AutoscaleSettingArgs:
    ...
    def _configure(
             ...
             profiles: Optional[pulumi.Input[Sequence[pulumi.Input['AutoscaleProfileArgs']]]] = None,
        ...
        if autoscale_setting_name is None and 'autoscaleSettingName' in kwargs:
            autoscale_setting_name = kwargs['autoscaleSettingName']
        if predictive_autoscale_policy is None and 'predictiveAutoscalePolicy' in kwargs:
            predictive_autoscale_policy = kwargs['predictiveAutoscalePolicy']
        ...
        if target_resource_uri is None and 'targetResourceUri' in kwargs:
            target_resource_uri = kwargs['targetResourceUri']
...
class AutoscaleSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            predictive_autoscale_policy = _utilities.configure(predictive_autoscale_policy, PredictiveAutoscalePolicyArgs, True)
