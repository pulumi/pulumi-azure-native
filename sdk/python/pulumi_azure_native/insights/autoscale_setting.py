...
class AutoscaleSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:AutoscaleSetting"), pulumi.Alias(type_="azure-native:insights/latest:AutoscaleSetting"), pulumi.Alias(type_="azure-nextgen:insights/latest:AutoscaleSetting"), pulumi.Alias(type_="azure-native:insights/v20150401:AutoscaleSetting"), pulumi.Alias(type_="azure-nextgen:insights/v20150401:AutoscaleSetting")])
    ...
    def get(resource_name: str,
        ...
        __props__["tags"] = None
        __props__["target_resource_uri"] = None
        __props__["type"] = None
