...
class AutoscaleSettingArgs:
    ...
    def _configure(
        ...
        if 'autoscaleSettingName' in kwargs:
            autoscale_setting_name = kwargs['autoscaleSettingName']
        if 'predictiveAutoscalePolicy' in kwargs:
        ...
        if 'targetResourceUri' in kwargs:
...
class AutoscaleSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if predictive_autoscale_policy is not None and not isinstance(predictive_autoscale_policy, PredictiveAutoscalePolicyArgs):
