...
class TenantActionGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:TenantActionGroup"), pulumi.Alias(type_="azure-native:insights/v20230501preview:TenantActionGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TenantActionGroup, __self__).__init__(
            'azure-native:insights/v20230301preview:TenantActionGroup',
            resource_name,
            __props__,
            opts)
