...
def get_scheduled_query_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scheduled_query_rule is deprecated: azure-native:insights/v20210201preview:ScheduledQueryRule is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220801preview:ScheduledQueryRule to guarantee forwards compatibility.""")
    __args__ = dict()
