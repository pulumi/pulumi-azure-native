...
warnings.warn("""azure-native:insights/v20170501preview:DiagnosticSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20210501preview:DiagnosticSetting to guarantee forwards compatibility.""", DeprecationWarning)
...
class DiagnosticSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DiagnosticSetting is deprecated: azure-native:insights/v20170501preview:DiagnosticSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20210501preview:DiagnosticSetting to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:DiagnosticSetting"), pulumi.Alias(type_="azure-native:insights/v20210501preview:DiagnosticSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiagnosticSetting, __self__).__init__(
            'azure-native:insights/v20170501preview:DiagnosticSetting',
            resource_name,
            __props__,
            opts)
