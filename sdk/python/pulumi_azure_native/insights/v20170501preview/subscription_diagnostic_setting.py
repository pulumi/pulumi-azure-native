...
class SubscriptionDiagnosticSettingArgs:
    def __init__(__self__, *,
        ...
        """
        SubscriptionDiagnosticSettingArgs._configure(
...
class SubscriptionDiagnosticSetting(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SubscriptionDiagnosticSettingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:SubscriptionDiagnosticSetting"), pulumi.Alias(type_="azure-native:insights/v20210501preview:SubscriptionDiagnosticSetting")])
