...
class Workbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workbook = azure_native.insights.v20210308.Workbook("workbook",
            category="workbook",
        ...
        workbook = azure_native.insights.v20210308.Workbook("workbook",
            ...
            identity=azure_native.insights.v20210308.WorkbookManagedIdentityArgs(
                type="UserAssigned",
            ),
            kind="shared",
            location="westus",
        ...
        ```sh
        $ pulumi import azure-native:insights/v20210308:Workbook e378d137-1243-4256-b5c4-ad2a937cae79 /subscriptions/00000000-0000-0000-0000-00000000/resourcegroups/MyGroup/providers/Microsoft.Insights/workbooks/72377f0c-b7e7-4044-a882-471bcbd9696e 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:Workbook"), pulumi.Alias(type_="azure-native:insights/v20150501:Workbook"), pulumi.Alias(type_="azure-native:insights/v20180617preview:Workbook"), pulumi.Alias(type_="azure-native:insights/v20201020:Workbook"), pulumi.Alias(type_="azure-native:insights/v20210801:Workbook"), pulumi.Alias(type_="azure-native:insights/v20220401:Workbook")])
