...
class Workbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workbook = azure_native.insights.v20210801.Workbook("workbook",
            category="workbook",
        ...
        workbook = azure_native.insights.v20210801.Workbook("workbook",
            ...
            description="Sample workbook",
            display_name="Sample workbook",
            identity=azure_native.insights.v20210801.WorkbookResourceResponseIdentityArgs(
                type="UserAssigned",
        ...
        ```sh
        $ pulumi import azure-native:insights/v20210801:Workbook deadb33f-5e0d-4064-8ebb-1a4ed0313eb2 /subscriptions/6b643656-33eb-422f-aee8-3ac145d124af/resourcegroups/my-resource-group/providers/Microsoft.Insights/workbooks/deadb33f-5e0d-4064-8ebb-1a4ed0313eb2 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:Workbook"), pulumi.Alias(type_="azure-native:insights/v20150501:Workbook"), pulumi.Alias(type_="azure-native:insights/v20180617preview:Workbook"), pulumi.Alias(type_="azure-native:insights/v20201020:Workbook"), pulumi.Alias(type_="azure-native:insights/v20210308:Workbook"), pulumi.Alias(type_="azure-native:insights/v20220401:Workbook")])
