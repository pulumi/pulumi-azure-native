...
class ActionGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 webhook_receivers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WebhookReceiverArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ActionGroup is deprecated: azure-native:insights/v20170401:ActionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20230101:ActionGroup to guarantee forwards compatibility.""")
