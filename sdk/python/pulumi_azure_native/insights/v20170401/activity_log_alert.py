...
class ActivityLogAlertArgs:
    ...
    def _configure(
             ...
             actions: Optional[pulumi.Input['ActivityLogAlertActionListArgs']] = None,
             condition: Optional[pulumi.Input['ActivityLogAlertAllOfConditionArgs']] = None,
...
class ActivityLogAlert(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            actions = _utilities.configure(actions, ActivityLogAlertActionListArgs, True)
            if actions is None and not opts.urn:
                raise TypeError("Missing required property 'actions'")
            __props__.__dict__["actions"] = actions
            __props__.__dict__["activity_log_alert_name"] = activity_log_alert_name
            condition = _utilities.configure(condition, ActivityLogAlertAllOfConditionArgs, True)
