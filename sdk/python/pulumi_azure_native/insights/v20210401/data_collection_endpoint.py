...
class DataCollectionEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DataCollectionEndpoint is deprecated: azure-native:insights/v20210401:DataCollectionEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20220601:DataCollectionEndpoint to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:DataCollectionEndpoint"), pulumi.Alias(type_="azure-native:insights/v20210901preview:DataCollectionEndpoint"), pulumi.Alias(type_="azure-native:insights/v20220601:DataCollectionEndpoint")])
