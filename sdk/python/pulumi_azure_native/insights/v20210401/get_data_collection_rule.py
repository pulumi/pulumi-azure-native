...
def get_data_collection_rule(data_collection_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_collection_rule is deprecated: azure-native:insights/v20210401:DataCollectionRule is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220601:DataCollectionRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dataCollectionRuleName'] = data_collection_rule_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:insights/v20210401:getDataCollectionRule', __args__, opts=opts, typ=GetDataCollectionRuleResult).value
