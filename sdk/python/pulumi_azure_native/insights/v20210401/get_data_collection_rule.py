...
def get_data_collection_rule(data_collection_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_collection_rule is deprecated: azure-native:insights/v20210401:DataCollectionRule is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20220601:DataCollectionRule to guarantee forwards compatibility.""")
    __args__ = dict()
