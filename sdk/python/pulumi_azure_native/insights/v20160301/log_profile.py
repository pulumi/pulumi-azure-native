...
class LogProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        log_profile = azure_native.insights.v20160301.LogProfile("logProfile",
            categories=[
                "Write",
                "Delete",
                "Action",
            ...
            retention_policy=azure_native.insights.v20160301.RetentionPolicyArgs(
                days=3,
                enabled=True,
            ),
            service_bus_rule_id="",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:LogProfile")])
