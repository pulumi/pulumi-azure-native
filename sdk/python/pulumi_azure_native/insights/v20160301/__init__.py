...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:insights/v20160301:AlertRule":
                return AlertRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20160301:LogProfile":
    ...
    pulumi.runtime.register_resource_module("azure-native", "insights/v20160301", _module_instance)
