...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getWorkbook'.""", DeprecationWarning)
...
def get_workbook(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workbook is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getWorkbook'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult).value
