...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getComponent'.""", DeprecationWarning)
...
def get_component(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_component is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getComponent'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getComponent', __args__, opts=opts, typ=GetComponentResult).value
