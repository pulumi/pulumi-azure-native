...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:insights:AnalyticsItem'.""", DeprecationWarning)
...
class AnalyticsItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/latest:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights:AnalyticsItem"), pulumi.Alias(type_="azure-nextgen:insights:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights/v20150501:AnalyticsItem"), pulumi.Alias(type_="azure-nextgen:insights/v20150501:AnalyticsItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AnalyticsItem, __self__).__init__(
            'azure-native:insights/latest:AnalyticsItem',
            resource_name,
            __props__,
            opts)
