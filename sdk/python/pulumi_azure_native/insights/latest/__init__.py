...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "azure-native:insights/latest:Workbook":
    ...
    pulumi.runtime.register_resource_module("azure-native", "insights/latest", _module_instance)
