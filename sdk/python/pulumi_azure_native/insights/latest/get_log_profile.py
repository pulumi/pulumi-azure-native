...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getLogProfile'.""", DeprecationWarning)
...
def get_log_profile(log_profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getLogProfile', __args__, opts=opts, typ=GetLogProfileResult).value
