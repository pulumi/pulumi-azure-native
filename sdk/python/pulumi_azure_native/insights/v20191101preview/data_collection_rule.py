...
class DataCollectionRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_collection_rule = azure_native.insights.v20191101preview.DataCollectionRule("dataCollectionRule",
            data_collection_rule_name="myCollectionRule",
            data_flows=[azure_native.insights.v20191101preview.DataFlowArgs(
            ...
            data_sources=azure_native.insights.v20191101preview.DataCollectionRuleResponseDataSourcesArgs(
                performance_counters=[
                    azure_native.insights.v20191101preview.PerfCounterDataSourceArgs(
                        counter_specifiers=[
                ...
                syslog=[
                    azure_native.insights.v20191101preview.SyslogDataSourceArgs(
                        facility_names=["cron"],
                        log_levels=[
                            "Debug",
                            "Critical",
                ...
                windows_event_logs=[
                    azure_native.insights.v20191101preview.WindowsEventLogDataSourceArgs(
            ...
            destinations=azure_native.insights.v20191101preview.DataCollectionRuleResponseDestinationsArgs(
                log_analytics=[azure_native.insights.v20191101preview.LogAnalyticsDestinationArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:DataCollectionRule"), pulumi.Alias(type_="azure-native:insights/v20210401:DataCollectionRule"), pulumi.Alias(type_="azure-native:insights/v20210901preview:DataCollectionRule"), pulumi.Alias(type_="azure-native:insights/v20220601:DataCollectionRule")])
