...
if not MYPY:
    class ConditionArgsDict(TypedDict):
        ...
        """
        min_recurrence_count: NotRequired[pulumi.Input[float]]
        """
...
class ConditionArgs:
    def __init__(__self__, *,
                 ...
                 min_recurrence_count: Optional[pulumi.Input[float]] = None,
        ...
        """
        A condition of the scheduled query rule.
        :param pulumi.Input[str] alert_sensitivity: The extent of deviation required to trigger an alert. Allowed values are 'Low', 'Medium' and 'High'. This will affect how tight the threshold is to the metric series pattern. Relevant only for dynamic threshold rules of the kind LogAlert.
        ...
        :param pulumi.Input[float] min_recurrence_count: The minimum results count that should be found for triggering an alert. Relevant only for rules of the kind SimpleLogAlert.
    ...
    def min_recurrence_count(self) -> Optional[pulumi.Input[float]]:
        """
        The minimum results count that should be found for triggering an alert. Relevant only for rules of the kind SimpleLogAlert.
        """
    ...
    def min_recurrence_count(self, value: Optional[pulumi.Input[float]]):
