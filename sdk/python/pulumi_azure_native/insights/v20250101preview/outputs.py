...
class ConditionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 min_recurrence_count: Optional[float] = None,
        ...
        """
        A condition of the scheduled query rule.
        :param str alert_sensitivity: The extent of deviation required to trigger an alert. Allowed values are 'Low', 'Medium' and 'High'. This will affect how tight the threshold is to the metric series pattern. Relevant only for dynamic threshold rules of the kind LogAlert.
        ...
        :param float min_recurrence_count: The minimum results count that should be found for triggering an alert. Relevant only for rules of the kind SimpleLogAlert.
    ...
    def min_recurrence_count(self) -> Optional[float]:
        """
