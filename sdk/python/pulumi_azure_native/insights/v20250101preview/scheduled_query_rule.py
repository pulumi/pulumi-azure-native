...
class ScheduledQueryRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] auto_mitigate: The flag that indicates whether the alert should be automatically resolved or not. The default is true. Relevant only for rules of kinds LogAlert and SimpleLogAlert.
...
class ScheduledQueryRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ScheduledQueryRule, __self__).__init__(
            'azure-native:insights/v20250101preview:ScheduledQueryRule',
            resource_name,
            __props__,
            opts)
