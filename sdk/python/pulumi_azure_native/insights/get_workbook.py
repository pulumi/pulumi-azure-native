...
def get_workbook(can_fetch_content: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult).value
...
def get_workbook_output(can_fetch_content: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:insights:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult)
