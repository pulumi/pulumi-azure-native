...
class Workbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workbook = azure_native.insights.v20220401.Workbook("workbook",
            category="workbook",
        ...
        workbook = azure_native.insights.v20220401.Workbook("workbook",
            ...
            description="Sample workbook",
            display_name="Sample workbook",
            identity=azure_native.insights.v20220401.WorkbookResourceResponseIdentityArgs(
                type="UserAssigned",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights:Workbook"), pulumi.Alias(type_="azure-native:insights/v20150501:Workbook"), pulumi.Alias(type_="azure-native:insights/v20180617preview:Workbook"), pulumi.Alias(type_="azure-native:insights/v20201020:Workbook"), pulumi.Alias(type_="azure-native:insights/v20210308:Workbook"), pulumi.Alias(type_="azure-native:insights/v20210801:Workbook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workbook, __self__).__init__(
            'azure-native:insights/v20220401:Workbook',
            resource_name,
            __props__,
            opts)
