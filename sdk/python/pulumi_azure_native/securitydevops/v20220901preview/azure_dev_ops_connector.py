...
class AzureDevOpsConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securitydevops:AzureDevOpsConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AzureDevOpsConnector, __self__).__init__(
            'azure-native:securitydevops/v20220901preview:AzureDevOpsConnector',
            resource_name,
            __props__,
            opts)
