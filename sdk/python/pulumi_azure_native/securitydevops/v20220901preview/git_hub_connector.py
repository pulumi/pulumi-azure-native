...
class GitHubConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        git_hub_connector = azure_native.securitydevops.v20220901preview.GitHubConnector("gitHubConnector",
            git_hub_connector_name="testconnector",
            location="West US",
            properties=azure_native.securitydevops.v20220901preview.GitHubConnectorPropertiesArgs(
