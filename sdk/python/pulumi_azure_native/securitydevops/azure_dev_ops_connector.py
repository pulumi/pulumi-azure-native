...
class AzureDevOpsConnectorArgs:
    def __init__(__self__, *,
        ...
        """
        AzureDevOpsConnectorArgs._configure(
    ...
    def _configure(
        ...
        if 'azureDevOpsConnectorName' in kwargs:
            azure_dev_ops_connector_name = kwargs['azureDevOpsConnectorName']

        _setter("resource_group_name", resource_group_name)
        if azure_dev_ops_connector_name is not None:
            _setter("azure_dev_ops_connector_name", azure_dev_ops_connector_name)
...
class AzureDevOpsConnector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AzureDevOpsConnectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, AzureDevOpsConnectorPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                AzureDevOpsConnectorPropertiesArgs._configure(_setter, **properties)
