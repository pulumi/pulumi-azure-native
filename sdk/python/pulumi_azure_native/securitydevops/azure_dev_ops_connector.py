...
class AzureDevOpsConnectorArgs:
    ...
    def _configure(
        ...
        if azure_dev_ops_connector_name is None and 'azureDevOpsConnectorName' in kwargs:
...
class AzureDevOpsConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, AzureDevOpsConnectorPropertiesArgs, True)
