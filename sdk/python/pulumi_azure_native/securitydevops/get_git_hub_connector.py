...
__all__ = [
    ...
    'get_git_hub_connector',
    'get_git_hub_connector_output',
]
...
class GetGitHubConnectorResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.GitHubConnectorPropertiesResponse':
        """
...
def get_git_hub_connector(git_hub_connector_name: Optional[str] = None,
    ...
    """
    __args__ = dict()
    __args__['gitHubConnectorName'] = git_hub_connector_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securitydevops:getGitHubConnector', __args__, opts=opts, typ=GetGitHubConnectorResult).value
...
@_utilities.lift_output_func(get_git_hub_connector)
