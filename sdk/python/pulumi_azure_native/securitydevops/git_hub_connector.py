...
class GitHubConnectorArgs:
    def __init__(__self__, *,
        ...
        """
        GitHubConnectorArgs._configure(
    ...
    def _configure(
        ...
        if 'gitHubConnectorName' in kwargs:
            git_hub_connector_name = kwargs['gitHubConnectorName']

        _setter("resource_group_name", resource_group_name)
        if git_hub_connector_name is not None:
            _setter("git_hub_connector_name", git_hub_connector_name)
...
class GitHubConnector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            GitHubConnectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, GitHubConnectorPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                GitHubConnectorPropertiesArgs._configure(_setter, **properties)
