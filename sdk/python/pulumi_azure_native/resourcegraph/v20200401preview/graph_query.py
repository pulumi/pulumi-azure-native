...
class GraphQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resourcegraph/v20200401preview:GraphQuery"), pulumi.Alias(type_="azure-native:resourcegraph:GraphQuery"), pulumi.Alias(type_="azure-nextgen:resourcegraph:GraphQuery"), pulumi.Alias(type_="azure-native:resourcegraph/v20180901preview:GraphQuery"), pulumi.Alias(type_="azure-nextgen:resourcegraph/v20180901preview:GraphQuery")])
