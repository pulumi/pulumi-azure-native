...
class GraphQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resourcegraph/v20180901preview:GraphQuery"), pulumi.Alias(type_="azure-native:resourcegraph/v20190401:GraphQuery"), pulumi.Alias(type_="azure-native:resourcegraph/v20200401preview:GraphQuery"), pulumi.Alias(type_="azure-native:resourcegraph/v20210301:GraphQuery"), pulumi.Alias(type_="azure-native:resourcegraph/v20221001:GraphQuery"), pulumi.Alias(type_="azure-native:resourcegraph/v20240401:GraphQuery"), pulumi.Alias(type_="azure-native_resourcegraph_v20180901preview:resourcegraph:GraphQuery"), pulumi.Alias(type_="azure-native_resourcegraph_v20190401:resourcegraph:GraphQuery"), pulumi.Alias(type_="azure-native_resourcegraph_v20200401preview:resourcegraph:GraphQuery"), pulumi.Alias(type_="azure-native_resourcegraph_v20210301:resourcegraph:GraphQuery"), pulumi.Alias(type_="azure-native_resourcegraph_v20221001:resourcegraph:GraphQuery"), pulumi.Alias(type_="azure-native_resourcegraph_v20240401:resourcegraph:GraphQuery")])
