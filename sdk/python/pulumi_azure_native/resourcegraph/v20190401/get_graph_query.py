...
def get_graph_query(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resourcegraph/v20190401:getGraphQuery', __args__, opts=opts, typ=GetGraphQueryResult).value
...
def get_graph_query_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['subscriptionId'] = subscription_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:resourcegraph/v20190401:getGraphQuery', __args__, opts=opts, typ=GetGraphQueryResult)
