...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:communication/latest:CommunicationService":
    ...
    pulumi.runtime.register_resource_module("azure-native", "communication/latest", _module_instance)
