...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:communication:getCommunicationService'.""", DeprecationWarning)
...
def get_communication_service(communication_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_communication_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:communication:getCommunicationService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:communication/latest:getCommunicationService', __args__, opts=opts, typ=GetCommunicationServiceResult).value
