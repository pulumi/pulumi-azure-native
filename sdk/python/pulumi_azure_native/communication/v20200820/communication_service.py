...
class CommunicationService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:communication/v20200820:CommunicationService"), pulumi.Alias(type_="azure-native:communication:CommunicationService"), pulumi.Alias(type_="azure-nextgen:communication:CommunicationService"), pulumi.Alias(type_="azure-native:communication/latest:CommunicationService"), pulumi.Alias(type_="azure-nextgen:communication/latest:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20200820preview:CommunicationService"), pulumi.Alias(type_="azure-nextgen:communication/v20200820preview:CommunicationService")])
