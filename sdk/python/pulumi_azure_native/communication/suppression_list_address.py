...
class SuppressionListAddress(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:communication/v20230601preview:SuppressionListAddress"), pulumi.Alias(type_="azure-native_communication_v20230601preview:communication:SuppressionListAddress"), pulumi.Alias(type_="azure-native_communication_v20240901preview:communication:SuppressionListAddress")])
