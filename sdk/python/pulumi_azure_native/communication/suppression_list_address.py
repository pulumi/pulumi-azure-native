...
class SuppressionListAddress(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:communication/v20230601preview:SuppressionListAddress"), pulumi.Alias(type_="azure-native:communication/v20240901preview:SuppressionListAddress"), pulumi.Alias(type_="azure-native:communication/v20250501preview:SuppressionListAddress"), pulumi.Alias(type_="azure-native:communication/v20250901:SuppressionListAddress"), pulumi.Alias(type_="azure-native:communication/v20260318:SuppressionListAddress")])
