...
def get_suppression_list_address_output(address_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['suppressionListName'] = suppression_list_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:communication/v20230601preview:getSuppressionListAddress', __args__, opts=opts, typ=GetSuppressionListAddressResult)
