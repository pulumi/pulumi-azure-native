...
def get_email_service(email_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:communication/v20230601preview:getEmailService', __args__, opts=opts, typ=GetEmailServiceResult).value
...
def get_email_service_output(email_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:communication/v20230601preview:getEmailService', __args__, opts=opts, typ=GetEmailServiceResult)
