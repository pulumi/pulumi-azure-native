...
class EmailServiceArgs:
    ...
    def email_service_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def email_service_name(self, value: pulumi.Input[Optional[_builtins.str]]):
