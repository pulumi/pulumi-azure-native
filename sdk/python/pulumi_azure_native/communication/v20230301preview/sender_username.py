...
class SenderUsername(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:communication:SenderUsername"), pulumi.Alias(type_="azure-native:communication/v20230331:SenderUsername"), pulumi.Alias(type_="azure-native:communication/v20230401preview:SenderUsername")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SenderUsername, __self__).__init__(
            'azure-native:communication/v20230301preview:SenderUsername',
            resource_name,
            __props__,
            opts)
