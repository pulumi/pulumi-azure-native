...
class CommunicationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:communication:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20200820:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20200820preview:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20211001preview:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20220701preview:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20230331:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20230401:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20230401preview:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20230601preview:CommunicationService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CommunicationService, __self__).__init__(
            'azure-native:communication/v20230301preview:CommunicationService',
            resource_name,
            __props__,
            opts)
