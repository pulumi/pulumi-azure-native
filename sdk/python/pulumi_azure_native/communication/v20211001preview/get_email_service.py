...
def get_email_service(email_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_email_service is deprecated: azure-native:communication/v20211001preview:EmailService is being removed in the next major version of this provider. Upgrade to at least azure-native:communication/v20230401preview:EmailService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['emailServiceName'] = email_service_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:communication/v20211001preview:getEmailService', __args__, opts=opts, typ=GetEmailServiceResult).value
