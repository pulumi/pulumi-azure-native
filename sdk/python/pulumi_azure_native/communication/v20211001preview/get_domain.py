...
def get_domain(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain is deprecated: azure-native:communication/v20211001preview:Domain is being removed in the next major version of this provider. Upgrade to at least azure-native:communication/v20220701preview:Domain to guarantee forwards compatibility.""")
    __args__ = dict()
