...
def get_domain_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:communication/v20211001preview:getDomain', __args__, opts=opts, typ=GetDomainResult)
    return __ret__.apply(lambda __response__: GetDomainResult(
        ...
        valid_sender_usernames=pulumi.get(__response__, 'valid_sender_usernames'),
