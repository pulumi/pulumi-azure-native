...
class SenderUsernameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] username: A sender senderUsername to be used when sending emails.
        :param pulumi.Input[builtins.str] display_name: The display name for the senderUsername.
        :param pulumi.Input[builtins.str] sender_username: The valid sender Username.
        """
    ...
    def sender_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sender_username(self, value: Optional[pulumi.Input[builtins.str]]):
