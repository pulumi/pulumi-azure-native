...
class SuppressionList(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:communication/v20230601preview:SuppressionList"), pulumi.Alias(type_="azure-native:communication/v20240901preview:SuppressionList"), pulumi.Alias(type_="azure-native:communication/v20250501preview:SuppressionList"), pulumi.Alias(type_="azure-native:communication/v20250901:SuppressionList"), pulumi.Alias(type_="azure-native:communication/v20260318:SuppressionList")])
