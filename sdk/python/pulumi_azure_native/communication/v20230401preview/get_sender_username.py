...
def get_sender_username(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:communication/v20230401preview:getSenderUsername', __args__, opts=opts, typ=GetSenderUsernameResult).value
...
def get_sender_username_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['senderUsername'] = sender_username
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:communication/v20230401preview:getSenderUsername', __args__, opts=opts, typ=GetSenderUsernameResult)
