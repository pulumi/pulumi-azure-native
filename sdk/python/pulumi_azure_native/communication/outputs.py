...
class VerificationStatusRecordResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A class that represents a VerificationStatus record.
        :param builtins.str error_code: Error code. This property will only be present if the status is UnableToVerify.
        :param builtins.str status: Status of the verification operation.
        """
