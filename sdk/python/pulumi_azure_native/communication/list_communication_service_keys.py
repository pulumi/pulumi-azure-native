...
def list_communication_service_keys(communication_service_name: Optional[builtins.str] = None,
...
def list_communication_service_keys_output(communication_service_name: Optional[pulumi.Input[builtins.str]] = None,
