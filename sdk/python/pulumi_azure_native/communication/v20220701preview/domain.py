...
class DomainArgs:
    def __init__(__self__, *,
        ...
        DomainArgs._configure(
            ...
            valid_sender_usernames=valid_sender_usernames,
        )
    @staticmethod
    def _configure(
             ...
             **kwargs):
        if domain_management is None and 'domainManagement' in kwargs:
            domain_management = kwargs['domainManagement']
        if domain_management is None:
            raise TypeError("Missing 'domain_management' argument")
        ...
        if user_engagement_tracking is None and 'userEngagementTracking' in kwargs:
            user_engagement_tracking = kwargs['userEngagementTracking']
        if valid_sender_usernames is None and 'validSenderUsernames' in kwargs:
            valid_sender_usernames = kwargs['validSenderUsernames']
        ...
        if valid_sender_usernames is not None:
            _setter("valid_sender_usernames", valid_sender_usernames)
...
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:communication:Domain"), pulumi.Alias(type_="azure-native:communication/v20211001preview:Domain"), pulumi.Alias(type_="azure-native:communication/v20230301preview:Domain"), pulumi.Alias(type_="azure-native:communication/v20230331:Domain"), pulumi.Alias(type_="azure-native:communication/v20230401preview:Domain"), pulumi.Alias(type_="azure-native:communication/v20230601preview:Domain")])
