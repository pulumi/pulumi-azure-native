...
def get_suppression_list_address(address_id: Optional[_builtins.str] = None,
...
def get_suppression_list_address_output(address_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
