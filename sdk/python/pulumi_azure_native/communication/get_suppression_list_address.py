...
def get_suppression_list_address(address_id: Optional[builtins.str] = None,
    ...
    :param builtins.str address_id: The id of the address in a suppression list.
...
def get_suppression_list_address_output(address_id: Optional[pulumi.Input[builtins.str]] = None,
