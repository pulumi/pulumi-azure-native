...
def get_email_service(email_service_name: Optional[_builtins.str] = None,
...
def get_email_service_output(email_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
