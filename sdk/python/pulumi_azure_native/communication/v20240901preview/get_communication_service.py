...
def get_communication_service(communication_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:communication/v20240901preview:getCommunicationService', __args__, opts=opts, typ=GetCommunicationServiceResult).value
...
def get_communication_service_output(communication_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:communication/v20240901preview:getCommunicationService', __args__, opts=opts, typ=GetCommunicationServiceResult)
