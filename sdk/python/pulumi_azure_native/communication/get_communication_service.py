...
def get_communication_service(communication_service_name: Optional[_builtins.str] = None,
...
def get_communication_service_output(communication_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
