...
def get_communication_service(communication_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_communication_service is deprecated: azure-native:communication/v20230331:CommunicationService is being removed in the next major version of this provider. Upgrade to at least azure-native:communication/v20230401preview:CommunicationService to guarantee forwards compatibility.""")
    __args__ = dict()
