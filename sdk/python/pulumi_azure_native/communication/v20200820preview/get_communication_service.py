...
def get_communication_service_output(communication_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:communication/v20200820preview:getCommunicationService', __args__, opts=opts, typ=GetCommunicationServiceResult)
