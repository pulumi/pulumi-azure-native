...
def get_communication_service(communication_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:communication/v20230401:getCommunicationService', __args__, opts=opts, typ=GetCommunicationServiceResult).value
...
def get_communication_service_output(communication_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:communication/v20230401:getCommunicationService', __args__, opts=opts, typ=GetCommunicationServiceResult)
