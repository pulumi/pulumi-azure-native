...
class FirewallRuleArgs:
    def __init__(__self__, *,
                 ...
                 fleetspace_name: pulumi.Input[str],
        ...
        :param pulumi.Input[str] fleet_name: Name of the database fleet.
        :param pulumi.Input[str] fleetspace_name: Name of the fleetspace.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] firewall_rule_name: Name of the firewall rule.
    ...
    def fleetspace_name(self) -> pulumi.Input[str]:
        """
    ...
    def fleetspace_name(self, value: pulumi.Input[str]):
...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databasefleetmanager:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:databasefleetmanager/v20250201preview:FirewallRule',
            resource_name,
            __props__,
            opts)
