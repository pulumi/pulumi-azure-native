...
def get_fleet_database(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databasefleetmanager/v20250201preview:getFleetDatabase', __args__, opts=opts, typ=GetFleetDatabaseResult).value

    return AwaitableGetFleetDatabaseResult(
...
def get_fleet_database_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databasefleetmanager/v20250201preview:getFleetDatabase', __args__, opts=opts, typ=GetFleetDatabaseResult)
    return __ret__.apply(lambda __response__: GetFleetDatabaseResult(
