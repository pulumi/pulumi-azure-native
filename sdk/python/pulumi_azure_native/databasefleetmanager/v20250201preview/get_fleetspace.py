...
def get_fleetspace(fleet_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databasefleetmanager/v20250201preview:getFleetspace', __args__, opts=opts, typ=GetFleetspaceResult).value
...
def get_fleetspace_output(fleet_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databasefleetmanager/v20250201preview:getFleetspace', __args__, opts=opts, typ=GetFleetspaceResult)
