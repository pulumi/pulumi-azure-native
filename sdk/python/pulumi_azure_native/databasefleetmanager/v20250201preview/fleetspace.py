...
class Fleetspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databasefleetmanager:Fleetspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Fleetspace, __self__).__init__(
            'azure-native:databasefleetmanager/v20250201preview:Fleetspace',
            resource_name,
            __props__,
            opts)
