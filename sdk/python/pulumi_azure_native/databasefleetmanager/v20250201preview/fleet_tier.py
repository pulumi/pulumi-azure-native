...
class FleetTierArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tier_name: Name of the tier.
        """
...
class FleetTier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databasefleetmanager:FleetTier")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FleetTier, __self__).__init__(
            'azure-native:databasefleetmanager/v20250201preview:FleetTier',
            resource_name,
            __props__,
            opts)
