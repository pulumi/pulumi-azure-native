...
class FirewallRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 end_ip_address: Optional[_builtins.str] = None,
...
class FleetDatabasePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 restore_from_time: Optional[_builtins.str] = None,
        ...
        :param _builtins.str earliest_restore_time: Earliest restore time.
        :param _builtins.str latest_restore_time: Latest restore time.
        :param _builtins.str original_database_id: Resource identifier for the underlying database resource.
        :param _builtins.str provisioning_state: Database state.
        :param _builtins.bool recoverable: If true, database is recoverable.
        :param _builtins.str collation: Database collation.
        :param _builtins.str create_mode: Create mode. Available options: Default - Create a database. Copy - Copy the source database (source database name must be specified) PointInTimeRestore - Create a database by restoring source database from a point in time (source database name and restore from time must be specified)
        :param 'IdentityResponse' identity: Identity property.
        :param Mapping[str, _builtins.str] resource_tags: Additional database properties to be applied as the underlying database resource tags.
        :param _builtins.str restore_from_time: Restore from time when CreateMode is PointInTimeRestore.
        :param _builtins.str source_database_name: Source database name used when CreateMode is Copy or PointInTimeRestore.
        :param _builtins.str tier_name: Name of the tier this database belongs to.
...
class FleetTierPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 database_capacity_max: Optional[_builtins.float] = None,
                 database_capacity_min: Optional[_builtins.float] = None,
                 database_size_gb_max: Optional[_builtins.int] = None,
                 family: Optional[_builtins.str] = None,
                 high_availability_replica_count: Optional[_builtins.int] = None,
                 pool_num_of_databases_max: Optional[_builtins.int] = None,
                 pooled: Optional[_builtins.bool] = None,
        ...
        :param _builtins.float database_capacity_max: Maximum allocated capacity per database, in units matching the specified service tier.
        :param _builtins.float database_capacity_min: Minimum allocated capacity per database, in units matching the specified service tier.
        :param _builtins.int database_size_gb_max: Maximum database size in Gb.
        :param _builtins.str family: Family of provisioned resources, for example Gen5.
        :param _builtins.int high_availability_replica_count: Number of high availability replicas for databases in this tier.
        :param _builtins.int pool_num_of_databases_max: Maximum number of databases per pool.
        :param _builtins.bool pooled: If true, databases are pooled.
        :param _builtins.bool serverless: If true, serverless resources are provisioned in the tier.
        :param _builtins.str service_tier: Service tier of provisioned resources. Supported values: GeneralPurpose, Hyperscale.
        :param _builtins.str zone_redundancy: Enable zone redundancy for all databases in this tier.
        """
...
class FleetspacePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 provisioning_state: _builtins.str,
                 capacity_max: Optional[_builtins.int] = None,
...
class MainPrincipalResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str principal_type: Principal type of the main principal.
        :param _builtins.str tenant_id: Tenant Id of the main principal.
        """
...
class TransparentDataEncryptionResponse(dict):
    ...
    def __init__(__self__, *,
                 enable_auto_rotation: Optional[_builtins.bool] = None,
