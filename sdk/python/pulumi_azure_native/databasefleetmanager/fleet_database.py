...
class FleetDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FleetDatabasePropertiesArgs'] properties: Fleet database properties.
        """
...
class FleetDatabase(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:databasefleetmanager:FleetDatabase"
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] fleet_name: Name of the database fleet.
        :param pulumi.Input[builtins.str] fleetspace_name: Name of the fleetspace.
        :param pulumi.Input[Union['FleetDatabasePropertiesArgs', 'FleetDatabasePropertiesArgsDict']] properties: Fleet database properties.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FleetDatabaseArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FleetDatabaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FleetDatabaseArgs.__new__(FleetDatabaseArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databasefleetmanager/v20250201preview:FleetDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FleetDatabase, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FleetDatabase':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return FleetDatabase(resource_name, opts=opts, __props__=__props__)
