...
class GetFleetResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.FleetPropertiesResponse':
        """
...
def get_fleet(fleet_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databasefleetmanager:getFleet', __args__, opts=opts, typ=GetFleetResult).value
...
def get_fleet_output(fleet_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databasefleetmanager:getFleet', __args__, opts=opts, typ=GetFleetResult)
