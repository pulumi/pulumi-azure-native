...
class FleetspaceArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['FleetspacePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['FleetspacePropertiesArgs']]):
...
class Fleetspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 fleetspace_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['FleetspacePropertiesArgs', 'FleetspacePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] fleet_name: Name of the database fleet.
        :param pulumi.Input[_builtins.str] fleetspace_name: Name of the fleetspace.
        :param pulumi.Input[Union['FleetspacePropertiesArgs', 'FleetspacePropertiesArgsDict']] properties: A Fleetspace properties.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databasefleetmanager/v20250201preview:Fleetspace")])
