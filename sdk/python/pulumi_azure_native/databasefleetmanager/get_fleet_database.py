...
def get_fleet_database(database_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databasefleetmanager:getFleetDatabase', __args__, opts=opts, typ=GetFleetDatabaseResult).value
...
def get_fleet_database_output(database_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databasefleetmanager:getFleetDatabase', __args__, opts=opts, typ=GetFleetDatabaseResult)
