...
def get_fleetspace(fleet_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databasefleetmanager:getFleetspace', __args__, opts=opts, typ=GetFleetspaceResult).value
...
def get_fleetspace_output(fleet_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databasefleetmanager:getFleetspace', __args__, opts=opts, typ=GetFleetspaceResult)
