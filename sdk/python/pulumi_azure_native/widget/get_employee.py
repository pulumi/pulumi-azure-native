...
def get_employee(employee_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:widget:getEmployee', __args__, opts=opts, typ=GetEmployeeResult).value
...
def get_employee_output(employee_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:widget:getEmployee', __args__, opts=opts, typ=GetEmployeeResult)
