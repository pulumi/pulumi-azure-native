...
def get_group_quota(group_quota_name: Optional[builtins.str] = None,
    ...
    :param builtins.str group_quota_name: The GroupQuota name. The name should be unique for the provided context tenantId/MgId.
...
def get_group_quota_output(group_quota_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:quota:getGroupQuota', __args__, opts=opts, typ=GetGroupQuotaResult)
