...
def get_group_quota_subscription(group_quota_name: Optional[builtins.str] = None,
...
def get_group_quota_subscription_output(group_quota_name: Optional[pulumi.Input[builtins.str]] = None,
