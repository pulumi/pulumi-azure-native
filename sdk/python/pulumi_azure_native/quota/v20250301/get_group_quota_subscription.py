...
def get_group_quota_subscription(group_quota_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:quota/v20250301:getGroupQuotaSubscription', __args__, opts=opts, typ=GetGroupQuotaSubscriptionResult).value
...
def get_group_quota_subscription_output(group_quota_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:quota/v20250301:getGroupQuotaSubscription', __args__, opts=opts, typ=GetGroupQuotaSubscriptionResult)
