...
class GroupQuota(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:quota/v20230601preview:GroupQuota"), pulumi.Alias(type_="azure-native:quota/v20241015preview:GroupQuota"), pulumi.Alias(type_="azure-native:quota/v20241218preview:GroupQuota"), pulumi.Alias(type_="azure-native:quota/v20250315preview:GroupQuota"), pulumi.Alias(type_="azure-native:quota:GroupQuota")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GroupQuota, __self__).__init__(
            'azure-native:quota/v20250301:GroupQuota',
            resource_name,
            __props__,
            opts)
