...
def get_group_quota(group_quota_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:quota/v20250301:getGroupQuota', __args__, opts=opts, typ=GetGroupQuotaResult).value
...
def get_group_quota_output(group_quota_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:quota/v20250301:getGroupQuota', __args__, opts=opts, typ=GetGroupQuotaResult)
