...
def get_group_quota_subscription_output(group_quota_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['managementGroupId'] = management_group_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:quota/v20230601preview:getGroupQuotaSubscription', __args__, opts=opts, typ=GetGroupQuotaSubscriptionResult)
