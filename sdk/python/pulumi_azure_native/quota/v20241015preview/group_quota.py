...
class GroupQuota(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:quota:GroupQuota"), pulumi.Alias(type_="azure-native:quota/v20230601preview:GroupQuota"), pulumi.Alias(type_="azure-native:quota/v20241218preview:GroupQuota"), pulumi.Alias(type_="azure-native:quota/v20250301:GroupQuota")])
