...
def get_group_quota(group_quota_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:quota/v20241015preview:getGroupQuota', __args__, opts=opts, typ=GetGroupQuotaResult).value
...
def get_group_quota_output(group_quota_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['managementGroupId'] = management_group_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:quota/v20241015preview:getGroupQuota', __args__, opts=opts, typ=GetGroupQuotaResult)
