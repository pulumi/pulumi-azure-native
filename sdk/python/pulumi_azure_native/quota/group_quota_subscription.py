...
class GroupQuotaSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:quota/v20230601preview:GroupQuotaSubscription"), pulumi.Alias(type_="azure-native:quota/v20241015preview:GroupQuotaSubscription"), pulumi.Alias(type_="azure-native:quota/v20241218preview:GroupQuotaSubscription"), pulumi.Alias(type_="azure-native:quota/v20250301:GroupQuotaSubscription"), pulumi.Alias(type_="azure-native:quota/v20250315preview:GroupQuotaSubscription"), pulumi.Alias(type_="azure-native:quota/v20250715:GroupQuotaSubscription"), pulumi.Alias(type_="azure-native:quota/v20250901:GroupQuotaSubscription"), pulumi.Alias(type_="azure-native:quota/v20260901preview:GroupQuotaSubscription")])
