...
def get_image(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_image is deprecated: Version 2017-12-01 will be removed in v2 of the provider.
azure-native:compute/v20171201:Image is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:Image to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20171201:getImage', __args__, opts=opts, typ=GetImageResult).value
