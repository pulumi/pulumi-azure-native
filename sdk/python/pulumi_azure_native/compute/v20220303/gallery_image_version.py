...
class GalleryImageVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(publishing_profile, GalleryImageVersionPublishingProfileArgs):
            ...
            if not isinstance(safety_profile, GalleryImageVersionSafetyProfileArgs):
            ...
            if not isinstance(storage_profile, GalleryImageVersionStorageProfileArgs):
