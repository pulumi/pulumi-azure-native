...
class GalleryApplicationVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if publishing_profile is not None and not isinstance(publishing_profile, GalleryApplicationVersionPublishingProfileArgs):
                publishing_profile = publishing_profile or {}
                def _setter(key, value):
                    publishing_profile[key] = value
                GalleryApplicationVersionPublishingProfileArgs._configure(_setter, **publishing_profile)
            ...
            if safety_profile is not None and not isinstance(safety_profile, GalleryApplicationVersionSafetyProfileArgs):
                safety_profile = safety_profile or {}
                def _setter(key, value):
                    safety_profile[key] = value
                GalleryApplicationVersionSafetyProfileArgs._configure(_setter, **safety_profile)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:compute:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20190301:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20190701:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20191201:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20200930:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20210701:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20211001:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20220103:GalleryApplicationVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GalleryApplicationVersion, __self__).__init__(
            'azure-native:compute/v20220303:GalleryApplicationVersion',
            resource_name,
            __props__,
            opts)
