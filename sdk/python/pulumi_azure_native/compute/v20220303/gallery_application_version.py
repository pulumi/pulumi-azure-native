...
class GalleryApplicationVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(publishing_profile, GalleryApplicationVersionPublishingProfileArgs):
            ...
            if not isinstance(safety_profile, GalleryApplicationVersionSafetyProfileArgs):
