...
def get_availability_set(availability_set_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_availability_set is deprecated: Version 2019-03-01 will be removed in v2 of the provider.
azure-native:compute/v20190301:AvailabilitySet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:AvailabilitySet to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20190301:getAvailabilitySet', __args__, opts=opts, typ=GetAvailabilitySetResult).value
