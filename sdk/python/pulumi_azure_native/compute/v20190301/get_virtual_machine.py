...
def get_virtual_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine is deprecated: Version v20190301 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20190301:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult).value
