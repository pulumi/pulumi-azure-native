...
class VirtualMachineExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachineExtension is deprecated: Version v20181001 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
        if opts is None:
