...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachine is deprecated: Version v20181001 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
        if opts is None:
