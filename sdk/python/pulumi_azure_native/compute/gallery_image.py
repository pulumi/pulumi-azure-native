...
class GalleryImageArgs:
    def __init__(__self__, *,
                 ...
                 allow_update_image: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def allow_update_image(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_update_image(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def gallery_image_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GalleryImage(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowUpdateImage")
    def allow_update_image(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Optional. Must be set to true if the gallery image features are being updated.
        """
        return pulumi.get(self, "allow_update_image")
    ...
    @property
    @pulumi.getter(name="osState")
    def os_state(self) -> pulumi.Output[builtins.str]:
        """
        This property allows the user to specify whether the virtual machines created under this image are 'Generalized' or 'Specialized'.
        """
        return pulumi.get(self, "os_state")
