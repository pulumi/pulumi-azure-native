...
class GalleryImage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(disallowed, DisallowedArgs):
            ...
            if not isinstance(identifier, GalleryImageIdentifierArgs):
            ...
            if not isinstance(purchase_plan, ImagePurchasePlanArgs):
            ...
            if not isinstance(recommended, RecommendedMachineConfigurationArgs):
