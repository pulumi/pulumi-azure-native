...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getGalleryImageVersion'.""", DeprecationWarning)
...
def get_gallery_image_version(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getGalleryImageVersion', __args__, opts=opts, typ=GetGalleryImageVersionResult).value
