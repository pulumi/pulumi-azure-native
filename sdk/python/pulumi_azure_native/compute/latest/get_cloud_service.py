...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getCloudService'.""", DeprecationWarning)
...
def get_cloud_service(cloud_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cloud_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getCloudService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getCloudService', __args__, opts=opts, typ=GetCloudServiceResult).value
