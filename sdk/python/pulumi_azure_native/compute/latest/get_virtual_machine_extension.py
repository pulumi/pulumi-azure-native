...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getVirtualMachineExtension'.""", DeprecationWarning)
...
def get_virtual_machine_extension(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getVirtualMachineExtension', __args__, opts=opts, typ=GetVirtualMachineExtensionResult).value
