...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getLogAnalyticExportThrottledRequests'.""", DeprecationWarning)
...
def get_log_analytic_export_throttled_requests(blob_container_sas_uri: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_log_analytic_export_throttled_requests is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getLogAnalyticExportThrottledRequests'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getLogAnalyticExportThrottledRequests', __args__, opts=opts, typ=GetLogAnalyticExportThrottledRequestsResult).value
