...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getImage'.""", DeprecationWarning)
...
def get_image(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_image is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getImage'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getImage', __args__, opts=opts, typ=GetImageResult).value
