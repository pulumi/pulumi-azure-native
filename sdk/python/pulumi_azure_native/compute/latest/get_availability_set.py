...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getAvailabilitySet'.""", DeprecationWarning)
...
def get_availability_set(availability_set_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getAvailabilitySet', __args__, opts=opts, typ=GetAvailabilitySetResult).value
