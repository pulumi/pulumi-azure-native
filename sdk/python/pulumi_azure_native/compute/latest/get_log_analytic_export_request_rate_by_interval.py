...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getLogAnalyticExportRequestRateByInterval'.""", DeprecationWarning)
...
def get_log_analytic_export_request_rate_by_interval(blob_container_sas_uri: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_log_analytic_export_request_rate_by_interval is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getLogAnalyticExportRequestRateByInterval'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getLogAnalyticExportRequestRateByInterval', __args__, opts=opts, typ=GetLogAnalyticExportRequestRateByIntervalResult).value
