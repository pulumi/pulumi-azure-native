...
class CapacityReservationGroupArgs:
    ...
    def _configure(
        ...
        if capacity_reservation_group_name is None and 'capacityReservationGroupName' in kwargs:
            capacity_reservation_group_name = kwargs['capacityReservationGroupName']
