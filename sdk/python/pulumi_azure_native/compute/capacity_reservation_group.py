...
class CapacityReservationGroupArgs:
    ...
    def sharing_profile(self) -> pulumi.Input[Optional['ResourceSharingProfileArgs']]:
        """
    ...
    def sharing_profile(self, value: pulumi.Input[Optional['ResourceSharingProfileArgs']]):
...
class CapacityReservationGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sharing_profile: pulumi.Input[Optional[Union['ResourceSharingProfileArgs', 'ResourceSharingProfileArgsDict']]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 zones: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
