...
class CapacityReservationGroupArgs:
    ...
    def capacity_reservation_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def capacity_reservation_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
