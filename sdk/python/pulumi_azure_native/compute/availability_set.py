...
class AvailabilitySetArgs:
    def __init__(__self__, *,
                 ...
                 platform_update_domain_count: Optional[pulumi.Input[builtins.int]] = None,
    ...
    def platform_update_domain_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Update Domain count.
        """
    ...
    def platform_update_domain_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AvailabilitySet(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="platformUpdateDomainCount")
    def platform_update_domain_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Update Domain count.
        """
        return pulumi.get(self, "platform_update_domain_count")
