...
def get_virtual_machine_extension(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_extension is deprecated: Version 2015-06-15 will be removed in v2 of the provider.
azure-native:compute/v20150615:VirtualMachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20211101:VirtualMachineExtension to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20150615:getVirtualMachineExtension', __args__, opts=opts, typ=GetVirtualMachineExtensionResult).value
