...
warnings.warn("""Version v20150615 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""", DeprecationWarning)
...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_machine_profile: Optional[pulumi.Input[pulumi.InputType['VirtualMachineScaleSetVMProfileArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachineScaleSet is deprecated: Version v20150615 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
        if opts is None:
