...
class DiskEncryptionSetArgs:
    def __init__(__self__, *,
                 ...
                 disk_encryption_set_name: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_type: Optional[pulumi.Input[Union[builtins.str, 'DiskEncryptionSetType']]] = None,
    ...
    def disk_encryption_set_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disk_encryption_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "disk_encryption_set_name", value)

    @property
    @pulumi.getter(name="encryptionType")
    def encryption_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'DiskEncryptionSetType']]]:
        """
    ...
    def encryption_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'DiskEncryptionSetType']]]):
...
class DiskEncryptionSet(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:compute:DiskEncryptionSet"
    ...
    def last_key_rotation_timestamp(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="rotationToLatestKeyVersionEnabled")
    def rotation_to_latest_key_version_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set this flag to true to enable auto-updating of this disk encryption set to the latest key version.
        """
        return pulumi.get(self, "rotation_to_latest_key_version_enabled")
