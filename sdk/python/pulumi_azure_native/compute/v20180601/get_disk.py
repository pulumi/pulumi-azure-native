...
class GetDiskResult:
    ...
    Disk resource.
    """
    def __init__(__self__, creation_data=None, disk_iops_read_write=None, disk_m_bps_read_write=None, disk_size_gb=None, encryption_settings=None, id=None, location=None, managed_by=None, name=None, os_type=None, provisioning_state=None, sku=None, tags=None, time_created=None, type=None, zones=None):
...
def get_disk(disk_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk is deprecated: Version v20180601 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20180601:getDisk', __args__, opts=opts, typ=GetDiskResult).value
