...
azure-native:compute/v20180601:GalleryImageVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20190301:GalleryImageVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_gallery_image_version(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery_image_version is deprecated: Version 2018-06-01 will be removed in v2 of the provider.
azure-native:compute/v20180601:GalleryImageVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20190301:GalleryImageVersion to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20180601:getGalleryImageVersion', __args__, opts=opts, typ=GetGalleryImageVersionResult).value
