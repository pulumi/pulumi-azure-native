...
def get_cloud_service(cloud_service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_service_name: Name of the cloud service.
    :param _builtins.str resource_group_name: Name of the resource group.
    """
    __args__ = dict()
...
def get_cloud_service_output(cloud_service_name: Optional[pulumi.Input[_builtins.str]] = None,
