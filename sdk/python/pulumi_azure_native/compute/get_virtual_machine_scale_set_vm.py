...
def get_virtual_machine_scale_set_vm(expand: Optional[_builtins.str] = None,
    ...
    :param _builtins.str expand: The expand expression to apply on the operation. 'InstanceView' will retrieve the instance view of the virtual machine. 'UserData' will retrieve the UserData of the virtual machine.
    :param _builtins.str instance_id: The instance ID of the virtual machine.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str vm_scale_set_name: The name of the VM scale set.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute:getVirtualMachineScaleSetVM', __args__, opts=opts, typ=GetVirtualMachineScaleSetVMResult).value
...
def get_virtual_machine_scale_set_vm_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute:getVirtualMachineScaleSetVM', __args__, opts=opts, typ=GetVirtualMachineScaleSetVMResult)
