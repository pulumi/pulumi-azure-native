...
def get_cloud_service(cloud_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20201001preview:getCloudService', __args__, opts=opts, typ=GetCloudServiceResult).value
...
def get_cloud_service_output(cloud_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20201001preview:getCloudService', __args__, opts=opts, typ=GetCloudServiceResult)
