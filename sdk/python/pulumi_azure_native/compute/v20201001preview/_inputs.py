...
if not MYPY:
    class LoadBalancerConfigurationPropertiesArgsDict(TypedDict):
        frontend_ip_configurations: NotRequired[pulumi.Input[Sequence[pulumi.Input['LoadBalancerFrontendIPConfigurationArgsDict']]]]
        """
        List of IP
        """
elif False:
...
if not MYPY:
    class LoadBalancerConfigurationArgsDict(TypedDict):
        ...
        Resource Name
        """
        properties: NotRequired[pulumi.Input['LoadBalancerConfigurationPropertiesArgsDict']]
elif False:
...
if not MYPY:
    class LoadBalancerFrontendIPConfigurationArgsDict(TypedDict):
        name: NotRequired[pulumi.Input[str]]
        properties: NotRequired[pulumi.Input['LoadBalancerFrontendIPConfigurationPropertiesArgsDict']]
        """
        Describes a cloud service IP Configuration
        """
elif False:
