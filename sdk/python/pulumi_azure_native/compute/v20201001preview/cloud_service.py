...
class CloudService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20201001preview:CloudService"), pulumi.Alias(type_="azure-native:compute:CloudService"), pulumi.Alias(type_="azure-nextgen:compute:CloudService")])
