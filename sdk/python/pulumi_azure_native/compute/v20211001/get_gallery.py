...
def get_gallery(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery is deprecated: azure-native:compute/v20211001:Gallery is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220303:Gallery to guarantee forwards compatibility.""")
    __args__ = dict()
