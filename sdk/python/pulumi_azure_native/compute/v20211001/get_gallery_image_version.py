...
def get_gallery_image_version(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery_image_version is deprecated: azure-native:compute/v20211001:GalleryImageVersion is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220303:GalleryImageVersion to guarantee forwards compatibility.""")
    __args__ = dict()
