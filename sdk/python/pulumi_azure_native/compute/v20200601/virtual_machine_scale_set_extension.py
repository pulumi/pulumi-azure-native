...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vmss_extension_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachineScaleSetExtension is deprecated: Version v20200601 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
        if opts is None:
