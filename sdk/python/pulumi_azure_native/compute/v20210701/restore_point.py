...
warnings.warn("""azure-native:compute/v20210701:RestorePoint is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:RestorePoint to guarantee forwards compatibility.""", DeprecationWarning)
...
class RestorePoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 time_created: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RestorePoint is deprecated: azure-native:compute/v20210701:RestorePoint is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:RestorePoint to guarantee forwards compatibility.""")
