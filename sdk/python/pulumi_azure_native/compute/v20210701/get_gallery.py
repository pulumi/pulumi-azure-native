...
warnings.warn("""azure-native:compute/v20210701:Gallery is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:Gallery to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetGalleryResult:
    ...
    """
    def __init__(__self__, description=None, id=None, identifier=None, location=None, name=None, provisioning_state=None, sharing_profile=None, soft_delete_policy=None, tags=None, type=None):
...
def get_gallery(gallery_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery is deprecated: azure-native:compute/v20210701:Gallery is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:Gallery to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['galleryName'] = gallery_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['select'] = select
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20210701:getGallery', __args__, opts=opts, typ=GetGalleryResult).value
