...
def get_proximity_placement_group(include_colocation_status: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_proximity_placement_group is deprecated: azure-native:compute/v20210701:ProximityPlacementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:ProximityPlacementGroup to guarantee forwards compatibility.""")
    __args__ = dict()
