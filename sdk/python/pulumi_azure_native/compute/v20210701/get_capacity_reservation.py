...
def get_capacity_reservation(capacity_reservation_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_capacity_reservation is deprecated: azure-native:compute/v20210701:CapacityReservation is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:CapacityReservation to guarantee forwards compatibility.""")
    __args__ = dict()
