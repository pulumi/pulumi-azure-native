...
def get_virtual_machine_run_command_by_virtual_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_run_command_by_virtual_machine is deprecated: azure-native:compute/v20210701:VirtualMachineRunCommandByVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:VirtualMachineRunCommandByVirtualMachine to guarantee forwards compatibility.""")
    __args__ = dict()
