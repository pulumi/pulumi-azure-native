...
def get_restore_point(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_restore_point is deprecated: azure-native:compute/v20210701:RestorePoint is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20211101:RestorePoint to guarantee forwards compatibility.""")
    __args__ = dict()
