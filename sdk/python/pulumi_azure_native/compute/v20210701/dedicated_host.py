...
warnings.warn("""azure-native:compute/v20210701:DedicatedHost is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHost to guarantee forwards compatibility.""", DeprecationWarning)
...
class DedicatedHost(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DedicatedHost is deprecated: azure-native:compute/v20210701:DedicatedHost is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHost to guarantee forwards compatibility.""")
