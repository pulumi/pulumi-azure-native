...
warnings.warn("""azure-native:compute/v20210701:VirtualMachineScaleSetVMRunCommand is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVMRunCommand to guarantee forwards compatibility.""", DeprecationWarning)
