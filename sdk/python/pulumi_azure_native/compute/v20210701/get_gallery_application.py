...
warnings.warn("""azure-native:compute/v20210701:GalleryApplication is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220303:GalleryApplication to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_gallery_application(gallery_application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery_application is deprecated: azure-native:compute/v20210701:GalleryApplication is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220303:GalleryApplication to guarantee forwards compatibility.""")
    __args__ = dict()
