...
warnings.warn("""azure-native:compute/v20210701:AvailabilitySet is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:AvailabilitySet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_availability_set(availability_set_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_availability_set is deprecated: azure-native:compute/v20210701:AvailabilitySet is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:AvailabilitySet to guarantee forwards compatibility.""")
    __args__ = dict()
