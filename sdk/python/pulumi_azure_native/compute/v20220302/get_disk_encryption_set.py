...
def get_disk_encryption_set(disk_encryption_set_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk_encryption_set is deprecated: azure-native:compute/v20220302:DiskEncryptionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskEncryptionSet to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['diskEncryptionSetName'] = disk_encryption_set_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20220302:getDiskEncryptionSet', __args__, opts=opts, typ=GetDiskEncryptionSetResult).value
