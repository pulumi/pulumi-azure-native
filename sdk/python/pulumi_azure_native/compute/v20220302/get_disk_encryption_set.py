...
def get_disk_encryption_set(disk_encryption_set_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk_encryption_set is deprecated: azure-native:compute/v20220302:DiskEncryptionSet is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskEncryptionSet to guarantee forwards compatibility.""")
    __args__ = dict()
