...
warnings.warn("""azure-native:compute/v20220302:DiskAccess is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccess to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_disk_access(disk_access_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk_access is deprecated: azure-native:compute/v20220302:DiskAccess is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccess to guarantee forwards compatibility.""")
    __args__ = dict()
