...
warnings.warn("""azure-native:compute/v20220801:RestorePoint is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:RestorePoint to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_restore_point(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_restore_point is deprecated: azure-native:compute/v20220801:RestorePoint is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:RestorePoint to guarantee forwards compatibility.""")
    __args__ = dict()
