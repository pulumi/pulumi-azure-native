...
def get_dedicated_host_group(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dedicated_host_group is deprecated: azure-native:compute/v20220801:DedicatedHostGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHostGroup to guarantee forwards compatibility.""")
    __args__ = dict()
