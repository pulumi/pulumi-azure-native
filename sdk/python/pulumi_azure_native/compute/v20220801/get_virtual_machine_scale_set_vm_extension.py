...
warnings.warn("""azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_machine_scale_set_vm_extension(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20220801:getVirtualMachineScaleSetVMExtension', __args__, opts=opts, typ=GetVirtualMachineScaleSetVMExtensionResult).value
