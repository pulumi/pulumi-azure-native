...
warnings.warn("""azure-native:compute/v20220801:ProximityPlacementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:ProximityPlacementGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_proximity_placement_group(include_colocation_status: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_proximity_placement_group is deprecated: azure-native:compute/v20220801:ProximityPlacementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:ProximityPlacementGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20220801:getProximityPlacementGroup', __args__, opts=opts, typ=GetProximityPlacementGroupResult).value
