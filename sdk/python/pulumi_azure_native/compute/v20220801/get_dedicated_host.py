...
def get_dedicated_host(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dedicated_host is deprecated: azure-native:compute/v20220801:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:DedicatedHost to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20220801:getDedicatedHost', __args__, opts=opts, typ=GetDedicatedHostResult).value
