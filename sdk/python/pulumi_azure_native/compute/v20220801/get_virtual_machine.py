...
def get_virtual_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine is deprecated: azure-native:compute/v20220801:VirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachine to guarantee forwards compatibility.""")
    __args__ = dict()
