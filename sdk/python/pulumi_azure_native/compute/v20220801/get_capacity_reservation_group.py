...
warnings.warn("""azure-native:compute/v20220801:CapacityReservationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:CapacityReservationGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_capacity_reservation_group(capacity_reservation_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_capacity_reservation_group is deprecated: azure-native:compute/v20220801:CapacityReservationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:CapacityReservationGroup to guarantee forwards compatibility.""")
    __args__ = dict()
