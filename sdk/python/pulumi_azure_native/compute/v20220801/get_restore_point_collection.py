...
def get_restore_point_collection(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_restore_point_collection is deprecated: azure-native:compute/v20220801:RestorePointCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:RestorePointCollection to guarantee forwards compatibility.""")
    __args__ = dict()
