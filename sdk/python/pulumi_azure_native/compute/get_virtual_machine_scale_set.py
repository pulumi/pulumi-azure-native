...
def get_virtual_machine_scale_set(expand: Optional[_builtins.str] = None,
    ...
    :param _builtins.str expand: The expand expression to apply on the operation. 'UserData' retrieves the UserData property of the VM scale set that was provided by the user during the VM scale set Create/Update operation
...
def get_virtual_machine_scale_set_output(expand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                         resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                         vm_scale_set_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
