...
warnings.warn("""Version 2020-09-30 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_disk_encryption_set(disk_encryption_set_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk_encryption_set is deprecated: Version 2020-09-30 will be removed in v2 of the provider.""")
    __args__ = dict()
