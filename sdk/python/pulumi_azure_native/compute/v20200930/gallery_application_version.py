...
class GalleryApplicationVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gallery_application_version = azure_native.compute.v20200930.GalleryApplicationVersion("galleryApplicationVersion",
            gallery_application_name="myGalleryApplicationName",
            gallery_application_version_name="1.0.0",
            gallery_name="myGalleryName",
            location="West US",
            publishing_profile=azure_native.compute.v20200930.GalleryApplicationVersionPublishingProfileResponseArgs(
                end_of_life_date="2019-07-01T07:00:00Z",
                manage_actions=azure_native.compute.v20200930.UserArtifactManageArgs(
                    install="powershell -command \\"Expand-Archive -Path package.zip -DestinationPath C:\\\\package\\"",
                    remove="del C:\\\\package ",
                ),
                replica_count=1,
                source=azure_native.compute.v20200930.UserArtifactSourceArgs(
                    media_link="https://mystorageaccount.blob.core.windows.net/mycontainer/package.zip?{sasKey}",
                ),
                storage_account_type="Standard_LRS",
                target_regions=[azure_native.compute.v20200930.TargetRegionArgs(
                    name="West US",
