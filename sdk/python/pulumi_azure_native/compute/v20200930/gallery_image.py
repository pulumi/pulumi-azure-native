...
class GalleryImage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gallery_image = azure_native.compute.v20200930.GalleryImage("galleryImage",
            gallery_image_name="myGalleryImageName",
            gallery_name="myGalleryName",
            hyper_v_generation="V1",
            identifier=azure_native.compute.v20200930.GalleryImageIdentifierArgs(
                offer="myOfferName",
                publisher="myPublisherName",
                sku="mySkuName",
            ),
            location="West US",
            os_state=azure_native.compute/v20200930.OperatingSystemStateTypes.GENERALIZED,
            os_type=azure_native.compute/v20200930.OperatingSystemTypes.WINDOWS,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:compute:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20180601:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20190301:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20190701:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20191201:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20210701:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20211001:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20220103:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20220303:GalleryImage")])
