...
def get_gallery_application(gallery_application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery_application is deprecated: azure-native:compute/v20200930:GalleryApplication is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplication to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['galleryApplicationName'] = gallery_application_name
    __args__['galleryName'] = gallery_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20200930:getGalleryApplication', __args__, opts=opts, typ=GetGalleryApplicationResult).value
