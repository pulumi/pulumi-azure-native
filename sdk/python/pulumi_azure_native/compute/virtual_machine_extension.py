...
class VirtualMachineExtensionArgs:
    ...
    def vm_extension_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vm_extension_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VirtualMachineExtension(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableAutomaticUpgrade")
    def enable_automatic_upgrade(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the extension should be automatically upgraded by the platform if there is a newer version of the extension available.
        """
        return pulumi.get(self, "enable_automatic_upgrade")
    ...
    @property
    @pulumi.getter(name="provisionAfterExtensions")
    def provision_after_extensions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Collection of extension names after which this extension needs to be provisioned.
        """
        return pulumi.get(self, "provision_after_extensions")
    ...
    @property
    @pulumi.getter(name="suppressFailures")
    def suppress_failures(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether failures stemming from the extension will be suppressed (Operational failures such as not connecting to the VM will not be suppressed regardless of this value). The default is false.
        """
        return pulumi.get(self, "suppress_failures")
