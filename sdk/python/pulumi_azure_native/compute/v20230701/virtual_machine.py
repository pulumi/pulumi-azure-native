...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(additional_capabilities, AdditionalCapabilitiesArgs):
            ...
            if not isinstance(application_profile, ApplicationProfileArgs):
            ...
            if not isinstance(availability_set, SubResourceArgs):
            ...
            if not isinstance(billing_profile, BillingProfileArgs):
            ...
            if not isinstance(capacity_reservation, CapacityReservationProfileArgs):
            ...
            if not isinstance(diagnostics_profile, DiagnosticsProfileArgs):
            ...
            if not isinstance(hardware_profile, HardwareProfileArgs):
            ...
            if not isinstance(host, SubResourceArgs):
                host = host or {}
                def _setter(key, value):
                    host[key] = value
                SubResourceArgs._configure(_setter, **host)
            __props__.__dict__["host"] = host
            if not isinstance(host_group, SubResourceArgs):
            ...
            if not isinstance(identity, VirtualMachineIdentityArgs):
            ...
            if not isinstance(plan, PlanArgs):
                plan = plan or {}
                def _setter(key, value):
                    plan[key] = value
            ...
            if not isinstance(proximity_placement_group, SubResourceArgs):
            ...
            if not isinstance(scheduled_events_profile, ScheduledEventsProfileArgs):
            ...
            if not isinstance(security_profile, SecurityProfileArgs):
            ...
            if not isinstance(storage_profile, StorageProfileArgs):
            ...
            if not isinstance(virtual_machine_scale_set, SubResourceArgs):
        ...
        super(VirtualMachine, __self__).__init__(
            'azure-native:compute/v20230701:VirtualMachine',
            resource_name,
            __props__,
            opts)
