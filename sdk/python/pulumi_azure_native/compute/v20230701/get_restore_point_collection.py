...
def get_restore_point_collection(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20230701:getRestorePointCollection', __args__, opts=opts, typ=GetRestorePointCollectionResult).value
...
def get_restore_point_collection_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['restorePointCollectionName'] = restore_point_collection_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20230701:getRestorePointCollection', __args__, opts=opts, typ=GetRestorePointCollectionResult)
