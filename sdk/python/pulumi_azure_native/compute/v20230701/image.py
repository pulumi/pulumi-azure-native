...
class ImageArgs:
    ...
    def _configure(
        ...
        if 'sourceVirtualMachine' in kwargs:
            source_virtual_machine = kwargs['sourceVirtualMachine']
        ...
        if source_virtual_machine is not None:
            _setter("source_virtual_machine", source_virtual_machine)
...
class Image(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if source_virtual_machine is not None and not isinstance(source_virtual_machine, SubResourceArgs):
                source_virtual_machine = source_virtual_machine or {}
                def _setter(key, value):
                    source_virtual_machine[key] = value
                SubResourceArgs._configure(_setter, **source_virtual_machine)
            __props__.__dict__["source_virtual_machine"] = source_virtual_machine
            if storage_profile is not None and not isinstance(storage_profile, ImageStorageProfileArgs):
                storage_profile = storage_profile or {}
                def _setter(key, value):
                    storage_profile[key] = value
                ImageStorageProfileArgs._configure(_setter, **storage_profile)
        ...
        super(Image, __self__).__init__(
            'azure-native:compute/v20230701:Image',
            resource_name,
            __props__,
            opts)
