...
class SshPublicKeyInitArgs:
    def __init__(__self__, *,
        ...
        """
        SshPublicKeyInitArgs._configure(
    ...
    def _configure(
        ...
        if ssh_public_key_name is None and 'sshPublicKeyName' in kwargs:
            ssh_public_key_name = kwargs['sshPublicKeyName']
        ...
        if ssh_public_key_name is not None:
            _setter("ssh_public_key_name", ssh_public_key_name)
        if tags is not None:
            _setter("tags", tags)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SshPublicKeyInitArgs._configure(_setter, **kwargs)
