...
class VirtualMachineScaleSetVMRunCommand(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(error_blob_managed_identity, RunCommandManagedIdentityArgs):
            ...
            if not isinstance(output_blob_managed_identity, RunCommandManagedIdentityArgs):
            ...
            if not isinstance(source, VirtualMachineRunCommandScriptSourceArgs):
                source = source or {}
                def _setter(key, value):
                    source[key] = value
