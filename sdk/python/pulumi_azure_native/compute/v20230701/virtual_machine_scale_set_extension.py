...
class VirtualMachineScaleSetExtensionInitArgs:
    def __init__(__self__, *,
        ...
        """
        VirtualMachineScaleSetExtensionInitArgs._configure(
...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            VirtualMachineScaleSetExtensionInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(VirtualMachineScaleSetExtension, __self__).__init__(
            'azure-native:compute/v20230701:VirtualMachineScaleSetExtension',
            resource_name,
            __props__,
            opts)
