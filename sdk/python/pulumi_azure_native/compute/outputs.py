...
class AutomaticZoneRebalancingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 enabled: Optional[bool] = None,
                 rebalance_behavior: Optional[str] = None,
                 rebalance_strategy: Optional[str] = None):
        """
        The configuration parameters used while performing automatic AZ balancing.
        :param bool enabled: Specifies whether Automatic AZ Balancing should be enabled on the virtual machine scale set. The default value is false.
        :param str rebalance_behavior: Type of rebalance behavior that will be used for recreating virtual machines in the scale set across availability zones. Default and only supported value for now is CreateBeforeDelete.
        :param str rebalance_strategy: Type of rebalance strategy that will be used for rebalancing virtual machines in the scale set across availability zones. Default and only supported value for now is Recreate.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def rebalance_behavior(self) -> Optional[str]:
        """
    ...
    def rebalance_strategy(self) -> Optional[str]:
        """
...
class DefaultVirtualMachineScaleSetInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Indicates the target Virtual Machine ScaleSet properties upon triggering a seamless migration without downtime of the VMs via the ConvertToVirtualMachineScaleSet API.
        :param bool constrained_maximum_capacity:  Indicates if the the maximum capacity of the default migrated Virtual Machine Scale Set after its migration will be constrained to a limited number of VMs.
    ...
    def constrained_maximum_capacity(self) -> bool:
        """
...
class EventGridAndResourceGraphResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies eventGridAndResourceGraph related Scheduled Event related configurations.
        :param bool enable: Specifies if event grid and resource graph is enabled for Scheduled event related configurations.
        """
...
class HostEndpointSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies particular host endpoint settings.
        :param str in_vm_access_control_profile_reference_id: Specifies the InVMAccessControlProfileVersion resource id in the format of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/inVMAccessControlProfiles/{profile}/versions/{version}
        :param str mode: Specifies the execution mode. In Audit mode, the system acts as if it is enforcing the access control policy, including emitting access denial entries in the logs but it does not actually deny any requests to host endpoints. In Enforce mode, the system will enforce the access control and it is the recommended mode of operation.
        """
    ...
    def in_vm_access_control_profile_reference_id(self) -> Optional[str]:
        """
...
class PlacementResponse(dict):
    ...
    def exclude_zones(self) -> Optional[Sequence[str]]:
        """
        This property supplements the 'zonePlacementPolicy' property. If 'zonePlacementPolicy' is set to 'Any', availability zone selected by the system must not be present in the list of availability zones passed with 'excludeZones'. If 'excludeZones' is not provided, all availability zones in region will be considered for selection.
        """
    ...
    def include_zones(self) -> Optional[Sequence[str]]:
        """
        This property supplements the 'zonePlacementPolicy' property. If 'zonePlacementPolicy' is set to 'Any', availability zone selected by the system must be present in the list of availability zones passed with 'includeZones'. If 'includeZones' is not provided, all availability zones in region will be considered for selection.
        """
    ...
    def zone_placement_policy(self) -> Optional[str]:
        """
...
class ProxyAgentSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int key_incarnation_id: Increase the value of this property allows users to reset the key used for securing communication channel between guest and host.
        :param str mode: Specifies the mode that ProxyAgent will execute on. Warning: this property has been deprecated, please specify 'mode' under particular hostendpoint setting.
...
class ScaleInPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 prioritize_unhealthy_vms: Optional[bool] = None,
        ...
        :param bool prioritize_unhealthy_vms: This property allows you to prioritize the deletion of unhealthy and inactive VMs when a virtual machine scale set is being scaled-in.(Feature in Preview)
    ...
    def prioritize_unhealthy_vms(self) -> Optional[bool]:
        """
...
class SkuProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the sku profile for the virtual machine scale set. With this property the customer is able to specify a list of VM sizes and an allocation strategy.
        :param str allocation_strategy: Specifies the allocation strategy for the virtual machine scale set based on which the VMs will be allocated.
...
class SkuProfileVMSizeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the VM Size.
        :param str name: Specifies the name of the VM Size.
        :param int rank: Specifies the rank (a.k.a priority) associated with the VM Size.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if rank is not None:
...
class StorageProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the storage settings for the virtual machine disks.
        :param bool align_regional_disks_to_vm_zone: Specifies whether the regional disks should be aligned/moved to the VM zone. This is applicable only for VMs with placement property set. Please note that this change is irreversible. Minimum api-version: 2024-11-01.
    ...
    def align_regional_disks_to_vm_zone(self) -> Optional[bool]:
        """
...
class UserInitiatedRebootResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies Reboot related Scheduled Event related configurations.
        :param bool automatically_approve: Specifies Reboot Scheduled Event related configurations.
        """
    ...
    def automatically_approve(self) -> Optional[bool]:
        """
...
class UserInitiatedRedeployResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies Redeploy related Scheduled Event related configurations.
        :param bool automatically_approve: Specifies Redeploy Scheduled Event related configurations.
        """
        if automatically_approve is not None:
            pulumi.set(__self__, "automatically_approve", automatically_approve)
...
class VirtualMachineScaleSetNetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str network_api_version: Specifies the Microsoft.Network API version used when creating networking resources in the Network Interface Configurations for Virtual Machine Scale Set with orchestration mode 'Flexible'. For support of all network properties, use '2022-11-01'.
...
class VirtualMachineScaleSetVMProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a virtual machine scale set virtual machine profile.
        :param str time_created: Specifies the time in which this VM profile for the Virtual Machine Scale Set was created. This value will be added to VMSS Flex VM tags when creating/updating the VMSS VM Profile. Minimum API version for this property is 2023-09-01.
...
class WindowsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies Windows operating system settings on the virtual machine.
        :param bool enable_vm_agent_platform_updates: Indicates whether VMAgent Platform Updates are enabled for the Windows Virtual Machine.
    ...
    @property
    @pulumi.getter(name="enableVMAgentPlatformUpdates")
    def enable_vm_agent_platform_updates(self) -> bool:
        """
