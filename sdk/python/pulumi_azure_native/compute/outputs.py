...
class AccessControlRulesIdentityResponse(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 exe_path: Optional[_builtins.str] = None,
        ...
        :param _builtins.str process_name: The process name of the executable.
        :param _builtins.str user_name: The username corresponding to this identity.
        """
...
class AdditionalReplicaSetResponse(dict):
    ...
    def __init__(__self__, *,
                 regional_replica_count: Optional[_builtins.int] = None,
...
class AdditionalUnattendContentResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pass_name: Optional[_builtins.str] = None,
...
class AutomaticOSUpgradePolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 disable_automatic_rollback: Optional[_builtins.bool] = None,
                 enable_automatic_os_upgrade: Optional[_builtins.bool] = None,
                 os_rolling_upgrade_deferral: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool use_rolling_upgrade_policy: Indicates whether rolling upgrade policy should be used during Auto OS Upgrade. Default value is false. Auto OS Upgrade will fallback to the default policy if no policy is defined on the VMSS.
        """
...
class AutomaticZoneRebalancingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 enabled: Optional[_builtins.bool] = None,
                 rebalance_behavior: Optional[_builtins.str] = None,
...
class AvailablePatchSummaryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str last_modified_time: The UTC timestamp when the operation began.
        :param _builtins.int other_patch_count: The number of all available patches excluding critical and security.
        :param _builtins.bool reboot_pending: The overall reboot status of the VM. It will be true when partially installed patches require a reboot to complete installation but the reboot has not yet occurred.
        :param _builtins.str start_time: The UTC timestamp when the operation began.
        :param _builtins.str status: The overall success or failure status of the operation. It remains "InProgress" until the operation completes. At that point it will become "Unknown", "Failed", "Succeeded", or "CompletedWithWarnings."
        """
...
class CommunityGalleryInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 public_name_prefix: Optional[_builtins.str] = None,
                 publisher_contact: Optional[_builtins.str] = None,
        ...
        :param _builtins.str public_name_prefix: The prefix of the gallery name that will be displayed publicly. Visible to all users.
        :param _builtins.str publisher_contact: Community gallery publisher support email. The email address of the publisher. Visible to all users.
        :param _builtins.str publisher_uri: The link to the publisher website. Visible to all users.
        """
...
class CreationDataResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 elastic_san_resource_id: Optional[_builtins.str] = None,
                 ...
                 logical_sector_size: Optional[_builtins.int] = None,
                 performance_plus: Optional[_builtins.bool] = None,
                 provisioned_bandwidth_copy_speed: Optional[_builtins.str] = None,
                 security_data_uri: Optional[_builtins.str] = None,
        ...
        :param _builtins.int logical_sector_size: Logical sector size in bytes for Ultra disks. Supported values are 512 ad 4096. 4096 is the default.
        :param _builtins.bool performance_plus: Set this flag to true to get a boost on the performance target of the disk deployed, see here on the respective performance target. This flag can only be set on disk creation time and cannot be disabled after enabled.
        :param _builtins.str provisioned_bandwidth_copy_speed: If this field is set on a snapshot and createOption is CopyStart, the snapshot will be copied at a quicker speed.
        :param _builtins.str security_data_uri: If createOption is ImportSecure, this is the URI of a blob to be imported into VM guest state.
        :param _builtins.str source_resource_id: If createOption is Copy, this is the ARM id of the source snapshot or disk.
        :param _builtins.str source_uri: If createOption is Import, this is the URI of a blob to be imported into a managed disk.
        :param _builtins.str storage_account_id: Required if createOption is Import. The Azure Resource Manager identifier of the storage account containing the blob to import as a disk.
        :param _builtins.float upload_size_bytes: If createOption is Upload, this is the size of the contents of the upload including the VHD footer. This value should be between 20972032 (20 MiB + 512 bytes for the VHD footer) and 35183298347520 bytes (32 TiB + 512 bytes for the VHD footer).
        """
...
class DataDiskResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 detach_option: Optional[_builtins.str] = None,
                 ...
                 to_be_detached: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str delete_option: Specifies whether data disk should be deleted or detached upon VM deletion. Possible values are: **Delete.** If this value is used, the data disk is deleted when VM is deleted. **Detach.** If this value is used, the data disk is retained after VM is deleted. The default value is set to **Detach**.
        :param _builtins.str detach_option: Specifies the detach behavior to be used while detaching a disk or which is already in the process of detachment from the virtual machine. Supported values: **ForceDetach.** detachOption: **ForceDetach** is applicable only for managed data disks. If a previous detachment attempt of the data disk did not complete due to an unexpected failure from the virtual machine and the disk is still not released then use force-detach as a last resort option to detach the disk forcibly from the VM. All writes might not have been flushed when using this detach behavior. **This feature is still in preview**. To force-detach a data disk update toBeDetached to 'true' along with setting detachOption: 'ForceDetach'.
        :param _builtins.int disk_size_gb: Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. The property 'diskSizeGB' is the number of bytes x 1024^3 for the disk and the value cannot be larger than 1023.
        ...
        :param _builtins.bool to_be_detached: Specifies whether the data disk is in process of detachment from the VirtualMachine/VirtualMachineScaleset
...
class DiskPurchasePlanResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str promotion_code: The Offer Promotion Code.
        """
        pulumi.set(__self__, "name", name)
...
class DiskRestorePointReplicationStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 completion_percent: Optional[_builtins.int] = None,
...
class GalleryApplicationCustomActionParameterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool required: Indicates whether this parameter must be passed when running the custom action.
        :param _builtins.str type: Specifies the type of the custom action parameter. Possible values are: String, ConfigurationDataBlob or LogOutputBlob
        """
        pulumi.set(__self__, "name", name)
...
class GalleryApplicationVersionPublishingProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 advanced_settings: Optional[Mapping[str, _builtins.str]] = None,
        ...
        :param _builtins.bool enable_health_check: Optional. Whether or not this application reports health.
...
class GalleryArtifactVersionFullSourceResponse(dict):
    ...
    def __init__(__self__, *,
                 community_gallery_image_id: Optional[_builtins.str] = None,
                 id: Optional[_builtins.str] = None,
...
class GalleryImageFeatureResponse(dict):
    ...
    def __init__(__self__, *,
                 name: Optional[_builtins.str] = None,
                 starts_at_version: Optional[_builtins.str] = None,
...
class GalleryImageVersionSafetyProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool allow_deletion_of_replicated_locations: Indicates whether or not removing this Gallery Image Version from replicated regions is allowed.
        :param _builtins.bool block_deletion_before_end_of_life: Indicates whether or not the deletion is blocked for this Gallery Image Version if its End Of Life has not expired.
        """
...
class GalleryInVMAccessControlProfilePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: The provisioning state, which only appears in the response.
        :param _builtins.str description: The description of this gallery inVMAccessControlProfile resources. This property is updatable.
        """
...
class GalleryTargetExtendedLocationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 extended_location_replica_count: Optional[_builtins.int] = None,
                 name: Optional[_builtins.str] = None,
                 storage_account_type: Optional[_builtins.str] = None):
        """
        ...
        :param _builtins.int extended_location_replica_count: The number of replicas of the Image Version to be created per extended location. This property is updatable.
...
class HostEndpointSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 in_vm_access_control_profile_reference_id: Optional[_builtins.str] = None,
...
class ImageDataDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int disk_size_gb: Specifies the size of empty data disks in gigabytes. This element can be used to overwrite the name of the disk in a virtual machine image. This value cannot be larger than 1023 GB.
...
class ImageDiskReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str shared_gallery_image_id: A relative uri containing a direct shared Azure Compute Gallery image reference.
        """
        if community_gallery_image_id is not None:
            pulumi.set(__self__, "community_gallery_image_id", community_gallery_image_id)
        if id is not None:
...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str shared_gallery_image_id: Specified the shared gallery image unique id for vm deployment. This can be fetched from shared gallery image GET call.
        :param _builtins.str sku: The image SKU.
        :param _builtins.str version: Specifies the version of the platform image or marketplace image used to create the virtual machine. The allowed formats are Major.Minor.Build or 'latest'. Major, Minor, and Build are decimal numbers. Specify 'latest' to use the latest version of an image available at deploy time. Even if you use 'latest', the VM image will not automatically update after deploy time even if a new version becomes available. Please do not use field 'version' for gallery image deployment, gallery image should always use 'id' field for deployment, to use 'latest' version of gallery image, just set '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{imageName}' in the 'id' field without version input.
        """
...
class InnerErrorResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 errordetail: Optional[_builtins.str] = None,
...
class LastPatchInstallationSummaryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str installation_activity_id: The activity ID of the operation that produced this result. It is used to correlate across CRP and extension logs.
        :param _builtins.int installed_patch_count: The count of patches that successfully installed.
        :param _builtins.str last_modified_time: The UTC timestamp when the operation began.
        :param _builtins.bool maintenance_window_exceeded: Describes whether the operation ran out of time before it completed all its intended actions
        :param _builtins.int not_selected_patch_count: The number of all available patches but not going to be installed because it didn't match a classification or inclusion list entry.
        :param _builtins.int pending_patch_count: The number of all available patches expected to be installed over the course of the patch installation operation.
        :param _builtins.str start_time: The UTC timestamp when the operation began.
        :param _builtins.str status: The overall success or failure status of the operation. It remains "InProgress" until the operation completes. At that point it will become "Unknown", "Failed", "Succeeded", or "CompletedWithWarnings."
        """
        pulumi.set(__self__, "error", error)
...
class LinuxConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_vm_agent_platform_updates: Optional[_builtins.bool] = None,
...
class LinuxPatchSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 assessment_mode: Optional[_builtins.str] = None,
...
class LinuxVMGuestPatchAutomaticByPlatformSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 bypass_platform_safety_checks_on_user_schedule: Optional[_builtins.bool] = None,
...
class MaintenanceRedeployStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 is_customer_initiated_maintenance_allowed: Optional[_builtins.bool] = None,
                 last_operation_message: Optional[_builtins.str] = None,
                 last_operation_result_code: Optional[_builtins.str] = None,
                 maintenance_window_end_time: Optional[_builtins.str] = None,
                 maintenance_window_start_time: Optional[_builtins.str] = None,
                 pre_maintenance_window_end_time: Optional[_builtins.str] = None,
        ...
        :param _builtins.str maintenance_window_end_time: End Time for the Maintenance Window.
        :param _builtins.str maintenance_window_start_time: Start Time for the Maintenance Window.
        :param _builtins.str pre_maintenance_window_end_time: End Time for the Pre Maintenance Window.
        :param _builtins.str pre_maintenance_window_start_time: Start Time for the Pre Maintenance Window.
        """
...
class NetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 network_api_version: Optional[_builtins.str] = None,
...
class OSDiskImageSecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 confidential_vm_encryption_type: Optional[_builtins.str] = None,
                 secure_vm_disk_encryption_set_id: Optional[_builtins.str] = None):
        """
        Contains security profile for an OS disk image.
...
class OSImageNotificationProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 enable: Optional[_builtins.bool] = None,
                 not_before_timeout: Optional[_builtins.str] = None):
        """
        :param _builtins.bool enable: Specifies whether the OS Image Scheduled event is enabled or disabled.
        :param _builtins.str not_before_timeout: Length of time a Virtual Machine being reimaged or having its OS upgraded will have to potentially approve the OS Image Scheduled Event before the event is auto approved (timed out). The configuration is specified in ISO 8601 format, and the value must be 15 minutes (PT15M)
        """
        if enable is not None:
            pulumi.set(__self__, "enable", enable)
...
class OSProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allow_extension_operations: Optional[_builtins.bool] = None,
                 ...
                 require_guest_provision_signal: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool require_guest_provision_signal: Optional property which must either be set to True or omitted.
...
class PatchSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_hotpatching: Optional[_builtins.bool] = None,
                 patch_mode: Optional[_builtins.str] = None):
        """
        Specifies settings related to VM Guest Patching on Windows.
        :param _builtins.str assessment_mode: Specifies the mode of VM Guest patch assessment for the IaaS virtual machine.<br /><br /> Possible values are:<br /><br /> **ImageDefault** - You control the timing of patch assessments on a virtual machine.<br /><br /> **AutomaticByPlatform** - The platform will trigger periodic patch assessments. The property provisionVMAgent must be true.
        ...
        :param _builtins.str patch_mode: Specifies the mode of VM Guest Patching to IaaS virtual machine or virtual machines associated to virtual machine scale set with OrchestrationMode as Flexible.<br /><br /> Possible values are:<br /><br /> **Manual** - You  control the application of patches to a virtual machine. You do this by applying patches manually inside the VM. In this mode, automatic updates are disabled; the property WindowsConfiguration.enableAutomaticUpdates must be false<br /><br /> **AutomaticByOS** - The virtual machine will automatically be updated by the OS. The property WindowsConfiguration.enableAutomaticUpdates must be true. <br /><br /> **AutomaticByPlatform** - the virtual machine will automatically updated by the platform. The properties provisionVMAgent and WindowsConfiguration.enableAutomaticUpdates must be true
        """
        if assessment_mode is not None:
            pulumi.set(__self__, "assessment_mode", assessment_mode)
        if automatic_by_platform_settings is not None:
...
class PlacementResponse(dict):
    ...
    def __init__(__self__, *,
                 exclude_zones: Optional[Sequence[_builtins.str]] = None,
                 include_zones: Optional[Sequence[_builtins.str]] = None,
        ...
        :param _builtins.str zone_placement_policy: Specifies the policy for virtual machine's placement in availability zone. Possible values are: **Any** - An availability zone will be automatically picked by system as part of virtual machine creation.
        """
...
class PriorityMixPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 base_regular_priority_count: Optional[_builtins.int] = None,
...
class ProxyAgentSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_incarnation_id: Optional[_builtins.int] = None,
                 mode: Optional[_builtins.str] = None,
        ...
        :param _builtins.str mode: Specifies the mode that ProxyAgent will execute on. Warning: this property has been deprecated, please specify 'mode' under particular hostendpoint setting.
...
class RegionalReplicationStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str state: This is the regional replication state.
        """
        pulumi.set(__self__, "details", details)
...
class RestorePointResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str time_created: Gets the creation time of the restore point.
        """
        pulumi.set(__self__, "id", id)
...
class RestorePointSourceMetadataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str license_type: Gets the license type, which is for bring your own license scenario.
        :param _builtins.str location: Location of the VM from which the restore point was created.
        ...
        :param _builtins.str user_data: UserData associated with the source VM for which restore point is captured, which is a base-64 encoded value.
        :param _builtins.str vm_id: Gets the virtual machine unique id.
...
class RestorePointSourceVMDataDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Gets the disk name.
        :param _builtins.bool write_accelerator_enabled: Shows true if the disk is write-accelerator enabled.
...
class RestorePointSourceVMOSDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Gets the disk name.
        :param _builtins.str os_type: Gets the Operating System type.
        :param _builtins.bool write_accelerator_enabled: Shows true if the disk is write-accelerator enabled.
        :param 'DiskRestorePointAttributesResponse' disk_restore_point: Contains Disk Restore Point properties.
...
class RollingUpgradePolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 enable_cross_zone_upgrade: Optional[_builtins.bool] = None,
                 max_batch_instance_percent: Optional[_builtins.int] = None,
                 max_surge: Optional[_builtins.bool] = None,
                 ...
                 prioritize_unhealthy_instances: Optional[_builtins.bool] = None,
        ...
        :param _builtins.int max_unhealthy_upgraded_instance_percent: The maximum percentage of upgraded virtual machine instances that can be found to be in an unhealthy state. This check will happen after each batch is upgraded. If this percentage is ever exceeded, the rolling update aborts. The default value for this parameter is 20%.
        :param _builtins.str pause_time_between_batches: The wait time between completing the update for all virtual machines in one batch and starting the next batch. The time duration should be specified in ISO 8601 format. The default value is 0 seconds (PT0S).
        :param _builtins.bool prioritize_unhealthy_instances: Upgrade all unhealthy instances in a scale set before any healthy instances.
        :param _builtins.bool rollback_failed_instances_on_policy_breach: Rollback failed instances to previous model if the Rolling Upgrade policy is violated.
        """
...
class ScaleInPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 force_deletion: Optional[_builtins.bool] = None,
                 prioritize_unhealthy_vms: Optional[_builtins.bool] = None,
...
class SecurityPostureReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 id: _builtins.str,
                 exclude_extensions: Optional[Sequence[_builtins.str]] = None,
...
class ShareInfoElementResponse(dict):
    ...
    def __init__(__self__, *,
                 vm_uri: _builtins.str):
        """
        :param _builtins.str vm_uri: A relative URI containing the ID of the VM that has the disk attached.
        """
...
class StorageProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 align_regional_disks_to_vm_zone: Optional[_builtins.bool] = None,
                 data_disks: Optional[Sequence['outputs.DataDiskResponse']] = None,
                 disk_controller_type: Optional[_builtins.str] = None,
...
class SupportedCapabilitiesResponse(dict):
    ...
    def __init__(__self__, *,
                 accelerated_network: Optional[_builtins.bool] = None,
...
class TargetRegionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'EncryptionImagesResponse' encryption: Optional. Allows users to provide customer managed keys for encrypting the OS and data disks in the gallery artifact.
        :param _builtins.bool exclude_from_latest: Contains the flag setting to hide an image when users specify version='latest'
        :param _builtins.int regional_replica_count: The number of replicas of the Image Version to be created per region. This property is updatable.
        :param _builtins.str storage_account_type: Specifies the storage account type to be used to store the image. This property is not updatable.
        """
        pulumi.set(__self__, "name", name)
...
class TerminateNotificationProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 not_before_timeout: Optional[_builtins.str] = None):
        """
        :param _builtins.bool enable: Specifies whether the Terminate Scheduled event is enabled or disabled.
        :param _builtins.str not_before_timeout: Configurable length of time a Virtual Machine being deleted will have to potentially approve the Terminate Scheduled Event before the event is auto approved (timed out). The configuration must be specified in ISO 8601 format, the default value is 5 minutes (PT5M)
        """
        if enable is not None:
            pulumi.set(__self__, "enable", enable)
        if not_before_timeout is not None:
...
class UserArtifactManageResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str install: Required. The path and arguments to install the gallery application. This is limited to 4096 characters.
        :param _builtins.str remove: Required. The path and arguments to remove the gallery application. This is limited to 4096 characters.
        :param _builtins.str update: Optional. The path and arguments to update the gallery application. If not present, then update operation will invoke remove command on the previous version and install command on the current version of the gallery application. This is limited to 4096 characters.
        """
...
class UserArtifactSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 package_file_name: Optional[_builtins.str] = None,
...
class VMGalleryApplicationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 configuration_reference: Optional[_builtins.str] = None,
        ...
        :param _builtins.int order: Optional, Specifies the order in which the packages have to be installed
        :param _builtins.str tags: Optional, Specifies a passthrough value for more generic context.
        :param _builtins.bool treat_failure_as_deployment_failure: Optional, If true, any failure for any operation in the VmApplication will fail the deployment
        """
...
class VMSizePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 v_cpus_available: Optional[_builtins.int] = None,
...
class VirtualMachineExtensionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 publisher: Optional[_builtins.str] = None,
                 settings: Optional[Any] = None,
                 suppress_failures: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str force_update_tag: How the extension handler should be forced to update even if the extension configuration has not changed.
        ...
        :param Sequence[_builtins.str] provision_after_extensions: Collection of extension names after which this extension needs to be provisioned.
        :param _builtins.str publisher: The name of the extension handler publisher.
        :param Any settings: Json formatted public settings for the extension.
        :param _builtins.bool suppress_failures: Indicates whether failures stemming from the extension will be suppressed (Operational failures such as not connecting to the VM will not be suppressed regardless of this value). The default is false.
...
class VirtualMachineInstanceViewResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hyper_v_generation: Optional[_builtins.str] = None,
                 ...
                 platform_fault_domain: Optional[_builtins.int] = None,
                 platform_update_domain: Optional[_builtins.int] = None,
                 rdp_thumb_print: Optional[_builtins.str] = None,
                 statuses: Optional[Sequence['outputs.InstanceViewStatusResponse']] = None,
        ...
        :param _builtins.str computer_name: The computer name assigned to the virtual machine.
        ...
        :param _builtins.str hyper_v_generation: Specifies the HyperVGeneration Type associated with a resource
        ...
        :param _builtins.str os_name: The Operating System running on the virtual machine.
        :param _builtins.str os_version: The version of Operating System running on the virtual machine.
        :param 'VirtualMachinePatchStatusResponse' patch_status: [Preview Feature] The status of virtual machine patch operations.
        :param _builtins.int platform_fault_domain: Specifies the fault domain of the virtual machine.
        :param _builtins.int platform_update_domain: Specifies the update domain of the virtual machine.
        :param _builtins.str rdp_thumb_print: The Remote desktop certificate thumbprint.
        :param Sequence['InstanceViewStatusResponse'] statuses: The resource status information.
...
class VirtualMachineNetworkInterfaceConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 delete_option: Optional[_builtins.str] = None,
                 disable_tcp_state_tracking: Optional[_builtins.bool] = None,
                 ...
                 enable_fpga: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str auxiliary_sku: Specifies whether the Auxiliary sku is enabled for the Network Interface resource.
        :param _builtins.str delete_option: Specify what happens to the network interface when the VM is deleted
        :param _builtins.bool disable_tcp_state_tracking: Specifies whether the network interface is disabled for tcp state tracking.
        ...
        :param _builtins.bool enable_accelerated_networking: Specifies whether the network interface is accelerated networking-enabled.
        :param _builtins.bool enable_fpga: Specifies whether the network interface is FPGA networking-enabled.
        :param _builtins.bool enable_ip_forwarding: Whether IP forwarding enabled on this NIC.
...
class VirtualMachineNetworkInterfaceIPConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool primary: Specifies the primary network interface in case the virtual machine has more than 1 network interface.
        :param _builtins.str private_ip_address_version: Available from Api-Version 2017-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.  Possible values are: 'IPv4' and 'IPv6'.
...
class VirtualMachinePublicIPAddressConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 public_ip_allocation_method: Optional[_builtins.str] = None,
        ...
        :param _builtins.int idle_timeout_in_minutes: The idle timeout of the public IP address.
        :param Sequence['VirtualMachineIpTagResponse'] ip_tags: The list of IP tags associated with the public IP address.
        :param _builtins.str public_ip_address_version: Available from Api-Version 2019-07-01 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4. Possible values are: 'IPv4' and 'IPv6'.
        :param _builtins.str public_ip_allocation_method: Specify the public IP allocation type
...
class VirtualMachineRunCommandInstanceViewResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str execution_state: Script execution status.
        :param _builtins.int exit_code: Exit code returned from script execution.
        :param _builtins.str output: Script output stream.
        :param _builtins.str start_time: Script start time.
        :param Sequence['InstanceViewStatusResponse'] statuses: The resource status information.
        """
...
class VirtualMachineRunCommandScriptSourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the script sources for run command. Use only one of script, scriptUri, commandId.
        :param _builtins.str command_id: Specifies a commandId of predefined built-in script.
...
class VirtualMachineScaleSetDataDiskResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 caching: Optional[_builtins.str] = None,
                 delete_option: Optional[_builtins.str] = None,
                 disk_iops_read_write: Optional[_builtins.float] = None,
                 disk_m_bps_read_write: Optional[_builtins.float] = None,
                 disk_size_gb: Optional[_builtins.int] = None,
        ...
        :param _builtins.int lun: Specifies the logical unit number of the data disk. This value is used to identify data disks within the VM and therefore must be unique for each data disk attached to a VM.
        :param _builtins.str caching: Specifies the caching requirements. Possible values are: **None,** **ReadOnly,** **ReadWrite.** The default values are: **None for Standard storage. ReadOnly for Premium storage.**
        :param _builtins.str delete_option: Specifies whether data disk should be deleted or detached upon VMSS Flex deletion (This feature is available for VMSS with Flexible OrchestrationMode only).<br><br> Possible values: <br><br> **Delete** If this value is used, the data disk is deleted when the VMSS Flex VM is deleted.<br><br> **Detach** If this value is used, the data disk is retained after VMSS Flex VM is deleted.<br><br> The default value is set to **Delete**.
        :param _builtins.float disk_iops_read_write: Specifies the Read-Write IOPS for the managed disk. Should be used only when StorageAccountType is UltraSSD_LRS. If not specified, a default value would be assigned based on diskSizeGB.
        :param _builtins.float disk_m_bps_read_write: Specifies the bandwidth in MB per second for the managed disk. Should be used only when StorageAccountType is UltraSSD_LRS. If not specified, a default value would be assigned based on diskSizeGB.
        :param _builtins.int disk_size_gb: Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. The property diskSizeGB is the number of bytes x 1024^3 for the disk and the value cannot be larger than 1023.
...
class VirtualMachineScaleSetExtensionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool auto_upgrade_minor_version: Indicates whether the extension should use a newer minor version if one is available at deployment time. Once deployed, however, the extension will not upgrade minor versions unless redeployed, even with this property set to true.
        :param _builtins.bool enable_automatic_upgrade: Indicates whether the extension should be automatically upgraded by the platform if there is a newer version of the extension available.
        :param _builtins.str force_update_tag: If a value is provided and is different from the previous value, the extension handler will be forced to update even if the extension configuration has not changed.
        :param _builtins.str name: Resource name
        :param Any protected_settings: The extension can contain either protectedSettings or protectedSettingsFromKeyVault or no protected settings at all.
        :param 'KeyVaultSecretReferenceResponse' protected_settings_from_key_vault: The extensions protected settings that are passed by reference, and consumed from key vault
        :param Sequence[_builtins.str] provision_after_extensions: Collection of extension names after which this extension needs to be provisioned.
...
class VirtualMachineScaleSetOSDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The disk name.
        :param _builtins.str os_type: This property allows you to specify the type of the OS that is included in the disk if creating a VM from user-image or a specialized VHD. Possible values are: **Windows,** **Linux.**
        :param Sequence[_builtins.str] vhd_containers: Specifies the container urls that are used to store operating system disks for the scale set.
        :param _builtins.bool write_accelerator_enabled: Specifies whether writeAccelerator should be enabled or disabled on the disk.
        """
        pulumi.set(__self__, "create_option", create_option)
        if caching is not None:
...
class VirtualMachineScaleSetOSProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str computer_name_prefix: Specifies the computer name prefix for all of the virtual machines in the scale set. Computer name prefixes must be 1 to 15 characters long.
...
class VirtualMachineScaleSetVMInstanceViewResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'MaintenanceRedeployStatusResponse' maintenance_redeploy_status: The Maintenance Operation status on the virtual machine.
        :param _builtins.str os_name: The Operating System running on the hybrid machine.
        :param _builtins.str os_version: The version of Operating System running on the hybrid machine.
        :param _builtins.str placement_group_id: The placement group in which the VM is running. If the VM is deallocated it will not have a placementGroupId.
        :param _builtins.int platform_fault_domain: The Fault Domain count.
        :param _builtins.int platform_update_domain: The Update Domain count.
        :param _builtins.str rdp_thumb_print: The Remote desktop certificate thumbprint.
        :param Sequence['InstanceViewStatusResponse'] statuses: The resource status information.
        :param 'VirtualMachineAgentInstanceViewResponse' vm_agent: The VM Agent running on the virtual machine.
        """
...
class VirtualMachineScaleSetVMProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str eviction_policy: Specifies the eviction policy for the Azure Spot virtual machine and Azure Spot scale set. For Azure Spot virtual machines, both 'Deallocate' and 'Delete' are supported and the minimum api-version is 2019-03-01. For Azure Spot scale sets, both 'Deallocate' and 'Delete' are supported and the minimum api-version is 2017-10-30-preview.
        ...
        :param _builtins.str license_type: Specifies that the image or disk that is being used was licensed on-premises. <br><br> Possible values for Windows Server operating system are: <br><br> Windows_Client <br><br> Windows_Server <br><br> Possible values for Linux Server operating system are: <br><br> RHEL_BYOS (for RHEL) <br><br> SLES_BYOS (for SUSE) <br><br> For more information, see [Azure Hybrid Use Benefit for Windows Server](https://docs.microsoft.com/azure/virtual-machines/windows/hybrid-use-benefit-licensing) <br><br> [Azure Hybrid Use Benefit for Linux Server](https://docs.microsoft.com/azure/virtual-machines/linux/azure-hybrid-benefit-linux) <br><br> Minimum api-version: 2015-06-15
        ...
        :param _builtins.str priority: Specifies the priority for the virtual machines in the scale set. Minimum api-version: 2017-10-30-preview.
        ...
        :param _builtins.str user_data: UserData for the virtual machines in the scale set, which must be base-64 encoded. Customer should not pass any secrets in here. Minimum api-version: 2021-03-01.
        """
        pulumi.set(__self__, "time_created", time_created)
...
class VirtualMachineScaleSetVMProtectionPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 protect_from_scale_in: Optional[_builtins.bool] = None,
...
class WindowsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str time_zone: Specifies the time zone of the virtual machine. e.g. "Pacific Standard Time". Possible values can be [TimeZoneInfo.Id](https://docs.microsoft.com/dotnet/api/system.timezoneinfo.id?#System_TimeZoneInfo_Id) value from time zones returned by [TimeZoneInfo.GetSystemTimeZones](https://docs.microsoft.com/dotnet/api/system.timezoneinfo.getsystemtimezones).
