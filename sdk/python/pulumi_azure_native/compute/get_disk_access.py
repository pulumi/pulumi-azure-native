...
def get_disk_access(disk_access_name: Optional[_builtins.str] = None,
...
def get_disk_access_output(disk_access_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
