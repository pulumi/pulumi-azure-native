...
warnings.warn("""Version 2018-09-30 will be removed in v2 of the provider.
azure-native:compute/v20180930:Snapshot is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:Snapshot to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:compute/v20180930:Snapshot is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:Snapshot to guarantee forwards compatibility.""")
    __args__ = dict()
