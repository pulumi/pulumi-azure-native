...
class GetGalleryImageVersionResult:
    ...
    """
    def __init__(__self__, id=None, location=None, name=None, provisioning_state=None, publishing_profile=None, replication_status=None, safety_profile=None, security_profile=None, storage_profile=None, tags=None, type=None):
...
def get_gallery_image_version(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20220803:getGalleryImageVersion', __args__, opts=opts, typ=GetGalleryImageVersionResult).value
...
def get_gallery_image_version_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20220803:getGalleryImageVersion', __args__, opts=opts, typ=GetGalleryImageVersionResult)
