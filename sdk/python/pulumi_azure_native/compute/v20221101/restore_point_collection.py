...
class RestorePointCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        restore_point_collection = azure_native.compute.v20221101.RestorePointCollection("restorePointCollection",
            location="norwayeast",
            resource_group_name="myResourceGroup",
            restore_point_collection_name="myRpc",
            source=azure_native.compute.v20221101.RestorePointCollectionSourcePropertiesArgs(
