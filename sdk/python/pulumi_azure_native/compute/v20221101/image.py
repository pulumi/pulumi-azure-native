...
class Image(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        image = azure_native.compute.v20221101.Image("image",
            image_name="myImage",
            location="West US",
            resource_group_name="myResourceGroup",
            storage_profile=azure_native.compute.v20221101.ImageStorageProfileResponseArgs(
                os_disk={
                    ...
                    "osState": azure_native.compute/v20221101.OperatingSystemStateTypes.GENERALIZED,
                    "osType": azure_native.compute/v20221101.OperatingSystemTypes.LINUX,
                },
            ))
        ...
        image = azure_native.compute.v20221101.Image("image",
            ...
            resource_group_name="myResourceGroup",
            storage_profile=azure_native.compute.v20221101.ImageStorageProfileResponseArgs(
                os_disk=azure_native.compute.v20221101.ImageOSDiskArgs(
                    blob_uri="https://mystorageaccount.blob.core.windows.net/osimages/osimage.vhd",
                    os_state=azure_native.compute/v20221101.OperatingSystemStateTypes.GENERALIZED,
                    os_type=azure_native.compute/v20221101.OperatingSystemTypes.LINUX,
                ),
                zone_resilient=True,
            ))
        ...
        image = azure_native.compute.v20221101.Image("image",
            ...
            storage_profile=azure_native.compute.v20221101.ImageStorageProfileResponseArgs(
                os_disk={
                    ...
                    "osState": azure_native.compute/v20221101.OperatingSystemStateTypes.GENERALIZED,
                    "osType": azure_native.compute/v20221101.OperatingSystemTypes.LINUX,
                    "snapshot": azure_native.compute.v20221101.SubResourceArgs(
        ...
        image = azure_native.compute.v20221101.Image("image",
            ...
            storage_profile=azure_native.compute.v20221101.ImageStorageProfileResponseArgs(
                os_disk={
                    "managedDisk": azure_native.compute.v20221101.SubResourceArgs(
        ...
        image = azure_native.compute.v20221101.Image("image",
            ...
            location="West US",
            resource_group_name="myResourceGroup",
            source_virtual_machine=azure_native.compute.v20221101.SubResourceArgs(
        ...
        image = azure_native.compute.v20221101.Image("image",
            ...
            resource_group_name="myResourceGroup",
            storage_profile=azure_native.compute.v20221101.ImageStorageProfileResponseArgs(
                data_disks=[azure_native.compute.v20221101.ImageDataDiskArgs(
