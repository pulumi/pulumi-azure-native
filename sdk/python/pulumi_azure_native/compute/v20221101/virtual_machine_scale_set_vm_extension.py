...
class VirtualMachineScaleSetVMExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_scale_set_vm_extension = azure_native.compute.v20221101.VirtualMachineScaleSetVMExtension("virtualMachineScaleSetVMExtension",
    ...
    def _internal_init(__self__,
        ...
        super(VirtualMachineScaleSetVMExtension, __self__).__init__(
            'azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension',
            resource_name,
            __props__,
            opts)
