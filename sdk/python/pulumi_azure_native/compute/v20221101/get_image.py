...
warnings.warn("""azure-native:compute/v20221101:Image is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:Image to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_image(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_image is deprecated: azure-native:compute/v20221101:Image is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:Image to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['imageName'] = image_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20221101:getImage', __args__, opts=opts, typ=GetImageResult).value
