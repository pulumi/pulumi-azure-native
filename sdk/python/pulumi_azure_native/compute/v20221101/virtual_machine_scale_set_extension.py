...
warnings.warn("""azure-native:compute/v20221101:VirtualMachineScaleSetExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VirtualMachineScaleSetExtension, __self__).__init__(
            'azure-native:compute/v20221101:VirtualMachineScaleSetExtension',
            resource_name,
            __props__,
            opts)
