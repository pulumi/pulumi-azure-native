...
class CapacityReservation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        capacity_reservation = azure_native.compute.v20221101.CapacityReservation("capacityReservation",
        ...
        ```sh
        $ pulumi import azure-native:compute/v20221101:CapacityReservation myCapacityReservation /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/capacityReservationGroups/myCapacityReservationGroup/capacityReservations/myCapacityReservation 
        ```
