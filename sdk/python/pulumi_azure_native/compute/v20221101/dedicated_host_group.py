...
class DedicatedHostGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dedicated_host_group = azure_native.compute.v20221101.DedicatedHostGroup("dedicatedHostGroup",
            additional_capabilities=azure_native.compute.v20221101.DedicatedHostGroupPropertiesAdditionalCapabilitiesArgs(
