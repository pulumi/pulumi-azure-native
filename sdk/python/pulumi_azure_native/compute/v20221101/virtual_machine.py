...
class VirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine = azure_native.compute.v20221101.VirtualMachine("virtualMachine",
            hardware_profile=azure_native.compute.v20221101.HardwareProfileArgs(
            ...
            storage_profile=azure_native.compute.v20221101.StorageProfileResponseArgs(
                ...
                os_disk={
                    ...
                    "managedDisk": azure_native.compute.v20221101.ManagedDiskParametersArgs(
            ...
            os_profile=azure_native.compute.v20221101.OSProfileResponseArgs(
                ...
                linux_configuration={
                    "patchSettings": {
                        ...
                        "automaticByPlatformSettings": azure_native.compute.v20221101.LinuxVMGuestPatchAutomaticByPlatformSettingsArgs(
        ...
        virtual_machine = azure_native.compute.v20221101.VirtualMachine("virtualMachine",
            ...
            os_profile=azure_native.compute.v20221101.OSProfileArgs(
                admin_password="{your-password}",
                admin_username="{your-username}",
                computer_name="myVM",
            ),
        ...
        virtual_machine = azure_native.compute.v20221101.VirtualMachine("virtualMachine",
            ...
            os_profile=azure_native.compute.v20221101.OSProfileResponseArgs(
                ...
                windows_configuration={
                    ...
                    "patchSettings": {
                        "assessmentMode": "AutomaticByPlatform",
                        "automaticByPlatformSettings": azure_native.compute.v20221101.WindowsVMGuestPatchAutomaticByPlatformSettingsArgs(
                            reboot_setting="Never",
                        ),
                        "patchMode": "AutomaticByPlatform",
                    },
        ...
        virtual_machine = azure_native.compute.v20221101.VirtualMachine("virtualMachine",
            ...
            virtual_machine_scale_set=azure_native.compute.v20221101.SubResourceArgs(
        ...
        virtual_machine = azure_native.compute.v20221101.VirtualMachine("virtualMachine",
            application_profile=azure_native.compute.v20221101.ApplicationProfileResponseArgs(
        ...
        virtual_machine = azure_native.compute.v20221101.VirtualMachine("virtualMachine",
            ...
            resource_group_name="myResourceGroup",
            scheduled_events_profile=azure_native.compute.v20221101.ScheduledEventsProfileResponseArgs(
                os_image_notification_profile=azure_native.compute.v20221101.OSImageNotificationProfileArgs(
                    enable=True,
                    not_before_timeout="PT15M",
                ),
                terminate_notification_profile=azure_native.compute.v20221101.TerminateNotificationProfileArgs(
                    enable=True,
        ...
        virtual_machine = azure_native.compute.v20221101.VirtualMachine("virtualMachine",
            ...
            storage_profile=azure_native.compute.v20221101.StorageProfileResponseArgs(
                data_disks=[
                    azure_native.compute.v20221101.DataDiskArgs(
                        create_option="Empty",
                        disk_size_gb=1023,
                        lun=0,
                    ),
        ...
        virtual_machine = azure_native.compute.v20221101.VirtualMachine("virtualMachine",
            capacity_reservation=azure_native.compute.v20221101.CapacityReservationProfileResponseArgs(
                capacity_reservation_group=azure_native.compute.v20221101.SubResourceArgs(
        ...
        ```sh
        $ pulumi import azure-native:compute/v20221101:VirtualMachine myVM /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/virtualMachines/myVM 
        ```
