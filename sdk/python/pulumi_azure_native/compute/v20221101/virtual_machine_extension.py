...
class VirtualMachineExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_extension = azure_native.compute.v20221101.VirtualMachineExtension("virtualMachineExtension",
            auto_upgrade_minor_version=True,
            enable_automatic_upgrade=True,
            force_update_tag="a",
            instance_view=azure_native.compute.v20221101.VirtualMachineExtensionInstanceViewResponseArgs(
                name="aaaaaaaaaaaaaaaaa",
                statuses=[azure_native.compute.v20221101.InstanceViewStatusArgs(
                ...
                substatuses=[azure_native.compute.v20221101.InstanceViewStatusArgs(
                    code="aaaaaaaaaaaaaaaaaaaaaaa",
                    display_status="aaaaaa",
                    level=azure_native.compute/v20221101.StatusLevelTypes.INFO,
                    message="a",
