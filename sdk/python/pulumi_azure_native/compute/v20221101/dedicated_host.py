...
class DedicatedHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dedicated_host = azure_native.compute.v20221101.DedicatedHost("dedicatedHost",
