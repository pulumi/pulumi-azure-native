...
class VirtualMachineRunCommandByVirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_run_command_by_virtual_machine = azure_native.compute.v20221101.VirtualMachineRunCommandByVirtualMachine("virtualMachineRunCommandByVirtualMachine",
            async_execution=False,
            location="West US",
            parameters=[
                {
