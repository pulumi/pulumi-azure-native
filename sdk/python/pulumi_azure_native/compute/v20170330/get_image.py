...
azure-native:compute/v20170330:Image is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:Image to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_image(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_image is deprecated: Version 2017-03-30 will be removed in v2 of the provider.
azure-native:compute/v20170330:Image is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:Image to guarantee forwards compatibility.""")
    __args__ = dict()
