...
def get_virtual_machine_extension(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_extension is deprecated: Version v20170330 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20170330:getVirtualMachineExtension', __args__, opts=opts, typ=GetVirtualMachineExtensionResult).value
