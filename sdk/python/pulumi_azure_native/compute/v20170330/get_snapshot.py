...
def get_snapshot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot is deprecated: Version v20170330 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20170330:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult).value
