...
def get_snapshot(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20230102:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult).value
...
def get_snapshot_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['snapshotName'] = snapshot_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20230102:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult)
