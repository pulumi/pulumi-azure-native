...
class GetSshPublicKeyResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, name=None, public_key=None, system_data=None, tags=None, type=None):
...
def get_ssh_public_key(resource_group_name: Optional[_builtins.str] = None,
                       ssh_public_key_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ssh_public_key_name: The name of the SSH public key.
    """
    __args__ = dict()
...
def get_ssh_public_key_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                              ssh_public_key_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
