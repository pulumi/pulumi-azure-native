...
def get_gallery_application(gallery_application_name: Optional[_builtins.str] = None,
...
def get_gallery_application_output(gallery_application_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
