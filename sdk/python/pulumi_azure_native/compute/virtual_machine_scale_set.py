...
class VirtualMachineScaleSetArgs:
    def __init__(__self__, *,
                 ...
                 constrained_maximum_capacity: Optional[pulumi.Input[builtins.bool]] = None,
                 do_not_run_extensions_on_overprovisioned_vms: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 orchestration_mode: Optional[pulumi.Input[Union[builtins.str, 'OrchestrationMode']]] = None,
                 overprovision: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 zonal_platform_fault_domain_align_mode: Optional[pulumi.Input[Union[builtins.str, 'ZonalPlatformFaultDomainAlignMode']]] = None,
        ...
        :param pulumi.Input[builtins.bool] do_not_run_extensions_on_overprovisioned_vms: When Overprovision is enabled, extensions are launched only on the requested number of VMs which are finally kept. This property will hence ensure that the extensions do not run on the extra overprovisioned VMs.
        ...
        :param pulumi.Input[builtins.int] platform_fault_domain_count: Fault Domain count for each placement group.
    ...
    def constrained_maximum_capacity(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def constrained_maximum_capacity(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "constrained_maximum_capacity", value)

    @property
    @pulumi.getter(name="doNotRunExtensionsOnOverprovisionedVMs")
    def do_not_run_extensions_on_overprovisioned_vms(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def do_not_run_extensions_on_overprovisioned_vms(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def orchestration_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'OrchestrationMode']]]:
        """
    ...
    def orchestration_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'OrchestrationMode']]]):
        pulumi.set(self, "orchestration_mode", value)

    @property
    @pulumi.getter
    def overprovision(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def overprovision(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def single_placement_group(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def vm_scale_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vm_scale_set_name", value)

    @property
    @pulumi.getter(name="zonalPlatformFaultDomainAlignMode")
    def zonal_platform_fault_domain_align_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'ZonalPlatformFaultDomainAlignMode']]]:
        """
    ...
    def zonal_platform_fault_domain_align_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'ZonalPlatformFaultDomainAlignMode']]]):
        pulumi.set(self, "zonal_platform_fault_domain_align_mode", value)

    @property
    @pulumi.getter(name="zoneBalance")
    def zone_balance(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @zone_balance.setter
    def zone_balance(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="constrainedMaximumCapacity")
    def constrained_maximum_capacity(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Optional property which must either be set to True or omitted.
        """
        return pulumi.get(self, "constrained_maximum_capacity")
    ...
    @property
    @pulumi.getter(name="doNotRunExtensionsOnOverprovisionedVMs")
    def do_not_run_extensions_on_overprovisioned_vms(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When Overprovision is enabled, extensions are launched only on the requested number of VMs which are finally kept. This property will hence ensure that the extensions do not run on the extra overprovisioned VMs.
        """
        return pulumi.get(self, "do_not_run_extensions_on_overprovisioned_vms")
    ...
    @property
    @pulumi.getter(name="orchestrationMode")
    def orchestration_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the orchestration mode for the virtual machine scale set.
        """
        return pulumi.get(self, "orchestration_mode")
    ...
    @property
    @pulumi.getter
    def overprovision(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the Virtual Machine Scale Set should be overprovisioned.
        """
        return pulumi.get(self, "overprovision")
    ...
    @property
    @pulumi.getter(name="platformFaultDomainCount")
    def platform_fault_domain_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Fault Domain count for each placement group.
        """
        return pulumi.get(self, "platform_fault_domain_count")
    ...
    @property
    @pulumi.getter(name="singlePlacementGroup")
    def single_placement_group(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true this limits the scale set to a single placement group, of max size 100 virtual machines. NOTE: If singlePlacementGroup is true, it may be modified to false. However, if singlePlacementGroup is false, it may not be modified to true.
        """
        return pulumi.get(self, "single_placement_group")
    ...
    @property
    @pulumi.getter(name="zonalPlatformFaultDomainAlignMode")
    def zonal_platform_fault_domain_align_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the align mode between Virtual Machine Scale Set compute and storage Fault Domain count.
        """
        return pulumi.get(self, "zonal_platform_fault_domain_align_mode")
    ...
    @property
    @pulumi.getter(name="zoneBalance")
    def zone_balance(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to force strictly even Virtual Machine distribution cross x-zones in case there is zone outage. zoneBalance property can only be set if the zones property of the scale set contains more than one zone. If there are no zones or only one zone specified, then zoneBalance property should not be set.
        """
        return pulumi.get(self, "zone_balance")
