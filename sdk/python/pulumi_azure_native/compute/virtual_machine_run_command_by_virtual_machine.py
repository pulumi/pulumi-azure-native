...
class VirtualMachineRunCommandByVirtualMachineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vm_name: The name of the VirtualMachine
        ...
        :param pulumi.Input[builtins.str] run_command_name: The name of the VirtualMachineRunCommand
