...
def get_dedicated_host(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20240701:getDedicatedHost', __args__, opts=opts, typ=GetDedicatedHostResult).value
...
def get_dedicated_host_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20240701:getDedicatedHost', __args__, opts=opts, typ=GetDedicatedHostResult)
