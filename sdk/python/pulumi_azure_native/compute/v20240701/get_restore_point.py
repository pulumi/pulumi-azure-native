...
def get_restore_point(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20240701:getRestorePoint', __args__, opts=opts, typ=GetRestorePointResult).value
...
def get_restore_point_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['restorePointName'] = restore_point_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20240701:getRestorePoint', __args__, opts=opts, typ=GetRestorePointResult)
