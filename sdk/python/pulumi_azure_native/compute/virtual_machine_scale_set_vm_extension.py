...
class VirtualMachineScaleSetVMExtensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The location of the extension.
