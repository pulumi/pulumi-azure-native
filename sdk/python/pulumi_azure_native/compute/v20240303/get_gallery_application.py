...
def get_gallery_application(gallery_application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20240303:getGalleryApplication', __args__, opts=opts, typ=GetGalleryApplicationResult).value
...
def get_gallery_application_output(gallery_application_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20240303:getGalleryApplication', __args__, opts=opts, typ=GetGalleryApplicationResult)
