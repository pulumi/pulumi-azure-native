...
def get_gallery_in_vm_access_control_profile_version(gallery_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20240303:getGalleryInVMAccessControlProfileVersion', __args__, opts=opts, typ=GetGalleryInVMAccessControlProfileVersionResult).value
