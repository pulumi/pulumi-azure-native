...
def get_proximity_placement_group(include_colocation_status: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_proximity_placement_group is deprecated: azure-native:compute/v20211101:ProximityPlacementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:ProximityPlacementGroup to guarantee forwards compatibility.""")
    __args__ = dict()
