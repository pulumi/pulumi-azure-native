...
warnings.warn("""azure-native:compute/v20211101:RestorePointCollection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:RestorePointCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_restore_point_collection(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_restore_point_collection is deprecated: azure-native:compute/v20211101:RestorePointCollection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:RestorePointCollection to guarantee forwards compatibility.""")
    __args__ = dict()
