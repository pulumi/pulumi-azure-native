...
warnings.warn("""azure-native:compute/v20211101:CapacityReservationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:CapacityReservationGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class CapacityReservationGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CapacityReservationGroup is deprecated: azure-native:compute/v20211101:CapacityReservationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:CapacityReservationGroup to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:compute:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:compute/v20210401:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:compute/v20210701:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:compute/v20220301:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:compute/v20220801:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:compute/v20221101:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:compute/v20230301:CapacityReservationGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CapacityReservationGroup, __self__).__init__(
            'azure-native:compute/v20211101:CapacityReservationGroup',
            resource_name,
            __props__,
            opts)
