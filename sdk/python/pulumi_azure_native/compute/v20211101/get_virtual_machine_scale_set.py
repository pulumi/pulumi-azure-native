...
def get_virtual_machine_scale_set(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_scale_set is deprecated: azure-native:compute/v20211101:VirtualMachineScaleSet is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineScaleSet to guarantee forwards compatibility.""")
    __args__ = dict()
