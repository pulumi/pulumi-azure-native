...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_scale_set_extension = azure_native.compute.v20211101.VirtualMachineScaleSetExtension("virtualMachineScaleSetExtension",
        ...
        ```sh
        $ pulumi import azure-native:compute/v20211101:VirtualMachineScaleSetExtension {extension-name} aaaaaaaa 
        ```
