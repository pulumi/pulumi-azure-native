...
class VirtualMachineScaleSetExtensionArgs:
    def __init__(__self__, *,
        ...
        """
        VirtualMachineScaleSetExtensionArgs._configure(
    ...
    def _configure(
        ...
        if 'vmssExtensionName' in kwargs:
            vmss_extension_name = kwargs['vmssExtensionName']
        ...
        if vmss_extension_name is not None:
            _setter("vmss_extension_name", vmss_extension_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            VirtualMachineScaleSetExtensionArgs._configure(_setter, **kwargs)
