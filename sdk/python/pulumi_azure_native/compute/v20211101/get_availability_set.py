...
def get_availability_set(availability_set_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_availability_set is deprecated: azure-native:compute/v20211101:AvailabilitySet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:AvailabilitySet to guarantee forwards compatibility.""")
    __args__ = dict()
