...
class GetVirtualMachineResult:
    ...
    """
    def __init__(__self__, additional_capabilities=None, application_profile=None, availability_set=None, azure_api_version=None, billing_profile=None, capacity_reservation=None, diagnostics_profile=None, etag=None, eviction_policy=None, extended_location=None, extensions_time_budget=None, hardware_profile=None, host=None, host_group=None, id=None, identity=None, instance_view=None, license_type=None, location=None, managed_by=None, name=None, network_profile=None, os_profile=None, plan=None, platform_fault_domain=None, priority=None, provisioning_state=None, proximity_placement_group=None, resources=None, scheduled_events_policy=None, scheduled_events_profile=None, security_profile=None, storage_profile=None, tags=None, time_created=None, type=None, user_data=None, virtual_machine_scale_set=None, vm_id=None, zones=None):
...
def get_virtual_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult).value
