...
class AwaitableGetGalleryScriptVersionResult(GetGalleryScriptVersionResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetGalleryScriptVersionResult(
...
def get_gallery_script_version(gallery_name: Optional[_builtins.str] = None,
                               gallery_script_name: Optional[_builtins.str] = None,
                               gallery_script_version_name: Optional[_builtins.str] = None,
                               resource_group_name: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGalleryScriptVersionResult:
    """
    ...
    __args__['galleryScriptVersionName'] = gallery_script_version_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute:getGalleryScriptVersion', __args__, opts=opts, typ=GetGalleryScriptVersionResult).value

    return AwaitableGetGalleryScriptVersionResult(
...
def get_gallery_script_version_output(gallery_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute:getGalleryScriptVersion', __args__, opts=opts, typ=GetGalleryScriptVersionResult)
    return __ret__.apply(lambda __response__: GetGalleryScriptVersionResult(
