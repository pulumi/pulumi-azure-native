...
if not MYPY:
    class AutomaticZoneRebalancingPolicyArgsDict(TypedDict):
        ...
        """
        rebalance_behavior: NotRequired[pulumi.Input[Union[str, 'RebalanceBehavior']]]
        """
        ...
        """
        rebalance_strategy: NotRequired[pulumi.Input[Union[str, 'RebalanceStrategy']]]
        """
...
class AutomaticZoneRebalancingPolicyArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 rebalance_behavior: Optional[pulumi.Input[Union[str, 'RebalanceBehavior']]] = None,
                 rebalance_strategy: Optional[pulumi.Input[Union[str, 'RebalanceStrategy']]] = None):
        """
        The configuration parameters used while performing automatic AZ balancing.
        :param pulumi.Input[bool] enabled: Specifies whether Automatic AZ Balancing should be enabled on the virtual machine scale set. The default value is false.
        :param pulumi.Input[Union[str, 'RebalanceBehavior']] rebalance_behavior: Type of rebalance behavior that will be used for recreating virtual machines in the scale set across availability zones. Default and only supported value for now is CreateBeforeDelete.
        :param pulumi.Input[Union[str, 'RebalanceStrategy']] rebalance_strategy: Type of rebalance strategy that will be used for rebalancing virtual machines in the scale set across availability zones. Default and only supported value for now is Recreate.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def rebalance_behavior(self) -> Optional[pulumi.Input[Union[str, 'RebalanceBehavior']]]:
        """
        Type of rebalance behavior that will be used for recreating virtual machines in the scale set across availability zones. Default and only supported value for now is CreateBeforeDelete.
        """
    ...
    def rebalance_behavior(self, value: Optional[pulumi.Input[Union[str, 'RebalanceBehavior']]]):
        pulumi.set(self, "rebalance_behavior", value)

    @property
    @pulumi.getter(name="rebalanceStrategy")
    def rebalance_strategy(self) -> Optional[pulumi.Input[Union[str, 'RebalanceStrategy']]]:
        """
        Type of rebalance strategy that will be used for rebalancing virtual machines in the scale set across availability zones. Default and only supported value for now is Recreate.
        """
    ...
    def rebalance_strategy(self, value: Optional[pulumi.Input[Union[str, 'RebalanceStrategy']]]):
...
class EventGridAndResourceGraphArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies eventGridAndResourceGraph related Scheduled Event related configurations.
        :param pulumi.Input[bool] enable: Specifies if event grid and resource graph is enabled for Scheduled event related configurations.
        """
...
if not MYPY:
    class HostEndpointSettingsArgsDict(TypedDict):
        ...
        """
        in_vm_access_control_profile_reference_id: NotRequired[pulumi.Input[str]]
        """
        ...
        """
        mode: NotRequired[pulumi.Input[Union[str, 'Modes']]]
        """
...
class HostEndpointSettingsArgs:
    def __init__(__self__, *,
                 in_vm_access_control_profile_reference_id: Optional[pulumi.Input[str]] = None,
                 mode: Optional[pulumi.Input[Union[str, 'Modes']]] = None):
        """
        Specifies particular host endpoint settings.
        :param pulumi.Input[str] in_vm_access_control_profile_reference_id: Specifies the InVMAccessControlProfileVersion resource id in the format of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/inVMAccessControlProfiles/{profile}/versions/{version}
        :param pulumi.Input[Union[str, 'Modes']] mode: Specifies the execution mode. In Audit mode, the system acts as if it is enforcing the access control policy, including emitting access denial entries in the logs but it does not actually deny any requests to host endpoints. In Enforce mode, the system will enforce the access control and it is the recommended mode of operation.
        """
    ...
    def in_vm_access_control_profile_reference_id(self) -> Optional[pulumi.Input[str]]:
        """
        Specifies the InVMAccessControlProfileVersion resource id in the format of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/inVMAccessControlProfiles/{profile}/versions/{version}
        """
    ...
    def in_vm_access_control_profile_reference_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "in_vm_access_control_profile_reference_id", value)

    @property
    @pulumi.getter
    def mode(self) -> Optional[pulumi.Input[Union[str, 'Modes']]]:
        """
        Specifies the execution mode. In Audit mode, the system acts as if it is enforcing the access control policy, including emitting access denial entries in the logs but it does not actually deny any requests to host endpoints. In Enforce mode, the system will enforce the access control and it is the recommended mode of operation.
        """
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input[Union[str, 'Modes']]]):
...
if not MYPY:
    class PlacementArgsDict(TypedDict):
        ...
        """
        exclude_zones: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        ...
        """
        include_zones: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        ...
        """
        zone_placement_policy: NotRequired[pulumi.Input[Union[str, 'ZonePlacementPolicyType']]]
        """
...
class PlacementArgs:
    def __init__(__self__, *,
                 exclude_zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 include_zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 zone_placement_policy: Optional[pulumi.Input[Union[str, 'ZonePlacementPolicyType']]] = None):
        """
        Describes the user-defined constraints for virtual machine hardware placement.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] exclude_zones: This property supplements the 'zonePlacementPolicy' property. If 'zonePlacementPolicy' is set to 'Any', availability zone selected by the system must not be present in the list of availability zones passed with 'excludeZones'. If 'excludeZones' is not provided, all availability zones in region will be considered for selection.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] include_zones: This property supplements the 'zonePlacementPolicy' property. If 'zonePlacementPolicy' is set to 'Any', availability zone selected by the system must be present in the list of availability zones passed with 'includeZones'. If 'includeZones' is not provided, all availability zones in region will be considered for selection.
        :param pulumi.Input[Union[str, 'ZonePlacementPolicyType']] zone_placement_policy: Specifies the policy for virtual machine's placement in availability zone. Possible values are: **Any** - An availability zone will be automatically picked by system as part of virtual machine creation.
        """
    ...
    def exclude_zones(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        This property supplements the 'zonePlacementPolicy' property. If 'zonePlacementPolicy' is set to 'Any', availability zone selected by the system must not be present in the list of availability zones passed with 'excludeZones'. If 'excludeZones' is not provided, all availability zones in region will be considered for selection.
        """
    ...
    def exclude_zones(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "exclude_zones", value)

    @property
    @pulumi.getter(name="includeZones")
    def include_zones(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        This property supplements the 'zonePlacementPolicy' property. If 'zonePlacementPolicy' is set to 'Any', availability zone selected by the system must be present in the list of availability zones passed with 'includeZones'. If 'includeZones' is not provided, all availability zones in region will be considered for selection.
        """
    ...
    def include_zones(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "include_zones", value)

    @property
    @pulumi.getter(name="zonePlacementPolicy")
    def zone_placement_policy(self) -> Optional[pulumi.Input[Union[str, 'ZonePlacementPolicyType']]]:
        """
        Specifies the policy for virtual machine's placement in availability zone. Possible values are: **Any** - An availability zone will be automatically picked by system as part of virtual machine creation.
        """
    ...
    def zone_placement_policy(self, value: Optional[pulumi.Input[Union[str, 'ZonePlacementPolicyType']]]):
...
class ProxyAgentSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] key_incarnation_id: Increase the value of this property allows users to reset the key used for securing communication channel between guest and host.
        :param pulumi.Input[Union[str, 'Mode']] mode: Specifies the mode that ProxyAgent will execute on. Warning: this property has been deprecated, please specify 'mode' under particular hostendpoint setting.
...
if not MYPY:
    class ScaleInPolicyArgsDict(TypedDict):
        ...
        """
        prioritize_unhealthy_vms: NotRequired[pulumi.Input[bool]]
        """
...
class ScaleInPolicyArgs:
    def __init__(__self__, *,
                 ...
                 prioritize_unhealthy_vms: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] prioritize_unhealthy_vms: This property allows you to prioritize the deletion of unhealthy and inactive VMs when a virtual machine scale set is being scaled-in.(Feature in Preview)
    ...
    def prioritize_unhealthy_vms(self) -> Optional[pulumi.Input[bool]]:
        """
        This property allows you to prioritize the deletion of unhealthy and inactive VMs when a virtual machine scale set is being scaled-in.(Feature in Preview)
        """
    ...
    def prioritize_unhealthy_vms(self, value: Optional[pulumi.Input[bool]]):
...
class SkuProfileVMSizeArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the VM Size.
        :param pulumi.Input[str] name: Specifies the name of the VM Size.
        :param pulumi.Input[int] rank: Specifies the rank (a.k.a priority) associated with the VM Size.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if rank is not None:
...
if not MYPY:
    class SkuProfileArgsDict(TypedDict):
        ...
        """
        allocation_strategy: NotRequired[pulumi.Input[Union[str, 'AllocationStrategy']]]
        """
...
class SkuProfileArgs:
    def __init__(__self__, *,
                 allocation_strategy: Optional[pulumi.Input[Union[str, 'AllocationStrategy']]] = None,
                 vm_sizes: Optional[pulumi.Input[Sequence[pulumi.Input['SkuProfileVMSizeArgs']]]] = None):
        """
        Specifies the sku profile for the virtual machine scale set. With this property the customer is able to specify a list of VM sizes and an allocation strategy.
        :param pulumi.Input[Union[str, 'AllocationStrategy']] allocation_strategy: Specifies the allocation strategy for the virtual machine scale set based on which the VMs will be allocated.
    ...
    def allocation_strategy(self) -> Optional[pulumi.Input[Union[str, 'AllocationStrategy']]]:
        """
        Specifies the allocation strategy for the virtual machine scale set based on which the VMs will be allocated.
        """
    ...
    def allocation_strategy(self, value: Optional[pulumi.Input[Union[str, 'AllocationStrategy']]]):
...
if not MYPY:
    class StorageProfileArgsDict(TypedDict):
        ...
        """
        align_regional_disks_to_vm_zone: NotRequired[pulumi.Input[bool]]
        """
...
class StorageProfileArgs:
    def __init__(__self__, *,
                 align_regional_disks_to_vm_zone: Optional[pulumi.Input[bool]] = None,
        ...
        """
        Specifies the storage settings for the virtual machine disks.
        :param pulumi.Input[bool] align_regional_disks_to_vm_zone: Specifies whether the regional disks should be aligned/moved to the VM zone. This is applicable only for VMs with placement property set. Please note that this change is irreversible. Minimum api-version: 2024-11-01.
    ...
    def align_regional_disks_to_vm_zone(self) -> Optional[pulumi.Input[bool]]:
        """
        Specifies whether the regional disks should be aligned/moved to the VM zone. This is applicable only for VMs with placement property set. Please note that this change is irreversible. Minimum api-version: 2024-11-01.
        """
    ...
    def align_regional_disks_to_vm_zone(self, value: Optional[pulumi.Input[bool]]):
...
if not MYPY:
    class UserInitiatedRebootArgsDict(TypedDict):
        ...
        """
        automatically_approve: NotRequired[pulumi.Input[bool]]
        """
...
class UserInitiatedRebootArgs:
    def __init__(__self__, *,
                 automatically_approve: Optional[pulumi.Input[bool]] = None):
        """
        Specifies Reboot related Scheduled Event related configurations.
        :param pulumi.Input[bool] automatically_approve: Specifies Reboot Scheduled Event related configurations.
        """
    ...
    def automatically_approve(self) -> Optional[pulumi.Input[bool]]:
        """
        Specifies Reboot Scheduled Event related configurations.
        """
    ...
    def automatically_approve(self, value: Optional[pulumi.Input[bool]]):
...
class UserInitiatedRedeployArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies Redeploy related Scheduled Event related configurations.
        :param pulumi.Input[bool] automatically_approve: Specifies Redeploy Scheduled Event related configurations.
        """
        if automatically_approve is not None:
            pulumi.set(__self__, "automatically_approve", automatically_approve)
...
class VirtualMachineScaleSetNetworkProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'NetworkApiVersion']] network_api_version: Specifies the Microsoft.Network API version used when creating networking resources in the Network Interface Configurations for Virtual Machine Scale Set with orchestration mode 'Flexible'. For support of all network properties, use '2022-11-01'.
