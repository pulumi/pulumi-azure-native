...
class PlacementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ZonePlacementPolicyType']] zone_placement_policy: Specifies the policy for virtual machine's placement in availability zone. Possible values are: **Any** - An availability zone will be automatically picked by system as part of virtual machine creation.
        """
...
class VirtualMachineRunCommandScriptSourceArgs:
    def __init__(__self__, *,
        ...
        """
        Describes the script sources for run command. Use only one of script, scriptUri, commandId.
        :param pulumi.Input[_builtins.str] command_id: Specifies a commandId of predefined built-in script.
