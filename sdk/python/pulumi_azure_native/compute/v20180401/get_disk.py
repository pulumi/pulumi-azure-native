...
azure-native:compute/v20180401:Disk is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20180601:Disk to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_disk(disk_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk is deprecated: Version 2018-04-01 will be removed in v2 of the provider.
azure-native:compute/v20180401:Disk is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20180601:Disk to guarantee forwards compatibility.""")
    __args__ = dict()
