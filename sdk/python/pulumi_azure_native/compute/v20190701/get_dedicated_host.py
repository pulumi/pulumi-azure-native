...
azure-native:compute/v20190701:DedicatedHost is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHost to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_dedicated_host(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dedicated_host is deprecated: Version 2019-07-01 will be removed in v2 of the provider.
azure-native:compute/v20190701:DedicatedHost is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHost to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20190701:getDedicatedHost', __args__, opts=opts, typ=GetDedicatedHostResult).value
