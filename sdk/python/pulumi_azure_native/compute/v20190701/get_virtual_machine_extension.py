...
azure-native:compute/v20190701:VirtualMachineExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:VirtualMachineExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_machine_extension(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_extension is deprecated: Version 2019-07-01 will be removed in v2 of the provider.
azure-native:compute/v20190701:VirtualMachineExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:VirtualMachineExtension to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20190701:getVirtualMachineExtension', __args__, opts=opts, typ=GetVirtualMachineExtensionResult).value
