...
def get_gallery_application(gallery_application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery_application is deprecated: Version v20190701 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
