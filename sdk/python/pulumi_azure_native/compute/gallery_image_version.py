...
class GalleryImageVersionArgs:
    def __init__(__self__, *,
                 gallery_image_name: pulumi.Input[builtins.str],
    ...
    def gallery_image_name(self, value: pulumi.Input[builtins.str]):
    ...
    def gallery_image_version_name(self, value: Optional[pulumi.Input[builtins.str]]):
