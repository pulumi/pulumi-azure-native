...
class GetAvailabilitySetResult:
    ...
    """
    def __init__(__self__, id=None, location=None, name=None, platform_fault_domain_count=None, platform_update_domain_count=None, proximity_placement_group=None, scheduled_events_policy=None, sku=None, statuses=None, tags=None, type=None, virtual_machine_scale_set_migration_info=None, virtual_machines=None):
...
def get_availability_set(availability_set_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20241101:getAvailabilitySet', __args__, opts=opts, typ=GetAvailabilitySetResult).value
...
def get_availability_set_output(availability_set_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20241101:getAvailabilitySet', __args__, opts=opts, typ=GetAvailabilitySetResult)
