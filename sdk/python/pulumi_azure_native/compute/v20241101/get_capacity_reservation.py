...
def get_capacity_reservation(capacity_reservation_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20241101:getCapacityReservation', __args__, opts=opts, typ=GetCapacityReservationResult).value
...
def get_capacity_reservation_output(capacity_reservation_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20241101:getCapacityReservation', __args__, opts=opts, typ=GetCapacityReservationResult)
