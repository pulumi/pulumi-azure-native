...
def get_capacity_reservation_group(capacity_reservation_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20241101:getCapacityReservationGroup', __args__, opts=opts, typ=GetCapacityReservationGroupResult).value
...
def get_capacity_reservation_group_output(capacity_reservation_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20241101:getCapacityReservationGroup', __args__, opts=opts, typ=GetCapacityReservationGroupResult)
