...
def get_dedicated_host(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20241101:getDedicatedHost', __args__, opts=opts, typ=GetDedicatedHostResult).value
...
def get_dedicated_host_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20241101:getDedicatedHost', __args__, opts=opts, typ=GetDedicatedHostResult)
