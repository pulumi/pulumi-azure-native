...
class AvailabilitySet(pulumi.CustomResource):
    ...
    def virtual_machine_scale_set_migration_info(self) -> pulumi.Output['outputs.VirtualMachineScaleSetMigrationInfoResponse']:
        """
