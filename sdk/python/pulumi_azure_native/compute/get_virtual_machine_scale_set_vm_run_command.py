...
def get_virtual_machine_scale_set_vm_run_command(expand: Optional[_builtins.str] = None,
                                                 instance_id: Optional[_builtins.str] = None,
                                                 resource_group_name: Optional[_builtins.str] = None,
                                                 run_command_name: Optional[_builtins.str] = None,
                                                 vm_scale_set_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance_id: The name of the VirtualMachineScaleSetVM
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str run_command_name: The name of the VirtualMachineRunCommand
    :param _builtins.str vm_scale_set_name: The name of the VirtualMachineScaleSet
    """
    __args__ = dict()
