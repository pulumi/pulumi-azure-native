...
def get_ssh_public_key(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ssh_public_key is deprecated: azure-native:compute/v20220301:SshPublicKey is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:SshPublicKey to guarantee forwards compatibility.""")
    __args__ = dict()
