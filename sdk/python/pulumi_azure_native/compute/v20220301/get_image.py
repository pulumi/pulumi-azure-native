...
def get_image(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_image is deprecated: azure-native:compute/v20220301:Image is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:Image to guarantee forwards compatibility.""")
    __args__ = dict()
