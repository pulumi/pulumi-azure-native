...
warnings.warn("""azure-native:compute/v20220301:VirtualMachine is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachine to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine is deprecated: azure-native:compute/v20220301:VirtualMachine is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachine to guarantee forwards compatibility.""")
    __args__ = dict()
