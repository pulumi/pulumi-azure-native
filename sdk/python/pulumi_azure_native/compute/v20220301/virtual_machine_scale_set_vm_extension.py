...
class VirtualMachineScaleSetVMExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_scale_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachineScaleSetVMExtension is deprecated: azure-native:compute/v20220301:VirtualMachineScaleSetVMExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVMExtension to guarantee forwards compatibility.""")
