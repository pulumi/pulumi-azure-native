...
warnings.warn("""azure-native:compute/v20220301:RestorePointCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:RestorePointCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_restore_point_collection(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_restore_point_collection is deprecated: azure-native:compute/v20220301:RestorePointCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:RestorePointCollection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['restorePointCollectionName'] = restore_point_collection_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20220301:getRestorePointCollection', __args__, opts=opts, typ=GetRestorePointCollectionResult).value
