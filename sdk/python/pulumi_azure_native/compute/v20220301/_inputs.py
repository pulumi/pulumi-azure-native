...
class VirtualMachineScaleSetHardwareProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VMSizePropertiesArgs'] vm_size_properties: Specifies the properties for customizing the size of the virtual machine. Minimum api-version: 2022-03-01. <br><br> Please follow the instructions in [VM Customization](https://aka.ms/vmcustomization) for more details.
        """
        if vm_size_properties is not None:
            pulumi.set(__self__, "vm_size_properties", vm_size_properties)
...
class VirtualMachineScaleSetVMProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VirtualMachineScaleSetHardwareProfileArgs'] hardware_profile: Specifies the hardware profile related details of a scale set. <br><br>Minimum api-version: 2022-03-01.
