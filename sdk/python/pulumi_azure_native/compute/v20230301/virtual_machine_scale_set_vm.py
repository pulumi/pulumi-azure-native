...
class VirtualMachineScaleSetVM(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_scale_set_vm = azure_native.compute.v20230301.VirtualMachineScaleSetVM("virtualMachineScaleSetVM",
            additional_capabilities=azure_native.compute.v20230301.AdditionalCapabilitiesArgs(
                hibernation_enabled=True,
                ultra_ssd_enabled=True,
            ),
            availability_set=azure_native.compute.v20230301.SubResourceArgs(
                id="/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
            ),
            diagnostics_profile=azure_native.compute.v20230301.DiagnosticsProfileResponseArgs(
                boot_diagnostics=azure_native.compute.v20230301.BootDiagnosticsArgs(
                    enabled=True,
                    storage_uri="aaaaaaaaaaaaa",
                ),
            ),
            hardware_profile=azure_native.compute.v20230301.HardwareProfileResponseArgs(
                vm_size="Basic_A0",
                vm_size_properties=azure_native.compute.v20230301.VMSizePropertiesArgs(
                    v_cpus_available=9,
                    v_cpus_per_core=12,
                ),
            ),
            ...
            location="westus",
            network_profile=azure_native.compute.v20230301.NetworkProfileResponseArgs(
                network_api_version="2020-11-01",
                network_interface_configurations=[{
                    "deleteOption": "Delete",
                    "dnsSettings": azure_native.compute.v20230301.VirtualMachineNetworkInterfaceDnsSettingsConfigurationArgs(
                        dns_servers=["aaaaaa"],
                    ),
                    "dscpConfiguration": azure_native.compute.v20230301.SubResourceArgs(
                        id="/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
                    ),
                    ...
                    "ipConfigurations": [{
                        ...
                        "applicationSecurityGroups": [azure_native.compute.v20230301.SubResourceArgs(
                            id="/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
                        )],
                        ...
                        "publicIPAddressConfiguration": {
                            "deleteOption": "Delete",
                            "dnsSettings": azure_native.compute.v20230301.VirtualMachinePublicIPAddressDnsSettingsConfigurationArgs(
                                domain_name_label="aaaaaaaaaaaaaaaaaaaaaaaaa",
                            ),
                            "idleTimeoutInMinutes": 2,
                            "ipTags": [azure_native.compute.v20230301.VirtualMachineIpTagArgs(
                            ...
                            "publicIPPrefix": azure_native.compute.v20230301.SubResourceArgs(
                                id="/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
                            ),
                            "sku": azure_native.compute.v20230301.PublicIPAddressSkuArgs(
                                name="Basic",
                                tier="Regional",
                            ),
                        },
                        "subnet": azure_native.compute.v20230301.SubResourceArgs(
                            id="/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
                        ),
                    }],
                    "name": "aaaaaaaaaaa",
                    "networkSecurityGroup": azure_native.compute.v20230301.SubResourceArgs(
                        id="/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
                    ),
                    "primary": True,
                }],
                network_interfaces=[azure_native.compute.v20230301.NetworkInterfaceReferenceArgs(
                    delete_option="Delete",
                    id="/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/virtualMachineScaleSets/{vmss-name}/virtualMachines/0/networkInterfaces/vmsstestnetconfig5415",
                    primary=True,
                )],
            ),
            network_profile_configuration=azure_native.compute.v20230301.VirtualMachineScaleSetVMNetworkProfileConfigurationResponseArgs(
                network_interface_configurations=[{
                    "deleteOption": "Delete",
                    "dnsSettings": azure_native.compute.v20230301.VirtualMachineScaleSetNetworkConfigurationDnsSettingsArgs(
                        dns_servers=[],
                    ),
                    "enableAcceleratedNetworking": True,
                    "enableFpga": True,
                    ...
                    "ipConfigurations": [{
                        ...
                        "publicIPAddressConfiguration": {
                            "deleteOption": "Delete",
                            "dnsSettings": azure_native.compute.v20230301.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsArgs(
                                domain_name_label="aaaaaaaaaaaaaaaaaa",
                            ),
                            "idleTimeoutInMinutes": 18,
                            "ipTags": [azure_native.compute.v20230301.VirtualMachineScaleSetIpTagArgs(
                                ip_tag_type="aaaaaaa",
            ...
            os_profile=azure_native.compute.v20230301.OSProfileResponseArgs(
                ...
                linux_configuration={
                    ...
                    "patchSettings": azure_native.compute.v20230301.LinuxPatchSettingsArgs(
                ...
                windows_configuration={
                    "additionalUnattendContent": [azure_native.compute.v20230301.AdditionalUnattendContentArgs(
                        component_name=azure_native.compute/v20230301.ComponentNames.MICROSOFT_WINDOWS_SHELL_SETUP,
                        content="aaaaaaaaaaaaaaaaaaaa",
                        pass_name=azure_native.compute/v20230301.PassNames.OOBE_SYSTEM,
                        setting_name=azure_native.compute/v20230301.SettingNames.AUTO_LOGON,
                    )],
                    "enableAutomaticUpdates": True,
                    "patchSettings": azure_native.compute.v20230301.PatchSettingsArgs(
                        assessment_mode="ImageDefault",
                    ...
                    "winRM": {
                        "listeners": [azure_native.compute.v20230301.WinRMListenerArgs(
            ...
            protection_policy=azure_native.compute.v20230301.VirtualMachineScaleSetVMProtectionPolicyArgs(
                protect_from_scale_in=True,
                protect_from_scale_set_actions=True,
            ),
            resource_group_name="rgcompute",
            security_profile=azure_native.compute.v20230301.SecurityProfileResponseArgs(
                encryption_at_host=True,
                security_type="TrustedLaunch",
                uefi_settings=azure_native.compute.v20230301.UefiSettingsArgs(
                    secure_boot_enabled=True,
                    v_tpm_enabled=True,
                ),
            ),
            storage_profile=azure_native.compute.v20230301.StorageProfileResponseArgs(
                data_disks=[{
                    ...
                    "toBeDetached": True,
                    "vhd": azure_native.compute.v20230301.VirtualHardDiskArgs(
                        uri="https://{storageAccountName}.blob.core.windows.net/{containerName}/{vhdName}.vhd",
                    ),
                    "writeAcceleratorEnabled": True,
                }],
                image_reference=azure_native.compute.v20230301.ImageReferenceArgs(
                    id="a",
                    offer="WindowsServer",
    ...
    def _internal_init(__self__,
        ...
        super(VirtualMachineScaleSetVM, __self__).__init__(
            'azure-native:compute/v20230301:VirtualMachineScaleSetVM',
            resource_name,
            __props__,
            opts)
