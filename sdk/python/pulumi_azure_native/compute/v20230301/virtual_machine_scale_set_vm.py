...
class VirtualMachineScaleSetVM(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(network_profile_configuration, VirtualMachineScaleSetVMNetworkProfileConfigurationArgs):
            ...
            if not isinstance(protection_policy, VirtualMachineScaleSetVMProtectionPolicyArgs):
