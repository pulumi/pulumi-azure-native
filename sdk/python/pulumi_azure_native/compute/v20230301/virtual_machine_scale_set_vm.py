...
class VirtualMachineScaleSetVMArgs:
    ...
    def _configure(
        ...
        if network_profile_configuration is None and 'networkProfileConfiguration' in kwargs:
            network_profile_configuration = kwargs['networkProfileConfiguration']
        if os_profile is None and 'osProfile' in kwargs:
            os_profile = kwargs['osProfile']
        if protection_policy is None and 'protectionPolicy' in kwargs:
            protection_policy = kwargs['protectionPolicy']
...
class VirtualMachineScaleSetVM(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            network_profile_configuration = _utilities.configure(network_profile_configuration, VirtualMachineScaleSetVMNetworkProfileConfigurationArgs, True)
            ...
            protection_policy = _utilities.configure(protection_policy, VirtualMachineScaleSetVMProtectionPolicyArgs, True)
