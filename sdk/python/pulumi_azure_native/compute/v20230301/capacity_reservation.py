...
class CapacityReservationArgs:
    ...
    def _configure(
        ...
        if capacity_reservation_group_name is None:
            raise TypeError("Missing 'capacity_reservation_group_name' argument")
