...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_scale_set_extension = azure_native.compute.v20230301.VirtualMachineScaleSetExtension("virtualMachineScaleSetExtension",
    ...
    def _internal_init(__self__,
        ...
        super(VirtualMachineScaleSetExtension, __self__).__init__(
            'azure-native:compute/v20230301:VirtualMachineScaleSetExtension',
            resource_name,
            __props__,
            opts)
