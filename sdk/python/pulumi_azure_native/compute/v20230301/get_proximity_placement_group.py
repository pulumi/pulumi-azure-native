...
def get_proximity_placement_group(include_colocation_status: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20230301:getProximityPlacementGroup', __args__, opts=opts, typ=GetProximityPlacementGroupResult).value
...
def get_proximity_placement_group_output(include_colocation_status: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20230301:getProximityPlacementGroup', __args__, opts=opts, typ=GetProximityPlacementGroupResult)
