...
class CapacityReservationGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        capacity_reservation_group = azure_native.compute.v20230301.CapacityReservationGroup("capacityReservationGroup",
        ...
        ```sh
        $ pulumi import azure-native:compute/v20230301:CapacityReservationGroup myCapacityReservationGroup /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/CapacityReservationGroups/myCapacityReservationGroup 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(CapacityReservationGroup, __self__).__init__(
            'azure-native:compute/v20230301:CapacityReservationGroup',
            resource_name,
            __props__,
            opts)
