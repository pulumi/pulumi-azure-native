...
class VirtualMachineScaleSetVMExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_scale_set_vm_extension = azure_native.compute.v20230301.VirtualMachineScaleSetVMExtension("virtualMachineScaleSetVMExtension",
        ...
        ```sh
        $ pulumi import azure-native:compute/v20230301:VirtualMachineScaleSetVMExtension myVMExtension /subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/virtualMachineScaleSets/myvmScaleSet/virtualMachines/0/extensions/myVMExtension 
        ```
