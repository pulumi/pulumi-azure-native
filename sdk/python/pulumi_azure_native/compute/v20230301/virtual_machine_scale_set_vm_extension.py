...
class VirtualMachineScaleSetVMExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(instance_view, VirtualMachineExtensionInstanceViewArgs):
            ...
            if not isinstance(protected_settings_from_key_vault, KeyVaultSecretReferenceArgs):
