...
class VirtualMachineScaleSetVMExtensionArgs:
    def __init__(__self__, *,
        ...
        """
        VirtualMachineScaleSetVMExtensionArgs._configure(
    ...
    def _configure(
        ...
        if 'vmExtensionName' in kwargs:
            vm_extension_name = kwargs['vmExtensionName']
        ...
        if vm_extension_name is not None:
            _setter("vm_extension_name", vm_extension_name)
...
class VirtualMachineScaleSetVMExtension(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            VirtualMachineScaleSetVMExtensionArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if instance_view is not None and not isinstance(instance_view, VirtualMachineExtensionInstanceViewArgs):
                instance_view = instance_view or {}
                def _setter(key, value):
                    instance_view[key] = value
                VirtualMachineExtensionInstanceViewArgs._configure(_setter, **instance_view)
            __props__.__dict__["instance_view"] = instance_view
            __props__.__dict__["location"] = location
            __props__.__dict__["protected_settings"] = protected_settings
            if protected_settings_from_key_vault is not None and not isinstance(protected_settings_from_key_vault, KeyVaultSecretReferenceArgs):
                protected_settings_from_key_vault = protected_settings_from_key_vault or {}
                def _setter(key, value):
                    protected_settings_from_key_vault[key] = value
                KeyVaultSecretReferenceArgs._configure(_setter, **protected_settings_from_key_vault)
        ...
        super(VirtualMachineScaleSetVMExtension, __self__).__init__(
            'azure-native:compute/v20230301:VirtualMachineScaleSetVMExtension',
            resource_name,
            __props__,
            opts)
