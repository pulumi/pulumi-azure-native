...
class SshPublicKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ssh_public_key = azure_native.compute.v20230301.SshPublicKey("sshPublicKey",
            location="westus",
        ...
        ```sh
        $ pulumi import azure-native:compute/v20230301:SshPublicKey mySshPublicKeyName /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/sshPublicKeys/mySshPublicKeyName 
        ```
