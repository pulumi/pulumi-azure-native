...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            location="westus",
            overprovision=True,
            resource_group_name="myResourceGroup",
            sku=azure_native.compute.v20230301.SkuArgs(
                capacity=3,
                name="Standard_D1_v2",
                tier="Standard",
            ),
            upgrade_policy=azure_native.compute.v20230301.UpgradePolicyArgs(
                mode=azure_native.compute/v20230301.UpgradeMode.MANUAL,
            ),
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                diagnostics_profile={
                    "bootDiagnostics": azure_native.compute.v20230301.BootDiagnosticsArgs(
                        enabled=True,
                        storage_uri="http://{existing-storage-account-name}.blob.core.windows.net",
                    ),
                },
                extension_profile={
                    "extensions": [azure_native.compute.v20230301.VirtualMachineScaleSetExtensionArgs(
                ...
                network_profile={
                    "networkInterfaceConfigurations": [{
                        ...
                        "ipConfigurations": [{
                            "name": "{vmss-name}",
                            "subnet": azure_native.compute.v20230301.ApiEntityReferenceArgs(
                ...
                os_profile=azure_native.compute.v20230301.VirtualMachineScaleSetOSProfileArgs(
                    admin_password="{your-password}",
                    admin_username="{your-username}",
                    computer_name_prefix="{vmss-name}",
                ),
                storage_profile={
                    "imageReference": azure_native.compute.v20230301.ImageReferenceArgs(
                        offer="WindowsServer",
                    ...
                    "osDisk": {
                        "caching": azure_native.compute/v20230301.CachingTypes.READ_WRITE,
                        "createOption": "FromImage",
                        "managedDisk": azure_native.compute.v20230301.VirtualMachineScaleSetManagedDiskParametersArgs(
                ...
                extension_profile={
                    "extensions": [{
                        ...
                        "protectedSettingsFromKeyVault": {
                            ...
                            "sourceVault": azure_native.compute.v20230301.SubResourceArgs(
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                storage_profile={
                    "osDisk": {
                        "caching": azure_native.compute/v20230301.CachingTypes.READ_WRITE,
                        "createOption": "FromImage",
                        "image": azure_native.compute.v20230301.VirtualHardDiskArgs(
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                storage_profile={
                    ...
                    "osDisk": azure_native.compute.v20230301.VirtualMachineScaleSetOSDiskArgs(
                        caching=azure_native.compute/v20230301.CachingTypes.READ_WRITE,
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                application_profile={
                    "galleryApplications": [
                        azure_native.compute.v20230301.VMGalleryApplicationArgs(
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                hardware_profile={
                    "vmSizeProperties": azure_native.compute.v20230301.VMSizePropertiesArgs(
                        v_cpus_available=1,
                        v_cpus_per_core=1,
                    ),
                },
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                storage_profile={
                    "dataDisks": [{
                        ...
                        "lun": 0,
                        "managedDisk": {
                            "diskEncryptionSet": azure_native.compute.v20230301.DiskEncryptionSetParametersArgs(
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            location="westus",
            overprovision=True,
            plan=azure_native.compute.v20230301.PlanArgs(
                name="windows2016",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                security_profile=azure_native.compute.v20230301.SecurityProfileArgs(
                ...
                storage_profile={
                    ...
                    "osDisk": {
                        "caching": azure_native.compute/v20230301.CachingTypes.READ_ONLY,
                        "createOption": "FromImage",
                        "managedDisk": azure_native.compute.v20230301.VirtualMachineScaleSetManagedDiskParametersArgs(
                            storage_account_type="Standard_LRS",
                        ),
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                scheduled_events_profile={
                    "osImageNotificationProfile": azure_native.compute.v20230301.OSImageNotificationProfileArgs(
                        enable=True,
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            upgrade_policy=azure_native.compute.v20230301.UpgradePolicyResponseArgs(
                automatic_os_upgrade_policy=azure_native.compute.v20230301.AutomaticOSUpgradePolicyArgs(
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                security_posture_reference=azure_native.compute.v20230301.SecurityPostureReferenceArgs(
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                security_profile={
                    ...
                    "uefiSettings": azure_native.compute.v20230301.UefiSettingsArgs(
                ...
                storage_profile={
                    ...
                    "osDisk": {
                        ...
                        "createOption": "FromImage",
                        "managedDisk": {
                            "securityProfile": azure_native.compute.v20230301.VMDiskSecurityProfileArgs(
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                service_artifact_reference=azure_native.compute.v20230301.ServiceArtifactReferenceArgs(
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                network_profile={
                    "networkInterfaceConfigurations": [{
                        "enableIPForwarding": True,
                        "ipConfigurations": [{
                            "applicationGatewayBackendAddressPools": [azure_native.compute.v20230301.SubResourceArgs(
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                network_profile={
                    "networkInterfaceConfigurations": [{
                        "enableIPForwarding": True,
                        "ipConfigurations": [{
                            "loadBalancerBackendAddressPools": [azure_native.compute.v20230301.SubResourceArgs(
                                id="/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Network/loadBalancers/{existing-load-balancer-name}/backendAddressPools/{existing-backend-address-pool-name}",
                            )],
                            "loadBalancerInboundNatPools": [azure_native.compute.v20230301.SubResourceArgs(
                                id="/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Network/loadBalancers/{existing-load-balancer-name}/inboundNatPools/{existing-nat-pool-name}",
                            )],
                            "name": "{vmss-name}",
                            "publicIPAddressConfiguration": azure_native.compute.v20230301.VirtualMachineScaleSetPublicIPAddressConfigurationArgs(
                                name="{vmss-name}",
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            automatic_repairs_policy=azure_native.compute.v20230301.AutomaticRepairsPolicyArgs(
                enabled=True,
                grace_period="PT10M",
            ),
            location="westus",
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                storage_profile={
                    "dataDisks": [
                        azure_native.compute.v20230301.VirtualMachineScaleSetDataDiskArgs(
                            create_option="Empty",
                            disk_size_gb=1023,
                            lun=0,
                        ),
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                storage_profile={
                    ...
                    "osDisk": {
                        "caching": azure_native.compute/v20230301.CachingTypes.READ_ONLY,
                        "createOption": "FromImage",
                        "diffDiskSettings": azure_native.compute.v20230301.DiffDiskSettingsArgs(
                            option="Local",
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            priority_mix_policy=azure_native.compute.v20230301.PriorityMixPolicyArgs(
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                billing_profile=azure_native.compute.v20230301.BillingProfileArgs(
                    max_price=-1,
                ),
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            overprovision=True,
            resource_group_name="myResourceGroup",
            scale_in_policy=azure_native.compute.v20230301.ScaleInPolicyArgs(
                force_deletion=True,
                rules=["OldestVM"],
            ),
            sku=azure_native.compute.v20230301.SkuArgs(
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            spot_restore_policy=azure_native.compute.v20230301.SpotRestorePolicyArgs(
                enabled=True,
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                os_profile={
                    ...
                    "linuxConfiguration": {
                        ...
                        "ssh": {
                            "publicKeys": [azure_native.compute.v20230301.SshPublicKeyArgs(
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                ...
                scheduled_events_profile={
                    "terminateNotificationProfile": azure_native.compute.v20230301.TerminateNotificationProfileArgs(
                        enable=True,
        ...
        virtual_machine_scale_set = azure_native.compute.v20230301.VirtualMachineScaleSet("virtualMachineScaleSet",
            ...
            virtual_machine_profile=azure_native.compute.v20230301.VirtualMachineScaleSetVMProfileResponseArgs(
                capacity_reservation={
                    "capacityReservationGroup": azure_native.compute.v20230301.SubResourceArgs(
