...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(automatic_repairs_policy, AutomaticRepairsPolicyArgs):
            ...
            if not isinstance(identity, VirtualMachineScaleSetIdentityArgs):
            ...
            if not isinstance(priority_mix_policy, PriorityMixPolicyArgs):
            ...
            if not isinstance(scale_in_policy, ScaleInPolicyArgs):
            ...
            if not isinstance(spot_restore_policy, SpotRestorePolicyArgs):
            ...
            if not isinstance(upgrade_policy, UpgradePolicyArgs):
                upgrade_policy = upgrade_policy or {}
                def _setter(key, value):
                    upgrade_policy[key] = value
                UpgradePolicyArgs._configure(_setter, **upgrade_policy)
            __props__.__dict__["upgrade_policy"] = upgrade_policy
            if not isinstance(virtual_machine_profile, VirtualMachineScaleSetVMProfileArgs):
