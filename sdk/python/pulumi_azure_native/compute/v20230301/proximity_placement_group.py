...
class ProximityPlacementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        proximity_placement_group = azure_native.compute.v20230301.ProximityPlacementGroup("proximityPlacementGroup",
            intent=azure_native.compute.v20230301.ProximityPlacementGroupPropertiesIntentArgs(
                vm_sizes=[
                    "Basic_A0",
                    "Basic_A2",
                ],
