...
class ProximityPlacementGroupArgs:
    ...
    def _configure(
        ...
        if 'proximityPlacementGroupName' in kwargs:
            proximity_placement_group_name = kwargs['proximityPlacementGroupName']
        if 'proximityPlacementGroupType' in kwargs:
...
class ProximityPlacementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if colocation_status is not None and not isinstance(colocation_status, InstanceViewStatusArgs):
                colocation_status = colocation_status or {}
                def _setter(key, value):
                    colocation_status[key] = value
                InstanceViewStatusArgs._configure(_setter, **colocation_status)
            __props__.__dict__["colocation_status"] = colocation_status
            if intent is not None and not isinstance(intent, ProximityPlacementGroupPropertiesIntentArgs):
                intent = intent or {}
                def _setter(key, value):
                    intent[key] = value
                ProximityPlacementGroupPropertiesIntentArgs._configure(_setter, **intent)
