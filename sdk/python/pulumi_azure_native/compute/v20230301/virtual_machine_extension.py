...
class VirtualMachineExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_extension = azure_native.compute.v20230301.VirtualMachineExtension("virtualMachineExtension",
            auto_upgrade_minor_version=True,
            enable_automatic_upgrade=True,
            force_update_tag="a",
            instance_view=azure_native.compute.v20230301.VirtualMachineExtensionInstanceViewResponseArgs(
                name="aaaaaaaaaaaaaaaaa",
                statuses=[azure_native.compute.v20230301.InstanceViewStatusArgs(
                    code="aaaaaaaaaaaaaaaaaaaaaaa",
                    display_status="aaaaaa",
                    level=azure_native.compute/v20230301.StatusLevelTypes.INFO,
                    message="a",
                    time="2021-11-30T12:58:26.522Z",
                )],
                substatuses=[azure_native.compute.v20230301.InstanceViewStatusArgs(
                    code="aaaaaaaaaaaaaaaaaaaaaaa",
                    display_status="aaaaaa",
                    level=azure_native.compute/v20230301.StatusLevelTypes.INFO,
                    message="a",
    ...
    def _internal_init(__self__,
        ...
        super(VirtualMachineExtension, __self__).__init__(
            'azure-native:compute/v20230301:VirtualMachineExtension',
            resource_name,
            __props__,
            opts)
