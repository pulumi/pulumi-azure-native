...
class RestorePointCollectionArgs:
    def __init__(__self__, *,
        ...
        """
        RestorePointCollectionArgs._configure(
...
class RestorePointCollection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RestorePointCollectionArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if source is not None and not isinstance(source, RestorePointCollectionSourcePropertiesArgs):
                source = source or {}
                def _setter(key, value):
                    source[key] = value
                RestorePointCollectionSourcePropertiesArgs._configure(_setter, **source)
