...
class ProximityPlacementGroupArgs:
    def __init__(__self__, *,
                 ...
                 proximity_placement_group_type: Optional[pulumi.Input[Union[builtins.str, 'ProximityPlacementGroupType']]] = None,
    ...
    def proximity_placement_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def proximity_placement_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proximity_placement_group_name", value)

    @property
    @pulumi.getter(name="proximityPlacementGroupType")
    def proximity_placement_group_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'ProximityPlacementGroupType']]]:
        """
    ...
    def proximity_placement_group_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'ProximityPlacementGroupType']]]):
...
class ProximityPlacementGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="proximityPlacementGroupType")
    def proximity_placement_group_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the type of the proximity placement group. Possible values are: **Standard** : Co-locate resources within an Azure region or Availability Zone. **Ultra** : For future use.
        """
        return pulumi.get(self, "proximity_placement_group_type")
