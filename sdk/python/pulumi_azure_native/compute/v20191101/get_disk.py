...
def get_disk(disk_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk is deprecated: Version v20191101 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
