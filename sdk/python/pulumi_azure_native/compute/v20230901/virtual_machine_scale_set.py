...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 resiliency_policy: Optional[pulumi.Input[pulumi.InputType['ResiliencyPolicyArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ResiliencyPolicyArgs']] resiliency_policy: Policy for Resiliency
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
