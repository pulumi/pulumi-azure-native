...
class DiskAccessAPrivateEndpointConnectionArgs:
    def __init__(__self__, *,
                 disk_access_name: pulumi.Input[builtins.str],
    ...
    def disk_access_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def disk_access_name(self, value: pulumi.Input[builtins.str]):
