...
def get_cloud_service(cloud_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cloud_service is deprecated: azure-native:compute/v20220404:CloudService is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220904:CloudService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['cloudServiceName'] = cloud_service_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20220404:getCloudService', __args__, opts=opts, typ=GetCloudServiceResult).value
