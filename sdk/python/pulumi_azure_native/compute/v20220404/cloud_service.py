...
warnings.warn("""azure-native:compute/v20220404:CloudService is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220904:CloudService to guarantee forwards compatibility.""", DeprecationWarning)
...
class CloudService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CloudService is deprecated: azure-native:compute/v20220404:CloudService is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220904:CloudService to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:compute:CloudService"), pulumi.Alias(type_="azure-native:compute/v20201001preview:CloudService"), pulumi.Alias(type_="azure-native:compute/v20210301:CloudService"), pulumi.Alias(type_="azure-native:compute/v20220904:CloudService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CloudService, __self__).__init__(
            'azure-native:compute/v20220404:CloudService',
            resource_name,
            __props__,
            opts)
