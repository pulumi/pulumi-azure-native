...
class DiskEncryptionSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        disk_encryption_set = azure_native.compute.v20200630.DiskEncryptionSet("diskEncryptionSet",
            active_key=azure_native.compute.v20200630.KeyVaultAndKeyReferenceResponseArgs(
                key_url="https://myvmvault.vault-int.azure-int.net/keys/{key}",
                source_vault=azure_native.compute.v20200630.SourceVaultArgs(
                    id="/subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.KeyVault/vaults/myVMVault",
                ),
            ),
            disk_encryption_set_name="myDiskEncryptionSet",
            encryption_type="EncryptionAtRestWithCustomerKey",
            identity=azure_native.compute.v20200630.EncryptionSetIdentityArgs(
                type="SystemAssigned",
            ),
            location="West US",
