...
def get_disk(disk_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk is deprecated: Version v20200630 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20200630:getDisk', __args__, opts=opts, typ=GetDiskResult).value
