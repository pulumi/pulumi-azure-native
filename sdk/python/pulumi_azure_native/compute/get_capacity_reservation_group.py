...
class GetCapacityReservationGroupResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, capacity_reservations=None, id=None, instance_view=None, location=None, name=None, sharing_profile=None, system_data=None, tags=None, type=None, virtual_machines_associated=None, zones=None):
...
def get_capacity_reservation_group(capacity_reservation_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str expand: The expand expression to apply on the operation. 'InstanceView' will retrieve the list of instance views of the capacity reservations under the capacity reservation group which is a snapshot of the runtime properties of a capacity reservation that is managed by the platform and can change outside of control plane operations.
...
def get_capacity_reservation_group_output(capacity_reservation_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
