...
def get_gallery_image_version(expand: Optional[_builtins.str] = None,
                              gallery_image_name: Optional[_builtins.str] = None,
                              gallery_image_version_name: Optional[_builtins.str] = None,
