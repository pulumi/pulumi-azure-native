...
class ManagedDiskParametersArgs:
    def __init__(__self__, *,
                 id: Optional[pulumi.Input[str]] = None,
                 storage_account_type: Optional[pulumi.Input['StorageAccountTypes']] = None):
        """
        The parameters of a managed disk.
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input['StorageAccountTypes'] storage_account_type: Specifies the storage account type for the managed disk. Possible values are: Standard_LRS or Premium_LRS.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
    ...
    def storage_account_type(self) -> Optional[pulumi.Input['StorageAccountTypes']]:
        """
    ...
    def storage_account_type(self, value: Optional[pulumi.Input['StorageAccountTypes']]):
...
class VirtualMachineScaleSetStorageProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineScaleSetDataDiskArgs']]] data_disks: The data disks.
