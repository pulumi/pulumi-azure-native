...
class GetAvailabilitySetResult:
    ...
    """
    def __init__(__self__, id=None, location=None, managed=None, name=None, platform_fault_domain_count=None, platform_update_domain_count=None, sku=None, statuses=None, tags=None, type=None, virtual_machines=None):
...
def get_availability_set(availability_set_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_availability_set is deprecated: Version v20160430preview will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20160430preview:getAvailabilitySet', __args__, opts=opts, typ=GetAvailabilitySetResult).value
