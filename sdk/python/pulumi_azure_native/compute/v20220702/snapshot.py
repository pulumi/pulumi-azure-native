...
class SnapshotArgs:
    ...
    def _configure(
        ...
        if 'copyCompletionError' in kwargs:
            copy_completion_error = kwargs['copyCompletionError']
        if 'dataAccessAuthMode' in kwargs:
        ...
        if 'encryptionSettingsCollection' in kwargs:
        ...
        if 'supportedCapabilities' in kwargs:
            supported_capabilities = kwargs['supportedCapabilities']
        if 'supportsHibernation' in kwargs:
...
class Snapshot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if copy_completion_error is not None and not isinstance(copy_completion_error, CopyCompletionErrorArgs):
            ...
            if sku is not None and not isinstance(sku, SnapshotSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
