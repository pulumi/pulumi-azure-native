...
class DiskEncryptionSetArgs:
    ...
    def _configure(
        ...
        if active_key is None and 'activeKey' in kwargs:
            active_key = kwargs['activeKey']
        if disk_encryption_set_name is None and 'diskEncryptionSetName' in kwargs:
            disk_encryption_set_name = kwargs['diskEncryptionSetName']
...
class DiskEncryptionSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            active_key = _utilities.configure(active_key, KeyForDiskEncryptionSetArgs, True)
            ...
            identity = _utilities.configure(identity, EncryptionSetIdentityArgs, True)
