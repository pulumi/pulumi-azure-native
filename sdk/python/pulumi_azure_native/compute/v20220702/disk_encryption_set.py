...
class DiskEncryptionSetArgs:
    ...
    def _configure(
        ...
        if 'activeKey' in kwargs:
            active_key = kwargs['activeKey']
        if 'diskEncryptionSetName' in kwargs:
...
class DiskEncryptionSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if active_key is not None and not isinstance(active_key, KeyForDiskEncryptionSetArgs):
            ...
            if identity is not None and not isinstance(identity, EncryptionSetIdentityArgs):
