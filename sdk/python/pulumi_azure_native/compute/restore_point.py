...
class RestorePointArgs:
    ...
    def _configure(
        ...
        if restore_point_collection_name is None and 'restorePointCollectionName' in kwargs:
            restore_point_collection_name = kwargs['restorePointCollectionName']
        if restore_point_collection_name is None:
            raise TypeError("Missing 'restore_point_collection_name' argument")
        ...
        if restore_point_name is None and 'restorePointName' in kwargs:
            restore_point_name = kwargs['restorePointName']
...
class RestorePoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            source_metadata = _utilities.configure(source_metadata, RestorePointSourceMetadataArgs, True)
            __props__.__dict__["source_metadata"] = source_metadata
            source_restore_point = _utilities.configure(source_restore_point, ApiEntityReferenceArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:compute/v20210301:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20210401:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20210701:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20211101:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20220301:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20220801:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20221101:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20230301:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20230701:RestorePoint")])
