...
class RestorePointArgs:
    def __init__(__self__, *,
                 ...
                 restore_point_collection_name: pulumi.Input[builtins.str],
                 consistency_mode: Optional[pulumi.Input[Union[builtins.str, 'ConsistencyModeTypes']]] = None,
        ...
        :param pulumi.Input[builtins.str] time_created: Gets the creation time of the restore point.
        """
    ...
    def restore_point_collection_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def restore_point_collection_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "restore_point_collection_name", value)

    @property
    @pulumi.getter(name="consistencyMode")
    def consistency_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'ConsistencyModeTypes']]]:
        """
    ...
    def consistency_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'ConsistencyModeTypes']]]):
    ...
    def restore_point_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_point_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RestorePoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="consistencyMode")
    def consistency_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ConsistencyMode of the RestorePoint. Can be specified in the input while creating a restore point. For now, only CrashConsistent is accepted as a valid input. Please refer to https://aka.ms/RestorePoints for more details.
        """
        return pulumi.get(self, "consistency_mode")
