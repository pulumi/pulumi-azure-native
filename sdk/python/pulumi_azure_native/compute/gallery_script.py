...
__all__ = ['GalleryScriptArgs', 'GalleryScript']
...
class GalleryScriptArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['GalleryScriptPropertiesArgs']] = None,
    ...
    def gallery_script_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def gallery_script_name(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['GalleryScriptPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['GalleryScriptPropertiesArgs']]):
...
@pulumi.type_token("azure-native:compute:GalleryScript")
class GalleryScript(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 gallery_script_name: Optional[pulumi.Input[_builtins.str]] = None,
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['GalleryScriptPropertiesArgs', 'GalleryScriptPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] gallery_script_name: The name of the gallery Script Definition to be retrieved.
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['GalleryScriptPropertiesArgs', 'GalleryScriptPropertiesArgsDict']] properties: Describes the properties of a gallery Script Definition.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GalleryScriptArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GalleryScriptArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GalleryScriptArgs.__new__(GalleryScriptArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:compute/v20250303:GalleryScript"), pulumi.Alias(type_="azure-native:compute/v20251203:GalleryScript")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GalleryScript, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GalleryScript':
        """
        ...
        __props__.__dict__["type"] = None
        return GalleryScript(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GalleryScriptPropertiesResponse']:
        """
        Describes the properties of a gallery Script Definition.
        """
        return pulumi.get(self, "properties")
