...
class GalleryScriptArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['GalleryScriptPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['GalleryScriptPropertiesArgs']]):
...
class GalleryScript(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 gallery_script_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['GalleryScriptPropertiesArgs', 'GalleryScriptPropertiesArgsDict']]] = None,
