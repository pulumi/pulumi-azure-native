...
def get_gallery_application_version(expand: Optional[_builtins.str] = None,
                                    gallery_application_name: Optional[_builtins.str] = None,
                                    gallery_application_version_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str gallery_application_version_name: The name of the gallery Application Version to be retrieved.
...
def get_gallery_application_version_output(expand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                           ...
                                           gallery_application_version_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
