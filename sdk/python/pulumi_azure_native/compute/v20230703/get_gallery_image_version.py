...
def get_gallery_image_version(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20230703:getGalleryImageVersion', __args__, opts=opts, typ=GetGalleryImageVersionResult).value
...
def get_gallery_image_version_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20230703:getGalleryImageVersion', __args__, opts=opts, typ=GetGalleryImageVersionResult)
