...
def get_gallery(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20230703:getGallery', __args__, opts=opts, typ=GetGalleryResult).value
...
def get_gallery_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['select'] = select
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20230703:getGallery', __args__, opts=opts, typ=GetGalleryResult)
