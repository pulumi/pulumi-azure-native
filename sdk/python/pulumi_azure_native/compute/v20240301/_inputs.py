...
class ResourceSharingProfileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input['SubResourceArgs']]] subscription_ids: Specifies an array of subscription resource IDs that capacity reservation group is shared with. **Note:** Minimum api-version: 2024-03-01. Please refer to https://aka.ms/computereservationsharing for more details.
        """
...
class SecurityProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ProxyAgentSettingsArgs'] proxy_agent_settings: Specifies ProxyAgent settings while creating the virtual machine. Minimum api-version: 2024-03-01.
