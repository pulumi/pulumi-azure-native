...
class CapacityReservationGroupInstanceViewResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['SubResourceReadOnlyResponse'] shared_subscription_ids: List of the subscriptions that the capacity reservation group is shared with. **Note:** Minimum api-version: 2024-03-01. Please refer to https://aka.ms/computereservationsharing for more details.
        """
...
class ResourceSharingProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['SubResourceResponse'] subscription_ids: Specifies an array of subscription resource IDs that capacity reservation group is shared with. **Note:** Minimum api-version: 2024-03-01. Please refer to https://aka.ms/computereservationsharing for more details.
        """
...
class SecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ProxyAgentSettingsResponse' proxy_agent_settings: Specifies ProxyAgent settings while creating the virtual machine. Minimum api-version: 2024-03-01.
...
class VirtualMachineScaleSetVMProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a virtual machine scale set virtual machine profile.
        :param str time_created: Specifies the time in which this VM profile for the Virtual Machine Scale Set was created. Minimum API version for this property is 2024-03-01. This value will be added to VMSS Flex VM tags when creating/updating the VMSS VM Profile with minimum api-version 2024-03-01.
