...
def get_virtual_machine_extension(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20240301:getVirtualMachineExtension', __args__, opts=opts, typ=GetVirtualMachineExtensionResult).value
...
def get_virtual_machine_extension_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['vmName'] = vm_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20240301:getVirtualMachineExtension', __args__, opts=opts, typ=GetVirtualMachineExtensionResult)
