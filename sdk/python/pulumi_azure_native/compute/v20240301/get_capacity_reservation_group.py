...
def get_capacity_reservation_group(capacity_reservation_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20240301:getCapacityReservationGroup', __args__, opts=opts, typ=GetCapacityReservationGroupResult).value
...
def get_capacity_reservation_group_output(capacity_reservation_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20240301:getCapacityReservationGroup', __args__, opts=opts, typ=GetCapacityReservationGroupResult)
