...
def get_restore_point(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20210401:getRestorePoint', __args__, opts=opts, typ=GetRestorePointResult).value
...
def get_restore_point_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:compute/v20210401:getRestorePoint', __args__, opts=opts, typ=GetRestorePointResult)
