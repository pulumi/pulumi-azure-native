...
def get_virtual_machine_scale_set_vm_run_command(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_scale_set_vm_run_command is deprecated: azure-native:compute/v20210401:VirtualMachineScaleSetVMRunCommand is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVMRunCommand to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20210401:getVirtualMachineScaleSetVMRunCommand', __args__, opts=opts, typ=GetVirtualMachineScaleSetVMRunCommandResult).value
