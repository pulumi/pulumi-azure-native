...
class RestorePoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20210401:RestorePoint"), pulumi.Alias(type_="azure-native:compute:RestorePoint"), pulumi.Alias(type_="azure-nextgen:compute:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20210301:RestorePoint"), pulumi.Alias(type_="azure-nextgen:compute/v20210301:RestorePoint"), pulumi.Alias(type_="azure-native:compute/v20210701:RestorePoint"), pulumi.Alias(type_="azure-nextgen:compute/v20210701:RestorePoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RestorePoint, __self__).__init__(
            'azure-native:compute/v20210401:RestorePoint',
            resource_name,
            __props__,
            opts)
