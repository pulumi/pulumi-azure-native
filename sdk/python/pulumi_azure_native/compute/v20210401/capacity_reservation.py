...
class CapacityReservation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20210401:CapacityReservation"), pulumi.Alias(type_="azure-native:compute:CapacityReservation"), pulumi.Alias(type_="azure-nextgen:compute:CapacityReservation"), pulumi.Alias(type_="azure-native:compute/v20210701:CapacityReservation"), pulumi.Alias(type_="azure-nextgen:compute/v20210701:CapacityReservation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CapacityReservation, __self__).__init__(
            'azure-native:compute/v20210401:CapacityReservation',
            resource_name,
            __props__,
            opts)
