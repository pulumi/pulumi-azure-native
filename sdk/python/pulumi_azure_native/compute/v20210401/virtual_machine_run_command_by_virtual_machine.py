...
class VirtualMachineRunCommandByVirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20210401:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-native:compute:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-nextgen:compute:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-native:compute/v20200601:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-nextgen:compute/v20200601:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-native:compute/v20201201:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-nextgen:compute/v20201201:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-native:compute/v20210301:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-nextgen:compute/v20210301:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-native:compute/v20210701:VirtualMachineRunCommandByVirtualMachine"), pulumi.Alias(type_="azure-nextgen:compute/v20210701:VirtualMachineRunCommandByVirtualMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineRunCommandByVirtualMachine, __self__).__init__(
            'azure-native:compute/v20210401:VirtualMachineRunCommandByVirtualMachine',
            resource_name,
            __props__,
            opts)
