...
warnings.warn("""azure-native:compute/v20210401:VirtualMachineScaleSetVM is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVM to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_machine_scale_set_vm(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_scale_set_vm is deprecated: azure-native:compute/v20210401:VirtualMachineScaleSetVM is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVM to guarantee forwards compatibility.""")
    __args__ = dict()
