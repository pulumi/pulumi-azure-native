...
warnings.warn("""azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_disk_access_a_private_endpoint_connection(disk_access_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk_access_a_private_endpoint_connection is deprecated: azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
