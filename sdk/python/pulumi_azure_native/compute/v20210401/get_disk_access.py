...
warnings.warn("""azure-native:compute/v20210401:DiskAccess is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskAccess to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_disk_access(disk_access_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk_access is deprecated: azure-native:compute/v20210401:DiskAccess is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskAccess to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['diskAccessName'] = disk_access_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20210401:getDiskAccess', __args__, opts=opts, typ=GetDiskAccessResult).value
