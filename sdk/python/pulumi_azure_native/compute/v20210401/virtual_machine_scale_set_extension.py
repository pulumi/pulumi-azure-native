...
warnings.warn("""azure-native:compute/v20210401:VirtualMachineScaleSetExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20211101:VirtualMachineScaleSetExtension to guarantee forwards compatibility.""", DeprecationWarning)
