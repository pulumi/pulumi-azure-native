...
class VirtualMachineScaleSetVM(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_scale_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachineScaleSetVM is deprecated: azure-native:compute/v20210401:VirtualMachineScaleSetVM is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineScaleSetVM to guarantee forwards compatibility.""")
