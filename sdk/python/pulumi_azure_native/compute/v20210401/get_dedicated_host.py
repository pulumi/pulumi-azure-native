...
def get_dedicated_host(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dedicated_host is deprecated: azure-native:compute/v20210401:DedicatedHost is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHost to guarantee forwards compatibility.""")
    __args__ = dict()
