...
class VirtualMachineRunCommandByVirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachineRunCommandByVirtualMachine is deprecated: Version 2020-12-01 will be removed in v2 of the provider.""")
