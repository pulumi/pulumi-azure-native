...
class Snapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        snapshot = azure_native.compute.v20201201.Snapshot("snapshot",
            creation_data=azure_native.compute.v20201201.CreationDataArgs(
