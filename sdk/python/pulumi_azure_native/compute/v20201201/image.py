...
class Image(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        image = azure_native.compute.v20201201.Image("image",
            image_name="myImage",
            location="West US",
            resource_group_name="myResourceGroup",
            storage_profile=azure_native.compute.v20201201.ImageStorageProfileResponseArgs(
                os_disk={
                    "blobUri": "https://mystorageaccount.blob.core.windows.net/osimages/osimage.vhd",
                    "diskEncryptionSet": azure_native.compute.v20201201.DiskEncryptionSetParametersArgs(
        ...
        image = azure_native.compute.v20201201.Image("image",
            ...
            resource_group_name="myResourceGroup",
            storage_profile=azure_native.compute.v20201201.ImageStorageProfileResponseArgs(
                os_disk=azure_native.compute.v20201201.ImageOSDiskArgs(
                    blob_uri="https://mystorageaccount.blob.core.windows.net/osimages/osimage.vhd",
                    os_state=azure_native.compute/v20201201.OperatingSystemStateTypes.GENERALIZED,
                    os_type=azure_native.compute/v20201201.OperatingSystemTypes.LINUX,
                ),
                zone_resilient=True,
            ))
        ...
        image = azure_native.compute.v20201201.Image("image",
            ...
            storage_profile=azure_native.compute.v20201201.ImageStorageProfileResponseArgs(
                os_disk={
                    ...
                    "managedDisk": azure_native.compute.v20201201.SubResourceArgs(
        ...
        image = azure_native.compute.v20201201.Image("image",
            ...
            storage_profile=azure_native.compute.v20201201.ImageStorageProfileResponseArgs(
                os_disk={
                    ...
                    "osState": azure_native.compute/v20201201.OperatingSystemStateTypes.GENERALIZED,
                    "osType": azure_native.compute/v20201201.OperatingSystemTypes.LINUX,
                    "snapshot": azure_native.compute.v20201201.SubResourceArgs(
        ...
        image = azure_native.compute.v20201201.Image("image",
            ...
            location="West US",
            resource_group_name="myResourceGroup",
            source_virtual_machine=azure_native.compute.v20201201.SubResourceArgs(
        ...
        image = azure_native.compute.v20201201.Image("image",
            ...
            resource_group_name="myResourceGroup",
            storage_profile=azure_native.compute.v20201201.ImageStorageProfileResponseArgs(
                data_disks=[azure_native.compute.v20201201.ImageDataDiskArgs(
