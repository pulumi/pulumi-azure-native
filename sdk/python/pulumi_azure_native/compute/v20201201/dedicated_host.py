...
class DedicatedHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dedicated_host = azure_native.compute.v20201201.DedicatedHost("dedicatedHost",
            host_group_name="myDedicatedHostGroup",
            host_name="myDedicatedHost",
            location="westus",
            platform_fault_domain=1,
            resource_group_name="myResourceGroup",
            sku=azure_native.compute.v20201201.SkuArgs(
                name="DSv3-Type1",
            ),
            tags={
                "department": "HR",
        ...
        ```sh
        $ pulumi import azure-native:compute/v20201201:DedicatedHost myDedicatedHost /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/HostGroups/myDedicatedHostGroup/hosts/myDedicatedHost 
        ```
