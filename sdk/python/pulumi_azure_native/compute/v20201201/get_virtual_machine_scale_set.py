...
warnings.warn("""azure-native:compute/v20201201:VirtualMachineScaleSet is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineScaleSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_machine_scale_set(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_scale_set is deprecated: azure-native:compute/v20201201:VirtualMachineScaleSet is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineScaleSet to guarantee forwards compatibility.""")
    __args__ = dict()
