...
warnings.warn("""azure-native:compute/v20201201:VirtualMachineScaleSetExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20211101:VirtualMachineScaleSetExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_machine_scale_set_extension(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20201201:getVirtualMachineScaleSetExtension', __args__, opts=opts, typ=GetVirtualMachineScaleSetExtensionResult).value
