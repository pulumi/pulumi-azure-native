...
class GetDedicatedHostGroupResult:
    ...
    def support_automatic_placement(self) -> Optional[builtins.bool]:
        """
...
def get_dedicated_host_group(expand: Optional[builtins.str] = None,
...
def get_dedicated_host_group_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
