...
class VirtualMachineScaleSetVMExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_scale_set_vm_extension = azure_native.compute.v20191201.VirtualMachineScaleSetVMExtension("virtualMachineScaleSetVMExtension",
    ...
    def _internal_init(__self__,
                 ...
                 vm_scale_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachineScaleSetVMExtension is deprecated: Version 2019-12-01 will be removed in v2 of the provider.""")
