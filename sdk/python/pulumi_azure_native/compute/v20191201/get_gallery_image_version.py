...
def get_gallery_image_version(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery_image_version is deprecated: Version v20191201 will be removed in the next major version of the provider. Upgrade to version v20200930 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20191201:getGalleryImageVersion', __args__, opts=opts, typ=GetGalleryImageVersionResult).value
