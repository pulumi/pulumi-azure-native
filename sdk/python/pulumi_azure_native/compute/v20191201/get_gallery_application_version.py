...
azure-native:compute/v20191201:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_gallery_application_version(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery_application_version is deprecated: Version 2019-12-01 will be removed in v2 of the provider.
azure-native:compute/v20191201:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20191201:getGalleryApplicationVersion', __args__, opts=opts, typ=GetGalleryApplicationVersionResult).value
