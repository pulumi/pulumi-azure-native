...
azure-native:compute/v20191201:SshPublicKey is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:SshPublicKey to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ssh_public_key(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ssh_public_key is deprecated: Version 2019-12-01 will be removed in v2 of the provider.
azure-native:compute/v20191201:SshPublicKey is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:SshPublicKey to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20191201:getSshPublicKey', __args__, opts=opts, typ=GetSshPublicKeyResult).value
