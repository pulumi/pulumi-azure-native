...
class RestorePointCollectionArgs:
    ...
    def restore_point_collection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_point_collection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RestorePointCollection(pulumi.CustomResource):
    ...
    def restore_point_collection_id(self) -> pulumi.Output[builtins.str]:
        """
