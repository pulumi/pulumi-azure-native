...
warnings.warn("""azure-native:compute/v20210301:DedicatedHostGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHostGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class DedicatedHostGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DedicatedHostGroup is deprecated: azure-native:compute/v20210301:DedicatedHostGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHostGroup to guarantee forwards compatibility.""")
