...
def get_image(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_image is deprecated: azure-native:compute/v20210301:Image is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:Image to guarantee forwards compatibility.""")
    __args__ = dict()
