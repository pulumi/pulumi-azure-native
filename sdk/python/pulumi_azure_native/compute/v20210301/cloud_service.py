...
class CloudService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20210301:CloudService"), pulumi.Alias(type_="azure-native:compute:CloudService"), pulumi.Alias(type_="azure-nextgen:compute:CloudService"), pulumi.Alias(type_="azure-native:compute/v20201001preview:CloudService"), pulumi.Alias(type_="azure-nextgen:compute/v20201001preview:CloudService")])
