...
def get_availability_set(availability_set_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_availability_set is deprecated: azure-native:compute/v20210301:AvailabilitySet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:AvailabilitySet to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['availabilitySetName'] = availability_set_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20210301:getAvailabilitySet', __args__, opts=opts, typ=GetAvailabilitySetResult).value
