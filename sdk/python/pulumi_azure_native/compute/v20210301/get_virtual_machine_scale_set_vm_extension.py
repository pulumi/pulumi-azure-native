...
def get_virtual_machine_scale_set_vm_extension(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_scale_set_vm_extension is deprecated: azure-native:compute/v20210301:VirtualMachineScaleSetVMExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20211101:VirtualMachineScaleSetVMExtension to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/v20210301:getVirtualMachineScaleSetVMExtension', __args__, opts=opts, typ=GetVirtualMachineScaleSetVMExtensionResult).value
