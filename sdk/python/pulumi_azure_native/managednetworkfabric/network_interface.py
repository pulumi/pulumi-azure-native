...
class NetworkInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:NetworkInterface"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkInterface"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:NetworkInterface"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:NetworkInterface")])
