...
class InternetGatewayRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:InternetGatewayRule"), pulumi.Alias(type_="azure-native_managednetworkfabric_v20230615:managednetworkfabric:InternetGatewayRule")])
