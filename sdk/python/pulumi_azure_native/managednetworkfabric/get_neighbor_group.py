...
def get_neighbor_group(neighbor_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str neighbor_group_name: Name of the Neighbor Group.
...
def get_neighbor_group_output(neighbor_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
