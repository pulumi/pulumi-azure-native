...
class NetworkRack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:NetworkRack"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkRack"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:NetworkRack"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:NetworkRack")])
