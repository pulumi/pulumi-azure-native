...
class NetworkRackArgs:
    def __init__(__self__, *,
                 ...
                 network_rack_name: Optional[pulumi.Input[builtins.str]] = None,
                 network_rack_type: Optional[pulumi.Input[Union[builtins.str, 'NetworkRackType']]] = None,
        ...
        :param pulumi.Input[builtins.str] network_rack_name: Name of the Network Rack.
        :param pulumi.Input[Union[builtins.str, 'NetworkRackType']] network_rack_type: Network Rack SKU name.
    ...
    def network_rack_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_rack_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_rack_name", value)

    @property
    @pulumi.getter(name="networkRackType")
    def network_rack_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'NetworkRackType']]]:
        """
    ...
    def network_rack_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'NetworkRackType']]]):
...
class NetworkRack(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:managednetworkfabric:NetworkRack"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:NetworkRack"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkRack")])
    ...
    def network_devices(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="networkRackType")
    def network_rack_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Network Rack SKU name.
        """
        return pulumi.get(self, "network_rack_type")
