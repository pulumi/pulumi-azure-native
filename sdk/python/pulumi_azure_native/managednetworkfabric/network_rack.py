...
class NetworkRackArgs:
    ...
    def _configure(
        ...
        if network_rack_sku is None and 'networkRackSku' in kwargs:
            network_rack_sku = kwargs['networkRackSku']
        if network_rack_sku is None:
            raise TypeError("Missing 'network_rack_sku' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if network_rack_name is None and 'networkRackName' in kwargs:
