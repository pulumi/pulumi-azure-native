...
class NetworkFabricControllerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'NfcSku']] nfc_sku: Network Fabric Controller SKU.
    ...
    def is_workload_management_network_enabled(self) -> Optional[pulumi.Input[Union[str, 'IsWorkloadManagementNetworkEnabled']]]:
        """
    ...
    def is_workload_management_network_enabled(self, value: Optional[pulumi.Input[Union[str, 'IsWorkloadManagementNetworkEnabled']]]):
    ...
    def nfc_sku(self) -> Optional[pulumi.Input[Union[str, 'NfcSku']]]:
        """
    ...
    @nfc_sku.setter
    def nfc_sku(self, value: Optional[pulumi.Input[Union[str, 'NfcSku']]]):
...
class NetworkFabricController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:NetworkFabricController"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkFabricController"), pulumi.Alias(type_="azure-native_managednetworkfabric_v20230201preview:managednetworkfabric:NetworkFabricController"), pulumi.Alias(type_="azure-native_managednetworkfabric_v20230615:managednetworkfabric:NetworkFabricController")])
    ...
    @property
    @pulumi.getter(name="nfcSku")
    def nfc_sku(self) -> pulumi.Output[Optional[str]]:
        """
        Network Fabric Controller SKU.
        """
        return pulumi.get(self, "nfc_sku")
