...
def get_network_tap(network_tap_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_tap_name: Name of the Network Tap.
...
def get_network_tap_output(network_tap_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
