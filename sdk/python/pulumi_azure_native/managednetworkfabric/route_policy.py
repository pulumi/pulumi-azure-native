...
class RoutePolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:RoutePolicy"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:RoutePolicy"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:RoutePolicy"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:RoutePolicy")])
