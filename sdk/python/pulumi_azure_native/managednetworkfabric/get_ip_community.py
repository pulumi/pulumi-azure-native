...
class GetIpCommunityResult:
    ...
    """
    def __init__(__self__, administrative_state=None, annotation=None, azure_api_version=None, configuration_state=None, id=None, ip_community_rules=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_ip_community(ip_community_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ip_community_name: Name of the IP Community.
...
def get_ip_community_output(ip_community_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                            resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIpCommunityResult]:
    """
    Implements an IP Community GET method.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric:getIpCommunity', __args__, opts=opts, typ=GetIpCommunityResult)
    return __ret__.apply(lambda __response__: GetIpCommunityResult(
        ...
        ip_community_rules=pulumi.get(__response__, 'ip_community_rules'),
