...
def get_ip_community(ip_community_name: Optional[builtins.str] = None,
    ...
    :param builtins.str ip_community_name: Name of the IP Community.
...
def get_ip_community_output(ip_community_name: Optional[pulumi.Input[builtins.str]] = None,
