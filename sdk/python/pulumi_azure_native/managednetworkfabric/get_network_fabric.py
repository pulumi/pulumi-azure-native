...
def get_network_fabric(network_fabric_name: Optional[_builtins.str] = None,
...
def get_network_fabric_output(network_fabric_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
