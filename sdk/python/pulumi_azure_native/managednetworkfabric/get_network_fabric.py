...
class GetNetworkFabricResult:
    ...
    def fabric_version(self) -> Optional[builtins.str]:
        """
    ...
    def ipv6_prefix(self) -> Optional[builtins.str]:
        """
    ...
    def l2_isolation_domains(self) -> Sequence[builtins.str]:
        """
    ...
    def l3_isolation_domains(self) -> Sequence[builtins.str]:
        """
    ...
    def network_fabric_sku(self) -> builtins.str:
        """
    ...
    def rack_count(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def racks(self) -> Sequence[builtins.str]:
        """
    ...
    def router_ids(self) -> Sequence[builtins.str]:
        """
        Array of router IDs.
        """
    ...
    def server_count_per_rack(self) -> builtins.int:
        """
...
def get_network_fabric(network_fabric_name: Optional[builtins.str] = None,
...
def get_network_fabric_output(network_fabric_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetNetworkFabricResult(
        ...
        l2_isolation_domains=pulumi.get(__response__, 'l2_isolation_domains'),
        l3_isolation_domains=pulumi.get(__response__, 'l3_isolation_domains'),
        location=pulumi.get(__response__, 'location'),
        management_network_configuration=pulumi.get(__response__, 'management_network_configuration'),
        ...
        terminal_server_configuration=pulumi.get(__response__, 'terminal_server_configuration'),
