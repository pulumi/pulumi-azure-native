...
class GetNetworkDeviceStatusResult:
    ...
    def power_cycle_state(self) -> builtins.str:
        """
...
def get_network_device_status(network_device_name: Optional[builtins.str] = None,
...
def get_network_device_status_output(network_device_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric:getNetworkDeviceStatus', __args__, opts=opts, typ=GetNetworkDeviceStatusResult)
