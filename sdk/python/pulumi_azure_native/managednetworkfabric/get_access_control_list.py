...
def get_access_control_list(access_control_list_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str access_control_list_name: Name of the Access Control List.
...
def get_access_control_list_output(access_control_list_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
