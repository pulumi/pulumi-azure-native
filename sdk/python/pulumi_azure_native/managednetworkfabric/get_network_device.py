...
def get_network_device(network_device_name: Optional[_builtins.str] = None,
...
def get_network_device_output(network_device_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
