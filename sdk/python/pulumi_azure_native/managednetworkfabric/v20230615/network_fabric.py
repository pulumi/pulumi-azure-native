...
class NetworkFabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if management_network_configuration is not None and not isinstance(management_network_configuration, ManagementNetworkConfigurationPropertiesArgs):
                management_network_configuration = management_network_configuration or {}
                def _setter(key, value):
                    management_network_configuration[key] = value
                ManagementNetworkConfigurationPropertiesArgs._configure(_setter, **management_network_configuration)
