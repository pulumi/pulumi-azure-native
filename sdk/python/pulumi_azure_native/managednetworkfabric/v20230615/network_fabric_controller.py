...
class NetworkFabricControllerArgs:
    def __init__(__self__, *,
        ...
        NetworkFabricControllerArgs._configure(
            ...
            is_workload_management_network_enabled=is_workload_management_network_enabled,
            location=location,
    ...
    def _configure(
        ...
        if is_workload_management_network_enabled is None and 'isWorkloadManagementNetworkEnabled' in kwargs:
            is_workload_management_network_enabled = kwargs['isWorkloadManagementNetworkEnabled']
        ...
        if nfc_sku is None and 'nfcSku' in kwargs:
            nfc_sku = kwargs['nfcSku']
        ...
        if is_workload_management_network_enabled is not None:
            _setter("is_workload_management_network_enabled", is_workload_management_network_enabled)
...
class NetworkFabricController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:NetworkFabricController"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:NetworkFabricController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkFabricController, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:NetworkFabricController',
            resource_name,
            __props__,
            opts)
