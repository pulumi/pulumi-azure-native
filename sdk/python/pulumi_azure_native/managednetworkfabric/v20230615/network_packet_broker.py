...
class NetworkPacketBroker(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:NetworkPacketBroker")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkPacketBroker, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:NetworkPacketBroker',
            resource_name,
            __props__,
            opts)
