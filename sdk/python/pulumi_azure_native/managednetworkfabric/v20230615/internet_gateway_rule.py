...
class InternetGatewayRuleArgs:
    ...
    def _configure(
        ...
        if 'ruleProperties' in kwargs:
            rule_properties = kwargs['ruleProperties']
        if 'internetGatewayRuleName' in kwargs:
...
class InternetGatewayRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if rule_properties is not None and not isinstance(rule_properties, RulePropertiesArgs):
                rule_properties = rule_properties or {}
                def _setter(key, value):
                    rule_properties[key] = value
                RulePropertiesArgs._configure(_setter, **rule_properties)
