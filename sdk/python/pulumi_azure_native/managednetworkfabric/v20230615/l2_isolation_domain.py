...
class L2IsolationDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:L2IsolationDomain"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:L2IsolationDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(L2IsolationDomain, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:L2IsolationDomain',
            resource_name,
            __props__,
            opts)
