...
class IpExtendedCommunityArgs:
    def __init__(__self__, *,
                 ip_extended_community_rules: pulumi.Input[Sequence[pulumi.Input['IpExtendedCommunityRuleArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IpExtendedCommunityRuleArgs']]] ip_extended_community_rules: List of IP Extended Community Rules.
    ...
    def _configure(
             ...
             **kwargs):
        if 'ipExtendedCommunityRules' in kwargs:
            ip_extended_community_rules = kwargs['ipExtendedCommunityRules']
        if 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if 'ipExtendedCommunityName' in kwargs:
    ...
    def ip_extended_community_rules(self, value: pulumi.Input[Sequence[pulumi.Input['IpExtendedCommunityRuleArgs']]]):
        pulumi.set(self, "ip_extended_community_rules", value)
...
class IpExtendedCommunity(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotation: Optional[pulumi.Input[str]] = None,
                 ip_extended_community_name: Optional[pulumi.Input[str]] = None,
                 ip_extended_community_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IpExtendedCommunityRuleArgs']]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] annotation: Switch configuration description.
        :param pulumi.Input[str] ip_extended_community_name: Name of the IP Extended Community.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IpExtendedCommunityRuleArgs']]]] ip_extended_community_rules: List of IP Extended Community Rules.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if ip_extended_community_rules is None and not opts.urn:
                raise TypeError("Missing required property 'ip_extended_community_rules'")
            __props__.__dict__["ip_extended_community_rules"] = ip_extended_community_rules
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:IpExtendedCommunity"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:IpExtendedCommunity")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IpExtendedCommunity, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:IpExtendedCommunity',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["configuration_state"] = None
        __props__.__dict__["ip_extended_community_rules"] = None
