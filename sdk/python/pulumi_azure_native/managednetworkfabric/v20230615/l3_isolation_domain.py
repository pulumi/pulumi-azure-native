...
class L3IsolationDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if connected_subnet_route_policy is not None and not isinstance(connected_subnet_route_policy, ConnectedSubnetRoutePolicyArgs):
                connected_subnet_route_policy = connected_subnet_route_policy or {}
                def _setter(key, value):
                    connected_subnet_route_policy[key] = value
                ConnectedSubnetRoutePolicyArgs._configure(_setter, **connected_subnet_route_policy)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:L3IsolationDomain"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:L3IsolationDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(L3IsolationDomain, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:L3IsolationDomain',
            resource_name,
            __props__,
            opts)
