...
class InternalNetworkArgs:
    ...
    def _configure(
        ...
        if is_monitoring_enabled is None and 'isMonitoringEnabled' in kwargs:
...
class InternalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            bgp_configuration = _utilities.configure(bgp_configuration, InternalNetworkPropertiesBgpConfigurationArgs, True)
            ...
            static_route_configuration = _utilities.configure(static_route_configuration, InternalNetworkPropertiesStaticRouteConfigurationArgs, True)
