...
class InternalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(bgp_configuration, InternalNetworkPropertiesBgpConfigurationArgs):
            ...
            if not isinstance(static_route_configuration, InternalNetworkPropertiesStaticRouteConfigurationArgs):
