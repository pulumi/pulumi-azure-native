...
class InternalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:InternalNetwork"), pulumi.Alias(type_="azure-native:managednetworkfabric:InternalNetwork")])
