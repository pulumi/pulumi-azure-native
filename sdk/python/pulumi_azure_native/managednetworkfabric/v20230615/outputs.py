...
class AccessControlListMatchConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the match condition that is supported to filter the traffic.
        :param Sequence[str] dscp_markings: List of DSCP Markings that needs to be matched.
        :param Sequence[str] ether_types: List of ether type values that needs to be matched.
        :param Sequence[str] fragments: List of IP fragment packets that needs to be matched.
        :param 'IpMatchConditionResponse' ip_condition: IP condition that needs to be matched.
        :param Sequence[str] ip_lengths: List of IP Lengths that needs to be matched.
        ...
        :param Sequence[str] ttl_values: List of TTL [Time To Live] values that needs to be matched.
...
class AccessControlListPortConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] flags: List of protocol flags that needs to be matched.
