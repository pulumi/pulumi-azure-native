...
class ExternalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(export_route_policy, ExportRoutePolicyArgs):
            ...
            if not isinstance(import_route_policy, ImportRoutePolicyArgs):
            ...
            if not isinstance(option_b_properties, L3OptionBPropertiesArgs):
