...
class ExternalNetworkArgs:
    ...
    def _configure(
        ...
        if 'importRoutePolicy' in kwargs:
...
class ExternalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if export_route_policy is not None and not isinstance(export_route_policy, ExportRoutePolicyArgs):
                export_route_policy = export_route_policy or {}
                def _setter(key, value):
                    export_route_policy[key] = value
                ExportRoutePolicyArgs._configure(_setter, **export_route_policy)
            ...
            if import_route_policy is not None and not isinstance(import_route_policy, ImportRoutePolicyArgs):
                import_route_policy = import_route_policy or {}
                def _setter(key, value):
                    import_route_policy[key] = value
                ImportRoutePolicyArgs._configure(_setter, **import_route_policy)
            ...
            if option_b_properties is not None and not isinstance(option_b_properties, L3OptionBPropertiesArgs):
                option_b_properties = option_b_properties or {}
                def _setter(key, value):
                    option_b_properties[key] = value
                L3OptionBPropertiesArgs._configure(_setter, **option_b_properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:ExternalNetwork"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:ExternalNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ExternalNetwork, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:ExternalNetwork',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="optionBProperties")
    def option_b_properties(self) -> pulumi.Output[Optional['outputs.L3OptionBPropertiesResponse']]:
        """
        option B properties object
        """
        return pulumi.get(self, "option_b_properties")
