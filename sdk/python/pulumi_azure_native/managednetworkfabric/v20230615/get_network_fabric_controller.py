...
def get_network_fabric_controller(network_fabric_controller_name: Optional[str] = None,
    ...
    return AwaitableGetNetworkFabricControllerResult(
        ...
        is_workload_management_network_enabled=__ret__.is_workload_management_network_enabled,
        ...
        nfc_sku=__ret__.nfc_sku,
        provisioning_state=__ret__.provisioning_state,
        system_data=__ret__.system_data,
        tags=__ret__.tags,
        tenant_internet_gateway_ids=__ret__.tenant_internet_gateway_ids,
        type=__ret__.type,
