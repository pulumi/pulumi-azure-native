...
def get_network_fabric(network_fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managednetworkfabric/v20230615:getNetworkFabric', __args__, opts=opts, typ=GetNetworkFabricResult).value
...
def get_network_fabric_output(network_fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric/v20230615:getNetworkFabric', __args__, opts=opts, typ=GetNetworkFabricResult)
