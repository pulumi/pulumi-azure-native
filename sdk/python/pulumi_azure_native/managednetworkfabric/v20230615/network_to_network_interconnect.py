...
class NetworkToNetworkInterconnect(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(export_route_policy, ExportRoutePolicyInformationArgs):
            ...
            if not isinstance(import_route_policy, ImportRoutePolicyInformationArgs):
            ...
            if not isinstance(npb_static_route_configuration, NpbStaticRouteConfigurationArgs):
            ...
            if not isinstance(option_b_layer3_configuration, NetworkToNetworkInterconnectPropertiesOptionBLayer3ConfigurationArgs):
