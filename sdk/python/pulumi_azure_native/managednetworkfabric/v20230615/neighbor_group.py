...
class NeighborGroupArgs:
    ...
    def _configure(
             ...
             destination: Optional[pulumi.Input['NeighborGroupDestinationArgs']] = None,
        ...
        if neighbor_group_name is None and 'neighborGroupName' in kwargs:
...
class NeighborGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            destination = _utilities.configure(destination, NeighborGroupDestinationArgs, True)
