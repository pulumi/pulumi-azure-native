...
class IpPrefixArgs:
    ...
    def _configure(
             ...
             ip_prefix_rules: Optional[pulumi.Input[Sequence[pulumi.Input['IpPrefixRuleArgs']]]] = None,
...
class IpPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotation: Optional[pulumi.Input[str]] = None,
                 ip_prefix_name: Optional[pulumi.Input[str]] = None,
                 ip_prefix_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IpPrefixRuleArgs']]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[str] annotation: Switch configuration description.
        :param pulumi.Input[str] ip_prefix_name: Name of the IP Prefix.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IpPrefixRuleArgs']]]] ip_prefix_rules: The list of IP Prefix Rules.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:IpPrefix")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IpPrefix, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:IpPrefix',
            resource_name,
            __props__,
            opts)
