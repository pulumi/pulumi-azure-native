...
class IpCommunityArgs:
    def __init__(__self__, *,
        ...
        IpCommunityArgs._configure(
            ...
            ip_community_rules=ip_community_rules,
    ...
    def _configure(
             ...
             ip_community_rules: Optional[pulumi.Input[Sequence[pulumi.Input['IpCommunityRuleArgs']]]] = None,
             ...
             **kwargs):
        if ip_community_rules is None and 'ipCommunityRules' in kwargs:
            ip_community_rules = kwargs['ipCommunityRules']
        if ip_community_rules is None:
            raise TypeError("Missing 'ip_community_rules' argument")
        ...
        _setter("ip_community_rules", ip_community_rules)
...
class IpCommunity(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotation: Optional[pulumi.Input[str]] = None,
                 ip_community_name: Optional[pulumi.Input[str]] = None,
                 ip_community_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IpCommunityRuleArgs']]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[str] annotation: Switch configuration description.
        :param pulumi.Input[str] ip_community_name: Name of the IP Community.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IpCommunityRuleArgs']]]] ip_community_rules: List of IP Community Rules.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:IpCommunity"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:IpCommunity")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IpCommunity, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:IpCommunity',
            resource_name,
            __props__,
            opts)
