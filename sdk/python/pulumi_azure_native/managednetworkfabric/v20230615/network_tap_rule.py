...
class NetworkTapRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:NetworkTapRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkTapRule, __self__).__init__(
            'azure-native:managednetworkfabric/v20230615:NetworkTapRule',
            resource_name,
            __props__,
            opts)
