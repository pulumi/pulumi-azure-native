...
def get_l3_isolation_domain(l3_isolation_domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managednetworkfabric/v20230615:getL3IsolationDomain', __args__, opts=opts, typ=GetL3IsolationDomainResult).value
