...
class AccessControlListMatchConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dscp_markings: List of DSCP Markings that needs to be matched.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ether_types: List of ether type values that needs to be matched.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] fragments: List of IP fragment packets that needs to be matched.
        :param pulumi.Input['IpMatchConditionArgs'] ip_condition: IP condition that needs to be matched.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ip_lengths: List of IP Lengths that needs to be matched.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ttl_values: List of TTL [Time To Live] values that needs to be matched.
...
class AccessControlListPortConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] flags: List of protocol flags that needs to be matched.
