...
class NetworkRackArgs:
    def __init__(__self__, *,
        ...
        NetworkRackArgs._configure(
            ...
            network_rack_type=network_rack_type,
            tags=tags,
        )
    @staticmethod
    def _configure(
        ...
        if network_rack_type is None and 'networkRackType' in kwargs:
            network_rack_type = kwargs['networkRackType']
        ...
        if network_rack_type is not None:
            _setter("network_rack_type", network_rack_type)
        if tags is not None:
            _setter("tags", tags)
