...
class AccessControlListMatchConditionArgsDict(TypedDict):
    ...
    """
    ip_condition: NotRequired[pulumi.Input[Optional['IpMatchConditionArgs']]]
    """
    ...
    """
    port_condition: NotRequired[pulumi.Input[Optional['AccessControlListPortConditionArgs']]]
    """
    ...
    """
    vlan_match_condition: NotRequired[pulumi.Input[Optional['VlanMatchConditionArgs']]]
    """
...
class AccessControlListMatchConfigurationArgsDict(TypedDict):
    ...
    """
    actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AccessControlListActionArgs']]]]]
    """
    ...
    """
    match_conditions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AccessControlListMatchConditionArgs']]]]]
    """
...
class ActionIpCommunityPropertiesArgsDict(TypedDict):
    ...
    """
    add: NotRequired[pulumi.Input[Optional['IpCommunityIdListArgs']]]
    """
    List of IP Community IDs.
    """
    delete: NotRequired[pulumi.Input[Optional['IpCommunityIdListArgs']]]
    """
    List of IP Community IDs.
    """
    set: NotRequired[pulumi.Input[Optional['IpCommunityIdListArgs']]]
    """
    List of IP Community IDs.
    """
...
class ActionIpExtendedCommunityPropertiesArgsDict(TypedDict):
    ...
    """
    add: NotRequired[pulumi.Input[Optional['IpExtendedCommunityIdListArgs']]]
    """
    List of IP Extended Community IDs.
    """
    delete: NotRequired[pulumi.Input[Optional['IpExtendedCommunityIdListArgs']]]
    """
    List of IP Extended Community IDs.
    """
    set: NotRequired[pulumi.Input[Optional['IpExtendedCommunityIdListArgs']]]
    """
    List of IP Extended Community IDs.
    """
...
class AggregateRouteConfigurationArgsDict(TypedDict):
    ...
    """
    ipv4_routes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AggregateRouteArgs']]]]]
    """
    List of IPv4 Route prefixes.
    """
    ipv6_routes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AggregateRouteArgs']]]]]
    """
...
class BmpConfigurationPropertiesArgsDict(TypedDict):
    ...
    """
    station_connection_properties: NotRequired[pulumi.Input[Optional['StationConnectionPropertiesArgs']]]
    """
...
class CommonDynamicMatchConfigurationArgsDict(TypedDict):
    ...
    """
    ip_groups: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IpGroupPropertiesArgs']]]]]
    """
    List of IP Groups.
    """
    port_groups: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PortGroupPropertiesArgs']]]]]
    """
    List of the port groups.
    """
    vlan_groups: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['VlanGroupPropertiesArgs']]]]]
    """
    List of vlan groups.
    """
...
class ConnectedSubnetRoutePolicyArgsDict(TypedDict):
    ...
    """
    export_route_policy: NotRequired[pulumi.Input[Optional['L3ExportRoutePolicyArgs']]]
    """
...
class ExternalNetworkPropertiesOptionAPropertiesArgsDict(TypedDict):
    ...
    """
    bfd_configuration: NotRequired[pulumi.Input[Optional['BfdConfigurationArgs']]]
    """
    BFD configuration properties
    """
...
class FabricOptionBPropertiesArgsDict(TypedDict):
    ...
    """
    route_targets: NotRequired[pulumi.Input[Optional['RouteTargetInformationArgs']]]
    """
...
class InternalNetworkPropertiesBgpConfigurationArgsDict(TypedDict):
    ...
    """
    ipv4_neighbor_address: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NeighborAddressArgs']]]]]
    """
    ...
    """
    ipv6_neighbor_address: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NeighborAddressArgs']]]]]
    """
...
class InternalNetworkPropertiesStaticRouteConfigurationArgsDict(TypedDict):
    ...
    """
    ipv4_routes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['StaticRoutePropertiesArgs']]]]]
    """
    List of IPv4 Routes.
    """
    ipv6_routes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['StaticRoutePropertiesArgs']]]]]
    """
    List of IPv6 Routes.
    """
...
class NetworkMonitorPropertiesArgsDict(TypedDict):
    ...
    Switch configuration description.
    """
    bmp_configuration: NotRequired[pulumi.Input[Optional['BmpConfigurationPropertiesArgs']]]
    """
...
class NetworkMonitorPropertiesArgs:
    def __init__(__self__, *,
                 annotation: pulumi.Input[Optional[_builtins.str]] = None,
                 bmp_configuration: pulumi.Input[Optional['BmpConfigurationPropertiesArgs']] = None):
        """
        Network Monitor Properties defines the properties of the resource.
    ...
    def bmp_configuration(self) -> pulumi.Input[Optional['BmpConfigurationPropertiesArgs']]:
        """
        BMP Configurations for the Network Fabric.
        """
    ...
    def bmp_configuration(self, value: pulumi.Input[Optional['BmpConfigurationPropertiesArgs']]):
...
class NetworkTapPropertiesDestinationsArgsDict(TypedDict):
    ...
    """
    isolation_domain_properties: NotRequired[pulumi.Input[Optional['IsolationDomainPropertiesArgs']]]
    """
    Isolation Domain Properties.
    """
...
class NetworkTapRuleMatchConditionArgsDict(TypedDict):
    ...
    IP condition that needs to be matched.
    """
    port_condition: NotRequired[pulumi.Input[Optional['PortConditionArgs']]]
    """
    Defines the port condition that needs to be matched.
    """
    protocol_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
...
class NetworkTapRuleMatchConfigurationArgsDict(TypedDict):
    ...
    Defines the match configuration that are supported to filter the traffic.
    """
    actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NetworkTapRuleActionArgs']]]]]
    """
    List of actions that need to be performed for the matched conditions.
    """
    ip_address_type: NotRequired[pulumi.Input[Optional[Union[_builtins.str, 'IPAddressType']]]]
    ...
    Type of IP Address. IPv4 or IPv6
    """
    match_conditions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NetworkTapRuleMatchConditionArgs']]]]]
    """
    List of the match conditions.
    """
    match_configuration_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
...
class StatementActionPropertiesArgsDict(TypedDict):
    ...
    """
    ip_community_properties: NotRequired[pulumi.Input[Optional['ActionIpCommunityPropertiesArgs']]]
    """
    IP Community Properties.
    """
    ip_extended_community_properties: NotRequired[pulumi.Input[Optional['ActionIpExtendedCommunityPropertiesArgs']]]
    """
    IP Extended Community Properties.
    """
...
class VpnConfigurationPropertiesArgsDict(TypedDict):
    ...
    """
    option_a_properties: NotRequired[pulumi.Input[Optional['VpnConfigurationPropertiesOptionAPropertiesArgs']]]
    """
    option A properties
    """
    option_b_properties: NotRequired[pulumi.Input[Optional['FabricOptionBPropertiesArgs']]]
    """
    option B properties
    """
