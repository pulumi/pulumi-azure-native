...
class GetNetworkInterfaceStatusResult:
    ...
    def connected_to(self) -> Optional[builtins.str]:
        """
    ...
    def operational_status(self) -> Optional[builtins.str]:
        """
    ...
    def phy_status(self) -> Optional[builtins.str]:
        """
        The physical status.
        """
    ...
    def transceiver_status(self) -> Optional[builtins.str]:
        """
...
def get_network_interface_status(network_device_name: Optional[builtins.str] = None,
    ...
    :param builtins.str network_device_name: Name of the NetworkDevice.
    :param builtins.str network_interface_name: Name of the NetworkInterface
...
def get_network_interface_status_output(network_device_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric:getNetworkInterfaceStatus', __args__, opts=opts, typ=GetNetworkInterfaceStatusResult)
