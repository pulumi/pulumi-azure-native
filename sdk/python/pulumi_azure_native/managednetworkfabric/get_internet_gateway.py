...
def get_internet_gateway(internet_gateway_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str internet_gateway_name: Name of the Internet Gateway.
...
def get_internet_gateway_output(internet_gateway_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
