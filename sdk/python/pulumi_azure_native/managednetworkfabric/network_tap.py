...
class NetworkTapArgs:
    def __init__(__self__, *,
                 ...
                 network_packet_broker_id: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 annotation: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 network_tap_name: Optional[pulumi.Input[builtins.str]] = None,
                 polling_type: Optional[pulumi.Input[Union[builtins.str, 'PollingType']]] = None,
        ...
        :param pulumi.Input[builtins.str] network_packet_broker_id: ARM resource ID of the Network Packet Broker.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] annotation: Switch configuration description.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] network_tap_name: Name of the Network Tap.
        :param pulumi.Input[Union[builtins.str, 'PollingType']] polling_type: Polling type.
    ...
    def network_packet_broker_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_packet_broker_id(self, value: pulumi.Input[builtins.str]):
    ...
    def network_tap_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_tap_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_tap_name", value)

    @property
    @pulumi.getter(name="pollingType")
    def polling_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'PollingType']]]:
        """
        Polling type.
        """
    ...
    @polling_type.setter
    def polling_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'PollingType']]]):
...
class NetworkTap(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 network_packet_broker_id: Optional[pulumi.Input[builtins.str]] = None,
                 network_tap_name: Optional[pulumi.Input[builtins.str]] = None,
                 polling_type: Optional[pulumi.Input[Union[builtins.str, 'PollingType']]] = None,
    ...
    @property
    @pulumi.getter(name="networkPacketBrokerId")
    def network_packet_broker_id(self) -> pulumi.Output[builtins.str]:
        """
        ARM resource ID of the Network Packet Broker.
        """
        return pulumi.get(self, "network_packet_broker_id")
    ...
    @property
    @pulumi.getter(name="pollingType")
    def polling_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Polling type.
        """
        return pulumi.get(self, "polling_type")
    ...
    def source_tap_rule_id(self) -> pulumi.Output[builtins.str]:
        """
