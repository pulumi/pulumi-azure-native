...
def get_external_network(external_network_name: Optional[_builtins.str] = None,
                         l3_isolation_domain_name: Optional[_builtins.str] = None,
...
def get_external_network_output(external_network_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
