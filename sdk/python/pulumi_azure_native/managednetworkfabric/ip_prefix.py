...
class IpPrefixArgs:
    def __init__(__self__, *,
                 ip_prefix_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] ip_prefix_name: Name of the IP Prefix.
    ...
    def ip_prefix_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def ip_prefix_name(self, value: pulumi.Input[_builtins.str]):
...
class IpPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotation: pulumi.Input[Optional[_builtins.str]] = None,
                 ip_prefix_name: pulumi.Input[Optional[_builtins.str]] = None,
                 ip_prefix_rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['IpPrefixRuleArgs', 'IpPrefixRuleArgsDict']]]]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if ip_prefix_name is None and not opts.urn:
                raise TypeError("Missing required property 'ip_prefix_name'")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:IpPrefix")])
