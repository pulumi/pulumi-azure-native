...
class IpPrefixArgs:
    ...
    def ip_prefix_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def ip_prefix_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class IpPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20250715:IpPrefix")])
