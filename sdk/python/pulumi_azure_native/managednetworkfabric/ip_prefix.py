...
class IpPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:IpPrefix"), pulumi.Alias(type_="azure-native_managednetworkfabric_v20230201preview:managednetworkfabric:IpPrefix"), pulumi.Alias(type_="azure-native_managednetworkfabric_v20230615:managednetworkfabric:IpPrefix")])
