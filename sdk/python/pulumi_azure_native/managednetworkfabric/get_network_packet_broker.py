...
def get_network_packet_broker(network_packet_broker_name: Optional[_builtins.str] = None,
...
def get_network_packet_broker_output(network_packet_broker_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
