...
def get_ip_extended_community(ip_extended_community_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ip_extended_community_name: Name of the IP Extended Community.
...
def get_ip_extended_community_output(ip_extended_community_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
