...
class ExternalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:ExternalNetwork"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:ExternalNetwork"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:ExternalNetwork"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:ExternalNetwork")])
