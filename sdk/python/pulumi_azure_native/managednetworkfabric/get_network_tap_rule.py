...
def get_network_tap_rule(network_tap_rule_name: Optional[_builtins.str] = None,
...
def get_network_tap_rule_output(network_tap_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
