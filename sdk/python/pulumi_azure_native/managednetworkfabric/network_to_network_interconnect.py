...
class NetworkToNetworkInterconnectArgs:
    def __init__(__self__, *,
                 network_fabric_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 use_option_b: pulumi.Input[Union[builtins.str, 'BooleanEnumProperty']],
                 ...
                 is_management_type: Optional[pulumi.Input[Union[builtins.str, 'IsManagementType']]] = None,
                 ...
                 nni_type: Optional[pulumi.Input[Union[builtins.str, 'NniType']]] = None,
        ...
        :param pulumi.Input[builtins.str] network_fabric_name: Name of the Network Fabric.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Union[builtins.str, 'BooleanEnumProperty']] use_option_b: Based on this option layer3 parameters are mandatory. Example: True/False
        ...
        :param pulumi.Input[Union[builtins.str, 'IsManagementType']] is_management_type: Configuration to use NNI for Infrastructure Management. Example: True/False.
        :param pulumi.Input['Layer2ConfigurationArgs'] layer2_configuration: Common properties for Layer2 Configuration.
        :param pulumi.Input[builtins.str] network_to_network_interconnect_name: Name of the Network to Network Interconnect.
        :param pulumi.Input[Union[builtins.str, 'NniType']] nni_type: Type of NNI used. Example: CE | NPB
    ...
    def network_fabric_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_fabric_name(self, value: pulumi.Input[builtins.str]):
    ...
    def use_option_b(self) -> pulumi.Input[Union[builtins.str, 'BooleanEnumProperty']]:
        """
    ...
    @use_option_b.setter
    def use_option_b(self, value: pulumi.Input[Union[builtins.str, 'BooleanEnumProperty']]):
    ...
    def is_management_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'IsManagementType']]]:
        """
    ...
    def is_management_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'IsManagementType']]]):
    ...
    def network_to_network_interconnect_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_to_network_interconnect_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_to_network_interconnect_name", value)

    @property
    @pulumi.getter(name="nniType")
    def nni_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'NniType']]]:
        """
    ...
    @nni_type.setter
    def nni_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'NniType']]]):
...
class NetworkToNetworkInterconnect(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 network_fabric_name: Optional[pulumi.Input[builtins.str]] = None,
                 network_to_network_interconnect_name: Optional[pulumi.Input[builtins.str]] = None,
                 nni_type: Optional[pulumi.Input[Union[builtins.str, 'NniType']]] = None,
                 ...
                 use_option_b: Optional[pulumi.Input[Union[builtins.str, 'BooleanEnumProperty']]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="isManagementType")
    def is_management_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Configuration to use NNI for Infrastructure Management. Example: True/False.
        """
        return pulumi.get(self, "is_management_type")
    ...
    @property
    @pulumi.getter(name="nniType")
    def nni_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of NNI used. Example: CE | NPB
        """
        return pulumi.get(self, "nni_type")
    ...
    @property
    @pulumi.getter(name="useOptionB")
    def use_option_b(self) -> pulumi.Output[builtins.str]:
        """
        Based on this option layer3 parameters are mandatory. Example: True/False
        """
        return pulumi.get(self, "use_option_b")
