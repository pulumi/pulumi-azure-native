...
class InternetGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:InternetGateway"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:InternetGateway"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:InternetGateway")])
