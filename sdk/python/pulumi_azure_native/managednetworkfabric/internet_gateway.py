...
class InternetGatewayArgs:
    def __init__(__self__, *,
                 ...
                 internet_gateway_name: Optional[pulumi.Input[_builtins.str]] = None,
                 internet_gateway_rule_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def internet_gateway_rule_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class InternetGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 type: Optional[pulumi.Input[Union[_builtins.str, 'GatewayType']]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:InternetGateway"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:InternetGateway"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:InternetGateway"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20250715:InternetGateway")])
