...
def get_ip_prefix(ip_prefix_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ip_prefix_name: Name of the IP Prefix.
...
def get_ip_prefix_output(ip_prefix_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
