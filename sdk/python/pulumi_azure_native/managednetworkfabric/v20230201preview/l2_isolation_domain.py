...
class L2IsolationDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        l2_isolation_domain = azure_native.managednetworkfabric.v20230201preview.L2IsolationDomain("l2IsolationDomain",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:L2IsolationDomain")])
