...
class NetworkToNetworkInterconnect(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_to_network_interconnect = azure_native.managednetworkfabric.v20230201preview.NetworkToNetworkInterconnect("networkToNetworkInterconnect",
            is_management_type="True",
            layer2_configuration=azure_native.managednetworkfabric.v20230201preview.NetworkToNetworkInterconnectPropertiesResponseLayer2ConfigurationArgs(
                mtu=1500,
                port_count=10,
            ),
            layer3_configuration=azure_native.managednetworkfabric.v20230201preview.Layer3ConfigurationArgs(
