...
class RoutePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        route_policy = azure_native.managednetworkfabric.v20230201preview.RoutePolicy("routePolicy",
            annotation="example routepolicy",
            conditions=[{
                "action": {
                    "action": "allow",
                    "set": {
                        "set": azure_native.managednetworkfabric.v20230201preview.RoutePolicyPropertiesSetSetArgs(
                ...
                "annotation": "",
                "match": azure_native.managednetworkfabric.v20230201preview.RoutePolicyPropertiesMatchArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:RoutePolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoutePolicy, __self__).__init__(
            'azure-native:managednetworkfabric/v20230201preview:RoutePolicy',
            resource_name,
            __props__,
            opts)
