...
class InternalNetworkArgs:
    ...
    def _configure(
        ...
        if bgp_configuration is None and 'bgpConfiguration' in kwargs:
            bgp_configuration = kwargs['bgpConfiguration']
        if connected_i_pv4_subnets is None and 'connectedIPv4Subnets' in kwargs:
            connected_i_pv4_subnets = kwargs['connectedIPv4Subnets']
        if connected_i_pv6_subnets is None and 'connectedIPv6Subnets' in kwargs:
        ...
        if internal_network_name is None and 'internalNetworkName' in kwargs:
            internal_network_name = kwargs['internalNetworkName']
        if static_route_configuration is None and 'staticRouteConfiguration' in kwargs:
...
class InternalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            bgp_configuration = _utilities.configure(bgp_configuration, BgpConfigurationArgs, True)
            ...
            static_route_configuration = _utilities.configure(static_route_configuration, StaticRouteConfigurationArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:InternalNetwork"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:InternalNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(InternalNetwork, __self__).__init__(
            'azure-native:managednetworkfabric/v20230201preview:InternalNetwork',
            resource_name,
            __props__,
            opts)
