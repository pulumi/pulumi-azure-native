...
class NetworkFabricControllerArgs:
    ...
    def _configure(
        ...
        if 'networkFabricControllerName' in kwargs:
            network_fabric_controller_name = kwargs['networkFabricControllerName']
        if 'workloadExpressRouteConnections' in kwargs:
