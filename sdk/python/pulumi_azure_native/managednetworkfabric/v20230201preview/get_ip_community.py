...
def get_ip_community(ip_community_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managednetworkfabric/v20230201preview:getIpCommunity', __args__, opts=opts, typ=GetIpCommunityResult).value
...
def get_ip_community_output(ip_community_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric/v20230201preview:getIpCommunity', __args__, opts=opts, typ=GetIpCommunityResult)
