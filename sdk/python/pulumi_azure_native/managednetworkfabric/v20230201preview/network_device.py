...
class NetworkDeviceArgs:
    def __init__(__self__, *,
        ...
        NetworkDeviceArgs._configure(
            ...
            network_device_role=network_device_role,
    ...
    def _configure(
             ...
             **kwargs):
        if network_device_role is None and 'networkDeviceRole' in kwargs:
            network_device_role = kwargs['networkDeviceRole']
        if network_device_role is None:
            raise TypeError("Missing 'network_device_role' argument")
        if network_device_sku is None and 'networkDeviceSku' in kwargs:
            network_device_sku = kwargs['networkDeviceSku']
        if network_device_sku is None:
            raise TypeError("Missing 'network_device_sku' argument")
        ...
        _setter("network_device_role", network_device_role)
...
class NetworkDevice(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:NetworkDevice"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkDevice")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkDevice, __self__).__init__(
            'azure-native:managednetworkfabric/v20230201preview:NetworkDevice',
            resource_name,
            __props__,
            opts)
