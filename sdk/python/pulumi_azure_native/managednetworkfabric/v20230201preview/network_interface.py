...
class NetworkInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:NetworkInterface"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkInterface")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkInterface, __self__).__init__(
            'azure-native:managednetworkfabric/v20230201preview:NetworkInterface',
            resource_name,
            __props__,
            opts)
