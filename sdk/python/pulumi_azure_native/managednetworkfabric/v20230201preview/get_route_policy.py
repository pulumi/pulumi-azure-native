...
def get_route_policy(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managednetworkfabric/v20230201preview:getRoutePolicy', __args__, opts=opts, typ=GetRoutePolicyResult).value
...
def get_route_policy_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['routePolicyName'] = route_policy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric/v20230201preview:getRoutePolicy', __args__, opts=opts, typ=GetRoutePolicyResult)
