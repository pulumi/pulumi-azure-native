...
def get_access_control_list_output(access_control_list_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric/v20230201preview:getAccessControlList', __args__, opts=opts, typ=GetAccessControlListResult)
