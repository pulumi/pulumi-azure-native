...
def get_internal_network_output(internal_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric/v20230201preview:getInternalNetwork', __args__, opts=opts, typ=GetInternalNetworkResult)
