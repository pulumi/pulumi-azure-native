...
class IpPrefixArgs:
    ...
    def _configure(
             ...
             ip_prefix_rules: Optional[pulumi.Input[Sequence[pulumi.Input['IpPrefixPropertiesIpPrefixRulesArgs']]]] = None,
             ...
             **kwargs):
        if ip_prefix_rules is None and 'ipPrefixRules' in kwargs:
            ip_prefix_rules = kwargs['ipPrefixRules']
        if ip_prefix_rules is None:
            raise TypeError("Missing 'ip_prefix_rules' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if ip_prefix_name is None and 'ipPrefixName' in kwargs:
...
class IpPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:IpPrefix"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:IpPrefix")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IpPrefix, __self__).__init__(
            'azure-native:managednetworkfabric/v20230201preview:IpPrefix',
            resource_name,
            __props__,
            opts)
