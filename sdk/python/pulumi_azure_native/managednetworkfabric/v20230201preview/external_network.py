...
class ExternalNetworkArgs:
    ...
    def _configure(
        ...
        if 'externalNetworkName' in kwargs:
...
class ExternalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if option_a_properties is not None and not isinstance(option_a_properties, ExternalNetworkPropertiesOptionAPropertiesArgs):
                option_a_properties = option_a_properties or {}
                def _setter(key, value):
                    option_a_properties[key] = value
                ExternalNetworkPropertiesOptionAPropertiesArgs._configure(_setter, **option_a_properties)
            __props__.__dict__["option_a_properties"] = option_a_properties
            if option_b_properties is not None and not isinstance(option_b_properties, OptionBPropertiesArgs):
                option_b_properties = option_b_properties or {}
                def _setter(key, value):
                    option_b_properties[key] = value
                OptionBPropertiesArgs._configure(_setter, **option_b_properties)
