...
class L3IsolationDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(aggregate_route_configuration, AggregateRouteConfigurationArgs):
            ...
            if not isinstance(connected_subnet_route_policy, L3IsolationDomainPatchPropertiesConnectedSubnetRoutePolicyArgs):
