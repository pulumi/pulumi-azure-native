...
class L3IsolationDomainArgs:
    ...
    def _configure(
        ...
        if 'aggregateRouteConfiguration' in kwargs:
            aggregate_route_configuration = kwargs['aggregateRouteConfiguration']
        if 'connectedSubnetRoutePolicy' in kwargs:
        ...
        if 'redistributeConnectedSubnets' in kwargs:
            redistribute_connected_subnets = kwargs['redistributeConnectedSubnets']
        if 'redistributeStaticRoutes' in kwargs:
...
class L3IsolationDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if aggregate_route_configuration is not None and not isinstance(aggregate_route_configuration, AggregateRouteConfigurationArgs):
                aggregate_route_configuration = aggregate_route_configuration or {}
                def _setter(key, value):
                    aggregate_route_configuration[key] = value
                AggregateRouteConfigurationArgs._configure(_setter, **aggregate_route_configuration)
            __props__.__dict__["aggregate_route_configuration"] = aggregate_route_configuration
            __props__.__dict__["annotation"] = annotation
            if connected_subnet_route_policy is not None and not isinstance(connected_subnet_route_policy, L3IsolationDomainPatchPropertiesConnectedSubnetRoutePolicyArgs):
                connected_subnet_route_policy = connected_subnet_route_policy or {}
                def _setter(key, value):
                    connected_subnet_route_policy[key] = value
                L3IsolationDomainPatchPropertiesConnectedSubnetRoutePolicyArgs._configure(_setter, **connected_subnet_route_policy)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric:L3IsolationDomain"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:L3IsolationDomain")])
