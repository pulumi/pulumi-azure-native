...
class L3IsolationDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        l3_isolation_domain = azure_native.managednetworkfabric.v20230201preview.L3IsolationDomain("l3IsolationDomain",
            aggregate_route_configuration=azure_native.managednetworkfabric.v20230201preview.L3IsolationDomainPatchPropertiesResponseAggregateRouteConfigurationArgs(
                ipv4_routes=[azure_native.managednetworkfabric.v20230201preview.L3IsolationDomainPatchPropertiesIpv4RoutesArgs(
                    prefix="10.0.0.0/24",
                )],
                ipv6_routes=[azure_native.managednetworkfabric.v20230201preview.L3IsolationDomainPatchPropertiesIpv6RoutesArgs(
                    prefix="10.0.0.1",
                )],
            ),
            connected_subnet_route_policy=azure_native.managednetworkfabric.v20230201preview.L3IsolationDomainPatchPropertiesConnectedSubnetRoutePolicyArgs(
