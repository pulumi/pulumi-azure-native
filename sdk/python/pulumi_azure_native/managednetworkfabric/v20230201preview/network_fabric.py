...
class NetworkFabricArgs:
    ...
    def _configure(
             ...
             management_network_configuration: Optional[pulumi.Input['ManagementNetworkConfigurationArgs']] = None,
        ...
        if rack_count is None:
            raise TypeError("Missing 'rack_count' argument")
...
class NetworkFabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            management_network_configuration = _utilities.configure(management_network_configuration, ManagementNetworkConfigurationArgs, True)
