...
class NetworkFabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(management_network_configuration, ManagementNetworkConfigurationArgs):
            ...
            if not isinstance(terminal_server_configuration, TerminalServerConfigurationArgs):
