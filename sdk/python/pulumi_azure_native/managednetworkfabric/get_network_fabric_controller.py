...
def get_network_fabric_controller(network_fabric_controller_name: Optional[_builtins.str] = None,
...
def get_network_fabric_controller_output(network_fabric_controller_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
