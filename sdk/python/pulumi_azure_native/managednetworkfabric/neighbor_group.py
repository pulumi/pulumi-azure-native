...
class NeighborGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotation: pulumi.Input[Optional[_builtins.str]] = None,
                 destination: pulumi.Input[Optional[Union['NeighborGroupDestinationArgs', 'NeighborGroupDestinationArgsDict']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 neighbor_group_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NeighborGroup"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:NeighborGroup"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:NeighborGroup"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20250715:NeighborGroup")])
