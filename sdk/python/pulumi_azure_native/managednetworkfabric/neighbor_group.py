...
class NeighborGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NeighborGroup"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:NeighborGroup"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:NeighborGroup")])
