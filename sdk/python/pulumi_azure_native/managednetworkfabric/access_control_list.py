...
class AccessControlList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotation: Optional[pulumi.Input[str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AccessControlListConditionPropertiesArgs', 'AccessControlListConditionPropertiesArgsDict']]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union[str, 'AddressFamily']] address_family: IP address family. Example: ipv4 | ipv6.
        :param pulumi.Input[str] annotation: Switch configuration description.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AccessControlListConditionPropertiesArgs', 'AccessControlListConditionPropertiesArgsDict']]]] conditions: Access Control List conditions.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
