...
class NetworkPacketBrokerArgs:
    def __init__(__self__, *,
                 ...
                 network_packet_broker_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def network_packet_broker_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class NetworkPacketBroker(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkPacketBroker"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:NetworkPacketBroker"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:NetworkPacketBroker"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20250715:NetworkPacketBroker")])
