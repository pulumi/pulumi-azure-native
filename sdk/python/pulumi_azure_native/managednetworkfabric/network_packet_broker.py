...
class NetworkPacketBrokerArgs:
    def __init__(__self__, *,
                 ...
                 network_packet_broker_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] network_packet_broker_name: Name of the Network Packet Broker.
    ...
    def network_packet_broker_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_packet_broker_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NetworkPacketBroker(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NetworkPacketBrokerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NetworkPacketBrokerArgs.__new__(NetworkPacketBrokerArgs)
            ...
            __props__.__dict__["neighbor_group_ids"] = None
            __props__.__dict__["network_device_ids"] = None
            __props__.__dict__["network_tap_ids"] = None
            __props__.__dict__["provisioning_state"] = None
            __props__.__dict__["source_interface_ids"] = None
            __props__.__dict__["system_data"] = None
            __props__.__dict__["type"] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkPacketBroker")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkPacketBroker, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NetworkPacketBroker':
        """
        ...
        __props__.__dict__["type"] = None
        return NetworkPacketBroker(resource_name, opts=opts, __props__=__props__)
    ...
    def neighbor_group_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def network_device_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def network_tap_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def source_interface_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
