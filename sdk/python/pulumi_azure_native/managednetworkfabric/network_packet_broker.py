...
class NetworkPacketBrokerArgs:
    ...
    def network_packet_broker_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def network_packet_broker_name(self, value: Optional[pulumi.Input[str]]):
...
class NetworkPacketBroker(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkPacketBroker"), pulumi.Alias(type_="azure-native_managednetworkfabric_v20230615:managednetworkfabric:NetworkPacketBroker")])
    ...
    def neighbor_group_ids(self) -> pulumi.Output[Sequence[str]]:
        """
    ...
    def network_device_ids(self) -> pulumi.Output[Sequence[str]]:
        """
    ...
    def source_interface_ids(self) -> pulumi.Output[Sequence[str]]:
        """
