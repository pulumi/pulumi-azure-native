...
def get_internet_gateway_rule(internet_gateway_rule_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str internet_gateway_rule_name: Name of the Internet Gateway rule.
...
def get_internet_gateway_rule_output(internet_gateway_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
