...
class NetworkBootstrapDeviceArgs:
    ...
    def network_bootstrap_device_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def network_bootstrap_device_name(self, value: pulumi.Input[Optional[_builtins.str]]):
