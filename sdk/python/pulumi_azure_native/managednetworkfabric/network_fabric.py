...
class NetworkFabric(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_fabric = azure_native.managednetworkfabric.NetworkFabric("networkFabric",
            ...
            management_network_configuration=azure_native.managednetworkfabric.NetworkFabricPropertiesResponseManagementNetworkConfigurationArgs(
                infrastructure_vpn_configuration=azure_native.managednetworkfabric.NetworkFabricPropertiesInfrastructureVpnConfigurationArgs(
                ...
                workload_vpn_configuration=azure_native.managednetworkfabric.NetworkFabricPropertiesWorkloadVpnConfigurationArgs(
                    option_b_properties=azure_native.managednetworkfabric.FabricOptionBPropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:NetworkFabric")])
