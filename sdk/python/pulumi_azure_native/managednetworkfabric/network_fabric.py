...
class NetworkFabricArgs:
    def __init__(__self__, *,
                 fabric_asn: pulumi.Input[builtins.float],
                 ipv4_prefix: pulumi.Input[builtins.str],
                 ...
                 network_fabric_sku: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 server_count_per_rack: pulumi.Input[builtins.int],
                 ...
                 fabric_version: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 network_fabric_name: Optional[pulumi.Input[builtins.str]] = None,
                 rack_count: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a NetworkFabric resource.
        :param pulumi.Input[builtins.float] fabric_asn: ASN of CE devices for CE/PE connectivity.
        :param pulumi.Input[builtins.str] ipv4_prefix: IPv4Prefix for Management Network. Example: 10.1.0.0/19.
        ...
        :param pulumi.Input[builtins.str] network_fabric_controller_id: Azure resource ID for the NetworkFabricController the NetworkFabric belongs.
        :param pulumi.Input[builtins.str] network_fabric_sku: Supported Network Fabric SKU.Example: Compute / Aggregate racks. Once the user chooses a particular SKU, only supported racks can be added to the Network Fabric. The SKU determines whether it is a single / multi rack Network Fabric.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.int] server_count_per_rack: Number of servers.Possible values are from 1-16.
        ...
        :param pulumi.Input[builtins.str] fabric_version: The version of Network Fabric.
        :param pulumi.Input[builtins.str] ipv6_prefix: IPv6Prefix for Management Network. Example: 3FFE:FFFF:0:CD40::/59
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] network_fabric_name: Name of the Network Fabric.
        :param pulumi.Input[builtins.int] rack_count: Number of compute racks associated to Network Fabric.
    ...
    def fabric_asn(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @fabric_asn.setter
    def fabric_asn(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "fabric_asn", value)

    @property
    @pulumi.getter(name="ipv4Prefix")
    def ipv4_prefix(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ipv4_prefix.setter
    def ipv4_prefix(self, value: pulumi.Input[builtins.str]):
    ...
    def network_fabric_sku(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_fabric_sku(self, value: pulumi.Input[builtins.str]):
    ...
    def server_count_per_rack(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def server_count_per_rack(self, value: pulumi.Input[builtins.int]):
    ...
    def fabric_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fabric_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def network_fabric_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_fabric_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_fabric_name", value)

    @property
    @pulumi.getter(name="rackCount")
    def rack_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @rack_count.setter
    def rack_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class NetworkFabric(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotation: Optional[pulumi.Input[builtins.str]] = None,
                 fabric_asn: Optional[pulumi.Input[builtins.float]] = None,
                 fabric_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 network_fabric_name: Optional[pulumi.Input[builtins.str]] = None,
                 network_fabric_sku: Optional[pulumi.Input[builtins.str]] = None,
                 rack_count: Optional[pulumi.Input[builtins.int]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 server_count_per_rack: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="fabricASN")
    def fabric_asn(self) -> pulumi.Output[builtins.float]:
        """
        ASN of CE devices for CE/PE connectivity.
        """
        return pulumi.get(self, "fabric_asn")
    ...
    @property
    @pulumi.getter(name="fabricVersion")
    def fabric_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of Network Fabric.
        """
        return pulumi.get(self, "fabric_version")
    ...
    def l2_isolation_domains(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def l3_isolation_domains(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="networkFabricSku")
    def network_fabric_sku(self) -> pulumi.Output[builtins.str]:
        """
        Supported Network Fabric SKU.Example: Compute / Aggregate racks. Once the user chooses a particular SKU, only supported racks can be added to the Network Fabric. The SKU determines whether it is a single / multi rack Network Fabric.
        """
        return pulumi.get(self, "network_fabric_sku")
    ...
    @property
    @pulumi.getter(name="rackCount")
    def rack_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of compute racks associated to Network Fabric.
        """
        return pulumi.get(self, "rack_count")
    ...
    @property
    @pulumi.getter
    def racks(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def router_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Array of router IDs.
        """
    ...
    @property
    @pulumi.getter(name="serverCountPerRack")
    def server_count_per_rack(self) -> pulumi.Output[builtins.int]:
        """
        Number of servers.Possible values are from 1-16.
        """
        return pulumi.get(self, "server_count_per_rack")
