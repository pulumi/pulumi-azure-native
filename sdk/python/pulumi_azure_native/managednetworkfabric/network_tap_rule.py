...
class NetworkTapRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:NetworkTapRule"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:NetworkTapRule"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:NetworkTapRule"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20250715:NetworkTapRule")])
