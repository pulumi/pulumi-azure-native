...
def get_l2_isolation_domain(l2_isolation_domain_name: Optional[builtins.str] = None,
    ...
    :param builtins.str l2_isolation_domain_name: Name of the L2 Isolation Domain.
...
def get_l2_isolation_domain_output(l2_isolation_domain_name: Optional[pulumi.Input[builtins.str]] = None,
