...
class GetL2IsolationDomainResult:
    ...
    """
    def __init__(__self__, administrative_state=None, annotation=None, azure_api_version=None, configuration_state=None, id=None, location=None, mtu=None, name=None, network_fabric_id=None, provisioning_state=None, system_data=None, tags=None, type=None, vlan_id=None):
...
def get_l2_isolation_domain(l2_isolation_domain_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str l2_isolation_domain_name: Name of the L2 Isolation Domain.
...
def get_l2_isolation_domain_output(l2_isolation_domain_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetworkfabric:getL2IsolationDomain', __args__, opts=opts, typ=GetL2IsolationDomainResult)
