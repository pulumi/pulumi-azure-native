...
def get_l3_isolation_domain(l3_isolation_domain_name: Optional[_builtins.str] = None,
...
def get_l3_isolation_domain_output(l3_isolation_domain_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
