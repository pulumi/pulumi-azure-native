...
class L2IsolationDomainArgs:
    def __init__(__self__, *,
                 ...
                 l2_isolation_domain_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def l2_isolation_domain_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class L2IsolationDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managednetworkfabric/v20230201preview:L2IsolationDomain"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20230615:L2IsolationDomain"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240215preview:L2IsolationDomain"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20240615preview:L2IsolationDomain"), pulumi.Alias(type_="azure-native:managednetworkfabric/v20250715:L2IsolationDomain")])
