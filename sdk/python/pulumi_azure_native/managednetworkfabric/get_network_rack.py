...
def get_network_rack(network_rack_name: Optional[_builtins.str] = None,
...
def get_network_rack_output(network_rack_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
