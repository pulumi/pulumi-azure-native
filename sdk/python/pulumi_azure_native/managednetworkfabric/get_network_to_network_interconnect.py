...
def get_network_to_network_interconnect(network_fabric_name: Optional[_builtins.str] = None,
                                        network_to_network_interconnect_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_to_network_interconnect_name: Name of the Network to Network Interconnect.
