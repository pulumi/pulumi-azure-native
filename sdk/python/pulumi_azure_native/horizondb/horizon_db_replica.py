...
__all__ = ['HorizonDbReplicaArgs', 'HorizonDbReplica']
...
class HorizonDbReplicaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['HorizonDbReplicaPropertiesArgs'] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] replica_name: The name of the HorizonDB replica.
        """
...
@pulumi.type_token("azure-native:horizondb:HorizonDbReplica")
class HorizonDbReplica(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        :param pulumi.Input[_builtins.str] cluster_name: The name of the HorizonDB cluster.
        :param pulumi.Input[_builtins.str] pool_name: The name of the HorizonDB pool.
        :param pulumi.Input[Union['HorizonDbReplicaPropertiesArgs', 'HorizonDbReplicaPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] replica_name: The name of the HorizonDB replica.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(HorizonDbReplicaArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = HorizonDbReplicaArgs.__new__(HorizonDbReplicaArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:horizondb/v20260120preview:HorizonDbReplica")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HorizonDbReplica, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'HorizonDbReplica':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return HorizonDbReplica(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.HorizonDbReplicaPropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
