...
class JobDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 data_service_name: pulumi.Input[_builtins.str],
                 data_sink_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] data_service_name: The data service type of the job definition.
        :param pulumi.Input[_builtins.str] data_sink_id: Data Sink Id associated to the job definition.
        :param pulumi.Input[_builtins.str] data_source_id: Data Source Id associated to the job definition.
        ...
        :param pulumi.Input[_builtins.str] job_definition_name: The job definition name to be created or updated.
        :param pulumi.Input[_builtins.str] last_modified_time: Last modified time of the job definition.
    ...
    def data_service_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def data_service_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "data_service_name", value)

    @_builtins.property
    @pulumi.getter(name="dataSinkId")
    def data_sink_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @data_sink_id.setter
    def data_sink_id(self, value: pulumi.Input[_builtins.str]):
...
class JobDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_sink_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="dataSinkId")
    def data_sink_id(self) -> pulumi.Output[_builtins.str]:
        """
        Data Sink Id associated to the job definition.
        """
        return pulumi.get(self, "data_sink_id")
    ...
    @_builtins.property
    @pulumi.getter(name="runLocation")
    def run_location(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        This is the preferred geo location for the job to run.
        """
        return pulumi.get(self, "run_location")
    ...
    @_builtins.property
    @pulumi.getter(name="userConfirmation")
    def user_confirmation(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Enum to detect if user confirmation is required. If not passed will default to NotRequired.
        """
        return pulumi.get(self, "user_confirmation")
