...
class JobDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 data_service_name: pulumi.Input[builtins.str],
                 data_sink_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] data_service_name: The data service type of the job definition.
        :param pulumi.Input[builtins.str] data_sink_id: Data Sink Id associated to the job definition.
        :param pulumi.Input[builtins.str] data_source_id: Data Source Id associated to the job definition.
        ...
        :param pulumi.Input[builtins.str] job_definition_name: The job definition name to be created or updated.
        :param pulumi.Input[builtins.str] last_modified_time: Last modified time of the job definition.
    ...
    def data_service_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_service_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "data_service_name", value)

    @property
    @pulumi.getter(name="dataSinkId")
    def data_sink_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @data_sink_id.setter
    def data_sink_id(self, value: pulumi.Input[builtins.str]):
...
class JobDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_sink_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dataSinkId")
    def data_sink_id(self) -> pulumi.Output[builtins.str]:
        """
        Data Sink Id associated to the job definition.
        """
        return pulumi.get(self, "data_sink_id")
    ...
    @property
    @pulumi.getter(name="runLocation")
    def run_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This is the preferred geo location for the job to run.
        """
        return pulumi.get(self, "run_location")
    ...
    @property
    @pulumi.getter(name="userConfirmation")
    def user_confirmation(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enum to detect if user confirmation is required. If not passed will default to NotRequired.
        """
        return pulumi.get(self, "user_confirmation")
