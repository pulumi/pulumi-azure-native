...
def get_data_manager(data_manager_name: Optional[_builtins.str] = None,
...
def get_data_manager_output(data_manager_name: Optional[pulumi.Input[_builtins.str]] = None,
