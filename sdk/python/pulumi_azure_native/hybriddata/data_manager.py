...
class DataManagerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The location of the resource. This will be one of the supported and registered Azure Geo Regions (e.g. West US, East
               US, Southeast Asia, etc.). The geo region of a resource cannot be changed once it is created, but if an identical geo
               region is specified on update the request will succeed.
        :param pulumi.Input['SkuArgs'] sku: The sku type.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource
    ...
    def data_manager_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def data_manager_name(self, value: Optional[pulumi.Input[_builtins.str]]):
