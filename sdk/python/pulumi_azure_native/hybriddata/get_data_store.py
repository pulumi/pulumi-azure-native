...
class GetDataStoreResult:
    ...
    def data_store_type_id(self) -> builtins.str:
        """
...
def get_data_store(data_manager_name: Optional[builtins.str] = None,
                   data_store_name: Optional[builtins.str] = None,
    ...
    :param builtins.str data_store_name: The data store/repository name queried.
...
def get_data_store_output(data_manager_name: Optional[pulumi.Input[builtins.str]] = None,
                          data_store_name: Optional[pulumi.Input[builtins.str]] = None,
