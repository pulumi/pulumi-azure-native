...
class GetDataStoreResult:
    ...
    def data_store_type_id(self) -> _builtins.str:
        """
...
def get_data_store(data_manager_name: Optional[_builtins.str] = None,
                   data_store_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_store_name: The data store/repository name queried.
...
def get_data_store_output(data_manager_name: Optional[pulumi.Input[_builtins.str]] = None,
                          data_store_name: Optional[pulumi.Input[_builtins.str]] = None,
