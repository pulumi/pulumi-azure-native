...
class DataManager(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_manager = azure_native.hybriddata.v20190601.DataManager("dataManager",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybriddata:DataManager"), pulumi.Alias(type_="azure-native:hybriddata/v20160601:DataManager")])
