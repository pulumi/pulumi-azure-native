...
class JobDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hybriddata/v20190601:JobDefinition"), pulumi.Alias(type_="azure-native:hybriddata:JobDefinition"), pulumi.Alias(type_="azure-nextgen:hybriddata:JobDefinition"), pulumi.Alias(type_="azure-native:hybriddata/latest:JobDefinition"), pulumi.Alias(type_="azure-nextgen:hybriddata/latest:JobDefinition"), pulumi.Alias(type_="azure-native:hybriddata/v20160601:JobDefinition"), pulumi.Alias(type_="azure-nextgen:hybriddata/v20160601:JobDefinition")])
