...
class JobDefinitionArgs:
    ...
    def _configure(
        ...
        if data_service_name is None and 'dataServiceName' in kwargs:
            data_service_name = kwargs['dataServiceName']
        if data_service_name is None:
            raise TypeError("Missing 'data_service_name' argument")
        if data_sink_id is None and 'dataSinkId' in kwargs:
            data_sink_id = kwargs['dataSinkId']
        if data_sink_id is None:
            raise TypeError("Missing 'data_sink_id' argument")
        ...
        if data_service_input is None and 'dataServiceInput' in kwargs:
        ...
        if run_location is None and 'runLocation' in kwargs:
            run_location = kwargs['runLocation']
        if user_confirmation is None and 'userConfirmation' in kwargs:
