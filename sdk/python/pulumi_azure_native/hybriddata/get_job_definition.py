...
class GetJobDefinitionResult:
    ...
    def data_sink_id(self) -> _builtins.str:
        """
    ...
    def run_location(self) -> Optional[_builtins.str]:
        """
    ...
    def user_confirmation(self) -> Optional[_builtins.str]:
        """
...
def get_job_definition(data_manager_name: Optional[_builtins.str] = None,
                       data_service_name: Optional[_builtins.str] = None,
                       job_definition_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_manager_name: The name of the DataManager Resource within the specified resource group. DataManager names must be between 3 and 24 characters in length and use any alphanumeric and underscore only
    :param _builtins.str data_service_name: The data service name of the job definition
    :param _builtins.str job_definition_name: The job definition name that is being queried.
...
def get_job_definition_output(data_manager_name: Optional[pulumi.Input[_builtins.str]] = None,
                              data_service_name: Optional[pulumi.Input[_builtins.str]] = None,
