...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:hybriddata/latest:DataManager":
                return DataManager(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybriddata/latest:DataStore":
                return DataStore(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybriddata/latest:JobDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-native", "hybriddata/latest", _module_instance)
