...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:hybriddata:getDataStore'.""", DeprecationWarning)
...
def get_data_store(data_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybriddata/latest:getDataStore', __args__, opts=opts, typ=GetDataStoreResult).value
