...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:hybriddata:getDataManager'.""", DeprecationWarning)
...
def get_data_manager(data_manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_manager is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:hybriddata:getDataManager'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybriddata/latest:getDataManager', __args__, opts=opts, typ=GetDataManagerResult).value
