...
class DataStore(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hybriddata:DataStore"), pulumi.Alias(type_="azure-native:hybriddata/latest:DataStore"), pulumi.Alias(type_="azure-nextgen:hybriddata/latest:DataStore"), pulumi.Alias(type_="azure-native:hybriddata/v20160601:DataStore"), pulumi.Alias(type_="azure-nextgen:hybriddata/v20160601:DataStore"), pulumi.Alias(type_="azure-native:hybriddata/v20190601:DataStore"), pulumi.Alias(type_="azure-nextgen:hybriddata/v20190601:DataStore")])
