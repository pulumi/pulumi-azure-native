...
class DataStoreArgs:
    def __init__(__self__, *,
                 data_manager_name: pulumi.Input[builtins.str],
                 data_store_type_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] data_manager_name: The name of the DataManager Resource within the specified resource group. DataManager names must be between 3 and 24 characters in length and use any alphanumeric and underscore only
        :param pulumi.Input[builtins.str] data_store_type_id: The arm id of the data store type.
        ...
        :param pulumi.Input[builtins.str] data_store_name: The data store/repository name to be created or updated.
        :param Any extended_properties: A generic json used differently by each data source type.
        :param pulumi.Input[builtins.str] repository_id: Arm Id for the manager resource to which the data source is associated. This is optional.
        """
    ...
    def data_manager_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_manager_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "data_manager_name", value)

    @property
    @pulumi.getter(name="dataStoreTypeId")
    def data_store_type_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_store_type_id(self, value: pulumi.Input[builtins.str]):
    ...
    def data_store_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_store_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataStore(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_manager_name: Optional[pulumi.Input[builtins.str]] = None,
                 data_store_name: Optional[pulumi.Input[builtins.str]] = None,
                 data_store_type_id: Optional[pulumi.Input[builtins.str]] = None,
                 extended_properties: Optional[Any] = None,
                 repository_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dataStoreTypeId")
    def data_store_type_id(self) -> pulumi.Output[builtins.str]:
        """
        The arm id of the data store type.
        """
        return pulumi.get(self, "data_store_type_id")
