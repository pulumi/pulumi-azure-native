...
class FlowProfileArgs:
    def __init__(__self__, *,
                 ...
                 flow_profile_name: pulumi.Input[Optional[_builtins.str]] = None,
                 identity: pulumi.Input[Optional['ManagedServiceIdentityArgs']] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional['FlowProfilePropertiesArgs']] = None,
        ...
        :param pulumi.Input['FlowProfilePropertiesArgs'] properties: The set of configuration properties that define the behavior and rules of the FlowProfile.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        pulumi.set(__self__, "pipeline_name", pipeline_name)
        pulumi.set(__self__, "resource_group_name", resource_group_name)
        if flow_profile_name is not None:
            pulumi.set(__self__, "flow_profile_name", flow_profile_name)
    ...
    def flow_profile_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ...
        """
        return pulumi.get(self, "flow_profile_name")

    @flow_profile_name.setter
    def flow_profile_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "flow_profile_name", value)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['FlowProfilePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['FlowProfilePropertiesArgs']]):
...
class FlowProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['FlowProfilePropertiesArgs', 'FlowProfilePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[_builtins.str] pipeline_name: The name of the pipeline on which to operate.
        :param pulumi.Input[Union['FlowProfilePropertiesArgs', 'FlowProfilePropertiesArgsDict']] properties: The set of configuration properties that define the behavior and rules of the FlowProfile.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FlowProfileArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FlowProfileArgs.__new__(FlowProfileArgs)

            __props__.__dict__["flow_profile_name"] = flow_profile_name
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredatatransfer/v20250530preview:FlowProfile"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20251010preview:FlowProfile"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20260206preview:FlowProfile")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FlowProfile':
        """
        ...
        __props__.__dict__["type"] = None
        return FlowProfile(resource_name, opts=opts, __props__=__props__)
