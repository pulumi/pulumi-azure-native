...
class ApiFlowOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str audience_override: Optional field to override the audience of the remote endpoint. Deprecated starting 2025-05-30-preview.
        :param builtins.str cname: Unique CNAME to represent the Azure Data Transfer API Flow instance
        :param builtins.str identity_translation: Determines which identity to use for extracting the user token for Azure Data Transfer API Flow. Deprecated starting 2025-05-30-preview.
        :param builtins.str remote_calling_mode_client_id: Remote stub app registration Client ID. Deprecated starting 2025-05-30-preview.
        :param builtins.str remote_endpoint: Remote host to which communication needs to be made. Deprecated starting 2025-05-30-preview.
        :param builtins.str sender_client_id: Sender's app user assigned Manage Identity client ID. Deprecated starting 2025-05-30-preview.
        """
