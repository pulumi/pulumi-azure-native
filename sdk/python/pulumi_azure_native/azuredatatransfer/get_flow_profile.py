...
def get_flow_profile(flow_profile_name: Optional[_builtins.str] = None,
                     pipeline_name: Optional[_builtins.str] = None,
                     resource_group_name: Optional[_builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFlowProfileResult:
    """
    ...
    """
    __args__ = dict()
    __args__['flowProfileName'] = flow_profile_name
    __args__['pipelineName'] = pipeline_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer:getFlowProfile', __args__, opts=opts, typ=GetFlowProfileResult).value

    return AwaitableGetFlowProfileResult(
...
def get_flow_profile_output(flow_profile_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer:getFlowProfile', __args__, opts=opts, typ=GetFlowProfileResult)
    return __ret__.apply(lambda __response__: GetFlowProfileResult(
