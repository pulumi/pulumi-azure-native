...
def get_flow_source_addresses(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:getFlowSourceAddresses', __args__, opts=opts, typ=GetFlowSourceAddressesResult).value
...
def get_flow_source_addresses_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:getFlowSourceAddresses', __args__, opts=opts, typ=GetFlowSourceAddressesResult)
