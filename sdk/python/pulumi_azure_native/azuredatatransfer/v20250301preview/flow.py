...
class Flow(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredatatransfer/v20231011preview:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240125:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240507:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240911:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240927:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer:Flow")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Flow, __self__).__init__(
            'azure-native:azuredatatransfer/v20250301preview:Flow',
            resource_name,
            __props__,
            opts)
