...
def get_flow_destination_endpoints(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:getFlowDestinationEndpoints', __args__, opts=opts, typ=GetFlowDestinationEndpointsResult).value
...
def get_flow_destination_endpoints_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:getFlowDestinationEndpoints', __args__, opts=opts, typ=GetFlowDestinationEndpointsResult)
