...
def list_list_pending_connection(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:listListPendingConnection', __args__, opts=opts, typ=ListListPendingConnectionResult).value
...
def list_list_pending_connection_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:listListPendingConnection', __args__, opts=opts, typ=ListListPendingConnectionResult)
