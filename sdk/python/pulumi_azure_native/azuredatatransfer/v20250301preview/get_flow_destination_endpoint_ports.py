...
def get_flow_destination_endpoint_ports(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:getFlowDestinationEndpointPorts', __args__, opts=opts, typ=GetFlowDestinationEndpointPortsResult).value
...
def get_flow_destination_endpoint_ports_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:getFlowDestinationEndpointPorts', __args__, opts=opts, typ=GetFlowDestinationEndpointPortsResult)
