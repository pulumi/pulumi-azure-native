...
class PipelineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ManagedServiceIdentityArgs'] identity: The managed identity of the pipeline resource, if configured.
...
class Pipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict']] identity: The managed identity of the pipeline resource, if configured.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] pipeline_name: The name for the pipeline that is to be requested.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredatatransfer/v20231011preview:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240125:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240507:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240911:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240927:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer:Pipeline")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pipeline, __self__).__init__(
            'azure-native:azuredatatransfer/v20250301preview:Pipeline',
            resource_name,
            __props__,
            opts)
