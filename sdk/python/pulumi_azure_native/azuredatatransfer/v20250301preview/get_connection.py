...
def get_connection(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:getConnection', __args__, opts=opts, typ=GetConnectionResult).value
...
def get_connection_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:getConnection', __args__, opts=opts, typ=GetConnectionResult)
