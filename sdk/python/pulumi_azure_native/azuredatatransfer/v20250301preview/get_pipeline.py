...
def get_pipeline(pipeline_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:getPipeline', __args__, opts=opts, typ=GetPipelineResult).value
...
def get_pipeline_output(pipeline_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:getPipeline', __args__, opts=opts, typ=GetPipelineResult)
