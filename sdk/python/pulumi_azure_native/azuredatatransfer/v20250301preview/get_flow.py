...
def get_flow(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:getFlow', __args__, opts=opts, typ=GetFlowResult).value
...
def get_flow_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:getFlow', __args__, opts=opts, typ=GetFlowResult)
