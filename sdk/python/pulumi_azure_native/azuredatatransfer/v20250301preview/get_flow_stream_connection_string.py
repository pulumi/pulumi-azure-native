...
def get_flow_stream_connection_string(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:getFlowStreamConnectionString', __args__, opts=opts, typ=GetFlowStreamConnectionStringResult).value
...
def get_flow_stream_connection_string_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:getFlowStreamConnectionString', __args__, opts=opts, typ=GetFlowStreamConnectionStringResult)
