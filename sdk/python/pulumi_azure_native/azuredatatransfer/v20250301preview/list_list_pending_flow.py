...
def list_list_pending_flow(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20250301preview:listListPendingFlow', __args__, opts=opts, typ=ListListPendingFlowResult).value
...
def list_list_pending_flow_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20250301preview:listListPendingFlow', __args__, opts=opts, typ=ListListPendingFlowResult)
