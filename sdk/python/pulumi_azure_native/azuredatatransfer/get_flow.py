...
def get_flow(connection_name: Optional[_builtins.str] = None,
...
def get_flow_output(connection_name: pulumi.Input[Optional[_builtins.str]] = None,
                    flow_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
