...
def list_list_pending_flow(connection_name: Optional[_builtins.str] = None,
...
def list_list_pending_flow_output(connection_name: Optional[pulumi.Input[_builtins.str]] = None,
