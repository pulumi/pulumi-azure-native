...
def list_list_schema(connection_id: Optional[_builtins.str] = None,
                     content: Optional[_builtins.str] = None,
                     direction: Optional[Union[_builtins.str, 'SchemaDirection']] = None,
                     id: Optional[_builtins.str] = None,
                     name: Optional[_builtins.str] = None,
                     pipeline_name: Optional[_builtins.str] = None,
                     resource_group_name: Optional[_builtins.str] = None,
                     schema_type: Optional[Union[_builtins.str, 'SchemaType']] = None,
                     schema_uri: Optional[_builtins.str] = None,
                     status: Optional[Union[_builtins.str, 'SchemaStatus']] = None,
    ...
    :param _builtins.str pipeline_name: The name for the pipeline that is to be requested.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param Union[_builtins.str, 'SchemaType'] schema_type: The Schema Type
    :param _builtins.str schema_uri: Uri containing SAS token for the zipped schema
    :param Union[_builtins.str, 'SchemaStatus'] status: Status of the schema
    """
    __args__ = dict()
