...
class Connection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredatatransfer/v20231011preview:Connection"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240125:Connection"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240507:Connection"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240911:Connection"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240927:Connection")])
