...
def get_connection(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20240507:getConnection', __args__, opts=opts, typ=GetConnectionResult).value
...
def get_connection_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20240507:getConnection', __args__, opts=opts, typ=GetConnectionResult)
