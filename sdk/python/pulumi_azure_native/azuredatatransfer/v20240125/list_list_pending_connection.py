...
def list_list_pending_connection(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20240125:listListPendingConnection', __args__, opts=opts, typ=ListListPendingConnectionResult).value
