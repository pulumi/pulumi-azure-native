...
class Flow(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredatatransfer/v20231011preview:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240507:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240911:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240927:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20250301preview:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer:Flow")])
