...
def get_flow_destination_endpoints(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20240927:getFlowDestinationEndpoints', __args__, opts=opts, typ=GetFlowDestinationEndpointsResult).value
...
def get_flow_destination_endpoints_output(connection_name: Optional[pulumi.Input[str]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFlowDestinationEndpointsResult]:
    """
    Get the destination endpoints for the specified flow and stream ID.
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20240927:getFlowDestinationEndpoints', __args__, opts=opts, typ=GetFlowDestinationEndpointsResult)
