...
class Pipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredatatransfer/v20231011preview:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240125:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240507:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240911:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20250301preview:Pipeline"), pulumi.Alias(type_="azure-native:azuredatatransfer:Pipeline")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pipeline, __self__).__init__(
            'azure-native:azuredatatransfer/v20240927:Pipeline',
            resource_name,
            __props__,
            opts)
