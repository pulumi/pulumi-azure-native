...
class FlowArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['FlowPropertiesArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['FlowPropertiesArgs']]:
        """
        Properties of flow
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['FlowPropertiesArgs']]):
...
class Flow(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['FlowPropertiesArgs', 'FlowPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredatatransfer/v20231011preview:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240125:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240507:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240911:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20240927:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20250301preview:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20250411preview:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20250521:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20250530preview:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20251010preview:Flow"), pulumi.Alias(type_="azure-native:azuredatatransfer/v20260206preview:Flow")])
