...
def get_flow_source_addresses(connection_name: Optional[builtins.str] = None,
...
def get_flow_source_addresses_output(connection_name: Optional[pulumi.Input[builtins.str]] = None,
