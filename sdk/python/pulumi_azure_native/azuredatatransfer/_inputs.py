...
class ConnectionPropertiesArgsDict(TypedDict):
    ...
    """
    schemas: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SchemaArgs']]]]]
    """
...
class FlowProfilePropertiesArgsDict(TypedDict):
    ...
    """
    rulesets: NotRequired[pulumi.Input[Optional['FlowProfileRulesetsArgs']]]
    """
...
class FlowProfileRulesetsArgsDict(TypedDict):
    ...
    """
    antivirus: NotRequired[pulumi.Input[Optional['AntivirusRulesetArgs']]]
    """
    Antivirus scanning rules for replicated data.
    """
    archives: NotRequired[pulumi.Input[Optional['ArchiveRulesetArgs']]]
    """
    Rules for handling archive files during replication.
    """
    data_size: NotRequired[pulumi.Input[Optional['DataSizeRulesetArgs']]]
    """
    Rules that enforce minimum and maximum data size limits.
    """
    mime_filters: NotRequired[pulumi.Input[Optional['MimeFilterRulesetArgs']]]
    """
    Rules for filtering files based on MIME types.
    """
    text_matching: NotRequired[pulumi.Input[Optional['TextMatchingRulesetArgs']]]
    """
    Rules for detecting and blocking specific text patterns.
    """
    xml_filters: NotRequired[pulumi.Input[Optional['XmlFilterRulesetArgs']]]
    """
...
class FlowPropertiesArgsDict(TypedDict):
    ...
    Properties of flow
    """
    connection: NotRequired[pulumi.Input[Optional['SelectedResourceArgs']]]
    """
    ...
    """
    messaging_options: NotRequired[pulumi.Input[Optional['MessagingOptionsArgs']]]
    """
    ...
    """
    schema: NotRequired[pulumi.Input[Optional['SchemaArgs']]]
    """
    ...
    """
    source_addresses: NotRequired[pulumi.Input[Optional['StreamSourceAddressesArgs']]]
    """
...
class MimeFilterRulesetArgsDict(TypedDict):
    ...
    """
    filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['MimeTypeFilterArgs']]]]]
    """
...
class PipelinePropertiesArgsDict(TypedDict):
    ...
    """
    subscribers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SubscriberArgs']]]]]
    """
...
class TextMatchingRulesetArgsDict(TypedDict):
    ...
    """
    deny: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TextMatchArgs']]]]]
    """
