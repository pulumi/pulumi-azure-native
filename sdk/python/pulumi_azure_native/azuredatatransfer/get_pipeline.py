...
def get_pipeline(pipeline_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer:getPipeline', __args__, opts=opts, typ=GetPipelineResult).value
...
def get_pipeline_output(pipeline_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer:getPipeline', __args__, opts=opts, typ=GetPipelineResult)
