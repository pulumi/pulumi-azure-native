...
def get_pipeline(pipeline_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuredatatransfer/v20240911:getPipeline', __args__, opts=opts, typ=GetPipelineResult).value
...
def get_pipeline_output(pipeline_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuredatatransfer/v20240911:getPipeline', __args__, opts=opts, typ=GetPipelineResult)
