...
def get_private_endpoint_connection(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str account_name: The Video Analyzer account name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:videoanalyzer:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
...
def get_private_endpoint_connection_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:videoanalyzer:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult)
