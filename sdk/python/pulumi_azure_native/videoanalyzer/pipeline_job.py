...
class PipelineJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] topology_name: Reference to an existing pipeline topology. When activated, this pipeline job will process content according to the pipeline topology definition.
        ...
        :param pulumi.Input[_builtins.str] pipeline_job_name: The pipeline job name.
        """
    ...
    def pipeline_job_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def pipeline_job_name(self, value: Optional[pulumi.Input[_builtins.str]]):
