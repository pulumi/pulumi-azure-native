...
class VideoArgs:
    def __init__(__self__, *,
                 ...
                 video_name: Optional[pulumi.Input[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: Optional video description provided by the user. Value can be up to 2048 characters long.
        :param pulumi.Input['VideoMediaInfoArgs'] media_info: Contains information about the video and audio content.
        :param pulumi.Input[_builtins.str] title: Optional video title provided by the user. Value can be up to 256 characters long.
        :param pulumi.Input[_builtins.str] video_name: The Video name.
        """
    ...
    def video_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The Video name.
        """
    ...
    @video_name.setter
    def video_name(self, value: Optional[pulumi.Input[_builtins.str]]):
