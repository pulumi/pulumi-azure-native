...
if not MYPY:
    class AccountEncryptionArgsDict(TypedDict):
        ...
        """
        type: pulumi.Input[Union[_builtins.str, 'AccountEncryptionKeyType']]
        """
...
class AccountEncryptionArgs:
    def __init__(__self__, *,
        ...
        """
        Defines how the Video Analyzer account is (optionally) encrypted.
        :param pulumi.Input[Union[_builtins.str, 'AccountEncryptionKeyType']] type: The type of key used to encrypt the Account Key.
    ...
    @_builtins.property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[_builtins.str, 'AccountEncryptionKeyType']]:
        """
        The type of key used to encrypt the Account Key.
        """
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, 'AccountEncryptionKeyType']]):
...
if not MYPY:
    class AudioEncoderAacArgsDict(TypedDict):
        ...
        """
        bitrate_kbps: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class AudioEncoderAacArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[_builtins.str],
                 bitrate_kbps: Optional[pulumi.Input[_builtins.str]] = None):
        """
        A custom preset for encoding audio with the AAC codec.
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.AudioEncoderAac'.
        :param pulumi.Input[_builtins.str] bitrate_kbps: Bitrate, in kilobits per second or Kbps, at which audio should be encoded (2-channel stereo audio at a sampling rate of 48 kHz). Allowed values are 96, 112, 128, 160, 192, 224, and 256. If omitted, the bitrate of the input audio is used.
        """
    ...
    def bitrate_kbps(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Bitrate, in kilobits per second or Kbps, at which audio should be encoded (2-channel stereo audio at a sampling rate of 48 kHz). Allowed values are 96, 112, 128, 160, 192, 224, and 256. If omitted, the bitrate of the input audio is used.
        """
    ...
    @bitrate_kbps.setter
    def bitrate_kbps(self, value: Optional[pulumi.Input[_builtins.str]]):
...
if not MYPY:
    class EccTokenKeyArgsDict(TypedDict):
        ...
        """
        alg: pulumi.Input[Union[_builtins.str, 'AccessPolicyEccAlgo']]
        """
        ...
        """
        x: pulumi.Input[_builtins.str]
        """
        X coordinate.
        """
        y: pulumi.Input[_builtins.str]
        """
        Y coordinate.
        """
elif False:
...
class EccTokenKeyArgs:
    def __init__(__self__, *,
        ...
        """
        Required validation properties for tokens generated with Elliptical Curve algorithm.
        :param pulumi.Input[Union[_builtins.str, 'AccessPolicyEccAlgo']] alg: Elliptical curve algorithm to be used: ES256, ES384 or ES512.
        :param pulumi.Input[_builtins.str] kid: JWT token key id. Validation keys are looked up based on the key id present on the JWT token header.
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.EccTokenKey'.
        :param pulumi.Input[_builtins.str] x: X coordinate.
        :param pulumi.Input[_builtins.str] y: Y coordinate.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def alg(self) -> pulumi.Input[Union[_builtins.str, 'AccessPolicyEccAlgo']]:
        """
        Elliptical curve algorithm to be used: ES256, ES384 or ES512.
        """
    ...
    @alg.setter
    def alg(self, value: pulumi.Input[Union[_builtins.str, 'AccessPolicyEccAlgo']]):
    ...
    @_builtins.property
    @pulumi.getter
    def x(self) -> pulumi.Input[_builtins.str]:
        """
        X coordinate.
        """
    ...
    @x.setter
    def x(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "x", value)

    @_builtins.property
    @pulumi.getter
    def y(self) -> pulumi.Input[_builtins.str]:
        """
        Y coordinate.
        """
    ...
    @y.setter
    def y(self, value: pulumi.Input[_builtins.str]):
...
class EncoderProcessorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Node name. Must be unique within the topology.
...
if not MYPY:
    class EncoderSystemPresetArgsDict(TypedDict):
        ...
        """
        name: pulumi.Input[Union[_builtins.str, 'EncoderSystemPresetType']]
        """
...
class EncoderSystemPresetArgs:
    def __init__(__self__, *,
        ...
        """
        Describes a built-in preset for encoding the input content using the encoder processor.
        :param pulumi.Input[Union[_builtins.str, 'EncoderSystemPresetType']] name: Name of the built-in encoding preset.
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.EncoderSystemPreset'.
        """
        pulumi.set(__self__, "name", name)
    ...
    @_builtins.property
    @pulumi.getter
    def name(self) -> pulumi.Input[Union[_builtins.str, 'EncoderSystemPresetType']]:
        """
        Name of the built-in encoding preset.
        """
        return pulumi.get(self, "name")
    ...
    @name.setter
    def name(self, value: pulumi.Input[Union[_builtins.str, 'EncoderSystemPresetType']]):
        pulumi.set(self, "name", value)
...
class GroupLevelAccessControlArgs:
    def __init__(__self__, *,
        ...
        """
        Group level network access control.
        :param pulumi.Input[Union[_builtins.str, 'PublicNetworkAccess']] public_network_access: Whether or not public network access is allowed for specified resources under the Video Analyzer account.
        """
...
class IotHubArgs:
    def __init__(__self__, *,
        ...
        """
        The IoT Hub details.
        :param pulumi.Input[_builtins.str] id: The IoT Hub resource identifier.
...
class JwtAuthenticationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.JwtAuthentication'.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] audiences: List of expected token audiences. Token audience is valid if it matches at least one of the given values.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] issuers: List of expected token issuers. Token issuer is valid if it matches at least one of the given values.
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The details for accessing the encryption keys in Key Vault.
        :param pulumi.Input[_builtins.str] key_identifier: The URL of the Key Vault key used to encrypt the account. The key may either be versioned (for example https://vault/keys/mykey/version1) or reference a key without a version (for example https://vault/keys/mykey).
        """
...
class NodeInputArgs:
    def __init__(__self__, *,
        ...
        """
        Describes an input signal to be used on a pipeline node.
        :param pulumi.Input[_builtins.str] node_name: The name of the upstream node in the pipeline which output is used as input of the current node.
        """
...
class ParameterDeclarationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ParameterType']] type: Type of the parameter.
        :param pulumi.Input[_builtins.str] default: The default value for the parameter to be used if the pipeline does not specify a value.
...
class ParameterDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        Defines the parameter value of an specific pipeline topology parameter. See pipeline topology parameters for more information.
        :param pulumi.Input[_builtins.str] name: Name of the parameter declared in the pipeline topology.
        :param pulumi.Input[_builtins.str] value: Parameter value to be applied on this specific pipeline.
        """
        pulumi.set(__self__, "name", name)
...
class PemCertificateListArgs:
    def __init__(__self__, *,
        ...
        """
        A list of PEM formatted certificates.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] certificates: PEM formatted public certificates. One certificate per entry.
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.PemCertificateList'.
        """
...
if not MYPY:
    class ResourceIdentityArgsDict(TypedDict):
        ...
        """
        user_assigned_identity: pulumi.Input[_builtins.str]
        """
...
class ResourceIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        The user assigned managed identity to use when accessing a resource.
        :param pulumi.Input[_builtins.str] user_assigned_identity: The user assigned managed identity's resource identifier to use when accessing a resource.
        """
        pulumi.set(__self__, "user_assigned_identity", user_assigned_identity)

    @_builtins.property
    @pulumi.getter(name="userAssignedIdentity")
    def user_assigned_identity(self) -> pulumi.Input[_builtins.str]:
        """
        The user assigned managed identity's resource identifier to use when accessing a resource.
        """
    ...
    def user_assigned_identity(self, value: pulumi.Input[_builtins.str]):
...
if not MYPY:
    class RsaTokenKeyArgsDict(TypedDict):
        ...
        """
        alg: pulumi.Input[Union[_builtins.str, 'AccessPolicyRsaAlgo']]
        """
        RSA algorithm to be used: RS256, RS384 or RS512.
        """
        e: pulumi.Input[_builtins.str]
        """
...
class RsaTokenKeyArgs:
    def __init__(__self__, *,
        ...
        """
        Required validation properties for tokens generated with RSA algorithm.
        :param pulumi.Input[Union[_builtins.str, 'AccessPolicyRsaAlgo']] alg: RSA algorithm to be used: RS256, RS384 or RS512.
        :param pulumi.Input[_builtins.str] e: RSA public key exponent.
        :param pulumi.Input[_builtins.str] kid: JWT token key id. Validation keys are looked up based on the key id present on the JWT token header.
        :param pulumi.Input[_builtins.str] n: RSA public key modulus.
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.RsaTokenKey'.
        """
        pulumi.set(__self__, "alg", alg)
    ...
    @_builtins.property
    @pulumi.getter
    def alg(self) -> pulumi.Input[Union[_builtins.str, 'AccessPolicyRsaAlgo']]:
        """
        RSA algorithm to be used: RS256, RS384 or RS512.
        """
        return pulumi.get(self, "alg")
    ...
    @alg.setter
    def alg(self, value: pulumi.Input[Union[_builtins.str, 'AccessPolicyRsaAlgo']]):
        pulumi.set(self, "alg", value)

    @_builtins.property
    @pulumi.getter
    def e(self) -> pulumi.Input[_builtins.str]:
        """
        RSA public key exponent.
        """
    ...
    @e.setter
    def e(self, value: pulumi.Input[_builtins.str]):
    ...
    @_builtins.property
    @pulumi.getter
    def n(self) -> pulumi.Input[_builtins.str]:
        """
        RSA public key modulus.
        """
    ...
    @n.setter
    def n(self, value: pulumi.Input[_builtins.str]):
...
if not MYPY:
    class RtspSourceArgsDict(TypedDict):
        ...
        """
        transport: NotRequired[pulumi.Input[Union[_builtins.str, 'RtspTransport']]]
        """
...
class RtspSourceArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str],
                 type: pulumi.Input[_builtins.str],
                 transport: Optional[pulumi.Input[Union[_builtins.str, 'RtspTransport']]] = None):
        """
        RTSP source allows for media from an RTSP camera or generic RTSP server to be ingested into a pipeline.
        ...
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.RtspSource'.
        :param pulumi.Input[Union[_builtins.str, 'RtspTransport']] transport: Network transport utilized by the RTSP and RTP exchange: TCP or HTTP. When using TCP, the RTP packets are interleaved on the TCP RTSP connection. When using HTTP, the RTSP messages are exchanged through long lived HTTP connections, and the RTP packages are interleaved in the HTTP connections alongside the RTSP messages.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def transport(self) -> Optional[pulumi.Input[Union[_builtins.str, 'RtspTransport']]]:
        """
        Network transport utilized by the RTSP and RTP exchange: TCP or HTTP. When using TCP, the RTP packets are interleaved on the TCP RTSP connection. When using HTTP, the RTSP messages are exchanged through long lived HTTP connections, and the RTP packages are interleaved in the HTTP connections alongside the RTSP messages.
        """
    ...
    @transport.setter
    def transport(self, value: Optional[pulumi.Input[Union[_builtins.str, 'RtspTransport']]]):
...
class SecureIotDeviceRemoteTunnelArgs:
    def __init__(__self__, *,
        ...
        """
        A remote tunnel securely established using IoT Hub device information.
        :param pulumi.Input[_builtins.str] device_id: The IoT device id to use when establishing the remote tunnel. This string is case-sensitive.
        :param pulumi.Input[_builtins.str] iot_hub_name: Name of the IoT Hub.
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.SecureIotDeviceRemoteTunnel'.
        """
...
class StorageAccountArgs:
    def __init__(__self__, *,
        ...
        """
        The details about the associated storage account.
        :param pulumi.Input[_builtins.str] id: The ID of the storage account resource. Video Analyzer relies on tables, queues, and blobs. The primary storage account must be a Standard Storage account (either Microsoft.ClassicStorage or Microsoft.Storage).
...
class TlsEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.TlsEndpoint'.
        :param pulumi.Input[_builtins.str] url: The endpoint URL for Video Analyzer to connect to.
...
if not MYPY:
    class TlsValidationOptionsArgsDict(TypedDict):
        ...
        """
        ignore_hostname: NotRequired[pulumi.Input[_builtins.str]]
        """
        When set to 'true' causes the certificate subject name validation to be skipped. Default is 'false'.
        """
        ignore_signature: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class TlsValidationOptionsArgs:
    def __init__(__self__, *,
                 ignore_hostname: Optional[pulumi.Input[_builtins.str]] = None,
                 ignore_signature: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Options for controlling the validation of TLS endpoints.
        :param pulumi.Input[_builtins.str] ignore_hostname: When set to 'true' causes the certificate subject name validation to be skipped. Default is 'false'.
        :param pulumi.Input[_builtins.str] ignore_signature: When set to 'true' causes the certificate chain trust validation to be skipped. Default is 'false'.
        """
    ...
    def ignore_hostname(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        When set to 'true' causes the certificate subject name validation to be skipped. Default is 'false'.
        """
    ...
    def ignore_hostname(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "ignore_hostname", value)

    @_builtins.property
    @pulumi.getter(name="ignoreSignature")
    def ignore_signature(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        When set to 'true' causes the certificate chain trust validation to be skipped. Default is 'false'.
        """
    ...
    def ignore_signature(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class TokenClaimArgs:
    def __init__(__self__, *,
        ...
        """
        Properties for expected token claims.
        :param pulumi.Input[_builtins.str] name: Name of the claim which must be present on the token.
        :param pulumi.Input[_builtins.str] value: Expected value of the claim to be present on the token.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class UsernamePasswordCredentialsArgs:
    def __init__(__self__, *,
        ...
        """
        Username and password credentials.
        :param pulumi.Input[_builtins.str] password: Password to be presented as part of the credentials. It is recommended that this value is parameterized as a secret string in order to prevent this value to be returned as part of the resource on API requests.
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.UsernamePasswordCredentials'.
        :param pulumi.Input[_builtins.str] username: Username to be presented as part of the credentials.
        """
...
class VideoArchivalArgs:
    def __init__(__self__, *,
        ...
        """
        Video archival properties.
        :param pulumi.Input[_builtins.str] retention_period: Video retention period indicates the maximum age of the video archive segments which are intended to be kept in storage. It must be provided in the ISO8601 duration format in the granularity of days, up to a maximum of 10 years. For example, if this is set to P30D (30 days), content older than 30 days will be periodically deleted. This value can be updated at any time and the new desired retention period will be effective within 24 hours.
        """
...
if not MYPY:
    class VideoCreationPropertiesArgsDict(TypedDict):
        ...
        """
        segment_length: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class VideoCreationPropertiesArgs:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 retention_period: Optional[pulumi.Input[_builtins.str]] = None,
                 segment_length: Optional[pulumi.Input[_builtins.str]] = None,
                 title: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Optional properties to be used in case a new video resource needs to be created on the service. These will not take effect if the video already exists.
        :param pulumi.Input[_builtins.str] description: Optional description provided by the user. Value can be up to 2048 characters long.
        :param pulumi.Input[_builtins.str] retention_period: Video retention period indicates how long the video is kept in storage. Value must be specified in ISO8601 duration format (i.e. "P1D" equals 1 day) and can vary between 1 day to 10 years, in 1 day increments. When absent (null), all video content is retained indefinitely. This property is only allowed for topologies where "kind" is set to "live".
        :param pulumi.Input[_builtins.str] segment_length: Segment length indicates the length of individual content files (segments) which are persisted to storage. Smaller segments provide lower archive playback latency but generate larger volume of storage transactions. Larger segments reduce the amount of storage transactions while increasing the archive playback latency. Value must be specified in ISO8601 duration format (i.e. "PT30S" equals 30 seconds) and can vary between 30 seconds to 5 minutes, in 30 seconds increments. Changing this value after the initial call to create the video resource can lead to errors when uploading content to the archive. Default value is 30 seconds. This property is only allowed for topologies where "kind" is set to "live".
        :param pulumi.Input[_builtins.str] title: Optional title provided by the user. Value can be up to 256 characters long.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if retention_period is not None:
    ...
    def segment_length(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Segment length indicates the length of individual content files (segments) which are persisted to storage. Smaller segments provide lower archive playback latency but generate larger volume of storage transactions. Larger segments reduce the amount of storage transactions while increasing the archive playback latency. Value must be specified in ISO8601 duration format (i.e. "PT30S" equals 30 seconds) and can vary between 30 seconds to 5 minutes, in 30 seconds increments. Changing this value after the initial call to create the video resource can lead to errors when uploading content to the archive. Default value is 30 seconds. This property is only allowed for topologies where "kind" is set to "live".
        """
    ...
    def segment_length(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class VideoEncoderH264Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.VideoEncoderH264'.
        :param pulumi.Input[_builtins.str] bitrate_kbps: The maximum bitrate, in kilobits per second or Kbps, at which video should be encoded. If omitted, encoder sets it automatically to try and match the quality of the input video.
        :param pulumi.Input[_builtins.str] frame_rate: The frame rate (in frames per second) of the encoded video. The value must be greater than zero, and less than or equal to 300. If omitted, the encoder uses the average frame rate of the input video.
...
class VideoMediaInfoArgs:
    def __init__(__self__, *,
        ...
        """
        Contains information about the video and audio content.
        :param pulumi.Input[_builtins.str] segment_length: Video segment length indicates the length of individual video files (segments) which are persisted to storage. Smaller segments provide lower archive playback latency but generate larger volume of storage transactions. Larger segments reduce the amount of storage transactions while increasing the archive playback latency. Value must be specified in ISO8601 duration format (i.e. "PT30S" equals 30 seconds) and can vary between 30 seconds to 5 minutes, in 30 seconds increments.
        """
        if segment_length is not None:
            pulumi.set(__self__, "segment_length", segment_length)
...
if not MYPY:
    class VideoPublishingOptionsArgsDict(TypedDict):
        ...
        """
        disable_archive: NotRequired[pulumi.Input[_builtins.str]]
        """
        ...
        """
        disable_rtsp_publishing: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class VideoPublishingOptionsArgs:
    def __init__(__self__, *,
                 disable_archive: Optional[pulumi.Input[_builtins.str]] = None,
                 disable_rtsp_publishing: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Optional flags used to change how video is published. These are only allowed for topologies where "kind" is set to "live".
        :param pulumi.Input[_builtins.str] disable_archive: When set to 'true' content will not be archived or recorded. This is used, for example, when the topology is used only for low latency video streaming. Default is 'false'.  If set to 'true', then "disableRtspPublishing" must be set to 'false'.
        :param pulumi.Input[_builtins.str] disable_rtsp_publishing: When set to 'true' the RTSP playback URL will not be published, disabling low latency streaming. This is used, for example, when the topology is used only for archiving content. Default is 'false'.  If set to 'true', then "disableArchive" must be set to 'false'.
        """
    ...
    def disable_archive(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        When set to 'true' content will not be archived or recorded. This is used, for example, when the topology is used only for low latency video streaming. Default is 'false'.  If set to 'true', then "disableRtspPublishing" must be set to 'false'.
        """
    ...
    def disable_archive(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "disable_archive", value)

    @_builtins.property
    @pulumi.getter(name="disableRtspPublishing")
    def disable_rtsp_publishing(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        When set to 'true' the RTSP playback URL will not be published, disabling low latency streaming. This is used, for example, when the topology is used only for archiving content. Default is 'false'.  If set to 'true', then "disableArchive" must be set to 'false'.
        """
    ...
    def disable_rtsp_publishing(self, value: Optional[pulumi.Input[_builtins.str]]):
...
if not MYPY:
    class VideoScaleArgsDict(TypedDict):
        ...
        """
        mode: NotRequired[pulumi.Input[Union[_builtins.str, 'VideoScaleMode']]]
        """
...
class VideoScaleArgs:
    def __init__(__self__, *,
                 ...
                 mode: Optional[pulumi.Input[Union[_builtins.str, 'VideoScaleMode']]] = None,
                 width: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The video scaling information.
        :param pulumi.Input[_builtins.str] height: The desired output video height.
        :param pulumi.Input[Union[_builtins.str, 'VideoScaleMode']] mode: Describes the video scaling mode to be applied. Default mode is 'Pad'. If the mode is 'Pad' or 'Stretch' then both width and height must be specified. Else if the mode is 'PreserveAspectRatio' then only one of width or height need be provided.
        :param pulumi.Input[_builtins.str] width: The desired output video width.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def mode(self) -> Optional[pulumi.Input[Union[_builtins.str, 'VideoScaleMode']]]:
        """
        Describes the video scaling mode to be applied. Default mode is 'Pad'. If the mode is 'Pad' or 'Stretch' then both width and height must be specified. Else if the mode is 'PreserveAspectRatio' then only one of width or height need be provided.
        """
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input[Union[_builtins.str, 'VideoScaleMode']]]):
...
if not MYPY:
    class VideoSequenceAbsoluteTimeMarkersArgsDict(TypedDict):
        ...
        """
        ranges: pulumi.Input[_builtins.str]
        """
...
class VideoSequenceAbsoluteTimeMarkersArgs:
    def __init__(__self__, *,
        ...
        """
        A sequence of absolute datetime ranges as a string. The datetime values should follow IS08601, and the sum of the ranges should add up to 24 hours or less. Currently, there can be only one range specified in the sequence.
        :param pulumi.Input[_builtins.str] ranges: The sequence of datetime ranges. Example: '[["2021-10-05T03:30:00Z", "2021-10-05T03:40:00Z"]]'.
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.VideoSequenceAbsoluteTimeMarkers'.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def ranges(self) -> pulumi.Input[_builtins.str]:
        """
        The sequence of datetime ranges. Example: '[["2021-10-05T03:30:00Z", "2021-10-05T03:40:00Z"]]'.
        """
    ...
    @ranges.setter
    def ranges(self, value: pulumi.Input[_builtins.str]):
...
if not MYPY:
    class VideoSinkArgsDict(TypedDict):
        ...
        """
        video_name: pulumi.Input[_builtins.str]
        """
...
class VideoSinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.VideoSink'.
        :param pulumi.Input[_builtins.str] video_name: Name of a new or existing video resource used to capture and publish content. Note: if downstream of RTSP source, and if disableArchive is set to true, then no content is archived.
    ...
    def video_name(self) -> pulumi.Input[_builtins.str]:
        """
        Name of a new or existing video resource used to capture and publish content. Note: if downstream of RTSP source, and if disableArchive is set to true, then no content is archived.
        """
    ...
    @video_name.setter
    def video_name(self, value: pulumi.Input[_builtins.str]):
...
class VideoSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The discriminator for derived types.
               Expected value is '#Microsoft.VideoAnalyzer.VideoSource'.
        :param pulumi.Input[_builtins.str] video_name: Name of the Video Analyzer video resource to be used as the source.
        """
        pulumi.set(__self__, "name", name)
