...
class VideoFlagsResponse(dict):
    ...
    def _configure(
        ...
        if is_recording is None and 'isRecording' in kwargs:
            is_recording = kwargs['isRecording']
        if is_recording is None:
            raise TypeError("Missing 'is_recording' argument")
...
class VideoMediaInfoResponse(dict):
    ...
    def _configure(
        ...
        if segment_length is None:
            raise TypeError("Missing 'segment_length' argument")
