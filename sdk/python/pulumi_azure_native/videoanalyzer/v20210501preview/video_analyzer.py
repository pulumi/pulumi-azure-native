...
class VideoAnalyzer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        video_analyzer = azure_native.videoanalyzer.v20210501preview.VideoAnalyzer("videoAnalyzer",
            account_name="contosotv",
            encryption=azure_native.videoanalyzer.v20210501preview.AccountEncryptionArgs(
                type="SystemKey",
            ),
            identity=azure_native.videoanalyzer.v20210501preview.VideoAnalyzerIdentityResponseArgs(
                type="UserAssigned",
            ...
            storage_accounts=[azure_native.videoanalyzer.v20210501preview.StorageAccountArgs(
                ...
                identity=azure_native.videoanalyzer.v20210501preview.ResourceIdentityArgs(
