...
class VideoAnalyzer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:videoanalyzer/v20211101preview:VideoAnalyzer"), pulumi.Alias(type_="azure-native:videoanalyzer:VideoAnalyzer")])
