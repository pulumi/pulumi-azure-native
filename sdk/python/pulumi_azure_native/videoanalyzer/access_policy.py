...
class AccessPolicyArgs:
    def __init__(__self__, *,
                 ...
                 role: Optional[pulumi.Input[Union[_builtins.str, 'AccessPolicyRole']]] = None):
        """
        The set of arguments for constructing a AccessPolicy resource.
        :param pulumi.Input[_builtins.str] account_name: The Azure Video Analyzer account name.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] access_policy_name: The Access Policy name.
        ...
        :param pulumi.Input[Union[_builtins.str, 'AccessPolicyRole']] role: Defines the access level granted by this policy.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def role(self) -> Optional[pulumi.Input[Union[_builtins.str, 'AccessPolicyRole']]]:
        """
    ...
    @role.setter
    def role(self, value: Optional[pulumi.Input[Union[_builtins.str, 'AccessPolicyRole']]]):
...
class AccessPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:videoanalyzer/v20210501preview:AccessPolicy"), pulumi.Alias(type_="azure-native:videoanalyzer/v20211101preview:AccessPolicy")])
