...
class EncoderCustomPresetResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'audioEncoder' in kwargs:
            audio_encoder = kwargs['audioEncoder']
        if 'videoEncoder' in kwargs:
...
class VideoFlagsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'canStream' in kwargs:
            can_stream = kwargs['canStream']
        if 'hasData' in kwargs:
            has_data = kwargs['hasData']
        if 'isInUse' in kwargs:
...
class VideoPublishingOptionsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'disableArchive' in kwargs:
            disable_archive = kwargs['disableArchive']
        if 'disableRtspPublishing' in kwargs:
...
class VideoSinkResponse(dict):
    ...
    def _configure(
        ...
        if 'videoCreationProperties' in kwargs:
            video_creation_properties = kwargs['videoCreationProperties']
        if 'videoPublishingOptions' in kwargs:
