...
class GetLivePipelineResult:
    ...
    def bitrate_kbps(self) -> _builtins.int:
        """
    ...
    def topology_name(self) -> _builtins.str:
        """
...
def get_live_pipeline(account_name: Optional[_builtins.str] = None,
                      live_pipeline_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str live_pipeline_name: Live pipeline unique identifier.
...
def get_live_pipeline_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
