...
class LivePipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:videoanalyzer/v20211101preview:LivePipeline"), pulumi.Alias(type_="azure-native_videoanalyzer_v20211101preview:videoanalyzer:LivePipeline")])
