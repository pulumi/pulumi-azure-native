...
class LivePipelineArgs:
    def __init__(__self__, *,
                 ...
                 bitrate_kbps: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] bitrate_kbps: Maximum bitrate capacity in Kbps reserved for the live pipeline. The allowed range is from 500 to 3000 Kbps in increments of 100 Kbps. If the RTSP camera exceeds this capacity, then the service will disconnect temporarily from the camera. It will retry to re-establish connection (with exponential backoff), checking to see if the camera bitrate is now below the reserved capacity. Doing so will ensure that one 'noisy neighbor' does not affect other live pipelines in your account.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] topology_name: The reference to an existing pipeline topology defined for real-time content processing. When activated, this live pipeline will process content according to the pipeline topology definition.
        :param pulumi.Input[builtins.str] description: An optional description for the pipeline.
        :param pulumi.Input[builtins.str] live_pipeline_name: Live pipeline unique identifier.
    ...
    def bitrate_kbps(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @bitrate_kbps.setter
    def bitrate_kbps(self, value: pulumi.Input[builtins.int]):
    ...
    def live_pipeline_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def live_pipeline_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LivePipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bitrate_kbps: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 live_pipeline_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="bitrateKbps")
    def bitrate_kbps(self) -> pulumi.Output[builtins.int]:
        """
        Maximum bitrate capacity in Kbps reserved for the live pipeline. The allowed range is from 500 to 3000 Kbps in increments of 100 Kbps. If the RTSP camera exceeds this capacity, then the service will disconnect temporarily from the camera. It will retry to re-establish connection (with exponential backoff), checking to see if the camera bitrate is now below the reserved capacity. Doing so will ensure that one 'noisy neighbor' does not affect other live pipelines in your account.
        """
        return pulumi.get(self, "bitrate_kbps")
