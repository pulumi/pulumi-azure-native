...
def list_edge_module_provisioning_token(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str expiration_date: The desired expiration date of the registration token. The Azure Video Analyzer IoT edge module must be initialized and connected to the Internet prior to the token expiration date.
...
def list_edge_module_provisioning_token_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
