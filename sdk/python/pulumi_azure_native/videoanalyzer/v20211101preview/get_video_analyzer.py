...
def get_video_analyzer_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:videoanalyzer/v20211101preview:getVideoAnalyzer', __args__, opts=opts, typ=GetVideoAnalyzerResult)
    return __ret__.apply(lambda __response__: GetVideoAnalyzerResult(
