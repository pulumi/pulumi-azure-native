...
class Video(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:videoanalyzer/v20211101preview:Video"), pulumi.Alias(type_="azure-native:videoanalyzer:Video"), pulumi.Alias(type_="azure-nextgen:videoanalyzer:Video"), pulumi.Alias(type_="azure-native:videoanalyzer/v20210501preview:Video"), pulumi.Alias(type_="azure-nextgen:videoanalyzer/v20210501preview:Video")])
