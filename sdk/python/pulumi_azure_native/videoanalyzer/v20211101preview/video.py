...
class Video(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        video = azure_native.videoanalyzer.v20211101preview.Video("video",
        ...
        ```sh
        $ pulumi import azure-native:videoanalyzer/v20211101preview:Video video1 /subscriptions/591e76c3-3e97-44db-879c-3e2b12961b62/resourceGroups/testrg/providers/Microsoft.Media/videoAnalyzers/testaccount2/videos/video1 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:videoanalyzer:Video"), pulumi.Alias(type_="azure-native:videoanalyzer/v20210501preview:Video")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Video, __self__).__init__(
            'azure-native:videoanalyzer/v20211101preview:Video',
            resource_name,
            __props__,
            opts)
