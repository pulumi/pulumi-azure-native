...
def list_video_content_token(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str video_name: The Video name.
    """
    __args__ = dict()
...
def list_video_content_token_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
