...
class PipelineTopologyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'Kind']] kind: Topology kind.
        ...
        :param pulumi.Input[_builtins.str] description: An optional description of the pipeline topology. It is recommended that the expected use of the topology to be described here.
        ...
        :param pulumi.Input[_builtins.str] pipeline_topology_name: Pipeline topology unique identifier.
    ...
    def pipeline_topology_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def pipeline_topology_name(self, value: Optional[pulumi.Input[_builtins.str]]):
