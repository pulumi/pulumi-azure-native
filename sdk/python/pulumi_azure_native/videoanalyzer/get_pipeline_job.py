...
def get_pipeline_job(account_name: Optional[_builtins.str] = None,
                     pipeline_job_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pipeline_job_name: The pipeline job name.
...
def get_pipeline_job_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
                            pipeline_job_name: Optional[pulumi.Input[_builtins.str]] = None,
