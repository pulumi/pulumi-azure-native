...
def get_pipeline_job(account_name: Optional[builtins.str] = None,
                     pipeline_job_name: Optional[builtins.str] = None,
    ...
    :param builtins.str pipeline_job_name: The pipeline job name.
...
def get_pipeline_job_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
