...
class VideoAnalyzer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 identity: Optional[pulumi.Input[Union['VideoAnalyzerIdentityArgs', 'VideoAnalyzerIdentityArgsDict']]] = None,
                 iot_hubs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IotHubArgs', 'IotHubArgsDict']]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 network_access_control: Optional[pulumi.Input[Union['NetworkAccessControlArgs', 'NetworkAccessControlArgsDict']]] = None,
                 public_network_access: Optional[pulumi.Input[Union[str, 'PublicNetworkAccess']]] = None,
        ...
        :param pulumi.Input[Union['VideoAnalyzerIdentityArgs', 'VideoAnalyzerIdentityArgsDict']] identity: The identities associated to the Video Analyzer resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['IotHubArgs', 'IotHubArgsDict']]]] iot_hubs: The IoT Hubs for this resource.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['NetworkAccessControlArgs', 'NetworkAccessControlArgsDict']] network_access_control: Network access control for Video Analyzer.
        :param pulumi.Input[Union[str, 'PublicNetworkAccess']] public_network_access: Whether or not public network access is allowed for resources under the Video Analyzer account.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:videoanalyzer/v20210501preview:VideoAnalyzer"), pulumi.Alias(type_="azure-native:videoanalyzer/v20211101preview:VideoAnalyzer"), pulumi.Alias(type_="azure-native_videoanalyzer_v20210501preview:videoanalyzer:VideoAnalyzer"), pulumi.Alias(type_="azure-native_videoanalyzer_v20211101preview:videoanalyzer:VideoAnalyzer")])
