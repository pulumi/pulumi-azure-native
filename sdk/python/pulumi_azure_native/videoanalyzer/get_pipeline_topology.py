...
def get_pipeline_topology(account_name: Optional[_builtins.str] = None,
                          pipeline_topology_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pipeline_topology_name: Pipeline topology unique identifier.
...
def get_pipeline_topology_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
                                 pipeline_topology_name: Optional[pulumi.Input[_builtins.str]] = None,
