...
class SubscriptionFeatureRegistrationPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] should_feature_display_in_portal: Indicates whether feature should be displayed in Portal.
        :param pulumi.Input[Union[_builtins.str, 'SubscriptionFeatureRegistrationState']] state: The state.
        """
