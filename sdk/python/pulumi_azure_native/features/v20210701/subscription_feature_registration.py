...
class SubscriptionFeatureRegistration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        subscription_feature_registration = azure_native.features.v20210701.SubscriptionFeatureRegistration("subscriptionFeatureRegistration",
            feature_name="testFeature",
            properties=azure_native.features.v20210701.SubscriptionFeatureRegistrationPropertiesArgs(),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:features:SubscriptionFeatureRegistration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SubscriptionFeatureRegistration, __self__).__init__(
            'azure-native:features/v20210701:SubscriptionFeatureRegistration',
            resource_name,
            __props__,
            opts)
