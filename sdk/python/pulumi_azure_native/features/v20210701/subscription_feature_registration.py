...
class SubscriptionFeatureRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:features/v20210701:SubscriptionFeatureRegistration"), pulumi.Alias(type_="azure-native:features:SubscriptionFeatureRegistration"), pulumi.Alias(type_="azure-nextgen:features:SubscriptionFeatureRegistration")])
