...
class FarmBeatsModel(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            FarmBeatsModelArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:agfoodplatform:FarmBeatsModel"), pulumi.Alias(type_="azure-native:agfoodplatform/v20210901preview:FarmBeatsModel"), pulumi.Alias(type_="azure-native:agfoodplatform/v20230601preview:FarmBeatsModel")])
