...
class FarmBeatsModel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        farm_beats_model = azure_native.agfoodplatform.v20200512preview.FarmBeatsModel("farmBeatsModel",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:agfoodplatform:FarmBeatsModel"), pulumi.Alias(type_="azure-native:agfoodplatform/v20210901preview:FarmBeatsModel")])
