...
def get_solution(data_manager_for_agriculture_resource_name: Optional[builtins.str] = None,
                 resource_group_name: Optional[builtins.str] = None,
                 solution_id: Optional[builtins.str] = None,
    ...
    :param builtins.str solution_id: SolutionId for Data Manager For Agriculture Resource.
    """
    __args__ = dict()
...
def get_solution_output(data_manager_for_agriculture_resource_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:agfoodplatform:getSolution', __args__, opts=opts, typ=GetSolutionResult)
