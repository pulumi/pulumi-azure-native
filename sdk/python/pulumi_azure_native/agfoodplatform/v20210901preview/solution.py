...
class Solution(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:agfoodplatform/v20230601preview:Solution"), pulumi.Alias(type_="azure-native:agfoodplatform:Solution")])
