...
class Solution(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        solution = azure_native.agfoodplatform.v20210901preview.Solution("solution",
            farm_beats_resource_name="examples-farmbeatsResourceName",
            properties=azure_native.agfoodplatform.v20210901preview.SolutionPropertiesResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:agfoodplatform:Solution")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Solution, __self__).__init__(
            'azure-native:agfoodplatform/v20210901preview:Solution',
            resource_name,
            __props__,
            opts)
