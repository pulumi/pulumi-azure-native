...
class Extension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:agfoodplatform:Extension"), pulumi.Alias(type_="azure-native:agfoodplatform/v20200512preview:Extension"), pulumi.Alias(type_="azure-native:agfoodplatform/v20210901preview:Extension")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Extension, __self__).__init__(
            'azure-native:agfoodplatform/v20230601preview:Extension',
            resource_name,
            __props__,
            opts)
