...
class SolutionArgs:
    ...
    def _configure(
        ...
        if data_manager_for_agriculture_resource_name is None:
            raise TypeError("Missing 'data_manager_for_agriculture_resource_name' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if solution_id is None and 'solutionId' in kwargs:
            solution_id = kwargs['solutionId']
...
class Solution(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, SolutionPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:agfoodplatform:Solution"), pulumi.Alias(type_="azure-native:agfoodplatform/v20210901preview:Solution")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Solution, __self__).__init__(
            'azure-native:agfoodplatform/v20230601preview:Solution',
            resource_name,
            __props__,
            opts)
