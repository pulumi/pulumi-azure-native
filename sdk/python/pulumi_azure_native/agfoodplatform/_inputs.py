...
class SolutionPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] saas_subscription_id: SaaS subscriptionId of the installed SaaS application.
        :param pulumi.Input[_builtins.str] saas_subscription_name: SaaS subscription name of the installed SaaS application.
        :param pulumi.Input[_builtins.str] term_id: SaaS application Term Id.
        :param pulumi.Input[_builtins.str] role_assignment_id: Role Assignment Id.
        """
