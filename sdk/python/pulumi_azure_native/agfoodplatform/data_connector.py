...
class DataConnectorArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['DataConnectorPropertiesArgs']] = None,
        ...
        if data_connector_name is None and 'dataConnectorName' in kwargs:
            data_connector_name = kwargs['dataConnectorName']
        ...
        if data_connector_name is not None:
            _setter("data_connector_name", data_connector_name)
...
class DataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DataConnectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, DataConnectorPropertiesArgs, True)
