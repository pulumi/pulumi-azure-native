...
class Environment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:timeseriesinsights/latest:Environment"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20170228preview:Environment"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20171115:Environment"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20180815preview:Environment"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20200515:Environment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Environment, __self__).__init__(
            'azurerm:timeseriesinsights/preview:Environment',
            resource_name,
            __props__,
            opts)
