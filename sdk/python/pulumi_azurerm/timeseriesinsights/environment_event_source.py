...
class EnvironmentEventSource(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, environment_name=None, kind=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        super(EnvironmentEventSource, __self__).__init__(
            'azurerm:timeseriesinsights:EnvironmentEventSource',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, kind=None, location=None, name=None, tags=None, type=None):
        """
