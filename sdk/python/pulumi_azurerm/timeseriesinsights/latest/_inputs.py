...
class SkuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] capacity: The capacity of the sku. For Gen1 environments, this value can be changed to support scale out of environments after they have been created.
