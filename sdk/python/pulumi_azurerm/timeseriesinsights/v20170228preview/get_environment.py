...
class GetEnvironmentResult:
    ...
    """
    def __init__(__self__, creation_time=None, data_access_fqdn=None, data_access_id=None, data_retention_time=None, location=None, name=None, provisioning_state=None, sku=None, storage_limit_exceeded_behavior=None, tags=None, type=None):
...
def get_environment(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:timeseriesinsights/v20170228preview:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult).value
