...
class ReferenceDataSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:timeseriesinsights/latest:ReferenceDataSet"), pulumi.Alias(type_="azurerm:timeseriesinsights/preview:ReferenceDataSet"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20171115:ReferenceDataSet"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20180815preview:ReferenceDataSet"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20200515:ReferenceDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReferenceDataSet, __self__).__init__(
            'azurerm:timeseriesinsights/v20170228preview:ReferenceDataSet',
            resource_name,
            __props__,
            opts)
