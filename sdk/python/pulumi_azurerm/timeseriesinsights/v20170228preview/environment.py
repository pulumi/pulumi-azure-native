...
class Environment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:timeseriesinsights/latest:Environment"), pulumi.Alias(type_="azurerm:timeseriesinsights/preview:Environment"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20171115:Environment"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20180815preview:Environment"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20200515:Environment")])
