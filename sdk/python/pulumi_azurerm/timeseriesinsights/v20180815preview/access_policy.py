...
class AccessPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        access_policy = azurerm.timeseriesinsights.v20180815preview.AccessPolicy("accessPolicy",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:timeseriesinsights/latest:AccessPolicy"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20170228preview:AccessPolicy"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20171115:AccessPolicy"), pulumi.Alias(type_="azurerm:timeseriesinsights/v20200515:AccessPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccessPolicy, __self__).__init__(
            'azurerm:timeseriesinsights/v20180815preview:AccessPolicy',
            resource_name,
            __props__,
            opts)
