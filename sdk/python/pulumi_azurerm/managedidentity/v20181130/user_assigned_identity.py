...
class UserAssignedIdentity(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:managedidentity/latest:UserAssignedIdentity"), pulumi.Alias(type_="azurerm:managedidentity/preview:UserAssignedIdentity"), pulumi.Alias(type_="azurerm:managedidentity/v20150831preview:UserAssignedIdentity")])
