...
class UserAssignedIdentity(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:managedidentity/preview:UserAssignedIdentity"), pulumi.Alias(type_="azurerm:managedidentity/v20150831preview:UserAssignedIdentity"), pulumi.Alias(type_="azurerm:managedidentity/v20181130:UserAssignedIdentity")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserAssignedIdentity, __self__).__init__(
            'azurerm:managedidentity/latest:UserAssignedIdentity',
            resource_name,
            __props__,
            opts)
