...
class DedicatedCloudNode(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:vmwarecloudsimple/latest:DedicatedCloudNode"), pulumi.Alias(type_="azurerm:vmwarecloudsimple/preview:DedicatedCloudNode")])
