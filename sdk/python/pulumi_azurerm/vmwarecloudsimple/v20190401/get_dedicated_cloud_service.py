...
def get_dedicated_cloud_service(dedicated_cloud_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:vmwarecloudsimple/v20190401:getDedicatedCloudService', __args__, opts=opts, typ=GetDedicatedCloudServiceResult).value
