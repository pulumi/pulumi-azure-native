...
class VirtualMachine(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:vmwarecloudsimple/latest:VirtualMachine"), pulumi.Alias(type_="azurerm:vmwarecloudsimple/v20190401:VirtualMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachine, __self__).__init__(
            'azurerm:vmwarecloudsimple/preview:VirtualMachine',
            resource_name,
            __props__,
            opts)
