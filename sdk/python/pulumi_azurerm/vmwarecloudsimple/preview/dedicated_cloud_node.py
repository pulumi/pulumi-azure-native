...
class DedicatedCloudNode(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:vmwarecloudsimple/latest:DedicatedCloudNode"), pulumi.Alias(type_="azurerm:vmwarecloudsimple/v20190401:DedicatedCloudNode")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DedicatedCloudNode, __self__).__init__(
            'azurerm:vmwarecloudsimple/preview:DedicatedCloudNode',
            resource_name,
            __props__,
            opts)
