...
class GetOperationalizationClusterResult:
    ...
    def provisioning_errors(self) -> List['outputs.ErrorResponseWrapperResponse']:
        """
...
def get_operationalization_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:machinelearningcompute/preview:getOperationalizationCluster', __args__, opts=opts, typ=GetOperationalizationClusterResult).value
