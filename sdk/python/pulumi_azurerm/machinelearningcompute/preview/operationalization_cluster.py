...
class OperationalizationCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningcompute/v20170601preview:OperationalizationCluster"), pulumi.Alias(type_="azurerm:machinelearningcompute/v20170801preview:OperationalizationCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OperationalizationCluster, __self__).__init__(
            'azurerm:machinelearningcompute/preview:OperationalizationCluster',
            resource_name,
            __props__,
            opts)
