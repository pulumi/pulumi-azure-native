...
def get_operationalization_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:machinelearningcompute/v20170601preview:getOperationalizationCluster', __args__, opts=opts, typ=GetOperationalizationClusterResult).value
