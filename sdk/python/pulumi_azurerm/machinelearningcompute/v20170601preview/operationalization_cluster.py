...
class OperationalizationCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningcompute/latest:OperationalizationCluster"), pulumi.Alias(type_="azurerm:machinelearningcompute/v20170801preview:OperationalizationCluster")])
