...
class AcsClusterPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 system_services: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None):
        """
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] system_services: The system services deployed to the cluster
        """
    ...
    def system_services(self) -> Optional[pulumi.Input[List[pulumi.Input[str]]]]:
        """
    ...
    def system_services(self, value: Optional[pulumi.Input[List[pulumi.Input[str]]]]):
