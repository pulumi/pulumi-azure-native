...
def get_machine_learning_compute(name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:machinelearningservices/v20200301:getMachineLearningCompute', __args__, opts=opts).value
