...
def get_mongo_db_resource_mongo_db_database(account_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20190801:getMongoDBResourceMongoDBDatabase', __args__, opts=opts).value
