...
class HubView(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, hub_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(HubView, __self__).__init__(
            'azurerm:customerinsights:HubView',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `changed` (`pulumi.Input[str]`) - Date time when view was last modified.
          * `created` (`pulumi.Input[str]`) - Date time when view was created.
          * `definition` (`pulumi.Input[str]`) - View definition.
          * `display_name` (`pulumi.Input[dict]`) - Localized display name for the view.
          * `tenant_id` (`pulumi.Input[str]`) - the hub name.
          * `user_id` (`pulumi.Input[str]`) - the user ID.
          * `view_name` (`pulumi.Input[str]`) - Name of the view.
        """
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return HubView(resource_name, opts=opts, __props__=__props__)
