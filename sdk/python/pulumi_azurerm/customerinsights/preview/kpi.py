...
class Kpi(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:Kpi"), pulumi.Alias(type_="azurerm:customerinsights/v20170101:Kpi"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:Kpi")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Kpi, __self__).__init__(
            'azurerm:customerinsights/preview:Kpi',
            resource_name,
            __props__,
            opts)
