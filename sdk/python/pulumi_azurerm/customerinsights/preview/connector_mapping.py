...
class ConnectorMapping(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:ConnectorMapping"), pulumi.Alias(type_="azurerm:customerinsights/v20170101:ConnectorMapping"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:ConnectorMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectorMapping, __self__).__init__(
            'azurerm:customerinsights/preview:ConnectorMapping',
            resource_name,
            __props__,
            opts)
