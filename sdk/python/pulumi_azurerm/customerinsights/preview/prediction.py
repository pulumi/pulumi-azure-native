...
class Prediction(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:Prediction"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:Prediction")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Prediction, __self__).__init__(
            'azurerm:customerinsights/preview:Prediction',
            resource_name,
            __props__,
            opts)
