...
class Connector(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/preview:Connector"), pulumi.Alias(type_="azurerm:customerinsights/v20170101:Connector"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:Connector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Connector, __self__).__init__(
            'azurerm:customerinsights/latest:Connector',
            resource_name,
            __props__,
            opts)
