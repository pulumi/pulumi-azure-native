...
class RoleAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/preview:RoleAssignment"), pulumi.Alias(type_="azurerm:customerinsights/v20170101:RoleAssignment"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:RoleAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoleAssignment, __self__).__init__(
            'azurerm:customerinsights/latest:RoleAssignment',
            resource_name,
            __props__,
            opts)
