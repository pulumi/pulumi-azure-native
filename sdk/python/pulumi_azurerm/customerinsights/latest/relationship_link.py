...
class RelationshipLink(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 profile_property_references: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ParticipantProfilePropertyReferenceArgs']]]]] = None,
                 related_profile_property_references: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ParticipantProfilePropertyReferenceArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ParticipantProfilePropertyReferenceArgs']]]] profile_property_references: The property references for the Profile of the Relationship.
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ParticipantProfilePropertyReferenceArgs']]]] related_profile_property_references: The property references for the Related Profile of the Relationship.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/preview:RelationshipLink"), pulumi.Alias(type_="azurerm:customerinsights/v20170101:RelationshipLink"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:RelationshipLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RelationshipLink, __self__).__init__(
            'azurerm:customerinsights/latest:RelationshipLink',
            resource_name,
            __props__,
            opts)
