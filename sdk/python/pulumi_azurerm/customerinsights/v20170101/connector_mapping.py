...
class ConnectorMapping(pulumi.CustomResource):
    def __init__(__self__,
        ...
        connector_mapping = azurerm.customerinsights.v20170101.ConnectorMapping("connectorMapping",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:ConnectorMapping"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:ConnectorMapping")])
