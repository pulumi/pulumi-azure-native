...
class Hub(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:Hub"), pulumi.Alias(type_="azurerm:customerinsights/preview:Hub"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:Hub")])
