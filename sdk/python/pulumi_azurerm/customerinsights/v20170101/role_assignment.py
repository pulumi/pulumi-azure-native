...
class RoleAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        role_assignment = azurerm.customerinsights.v20170101.RoleAssignment("roleAssignment",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:RoleAssignment"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:RoleAssignment")])
