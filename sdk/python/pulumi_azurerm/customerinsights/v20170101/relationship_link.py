...
class RelationshipLink(pulumi.CustomResource):
    ...
    def profile_property_references(self) -> List['outputs.ParticipantPropertyReferenceResponse']:
        """
    ...
    def related_profile_property_references(self) -> List['outputs.ParticipantPropertyReferenceResponse']:
        """
