...
class RelationshipLink(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:RelationshipLink"), pulumi.Alias(type_="azurerm:customerinsights/preview:RelationshipLink"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:RelationshipLink")])
