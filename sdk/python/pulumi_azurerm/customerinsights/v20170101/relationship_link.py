...
class RelationshipLink(pulumi.CustomResource):
    def __init__(__self__,
        ...
        relationship_link = azurerm.customerinsights.v20170101.RelationshipLink("relationshipLink",
            description={
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:RelationshipLink"), pulumi.Alias(type_="azurerm:customerinsights/v20170426:RelationshipLink")])
    ...
    def profile_property_references(self) -> pulumi.Output[List['outputs.ParticipantPropertyReferenceResponse']]:
        """
    ...
    def related_profile_property_references(self) -> pulumi.Output[List['outputs.ParticipantPropertyReferenceResponse']]:
        """
