...
class Connector(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:Connector"), pulumi.Alias(type_="azurerm:customerinsights/preview:Connector"), pulumi.Alias(type_="azurerm:customerinsights/v20170101:Connector")])
