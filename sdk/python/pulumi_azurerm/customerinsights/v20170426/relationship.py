...
class Relationship(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:Relationship"), pulumi.Alias(type_="azurerm:customerinsights/preview:Relationship"), pulumi.Alias(type_="azurerm:customerinsights/v20170101:Relationship")])
