...
class Prediction(pulumi.CustomResource):
    def __init__(__self__,
        ...
        prediction = azurerm.customerinsights.v20170426.Prediction("prediction",
            auto_analyze=True,
            description={
                "en-us": "sdktest",
            },
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:Prediction")])
