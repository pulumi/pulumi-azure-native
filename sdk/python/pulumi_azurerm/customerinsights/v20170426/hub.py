...
class Hub(pulumi.CustomResource):
    def __init__(__self__,
        ...
        hub = azurerm.customerinsights.v20170426.Hub("hub",
            hub_billing_info={
                "maxUnits": 5,
                "minUnits": 1,
                "skuName": "B0",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customerinsights/latest:Hub"), pulumi.Alias(type_="azurerm:customerinsights/v20170101:Hub")])
