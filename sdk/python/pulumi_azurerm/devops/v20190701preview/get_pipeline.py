...
class GetPipelineResult:
    ...
    """
    def __init__(__self__, bootstrap_configuration=None, location=None, name=None, organization=None, pipeline_id=None, project=None, tags=None, type=None):
...
def get_pipeline(pipeline_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devops/v20190701preview:getPipeline', __args__, opts=opts, typ=GetPipelineResult).value
