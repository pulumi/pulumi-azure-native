...
class Gateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            if gateway_resource_name is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabricmesh/v20180901preview:Gateway")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Gateway, __self__).__init__(
            'azurerm:servicefabricmesh/preview:Gateway',
            resource_name,
            __props__,
            opts)
