...
class Secret(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            if secret_resource_name is None:
                raise TypeError("Missing required property 'secret_resource_name'")
            __props__['secret_resource_name'] = secret_resource_name
            __props__['tags'] = tags
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabricmesh/preview:Secret")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Secret, __self__).__init__(
            'azurerm:servicefabricmesh/v20180901preview:Secret',
            resource_name,
            __props__,
            opts)
