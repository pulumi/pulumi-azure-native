...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabricmesh/preview:Application"), pulumi.Alias(type_="azurerm:servicefabricmesh/v20180701preview:Application")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Application, __self__).__init__(
            'azurerm:servicefabricmesh/v20180901preview:Application',
            resource_name,
            __props__,
            opts)
