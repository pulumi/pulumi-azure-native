...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application = azurerm.servicefabricmesh.v20180701preview.Application("application",
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceResourceDescriptionArgs']]]] services: describes the services in the application.
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabricmesh/v20180901preview:Application")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Application, __self__).__init__(
            'azurerm:servicefabricmesh/v20180701preview:Application',
            resource_name,
            __props__,
            opts)
