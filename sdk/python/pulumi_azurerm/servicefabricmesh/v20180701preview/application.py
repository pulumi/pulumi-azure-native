...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabricmesh/latest:Application"), pulumi.Alias(type_="azurerm:servicefabricmesh/v20180901preview:Application")])
