...
class Volume(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabricmesh/latest:Volume"), pulumi.Alias(type_="azurerm:servicefabricmesh/v20180901preview:Volume")])
