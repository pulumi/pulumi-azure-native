...
class ClusterReportedPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cluster_version: str,
                 last_updated: str,
                 nodes: List['outputs.ClusterNodeResponse']):
        """
        Properties reported by cluster agent.
        ...
        :param List['ClusterNodeResponseArgs'] nodes: List of nodes reported by the cluster.
        """
    ...
    @property
    @pulumi.getter
    def nodes(self) -> List['outputs.ClusterNodeResponse']:
        """
