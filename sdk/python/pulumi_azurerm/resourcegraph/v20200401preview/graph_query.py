...
class GraphQuery(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:resourcegraph/preview:GraphQuery"), pulumi.Alias(type_="azurerm:resourcegraph/v20180901preview:GraphQuery")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GraphQuery, __self__).__init__(
            'azurerm:resourcegraph/v20200401preview:GraphQuery',
            resource_name,
            __props__,
            opts)
