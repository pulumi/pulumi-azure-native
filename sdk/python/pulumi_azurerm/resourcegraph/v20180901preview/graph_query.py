...
class GraphQuery(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:resourcegraph/preview:GraphQuery"), pulumi.Alias(type_="azurerm:resourcegraph/v20200401preview:GraphQuery")])
