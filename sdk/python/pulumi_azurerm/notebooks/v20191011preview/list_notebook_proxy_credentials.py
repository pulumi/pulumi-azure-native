...
def list_notebook_proxy_credentials(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:notebooks/v20191011preview:listNotebookProxyCredentials', __args__, opts=opts, typ=ListNotebookProxyCredentialsResult).value
