...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datamigration/v20171115preview:Service"), pulumi.Alias(type_="azurerm:datamigration/v20180315preview:Service"), pulumi.Alias(type_="azurerm:datamigration/v20180331preview:Service"), pulumi.Alias(type_="azurerm:datamigration/v20180419:Service"), pulumi.Alias(type_="azurerm:datamigration/v20180715preview:Service")])
