...
class Project(pulumi.CustomResource):
    def __init__(__self__,
        ...
        project = azurerm.datamigration.v20171115preview.Project("project",
            group_name="DmsSdkRg",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datamigration/latest:Project"), pulumi.Alias(type_="azurerm:datamigration/v20180315preview:Project"), pulumi.Alias(type_="azurerm:datamigration/v20180331preview:Project"), pulumi.Alias(type_="azurerm:datamigration/v20180419:Project"), pulumi.Alias(type_="azurerm:datamigration/v20180715preview:Project")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Project, __self__).__init__(
            'azurerm:datamigration/v20171115preview:Project',
            resource_name,
            __props__,
            opts)
