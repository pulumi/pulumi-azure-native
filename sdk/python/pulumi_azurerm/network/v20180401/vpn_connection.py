...
class VpnConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        vpn_connection = azurerm.network.v20180401.VpnConnection("vpnConnection",
