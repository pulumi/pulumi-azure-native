...
class GetProfileResult:
    ...
    def __init__(__self__, dns_config=None, endpoints=None, location=None, max_return=None, monitor_config=None, name=None, profile_status=None, tags=None, traffic_routing_method=None, traffic_view_enrollment_status=None, type=None):
        ...
        __self__.max_return = max_return
        """
...
def get_profile(name=None, resource_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20180401:getProfile', __args__, opts=opts).value

    return AwaitableGetProfileResult(
        dns_config=__ret__.get('dnsConfig'),
        endpoints=__ret__.get('endpoints'),
        location=__ret__.get('location'),
        max_return=__ret__.get('maxReturn'),
