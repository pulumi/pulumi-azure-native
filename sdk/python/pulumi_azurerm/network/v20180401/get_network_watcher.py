...
def get_network_watcher(name: Optional[str] = None,
    ...
    :param str name: The name of the network watcher.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20180401:getNetworkWatcher', __args__, opts=opts, typ=GetNetworkWatcherResult).value
