...
class ApplicationGatewayAutoscaleBoundsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Application Gateway autoscale bounds on number of Application Gateway instance.
        :param float max: Upper bound on number of Application Gateway instances.
        :param float min: Lower bound on number of Application Gateway instances.
        """
...
class AzureFirewallApplicationRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param List[str] target_urls: List of URLs for this rule.
        """
    ...
    def target_urls(self) -> Optional[List[str]]:
        """
...
class VpnConnectionResponse(dict):
    ...
    def connection_bandwidth(self) -> float:
        """
