...
class PrivateDnsZoneVirtualNetworkLink(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, location=None, name=None, private_zone_name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        super(PrivateDnsZoneVirtualNetworkLink, __self__).__init__(
            'azurerm:network:PrivateDnsZoneVirtualNetworkLink',
            resource_name,
            __props__,
            opts)
