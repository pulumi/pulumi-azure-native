...
class VirtualNetworkPeering(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_network_peering = azurerm.network.v20170801.VirtualNetworkPeering("virtualNetworkPeering",
