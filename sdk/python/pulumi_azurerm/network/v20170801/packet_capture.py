...
class PacketCapture(pulumi.CustomResource):
    def __init__(__self__,
        ...
        packet_capture = azurerm.network.v20170801.PacketCapture("packetCapture",
