...
class ApplicationGatewayWebApplicationFirewallPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        super(ApplicationGatewayWebApplicationFirewallPolicy, __self__).__init__(
            'azurerm:network:ApplicationGatewayWebApplicationFirewallPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `application_gateways` (`pulumi.Input[list]`) - A collection of references to application gateways.
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
            * `id` (`pulumi.Input[str]`) - Resource ID.
            * `identity` (`pulumi.Input[dict]`) - The identity of the application gateway, if configured.
            ...
            * `properties` (`pulumi.Input[dict]`) - Properties of the application gateway.
            ...
            * `tags` (`pulumi.Input[dict]`) - Resource tags.
            * `type` (`pulumi.Input[str]`) - Resource type.
            * `zones` (`pulumi.Input[list]`) - A list of availability zones denoting where the resource needs to come from.
          ...
          * `http_listeners` (`pulumi.Input[list]`) - A collection of references to application gateway http listeners.
          * `managed_rules` (`pulumi.Input[dict]`) - Describes the managedRules structure.
            * `exclusions` (`pulumi.Input[list]`) - The Exclusions that are applied on the policy.
              * `match_variable` (`pulumi.Input[str]`) - The variable to be excluded.
              * `selector` (`pulumi.Input[str]`) - When matchVariable is a collection, operator used to specify which elements in the collection this exclusion applies to.
          ...
          * `path_based_rules` (`pulumi.Input[list]`) - A collection of references to application gateway path rules.
          * `policy_settings` (`pulumi.Input[dict]`) - The PolicySettings for policy.
            * `file_upload_limit_in_mb` (`pulumi.Input[float]`) - Maximum file upload size in Mb for WAF.
            * `max_request_body_size_in_kb` (`pulumi.Input[float]`) - Maximum request body size in Kb for WAF.
            * `mode` (`pulumi.Input[str]`) - The mode of the policy.
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the web application firewall policy resource.
          * `resource_state` (`pulumi.Input[str]`) - Resource status of the policy.
        """
        ...
        __props__["tags"] = tags
        __props__["type"] = type
        return ApplicationGatewayWebApplicationFirewallPolicy(resource_name, opts=opts, __props__=__props__)
