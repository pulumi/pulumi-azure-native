...
class ExpressRouteCircuitPeeringConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, circuit_name=None, connection_name=None, id=None, name=None, peering_name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        super(ExpressRouteCircuitPeeringConnection, __self__).__init__(
            'azurerm:network:ExpressRouteCircuitPeeringConnection',
            resource_name,
            __props__,
            opts)
