...
class NetworkSecurityGroup(pulumi.CustomResource):
    ...
    Resource type
    """
    def __init__(__self__, resource_name, opts=None, default_security_rules=None, etag=None, id=None, location=None, name=None, network_interfaces=None, provisioning_state=None, resource_group_name=None, resource_guid=None, security_rules=None, subnets=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        NetworkSecurityGroup resource

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[list] default_security_rules: Gets or sets Default security rules of network security group
        :param pulumi.Input[str] etag: Gets a unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] location: Resource location
        :param pulumi.Input[str] name: The name of the network security group.
        :param pulumi.Input[list] network_interfaces: Gets collection of references to Network Interfaces
        ...
        :param pulumi.Input[list] security_rules: Gets or sets Security rules of network security group
        :param pulumi.Input[list] subnets: Gets collection of references to subnets
