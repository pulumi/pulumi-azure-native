...
def get_load_balancer(expand: Optional[str] = None,
    ...
    :param str name: The name of the loadBalancer.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20160330:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value
