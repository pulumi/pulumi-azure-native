...
class Subnet(pulumi.CustomResource):
    ...
    Gets or sets the reference of the RouteTable resource
      ...
      * `type` (`str`) - Resource type
    """
    def __init__(__self__, resource_name, opts=None, address_prefix=None, etag=None, id=None, ip_configurations=None, name=None, network_security_group=None, provisioning_state=None, resource_group_name=None, route_table=None, virtual_network_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[list] ip_configurations: Gets array of references to the network interface IP configurations using subnet
