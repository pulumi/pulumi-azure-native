...
class RouteFilterRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        route_filter_rule = azurerm.network.v20180201.RouteFilterRule("routeFilterRule",
            access="Allow",
            communities=[
                "12076:5030",
                "12076:5040",
