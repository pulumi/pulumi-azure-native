...
class NetworkWatcher(pulumi.CustomResource):
    def __init__(__self__,
        ...
        network_watcher = azurerm.network.v20180201.NetworkWatcher("networkWatcher",
            location="eastus",
