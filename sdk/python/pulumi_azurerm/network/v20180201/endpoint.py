...
class Endpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:Endpoint"), pulumi.Alias(type_="azurerm:network/preview:Endpoint"), pulumi.Alias(type_="azurerm:network/v20151101:Endpoint"), pulumi.Alias(type_="azurerm:network/v20170301:Endpoint"), pulumi.Alias(type_="azurerm:network/v20170501:Endpoint"), pulumi.Alias(type_="azurerm:network/v20180301:Endpoint"), pulumi.Alias(type_="azurerm:network/v20180401:Endpoint")])
