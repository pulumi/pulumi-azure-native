...
class ConnectionMonitor(pulumi.CustomResource):
    def __init__(__self__,
        ...
        connection_monitor = azurerm.network.v20180101.ConnectionMonitor("connectionMonitor",
