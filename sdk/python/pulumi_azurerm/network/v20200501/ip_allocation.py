...
class IpAllocation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        ip_allocation = azurerm.network.v20200501.IpAllocation("ipAllocation",
            allocation_tags={
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:IpAllocation"), pulumi.Alias(type_="azurerm:network/v20200301:IpAllocation"), pulumi.Alias(type_="azurerm:network/v20200401:IpAllocation"), pulumi.Alias(type_="azurerm:network/v20200601:IpAllocation")])
