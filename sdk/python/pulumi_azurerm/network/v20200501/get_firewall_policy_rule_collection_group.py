...
def get_firewall_policy_rule_collection_group(firewall_policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20200501:getFirewallPolicyRuleCollectionGroup', __args__, opts=opts, typ=GetFirewallPolicyRuleCollectionGroupResult).value
