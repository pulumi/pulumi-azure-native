...
class ApplicationGateway(pulumi.CustomResource):
    ...
    Properties of the application gateway.
      ...
      * `private_endpoint_connections` (`list`) - Private Endpoint connections on application gateway.
        ...
        * `properties` (`dict`) - Properties of the application gateway private endpoint connection.
      ...
      * `private_link_configurations` (`list`) - PrivateLink configurations on application gateway.
        ...
        * `properties` (`dict`) - Properties of the application gateway private link configuration.
          * `ip_configurations` (`list`) - An array of application gateway private link ip configurations.
            ...
            * `properties` (`dict`) - Properties of an application gateway private link ip configuration.
