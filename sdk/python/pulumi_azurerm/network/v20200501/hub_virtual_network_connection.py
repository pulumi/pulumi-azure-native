...
class HubVirtualNetworkConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        hub_virtual_network_connection = azurerm.network.v20200501.HubVirtualNetworkConnection("hubVirtualNetworkConnection",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:HubVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:network/v20200601:HubVirtualNetworkConnection")])
