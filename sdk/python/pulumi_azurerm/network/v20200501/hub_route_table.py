...
class HubRouteTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        hub_route_table = azurerm.network.v20200501.HubRouteTable("hubRouteTable",
            labels=[
                "label1",
                "label2",
            ],
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:HubRouteTable"), pulumi.Alias(type_="azurerm:network/v20200401:HubRouteTable"), pulumi.Alias(type_="azurerm:network/v20200601:HubRouteTable")])
