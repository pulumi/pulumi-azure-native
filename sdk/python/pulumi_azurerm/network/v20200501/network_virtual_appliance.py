...
class NetworkVirtualAppliance(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, boot_strap_configuration_blobs=None, cloud_init_configuration=None, cloud_init_configuration_blobs=None, id=None, identity=None, location=None, name=None, nva_sku=None, resource_group_name=None, tags=None, virtual_appliance_asn=None, virtual_hub=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] boot_strap_configuration_blobs: BootStrapConfigurationBlobs storage URLs.
        :param pulumi.Input[str] cloud_init_configuration: CloudInitConfiguration string in plain text.
        :param pulumi.Input[list] cloud_init_configuration_blobs: CloudInitConfigurationBlob storage URLs.
        ...
        :param pulumi.Input[dict] nva_sku: Network Virtual Appliance SKU.
        ...
        The **nva_sku** object supports the following:
