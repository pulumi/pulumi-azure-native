...
class NetworkVirtualAppliance(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 cloud_init_configuration_blobs: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None,
        ...
        network_virtual_appliance = azurerm.network.v20200501.NetworkVirtualAppliance("networkVirtualAppliance",
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] boot_strap_configuration_blobs: BootStrapConfigurationBlobs storage URLs.
        :param pulumi.Input[str] cloud_init_configuration: CloudInitConfiguration string in plain text.
        :param pulumi.Input[List[pulumi.Input[str]]] cloud_init_configuration_blobs: CloudInitConfigurationBlob storage URLs.
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20191201:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200301:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200401:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200601:NetworkVirtualAppliance")])
