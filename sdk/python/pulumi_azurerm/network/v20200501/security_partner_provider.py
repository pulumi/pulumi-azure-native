...
class SecurityPartnerProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        security_partner_provider = azurerm.network.v20200501.SecurityPartnerProvider("securityPartnerProvider",
            location="West US",
