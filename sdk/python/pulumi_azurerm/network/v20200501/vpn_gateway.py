...
class VpnGateway(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, bgp_settings=None, connections=None, id=None, location=None, name=None, resource_group_name=None, tags=None, virtual_hub=None, vpn_gateway_scale_unit=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180401:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20180601:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20180701:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20180801:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20181001:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20181101:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20181201:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20190201:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20190401:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20190601:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20190701:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20190801:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20190901:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20191101:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20191201:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20200301:VpnGateway"), pulumi.Alias(type_="azurerm:network/v20200401:VpnGateway")])
