...
class AzureFirewall(pulumi.CustomResource):
    def __init__(__self__,
        ...
        azure_firewall = azurerm.network.v20190601.AzureFirewall("azureFirewall",
