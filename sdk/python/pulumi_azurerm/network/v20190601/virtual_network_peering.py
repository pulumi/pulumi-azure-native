...
class VirtualNetworkPeering(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_network_peering = azurerm.network.v20190601.VirtualNetworkPeering("virtualNetworkPeering",
