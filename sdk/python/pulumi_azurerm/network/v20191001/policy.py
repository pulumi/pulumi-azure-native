...
class Policy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:Policy"), pulumi.Alias(type_="azurerm:network/preview:Policy"), pulumi.Alias(type_="azurerm:network/v20180801:Policy"), pulumi.Alias(type_="azurerm:network/v20190301:Policy"), pulumi.Alias(type_="azurerm:network/v20200401:Policy")])
