...
class ManagedRuleGroupOverrideArgs:
    def __init__(__self__, *,
                 ...
                 exclusions: Optional[pulumi.Input[List[pulumi.Input['ManagedRuleExclusionArgs']]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input['ManagedRuleExclusionArgs']]] exclusions: Describes the exclusions that are applied to all rules in the group.
    ...
    @property
    @pulumi.getter
    def exclusions(self) -> Optional[pulumi.Input[List[pulumi.Input['ManagedRuleExclusionArgs']]]]:
        """
    ...
    @exclusions.setter
    def exclusions(self, value: Optional[pulumi.Input[List[pulumi.Input['ManagedRuleExclusionArgs']]]]):
...
class ManagedRuleOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input['ManagedRuleExclusionArgs']]] exclusions: Describes the exclusions that are applied to this specific rule.
        """
...
class ManagedRuleSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input['ManagedRuleExclusionArgs']]] exclusions: Describes the exclusions that are applied to all rules in the set.
...
class PolicySettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] custom_block_response_status_code: If the action type is block, customer can override the response status code.
    ...
    def custom_block_response_status_code(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def custom_block_response_status_code(self, value: Optional[pulumi.Input[float]]):
