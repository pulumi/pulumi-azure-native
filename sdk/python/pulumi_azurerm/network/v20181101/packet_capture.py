...
class PacketCapture(pulumi.CustomResource):
    def __init__(__self__,
        ...
        packet_capture = azurerm.network.v20181101.PacketCapture("packetCapture",
