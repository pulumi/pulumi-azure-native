...
class PublicIPPrefix(pulumi.CustomResource):
    def __init__(__self__,
        ...
        public_ip_prefix = azurerm.network.v20181101.PublicIPPrefix("publicIPPrefix",
            location="westus",
            prefix_length=30,
