...
class RecordSet(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, etag=None, name=None, private_zone_name=None, properties=None, record_type=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        """
