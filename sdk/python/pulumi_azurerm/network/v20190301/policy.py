...
class Policy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        policy = azurerm.network.v20190301.Policy("policy",
            custom_rules={
                "rules": [
                    {
                        "action": "Block",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:Policy"), pulumi.Alias(type_="azurerm:network/v20180801:Policy"), pulumi.Alias(type_="azurerm:network/v20191001:Policy"), pulumi.Alias(type_="azurerm:network/v20200401:Policy")])
