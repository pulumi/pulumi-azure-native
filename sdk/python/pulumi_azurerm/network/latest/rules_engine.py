...
class RulesEngine(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/preview:RulesEngine"), pulumi.Alias(type_="azurerm:network/v20200101:RulesEngine"), pulumi.Alias(type_="azurerm:network/v20200401:RulesEngine"), pulumi.Alias(type_="azurerm:network/v20200501:RulesEngine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RulesEngine, __self__).__init__(
            'azurerm:network/latest:RulesEngine',
            resource_name,
            __props__,
            opts)
