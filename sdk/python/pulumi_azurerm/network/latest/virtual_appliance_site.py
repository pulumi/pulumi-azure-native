...
class VirtualApplianceSite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/preview:VirtualApplianceSite"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualApplianceSite"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualApplianceSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualApplianceSite, __self__).__init__(
            'azurerm:network/latest:VirtualApplianceSite',
            resource_name,
            __props__,
            opts)
