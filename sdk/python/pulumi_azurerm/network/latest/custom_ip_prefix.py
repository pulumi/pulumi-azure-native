...
class CustomIPPrefix(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/preview:CustomIPPrefix"), pulumi.Alias(type_="azurerm:network/v20200601:CustomIPPrefix")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomIPPrefix, __self__).__init__(
            'azurerm:network/latest:CustomIPPrefix',
            resource_name,
            __props__,
            opts)
    ...
    def public_ip_prefixes(self) -> pulumi.Output[List['outputs.SubResourceResponse']]:
        """
