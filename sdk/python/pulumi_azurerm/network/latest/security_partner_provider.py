...
class SecurityPartnerProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/preview:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200301:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200401:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200501:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200601:SecurityPartnerProvider")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecurityPartnerProvider, __self__).__init__(
            'azurerm:network/latest:SecurityPartnerProvider',
            resource_name,
            __props__,
            opts)
