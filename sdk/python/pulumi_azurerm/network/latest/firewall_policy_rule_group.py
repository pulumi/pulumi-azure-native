...
class FirewallPolicyRuleGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/preview:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20190601:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20190701:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20190801:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20190901:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20191101:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20191201:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20200301:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20200401:FirewallPolicyRuleGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallPolicyRuleGroup, __self__).__init__(
            'azurerm:network/latest:FirewallPolicyRuleGroup',
            resource_name,
            __props__,
            opts)
