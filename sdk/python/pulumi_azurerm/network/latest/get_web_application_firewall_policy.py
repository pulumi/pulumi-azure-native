...
def get_web_application_firewall_policy(policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/latest:getWebApplicationFirewallPolicy', __args__, opts=opts, typ=GetWebApplicationFirewallPolicyResult).value
