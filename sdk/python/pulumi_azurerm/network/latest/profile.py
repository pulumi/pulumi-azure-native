...
class Profile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/preview:Profile"), pulumi.Alias(type_="azurerm:network/v20151101:Profile"), pulumi.Alias(type_="azurerm:network/v20170301:Profile"), pulumi.Alias(type_="azurerm:network/v20170501:Profile"), pulumi.Alias(type_="azurerm:network/v20180201:Profile"), pulumi.Alias(type_="azurerm:network/v20180301:Profile"), pulumi.Alias(type_="azurerm:network/v20180401:Profile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Profile, __self__).__init__(
            'azurerm:network/latest:Profile',
            resource_name,
            __props__,
            opts)
