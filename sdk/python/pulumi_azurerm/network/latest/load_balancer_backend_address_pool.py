...
class LoadBalancerBackendAddressPool(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/preview:LoadBalancerBackendAddressPool"), pulumi.Alias(type_="azurerm:network/v20200401:LoadBalancerBackendAddressPool"), pulumi.Alias(type_="azurerm:network/v20200501:LoadBalancerBackendAddressPool"), pulumi.Alias(type_="azurerm:network/v20200601:LoadBalancerBackendAddressPool")])
