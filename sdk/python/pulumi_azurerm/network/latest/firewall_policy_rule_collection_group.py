...
class FirewallPolicyRuleCollectionGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/preview:FirewallPolicyRuleCollectionGroup"), pulumi.Alias(type_="azurerm:network/v20200501:FirewallPolicyRuleCollectionGroup"), pulumi.Alias(type_="azurerm:network/v20200601:FirewallPolicyRuleCollectionGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallPolicyRuleCollectionGroup, __self__).__init__(
            'azurerm:network/latest:FirewallPolicyRuleCollectionGroup',
            resource_name,
            __props__,
            opts)
