...
class FirewallPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        firewall_policy = azurerm.network.v20191201.FirewallPolicy("firewallPolicy",
