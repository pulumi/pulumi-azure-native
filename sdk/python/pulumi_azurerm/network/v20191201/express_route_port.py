...
class ExpressRoutePort(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, bandwidth_in_gbps=None, encapsulation=None, id=None, identity=None, links=None, location=None, name=None, peering_location=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180801:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20181001:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20181101:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20181201:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190201:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190401:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190601:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190701:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190801:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190901:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20191101:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20200301:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20200401:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20200501:ExpressRoutePort")])
