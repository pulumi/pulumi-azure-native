...
class NetworkVirtualAppliance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        network_virtual_appliance = azurerm.network.v20191201.NetworkVirtualAppliance("networkVirtualAppliance",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200301:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200401:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200501:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200601:NetworkVirtualAppliance")])
    ...
    def boot_strap_configuration_blob(self) -> pulumi.Output[Optional[List[str]]]:
        """
    ...
    def cloud_init_configuration_blob(self) -> pulumi.Output[Optional[List[str]]]:
        """
