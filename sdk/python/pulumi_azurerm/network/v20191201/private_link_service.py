...
class PrivateLinkService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/preview:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190401:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190601:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190701:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190801:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190901:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20191101:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200301:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200401:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200501:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200601:PrivateLinkService")])
