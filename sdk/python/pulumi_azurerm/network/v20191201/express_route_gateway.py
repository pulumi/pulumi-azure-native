...
class ExpressRouteGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        express_route_gateway = azurerm.network.v20191201.ExpressRouteGateway("expressRouteGateway",
