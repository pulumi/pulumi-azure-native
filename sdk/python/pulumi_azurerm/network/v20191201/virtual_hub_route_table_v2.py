...
class VirtualHubRouteTableV2(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_hub_route_table_v2 = azurerm.network.v20191201.VirtualHubRouteTableV2("virtualHubRouteTableV2",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VirtualHubRouteTableV2"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualHubRouteTableV2"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualHubRouteTableV2"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualHubRouteTableV2"), pulumi.Alias(type_="azurerm:network/v20200401:VirtualHubRouteTableV2"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualHubRouteTableV2"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualHubRouteTableV2")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualHubRouteTableV2, __self__).__init__(
            'azurerm:network/v20191201:VirtualHubRouteTableV2',
            resource_name,
            __props__,
            opts)
