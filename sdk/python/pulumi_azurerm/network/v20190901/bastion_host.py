...
class BastionHost(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, dns_name=None, id=None, ip_configurations=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20190401:BastionHost"), pulumi.Alias(type_="azurerm:network/v20190601:BastionHost"), pulumi.Alias(type_="azurerm:network/v20190701:BastionHost"), pulumi.Alias(type_="azurerm:network/v20190801:BastionHost"), pulumi.Alias(type_="azurerm:network/v20191101:BastionHost"), pulumi.Alias(type_="azurerm:network/v20191201:BastionHost"), pulumi.Alias(type_="azurerm:network/v20200301:BastionHost"), pulumi.Alias(type_="azurerm:network/v20200401:BastionHost"), pulumi.Alias(type_="azurerm:network/v20200501:BastionHost")])
