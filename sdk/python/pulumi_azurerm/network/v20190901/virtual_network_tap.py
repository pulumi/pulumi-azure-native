...
class VirtualNetworkTap(pulumi.CustomResource):
    destination_load_balancer_front_end_ip_configuration: pulumi.Output[dict]
    """
    The reference to the private IP address on the internal Load Balancer that will receive the tap.
      ...
      * `zones` (`list`) - A list of availability zones denoting the IP allocated for the resource needs to come from.
    """
    destination_network_interface_ip_configuration: pulumi.Output[dict]
    """
    ...
    Resource name.
    """
    network_interface_tap_configurations: pulumi.Output[list]
    """
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, destination_load_balancer_front_end_ip_configuration=None, destination_network_interface_ip_configuration=None, destination_port=None, id=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Virtual Network Tap resource.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[dict] destination_load_balancer_front_end_ip_configuration: The reference to the private IP address on the internal Load Balancer that will receive the tap.
        :param pulumi.Input[dict] destination_network_interface_ip_configuration: The reference to the private IP Address of the collector nic that will receive the tap.
        ...
        The **destination_load_balancer_front_end_ip_configuration** object supports the following:
        ...
        The **destination_network_interface_ip_configuration** object supports the following:
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180801:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181001:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181101:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190401:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190601:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190701:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190801:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200401:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualNetworkTap")])
