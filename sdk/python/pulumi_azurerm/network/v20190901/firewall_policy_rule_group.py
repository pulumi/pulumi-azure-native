...
class FirewallPolicyRuleGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        firewall_policy_rule_group = azurerm.network.v20190901.FirewallPolicyRuleGroup("firewallPolicyRuleGroup",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20190601:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20190701:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20190801:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20191101:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20191201:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20200301:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azurerm:network/v20200401:FirewallPolicyRuleGroup")])
