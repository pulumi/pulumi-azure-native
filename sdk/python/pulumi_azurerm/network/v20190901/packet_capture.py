...
class PacketCapture(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PacketCaptureFilterArgs']]]] filters: A list of packet capture filters.
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:PacketCapture"), pulumi.Alias(type_="azurerm:network/preview:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20160901:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20161201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20170301:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20170601:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20170801:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20170901:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20171001:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20171101:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180101:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180401:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180601:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180701:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180801:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20181001:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20181101:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20181201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190401:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190601:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190701:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190801:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20191101:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20191201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20200301:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20200401:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20200501:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20200601:PacketCapture")])
