...
class ApplicationGateway(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, authentication_certificates=None, autoscale_configuration=None, backend_address_pools=None, backend_http_settings_collection=None, custom_error_configurations=None, enable_fips=None, enable_http2=None, firewall_policy=None, frontend_ip_configurations=None, frontend_ports=None, gateway_ip_configurations=None, http_listeners=None, id=None, identity=None, location=None, name=None, probes=None, redirect_configurations=None, request_routing_rules=None, resource_group_name=None, rewrite_rule_sets=None, sku=None, ssl_certificates=None, ssl_policy=None, tags=None, trusted_root_certificates=None, url_path_maps=None, web_application_firewall_configuration=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **http_listeners** object supports the following:
          ...
          * `hostnames` (`pulumi.Input[list]`) - List of Host names for HTTP Listener that allows special wildcard characters as well.
          * `id` (`pulumi.Input[str]`) - Resource ID.
