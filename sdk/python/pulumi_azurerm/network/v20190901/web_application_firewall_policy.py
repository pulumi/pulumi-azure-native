...
class WebApplicationFirewallPolicy(pulumi.CustomResource):
    ...
    A collection of references to application gateways.
      ...
      * `http_listeners` (`list`) - Http listeners of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `hostnames` (`list`) - List of Host names for HTTP Listener that allows special wildcard characters as well.
        * `id` (`str`) - Resource ID.
    ...
    def __init__(__self__, resource_name, opts=None, custom_rules=None, id=None, location=None, managed_rules=None, name=None, policy_settings=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20181201:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20190201:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20190401:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20190601:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20190701:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20190801:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20191101:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20191201:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20200301:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20200401:WebApplicationFirewallPolicy"), pulumi.Alias(type_="azurerm:network/v20200601:WebApplicationFirewallPolicy")])
