...
class IpGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20191101:IpGroup"), pulumi.Alias(type_="azurerm:network/v20191201:IpGroup"), pulumi.Alias(type_="azurerm:network/v20200301:IpGroup"), pulumi.Alias(type_="azurerm:network/v20200401:IpGroup"), pulumi.Alias(type_="azurerm:network/v20200501:IpGroup"), pulumi.Alias(type_="azurerm:network/v20200601:IpGroup")])
