...
class Endpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] geo_mapping: Gets or sets the list of countries/regions mapped to this endpoint when using the ‘Geographic’ traffic routing method. Please consult Traffic Manager Geographic documentation for a full list of accepted values.
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:Endpoint"), pulumi.Alias(type_="azurerm:network/preview:Endpoint"), pulumi.Alias(type_="azurerm:network/v20151101:Endpoint"), pulumi.Alias(type_="azurerm:network/v20170501:Endpoint"), pulumi.Alias(type_="azurerm:network/v20180201:Endpoint"), pulumi.Alias(type_="azurerm:network/v20180301:Endpoint"), pulumi.Alias(type_="azurerm:network/v20180401:Endpoint")])
