...
class EndpointResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param List[str] geo_mapping: Gets or sets the list of countries/regions mapped to this endpoint when using the ‘Geographic’ traffic routing method. Please consult Traffic Manager Geographic documentation for a full list of accepted values.
...
class RouteFilterResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 location: str,
                 name: str,
                 peerings: List['outputs.ExpressRouteCircuitPeeringResponse'],
                 provisioning_state: str,
                 type: str,
                 id: Optional[str] = None,
