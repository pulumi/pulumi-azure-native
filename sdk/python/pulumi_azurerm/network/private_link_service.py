...
class PrivateLinkService(pulumi.CustomResource):
    ...
    Properties of the private link service.
      ...
      * `ip_configurations` (`list`) - An array of private link service IP configurations.
        ...
        * `id` (`str`) - Resource ID.
        * `name` (`str`) - The name of private link service ip configuration.
        * `properties` (`dict`) - Properties of the private link service ip configuration.
          ...
          * `provisioning_state` (`str`) - The provisioning state of the private link service IP configuration resource.
      ...
      * `load_balancer_frontend_ip_configurations` (`list`) - An array of references to the load balancer IP configurations.
      * `network_interfaces` (`list`) - An array of references to the network interfaces created for this private link service.
      * `private_endpoint_connections` (`list`) - An array of list about connections to the private endpoint.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `id` (`str`) - Resource ID.
        * `name` (`str`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
        * `properties` (`dict`) - Properties of the private end point connection.
    ...
    def __init__(__self__, resource_name, opts=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: Properties of the private link service.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[dict] tags: Resource tags.

        The **properties** object supports the following:

          * `auto_approval` (`pulumi.Input[dict]`) - The auto-approval list of the private link service.
          * `enable_proxy_protocol` (`pulumi.Input[bool]`) - Whether the private link service is enabled for proxy protocol or not.
          * `fqdns` (`pulumi.Input[list]`) - The list of Fqdn.
          * `ip_configurations` (`pulumi.Input[list]`) - An array of private link service IP configurations.
            * `id` (`pulumi.Input[str]`) - Resource ID.
            * `name` (`pulumi.Input[str]`) - The name of private link service ip configuration.
            * `properties` (`pulumi.Input[dict]`) - Properties of the private link service ip configuration.
          ...
          * `load_balancer_frontend_ip_configurations` (`pulumi.Input[list]`) - An array of references to the load balancer IP configurations.
            * `id` (`pulumi.Input[str]`) - Resource ID.
          ...
          * `visibility` (`pulumi.Input[dict]`) - The visibility list of the private link service.
        """
    ...
    def get(resource_name, id, opts=None, etag=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `alias` (`pulumi.Input[str]`) - The alias of the private link service.
          * `auto_approval` (`pulumi.Input[dict]`) - The auto-approval list of the private link service.
          * `enable_proxy_protocol` (`pulumi.Input[bool]`) - Whether the private link service is enabled for proxy protocol or not.
          * `fqdns` (`pulumi.Input[list]`) - The list of Fqdn.
          * `ip_configurations` (`pulumi.Input[list]`) - An array of private link service IP configurations.
            ...
            * `properties` (`pulumi.Input[dict]`) - Properties of the private link service ip configuration.
              ...
              * `private_ip_address_version` (`pulumi.Input[str]`) - Whether the specific IP configuration is IPv4 or IPv6. Default is IPv4.
              * `private_ip_allocation_method` (`pulumi.Input[str]`) - The private IP address allocation method.
              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the private link service IP configuration resource.
              * `subnet` (`pulumi.Input[dict]`) - The reference to the subnet resource.
                * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                * `id` (`pulumi.Input[str]`) - Resource ID.
                * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
                * `properties` (`pulumi.Input[dict]`) - Properties of the subnet.
                  ...
                  * `delegations` (`pulumi.Input[list]`) - An array of references to the delegations on the subnet.
                    ...
                    * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within a subnet. This name can be used to access the resource.
                    * `properties` (`pulumi.Input[dict]`) - Properties of the subnet.
                      * `actions` (`pulumi.Input[list]`) - The actions permitted to the service upon delegation.
                      * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the service delegation resource.
                      * `service_name` (`pulumi.Input[str]`) - The name of the service to whom the subnet should be delegated (e.g. Microsoft.Sql/servers).

                  * `ip_allocations` (`pulumi.Input[list]`) - Array of IpAllocation which reference this subnet.
                    * `id` (`pulumi.Input[str]`) - Resource ID.

                  * `ip_configuration_profiles` (`pulumi.Input[list]`) - Array of IP configuration profiles which reference this subnet.
                    * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                    * `id` (`pulumi.Input[str]`) - Resource ID.
                    ...
                    * `properties` (`pulumi.Input[dict]`) - Properties of the IP configuration profile.
                      * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the IP configuration profile resource.
                      * `subnet` (`pulumi.Input[dict]`) - The reference to the subnet resource to create a container network interface ip configuration.

                    * `type` (`pulumi.Input[str]`) - Sub Resource type.

                  * `ip_configurations` (`pulumi.Input[list]`) - An array of references to the network interface IP configurations using subnet.
                    * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                    * `id` (`pulumi.Input[str]`) - Resource ID.
                    * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
                    * `properties` (`pulumi.Input[dict]`) - Properties of the IP configuration.
                      * `private_ip_address` (`pulumi.Input[str]`) - The private IP address of the IP configuration.
                      * `private_ip_allocation_method` (`pulumi.Input[str]`) - The private IP address allocation method.
                      * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the IP configuration resource.
                      * `public_ip_address` (`pulumi.Input[dict]`) - The reference to the public IP resource.
                        * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                        * `id` (`pulumi.Input[str]`) - Resource ID.
                        * `location` (`pulumi.Input[str]`) - Resource location.
                  ...
                  * `network_security_group` (`pulumi.Input[dict]`) - The reference to the NetworkSecurityGroup resource.
                    ...
                    * `properties` (`pulumi.Input[dict]`) - Properties of the network security group.
                      * `default_security_rules` (`pulumi.Input[list]`) - The default security rules of network security group.
                        ...
                        * `properties` (`pulumi.Input[dict]`) - Properties of the security rule.
                          ...
                          * `destination_application_security_groups` (`pulumi.Input[list]`) - The application security group specified as destination.
                            ...
                            * `name` (`pulumi.Input[str]`) - Resource name.
                            * `properties` (`pulumi.Input[dict]`) - Properties of the application security group.
                              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the application security group resource.
                      ...
                      * `flow_logs` (`pulumi.Input[list]`) - A collection of references to flow log resources.
                        * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                        * `id` (`pulumi.Input[str]`) - Resource ID.
                        * `location` (`pulumi.Input[str]`) - Resource location.
                        * `name` (`pulumi.Input[str]`) - Resource name.
                        * `properties` (`pulumi.Input[dict]`) - Properties of the flow log.
                      ...
                      * `network_interfaces` (`pulumi.Input[list]`) - A collection of references to network interfaces.
                        ...
                        * `properties` (`pulumi.Input[dict]`) - Properties of the network interface.
                          ...
                          * `hosted_workloads` (`pulumi.Input[list]`) - A list of references to linked BareMetal resources.
                          * `ip_configurations` (`pulumi.Input[list]`) - A list of IPConfigurations of the network interface.
                            ...
                            * `properties` (`pulumi.Input[dict]`) - Network interface IP configuration properties.
                              * `application_gateway_backend_address_pools` (`pulumi.Input[list]`) - The reference to ApplicationGatewayBackendAddressPool resource.
                                * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                                * `id` (`pulumi.Input[str]`) - Resource ID.
                              ...
                              * `load_balancer_backend_address_pools` (`pulumi.Input[list]`) - The reference to LoadBalancerBackendAddressPool resource.
                                * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                                * `id` (`pulumi.Input[str]`) - Resource ID.
                                ...
                                * `properties` (`pulumi.Input[dict]`) - Properties of load balancer backend address pool.
                                  * `backend_ip_configurations` (`pulumi.Input[list]`) - An array of references to IP addresses defined in network interfaces.
                                  * `load_balancer_backend_addresses` (`pulumi.Input[list]`) - An array of backend addresses.
                                    ...
                                    * `properties` (`pulumi.Input[dict]`) - Properties of load balancer backend address pool.
                                      ...
                                      * `network_interface_ip_configuration` (`pulumi.Input[dict]`) - Reference to IP address defined in network interfaces.
                                      * `virtual_network` (`pulumi.Input[dict]`) - Reference to an existing virtual network.

                                  * `load_balancing_rules` (`pulumi.Input[list]`) - An array of references to load balancing rules that use this backend address pool.
                                  * `outbound_rule` (`pulumi.Input[dict]`) - A reference to an outbound rule that uses this backend address pool.
                                  * `outbound_rules` (`pulumi.Input[list]`) - An array of references to outbound rules that use this backend address pool.
                                  * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the backend address pool resource.
                              ...
                              * `private_ip_address_version` (`pulumi.Input[str]`) - Whether the specific IP configuration is IPv4 or IPv6. Default is IPv4.
                              * `private_ip_allocation_method` (`pulumi.Input[str]`) - The private IP address allocation method.
                              * `private_link_connection_properties` (`pulumi.Input[dict]`) - PrivateLinkConnection properties for the network interface.
                                * `fqdns` (`pulumi.Input[list]`) - List of FQDNs for current private link connection.
                                * `group_id` (`pulumi.Input[str]`) - The group ID for current private link connection.
                                * `required_member_name` (`pulumi.Input[str]`) - The required member name for current private link connection.
                              ...
                              * `virtual_network_taps` (`pulumi.Input[list]`) - The reference to Virtual Network Taps.
                                ...
                                * `properties` (`pulumi.Input[dict]`) - Virtual Network Tap Properties.
                                  * `destination_load_balancer_front_end_ip_configuration` (`pulumi.Input[dict]`) - The reference to the private IP address on the internal Load Balancer that will receive the tap.
                                    ...
                                    * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within the set of frontend IP configurations used by the load balancer. This name can be used to access the resource.
                                    * `properties` (`pulumi.Input[dict]`) - Properties of the load balancer probe.
                                      * `inbound_nat_pools` (`pulumi.Input[list]`) - An array of references to inbound pools that use this frontend IP.
                                      * `inbound_nat_rules` (`pulumi.Input[list]`) - An array of references to inbound rules that use this frontend IP.
                                      * `load_balancing_rules` (`pulumi.Input[list]`) - An array of references to load balancing rules that use this frontend IP.
                                      * `outbound_rules` (`pulumi.Input[list]`) - An array of references to outbound rules that use this frontend IP.
                                      * `private_ip_address` (`pulumi.Input[str]`) - The private IP address of the IP configuration.
                                      * `private_ip_address_version` (`pulumi.Input[str]`) - Whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.
                                      * `private_ip_allocation_method` (`pulumi.Input[str]`) - The Private IP allocation method.
                                  ...
                                  * `network_interface_tap_configurations` (`pulumi.Input[list]`) - Specifies the list of resource IDs for the network interface IP configuration that needs to be tapped.
                                    * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                                    * `id` (`pulumi.Input[str]`) - Resource ID.
                                    * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
                                    * `properties` (`pulumi.Input[dict]`) - Properties of the Virtual Network Tap configuration.
                                      * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the network interface tap configuration resource.
                                      * `virtual_network_tap` (`pulumi.Input[dict]`) - The reference to the Virtual Network Tap resource.

                                    * `type` (`pulumi.Input[str]`) - Sub Resource type.

                                  * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the virtual network tap resource.
                                  * `resource_guid` (`pulumi.Input[str]`) - The resource GUID property of the virtual network tap resource.
                          ...
                          * `private_endpoint` (`pulumi.Input[dict]`) - A reference to the private endpoint to which the network interface is linked.
                            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                            * `id` (`pulumi.Input[str]`) - Resource ID.
                            * `location` (`pulumi.Input[str]`) - Resource location.
                            * `name` (`pulumi.Input[str]`) - Resource name.
                            * `properties` (`pulumi.Input[dict]`) - Properties of the private endpoint.
                              ...
                              * `network_interfaces` (`pulumi.Input[list]`) - An array of references to the network interfaces created for this private endpoint.
                          ...
                          * `virtual_machine` (`pulumi.Input[dict]`) - The reference to a virtual machine.
                  ...
                  * `private_endpoint_network_policies` (`pulumi.Input[str]`) - Enable or Disable apply network policies on private end point in the subnet.
                  * `private_endpoints` (`pulumi.Input[list]`) - An array of references to private endpoints.
                  * `private_link_service_network_policies` (`pulumi.Input[str]`) - Enable or Disable apply network policies on private link service in the subnet.
                  * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the subnet resource.
                  * `purpose` (`pulumi.Input[str]`) - A read-only string identifying the intention of use for this subnet based on delegations and other user-defined properties.
                  * `resource_navigation_links` (`pulumi.Input[list]`) - An array of references to the external resources using subnet.
                    ...
                    * `properties` (`pulumi.Input[dict]`) - Resource navigation link properties format.
                      ...
                      * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the resource navigation link resource.
                  ...
                  * `service_association_links` (`pulumi.Input[list]`) - An array of references to services injecting into this subnet.
                    ...
                    * `properties` (`pulumi.Input[dict]`) - Resource navigation link properties format.
                      ...
                      * `linked_resource_type` (`pulumi.Input[str]`) - Resource type of the linked resource.
                      * `locations` (`pulumi.Input[list]`) - A list of locations.
                      * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the service association link resource.
                  ...
                  * `service_endpoint_policies` (`pulumi.Input[list]`) - An array of service endpoint policies.
                    ...
                    * `name` (`pulumi.Input[str]`) - Resource name.
                    * `properties` (`pulumi.Input[dict]`) - Properties of the service end point policy.
                      * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the service endpoint policy resource.
                      ...
                      * `service_endpoint_policy_definitions` (`pulumi.Input[list]`) - A collection of service endpoint policy definitions of the service endpoint policy.
                        ...
                        * `properties` (`pulumi.Input[dict]`) - Properties of the service endpoint policy definition.
                          * `description` (`pulumi.Input[str]`) - A description for this rule. Restricted to 140 chars.
                          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the service endpoint policy definition resource.
                          * `service` (`pulumi.Input[str]`) - Service endpoint name.
                          * `service_resources` (`pulumi.Input[list]`) - A list of service resources.
          ...
          * `load_balancer_frontend_ip_configurations` (`pulumi.Input[list]`) - An array of references to the load balancer IP configurations.
          * `network_interfaces` (`pulumi.Input[list]`) - An array of references to the network interfaces created for this private link service.
          * `private_endpoint_connections` (`pulumi.Input[list]`) - An array of list about connections to the private endpoint.
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
            * `id` (`pulumi.Input[str]`) - Resource ID.
            * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
            * `properties` (`pulumi.Input[dict]`) - Properties of the private end point connection.
              * `link_identifier` (`pulumi.Input[str]`) - The consumer link id.
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the private link service resource.
          * `visibility` (`pulumi.Input[dict]`) - The visibility list of the private link service.
        """
