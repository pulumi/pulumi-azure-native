...
class RecordSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        record_set = azurerm.network.v20180301preview.RecordSet("recordSet",
            a_records=[{
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20150504preview:RecordSet"), pulumi.Alias(type_="azurerm:network/v20160401:RecordSet"), pulumi.Alias(type_="azurerm:network/v20170901:RecordSet"), pulumi.Alias(type_="azurerm:network/v20171001:RecordSet"), pulumi.Alias(type_="azurerm:network/v20180501:RecordSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RecordSet, __self__).__init__(
            'azurerm:network/v20180301preview:RecordSet',
            resource_name,
            __props__,
            opts)
