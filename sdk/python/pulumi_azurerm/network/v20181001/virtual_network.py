...
class VirtualNetwork(pulumi.CustomResource):
    ...
    The DDoS protection plan associated with the virtual network.
      * `id` (`str`) - Resource ID.
    """
    dhcp_options: pulumi.Output[dict]
    """
    The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
      * `dns_servers` (`list`) - The list of DNS servers IP addresses.
    """
    enable_ddos_protection: pulumi.Output[bool]
    """
    Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
    """
    enable_vm_protection: pulumi.Output[bool]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, address_space=None, ddos_protection_plan=None, dhcp_options=None, enable_ddos_protection=None, enable_vm_protection=None, etag=None, id=None, location=None, name=None, provisioning_state=None, resource_group_name=None, resource_guid=None, subnets=None, tags=None, virtual_network_peerings=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20150615:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20160330:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20160601:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20160901:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20161201:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20170301:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20170601:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20170801:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20170901:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20171001:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20171101:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20180101:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20180201:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20180401:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20180601:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20180701:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20180801:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20181101:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20181201:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20190201:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20190401:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20190601:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20190701:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20190801:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20200401:VirtualNetwork"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualNetwork")])
