...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: Properties of the virtual network.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[dict] tags: Resource tags.

        The **properties** object supports the following:

          * `address_space` (`pulumi.Input[dict]`) - The AddressSpace that contains an array of IP address ranges that can be used by subnets.
            * `address_prefixes` (`pulumi.Input[list]`) - A list of address blocks reserved for this virtual network in CIDR notation.

          * `ddos_protection_plan` (`pulumi.Input[dict]`) - The DDoS protection plan associated with the virtual network.
            * `id` (`pulumi.Input[str]`) - Resource ID.

          * `dhcp_options` (`pulumi.Input[dict]`) - The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
            * `dns_servers` (`pulumi.Input[list]`) - The list of DNS servers IP addresses.

          * `enable_ddos_protection` (`pulumi.Input[bool]`) - Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
          * `enable_vm_protection` (`pulumi.Input[bool]`) - Indicates if VM protection is enabled for all the subnets in the virtual network.
          ...
          * `resource_guid` (`pulumi.Input[str]`) - The resourceGuid property of the Virtual Network resource.
          * `subnets` (`pulumi.Input[list]`) - A list of subnets in a Virtual Network.
          ...
          * `virtual_network_peerings` (`pulumi.Input[list]`) - A list of peerings in a Virtual Network.
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
            * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
