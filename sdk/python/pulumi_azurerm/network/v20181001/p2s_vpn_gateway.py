...
class P2sVpnGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        p2s_vpn_gateway = azurerm.network.v20181001.P2sVpnGateway("p2sVpnGateway",
