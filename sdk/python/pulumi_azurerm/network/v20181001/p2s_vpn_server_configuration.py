...
class P2sVpnServerConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        p2s_vpn_server_configuration = azurerm.network.v20181001.P2sVpnServerConfiguration("p2sVpnServerConfiguration",
