...
def get_public_ip_address(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20181001:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult).value
