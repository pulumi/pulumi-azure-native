...
class ServiceEndpointPolicyDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        service_endpoint_policy_definition = azurerm.network.v20181001.ServiceEndpointPolicyDefinition("serviceEndpointPolicyDefinition",
