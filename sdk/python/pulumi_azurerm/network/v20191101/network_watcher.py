...
class NetworkWatcher(pulumi.CustomResource):
    def __init__(__self__,
        ...
        network_watcher = azurerm.network.v20191101.NetworkWatcher("networkWatcher",
            location="eastus",
