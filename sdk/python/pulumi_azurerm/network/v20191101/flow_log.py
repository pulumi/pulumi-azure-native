...
class FlowLog(pulumi.CustomResource):
    def __init__(__self__,
        ...
        flow_log = azurerm.network.v20191101.FlowLog("flowLog",
            enabled=True,
            flow_log_name="fl",
            format={
                "type": "JSON",
