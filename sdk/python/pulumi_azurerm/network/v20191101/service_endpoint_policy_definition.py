...
class ServiceEndpointPolicyDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        service_endpoint_policy_definition = azurerm.network.v20191101.ServiceEndpointPolicyDefinition("serviceEndpointPolicyDefinition",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20180701:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20180801:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20181001:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20181101:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20181201:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20190201:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20190401:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20190601:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20190701:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20190801:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20190901:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20191201:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20200301:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20200401:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20200501:ServiceEndpointPolicyDefinition"), pulumi.Alias(type_="azurerm:network/v20200601:ServiceEndpointPolicyDefinition")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServiceEndpointPolicyDefinition, __self__).__init__(
            'azurerm:network/v20191101:ServiceEndpointPolicyDefinition',
            resource_name,
            __props__,
            opts)
