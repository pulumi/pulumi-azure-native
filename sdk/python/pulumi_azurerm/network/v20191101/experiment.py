...
class Experiment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        experiment = azurerm.network.v20191101.Experiment("experiment",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:Experiment")])
