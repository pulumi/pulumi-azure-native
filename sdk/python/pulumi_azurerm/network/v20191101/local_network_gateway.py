...
class LocalNetworkGateway(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, bgp_settings=None, gateway_ip_address=None, id=None, local_network_address_space=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
