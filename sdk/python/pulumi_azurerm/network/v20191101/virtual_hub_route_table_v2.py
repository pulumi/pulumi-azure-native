...
class VirtualHubRouteTableV2(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_hub_route_table_v2 = azurerm.network.v20191101.VirtualHubRouteTableV2("virtualHubRouteTableV2",
