...
class PrivateLinkServicePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, name=None, private_link_service_connection_state=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20190401:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20190601:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20190701:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20190801:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20190901:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20191201:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20200301:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20200401:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20200501:PrivateLinkServicePrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20200601:PrivateLinkServicePrivateEndpointConnection")])
