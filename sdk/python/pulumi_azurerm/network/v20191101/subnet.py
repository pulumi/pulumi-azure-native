...
class Subnet(pulumi.CustomResource):
    ...
    An array of service endpoints.
      ...
      * `service` (`str`) - The type of the endpoint service.
    """
    def __init__(__self__, resource_name, opts=None, address_prefix=None, address_prefixes=None, delegations=None, id=None, name=None, nat_gateway=None, network_security_group=None, private_endpoint_network_policies=None, private_link_service_network_policies=None, resource_group_name=None, route_table=None, service_endpoint_policies=None, service_endpoints=None, virtual_network_name=None, __props__=None, __name__=None, __opts__=None):
        """
