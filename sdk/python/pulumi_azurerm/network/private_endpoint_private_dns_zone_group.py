...
class PrivateEndpointPrivateDnsZoneGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, name=None, private_dns_zone_group_name=None, private_endpoint_name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
        super(PrivateEndpointPrivateDnsZoneGroup, __self__).__init__(
            'azurerm:network:PrivateEndpointPrivateDnsZoneGroup',
            resource_name,
            __props__,
            opts)
