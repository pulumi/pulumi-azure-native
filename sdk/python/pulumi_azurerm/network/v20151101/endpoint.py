...
class Endpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:Endpoint"), pulumi.Alias(type_="azurerm:network/v20170301:Endpoint"), pulumi.Alias(type_="azurerm:network/v20170501:Endpoint"), pulumi.Alias(type_="azurerm:network/v20180201:Endpoint"), pulumi.Alias(type_="azurerm:network/v20180301:Endpoint"), pulumi.Alias(type_="azurerm:network/v20180401:Endpoint")])
