...
class PacketCapture(pulumi.CustomResource):
    def __init__(__self__,
        ...
        packet_capture = azurerm.network.v20190701.PacketCapture("packetCapture",
