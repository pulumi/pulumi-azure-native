...
class PrivateLinkService(pulumi.CustomResource):
    ...
    """
    auto_approval: pulumi.Output[dict]
    """
    ...
    An array of private link service IP configurations.
      ...
      * `type` (`str`) - The resource type.
    """
    load_balancer_frontend_ip_configurations: pulumi.Output[list]
    """
    ...
    Resource type.
    """
    visibility: pulumi.Output[dict]
    """
    The visibility list of the private link service.
      * `subscriptions` (`list`) - The list of subscriptions.
    """
    def __init__(__self__, resource_name, opts=None, auto_approval=None, etag=None, fqdns=None, id=None, ip_configurations=None, load_balancer_frontend_ip_configurations=None, location=None, name=None, private_endpoint_connections=None, provisioning_state=None, resource_group_name=None, tags=None, visibility=None, __props__=None, __name__=None, __opts__=None):
        """
        Private link service resource.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[dict] auto_approval: The auto-approval list of the private link service.
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated.
        :param pulumi.Input[list] fqdns: The list of Fqdn.
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[list] ip_configurations: An array of private link service IP configurations.
        :param pulumi.Input[list] load_balancer_frontend_ip_configurations: An array of references to the load balancer IP configurations.
        :param pulumi.Input[str] location: Resource location.
        :param pulumi.Input[str] name: The name of the private link service.
        :param pulumi.Input[list] private_endpoint_connections: An array of list about connections to the private endpoint.
        :param pulumi.Input[str] provisioning_state: The provisioning state of the private link service resource.
        ...
        The **load_balancer_frontend_ip_configurations** object supports the following:
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20190401:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190601:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190801:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190901:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20191101:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20191201:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200301:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200401:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200501:PrivateLinkService")])
