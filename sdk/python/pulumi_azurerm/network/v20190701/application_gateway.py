...
class ApplicationGateway(pulumi.CustomResource):
    ...
    Properties of the application gateway.
      * `authentication_certificates` (`list`) - Authentication certificates of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway authentication certificate.
      ...
      * `backend_http_settings_collection` (`list`) - Backend http settings of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway backend HTTP settings.
      ...
      * `frontend_ip_configurations` (`list`) - Frontend IP addresses of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway frontend IP configuration.
      ...
      * `frontend_ports` (`list`) - Frontend ports of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway frontend port.
      ...
      * `gateway_ip_configurations` (`list`) - Subnets of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway IP configuration.
      ...
      * `http_listeners` (`list`) - Http listeners of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway HTTP listener.
      ...
      * `probes` (`list`) - Probes of the application gateway resource.
        ...
        * `properties` (`dict`) - Properties of the application gateway probe.
      ...
      * `provisioning_state` (`str`) - The provisioning state of the application gateway resource.
      * `redirect_configurations` (`list`) - Redirect configurations of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway redirect configuration.
      ...
      * `request_routing_rules` (`list`) - Request routing rules of the application gateway resource.
        ...
        * `properties` (`dict`) - Properties of the application gateway request routing rule.
      ...
      * `resource_guid` (`str`) - The resource GUID property of the application gateway resource.
      * `rewrite_rule_sets` (`list`) - Rewrite rules for the application gateway resource.
        ...
        * `properties` (`dict`) - Properties of the application gateway rewrite rule set.
      ...
      * `ssl_certificates` (`list`) - SSL certificates of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway SSL certificate.
      ...
      * `trusted_root_certificates` (`list`) - Trusted Root certificates of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway trusted root certificate.
          * `data` (`str`) - Certificate public data.
          * `key_vault_secret_id` (`str`) - Secret Id of (base-64 encoded unencrypted pfx) 'Secret' or 'Certificate' object stored in KeyVault.
      ...
      * `url_path_maps` (`list`) - URL path map of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        ...
        * `properties` (`dict`) - Properties of the application gateway URL path map.
          ...
          * `path_rules` (`list`) - Path rule of URL path map resource.
            ...
            * `properties` (`dict`) - Properties of the application gateway path rule.
    ...
    def __init__(__self__, resource_name, opts=None, authentication_certificates=None, autoscale_configuration=None, backend_address_pools=None, backend_http_settings_collection=None, custom_error_configurations=None, enable_fips=None, enable_http2=None, etag=None, firewall_policy=None, frontend_ip_configurations=None, frontend_ports=None, gateway_ip_configurations=None, http_listeners=None, id=None, identity=None, location=None, name=None, probes=None, provisioning_state=None, redirect_configurations=None, request_routing_rules=None, resource_group_name=None, resource_guid=None, rewrite_rule_sets=None, sku=None, ssl_certificates=None, ssl_policy=None, tags=None, trusted_root_certificates=None, url_path_maps=None, web_application_firewall_configuration=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] firewall_policy: Reference of the FirewallPolicy resource.
        ...
        :param pulumi.Input[str] resource_guid: The resource GUID property of the application gateway resource.
        ...
        The **authentication_certificates** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the authentication certificate resource.
        ...
        The **backend_address_pools** object supports the following:
          ...
          * `backend_ip_configurations` (`pulumi.Input[list]`) - Collection of references to IPs defined in network interfaces.
            ...
            * `load_balancer_backend_address_pools` (`pulumi.Input[list]`) - The reference of LoadBalancerBackendAddressPool resource.
              ...
              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the backend address pool resource.
            ...
            * `load_balancer_inbound_nat_rules` (`pulumi.Input[list]`) - A list of references of LoadBalancerInboundNatRules.
              ...
              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the inbound NAT rule resource.

            * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
            * `primary` (`pulumi.Input[bool]`) - Whether this is a primary customer address on the network interface.
            * `private_ip_address` (`pulumi.Input[str]`) - Private IP address of the IP configuration.
            * `private_ip_address_version` (`pulumi.Input[str]`) - Whether the specific IP configuration is IPv4 or IPv6. Default is IPv4.
            * `private_ip_allocation_method` (`pulumi.Input[str]`) - The private IP address allocation method.
            * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the network interface IP configuration.
            * `public_ip_address` (`pulumi.Input[dict]`) - Public IP address bound to the IP configuration.
              ...
              * `location` (`pulumi.Input[str]`) - Resource location.
              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the public IP address resource.
              ...
              * `resource_guid` (`pulumi.Input[str]`) - The resource GUID property of the public IP address resource.
            ...
            * `virtual_network_taps` (`pulumi.Input[list]`) - The reference to Virtual Network Taps.
              * `destination_load_balancer_front_end_ip_configuration` (`pulumi.Input[dict]`) - The reference to the private IP address on the internal Load Balancer that will receive the tap.
                * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
                * `id` (`pulumi.Input[str]`) - Resource ID.
                ...
                * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the frontend IP configuration resource.
                * `public_ip_address` (`pulumi.Input[dict]`) - The reference of the Public IP resource.
                * `public_ip_prefix` (`pulumi.Input[dict]`) - The reference of the Public IP Prefix resource.
                * `subnet` (`pulumi.Input[dict]`) - The reference of the subnet resource.
                * `zones` (`pulumi.Input[list]`) - A list of availability zones denoting the IP allocated for the resource needs to come from.

              * `destination_network_interface_ip_configuration` (`pulumi.Input[dict]`) - The reference to the private IP Address of the collector nic that will receive the tap.
              * `destination_port` (`pulumi.Input[float]`) - The VXLAN destination port that will receive the tapped traffic.
              * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
              * `id` (`pulumi.Input[str]`) - Resource ID.
              * `location` (`pulumi.Input[str]`) - Resource location.
              * `tags` (`pulumi.Input[dict]`) - Resource tags.
        ...
        The **backend_http_settings_collection** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the backend HTTP settings resource.
        ...
        The **frontend_ports** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the frontend port resource.
          * `type` (`pulumi.Input[str]`) - Type of the resource.
        ...
        The **gateway_ip_configurations** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the application gateway IP configuration resource.
        ...
        The **http_listeners** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the HTTP listener resource.
        ...
        The **probes** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the probe resource.
        ...
        The **request_routing_rules** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the request routing rule resource.
        ...
        The **ssl_certificates** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the SSL certificate resource.
        ...
        The **trusted_root_certificates** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the trusted root certificate resource.
          * `type` (`pulumi.Input[str]`) - Type of the resource.
        ...
        The **url_path_maps** object supports the following:
          ...
          * `path_rules` (`pulumi.Input[list]`) - Path rule of URL path map resource.
            ...
            * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the path rule resource.
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the URL path map resource.
          * `type` (`pulumi.Input[str]`) - Type of the resource.
