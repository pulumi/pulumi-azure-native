...
class VirtualWan(pulumi.CustomResource):
    ...
    List of all P2SVpnServerConfigurations associated with the virtual wan.
      ...
      * `p2_s_vpn_server_config_radius_client_root_certificates` (`list`) - Radius client root certificate of P2SVpnServerConfiguration.
        ...
        * `provisioning_state` (`str`) - The provisioning state of the radius client root certificate resource.
      ...
      * `p2_s_vpn_server_config_radius_server_root_certificates` (`list`) - Radius Server root certificate of P2SVpnServerConfiguration.
        ...
        * `id` (`str`) - Resource ID.
        * `name` (`str`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
        * `provisioning_state` (`str`) - The provisioning state of the radius server root certificate resource.
      ...
      * `provisioning_state` (`str`) - The provisioning state of the P2S VPN server configuration resource.
