...
class Subnet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ResourceNavigationLinkArgs']]]] resource_navigation_links: An array of references to the external resources using subnet.
        :param pulumi.Input[pulumi.InputType['RouteTableArgs']] route_table: The reference of the RouteTable resource.
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceAssociationLinkArgs']]]] service_association_links: An array of references to services injecting into this subnet.
