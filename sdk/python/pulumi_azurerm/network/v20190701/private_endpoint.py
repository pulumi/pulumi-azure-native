...
class PrivateEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/preview:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20190401:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20190601:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20190801:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20190901:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20191101:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20191201:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20200301:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20200401:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20200501:PrivateEndpoint"), pulumi.Alias(type_="azurerm:network/v20200601:PrivateEndpoint")])
