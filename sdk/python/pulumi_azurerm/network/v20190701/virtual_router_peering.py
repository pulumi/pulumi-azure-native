...
class VirtualRouterPeering(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_router_peering = azurerm.network.v20190701.VirtualRouterPeering("virtualRouterPeering",
            peer_asn=20000,
            peer_ip="192.168.1.5",
