...
def get_express_route_circuit_connection(circuit_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20190701:getExpressRouteCircuitConnection', __args__, opts=opts, typ=GetExpressRouteCircuitConnectionResult).value
