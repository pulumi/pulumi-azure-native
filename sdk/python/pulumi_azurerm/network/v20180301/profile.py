...
class Profile(pulumi.CustomResource):
    ...
    The endpoint monitoring settings of the Traffic Manager profile.
      ...
      * `expected_status_code_ranges` (`list`) - List of expected status code ranges.
        * `max` (`float`) - Max status code.
        * `min` (`float`) - Min status code.
    ...
    """
    def __init__(__self__, resource_name, opts=None, dns_config=None, endpoints=None, id=None, location=None, monitor_config=None, name=None, profile_status=None, resource_group_name=None, tags=None, traffic_routing_method=None, traffic_view_enrollment_status=None, type=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        The **monitor_config** object supports the following:
          ...
          * `expected_status_code_ranges` (`pulumi.Input[list]`) - List of expected status code ranges.
            * `max` (`pulumi.Input[float]`) - Max status code.
            * `min` (`pulumi.Input[float]`) - Min status code.
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20151101:Profile"), pulumi.Alias(type_="azurerm:network/v20170301:Profile"), pulumi.Alias(type_="azurerm:network/v20170501:Profile"), pulumi.Alias(type_="azurerm:network/v20180201:Profile"), pulumi.Alias(type_="azurerm:network/v20180401:Profile")])
