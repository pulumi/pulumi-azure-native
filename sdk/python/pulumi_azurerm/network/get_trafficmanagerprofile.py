...
def get_trafficmanagerprofile(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network:getTrafficmanagerprofile', __args__, opts=opts).value
