...
def get_virtual_network_subnet(name=None, resource_group_name=None, virtual_network_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network:getVirtualNetworkSubnet', __args__, opts=opts).value

    return AwaitableGetVirtualNetworkSubnetResult(
