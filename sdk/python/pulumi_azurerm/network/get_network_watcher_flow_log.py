...
class AwaitableGetNetworkWatcherFlowLogResult(GetNetworkWatcherFlowLogResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkWatcherFlowLogResult(
            etag=self.etag,
...
def get_network_watcher_flow_log(name=None, network_watcher_name=None, resource_group_name=None, opts=None):
    """
