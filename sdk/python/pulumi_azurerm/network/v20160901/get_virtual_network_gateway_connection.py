...
def get_virtual_network_gateway_connection(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20160901:getVirtualNetworkGatewayConnection', __args__, opts=opts, typ=GetVirtualNetworkGatewayConnectionResult).value
