...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def ip_configurations(self) -> pulumi.Output[List['outputs.VirtualNetworkGatewayIPConfigurationResponse']]:
        """
