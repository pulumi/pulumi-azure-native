...
class PacketCapture(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, bytes_to_capture_per_packet=None, filters=None, name=None, network_watcher_name=None, resource_group_name=None, storage_location=None, target=None, time_limit_in_seconds=None, total_bytes_per_session=None, __props__=None, __name__=None, __opts__=None):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20161201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20170301:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20170601:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20170801:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20170901:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20171001:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20171101:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180101:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180401:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180601:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180701:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20180801:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20181001:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20181101:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20181201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190401:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190601:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190701:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190801:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20190901:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20191101:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20191201:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20200301:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20200401:PacketCapture"), pulumi.Alias(type_="azurerm:network/v20200501:PacketCapture")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PacketCapture, __self__).__init__(
            'azurerm:network/v20160901:PacketCapture',
            resource_name,
            __props__,
            opts)
