...
class VirtualHub(pulumi.CustomResource):
    ...
    List of references to Bgp Connections.
      * `id` (`str`) - Resource ID.
    """
    enable_virtual_router_route_propogation: pulumi.Output[bool]
    """
    ...
    def __init__(__self__, resource_name, opts=None, address_prefix=None, azure_firewall=None, enable_virtual_router_route_propogation=None, express_route_gateway=None, id=None, location=None, name=None, p2_s_vpn_gateway=None, resource_group_name=None, route_table=None, routing_state=None, security_partner_provider=None, security_provider_name=None, sku=None, tags=None, virtual_hub_route_table_v2s=None, virtual_router_asn=None, virtual_router_ips=None, virtual_wan=None, vpn_gateway=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(VirtualHub, __self__).__init__(
            'azurerm:network/v20200601:VirtualHub',
            resource_name,
            __props__,
            opts)
