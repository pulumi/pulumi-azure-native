...
class ServiceEndpointPolicyDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        service_endpoint_policy_definition = azurerm.network.v20200601.ServiceEndpointPolicyDefinition("serviceEndpointPolicyDefinition",
        ...
        super(ServiceEndpointPolicyDefinition, __self__).__init__(
            'azurerm:network/v20200601:ServiceEndpointPolicyDefinition',
            resource_name,
            __props__,
            opts)
