...
class PublicIPPrefix(pulumi.CustomResource):
    custom_ip_prefix: pulumi.Output[dict]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, custom_ip_prefix=None, id=None, ip_tags=None, location=None, name=None, prefix_length=None, public_ip_address_version=None, resource_group_name=None, sku=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        """
        Public IP prefix resource.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[dict] custom_ip_prefix: The customIpPrefix that this prefix is associated with.
        ...
        The **custom_ip_prefix** object supports the following:
        ...
        super(PublicIPPrefix, __self__).__init__(
            'azurerm:network/v20200601:PublicIPPrefix',
            resource_name,
            __props__,
            opts)
