...
class GetVirtualNetworkPeeringResult:
    ...
    def __init__(__self__, allow_forwarded_traffic=None, allow_gateway_transit=None, allow_virtual_network_access=None, etag=None, name=None, peering_state=None, provisioning_state=None, remote_address_space=None, remote_bgp_communities=None, remote_virtual_network=None, use_remote_gateways=None):
        ...
        __self__.remote_bgp_communities = remote_bgp_communities
        """
...
def get_virtual_network_peering(name=None, resource_group_name=None, virtual_network_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20200601:getVirtualNetworkPeering', __args__, opts=opts).value
    ...
    return AwaitableGetVirtualNetworkPeeringResult(
        ...
        remote_bgp_communities=__ret__.get('remoteBgpCommunities'),
