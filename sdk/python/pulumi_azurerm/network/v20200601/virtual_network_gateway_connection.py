...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_network_gateway_connection = azurerm.network.v20200601.VirtualNetworkGatewayConnection("virtualNetworkGatewayConnection",
        ...
        super(VirtualNetworkGatewayConnection, __self__).__init__(
            'azurerm:network/v20200601:VirtualNetworkGatewayConnection',
            resource_name,
            __props__,
            opts)
