...
class VirtualApplianceSite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VirtualApplianceSite"), pulumi.Alias(type_="azurerm:network/preview:VirtualApplianceSite"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualApplianceSite")])
