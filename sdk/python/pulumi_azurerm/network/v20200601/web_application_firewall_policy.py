...
class WebApplicationFirewallPolicy(pulumi.CustomResource):
    ...
    A collection of references to application gateways.
      ...
      * `private_endpoint_connections` (`list`) - Private Endpoint connections on application gateway.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `id` (`str`) - Resource ID.
      ...
      * `private_link_configurations` (`list`) - PrivateLink configurations on application gateway.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `id` (`str`) - Resource ID.
      ...
      * `ssl_profiles` (`list`) - SSL profiles of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
      ...
      * `tags` (`dict`) - Resource tags.
      * `trusted_client_certificates` (`list`) - Trusted client certificates of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
        * `data` (`str`) - Certificate public data.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `id` (`str`) - Resource ID.
