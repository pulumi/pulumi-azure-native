...
class VpnConnection(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 vpn_link_connections: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VpnSiteLinkConnectionArgs']]]]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        vpn_connection = azurerm.network.v20200601.VpnConnection("vpnConnection",
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['VpnSiteLinkConnectionArgs']]]] vpn_link_connections: List of all vpn site link connections to the gateway.
        """
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20180401:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20180601:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20180701:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20180801:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20181001:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20181101:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20181201:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20190201:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20190401:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20190601:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20190701:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20190801:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20190901:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20191101:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20191201:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20200301:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20200401:VpnConnection"), pulumi.Alias(type_="azurerm:network/v20200501:VpnConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VpnConnection, __self__).__init__(
            'azurerm:network/v20200601:VpnConnection',
            resource_name,
            __props__,
            opts)
    ...
    def dpd_timeout_seconds(self) -> pulumi.Output[Optional[float]]:
        """
    ...
    def vpn_link_connections(self) -> pulumi.Output[Optional[List['outputs.VpnSiteLinkConnectionResponse']]]:
        """
