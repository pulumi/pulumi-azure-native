...
def get_dscp_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20200601:getDscpConfiguration', __args__, opts=opts, typ=GetDscpConfigurationResult).value
