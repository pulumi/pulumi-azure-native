...
class VirtualNetwork(pulumi.CustomResource):
    ...
    A list of peerings in a Virtual Network.
      ...
      * `remote_bgp_communities` (`dict`) - The reference to the remote virtual network's Bgp Communities.
        * `regional_community` (`str`) - The BGP community associated with the region of the virtual network.
        * `virtual_network_community` (`str`) - The BGP community associated with the virtual network.
    ...
    """
    def __init__(__self__, resource_name, opts=None, address_space=None, bgp_communities=None, ddos_protection_plan=None, dhcp_options=None, enable_ddos_protection=None, enable_vm_protection=None, id=None, ip_allocations=None, location=None, name=None, resource_group_name=None, subnets=None, tags=None, virtual_network_peerings=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[list] ip_allocations: Array of IpAllocation which reference this VNET.
        ...
        The **virtual_network_peerings** object supports the following:
          ...
          * `remote_bgp_communities` (`pulumi.Input[dict]`) - The reference to the remote virtual network's Bgp Communities.
