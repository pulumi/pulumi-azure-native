...
class GetExpressRouteCircuitConnectionResult:
    ...
    def __init__(__self__, address_prefix=None, authorization_key=None, circuit_connection_status=None, etag=None, express_route_circuit_peering=None, ipv6_circuit_connection_config=None, name=None, peer_express_route_circuit_peering=None, provisioning_state=None, type=None):
        ...
        __self__.ipv6_circuit_connection_config = ipv6_circuit_connection_config
        """
...
def get_express_route_circuit_connection(circuit_name=None, name=None, peering_name=None, resource_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20200601:getExpressRouteCircuitConnection', __args__, opts=opts).value
    ...
    return AwaitableGetExpressRouteCircuitConnectionResult(
        ...
        ipv6_circuit_connection_config=__ret__.get('ipv6CircuitConnectionConfig'),
