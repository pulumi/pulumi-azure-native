...
class CustomIPPrefix(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:CustomIPPrefix"), pulumi.Alias(type_="azurerm:network/preview:CustomIPPrefix")])
