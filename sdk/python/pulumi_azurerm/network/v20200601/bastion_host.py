...
class BastionHost(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:BastionHost"), pulumi.Alias(type_="azurerm:network/preview:BastionHost"), pulumi.Alias(type_="azurerm:network/v20190401:BastionHost"), pulumi.Alias(type_="azurerm:network/v20190601:BastionHost"), pulumi.Alias(type_="azurerm:network/v20190701:BastionHost"), pulumi.Alias(type_="azurerm:network/v20190801:BastionHost"), pulumi.Alias(type_="azurerm:network/v20190901:BastionHost"), pulumi.Alias(type_="azurerm:network/v20191101:BastionHost"), pulumi.Alias(type_="azurerm:network/v20191201:BastionHost"), pulumi.Alias(type_="azurerm:network/v20200301:BastionHost"), pulumi.Alias(type_="azurerm:network/v20200401:BastionHost"), pulumi.Alias(type_="azurerm:network/v20200501:BastionHost")])
