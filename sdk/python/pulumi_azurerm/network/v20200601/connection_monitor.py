...
class ConnectionMonitor(pulumi.CustomResource):
    ...
    List of connection monitor endpoints.
      ...
      * `coverage_level` (`str`) - Test coverage for the endpoint.
      ...
      * `scope` (`dict`) - Endpoint scope.
        * `exclude` (`list`) - List of items which needs to be excluded from the endpoint scope.
          * `address` (`str`) - The address of the endpoint item. Supported types are IPv4/IPv6 subnet mask or IPv4/IPv6 IP address.

        * `include` (`list`) - List of items which needs to be included to the endpoint scope.
    ...
    List of connection monitor test configurations.
      ...
      * `tcp_configuration` (`dict`) - The parameters used to perform test evaluation over TCP.
        * `destination_port_behavior` (`str`) - Destination port behavior.
        * `disable_trace_route` (`bool`) - Value indicating whether path evaluation with trace route should be disabled.
        * `port` (`float`) - The port to connect to.
    ...
    def __init__(__self__, resource_name, opts=None, auto_start=None, destination=None, endpoints=None, location=None, monitoring_interval_in_seconds=None, name=None, network_watcher_name=None, notes=None, outputs=None, resource_group_name=None, source=None, tags=None, test_configurations=None, test_groups=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **endpoints** object supports the following:
          ...
          * `coverage_level` (`pulumi.Input[str]`) - Test coverage for the endpoint.
          ...
          * `scope` (`pulumi.Input[dict]`) - Endpoint scope.
            * `exclude` (`pulumi.Input[list]`) - List of items which needs to be excluded from the endpoint scope.
              * `address` (`pulumi.Input[str]`) - The address of the endpoint item. Supported types are IPv4/IPv6 subnet mask or IPv4/IPv6 IP address.

            * `include` (`pulumi.Input[list]`) - List of items which needs to be included to the endpoint scope.

          * `type` (`pulumi.Input[str]`) - The endpoint type.
        ...
        The **test_configurations** object supports the following:
          ...
          * `tcp_configuration` (`pulumi.Input[dict]`) - The parameters used to perform test evaluation over TCP.
            * `destination_port_behavior` (`pulumi.Input[str]`) - Destination port behavior.
            * `disable_trace_route` (`pulumi.Input[bool]`) - Value indicating whether path evaluation with trace route should be disabled.
            * `port` (`pulumi.Input[float]`) - The port to connect to.
        ...
        super(ConnectionMonitor, __self__).__init__(
            'azurerm:network/v20200601:ConnectionMonitor',
            resource_name,
            __props__,
            opts)
