...
class ExpressRouteCircuitConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        express_route_circuit_connection = azurerm.network.v20200601.ExpressRouteCircuitConnection("expressRouteCircuitConnection",
        ...
        super(ExpressRouteCircuitConnection, __self__).__init__(
            'azurerm:network/v20200601:ExpressRouteCircuitConnection',
            resource_name,
            __props__,
            opts)
