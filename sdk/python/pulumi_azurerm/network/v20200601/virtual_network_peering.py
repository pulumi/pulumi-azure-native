...
class VirtualNetworkPeering(pulumi.CustomResource):
    ...
    """
    remote_bgp_communities: pulumi.Output[dict]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, allow_forwarded_traffic=None, allow_gateway_transit=None, allow_virtual_network_access=None, id=None, name=None, peering_state=None, remote_address_space=None, remote_bgp_communities=None, remote_virtual_network=None, resource_group_name=None, use_remote_gateways=None, virtual_network_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[dict] remote_bgp_communities: The reference to the remote virtual network's Bgp Communities.
        ...
        The **remote_bgp_communities** object supports the following:
        ...
        super(VirtualNetworkPeering, __self__).__init__(
            'azurerm:network/v20200601:VirtualNetworkPeering',
            resource_name,
            __props__,
            opts)
