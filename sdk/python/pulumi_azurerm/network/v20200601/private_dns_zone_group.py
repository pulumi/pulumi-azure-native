...
class PrivateDnsZoneGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:PrivateDnsZoneGroup"), pulumi.Alias(type_="azurerm:network/preview:PrivateDnsZoneGroup"), pulumi.Alias(type_="azurerm:network/v20200301:PrivateDnsZoneGroup"), pulumi.Alias(type_="azurerm:network/v20200401:PrivateDnsZoneGroup"), pulumi.Alias(type_="azurerm:network/v20200501:PrivateDnsZoneGroup")])
