...
class VpnGateway(pulumi.CustomResource):
    ...
    List of all vpn connections to the gateway.
      ...
      * `dpd_timeout_seconds` (`float`) - DPD timeout in seconds for vpn connection.
    ...
    List of all IPs configured on the gateway.
      * `id` (`str`) - The identifier of the IP configuration for a VPN Gateway.
      * `private_ip_address` (`str`) - The private IP address of this IP configuration.
      * `public_ip_address` (`str`) - The public IP address of this IP configuration.
    """
    ...
    def __init__(__self__, resource_name, opts=None, bgp_settings=None, connections=None, id=None, location=None, name=None, resource_group_name=None, tags=None, virtual_hub=None, vpn_gateway_scale_unit=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **connections** object supports the following:
          ...
          * `dpd_timeout_seconds` (`pulumi.Input[float]`) - DPD timeout in seconds for vpn connection.
        ...
        super(VpnGateway, __self__).__init__(
            'azurerm:network/v20200601:VpnGateway',
            resource_name,
            __props__,
            opts)
