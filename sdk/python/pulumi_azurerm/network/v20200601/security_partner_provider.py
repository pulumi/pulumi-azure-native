...
class SecurityPartnerProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        security_partner_provider = azurerm.network.v20200601.SecurityPartnerProvider("securityPartnerProvider",
            location="West US",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200301:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200401:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200501:SecurityPartnerProvider")])
