...
class SecurityPartnerProvider(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, location=None, name=None, resource_group_name=None, security_provider_name=None, tags=None, virtual_hub=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] virtual_hub: The virtualHub to which the Security Partner Provider belongs.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20200301:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200401:SecurityPartnerProvider"), pulumi.Alias(type_="azurerm:network/v20200501:SecurityPartnerProvider")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecurityPartnerProvider, __self__).__init__(
            'azurerm:network/v20200601:SecurityPartnerProvider',
            resource_name,
            __props__,
            opts)
