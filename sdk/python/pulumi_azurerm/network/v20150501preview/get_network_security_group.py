...
class GetNetworkSecurityGroupResult:
    ...
    def network_interfaces(self) -> Optional[List['outputs.SubResourceResponse']]:
        """
...
def get_network_security_group(network_security_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20150501preview:getNetworkSecurityGroup', __args__, opts=opts, typ=GetNetworkSecurityGroupResult).value
