...
class GetRouteTableResult:
    ...
    @property
    @pulumi.getter
    def subnets(self) -> Optional[List['outputs.SubResourceResponse']]:
        """
...
def get_route_table(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20150501preview:getRouteTable', __args__, opts=opts, typ=GetRouteTableResult).value
