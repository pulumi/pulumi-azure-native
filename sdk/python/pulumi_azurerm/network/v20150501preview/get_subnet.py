...
class GetSubnetResult:
    ...
    def ip_configurations(self) -> Optional[List['outputs.SubResourceResponse']]:
        """
...
def get_subnet(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20150501preview:getSubnet', __args__, opts=opts, typ=GetSubnetResult).value
