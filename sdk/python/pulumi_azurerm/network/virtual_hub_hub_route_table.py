...
class VirtualHubHubRouteTable(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, id=None, name=None, properties=None, resource_group_name=None, route_table_name=None, virtual_hub_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        super(VirtualHubHubRouteTable, __self__).__init__(
            'azurerm:network:VirtualHubHubRouteTable',
            resource_name,
            __props__,
            opts)
