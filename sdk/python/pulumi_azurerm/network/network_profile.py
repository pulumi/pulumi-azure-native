        ...
        The **properties** object supports the following:
          ...
          * `container_network_interface_configurations` (`pulumi.Input[list]`) - List of chid container network interface configurations.
            ...
            * `properties` (`pulumi.Input[dict]`) - Container network interface configuration properties.
              ...
              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the container network interface configuration resource.
            ...
            * `properties` (`pulumi.Input[dict]`) - Container network interface properties.
              ...
              * `ip_configurations` (`pulumi.Input[list]`) - Reference to the ip configuration on this container nic.
                ...
                * `properties` (`pulumi.Input[dict]`) - Properties of the container network interface IP configuration.
                  * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the container network interface IP configuration resource.

                * `type` (`pulumi.Input[str]`) - Sub Resource type.

              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the container network interface resource.

            * `type` (`pulumi.Input[str]`) - Sub Resource type.

          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the network profile resource.
          * `resource_guid` (`pulumi.Input[str]`) - The resource GUID property of the network profile resource.
        """
