...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, authorization_key=None, connection_protocol=None, connection_type=None, enable_bgp=None, etag=None, express_route_gateway_bypass=None, id=None, ipsec_policies=None, local_network_gateway2=None, location=None, name=None, peer=None, resource_group_name=None, resource_guid=None, routing_weight=None, shared_key=None, tags=None, use_policy_based_traffic_selectors=None, virtual_network_gateway1=None, virtual_network_gateway2=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20150615:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20160330:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20160601:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20160901:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20161201:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20170301:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20170601:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20170801:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20170901:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20171001:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20171101:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20180101:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20180201:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20180401:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20180601:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20180701:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20180801:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20181001:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20181101:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20181201:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20190401:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20190601:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20190701:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20190801:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20200401:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualNetworkGatewayConnection"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualNetworkGatewayConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkGatewayConnection, __self__).__init__(
            'azurerm:network/v20190201:VirtualNetworkGatewayConnection',
            resource_name,
            __props__,
            opts)
