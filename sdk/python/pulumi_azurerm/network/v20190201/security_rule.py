...
class SecurityRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        security_rule = azurerm.network.v20190201.SecurityRule("securityRule",
            access="Deny",
        ...
        :param pulumi.Input[str] protocol: Network protocol this rule applies to. Possible values are 'Tcp', 'Udp', 'Icmp', 'Esp', and '*'.
