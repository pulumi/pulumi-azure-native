...
class HubVirtualNetworkConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:HubVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:network/v20200501:HubVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:network/v20200601:HubVirtualNetworkConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HubVirtualNetworkConnection, __self__).__init__(
            'azurerm:network/preview:HubVirtualNetworkConnection',
            resource_name,
            __props__,
            opts)
