...
class HubRouteTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:HubRouteTable"), pulumi.Alias(type_="azurerm:network/v20200401:HubRouteTable"), pulumi.Alias(type_="azurerm:network/v20200501:HubRouteTable"), pulumi.Alias(type_="azurerm:network/v20200601:HubRouteTable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HubRouteTable, __self__).__init__(
            'azurerm:network/preview:HubRouteTable',
            resource_name,
            __props__,
            opts)
    ...
    def associated_connections(self) -> pulumi.Output[List['outputs.SubResourceResponse']]:
        """
    ...
    def propagating_connections(self) -> pulumi.Output[List['outputs.SubResourceResponse']]:
        """
