...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[float] dpd_timeout_seconds: The dead peer detection timeout of this connection in seconds.
        ...
        super(VirtualNetworkGatewayConnection, __self__).__init__(
            'azurerm:network/preview:VirtualNetworkGatewayConnection',
            resource_name,
            __props__,
            opts)
