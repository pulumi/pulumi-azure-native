...
class VirtualHubIpConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VirtualHubIpConfiguration"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualHubIpConfiguration"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualHubIpConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualHubIpConfiguration, __self__).__init__(
            'azurerm:network/preview:VirtualHubIpConfiguration',
            resource_name,
            __props__,
            opts)
