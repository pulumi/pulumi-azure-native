...
class NetworkExperimentProfile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:NetworkExperimentProfile"), pulumi.Alias(type_="azurerm:network/v20191101:NetworkExperimentProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkExperimentProfile, __self__).__init__(
            'azurerm:network/preview:NetworkExperimentProfile',
            resource_name,
            __props__,
            opts)
