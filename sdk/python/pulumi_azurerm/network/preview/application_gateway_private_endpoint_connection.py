...
class ApplicationGatewayPrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20200501:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azurerm:network/v20200601:ApplicationGatewayPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationGatewayPrivateEndpointConnection, __self__).__init__(
            'azurerm:network/preview:ApplicationGatewayPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
