...
class VirtualNetworkLink(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VirtualNetworkLink"), pulumi.Alias(type_="azurerm:network/v20180901:VirtualNetworkLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkLink, __self__).__init__(
            'azurerm:network/preview:VirtualNetworkLink',
            resource_name,
            __props__,
            opts)
