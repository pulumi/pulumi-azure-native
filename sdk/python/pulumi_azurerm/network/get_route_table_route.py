...
class AwaitableGetRouteTableRouteResult(GetRouteTableRouteResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRouteTableRouteResult(
            etag=self.etag,
            name=self.name,
            properties=self.properties)


def get_route_table_route(name=None, resource_group_name=None, route_table_name=None, opts=None):
    """
