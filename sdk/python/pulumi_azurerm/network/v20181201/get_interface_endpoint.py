...
def get_interface_endpoint(expand=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20181201:getInterfaceEndpoint', __args__, opts=opts).value
