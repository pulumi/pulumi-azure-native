...
class InterfaceEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, endpoint_service=None, etag=None, fqdn=None, id=None, location=None, name=None, resource_group_name=None, subnet=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180801:InterfaceEndpoint"), pulumi.Alias(type_="azurerm:network/v20181001:InterfaceEndpoint"), pulumi.Alias(type_="azurerm:network/v20181101:InterfaceEndpoint"), pulumi.Alias(type_="azurerm:network/v20190201:InterfaceEndpoint")])
