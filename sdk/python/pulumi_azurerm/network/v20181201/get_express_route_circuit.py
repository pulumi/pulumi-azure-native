...
class GetExpressRouteCircuitResult:
    ...
    """
    def __init__(__self__, allow_classic_operations=None, allow_global_reach=None, authorizations=None, bandwidth_in_gbps=None, circuit_provisioning_state=None, etag=None, express_route_port=None, gateway_manager_etag=None, global_reach_enabled=None, location=None, name=None, peerings=None, provisioning_state=None, service_key=None, service_provider_notes=None, service_provider_properties=None, service_provider_provisioning_state=None, sku=None, stag=None, tags=None, type=None):
...
def get_express_route_circuit(circuit_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20181201:getExpressRouteCircuit', __args__, opts=opts, typ=GetExpressRouteCircuitResult).value
