...
class LocalNetworkGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        local_network_gateway = azurerm.network.v20181201.LocalNetworkGateway("localNetworkGateway",
