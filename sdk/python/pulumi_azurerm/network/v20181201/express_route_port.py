...
class ExpressRoutePort(pulumi.CustomResource):
    def __init__(__self__,
        ...
        express_route_port = azurerm.network.v20181201.ExpressRoutePort("expressRoutePort",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20180801:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20181001:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20181101:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190201:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190401:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190601:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190701:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190801:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20190901:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20191101:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20191201:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20200301:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20200401:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20200501:ExpressRoutePort"), pulumi.Alias(type_="azurerm:network/v20200601:ExpressRoutePort")])
