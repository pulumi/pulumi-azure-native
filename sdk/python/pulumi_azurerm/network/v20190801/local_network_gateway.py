...
class LocalNetworkGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        local_network_gateway = azurerm.network.v20190801.LocalNetworkGateway("localNetworkGateway",
