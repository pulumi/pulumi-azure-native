...
class VirtualRouterPeering(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, name=None, peer_asn=None, peer_ip=None, resource_group_name=None, virtual_router_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20190701:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20200401:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualRouterPeering")])
