...
class VirtualRouterPeering(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_router_peering = azurerm.network.v20190801.VirtualRouterPeering("virtualRouterPeering",
            peer_asn=20000,
            peer_ip="192.168.1.5",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20190701:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20200401:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualRouterPeering"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualRouterPeering")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualRouterPeering, __self__).__init__(
            'azurerm:network/v20190801:VirtualRouterPeering',
            resource_name,
            __props__,
            opts)
