...
class VirtualHub(pulumi.CustomResource):
    ...
    The VpnGateway associated with this VirtualHub.
      * `id` (`str`) - Resource ID.
    """
    def __init__(__self__, resource_name, opts=None, address_prefix=None, azure_firewall=None, express_route_gateway=None, id=None, location=None, name=None, p2_s_vpn_gateway=None, provisioning_state=None, resource_group_name=None, route_table=None, security_provider_name=None, tags=None, virtual_network_connections=None, virtual_wan=None, vpn_gateway=None, __props__=None, __name__=None, __opts__=None):
        """
        VirtualHub Resource.
        ...
        :param pulumi.Input[str] provisioning_state: The provisioning state of the virtual hub resource.
