...
class ConnectionMonitor(pulumi.CustomResource):
    def __init__(__self__,
        ...
        connection_monitor = azurerm.network.v20190801.ConnectionMonitor("connectionMonitor",
