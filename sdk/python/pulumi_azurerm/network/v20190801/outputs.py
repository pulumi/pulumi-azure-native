...
class ManagedRulesDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Allow to exclude some variable satisfy the condition for the WAF check.
        :param List['ManagedRuleSetResponseArgs'] managed_rule_sets: Describes the ruleSets that are associated with the policy.
        :param List['OwaspCrsExclusionEntryResponseArgs'] exclusions: Describes the Exclusions that are applied on the policy.
        """
