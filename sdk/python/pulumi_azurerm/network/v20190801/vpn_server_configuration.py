...
class VpnServerConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        vpn_server_configuration = azurerm.network.v20190801.VpnServerConfiguration("vpnServerConfiguration",
            location="West US",
