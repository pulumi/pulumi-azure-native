...
class FirewallPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        firewall_policy = azurerm.network.v20190801.FirewallPolicy("firewallPolicy",
