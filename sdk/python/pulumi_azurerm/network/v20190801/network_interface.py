...
class NetworkInterface(pulumi.CustomResource):
    ...
    """
    hosted_workloads: pulumi.Output[list]
    """
    ...
    Resource tags.
    """
    tap_configurations: pulumi.Output[list]
    """
    ...
    def __init__(__self__, resource_name, opts=None, dns_settings=None, enable_accelerated_networking=None, enable_ip_forwarding=None, etag=None, id=None, ip_configurations=None, location=None, mac_address=None, name=None, network_security_group=None, primary=None, provisioning_state=None, resource_group_name=None, resource_guid=None, tags=None, tap_configurations=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] tap_configurations: A list of TapConfigurations of the network interface.
        ...
        The **tap_configurations** object supports the following:

          * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
          * `id` (`pulumi.Input[str]`) - Resource ID.
          * `name` (`pulumi.Input[str]`) - The name of the resource that is unique within a resource group. This name can be used to access the resource.
          * `virtual_network_tap` (`pulumi.Input[dict]`) - The reference of the Virtual Network Tap resource.
        """
