...
class VirtualHubBgpConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, connection_name=None, id=None, name=None, properties=None, resource_group_name=None, virtual_hub_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(VirtualHubBgpConnection, __self__).__init__(
            'azurerm:network:VirtualHubBgpConnection',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, name=None, properties=None, type=None):
        ...
        :param pulumi.Input[str] name: Name of the connection.
        :param pulumi.Input[dict] properties: The properties of the Bgp connections.
        :param pulumi.Input[str] type: Connection type.

        The **properties** object supports the following:

          * `connection_state` (`pulumi.Input[str]`) - The current state of the VirtualHub to Peer.
          * `peer_asn` (`pulumi.Input[float]`) - Peer ASN.
          * `peer_ip` (`pulumi.Input[str]`) - Peer IP.
