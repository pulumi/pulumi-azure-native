...
class GetRecordSetResult:
    ...
    """
    def __init__(__self__, a_records=None, ttl=None, aaaa_records=None, cname_record=None, etag=None, metadata=None, mx_records=None, name=None, ns_records=None, ptr_records=None, soa_record=None, srv_records=None, txt_records=None, type=None):
