...
class Zone(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:Zone"), pulumi.Alias(type_="azurerm:network/preview:Zone"), pulumi.Alias(type_="azurerm:network/v20150504preview:Zone"), pulumi.Alias(type_="azurerm:network/v20170901:Zone"), pulumi.Alias(type_="azurerm:network/v20171001:Zone"), pulumi.Alias(type_="azurerm:network/v20180301preview:Zone"), pulumi.Alias(type_="azurerm:network/v20180501:Zone")])
