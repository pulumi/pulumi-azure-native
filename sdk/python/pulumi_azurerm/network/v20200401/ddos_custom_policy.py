...
class DdosCustomPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        ddos_custom_policy = azurerm.network.v20200401.DdosCustomPolicy("ddosCustomPolicy",
