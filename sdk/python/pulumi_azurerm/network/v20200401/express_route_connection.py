...
class ExpressRouteConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        express_route_connection = azurerm.network.v20200401.ExpressRouteConnection("expressRouteConnection",
