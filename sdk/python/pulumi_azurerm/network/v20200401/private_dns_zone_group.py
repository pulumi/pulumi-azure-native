...
class PrivateDnsZoneGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        private_dns_zone_group = azurerm.network.v20200401.PrivateDnsZoneGroup("privateDnsZoneGroup",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:PrivateDnsZoneGroup"), pulumi.Alias(type_="azurerm:network/v20200301:PrivateDnsZoneGroup"), pulumi.Alias(type_="azurerm:network/v20200501:PrivateDnsZoneGroup"), pulumi.Alias(type_="azurerm:network/v20200601:PrivateDnsZoneGroup")])
