...
class FirewallPolicy(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, base_policy=None, id=None, location=None, name=None, resource_group_name=None, tags=None, threat_intel_mode=None, threat_intel_whitelist=None, __props__=None, __name__=None, __opts__=None):
        """
