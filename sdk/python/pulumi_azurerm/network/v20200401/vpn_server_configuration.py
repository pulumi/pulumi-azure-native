...
class VpnServerConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 radius_servers: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RadiusServerArgs']]]]] = None,
        ...
        vpn_server_configuration = azurerm.network.v20200401.VpnServerConfiguration("vpnServerConfiguration",
            location="West US",
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['RadiusServerArgs']]]] radius_servers: Multiple Radius Server configuration for VpnServerConfiguration.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VpnServerConfiguration"), pulumi.Alias(type_="azurerm:network/v20190801:VpnServerConfiguration"), pulumi.Alias(type_="azurerm:network/v20190901:VpnServerConfiguration"), pulumi.Alias(type_="azurerm:network/v20191101:VpnServerConfiguration"), pulumi.Alias(type_="azurerm:network/v20191201:VpnServerConfiguration"), pulumi.Alias(type_="azurerm:network/v20200301:VpnServerConfiguration"), pulumi.Alias(type_="azurerm:network/v20200501:VpnServerConfiguration"), pulumi.Alias(type_="azurerm:network/v20200601:VpnServerConfiguration")])
    ...
    def radius_servers(self) -> pulumi.Output[Optional[List['outputs.RadiusServerResponse']]]:
        """
