...
class VirtualNetworkTap(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, destination_load_balancer_front_end_ip_configuration=None, destination_network_interface_ip_configuration=None, destination_port=None, id=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180801:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181001:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181101:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190401:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190601:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190701:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190801:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualNetworkTap")])
