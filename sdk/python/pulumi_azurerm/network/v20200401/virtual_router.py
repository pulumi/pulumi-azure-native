...
class VirtualRouter(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VirtualRouter"), pulumi.Alias(type_="azurerm:network/preview:VirtualRouter"), pulumi.Alias(type_="azurerm:network/v20190701:VirtualRouter"), pulumi.Alias(type_="azurerm:network/v20190801:VirtualRouter"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualRouter"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualRouter"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualRouter"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualRouter"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualRouter"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualRouter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualRouter, __self__).__init__(
            'azurerm:network/v20200401:VirtualRouter',
            resource_name,
            __props__,
            opts)
