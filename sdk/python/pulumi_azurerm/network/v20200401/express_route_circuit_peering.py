...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, azure_asn=None, circuit_name=None, connections=None, express_route_connection=None, gateway_manager_etag=None, id=None, ipv6_peering_config=None, microsoft_peering_config=None, name=None, peer_asn=None, peering_type=None, primary_azure_port=None, primary_peer_address_prefix=None, resource_group_name=None, route_filter=None, secondary_azure_port=None, secondary_peer_address_prefix=None, shared_key=None, state=None, stats=None, vlan_id=None, __props__=None, __name__=None, __opts__=None):
        """
