...
class PublicIPAddress(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, ddos_settings=None, dns_settings=None, id=None, idle_timeout_in_minutes=None, ip_address=None, ip_tags=None, location=None, name=None, public_ip_address_version=None, public_ip_allocation_method=None, public_ip_prefix=None, resource_group_name=None, sku=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        """
