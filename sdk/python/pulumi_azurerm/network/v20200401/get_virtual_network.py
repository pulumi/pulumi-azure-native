...
class GetVirtualNetworkResult:
    ...
    """
    def __init__(__self__, address_space=None, bgp_communities=None, ddos_protection_plan=None, dhcp_options=None, enable_ddos_protection=None, enable_vm_protection=None, etag=None, ip_allocations=None, location=None, name=None, provisioning_state=None, resource_guid=None, subnets=None, tags=None, type=None, virtual_network_peerings=None):
        ...
        __self__.bgp_communities = bgp_communities
        """
        ...
        __self__.ip_allocations = ip_allocations
        """
...
def get_virtual_network(name=None, resource_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20200401:getVirtualNetwork', __args__, opts=opts).value

    return AwaitableGetVirtualNetworkResult(
        address_space=__ret__.get('addressSpace'),
        bgp_communities=__ret__.get('bgpCommunities'),
        ...
        ip_allocations=__ret__.get('ipAllocations'),
