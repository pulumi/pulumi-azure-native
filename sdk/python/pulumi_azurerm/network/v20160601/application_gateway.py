...
class ApplicationGateway(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: Properties of Application Gateway
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[dict] tags: Resource tags

        The **properties** object supports the following:

          * `authentication_certificates` (`pulumi.Input[list]`) - Authentication certificates of application gateway resource
            ...
            * `properties` (`pulumi.Input[dict]`) - Properties of Authentication certificates of application gateway
          ...
          * `backend_address_pools` (`pulumi.Input[list]`) - Backend address pool of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
          ...
          * `backend_http_settings_collection` (`pulumi.Input[list]`) - Backend http settings of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`) - Properties of Backend address pool settings of application gateway
          ...
          * `frontend_ip_configurations` (`pulumi.Input[list]`) - Frontend IP addresses of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`) - Properties of Frontend IP configuration of application gateway
          ...
          * `frontend_ports` (`pulumi.Input[list]`) - Frontend ports of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`) - Properties of Frontend Port of application gateway
          ...
          * `gateway_ip_configurations` (`pulumi.Input[list]`) - Subnets of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`) - Properties of IP configuration of application gateway
          ...
          * `http_listeners` (`pulumi.Input[list]`) - HTTP listeners of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`) - Properties of Http listener of application gateway
          ...
          * `probes` (`pulumi.Input[list]`) - Probes of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`) - Properties of probe of application gateway
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - Provisioning state of the ApplicationGateway resource Updating/Deleting/Failed
          * `request_routing_rules` (`pulumi.Input[list]`) - Request routing rules of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`) - Properties of Request routing rule of application gateway
          ...
          * `resource_guid` (`pulumi.Input[str]`) - Resource guid property of the ApplicationGateway resource
          * `sku` (`pulumi.Input[dict]`) - Sku of application gateway resource
          ...
          * `ssl_certificates` (`pulumi.Input[list]`) - SSL certificates of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
          ...
          * `ssl_policy` (`pulumi.Input[dict]`) - SSL policy of application gateway resource
            * `disabled_ssl_protocols` (`pulumi.Input[list]`) - SSL protocols to be disabled on Application Gateway

          * `url_path_maps` (`pulumi.Input[list]`) - URL path map of application gateway resource
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `id` (`pulumi.Input[str]`) - Resource Id
            * `name` (`pulumi.Input[str]`) - Name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`) - Properties of UrlPathMap of application gateway
