...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `virtual_network_peerings` (`pulumi.Input[list]`) - Gets or sets list of peerings in a VirtualNetwork
          ...
          * `address_space` (`pulumi.Input[dict]`) - Gets or sets AddressSpace that contains an array of IP address ranges that can be used by subnets
          ...
          * `dhcp_options` (`pulumi.Input[dict]`) - Gets or sets DHCPOptions that contains an array of DNS servers available to VMs deployed in the virtual network
          ...
          * `resource_guid` (`pulumi.Input[str]`) - Gets or sets resource guid property of the VirtualNetwork resource
          * `subnets` (`pulumi.Input[list]`) - Gets or sets list of subnets in a VirtualNetwork
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated
            * `name` (`pulumi.Input[str]`) - Gets or sets the name of the resource that is unique within a resource group. This name can be used to access the resource
            * `properties` (`pulumi.Input[dict]`)
