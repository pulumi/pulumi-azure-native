...
class LoadBalancerInboundNatRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, inbound_nat_rule_name=None, load_balancer_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        super(LoadBalancerInboundNatRule, __self__).__init__(
            'azurerm:network:LoadBalancerInboundNatRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, name=None, properties=None, type=None):
        """
        Get an existing LoadBalancerInboundNatRule resource's state with the given name, id, and optional extra
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return LoadBalancerInboundNatRule(resource_name, opts=opts, __props__=__props__)
