...
class TrafficManagerUserMetricsKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        traffic_manager_user_metrics_key = azurerm.network.v20170901preview.TrafficManagerUserMetricsKey("trafficManagerUserMetricsKey")
        ...
        super(TrafficManagerUserMetricsKey, __self__).__init__(
            'azurerm:network/v20170901preview:TrafficManagerUserMetricsKey',
            resource_name,
            __props__,
            opts)
