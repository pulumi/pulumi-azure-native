...
class SecurityPartnerProvider(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(SecurityPartnerProvider, __self__).__init__(
            'azurerm:network:SecurityPartnerProvider',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `connection_status` (`pulumi.Input[str]`) - The connection status with the Security Partner Provider.
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the Security Partner Provider resource.
          * `security_provider_name` (`pulumi.Input[str]`) - The security provider name.
          * `virtual_hub` (`pulumi.Input[dict]`) - The virtualHub to which the Security Partner Provider belongs.
            * `id` (`pulumi.Input[str]`) - Resource ID.
        """
