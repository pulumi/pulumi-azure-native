...
class NetworkWatcher(pulumi.CustomResource):
    def __init__(__self__,
        ...
        network_watcher = azurerm.network.v20180801.NetworkWatcher("networkWatcher",
            location="eastus",
