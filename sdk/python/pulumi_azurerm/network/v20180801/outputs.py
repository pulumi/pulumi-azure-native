...
class ContainerNetworkInterfaceConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 provisioning_state: str,
                 type: str,
                 container_network_interfaces: Optional[List['outputs.ContainerNetworkInterfaceResponse']] = None,
                 etag: Optional[str] = None,
                 id: Optional[str] = None,
        ...
        :param List['ContainerNetworkInterfaceResponseArgs'] container_network_interfaces: A list of container network interfaces created from this container network interface configuration.
        :param str etag: A unique read-only string that changes whenever the resource is updated.
        :param str id: Resource ID.
