...
class InterfaceEndpoint(pulumi.CustomResource):
    endpoint_service: pulumi.Output[dict]
    """
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, endpoint_service=None, etag=None, fqdn=None, id=None, location=None, name=None, resource_group_name=None, subnet=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Interface endpoint resource.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[dict] endpoint_service: A reference to the service being brought into the virtual network.
        ...
        The **endpoint_service** object supports the following:
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20181001:InterfaceEndpoint"), pulumi.Alias(type_="azurerm:network/v20181101:InterfaceEndpoint"), pulumi.Alias(type_="azurerm:network/v20181201:InterfaceEndpoint"), pulumi.Alias(type_="azurerm:network/v20190201:InterfaceEndpoint")])
