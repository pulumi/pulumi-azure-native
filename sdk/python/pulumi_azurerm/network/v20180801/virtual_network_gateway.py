...
class VirtualNetworkGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_network_gateway = azurerm.network.v20180801.VirtualNetworkGateway("virtualNetworkGateway",
            active_active=False,
            bgp_settings={
                "asn": 65515,
