...
class VirtualWan(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VirtualWan"), pulumi.Alias(type_="azurerm:network/preview:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20180401:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20180601:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20180701:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20181001:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20181101:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20181201:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20190201:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20190401:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20190601:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20190701:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20190801:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20200401:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualWan"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualWan")])
