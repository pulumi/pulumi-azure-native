...
class ServiceEndpointPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, location=None, name=None, resource_group_name=None, service_endpoint_policy_definitions=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180701:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20181001:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20181101:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20181201:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20190201:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20190401:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20190601:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20190701:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20190801:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20190901:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20191101:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20191201:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20200301:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20200401:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20200501:ServiceEndpointPolicy"), pulumi.Alias(type_="azurerm:network/v20200601:ServiceEndpointPolicy")])
