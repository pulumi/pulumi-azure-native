...
class NetworkInterfaceTapConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, name=None, network_interface_name=None, resource_group_name=None, virtual_network_tap=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20181001:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20181101:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20181201:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20190201:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20190401:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20190601:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20190701:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20190801:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20190901:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20191101:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20191201:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20200301:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20200401:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azurerm:network/v20200501:NetworkInterfaceTapConfiguration")])
