...
class AzureFirewall(pulumi.CustomResource):
    def __init__(__self__,
        ...
        azure_firewall = azurerm.network.v20180801.AzureFirewall("azureFirewall",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20180401:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20180601:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20180701:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20181001:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20181101:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20181201:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20190201:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20190401:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20190601:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20190701:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20190801:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20190901:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20191101:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20191201:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20200301:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20200401:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20200501:AzureFirewall"), pulumi.Alias(type_="azurerm:network/v20200601:AzureFirewall")])
