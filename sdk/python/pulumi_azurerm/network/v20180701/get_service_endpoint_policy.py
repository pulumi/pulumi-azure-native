...
class GetServiceEndpointPolicyResult:
    ...
    """
    def __init__(__self__, etag=None, location=None, name=None, provisioning_state=None, resource_guid=None, service_endpoint_policy_definitions=None, tags=None, type=None):
...
def get_service_endpoint_policy(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20180701:getServiceEndpointPolicy', __args__, opts=opts, typ=GetServiceEndpointPolicyResult).value
