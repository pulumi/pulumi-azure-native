...
class PacketCapture(pulumi.CustomResource):
    def __init__(__self__,
        ...
        packet_capture = azurerm.network.v20180701.PacketCapture("packetCapture",
