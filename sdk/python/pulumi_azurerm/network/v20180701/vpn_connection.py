...
class VpnConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        vpn_connection = azurerm.network.v20180701.VpnConnection("vpnConnection",
    ...
    def connection_bandwidth_in_mbps(self) -> pulumi.Output[float]:
        """
