...
class VpnGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        vpn_gateway = azurerm.network.v20180701.VpnGateway("vpnGateway",
            bgp_settings={
                "asn": 65515,
