...
class NetworkWatcher(pulumi.CustomResource):
    def __init__(__self__,
        ...
        network_watcher = azurerm.network.v20170901.NetworkWatcher("networkWatcher",
            location="eastus",
