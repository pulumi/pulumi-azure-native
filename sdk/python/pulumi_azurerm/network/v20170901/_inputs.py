...
class CaaRecordArgs:
    def __init__(__self__, *,
        ...
        """
        A CAA record.
        :param pulumi.Input[float] flags: The flags for this CAA record as an integer between 0 and 255.
...
class IpsecPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] pfs_group: The DH Groups used in IKE Phase 2 for new child SA.
