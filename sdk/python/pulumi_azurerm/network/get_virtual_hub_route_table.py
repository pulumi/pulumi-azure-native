...
def get_virtual_hub_route_table(name=None, resource_group_name=None, virtual_hub_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network:getVirtualHubRouteTable', __args__, opts=opts).value
