...
class PrivateLinkService(pulumi.CustomResource):
    ...
    The visibility list of the private link service.
      * `subscriptions` (`list`) - The list of subscriptions.
    """
    def __init__(__self__, resource_name, opts=None, auto_approval=None, etag=None, fqdns=None, id=None, ip_configurations=None, load_balancer_frontend_ip_configurations=None, location=None, name=None, private_endpoint_connections=None, resource_group_name=None, tags=None, visibility=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[list] ip_configurations: An array of references to the private link service IP configuration.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20190601:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190701:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190801:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20190901:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20191101:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20191201:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200301:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200401:PrivateLinkService"), pulumi.Alias(type_="azurerm:network/v20200501:PrivateLinkService")])
