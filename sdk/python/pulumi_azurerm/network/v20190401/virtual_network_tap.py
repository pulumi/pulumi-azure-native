...
class VirtualNetworkTap(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20180801:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181001:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181101:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20181201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190601:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190701:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190801:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20190901:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20191101:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20191201:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200301:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200401:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200501:VirtualNetworkTap"), pulumi.Alias(type_="azurerm:network/v20200601:VirtualNetworkTap")])
