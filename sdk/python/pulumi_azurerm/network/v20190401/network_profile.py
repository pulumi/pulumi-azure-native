...
class NetworkProfile(pulumi.CustomResource):
    container_network_interface_configurations: pulumi.Output[list]
    """
    List of chid container network interface configurations.
      * `container_network_interfaces` (`list`) - A list of container network interfaces created from this container network interface configuration.
        * `id` (`str`) - Resource ID.

      * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
      * `id` (`str`) - Resource ID.
      * `ip_configurations` (`list`) - A list of ip configurations of the container network interface configuration.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `id` (`str`) - Resource ID.
        ...
        * `subnet` (`dict`) - The reference of the subnet resource to create a container network interface ip configuration.
          ...
          * `private_endpoint_network_policies` (`str`) - Enable or Disable private end point on the subnet.
          * `private_endpoints` (`list`) - An array of references to private endpoints.
          * `private_link_service_network_policies` (`str`) - Enable or Disable private link service on the subnet.
          * `provisioning_state` (`str`) - The provisioning state of the resource.
      ...
      * `type` (`str`) - Sub Resource type.
    """
    container_network_interfaces: pulumi.Output[list]
    """
    List of child container network interfaces.
      * `container` (`dict`) - Reference to the container to which this container network interface is attached.
        * `id` (`str`) - Resource ID.

      * `container_network_interface_configuration` (`dict`) - Container network interface configuration from which this container network interface is created.
        * `container_network_interfaces` (`list`) - A list of container network interfaces created from this container network interface configuration.
          * `id` (`str`) - Resource ID.
      ...
      * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
      * `id` (`str`) - Resource ID.
      * `ip_configurations` (`list`) - Reference to the ip configuration on this container nic.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `name` (`str`) - The name of the resource. This name can be used to access the resource.
        * `provisioning_state` (`str`) - The provisioning state of the resource.
        * `type` (`str`) - Sub Resource type.
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, container_network_interface_configurations=None, container_network_interfaces=None, etag=None, id=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Network profile resource.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[list] container_network_interface_configurations: List of chid container network interface configurations.
        :param pulumi.Input[list] container_network_interfaces: List of child container network interfaces.
        ...
        The **container_network_interface_configurations** object supports the following:

          * `container_network_interfaces` (`pulumi.Input[list]`) - A list of container network interfaces created from this container network interface configuration.
            * `id` (`pulumi.Input[str]`) - Resource ID.

          * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
          * `id` (`pulumi.Input[str]`) - Resource ID.
          * `ip_configurations` (`pulumi.Input[list]`) - A list of ip configurations of the container network interface configuration.
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
            * `id` (`pulumi.Input[str]`) - Resource ID.
            * `name` (`pulumi.Input[str]`) - The name of the resource. This name can be used to access the resource.
            * `subnet` (`pulumi.Input[dict]`) - The reference of the subnet resource to create a container network interface ip configuration.
              ...
              * `delegations` (`pulumi.Input[list]`) - Gets an array of references to the delegations on the subnet.
              ...
              * `private_endpoint_network_policies` (`pulumi.Input[str]`) - Enable or Disable private end point on the subnet.
              * `private_link_service_network_policies` (`pulumi.Input[str]`) - Enable or Disable private link service on the subnet.
              ...
              * `service_association_links` (`pulumi.Input[list]`) - Gets an array of references to services injecting into this subnet.
        ...
        The **container_network_interfaces** object supports the following:

          * `container` (`pulumi.Input[dict]`) - Reference to the container to which this container network interface is attached.
            * `id` (`pulumi.Input[str]`) - Resource ID.

          * `container_network_interface_configuration` (`pulumi.Input[dict]`) - Container network interface configuration from which this container network interface is created.
          * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
          * `id` (`pulumi.Input[str]`) - Resource ID.
          * `ip_configurations` (`pulumi.Input[list]`) - Reference to the ip configuration on this container nic.
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
            * `name` (`pulumi.Input[str]`) - The name of the resource. This name can be used to access the resource.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180801:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20181001:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20181101:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20181201:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190201:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190601:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190701:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190801:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190901:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20191101:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20191201:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20200301:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20200401:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20200501:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20200601:NetworkProfile")])
