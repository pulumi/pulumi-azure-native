...
class NetworkProfile(pulumi.CustomResource):
    ...
    Network profile properties.
      * `container_network_interface_configurations` (`list`) - List of chid container network interface configurations.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `id` (`str`) - Resource ID.
        * `name` (`str`) - The name of the resource. This name can be used to access the resource.
        * `properties` (`dict`) - Container network interface configuration properties.
      ...
      * `container_network_interfaces` (`list`) - List of child container network interfaces.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `id` (`str`) - Resource ID.
        * `name` (`str`) - The name of the resource. This name can be used to access the resource.
        * `properties` (`dict`) - Container network interface properties.
          ...
          * `ip_configurations` (`list`) - Reference to the ip configuration on this container nic.
            * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
            * `name` (`str`) - The name of the resource. This name can be used to access the resource.
            * `properties` (`dict`) - Properties of the container network interface IP configuration.
              * `provisioning_state` (`str`) - The provisioning state of the resource.
