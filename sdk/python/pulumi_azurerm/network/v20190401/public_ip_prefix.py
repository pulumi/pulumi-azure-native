...
class PublicIPPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, ip_prefix=None, ip_tags=None, location=None, name=None, prefix_length=None, provisioning_state=None, public_ip_address_version=None, public_ip_addresses=None, resource_group_name=None, resource_guid=None, sku=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180701:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20180801:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20181001:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20181101:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20181201:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20190201:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20190601:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20190701:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20190801:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20190901:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20191101:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20191201:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20200301:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20200401:PublicIPPrefix"), pulumi.Alias(type_="azurerm:network/v20200501:PublicIPPrefix")])
