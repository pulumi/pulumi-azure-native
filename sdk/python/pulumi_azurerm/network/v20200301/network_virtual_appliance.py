...
class NetworkVirtualAppliance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/preview:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20191201:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200401:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200501:NetworkVirtualAppliance"), pulumi.Alias(type_="azurerm:network/v20200601:NetworkVirtualAppliance")])
