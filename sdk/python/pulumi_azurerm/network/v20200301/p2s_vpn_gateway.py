...
class P2sVpnGateway(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, location=None, name=None, p2_s_connection_configurations=None, resource_group_name=None, tags=None, virtual_hub=None, vpn_gateway_scale_unit=None, vpn_server_configuration=None, __props__=None, __name__=None, __opts__=None):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180801:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20181001:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20181101:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20181201:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20190201:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20190401:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20190601:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20190701:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20190801:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20190901:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20191101:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20191201:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20200401:P2sVpnGateway"), pulumi.Alias(type_="azurerm:network/v20200501:P2sVpnGateway")])
