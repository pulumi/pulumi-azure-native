...
class ServiceEndpointPolicy(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, id=None, location=None, name=None, resource_group_name=None, service_endpoint_policy_definitions=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
