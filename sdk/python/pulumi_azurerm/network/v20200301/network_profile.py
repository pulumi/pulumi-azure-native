...
class NetworkProfile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            if network_profile_name is None:
    ...
    def container_network_interfaces(self) -> pulumi.Output[List['outputs.ContainerNetworkInterfaceResponse']]:
        """
