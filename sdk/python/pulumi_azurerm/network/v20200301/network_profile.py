...
class NetworkProfile(pulumi.CustomResource):
    ...
    List of chid container network interface configurations.
      ...
      * `name` (`str`) - The name of the resource. This name can be used to access the resource.
      * `provisioning_state` (`str`) - The provisioning state of the container network interface configuration resource.
      * `type` (`str`) - Sub Resource type.
    """
    ...
    List of child container network interfaces.
      ...
      * `ip_configurations` (`list`) - Reference to the ip configuration on this container nic.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `name` (`str`) - The name of the resource. This name can be used to access the resource.
        * `provisioning_state` (`str`) - The provisioning state of the container network interface IP configuration resource.
        * `type` (`str`) - Sub Resource type.

      * `name` (`str`) - The name of the resource. This name can be used to access the resource.
      * `provisioning_state` (`str`) - The provisioning state of the container network interface resource.
      * `type` (`str`) - Sub Resource type.
    """
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, container_network_interface_configurations=None, id=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        The **container_network_interface_configurations** object supports the following:
          ...
          * `ip_configurations` (`pulumi.Input[list]`) - A list of ip configurations of the container network interface configuration.
            ...
            * `subnet` (`pulumi.Input[dict]`) - The reference to the subnet resource to create a container network interface ip configuration.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/v20180801:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20181001:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20181101:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20181201:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190201:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190401:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190601:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190701:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190801:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20190901:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20191101:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20191201:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20200401:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20200501:NetworkProfile"), pulumi.Alias(type_="azurerm:network/v20200601:NetworkProfile")])
