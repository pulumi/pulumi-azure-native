...
class NetworkProfile(pulumi.CustomResource):
    ...
    Network profile properties.
      ...
      * `provisioning_state` (`str`) - The provisioning state of the network profile resource.
      * `resource_guid` (`str`) - The resource GUID property of the network profile resource.
    """
