...
class VpnServerConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        vpn_server_configuration = azurerm.network.v20200301.VpnServerConfiguration("vpnServerConfiguration",
            location="West US",
