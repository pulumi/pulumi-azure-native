...
class IpGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        ip_group = azurerm.network.v20200301.IpGroup("ipGroup",
            ip_addresses=[
                "13.64.39.16/32",
                "40.74.146.80/31",
                "40.74.147.32/28",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:network/latest:IpGroup"), pulumi.Alias(type_="azurerm:network/v20190901:IpGroup"), pulumi.Alias(type_="azurerm:network/v20191101:IpGroup"), pulumi.Alias(type_="azurerm:network/v20191201:IpGroup"), pulumi.Alias(type_="azurerm:network/v20200401:IpGroup"), pulumi.Alias(type_="azurerm:network/v20200501:IpGroup"), pulumi.Alias(type_="azurerm:network/v20200601:IpGroup")])
