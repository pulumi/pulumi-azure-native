...
class ExpressRouteCircuitConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        express_route_circuit_connection = azurerm.network.v20200301.ExpressRouteCircuitConnection("expressRouteCircuitConnection",
