...
class NetworkInterface(pulumi.CustomResource):
    ...
    The reference to a virtual machine.
      * `id` (`str`) - Resource ID.
    """
    def __init__(__self__, resource_name, opts=None, dns_settings=None, enable_accelerated_networking=None, enable_ip_forwarding=None, id=None, ip_configurations=None, location=None, name=None, network_security_group=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
