...
def get_ddos_custom_policy(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20200301:getDdosCustomPolicy', __args__, opts=opts, typ=GetDdosCustomPolicyResult).value
