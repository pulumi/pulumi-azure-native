...
class DdosProtectionPlan(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(DdosProtectionPlan, __self__).__init__(
            'azurerm:network:DdosProtectionPlan',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the DDoS protection plan resource.
          * `resource_guid` (`pulumi.Input[str]`) - The resource GUID property of the DDoS protection plan resource. It uniquely identifies the resource, even if the user changes its name or migrate the resource across subscriptions or resource groups.
          * `virtual_networks` (`pulumi.Input[list]`) - The list of virtual networks associated with the DDoS protection plan resource. This list is read-only.
