...
class AwaitableGetApplicationGatewayWebApplicationFirewallPolicyResult(GetApplicationGatewayWebApplicationFirewallPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApplicationGatewayWebApplicationFirewallPolicyResult(
            etag=self.etag,
...
def get_application_gateway_web_application_firewall_policy(name=None, resource_group_name=None, opts=None):
    """
