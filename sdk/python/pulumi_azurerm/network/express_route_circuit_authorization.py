...
class ExpressRouteCircuitAuthorization(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, authorization_name=None, circuit_name=None, id=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        super(ExpressRouteCircuitAuthorization, __self__).__init__(
            'azurerm:network:ExpressRouteCircuitAuthorization',
            resource_name,
            __props__,
            opts)
