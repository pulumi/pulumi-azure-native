...
class AwaitableGetNetworkVirtualApplianceVirtualApplianceSiteResult(GetNetworkVirtualApplianceVirtualApplianceSiteResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkVirtualApplianceVirtualApplianceSiteResult(
            etag=self.etag,
            name=self.name,
...
def get_network_virtual_appliance_virtual_appliance_site(name=None, network_virtual_appliance_name=None, resource_group_name=None, opts=None):
    """
