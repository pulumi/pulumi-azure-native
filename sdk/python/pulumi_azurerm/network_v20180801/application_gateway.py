...
class ApplicationGateway(pulumi.CustomResource):
    ...
    Properties of the application gateway.
      ...
      * `autoscale_configuration` (`dict`) - Autoscale Configuration.
        * `min_capacity` (`float`) - Lower bound on number of Application Gateway instances
      ...
      * `trusted_root_certificates` (`list`) - Trusted Root certificates of the application gateway resource.
        * `etag` (`str`) - A unique read-only string that changes whenever the resource is updated.
        * `id` (`str`) - Resource ID.
        * `name` (`str`) - Name of the trusted root certificate that is unique within an Application Gateway.
        * `properties` (`dict`) - Trusted Root certificates properties of an application gateway.
          * `data` (`str`) - Certificate public data.
          * `keyvault_secret_id` (`str`) - KeyVault Secret Id for certificate.
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `autoscale_configuration` (`pulumi.Input[dict]`) - Autoscale Configuration.
            * `min_capacity` (`pulumi.Input[float]`) - Lower bound on number of Application Gateway instances
          ...
          * `trusted_root_certificates` (`pulumi.Input[list]`) - Trusted Root certificates of the application gateway resource.
            * `etag` (`pulumi.Input[str]`) - A unique read-only string that changes whenever the resource is updated.
            * `id` (`pulumi.Input[str]`) - Resource ID.
            * `name` (`pulumi.Input[str]`) - Name of the trusted root certificate that is unique within an Application Gateway.
            * `properties` (`pulumi.Input[dict]`) - Trusted Root certificates properties of an application gateway.
              * `data` (`pulumi.Input[str]`) - Certificate public data.
              * `keyvault_secret_id` (`pulumi.Input[str]`) - KeyVault Secret Id for certificate.
