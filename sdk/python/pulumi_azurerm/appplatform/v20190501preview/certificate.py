...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        certificate = azurerm.appplatform.v20190501preview.Certificate("certificate",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:appplatform/latest:Certificate"), pulumi.Alias(type_="azurerm:appplatform/v20200701:Certificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'azurerm:appplatform/v20190501preview:Certificate',
            resource_name,
            __props__,
            opts)
