...
class Deployment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        deployment = azurerm.appplatform.v20190501preview.Deployment("deployment",
            app_name="myapp",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:appplatform/latest:Deployment"), pulumi.Alias(type_="azurerm:appplatform/v20200701:Deployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Deployment, __self__).__init__(
            'azurerm:appplatform/v20190501preview:Deployment',
            resource_name,
            __props__,
            opts)
