...
class Binding(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:appplatform/latest:Binding"), pulumi.Alias(type_="azurerm:appplatform/preview:Binding"), pulumi.Alias(type_="azurerm:appplatform/v20200701:Binding")])
