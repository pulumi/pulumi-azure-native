...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:appplatform/latest:Certificate"), pulumi.Alias(type_="azurerm:appplatform/preview:Certificate"), pulumi.Alias(type_="azurerm:appplatform/v20190501preview:Certificate")])
