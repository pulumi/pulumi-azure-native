...
class Account(pulumi.CustomResource):
    def __init__(__self__,
        ...
        account = azurerm.maps.v20170101preview.Account("account",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:maps/latest:Account"), pulumi.Alias(type_="azurerm:maps/v20180501:Account"), pulumi.Alias(type_="azurerm:maps/v20200201preview:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azurerm:maps/v20170101preview:Account',
            resource_name,
            __props__,
            opts)
