...
class HyperVCollector(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:migrate/preview:HyperVCollector"), pulumi.Alias(type_="azurerm:migrate/v20191001:HyperVCollector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HyperVCollector, __self__).__init__(
            'azurerm:migrate/latest:HyperVCollector',
            resource_name,
            __props__,
            opts)
