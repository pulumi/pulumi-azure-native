...
class AssessmentProjectHypervcollector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, e_tag=None, name=None, project_name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a AssessmentProjectHypervcollector resource with the given unique name, props, and options.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AssessmentProjectHypervcollector, __self__).__init__(
            'azurerm:migrate:AssessmentProjectHypervcollector',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, e_tag=None, name=None, properties=None, type=None):
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return AssessmentProjectHypervcollector(resource_name, opts=opts, __props__=__props__)
