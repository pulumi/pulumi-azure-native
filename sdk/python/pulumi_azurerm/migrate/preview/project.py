...
class Project(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:migrate/latest:Project"), pulumi.Alias(type_="azurerm:migrate/v20191001:Project")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Project, __self__).__init__(
            'azurerm:migrate/preview:Project',
            resource_name,
            __props__,
            opts)
