...
class VMwareCollector(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:migrate/latest:VMwareCollector"), pulumi.Alias(type_="azurerm:migrate/v20191001:VMwareCollector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VMwareCollector, __self__).__init__(
            'azurerm:migrate/preview:VMwareCollector',
            resource_name,
            __props__,
            opts)
