...
def get_v_mware_collector(name=None, project_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:migrate/v20191001:getVMwareCollector', __args__, opts=opts).value
