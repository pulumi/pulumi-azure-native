...
class Pool(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/v20170901:Pool"), pulumi.Alias(type_="azurerm:batch/v20181201:Pool"), pulumi.Alias(type_="azurerm:batch/v20190401:Pool"), pulumi.Alias(type_="azurerm:batch/v20190801:Pool"), pulumi.Alias(type_="azurerm:batch/v20200501:Pool")])
