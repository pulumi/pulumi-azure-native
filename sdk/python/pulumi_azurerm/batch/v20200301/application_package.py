...
class ApplicationPackage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application_package = azurerm.batch.v20200301.ApplicationPackage("applicationPackage",
