...
class AutoUserSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] elevation_level: The default value is nonAdmin.
        :param pulumi.Input[str] scope: The default value is Pool. If the pool is running Windows a value of Task should be specified if stricter isolation between tasks is required. For example, if the task mutates the registry in a way which could impact other tasks, or if certificates have been specified on the pool which should not be accessible by normal tasks but should be accessible by start tasks.
        """
...
class DiskEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] targets: On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.
        """
    ...
    @property
    @pulumi.getter
    def targets(self) -> Optional[pulumi.Input[List[pulumi.Input[str]]]]:
        """
    ...
    @targets.setter
    def targets(self, value: Optional[pulumi.Input[List[pulumi.Input[str]]]]):
...
class EncryptionPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] key_source: Type of the key source.
...
class FixedScaleSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] target_dedicated_nodes: At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.
        :param pulumi.Input[float] target_low_priority_nodes: At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.
        """
...
class NetworkSecurityGroupRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] source_port_ranges: Valid values are '*' (for all ports 0 - 65535) or arrays of ports or port ranges (i.e. 100-200). The ports should in the range of 0 to 65535 and the port ranges or ports can't overlap. If any other values are provided the request fails with HTTP status code 400. Default value will be *.
        """
...
class PublicIPAddressConfigurationArgs:
    def __init__(__self__, *,
                 ip_address_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None,
                 provision: Optional[pulumi.Input[str]] = None):
        """
        The public IP Address configuration of the networking configuration of a Pool.
        :param pulumi.Input[List[pulumi.Input[str]]] ip_address_ids: The number of IPs specified here limits the maximum size of the Pool - 50 dedicated nodes or 20 low-priority nodes can be allocated for each public IP. For example, a pool needing 150 dedicated VMs would need at least 3 public IPs specified. Each element of this collection is of the form: /subscriptions/{subscription}/resourceGroups/{group}/providers/Microsoft.Network/publicIPAddresses/{ip}.
        :param pulumi.Input[str] provision: The default value is BatchManaged
        """
    ...
    def ip_address_ids(self) -> Optional[pulumi.Input[List[pulumi.Input[str]]]]:
        """
    ...
    def ip_address_ids(self, value: Optional[pulumi.Input[List[pulumi.Input[str]]]]):
        pulumi.set(self, "ip_address_ids", value)

    @property
    @pulumi.getter
    def provision(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @provision.setter
    def provision(self, value: Optional[pulumi.Input[str]]):
