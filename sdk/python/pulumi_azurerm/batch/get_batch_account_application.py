...
class AwaitableGetBatchAccountApplicationResult(GetBatchAccountApplicationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBatchAccountApplicationResult(
            etag=self.etag,
            name=self.name,
...
def get_batch_account_application(account_name=None, name=None, resource_group_name=None, opts=None):
    """
