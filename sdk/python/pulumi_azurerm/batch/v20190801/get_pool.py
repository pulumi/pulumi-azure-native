...
class GetPoolResult:
    ...
    def mount_configuration(self) -> Optional[List['outputs.MountConfigurationResponse']]:
        """
...
def get_pool(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batch/v20190801:getPool', __args__, opts=opts, typ=GetPoolResult).value
