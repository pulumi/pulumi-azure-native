...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/v20181201:Application"), pulumi.Alias(type_="azurerm:batch/v20190401:Application"), pulumi.Alias(type_="azurerm:batch/v20190801:Application"), pulumi.Alias(type_="azurerm:batch/v20200301:Application")])
