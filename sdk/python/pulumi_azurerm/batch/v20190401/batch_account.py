...
class BatchAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/latest:BatchAccount"), pulumi.Alias(type_="azurerm:batch/preview:BatchAccount"), pulumi.Alias(type_="azurerm:batch/v20151201:BatchAccount"), pulumi.Alias(type_="azurerm:batch/v20170101:BatchAccount"), pulumi.Alias(type_="azurerm:batch/v20170501:BatchAccount"), pulumi.Alias(type_="azurerm:batch/v20170901:BatchAccount"), pulumi.Alias(type_="azurerm:batch/v20181201:BatchAccount"), pulumi.Alias(type_="azurerm:batch/v20190801:BatchAccount"), pulumi.Alias(type_="azurerm:batch/v20200301:BatchAccount"), pulumi.Alias(type_="azurerm:batch/v20200501:BatchAccount")])
