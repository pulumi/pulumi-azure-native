...
class Pool(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, account_name=None, application_licenses=None, application_packages=None, certificates=None, deployment_configuration=None, display_name=None, inter_node_communication=None, max_tasks_per_node=None, metadata=None, name=None, network_configuration=None, resource_group_name=None, scale_settings=None, start_task=None, task_scheduling_policy=None, user_accounts=None, vm_size=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[list] application_licenses: The list of application licenses must be a subset of available Batch service application licenses. If a license is requested which is not supported, pool creation will fail.
        :param pulumi.Input[list] application_packages: Changes to application package references affect all new compute nodes joining the pool, but do not affect compute nodes that are already in the pool until they are rebooted or reimaged. There is a maximum of 10 application package references on any given pool.
        :param pulumi.Input[list] certificates: For Windows compute nodes, the Batch service installs the certificates to the specified certificate store and location. For Linux compute nodes, the certificates are stored in a directory inside the task working directory and an environment variable AZ_BATCH_CERTIFICATES_DIR is supplied to the task to query for this location. For certificates with visibility of 'remoteUser', a 'certs' directory is created in the user's home directory (e.g., /home/{user-name}/certs) and certificates are placed in that directory.
        :param pulumi.Input[dict] deployment_configuration: Using CloudServiceConfiguration specifies that the nodes should be creating using Azure Cloud Services (PaaS), while VirtualMachineConfiguration uses Azure Virtual Machines (IaaS).
        ...
        :param pulumi.Input[list] metadata: The Batch service does not assign any meaning to metadata; it is solely for the use of user code.
        :param pulumi.Input[str] name: The pool name. This must be unique within the account.
        :param pulumi.Input[dict] network_configuration: The network configuration for a pool.
        ...
        :param pulumi.Input[dict] start_task: In an PATCH (update) operation, this property can be set to an empty object to remove the start task from the pool.
        :param pulumi.Input[dict] task_scheduling_policy: If not specified, the default is spread.
        :param pulumi.Input[str] vm_size: For information about available sizes of virtual machines for Cloud Services pools (pools created with cloudServiceConfiguration), see Sizes for Cloud Services (https://azure.microsoft.com/documentation/articles/cloud-services-sizes-specs/). Batch supports all Cloud Services VM sizes except ExtraSmall. For information about available VM sizes for pools using images from the Virtual Machines Marketplace (pools created with virtualMachineConfiguration) see Sizes for Virtual Machines (Linux) (https://azure.microsoft.com/documentation/articles/virtual-machines-linux-sizes/) or Sizes for Virtual Machines (Windows) (https://azure.microsoft.com/documentation/articles/virtual-machines-windows-sizes/). Batch supports all Azure VM sizes except STANDARD_A0 and those with premium storage (STANDARD_GS, STANDARD_DS, and STANDARD_DSV2 series).

        The **application_packages** object supports the following:
        ...
        The **deployment_configuration** object supports the following:
        ...
        The **task_scheduling_policy** object supports the following:

          * `node_fill_type` (`pulumi.Input[str]`)

        The **user_accounts** object supports the following:
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/v20170901:Pool"), pulumi.Alias(type_="azurerm:batch/v20181201:Pool"), pulumi.Alias(type_="azurerm:batch/v20190801:Pool"), pulumi.Alias(type_="azurerm:batch/v20200301:Pool"), pulumi.Alias(type_="azurerm:batch/v20200501:Pool")])
