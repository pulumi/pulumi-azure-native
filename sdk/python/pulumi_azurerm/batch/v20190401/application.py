...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/latest:Application"), pulumi.Alias(type_="azurerm:batch/preview:Application"), pulumi.Alias(type_="azurerm:batch/v20151201:Application"), pulumi.Alias(type_="azurerm:batch/v20170101:Application"), pulumi.Alias(type_="azurerm:batch/v20170501:Application"), pulumi.Alias(type_="azurerm:batch/v20170901:Application"), pulumi.Alias(type_="azurerm:batch/v20181201:Application"), pulumi.Alias(type_="azurerm:batch/v20190801:Application"), pulumi.Alias(type_="azurerm:batch/v20200301:Application"), pulumi.Alias(type_="azurerm:batch/v20200501:Application")])
