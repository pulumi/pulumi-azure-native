...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, data=None, format=None, name=None, password=None, resource_group_name=None, thumbprint=None, thumbprint_algorithm=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/v20170901:Certificate"), pulumi.Alias(type_="azurerm:batch/v20181201:Certificate"), pulumi.Alias(type_="azurerm:batch/v20190801:Certificate"), pulumi.Alias(type_="azurerm:batch/v20200301:Certificate"), pulumi.Alias(type_="azurerm:batch/v20200501:Certificate")])
