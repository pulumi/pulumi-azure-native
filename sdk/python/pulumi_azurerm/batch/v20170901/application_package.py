...
class ApplicationPackage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application_package = azurerm.batch.v20170901.ApplicationPackage("applicationPackage",
