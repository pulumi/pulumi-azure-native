...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/latest:Certificate"), pulumi.Alias(type_="azurerm:batch/v20181201:Certificate"), pulumi.Alias(type_="azurerm:batch/v20190401:Certificate"), pulumi.Alias(type_="azurerm:batch/v20190801:Certificate"), pulumi.Alias(type_="azurerm:batch/v20200301:Certificate"), pulumi.Alias(type_="azurerm:batch/v20200501:Certificate")])
