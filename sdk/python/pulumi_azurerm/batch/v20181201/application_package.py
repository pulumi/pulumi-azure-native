...
class ApplicationPackage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/latest:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/preview:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/v20151201:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/v20170101:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/v20170501:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/v20170901:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/v20190401:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/v20190801:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/v20200301:ApplicationPackage"), pulumi.Alias(type_="azurerm:batch/v20200501:ApplicationPackage")])
