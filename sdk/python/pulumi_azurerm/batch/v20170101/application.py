...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batch/v20151201:Application"), pulumi.Alias(type_="azurerm:batch/v20170501:Application"), pulumi.Alias(type_="azurerm:batch/v20170901:Application")])
