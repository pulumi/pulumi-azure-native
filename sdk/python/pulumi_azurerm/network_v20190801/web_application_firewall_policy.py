...
class WebApplicationFirewallPolicy(pulumi.CustomResource):
    ...
    Properties of the web application firewall policy.
      * `application_gateways` (`list`) - A collection of references to application gateways.
        ...
        * `properties` (`dict`) - Properties of the application gateway.
      ...
      * `custom_rules` (`list`) - Describes custom rules inside the policy.
        ...
        * `name` (`str`) - The name of the resource that is unique within a policy. This name can be used to access the resource.
      ...
      * `managed_rules` (`dict`) - Describes the managedRules structure
        * `exclusions` (`list`) - Describes the Exclusions that are applied on the policy.
          * `match_variable` (`str`) - The variable to be excluded.
          * `selector` (`str`) - When matchVariable is a collection, operator used to specify which elements in the collection this exclusion applies to.
          * `selector_match_operator` (`str`) - When matchVariable is a collection, operate on the selector to specify which elements in the collection this exclusion applies to.

        * `managed_rule_sets` (`list`) - Describes the ruleSets that are associated with the policy.
          * `rule_group_overrides` (`list`) - Defines the rule group overrides to apply to the rule set.
            ...
            * `rules` (`list`) - List of rules that will be disabled. If none specified, all rules in the group will be disabled.
              ...
              * `state` (`str`) - Describes the state of the managed rule. Defaults to Disabled if not specified.
      ...
      * `provisioning_state` (`str`) - The provisioning state of the web application firewall policy resource.
      * `resource_state` (`str`) - Resource status of the policy.
    """
