...
class JitRequest(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:solutions/v20190701:JitRequest"), pulumi.Alias(type_="azurerm:solutions/v20200821preview:JitRequest")])
