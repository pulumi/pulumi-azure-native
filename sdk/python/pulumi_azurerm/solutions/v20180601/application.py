...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application = azurerm.solutions.v20180601.Application("application",
            kind="ServiceCatalog",
            location="East US 2",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:solutions/latest:Application"), pulumi.Alias(type_="azurerm:solutions/v20170901:Application"), pulumi.Alias(type_="azurerm:solutions/v20190701:Application")])
