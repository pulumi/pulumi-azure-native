...
class ApplicationDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:solutions/latest:ApplicationDefinition"), pulumi.Alias(type_="azurerm:solutions/preview:ApplicationDefinition"), pulumi.Alias(type_="azurerm:solutions/v20170901:ApplicationDefinition"), pulumi.Alias(type_="azurerm:solutions/v20190701:ApplicationDefinition"), pulumi.Alias(type_="azurerm:solutions/v20200821preview:ApplicationDefinition")])
