...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:solutions/latest:Application"), pulumi.Alias(type_="azurerm:solutions/v20170901:Application"), pulumi.Alias(type_="azurerm:solutions/v20180601:Application"), pulumi.Alias(type_="azurerm:solutions/v20190701:Application"), pulumi.Alias(type_="azurerm:solutions/v20200821preview:Application")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Application, __self__).__init__(
            'azurerm:solutions/preview:Application',
            resource_name,
            __props__,
            opts)
