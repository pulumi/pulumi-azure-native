...
class GetApplianceDefinitionResult:
    ...
    """
    def __init__(__self__, artifacts=None, authorizations=None, description=None, display_name=None, identity=None, location=None, lock_level=None, managed_by=None, name=None, package_file_uri=None, sku=None, tags=None, type=None):
...
def get_appliance_definition(appliance_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:solutions/preview:getApplianceDefinition', __args__, opts=opts, typ=GetApplianceDefinitionResult).value
