...
class Appliance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[Mapping[str, Any]] parameters: Name and value pairs that define the appliance parameters. It can be a JObject or a well formed JSON string.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:solutions/preview:Appliance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Appliance, __self__).__init__(
            'azurerm:solutions/v20160901preview:Appliance',
            resource_name,
            __props__,
            opts)
