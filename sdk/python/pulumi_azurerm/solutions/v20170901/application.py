...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:solutions/latest:Application"), pulumi.Alias(type_="azurerm:solutions/preview:Application"), pulumi.Alias(type_="azurerm:solutions/v20180601:Application"), pulumi.Alias(type_="azurerm:solutions/v20190701:Application"), pulumi.Alias(type_="azurerm:solutions/v20200821preview:Application")])
