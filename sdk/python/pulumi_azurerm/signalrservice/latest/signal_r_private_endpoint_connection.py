...
class SignalRPrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:signalrservice/preview:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azurerm:signalrservice/v20200501:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azurerm:signalrservice/v20200701preview:SignalRPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SignalRPrivateEndpointConnection, __self__).__init__(
            'azurerm:signalrservice/latest:SignalRPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
