...
class SignalR(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, kind=None, location=None, name=None, properties=None, resource_group_name=None, sku=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(SignalR, __self__).__init__(
            'azurerm:signalrservice:SignalR',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, kind=None, location=None, name=None, properties=None, sku=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `external_ip` (`pulumi.Input[str]`) - The publicly accessible IP of the SignalR service.
          * `features` (`pulumi.Input[list]`) - List of SignalR featureFlags. e.g. ServiceMode.
          ...
          * `host_name` (`pulumi.Input[str]`) - FQDN of the SignalR service instance. Format: xxx.service.signalr.net
          * `host_name_prefix` (`pulumi.Input[str]`) - Prefix for the hostName of the SignalR service. Retained for future use.
            The hostname will be of format: &lt;hostNamePrefix&gt;.service.signalr.net.
          * `network_ac_ls` (`pulumi.Input[dict]`) - Network ACLs
            * `default_action` (`pulumi.Input[str]`) - Default action when no other rule matches
          ...
          * `private_endpoint_connections` (`pulumi.Input[list]`) - Private endpoint connections to the SignalR resource.
            * `id` (`pulumi.Input[str]`) - Fully qualified resource Id for the resource.
            * `name` (`pulumi.Input[str]`) - The name of the resource.
            * `properties` (`pulumi.Input[dict]`) - Properties of the private endpoint connection
            ...
            * `type` (`pulumi.Input[str]`) - The type of the resource - e.g. "Microsoft.SignalRService/SignalR"

          * `provisioning_state` (`pulumi.Input[str]`) - Provisioning state of the resource.
          * `public_port` (`pulumi.Input[float]`) - The publicly accessible port of the SignalR service which is designed for browser/client side usage.
          * `server_port` (`pulumi.Input[float]`) - The publicly accessible port of the SignalR service which is designed for customer server side usage.
          * `upstream` (`pulumi.Input[dict]`) - Upstream settings when the Azure SignalR is in server-less mode.
            * `templates` (`pulumi.Input[list]`) - Gets or sets the list of Upstream URL templates. Order matters, and the first matching template takes effects.
              * `category_pattern` (`pulumi.Input[str]`) - Gets or sets the matching pattern for category names. If not set, it matches any category.
                There are 3 kind of patterns supported:
          ...
          * `version` (`pulumi.Input[str]`) - Version of the SignalR resource. Probably you need the same or higher version of client SDKs.
