...
class SignalR(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:signalrservice/latest:SignalR"), pulumi.Alias(type_="azurerm:signalrservice/v20180301preview:SignalR"), pulumi.Alias(type_="azurerm:signalrservice/v20181001:SignalR"), pulumi.Alias(type_="azurerm:signalrservice/v20200501:SignalR"), pulumi.Alias(type_="azurerm:signalrservice/v20200701preview:SignalR")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SignalR, __self__).__init__(
            'azurerm:signalrservice/preview:SignalR',
            resource_name,
            __props__,
            opts)
