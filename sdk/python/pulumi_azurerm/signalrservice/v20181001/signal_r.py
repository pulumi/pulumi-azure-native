...
class SignalR(pulumi.CustomResource):
    def __init__(__self__,
        ...
        signal_r = azurerm.signalrservice.v20181001.SignalR("signalR",
            location="eastus",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:signalrservice/latest:SignalR"), pulumi.Alias(type_="azurerm:signalrservice/v20180301preview:SignalR"), pulumi.Alias(type_="azurerm:signalrservice/v20200501:SignalR"), pulumi.Alias(type_="azurerm:signalrservice/v20200701preview:SignalR")])
