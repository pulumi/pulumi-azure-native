...
class SignalRPrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:signalrservice/latest:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azurerm:signalrservice/v20200701preview:SignalRPrivateEndpointConnection")])
