...
class Component(pulumi.CustomResource):
    def __init__(__self__,
        ...
        component = azurerm.insights.v20180501preview.Component("component",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:Component"), pulumi.Alias(type_="azurerm:insights/v20150501:Component"), pulumi.Alias(type_="azurerm:insights/v20200202preview:Component")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Component, __self__).__init__(
            'azurerm:insights/v20180501preview:Component',
            resource_name,
            __props__,
            opts)
