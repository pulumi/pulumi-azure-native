...
class ActivityLogAlert(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:ActivityLogAlert"), pulumi.Alias(type_="azurerm:insights/preview:ActivityLogAlert"), pulumi.Alias(type_="azurerm:insights/v20170301preview:ActivityLogAlert")])
