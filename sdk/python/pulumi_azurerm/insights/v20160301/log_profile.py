...
class LogProfile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        log_profile = azurerm.insights.v20160301.LogProfile("logProfile",
            categories=[
                "Write",
                "Delete",
                "Action",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:LogProfile")])
