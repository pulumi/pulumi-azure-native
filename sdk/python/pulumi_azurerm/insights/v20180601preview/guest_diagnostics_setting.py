...
class GuestDiagnosticsSetting(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 data_sources: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['DataSourceArgs']]]]] = None,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/preview:guestDiagnosticsSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestDiagnosticsSetting, __self__).__init__(
            'azurerm:insights/v20180601preview:guestDiagnosticsSetting',
            resource_name,
            __props__,
            opts)
    ...
    def data_sources(self) -> pulumi.Output[Optional[List['outputs.DataSourceResponse']]]:
        """
