...
class Workbook(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/preview:Workbook"), pulumi.Alias(type_="azurerm:insights/v20150501:Workbook"), pulumi.Alias(type_="azurerm:insights/v20180617preview:Workbook")])
