...
class ActionGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:ActionGroup"), pulumi.Alias(type_="azurerm:insights/preview:ActionGroup"), pulumi.Alias(type_="azurerm:insights/v20170401:ActionGroup"), pulumi.Alias(type_="azurerm:insights/v20180301:ActionGroup"), pulumi.Alias(type_="azurerm:insights/v20180901:ActionGroup"), pulumi.Alias(type_="azurerm:insights/v20190601:ActionGroup")])
