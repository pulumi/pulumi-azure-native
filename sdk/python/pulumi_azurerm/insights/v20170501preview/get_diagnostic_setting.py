...
class GetDiagnosticSettingResult:
    ...
    @property
    @pulumi.getter
    def metrics(self) -> Optional[List['outputs.MetricSettingsResponse']]:
        """
...
def get_diagnostic_setting(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:insights/v20170501preview:getDiagnosticSetting', __args__, opts=opts, typ=GetDiagnosticSettingResult).value
