...
class ActionGroup(pulumi.CustomResource):
    ...
    The action groups properties of the resource.
      * `arm_role_receivers` (`list`) - The list of ARM role receivers that are part of this action group. Roles are Azure RBAC roles and only built-in roles are supported.
      ...
      * `azure_function_receivers` (`list`) - The list of azure function receivers that are part of this action group.
      ...
      * `logic_app_receivers` (`list`) - The list of logic app receivers that are part of this action group.
      ...
      * `voice_receivers` (`list`) - The list of voice receivers that are part of this action group.
      ...
      * `webhook_receivers` (`list`) - The list of webhook receivers that are part of this action group.
        * `identifier_uri` (`str`) - Indicates the identifier uri for aad auth.
        * `name` (`str`) - The name of the webhook receiver. Names must be unique across all receivers within an action group.
        * `object_id` (`str`) - Indicates the webhook app object Id for aad auth.
        * `service_uri` (`str`) - The URI where webhooks should be sent.
        * `tenant_id` (`str`) - Indicates the tenant id for aad auth.
        * `use_aad_auth` (`bool`) - Indicates whether or not use AAD authentication.
        * `use_common_alert_schema` (`bool`) - Indicates whether to use common alert schema.
    """
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `arm_role_receivers` (`pulumi.Input[list]`) - The list of ARM role receivers that are part of this action group. Roles are Azure RBAC roles and only built-in roles are supported.
            ...
            * `use_common_alert_schema` (`pulumi.Input[bool]`) - Indicates whether to use common alert schema.
          ...
          * `webhook_receivers` (`pulumi.Input[list]`) - The list of webhook receivers that are part of this action group.
            * `identifier_uri` (`pulumi.Input[str]`) - Indicates the identifier uri for aad auth.
            * `name` (`pulumi.Input[str]`) - The name of the webhook receiver. Names must be unique across all receivers within an action group.
            * `object_id` (`pulumi.Input[str]`) - Indicates the webhook app object Id for aad auth.
            * `service_uri` (`pulumi.Input[str]`) - The URI where webhooks should be sent.
            * `tenant_id` (`pulumi.Input[str]`) - Indicates the tenant id for aad auth.
            * `use_aad_auth` (`pulumi.Input[bool]`) - Indicates whether or not use AAD authentication.
            * `use_common_alert_schema` (`pulumi.Input[bool]`) - Indicates whether to use common alert schema.
        """
