...
class GetComponentFavoriteResult:
    """
...
class AwaitableGetComponentFavoriteResult(GetComponentFavoriteResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetComponentFavoriteResult(
...
def get_component_favorite(favorite_id=None, resource_group_name=None, resource_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:insights:getComponentFavorite', __args__, opts=opts).value

    return AwaitableGetComponentFavoriteResult(
