...
def get_data_collection_rule_association(association_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:insights/v20191101preview:getDataCollectionRuleAssociation', __args__, opts=opts, typ=GetDataCollectionRuleAssociationResult).value
