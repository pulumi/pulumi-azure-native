...
def get_metric_alert(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:insights/v20180301:getMetricAlert', __args__, opts=opts, typ=GetMetricAlertResult).value
