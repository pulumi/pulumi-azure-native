...
class AnalyticsItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:AnalyticsItem"), pulumi.Alias(type_="azurerm:insights/v20150501:AnalyticsItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AnalyticsItem, __self__).__init__(
            'azurerm:insights/preview:AnalyticsItem',
            resource_name,
            __props__,
            opts)
