...
class GetSubscriptionDiagnosticSettingResult:
    ...
    @property
    @pulumi.getter
    def logs(self) -> Optional[List['outputs.SubscriptionLogSettingsResponse']]:
        """
...
def get_subscription_diagnostic_setting(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:insights/preview:getSubscriptionDiagnosticSetting', __args__, opts=opts, typ=GetSubscriptionDiagnosticSettingResult).value
