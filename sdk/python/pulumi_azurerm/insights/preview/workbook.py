...
class Workbook(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:Workbook"), pulumi.Alias(type_="azurerm:insights/v20150501:Workbook"), pulumi.Alias(type_="azurerm:insights/v20180617preview:Workbook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workbook, __self__).__init__(
            'azurerm:insights/preview:Workbook',
            resource_name,
            __props__,
            opts)
