...
class MyWorkbook(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:MyWorkbook"), pulumi.Alias(type_="azurerm:insights/v20150501:MyWorkbook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MyWorkbook, __self__).__init__(
            'azurerm:insights/preview:MyWorkbook',
            resource_name,
            __props__,
            opts)
