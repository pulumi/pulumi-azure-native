...
class AlertRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['RuleActionArgs']]]] actions: the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
        :param pulumi.Input[pulumi.InputType['RuleConditionArgs']] condition: the condition that results in the alert rule being activated.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:AlertRule"), pulumi.Alias(type_="azurerm:insights/v20160301:AlertRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AlertRule, __self__).__init__(
            'azurerm:insights/preview:AlertRule',
            resource_name,
            __props__,
            opts)
