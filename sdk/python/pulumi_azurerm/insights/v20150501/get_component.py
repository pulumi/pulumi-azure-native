...
def get_component(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:insights/v20150501:getComponent', __args__, opts=opts, typ=GetComponentResult).value
