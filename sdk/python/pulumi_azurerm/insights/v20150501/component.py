...
class Component(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:Component"), pulumi.Alias(type_="azurerm:insights/preview:Component"), pulumi.Alias(type_="azurerm:insights/v20180501preview:Component"), pulumi.Alias(type_="azurerm:insights/v20200202preview:Component")])
