...
def get_my_workbook(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:insights/v20150501:getMyWorkbook', __args__, opts=opts, typ=GetMyWorkbookResult).value
