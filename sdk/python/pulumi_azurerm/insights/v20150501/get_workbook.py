...
def get_workbook(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:insights/v20150501:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult).value
