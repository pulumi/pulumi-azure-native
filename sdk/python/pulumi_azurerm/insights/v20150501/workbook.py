...
class Workbook(pulumi.CustomResource):
    def __init__(__self__,
        ...
        workbook = azurerm.insights.v20150501.Workbook("workbook",
            category="workbook",
            location="west us",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:insights/latest:Workbook"), pulumi.Alias(type_="azurerm:insights/v20180617preview:Workbook")])
