...
class Console(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:portal/latest:Console"), pulumi.Alias(type_="azurerm:portal/v20181001:Console")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Console, __self__).__init__(
            'azurerm:portal/preview:Console',
            resource_name,
            __props__,
            opts)
