...
class UserSettingsWithLocation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:portal/latest:UserSettingsWithLocation"), pulumi.Alias(type_="azurerm:portal/v20181001:UserSettingsWithLocation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserSettingsWithLocation, __self__).__init__(
            'azurerm:portal/preview:UserSettingsWithLocation',
            resource_name,
            __props__,
            opts)
