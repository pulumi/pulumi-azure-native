...
class UserSettings(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:portal/latest:UserSettings"), pulumi.Alias(type_="azurerm:portal/v20181001:UserSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserSettings, __self__).__init__(
            'azurerm:portal/preview:UserSettings',
            resource_name,
            __props__,
            opts)
