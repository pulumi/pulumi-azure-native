...
class Dashboard(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:portal/latest:Dashboard"), pulumi.Alias(type_="azurerm:portal/v20150801preview:Dashboard"), pulumi.Alias(type_="azurerm:portal/v20181001preview:Dashboard"), pulumi.Alias(type_="azurerm:portal/v20200901preview:Dashboard")])
