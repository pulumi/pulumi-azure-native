...
def get_console_with_location(console_name=None, location=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:portal:getConsoleWithLocation', __args__, opts=opts).value
