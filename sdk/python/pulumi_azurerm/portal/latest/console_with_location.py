...
class ConsoleWithLocation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:portal/preview:ConsoleWithLocation"), pulumi.Alias(type_="azurerm:portal/v20181001:ConsoleWithLocation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConsoleWithLocation, __self__).__init__(
            'azurerm:portal/latest:ConsoleWithLocation',
            resource_name,
            __props__,
            opts)
