...
class TenantConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        tenant_configuration = azurerm.portal.v20200901preview.TenantConfiguration("tenantConfiguration",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:portal/v20190101preview:TenantConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TenantConfiguration, __self__).__init__(
            'azurerm:portal/v20200901preview:TenantConfiguration',
            resource_name,
            __props__,
            opts)
