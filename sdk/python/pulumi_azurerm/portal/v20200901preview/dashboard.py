...
class Dashboard(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 lenses: Optional[pulumi.Input[List[pulumi.Input[Mapping[str, Any]]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[Mapping[str, Any]]]] lenses: The dashboard lenses.
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:portal/latest:Dashboard"), pulumi.Alias(type_="azurerm:portal/v20150801preview:Dashboard"), pulumi.Alias(type_="azurerm:portal/v20181001preview:Dashboard"), pulumi.Alias(type_="azurerm:portal/v20190101preview:Dashboard")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dashboard, __self__).__init__(
            'azurerm:portal/v20200901preview:Dashboard',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def lenses(self) -> pulumi.Output[Optional[List[Mapping[str, Any]]]]:
        """
