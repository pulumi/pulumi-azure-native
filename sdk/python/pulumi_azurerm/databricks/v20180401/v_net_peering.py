...
class VNetPeering(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databricks/latest:vNetPeering"), pulumi.Alias(type_="azurerm:databricks/preview:vNetPeering")])
