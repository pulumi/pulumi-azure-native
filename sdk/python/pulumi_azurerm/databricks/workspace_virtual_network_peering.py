...
class WorkspaceVirtualNetworkPeering(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, properties=None, resource_group_name=None, workspace_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(WorkspaceVirtualNetworkPeering, __self__).__init__(
            'azurerm:databricks:WorkspaceVirtualNetworkPeering',
            resource_name,
            __props__,
            opts)
