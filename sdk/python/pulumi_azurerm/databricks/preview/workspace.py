...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databricks/latest:Workspace"), pulumi.Alias(type_="azurerm:databricks/v20180401:Workspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workspace, __self__).__init__(
            'azurerm:databricks/preview:Workspace',
            resource_name,
            __props__,
            opts)
