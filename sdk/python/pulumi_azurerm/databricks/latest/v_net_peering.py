...
class VNetPeering(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databricks/preview:vNetPeering"), pulumi.Alias(type_="azurerm:databricks/v20180401:vNetPeering")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VNetPeering, __self__).__init__(
            'azurerm:databricks/latest:vNetPeering',
            resource_name,
            __props__,
            opts)
