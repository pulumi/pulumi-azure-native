...
class VirtualNetworkRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbforpostgresql/latest:VirtualNetworkRule"), pulumi.Alias(type_="azurerm:dbforpostgresql/v20171201:VirtualNetworkRule"), pulumi.Alias(type_="azurerm:dbforpostgresql/v20171201preview:VirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkRule, __self__).__init__(
            'azurerm:dbforpostgresql/preview:VirtualNetworkRule',
            resource_name,
            __props__,
            opts)
