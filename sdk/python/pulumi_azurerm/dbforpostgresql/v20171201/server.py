...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbforpostgresql/latest:Server"), pulumi.Alias(type_="azurerm:dbforpostgresql/v20171201preview:Server")])
