...
def get_server_administrator(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:dbforpostgresql/v20171201:getServerAdministrator', __args__, opts=opts, typ=GetServerAdministratorResult).value
