...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        private_endpoint_connection = azurerm.dbforpostgresql.v20180601.PrivateEndpointConnection("privateEndpointConnection",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbforpostgresql/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection")])
