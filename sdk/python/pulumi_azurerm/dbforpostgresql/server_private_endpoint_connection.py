...
class ServerPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, properties=None, resource_group_name=None, server_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ServerPrivateEndpointConnection, __self__).__init__(
            'azurerm:dbforpostgresql:ServerPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
