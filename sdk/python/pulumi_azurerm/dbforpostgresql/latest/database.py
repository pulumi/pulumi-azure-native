...
class Database(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbforpostgresql/v20171201:Database"), pulumi.Alias(type_="azurerm:dbforpostgresql/v20171201preview:Database")])
