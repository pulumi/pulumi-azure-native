...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        private_endpoint_connection = azurerm.dbforpostgresql.v20180601privatepreview.PrivateEndpointConnection("privateEndpointConnection",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbforpostgresql/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:dbforpostgresql/v20180601:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azurerm:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
