...
def list_connected_cluster_user_credentials(authentication_method: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:kubernetes/v20200101preview:listConnectedClusterUserCredentials', __args__, opts=opts, typ=ListConnectedClusterUserCredentialsResult).value
