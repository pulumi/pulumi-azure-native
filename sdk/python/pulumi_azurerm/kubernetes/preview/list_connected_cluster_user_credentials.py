...
def list_connected_cluster_user_credentials(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:kubernetes/preview:listConnectedClusterUserCredentials', __args__, opts=opts, typ=ListConnectedClusterUserCredentialsResult).value
