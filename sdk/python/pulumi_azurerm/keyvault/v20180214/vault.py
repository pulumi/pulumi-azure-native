...
class Vault(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:keyvault/latest:Vault"), pulumi.Alias(type_="azurerm:keyvault/v20150601:Vault"), pulumi.Alias(type_="azurerm:keyvault/v20161001:Vault"), pulumi.Alias(type_="azurerm:keyvault/v20190901:Vault")])
