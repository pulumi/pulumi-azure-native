...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:keyvault/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:keyvault/preview:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:keyvault/v20190901:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:keyvault/v20200401preview:PrivateEndpointConnection")])
