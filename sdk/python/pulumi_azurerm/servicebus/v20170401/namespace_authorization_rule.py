...
class NamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    Resource type
    """
    def __init__(__self__, resource_name, opts=None, name=None, namespace_name=None, resource_group_name=None, rights=None, __props__=None, __name__=None, __opts__=None):
        """
