...
def get_disaster_recovery_config(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:servicebus/v20170401:getDisasterRecoveryConfig', __args__, opts=opts, typ=GetDisasterRecoveryConfigResult).value
