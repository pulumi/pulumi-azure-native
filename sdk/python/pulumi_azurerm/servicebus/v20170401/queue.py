...
class Queue(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/latest:Queue"), pulumi.Alias(type_="azurerm:servicebus/preview:Queue"), pulumi.Alias(type_="azurerm:servicebus/v20140901:Queue"), pulumi.Alias(type_="azurerm:servicebus/v20150801:Queue")])
