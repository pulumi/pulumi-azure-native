...
class QueueAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        queue_authorization_rule = azurerm.servicebus.v20170401.QueueAuthorizationRule("queueAuthorizationRule",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/latest:QueueAuthorizationRule"), pulumi.Alias(type_="azurerm:servicebus/v20140901:QueueAuthorizationRule"), pulumi.Alias(type_="azurerm:servicebus/v20150801:QueueAuthorizationRule")])
