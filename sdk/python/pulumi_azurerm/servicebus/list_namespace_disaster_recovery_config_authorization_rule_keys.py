...
class ListNamespaceDisasterRecoveryConfigAuthorizationRuleKeysResult:
    """
...
class AwaitableListNamespaceDisasterRecoveryConfigAuthorizationRuleKeysResult(ListNamespaceDisasterRecoveryConfigAuthorizationRuleKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListNamespaceDisasterRecoveryConfigAuthorizationRuleKeysResult(
...
def list_namespace_disaster_recovery_config_authorization_rule_keys(alias=None, authorization_rule_name=None, namespace_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:servicebus:listNamespaceDisasterRecoveryConfigAuthorizationRuleKeys', __args__, opts=opts).value

    return AwaitableListNamespaceDisasterRecoveryConfigAuthorizationRuleKeysResult(
