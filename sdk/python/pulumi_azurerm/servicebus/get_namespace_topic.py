...
def get_namespace_topic(name=None, namespace_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:servicebus:getNamespaceTopic', __args__, opts=opts).value
