...
class Namespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/latest:Namespace"), pulumi.Alias(type_="azurerm:servicebus/v20150801:Namespace"), pulumi.Alias(type_="azurerm:servicebus/v20170401:Namespace"), pulumi.Alias(type_="azurerm:servicebus/v20180101preview:Namespace")])
