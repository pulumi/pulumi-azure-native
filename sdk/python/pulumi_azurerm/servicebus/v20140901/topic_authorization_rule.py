...
class TopicAuthorizationRule(pulumi.CustomResource):
    ...
    Resource type
    """
    def __init__(__self__, resource_name, opts=None, claim_type=None, claim_value=None, key_name=None, location=None, name=None, namespace_name=None, primary_key=None, resource_group_name=None, rights=None, secondary_key=None, topic_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/v20150801:TopicAuthorizationRule"), pulumi.Alias(type_="azurerm:servicebus/v20170401:TopicAuthorizationRule")])
