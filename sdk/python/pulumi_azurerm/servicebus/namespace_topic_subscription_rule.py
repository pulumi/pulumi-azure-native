...
class NamespaceTopicSubscriptionRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, namespace_name=None, properties=None, resource_group_name=None, subscription_name=None, topic_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(NamespaceTopicSubscriptionRule, __self__).__init__(
            'azurerm:servicebus:NamespaceTopicSubscriptionRule',
            resource_name,
            __props__,
            opts)
