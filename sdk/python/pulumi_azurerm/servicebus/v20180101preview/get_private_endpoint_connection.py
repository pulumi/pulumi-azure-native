...
def get_private_endpoint_connection(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:servicebus/v20180101preview:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
