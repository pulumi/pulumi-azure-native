...
class Topic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/latest:Topic"), pulumi.Alias(type_="azurerm:servicebus/preview:Topic"), pulumi.Alias(type_="azurerm:servicebus/v20140901:Topic"), pulumi.Alias(type_="azurerm:servicebus/v20170401:Topic")])
