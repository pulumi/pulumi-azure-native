...
class NamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, namespace_name=None, resource_group_name=None, rights=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/v20140901:NamespaceAuthorizationRule"), pulumi.Alias(type_="azurerm:servicebus/v20170401:NamespaceAuthorizationRule")])
