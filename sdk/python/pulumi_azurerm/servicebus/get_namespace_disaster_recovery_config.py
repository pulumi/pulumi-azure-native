...
def get_namespace_disaster_recovery_config(name=None, namespace_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:servicebus:getNamespaceDisasterRecoveryConfig', __args__, opts=opts).value
