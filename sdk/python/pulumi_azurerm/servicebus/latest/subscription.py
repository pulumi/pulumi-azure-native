...
class Subscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/preview:Subscription"), pulumi.Alias(type_="azurerm:servicebus/v20140901:Subscription"), pulumi.Alias(type_="azurerm:servicebus/v20150801:Subscription"), pulumi.Alias(type_="azurerm:servicebus/v20170401:Subscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Subscription, __self__).__init__(
            'azurerm:servicebus/latest:Subscription',
            resource_name,
            __props__,
            opts)
