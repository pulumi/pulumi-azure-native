...
class Topic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/preview:Topic"), pulumi.Alias(type_="azurerm:servicebus/v20140901:Topic"), pulumi.Alias(type_="azurerm:servicebus/v20150801:Topic"), pulumi.Alias(type_="azurerm:servicebus/v20170401:Topic")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Topic, __self__).__init__(
            'azurerm:servicebus/latest:Topic',
            resource_name,
            __props__,
            opts)
