...
class NamespaceAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        namespace_authorization_rule = azurerm.servicebus.latest.NamespaceAuthorizationRule("namespaceAuthorizationRule",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/v20140901:NamespaceAuthorizationRule"), pulumi.Alias(type_="azurerm:servicebus/v20150801:NamespaceAuthorizationRule"), pulumi.Alias(type_="azurerm:servicebus/v20170401:NamespaceAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NamespaceAuthorizationRule, __self__).__init__(
            'azurerm:servicebus/latest:NamespaceAuthorizationRule',
            resource_name,
            __props__,
            opts)
