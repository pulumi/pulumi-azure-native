...
class MigrationConfig(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicebus/preview:MigrationConfig"), pulumi.Alias(type_="azurerm:servicebus/v20170401:MigrationConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MigrationConfig, __self__).__init__(
            'azurerm:servicebus/latest:MigrationConfig',
            resource_name,
            __props__,
            opts)
