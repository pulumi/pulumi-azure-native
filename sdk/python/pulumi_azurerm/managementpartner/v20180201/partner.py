...
class Partner(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:managementpartner/latest:Partner"), pulumi.Alias(type_="azurerm:managementpartner/preview:Partner")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Partner, __self__).__init__(
            'azurerm:managementpartner/v20180201:Partner',
            resource_name,
            __props__,
            opts)
