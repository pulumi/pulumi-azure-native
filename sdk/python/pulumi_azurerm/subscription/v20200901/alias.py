...
class Alias(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:subscription/latest:Alias"), pulumi.Alias(type_="azurerm:subscription/preview:Alias"), pulumi.Alias(type_="azurerm:subscription/v20191001preview:Alias")])
