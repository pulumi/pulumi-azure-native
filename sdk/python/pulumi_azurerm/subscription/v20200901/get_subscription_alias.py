...
def get_subscription_alias(name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:subscription/v20200901:getSubscriptionAlias', __args__, opts=opts).value
