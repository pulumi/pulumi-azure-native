...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    Describes the properties of a Virtual Machine Scale Set.
      ...
      * `host_group` (`dict`) - Specifies information about the dedicated host group that the virtual machine scale set resides in. <br><br>Minimum api-version: 2020-06-01.
        * `id` (`str`) - Resource Id
      ...
      * `virtual_machine_profile` (`dict`) - The virtual machine profile.
        ...
        * `diagnostics_profile` (`dict`) - Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.
          * `boot_diagnostics` (`dict`) - Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
            ...
            * `storage_uri` (`str`) - Uri of the storage account to use for placing the console output and screenshot. <br><br>If storageUri is not specified while enabling boot diagnostics, managed storage will be used.
        ...
        * `security_profile` (`dict`) - Specifies the Security related profile settings for the virtual machines in the scale set.
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, plan=None, properties=None, resource_group_name=None, sku=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `host_group` (`pulumi.Input[dict]`) - Specifies information about the dedicated host group that the virtual machine scale set resides in. <br><br>Minimum api-version: 2020-06-01.
          ...
          * `virtual_machine_profile` (`pulumi.Input[dict]`) - The virtual machine profile.
            ...
            * `diagnostics_profile` (`pulumi.Input[dict]`) - Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.
              * `boot_diagnostics` (`pulumi.Input[dict]`) - Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
                ...
                * `storage_uri` (`pulumi.Input[str]`) - Uri of the storage account to use for placing the console output and screenshot. <br><br>If storageUri is not specified while enabling boot diagnostics, managed storage will be used.
            ...
            * `extension_profile` (`pulumi.Input[dict]`) - Specifies a collection of settings for extensions installed on virtual machines in the scale set.
              ...
              * `extensions_time_budget` (`pulumi.Input[str]`) - Specifies the time alloted for all extensions to start. The time duration should be between 15 minutes and 120 minutes (inclusive) and should be specified in ISO 8601 format. The default value is 90 minutes (PT1H30M). <br><br> Minimum api-version: 2020-06-01
            ...
            * `security_profile` (`pulumi.Input[dict]`) - Specifies the Security related profile settings for the virtual machines in the scale set.
              * `encryption_at_host` (`pulumi.Input[bool]`) - This property can be used by user in the request to enable or disable the Host Encryption for the virtual machine or virtual machine scale set. This will enable the encryption for all the disks including Resource/Temp disk at host itself. <br><br> Default: The Encryption at host will be disabled unless this property is set to true for the resource.
        ...
        super(VirtualMachineScaleSet, __self__).__init__(
            'azurerm:compute/v20200601:VirtualMachineScaleSet',
            resource_name,
            __props__,
            opts)
