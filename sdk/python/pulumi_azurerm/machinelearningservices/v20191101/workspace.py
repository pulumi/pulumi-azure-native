...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        workspace = azurerm.machinelearningservices.v20191101.Workspace("workspace",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningservices/latest:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20181119:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20190501:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20190601:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200101:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200301:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200401:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200601:Workspace")])
