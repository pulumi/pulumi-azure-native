...
class Workspace(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, application_insights=None, container_registry=None, description=None, discovery_url=None, friendly_name=None, identity=None, key_vault=None, location=None, name=None, resource_group_name=None, sku=None, storage_account=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningservices/v20181119:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20190501:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20190601:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200101:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200301:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200401:Workspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200601:Workspace")])
