...
def get_workspace_private_endpoint_connection(name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:machinelearningservices:getWorkspacePrivateEndpointConnection', __args__, opts=opts).value
