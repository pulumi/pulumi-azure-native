...
def get_machine_learning_compute(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:machinelearningservices/v20190601:getMachineLearningCompute', __args__, opts=opts, typ=GetMachineLearningComputeResult).value
