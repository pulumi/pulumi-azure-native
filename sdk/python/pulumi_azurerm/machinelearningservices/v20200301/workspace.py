...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        workspace = azurerm.machinelearningservices.v20200301.Workspace("workspace",
