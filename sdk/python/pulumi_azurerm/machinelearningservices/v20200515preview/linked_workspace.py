...
class LinkedWorkspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        linked_workspace = azurerm.machinelearningservices.v20200515preview.LinkedWorkspace("linkedWorkspace",
            link_name="link-1",
            name="link-1",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningservices/v20200501preview:LinkedWorkspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LinkedWorkspace, __self__).__init__(
            'azurerm:machinelearningservices/v20200515preview:LinkedWorkspace',
            resource_name,
            __props__,
            opts)
