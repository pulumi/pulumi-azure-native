...
class MachineLearningService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        machine_learning_service = azurerm.machinelearningservices.v20200515preview.MachineLearningService("machineLearningService",
            compute_type="ACI",
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningservices/v20200501preview:MachineLearningService"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200901preview:MachineLearningService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MachineLearningService, __self__).__init__(
            'azurerm:machinelearningservices/v20200515preview:MachineLearningService',
            resource_name,
            __props__,
            opts)
