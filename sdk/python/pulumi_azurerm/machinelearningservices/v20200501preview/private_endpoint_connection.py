...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        private_endpoint_connection = azurerm.machinelearningservices.v20200501preview.PrivateEndpointConnection("privateEndpointConnection",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningservices/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200101:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200218preview:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200401:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200515preview:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200601:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200901preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azurerm:machinelearningservices/v20200501preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
