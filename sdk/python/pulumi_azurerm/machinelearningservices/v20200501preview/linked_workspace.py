...
class LinkedWorkspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningservices/latest:LinkedWorkspace"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200515preview:LinkedWorkspace")])
