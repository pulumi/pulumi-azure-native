...
def get_linked_workspace(link_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:machinelearningservices/v20200501preview:getLinkedWorkspace', __args__, opts=opts, typ=GetLinkedWorkspaceResult).value
