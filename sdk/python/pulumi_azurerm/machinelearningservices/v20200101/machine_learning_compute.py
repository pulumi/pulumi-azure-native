...
class MachineLearningCompute(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningservices/latest:MachineLearningCompute"), pulumi.Alias(type_="azurerm:machinelearningservices/v20181119:MachineLearningCompute"), pulumi.Alias(type_="azurerm:machinelearningservices/v20190501:MachineLearningCompute"), pulumi.Alias(type_="azurerm:machinelearningservices/v20190601:MachineLearningCompute"), pulumi.Alias(type_="azurerm:machinelearningservices/v20191101:MachineLearningCompute"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200301:MachineLearningCompute"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200401:MachineLearningCompute"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200601:MachineLearningCompute")])
