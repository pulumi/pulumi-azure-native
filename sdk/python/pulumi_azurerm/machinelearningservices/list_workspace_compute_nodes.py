...
class ListWorkspaceComputeNodesResult:
    """
...
class AwaitableListWorkspaceComputeNodesResult(ListWorkspaceComputeNodesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListWorkspaceComputeNodesResult(
            compute_type=self.compute_type,
            next_link=self.next_link,
            nodes=self.nodes)


def list_workspace_compute_nodes(compute_name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:machinelearningservices:listWorkspaceComputeNodes', __args__, opts=opts).value

    return AwaitableListWorkspaceComputeNodesResult(
