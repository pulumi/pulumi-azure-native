...
class WorkspaceConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearningservices/latest:WorkspaceConnection"), pulumi.Alias(type_="azurerm:machinelearningservices/v20200601:WorkspaceConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceConnection, __self__).__init__(
            'azurerm:machinelearningservices/preview:WorkspaceConnection',
            resource_name,
            __props__,
            opts)
