...
def list_machine_learning_compute_nodes(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:machinelearningservices/v20181119:listMachineLearningComputeNodes', __args__, opts=opts, typ=ListMachineLearningComputeNodesResult).value
