...
def list_identity_provider_secrets(identity_provider_name=None, resource_group_name=None, service_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/v20191201:listIdentityProviderSecrets', __args__, opts=opts).value
