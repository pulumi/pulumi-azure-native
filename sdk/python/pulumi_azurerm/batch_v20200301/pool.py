    ...
    The properties associated with the pool.
      ...
      * `deployment_configuration` (`dict`) - Using CloudServiceConfiguration specifies that the nodes should be creating using Azure Cloud Services (PaaS), while VirtualMachineConfiguration uses Azure Virtual Machines (IaaS).
        ...
        * `virtual_machine_configuration` (`dict`) - This property and cloudServiceConfiguration are mutually exclusive and one of the properties must be specified.
          ...
          * `disk_encryption_configuration` (`dict`) - If specified, encryption is performed on each node in the pool during node provisioning.
            * `targets` (`list`) - On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.
      ...
      * `network_configuration` (`dict`) - The network configuration for a pool.
        ...
        * `public_ip_address_configuration` (`dict`) - This property is only supported on Pools with the virtualMachineConfiguration property.
          ...
          * `provision` (`str`) - The default value is BatchManaged
      ...
      * `scale_settings` (`dict`) - Defines the desired size of the pool. This can either be 'fixedScale' where the requested targetDedicatedNodes is specified, or 'autoScale' which defines a formula which is periodically reevaluated. If this property is not specified, the pool will have a fixed scale with 0 targetDedicatedNodes.
        ...
        * `fixed_scale` (`dict`) - This property and autoScale are mutually exclusive and one of the properties must be specified.
          ...
          * `target_dedicated_nodes` (`float`) - At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.
          * `target_low_priority_nodes` (`float`) - At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.
        ...
        The **properties** object supports the following:
          ...
          * `deployment_configuration` (`pulumi.Input[dict]`) - Using CloudServiceConfiguration specifies that the nodes should be creating using Azure Cloud Services (PaaS), while VirtualMachineConfiguration uses Azure Virtual Machines (IaaS).
            ...
            * `virtual_machine_configuration` (`pulumi.Input[dict]`) - This property and cloudServiceConfiguration are mutually exclusive and one of the properties must be specified.
              ...
              * `disk_encryption_configuration` (`pulumi.Input[dict]`) - If specified, encryption is performed on each node in the pool during node provisioning.
                * `targets` (`pulumi.Input[list]`) - On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.

              * `image_reference` (`pulumi.Input[dict]`)
                * `id` (`pulumi.Input[str]`) - This property is mutually exclusive with other properties. The Shared Image Gallery image must have replicas in the same region as the Azure Batch account. For information about the firewall settings for the Batch node agent to communicate with the Batch service see https://docs.microsoft.com/en-us/azure/batch/batch-api-basics#virtual-network-vnet-and-firewall-configuration.
          ...
          * `network_configuration` (`pulumi.Input[dict]`) - The network configuration for a pool.
            ...
            * `public_ip_address_configuration` (`pulumi.Input[dict]`) - This property is only supported on Pools with the virtualMachineConfiguration property.
              ...
              * `provision` (`pulumi.Input[str]`) - The default value is BatchManaged
          ...
          * `scale_settings` (`pulumi.Input[dict]`) - Defines the desired size of the pool. This can either be 'fixedScale' where the requested targetDedicatedNodes is specified, or 'autoScale' which defines a formula which is periodically reevaluated. If this property is not specified, the pool will have a fixed scale with 0 targetDedicatedNodes.
            ...
            * `fixed_scale` (`pulumi.Input[dict]`) - This property and autoScale are mutually exclusive and one of the properties must be specified.
              ...
              * `target_dedicated_nodes` (`pulumi.Input[float]`) - At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.
              * `target_low_priority_nodes` (`pulumi.Input[float]`) - At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.
