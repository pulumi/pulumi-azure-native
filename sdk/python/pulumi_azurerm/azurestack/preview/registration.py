...
class Registration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:azurestack/latest:Registration"), pulumi.Alias(type_="azurerm:azurestack/v20170601:Registration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Registration, __self__).__init__(
            'azurerm:azurestack/preview:Registration',
            resource_name,
            __props__,
            opts)
