...
class ListRegistrationProductDetailsResult:
    """
...
class AwaitableListRegistrationProductDetailsResult(ListRegistrationProductDetailsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListRegistrationProductDetailsResult(
            gallery_package_blob_sas_uri=self.gallery_package_blob_sas_uri,
            product_kind=self.product_kind,
            properties=self.properties)


def list_registration_product_details(product_name=None, registration_name=None, resource_group=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:azurestack:listRegistrationProductDetails', __args__, opts=opts).value

    return AwaitableListRegistrationProductDetailsResult(
