...
class RegistrationCustomerSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, name=None, properties=None, registration_name=None, resource_group=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(RegistrationCustomerSubscription, __self__).__init__(
            'azurerm:azurestack:RegistrationCustomerSubscription',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, name=None, properties=None, type=None):
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return RegistrationCustomerSubscription(resource_name, opts=opts, __props__=__props__)
