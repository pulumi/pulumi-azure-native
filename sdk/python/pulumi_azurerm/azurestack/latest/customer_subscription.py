...
class CustomerSubscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:azurestack/preview:CustomerSubscription"), pulumi.Alias(type_="azurerm:azurestack/v20170601:CustomerSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomerSubscription, __self__).__init__(
            'azurerm:azurestack/latest:CustomerSubscription',
            resource_name,
            __props__,
            opts)
