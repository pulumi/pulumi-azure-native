...
class MediaGraph(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/v20190901preview:MediaGraph"), pulumi.Alias(type_="azurerm:media/v20200201preview:MediaGraph")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MediaGraph, __self__).__init__(
            'azurerm:media/preview:MediaGraph',
            resource_name,
            __props__,
            opts)
