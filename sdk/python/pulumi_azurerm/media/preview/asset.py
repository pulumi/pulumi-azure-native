...
class Asset(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:Asset"), pulumi.Alias(type_="azurerm:media/v20180330preview:Asset"), pulumi.Alias(type_="azurerm:media/v20180601preview:Asset"), pulumi.Alias(type_="azurerm:media/v20180701:Asset"), pulumi.Alias(type_="azurerm:media/v20200501:Asset")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Asset, __self__).__init__(
            'azurerm:media/preview:Asset',
            resource_name,
            __props__,
            opts)
