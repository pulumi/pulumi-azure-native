...
class StreamingEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        streaming_endpoint = azurerm.media.v20180701.StreamingEndpoint("streamingEndpoint",
            access_control={
                "akamai": {
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:StreamingEndpoint"), pulumi.Alias(type_="azurerm:media/v20200501:StreamingEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StreamingEndpoint, __self__).__init__(
            'azurerm:media/v20180701:StreamingEndpoint',
            resource_name,
            __props__,
            opts)
