...
class AssetFilter(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:AssetFilter"), pulumi.Alias(type_="azurerm:media/preview:AssetFilter"), pulumi.Alias(type_="azurerm:media/v20200501:AssetFilter")])
