...
class StreamingLocator(pulumi.CustomResource):
    def __init__(__self__,
        ...
        streaming_locator = azurerm.media.v20180701.StreamingLocator("streamingLocator",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:StreamingLocator"), pulumi.Alias(type_="azurerm:media/v20200501:StreamingLocator")])
