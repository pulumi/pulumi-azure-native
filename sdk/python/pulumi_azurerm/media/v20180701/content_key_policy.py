...
class ContentKeyPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:ContentKeyPolicy"), pulumi.Alias(type_="azurerm:media/preview:ContentKeyPolicy"), pulumi.Alias(type_="azurerm:media/v20180330preview:ContentKeyPolicy"), pulumi.Alias(type_="azurerm:media/v20180601preview:ContentKeyPolicy"), pulumi.Alias(type_="azurerm:media/v20200501:ContentKeyPolicy")])
