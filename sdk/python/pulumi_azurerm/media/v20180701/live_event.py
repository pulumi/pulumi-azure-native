...
class LiveEvent(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:LiveEvent"), pulumi.Alias(type_="azurerm:media/preview:LiveEvent"), pulumi.Alias(type_="azurerm:media/v20180330preview:LiveEvent"), pulumi.Alias(type_="azurerm:media/v20180601preview:LiveEvent"), pulumi.Alias(type_="azurerm:media/v20190501preview:LiveEvent"), pulumi.Alias(type_="azurerm:media/v20200501:LiveEvent")])
