...
class MediaService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:MediaService"), pulumi.Alias(type_="azurerm:media/v20151001:MediaService"), pulumi.Alias(type_="azurerm:media/v20200501:MediaService")])
