...
class GetStreamingLocatorResult:
    ...
    """
    def __init__(__self__, alternative_media_id=None, asset_name=None, content_keys=None, created=None, default_content_key_policy_name=None, end_time=None, name=None, start_time=None, streaming_locator_id=None, streaming_policy_name=None, type=None):
...
def get_streaming_locator(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:media/v20180601preview:getStreamingLocator', __args__, opts=opts, typ=GetStreamingLocatorResult).value
