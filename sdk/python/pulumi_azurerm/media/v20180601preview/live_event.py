...
class LiveEvent(pulumi.CustomResource):
    def __init__(__self__,
        ...
        live_event = azurerm.media.v20180601preview.LiveEvent("liveEvent",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:LiveEvent"), pulumi.Alias(type_="azurerm:media/v20180330preview:LiveEvent"), pulumi.Alias(type_="azurerm:media/v20180701:LiveEvent"), pulumi.Alias(type_="azurerm:media/v20190501preview:LiveEvent"), pulumi.Alias(type_="azurerm:media/v20200501:LiveEvent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LiveEvent, __self__).__init__(
            'azurerm:media/v20180601preview:LiveEvent',
            resource_name,
            __props__,
            opts)
