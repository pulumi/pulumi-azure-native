...
def list_streaming_locator_content_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:media/v20180601preview:listStreamingLocatorContentKeys', __args__, opts=opts, typ=ListStreamingLocatorContentKeysResult).value
