...
class StreamingPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:StreamingPolicy"), pulumi.Alias(type_="azurerm:media/preview:StreamingPolicy"), pulumi.Alias(type_="azurerm:media/v20180330preview:StreamingPolicy"), pulumi.Alias(type_="azurerm:media/v20180701:StreamingPolicy"), pulumi.Alias(type_="azurerm:media/v20200501:StreamingPolicy")])
