...
class StreamingEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        streaming_endpoint = azurerm.media.v20180601preview.StreamingEndpoint("streamingEndpoint",
            access_control={
                "akamai": {
        ...
        :param pulumi.Input[float] scale_units: The number of scale units.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:StreamingEndpoint"), pulumi.Alias(type_="azurerm:media/v20180330preview:StreamingEndpoint"), pulumi.Alias(type_="azurerm:media/v20180701:StreamingEndpoint"), pulumi.Alias(type_="azurerm:media/v20190501preview:StreamingEndpoint"), pulumi.Alias(type_="azurerm:media/v20200501:StreamingEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StreamingEndpoint, __self__).__init__(
            'azurerm:media/v20180601preview:StreamingEndpoint',
            resource_name,
            __props__,
            opts)
    ...
    def scale_units(self) -> pulumi.Output[Optional[float]]:
        """
