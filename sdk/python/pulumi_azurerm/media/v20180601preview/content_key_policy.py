...
class ContentKeyPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        content_key_policy = azurerm.media.v20180601preview.ContentKeyPolicy("contentKeyPolicy",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:ContentKeyPolicy"), pulumi.Alias(type_="azurerm:media/v20180330preview:ContentKeyPolicy"), pulumi.Alias(type_="azurerm:media/v20180701:ContentKeyPolicy"), pulumi.Alias(type_="azurerm:media/v20200501:ContentKeyPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContentKeyPolicy, __self__).__init__(
            'azurerm:media/v20180601preview:ContentKeyPolicy',
            resource_name,
            __props__,
            opts)
