...
def list_streaming_locator_content_keys(account_name=None, resource_group_name=None, streaming_locator_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:media/v20200501:listStreamingLocatorContentKeys', __args__, opts=opts).value
