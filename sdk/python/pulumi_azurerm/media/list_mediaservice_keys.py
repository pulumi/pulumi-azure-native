...
def list_mediaservice_keys(media_service_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:media:listMediaserviceKeys', __args__, opts=opts).value
