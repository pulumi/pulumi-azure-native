...
class GetMediaGraphResult:
    ...
    The Media Graph.
    """
    def __init__(__self__, created=None, description=None, last_modified=None, name=None, sinks=None, sources=None, state=None, type=None):
...
def get_media_graph(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:media/v20190901preview:getMediaGraph', __args__, opts=opts, typ=GetMediaGraphResult).value
