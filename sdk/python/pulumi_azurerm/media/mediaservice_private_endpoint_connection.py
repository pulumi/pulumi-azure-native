...
class MediaservicePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(MediaservicePrivateEndpointConnection, __self__).__init__(
            'azurerm:media:MediaservicePrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return MediaservicePrivateEndpointConnection(resource_name, opts=opts, __props__=__props__)
