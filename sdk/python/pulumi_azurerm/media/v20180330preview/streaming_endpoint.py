...
class StreamingEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        streaming_endpoint = azurerm.media.v20180330preview.StreamingEndpoint("streamingEndpoint",
            access_control={
                "akamai": {
