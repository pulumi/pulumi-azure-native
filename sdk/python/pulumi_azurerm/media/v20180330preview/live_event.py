...
class LiveEvent(pulumi.CustomResource):
    def __init__(__self__,
        ...
        live_event = azurerm.media.v20180330preview.LiveEvent("liveEvent",
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] stream_options: The stream options.
