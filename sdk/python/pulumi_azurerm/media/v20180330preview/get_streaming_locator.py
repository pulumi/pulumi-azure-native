...
class GetStreamingLocatorResult:
    ...
    def content_keys(self) -> Optional[List['outputs.StreamingLocatorUserDefinedContentKeyResponse']]:
        """
...
def get_streaming_locator(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:media/v20180330preview:getStreamingLocator', __args__, opts=opts, typ=GetStreamingLocatorResult).value
