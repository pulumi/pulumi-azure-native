...
class Asset(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:Asset"), pulumi.Alias(type_="azurerm:media/preview:Asset"), pulumi.Alias(type_="azurerm:media/v20180601preview:Asset"), pulumi.Alias(type_="azurerm:media/v20180701:Asset"), pulumi.Alias(type_="azurerm:media/v20200501:Asset")])
