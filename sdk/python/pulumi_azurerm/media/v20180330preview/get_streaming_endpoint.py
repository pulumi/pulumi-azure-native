...
class GetStreamingEndpointResult:
    ...
    def scale_units(self) -> Optional[float]:
        """
...
def get_streaming_endpoint(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:media/v20180330preview:getStreamingEndpoint', __args__, opts=opts, typ=GetStreamingEndpointResult).value
