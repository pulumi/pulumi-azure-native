...
class Transform(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/preview:Transform"), pulumi.Alias(type_="azurerm:media/v20180330preview:Transform"), pulumi.Alias(type_="azurerm:media/v20180601preview:Transform"), pulumi.Alias(type_="azurerm:media/v20180701:Transform"), pulumi.Alias(type_="azurerm:media/v20200501:Transform")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Transform, __self__).__init__(
            'azurerm:media/latest:Transform',
            resource_name,
            __props__,
            opts)
