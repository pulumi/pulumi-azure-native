...
class AccountFilter(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/preview:AccountFilter"), pulumi.Alias(type_="azurerm:media/v20180701:AccountFilter"), pulumi.Alias(type_="azurerm:media/v20200501:AccountFilter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccountFilter, __self__).__init__(
            'azurerm:media/latest:AccountFilter',
            resource_name,
            __props__,
            opts)
