...
class StreamingPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/preview:StreamingPolicy"), pulumi.Alias(type_="azurerm:media/v20180330preview:StreamingPolicy"), pulumi.Alias(type_="azurerm:media/v20180601preview:StreamingPolicy"), pulumi.Alias(type_="azurerm:media/v20180701:StreamingPolicy"), pulumi.Alias(type_="azurerm:media/v20200501:StreamingPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StreamingPolicy, __self__).__init__(
            'azurerm:media/latest:StreamingPolicy',
            resource_name,
            __props__,
            opts)
