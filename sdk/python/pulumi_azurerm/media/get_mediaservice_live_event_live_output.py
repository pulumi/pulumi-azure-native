...
class AwaitableGetMediaserviceLiveEventLiveOutputResult(GetMediaserviceLiveEventLiveOutputResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMediaserviceLiveEventLiveOutputResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_mediaservice_live_event_live_output(account_name=None, live_event_name=None, name=None, resource_group_name=None, opts=None):
    """
