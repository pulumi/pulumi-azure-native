...
class LiveOutput(pulumi.CustomResource):
    def __init__(__self__,
        ...
        live_output = azurerm.media.v20190501preview.LiveOutput("liveOutput",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:LiveOutput"), pulumi.Alias(type_="azurerm:media/v20180330preview:LiveOutput"), pulumi.Alias(type_="azurerm:media/v20180601preview:LiveOutput"), pulumi.Alias(type_="azurerm:media/v20180701:LiveOutput"), pulumi.Alias(type_="azurerm:media/v20200501:LiveOutput")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LiveOutput, __self__).__init__(
            'azurerm:media/v20190501preview:LiveOutput',
            resource_name,
            __props__,
            opts)
