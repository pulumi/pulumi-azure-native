...
class LiveOutput(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:media/latest:LiveOutput"), pulumi.Alias(type_="azurerm:media/preview:LiveOutput"), pulumi.Alias(type_="azurerm:media/v20180330preview:LiveOutput"), pulumi.Alias(type_="azurerm:media/v20180601preview:LiveOutput"), pulumi.Alias(type_="azurerm:media/v20180701:LiveOutput"), pulumi.Alias(type_="azurerm:media/v20200501:LiveOutput")])
