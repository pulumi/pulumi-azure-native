...
class JobDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hybriddata/latest:JobDefinition"), pulumi.Alias(type_="azurerm:hybriddata/v20160601:JobDefinition"), pulumi.Alias(type_="azurerm:hybriddata/v20190601:JobDefinition")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(JobDefinition, __self__).__init__(
            'azurerm:hybriddata/preview:JobDefinition',
            resource_name,
            __props__,
            opts)
