...
class JobDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hybriddata/latest:JobDefinition"), pulumi.Alias(type_="azurerm:hybriddata/preview:JobDefinition"), pulumi.Alias(type_="azurerm:hybriddata/v20160601:JobDefinition")])
