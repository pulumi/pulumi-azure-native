...
class PolicyAssignment(pulumi.CustomResource):
    ...
    The managed identity associated with the policy assignment.
      ...
      * `type` (`str`) - The identity type. This is the only required field when adding a system assigned identity to a resource.
    """
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, properties=None, scope=None, sku=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **identity** object supports the following:
          ...
          * `type` (`pulumi.Input[str]`) - The identity type. This is the only required field when adding a system assigned identity to a resource.
        ...
        The **properties** object supports the following:
          ...
          * `metadata` (`pulumi.Input[dict]`) - The policy assignment metadata. Metadata is an open ended object and is typically a collection of key value pairs.
          * `not_scopes` (`pulumi.Input[list]`) - The policy's excluded scopes.
          * `parameters` (`pulumi.Input[dict]`) - The parameter values for the assigned policy rule. The keys are the parameter names.
        ...
        super(PolicyAssignment, __self__).__init__(
            'azurerm:authorization:PolicyAssignment',
            resource_name,
            __props__,
            opts)
