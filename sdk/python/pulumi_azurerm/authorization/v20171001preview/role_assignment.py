...
class RoleAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:authorization/latest:RoleAssignment"), pulumi.Alias(type_="azurerm:authorization/preview:RoleAssignment"), pulumi.Alias(type_="azurerm:authorization/v20150701:RoleAssignment"), pulumi.Alias(type_="azurerm:authorization/v20180101preview:RoleAssignment"), pulumi.Alias(type_="azurerm:authorization/v20180901preview:RoleAssignment"), pulumi.Alias(type_="azurerm:authorization/v20200401preview:RoleAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoleAssignment, __self__).__init__(
            'azurerm:authorization/v20171001preview:RoleAssignment',
            resource_name,
            __props__,
            opts)
