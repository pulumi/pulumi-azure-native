...
def get_policy_definition(management_group_id=None, name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:authorization:getPolicyDefinition', __args__, opts=opts).value
