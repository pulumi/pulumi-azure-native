...
class PolicyAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        policy_assignment = azurerm.authorization.v20190601.PolicyAssignment("policyAssignment",
