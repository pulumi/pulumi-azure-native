...
class PolicyDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:authorization/v20161201:PolicyDefinition"), pulumi.Alias(type_="azurerm:authorization/v20180301:PolicyDefinition"), pulumi.Alias(type_="azurerm:authorization/v20180501:PolicyDefinition"), pulumi.Alias(type_="azurerm:authorization/v20190101:PolicyDefinition"), pulumi.Alias(type_="azurerm:authorization/v20190601:PolicyDefinition"), pulumi.Alias(type_="azurerm:authorization/v20190901:PolicyDefinition")])
