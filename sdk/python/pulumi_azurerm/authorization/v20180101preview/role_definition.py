...
class RoleDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:authorization/latest:RoleDefinition"), pulumi.Alias(type_="azurerm:authorization/preview:RoleDefinition"), pulumi.Alias(type_="azurerm:authorization/v20150701:RoleDefinition")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoleDefinition, __self__).__init__(
            'azurerm:authorization/v20180101preview:RoleDefinition',
            resource_name,
            __props__,
            opts)
