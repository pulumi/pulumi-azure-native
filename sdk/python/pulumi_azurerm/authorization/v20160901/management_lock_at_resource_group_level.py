...
class ManagementLockAtResourceGroupLevel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:authorization/latest:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azurerm:authorization/preview:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azurerm:authorization/v20150101:ManagementLockAtResourceGroupLevel")])
