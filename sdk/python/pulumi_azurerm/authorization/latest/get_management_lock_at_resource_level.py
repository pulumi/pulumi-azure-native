...
def get_management_lock_at_resource_level(lock_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:authorization/latest:getManagementLockAtResourceLevel', __args__, opts=opts, typ=GetManagementLockAtResourceLevelResult).value
