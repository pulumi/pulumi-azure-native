...
def get_management_lock_at_subscription_level(lock_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:authorization/latest:getManagementLockAtSubscriptionLevel', __args__, opts=opts, typ=GetManagementLockAtSubscriptionLevelResult).value
