...
class ManagementLock(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:authorization/latest:ManagementLock"), pulumi.Alias(type_="azurerm:authorization/preview:ManagementLock"), pulumi.Alias(type_="azurerm:authorization/v20160901:ManagementLock")])
