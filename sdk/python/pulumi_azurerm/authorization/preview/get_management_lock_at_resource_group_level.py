...
def get_management_lock_at_resource_group_level(lock_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:authorization/preview:getManagementLockAtResourceGroupLevel', __args__, opts=opts, typ=GetManagementLockAtResourceGroupLevelResult).value
