...
class ManagementLockAtResourceLevel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:authorization/latest:ManagementLockAtResourceLevel"), pulumi.Alias(type_="azurerm:authorization/v20160901:ManagementLockAtResourceLevel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagementLockAtResourceLevel, __self__).__init__(
            'azurerm:authorization/preview:ManagementLockAtResourceLevel',
            resource_name,
            __props__,
            opts)
