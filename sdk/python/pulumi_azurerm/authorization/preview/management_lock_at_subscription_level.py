...
class ManagementLockAtSubscriptionLevel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:authorization/latest:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azurerm:authorization/v20150101:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azurerm:authorization/v20160901:ManagementLockAtSubscriptionLevel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagementLockAtSubscriptionLevel, __self__).__init__(
            'azurerm:authorization/preview:ManagementLockAtSubscriptionLevel',
            resource_name,
            __props__,
            opts)
