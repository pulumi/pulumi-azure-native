...
class GetRoleAssignmentResult:
    ...
    Role Assignments
    """
    def __init__(__self__, can_delegate=None, name=None, principal_id=None, principal_type=None, role_definition_id=None, scope=None, type=None):
...
def get_role_assignment(role_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:authorization/v20180901preview:getRoleAssignment', __args__, opts=opts, typ=GetRoleAssignmentResult).value
