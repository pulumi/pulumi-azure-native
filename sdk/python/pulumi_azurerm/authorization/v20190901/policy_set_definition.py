...
class PolicySetDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:authorization/latest:PolicySetDefinition"), pulumi.Alias(type_="azurerm:authorization/preview:PolicySetDefinition"), pulumi.Alias(type_="azurerm:authorization/v20170601preview:PolicySetDefinition"), pulumi.Alias(type_="azurerm:authorization/v20180301:PolicySetDefinition"), pulumi.Alias(type_="azurerm:authorization/v20180501:PolicySetDefinition"), pulumi.Alias(type_="azurerm:authorization/v20190101:PolicySetDefinition"), pulumi.Alias(type_="azurerm:authorization/v20190601:PolicySetDefinition"), pulumi.Alias(type_="azurerm:authorization/v20200301:PolicySetDefinition")])
