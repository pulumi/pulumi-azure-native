...
def get_policy_set_definition(management_group_id=None, name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:authorization:getPolicySetDefinition', __args__, opts=opts).value
