...
class CustomResourceProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:customproviders/preview:CustomResourceProvider")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomResourceProvider, __self__).__init__(
            'azurerm:customproviders/v20180901preview:CustomResourceProvider',
            resource_name,
            __props__,
            opts)
