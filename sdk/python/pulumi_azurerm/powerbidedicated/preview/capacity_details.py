...
class CapacityDetails(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:powerbidedicated/latest:CapacityDetails"), pulumi.Alias(type_="azurerm:powerbidedicated/v20171001:CapacityDetails")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CapacityDetails, __self__).__init__(
            'azurerm:powerbidedicated/preview:CapacityDetails',
            resource_name,
            __props__,
            opts)
