...
class AwaitableGetCapacityResult(GetCapacityResult):
...
def get_capacity(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:powerbidedicated:getCapacity', __args__, opts=opts).value

    return AwaitableGetCapacityResult(
