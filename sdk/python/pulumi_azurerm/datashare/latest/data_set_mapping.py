...
class DataSetMapping(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datashare/preview:DataSetMapping"), pulumi.Alias(type_="azurerm:datashare/v20181101preview:DataSetMapping"), pulumi.Alias(type_="azurerm:datashare/v20191101:DataSetMapping")])
