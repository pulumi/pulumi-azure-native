...
def get_synchronization_setting(account_name=None, name=None, resource_group_name=None, share_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datashare:getSynchronizationSetting', __args__, opts=opts).value
