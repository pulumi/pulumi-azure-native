...
class AccountShareSubscriptionTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, kind=None, name=None, resource_group_name=None, share_subscription_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AccountShareSubscriptionTrigger, __self__).__init__(
            'azurerm:datashare:AccountShareSubscriptionTrigger',
            resource_name,
            __props__,
            opts)
