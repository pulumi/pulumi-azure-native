...
class ShareSubscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datashare/latest:ShareSubscription"), pulumi.Alias(type_="azurerm:datashare/v20181101preview:ShareSubscription"), pulumi.Alias(type_="azurerm:datashare/v20191101:ShareSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ShareSubscription, __self__).__init__(
            'azurerm:datashare/preview:ShareSubscription',
            resource_name,
            __props__,
            opts)
