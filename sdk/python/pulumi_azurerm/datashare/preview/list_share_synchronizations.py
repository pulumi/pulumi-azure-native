...
class ListShareSynchronizationsResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> List['outputs.ShareSynchronizationResponseResult']:
        """
...
def list_share_synchronizations(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datashare/preview:listShareSynchronizations', __args__, opts=opts, typ=ListShareSynchronizationsResult).value
