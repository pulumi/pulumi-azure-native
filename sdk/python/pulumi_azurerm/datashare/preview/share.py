...
class Share(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datashare/latest:Share"), pulumi.Alias(type_="azurerm:datashare/v20181101preview:Share"), pulumi.Alias(type_="azurerm:datashare/v20191101:Share")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Share, __self__).__init__(
            'azurerm:datashare/preview:Share',
            resource_name,
            __props__,
            opts)
