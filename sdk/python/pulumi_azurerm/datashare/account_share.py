...
class AccountShare(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AccountShare, __self__).__init__(
            'azurerm:datashare:AccountShare',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `created_at` (`pulumi.Input[str]`) - Time at which the share was created.
          * `description` (`pulumi.Input[str]`) - Share description.
          * `provisioning_state` (`pulumi.Input[str]`) - Gets or sets the provisioning state
          * `share_kind` (`pulumi.Input[str]`) - Share kind.
          * `terms` (`pulumi.Input[str]`) - Share terms.
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return AccountShare(resource_name, opts=opts, __props__=__props__)
