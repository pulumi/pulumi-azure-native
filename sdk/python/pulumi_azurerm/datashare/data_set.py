...
class DataSet(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, account_name=None, kind=None, name=None, resource_group_name=None, share_name=None, __props__=None, __name__=None, __opts__=None):
        """
