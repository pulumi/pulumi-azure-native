...
class Account(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datashare/latest:Account"), pulumi.Alias(type_="azurerm:datashare/preview:Account"), pulumi.Alias(type_="azurerm:datashare/v20181101preview:Account")])
