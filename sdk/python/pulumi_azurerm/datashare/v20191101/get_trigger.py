...
def get_trigger(account_name=None, name=None, resource_group_name=None, share_subscription_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datashare/v20191101:getTrigger', __args__, opts=opts).value
