...
def list_share_subscription_source_share_synchronization_settings(account_name=None, resource_group_name=None, share_subscription_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datashare:listShareSubscriptionSourceShareSynchronizationSettings', __args__, opts=opts).value
