...
class SynchronizationSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        synchronization_setting = azurerm.datashare.v20181101preview.SynchronizationSetting("synchronizationSetting",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datashare/latest:SynchronizationSetting"), pulumi.Alias(type_="azurerm:datashare/v20191101:SynchronizationSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SynchronizationSetting, __self__).__init__(
            'azurerm:datashare/v20181101preview:SynchronizationSetting',
            resource_name,
            __props__,
            opts)
