...
class SynchronizationSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datashare/latest:SynchronizationSetting"), pulumi.Alias(type_="azurerm:datashare/preview:SynchronizationSetting"), pulumi.Alias(type_="azurerm:datashare/v20191101:SynchronizationSetting")])
