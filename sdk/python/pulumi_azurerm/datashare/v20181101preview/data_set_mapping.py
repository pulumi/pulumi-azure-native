...
class DataSetMapping(pulumi.CustomResource):
    def __init__(__self__,
        ...
        data_set_mapping = azurerm.datashare.v20181101preview.DataSetMapping("dataSetMapping",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datashare/latest:DataSetMapping"), pulumi.Alias(type_="azurerm:datashare/v20191101:DataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataSetMapping, __self__).__init__(
            'azurerm:datashare/v20181101preview:DataSetMapping',
            resource_name,
            __props__,
            opts)
