...
class Trigger(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datashare/latest:Trigger"), pulumi.Alias(type_="azurerm:datashare/preview:Trigger"), pulumi.Alias(type_="azurerm:datashare/v20191101:Trigger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Trigger, __self__).__init__(
            'azurerm:datashare/v20181101preview:Trigger',
            resource_name,
            __props__,
            opts)
