...
class ListShareSubscriptionSourceShareSynchronizationSettingsResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> List['outputs.ScheduledSourceSynchronizationSettingResponseResult']:
        """
...
def list_share_subscription_source_share_synchronization_settings(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datashare/v20181101preview:listShareSubscriptionSourceShareSynchronizationSettings', __args__, opts=opts, typ=ListShareSubscriptionSourceShareSynchronizationSettingsResult).value
