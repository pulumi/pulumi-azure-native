...
def get_synchronization_setting(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datashare/v20181101preview:getSynchronizationSetting', __args__, opts=opts, typ=GetSynchronizationSettingResult).value
