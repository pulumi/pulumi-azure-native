...
def get_app_service_certificate_order(certificate_order_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:certificateregistration/v20180201:getAppServiceCertificateOrder', __args__, opts=opts, typ=GetAppServiceCertificateOrderResult).value
