...
def get_app_service_certificate_order_certificate(certificate_order_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:certificateregistration/latest:getAppServiceCertificateOrderCertificate', __args__, opts=opts, typ=GetAppServiceCertificateOrderCertificateResult).value
