...
class CertificateOrder(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:certificateregistration/latest:CertificateOrder"), pulumi.Alias(type_="azurerm:certificateregistration/preview:CertificateOrder"), pulumi.Alias(type_="azurerm:certificateregistration/v20180201:CertificateOrder"), pulumi.Alias(type_="azurerm:certificateregistration/v20190801:CertificateOrder"), pulumi.Alias(type_="azurerm:certificateregistration/v20200601:CertificateOrder")])
