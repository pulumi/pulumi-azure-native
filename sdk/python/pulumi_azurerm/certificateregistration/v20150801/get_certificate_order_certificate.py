...
def get_certificate_order_certificate(certificate_order_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:certificateregistration/v20150801:getCertificateOrderCertificate', __args__, opts=opts, typ=GetCertificateOrderCertificateResult).value
