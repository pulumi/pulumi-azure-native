...
class AppServiceCertificateOrder(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:certificateregistration/latest:AppServiceCertificateOrder"), pulumi.Alias(type_="azurerm:certificateregistration/v20180201:AppServiceCertificateOrder"), pulumi.Alias(type_="azurerm:certificateregistration/v20190801:AppServiceCertificateOrder"), pulumi.Alias(type_="azurerm:certificateregistration/v20200601:AppServiceCertificateOrder")])
