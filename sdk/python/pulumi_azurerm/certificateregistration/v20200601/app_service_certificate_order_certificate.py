...
class AppServiceCertificateOrderCertificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:certificateregistration/latest:AppServiceCertificateOrderCertificate"), pulumi.Alias(type_="azurerm:certificateregistration/preview:AppServiceCertificateOrderCertificate"), pulumi.Alias(type_="azurerm:certificateregistration/v20150801:AppServiceCertificateOrderCertificate"), pulumi.Alias(type_="azurerm:certificateregistration/v20180201:AppServiceCertificateOrderCertificate"), pulumi.Alias(type_="azurerm:certificateregistration/v20190801:AppServiceCertificateOrderCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AppServiceCertificateOrderCertificate, __self__).__init__(
            'azurerm:certificateregistration/v20200601:AppServiceCertificateOrderCertificate',
            resource_name,
            __props__,
            opts)
