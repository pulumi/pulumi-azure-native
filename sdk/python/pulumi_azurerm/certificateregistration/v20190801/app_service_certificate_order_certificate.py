...
class AppServiceCertificateOrderCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, certificate_order_name=None, key_vault_id=None, key_vault_secret_name=None, kind=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:certificateregistration/v20150801:AppServiceCertificateOrderCertificate"), pulumi.Alias(type_="azurerm:certificateregistration/v20180201:AppServiceCertificateOrderCertificate")])
