...
class AppServiceCertificateOrderCertificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:certificateregistration/latest:AppServiceCertificateOrderCertificate"), pulumi.Alias(type_="azurerm:certificateregistration/v20150801:AppServiceCertificateOrderCertificate"), pulumi.Alias(type_="azurerm:certificateregistration/v20180201:AppServiceCertificateOrderCertificate"), pulumi.Alias(type_="azurerm:certificateregistration/v20200601:AppServiceCertificateOrderCertificate")])
