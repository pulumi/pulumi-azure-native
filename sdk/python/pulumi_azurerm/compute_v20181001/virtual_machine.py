...
class VirtualMachine(pulumi.CustomResource):
    ...
    Describes the properties of a Virtual Machine.
      * `additional_capabilities` (`dict`) - Specifies additional capabilities enabled or disabled on the virtual machine.
      ...
      * `os_profile` (`dict`) - Specifies the operating system settings for the virtual machine.
        ...
        * `windows_configuration` (`dict`) - Specifies Windows operating system settings on the virtual machine.
          ...
          * `enable_automatic_updates` (`bool`) - Indicates whether virtual machine is enabled for automatic Windows updates. Default value is true. <br><br> For virtual machine scale sets, this property can be updated and updates will take effect on OS reprovisioning.
          * `provision_vm_agent` (`bool`) - Indicates whether virtual machine agent should be provisioned on the virtual machine. <br><br> When this property is not specified in the request body, default behavior is to set it to true.  This will ensure that VM Agent is installed on the VM so that extensions can be added to the VM later.
      ...
      * `proximity_placement_group` (`dict`) - Specifies information about the proximity placement group that the virtual machine should be assigned to. <br><br>Minimum api-version: 2018-04-01.
    ...
    """
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, plan=None, properties=None, resource_group_name=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        The **identity** object supports the following:
          ...
          * `user_assigned_identities` (`pulumi.Input[dict]`) - The list of user identities associated with the Virtual Machine. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
        ...
        The **properties** object supports the following:
          ...
          * `additional_capabilities` (`pulumi.Input[dict]`) - Specifies additional capabilities enabled or disabled on the virtual machine.
            * `ultra_ssd_enabled` (`pulumi.Input[bool]`) - The flag that enables or disables a capability to have one or more managed data disks with UltraSSD_LRS storage account type on the VM or VMSS. Managed disks with storage account type UltraSSD_LRS can be added to a virtual machine or virtual machine scale set only if this property is enabled.
          ...
          * `os_profile` (`pulumi.Input[dict]`) - Specifies the operating system settings for the virtual machine.
            ...
            * `windows_configuration` (`pulumi.Input[dict]`) - Specifies Windows operating system settings on the virtual machine.
              ...
              * `enable_automatic_updates` (`pulumi.Input[bool]`) - Indicates whether virtual machine is enabled for automatic Windows updates. Default value is true. <br><br> For virtual machine scale sets, this property can be updated and updates will take effect on OS reprovisioning.
              * `provision_vm_agent` (`pulumi.Input[bool]`) - Indicates whether virtual machine agent should be provisioned on the virtual machine. <br><br> When this property is not specified in the request body, default behavior is to set it to true.  This will ensure that VM Agent is installed on the VM so that extensions can be added to the VM later.
          ...
          * `proximity_placement_group` (`pulumi.Input[dict]`) - Specifies information about the proximity placement group that the virtual machine should be assigned to. <br><br>Minimum api-version: 2018-04-01.
        ...
        super(VirtualMachine, __self__).__init__(
            'azurerm:compute/v20181001:VirtualMachine',
            resource_name,
            __props__,
            opts)
