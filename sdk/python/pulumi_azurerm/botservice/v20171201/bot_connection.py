...
class BotConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        bot_connection = azurerm.botservice.v20171201.BotConnection("botConnection",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:botservice/latest:BotConnection"), pulumi.Alias(type_="azurerm:botservice/v20180712:BotConnection"), pulumi.Alias(type_="azurerm:botservice/v20200602:BotConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BotConnection, __self__).__init__(
            'azurerm:botservice/v20171201:BotConnection',
            resource_name,
            __props__,
            opts)
