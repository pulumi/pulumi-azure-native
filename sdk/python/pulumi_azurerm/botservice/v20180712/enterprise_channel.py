...
class EnterpriseChannel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        enterprise_channel = azurerm.botservice.v20180712.EnterpriseChannel("enterpriseChannel",
            etag="etag1",
            location="West US",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:botservice/latest:EnterpriseChannel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterpriseChannel, __self__).__init__(
            'azurerm:botservice/v20180712:EnterpriseChannel',
            resource_name,
            __props__,
            opts)
