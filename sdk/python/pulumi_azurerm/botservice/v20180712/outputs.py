...
class DirectLineSiteResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param List[str] trusted_origins: List of Trusted Origin URLs for this site. This field is applicable only if isSecureSiteEnabled is True.
        """
...
class EnterpriseChannelPropertiesResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 nodes: List['outputs.EnterpriseChannelNodeResponse'],
                 state: Optional[str] = None):
        """
        The parameters to provide for the Enterprise Channel.
        :param List['EnterpriseChannelNodeResponseArgs'] nodes: The nodes associated with the Enterprise Channel.
    ...
    @property
    @pulumi.getter
    def nodes(self) -> List['outputs.EnterpriseChannelNodeResponse']:
        """
