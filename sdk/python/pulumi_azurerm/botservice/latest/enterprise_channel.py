...
class EnterpriseChannel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:botservice/preview:EnterpriseChannel"), pulumi.Alias(type_="azurerm:botservice/v20180712:EnterpriseChannel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterpriseChannel, __self__).__init__(
            'azurerm:botservice/latest:EnterpriseChannel',
            resource_name,
            __props__,
            opts)
