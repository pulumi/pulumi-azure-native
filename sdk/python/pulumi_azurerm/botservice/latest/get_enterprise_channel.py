...
__all__ = [
    'GetEnterpriseChannelResult',
    'AwaitableGetEnterpriseChannelResult',
...
class AwaitableGetEnterpriseChannelResult(GetEnterpriseChannelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEnterpriseChannelResult(
            etag=self.etag,
            kind=self.kind,
...
def get_enterprise_channel(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:botservice/latest:getEnterpriseChannel', __args__, opts=opts, typ=GetEnterpriseChannelResult).value

    return AwaitableGetEnterpriseChannelResult(
        etag=__ret__.etag,
        kind=__ret__.kind,
