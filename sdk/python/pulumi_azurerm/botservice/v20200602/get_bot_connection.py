...
def get_bot_connection(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:botservice/v20200602:getBotConnection', __args__, opts=opts, typ=GetBotConnectionResult).value
