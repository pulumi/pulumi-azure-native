...
def list_bot_connection_with_secrets(name=None, resource_group_name=None, resource_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:botservice/v20200602:listBotConnectionWithSecrets', __args__, opts=opts).value
