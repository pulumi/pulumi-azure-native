...
class BotConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:botservice/latest:BotConnection"), pulumi.Alias(type_="azurerm:botservice/v20171201:BotConnection"), pulumi.Alias(type_="azurerm:botservice/v20180712:BotConnection")])
