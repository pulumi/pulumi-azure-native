...
class DirectLineSiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] trusted_origins: List of Trusted Origin URLs for this site. This field is applicable only if isSecureSiteEnabled is True.
        """
        pulumi.set(__self__, "is_enabled", is_enabled)
...
class LineChannelPropertiesArgs:
    def __init__(__self__, *,
                 line_registrations: pulumi.Input[List[pulumi.Input['LineRegistrationArgs']]]):
        """
        The parameters to provide for the Line channel.
        :param pulumi.Input[List[pulumi.Input['LineRegistrationArgs']]] line_registrations: The list of line channel registrations
        """
        pulumi.set(__self__, "line_registrations", line_registrations)

    @property
    @pulumi.getter(name="lineRegistrations")
    def line_registrations(self) -> pulumi.Input[List[pulumi.Input['LineRegistrationArgs']]]:
        """
    ...
    def line_registrations(self, value: pulumi.Input[List[pulumi.Input['LineRegistrationArgs']]]):
