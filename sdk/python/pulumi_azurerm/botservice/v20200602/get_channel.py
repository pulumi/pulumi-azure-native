...
def get_channel(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:botservice/v20200602:getChannel', __args__, opts=opts, typ=GetChannelResult).value
