...
class Channel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:botservice/latest:Channel"), pulumi.Alias(type_="azurerm:botservice/preview:Channel"), pulumi.Alias(type_="azurerm:botservice/v20171201:Channel"), pulumi.Alias(type_="azurerm:botservice/v20180712:Channel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Channel, __self__).__init__(
            'azurerm:botservice/v20200602:Channel',
            resource_name,
            __props__,
            opts)
