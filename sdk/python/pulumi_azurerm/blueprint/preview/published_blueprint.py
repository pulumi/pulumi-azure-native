...
class PublishedBlueprint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:blueprint/v20181101preview:PublishedBlueprint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PublishedBlueprint, __self__).__init__(
            'azurerm:blueprint/preview:PublishedBlueprint',
            resource_name,
            __props__,
            opts)
