...
class GetAssignmentResult:
    ...
    """
    def __init__(__self__, blueprint_id=None, description=None, display_name=None, identity=None, location=None, locks=None, name=None, parameters=None, provisioning_state=None, resource_groups=None, scope=None, status=None, type=None):
...
def get_assignment(assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:blueprint/v20181101preview:getAssignment', __args__, opts=opts, typ=GetAssignmentResult).value
