...
class PrivateStoreOffer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:marketplace/latest:PrivateStoreOffer"), pulumi.Alias(type_="azurerm:marketplace/preview:PrivateStoreOffer")])
