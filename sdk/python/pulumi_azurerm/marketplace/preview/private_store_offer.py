...
class PrivateStoreOffer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:marketplace/latest:PrivateStoreOffer"), pulumi.Alias(type_="azurerm:marketplace/v20200101:PrivateStoreOffer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateStoreOffer, __self__).__init__(
            'azurerm:marketplace/preview:PrivateStoreOffer',
            resource_name,
            __props__,
            opts)
