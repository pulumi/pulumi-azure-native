...
def get_web_app_vnet_connection_slot(name=None, resource_group_name=None, slot=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20180201:getWebAppVnetConnectionSlot', __args__, opts=opts).value
