...
def list_cluster_remote_login_information(cluster_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai/v20180301:listClusterRemoteLoginInformation', __args__, opts=opts).value
