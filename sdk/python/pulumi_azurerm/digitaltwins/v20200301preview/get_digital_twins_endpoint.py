...
def get_digital_twins_endpoint(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:digitaltwins/v20200301preview:getDigitalTwinsEndpoint', __args__, opts=opts, typ=GetDigitalTwinsEndpointResult).value
