...
class DigitalTwinsEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:digitaltwins/latest:DigitalTwinsEndpoint"), pulumi.Alias(type_="azurerm:digitaltwins/v20201031:DigitalTwinsEndpoint")])
