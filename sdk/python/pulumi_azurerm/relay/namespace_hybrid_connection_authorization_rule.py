...
class NamespaceHybridConnectionAuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, hybrid_connection_name=None, name=None, namespace_name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(NamespaceHybridConnectionAuthorizationRule, __self__).__init__(
            'azurerm:relay:NamespaceHybridConnectionAuthorizationRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return NamespaceHybridConnectionAuthorizationRule(resource_name, opts=opts, __props__=__props__)
