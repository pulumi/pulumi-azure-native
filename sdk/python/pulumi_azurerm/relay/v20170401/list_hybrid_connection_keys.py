...
def list_hybrid_connection_keys(authorization_rule_name=None, hybrid_connection_name=None, namespace_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:relay/v20170401:listHybridConnectionKeys', __args__, opts=opts).value
