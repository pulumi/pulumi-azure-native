...
class WCFRelayAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        wcf_relay_authorization_rule = azurerm.relay.v20170401.WCFRelayAuthorizationRule("wcfRelayAuthorizationRule",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:relay/latest:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azurerm:relay/v20160701:WCFRelayAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WCFRelayAuthorizationRule, __self__).__init__(
            'azurerm:relay/v20170401:WCFRelayAuthorizationRule',
            resource_name,
            __props__,
            opts)
