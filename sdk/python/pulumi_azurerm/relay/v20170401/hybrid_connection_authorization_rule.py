...
class HybridConnectionAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:relay/latest:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azurerm:relay/preview:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azurerm:relay/v20160701:HybridConnectionAuthorizationRule")])
