...
class Namespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:relay/latest:Namespace"), pulumi.Alias(type_="azurerm:relay/v20160701:Namespace"), pulumi.Alias(type_="azurerm:relay/v20170401:Namespace"), pulumi.Alias(type_="azurerm:relay/v20180101preview:Namespace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Namespace, __self__).__init__(
            'azurerm:relay/preview:Namespace',
            resource_name,
            __props__,
            opts)
