...
class WCFRelay(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:relay/preview:WCFRelay"), pulumi.Alias(type_="azurerm:relay/v20160701:WCFRelay"), pulumi.Alias(type_="azurerm:relay/v20170401:WCFRelay")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WCFRelay, __self__).__init__(
            'azurerm:relay/latest:WCFRelay',
            resource_name,
            __props__,
            opts)
