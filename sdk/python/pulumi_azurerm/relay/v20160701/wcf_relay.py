...
class WCFRelay(pulumi.CustomResource):
    def __init__(__self__,
        ...
        wcf_relay = azurerm.relay.v20160701.WCFRelay("wcfRelay",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:relay/latest:WCFRelay"), pulumi.Alias(type_="azurerm:relay/v20170401:WCFRelay")])
