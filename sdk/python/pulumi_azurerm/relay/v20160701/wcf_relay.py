...
class WCFRelay(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:relay/latest:WCFRelay"), pulumi.Alias(type_="azurerm:relay/preview:WCFRelay"), pulumi.Alias(type_="azurerm:relay/v20170401:WCFRelay")])
