...
class HybridConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        hybrid_connection = azurerm.relay.v20160701.HybridConnection("hybridConnection",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:relay/latest:HybridConnection"), pulumi.Alias(type_="azurerm:relay/v20170401:HybridConnection")])
