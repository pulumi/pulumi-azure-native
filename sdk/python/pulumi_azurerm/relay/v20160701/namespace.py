...
class Namespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        namespace = azurerm.relay.v20160701.Namespace("namespace",
            location="West US",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:relay/latest:Namespace"), pulumi.Alias(type_="azurerm:relay/v20170401:Namespace"), pulumi.Alias(type_="azurerm:relay/v20180101preview:Namespace")])
