...
class ListNamespaceWcfRelayAuthorizationRuleKeysResult:
    """
...
class AwaitableListNamespaceWcfRelayAuthorizationRuleKeysResult(ListNamespaceWcfRelayAuthorizationRuleKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListNamespaceWcfRelayAuthorizationRuleKeysResult(
...
def list_namespace_wcf_relay_authorization_rule_keys(authorization_rule_name=None, namespace_name=None, relay_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:relay:listNamespaceWcfRelayAuthorizationRuleKeys', __args__, opts=opts).value

    return AwaitableListNamespaceWcfRelayAuthorizationRuleKeysResult(
