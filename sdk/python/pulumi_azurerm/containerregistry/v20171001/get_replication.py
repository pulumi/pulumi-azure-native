...
def get_replication(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerregistry/v20171001:getReplication', __args__, opts=opts, typ=GetReplicationResult).value
