...
class Replication(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerregistry/latest:Replication"), pulumi.Alias(type_="azurerm:containerregistry/v20170601preview:Replication"), pulumi.Alias(type_="azurerm:containerregistry/v20190501:Replication"), pulumi.Alias(type_="azurerm:containerregistry/v20191201preview:Replication")])
