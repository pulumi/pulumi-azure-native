...
class Replication(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerregistry/preview:Replication"), pulumi.Alias(type_="azurerm:containerregistry/v20170601preview:Replication"), pulumi.Alias(type_="azurerm:containerregistry/v20171001:Replication"), pulumi.Alias(type_="azurerm:containerregistry/v20190501:Replication"), pulumi.Alias(type_="azurerm:containerregistry/v20191201preview:Replication")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Replication, __self__).__init__(
            'azurerm:containerregistry/latest:Replication',
            resource_name,
            __props__,
            opts)
