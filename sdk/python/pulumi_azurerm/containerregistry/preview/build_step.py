...
class BuildStep(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerregistry/v20180201preview:BuildStep")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildStep, __self__).__init__(
            'azurerm:containerregistry/preview:BuildStep',
            resource_name,
            __props__,
            opts)
