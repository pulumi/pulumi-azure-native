...
def list_build_step_build_arguments(build_task_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerregistry/preview:listBuildStepBuildArguments', __args__, opts=opts, typ=ListBuildStepBuildArgumentsResult).value
