...
class Registry(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerregistry/latest:Registry"), pulumi.Alias(type_="azurerm:containerregistry/preview:Registry"), pulumi.Alias(type_="azurerm:containerregistry/v20160627preview:Registry"), pulumi.Alias(type_="azurerm:containerregistry/v20170301:Registry"), pulumi.Alias(type_="azurerm:containerregistry/v20171001:Registry"), pulumi.Alias(type_="azurerm:containerregistry/v20190501:Registry"), pulumi.Alias(type_="azurerm:containerregistry/v20191201preview:Registry")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Registry, __self__).__init__(
            'azurerm:containerregistry/v20170601preview:Registry',
            resource_name,
            __props__,
            opts)
