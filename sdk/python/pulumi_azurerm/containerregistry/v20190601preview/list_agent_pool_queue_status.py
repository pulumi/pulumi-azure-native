...
def list_agent_pool_queue_status(agent_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerregistry/v20190601preview:listAgentPoolQueueStatus', __args__, opts=opts, typ=ListAgentPoolQueueStatusResult).value
