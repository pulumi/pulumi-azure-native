...
class Task(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerregistry/latest:Task"), pulumi.Alias(type_="azurerm:containerregistry/preview:Task"), pulumi.Alias(type_="azurerm:containerregistry/v20180901:Task"), pulumi.Alias(type_="azurerm:containerregistry/v20190601preview:Task")])
