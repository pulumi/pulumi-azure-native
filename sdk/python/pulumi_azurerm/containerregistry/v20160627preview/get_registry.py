...
class GetRegistryResult:
    ...
    """
    def __init__(__self__, admin_user_enabled=None, creation_date=None, location=None, login_server=None, name=None, storage_account=None, tags=None, type=None):
...
def get_registry(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerregistry/v20160627preview:getRegistry', __args__, opts=opts, typ=GetRegistryResult).value
