...
def list_lab_vhds(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devtestlab/v20180915:listLabVhds', __args__, opts=opts).value
