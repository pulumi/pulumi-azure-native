...
class VirtualMachineSchedule(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, lab_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, virtual_machine_name=None, __props__=None, __name__=None, __opts__=None):
        """
        A schedule.
