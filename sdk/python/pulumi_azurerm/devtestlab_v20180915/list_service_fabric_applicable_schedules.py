...
def list_service_fabric_applicable_schedules(lab_name=None, name=None, resource_group_name=None, user_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devtestlab/v20180915:listServiceFabricApplicableSchedules', __args__, opts=opts).value
