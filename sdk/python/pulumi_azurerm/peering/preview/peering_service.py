...
class PeeringService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:peering/latest:PeeringService"), pulumi.Alias(type_="azurerm:peering/v20190801preview:PeeringService"), pulumi.Alias(type_="azurerm:peering/v20190901preview:PeeringService"), pulumi.Alias(type_="azurerm:peering/v20200101preview:PeeringService"), pulumi.Alias(type_="azurerm:peering/v20200401:PeeringService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PeeringService, __self__).__init__(
            'azurerm:peering/preview:PeeringService',
            resource_name,
            __props__,
            opts)
