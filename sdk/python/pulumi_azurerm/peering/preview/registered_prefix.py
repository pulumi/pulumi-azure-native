...
class RegisteredPrefix(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:peering/latest:RegisteredPrefix"), pulumi.Alias(type_="azurerm:peering/v20200101preview:RegisteredPrefix"), pulumi.Alias(type_="azurerm:peering/v20200401:RegisteredPrefix")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegisteredPrefix, __self__).__init__(
            'azurerm:peering/preview:RegisteredPrefix',
            resource_name,
            __props__,
            opts)
