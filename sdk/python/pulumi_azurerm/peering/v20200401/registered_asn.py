...
class RegisteredAsn(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:peering/latest:RegisteredAsn"), pulumi.Alias(type_="azurerm:peering/preview:RegisteredAsn"), pulumi.Alias(type_="azurerm:peering/v20200101preview:RegisteredAsn")])
