...
def get_peering(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:peering/v20200401:getPeering', __args__, opts=opts, typ=GetPeeringResult).value
