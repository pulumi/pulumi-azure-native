...
class Peering(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:peering/latest:Peering"), pulumi.Alias(type_="azurerm:peering/v20190801preview:Peering"), pulumi.Alias(type_="azurerm:peering/v20190901preview:Peering"), pulumi.Alias(type_="azurerm:peering/v20200101preview:Peering")])
