...
def get_peering_service_prefix(name=None, peering_service_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:peering:getPeeringServicePrefix', __args__, opts=opts).value
