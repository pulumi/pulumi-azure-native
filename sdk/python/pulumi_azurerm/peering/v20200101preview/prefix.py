...
class Prefix(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:peering/latest:Prefix"), pulumi.Alias(type_="azurerm:peering/v20190801preview:Prefix"), pulumi.Alias(type_="azurerm:peering/v20190901preview:Prefix"), pulumi.Alias(type_="azurerm:peering/v20200401:Prefix")])
