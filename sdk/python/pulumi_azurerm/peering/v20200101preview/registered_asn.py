...
class RegisteredAsn(pulumi.CustomResource):
    def __init__(__self__,
        ...
        registered_asn = azurerm.peering.v20200101preview.RegisteredAsn("registeredAsn",
            asn=65000,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:peering/latest:RegisteredAsn"), pulumi.Alias(type_="azurerm:peering/v20200401:RegisteredAsn")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegisteredAsn, __self__).__init__(
            'azurerm:peering/v20200101preview:RegisteredAsn',
            resource_name,
            __props__,
            opts)
