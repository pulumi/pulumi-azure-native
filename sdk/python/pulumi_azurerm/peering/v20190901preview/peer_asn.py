...
class PeerAsn(pulumi.CustomResource):
    def __init__(__self__,
        ...
        peer_asn = azurerm.peering.v20190901preview.PeerAsn("peerAsn",
            peer_asn=65000,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:peering/latest:PeerAsn"), pulumi.Alias(type_="azurerm:peering/v20190801preview:PeerAsn"), pulumi.Alias(type_="azurerm:peering/v20200101preview:PeerAsn"), pulumi.Alias(type_="azurerm:peering/v20200401:PeerAsn")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PeerAsn, __self__).__init__(
            'azurerm:peering/v20190901preview:PeerAsn',
            resource_name,
            __props__,
            opts)
