...
class DirectConnectionArgs:
    def __init__(__self__, *,
                 ...
                 provisioned_bandwidth_in_mbps: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[float] provisioned_bandwidth_in_mbps: The bandwidth that is actually provisioned.
    ...
    def provisioned_bandwidth_in_mbps(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def provisioned_bandwidth_in_mbps(self, value: Optional[pulumi.Input[float]]):
