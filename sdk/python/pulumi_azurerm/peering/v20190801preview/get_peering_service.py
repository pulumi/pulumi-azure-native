...
class GetPeeringServiceResult:
    ...
    Peering Service
    """
    def __init__(__self__, location=None, name=None, peering_service_location=None, peering_service_provider=None, provisioning_state=None, tags=None, type=None):
...
def get_peering_service(peering_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:peering/v20190801preview:getPeeringService', __args__, opts=opts, typ=GetPeeringServiceResult).value
