...
class PeeringService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:peering/latest:PeeringService"), pulumi.Alias(type_="azurerm:peering/v20190901preview:PeeringService"), pulumi.Alias(type_="azurerm:peering/v20200101preview:PeeringService"), pulumi.Alias(type_="azurerm:peering/v20200401:PeeringService")])
