...
class PeeringRegisteredAsn(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, peering_name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(PeeringRegisteredAsn, __self__).__init__(
            'azurerm:peering:PeeringRegisteredAsn',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `asn` (`pulumi.Input[float]`) - The customer's ASN from which traffic originates.
          * `peering_service_prefix_key` (`pulumi.Input[str]`) - The peering service prefix key that is to be shared with the customer.
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return PeeringRegisteredAsn(resource_name, opts=opts, __props__=__props__)
