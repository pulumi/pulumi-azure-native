...
class PeeringRegisteredPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, peering_name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(PeeringRegisteredPrefix, __self__).__init__(
            'azurerm:peering:PeeringRegisteredPrefix',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `error_message` (`pulumi.Input[str]`) - The error message associated with the validation state, if any.
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return PeeringRegisteredPrefix(resource_name, opts=opts, __props__=__props__)
