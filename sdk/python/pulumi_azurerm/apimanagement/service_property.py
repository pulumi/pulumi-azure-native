...
class ServiceProperty(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, properties=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ServiceProperty, __self__).__init__(
            'azurerm:apimanagement:ServiceProperty',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return ServiceProperty(resource_name, opts=opts, __props__=__props__)
