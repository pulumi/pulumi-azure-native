...
class NamedValue(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:NamedValue"), pulumi.Alias(type_="azurerm:apimanagement/preview:NamedValue"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:NamedValue")])
