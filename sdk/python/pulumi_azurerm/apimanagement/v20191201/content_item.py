...
class ContentItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        content_item = azurerm.apimanagement.v20191201.ContentItem("contentItem",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ContentItem")])
