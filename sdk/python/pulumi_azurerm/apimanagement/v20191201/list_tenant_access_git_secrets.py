...
def list_tenant_access_git_secrets(access_name=None, resource_group_name=None, service_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/v20191201:listTenantAccessGitSecrets', __args__, opts=opts).value
