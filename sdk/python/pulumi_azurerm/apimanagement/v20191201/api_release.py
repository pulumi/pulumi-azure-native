...
class ApiRelease(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiRelease"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:ApiRelease"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiRelease"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiRelease")])
