...
class TagByOperation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        tag_by_operation = azurerm.apimanagement.v20191201.TagByOperation("tagByOperation",
