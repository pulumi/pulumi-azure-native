...
class ApiIssueAttachment(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, api_id=None, content=None, content_format=None, issue_id=None, name=None, resource_group_name=None, service_name=None, title=None, __props__=None, __name__=None, __opts__=None):
        """
