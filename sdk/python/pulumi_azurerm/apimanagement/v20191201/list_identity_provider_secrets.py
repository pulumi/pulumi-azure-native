...
def list_identity_provider_secrets(identity_provider_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/v20191201:listIdentityProviderSecrets', __args__, opts=opts, typ=ListIdentityProviderSecretsResult).value
