...
class ContentType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ContentType"), pulumi.Alias(type_="azurerm:apimanagement/preview:ContentType")])
