...
class ContentType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        content_type = azurerm.apimanagement.v20191201.ContentType("contentType",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ContentType")])
