...
def get_tag_by_operation(api_id=None, name=None, operation_id=None, resource_group_name=None, service_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/v20191201:getTagByOperation', __args__, opts=opts).value
