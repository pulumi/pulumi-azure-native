...
class ApiIssueComment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        api_issue_comment = azurerm.apimanagement.v20191201.ApiIssueComment("apiIssueComment",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiIssueComment"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:ApiIssueComment"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiIssueComment"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:ApiIssueComment"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiIssueComment"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:ApiIssueComment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiIssueComment, __self__).__init__(
            'azurerm:apimanagement/v20191201:ApiIssueComment',
            resource_name,
            __props__,
            opts)
