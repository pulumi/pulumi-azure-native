...
class ApiIssueComment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        api_issue_comment = azurerm.apimanagement.v20180601preview.ApiIssueComment("apiIssueComment",
