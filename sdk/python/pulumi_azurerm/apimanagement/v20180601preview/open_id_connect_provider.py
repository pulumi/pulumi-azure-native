...
class OpenIdConnectProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        open_id_connect_provider = azurerm.apimanagement.v20180601preview.OpenIdConnectProvider("openIdConnectProvider",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:OpenIdConnectProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20160707:OpenIdConnectProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:OpenIdConnectProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:OpenIdConnectProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:OpenIdConnectProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:OpenIdConnectProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:OpenIdConnectProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:OpenIdConnectProvider")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OpenIdConnectProvider, __self__).__init__(
            'azurerm:apimanagement/v20180601preview:OpenIdConnectProvider',
            resource_name,
            __props__,
            opts)
