...
class ProductPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ProductPolicy"), pulumi.Alias(type_="azurerm:apimanagement/preview:ProductPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:ProductPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ProductPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ProductPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ProductPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:ProductPolicy")])
