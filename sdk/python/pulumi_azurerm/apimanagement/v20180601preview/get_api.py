...
def get_api(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/v20180601preview:getApi', __args__, opts=opts, typ=GetApiResult).value
