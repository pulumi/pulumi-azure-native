...
class AuthorizationServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        authorization_server = azurerm.apimanagement.v20180601preview.AuthorizationServer("authorizationServer",
        ...
        super(AuthorizationServer, __self__).__init__(
            'azurerm:apimanagement/v20180601preview:AuthorizationServer',
            resource_name,
            __props__,
            opts)
