...
class ApiRelease(pulumi.CustomResource):
    def __init__(__self__,
        ...
        api_release = azurerm.apimanagement.v20180601preview.ApiRelease("apiRelease",
