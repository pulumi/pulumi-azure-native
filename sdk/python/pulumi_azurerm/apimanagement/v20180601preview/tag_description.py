...
class TagDescription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        tag_description = azurerm.apimanagement.v20180601preview.TagDescription("tagDescription",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:TagDescription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagDescription, __self__).__init__(
            'azurerm:apimanagement/v20180601preview:TagDescription',
            resource_name,
            __props__,
            opts)
