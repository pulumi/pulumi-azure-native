...
class ServiceApiTag(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_id=None, name=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ServiceApiTag, __self__).__init__(
            'azurerm:apimanagement:ServiceApiTag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return ServiceApiTag(resource_name, opts=opts, __props__=__props__)
