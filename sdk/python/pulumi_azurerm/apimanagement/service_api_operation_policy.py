...
class ServiceApiOperationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_id=None, name=None, operation_id=None, properties=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ServiceApiOperationPolicy, __self__).__init__(
            'azurerm:apimanagement:ServiceApiOperationPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return ServiceApiOperationPolicy(resource_name, opts=opts, __props__=__props__)
