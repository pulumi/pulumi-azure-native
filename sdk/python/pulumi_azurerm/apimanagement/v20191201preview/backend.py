...
class Backend(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:Backend"), pulumi.Alias(type_="azurerm:apimanagement/preview:Backend"), pulumi.Alias(type_="azurerm:apimanagement/v20160707:Backend"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:Backend"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:Backend"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:Backend"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:Backend"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:Backend"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:Backend")])
