...
class User(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:User"), pulumi.Alias(type_="azurerm:apimanagement/preview:User"), pulumi.Alias(type_="azurerm:apimanagement/v20160707:User"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:User"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:User"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:User"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:User"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:User"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:User")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(User, __self__).__init__(
            'azurerm:apimanagement/v20191201preview:User',
            resource_name,
            __props__,
            opts)
