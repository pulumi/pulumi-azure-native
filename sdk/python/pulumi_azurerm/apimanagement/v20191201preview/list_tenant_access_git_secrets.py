...
def list_tenant_access_git_secrets(access_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/v20191201preview:listTenantAccessGitSecrets', __args__, opts=opts, typ=ListTenantAccessGitSecretsResult).value
