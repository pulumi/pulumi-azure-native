...
class ApiVersionSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiVersionSet"), pulumi.Alias(type_="azurerm:apimanagement/preview:ApiVersionSet"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:ApiVersionSet"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiVersionSet"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:ApiVersionSet"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiVersionSet"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiVersionSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiVersionSet, __self__).__init__(
            'azurerm:apimanagement/v20191201preview:ApiVersionSet',
            resource_name,
            __props__,
            opts)
