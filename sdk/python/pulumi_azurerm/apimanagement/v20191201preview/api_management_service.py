...
class ApiManagementService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiManagementService"), pulumi.Alias(type_="azurerm:apimanagement/preview:ApiManagementService"), pulumi.Alias(type_="azurerm:apimanagement/v20160707:ApiManagementService"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:ApiManagementService"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:ApiManagementService"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiManagementService"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:ApiManagementService"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiManagementService"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiManagementService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiManagementService, __self__).__init__(
            'azurerm:apimanagement/v20191201preview:ApiManagementService',
            resource_name,
            __props__,
            opts)
