...
def get_api_operation_policy(api_id=None, format=None, name=None, operation_id=None, resource_group_name=None, service_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement:getApiOperationPolicy', __args__, opts=opts).value
