...
class ContentItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/preview:ContentItem"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ContentItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContentItem, __self__).__init__(
            'azurerm:apimanagement/latest:ContentItem',
            resource_name,
            __props__,
            opts)
