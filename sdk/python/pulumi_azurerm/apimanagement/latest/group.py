...
class Group(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/v20160707:Group"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:Group"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:Group"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:Group"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:Group"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:Group")])
