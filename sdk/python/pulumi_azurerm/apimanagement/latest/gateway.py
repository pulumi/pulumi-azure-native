...
class Gateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/preview:Gateway"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:Gateway"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:Gateway")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Gateway, __self__).__init__(
            'azurerm:apimanagement/latest:Gateway',
            resource_name,
            __props__,
            opts)
