...
class ApiDiagnostic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        api_diagnostic = azurerm.apimanagement.latest.ApiDiagnostic("apiDiagnostic",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/v20170301:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiDiagnostic")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiDiagnostic, __self__).__init__(
            'azurerm:apimanagement/latest:ApiDiagnostic',
            resource_name,
            __props__,
            opts)
