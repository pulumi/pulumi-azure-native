...
class GatewayHostnameConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/preview:GatewayHostnameConfiguration"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:GatewayHostnameConfiguration"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:GatewayHostnameConfiguration")])
