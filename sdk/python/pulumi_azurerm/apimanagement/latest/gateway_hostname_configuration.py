...
class GatewayHostnameConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        gateway_hostname_configuration = azurerm.apimanagement.latest.GatewayHostnameConfiguration("gatewayHostnameConfiguration",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/v20191201:GatewayHostnameConfiguration"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:GatewayHostnameConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GatewayHostnameConfiguration, __self__).__init__(
            'azurerm:apimanagement/latest:GatewayHostnameConfiguration',
            resource_name,
            __props__,
            opts)
