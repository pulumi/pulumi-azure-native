...
class IdentityProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
            __props__['name'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:IdentityProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20160707:IdentityProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:IdentityProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:IdentityProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:IdentityProvider"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:IdentityProvider")])
