...
class TagByOperation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/v20170301:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:TagByOperation")])
