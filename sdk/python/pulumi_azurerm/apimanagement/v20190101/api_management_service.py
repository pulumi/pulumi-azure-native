...
class ApiManagementService(pulumi.CustomResource):
    ...
    Additional datacenter locations of the API Management service.
      ...
      * `sku` (`dict`) - SKU properties of the API Management service.
        * `capacity` (`float`) - Capacity of the SKU (number of deployed units of the SKU).
    ...
    """
    enable_client_certificate: pulumi.Output[bool]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, additional_locations=None, certificates=None, custom_properties=None, enable_client_certificate=None, hostname_configurations=None, identity=None, location=None, name=None, notification_sender_email=None, publisher_email=None, publisher_name=None, resource_group_name=None, sku=None, tags=None, virtual_network_configuration=None, virtual_network_type=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        The **additional_locations** object supports the following:
          ...
          * `sku` (`pulumi.Input[dict]`) - SKU properties of the API Management service.
            * `capacity` (`pulumi.Input[float]`) - Capacity of the SKU (number of deployed units of the SKU).
