...
class Diagnostic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        diagnostic = azurerm.apimanagement.v20190101.Diagnostic("diagnostic",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:Diagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:Diagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:Diagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:Diagnostic")])
