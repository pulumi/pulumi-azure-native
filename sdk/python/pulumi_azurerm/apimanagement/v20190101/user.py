...
class User(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, app_type=None, confirmation=None, email=None, first_name=None, identities=None, last_name=None, name=None, note=None, notify=None, password=None, resource_group_name=None, service_name=None, state=None, __props__=None, __name__=None, __opts__=None):
        """
        User details.
