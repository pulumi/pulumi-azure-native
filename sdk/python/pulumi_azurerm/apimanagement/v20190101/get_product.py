...
def get_product(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/v20190101:getProduct', __args__, opts=opts, typ=GetProductResult).value
