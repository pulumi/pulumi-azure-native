...
class ApiTagDescription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiTagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:ApiTagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiTagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiTagDescription")])
