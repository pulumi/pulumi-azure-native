...
class ApiDiagnostic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        api_diagnostic = azurerm.apimanagement.v20190101.ApiDiagnostic("apiDiagnostic",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiDiagnostic")])
