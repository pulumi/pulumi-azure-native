...
def get_tag(name=None, resource_group_name=None, service_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/v20190101:getTag', __args__, opts=opts).value
