...
class Cache(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:Cache"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:Cache"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:Cache"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:Cache"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:Cache")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Cache, __self__).__init__(
            'azurerm:apimanagement/preview:Cache',
            resource_name,
            __props__,
            opts)
