...
def list_authorization_server_secrets(authsid: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement/preview:listAuthorizationServerSecrets', __args__, opts=opts, typ=ListAuthorizationServerSecretsResult).value
