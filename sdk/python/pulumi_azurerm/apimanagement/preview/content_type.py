...
class ContentType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ContentType"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ContentType")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContentType, __self__).__init__(
            'azurerm:apimanagement/preview:ContentType',
            resource_name,
            __props__,
            opts)
