...
class NamedValue(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] tags: Optional tags that when provided can be used to filter the NamedValue list.
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:NamedValue"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:NamedValue"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:NamedValue")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NamedValue, __self__).__init__(
            'azurerm:apimanagement/preview:NamedValue',
            resource_name,
            __props__,
            opts)
