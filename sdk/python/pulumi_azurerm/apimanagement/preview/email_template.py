...
class EmailTemplate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:EmailTemplate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EmailTemplate, __self__).__init__(
            'azurerm:apimanagement/preview:EmailTemplate',
            resource_name,
            __props__,
            opts)
