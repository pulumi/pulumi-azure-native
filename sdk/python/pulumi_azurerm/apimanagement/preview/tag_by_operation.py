...
class TagByOperation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:TagByOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagByOperation, __self__).__init__(
            'azurerm:apimanagement/preview:TagByOperation',
            resource_name,
            __props__,
            opts)
