...
class ListServiceGatewayKeysResult:
    """
...
class AwaitableListServiceGatewayKeysResult(ListServiceGatewayKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListServiceGatewayKeysResult(
            primary=self.primary,
            secondary=self.secondary)


def list_service_gateway_keys(gateway_id=None, resource_group_name=None, service_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement:listServiceGatewayKeys', __args__, opts=opts).value

    return AwaitableListServiceGatewayKeysResult(
