...
def get_service_gateway(name=None, resource_group_name=None, service_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement:getServiceGateway', __args__, opts=opts).value
