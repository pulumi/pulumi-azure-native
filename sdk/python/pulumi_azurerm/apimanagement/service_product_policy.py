...
class ServiceProductPolicy(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, name=None, product_id=None, properties=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ServiceProductPolicy, __self__).__init__(
            'azurerm:apimanagement:ServiceProductPolicy',
            resource_name,
            __props__,
            opts)
