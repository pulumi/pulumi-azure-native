...
class User(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, confirmation=None, email=None, first_name=None, last_name=None, name=None, note=None, password=None, resource_group_name=None, service_name=None, state=None, __props__=None, __name__=None, __opts__=None):
        """
        User details.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/v20160707:User"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:User"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:User")])
