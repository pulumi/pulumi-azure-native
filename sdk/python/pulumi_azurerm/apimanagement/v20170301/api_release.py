...
class ApiRelease(pulumi.CustomResource):
    def __init__(__self__,
        ...
        api_release = azurerm.apimanagement.v20170301.ApiRelease("apiRelease",
            api_id="a1",
            notes="yahooagain",
            release_id="testrev",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiRelease"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiRelease"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiRelease"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiRelease")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiRelease, __self__).__init__(
            'azurerm:apimanagement/v20170301:ApiRelease',
            resource_name,
            __props__,
            opts)
