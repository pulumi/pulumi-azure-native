...
class ProductPolicy(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, name=None, policy_content=None, product_id=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/v20180101:ProductPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ProductPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ProductPolicy")])
