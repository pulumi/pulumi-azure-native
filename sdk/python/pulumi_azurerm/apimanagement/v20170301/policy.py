...
class Policy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:Policy"), pulumi.Alias(type_="azurerm:apimanagement/preview:Policy"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:Policy"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:Policy"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:Policy"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:Policy"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:Policy")])
