...
class LoggerSamplingContractResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_telemetry_items_per_second: Optional[float] = None,
        ...
        :param float max_telemetry_items_per_second: Target rate of telemetry items per second.
    ...
    def max_telemetry_items_per_second(self) -> Optional[float]:
        """
