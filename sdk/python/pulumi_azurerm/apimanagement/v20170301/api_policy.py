...
class ApiPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiPolicy"), pulumi.Alias(type_="azurerm:apimanagement/preview:ApiPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:ApiPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiPolicy"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:ApiPolicy")])
