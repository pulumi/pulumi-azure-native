...
class ApiDiagnostic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiDiagnostic"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:ApiDiagnostic")])
