...
class Subscription(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, display_name=None, name=None, primary_key=None, product_id=None, resource_group_name=None, secondary_key=None, service_name=None, state=None, user_id=None, __props__=None, __name__=None, __opts__=None):
        """
