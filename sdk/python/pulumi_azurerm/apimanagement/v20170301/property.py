...
class Property(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/v20160707:Property"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:Property"), pulumi.Alias(type_="azurerm:apimanagement/v20180101:Property"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:Property")])
