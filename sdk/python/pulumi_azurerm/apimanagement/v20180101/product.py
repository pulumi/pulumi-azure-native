...
class Product(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:Product"), pulumi.Alias(type_="azurerm:apimanagement/preview:Product"), pulumi.Alias(type_="azurerm:apimanagement/v20160707:Product"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:Product"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:Product"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:Product"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:Product"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:Product"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:Product")])
