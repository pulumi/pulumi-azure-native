...
class EmailTemplate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/preview:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:EmailTemplate"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:EmailTemplate")])
