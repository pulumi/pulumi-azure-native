...
class TagDescription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        tag_description = azurerm.apimanagement.v20180101.TagDescription("tagDescription",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:TagDescription"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:TagDescription")])
