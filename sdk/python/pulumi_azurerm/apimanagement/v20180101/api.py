...
class Api(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:Api"), pulumi.Alias(type_="azurerm:apimanagement/preview:Api"), pulumi.Alias(type_="azurerm:apimanagement/v20160707:Api"), pulumi.Alias(type_="azurerm:apimanagement/v20161010:Api"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:Api"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:Api"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:Api"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:Api"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:Api")])
