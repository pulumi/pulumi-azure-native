...
class TagByOperation(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, api_id=None, name=None, operation_id=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/v20170301:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:TagByOperation"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:TagByOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagByOperation, __self__).__init__(
            'azurerm:apimanagement/v20180101:TagByOperation',
            resource_name,
            __props__,
            opts)
