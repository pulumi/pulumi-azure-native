...
class ApiSchema(pulumi.CustomResource):
    def __init__(__self__,
        ...
        api_schema = azurerm.apimanagement.v20180101.ApiSchema("apiSchema",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:apimanagement/latest:ApiSchema"), pulumi.Alias(type_="azurerm:apimanagement/v20170301:ApiSchema"), pulumi.Alias(type_="azurerm:apimanagement/v20180601preview:ApiSchema"), pulumi.Alias(type_="azurerm:apimanagement/v20190101:ApiSchema"), pulumi.Alias(type_="azurerm:apimanagement/v20191201:ApiSchema"), pulumi.Alias(type_="azurerm:apimanagement/v20191201preview:ApiSchema")])
