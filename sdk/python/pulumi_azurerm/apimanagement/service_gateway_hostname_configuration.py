...
class ServiceGatewayHostnameConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, gateway_id=None, name=None, properties=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ServiceGatewayHostnameConfiguration, __self__).__init__(
            'azurerm:apimanagement:ServiceGatewayHostnameConfiguration',
            resource_name,
            __props__,
            opts)
