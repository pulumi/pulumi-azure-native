...
class AwaitableGetServiceProductTagResult(GetServiceProductTagResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceProductTagResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_service_product_tag(name=None, product_id=None, resource_group_name=None, service_name=None, opts=None):
    """
