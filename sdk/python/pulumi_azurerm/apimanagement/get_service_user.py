...
def get_service_user(name=None, resource_group_name=None, service_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:apimanagement:getServiceUser', __args__, opts=opts).value
