...
def get_gallery_application(gallery_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:compute/v20190701:getGalleryApplication', __args__, opts=opts, typ=GetGalleryApplicationResult).value
