...
class VirtualMachineScaleSetVM(pulumi.CustomResource):
    ...
    Resource location
    """
    model_definition_applied: pulumi.Output[str]
    """
    ...
    """
    network_profile_configuration: pulumi.Output[dict]
    """
    ...
    """
    protection_policy: pulumi.Output[dict]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, additional_capabilities=None, availability_set=None, diagnostics_profile=None, hardware_profile=None, license_type=None, location=None, name=None, network_profile=None, network_profile_configuration=None, os_profile=None, plan=None, protection_policy=None, resource_group_name=None, storage_profile=None, tags=None, vm_scale_set_name=None, __props__=None, __name__=None, __opts__=None):
        """
        Describes a virtual machine scale set virtual machine.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[dict] additional_capabilities: Specifies additional capabilities enabled or disabled on the virtual machine in the scale set. For instance: whether the virtual machine has the capability to support attaching managed data disks with UltraSSD_LRS storage account type.
        ...
        :param pulumi.Input[dict] network_profile_configuration: Specifies the network profile configuration of the virtual machine.
        ...
        :param pulumi.Input[dict] protection_policy: Specifies the protection policy of the virtual machine.
        ...
        The **network_profile_configuration** object supports the following:
        ...
        The **protection_policy** object supports the following:
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20150615:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20160330:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20190301:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineScaleSetVM")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineScaleSetVM, __self__).__init__(
            'azurerm:compute/v20190701:VirtualMachineScaleSetVM',
            resource_name,
            __props__,
            opts)
