...
class VirtualMachineScaleSetVMExtension(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachineScaleSetVMExtension"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineScaleSetVMExtension")])
