...
class DedicatedHost(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:DedicatedHost"), pulumi.Alias(type_="azurerm:compute/preview:DedicatedHost"), pulumi.Alias(type_="azurerm:compute/v20190301:DedicatedHost"), pulumi.Alias(type_="azurerm:compute/v20191201:DedicatedHost"), pulumi.Alias(type_="azurerm:compute/v20200601:DedicatedHost")])
