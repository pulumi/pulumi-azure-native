...
class GalleryApplication(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20190301:GalleryApplication"), pulumi.Alias(type_="azurerm:compute/v20191201:GalleryApplication")])
