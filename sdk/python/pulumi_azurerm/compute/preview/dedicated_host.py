...
class DedicatedHost(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:DedicatedHost"), pulumi.Alias(type_="azurerm:compute/v20190301:DedicatedHost"), pulumi.Alias(type_="azurerm:compute/v20190701:DedicatedHost"), pulumi.Alias(type_="azurerm:compute/v20191201:DedicatedHost"), pulumi.Alias(type_="azurerm:compute/v20200601:DedicatedHost")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DedicatedHost, __self__).__init__(
            'azurerm:compute/preview:DedicatedHost',
            resource_name,
            __props__,
            opts)
