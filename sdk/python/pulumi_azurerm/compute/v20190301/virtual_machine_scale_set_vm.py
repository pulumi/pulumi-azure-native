...
class VirtualMachineScaleSetVM(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachineScaleSetVM"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineScaleSetVM")])
