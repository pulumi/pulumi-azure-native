...
class GalleryImageVersion(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:GalleryImageVersion"), pulumi.Alias(type_="azurerm:compute/v20180601:GalleryImageVersion"), pulumi.Alias(type_="azurerm:compute/v20190701:GalleryImageVersion"), pulumi.Alias(type_="azurerm:compute/v20191201:GalleryImageVersion")])
