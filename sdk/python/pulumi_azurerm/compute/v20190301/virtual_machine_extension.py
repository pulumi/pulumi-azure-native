...
class VirtualMachineExtension(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20150615:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20160330:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20160430preview:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachineExtension"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineExtension")])
