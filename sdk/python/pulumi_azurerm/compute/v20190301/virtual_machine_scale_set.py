...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    The virtual machine profile.
      ...
      * `eviction_policy` (`str`) - Specifies the eviction policy for virtual machines in a Azure Spot scale set. <br><br>Minimum api-version: 2017-10-30-preview
    ...
    def __init__(__self__, resource_name, opts=None, additional_capabilities=None, automatic_repairs_policy=None, do_not_run_extensions_on_overprovisioned_v_ms=None, identity=None, location=None, name=None, overprovision=None, plan=None, platform_fault_domain_count=None, proximity_placement_group=None, resource_group_name=None, scale_in_policy=None, single_placement_group=None, sku=None, tags=None, upgrade_policy=None, virtual_machine_profile=None, zone_balance=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **virtual_machine_profile** object supports the following:
          ...
          * `eviction_policy` (`pulumi.Input[str]`) - Specifies the eviction policy for virtual machines in a Azure Spot scale set. <br><br>Minimum api-version: 2017-10-30-preview
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20150615:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20160330:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineScaleSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineScaleSet, __self__).__init__(
            'azurerm:compute/v20190301:VirtualMachineScaleSet',
            resource_name,
            __props__,
            opts)
