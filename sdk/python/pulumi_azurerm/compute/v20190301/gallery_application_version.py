...
class GalleryApplicationVersion(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:GalleryApplicationVersion"), pulumi.Alias(type_="azurerm:compute/preview:GalleryApplicationVersion"), pulumi.Alias(type_="azurerm:compute/v20190701:GalleryApplicationVersion"), pulumi.Alias(type_="azurerm:compute/v20191201:GalleryApplicationVersion")])
