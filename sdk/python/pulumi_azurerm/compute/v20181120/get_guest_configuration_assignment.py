...
def get_guest_configuration_assignment(name=None, resource_group_name=None, vm_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:compute/v20181120:getGuestConfigurationAssignment', __args__, opts=opts).value
