...
class VirtualMachineScaleSetVirtualMachineExtension(pulumi.CustomResource):
    ...
    Resource type
    """
    def __init__(__self__, resource_name, opts=None, instance_id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, vm_scale_set_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(VirtualMachineScaleSetVirtualMachineExtension, __self__).__init__(
            'azurerm:compute:VirtualMachineScaleSetVirtualMachineExtension',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        """
        Get an existing VirtualMachineScaleSetVirtualMachineExtension resource's state with the given name, id, and optional extra
        ...
        return VirtualMachineScaleSetVirtualMachineExtension(resource_name, opts=opts, __props__=__props__)
