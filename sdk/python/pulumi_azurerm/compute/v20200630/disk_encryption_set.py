...
class DiskEncryptionSet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, active_key=None, encryption_type=None, identity=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20190701:DiskEncryptionSet"), pulumi.Alias(type_="azurerm:compute/v20191101:DiskEncryptionSet"), pulumi.Alias(type_="azurerm:compute/v20200501:DiskEncryptionSet")])
