...
class Snapshot(pulumi.CustomResource):
    ...
    Disk source information. CreationData information cannot be changed after the disk has been created.
      ...
      * `logical_sector_size` (`float`) - Logical sector size in bytes for Ultra disks. Supported values are 512 ad 4096. 4096 is the default.
    ...
    def __init__(__self__, resource_name, opts=None, creation_data=None, disk_access_id=None, disk_size_gb=None, disk_state=None, encryption=None, encryption_settings_collection=None, hyper_v_generation=None, incremental=None, location=None, name=None, network_access_policy=None, os_type=None, resource_group_name=None, sku=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **creation_data** object supports the following:
          ...
          * `logical_sector_size` (`pulumi.Input[float]`) - Logical sector size in bytes for Ultra disks. Supported values are 512 ad 4096. 4096 is the default.
