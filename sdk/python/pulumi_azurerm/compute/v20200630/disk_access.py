...
class DiskAccess(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:DiskAccess"), pulumi.Alias(type_="azurerm:compute/preview:DiskAccess"), pulumi.Alias(type_="azurerm:compute/v20200501:DiskAccess")])
