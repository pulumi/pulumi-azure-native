...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, plan=None, properties=None, resource_group_name=None, sku=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(VirtualMachineScaleSet, __self__).__init__(
            'azurerm:compute:VirtualMachineScaleSet',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, identity=None, location=None, name=None, plan=None, properties=None, sku=None, tags=None, type=None, zones=None):
        """
        ...
        The **identity** object supports the following:
          ...
          * `principal_id` (`pulumi.Input[str]`) - The principal id of virtual machine scale set identity. This property will only be provided for a system assigned identity.
          * `tenant_id` (`pulumi.Input[str]`) - The tenant id associated with the virtual machine scale set. This property will only be provided for a system assigned identity.
          * `type` (`pulumi.Input[str]`) - The type of identity used for the virtual machine scale set. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user assigned identities. The type 'None' will remove any identities from the virtual machine scale set.
          * `user_assigned_identities` (`pulumi.Input[dict]`) - The list of user identities associated with the virtual machine scale set. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
        ...
        The **properties** object supports the following:
          ...
          * `single_placement_group` (`pulumi.Input[bool]`) - When true this limits the scale set to a single placement group, of max size 100 virtual machines. NOTE: If singlePlacementGroup is true, it may be modified to false. However, if singlePlacementGroup is false, it may not be modified to true.
          * `unique_id` (`pulumi.Input[str]`) - Specifies the ID which uniquely identifies a Virtual Machine Scale Set.
          * `upgrade_policy` (`pulumi.Input[dict]`) - The upgrade policy.
            * `automatic_os_upgrade_policy` (`pulumi.Input[dict]`) - Configuration parameters used for performing automatic OS Upgrade.
              * `disable_automatic_rollback` (`pulumi.Input[bool]`) - Whether OS image rollback feature should be disabled. Default value is false.
              * `enable_automatic_os_upgrade` (`pulumi.Input[bool]`) - Indicates whether OS upgrades should automatically be applied to scale set instances in a rolling fashion when a newer version of the OS image becomes available. Default value is false. <br><br> If this is set to true for Windows based scale sets, [enableAutomaticUpdates](https://docs.microsoft.com/dotnet/api/microsoft.azure.management.compute.models.windowsconfiguration.enableautomaticupdates?view=azure-dotnet) is automatically set to false and cannot be set to true.
