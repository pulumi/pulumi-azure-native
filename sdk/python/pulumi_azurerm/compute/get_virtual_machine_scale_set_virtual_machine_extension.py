...
class AwaitableGetVirtualMachineScaleSetVirtualMachineExtensionResult(GetVirtualMachineScaleSetVirtualMachineExtensionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualMachineScaleSetVirtualMachineExtensionResult(
...
def get_virtual_machine_scale_set_virtual_machine_extension(instance_id=None, name=None, resource_group_name=None, vm_scale_set_name=None, opts=None):
    """
