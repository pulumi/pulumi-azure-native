...
class GetAvailabilitySetResult:
    ...
    """
    def __init__(__self__, location=None, managed=None, name=None, platform_fault_domain_count=None, platform_update_domain_count=None, sku=None, statuses=None, tags=None, type=None, virtual_machines=None):
...
def get_availability_set(availability_set_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:compute/v20160430preview:getAvailabilitySet', __args__, opts=opts, typ=GetAvailabilitySetResult).value
