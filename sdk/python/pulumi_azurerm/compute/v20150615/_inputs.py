...
class DiskEncryptionSettingsArgs:
    def __init__(__self__, *,
                 disk_encryption_key: pulumi.Input['KeyVaultSecretReferenceArgs'],
                 enabled: Optional[pulumi.Input[bool]] = None,
    ...
    def disk_encryption_key(self) -> pulumi.Input['KeyVaultSecretReferenceArgs']:
        """
    ...
    def disk_encryption_key(self, value: pulumi.Input['KeyVaultSecretReferenceArgs']):
