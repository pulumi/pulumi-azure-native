...
class VirtualMachineScaleSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20160330:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20190301:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineScaleSet")])
