...
class SshPublicKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        ssh_public_key = azurerm.compute.v20200601.SshPublicKey("sshPublicKey",
            location="westus",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:SshPublicKey"), pulumi.Alias(type_="azurerm:compute/v20191201:SshPublicKey")])
