...
def get_virtual_machine_scale_set(name=None, resource_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:compute/v20200601:getVirtualMachineScaleSet', __args__, opts=opts).value
