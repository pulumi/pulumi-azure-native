...
class VirtualMachine(pulumi.CustomResource):
    ...
    Describes the properties of a Virtual Machine.
      ...
      * `billing_profile` (`dict`) - Specifies the billing related details of a Azure Spot virtual machine. <br><br>Minimum api-version: 2019-03-01.
      ...
      * `host` (`dict`) - Specifies information about the dedicated host that the virtual machine resides in. <br><br>Minimum api-version: 2018-10-01.
      * `host_group` (`dict`) - Specifies information about the dedicated host group that the virtual machine resides in. <br><br>Minimum api-version: 2020-06-01. <br><br>NOTE: User cannot specify both host and hostGroup properties.
      * `instance_view` (`dict`) - The virtual machine instance view.
        * `assigned_host` (`str`) - Resource id of the dedicated host, on which the virtual machine is allocated through automatic placement, when the virtual machine is associated with a dedicated host group that has automatic placement enabled. <br><br>Minimum api-version: 2020-06-01.
        * `boot_diagnostics` (`dict`) - Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.
          * `console_screenshot_blob_uri` (`str`) - The console screenshot blob URI. <br><br>NOTE: This will **not** be set if boot diagnostics is currently enabled with managed storage.
          * `serial_console_log_blob_uri` (`str`) - The serial console log blob Uri. <br><br>NOTE: This will **not** be set if boot diagnostics is currently enabled with managed storage.
      ...
      * `os_profile` (`dict`) - Specifies the operating system settings used while creating the virtual machine. Some of the settings cannot be changed once VM is provisioned.
      ...
      * `priority` (`str`) - Specifies the priority for the virtual machine. <br><br>Minimum api-version: 2019-03-01
      ...
      * `security_profile` (`dict`) - Specifies the Security related profile settings for the virtual machine.
      ...
      * `virtual_machine_scale_set` (`dict`) - Specifies information about the virtual machine scale set that the virtual machine should be assigned to. Virtual machines specified in the same virtual machine scale set are allocated to different nodes to maximize availability. Currently, a VM can only be added to virtual machine scale set at creation time. An existing VM cannot be added to a virtual machine scale set. <br><br>This property cannot exist along with a non-null properties.availabilitySet reference. <br><br>Minimum api‐version: 2019‐03‐01
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, plan=None, properties=None, resource_group_name=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `billing_profile` (`pulumi.Input[dict]`) - Specifies the billing related details of a Azure Spot virtual machine. <br><br>Minimum api-version: 2019-03-01.
          ...
          * `host` (`pulumi.Input[dict]`) - Specifies information about the dedicated host that the virtual machine resides in. <br><br>Minimum api-version: 2018-10-01.
          * `host_group` (`pulumi.Input[dict]`) - Specifies information about the dedicated host group that the virtual machine resides in. <br><br>Minimum api-version: 2020-06-01. <br><br>NOTE: User cannot specify both host and hostGroup properties.
          ...
          * `os_profile` (`pulumi.Input[dict]`) - Specifies the operating system settings used while creating the virtual machine. Some of the settings cannot be changed once VM is provisioned.
          ...
          * `priority` (`pulumi.Input[str]`) - Specifies the priority for the virtual machine. <br><br>Minimum api-version: 2019-03-01
          ...
          * `security_profile` (`pulumi.Input[dict]`) - Specifies the Security related profile settings for the virtual machine.
          ...
          * `virtual_machine_scale_set` (`pulumi.Input[dict]`) - Specifies information about the virtual machine scale set that the virtual machine should be assigned to. Virtual machines specified in the same virtual machine scale set are allocated to different nodes to maximize availability. Currently, a VM can only be added to virtual machine scale set at creation time. An existing VM cannot be added to a virtual machine scale set. <br><br>This property cannot exist along with a non-null properties.availabilitySet reference. <br><br>Minimum api‐version: 2019‐03‐01
        """
        ...
        super(VirtualMachine, __self__).__init__(
            'azurerm:compute/v20200601:VirtualMachine',
            resource_name,
            __props__,
            opts)
