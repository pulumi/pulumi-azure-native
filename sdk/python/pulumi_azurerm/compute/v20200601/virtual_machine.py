...
class VirtualMachine(pulumi.CustomResource):
    ...
    """
    extensions_time_budget: pulumi.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, additional_capabilities=None, availability_set=None, billing_profile=None, diagnostics_profile=None, eviction_policy=None, extensions_time_budget=None, hardware_profile=None, host=None, host_group=None, identity=None, license_type=None, location=None, name=None, network_profile=None, os_profile=None, plan=None, priority=None, proximity_placement_group=None, resource_group_name=None, security_profile=None, storage_profile=None, tags=None, virtual_machine_scale_set=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20150615:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20160330:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20190301:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachine")])
