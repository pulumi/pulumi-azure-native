...
class VirtualMachineScaleSetVM(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, additional_capabilities=None, availability_set=None, diagnostics_profile=None, hardware_profile=None, license_type=None, location=None, name=None, network_profile=None, network_profile_configuration=None, os_profile=None, plan=None, protection_policy=None, resource_group_name=None, security_profile=None, storage_profile=None, tags=None, vm_scale_set_name=None, __props__=None, __name__=None, __opts__=None):
        """
