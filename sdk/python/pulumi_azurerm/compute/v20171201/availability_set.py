...
class AvailabilitySet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/preview:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20150615:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20160330:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20160430preview:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20170330:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20180401:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20180601:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20181001:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20190301:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20190701:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20191201:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20200601:AvailabilitySet")])
