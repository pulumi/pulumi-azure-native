...
class GetVirtualMachineScaleSetVMResult:
    ...
    """
    def __init__(__self__, instance_id=None, location=None, name=None, plan=None, properties=None, resources=None, sku=None, tags=None, type=None):
...
def get_virtual_machine_scale_set_vm(name=None, resource_group_name=None, vm_scale_set_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:compute/v20171201:getVirtualMachineScaleSetVM', __args__, opts=opts).value
