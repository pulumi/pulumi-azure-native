...
class VirtualMachine(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, availability_set=None, diagnostics_profile=None, hardware_profile=None, identity=None, license_type=None, location=None, name=None, network_profile=None, os_profile=None, plan=None, resource_group_name=None, storage_profile=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20150615:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20190301:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachine"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachine")])
