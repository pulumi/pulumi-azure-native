...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    Resource name
    """
    over_provision: pulumi.Output[bool]
    """
      ...
      * `network_profile` (`dict`) - The virtual machine scale set network profile.
        * `network_interface_configurations` (`list`) - The list of network configurations.
          ...
          * `ip_configurations` (`list`) - The virtual machine scale set IP Configuration.
            * `application_gateway_backend_address_pools` (`list`) - The application gateway backend address pools.
              * `id` (`str`) - Resource Id
    ...
    """
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, over_provision=None, resource_group_name=None, sku=None, tags=None, upgrade_policy=None, virtual_machine_profile=None, __props__=None, __name__=None, __opts__=None):
        """
          ...
          * `network_profile` (`pulumi.Input[dict]`) - The virtual machine scale set network profile.
            * `network_interface_configurations` (`pulumi.Input[list]`) - The list of network configurations.
              ...
              * `ip_configurations` (`pulumi.Input[list]`) - The virtual machine scale set IP Configuration.
                * `application_gateway_backend_address_pools` (`pulumi.Input[list]`) - The application gateway backend address pools.
                  * `id` (`pulumi.Input[str]`) - Resource Id
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20150615:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20190301:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachineScaleSet"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineScaleSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineScaleSet, __self__).__init__(
            'azurerm:compute/v20160330:VirtualMachineScaleSet',
            resource_name,
            __props__,
            opts)
