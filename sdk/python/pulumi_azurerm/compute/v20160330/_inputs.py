...
class DataDiskArgs:
    ...
    @property
    @pulumi.getter
    def vhd(self) -> pulumi.Input['VirtualHardDiskArgs']:
        """
    ...
    @vhd.setter
    def vhd(self, value: pulumi.Input['VirtualHardDiskArgs']):
...
class VirtualMachineIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: The type of identity used for the virtual machine. Currently, the only supported type is 'SystemAssigned', which implicitly creates an identity.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class VirtualMachineScaleSetIPConfigurationArgs:
    ...
    @property
    @pulumi.getter
    def subnet(self) -> pulumi.Input['ApiEntityReferenceArgs']:
        """
        The subnet.
        """
    ...
    @subnet.setter
    def subnet(self, value: pulumi.Input['ApiEntityReferenceArgs']):
...
class VirtualMachineScaleSetIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: The type of identity used for the virtual machine scale set. Currently, the only supported type is 'SystemAssigned', which implicitly creates an identity.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class VirtualMachineScaleSetStorageProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VirtualMachineScaleSetOSDiskArgs'] os_disk: The OS disk.
        """
        if image_reference is not None:
            pulumi.set(__self__, "image_reference", image_reference)
        if os_disk is not None:
...
class VirtualMachineScaleSetVMProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VirtualMachineScaleSetExtensionProfileArgs'] extension_profile: The virtual machine scale set extension profile.
        :param pulumi.Input['VirtualMachineScaleSetNetworkProfileArgs'] network_profile: The virtual machine scale set network profile.
        :param pulumi.Input['VirtualMachineScaleSetOSProfileArgs'] os_profile: The virtual machine scale set OS profile.
        :param pulumi.Input['VirtualMachineScaleSetStorageProfileArgs'] storage_profile: The virtual machine scale set storage profile.
        """
