...
class DiskAccess(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/preview:DiskAccess"), pulumi.Alias(type_="azurerm:compute/v20200501:DiskAccess"), pulumi.Alias(type_="azurerm:compute/v20200630:DiskAccess")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiskAccess, __self__).__init__(
            'azurerm:compute/latest:DiskAccess',
            resource_name,
            __props__,
            opts)
