...
class ProximityPlacementGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20180401:ProximityPlacementGroup"), pulumi.Alias(type_="azurerm:compute/v20180601:ProximityPlacementGroup"), pulumi.Alias(type_="azurerm:compute/v20181001:ProximityPlacementGroup"), pulumi.Alias(type_="azurerm:compute/v20190301:ProximityPlacementGroup"), pulumi.Alias(type_="azurerm:compute/v20190701:ProximityPlacementGroup"), pulumi.Alias(type_="azurerm:compute/v20191201:ProximityPlacementGroup"), pulumi.Alias(type_="azurerm:compute/v20200601:ProximityPlacementGroup")])
