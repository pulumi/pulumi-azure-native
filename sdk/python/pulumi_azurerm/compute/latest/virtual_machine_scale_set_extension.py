...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20190301:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20191201:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineScaleSetExtension")])
