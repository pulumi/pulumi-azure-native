...
class Disk(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/preview:Disk"), pulumi.Alias(type_="azurerm:compute/v20160430preview:Disk"), pulumi.Alias(type_="azurerm:compute/v20170330:Disk"), pulumi.Alias(type_="azurerm:compute/v20180401:Disk"), pulumi.Alias(type_="azurerm:compute/v20180601:Disk"), pulumi.Alias(type_="azurerm:compute/v20180930:Disk"), pulumi.Alias(type_="azurerm:compute/v20190301:Disk"), pulumi.Alias(type_="azurerm:compute/v20190701:Disk"), pulumi.Alias(type_="azurerm:compute/v20191101:Disk"), pulumi.Alias(type_="azurerm:compute/v20200501:Disk"), pulumi.Alias(type_="azurerm:compute/v20200630:Disk")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Disk, __self__).__init__(
            'azurerm:compute/latest:Disk',
            resource_name,
            __props__,
            opts)
