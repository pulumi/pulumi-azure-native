...
class Snapshot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20170330:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20180401:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20180601:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20190301:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20190701:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20191101:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20200501:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20200630:Snapshot")])
