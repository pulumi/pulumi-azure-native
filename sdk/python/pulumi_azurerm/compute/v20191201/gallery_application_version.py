...
class GalleryApplicationVersion(pulumi.CustomResource):
    def __init__(__self__,
        ...
        gallery_application_version = azurerm.compute.v20191201.GalleryApplicationVersion("galleryApplicationVersion",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:GalleryApplicationVersion"), pulumi.Alias(type_="azurerm:compute/v20190301:GalleryApplicationVersion"), pulumi.Alias(type_="azurerm:compute/v20190701:GalleryApplicationVersion"), pulumi.Alias(type_="azurerm:compute/v20200930:GalleryApplicationVersion")])
