...
class GalleryImageVersion(pulumi.CustomResource):
    ...
    Resource type
    """
    def __init__(__self__, resource_name, opts=None, gallery_image_name=None, gallery_name=None, location=None, name=None, publishing_profile=None, resource_group_name=None, storage_profile=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[dict] storage_profile: This is the storage profile of a Gallery Image Version.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20180601:GalleryImageVersion"), pulumi.Alias(type_="azurerm:compute/v20190301:GalleryImageVersion"), pulumi.Alias(type_="azurerm:compute/v20190701:GalleryImageVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GalleryImageVersion, __self__).__init__(
            'azurerm:compute/v20191201:GalleryImageVersion',
            resource_name,
            __props__,
            opts)
