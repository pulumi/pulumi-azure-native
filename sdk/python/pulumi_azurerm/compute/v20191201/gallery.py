...
class Gallery(pulumi.CustomResource):
    def __init__(__self__,
        ...
        gallery = azurerm.compute.v20191201.Gallery("gallery",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:Gallery"), pulumi.Alias(type_="azurerm:compute/v20180601:Gallery"), pulumi.Alias(type_="azurerm:compute/v20190301:Gallery"), pulumi.Alias(type_="azurerm:compute/v20190701:Gallery"), pulumi.Alias(type_="azurerm:compute/v20200930:Gallery")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Gallery, __self__).__init__(
            'azurerm:compute/v20191201:Gallery',
            resource_name,
            __props__,
            opts)
