...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, auto_upgrade_minor_version=None, force_update_tag=None, name=None, protected_settings=None, provision_after_extensions=None, publisher=None, resource_group_name=None, settings=None, type=None, type_handler_version=None, vm_scale_set_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20170330:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20171201:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20180401:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20180601:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20181001:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20190301:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20190701:VirtualMachineScaleSetExtension"), pulumi.Alias(type_="azurerm:compute/v20200601:VirtualMachineScaleSetExtension")])
