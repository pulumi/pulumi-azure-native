...
class DedicatedHostGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:DedicatedHostGroup"), pulumi.Alias(type_="azurerm:compute/preview:DedicatedHostGroup"), pulumi.Alias(type_="azurerm:compute/v20190301:DedicatedHostGroup"), pulumi.Alias(type_="azurerm:compute/v20190701:DedicatedHostGroup"), pulumi.Alias(type_="azurerm:compute/v20200601:DedicatedHostGroup")])
