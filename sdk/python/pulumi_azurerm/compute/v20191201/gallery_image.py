...
class GalleryImage(pulumi.CustomResource):
    ...
    Resource type
    """
    def __init__(__self__, resource_name, opts=None, description=None, disallowed=None, end_of_life_date=None, eula=None, gallery_name=None, hyper_v_generation=None, identifier=None, location=None, name=None, os_state=None, os_type=None, privacy_statement_uri=None, purchase_plan=None, recommended=None, release_note_uri=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20180601:GalleryImage"), pulumi.Alias(type_="azurerm:compute/v20190301:GalleryImage"), pulumi.Alias(type_="azurerm:compute/v20190701:GalleryImage")])
