...
class GalleryImage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:GalleryImage"), pulumi.Alias(type_="azurerm:compute/v20180601:GalleryImage"), pulumi.Alias(type_="azurerm:compute/v20190301:GalleryImage"), pulumi.Alias(type_="azurerm:compute/v20190701:GalleryImage")])
