...
class Image(pulumi.CustomResource):
    def __init__(__self__,
        ...
        image = azurerm.compute.v20191201.Image("image",
            image_name="myImage",
            location="West US",
