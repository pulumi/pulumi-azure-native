...
class VirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, plan=None, properties=None, resource_group_name=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(VirtualMachine, __self__).__init__(
            'azurerm:compute:VirtualMachine',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, identity=None, location=None, name=None, plan=None, properties=None, resources=None, tags=None, type=None, zones=None):
        """
        ...
        The **identity** object supports the following:
          ...
          * `principal_id` (`pulumi.Input[str]`) - The principal id of virtual machine identity. This property will only be provided for a system assigned identity.
          * `tenant_id` (`pulumi.Input[str]`) - The tenant id associated with the virtual machine. This property will only be provided for a system assigned identity.
          * `type` (`pulumi.Input[str]`) - The type of identity used for the virtual machine. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user assigned identities. The type 'None' will remove any identities from the virtual machine.
          * `user_assigned_identities` (`pulumi.Input[dict]`) - The list of user identities associated with the Virtual Machine. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
        ...
        The **properties** object supports the following:
          ...
          * `instance_view` (`pulumi.Input[dict]`) - The virtual machine instance view.
            ...
            * `computer_name` (`pulumi.Input[str]`) - The computer name assigned to the virtual machine.
            * `disks` (`pulumi.Input[list]`) - The virtual machine disk information.
            ...
            * `hyper_v_generation` (`pulumi.Input[str]`) - Specifies the HyperVGeneration Type associated with a resource
            ...
            * `os_name` (`pulumi.Input[str]`) - The Operating System running on the virtual machine.
            * `os_version` (`pulumi.Input[str]`) - The version of Operating System running on the virtual machine.
            * `platform_fault_domain` (`pulumi.Input[float]`) - Specifies the fault domain of the virtual machine.
            * `platform_update_domain` (`pulumi.Input[float]`) - Specifies the update domain of the virtual machine.
          ...
          * `virtual_machine_scale_set` (`pulumi.Input[dict]`) - Specifies information about the virtual machine scale set that the virtual machine should be assigned to. Virtual machines specified in the same virtual machine scale set are allocated to different nodes to maximize availability. Currently, a VM can only be added to virtual machine scale set at creation time. An existing VM cannot be added to a virtual machine scale set. <br><br>This property cannot exist along with a non-null properties.availabilitySet reference. <br><br>Minimum api‐version: 2019‐03‐01
          * `vm_id` (`pulumi.Input[str]`) - Specifies the VM unique ID which is a 128-bits identifier that is encoded and stored in all Azure IaaS VMs SMBIOS and can be read using platform BIOS commands.
