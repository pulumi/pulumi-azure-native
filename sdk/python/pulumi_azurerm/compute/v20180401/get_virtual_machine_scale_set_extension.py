...
def get_virtual_machine_scale_set_extension(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:compute/v20180401:getVirtualMachineScaleSetExtension', __args__, opts=opts, typ=GetVirtualMachineScaleSetExtensionResult).value
