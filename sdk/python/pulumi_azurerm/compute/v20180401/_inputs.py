...
class ImageDataDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] storage_account_type: Specifies the storage account type for the managed disk. Possible values are: Standard_LRS, Premium_LRS, and StandardSSD_LRS.
        """
        pulumi.set(__self__, "lun", lun)
...
class VirtualMachineIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] identity_ids: The list of user identities associated with the Virtual Machine. The user identity references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/identities/{identityName}'.
...
class VirtualMachineScaleSetIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] identity_ids: The list of user identities associated with the virtual machine scale set. The user identity references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/identities/{identityName}'.
...
class VirtualMachineScaleSetOSDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] caching: Specifies the caching requirements. <br><br> Possible values are: <br><br> **None** <br><br> **ReadOnly** <br><br> **ReadWrite** <br><br> Default: **None for Standard storage. ReadOnly for Premium storage**
        :param pulumi.Input[float] disk_size_gb: Specifies the size of the operating system disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. <br><br> This value cannot be larger than 1023 GB
...
class VirtualMachineScaleSetPublicIPAddressConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 ip_tags: Optional[pulumi.Input[List[pulumi.Input['VirtualMachineScaleSetIpTagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[List[pulumi.Input['VirtualMachineScaleSetIpTagArgs']]] ip_tags: The list of IP tags associated with the public IP address.
        """
        pulumi.set(__self__, "name", name)
        if dns_settings is not None:
            pulumi.set(__self__, "dns_settings", dns_settings)
    ...
    def ip_tags(self) -> Optional[pulumi.Input[List[pulumi.Input['VirtualMachineScaleSetIpTagArgs']]]]:
        """
    ...
    @ip_tags.setter
    def ip_tags(self, value: Optional[pulumi.Input[List[pulumi.Input['VirtualMachineScaleSetIpTagArgs']]]]):
