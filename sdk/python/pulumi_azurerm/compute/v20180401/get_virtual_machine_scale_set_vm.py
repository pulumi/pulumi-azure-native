...
class GetVirtualMachineScaleSetVMResult:
    ...
    """
    def __init__(__self__, availability_set=None, diagnostics_profile=None, hardware_profile=None, instance_id=None, instance_view=None, latest_model_applied=None, license_type=None, location=None, name=None, network_profile=None, os_profile=None, plan=None, provisioning_state=None, resources=None, sku=None, storage_profile=None, tags=None, type=None, vm_id=None, zones=None):
...
def get_virtual_machine_scale_set_vm(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:compute/v20180401:getVirtualMachineScaleSetVM', __args__, opts=opts, typ=GetVirtualMachineScaleSetVMResult).value
