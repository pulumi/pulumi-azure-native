...
class VirtualMachineIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param List[str] identity_ids: The list of user identities associated with the Virtual Machine. The user identity references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/identities/{identityName}'.
...
class VirtualMachineScaleSetIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param List[str] identity_ids: The list of user identities associated with the virtual machine scale set. The user identity references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/identities/{identityName}'.
