...
class GalleryApplication(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:GalleryApplication"), pulumi.Alias(type_="azurerm:compute/v20190301:GalleryApplication"), pulumi.Alias(type_="azurerm:compute/v20190701:GalleryApplication"), pulumi.Alias(type_="azurerm:compute/v20191201:GalleryApplication")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GalleryApplication, __self__).__init__(
            'azurerm:compute/v20200930:GalleryApplication',
            resource_name,
            __props__,
            opts)
