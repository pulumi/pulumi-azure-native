...
class AvailabilitySet(pulumi.CustomResource):
    ...
    Sku of the availability set
      * `capacity` (`float`) - Specifies the number of virtual machines in the scale set. NOTE: If the new VM SKU is not supported on the hardware the scale set is currently on, you need to deallocate the VMs in the scale set before you modify the SKU name.
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, platform_fault_domain_count=None, platform_update_domain_count=None, resource_group_name=None, sku=None, tags=None, virtual_machines=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20150615:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20160330:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20171201:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20180401:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20180601:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20181001:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20190301:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20190701:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20191201:AvailabilitySet"), pulumi.Alias(type_="azurerm:compute/v20200601:AvailabilitySet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AvailabilitySet, __self__).__init__(
            'azurerm:compute/v20170330:AvailabilitySet',
            resource_name,
            __props__,
            opts)
