...
class AvailabilitySet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        availability_set = azurerm.compute.v20170330.AvailabilitySet("availabilitySet",
