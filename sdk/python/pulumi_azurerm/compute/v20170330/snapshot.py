...
class Snapshot(pulumi.CustomResource):
    ...
    Resource type
    """
    def __init__(__self__, resource_name, opts=None, creation_data=None, disk_size_gb=None, encryption_settings=None, location=None, name=None, os_type=None, resource_group_name=None, sku=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Snapshot resource.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20180401:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20180601:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20180930:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20190301:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20190701:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20191101:Snapshot"), pulumi.Alias(type_="azurerm:compute/v20200501:Snapshot")])
