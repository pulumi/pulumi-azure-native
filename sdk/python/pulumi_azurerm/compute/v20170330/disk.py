...
class Disk(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/v20180401:Disk"), pulumi.Alias(type_="azurerm:compute/v20180601:Disk"), pulumi.Alias(type_="azurerm:compute/v20180930:Disk"), pulumi.Alias(type_="azurerm:compute/v20190301:Disk"), pulumi.Alias(type_="azurerm:compute/v20190701:Disk"), pulumi.Alias(type_="azurerm:compute/v20191101:Disk"), pulumi.Alias(type_="azurerm:compute/v20200501:Disk"), pulumi.Alias(type_="azurerm:compute/v20200630:Disk")])
