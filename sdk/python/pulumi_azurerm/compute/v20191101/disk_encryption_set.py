...
class DiskEncryptionSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        disk_encryption_set = azurerm.compute.v20191101.DiskEncryptionSet("diskEncryptionSet",
            active_key={
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:compute/latest:DiskEncryptionSet"), pulumi.Alias(type_="azurerm:compute/v20190701:DiskEncryptionSet"), pulumi.Alias(type_="azurerm:compute/v20200501:DiskEncryptionSet"), pulumi.Alias(type_="azurerm:compute/v20200630:DiskEncryptionSet")])
