...
class SqlPoolsV3(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:synapse/preview:SqlPoolsV3"), pulumi.Alias(type_="azurerm:synapse/v20190601preview:SqlPoolsV3")])
