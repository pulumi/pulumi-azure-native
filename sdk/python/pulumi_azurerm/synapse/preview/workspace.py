...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:synapse/v20190601preview:Workspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workspace, __self__).__init__(
            'azurerm:synapse/preview:Workspace',
            resource_name,
            __props__,
            opts)
    ...
    def extra_properties(self) -> pulumi.Output[Mapping[str, Mapping[str, Any]]]:
        """
