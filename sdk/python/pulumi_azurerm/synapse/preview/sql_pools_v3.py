...
class SqlPoolsV3(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:synapse/v20190601preview:SqlPoolsV3"), pulumi.Alias(type_="azurerm:synapse/v20200401preview:SqlPoolsV3")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPoolsV3, __self__).__init__(
            'azurerm:synapse/preview:SqlPoolsV3',
            resource_name,
            __props__,
            opts)
