...
class WorkspaceAadAdmin(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:synapse/preview:WorkspaceAadAdmin")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceAadAdmin, __self__).__init__(
            'azurerm:synapse/v20190601preview:WorkspaceAadAdmin',
            resource_name,
            __props__,
            opts)
