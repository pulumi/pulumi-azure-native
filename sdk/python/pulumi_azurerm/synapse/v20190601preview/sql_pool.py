...
class SqlPool(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:synapse/preview:SqlPool"), pulumi.Alias(type_="azurerm:synapse/v20200401preview:SqlPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPool, __self__).__init__(
            'azurerm:synapse/v20190601preview:SqlPool',
            resource_name,
            __props__,
            opts)
