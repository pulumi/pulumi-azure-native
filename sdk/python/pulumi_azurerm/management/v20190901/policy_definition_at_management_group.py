...
class PolicyDefinitionAtManagementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, management_group_id=None, metadata=None, mode=None, name=None, parameters=None, policy_rule=None, policy_type=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] metadata: The policy definition metadata.  Metadata is an open ended object and is typically a collection of key value pairs.
        ...
        :param pulumi.Input[dict] parameters: The parameter definitions for parameters used in the policy rule. The keys are the parameter names.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/v20161201:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azurerm:management/v20180301:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azurerm:management/v20180501:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azurerm:management/v20190101:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azurerm:management/v20190601:PolicyDefinitionAtManagementGroup")])
