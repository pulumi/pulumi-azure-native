...
class PolicySetDefinitionAtManagementGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        policy_set_definition_at_management_group = azurerm.management.v20190901.PolicySetDefinitionAtManagementGroup("policySetDefinitionAtManagementGroup",
