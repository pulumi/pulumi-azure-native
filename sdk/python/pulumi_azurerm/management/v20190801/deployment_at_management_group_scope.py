...
class DeploymentAtManagementGroupScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/latest:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azurerm:management/preview:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azurerm:management/v20190501:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azurerm:management/v20190510:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azurerm:management/v20190701:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azurerm:management/v20191001:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azurerm:management/v20200601:DeploymentAtManagementGroupScope")])
