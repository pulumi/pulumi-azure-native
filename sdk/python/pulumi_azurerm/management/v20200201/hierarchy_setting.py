...
class HierarchySetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/latest:HierarchySetting"), pulumi.Alias(type_="azurerm:management/v20200501:HierarchySetting")])
