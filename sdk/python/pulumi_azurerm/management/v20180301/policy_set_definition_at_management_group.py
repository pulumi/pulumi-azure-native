...
class PolicySetDefinitionAtManagementGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/v20180501:PolicySetDefinitionAtManagementGroup"), pulumi.Alias(type_="azurerm:management/v20190101:PolicySetDefinitionAtManagementGroup"), pulumi.Alias(type_="azurerm:management/v20190601:PolicySetDefinitionAtManagementGroup"), pulumi.Alias(type_="azurerm:management/v20190901:PolicySetDefinitionAtManagementGroup")])
