...
class HierarchySetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        hierarchy_setting = azurerm.management.v20200501.HierarchySetting("hierarchySetting",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/latest:HierarchySetting"), pulumi.Alias(type_="azurerm:management/v20200201:HierarchySetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HierarchySetting, __self__).__init__(
            'azurerm:management/v20200501:HierarchySetting',
            resource_name,
            __props__,
            opts)
