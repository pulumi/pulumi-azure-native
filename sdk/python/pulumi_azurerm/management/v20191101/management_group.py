...
class ManagementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, details=None, display_name=None, name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/v20200201:ManagementGroup"), pulumi.Alias(type_="azurerm:management/v20200501:ManagementGroup")])
