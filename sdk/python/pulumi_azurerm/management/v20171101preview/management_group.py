...
class ManagementGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/latest:ManagementGroup"), pulumi.Alias(type_="azurerm:management/preview:ManagementGroup"), pulumi.Alias(type_="azurerm:management/v20180101preview:ManagementGroup"), pulumi.Alias(type_="azurerm:management/v20180301preview:ManagementGroup"), pulumi.Alias(type_="azurerm:management/v20191101:ManagementGroup"), pulumi.Alias(type_="azurerm:management/v20200201:ManagementGroup"), pulumi.Alias(type_="azurerm:management/v20200501:ManagementGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagementGroup, __self__).__init__(
            'azurerm:management/v20171101preview:ManagementGroup',
            resource_name,
            __props__,
            opts)
