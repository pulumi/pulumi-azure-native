...
class PolicySetDefinitionAtManagementGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        policy_set_definition_at_management_group = azurerm.management.v20200301.PolicySetDefinitionAtManagementGroup("policySetDefinitionAtManagementGroup",
        ...
        super(PolicySetDefinitionAtManagementGroup, __self__).__init__(
            'azurerm:management/v20200301:PolicySetDefinitionAtManagementGroup',
            resource_name,
            __props__,
            opts)
