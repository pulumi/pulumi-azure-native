...
class ManagementGroupSubscriptionSubscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/latest:ManagementGroupSubscriptionSubscription"), pulumi.Alias(type_="azurerm:management/v20200501:ManagementGroupSubscriptionSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagementGroupSubscriptionSubscription, __self__).__init__(
            'azurerm:management/preview:ManagementGroupSubscriptionSubscription',
            resource_name,
            __props__,
            opts)
