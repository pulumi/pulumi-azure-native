...
class GetManagementGroupDiagnosticSettingResult:
    ...
    @property
    @pulumi.getter
    def logs(self) -> Optional[List['outputs.ManagementGroupLogSettingsResponse']]:
        """
...
def get_management_group_diagnostic_setting(management_group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:management/preview:getManagementGroupDiagnosticSetting', __args__, opts=opts, typ=GetManagementGroupDiagnosticSettingResult).value
