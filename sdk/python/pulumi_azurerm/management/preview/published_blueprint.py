...
class PublishedBlueprint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:management/v20171111preview:PublishedBlueprint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PublishedBlueprint, __self__).__init__(
            'azurerm:management/preview:PublishedBlueprint',
            resource_name,
            __props__,
            opts)
