...
class GetManagementGroupResult:
    ...
    """
    def __init__(__self__, children=None, details=None, display_name=None, name=None, roles=None, tenant_id=None, type=None):
...
def get_management_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:management/v20180101preview:getManagementGroup', __args__, opts=opts, typ=GetManagementGroupResult).value
