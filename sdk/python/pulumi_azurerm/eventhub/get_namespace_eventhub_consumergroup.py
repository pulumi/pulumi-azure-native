...
class AwaitableGetNamespaceEventhubConsumergroupResult(GetNamespaceEventhubConsumergroupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNamespaceEventhubConsumergroupResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_namespace_eventhub_consumergroup(event_hub_name=None, name=None, namespace_name=None, resource_group_name=None, opts=None):
    """
