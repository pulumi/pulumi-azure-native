...
class ListNamespaceEventhubAuthorizationRuleKeysResult:
    """
...
class AwaitableListNamespaceEventhubAuthorizationRuleKeysResult(ListNamespaceEventhubAuthorizationRuleKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListNamespaceEventhubAuthorizationRuleKeysResult(
...
def list_namespace_eventhub_authorization_rule_keys(authorization_rule_name=None, event_hub_name=None, namespace_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:eventhub:listNamespaceEventhubAuthorizationRuleKeys', __args__, opts=opts).value

    return AwaitableListNamespaceEventhubAuthorizationRuleKeysResult(
