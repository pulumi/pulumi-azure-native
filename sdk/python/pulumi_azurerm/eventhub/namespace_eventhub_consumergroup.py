...
class NamespaceEventhubConsumergroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, event_hub_name=None, name=None, namespace_name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(NamespaceEventhubConsumergroup, __self__).__init__(
            'azurerm:eventhub:NamespaceEventhubConsumergroup',
            resource_name,
            __props__,
            opts)
