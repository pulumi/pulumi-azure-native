...
def list_event_hub_keys(authorization_rule_name=None, event_hub_name=None, namespace_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:eventhub/v20170401:listEventHubKeys', __args__, opts=opts).value
