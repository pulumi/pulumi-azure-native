...
class EventHubAuthorizationRule(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, event_hub_name=None, name=None, namespace_name=None, resource_group_name=None, rights=None, __props__=None, __name__=None, __opts__=None):
        """
