...
class ConsumerGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventhub/latest:ConsumerGroup"), pulumi.Alias(type_="azurerm:eventhub/preview:ConsumerGroup"), pulumi.Alias(type_="azurerm:eventhub/v20140901:ConsumerGroup"), pulumi.Alias(type_="azurerm:eventhub/v20150801:ConsumerGroup")])
