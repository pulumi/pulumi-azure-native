...
def get_namespace_virtual_network_rule(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:eventhub/preview:getNamespaceVirtualNetworkRule', __args__, opts=opts, typ=GetNamespaceVirtualNetworkRuleResult).value
