...
class ConsumerGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventhub/latest:ConsumerGroup"), pulumi.Alias(type_="azurerm:eventhub/v20140901:ConsumerGroup"), pulumi.Alias(type_="azurerm:eventhub/v20150801:ConsumerGroup"), pulumi.Alias(type_="azurerm:eventhub/v20170401:ConsumerGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConsumerGroup, __self__).__init__(
            'azurerm:eventhub/preview:ConsumerGroup',
            resource_name,
            __props__,
            opts)
