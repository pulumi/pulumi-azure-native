...
class Namespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventhub/preview:Namespace"), pulumi.Alias(type_="azurerm:eventhub/v20140901:Namespace"), pulumi.Alias(type_="azurerm:eventhub/v20150801:Namespace"), pulumi.Alias(type_="azurerm:eventhub/v20170401:Namespace"), pulumi.Alias(type_="azurerm:eventhub/v20180101preview:Namespace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Namespace, __self__).__init__(
            'azurerm:eventhub/latest:Namespace',
            resource_name,
            __props__,
            opts)
