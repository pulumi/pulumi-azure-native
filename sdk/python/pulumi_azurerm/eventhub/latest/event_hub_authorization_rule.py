...
class EventHubAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventhub/preview:EventHubAuthorizationRule"), pulumi.Alias(type_="azurerm:eventhub/v20140901:EventHubAuthorizationRule"), pulumi.Alias(type_="azurerm:eventhub/v20150801:EventHubAuthorizationRule"), pulumi.Alias(type_="azurerm:eventhub/v20170401:EventHubAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventHubAuthorizationRule, __self__).__init__(
            'azurerm:eventhub/latest:EventHubAuthorizationRule',
            resource_name,
            __props__,
            opts)
