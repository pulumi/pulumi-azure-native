...
class EventHub(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventhub/preview:EventHub"), pulumi.Alias(type_="azurerm:eventhub/v20140901:EventHub"), pulumi.Alias(type_="azurerm:eventhub/v20150801:EventHub"), pulumi.Alias(type_="azurerm:eventhub/v20170401:EventHub")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventHub, __self__).__init__(
            'azurerm:eventhub/latest:EventHub',
            resource_name,
            __props__,
            opts)
