...
class DisasterRecoveryConfig(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['role'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventhub/preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azurerm:eventhub/v20170401:DisasterRecoveryConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DisasterRecoveryConfig, __self__).__init__(
            'azurerm:eventhub/latest:DisasterRecoveryConfig',
            resource_name,
            __props__,
            opts)
