...
class GetWatchlistResult:
    ...
    def watchlist_items(self) -> Optional[List['outputs.WatchlistItemResponse']]:
        """
...
def get_watchlist(operational_insights_resource_provider: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:securityinsights/preview:getWatchlist', __args__, opts=opts, typ=GetWatchlistResult).value
