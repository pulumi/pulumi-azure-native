...
class AlertRuleAction(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:securityinsights/v20190101preview:AlertRuleAction")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AlertRuleAction, __self__).__init__(
            'azurerm:securityinsights/preview:AlertRuleAction',
            resource_name,
            __props__,
            opts)
