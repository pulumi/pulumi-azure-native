...
__all__ = ['CaseRelationRelation']


class CaseRelationRelation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:securityinsights/v20190101preview:CaseRelationRelation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CaseRelationRelation, __self__).__init__(
            'azurerm:securityinsights/preview:CaseRelationRelation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CaseRelationRelation':
        """
        ...
        return CaseRelationRelation(resource_name, opts=opts, __props__=__props__)
