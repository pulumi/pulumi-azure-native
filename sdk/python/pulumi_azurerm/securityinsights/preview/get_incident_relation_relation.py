...
__all__ = [
    'GetIncidentRelationRelationResult',
    'AwaitableGetIncidentRelationRelationResult',
    'get_incident_relation_relation',
]

@pulumi.output_type
class GetIncidentRelationRelationResult:
    """
...
class AwaitableGetIncidentRelationRelationResult(GetIncidentRelationRelationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIncidentRelationRelationResult(
            etag=self.etag,
            name=self.name,
...
def get_incident_relation_relation(incident_id: Optional[str] = None,
                                   operational_insights_resource_provider: Optional[str] = None,
                                   relation_name: Optional[str] = None,
                                   resource_group_name: Optional[str] = None,
                                   workspace_name: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIncidentRelationRelationResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:securityinsights/preview:getIncidentRelationRelation', __args__, opts=opts, typ=GetIncidentRelationRelationResult).value

    return AwaitableGetIncidentRelationRelationResult(
        etag=__ret__.etag,
        name=__ret__.name,
