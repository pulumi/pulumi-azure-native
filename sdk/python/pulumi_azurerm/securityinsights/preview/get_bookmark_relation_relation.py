...
def get_bookmark_relation_relation(bookmark_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:securityinsights/preview:getBookmarkRelationRelation', __args__, opts=opts, typ=GetBookmarkRelationRelationResult).value
