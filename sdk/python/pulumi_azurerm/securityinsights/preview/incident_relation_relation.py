...
__all__ = ['IncidentRelationRelation']


class IncidentRelationRelation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:securityinsights/v20190101preview:IncidentRelationRelation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IncidentRelationRelation, __self__).__init__(
            'azurerm:securityinsights/preview:IncidentRelationRelation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'IncidentRelationRelation':
        """
        ...
        return IncidentRelationRelation(resource_name, opts=opts, __props__=__props__)
