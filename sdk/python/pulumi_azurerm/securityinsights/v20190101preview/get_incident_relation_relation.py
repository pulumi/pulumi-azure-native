...
def get_incident_relation_relation(incident_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:securityinsights/v20190101preview:getIncidentRelationRelation', __args__, opts=opts, typ=GetIncidentRelationRelationResult).value
