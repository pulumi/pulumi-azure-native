...
__all__ = ['BookmarkRelationRelation']


class BookmarkRelationRelation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:securityinsights/preview:BookmarkRelationRelation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BookmarkRelationRelation, __self__).__init__(
            'azurerm:securityinsights/v20190101preview:BookmarkRelationRelation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BookmarkRelationRelation':
        """
        ...
        return BookmarkRelationRelation(resource_name, opts=opts, __props__=__props__)
