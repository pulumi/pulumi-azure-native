...
__all__ = [
    'GetBookmarkRelationRelationResult',
    'AwaitableGetBookmarkRelationRelationResult',
    'get_bookmark_relation_relation',
]

@pulumi.output_type
class GetBookmarkRelationRelationResult:
    """
...
class AwaitableGetBookmarkRelationRelationResult(GetBookmarkRelationRelationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBookmarkRelationRelationResult(
            etag=self.etag,
            name=self.name,
...
def get_bookmark_relation_relation(bookmark_id: Optional[str] = None,
                                   operational_insights_resource_provider: Optional[str] = None,
                                   relation_name: Optional[str] = None,
                                   resource_group_name: Optional[str] = None,
                                   workspace_name: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBookmarkRelationRelationResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:securityinsights/v20190101preview:getBookmarkRelationRelation', __args__, opts=opts, typ=GetBookmarkRelationRelationResult).value

    return AwaitableGetBookmarkRelationRelationResult(
        etag=__ret__.etag,
        name=__ret__.name,
