...
class MaintenanceConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:maintenance/latest:MaintenanceConfiguration"), pulumi.Alias(type_="azurerm:maintenance/v20180601preview:MaintenanceConfiguration"), pulumi.Alias(type_="azurerm:maintenance/v20200401:MaintenanceConfiguration"), pulumi.Alias(type_="azurerm:maintenance/v20200701preview:MaintenanceConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MaintenanceConfiguration, __self__).__init__(
            'azurerm:maintenance/preview:MaintenanceConfiguration',
            resource_name,
            __props__,
            opts)
