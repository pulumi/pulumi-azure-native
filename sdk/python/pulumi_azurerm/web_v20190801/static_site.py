...
class StaticSite(pulumi.CustomResource):
    ...
    Core resource properties
      * `branch` (`str`) - The target branch in the repository.
      * `build_properties` (`dict`) - Build properties to configure on the repository.
      ...
      * `custom_domains` (`list`) - The custom domains associated with this static site.
      * `default_hostname` (`str`) - The default autogenerated hostname for the static site.
      * `repository_token` (`str`) - A user's github repository token. This is used to setup the Github Actions workflow file and API secrets.
      * `repository_url` (`str`) - URL for the repository of the static site.
    """
