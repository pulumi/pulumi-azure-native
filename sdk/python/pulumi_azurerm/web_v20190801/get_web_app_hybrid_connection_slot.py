...
def get_web_app_hybrid_connection_slot(name=None, namespace_name=None, resource_group_name=None, slot=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20190801:getWebAppHybridConnectionSlot', __args__, opts=opts).value
