...
class WebApplicationFirewallPolicy(pulumi.CustomResource):
    ...
    Properties of the web application firewall policy.
      ...
      * `custom_rules` (`list`) - The custom rules inside the policy.
        ...
        * `priority` (`float`) - Priority of the rule. Rules with a lower value will be evaluated before rules with a higher value.
        * `rule_type` (`str`) - The rule type.

      * `http_listeners` (`list`) - A collection of references to application gateway http listeners.
      * `managed_rules` (`dict`) - Describes the managedRules structure.
        * `exclusions` (`list`) - The Exclusions that are applied on the policy.
          * `match_variable` (`str`) - The variable to be excluded.
          * `selector` (`str`) - When matchVariable is a collection, operator used to specify which elements in the collection this exclusion applies to.
          * `selector_match_operator` (`str`) - When matchVariable is a collection, operate on the selector to specify which elements in the collection this exclusion applies to.

        * `managed_rule_sets` (`list`) - The managed rule sets that are associated with the policy.
      ...
      * `path_based_rules` (`list`) - A collection of references to application gateway path rules.
      * `policy_settings` (`dict`) - The PolicySettings for policy.
        * `file_upload_limit_in_mb` (`float`) - Maximum file upload size in Mb for WAF.
        * `max_request_body_size_in_kb` (`float`) - Maximum request body size in Kb for WAF.
    ...
    def __init__(__self__, resource_name, opts=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `custom_rules` (`pulumi.Input[list]`) - The custom rules inside the policy.
            ...
            * `priority` (`pulumi.Input[float]`) - Priority of the rule. Rules with a lower value will be evaluated before rules with a higher value.
            * `rule_type` (`pulumi.Input[str]`) - The rule type.

          * `managed_rules` (`pulumi.Input[dict]`) - Describes the managedRules structure.
            * `exclusions` (`pulumi.Input[list]`) - The Exclusions that are applied on the policy.
            ...
            * `managed_rule_sets` (`pulumi.Input[list]`) - The managed rule sets that are associated with the policy.
          ...
          * `policy_settings` (`pulumi.Input[dict]`) - The PolicySettings for policy.
