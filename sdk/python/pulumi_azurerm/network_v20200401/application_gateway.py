...
class ApplicationGateway(pulumi.CustomResource):
    ...
    Properties of the application gateway.
      ...
      * `force_firewall_policy_association` (`bool`) - If true, associates a firewall policy with an application gateway regardless whether the policy differs from the WAF Config.
