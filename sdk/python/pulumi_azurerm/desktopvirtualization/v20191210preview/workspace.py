...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:desktopvirtualization/latest:Workspace"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20190123preview:Workspace"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20190924preview:Workspace")])
