...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:desktopvirtualization/v20190123preview:Application"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20190924preview:Application")])
