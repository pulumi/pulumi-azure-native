...
class Application(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 icon_index: Optional[pulumi.Input[float]] = None,
        ...
        application = azurerm.desktopvirtualization.v20190924preview.Application("application",
        ...
        :param pulumi.Input[float] icon_index: Index of the icon.
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:desktopvirtualization/v20190123preview:Application"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20191210preview:Application")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Application, __self__).__init__(
            'azurerm:desktopvirtualization/v20190924preview:Application',
            resource_name,
            __props__,
            opts)
    ...
    def icon_index(self) -> pulumi.Output[Optional[float]]:
        """
        Index of the icon.
        """
