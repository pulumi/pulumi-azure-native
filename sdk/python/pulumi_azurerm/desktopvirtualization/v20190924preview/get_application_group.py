...
def get_application_group(application_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:desktopvirtualization/v20190924preview:getApplicationGroup', __args__, opts=opts, typ=GetApplicationGroupResult).value
