...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application = azurerm.desktopvirtualization.v20190123preview.Application("application",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:desktopvirtualization/v20190924preview:Application"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20191210preview:Application")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Application, __self__).__init__(
            'azurerm:desktopvirtualization/v20190123preview:Application',
            resource_name,
            __props__,
            opts)
