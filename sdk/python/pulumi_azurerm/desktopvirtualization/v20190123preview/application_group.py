...
class ApplicationGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application_group = azurerm.desktopvirtualization.v20190123preview.ApplicationGroup("applicationGroup",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:desktopvirtualization/v20190924preview:ApplicationGroup"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20191210preview:ApplicationGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationGroup, __self__).__init__(
            'azurerm:desktopvirtualization/v20190123preview:ApplicationGroup',
            resource_name,
            __props__,
            opts)
