...
class ApplicationGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:desktopvirtualization/preview:ApplicationGroup"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20190924preview:ApplicationGroup"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20191210preview:ApplicationGroup")])
