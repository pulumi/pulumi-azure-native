...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:desktopvirtualization/preview:Workspace"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20190924preview:Workspace"), pulumi.Alias(type_="azurerm:desktopvirtualization/v20191210preview:Workspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workspace, __self__).__init__(
            'azurerm:desktopvirtualization/v20190123preview:Workspace',
            resource_name,
            __props__,
            opts)
