...
class GetChannelResult:
    ...
    """
    def __init__(__self__, channel_functions=None, channel_type=None, credentials=None, name=None, type=None):
...
def get_channel(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:engagementfabric/v20180901preview:getChannel', __args__, opts=opts, typ=GetChannelResult).value
