...
class ListAccountKeysResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> List['outputs.KeyDescriptionResponseResult']:
        """
        Account keys
        """
...
def list_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:engagementfabric/v20180901preview:listAccountKeys', __args__, opts=opts, typ=ListAccountKeysResult).value
