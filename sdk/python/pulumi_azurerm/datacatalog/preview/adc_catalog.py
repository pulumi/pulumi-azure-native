...
class ADCCatalog(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datacatalog/latest:ADCCatalog"), pulumi.Alias(type_="azurerm:datacatalog/v20160330:ADCCatalog")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ADCCatalog, __self__).__init__(
            'azurerm:datacatalog/preview:ADCCatalog',
            resource_name,
            __props__,
            opts)
