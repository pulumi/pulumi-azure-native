...
class SpatialAnchorsAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        spatial_anchors_account = azurerm.mixedreality.v20190228preview.SpatialAnchorsAccount("spatialAnchorsAccount",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:mixedreality/latest:SpatialAnchorsAccount"), pulumi.Alias(type_="azurerm:mixedreality/v20191202preview:SpatialAnchorsAccount"), pulumi.Alias(type_="azurerm:mixedreality/v20200501:SpatialAnchorsAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SpatialAnchorsAccount, __self__).__init__(
            'azurerm:mixedreality/v20190228preview:SpatialAnchorsAccount',
            resource_name,
            __props__,
            opts)
