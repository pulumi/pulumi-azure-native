...
class RemoteRenderingAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        remote_rendering_account = azurerm.mixedreality.v20191202preview.RemoteRenderingAccount("remoteRenderingAccount",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:mixedreality/v20200406preview:RemoteRenderingAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemoteRenderingAccount, __self__).__init__(
            'azurerm:mixedreality/v20191202preview:RemoteRenderingAccount',
            resource_name,
            __props__,
            opts)
