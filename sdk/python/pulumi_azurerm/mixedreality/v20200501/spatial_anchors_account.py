...
class SpatialAnchorsAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:mixedreality/latest:SpatialAnchorsAccount"), pulumi.Alias(type_="azurerm:mixedreality/v20190228preview:SpatialAnchorsAccount"), pulumi.Alias(type_="azurerm:mixedreality/v20191202preview:SpatialAnchorsAccount")])
