...
def list_spatial_anchors_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:mixedreality/latest:listSpatialAnchorsAccountKeys', __args__, opts=opts, typ=ListSpatialAnchorsAccountKeysResult).value
