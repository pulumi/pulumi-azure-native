...
class RemoteRenderingAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:mixedreality/preview:RemoteRenderingAccount"), pulumi.Alias(type_="azurerm:mixedreality/v20191202preview:RemoteRenderingAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemoteRenderingAccount, __self__).__init__(
            'azurerm:mixedreality/v20200406preview:RemoteRenderingAccount',
            resource_name,
            __props__,
            opts)
