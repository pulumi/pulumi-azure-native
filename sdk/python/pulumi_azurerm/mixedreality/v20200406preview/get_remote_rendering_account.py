...
def get_remote_rendering_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:mixedreality/v20200406preview:getRemoteRenderingAccount', __args__, opts=opts, typ=GetRemoteRenderingAccountResult).value
