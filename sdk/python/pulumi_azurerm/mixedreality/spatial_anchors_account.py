...
class SpatialAnchorsAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: Property bag.
        ...
        super(SpatialAnchorsAccount, __self__).__init__(
            'azurerm:mixedreality:SpatialAnchorsAccount',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `account_domain` (`pulumi.Input[str]`) - Correspond domain name of certain Spatial Anchors Account
          * `account_id` (`pulumi.Input[str]`) - unique id of certain account.
        """
