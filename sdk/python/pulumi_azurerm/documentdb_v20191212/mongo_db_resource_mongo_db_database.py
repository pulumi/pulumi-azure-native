...
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: Properties to create and update Azure Cosmos DB MongoDB database.
        ...
        The **properties** object supports the following:
          ...
          * `resource` (`pulumi.Input[dict]`) - The standard JSON format of a MongoDB database
        ...
        super(MongoDBResourceMongoDBDatabase, __self__).__init__(
            'azurerm:documentdb/v20191212:MongoDBResourceMongoDBDatabase',
            resource_name,
            __props__,
            opts)
