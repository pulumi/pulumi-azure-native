...
class CassandraResourceCassandraKeyspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20190801:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20191212:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20200301:CassandraResourceCassandraKeyspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CassandraResourceCassandraKeyspace, __self__).__init__(
            'azurerm:documentdb/v20200401:CassandraResourceCassandraKeyspace',
            resource_name,
            __props__,
            opts)
