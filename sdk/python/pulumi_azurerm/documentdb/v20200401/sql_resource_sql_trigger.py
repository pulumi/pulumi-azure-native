...
class SqlResourceSqlTrigger(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20190801:SqlResourceSqlTrigger"), pulumi.Alias(type_="azurerm:documentdb/v20191212:SqlResourceSqlTrigger"), pulumi.Alias(type_="azurerm:documentdb/v20200301:SqlResourceSqlTrigger")])
