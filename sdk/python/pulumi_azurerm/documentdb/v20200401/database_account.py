...
class DatabaseAccount(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 cors: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CorsPolicyArgs']]]]] = None,
                 ...
                 ip_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['IpAddressOrRangeArgs']]]]] = None,
        ...
        database_account = azurerm.documentdb.v20200401.DatabaseAccount("databaseAccount",
            account_name="ddb1",
            api_properties={
                "serverVersion": "3.2",
            },
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['CorsPolicyArgs']]]] cors: The CORS policy for the Cosmos DB database account.
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['IpAddressOrRangeArgs']]]] ip_rules: List of IpRules.
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20190801:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20191212:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20200301:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20200601preview:DatabaseAccount")])
    ...
    @property
    @pulumi.getter
    def cors(self) -> pulumi.Output[Optional[List['outputs.CorsPolicyResponse']]]:
        """
    ...
    def ip_rules(self) -> pulumi.Output[Optional[List['outputs.IpAddressOrRangeResponse']]]:
        """
        List of IpRules.
        """
