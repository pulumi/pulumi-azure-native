...
def get_mongo_db_resource_mongo_db_collection(account_name=None, database_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20200401:getMongoDBResourceMongoDBCollection', __args__, opts=opts).value
