...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, container_name=None, database_name=None, location=None, name=None, options=None, resource=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] resource: The standard JSON format of a storedProcedure
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20190801:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20191212:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20200301:SqlResourceSqlStoredProcedure")])
