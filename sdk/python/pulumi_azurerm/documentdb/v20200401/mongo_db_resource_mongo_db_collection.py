...
class MongoDBResourceMongoDBCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_db_collection = azurerm.documentdb.v20200401.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection",
            account_name="ddb1",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:MongoDBResourceMongoDBCollection"), pulumi.Alias(type_="azurerm:documentdb/v20190801:MongoDBResourceMongoDBCollection"), pulumi.Alias(type_="azurerm:documentdb/v20191212:MongoDBResourceMongoDBCollection"), pulumi.Alias(type_="azurerm:documentdb/v20200301:MongoDBResourceMongoDBCollection"), pulumi.Alias(type_="azurerm:documentdb/v20200601preview:MongoDBResourceMongoDBCollection")])
