...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: Properties to create and update Azure Cosmos DB Gremlin database.
        ...
        The **properties** object supports the following:
          ...
          * `resource` (`pulumi.Input[dict]`) - The standard JSON format of a Gremlin database
