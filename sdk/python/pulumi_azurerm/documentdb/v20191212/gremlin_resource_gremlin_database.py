...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, location=None, name=None, options=None, resource=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] resource: The standard JSON format of a Gremlin database
        ...
        The **resource** object supports the following:
          ...
          * `id` (`pulumi.Input[str]`) - Name of the Cosmos DB Gremlin database
        """
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20190801:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20200301:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20200401:GremlinResourceGremlinDatabase")])
