...
__all__ = ['CassandraResourceCassandraTable']
...
class CassandraResourceCassandraTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        cassandra_resource_cassandra_table = azurerm.documentdb.v20191212.CassandraResourceCassandraTable("cassandraResourceCassandraTable",
            account_name="ddb1",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:CassandraResourceCassandraTable"), pulumi.Alias(type_="azurerm:documentdb/v20190801:CassandraResourceCassandraTable"), pulumi.Alias(type_="azurerm:documentdb/v20200301:CassandraResourceCassandraTable"), pulumi.Alias(type_="azurerm:documentdb/v20200401:CassandraResourceCassandraTable")])
