...
class SqlResourceSqlUserDefinedFunction(pulumi.CustomResource):
    def __init__(__self__,
        ...
        sql_resource_sql_user_defined_function = azurerm.documentdb.v20191212.SqlResourceSqlUserDefinedFunction("sqlResourceSqlUserDefinedFunction",
            account_name="ddb1",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:SqlResourceSqlUserDefinedFunction"), pulumi.Alias(type_="azurerm:documentdb/v20190801:SqlResourceSqlUserDefinedFunction"), pulumi.Alias(type_="azurerm:documentdb/v20200301:SqlResourceSqlUserDefinedFunction"), pulumi.Alias(type_="azurerm:documentdb/v20200401:SqlResourceSqlUserDefinedFunction"), pulumi.Alias(type_="azurerm:documentdb/v20200601preview:SqlResourceSqlUserDefinedFunction")])
