...
class MongoDBResourceMongoDBCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_db_collection = azurerm.documentdb.v20190801.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection",
            account_name="ddb1",
