...
def get_sql_resource_sql_user_defined_function(account_name=None, container_name=None, database_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    :param str name: Cosmos DB userDefinedFunction name.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20190801:getSqlResourceSqlUserDefinedFunction', __args__, opts=opts).value
