...
class TableResourceTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:TableResourceTable"), pulumi.Alias(type_="azurerm:documentdb/v20191212:TableResourceTable"), pulumi.Alias(type_="azurerm:documentdb/v20200301:TableResourceTable"), pulumi.Alias(type_="azurerm:documentdb/v20200401:TableResourceTable")])
