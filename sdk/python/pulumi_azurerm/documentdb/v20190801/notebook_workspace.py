...
class NotebookWorkspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20191212:NotebookWorkspace"), pulumi.Alias(type_="azurerm:documentdb/v20200301:NotebookWorkspace"), pulumi.Alias(type_="azurerm:documentdb/v20200401:NotebookWorkspace")])
