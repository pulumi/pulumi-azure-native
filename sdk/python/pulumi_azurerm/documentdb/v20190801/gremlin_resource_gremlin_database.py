...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20191212:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20200301:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20200401:GremlinResourceGremlinDatabase")])
