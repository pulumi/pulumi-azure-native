...
class SqlResourceSqlContainer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, database_name=None, location=None, name=None, options=None, resource=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20191212:SqlResourceSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20200301:SqlResourceSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20200401:SqlResourceSqlContainer")])
