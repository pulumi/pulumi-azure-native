...
def get_gremlin_resource_gremlin_graph(account_name=None, database_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20190801:getGremlinResourceGremlinGraph', __args__, opts=opts).value
