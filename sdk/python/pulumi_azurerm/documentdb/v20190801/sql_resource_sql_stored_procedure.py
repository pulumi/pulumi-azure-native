...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/preview:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20191212:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20200301:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20200401:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20200601preview:SqlResourceSqlStoredProcedure")])
