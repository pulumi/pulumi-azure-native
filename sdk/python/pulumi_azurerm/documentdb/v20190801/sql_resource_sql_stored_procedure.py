...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    def __init__(__self__,
        ...
        sql_resource_sql_stored_procedure = azurerm.documentdb.v20190801.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure",
            account_name="ddb1",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20191212:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20200301:SqlResourceSqlStoredProcedure"), pulumi.Alias(type_="azurerm:documentdb/v20200401:SqlResourceSqlStoredProcedure")])
