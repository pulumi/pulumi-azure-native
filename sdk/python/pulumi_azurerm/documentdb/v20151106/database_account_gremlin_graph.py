...
class DatabaseAccountGremlinGraph(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_gremlin_graph = azurerm.documentdb.v20151106.DatabaseAccountGremlinGraph("databaseAccountGremlinGraph",
            account_name="ddb1",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountGremlinGraph")])
