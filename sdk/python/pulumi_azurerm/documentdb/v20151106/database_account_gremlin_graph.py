...
class DatabaseAccountGremlinGraph(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, database_name=None, name=None, options=None, resource=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountGremlinGraph")])
