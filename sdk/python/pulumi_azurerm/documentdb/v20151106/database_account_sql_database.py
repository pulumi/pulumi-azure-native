...
class DatabaseAccountSqlDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_sql_database = azurerm.documentdb.v20151106.DatabaseAccountSqlDatabase("databaseAccountSqlDatabase",
            account_name="ddb1",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountSqlDatabase")])
