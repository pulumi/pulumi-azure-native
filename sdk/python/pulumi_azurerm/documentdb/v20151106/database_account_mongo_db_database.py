...
class DatabaseAccountMongoDBDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azurerm:documentdb/preview:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountMongoDBDatabase")])
