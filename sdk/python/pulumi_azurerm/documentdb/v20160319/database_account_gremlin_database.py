...
class DatabaseAccountGremlinDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_gremlin_database = azurerm.documentdb.v20160319.DatabaseAccountGremlinDatabase("databaseAccountGremlinDatabase",
            account_name="ddb1",
