...
def get_database_account_gremlin_graph(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20160319:getDatabaseAccountGremlinGraph', __args__, opts=opts, typ=GetDatabaseAccountGremlinGraphResult).value
