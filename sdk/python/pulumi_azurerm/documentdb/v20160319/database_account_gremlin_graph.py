...
class DatabaseAccountGremlinGraph(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_gremlin_graph = azurerm.documentdb.v20160319.DatabaseAccountGremlinGraph("databaseAccountGremlinGraph",
            account_name="ddb1",
