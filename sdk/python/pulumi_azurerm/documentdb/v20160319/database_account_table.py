...
class DatabaseAccountTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_table = azurerm.documentdb.v20160319.DatabaseAccountTable("databaseAccountTable",
            account_name="ddb1",
            options={},
            resource={
                "id": "tableName",
