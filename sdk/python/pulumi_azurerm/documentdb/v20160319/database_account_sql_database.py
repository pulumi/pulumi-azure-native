...
class DatabaseAccountSqlDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_sql_database = azurerm.documentdb.v20160319.DatabaseAccountSqlDatabase("databaseAccountSqlDatabase",
            account_name="ddb1",
