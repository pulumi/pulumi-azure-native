...
class DatabaseAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account = azurerm.documentdb.v20160319.DatabaseAccount("databaseAccount",
            account_name="ddb1",
            consistency_policy={
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20190801:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20191212:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20200301:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20200401:DatabaseAccount"), pulumi.Alias(type_="azurerm:documentdb/v20200601preview:DatabaseAccount")])
