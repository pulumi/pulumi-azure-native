...
class DatabaseAccountMongoDBCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_mongo_db_collection = azurerm.documentdb.v20160319.DatabaseAccountMongoDBCollection("databaseAccountMongoDBCollection",
            account_name="ddb1",
