...
class DatabaseAccountCassandraKeyspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_cassandra_keyspace = azurerm.documentdb.v20160319.DatabaseAccountCassandraKeyspace("databaseAccountCassandraKeyspace",
            account_name="ddb1",
