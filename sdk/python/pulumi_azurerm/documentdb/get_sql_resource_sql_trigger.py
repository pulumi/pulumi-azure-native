...
def get_sql_resource_sql_trigger(account_name=None, container_name=None, database_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb:getSqlResourceSqlTrigger', __args__, opts=opts).value
