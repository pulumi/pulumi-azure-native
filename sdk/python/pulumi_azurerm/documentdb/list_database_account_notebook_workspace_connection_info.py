...
class ListDatabaseAccountNotebookWorkspaceConnectionInfoResult:
    """
...
class AwaitableListDatabaseAccountNotebookWorkspaceConnectionInfoResult(ListDatabaseAccountNotebookWorkspaceConnectionInfoResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListDatabaseAccountNotebookWorkspaceConnectionInfoResult(
            auth_token=self.auth_token,
            notebook_server_endpoint=self.notebook_server_endpoint)


def list_database_account_notebook_workspace_connection_info(account_name=None, notebook_workspace_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb:listDatabaseAccountNotebookWorkspaceConnectionInfo', __args__, opts=opts).value

    return AwaitableListDatabaseAccountNotebookWorkspaceConnectionInfoResult(
