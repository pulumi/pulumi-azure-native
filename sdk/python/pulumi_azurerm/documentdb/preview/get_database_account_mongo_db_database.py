...
def get_database_account_mongo_db_database(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/preview:getDatabaseAccountMongoDBDatabase', __args__, opts=opts, typ=GetDatabaseAccountMongoDBDatabaseResult).value
