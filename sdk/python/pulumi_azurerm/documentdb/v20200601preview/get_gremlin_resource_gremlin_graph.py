...
def get_gremlin_resource_gremlin_graph(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20200601preview:getGremlinResourceGremlinGraph', __args__, opts=opts, typ=GetGremlinResourceGremlinGraphResult).value
