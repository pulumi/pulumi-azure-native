...
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_db_database = azurerm.documentdb.v20200601preview.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase",
            account_name="ddb1",
        ...
        super(MongoDBResourceMongoDBDatabase, __self__).__init__(
            'azurerm:documentdb/v20200601preview:MongoDBResourceMongoDBDatabase',
            resource_name,
            __props__,
            opts)
