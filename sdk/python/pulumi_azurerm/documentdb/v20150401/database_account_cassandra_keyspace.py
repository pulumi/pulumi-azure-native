...
class DatabaseAccountCassandraKeyspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/preview:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountCassandraKeyspace")])
