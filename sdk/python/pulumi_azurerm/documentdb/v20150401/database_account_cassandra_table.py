...
class DatabaseAccountCassandraTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_cassandra_table = azurerm.documentdb.v20150401.DatabaseAccountCassandraTable("databaseAccountCassandraTable",
            account_name="ddb1",
