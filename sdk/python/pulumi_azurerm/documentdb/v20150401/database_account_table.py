...
class DatabaseAccountTable(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, options=None, resource=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountTable"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountTable"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountTable"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountTable")])
