...
class DatabaseAccountSqlContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/preview:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountSqlContainer")])
