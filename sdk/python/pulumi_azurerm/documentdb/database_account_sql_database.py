...
class DatabaseAccountSqlDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(DatabaseAccountSqlDatabase, __self__).__init__(
            'azurerm:documentdb:DatabaseAccountSqlDatabase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `resource` (`pulumi.Input[dict]`)
            * `_colls` (`pulumi.Input[str]`) - A system generated property that specified the addressable path of the collections resource.
            * `_etag` (`pulumi.Input[str]`) - A system generated property representing the resource etag required for optimistic concurrency control.
            * `_rid` (`pulumi.Input[str]`) - A system generated property. A unique identifier.
            * `_ts` (`pulumi.Input[dict]`) - A system generated property that denotes the last updated timestamp of the resource.
            * `_users` (`pulumi.Input[str]`) - A system generated property that specifies the addressable path of the users resource.
            * `id` (`pulumi.Input[str]`) - Name of the Cosmos DB SQL database
        """
