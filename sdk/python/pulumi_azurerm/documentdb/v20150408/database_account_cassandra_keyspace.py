...
class DatabaseAccountCassandraKeyspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/preview:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountCassandraKeyspace"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountCassandraKeyspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseAccountCassandraKeyspace, __self__).__init__(
            'azurerm:documentdb/v20150408:DatabaseAccountCassandraKeyspace',
            resource_name,
            __props__,
            opts)
