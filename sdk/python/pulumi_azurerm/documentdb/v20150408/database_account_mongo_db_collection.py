...
class DatabaseAccountMongoDBCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_mongo_db_collection = azurerm.documentdb.v20150408.DatabaseAccountMongoDBCollection("databaseAccountMongoDBCollection",
            account_name="ddb1",
        ...
        super(DatabaseAccountMongoDBCollection, __self__).__init__(
            'azurerm:documentdb/v20150408:DatabaseAccountMongoDBCollection',
            resource_name,
            __props__,
            opts)
