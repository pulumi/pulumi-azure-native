...
class DatabaseAccountSqlContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_sql_container = azurerm.documentdb.v20150408.DatabaseAccountSqlContainer("databaseAccountSqlContainer",
            account_name="ddb1",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountSqlContainer")])
