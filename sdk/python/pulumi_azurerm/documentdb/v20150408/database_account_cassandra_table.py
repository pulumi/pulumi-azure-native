...
class DatabaseAccountCassandraTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_cassandra_table = azurerm.documentdb.v20150408.DatabaseAccountCassandraTable("databaseAccountCassandraTable",
            account_name="ddb1",
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountCassandraTable")])
