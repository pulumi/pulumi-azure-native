...
class DatabaseAccountTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_table = azurerm.documentdb.v20150408.DatabaseAccountTable("databaseAccountTable",
            account_name="ddb1",
            options={},
            resource={
                "id": "tableName",
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountTable"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountTable"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountTable"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountTable"), pulumi.Alias(type_="azurerm:documentdb/v20160331:DatabaseAccountTable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseAccountTable, __self__).__init__(
            'azurerm:documentdb/v20150408:DatabaseAccountTable',
            resource_name,
            __props__,
            opts)
