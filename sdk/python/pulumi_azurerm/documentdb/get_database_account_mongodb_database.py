...
def get_database_account_mongodb_database(account_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb:getDatabaseAccountMongodbDatabase', __args__, opts=opts).value
