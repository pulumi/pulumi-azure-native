...
def get_database_account_sql_container(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/latest:getDatabaseAccountSqlContainer', __args__, opts=opts, typ=GetDatabaseAccountSqlContainerResult).value
