...
def get_database_account_sql_database(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20160331:getDatabaseAccountSqlDatabase', __args__, opts=opts, typ=GetDatabaseAccountSqlDatabaseResult).value
