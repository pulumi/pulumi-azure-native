...
class DatabaseAccountMongoDBCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_mongo_db_collection = azurerm.documentdb.v20160331.DatabaseAccountMongoDBCollection("databaseAccountMongoDBCollection",
            account_name="ddb1",
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountMongoDBCollection"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountMongoDBCollection"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountMongoDBCollection"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountMongoDBCollection"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountMongoDBCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseAccountMongoDBCollection, __self__).__init__(
            'azurerm:documentdb/v20160331:DatabaseAccountMongoDBCollection',
            resource_name,
            __props__,
            opts)
