...
class DatabaseAccountSqlDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_sql_database = azurerm.documentdb.v20160331.DatabaseAccountSqlDatabase("databaseAccountSqlDatabase",
            account_name="ddb1",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountSqlDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseAccountSqlDatabase, __self__).__init__(
            'azurerm:documentdb/v20160331:DatabaseAccountSqlDatabase',
            resource_name,
            __props__,
            opts)
