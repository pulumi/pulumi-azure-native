...
class DatabaseAccountMongoDBDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account_mongo_db_database = azurerm.documentdb.v20160331.DatabaseAccountMongoDBDatabase("databaseAccountMongoDBDatabase",
            account_name="ddb1",
