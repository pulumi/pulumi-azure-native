...
class DatabaseAccountGremlinDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['ts'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/preview:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20150401:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20150408:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20151106:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20160319:DatabaseAccountGremlinDatabase")])
