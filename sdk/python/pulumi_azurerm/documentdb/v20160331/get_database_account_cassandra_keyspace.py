...
def get_database_account_cassandra_keyspace(account_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20160331:getDatabaseAccountCassandraKeyspace', __args__, opts=opts).value
