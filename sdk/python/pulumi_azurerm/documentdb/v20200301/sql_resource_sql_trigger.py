...
class SqlResourceSqlTrigger(pulumi.CustomResource):
    def __init__(__self__,
        ...
        sql_resource_sql_trigger = azurerm.documentdb.v20200301.SqlResourceSqlTrigger("sqlResourceSqlTrigger",
            account_name="ddb1",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:SqlResourceSqlTrigger"), pulumi.Alias(type_="azurerm:documentdb/v20190801:SqlResourceSqlTrigger"), pulumi.Alias(type_="azurerm:documentdb/v20191212:SqlResourceSqlTrigger"), pulumi.Alias(type_="azurerm:documentdb/v20200401:SqlResourceSqlTrigger"), pulumi.Alias(type_="azurerm:documentdb/v20200601preview:SqlResourceSqlTrigger")])
