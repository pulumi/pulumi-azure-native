...
class SqlResourceSqlDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/v20190801:SqlResourceSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20191212:SqlResourceSqlDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20200401:SqlResourceSqlDatabase")])
