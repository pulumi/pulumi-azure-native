...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        gremlin_resource_gremlin_database = azurerm.documentdb.v20200301.GremlinResourceGremlinDatabase("gremlinResourceGremlinDatabase",
            account_name="ddb1",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20190801:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20191212:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azurerm:documentdb/v20200401:GremlinResourceGremlinDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GremlinResourceGremlinDatabase, __self__).__init__(
            'azurerm:documentdb/v20200301:GremlinResourceGremlinDatabase',
            resource_name,
            __props__,
            opts)
