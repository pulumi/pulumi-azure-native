...
class TableResourceTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        table_resource_table = azurerm.documentdb.v20200301.TableResourceTable("tableResourceTable",
            account_name="ddb1",
            location="West US",
            options={},
            resource={
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:documentdb/latest:TableResourceTable"), pulumi.Alias(type_="azurerm:documentdb/v20190801:TableResourceTable"), pulumi.Alias(type_="azurerm:documentdb/v20191212:TableResourceTable"), pulumi.Alias(type_="azurerm:documentdb/v20200401:TableResourceTable"), pulumi.Alias(type_="azurerm:documentdb/v20200601preview:TableResourceTable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TableResourceTable, __self__).__init__(
            'azurerm:documentdb/v20200301:TableResourceTable',
            resource_name,
            __props__,
            opts)
