...
def get_sql_resource_sql_stored_procedure(account_name=None, container_name=None, database_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20200301:getSqlResourceSqlStoredProcedure', __args__, opts=opts).value
