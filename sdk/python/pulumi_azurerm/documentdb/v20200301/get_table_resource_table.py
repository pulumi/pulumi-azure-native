...
def get_table_resource_table(account_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20200301:getTableResourceTable', __args__, opts=opts).value
