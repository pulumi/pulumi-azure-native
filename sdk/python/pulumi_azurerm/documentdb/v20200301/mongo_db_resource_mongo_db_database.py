...
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_db_database = azurerm.documentdb.v20200301.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase",
            account_name="ddb1",
