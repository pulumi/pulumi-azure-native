...
class DatabaseAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database_account = azurerm.documentdb.v20200301.DatabaseAccount("databaseAccount",
            account_name="ddb1",
            consistency_policy={
