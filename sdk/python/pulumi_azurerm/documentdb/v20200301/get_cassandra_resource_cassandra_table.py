...
def get_cassandra_resource_cassandra_table(account_name=None, keyspace_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:documentdb/v20200301:getCassandraResourceCassandraTable', __args__, opts=opts).value
