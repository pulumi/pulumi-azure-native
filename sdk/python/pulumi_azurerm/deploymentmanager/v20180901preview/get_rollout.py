...
class GetRolloutResult:
    ...
    def step_groups(self) -> List['outputs.StepResponse']:
        """
...
def get_rollout(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:deploymentmanager/v20180901preview:getRollout', __args__, opts=opts, typ=GetRolloutResult).value
