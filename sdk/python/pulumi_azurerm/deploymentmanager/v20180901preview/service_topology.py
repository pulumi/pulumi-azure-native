...
class ServiceTopology(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:deploymentmanager/latest:ServiceTopology"), pulumi.Alias(type_="azurerm:deploymentmanager/v20191101preview:ServiceTopology")])
