...
class GetStepResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.StepPropertiesResponse':
        """
...
def get_step(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:deploymentmanager/v20191101preview:getStep', __args__, opts=opts, typ=GetStepResult).value
