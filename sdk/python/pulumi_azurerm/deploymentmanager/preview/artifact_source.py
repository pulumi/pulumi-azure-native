...
class ArtifactSource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:deploymentmanager/v20180901preview:ArtifactSource"), pulumi.Alias(type_="azurerm:deploymentmanager/v20191101preview:ArtifactSource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ArtifactSource, __self__).__init__(
            'azurerm:deploymentmanager/preview:ArtifactSource',
            resource_name,
            __props__,
            opts)
