...
class PrivateCloud(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:avs/latest:PrivateCloud"), pulumi.Alias(type_="azurerm:avs/preview:PrivateCloud"), pulumi.Alias(type_="azurerm:avs/v20200320:PrivateCloud")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateCloud, __self__).__init__(
            'azurerm:avs/v20190809preview:PrivateCloud',
            resource_name,
            __props__,
            opts)
