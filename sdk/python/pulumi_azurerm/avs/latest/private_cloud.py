...
class PrivateCloud(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:avs/v20190809preview:PrivateCloud"), pulumi.Alias(type_="azurerm:avs/v20200320:PrivateCloud")])
