...
class PrivateCloud(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:avs/preview:PrivateCloud"), pulumi.Alias(type_="azurerm:avs/v20190809preview:PrivateCloud"), pulumi.Alias(type_="azurerm:avs/v20200320:PrivateCloud")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateCloud, __self__).__init__(
            'azurerm:avs/latest:PrivateCloud',
            resource_name,
            __props__,
            opts)
