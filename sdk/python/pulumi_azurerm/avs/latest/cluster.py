...
class Cluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:avs/preview:Cluster"), pulumi.Alias(type_="azurerm:avs/v20190809preview:Cluster"), pulumi.Alias(type_="azurerm:avs/v20200320:Cluster")])
