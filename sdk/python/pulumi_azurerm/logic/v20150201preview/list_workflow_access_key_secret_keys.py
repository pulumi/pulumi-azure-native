...
def list_workflow_access_key_secret_keys(access_key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20150201preview:listWorkflowAccessKeySecretKeys', __args__, opts=opts, typ=ListWorkflowAccessKeySecretKeysResult).value
