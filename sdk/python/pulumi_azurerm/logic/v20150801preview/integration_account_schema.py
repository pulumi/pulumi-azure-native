...
class IntegrationAccountSchema(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountSchema"), pulumi.Alias(type_="azurerm:logic/preview:IntegrationAccountSchema"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountSchema"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccountSchema"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountSchema")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountSchema, __self__).__init__(
            'azurerm:logic/v20150801preview:IntegrationAccountSchema',
            resource_name,
            __props__,
            opts)
