...
class IntegrationAccountCertificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountCertificate"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountCertificate"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountCertificate, __self__).__init__(
            'azurerm:logic/v20150801preview:IntegrationAccountCertificate',
            resource_name,
            __props__,
            opts)
