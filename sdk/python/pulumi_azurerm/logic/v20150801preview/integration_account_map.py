...
class IntegrationAccountMap(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountMap")])
