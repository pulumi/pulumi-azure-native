...
class IntegrationAccountMap(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/preview:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountMap, __self__).__init__(
            'azurerm:logic/v20150801preview:IntegrationAccountMap',
            resource_name,
            __props__,
            opts)
