...
class IntegrationAccountPartner(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountPartner"), pulumi.Alias(type_="azurerm:logic/preview:IntegrationAccountPartner"), pulumi.Alias(type_="azurerm:logic/v20150801preview:IntegrationAccountPartner"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountPartner"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountPartner")])
