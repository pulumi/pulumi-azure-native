...
class IntegrationAccountAgreement(pulumi.CustomResource):
    def __init__(__self__,
        ...
        integration_account_agreement = azurerm.logic.v20180701preview.IntegrationAccountAgreement("integrationAccountAgreement",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountAgreement"), pulumi.Alias(type_="azurerm:logic/v20150801preview:IntegrationAccountAgreement"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountAgreement"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountAgreement")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountAgreement, __self__).__init__(
            'azurerm:logic/v20180701preview:IntegrationAccountAgreement',
            resource_name,
            __props__,
            opts)
