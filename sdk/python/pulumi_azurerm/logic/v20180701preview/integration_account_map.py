...
class IntegrationAccountMap(pulumi.CustomResource):
    def __init__(__self__,
        ...
        integration_account_map = azurerm.logic.v20180701preview.IntegrationAccountMap("integrationAccountMap",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20150801preview:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountMap, __self__).__init__(
            'azurerm:logic/v20180701preview:IntegrationAccountMap',
            resource_name,
            __props__,
            opts)
