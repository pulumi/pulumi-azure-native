...
class IntegrationAccountSchema(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountSchema"), pulumi.Alias(type_="azurerm:logic/preview:IntegrationAccountSchema"), pulumi.Alias(type_="azurerm:logic/v20150801preview:IntegrationAccountSchema"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountSchema"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountSchema")])
