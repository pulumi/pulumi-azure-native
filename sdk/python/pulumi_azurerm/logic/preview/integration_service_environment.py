...
class IntegrationServiceEnvironment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationServiceEnvironment"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationServiceEnvironment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationServiceEnvironment, __self__).__init__(
            'azurerm:logic/preview:IntegrationServiceEnvironment',
            resource_name,
            __props__,
            opts)
