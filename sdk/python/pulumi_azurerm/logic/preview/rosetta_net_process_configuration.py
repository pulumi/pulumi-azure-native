...
class RosettaNetProcessConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:RosettaNetProcessConfiguration"), pulumi.Alias(type_="azurerm:logic/v20160601:RosettaNetProcessConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RosettaNetProcessConfiguration, __self__).__init__(
            'azurerm:logic/preview:RosettaNetProcessConfiguration',
            resource_name,
            __props__,
            opts)
