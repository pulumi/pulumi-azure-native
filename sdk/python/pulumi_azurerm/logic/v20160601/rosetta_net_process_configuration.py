...
class RosettaNetProcessConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        rosetta_net_process_configuration = azurerm.logic.v20160601.RosettaNetProcessConfiguration("rosettaNetProcessConfiguration",
            activity_settings={
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:RosettaNetProcessConfiguration")])
