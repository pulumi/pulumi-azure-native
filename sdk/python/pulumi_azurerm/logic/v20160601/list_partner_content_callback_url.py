...
__all__ = [
    'ListPartnerContentCallbackUrlResult',
    'AwaitableListPartnerContentCallbackUrlResult',
    'list_partner_content_callback_url',
]
...
def list_partner_content_callback_url(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20160601:listPartnerContentCallbackUrl', __args__, opts=opts, typ=ListPartnerContentCallbackUrlResult).value
