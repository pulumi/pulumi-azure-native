...
def list_agreement_content_callback_url(agreement_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20160601:listAgreementContentCallbackUrl', __args__, opts=opts, typ=ListAgreementContentCallbackUrlResult).value
