...
class Agreement(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, integration_account_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: The integration account agreement properties.
        :param pulumi.Input[str] resource_group_name: The resource group name.
        :param pulumi.Input[dict] tags: The resource tags.

        The **properties** object supports the following:

          * `agreement_type` (`pulumi.Input[str]`) - The agreement type.
          * `content` (`pulumi.Input[dict]`) - The agreement content.
          ...
          * `guest_identity` (`pulumi.Input[dict]`) - The business identity of the guest partner.
          * `guest_partner` (`pulumi.Input[str]`) - The integration account partner that is set as guest partner for this agreement.
          * `host_identity` (`pulumi.Input[dict]`) - The business identity of the host partner.
          * `host_partner` (`pulumi.Input[str]`) - The integration account partner that is set as host partner for this agreement.
