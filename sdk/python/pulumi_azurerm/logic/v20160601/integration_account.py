...
class IntegrationAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        integration_account = azurerm.logic.v20160601.IntegrationAccount("integrationAccount",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccount"), pulumi.Alias(type_="azurerm:logic/v20150801preview:IntegrationAccount"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccount"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccount")])
