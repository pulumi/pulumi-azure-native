...
def list_integration_account_assembly_content_callback_url(assembly_artifact_name=None, integration_account_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20160601:listIntegrationAccountAssemblyContentCallbackUrl', __args__, opts=opts).value
