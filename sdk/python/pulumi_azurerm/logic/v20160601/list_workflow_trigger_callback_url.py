...
def list_workflow_trigger_callback_url(resource_group_name=None, trigger_name=None, workflow_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20160601:listWorkflowTriggerCallbackUrl', __args__, opts=opts).value
