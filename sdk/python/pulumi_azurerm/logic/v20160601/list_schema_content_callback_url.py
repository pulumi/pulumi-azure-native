...
def list_schema_content_callback_url(integration_account_name=None, key_type=None, not_after=None, resource_group_name=None, schema_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20160601:listSchemaContentCallbackUrl', __args__, opts=opts).value
