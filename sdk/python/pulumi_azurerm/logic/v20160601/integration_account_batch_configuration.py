...
class IntegrationAccountBatchConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        integration_account_batch_configuration = azurerm.logic.v20160601.IntegrationAccountBatchConfiguration("integrationAccountBatchConfiguration",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountBatchConfiguration")])
