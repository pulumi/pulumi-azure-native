...
def list_workflow_version_callback_url(key_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20160601:listWorkflowVersionCallbackUrl', __args__, opts=opts, typ=ListWorkflowVersionCallbackUrlResult).value
