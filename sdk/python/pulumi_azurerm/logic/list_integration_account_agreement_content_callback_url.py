...
def list_integration_account_agreement_content_callback_url(agreement_name=None, integration_account_name=None, key_type=None, not_after=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic:listIntegrationAccountAgreementContentCallbackUrl', __args__, opts=opts).value
