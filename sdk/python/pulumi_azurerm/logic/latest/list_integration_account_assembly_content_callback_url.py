...
def list_integration_account_assembly_content_callback_url(assembly_artifact_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/latest:listIntegrationAccountAssemblyContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAssemblyContentCallbackUrlResult).value
