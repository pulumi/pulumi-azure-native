...
def get_rosetta_net_process_configuration(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/latest:getRosettaNetProcessConfiguration', __args__, opts=opts, typ=GetRosettaNetProcessConfigurationResult).value
