...
class IntegrationAccountAgreement(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/v20150801preview:IntegrationAccountAgreement"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountAgreement"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccountAgreement"), pulumi.Alias(type_="azurerm:logic/v20190501:IntegrationAccountAgreement")])
