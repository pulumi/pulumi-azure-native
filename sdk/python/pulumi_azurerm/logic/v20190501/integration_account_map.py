...
class IntegrationAccountMap(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/preview:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20150801preview:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccountMap")])
