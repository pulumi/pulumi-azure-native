...
class Workflow(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:Workflow"), pulumi.Alias(type_="azurerm:logic/v20150201preview:Workflow"), pulumi.Alias(type_="azurerm:logic/v20160601:Workflow"), pulumi.Alias(type_="azurerm:logic/v20180701preview:Workflow")])
