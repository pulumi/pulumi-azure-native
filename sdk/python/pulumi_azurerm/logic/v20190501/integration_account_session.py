...
class IntegrationAccountSession(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationAccountSession"), pulumi.Alias(type_="azurerm:logic/preview:IntegrationAccountSession"), pulumi.Alias(type_="azurerm:logic/v20160601:IntegrationAccountSession"), pulumi.Alias(type_="azurerm:logic/v20180701preview:IntegrationAccountSession")])
