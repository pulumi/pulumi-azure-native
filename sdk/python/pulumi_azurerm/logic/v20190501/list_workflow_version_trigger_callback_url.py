...
def list_workflow_version_trigger_callback_url(key_type=None, not_after=None, resource_group_name=None, trigger_name=None, version_id=None, workflow_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20190501:listWorkflowVersionTriggerCallbackUrl', __args__, opts=opts).value
