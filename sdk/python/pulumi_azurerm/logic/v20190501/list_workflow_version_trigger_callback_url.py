...
def list_workflow_version_trigger_callback_url(key_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20190501:listWorkflowVersionTriggerCallbackUrl', __args__, opts=opts, typ=ListWorkflowVersionTriggerCallbackUrlResult).value
