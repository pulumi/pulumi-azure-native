...
def list_integration_account_partner_content_callback_url(integration_account_name=None, key_type=None, not_after=None, partner_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20190501:listIntegrationAccountPartnerContentCallbackUrl', __args__, opts=opts).value
