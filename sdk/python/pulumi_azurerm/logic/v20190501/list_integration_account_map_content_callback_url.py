...
def list_integration_account_map_content_callback_url(integration_account_name=None, key_type=None, map_name=None, not_after=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20190501:listIntegrationAccountMapContentCallbackUrl', __args__, opts=opts).value
