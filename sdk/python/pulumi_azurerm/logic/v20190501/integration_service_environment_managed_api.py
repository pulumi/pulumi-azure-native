...
class IntegrationServiceEnvironmentManagedApi(pulumi.CustomResource):
    def __init__(__self__,
        ...
        integration_service_environment_managed_api = azurerm.logic.v20190501.IntegrationServiceEnvironmentManagedApi("integrationServiceEnvironmentManagedApi",
            api_name="servicebus",
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:logic/latest:IntegrationServiceEnvironmentManagedApi")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationServiceEnvironmentManagedApi, __self__).__init__(
            'azurerm:logic/v20190501:IntegrationServiceEnvironmentManagedApi',
            resource_name,
            __props__,
            opts)
