...
class IntegrationAccountAgreement(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, integration_account_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
              ...
              * `receive_agreement` (`pulumi.Input[dict]`) - The AS2 one-way receive agreement.
                * `protocol_settings` (`pulumi.Input[dict]`) - The AS2 protocol settings.
                  * `acknowledgement_connection_settings` (`pulumi.Input[dict]`) - The acknowledgement connection settings.
                    * `ignore_certificate_name_mismatch` (`pulumi.Input[bool]`) - Indicates whether to ignore mismatch in certificate name.
                    * `keep_http_connection_alive` (`pulumi.Input[bool]`) - Indicates whether to keep the connection alive.
                    * `support_http_status_code_continue` (`pulumi.Input[bool]`) - Indicates whether to support HTTP status code 'CONTINUE'.
                    * `unfold_http_headers` (`pulumi.Input[bool]`) - Indicates whether to unfold the HTTP headers.
        ...
        super(IntegrationAccountAgreement, __self__).__init__(
            'azurerm:logic:IntegrationAccountAgreement',
            resource_name,
            __props__,
            opts)
