...
def get_integration_account_schema(integration_account_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic:getIntegrationAccountSchema', __args__, opts=opts).value
