...
def get_global_schedule(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devtestlab/v20160515:getGlobalSchedule', __args__, opts=opts).value
