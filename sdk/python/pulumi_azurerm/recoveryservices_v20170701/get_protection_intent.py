...
def get_protection_intent(fabric_name=None, name=None, resource_group_name=None, vault_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:recoveryservices/v20170701:getProtectionIntent', __args__, opts=opts).value
