...
class VirtualNetworkFunction(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hybridnetwork/v20200101preview:VirtualNetworkFunction")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkFunction, __self__).__init__(
            'azurerm:hybridnetwork/preview:VirtualNetworkFunction',
            resource_name,
            __props__,
            opts)
