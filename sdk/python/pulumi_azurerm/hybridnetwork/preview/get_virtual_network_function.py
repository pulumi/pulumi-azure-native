...
__all__ = [
    'GetVirtualNetworkFunctionResult',
    'AwaitableGetVirtualNetworkFunctionResult',
    'get_virtual_network_function',
]

@pulumi.output_type
class GetVirtualNetworkFunctionResult:
    """
    Hybrid network virtual network function resource response.
    """
    def __init__(__self__, device=None, etag=None, location=None, managed_application=None, managed_application_parameters=None, name=None, provisioning_state=None, service_key=None, sku_name=None, sku_type=None, tags=None, type=None, vendor_name=None, vendor_provisioning_state=None, virtual_network_function_user_configurations=None):
        ...
        if virtual_network_function_user_configurations and not isinstance(virtual_network_function_user_configurations, list):
            raise TypeError("Expected argument 'virtual_network_function_user_configurations' to be a list")
        pulumi.set(__self__, "virtual_network_function_user_configurations", virtual_network_function_user_configurations)
...
class AwaitableGetVirtualNetworkFunctionResult(GetVirtualNetworkFunctionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualNetworkFunctionResult(
            device=self.device,
            etag=self.etag,
            ...
            virtual_network_function_user_configurations=self.virtual_network_function_user_configurations)


def get_virtual_network_function(resource_group_name: Optional[str] = None,
                                 virtual_network_function_name: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualNetworkFunctionResult:
    """
    Use this data source to access information about an existing resource.

    :param str resource_group_name: The name of the resource group.
    :param str virtual_network_function_name: The name of hybrid network virtual network function resource.
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualNetworkFunctionName'] = virtual_network_function_name
    if opts is None:
        opts = pulumi.InvokeOptions()
    if opts.version is None:
        opts.version = _utilities.get_version()
    __ret__ = pulumi.runtime.invoke('azurerm:hybridnetwork/preview:getVirtualNetworkFunction', __args__, opts=opts, typ=GetVirtualNetworkFunctionResult).value

    return AwaitableGetVirtualNetworkFunctionResult(
        ...
        virtual_network_function_user_configurations=__ret__.virtual_network_function_user_configurations)
