...
def get_virtual_network_function(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:hybridnetwork/v20200101preview:getVirtualNetworkFunction', __args__, opts=opts, typ=GetVirtualNetworkFunctionResult).value
