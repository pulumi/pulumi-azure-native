...
class GetVendorResult:
    ...
    @property
    @pulumi.getter
    def skus(self) -> List['outputs.SubResourceResponse']:
        """
...
def get_vendor(vendor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:hybridnetwork/v20200101preview:getVendor', __args__, opts=opts, typ=GetVendorResult).value
