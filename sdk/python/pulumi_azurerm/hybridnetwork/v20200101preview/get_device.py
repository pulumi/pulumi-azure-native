...
class GetDeviceResult:
    ...
    def virtual_network_functions(self) -> List['outputs.SubResourceResponse']:
        """
...
def get_device(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:hybridnetwork/v20200101preview:getDevice', __args__, opts=opts, typ=GetDeviceResult).value
