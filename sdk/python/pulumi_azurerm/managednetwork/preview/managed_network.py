...
class ManagedNetwork(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:managednetwork/v20190601preview:ManagedNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedNetwork, __self__).__init__(
            'azurerm:managednetwork/preview:ManagedNetwork',
            resource_name,
            __props__,
            opts)
