...
class ScopeAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:managednetwork/v20190601preview:ScopeAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScopeAssignment, __self__).__init__(
            'azurerm:managednetwork/preview:ScopeAssignment',
            resource_name,
            __props__,
            opts)
