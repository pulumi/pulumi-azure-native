...
class GetScopeAssignmentResult:
    ...
    """
    def __init__(__self__, assigned_managed_network=None, etag=None, location=None, name=None, provisioning_state=None, type=None):
...
def get_scope_assignment(scope: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:managednetwork/preview:getScopeAssignment', __args__, opts=opts, typ=GetScopeAssignmentResult).value
