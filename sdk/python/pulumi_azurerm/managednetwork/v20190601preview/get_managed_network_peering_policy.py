...
def get_managed_network_peering_policy(managed_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:managednetwork/v20190601preview:getManagedNetworkPeeringPolicy', __args__, opts=opts, typ=GetManagedNetworkPeeringPolicyResult).value
