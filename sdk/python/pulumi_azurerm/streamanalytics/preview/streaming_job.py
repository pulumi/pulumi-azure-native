...
class StreamingJob(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:streamanalytics/latest:StreamingJob"), pulumi.Alias(type_="azurerm:streamanalytics/v20160301:StreamingJob")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StreamingJob, __self__).__init__(
            'azurerm:streamanalytics/preview:StreamingJob',
            resource_name,
            __props__,
            opts)
