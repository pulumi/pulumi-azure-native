...
class Function(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:streamanalytics/latest:Function"), pulumi.Alias(type_="azurerm:streamanalytics/v20170401preview:Function")])
