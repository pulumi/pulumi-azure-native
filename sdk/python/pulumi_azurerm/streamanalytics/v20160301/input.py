...
class Input(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['InputPropertiesArgs']] properties: The properties that are associated with an input. Required on PUT (CreateOrReplace) requests.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:streamanalytics/latest:Input"), pulumi.Alias(type_="azurerm:streamanalytics/preview:Input")])
