...
class Output(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:streamanalytics/latest:Output"), pulumi.Alias(type_="azurerm:streamanalytics/v20160301:Output")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Output, __self__).__init__(
            'azurerm:streamanalytics/v20170401preview:Output',
            resource_name,
            __props__,
            opts)
