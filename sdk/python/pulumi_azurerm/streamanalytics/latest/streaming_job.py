...
class StreamingJob(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 outputs: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['OutputArgs']]]]] = None,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:streamanalytics/v20160301:StreamingJob"), pulumi.Alias(type_="azurerm:streamanalytics/v20170401preview:StreamingJob")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StreamingJob, __self__).__init__(
            'azurerm:streamanalytics/latest:StreamingJob',
            resource_name,
            __props__,
            opts)
