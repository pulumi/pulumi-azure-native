...
class Function(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:streamanalytics/v20160301:Function"), pulumi.Alias(type_="azurerm:streamanalytics/v20170401preview:Function")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Function, __self__).__init__(
            'azurerm:streamanalytics/latest:Function',
            resource_name,
            __props__,
            opts)
