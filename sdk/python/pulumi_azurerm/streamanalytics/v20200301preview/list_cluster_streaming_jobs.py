...
class ListClusterStreamingJobsResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> List['outputs.ClusterJobResponseResult']:
        """
...
def list_cluster_streaming_jobs(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:streamanalytics/v20200301preview:listClusterStreamingJobs', __args__, opts=opts, typ=ListClusterStreamingJobsResult).value
