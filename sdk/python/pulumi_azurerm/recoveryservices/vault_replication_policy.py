...
class VaultReplicationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, properties=None, resource_group_name=None, resource_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(VaultReplicationPolicy, __self__).__init__(
            'azurerm:recoveryservices:VaultReplicationPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, location=None, name=None, properties=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `friendly_name` (`pulumi.Input[str]`) - The FriendlyName.
          * `provider_specific_details` (`pulumi.Input[dict]`) - The ReplicationChannelSetting.
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return VaultReplicationPolicy(resource_name, opts=opts, __props__=__props__)
