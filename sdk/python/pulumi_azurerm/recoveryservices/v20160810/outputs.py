...
class AzureToAzureVmSyncedConfigDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 role_assignments: Optional[List['outputs.RoleAssignmentResponse']] = None,
                 tags: Optional[Mapping[str, str]] = None):
        """
        Azure to Azure VM synced configuration details.
        :param List['InputEndpointResponseArgs'] input_endpoints: The Azure VM input endpoints.
        :param List['RoleAssignmentResponseArgs'] role_assignments: The Azure role assignments.
    ...
    def role_assignments(self) -> Optional[List['outputs.RoleAssignmentResponse']]:
        """
