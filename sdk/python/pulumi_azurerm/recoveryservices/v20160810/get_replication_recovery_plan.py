...
def get_replication_recovery_plan(name=None, resource_group_name=None, resource_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:recoveryservices/v20160810:getReplicationRecoveryPlan', __args__, opts=opts).value
