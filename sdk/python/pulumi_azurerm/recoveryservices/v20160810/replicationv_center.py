...
class ReplicationvCenter(pulumi.CustomResource):
    def __init__(__self__,
        ...
        replicationv_center = azurerm.recoveryservices.v20160810.ReplicationvCenter("replicationvCenter",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/latest:ReplicationvCenter"), pulumi.Alias(type_="azurerm:recoveryservices/v20180110:ReplicationvCenter"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationvCenter")])
