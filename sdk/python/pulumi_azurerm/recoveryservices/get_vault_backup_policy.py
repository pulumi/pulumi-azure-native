...
class AwaitableGetVaultBackupPolicyResult(GetVaultBackupPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVaultBackupPolicyResult(
            e_tag=self.e_tag,
...
def get_vault_backup_policy(name=None, resource_group_name=None, vault_name=None, opts=None):
    """
