...
class ReplicationRecoveryPlan(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/latest:ReplicationRecoveryPlan"), pulumi.Alias(type_="azurerm:recoveryservices/preview:ReplicationRecoveryPlan"), pulumi.Alias(type_="azurerm:recoveryservices/v20160810:ReplicationRecoveryPlan"), pulumi.Alias(type_="azurerm:recoveryservices/v20180110:ReplicationRecoveryPlan")])
