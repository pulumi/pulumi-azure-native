...
def get_replication_migration_item(fabric_name=None, name=None, protection_container_name=None, resource_group_name=None, resource_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:recoveryservices/v20180710:getReplicationMigrationItem', __args__, opts=opts).value
