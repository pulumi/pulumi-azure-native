...
def get_replication_fabric(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:recoveryservices/v20180110:getReplicationFabric', __args__, opts=opts, typ=GetReplicationFabricResult).value
