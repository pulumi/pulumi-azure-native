...
class ReplicationProtectionContainerMapping(pulumi.CustomResource):
    def __init__(__self__,
        ...
        replication_protection_container_mapping = azurerm.recoveryservices.v20180110.ReplicationProtectionContainerMapping("replicationProtectionContainerMapping",
            fabric_name="cloud1",
