...
class ReplicationFabric(pulumi.CustomResource):
    def __init__(__self__,
        ...
        replication_fabric = azurerm.recoveryservices.v20180110.ReplicationFabric("replicationFabric",
            fabric_name="cloud1",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/latest:ReplicationFabric"), pulumi.Alias(type_="azurerm:recoveryservices/v20160810:ReplicationFabric"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationFabric")])
