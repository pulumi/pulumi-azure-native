...
class ReplicationvCenter(pulumi.CustomResource):
    def __init__(__self__,
        ...
        replicationv_center = azurerm.recoveryservices.v20180110.ReplicationvCenter("replicationvCenter",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/latest:ReplicationvCenter"), pulumi.Alias(type_="azurerm:recoveryservices/v20160810:ReplicationvCenter"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationvCenter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationvCenter, __self__).__init__(
            'azurerm:recoveryservices/v20180110:ReplicationvCenter',
            resource_name,
            __props__,
            opts)
