...
class ReplicationProtectedItem(pulumi.CustomResource):
    ...
    The custom data.
      ...
      * `health_errors` (`list`) - List of health errors.
      ...
      * `primary_fabric_provider` (`str`) - The fabric provider of the primary fabric.
    ...
    def __init__(__self__, resource_name, opts=None, fabric_name=None, name=None, properties=None, protection_container_name=None, resource_group_name=None, resource_name_=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/v20160810:ReplicationProtectedItem"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationProtectedItem")])
