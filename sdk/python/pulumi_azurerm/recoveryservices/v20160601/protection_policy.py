...
class ProtectionPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/v20161201:ProtectionPolicy"), pulumi.Alias(type_="azurerm:recoveryservices/v20190513:ProtectionPolicy"), pulumi.Alias(type_="azurerm:recoveryservices/v20190615:ProtectionPolicy")])
