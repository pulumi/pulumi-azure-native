...
class VaultReplicationFabricReplicationProtectionContainerReplicationMigrationItem(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, fabric_name=None, name=None, properties=None, protection_container_name=None, resource_group_name=None, resource_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(VaultReplicationFabricReplicationProtectionContainerReplicationMigrationItem, __self__).__init__(
            'azurerm:recoveryservices:VaultReplicationFabricReplicationProtectionContainerReplicationMigrationItem',
            resource_name,
            __props__,
            opts)
