...
class VaultReplicationFabricReplicationNetworkReplicationNetworkMapping(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, fabric_name=None, name=None, network_name=None, properties=None, resource_group_name=None, resource_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(VaultReplicationFabricReplicationNetworkReplicationNetworkMapping, __self__).__init__(
            'azurerm:recoveryservices:VaultReplicationFabricReplicationNetworkReplicationNetworkMapping',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, location=None, name=None, properties=None, type=None):
        ...
        :param pulumi.Input[dict] properties: The Network Mapping Properties.
        :param pulumi.Input[str] type: Resource Type

        The **properties** object supports the following:

          * `fabric_specific_settings` (`pulumi.Input[dict]`) - The fabric specific settings.
          ...
          * `primary_network_friendly_name` (`pulumi.Input[str]`) - The primary network friendly name.
          * `primary_network_id` (`pulumi.Input[str]`) - The primary network id for network mapping.
          * `recovery_fabric_arm_id` (`pulumi.Input[str]`) - The recovery fabric ARM id.
          * `recovery_fabric_friendly_name` (`pulumi.Input[str]`) - The recovery fabric friendly name.
          * `recovery_network_friendly_name` (`pulumi.Input[str]`) - The recovery network friendly name.
          * `recovery_network_id` (`pulumi.Input[str]`) - The recovery network id for network mapping.
          * `state` (`pulumi.Input[str]`) - The pairing state for network mapping.
        """
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return VaultReplicationFabricReplicationNetworkReplicationNetworkMapping(resource_name, opts=opts, __props__=__props__)
