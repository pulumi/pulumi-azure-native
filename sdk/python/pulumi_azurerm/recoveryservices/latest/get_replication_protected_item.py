...
def get_replication_protected_item(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:recoveryservices/latest:getReplicationProtectedItem', __args__, opts=opts, typ=GetReplicationProtectedItemResult).value
