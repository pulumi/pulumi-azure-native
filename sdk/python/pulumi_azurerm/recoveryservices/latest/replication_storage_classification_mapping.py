...
class ReplicationStorageClassificationMapping(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/v20160810:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azurerm:recoveryservices/v20180110:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationStorageClassificationMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationStorageClassificationMapping, __self__).__init__(
            'azurerm:recoveryservices/latest:ReplicationStorageClassificationMapping',
            resource_name,
            __props__,
            opts)
