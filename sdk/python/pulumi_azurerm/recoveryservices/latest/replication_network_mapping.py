...
class ReplicationNetworkMapping(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/preview:ReplicationNetworkMapping"), pulumi.Alias(type_="azurerm:recoveryservices/v20160810:ReplicationNetworkMapping"), pulumi.Alias(type_="azurerm:recoveryservices/v20180110:ReplicationNetworkMapping"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationNetworkMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationNetworkMapping, __self__).__init__(
            'azurerm:recoveryservices/latest:ReplicationNetworkMapping',
            resource_name,
            __props__,
            opts)
