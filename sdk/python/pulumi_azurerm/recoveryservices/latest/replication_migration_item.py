...
class ReplicationMigrationItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/preview:ReplicationMigrationItem"), pulumi.Alias(type_="azurerm:recoveryservices/v20180110:ReplicationMigrationItem"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationMigrationItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationMigrationItem, __self__).__init__(
            'azurerm:recoveryservices/latest:ReplicationMigrationItem',
            resource_name,
            __props__,
            opts)
