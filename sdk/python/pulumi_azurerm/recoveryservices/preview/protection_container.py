...
class ProtectionContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/latest:ProtectionContainer"), pulumi.Alias(type_="azurerm:recoveryservices/v20161201:ProtectionContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProtectionContainer, __self__).__init__(
            'azurerm:recoveryservices/preview:ProtectionContainer',
            resource_name,
            __props__,
            opts)
