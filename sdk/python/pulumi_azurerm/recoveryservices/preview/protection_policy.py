...
class ProtectionPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/latest:ProtectionPolicy"), pulumi.Alias(type_="azurerm:recoveryservices/v20160601:ProtectionPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProtectionPolicy, __self__).__init__(
            'azurerm:recoveryservices/preview:ProtectionPolicy',
            resource_name,
            __props__,
            opts)
