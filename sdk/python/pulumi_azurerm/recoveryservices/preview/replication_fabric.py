...
class ReplicationFabric(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/latest:ReplicationFabric"), pulumi.Alias(type_="azurerm:recoveryservices/v20160810:ReplicationFabric"), pulumi.Alias(type_="azurerm:recoveryservices/v20180110:ReplicationFabric"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationFabric")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationFabric, __self__).__init__(
            'azurerm:recoveryservices/preview:ReplicationFabric',
            resource_name,
            __props__,
            opts)
