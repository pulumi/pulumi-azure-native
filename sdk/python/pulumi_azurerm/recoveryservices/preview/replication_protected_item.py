...
class ReplicationProtectedItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:recoveryservices/latest:ReplicationProtectedItem"), pulumi.Alias(type_="azurerm:recoveryservices/v20160810:ReplicationProtectedItem"), pulumi.Alias(type_="azurerm:recoveryservices/v20180110:ReplicationProtectedItem"), pulumi.Alias(type_="azurerm:recoveryservices/v20180710:ReplicationProtectedItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationProtectedItem, __self__).__init__(
            'azurerm:recoveryservices/preview:ReplicationProtectedItem',
            resource_name,
            __props__,
            opts)
