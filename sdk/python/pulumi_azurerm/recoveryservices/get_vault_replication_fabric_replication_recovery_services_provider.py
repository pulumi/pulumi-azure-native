...
class AwaitableGetVaultReplicationFabricReplicationRecoveryServicesProviderResult(GetVaultReplicationFabricReplicationRecoveryServicesProviderResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVaultReplicationFabricReplicationRecoveryServicesProviderResult(
...
def get_vault_replication_fabric_replication_recovery_services_provider(fabric_name=None, name=None, resource_group_name=None, resource_name=None, opts=None):
    """
