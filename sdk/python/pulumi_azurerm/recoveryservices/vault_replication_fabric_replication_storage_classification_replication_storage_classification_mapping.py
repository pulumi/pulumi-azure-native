...
class VaultReplicationFabricReplicationStorageClassificationReplicationStorageClassificationMapping(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, fabric_name=None, name=None, properties=None, resource_group_name=None, resource_name=None, storage_classification_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(VaultReplicationFabricReplicationStorageClassificationReplicationStorageClassificationMapping, __self__).__init__(
            'azurerm:recoveryservices:VaultReplicationFabricReplicationStorageClassificationReplicationStorageClassificationMapping',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, location=None, name=None, properties=None, type=None):
        ...
        :param pulumi.Input[dict] properties: Properties of the storage mapping object.
        :param pulumi.Input[str] type: Resource Type

        The **properties** object supports the following:

          * `target_storage_classification_id` (`pulumi.Input[str]`) - Target storage object Id.
        """
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return VaultReplicationFabricReplicationStorageClassificationReplicationStorageClassificationMapping(resource_name, opts=opts, __props__=__props__)
