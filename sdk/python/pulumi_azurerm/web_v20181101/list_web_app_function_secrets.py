...
def list_web_app_function_secrets(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20181101:listWebAppFunctionSecrets', __args__, opts=opts).value
