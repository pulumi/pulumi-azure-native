...
def get_server_details(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:analysisservices/v20170801:getServerDetails', __args__, opts=opts, typ=GetServerDetailsResult).value
