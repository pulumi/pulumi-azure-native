...
class ServerDetails(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, as_administrators=None, backup_blob_container_uri=None, gateway_details=None, location=None, name=None, resource_group_name=None, sku=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:analysisservices/v20160516:ServerDetails"), pulumi.Alias(type_="azurerm:analysisservices/v20170801:ServerDetails")])
