...
def list_server_gateway_status(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:analysisservices/v20170801beta:listServerGatewayStatus', __args__, opts=opts, typ=ListServerGatewayStatusResult).value
