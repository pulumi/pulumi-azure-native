...
class Redis(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cache/latest:Redis"), pulumi.Alias(type_="azurerm:cache/v20150801:Redis"), pulumi.Alias(type_="azurerm:cache/v20170201:Redis"), pulumi.Alias(type_="azurerm:cache/v20171001:Redis"), pulumi.Alias(type_="azurerm:cache/v20180301:Redis"), pulumi.Alias(type_="azurerm:cache/v20190701:Redis")])
