...
class GetRedisResult:
    ...
    """
    def __init__(__self__, access_keys=None, enable_non_ssl_port=None, host_name=None, location=None, name=None, port=None, provisioning_state=None, redis_configuration=None, redis_version=None, shard_count=None, sku=None, ssl_port=None, static_ip=None, subnet_id=None, tags=None, tenant_settings=None, type=None):
...
def get_redis(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:cache/v20160401:getRedis', __args__, opts=opts, typ=GetRedisResult).value
