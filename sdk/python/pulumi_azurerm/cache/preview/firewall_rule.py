...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cache/latest:FirewallRule"), pulumi.Alias(type_="azurerm:cache/v20160401:FirewallRule"), pulumi.Alias(type_="azurerm:cache/v20170201:FirewallRule"), pulumi.Alias(type_="azurerm:cache/v20171001:FirewallRule"), pulumi.Alias(type_="azurerm:cache/v20180301:FirewallRule"), pulumi.Alias(type_="azurerm:cache/v20190701:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azurerm:cache/preview:FirewallRule',
            resource_name,
            __props__,
            opts)
