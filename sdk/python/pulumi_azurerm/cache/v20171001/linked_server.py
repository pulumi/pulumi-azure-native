...
class LinkedServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        linked_server = azurerm.cache.v20171001.LinkedServer("linkedServer",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cache/latest:LinkedServer"), pulumi.Alias(type_="azurerm:cache/v20170201:LinkedServer"), pulumi.Alias(type_="azurerm:cache/v20180301:LinkedServer"), pulumi.Alias(type_="azurerm:cache/v20190701:LinkedServer")])
