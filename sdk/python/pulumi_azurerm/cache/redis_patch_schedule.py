...
class RedisPatchSchedule(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, default=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(RedisPatchSchedule, __self__).__init__(
            'azurerm:cache:RedisPatchSchedule',
            resource_name,
            __props__,
            opts)
