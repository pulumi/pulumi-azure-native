...
class Redis(pulumi.CustomResource):
    ...
    Redis host name.
    """
    linked_servers: pulumi.Output[dict]
    """
    ...
    def __init__(__self__, resource_name, opts=None, enable_non_ssl_port=None, location=None, name=None, redis_configuration=None, resource_group_name=None, shard_count=None, sku=None, static_ip=None, subnet_id=None, tags=None, tenant_settings=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cache/v20150801:Redis"), pulumi.Alias(type_="azurerm:cache/v20160401:Redis"), pulumi.Alias(type_="azurerm:cache/v20171001:Redis"), pulumi.Alias(type_="azurerm:cache/v20180301:Redis")])
