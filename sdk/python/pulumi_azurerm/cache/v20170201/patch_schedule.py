...
class PatchSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        patch_schedule = azurerm.cache.v20170201.PatchSchedule("patchSchedule",
            name="cache1",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cache/v20160401:PatchSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PatchSchedule, __self__).__init__(
            'azurerm:cache/v20170201:PatchSchedule',
            resource_name,
            __props__,
            opts)
