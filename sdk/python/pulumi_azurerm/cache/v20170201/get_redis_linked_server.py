...
def get_redis_linked_server(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:cache/v20170201:getRedisLinkedServer', __args__, opts=opts, typ=GetRedisLinkedServerResult).value
