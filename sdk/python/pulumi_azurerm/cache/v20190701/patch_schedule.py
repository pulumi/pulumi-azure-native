...
class PatchSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cache/latest:PatchSchedule"), pulumi.Alias(type_="azurerm:cache/preview:PatchSchedule"), pulumi.Alias(type_="azurerm:cache/v20171001:PatchSchedule"), pulumi.Alias(type_="azurerm:cache/v20180301:PatchSchedule")])
