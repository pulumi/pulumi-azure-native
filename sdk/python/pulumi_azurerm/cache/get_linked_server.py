...
def get_linked_server(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:cache:getLinkedServer', __args__, opts=opts).value
