...
class ConfigurationProfile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:changeanalysis/preview:ConfigurationProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationProfile, __self__).__init__(
            'azurerm:changeanalysis/v20200401preview:ConfigurationProfile',
            resource_name,
            __props__,
            opts)
