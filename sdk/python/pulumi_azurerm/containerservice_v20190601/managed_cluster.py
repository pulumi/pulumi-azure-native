...
class ManagedCluster(pulumi.CustomResource):
    ...
    Properties of a managed cluster.
      ...
      * `api_server_authorized_ip_ranges` (`list`) - (PREVIEW) Authorized IP Ranges to kubernetes API server.
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `api_server_authorized_ip_ranges` (`pulumi.Input[list]`) - (PREVIEW) Authorized IP Ranges to kubernetes API server.
        ...
        super(ManagedCluster, __self__).__init__(
            'azurerm:containerservice/v20190601:ManagedCluster',
            resource_name,
            __props__,
            opts)
