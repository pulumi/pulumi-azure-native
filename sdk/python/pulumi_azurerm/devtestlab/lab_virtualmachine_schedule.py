...
class LabVirtualmachineSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, lab_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, virtual_machine_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(LabVirtualmachineSchedule, __self__).__init__(
            'azurerm:devtestlab:LabVirtualmachineSchedule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        """
        Get an existing LabVirtualmachineSchedule resource's state with the given name, id, and optional extra
        ...
        return LabVirtualmachineSchedule(resource_name, opts=opts, __props__=__props__)
