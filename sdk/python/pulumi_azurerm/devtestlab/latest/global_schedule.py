...
class GlobalSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/preview:GlobalSchedule"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:GlobalSchedule"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:GlobalSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GlobalSchedule, __self__).__init__(
            'azurerm:devtestlab/latest:GlobalSchedule',
            resource_name,
            __props__,
            opts)
