...
class GlobalSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/v20160515:GlobalSchedule"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:GlobalSchedule")])
