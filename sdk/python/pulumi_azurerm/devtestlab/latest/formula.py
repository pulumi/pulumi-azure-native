...
class Formula(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/preview:Formula"), pulumi.Alias(type_="azurerm:devtestlab/v20150521preview:Formula"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Formula"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:Formula")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Formula, __self__).__init__(
            'azurerm:devtestlab/latest:Formula',
            resource_name,
            __props__,
            opts)
