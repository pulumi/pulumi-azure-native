...
class NotificationChannel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/preview:NotificationChannel"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:NotificationChannel"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:NotificationChannel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NotificationChannel, __self__).__init__(
            'azurerm:devtestlab/latest:NotificationChannel',
            resource_name,
            __props__,
            opts)
