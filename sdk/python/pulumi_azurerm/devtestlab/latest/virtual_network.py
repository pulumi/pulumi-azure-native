...
class VirtualNetwork(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/v20150521preview:VirtualNetwork"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:VirtualNetwork"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:VirtualNetwork")])
