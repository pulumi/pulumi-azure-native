...
class ServiceFabricSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/preview:ServiceFabricSchedule"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:ServiceFabricSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServiceFabricSchedule, __self__).__init__(
            'azurerm:devtestlab/latest:ServiceFabricSchedule',
            resource_name,
            __props__,
            opts)
