...
class ServiceFabric(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:ServiceFabric"), pulumi.Alias(type_="azurerm:devtestlab/preview:ServiceFabric")])
