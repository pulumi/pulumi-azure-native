...
class VirtualMachine(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:VirtualMachine"), pulumi.Alias(type_="azurerm:devtestlab/v20150521preview:VirtualMachine"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:VirtualMachine")])
