...
class ServiceFabricSchedule(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, daily_recurrence=None, hourly_recurrence=None, lab_name=None, location=None, name=None, notification_settings=None, resource_group_name=None, service_fabric_name=None, status=None, tags=None, target_resource_id=None, task_type=None, time_zone_id=None, user_name=None, weekly_recurrence=None, __props__=None, __name__=None, __opts__=None):
        """
        A schedule.
        ...
        super(ServiceFabricSchedule, __self__).__init__(
            'azurerm:devtestlab/v20180915:ServiceFabricSchedule',
            resource_name,
            __props__,
            opts)
