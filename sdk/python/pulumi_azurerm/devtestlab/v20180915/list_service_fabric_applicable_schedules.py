...
def list_service_fabric_applicable_schedules(lab_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devtestlab/v20180915:listServiceFabricApplicableSchedules', __args__, opts=opts, typ=ListServiceFabricApplicableSchedulesResult).value
