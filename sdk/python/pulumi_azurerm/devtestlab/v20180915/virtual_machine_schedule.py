...
class VirtualMachineSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:VirtualMachineSchedule"), pulumi.Alias(type_="azurerm:devtestlab/preview:VirtualMachineSchedule"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:VirtualMachineSchedule")])
