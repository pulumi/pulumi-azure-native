...
class Policy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:Policy"), pulumi.Alias(type_="azurerm:devtestlab/v20150521preview:Policy"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Policy")])
