...
class Secret(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:Secret"), pulumi.Alias(type_="azurerm:devtestlab/preview:Secret"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Secret")])
