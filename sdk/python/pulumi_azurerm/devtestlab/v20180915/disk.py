...
class Disk(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:Disk"), pulumi.Alias(type_="azurerm:devtestlab/preview:Disk"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Disk")])
