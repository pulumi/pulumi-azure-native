...
class GlobalSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:GlobalSchedule"), pulumi.Alias(type_="azurerm:devtestlab/preview:GlobalSchedule"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:GlobalSchedule")])
