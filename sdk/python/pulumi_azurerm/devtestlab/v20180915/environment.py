...
class Environment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:Environment"), pulumi.Alias(type_="azurerm:devtestlab/preview:Environment"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Environment")])
