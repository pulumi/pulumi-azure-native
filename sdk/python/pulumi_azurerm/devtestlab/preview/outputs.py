...
class AttachNewDataDiskOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float disk_size_gi_b: Size of the disk to be attached in GibiBytes.
...
class LabVirtualMachineCreationParameterResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 data_disk_parameters: Optional[List['outputs.DataDiskPropertiesResponse']] = None,
                 ...
                 schedule_parameters: Optional[List['outputs.ScheduleCreationParameterResponse']] = None,
        ...
        :param List['DataDiskPropertiesResponseArgs'] data_disk_parameters: New or existing data disks to attach to the virtual machine after creation
        ...
        :param List['ScheduleCreationParameterResponseArgs'] schedule_parameters: Virtual Machine schedules to be created
