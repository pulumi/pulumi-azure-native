...
class Lab(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:Lab"), pulumi.Alias(type_="azurerm:devtestlab/v20150521preview:Lab"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Lab"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:Lab")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Lab, __self__).__init__(
            'azurerm:devtestlab/preview:Lab',
            resource_name,
            __props__,
            opts)
