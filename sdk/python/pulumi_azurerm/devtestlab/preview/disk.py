...
class Disk(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:Disk"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Disk"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:Disk")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Disk, __self__).__init__(
            'azurerm:devtestlab/preview:Disk',
            resource_name,
            __props__,
            opts)
