...
class Schedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:Schedule"), pulumi.Alias(type_="azurerm:devtestlab/v20150521preview:Schedule"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Schedule"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:Schedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Schedule, __self__).__init__(
            'azurerm:devtestlab/preview:Schedule',
            resource_name,
            __props__,
            opts)
