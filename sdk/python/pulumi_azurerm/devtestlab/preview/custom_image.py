...
class CustomImage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:CustomImage"), pulumi.Alias(type_="azurerm:devtestlab/v20150521preview:CustomImage"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:CustomImage"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:CustomImage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomImage, __self__).__init__(
            'azurerm:devtestlab/preview:CustomImage',
            resource_name,
            __props__,
            opts)
