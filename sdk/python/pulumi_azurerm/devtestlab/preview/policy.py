...
class Policy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:Policy"), pulumi.Alias(type_="azurerm:devtestlab/v20150521preview:Policy"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:Policy"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:Policy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Policy, __self__).__init__(
            'azurerm:devtestlab/preview:Policy',
            resource_name,
            __props__,
            opts)
