...
class ServiceRunner(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:ServiceRunner"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:ServiceRunner"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:ServiceRunner")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServiceRunner, __self__).__init__(
            'azurerm:devtestlab/preview:ServiceRunner',
            resource_name,
            __props__,
            opts)
