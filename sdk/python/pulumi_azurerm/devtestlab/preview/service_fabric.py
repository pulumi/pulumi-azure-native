...
class ServiceFabric(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:ServiceFabric"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:ServiceFabric")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServiceFabric, __self__).__init__(
            'azurerm:devtestlab/preview:ServiceFabric',
            resource_name,
            __props__,
            opts)
