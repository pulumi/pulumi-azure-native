...
class LabUserServicefabric(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, lab_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, user_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(LabUserServicefabric, __self__).__init__(
            'azurerm:devtestlab:LabUserServicefabric',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `applicable_schedule` (`pulumi.Input[dict]`) - The applicable schedule for the virtual machine.
            * `id` (`pulumi.Input[str]`) - The identifier of the resource.
        ...
        __props__["tags"] = tags
        __props__["type"] = type
        return LabUserServicefabric(resource_name, opts=opts, __props__=__props__)
