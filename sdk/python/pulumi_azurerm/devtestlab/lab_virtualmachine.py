...
class LabVirtualmachine(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, lab_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        super(LabVirtualmachine, __self__).__init__(
            'azurerm:devtestlab:LabVirtualmachine',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return LabVirtualmachine(resource_name, opts=opts, __props__=__props__)
