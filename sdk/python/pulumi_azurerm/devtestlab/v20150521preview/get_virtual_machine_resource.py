...
def get_virtual_machine_resource(lab_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devtestlab/v20150521preview:getVirtualMachineResource', __args__, opts=opts, typ=GetVirtualMachineResourceResult).value
