...
class CustomImageResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['vhd'] = vhd
            __props__['vm'] = vm
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:CustomImageResource"), pulumi.Alias(type_="azurerm:devtestlab/preview:CustomImageResource"), pulumi.Alias(type_="azurerm:devtestlab/v20160515:CustomImageResource"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:CustomImageResource")])
