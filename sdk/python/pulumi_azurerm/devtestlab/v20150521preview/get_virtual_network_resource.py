...
def get_virtual_network_resource(lab_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devtestlab/v20150521preview:getVirtualNetworkResource', __args__, opts=opts, typ=GetVirtualNetworkResourceResult).value
