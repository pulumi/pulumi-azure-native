...
def get_virtual_machine_schedule(expand=None, lab_name=None, name=None, resource_group_name=None, virtual_machine_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devtestlab/v20160515:getVirtualMachineSchedule', __args__, opts=opts).value
