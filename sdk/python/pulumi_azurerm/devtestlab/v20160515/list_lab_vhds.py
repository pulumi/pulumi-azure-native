...
class ListLabVhdsResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[List['outputs.LabVhdResponseResult']]:
        """
...
def list_lab_vhds(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devtestlab/v20160515:listLabVhds', __args__, opts=opts, typ=ListLabVhdsResult).value
