...
class ServiceRunner(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devtestlab/latest:ServiceRunner"), pulumi.Alias(type_="azurerm:devtestlab/preview:ServiceRunner"), pulumi.Alias(type_="azurerm:devtestlab/v20180915:ServiceRunner")])
