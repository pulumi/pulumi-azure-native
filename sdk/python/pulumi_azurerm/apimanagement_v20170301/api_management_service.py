...
class ApiManagementService(pulumi.CustomResource):
    ...
    Properties of the API Management service.
      * `additional_locations` (`list`) - Additional datacenter locations of the API Management service.
        ...
        * `static_ips` (`list`) - Static IP addresses of the location's virtual machines.
      ...
      * `static_ips` (`list`) - Static IP addresses of the API Management service virtual machines. Available only for Standard and Premium SKU.
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, properties=None, resource_group_name=None, sku=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `certificates` (`pulumi.Input[list]`) - List of Certificates that need to be installed in the API Management service. Max supported certificates that can be installed is 10.
            ...
            * `store_name` (`pulumi.Input[str]`) - The local certificate store location. Only Root and CertificateAuthority are valid locations.
        ...
        super(ApiManagementService, __self__).__init__(
            'azurerm:apimanagement/v20170301:ApiManagementService',
            resource_name,
            __props__,
            opts)
