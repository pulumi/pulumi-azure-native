...
class WebAppHybridConnectionSlot(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, kind=None, name=None, namespace_name=None, properties=None, resource_group_name=None, slot=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        super(WebAppHybridConnectionSlot, __self__).__init__(
            'azurerm:web/v20160801:WebAppHybridConnectionSlot',
            resource_name,
            __props__,
            opts)
