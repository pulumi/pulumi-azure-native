...
def list_web_app_hybrid_connection_keys(name=None, namespace_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20160801:listWebAppHybridConnectionKeys', __args__, opts=opts).value
