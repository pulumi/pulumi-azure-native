...
class Cluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        cluster = azurerm.servicefabric.v20180201.Cluster("cluster",
            add_on_features=[
                "RepairManager",
                "DnsService",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabric/latest:Cluster"), pulumi.Alias(type_="azurerm:servicefabric/v20160901:Cluster"), pulumi.Alias(type_="azurerm:servicefabric/v20190301:Cluster"), pulumi.Alias(type_="azurerm:servicefabric/v20200301:Cluster")])
