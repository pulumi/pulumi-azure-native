...
class ClusterApplicationTypeVersion(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, application_type_name=None, cluster_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        super(ClusterApplicationTypeVersion, __self__).__init__(
            'azurerm:servicefabric:ClusterApplicationTypeVersion',
            resource_name,
            __props__,
            opts)
