...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application = azurerm.servicefabric.v20190301.Application("application",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabric/latest:Application"), pulumi.Alias(type_="azurerm:servicefabric/v20200301:Application")])
