...
def get_application_type(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:servicefabric/v20190301:getApplicationType', __args__, opts=opts, typ=GetApplicationTypeResult).value
