...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        service = azurerm.servicefabric.v20190301.Service("service",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabric/latest:Service"), pulumi.Alias(type_="azurerm:servicefabric/v20200301:Service")])
