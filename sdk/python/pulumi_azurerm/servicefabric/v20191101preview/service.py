...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        service = azurerm.servicefabric.v20191101preview.Service("service",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabric/latest:Service"), pulumi.Alias(type_="azurerm:servicefabric/v20170701preview:Service"), pulumi.Alias(type_="azurerm:servicefabric/v20190301:Service"), pulumi.Alias(type_="azurerm:servicefabric/v20190301preview:Service"), pulumi.Alias(type_="azurerm:servicefabric/v20190601preview:Service"), pulumi.Alias(type_="azurerm:servicefabric/v20200301:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azurerm:servicefabric/v20191101preview:Service',
            resource_name,
            __props__,
            opts)
