...
class ApplicationTypeVersion(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application_type_version = azurerm.servicefabric.v20190601preview.ApplicationTypeVersion("applicationTypeVersion",
        ...
        super(ApplicationTypeVersion, __self__).__init__(
            'azurerm:servicefabric/v20190601preview:ApplicationTypeVersion',
            resource_name,
            __props__,
            opts)
