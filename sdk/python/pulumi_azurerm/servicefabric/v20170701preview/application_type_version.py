...
class ApplicationTypeVersion(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application_type_version = azurerm.servicefabric.v20170701preview.ApplicationTypeVersion("applicationTypeVersion",
        ...
        super(ApplicationTypeVersion, __self__).__init__(
            'azurerm:servicefabric/v20170701preview:ApplicationTypeVersion',
            resource_name,
            __props__,
            opts)
