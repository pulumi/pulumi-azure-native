...
class Application(pulumi.CustomResource):
    def __init__(__self__,
        ...
        application = azurerm.servicefabric.v20190301preview.Application("application",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:servicefabric/latest:Application"), pulumi.Alias(type_="azurerm:servicefabric/v20170701preview:Application"), pulumi.Alias(type_="azurerm:servicefabric/v20190301:Application"), pulumi.Alias(type_="azurerm:servicefabric/v20190601preview:Application"), pulumi.Alias(type_="azurerm:servicefabric/v20191101preview:Application"), pulumi.Alias(type_="azurerm:servicefabric/v20200301:Application")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Application, __self__).__init__(
            'azurerm:servicefabric/v20190301preview:Application',
            resource_name,
            __props__,
            opts)
