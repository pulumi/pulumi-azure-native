...
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, location=None, name=None, resource_group_name=None, service_level=None, size=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/v20190501:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190601:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190701:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190801:Pool"), pulumi.Alias(type_="azurerm:netapp/v20191001:Pool")])
