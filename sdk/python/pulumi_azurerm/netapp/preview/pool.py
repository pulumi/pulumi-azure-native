...
class Pool(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/latest:Pool"), pulumi.Alias(type_="azurerm:netapp/v20170815:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190501:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190601:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190701:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190801:Pool"), pulumi.Alias(type_="azurerm:netapp/v20191001:Pool"), pulumi.Alias(type_="azurerm:netapp/v20191101:Pool"), pulumi.Alias(type_="azurerm:netapp/v20200201:Pool"), pulumi.Alias(type_="azurerm:netapp/v20200601:Pool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pool, __self__).__init__(
            'azurerm:netapp/preview:Pool',
            resource_name,
            __props__,
            opts)
