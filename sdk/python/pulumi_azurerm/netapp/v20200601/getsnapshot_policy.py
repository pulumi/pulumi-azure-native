...
def getsnapshot_policy(account_name: Optional[str] = None,
    ...
    :param str name: The name of the snapshot policy target
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:netapp/v20200601:getsnapshotPolicy', __args__, opts=opts, typ=GetsnapshotPolicyResult).value
