...
def getbackup_policy(account_name: Optional[str] = None,
    ...
    :param str name: Backup policy Name which uniquely identify backup policy.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:netapp/v20200601:getbackupPolicy', __args__, opts=opts, typ=GetbackupPolicyResult).value
