...
class Snapshot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/latest:Snapshot"), pulumi.Alias(type_="azurerm:netapp/preview:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20170815:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20190501:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20190601:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20190701:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20190801:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20191001:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20191101:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20200201:Snapshot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Snapshot, __self__).__init__(
            'azurerm:netapp/v20200601:Snapshot',
            resource_name,
            __props__,
            opts)
