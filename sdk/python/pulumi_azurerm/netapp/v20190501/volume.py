...
class Volume(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, creation_token=None, export_policy=None, location=None, mount_targets=None, name=None, pool_name=None, protocol_types=None, resource_group_name=None, service_level=None, snapshot_id=None, subnet_id=None, tags=None, usage_threshold=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/v20190601:Volume"), pulumi.Alias(type_="azurerm:netapp/v20190701:Volume"), pulumi.Alias(type_="azurerm:netapp/v20190801:Volume"), pulumi.Alias(type_="azurerm:netapp/v20191001:Volume"), pulumi.Alias(type_="azurerm:netapp/v20191101:Volume")])
