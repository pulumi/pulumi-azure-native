...
class GetVolumeResult:
    ...
    Volume resource
    """
    def __init__(__self__, baremetal_tenant_id=None, creation_token=None, export_policy=None, file_system_id=None, location=None, mount_targets=None, name=None, protocol_types=None, provisioning_state=None, service_level=None, snapshot_id=None, subnet_id=None, tags=None, type=None, usage_threshold=None):
...
def get_volume(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:netapp/v20190501:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
