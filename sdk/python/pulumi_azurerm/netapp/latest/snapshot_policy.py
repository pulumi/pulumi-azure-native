...
class SnapshotPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/preview:snapshotPolicy"), pulumi.Alias(type_="azurerm:netapp/v20200601:snapshotPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SnapshotPolicy, __self__).__init__(
            'azurerm:netapp/latest:snapshotPolicy',
            resource_name,
            __props__,
            opts)
