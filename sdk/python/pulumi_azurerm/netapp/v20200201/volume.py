...
class Volume(pulumi.CustomResource):
    ...
    """
    snapshot_directory_visible: pulumi.Output[bool]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, account_name=None, creation_token=None, data_protection=None, export_policy=None, is_restoring=None, location=None, mount_targets=None, name=None, pool_name=None, protocol_types=None, resource_group_name=None, service_level=None, snapshot_directory_visible=None, snapshot_id=None, subnet_id=None, tags=None, usage_threshold=None, volume_type=None, __props__=None, __name__=None, __opts__=None):
        """
        Volume resource
        ...
        The **export_policy** object supports the following:
          ...
          * `rules` (`pulumi.Input[list]`) - Export policy rule
            ...
            * `nfsv3` (`pulumi.Input[bool]`) - Allows NFSv3 protocol. Enable only for NFSv3 type volumes
            * `nfsv41` (`pulumi.Input[bool]`) - Allows NFSv4.1 protocol. Enable only for NFSv4.1 type volumes
