...
class Pool(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/v20190501:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190601:Pool"), pulumi.Alias(type_="azurerm:netapp/v20190701:Pool"), pulumi.Alias(type_="azurerm:netapp/v20191001:Pool"), pulumi.Alias(type_="azurerm:netapp/v20191101:Pool"), pulumi.Alias(type_="azurerm:netapp/v20200201:Pool"), pulumi.Alias(type_="azurerm:netapp/v20200601:Pool")])
