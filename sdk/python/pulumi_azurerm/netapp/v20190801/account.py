...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, active_directories=None, location=None, name=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/v20190501:Account"), pulumi.Alias(type_="azurerm:netapp/v20190601:Account"), pulumi.Alias(type_="azurerm:netapp/v20190701:Account"), pulumi.Alias(type_="azurerm:netapp/v20191001:Account"), pulumi.Alias(type_="azurerm:netapp/v20191101:Account")])
