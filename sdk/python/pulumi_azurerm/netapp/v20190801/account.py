...
class Account(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/latest:Account"), pulumi.Alias(type_="azurerm:netapp/v20190501:Account"), pulumi.Alias(type_="azurerm:netapp/v20190601:Account"), pulumi.Alias(type_="azurerm:netapp/v20190701:Account"), pulumi.Alias(type_="azurerm:netapp/v20191001:Account"), pulumi.Alias(type_="azurerm:netapp/v20191101:Account"), pulumi.Alias(type_="azurerm:netapp/v20200201:Account"), pulumi.Alias(type_="azurerm:netapp/v20200601:Account")])
