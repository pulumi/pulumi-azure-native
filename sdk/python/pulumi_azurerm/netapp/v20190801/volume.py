...
class Volume(pulumi.CustomResource):
    ...
    """
    data_protection: pulumi.Output[dict]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, account_name=None, creation_token=None, data_protection=None, export_policy=None, location=None, mount_targets=None, name=None, pool_name=None, protocol_types=None, resource_group_name=None, service_level=None, snapshot_id=None, subnet_id=None, tags=None, usage_threshold=None, volume_type=None, __props__=None, __name__=None, __opts__=None):
        """
        Volume resource
        ...
        :param pulumi.Input[dict] data_protection: DataProtection volume, can have a replication object
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/v20190501:Volume"), pulumi.Alias(type_="azurerm:netapp/v20190601:Volume"), pulumi.Alias(type_="azurerm:netapp/v20190701:Volume"), pulumi.Alias(type_="azurerm:netapp/v20191001:Volume"), pulumi.Alias(type_="azurerm:netapp/v20191101:Volume"), pulumi.Alias(type_="azurerm:netapp/v20200201:Volume")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Volume, __self__).__init__(
            'azurerm:netapp/v20190801:Volume',
            resource_name,
            __props__,
            opts)
