...
class Snapshot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, file_system_id=None, location=None, name=None, pool_name=None, resource_group_name=None, volume_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/v20190501:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20190601:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20190801:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20191001:Snapshot"), pulumi.Alias(type_="azurerm:netapp/v20191101:Snapshot")])
