...
class Volume(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:netapp/latest:Volume"), pulumi.Alias(type_="azurerm:netapp/v20190501:Volume"), pulumi.Alias(type_="azurerm:netapp/v20190601:Volume"), pulumi.Alias(type_="azurerm:netapp/v20190801:Volume"), pulumi.Alias(type_="azurerm:netapp/v20191001:Volume"), pulumi.Alias(type_="azurerm:netapp/v20191101:Volume"), pulumi.Alias(type_="azurerm:netapp/v20200201:Volume"), pulumi.Alias(type_="azurerm:netapp/v20200601:Volume")])
