...
class GetprivateLinkForAzureAdResult:
    ...
    @property
    @pulumi.getter
    def tenants(self) -> Optional[List[str]]:
        """
...
def getprivate_link_for_azure_ad(policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:aadiam/preview:getprivateLinkForAzureAd', __args__, opts=opts, typ=GetprivateLinkForAzureAdResult).value
