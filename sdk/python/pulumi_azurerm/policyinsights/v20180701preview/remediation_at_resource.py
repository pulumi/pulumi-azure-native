...
class RemediationAtResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        remediation_at_resource = azurerm.policyinsights.v20180701preview.RemediationAtResource("remediationAtResource",
            policy_assignment_id="/subscriptions/35ee058e-5fa0-414c-8145-3ebb8d09b6e2/resourceGroups/rg1/providers/microsoft.authorization/policyassignments/b101830944f246d8a14088c5",
            remediation_name="storageRemediation",
            resource_id="subscriptions/35ee058e-5fa0-414c-8145-3ebb8d09b6e2/resourcegroups/rg1/providers/microsoft.storage/storageaccounts/storAc1")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:policyinsights/latest:RemediationAtResource"), pulumi.Alias(type_="azurerm:policyinsights/v20190701:RemediationAtResource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemediationAtResource, __self__).__init__(
            'azurerm:policyinsights/v20180701preview:RemediationAtResource',
            resource_name,
            __props__,
            opts)
