...
def get_remediation_at_resource(remediation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:policyinsights/v20180701preview:getRemediationAtResource', __args__, opts=opts, typ=GetRemediationAtResourceResult).value
