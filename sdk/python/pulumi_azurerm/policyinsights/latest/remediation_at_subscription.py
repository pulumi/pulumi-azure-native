...
class RemediationAtSubscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:policyinsights/preview:RemediationAtSubscription"), pulumi.Alias(type_="azurerm:policyinsights/v20180701preview:RemediationAtSubscription"), pulumi.Alias(type_="azurerm:policyinsights/v20190701:RemediationAtSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemediationAtSubscription, __self__).__init__(
            'azurerm:policyinsights/latest:RemediationAtSubscription',
            resource_name,
            __props__,
            opts)
