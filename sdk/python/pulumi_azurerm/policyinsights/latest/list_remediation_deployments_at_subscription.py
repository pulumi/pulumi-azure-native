...
def list_remediation_deployments_at_subscription(remediation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:policyinsights/latest:listRemediationDeploymentsAtSubscription', __args__, opts=opts, typ=ListRemediationDeploymentsAtSubscriptionResult).value
