...
def list_remediation_deployments_at_resource(remediation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:policyinsights/latest:listRemediationDeploymentsAtResource', __args__, opts=opts, typ=ListRemediationDeploymentsAtResourceResult).value
