...
def list_remediation_deployments_at_resource(remediation_name=None, resource_id=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:policyinsights:listRemediationDeploymentsAtResource', __args__, opts=opts).value
