...
def get_remediation_at_resource_group(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:policyinsights/v20190701:getRemediationAtResourceGroup', __args__, opts=opts, typ=GetRemediationAtResourceGroupResult).value
