...
class RemediationAtSubscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        remediation_at_subscription = azurerm.policyinsights.v20190701.RemediationAtSubscription("remediationAtSubscription",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:policyinsights/latest:RemediationAtSubscription"), pulumi.Alias(type_="azurerm:policyinsights/v20180701preview:RemediationAtSubscription")])
