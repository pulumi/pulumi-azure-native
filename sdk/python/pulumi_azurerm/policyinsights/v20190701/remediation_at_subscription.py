...
class RemediationAtSubscription(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, filters=None, name=None, policy_assignment_id=None, policy_definition_reference_id=None, resource_discovery_mode=None, __props__=None, __name__=None, __opts__=None):
        """
