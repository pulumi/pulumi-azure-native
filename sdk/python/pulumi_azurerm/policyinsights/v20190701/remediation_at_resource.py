...
class RemediationAtResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:policyinsights/latest:RemediationAtResource"), pulumi.Alias(type_="azurerm:policyinsights/preview:RemediationAtResource"), pulumi.Alias(type_="azurerm:policyinsights/v20180701preview:RemediationAtResource")])
