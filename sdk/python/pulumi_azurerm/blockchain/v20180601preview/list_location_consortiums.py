...
class ListLocationConsortiumsResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[List['outputs.ConsortiumResponseResult']]:
        """
...
def list_location_consortiums(location_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:blockchain/v20180601preview:listLocationConsortiums', __args__, opts=opts, typ=ListLocationConsortiumsResult).value
