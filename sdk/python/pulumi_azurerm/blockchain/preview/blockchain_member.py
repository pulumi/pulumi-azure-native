...
class BlockchainMember(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:blockchain/v20180601preview:BlockchainMember")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlockchainMember, __self__).__init__(
            'azurerm:blockchain/preview:BlockchainMember',
            resource_name,
            __props__,
            opts)
