...
class Factory(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datafactory/preview:Factory"), pulumi.Alias(type_="azurerm:datafactory/v20170901preview:Factory"), pulumi.Alias(type_="azurerm:datafactory/v20180601:Factory")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Factory, __self__).__init__(
            'azurerm:datafactory/latest:Factory',
            resource_name,
            __props__,
            opts)
