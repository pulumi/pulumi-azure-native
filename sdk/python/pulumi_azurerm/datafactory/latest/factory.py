...
class Factory(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datafactory/v20170901preview:Factory"), pulumi.Alias(type_="azurerm:datafactory/v20180601:Factory")])
