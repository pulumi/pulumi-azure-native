...
class Pipeline(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datafactory/preview:Pipeline"), pulumi.Alias(type_="azurerm:datafactory/v20170901preview:Pipeline"), pulumi.Alias(type_="azurerm:datafactory/v20180601:Pipeline")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pipeline, __self__).__init__(
            'azurerm:datafactory/latest:Pipeline',
            resource_name,
            __props__,
            opts)
