...
def list_integration_runtime_auth_keys(factory_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datafactory/v20180601:listIntegrationRuntimeAuthKeys', __args__, opts=opts, typ=ListIntegrationRuntimeAuthKeysResult).value
