...
def get_linked_service(factory_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datafactory:getLinkedService', __args__, opts=opts).value
