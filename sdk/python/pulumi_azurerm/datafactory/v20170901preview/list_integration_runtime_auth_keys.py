...
def list_integration_runtime_auth_keys(factory_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datafactory/v20170901preview:listIntegrationRuntimeAuthKeys', __args__, opts=opts, typ=ListIntegrationRuntimeAuthKeysResult).value
