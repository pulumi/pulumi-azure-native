...
class IntegrationRuntime(pulumi.CustomResource):
    def __init__(__self__,
        ...
        integration_runtime = azurerm.datafactory.v20170901preview.IntegrationRuntime("integrationRuntime",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datafactory/latest:IntegrationRuntime"), pulumi.Alias(type_="azurerm:datafactory/v20180601:IntegrationRuntime")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationRuntime, __self__).__init__(
            'azurerm:datafactory/v20170901preview:IntegrationRuntime',
            resource_name,
            __props__,
            opts)
