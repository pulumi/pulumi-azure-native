...
class Factory(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datafactory/latest:Factory"), pulumi.Alias(type_="azurerm:datafactory/v20180601:Factory")])
