...
class Account(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cognitiveservices/latest:Account"), pulumi.Alias(type_="azurerm:cognitiveservices/v20160201preview:Account"), pulumi.Alias(type_="azurerm:cognitiveservices/v20170418:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azurerm:cognitiveservices/preview:Account',
            resource_name,
            __props__,
            opts)
