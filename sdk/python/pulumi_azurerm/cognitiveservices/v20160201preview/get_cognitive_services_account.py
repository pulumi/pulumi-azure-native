...
def get_cognitive_services_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:cognitiveservices/v20160201preview:getCognitiveServicesAccount', __args__, opts=opts, typ=GetCognitiveServicesAccountResult).value
