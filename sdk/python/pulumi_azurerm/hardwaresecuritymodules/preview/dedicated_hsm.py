...
class DedicatedHsm(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] zones: The Dedicated Hsm zones.
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hardwaresecuritymodules/v20181031preview:DedicatedHsm")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DedicatedHsm, __self__).__init__(
            'azurerm:hardwaresecuritymodules/preview:DedicatedHsm',
            resource_name,
            __props__,
            opts)
