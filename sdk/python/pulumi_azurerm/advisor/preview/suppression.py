...
class Suppression(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['ttl'] = ttl
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:advisor/latest:Suppression"), pulumi.Alias(type_="azurerm:advisor/v20160712preview:Suppression"), pulumi.Alias(type_="azurerm:advisor/v20170331:Suppression"), pulumi.Alias(type_="azurerm:advisor/v20170419:Suppression"), pulumi.Alias(type_="azurerm:advisor/v20200101:Suppression")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Suppression, __self__).__init__(
            'azurerm:advisor/preview:Suppression',
            resource_name,
            __props__,
            opts)
