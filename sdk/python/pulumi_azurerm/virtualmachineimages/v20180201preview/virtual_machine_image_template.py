...
class VirtualMachineImageTemplate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:virtualmachineimages/latest:VirtualMachineImageTemplate"), pulumi.Alias(type_="azurerm:virtualmachineimages/preview:VirtualMachineImageTemplate"), pulumi.Alias(type_="azurerm:virtualmachineimages/v20190201preview:VirtualMachineImageTemplate"), pulumi.Alias(type_="azurerm:virtualmachineimages/v20190501preview:VirtualMachineImageTemplate"), pulumi.Alias(type_="azurerm:virtualmachineimages/v20200214:VirtualMachineImageTemplate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineImageTemplate, __self__).__init__(
            'azurerm:virtualmachineimages/v20180201preview:VirtualMachineImageTemplate',
            resource_name,
            __props__,
            opts)
