...
def get_virtual_machine_image_template(image_template_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:virtualmachineimages/latest:getVirtualMachineImageTemplate', __args__, opts=opts, typ=GetVirtualMachineImageTemplateResult).value
