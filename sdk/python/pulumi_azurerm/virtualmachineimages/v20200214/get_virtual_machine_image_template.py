...
def get_virtual_machine_image_template(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:virtualmachineimages/v20200214:getVirtualMachineImageTemplate', __args__, opts=opts, typ=GetVirtualMachineImageTemplateResult).value
