...
class VirtualMachineImageTemplate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        virtual_machine_image_template = azurerm.virtualmachineimages.v20200214.VirtualMachineImageTemplate("virtualMachineImageTemplate",
            customize=[{
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:virtualmachineimages/latest:VirtualMachineImageTemplate")])
