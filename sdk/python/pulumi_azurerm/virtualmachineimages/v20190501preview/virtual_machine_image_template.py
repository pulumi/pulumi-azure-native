...
class VirtualMachineImageTemplate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 customize: Optional[pulumi.Input[List[pulumi.Input[Union[pulumi.InputType['ImageTemplateFileCustomizerArgs'], pulumi.InputType['ImageTemplatePowerShellCustomizerArgs'], pulumi.InputType['ImageTemplateRestartCustomizerArgs'], pulumi.InputType['ImageTemplateShellCustomizerArgs']]]]]] = None,
        ...
        virtual_machine_image_template = azurerm.virtualmachineimages.v20190501preview.VirtualMachineImageTemplate("virtualMachineImageTemplate",
            customize=[{
