...
class VirtualMachineImageTemplate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 customize: Optional[pulumi.Input[List[pulumi.Input[Union[pulumi.InputType['ImageTemplatePowerShellCustomizerArgs'], pulumi.InputType['ImageTemplateRestartCustomizerArgs'], pulumi.InputType['ImageTemplateShellCustomizerArgs']]]]]] = None,
        ...
        virtual_machine_image_template = azurerm.virtualmachineimages.v20190201preview.VirtualMachineImageTemplate("virtualMachineImageTemplate",
            customize=[{
        ...
        super(VirtualMachineImageTemplate, __self__).__init__(
            'azurerm:virtualmachineimages/v20190201preview:VirtualMachineImageTemplate',
            resource_name,
            __props__,
            opts)
