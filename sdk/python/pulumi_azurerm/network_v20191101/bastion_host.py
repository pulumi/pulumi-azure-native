...
class BastionHost(pulumi.CustomResource):
    ...
    Represents the bastion host resource.
      ...
      * `ip_configurations` (`list`) - IP configuration of the Bastion Host resource.
        ...
        * `properties` (`dict`) - Represents the ip configuration associated with the resource.
          ...
          * `provisioning_state` (`str`) - The provisioning state of the bastion host IP configuration resource.
      ...
      * `provisioning_state` (`str`) - The provisioning state of the bastion host resource.
    """
    ...
    def __init__(__self__, resource_name, opts=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(BastionHost, __self__).__init__(
            'azurerm:network/v20191101:BastionHost',
            resource_name,
            __props__,
            opts)
