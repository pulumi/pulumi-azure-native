...
def get_report_config_by_resource_group_name(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:costmanagement/v20180531:getReportConfigByResourceGroupName', __args__, opts=opts, typ=GetReportConfigByResourceGroupNameResult).value
