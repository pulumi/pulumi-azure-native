...
class ReportConfig(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:costmanagement/latest:ReportConfig"), pulumi.Alias(type_="azurerm:costmanagement/preview:ReportConfig")])
