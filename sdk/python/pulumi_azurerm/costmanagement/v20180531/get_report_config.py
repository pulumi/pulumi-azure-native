...
def get_report_config(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:costmanagement/v20180531:getReportConfig', __args__, opts=opts, typ=GetReportConfigResult).value
