...
class ExportDatasetConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The export dataset configuration. Allows columns to be selected for the export. If not provided then the export will include all available columns.
        :param List[str] columns: Array of column names to be included in the export. If not provided then the export will include all available columns. The available columns can vary by customer channel (see examples).
        """
...
class ExportExecutionListResultResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 value: List['outputs.ExportExecutionResponse']):
        """
        Result of listing the execution history of an export.
        :param List['ExportExecutionResponseArgs'] value: A list of export executions.
        """
        pulumi.set(__self__, "value", value)

    @property
    @pulumi.getter
    def value(self) -> List['outputs.ExportExecutionResponse']:
        """
...
class ReportConfigDatasetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sorting: Optional[List['outputs.ReportConfigSortingResponse']] = None):
        """
        The definition of data present in the report.
        ...
        :param List['ReportConfigSortingResponseArgs'] sorting: Array of order by expression to use in the report.
        """
    ...
    @property
    @pulumi.getter
    def sorting(self) -> Optional[List['outputs.ReportConfigSortingResponse']]:
        """
