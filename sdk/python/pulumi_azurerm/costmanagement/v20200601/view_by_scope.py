...
class ViewByScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:costmanagement/latest:ViewByScope"), pulumi.Alias(type_="azurerm:costmanagement/v20191101:ViewByScope")])
