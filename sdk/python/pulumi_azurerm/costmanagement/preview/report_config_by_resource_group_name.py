...
class ReportConfigByResourceGroupName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:costmanagement/latest:ReportConfigByResourceGroupName"), pulumi.Alias(type_="azurerm:costmanagement/v20180531:ReportConfigByResourceGroupName")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReportConfigByResourceGroupName, __self__).__init__(
            'azurerm:costmanagement/preview:ReportConfigByResourceGroupName',
            resource_name,
            __props__,
            opts)
