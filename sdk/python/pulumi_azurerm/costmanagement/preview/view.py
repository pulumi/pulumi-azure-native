...
class View(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:costmanagement/latest:View"), pulumi.Alias(type_="azurerm:costmanagement/v20190401preview:View"), pulumi.Alias(type_="azurerm:costmanagement/v20191101:View"), pulumi.Alias(type_="azurerm:costmanagement/v20200601:View")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(View, __self__).__init__(
            'azurerm:costmanagement/preview:View',
            resource_name,
            __props__,
            opts)
