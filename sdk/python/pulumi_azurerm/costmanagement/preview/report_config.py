...
class ReportConfig(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:costmanagement/latest:ReportConfig"), pulumi.Alias(type_="azurerm:costmanagement/v20180531:ReportConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReportConfig, __self__).__init__(
            'azurerm:costmanagement/preview:ReportConfig',
            resource_name,
            __props__,
            opts)
