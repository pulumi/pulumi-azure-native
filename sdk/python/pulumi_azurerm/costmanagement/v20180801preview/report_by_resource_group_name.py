...
class ReportByResourceGroupName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:costmanagement/preview:ReportByResourceGroupName")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReportByResourceGroupName, __self__).__init__(
            'azurerm:costmanagement/v20180801preview:ReportByResourceGroupName',
            resource_name,
            __props__,
            opts)
