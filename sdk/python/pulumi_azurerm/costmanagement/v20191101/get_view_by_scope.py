...
def get_view_by_scope(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:costmanagement/v20191101:getViewByScope', __args__, opts=opts, typ=GetViewByScopeResult).value
