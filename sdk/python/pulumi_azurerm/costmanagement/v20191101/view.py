...
class View(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:costmanagement/latest:View"), pulumi.Alias(type_="azurerm:costmanagement/v20190401preview:View"), pulumi.Alias(type_="azurerm:costmanagement/v20200601:View")])
