...
class Domain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:domainregistration/latest:Domain"), pulumi.Alias(type_="azurerm:domainregistration/preview:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20150801:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20180201:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20190801:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20200601:Domain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Domain, __self__).__init__(
            'azurerm:domainregistration/v20150401:Domain',
            resource_name,
            __props__,
            opts)
    ...
    def domain_not_renewable_reasons(self) -> pulumi.Output[List[str]]:
        """
    ...
    def managed_host_names(self) -> pulumi.Output[List['outputs.HostNameResponse']]:
        """
