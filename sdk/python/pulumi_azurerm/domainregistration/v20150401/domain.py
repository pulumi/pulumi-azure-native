...
class Domain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:domainregistration/v20150801:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20180201:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20190801:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20200601:Domain")])
