...
class DomainOwnershipIdentifier(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, domain_name=None, kind=None, name=None, ownership_id=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:domainregistration/v20150401:DomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:domainregistration/v20190801:DomainOwnershipIdentifier")])
