...
class DomainOwnershipIdentifier(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:domainregistration/latest:DomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:domainregistration/v20150401:DomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:domainregistration/v20180201:DomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:domainregistration/v20200601:DomainOwnershipIdentifier")])
