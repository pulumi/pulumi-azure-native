...
class Domain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:domainregistration/latest:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20150401:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20150801:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20180201:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20190801:Domain"), pulumi.Alias(type_="azurerm:domainregistration/v20200601:Domain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Domain, __self__).__init__(
            'azurerm:domainregistration/preview:Domain',
            resource_name,
            __props__,
            opts)
