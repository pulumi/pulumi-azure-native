...
def list_global_domain_registration_domain_recommendations(keywords: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:domainregistration/v20150801:listGlobalDomainRegistrationDomainRecommendations', __args__, opts=opts, typ=ListGlobalDomainRegistrationDomainRecommendationsResult).value
