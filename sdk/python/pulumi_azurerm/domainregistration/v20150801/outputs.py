...
class DomainPurchaseConsentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param List[str] agreement_keys: List of applicable legal agreement keys. This list can be retrieved using ListLegalAgreements Api under TopLevelDomain resource
        """
...
class HostNameResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param List[str] site_names: List of sites the hostname is assigned to. This list will have more than one site only if the hostname is pointing to a Traffic Manager
        """
