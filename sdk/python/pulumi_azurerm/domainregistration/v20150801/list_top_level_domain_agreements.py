...
def list_top_level_domain_agreements(include_privacy=None, name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:domainregistration/v20150801:listTopLevelDomainAgreements', __args__, opts=opts).value
