...
def list_domain_recommendations(keywords: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:domainregistration/latest:listDomainRecommendations', __args__, opts=opts, typ=ListDomainRecommendationsResult).value
