...
def get_domain_ownership_identifier(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:domainregistration/latest:getDomainOwnershipIdentifier', __args__, opts=opts, typ=GetDomainOwnershipIdentifierResult).value
