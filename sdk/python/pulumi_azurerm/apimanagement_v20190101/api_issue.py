...
class ApiIssue(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_id=None, name=None, properties=None, resource_group_name=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: Properties of the Issue.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[str] service_name: The name of the API Management service.

        The **properties** object supports the following:

          * `api_id` (`pulumi.Input[str]`) - A resource identifier for the API the issue was created for.
          * `created_date` (`pulumi.Input[str]`) - Date and time when the issue was created.
          * `description` (`pulumi.Input[str]`) - Text describing the issue.
          * `state` (`pulumi.Input[str]`) - Status of the issue.
          * `title` (`pulumi.Input[str]`) - The issue title.
          * `user_id` (`pulumi.Input[str]`) - A resource identifier for the user created the issue.
        """
        ...
        super(ApiIssue, __self__).__init__(
            'azurerm:apimanagement/v20190101:ApiIssue',
            resource_name,
            __props__,
            opts)
