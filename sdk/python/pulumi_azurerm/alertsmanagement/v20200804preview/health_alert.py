...
class HealthAlert(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:alertsmanagement/preview:HealthAlert")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HealthAlert, __self__).__init__(
            'azurerm:alertsmanagement/v20200804preview:HealthAlert',
            resource_name,
            __props__,
            opts)
