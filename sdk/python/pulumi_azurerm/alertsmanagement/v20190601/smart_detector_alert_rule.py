...
class SmartDetectorAlertRule(pulumi.CustomResource):
    ...
    The resource type.
    """
    def __init__(__self__, resource_name, opts=None, action_groups=None, description=None, detector=None, frequency=None, location=None, name=None, resource_group_name=None, scope=None, severity=None, state=None, tags=None, throttling=None, __props__=None, __name__=None, __opts__=None):
        """
