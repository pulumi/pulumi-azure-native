...
class VirtualMachineScaleSet(pulumi.CustomResource):
    ...
    The identity of the virtual machine scale set, if configured.
      ...
      * `type` (`str`) - The type of identity used for the virtual machine scale set. Currently, the only supported type is 'SystemAssigned', which implicitly creates an identity.
    """
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, location=None, name=None, plan=None, properties=None, resource_group_name=None, sku=None, tags=None, zones=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **identity** object supports the following:
          ...
          * `type` (`pulumi.Input[str]`) - The type of identity used for the virtual machine scale set. Currently, the only supported type is 'SystemAssigned', which implicitly creates an identity.
