...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        server = azurerm.dbformariadb.v20180601preview.Server("server",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformariadb/latest:Server"), pulumi.Alias(type_="azurerm:dbformariadb/v20180601:Server")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Server, __self__).__init__(
            'azurerm:dbformariadb/v20180601preview:Server',
            resource_name,
            __props__,
            opts)
