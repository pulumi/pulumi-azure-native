...
class VirtualNetworkRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformariadb/latest:VirtualNetworkRule"), pulumi.Alias(type_="azurerm:dbformariadb/preview:VirtualNetworkRule"), pulumi.Alias(type_="azurerm:dbformariadb/v20180601:VirtualNetworkRule")])
