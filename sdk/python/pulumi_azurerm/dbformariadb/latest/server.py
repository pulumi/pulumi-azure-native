...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        server = azurerm.dbformariadb.latest.Server("server",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformariadb/v20180601:Server"), pulumi.Alias(type_="azurerm:dbformariadb/v20180601preview:Server")])
