...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformariadb/latest:FirewallRule"), pulumi.Alias(type_="azurerm:dbformariadb/v20180601:FirewallRule"), pulumi.Alias(type_="azurerm:dbformariadb/v20180601preview:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azurerm:dbformariadb/preview:FirewallRule',
            resource_name,
            __props__,
            opts)
