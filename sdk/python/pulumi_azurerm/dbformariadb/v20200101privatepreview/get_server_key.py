...
def get_server_key(key_name: Optional[str] = None,
    ...
    :param str key_name: The name of the MariaDB Server key to be retrieved.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:dbformariadb/v20200101privatepreview:getServerKey', __args__, opts=opts, typ=GetServerKeyResult).value
