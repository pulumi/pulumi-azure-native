...
def get_data_set_mapping(account_name=None, name=None, resource_group_name=None, share_subscription_name=None, opts=None):
    """
    Use this data source to access information about an existing resource.

    :param str account_name: The name of the share account.
    :param str name: The name of the dataSetMapping.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datashare/v20191101:getDataSetMapping', __args__, opts=opts).value
