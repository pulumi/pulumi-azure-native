...
class SupportPlanType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:addons/latest:SupportPlanType"), pulumi.Alias(type_="azurerm:addons/preview:SupportPlanType"), pulumi.Alias(type_="azurerm:addons/v20180301:SupportPlanType")])
