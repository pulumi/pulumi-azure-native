...
class SupportPlanType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        support_plan_type = azurerm.addons.v20170515.SupportPlanType("supportPlanType",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:addons/latest:SupportPlanType"), pulumi.Alias(type_="azurerm:addons/v20180301:SupportPlanType")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SupportPlanType, __self__).__init__(
            'azurerm:addons/v20170515:SupportPlanType',
            resource_name,
            __props__,
            opts)
