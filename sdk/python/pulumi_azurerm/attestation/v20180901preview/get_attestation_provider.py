...
class GetAttestationProviderResult:
    ...
    """
    def __init__(__self__, attest_uri=None, location=None, name=None, status=None, tags=None, trust_model=None, type=None):
...
def get_attestation_provider(provider_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:attestation/v20180901preview:getAttestationProvider', __args__, opts=opts, typ=GetAttestationProviderResult).value
