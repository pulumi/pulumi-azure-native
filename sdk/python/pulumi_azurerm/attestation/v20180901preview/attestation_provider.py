...
class AttestationProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] provider_name: Name of the attestation service
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:attestation/preview:AttestationProvider")])
