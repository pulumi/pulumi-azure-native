...
class StorageAccountPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(StorageAccountPrivateEndpointConnection, __self__).__init__(
            'azurerm:storage:StorageAccountPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        """
        Get an existing StorageAccountPrivateEndpointConnection resource's state with the given name, id, and optional extra
        ...
        return StorageAccountPrivateEndpointConnection(resource_name, opts=opts, __props__=__props__)
