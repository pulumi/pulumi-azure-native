...
class StorageAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        storage_account = azurerm.storage.v20180701.StorageAccount("storageAccount",
