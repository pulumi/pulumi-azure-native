...
class GetStorageAccountResult:
    ...
    def __init__(__self__, access_tier=None, creation_time=None, custom_domain=None, enable_azure_files_aad_integration=None, enable_https_traffic_only=None, encryption=None, failover_in_progress=None, geo_replication_stats=None, identity=None, is_hns_enabled=None, kind=None, last_geo_failover_time=None, location=None, name=None, network_rule_set=None, primary_endpoints=None, primary_location=None, provisioning_state=None, secondary_endpoints=None, secondary_location=None, sku=None, status_of_primary=None, status_of_secondary=None, tags=None, type=None):
        ...
        __self__.enable_azure_files_aad_integration = enable_azure_files_aad_integration
        """
        ...
        __self__.failover_in_progress = failover_in_progress
        """
        ...
        __self__.geo_replication_stats = geo_replication_stats
        """
...
def get_storage_account(expand=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    return AwaitableGetStorageAccountResult(
        ...
        enable_azure_files_aad_integration=__ret__.get('enableAzureFilesAadIntegration'),
        enable_https_traffic_only=__ret__.get('enableHttpsTrafficOnly'),
        encryption=__ret__.get('encryption'),
        failover_in_progress=__ret__.get('failoverInProgress'),
        geo_replication_stats=__ret__.get('geoReplicationStats'),
