...
class StorageAccountFileServiceShare(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        super(StorageAccountFileServiceShare, __self__).__init__(
            'azurerm:storage:StorageAccountFileServiceShare',
            resource_name,
            __props__,
            opts)
