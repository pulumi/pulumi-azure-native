...
class FileShare(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storage/latest:FileShare"), pulumi.Alias(type_="azurerm:storage/v20190401:FileShare"), pulumi.Alias(type_="azurerm:storage/v20200801preview:FileShare")])
