...
class BlobContainerImmutabilityPolicy(pulumi.CustomResource):
    ...
    def immutability_period_since_creation_in_days(self) -> pulumi.Output[Optional[float]]:
        """
