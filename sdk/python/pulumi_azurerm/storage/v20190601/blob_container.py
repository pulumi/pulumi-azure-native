...
class BlobContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storage/v20180201:BlobContainer"), pulumi.Alias(type_="azurerm:storage/v20180701:BlobContainer"), pulumi.Alias(type_="azurerm:storage/v20181101:BlobContainer"), pulumi.Alias(type_="azurerm:storage/v20190401:BlobContainer")])
