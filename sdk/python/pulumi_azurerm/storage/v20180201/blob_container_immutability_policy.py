...
class BlobContainerImmutabilityPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        blob_container_immutability_policy = azurerm.storage.v20180201.BlobContainerImmutabilityPolicy("blobContainerImmutabilityPolicy",
