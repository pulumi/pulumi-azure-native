...
class GetStorageAccountResult:
    ...
    def __init__(__self__, access_tier=None, allow_blob_public_access=None, azure_files_identity_based_authentication=None, creation_time=None, custom_domain=None, enable_https_traffic_only=None, encryption=None, failover_in_progress=None, geo_replication_stats=None, identity=None, is_hns_enabled=None, kind=None, large_file_shares_state=None, last_geo_failover_time=None, location=None, minimum_tls_version=None, name=None, network_rule_set=None, primary_endpoints=None, primary_location=None, provisioning_state=None, secondary_endpoints=None, secondary_location=None, sku=None, status_of_primary=None, status_of_secondary=None, tags=None, type=None):
        ...
        __self__.azure_files_identity_based_authentication = azure_files_identity_based_authentication
        """
        ...
        __self__.large_file_shares_state = large_file_shares_state
        """
...
def get_storage_account(expand=None, name=None, resource_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storage/v20190401:getStorageAccount', __args__, opts=opts).value
    ...
    return AwaitableGetStorageAccountResult(
        ...
        azure_files_identity_based_authentication=__ret__.get('azureFilesIdentityBasedAuthentication'),
        ...
        large_file_shares_state=__ret__.get('largeFileSharesState'),
