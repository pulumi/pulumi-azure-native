...
class FileShare(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storage/latest:FileShare"), pulumi.Alias(type_="azurerm:storage/v20190601:FileShare"), pulumi.Alias(type_="azurerm:storage/v20200801preview:FileShare")])
