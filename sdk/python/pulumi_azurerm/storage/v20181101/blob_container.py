...
class BlobContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        blob_container = azurerm.storage.v20181101.BlobContainer("blobContainer",
            account_name="sto328",
