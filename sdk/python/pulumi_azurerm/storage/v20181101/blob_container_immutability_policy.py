...
class BlobContainerImmutabilityPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storage/latest:BlobContainerImmutabilityPolicy"), pulumi.Alias(type_="azurerm:storage/v20180201:BlobContainerImmutabilityPolicy"), pulumi.Alias(type_="azurerm:storage/v20180301preview:BlobContainerImmutabilityPolicy"), pulumi.Alias(type_="azurerm:storage/v20180701:BlobContainerImmutabilityPolicy"), pulumi.Alias(type_="azurerm:storage/v20190401:BlobContainerImmutabilityPolicy"), pulumi.Alias(type_="azurerm:storage/v20190601:BlobContainerImmutabilityPolicy"), pulumi.Alias(type_="azurerm:storage/v20200801preview:BlobContainerImmutabilityPolicy")])
