...
def get_blob_container(account_name: Optional[str] = None,
    ...
    :param str name: The name of the blob container within the specified storage account. Blob container names must be between 3 and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must be immediately preceded and followed by a letter or number.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storage/v20181101:getBlobContainer', __args__, opts=opts, typ=GetBlobContainerResult).value
