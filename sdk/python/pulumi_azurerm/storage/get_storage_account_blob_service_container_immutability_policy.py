...
class AwaitableGetStorageAccountBlobServiceContainerImmutabilityPolicyResult(GetStorageAccountBlobServiceContainerImmutabilityPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetStorageAccountBlobServiceContainerImmutabilityPolicyResult(
            etag=self.etag,
            name=self.name,
...
def get_storage_account_blob_service_container_immutability_policy(account_name=None, container_name=None, name=None, resource_group_name=None, opts=None):
    """
