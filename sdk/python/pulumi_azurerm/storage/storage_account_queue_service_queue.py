...
class StorageAccountQueueServiceQueue(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a StorageAccountQueueServiceQueue resource with the given unique name, props, and options.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(StorageAccountQueueServiceQueue, __self__).__init__(
            'azurerm:storage:StorageAccountQueueServiceQueue',
            resource_name,
            __props__,
            opts)
