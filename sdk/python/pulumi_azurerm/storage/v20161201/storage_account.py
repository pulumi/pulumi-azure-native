...
class StorageAccount(pulumi.CustomResource):
    ...
    Resource type
    """
    def __init__(__self__, resource_name, opts=None, access_tier=None, custom_domain=None, enable_https_traffic_only=None, encryption=None, kind=None, location=None, name=None, resource_group_name=None, sku=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        The storage account.
