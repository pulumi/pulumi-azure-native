...
class StorageAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storage/latest:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20150501preview:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20150615:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20160101:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20160501:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20170601:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20171001:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20180201:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20180301preview:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20180701:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20181101:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20190401:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20190601:StorageAccount"), pulumi.Alias(type_="azurerm:storage/v20200801preview:StorageAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageAccount, __self__).__init__(
            'azurerm:storage/v20161201:StorageAccount',
            resource_name,
            __props__,
            opts)
