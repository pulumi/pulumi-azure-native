...
def get_storage_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storage/v20161201:getStorageAccount', __args__, opts=opts, typ=GetStorageAccountResult).value
