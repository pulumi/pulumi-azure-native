...
class ManagementPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storage/latest:ManagementPolicy"), pulumi.Alias(type_="azurerm:storage/v20181101:ManagementPolicy"), pulumi.Alias(type_="azurerm:storage/v20190401:ManagementPolicy"), pulumi.Alias(type_="azurerm:storage/v20190601:ManagementPolicy"), pulumi.Alias(type_="azurerm:storage/v20200801preview:ManagementPolicy")])
