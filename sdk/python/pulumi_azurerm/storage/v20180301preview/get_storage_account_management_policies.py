...
def get_storage_account_management_policies(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storage/v20180301preview:getStorageAccountManagementPolicies', __args__, opts=opts, typ=GetStorageAccountManagementPoliciesResult).value
