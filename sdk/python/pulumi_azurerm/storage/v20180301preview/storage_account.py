...
class StorageAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        storage_account = azurerm.storage.v20180301preview.StorageAccount("storageAccount",
