...
def get_object_replication_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storage/v20200801preview:getObjectReplicationPolicy', __args__, opts=opts, typ=GetObjectReplicationPolicyResult).value
