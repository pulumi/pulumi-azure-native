...
class GetAvailabilityGroupListenerResult:
    ...
    def load_balancer_configurations(self) -> Optional[List['outputs.LoadBalancerConfigurationResponse']]:
        """
...
def get_availability_group_listener(availability_group_listener_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:sqlvirtualmachine/v20170301preview:getAvailabilityGroupListener', __args__, opts=opts, typ=GetAvailabilityGroupListenerResult).value
