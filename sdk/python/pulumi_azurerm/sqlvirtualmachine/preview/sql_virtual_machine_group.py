...
class SqlVirtualMachineGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlVirtualMachineGroup, __self__).__init__(
            'azurerm:sqlvirtualmachine/preview:SqlVirtualMachineGroup',
            resource_name,
            __props__,
            opts)
