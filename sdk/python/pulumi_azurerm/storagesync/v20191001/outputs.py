...
class CloudTieringCachePerformanceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cache_hit_bytes_percent: float,
                 cache_miss_bytes: float,
                 last_updated_timestamp: str):
        """
        Server endpoint cloud tiering status object.
        :param float cache_hit_bytes: Count of bytes that were served from the local server
        :param float cache_hit_bytes_percent: Percentage of total bytes (hit + miss) that were served from the local server
    ...
    def cache_hit_bytes_percent(self) -> float:
        """
...
class CloudTieringFilesNotTieringResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 errors: List['outputs.FilesNotTieringErrorResponse'],
                 last_updated_timestamp: str,
                 total_file_count: float):
        """
        Server endpoint cloud tiering status object.
        :param List['FilesNotTieringErrorResponseArgs'] errors: Array of tiering errors
        :param str last_updated_timestamp: Last updated timestamp
    ...
    @property
    @pulumi.getter
    def errors(self) -> List['outputs.FilesNotTieringErrorResponse']:
        """
...
class CloudTieringSpaceSavingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float space_savings_percent: Percentage of cached size over total size
...
class CloudTieringVolumeFreeSpacePolicyStatusResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 current_volume_free_space_percent: float,
                 effective_volume_free_space_policy: float,
                 last_updated_timestamp: str):
        """
        Status of the volume free space policy
        :param float current_volume_free_space_percent: Current volume free space percentage.
        :param float effective_volume_free_space_policy: In the case where multiple server endpoints are present in a volume, an effective free space policy is applied.
        :param str last_updated_timestamp: Last updated timestamp
        """
    ...
    def current_volume_free_space_percent(self) -> float:
        """
    ...
    def effective_volume_free_space_policy(self) -> float:
        """
...
class FilesNotTieringErrorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Files not tiering error object
        :param float error_code: Error code (HResult)
...
class ServerEndpointCloudTieringStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_cloud_tiering_result: float,
        ...
        :param float last_cloud_tiering_result: Last cloud tiering result (HResult)
    ...
    def last_cloud_tiering_result(self) -> float:
        """
        Last cloud tiering result (HResult)
        """
...
class ServerEndpointRecallStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 last_updated_timestamp: str,
                 recall_errors: List['outputs.ServerEndpointRecallErrorResponse'],
                 total_recall_errors_count: float):
        """
        Server endpoint recall status object.
        :param str last_updated_timestamp: Last updated timestamp
        :param List['ServerEndpointRecallErrorResponseArgs'] recall_errors: Array of recall errors
    ...
    def recall_errors(self) -> List['outputs.ServerEndpointRecallErrorResponse']:
        """
...
class SyncSessionStatusResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 files_not_syncing_errors: List['outputs.ServerEndpointFilesNotSyncingErrorResponse'],
                 last_sync_per_item_error_count: float,
                 last_sync_result: float,
        ...
        """
        Sync Session status object.
        :param List['ServerEndpointFilesNotSyncingErrorResponseArgs'] files_not_syncing_errors: Array of per-item errors coming from the last sync session.
        :param float last_sync_per_item_error_count: Last sync per item error count.
        :param float last_sync_result: Last sync result (HResult)
    ...
    def files_not_syncing_errors(self) -> List['outputs.ServerEndpointFilesNotSyncingErrorResponse']:
        """
    ...
    def last_sync_result(self) -> float:
        """
