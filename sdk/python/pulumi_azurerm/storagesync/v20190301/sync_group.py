...
class SyncGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagesync/latest:SyncGroup"), pulumi.Alias(type_="azurerm:storagesync/v20180402:SyncGroup"), pulumi.Alias(type_="azurerm:storagesync/v20180701:SyncGroup"), pulumi.Alias(type_="azurerm:storagesync/v20181001:SyncGroup"), pulumi.Alias(type_="azurerm:storagesync/v20190201:SyncGroup"), pulumi.Alias(type_="azurerm:storagesync/v20190601:SyncGroup"), pulumi.Alias(type_="azurerm:storagesync/v20191001:SyncGroup"), pulumi.Alias(type_="azurerm:storagesync/v20200301:SyncGroup")])
