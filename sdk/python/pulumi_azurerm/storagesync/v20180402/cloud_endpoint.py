...
class CloudEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagesync/latest:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/preview:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/v20170605preview:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/v20180701:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/v20181001:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/v20190201:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/v20190301:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/v20190601:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/v20191001:CloudEndpoint"), pulumi.Alias(type_="azurerm:storagesync/v20200301:CloudEndpoint")])
