...
class StorageSyncService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        storage_sync_service = azurerm.storagesync.v20180402.StorageSyncService("storageSyncService",
            location="WestUS",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagesync/latest:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20170605preview:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20180701:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20181001:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20190201:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20190301:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20190601:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20191001:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20200301:StorageSyncService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageSyncService, __self__).__init__(
            'azurerm:storagesync/v20180402:StorageSyncService',
            resource_name,
            __props__,
            opts)
