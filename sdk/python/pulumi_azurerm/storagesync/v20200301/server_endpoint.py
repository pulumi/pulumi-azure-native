...
class ServerEndpoint(pulumi.CustomResource):
    ...
    Friendly Name
    """
    initial_download_policy: pulumi.Output[str]
    """
    ...
    """
    local_cache_mode: pulumi.Output[str]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, cloud_tiering=None, friendly_name=None, initial_download_policy=None, local_cache_mode=None, name=None, offline_data_transfer=None, offline_data_transfer_share_name=None, resource_group_name=None, server_local_path=None, server_resource_id=None, storage_sync_service_name=None, sync_group_name=None, tier_files_older_than_days=None, volume_free_space_percent=None, __props__=None, __name__=None, __opts__=None):
        """
