...
class GetServerEndpointResult:
    ...
    def __init__(__self__, cloud_tiering=None, cloud_tiering_status=None, friendly_name=None, initial_download_policy=None, last_operation_name=None, last_workflow_id=None, local_cache_mode=None, name=None, offline_data_transfer=None, offline_data_transfer_share_name=None, offline_data_transfer_storage_account_resource_id=None, offline_data_transfer_storage_account_tenant_id=None, provisioning_state=None, recall_status=None, server_local_path=None, server_resource_id=None, sync_status=None, tier_files_older_than_days=None, type=None, volume_free_space_percent=None):
        ...
        __self__.initial_download_policy = initial_download_policy
        """
        ...
        __self__.local_cache_mode = local_cache_mode
        """
...
def get_server_endpoint(name=None, resource_group_name=None, storage_sync_service_name=None, sync_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storagesync/v20200301:getServerEndpoint', __args__, opts=opts).value
    ...
    return AwaitableGetServerEndpointResult(
        ...
        initial_download_policy=__ret__.get('initialDownloadPolicy'),
        last_operation_name=__ret__.get('lastOperationName'),
        last_workflow_id=__ret__.get('lastWorkflowId'),
        local_cache_mode=__ret__.get('localCacheMode'),
