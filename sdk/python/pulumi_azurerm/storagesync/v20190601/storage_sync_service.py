...
class StorageSyncService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagesync/latest:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/preview:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20170605preview:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20180402:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20180701:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20181001:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20190201:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20190301:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20191001:StorageSyncService"), pulumi.Alias(type_="azurerm:storagesync/v20200301:StorageSyncService")])
