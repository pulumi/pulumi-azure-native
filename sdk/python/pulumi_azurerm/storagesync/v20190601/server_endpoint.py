...
class ServerEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        server_endpoint = azurerm.storagesync.v20190601.ServerEndpoint("serverEndpoint",
            cloud_tiering="off",
