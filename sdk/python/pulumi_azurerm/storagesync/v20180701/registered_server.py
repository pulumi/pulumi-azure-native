...
class RegisteredServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        registered_server = azurerm.storagesync.v20180701.RegisteredServer("registeredServer",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagesync/latest:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20170605preview:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20180402:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20181001:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20190201:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20190301:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20190601:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20191001:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20200301:RegisteredServer")])
