...
class CloudEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        cloud_endpoint = azurerm.storagesync.v20180701.CloudEndpoint("cloudEndpoint",
