...
class GetCloudEndpointResult:
    ...
    """
    def __init__(__self__, backup_enabled=None, friendly_name=None, last_workflow_id=None, name=None, partnership_id=None, provisioning_state=None, storage_account=None, storage_account_key=None, storage_account_resource_id=None, storage_account_share_name=None, storage_account_tenant_id=None, type=None):
...
def get_cloud_endpoint(cloud_endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storagesync/v20170605preview:getCloudEndpoint', __args__, opts=opts, typ=GetCloudEndpointResult).value
