...
class RegisteredServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        registered_server = azurerm.storagesync.v20170605preview.RegisteredServer("registeredServer",
            ...
            server_managementt_error_code=0,
        ...
        :param pulumi.Input[str] last_workflow_id: Registered Server lastWorkflowId
        :param pulumi.Input[str] provisioning_state: Registered Server Provisioning State
        ...
        :param pulumi.Input[str] storage_sync_service_uid: Registered Server storageSyncServiceUid
        """
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagesync/latest:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20180402:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20180701:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20181001:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20190201:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20190301:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20190601:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20191001:RegisteredServer"), pulumi.Alias(type_="azurerm:storagesync/v20200301:RegisteredServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegisteredServer, __self__).__init__(
            'azurerm:storagesync/v20170605preview:RegisteredServer',
            resource_name,
            __props__,
            opts)
