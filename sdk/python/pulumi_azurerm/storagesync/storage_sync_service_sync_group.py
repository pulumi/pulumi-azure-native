...
class StorageSyncServiceSyncGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, properties=None, resource_group_name=None, storage_sync_service_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(StorageSyncServiceSyncGroup, __self__).__init__(
            'azurerm:storagesync:StorageSyncServiceSyncGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        :param pulumi.Input[dict] properties: SyncGroup properties.
        ...
        The **properties** object supports the following:
          ...
          * `sync_group_status` (`pulumi.Input[str]`) - Sync group status
          * `unique_id` (`pulumi.Input[str]`) - Unique Id
        """
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return StorageSyncServiceSyncGroup(resource_name, opts=opts, __props__=__props__)
