...
def get_open_shift_cluster(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:redhatopenshift/v20200430:getOpenShiftCluster', __args__, opts=opts, typ=GetOpenShiftClusterResult).value
