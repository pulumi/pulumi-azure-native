...
class OpenShiftCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:redhatopenshift/latest:OpenShiftCluster"), pulumi.Alias(type_="azurerm:redhatopenshift/v20200430:OpenShiftCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OpenShiftCluster, __self__).__init__(
            'azurerm:redhatopenshift/preview:OpenShiftCluster',
            resource_name,
            __props__,
            opts)
