...
def get_management_association(management_association_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:operationsmanagement/preview:getManagementAssociation', __args__, opts=opts, typ=GetManagementAssociationResult).value
