...
class HybridUseBenefit(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:softwareplan/latest:HybridUseBenefit"), pulumi.Alias(type_="azurerm:softwareplan/v20190601preview:HybridUseBenefit"), pulumi.Alias(type_="azurerm:softwareplan/v20191201:HybridUseBenefit")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HybridUseBenefit, __self__).__init__(
            'azurerm:softwareplan/preview:HybridUseBenefit',
            resource_name,
            __props__,
            opts)
