...
class HyperVSiteSite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:offazure/latest:HyperVSiteSite"), pulumi.Alias(type_="azurerm:offazure/v20200101:HyperVSiteSite"), pulumi.Alias(type_="azurerm:offazure/v20200707:HyperVSiteSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HyperVSiteSite, __self__).__init__(
            'azurerm:offazure/preview:HyperVSiteSite',
            resource_name,
            __props__,
            opts)
