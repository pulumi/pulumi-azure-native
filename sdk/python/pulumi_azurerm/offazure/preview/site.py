...
class Site(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:offazure/latest:Site"), pulumi.Alias(type_="azurerm:offazure/v20200101:Site"), pulumi.Alias(type_="azurerm:offazure/v20200707:Site")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Site, __self__).__init__(
            'azurerm:offazure/preview:Site',
            resource_name,
            __props__,
            opts)
