...
class Site(pulumi.CustomResource):
    def __init__(__self__,
        ...
        site = azurerm.offazure.v20200707.Site("site",
            location="eastus",
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:offazure/latest:Site"), pulumi.Alias(type_="azurerm:offazure/v20200101:Site")])
