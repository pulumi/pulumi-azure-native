...
class HyperVSite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:offazure/v20200101:HyperVSite"), pulumi.Alias(type_="azurerm:offazure/v20200707:HyperVSite")])
