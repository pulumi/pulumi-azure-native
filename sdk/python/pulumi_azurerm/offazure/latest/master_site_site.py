...
class MasterSiteSite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:offazure/preview:MasterSiteSite"), pulumi.Alias(type_="azurerm:offazure/v20200707:MasterSiteSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MasterSiteSite, __self__).__init__(
            'azurerm:offazure/latest:MasterSiteSite',
            resource_name,
            __props__,
            opts)
