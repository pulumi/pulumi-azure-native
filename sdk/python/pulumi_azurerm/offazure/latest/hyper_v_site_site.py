...
class HyperVSiteSite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:offazure/preview:HyperVSiteSite"), pulumi.Alias(type_="azurerm:offazure/v20200101:HyperVSiteSite"), pulumi.Alias(type_="azurerm:offazure/v20200707:HyperVSiteSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HyperVSiteSite, __self__).__init__(
            'azurerm:offazure/latest:HyperVSiteSite',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'HyperVSiteSite':
        """
