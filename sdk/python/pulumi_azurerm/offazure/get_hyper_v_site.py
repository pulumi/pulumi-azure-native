...
def get_hyper_v_site(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:offazure:getHyperVSite', __args__, opts=opts).value
