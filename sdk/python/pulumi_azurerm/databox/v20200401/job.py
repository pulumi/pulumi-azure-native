...
class Job(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['JobDetailsArgs']] details: Details of a job run. This field will only be sent for expand details filter.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databox/latest:Job"), pulumi.Alias(type_="azurerm:databox/preview:Job"), pulumi.Alias(type_="azurerm:databox/v20180101:Job"), pulumi.Alias(type_="azurerm:databox/v20190901:Job")])
