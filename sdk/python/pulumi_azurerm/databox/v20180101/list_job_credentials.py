...
def list_job_credentials(job_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:databox/v20180101:listJobCredentials', __args__, opts=opts).value
