...
class Job(pulumi.CustomResource):
    cancellation_reason: pulumi.Output[str]
    """
    ...
    """
    is_cancellable: pulumi.Output[bool]
    """
    Describes whether the job is cancellable or not.
    """
    is_deletable: pulumi.Output[bool]
    """
    Describes whether the job is deletable or not.
    """
    is_shipping_address_editable: pulumi.Output[bool]
    """
    ...
    def __init__(__self__, resource_name, opts=None, details=None, location=None, name=None, resource_group_name=None, sku=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databox/v20190901:Job")])
