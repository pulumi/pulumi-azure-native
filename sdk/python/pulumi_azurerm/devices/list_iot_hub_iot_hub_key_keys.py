...
class ListIotHubIotHubKeyKeysResult:
    """
...
class AwaitableListIotHubIotHubKeyKeysResult(ListIotHubIotHubKeyKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListIotHubIotHubKeyKeysResult(
...
def list_iot_hub_iot_hub_key_keys(key_name=None, resource_group_name=None, resource_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devices:listIotHubIotHubKeyKeys', __args__, opts=opts).value

    return AwaitableListIotHubIotHubKeyKeysResult(
