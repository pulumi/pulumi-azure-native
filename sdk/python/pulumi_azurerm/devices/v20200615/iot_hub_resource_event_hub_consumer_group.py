...
class IotHubResourceEventHubConsumerGroup(pulumi.CustomResource):
    ...
    the resource type.
    """
    def __init__(__self__, resource_name, opts=None, event_hub_endpoint_name=None, name=None, properties=None, resource_group_name=None, resource_name_=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[dict] properties: The EventHub consumer group name.
        ...
        The **properties** object supports the following:
          ...
          * `name` (`pulumi.Input[str]`) - EventHub consumer group name
        """
