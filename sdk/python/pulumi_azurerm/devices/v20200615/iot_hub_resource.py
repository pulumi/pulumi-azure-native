...
class IotHubResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        iot_hub_resource = azurerm.devices.v20200615.IotHubResource("iotHubResource",
            etag="AAAAAAFD6M4=",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devices/latest:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20160203:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20170119:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20170701:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20180122:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20180401:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20181201preview:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20190322:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20190322preview:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20190701preview:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20191104:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20200301:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20200401:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20200710preview:IotHubResource"), pulumi.Alias(type_="azurerm:devices/v20200801:IotHubResource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IotHubResource, __self__).__init__(
            'azurerm:devices/v20200615:IotHubResource',
            resource_name,
            __props__,
            opts)
