...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        certificate = azurerm.devices.v20180401.Certificate("certificate",
            certificate="############################################",
