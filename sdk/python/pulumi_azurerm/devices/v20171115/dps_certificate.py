...
class DpsCertificate(pulumi.CustomResource):
    ...
    properties of a certificate
      * `created` (`str`) - The certificate's creation date and time.
    ...
    def __init__(__self__, resource_name, opts=None, certificate=None, name=None, provisioning_service_name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devices/v20180122:DpsCertificate"), pulumi.Alias(type_="azurerm:devices/v20200101:DpsCertificate")])
