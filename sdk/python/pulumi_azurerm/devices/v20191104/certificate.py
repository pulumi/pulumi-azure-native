...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        certificate = azurerm.devices.v20191104.Certificate("certificate",
            certificate="############################################",
