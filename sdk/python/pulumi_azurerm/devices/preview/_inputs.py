...
class EnrichmentPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] endpoint_names: The list of endpoints for which the enrichment is applied to the message.
...
class IotHubDefinitionDescriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] allocation_weight: weight to apply for a given iot h.
...
class RoutingPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 enrichments: Optional[pulumi.Input[List[pulumi.Input['EnrichmentPropertiesArgs']]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input['EnrichmentPropertiesArgs']]] enrichments: The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/telemetryoneventgrid
    ...
    @property
    @pulumi.getter
    def enrichments(self) -> Optional[pulumi.Input[List[pulumi.Input['EnrichmentPropertiesArgs']]]]:
        """
    ...
    @enrichments.setter
    def enrichments(self, value: Optional[pulumi.Input[List[pulumi.Input['EnrichmentPropertiesArgs']]]]):
