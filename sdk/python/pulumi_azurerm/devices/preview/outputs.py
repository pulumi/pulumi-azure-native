...
class IotHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'EncryptionPropertiesDescriptionResponseArgs' encryption: The encryption properties for the IoT hub.
...
class IotHubPropertiesResponseDeviceStreams(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The device streams properties of iothub.
        :param List[str] streaming_endpoints: List of Device Streams Endpoints.
        """
    ...
    def streaming_endpoints(self) -> Optional[List[str]]:
        """
