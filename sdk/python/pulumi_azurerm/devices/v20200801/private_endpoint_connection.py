...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        private_endpoint_connection = azurerm.devices.v20200801.PrivateEndpointConnection("privateEndpointConnection",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devices/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:devices/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:devices/v20200401:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:devices/v20200615:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:devices/v20200710preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azurerm:devices/v20200801:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
