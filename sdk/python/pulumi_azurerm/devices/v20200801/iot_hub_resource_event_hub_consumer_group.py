...
class IotHubResourceEventHubConsumerGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        iot_hub_resource_event_hub_consumer_group = azurerm.devices.v20200801.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup",
        ...
        super(IotHubResourceEventHubConsumerGroup, __self__).__init__(
            'azurerm:devices/v20200801:IotHubResourceEventHubConsumerGroup',
            resource_name,
            __props__,
            opts)
