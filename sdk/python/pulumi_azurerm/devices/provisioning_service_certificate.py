...
class ProvisioningServiceCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, certificate=None, name=None, provisioning_service_name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ProvisioningServiceCertificate, __self__).__init__(
            'azurerm:devices:ProvisioningServiceCertificate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, name=None, properties=None, type=None):
        ...
        :param pulumi.Input[dict] properties: properties of a certificate
        ...
        __props__["type"] = type
        return ProvisioningServiceCertificate(resource_name, opts=opts, __props__=__props__)
