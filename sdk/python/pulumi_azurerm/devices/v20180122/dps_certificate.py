...
class DpsCertificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devices/latest:DpsCertificate"), pulumi.Alias(type_="azurerm:devices/preview:DpsCertificate"), pulumi.Alias(type_="azurerm:devices/v20170821preview:DpsCertificate"), pulumi.Alias(type_="azurerm:devices/v20171115:DpsCertificate"), pulumi.Alias(type_="azurerm:devices/v20200101:DpsCertificate"), pulumi.Alias(type_="azurerm:devices/v20200301:DpsCertificate")])
