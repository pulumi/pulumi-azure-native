...
def list_iot_dps_resource_keys_for_key_name(key_name=None, provisioning_service_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devices/v20180122:listIotDpsResourceKeysForKeyName', __args__, opts=opts).value
