...
class IotDpsResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devices/latest:IotDpsResource"), pulumi.Alias(type_="azurerm:devices/preview:IotDpsResource"), pulumi.Alias(type_="azurerm:devices/v20170821preview:IotDpsResource"), pulumi.Alias(type_="azurerm:devices/v20171115:IotDpsResource"), pulumi.Alias(type_="azurerm:devices/v20200101:IotDpsResource")])
