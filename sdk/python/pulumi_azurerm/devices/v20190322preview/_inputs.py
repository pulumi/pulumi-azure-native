...
class RoutingPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input['EnrichmentPropertiesArgs']]] enrichments: The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/iotmsgenrich
