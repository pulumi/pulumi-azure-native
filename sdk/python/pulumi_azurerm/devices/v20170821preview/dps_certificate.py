...
class DpsCertificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        dps_certificate = azurerm.devices.v20170821preview.DpsCertificate("dpsCertificate",
            certificate="############################################",
