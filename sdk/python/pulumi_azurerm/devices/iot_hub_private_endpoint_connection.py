...
class IotHubPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, properties=None, resource_group_name=None, resource_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(IotHubPrivateEndpointConnection, __self__).__init__(
            'azurerm:devices:IotHubPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
