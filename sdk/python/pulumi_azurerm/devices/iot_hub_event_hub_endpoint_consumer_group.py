...
class IotHubEventHubEndpointConsumerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, event_hub_endpoint_name=None, name=None, resource_group_name=None, resource_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(IotHubEventHubEndpointConsumerGroup, __self__).__init__(
            'azurerm:devices:IotHubEventHubEndpointConsumerGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, name=None, properties=None, type=None):
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] etag: The etag.
        :param pulumi.Input[str] name: The Event Hub-compatible consumer group name.
        :param pulumi.Input[dict] properties: The tags.
        ...
        __props__["type"] = type
        return IotHubEventHubEndpointConsumerGroup(resource_name, opts=opts, __props__=__props__)
