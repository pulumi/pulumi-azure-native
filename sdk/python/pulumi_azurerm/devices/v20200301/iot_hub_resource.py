...
class IotHubResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        iot_hub_resource = azurerm.devices.v20200301.IotHubResource("iotHubResource",
            etag="AAAAAAFD6M4=",
