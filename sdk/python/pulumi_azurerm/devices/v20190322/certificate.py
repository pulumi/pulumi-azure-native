...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        certificate = azurerm.devices.v20190322.Certificate("certificate",
            certificate="############################################",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:devices/latest:Certificate"), pulumi.Alias(type_="azurerm:devices/v20170701:Certificate"), pulumi.Alias(type_="azurerm:devices/v20180122:Certificate"), pulumi.Alias(type_="azurerm:devices/v20180401:Certificate"), pulumi.Alias(type_="azurerm:devices/v20191104:Certificate"), pulumi.Alias(type_="azurerm:devices/v20200301:Certificate"), pulumi.Alias(type_="azurerm:devices/v20200401:Certificate"), pulumi.Alias(type_="azurerm:devices/v20200615:Certificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'azurerm:devices/v20190322:Certificate',
            resource_name,
            __props__,
            opts)
