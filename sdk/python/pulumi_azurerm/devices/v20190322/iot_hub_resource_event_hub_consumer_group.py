...
class IotHubResourceEventHubConsumerGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        iot_hub_resource_event_hub_consumer_group = azurerm.devices.v20190322.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup",
