...
class EventSubscription(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, dead_letter_destination=None, destination=None, event_delivery_schema=None, expiration_time_utc=None, filter=None, labels=None, name=None, retry_policy=None, scope=None, __props__=None, __name__=None, __opts__=None):
        """
        Event Subscription
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventgrid/v20180101:EventSubscription"), pulumi.Alias(type_="azurerm:eventgrid/v20190101:EventSubscription"), pulumi.Alias(type_="azurerm:eventgrid/v20190601:EventSubscription")])
