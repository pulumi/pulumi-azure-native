...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventgrid/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:eventgrid/preview:PrivateEndpointConnection"), pulumi.Alias(type_="azurerm:eventgrid/v20200401preview:PrivateEndpointConnection")])
