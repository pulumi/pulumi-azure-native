...
class DomainTopic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventgrid/latest:DomainTopic"), pulumi.Alias(type_="azurerm:eventgrid/preview:DomainTopic"), pulumi.Alias(type_="azurerm:eventgrid/v20190201preview:DomainTopic"), pulumi.Alias(type_="azurerm:eventgrid/v20200101preview:DomainTopic"), pulumi.Alias(type_="azurerm:eventgrid/v20200401preview:DomainTopic"), pulumi.Alias(type_="azurerm:eventgrid/v20200601:DomainTopic")])
