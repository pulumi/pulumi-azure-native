...
def list_domain_shared_access_keys(domain_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:eventgrid/v20190601:listDomainSharedAccessKeys', __args__, opts=opts).value
