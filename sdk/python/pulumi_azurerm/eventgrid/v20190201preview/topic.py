...
class Topic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        topic = azurerm.eventgrid.v20190201preview.Topic("topic",
            location="westus2",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventgrid/latest:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20170615preview:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20170915preview:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20180101:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20180501preview:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20180915preview:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20190101:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20190601:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20200101preview:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20200401preview:Topic"), pulumi.Alias(type_="azurerm:eventgrid/v20200601:Topic")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Topic, __self__).__init__(
            'azurerm:eventgrid/v20190201preview:Topic',
            resource_name,
            __props__,
            opts)
