...
def get_system_topic_event_subscription(event_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:eventgrid/preview:getSystemTopicEventSubscription', __args__, opts=opts, typ=GetSystemTopicEventSubscriptionResult).value
