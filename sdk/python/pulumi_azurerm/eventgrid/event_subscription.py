...
class EventSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, properties=None, scope=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `event_delivery_schema` (`pulumi.Input[str]`) - The event delivery schema for the event subscription.
          * `expiration_time_utc` (`pulumi.Input[str]`) - Expiration time of the event subscription.
        ...
        super(EventSubscription, __self__).__init__(
            'azurerm:eventgrid:EventSubscription',
            resource_name,
            __props__,
            opts)
