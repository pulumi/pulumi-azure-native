...
class Domain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:eventgrid/preview:Domain"), pulumi.Alias(type_="azurerm:eventgrid/v20180915preview:Domain"), pulumi.Alias(type_="azurerm:eventgrid/v20190201preview:Domain"), pulumi.Alias(type_="azurerm:eventgrid/v20190601:Domain"), pulumi.Alias(type_="azurerm:eventgrid/v20200101preview:Domain"), pulumi.Alias(type_="azurerm:eventgrid/v20200401preview:Domain"), pulumi.Alias(type_="azurerm:eventgrid/v20200601:Domain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Domain, __self__).__init__(
            'azurerm:eventgrid/latest:Domain',
            resource_name,
            __props__,
            opts)
