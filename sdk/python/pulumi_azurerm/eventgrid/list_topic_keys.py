...
def list_topic_keys(resource_group_name=None, topic_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:eventgrid:listTopicKeys', __args__, opts=opts).value
