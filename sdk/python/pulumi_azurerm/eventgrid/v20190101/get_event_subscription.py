...
def get_event_subscription(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:eventgrid/v20190101:getEventSubscription', __args__, opts=opts, typ=GetEventSubscriptionResult).value
