...
class DomainTopic(pulumi.CustomResource):
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        :param pulumi.Input[dict] properties: Properties of the Domain Topic.
        :param pulumi.Input[str] type: Type of the resource.

        The **properties** object supports the following:

          * `provisioning_state` (`pulumi.Input[str]`) - Provisioning state of the domain topic.
        """
