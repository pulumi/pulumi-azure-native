...
class PrivateLinkService(pulumi.CustomResource):
    ...
    Properties of the private link service.
      ...
      * `ip_configurations` (`list`) - An array of references to the private link service IP configuration.
        ...
        * `properties` (`dict`) - Properties of the private link service ip configuration.
          ...
          * `provisioning_state` (`str`) - The provisioning state of the private link service ip configuration.
      ...
      * `network_interfaces` (`list`) - Gets an array of references to the network interfaces created for this private link service.
      * `private_endpoint_connections` (`list`) - An array of list about connections to the private endpoint.
        ...
        * `properties` (`dict`) - Properties of the private end point connection.
          ...
          * `provisioning_state` (`str`) - The provisioning state of the private endpoint connection.
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `ip_configurations` (`pulumi.Input[list]`) - An array of references to the private link service IP configuration.
            ...
            * `properties` (`pulumi.Input[dict]`) - Properties of the private link service ip configuration.
              ...
              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the private link service ip configuration.
          ...
          * `private_endpoint_connections` (`pulumi.Input[list]`) - An array of list about connections to the private endpoint.
            ...
            * `properties` (`pulumi.Input[dict]`) - Properties of the private end point connection.
                ...
                * `properties` (`pulumi.Input[dict]`) - Properties of the private endpoint.
                  * `manual_private_link_service_connections` (`pulumi.Input[list]`) - A grouping of information about the connection to the remote resource. Used when the network admin does not have access to approve connections to the remote resource.
                    ...
                    * `properties` (`pulumi.Input[dict]`) - Properties of the private link service connection.
                      ...
                      * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the private link service connection.
                  ...
                  * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the private endpoint.
              ...
              * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the private endpoint connection.

          * `provisioning_state` (`pulumi.Input[str]`) - The provisioning state of the private link service.
