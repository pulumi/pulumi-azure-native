...
def get_network_profile(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:network/v20190601:getNetworkProfile', __args__, opts=opts).value
