...
class Endpoint(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, endpoint_type=None, name=None, profile_name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        """
