...
class Job(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:importexport/latest:Job"), pulumi.Alias(type_="azurerm:importexport/preview:Job"), pulumi.Alias(type_="azurerm:importexport/v20200801:Job")])
