...
def get_replication_network_mapping(fabric_name=None, name=None, network_name=None, resource_group_name=None, resource_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:recoveryservices/v20180710:getReplicationNetworkMapping', __args__, opts=opts).value
