...
def get_replication_protection_container_mapping(fabric_name=None, name=None, protection_container_name=None, resource_group_name=None, resource_name=None, opts=None):
    ...
    :param str name: Protection Container mapping name.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:recoveryservices/v20180710:getReplicationProtectionContainerMapping', __args__, opts=opts).value
