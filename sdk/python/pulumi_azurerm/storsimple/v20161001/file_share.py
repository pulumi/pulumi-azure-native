...
class FileShare(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:FileShare"), pulumi.Alias(type_="azurerm:storsimple/preview:FileShare")])
