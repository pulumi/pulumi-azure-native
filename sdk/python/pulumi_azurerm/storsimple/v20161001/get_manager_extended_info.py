...
class GetManagerExtendedInfoResult:
    ...
    """
    def __init__(__self__, algorithm=None, encryption_key=None, encryption_key_thumbprint=None, etag=None, integrity_key=None, name=None, portal_certificate_thumbprint=None, type=None, version=None):
...
def get_manager_extended_info(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storsimple/v20161001:getManagerExtendedInfo', __args__, opts=opts, typ=GetManagerExtendedInfoResult).value
