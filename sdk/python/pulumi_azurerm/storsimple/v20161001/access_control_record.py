...
class AccessControlRecord(pulumi.CustomResource):
    def __init__(__self__,
        ...
        access_control_record = azurerm.storsimple.v20161001.AccessControlRecord("accessControlRecord",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:AccessControlRecord"), pulumi.Alias(type_="azurerm:storsimple/v20170601:AccessControlRecord")])
