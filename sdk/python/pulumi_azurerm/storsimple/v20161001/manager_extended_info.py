...
class ManagerExtendedInfo(pulumi.CustomResource):
    def __init__(__self__,
        ...
        manager_extended_info = azurerm.storsimple.v20161001.ManagerExtendedInfo("managerExtendedInfo",
            algorithm="SHA256",
            etag="6531d5d7-3ced-4f78-83b6-804368f2ca0c",
            integrity_key="e6501980-7efe-4602-bb0e-3cb9a08a6003",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:ManagerExtendedInfo"), pulumi.Alias(type_="azurerm:storsimple/v20170601:ManagerExtendedInfo")])
