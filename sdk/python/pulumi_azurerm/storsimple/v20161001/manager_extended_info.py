...
class ManagerExtendedInfo(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:ManagerExtendedInfo"), pulumi.Alias(type_="azurerm:storsimple/preview:ManagerExtendedInfo"), pulumi.Alias(type_="azurerm:storsimple/v20170601:ManagerExtendedInfo")])
