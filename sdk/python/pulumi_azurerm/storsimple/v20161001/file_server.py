...
class FileServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        file_server = azurerm.storsimple.v20161001.FileServer("fileServer",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:FileServer")])
