...
class BackupSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:BackupSchedule"), pulumi.Alias(type_="azurerm:storsimple/v20170601:BackupSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BackupSchedule, __self__).__init__(
            'azurerm:storsimple/preview:BackupSchedule',
            resource_name,
            __props__,
            opts)
