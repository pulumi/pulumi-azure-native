...
class IscsiDisk(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:IscsiDisk"), pulumi.Alias(type_="azurerm:storsimple/v20161001:IscsiDisk")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IscsiDisk, __self__).__init__(
            'azurerm:storsimple/preview:IscsiDisk',
            resource_name,
            __props__,
            opts)
