...
class BackupScheduleGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:BackupScheduleGroup"), pulumi.Alias(type_="azurerm:storsimple/v20161001:BackupScheduleGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BackupScheduleGroup, __self__).__init__(
            'azurerm:storsimple/preview:BackupScheduleGroup',
            resource_name,
            __props__,
            opts)
