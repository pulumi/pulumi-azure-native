...
class StorageAccountCredential(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:StorageAccountCredential"), pulumi.Alias(type_="azurerm:storsimple/v20161001:StorageAccountCredential"), pulumi.Alias(type_="azurerm:storsimple/v20170601:StorageAccountCredential")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageAccountCredential, __self__).__init__(
            'azurerm:storsimple/preview:StorageAccountCredential',
            resource_name,
            __props__,
            opts)
