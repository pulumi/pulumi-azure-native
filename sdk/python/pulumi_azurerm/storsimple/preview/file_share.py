...
class FileShare(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:FileShare"), pulumi.Alias(type_="azurerm:storsimple/v20161001:FileShare")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileShare, __self__).__init__(
            'azurerm:storsimple/preview:FileShare',
            resource_name,
            __props__,
            opts)
