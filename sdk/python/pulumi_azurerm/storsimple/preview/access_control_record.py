...
class AccessControlRecord(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:AccessControlRecord"), pulumi.Alias(type_="azurerm:storsimple/v20161001:AccessControlRecord"), pulumi.Alias(type_="azurerm:storsimple/v20170601:AccessControlRecord")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccessControlRecord, __self__).__init__(
            'azurerm:storsimple/preview:AccessControlRecord',
            resource_name,
            __props__,
            opts)
