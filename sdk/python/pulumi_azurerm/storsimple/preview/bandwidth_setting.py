...
class BandwidthSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:BandwidthSetting"), pulumi.Alias(type_="azurerm:storsimple/v20170601:BandwidthSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BandwidthSetting, __self__).__init__(
            'azurerm:storsimple/preview:BandwidthSetting',
            resource_name,
            __props__,
            opts)
