...
class ChapSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/preview:ChapSetting"), pulumi.Alias(type_="azurerm:storsimple/v20161001:ChapSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ChapSetting, __self__).__init__(
            'azurerm:storsimple/latest:ChapSetting',
            resource_name,
            __props__,
            opts)
