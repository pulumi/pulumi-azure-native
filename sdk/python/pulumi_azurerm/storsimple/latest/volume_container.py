...
class VolumeContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        volume_container = azurerm.storsimple.latest.VolumeContainer("volumeContainer",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/v20170601:VolumeContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VolumeContainer, __self__).__init__(
            'azurerm:storsimple/latest:VolumeContainer',
            resource_name,
            __props__,
            opts)
