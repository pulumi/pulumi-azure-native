...
def list_manager_public_encryption_key(manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storsimple/latest:listManagerPublicEncryptionKey', __args__, opts=opts, typ=ListManagerPublicEncryptionKeyResult).value
