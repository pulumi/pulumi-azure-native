...
class BackupPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/preview:BackupPolicy"), pulumi.Alias(type_="azurerm:storsimple/v20170601:BackupPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BackupPolicy, __self__).__init__(
            'azurerm:storsimple/latest:BackupPolicy',
            resource_name,
            __props__,
            opts)
