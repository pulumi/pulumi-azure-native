...
class Manager(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:Manager"), pulumi.Alias(type_="azurerm:storsimple/preview:Manager"), pulumi.Alias(type_="azurerm:storsimple/v20161001:Manager")])
