...
class BandwidthSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:BandwidthSetting"), pulumi.Alias(type_="azurerm:storsimple/preview:BandwidthSetting")])
