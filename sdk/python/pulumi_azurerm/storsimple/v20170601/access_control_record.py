...
class AccessControlRecord(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:AccessControlRecord"), pulumi.Alias(type_="azurerm:storsimple/v20161001:AccessControlRecord")])
