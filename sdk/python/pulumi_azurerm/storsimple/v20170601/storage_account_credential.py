...
class StorageAccountCredential(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storsimple/latest:StorageAccountCredential"), pulumi.Alias(type_="azurerm:storsimple/preview:StorageAccountCredential"), pulumi.Alias(type_="azurerm:storsimple/v20161001:StorageAccountCredential")])
