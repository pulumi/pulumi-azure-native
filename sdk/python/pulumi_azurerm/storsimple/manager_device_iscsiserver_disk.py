...
class ManagerDeviceIscsiserverDisk(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, device_name=None, iscsi_server_name=None, manager_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ManagerDeviceIscsiserverDisk, __self__).__init__(
            'azurerm:storsimple:ManagerDeviceIscsiserverDisk',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return ManagerDeviceIscsiserverDisk(resource_name, opts=opts, __props__=__props__)
