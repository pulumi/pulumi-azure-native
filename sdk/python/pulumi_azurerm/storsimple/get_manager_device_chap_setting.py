...
class AwaitableGetManagerDeviceChapSettingResult(GetManagerDeviceChapSettingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagerDeviceChapSettingResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_manager_device_chap_setting(device_name=None, manager_name=None, name=None, resource_group_name=None, opts=None):
    """
