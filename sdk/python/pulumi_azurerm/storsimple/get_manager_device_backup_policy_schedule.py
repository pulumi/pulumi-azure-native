...
class AwaitableGetManagerDeviceBackupPolicyScheduleResult(GetManagerDeviceBackupPolicyScheduleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagerDeviceBackupPolicyScheduleResult(
            kind=self.kind,
            name=self.name,
...
def get_manager_device_backup_policy_schedule(backup_policy_name=None, device_name=None, manager_name=None, name=None, resource_group_name=None, opts=None):
    """
