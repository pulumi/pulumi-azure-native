...
def list_wcf_relay_keys(authorization_rule_name=None, namespace_name=None, relay_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:relay/v20170401:listWCFRelayKeys', __args__, opts=opts).value
