...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:windowsiot/latest:Service"), pulumi.Alias(type_="azurerm:windowsiot/v20180216preview:Service"), pulumi.Alias(type_="azurerm:windowsiot/v20190601:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azurerm:windowsiot/preview:Service',
            resource_name,
            __props__,
            opts)
