...
class DeviceService(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, admin_domain_name=None, billing_domain_name=None, name=None, notes=None, quantity=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        super(DeviceService, __self__).__init__(
            'azurerm:windowsiot:DeviceService',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        :param pulumi.Input[dict] properties: The properties of a Windows IoT Device Service.
        :param pulumi.Input[dict] tags: Resource tags.
        :param pulumi.Input[str] type: The type of the resource.

        The **properties** object supports the following:

          * `admin_domain_name` (`pulumi.Input[str]`) - Windows IoT Device Service OEM AAD domain
          * `billing_domain_name` (`pulumi.Input[str]`) - Windows IoT Device Service ODM AAD domain
          * `notes` (`pulumi.Input[str]`) - Windows IoT Device Service notes.
          * `quantity` (`pulumi.Input[float]`) - Windows IoT Device Service device allocation,
          * `start_date` (`pulumi.Input[str]`) - Windows IoT Device Service start date,
        """
        ...
        __props__["tags"] = tags
        __props__["type"] = type
        return DeviceService(resource_name, opts=opts, __props__=__props__)
