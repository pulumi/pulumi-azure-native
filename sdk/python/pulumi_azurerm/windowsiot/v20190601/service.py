...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:windowsiot/latest:Service"), pulumi.Alias(type_="azurerm:windowsiot/preview:Service"), pulumi.Alias(type_="azurerm:windowsiot/v20180216preview:Service")])
