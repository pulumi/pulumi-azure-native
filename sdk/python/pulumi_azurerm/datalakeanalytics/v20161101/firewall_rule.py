...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        firewall_rule = azurerm.datalakeanalytics.v20161101.FirewallRule("firewallRule",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datalakeanalytics/latest:FirewallRule")])
