...
class ListAccountSasTokensResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> List['outputs.SasTokenInfoResponseResult']:
...
def list_account_sas_tokens(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datalakeanalytics/v20151001preview:listAccountSasTokens', __args__, opts=opts, typ=ListAccountSasTokensResult).value
