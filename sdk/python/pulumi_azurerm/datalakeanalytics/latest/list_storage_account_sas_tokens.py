...
class ListStorageAccountSasTokensResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> List['outputs.SasTokenInformationResponseResult']:
        """
...
def list_storage_account_sas_tokens(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datalakeanalytics/latest:listStorageAccountSasTokens', __args__, opts=opts, typ=ListStorageAccountSasTokensResult).value
