...
class ComputePolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datalakeanalytics/latest:ComputePolicy"), pulumi.Alias(type_="azurerm:datalakeanalytics/v20161101:ComputePolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ComputePolicy, __self__).__init__(
            'azurerm:datalakeanalytics/preview:ComputePolicy',
            resource_name,
            __props__,
            opts)
