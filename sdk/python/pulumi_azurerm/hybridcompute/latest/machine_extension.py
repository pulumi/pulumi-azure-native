...
class MachineExtension(pulumi.CustomResource):
    def __init__(__self__,
        ...
        machine_extension = azurerm.hybridcompute.latest.MachineExtension("machineExtension",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hybridcompute/v20191212:MachineExtension"), pulumi.Alias(type_="azurerm:hybridcompute/v20200802:MachineExtension")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MachineExtension, __self__).__init__(
            'azurerm:hybridcompute/latest:MachineExtension',
            resource_name,
            __props__,
            opts)
