...
class Machine(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hybridcompute/preview:Machine"), pulumi.Alias(type_="azurerm:hybridcompute/v20190318preview:Machine"), pulumi.Alias(type_="azurerm:hybridcompute/v20190802preview:Machine"), pulumi.Alias(type_="azurerm:hybridcompute/v20191212:Machine"), pulumi.Alias(type_="azurerm:hybridcompute/v20200730preview:Machine"), pulumi.Alias(type_="azurerm:hybridcompute/v20200802:Machine"), pulumi.Alias(type_="azurerm:hybridcompute/v20200815preview:Machine")])
