...
class Machine(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hybridcompute/latest:Machine"), pulumi.Alias(type_="azurerm:hybridcompute/v20200802:Machine")])
