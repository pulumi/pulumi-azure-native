...
class MachineExtension(pulumi.CustomResource):
    def __init__(__self__,
        ...
        machine_extension = azurerm.hybridcompute.v20191212.MachineExtension("machineExtension",
            extension_name="CustomScriptExtension",
            location="eastus2euap",
            name="extdemo",
            publisher="Microsoft.Compute",
            resource_group_name="extRG",
            settings={
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hybridcompute/latest:MachineExtension"), pulumi.Alias(type_="azurerm:hybridcompute/v20190802preview:MachineExtension"), pulumi.Alias(type_="azurerm:hybridcompute/v20200730preview:MachineExtension"), pulumi.Alias(type_="azurerm:hybridcompute/v20200802:MachineExtension"), pulumi.Alias(type_="azurerm:hybridcompute/v20200815preview:MachineExtension")])
