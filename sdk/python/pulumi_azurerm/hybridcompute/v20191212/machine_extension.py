...
class MachineExtension(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hybridcompute/latest:MachineExtension"), pulumi.Alias(type_="azurerm:hybridcompute/v20200802:MachineExtension")])
