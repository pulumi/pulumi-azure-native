...
def get_machine_extension(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:hybridcompute/v20191212:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
