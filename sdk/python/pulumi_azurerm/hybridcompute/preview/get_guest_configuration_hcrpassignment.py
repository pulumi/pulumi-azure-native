...
def get_guest_configuration_hcrpassignment(guest_configuration_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:hybridcompute/preview:getGuestConfigurationHCRPAssignment', __args__, opts=opts, typ=GetGuestConfigurationHCRPAssignmentResult).value
