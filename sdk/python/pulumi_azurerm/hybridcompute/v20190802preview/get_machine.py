...
class GetMachineResult:
    ...
    """
    def __init__(__self__, agent_version=None, client_public_key=None, display_name=None, error_details=None, extensions=None, last_status_change=None, location=None, machine_fqdn=None, name=None, os_name=None, os_profile=None, os_version=None, physical_location=None, principal_id=None, provisioning_state=None, status=None, tags=None, tenant_id=None, type=None, vm_id=None):
...
def get_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:hybridcompute/v20190802preview:getMachine', __args__, opts=opts, typ=GetMachineResult).value
