...
def get_guest_configuration_hcrpassignment(machine_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:hybridcompute/v20181120:getGuestConfigurationHCRPAssignment', __args__, opts=opts, typ=GetGuestConfigurationHCRPAssignmentResult).value
