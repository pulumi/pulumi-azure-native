...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearning/latest:Workspace"), pulumi.Alias(type_="azurerm:machinelearning/v20160401:Workspace"), pulumi.Alias(type_="azurerm:machinelearning/v20191001:Workspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workspace, __self__).__init__(
            'azurerm:machinelearning/preview:Workspace',
            resource_name,
            __props__,
            opts)
