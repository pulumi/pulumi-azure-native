...
class WebService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:machinelearning/latest:WebService"), pulumi.Alias(type_="azurerm:machinelearning/v20160501preview:WebService"), pulumi.Alias(type_="azurerm:machinelearning/v20170101:WebService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebService, __self__).__init__(
            'azurerm:machinelearning/preview:WebService',
            resource_name,
            __props__,
            opts)
