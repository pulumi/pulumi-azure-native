...
class AwaitableGetIoTAppResult(GetIoTAppResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIoTAppResult(
...
def get_io_t_app(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:iotcentral:getIoTApp', __args__, opts=opts).value

    return AwaitableGetIoTAppResult(
