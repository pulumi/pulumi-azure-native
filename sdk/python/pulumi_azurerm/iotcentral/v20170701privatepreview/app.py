...
class App(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:iotcentral/latest:App"), pulumi.Alias(type_="azurerm:iotcentral/preview:App"), pulumi.Alias(type_="azurerm:iotcentral/v20180901:App")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(App, __self__).__init__(
            'azurerm:iotcentral/v20170701privatepreview:App',
            resource_name,
            __props__,
            opts)
