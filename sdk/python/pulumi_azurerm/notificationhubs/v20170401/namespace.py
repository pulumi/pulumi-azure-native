...
class Namespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:notificationhubs/v20140901:Namespace"), pulumi.Alias(type_="azurerm:notificationhubs/v20160301:Namespace")])
