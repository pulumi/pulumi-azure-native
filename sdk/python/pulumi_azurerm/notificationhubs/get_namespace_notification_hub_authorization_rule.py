...
class AwaitableGetNamespaceNotificationHubAuthorizationRuleResult(GetNamespaceNotificationHubAuthorizationRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNamespaceNotificationHubAuthorizationRuleResult(
...
def get_namespace_notification_hub_authorization_rule(name=None, namespace_name=None, notification_hub_name=None, resource_group_name=None, opts=None):
    """
