...
class NotificationHub(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:notificationhubs/preview:NotificationHub"), pulumi.Alias(type_="azurerm:notificationhubs/v20140901:NotificationHub"), pulumi.Alias(type_="azurerm:notificationhubs/v20160301:NotificationHub"), pulumi.Alias(type_="azurerm:notificationhubs/v20170401:NotificationHub")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NotificationHub, __self__).__init__(
            'azurerm:notificationhubs/latest:NotificationHub',
            resource_name,
            __props__,
            opts)
