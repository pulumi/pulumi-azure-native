...
class Namespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:notificationhubs/preview:Namespace"), pulumi.Alias(type_="azurerm:notificationhubs/v20140901:Namespace"), pulumi.Alias(type_="azurerm:notificationhubs/v20160301:Namespace"), pulumi.Alias(type_="azurerm:notificationhubs/v20170401:Namespace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Namespace, __self__).__init__(
            'azurerm:notificationhubs/latest:Namespace',
            resource_name,
            __props__,
            opts)
