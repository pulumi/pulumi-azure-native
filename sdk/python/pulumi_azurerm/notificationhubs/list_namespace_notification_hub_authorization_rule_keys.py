...
class ListNamespaceNotificationHubAuthorizationRuleKeysResult:
    """
...
class AwaitableListNamespaceNotificationHubAuthorizationRuleKeysResult(ListNamespaceNotificationHubAuthorizationRuleKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListNamespaceNotificationHubAuthorizationRuleKeysResult(
...
def list_namespace_notification_hub_authorization_rule_keys(authorization_rule_name=None, namespace_name=None, notification_hub_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:notificationhubs:listNamespaceNotificationHubAuthorizationRuleKeys', __args__, opts=opts).value

    return AwaitableListNamespaceNotificationHubAuthorizationRuleKeysResult(
