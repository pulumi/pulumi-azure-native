...
class NotificationHubAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:notificationhubs/latest:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azurerm:notificationhubs/v20160301:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azurerm:notificationhubs/v20170401:NotificationHubAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NotificationHubAuthorizationRule, __self__).__init__(
            'azurerm:notificationhubs/preview:NotificationHubAuthorizationRule',
            resource_name,
            __props__,
            opts)
