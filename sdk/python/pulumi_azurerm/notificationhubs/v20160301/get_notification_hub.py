...
def get_notification_hub(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:notificationhubs/v20160301:getNotificationHub', __args__, opts=opts, typ=GetNotificationHubResult).value
