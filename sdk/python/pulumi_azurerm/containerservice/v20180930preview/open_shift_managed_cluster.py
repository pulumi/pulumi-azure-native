...
class OpenShiftManagedCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        open_shift_managed_cluster = azurerm.containerservice.v20180930preview.OpenShiftManagedCluster("openShiftManagedCluster",
            agent_pool_profiles=[
                {
                    "count": 2,
                    "name": "infra",
        ...
        if opts.id is None:
            ...
            __props__['plan'] = plan
            __props__['public_hostname'] = public_hostname
