...
class ContainerService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerservice/latest:ContainerService"), pulumi.Alias(type_="azurerm:containerservice/v20160330:ContainerService"), pulumi.Alias(type_="azurerm:containerservice/v20160930:ContainerService"), pulumi.Alias(type_="azurerm:containerservice/v20170131:ContainerService"), pulumi.Alias(type_="azurerm:containerservice/v20170701:ContainerService")])
