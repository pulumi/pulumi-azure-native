...
class ManagedCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        managed_cluster = azurerm.containerservice.v20200201.ManagedCluster("managedCluster",
            addon_profiles={},
            agent_pool_profiles=[{
                "availabilityZones": [
                    "1",
