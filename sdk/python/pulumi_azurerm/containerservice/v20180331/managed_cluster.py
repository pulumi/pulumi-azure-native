...
class ManagedCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        managed_cluster = azurerm.containerservice.v20180331.ManagedCluster("managedCluster",
            addon_profiles={},
            agent_pool_profiles=[{
                "count": 3,
                "name": "nodepool1",
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ManagedClusterAgentPoolProfileArgs']]]] agent_pool_profiles: Properties of the agent pool. Currently only one agent pool can exist.
