...
def get_managed_cluster(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerservice/v20180331:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
