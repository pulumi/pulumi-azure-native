...
class GetOpenShiftManagedClusterResult:
    ...
    """
    def __init__(__self__, agent_pool_profiles=None, auth_profile=None, cluster_version=None, fqdn=None, location=None, master_pool_profile=None, monitor_profile=None, name=None, network_profile=None, open_shift_version=None, plan=None, provisioning_state=None, public_hostname=None, router_profiles=None, tags=None, type=None):
...
def get_open_shift_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerservice/v20190930preview:getOpenShiftManagedCluster', __args__, opts=opts, typ=GetOpenShiftManagedClusterResult).value
