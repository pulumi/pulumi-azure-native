...
class OpenShiftManagedCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerservice/latest:OpenShiftManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20180930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20190430:OpenShiftManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20191027preview:OpenShiftManagedCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OpenShiftManagedCluster, __self__).__init__(
            'azurerm:containerservice/v20190930preview:OpenShiftManagedCluster',
            resource_name,
            __props__,
            opts)
