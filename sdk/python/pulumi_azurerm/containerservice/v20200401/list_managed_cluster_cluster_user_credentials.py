...
def list_managed_cluster_cluster_user_credentials(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerservice/v20200401:listManagedClusterClusterUserCredentials', __args__, opts=opts, typ=ListManagedClusterClusterUserCredentialsResult).value
