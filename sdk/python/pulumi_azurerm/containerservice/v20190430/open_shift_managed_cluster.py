...
class OpenShiftManagedCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerservice/latest:OpenShiftManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20180930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20190930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20191027preview:OpenShiftManagedCluster")])
