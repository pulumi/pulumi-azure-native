...
def get_agent_pool(managed_cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerservice/v20190201:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value
