...
class ManagedCluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        managed_cluster = azurerm.containerservice.v20190201.ManagedCluster("managedCluster",
            addon_profiles={},
            agent_pool_profiles=[{
                "count": 3,
                "name": "nodepool1",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerservice/latest:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20170831:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20180331:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20180801preview:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20190401:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20190601:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20190801:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20191001:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20191101:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20200101:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20200201:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20200301:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20200401:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20200601:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20200701:ManagedCluster"), pulumi.Alias(type_="azurerm:containerservice/v20200901:ManagedCluster")])
