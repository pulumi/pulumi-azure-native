...
class ManagedCluster(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, aad_profile=None, addon_profiles=None, agent_pool_profiles=None, api_server_access_profile=None, dns_prefix=None, enable_pod_security_policy=None, enable_rbac=None, identity=None, identity_profile=None, kubernetes_version=None, linux_profile=None, location=None, name=None, network_profile=None, node_resource_group=None, resource_group_name=None, service_principal_profile=None, tags=None, windows_profile=None, __props__=None, __name__=None, __opts__=None):
        """
        Managed cluster.
