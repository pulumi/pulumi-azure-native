...
class AgentPool(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, availability_zones=None, count=None, enable_auto_scaling=None, enable_node_public_ip=None, max_count=None, max_pods=None, min_count=None, mode=None, name=None, node_labels=None, node_taints=None, orchestrator_version=None, os_disk_size_gb=None, os_type=None, resource_group_name=None, resource_name_=None, scale_set_eviction_policy=None, scale_set_priority=None, spot_max_price=None, tags=None, type=None, vm_size=None, vnet_subnet_id=None, __props__=None, __name__=None, __opts__=None):
        """
        Agent Pool.
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerservice/v20190401:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20190601:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20190801:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20191001:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20191101:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20200101:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20200201:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20200401:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20200601:AgentPool"), pulumi.Alias(type_="azurerm:containerservice/v20200701:AgentPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AgentPool, __self__).__init__(
            'azurerm:containerservice/v20200301:AgentPool',
            resource_name,
            __props__,
            opts)
