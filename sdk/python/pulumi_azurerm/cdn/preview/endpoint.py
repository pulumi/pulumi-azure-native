...
class Endpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/latest:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20150601:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20160402:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20161002:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20170402:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20171012:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20190415:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20190615:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20190615preview:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20191231:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20200331:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20200415:Endpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Endpoint, __self__).__init__(
            'azurerm:cdn/preview:Endpoint',
            resource_name,
            __props__,
            opts)
