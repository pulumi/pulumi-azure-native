...
class Origin(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, enabled=None, endpoint_name=None, host_name=None, http_port=None, https_port=None, name=None, origin_host_header=None, priority=None, profile_name=None, resource_group_name=None, weight=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/v20150601:Origin"), pulumi.Alias(type_="azurerm:cdn/v20160402:Origin"), pulumi.Alias(type_="azurerm:cdn/v20161002:Origin"), pulumi.Alias(type_="azurerm:cdn/v20170402:Origin"), pulumi.Alias(type_="azurerm:cdn/v20171012:Origin"), pulumi.Alias(type_="azurerm:cdn/v20190415:Origin"), pulumi.Alias(type_="azurerm:cdn/v20190615:Origin"), pulumi.Alias(type_="azurerm:cdn/v20200331:Origin"), pulumi.Alias(type_="azurerm:cdn/v20200415:Origin")])
