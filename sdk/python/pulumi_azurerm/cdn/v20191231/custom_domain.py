...
class CustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, endpoint_name=None, host_name=None, name=None, profile_name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/v20150601:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20160402:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20161002:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20170402:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20171012:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20190415:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20190615:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20200331:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20200415:CustomDomain")])
