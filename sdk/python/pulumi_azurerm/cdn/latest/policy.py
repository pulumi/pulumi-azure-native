...
class Policy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/v20190615:Policy"), pulumi.Alias(type_="azurerm:cdn/v20190615preview:Policy"), pulumi.Alias(type_="azurerm:cdn/v20200331:Policy"), pulumi.Alias(type_="azurerm:cdn/v20200415:Policy")])
