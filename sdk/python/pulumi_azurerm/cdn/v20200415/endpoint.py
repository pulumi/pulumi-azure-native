...
class Endpoint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 url_signing_keys: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['UrlSigningKeyArgs']]]]] = None,
        ...
        endpoint = azurerm.cdn.v20200415.Endpoint("endpoint",
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['UrlSigningKeyArgs']]]] url_signing_keys: List of keys used to validate the signed URL hashes.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/latest:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20150601:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20160402:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20161002:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20170402:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20171012:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20190415:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20190615:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20190615preview:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20191231:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20200331:Endpoint")])
    ...
    def origin_groups(self) -> pulumi.Output[Optional[List['outputs.DeepCreatedOriginGroupResponse']]]:
        """
    ...
    def url_signing_keys(self) -> pulumi.Output[Optional[List['outputs.UrlSigningKeyResponse']]]:
        """
