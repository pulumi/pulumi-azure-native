...
class Endpoint(pulumi.CustomResource):
    ...
    Resource type.
    """
    url_signing_keys: pulumi.Output[list]
    """
    ...
    def __init__(__self__, resource_name, opts=None, content_types_to_compress=None, default_origin_group=None, delivery_policy=None, geo_filters=None, is_compression_enabled=None, is_http_allowed=None, is_https_allowed=None, location=None, name=None, optimization_type=None, origin_groups=None, origin_host_header=None, origin_path=None, origins=None, probe_path=None, profile_name=None, query_string_caching_behavior=None, resource_group_name=None, tags=None, url_signing_keys=None, web_application_firewall_policy_link=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] url_signing_keys: List of keys used to validate the signed URL hashes.
        :param pulumi.Input[dict] web_application_firewall_policy_link: Defines the Web Application Firewall policy for the endpoint (if applicable)
        ...
        The **origins** object supports the following:
          ...
          * `private_link_alias` (`pulumi.Input[str]`) - The Alias of the Private Link resource. Populating this optional field indicates that this origin is 'Private'
        ...
        The **url_signing_keys** object supports the following:
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/v20150601:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20160402:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20161002:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20170402:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20171012:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20190415:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20190615:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20191231:Endpoint"), pulumi.Alias(type_="azurerm:cdn/v20200331:Endpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Endpoint, __self__).__init__(
            'azurerm:cdn/v20200415:Endpoint',
            resource_name,
            __props__,
            opts)
