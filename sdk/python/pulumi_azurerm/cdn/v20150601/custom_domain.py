...
class CustomDomain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/latest:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/preview:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20160402:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20161002:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20170402:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20171012:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20190415:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20190615:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20190615preview:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20191231:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20200331:CustomDomain"), pulumi.Alias(type_="azurerm:cdn/v20200415:CustomDomain")])
