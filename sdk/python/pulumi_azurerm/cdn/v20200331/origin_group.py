...
class OriginGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/latest:OriginGroup"), pulumi.Alias(type_="azurerm:cdn/preview:OriginGroup"), pulumi.Alias(type_="azurerm:cdn/v20191231:OriginGroup"), pulumi.Alias(type_="azurerm:cdn/v20200415:OriginGroup")])
