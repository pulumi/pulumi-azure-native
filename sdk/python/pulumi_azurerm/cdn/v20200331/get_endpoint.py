...
def get_endpoint(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:cdn/v20200331:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
    ...
    return AwaitableGetEndpointResult(
        ...
        web_application_firewall_policy_link=__ret__.web_application_firewall_policy_link)
