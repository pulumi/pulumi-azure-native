...
class Profile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:cdn/latest:Profile"), pulumi.Alias(type_="azurerm:cdn/v20150601:Profile"), pulumi.Alias(type_="azurerm:cdn/v20161002:Profile"), pulumi.Alias(type_="azurerm:cdn/v20170402:Profile"), pulumi.Alias(type_="azurerm:cdn/v20171012:Profile"), pulumi.Alias(type_="azurerm:cdn/v20190415:Profile"), pulumi.Alias(type_="azurerm:cdn/v20190615:Profile"), pulumi.Alias(type_="azurerm:cdn/v20191231:Profile"), pulumi.Alias(type_="azurerm:cdn/v20200331:Profile"), pulumi.Alias(type_="azurerm:cdn/v20200415:Profile")])
