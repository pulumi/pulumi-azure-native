...
class GetProfileEndpointOriginResult:
    """
...
class AwaitableGetProfileEndpointOriginResult(GetProfileEndpointOriginResult):
...
def get_profile_endpoint_origin(endpoint_name=None, name=None, profile_name=None, resource_group_name=None, opts=None):
    """
