...
class AwaitableGetDataBoxEdgeDeviceResult(GetDataBoxEdgeDeviceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataBoxEdgeDeviceResult(
            etag=self.etag,
...
def get_data_box_edge_device(name=None, resource_group_name=None, opts=None):
    """
