...
class Container(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databoxedge/latest:Container"), pulumi.Alias(type_="azurerm:databoxedge/v20190801:Container"), pulumi.Alias(type_="azurerm:databoxedge/v20200501preview:Container")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Container, __self__).__init__(
            'azurerm:databoxedge/preview:Container',
            resource_name,
            __props__,
            opts)
