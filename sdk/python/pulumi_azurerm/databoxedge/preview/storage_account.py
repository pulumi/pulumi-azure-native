...
class StorageAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databoxedge/latest:StorageAccount"), pulumi.Alias(type_="azurerm:databoxedge/v20190801:StorageAccount"), pulumi.Alias(type_="azurerm:databoxedge/v20200501preview:StorageAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageAccount, __self__).__init__(
            'azurerm:databoxedge/preview:StorageAccount',
            resource_name,
            __props__,
            opts)
