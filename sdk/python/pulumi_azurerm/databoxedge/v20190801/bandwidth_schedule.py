...
class BandwidthSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['stop'] = stop
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databoxedge/v20190301:BandwidthSchedule"), pulumi.Alias(type_="azurerm:databoxedge/v20190701:BandwidthSchedule")])
