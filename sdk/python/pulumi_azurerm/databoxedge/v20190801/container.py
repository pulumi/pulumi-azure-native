...
class Container(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databoxedge/latest:Container"), pulumi.Alias(type_="azurerm:databoxedge/preview:Container"), pulumi.Alias(type_="azurerm:databoxedge/v20200501preview:Container")])
