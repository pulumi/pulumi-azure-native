...
class Device(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databoxedge/latest:Device"), pulumi.Alias(type_="azurerm:databoxedge/preview:Device"), pulumi.Alias(type_="azurerm:databoxedge/v20190301:Device"), pulumi.Alias(type_="azurerm:databoxedge/v20190701:Device"), pulumi.Alias(type_="azurerm:databoxedge/v20190801:Device")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Device, __self__).__init__(
            'azurerm:databoxedge/v20200501preview:Device',
            resource_name,
            __props__,
            opts)
