...
class StorageAccountCredential(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databoxedge/latest:StorageAccountCredential"), pulumi.Alias(type_="azurerm:databoxedge/preview:StorageAccountCredential"), pulumi.Alias(type_="azurerm:databoxedge/v20190301:StorageAccountCredential"), pulumi.Alias(type_="azurerm:databoxedge/v20190701:StorageAccountCredential"), pulumi.Alias(type_="azurerm:databoxedge/v20190801:StorageAccountCredential")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageAccountCredential, __self__).__init__(
            'azurerm:databoxedge/v20200501preview:StorageAccountCredential',
            resource_name,
            __props__,
            opts)
