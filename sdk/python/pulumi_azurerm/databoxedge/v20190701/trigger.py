...
class Trigger(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, device_name=None, kind=None, name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databoxedge/v20190301:Trigger"), pulumi.Alias(type_="azurerm:databoxedge/v20190801:Trigger")])
