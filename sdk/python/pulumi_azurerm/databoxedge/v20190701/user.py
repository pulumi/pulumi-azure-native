...
class User(pulumi.CustomResource):
    def __init__(__self__,
        ...
        user = azurerm.databoxedge.v20190701.User("user",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:databoxedge/latest:User"), pulumi.Alias(type_="azurerm:databoxedge/v20190301:User"), pulumi.Alias(type_="azurerm:databoxedge/v20190801:User"), pulumi.Alias(type_="azurerm:databoxedge/v20200501preview:User")])
