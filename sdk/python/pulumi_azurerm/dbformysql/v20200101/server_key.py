...
class ServerKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        server_key = azurerm.dbformysql.v20200101.ServerKey("serverKey",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformysql/latest:ServerKey"), pulumi.Alias(type_="azurerm:dbformysql/v20200101privatepreview:ServerKey")])
