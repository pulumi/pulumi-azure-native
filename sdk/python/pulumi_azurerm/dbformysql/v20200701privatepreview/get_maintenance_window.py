...
def get_maintenance_window(maintenance_window_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:dbformysql/v20200701privatepreview:getMaintenanceWindow', __args__, opts=opts, typ=GetMaintenanceWindowResult).value
