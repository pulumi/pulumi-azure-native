...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformysql/latest:Server"), pulumi.Alias(type_="azurerm:dbformysql/preview:Server"), pulumi.Alias(type_="azurerm:dbformysql/v20171201:Server")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Server, __self__).__init__(
            'azurerm:dbformysql/v20171201preview:Server',
            resource_name,
            __props__,
            opts)
