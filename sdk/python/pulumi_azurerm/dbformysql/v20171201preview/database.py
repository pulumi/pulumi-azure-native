...
class Database(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database = azurerm.dbformysql.v20171201preview.Database("database",
            charset="utf8",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformysql/latest:Database"), pulumi.Alias(type_="azurerm:dbformysql/v20171201:Database")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Database, __self__).__init__(
            'azurerm:dbformysql/v20171201preview:Database',
            resource_name,
            __props__,
            opts)
