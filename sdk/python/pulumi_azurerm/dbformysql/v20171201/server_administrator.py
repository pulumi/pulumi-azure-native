...
class ServerAdministrator(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformysql/latest:ServerAdministrator"), pulumi.Alias(type_="azurerm:dbformysql/preview:ServerAdministrator"), pulumi.Alias(type_="azurerm:dbformysql/v20171201preview:ServerAdministrator")])
