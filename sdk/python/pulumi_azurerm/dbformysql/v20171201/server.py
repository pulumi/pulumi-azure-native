...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:dbformysql/latest:Server"), pulumi.Alias(type_="azurerm:dbformysql/preview:Server"), pulumi.Alias(type_="azurerm:dbformysql/v20171201preview:Server")])
