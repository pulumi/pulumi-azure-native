...
class Account(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datalakestore/latest:Account"), pulumi.Alias(type_="azurerm:datalakestore/v20161101:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azurerm:datalakestore/preview:Account',
            resource_name,
            __props__,
            opts)
