...
class AccountVirtualNetworkRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AccountVirtualNetworkRule, __self__).__init__(
            'azurerm:datalakestore:AccountVirtualNetworkRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        :param pulumi.Input[dict] properties: The virtual network rule properties.
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return AccountVirtualNetworkRule(resource_name, opts=opts, __props__=__props__)
