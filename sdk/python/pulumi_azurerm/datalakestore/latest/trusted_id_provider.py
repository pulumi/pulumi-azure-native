...
class TrustedIdProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:datalakestore/preview:TrustedIdProvider"), pulumi.Alias(type_="azurerm:datalakestore/v20161101:TrustedIdProvider")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TrustedIdProvider, __self__).__init__(
            'azurerm:datalakestore/latest:TrustedIdProvider',
            resource_name,
            __props__,
            opts)
