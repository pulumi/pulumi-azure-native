...
class AccountTrustedIdProvider(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: The trusted identity provider properties to use when creating a new trusted identity provider.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AccountTrustedIdProvider, __self__).__init__(
            'azurerm:datalakestore:AccountTrustedIdProvider',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        :param pulumi.Input[dict] properties: The trusted identity provider properties.
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return AccountTrustedIdProvider(resource_name, opts=opts, __props__=__props__)
