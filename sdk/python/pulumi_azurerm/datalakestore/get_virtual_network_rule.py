...
def get_virtual_network_rule(account_name=None, name=None, resource_group_name=None, opts=None):
    """
    Use this data source to access information about an existing resource.

    :param str account_name: The name of the Data Lake Store account.
    :param str name: The name of the virtual network rule to retrieve.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:datalakestore:getVirtualNetworkRule', __args__, opts=opts).value
