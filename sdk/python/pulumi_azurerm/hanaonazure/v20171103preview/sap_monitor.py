...
class SapMonitor(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hanaonazure/latest:SapMonitor"), pulumi.Alias(type_="azurerm:hanaonazure/v20200207preview:SapMonitor")])
