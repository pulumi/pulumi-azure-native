...
class SapMonitor(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hanaonazure/v20171103preview:SapMonitor"), pulumi.Alias(type_="azurerm:hanaonazure/v20200207preview:SapMonitor")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SapMonitor, __self__).__init__(
            'azurerm:hanaonazure/preview:SapMonitor',
            resource_name,
            __props__,
            opts)
