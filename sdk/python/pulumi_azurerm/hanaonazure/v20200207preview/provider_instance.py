...
class ProviderInstance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:hanaonazure/preview:ProviderInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProviderInstance, __self__).__init__(
            'azurerm:hanaonazure/v20200207preview:ProviderInstance',
            resource_name,
            __props__,
            opts)
