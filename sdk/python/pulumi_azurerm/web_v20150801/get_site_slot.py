...
def get_site_slot(name=None, properties_to_include=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:getSiteSlot', __args__, opts=opts).value
