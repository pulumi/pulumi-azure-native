...
def list_site_metadata(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:listSiteMetadata', __args__, opts=opts).value
