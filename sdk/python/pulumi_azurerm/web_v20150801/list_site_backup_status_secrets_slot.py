...
def list_site_backup_status_secrets_slot(id=None, kind=None, location=None, name=None, properties=None, resource_group_name=None, slot=None, tags=None, type=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:listSiteBackupStatusSecretsSlot', __args__, opts=opts).value
