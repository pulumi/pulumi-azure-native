...
def get_site_instance_deployment(instance_id=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:getSiteInstanceDeployment', __args__, opts=opts).value
