...
class DomainService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:aad/latest:DomainService"), pulumi.Alias(type_="azurerm:aad/v20170101:DomainService"), pulumi.Alias(type_="azurerm:aad/v20170601:DomainService")])
