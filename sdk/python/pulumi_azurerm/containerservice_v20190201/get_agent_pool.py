...
def get_agent_pool(managed_cluster_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerservice/v20190201:getAgentPool', __args__, opts=opts).value
