...
class ConfigurationProfilePreference(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automanage/v20200630preview:ConfigurationProfilePreference")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationProfilePreference, __self__).__init__(
            'azurerm:automanage/preview:ConfigurationProfilePreference',
            resource_name,
            __props__,
            opts)
