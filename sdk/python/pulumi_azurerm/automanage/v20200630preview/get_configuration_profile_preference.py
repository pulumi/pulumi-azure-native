...
def get_configuration_profile_preference(configuration_profile_preference_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:automanage/v20200630preview:getConfigurationProfilePreference', __args__, opts=opts, typ=GetConfigurationProfilePreferenceResult).value
