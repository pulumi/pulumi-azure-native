...
def get_channel(name=None, resource_group_name=None, resource_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:botservice/v20200602:getChannel', __args__, opts=opts).value
