...
class ConfigurationStore(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:appconfiguration/latest:ConfigurationStore"), pulumi.Alias(type_="azurerm:appconfiguration/preview:ConfigurationStore"), pulumi.Alias(type_="azurerm:appconfiguration/v20190201preview:ConfigurationStore"), pulumi.Alias(type_="azurerm:appconfiguration/v20191001:ConfigurationStore"), pulumi.Alias(type_="azurerm:appconfiguration/v20200601:ConfigurationStore")])
