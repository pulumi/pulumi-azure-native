...
def list_configuration_store_key_value(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:appconfiguration/v20190201preview:listConfigurationStoreKeyValue', __args__, opts=opts, typ=ListConfigurationStoreKeyValueResult).value
