...
def get_configuration_store(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:appconfiguration/v20190201preview:getConfigurationStore', __args__, opts=opts, typ=GetConfigurationStoreResult).value
