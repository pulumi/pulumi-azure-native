...
def get_private_endpoint_connection(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:appconfiguration/v20200601:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
