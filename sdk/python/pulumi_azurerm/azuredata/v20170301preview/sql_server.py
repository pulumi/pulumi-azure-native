...
class SqlServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        sql_server = azurerm.azuredata.v20170301preview.SqlServer("sqlServer",
            cores=8,
            edition="Latin",
            property_bag="",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:azuredata/v20190724preview:SqlServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServer, __self__).__init__(
            'azurerm:azuredata/v20170301preview:SqlServer',
            resource_name,
            __props__,
            opts)
