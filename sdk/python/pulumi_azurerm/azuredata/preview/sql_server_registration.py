...
class SqlServerRegistration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:azuredata/v20170301preview:SqlServerRegistration"), pulumi.Alias(type_="azurerm:azuredata/v20190724preview:SqlServerRegistration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServerRegistration, __self__).__init__(
            'azurerm:azuredata/preview:SqlServerRegistration',
            resource_name,
            __props__,
            opts)
