...
class SqlServerInstance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:azuredata/v20190724preview:SqlServerInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServerInstance, __self__).__init__(
            'azurerm:azuredata/preview:SqlServerInstance',
            resource_name,
            __props__,
            opts)
