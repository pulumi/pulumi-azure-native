...
class GetSqlServerRegistrationResult:
    ...
    """
    def __init__(__self__, location=None, name=None, property_bag=None, resource_group=None, subscription_id=None, system_data=None, tags=None, type=None):
...
def get_sql_server_registration(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:azuredata/v20190724preview:getSqlServerRegistration', __args__, opts=opts, typ=GetSqlServerRegistrationResult).value
