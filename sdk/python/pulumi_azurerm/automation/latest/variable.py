...
class Variable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/preview:Variable"), pulumi.Alias(type_="azurerm:automation/v20151031:Variable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Variable, __self__).__init__(
            'azurerm:automation/latest:Variable',
            resource_name,
            __props__,
            opts)
