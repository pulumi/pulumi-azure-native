...
class Connection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/preview:Connection"), pulumi.Alias(type_="azurerm:automation/v20151031:Connection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Connection, __self__).__init__(
            'azurerm:automation/latest:Connection',
            resource_name,
            __props__,
            opts)
