...
class DscNodeConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        dsc_node_configuration = azurerm.automation.v20180115.DscNodeConfiguration("dscNodeConfiguration",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/latest:DscNodeConfiguration"), pulumi.Alias(type_="azurerm:automation/v20151031:DscNodeConfiguration")])
