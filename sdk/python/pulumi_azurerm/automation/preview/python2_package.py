...
class Python2Package(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/latest:Python2Package"), pulumi.Alias(type_="azurerm:automation/v20180630:Python2Package")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Python2Package, __self__).__init__(
            'azurerm:automation/preview:Python2Package',
            resource_name,
            __props__,
            opts)
