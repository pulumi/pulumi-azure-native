...
class Module(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/latest:Module"), pulumi.Alias(type_="azurerm:automation/v20151031:Module")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Module, __self__).__init__(
            'azurerm:automation/preview:Module',
            resource_name,
            __props__,
            opts)
