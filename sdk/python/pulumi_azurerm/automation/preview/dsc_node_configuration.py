...
class DscNodeConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/latest:DscNodeConfiguration"), pulumi.Alias(type_="azurerm:automation/v20151031:DscNodeConfiguration"), pulumi.Alias(type_="azurerm:automation/v20180115:DscNodeConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DscNodeConfiguration, __self__).__init__(
            'azurerm:automation/preview:DscNodeConfiguration',
            resource_name,
            __props__,
            opts)
