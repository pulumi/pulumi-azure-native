...
class JobSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/latest:JobSchedule"), pulumi.Alias(type_="azurerm:automation/v20151031:JobSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(JobSchedule, __self__).__init__(
            'azurerm:automation/preview:JobSchedule',
            resource_name,
            __props__,
            opts)
