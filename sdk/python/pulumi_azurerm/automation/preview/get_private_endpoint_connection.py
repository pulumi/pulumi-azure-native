...
class GetPrivateEndpointConnectionResult:
    ...
    """
    def __init__(__self__, name=None, private_endpoint=None, private_link_service_connection_state=None, type=None):
...
def get_private_endpoint_connection(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:automation/preview:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
