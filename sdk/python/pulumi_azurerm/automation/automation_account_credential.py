...
class AutomationAccountCredential(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, automation_account_name=None, credential_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AutomationAccountCredential, __self__).__init__(
            'azurerm:automation:AutomationAccountCredential',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, name=None, properties=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `user_name` (`pulumi.Input[str]`) - Gets the user name of the credential.
        """
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return AutomationAccountCredential(resource_name, opts=opts, __props__=__props__)
