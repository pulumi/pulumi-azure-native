...
class Python2Package(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/latest:Python2Package"), pulumi.Alias(type_="azurerm:automation/preview:Python2Package")])
