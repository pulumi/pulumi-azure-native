...
class Runbook(pulumi.CustomResource):
    def __init__(__self__,
        ...
        runbook = azurerm.automation.v20151031.Runbook("runbook",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:automation/latest:Runbook"), pulumi.Alias(type_="azurerm:automation/v20180630:Runbook")])
