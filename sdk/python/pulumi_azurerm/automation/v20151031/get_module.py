...
def get_module(automation_account_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:automation/v20151031:getModule', __args__, opts=opts).value
