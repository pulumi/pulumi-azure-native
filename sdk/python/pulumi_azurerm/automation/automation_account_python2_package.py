...
class AutomationAccountPython2Package(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, automation_account_name=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AutomationAccountPython2Package, __self__).__init__(
            'azurerm:automation:AutomationAccountPython2Package',
            resource_name,
            __props__,
            opts)
