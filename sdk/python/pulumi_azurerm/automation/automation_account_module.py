...
class AutomationAccountModule(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, automation_account_name=None, location=None, module_name=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['etag'] = None
            __props__['type'] = None
        super(AutomationAccountModule, __self__).__init__(
            'azurerm:automation:AutomationAccountModule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        __props__["tags"] = tags
        __props__["type"] = type
        return AutomationAccountModule(resource_name, opts=opts, __props__=__props__)
