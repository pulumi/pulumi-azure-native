...
class AutomationAccountWatcher(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, automation_account_name=None, etag=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        super(AutomationAccountWatcher, __self__).__init__(
            'azurerm:automation:AutomationAccountWatcher',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, etag=None, location=None, name=None, properties=None, tags=None, type=None):
        """
        Get an existing AutomationAccountWatcher resource's state with the given name, id, and optional extra
        ...
        The **properties** object supports the following:
          ...
          * `description` (`pulumi.Input[str]`) - Gets or sets the description.
          * `execution_frequency_in_seconds` (`pulumi.Input[float]`) - Gets or sets the frequency at which the watcher is invoked.
          * `last_modified_by` (`pulumi.Input[str]`) - Details of the user who last modified the watcher.
          * `last_modified_time` (`pulumi.Input[str]`) - Gets or sets the last modified time.
          * `script_name` (`pulumi.Input[str]`) - Gets or sets the name of the script the watcher is attached to, i.e. the name of an existing runbook.
          * `script_parameters` (`pulumi.Input[dict]`) - Gets or sets the parameters of the script.
          * `script_run_on` (`pulumi.Input[str]`) - Gets or sets the name of the hybrid worker group the watcher will run on.
          * `status` (`pulumi.Input[str]`) - Gets the current status of the watcher.
        """
        ...
        __props__["tags"] = tags
        __props__["type"] = type
        return AutomationAccountWatcher(resource_name, opts=opts, __props__=__props__)
