...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        attached_database_configuration = azurerm.kusto.v20190907.AttachedDatabaseConfiguration("attachedDatabaseConfiguration",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:kusto/latest:AttachedDatabaseConfiguration"), pulumi.Alias(type_="azurerm:kusto/v20191109:AttachedDatabaseConfiguration"), pulumi.Alias(type_="azurerm:kusto/v20200215:AttachedDatabaseConfiguration"), pulumi.Alias(type_="azurerm:kusto/v20200614:AttachedDatabaseConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AttachedDatabaseConfiguration, __self__).__init__(
            'azurerm:kusto/v20190907:AttachedDatabaseConfiguration',
            resource_name,
            __props__,
            opts)
