...
class Database(pulumi.CustomResource):
    def __init__(__self__,
        ...
        database = azurerm.kusto.v20180907preview.Database("database",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:kusto/latest:Database"), pulumi.Alias(type_="azurerm:kusto/v20170907privatepreview:Database"), pulumi.Alias(type_="azurerm:kusto/v20190121:Database"), pulumi.Alias(type_="azurerm:kusto/v20190515:Database"), pulumi.Alias(type_="azurerm:kusto/v20190907:Database"), pulumi.Alias(type_="azurerm:kusto/v20191109:Database"), pulumi.Alias(type_="azurerm:kusto/v20200215:Database"), pulumi.Alias(type_="azurerm:kusto/v20200614:Database")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Database, __self__).__init__(
            'azurerm:kusto/v20180907preview:Database',
            resource_name,
            __props__,
            opts)
