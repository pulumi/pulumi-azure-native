...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        attached_database_configuration = azurerm.kusto.v20191109.AttachedDatabaseConfiguration("attachedDatabaseConfiguration",
