...
class Cluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
            __props__['uri'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:kusto/latest:Cluster"), pulumi.Alias(type_="azurerm:kusto/preview:Cluster"), pulumi.Alias(type_="azurerm:kusto/v20180907preview:Cluster"), pulumi.Alias(type_="azurerm:kusto/v20190121:Cluster"), pulumi.Alias(type_="azurerm:kusto/v20190515:Cluster"), pulumi.Alias(type_="azurerm:kusto/v20190907:Cluster"), pulumi.Alias(type_="azurerm:kusto/v20191109:Cluster"), pulumi.Alias(type_="azurerm:kusto/v20200215:Cluster"), pulumi.Alias(type_="azurerm:kusto/v20200614:Cluster")])
