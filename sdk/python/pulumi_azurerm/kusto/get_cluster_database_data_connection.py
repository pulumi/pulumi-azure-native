...
class AwaitableGetClusterDatabaseDataConnectionResult(GetClusterDatabaseDataConnectionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetClusterDatabaseDataConnectionResult(
            kind=self.kind,
...
def get_cluster_database_data_connection(cluster_name=None, database_name=None, name=None, resource_group_name=None, opts=None):
    """
