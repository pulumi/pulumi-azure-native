...
class ClusterPrincipalAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:kusto/preview:ClusterPrincipalAssignment"), pulumi.Alias(type_="azurerm:kusto/v20191109:ClusterPrincipalAssignment"), pulumi.Alias(type_="azurerm:kusto/v20200215:ClusterPrincipalAssignment"), pulumi.Alias(type_="azurerm:kusto/v20200614:ClusterPrincipalAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterPrincipalAssignment, __self__).__init__(
            'azurerm:kusto/latest:ClusterPrincipalAssignment',
            resource_name,
            __props__,
            opts)
