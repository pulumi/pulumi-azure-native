...
class Database(pulumi.CustomResource):
    ...
    The database properties.
      * `hot_cache_period` (`str`) - The time the data that should be kept in cache for fast queries in TimeSpan.
    ...
    def __init__(__self__, resource_name, opts=None, cluster_name=None, location=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `hot_cache_period` (`pulumi.Input[str]`) - The time the data that should be kept in cache for fast queries in TimeSpan.
