...
class EventHubConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:kusto/v20170907privatepreview:EventHubConnection"), pulumi.Alias(type_="azurerm:kusto/v20180907preview:EventHubConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventHubConnection, __self__).__init__(
            'azurerm:kusto/preview:EventHubConnection',
            resource_name,
            __props__,
            opts)
