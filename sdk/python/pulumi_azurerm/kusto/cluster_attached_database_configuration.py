...
class ClusterAttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, cluster_name=None, location=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(ClusterAttachedDatabaseConfiguration, __self__).__init__(
            'azurerm:kusto:ClusterAttachedDatabaseConfiguration',
            resource_name,
            __props__,
            opts)
