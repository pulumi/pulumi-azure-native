...
class ClusterPrincipalAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:kusto/latest:ClusterPrincipalAssignment"), pulumi.Alias(type_="azurerm:kusto/v20191109:ClusterPrincipalAssignment"), pulumi.Alias(type_="azurerm:kusto/v20200215:ClusterPrincipalAssignment")])
