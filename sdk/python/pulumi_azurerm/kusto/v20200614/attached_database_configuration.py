...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        attached_database_configuration = azurerm.kusto.v20200614.AttachedDatabaseConfiguration("attachedDatabaseConfiguration",
