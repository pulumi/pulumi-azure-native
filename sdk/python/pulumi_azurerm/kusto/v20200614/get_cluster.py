...
class GetClusterResult:
    ...
    def __init__(__self__, data_ingestion_uri=None, enable_disk_encryption=None, enable_double_encryption=None, enable_purge=None, enable_streaming_ingest=None, identity=None, key_vault_properties=None, language_extensions=None, location=None, name=None, optimized_autoscale=None, provisioning_state=None, sku=None, state=None, state_reason=None, tags=None, trusted_external_tenants=None, type=None, uri=None, virtual_network_configuration=None, zones=None):
        ...
        __self__.enable_double_encryption = enable_double_encryption
        """
...
def get_cluster(name=None, resource_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:kusto/v20200614:getCluster', __args__, opts=opts).value

    return AwaitableGetClusterResult(
        data_ingestion_uri=__ret__.get('dataIngestionUri'),
        enable_disk_encryption=__ret__.get('enableDiskEncryption'),
        enable_double_encryption=__ret__.get('enableDoubleEncryption'),
