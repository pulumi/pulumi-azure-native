...
class ContainerGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        container_group = azurerm.containerinstance.v20171001preview.ContainerGroup("containerGroup",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerinstance/latest:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20170801preview:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20171201preview:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20180201preview:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20180401:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20180601:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20180901:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20181001:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20191201:ContainerGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerGroup, __self__).__init__(
            'azurerm:containerinstance/v20171001preview:ContainerGroup',
            resource_name,
            __props__,
            opts)
