...
class ContainerGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        container_group = azurerm.containerinstance.v20171201preview.ContainerGroup("containerGroup",
