...
class ContainerGroup(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, containers=None, diagnostics=None, image_registry_credentials=None, ip_address=None, location=None, name=None, os_type=None, resource_group_name=None, restart_policy=None, tags=None, volumes=None, __props__=None, __name__=None, __opts__=None):
        """
        A container group.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:containerinstance/v20180401:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20180901:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20181001:ContainerGroup"), pulumi.Alias(type_="azurerm:containerinstance/v20191201:ContainerGroup")])
