...
class GetContainerGroupResult:
    ...
    A container group.
    """
    def __init__(__self__, containers=None, diagnostics=None, image_registry_credentials=None, instance_view=None, ip_address=None, location=None, name=None, network_profile=None, os_type=None, provisioning_state=None, restart_policy=None, tags=None, type=None, volumes=None):
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerinstance/v20180901:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
