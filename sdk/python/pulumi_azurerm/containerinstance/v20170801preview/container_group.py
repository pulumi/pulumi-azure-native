...
class ContainerGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        container_group = azurerm.containerinstance.v20170801preview.ContainerGroup("containerGroup",
