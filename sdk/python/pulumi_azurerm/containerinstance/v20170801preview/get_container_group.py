...
class GetContainerGroupResult:
    ...
    A container group.
    """
    def __init__(__self__, containers=None, image_registry_credentials=None, ip_address=None, location=None, name=None, os_type=None, provisioning_state=None, restart_policy=None, state=None, tags=None, type=None, volumes=None):
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:containerinstance/v20170801preview:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
