...
class ContainerGroup(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, containers=None, diagnostics=None, dns_config=None, identity=None, image_registry_credentials=None, ip_address=None, location=None, name=None, network_profile=None, os_type=None, resource_group_name=None, restart_policy=None, tags=None, volumes=None, __props__=None, __name__=None, __opts__=None):
        """
        A container group.
