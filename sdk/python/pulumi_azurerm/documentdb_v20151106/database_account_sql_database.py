...
class DatabaseAccountSqlDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] properties: Properties to create and update Azure Cosmos DB SQL database.
        ...
        The **properties** object supports the following:
          ...
          * `resource` (`pulumi.Input[dict]`) - The standard JSON format of a SQL database
        ...
        super(DatabaseAccountSqlDatabase, __self__).__init__(
            'azurerm:documentdb/v20151106:DatabaseAccountSqlDatabase',
            resource_name,
            __props__,
            opts)
