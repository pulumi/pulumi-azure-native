...
def get_multiple_activation_key(multiple_activation_key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:windowsesu/v20190916preview:getMultipleActivationKey', __args__, opts=opts, typ=GetMultipleActivationKeyResult).value
