...
class LabaccountLabEnvironmentsettingEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, environment_setting_name=None, lab_account_name=None, lab_name=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        super(LabaccountLabEnvironmentsettingEnvironment, __self__).__init__(
            'azurerm:labservices:LabaccountLabEnvironmentsettingEnvironment',
            resource_name,
            __props__,
            opts)
