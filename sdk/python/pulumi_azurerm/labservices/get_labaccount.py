...
def get_labaccount(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:labservices:getLabaccount', __args__, opts=opts).value
