...
class Environment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:labservices/latest:Environment"), pulumi.Alias(type_="azurerm:labservices/v20181015:Environment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Environment, __self__).__init__(
            'azurerm:labservices/preview:Environment',
            resource_name,
            __props__,
            opts)
