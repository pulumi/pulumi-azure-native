...
class GalleryImage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:labservices/latest:GalleryImage"), pulumi.Alias(type_="azurerm:labservices/v20181015:GalleryImage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GalleryImage, __self__).__init__(
            'azurerm:labservices/preview:GalleryImage',
            resource_name,
            __props__,
            opts)
