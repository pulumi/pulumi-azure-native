...
class Budget(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:consumption/v20180131:Budget"), pulumi.Alias(type_="azurerm:consumption/v20180331:Budget"), pulumi.Alias(type_="azurerm:consumption/v20180630:Budget"), pulumi.Alias(type_="azurerm:consumption/v20180831:Budget")])
