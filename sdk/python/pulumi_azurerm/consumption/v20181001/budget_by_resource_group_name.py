...
class BudgetByResourceGroupName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        budget_by_resource_group_name = azurerm.consumption.v20181001.BudgetByResourceGroupName("budgetByResourceGroupName",
            amount=100.65,
        ...
        super(BudgetByResourceGroupName, __self__).__init__(
            'azurerm:consumption/v20181001:BudgetByResourceGroupName',
            resource_name,
            __props__,
            opts)
