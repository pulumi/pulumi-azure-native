...
class BudgetByResourceGroupName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:consumption/latest:BudgetByResourceGroupName"), pulumi.Alias(type_="azurerm:consumption/preview:BudgetByResourceGroupName"), pulumi.Alias(type_="azurerm:consumption/v20180331:BudgetByResourceGroupName"), pulumi.Alias(type_="azurerm:consumption/v20180630:BudgetByResourceGroupName"), pulumi.Alias(type_="azurerm:consumption/v20180831:BudgetByResourceGroupName"), pulumi.Alias(type_="azurerm:consumption/v20181001:BudgetByResourceGroupName")])
