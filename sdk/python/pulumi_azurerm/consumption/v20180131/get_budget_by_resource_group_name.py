...
def get_budget_by_resource_group_name(budget_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:consumption/v20180131:getBudgetByResourceGroupName', __args__, opts=opts, typ=GetBudgetByResourceGroupNameResult).value
