...
class Budget(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, amount=None, category=None, e_tag=None, filters=None, name=None, notifications=None, scope=None, time_grain=None, time_period=None, __props__=None, __name__=None, __opts__=None):
        """
        A budget resource.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:consumption/v20190101:Budget"), pulumi.Alias(type_="azurerm:consumption/v20190601:Budget"), pulumi.Alias(type_="azurerm:consumption/v20191001:Budget")])
