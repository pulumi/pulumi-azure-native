...
class Budget(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, e_tag=None, name=None, properties=None, scope=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `filter` (`pulumi.Input[dict]`) - May be used to filter budgets by resource group, resource, or meter.
          ...
          * `time_grain` (`pulumi.Input[str]`) - The time covered by a budget. Tracking of the amount will be reset based on the time grain. BillingMonth, BillingQuarter, and BillingAnnual are only supported by WD customers
