...
def get_connection(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20160601:getConnection', __args__, opts=opts).value
