...
def get_integration_account_batch_configuration(integration_account_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:logic/v20160601:getIntegrationAccountBatchConfiguration', __args__, opts=opts).value
