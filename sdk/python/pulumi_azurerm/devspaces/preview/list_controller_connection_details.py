...
def list_controller_connection_details(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:devspaces/preview:listControllerConnectionDetails', __args__, opts=opts, typ=ListControllerConnectionDetailsResult).value
