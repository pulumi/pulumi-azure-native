...
class Cluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        cluster = azurerm.batchai.v20180301.Cluster("cluster",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batchai/v20170901preview:Cluster")])
