...
class FileServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        file_server = azurerm.batchai.v20180301.FileServer("fileServer",
            data_disks={
                "diskCount": 2,
                "diskSizeInGB": 10,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batchai/v20170901preview:FileServer")])
