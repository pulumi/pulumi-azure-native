...
def list_cluster_remote_login_information(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai/v20180301:listClusterRemoteLoginInformation', __args__, opts=opts, typ=ListClusterRemoteLoginInformationResult).value
