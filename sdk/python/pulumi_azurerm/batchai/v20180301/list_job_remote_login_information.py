...
def list_job_remote_login_information(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai/v20180301:listJobRemoteLoginInformation', __args__, opts=opts, typ=ListJobRemoteLoginInformationResult).value
