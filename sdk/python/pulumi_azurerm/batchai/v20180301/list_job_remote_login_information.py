...
def list_job_remote_login_information(job_name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai/v20180301:listJobRemoteLoginInformation', __args__, opts=opts).value
