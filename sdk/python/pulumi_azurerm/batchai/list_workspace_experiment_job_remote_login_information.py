...
class ListWorkspaceExperimentJobRemoteLoginInformationResult:
    """
...
class AwaitableListWorkspaceExperimentJobRemoteLoginInformationResult(ListWorkspaceExperimentJobRemoteLoginInformationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListWorkspaceExperimentJobRemoteLoginInformationResult(
            next_link=self.next_link,
            value=self.value)


def list_workspace_experiment_job_remote_login_information(experiment_name=None, job_name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai:listWorkspaceExperimentJobRemoteLoginInformation', __args__, opts=opts).value

    return AwaitableListWorkspaceExperimentJobRemoteLoginInformationResult(
