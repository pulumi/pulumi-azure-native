...
class Job(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 environment_variables: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['EnvironmentSettingArgs']]]]] = None,
        ...
        job = azurerm.batchai.v20170901preview.Job("job",
            cluster={
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batchai/v20180301:Job")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Job, __self__).__init__(
            'azurerm:batchai/v20170901preview:Job',
            resource_name,
            __props__,
            opts)
    ...
    def environment_variables(self) -> pulumi.Output[Optional[List['outputs.EnvironmentSettingResponse']]]:
        """
