...
class ListJobRemoteLoginInformationResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[List['outputs.RemoteLoginInformationResponseResult']]:
        """
...
def list_job_remote_login_information(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai/v20170901preview:listJobRemoteLoginInformation', __args__, opts=opts, typ=ListJobRemoteLoginInformationResult).value
