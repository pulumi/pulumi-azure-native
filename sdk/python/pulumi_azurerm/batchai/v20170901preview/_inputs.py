...
class SetupTaskArgs:
    def __init__(__self__, *,
                 ...
                 environment_variables: Optional[pulumi.Input[List[pulumi.Input['EnvironmentSettingArgs']]]] = None,
    ...
    def environment_variables(self) -> Optional[pulumi.Input[List[pulumi.Input['EnvironmentSettingArgs']]]]:
        return pulumi.get(self, "environment_variables")

    @environment_variables.setter
    def environment_variables(self, value: Optional[pulumi.Input[List[pulumi.Input['EnvironmentSettingArgs']]]]):
...
class SshConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] public_ips_to_allow: Default value is '*' can be used to match all source IPs. Maximum number of publicIPs that can be specified are 400.
        """
