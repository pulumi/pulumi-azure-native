...
class FileServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        file_server = azurerm.batchai.v20170901preview.FileServer("fileServer",
            data_disks={
                "diskCount": 2,
                "diskSizeInGB": 10,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batchai/v20180301:FileServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileServer, __self__).__init__(
            'azurerm:batchai/v20170901preview:FileServer',
            resource_name,
            __props__,
            opts)
