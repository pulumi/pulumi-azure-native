...
class ListWorkspaceClusterRemoteLoginInformationResult:
    """
...
class AwaitableListWorkspaceClusterRemoteLoginInformationResult(ListWorkspaceClusterRemoteLoginInformationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListWorkspaceClusterRemoteLoginInformationResult(
            next_link=self.next_link,
            value=self.value)


def list_workspace_cluster_remote_login_information(cluster_name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai:listWorkspaceClusterRemoteLoginInformation', __args__, opts=opts).value

    return AwaitableListWorkspaceClusterRemoteLoginInformationResult(
