...
class GetWorkspaceFileServerResult:
    """
...
class AwaitableGetWorkspaceFileServerResult(GetWorkspaceFileServerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWorkspaceFileServerResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_workspace_file_server(name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai:getWorkspaceFileServer', __args__, opts=opts).value

    return AwaitableGetWorkspaceFileServerResult(
