...
class FileServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batchai/latest:FileServer"), pulumi.Alias(type_="azurerm:batchai/v20180501:FileServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileServer, __self__).__init__(
            'azurerm:batchai/preview:FileServer',
            resource_name,
            __props__,
            opts)
