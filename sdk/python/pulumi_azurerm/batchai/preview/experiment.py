...
class Experiment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:batchai/latest:Experiment"), pulumi.Alias(type_="azurerm:batchai/v20180501:Experiment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Experiment, __self__).__init__(
            'azurerm:batchai/preview:Experiment',
            resource_name,
            __props__,
            opts)
