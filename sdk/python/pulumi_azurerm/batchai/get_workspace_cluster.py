...
class AwaitableGetWorkspaceClusterResult(GetWorkspaceClusterResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWorkspaceClusterResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_workspace_cluster(name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
