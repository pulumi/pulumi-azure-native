...
class GetWorkspaceExperimentJobResult:
    """
...
class AwaitableGetWorkspaceExperimentJobResult(GetWorkspaceExperimentJobResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWorkspaceExperimentJobResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_workspace_experiment_job(experiment_name=None, name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:batchai:getWorkspaceExperimentJob', __args__, opts=opts).value

    return AwaitableGetWorkspaceExperimentJobResult(
