...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, etag=None, id=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **properties** object supports the following:
          ...
          * `enable_ddos_protection` (`pulumi.Input[bool]`) - Indicates if DDoS protection is enabled for all the protected resources in a Virtual Network.
          * `enable_vm_protection` (`pulumi.Input[bool]`) - Indicates if Vm protection is enabled for all the subnets in a Virtual Network.
