...
class EnterpriseKnowledgeGraph(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph"), pulumi.Alias(type_="azurerm:enterpriseknowledgegraph/preview:EnterpriseKnowledgeGraph")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterpriseKnowledgeGraph, __self__).__init__(
            'azurerm:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph',
            resource_name,
            __props__,
            opts)
