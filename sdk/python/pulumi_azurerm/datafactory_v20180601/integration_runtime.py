...
class IntegrationRuntime(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, factory_name=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[str] name: The integration runtime name.
        :param pulumi.Input[dict] properties: Integration runtime properties.
        ...
        super(IntegrationRuntime, __self__).__init__(
            'azurerm:datafactory/v20180601:IntegrationRuntime',
            resource_name,
            __props__,
            opts)
