...
class Incident(pulumi.CustomResource):
    def __init__(__self__,
        ...
        incident = azurerm.operationalinsights.v20200101.Incident("incident",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:Incident")])
