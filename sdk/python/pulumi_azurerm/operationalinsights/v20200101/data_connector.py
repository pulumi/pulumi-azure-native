...
class DataConnector(pulumi.CustomResource):
    def __init__(__self__,
        ...
        data_connector = azurerm.operationalinsights.v20200101.DataConnector("dataConnector",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:DataConnector")])
