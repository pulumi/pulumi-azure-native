...
class AlertRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alert_rule = azurerm.operationalinsights.v20200101.AlertRule("alertRule",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:AlertRule")])
