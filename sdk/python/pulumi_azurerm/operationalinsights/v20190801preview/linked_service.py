...
class LinkedService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        linked_service = azurerm.operationalinsights.v20190801preview.LinkedService("linkedService",
            linked_service_name="TestLinkWS/Cluster",
            resource_group_name="mms-eus",
            workspace_name="TestLinkWS",
            write_access_resource_id="/subscriptions/00000000-0000-0000-0000-00000000000/resourceGroups/mms-eus/providers/Microsoft.OperationalInsights/automationClusters/testcluster")
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:LinkedService"), pulumi.Alias(type_="azurerm:operationalinsights/v20151101preview:LinkedService"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:LinkedService"), pulumi.Alias(type_="azurerm:operationalinsights/v20200801:LinkedService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LinkedService, __self__).__init__(
            'azurerm:operationalinsights/v20190801preview:LinkedService',
            resource_name,
            __props__,
            opts)
