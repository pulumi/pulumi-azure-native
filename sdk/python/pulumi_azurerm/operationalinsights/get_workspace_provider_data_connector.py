...
class AwaitableGetWorkspaceProviderDataConnectorResult(GetWorkspaceProviderDataConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWorkspaceProviderDataConnectorResult(
            etag=self.etag,
            kind=self.kind,
            name=self.name,
            type=self.type)
...
def get_workspace_provider_data_connector(name=None, resource_group_name=None, workspace_name=None, opts=None):
    """
