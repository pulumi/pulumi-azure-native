...
class DataSource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/v20151101preview:DataSource"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:DataSource"), pulumi.Alias(type_="azurerm:operationalinsights/v20200801:DataSource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataSource, __self__).__init__(
            'azurerm:operationalinsights/latest:DataSource',
            resource_name,
            __props__,
            opts)
