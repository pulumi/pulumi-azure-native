...
class Incident(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/preview:Incident"), pulumi.Alias(type_="azurerm:operationalinsights/v20200101:Incident")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Incident, __self__).__init__(
            'azurerm:operationalinsights/latest:Incident',
            resource_name,
            __props__,
            opts)
