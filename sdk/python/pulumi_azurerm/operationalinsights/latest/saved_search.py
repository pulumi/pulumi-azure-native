...
class SavedSearch(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/v20150320:SavedSearch"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:SavedSearch"), pulumi.Alias(type_="azurerm:operationalinsights/v20200801:SavedSearch")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SavedSearch, __self__).__init__(
            'azurerm:operationalinsights/latest:SavedSearch',
            resource_name,
            __props__,
            opts)
