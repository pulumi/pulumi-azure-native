...
class DataConnector(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/preview:DataConnector"), pulumi.Alias(type_="azurerm:operationalinsights/v20200101:DataConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataConnector, __self__).__init__(
            'azurerm:operationalinsights/latest:DataConnector',
            resource_name,
            __props__,
            opts)
