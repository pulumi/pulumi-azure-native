...
class Bookmark(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:Bookmark"), pulumi.Alias(type_="azurerm:operationalinsights/v20200101:Bookmark")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Bookmark, __self__).__init__(
            'azurerm:operationalinsights/preview:Bookmark',
            resource_name,
            __props__,
            opts)
