...
class DataExport(pulumi.CustomResource):
    def __init__(__self__,
        ...
        data_export = azurerm.operationalinsights.v20200301preview.DataExport("dataExport",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:DataExport"), pulumi.Alias(type_="azurerm:operationalinsights/v20190801preview:DataExport"), pulumi.Alias(type_="azurerm:operationalinsights/v20200801:DataExport")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataExport, __self__).__init__(
            'azurerm:operationalinsights/v20200301preview:DataExport',
            resource_name,
            __props__,
            opts)
