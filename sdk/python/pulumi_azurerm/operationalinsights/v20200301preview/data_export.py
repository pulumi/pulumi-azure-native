...
class DataExport(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:DataExport"), pulumi.Alias(type_="azurerm:operationalinsights/preview:DataExport"), pulumi.Alias(type_="azurerm:operationalinsights/v20190801preview:DataExport"), pulumi.Alias(type_="azurerm:operationalinsights/v20200801:DataExport")])
