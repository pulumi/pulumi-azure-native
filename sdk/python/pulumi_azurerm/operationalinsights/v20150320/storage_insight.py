...
class StorageInsight(pulumi.CustomResource):
    def __init__(__self__,
        ...
        storage_insight = azurerm.operationalinsights.v20150320.StorageInsight("storageInsight",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:StorageInsight"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:StorageInsight"), pulumi.Alias(type_="azurerm:operationalinsights/v20200801:StorageInsight")])
