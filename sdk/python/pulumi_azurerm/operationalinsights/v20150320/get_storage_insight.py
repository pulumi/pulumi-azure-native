...
def get_storage_insight(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:operationalinsights/v20150320:getStorageInsight', __args__, opts=opts, typ=GetStorageInsightResult).value
