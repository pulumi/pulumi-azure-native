...
def get_linked_storage_account(data_source_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:operationalinsights/v20200801:getLinkedStorageAccount', __args__, opts=opts, typ=GetLinkedStorageAccountResult).value
