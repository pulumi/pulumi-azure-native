...
class DataSource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        data_source = azurerm.operationalinsights.v20200801.DataSource("dataSource",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:DataSource"), pulumi.Alias(type_="azurerm:operationalinsights/v20151101preview:DataSource"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:DataSource")])
