...
class LinkedStorageAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        linked_storage_account = azurerm.operationalinsights.v20200801.LinkedStorageAccount("linkedStorageAccount",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:LinkedStorageAccount"), pulumi.Alias(type_="azurerm:operationalinsights/v20190801preview:LinkedStorageAccount"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:LinkedStorageAccount")])
