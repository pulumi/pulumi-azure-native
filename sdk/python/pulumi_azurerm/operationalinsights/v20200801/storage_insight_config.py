...
class StorageInsightConfig(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:StorageInsightConfig"), pulumi.Alias(type_="azurerm:operationalinsights/v20150320:StorageInsightConfig"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:StorageInsightConfig")])
