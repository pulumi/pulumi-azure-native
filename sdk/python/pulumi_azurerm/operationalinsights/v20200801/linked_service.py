...
class LinkedService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        linked_service = azurerm.operationalinsights.v20200801.LinkedService("linkedService",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:LinkedService"), pulumi.Alias(type_="azurerm:operationalinsights/v20151101preview:LinkedService"), pulumi.Alias(type_="azurerm:operationalinsights/v20190801preview:LinkedService"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:LinkedService")])
