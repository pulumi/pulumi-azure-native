...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        workspace = azurerm.operationalinsights.v20200801.Workspace("workspace",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:operationalinsights/latest:Workspace"), pulumi.Alias(type_="azurerm:operationalinsights/v20151101preview:Workspace"), pulumi.Alias(type_="azurerm:operationalinsights/v20200301preview:Workspace")])
