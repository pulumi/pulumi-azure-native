...
class GetServiceResult:
    ...
    """
    def __init__(__self__, etag=None, kind=None, location=None, name=None, properties=None, tags=None, type=None):
...
def get_service(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:healthcareapis/v20180820preview:getService', __args__, opts=opts, typ=GetServiceResult).value
