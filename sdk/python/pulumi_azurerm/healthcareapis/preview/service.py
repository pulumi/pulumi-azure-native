...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:healthcareapis/latest:Service"), pulumi.Alias(type_="azurerm:healthcareapis/v20180820preview:Service"), pulumi.Alias(type_="azurerm:healthcareapis/v20190916:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azurerm:healthcareapis/preview:Service',
            resource_name,
            __props__,
            opts)
