...
class GuestUsage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:azureactivedirectory/v20200501preview:GuestUsage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestUsage, __self__).__init__(
            'azurerm:azureactivedirectory/preview:GuestUsage',
            resource_name,
            __props__,
            opts)
