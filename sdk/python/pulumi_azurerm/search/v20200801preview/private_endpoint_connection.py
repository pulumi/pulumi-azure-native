...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        private_endpoint_connection = azurerm.search.v20200801preview.PrivateEndpointConnection("privateEndpointConnection",
