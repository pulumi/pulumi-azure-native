...
class SharedPrivateLinkResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:search/preview:SharedPrivateLinkResource"), pulumi.Alias(type_="azurerm:search/v20200801:SharedPrivateLinkResource"), pulumi.Alias(type_="azurerm:search/v20200801preview:SharedPrivateLinkResource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SharedPrivateLinkResource, __self__).__init__(
            'azurerm:search/latest:SharedPrivateLinkResource',
            resource_name,
            __props__,
            opts)
