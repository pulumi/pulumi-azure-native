...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:search/v20150819:Service"), pulumi.Alias(type_="azurerm:search/v20200313:Service"), pulumi.Alias(type_="azurerm:search/v20200801:Service")])
