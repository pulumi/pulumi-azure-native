...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:search/preview:Service"), pulumi.Alias(type_="azurerm:search/v20150819:Service"), pulumi.Alias(type_="azurerm:search/v20191001preview:Service"), pulumi.Alias(type_="azurerm:search/v20200313:Service"), pulumi.Alias(type_="azurerm:search/v20200801:Service"), pulumi.Alias(type_="azurerm:search/v20200801preview:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azurerm:search/latest:Service',
            resource_name,
            __props__,
            opts)
