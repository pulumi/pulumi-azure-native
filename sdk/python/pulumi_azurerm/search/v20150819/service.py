...
class Service(pulumi.CustomResource):
    ...
    The resource type.
    """
    def __init__(__self__, resource_name, opts=None, hosting_mode=None, identity=None, location=None, name=None, partition_count=None, replica_count=None, resource_group_name=None, sku=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
