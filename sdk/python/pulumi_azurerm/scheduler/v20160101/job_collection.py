...
class JobCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:scheduler/latest:JobCollection"), pulumi.Alias(type_="azurerm:scheduler/v20160301:JobCollection")])
