...
class AwaitableGetJobCollectionJobResult(GetJobCollectionJobResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetJobCollectionJobResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_job_collection_job(job_collection_name=None, name=None, resource_group_name=None, opts=None):
    """
