...
class WorkspaceCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:powerbi/latest:WorkspaceCollection"), pulumi.Alias(type_="azurerm:powerbi/preview:WorkspaceCollection")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WorkspaceCollection':
        """
