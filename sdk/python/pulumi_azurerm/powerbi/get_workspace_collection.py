...
def get_workspace_collection(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:powerbi:getWorkspaceCollection', __args__, opts=opts).value
