...
class WorkspaceCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:powerbi/latest:WorkspaceCollection"), pulumi.Alias(type_="azurerm:powerbi/v20160129:WorkspaceCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceCollection, __self__).__init__(
            'azurerm:powerbi/preview:WorkspaceCollection',
            resource_name,
            __props__,
            opts)
