...
class DeploymentAtSubscriptionScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:resources/latest:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azurerm:resources/preview:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azurerm:resources/v20180501:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azurerm:resources/v20190301:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azurerm:resources/v20190501:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azurerm:resources/v20190510:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azurerm:resources/v20190701:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azurerm:resources/v20190801:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azurerm:resources/v20191001:DeploymentAtSubscriptionScope")])
