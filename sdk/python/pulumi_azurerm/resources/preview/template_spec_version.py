...
class TemplateSpecVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 artifacts: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TemplateSpecArtifactArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['TemplateSpecArtifactArgs']]]] artifacts: An array of Template Spec artifacts.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:resources/v20190601preview:TemplateSpecVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TemplateSpecVersion, __self__).__init__(
            'azurerm:resources/preview:TemplateSpecVersion',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def artifacts(self) -> pulumi.Output[Optional[List['outputs.TemplateSpecArtifactResponse']]]:
        """
