...
class DeploymentAtTenantScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:resources/latest:DeploymentAtTenantScope"), pulumi.Alias(type_="azurerm:resources/v20190701:DeploymentAtTenantScope"), pulumi.Alias(type_="azurerm:resources/v20190801:DeploymentAtTenantScope"), pulumi.Alias(type_="azurerm:resources/v20191001:DeploymentAtTenantScope"), pulumi.Alias(type_="azurerm:resources/v20200601:DeploymentAtTenantScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeploymentAtTenantScope, __self__).__init__(
            'azurerm:resources/preview:DeploymentAtTenantScope',
            resource_name,
            __props__,
            opts)
