...
class TagAtScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:resources/preview:TagAtScope"), pulumi.Alias(type_="azurerm:resources/v20191001:TagAtScope"), pulumi.Alias(type_="azurerm:resources/v20200601:TagAtScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagAtScope, __self__).__init__(
            'azurerm:resources/latest:TagAtScope',
            resource_name,
            __props__,
            opts)
