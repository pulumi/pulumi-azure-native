...
class DeploymentAtScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:resources/v20190701:DeploymentAtScope"), pulumi.Alias(type_="azurerm:resources/v20190801:DeploymentAtScope"), pulumi.Alias(type_="azurerm:resources/v20191001:DeploymentAtScope"), pulumi.Alias(type_="azurerm:resources/v20200601:DeploymentAtScope")])
