...
class DeploymentAtManagementGroupScope(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, group_id=None, location=None, name=None, properties=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        super(DeploymentAtManagementGroupScope, __self__).__init__(
            'azurerm:resources:DeploymentAtManagementGroupScope',
            resource_name,
            __props__,
            opts)
