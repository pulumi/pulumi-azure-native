...
class Resource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:resources/latest:Resource"), pulumi.Alias(type_="azurerm:resources/v20151101:Resource"), pulumi.Alias(type_="azurerm:resources/v20160201:Resource"), pulumi.Alias(type_="azurerm:resources/v20160701:Resource"), pulumi.Alias(type_="azurerm:resources/v20160901:Resource"), pulumi.Alias(type_="azurerm:resources/v20180201:Resource"), pulumi.Alias(type_="azurerm:resources/v20180501:Resource"), pulumi.Alias(type_="azurerm:resources/v20190301:Resource"), pulumi.Alias(type_="azurerm:resources/v20190501:Resource"), pulumi.Alias(type_="azurerm:resources/v20190510:Resource"), pulumi.Alias(type_="azurerm:resources/v20190701:Resource"), pulumi.Alias(type_="azurerm:resources/v20190801:Resource"), pulumi.Alias(type_="azurerm:resources/v20191001:Resource"), pulumi.Alias(type_="azurerm:resources/v20200601:Resource")])
