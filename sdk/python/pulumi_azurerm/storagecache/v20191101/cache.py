...
class Cache(pulumi.CustomResource):
    def __init__(__self__,
        ...
        cache = azurerm.storagecache.v20191101.Cache("cache",
            cache_name="sc1",
            cache_size_gb=3072,
            location="westus",
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagecache/latest:Cache"), pulumi.Alias(type_="azurerm:storagecache/v20200301:Cache")])
