...
class AwaitableGetCachResult(GetCachResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCachResult(
...
def get_cach(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storagecache:getCach', __args__, opts=opts).value

    return AwaitableGetCachResult(
