...
class Cache(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagecache/latest:Cache"), pulumi.Alias(type_="azurerm:storagecache/v20191101:Cache")])
