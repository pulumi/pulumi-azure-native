...
class GetCachStorageTargetResult:
    """
...
class AwaitableGetCachStorageTargetResult(GetCachStorageTargetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCachStorageTargetResult(
            name=self.name,
            properties=self.properties,
            type=self.type)


def get_cach_storage_target(cache_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:storagecache:getCachStorageTarget', __args__, opts=opts).value

    return AwaitableGetCachStorageTargetResult(
