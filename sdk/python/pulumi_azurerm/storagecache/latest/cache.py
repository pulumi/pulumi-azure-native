...
class Cache(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagecache/preview:Cache"), pulumi.Alias(type_="azurerm:storagecache/v20190801preview:Cache"), pulumi.Alias(type_="azurerm:storagecache/v20191101:Cache"), pulumi.Alias(type_="azurerm:storagecache/v20200301:Cache")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Cache, __self__).__init__(
            'azurerm:storagecache/latest:Cache',
            resource_name,
            __props__,
            opts)
