...
class StorageTarget(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagecache/v20190801preview:StorageTarget"), pulumi.Alias(type_="azurerm:storagecache/v20191101:StorageTarget"), pulumi.Alias(type_="azurerm:storagecache/v20200301:StorageTarget")])
