...
class StorageTarget(pulumi.CustomResource):
    def __init__(__self__,
        ...
        storage_target = azurerm.storagecache.v20190801preview.StorageTarget("storageTarget",
            cache_name="sc1",
            junctions=[
                {
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:storagecache/latest:StorageTarget"), pulumi.Alias(type_="azurerm:storagecache/v20191101:StorageTarget"), pulumi.Alias(type_="azurerm:storagecache/v20200301:StorageTarget")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageTarget, __self__).__init__(
            'azurerm:storagecache/v20190801preview:StorageTarget',
            resource_name,
            __props__,
            opts)
