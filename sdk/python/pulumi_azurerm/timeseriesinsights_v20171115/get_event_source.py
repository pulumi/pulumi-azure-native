...
def get_event_source(environment_name=None, name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:timeseriesinsights/v20171115:getEventSource', __args__, opts=opts).value
