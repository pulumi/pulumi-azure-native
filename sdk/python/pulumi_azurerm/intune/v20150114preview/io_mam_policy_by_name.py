...
class IoMAMPolicyByName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:intune/preview:IoMAMPolicyByName"), pulumi.Alias(type_="azurerm:intune/v20150114privatepreview:IoMAMPolicyByName")])
