...
class AndroidMAMPolicyByName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:intune/preview:AndroidMAMPolicyByName"), pulumi.Alias(type_="azurerm:intune/v20150114privatepreview:AndroidMAMPolicyByName")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AndroidMAMPolicyByName, __self__).__init__(
            'azurerm:intune/v20150114preview:AndroidMAMPolicyByName',
            resource_name,
            __props__,
            opts)
