...
def get_android_mam_policy_by_name(host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:intune/v20150114privatepreview:getAndroidMAMPolicyByName', __args__, opts=opts, typ=GetAndroidMAMPolicyByNameResult).value
