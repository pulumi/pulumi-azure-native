...
class DeviceSecurityGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        device_security_group = azurerm.security.v20170801preview.DeviceSecurityGroup("deviceSecurityGroup",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/latest:DeviceSecurityGroup"), pulumi.Alias(type_="azurerm:security/v20190801:DeviceSecurityGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeviceSecurityGroup, __self__).__init__(
            'azurerm:security/v20170801preview:DeviceSecurityGroup',
            resource_name,
            __props__,
            opts)
