...
class DeviceSecurityGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/latest:DeviceSecurityGroup"), pulumi.Alias(type_="azurerm:security/preview:DeviceSecurityGroup"), pulumi.Alias(type_="azurerm:security/v20190801:DeviceSecurityGroup")])
