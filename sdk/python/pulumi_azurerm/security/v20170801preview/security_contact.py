...
class SecurityContact(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/preview:SecurityContact"), pulumi.Alias(type_="azurerm:security/v20200101preview:SecurityContact")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecurityContact, __self__).__init__(
            'azurerm:security/v20170801preview:SecurityContact',
            resource_name,
            __props__,
            opts)
