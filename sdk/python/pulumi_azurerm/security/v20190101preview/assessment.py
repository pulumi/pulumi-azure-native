...
class Assessment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        assessment = azurerm.security.v20190101preview.Assessment("assessment",
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/latest:Assessment"), pulumi.Alias(type_="azurerm:security/v20200101:Assessment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Assessment, __self__).__init__(
            'azurerm:security/v20190101preview:Assessment',
            resource_name,
            __props__,
            opts)
