...
class IotSecuritySolution(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/preview:IotSecuritySolution"), pulumi.Alias(type_="azurerm:security/v20170801preview:IotSecuritySolution"), pulumi.Alias(type_="azurerm:security/v20190801:IotSecuritySolution")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IotSecuritySolution, __self__).__init__(
            'azurerm:security/latest:IotSecuritySolution',
            resource_name,
            __props__,
            opts)
