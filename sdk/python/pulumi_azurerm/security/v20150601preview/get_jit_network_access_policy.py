...
def get_jit_network_access_policy(asc_location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:security/v20150601preview:getJitNetworkAccessPolicy', __args__, opts=opts, typ=GetJitNetworkAccessPolicyResult).value
