...
class AdaptiveApplicationControl(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/latest:AdaptiveApplicationControl"), pulumi.Alias(type_="azurerm:security/v20200101:AdaptiveApplicationControl")])
