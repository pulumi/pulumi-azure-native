...
class IotDefenderSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/v20200806preview:IotDefenderSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IotDefenderSetting, __self__).__init__(
            'azurerm:security/preview:IotDefenderSetting',
            resource_name,
            __props__,
            opts)
