...
class AssessmentMetadataInSubscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/latest:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azurerm:security/preview:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azurerm:security/v20190101preview:AssessmentMetadataInSubscription")])
