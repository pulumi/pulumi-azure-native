...
def get_adaptive_application_control(asc_location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:security/v20200101:getAdaptiveApplicationControl', __args__, opts=opts, typ=GetAdaptiveApplicationControlResult).value
