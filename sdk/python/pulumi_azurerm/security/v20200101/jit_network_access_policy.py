...
class JitNetworkAccessPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:security/latest:JitNetworkAccessPolicy"), pulumi.Alias(type_="azurerm:security/v20150601preview:JitNetworkAccessPolicy")])
