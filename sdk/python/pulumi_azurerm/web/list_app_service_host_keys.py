...
class ListAppServiceHostKeysResult:
    """
...
class AwaitableListAppServiceHostKeysResult(ListAppServiceHostKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListAppServiceHostKeysResult(
            function_keys=self.function_keys,
            master_key=self.master_key,
            system_keys=self.system_keys)


def list_app_service_host_keys(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:listAppServiceHostKeys', __args__, opts=opts).value

    return AwaitableListAppServiceHostKeysResult(
