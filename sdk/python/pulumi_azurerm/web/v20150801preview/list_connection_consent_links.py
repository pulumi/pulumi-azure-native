...
class ListConnectionConsentLinksResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[List['outputs.ConsentLinkResponseResult']]:
        """
...
def list_connection_consent_links(connection_name: Optional[str] = None,
                                  ...
                                  parameters: Optional[List[pulumi.InputType['ConsentLinkInputParameterArgs']]] = None,
    ...
    :param List[pulumi.InputType['ConsentLinkInputParameterArgs']] parameters: Array of links
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801preview:listConnectionConsentLinks', __args__, opts=opts, typ=ListConnectionConsentLinksResult).value
