...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/preview:Certificate"), pulumi.Alias(type_="azurerm:web/v20150801:Certificate"), pulumi.Alias(type_="azurerm:web/v20160301:Certificate"), pulumi.Alias(type_="azurerm:web/v20180201:Certificate"), pulumi.Alias(type_="azurerm:web/v20181101:Certificate"), pulumi.Alias(type_="azurerm:web/v20190801:Certificate"), pulumi.Alias(type_="azurerm:web/v20200601:Certificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'azurerm:web/latest:Certificate',
            resource_name,
            __props__,
            opts)
