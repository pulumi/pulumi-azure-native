...
class StaticSite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/preview:StaticSite"), pulumi.Alias(type_="azurerm:web/v20190801:StaticSite"), pulumi.Alias(type_="azurerm:web/v20200601:StaticSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StaticSite, __self__).__init__(
            'azurerm:web/latest:StaticSite',
            resource_name,
            __props__,
            opts)
