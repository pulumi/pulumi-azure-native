...
class WebApp(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/preview:WebApp"), pulumi.Alias(type_="azurerm:web/v20150801:WebApp"), pulumi.Alias(type_="azurerm:web/v20160801:WebApp"), pulumi.Alias(type_="azurerm:web/v20180201:WebApp"), pulumi.Alias(type_="azurerm:web/v20181101:WebApp"), pulumi.Alias(type_="azurerm:web/v20190801:WebApp"), pulumi.Alias(type_="azurerm:web/v20200601:WebApp")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebApp, __self__).__init__(
            'azurerm:web/latest:WebApp',
            resource_name,
            __props__,
            opts)
