...
class WebAppSwiftVirtualNetworkConnectionSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/preview:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppSwiftVirtualNetworkConnectionSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSwiftVirtualNetworkConnectionSlot, __self__).__init__(
            'azurerm:web/latest:WebAppSwiftVirtualNetworkConnectionSlot',
            resource_name,
            __props__,
            opts)
