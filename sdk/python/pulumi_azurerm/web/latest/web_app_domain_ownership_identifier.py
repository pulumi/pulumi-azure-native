...
class WebAppDomainOwnershipIdentifier(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/preview:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppDomainOwnershipIdentifier")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppDomainOwnershipIdentifier, __self__).__init__(
            'azurerm:web/latest:WebAppDomainOwnershipIdentifier',
            resource_name,
            __props__,
            opts)
