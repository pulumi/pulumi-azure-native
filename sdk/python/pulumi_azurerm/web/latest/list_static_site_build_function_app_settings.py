...
def list_static_site_build_function_app_settings(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/latest:listStaticSiteBuildFunctionAppSettings', __args__, opts=opts, typ=ListStaticSiteBuildFunctionAppSettingsResult).value
