...
class GetAppServiceSlotVirtualNetworkConnectionResult:
    """
...
class AwaitableGetAppServiceSlotVirtualNetworkConnectionResult(GetAppServiceSlotVirtualNetworkConnectionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppServiceSlotVirtualNetworkConnectionResult(
            kind=self.kind,
            name=self.name,
...
def get_app_service_slot_virtual_network_connection(name=None, resource_group_name=None, slot=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:getAppServiceSlotVirtualNetworkConnection', __args__, opts=opts).value

    return AwaitableGetAppServiceSlotVirtualNetworkConnectionResult(
