...
class ListAppServiceSlotBackupResult:
    """
    Backup description.
    """
...
class AwaitableListAppServiceSlotBackupResult(ListAppServiceSlotBackupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListAppServiceSlotBackupResult(
            kind=self.kind,
            name=self.name,
...
def list_app_service_slot_backup(kind=None, name=None, properties=None, resource_group_name=None, slot=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:listAppServiceSlotBackup', __args__, opts=opts).value

    return AwaitableListAppServiceSlotBackupResult(
