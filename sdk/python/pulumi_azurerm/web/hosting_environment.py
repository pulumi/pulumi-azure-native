...
class HostingEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, kind=None, location=None, name=None, properties=None, resource_group_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(HostingEnvironment, __self__).__init__(
            'azurerm:web:HostingEnvironment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, kind=None, location=None, name=None, properties=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `database_edition` (`pulumi.Input[str]`) - Edition of the metadata database for the App Service Environment, e.g. "Standard".
          * `database_service_objective` (`pulumi.Input[str]`) - Service objective of the metadata database for the App Service Environment, e.g. "S0".
          * `default_front_end_scale_factor` (`pulumi.Input[float]`) - Default Scale Factor for FrontEnds.
          * `dns_suffix` (`pulumi.Input[str]`) - DNS suffix of the App Service Environment.
          * `dynamic_cache_enabled` (`pulumi.Input[bool]`) - True/false indicating whether the App Service Environment is suspended. The environment can be suspended e.g. when the management endpoint is no longer available
            (most likely because NSG blocked the incoming traffic).
          * `environment_capacities` (`pulumi.Input[list]`) - Current total, used, and available worker capacities.
            ...
            * `exclude_from_capacity_allocation` (`pulumi.Input[bool]`) - If <code>true</code>, it includes basic apps.
              Basic apps are not used for capacity allocation.
            * `is_applicable_for_all_compute_modes` (`pulumi.Input[bool]`) - <code>true</code> if capacity is applicable for all apps; otherwise, <code>false</code>.
            * `is_linux` (`pulumi.Input[bool]`) - Is this a linux stamp capacity
          ...
          * `environment_is_healthy` (`pulumi.Input[bool]`) - True/false indicating whether the App Service Environment is healthy.
          * `environment_status` (`pulumi.Input[str]`) - Detailed message about with results of the last check of the App Service Environment.
          * `front_end_scale_factor` (`pulumi.Input[float]`) - Scale factor for front-ends.
          * `has_linux_workers` (`pulumi.Input[bool]`) - Flag that displays whether an ASE has linux workers or not
          * `internal_load_balancing_mode` (`pulumi.Input[str]`) - Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment.
          * `ipssl_address_count` (`pulumi.Input[float]`) - Number of IP SSL addresses reserved for the App Service Environment.
          * `last_action` (`pulumi.Input[str]`) - Last deployment action on the App Service Environment.
          * `last_action_result` (`pulumi.Input[str]`) - Result of the last deployment action on the App Service Environment.
          * `location` (`pulumi.Input[str]`) - Location of the App Service Environment, e.g. "West US".
          * `maximum_number_of_machines` (`pulumi.Input[float]`) - Maximum number of VMs in the App Service Environment.
          * `multi_role_count` (`pulumi.Input[float]`) - Number of front-end instances.
          * `multi_size` (`pulumi.Input[str]`) - Front-end VM size, e.g. "Medium", "Large".
          * `name` (`pulumi.Input[str]`) - Name of the App Service Environment.
          * `network_access_control_list` (`pulumi.Input[list]`) - Access control list for controlling traffic to the App Service Environment.
          ...
          * `resource_group` (`pulumi.Input[str]`) - Resource group of the App Service Environment.
          * `ssl_cert_key_vault_id` (`pulumi.Input[str]`) - Key Vault ID for ILB App Service Environment default SSL certificate
          * `ssl_cert_key_vault_secret_name` (`pulumi.Input[str]`) - Key Vault Secret Name for ILB App Service Environment default SSL certificate
          * `status` (`pulumi.Input[str]`) - Current status of the App Service Environment.
          * `subscription_id` (`pulumi.Input[str]`) - Subscription of the App Service Environment.
          * `suspended` (`pulumi.Input[bool]`) - <code>true</code> if the App Service Environment is suspended; otherwise, <code>false</code>. The environment can be suspended, e.g. when the management endpoint is no longer available
             (most likely because NSG blocked the incoming traffic).
          * `upgrade_domains` (`pulumi.Input[float]`) - Number of upgrade domains of the App Service Environment.
          * `user_whitelisted_ip_ranges` (`pulumi.Input[list]`) - User added ip ranges to whitelist on ASE db
          * `vip_mappings` (`pulumi.Input[list]`) - Description of IP SSL mapping for the App Service Environment.
            * `in_use` (`pulumi.Input[bool]`) - Is virtual IP mapping in use.
            * `internal_http_port` (`pulumi.Input[float]`) - Internal HTTP port.
            * `internal_https_port` (`pulumi.Input[float]`) - Internal HTTPS port.
            * `service_name` (`pulumi.Input[str]`) - name of the service that virtual IP is assigned to
