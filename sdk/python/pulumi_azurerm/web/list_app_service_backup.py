...
class ListAppServiceBackupResult:
    """
    Backup description.
    """
...
class AwaitableListAppServiceBackupResult(ListAppServiceBackupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListAppServiceBackupResult(
            kind=self.kind,
            name=self.name,
...
def list_app_service_backup(kind=None, name=None, properties=None, resource_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:listAppServiceBackup', __args__, opts=opts).value

    return AwaitableListAppServiceBackupResult(
