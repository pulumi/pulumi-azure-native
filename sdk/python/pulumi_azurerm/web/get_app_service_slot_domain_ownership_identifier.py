...
class AwaitableGetAppServiceSlotDomainOwnershipIdentifierResult(GetAppServiceSlotDomainOwnershipIdentifierResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppServiceSlotDomainOwnershipIdentifierResult(
            kind=self.kind,
            name=self.name,
