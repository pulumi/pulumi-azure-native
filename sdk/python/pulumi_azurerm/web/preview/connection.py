...
class Connection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:Connection"), pulumi.Alias(type_="azurerm:web/v20150801preview:Connection"), pulumi.Alias(type_="azurerm:web/v20160601:Connection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Connection, __self__).__init__(
            'azurerm:web/preview:Connection',
            resource_name,
            __props__,
            opts)
