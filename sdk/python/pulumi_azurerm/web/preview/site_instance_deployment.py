...
class SiteInstanceDeployment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:SiteInstanceDeployment"), pulumi.Alias(type_="azurerm:web/v20150801:SiteInstanceDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteInstanceDeployment, __self__).__init__(
            'azurerm:web/preview:SiteInstanceDeployment',
            resource_name,
            __props__,
            opts)
