...
class WebAppSwiftVirtualNetworkConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppSwiftVirtualNetworkConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSwiftVirtualNetworkConnection, __self__).__init__(
            'azurerm:web/preview:WebAppSwiftVirtualNetworkConnection',
            resource_name,
            __props__,
            opts)
