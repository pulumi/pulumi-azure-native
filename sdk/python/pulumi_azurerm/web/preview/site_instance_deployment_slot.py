...
class SiteInstanceDeploymentSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azurerm:web/v20150801:SiteInstanceDeploymentSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteInstanceDeploymentSlot, __self__).__init__(
            'azurerm:web/preview:SiteInstanceDeploymentSlot',
            resource_name,
            __props__,
            opts)
