...
class WebAppSourceControlSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppSourceControlSlot"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppSourceControlSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppSourceControlSlot"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppSourceControlSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppSourceControlSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSourceControlSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppSourceControlSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSourceControlSlot, __self__).__init__(
            'azurerm:web/preview:WebAppSourceControlSlot',
            resource_name,
            __props__,
            opts)
