...
def get_web_app_swift_virtual_network_connection(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/preview:getWebAppSwiftVirtualNetworkConnection', __args__, opts=opts, typ=GetWebAppSwiftVirtualNetworkConnectionResult).value
