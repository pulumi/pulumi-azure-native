...
class CertificateCsr(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:CertificateCsr"), pulumi.Alias(type_="azurerm:web/v20150801:CertificateCsr")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CertificateCsr, __self__).__init__(
            'azurerm:web/preview:CertificateCsr',
            resource_name,
            __props__,
            opts)
