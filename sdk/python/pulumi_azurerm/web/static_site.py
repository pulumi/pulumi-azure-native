...
class StaticSite(pulumi.CustomResource):
    ...
    def get(resource_name, id, opts=None, kind=None, location=None, name=None, properties=None, sku=None, tags=None, type=None):
        ...
        The **properties** object supports the following:
          ...
          * `custom_domains` (`pulumi.Input[list]`) - The custom domains associated with this static site.
          * `default_hostname` (`pulumi.Input[str]`) - The default autogenerated hostname for the static site.
          * `repository_token` (`pulumi.Input[str]`) - A user's github repository token. This is used to setup the Github Actions workflow file and API secrets.
          * `repository_url` (`pulumi.Input[str]`) - URL for the repository of the static site.
