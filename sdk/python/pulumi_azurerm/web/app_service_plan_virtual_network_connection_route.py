...
class AppServicePlanVirtualNetworkConnectionRoute(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, kind=None, name=None, properties=None, resource_group_name=None, route_name=None, vnet_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AppServicePlanVirtualNetworkConnectionRoute, __self__).__init__(
            'azurerm:web:AppServicePlanVirtualNetworkConnectionRoute',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, kind=None, name=None, properties=None, type=None):
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return AppServicePlanVirtualNetworkConnectionRoute(resource_name, opts=opts, __props__=__props__)
