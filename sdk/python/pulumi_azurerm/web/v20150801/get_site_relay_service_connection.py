...
def get_site_relay_service_connection(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:getSiteRelayServiceConnection', __args__, opts=opts, typ=GetSiteRelayServiceConnectionResult).value
