...
class ServerFarm(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:ServerFarm"), pulumi.Alias(type_="azurerm:web/preview:ServerFarm"), pulumi.Alias(type_="azurerm:web/v20160901:ServerFarm"), pulumi.Alias(type_="azurerm:web/v20180201:ServerFarm"), pulumi.Alias(type_="azurerm:web/v20190801:ServerFarm"), pulumi.Alias(type_="azurerm:web/v20200601:ServerFarm")])
