...
def list_site_publishing_credentials_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:listSitePublishingCredentialsSlot', __args__, opts=opts, typ=ListSitePublishingCredentialsSlotResult).value
