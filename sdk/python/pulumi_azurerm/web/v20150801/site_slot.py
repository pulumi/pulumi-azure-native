...
class SiteSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:SiteSlot"), pulumi.Alias(type_="azurerm:web/preview:SiteSlot"), pulumi.Alias(type_="azurerm:web/v20160801:SiteSlot"), pulumi.Alias(type_="azurerm:web/v20180201:SiteSlot"), pulumi.Alias(type_="azurerm:web/v20181101:SiteSlot"), pulumi.Alias(type_="azurerm:web/v20190801:SiteSlot"), pulumi.Alias(type_="azurerm:web/v20200601:SiteSlot")])
