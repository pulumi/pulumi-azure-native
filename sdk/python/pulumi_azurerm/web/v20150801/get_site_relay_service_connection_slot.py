...
def get_site_relay_service_connection_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:getSiteRelayServiceConnectionSlot', __args__, opts=opts, typ=GetSiteRelayServiceConnectionSlotResult).value
