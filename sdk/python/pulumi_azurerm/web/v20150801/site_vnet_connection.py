...
class SiteVNETConnection(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, cert_blob=None, cert_thumbprint=None, dns_servers=None, id=None, kind=None, location=None, name=None, resource_group_name=None, resync_required=None, routes=None, tags=None, type=None, vnet_resource_id=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20160801:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/v20180201:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/v20181101:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/v20190801:SiteVNETConnection")])
