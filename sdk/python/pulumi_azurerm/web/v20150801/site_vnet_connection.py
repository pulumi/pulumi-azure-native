...
class SiteVNETConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/preview:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/v20160801:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/v20180201:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/v20181101:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/v20190801:SiteVNETConnection"), pulumi.Alias(type_="azurerm:web/v20200601:SiteVNETConnection")])
