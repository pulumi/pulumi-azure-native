...
def list_site_backup_configuration_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:listSiteBackupConfigurationSlot', __args__, opts=opts, typ=ListSiteBackupConfigurationSlotResult).value
