...
def list_site_backup_status_secrets_slot(backup_schedule=None, databases=None, enabled=None, id=None, kind=None, location=None, name=None, resource_group_name=None, slot=None, storage_account_url=None, tags=None, type=None, opts=None):
    """
