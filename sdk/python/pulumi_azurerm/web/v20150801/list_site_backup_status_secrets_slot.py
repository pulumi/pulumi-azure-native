...
def list_site_backup_status_secrets_slot(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:listSiteBackupStatusSecretsSlot', __args__, opts=opts, typ=ListSiteBackupStatusSecretsSlotResult).value
