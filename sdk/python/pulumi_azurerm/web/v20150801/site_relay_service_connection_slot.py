...
class SiteRelayServiceConnectionSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20160801:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20180201:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20181101:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20190801:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20200601:SiteRelayServiceConnectionSlot")])
