...
class ManagedHostingEnvironment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:ManagedHostingEnvironment"), pulumi.Alias(type_="azurerm:web/preview:ManagedHostingEnvironment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedHostingEnvironment, __self__).__init__(
            'azurerm:web/v20150801:ManagedHostingEnvironment',
            resource_name,
            __props__,
            opts)
