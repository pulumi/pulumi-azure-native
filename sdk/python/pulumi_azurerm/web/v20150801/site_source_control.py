...
class SiteSourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, branch=None, deployment_rollback_enabled=None, id=None, is_manual_integration=None, is_mercurial=None, kind=None, location=None, name=None, repo_url=None, resource_group_name=None, tags=None, type=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20160801:SiteSourceControl"), pulumi.Alias(type_="azurerm:web/v20180201:SiteSourceControl"), pulumi.Alias(type_="azurerm:web/v20181101:SiteSourceControl"), pulumi.Alias(type_="azurerm:web/v20190801:SiteSourceControl")])
