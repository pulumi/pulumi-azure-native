...
class HostingEnvironment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:HostingEnvironment"), pulumi.Alias(type_="azurerm:web/preview:HostingEnvironment"), pulumi.Alias(type_="azurerm:web/v20160901:HostingEnvironment"), pulumi.Alias(type_="azurerm:web/v20180201:HostingEnvironment"), pulumi.Alias(type_="azurerm:web/v20190801:HostingEnvironment"), pulumi.Alias(type_="azurerm:web/v20200601:HostingEnvironment")])
