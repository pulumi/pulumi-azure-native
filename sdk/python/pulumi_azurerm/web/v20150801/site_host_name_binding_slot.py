...
class SiteHostNameBindingSlot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, azure_resource_name=None, azure_resource_type=None, custom_host_name_dns_record_type=None, domain_id=None, host_name_type=None, id=None, kind=None, location=None, name=None, resource_group_name=None, site_name=None, slot=None, tags=None, type=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20160801:SiteHostNameBindingSlot"), pulumi.Alias(type_="azurerm:web/v20180201:SiteHostNameBindingSlot"), pulumi.Alias(type_="azurerm:web/v20181101:SiteHostNameBindingSlot"), pulumi.Alias(type_="azurerm:web/v20190801:SiteHostNameBindingSlot")])
