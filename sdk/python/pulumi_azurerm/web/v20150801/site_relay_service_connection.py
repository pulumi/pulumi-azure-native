...
class SiteRelayServiceConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:SiteRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/preview:SiteRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20160801:SiteRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20180201:SiteRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20181101:SiteRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20190801:SiteRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20200601:SiteRelayServiceConnection")])
