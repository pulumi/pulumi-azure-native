...
def get_site_deployment(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:getSiteDeployment', __args__, opts=opts).value
