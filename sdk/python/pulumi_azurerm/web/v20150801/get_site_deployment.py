...
def get_site_deployment(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:getSiteDeployment', __args__, opts=opts, typ=GetSiteDeploymentResult).value
