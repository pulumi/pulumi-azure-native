...
class SiteInstanceDeploymentSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:SiteInstanceDeploymentSlot"), pulumi.Alias(type_="azurerm:web/preview:SiteInstanceDeploymentSlot")])
