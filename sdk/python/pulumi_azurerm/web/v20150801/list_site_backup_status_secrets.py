...
def list_site_backup_status_secrets(backup_schedule: Optional[pulumi.InputType['BackupScheduleArgs']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20150801:listSiteBackupStatusSecrets', __args__, opts=opts, typ=ListSiteBackupStatusSecretsResult).value
