...
class GetAppServiceSlotHybridConnectionNamespaceRelayResult:
    """
...
class AwaitableGetAppServiceSlotHybridConnectionNamespaceRelayResult(GetAppServiceSlotHybridConnectionNamespaceRelayResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppServiceSlotHybridConnectionNamespaceRelayResult(
            kind=self.kind,
            name=self.name,
...
def get_app_service_slot_hybrid_connection_namespace_relay(name=None, namespace_name=None, relay_name=None, resource_group_name=None, slot=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:getAppServiceSlotHybridConnectionNamespaceRelay', __args__, opts=opts).value

    return AwaitableGetAppServiceSlotHybridConnectionNamespaceRelayResult(
