...
class GetAppServiceSlotDeploymentResult:
    """
...
class AwaitableGetAppServiceSlotDeploymentResult(GetAppServiceSlotDeploymentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppServiceSlotDeploymentResult(
            kind=self.kind,
            name=self.name,
...
def get_app_service_slot_deployment(name=None, resource_group_name=None, slot=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:getAppServiceSlotDeployment', __args__, opts=opts).value

    return AwaitableGetAppServiceSlotDeploymentResult(
