...
def get_web_app_relay_service_connection_slot(name=None, resource_group_name=None, slot=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:getWebAppRelayServiceConnectionSlot', __args__, opts=opts).value
