...
def get_connection_gateway(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20160601:getConnectionGateway', __args__, opts=opts, typ=GetConnectionGatewayResult).value
