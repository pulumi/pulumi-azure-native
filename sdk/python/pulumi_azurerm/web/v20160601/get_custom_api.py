...
def get_custom_api(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20160601:getCustomApi', __args__, opts=opts).value
