...
class ConnectionGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        connection_gateway = azurerm.web.v20160601.ConnectionGateway("connectionGateway",
        ...
        if opts.id is None:
            ...
            if connection_gateway_name is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:ConnectionGateway")])
