...
def get_web_app_premier_add_on(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:getWebAppPremierAddOn', __args__, opts=opts).value
