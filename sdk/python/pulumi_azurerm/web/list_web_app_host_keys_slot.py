...
def list_web_app_host_keys_slot(name=None, resource_group_name=None, slot=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:listWebAppHostKeysSlot', __args__, opts=opts).value
