...
class WebAppSwiftVirtualNetworkConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, kind=None, name=None, resource_group_name=None, subnet_resource_id=None, swift_supported=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20181101:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSwiftVirtualNetworkConnection"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppSwiftVirtualNetworkConnection")])
