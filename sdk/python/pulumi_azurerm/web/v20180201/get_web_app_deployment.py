...
def get_web_app_deployment(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20180201:getWebAppDeployment', __args__, opts=opts, typ=GetWebAppDeploymentResult).value
