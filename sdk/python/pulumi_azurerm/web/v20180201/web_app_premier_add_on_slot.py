...
class WebAppPremierAddOnSlot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, kind=None, location=None, marketplace_offer=None, marketplace_publisher=None, name=None, product=None, resource_group_name=None, sku=None, slot=None, tags=None, vendor=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:WebAppPremierAddOnSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppPremierAddOnSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppPremierAddOnSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppPremierAddOnSlot")])
