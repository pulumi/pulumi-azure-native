...
class WebAppHybridConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20160801:WebAppHybridConnection"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppHybridConnection"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppHybridConnection"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppHybridConnection")])
