...
class WebAppSwiftVirtualNetworkConnectionSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azurerm:web/preview:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppSwiftVirtualNetworkConnectionSlot")])
