...
class WebAppSiteExtensionSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azurerm:web/preview:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppSiteExtensionSlot")])
