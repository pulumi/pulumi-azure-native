...
class WebAppPremierAddOn(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppPremierAddOn"), pulumi.Alias(type_="azurerm:web/preview:WebAppPremierAddOn"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppPremierAddOn"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppPremierAddOn"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppPremierAddOn"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppPremierAddOn"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppPremierAddOn")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppPremierAddOn, __self__).__init__(
            'azurerm:web/v20180201:WebAppPremierAddOn',
            resource_name,
            __props__,
            opts)
