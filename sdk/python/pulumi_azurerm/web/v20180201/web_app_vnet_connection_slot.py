...
class WebAppVnetConnectionSlot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, cert_blob=None, dns_servers=None, is_swift=None, kind=None, name=None, resource_group_name=None, slot=None, vnet_resource_id=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppVnetConnectionSlot")])
