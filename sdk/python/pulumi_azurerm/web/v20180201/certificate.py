...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:Certificate"), pulumi.Alias(type_="azurerm:web/preview:Certificate"), pulumi.Alias(type_="azurerm:web/v20150801:Certificate"), pulumi.Alias(type_="azurerm:web/v20160301:Certificate"), pulumi.Alias(type_="azurerm:web/v20181101:Certificate"), pulumi.Alias(type_="azurerm:web/v20190801:Certificate"), pulumi.Alias(type_="azurerm:web/v20200601:Certificate")])
