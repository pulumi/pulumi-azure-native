...
class WebAppDomainOwnershipIdentifierSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppDomainOwnershipIdentifierSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppDomainOwnershipIdentifierSlot")])
