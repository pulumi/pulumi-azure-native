...
class WebAppHostNameBindingSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppHostNameBindingSlot")])
