...
class AppServicePlanRouteForVnet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:AppServicePlanRouteForVnet"), pulumi.Alias(type_="azurerm:web/preview:AppServicePlanRouteForVnet"), pulumi.Alias(type_="azurerm:web/v20150801:AppServicePlanRouteForVnet"), pulumi.Alias(type_="azurerm:web/v20160901:AppServicePlanRouteForVnet"), pulumi.Alias(type_="azurerm:web/v20190801:AppServicePlanRouteForVnet"), pulumi.Alias(type_="azurerm:web/v20200601:AppServicePlanRouteForVnet")])
