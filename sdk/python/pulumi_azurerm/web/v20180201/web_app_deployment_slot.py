...
class WebAppDeploymentSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppDeploymentSlot"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppDeploymentSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppDeploymentSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppDeploymentSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppDeploymentSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppDeploymentSlot")])
