...
def list_web_app_publishing_credentials(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20180201:listWebAppPublishingCredentials', __args__, opts=opts, typ=ListWebAppPublishingCredentialsResult).value
