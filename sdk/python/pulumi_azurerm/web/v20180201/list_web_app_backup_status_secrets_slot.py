...
def list_web_app_backup_status_secrets_slot(backup_name=None, backup_schedule=None, databases=None, enabled=None, kind=None, name=None, resource_group_name=None, slot=None, storage_account_url=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20180201:listWebAppBackupStatusSecretsSlot', __args__, opts=opts).value
