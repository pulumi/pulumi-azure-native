...
class AwaitableGetAppServiceSlotResult(GetAppServiceSlotResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppServiceSlotResult(
...
def get_app_service_slot(name=None, resource_group_name=None, slot=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:getAppServiceSlot', __args__, opts=opts).value

    return AwaitableGetAppServiceSlotResult(
