...
class AppServiceHostNameBinding(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, host_name=None, kind=None, name=None, properties=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AppServiceHostNameBinding, __self__).__init__(
            'azurerm:web:AppServiceHostNameBinding',
            resource_name,
            __props__,
            opts)
