...
class AppServiceSlotHybridConnectionNamespaceRelay(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, kind=None, name=None, namespace_name=None, properties=None, relay_name=None, resource_group_name=None, slot=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        super(AppServiceSlotHybridConnectionNamespaceRelay, __self__).__init__(
            'azurerm:web:AppServiceSlotHybridConnectionNamespaceRelay',
            resource_name,
            __props__,
            opts)
