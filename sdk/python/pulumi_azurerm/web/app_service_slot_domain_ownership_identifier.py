...
class AppServiceSlotDomainOwnershipIdentifier(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, domain_ownership_identifier_name=None, kind=None, name=None, properties=None, resource_group_name=None, slot=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        super(AppServiceSlotDomainOwnershipIdentifier, __self__).__init__(
            'azurerm:web:AppServiceSlotDomainOwnershipIdentifier',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return AppServiceSlotDomainOwnershipIdentifier(resource_name, opts=opts, __props__=__props__)
