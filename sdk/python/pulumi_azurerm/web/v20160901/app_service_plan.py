...
class AppServicePlan(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:AppServicePlan"), pulumi.Alias(type_="azurerm:web/preview:AppServicePlan"), pulumi.Alias(type_="azurerm:web/v20150801:AppServicePlan"), pulumi.Alias(type_="azurerm:web/v20180201:AppServicePlan"), pulumi.Alias(type_="azurerm:web/v20190801:AppServicePlan"), pulumi.Alias(type_="azurerm:web/v20200601:AppServicePlan")])
