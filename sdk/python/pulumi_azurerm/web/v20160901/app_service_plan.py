...
class AppServicePlan(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, admin_site_name=None, hosting_environment_profile=None, is_spot=None, kind=None, location=None, name=None, per_site_scaling=None, reserved=None, resource_group_name=None, sku=None, spot_expiration_time=None, tags=None, target_worker_count=None, target_worker_size_id=None, worker_tier_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:AppServicePlan"), pulumi.Alias(type_="azurerm:web/v20180201:AppServicePlan"), pulumi.Alias(type_="azurerm:web/v20190801:AppServicePlan")])
