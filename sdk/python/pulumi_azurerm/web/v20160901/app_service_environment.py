...
class AppServiceEnvironment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:AppServiceEnvironment"), pulumi.Alias(type_="azurerm:web/v20180201:AppServiceEnvironment"), pulumi.Alias(type_="azurerm:web/v20190801:AppServiceEnvironment"), pulumi.Alias(type_="azurerm:web/v20200601:AppServiceEnvironment")])
