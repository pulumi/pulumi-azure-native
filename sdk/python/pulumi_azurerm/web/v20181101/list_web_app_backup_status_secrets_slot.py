...
def list_web_app_backup_status_secrets_slot(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20181101:listWebAppBackupStatusSecretsSlot', __args__, opts=opts, typ=ListWebAppBackupStatusSecretsSlotResult).value
