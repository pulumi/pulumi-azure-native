...
class WebAppDomainOwnershipIdentifier(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/preview:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppDomainOwnershipIdentifier")])
