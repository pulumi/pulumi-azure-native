...
class WebAppSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppSlot"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppSlot"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppSlot")])
