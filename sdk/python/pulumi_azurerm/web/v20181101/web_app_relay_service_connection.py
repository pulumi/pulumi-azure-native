...
class WebAppRelayServiceConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/preview:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppRelayServiceConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppRelayServiceConnection, __self__).__init__(
            'azurerm:web/v20181101:WebAppRelayServiceConnection',
            resource_name,
            __props__,
            opts)
