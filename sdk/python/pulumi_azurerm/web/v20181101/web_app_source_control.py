...
class WebAppSourceControl(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/preview:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppSourceControl")])
