...
class WebAppDeployment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, active=None, author=None, author_email=None, deployer=None, details=None, end_time=None, kind=None, message=None, name=None, resource_group_name=None, start_time=None, status=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:WebAppDeployment"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppDeployment"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppDeployment"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppDeployment")])
