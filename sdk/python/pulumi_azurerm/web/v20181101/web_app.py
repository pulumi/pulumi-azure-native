...
class WebApp(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 geo_distributions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GeoDistributionArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['GeoDistributionArgs']]]] geo_distributions: GeoDistributions for this site
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebApp"), pulumi.Alias(type_="azurerm:web/preview:WebApp"), pulumi.Alias(type_="azurerm:web/v20150801:WebApp"), pulumi.Alias(type_="azurerm:web/v20160801:WebApp"), pulumi.Alias(type_="azurerm:web/v20180201:WebApp"), pulumi.Alias(type_="azurerm:web/v20190801:WebApp"), pulumi.Alias(type_="azurerm:web/v20200601:WebApp")])
    ...
    def geo_distributions(self) -> pulumi.Output[Optional[List['outputs.GeoDistributionResponse']]]:
        """
