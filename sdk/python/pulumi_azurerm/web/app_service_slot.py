...
class AppServiceSlot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, identity=None, kind=None, location=None, name=None, properties=None, resource_group_name=None, slot=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(AppServiceSlot, __self__).__init__(
            'azurerm:web:AppServiceSlot',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, identity=None, kind=None, location=None, name=None, properties=None, tags=None, type=None):
        """
        ...
        The **properties** object supports the following:
          ...
          * `availability_state` (`pulumi.Input[str]`) - Management information availability state for the app.
          * `client_affinity_enabled` (`pulumi.Input[bool]`) - <code>true</code> to enable client affinity; <code>false</code> to stop sending session affinity cookies, which route client requests in the same session to the same instance. Default is <code>true</code>.
          * `client_cert_enabled` (`pulumi.Input[bool]`) - <code>true</code> to enable client certificate authentication (TLS mutual authentication); otherwise, <code>false</code>. Default is <code>false</code>.
          * `client_cert_exclusion_paths` (`pulumi.Input[str]`) - client certificate authentication comma-separated exclusion paths
          * `cloning_info` (`pulumi.Input[dict]`) - If specified during app creation, the app is cloned from a source app.
          ...
          * `container_size` (`pulumi.Input[float]`) - Size of the function container.
          * `daily_memory_time_quota` (`pulumi.Input[float]`) - Maximum allowed daily memory-time quota (applicable on dynamic apps only).
          * `default_host_name` (`pulumi.Input[str]`) - Default hostname of the app. Read-only.
          * `enabled` (`pulumi.Input[bool]`) - <code>true</code> if the app is enabled; otherwise, <code>false</code>. Setting this value to false disables the app (takes the app offline).
          * `enabled_host_names` (`pulumi.Input[list]`) - Enabled hostnames for the app.Hostnames need to be assigned (see HostNames) AND enabled. Otherwise,
            the app is not served on those hostnames.
          * `host_name_ssl_states` (`pulumi.Input[list]`) - Hostname SSL states are used to manage the SSL bindings for app's hostnames.
            * `host_type` (`pulumi.Input[str]`) - Indicates whether the hostname is a standard or repository hostname.
            * `name` (`pulumi.Input[str]`) - Hostname.
          ...
          * `host_names` (`pulumi.Input[list]`) - Hostnames associated with the app.
          * `host_names_disabled` (`pulumi.Input[bool]`) - <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
             If <code>true</code>, the app is only accessible via API management process.
          * `hosting_environment_profile` (`pulumi.Input[dict]`) - App Service Environment to use for the app.
            * `id` (`pulumi.Input[str]`) - Resource ID of the App Service Environment.
          ...
          * `https_only` (`pulumi.Input[bool]`) - HttpsOnly: configures a web site to accept only https requests. Issues redirect for
            http requests
          * `hyper_v` (`pulumi.Input[bool]`) - Hyper-V sandbox.
          * `in_progress_operation_id` (`pulumi.Input[str]`) - Specifies an operation id if this site has a pending operation.
          * `is_default_container` (`pulumi.Input[bool]`) - <code>true</code> if the app is a default container; otherwise, <code>false</code>.
          * `is_xenon` (`pulumi.Input[bool]`) - Obsolete: Hyper-V sandbox.
          * `last_modified_time_utc` (`pulumi.Input[str]`) - Last time the app was modified, in UTC. Read-only.
          * `max_number_of_workers` (`pulumi.Input[float]`) - Maximum number of workers.
            This only applies to Functions container.
          * `outbound_ip_addresses` (`pulumi.Input[str]`) - List of IP addresses that the app uses for outbound connections (e.g. database access). Includes VIPs from tenants that site can be hosted with current settings. Read-only.
          * `possible_outbound_ip_addresses` (`pulumi.Input[str]`) - List of IP addresses that the app uses for outbound connections (e.g. database access). Includes VIPs from all tenants except dataComponent. Read-only.
          * `redundancy_mode` (`pulumi.Input[str]`) - Site redundancy mode
          * `repository_site_name` (`pulumi.Input[str]`) - Name of the repository site.
          * `reserved` (`pulumi.Input[bool]`) - <code>true</code> if reserved; otherwise, <code>false</code>.
          * `resource_group` (`pulumi.Input[str]`) - Name of the resource group the app belongs to. Read-only.
          * `scm_site_also_stopped` (`pulumi.Input[bool]`) - <code>true</code> to stop SCM (KUDU) site when the app is stopped; otherwise, <code>false</code>. The default is <code>false</code>.
          * `server_farm_id` (`pulumi.Input[str]`) - Resource ID of the associated App Service plan, formatted as: "/subscriptions/{subscriptionID}/resourceGroups/{groupName}/providers/Microsoft.Web/serverfarms/{appServicePlanName}".
          * `site_config` (`pulumi.Input[dict]`) - Configuration of the app.
            * `always_on` (`pulumi.Input[bool]`) - <code>true</code> if Always On is enabled; otherwise, <code>false</code>.
            ...
            * `local_my_sql_enabled` (`pulumi.Input[bool]`) - <code>true</code> to enable local MySQL; otherwise, <code>false</code>.
            * `logs_directory_size_limit` (`pulumi.Input[float]`) - HTTP logs directory size limit.
            * `machine_key` (`pulumi.Input[dict]`) - Site MachineKey.
              * `decryption` (`pulumi.Input[str]`) - Algorithm used for decryption.
              * `decryption_key` (`pulumi.Input[str]`) - Decryption key.
              * `validation` (`pulumi.Input[str]`) - MachineKey validation.
              * `validation_key` (`pulumi.Input[str]`) - Validation key.
          ...
          * `slot_swap_status` (`pulumi.Input[dict]`) - Status of the last deployment slot swap operation.
            * `destination_slot_name` (`pulumi.Input[str]`) - The destination slot of the last swap operation.
            * `source_slot_name` (`pulumi.Input[str]`) - The source slot of the last swap operation.
            * `timestamp_utc` (`pulumi.Input[str]`) - The time the last successful slot swap completed.

          * `state` (`pulumi.Input[str]`) - Current state of the app.
          * `suspended_till` (`pulumi.Input[str]`) - App suspended till in case memory-time quota is exceeded.
          * `target_swap_slot` (`pulumi.Input[str]`) - Specifies which deployment slot this app will swap into. Read-only.
          * `traffic_manager_host_names` (`pulumi.Input[list]`) - Azure Traffic Manager hostnames associated with the app. Read-only.
          * `usage_state` (`pulumi.Input[str]`) - State indicating whether the app has exceeded its quota usage. Read-only.
        """
        ...
        __props__["tags"] = tags
        __props__["type"] = type
        return AppServiceSlot(resource_name, opts=opts, __props__=__props__)
