...
def list_web_app_backup_status_secrets(backup_request_name=None, backup_schedule=None, databases=None, enabled=None, kind=None, name=None, resource_group_name=None, storage_account_url=None, type=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20160801:listWebAppBackupStatusSecrets', __args__, opts=opts).value
