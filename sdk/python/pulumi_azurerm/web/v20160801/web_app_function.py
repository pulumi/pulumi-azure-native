...
class WebAppFunction(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, config=None, config_href=None, files=None, href=None, kind=None, name=None, resource_group_name=None, script_href=None, script_root_path_href=None, secrets_file_href=None, test_data=None, __props__=None, __name__=None, __opts__=None):
        """
        Web Job Information.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20180201:WebAppFunction"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppFunction"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppFunction"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppFunction")])
