...
class WebAppSiteExtension(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20180201:WebAppSiteExtension"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppSiteExtension"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppSiteExtension")])
