...
class WebAppDomainOwnershipIdentifier(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, id=None, kind=None, name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20180201:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppDomainOwnershipIdentifier"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppDomainOwnershipIdentifier")])
