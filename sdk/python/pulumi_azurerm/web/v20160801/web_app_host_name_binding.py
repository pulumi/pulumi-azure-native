...
class WebAppHostNameBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, azure_resource_name=None, azure_resource_type=None, custom_host_name_dns_record_type=None, domain_id=None, host_name_type=None, kind=None, name=None, resource_group_name=None, site_name=None, ssl_state=None, thumbprint=None, __props__=None, __name__=None, __opts__=None):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:WebAppHostNameBinding"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppHostNameBinding"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppHostNameBinding"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppHostNameBinding"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppHostNameBinding")])
