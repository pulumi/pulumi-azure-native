...
class WebAppRelayServiceConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppRelayServiceConnection"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppRelayServiceConnection")])
