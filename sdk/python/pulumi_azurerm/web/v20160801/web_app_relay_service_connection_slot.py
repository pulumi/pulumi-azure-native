...
class WebAppRelayServiceConnectionSlot(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, biztalk_uri=None, entity_connection_string=None, hostname=None, kind=None, name=None, port=None, resource_connection_string=None, resource_group_name=None, resource_type=None, slot=None, __props__=None, __name__=None, __opts__=None):
        """
