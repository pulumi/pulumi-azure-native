...
def list_web_app_site_push_settings_slot(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20160801:listWebAppSitePushSettingsSlot', __args__, opts=opts).value
