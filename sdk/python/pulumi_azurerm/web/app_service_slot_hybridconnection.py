...
class AppServiceSlotHybridconnection(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, entity_name=None, kind=None, name=None, properties=None, resource_group_name=None, slot=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        super(AppServiceSlotHybridconnection, __self__).__init__(
            'azurerm:web:AppServiceSlotHybridconnection',
            resource_name,
            __props__,
            opts)
