...
class AwaitableGetAppServiceHostNameBindingResult(GetAppServiceHostNameBindingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppServiceHostNameBindingResult(
            kind=self.kind,
            name=self.name,
...
def get_app_service_host_name_binding(host_name=None, name=None, resource_group_name=None, opts=None):
    """
