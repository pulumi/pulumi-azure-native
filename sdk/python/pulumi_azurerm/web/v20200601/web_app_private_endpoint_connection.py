...
class WebAppPrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azurerm:web/preview:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppPrivateEndpointConnection, __self__).__init__(
            'azurerm:web/v20200601:WebAppPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
