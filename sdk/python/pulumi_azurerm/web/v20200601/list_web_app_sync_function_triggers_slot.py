...
def list_web_app_sync_function_triggers_slot(name=None, resource_group_name=None, slot=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:listWebAppSyncFunctionTriggersSlot', __args__, opts=opts).value
