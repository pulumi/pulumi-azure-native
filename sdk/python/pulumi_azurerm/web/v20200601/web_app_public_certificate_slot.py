...
class WebAppPublicCertificateSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppPublicCertificateSlot"), pulumi.Alias(type_="azurerm:web/preview:WebAppPublicCertificateSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppPublicCertificateSlot"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppPublicCertificateSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppPublicCertificateSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppPublicCertificateSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppPublicCertificateSlot, __self__).__init__(
            'azurerm:web/v20200601:WebAppPublicCertificateSlot',
            resource_name,
            __props__,
            opts)
