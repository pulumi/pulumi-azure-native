...
class ListSiteIdentifiersAssignedToHostNameResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> List['outputs.IdentifierResponseResult']:
        """
...
def list_site_identifiers_assigned_to_host_name(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:listSiteIdentifiersAssignedToHostName', __args__, opts=opts, typ=ListSiteIdentifiersAssignedToHostNameResult).value
