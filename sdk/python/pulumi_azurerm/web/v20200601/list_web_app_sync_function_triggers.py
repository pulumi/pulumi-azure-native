...
def list_web_app_sync_function_triggers(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:listWebAppSyncFunctionTriggers', __args__, opts=opts).value
