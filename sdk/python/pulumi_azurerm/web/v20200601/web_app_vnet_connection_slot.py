...
class WebAppVnetConnectionSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/preview:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppVnetConnectionSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppVnetConnectionSlot, __self__).__init__(
            'azurerm:web/v20200601:WebAppVnetConnectionSlot',
            resource_name,
            __props__,
            opts)
