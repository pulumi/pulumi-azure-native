...
def list_web_app_backup_configuration_slot(name=None, resource_group_name=None, opts=None):
    """
    Use this data source to access information about an existing resource.

    :param str name: Name of the deployment slot. If a slot is not specified, the API will get the backup configuration for the production slot.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:listWebAppBackupConfigurationSlot', __args__, opts=opts).value
