...
class WebAppFunction(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppFunction"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppFunction"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppFunction"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppFunction"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppFunction")])
