...
class WebAppDeployment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppDeployment"), pulumi.Alias(type_="azurerm:web/v20150801:WebAppDeployment"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppDeployment"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppDeployment"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppDeployment"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppDeployment")])
