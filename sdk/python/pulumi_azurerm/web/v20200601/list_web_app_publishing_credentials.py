...
def list_web_app_publishing_credentials(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:listWebAppPublishingCredentials', __args__, opts=opts).value
