...
def list_web_app_function_secrets_slot(function_name=None, name=None, resource_group_name=None, slot=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:listWebAppFunctionSecretsSlot', __args__, opts=opts).value
