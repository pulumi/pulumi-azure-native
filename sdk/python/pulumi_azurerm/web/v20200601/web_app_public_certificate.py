...
class WebAppPublicCertificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppPublicCertificate"), pulumi.Alias(type_="azurerm:web/preview:WebAppPublicCertificate"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppPublicCertificate"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppPublicCertificate"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppPublicCertificate"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppPublicCertificate")])
