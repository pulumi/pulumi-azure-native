...
def list_web_app_metadata(name=None, resource_group_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:listWebAppMetadata', __args__, opts=opts).value
