...
class ListWebAppAuthSettingsResult:
    ...
    def git_hub_o_auth_scopes(self) -> Optional[List[str]]:
        """
...
def list_web_app_auth_settings(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:listWebAppAuthSettings', __args__, opts=opts, typ=ListWebAppAuthSettingsResult).value
