...
class GetWebAppSourceControlResult:
    ...
    def __init__(__self__, branch=None, deployment_rollback_enabled=None, is_git_hub_action=None, is_manual_integration=None, is_mercurial=None, kind=None, name=None, repo_url=None, type=None):
        ...
        __self__.is_git_hub_action = is_git_hub_action
        """
...
def get_web_app_source_control(name=None, resource_group_name=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web/v20200601:getWebAppSourceControl', __args__, opts=opts).value
    ...
    return AwaitableGetWebAppSourceControlResult(
        ...
        is_git_hub_action=__ret__.get('isGitHubAction'),
