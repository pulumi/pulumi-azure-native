...
class WebAppHostNameBinding(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:WebAppHostNameBinding"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppHostNameBinding"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppHostNameBinding"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppHostNameBinding"), pulumi.Alias(type_="azurerm:web/v20190801:WebAppHostNameBinding")])
