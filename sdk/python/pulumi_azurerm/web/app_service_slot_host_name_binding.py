...
class AppServiceSlotHostNameBinding(pulumi.CustomResource):
    ...
    Resource type.
    """
    def __init__(__self__, resource_name, opts=None, host_name=None, kind=None, name=None, properties=None, resource_group_name=None, slot=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        super(AppServiceSlotHostNameBinding, __self__).__init__(
            'azurerm:web:AppServiceSlotHostNameBinding',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None, kind=None, name=None, properties=None, type=None):
        ...
        __props__["properties"] = properties
        __props__["type"] = type
        return AppServiceSlotHostNameBinding(resource_name, opts=opts, __props__=__props__)
