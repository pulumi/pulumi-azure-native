...
class AppServiceSlotVirtualNetworkConnection(pulumi.CustomResource):
    ...
    def get(resource_name, id, opts=None):
        ...
        return AppServiceSlotVirtualNetworkConnection(resource_name, opts=opts, __props__=__props__)
