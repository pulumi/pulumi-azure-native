...
class AppServiceSlotSiteextension(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, resource_group_name=None, site_extension_id=None, slot=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        super(AppServiceSlotSiteextension, __self__).__init__(
            'azurerm:web:AppServiceSlotSiteextension',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name, id, opts=None):
        ...
        return AppServiceSlotSiteextension(resource_name, opts=opts, __props__=__props__)
