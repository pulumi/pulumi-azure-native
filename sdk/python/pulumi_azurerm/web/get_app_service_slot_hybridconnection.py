...
class GetAppServiceSlotHybridconnectionResult:
    """
...
class AwaitableGetAppServiceSlotHybridconnectionResult(GetAppServiceSlotHybridconnectionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppServiceSlotHybridconnectionResult(
            kind=self.kind,
            name=self.name,
...
def get_app_service_slot_hybridconnection(entity_name=None, name=None, resource_group_name=None, slot=None, opts=None):
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:web:getAppServiceSlotHybridconnection', __args__, opts=opts).value

    return AwaitableGetAppServiceSlotHybridconnectionResult(
