...
class WebAppInstanceFunctionSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20160801:WebAppInstanceFunctionSlot"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppInstanceFunctionSlot"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppInstanceFunctionSlot"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppInstanceFunctionSlot")])
