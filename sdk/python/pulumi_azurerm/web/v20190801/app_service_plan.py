...
class AppServicePlan(pulumi.CustomResource):
    def __init__(__self__,
        ...
        app_service_plan = azurerm.web.v20190801.AppServicePlan("appServicePlan",
            kind="app",
            location="East US",
            name="testsf6141",
