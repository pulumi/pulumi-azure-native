...
class WebAppPrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        web_app_private_endpoint_connection = azurerm.web.v20190801.WebAppPrivateEndpointConnection("webAppPrivateEndpointConnection",
            name="testSite",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/latest:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azurerm:web/v20200601:WebAppPrivateEndpointConnection")])
