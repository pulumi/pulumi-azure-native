...
class WebAppSourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, branch=None, deployment_rollback_enabled=None, is_manual_integration=None, is_mercurial=None, kind=None, name=None, repo_url=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/v20160801:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/v20180201:WebAppSourceControl"), pulumi.Alias(type_="azurerm:web/v20181101:WebAppSourceControl")])
