...
class Certificate(pulumi.CustomResource):
    canonical_name: pulumi.Output[str]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, canonical_name=None, host_names=None, key_vault_id=None, key_vault_secret_name=None, kind=None, location=None, name=None, password=None, pfx_blob=None, resource_group_name=None, server_farm_id=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:Certificate"), pulumi.Alias(type_="azurerm:web/v20160301:Certificate"), pulumi.Alias(type_="azurerm:web/v20180201:Certificate"), pulumi.Alias(type_="azurerm:web/v20181101:Certificate"), pulumi.Alias(type_="azurerm:web/v20200601:Certificate")])
