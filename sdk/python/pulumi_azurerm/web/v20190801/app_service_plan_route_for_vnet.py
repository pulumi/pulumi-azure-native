...
class AppServicePlanRouteForVnet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, end_address=None, kind=None, name=None, resource_group_name=None, route_type=None, start_address=None, vnet_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:web/v20150801:AppServicePlanRouteForVnet"), pulumi.Alias(type_="azurerm:web/v20160901:AppServicePlanRouteForVnet"), pulumi.Alias(type_="azurerm:web/v20180201:AppServicePlanRouteForVnet")])
