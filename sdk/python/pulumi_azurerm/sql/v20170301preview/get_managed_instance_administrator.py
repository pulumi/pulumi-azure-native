...
def get_managed_instance_administrator(administrator_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:sql/v20170301preview:getManagedInstanceAdministrator', __args__, opts=opts, typ=GetManagedInstanceAdministratorResult).value
