...
def get_managed_instance_administrator(administrator_name: Optional[str] = None,
    ...
    :param str administrator_name: The administrator name.
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:sql/preview:getManagedInstanceAdministrator', __args__, opts=opts, typ=GetManagedInstanceAdministratorResult).value
