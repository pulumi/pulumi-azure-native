...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/latest:FirewallRule"), pulumi.Alias(type_="azurerm:sql/v20140401:FirewallRule"), pulumi.Alias(type_="azurerm:sql/v20150501preview:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azurerm:sql/preview:FirewallRule',
            resource_name,
            __props__,
            opts)
