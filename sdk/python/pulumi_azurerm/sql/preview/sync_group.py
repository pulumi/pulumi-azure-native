...
class SyncGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/v20150501preview:SyncGroup"), pulumi.Alias(type_="azurerm:sql/v20190601preview:SyncGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SyncGroup, __self__).__init__(
            'azurerm:sql/preview:SyncGroup',
            resource_name,
            __props__,
            opts)
