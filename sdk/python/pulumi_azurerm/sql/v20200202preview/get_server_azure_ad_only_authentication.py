...
def get_server_azure_ad_only_authentication(authentication_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:sql/v20200202preview:getServerAzureADOnlyAuthentication', __args__, opts=opts, typ=GetServerAzureADOnlyAuthenticationResult).value
