...
class ServerAzureADOnlyAuthentication(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/preview:ServerAzureADOnlyAuthentication")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerAzureADOnlyAuthentication, __self__).__init__(
            'azurerm:sql/v20200202preview:ServerAzureADOnlyAuthentication',
            resource_name,
            __props__,
            opts)
