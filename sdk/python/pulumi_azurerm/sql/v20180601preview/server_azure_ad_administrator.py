...
class ServerAzureADAdministrator(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/latest:ServerAzureADAdministrator"), pulumi.Alias(type_="azurerm:sql/preview:ServerAzureADAdministrator"), pulumi.Alias(type_="azurerm:sql/v20140401:ServerAzureADAdministrator"), pulumi.Alias(type_="azurerm:sql/v20190601preview:ServerAzureADAdministrator")])
