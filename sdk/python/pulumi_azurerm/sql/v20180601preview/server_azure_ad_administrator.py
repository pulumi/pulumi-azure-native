...
class ServerAzureADAdministrator(pulumi.CustomResource):
    def __init__(__self__,
        ...
        server_azure_ad_administrator = azurerm.sql.v20180601preview.ServerAzureADAdministrator("serverAzureADAdministrator",
        ...
        :param pulumi.Input[str] administrator_type: Type of the sever administrator.
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/latest:ServerAzureADAdministrator"), pulumi.Alias(type_="azurerm:sql/v20140401:ServerAzureADAdministrator"), pulumi.Alias(type_="azurerm:sql/v20190601preview:ServerAzureADAdministrator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerAzureADAdministrator, __self__).__init__(
            'azurerm:sql/v20180601preview:ServerAzureADAdministrator',
            resource_name,
            __props__,
            opts)
