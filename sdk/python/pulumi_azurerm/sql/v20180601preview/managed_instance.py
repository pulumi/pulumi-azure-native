...
class ManagedInstance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/latest:ManagedInstance"), pulumi.Alias(type_="azurerm:sql/v20150501preview:ManagedInstance"), pulumi.Alias(type_="azurerm:sql/v20200202preview:ManagedInstance")])
