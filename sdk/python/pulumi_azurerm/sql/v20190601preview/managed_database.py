...
class ManagedDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        managed_database = azurerm.sql.v20190601preview.ManagedDatabase("managedDatabase",
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/v20170301preview:ManagedDatabase"), pulumi.Alias(type_="azurerm:sql/v20180601preview:ManagedDatabase"), pulumi.Alias(type_="azurerm:sql/v20200202preview:ManagedDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedDatabase, __self__).__init__(
            'azurerm:sql/v20190601preview:ManagedDatabase',
            resource_name,
            __props__,
            opts)
