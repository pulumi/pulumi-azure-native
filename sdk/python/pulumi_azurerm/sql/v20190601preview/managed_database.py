...
class ManagedDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/preview:ManagedDatabase"), pulumi.Alias(type_="azurerm:sql/v20170301preview:ManagedDatabase"), pulumi.Alias(type_="azurerm:sql/v20180601preview:ManagedDatabase"), pulumi.Alias(type_="azurerm:sql/v20200202preview:ManagedDatabase")])
