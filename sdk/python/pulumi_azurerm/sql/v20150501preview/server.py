...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/latest:Server"), pulumi.Alias(type_="azurerm:sql/preview:Server"), pulumi.Alias(type_="azurerm:sql/v20140401:Server"), pulumi.Alias(type_="azurerm:sql/v20190601preview:Server")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Server, __self__).__init__(
            'azurerm:sql/v20150501preview:Server',
            resource_name,
            __props__,
            opts)
