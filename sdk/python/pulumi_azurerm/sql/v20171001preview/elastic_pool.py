...
class ElasticPool(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/latest:ElasticPool"), pulumi.Alias(type_="azurerm:sql/preview:ElasticPool"), pulumi.Alias(type_="azurerm:sql/v20140401:ElasticPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ElasticPool, __self__).__init__(
            'azurerm:sql/v20171001preview:ElasticPool',
            resource_name,
            __props__,
            opts)
