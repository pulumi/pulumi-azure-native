...
class Database(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/latest:Database"), pulumi.Alias(type_="azurerm:sql/preview:Database"), pulumi.Alias(type_="azurerm:sql/v20170301preview:Database"), pulumi.Alias(type_="azurerm:sql/v20171001preview:Database"), pulumi.Alias(type_="azurerm:sql/v20190601preview:Database")])
