...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:sql/latest:FirewallRule"), pulumi.Alias(type_="azurerm:sql/preview:FirewallRule"), pulumi.Alias(type_="azurerm:sql/v20150501preview:FirewallRule")])
