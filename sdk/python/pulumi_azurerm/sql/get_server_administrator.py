...
def get_server_administrator(name=None, resource_group_name=None, server_name=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:sql:getServerAdministrator', __args__, opts=opts).value
