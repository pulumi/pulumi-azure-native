...
class BillingRoleAssignmentByBillingAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:billing/preview:BillingRoleAssignmentByBillingAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BillingRoleAssignmentByBillingAccount, __self__).__init__(
            'azurerm:billing/v20191001preview:BillingRoleAssignmentByBillingAccount',
            resource_name,
            __props__,
            opts)
