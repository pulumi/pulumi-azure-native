...
class BillingRoleAssignmentByEnrollmentAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:billing/v20191001preview:BillingRoleAssignmentByEnrollmentAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BillingRoleAssignmentByEnrollmentAccount, __self__).__init__(
            'azurerm:billing/preview:BillingRoleAssignmentByEnrollmentAccount',
            resource_name,
            __props__,
            opts)
