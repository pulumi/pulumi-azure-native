...
class ReportByBillingAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:billing/v20180801preview:ReportByBillingAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReportByBillingAccount, __self__).__init__(
            'azurerm:billing/preview:ReportByBillingAccount',
            resource_name,
            __props__,
            opts)
