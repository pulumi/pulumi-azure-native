...
class RegistrationAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:managedservices/latest:RegistrationAssignment"), pulumi.Alias(type_="azurerm:managedservices/v20180601preview:RegistrationAssignment"), pulumi.Alias(type_="azurerm:managedservices/v20190401preview:RegistrationAssignment"), pulumi.Alias(type_="azurerm:managedservices/v20190601:RegistrationAssignment"), pulumi.Alias(type_="azurerm:managedservices/v20190901:RegistrationAssignment"), pulumi.Alias(type_="azurerm:managedservices/v20200201preview:RegistrationAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegistrationAssignment, __self__).__init__(
            'azurerm:managedservices/preview:RegistrationAssignment',
            resource_name,
            __props__,
            opts)
