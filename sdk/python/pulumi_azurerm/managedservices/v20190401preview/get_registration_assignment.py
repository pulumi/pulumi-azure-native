...
def get_registration_assignment(expand_registration_definition: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:managedservices/v20190401preview:getRegistrationAssignment', __args__, opts=opts, typ=GetRegistrationAssignmentResult).value
