...
def get_registration_definition(registration_definition_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azurerm:managedservices/v20180601preview:getRegistrationDefinition', __args__, opts=opts, typ=GetRegistrationDefinitionResult).value
