...
class RegistrationAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azurerm:managedservices/latest:RegistrationAssignment"), pulumi.Alias(type_="azurerm:managedservices/v20190901:RegistrationAssignment")])
