...
__all__ = [
    ...
    'ClientCertificateInvokeResponseResult',
    ...
    'SubResourceResponse',
    'VMSSExtensionInvokeResponseResult',
...
@pulumi.output_type
class ClientCertificateInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class VMSSExtensionInvokeResponseResult(dict):
    """
...
class VaultSecretGroupInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vault_certificates: Sequence['outputs.VaultCertificateInvokeResponseResult']):
        """
        Specifies set of certificates that should be installed onto the virtual machines.
    ...
    def vault_certificates(self) -> Sequence['outputs.VaultCertificateInvokeResponseResult']:
        """
