...
class ApplicationType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicefabric:ApplicationType"), pulumi.Alias(type_="azure-nextgen:servicefabric/latest:ApplicationType"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20170701preview:ApplicationType"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20190301:ApplicationType"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20190301preview:ApplicationType"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20191101preview:ApplicationType"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20200301:ApplicationType")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationType, __self__).__init__(
            'azure-nextgen:servicefabric/v20190601preview:ApplicationType',
            resource_name,
            __props__,
            opts)
