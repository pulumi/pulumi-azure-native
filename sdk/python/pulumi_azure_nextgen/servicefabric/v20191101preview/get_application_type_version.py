...
def get_application_type_version(application_type_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:servicefabric/v20191101preview:getApplicationTypeVersion', __args__, opts=opts, typ=GetApplicationTypeVersionResult).value
