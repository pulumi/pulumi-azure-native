...
@pulumi.output_type
class ApplicationTypeVersionsCleanupPolicyInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ApplicationUserAssignedIdentityInvokeResponseResult(dict):
    def __init__(__self__, *,
                 name: str,
                 principal_id: str):
        """
...
class ManagedIdentityInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, 'UserAssignedIdentityInvokeResponseArgs'] user_assigned_identities: The list of user identities associated with the resource. The user identity dictionary key references will be ARM resource ids in the form:
