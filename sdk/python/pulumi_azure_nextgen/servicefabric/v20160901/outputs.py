...
class ClusterUpgradePolicyInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ClusterHealthPolicyInvokeResponseArgs' health_policy: Cluster health Policy
        ...
        :param 'ClusterUpgradeDeltaHealthPolicyInvokeResponseArgs' delta_health_policy: Delta health policy
...
class NodeTypeDescriptionInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'EndpointRangeDescriptionInvokeResponseArgs' application_ports: Ports used by applications
        ...
        :param 'EndpointRangeDescriptionInvokeResponseArgs' ephemeral_ports: System assigned application ports
...
class SettingsSectionDescriptionInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['SettingsParameterDescriptionInvokeResponseArgs'] parameters: Collection of settings in the section, each setting is a tuple consisting of setting name and value
        """
        pulumi.set(__self__, "name", name)
