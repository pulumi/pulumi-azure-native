...
class GetClusterResult:
    ...
    def available_cluster_versions(self) -> Optional[Sequence['outputs.ClusterVersionDetailsInvokeResponseResult']]:
        """
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:servicefabric/v20170701preview:getCluster', __args__, opts=opts, typ=GetClusterResult).value
