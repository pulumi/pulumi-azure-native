...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:dbforpostgresql:Server'.""", DeprecationWarning)
...
class Server(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql:Server"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:Server"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201preview:Server")])
