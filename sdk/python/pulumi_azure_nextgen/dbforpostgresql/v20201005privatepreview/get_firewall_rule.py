...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:dbforpostgresql/v20201005privatepreview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
