...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql:Server"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/latest:Server"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:Server")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Server, __self__).__init__(
            'azure-nextgen:dbforpostgresql/v20171201preview:Server',
            resource_name,
            __props__,
            opts)
