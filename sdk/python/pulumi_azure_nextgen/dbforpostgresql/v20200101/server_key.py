...
class ServerKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/latest:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20200101privatepreview:ServerKey")])
