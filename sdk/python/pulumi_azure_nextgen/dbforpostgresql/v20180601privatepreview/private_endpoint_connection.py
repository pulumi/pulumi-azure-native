...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20180601:PrivateEndpointConnection")])
