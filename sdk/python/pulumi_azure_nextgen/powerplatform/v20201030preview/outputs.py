...
__all__ = [
    'EnterprisePolicyIdentityInvokeResponseResult',
    'EnterprisePolicyIdentityResponse',
    'KeyPropertiesInvokeResponseResult',
    ...
    'PropertiesInvokeResponseEncryptionResult',
    'PropertiesInvokeResponseLockboxResult',
...
@pulumi.output_type
class EnterprisePolicyIdentityInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class KeyPropertiesInvokeResponseResult(dict):
    """
...
class KeyVaultPropertiesInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key: Optional['outputs.KeyPropertiesInvokeResponseResult'] = None):
        """
        Settings concerning key vault encryption for a configuration store.
        :param str status: The state of onboarding, which only appears in the response.
        :param str id: Uri of KeyVault
        :param 'KeyPropertiesInvokeResponseArgs' key: Identity of the secret that includes name and version.
        """
    ...
    @property
    @pulumi.getter
    def key(self) -> Optional['outputs.KeyPropertiesInvokeResponseResult']:
        """
...
@pulumi.output_type
class PropertiesInvokeResponseEncryptionResult(dict):
    """
...
@pulumi.output_type
class PropertiesInvokeResponseLockboxResult(dict):
    """
