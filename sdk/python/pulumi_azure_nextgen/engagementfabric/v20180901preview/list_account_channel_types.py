...
class ListAccountChannelTypesResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ChannelTypeDescriptionInvokeResponseResult']]:
        """
...
def list_account_channel_types(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:engagementfabric/v20180901preview:listAccountChannelTypes', __args__, opts=opts, typ=ListAccountChannelTypesResult).value
