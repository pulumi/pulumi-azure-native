...
def getprivate_link_for_azure_ad(policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:aadiam/v20200301preview:getprivateLinkForAzureAd', __args__, opts=opts, typ=GetprivateLinkForAzureAdResult).value
