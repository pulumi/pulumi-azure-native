...
def get_workspace(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:machinelearningexperimentation/v20170501preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
