...
class ManagedNetworkPeeringPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:managednetwork/v20190601preview:ManagedNetworkPeeringPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedNetworkPeeringPolicy, __self__).__init__(
            'azure-nextgen:managednetwork:ManagedNetworkPeeringPolicy',
            resource_name,
            __props__,
            opts)
