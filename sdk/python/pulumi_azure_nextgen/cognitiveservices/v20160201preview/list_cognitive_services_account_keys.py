...
def list_cognitive_services_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:cognitiveservices/v20160201preview:listCognitiveServicesAccountKeys', __args__, opts=opts, typ=ListCognitiveServicesAccountKeysResult).value
