...
__all__ = [
    'ConfidentialLedgerCertUserInvokeResponseResult',
    'ConfidentialLedgerCertUserResponse',
    'LedgerPropertiesInvokeResponseResult',
...
@pulumi.output_type
class ConfidentialLedgerCertUserInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class LedgerPropertiesInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 cert_users: Optional[Sequence['outputs.ConfidentialLedgerCertUserInvokeResponseResult']] = None,
        ...
        :param Sequence['ConfidentialLedgerCertUserInvokeResponseArgs'] cert_users: Array of all the cert based users who can access Confidential Ledger
    ...
    def cert_users(self) -> Optional[Sequence['outputs.ConfidentialLedgerCertUserInvokeResponseResult']]:
        """
