...
__all__ = [
    'CustomRPActionRouteDefinitionInvokeResponseResult',
    'CustomRPActionRouteDefinitionResponse',
    'CustomRPResourceTypeRouteDefinitionInvokeResponseResult',
    'CustomRPResourceTypeRouteDefinitionResponse',
    'CustomRPValidationsInvokeResponseResult',
    'CustomRPValidationsResponse',
]

@pulumi.output_type
class CustomRPActionRouteDefinitionInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CustomRPResourceTypeRouteDefinitionInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CustomRPValidationsInvokeResponseResult(dict):
    """
