...
class GetPoolResult:
    ...
    @property
    @pulumi.getter
    def identity(self) -> Optional['outputs.BatchPoolIdentityInvokeResponseResult']:
        """
...
def get_pool(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:batch/v20210101:getPool', __args__, opts=opts, typ=GetPoolResult).value
