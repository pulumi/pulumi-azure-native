...
def get_pool(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:batch/v20200901:getPool', __args__, opts=opts, typ=GetPoolResult).value
