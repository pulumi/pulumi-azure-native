...
class GetPoolResult:
    ...
    def mount_configuration(self) -> Optional[Sequence['outputs.MountConfigurationInvokeResponseResult']]:
        """
...
def get_pool(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:batch/v20200501:getPool', __args__, opts=opts, typ=GetPoolResult).value
