...
class BatchAccountIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: The type of identity used for the Batch account.
        """
...
class DiskEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] targets: On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.
        """
