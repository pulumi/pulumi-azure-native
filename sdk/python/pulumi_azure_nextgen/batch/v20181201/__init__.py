...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:batch/v20181201:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:batch/v20181201:ApplicationPackage":
                return ApplicationPackage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:batch/v20181201:BatchAccount":
                return BatchAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:batch/v20181201:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:batch/v20181201:Pool":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "batch/v20181201", _module_instance)
