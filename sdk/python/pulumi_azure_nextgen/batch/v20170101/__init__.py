...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:batch/v20170101:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:batch/v20170101:ApplicationPackage":
                return ApplicationPackage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:batch/v20170101:BatchAccount":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "batch/v20170101", _module_instance)
