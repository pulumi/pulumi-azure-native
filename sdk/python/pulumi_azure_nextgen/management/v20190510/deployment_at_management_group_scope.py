...
class DeploymentAtManagementGroupScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:management/latest:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azure-nextgen:management/v20190501:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azure-nextgen:management/v20190701:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azure-nextgen:management/v20190801:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azure-nextgen:management/v20191001:DeploymentAtManagementGroupScope"), pulumi.Alias(type_="azure-nextgen:management/v20200601:DeploymentAtManagementGroupScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeploymentAtManagementGroupScope, __self__).__init__(
            'azure-nextgen:management/v20190510:DeploymentAtManagementGroupScope',
            resource_name,
            __props__,
            opts)
