...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:management/v20200501:HierarchySetting":
                return HierarchySetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:management/v20200501:ManagementGroup":
                return ManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:management/v20200501:ManagementGroupSubscription":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "management/v20200501", _module_instance)
