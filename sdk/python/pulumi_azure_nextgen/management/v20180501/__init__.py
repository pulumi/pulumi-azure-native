...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:management/v20180501:PolicyDefinitionAtManagementGroup":
                return PolicyDefinitionAtManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:management/v20180501:PolicySetDefinitionAtManagementGroup":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "management/v20180501", _module_instance)
