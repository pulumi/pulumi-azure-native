...
def get_published_blueprint(blueprint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:management/v20171111preview:getPublishedBlueprint', __args__, opts=opts, typ=GetPublishedBlueprintResult).value
