...
class PolicyDefinitionAtManagementGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:management/latest:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:management/v20161201:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:management/v20180301:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:management/v20180501:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:management/v20190101:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:management/v20190601:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:management/v20200301:PolicyDefinitionAtManagementGroup")])
