...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:management/v20190801:DeploymentAtManagementGroupScope":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "management/v20190801", _module_instance)
