...
class GetContainerGroupResult:
    ...
    def encryption_properties(self) -> Optional['outputs.EncryptionPropertiesInvokeResponseResult']:
        """
    ...
    def init_containers(self) -> Optional[Sequence['outputs.InitContainerDefinitionInvokeResponseResult']]:
        """
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerinstance/v20201101:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
