...
class RemediationAtResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights:RemediationAtResource"), pulumi.Alias(type_="azure-nextgen:policyinsights/latest:RemediationAtResource"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20190701:RemediationAtResource")])
