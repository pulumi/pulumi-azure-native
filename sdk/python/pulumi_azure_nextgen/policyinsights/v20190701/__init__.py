...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:policyinsights/v20190701:RemediationAtManagementGroup":
                return RemediationAtManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:policyinsights/v20190701:RemediationAtResource":
                return RemediationAtResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:policyinsights/v20190701:RemediationAtResourceGroup":
                return RemediationAtResourceGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:policyinsights/v20190701:RemediationAtSubscription":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "policyinsights/v20190701", _module_instance)
