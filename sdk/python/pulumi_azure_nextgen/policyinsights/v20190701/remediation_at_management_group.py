...
class RemediationAtManagementGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/latest:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20180701preview:RemediationAtManagementGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemediationAtManagementGroup, __self__).__init__(
            'azure-nextgen:policyinsights/v20190701:RemediationAtManagementGroup',
            resource_name,
            __props__,
            opts)
