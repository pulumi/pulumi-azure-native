...
class RemediationAtResourceGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights:RemediationAtResourceGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/latest:RemediationAtResourceGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20180701preview:RemediationAtResourceGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemediationAtResourceGroup, __self__).__init__(
            'azure-nextgen:policyinsights/v20190701:RemediationAtResourceGroup',
            resource_name,
            __props__,
            opts)
