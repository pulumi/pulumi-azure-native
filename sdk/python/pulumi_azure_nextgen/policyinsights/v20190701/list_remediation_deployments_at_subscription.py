...
class ListRemediationDeploymentsAtSubscriptionResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Sequence['outputs.RemediationDeploymentInvokeResponseResult']:
        """
...
def list_remediation_deployments_at_subscription(remediation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:policyinsights/v20190701:listRemediationDeploymentsAtSubscription', __args__, opts=opts, typ=ListRemediationDeploymentsAtSubscriptionResult).value
