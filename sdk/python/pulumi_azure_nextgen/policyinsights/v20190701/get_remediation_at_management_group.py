...
def get_remediation_at_management_group(management_group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:policyinsights/v20190701:getRemediationAtManagementGroup', __args__, opts=opts, typ=GetRemediationAtManagementGroupResult).value
