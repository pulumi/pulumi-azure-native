...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:policyinsights/latest:RemediationAtManagementGroup":
                return RemediationAtManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:policyinsights/latest:RemediationAtResource":
                return RemediationAtResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:policyinsights/latest:RemediationAtResourceGroup":
                return RemediationAtResourceGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:policyinsights/latest:RemediationAtSubscription":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "policyinsights/latest", _module_instance)
