...
def get_attestation_at_resource(attestation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:policyinsights/v20210101:getAttestationAtResource', __args__, opts=opts, typ=GetAttestationAtResourceResult).value
