...
def get_attestation_at_subscription(attestation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:policyinsights/v20210101:getAttestationAtSubscription', __args__, opts=opts, typ=GetAttestationAtSubscriptionResult).value
