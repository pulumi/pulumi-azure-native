...
__all__ = [
    'CacheEncryptionSettingsInvokeResponseResult',
    'CacheEncryptionSettingsResponse',
    'CacheHealthInvokeResponseResult',
    'CacheHealthResponse',
    'CacheIdentityInvokeResponseResult',
    'CacheIdentityResponse',
    'CacheInvokeResponseSkuResult',
    'CacheNetworkSettingsInvokeResponseResult',
    'CacheNetworkSettingsResponse',
    'CacheResponseSku',
    'CacheSecuritySettingsInvokeResponseResult',
    'CacheSecuritySettingsResponse',
    'CacheUpgradeStatusInvokeResponseResult',
    'CacheUpgradeStatusResponse',
    'ClfsTargetInvokeResponseResult',
    'ClfsTargetResponse',
    'KeyVaultKeyReferenceInvokeResponseResult',
    'KeyVaultKeyReferenceInvokeResponseSourceVaultResult',
    'KeyVaultKeyReferenceResponse',
    'KeyVaultKeyReferenceResponseSourceVault',
    'NamespaceJunctionInvokeResponseResult',
    'NamespaceJunctionResponse',
    'Nfs3TargetInvokeResponseResult',
    'Nfs3TargetResponse',
    'SystemDataInvokeResponseResult',
    'SystemDataResponse',
    'UnknownTargetInvokeResponseResult',
    'UnknownTargetResponse',
]

@pulumi.output_type
class CacheEncryptionSettingsInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CacheHealthInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CacheIdentityInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CacheInvokeResponseSkuResult(dict):
    """
    SKU for the Cache.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class CacheNetworkSettingsInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CacheSecuritySettingsInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CacheUpgradeStatusInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ClfsTargetInvokeResponseResult(dict):
    """
...
class KeyVaultKeyReferenceInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 key_url: str,
                 source_vault: 'outputs.KeyVaultKeyReferenceInvokeResponseSourceVaultResult'):
        """
        Describes a reference to Key Vault Key.
        :param str key_url: The URL referencing a key encryption key in Key Vault.
        :param 'KeyVaultKeyReferenceInvokeResponseSourceVaultArgs' source_vault: Describes a resource Id to source Key Vault.
        """
    ...
    def source_vault(self) -> 'outputs.KeyVaultKeyReferenceInvokeResponseSourceVaultResult':
        """
...
@pulumi.output_type
class KeyVaultKeyReferenceInvokeResponseSourceVaultResult(dict):
    """
    Describes a resource Id to source Key Vault.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class NamespaceJunctionInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class Nfs3TargetInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class UnknownTargetInvokeResponseResult(dict):
    """
