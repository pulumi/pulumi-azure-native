...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:storagecache:Cache":
                return Cache(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storagecache:StorageTarget":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "storagecache", _module_instance)
