...
class WorkspaceCollection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:powerbi:WorkspaceCollection"), pulumi.Alias(type_="azure-nextgen:powerbi/latest:WorkspaceCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceCollection, __self__).__init__(
            'azure-nextgen:powerbi/v20160129:WorkspaceCollection',
            resource_name,
            __props__,
            opts)
