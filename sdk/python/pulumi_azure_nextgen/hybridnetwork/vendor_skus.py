...
class VendorSkus(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hybridnetwork/v20200101preview:VendorSkus")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VendorSkus, __self__).__init__(
            'azure-nextgen:hybridnetwork:VendorSkus',
            resource_name,
            __props__,
            opts)
