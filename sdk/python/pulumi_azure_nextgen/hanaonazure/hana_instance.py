...
class HanaInstance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hanaonazure/v20171103preview:HanaInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HanaInstance, __self__).__init__(
            'azure-nextgen:hanaonazure:HanaInstance',
            resource_name,
            __props__,
            opts)
