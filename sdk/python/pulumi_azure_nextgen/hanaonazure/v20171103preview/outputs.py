...
class NetworkProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 network_interfaces: Optional[Sequence['outputs.IpAddressInvokeResponseResult']] = None):
        """
        Specifies the network settings for the HANA instance disks.
        :param str circuit_id: Specifies the circuit id for connecting to express route.
        :param Sequence['IpAddressInvokeResponseArgs'] network_interfaces: Specifies the network interfaces for the HANA instance.
        """
    ...
    def network_interfaces(self) -> Optional[Sequence['outputs.IpAddressInvokeResponseResult']]:
        """
...
class StorageProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 os_disks: Optional[Sequence['outputs.DiskInvokeResponseResult']] = None):
        """
        Specifies the storage settings for the HANA instance disks.
        :param str nfs_ip_address: IP Address to connect to storage.
        :param Sequence['DiskInvokeResponseArgs'] os_disks: Specifies information about the operating system disk used by the hana instance.
        """
    ...
    def os_disks(self) -> Optional[Sequence['outputs.DiskInvokeResponseResult']]:
        """
