...
class VaultPropertiesInvokeResponseResult(dict):
    ...
    """
    def __init__(__self__, *,
                 access_policies: Sequence['outputs.AccessPolicyEntryInvokeResponseResult'],
        ...
        """
        Properties of the vault
        :param Sequence['AccessPolicyEntryInvokeResponseArgs'] access_policies: An array of 0 to 16 identities that have access to the key vault. All identities in the array must use the same tenant ID as the key vault's tenant ID.
    ...
    def access_policies(self) -> Sequence['outputs.AccessPolicyEntryInvokeResponseResult']:
        """
