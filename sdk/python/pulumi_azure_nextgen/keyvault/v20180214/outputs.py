...
__all__ = [
    'AccessPolicyEntryInvokeResponseResult',
    'AccessPolicyEntryResponse',
    'IPRuleInvokeResponseResult',
    'IPRuleResponse',
    'NetworkRuleSetInvokeResponseResult',
    'NetworkRuleSetResponse',
    'PermissionsInvokeResponseResult',
    'PermissionsResponse',
    'PrivateEndpointConnectionItemInvokeResponseResult',
    ...
    'SecretAttributesInvokeResponseResult',
    'SecretAttributesResponse',
    'SecretPropertiesInvokeResponseResult',
...
@pulumi.output_type
class AccessPolicyEntryInvokeResponseResult(dict):
    """
    An identity that have access to the key vault. All identities in the array must use the same tenant ID as the key vault's tenant ID.
    """
    def __init__(__self__, *,
                 object_id: str,
                 permissions: 'outputs.PermissionsInvokeResponseResult',
                 tenant_id: str,
        ...
        :param 'PermissionsInvokeResponseArgs' permissions: Permissions the identity has for keys, secrets and certificates.
    ...
    @property
    @pulumi.getter
    def permissions(self) -> 'outputs.PermissionsInvokeResponseResult':
        """
...
class NetworkRuleSetInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['IPRuleInvokeResponseArgs'] ip_rules: The list of IP address rules.
        :param Sequence['VirtualNetworkRuleInvokeResponseArgs'] virtual_network_rules: The list of virtual network rules.
        """
...
@pulumi.output_type
class PermissionsInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class PrivateEndpointConnectionItemInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        :param 'PrivateEndpointInvokeResponseArgs' private_endpoint: Properties of the private endpoint object.
        :param 'PrivateLinkServiceConnectionStateInvokeResponseArgs' private_link_service_connection_state: Approval state of the private link connection.
        """
...
@pulumi.output_type
class SecretAttributesInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class SecretPropertiesInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 attributes: Optional['outputs.SecretAttributesInvokeResponseResult'] = None,
        ...
        :param 'SecretAttributesInvokeResponseArgs' attributes: The attributes of the secret.
    ...
    @property
    @pulumi.getter
    def attributes(self) -> Optional['outputs.SecretAttributesInvokeResponseResult']:
        """
...
class VaultPropertiesInvokeResponseResult(dict):
    ...
    """
    def __init__(__self__, *,
                 private_endpoint_connections: Sequence['outputs.PrivateEndpointConnectionItemInvokeResponseResult'],
                 sku: 'outputs.SkuInvokeResponseResult',
                 tenant_id: str,
                 access_policies: Optional[Sequence['outputs.AccessPolicyEntryInvokeResponseResult']] = None,
                 ...
                 network_acls: Optional['outputs.NetworkRuleSetInvokeResponseResult'] = None,
                 vault_uri: Optional[str] = None):
        """
        Properties of the vault
        :param Sequence['PrivateEndpointConnectionItemInvokeResponseArgs'] private_endpoint_connections: List of private endpoint connections associated with the key vault.
        :param 'SkuInvokeResponseArgs' sku: SKU details
        :param str tenant_id: The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
        :param Sequence['AccessPolicyEntryInvokeResponseArgs'] access_policies: An array of 0 to 1024 identities that have access to the key vault. All identities in the array must use the same tenant ID as the key vault's tenant ID. When `createMode` is set to `recover`, access policies are not required. Otherwise, access policies are required.
        ...
        :param 'NetworkRuleSetInvokeResponseArgs' network_acls: Rules governing the accessibility of the key vault from specific network locations.
    ...
    def private_endpoint_connections(self) -> Sequence['outputs.PrivateEndpointConnectionItemInvokeResponseResult']:
        """
    ...
    def access_policies(self) -> Optional[Sequence['outputs.AccessPolicyEntryInvokeResponseResult']]:
        """
    ...
    def network_acls(self) -> Optional['outputs.NetworkRuleSetInvokeResponseResult']:
        """
