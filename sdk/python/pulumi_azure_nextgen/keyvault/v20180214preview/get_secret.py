...
class GetSecretResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.SecretPropertiesInvokeResponseResult':
        """
...
def get_secret(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:keyvault/v20180214preview:getSecret', __args__, opts=opts, typ=GetSecretResult).value
