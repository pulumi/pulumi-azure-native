...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:managedservices:RegistrationAssignment":
                return RegistrationAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:managedservices:RegistrationDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "managedservices", _module_instance)
