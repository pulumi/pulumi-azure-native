...
__all__ = [
    ...
    'EligibleAuthorizationInvokeResponseResult',
    'EligibleAuthorizationResponse',
    'JustInTimeAccessPolicyInvokeResponseResult',
    'JustInTimeAccessPolicyResponse',
    'PlanInvokeResponseResult',
    'PlanResponse',
    'RegistrationAssignmentPropertiesInvokeResponseResult',
    'RegistrationAssignmentPropertiesInvokeResponsePropertiesResult',
    'RegistrationAssignmentPropertiesInvokeResponseRegistrationDefinitionResult',
    ...
    'RegistrationDefinitionPropertiesInvokeResponseResult',
...
@pulumi.output_type
class EligibleAuthorizationInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 principal_id: str,
                 role_definition_id: str,
                 just_in_time_access_policy: Optional['outputs.JustInTimeAccessPolicyInvokeResponseResult'] = None,
                 principal_id_display_name: Optional[str] = None):
        """
        Eligible authorization tuple containing principle Id (of user/service principal/security group), role definition id, and the just-in-time access setting.
        ...
        :param 'JustInTimeAccessPolicyInvokeResponseArgs' just_in_time_access_policy: Just-in-time access policy setting.
        :param str principal_id_display_name: Display name of the principal Id.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "role_definition_id", role_definition_id)
    ...
    def just_in_time_access_policy(self) -> Optional['outputs.JustInTimeAccessPolicyInvokeResponseResult']:
        """
...
@pulumi.output_type
class JustInTimeAccessPolicyInvokeResponseResult(dict):
    """
    Just-in-time access policy setting.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class RegistrationAssignmentPropertiesInvokeResponseResult(dict):
    """
    Properties of a registration assignment.
    """
    def __init__(__self__, *,
                 provisioning_state: str,
                 registration_definition: 'outputs.RegistrationAssignmentPropertiesInvokeResponseRegistrationDefinitionResult',
                 registration_definition_id: str):
        """
        Properties of a registration assignment.
        :param str provisioning_state: Current state of the registration assignment.
        :param 'RegistrationAssignmentPropertiesInvokeResponseRegistrationDefinitionArgs' registration_definition: Registration definition inside registration assignment.
    ...
    def registration_definition(self) -> 'outputs.RegistrationAssignmentPropertiesInvokeResponseRegistrationDefinitionResult':
        """
...
@pulumi.output_type
class RegistrationAssignmentPropertiesInvokeResponsePropertiesResult(dict):
    """
    Properties of registration definition inside registration assignment.
    """
    def __init__(__self__, *,
                 authorizations: Optional[Sequence['outputs.AuthorizationInvokeResponseResult']] = None,
                 description: Optional[str] = None,
                 eligible_authorizations: Optional[Sequence['outputs.EligibleAuthorizationInvokeResponseResult']] = None,
        ...
        """
        Properties of registration definition inside registration assignment.
        :param Sequence['AuthorizationInvokeResponseArgs'] authorizations: Authorization tuple containing principal id of the user/security group or service principal and id of the build-in role.
        :param str description: Description of the registration definition.
        :param Sequence['EligibleAuthorizationInvokeResponseArgs'] eligible_authorizations: Eligible PIM authorization tuple containing principal id of the user/security group or service principal, id of the built-in role, and just-in-time access policy setting
    ...
    @property
    @pulumi.getter
    def authorizations(self) -> Optional[Sequence['outputs.AuthorizationInvokeResponseResult']]:
        """
    ...
    def eligible_authorizations(self) -> Optional[Sequence['outputs.EligibleAuthorizationInvokeResponseResult']]:
        """
...
@pulumi.output_type
class RegistrationAssignmentPropertiesInvokeResponseRegistrationDefinitionResult(dict):
    """
    Registration definition inside registration assignment.
    """
    def __init__(__self__, *,
                 ...
                 name: str,
                 type: str,
                 plan: Optional['outputs.PlanInvokeResponseResult'] = None,
                 properties: Optional['outputs.RegistrationAssignmentPropertiesInvokeResponsePropertiesResult'] = None):
        """
        Registration definition inside registration assignment.
        ...
        :param 'PlanInvokeResponseArgs' plan: Plan details for the managed services.
        :param 'RegistrationAssignmentPropertiesInvokeResponsePropertiesArgs' properties: Properties of registration definition inside registration assignment.
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional['outputs.RegistrationAssignmentPropertiesInvokeResponsePropertiesResult']:
        """
        Properties of registration definition inside registration assignment.
        """
...
@pulumi.output_type
class RegistrationDefinitionPropertiesInvokeResponseResult(dict):
    """
    Properties of a registration definition.
    """
    def __init__(__self__, *,
                 authorizations: Sequence['outputs.AuthorizationInvokeResponseResult'],
    ...
    @property
    @pulumi.getter
    def authorizations(self) -> Sequence['outputs.AuthorizationInvokeResponseResult']:
        """
        Authorization tuple containing principal id of the user/security group or service principal and id of the build-in role.
        """
        return pulumi.get(self, "authorizations")
