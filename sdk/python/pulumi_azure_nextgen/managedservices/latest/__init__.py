...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:managedservices/latest:RegistrationAssignment":
                return RegistrationAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:managedservices/latest:RegistrationDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "managedservices/latest", _module_instance)
