...
def get_registration_definition(registration_definition_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:managedservices/latest:getRegistrationDefinition', __args__, opts=opts, typ=GetRegistrationDefinitionResult).value
