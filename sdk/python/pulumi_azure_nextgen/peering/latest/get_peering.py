...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:peering:getPeering'.""", DeprecationWarning)
...
def get_peering(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_peering is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:peering:getPeering'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:peering/latest:getPeering', __args__, opts=opts, typ=GetPeeringResult).value
