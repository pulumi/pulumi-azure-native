...
class DirectConnectionArgs:
    def __init__(__self__, *,
                 ...
                 provisioned_bandwidth_in_mbps: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[int] provisioned_bandwidth_in_mbps: The bandwidth that is actually provisioned.
    ...
    def provisioned_bandwidth_in_mbps(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def provisioned_bandwidth_in_mbps(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "provisioned_bandwidth_in_mbps", value)
...
class PeeringPropertiesDirectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] use_for_peering_service: The flag that indicates whether or not the peering is used for peering service.
        """
