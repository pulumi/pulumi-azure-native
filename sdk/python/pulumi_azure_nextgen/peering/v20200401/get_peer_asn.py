...
class GetPeerAsnResult:
    ...
    def peer_contact_detail(self) -> Optional[Sequence['outputs.ContactDetailInvokeResponseResult']]:
        """
...
def get_peer_asn(peer_asn_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:peering/v20200401:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult).value
