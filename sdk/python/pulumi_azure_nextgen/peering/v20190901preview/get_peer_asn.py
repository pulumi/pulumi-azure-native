...
class GetPeerAsnResult:
    ...
    """
    def __init__(__self__, error_message=None, id=None, name=None, peer_asn=None, peer_contact_info=None, peer_name=None, type=None, validation_state=None):
        ...
        pulumi.set(__self__, "peer_contact_info", peer_contact_info)
...
def get_peer_asn(peer_asn_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:peering/v20190901preview:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult).value
