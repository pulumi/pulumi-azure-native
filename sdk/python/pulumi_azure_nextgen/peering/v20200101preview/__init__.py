...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:peering/v20200101preview:PeerAsn":
                return PeerAsn(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:peering/v20200101preview:Peering":
                return Peering(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:peering/v20200101preview:PeeringService":
                return PeeringService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:peering/v20200101preview:Prefix":
                return Prefix(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:peering/v20200101preview:RegisteredAsn":
                return RegisteredAsn(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:peering/v20200101preview:RegisteredPrefix":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "peering/v20200101preview", _module_instance)
