...
class Alias(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:subscription/latest:Alias"), pulumi.Alias(type_="azure-nextgen:subscription/v20191001preview:Alias"), pulumi.Alias(type_="azure-nextgen:subscription/v20200901:Alias")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Alias, __self__).__init__(
            'azure-nextgen:subscription:Alias',
            resource_name,
            __props__,
            opts)
