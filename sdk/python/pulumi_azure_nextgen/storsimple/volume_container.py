...
class VolumeContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:VolumeContainer"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:VolumeContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VolumeContainer, __self__).__init__(
            'azure-nextgen:storsimple:VolumeContainer',
            resource_name,
            __props__,
            opts)
