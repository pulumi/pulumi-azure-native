...
class IscsiDisk(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:IscsiDisk"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:IscsiDisk")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IscsiDisk, __self__).__init__(
            'azure-nextgen:storsimple:IscsiDisk',
            resource_name,
            __props__,
            opts)
