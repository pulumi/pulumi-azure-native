...
class Volume(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:Volume"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:Volume")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Volume, __self__).__init__(
            'azure-nextgen:storsimple:Volume',
            resource_name,
            __props__,
            opts)
