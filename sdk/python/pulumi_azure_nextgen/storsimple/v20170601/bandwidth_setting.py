...
class BandwidthSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:BandwidthSetting"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:BandwidthSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BandwidthSetting, __self__).__init__(
            'azure-nextgen:storsimple/v20170601:BandwidthSetting',
            resource_name,
            __props__,
            opts)
