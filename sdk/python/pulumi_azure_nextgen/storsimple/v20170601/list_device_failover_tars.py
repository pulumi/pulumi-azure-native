...
class ListDeviceFailoverTarsResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.FailoverTargetInvokeResponseResult']]:
        """
...
def list_device_failover_tars(manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:storsimple/v20170601:listDeviceFailoverTars', __args__, opts=opts, typ=ListDeviceFailoverTarsResult).value
