...
class VolumeContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:VolumeContainer"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:VolumeContainer")])
