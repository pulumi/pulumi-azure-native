...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:security/latest:AdaptiveApplicationControl":
                return AdaptiveApplicationControl(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:security/latest:Assessment":
                return Assessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:security/latest:AssessmentMetadataInSubscription":
                return AssessmentMetadataInSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:security/latest:DeviceSecurityGroup":
                return DeviceSecurityGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:security/latest:IotSecuritySolution":
                return IotSecuritySolution(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:security/latest:JitNetworkAccessPolicy":
                return JitNetworkAccessPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:security/latest:ServerVulnerabilityAssessment":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "security/latest", _module_instance)
