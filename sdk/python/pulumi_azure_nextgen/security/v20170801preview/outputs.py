...
__all__ = [
    'AllowlistCustomAlertRuleInvokeResponseResult',
    'AllowlistCustomAlertRuleResponse',
    'DenylistCustomAlertRuleInvokeResponseResult',
    'DenylistCustomAlertRuleResponse',
    'RecommendationConfigurationPropertiesInvokeResponseResult',
    'RecommendationConfigurationPropertiesResponse',
    'ThresholdCustomAlertRuleInvokeResponseResult',
    'ThresholdCustomAlertRuleResponse',
    'TimeWindowCustomAlertRuleInvokeResponseResult',
    'TimeWindowCustomAlertRuleResponse',
    'UserDefinedResourcesPropertiesInvokeResponseResult',
    'UserDefinedResourcesPropertiesResponse',
]

@pulumi.output_type
class AllowlistCustomAlertRuleInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class DenylistCustomAlertRuleInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class RecommendationConfigurationPropertiesInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ThresholdCustomAlertRuleInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class TimeWindowCustomAlertRuleInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class UserDefinedResourcesPropertiesInvokeResponseResult(dict):
    """
