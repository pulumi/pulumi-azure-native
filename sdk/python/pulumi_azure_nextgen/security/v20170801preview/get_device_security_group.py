...
def get_device_security_group(device_security_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:security/v20170801preview:getDeviceSecurityGroup', __args__, opts=opts, typ=GetDeviceSecurityGroupResult).value
