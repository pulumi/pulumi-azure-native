...
class AssessmentsMetadataSubscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-nextgen:security/latest:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-nextgen:security/v20200101:AssessmentsMetadataSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentsMetadataSubscription, __self__).__init__(
            'azure-nextgen:security/v20190101preview:AssessmentsMetadataSubscription',
            resource_name,
            __props__,
            opts)
