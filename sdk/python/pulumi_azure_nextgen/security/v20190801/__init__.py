...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:security/v20190801:DeviceSecurityGroup":
                return DeviceSecurityGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:security/v20190801:IotSecuritySolution":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "security/v20190801", _module_instance)
