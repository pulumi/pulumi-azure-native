...
class GuestDiagnosticsSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20180601preview:guestDiagnosticsSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestDiagnosticsSetting, __self__).__init__(
            'azure-nextgen:insights:guestDiagnosticsSetting',
            resource_name,
            __props__,
            opts)
