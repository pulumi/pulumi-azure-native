...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:insights/v20191101preview:DataCollectionRule":
                return DataCollectionRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:insights/v20191101preview:DataCollectionRuleAssociation":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "insights/v20191101preview", _module_instance)
