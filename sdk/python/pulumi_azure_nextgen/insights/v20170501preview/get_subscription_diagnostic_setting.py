...
def get_subscription_diagnostic_setting(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:insights/v20170501preview:getSubscriptionDiagnosticSetting', __args__, opts=opts, typ=GetSubscriptionDiagnosticSettingResult).value
