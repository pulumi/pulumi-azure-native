...
__all__ = [
    ...
    'ConditionInvokeResponseFailingPeriodsResult',
    'ConditionResponse',
    'ConditionResponseFailingPeriods',
    'DimensionInvokeResponseResult',
    'DimensionResponse',
    'ScheduledQueryRuleCriteriaInvokeResponseResult',
...
class ConditionInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failing_periods: Optional['outputs.ConditionInvokeResponseFailingPeriodsResult'] = None,
        ...
        :param Sequence['DimensionInvokeResponseArgs'] dimensions: List of Dimensions conditions
        :param 'ConditionInvokeResponseFailingPeriodsArgs' failing_periods: The minimum number of violations required within the selected lookback time window required to raise an alert.
    ...
    def failing_periods(self) -> Optional['outputs.ConditionInvokeResponseFailingPeriodsResult']:
        """
...
@pulumi.output_type
class ConditionInvokeResponseFailingPeriodsResult(dict):
    """
    The minimum number of violations required within the selected lookback time window required to raise an alert.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class ScheduledQueryRuleCriteriaInvokeResponseResult(dict):
    """
    The rule criteria that defines the conditions of the scheduled query rule.
    """
    def __init__(__self__, *,
                 all_of: Optional[Sequence['outputs.ConditionInvokeResponseResult']] = None):
        """
        The rule criteria that defines the conditions of the scheduled query rule.
        :param Sequence['ConditionInvokeResponseArgs'] all_of: A list of conditions to evaluate against the specified scopes
        """
    ...
    def all_of(self) -> Optional[Sequence['outputs.ConditionInvokeResponseResult']]:
        """
