...
class AlertRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:AlertRule"), pulumi.Alias(type_="azure-nextgen:insights/latest:AlertRule"), pulumi.Alias(type_="azure-nextgen:insights/v20160301:AlertRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AlertRule, __self__).__init__(
            'azure-nextgen:insights/v20140401:AlertRule',
            resource_name,
            __props__,
            opts)
