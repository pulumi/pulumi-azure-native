...
class WebTest(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:WebTest"), pulumi.Alias(type_="azure-nextgen:insights/latest:WebTest"), pulumi.Alias(type_="azure-nextgen:insights/v20201005preview:WebTest")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebTest, __self__).__init__(
            'azure-nextgen:insights/v20150501:WebTest',
            resource_name,
            __props__,
            opts)
