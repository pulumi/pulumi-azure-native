...
def list_web_app_hybrid_connection_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20160801:listWebAppHybridConnectionKeys', __args__, opts=opts, typ=ListWebAppHybridConnectionKeysResult).value
