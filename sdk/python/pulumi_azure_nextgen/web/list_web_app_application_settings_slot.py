...
def list_web_app_application_settings_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web:listWebAppApplicationSettingsSlot', __args__, opts=opts, typ=ListWebAppApplicationSettingsSlotResult).value
