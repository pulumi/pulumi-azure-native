...
class ListSiteIdentifiersAssignedToHostNameResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Sequence['outputs.IdentifierInvokeResponseResult']:
        """
...
def list_site_identifiers_assigned_to_host_name(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20200901:listSiteIdentifiersAssignedToHostName', __args__, opts=opts, typ=ListSiteIdentifiersAssignedToHostNameResult).value
