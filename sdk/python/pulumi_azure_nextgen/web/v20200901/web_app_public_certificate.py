...
class WebAppPublicCertificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:WebAppPublicCertificate"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppPublicCertificate"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppPublicCertificate"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppPublicCertificate"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppPublicCertificate"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppPublicCertificate"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppPublicCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppPublicCertificate, __self__).__init__(
            'azure-nextgen:web/v20200901:WebAppPublicCertificate',
            resource_name,
            __props__,
            opts)
