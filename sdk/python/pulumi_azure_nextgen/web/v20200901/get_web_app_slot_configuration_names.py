...
class GetWebAppSlotConfigurationNamesResult:
    ...
    """
    def __init__(__self__, app_setting_names=None, azure_storage_config_names=None, connection_string_names=None, kind=None, name=None, system_data=None, type=None):
...
def get_web_app_slot_configuration_names(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20200901:getWebAppSlotConfigurationNames', __args__, opts=opts, typ=GetWebAppSlotConfigurationNamesResult).value
