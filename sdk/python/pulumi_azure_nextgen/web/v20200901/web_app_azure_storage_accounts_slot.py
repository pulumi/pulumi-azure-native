...
class WebAppAzureStorageAccountsSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppAzureStorageAccountsSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppAzureStorageAccountsSlot, __self__).__init__(
            'azure-nextgen:web/v20200901:WebAppAzureStorageAccountsSlot',
            resource_name,
            __props__,
            opts)
