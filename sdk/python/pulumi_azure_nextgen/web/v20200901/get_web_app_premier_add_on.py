...
class GetWebAppPremierAddOnResult:
    ...
    Premier add-on.
    """
    def __init__(__self__, kind=None, location=None, marketplace_offer=None, marketplace_publisher=None, name=None, product=None, sku=None, system_data=None, tags=None, type=None, vendor=None):
...
def get_web_app_premier_add_on(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20200901:getWebAppPremierAddOn', __args__, opts=opts, typ=GetWebAppPremierAddOnResult).value
