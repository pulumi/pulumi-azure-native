...
class GetWebAppDiagnosticLogsConfigurationResult:
    ...
    """
    def __init__(__self__, application_logs=None, detailed_error_messages=None, failed_requests_tracing=None, http_logs=None, kind=None, name=None, system_data=None, type=None):
...
def get_web_app_diagnostic_logs_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20200901:getWebAppDiagnosticLogsConfiguration', __args__, opts=opts, typ=GetWebAppDiagnosticLogsConfigurationResult).value
