...
class ListWebAppBackupConfigurationResult:
    ...
    def backup_schedule(self) -> Optional['outputs.BackupScheduleInvokeResponseResult']:
        """
...
def list_web_app_backup_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20200901:listWebAppBackupConfiguration', __args__, opts=opts, typ=ListWebAppBackupConfigurationResult).value
