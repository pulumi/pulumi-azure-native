...
class ListConnectionConsentLinksResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ConsentLinkDefinitionInvokeResponseResult']]:
        """
...
def list_connection_consent_links(connection_name: Optional[str] = None,
                                  parameters: Optional[Sequence[pulumi.InputType['ConsentLinkParameterDefinitionInvokeArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['ConsentLinkParameterDefinitionInvokeArgs']] parameters: Collection of resources
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20160601:listConnectionConsentLinks', __args__, opts=opts, typ=ListConnectionConsentLinksResult).value
