...
def get_web_app_hybrid_connection_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20180201:getWebAppHybridConnectionSlot', __args__, opts=opts, typ=GetWebAppHybridConnectionSlotResult).value
