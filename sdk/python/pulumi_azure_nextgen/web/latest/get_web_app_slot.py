...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:web:getWebAppSlot'.""", DeprecationWarning)
...
def get_web_app_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_web_app_slot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:web:getWebAppSlot'.")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/latest:getWebAppSlot', __args__, opts=opts, typ=GetWebAppSlotResult).value
