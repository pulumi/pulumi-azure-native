...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:web:getCustomApi'.""", DeprecationWarning)
...
def get_custom_api(api_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_custom_api is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:web:getCustomApi'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/latest:getCustomApi', __args__, opts=opts, typ=GetCustomApiResult).value
