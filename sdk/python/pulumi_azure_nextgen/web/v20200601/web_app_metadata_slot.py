...
class WebAppMetadataSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:WebAppMetadataSlot"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppMetadataSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppMetadataSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppMetadataSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppMetadataSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppMetadataSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppMetadataSlot")])
