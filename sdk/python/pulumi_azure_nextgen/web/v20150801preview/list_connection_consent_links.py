...
class ListConnectionConsentLinksResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ConsentLinkInvokeResponseResult']]:
        """
...
def list_connection_consent_links(connection_name: Optional[str] = None,
                                  ...
                                  parameters: Optional[Sequence[pulumi.InputType['ConsentLinkInputParameterInvokeArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['ConsentLinkInputParameterInvokeArgs']] parameters: Array of links
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20150801preview:listConnectionConsentLinks', __args__, opts=opts, typ=ListConnectionConsentLinksResult).value
