...
__all__ = [
    ...
    'GeoDistributionInvokeResponseResult',
...
@pulumi.output_type
class GeoDistributionInvokeResponseResult(dict):
    """
...
class SiteConfigInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 azure_storage_accounts: Optional[Mapping[str, 'outputs.AzureStorageInfoValueInvokeResponseResult']] = None,
        ...
        :param Mapping[str, 'AzureStorageInfoValueInvokeResponseArgs'] azure_storage_accounts: User-provided Azure storage accounts.
    ...
    def azure_storage_accounts(self) -> Optional[Mapping[str, 'outputs.AzureStorageInfoValueInvokeResponseResult']]:
        """
