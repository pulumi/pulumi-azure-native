...
def list_web_app_sync_function_triggers_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20181101:listWebAppSyncFunctionTriggersSlot', __args__, opts=opts, typ=ListWebAppSyncFunctionTriggersSlotResult).value
