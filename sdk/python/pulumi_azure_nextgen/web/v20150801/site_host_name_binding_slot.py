...
class SiteHostNameBindingSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteHostNameBindingSlot")])
