...
class SiteDeployment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteDeployment, __self__).__init__(
            'azure-nextgen:web/v20150801:SiteDeployment',
            resource_name,
            __props__,
            opts)
