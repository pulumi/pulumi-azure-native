...
class SiteAuthSettings(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['http_api_prefix_path'] = http_api_prefix_path
            ...
            __props__['name'] = name
            __props__['open_id_issuer'] = open_id_issuer
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteAuthSettings"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteAuthSettings")])
