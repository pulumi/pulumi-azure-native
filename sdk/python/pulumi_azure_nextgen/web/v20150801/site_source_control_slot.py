...
class SiteSourceControlSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:SiteSourceControlSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteSourceControlSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteSourceControlSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteSourceControlSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteSourceControlSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteSourceControlSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteSourceControlSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteSourceControlSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteSourceControlSlot")])
