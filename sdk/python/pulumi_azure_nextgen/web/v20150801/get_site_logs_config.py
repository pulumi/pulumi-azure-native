...
class GetSiteLogsConfigResult:
    ...
    """
    def __init__(__self__, application_logs=None, detailed_error_messages=None, failed_requests_tracing=None, http_logs=None, kind=None, location=None, name=None, tags=None, type=None):
...
def get_site_logs_config(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20150801:getSiteLogsConfig', __args__, opts=opts, typ=GetSiteLogsConfigResult).value
