...
class SiteDeploymentSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:SiteDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteDeploymentSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteDeploymentSlot, __self__).__init__(
            'azure-nextgen:web/v20150801:SiteDeploymentSlot',
            resource_name,
            __props__,
            opts)
