...
def get_site_instance_deployment_slot(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20150801:getSiteInstanceDeploymentSlot', __args__, opts=opts, typ=GetSiteInstanceDeploymentSlotResult).value
