...
@pulumi.output_type
class GetSiteDeploymentSlotResult:
    """
...
class AwaitableGetSiteDeploymentSlotResult(GetSiteDeploymentSlotResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSiteDeploymentSlotResult(
            active=self.active,
            author=self.author,
...
def get_site_deployment_slot(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:web/v20150801:getSiteDeploymentSlot', __args__, opts=opts, typ=GetSiteDeploymentSlotResult).value

    return AwaitableGetSiteDeploymentSlotResult(
