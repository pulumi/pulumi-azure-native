...
class SiteRelayServiceConnectionSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteRelayServiceConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteRelayServiceConnectionSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteRelayServiceConnectionSlot, __self__).__init__(
            'azure-nextgen:web/v20150801:SiteRelayServiceConnectionSlot',
            resource_name,
            __props__,
            opts)
