...
class SiteAuthSettingsSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteAuthSettingsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteAuthSettingsSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteAuthSettingsSlot, __self__).__init__(
            'azure-nextgen:web/v20150801:SiteAuthSettingsSlot',
            resource_name,
            __props__,
            opts)
