...
__all__ = ['WebApplicationSettingsSlot']


class WebApplicationSettingsSlot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WebApplicationSettingsSlot':
        """
        ...
        return WebApplicationSettingsSlot(resource_name, opts=opts, __props__=__props__)
