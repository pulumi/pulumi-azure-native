...
__all__ = [
    'CircuitInvokeResponseResult',
    'CircuitResponse',
    'EndpointsInvokeResponseResult',
    'EndpointsResponse',
    'IdentitySourceInvokeResponseResult',
    'IdentitySourceResponse',
    'ManagementClusterInvokeResponseResult',
...
@pulumi.output_type
class CircuitInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class IdentitySourceInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ManagementClusterInvokeResponseResult(dict):
    """
