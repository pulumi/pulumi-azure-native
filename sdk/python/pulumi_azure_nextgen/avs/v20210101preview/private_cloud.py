...
class PrivateCloud(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs:PrivateCloud"), pulumi.Alias(type_="azure-nextgen:avs/latest:PrivateCloud"), pulumi.Alias(type_="azure-nextgen:avs/v20200320:PrivateCloud"), pulumi.Alias(type_="azure-nextgen:avs/v20200717preview:PrivateCloud")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateCloud, __self__).__init__(
            'azure-nextgen:avs/v20210101preview:PrivateCloud',
            resource_name,
            __props__,
            opts)
