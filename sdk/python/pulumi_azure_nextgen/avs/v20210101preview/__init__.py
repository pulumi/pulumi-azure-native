...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:avs/v20210101preview:Addon":
                return Addon(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:Authorization":
                return Authorization(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:Cluster":
                return Cluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:Datastore":
                return Datastore(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:GlobalReachConnection":
                return GlobalReachConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:HcxEnterpriseSite":
                return HcxEnterpriseSite(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:PrivateCloud":
                return PrivateCloud(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:WorkloadNetworkDhcp":
                return WorkloadNetworkDhcp(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:WorkloadNetworkDnsService":
                return WorkloadNetworkDnsService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:WorkloadNetworkDnsZone":
                return WorkloadNetworkDnsZone(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:WorkloadNetworkPortMirroring":
                return WorkloadNetworkPortMirroring(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:WorkloadNetworkSegment":
                return WorkloadNetworkSegment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:avs/v20210101preview:WorkloadNetworkVMGroup":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "avs/v20210101preview", _module_instance)
