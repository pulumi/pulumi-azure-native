...
class WorkloadNetworkDhcp(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs:WorkloadNetworkDhcp"), pulumi.Alias(type_="azure-nextgen:avs/v20200717preview:WorkloadNetworkDhcp")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadNetworkDhcp, __self__).__init__(
            'azure-nextgen:avs/v20210101preview:WorkloadNetworkDhcp',
            resource_name,
            __props__,
            opts)
