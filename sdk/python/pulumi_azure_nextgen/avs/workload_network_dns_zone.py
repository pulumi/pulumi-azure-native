...
class WorkloadNetworkDnsZone(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20200717preview:WorkloadNetworkDnsZone"), pulumi.Alias(type_="azure-nextgen:avs/v20210101preview:WorkloadNetworkDnsZone")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadNetworkDnsZone, __self__).__init__(
            'azure-nextgen:avs:WorkloadNetworkDnsZone',
            resource_name,
            __props__,
            opts)
