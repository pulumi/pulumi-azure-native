...
class Authorization(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs:Authorization"), pulumi.Alias(type_="azure-nextgen:avs/latest:Authorization"), pulumi.Alias(type_="azure-nextgen:avs/v20200320:Authorization"), pulumi.Alias(type_="azure-nextgen:avs/v20210101preview:Authorization")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Authorization, __self__).__init__(
            'azure-nextgen:avs/v20200717preview:Authorization',
            resource_name,
            __props__,
            opts)
