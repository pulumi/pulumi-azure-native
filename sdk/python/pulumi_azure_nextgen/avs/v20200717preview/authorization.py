...
class Authorization(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs:Authorization"), pulumi.Alias(type_="azure-nextgen:avs/latest:Authorization"), pulumi.Alias(type_="azure-nextgen:avs/v20200320:Authorization")])
