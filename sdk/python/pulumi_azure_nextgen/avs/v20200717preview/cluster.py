...
class Cluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs:Cluster"), pulumi.Alias(type_="azure-nextgen:avs/latest:Cluster"), pulumi.Alias(type_="azure-nextgen:avs/v20200320:Cluster")])
