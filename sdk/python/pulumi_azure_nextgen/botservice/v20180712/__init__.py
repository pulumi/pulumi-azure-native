...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:botservice/v20180712:Bot":
                return Bot(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:botservice/v20180712:BotConnection":
                return BotConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:botservice/v20180712:Channel":
                return Channel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:botservice/v20180712:EnterpriseChannel":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "botservice/v20180712", _module_instance)
