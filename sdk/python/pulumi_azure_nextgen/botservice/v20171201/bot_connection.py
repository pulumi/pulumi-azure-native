...
class BotConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice/latest:BotConnection"), pulumi.Alias(type_="azure-nextgen:botservice/v20180712:BotConnection"), pulumi.Alias(type_="azure-nextgen:botservice/v20200602:BotConnection")])
