...
def list_bot_connection_with_secrets(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:botservice/latest:listBotConnectionWithSecrets', __args__, opts=opts, typ=ListBotConnectionWithSecretsResult).value
