...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:search:getService'.""", DeprecationWarning)
...
def get_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:search:getService'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:search/latest:getService', __args__, opts=opts, typ=GetServiceResult).value
