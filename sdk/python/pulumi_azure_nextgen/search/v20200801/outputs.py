...
class SharedPrivateLinkResourceInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: str,
                 type: str,
                 properties: Optional['outputs.SharedPrivateLinkResourcePropertiesInvokeResponseResult'] = None):
        """
        Describes a Shared Private Link Resource managed by the Azure Cognitive Search service.
        :param str id: Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
        :param str name: The name of the resource
        :param str type: The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
        :param 'SharedPrivateLinkResourcePropertiesInvokeResponseArgs' properties: Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional['outputs.SharedPrivateLinkResourcePropertiesInvokeResponseResult']:
        """
