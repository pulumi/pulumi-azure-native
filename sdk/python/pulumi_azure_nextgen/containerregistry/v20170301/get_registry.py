...
class GetRegistryResult:
    ...
    """
    def __init__(__self__, admin_user_enabled=None, creation_date=None, id=None, location=None, login_server=None, name=None, provisioning_state=None, sku=None, storage_account=None, tags=None, type=None):
...
def get_registry(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerregistry/v20170301:getRegistry', __args__, opts=opts, typ=GetRegistryResult).value
