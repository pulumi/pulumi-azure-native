...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerregistry:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20201101preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-nextgen:containerregistry/v20191201preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
