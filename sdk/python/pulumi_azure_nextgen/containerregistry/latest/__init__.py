...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:containerregistry/latest:Registry":
                return Registry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/latest:Replication":
                return Replication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/latest:Task":
                return Task(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/latest:Webhook":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "containerregistry/latest", _module_instance)
