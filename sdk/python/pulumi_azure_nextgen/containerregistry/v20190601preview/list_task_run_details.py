...
def list_task_run_details(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerregistry/v20190601preview:listTaskRunDetails', __args__, opts=opts, typ=ListTaskRunDetailsResult).value
