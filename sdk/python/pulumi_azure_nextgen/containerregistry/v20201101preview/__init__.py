...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:containerregistry/v20201101preview:ConnectedRegistry":
                return ConnectedRegistry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:ExportPipeline":
                return ExportPipeline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:ImportPipeline":
                return ImportPipeline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:PipelineRun":
                return PipelineRun(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:Registry":
                return Registry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:Replication":
                return Replication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:ScopeMap":
                return ScopeMap(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:Token":
                return Token(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:containerregistry/v20201101preview:Webhook":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "containerregistry/v20201101preview", _module_instance)
