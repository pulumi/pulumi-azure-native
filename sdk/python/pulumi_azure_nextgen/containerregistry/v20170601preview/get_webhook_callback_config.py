...
def get_webhook_callback_config(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerregistry/v20170601preview:getWebhookCallbackConfig', __args__, opts=opts, typ=GetWebhookCallbackConfigResult).value
