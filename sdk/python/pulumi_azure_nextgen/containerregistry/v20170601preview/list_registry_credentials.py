...
def list_registry_credentials(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerregistry/v20170601preview:listRegistryCredentials', __args__, opts=opts, typ=ListRegistryCredentialsResult).value
