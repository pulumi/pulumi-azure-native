...
class ScopeMap(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerregistry/v20190501preview:ScopeMap"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20201101preview:ScopeMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScopeMap, __self__).__init__(
            'azure-nextgen:containerregistry:ScopeMap',
            resource_name,
            __props__,
            opts)
