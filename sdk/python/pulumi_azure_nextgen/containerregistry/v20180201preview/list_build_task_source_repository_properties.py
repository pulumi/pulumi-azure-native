...
class ListBuildTaskSourceRepositoryPropertiesResult:
    ...
    def source_control_auth_properties(self) -> Optional['outputs.SourceControlAuthInfoInvokeResponseResult']:
        """
...
def list_build_task_source_repository_properties(build_task_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerregistry/v20180201preview:listBuildTaskSourceRepositoryProperties', __args__, opts=opts, typ=ListBuildTaskSourceRepositoryPropertiesResult).value
