...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:kubernetes:getConnectedCluster'.""", DeprecationWarning)
...
def get_connected_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_connected_cluster is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:kubernetes:getConnectedCluster'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:kubernetes/latest:getConnectedCluster', __args__, opts=opts, typ=GetConnectedClusterResult).value
