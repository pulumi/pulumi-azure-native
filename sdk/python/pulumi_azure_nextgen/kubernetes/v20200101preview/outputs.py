...
__all__ = [
    'ConnectedClusterAADProfileInvokeResponseResult',
    'ConnectedClusterAADProfileResponse',
    'ConnectedClusterIdentityInvokeResponseResult',
    'ConnectedClusterIdentityResponse',
    'CredentialResultInvokeResponseResult',
    'HybridConnectionConfigInvokeResponseResult',
]

@pulumi.output_type
class ConnectedClusterAADProfileInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ConnectedClusterIdentityInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class HybridConnectionConfigInvokeResponseResult(dict):
    """
