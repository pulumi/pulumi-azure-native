...
class GetReferenceDataSetResult:
    ...
    """
    def __init__(__self__, creation_time=None, key_properties=None, location=None, name=None, provisioning_state=None, tags=None, type=None):
...
def get_reference_data_set(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:timeseriesinsights/v20170228preview:getReferenceDataSet', __args__, opts=opts, typ=GetReferenceDataSetResult).value
