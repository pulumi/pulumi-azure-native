...
def get_reference_data_set(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:timeseriesinsights/v20180815preview:getReferenceDataSet', __args__, opts=opts, typ=GetReferenceDataSetResult).value
