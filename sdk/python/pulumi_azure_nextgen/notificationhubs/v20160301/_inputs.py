...
class ApnsCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] apns_certificate: The APNS certificate.
        :param pulumi.Input[str] certificate_key: The certificate key.
        :param pulumi.Input[str] endpoint: The endpoint of this credential.
        :param pulumi.Input[str] thumbprint: The APNS certificate Thumbprint
        """
...
class GcmCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] gcm_endpoint: The GCM endpoint.
