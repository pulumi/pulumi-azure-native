...
__all__ = [
    'AdmCredentialInvokeResponseResult',
    'AdmCredentialResponse',
    'ApnsCredentialInvokeResponseResult',
    'ApnsCredentialResponse',
    'BaiduCredentialInvokeResponseResult',
    'BaiduCredentialResponse',
    'GcmCredentialInvokeResponseResult',
    'GcmCredentialResponse',
    'MpnsCredentialInvokeResponseResult',
    'MpnsCredentialResponse',
    'SharedAccessAuthorizationRulePropertiesInvokeResponseResult',
    'SharedAccessAuthorizationRulePropertiesResponse',
    'SharedAccessAuthorizationRuleResourceInvokeResponseResult',
    'SkuInvokeResponseResult',
    'SkuResponse',
    'WnsCredentialInvokeResponseResult',
    'WnsCredentialResponse',
]

@pulumi.output_type
class AdmCredentialInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ApnsCredentialInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class BaiduCredentialInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class GcmCredentialInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class MpnsCredentialInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class SharedAccessAuthorizationRulePropertiesInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class SharedAccessAuthorizationRuleResourceInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] rights: The rights associated with the rule.
        :param 'SkuInvokeResponseArgs' sku: The sku of the created namespace
...
@pulumi.output_type
class WnsCredentialInvokeResponseResult(dict):
    """
