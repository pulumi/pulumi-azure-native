...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:resources/v20190501:Deployment":
                return Deployment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:resources/v20190501:DeploymentAtManagementGroupScope":
                return DeploymentAtManagementGroupScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:resources/v20190501:DeploymentAtSubscriptionScope":
                return DeploymentAtSubscriptionScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:resources/v20190501:Resource":
                return Resource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:resources/v20190501:ResourceGroup":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "resources/v20190501", _module_instance)
