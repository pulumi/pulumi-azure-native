...
class DeploymentAtScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources:DeploymentAtScope"), pulumi.Alias(type_="azure-nextgen:resources/latest:DeploymentAtScope"), pulumi.Alias(type_="azure-nextgen:resources/v20190701:DeploymentAtScope"), pulumi.Alias(type_="azure-nextgen:resources/v20190801:DeploymentAtScope"), pulumi.Alias(type_="azure-nextgen:resources/v20191001:DeploymentAtScope"), pulumi.Alias(type_="azure-nextgen:resources/v20200601:DeploymentAtScope"), pulumi.Alias(type_="azure-nextgen:resources/v20200801:DeploymentAtScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeploymentAtScope, __self__).__init__(
            'azure-nextgen:resources/v20201001:DeploymentAtScope',
            resource_name,
            __props__,
            opts)
