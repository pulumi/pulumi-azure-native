...
class DeploymentAtSubscriptionScope(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/latest:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20180501:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20190301:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20190501:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20190701:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20190801:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20191001:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20200601:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20200801:DeploymentAtSubscriptionScope"), pulumi.Alias(type_="azure-nextgen:resources/v20201001:DeploymentAtSubscriptionScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeploymentAtSubscriptionScope, __self__).__init__(
            'azure-nextgen:resources/v20190510:DeploymentAtSubscriptionScope',
            resource_name,
            __props__,
            opts)
