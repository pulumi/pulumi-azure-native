...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:resources:getDeploymentAtScope'.""", DeprecationWarning)
...
def get_deployment_at_scope(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_deployment_at_scope is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:resources:getDeploymentAtScope'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:resources/latest:getDeploymentAtScope', __args__, opts=opts, typ=GetDeploymentAtScopeResult).value
