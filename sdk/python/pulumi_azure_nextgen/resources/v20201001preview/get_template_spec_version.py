...
class GetTemplateSpecVersionResult:
    ...
    """
    def __init__(__self__, artifacts=None, description=None, location=None, name=None, system_data=None, tags=None, template=None, type=None, ui_definition=None):
        ...
        if ui_definition and not isinstance(ui_definition, dict):
            raise TypeError("Expected argument 'ui_definition' to be a dict")
...
class AwaitableGetTemplateSpecVersionResult(GetTemplateSpecVersionResult):
    ...
    def __await__(self):
        ...
        return GetTemplateSpecVersionResult(
            ...
            type=self.type,
            ui_definition=self.ui_definition)
...
def get_template_spec_version(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:resources/v20201001preview:getTemplateSpecVersion', __args__, opts=opts, typ=GetTemplateSpecVersionResult).value
    ...
    return AwaitableGetTemplateSpecVersionResult(
        ...
        type=__ret__.type,
        ui_definition=__ret__.ui_definition)
