...
class TemplateSpecVersion(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param Any ui_definition: The Azure Resource Manager template UI definition content
        """
        ...
        if opts.id is None:
            ...
            __props__['ui_definition'] = ui_definition
            __props__['name'] = None
            __props__['system_data'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources/v20190601preview:TemplateSpecVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TemplateSpecVersion, __self__).__init__(
            'azure-nextgen:resources/v20201001preview:TemplateSpecVersion',
            resource_name,
            __props__,
            opts)
    ...
    def ui_definition(self) -> pulumi.Output[Optional[Any]]:
        """
