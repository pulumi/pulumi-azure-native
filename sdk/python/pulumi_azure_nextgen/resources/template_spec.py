...
class TemplateSpec(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources/v20190601preview:TemplateSpec")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TemplateSpec, __self__).__init__(
            'azure-nextgen:resources:TemplateSpec',
            resource_name,
            __props__,
            opts)
