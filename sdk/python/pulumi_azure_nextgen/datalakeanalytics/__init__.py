...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:datalakeanalytics:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datalakeanalytics:ComputePolicy":
                return ComputePolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datalakeanalytics:FirewallRule":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "datalakeanalytics", _module_instance)
