...
class GetAccountResult:
    ...
    def data_lake_store_accounts(self) -> Optional[Sequence['outputs.DataLakeStoreAccountInformationInvokeResponseResult']]:
        """
...
def get_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:datalakeanalytics/v20151001preview:getAccount', __args__, opts=opts, typ=GetAccountResult).value
