...
@pulumi.output_type
class CreatorPropertiesInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class PrivateAtlasPropertiesInvokeResponseResult(dict):
    """
