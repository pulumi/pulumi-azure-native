...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:servicebus/latest:DisasterRecoveryConfig":
                return DisasterRecoveryConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:MigrationConfig":
                return MigrationConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:NamespaceAuthorizationRule":
                return NamespaceAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:NamespaceNetworkRuleSet":
                return NamespaceNetworkRuleSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:Queue":
                return Queue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:QueueAuthorizationRule":
                return QueueAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:Rule":
                return Rule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:Subscription":
                return Subscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:Topic":
                return Topic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:servicebus/latest:TopicAuthorizationRule":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "servicebus/latest", _module_instance)
