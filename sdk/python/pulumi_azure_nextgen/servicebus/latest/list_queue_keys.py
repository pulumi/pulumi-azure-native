...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:servicebus:listQueueKeys'.""", DeprecationWarning)
...
def list_queue_keys(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("list_queue_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:servicebus:listQueueKeys'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:servicebus/latest:listQueueKeys', __args__, opts=opts, typ=ListQueueKeysResult).value
