...
class NamespaceNetworkRuleSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus:NamespaceNetworkRuleSet"), pulumi.Alias(type_="azure-nextgen:servicebus/latest:NamespaceNetworkRuleSet"), pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:NamespaceNetworkRuleSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NamespaceNetworkRuleSet, __self__).__init__(
            'azure-nextgen:servicebus/v20170401:NamespaceNetworkRuleSet',
            resource_name,
            __props__,
            opts)
