...
class NamespaceVirtualNetworkRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus:NamespaceVirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NamespaceVirtualNetworkRule, __self__).__init__(
            'azure-nextgen:servicebus/v20180101preview:NamespaceVirtualNetworkRule',
            resource_name,
            __props__,
            opts)
