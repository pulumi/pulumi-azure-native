...
def list_database_principals(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:kusto/v20170907privatepreview:listDatabasePrincipals', __args__, opts=opts, typ=ListDatabasePrincipalsResult).value
