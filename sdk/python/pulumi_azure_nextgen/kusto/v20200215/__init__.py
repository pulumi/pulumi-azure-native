...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:kusto/v20200215:AttachedDatabaseConfiguration":
                return AttachedDatabaseConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:kusto/v20200215:Cluster":
                return Cluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:kusto/v20200215:ClusterPrincipalAssignment":
                return ClusterPrincipalAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:kusto/v20200215:DataConnection":
                return DataConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:kusto/v20200215:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:kusto/v20200215:DatabasePrincipalAssignment":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "kusto/v20200215", _module_instance)
