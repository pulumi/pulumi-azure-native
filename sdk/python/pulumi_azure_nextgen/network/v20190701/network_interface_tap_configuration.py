...
class NetworkInterfaceTapConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/latest:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20180801:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20181001:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20181101:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20181201:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20190201:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20190401:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20190601:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20190801:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20190901:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20191101:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20191201:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200301:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200401:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200501:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200601:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200701:NetworkInterfaceTapConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200801:NetworkInterfaceTapConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkInterfaceTapConfiguration, __self__).__init__(
            'azure-nextgen:network/v20190701:NetworkInterfaceTapConfiguration',
            resource_name,
            __props__,
            opts)
