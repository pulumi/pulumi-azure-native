...
class ApplicationGatewaySslPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] cipher_suites: Ssl cipher suites to be enabled in the specified order to application gateway.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] disabled_ssl_protocols: Ssl protocols to be disabled on application gateway.
...
class AzureFirewallNatRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] protocols: Array of AzureFirewallNetworkRuleProtocols applicable to this NAT rule.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] source_addresses: List of source IP addresses for this rule.
...
class AzureFirewallNetworkRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] protocols: Array of AzureFirewallNetworkRuleProtocols.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] source_addresses: List of source IP addresses for this rule.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class BackendAddressPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated.
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[str] name: Gets name of the resource that is unique within the set of backend address pools used by the load balancer. This name can be used to access the resource.
...
class ExpressRouteCircuitPeeringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provisioning_state: Gets the provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
        :param pulumi.Input['SubResourceArgs'] route_filter: The reference of the RouteFilter resource.
...
class ExpressRouteCircuitPeeringConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] advertised_public_prefixes_state: The advertised public prefix state of the Peering resource.
...
class FirewallPolicyNatRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] rule_type:  The type of the rule
        :param pulumi.Input['FirewallPolicyNatRuleActionArgs'] action: The action type of a Nat rule, SNAT or DNAT
        :param pulumi.Input[str] name: Name of the Rule
        :param pulumi.Input[int] priority: Priority of the Firewall Policy Rule resource.
...
class FrontendIPConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] private_ip_address_version: It represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.
...
class InboundNatRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[int] idle_timeout_in_minutes: The timeout for the TCP idle connection. The value can be set between 4 and 30 minutes. The default value is 4 minutes. This element is only used when the protocol is set to TCP.
        :param pulumi.Input[str] name: Gets name of the resource that is unique within the set of inbound NAT rules used by the load balancer. This name can be used to access the resource.
...
class NetworkInterfaceIPConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] private_ip_address_version: Available from Api-Version 2016-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.
        :param pulumi.Input[str] private_ip_allocation_method: The private IP address allocation method.
...
class NetworkRuleConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destination_addresses: List of destination IP addresses or Service Tags.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destination_ports: List of destination ports.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ip_protocols: Array of FirewallPolicyRuleConditionNetworkProtocols.
        :param pulumi.Input[str] name: Name of the rule condition.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] source_addresses: List of source IP addresses for this rule.
        """
...
class PrivateEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provisioning_state: The provisioning state of the private endpoint.
...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[str] name: The name of the resource that is unique within a resource group. This name can be used to access the resource.
        :param pulumi.Input['PrivateEndpointArgs'] private_endpoint: The resource of private end point.
        :param pulumi.Input['PrivateLinkServiceConnectionStateArgs'] private_link_service_connection_state: A collection of information about the state of the connection between service consumer and provider.
        :param pulumi.Input[str] provisioning_state: The provisioning state of the private endpoint connection.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
...
class PrivateLinkServiceConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provisioning_state: The provisioning state of the private link service connection.
...
class PrivateLinkServiceIpConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] private_ip_address_version: Available from Api-Version 2016-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.
        :param pulumi.Input[str] private_ip_allocation_method: The private IP address allocation method.
        :param pulumi.Input[str] provisioning_state: The provisioning state of the private link service ip configuration.
        :param pulumi.Input['SubnetArgs'] subnet: The reference of the subnet resource.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class ProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Gets name of the resource that is unique within the set of probes used by the load balancer. This name can be used to access the resource.
...
class ServiceAssociationLinkArgs:
    def __init__(__self__, *,
                 allow_delete: Optional[pulumi.Input[bool]] = None,
                 id: Optional[pulumi.Input[str]] = None,
                 link: Optional[pulumi.Input[str]] = None,
                 linked_resource_type: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[bool] allow_delete: If true, the resource can be deleted.
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[str] link: Link to the external resource.
        :param pulumi.Input[str] linked_resource_type: Resource type of the linked resource.
    ...
    def allow_delete(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    @allow_delete.setter
    def allow_delete(self, value: Optional[pulumi.Input[bool]]):
...
class VpnClientConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] vpn_client_protocols: VpnClientProtocols for Virtual network gateway.
