...
__all__ = [
    ...
    'ApplicationGatewayProbeHealthResponseMatchInvokeArgs',
...
@pulumi.input_type
class ApplicationGatewayProbeHealthResponseMatchInvokeArgs:
    def __init__(__self__, *,
...
class ExpressRouteCircuitPeeringConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'ExpressRouteCircuitPeeringAdvertisedPublicPrefixState']] advertised_public_prefixes_state: The advertised public prefix state of the Peering resource.
...
class FrontendIPConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'IPVersion']] private_ip_address_version: It represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.
