...
class GetFrontDoorResult:
    ...
    def backend_pools_settings(self) -> Optional['outputs.BackendPoolsSettingsInvokeResponseResult']:
        """
    ...
    def rules_engines(self) -> Sequence['outputs.RulesEngineInvokeResponseResult']:
        """
...
def get_front_door(front_door_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20200401:getFrontDoor', __args__, opts=opts, typ=GetFrontDoorResult).value
