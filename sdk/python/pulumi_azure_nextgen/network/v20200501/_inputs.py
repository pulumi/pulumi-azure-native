...
__all__ = [
    ...
    'BastionShareableLinkInvokeArgs',
    'BgpSettingsArgs',
...
@pulumi.input_type
class BastionShareableLinkInvokeArgs:
    def __init__(__self__, *,
                 vm: 'VMInvokeArgs'):
        """
        Bastion Shareable Link.
        :param 'VMInvokeArgs' vm: Reference of the virtual machine resource.
        """
        pulumi.set(__self__, "vm", vm)

    @property
    @pulumi.getter
    def vm(self) -> 'VMInvokeArgs':
        """
    ...
    @vm.setter
    def vm(self, value: 'VMInvokeArgs'):
