...
class GetApplicationGatewayResult:
    ...
    def private_endpoint_connections(self) -> Sequence['outputs.ApplicationGatewayPrivateEndpointConnectionInvokeResponseResult']:
        """
    ...
    def private_link_configurations(self) -> Optional[Sequence['outputs.ApplicationGatewayPrivateLinkConfigurationInvokeResponseResult']]:
        """
...
def get_application_gateway(application_gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20200501:getApplicationGateway', __args__, opts=opts, typ=GetApplicationGatewayResult).value
