...
class VirtualHubIpConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/latest:VirtualHubIpConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200601:VirtualHubIpConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200701:VirtualHubIpConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualHubIpConfiguration, __self__).__init__(
            'azure-nextgen:network/v20200501:VirtualHubIpConfiguration',
            resource_name,
            __props__,
            opts)
