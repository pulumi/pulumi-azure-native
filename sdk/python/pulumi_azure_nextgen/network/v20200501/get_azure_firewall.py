...
class GetAzureFirewallResult:
    ...
    def hub_ip_addresses(self) -> Optional['outputs.HubIPAddressesInvokeResponseResult']:
        """
...
def get_azure_firewall(azure_firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20200501:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult).value
