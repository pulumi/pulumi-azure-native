...
class GetVirtualNetworkGatewayAdvertisedRoutesResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.GatewayRouteInvokeResponseResult']]:
        """
...
def get_virtual_network_gateway_advertised_routes(peer: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20170901:getVirtualNetworkGatewayAdvertisedRoutes', __args__, opts=opts, typ=GetVirtualNetworkGatewayAdvertisedRoutesResult).value
