...
class GetExpressRouteConnectionResult:
    ...
    """
    def __init__(__self__, authorization_key=None, enable_internet_security=None, express_route_circuit_peering=None, id=None, name=None, provisioning_state=None, routing_weight=None):
...
def get_express_route_connection(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20190901:getExpressRouteConnection', __args__, opts=opts, typ=GetExpressRouteConnectionResult).value
