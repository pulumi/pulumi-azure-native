...
class GetNetworkProfileResult:
    ...
    def container_network_interfaces(self) -> Sequence['outputs.ContainerNetworkInterfaceInvokeResponseResult']:
        """
...
def get_network_profile(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20190901:getNetworkProfile', __args__, opts=opts, typ=GetNetworkProfileResult).value
