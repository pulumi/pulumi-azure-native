...
class VirtualNetworkLink(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/latest:VirtualNetworkLink"), pulumi.Alias(type_="azure-nextgen:network/v20180901:VirtualNetworkLink"), pulumi.Alias(type_="azure-nextgen:network/v20200601:VirtualNetworkLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkLink, __self__).__init__(
            'azure-nextgen:network/v20200101:VirtualNetworkLink',
            resource_name,
            __props__,
            opts)
