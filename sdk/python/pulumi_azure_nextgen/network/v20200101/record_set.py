...
class RecordSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/latest:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20180901:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20200601:RecordSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RecordSet, __self__).__init__(
            'azure-nextgen:network/v20200101:RecordSet',
            resource_name,
            __props__,
            opts)
