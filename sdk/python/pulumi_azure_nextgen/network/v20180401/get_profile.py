...
class GetProfileResult:
    ...
    """
    def __init__(__self__, dns_config=None, endpoints=None, location=None, max_return=None, monitor_config=None, name=None, profile_status=None, tags=None, traffic_routing_method=None, traffic_view_enrollment_status=None, type=None):
...
def get_profile(profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20180401:getProfile', __args__, opts=opts, typ=GetProfileResult).value
