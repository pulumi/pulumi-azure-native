...
__all__ = [
    ...
    'EndpointPropertiesInvokeResponseSubnetsResult',
...
class EndpointInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subnets: Optional[Sequence['outputs.EndpointPropertiesInvokeResponseSubnetsResult']] = None,
        ...
        :param Sequence['EndpointPropertiesInvokeResponseSubnetsArgs'] subnets: The list of subnets, IP addresses, and/or address ranges mapped to this endpoint when using the 'Subnet' traffic routing method. An empty list will match all ranges not covered by other endpoints.
...
@pulumi.output_type
class EndpointPropertiesInvokeResponseSubnetsResult(dict):
    """
