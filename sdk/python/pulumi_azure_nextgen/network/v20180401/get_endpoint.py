...
class GetEndpointResult:
    ...
    @property
    @pulumi.getter
    def subnets(self) -> Optional[Sequence['outputs.EndpointPropertiesInvokeResponseSubnetsResult']]:
        """
...
def get_endpoint(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20180401:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
