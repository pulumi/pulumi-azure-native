...
class GetVirtualNetworkResult:
    ...
    """
    def __init__(__self__, address_space=None, dhcp_options=None, etag=None, id=None, location=None, name=None, provisioning_state=None, resource_guid=None, subnets=None, tags=None, type=None):
...
def get_virtual_network(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20160330:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
