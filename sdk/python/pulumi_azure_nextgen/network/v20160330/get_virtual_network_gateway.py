...
class GetVirtualNetworkGatewayResult:
    ...
    """
    def __init__(__self__, bgp_settings=None, enable_bgp=None, etag=None, gateway_default_site=None, gateway_type=None, ip_configurations=None, location=None, name=None, provisioning_state=None, resource_guid=None, sku=None, tags=None, type=None, vpn_client_configuration=None, vpn_type=None):
