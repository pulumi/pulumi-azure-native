...
def get_network_virtual_appliance(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20191201:getNetworkVirtualAppliance', __args__, opts=opts, typ=GetNetworkVirtualApplianceResult).value
