...
class TrafficManagerUserMetricsKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/latest:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-nextgen:network/v20180401:TrafficManagerUserMetricsKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TrafficManagerUserMetricsKey, __self__).__init__(
            'azure-nextgen:network:TrafficManagerUserMetricsKey',
            resource_name,
            __props__,
            opts)
