...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:network/v20180501:RecordSet":
                return RecordSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:network/v20180501:Zone":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "network/v20180501", _module_instance)
