...
class GetPublicIPPrefixResult:
    ...
    def public_ip_addresses(self) -> Optional[Sequence['outputs.ReferencedPublicIpAddressInvokeResponseResult']]:
        """
...
def get_public_ip_prefix(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20181001:getPublicIPPrefix', __args__, opts=opts, typ=GetPublicIPPrefixResult).value
