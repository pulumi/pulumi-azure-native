...
class GetNetworkVirtualApplianceResult:
    ...
    def inbound_security_rules(self) -> Sequence['outputs.SubResourceInvokeResponseResult']:
        """
    ...
    def nva_sku(self) -> Optional['outputs.VirtualApplianceSkuPropertiesInvokeResponseResult']:
        """
    ...
    def virtual_appliance_sites(self) -> Sequence['outputs.SubResourceInvokeResponseResult']:
        """
...
def get_network_virtual_appliance(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20200801:getNetworkVirtualAppliance', __args__, opts=opts, typ=GetNetworkVirtualApplianceResult).value
