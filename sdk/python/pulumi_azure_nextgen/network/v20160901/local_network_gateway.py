...
class LocalNetworkGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['id'] = id
            if local_network_address_space is None:
    ...
    def local_network_address_space(self) -> pulumi.Output['outputs.AddressSpaceResponse']:
        """
