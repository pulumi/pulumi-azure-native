...
class GetLocalNetworkGatewayResult:
    ...
    def local_network_address_space(self) -> 'outputs.AddressSpaceInvokeResponseResult':
        """
...
def get_local_network_gateway(local_network_gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20160901:getLocalNetworkGateway', __args__, opts=opts, typ=GetLocalNetworkGatewayResult).value
