...
class GetNetworkSecurityGroupResult:
    ...
    def flow_logs(self) -> Sequence['outputs.FlowLogInvokeResponseResult']:
        """
...
def get_network_security_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20200301:getNetworkSecurityGroup', __args__, opts=opts, typ=GetNetworkSecurityGroupResult).value
