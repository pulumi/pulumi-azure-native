...
class DdosCustomPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/latest:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20181101:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20181201:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20190201:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20190401:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20190601:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20190701:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20190901:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20191101:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20191201:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20200301:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20200401:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20200501:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20200601:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20200701:DdosCustomPolicy"), pulumi.Alias(type_="azure-nextgen:network/v20200801:DdosCustomPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DdosCustomPolicy, __self__).__init__(
            'azure-nextgen:network/v20190801:DdosCustomPolicy',
            resource_name,
            __props__,
            opts)
