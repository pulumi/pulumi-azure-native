...
class ManagedRuleOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] state: Describes the state of the managed rule. Defaults to Disabled if not specified.
        """
...
class P2SConnectionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[str] name: The name of the resource that is unique within a resource group. This name can be used to access the resource.
        :param pulumi.Input[str] provisioning_state: The provisioning state of the P2SConnectionConfiguration resource.
...
class PolicySettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] state: Describes if the policy is in enabled state or disabled state.
        """
        if file_upload_limit_in_mb is not None:
            pulumi.set(__self__, "file_upload_limit_in_mb", file_upload_limit_in_mb)
        if max_request_body_size_in_kb is not None:
