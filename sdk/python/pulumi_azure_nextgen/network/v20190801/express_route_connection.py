...
class ExpressRouteConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] provisioning_state: The provisioning state of the express route connection resource.
        ...
        super(ExpressRouteConnection, __self__).__init__(
            'azure-nextgen:network/v20190801:ExpressRouteConnection',
            resource_name,
            __props__,
            opts)
