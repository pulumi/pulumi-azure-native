...
class GetNetworkSecurityGroupResult:
    ...
    def default_security_rules(self) -> Optional[Sequence['outputs.SecurityRuleInvokeResponseResult']]:
        """
...
def get_network_security_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20180701:getNetworkSecurityGroup', __args__, opts=opts, typ=GetNetworkSecurityGroupResult).value
