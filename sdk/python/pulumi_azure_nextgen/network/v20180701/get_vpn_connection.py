...
class GetVpnConnectionResult:
    ...
    """
    def __init__(__self__, connection_bandwidth_in_mbps=None, connection_status=None, egress_bytes_transferred=None, enable_bgp=None, etag=None, id=None, ingress_bytes_transferred=None, ipsec_policies=None, name=None, provisioning_state=None, remote_vpn_site=None, routing_weight=None, shared_key=None):
...
def get_vpn_connection(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20180701:getVpnConnection', __args__, opts=opts, typ=GetVpnConnectionResult).value
