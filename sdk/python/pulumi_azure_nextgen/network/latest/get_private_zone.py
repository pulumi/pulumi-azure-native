...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:network:getPrivateZone'.""", DeprecationWarning)
...
def get_private_zone(private_zone_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_private_zone is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:network:getPrivateZone'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/latest:getPrivateZone', __args__, opts=opts, typ=GetPrivateZoneResult).value
