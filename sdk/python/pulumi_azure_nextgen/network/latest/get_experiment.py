...
class GetExperimentResult:
    ...
    def endpoint_a(self) -> Optional['outputs.EndpointInvokeResponseResult']:
        """
    ...
    def endpoint_b(self) -> Optional['outputs.EndpointInvokeResponseResult']:
        """
...
def get_experiment(experiment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/latest:getExperiment', __args__, opts=opts, typ=GetExperimentResult).value
