...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:network:ExpressRouteCircuitAuthorization'.""", DeprecationWarning)
...
class ExpressRouteCircuitAuthorization(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(ExpressRouteCircuitAuthorization, __self__).__init__(
            'azure-nextgen:network/latest:ExpressRouteCircuitAuthorization',
            resource_name,
            __props__,
            opts)
