...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:network:getNatGateway'.""", DeprecationWarning)
...
def get_nat_gateway(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_nat_gateway is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:network:getNatGateway'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/latest:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult).value
