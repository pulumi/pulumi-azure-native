...
class GetExpressRouteConnectionResult:
    ...
    """
    def __init__(__self__, authorization_key=None, enable_internet_security=None, express_route_circuit_peering=None, express_route_gateway_bypass=None, name=None, provisioning_state=None, routing_configuration=None, routing_weight=None):
