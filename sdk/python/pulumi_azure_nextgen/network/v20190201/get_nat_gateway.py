...
class GetNatGatewayResult:
    ...
    """
    def __init__(__self__, etag=None, id=None, idle_timeout_in_minutes=None, location=None, name=None, provisioning_state=None, public_ip_addresses=None, public_ip_prefixes=None, resource_guid=None, sku=None, subnets=None, tags=None, type=None):
...
def get_nat_gateway(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20190201:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult).value
