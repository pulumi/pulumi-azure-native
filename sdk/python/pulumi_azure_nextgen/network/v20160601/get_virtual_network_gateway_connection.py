...
class GetVirtualNetworkGatewayConnectionResult:
    ...
    def virtual_network_gateway1(self) -> Optional['outputs.VirtualNetworkGatewayInvokeResponseResult']:
        """
        A common class for general resource information
        """
...
def get_virtual_network_gateway_connection(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20160601:getVirtualNetworkGatewayConnection', __args__, opts=opts, typ=GetVirtualNetworkGatewayConnectionResult).value
