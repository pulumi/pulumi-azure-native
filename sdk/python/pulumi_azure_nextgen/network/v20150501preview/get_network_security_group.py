...
class GetNetworkSecurityGroupResult:
    ...
    def network_interfaces(self) -> Optional[Sequence['outputs.SubResourceInvokeResponseResult']]:
        """
    ...
    @property
    @pulumi.getter
    def subnets(self) -> Optional[Sequence['outputs.SubResourceInvokeResponseResult']]:
        """
...
def get_network_security_group(network_security_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20150501preview:getNetworkSecurityGroup', __args__, opts=opts, typ=GetNetworkSecurityGroupResult).value
