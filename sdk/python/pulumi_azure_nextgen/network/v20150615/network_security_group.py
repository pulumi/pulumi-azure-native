...
class NetworkSecurityGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkInterfaceArgs']]]] network_interfaces: A collection of references to network interfaces.
