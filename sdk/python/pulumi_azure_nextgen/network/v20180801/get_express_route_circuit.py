...
class GetExpressRouteCircuitResult:
    ...
    """
    def __init__(__self__, allow_classic_operations=None, allow_global_reach=None, authorizations=None, bandwidth_in_gbps=None, circuit_provisioning_state=None, etag=None, express_route_port=None, gateway_manager_etag=None, id=None, location=None, name=None, peerings=None, provisioning_state=None, service_key=None, service_provider_notes=None, service_provider_properties=None, service_provider_provisioning_state=None, sku=None, stag=None, tags=None, type=None):
        ...
        if allow_global_reach and not isinstance(allow_global_reach, bool):
            raise TypeError("Expected argument 'allow_global_reach' to be a bool")
        pulumi.set(__self__, "allow_global_reach", allow_global_reach)
...
class AwaitableGetExpressRouteCircuitResult(GetExpressRouteCircuitResult):
    ...
    def __await__(self):
        ...
        return GetExpressRouteCircuitResult(
            ...
            allow_global_reach=self.allow_global_reach,
...
def get_express_route_circuit(circuit_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20180801:getExpressRouteCircuit', __args__, opts=opts, typ=GetExpressRouteCircuitResult).value

    return AwaitableGetExpressRouteCircuitResult(
        allow_classic_operations=__ret__.allow_classic_operations,
        allow_global_reach=__ret__.allow_global_reach,
