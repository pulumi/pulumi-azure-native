...
class VirtualNetworkLink(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network:VirtualNetworkLink"), pulumi.Alias(type_="azure-nextgen:network/latest:VirtualNetworkLink"), pulumi.Alias(type_="azure-nextgen:network/v20180901:VirtualNetworkLink"), pulumi.Alias(type_="azure-nextgen:network/v20200101:VirtualNetworkLink")])
