...
class GetActiveSessionsResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.BastionActiveSessionInvokeResponseResult']]:
        """
...
def get_active_sessions(bastion_host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20200601:getActiveSessions', __args__, opts=opts, typ=GetActiveSessionsResult).value
