...
class GetRouteFilterResult:
    ...
    def ipv6_peerings(self) -> Sequence['outputs.ExpressRouteCircuitPeeringInvokeResponseResult']:
        """
...
def get_route_filter(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20200601:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult).value
