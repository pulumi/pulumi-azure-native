...
class GetBastionShareableLinkResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.BastionShareableLinkInvokeResponseResult']]:
        """
...
def get_bastion_shareable_link(bastion_host_name: Optional[str] = None,
                               ...
                               vms: Optional[Sequence[pulumi.InputType['BastionShareableLinkInvokeArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['BastionShareableLinkInvokeArgs']] vms: List of VM references.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:network/v20200601:getBastionShareableLink', __args__, opts=opts, typ=GetBastionShareableLinkResult).value
