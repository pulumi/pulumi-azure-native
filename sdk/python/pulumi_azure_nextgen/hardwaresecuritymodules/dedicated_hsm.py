...
class DedicatedHsm(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hardwaresecuritymodules/v20181031preview:DedicatedHsm")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DedicatedHsm, __self__).__init__(
            'azure-nextgen:hardwaresecuritymodules:DedicatedHsm',
            resource_name,
            __props__,
            opts)
