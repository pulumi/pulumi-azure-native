...
class TransactionNode(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:blockchain/v20180601preview:TransactionNode")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TransactionNode, __self__).__init__(
            'azure-nextgen:blockchain:TransactionNode',
            resource_name,
            __props__,
            opts)
