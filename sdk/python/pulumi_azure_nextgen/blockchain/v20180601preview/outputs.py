...
__all__ = [
    'ApiKeyInvokeResponseResult',
    'BlockchainMemberNodesSkuInvokeResponseResult',
    'BlockchainMemberNodesSkuResponse',
    'ConsortiumInvokeResponseResult',
...
@pulumi.output_type
class ApiKeyInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class BlockchainMemberNodesSkuInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ConsortiumInvokeResponseResult(dict):
    """
    Consortium payload
    """
    def __init__(__self__, *,
