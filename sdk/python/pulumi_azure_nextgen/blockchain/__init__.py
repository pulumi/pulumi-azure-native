...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:blockchain:BlockchainMember":
                return BlockchainMember(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:blockchain:TransactionNode":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "blockchain", _module_instance)
