...
class GetVirtualMachineScaleSetVMResult:
    ...
    def network_profile_configuration(self) -> Optional['outputs.VirtualMachineScaleSetVMNetworkProfileConfigurationInvokeResponseResult']:
        """
    ...
    def protection_policy(self) -> Optional['outputs.VirtualMachineScaleSetVMProtectionPolicyInvokeResponseResult']:
        """
...
def get_virtual_machine_scale_set_vm(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/v20190701:getVirtualMachineScaleSetVM', __args__, opts=opts, typ=GetVirtualMachineScaleSetVMResult).value
