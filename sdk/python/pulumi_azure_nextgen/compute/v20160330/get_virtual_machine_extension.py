...
def get_virtual_machine_extension(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/v20160330:getVirtualMachineExtension', __args__, opts=opts, typ=GetVirtualMachineExtensionResult).value
