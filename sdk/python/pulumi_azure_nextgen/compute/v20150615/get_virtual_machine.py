...
class GetVirtualMachineResult:
    ...
    """
    def __init__(__self__, availability_set=None, diagnostics_profile=None, hardware_profile=None, id=None, instance_view=None, license_type=None, location=None, name=None, network_profile=None, os_profile=None, plan=None, provisioning_state=None, resources=None, storage_profile=None, tags=None, type=None):
    ...
    def instance_view(self) -> 'outputs.VirtualMachineInstanceViewInvokeResponseResult':
        """
...
def get_virtual_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/v20150615:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult).value
