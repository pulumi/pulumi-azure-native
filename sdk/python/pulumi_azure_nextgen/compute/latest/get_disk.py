...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:compute:getDisk'.""", DeprecationWarning)
...
def get_disk(disk_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_disk is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:compute:getDisk'.")
    __args__ = dict()
