...
class GetDiskEncryptionSetResult:
    ...
    def active_key(self) -> Optional['outputs.KeyForDiskEncryptionSetInvokeResponseResult']:
        """
    ...
    def previous_keys(self) -> Sequence['outputs.KeyForDiskEncryptionSetInvokeResponseResult']:
        """
...
def get_disk_encryption_set(disk_encryption_set_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/latest:getDiskEncryptionSet', __args__, opts=opts, typ=GetDiskEncryptionSetResult).value
