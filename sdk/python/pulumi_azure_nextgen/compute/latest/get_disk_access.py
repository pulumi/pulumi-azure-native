...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:compute:getDiskAccess'.""", DeprecationWarning)
...
def get_disk_access(disk_access_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_disk_access is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:compute:getDiskAccess'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/latest:getDiskAccess', __args__, opts=opts, typ=GetDiskAccessResult).value
