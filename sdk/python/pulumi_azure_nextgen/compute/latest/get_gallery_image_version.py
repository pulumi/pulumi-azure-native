...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:compute:getGalleryImageVersion'.""", DeprecationWarning)
...
def get_gallery_image_version(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_gallery_image_version is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:compute:getGalleryImageVersion'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/latest:getGalleryImageVersion', __args__, opts=opts, typ=GetGalleryImageVersionResult).value
