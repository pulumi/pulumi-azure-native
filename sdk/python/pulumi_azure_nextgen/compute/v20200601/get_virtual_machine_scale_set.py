...
class GetVirtualMachineScaleSetResult:
    ...
    def host_group(self) -> Optional['outputs.SubResourceInvokeResponseResult']:
        """
...
def get_virtual_machine_scale_set(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/v20200601:getVirtualMachineScaleSet', __args__, opts=opts, typ=GetVirtualMachineScaleSetResult).value
