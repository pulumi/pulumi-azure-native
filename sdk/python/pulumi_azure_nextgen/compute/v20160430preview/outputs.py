...
class ImageStorageProfileInvokeResponseResult(dict):
    ...
    """
    def __init__(__self__, *,
                 os_disk: 'outputs.ImageOSDiskInvokeResponseResult',
    ...
    def os_disk(self) -> 'outputs.ImageOSDiskInvokeResponseResult':
        """
...
class VirtualMachineScaleSetIPConfigurationInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['SubResourceInvokeResponseArgs'] application_gateway_backend_address_pools: The application gateway backend address pools.
        :param str id: Resource Id
...
class VirtualMachineScaleSetStorageProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a virtual machine scale set storage profile.
        :param Sequence['VirtualMachineScaleSetDataDiskInvokeResponseArgs'] data_disks: The data disks.
