...
class GetVirtualMachineResult:
    ...
    @property
    @pulumi.getter
    def identity(self) -> Optional['outputs.VirtualMachineIdentityInvokeResponseResult']:
        """
...
def get_virtual_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/v20160430preview:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult).value
