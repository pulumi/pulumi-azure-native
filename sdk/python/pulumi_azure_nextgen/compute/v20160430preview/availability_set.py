...
class AvailabilitySet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[bool] managed: If the availability set supports managed disks.
