...
class GetVirtualMachineScaleSetResult:
    ...
    """
    def __init__(__self__, identity=None, location=None, name=None, over_provision=None, plan=None, provisioning_state=None, single_placement_group=None, sku=None, tags=None, type=None, upgrade_policy=None, virtual_machine_profile=None):
...
def get_virtual_machine_scale_set(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/v20160430preview:getVirtualMachineScaleSet', __args__, opts=opts, typ=GetVirtualMachineScaleSetResult).value
