...
class DiskAccess(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute:DiskAccess"), pulumi.Alias(type_="azure-nextgen:compute/latest:DiskAccess"), pulumi.Alias(type_="azure-nextgen:compute/v20200501:DiskAccess"), pulumi.Alias(type_="azure-nextgen:compute/v20200630:DiskAccess")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiskAccess, __self__).__init__(
            'azure-nextgen:compute/v20200930:DiskAccess',
            resource_name,
            __props__,
            opts)
