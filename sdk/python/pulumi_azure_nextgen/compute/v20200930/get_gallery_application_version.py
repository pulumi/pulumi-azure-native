...
def get_gallery_application_version(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:compute/v20200930:getGalleryApplicationVersion', __args__, opts=opts, typ=GetGalleryApplicationVersionResult).value
