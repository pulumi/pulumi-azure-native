...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:compute/v20200930:Disk":
                return Disk(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:DiskAccess":
                return DiskAccess(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:DiskAccessAPrivateEndpointConnection":
                return DiskAccessAPrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:DiskEncryptionSet":
                return DiskEncryptionSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:Gallery":
                return Gallery(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:GalleryApplication":
                return GalleryApplication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:GalleryApplicationVersion":
                return GalleryApplicationVersion(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:GalleryImage":
                return GalleryImage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:GalleryImageVersion":
                return GalleryImageVersion(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20200930:Snapshot":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "compute/v20200930", _module_instance)
