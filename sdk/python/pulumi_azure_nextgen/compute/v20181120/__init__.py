...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:compute/v20181120:GuestConfigurationAssignment":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "compute/v20181120", _module_instance)
