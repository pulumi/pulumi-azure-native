...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:compute/v20191101:Disk":
                return Disk(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20191101:DiskEncryptionSet":
                return DiskEncryptionSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:compute/v20191101:Snapshot":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "compute/v20191101", _module_instance)
