...
class Extension(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:visualstudio:Extension"), pulumi.Alias(type_="azure-nextgen:visualstudio/v20171101preview:Extension")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Extension, __self__).__init__(
            'azure-nextgen:visualstudio/v20140401preview:Extension',
            resource_name,
            __props__,
            opts)
