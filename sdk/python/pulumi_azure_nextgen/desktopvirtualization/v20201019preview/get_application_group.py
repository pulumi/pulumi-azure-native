...
def get_application_group(application_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:desktopvirtualization/v20201019preview:getApplicationGroup', __args__, opts=opts, typ=GetApplicationGroupResult).value
