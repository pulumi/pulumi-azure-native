...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:desktopvirtualization/v20201019preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult).value
