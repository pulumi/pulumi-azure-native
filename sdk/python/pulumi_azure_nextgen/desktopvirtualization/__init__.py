...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:desktopvirtualization:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:desktopvirtualization:ApplicationGroup":
                return ApplicationGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:desktopvirtualization:HostPool":
                return HostPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:desktopvirtualization:MSIXPackage":
                return MSIXPackage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:desktopvirtualization:ScalingPlan":
                return ScalingPlan(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:desktopvirtualization:Workspace":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "desktopvirtualization", _module_instance)
