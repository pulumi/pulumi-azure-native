...
class ObjectAnchorsAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:mixedreality/v20210301preview:ObjectAnchorsAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ObjectAnchorsAccount, __self__).__init__(
            'azure-nextgen:mixedreality:ObjectAnchorsAccount',
            resource_name,
            __props__,
            opts)
