...
class RemoteRenderingAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:mixedreality:RemoteRenderingAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/latest:RemoteRenderingAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20191202preview:RemoteRenderingAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20200406preview:RemoteRenderingAccount")])
