...
def list_spatial_anchors_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:mixedreality/v20210301preview:listSpatialAnchorsAccountKeys', __args__, opts=opts, typ=ListSpatialAnchorsAccountKeysResult).value
