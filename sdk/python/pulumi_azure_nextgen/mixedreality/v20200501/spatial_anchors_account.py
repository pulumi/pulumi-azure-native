...
class SpatialAnchorsAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:mixedreality:SpatialAnchorsAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/latest:SpatialAnchorsAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20190228preview:SpatialAnchorsAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20191202preview:SpatialAnchorsAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20210101:SpatialAnchorsAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20210301preview:SpatialAnchorsAccount")])
