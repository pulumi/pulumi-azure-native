...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:offazure:getHyperVSite'.""", DeprecationWarning)
...
def get_hyper_v_site(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_hyper_v_site is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:offazure:getHyperVSite'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:offazure/latest:getHyperVSite', __args__, opts=opts, typ=GetHyperVSiteResult).value
