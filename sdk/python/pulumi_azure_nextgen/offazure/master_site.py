...
class MasterSite(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:offazure/latest:MasterSite"), pulumi.Alias(type_="azure-nextgen:offazure/v20200707:MasterSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MasterSite, __self__).__init__(
            'azure-nextgen:offazure:MasterSite',
            resource_name,
            __props__,
            opts)
