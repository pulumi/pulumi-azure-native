...
class IoMAMPolicyByName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:intune:IoMAMPolicyByName"), pulumi.Alias(type_="azure-nextgen:intune/v20150114preview:IoMAMPolicyByName")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IoMAMPolicyByName, __self__).__init__(
            'azure-nextgen:intune/v20150114privatepreview:IoMAMPolicyByName',
            resource_name,
            __props__,
            opts)
