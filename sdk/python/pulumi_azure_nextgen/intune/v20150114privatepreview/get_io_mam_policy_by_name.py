...
def get_io_mam_policy_by_name(host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:intune/v20150114privatepreview:getIoMAMPolicyByName', __args__, opts=opts, typ=GetIoMAMPolicyByNameResult).value
