...
def get_integration_runtime(factory_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:datafactory/v20170901preview:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult).value
