...
class Dataset(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory:Dataset"), pulumi.Alias(type_="azure-nextgen:datafactory/latest:Dataset"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:Dataset")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dataset, __self__).__init__(
            'azure-nextgen:datafactory/v20170901preview:Dataset',
            resource_name,
            __props__,
            opts)
