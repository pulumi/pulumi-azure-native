...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:datafactory:getFactory'.""", DeprecationWarning)
...
def get_factory(factory_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_factory is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:datafactory:getFactory'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:datafactory/latest:getFactory', __args__, opts=opts, typ=GetFactoryResult).value
