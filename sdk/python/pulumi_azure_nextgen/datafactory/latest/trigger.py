...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:datafactory:Trigger'.""", DeprecationWarning)
...
class Trigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory:Trigger"), pulumi.Alias(type_="azure-nextgen:datafactory/v20170901preview:Trigger"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:Trigger")])
