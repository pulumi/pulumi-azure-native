...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:datafactory:LinkedService'.""", DeprecationWarning)
...
class LinkedService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory:LinkedService"), pulumi.Alias(type_="azure-nextgen:datafactory/v20170901preview:LinkedService"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:LinkedService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LinkedService, __self__).__init__(
            'azure-nextgen:datafactory/latest:LinkedService',
            resource_name,
            __props__,
            opts)
