...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:datafactory:Factory'.""", DeprecationWarning)
...
class Factory(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory:Factory"), pulumi.Alias(type_="azure-nextgen:datafactory/v20170901preview:Factory"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:Factory")])
