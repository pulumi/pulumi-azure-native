...
__all__ = [
    'EventGridInvokeResponseResult',
    'EventGridResponse',
    'EventHubInvokeResponseResult',
    'EventHubResponse',
    'ServiceBusInvokeResponseResult',
    'ServiceBusResponse',
]

@pulumi.output_type
class EventGridInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class EventHubInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ServiceBusInvokeResponseResult(dict):
    """
