...
class GetRelationshipLinkResult:
    ...
    def profile_property_references(self) -> Sequence['outputs.ParticipantPropertyReferenceInvokeResponseResult']:
        """
    ...
    def related_profile_property_references(self) -> Sequence['outputs.ParticipantPropertyReferenceInvokeResponseResult']:
        """
...
def get_relationship_link(hub_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:customerinsights/v20170101:getRelationshipLink', __args__, opts=opts, typ=GetRelationshipLinkResult).value
