...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:customerinsights:getImageUploadUrlForData'.""", DeprecationWarning)
...
def get_image_upload_url_for_data(entity_type: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_image_upload_url_for_data is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:customerinsights:getImageUploadUrlForData'.")
    __args__ = dict()
