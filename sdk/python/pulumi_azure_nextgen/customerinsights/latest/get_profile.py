...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:customerinsights:getProfile'.""", DeprecationWarning)
...
def get_profile(hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_profile is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:customerinsights:getProfile'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:customerinsights/latest:getProfile', __args__, opts=opts, typ=GetProfileResult).value
