...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:customerinsights:Hub'.""", DeprecationWarning)
...
class Hub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights:Hub"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Hub"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Hub")])
