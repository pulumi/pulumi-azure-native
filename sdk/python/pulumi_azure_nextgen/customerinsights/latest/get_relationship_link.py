...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:customerinsights:getRelationshipLink'.""", DeprecationWarning)
...
def get_relationship_link(hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_relationship_link is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:customerinsights:getRelationshipLink'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:customerinsights/latest:getRelationshipLink', __args__, opts=opts, typ=GetRelationshipLinkResult).value
