...
class Relationship(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights:Relationship"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Relationship"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Relationship")])
