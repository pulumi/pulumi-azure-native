...
def get_prediction_training_results(hub_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:customerinsights:getPredictionTrainingResults', __args__, opts=opts, typ=GetPredictionTrainingResultsResult).value
