...
class Certificate(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/latest:Certificate"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:Certificate"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:Certificate"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:Certificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'azure-nextgen:appplatform:Certificate',
            resource_name,
            __props__,
            opts)
