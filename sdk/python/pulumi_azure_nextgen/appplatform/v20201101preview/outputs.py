...
__all__ = [
    ...
    'RequiredTrafficInvokeResponseResult',
...
class NetworkProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 required_traffics: Sequence['outputs.RequiredTrafficInvokeResponseResult'],
        ...
        :param Sequence['RequiredTrafficInvokeResponseArgs'] required_traffics: Required inbound or outbound traffics for Azure Spring Cloud instance.
    ...
    def required_traffics(self) -> Sequence['outputs.RequiredTrafficInvokeResponseResult']:
        """
...
@pulumi.output_type
class RequiredTrafficInvokeResponseResult(dict):
    """
