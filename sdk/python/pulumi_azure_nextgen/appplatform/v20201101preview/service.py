...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform:Service"), pulumi.Alias(type_="azure-nextgen:appplatform/latest:Service"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:Service"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-nextgen:appplatform/v20201101preview:Service',
            resource_name,
            __props__,
            opts)
