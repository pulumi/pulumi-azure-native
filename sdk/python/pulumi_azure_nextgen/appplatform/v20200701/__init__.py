...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:appplatform/v20200701:App":
                return App(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20200701:Binding":
                return Binding(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20200701:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20200701:CustomDomain":
                return CustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20200701:Deployment":
                return Deployment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20200701:Service":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "appplatform/v20200701", _module_instance)
