...
class CustomDomain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/latest:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:CustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomDomain, __self__).__init__(
            'azure-nextgen:appplatform/v20200701:CustomDomain',
            resource_name,
            __props__,
            opts)
