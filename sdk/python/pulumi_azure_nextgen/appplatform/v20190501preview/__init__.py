...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:appplatform/v20190501preview:App":
                return App(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20190501preview:Binding":
                return Binding(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20190501preview:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20190501preview:CustomDomain":
                return CustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20190501preview:Deployment":
                return Deployment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:appplatform/v20190501preview:Service":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "appplatform/v20190501preview", _module_instance)
