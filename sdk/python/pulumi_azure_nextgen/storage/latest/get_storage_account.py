...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:storage:getStorageAccount'.""", DeprecationWarning)
...
def get_storage_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_storage_account is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:storage:getStorageAccount'.")
    __args__ = dict()
