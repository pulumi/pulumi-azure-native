...
class GetBlobServicePropertiesResult:
    ...
    """
    def __init__(__self__, cors=None, default_service_version=None, delete_retention_policy=None, name=None, type=None):
...
def get_blob_service_properties(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:storage/v20180701:getBlobServiceProperties', __args__, opts=opts, typ=GetBlobServicePropertiesResult).value
