...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:storage/v20210101:BlobContainer":
                return BlobContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:BlobContainerImmutabilityPolicy":
                return BlobContainerImmutabilityPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:BlobInventoryPolicy":
                return BlobInventoryPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:BlobServiceProperties":
                return BlobServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:FileServiceProperties":
                return FileServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:FileShare":
                return FileShare(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:ManagementPolicy":
                return ManagementPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:ObjectReplicationPolicy":
                return ObjectReplicationPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:Queue":
                return Queue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:QueueServiceProperties":
                return QueueServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:StorageAccount":
                return StorageAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:Table":
                return Table(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storage/v20210101:TableServiceProperties":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "storage/v20210101", _module_instance)
