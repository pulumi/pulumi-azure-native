...
class GetFileServicePropertiesResult:
    ...
    def protocol_settings(self) -> Optional['outputs.ProtocolSettingsInvokeResponseResult']:
        """
...
def get_file_service_properties(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:storage/v20200801preview:getFileServiceProperties', __args__, opts=opts, typ=GetFileServicePropertiesResult).value
