...
class StorageAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] account_type: Gets or sets the account type.
