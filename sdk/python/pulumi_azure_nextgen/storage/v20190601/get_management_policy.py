...
class GetManagementPolicyResult:
    ...
    @property
    @pulumi.getter
    def policy(self) -> 'outputs.ManagementPolicySchemaInvokeResponseResult':
        """
...
def get_management_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:storage/v20190601:getManagementPolicy', __args__, opts=opts, typ=GetManagementPolicyResult).value
