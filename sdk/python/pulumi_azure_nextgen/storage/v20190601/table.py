...
class Table(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage:Table"), pulumi.Alias(type_="azure-nextgen:storage/latest:Table"), pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:Table"), pulumi.Alias(type_="azure-nextgen:storage/v20210101:Table")])
