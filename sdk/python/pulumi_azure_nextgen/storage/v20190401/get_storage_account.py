...
def get_storage_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:storage/v20190401:getStorageAccount', __args__, opts=opts, typ=GetStorageAccountResult).value
