...
class Getbot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:healthbot/v20201020:getbot"), pulumi.Alias(type_="azure-nextgen:healthbot/v20201020preview:getbot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Getbot, __self__).__init__(
            'azure-nextgen:healthbot/latest:getbot',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Getbot':
        """
        ...
        return Getbot(resource_name, opts=opts, __props__=__props__)
