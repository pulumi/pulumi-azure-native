...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:healthbot:getBot'.""", DeprecationWarning)
...
def get_bot(bot_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_bot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:healthbot:getBot'.")
    __args__ = dict()
