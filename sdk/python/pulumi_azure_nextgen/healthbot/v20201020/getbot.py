...
class Getbot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:healthbot/latest:getbot"), pulumi.Alias(type_="azure-nextgen:healthbot/v20201020preview:getbot"), pulumi.Alias(type_="azure-nextgen:healthbot/v20201208:getbot"), pulumi.Alias(type_="azure-nextgen:healthbot/v20201208preview:getbot")])
