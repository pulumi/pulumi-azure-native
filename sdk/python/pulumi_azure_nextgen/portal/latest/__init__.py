...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:portal/latest:Console":
                return Console(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:portal/latest:ConsoleWithLocation":
                return ConsoleWithLocation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:portal/latest:UserSettings":
                return UserSettings(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:portal/latest:UserSettingsWithLocation":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "portal/latest", _module_instance)
