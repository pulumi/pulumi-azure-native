...
class ConsoleWithLocation(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:portal:ConsoleWithLocation"), pulumi.Alias(type_="azure-nextgen:portal/latest:ConsoleWithLocation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConsoleWithLocation, __self__).__init__(
            'azure-nextgen:portal/v20181001:ConsoleWithLocation',
            resource_name,
            __props__,
            opts)
