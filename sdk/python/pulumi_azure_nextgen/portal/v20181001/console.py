...
class Console(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:portal:Console"), pulumi.Alias(type_="azure-nextgen:portal/latest:Console")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Console, __self__).__init__(
            'azure-nextgen:portal/v20181001:Console',
            resource_name,
            __props__,
            opts)
