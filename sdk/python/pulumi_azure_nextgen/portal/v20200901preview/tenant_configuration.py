...
class TenantConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:portal:TenantConfiguration"), pulumi.Alias(type_="azure-nextgen:portal/v20190101preview:TenantConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TenantConfiguration, __self__).__init__(
            'azure-nextgen:portal/v20200901preview:TenantConfiguration',
            resource_name,
            __props__,
            opts)
