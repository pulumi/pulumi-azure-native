...
class ListBitLockerKeyResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.DriveBitLockerKeyInvokeResponseResult']]:
        """
        drive status
        """
...
def list_bit_locker_key(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:importexport/v20161101:listBitLockerKey', __args__, opts=opts, typ=ListBitLockerKeyResult).value
