...
__all__ = [
    ...
    'JobDetailsResponse',
    'PackageInformationInvokeResponseResult',
...
class JobDetailsInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 return_package: Optional['outputs.PackageInformationInvokeResponseResult'] = None,
        ...
        :param 'PackageInformationInvokeResponseArgs' return_package: Contains information about the package being shipped from the Microsoft data center to the customer to return the drives. The format is the same as the deliveryPackage property above. This property is not included if the drives have not yet been returned. 
    ...
    def return_package(self) -> Optional['outputs.PackageInformationInvokeResponseResult']:
        """
...
@pulumi.output_type
class PackageInformationInvokeResponseResult(dict):
    """
    Contains information about the package being shipped by the customer to the Microsoft data center.
    """
    def __init__(__self__, *,
