...
__all__ = [
    'ClusterNodeInvokeResponseResult',
    'ClusterNodeResponse',
    'ClusterReportedPropertiesInvokeResponseResult',
    'ClusterReportedPropertiesResponse',
]

@pulumi.output_type
class ClusterNodeInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ClusterReportedPropertiesInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 cluster_version: str,
                 last_updated: str,
                 nodes: Sequence['outputs.ClusterNodeInvokeResponseResult']):
        """
        Properties reported by cluster agent.
        ...
        :param Sequence['ClusterNodeInvokeResponseArgs'] nodes: List of nodes reported by the cluster.
        """
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Sequence['outputs.ClusterNodeInvokeResponseResult']:
        """
