...
class Cluster(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azurestackhci:Cluster"), pulumi.Alias(type_="azure-nextgen:azurestackhci/latest:Cluster"), pulumi.Alias(type_="azure-nextgen:azurestackhci/v20201001:Cluster")])
