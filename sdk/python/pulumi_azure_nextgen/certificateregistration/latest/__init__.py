...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:certificateregistration/latest:AppServiceCertificateOrder":
                return AppServiceCertificateOrder(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:certificateregistration/latest:AppServiceCertificateOrderCertificate":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "certificateregistration/latest", _module_instance)
