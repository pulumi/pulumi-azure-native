...
class Python2Package(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/latest:Python2Package"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Python2Package"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Python2Package")])
