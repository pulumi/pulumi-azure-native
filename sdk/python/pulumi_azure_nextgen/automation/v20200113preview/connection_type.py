...
class ConnectionType(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/latest:ConnectionType"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:ConnectionType"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:ConnectionType")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectionType, __self__).__init__(
            'azure-nextgen:automation/v20200113preview:ConnectionType',
            resource_name,
            __props__,
            opts)
