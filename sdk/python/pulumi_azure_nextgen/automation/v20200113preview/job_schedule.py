...
class JobSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/latest:JobSchedule"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:JobSchedule"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:JobSchedule")])
