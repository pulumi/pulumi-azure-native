...
class Variable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation:Variable"), pulumi.Alias(type_="azure-nextgen:automation/latest:Variable"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Variable"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Variable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Variable, __self__).__init__(
            'azure-nextgen:automation/v20200113preview:Variable',
            resource_name,
            __props__,
            opts)
