...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:automation:getPython2Package'.""", DeprecationWarning)
...
def get_python2_package(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_python2_package is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:automation:getPython2Package'.")
    __args__ = dict()
