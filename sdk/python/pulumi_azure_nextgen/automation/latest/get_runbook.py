...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:automation:getRunbook'.""", DeprecationWarning)
...
def get_runbook(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_runbook is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:automation:getRunbook'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:automation/latest:getRunbook', __args__, opts=opts, typ=GetRunbookResult).value
