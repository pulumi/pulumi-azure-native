...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:automation/latest:AutomationAccount":
                return AutomationAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:Connection":
                return Connection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:ConnectionType":
                return ConnectionType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:Credential":
                return Credential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:DscConfiguration":
                return DscConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:DscNodeConfiguration":
                return DscNodeConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:JobSchedule":
                return JobSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:Module":
                return Module(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:Python2Package":
                return Python2Package(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automation/latest:Runbook":
            ...
            elif typ == "azure-nextgen:automation/latest:Webhook":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "automation/latest", _module_instance)
