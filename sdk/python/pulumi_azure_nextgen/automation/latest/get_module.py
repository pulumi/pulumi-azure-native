...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:automation:getModule'.""", DeprecationWarning)
...
def get_module(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_module is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:automation:getModule'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:automation/latest:getModule', __args__, opts=opts, typ=GetModuleResult).value
