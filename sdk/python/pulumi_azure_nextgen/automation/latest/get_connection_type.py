...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:automation:getConnectionType'.""", DeprecationWarning)
...
def get_connection_type(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_connection_type is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:automation:getConnectionType'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:automation/latest:getConnectionType', __args__, opts=opts, typ=GetConnectionTypeResult).value
