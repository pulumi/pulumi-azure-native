...
class Credential(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation:Credential"), pulumi.Alias(type_="azure-nextgen:automation/latest:Credential"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Credential"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Credential")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Credential, __self__).__init__(
            'azure-nextgen:automation/v20151031:Credential',
            resource_name,
            __props__,
            opts)
