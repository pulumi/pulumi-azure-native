...
class Runbook(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation:Runbook"), pulumi.Alias(type_="azure-nextgen:automation/latest:Runbook"), pulumi.Alias(type_="azure-nextgen:automation/v20180630:Runbook"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Runbook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Runbook, __self__).__init__(
            'azure-nextgen:automation/v20151031:Runbook',
            resource_name,
            __props__,
            opts)
