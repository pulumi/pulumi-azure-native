...
class DscConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation:DscConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/latest:DscConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:DscConfiguration")])
