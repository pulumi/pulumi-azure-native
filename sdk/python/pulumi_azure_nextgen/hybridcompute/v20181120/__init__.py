...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:hybridcompute/v20181120:GuestConfigurationHCRPAssignment":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "hybridcompute/v20181120", _module_instance)
