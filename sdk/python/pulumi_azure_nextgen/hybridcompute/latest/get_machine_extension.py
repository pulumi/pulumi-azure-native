...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:hybridcompute:getMachineExtension'.""", DeprecationWarning)
...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_machine_extension is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:hybridcompute:getMachineExtension'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:hybridcompute/latest:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
