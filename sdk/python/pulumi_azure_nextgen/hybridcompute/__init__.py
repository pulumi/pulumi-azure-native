...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:hybridcompute:Machine":
                return Machine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:hybridcompute:MachineExtension":
                return MachineExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:hybridcompute:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:hybridcompute:PrivateLinkScope":
                return PrivateLinkScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:hybridcompute:PrivateLinkScopedResource":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "hybridcompute", _module_instance)
