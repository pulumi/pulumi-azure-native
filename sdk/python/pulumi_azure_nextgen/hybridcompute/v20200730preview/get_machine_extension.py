...
class GetMachineExtensionResult:
    ...
    def instance_view(self) -> Optional['outputs.MachineExtensionPropertiesInvokeResponseInstanceViewResult']:
        """
...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:hybridcompute/v20200730preview:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
