...
class GetMachineExtensionResult:
    ...
    """
    def __init__(__self__, auto_upgrade_minor_version=None, force_update_tag=None, id=None, instance_view=None, location=None, name=None, principal_id=None, protected_settings=None, provisioning_state=None, publisher=None, settings=None, tags=None, tenant_id=None, type=None, type_handler_version=None):
    ...
    def instance_view(self) -> Optional['outputs.MachineExtensionInstanceViewInvokeResponseResult']:
        """
...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:hybridcompute/v20190802preview:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
