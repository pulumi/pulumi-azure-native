...
def get_management_configuration(management_configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:operationsmanagement:getManagementConfiguration', __args__, opts=opts, typ=GetManagementConfigurationResult).value
