...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:dbformysql/latest:Configuration":
                return Configuration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:dbformysql/latest:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:dbformysql/latest:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:dbformysql/latest:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:dbformysql/latest:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:dbformysql/latest:ServerAdministrator":
                return ServerAdministrator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:dbformysql/latest:ServerKey":
                return ServerKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:dbformysql/latest:VirtualNetworkRule":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "dbformysql/latest", _module_instance)
