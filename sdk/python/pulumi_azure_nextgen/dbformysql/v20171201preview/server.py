...
class Server(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql:Server"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:Server"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:Server")])
