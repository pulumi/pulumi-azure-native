...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-nextgen:dbformysql/v20171201preview:FirewallRule',
            resource_name,
            __props__,
            opts)
