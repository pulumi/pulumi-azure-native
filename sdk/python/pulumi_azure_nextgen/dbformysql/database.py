...
class Database(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/latest:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:Database")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Database, __self__).__init__(
            'azure-nextgen:dbformysql:Database',
            resource_name,
            __props__,
            opts)
