...
def get_linked_subscription(linked_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:azurestack/v20200601preview:getLinkedSubscription', __args__, opts=opts, typ=GetLinkedSubscriptionResult).value
