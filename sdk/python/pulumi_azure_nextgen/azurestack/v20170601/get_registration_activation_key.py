...
def get_registration_activation_key(registration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:azurestack/v20170601:getRegistrationActivationKey', __args__, opts=opts, typ=GetRegistrationActivationKeyResult).value
