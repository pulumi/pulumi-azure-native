...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:azurestack/latest:CustomerSubscription":
                return CustomerSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:azurestack/latest:Registration":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "azurestack/latest", _module_instance)
