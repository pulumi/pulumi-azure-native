...
class ListShareSynchronizationsResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Sequence['outputs.ShareSynchronizationInvokeResponseResult']:
        """
...
def list_share_synchronizations(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:datashare/v20181101preview:listShareSynchronizations', __args__, opts=opts, typ=ListShareSynchronizationsResult).value
