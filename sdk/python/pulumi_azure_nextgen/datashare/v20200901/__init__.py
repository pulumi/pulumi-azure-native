...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:datashare/v20200901:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datashare/v20200901:DataSet":
                return DataSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datashare/v20200901:DataSetMapping":
                return DataSetMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datashare/v20200901:Invitation":
                return Invitation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datashare/v20200901:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datashare/v20200901:ShareSubscription":
                return ShareSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datashare/v20200901:SynchronizationSetting":
                return SynchronizationSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:datashare/v20200901:Trigger":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "datashare/v20200901", _module_instance)
