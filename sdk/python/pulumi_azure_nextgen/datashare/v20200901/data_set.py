...
class DataSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/latest:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:DataSet")])
