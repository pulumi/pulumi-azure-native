...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:datashare:getTrigger'.""", DeprecationWarning)
...
def get_trigger(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_trigger is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:datashare:getTrigger'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:datashare/latest:getTrigger', __args__, opts=opts, typ=GetTriggerResult).value
