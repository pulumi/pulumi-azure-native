...
class Trigger(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/latest:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:Trigger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Trigger, __self__).__init__(
            'azure-nextgen:datashare/v20201001preview:Trigger',
            resource_name,
            __props__,
            opts)
