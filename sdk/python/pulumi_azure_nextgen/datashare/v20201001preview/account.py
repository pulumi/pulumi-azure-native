...
class Account(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/latest:Account"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:Account"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:Account"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:Account")])
