...
def get_synchronization_setting(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:datashare/v20201001preview:getSynchronizationSetting', __args__, opts=opts, typ=GetSynchronizationSettingResult).value
