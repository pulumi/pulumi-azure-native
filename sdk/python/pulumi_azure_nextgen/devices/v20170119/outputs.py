...
__all__ = [
    ...
    'OperationsMonitoringPropertiesInvokeResponseResult',
...
class IotHubPropertiesInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operations_monitoring_properties: Optional['outputs.OperationsMonitoringPropertiesInvokeResponseResult'] = None,
    ...
    def operations_monitoring_properties(self) -> Optional['outputs.OperationsMonitoringPropertiesInvokeResponseResult']:
        """
...
@pulumi.output_type
class OperationsMonitoringPropertiesInvokeResponseResult(dict):
    """
    The operations monitoring properties for the IoT hub. The possible keys to the dictionary are Connections, DeviceTelemetry, C2DCommands, DeviceIdentityOperations, FileUploadOperations, Routes, D2CTwinOperations, C2DTwinOperations, TwinQueries, JobsOperations, DirectMethods.
    """
    def __init__(__self__, *,
