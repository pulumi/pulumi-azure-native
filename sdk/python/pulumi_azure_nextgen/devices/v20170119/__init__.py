...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:devices/v20170119:IotHubResource":
                return IotHubResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:devices/v20170119:IotHubResourceEventHubConsumerGroup":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "devices/v20170119", _module_instance)
