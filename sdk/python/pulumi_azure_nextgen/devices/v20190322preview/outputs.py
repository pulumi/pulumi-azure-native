...
class RoutingPropertiesInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['EnrichmentPropertiesInvokeResponseArgs'] enrichments: The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/iotmsgenrich
