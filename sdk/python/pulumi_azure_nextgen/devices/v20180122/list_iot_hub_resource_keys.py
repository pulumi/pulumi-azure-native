...
class ListIotHubResourceKeysResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.SharedAccessSignatureAuthorizationRuleInvokeResponseResult']]:
        """
...
def list_iot_hub_resource_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:devices/v20180122:listIotHubResourceKeys', __args__, opts=opts, typ=ListIotHubResourceKeysResult).value
