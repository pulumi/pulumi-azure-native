...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:devices/v20200831preview:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:devices/v20200831preview:IotHubResource":
                return IotHubResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:devices/v20200831preview:IotHubResourceEventHubConsumerGroup":
                return IotHubResourceEventHubConsumerGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:devices/v20200831preview:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "devices/v20200831preview", _module_instance)
