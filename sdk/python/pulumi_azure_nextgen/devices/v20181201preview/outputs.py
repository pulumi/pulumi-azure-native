...
class IotHubPropertiesInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 locations: Optional[Sequence['outputs.IotHubLocationDescriptionInvokeResponseResult']] = None,
    ...
    @property
    @pulumi.getter
    def locations(self) -> Optional[Sequence['outputs.IotHubLocationDescriptionInvokeResponseResult']]:
        """
