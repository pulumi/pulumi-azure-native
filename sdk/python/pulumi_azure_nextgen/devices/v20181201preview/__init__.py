...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:devices/v20181201preview:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:devices/v20181201preview:IotHubResource":
                return IotHubResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:devices/v20181201preview:IotHubResourceEventHubConsumerGroup":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "devices/v20181201preview", _module_instance)
