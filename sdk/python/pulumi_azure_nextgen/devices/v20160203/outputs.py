...
class IotHubPropertiesInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'OperationsMonitoringPropertiesInvokeResponseArgs' operations_monitoring_properties: The operations monitoring properties for the IoT hub. The possible keys to the dictionary are Connections, DeviceTelemetry, C2DCommands, DeviceIdentityOperations, FileUploadOperations.
