...
def get_open_shift_cluster(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:redhatopenshift/v20210131preview:getOpenShiftCluster', __args__, opts=opts, typ=GetOpenShiftClusterResult).value
