...
class GetDataSourceResult:
    ...
    """
    def __init__(__self__, e_tag=None, kind=None, name=None, properties=None, tags=None, type=None):
...
def get_data_source(data_source_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:operationalinsights/v20151101preview:getDataSource', __args__, opts=opts, typ=GetDataSourceResult).value
