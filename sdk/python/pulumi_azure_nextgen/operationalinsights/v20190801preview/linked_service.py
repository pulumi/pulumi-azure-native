...
class LinkedService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationalinsights:LinkedService"), pulumi.Alias(type_="azure-nextgen:operationalinsights/latest:LinkedService"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20151101preview:LinkedService"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200301preview:LinkedService"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200801:LinkedService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LinkedService, __self__).__init__(
            'azure-nextgen:operationalinsights/v20190801preview:LinkedService',
            resource_name,
            __props__,
            opts)
