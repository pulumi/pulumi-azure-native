...
class GetWorkspaceResult:
    ...
    """
    def __init__(__self__, customer_id=None, e_tag=None, force_query_cmk=None, location=None, name=None, private_link_scoped_resources=None, provisioning_state=None, public_network_access_for_ingestion=None, public_network_access_for_query=None, retention_in_days=None, sku=None, tags=None, type=None, workspace_capping=None):
        ...
        if force_query_cmk and not isinstance(force_query_cmk, bool):
            raise TypeError("Expected argument 'force_query_cmk' to be a bool")
        pulumi.set(__self__, "force_query_cmk", force_query_cmk)
    ...
    def force_query_cmk(self) -> Optional[bool]:
        """
...
class AwaitableGetWorkspaceResult(GetWorkspaceResult):
    ...
    def __await__(self):
        ...
        return GetWorkspaceResult(
            ...
            e_tag=self.e_tag,
            force_query_cmk=self.force_query_cmk,
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:operationalinsights/v20201001:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value

    return AwaitableGetWorkspaceResult(
        customer_id=__ret__.customer_id,
        e_tag=__ret__.e_tag,
        force_query_cmk=__ret__.force_query_cmk,
