...
def get_storage_insight(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:operationalinsights/v20150320:getStorageInsight', __args__, opts=opts, typ=GetStorageInsightResult).value
