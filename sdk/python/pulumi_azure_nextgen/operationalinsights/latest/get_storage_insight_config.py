...
def get_storage_insight_config(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:operationalinsights/latest:getStorageInsightConfig', __args__, opts=opts, typ=GetStorageInsightConfigResult).value
