...
def get_operationalization_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:machinelearningcompute/v20170801preview:getOperationalizationCluster', __args__, opts=opts, typ=GetOperationalizationClusterResult).value
