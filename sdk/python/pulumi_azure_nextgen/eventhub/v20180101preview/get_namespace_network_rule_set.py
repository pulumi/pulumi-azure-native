...
class GetNamespaceNetworkRuleSetResult:
    ...
    """
    def __init__(__self__, default_action=None, ip_rules=None, name=None, type=None):
...
def get_namespace_network_rule_set(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:eventhub/v20180101preview:getNamespaceNetworkRuleSet', __args__, opts=opts, typ=GetNamespaceNetworkRuleSetResult).value
