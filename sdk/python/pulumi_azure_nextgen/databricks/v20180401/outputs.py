...
__all__ = [
    ...
    'CreatedByInvokeResponseResult',
    'CreatedByResponse',
    'EncryptionInvokeResponseResult',
    'EncryptionResponse',
    'ManagedIdentityConfigurationInvokeResponseResult',
    'ManagedIdentityConfigurationResponse',
    'SkuInvokeResponseResult',
    'SkuResponse',
    'VirtualNetworkPeeringPropertiesFormatInvokeResponseDatabricksVirtualNetworkResult',
    'VirtualNetworkPeeringPropertiesFormatInvokeResponseRemoteVirtualNetworkResult',
    ...
    'WorkspaceCustomBooleanParameterInvokeResponseResult',
    'WorkspaceCustomBooleanParameterResponse',
    'WorkspaceCustomParametersInvokeResponseResult',
    'WorkspaceCustomParametersResponse',
    'WorkspaceCustomStringParameterInvokeResponseResult',
    'WorkspaceCustomStringParameterResponse',
    'WorkspaceEncryptionParameterInvokeResponseResult',
    'WorkspaceEncryptionParameterResponse',
    'WorkspaceProviderAuthorizationInvokeResponseResult',
...
@pulumi.output_type
class CreatedByInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ManagedIdentityConfigurationInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class VirtualNetworkPeeringPropertiesFormatInvokeResponseDatabricksVirtualNetworkResult(dict):
    """
...
@pulumi.output_type
class VirtualNetworkPeeringPropertiesFormatInvokeResponseRemoteVirtualNetworkResult(dict):
    """
     The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class WorkspaceCustomBooleanParameterInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class WorkspaceCustomParametersInvokeResponseResult(dict):
    """
    Custom Parameters used for Cluster Creation.
    """
    def __init__(__self__, *,
                 aml_workspace_id: Optional['outputs.WorkspaceCustomStringParameterInvokeResponseResult'] = None,
                 custom_private_subnet_name: Optional['outputs.WorkspaceCustomStringParameterInvokeResponseResult'] = None,
                 custom_public_subnet_name: Optional['outputs.WorkspaceCustomStringParameterInvokeResponseResult'] = None,
                 custom_virtual_network_id: Optional['outputs.WorkspaceCustomStringParameterInvokeResponseResult'] = None,
                 enable_no_public_ip: Optional['outputs.WorkspaceCustomBooleanParameterInvokeResponseResult'] = None,
                 encryption: Optional['outputs.WorkspaceEncryptionParameterInvokeResponseResult'] = None,
                 prepare_encryption: Optional['outputs.WorkspaceCustomBooleanParameterInvokeResponseResult'] = None,
                 require_infrastructure_encryption: Optional['outputs.WorkspaceCustomBooleanParameterInvokeResponseResult'] = None):
        """
        Custom Parameters used for Cluster Creation.
        :param 'WorkspaceCustomStringParameterInvokeResponseArgs' aml_workspace_id: The ID of a Azure Machine Learning workspace to link with Databricks workspace
        :param 'WorkspaceCustomStringParameterInvokeResponseArgs' custom_private_subnet_name: The name of the Private Subnet within the Virtual Network
        :param 'WorkspaceCustomStringParameterInvokeResponseArgs' custom_public_subnet_name: The name of a Public Subnet within the Virtual Network
        :param 'WorkspaceCustomStringParameterInvokeResponseArgs' custom_virtual_network_id: The ID of a Virtual Network where this Databricks Cluster should be created
        :param 'WorkspaceCustomBooleanParameterInvokeResponseArgs' enable_no_public_ip: Should the Public IP be Disabled?
        :param 'WorkspaceEncryptionParameterInvokeResponseArgs' encryption: Contains the encryption details for Customer-Managed Key (CMK) enabled workspace.
        :param 'WorkspaceCustomBooleanParameterInvokeResponseArgs' prepare_encryption: Prepare the workspace for encryption. Enables the Managed Identity for managed storage account.
        :param 'WorkspaceCustomBooleanParameterInvokeResponseArgs' require_infrastructure_encryption: A boolean indicating whether or not the DBFS root file system will be enabled with secondary layer of encryption with platform managed keys for data at rest.
        """
    ...
    def aml_workspace_id(self) -> Optional['outputs.WorkspaceCustomStringParameterInvokeResponseResult']:
        """
    ...
    def custom_private_subnet_name(self) -> Optional['outputs.WorkspaceCustomStringParameterInvokeResponseResult']:
        """
    ...
    def custom_public_subnet_name(self) -> Optional['outputs.WorkspaceCustomStringParameterInvokeResponseResult']:
        """
    ...
    def custom_virtual_network_id(self) -> Optional['outputs.WorkspaceCustomStringParameterInvokeResponseResult']:
        """
    ...
    def enable_no_public_ip(self) -> Optional['outputs.WorkspaceCustomBooleanParameterInvokeResponseResult']:
        """
    ...
    @property
    @pulumi.getter
    def encryption(self) -> Optional['outputs.WorkspaceEncryptionParameterInvokeResponseResult']:
        """
    ...
    def prepare_encryption(self) -> Optional['outputs.WorkspaceCustomBooleanParameterInvokeResponseResult']:
        """
    ...
    def require_infrastructure_encryption(self) -> Optional['outputs.WorkspaceCustomBooleanParameterInvokeResponseResult']:
        """
...
@pulumi.output_type
class WorkspaceCustomStringParameterInvokeResponseResult(dict):
    """
    The Value.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class WorkspaceEncryptionParameterInvokeResponseResult(dict):
    """
    The object that contains details of encryption used on the workspace.
    """
    def __init__(__self__, *,
                 type: str,
                 value: Optional['outputs.EncryptionInvokeResponseResult'] = None):
        """
        The object that contains details of encryption used on the workspace.
        :param str type: The type of variable that this is
        :param 'EncryptionInvokeResponseArgs' value: The value which should be used for this field.
        """
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional['outputs.EncryptionInvokeResponseResult']:
        """
        The value which should be used for this field.
        """
        return pulumi.get(self, "value")
...
@pulumi.output_type
class WorkspaceProviderAuthorizationInvokeResponseResult(dict):
    """
