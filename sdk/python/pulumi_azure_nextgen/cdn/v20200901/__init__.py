...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:cdn/v20200901:AFDCustomDomain":
                return AFDCustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:AFDEndpoint":
                return AFDEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:AFDOrigin":
                return AFDOrigin(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:AFDOriginGroup":
                return AFDOriginGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:CustomDomain":
                return CustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:Endpoint":
                return Endpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:Origin":
                return Origin(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:OriginGroup":
                return OriginGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:Policy":
                return Policy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:Profile":
                return Profile(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:Route":
                return Route(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:Rule":
                return Rule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:RuleSet":
                return RuleSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:Secret":
                return Secret(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200901:SecurityPolicy":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "cdn/v20200901", _module_instance)
