...
class GetCustomDomainResult:
    ...
    """
    def __init__(__self__, custom_https_provisioning_state=None, custom_https_provisioning_substate=None, host_name=None, id=None, name=None, provisioning_state=None, resource_state=None, type=None, validation_data=None):
...
def get_custom_domain(custom_domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:cdn/v20200331:getCustomDomain', __args__, opts=opts, typ=GetCustomDomainResult).value
