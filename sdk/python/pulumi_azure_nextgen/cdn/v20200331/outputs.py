...
class DeliveryRuleInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A rule that specifies a set of actions and conditions
        :param Sequence[Union['DeliveryRuleCacheExpirationActionInvokeResponseArgs', 'DeliveryRuleCacheKeyQueryStringActionInvokeResponseArgs', 'DeliveryRuleRequestHeaderActionInvokeResponseArgs', 'DeliveryRuleResponseHeaderActionInvokeResponseArgs', 'UrlRedirectActionInvokeResponseArgs', 'UrlRewriteActionInvokeResponseArgs', 'UrlSigningActionInvokeResponseArgs']] actions: A list of actions that are executed when all the conditions of a rule are satisfied.
