...
class OriginGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/latest:OriginGroup"), pulumi.Alias(type_="azure-nextgen:cdn/v20200331:OriginGroup"), pulumi.Alias(type_="azure-nextgen:cdn/v20200415:OriginGroup")])
