...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:cdn/v20191231:CustomDomain":
                return CustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20191231:Endpoint":
                return Endpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20191231:Origin":
                return Origin(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20191231:OriginGroup":
                return OriginGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20191231:Profile":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "cdn/v20191231", _module_instance)
