...
class OriginGroupOverrideActionParametersInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the parameters for the Origin Group override action.
        :param 'ResourceReferenceInvokeResponseArgs' origin_group: A reference to the origin group from where the content will be fetched from when CDN does not have it
        """
        pulumi.set(__self__, "odata_type", odata_type)
