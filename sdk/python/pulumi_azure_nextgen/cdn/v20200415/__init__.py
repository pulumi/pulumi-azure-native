...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:cdn/v20200415:CustomDomain":
                return CustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200415:Endpoint":
                return Endpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200415:Origin":
                return Origin(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200415:OriginGroup":
                return OriginGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200415:Policy":
                return Policy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cdn/v20200415:Profile":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "cdn/v20200415", _module_instance)
