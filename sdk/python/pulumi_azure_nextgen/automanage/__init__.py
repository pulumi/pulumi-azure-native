...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:automanage:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automanage:ConfigurationProfileAssignment":
                return ConfigurationProfileAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:automanage:ConfigurationProfilePreference":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "automanage", _module_instance)
