...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:blueprint:Artifact":
                return Artifact(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:blueprint:Assignment":
                return Assignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:blueprint:Blueprint":
                return Blueprint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:blueprint:PublishedBlueprint":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "blueprint", _module_instance)
