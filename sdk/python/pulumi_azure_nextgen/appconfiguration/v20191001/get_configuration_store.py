...
class GetConfigurationStoreResult:
    ...
    """
    def __init__(__self__, creation_date=None, endpoint=None, id=None, identity=None, location=None, name=None, provisioning_state=None, sku=None, tags=None, type=None):
...
def get_configuration_store(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:appconfiguration/v20191001:getConfigurationStore', __args__, opts=opts, typ=GetConfigurationStoreResult).value
