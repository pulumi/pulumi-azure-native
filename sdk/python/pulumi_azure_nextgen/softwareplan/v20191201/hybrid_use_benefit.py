...
class HybridUseBenefit(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:softwareplan/latest:HybridUseBenefit"), pulumi.Alias(type_="azure-nextgen:softwareplan/v20190601preview:HybridUseBenefit")])
