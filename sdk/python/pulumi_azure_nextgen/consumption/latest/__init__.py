...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:consumption/latest:Budget":
                return Budget(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:consumption/latest:BudgetByResourceGroupName":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "consumption/latest", _module_instance)
