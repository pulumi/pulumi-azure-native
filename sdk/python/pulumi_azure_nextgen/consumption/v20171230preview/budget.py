...
class Budget(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:consumption/v20180131:Budget"), pulumi.Alias(type_="azure-nextgen:consumption/v20180331:Budget"), pulumi.Alias(type_="azure-nextgen:consumption/v20180630:Budget"), pulumi.Alias(type_="azure-nextgen:consumption/v20180831:Budget"), pulumi.Alias(type_="azure-nextgen:consumption/v20181001:Budget")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Budget, __self__).__init__(
            'azure-nextgen:consumption/v20171230preview:Budget',
            resource_name,
            __props__,
            opts)
