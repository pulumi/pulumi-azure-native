...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cache:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:cache/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:cache/v20210301:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-nextgen:cache/v20201001preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
