...
class RedisEnterprise(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cache:RedisEnterprise"), pulumi.Alias(type_="azure-nextgen:cache/latest:RedisEnterprise"), pulumi.Alias(type_="azure-nextgen:cache/v20201001preview:RedisEnterprise")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RedisEnterprise, __self__).__init__(
            'azure-nextgen:cache/v20210301:RedisEnterprise',
            resource_name,
            __props__,
            opts)
