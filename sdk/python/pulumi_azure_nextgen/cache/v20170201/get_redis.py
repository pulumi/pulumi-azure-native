...
class GetRedisResult:
    ...
    def linked_servers(self) -> 'outputs.RedisLinkedServerListInvokeResponseResult':
        """
...
def get_redis(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:cache/v20170201:getRedis', __args__, opts=opts, typ=GetRedisResult).value
