...
__all__ = [
    ...
    'RedisLinkedServerListInvokeResponseResult',
...
@pulumi.output_type
class RedisLinkedServerListInvokeResponseResult(dict):
    """
    List of linked server Ids of a Redis cache.
    """
    def __init__(__self__, *,
                 value: Sequence['outputs.RedisLinkedServerInvokeResponseResult']):
        """
        List of linked server Ids of a Redis cache.
        :param Sequence['RedisLinkedServerInvokeResponseArgs'] value: List of linked server Ids of a Redis cache.
        """
        pulumi.set(__self__, "value", value)

    @property
    @pulumi.getter
    def value(self) -> Sequence['outputs.RedisLinkedServerInvokeResponseResult']:
        """
        List of linked server Ids of a Redis cache.
        """
