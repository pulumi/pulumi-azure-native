...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "azure-nextgen:cache/latest:PatchSchedule":
                return PatchSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:cache/latest:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "cache/latest", _module_instance)
