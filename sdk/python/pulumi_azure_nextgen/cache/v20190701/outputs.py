...
__all__ = [
    ...
    'RedisInstanceDetailsInvokeResponseResult',
    'RedisInstanceDetailsResponse',
    'RedisLinkedServerInvokeResponseResult',
...
@pulumi.output_type
class RedisInstanceDetailsInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class RedisLinkedServerInvokeResponseResult(dict):
    """
    Linked server Id
    """
    def __init__(__self__, *,
