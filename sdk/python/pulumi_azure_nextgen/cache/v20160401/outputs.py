...
__all__ = [
    'RedisAccessKeysInvokeResponseResult',
    'RedisAccessKeysResponse',
    'ScheduleEntryInvokeResponseResult',
...
@pulumi.output_type
class RedisAccessKeysInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ScheduleEntryInvokeResponseResult(dict):
    """
