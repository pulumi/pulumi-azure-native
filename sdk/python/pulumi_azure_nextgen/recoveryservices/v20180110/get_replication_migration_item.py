...
def get_replication_migration_item(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:recoveryservices/v20180110:getReplicationMigrationItem', __args__, opts=opts, typ=GetReplicationMigrationItemResult).value
