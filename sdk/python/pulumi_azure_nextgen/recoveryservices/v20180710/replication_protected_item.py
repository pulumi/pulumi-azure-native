...
class ReplicationProtectedItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationProtectedItem")])
