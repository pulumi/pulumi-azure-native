...
class ProtectionIntent(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20170701:ProtectionIntent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProtectionIntent, __self__).__init__(
            'azure-nextgen:recoveryservices/v20210201:ProtectionIntent',
            resource_name,
            __props__,
            opts)
