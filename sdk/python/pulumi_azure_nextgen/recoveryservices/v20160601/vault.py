...
class Vault(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices:Vault"), pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:Vault"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20200202:Vault")])
