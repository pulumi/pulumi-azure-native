...
def get_replication_protected_item(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:recoveryservices:getReplicationProtectedItem', __args__, opts=opts, typ=GetReplicationProtectedItemResult).value
