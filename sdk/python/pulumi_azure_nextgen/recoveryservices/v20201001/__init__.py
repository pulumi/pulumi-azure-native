...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:recoveryservices/v20201001:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:recoveryservices/v20201001:ProtectedItem":
                return ProtectedItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:recoveryservices/v20201001:ProtectionContainer":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "recoveryservices/v20201001", _module_instance)
