...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20200202:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20201201:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210101:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210201:PrivateEndpointConnection")])
