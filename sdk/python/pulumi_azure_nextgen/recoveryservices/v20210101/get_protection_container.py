...
def get_protection_container(container_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:recoveryservices/v20210101:getProtectionContainer', __args__, opts=opts, typ=GetProtectionContainerResult).value
