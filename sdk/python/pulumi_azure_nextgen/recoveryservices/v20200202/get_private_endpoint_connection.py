...
class GetPrivateEndpointConnectionResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.PrivateEndpointConnectionInvokeResponseResult':
        """
...
def get_private_endpoint_connection(private_endpoint_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:recoveryservices/v20200202:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
