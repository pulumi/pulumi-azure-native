...
def get_order_collection_by_name(order_collection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:edgeorder/v20201201preview:getOrderCollectionByName', __args__, opts=opts, typ=GetOrderCollectionByNameResult).value
