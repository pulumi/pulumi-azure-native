...
class ListProductFamiliesResult:
    ...
    @property
    @pulumi.getter
    def value(self) -> Sequence['outputs.ProductFamilyInvokeResponseResult']:
        """
...
def list_product_families(customer_subscription_details: Optional[pulumi.InputType['CustomerSubscriptionDetailsInvokeArgs']] = None,
                          expand: Optional[str] = None,
                          filterable_properties: Optional[Mapping[str, pulumi.InputType['FilterablePropertyInvokeArgs']]] = None,
    ...
    :param Mapping[str, pulumi.InputType['FilterablePropertyInvokeArgs']] filterable_properties: Dictionary of filterable properties on product family.
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:edgeorder/v20201201preview:listProductFamilies', __args__, opts=opts, typ=ListProductFamiliesResult).value
