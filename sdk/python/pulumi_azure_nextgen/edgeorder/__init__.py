...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:edgeorder:AddressByName":
                return AddressByName(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:edgeorder:OrderByName":
                return OrderByName(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:edgeorder:OrderCollectionByName":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "edgeorder", _module_instance)
