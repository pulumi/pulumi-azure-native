...
class AddressByName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:edgeorder/v20201201preview:AddressByName")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AddressByName, __self__).__init__(
            'azure-nextgen:edgeorder:AddressByName',
            resource_name,
            __props__,
            opts)
