...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:synapse:getPrivateLinkHub'.""", DeprecationWarning)
...
def get_private_link_hub(private_link_hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_private_link_hub is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:synapse:getPrivateLinkHub'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:synapse/latest:getPrivateLinkHub', __args__, opts=opts, typ=GetPrivateLinkHubResult).value
