...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:synapse:getWorkspaceAadAdmin'.""", DeprecationWarning)
...
def get_workspace_aad_admin(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_workspace_aad_admin is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:synapse:getWorkspaceAadAdmin'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:synapse/latest:getWorkspaceAadAdmin', __args__, opts=opts, typ=GetWorkspaceAadAdminResult).value
