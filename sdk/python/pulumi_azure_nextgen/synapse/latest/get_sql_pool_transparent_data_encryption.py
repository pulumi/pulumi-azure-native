...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:synapse:getSqlPoolTransparentDataEncryption'.""", DeprecationWarning)
...
def get_sql_pool_transparent_data_encryption(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_sql_pool_transparent_data_encryption is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:synapse:getSqlPoolTransparentDataEncryption'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:synapse/latest:getSqlPoolTransparentDataEncryption', __args__, opts=opts, typ=GetSqlPoolTransparentDataEncryptionResult).value
