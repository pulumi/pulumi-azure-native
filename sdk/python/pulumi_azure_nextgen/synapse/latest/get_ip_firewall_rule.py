...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:synapse:getIpFirewallRule'.""", DeprecationWarning)
...
def get_ip_firewall_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_ip_firewall_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:synapse:getIpFirewallRule'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:synapse/latest:getIpFirewallRule', __args__, opts=opts, typ=GetIpFirewallRuleResult).value
