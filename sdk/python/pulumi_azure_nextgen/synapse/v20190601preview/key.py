...
class Key(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:Key"), pulumi.Alias(type_="azure-nextgen:synapse/latest:Key"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:Key")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Key, __self__).__init__(
            'azure-nextgen:synapse/v20190601preview:Key',
            resource_name,
            __props__,
            opts)
