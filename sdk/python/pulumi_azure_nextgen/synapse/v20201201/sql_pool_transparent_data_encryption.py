...
class SqlPoolTransparentDataEncryption(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/latest:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolTransparentDataEncryption")])
