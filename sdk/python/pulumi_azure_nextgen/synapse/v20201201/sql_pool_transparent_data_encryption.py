...
class SqlPoolTransparentDataEncryption(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/latest:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolTransparentDataEncryption")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPoolTransparentDataEncryption, __self__).__init__(
            'azure-nextgen:synapse/v20201201:SqlPoolTransparentDataEncryption',
            resource_name,
            __props__,
            opts)
