...
class SqlPoolSensitivityLabel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/latest:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:SqlPoolSensitivityLabel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPoolSensitivityLabel, __self__).__init__(
            'azure-nextgen:synapse:SqlPoolSensitivityLabel',
            resource_name,
            __props__,
            opts)
