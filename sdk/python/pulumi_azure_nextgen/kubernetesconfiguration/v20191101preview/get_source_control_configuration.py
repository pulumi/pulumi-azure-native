...
def get_source_control_configuration(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:kubernetesconfiguration/v20191101preview:getSourceControlConfiguration', __args__, opts=opts, typ=GetSourceControlConfigurationResult).value
