...
class GetOrganizationResult:
    ...
    """
    def __init__(__self__, created_time=None, location=None, name=None, offer_detail=None, organization_id=None, provisioning_state=None, sso_url=None, tags=None, type=None, user_detail=None):
...
def get_organization(organization_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:confluent/v20200301preview:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
