...
class GetOrganizationResult:
    ...
    def offer_detail(self) -> Optional['outputs.OrganizationResourcePropertiesInvokeResponseOfferDetailResult']:
        """
    ...
    def user_detail(self) -> Optional['outputs.OrganizationResourcePropertiesInvokeResponseUserDetailResult']:
        """
        Subscriber detail
        """
...
def get_organization(organization_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:confluent/v20200301:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
