...
__all__ = [
    'OrganizationResourcePropertiesInvokeResponseOfferDetailResult',
    'OrganizationResourcePropertiesInvokeResponseUserDetailResult',
    'OrganizationResourcePropertiesResponseOfferDetail',
    'OrganizationResourcePropertiesResponseUserDetail',
]

@pulumi.output_type
class OrganizationResourcePropertiesInvokeResponseOfferDetailResult(dict):
    """
...
@pulumi.output_type
class OrganizationResourcePropertiesInvokeResponseUserDetailResult(dict):
    """
    Subscriber detail
    """
    def __init__(__self__, *,
