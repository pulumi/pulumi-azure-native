...
__all__ = [
    'OperationImpactInvokeResponseResult',
    'OperationImpactResponse',
    'RecommendedIndexInvokeResponseResult',
    'RecommendedIndexResponse',
    'ServiceTierAdvisorInvokeResponseResult',
    'ServiceTierAdvisorResponse',
    'SloUsageMetricInvokeResponseResult',
    'SloUsageMetricResponse',
    'TransparentDataEncryptionInvokeResponseResult',
    'TransparentDataEncryptionResponse',
]

@pulumi.output_type
class OperationImpactInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class RecommendedIndexInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 created: str,
                 estimated_impact: Sequence['outputs.OperationImpactInvokeResponseResult'],
                 id: str,
                 ...
                 last_modified: str,
                 name: str,
                 reported_impact: Sequence['outputs.OperationImpactInvokeResponseResult'],
                 schema: str,
                 state: str,
                 table: str,
                 type: str):
        ...
        :param Sequence['OperationImpactInvokeResponseArgs'] estimated_impact: The estimated impact of doing recommended index action.
        ...
        :param Sequence['OperationImpactInvokeResponseArgs'] reported_impact: The values reported after index action is complete.
    ...
    def estimated_impact(self) -> Sequence['outputs.OperationImpactInvokeResponseResult']:
        """
    ...
    def reported_impact(self) -> Sequence['outputs.OperationImpactInvokeResponseResult']:
        """
...
@pulumi.output_type
class ServiceTierAdvisorInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 service_level_objective_usage_metrics: Sequence['outputs.SloUsageMetricInvokeResponseResult'],
                 type: str,
        ...
        :param Sequence['SloUsageMetricInvokeResponseArgs'] service_level_objective_usage_metrics: Gets or sets serviceLevelObjectiveUsageMetrics for the service tier advisor.
        :param str type: Resource type.
    ...
    def service_level_objective_usage_metrics(self) -> Sequence['outputs.SloUsageMetricInvokeResponseResult']:
        """
...
@pulumi.output_type
class SloUsageMetricInvokeResponseResult(dict):
    """
    A Slo Usage Metric.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class TransparentDataEncryptionInvokeResponseResult(dict):
    """
