...
class TransparentDataEncryption(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] state: Specifies the state of the transparent data encryption.
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/latest:TransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:TransparentDataEncryption")])
