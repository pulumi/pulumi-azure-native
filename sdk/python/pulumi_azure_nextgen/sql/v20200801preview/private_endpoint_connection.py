...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20180601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-nextgen:sql/v20200801preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
