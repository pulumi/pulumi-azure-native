...
class SyncAgent(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:SyncAgent"), pulumi.Alias(type_="azure-nextgen:sql/v20150501preview:SyncAgent"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:SyncAgent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SyncAgent, __self__).__init__(
            'azure-nextgen:sql/v20200801preview:SyncAgent',
            resource_name,
            __props__,
            opts)
