...
class GetManagedInstanceKeyResult:
    ...
    """
    def __init__(__self__, creation_date=None, kind=None, name=None, server_key_type=None, thumbprint=None, type=None, uri=None):
...
def get_managed_instance_key(key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:sql/v20171001preview:getManagedInstanceKey', __args__, opts=opts, typ=GetManagedInstanceKeyResult).value
