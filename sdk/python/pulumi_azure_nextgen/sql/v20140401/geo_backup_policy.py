...
class GeoBackupPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:GeoBackupPolicy"), pulumi.Alias(type_="azure-nextgen:sql/latest:GeoBackupPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GeoBackupPolicy, __self__).__init__(
            'azure-nextgen:sql/v20140401:GeoBackupPolicy',
            resource_name,
            __props__,
            opts)
