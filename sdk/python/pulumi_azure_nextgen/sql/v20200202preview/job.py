...
class Job(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:Job"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:Job"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:Job")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Job, __self__).__init__(
            'azure-nextgen:sql/v20200202preview:Job',
            resource_name,
            __props__,
            opts)
