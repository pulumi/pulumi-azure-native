...
class GetSyncGroupResult:
    ...
    """
    def __init__(__self__, conflict_resolution_policy=None, hub_database_password=None, hub_database_user_name=None, interval=None, last_sync_time=None, name=None, schema=None, sync_database_id=None, sync_state=None, type=None):
...
def get_sync_group(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:sql/v20150501preview:getSyncGroup', __args__, opts=opts, typ=GetSyncGroupResult).value
