...
class VirtualNetworkRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:VirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkRule, __self__).__init__(
            'azure-nextgen:sql/v20150501preview:VirtualNetworkRule',
            resource_name,
            __props__,
            opts)
