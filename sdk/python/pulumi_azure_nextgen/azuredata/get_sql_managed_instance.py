...
class GetSqlManagedInstanceResult:
    ...
    """
    def __init__(__self__, admin=None, data_controller_id=None, end_time=None, id=None, instance_endpoint=None, k8s_raw=None, last_uploaded_date=None, location=None, name=None, start_time=None, system_data=None, tags=None, type=None, v_core=None):
...
def get_sql_managed_instance(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:azuredata:getSqlManagedInstance', __args__, opts=opts, typ=GetSqlManagedInstanceResult).value
