...
class Namespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay:Namespace"), pulumi.Alias(type_="azure-nextgen:relay/latest:Namespace"), pulumi.Alias(type_="azure-nextgen:relay/v20160701:Namespace"), pulumi.Alias(type_="azure-nextgen:relay/v20180101preview:Namespace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Namespace, __self__).__init__(
            'azure-nextgen:relay/v20170401:Namespace',
            resource_name,
            __props__,
            opts)
