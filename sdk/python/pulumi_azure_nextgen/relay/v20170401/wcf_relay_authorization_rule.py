...
class WCFRelayAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay/latest:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay/v20160701:WCFRelayAuthorizationRule")])
