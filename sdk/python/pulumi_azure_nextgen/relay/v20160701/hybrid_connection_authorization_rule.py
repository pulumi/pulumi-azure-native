...
class HybridConnectionAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay/latest:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay/v20170401:HybridConnectionAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HybridConnectionAuthorizationRule, __self__).__init__(
            'azure-nextgen:relay/v20160701:HybridConnectionAuthorizationRule',
            resource_name,
            __props__,
            opts)
