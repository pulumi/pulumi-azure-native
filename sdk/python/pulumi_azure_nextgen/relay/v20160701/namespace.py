...
class Namespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay:Namespace"), pulumi.Alias(type_="azure-nextgen:relay/latest:Namespace"), pulumi.Alias(type_="azure-nextgen:relay/v20170401:Namespace"), pulumi.Alias(type_="azure-nextgen:relay/v20180101preview:Namespace")])
