...
def get_machine_learning_datastore(datastore_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:machinelearningservices:getMachineLearningDatastore', __args__, opts=opts, typ=GetMachineLearningDatastoreResult).value
