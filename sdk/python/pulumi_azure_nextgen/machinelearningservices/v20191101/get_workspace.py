...
class GetWorkspaceResult:
    ...
    """
    def __init__(__self__, application_insights=None, container_registry=None, creation_time=None, description=None, discovery_url=None, friendly_name=None, id=None, identity=None, key_vault=None, location=None, name=None, provisioning_state=None, sku=None, storage_account=None, tags=None, type=None, workspace_id=None):
