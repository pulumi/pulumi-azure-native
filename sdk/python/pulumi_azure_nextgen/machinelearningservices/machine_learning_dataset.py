...
class MachineLearningDataset(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200501preview:MachineLearningDataset")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MachineLearningDataset, __self__).__init__(
            'azure-nextgen:machinelearningservices:MachineLearningDataset',
            resource_name,
            __props__,
            opts)
