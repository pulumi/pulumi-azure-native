...
class AmlComputePropertiesArgs:
    ...
    def virtual_machine_image(self) -> Optional[pulumi.Input['ResourceIdArgs']]:
        """
    ...
    def virtual_machine_image(self, value: Optional[pulumi.Input['ResourceIdArgs']]):
...
class UserAccountCredentialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] admin_user_ssh_public_key: SSH public key of the administrator user account. This property is only supported on Linux based clusters.
        """
