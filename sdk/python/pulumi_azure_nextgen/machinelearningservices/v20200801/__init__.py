...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:machinelearningservices/v20200801:MachineLearningCompute":
                return MachineLearningCompute(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:machinelearningservices/v20200801:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:machinelearningservices/v20200801:Workspace":
                return Workspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:machinelearningservices/v20200801:WorkspaceConnection":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "machinelearningservices/v20200801", _module_instance)
