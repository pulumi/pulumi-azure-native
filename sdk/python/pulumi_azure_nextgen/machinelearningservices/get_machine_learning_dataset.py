...
def get_machine_learning_dataset(dataset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:machinelearningservices:getMachineLearningDataset', __args__, opts=opts, typ=GetMachineLearningDatasetResult).value
