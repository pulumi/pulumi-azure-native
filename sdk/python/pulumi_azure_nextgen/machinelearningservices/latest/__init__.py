...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:machinelearningservices/latest:LinkedWorkspace":
            ...
            elif typ == "azure-nextgen:machinelearningservices/latest:WorkspaceConnection":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "machinelearningservices/latest", _module_instance)
