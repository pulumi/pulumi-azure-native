...
class LinkedWorkspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/latest:LinkedWorkspace"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200301:LinkedWorkspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LinkedWorkspace, __self__).__init__(
            'azure-nextgen:machinelearningservices:LinkedWorkspace',
            resource_name,
            __props__,
            opts)
