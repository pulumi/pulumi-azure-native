...
def list_notebook_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:machinelearningservices/v20200901preview:listNotebookKeys', __args__, opts=opts, typ=ListNotebookKeysResult).value
