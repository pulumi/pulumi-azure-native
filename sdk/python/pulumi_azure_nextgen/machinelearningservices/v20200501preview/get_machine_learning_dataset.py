...
class GetMachineLearningDatasetResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.DatasetInvokeResponseResult':
        """
        Dataset properties
        """
...
def get_machine_learning_dataset(dataset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:machinelearningservices/v20200501preview:getMachineLearningDataset', __args__, opts=opts, typ=GetMachineLearningDatasetResult).value
