...
__all__ = [
    'ActionGroupInvokeResponseResult',
    'ActionGroupResponse',
    'ConditionInvokeResponseResult',
    'ConditionResponse',
    'ConditionsInvokeResponseResult',
    'ConditionsResponse',
    'DiagnosticsInvokeResponseResult',
    'DiagnosticsResponse',
    'ScopeInvokeResponseResult',
    'ScopeResponse',
    'SuppressionConfigInvokeResponseResult',
    'SuppressionConfigResponse',
    'SuppressionInvokeResponseResult',
    'SuppressionResponse',
    'SuppressionScheduleInvokeResponseResult',
    'SuppressionScheduleResponse',
]

@pulumi.output_type
class ActionGroupInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 type: str,
                 conditions: Optional['outputs.ConditionsInvokeResponseResult'] = None,
                 description: Optional[str] = None,
                 scope: Optional['outputs.ScopeInvokeResponseResult'] = None,
        ...
        :param 'ConditionsInvokeResponseArgs' conditions: conditions on which alerts will be filtered
        :param str description: Description of action rule
        :param 'ScopeInvokeResponseArgs' scope: scope on which action rule will apply
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional['outputs.ConditionsInvokeResponseResult']:
        """
...
@pulumi.output_type
class ConditionInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ConditionsInvokeResponseResult(dict):
    """
    Conditions in alert instance to be matched for a given action rule. Default value is all. Multiple values could be provided with comma separation.
    """
    def __init__(__self__, *,
                 alert_context: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 alert_rule_id: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 description: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 monitor_condition: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 monitor_service: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 severity: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 target_resource_type: Optional['outputs.ConditionInvokeResponseResult'] = None):
        """
        Conditions in alert instance to be matched for a given action rule. Default value is all. Multiple values could be provided with comma separation.
        :param 'ConditionInvokeResponseArgs' alert_context: filter alerts by alert context (payload)
        :param 'ConditionInvokeResponseArgs' alert_rule_id: filter alerts by alert rule id
        :param 'ConditionInvokeResponseArgs' description: filter alerts by alert rule description
        :param 'ConditionInvokeResponseArgs' monitor_condition: filter alerts by monitor condition
        :param 'ConditionInvokeResponseArgs' monitor_service: filter alerts by monitor service
        :param 'ConditionInvokeResponseArgs' severity: filter alerts by severity
        :param 'ConditionInvokeResponseArgs' target_resource_type: filter alerts by target resource type
        """
    ...
    def alert_context(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
    ...
    def alert_rule_id(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
    ...
    @property
    @pulumi.getter
    def description(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
    ...
    def monitor_condition(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
    ...
    def monitor_service(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
    ...
    @property
    @pulumi.getter
    def severity(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
    ...
    def target_resource_type(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
...
@pulumi.output_type
class DiagnosticsInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class SuppressionConfigInvokeResponseResult(dict):
    """
    Suppression logic for a given action rule
    """
    def __init__(__self__, *,
                 recurrence_type: str,
                 schedule: Optional['outputs.SuppressionScheduleInvokeResponseResult'] = None):
        """
        Suppression logic for a given action rule
        :param str recurrence_type: Specifies when the suppression should be applied
        :param 'SuppressionScheduleInvokeResponseArgs' schedule: suppression schedule configuration
        """
    ...
    @property
    @pulumi.getter
    def schedule(self) -> Optional['outputs.SuppressionScheduleInvokeResponseResult']:
        """
...
@pulumi.output_type
class SuppressionInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 last_modified_at: str,
                 last_modified_by: str,
                 suppression_config: 'outputs.SuppressionConfigInvokeResponseResult',
                 type: str,
                 conditions: Optional['outputs.ConditionsInvokeResponseResult'] = None,
                 description: Optional[str] = None,
                 scope: Optional['outputs.ScopeInvokeResponseResult'] = None,
        ...
        :param str last_modified_at: Last updated time of action rule. Date-Time in ISO-8601 format.
        :param str last_modified_by: Last modified by user name.
        :param 'SuppressionConfigInvokeResponseArgs' suppression_config: suppression configuration for the action rule
        :param str type: Indicates type of action rule
    ...
    def suppression_config(self) -> 'outputs.SuppressionConfigInvokeResponseResult':
        """
...
@pulumi.output_type
class SuppressionScheduleInvokeResponseResult(dict):
    """
