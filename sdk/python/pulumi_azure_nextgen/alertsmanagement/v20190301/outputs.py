...
__all__ = [
    'ActionGroupsInformationInvokeResponseResult',
    'ActionGroupsInformationResponse',
    'DetectorInvokeResponseResult',
    'DetectorResponse',
    'ThrottlingInformationInvokeResponseResult',
    'ThrottlingInformationResponse',
]

@pulumi.output_type
class ActionGroupsInformationInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class DetectorInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ThrottlingInformationInvokeResponseResult(dict):
    """
