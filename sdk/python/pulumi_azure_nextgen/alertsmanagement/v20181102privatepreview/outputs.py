...
__all__ = [
    'ActionRulePropertiesInvokeResponseResult',
...
@pulumi.output_type
class ActionRulePropertiesInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 suppression_config: Optional['outputs.SuppressionConfigInvokeResponseResult'] = None):
        """
        Action rule properties defining scope, conditions, suppression logic for action rule
        ...
        :param 'ConditionsInvokeResponseArgs' conditions: Conditions in alert instance to be matched for a given action rule. Default value is all. Multiple values could be provided with comma separation.
        :param str description: Description of action rule
        :param 'ScopeInvokeResponseArgs' scope: Target scope for a given action rule. By default scope will be the subscription. User can also provide list of resource groups or list of resources from the scope subscription as well.
        :param str status: Indicates if the given action rule is enabled or disabled
        :param 'SuppressionConfigInvokeResponseArgs' suppression_config: Suppression logic for a given action rule
        """
    ...
    def suppression_config(self) -> Optional['outputs.SuppressionConfigInvokeResponseResult']:
        """
...
class ConditionsInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 application_insights_search_results: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 description: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 log_analytics_search_results: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 ...
                 signal_type: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 target_resource: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 target_resource_group: Optional['outputs.ConditionInvokeResponseResult'] = None,
                 target_resource_type: Optional['outputs.ConditionInvokeResponseResult'] = None):
        """
        Conditions in alert instance to be matched for a given action rule. Default value is all. Multiple values could be provided with comma separation.
        :param 'ConditionInvokeResponseArgs' alert_rule_id: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' application_insights_search_results: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' description: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' log_analytics_search_results: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' monitor_condition: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' monitor_service: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' severity: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' signal_type: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' target_resource: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' target_resource_group: condition to trigger an action rule
        :param 'ConditionInvokeResponseArgs' target_resource_type: condition to trigger an action rule
        """
    ...
    def application_insights_search_results(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
        condition to trigger an action rule
        """
    ...
    def log_analytics_search_results(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
        condition to trigger an action rule
        """
    ...
    def signal_type(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
        condition to trigger an action rule
        """
    ...
    def target_resource(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
        condition to trigger an action rule
        """
    ...
    def target_resource_group(self) -> Optional['outputs.ConditionInvokeResponseResult']:
        """
        condition to trigger an action rule
        """
...
class SuppressionConfigInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SuppressionScheduleInvokeResponseArgs' schedule: Schedule for a given suppression configuration.
        """
