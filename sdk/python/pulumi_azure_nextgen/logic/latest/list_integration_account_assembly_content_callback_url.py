...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:logic:listIntegrationAccountAssemblyContentCallbackUrl'.""", DeprecationWarning)
...
def list_integration_account_assembly_content_callback_url(assembly_artifact_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("list_integration_account_assembly_content_callback_url is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:logic:listIntegrationAccountAssemblyContentCallbackUrl'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:logic/latest:listIntegrationAccountAssemblyContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAssemblyContentCallbackUrlResult).value
