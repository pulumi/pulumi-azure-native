...
class Schema(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic:Schema"), pulumi.Alias(type_="azure-nextgen:logic/latest:Schema"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:Schema"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:Schema"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:Schema")])
