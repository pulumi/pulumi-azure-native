...
class ContentLinkInvokeResponseResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param 'ContentHashInvokeResponseArgs' content_hash: Gets or sets the content hash.
...
class SkuInvokeResponseResult(dict):
    def __init__(__self__, *,
        ...
        :param 'ResourceReferenceInvokeResponseArgs' plan: Gets or sets the reference to plan.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if plan is not None:
