...
def get_integration_account_schema(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:logic/v20180701preview:getIntegrationAccountSchema', __args__, opts=opts, typ=GetIntegrationAccountSchemaResult).value
