...
def list_integration_account_schema_content_callback_url(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:logic/v20180701preview:listIntegrationAccountSchemaContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountSchemaContentCallbackUrlResult).value
