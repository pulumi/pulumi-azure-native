...
class WorkflowAccessKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20150201preview:WorkflowAccessKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkflowAccessKey, __self__).__init__(
            'azure-nextgen:logic:WorkflowAccessKey',
            resource_name,
            __props__,
            opts)
