...
class IntegrationAccountBatchConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/latest:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountBatchConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountBatchConfiguration, __self__).__init__(
            'azure-nextgen:logic:IntegrationAccountBatchConfiguration',
            resource_name,
            __props__,
            opts)
