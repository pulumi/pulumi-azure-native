...
class GetIntegrationAccountPartnerResult:
    ...
    @property
    @pulumi.getter
    def content(self) -> Optional['outputs.PartnerContentInvokeResponseResult']:
        """
        The partner content.
        """
...
def get_integration_account_partner(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:logic/v20150801preview:getIntegrationAccountPartner', __args__, opts=opts, typ=GetIntegrationAccountPartnerResult).value
