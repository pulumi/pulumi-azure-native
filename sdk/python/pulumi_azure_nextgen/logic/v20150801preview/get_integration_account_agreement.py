...
def get_integration_account_agreement(agreement_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:logic/v20150801preview:getIntegrationAccountAgreement', __args__, opts=opts, typ=GetIntegrationAccountAgreementResult).value
