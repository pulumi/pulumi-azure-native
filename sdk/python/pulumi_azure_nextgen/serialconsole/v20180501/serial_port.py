...
class SerialPort(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:serialconsole:SerialPort"), pulumi.Alias(type_="azure-nextgen:serialconsole/latest:SerialPort")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SerialPort, __self__).__init__(
            'azure-nextgen:serialconsole/v20180501:SerialPort',
            resource_name,
            __props__,
            opts)
