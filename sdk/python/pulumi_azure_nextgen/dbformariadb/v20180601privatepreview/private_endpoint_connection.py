...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformariadb/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601:PrivateEndpointConnection")])
