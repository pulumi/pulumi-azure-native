...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:dbformariadb:getVirtualNetworkRule'.""", DeprecationWarning)
...
def get_virtual_network_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_virtual_network_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:dbformariadb:getVirtualNetworkRule'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:dbformariadb/latest:getVirtualNetworkRule', __args__, opts=opts, typ=GetVirtualNetworkRuleResult).value
