...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:vmwarecloudsimple:DedicatedCloudNode":
                return DedicatedCloudNode(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:vmwarecloudsimple:DedicatedCloudService":
                return DedicatedCloudService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:vmwarecloudsimple:VirtualMachine":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "vmwarecloudsimple", _module_instance)
