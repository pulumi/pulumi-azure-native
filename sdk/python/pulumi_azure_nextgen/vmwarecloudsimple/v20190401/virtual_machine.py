...
class VirtualMachine(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple:VirtualMachine"), pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple/latest:VirtualMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachine, __self__).__init__(
            'azure-nextgen:vmwarecloudsimple/v20190401:VirtualMachine',
            resource_name,
            __props__,
            opts)
