...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:vmwarecloudsimple:getDedicatedCloudNode'.""", DeprecationWarning)
...
def get_dedicated_cloud_node(dedicated_cloud_node_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_dedicated_cloud_node is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:vmwarecloudsimple:getDedicatedCloudNode'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:vmwarecloudsimple/latest:getDedicatedCloudNode', __args__, opts=opts, typ=GetDedicatedCloudNodeResult).value
