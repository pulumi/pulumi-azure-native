...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:domainregistration/v20150801:Domain":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "domainregistration/v20150801", _module_instance)
