...
def list_domain_recommendations(keywords: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:domainregistration/v20200901:listDomainRecommendations', __args__, opts=opts, typ=ListDomainRecommendationsResult).value
