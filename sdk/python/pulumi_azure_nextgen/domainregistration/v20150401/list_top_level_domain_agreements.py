...
def list_top_level_domain_agreements(for_transfer: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:domainregistration/v20150401:listTopLevelDomainAgreements', __args__, opts=opts, typ=ListTopLevelDomainAgreementsResult).value
