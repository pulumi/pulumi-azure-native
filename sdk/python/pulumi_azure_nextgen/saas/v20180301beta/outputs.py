...
__all__ = [
    'SaasPropertiesInvokeResponseTermResult',
    'SaasPropertiesResponseTerm',
    'SaasResourceInvokeResponsePropertiesResult',
    'SaasResourceResponseProperties',
]

@pulumi.output_type
class SaasPropertiesInvokeResponseTermResult(dict):
    """
...
@pulumi.output_type
class SaasResourceInvokeResponsePropertiesResult(dict):
    """
    saas properties
    """
    def __init__(__self__, *,
                 ...
                 term: Optional['outputs.SaasPropertiesInvokeResponseTermResult'] = None,
        ...
        :param 'SaasPropertiesInvokeResponseTermArgs' term: The current Term object.
    ...
    @property
    @pulumi.getter
    def term(self) -> Optional['outputs.SaasPropertiesInvokeResponseTermResult']:
        """
        The current Term object.
        """
