...
def list_saas_resource_access_token(resource_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:saas/v20180301beta:listSaasResourceAccessToken', __args__, opts=opts, typ=ListSaasResourceAccessTokenResult).value
