...
def list_saas_subscription_level_access_token(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:saas:listSaasSubscriptionLevelAccessToken', __args__, opts=opts, typ=ListSaasSubscriptionLevelAccessTokenResult).value
