...
class SaasSubscriptionLevel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:saas/v20180301beta:SaasSubscriptionLevel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SaasSubscriptionLevel, __self__).__init__(
            'azure-nextgen:saas:SaasSubscriptionLevel',
            resource_name,
            __props__,
            opts)
