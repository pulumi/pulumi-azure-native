...
class GetServerDetailsResult:
    ...
    """
    def __init__(__self__, as_administrators=None, backup_blob_container_uri=None, gateway_details=None, id=None, location=None, name=None, provisioning_state=None, server_full_name=None, sku=None, state=None, tags=None, type=None):
...
def get_server_details(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:analysisservices/v20170714:getServerDetails', __args__, opts=opts, typ=GetServerDetailsResult).value
