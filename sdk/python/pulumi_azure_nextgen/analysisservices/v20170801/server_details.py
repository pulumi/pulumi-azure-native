...
class ServerDetails(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:analysisservices/latest:ServerDetails"), pulumi.Alias(type_="azure-nextgen:analysisservices/v20160516:ServerDetails"), pulumi.Alias(type_="azure-nextgen:analysisservices/v20170714:ServerDetails"), pulumi.Alias(type_="azure-nextgen:analysisservices/v20170801beta:ServerDetails")])
