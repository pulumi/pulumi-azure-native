...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:databoxedge/v20200901:Addon":
                return Addon(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:BandwidthSchedule":
                return BandwidthSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:Container":
                return Container(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:Device":
                return Device(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:MonitoringConfig":
                return MonitoringConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:Order":
                return Order(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:Role":
                return Role(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:StorageAccount":
                return StorageAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:StorageAccountCredential":
                return StorageAccountCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:Trigger":
                return Trigger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:databoxedge/v20200901:User":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "databoxedge/v20200901", _module_instance)
