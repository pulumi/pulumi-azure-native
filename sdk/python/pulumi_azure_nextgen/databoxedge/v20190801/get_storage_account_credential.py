...
class GetStorageAccountCredentialResult:
    ...
    def account_key(self) -> Optional['outputs.AsymmetricEncryptedSecretInvokeResponseResult']:
        """
...
def get_storage_account_credential(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:databoxedge/v20190801:getStorageAccountCredential', __args__, opts=opts, typ=GetStorageAccountCredentialResult).value
