...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:databoxedge:getOrder'.""", DeprecationWarning)
...
def get_order(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_order is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:databoxedge:getOrder'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:databoxedge/latest:getOrder', __args__, opts=opts, typ=GetOrderResult).value
