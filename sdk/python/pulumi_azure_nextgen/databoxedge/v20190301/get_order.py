...
class GetOrderResult:
    ...
    def shipping_address(self) -> 'outputs.AddressInvokeResponseResult':
        """
...
def get_order(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:databoxedge/v20190301:getOrder', __args__, opts=opts, typ=GetOrderResult).value
