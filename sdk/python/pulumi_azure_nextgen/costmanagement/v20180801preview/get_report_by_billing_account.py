...
def get_report_by_billing_account(billing_account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:costmanagement/v20180801preview:getReportByBillingAccount', __args__, opts=opts, typ=GetReportByBillingAccountResult).value
