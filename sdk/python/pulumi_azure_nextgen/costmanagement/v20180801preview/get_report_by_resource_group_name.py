...
def get_report_by_resource_group_name(report_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:costmanagement/v20180801preview:getReportByResourceGroupName', __args__, opts=opts, typ=GetReportByResourceGroupNameResult).value
