...
def get_report_by_department(department_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:costmanagement/v20180801preview:getReportByDepartment', __args__, opts=opts, typ=GetReportByDepartmentResult).value
