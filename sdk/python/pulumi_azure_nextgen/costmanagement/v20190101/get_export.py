...
class GetExportResult:
    ...
    @property
    @pulumi.getter
    def definition(self) -> 'outputs.QueryDefinitionInvokeResponseResult':
        """
...
def get_export(export_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:costmanagement/v20190101:getExport', __args__, opts=opts, typ=GetExportResult).value
