...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:costmanagement/v20180531:ReportConfig":
                return ReportConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:costmanagement/v20180531:ReportConfigByResourceGroupName":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "costmanagement/v20180531", _module_instance)
