...
__all__ = [
    'ConnectorCollectionErrorInfoInvokeResponseResult',
    'ConnectorCollectionErrorInfoResponse',
    'ConnectorCollectionInfoInvokeResponseResult',
    'ConnectorCollectionInfoResponse',
]

@pulumi.output_type
class ConnectorCollectionErrorInfoInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ConnectorCollectionInfoInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 error: Optional['outputs.ConnectorCollectionErrorInfoInvokeResponseResult'] = None):
        """
        Collection and ingestion information
        ...
        :param 'ConnectorCollectionErrorInfoInvokeResponseArgs' error: Error information of last collection
        """
    ...
    @property
    @pulumi.getter
    def error(self) -> Optional['outputs.ConnectorCollectionErrorInfoInvokeResponseResult']:
        """
