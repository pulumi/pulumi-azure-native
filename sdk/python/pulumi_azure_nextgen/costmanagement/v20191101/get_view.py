...
class GetViewResult:
    ...
    def data_set(self) -> Optional['outputs.ReportConfigDatasetInvokeResponseResult']:
        """
...
def get_view(view_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:costmanagement/v20191101:getView', __args__, opts=opts, typ=GetViewResult).value
