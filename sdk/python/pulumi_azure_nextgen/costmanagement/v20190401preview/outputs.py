...
__all__ = [
    'BudgetTimePeriodInvokeResponseResult',
    'BudgetTimePeriodResponse',
    'CurrentSpendInvokeResponseResult',
    'CurrentSpendResponse',
    'KpiPropertiesInvokeResponseResult',
    'KpiPropertiesResponse',
    'NotificationInvokeResponseResult',
...
@pulumi.output_type
class BudgetTimePeriodInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CurrentSpendInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class NotificationInvokeResponseResult(dict):
    """
