...
class View(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:costmanagement:View"), pulumi.Alias(type_="azure-nextgen:costmanagement/latest:View"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20191101:View"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20200601:View")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(View, __self__).__init__(
            'azure-nextgen:costmanagement/v20190401preview:View',
            resource_name,
            __props__,
            opts)
