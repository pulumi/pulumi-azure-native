...
__all__ = [
    'CostAllocationProportionInvokeResponseResult',
    'CostAllocationProportionResponse',
    'CostAllocationRuleDetailsInvokeResponseResult',
    'CostAllocationRuleDetailsResponse',
    'CostAllocationRulePropertiesInvokeResponseResult',
    'CostAllocationRulePropertiesResponse',
    'SourceCostAllocationResourceInvokeResponseResult',
    'SourceCostAllocationResourceResponse',
    'TargetCostAllocationResourceInvokeResponseResult',
    'TargetCostAllocationResourceResponse',
]

@pulumi.output_type
class CostAllocationProportionInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CostAllocationRuleDetailsInvokeResponseResult(dict):
    """
    Resource details of the cost allocation rule
    """
    def __init__(__self__, *,
                 source_resources: Optional[Sequence['outputs.SourceCostAllocationResourceInvokeResponseResult']] = None,
                 target_resources: Optional[Sequence['outputs.TargetCostAllocationResourceInvokeResponseResult']] = None):
        """
        Resource details of the cost allocation rule
        :param Sequence['SourceCostAllocationResourceInvokeResponseArgs'] source_resources: Source resources for cost allocation. At this time, this list can contain no more than one element.
        :param Sequence['TargetCostAllocationResourceInvokeResponseArgs'] target_resources: Target resources for cost allocation. At this time, this list can contain no more than one element.
        """
    ...
    def source_resources(self) -> Optional[Sequence['outputs.SourceCostAllocationResourceInvokeResponseResult']]:
        """
    ...
    def target_resources(self) -> Optional[Sequence['outputs.TargetCostAllocationResourceInvokeResponseResult']]:
        """
...
@pulumi.output_type
class CostAllocationRulePropertiesInvokeResponseResult(dict):
    """
    The properties of a cost allocation rule
    """
    def __init__(__self__, *,
                 created_date: str,
                 details: 'outputs.CostAllocationRuleDetailsInvokeResponseResult',
                 status: str,
                 updated_date: str,
        ...
        :param 'CostAllocationRuleDetailsInvokeResponseArgs' details: Resource information for the cost allocation rule
    ...
    @property
    @pulumi.getter
    def details(self) -> 'outputs.CostAllocationRuleDetailsInvokeResponseResult':
        """
...
@pulumi.output_type
class SourceCostAllocationResourceInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class TargetCostAllocationResourceInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 policy_type: str,
                 resource_type: str,
                 values: Sequence['outputs.CostAllocationProportionInvokeResponseResult']):
        """
        Target resources for cost allocation.
        :param str name: If resource type is dimension, this must be either ResourceGroupName or SubscriptionId. If resource type is tag, this must be a valid Azure tag
        :param str policy_type: Method of cost allocation for the rule
        :param str resource_type: Type of resources contained in this cost allocation rule
        :param Sequence['CostAllocationProportionInvokeResponseArgs'] values: Target resources for cost allocation. This list cannot contain more than 25 values.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def values(self) -> Sequence['outputs.CostAllocationProportionInvokeResponseResult']:
        """
