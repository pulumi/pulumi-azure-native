...
def get_report_config_by_resource_group_name(report_config_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:costmanagement:getReportConfigByResourceGroupName', __args__, opts=opts, typ=GetReportConfigByResourceGroupNameResult).value
