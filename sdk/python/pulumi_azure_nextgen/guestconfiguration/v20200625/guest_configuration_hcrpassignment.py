...
class GuestConfigurationHCRPAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:guestconfiguration/latest:GuestConfigurationHCRPAssignment"), pulumi.Alias(type_="azure-nextgen:guestconfiguration/v20181120:GuestConfigurationHCRPAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestConfigurationHCRPAssignment, __self__).__init__(
            'azure-nextgen:guestconfiguration/v20200625:GuestConfigurationHCRPAssignment',
            resource_name,
            __props__,
            opts)
