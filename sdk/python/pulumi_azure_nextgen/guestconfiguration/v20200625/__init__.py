...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:guestconfiguration/v20200625:GuestConfigurationAssignment":
                return GuestConfigurationAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:guestconfiguration/v20200625:GuestConfigurationHCRPAssignment":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "guestconfiguration/v20200625", _module_instance)
