...
class WebService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearning/latest:WebService"), pulumi.Alias(type_="azure-nextgen:machinelearning/v20160501preview:WebService"), pulumi.Alias(type_="azure-nextgen:machinelearning/v20170101:WebService")])
