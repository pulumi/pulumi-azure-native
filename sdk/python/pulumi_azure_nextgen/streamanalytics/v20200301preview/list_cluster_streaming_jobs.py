...
def list_cluster_streaming_jobs(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:streamanalytics/v20200301preview:listClusterStreamingJobs', __args__, opts=opts, typ=ListClusterStreamingJobsResult).value
