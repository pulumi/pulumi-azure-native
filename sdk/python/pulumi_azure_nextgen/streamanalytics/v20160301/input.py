...
class Input(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:streamanalytics/latest:Input"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20170401preview:Input")])
