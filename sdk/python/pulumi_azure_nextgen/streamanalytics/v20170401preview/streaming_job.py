...
class StreamingJob(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] job_type: Describes the type of the job. Valid modes are `Cloud` and 'Edge'.
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:streamanalytics/latest:StreamingJob"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20160301:StreamingJob")])
