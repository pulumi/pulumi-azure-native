...
class Input(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:streamanalytics:Input"), pulumi.Alias(type_="azure-nextgen:streamanalytics/latest:Input"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20160301:Input")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Input, __self__).__init__(
            'azure-nextgen:streamanalytics/v20170401preview:Input',
            resource_name,
            __props__,
            opts)
