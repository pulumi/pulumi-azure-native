...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:hybriddata/v20160601:DataManager":
                return DataManager(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:hybriddata/v20160601:DataStore":
                return DataStore(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:hybriddata/v20160601:JobDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "hybriddata/v20160601", _module_instance)
