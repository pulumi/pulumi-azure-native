...
class Lab(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices/latest:Lab"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:Lab")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Lab, __self__).__init__(
            'azure-nextgen:labservices:Lab',
            resource_name,
            __props__,
            opts)
