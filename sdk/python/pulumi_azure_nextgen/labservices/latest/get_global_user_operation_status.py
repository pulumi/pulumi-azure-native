...
def get_global_user_operation_status(operation_url: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:labservices/latest:getGlobalUserOperationStatus', __args__, opts=opts, typ=GetGlobalUserOperationStatusResult).value
