...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:labservices:LabAccount'.""", DeprecationWarning)
...
class LabAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices:LabAccount"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:LabAccount")])
