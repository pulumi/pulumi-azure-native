...
class GetGlobalUserOperationBatchStatusResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence['outputs.OperationBatchStatusResponseItemInvokeResponseResult']:
        """
...
def get_global_user_operation_batch_status(urls: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:labservices/v20181015:getGlobalUserOperationBatchStatus', __args__, opts=opts, typ=GetGlobalUserOperationBatchStatusResult).value
