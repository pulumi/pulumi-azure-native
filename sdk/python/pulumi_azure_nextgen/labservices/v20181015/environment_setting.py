...
class EnvironmentSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices:EnvironmentSetting"), pulumi.Alias(type_="azure-nextgen:labservices/latest:EnvironmentSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnvironmentSetting, __self__).__init__(
            'azure-nextgen:labservices/v20181015:EnvironmentSetting',
            resource_name,
            __props__,
            opts)
