...
class GetGlobalUserEnvironmentResult:
    ...
    @property
    @pulumi.getter
    def environment(self) -> 'outputs.EnvironmentDetailsInvokeResponseResult':
        """
...
def get_global_user_environment(environment_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:labservices/v20181015:getGlobalUserEnvironment', __args__, opts=opts, typ=GetGlobalUserEnvironmentResult).value
