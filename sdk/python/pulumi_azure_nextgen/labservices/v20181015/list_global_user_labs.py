...
class ListGlobalUserLabsResult:
    ...
    @property
    @pulumi.getter
    def labs(self) -> Optional[Sequence['outputs.LabDetailsInvokeResponseResult']]:
        """
...
def list_global_user_labs(user_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:labservices/v20181015:listGlobalUserLabs', __args__, opts=opts, typ=ListGlobalUserLabsResult).value
