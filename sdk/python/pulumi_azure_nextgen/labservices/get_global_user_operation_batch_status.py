...
def get_global_user_operation_batch_status(urls: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:labservices:getGlobalUserOperationBatchStatus', __args__, opts=opts, typ=GetGlobalUserOperationBatchStatusResult).value
