...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:billing:BillingRoleAssignmentByBillingAccount":
                return BillingRoleAssignmentByBillingAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:billing:BillingRoleAssignmentByDepartment":
                return BillingRoleAssignmentByDepartment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:billing:BillingRoleAssignmentByEnrollmentAccount":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "billing", _module_instance)
