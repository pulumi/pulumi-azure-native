...
__all__ = [
    'AzurePlanInvokeResponseResult',
    'InvoiceSectionWithCreateSubPermissionInvokeResponseResult',
]

@pulumi.output_type
class AzurePlanInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class InvoiceSectionWithCreateSubPermissionInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 enabled_azure_plans: Optional[Sequence['outputs.AzurePlanInvokeResponseResult']] = None):
        """
        Invoice section properties with create subscription permission.
        ...
        :param Sequence['AzurePlanInvokeResponseArgs'] enabled_azure_plans: Enabled azure plans for the associated billing profile.
        """
    ...
    def enabled_azure_plans(self) -> Optional[Sequence['outputs.AzurePlanInvokeResponseResult']]:
        """
