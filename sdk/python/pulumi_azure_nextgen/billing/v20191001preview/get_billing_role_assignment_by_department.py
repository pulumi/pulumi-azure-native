...
def get_billing_role_assignment_by_department(billing_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:billing/v20191001preview:getBillingRoleAssignmentByDepartment', __args__, opts=opts, typ=GetBillingRoleAssignmentByDepartmentResult).value
