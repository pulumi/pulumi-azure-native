...
class Diagnostic(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] operation_name_format: The format of the Operation Name for Application Insights telemetries. Default is Name.
        ...
        super(Diagnostic, __self__).__init__(
            'azure-nextgen:apimanagement/v20200601preview:Diagnostic',
            resource_name,
            __props__,
            opts)
