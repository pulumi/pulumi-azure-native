...
class GetCertificateResult:
    ...
    Certificate details.
    """
    def __init__(__self__, expiration_date=None, key_vault=None, name=None, subject=None, thumbprint=None, type=None):
...
def get_certificate(certificate_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/v20200601preview:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
