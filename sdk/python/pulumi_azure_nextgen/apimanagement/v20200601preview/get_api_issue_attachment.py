...
def get_api_issue_attachment(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/v20200601preview:getApiIssueAttachment', __args__, opts=opts, typ=GetApiIssueAttachmentResult).value
