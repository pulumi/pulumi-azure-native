...
class TagDescription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement:TagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:TagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:TagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:TagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:TagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:TagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:TagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:TagDescription")])
