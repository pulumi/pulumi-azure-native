...
__all__ = [
    'AdditionalLocationInvokeResponseResult',
    'AdditionalLocationResponse',
    'ApiManagementServiceIdentityInvokeResponseResult',
    'ApiManagementServiceIdentityResponse',
    'ApiManagementServiceSkuPropertiesInvokeResponseResult',
    'ApiManagementServiceSkuPropertiesResponse',
    'ApiVersionSetContractInvokeResponseResult',
    'ApiVersionSetContractResponse',
    'AuthenticationSettingsContractInvokeResponseResult',
    'AuthenticationSettingsContractResponse',
    'BackendAuthorizationHeaderCredentialsInvokeResponseResult',
    'BackendAuthorizationHeaderCredentialsResponse',
    'BackendCredentialsContractInvokeResponseResult',
    'BackendCredentialsContractResponse',
    'BackendPropertiesInvokeResponseResult',
    'BackendPropertiesResponse',
    'BackendProxyContractInvokeResponseResult',
    'BackendProxyContractResponse',
    'BackendServiceFabricClusterPropertiesInvokeResponseResult',
    'BackendServiceFabricClusterPropertiesResponse',
    'BackendTlsPropertiesInvokeResponseResult',
    'BackendTlsPropertiesResponse',
    'CertificateConfigurationInvokeResponseResult',
    'CertificateConfigurationResponse',
    'CertificateInformationInvokeResponseResult',
    'CertificateInformationResponse',
    'EmailTemplateParametersContractPropertiesInvokeResponseResult',
    'EmailTemplateParametersContractPropertiesResponse',
    'GroupContractInvokeResponseResult',
    'GroupContractResponse',
    'HostnameConfigurationInvokeResponseResult',
    'HostnameConfigurationResponse',
    'LoggerSamplingContractInvokeResponseResult',
    'LoggerSamplingContractResponse',
    'OAuth2AuthenticationSettingsContractInvokeResponseResult',
    'OAuth2AuthenticationSettingsContractResponse',
    'ParameterContractInvokeResponseResult',
    'ParameterContractResponse',
    'RepresentationContractInvokeResponseResult',
    'RepresentationContractResponse',
    'RequestContractInvokeResponseResult',
    'RequestContractResponse',
    'ResponseContractInvokeResponseResult',
    'ResponseContractResponse',
    'SubscriptionKeyParameterNamesContractInvokeResponseResult',
    'SubscriptionKeyParameterNamesContractResponse',
    'TokenBodyParameterContractInvokeResponseResult',
    'TokenBodyParameterContractResponse',
    'UserIdentityContractInvokeResponseResult',
    'UserIdentityContractResponse',
    'VirtualNetworkConfigurationInvokeResponseResult',
    'VirtualNetworkConfigurationResponse',
    'X509CertificateNameInvokeResponseResult',
    'X509CertificateNameResponse',
]

@pulumi.output_type
class AdditionalLocationInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 location: str,
                 sku: 'outputs.ApiManagementServiceSkuPropertiesInvokeResponseResult',
                 static_ips: Sequence[str],
                 virtual_network_configuration: Optional['outputs.VirtualNetworkConfigurationInvokeResponseResult'] = None):
        """
        Description of an additional API Management resource location.
        ...
        :param 'ApiManagementServiceSkuPropertiesInvokeResponseArgs' sku: SKU properties of the API Management service.
        :param Sequence[str] static_ips: Static IP addresses of the location's virtual machines.
        :param 'VirtualNetworkConfigurationInvokeResponseArgs' virtual_network_configuration: Virtual network configuration for the location.
        """
...
@pulumi.output_type
class ApiManagementServiceIdentityInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ApiManagementServiceSkuPropertiesInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ApiVersionSetContractInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class AuthenticationSettingsContractInvokeResponseResult(dict):
    """
    API Authentication Settings.
    """
    def __init__(__self__, *,
                 o_auth2: Optional['outputs.OAuth2AuthenticationSettingsContractInvokeResponseResult'] = None):
        """
        API Authentication Settings.
        :param 'OAuth2AuthenticationSettingsContractInvokeResponseArgs' o_auth2: OAuth2 Authentication settings
        """
    ...
    def o_auth2(self) -> Optional['outputs.OAuth2AuthenticationSettingsContractInvokeResponseResult']:
        """
...
@pulumi.output_type
class BackendAuthorizationHeaderCredentialsInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class BackendCredentialsContractInvokeResponseResult(dict):
    """
    Details of the Credentials used to connect to Backend.
    """
    def __init__(__self__, *,
                 authorization: Optional['outputs.BackendAuthorizationHeaderCredentialsInvokeResponseResult'] = None,
        ...
        """
        Details of the Credentials used to connect to Backend.
        :param 'BackendAuthorizationHeaderCredentialsInvokeResponseArgs' authorization: Authorization header authentication
    ...
    @property
    @pulumi.getter
    def authorization(self) -> Optional['outputs.BackendAuthorizationHeaderCredentialsInvokeResponseResult']:
        """
...
@pulumi.output_type
class BackendPropertiesInvokeResponseResult(dict):
    """
    Properties specific to the Backend Type.
    """
    def __init__(__self__, *,
                 service_fabric_cluster: Optional['outputs.BackendServiceFabricClusterPropertiesInvokeResponseResult'] = None):
        """
        Properties specific to the Backend Type.
        :param 'BackendServiceFabricClusterPropertiesInvokeResponseArgs' service_fabric_cluster: Backend Service Fabric Cluster Properties
        """
    ...
    def service_fabric_cluster(self) -> Optional['outputs.BackendServiceFabricClusterPropertiesInvokeResponseResult']:
        """
...
@pulumi.output_type
class BackendProxyContractInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class BackendServiceFabricClusterPropertiesInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 server_x509_names: Optional[Sequence['outputs.X509CertificateNameInvokeResponseResult']] = None):
        """
        Properties of the Service Fabric Type Backend.
        ...
        :param Sequence['X509CertificateNameInvokeResponseArgs'] server_x509_names: Server X509 Certificate Names Collection
        """
    ...
    def server_x509_names(self) -> Optional[Sequence['outputs.X509CertificateNameInvokeResponseResult']]:
        """
...
@pulumi.output_type
class BackendTlsPropertiesInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class CertificateConfigurationInvokeResponseResult(dict):
    """
    Certificate configuration which consist of non-trusted intermediates and root certificates.
    """
    def __init__(__self__, *,
                 certificate: 'outputs.CertificateInformationInvokeResponseResult',
                 store_name: str,
                 certificate_password: Optional[str] = None,
                 encoded_certificate: Optional[str] = None):
        """
        Certificate configuration which consist of non-trusted intermediates and root certificates.
        :param 'CertificateInformationInvokeResponseArgs' certificate: Certificate information.
    ...
    @property
    @pulumi.getter
    def certificate(self) -> 'outputs.CertificateInformationInvokeResponseResult':
        """
...
@pulumi.output_type
class CertificateInformationInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class EmailTemplateParametersContractPropertiesInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class GroupContractInvokeResponseResult(dict):
    """
    Contract details.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class HostnameConfigurationInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class LoggerSamplingContractInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class OAuth2AuthenticationSettingsContractInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ParameterContractInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class RepresentationContractInvokeResponseResult(dict):
    """
    Operation request/response representation details.
    """
    def __init__(__self__, *,
                 content_type: str,
                 form_parameters: Optional[Sequence['outputs.ParameterContractInvokeResponseResult']] = None,
        ...
        :param Sequence['ParameterContractInvokeResponseArgs'] form_parameters: Collection of form parameters. Required if 'contentType' value is either 'application/x-www-form-urlencoded' or 'multipart/form-data'..
    ...
    def form_parameters(self) -> Optional[Sequence['outputs.ParameterContractInvokeResponseResult']]:
        """
...
@pulumi.output_type
class RequestContractInvokeResponseResult(dict):
    """
    Operation request details.
    """
    def __init__(__self__, *,
                 description: Optional[str] = None,
                 headers: Optional[Sequence['outputs.ParameterContractInvokeResponseResult']] = None,
                 query_parameters: Optional[Sequence['outputs.ParameterContractInvokeResponseResult']] = None,
                 representations: Optional[Sequence['outputs.RepresentationContractInvokeResponseResult']] = None):
        """
        Operation request details.
        :param str description: Operation request description.
        :param Sequence['ParameterContractInvokeResponseArgs'] headers: Collection of operation request headers.
        :param Sequence['ParameterContractInvokeResponseArgs'] query_parameters: Collection of operation request query parameters.
        :param Sequence['RepresentationContractInvokeResponseArgs'] representations: Collection of operation request representations.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter
    def headers(self) -> Optional[Sequence['outputs.ParameterContractInvokeResponseResult']]:
        """
    ...
    def query_parameters(self) -> Optional[Sequence['outputs.ParameterContractInvokeResponseResult']]:
        """
    ...
    @property
    @pulumi.getter
    def representations(self) -> Optional[Sequence['outputs.RepresentationContractInvokeResponseResult']]:
        """
...
@pulumi.output_type
class ResponseContractInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['ParameterContractInvokeResponseArgs'] headers: Collection of operation response headers.
        :param Sequence['RepresentationContractInvokeResponseArgs'] representations: Collection of operation response representations.
        """
...
@pulumi.output_type
class SubscriptionKeyParameterNamesContractInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class TokenBodyParameterContractInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class UserIdentityContractInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class X509CertificateNameInvokeResponseResult(dict):
    """
