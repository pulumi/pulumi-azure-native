...
class GetApiManagementServiceResult:
    ...
    """
    def __init__(__self__, additional_locations=None, certificates=None, created_at_utc=None, custom_properties=None, etag=None, gateway_regional_url=None, gateway_url=None, hostname_configurations=None, id=None, identity=None, location=None, management_api_url=None, name=None, notification_sender_email=None, portal_url=None, provisioning_state=None, publisher_email=None, publisher_name=None, scm_url=None, sku=None, static_ips=None, tags=None, target_provisioning_state=None, type=None, virtual_network_configuration=None, virtual_network_type=None):
...
def get_api_management_service(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/v20170301:getApiManagementService', __args__, opts=opts, typ=GetApiManagementServiceResult).value
