...
class TagByApi(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement:TagByApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:TagByApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:TagByApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:TagByApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:TagByApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:TagByApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:TagByApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:TagByApi")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagByApi, __self__).__init__(
            'azure-nextgen:apimanagement/v20170301:TagByApi',
            resource_name,
            __props__,
            opts)
