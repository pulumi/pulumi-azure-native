...
class GetApiResult:
    ...
    def api_version_set(self) -> Optional['outputs.ApiVersionSetContractInvokeResponseResult']:
        """
...
def get_api(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/v20170301:getApi', __args__, opts=opts, typ=GetApiResult).value
