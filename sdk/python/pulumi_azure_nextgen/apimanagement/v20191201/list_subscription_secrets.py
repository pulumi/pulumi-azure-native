...
def list_subscription_secrets(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/v20191201:listSubscriptionSecrets', __args__, opts=opts, typ=ListSubscriptionSecretsResult).value
