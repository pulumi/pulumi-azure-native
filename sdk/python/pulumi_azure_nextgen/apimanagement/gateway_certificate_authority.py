...
class GatewayCertificateAuthority(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:GatewayCertificateAuthority")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GatewayCertificateAuthority, __self__).__init__(
            'azure-nextgen:apimanagement:GatewayCertificateAuthority',
            resource_name,
            __props__,
            opts)
