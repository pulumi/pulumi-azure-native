...
class TagByProduct(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/latest:TagByProduct"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:TagByProduct"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:TagByProduct"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:TagByProduct"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:TagByProduct"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:TagByProduct"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:TagByProduct")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagByProduct, __self__).__init__(
            'azure-nextgen:apimanagement/v20190101:TagByProduct',
            resource_name,
            __props__,
            opts)
