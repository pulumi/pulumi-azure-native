...
class ContentItem(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ContentItem"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ContentItem"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ContentItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContentItem, __self__).__init__(
            'azure-nextgen:apimanagement:ContentItem',
            resource_name,
            __props__,
            opts)
