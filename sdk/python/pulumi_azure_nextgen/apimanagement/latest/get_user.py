...
class GetUserResult:
    ...
    @property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GroupContractPropertiesInvokeResponseResult']:
        """
    ...
    @property
    @pulumi.getter
    def identities(self) -> Optional[Sequence['outputs.UserIdentityContractInvokeResponseResult']]:
        """
...
def get_user(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/latest:getUser', __args__, opts=opts, typ=GetUserResult).value
