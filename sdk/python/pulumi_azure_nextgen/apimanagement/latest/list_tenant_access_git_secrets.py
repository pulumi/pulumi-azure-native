...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:apimanagement:listTenantAccessGitSecrets'.""", DeprecationWarning)
...
def list_tenant_access_git_secrets(access_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("list_tenant_access_git_secrets is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:apimanagement:listTenantAccessGitSecrets'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/latest:listTenantAccessGitSecrets', __args__, opts=opts, typ=ListTenantAccessGitSecretsResult).value
