...
def list_identity_provider_secrets(identity_provider_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/latest:listIdentityProviderSecrets', __args__, opts=opts, typ=ListIdentityProviderSecretsResult).value
