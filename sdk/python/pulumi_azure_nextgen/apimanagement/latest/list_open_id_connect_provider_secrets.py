...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:apimanagement:listOpenIdConnectProviderSecrets'.""", DeprecationWarning)
...
def list_open_id_connect_provider_secrets(opid: Optional[str] = None,
    ...
    """
    pulumi.log.warn("list_open_id_connect_provider_secrets is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:apimanagement:listOpenIdConnectProviderSecrets'.")
    __args__ = dict()
    __args__['opid'] = opid
