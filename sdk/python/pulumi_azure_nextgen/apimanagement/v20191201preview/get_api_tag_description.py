...
def get_api_tag_description(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/v20191201preview:getApiTagDescription', __args__, opts=opts, typ=GetApiTagDescriptionResult).value
