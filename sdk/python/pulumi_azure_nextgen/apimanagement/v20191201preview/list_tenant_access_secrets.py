...
def list_tenant_access_secrets(access_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/v20191201preview:listTenantAccessSecrets', __args__, opts=opts, typ=ListTenantAccessSecretsResult).value
