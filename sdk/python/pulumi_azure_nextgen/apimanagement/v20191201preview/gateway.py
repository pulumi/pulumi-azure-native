...
class Gateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/latest:Gateway"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:Gateway"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:Gateway")])
