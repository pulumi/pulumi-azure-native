...
class GetLoggerResult:
    ...
    Logger details.
    """
    def __init__(__self__, credentials=None, description=None, id=None, is_buffered=None, logger_type=None, name=None, type=None):
...
def get_logger(loggerid: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:apimanagement/v20180101:getLogger', __args__, opts=opts, typ=GetLoggerResult).value
