...
class ProductGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ProductGroup"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ProductGroup"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:ProductGroup"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:ProductGroup"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ProductGroup"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:ProductGroup"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ProductGroup")])
