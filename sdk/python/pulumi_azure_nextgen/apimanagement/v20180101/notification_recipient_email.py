...
class NotificationRecipientEmail(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement:NotificationRecipientEmail"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:NotificationRecipientEmail"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:NotificationRecipientEmail"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:NotificationRecipientEmail"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:NotificationRecipientEmail"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:NotificationRecipientEmail"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:NotificationRecipientEmail"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:NotificationRecipientEmail")])
