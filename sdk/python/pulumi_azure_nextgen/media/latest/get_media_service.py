...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:media:getMediaService'.""", DeprecationWarning)
...
def get_media_service(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_media_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:media:getMediaService'.")
    __args__ = dict()
