...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:media/v20180601preview:Asset":
                return Asset(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:ContentKeyPolicy":
                return ContentKeyPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:Job":
                return Job(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:LiveEvent":
                return LiveEvent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:LiveOutput":
                return LiveOutput(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:MediaService":
                return MediaService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:StreamingEndpoint":
                return StreamingEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:StreamingLocator":
                return StreamingLocator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:StreamingPolicy":
                return StreamingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:media/v20180601preview:Transform":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "media/v20180601preview", _module_instance)
