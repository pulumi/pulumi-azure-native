...
__all__ = [
    ...
    'MediaGraphUserCredentialsInvokeResponseResult',
...
class MediaGraphRtspSourceInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 odata_type: str,
                 rtsp_url: str,
                 credentials: Optional['outputs.MediaGraphUserCredentialsInvokeResponseResult'] = None):
        """
        RTSP source
        ...
        :param 'MediaGraphUserCredentialsInvokeResponseArgs' credentials: RTSP Credentials
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def credentials(self) -> Optional['outputs.MediaGraphUserCredentialsInvokeResponseResult']:
        """
        RTSP Credentials
        """
...
@pulumi.output_type
class MediaGraphUserCredentialsInvokeResponseResult(dict):
    """
