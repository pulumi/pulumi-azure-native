...
class GetAssetEncryptionKeyResult:
    ...
    def asset_file_encryption_metadata(self) -> Optional[Sequence['outputs.AssetFileEncryptionMetadataInvokeResponseResult']]:
        """
...
def get_asset_encryption_key(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:media/v20180701:getAssetEncryptionKey', __args__, opts=opts, typ=GetAssetEncryptionKeyResult).value
