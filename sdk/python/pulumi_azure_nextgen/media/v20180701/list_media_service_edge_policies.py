...
class ListMediaServiceEdgePoliciesResult:
    ...
    def usage_data_collection_policy(self) -> Optional['outputs.EdgeUsageDataCollectionPolicyInvokeResponseResult']:
...
def list_media_service_edge_policies(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:media/v20180701:listMediaServiceEdgePolicies', __args__, opts=opts, typ=ListMediaServiceEdgePoliciesResult).value
