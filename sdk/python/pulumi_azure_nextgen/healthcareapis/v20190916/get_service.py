...
class GetServiceResult:
    ...
    @property
    @pulumi.getter
    def identity(self) -> Optional['outputs.ResourceInvokeResponseIdentityResult']:
        """
...
def get_service(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:healthcareapis/v20190916:getService', __args__, opts=opts, typ=GetServiceResult).value
