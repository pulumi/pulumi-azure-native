...
class GetArtifactSourceResult:
    ...
    @property
    @pulumi.getter
    def authentication(self) -> 'outputs.SasAuthenticationInvokeResponseResult':
        """
...
def get_artifact_source(artifact_source_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:deploymentmanager/v20191101preview:getArtifactSource', __args__, opts=opts, typ=GetArtifactSourceResult).value
