...
def get_service_topology(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:deploymentmanager/v20180901preview:getServiceTopology', __args__, opts=opts, typ=GetServiceTopologyResult).value
