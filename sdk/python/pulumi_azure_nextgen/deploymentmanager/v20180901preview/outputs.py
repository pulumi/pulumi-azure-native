...
@pulumi.output_type
class StepInvokeResponseResult(dict):
    """
...
class WaitStepPropertiesInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 step_type: str,
                 attributes: Optional['outputs.WaitStepAttributesInvokeResponseResult'] = None):
        """
        Defines the properties of a Wait step.
    ...
    @property
    @pulumi.getter
    def attributes(self) -> Optional['outputs.WaitStepAttributesInvokeResponseResult']:
        """
        The Wait attributes
        """
