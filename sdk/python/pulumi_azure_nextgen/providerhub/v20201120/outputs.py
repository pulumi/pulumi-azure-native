...
__all__ = [
    'AuthorizationActionMappingInvokeResponseResult',
    'AuthorizationActionMappingResponse',
    'DefaultRolloutPropertiesInvokeResponseSpecificationResult',
    'DefaultRolloutPropertiesInvokeResponseStatusResult',
    'DefaultRolloutPropertiesResponseSpecification',
    'DefaultRolloutPropertiesResponseStatus',
    'DefaultRolloutSpecificationInvokeResponseCanaryResult',
    'DefaultRolloutSpecificationInvokeResponseHighTrafficResult',
    'DefaultRolloutSpecificationInvokeResponseLowTrafficResult',
    'DefaultRolloutSpecificationInvokeResponseMediumTrafficResult',
    'DefaultRolloutSpecificationInvokeResponseProviderRegistrationResult',
    'DefaultRolloutSpecificationInvokeResponseRestOfTheWorldGroupOneResult',
    'DefaultRolloutSpecificationInvokeResponseRestOfTheWorldGroupTwoResult',
    ...
    'ExtendedErrorInfoInvokeResponseResult',
    'ExtendedErrorInfoResponse',
    'ExtendedLocationOptionsInvokeResponseResult',
    'ExtendedLocationOptionsResponse',
    'LightHouseAuthorizationInvokeResponseResult',
    'LightHouseAuthorizationResponse',
    'LinkedAccessCheckInvokeResponseResult',
    'LinkedAccessCheckResponse',
    'LoggingRuleInvokeResponseResult',
    'LoggingRuleInvokeResponseHiddenPropertyPathsResult',
    'LoggingRuleResponse',
    'LoggingRuleResponseHiddenPropertyPaths',
    'NotificationEndpointInvokeResponseResult',
    'NotificationEndpointResponse',
    'NotificationRegistrationInvokeResponsePropertiesResult',
    'NotificationRegistrationResponseProperties',
    'OperationsDefinitionResponseDisplay',
    'ProviderHubMetadataInvokeResponseProviderAuthenticationResult',
    'ProviderHubMetadataInvokeResponseThirdPartyProviderAuthorizationResult',
    'ProviderHubMetadataResponseProviderAuthentication',
    'ProviderHubMetadataResponseThirdPartyProviderAuthorization',
    'ProviderRegistrationInvokeResponsePropertiesResult',
    'ProviderRegistrationPropertiesInvokeResponseProviderHubMetadataResult',
    'ProviderRegistrationPropertiesInvokeResponseSubscriptionLifecycleNotificationSpecificationsResult',
    ...
    'ResourceProviderAuthorizationInvokeResponseResult',
    'ResourceProviderAuthorizationResponse',
    'ResourceProviderCapabilitiesInvokeResponseResult',
    'ResourceProviderCapabilitiesResponse',
    'ResourceProviderManifestPropertiesInvokeResponseFeaturesRuleResult',
    'ResourceProviderManifestPropertiesInvokeResponseManagementResult',
    'ResourceProviderManifestPropertiesInvokeResponseProviderAuthenticationResult',
    'ResourceProviderManifestPropertiesInvokeResponseRequestHeaderOptionsResult',
    'ResourceProviderManifestPropertiesInvokeResponseTemplateDeploymentOptionsResult',
    ...
    'ResourceTypeEndpointInvokeResponseResult',
    'ResourceTypeEndpointInvokeResponseFeaturesRuleResult',
    'ResourceTypeEndpointResponse',
    'ResourceTypeEndpointResponseFeaturesRule',
    'ResourceTypeExtensionInvokeResponseResult',
    'ResourceTypeExtensionOptionsInvokeResponseResourceCreationBeginResult',
    'ResourceTypeExtensionOptionsResponseResourceCreationBegin',
    'ResourceTypeExtensionResponse',
    'ResourceTypeRegistrationInvokeResponseResult',
    'ResourceTypeRegistrationInvokeResponsePropertiesResult',
    'ResourceTypeRegistrationPropertiesInvokeResponseCheckNameAvailabilitySpecificationsResult',
    'ResourceTypeRegistrationPropertiesInvokeResponseExtensionOptionsResult',
    'ResourceTypeRegistrationPropertiesInvokeResponseFeaturesRuleResult',
    'ResourceTypeRegistrationPropertiesInvokeResponseIdentityManagementResult',
    'ResourceTypeRegistrationPropertiesInvokeResponseRequestHeaderOptionsResult',
    'ResourceTypeRegistrationPropertiesInvokeResponseResourceMovePolicyResult',
    'ResourceTypeRegistrationPropertiesInvokeResponseSubscriptionLifecycleNotificationSpecificationsResult',
    'ResourceTypeRegistrationPropertiesInvokeResponseTemplateDeploymentOptionsResult',
    ...
    'ServiceTreeInfoInvokeResponseResult',
    'ServiceTreeInfoResponse',
    'SkuCapabilityInvokeResponseResult',
    'SkuCapabilityResponse',
    'SkuCostInvokeResponseResult',
    'SkuCostResponse',
    'SkuLocationInfoInvokeResponseResult',
    'SkuLocationInfoResponse',
    'SkuResourceInvokeResponsePropertiesResult',
    'SkuResourceResponseProperties',
    'SkuSettingInvokeResponseResult',
    'SkuSettingInvokeResponseCapacityResult',
    'SkuSettingResponse',
    'SkuSettingResponseCapacity',
    'SkuZoneDetailInvokeResponseResult',
    'SkuZoneDetailResponse',
    'SubscriptionStateOverrideActionInvokeResponseResult',
    'SubscriptionStateOverrideActionResponse',
    'SubscriptionStateRuleInvokeResponseResult',
    'SubscriptionStateRuleResponse',
    'SwaggerSpecificationInvokeResponseResult',
    'SwaggerSpecificationResponse',
    'ThrottlingMetricInvokeResponseResult',
    'ThrottlingMetricResponse',
    'ThrottlingRuleInvokeResponseResult',
...
@pulumi.output_type
class AuthorizationActionMappingInvokeResponseResult(dict):
...
@pulumi.output_type
class DefaultRolloutPropertiesInvokeResponseSpecificationResult(dict):
    def __init__(__self__, *,
                 canary: Optional['outputs.DefaultRolloutSpecificationInvokeResponseCanaryResult'] = None,
                 high_traffic: Optional['outputs.DefaultRolloutSpecificationInvokeResponseHighTrafficResult'] = None,
                 low_traffic: Optional['outputs.DefaultRolloutSpecificationInvokeResponseLowTrafficResult'] = None,
                 medium_traffic: Optional['outputs.DefaultRolloutSpecificationInvokeResponseMediumTrafficResult'] = None,
                 provider_registration: Optional['outputs.DefaultRolloutSpecificationInvokeResponseProviderRegistrationResult'] = None,
                 resource_type_registrations: Optional[Sequence['outputs.ResourceTypeRegistrationInvokeResponseResult']] = None,
                 rest_of_the_world_group_one: Optional['outputs.DefaultRolloutSpecificationInvokeResponseRestOfTheWorldGroupOneResult'] = None,
                 rest_of_the_world_group_two: Optional['outputs.DefaultRolloutSpecificationInvokeResponseRestOfTheWorldGroupTwoResult'] = None):
    ...
    @property
    @pulumi.getter
    def canary(self) -> Optional['outputs.DefaultRolloutSpecificationInvokeResponseCanaryResult']:
        return pulumi.get(self, "canary")

    @property
    @pulumi.getter(name="highTraffic")
    def high_traffic(self) -> Optional['outputs.DefaultRolloutSpecificationInvokeResponseHighTrafficResult']:
        return pulumi.get(self, "high_traffic")

    @property
    @pulumi.getter(name="lowTraffic")
    def low_traffic(self) -> Optional['outputs.DefaultRolloutSpecificationInvokeResponseLowTrafficResult']:
        return pulumi.get(self, "low_traffic")

    @property
    @pulumi.getter(name="mediumTraffic")
    def medium_traffic(self) -> Optional['outputs.DefaultRolloutSpecificationInvokeResponseMediumTrafficResult']:
        return pulumi.get(self, "medium_traffic")

    @property
    @pulumi.getter(name="providerRegistration")
    def provider_registration(self) -> Optional['outputs.DefaultRolloutSpecificationInvokeResponseProviderRegistrationResult']:
        return pulumi.get(self, "provider_registration")

    @property
    @pulumi.getter(name="resourceTypeRegistrations")
    def resource_type_registrations(self) -> Optional[Sequence['outputs.ResourceTypeRegistrationInvokeResponseResult']]:
        return pulumi.get(self, "resource_type_registrations")

    @property
    @pulumi.getter(name="restOfTheWorldGroupOne")
    def rest_of_the_world_group_one(self) -> Optional['outputs.DefaultRolloutSpecificationInvokeResponseRestOfTheWorldGroupOneResult']:
        return pulumi.get(self, "rest_of_the_world_group_one")

    @property
    @pulumi.getter(name="restOfTheWorldGroupTwo")
    def rest_of_the_world_group_two(self) -> Optional['outputs.DefaultRolloutSpecificationInvokeResponseRestOfTheWorldGroupTwoResult']:
        return pulumi.get(self, "rest_of_the_world_group_two")


@pulumi.output_type
class DefaultRolloutPropertiesInvokeResponseStatusResult(dict):
    def __init__(__self__, *,
                 completed_regions: Optional[Sequence[str]] = None,
                 failed_or_skipped_regions: Optional[Mapping[str, 'outputs.ExtendedErrorInfoInvokeResponseResult']] = None,
    ...
    def failed_or_skipped_regions(self) -> Optional[Mapping[str, 'outputs.ExtendedErrorInfoInvokeResponseResult']]:
...
@pulumi.output_type
class DefaultRolloutSpecificationInvokeResponseCanaryResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class DefaultRolloutSpecificationInvokeResponseHighTrafficResult(dict):
    def __init__(__self__, *,
                 regions: Optional[Sequence[str]] = None,
...
@pulumi.output_type
class DefaultRolloutSpecificationInvokeResponseLowTrafficResult(dict):
    def __init__(__self__, *,
                 regions: Optional[Sequence[str]] = None,
                 wait_duration: Optional[str] = None):
        if regions is not None:
...
@pulumi.output_type
class DefaultRolloutSpecificationInvokeResponseMediumTrafficResult(dict):
    def __init__(__self__, *,
                 regions: Optional[Sequence[str]] = None,
                 wait_duration: Optional[str] = None):
        if regions is not None:
...
@pulumi.output_type
class DefaultRolloutSpecificationInvokeResponseProviderRegistrationResult(dict):
    def __init__(__self__, *,
                 id: str,
                 name: str,
                 type: str,
                 properties: Optional['outputs.ProviderRegistrationInvokeResponsePropertiesResult'] = None):
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional['outputs.ProviderRegistrationInvokeResponsePropertiesResult']:
        return pulumi.get(self, "properties")


@pulumi.output_type
class DefaultRolloutSpecificationInvokeResponseRestOfTheWorldGroupOneResult(dict):
    def __init__(__self__, *,
                 regions: Optional[Sequence[str]] = None,
                 wait_duration: Optional[str] = None):
        if regions is not None:
...
@pulumi.output_type
class DefaultRolloutSpecificationInvokeResponseRestOfTheWorldGroupTwoResult(dict):
    def __init__(__self__, *,
                 regions: Optional[Sequence[str]] = None,
                 wait_duration: Optional[str] = None):
        if regions is not None:
...
@pulumi.output_type
class ExtendedErrorInfoInvokeResponseResult(dict):
    def __init__(__self__, *,
                 additional_info: Optional[Sequence['outputs.TypedErrorInfoInvokeResponseResult']] = None,
                 code: Optional[str] = None,
                 details: Optional[Sequence['outputs.ExtendedErrorInfoInvokeResponseResult']] = None,
    ...
    def additional_info(self) -> Optional[Sequence['outputs.TypedErrorInfoInvokeResponseResult']]:
    ...
    @property
    @pulumi.getter
    def details(self) -> Optional[Sequence['outputs.ExtendedErrorInfoInvokeResponseResult']]:
...
@pulumi.output_type
class ExtendedLocationOptionsInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class LightHouseAuthorizationInvokeResponseResult(dict):
    def __init__(__self__, *,
                 principal_id: str,
...
@pulumi.output_type
class LinkedAccessCheckInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class LoggingRuleInvokeResponseResult(dict):
    def __init__(__self__, *,
                 action: str,
                 detail_level: str,
                 direction: str,
                 hidden_property_paths: Optional['outputs.LoggingRuleInvokeResponseHiddenPropertyPathsResult'] = None):
    ...
    def hidden_property_paths(self) -> Optional['outputs.LoggingRuleInvokeResponseHiddenPropertyPathsResult']:
        return pulumi.get(self, "hidden_property_paths")


@pulumi.output_type
class LoggingRuleInvokeResponseHiddenPropertyPathsResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class NotificationEndpointInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class NotificationRegistrationInvokeResponsePropertiesResult(dict):
    def __init__(__self__, *,
                 included_events: Optional[Sequence[str]] = None,
                 message_scope: Optional[str] = None,
                 notification_endpoints: Optional[Sequence['outputs.NotificationEndpointInvokeResponseResult']] = None,
    ...
    def notification_endpoints(self) -> Optional[Sequence['outputs.NotificationEndpointInvokeResponseResult']]:
...
@pulumi.output_type
class ProviderHubMetadataInvokeResponseProviderAuthenticationResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ProviderHubMetadataInvokeResponseThirdPartyProviderAuthorizationResult(dict):
    def __init__(__self__, *,
                 authorizations: Optional[Sequence['outputs.LightHouseAuthorizationInvokeResponseResult']] = None,
    ...
    @property
    @pulumi.getter
    def authorizations(self) -> Optional[Sequence['outputs.LightHouseAuthorizationInvokeResponseResult']]:
...
@pulumi.output_type
class ProviderRegistrationInvokeResponsePropertiesResult(dict):
    def __init__(__self__, *,
                 capabilities: Optional[Sequence['outputs.ResourceProviderCapabilitiesInvokeResponseResult']] = None,
                 features_rule: Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseFeaturesRuleResult'] = None,
                 management: Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseManagementResult'] = None,
                 metadata: Optional[Any] = None,
                 namespace: Optional[str] = None,
                 provider_authentication: Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseProviderAuthenticationResult'] = None,
                 provider_authorizations: Optional[Sequence['outputs.ResourceProviderAuthorizationInvokeResponseResult']] = None,
                 provider_hub_metadata: Optional['outputs.ProviderRegistrationPropertiesInvokeResponseProviderHubMetadataResult'] = None,
                 provider_type: Optional[str] = None,
                 provider_version: Optional[str] = None,
                 provisioning_state: Optional[str] = None,
                 request_header_options: Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseRequestHeaderOptionsResult'] = None,
                 required_features: Optional[Sequence[str]] = None,
                 subscription_lifecycle_notification_specifications: Optional['outputs.ProviderRegistrationPropertiesInvokeResponseSubscriptionLifecycleNotificationSpecificationsResult'] = None,
                 template_deployment_options: Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseTemplateDeploymentOptionsResult'] = None):
    ...
    @property
    @pulumi.getter
    def capabilities(self) -> Optional[Sequence['outputs.ResourceProviderCapabilitiesInvokeResponseResult']]:
        return pulumi.get(self, "capabilities")

    @property
    @pulumi.getter(name="featuresRule")
    def features_rule(self) -> Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseFeaturesRuleResult']:
        return pulumi.get(self, "features_rule")

    @property
    @pulumi.getter
    def management(self) -> Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseManagementResult']:
    ...
    def provider_authentication(self) -> Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseProviderAuthenticationResult']:
        return pulumi.get(self, "provider_authentication")

    @property
    @pulumi.getter(name="providerAuthorizations")
    def provider_authorizations(self) -> Optional[Sequence['outputs.ResourceProviderAuthorizationInvokeResponseResult']]:
        return pulumi.get(self, "provider_authorizations")

    @property
    @pulumi.getter(name="providerHubMetadata")
    def provider_hub_metadata(self) -> Optional['outputs.ProviderRegistrationPropertiesInvokeResponseProviderHubMetadataResult']:
    ...
    def request_header_options(self) -> Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseRequestHeaderOptionsResult']:
    ...
    def subscription_lifecycle_notification_specifications(self) -> Optional['outputs.ProviderRegistrationPropertiesInvokeResponseSubscriptionLifecycleNotificationSpecificationsResult']:
        return pulumi.get(self, "subscription_lifecycle_notification_specifications")

    @property
    @pulumi.getter(name="templateDeploymentOptions")
    def template_deployment_options(self) -> Optional['outputs.ResourceProviderManifestPropertiesInvokeResponseTemplateDeploymentOptionsResult']:
        return pulumi.get(self, "template_deployment_options")


@pulumi.output_type
class ProviderRegistrationPropertiesInvokeResponseProviderHubMetadataResult(dict):
    def __init__(__self__, *,
                 provider_authentication: Optional['outputs.ProviderHubMetadataInvokeResponseProviderAuthenticationResult'] = None,
                 provider_authorizations: Optional[Sequence['outputs.ResourceProviderAuthorizationInvokeResponseResult']] = None,
                 third_party_provider_authorization: Optional['outputs.ProviderHubMetadataInvokeResponseThirdPartyProviderAuthorizationResult'] = None):
        if provider_authentication is not None:
            pulumi.set(__self__, "provider_authentication", provider_authentication)
        if provider_authorizations is not None:
            pulumi.set(__self__, "provider_authorizations", provider_authorizations)
    ...
    @property
    @pulumi.getter(name="providerAuthentication")
    def provider_authentication(self) -> Optional['outputs.ProviderHubMetadataInvokeResponseProviderAuthenticationResult']:
        return pulumi.get(self, "provider_authentication")
    ...
    def third_party_provider_authorization(self) -> Optional['outputs.ProviderHubMetadataInvokeResponseThirdPartyProviderAuthorizationResult']:
        return pulumi.get(self, "third_party_provider_authorization")


@pulumi.output_type
class ProviderRegistrationPropertiesInvokeResponseSubscriptionLifecycleNotificationSpecificationsResult(dict):
    def __init__(__self__, *,
                 soft_delete_ttl: Optional[str] = None,
                 subscription_state_override_actions: Optional[Sequence['outputs.SubscriptionStateOverrideActionInvokeResponseResult']] = None):
    ...
    def subscription_state_override_actions(self) -> Optional[Sequence['outputs.SubscriptionStateOverrideActionInvokeResponseResult']]:
...
@pulumi.output_type
class ResourceProviderAuthorizationInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceProviderCapabilitiesInvokeResponseResult(dict):
    def __init__(__self__, *,
                 effect: str,
                 quota_id: str,
                 required_features: Optional[Sequence[str]] = None):
...
@pulumi.output_type
class ResourceProviderManifestPropertiesInvokeResponseFeaturesRuleResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceProviderManifestPropertiesInvokeResponseManagementResult(dict):
    def __init__(__self__, *,
                 ...
                 service_tree_infos: Optional[Sequence['outputs.ServiceTreeInfoInvokeResponseResult']] = None):
    ...
    def service_tree_infos(self) -> Optional[Sequence['outputs.ServiceTreeInfoInvokeResponseResult']]:
        return pulumi.get(self, "service_tree_infos")


@pulumi.output_type
class ResourceProviderManifestPropertiesInvokeResponseProviderAuthenticationResult(dict):
    def __init__(__self__, *,
                 allowed_audiences: Sequence[str]):
        pulumi.set(__self__, "allowed_audiences", allowed_audiences)
...
@pulumi.output_type
class ResourceProviderManifestPropertiesInvokeResponseRequestHeaderOptionsResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceProviderManifestPropertiesInvokeResponseTemplateDeploymentOptionsResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceTypeEndpointInvokeResponseResult(dict):
    def __init__(__self__, *,
                 api_versions: Optional[Sequence[str]] = None,
                 enabled: Optional[bool] = None,
                 extensions: Optional[Sequence['outputs.ResourceTypeExtensionInvokeResponseResult']] = None,
                 features_rule: Optional['outputs.ResourceTypeEndpointInvokeResponseFeaturesRuleResult'] = None,
                 locations: Optional[Sequence[str]] = None,
                 required_features: Optional[Sequence[str]] = None,
    ...
    @property
    @pulumi.getter
    def extensions(self) -> Optional[Sequence['outputs.ResourceTypeExtensionInvokeResponseResult']]:
        return pulumi.get(self, "extensions")

    @property
    @pulumi.getter(name="featuresRule")
    def features_rule(self) -> Optional['outputs.ResourceTypeEndpointInvokeResponseFeaturesRuleResult']:
        return pulumi.get(self, "features_rule")
...
@pulumi.output_type
class ResourceTypeEndpointInvokeResponseFeaturesRuleResult(dict):
    def __init__(__self__, *,
                 required_features_policy: str):
        pulumi.set(__self__, "required_features_policy", required_features_policy)
...
@pulumi.output_type
class ResourceTypeExtensionInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceTypeExtensionOptionsInvokeResponseResourceCreationBeginResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceTypeRegistrationInvokeResponseResult(dict):
    def __init__(__self__, *,
                 id: str,
                 name: str,
                 type: str,
                 properties: Optional['outputs.ResourceTypeRegistrationInvokeResponsePropertiesResult'] = None):
        """
        :param str id: Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
        :param str name: The name of the resource
        :param str type: The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional['outputs.ResourceTypeRegistrationInvokeResponsePropertiesResult']:
        return pulumi.get(self, "properties")


@pulumi.output_type
class ResourceTypeRegistrationInvokeResponsePropertiesResult(dict):
    def __init__(__self__, *,
                 allowed_unauthorized_actions: Optional[Sequence[str]] = None,
                 authorization_action_mappings: Optional[Sequence['outputs.AuthorizationActionMappingInvokeResponseResult']] = None,
                 check_name_availability_specifications: Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseCheckNameAvailabilitySpecificationsResult'] = None,
                 ...
                 endpoints: Optional[Sequence['outputs.ResourceTypeEndpointInvokeResponseResult']] = None,
                 extended_locations: Optional[Sequence['outputs.ExtendedLocationOptionsInvokeResponseResult']] = None,
                 extension_options: Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseExtensionOptionsResult'] = None,
                 features_rule: Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseFeaturesRuleResult'] = None,
                 identity_management: Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseIdentityManagementResult'] = None,
                 is_pure_proxy: Optional[bool] = None,
                 linked_access_checks: Optional[Sequence['outputs.LinkedAccessCheckInvokeResponseResult']] = None,
                 logging_rules: Optional[Sequence['outputs.LoggingRuleInvokeResponseResult']] = None,
                 marketplace_type: Optional[str] = None,
                 provisioning_state: Optional[str] = None,
                 regionality: Optional[str] = None,
                 request_header_options: Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseRequestHeaderOptionsResult'] = None,
                 required_features: Optional[Sequence[str]] = None,
                 resource_deletion_policy: Optional[str] = None,
                 resource_move_policy: Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseResourceMovePolicyResult'] = None,
                 routing_type: Optional[str] = None,
                 service_tree_infos: Optional[Sequence['outputs.ServiceTreeInfoInvokeResponseResult']] = None,
                 subscription_lifecycle_notification_specifications: Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseSubscriptionLifecycleNotificationSpecificationsResult'] = None,
                 subscription_state_rules: Optional[Sequence['outputs.SubscriptionStateRuleInvokeResponseResult']] = None,
                 swagger_specifications: Optional[Sequence['outputs.SwaggerSpecificationInvokeResponseResult']] = None,
                 template_deployment_options: Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseTemplateDeploymentOptionsResult'] = None,
                 throttling_rules: Optional[Sequence['outputs.ThrottlingRuleInvokeResponseResult']] = None):
    ...
    def authorization_action_mappings(self) -> Optional[Sequence['outputs.AuthorizationActionMappingInvokeResponseResult']]:
        return pulumi.get(self, "authorization_action_mappings")

    @property
    @pulumi.getter(name="checkNameAvailabilitySpecifications")
    def check_name_availability_specifications(self) -> Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseCheckNameAvailabilitySpecificationsResult']:
    ...
    @property
    @pulumi.getter
    def endpoints(self) -> Optional[Sequence['outputs.ResourceTypeEndpointInvokeResponseResult']]:
        return pulumi.get(self, "endpoints")

    @property
    @pulumi.getter(name="extendedLocations")
    def extended_locations(self) -> Optional[Sequence['outputs.ExtendedLocationOptionsInvokeResponseResult']]:
        return pulumi.get(self, "extended_locations")

    @property
    @pulumi.getter(name="extensionOptions")
    def extension_options(self) -> Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseExtensionOptionsResult']:
        return pulumi.get(self, "extension_options")

    @property
    @pulumi.getter(name="featuresRule")
    def features_rule(self) -> Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseFeaturesRuleResult']:
        return pulumi.get(self, "features_rule")

    @property
    @pulumi.getter(name="identityManagement")
    def identity_management(self) -> Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseIdentityManagementResult']:
    ...
    def linked_access_checks(self) -> Optional[Sequence['outputs.LinkedAccessCheckInvokeResponseResult']]:
        return pulumi.get(self, "linked_access_checks")

    @property
    @pulumi.getter(name="loggingRules")
    def logging_rules(self) -> Optional[Sequence['outputs.LoggingRuleInvokeResponseResult']]:
    ...
    @property
    @pulumi.getter(name="requestHeaderOptions")
    def request_header_options(self) -> Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseRequestHeaderOptionsResult']:
        return pulumi.get(self, "request_header_options")
    ...
    def resource_move_policy(self) -> Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseResourceMovePolicyResult']:
    ...
    @property
    @pulumi.getter(name="subscriptionLifecycleNotificationSpecifications")
    def subscription_lifecycle_notification_specifications(self) -> Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseSubscriptionLifecycleNotificationSpecificationsResult']:
        return pulumi.get(self, "subscription_lifecycle_notification_specifications")

    @property
    @pulumi.getter(name="subscriptionStateRules")
    def subscription_state_rules(self) -> Optional[Sequence['outputs.SubscriptionStateRuleInvokeResponseResult']]:
        return pulumi.get(self, "subscription_state_rules")

    @property
    @pulumi.getter(name="swaggerSpecifications")
    def swagger_specifications(self) -> Optional[Sequence['outputs.SwaggerSpecificationInvokeResponseResult']]:
        return pulumi.get(self, "swagger_specifications")

    @property
    @pulumi.getter(name="templateDeploymentOptions")
    def template_deployment_options(self) -> Optional['outputs.ResourceTypeRegistrationPropertiesInvokeResponseTemplateDeploymentOptionsResult']:
        return pulumi.get(self, "template_deployment_options")

    @property
    @pulumi.getter(name="throttlingRules")
    def throttling_rules(self) -> Optional[Sequence['outputs.ThrottlingRuleInvokeResponseResult']]:
        return pulumi.get(self, "throttling_rules")


@pulumi.output_type
class ResourceTypeRegistrationPropertiesInvokeResponseCheckNameAvailabilitySpecificationsResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceTypeRegistrationPropertiesInvokeResponseExtensionOptionsResult(dict):
    def __init__(__self__, *,
                 resource_creation_begin: Optional['outputs.ResourceTypeExtensionOptionsInvokeResponseResourceCreationBeginResult'] = None):
    ...
    def resource_creation_begin(self) -> Optional['outputs.ResourceTypeExtensionOptionsInvokeResponseResourceCreationBeginResult']:
        return pulumi.get(self, "resource_creation_begin")


@pulumi.output_type
class ResourceTypeRegistrationPropertiesInvokeResponseFeaturesRuleResult(dict):
    def __init__(__self__, *,
                 required_features_policy: str):
        pulumi.set(__self__, "required_features_policy", required_features_policy)
...
@pulumi.output_type
class ResourceTypeRegistrationPropertiesInvokeResponseIdentityManagementResult(dict):
    def __init__(__self__, *,
                 application_id: Optional[str] = None,
                 type: Optional[str] = None):
        if application_id is not None:
...
@pulumi.output_type
class ResourceTypeRegistrationPropertiesInvokeResponseRequestHeaderOptionsResult(dict):
    def __init__(__self__, *,
                 opt_in_headers: Optional[str] = None):
        if opt_in_headers is not None:
            pulumi.set(__self__, "opt_in_headers", opt_in_headers)
...
@pulumi.output_type
class ResourceTypeRegistrationPropertiesInvokeResponseResourceMovePolicyResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceTypeRegistrationPropertiesInvokeResponseSubscriptionLifecycleNotificationSpecificationsResult(dict):
    def __init__(__self__, *,
                 soft_delete_ttl: Optional[str] = None,
                 subscription_state_override_actions: Optional[Sequence['outputs.SubscriptionStateOverrideActionInvokeResponseResult']] = None):
        if soft_delete_ttl is not None:
...
@pulumi.output_type
class ResourceTypeRegistrationPropertiesInvokeResponseTemplateDeploymentOptionsResult(dict):
    def __init__(__self__, *,
                 preflight_options: Optional[Sequence[str]] = None,
                 preflight_supported: Optional[bool] = None):
        if preflight_options is not None:
...
@pulumi.output_type
class ServiceTreeInfoInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class SkuCostInvokeResponseResult(dict):
    def __init__(__self__, *,
                 meter_id: str,
...
@pulumi.output_type
class SkuLocationInfoInvokeResponseResult(dict):
    def __init__(__self__, *,
                 location: str,
                 extended_locations: Optional[Sequence[str]] = None,
                 type: Optional[str] = None,
                 zone_details: Optional[Sequence['outputs.SkuZoneDetailInvokeResponseResult']] = None,
    ...
    def zone_details(self) -> Optional[Sequence['outputs.SkuZoneDetailInvokeResponseResult']]:
...
@pulumi.output_type
class SkuResourceInvokeResponsePropertiesResult(dict):
    def __init__(__self__, *,
                 sku_settings: Sequence['outputs.SkuSettingInvokeResponseResult']):
        pulumi.set(__self__, "sku_settings", sku_settings)

    @property
    @pulumi.getter(name="skuSettings")
    def sku_settings(self) -> Sequence['outputs.SkuSettingInvokeResponseResult']:
...
@pulumi.output_type
class SkuSettingInvokeResponseResult(dict):
    def __init__(__self__, *,
                 name: str,
                 capabilities: Optional[Sequence['outputs.SkuCapabilityInvokeResponseResult']] = None,
                 capacity: Optional['outputs.SkuSettingInvokeResponseCapacityResult'] = None,
                 costs: Optional[Sequence['outputs.SkuCostInvokeResponseResult']] = None,
                 family: Optional[str] = None,
                 kind: Optional[str] = None,
                 location_info: Optional[Sequence['outputs.SkuLocationInfoInvokeResponseResult']] = None,
                 locations: Optional[Sequence[str]] = None,
                 required_features: Optional[Sequence[str]] = None,
    ...
    @property
    @pulumi.getter
    def capabilities(self) -> Optional[Sequence['outputs.SkuCapabilityInvokeResponseResult']]:
        return pulumi.get(self, "capabilities")

    @property
    @pulumi.getter
    def capacity(self) -> Optional['outputs.SkuSettingInvokeResponseCapacityResult']:
        return pulumi.get(self, "capacity")

    @property
    @pulumi.getter
    def costs(self) -> Optional[Sequence['outputs.SkuCostInvokeResponseResult']]:
    ...
    def location_info(self) -> Optional[Sequence['outputs.SkuLocationInfoInvokeResponseResult']]:
...
@pulumi.output_type
class SkuSettingInvokeResponseCapacityResult(dict):
    def __init__(__self__, *,
                 minimum: int,
...
@pulumi.output_type
class SkuZoneDetailInvokeResponseResult(dict):
    def __init__(__self__, *,
                 capabilities: Optional[Sequence['outputs.SkuCapabilityInvokeResponseResult']] = None,
...
@pulumi.output_type
class SubscriptionStateOverrideActionInvokeResponseResult(dict):
    def __init__(__self__, *,
                 action: str,
                 state: str):
        pulumi.set(__self__, "action", action)
...
@pulumi.output_type
class SubscriptionStateRuleInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class SwaggerSpecificationInvokeResponseResult(dict):
    def __init__(__self__, *,
                 api_versions: Optional[Sequence[str]] = None,
...
@pulumi.output_type
class ThrottlingMetricInvokeResponseResult(dict):
    def __init__(__self__, *,
                 limit: float,
                 type: str,
...
@pulumi.output_type
class ThrottlingRuleInvokeResponseResult(dict):
    def __init__(__self__, *,
                 action: str,
                 metrics: Sequence['outputs.ThrottlingMetricInvokeResponseResult'],
                 required_features: Optional[Sequence[str]] = None):
        pulumi.set(__self__, "action", action)
    ...
    @property
    @pulumi.getter
    def metrics(self) -> Sequence['outputs.ThrottlingMetricInvokeResponseResult']:
