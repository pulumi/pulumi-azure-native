...
class SkusNestedResourceTypeSecond(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-nextgen:providerhub/latest:SkusNestedResourceTypeSecond")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SkusNestedResourceTypeSecond, __self__).__init__(
            'azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeSecond',
            resource_name,
            __props__,
            opts)
