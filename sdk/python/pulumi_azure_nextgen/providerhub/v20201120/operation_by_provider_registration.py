...
class OperationByProviderRegistration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub:OperationByProviderRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/latest:OperationByProviderRegistration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OperationByProviderRegistration, __self__).__init__(
            'azure-nextgen:providerhub/v20201120:OperationByProviderRegistration',
            resource_name,
            __props__,
            opts)
