...
class ResourceTypeRegistration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/latest:ResourceTypeRegistration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ResourceTypeRegistration, __self__).__init__(
            'azure-nextgen:providerhub/v20201120:ResourceTypeRegistration',
            resource_name,
            __props__,
            opts)
