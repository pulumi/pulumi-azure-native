...
def get_skus_nested_resource_type_second(nested_resource_type_first: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:providerhub/latest:getSkusNestedResourceTypeSecond', __args__, opts=opts, typ=GetSkusNestedResourceTypeSecondResult).value
