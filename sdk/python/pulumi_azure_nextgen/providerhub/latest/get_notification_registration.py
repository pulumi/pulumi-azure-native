...
def get_notification_registration(notification_registration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:providerhub/latest:getNotificationRegistration', __args__, opts=opts, typ=GetNotificationRegistrationResult).value
