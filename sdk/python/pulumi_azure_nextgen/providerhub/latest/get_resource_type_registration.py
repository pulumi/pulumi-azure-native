...
def get_resource_type_registration(provider_namespace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:providerhub/latest:getResourceTypeRegistration', __args__, opts=opts, typ=GetResourceTypeRegistrationResult).value
