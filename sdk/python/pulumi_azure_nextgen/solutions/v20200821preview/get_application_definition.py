...
def get_application_definition(application_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:solutions/v20200821preview:getApplicationDefinition', __args__, opts=opts, typ=GetApplicationDefinitionResult).value
