...
__all__ = [
    'ApplianceArtifactInvokeResponseResult',
    'ApplianceArtifactResponse',
    'ApplianceProviderAuthorizationInvokeResponseResult',
...
@pulumi.output_type
class ApplianceArtifactInvokeResponseResult(dict):
    """
    Appliance artifact.
    """
...
@pulumi.output_type
class ApplianceProviderAuthorizationInvokeResponseResult(dict):
    """
