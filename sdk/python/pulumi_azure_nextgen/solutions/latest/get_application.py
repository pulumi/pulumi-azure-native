...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:solutions:getApplication'.""", DeprecationWarning)
...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_application is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:solutions:getApplication'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:solutions/latest:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
