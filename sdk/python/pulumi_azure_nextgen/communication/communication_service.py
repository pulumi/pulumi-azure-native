...
class CommunicationService(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:communication/v20200820preview:CommunicationService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CommunicationService, __self__).__init__(
            'azure-nextgen:communication:CommunicationService',
            resource_name,
            __props__,
            opts)
