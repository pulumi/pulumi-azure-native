...
class GetDatabaseAccountResult:
    ...
    def restore_parameters(self) -> Optional['outputs.RestoreParametersInvokeResponseResult']:
        """
...
def get_database_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:documentdb/v20200601preview:getDatabaseAccount', __args__, opts=opts, typ=GetDatabaseAccountResult).value
