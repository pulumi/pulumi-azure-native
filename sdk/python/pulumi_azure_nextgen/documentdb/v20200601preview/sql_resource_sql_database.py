...
class SqlResourceSqlDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/latest:SqlResourceSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20190801:SqlResourceSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20191212:SqlResourceSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200301:SqlResourceSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200401:SqlResourceSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200901:SqlResourceSqlDatabase")])
