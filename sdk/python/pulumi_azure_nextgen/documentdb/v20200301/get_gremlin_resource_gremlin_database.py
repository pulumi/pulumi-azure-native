...
class GetGremlinResourceGremlinDatabaseResult:
    ...
    @property
    @pulumi.getter
    def options(self) -> Optional['outputs.GremlinDatabaseGetPropertiesInvokeResponseOptionsResult']:
...
def get_gremlin_resource_gremlin_database(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:documentdb/v20200301:getGremlinResourceGremlinDatabase', __args__, opts=opts, typ=GetGremlinResourceGremlinDatabaseResult).value
