...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:documentdb/v20160319:DatabaseAccount":
                return DatabaseAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountCassandraKeyspace":
                return DatabaseAccountCassandraKeyspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountCassandraTable":
                return DatabaseAccountCassandraTable(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountGremlinDatabase":
                return DatabaseAccountGremlinDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountGremlinGraph":
                return DatabaseAccountGremlinGraph(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountMongoDBCollection":
                return DatabaseAccountMongoDBCollection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountMongoDBDatabase":
                return DatabaseAccountMongoDBDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountSqlContainer":
                return DatabaseAccountSqlContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountSqlDatabase":
                return DatabaseAccountSqlDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20160319:DatabaseAccountTable":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "documentdb/v20160319", _module_instance)
