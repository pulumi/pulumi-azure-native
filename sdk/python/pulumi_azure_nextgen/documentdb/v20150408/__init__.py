...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:documentdb/v20150408:DatabaseAccount":
                return DatabaseAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountCassandraKeyspace":
                return DatabaseAccountCassandraKeyspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountCassandraTable":
                return DatabaseAccountCassandraTable(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountGremlinDatabase":
                return DatabaseAccountGremlinDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountGremlinGraph":
                return DatabaseAccountGremlinGraph(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountMongoDBCollection":
                return DatabaseAccountMongoDBCollection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountMongoDBDatabase":
                return DatabaseAccountMongoDBDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountSqlContainer":
                return DatabaseAccountSqlContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountSqlDatabase":
                return DatabaseAccountSqlDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20150408:DatabaseAccountTable":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "documentdb/v20150408", _module_instance)
