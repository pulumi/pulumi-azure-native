...
def get_database_account_cassandra_keyspace(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:documentdb/v20151106:getDatabaseAccountCassandraKeyspace', __args__, opts=opts, typ=GetDatabaseAccountCassandraKeyspaceResult).value
