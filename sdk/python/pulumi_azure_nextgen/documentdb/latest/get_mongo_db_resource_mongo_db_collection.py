...
class GetMongoDBResourceMongoDBCollectionResult:
    ...
    @property
    @pulumi.getter
    def options(self) -> Optional['outputs.MongoDBCollectionGetPropertiesInvokeResponseOptionsResult']:
        return pulumi.get(self, "options")

    @property
    @pulumi.getter
    def resource(self) -> Optional['outputs.MongoDBCollectionGetPropertiesInvokeResponseResourceResult']:
...
def get_mongo_db_resource_mongo_db_collection(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:documentdb/latest:getMongoDBResourceMongoDBCollection', __args__, opts=opts, typ=GetMongoDBResourceMongoDBCollectionResult).value
