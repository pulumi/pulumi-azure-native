...
class GetTableResourceTableResult:
    ...
    @property
    @pulumi.getter
    def options(self) -> Optional['outputs.TableGetPropertiesInvokeResponseOptionsResult']:
...
def get_table_resource_table(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:documentdb/latest:getTableResourceTable', __args__, opts=opts, typ=GetTableResourceTableResult).value
