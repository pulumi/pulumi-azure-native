...
def get_gremlin_resource_gremlin_graph(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:documentdb/v20190801:getGremlinResourceGremlinGraph', __args__, opts=opts, typ=GetGremlinResourceGremlinGraphResult).value
