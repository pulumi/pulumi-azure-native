...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:documentdb/v20190801:CassandraResourceCassandraKeyspace":
                return CassandraResourceCassandraKeyspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:CassandraResourceCassandraTable":
                return CassandraResourceCassandraTable(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:DatabaseAccount":
                return DatabaseAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:GremlinResourceGremlinDatabase":
                return GremlinResourceGremlinDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:GremlinResourceGremlinGraph":
                return GremlinResourceGremlinGraph(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:MongoDBResourceMongoDBCollection":
                return MongoDBResourceMongoDBCollection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:MongoDBResourceMongoDBDatabase":
                return MongoDBResourceMongoDBDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:NotebookWorkspace":
                return NotebookWorkspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:SqlResourceSqlContainer":
                return SqlResourceSqlContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:SqlResourceSqlDatabase":
                return SqlResourceSqlDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:SqlResourceSqlStoredProcedure":
                return SqlResourceSqlStoredProcedure(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:SqlResourceSqlTrigger":
                return SqlResourceSqlTrigger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:SqlResourceSqlUserDefinedFunction":
                return SqlResourceSqlUserDefinedFunction(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:documentdb/v20190801:TableResourceTable":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "documentdb/v20190801", _module_instance)
