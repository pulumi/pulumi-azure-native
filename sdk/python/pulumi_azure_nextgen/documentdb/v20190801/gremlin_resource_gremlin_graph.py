...
class GremlinResourceGremlinGraph(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/latest:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20191212:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200301:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200401:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200601preview:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200901:GremlinResourceGremlinGraph")])
