...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/latest:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20190801:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20191212:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200301:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200601preview:GremlinResourceGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200901:GremlinResourceGremlinDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GremlinResourceGremlinDatabase, __self__).__init__(
            'azure-nextgen:documentdb/v20200401:GremlinResourceGremlinDatabase',
            resource_name,
            __props__,
            opts)
