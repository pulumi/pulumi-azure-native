...
class GetSqlResourceSqlDatabaseResult:
    ...
    @property
    @pulumi.getter
    def options(self) -> Optional['outputs.SqlDatabaseGetPropertiesInvokeResponseOptionsResult']:
...
def get_sql_resource_sql_database(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:documentdb/v20200401:getSqlResourceSqlDatabase', __args__, opts=opts, typ=GetSqlResourceSqlDatabaseResult).value
