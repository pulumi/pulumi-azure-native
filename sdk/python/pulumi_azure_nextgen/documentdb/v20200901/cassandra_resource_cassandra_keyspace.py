...
class CassandraResourceCassandraKeyspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azure-nextgen:documentdb/v20190801:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azure-nextgen:documentdb/v20191212:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200301:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200401:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200601preview:CassandraResourceCassandraKeyspace"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210115:CassandraResourceCassandraKeyspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CassandraResourceCassandraKeyspace, __self__).__init__(
            'azure-nextgen:documentdb/v20200901:CassandraResourceCassandraKeyspace',
            resource_name,
            __props__,
            opts)
