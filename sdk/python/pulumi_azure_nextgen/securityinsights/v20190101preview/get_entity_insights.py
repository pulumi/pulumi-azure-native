...
class GetEntityInsightsResult:
    ...
    def meta_data(self) -> Optional['outputs.GetInsightsResultsMetadataInvokeResponseResult']:
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.EntityInsightItemInvokeResponseResult']]:
        """
...
def get_entity_insights(add_default_extended_time_range: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:securityinsights/v20190101preview:getEntityInsights', __args__, opts=opts, typ=GetEntityInsightsResult).value
