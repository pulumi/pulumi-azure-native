...
class GetEntitiesGetTimelineResult:
    ...
    def meta_data(self) -> Optional['outputs.TimelineResultsMetadataInvokeResponseResult']:
        """
...
def get_entities_get_timeline(end_time: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:securityinsights/v20190101preview:getEntitiesGetTimeline', __args__, opts=opts, typ=GetEntitiesGetTimelineResult).value
