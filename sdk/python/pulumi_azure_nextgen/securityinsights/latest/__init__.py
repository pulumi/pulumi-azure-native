...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:securityinsights/latest:Action":
                return Action(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:securityinsights/latest:AlertRule":
                return AlertRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:securityinsights/latest:Bookmark":
                return Bookmark(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:securityinsights/latest:DataConnector":
                return DataConnector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:securityinsights/latest:Incident":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "securityinsights/latest", _module_instance)
