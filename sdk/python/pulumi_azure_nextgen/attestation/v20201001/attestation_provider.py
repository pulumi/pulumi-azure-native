...
class AttestationProvider(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:attestation/latest:AttestationProvider"), pulumi.Alias(type_="azure-nextgen:attestation/v20180901:AttestationProvider")])
