...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:sqlvirtualmachine:AvailabilityGroupListener":
                return AvailabilityGroupListener(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:sqlvirtualmachine:SqlVirtualMachine":
                return SqlVirtualMachine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:sqlvirtualmachine:SqlVirtualMachineGroup":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "sqlvirtualmachine", _module_instance)
