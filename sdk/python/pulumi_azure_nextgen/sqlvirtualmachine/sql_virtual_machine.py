...
class SqlVirtualMachine(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sqlvirtualmachine/v20170301preview:SqlVirtualMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlVirtualMachine, __self__).__init__(
            'azure-nextgen:sqlvirtualmachine:SqlVirtualMachine',
            resource_name,
            __props__,
            opts)
