...
def get_cluster_gateway_settings(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:hdinsight/v20150301preview:getClusterGatewaySettings', __args__, opts=opts, typ=GetClusterGatewaySettingsResult).value
