...
class GetManagedClusterResult:
    ...
    def auto_upgrade_profile(self) -> Optional['outputs.ManagedClusterAutoUpgradeProfileInvokeResponseResult']:
        """
    ...
    def pod_identity_profile(self) -> Optional['outputs.ManagedClusterPodIdentityProfileInvokeResponseResult']:
        """
...
def get_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerservice/v20201101:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
