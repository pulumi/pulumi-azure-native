...
class ContainerServiceDiagnosticsProfileInvokeResponseResult(dict):
    def __init__(__self__, *,
                 vm_diagnostics: Optional['outputs.ContainerServiceVMDiagnosticsInvokeResponseResult'] = None):
        """
        :param 'ContainerServiceVMDiagnosticsInvokeResponseArgs' vm_diagnostics: Profile for container service VM diagnostic agent
        """
    ...
    def vm_diagnostics(self) -> Optional['outputs.ContainerServiceVMDiagnosticsInvokeResponseResult']:
        """
...
class ContainerServiceLinuxProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ContainerServiceSshConfigurationInvokeResponseArgs' ssh: Specifies the ssh key configuration for Linux VMs
        """
...
class ContainerServiceSshConfigurationInvokeResponseResult(dict):
    ...
    """
    def __init__(__self__, *,
                 public_keys: Optional[Sequence['outputs.ContainerServiceSshPublicKeyInvokeResponseResult']] = None):
        """
        SSH configuration for Linux based VMs running on Azure
        :param Sequence['ContainerServiceSshPublicKeyInvokeResponseArgs'] public_keys: Gets or sets the list of SSH public keys used to authenticate with Linux based VMs
        """
    ...
    def public_keys(self) -> Optional[Sequence['outputs.ContainerServiceSshPublicKeyInvokeResponseResult']]:
        """
