...
def get_container_service(container_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerservice/v20151101preview:getContainerService', __args__, opts=opts, typ=GetContainerServiceResult).value
