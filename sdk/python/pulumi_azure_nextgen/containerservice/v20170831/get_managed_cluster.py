...
class GetManagedClusterResult:
    ...
    def agent_pool_profiles(self) -> Optional[Sequence['outputs.ContainerServiceAgentPoolProfileInvokeResponseResult']]:
        """
...
def get_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerservice/v20170831:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
