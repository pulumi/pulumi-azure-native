...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:containerservice/v20170831:ManagedCluster":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "containerservice/v20170831", _module_instance)
