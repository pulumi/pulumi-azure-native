...
__all__ = [
    ...
    'KeyVaultSecretRefInvokeResponseResult',
...
class ContainerServiceServicePrincipalProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 client_id: str,
                 key_vault_secret_ref: Optional['outputs.KeyVaultSecretRefInvokeResponseResult'] = None,
                 secret: Optional[str] = None):
        """
        Information about a service principal identity for the cluster to use for manipulating Azure APIs. Either secret or keyVaultSecretRef must be specified.
        :param str client_id: The ID for the service principal.
        :param 'KeyVaultSecretRefInvokeResponseArgs' key_vault_secret_ref: Reference to a secret stored in Azure Key Vault.
    ...
    def key_vault_secret_ref(self) -> Optional['outputs.KeyVaultSecretRefInvokeResponseResult']:
        """
...
@pulumi.output_type
class KeyVaultSecretRefInvokeResponseResult(dict):
    """
    Reference to a secret stored in Azure Key Vault.
    """
    def __init__(__self__, *,
