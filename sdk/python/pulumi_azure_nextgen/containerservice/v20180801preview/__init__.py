...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:containerservice/v20180801preview:ManagedCluster":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "containerservice/v20180801preview", _module_instance)
