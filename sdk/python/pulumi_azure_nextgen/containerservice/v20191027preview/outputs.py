...
__all__ = [
    ...
    'OpenShiftAPIPropertiesInvokeResponseResult',
...
@pulumi.output_type
class OpenShiftAPIPropertiesInvokeResponseResult(dict):
    """
...
class OpenShiftManagedClusterMasterPoolProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 count: int,
                 vm_size: str,
                 api_properties: Optional['outputs.OpenShiftAPIPropertiesInvokeResponseResult'] = None,
                 subnet_cidr: Optional[str] = None):
        """
        OpenShiftManagedClusterMaterPoolProfile contains configuration for OpenShift master VMs.
        :param int count: Number of masters (VMs) to host docker containers. The default value is 3.
        :param str vm_size: Size of agent VMs.
        :param 'OpenShiftAPIPropertiesInvokeResponseArgs' api_properties: Defines further properties on the API.
        :param str subnet_cidr: Subnet CIDR for the peering.
        """
        pulumi.set(__self__, "count", count)
        pulumi.set(__self__, "vm_size", vm_size)
    ...
    def api_properties(self) -> Optional['outputs.OpenShiftAPIPropertiesInvokeResponseResult']:
        """
        Defines further properties on the API.
        """
