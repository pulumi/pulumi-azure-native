...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:containerservice:getContainerService'.""", DeprecationWarning)
...
def get_container_service(container_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_container_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:containerservice:getContainerService'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerservice/latest:getContainerService', __args__, opts=opts, typ=GetContainerServiceResult).value
