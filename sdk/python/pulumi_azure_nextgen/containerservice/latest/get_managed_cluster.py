...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:containerservice:getManagedCluster'.""", DeprecationWarning)
...
def get_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_managed_cluster is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:containerservice:getManagedCluster'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:containerservice/latest:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
