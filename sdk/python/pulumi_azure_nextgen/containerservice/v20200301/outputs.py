...
__all__ = [
    ...
    'ManagedClusterAPIServerAccessProfileInvokeResponseResult',
    'ManagedClusterAPIServerAccessProfileResponse',
    'ManagedClusterAddonProfileInvokeResponseResult',
    'ManagedClusterAddonProfileInvokeResponseIdentityResult',
    ...
    'ManagedClusterIdentityInvokeResponseResult',
    'ManagedClusterIdentityResponse',
    'ManagedClusterLoadBalancerProfileInvokeResponseResult',
    'ManagedClusterLoadBalancerProfileInvokeResponseManagedOutboundIPsResult',
    'ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPPrefixesResult',
    'ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPsResult',
    ...
    'ManagedClusterPropertiesInvokeResponseAutoScalerProfileResult',
    'ManagedClusterPropertiesInvokeResponseIdentityProfileResult',
    'ManagedClusterPropertiesResponseAutoScalerProfile',
    'ManagedClusterPropertiesResponseIdentityProfile',
    'ManagedClusterSKUInvokeResponseResult',
    ...
    'ManagedClusterWindowsProfileInvokeResponseResult',
...
class ContainerServiceNetworkProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 load_balancer_profile: Optional['outputs.ManagedClusterLoadBalancerProfileInvokeResponseResult'] = None,
        ...
        :param 'ManagedClusterLoadBalancerProfileInvokeResponseArgs' load_balancer_profile: Profile of the cluster load balancer.
    ...
    def load_balancer_profile(self) -> Optional['outputs.ManagedClusterLoadBalancerProfileInvokeResponseResult']:
        """
...
@pulumi.output_type
class ManagedClusterAPIServerAccessProfileInvokeResponseResult(dict):
    """
...
class ManagedClusterAddonProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 enabled: bool,
                 identity: 'outputs.ManagedClusterAddonProfileInvokeResponseIdentityResult',
                 config: Optional[Mapping[str, str]] = None):
        """
        A Kubernetes add-on profile for a managed cluster.
        :param bool enabled: Whether the add-on is enabled or not.
        :param 'ManagedClusterAddonProfileInvokeResponseIdentityArgs' identity: Information of user assigned identity used by this add-on.
    ...
    @property
    @pulumi.getter
    def identity(self) -> 'outputs.ManagedClusterAddonProfileInvokeResponseIdentityResult':
        """
...
@pulumi.output_type
class ManagedClusterAddonProfileInvokeResponseIdentityResult(dict):
    """
    Information of user assigned identity used by this add-on.
    """
    def __init__(__self__, *,
...
class ManagedClusterAgentPoolProfileInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str scale_set_eviction_policy: ScaleSetEvictionPolicy to be used to specify eviction policy for Spot or low priority virtual machine scale set. Default to Delete.
...
@pulumi.output_type
class ManagedClusterIdentityInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class ManagedClusterLoadBalancerProfileInvokeResponseResult(dict):
    """
    Profile of the managed cluster load balancer.
    """
    def __init__(__self__, *,
                 allocated_outbound_ports: Optional[int] = None,
                 effective_outbound_ips: Optional[Sequence['outputs.ResourceReferenceInvokeResponseResult']] = None,
                 idle_timeout_in_minutes: Optional[int] = None,
                 managed_outbound_ips: Optional['outputs.ManagedClusterLoadBalancerProfileInvokeResponseManagedOutboundIPsResult'] = None,
                 outbound_ip_prefixes: Optional['outputs.ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPPrefixesResult'] = None,
                 outbound_ips: Optional['outputs.ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPsResult'] = None):
        """
        Profile of the managed cluster load balancer.
        ...
        :param Sequence['ResourceReferenceInvokeResponseArgs'] effective_outbound_ips: The effective outbound IP resources of the cluster load balancer.
        ...
        :param 'ManagedClusterLoadBalancerProfileInvokeResponseManagedOutboundIPsArgs' managed_outbound_ips: Desired managed outbound IPs for the cluster load balancer.
        :param 'ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPPrefixesArgs' outbound_ip_prefixes: Desired outbound IP Prefix resources for the cluster load balancer.
        :param 'ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPsArgs' outbound_ips: Desired outbound IP resources for the cluster load balancer.
        """
    ...
    def effective_outbound_ips(self) -> Optional[Sequence['outputs.ResourceReferenceInvokeResponseResult']]:
        """
    ...
    def managed_outbound_ips(self) -> Optional['outputs.ManagedClusterLoadBalancerProfileInvokeResponseManagedOutboundIPsResult']:
        """
    ...
    def outbound_ip_prefixes(self) -> Optional['outputs.ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPPrefixesResult']:
        """
    ...
    def outbound_ips(self) -> Optional['outputs.ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPsResult']:
        """
...
@pulumi.output_type
class ManagedClusterLoadBalancerProfileInvokeResponseManagedOutboundIPsResult(dict):
    """
    Desired managed outbound IPs for the cluster load balancer.
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPPrefixesResult(dict):
    """
    Desired outbound IP Prefix resources for the cluster load balancer.
    """
    def __init__(__self__, *,
                 public_ip_prefixes: Optional[Sequence['outputs.ResourceReferenceInvokeResponseResult']] = None):
        """
        Desired outbound IP Prefix resources for the cluster load balancer.
        :param Sequence['ResourceReferenceInvokeResponseArgs'] public_ip_prefixes: A list of public IP prefix resources.
        """
    ...
    def public_ip_prefixes(self) -> Optional[Sequence['outputs.ResourceReferenceInvokeResponseResult']]:
        """
...
@pulumi.output_type
class ManagedClusterLoadBalancerProfileInvokeResponseOutboundIPsResult(dict):
    """
    Desired outbound IP resources for the cluster load balancer.
    """
    def __init__(__self__, *,
                 public_ips: Optional[Sequence['outputs.ResourceReferenceInvokeResponseResult']] = None):
        """
        Desired outbound IP resources for the cluster load balancer.
        :param Sequence['ResourceReferenceInvokeResponseArgs'] public_ips: A list of public IP resources.
        """
    ...
    def public_ips(self) -> Optional[Sequence['outputs.ResourceReferenceInvokeResponseResult']]:
        """
...
@pulumi.output_type
class ManagedClusterPropertiesInvokeResponseAutoScalerProfileResult(dict):
    """
...
@pulumi.output_type
class ManagedClusterPropertiesInvokeResponseIdentityProfileResult(dict):
    def __init__(__self__, *,
                 client_id: Optional[str] = None,
                 object_id: Optional[str] = None,
                 resource_id: Optional[str] = None):
...
@pulumi.output_type
class ManagedClusterSKUInvokeResponseResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ManagedClusterWindowsProfileInvokeResponseResult(dict):
    """
