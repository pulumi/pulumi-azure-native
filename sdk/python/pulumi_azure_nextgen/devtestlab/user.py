...
class User(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:User"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:User"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:User")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(User, __self__).__init__(
            'azure-nextgen:devtestlab:User',
            resource_name,
            __props__,
            opts)
