...
class Secret(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:Secret"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Secret"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Secret")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Secret, __self__).__init__(
            'azure-nextgen:devtestlab:Secret',
            resource_name,
            __props__,
            opts)
