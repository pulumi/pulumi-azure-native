...
class VirtualMachineSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:VirtualMachineSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineSchedule, __self__).__init__(
            'azure-nextgen:devtestlab:VirtualMachineSchedule',
            resource_name,
            __props__,
            opts)
