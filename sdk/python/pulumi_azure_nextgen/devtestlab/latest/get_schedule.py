...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:devtestlab:getSchedule'.""", DeprecationWarning)
...
def get_schedule(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_schedule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:devtestlab:getSchedule'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:devtestlab/latest:getSchedule', __args__, opts=opts, typ=GetScheduleResult).value
