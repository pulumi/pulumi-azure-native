...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:devtestlab:Disk'.""", DeprecationWarning)
...
class Disk(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab:Disk"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Disk"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Disk")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Disk, __self__).__init__(
            'azure-nextgen:devtestlab/latest:Disk',
            resource_name,
            __props__,
            opts)
