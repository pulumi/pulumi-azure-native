...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:devtestlab:getUser'.""", DeprecationWarning)
...
def get_user(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_user is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:devtestlab:getUser'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:devtestlab/latest:getUser', __args__, opts=opts, typ=GetUserResult).value
