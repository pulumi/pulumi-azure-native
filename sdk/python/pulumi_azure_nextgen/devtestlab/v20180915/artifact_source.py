...
class ArtifactSource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:ArtifactSource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ArtifactSource, __self__).__init__(
            'azure-nextgen:devtestlab/v20180915:ArtifactSource',
            resource_name,
            __props__,
            opts)
