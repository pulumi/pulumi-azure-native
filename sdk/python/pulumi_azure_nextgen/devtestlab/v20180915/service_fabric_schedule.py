...
class ServiceFabricSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab:ServiceFabricSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:ServiceFabricSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServiceFabricSchedule, __self__).__init__(
            'azure-nextgen:devtestlab/v20180915:ServiceFabricSchedule',
            resource_name,
            __props__,
            opts)
