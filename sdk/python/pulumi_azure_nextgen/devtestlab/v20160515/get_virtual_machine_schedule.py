...
def get_virtual_machine_schedule(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:devtestlab/v20160515:getVirtualMachineSchedule', __args__, opts=opts, typ=GetVirtualMachineScheduleResult).value
