...
class GetVirtualMachineResult:
    ...
    A virtual machine.
    """
    def __init__(__self__, allow_claim=None, applicable_schedule=None, artifact_deployment_status=None, artifacts=None, compute_id=None, compute_vm=None, created_by_user=None, created_by_user_id=None, created_date=None, custom_image_id=None, disallow_public_ip_address=None, environment_id=None, expiration_date=None, fqdn=None, gallery_image_reference=None, id=None, is_authentication_with_ssh_key=None, lab_subnet_name=None, lab_virtual_network_id=None, location=None, name=None, network_interface=None, notes=None, os_type=None, owner_object_id=None, owner_user_principal_name=None, password=None, provisioning_state=None, size=None, ssh_key=None, storage_type=None, tags=None, type=None, unique_identifier=None, user_name=None, virtual_machine_creation_source=None):
...
def get_virtual_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:devtestlab/v20160515:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult).value
