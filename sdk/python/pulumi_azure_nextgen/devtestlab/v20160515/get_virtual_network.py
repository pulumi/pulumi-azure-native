...
class GetVirtualNetworkResult:
    ...
    def external_subnets(self) -> Optional[Sequence['outputs.ExternalSubnetInvokeResponseResult']]:
        """
...
def get_virtual_network(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:devtestlab/v20160515:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
