...
class DefenderSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:iotsecurity/v20210201preview:DefenderSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DefenderSetting, __self__).__init__(
            'azure-nextgen:iotsecurity:DefenderSetting',
            resource_name,
            __props__,
            opts)
