...
class Task(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datamigration/latest:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/v20171115preview:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/v20180315preview:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/v20180331preview:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/v20180715preview:Task")])
