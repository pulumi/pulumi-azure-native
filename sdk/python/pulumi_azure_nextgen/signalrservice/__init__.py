...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:signalrservice:SignalR":
                return SignalR(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:signalrservice:SignalRPrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "signalrservice", _module_instance)
