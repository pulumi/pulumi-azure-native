...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storagesync:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storagesync/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storagesync/v20200901:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-nextgen:storagesync/v20200301:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
