...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:storagesync/v20200901:CloudEndpoint":
                return CloudEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storagesync/v20200901:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storagesync/v20200901:RegisteredServer":
                return RegisteredServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storagesync/v20200901:ServerEndpoint":
                return ServerEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storagesync/v20200901:StorageSyncService":
                return StorageSyncService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:storagesync/v20200901:SyncGroup":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "storagesync/v20200901", _module_instance)
