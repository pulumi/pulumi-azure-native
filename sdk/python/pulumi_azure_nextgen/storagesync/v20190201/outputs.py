...
__all__ = [
    'FilesNotSyncingErrorInvokeResponseResult',
...
@pulumi.output_type
class FilesNotSyncingErrorInvokeResponseResult(dict):
    """
...
class SyncSessionStatusInvokeResponseResult(dict):
    ...
    """
    def __init__(__self__, *,
                 files_not_syncing_errors: Sequence['outputs.FilesNotSyncingErrorInvokeResponseResult'],
        ...
        """
        Sync Session status object.
        :param Sequence['FilesNotSyncingErrorInvokeResponseArgs'] files_not_syncing_errors: Array of per-item errors coming from the last sync session. Reserved for future use.
    ...
    def files_not_syncing_errors(self) -> Sequence['outputs.FilesNotSyncingErrorInvokeResponseResult']:
        """
