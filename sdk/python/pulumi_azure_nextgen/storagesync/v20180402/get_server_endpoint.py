...
class GetServerEndpointResult:
    ...
    """
    def __init__(__self__, cloud_tiering=None, friendly_name=None, last_operation_name=None, last_workflow_id=None, name=None, provisioning_state=None, server_local_path=None, server_resource_id=None, sync_status=None, type=None, volume_free_space_percent=None):
...
def get_server_endpoint(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:storagesync/v20180402:getServerEndpoint', __args__, opts=opts, typ=GetServerEndpointResult).value
