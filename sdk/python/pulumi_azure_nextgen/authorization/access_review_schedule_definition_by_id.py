...
class AccessReviewScheduleDefinitionById(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20180501preview:AccessReviewScheduleDefinitionById")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccessReviewScheduleDefinitionById, __self__).__init__(
            'azure-nextgen:authorization:AccessReviewScheduleDefinitionById',
            resource_name,
            __props__,
            opts)
