...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:authorization/v20150101:ManagementLock":
                return ManagementLock(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:authorization/v20150101:ManagementLockAtResourceGroupLevel":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "authorization/v20150101", _module_instance)
