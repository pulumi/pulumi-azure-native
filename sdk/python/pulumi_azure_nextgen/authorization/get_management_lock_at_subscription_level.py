...
def get_management_lock_at_subscription_level(lock_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:authorization:getManagementLockAtSubscriptionLevel', __args__, opts=opts, typ=GetManagementLockAtSubscriptionLevelResult).value
