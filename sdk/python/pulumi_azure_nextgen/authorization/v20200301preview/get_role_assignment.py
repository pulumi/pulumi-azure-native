...
class GetRoleAssignmentResult:
    ...
    Role Assignments
    """
    def __init__(__self__, can_delegate=None, condition=None, condition_version=None, created_by=None, created_on=None, delegated_managed_identity_resource_id=None, id=None, name=None, principal_id=None, principal_type=None, role_definition_id=None, scope=None, type=None, updated_by=None, updated_on=None):
...
def get_role_assignment(role_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:authorization/v20200301preview:getRoleAssignment', __args__, opts=opts, typ=GetRoleAssignmentResult).value
