...
class DenyAssignment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization:DenyAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DenyAssignment, __self__).__init__(
            'azure-nextgen:authorization/v20200301preview:DenyAssignment',
            resource_name,
            __props__,
            opts)
