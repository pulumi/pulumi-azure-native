...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:authorization/v20151001preview:PolicyAssignment":
                return PolicyAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:authorization/v20151001preview:PolicyDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "authorization/v20151001preview", _module_instance)
