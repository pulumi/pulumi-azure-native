...
class Job(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:scheduler:Job"), pulumi.Alias(type_="azure-nextgen:scheduler/latest:Job"), pulumi.Alias(type_="azure-nextgen:scheduler/v20160101:Job"), pulumi.Alias(type_="azure-nextgen:scheduler/v20160301:Job")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Job, __self__).__init__(
            'azure-nextgen:scheduler/v20140801preview:Job',
            resource_name,
            __props__,
            opts)
