...
class EventChannel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:eventgrid/v20200401preview:EventChannel"), pulumi.Alias(type_="azure-nextgen:eventgrid/v20201015preview:EventChannel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventChannel, __self__).__init__(
            'azure-nextgen:eventgrid:EventChannel',
            resource_name,
            __props__,
            opts)
