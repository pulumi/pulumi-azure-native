...
class GetEventSubscriptionResult:
    ...
    @property
    @pulumi.getter
    def destination(self) -> Optional['outputs.EventSubscriptionDestinationInvokeResponseResult']:
        """
...
def get_event_subscription(event_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:eventgrid/v20170615preview:getEventSubscription', __args__, opts=opts, typ=GetEventSubscriptionResult).value
