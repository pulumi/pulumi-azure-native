...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-nextgen:eventgrid/latest:Domain":
                return Domain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:eventgrid/latest:DomainTopic":
                return DomainTopic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:eventgrid/latest:EventSubscription":
                return EventSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:eventgrid/latest:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-nextgen:eventgrid/latest:Topic":
    ...
    pulumi.runtime.register_resource_module("azure-nextgen", "eventgrid/latest", _module_instance)
