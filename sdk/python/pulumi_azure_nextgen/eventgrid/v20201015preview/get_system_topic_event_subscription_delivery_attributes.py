...
def get_system_topic_event_subscription_delivery_attributes(event_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:eventgrid/v20201015preview:getSystemTopicEventSubscriptionDeliveryAttributes', __args__, opts=opts, typ=GetSystemTopicEventSubscriptionDeliveryAttributesResult).value
