...
def list_partner_namespace_shared_access_keys(partner_namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:eventgrid/v20201015preview:listPartnerNamespaceSharedAccessKeys', __args__, opts=opts, typ=ListPartnerNamespaceSharedAccessKeysResult).value
