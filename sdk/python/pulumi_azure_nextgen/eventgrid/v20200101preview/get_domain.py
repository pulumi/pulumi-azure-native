...
class GetDomainResult:
    ...
    EventGrid Domain
    """
    def __init__(__self__, endpoint=None, input_schema=None, input_schema_mapping=None, location=None, metric_resource_id=None, name=None, provisioning_state=None, tags=None, type=None):
...
def get_domain(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:eventgrid/v20200101preview:getDomain', __args__, opts=opts, typ=GetDomainResult).value
