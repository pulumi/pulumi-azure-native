...
__all__ = [
    'EventHubEventSubscriptionDestinationInvokeResponseResult',
    'EventHubEventSubscriptionDestinationResponse',
    'EventSubscriptionFilterInvokeResponseResult',
    'EventSubscriptionFilterResponse',
    'WebHookEventSubscriptionDestinationInvokeResponseResult',
    'WebHookEventSubscriptionDestinationResponse',
]

@pulumi.output_type
class EventHubEventSubscriptionDestinationInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class EventSubscriptionFilterInvokeResponseResult(dict):
    """
...
@pulumi.output_type
class WebHookEventSubscriptionDestinationInvokeResponseResult(dict):
    """
