...
class GetPrivateEndpointConnectionResult:
    ...
    def private_link_service_connection_state(self) -> Optional['outputs.ConnectionStateInvokeResponseResult']:
        """
...
def get_private_endpoint_connection(parent_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:eventgrid/v20200601:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
