...
__all__ = [
    'AppInsightsReferenceInvokeResponseResult',
    ...
    'EnvironmentVariableWithSecretValueInvokeResponseResult',
...
@pulumi.output_type
class AppInsightsReferenceInvokeResponseResult(dict):
    """
    Specifies Azure Application Insights information for performance counters reporting.
    """
    def __init__(__self__, *,
                 component: 'outputs.ResourceIdInvokeResponseResult',
                 instrumentation_key: Optional[str] = None,
                 instrumentation_key_secret_reference: Optional['outputs.KeyVaultSecretReferenceInvokeResponseResult'] = None):
        """
        Specifies Azure Application Insights information for performance counters reporting.
        :param 'ResourceIdInvokeResponseArgs' component: Represents a resource ID. For example, for a subnet, it is the resource URL for the subnet.
        :param 'KeyVaultSecretReferenceInvokeResponseArgs' instrumentation_key_secret_reference: Specifies KeyVault Store and Secret which contains Azure Application Insights instrumentation key. One of instrumentationKey or instrumentationKeySecretReference must be specified.
        """
    ...
    @property
    @pulumi.getter
    def component(self) -> 'outputs.ResourceIdInvokeResponseResult':
        """
    ...
    def instrumentation_key_secret_reference(self) -> Optional['outputs.KeyVaultSecretReferenceInvokeResponseResult']:
        """
...
@pulumi.output_type
class EnvironmentVariableWithSecretValueInvokeResponseResult(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 value_secret_reference: Optional['outputs.KeyVaultSecretReferenceInvokeResponseResult'] = None):
        """
        A collection of environment variables with secret values to set.
        :param 'KeyVaultSecretReferenceInvokeResponseArgs' value_secret_reference: Specifies KeyVault Store and Secret which contains the value for the environment variable. One of value or valueSecretReference must be provided.
        """
        pulumi.set(__self__, "name", name)
    ...
    def value_secret_reference(self) -> Optional['outputs.KeyVaultSecretReferenceInvokeResponseResult']:
        """
...
class NodeSetupInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 performance_counters_settings: Optional['outputs.PerformanceCountersSettingsInvokeResponseResult'] = None,
                 setup_task: Optional['outputs.SetupTaskInvokeResponseResult'] = None):
        """
        Use this to prepare the VM. NOTE: The volumes specified in mountVolumes are mounted first and then the setupTask is run. Therefore the setup task can use local mountPaths in its execution.
        :param 'MountVolumesInvokeResponseArgs' mount_volumes: Specified mount volumes will be available to all jobs executing on the cluster. The volumes will be mounted at location specified by $AZ_BATCHAI_MOUNT_ROOT environment variable.
        :param 'PerformanceCountersSettingsInvokeResponseArgs' performance_counters_settings: Performance counters reporting settings.
    ...
    def performance_counters_settings(self) -> Optional['outputs.PerformanceCountersSettingsInvokeResponseResult']:
        """
...
@pulumi.output_type
class PerformanceCountersSettingsInvokeResponseResult(dict):
    """
    Performance counters reporting settings.
    """
    def __init__(__self__, *,
                 app_insights_reference: 'outputs.AppInsightsReferenceInvokeResponseResult'):
        """
        Performance counters reporting settings.
        :param 'AppInsightsReferenceInvokeResponseArgs' app_insights_reference: If provided, Batch AI will upload node performance counters to the corresponding Azure Application Insights account.
        """
        pulumi.set(__self__, "app_insights_reference", app_insights_reference)

    @property
    @pulumi.getter(name="appInsightsReference")
    def app_insights_reference(self) -> 'outputs.AppInsightsReferenceInvokeResponseResult':
        """
...
@pulumi.output_type
class PyTorchSettingsInvokeResponseResult(dict):
    """
...
class SetupTaskInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secrets: Optional[Sequence['outputs.EnvironmentVariableWithSecretValueInvokeResponseResult']] = None):
        """
        Specifies a setup task which can be used to customize the compute nodes of the cluster.
        ...
        :param Sequence['EnvironmentVariableWithSecretValueInvokeResponseArgs'] secrets: Server will never report values of these variables back.
        """
        pulumi.set(__self__, "command_line", command_line)
