...
__all__ = [
    ...
    'Caffe2SettingsInvokeResponseResult',
    ...
    'CustomMpiSettingsInvokeResponseResult',
    ...
    'HorovodSettingsInvokeResponseResult',
...
class AppInsightsReferenceInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Azure Application Insights information for performance counters reporting.
        :param 'ResourceIdInvokeResponseArgs' component: Azure Application Insights component resource ID.
        :param str instrumentation_key: Value of the Azure Application Insights instrumentation key.
        :param 'KeyVaultSecretReferenceInvokeResponseArgs' instrumentation_key_secret_reference: KeyVault Store and Secret which contains Azure Application Insights instrumentation key. One of instrumentationKey or instrumentationKeySecretReference must be specified.
        """
...
class AzureBlobFileSystemReferenceInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'AzureStorageCredentialsInfoInvokeResponseArgs' credentials: Information about the Azure storage credentials.
...
class AzureStorageCredentialsInfoInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'KeyVaultSecretReferenceInvokeResponseArgs' account_key_secret_reference: Information about KeyVault secret storing the storage account key. One of accountKey or accountKeySecretReference must be specified.
        """
...
class BatchAIErrorInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
                 code: str,
                 details: Sequence['outputs.NameValuePairInvokeResponseResult'],
                 message: str):
        """
        An error response from the Batch AI service.
    ...
    @property
    @pulumi.getter
    def details(self) -> Sequence['outputs.NameValuePairInvokeResponseResult']:
        """
...
@pulumi.output_type
class Caffe2SettingsInvokeResponseResult(dict):
    """
    Caffe2 job settings.
    """
    def __init__(__self__, *,
...
class ContainerSettingsInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Docker container settings.
        :param 'ImageSourceRegistryInvokeResponseArgs' image_source_registry: Information about docker image and docker registry to download the container from.
...
@pulumi.output_type
class CustomMpiSettingsInvokeResponseResult(dict):
    """
...
class EnvironmentVariableWithSecretValueInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'KeyVaultSecretReferenceInvokeResponseArgs' value_secret_reference: KeyVault store and secret which contains the value for the environment variable. One of value or valueSecretReference must be provided.
        """
        pulumi.set(__self__, "name", name)
...
class FileServerReferenceInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        File Server mounting configuration.
        :param 'ResourceIdInvokeResponseArgs' file_server: Resource ID of the existing File Server to be mounted.
...
@pulumi.output_type
class HorovodSettingsInvokeResponseResult(dict):
    """
...
class ImageSourceRegistryInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'PrivateRegistryCredentialsInvokeResponseArgs' credentials: Credentials to access the private docker repository.
...
class JobPropertiesInvokeResponseExecutionInfoResult(dict):
    ...
    def __init__(__self__, *,
                 end_time: str,
                 errors: Sequence['outputs.BatchAIErrorInvokeResponseResult'],
                 exit_code: int,
                 start_time: str):
        """
        Information about the execution of a job.
        :param str end_time: The time at which the job completed. This property is only returned if the job is in completed state.
        :param Sequence['BatchAIErrorInvokeResponseArgs'] errors: A collection of errors encountered by the service during job execution.
...
class KeyVaultSecretReferenceInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ResourceIdInvokeResponseArgs' source_vault: Fully qualified resource identifier of the Key Vault.
        """
...
class MountVolumesInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details of volumes to mount on the cluster.
        :param Sequence['AzureBlobFileSystemReferenceInvokeResponseArgs'] azure_blob_file_systems: A collection of Azure Blob Containers that are to be mounted to the cluster nodes.
        :param Sequence['AzureFileShareReferenceInvokeResponseArgs'] azure_file_shares: A collection of Azure File Shares that are to be mounted to the cluster nodes.
        :param Sequence['FileServerReferenceInvokeResponseArgs'] file_servers: A collection of Batch AI File Servers that are to be mounted to the cluster nodes.
        :param Sequence['UnmanagedFileSystemReferenceInvokeResponseArgs'] unmanaged_file_systems: A collection of unmanaged file systems that are to be mounted to the cluster nodes.
        """
...
class NodeSetupInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Node setup settings.
        :param 'MountVolumesInvokeResponseArgs' mount_volumes: Mount volumes to be available to setup task and all jobs executing on the cluster. The volumes will be mounted at location specified by $AZ_BATCHAI_MOUNT_ROOT environment variable.
        :param 'PerformanceCountersSettingsInvokeResponseArgs' performance_counters_settings: Settings for performance counters collecting and uploading.
        :param 'SetupTaskInvokeResponseArgs' setup_task: Setup task to run on cluster nodes when nodes got created or rebooted. The setup task code needs to be idempotent. Generally the setup task is used to download static data that is required for all jobs that run on the cluster VMs and/or to download/install software.
        """
...
class PerformanceCountersSettingsInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Performance counters reporting settings.
        :param 'AppInsightsReferenceInvokeResponseArgs' app_insights_reference: Azure Application Insights information for performance counters reporting. If provided, Batch AI will upload node performance counters to the corresponding Azure Application Insights account.
        """
...
class PrivateRegistryCredentialsInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'KeyVaultSecretReferenceInvokeResponseArgs' password_secret_reference: KeyVault Secret storing the password. Users can store their secrets in Azure KeyVault and pass it to the Batch AI service to integrate with KeyVault. One of password or passwordSecretReference must be specified.
        """
...
class ScaleSettingsInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        At least one of manual or autoScale settings must be specified. Only one of manual or autoScale settings can be specified. If autoScale settings are specified, the system automatically scales the cluster up and down (within the supplied limits) based on the pending jobs on the cluster.
        :param 'AutoScaleSettingsInvokeResponseArgs' auto_scale: Auto-scale settings for the cluster.
...
class SetupTaskInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['EnvironmentVariableInvokeResponseArgs'] environment_variables: A collection of user defined environment variables to be set for setup task.
        :param Sequence['EnvironmentVariableWithSecretValueInvokeResponseArgs'] secrets: A collection of user defined environment variables with secret values to be set for the setup task. Server will never report values of these variables back.
        """
        pulumi.set(__self__, "command_line", command_line)
...
class SshConfigurationInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SSH configuration.
        :param 'UserAccountSettingsInvokeResponseArgs' user_account_settings: Settings for administrator user account to be created on a node. The account can be used to establish SSH connection to the node.
...
class VirtualMachineConfigurationInvokeResponseResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        VM configuration.
        :param 'ImageReferenceInvokeResponseArgs' image_reference: OS image reference for cluster nodes.
        """
