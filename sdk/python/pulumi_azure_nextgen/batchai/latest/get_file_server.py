...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:batchai:getFileServer'.""", DeprecationWarning)
...
def get_file_server(file_server_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("get_file_server is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:batchai:getFileServer'.")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-nextgen:batchai/latest:getFileServer', __args__, opts=opts, typ=GetFileServerResult).value
