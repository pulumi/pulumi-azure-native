...
export class LandingZoneRegistrationOperation extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.sovereign.LandingZoneRegistrationResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LandingZoneRegistrationOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native_sovereign_v20250227preview:sovereign:LandingZoneRegistrationOperation" }] };
