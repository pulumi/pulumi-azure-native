...
export class LandingZoneConfigurationOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sovereign/v20250227preview:LandingZoneConfigurationOperation';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.sovereign.v20250227preview.LandingZoneConfigurationResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LandingZoneConfigurationOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sovereign:LandingZoneConfigurationOperation" }] };
