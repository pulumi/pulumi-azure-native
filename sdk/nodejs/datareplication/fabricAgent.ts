...
export class FabricAgent extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datareplication.FabricAgentModelPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FabricAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datareplication/v20210216preview:FabricAgent" }, { type: "azure-native:datareplication/v20240901:FabricAgent" }] };
