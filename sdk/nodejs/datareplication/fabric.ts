...
export class Fabric extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.datareplication.FabricModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<outputs.datareplication.FabricModelResponseSystemData>;
    /**
    ...
    constructor(name: string, args: FabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datareplication/v20210216preview:Fabric" }, { type: "azure-native:datareplication/v20240901:Fabric" }, { type: "azure-native:datareplication/v20260501:Fabric" }] };
