...
export class Fabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datareplication/v20240901:Fabric';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datareplication.v20240901.FabricModelPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datareplication/v20210216preview:Fabric" }, { type: "azure-native:datareplication:Fabric" }] };
...
export interface FabricArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.datareplication.v20240901.FabricModelPropertiesArgs>;
    /**
