...
export class FabricAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datareplication/v20240901:FabricAgent';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datareplication.v20240901.FabricAgentModelPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FabricAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datareplication/v20210216preview:FabricAgent" }, { type: "azure-native:datareplication:FabricAgent" }] };
