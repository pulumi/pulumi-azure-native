...
export function getReplicationExtension(args: GetReplicationExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:datareplication/v20240901:getReplicationExtension", {
...
export interface GetReplicationExtensionResult {
     ...
     */
    readonly properties: outputs.datareplication.v20240901.ReplicationExtensionModelPropertiesResponse;
    /**
...
export function getReplicationExtensionOutput(args: GetReplicationExtensionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationExtensionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:datareplication/v20240901:getReplicationExtension", {
        "replicationExtensionName": args.replicationExtensionName,
        "resourceGroupName": args.resourceGroupName,
        "vaultName": args.vaultName,
    }, opts);
