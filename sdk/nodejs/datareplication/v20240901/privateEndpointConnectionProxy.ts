...
export class PrivateEndpointConnectionProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datareplication/v20240901:PrivateEndpointConnectionProxy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datareplication.v20240901.PrivateEndpointConnectionProxyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datareplication:PrivateEndpointConnectionProxy" }] };
