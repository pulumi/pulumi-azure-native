...
export class Dra extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.datareplication.DraModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<outputs.datareplication.DraModelResponseSystemData>;
    /**
    ...
    constructor(name: string, args: DraArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datareplication/v20210216preview:Dra" }, { type: "azure-native:datareplication/v20240901:Dra" }, { type: "azure-native:datareplication/v20260501:Dra" }] };
