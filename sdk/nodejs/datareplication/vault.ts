...
export class Vault extends pulumi.CustomResource {
     ...
     * Vault properties.
     */
    declare public readonly properties: pulumi.Output<outputs.datareplication.VaultModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<outputs.datareplication.VaultModelResponseSystemData>;
    /**
    ...
    constructor(name: string, args: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datareplication/v20210216preview:Vault" }, { type: "azure-native:datareplication/v20240901:Vault" }, { type: "azure-native:datareplication/v20260501:Vault" }] };
