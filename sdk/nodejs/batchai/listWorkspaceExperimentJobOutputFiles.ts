...
export function listWorkspaceExperimentJobOutputFiles(args: ListWorkspaceExperimentJobOutputFilesArgs, opts?: pulumi.InvokeOptions): Promise<ListWorkspaceExperimentJobOutputFilesResult> {
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azurerm:batchai:listWorkspaceExperimentJobOutputFiles", {
...
export interface ListWorkspaceExperimentJobOutputFilesArgs {
    /**
 ...
 */
export interface ListWorkspaceExperimentJobOutputFilesResult {
    /**
