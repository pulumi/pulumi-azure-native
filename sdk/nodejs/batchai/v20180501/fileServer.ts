...
export class FileServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batchai/v20180501:FileServer';
    ...
    constructor(name: string, args: FileServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:batchai/v20180501:FileServer" }, { type: "azure-native:batchai:FileServer" }, { type: "azure-nextgen:batchai:FileServer" }, { type: "azure-native:batchai/latest:FileServer" }, { type: "azure-nextgen:batchai/latest:FileServer" }] };
