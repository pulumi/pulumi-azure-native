...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batchai:Job';
     ...
     * Caffe2 job settings.
     */
    public readonly caffe2Settings!: pulumi.Output<outputs.batchai.Caffe2SettingsResponse | undefined>;
    /**
     * Caffe job settings.
     */
    public readonly caffeSettings!: pulumi.Output<outputs.batchai.CaffeSettingsResponse | undefined>;
    /**
     * Chainer job settings.
     */
    public readonly chainerSettings!: pulumi.Output<outputs.batchai.ChainerSettingsResponse | undefined>;
    /**
     * Resource ID of the cluster associated with the job.
     */
    public readonly cluster!: pulumi.Output<outputs.batchai.ResourceIdResponse | undefined>;
    /**
     * CNTK (aka Microsoft Cognitive Toolkit) job settings.
     */
    public readonly cntkSettings!: pulumi.Output<outputs.batchai.CNTKsettingsResponse | undefined>;
    /**
     * Constraints associated with the Job.
     */
    public readonly constraints!: pulumi.Output<outputs.batchai.JobPropertiesResponseConstraints | undefined>;
    /**
     * If the container was downloaded as part of cluster setup then the same container image will be used. If not provided, the job will run on the VM.
     */
    public readonly containerSettings!: pulumi.Output<outputs.batchai.ContainerSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly customMpiSettings!: pulumi.Output<outputs.batchai.CustomMpiSettingsResponse | undefined>;
    /**
     * Custom tool kit job settings.
     */
    public readonly customToolkitSettings!: pulumi.Output<outputs.batchai.CustomToolkitSettingsResponse | undefined>;
    /**
     * A collection of user defined environment variables to be setup for the job.
     */
    public readonly environmentVariables!: pulumi.Output<outputs.batchai.EnvironmentVariableResponse[] | undefined>;
    /**
     * Information about the execution of a job.
     */
    public /*out*/ readonly executionInfo!: pulumi.Output<outputs.batchai.JobPropertiesResponseExecutionInfo | undefined>;
    /**
     ...
     */
    public readonly horovodSettings!: pulumi.Output<outputs.batchai.HorovodSettingsResponse | undefined>;
    /**
     * A list of input directories for the job.
     */
    public readonly inputDirectories!: pulumi.Output<outputs.batchai.InputDirectoryResponse[] | undefined>;
    /**
     ...
     */
    public readonly jobPreparation!: pulumi.Output<outputs.batchai.JobPreparationResponse | undefined>;
    /**
     ...
     */
    public readonly mountVolumes!: pulumi.Output<outputs.batchai.MountVolumesResponse | undefined>;
    /**
     ...
     */
    public readonly outputDirectories!: pulumi.Output<outputs.batchai.OutputDirectoryResponse[] | undefined>;
    /**
     ...
     */
    public readonly pyTorchSettings!: pulumi.Output<outputs.batchai.PyTorchSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly secrets!: pulumi.Output<outputs.batchai.EnvironmentVariableWithSecretValueResponse[] | undefined>;
    /**
     ...
     */
    public readonly tensorFlowSettings!: pulumi.Output<outputs.batchai.TensorFlowSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:batchai:Job" }, { type: "azure-native:batchai/v20180501:Job" }, { type: "azure-nextgen:batchai/v20180501:Job" }] };
...
export interface JobArgs {
     ...
     */
    caffe2Settings?: pulumi.Input<inputs.batchai.Caffe2SettingsArgs>;
    /**
     * Settings for Caffe job.
     */
    caffeSettings?: pulumi.Input<inputs.batchai.CaffeSettingsArgs>;
    /**
     * Settings for Chainer job.
     */
    chainerSettings?: pulumi.Input<inputs.batchai.ChainerSettingsArgs>;
    /**
     * Resource ID of the cluster on which this job will run.
     */
    cluster: pulumi.Input<inputs.batchai.ResourceIdArgs>;
    /**
     * Settings for CNTK (aka Microsoft Cognitive Toolkit) job.
     */
    cntkSettings?: pulumi.Input<inputs.batchai.CNTKsettingsArgs>;
    /**
     * Constraints associated with the Job.
     */
    constraints?: pulumi.Input<inputs.batchai.JobBasePropertiesConstraintsArgs>;
    /**
     * Docker container settings for the job. If not provided, the job will run directly on the node.
     */
    containerSettings?: pulumi.Input<inputs.batchai.ContainerSettingsArgs>;
    /**
     * Settings for custom MPI job.
     */
    customMpiSettings?: pulumi.Input<inputs.batchai.CustomMpiSettingsArgs>;
    /**
     * Settings for custom tool kit job.
     */
    customToolkitSettings?: pulumi.Input<inputs.batchai.CustomToolkitSettingsArgs>;
    /**
     * A list of user defined environment variables which will be setup for the job.
     */
    environmentVariables?: pulumi.Input<pulumi.Input<inputs.batchai.EnvironmentVariableArgs>[]>;
    /**
     ...
     */
    horovodSettings?: pulumi.Input<inputs.batchai.HorovodSettingsArgs>;
    /**
     * A list of input directories for the job.
     */
    inputDirectories?: pulumi.Input<pulumi.Input<inputs.batchai.InputDirectoryArgs>[]>;
    /**
     ...
     */
    jobPreparation?: pulumi.Input<inputs.batchai.JobPreparationArgs>;
    /**
     ...
     */
    mountVolumes?: pulumi.Input<inputs.batchai.MountVolumesArgs>;
    /**
     ...
     * A list of output directories for the job.
     */
    outputDirectories?: pulumi.Input<pulumi.Input<inputs.batchai.OutputDirectoryArgs>[]>;
    /**
     * Settings for pyTorch job.
     */
    pyTorchSettings?: pulumi.Input<inputs.batchai.PyTorchSettingsArgs>;
    /**
     ...
     */
    schedulingPriority?: pulumi.Input<string | enums.batchai.JobPriority>;
    /**
     ...
     */
    secrets?: pulumi.Input<pulumi.Input<inputs.batchai.EnvironmentVariableWithSecretValueArgs>[]>;
    /**
     ...
     */
    tensorFlowSettings?: pulumi.Input<inputs.batchai.TensorFlowSettingsArgs>;
    /**
