 ...
 *
 * const workspace = new azurerm.batchai.latest.Workspace("workspace", {
 *     location: "eastus",
...
export class Workspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:batchai/latest:Workspace';
    ...
    constructor(name: string, argsOrState?: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batchai/v20180501:Workspace" }] };
