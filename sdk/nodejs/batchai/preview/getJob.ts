...
export function getJob(args: GetJobArgs, opts?: pulumi.InvokeOptions): Promise<GetJobResult> {
    ...
    return pulumi.runtime.invoke("azurerm:batchai/preview:getJob", {
...
export interface GetJobResult {
     ...
     * Caffe2 job settings.
     */
    readonly caffe2Settings?: outputs.batchai.preview.Caffe2SettingsResponse;
    /**
     * Caffe job settings.
     */
    readonly caffeSettings?: outputs.batchai.preview.CaffeSettingsResponse;
    /**
     * Chainer job settings.
     */
    readonly chainerSettings?: outputs.batchai.preview.ChainerSettingsResponse;
    /**
     * Resource ID of the cluster associated with the job.
     */
    readonly cluster?: outputs.batchai.preview.ResourceIdResponse;
    /**
     * CNTK (aka Microsoft Cognitive Toolkit) job settings.
     */
    readonly cntkSettings?: outputs.batchai.preview.CNTKsettingsResponse;
    /**
     * Constraints associated with the Job.
     */
    readonly constraints?: outputs.batchai.preview.JobPropertiesResponseConstraints;
    /**
     * If the container was downloaded as part of cluster setup then the same container image will be used. If not provided, the job will run on the VM.
     */
    readonly containerSettings?: outputs.batchai.preview.ContainerSettingsResponse;
    /**
     ...
     */
    readonly customMpiSettings?: outputs.batchai.preview.CustomMpiSettingsResponse;
    /**
     * Custom tool kit job settings.
     */
    readonly customToolkitSettings?: outputs.batchai.preview.CustomToolkitSettingsResponse;
    /**
     * A collection of user defined environment variables to be setup for the job.
     */
    readonly environmentVariables?: outputs.batchai.preview.EnvironmentVariableResponse[];
    /**
     * Information about the execution of a job.
     */
    readonly executionInfo?: outputs.batchai.preview.JobPropertiesResponseExecutionInfo;
    /**
     ...
     */
    readonly horovodSettings?: outputs.batchai.preview.HorovodSettingsResponse;
    /**
     * A list of input directories for the job.
     */
    readonly inputDirectories?: outputs.batchai.preview.InputDirectoryResponse[];
    /**
     ...
     */
    readonly jobPreparation?: outputs.batchai.preview.JobPreparationResponse;
    /**
     ...
     */
    readonly mountVolumes?: outputs.batchai.preview.MountVolumesResponse;
    /**
     ...
     */
    readonly outputDirectories?: outputs.batchai.preview.OutputDirectoryResponse[];
    /**
     ...
     */
    readonly pyTorchSettings?: outputs.batchai.preview.PyTorchSettingsResponse;
    /**
     ...
     */
    readonly secrets?: outputs.batchai.preview.EnvironmentVariableWithSecretValueResponse[];
    /**
     ...
     */
    readonly tensorFlowSettings?: outputs.batchai.preview.TensorFlowSettingsResponse;
    /**
