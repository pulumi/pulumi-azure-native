...
export function getFileServer(args: GetFileServerArgs, opts?: pulumi.InvokeOptions): Promise<GetFileServerResult> {
    ...
    return pulumi.runtime.invoke("azurerm:batchai/preview:getFileServer", {
...
export interface GetFileServerResult {
     ...
     */
    readonly dataDisks?: outputs.batchai.preview.DataDisksResponse;
    /**
     * File Server mount settings.
     */
    readonly mountSettings: outputs.batchai.preview.MountSettingsResponse;
    /**
     ...
     */
    readonly sshConfiguration?: outputs.batchai.preview.SshConfigurationResponse;
    /**
