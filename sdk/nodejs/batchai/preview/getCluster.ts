...
export function getCluster(args: GetClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:batchai/preview:getCluster", {
...
export interface GetClusterResult {
     ...
     */
    readonly errors: outputs.batchai.preview.BatchAIErrorResponse[];
    /**
     ...
     */
    readonly nodeSetup?: outputs.batchai.preview.NodeSetupResponse;
    /**
     * Counts of various node states on the cluster.
     */
    readonly nodeStateCounts: outputs.batchai.preview.NodeStateCountsResponse;
    /**
     ...
     */
    readonly scaleSettings?: outputs.batchai.preview.ScaleSettingsResponse;
    /**
     * Virtual network subnet resource ID the cluster nodes belong to.
     */
    readonly subnet?: outputs.batchai.preview.ResourceIdResponse;
    /**
     ...
     */
    readonly userAccountSettings?: outputs.batchai.preview.UserAccountSettingsResponse;
    /**
     * Virtual machine configuration (OS image) of the compute nodes. All nodes in a cluster have the same OS image configuration.
     */
    readonly virtualMachineConfiguration?: outputs.batchai.preview.VirtualMachineConfigurationResponse;
    /**
