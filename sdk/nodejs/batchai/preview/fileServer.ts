...
export class FileServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:batchai/preview:FileServer';
     ...
     */
    public readonly dataDisks!: pulumi.Output<outputs.batchai.preview.DataDisksResponse | undefined>;
    /**
     * File Server mount settings.
     */
    public /*out*/ readonly mountSettings!: pulumi.Output<outputs.batchai.preview.MountSettingsResponse>;
    /**
     ...
     */
    public readonly sshConfiguration!: pulumi.Output<outputs.batchai.preview.SshConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: FileServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batchai/latest:FileServer" }, { type: "azurerm:batchai/v20180501:FileServer" }] };
...
export interface FileServerArgs {
     ...
     */
    readonly dataDisks: pulumi.Input<inputs.batchai.preview.DataDisks>;
    /**
     ...
     */
    readonly sshConfiguration: pulumi.Input<inputs.batchai.preview.SshConfiguration>;
    /**
