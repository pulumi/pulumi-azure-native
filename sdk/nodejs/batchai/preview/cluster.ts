...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:batchai/preview:Cluster';
     ...
     */
    public /*out*/ readonly errors!: pulumi.Output<outputs.batchai.preview.BatchAIErrorResponse[]>;
    /**
     ...
     */
    public readonly nodeSetup!: pulumi.Output<outputs.batchai.preview.NodeSetupResponse | undefined>;
    /**
     * Counts of various node states on the cluster.
     */
    public /*out*/ readonly nodeStateCounts!: pulumi.Output<outputs.batchai.preview.NodeStateCountsResponse>;
    /**
     ...
     */
    public readonly scaleSettings!: pulumi.Output<outputs.batchai.preview.ScaleSettingsResponse | undefined>;
    /**
     * Virtual network subnet resource ID the cluster nodes belong to.
     */
    public readonly subnet!: pulumi.Output<outputs.batchai.preview.ResourceIdResponse | undefined>;
    /**
     ...
     */
    public readonly userAccountSettings!: pulumi.Output<outputs.batchai.preview.UserAccountSettingsResponse | undefined>;
    /**
     * Virtual machine configuration (OS image) of the compute nodes. All nodes in a cluster have the same OS image configuration.
     */
    public readonly virtualMachineConfiguration!: pulumi.Output<outputs.batchai.preview.VirtualMachineConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batchai/latest:Cluster" }, { type: "azurerm:batchai/v20180501:Cluster" }] };
...
export interface ClusterArgs {
     ...
     */
    readonly nodeSetup?: pulumi.Input<inputs.batchai.preview.NodeSetup>;
    /**
     ...
     */
    readonly scaleSettings?: pulumi.Input<inputs.batchai.preview.ScaleSettings>;
    /**
     ...
     */
    readonly subnet?: pulumi.Input<inputs.batchai.preview.ResourceId>;
    /**
     * Settings for an administrator user account that will be created on each compute node in the cluster.
     */
    readonly userAccountSettings: pulumi.Input<inputs.batchai.preview.UserAccountSettings>;
    /**
     * OS image configuration for cluster nodes. All nodes in a cluster have the same OS image.
     */
    readonly virtualMachineConfiguration?: pulumi.Input<inputs.batchai.preview.VirtualMachineConfiguration>;
    /**
