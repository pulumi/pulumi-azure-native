...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:batchai/preview:Job';
     ...
     * Caffe2 job settings.
     */
    public readonly caffe2Settings!: pulumi.Output<outputs.batchai.preview.Caffe2SettingsResponse | undefined>;
    /**
     * Caffe job settings.
     */
    public readonly caffeSettings!: pulumi.Output<outputs.batchai.preview.CaffeSettingsResponse | undefined>;
    /**
     * Chainer job settings.
     */
    public readonly chainerSettings!: pulumi.Output<outputs.batchai.preview.ChainerSettingsResponse | undefined>;
    /**
     * Resource ID of the cluster associated with the job.
     */
    public readonly cluster!: pulumi.Output<outputs.batchai.preview.ResourceIdResponse | undefined>;
    /**
     * CNTK (aka Microsoft Cognitive Toolkit) job settings.
     */
    public readonly cntkSettings!: pulumi.Output<outputs.batchai.preview.CNTKsettingsResponse | undefined>;
    /**
     * Constraints associated with the Job.
     */
    public readonly constraints!: pulumi.Output<outputs.batchai.preview.JobPropertiesResponseConstraints | undefined>;
    /**
     * If the container was downloaded as part of cluster setup then the same container image will be used. If not provided, the job will run on the VM.
     */
    public readonly containerSettings!: pulumi.Output<outputs.batchai.preview.ContainerSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly customMpiSettings!: pulumi.Output<outputs.batchai.preview.CustomMpiSettingsResponse | undefined>;
    /**
     * Custom tool kit job settings.
     */
    public readonly customToolkitSettings!: pulumi.Output<outputs.batchai.preview.CustomToolkitSettingsResponse | undefined>;
    /**
     * A collection of user defined environment variables to be setup for the job.
     */
    public readonly environmentVariables!: pulumi.Output<outputs.batchai.preview.EnvironmentVariableResponse[] | undefined>;
    /**
     * Information about the execution of a job.
     */
    public /*out*/ readonly executionInfo!: pulumi.Output<outputs.batchai.preview.JobPropertiesResponseExecutionInfo | undefined>;
    /**
     ...
     */
    public readonly horovodSettings!: pulumi.Output<outputs.batchai.preview.HorovodSettingsResponse | undefined>;
    /**
     * A list of input directories for the job.
     */
    public readonly inputDirectories!: pulumi.Output<outputs.batchai.preview.InputDirectoryResponse[] | undefined>;
    /**
     ...
     */
    public readonly jobPreparation!: pulumi.Output<outputs.batchai.preview.JobPreparationResponse | undefined>;
    /**
     ...
     */
    public readonly mountVolumes!: pulumi.Output<outputs.batchai.preview.MountVolumesResponse | undefined>;
    /**
     ...
     */
    public readonly outputDirectories!: pulumi.Output<outputs.batchai.preview.OutputDirectoryResponse[] | undefined>;
    /**
     ...
     */
    public readonly pyTorchSettings!: pulumi.Output<outputs.batchai.preview.PyTorchSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly secrets!: pulumi.Output<outputs.batchai.preview.EnvironmentVariableWithSecretValueResponse[] | undefined>;
    /**
     ...
     */
    public readonly tensorFlowSettings!: pulumi.Output<outputs.batchai.preview.TensorFlowSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batchai/latest:Job" }, { type: "azurerm:batchai/v20180501:Job" }] };
...
export interface JobArgs {
     ...
     */
    readonly caffe2Settings?: pulumi.Input<inputs.batchai.preview.Caffe2Settings>;
    /**
     * Settings for Caffe job.
     */
    readonly caffeSettings?: pulumi.Input<inputs.batchai.preview.CaffeSettings>;
    /**
     * Settings for Chainer job.
     */
    readonly chainerSettings?: pulumi.Input<inputs.batchai.preview.ChainerSettings>;
    /**
     * Resource ID of the cluster on which this job will run.
     */
    readonly cluster: pulumi.Input<inputs.batchai.preview.ResourceId>;
    /**
     * Settings for CNTK (aka Microsoft Cognitive Toolkit) job.
     */
    readonly cntkSettings?: pulumi.Input<inputs.batchai.preview.CNTKsettings>;
    /**
     * Constraints associated with the Job.
     */
    readonly constraints?: pulumi.Input<inputs.batchai.preview.JobBasePropertiesConstraints>;
    /**
     * Docker container settings for the job. If not provided, the job will run directly on the node.
     */
    readonly containerSettings?: pulumi.Input<inputs.batchai.preview.ContainerSettings>;
    /**
     * Settings for custom MPI job.
     */
    readonly customMpiSettings?: pulumi.Input<inputs.batchai.preview.CustomMpiSettings>;
    /**
     * Settings for custom tool kit job.
     */
    readonly customToolkitSettings?: pulumi.Input<inputs.batchai.preview.CustomToolkitSettings>;
    /**
     * A list of user defined environment variables which will be setup for the job.
     */
    readonly environmentVariables?: pulumi.Input<pulumi.Input<inputs.batchai.preview.EnvironmentVariable>[]>;
    /**
     ...
     */
    readonly horovodSettings?: pulumi.Input<inputs.batchai.preview.HorovodSettings>;
    /**
     * A list of input directories for the job.
     */
    readonly inputDirectories?: pulumi.Input<pulumi.Input<inputs.batchai.preview.InputDirectory>[]>;
    /**
     ...
     */
    readonly jobPreparation?: pulumi.Input<inputs.batchai.preview.JobPreparation>;
    /**
     ...
     */
    readonly mountVolumes?: pulumi.Input<inputs.batchai.preview.MountVolumes>;
    /**
     ...
     * A list of output directories for the job.
     */
    readonly outputDirectories?: pulumi.Input<pulumi.Input<inputs.batchai.preview.OutputDirectory>[]>;
    /**
     * Settings for pyTorch job.
     */
    readonly pyTorchSettings?: pulumi.Input<inputs.batchai.preview.PyTorchSettings>;
    /**
     ...
     */
    readonly secrets?: pulumi.Input<pulumi.Input<inputs.batchai.preview.EnvironmentVariableWithSecretValue>[]>;
    /**
     ...
     */
    readonly tensorFlowSettings?: pulumi.Input<inputs.batchai.preview.TensorFlowSettings>;
    /**
