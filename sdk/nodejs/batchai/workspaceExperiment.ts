...
export class WorkspaceExperiment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceExperiment {
        return new WorkspaceExperiment(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: WorkspaceExperimentArgs, opts?: pulumi.CustomResourceOptions) {
