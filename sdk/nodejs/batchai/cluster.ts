...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batchai:Cluster';
     ...
     */
    public /*out*/ readonly errors!: pulumi.Output<outputs.batchai.BatchAIErrorResponse[]>;
    /**
     ...
     */
    public readonly nodeSetup!: pulumi.Output<outputs.batchai.NodeSetupResponse | undefined>;
    /**
     * Counts of various node states on the cluster.
     */
    public /*out*/ readonly nodeStateCounts!: pulumi.Output<outputs.batchai.NodeStateCountsResponse>;
    /**
     ...
     */
    public readonly scaleSettings!: pulumi.Output<outputs.batchai.ScaleSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly userAccountSettings!: pulumi.Output<outputs.batchai.UserAccountSettingsResponse | undefined>;
    /**
     * Virtual machine configuration (OS image) of the compute nodes. All nodes in a cluster have the same OS image configuration.
     */
    public readonly virtualMachineConfiguration!: pulumi.Output<outputs.batchai.VirtualMachineConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:batchai:Cluster" }, { type: "azure-native:batchai/latest:Cluster" }, { type: "azure-nextgen:batchai/latest:Cluster" }, { type: "azure-native:batchai/v20180501:Cluster" }, { type: "azure-nextgen:batchai/v20180501:Cluster" }] };
...
export interface ClusterArgs {
     ...
     */
    readonly nodeSetup?: pulumi.Input<inputs.batchai.NodeSetup>;
    /**
     ...
     */
    readonly scaleSettings?: pulumi.Input<inputs.batchai.ScaleSettings>;
    /**
     ...
     */
    readonly userAccountSettings: pulumi.Input<inputs.batchai.UserAccountSettings>;
    /**
     * OS image configuration for cluster nodes. All nodes in a cluster have the same OS image.
     */
    readonly virtualMachineConfiguration?: pulumi.Input<inputs.batchai.VirtualMachineConfiguration>;
    /**
