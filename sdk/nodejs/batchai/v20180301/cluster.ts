...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batchai/v20180301:Cluster';
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:batchai/v20180301:Cluster" }, { type: "azure-native:batchai/v20170901preview:Cluster" }, { type: "azure-nextgen:batchai/v20170901preview:Cluster" }] };
...
export interface ClusterArgs {
     ...
     * Use this to prepare the VM. NOTE: The volumes specified in mountVolumes are mounted first and then the setupTask is run. Therefore the setup task can use local mountPaths in its execution.
     */
    nodeSetup?: pulumi.Input<inputs.batchai.v20180301.NodeSetupArgs>;
    /**
     ...
     * At least one of manual or autoScale settings must be specified. Only one of manual or autoScale settings can be specified. If autoScale settings are specified, the system automatically scales the cluster up and down (within the supplied limits) based on the pending jobs on the cluster.
     */
    scaleSettings?: pulumi.Input<inputs.batchai.v20180301.ScaleSettingsArgs>;
    /**
     * Represents a resource ID. For example, for a subnet, it is the resource URL for the subnet.
     */
    subnet?: pulumi.Input<inputs.batchai.v20180301.ResourceIdArgs>;
    /**
     ...
     * Settings for user account that gets created on each on the nodes of a cluster.
     */
    userAccountSettings: pulumi.Input<inputs.batchai.v20180301.UserAccountSettingsArgs>;
    /**
     * Settings for OS image.
     */
    virtualMachineConfiguration?: pulumi.Input<inputs.batchai.v20180301.VirtualMachineConfigurationArgs>;
    /**
     * Default is dedicated.
     */
    vmPriority?: pulumi.Input<enums.batchai.v20180301.VmPriority>;
    /**
     * All virtual machines in a cluster are the same size. For information about available VM sizes for clusters using images from the Virtual Machines Marketplace (see Sizes for Virtual Machines (Linux) or Sizes for Virtual Machines (Windows). Batch AI service supports all Azure VM sizes except STANDARD_A0 and those with premium storage (STANDARD_GS, STANDARD_DS, and STANDARD_DSV2 series).
     */
