...
export interface GetJobResult {
     ...
     */
    readonly caffeSettings?: outputs.batchai.v20180301.CaffeSettingsInvokeResponse;
    /**
     * Specifies the settings for Chainer job.
     */
    readonly chainerSettings?: outputs.batchai.v20180301.ChainerSettingsInvokeResponse;
    /**
     * Represents a resource ID. For example, for a subnet, it is the resource URL for the subnet.
     */
    readonly cluster?: outputs.batchai.v20180301.ResourceIdInvokeResponse;
    /**
     * Specifies the settings for CNTK (aka Microsoft Cognitive Toolkit) job.
     */
    readonly cntkSettings?: outputs.batchai.v20180301.CNTKsettingsInvokeResponse;
    /**
     * Constraints associated with the Job.
     */
    readonly constraints?: outputs.batchai.v20180301.JobPropertiesInvokeResponseConstraints;
    /**
     * If the container was downloaded as part of cluster setup then the same container image will be used. If not provided, the job will run on the VM.
     */
    readonly containerSettings?: outputs.batchai.v20180301.ContainerSettingsInvokeResponse;
    /**
     ...
     */
    readonly customToolkitSettings?: outputs.batchai.v20180301.CustomToolkitSettingsInvokeResponse;
    /**
     * Batch AI will setup these additional environment variables for the job.
     */
    readonly environmentVariables?: outputs.batchai.v20180301.EnvironmentVariableInvokeResponse[];
    /**
     * Contains information about the execution of a job in the Azure Batch service.
     */
    readonly executionInfo?: outputs.batchai.v20180301.JobPropertiesInvokeResponseExecutionInfo;
    /**
     ...
     */
    readonly id: string;
    readonly inputDirectories?: outputs.batchai.v20180301.InputDirectoryInvokeResponse[];
    /**
     ...
     */
    readonly jobPreparation?: outputs.batchai.v20180301.JobPreparationInvokeResponse;
    /**
     ...
     */
    readonly mountVolumes?: outputs.batchai.v20180301.MountVolumesInvokeResponse;
    /**
    ...
    readonly outputDirectories?: outputs.batchai.v20180301.OutputDirectoryInvokeResponse[];
    /**
     ...
     */
    readonly pyTorchSettings?: outputs.batchai.v20180301.PyTorchSettingsInvokeResponse;
    /**
     ...
     */
    readonly secrets?: outputs.batchai.v20180301.EnvironmentVariableWithSecretValueInvokeResponse[];
    /**
     ...
     */
    readonly tensorFlowSettings?: outputs.batchai.v20180301.TensorFlowSettingsInvokeResponse;
    /**
