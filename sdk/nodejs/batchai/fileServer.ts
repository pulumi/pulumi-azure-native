...
export class FileServer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:batchai:FileServer" }, { type: "azure-native:batchai/v20180501:FileServer" }, { type: "azure-nextgen:batchai/v20180501:FileServer" }] };
