...
export class FileServer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:batchai:FileServer" }, { type: "azure-native:batchai/v20170901preview:FileServer" }, { type: "azure-nextgen:batchai/v20170901preview:FileServer" }, { type: "azure-native:batchai/v20180301:FileServer" }, { type: "azure-nextgen:batchai/v20180301:FileServer" }] };
...
export interface FileServerArgs {
     ...
     * Settings for the data disk which would be created for the File Server.
     */
    readonly dataDisks: pulumi.Input<inputs.batchai.DataDisksArgs>;
    /**
     ...
     * SSH configuration settings for the VM
     */
    readonly sshConfiguration: pulumi.Input<inputs.batchai.SshConfigurationArgs>;
    /**
     * Represents a resource ID. For example, for a subnet, it is the resource URL for the subnet.
     */
