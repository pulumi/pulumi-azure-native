...
export class FileServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batchai:FileServer';
     ...
     */
    public readonly dataDisks!: pulumi.Output<outputs.batchai.DataDisksResponse | undefined>;
    /**
     * File Server mount settings.
     */
    public /*out*/ readonly mountSettings!: pulumi.Output<outputs.batchai.MountSettingsResponse>;
    /**
     ...
     */
    public readonly sshConfiguration!: pulumi.Output<outputs.batchai.SshConfigurationResponse | undefined>;
    /**
     * File Server virtual network subnet resource ID.
     */
    public readonly subnet!: pulumi.Output<outputs.batchai.ResourceIdResponse | undefined>;
    /**
    ...
    constructor(name: string, args: FileServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:batchai:FileServer" }, { type: "azure-native:batchai/latest:FileServer" }, { type: "azure-nextgen:batchai/latest:FileServer" }, { type: "azure-native:batchai/v20180501:FileServer" }, { type: "azure-nextgen:batchai/v20180501:FileServer" }] };
...
export interface FileServerArgs {
     ...
     */
    readonly dataDisks: pulumi.Input<inputs.batchai.DataDisks>;
    /**
     ...
     */
    readonly sshConfiguration: pulumi.Input<inputs.batchai.SshConfiguration>;
    /**
     ...
     */
    readonly subnet?: pulumi.Input<inputs.batchai.ResourceId>;
    /**
