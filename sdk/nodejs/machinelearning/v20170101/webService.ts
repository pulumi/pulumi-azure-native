...
export class WebService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearning/v20170101:WebService';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearning.v20170101.WebServicePropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: WebServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearning/latest:WebService" }, { type: "azurerm:machinelearning/preview:WebService" }, { type: "azurerm:machinelearning/v20160501preview:WebService" }] };
