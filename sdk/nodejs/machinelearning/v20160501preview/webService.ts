...
export class WebService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearning:WebService" }, { type: "azure-nextgen:machinelearning:WebService" }, { type: "azure-native:machinelearning/latest:WebService" }, { type: "azure-nextgen:machinelearning/latest:WebService" }, { type: "azure-native:machinelearning/v20170101:WebService" }, { type: "azure-nextgen:machinelearning/v20170101:WebService" }] };
