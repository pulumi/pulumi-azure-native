 ...
 *
 * @deprecated Version 2016-05-01-preview will be removed in v2 of the provider.
 */
export class WebService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebService {
        pulumi.log.warn("WebService is deprecated: Version 2016-05-01-preview will be removed in v2 of the provider.")
