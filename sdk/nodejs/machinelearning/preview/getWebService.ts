...
export function getWebService(args: GetWebServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetWebServiceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:machinelearning/preview:getWebService", {
        "region": args.region,
...
export interface GetWebServiceResult {
     ...
     */
    readonly properties: outputs.machinelearning.preview.WebServicePropertiesForGraphResponse;
    /**
