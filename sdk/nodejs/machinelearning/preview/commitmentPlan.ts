...
export class CommitmentPlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CommitmentPlan {
        return new CommitmentPlan(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearning/preview:CommitmentPlan';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.machinelearning.preview.CommitmentPlanPropertiesResponse>;
    /**
     * The commitment plan SKU.
     */
    public readonly sku!: pulumi.Output<outputs.machinelearning.preview.ResourceSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CommitmentPlanArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CommitmentPlanArgs | undefined;
            if (!args || args.commitmentPlanName === undefined) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearning/v20160501preview:CommitmentPlan" }] };
...
export interface CommitmentPlanArgs {
     ...
     * The commitment plan SKU.
     */
    readonly sku?: pulumi.Input<inputs.machinelearning.preview.ResourceSku>;
    /**
     * User-defined tags for the resource.
     */
