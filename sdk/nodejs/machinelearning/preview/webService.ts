...
export class WebService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebService {
        return new WebService(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearning/preview:WebService';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearning.preview.WebServicePropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: WebServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearning/latest:WebService" }, { type: "azurerm:machinelearning/v20160501preview:WebService" }, { type: "azurerm:machinelearning/v20170101:WebService" }] };
...
export interface WebServiceArgs {
     ...
     * Contains the property payload that describes the web service.
     */
    readonly properties: pulumi.Input<inputs.machinelearning.preview.WebServiceProperties>;
    /**
