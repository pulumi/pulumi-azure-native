...
export class WebService extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearning.preview.WebServicePropertiesForGraphResponse>;
    /**
...
export interface WebServiceArgs {
     ...
     * Contains the property payload that describes the web service.
     */
    readonly properties: pulumi.Input<inputs.machinelearning.preview.WebServicePropertiesForGraph>;
    /**
