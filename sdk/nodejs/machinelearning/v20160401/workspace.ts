...
export class Workspace extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearning/latest:Workspace" }, { type: "azurerm:machinelearning/preview:Workspace" }, { type: "azurerm:machinelearning/v20191001:Workspace" }] };
