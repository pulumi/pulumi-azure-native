...
export class WebService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearning/latest:WebService';
    ...
    constructor(name: string, args: WebServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearning/preview:WebService" }, { type: "azurerm:machinelearning/v20160501preview:WebService" }, { type: "azurerm:machinelearning/v20170101:WebService" }] };
