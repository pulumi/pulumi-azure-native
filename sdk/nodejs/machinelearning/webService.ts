...
export class WebService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:machinelearning:WebService';
    ...
    constructor(name: string, args: WebServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearning/latest:WebService" }, { type: "azure-nextgen:machinelearning/v20160501preview:WebService" }, { type: "azure-nextgen:machinelearning/v20170101:WebService" }] };
