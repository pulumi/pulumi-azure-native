...
export class WebService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearning:WebService';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearning.WebServicePropertiesResponse>;
    /**
...
export interface WebServiceState {
     ...
     * Contains the property payload that describes the web service.
     */
    readonly properties: pulumi.Input<inputs.machinelearning.WebServicePropertiesResponse>;
    /**
     * Contains resource tags defined as key/value pairs.
     */
...
export interface WebServiceArgs {
     ...
     * Contains the property payload that describes the web service.
     */
    readonly properties: pulumi.Input<inputs.machinelearning.WebServiceProperties>;
    /**
