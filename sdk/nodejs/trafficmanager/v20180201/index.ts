...
// Export enums:
export * from "../../types/enums/trafficmanager/v20180201";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:trafficmanager/v20180201:Endpoint":
                return new Endpoint(name, <any>undefined, { urn })
            case "azure-native:trafficmanager/v20180201:Profile":
...
pulumi.runtime.registerResourceModule("azure-native", "trafficmanager/v20180201", _module)
