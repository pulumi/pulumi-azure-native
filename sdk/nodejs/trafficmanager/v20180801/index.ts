...
// Export enums:
export * from "../../types/enums/trafficmanager/v20180801";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:trafficmanager/v20180801:Endpoint":
                return new Endpoint(name, <any>undefined, { urn })
            case "azure-native:trafficmanager/v20180801:Profile":
                return new Profile(name, <any>undefined, { urn })
            case "azure-native:trafficmanager/v20180801:TrafficManagerUserMetricsKey":
...
pulumi.runtime.registerResourceModule("azure-native", "trafficmanager/v20180801", _module)
