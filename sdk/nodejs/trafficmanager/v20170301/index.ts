...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:trafficmanager/v20170301:Endpoint":
                return new Endpoint(name, <any>undefined, { urn })
            case "azure-native:trafficmanager/v20170301:Profile":
...
pulumi.runtime.registerResourceModule("azure-native", "trafficmanager/v20170301", _module)
