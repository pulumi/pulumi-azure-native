...
export function getEndpoint(args: GetEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-native:trafficmanager/v20220401preview:getEndpoint", {
...
export interface GetEndpointResult {
     ...
     */
    readonly customHeaders?: outputs.trafficmanager.v20220401preview.EndpointPropertiesResponseCustomHeaders[];
    /**
     ...
     */
    readonly subnets?: outputs.trafficmanager.v20220401preview.EndpointPropertiesResponseSubnets[];
    /**
...
export function getEndpointOutput(args: GetEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEndpointResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:trafficmanager/v20220401preview:getEndpoint", {
        "endpointName": args.endpointName,
        "endpointType": args.endpointType,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
