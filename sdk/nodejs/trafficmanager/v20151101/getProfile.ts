...
export function getProfile(args: GetProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:trafficmanager/v20151101:getProfile", {
...
export interface GetProfileResult {
     ...
     */
    readonly dnsConfig?: outputs.trafficmanager.v20151101.DnsConfigResponse;
    /**
     * Gets or sets the list of endpoints in the Traffic Manager profile.
     */
    readonly endpoints?: outputs.trafficmanager.v20151101.EndpointResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly monitorConfig?: outputs.trafficmanager.v20151101.MonitorConfigResponse;
    /**
     * Resource name
     */
...
export function getProfileOutput(args: GetProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProfileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:trafficmanager/v20151101:getProfile", {
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
