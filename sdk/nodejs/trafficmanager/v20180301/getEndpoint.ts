...
export function getEndpoint(args: GetEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-native:trafficmanager/v20180301:getEndpoint", {
...
export interface GetEndpointResult {
     ...
     */
    readonly customHeaders?: outputs.trafficmanager.v20180301.EndpointPropertiesResponseCustomHeaders[];
    /**
...
export function getEndpointOutput(args: GetEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEndpointResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:trafficmanager/v20180301:getEndpoint", {
        "endpointName": args.endpointName,
        "endpointType": args.endpointType,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
