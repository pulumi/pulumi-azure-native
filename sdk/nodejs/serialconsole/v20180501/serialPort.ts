...
export class SerialPort extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SerialPortArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:serialconsole/v20180501:SerialPort" }, { type: "azure-native:serialconsole:SerialPort" }, { type: "azure-nextgen:serialconsole:SerialPort" }] };
...
export interface SerialPortArgs {
     ...
     * Specifies whether the port is enabled for a serial console connection.
     */
    state?: pulumi.Input<enums.serialconsole.v20180501.SerialPortState>;
}
