...
export function getSerialPort(args: GetSerialPortArgs, opts?: pulumi.InvokeOptions): Promise<GetSerialPortResult> {
    pulumi.log.warn("getSerialPort is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:serialconsole:getSerialPort'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-nextgen:serialconsole/latest:getSerialPort", {
