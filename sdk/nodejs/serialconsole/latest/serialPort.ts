 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:serialconsole:SerialPort'.
 */
export class SerialPort extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:serialconsole/latest:SerialPort';
    ...
    constructor(name: string, args: SerialPortArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:serialconsole/latest:SerialPort" }, { type: "azure-native:serialconsole:SerialPort" }, { type: "azure-nextgen:serialconsole:SerialPort" }, { type: "azure-native:serialconsole/v20180501:SerialPort" }, { type: "azure-nextgen:serialconsole/v20180501:SerialPort" }] };
