...
export class StandbyVirtualMachinePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:standbypool/v20240301:StandbyVirtualMachinePool';
     ...
     */
    public readonly elasticityProfile!: pulumi.Output<outputs.standbypool.v20240301.StandbyVirtualMachinePoolElasticityProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, args: StandbyVirtualMachinePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:standbypool/v20231201preview:StandbyVirtualMachinePool" }, { type: "azure-native:standbypool/v20240301preview:StandbyVirtualMachinePool" }, { type: "azure-native:standbypool/v20250301:StandbyVirtualMachinePool" }, { type: "azure-native:standbypool:StandbyVirtualMachinePool" }] };
