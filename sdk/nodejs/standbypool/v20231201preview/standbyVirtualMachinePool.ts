...
export class StandbyVirtualMachinePool extends pulumi.CustomResource {
     ...
     */
    public readonly elasticityProfile!: pulumi.Output<outputs.standbypool.v20231201preview.StandbyVirtualMachinePoolElasticityProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, args: StandbyVirtualMachinePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:standbypool/v20240301:StandbyVirtualMachinePool" }, { type: "azure-native:standbypool/v20240301preview:StandbyVirtualMachinePool" }, { type: "azure-native:standbypool/v20250301:StandbyVirtualMachinePool" }, { type: "azure-native:standbypool:StandbyVirtualMachinePool" }] };
