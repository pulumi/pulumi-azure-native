...
export class StandbyContainerGroupPool extends pulumi.CustomResource {
     ...
     */
    public readonly containerGroupProperties!: pulumi.Output<outputs.standbypool.v20231201preview.ContainerGroupPropertiesResponse>;
    /**
     * Specifies elasticity profile of standby container group pools.
     */
    public readonly elasticityProfile!: pulumi.Output<outputs.standbypool.v20231201preview.StandbyContainerGroupPoolElasticityProfileResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.standbypool.v20231201preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: StandbyContainerGroupPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:standbypool/v20240301:StandbyContainerGroupPool" }, { type: "azure-native:standbypool/v20240301preview:StandbyContainerGroupPool" }, { type: "azure-native:standbypool/v20250301:StandbyContainerGroupPool" }, { type: "azure-native:standbypool:StandbyContainerGroupPool" }] };
