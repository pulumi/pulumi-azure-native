...
export class StandbyContainerGroupPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StandbyContainerGroupPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:standbypool/v20240301:StandbyContainerGroupPool" }, { type: "azure-native:standbypool/v20240301preview:StandbyContainerGroupPool" }, { type: "azure-native:standbypool:StandbyContainerGroupPool" }] };
