...
export function getStandbyContainerGroupPool(args: GetStandbyContainerGroupPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetStandbyContainerGroupPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:standbypool/v20240301preview:getStandbyContainerGroupPool", {
...
export interface GetStandbyContainerGroupPoolResult {
     ...
     */
    readonly containerGroupProperties: outputs.standbypool.v20240301preview.ContainerGroupPropertiesResponse;
    /**
     * Specifies elasticity profile of standby container group pools.
     */
    readonly elasticityProfile: outputs.standbypool.v20240301preview.StandbyContainerGroupPoolElasticityProfileResponse;
    /**
     ...
     */
    readonly systemData: outputs.standbypool.v20240301preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getStandbyContainerGroupPoolOutput(args: GetStandbyContainerGroupPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStandbyContainerGroupPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:standbypool/v20240301preview:getStandbyContainerGroupPool", {
        "resourceGroupName": args.resourceGroupName,
        "standbyContainerGroupPoolName": args.standbyContainerGroupPoolName,
    }, opts);
}
