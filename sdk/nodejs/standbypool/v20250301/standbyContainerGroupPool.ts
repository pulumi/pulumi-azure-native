...
export class StandbyContainerGroupPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:standbypool/v20250301:StandbyContainerGroupPool';
     ...
     */
    public readonly containerGroupProperties!: pulumi.Output<outputs.standbypool.v20250301.ContainerGroupPropertiesResponse>;
    /**
     * Specifies elasticity profile of standby container group pools.
     */
    public readonly elasticityProfile!: pulumi.Output<outputs.standbypool.v20250301.StandbyContainerGroupPoolElasticityProfileResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.standbypool.v20250301.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: StandbyContainerGroupPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:standbypool/v20231201preview:StandbyContainerGroupPool" }, { type: "azure-native:standbypool/v20240301:StandbyContainerGroupPool" }, { type: "azure-native:standbypool/v20240301preview:StandbyContainerGroupPool" }, { type: "azure-native:standbypool:StandbyContainerGroupPool" }] };
...
export interface StandbyContainerGroupPoolArgs {
     ...
     * Specifies container group properties of standby container group pools.
     */
    containerGroupProperties: pulumi.Input<inputs.standbypool.v20250301.ContainerGroupPropertiesArgs>;
    /**
     * Specifies elasticity profile of standby container group pools.
     */
    elasticityProfile: pulumi.Input<inputs.standbypool.v20250301.StandbyContainerGroupPoolElasticityProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
