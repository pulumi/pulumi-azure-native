...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:standbypool/v20250301:StandbyContainerGroupPool":
                return new StandbyContainerGroupPool(name, <any>undefined, { urn })
            case "azure-native:standbypool/v20250301:StandbyVirtualMachinePool":
...
pulumi.runtime.registerResourceModule("azure-native", "standbypool/v20250301", _module)
