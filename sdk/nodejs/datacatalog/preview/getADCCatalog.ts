...
export function getADCCatalog(args: GetADCCatalogArgs, opts?: pulumi.InvokeOptions): Promise<GetADCCatalogResult> {
    ...
    return pulumi.runtime.invoke("azurerm:datacatalog/preview:getADCCatalog", {
...
export interface GetADCCatalogResult {
     ...
     */
    readonly admins?: outputs.datacatalog.preview.PrincipalsResponse[];
    /**
     ...
     */
    readonly users?: outputs.datacatalog.preview.PrincipalsResponse[];
}
