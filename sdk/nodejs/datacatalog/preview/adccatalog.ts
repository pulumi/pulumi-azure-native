...
export class ADCCatalog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datacatalog/preview:ADCCatalog';
     ...
     */
    public readonly admins!: pulumi.Output<outputs.datacatalog.preview.PrincipalsResponse[] | undefined>;
    /**
     ...
     */
    public readonly users!: pulumi.Output<outputs.datacatalog.preview.PrincipalsResponse[] | undefined>;
    ...
    constructor(name: string, argsOrState?: ADCCatalogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datacatalog/latest:ADCCatalog" }, { type: "azurerm:datacatalog/v20160330:ADCCatalog" }] };
...
export interface ADCCatalogArgs {
     ...
     * Azure data catalog admin list.
     */
    readonly admins?: pulumi.Input<pulumi.Input<inputs.datacatalog.preview.Principals>[]>;
    /**
     ...
     * Azure data catalog user list.
     */
    readonly users?: pulumi.Input<pulumi.Input<inputs.datacatalog.preview.Principals>[]>;
}
