...
export class ADCCatalog extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ADCCatalogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datacatalog/v20160330:ADCCatalog" }, { type: "azure-native:datacatalog:ADCCatalog" }, { type: "azure-nextgen:datacatalog:ADCCatalog" }] };
...
export interface ADCCatalogArgs {
     ...
     * Azure data catalog SKU.
     */
    readonly sku?: pulumi.Input<string | enums.datacatalog.v20160330.SkuType>;
    /**
     * Azure data catalog provision status.
     */
