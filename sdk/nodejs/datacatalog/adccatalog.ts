...
export class ADCCatalog extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ADCCatalogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datacatalog:ADCCatalog" }, { type: "azure-native:datacatalog/latest:ADCCatalog" }, { type: "azure-nextgen:datacatalog/latest:ADCCatalog" }, { type: "azure-native:datacatalog/v20160330:ADCCatalog" }, { type: "azure-nextgen:datacatalog/v20160330:ADCCatalog" }] };
...
export interface ADCCatalogArgs {
     ...
     * Azure data catalog admin list.
     */
    readonly admins?: pulumi.Input<pulumi.Input<inputs.datacatalog.Principals>[]>;
    /**
     ...
     * Azure data catalog SKU.
     */
    readonly sku?: pulumi.Input<string | enums.datacatalog.SkuType>;
    /**
     * Azure data catalog provision status.
     */
     ...
     * Azure data catalog user list.
     */
    readonly users?: pulumi.Input<pulumi.Input<inputs.datacatalog.Principals>[]>;
}
