...
export class ADCCatalog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datacatalog/latest:ADCCatalog';
    ...
    constructor(name: string, args: ADCCatalogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datacatalog/latest:ADCCatalog" }, { type: "azure-native:datacatalog:ADCCatalog" }, { type: "azure-nextgen:datacatalog:ADCCatalog" }, { type: "azure-native:datacatalog/v20160330:ADCCatalog" }, { type: "azure-nextgen:datacatalog/v20160330:ADCCatalog" }] };
...
export interface ADCCatalogArgs {
     ...
     * Azure data catalog SKU.
     */
    readonly sku?: pulumi.Input<string | enums.datacatalog.latest.SkuType>;
    /**
     * Azure data catalog provision status.
     */
