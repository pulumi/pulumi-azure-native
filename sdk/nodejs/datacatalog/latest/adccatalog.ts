...
export class ADCCatalog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datacatalog/latest:ADCCatalog';
    ...
    constructor(name: string, argsOrState?: ADCCatalogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datacatalog/preview:ADCCatalog" }, { type: "azurerm:datacatalog/v20160330:ADCCatalog" }] };
