...
export class DeploymentAtManagementGroupScope extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.v20190510.DeploymentPropertiesExtendedResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: DeploymentAtManagementGroupScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/latest:DeploymentAtManagementGroupScope" }, { type: "azurerm:management/preview:DeploymentAtManagementGroupScope" }, { type: "azurerm:management/v20190501:DeploymentAtManagementGroupScope" }, { type: "azurerm:management/v20190701:DeploymentAtManagementGroupScope" }, { type: "azurerm:management/v20190801:DeploymentAtManagementGroupScope" }, { type: "azurerm:management/v20191001:DeploymentAtManagementGroupScope" }, { type: "azurerm:management/v20200601:DeploymentAtManagementGroupScope" }] };
...
export interface DeploymentAtManagementGroupScopeArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.management.v20190510.DeploymentProperties>;
}
