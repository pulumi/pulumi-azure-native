...
export class ManagementGroupSubscriptionSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/v20200501:ManagementGroupSubscriptionSubscription';
    ...
    constructor(name: string, argsOrState?: ManagementGroupSubscriptionSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/latest:ManagementGroupSubscriptionSubscription" }, { type: "azurerm:management/preview:ManagementGroupSubscriptionSubscription" }] };
