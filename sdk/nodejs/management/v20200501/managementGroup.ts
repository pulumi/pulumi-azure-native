 ...
 *
 * const managementGroup = new azure_native.management.v20200501.ManagementGroup("managementGroup", {
 *     details: {
 *         parent: {
...
export class ManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:management/v20200501:ManagementGroup';
     ...
     */
    public /*out*/ readonly children!: pulumi.Output<outputs.management.v20200501.ManagementGroupChildInfoResponse[] | undefined>;
    /**
     * The details of a management group.
     */
    public readonly details!: pulumi.Output<outputs.management.v20200501.ManagementGroupDetailsResponse | undefined>;
    /**
    ...
    constructor(name: string, args?: ManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:management:ManagementGroup" }, { type: "azure-native:management/v20171101preview:ManagementGroup" }, { type: "azure-native:management/v20180101preview:ManagementGroup" }, { type: "azure-native:management/v20180301preview:ManagementGroup" }, { type: "azure-native:management/v20191101:ManagementGroup" }, { type: "azure-native:management/v20200201:ManagementGroup" }, { type: "azure-native:management/v20201001:ManagementGroup" }, { type: "azure-native:management/v20210401:ManagementGroup" }] };
...
export interface ManagementGroupArgs {
     ...
     */
    details?: pulumi.Input<inputs.management.v20200501.CreateManagementGroupDetailsArgs>;
    /**
