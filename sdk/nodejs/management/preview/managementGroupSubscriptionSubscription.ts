...
export class ManagementGroupSubscriptionSubscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagementGroupSubscriptionSubscription {
        return new ManagementGroupSubscriptionSubscription(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/preview:ManagementGroupSubscriptionSubscription';
     ...
     */
    public /*out*/ readonly parent!: pulumi.Output<outputs.management.preview.DescendantParentGroupInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagementGroupSubscriptionSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ManagementGroupSubscriptionSubscriptionArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/latest:ManagementGroupSubscriptionSubscription" }, { type: "azurerm:management/v20200501:ManagementGroupSubscriptionSubscription" }] };
