...
export class ManagementGroupSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/preview:ManagementGroupSubscription';
    ...
    constructor(name: string, args: ManagementGroupSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/latest:ManagementGroupSubscription" }, { type: "azurerm:management/v20200501:ManagementGroupSubscription" }] };
