...
export class HierarchySetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/preview:HierarchySetting';
    ...
    constructor(name: string, args: HierarchySettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/latest:HierarchySetting" }, { type: "azurerm:management/v20200201:HierarchySetting" }, { type: "azurerm:management/v20200501:HierarchySetting" }] };
