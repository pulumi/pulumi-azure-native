...
export class ManagementGroupDiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/preview:ManagementGroupDiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<outputs.management.preview.ManagementGroupLogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, argsOrState?: ManagementGroupDiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/v20200101preview:ManagementGroupDiagnosticSetting" }] };
...
export interface ManagementGroupDiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    readonly logs?: pulumi.Input<pulumi.Input<inputs.management.preview.ManagementGroupLogSettings>[]>;
    /**
