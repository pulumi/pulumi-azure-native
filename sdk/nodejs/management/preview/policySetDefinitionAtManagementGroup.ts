...
export class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/preview:PolicySetDefinitionAtManagementGroup';
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.management.preview.ParameterDefinitionsValueResponse} | undefined>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    public readonly policyDefinitionGroups!: pulumi.Output<outputs.management.preview.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    public readonly policyDefinitions!: pulumi.Output<outputs.management.preview.PolicyDefinitionReferenceResponse[]>;
    /**
...
export interface PolicySetDefinitionAtManagementGroupArgs {
     ...
     * The policy set definition parameters that can be used in policy definition references.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.management.preview.ParameterDefinitionsValue>}>;
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups?: pulumi.Input<pulumi.Input<inputs.management.preview.PolicyDefinitionGroup>[]>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Input<pulumi.Input<inputs.management.preview.PolicyDefinitionReference>[]>;
    /**
