...
export class Blueprint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/preview:Blueprint';
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.management.preview.ParameterDefinitionResponse} | undefined>;
    /**
     * Resource group placeholders defined by this Blueprint definition.
     */
    public readonly resourceGroups!: pulumi.Output<{[key: string]: outputs.management.preview.ResourceGroupDefinitionResponse} | undefined>;
    /**
     * Status of the Blueprint. This field is readonly.
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.management.preview.BlueprintStatusResponse>;
    /**
    ...
    constructor(name: string, args: BlueprintArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/v20171111preview:Blueprint" }] };
...
export interface BlueprintArgs {
     ...
     * Parameters required by this Blueprint definition.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.management.preview.ParameterDefinition>}>;
    /**
     * Resource group placeholders defined by this Blueprint definition.
     */
    readonly resourceGroups?: pulumi.Input<{[key: string]: pulumi.Input<inputs.management.preview.ResourceGroupDefinition>}>;
    /**
     * The scope where this Blueprint can be applied.
     */
