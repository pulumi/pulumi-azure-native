...
export class PolicyDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:management/latest:PolicyDefinitionAtManagementGroup';
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.management.latest.ParameterDefinitionsValueResponse} | undefined>;
    /**
     * The policy rule.
     */
...
export interface PolicyDefinitionAtManagementGroupArgs {
     ...
     * The parameter definitions for parameters used in the policy rule. The keys are the parameter names.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.management.latest.ParameterDefinitionsValue>}>;
    /**
     ...
     * The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
     */
    readonly policyType?: pulumi.Input<string | enums.management.latest.PolicyType>;
}
