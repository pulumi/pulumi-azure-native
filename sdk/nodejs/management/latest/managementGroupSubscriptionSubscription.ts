...
export class ManagementGroupSubscriptionSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ManagementGroupSubscriptionSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/preview:ManagementGroupSubscriptionSubscription" }, { type: "azurerm:management/v20200501:ManagementGroupSubscriptionSubscription" }] };
