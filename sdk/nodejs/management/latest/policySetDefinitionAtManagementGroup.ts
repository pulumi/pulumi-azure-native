...
export class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/latest:PolicySetDefinitionAtManagementGroup';
     ...
     */
    public readonly policyDefinitionGroups!: pulumi.Output<outputs.management.latest.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    public readonly policyDefinitions!: pulumi.Output<outputs.management.latest.PolicyDefinitionReferenceResponse[]>;
    /**
...
export interface PolicySetDefinitionAtManagementGroupArgs {
     ...
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups?: pulumi.Input<pulumi.Input<inputs.management.latest.PolicyDefinitionGroup>[]>;
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: pulumi.Input<pulumi.Input<inputs.management.latest.PolicyDefinitionReference>[]>;
    /**
