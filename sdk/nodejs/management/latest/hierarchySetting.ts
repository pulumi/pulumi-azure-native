...
export class HierarchySetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/latest:HierarchySetting';
    ...
    constructor(name: string, argsOrState?: HierarchySettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/preview:HierarchySetting" }, { type: "azurerm:management/v20200201:HierarchySetting" }, { type: "azurerm:management/v20200501:HierarchySetting" }] };
