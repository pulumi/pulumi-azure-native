...
export function getHierarchySetting(args: GetHierarchySettingArgs, opts?: pulumi.InvokeOptions): Promise<GetHierarchySettingResult> {
    pulumi.log.warn("getHierarchySetting is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:management:getHierarchySetting'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:management/latest:getHierarchySetting", {
