...
export class ManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/latest:ManagementGroup';
    ...
    constructor(name: string, argsOrState?: ManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/v20191101:ManagementGroup" }, { type: "azurerm:management/v20200201:ManagementGroup" }, { type: "azurerm:management/v20200501:ManagementGroup" }] };
