...
export class PolicyDefinitionAtManagementGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.v20190901.PolicyDefinitionPropertiesResponse>;
    /**
...
export interface PolicyDefinitionAtManagementGroupArgs {
     ...
     * The policy definition properties.
     */
    readonly properties?: pulumi.Input<inputs.management.v20190901.PolicyDefinitionProperties>;
}
