...
export class DeploymentAtManagementGroupScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management:DeploymentAtManagementGroupScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.DeploymentPropertiesExtendedResponse>;
    /**
     * Deployment tags
     */
...
export interface DeploymentAtManagementGroupScopeArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.management.DeploymentProperties>;
    /**
     * Deployment tags
     */
