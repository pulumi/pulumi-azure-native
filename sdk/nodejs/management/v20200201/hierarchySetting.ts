...
export class HierarchySetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HierarchySettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/latest:HierarchySetting" }, { type: "azurerm:management/preview:HierarchySetting" }, { type: "azurerm:management/v20200501:HierarchySetting" }] };
