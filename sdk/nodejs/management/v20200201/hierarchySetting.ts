...
export class HierarchySetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:management/v20200201:HierarchySetting';
    ...
    constructor(name: string, args: HierarchySettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:management:HierarchySetting" }, { type: "azure-nextgen:management/latest:HierarchySetting" }, { type: "azure-nextgen:management/v20200501:HierarchySetting" }] };
