...
// Export enums:
export * from "../../types/enums/management/v20191001";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:management/v20191001:DeploymentAtManagementGroupScope":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "management/v20191001", _module)
