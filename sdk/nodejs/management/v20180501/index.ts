...
// Export enums:
export * from "../../types/enums/management/v20180501";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:management/v20180501:PolicyDefinitionAtManagementGroup":
                return new PolicyDefinitionAtManagementGroup(name, <any>undefined, { urn })
            case "azure-nextgen:management/v20180501:PolicySetDefinitionAtManagementGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "management/v20180501", _module)
