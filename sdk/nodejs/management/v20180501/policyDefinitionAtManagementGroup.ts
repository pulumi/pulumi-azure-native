...
export class PolicyDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/v20180501:PolicyDefinitionAtManagementGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.v20180501.PolicyDefinitionPropertiesResponse>;
    /**
...
export interface PolicyDefinitionAtManagementGroupArgs {
     ...
     * The policy definition properties.
     */
    readonly properties?: pulumi.Input<inputs.management.v20180501.PolicyDefinitionProperties>;
}
