...
export function getPolicySetDefinitionAtManagementGroup(args: GetPolicySetDefinitionAtManagementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionAtManagementGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:management/v20200901:getPolicySetDefinitionAtManagementGroup", {
...
export interface GetPolicySetDefinitionAtManagementGroupResult {
     ...
     */
    readonly parameters?: {[key: string]: outputs.management.v20200901.ParameterDefinitionsValueResponse};
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups?: outputs.management.v20200901.PolicyDefinitionGroupResponse[];
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: outputs.management.v20200901.PolicyDefinitionReferenceResponse[];
    /**
