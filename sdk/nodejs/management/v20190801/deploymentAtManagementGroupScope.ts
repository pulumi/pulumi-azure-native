...
export class DeploymentAtManagementGroupScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:management/v20190801:DeploymentAtManagementGroupScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.v20190801.DeploymentPropertiesExtendedResponse>;
    /**
...
export interface DeploymentAtManagementGroupScopeArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.management.v20190801.DeploymentProperties>;
}
