...
// Export enums:
export * from "../../types/enums/management/v20190801";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:management/v20190801:DeploymentAtManagementGroupScope":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "management/v20190801", _module)
