...
export class ManagementGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/latest:ManagementGroup" }, { type: "azurerm:management/v20200201:ManagementGroup" }, { type: "azurerm:management/v20200501:ManagementGroup" }] };
