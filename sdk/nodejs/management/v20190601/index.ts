...
// Export enums:
export * from "../../types/enums/management/v20190601";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:management/v20190601:PolicyDefinitionAtManagementGroup":
                return new PolicyDefinitionAtManagementGroup(name, <any>undefined, { urn })
            case "azure-nextgen:management/v20190601:PolicySetDefinitionAtManagementGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "management/v20190601", _module)
