...
export class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management:PolicySetDefinitionAtManagementGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.PolicySetDefinitionPropertiesResponse>;
    /**
...
export interface PolicySetDefinitionAtManagementGroupArgs {
     ...
     * The policy definition properties.
     */
    readonly properties?: pulumi.Input<inputs.management.PolicySetDefinitionProperties>;
}
