...
export class DeploymentAtManagementGroupScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:management/v20190501:DeploymentAtManagementGroupScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.v20190501.DeploymentPropertiesExtendedResponse>;
    /**
    ...
    constructor(name: string, args: DeploymentAtManagementGroupScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:management/latest:DeploymentAtManagementGroupScope" }, { type: "azure-nextgen:management/v20190510:DeploymentAtManagementGroupScope" }, { type: "azure-nextgen:management/v20190701:DeploymentAtManagementGroupScope" }, { type: "azure-nextgen:management/v20190801:DeploymentAtManagementGroupScope" }, { type: "azure-nextgen:management/v20191001:DeploymentAtManagementGroupScope" }, { type: "azure-nextgen:management/v20200601:DeploymentAtManagementGroupScope" }, { type: "azure-nextgen:management/v20201001:DeploymentAtManagementGroupScope" }] };
...
export interface DeploymentAtManagementGroupScopeArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.management.v20190501.DeploymentProperties>;
}
