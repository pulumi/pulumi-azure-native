...
export class DeploymentAtManagementGroupScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:management/v20201001:DeploymentAtManagementGroupScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.v20201001.DeploymentPropertiesExtendedResponse>;
    /**
     * Deployment tags
     */
...
export interface DeploymentAtManagementGroupScopeArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.management.v20201001.DeploymentProperties>;
    /**
     * Deployment tags
     */
