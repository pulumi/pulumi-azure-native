...
export class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
     ...
     */
    public readonly policyDefinitions!: pulumi.Output<outputs.management.v20190101.PolicyDefinitionReferenceResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: PolicySetDefinitionAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/v20180301:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20180501:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20190601:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20190901:PolicySetDefinitionAtManagementGroup" }] };
