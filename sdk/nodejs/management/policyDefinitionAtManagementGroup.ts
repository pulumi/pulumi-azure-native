...
export class PolicyDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management:PolicyDefinitionAtManagementGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.PolicyDefinitionPropertiesResponse>;
    /**
...
export interface PolicyDefinitionAtManagementGroupArgs {
     ...
     * The policy definition properties.
     */
    readonly properties?: pulumi.Input<inputs.management.PolicyDefinitionProperties>;
}
