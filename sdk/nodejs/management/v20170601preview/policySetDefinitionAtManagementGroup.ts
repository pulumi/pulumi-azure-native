...
export class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management/v20170601preview:PolicySetDefinitionAtManagementGroup';
    ...
    constructor(name: string, args: PolicySetDefinitionAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:management/latest:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/preview:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20180301:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20180501:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20190101:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20190601:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20190901:PolicySetDefinitionAtManagementGroup" }, { type: "azurerm:management/v20200301:PolicySetDefinitionAtManagementGroup" }] };
