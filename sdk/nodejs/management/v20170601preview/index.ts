...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:management/v20170601preview:PolicySetDefinitionAtManagementGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "management/v20170601preview", _module)
