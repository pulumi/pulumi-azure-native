...
export class HierarchySetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:management:HierarchySetting';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.management.HierarchySettingsPropertiesResponse>;
    /**
...
export interface HierarchySettingArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.management.CreateOrUpdateSettingsProperties>;
}
