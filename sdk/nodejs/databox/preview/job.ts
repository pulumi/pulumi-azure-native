...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databox/preview:Job';
     ...
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.databox.preview.JobDeliveryInfoResponse | undefined>;
    /**
     ...
     */
    public readonly details!: pulumi.Output<outputs.databox.preview.DataBoxDiskJobDetailsResponse | outputs.databox.preview.DataBoxHeavyJobDetailsResponse | outputs.databox.preview.DataBoxJobDetailsResponse | undefined>;
    /**
     * Top level error for the job.
     */
    public /*out*/ readonly error!: pulumi.Output<outputs.databox.preview.CloudErrorResponse>;
    /**
     * Msi identity of the resource
     */
    public readonly identity!: pulumi.Output<outputs.databox.preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     * The sku type.
     */
    public readonly sku!: pulumi.Output<outputs.databox.preview.SkuResponse>;
    /**
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databox/latest:Job" }, { type: "azurerm:databox/v20180101:Job" }, { type: "azurerm:databox/v20190901:Job" }, { type: "azurerm:databox/v20200401:Job" }] };
...
export interface JobArgs {
     ...
     * Delivery Info of Job.
     */
    readonly deliveryInfo?: pulumi.Input<inputs.databox.preview.JobDeliveryInfo>;
    /**
     * Delivery type of Job.
     */
     ...
     * Details of a job run. This field will only be sent for expand details filter.
     */
    readonly details?: pulumi.Input<inputs.databox.preview.DataBoxDiskJobDetails | inputs.databox.preview.DataBoxHeavyJobDetails | inputs.databox.preview.DataBoxJobDetails>;
    /**
     * Msi identity of the resource
     */
    readonly identity?: pulumi.Input<inputs.databox.preview.ResourceIdentity>;
    /**
     ...
     * The sku type.
     */
    readonly sku: pulumi.Input<inputs.databox.preview.Sku>;
    /**
     * The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups).
     */
