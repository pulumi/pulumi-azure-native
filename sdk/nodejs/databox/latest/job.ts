...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databox/latest:Job';
     ...
     */
    public readonly details!: pulumi.Output<outputs.databox.latest.JobDetailsResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databox/preview:Job" }, { type: "azurerm:databox/v20180101:Job" }, { type: "azurerm:databox/v20190901:Job" }, { type: "azurerm:databox/v20200401:Job" }] };
...
export interface JobArgs {
     ...
     * Details of a job run. This field will only be sent for expand details filter.
     */
    readonly details?: pulumi.Input<inputs.databox.latest.JobDetails>;
    /**
     * Msi identity of the resource
     */
