 ...
 *
 * const job = new azurerm.databox.v20190901.Job("job", {
 *     details: {
 *         contactDetails: {
...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databox/v20190901:Job';
    ...
    constructor(name: string, argsOrState?: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databox/latest:Job" }, { type: "azurerm:databox/v20180101:Job" }, { type: "azurerm:databox/v20200401:Job" }] };
