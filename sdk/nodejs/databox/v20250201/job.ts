...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databox/v20250201:Job';
     ...
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.databox.v20250201.JobDeliveryInfoResponse | undefined>;
    /**
     ...
     */
    public readonly details!: pulumi.Output<outputs.databox.v20250201.DataBoxCustomerDiskJobDetailsResponse | outputs.databox.v20250201.DataBoxDiskJobDetailsResponse | outputs.databox.v20250201.DataBoxHeavyJobDetailsResponse | outputs.databox.v20250201.DataBoxJobDetailsResponse | undefined>;
    /**
     * Top level error for the job.
     */
    public /*out*/ readonly error!: pulumi.Output<outputs.databox.v20250201.CloudErrorResponse>;
    /**
     * Msi identity of the resource
     */
    public readonly identity!: pulumi.Output<outputs.databox.v20250201.ResourceIdentityResponse | undefined>;
    /**
     ...
     * The sku type.
     */
    public readonly sku!: pulumi.Output<outputs.databox.v20250201.SkuResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.databox.v20250201.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["identity"] = args ? (args.identity ? pulumi.output(args.identity).apply(inputs.databox.v20250201.resourceIdentityArgsProvideDefaults) : undefined) : undefined;
...
export interface JobArgs {
     ...
     * Delivery Info of Job.
     */
    deliveryInfo?: pulumi.Input<inputs.databox.v20250201.JobDeliveryInfoArgs>;
    /**
     * Delivery type of Job.
     */
    deliveryType?: pulumi.Input<string | enums.databox.v20250201.JobDeliveryType>;
    /**
     * Details of a job run. This field will only be sent for expand details filter.
     */
    details?: pulumi.Input<inputs.databox.v20250201.DataBoxCustomerDiskJobDetailsArgs | inputs.databox.v20250201.DataBoxDiskJobDetailsArgs | inputs.databox.v20250201.DataBoxHeavyJobDetailsArgs | inputs.databox.v20250201.DataBoxJobDetailsArgs>;
    /**
     * Msi identity of the resource
     */
    identity?: pulumi.Input<inputs.databox.v20250201.ResourceIdentityArgs>;
    /**
     ...
     * The sku type.
     */
    sku: pulumi.Input<inputs.databox.v20250201.SkuArgs>;
    /**
     * The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups).
     */
     ...
     * Type of the data transfer.
     */
    transferType: pulumi.Input<string | enums.databox.v20250201.TransferType>;
}
