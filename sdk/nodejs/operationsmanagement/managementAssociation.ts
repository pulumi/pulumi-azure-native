...
export class ManagementAssociation extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.operationsmanagement.ManagementAssociationPropertiesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: ManagementAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.managementAssociationName === undefined && !opts.urn) {
