...
export class ManagementConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:operationsmanagement:ManagementConfiguration';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.operationsmanagement.ManagementConfigurationPropertiesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: ManagementConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            if ((!args || args.managementConfigurationName === undefined) && !(opts && opts.urn)) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationsmanagement/v20151101preview:ManagementConfiguration" }] };
...
export interface ManagementConfigurationArgs {
     ...
     * Properties for ManagementConfiguration object supported by the OperationsManagement resource provider.
     */
    readonly properties?: pulumi.Input<inputs.operationsmanagement.ManagementConfigurationProperties>;
    /**
