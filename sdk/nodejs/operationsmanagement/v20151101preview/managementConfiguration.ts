...
export class ManagementConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagementConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:operationsmanagement/v20151101preview:ManagementConfiguration" }, { type: "azure-native:operationsmanagement:ManagementConfiguration" }, { type: "azure-nextgen:operationsmanagement:ManagementConfiguration" }] };
...
export interface ManagementConfigurationArgs {
     ...
     * Properties for ManagementConfiguration object supported by the OperationsManagement resource provider.
     */
    properties?: pulumi.Input<inputs.operationsmanagement.v20151101preview.ManagementConfigurationPropertiesArgs>;
    /**
