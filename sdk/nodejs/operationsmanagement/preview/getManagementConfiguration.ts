...
export function getManagementConfiguration(args: GetManagementConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azurerm:operationsmanagement/preview:getManagementConfiguration", {
...
export interface GetManagementConfigurationResult {
     ...
     */
    readonly properties: outputs.operationsmanagement.preview.ManagementConfigurationPropertiesResponse;
    /**
     * Resource type.
     */
