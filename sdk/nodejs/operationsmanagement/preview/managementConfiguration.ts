...
export class ManagementConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:operationsmanagement/preview:ManagementConfiguration';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.operationsmanagement.preview.ManagementConfigurationPropertiesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: ManagementConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:operationsmanagement/v20151101preview:ManagementConfiguration" }] };
...
export interface ManagementConfigurationArgs {
     ...
     * Properties for ManagementConfiguration object supported by the OperationsManagement resource provider.
     */
    readonly properties?: pulumi.Input<inputs.operationsmanagement.preview.ManagementConfigurationProperties>;
    /**
