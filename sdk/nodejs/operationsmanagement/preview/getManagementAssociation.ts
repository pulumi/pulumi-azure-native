...
export function getManagementAssociation(args: GetManagementAssociationArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementAssociationResult> {
    ...
    return pulumi.runtime.invoke("azurerm:operationsmanagement/preview:getManagementAssociation", {
...
export interface GetManagementAssociationResult {
     ...
     */
    readonly properties: outputs.operationsmanagement.preview.ManagementAssociationPropertiesResponse;
    /**
     * Resource type.
     */
