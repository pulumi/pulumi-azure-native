...
export function getIncidentTask(args: GetIncidentTaskArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentTaskResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230901preview:getIncidentTask", {
...
export interface GetIncidentTaskResult {
     ...
     */
    readonly createdBy?: outputs.securityinsights.v20230901preview.ClientInfoResponse;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    readonly lastModifiedBy?: outputs.securityinsights.v20230901preview.ClientInfoResponse;
    /**
...
export function getIncidentTaskOutput(args: GetIncidentTaskOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncidentTaskResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230901preview:getIncidentTask", {
        "incidentId": args.incidentId,
        "incidentTaskId": args.incidentTaskId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
