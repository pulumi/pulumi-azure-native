...
export interface GetGCPDataConnectorResult {
     ...
     */
    readonly auth: outputs.securityinsights.v20230901preview.GCPAuthPropertiesResponse;
    /**
     ...
     */
    readonly dcrConfig?: outputs.securityinsights.v20230901preview.DCRConfigurationResponse;
    /**
     ...
     */
    readonly request: outputs.securityinsights.v20230901preview.GCPRequestPropertiesResponse;
    /**
...
export function getGCPDataConnectorOutput(args: GetGCPDataConnectorOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGCPDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230901preview:getGCPDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
