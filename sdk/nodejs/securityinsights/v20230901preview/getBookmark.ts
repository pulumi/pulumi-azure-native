...
export interface GetBookmarkResult {
     ...
     */
    readonly createdBy?: outputs.securityinsights.v20230901preview.UserInfoResponse;
    /**
     ...
     */
    readonly entityMappings?: outputs.securityinsights.v20230901preview.BookmarkEntityMappingsResponse[];
    /**
     ...
     */
    readonly incidentInfo?: outputs.securityinsights.v20230901preview.IncidentInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: outputs.securityinsights.v20230901preview.UserInfoResponse;
}
/**
 * Gets a bookmark.
 */
export function getBookmarkOutput(args: GetBookmarkOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBookmarkResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230901preview:getBookmark", {
        "bookmarkId": args.bookmarkId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
