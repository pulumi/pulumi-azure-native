...
export class AutomationRule extends pulumi.CustomResource {
     ...
     */
    public readonly actions!: pulumi.Output<(outputs.securityinsights.v20230901preview.AutomationRuleAddIncidentTaskActionResponse | outputs.securityinsights.v20230901preview.AutomationRuleModifyPropertiesActionResponse | outputs.securityinsights.v20230901preview.AutomationRuleRunPlaybookActionResponse)[]>;
    /**
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly createdBy!: pulumi.Output<outputs.securityinsights.v20230901preview.ClientInfoResponse>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20230901preview.ClientInfoResponse>;
    /**
     ...
     */
    public readonly triggeringLogic!: pulumi.Output<outputs.securityinsights.v20230901preview.AutomationRuleTriggeringLogicResponse>;
    /**
...
export interface AutomationRuleArgs {
     ...
     * The actions to execute when the automation rule is triggered.
     */
    actions: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230901preview.AutomationRuleAddIncidentTaskActionArgs | inputs.securityinsights.v20230901preview.AutomationRuleModifyPropertiesActionArgs | inputs.securityinsights.v20230901preview.AutomationRuleRunPlaybookActionArgs>[]>;
    /**
     * Automation rule ID
     */
     ...
     * Describes automation rule triggering logic.
     */
    triggeringLogic: pulumi.Input<inputs.securityinsights.v20230901preview.AutomationRuleTriggeringLogicArgs>;
    /**
