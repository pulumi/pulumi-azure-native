...
export class WorkspaceManagerAssignment extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.securityinsights.v20230601preview.AssignmentItemResponse[]>;
    /**
    ...
    constructor(name: string, args: WorkspaceManagerAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230401preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230501preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230701preview:WorkspaceManagerAssignment" }] };
