...
export interface GetCodelessApiPollingDataConnectorResult {
     ...
     */
    readonly connectorUiConfig?: outputs.securityinsights.v20230601preview.CodelessUiConnectorConfigPropertiesResponse;
    /**
     ...
     */
    readonly pollingConfig?: outputs.securityinsights.v20230601preview.CodelessConnectorPollingConfigPropertiesResponse;
    /**
...
export function getCodelessApiPollingDataConnectorOutput(args: GetCodelessApiPollingDataConnectorOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCodelessApiPollingDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230601preview:getCodelessApiPollingDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
