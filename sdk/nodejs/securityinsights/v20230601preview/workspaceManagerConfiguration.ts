...
export class WorkspaceManagerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230601preview:WorkspaceManagerConfiguration';
    ...
    constructor(name: string, args: WorkspaceManagerConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:WorkspaceManagerConfiguration" }, { type: "azure-native:securityinsights/v20230401preview:WorkspaceManagerConfiguration" }, { type: "azure-native:securityinsights/v20230501preview:WorkspaceManagerConfiguration" }] };
...
export interface WorkspaceManagerConfigurationArgs {
     ...
     * The current mode of the workspace manager configuration
     */
    mode: pulumi.Input<string | enums.securityinsights.v20230601preview.Mode>;
    /**
