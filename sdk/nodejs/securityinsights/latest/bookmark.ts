...
export class Bookmark extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/latest:Bookmark';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.latest.UserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<outputs.securityinsights.latest.UserInfoResponse | undefined>;
    ...
    constructor(name: string, args: BookmarkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/latest:Bookmark" }, { type: "azure-native:securityinsights:Bookmark" }, { type: "azure-nextgen:securityinsights:Bookmark" }, { type: "azure-native:securityinsights/v20200101:Bookmark" }, { type: "azure-nextgen:securityinsights/v20200101:Bookmark" }] };
...
export interface BookmarkArgs {
     ...
     * Describes a user that created the bookmark
     */
    readonly createdBy?: pulumi.Input<inputs.securityinsights.latest.UserInfo>;
    /**
     * The display name of the bookmark
     */
     ...
     * Describes a user that updated the bookmark
     */
    readonly updatedBy?: pulumi.Input<inputs.securityinsights.latest.UserInfo>;
    /**
