...
export class Incident extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<outputs.securityinsights.latest.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<outputs.securityinsights.latest.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<outputs.securityinsights.latest.IncidentOwnerInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: IncidentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/latest:Incident" }, { type: "azure-native:securityinsights:Incident" }, { type: "azure-nextgen:securityinsights:Incident" }, { type: "azure-native:securityinsights/v20200101:Incident" }, { type: "azure-nextgen:securityinsights/v20200101:Incident" }] };
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    readonly classification?: pulumi.Input<string | enums.securityinsights.latest.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    readonly classificationReason?: pulumi.Input<string | enums.securityinsights.latest.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    readonly labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.latest.IncidentLabel>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    readonly owner?: pulumi.Input<inputs.securityinsights.latest.IncidentOwnerInfo>;
    /**
     ...
     * The severity of the incident
     */
    readonly severity: pulumi.Input<string | enums.securityinsights.latest.IncidentSeverity>;
    /**
     * The status of the incident
     */
    readonly status: pulumi.Input<string | enums.securityinsights.latest.IncidentStatus>;
    /**
     * The title of the incident
     */
