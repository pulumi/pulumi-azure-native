...
export class DataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/latest:DataConnector';
    ...
    constructor(name: string, args: DataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/latest:DataConnector" }, { type: "azure-native:securityinsights:DataConnector" }, { type: "azure-nextgen:securityinsights:DataConnector" }, { type: "azure-native:securityinsights/v20200101:DataConnector" }, { type: "azure-nextgen:securityinsights/v20200101:DataConnector" }] };
...
export interface DataConnectorArgs {
     ...
     * The data connector kind
     */
    readonly kind: pulumi.Input<string | enums.securityinsights.latest.DataConnectorKind>;
    /**
