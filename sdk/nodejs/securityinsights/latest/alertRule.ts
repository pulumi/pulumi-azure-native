...
export class AlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/latest:AlertRule';
    ...
    constructor(name: string, args: AlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/latest:AlertRule" }, { type: "azure-native:securityinsights:AlertRule" }, { type: "azure-nextgen:securityinsights:AlertRule" }, { type: "azure-native:securityinsights/v20200101:AlertRule" }, { type: "azure-nextgen:securityinsights/v20200101:AlertRule" }] };
...
export interface AlertRuleArgs {
     ...
     * The alert rule kind
     */
    readonly kind: pulumi.Input<string | enums.securityinsights.latest.AlertRuleKind>;
    /**
