...
export function getMSTIDataConnector(args: GetMSTIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMSTIDataConnectorResult> {
    pulumi.log.warn("getMSTIDataConnector is deprecated: azure-native:securityinsights/v20220501preview:MSTIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MSTIDataConnector to guarantee forwards compatibility.")
...
export interface GetMSTIDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20220501preview.MSTIDataConnectorDataTypesResponse;
    /**
