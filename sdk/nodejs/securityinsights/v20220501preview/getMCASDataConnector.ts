...
export function getMCASDataConnector(args: GetMCASDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMCASDataConnectorResult> {
    pulumi.log.warn("getMCASDataConnector is deprecated: azure-native:securityinsights/v20220501preview:MCASDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:MCASDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20220501preview:getMCASDataConnector", {
...
export interface GetMCASDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20220501preview.MCASDataConnectorDataTypesResponse;
    /**
