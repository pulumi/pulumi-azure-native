 ...
 *
 * @deprecated azure-native:securityinsights/v20220501preview:ScheduledAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ScheduledAlertRule to guarantee forwards compatibility.
 */
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220501preview:ScheduledAlertRule';
     ...
     */
    public readonly eventGroupingSettings!: pulumi.Output<outputs.securityinsights.v20220501preview.EventGroupingSettingsResponse | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20220501preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20220501preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
