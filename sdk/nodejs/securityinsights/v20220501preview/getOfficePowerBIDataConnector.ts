...
export interface GetOfficePowerBIDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20220501preview.OfficePowerBIConnectorDataTypesResponse;
    /**
...
export function getOfficePowerBIDataConnectorOutput(args: GetOfficePowerBIDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOfficePowerBIDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20220501preview:getOfficePowerBIDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
