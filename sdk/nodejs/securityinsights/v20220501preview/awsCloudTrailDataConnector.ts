 ...
 *
 * const awsCloudTrailDataConnector = new azure_native.securityinsights.v20220501preview.AwsCloudTrailDataConnector("awsCloudTrailDataConnector", {
...
export class AwsCloudTrailDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220501preview:AwsCloudTrailDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20220501preview.AwsCloudTrailDataConnectorDataTypesResponse>;
    /**
...
export interface AwsCloudTrailDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20220501preview.AwsCloudTrailDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'AmazonWebServicesCloudTrail'.
     */
