 ...
 *
 * @deprecated azure-native:securityinsights/v20220501preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:TiTaxiiDataConnector to guarantee forwards compatibility.
 */
export class TiTaxiiDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220501preview:TiTaxiiDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20220501preview.TiTaxiiDataConnectorDataTypesResponse>;
    /**
...
export interface TiTaxiiDataConnectorArgs {
     ...
     * The available data types for Threat Intelligence TAXII data connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20220501preview.TiTaxiiDataConnectorDataTypesArgs>;
    /**
     * The friendly name for the TAXII server.
     */
     ...
     * The polling frequency for the TAXII server.
     */
    pollingFrequency: pulumi.Input<string | enums.securityinsights.v20220501preview.PollingFrequency>;
    /**
