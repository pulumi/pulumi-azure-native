 ...
 *
 * @deprecated azure-native:securityinsights/v20220501preview:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ASCDataConnector to guarantee forwards compatibility.
 */
export class ASCDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ASCDataConnector {
        pulumi.log.warn("ASCDataConnector is deprecated: azure-native:securityinsights/v20220501preview:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ASCDataConnector to guarantee forwards compatibility.")
        return new ASCDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220501preview:ASCDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20220501preview.AlertsDataTypeOfDataConnectorResponse | undefined>;
    /**
...
export interface ASCDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes?: pulumi.Input<inputs.securityinsights.v20220501preview.AlertsDataTypeOfDataConnectorArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'AzureSecurityCenter'.
     */
