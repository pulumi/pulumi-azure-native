 ...
 */
/** @deprecated azure-native:securityinsights/v20220501preview:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector to guarantee forwards compatibility. */
export function getAwsCloudTrailDataConnector(args: GetAwsCloudTrailDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetAwsCloudTrailDataConnectorResult> {
    pulumi.log.warn("getAwsCloudTrailDataConnector is deprecated: azure-native:securityinsights/v20220501preview:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20220501preview:getAwsCloudTrailDataConnector", {
...
export interface GetAwsCloudTrailDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20220501preview.AwsCloudTrailDataConnectorDataTypesResponse;
    /**
