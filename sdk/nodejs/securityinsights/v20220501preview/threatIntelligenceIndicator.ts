 ...
 *
 * @deprecated azure-native:securityinsights/v20220501preview:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.
 */
...
export interface ThreatIntelligenceIndicatorArgs {
     ...
     * External References
     */
    externalReferences?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.ThreatIntelligenceExternalReferenceArgs>[]>;
    /**
     * Granular Markings
     */
    granularMarkings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.ThreatIntelligenceGranularMarkingModelArgs>[]>;
    /**
     ...
     * Kill chain phases
     */
    killChainPhases?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.ThreatIntelligenceKillChainPhaseArgs>[]>;
    /**
     ...
     * Parsed patterns
     */
    parsedPattern?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220501preview.ThreatIntelligenceParsedPatternArgs>[]>;
    /**
