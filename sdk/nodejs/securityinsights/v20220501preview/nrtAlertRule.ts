...
export class NrtAlertRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NrtAlertRule {
        pulumi.log.warn("NrtAlertRule is deprecated: azure-native:securityinsights/v20220501preview:NrtAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:NrtAlertRule to guarantee forwards compatibility.")
