 ...
 *
 * @deprecated azure-native:securityinsights/v20230401preview:SentinelOnboardingState is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:SentinelOnboardingState to guarantee forwards compatibility.
 */
export class SentinelOnboardingState extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SentinelOnboardingState {
        pulumi.log.warn("SentinelOnboardingState is deprecated: azure-native:securityinsights/v20230401preview:SentinelOnboardingState is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:SentinelOnboardingState to guarantee forwards compatibility.")
        return new SentinelOnboardingState(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230401preview:SentinelOnboardingState';
