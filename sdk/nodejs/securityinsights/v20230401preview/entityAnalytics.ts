...
export class EntityAnalytics extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230401preview:EntityAnalytics';
...
export interface EntityAnalyticsArgs {
     ...
     * The relevant entity providers that are synced
     */
    entityProviders?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20230401preview.EntityProviders>[]>;
    /**
     * The kind of the setting
     * Expected value is 'EntityAnalytics'.
     */
