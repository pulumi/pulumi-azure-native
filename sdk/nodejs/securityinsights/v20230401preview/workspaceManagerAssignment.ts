...
export class WorkspaceManagerAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230401preview:WorkspaceManagerAssignment';
     ...
     */
    public readonly items!: pulumi.Output<outputs.securityinsights.v20230401preview.AssignmentItemResponse[]>;
    /**
...
export interface WorkspaceManagerAssignmentArgs {
     ...
     * List of resources included in this workspace manager assignment
     */
    items: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230401preview.AssignmentItemArgs>[]>;
    /**
