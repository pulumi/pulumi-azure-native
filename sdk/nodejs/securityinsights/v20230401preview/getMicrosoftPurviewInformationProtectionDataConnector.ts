...
export interface GetMicrosoftPurviewInformationProtectionDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20230401preview.MicrosoftPurviewInformationProtectionConnectorDataTypesResponse;
    /**
...
export function getMicrosoftPurviewInformationProtectionDataConnectorOutput(args: GetMicrosoftPurviewInformationProtectionDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMicrosoftPurviewInformationProtectionDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230401preview:getMicrosoftPurviewInformationProtectionDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
