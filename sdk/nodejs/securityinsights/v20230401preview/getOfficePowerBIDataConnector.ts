...
export function getOfficePowerBIDataConnector(args: GetOfficePowerBIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOfficePowerBIDataConnectorResult> {
    pulumi.log.warn("getOfficePowerBIDataConnector is deprecated: azure-native:securityinsights/v20230401preview:OfficePowerBIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:OfficePowerBIDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230401preview:getOfficePowerBIDataConnector", {
...
export interface GetOfficePowerBIDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20230401preview.OfficePowerBIConnectorDataTypesResponse;
    /**
