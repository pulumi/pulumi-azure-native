...
export function getMTPDataConnector(args: GetMTPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMTPDataConnectorResult> {
    pulumi.log.warn("getMTPDataConnector is deprecated: azure-native:securityinsights/v20230401preview:MTPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MTPDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230401preview:getMTPDataConnector", {
...
export interface GetMTPDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20230401preview.MTPDataConnectorDataTypesResponse;
    /**
     ...
     */
    readonly filteredProviders?: outputs.securityinsights.v20230401preview.MtpFilteredProvidersResponse;
    /**
