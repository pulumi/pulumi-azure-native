...
export class AutomationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230401preview:AutomationRule';
     ...
     */
    public readonly actions!: pulumi.Output<(outputs.securityinsights.v20230401preview.AutomationRuleAddIncidentTaskActionResponse | outputs.securityinsights.v20230401preview.AutomationRuleModifyPropertiesActionResponse | outputs.securityinsights.v20230401preview.AutomationRuleRunPlaybookActionResponse)[]>;
    /**
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly createdBy!: pulumi.Output<outputs.securityinsights.v20230401preview.ClientInfoResponse>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20230401preview.ClientInfoResponse>;
    /**
     ...
     */
    public readonly triggeringLogic!: pulumi.Output<outputs.securityinsights.v20230401preview.AutomationRuleTriggeringLogicResponse>;
    /**
...
export interface AutomationRuleArgs {
     ...
     * The actions to execute when the automation rule is triggered.
     */
    actions: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230401preview.AutomationRuleAddIncidentTaskActionArgs | inputs.securityinsights.v20230401preview.AutomationRuleModifyPropertiesActionArgs | inputs.securityinsights.v20230401preview.AutomationRuleRunPlaybookActionArgs>[]>;
    /**
     * Automation rule ID
     */
     ...
     * Describes automation rule triggering logic.
     */
    triggeringLogic: pulumi.Input<inputs.securityinsights.v20230401preview.AutomationRuleTriggeringLogicArgs>;
    /**
