...
export function getOffice365ProjectDataConnector(args: GetOffice365ProjectDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOffice365ProjectDataConnectorResult> {
    pulumi.log.warn("getOffice365ProjectDataConnector is deprecated: azure-native:securityinsights/v20230401preview:Office365ProjectDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Office365ProjectDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230401preview:getOffice365ProjectDataConnector", {
...
export interface GetOffice365ProjectDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20230401preview.Office365ProjectConnectorDataTypesResponse;
    /**
