...
export class MCASDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230401preview:MCASDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20230401preview.MCASDataConnectorDataTypesResponse>;
    /**
...
export interface MCASDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230401preview.MCASDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftCloudAppSecurity'.
     */
