...
export class AwsS3DataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230401preview:AwsS3DataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20230401preview.AwsS3DataConnectorDataTypesResponse>;
    /**
...
export interface AwsS3DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230401preview.AwsS3DataConnectorDataTypesArgs>;
    /**
     * The logs destination table name in LogAnalytics.
     */
