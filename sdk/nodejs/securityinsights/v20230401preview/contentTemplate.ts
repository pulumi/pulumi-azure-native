...
export class ContentTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230401preview:ContentTemplate';
     ...
     */
    public readonly source!: pulumi.Output<outputs.securityinsights.v20230401preview.MetadataSourceResponse>;
    /**
...
export interface ContentTemplateArgs {
     ...
     * The kind of content the template is for.
     */
    contentKind: pulumi.Input<string | enums.securityinsights.v20230401preview.Kind>;
    /**
     * Schema version of the content. Can be used to distinguish between different flow based on the schema version
     */
     ...
     * the packageKind of the package contains this template
     */
    packageKind?: pulumi.Input<string | enums.securityinsights.v20230401preview.PackageKind>;
    /**
     * the name of the package contains this template
     */
