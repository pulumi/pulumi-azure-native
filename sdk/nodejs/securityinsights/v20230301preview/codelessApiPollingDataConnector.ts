 ...
 *
 * const codelessApiPollingDataConnector = new azure_native.securityinsights.v20230301preview.CodelessApiPollingDataConnector("codelessApiPollingDataConnector", {
 *     connectorUiConfig: {
 *         availability: {
 *             isPreview: true,
 *             status: 1,
