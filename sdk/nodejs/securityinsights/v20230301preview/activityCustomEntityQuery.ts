 ...
 *
 * const activityCustomEntityQuery = new azure_native.securityinsights.v20230301preview.ActivityCustomEntityQuery("activityCustomEntityQuery", {
...
export class ActivityCustomEntityQuery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230301preview:ActivityCustomEntityQuery';
     ...
     */
    public readonly queryDefinitions!: pulumi.Output<outputs.securityinsights.v20230301preview.ActivityEntityQueriesPropertiesResponseQueryDefinitions | undefined>;
    /**
...
export interface ActivityCustomEntityQueryArgs {
     ...
     * The type of the query's source entity
     */
    inputEntityType?: pulumi.Input<string | enums.securityinsights.v20230301preview.EntityType>;
    /**
     ...
     * The Activity query definitions
     */
    queryDefinitions?: pulumi.Input<inputs.securityinsights.v20230301preview.ActivityEntityQueriesPropertiesQueryDefinitionsArgs>;
    /**
     * List of the fields of the source entity that are required to run the query
     */
