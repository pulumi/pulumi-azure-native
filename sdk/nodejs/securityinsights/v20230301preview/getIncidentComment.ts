...
export function getIncidentComment(args: GetIncidentCommentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentCommentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230301preview:getIncidentComment", {
...
export interface GetIncidentCommentResult {
     ...
     */
    readonly author: outputs.securityinsights.v20230301preview.ClientInfoResponse;
    /**
...
export function getIncidentCommentOutput(args: GetIncidentCommentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncidentCommentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230301preview:getIncidentComment", {
        "incidentCommentId": args.incidentCommentId,
        "incidentId": args.incidentId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
