 ...
 *
 * const awsS3DataConnector = new azure_native.securityinsights.v20230301preview.AwsS3DataConnector("awsS3DataConnector", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:securityinsights/v20230301preview:AwsS3DataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
 * ```
 */
export class AwsS3DataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230301preview:AwsS3DataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20230301preview.AwsS3DataConnectorDataTypesResponse>;
    /**
...
export interface AwsS3DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230301preview.AwsS3DataConnectorDataTypesArgs>;
    /**
     * The logs destination table name in LogAnalytics.
     */
