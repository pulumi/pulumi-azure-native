...
export class AwsCloudTrailDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AwsCloudTrailDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights:AwsCloudTrailDataConnector" }, { type: "azure-native:securityinsights/v20200101:AwsCloudTrailDataConnector" }, { type: "azure-nextgen:securityinsights/v20200101:AwsCloudTrailDataConnector" }] };
...
export interface AwsCloudTrailDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes?: pulumi.Input<inputs.securityinsights.AwsCloudTrailDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
