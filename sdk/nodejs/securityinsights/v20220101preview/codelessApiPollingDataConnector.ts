 ...
 *
 * const codelessApiPollingDataConnector = new azure_native.securityinsights.v20220101preview.CodelessApiPollingDataConnector("codelessApiPollingDataConnector", {
 *     connectorUiConfig: {
 *         availability: {
 *             isPreview: true,
 *             status: 1,
...
export class CodelessApiPollingDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220101preview:CodelessApiPollingDataConnector';
     ...
     */
    public readonly pollingConfig!: pulumi.Output<outputs.securityinsights.v20220101preview.CodelessConnectorPollingConfigPropertiesResponse | undefined>;
    /**
