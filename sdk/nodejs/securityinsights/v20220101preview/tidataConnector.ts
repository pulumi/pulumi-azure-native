 ...
 *
 * @deprecated azure-native:securityinsights/v20220101preview:TIDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:TIDataConnector to guarantee forwards compatibility.
 */
export class TIDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TIDataConnector {
        pulumi.log.warn("TIDataConnector is deprecated: azure-native:securityinsights/v20220101preview:TIDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:TIDataConnector to guarantee forwards compatibility.")
