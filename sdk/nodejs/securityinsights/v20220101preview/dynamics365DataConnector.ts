...
export class Dynamics365DataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Dynamics365DataConnector {
        pulumi.log.warn("Dynamics365DataConnector is deprecated: azure-native:securityinsights/v20220101preview:Dynamics365DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Dynamics365DataConnector to guarantee forwards compatibility.")
