...
export function getWatchlist(args: GetWatchlistArgs, opts?: pulumi.InvokeOptions): Promise<GetWatchlistResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20250301:getWatchlist", {
...
export interface GetWatchlistResult {
     ...
     */
    readonly createdBy?: outputs.securityinsights.v20250301.WatchlistUserInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: outputs.securityinsights.v20250301.WatchlistUserInfoResponse;
    /**
...
export function getWatchlistOutput(args: GetWatchlistOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWatchlistResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20250301:getWatchlist", {
        "resourceGroupName": args.resourceGroupName,
        "watchlistAlias": args.watchlistAlias,
        "workspaceName": args.workspaceName,
    }, opts);
