...
export function getScheduledAlertRule(args: GetScheduledAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledAlertRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20250301:getScheduledAlertRule", {
...
export interface GetScheduledAlertRuleResult {
     ...
     */
    readonly alertDetailsOverride?: outputs.securityinsights.v20250301.AlertDetailsOverrideResponse;
    /**
     ...
     */
    readonly entityMappings?: outputs.securityinsights.v20250301.EntityMappingResponse[];
    /**
     ...
     */
    readonly eventGroupingSettings?: outputs.securityinsights.v20250301.EventGroupingSettingsResponse;
    /**
     ...
     */
    readonly incidentConfiguration?: outputs.securityinsights.v20250301.IncidentConfigurationResponse;
    /**
...
export function getScheduledAlertRuleOutput(args: GetScheduledAlertRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledAlertRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20250301:getScheduledAlertRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleId": args.ruleId,
        "workspaceName": args.workspaceName,
    }, opts);
