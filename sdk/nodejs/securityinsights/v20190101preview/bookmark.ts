...
export class Bookmark extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/v20190101preview:Bookmark';
    ...
    constructor(name: string, argsOrState?: BookmarkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/preview:Bookmark" }] };
