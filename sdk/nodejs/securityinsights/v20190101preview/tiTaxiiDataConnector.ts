...
export interface TiTaxiiDataConnectorArgs {
     ...
     * The available data types for Threat Intelligence TAXII data connector.
     */
    readonly dataTypes: pulumi.Input<inputs.securityinsights.v20190101preview.TiTaxiiDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
     ...
     * The polling frequency for the TAXII server.
     */
    readonly pollingFrequency: pulumi.Input<string | enums.securityinsights.v20190101preview.PollingFrequency>;
    /**
