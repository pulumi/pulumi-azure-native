...
export class MSTIDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MSTIDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20190101preview:MSTIDataConnector" }, { type: "azure-native:securityinsights/v20210301preview:MSTIDataConnector" }, { type: "azure-nextgen:securityinsights/v20210301preview:MSTIDataConnector" }] };
...
export interface MSTIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes: pulumi.Input<inputs.securityinsights.v20190101preview.MSTIDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
     ...
     * Expected value is 'MicrosoftThreatIntelligence'.
     */
    readonly kind: pulumi.Input<"MicrosoftThreatIntelligence">;
    /**
