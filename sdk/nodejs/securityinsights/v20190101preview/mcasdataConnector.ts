 ...
 *
 * @deprecated azure-native:securityinsights/v20190101preview:MCASDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:MCASDataConnector to guarantee forwards compatibility.
 */
export class MCASDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MCASDataConnector {
        pulumi.log.warn("MCASDataConnector is deprecated: azure-native:securityinsights/v20190101preview:MCASDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:MCASDataConnector to guarantee forwards compatibility.")
        return new MCASDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20190101preview:MCASDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20190101preview.MCASDataConnectorDataTypesResponse>;
    /**
