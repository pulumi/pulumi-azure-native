...
export class MCASDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MCASDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20190101preview:MCASDataConnector" }, { type: "azure-native:securityinsights/v20210301preview:MCASDataConnector" }, { type: "azure-nextgen:securityinsights/v20210301preview:MCASDataConnector" }] };
...
export interface MCASDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes: pulumi.Input<inputs.securityinsights.v20190101preview.MCASDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
     ...
     * Expected value is 'MicrosoftCloudAppSecurity'.
     */
    readonly kind: pulumi.Input<"MicrosoftCloudAppSecurity">;
    /**
