...
export class MCASDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MCASDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["kind"] = "MicrosoftCloudAppSecurity";
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20190101preview:MCASDataConnector" }, { type: "azure-native:securityinsights:MCASDataConnector" }, { type: "azure-nextgen:securityinsights:MCASDataConnector" }, { type: "azure-native:securityinsights/v20200101:MCASDataConnector" }, { type: "azure-nextgen:securityinsights/v20200101:MCASDataConnector" }, { type: "azure-native:securityinsights/v20210301preview:MCASDataConnector" }, { type: "azure-nextgen:securityinsights/v20210301preview:MCASDataConnector" }] };
