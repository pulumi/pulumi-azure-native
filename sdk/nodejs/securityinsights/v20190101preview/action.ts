...
export class Action extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ActionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20190101preview:Action" }, { type: "azure-native:securityinsights:Action" }, { type: "azure-nextgen:securityinsights:Action" }, { type: "azure-native:securityinsights/v20200101:Action" }, { type: "azure-nextgen:securityinsights/v20200101:Action" }, { type: "azure-native:securityinsights/v20210301preview:Action" }, { type: "azure-nextgen:securityinsights/v20210301preview:Action" }] };
