...
export class ThreatIntelligenceIndicator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ThreatIntelligenceIndicatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:ThreatIntelligenceIndicator" }, { type: "azure-nextgen:securityinsights:ThreatIntelligenceIndicator" }] };
...
export interface ThreatIntelligenceIndicatorArgs {
     ...
     * External References
     */
    readonly externalReferences?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20190101preview.ThreatIntelligenceExternalReference>[]>;
    /**
     * Granular Markings
     */
