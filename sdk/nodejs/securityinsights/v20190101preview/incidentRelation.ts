...
export class IncidentRelation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IncidentRelationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20190101preview:IncidentRelation" }, { type: "azure-native:securityinsights:IncidentRelation" }, { type: "azure-nextgen:securityinsights:IncidentRelation" }] };
