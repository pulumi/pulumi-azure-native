...
export class OfficeDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OfficeDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20190101preview:OfficeDataConnector" }, { type: "azure-native:securityinsights/v20210301preview:OfficeDataConnector" }, { type: "azure-nextgen:securityinsights/v20210301preview:OfficeDataConnector" }] };
...
export interface OfficeDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes: pulumi.Input<inputs.securityinsights.v20190101preview.OfficeDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
     ...
     * Expected value is 'Office365'.
     */
    readonly kind: pulumi.Input<"Office365">;
    /**
