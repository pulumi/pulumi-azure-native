...
export class OfficeDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OfficeDataConnector {
        pulumi.log.warn("OfficeDataConnector is deprecated: azure-native:securityinsights/v20190101preview:OfficeDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:OfficeDataConnector to guarantee forwards compatibility.")
