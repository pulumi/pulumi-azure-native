...
export function getAction(args: GetActionArgs, opts?: pulumi.InvokeOptions): Promise<GetActionResult> {
    pulumi.log.warn("getAction is deprecated: azure-native:securityinsights/v20190101preview:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:Action to guarantee forwards compatibility.")
