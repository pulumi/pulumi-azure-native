 ...
 */
export class CaseRelationRelation extends pulumi.CustomResource {
    /**
     * Get an existing CaseRelationRelation resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CaseRelationRelation {
        return new CaseRelationRelation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/v20190101preview:CaseRelationRelation';

    /**
     * Returns true if the given object is an instance of CaseRelationRelation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CaseRelationRelation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CaseRelationRelation.__pulumiType;
    }
    ...
    /**
     * Create a CaseRelationRelation resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CaseRelationRelationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, state: undefined, opts: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CaseRelationRelationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CaseRelationRelationArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/preview:CaseRelationRelation" }] };
        opts = opts ? pulumi.mergeOptions(opts, aliasOpts) : aliasOpts;
        super(CaseRelationRelation.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface CaseRelationRelationArgs {
    /**
     * Case ID
     */
