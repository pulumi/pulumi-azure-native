...
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20190101preview:ScheduledAlertRule';
     ...
     */
    public readonly eventGroupingSettings!: pulumi.Output<outputs.securityinsights.v20190101preview.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    public readonly incidentConfiguration!: pulumi.Output<outputs.securityinsights.v20190101preview.IncidentConfigurationResponse | undefined>;
    /**
     *
    ...
    constructor(name: string, args: ScheduledAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20190101preview:ScheduledAlertRule" }] };
...
export interface ScheduledAlertRuleArgs {
     ...
     * The event grouping settings.
     */
    readonly eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20190101preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    readonly incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20190101preview.IncidentConfigurationArgs>;
    /**
     *
     * Expected value is 'Scheduled'.
     */
     ...
     * The severity for alerts created by this alert rule.
     */
    readonly severity: pulumi.Input<string | enums.securityinsights.v20190101preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    readonly tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20190101preview.AttackTactic>[]>;
    /**
     * The operation against the threshold that triggers alert rule.
     */
    readonly triggerOperator: pulumi.Input<enums.securityinsights.v20190101preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
