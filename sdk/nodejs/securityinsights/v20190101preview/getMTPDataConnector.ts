...
export function getMTPDataConnector(args: GetMTPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMTPDataConnectorResult> {
    pulumi.log.warn("getMTPDataConnector is deprecated: azure-native:securityinsights/v20190101preview:MTPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:MTPDataConnector to guarantee forwards compatibility.")
