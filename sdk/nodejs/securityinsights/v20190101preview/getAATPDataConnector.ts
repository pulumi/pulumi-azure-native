 ...
 */
/** @deprecated azure-native:securityinsights/v20190101preview:AATPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:AATPDataConnector to guarantee forwards compatibility. */
export function getAATPDataConnector(args: GetAATPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetAATPDataConnectorResult> {
    pulumi.log.warn("getAATPDataConnector is deprecated: azure-native:securityinsights/v20190101preview:AATPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:AATPDataConnector to guarantee forwards compatibility.")
