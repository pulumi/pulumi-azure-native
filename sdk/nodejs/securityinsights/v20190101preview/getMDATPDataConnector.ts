...
export function getMDATPDataConnector(args: GetMDATPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMDATPDataConnectorResult> {
    pulumi.log.warn("getMDATPDataConnector is deprecated: azure-native:securityinsights/v20190101preview:MDATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:MDATPDataConnector to guarantee forwards compatibility.")
