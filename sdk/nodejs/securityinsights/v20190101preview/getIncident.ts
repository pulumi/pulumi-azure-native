...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    pulumi.log.warn("getIncident is deprecated: azure-native:securityinsights/v20190101preview:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:Incident to guarantee forwards compatibility.")
