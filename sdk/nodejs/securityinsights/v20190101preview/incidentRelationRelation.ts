 ...
 */
export class IncidentRelationRelation extends pulumi.CustomResource {
    /**
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/v20190101preview:IncidentRelationRelation';

    /**
     * Returns true if the given object is an instance of IncidentRelationRelation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IncidentRelationRelation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IncidentRelationRelation.__pulumiType;
    }
 ...
 */
export interface IncidentRelationRelationArgs {
    /**
     * Etag of the azure resource
     */
