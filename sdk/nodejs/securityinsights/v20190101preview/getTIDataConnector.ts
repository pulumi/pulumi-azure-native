 ...
 */
/** @deprecated azure-native:securityinsights/v20190101preview:TIDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:TIDataConnector to guarantee forwards compatibility. */
export function getTIDataConnector(args: GetTIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetTIDataConnectorResult> {
    pulumi.log.warn("getTIDataConnector is deprecated: azure-native:securityinsights/v20190101preview:TIDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:TIDataConnector to guarantee forwards compatibility.")
