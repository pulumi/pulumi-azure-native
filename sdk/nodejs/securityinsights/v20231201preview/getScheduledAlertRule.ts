...
export interface GetScheduledAlertRuleResult {
     ...
     */
    readonly alertDetailsOverride?: outputs.securityinsights.v20231201preview.AlertDetailsOverrideResponse;
    /**
     ...
     */
    readonly entityMappings?: outputs.securityinsights.v20231201preview.EntityMappingResponse[];
    /**
     ...
     */
    readonly eventGroupingSettings?: outputs.securityinsights.v20231201preview.EventGroupingSettingsResponse;
    /**
     ...
     */
    readonly incidentConfiguration?: outputs.securityinsights.v20231201preview.IncidentConfigurationResponse;
    /**
     ...
     */
    readonly sentinelEntitiesMappings?: outputs.securityinsights.v20231201preview.SentinelEntityMappingResponse[];
    /**
...
export function getScheduledAlertRuleOutput(args: GetScheduledAlertRuleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScheduledAlertRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20231201preview:getScheduledAlertRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleId": args.ruleId,
        "workspaceName": args.workspaceName,
    }, opts);
