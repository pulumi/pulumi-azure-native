...
export function getContentPackage(args: GetContentPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetContentPackageResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20231201preview:getContentPackage", {
...
export interface GetContentPackageResult {
     ...
     */
    readonly author?: outputs.securityinsights.v20231201preview.MetadataAuthorResponse;
    /**
     * The categories of the package
     */
    readonly categories?: outputs.securityinsights.v20231201preview.MetadataCategoriesResponse;
    /**
     ...
     */
    readonly dependencies?: outputs.securityinsights.v20231201preview.MetadataDependenciesResponse;
    /**
     ...
     */
    readonly source?: outputs.securityinsights.v20231201preview.MetadataSourceResponse;
    /**
     * The support tier of the package
     */
    readonly support?: outputs.securityinsights.v20231201preview.MetadataSupportResponse;
    /**
...
export function getContentPackageOutput(args: GetContentPackageOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetContentPackageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20231201preview:getContentPackage", {
        "packageId": args.packageId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
