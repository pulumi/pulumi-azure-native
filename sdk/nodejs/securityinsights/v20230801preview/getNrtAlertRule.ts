...
export interface GetNrtAlertRuleResult {
     ...
     */
    readonly alertDetailsOverride?: outputs.securityinsights.v20230801preview.AlertDetailsOverrideResponse;
    /**
     ...
     */
    readonly entityMappings?: outputs.securityinsights.v20230801preview.EntityMappingResponse[];
    /**
     ...
     */
    readonly eventGroupingSettings?: outputs.securityinsights.v20230801preview.EventGroupingSettingsResponse;
    /**
     ...
     */
    readonly incidentConfiguration?: outputs.securityinsights.v20230801preview.IncidentConfigurationResponse;
    /**
     ...
     */
    readonly sentinelEntitiesMappings?: outputs.securityinsights.v20230801preview.SentinelEntityMappingResponse[];
    /**
...
export function getNrtAlertRuleOutput(args: GetNrtAlertRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNrtAlertRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230801preview:getNrtAlertRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleId": args.ruleId,
        "workspaceName": args.workspaceName,
    }, opts);
