...
export interface GetMTPDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20230801preview.MTPDataConnectorDataTypesResponse;
    /**
     ...
     */
    readonly filteredProviders?: outputs.securityinsights.v20230801preview.MtpFilteredProvidersResponse;
    /**
...
export function getMTPDataConnectorOutput(args: GetMTPDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMTPDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230801preview:getMTPDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
