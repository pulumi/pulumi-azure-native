...
export class DataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights:DataConnector" }, { type: "azure-native:securityinsights/latest:DataConnector" }, { type: "azure-nextgen:securityinsights/latest:DataConnector" }, { type: "azure-native:securityinsights/v20200101:DataConnector" }, { type: "azure-nextgen:securityinsights/v20200101:DataConnector" }] };
