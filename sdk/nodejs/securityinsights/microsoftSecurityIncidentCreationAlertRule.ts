...
export class MicrosoftSecurityIncidentCreationAlertRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MicrosoftSecurityIncidentCreationAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights:MicrosoftSecurityIncidentCreationAlertRule" }, { type: "azure-native:securityinsights/v20200101:MicrosoftSecurityIncidentCreationAlertRule" }, { type: "azure-nextgen:securityinsights/v20200101:MicrosoftSecurityIncidentCreationAlertRule" }] };
...
export interface MicrosoftSecurityIncidentCreationAlertRuleArgs {
     ...
     * The alerts' productName on which the cases will be generated
     */
    readonly productFilter: pulumi.Input<string | enums.securityinsights.MicrosoftSecurityProductName>;
    /**
     ...
     * the alerts' severities on which the cases will be generated
     */
    readonly severitiesFilter?: pulumi.Input<pulumi.Input<string | enums.securityinsights.AlertSeverity>[]>;
    /**
