 ...
 */
/** @deprecated azure-native:securityinsights/v20211001:IncidentComment is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:IncidentComment to guarantee forwards compatibility. */
export function getIncidentComment(args: GetIncidentCommentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentCommentResult> {
    pulumi.log.warn("getIncidentComment is deprecated: azure-native:securityinsights/v20211001:IncidentComment is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:IncidentComment to guarantee forwards compatibility.")
