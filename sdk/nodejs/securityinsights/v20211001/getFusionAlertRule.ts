...
export function getFusionAlertRule(args: GetFusionAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetFusionAlertRuleResult> {
    pulumi.log.warn("getFusionAlertRule is deprecated: azure-native:securityinsights/v20211001:FusionAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20211001preview:FusionAlertRule to guarantee forwards compatibility.")
