...
export class Incident extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:securityinsights:Incident';
    ...
    constructor(name: string, args: IncidentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/latest:Incident" }, { type: "azure-nextgen:securityinsights/v20200101:Incident" }] };
