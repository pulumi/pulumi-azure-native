...
export class Incident extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IncidentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights:Incident" }, { type: "azure-native:securityinsights/latest:Incident" }, { type: "azure-nextgen:securityinsights/latest:Incident" }, { type: "azure-native:securityinsights/v20200101:Incident" }, { type: "azure-nextgen:securityinsights/v20200101:Incident" }] };
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    readonly classification?: pulumi.Input<string | enums.securityinsights.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    readonly classificationReason?: pulumi.Input<string | enums.securityinsights.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    readonly labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.IncidentLabel>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    readonly owner?: pulumi.Input<inputs.securityinsights.IncidentOwnerInfo>;
    /**
     ...
     * The severity of the incident
     */
    readonly severity: pulumi.Input<string | enums.securityinsights.IncidentSeverity>;
    /**
     * The status of the incident
     */
    readonly status: pulumi.Input<string | enums.securityinsights.IncidentStatus>;
    /**
     * The title of the incident
     */
