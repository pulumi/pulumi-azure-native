...
export class Incident extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IncidentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/latest:Incident" }, { type: "azure-nextgen:securityinsights/latest:Incident" }, { type: "azure-native:securityinsights/v20200101:Incident" }, { type: "azure-nextgen:securityinsights/v20200101:Incident" }] };
