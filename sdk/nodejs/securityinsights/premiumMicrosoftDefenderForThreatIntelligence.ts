...
export class PremiumMicrosoftDefenderForThreatIntelligence extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights:PremiumMicrosoftDefenderForThreatIntelligence';
