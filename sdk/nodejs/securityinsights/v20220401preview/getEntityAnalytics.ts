...
export function getEntityAnalytics(args: GetEntityAnalyticsArgs, opts?: pulumi.InvokeOptions): Promise<GetEntityAnalyticsResult> {
    pulumi.log.warn("getEntityAnalytics is deprecated: azure-native:securityinsights/v20220401preview:EntityAnalytics is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:EntityAnalytics to guarantee forwards compatibility.")
