 ...
 *
 * @deprecated azure-native:securityinsights/v20220401preview:MCASDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:MCASDataConnector to guarantee forwards compatibility.
 */
export class MCASDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MCASDataConnector {
        pulumi.log.warn("MCASDataConnector is deprecated: azure-native:securityinsights/v20220401preview:MCASDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:MCASDataConnector to guarantee forwards compatibility.")
        return new MCASDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220401preview:MCASDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20220401preview.MCASDataConnectorDataTypesResponse>;
    /**
