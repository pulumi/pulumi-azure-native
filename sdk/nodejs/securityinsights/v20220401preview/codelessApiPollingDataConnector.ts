 ...
 *
 * const codelessApiPollingDataConnector = new azure_native.securityinsights.v20220401preview.CodelessApiPollingDataConnector("codelessApiPollingDataConnector", {
 *     connectorUiConfig: {
 *         availability: {
 *             isPreview: true,
 *             status: 1,
 ...
 *
 * ```sh
 * $ pulumi import azure-native:securityinsights/v20220401preview:CodelessApiPollingDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
 * ```
 */
export class CodelessApiPollingDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220401preview:CodelessApiPollingDataConnector';
     ...
     */
    public readonly pollingConfig!: pulumi.Output<outputs.securityinsights.v20220401preview.CodelessConnectorPollingConfigPropertiesResponse | undefined>;
    /**
