...
export class MLBehaviorAnalyticsAlertRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MLBehaviorAnalyticsAlertRule {
        pulumi.log.warn("MLBehaviorAnalyticsAlertRule is deprecated: azure-native:securityinsights/v20220401preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.")
