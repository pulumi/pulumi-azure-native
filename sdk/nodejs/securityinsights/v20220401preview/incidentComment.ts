 ...
 *
 * @deprecated azure-native:securityinsights/v20220401preview:IncidentComment is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:IncidentComment to guarantee forwards compatibility.
 */
export class IncidentComment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IncidentComment {
        pulumi.log.warn("IncidentComment is deprecated: azure-native:securityinsights/v20220401preview:IncidentComment is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:IncidentComment to guarantee forwards compatibility.")
        return new IncidentComment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220401preview:IncidentComment';
     ...
     */
    public /*out*/ readonly author!: pulumi.Output<outputs.securityinsights.v20220401preview.ClientInfoResponse>;
    /**
