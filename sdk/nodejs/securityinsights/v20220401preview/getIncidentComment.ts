...
export function getIncidentComment(args: GetIncidentCommentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentCommentResult> {
    pulumi.log.warn("getIncidentComment is deprecated: azure-native:securityinsights/v20220401preview:IncidentComment is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:IncidentComment to guarantee forwards compatibility.")
