...
export class CustomizableConnectorDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly connectionsConfig!: pulumi.Output<outputs.securityinsights.CustomizableConnectionsConfigResponse | undefined>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    public readonly connectorUiConfig!: pulumi.Output<outputs.securityinsights.CustomizableConnectorUiConfigResponse>;
    /**
