...
export class CustomizableConnectorDefinition extends pulumi.CustomResource {
     ...
     */
    declare public readonly connectionsConfig: pulumi.Output<outputs.securityinsights.CustomizableConnectionsConfigResponse | undefined>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    declare public readonly connectorUiConfig: pulumi.Output<outputs.securityinsights.CustomizableConnectorUiConfigResponse>;
    /**
