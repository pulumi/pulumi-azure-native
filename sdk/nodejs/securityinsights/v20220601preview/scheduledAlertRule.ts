 ...
 *
 * const scheduledAlertRule = new azure_native.securityinsights.v20220601preview.ScheduledAlertRule("scheduledAlertRule", {
 ...
 *         "T1021",
 *     ],
 *     triggerOperator: azure_native.securityinsights.v20220601preview.TriggerOperator.GreaterThan,
 *     triggerThreshold: 0,
 *     workspaceName: "myWorkspace",
 * });
 *
...
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220601preview:ScheduledAlertRule';
     ...
     */
    public readonly eventGroupingSettings!: pulumi.Output<outputs.securityinsights.v20220601preview.EventGroupingSettingsResponse | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20220601preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20220601preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
