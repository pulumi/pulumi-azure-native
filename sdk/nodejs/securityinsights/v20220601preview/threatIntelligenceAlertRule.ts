 ...
 *
 * @deprecated azure-native:securityinsights/v20220601preview:ThreatIntelligenceAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ThreatIntelligenceAlertRule to guarantee forwards compatibility.
 */
export class ThreatIntelligenceAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220601preview:ThreatIntelligenceAlertRule';
