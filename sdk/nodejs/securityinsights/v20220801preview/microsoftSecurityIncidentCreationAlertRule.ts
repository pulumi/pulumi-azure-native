 ...
 *
 * @deprecated azure-native:securityinsights/v20220801preview:MicrosoftSecurityIncidentCreationAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MicrosoftSecurityIncidentCreationAlertRule to guarantee forwards compatibility.
 */
export class MicrosoftSecurityIncidentCreationAlertRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MicrosoftSecurityIncidentCreationAlertRule {
        pulumi.log.warn("MicrosoftSecurityIncidentCreationAlertRule is deprecated: azure-native:securityinsights/v20220801preview:MicrosoftSecurityIncidentCreationAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MicrosoftSecurityIncidentCreationAlertRule to guarantee forwards compatibility.")
        return new MicrosoftSecurityIncidentCreationAlertRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220801preview:MicrosoftSecurityIncidentCreationAlertRule';
...
export interface MicrosoftSecurityIncidentCreationAlertRuleArgs {
     ...
     * The alerts' productName on which the cases will be generated
     */
    productFilter: pulumi.Input<string | enums.securityinsights.v20220801preview.MicrosoftSecurityProductName>;
    /**
     ...
     * the alerts' severities on which the cases will be generated
     */
    severitiesFilter?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220801preview.AlertSeverity>[]>;
    /**
