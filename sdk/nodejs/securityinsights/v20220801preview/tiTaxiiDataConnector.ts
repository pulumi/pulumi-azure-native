...
export class TiTaxiiDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TiTaxiiDataConnector {
        pulumi.log.warn("TiTaxiiDataConnector is deprecated: azure-native:securityinsights/v20220801preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:TiTaxiiDataConnector to guarantee forwards compatibility.")
