...
export class Watchlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220801preview:Watchlist';
...
export interface WatchlistArgs {
     ...
     * The sourceType of the watchlist
     */
    sourceType?: pulumi.Input<string | enums.securityinsights.v20220801preview.SourceType>;
    /**
     * The tenantId where the watchlist belongs to
     */
