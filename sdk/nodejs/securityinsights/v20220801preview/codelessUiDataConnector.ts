 ...
 *
 * const codelessUiDataConnector = new azure_native.securityinsights.v20220801preview.CodelessUiDataConnector("codelessUiDataConnector", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:securityinsights/v20220801preview:CodelessUiDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
 * ```
 */
export class CodelessUiDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220801preview:CodelessUiDataConnector';
     ...
     */
    public readonly connectorUiConfig!: pulumi.Output<outputs.securityinsights.v20220801preview.CodelessUiConnectorConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessUiDataConnectorArgs {
     ...
     * Config to describe the instructions blade
     */
    connectorUiConfig?: pulumi.Input<inputs.securityinsights.v20220801preview.CodelessUiConnectorConfigPropertiesArgs>;
    /**
     * Connector ID
     */
