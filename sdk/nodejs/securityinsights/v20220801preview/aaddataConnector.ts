 ...
 *
 * @deprecated azure-native:securityinsights/v20220801preview:AADDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:AADDataConnector to guarantee forwards compatibility.
 */
export class AADDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AADDataConnector {
        pulumi.log.warn("AADDataConnector is deprecated: azure-native:securityinsights/v20220801preview:AADDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:AADDataConnector to guarantee forwards compatibility.")
