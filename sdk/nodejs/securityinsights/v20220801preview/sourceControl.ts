...
export class SourceControl extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SourceControl {
        pulumi.log.warn("SourceControl is deprecated: azure-native:securityinsights/v20220801preview:SourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230501preview:SourceControl to guarantee forwards compatibility.")
