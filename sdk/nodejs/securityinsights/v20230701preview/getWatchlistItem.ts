...
export function getWatchlistItem(args: GetWatchlistItemArgs, opts?: pulumi.InvokeOptions): Promise<GetWatchlistItemResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230701preview:getWatchlistItem", {
...
export interface GetWatchlistItemResult {
     ...
     */
    readonly createdBy?: outputs.securityinsights.v20230701preview.WatchlistUserInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: outputs.securityinsights.v20230701preview.WatchlistUserInfoResponse;
    /**
...
export function getWatchlistItemOutput(args: GetWatchlistItemOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetWatchlistItemResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230701preview:getWatchlistItem", {
        "resourceGroupName": args.resourceGroupName,
        "watchlistAlias": args.watchlistAlias,
        "watchlistItemId": args.watchlistItemId,
        "workspaceName": args.workspaceName,
