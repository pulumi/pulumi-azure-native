...
export class ContentTemplate extends pulumi.CustomResource {
     ...
     */
    public readonly source!: pulumi.Output<outputs.securityinsights.v20230701preview.MetadataSourceResponse>;
    /**
    ...
    constructor(name: string, args: ContentTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:ContentTemplate" }, { type: "azure-native:securityinsights/v20230401preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230501preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230601preview:ContentTemplate" }] };
...
export interface ContentTemplateArgs {
     ...
     * The kind of content the template is for.
     */
    contentKind: pulumi.Input<string | enums.securityinsights.v20230701preview.Kind>;
    /**
     * Unique ID for the content. It should be generated based on the contentId of the package, contentId of the template, contentKind of the template and the contentVersion of the template
     */
     ...
     * the packageKind of the package contains this template
     */
    packageKind?: pulumi.Input<string | enums.securityinsights.v20230701preview.PackageKind>;
    /**
     * the name of the package contains this template
     */
