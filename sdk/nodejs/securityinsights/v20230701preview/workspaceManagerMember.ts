...
export class WorkspaceManagerMember extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceManagerMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230401preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230501preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230601preview:WorkspaceManagerMember" }] };
