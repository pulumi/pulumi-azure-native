...
export class Hunt extends pulumi.CustomResource {
     ...
     */
    public readonly owner!: pulumi.Output<outputs.securityinsights.v20230701preview.HuntOwnerResponse | undefined>;
    /**
    ...
    constructor(name: string, args: HuntArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:Hunt" }, { type: "azure-native:securityinsights/v20230401preview:Hunt" }, { type: "azure-native:securityinsights/v20230501preview:Hunt" }, { type: "azure-native:securityinsights/v20230601preview:Hunt" }] };
