...
export class EntityAnalytics extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EntityAnalytics {
        pulumi.log.warn("EntityAnalytics is deprecated: azure-native:securityinsights/v20211001preview:EntityAnalytics is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20220101preview:EntityAnalytics to guarantee forwards compatibility.")
