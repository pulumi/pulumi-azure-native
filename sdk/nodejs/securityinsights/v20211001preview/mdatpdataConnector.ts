 ...
 *
 * @deprecated azure-native:securityinsights/v20211001preview:MDATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:MDATPDataConnector to guarantee forwards compatibility.
 */
export class MDATPDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MDATPDataConnector {
        pulumi.log.warn("MDATPDataConnector is deprecated: azure-native:securityinsights/v20211001preview:MDATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:MDATPDataConnector to guarantee forwards compatibility.")
        return new MDATPDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20211001preview:MDATPDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20211001preview.AlertsDataTypeOfDataConnectorResponse | undefined>;
    /**
