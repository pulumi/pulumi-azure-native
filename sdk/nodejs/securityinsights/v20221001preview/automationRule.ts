...
export class AutomationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221001preview:AutomationRule';
     ...
     */
    public readonly actions!: pulumi.Output<(outputs.securityinsights.v20221001preview.AutomationRuleModifyPropertiesActionResponse | outputs.securityinsights.v20221001preview.AutomationRuleRunPlaybookActionResponse)[]>;
    /**
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly createdBy!: pulumi.Output<outputs.securityinsights.v20221001preview.ClientInfoResponse>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20221001preview.ClientInfoResponse>;
    /**
     ...
     */
    public readonly triggeringLogic!: pulumi.Output<outputs.securityinsights.v20221001preview.AutomationRuleTriggeringLogicResponse>;
    /**
...
export interface AutomationRuleArgs {
     ...
     * The actions to execute when the automation rule is triggered.
     */
    actions: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221001preview.AutomationRuleModifyPropertiesActionArgs | inputs.securityinsights.v20221001preview.AutomationRuleRunPlaybookActionArgs>[]>;
    /**
     * Automation rule ID
     */
     ...
     * Describes automation rule triggering logic.
     */
    triggeringLogic: pulumi.Input<inputs.securityinsights.v20221001preview.AutomationRuleTriggeringLogicArgs>;
    /**
