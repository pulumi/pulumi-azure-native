 ...
 */
/** @deprecated azure-native:securityinsights/v20221001preview:OfficePowerBIDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:OfficePowerBIDataConnector to guarantee forwards compatibility. */
export function getOfficePowerBIDataConnector(args: GetOfficePowerBIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOfficePowerBIDataConnectorResult> {
    pulumi.log.warn("getOfficePowerBIDataConnector is deprecated: azure-native:securityinsights/v20221001preview:OfficePowerBIDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:OfficePowerBIDataConnector to guarantee forwards compatibility.")
...
export interface GetOfficePowerBIDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20221001preview.OfficePowerBIConnectorDataTypesResponse;
    /**
