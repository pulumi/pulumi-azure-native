...
export function getFileImport(args: GetFileImportArgs, opts?: pulumi.InvokeOptions): Promise<GetFileImportResult> {
    pulumi.log.warn("getFileImport is deprecated: azure-native:securityinsights/v20221001preview:FileImport is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:FileImport to guarantee forwards compatibility.")
