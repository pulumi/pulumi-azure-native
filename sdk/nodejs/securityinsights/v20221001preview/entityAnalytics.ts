 ...
 *
 * @deprecated azure-native:securityinsights/v20221001preview:EntityAnalytics is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:EntityAnalytics to guarantee forwards compatibility.
 */
export class EntityAnalytics extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EntityAnalytics {
        pulumi.log.warn("EntityAnalytics is deprecated: azure-native:securityinsights/v20221001preview:EntityAnalytics is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:EntityAnalytics to guarantee forwards compatibility.")
        return new EntityAnalytics(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221001preview:EntityAnalytics';
...
export interface EntityAnalyticsArgs {
     ...
     * The relevant entity providers that are synced
     */
    entityProviders?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20221001preview.EntityProviders>[]>;
    /**
     * The kind of the setting
     * Expected value is 'EntityAnalytics'.
     */
