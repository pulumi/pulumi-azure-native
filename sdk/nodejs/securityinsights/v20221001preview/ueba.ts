 ...
 *
 * @deprecated azure-native:securityinsights/v20221001preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Ueba to guarantee forwards compatibility.
 */
export class Ueba extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ueba {
        pulumi.log.warn("Ueba is deprecated: azure-native:securityinsights/v20221001preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Ueba to guarantee forwards compatibility.")
        return new Ueba(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221001preview:Ueba';
...
export interface UebaArgs {
     ...
     * The relevant data sources that enriched by ueba
     */
    dataSources?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20221001preview.UebaDataSources>[]>;
    /**
     * The kind of the setting
     * Expected value is 'Ueba'.
     */
