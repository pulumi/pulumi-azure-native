 ...
 *
 * @deprecated azure-native:securityinsights/v20221001preview:SourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:SourceControl to guarantee forwards compatibility.
 */
export class SourceControl extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SourceControl {
        pulumi.log.warn("SourceControl is deprecated: azure-native:securityinsights/v20221001preview:SourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:SourceControl to guarantee forwards compatibility.")
        return new SourceControl(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221001preview:SourceControl';
     ...
     */
    public readonly lastDeploymentInfo!: pulumi.Output<outputs.securityinsights.v20221001preview.DeploymentInfoResponse | undefined>;
    /**
     ...
     * Repository metadata.
     */
    public readonly repository!: pulumi.Output<outputs.securityinsights.v20221001preview.RepositoryResponse>;
    /**
     * Information regarding the resources created in user's repository.
     */
    public readonly repositoryResourceInfo!: pulumi.Output<outputs.securityinsights.v20221001preview.RepositoryResourceInfoResponse | undefined>;
    /**
...
export interface SourceControlArgs {
     ...
     * Array of source control content types.
     */
    contentTypes: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20221001preview.ContentType>[]>;
    /**
     * A description of the source control
     */
     ...
     * Information regarding the latest deployment for the source control.
     */
    lastDeploymentInfo?: pulumi.Input<inputs.securityinsights.v20221001preview.DeploymentInfoArgs>;
    /**
     * The repository type of the source control
     */
    repoType: pulumi.Input<string | enums.securityinsights.v20221001preview.RepoType>;
    /**
     * Repository metadata.
     */
    repository: pulumi.Input<inputs.securityinsights.v20221001preview.RepositoryArgs>;
    /**
     * Information regarding the resources created in user's repository.
     */
    repositoryResourceInfo?: pulumi.Input<inputs.securityinsights.v20221001preview.RepositoryResourceInfoArgs>;
    /**
     ...
     * The version number associated with the source control
     */
    version?: pulumi.Input<string | enums.securityinsights.v20221001preview.Version>;
    /**
