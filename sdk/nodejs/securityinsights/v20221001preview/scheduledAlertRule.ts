 ...
 *
 * @deprecated azure-native:securityinsights/v20221001preview:ScheduledAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ScheduledAlertRule to guarantee forwards compatibility.
 */
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221001preview:ScheduledAlertRule';
     ...
     */
    public readonly alertDetailsOverride!: pulumi.Output<outputs.securityinsights.v20221001preview.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    public readonly entityMappings!: pulumi.Output<outputs.securityinsights.v20221001preview.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    public readonly eventGroupingSettings!: pulumi.Output<outputs.securityinsights.v20221001preview.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    public readonly incidentConfiguration!: pulumi.Output<outputs.securityinsights.v20221001preview.IncidentConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly sentinelEntitiesMappings!: pulumi.Output<outputs.securityinsights.v20221001preview.SentinelEntityMappingResponse[] | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<inputs.securityinsights.v20221001preview.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221001preview.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20221001preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20221001preview.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * Array of the sentinel entity mappings of the alert rule
     */
    sentinelEntitiesMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221001preview.SentinelEntityMappingArgs>[]>;
    /**
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | enums.securityinsights.v20221001preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20221001preview.AttackTactic>[]>;
    /**
     * The techniques of the alert rule
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20221001preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
