 ...
 *
 * @deprecated azure-native:securityinsights/v20221001preview:Dynamics365DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Dynamics365DataConnector to guarantee forwards compatibility.
 */
export class Dynamics365DataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20221001preview.Dynamics365DataConnectorDataTypesResponse>;
    /**
...
export interface Dynamics365DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20221001preview.Dynamics365DataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Dynamics365'.
     */
