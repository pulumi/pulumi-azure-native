...
export class OfficeATPDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OfficeATPDataConnector {
        pulumi.log.warn("OfficeATPDataConnector is deprecated: azure-native:securityinsights/v20221001preview:OfficeATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:OfficeATPDataConnector to guarantee forwards compatibility.")
