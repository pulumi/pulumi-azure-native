 ...
 *
 * const codelessApiPollingDataConnector = new azure_native.securityinsights.v20221001preview.CodelessApiPollingDataConnector("codelessApiPollingDataConnector", {
 *     connectorUiConfig: {
 *         availability: {
 *             isPreview: true,
 *             status: 1,
...
export class CodelessApiPollingDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221001preview:CodelessApiPollingDataConnector';
     ...
     */
    public readonly pollingConfig!: pulumi.Output<outputs.securityinsights.v20221001preview.CodelessConnectorPollingConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessApiPollingDataConnectorArgs {
     ...
     * Config to describe the polling instructions
     */
    pollingConfig?: pulumi.Input<inputs.securityinsights.v20221001preview.CodelessConnectorPollingConfigPropertiesArgs>;
    /**
