 ...
 */
/** @deprecated azure-native:securityinsights/v20221001preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ActivityCustomEntityQuery to guarantee forwards compatibility. */
export function getActivityCustomEntityQuery(args: GetActivityCustomEntityQueryArgs, opts?: pulumi.InvokeOptions): Promise<GetActivityCustomEntityQueryResult> {
    pulumi.log.warn("getActivityCustomEntityQuery is deprecated: azure-native:securityinsights/v20221001preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ActivityCustomEntityQuery to guarantee forwards compatibility.")
...
export interface GetActivityCustomEntityQueryResult {
     ...
     */
    readonly queryDefinitions?: outputs.securityinsights.v20221001preview.ActivityEntityQueriesPropertiesResponseQueryDefinitions;
    /**
