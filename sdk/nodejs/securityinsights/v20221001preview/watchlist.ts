 ...
 *
 * @deprecated azure-native:securityinsights/v20221001preview:Watchlist is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.
 */
export class Watchlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221001preview:Watchlist';
...
export interface WatchlistArgs {
     ...
     * The sourceType of the watchlist
     */
    sourceType?: pulumi.Input<string | enums.securityinsights.v20221001preview.SourceType>;
    /**
     * The tenantId where the watchlist belongs to
     */
