...
export class IoTDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IoTDataConnector {
        pulumi.log.warn("IoTDataConnector is deprecated: azure-native:securityinsights/v20221201preview:IoTDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:IoTDataConnector to guarantee forwards compatibility.")
