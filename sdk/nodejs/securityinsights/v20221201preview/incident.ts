...
/**
 * @deprecated azure-native:securityinsights/v20221201preview:Incident is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.
 */
export class Incident extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Incident {
        pulumi.log.warn("Incident is deprecated: azure-native:securityinsights/v20221201preview:Incident is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.")
        return new Incident(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221201preview:Incident';
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<outputs.securityinsights.v20221201preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<outputs.securityinsights.v20221201preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<outputs.securityinsights.v20221201preview.IncidentOwnerInfoResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly teamInformation!: pulumi.Output<outputs.securityinsights.v20221201preview.TeamInformationResponse | undefined>;
    /**
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    classification?: pulumi.Input<string | enums.securityinsights.v20221201preview.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    classificationReason?: pulumi.Input<string | enums.securityinsights.v20221201preview.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221201preview.IncidentLabelArgs>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    owner?: pulumi.Input<inputs.securityinsights.v20221201preview.IncidentOwnerInfoArgs>;
    /**
     * The incident ID assigned by the incident provider
     */
     ...
     * The severity of the incident
     */
    severity: pulumi.Input<string | enums.securityinsights.v20221201preview.IncidentSeverity>;
    /**
     * The status of the incident
     */
    status: pulumi.Input<string | enums.securityinsights.v20221201preview.IncidentStatus>;
    /**
     * The title of the incident
     */
