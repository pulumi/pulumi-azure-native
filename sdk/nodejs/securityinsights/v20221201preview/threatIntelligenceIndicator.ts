 ...
 *
 * @deprecated azure-native:securityinsights/v20221201preview:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.
 */
export class ThreatIntelligenceIndicator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ThreatIntelligenceIndicator {
        pulumi.log.warn("ThreatIntelligenceIndicator is deprecated: azure-native:securityinsights/v20221201preview:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.")
        return new ThreatIntelligenceIndicator(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221201preview:ThreatIntelligenceIndicator';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.securityinsights.v20221201preview.SystemDataResponse>;
    /**
...
export interface ThreatIntelligenceIndicatorArgs {
     ...
     * External References
     */
    externalReferences?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221201preview.ThreatIntelligenceExternalReferenceArgs>[]>;
    /**
     * Granular Markings
     */
    granularMarkings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221201preview.ThreatIntelligenceGranularMarkingModelArgs>[]>;
    /**
     ...
     * Kill chain phases
     */
    killChainPhases?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221201preview.ThreatIntelligenceKillChainPhaseArgs>[]>;
    /**
     ...
     * Parsed patterns
     */
    parsedPattern?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221201preview.ThreatIntelligenceParsedPatternArgs>[]>;
    /**
