...
export function getOffice365ProjectDataConnector(args: GetOffice365ProjectDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOffice365ProjectDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20221201preview:getOffice365ProjectDataConnector", {
...
export interface GetOffice365ProjectDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20221201preview.Office365ProjectConnectorDataTypesResponse;
    /**
...
export function getOffice365ProjectDataConnectorOutput(args: GetOffice365ProjectDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOffice365ProjectDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20221201preview:getOffice365ProjectDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
