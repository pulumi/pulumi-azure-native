 ...
 *
 * @deprecated azure-native:securityinsights/v20221201preview:MTPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:MTPDataConnector to guarantee forwards compatibility.
 */
export class MTPDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MTPDataConnector {
        pulumi.log.warn("MTPDataConnector is deprecated: azure-native:securityinsights/v20221201preview:MTPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:MTPDataConnector to guarantee forwards compatibility.")
        return new MTPDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221201preview:MTPDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20221201preview.MTPDataConnectorDataTypesResponse>;
    /**
...
export interface MTPDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20221201preview.MTPDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftThreatProtection'.
     */
