...
export class FusionAlertRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FusionAlertRule {
        pulumi.log.warn("FusionAlertRule is deprecated: azure-native:securityinsights/v20221201preview:FusionAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:FusionAlertRule to guarantee forwards compatibility.")
        return new FusionAlertRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221201preview:FusionAlertRule';
     ...
     */
    public readonly scenarioExclusionPatterns!: pulumi.Output<outputs.securityinsights.v20221201preview.FusionScenarioExclusionPatternResponse[] | undefined>;
    /**
     ...
     */
    public readonly sourceSettings!: pulumi.Output<outputs.securityinsights.v20221201preview.FusionSourceSettingsResponse[] | undefined>;
    /**
...
export interface FusionAlertRuleArgs {
     ...
     * Configuration to exclude scenarios in fusion detection.
     */
    scenarioExclusionPatterns?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221201preview.FusionScenarioExclusionPatternArgs>[]>;
    /**
     * Configuration for all supported source signals in fusion detection.
     */
    sourceSettings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221201preview.FusionSourceSettingsArgs>[]>;
    /**
