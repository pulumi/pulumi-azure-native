 ...
 *
 * @deprecated azure-native:securityinsights/v20221201preview:Office365ProjectDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Office365ProjectDataConnector to guarantee forwards compatibility.
 */
export class Office365ProjectDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Office365ProjectDataConnector {
        pulumi.log.warn("Office365ProjectDataConnector is deprecated: azure-native:securityinsights/v20221201preview:Office365ProjectDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Office365ProjectDataConnector to guarantee forwards compatibility.")
        return new Office365ProjectDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221201preview:Office365ProjectDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20221201preview.Office365ProjectConnectorDataTypesResponse>;
    /**
...
export interface Office365ProjectDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20221201preview.Office365ProjectConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Office365Project'.
     */
