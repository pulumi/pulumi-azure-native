 ...
 *
 * const tiTaxiiDataConnector = new azure_native.securityinsights.v20221201preview.TiTaxiiDataConnector("tiTaxiiDataConnector", {
...
export class TiTaxiiDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221201preview:TiTaxiiDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20221201preview.TiTaxiiDataConnectorDataTypesResponse>;
    /**
...
export interface TiTaxiiDataConnectorArgs {
     ...
     * The available data types for Threat Intelligence TAXII data connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20221201preview.TiTaxiiDataConnectorDataTypesArgs>;
    /**
     * The friendly name for the TAXII server.
     */
     ...
     * The polling frequency for the TAXII server.
     */
    pollingFrequency: pulumi.Input<string | enums.securityinsights.v20221201preview.PollingFrequency>;
    /**
