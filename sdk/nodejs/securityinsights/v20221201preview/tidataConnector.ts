 ...
 *
 * const tiDataConnector = new azure_native.securityinsights.v20221201preview.TIDataConnector("tiDataConnector", {
...
export class TIDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221201preview:TIDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20221201preview.TIDataConnectorDataTypesResponse>;
    /**
...
export interface TIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20221201preview.TIDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'ThreatIntelligence'.
     */
