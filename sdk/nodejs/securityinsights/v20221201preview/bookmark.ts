 ...
 *
 * @deprecated azure-native:securityinsights/v20221201preview:Bookmark is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.
 */
export class Bookmark extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Bookmark {
        pulumi.log.warn("Bookmark is deprecated: azure-native:securityinsights/v20221201preview:Bookmark is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.")
        return new Bookmark(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221201preview:Bookmark';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20221201preview.UserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly entityMappings!: pulumi.Output<outputs.securityinsights.v20221201preview.BookmarkEntityMappingsResponse[] | undefined>;
    /**
     ...
     */
    public readonly incidentInfo!: pulumi.Output<outputs.securityinsights.v20221201preview.IncidentInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<outputs.securityinsights.v20221201preview.UserInfoResponse | undefined>;
...
export interface BookmarkArgs {
     ...
     * Describes a user that created the bookmark
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20221201preview.UserInfoArgs>;
    /**
     * The display name of the bookmark
     */
     ...
     * Describes the entity mappings of the bookmark
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221201preview.BookmarkEntityMappingsArgs>[]>;
    /**
     * The bookmark event time
     */
     ...
     * Describes an incident that relates to bookmark
     */
    incidentInfo?: pulumi.Input<inputs.securityinsights.v20221201preview.IncidentInfoArgs>;
    /**
     * List of labels relevant to this bookmark
     */
     ...
     * A list of relevant mitre attacks
     */
    tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20221201preview.AttackTactic>[]>;
    /**
     * A list of relevant mitre techniques
     */
     ...
     * Describes a user that updated the bookmark
     */
    updatedBy?: pulumi.Input<inputs.securityinsights.v20221201preview.UserInfoArgs>;
    /**
