...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getIncident", {
...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: outputs.securityinsights.v20230501preview.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: outputs.securityinsights.v20230501preview.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: outputs.securityinsights.v20230501preview.IncidentOwnerInfoResponse;
    /**
     ...
     */
    readonly teamInformation?: outputs.securityinsights.v20230501preview.TeamInformationResponse;
    /**
...
export function getIncidentOutput(args: GetIncidentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncidentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230501preview:getIncident", {
        "incidentId": args.incidentId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
