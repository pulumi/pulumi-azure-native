...
export function getDynamics365DataConnector(args: GetDynamics365DataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetDynamics365DataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getDynamics365DataConnector", {
...
export interface GetDynamics365DataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20230501preview.Dynamics365DataConnectorDataTypesResponse;
    /**
...
export function getDynamics365DataConnectorOutput(args: GetDynamics365DataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDynamics365DataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230501preview:getDynamics365DataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
