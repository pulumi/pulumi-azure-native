...
export class CodelessApiPollingDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230501preview:CodelessApiPollingDataConnector';
     ...
     */
    public readonly pollingConfig!: pulumi.Output<outputs.securityinsights.v20230501preview.CodelessConnectorPollingConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessApiPollingDataConnectorArgs {
     ...
     * Config to describe the polling instructions
     */
    pollingConfig?: pulumi.Input<inputs.securityinsights.v20230501preview.CodelessConnectorPollingConfigPropertiesArgs>;
    /**
