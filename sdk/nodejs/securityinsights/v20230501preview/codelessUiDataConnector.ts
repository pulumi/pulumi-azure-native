...
export class CodelessUiDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230501preview:CodelessUiDataConnector';
     ...
     */
    public readonly connectorUiConfig!: pulumi.Output<outputs.securityinsights.v20230501preview.CodelessUiConnectorConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessUiDataConnectorArgs {
     ...
     * Config to describe the instructions blade
     */
    connectorUiConfig?: pulumi.Input<inputs.securityinsights.v20230501preview.CodelessUiConnectorConfigPropertiesArgs>;
    /**
     * Connector ID
     */
