...
export class AnomalySecurityMLAnalyticsSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230501preview:AnomalySecurityMLAnalyticsSettings';
     ...
     */
    public readonly requiredDataConnectors!: pulumi.Output<outputs.securityinsights.v20230501preview.SecurityMLAnalyticsSettingsDataSourceResponse[] | undefined>;
    /**
...
export interface AnomalySecurityMLAnalyticsSettingsArgs {
     ...
     * The required data sources for this SecurityMLAnalyticsSettings
     */
    requiredDataConnectors?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20230501preview.SecurityMLAnalyticsSettingsDataSourceArgs>[]>;
    /**
     ...
     * The anomaly SecurityMLAnalyticsSettings status
     */
    settingsStatus: pulumi.Input<string | enums.securityinsights.v20230501preview.SettingsStatus>;
    /**
     * The tactics of the SecurityMLAnalyticsSettings
     */
