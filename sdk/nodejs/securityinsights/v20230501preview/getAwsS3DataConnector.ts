...
export function getAwsS3DataConnector(args: GetAwsS3DataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetAwsS3DataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getAwsS3DataConnector", {
...
export interface GetAwsS3DataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20230501preview.AwsS3DataConnectorDataTypesResponse;
    /**
...
export function getAwsS3DataConnectorOutput(args: GetAwsS3DataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAwsS3DataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230501preview:getAwsS3DataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
