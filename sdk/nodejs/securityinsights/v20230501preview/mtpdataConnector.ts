...
export class MTPDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230501preview:MTPDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20230501preview.MTPDataConnectorDataTypesResponse>;
    /**
     ...
     */
    public readonly filteredProviders!: pulumi.Output<outputs.securityinsights.v20230501preview.MtpFilteredProvidersResponse | undefined>;
    /**
...
export interface MTPDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230501preview.MTPDataConnectorDataTypesArgs>;
    /**
     * The available filtered providers for the connector.
     */
    filteredProviders?: pulumi.Input<inputs.securityinsights.v20230501preview.MtpFilteredProvidersArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftThreatProtection'.
     */
