...
export function getCodelessUiDataConnector(args: GetCodelessUiDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetCodelessUiDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getCodelessUiDataConnector", {
...
export interface GetCodelessUiDataConnectorResult {
     ...
     */
    readonly connectorUiConfig?: outputs.securityinsights.v20230501preview.CodelessUiConnectorConfigPropertiesResponse;
    /**
...
export function getCodelessUiDataConnectorOutput(args: GetCodelessUiDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCodelessUiDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230501preview:getCodelessUiDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
