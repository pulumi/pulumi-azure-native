...
export class MLBehaviorAnalyticsAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230501preview:MLBehaviorAnalyticsAlertRule';
