...
export function getFileImport(args: GetFileImportArgs, opts?: pulumi.InvokeOptions): Promise<GetFileImportResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getFileImport", {
...
export interface GetFileImportResult {
     ...
     */
    readonly errorFile: outputs.securityinsights.v20230501preview.FileMetadataResponse;
    /**
     * An ordered list of some of the errors that were encountered during validation.
     */
    readonly errorsPreview: outputs.securityinsights.v20230501preview.ValidationErrorResponse[];
    /**
     ...
     */
    readonly importFile: outputs.securityinsights.v20230501preview.FileMetadataResponse;
    /**
...
export function getFileImportOutput(args: GetFileImportOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileImportResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230501preview:getFileImport", {
        "fileImportId": args.fileImportId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
