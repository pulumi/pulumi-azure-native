...
export class GCPDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230501preview:GCPDataConnector';
     ...
     */
    public readonly auth!: pulumi.Output<outputs.securityinsights.v20230501preview.GCPAuthPropertiesResponse>;
    /**
     ...
     */
    public readonly dcrConfig!: pulumi.Output<outputs.securityinsights.v20230501preview.DCRConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly request!: pulumi.Output<outputs.securityinsights.v20230501preview.GCPRequestPropertiesResponse>;
    /**
...
export interface GCPDataConnectorArgs {
     ...
     * The auth section of the connector.
     */
    auth: pulumi.Input<inputs.securityinsights.v20230501preview.GCPAuthPropertiesArgs>;
    /**
     * The name of the connector definition that represents the UI config.
     */
     ...
     * The configuration of the destination of the data.
     */
    dcrConfig?: pulumi.Input<inputs.securityinsights.v20230501preview.DCRConfigurationArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'GCP'.
     */
     ...
     * The request section of the connector.
     */
    request: pulumi.Input<inputs.securityinsights.v20230501preview.GCPRequestPropertiesArgs>;
    /**
