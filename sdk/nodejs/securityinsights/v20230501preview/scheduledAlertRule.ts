...
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230501preview:ScheduledAlertRule';
...
export interface ScheduledAlertRuleArgs {
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20230501preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
