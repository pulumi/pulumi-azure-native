...
export function getOfficeIRMDataConnector(args: GetOfficeIRMDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOfficeIRMDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getOfficeIRMDataConnector", {
...
export interface GetOfficeIRMDataConnectorResult {
     ...
     */
    readonly dataTypes?: outputs.securityinsights.v20230501preview.AlertsDataTypeOfDataConnectorResponse;
    /**
...
export function getOfficeIRMDataConnectorOutput(args: GetOfficeIRMDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOfficeIRMDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230501preview:getOfficeIRMDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
