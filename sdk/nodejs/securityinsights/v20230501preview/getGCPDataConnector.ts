...
export function getGCPDataConnector(args: GetGCPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetGCPDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getGCPDataConnector", {
...
export interface GetGCPDataConnectorResult {
     ...
     */
    readonly auth: outputs.securityinsights.v20230501preview.GCPAuthPropertiesResponse;
    /**
     ...
     */
    readonly dcrConfig?: outputs.securityinsights.v20230501preview.DCRConfigurationResponse;
    /**
     ...
     */
    readonly request: outputs.securityinsights.v20230501preview.GCPRequestPropertiesResponse;
    /**
...
export function getGCPDataConnectorOutput(args: GetGCPDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGCPDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230501preview:getGCPDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
