...
export function getMTPDataConnector(args: GetMTPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMTPDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getMTPDataConnector", {
...
export interface GetMTPDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20230501preview.MTPDataConnectorDataTypesResponse;
    /**
     ...
     */
    readonly filteredProviders?: outputs.securityinsights.v20230501preview.MtpFilteredProvidersResponse;
    /**
...
export function getMTPDataConnectorOutput(args: GetMTPDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMTPDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230501preview:getMTPDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
