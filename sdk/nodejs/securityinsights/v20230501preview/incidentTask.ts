...
export class IncidentTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230501preview:IncidentTask';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20230501preview.ClientInfoResponse | undefined>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20230501preview.ClientInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: IncidentTaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/v20221201preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230201preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230301preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230401preview:IncidentTask" }] };
...
export interface IncidentTaskArgs {
     ...
     * Information on the client (user or application) that made some action
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20230501preview.ClientInfoArgs>;
    /**
     * The description of the task
     */
     ...
     * Information on the client (user or application) that made some action
     */
    lastModifiedBy?: pulumi.Input<inputs.securityinsights.v20230501preview.ClientInfoArgs>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
    resourceGroupName: pulumi.Input<string>;
    status: pulumi.Input<string | enums.securityinsights.v20230501preview.IncidentTaskStatus>;
    /**
     * The title of the task
     */
