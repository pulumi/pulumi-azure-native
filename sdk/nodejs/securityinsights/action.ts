...
export class Action extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ActionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights:Action" }, { type: "azure-native:securityinsights/latest:Action" }, { type: "azure-nextgen:securityinsights/latest:Action" }, { type: "azure-native:securityinsights/v20200101:Action" }, { type: "azure-nextgen:securityinsights/v20200101:Action" }] };
