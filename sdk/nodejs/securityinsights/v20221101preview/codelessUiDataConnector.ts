 ...
 *
 * @deprecated azure-native:securityinsights/v20221101preview:CodelessUiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:CodelessUiDataConnector to guarantee forwards compatibility.
 */
export class CodelessUiDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CodelessUiDataConnector {
        pulumi.log.warn("CodelessUiDataConnector is deprecated: azure-native:securityinsights/v20221101preview:CodelessUiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:CodelessUiDataConnector to guarantee forwards compatibility.")
        return new CodelessUiDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101preview:CodelessUiDataConnector';
     ...
     */
    public readonly connectorUiConfig!: pulumi.Output<outputs.securityinsights.v20221101preview.CodelessUiConnectorConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessUiDataConnectorArgs {
     ...
     * Config to describe the instructions blade
     */
    connectorUiConfig?: pulumi.Input<inputs.securityinsights.v20221101preview.CodelessUiConnectorConfigPropertiesArgs>;
    /**
     * Connector ID
     */
