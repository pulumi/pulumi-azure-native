...
/**
 * @deprecated azure-native:securityinsights/v20221101preview:AutomationRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AutomationRule to guarantee forwards compatibility.
 */
export class AutomationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AutomationRule {
        pulumi.log.warn("AutomationRule is deprecated: azure-native:securityinsights/v20221101preview:AutomationRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AutomationRule to guarantee forwards compatibility.")
        return new AutomationRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101preview:AutomationRule';
     ...
     */
    public readonly actions!: pulumi.Output<(outputs.securityinsights.v20221101preview.AutomationRuleModifyPropertiesActionResponse | outputs.securityinsights.v20221101preview.AutomationRuleRunPlaybookActionResponse)[]>;
    /**
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly createdBy!: pulumi.Output<outputs.securityinsights.v20221101preview.ClientInfoResponse>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20221101preview.ClientInfoResponse>;
    /**
     ...
     */
    public readonly triggeringLogic!: pulumi.Output<outputs.securityinsights.v20221101preview.AutomationRuleTriggeringLogicResponse>;
    /**
...
export interface AutomationRuleArgs {
     ...
     * The actions to execute when the automation rule is triggered.
     */
    actions: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221101preview.AutomationRuleModifyPropertiesActionArgs | inputs.securityinsights.v20221101preview.AutomationRuleRunPlaybookActionArgs>[]>;
    /**
     * Automation rule ID
     */
     ...
     * Describes automation rule triggering logic.
     */
    triggeringLogic: pulumi.Input<inputs.securityinsights.v20221101preview.AutomationRuleTriggeringLogicArgs>;
    /**
