 ...
 *
 * @deprecated azure-native:securityinsights/v20221101preview:MTPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MTPDataConnector to guarantee forwards compatibility.
 */
export class MTPDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MTPDataConnector {
        pulumi.log.warn("MTPDataConnector is deprecated: azure-native:securityinsights/v20221101preview:MTPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MTPDataConnector to guarantee forwards compatibility.")
