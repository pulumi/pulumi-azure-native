 ...
 */
/** @deprecated azure-native:securityinsights/v20221101preview:Dynamics365DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Dynamics365DataConnector to guarantee forwards compatibility. */
export function getDynamics365DataConnector(args: GetDynamics365DataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetDynamics365DataConnectorResult> {
    pulumi.log.warn("getDynamics365DataConnector is deprecated: azure-native:securityinsights/v20221101preview:Dynamics365DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Dynamics365DataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20221101preview:getDynamics365DataConnector", {
...
export interface GetDynamics365DataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20221101preview.Dynamics365DataConnectorDataTypesResponse;
    /**
