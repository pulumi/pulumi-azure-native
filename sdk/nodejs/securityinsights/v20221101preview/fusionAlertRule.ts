 ...
 *
 * @deprecated azure-native:securityinsights/v20221101preview:FusionAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:FusionAlertRule to guarantee forwards compatibility.
 */
export class FusionAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101preview:FusionAlertRule';
     ...
     */
    public readonly scenarioExclusionPatterns!: pulumi.Output<outputs.securityinsights.v20221101preview.FusionScenarioExclusionPatternResponse[] | undefined>;
    /**
     ...
     */
    public readonly sourceSettings!: pulumi.Output<outputs.securityinsights.v20221101preview.FusionSourceSettingsResponse[] | undefined>;
    /**
...
export interface FusionAlertRuleArgs {
     ...
     * Configuration to exclude scenarios in fusion detection.
     */
    scenarioExclusionPatterns?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221101preview.FusionScenarioExclusionPatternArgs>[]>;
    /**
     * Configuration for all supported source signals in fusion detection.
     */
    sourceSettings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221101preview.FusionSourceSettingsArgs>[]>;
    /**
