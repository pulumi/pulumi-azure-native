 ...
 *
 * const officePowerBIDataConnector = new azure_native.securityinsights.v20221101preview.OfficePowerBIDataConnector("officePowerBIDataConnector", {
...
export class OfficePowerBIDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101preview:OfficePowerBIDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20221101preview.OfficePowerBIConnectorDataTypesResponse>;
    /**
...
export interface OfficePowerBIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20221101preview.OfficePowerBIConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'OfficePowerBI'.
     */
