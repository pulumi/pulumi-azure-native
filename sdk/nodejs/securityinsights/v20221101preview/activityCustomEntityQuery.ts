 ...
 *
 * @deprecated azure-native:securityinsights/v20221101preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ActivityCustomEntityQuery to guarantee forwards compatibility.
 */
export class ActivityCustomEntityQuery extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ActivityCustomEntityQuery {
        pulumi.log.warn("ActivityCustomEntityQuery is deprecated: azure-native:securityinsights/v20221101preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ActivityCustomEntityQuery to guarantee forwards compatibility.")
        return new ActivityCustomEntityQuery(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101preview:ActivityCustomEntityQuery';
     ...
     */
    public readonly queryDefinitions!: pulumi.Output<outputs.securityinsights.v20221101preview.ActivityEntityQueriesPropertiesResponseQueryDefinitions | undefined>;
    /**
...
export interface ActivityCustomEntityQueryArgs {
     ...
     * The type of the query's source entity
     */
    inputEntityType?: pulumi.Input<string | enums.securityinsights.v20221101preview.EntityType>;
    /**
     ...
     * The Activity query definitions
     */
    queryDefinitions?: pulumi.Input<inputs.securityinsights.v20221101preview.ActivityEntityQueriesPropertiesQueryDefinitionsArgs>;
    /**
     * List of the fields of the source entity that are required to run the query
     */
