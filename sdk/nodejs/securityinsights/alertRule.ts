...
export class AlertRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/v20190101preview:AlertRule" }, { type: "azure-native:securityinsights/v20200101:AlertRule" }, { type: "azure-native:securityinsights/v20210301preview:AlertRule" }] };
