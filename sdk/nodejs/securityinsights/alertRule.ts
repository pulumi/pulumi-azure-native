...
export class AlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights:AlertRule';
    ...
    constructor(name: string, args: AlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights:AlertRule" }, { type: "azure-native:securityinsights/v20190101preview:AlertRule" }, { type: "azure-nextgen:securityinsights/v20190101preview:AlertRule" }, { type: "azure-native:securityinsights/v20200101:AlertRule" }, { type: "azure-nextgen:securityinsights/v20200101:AlertRule" }, { type: "azure-native:securityinsights/v20210301preview:AlertRule" }, { type: "azure-nextgen:securityinsights/v20210301preview:AlertRule" }] };
