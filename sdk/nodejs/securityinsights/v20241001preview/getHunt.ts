...
export function getHunt(args: GetHuntArgs, opts?: pulumi.InvokeOptions): Promise<GetHuntResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20241001preview:getHunt", {
        "huntId": args.huntId,
...
export interface GetHuntResult {
     ...
     */
    readonly owner?: outputs.securityinsights.v20241001preview.HuntOwnerResponse;
    /**
...
export function getHuntOutput(args: GetHuntOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHuntResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20241001preview:getHunt", {
        "huntId": args.huntId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
