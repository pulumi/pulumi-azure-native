...
export class IncidentTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20241001preview:IncidentTask';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20241001preview.ClientInfoResponse | undefined>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20241001preview.ClientInfoResponse | undefined>;
    /**
