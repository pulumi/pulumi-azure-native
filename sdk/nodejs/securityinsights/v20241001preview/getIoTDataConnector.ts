...
export function getIoTDataConnector(args: GetIoTDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetIoTDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20241001preview:getIoTDataConnector", {
...
export function getIoTDataConnectorOutput(args: GetIoTDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIoTDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20241001preview:getIoTDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
