...
export class ThreatIntelligenceIndicator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20241001preview:ThreatIntelligenceIndicator';
