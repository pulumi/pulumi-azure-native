...
export function getWatchlist(args: GetWatchlistArgs, opts?: pulumi.InvokeOptions): Promise<GetWatchlistResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20241001preview:getWatchlist", {
...
export interface GetWatchlistResult {
     ...
     */
    readonly createdBy?: outputs.securityinsights.v20241001preview.WatchlistUserInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: outputs.securityinsights.v20241001preview.WatchlistUserInfoResponse;
    /**
...
export function getWatchlistOutput(args: GetWatchlistOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWatchlistResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20241001preview:getWatchlist", {
        "resourceGroupName": args.resourceGroupName,
        "watchlistAlias": args.watchlistAlias,
        "workspaceName": args.workspaceName,
    }, opts);
