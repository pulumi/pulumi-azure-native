...
export class System extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20241001preview:System';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.securityinsights.v20241001preview.SapSystemsConfigurationResponse>;
    ...
    constructor(name: string, args: SystemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/v20240401preview:System" }, { type: "azure-native:securityinsights:System" }] };
