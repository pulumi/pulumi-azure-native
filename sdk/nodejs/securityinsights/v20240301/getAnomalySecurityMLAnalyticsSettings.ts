...
export interface GetAnomalySecurityMLAnalyticsSettingsResult {
     ...
     */
    readonly requiredDataConnectors?: outputs.securityinsights.v20240301.SecurityMLAnalyticsSettingsDataSourceResponse[];
    /**
...
export function getAnomalySecurityMLAnalyticsSettingsOutput(args: GetAnomalySecurityMLAnalyticsSettingsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAnomalySecurityMLAnalyticsSettingsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20240301:getAnomalySecurityMLAnalyticsSettings", {
        "resourceGroupName": args.resourceGroupName,
        "settingsResourceName": args.settingsResourceName,
        "workspaceName": args.workspaceName,
    }, opts);
