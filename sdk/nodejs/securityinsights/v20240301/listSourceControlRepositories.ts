...
export interface ListSourceControlRepositoriesArgs {
     ...
     */
    kind: string | enums.securityinsights.v20240301.RepositoryAccessKind;
    /**
...
export interface ListSourceControlRepositoriesResult {
     ...
     */
    readonly value: outputs.securityinsights.v20240301.RepoResponse[];
}
/**
 * Gets a list of repositories metadata.
 */
export function listSourceControlRepositoriesOutput(args: ListSourceControlRepositoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListSourceControlRepositoriesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20240301:listSourceControlRepositories", {
        "clientId": args.clientId,
        "code": args.code,
        "installationId": args.installationId,
        "kind": args.kind,
...
export interface ListSourceControlRepositoriesOutputArgs {
     ...
     * The kind of repository access credentials
     */
    kind: pulumi.Input<string | enums.securityinsights.v20240301.RepositoryAccessKind>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
