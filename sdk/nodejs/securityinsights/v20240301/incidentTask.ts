...
export class IncidentTask extends pulumi.CustomResource {
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20240301.ClientInfoResponse | undefined>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20240301.ClientInfoResponse | undefined>;
    /**
