...
export class Metadatum extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210301preview:Metadatum';
    ...
    constructor(name: string, args: MetadatumArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:Metadatum" }, { type: "azure-native:securityinsights:Metadatum" }, { type: "azure-nextgen:securityinsights:Metadatum" }] };
