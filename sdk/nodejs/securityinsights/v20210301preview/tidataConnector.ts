...
export class TIDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TIDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:TIDataConnector" }, { type: "azure-native:securityinsights:TIDataConnector" }, { type: "azure-nextgen:securityinsights:TIDataConnector" }, { type: "azure-native:securityinsights/v20190101preview:TIDataConnector" }, { type: "azure-nextgen:securityinsights/v20190101preview:TIDataConnector" }, { type: "azure-native:securityinsights/v20200101:TIDataConnector" }, { type: "azure-nextgen:securityinsights/v20200101:TIDataConnector" }] };
