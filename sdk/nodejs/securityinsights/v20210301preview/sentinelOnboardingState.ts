...
export class SentinelOnboardingState extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SentinelOnboardingStateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["sentinelOnboardingStateName"] = args ? args.sentinelOnboardingStateName : undefined;
            inputs["workspaceName"] = args ? args.workspaceName : undefined;
            inputs["name"] = undefined /*out*/;
            inputs["systemData"] = undefined /*out*/;
            inputs["type"] = undefined /*out*/;
        } else {
            inputs["customerManagedKey"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:SentinelOnboardingState" }, { type: "azure-native:securityinsights:SentinelOnboardingState" }, { type: "azure-nextgen:securityinsights:SentinelOnboardingState" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(SentinelOnboardingState.__pulumiType, name, inputs, opts);
    }
}
