...
export class DataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:DataConnector" }, { type: "azure-native:securityinsights:DataConnector" }, { type: "azure-nextgen:securityinsights:DataConnector" }, { type: "azure-native:securityinsights/v20190101preview:DataConnector" }, { type: "azure-nextgen:securityinsights/v20190101preview:DataConnector" }, { type: "azure-native:securityinsights/v20200101:DataConnector" }, { type: "azure-nextgen:securityinsights/v20200101:DataConnector" }] };
