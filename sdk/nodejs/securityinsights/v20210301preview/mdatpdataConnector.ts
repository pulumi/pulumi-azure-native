...
export class MDATPDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MDATPDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:MDATPDataConnector" }, { type: "azure-native:securityinsights/v20190101preview:MDATPDataConnector" }, { type: "azure-nextgen:securityinsights/v20190101preview:MDATPDataConnector" }] };
...
export interface MDATPDataConnectorArgs {
     ...
     * Expected value is 'MicrosoftDefenderAdvancedThreatProtection'.
     */
    readonly kind: pulumi.Input<"MicrosoftDefenderAdvancedThreatProtection">;
    /**
