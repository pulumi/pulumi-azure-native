...
export class Anomalies extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AnomaliesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:Anomalies" }, { type: "azure-native:securityinsights:Anomalies" }, { type: "azure-nextgen:securityinsights:Anomalies" }, { type: "azure-native:securityinsights/v20190101preview:Anomalies" }, { type: "azure-nextgen:securityinsights/v20190101preview:Anomalies" }] };
