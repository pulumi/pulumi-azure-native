...
export class FusionAlertRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FusionAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:FusionAlertRule" }, { type: "azure-native:securityinsights:FusionAlertRule" }, { type: "azure-nextgen:securityinsights:FusionAlertRule" }, { type: "azure-native:securityinsights/v20190101preview:FusionAlertRule" }, { type: "azure-nextgen:securityinsights/v20190101preview:FusionAlertRule" }, { type: "azure-native:securityinsights/v20200101:FusionAlertRule" }, { type: "azure-nextgen:securityinsights/v20200101:FusionAlertRule" }] };
