...
export class WatchlistItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WatchlistItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:WatchlistItem" }, { type: "azure-native:securityinsights:WatchlistItem" }, { type: "azure-nextgen:securityinsights:WatchlistItem" }, { type: "azure-native:securityinsights/v20190101preview:WatchlistItem" }, { type: "azure-nextgen:securityinsights/v20190101preview:WatchlistItem" }, { type: "azure-native:securityinsights/v20210401:WatchlistItem" }, { type: "azure-nextgen:securityinsights/v20210401:WatchlistItem" }] };
