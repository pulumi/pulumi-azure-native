...
export class EyesOn extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EyesOnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:EyesOn" }, { type: "azure-native:securityinsights/v20190101preview:EyesOn" }, { type: "azure-native:securityinsights/v20210901preview:EyesOn" }] };
