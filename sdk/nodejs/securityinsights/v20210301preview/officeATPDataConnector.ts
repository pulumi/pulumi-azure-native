...
export class OfficeATPDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OfficeATPDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:OfficeATPDataConnector" }, { type: "azure-native:securityinsights/v20190101preview:OfficeATPDataConnector" }, { type: "azure-nextgen:securityinsights/v20190101preview:OfficeATPDataConnector" }] };
