...
export class ProductSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210301preview:ProductSetting';
    ...
    constructor(name: string, args: ProductSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:ProductSetting" }, { type: "azure-native:securityinsights:ProductSetting" }, { type: "azure-nextgen:securityinsights:ProductSetting" }, { type: "azure-native:securityinsights/v20190101preview:ProductSetting" }, { type: "azure-nextgen:securityinsights/v20190101preview:ProductSetting" }] };
...
export interface ProductSettingArgs {
     ...
     * The kind of the setting
     */
    readonly kind: pulumi.Input<string | enums.securityinsights.v20210301preview.SettingKind>;
    /**
