...
export class EntityQuery extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EntityQueryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:EntityQuery" }, { type: "azure-native:securityinsights/v20210901preview:EntityQuery" }, { type: "azure-native:securityinsights/v20211001preview:EntityQuery" }] };
