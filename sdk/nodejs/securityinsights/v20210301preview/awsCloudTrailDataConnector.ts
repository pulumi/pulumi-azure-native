...
export class AwsCloudTrailDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AwsCloudTrailDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:AwsCloudTrailDataConnector" }, { type: "azure-native:securityinsights/v20190101preview:AwsCloudTrailDataConnector" }, { type: "azure-nextgen:securityinsights/v20190101preview:AwsCloudTrailDataConnector" }] };
...
export interface AwsCloudTrailDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes: pulumi.Input<inputs.securityinsights.v20210301preview.AwsCloudTrailDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
