...
export class MTPDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MTPDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20210301preview:MTPDataConnector" }, { type: "azure-native:securityinsights/v20190101preview:MTPDataConnector" }, { type: "azure-nextgen:securityinsights/v20190101preview:MTPDataConnector" }] };
...
export interface MTPDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes: pulumi.Input<inputs.securityinsights.v20210301preview.MTPDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
     ...
     * Expected value is 'MicrosoftThreatProtection'.
     */
    readonly kind: pulumi.Input<"MicrosoftThreatProtection">;
    /**
