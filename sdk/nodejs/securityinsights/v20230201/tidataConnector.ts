 ...
 *
 * const tiDataConnector = new azure_native.securityinsights.v20230201.TIDataConnector("tiDataConnector", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:securityinsights/v20230201:TIDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
 * ```
 */
export class TIDataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20230201.TIDataConnectorDataTypesResponse | undefined>;
    /**
...
export interface TIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes?: pulumi.Input<inputs.securityinsights.v20230201.TIDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'ThreatIntelligence'.
     */
