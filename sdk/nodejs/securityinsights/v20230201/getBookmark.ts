...
export function getBookmark(args: GetBookmarkArgs, opts?: pulumi.InvokeOptions): Promise<GetBookmarkResult> {
    pulumi.log.warn("getBookmark is deprecated: azure-native:securityinsights/v20230201:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Bookmark to guarantee forwards compatibility.")
...
export interface GetBookmarkResult {
     ...
     */
    readonly createdBy?: outputs.securityinsights.v20230201.UserInfoResponse;
    /**
     ...
     */
    readonly incidentInfo?: outputs.securityinsights.v20230201.IncidentInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: outputs.securityinsights.v20230201.UserInfoResponse;
}
/**
 * Gets a bookmark.
 */
