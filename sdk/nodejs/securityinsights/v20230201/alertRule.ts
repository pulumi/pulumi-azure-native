...
export class AlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201:AlertRule';
...
export interface AlertRuleArgs {
     ...
     * The alert rule kind
     */
    kind: pulumi.Input<string | enums.securityinsights.v20230201.AlertRuleKind>;
    /**
