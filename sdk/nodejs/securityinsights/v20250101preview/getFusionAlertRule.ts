...
export function getFusionAlertRule(args: GetFusionAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetFusionAlertRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20250101preview:getFusionAlertRule", {
...
export interface GetFusionAlertRuleResult {
     ...
     */
    readonly scenarioExclusionPatterns?: outputs.securityinsights.v20250101preview.FusionScenarioExclusionPatternResponse[];
    /**
     ...
     */
    readonly sourceSettings?: outputs.securityinsights.v20250101preview.FusionSourceSettingsResponse[];
    /**
...
export function getFusionAlertRuleOutput(args: GetFusionAlertRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionAlertRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20250101preview:getFusionAlertRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleId": args.ruleId,
        "workspaceName": args.workspaceName,
    }, opts);
