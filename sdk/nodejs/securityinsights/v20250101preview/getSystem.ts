...
export function getSystem(args: GetSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetSystemResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20250101preview:getSystem", {
...
export function getSystemOutput(args: GetSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSystemResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20250101preview:getSystem", {
        "agentResourceName": args.agentResourceName,
        "resourceGroupName": args.resourceGroupName,
        "systemResourceName": args.systemResourceName,
        "workspaceName": args.workspaceName,
