...
export function listWhoisByDomain(args: ListWhoisByDomainArgs, opts?: pulumi.InvokeOptions): Promise<ListWhoisByDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20250101preview:listWhoisByDomain", {
        "domain": args.domain,
...
export interface ListWhoisByDomainResult {
     ...
     */
    readonly parsedWhois?: outputs.securityinsights.v20250101preview.EnrichmentDomainWhoisDetailsResponse;
    /**
...
export function listWhoisByDomainOutput(args: ListWhoisByDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListWhoisByDomainResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20250101preview:listWhoisByDomain", {
        "domain": args.domain,
        "enrichmentType": args.enrichmentType,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
