...
export class RestApiPollerDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20250101preview:RestApiPollerDataConnector';
     ...
     */
    public readonly auth!: pulumi.Output<outputs.securityinsights.v20250101preview.AWSAuthModelResponse | outputs.securityinsights.v20250101preview.ApiKeyAuthModelResponse | outputs.securityinsights.v20250101preview.BasicAuthModelResponse | outputs.securityinsights.v20250101preview.GCPAuthModelResponse | outputs.securityinsights.v20250101preview.GenericBlobSbsAuthModelResponse | outputs.securityinsights.v20250101preview.GitHubAuthModelResponse | outputs.securityinsights.v20250101preview.JwtAuthModelResponse | outputs.securityinsights.v20250101preview.NoneAuthModelResponse | outputs.securityinsights.v20250101preview.OAuthModelResponse | outputs.securityinsights.v20250101preview.OracleAuthModelResponse | outputs.securityinsights.v20250101preview.SessionAuthModelResponse>;
    /**
     ...
     */
    public readonly paging!: pulumi.Output<outputs.securityinsights.v20250101preview.RestApiPollerRequestPagingConfigResponse | undefined>;
    /**
     * The request configuration.
     */
    public readonly request!: pulumi.Output<outputs.securityinsights.v20250101preview.RestApiPollerRequestConfigResponse>;
    /**
     * The response configuration.
     */
    public readonly response!: pulumi.Output<outputs.securityinsights.v20250101preview.CcpResponseConfigResponse | undefined>;
    /**
    ...
    constructor(name: string, args: RestApiPollerDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["response"] = args ? (args.response ? pulumi.output(args.response).apply(inputs.securityinsights.v20250101preview.ccpResponseConfigArgsProvideDefaults) : undefined) : undefined;
...
export interface RestApiPollerDataConnectorArgs {
     ...
     * The a authentication model.
     */
    auth: pulumi.Input<inputs.securityinsights.v20250101preview.AWSAuthModelArgs | inputs.securityinsights.v20250101preview.ApiKeyAuthModelArgs | inputs.securityinsights.v20250101preview.BasicAuthModelArgs | inputs.securityinsights.v20250101preview.GCPAuthModelArgs | inputs.securityinsights.v20250101preview.GenericBlobSbsAuthModelArgs | inputs.securityinsights.v20250101preview.GitHubAuthModelArgs | inputs.securityinsights.v20250101preview.JwtAuthModelArgs | inputs.securityinsights.v20250101preview.NoneAuthModelArgs | inputs.securityinsights.v20250101preview.OAuthModelArgs | inputs.securityinsights.v20250101preview.OracleAuthModelArgs | inputs.securityinsights.v20250101preview.SessionAuthModelArgs>;
    /**
     * The connector definition name (the dataConnectorDefinition resource id).
     */
     ...
     * The paging configuration.
     */
    paging?: pulumi.Input<inputs.securityinsights.v20250101preview.RestApiPollerRequestPagingConfigArgs>;
    /**
     * The request configuration.
     */
    request: pulumi.Input<inputs.securityinsights.v20250101preview.RestApiPollerRequestConfigArgs>;
    /**
     ...
     * The response configuration.
     */
    response?: pulumi.Input<inputs.securityinsights.v20250101preview.CcpResponseConfigArgs>;
    /**
