...
export function getScheduledAlertRule(args: GetScheduledAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledAlertRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20250101preview:getScheduledAlertRule", {
...
export interface GetScheduledAlertRuleResult {
     ...
     */
    readonly alertDetailsOverride?: outputs.securityinsights.v20250101preview.AlertDetailsOverrideResponse;
    /**
     ...
     */
    readonly entityMappings?: outputs.securityinsights.v20250101preview.EntityMappingResponse[];
    /**
     ...
     */
    readonly eventGroupingSettings?: outputs.securityinsights.v20250101preview.EventGroupingSettingsResponse;
    /**
     ...
     */
    readonly incidentConfiguration?: outputs.securityinsights.v20250101preview.IncidentConfigurationResponse;
    /**
     ...
     */
    readonly sentinelEntitiesMappings?: outputs.securityinsights.v20250101preview.SentinelEntityMappingResponse[];
    /**
...
export function getScheduledAlertRuleOutput(args: GetScheduledAlertRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledAlertRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20250101preview:getScheduledAlertRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleId": args.ruleId,
        "workspaceName": args.workspaceName,
    }, opts);
