...
export class OfficeDataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20231101.OfficeDataConnectorDataTypesResponse | undefined>;
    /**
...
export interface OfficeDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes?: pulumi.Input<inputs.securityinsights.v20231101.OfficeDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Office365'.
     */
