...
export interface GetScheduledAlertRuleResult {
     ...
     */
    readonly alertDetailsOverride?: outputs.securityinsights.v20231101.AlertDetailsOverrideResponse;
    /**
     ...
     */
    readonly entityMappings?: outputs.securityinsights.v20231101.EntityMappingResponse[];
    /**
     ...
     */
    readonly eventGroupingSettings?: outputs.securityinsights.v20231101.EventGroupingSettingsResponse;
    /**
     ...
     */
    readonly incidentConfiguration?: outputs.securityinsights.v20231101.IncidentConfigurationResponse;
    /**
...
export function getScheduledAlertRuleOutput(args: GetScheduledAlertRuleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScheduledAlertRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20231101:getScheduledAlertRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleId": args.ruleId,
        "workspaceName": args.workspaceName,
    }, opts);
