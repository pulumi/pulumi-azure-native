...
export class OfficeDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OfficeDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights:OfficeDataConnector" }, { type: "azure-native:securityinsights/v20200101:OfficeDataConnector" }, { type: "azure-nextgen:securityinsights/v20200101:OfficeDataConnector" }] };
...
export interface OfficeDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes?: pulumi.Input<inputs.securityinsights.OfficeDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
