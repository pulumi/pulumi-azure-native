...
export interface GetEntitiesGetTimelineArgs {
     ...
     */
    kinds?: (string | enums.securityinsights.v20220701preview.EntityTimelineKind)[];
    /**
...
export interface GetEntitiesGetTimelineResult {
     ...
     */
    readonly metaData?: outputs.securityinsights.v20220701preview.TimelineResultsMetadataResponse;
    /**
     * The timeline result values.
     */
    readonly value?: (outputs.securityinsights.v20220701preview.ActivityTimelineItemResponse | outputs.securityinsights.v20220701preview.AnomalyTimelineItemResponse | outputs.securityinsights.v20220701preview.BookmarkTimelineItemResponse | outputs.securityinsights.v20220701preview.SecurityAlertTimelineItemResponse)[];
}
/**
 * Timeline for an entity.
 */
export function getEntitiesGetTimelineOutput(args: GetEntitiesGetTimelineOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEntitiesGetTimelineResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20220701preview:getEntitiesGetTimeline", {
        "endTime": args.endTime,
        "entityId": args.entityId,
        "kinds": args.kinds,
        "numberOfBucket": args.numberOfBucket,
...
export interface GetEntitiesGetTimelineOutputArgs {
     ...
     * Array of timeline Item kinds.
     */
    kinds?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220701preview.EntityTimelineKind>[]>;
    /**
     * The number of bucket for timeline queries aggregation.
     */
