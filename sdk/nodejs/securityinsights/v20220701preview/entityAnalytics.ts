 ...
 *
 * const entityAnalytics = new azure_native.securityinsights.v20220701preview.EntityAnalytics("entityAnalytics", {
...
export class EntityAnalytics extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220701preview:EntityAnalytics';
...
export interface EntityAnalyticsArgs {
     ...
     * The relevant entity providers that are synced
     */
    entityProviders?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220701preview.EntityProviders>[]>;
    /**
     * The kind of the setting
     * Expected value is 'EntityAnalytics'.
     */
