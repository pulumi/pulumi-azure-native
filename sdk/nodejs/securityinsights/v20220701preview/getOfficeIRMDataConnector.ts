 ...
 */
/** @deprecated azure-native:securityinsights/v20220701preview:OfficeIRMDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:OfficeIRMDataConnector to guarantee forwards compatibility. */
export function getOfficeIRMDataConnector(args: GetOfficeIRMDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOfficeIRMDataConnectorResult> {
    pulumi.log.warn("getOfficeIRMDataConnector is deprecated: azure-native:securityinsights/v20220701preview:OfficeIRMDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:OfficeIRMDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20220701preview:getOfficeIRMDataConnector", {
