 ...
 *
 * @deprecated azure-native:securityinsights/v20220701preview:Metadata is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.
 */
export class Metadata extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Metadata {
        pulumi.log.warn("Metadata is deprecated: azure-native:securityinsights/v20220701preview:Metadata is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.")
        return new Metadata(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220701preview:Metadata';
     ...
     */
    public readonly author!: pulumi.Output<outputs.securityinsights.v20220701preview.MetadataAuthorResponse | undefined>;
    /**
     * Categories for the solution content item
     */
    public readonly categories!: pulumi.Output<outputs.securityinsights.v20220701preview.MetadataCategoriesResponse | undefined>;
    /**
     ...
     */
    public readonly dependencies!: pulumi.Output<outputs.securityinsights.v20220701preview.MetadataDependenciesResponse | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.securityinsights.v20220701preview.MetadataSourceResponse | undefined>;
    /**
     * Support information for the metadata - type, name, contact information
     */
    public readonly support!: pulumi.Output<outputs.securityinsights.v20220701preview.MetadataSupportResponse | undefined>;
    /**
...
export interface MetadataArgs {
     ...
     * The creator of the content item.
     */
    author?: pulumi.Input<inputs.securityinsights.v20220701preview.MetadataAuthorArgs>;
    /**
     * Categories for the solution content item
     */
    categories?: pulumi.Input<inputs.securityinsights.v20220701preview.MetadataCategoriesArgs>;
    /**
     * Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Dynamic for user-created.  This is the resource name
     */
     ...
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    dependencies?: pulumi.Input<inputs.securityinsights.v20220701preview.MetadataDependenciesArgs>;
    /**
     * first publish date solution content item
     */
     ...
     * The kind of content the metadata is for.
     */
    kind: pulumi.Input<string | enums.securityinsights.v20220701preview.Kind>;
    /**
     * last publish date for the solution content item
     */
     ...
     * Source of the content.  This is where/how it was created.
     */
    source?: pulumi.Input<inputs.securityinsights.v20220701preview.MetadataSourceArgs>;
    /**
     * Support information for the metadata - type, name, contact information
     */
    support?: pulumi.Input<inputs.securityinsights.v20220701preview.MetadataSupportArgs>;
    /**
     * the tactics the resource covers
     */
