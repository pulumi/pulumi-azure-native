 ...
 *
 * @deprecated azure-native:securityinsights/v20220701preview:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.
 */
export class Incident extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Incident {
        pulumi.log.warn("Incident is deprecated: azure-native:securityinsights/v20220701preview:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.")
        return new Incident(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220701preview:Incident';
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<outputs.securityinsights.v20220701preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<outputs.securityinsights.v20220701preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<outputs.securityinsights.v20220701preview.IncidentOwnerInfoResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly teamInformation!: pulumi.Output<outputs.securityinsights.v20220701preview.TeamInformationResponse | undefined>;
    /**
