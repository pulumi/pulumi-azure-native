...
export class ActivityCustomEntityQuery extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ActivityCustomEntityQuery {
        pulumi.log.warn("ActivityCustomEntityQuery is deprecated: azure-native:securityinsights/v20220701preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ActivityCustomEntityQuery to guarantee forwards compatibility.")
