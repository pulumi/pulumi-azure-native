 ...
 *
 * @deprecated azure-native:securityinsights/v20220701preview:NrtAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:NrtAlertRule to guarantee forwards compatibility.
 */
export class NrtAlertRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NrtAlertRule {
        pulumi.log.warn("NrtAlertRule is deprecated: azure-native:securityinsights/v20220701preview:NrtAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:NrtAlertRule to guarantee forwards compatibility.")
        return new NrtAlertRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220701preview:NrtAlertRule';
     ...
     */
    public readonly alertDetailsOverride!: pulumi.Output<outputs.securityinsights.v20220701preview.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    public readonly entityMappings!: pulumi.Output<outputs.securityinsights.v20220701preview.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    public readonly incidentConfiguration!: pulumi.Output<outputs.securityinsights.v20220701preview.IncidentConfigurationResponse | undefined>;
    /**
...
export interface NrtAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<inputs.securityinsights.v20220701preview.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220701preview.EntityMappingArgs>[]>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20220701preview.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'NRT'.
     */
     ...
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | enums.securityinsights.v20220701preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220701preview.AttackTactic>[]>;
    /**
     * The techniques of the alert rule
     */
