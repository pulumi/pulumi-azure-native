 ...
 *
 * const mtpDataConnector = new azure_native.securityinsights.v20220701preview.MTPDataConnector("mtpDataConnector", {
...
export class MTPDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220701preview:MTPDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20220701preview.MTPDataConnectorDataTypesResponse>;
    /**
...
export interface MTPDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20220701preview.MTPDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftThreatProtection'.
     */
