 ...
 *
 * @deprecated azure-native:securityinsights/v20220701preview:Anomalies is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Anomalies to guarantee forwards compatibility.
 */
export class Anomalies extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Anomalies {
        pulumi.log.warn("Anomalies is deprecated: azure-native:securityinsights/v20220701preview:Anomalies is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Anomalies to guarantee forwards compatibility.")
        return new Anomalies(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220701preview:Anomalies';
