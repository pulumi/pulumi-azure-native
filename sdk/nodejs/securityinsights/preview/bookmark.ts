...
export class Bookmark extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:Bookmark';
     ...
     */
    public readonly incidentInfo!: pulumi.Output<outputs.securityinsights.preview.IncidentInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: BookmarkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:Bookmark" }] };
...
export interface BookmarkArgs {
     ...
     * Describes an incident that relates to bookmark
     */
    readonly incidentInfo?: pulumi.Input<inputs.securityinsights.preview.IncidentInfo>;
    /**
     * List of labels relevant to this bookmark
     */
