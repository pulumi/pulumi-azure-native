...
export class CaseRelation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:CaseRelation';
    ...
    constructor(name: string, args: CaseRelationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:CaseRelation" }] };
...
export interface CaseRelationArgs {
     ...
     */
    readonly sourceRelationNode?: pulumi.Input<inputs.securityinsights.preview.RelationNode>;
    /**
     * Relation target node
     */
    readonly targetRelationNode?: pulumi.Input<inputs.securityinsights.preview.RelationNode>;
    /**
