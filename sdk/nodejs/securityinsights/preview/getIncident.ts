...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:securityinsights/preview:getIncident", {
...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: outputs.securityinsights.preview.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: outputs.securityinsights.preview.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: outputs.securityinsights.preview.IncidentOwnerInfoResponse;
    /**
