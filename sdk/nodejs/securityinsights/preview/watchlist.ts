...
export class Watchlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:Watchlist';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.preview.UserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<outputs.securityinsights.preview.UserInfoResponse | undefined>;
    /**
     * List of watchlist items.
     */
    public readonly watchlistItems!: pulumi.Output<outputs.securityinsights.preview.WatchlistItemResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: WatchlistArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:Watchlist" }] };
...
export interface WatchlistArgs {
     ...
     * Describes a user that created the watchlist
     */
    readonly createdBy?: pulumi.Input<inputs.securityinsights.preview.UserInfo>;
    /**
     * The time the watchlist was created
     */
     ...
     * Describes a user that updated the watchlist
     */
    readonly updatedBy?: pulumi.Input<inputs.securityinsights.preview.UserInfo>;
    /**
     * Watchlist Alias
     */
     ...
     * List of watchlist items.
     */
    readonly watchlistItems?: pulumi.Input<pulumi.Input<inputs.securityinsights.preview.WatchlistItem>[]>;
    /**
     * The type of the watchlist
     */
