...
export class IncidentRelation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:IncidentRelation';
    ...
    constructor(name: string, args: IncidentRelationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:IncidentRelation" }] };
