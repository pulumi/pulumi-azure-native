...
export class Case extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:Case';
     ...
     */
    public readonly owner!: pulumi.Output<outputs.securityinsights.preview.UserInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: CaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:Case" }] };
...
export interface CaseArgs {
     ...
     * Describes a user that the case is assigned to
     */
    readonly owner?: pulumi.Input<inputs.securityinsights.preview.UserInfo>;
    /**
