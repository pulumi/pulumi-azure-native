...
export class ThreatIntelligenceIndicator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:ThreatIntelligenceIndicator';
    ...
    constructor(name: string, args: ThreatIntelligenceIndicatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:ThreatIntelligenceIndicator" }] };
...
export interface ThreatIntelligenceIndicatorArgs {
     ...
     * Granular Markings
     */
    readonly granularMarkings?: pulumi.Input<pulumi.Input<inputs.securityinsights.preview.ThreatIntelligenceGranularMarkingModel>[]>;
    /**
     ...
     * Kill chain phases
     */
    readonly killChainPhases?: pulumi.Input<pulumi.Input<inputs.securityinsights.preview.ThreatIntelligenceKillChainPhase>[]>;
    /**
     * The kind of the entity.
     */
