...
export function getWatchlist(args: GetWatchlistArgs, opts?: pulumi.InvokeOptions): Promise<GetWatchlistResult> {
    ...
    return pulumi.runtime.invoke("azurerm:securityinsights/preview:getWatchlist", {
...
export interface GetWatchlistResult {
     ...
     */
    readonly watchlistItems?: outputs.securityinsights.preview.WatchlistItemResponse[];
    /**
