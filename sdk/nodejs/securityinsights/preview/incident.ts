...
export class Incident extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:Incident';
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<outputs.securityinsights.preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<outputs.securityinsights.preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<outputs.securityinsights.preview.IncidentOwnerInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: IncidentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:Incident" }] };
...
export interface IncidentArgs {
     ...
     * List of labels relevant to this incident
     */
    readonly labels?: pulumi.Input<pulumi.Input<inputs.securityinsights.preview.IncidentLabel>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    readonly owner?: pulumi.Input<inputs.securityinsights.preview.IncidentOwnerInfo>;
    /**
