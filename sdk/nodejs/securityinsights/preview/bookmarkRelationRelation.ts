...
export class BookmarkRelationRelation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:BookmarkRelationRelation';
    ...
    constructor(name: string, argsOrState?: BookmarkRelationRelationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:BookmarkRelationRelation" }] };
