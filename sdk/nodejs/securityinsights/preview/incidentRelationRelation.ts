...
export class IncidentRelationRelation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:IncidentRelationRelation';
    ...
    constructor(name: string, argsOrState?: IncidentRelationRelationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:IncidentRelationRelation" }] };
