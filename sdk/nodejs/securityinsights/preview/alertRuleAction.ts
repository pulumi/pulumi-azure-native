...
export class AlertRuleAction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:securityinsights/preview:AlertRuleAction';
    ...
    constructor(name: string, args: AlertRuleActionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:securityinsights/v20190101preview:AlertRuleAction" }] };
