...
export class MDATPDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210901preview:MDATPDataConnector';
    ...
    constructor(name: string, args: MDATPDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["kind"] = "MicrosoftDefenderAdvancedThreatProtection";
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:MDATPDataConnector" }, { type: "azure-native:securityinsights/v20190101preview:MDATPDataConnector" }, { type: "azure-native:securityinsights/v20200101:MDATPDataConnector" }, { type: "azure-native:securityinsights/v20210301preview:MDATPDataConnector" }] };
