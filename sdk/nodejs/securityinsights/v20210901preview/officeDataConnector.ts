...
export class OfficeDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OfficeDataConnector {
        pulumi.log.warn("OfficeDataConnector is deprecated: azure-native:securityinsights/v20210901preview:OfficeDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:OfficeDataConnector to guarantee forwards compatibility.")
