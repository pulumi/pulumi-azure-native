...
export class EntityQuery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210901preview:EntityQuery';
    ...
    constructor(name: string, args: EntityQueryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:EntityQuery" }, { type: "azure-native:securityinsights/v20210301preview:EntityQuery" }, { type: "azure-native:securityinsights/v20211001preview:EntityQuery" }, { type: "azure-native:securityinsights/v20220101preview:EntityQuery" }] };
