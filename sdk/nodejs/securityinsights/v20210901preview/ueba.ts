 ...
 *
 * const ueba = new azure_native.securityinsights.v20210901preview.Ueba("ueba", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:securityinsights/v20210901preview:Ueba EyesOn /subscriptions/bd794837-4d29-4647-9105-6339bfdb4e6a/resourceGroups/mms-eus/providers/Microsoft.OperationalInsights/workspaces/avdvirInt/providers/Microsoft.SecurityInsights/settings/EyesOn 
 * ```
 */
export class Ueba extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210901preview:Ueba';
