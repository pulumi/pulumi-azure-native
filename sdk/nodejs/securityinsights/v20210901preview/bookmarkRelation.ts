...
export class BookmarkRelation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BookmarkRelation {
        pulumi.log.warn("BookmarkRelation is deprecated: azure-native:securityinsights/v20210901preview:BookmarkRelation is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:BookmarkRelation to guarantee forwards compatibility.")
