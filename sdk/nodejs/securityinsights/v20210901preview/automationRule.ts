...
export class AutomationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210901preview:AutomationRule';
     ...
     */
    public readonly actions!: pulumi.Output<(outputs.securityinsights.v20210901preview.AutomationRuleModifyPropertiesActionResponse | outputs.securityinsights.v20210901preview.AutomationRuleRunPlaybookActionResponse)[]>;
    /**
     * Describes the client that created the automation rule
     */
    public /*out*/ readonly createdBy!: pulumi.Output<outputs.securityinsights.v20210901preview.ClientInfoResponse>;
    /**
     ...
     */
    public /*out*/ readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20210901preview.ClientInfoResponse>;
    /**
     ...
     */
    public readonly triggeringLogic!: pulumi.Output<outputs.securityinsights.v20210901preview.AutomationRuleTriggeringLogicResponse>;
    /**
    ...
    constructor(name: string, args: AutomationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:AutomationRule" }, { type: "azure-native:securityinsights/v20190101preview:AutomationRule" }, { type: "azure-native:securityinsights/v20211001preview:AutomationRule" }] };
