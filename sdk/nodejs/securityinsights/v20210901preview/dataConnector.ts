...
export class DataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210901preview:DataConnector';
    ...
    constructor(name: string, args: DataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:DataConnector" }, { type: "azure-native:securityinsights/v20190101preview:DataConnector" }, { type: "azure-native:securityinsights/v20200101:DataConnector" }, { type: "azure-native:securityinsights/v20210301preview:DataConnector" }, { type: "azure-native:securityinsights/v20211001preview:DataConnector" }] };
