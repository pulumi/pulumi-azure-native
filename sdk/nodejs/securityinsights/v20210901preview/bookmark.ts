 ...
 *
 * @deprecated azure-native:securityinsights/v20210901preview:Bookmark is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.
 */
export class Bookmark extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Bookmark {
        pulumi.log.warn("Bookmark is deprecated: azure-native:securityinsights/v20210901preview:Bookmark is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.")
        return new Bookmark(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210901preview:Bookmark';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20210901preview.UserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly incidentInfo!: pulumi.Output<outputs.securityinsights.v20210901preview.IncidentInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<outputs.securityinsights.v20210901preview.UserInfoResponse | undefined>;
