 ...
 *
 * @deprecated azure-native:securityinsights/v20210901preview:IncidentRelation is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:IncidentRelation to guarantee forwards compatibility.
 */
export class IncidentRelation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IncidentRelation {
        pulumi.log.warn("IncidentRelation is deprecated: azure-native:securityinsights/v20210901preview:IncidentRelation is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:IncidentRelation to guarantee forwards compatibility.")
        return new IncidentRelation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20210901preview:IncidentRelation';
