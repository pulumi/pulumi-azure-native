...
export class TIDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TIDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20200101:TIDataConnector" }, { type: "azure-native:securityinsights:TIDataConnector" }, { type: "azure-nextgen:securityinsights:TIDataConnector" }] };
...
export interface TIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes?: pulumi.Input<inputs.securityinsights.v20200101.TIDataConnectorDataTypesArgs>;
    /**
     * Etag of the azure resource
     */
