...
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20200101:ScheduledAlertRule';
    ...
    constructor(name: string, args: ScheduledAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20200101:ScheduledAlertRule" }, { type: "azure-native:securityinsights:ScheduledAlertRule" }, { type: "azure-nextgen:securityinsights:ScheduledAlertRule" }] };
...
export interface ScheduledAlertRuleArgs {
     ...
     * The severity for alerts created by this alert rule.
     */
    readonly severity: pulumi.Input<string | enums.securityinsights.v20200101.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    readonly tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20200101.AttackTactic>[]>;
    /**
     * The operation against the threshold that triggers alert rule.
     */
    readonly triggerOperator: pulumi.Input<enums.securityinsights.v20200101.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
