...
export function getScheduledAlertRule(args: GetScheduledAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledAlertRuleResult> {
    pulumi.log.warn("getScheduledAlertRule is deprecated: azure-native:securityinsights/v20200101:ScheduledAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:ScheduledAlertRule to guarantee forwards compatibility.")
