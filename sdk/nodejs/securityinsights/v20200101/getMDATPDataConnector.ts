 ...
 */
/** @deprecated azure-native:securityinsights/v20200101:MDATPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:MDATPDataConnector to guarantee forwards compatibility. */
export function getMDATPDataConnector(args: GetMDATPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMDATPDataConnectorResult> {
    pulumi.log.warn("getMDATPDataConnector is deprecated: azure-native:securityinsights/v20200101:MDATPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:MDATPDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20200101:getMDATPDataConnector", {
