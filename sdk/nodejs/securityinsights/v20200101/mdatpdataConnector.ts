...
export class MDATPDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MDATPDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20200101:MDATPDataConnector" }, { type: "azure-native:securityinsights:MDATPDataConnector" }, { type: "azure-nextgen:securityinsights:MDATPDataConnector" }] };
