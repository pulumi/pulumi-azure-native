...
export class AADDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20200101:AADDataConnector';
    ...
    constructor(name: string, args: AADDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20200101:AADDataConnector" }, { type: "azure-native:securityinsights:AADDataConnector" }, { type: "azure-nextgen:securityinsights:AADDataConnector" }] };
