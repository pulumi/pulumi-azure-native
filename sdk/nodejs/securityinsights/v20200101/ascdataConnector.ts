...
export class ASCDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ASCDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20200101:ASCDataConnector" }, { type: "azure-native:securityinsights:ASCDataConnector" }, { type: "azure-nextgen:securityinsights:ASCDataConnector" }] };
