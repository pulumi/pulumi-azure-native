...
export class AATPDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AATPDataConnector {
        pulumi.log.warn("AATPDataConnector is deprecated: azure-native:securityinsights/v20200101:AATPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:AATPDataConnector to guarantee forwards compatibility.")
