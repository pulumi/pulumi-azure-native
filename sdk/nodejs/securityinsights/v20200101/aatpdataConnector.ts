...
export class AATPDataConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AATPDataConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20200101:AATPDataConnector" }, { type: "azure-native:securityinsights:AATPDataConnector" }, { type: "azure-nextgen:securityinsights:AATPDataConnector" }] };
...
export interface AATPDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    readonly dataTypes?: pulumi.Input<inputs.securityinsights.v20200101.AlertsDataTypeOfDataConnectorArgs>;
    /**
     * Etag of the azure resource
     */
