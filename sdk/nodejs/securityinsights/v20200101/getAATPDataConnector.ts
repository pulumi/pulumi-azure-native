...
export function getAATPDataConnector(args: GetAATPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetAATPDataConnectorResult> {
    pulumi.log.warn("getAATPDataConnector is deprecated: azure-native:securityinsights/v20200101:AATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:AATPDataConnector to guarantee forwards compatibility.")
