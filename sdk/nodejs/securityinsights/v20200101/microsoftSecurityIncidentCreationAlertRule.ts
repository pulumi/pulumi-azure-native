...
export class MicrosoftSecurityIncidentCreationAlertRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MicrosoftSecurityIncidentCreationAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20200101:MicrosoftSecurityIncidentCreationAlertRule" }, { type: "azure-native:securityinsights:MicrosoftSecurityIncidentCreationAlertRule" }, { type: "azure-nextgen:securityinsights:MicrosoftSecurityIncidentCreationAlertRule" }, { type: "azure-native:securityinsights/v20190101preview:MicrosoftSecurityIncidentCreationAlertRule" }, { type: "azure-nextgen:securityinsights/v20190101preview:MicrosoftSecurityIncidentCreationAlertRule" }] };
