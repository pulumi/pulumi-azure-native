...
export class IncidentTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20240901:IncidentTask';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20240901.ClientInfoResponse | undefined>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public readonly lastModifiedBy!: pulumi.Output<outputs.securityinsights.v20240901.ClientInfoResponse | undefined>;
    /**
...
export interface IncidentTaskArgs {
     ...
     * Information on the client (user or application) that made some action
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20240901.ClientInfoArgs>;
    /**
     * The description of the task
     */
     ...
     * Information on the client (user or application) that made some action
     */
    lastModifiedBy?: pulumi.Input<inputs.securityinsights.v20240901.ClientInfoArgs>;
    /**
     ...
     * The status of the task
     */
    status: pulumi.Input<string | enums.securityinsights.v20240901.IncidentTaskStatus>;
    /**
     * The title of the task
     */
