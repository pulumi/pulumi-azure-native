...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20240901:getIncident", {
...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: outputs.securityinsights.v20240901.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: outputs.securityinsights.v20240901.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: outputs.securityinsights.v20240901.IncidentOwnerInfoResponse;
    /**
     ...
     */
    readonly systemData: outputs.securityinsights.v20240901.SystemDataResponse;
    /**
...
export function getIncidentOutput(args: GetIncidentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncidentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20240901:getIncident", {
        "incidentId": args.incidentId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
