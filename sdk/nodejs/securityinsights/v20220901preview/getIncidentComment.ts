...
export function getIncidentComment(args: GetIncidentCommentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentCommentResult> {
    pulumi.log.warn("getIncidentComment is deprecated: azure-native:securityinsights/v20220901preview:IncidentComment is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:IncidentComment to guarantee forwards compatibility.")
