...
export class AwsS3DataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AwsS3DataConnector {
        pulumi.log.warn("AwsS3DataConnector is deprecated: azure-native:securityinsights/v20220901preview:AwsS3DataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:AwsS3DataConnector to guarantee forwards compatibility.")
        return new AwsS3DataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220901preview:AwsS3DataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20220901preview.AwsS3DataConnectorDataTypesResponse>;
    /**
...
export interface AwsS3DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20220901preview.AwsS3DataConnectorDataTypesArgs>;
    /**
     * The logs destination table name in LogAnalytics.
     */
