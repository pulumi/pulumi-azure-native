...
export function getTiTaxiiDataConnector(args: GetTiTaxiiDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetTiTaxiiDataConnectorResult> {
    pulumi.log.warn("getTiTaxiiDataConnector is deprecated: azure-native:securityinsights/v20220901preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:TiTaxiiDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20220901preview:getTiTaxiiDataConnector", {
...
export interface GetTiTaxiiDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20220901preview.TiTaxiiDataConnectorDataTypesResponse;
    /**
