 ...
 *
 * @deprecated azure-native:securityinsights/v20220901preview:OfficeDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:OfficeDataConnector to guarantee forwards compatibility.
 */
export class OfficeDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OfficeDataConnector {
        pulumi.log.warn("OfficeDataConnector is deprecated: azure-native:securityinsights/v20220901preview:OfficeDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:OfficeDataConnector to guarantee forwards compatibility.")
        return new OfficeDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220901preview:OfficeDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20220901preview.OfficeDataConnectorDataTypesResponse>;
    /**
...
export interface OfficeDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20220901preview.OfficeDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Office365'.
     */
