 ...
 *
 * @deprecated azure-native:securityinsights/v20220901preview:CodelessApiPollingDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:CodelessApiPollingDataConnector to guarantee forwards compatibility.
 */
export class CodelessApiPollingDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CodelessApiPollingDataConnector {
        pulumi.log.warn("CodelessApiPollingDataConnector is deprecated: azure-native:securityinsights/v20220901preview:CodelessApiPollingDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:CodelessApiPollingDataConnector to guarantee forwards compatibility.")
        return new CodelessApiPollingDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220901preview:CodelessApiPollingDataConnector';
     ...
     */
    public readonly connectorUiConfig!: pulumi.Output<outputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly pollingConfig!: pulumi.Output<outputs.securityinsights.v20220901preview.CodelessConnectorPollingConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessApiPollingDataConnectorArgs {
     ...
     * Config to describe the instructions blade
     */
    connectorUiConfig?: pulumi.Input<inputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesArgs>;
    /**
     * Connector ID
     */
     ...
     * Config to describe the polling instructions
     */
    pollingConfig?: pulumi.Input<inputs.securityinsights.v20220901preview.CodelessConnectorPollingConfigPropertiesArgs>;
    /**
