 ...
 *
 * @deprecated azure-native:securityinsights/v20220901preview:Watchlist is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.
 */
export class Watchlist extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Watchlist {
        pulumi.log.warn("Watchlist is deprecated: azure-native:securityinsights/v20220901preview:Watchlist is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.")
        return new Watchlist(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220901preview:Watchlist';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20220901preview.WatchlistUserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<outputs.securityinsights.v20220901preview.WatchlistUserInfoResponse | undefined>;
    /**
...
export interface WatchlistArgs {
     ...
     * Describes a user that created the watchlist
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20220901preview.WatchlistUserInfoArgs>;
    /**
     * The default duration of a watchlist (in ISO 8601 duration format)
     */
     ...
     * The sourceType of the watchlist
     */
    sourceType?: pulumi.Input<string | enums.securityinsights.v20220901preview.SourceType>;
    /**
     * The tenantId where the watchlist belongs to
     */
     ...
     * Describes a user that updated the watchlist
     */
    updatedBy?: pulumi.Input<inputs.securityinsights.v20220901preview.WatchlistUserInfoArgs>;
    /**
     * The status of the Watchlist upload : New, InProgress or Complete. Pls note : When a Watchlist upload status is equal to InProgress, the Watchlist cannot be deleted
     */
