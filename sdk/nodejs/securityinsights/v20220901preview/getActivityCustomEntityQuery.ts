...
export function getActivityCustomEntityQuery(args: GetActivityCustomEntityQueryArgs, opts?: pulumi.InvokeOptions): Promise<GetActivityCustomEntityQueryResult> {
    pulumi.log.warn("getActivityCustomEntityQuery is deprecated: azure-native:securityinsights/v20220901preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ActivityCustomEntityQuery to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20220901preview:getActivityCustomEntityQuery", {
...
export interface GetActivityCustomEntityQueryResult {
     ...
     */
    readonly queryDefinitions?: outputs.securityinsights.v20220901preview.ActivityEntityQueriesPropertiesResponseQueryDefinitions;
    /**
