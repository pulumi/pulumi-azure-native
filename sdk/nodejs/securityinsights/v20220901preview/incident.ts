 ...
 *
 * @deprecated azure-native:securityinsights/v20220901preview:Incident is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.
 */
export class Incident extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Incident {
        pulumi.log.warn("Incident is deprecated: azure-native:securityinsights/v20220901preview:Incident is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.")
        return new Incident(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220901preview:Incident';
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<outputs.securityinsights.v20220901preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<outputs.securityinsights.v20220901preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<outputs.securityinsights.v20220901preview.IncidentOwnerInfoResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly teamInformation!: pulumi.Output<outputs.securityinsights.v20220901preview.TeamInformationResponse | undefined>;
    /**
