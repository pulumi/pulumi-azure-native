 ...
 * Gets a file import.
 */
/** @deprecated azure-native:securityinsights/v20220901preview:FileImport is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:FileImport to guarantee forwards compatibility. */
export function getFileImport(args: GetFileImportArgs, opts?: pulumi.InvokeOptions): Promise<GetFileImportResult> {
    pulumi.log.warn("getFileImport is deprecated: azure-native:securityinsights/v20220901preview:FileImport is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:FileImport to guarantee forwards compatibility.")
...
export interface GetFileImportResult {
     ...
     */
    readonly errorFile: outputs.securityinsights.v20220901preview.FileMetadataResponse;
    /**
     * An ordered list of some of the errors that were encountered during validation.
     */
    readonly errorsPreview: outputs.securityinsights.v20220901preview.ValidationErrorResponse[];
    /**
     ...
     */
    readonly importFile: outputs.securityinsights.v20220901preview.FileMetadataResponse;
    /**
