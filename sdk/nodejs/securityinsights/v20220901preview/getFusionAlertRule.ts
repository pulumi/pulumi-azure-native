...
export function getFusionAlertRule(args: GetFusionAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetFusionAlertRuleResult> {
    pulumi.log.warn("getFusionAlertRule is deprecated: azure-native:securityinsights/v20220901preview:FusionAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:FusionAlertRule to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20220901preview:getFusionAlertRule", {
...
export interface GetFusionAlertRuleResult {
     ...
     */
    readonly scenarioExclusionPatterns?: outputs.securityinsights.v20220901preview.FusionScenarioExclusionPatternResponse[];
    /**
     ...
     */
    readonly sourceSettings?: outputs.securityinsights.v20220901preview.FusionSourceSettingsResponse[];
    /**
