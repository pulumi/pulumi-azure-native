...
export interface GetCodelessApiPollingDataConnectorResult {
     ...
     */
    readonly connectorUiConfig?: outputs.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesResponse;
    /**
     ...
     */
    readonly pollingConfig?: outputs.securityinsights.v20220901preview.CodelessConnectorPollingConfigPropertiesResponse;
    /**
...
export function getCodelessApiPollingDataConnectorOutput(args: GetCodelessApiPollingDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCodelessApiPollingDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20220901preview:getCodelessApiPollingDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
