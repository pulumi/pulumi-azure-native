...
export class AATPDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AATPDataConnector {
        pulumi.log.warn("AATPDataConnector is deprecated: azure-native:securityinsights/v20220901preview:AATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AATPDataConnector to guarantee forwards compatibility.")
        return new AATPDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220901preview:AATPDataConnector';
