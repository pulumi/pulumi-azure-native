 ...
 *
 * @deprecated azure-native:securityinsights/v20220901preview:OfficePowerBIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:OfficePowerBIDataConnector to guarantee forwards compatibility.
 */
export class OfficePowerBIDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OfficePowerBIDataConnector {
        pulumi.log.warn("OfficePowerBIDataConnector is deprecated: azure-native:securityinsights/v20220901preview:OfficePowerBIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:OfficePowerBIDataConnector to guarantee forwards compatibility.")
        return new OfficePowerBIDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220901preview:OfficePowerBIDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20220901preview.OfficePowerBIConnectorDataTypesResponse>;
    /**
...
export interface OfficePowerBIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20220901preview.OfficePowerBIConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'OfficePowerBI'.
     */
