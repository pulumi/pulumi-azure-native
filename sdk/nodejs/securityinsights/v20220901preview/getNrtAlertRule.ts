...
export function getNrtAlertRule(args: GetNrtAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetNrtAlertRuleResult> {
    pulumi.log.warn("getNrtAlertRule is deprecated: azure-native:securityinsights/v20220901preview:NrtAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:NrtAlertRule to guarantee forwards compatibility.")
