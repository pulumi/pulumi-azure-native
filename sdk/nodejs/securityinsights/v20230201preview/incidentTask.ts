...
export class IncidentTask extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IncidentTask {
        pulumi.log.warn("IncidentTask is deprecated: azure-native:securityinsights/v20230201preview:IncidentTask is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:IncidentTask to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: IncidentTaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/v20221201preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230401preview:IncidentTask" }] };
