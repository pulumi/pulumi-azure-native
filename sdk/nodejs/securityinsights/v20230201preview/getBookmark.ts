...
export function getBookmark(args: GetBookmarkArgs, opts?: pulumi.InvokeOptions): Promise<GetBookmarkResult> {
    pulumi.log.warn("getBookmark is deprecated: azure-native:securityinsights/v20230201preview:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Bookmark to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230201preview:getBookmark", {
...
export interface GetBookmarkResult {
     ...
     */
    readonly createdBy?: outputs.securityinsights.v20230201preview.UserInfoResponse;
    /**
     ...
     */
    readonly entityMappings?: outputs.securityinsights.v20230201preview.BookmarkEntityMappingsResponse[];
    /**
     ...
     */
    readonly incidentInfo?: outputs.securityinsights.v20230201preview.IncidentInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: outputs.securityinsights.v20230201preview.UserInfoResponse;
}
/**
 * Gets a bookmark.
 */
