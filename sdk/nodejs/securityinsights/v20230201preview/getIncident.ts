...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: outputs.securityinsights.v20230201preview.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: outputs.securityinsights.v20230201preview.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: outputs.securityinsights.v20230201preview.IncidentOwnerInfoResponse;
    /**
     ...
     */
    readonly teamInformation?: outputs.securityinsights.v20230201preview.TeamInformationResponse;
    /**
...
export function getIncidentOutput(args: GetIncidentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncidentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20230201preview:getIncident", {
        "incidentId": args.incidentId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
