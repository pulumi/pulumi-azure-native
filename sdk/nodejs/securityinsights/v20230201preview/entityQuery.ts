...
export class EntityQuery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201preview:EntityQuery';
...
export interface EntityQueryArgs {
     ...
     * the entity query kind
     */
    kind: pulumi.Input<string | enums.securityinsights.v20230201preview.CustomEntityQueryKind>;
    /**
