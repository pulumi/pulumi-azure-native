...
export class ASCDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ASCDataConnector {
        pulumi.log.warn("ASCDataConnector is deprecated: azure-native:securityinsights/v20230201preview:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ASCDataConnector to guarantee forwards compatibility.")
