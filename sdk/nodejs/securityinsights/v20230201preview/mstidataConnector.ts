...
export class MSTIDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201preview:MSTIDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20230201preview.MSTIDataConnectorDataTypesResponse>;
    /**
...
export interface MSTIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<inputs.securityinsights.v20230201preview.MSTIDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftThreatIntelligence'.
     */
