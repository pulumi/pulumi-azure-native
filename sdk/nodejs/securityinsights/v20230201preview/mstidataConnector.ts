...
export class MSTIDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MSTIDataConnector {
        pulumi.log.warn("MSTIDataConnector is deprecated: azure-native:securityinsights/v20230201preview:MSTIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MSTIDataConnector to guarantee forwards compatibility.")
