...
export function getMDATPDataConnector(args: GetMDATPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMDATPDataConnectorResult> {
    pulumi.log.warn("getMDATPDataConnector is deprecated: azure-native:securityinsights/v20230201preview:MDATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MDATPDataConnector to guarantee forwards compatibility.")
