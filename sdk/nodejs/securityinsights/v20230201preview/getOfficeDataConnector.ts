...
export function getOfficeDataConnector(args: GetOfficeDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOfficeDataConnectorResult> {
    pulumi.log.warn("getOfficeDataConnector is deprecated: azure-native:securityinsights/v20230201preview:OfficeDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:OfficeDataConnector to guarantee forwards compatibility.")
