 ...
 *
 * @deprecated azure-native:securityinsights/v20230201preview:AADDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AADDataConnector to guarantee forwards compatibility.
 */
export class AADDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AADDataConnector {
        pulumi.log.warn("AADDataConnector is deprecated: azure-native:securityinsights/v20230201preview:AADDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AADDataConnector to guarantee forwards compatibility.")
        return new AADDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201preview:AADDataConnector';
