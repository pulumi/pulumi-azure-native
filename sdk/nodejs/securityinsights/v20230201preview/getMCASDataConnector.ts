...
export function getMCASDataConnector(args: GetMCASDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMCASDataConnectorResult> {
    pulumi.log.warn("getMCASDataConnector is deprecated: azure-native:securityinsights/v20230201preview:MCASDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MCASDataConnector to guarantee forwards compatibility.")
