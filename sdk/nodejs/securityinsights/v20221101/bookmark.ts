 ...
 *
 * @deprecated azure-native:securityinsights/v20221101:Bookmark is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.
 */
export class Bookmark extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Bookmark {
        pulumi.log.warn("Bookmark is deprecated: azure-native:securityinsights/v20221101:Bookmark is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.")
        return new Bookmark(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101:Bookmark';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20221101.UserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly incidentInfo!: pulumi.Output<outputs.securityinsights.v20221101.IncidentInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<outputs.securityinsights.v20221101.UserInfoResponse | undefined>;
...
export interface BookmarkArgs {
     ...
     * Describes a user that created the bookmark
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20221101.UserInfoArgs>;
    /**
     * The display name of the bookmark
     */
     ...
     * Describes an incident that relates to bookmark
     */
    incidentInfo?: pulumi.Input<inputs.securityinsights.v20221101.IncidentInfoArgs>;
    /**
     * List of labels relevant to this bookmark
     */
     ...
     * Describes a user that updated the bookmark
     */
    updatedBy?: pulumi.Input<inputs.securityinsights.v20221101.UserInfoArgs>;
    /**
