...
export function getAnomalySecurityMLAnalyticsSettings(args: GetAnomalySecurityMLAnalyticsSettingsArgs, opts?: pulumi.InvokeOptions): Promise<GetAnomalySecurityMLAnalyticsSettingsResult> {
    pulumi.log.warn("getAnomalySecurityMLAnalyticsSettings is deprecated: azure-native:securityinsights/v20221101:AnomalySecurityMLAnalyticsSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:AnomalySecurityMLAnalyticsSettings to guarantee forwards compatibility.")
...
export interface GetAnomalySecurityMLAnalyticsSettingsResult {
     ...
     */
    readonly requiredDataConnectors?: outputs.securityinsights.v20221101.SecurityMLAnalyticsSettingsDataSourceResponse[];
    /**
