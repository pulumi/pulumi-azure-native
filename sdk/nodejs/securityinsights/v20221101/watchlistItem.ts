...
export class WatchlistItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WatchlistItem {
        pulumi.log.warn("WatchlistItem is deprecated: azure-native:securityinsights/v20221101:WatchlistItem is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:WatchlistItem to guarantee forwards compatibility.")
        return new WatchlistItem(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101:WatchlistItem';
     ...
     */
    public readonly createdBy!: pulumi.Output<outputs.securityinsights.v20221101.WatchlistUserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<outputs.securityinsights.v20221101.WatchlistUserInfoResponse | undefined>;
    /**
...
export interface WatchlistItemArgs {
     ...
     * Describes a user that created the watchlist item
     */
    createdBy?: pulumi.Input<inputs.securityinsights.v20221101.WatchlistUserInfoArgs>;
    /**
     * key-value pairs for a watchlist item entity mapping
     */
    entityMapping?: any;
     ...
     * Describes a user that updated the watchlist item
     */
    updatedBy?: pulumi.Input<inputs.securityinsights.v20221101.WatchlistUserInfoArgs>;
    /**
     * The watchlist alias
     */
