 ...
 *
 * @deprecated azure-native:securityinsights/v20221101:AnomalySecurityMLAnalyticsSettings is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AnomalySecurityMLAnalyticsSettings to guarantee forwards compatibility.
 */
export class AnomalySecurityMLAnalyticsSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AnomalySecurityMLAnalyticsSettings {
        pulumi.log.warn("AnomalySecurityMLAnalyticsSettings is deprecated: azure-native:securityinsights/v20221101:AnomalySecurityMLAnalyticsSettings is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AnomalySecurityMLAnalyticsSettings to guarantee forwards compatibility.")
        return new AnomalySecurityMLAnalyticsSettings(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101:AnomalySecurityMLAnalyticsSettings';
     ...
     */
    public readonly requiredDataConnectors!: pulumi.Output<outputs.securityinsights.v20221101.SecurityMLAnalyticsSettingsDataSourceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: AnomalySecurityMLAnalyticsSettingsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20220501preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20220601preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20220701preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20220801preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20220901preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20221001preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20221101preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20221201preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20230201:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20230201preview:AnomalySecurityMLAnalyticsSettings" }, { type: "azure-native:securityinsights/v20230401preview:AnomalySecurityMLAnalyticsSettings" }] };
...
export interface AnomalySecurityMLAnalyticsSettingsArgs {
     ...
     * The required data sources for this SecurityMLAnalyticsSettings
     */
    requiredDataConnectors?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20221101.SecurityMLAnalyticsSettingsDataSourceArgs>[]>;
    /**
     ...
     * The anomaly SecurityMLAnalyticsSettings status
     */
    settingsStatus: pulumi.Input<string | enums.securityinsights.v20221101.SettingsStatus>;
    /**
     * The tactics of the SecurityMLAnalyticsSettings
     */
    tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20221101.AttackTactic>[]>;
    /**
     * The techniques of the SecurityMLAnalyticsSettings
     */
