...
export class Watchlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101:Watchlist';
...
export interface WatchlistArgs {
     ...
     * The source of the watchlist
     */
    source: pulumi.Input<string | enums.securityinsights.v20221101.Source>;
    /**
     * The tenantId where the watchlist belongs to
     */
