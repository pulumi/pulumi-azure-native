 ...
 *
 * @deprecated azure-native:securityinsights/v20221101:MCASDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:MCASDataConnector to guarantee forwards compatibility.
 */
export class MCASDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MCASDataConnector {
        pulumi.log.warn("MCASDataConnector is deprecated: azure-native:securityinsights/v20221101:MCASDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:MCASDataConnector to guarantee forwards compatibility.")
        return new MCASDataConnector(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20221101:MCASDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20221101.MCASDataConnectorDataTypesResponse | undefined>;
    /**
...
export interface MCASDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes?: pulumi.Input<inputs.securityinsights.v20221101.MCASDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftCloudAppSecurity'.
     */
