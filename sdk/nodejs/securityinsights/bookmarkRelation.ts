...
export class BookmarkRelation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:securityinsights:BookmarkRelation';
    ...
    constructor(name: string, args: BookmarkRelationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityinsights/v20190101preview:BookmarkRelation" }] };
