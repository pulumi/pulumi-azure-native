...
export class ContentTemplate extends pulumi.CustomResource {
     ...
     */
    public readonly author!: pulumi.Output<outputs.securityinsights.v20231001preview.MetadataAuthorResponse | undefined>;
    /**
     * Categories for the item
     */
    public readonly categories!: pulumi.Output<outputs.securityinsights.v20231001preview.MetadataCategoriesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly dependantTemplates!: pulumi.Output<outputs.securityinsights.v20231001preview.TemplatePropertiesResponse[]>;
    /**
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    public readonly dependencies!: pulumi.Output<outputs.securityinsights.v20231001preview.MetadataDependenciesResponse | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.securityinsights.v20231001preview.MetadataSourceResponse>;
    /**
     * Support information for the template - type, name, contact information
     */
    public readonly support!: pulumi.Output<outputs.securityinsights.v20231001preview.MetadataSupportResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContentTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/v20230401preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230501preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230601preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230701preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230801preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230901preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20231101:ContentTemplate" }, { type: "azure-native:securityinsights/v20231201preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20240101preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20240301:ContentTemplate" }, { type: "azure-native:securityinsights/v20240401preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20240901:ContentTemplate" }, { type: "azure-native:securityinsights/v20241001preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20250101preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20250301:ContentTemplate" }, { type: "azure-native:securityinsights:ContentTemplate" }] };
...
export interface ContentTemplateArgs {
     ...
     * The creator of the content item.
     */
    author?: pulumi.Input<inputs.securityinsights.v20231001preview.MetadataAuthorArgs>;
    /**
     * Categories for the item
     */
    categories?: pulumi.Input<inputs.securityinsights.v20231001preview.MetadataCategoriesArgs>;
    /**
     * Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Dynamic for user-created.  This is the resource name
     */
     ...
     * The kind of content the template is for.
     */
    contentKind: pulumi.Input<string | enums.securityinsights.v20231001preview.Kind>;
    /**
     * Unique ID for the content. It should be generated based on the contentId of the package, contentId of the template, contentKind of the template and the contentVersion of the template
     */
     ...
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    dependencies?: pulumi.Input<inputs.securityinsights.v20231001preview.MetadataDependenciesArgs>;
    /**
     * The display name of the template
     */
     ...
     * the packageKind of the package contains this template
     */
    packageKind?: pulumi.Input<string | enums.securityinsights.v20231001preview.PackageKind>;
    /**
     * the name of the package contains this template
     */
     ...
     * Source of the content.  This is where/how it was created.
     */
    source: pulumi.Input<inputs.securityinsights.v20231001preview.MetadataSourceArgs>;
    /**
     * Support information for the template - type, name, contact information
     */
    support?: pulumi.Input<inputs.securityinsights.v20231001preview.MetadataSupportArgs>;
    /**
     * template Id
     */
