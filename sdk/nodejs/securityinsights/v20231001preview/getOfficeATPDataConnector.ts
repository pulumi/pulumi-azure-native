...
export interface GetOfficeATPDataConnectorResult {
     ...
     */
    readonly dataTypes?: outputs.securityinsights.v20231001preview.AlertsDataTypeOfDataConnectorResponse;
    /**
...
export function getOfficeATPDataConnectorOutput(args: GetOfficeATPDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOfficeATPDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20231001preview:getOfficeATPDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
