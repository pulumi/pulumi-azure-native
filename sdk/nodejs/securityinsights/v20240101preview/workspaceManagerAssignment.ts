...
export class WorkspaceManagerAssignment extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.securityinsights.v20240101preview.AssignmentItemResponse[]>;
    /**
...
export interface WorkspaceManagerAssignmentArgs {
     ...
     * List of resources included in this workspace manager assignment
     */
    items: pulumi.Input<pulumi.Input<inputs.securityinsights.v20240101preview.AssignmentItemArgs>[]>;
    /**
