...
export class ThreatIntelligenceAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20240101preview:ThreatIntelligenceAlertRule';
     ...
     */
    public /*out*/ readonly subTechniques!: pulumi.Output<string[]>;
    /**
    ...
    constructor(name: string, args: ThreatIntelligenceAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["subTechniques"] = undefined /*out*/;
