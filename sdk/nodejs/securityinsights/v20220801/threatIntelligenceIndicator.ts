...
export class ThreatIntelligenceIndicator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ThreatIntelligenceIndicator {
        pulumi.log.warn("ThreatIntelligenceIndicator is deprecated: azure-native:securityinsights/v20220801:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.")
