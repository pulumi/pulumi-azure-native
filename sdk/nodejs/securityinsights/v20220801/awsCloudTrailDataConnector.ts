 ...
 *
 * @deprecated azure-native:securityinsights/v20220801:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector to guarantee forwards compatibility.
 */
export class AwsCloudTrailDataConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AwsCloudTrailDataConnector {
        pulumi.log.warn("AwsCloudTrailDataConnector is deprecated: azure-native:securityinsights/v20220801:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector to guarantee forwards compatibility.")
