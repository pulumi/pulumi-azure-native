...
export function getTIDataConnector(args: GetTIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetTIDataConnectorResult> {
    pulumi.log.warn("getTIDataConnector is deprecated: azure-native:securityinsights/v20220801:TIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:TIDataConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:securityinsights/v20220801:getTIDataConnector", {
...
export interface GetTIDataConnectorResult {
     ...
     */
    readonly dataTypes?: outputs.securityinsights.v20220801.TIDataConnectorDataTypesResponse;
    /**
