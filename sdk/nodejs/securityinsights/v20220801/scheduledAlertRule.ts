...
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScheduledAlertRule {
        pulumi.log.warn("ScheduledAlertRule is deprecated: azure-native:securityinsights/v20220801:ScheduledAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ScheduledAlertRule to guarantee forwards compatibility.")
        return new ScheduledAlertRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220801:ScheduledAlertRule';
     ...
     */
    public readonly alertDetailsOverride!: pulumi.Output<outputs.securityinsights.v20220801.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    public readonly entityMappings!: pulumi.Output<outputs.securityinsights.v20220801.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    public readonly eventGroupingSettings!: pulumi.Output<outputs.securityinsights.v20220801.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    public readonly incidentConfiguration!: pulumi.Output<outputs.securityinsights.v20220801.IncidentConfigurationResponse | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<inputs.securityinsights.v20220801.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<inputs.securityinsights.v20220801.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<inputs.securityinsights.v20220801.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<inputs.securityinsights.v20220801.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | enums.securityinsights.v20220801.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    tactics?: pulumi.Input<pulumi.Input<string | enums.securityinsights.v20220801.AttackTactic>[]>;
    /**
     * The techniques of the alert rule
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<enums.securityinsights.v20220801.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */
