...
export class AADDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20240401preview:AADDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<outputs.securityinsights.v20240401preview.AlertsDataTypeOfDataConnectorResponse | undefined>;
    /**
...
export interface AADDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes?: pulumi.Input<inputs.securityinsights.v20240401preview.AlertsDataTypeOfDataConnectorArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'AzureActiveDirectory'.
     */
