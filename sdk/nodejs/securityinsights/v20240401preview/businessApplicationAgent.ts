...
export class BusinessApplicationAgent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BusinessApplicationAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:BusinessApplicationAgent" }, { type: "azure-native:securityinsights/v20241001preview:BusinessApplicationAgent" }] };
