...
export class BusinessApplicationAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20240401preview:BusinessApplicationAgent';
    ...
    public /*out*/ readonly agentSystems!: pulumi.Output<outputs.securityinsights.v20240401preview.AgentSystemResponse[]>;
    /**
     * Describes the configuration of a Business Application Agent.
     */
    public readonly configuration!: pulumi.Output<outputs.securityinsights.v20240401preview.SapAgentConfigurationResponse>;
    ...
    constructor(name: string, args: BusinessApplicationAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/v20241001preview:BusinessApplicationAgent" }, { type: "azure-native:securityinsights/v20250101preview:BusinessApplicationAgent" }, { type: "azure-native:securityinsights:BusinessApplicationAgent" }] };
