...
export class GCPDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20240401preview:GCPDataConnector';
     ...
     */
    public readonly auth!: pulumi.Output<outputs.securityinsights.v20240401preview.GCPAuthPropertiesResponse>;
    /**
     ...
     */
    public readonly request!: pulumi.Output<outputs.securityinsights.v20240401preview.GCPRequestPropertiesResponse>;
    /**
...
export interface GCPDataConnectorArgs {
     ...
     * The auth section of the connector.
     */
    auth: pulumi.Input<inputs.securityinsights.v20240401preview.GCPAuthPropertiesArgs>;
    /**
     * The name of the connector definition that represents the UI config.
     */
     ...
     * The request section of the connector.
     */
    request: pulumi.Input<inputs.securityinsights.v20240401preview.GCPRequestPropertiesArgs>;
    /**
