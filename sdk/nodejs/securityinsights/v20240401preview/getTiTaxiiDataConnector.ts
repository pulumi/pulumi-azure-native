...
export function getTiTaxiiDataConnector(args: GetTiTaxiiDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetTiTaxiiDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20240401preview:getTiTaxiiDataConnector", {
...
export interface GetTiTaxiiDataConnectorResult {
     ...
     */
    readonly dataTypes: outputs.securityinsights.v20240401preview.TiTaxiiDataConnectorDataTypesResponse;
    /**
...
export function getTiTaxiiDataConnectorOutput(args: GetTiTaxiiDataConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTiTaxiiDataConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20240401preview:getTiTaxiiDataConnector", {
        "dataConnectorId": args.dataConnectorId,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
