...
export function getContentTemplate(args: GetContentTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetContentTemplateResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20240401preview:getContentTemplate", {
...
export interface GetContentTemplateResult {
     ...
     */
    readonly author?: outputs.securityinsights.v20240401preview.MetadataAuthorResponse;
    /**
     * Categories for the item
     */
    readonly categories?: outputs.securityinsights.v20240401preview.MetadataCategoriesResponse;
    /**
     ...
     */
    readonly dependantTemplates: outputs.securityinsights.v20240401preview.TemplatePropertiesResponse[];
    /**
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    readonly dependencies?: outputs.securityinsights.v20240401preview.MetadataDependenciesResponse;
    /**
     ...
     */
    readonly source: outputs.securityinsights.v20240401preview.MetadataSourceResponse;
    /**
     * Support information for the template - type, name, contact information
     */
    readonly support?: outputs.securityinsights.v20240401preview.MetadataSupportResponse;
    /**
...
export function getContentTemplateOutput(args: GetContentTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContentTemplateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:securityinsights/v20240401preview:getContentTemplate", {
        "resourceGroupName": args.resourceGroupName,
        "templateId": args.templateId,
        "workspaceName": args.workspaceName,
    }, opts);
