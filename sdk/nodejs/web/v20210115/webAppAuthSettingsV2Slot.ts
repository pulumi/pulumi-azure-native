 ...
 *
 * @deprecated azure-native:web/v20210115:WebAppAuthSettingsV2Slot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:WebAppAuthSettingsV2Slot to guarantee forwards compatibility.
 */
export class WebAppAuthSettingsV2Slot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAuthSettingsV2Slot {
        pulumi.log.warn("WebAppAuthSettingsV2Slot is deprecated: azure-native:web/v20210115:WebAppAuthSettingsV2Slot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:WebAppAuthSettingsV2Slot to guarantee forwards compatibility.")
