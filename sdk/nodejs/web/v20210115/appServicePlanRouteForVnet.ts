...
export class AppServicePlanRouteForVnet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServicePlanRouteForVnet {
        pulumi.log.warn("AppServicePlanRouteForVnet is deprecated: azure-native:web/v20210115:AppServicePlanRouteForVnet is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServicePlanRouteForVnet to guarantee forwards compatibility.")
