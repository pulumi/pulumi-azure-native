...
export class KubeEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KubeEnvironment {
        pulumi.log.warn("KubeEnvironment is deprecated: azure-native:web/v20210115:KubeEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:KubeEnvironment to guarantee forwards compatibility.")
