...
export function getWebAppHostNameBindingSlot(args: GetWebAppHostNameBindingSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppHostNameBindingSlotResult> {
    pulumi.log.warn("getWebAppHostNameBindingSlot is deprecated: azure-native:web/v20210115:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHostNameBindingSlot to guarantee forwards compatibility.")
