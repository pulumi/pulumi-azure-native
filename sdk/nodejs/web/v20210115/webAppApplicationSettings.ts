 ...
 *
 * @deprecated azure-native:web/v20210115:WebAppApplicationSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppApplicationSettings to guarantee forwards compatibility.
 */
export class WebAppApplicationSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppApplicationSettings {
        pulumi.log.warn("WebAppApplicationSettings is deprecated: azure-native:web/v20210115:WebAppApplicationSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppApplicationSettings to guarantee forwards compatibility.")
