...
export class StaticSitePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210115:StaticSitePrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.web.v20210115.ArmIdWrapperResponse | undefined>;
    /**
     * The state of a private link connection
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.web.v20210115.PrivateLinkConnectionStateResponse | undefined>;
    ...
    constructor(name: string, args: StaticSitePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20210115:StaticSitePrivateEndpointConnection" }, { type: "azure-native:web:StaticSitePrivateEndpointConnection" }, { type: "azure-nextgen:web:StaticSitePrivateEndpointConnection" }, { type: "azure-native:web/v20201201:StaticSitePrivateEndpointConnection" }, { type: "azure-nextgen:web/v20201201:StaticSitePrivateEndpointConnection" }, { type: "azure-native:web/v20210101:StaticSitePrivateEndpointConnection" }, { type: "azure-nextgen:web/v20210101:StaticSitePrivateEndpointConnection" }, { type: "azure-native:web/v20210201:StaticSitePrivateEndpointConnection" }, { type: "azure-nextgen:web/v20210201:StaticSitePrivateEndpointConnection" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(StaticSitePrivateEndpointConnection.__pulumiType, name, inputs, opts);
    }
}
...
export interface StaticSitePrivateEndpointConnectionArgs {
     ...
     * The state of a private link connection
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.web.v20210115.PrivateLinkConnectionStateArgs>;
    /**
