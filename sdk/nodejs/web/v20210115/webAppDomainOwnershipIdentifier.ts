 ...
 *
 * @deprecated azure-native:web/v20210115:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.
 */
export class WebAppDomainOwnershipIdentifier extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppDomainOwnershipIdentifier {
        pulumi.log.warn("WebAppDomainOwnershipIdentifier is deprecated: azure-native:web/v20210115:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.")
