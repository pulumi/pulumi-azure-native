 ...
 *
 * @deprecated azure-native:web/v20210115:WebAppBackupConfigurationSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppBackupConfigurationSlot to guarantee forwards compatibility.
 */
export class WebAppBackupConfigurationSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppBackupConfigurationSlot {
        pulumi.log.warn("WebAppBackupConfigurationSlot is deprecated: azure-native:web/v20210115:WebAppBackupConfigurationSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppBackupConfigurationSlot to guarantee forwards compatibility.")
        return new WebAppBackupConfigurationSlot(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210115:WebAppBackupConfigurationSlot';
     ...
     */
    public readonly backupSchedule!: pulumi.Output<outputs.web.v20210115.BackupScheduleResponse | undefined>;
    /**
     * Databases included in the backup.
     */
    public readonly databases!: pulumi.Output<outputs.web.v20210115.DatabaseBackupSettingResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppBackupConfigurationSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["backupSchedule"] = args ? (args.backupSchedule ? pulumi.output(args.backupSchedule).apply(inputs.web.v20210115.backupScheduleArgsProvideDefaults) : undefined) : undefined;
