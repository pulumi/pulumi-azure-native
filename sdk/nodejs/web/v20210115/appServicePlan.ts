...
export class AppServicePlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServicePlan {
        pulumi.log.warn("AppServicePlan is deprecated: azure-native:web/v20210115:AppServicePlan is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.")
