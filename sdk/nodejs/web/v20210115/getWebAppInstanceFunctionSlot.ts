 ...
 */
/** @deprecated azure-native:web/v20210115:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppInstanceFunctionSlot to guarantee forwards compatibility. */
export function getWebAppInstanceFunctionSlot(args: GetWebAppInstanceFunctionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppInstanceFunctionSlotResult> {
    pulumi.log.warn("getWebAppInstanceFunctionSlot is deprecated: azure-native:web/v20210115:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppInstanceFunctionSlot to guarantee forwards compatibility.")
