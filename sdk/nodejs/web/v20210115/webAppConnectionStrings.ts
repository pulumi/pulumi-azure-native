...
export class WebAppConnectionStrings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppConnectionStrings {
        pulumi.log.warn("WebAppConnectionStrings is deprecated: azure-native:web/v20210115:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppConnectionStrings to guarantee forwards compatibility.")
