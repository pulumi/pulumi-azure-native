...
export class WebAppSourceControl extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSourceControl {
        pulumi.log.warn("WebAppSourceControl is deprecated: azure-native:web/v20210115:WebAppSourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSourceControl to guarantee forwards compatibility.")
