 ...
 *
 * @deprecated azure-native:web/v20190801:WebAppDiagnosticLogsConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDiagnosticLogsConfiguration to guarantee forwards compatibility.
 */
export class WebAppDiagnosticLogsConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppDiagnosticLogsConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["applicationLogs"] = args ? (args.applicationLogs ? pulumi.output(args.applicationLogs).apply(inputs.web.v20190801.applicationLogsConfigArgsProvideDefaults) : undefined) : undefined;
