 ...
 */
/** @deprecated azure-native:web/v20190801:WebAppRelayServiceConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppRelayServiceConnection to guarantee forwards compatibility. */
export function getWebAppRelayServiceConnection(args: GetWebAppRelayServiceConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppRelayServiceConnectionResult> {
    pulumi.log.warn("getWebAppRelayServiceConnection is deprecated: azure-native:web/v20190801:WebAppRelayServiceConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppRelayServiceConnection to guarantee forwards compatibility.")
