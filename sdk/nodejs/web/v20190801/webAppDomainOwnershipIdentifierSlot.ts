...
export class WebAppDomainOwnershipIdentifierSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppDomainOwnershipIdentifierSlot {
        pulumi.log.warn("WebAppDomainOwnershipIdentifierSlot is deprecated: azure-native:web/v20190801:WebAppDomainOwnershipIdentifierSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppDomainOwnershipIdentifierSlot to guarantee forwards compatibility.")
