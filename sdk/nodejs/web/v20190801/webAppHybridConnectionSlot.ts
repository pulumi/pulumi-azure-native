 ...
 *
 * @deprecated azure-native:web/v20190801:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppHybridConnectionSlot to guarantee forwards compatibility.
 */
export class WebAppHybridConnectionSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppHybridConnectionSlot {
        pulumi.log.warn("WebAppHybridConnectionSlot is deprecated: azure-native:web/v20190801:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppHybridConnectionSlot to guarantee forwards compatibility.")
