...
export class StaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20190801:StaticSite';
    ...
    constructor(name: string, argsOrState?: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:StaticSite" }, { type: "azurerm:web/preview:StaticSite" }, { type: "azurerm:web/v20200601:StaticSite" }] };
