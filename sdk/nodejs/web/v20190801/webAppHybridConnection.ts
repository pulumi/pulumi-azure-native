...
export class WebAppHybridConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppHybridConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppHybridConnection" }, { type: "azurerm:web/preview:WebAppHybridConnection" }, { type: "azurerm:web/v20160801:WebAppHybridConnection" }, { type: "azurerm:web/v20180201:WebAppHybridConnection" }, { type: "azurerm:web/v20181101:WebAppHybridConnection" }, { type: "azurerm:web/v20200601:WebAppHybridConnection" }] };
