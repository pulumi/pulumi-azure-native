 ...
 *
 * const webAppPrivateEndpointConnection = new azurerm.web.v20190801.WebAppPrivateEndpointConnection("webAppPrivateEndpointConnection", {
 *     name: "testSite",
...
export class WebAppPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppPrivateEndpointConnection" }, { type: "azurerm:web/v20200601:WebAppPrivateEndpointConnection" }] };
