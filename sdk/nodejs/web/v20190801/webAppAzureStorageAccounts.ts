 ...
 *
 * @deprecated azure-native:web/v20190801:WebAppAzureStorageAccounts is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppAzureStorageAccounts to guarantee forwards compatibility.
 */
export class WebAppAzureStorageAccounts extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAzureStorageAccounts {
        pulumi.log.warn("WebAppAzureStorageAccounts is deprecated: azure-native:web/v20190801:WebAppAzureStorageAccounts is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppAzureStorageAccounts to guarantee forwards compatibility.")
