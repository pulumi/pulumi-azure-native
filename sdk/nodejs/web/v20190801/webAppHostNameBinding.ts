...
export class WebAppHostNameBinding extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppHostNameBindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20150801:WebAppHostNameBinding" }, { type: "azurerm:web/v20160801:WebAppHostNameBinding" }, { type: "azurerm:web/v20180201:WebAppHostNameBinding" }, { type: "azurerm:web/v20181101:WebAppHostNameBinding" }] };
