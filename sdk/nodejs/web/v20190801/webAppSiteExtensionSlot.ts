...
export class WebAppSiteExtensionSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppSiteExtensionSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppSiteExtensionSlot" }, { type: "azurerm:web/preview:WebAppSiteExtensionSlot" }, { type: "azurerm:web/v20160801:WebAppSiteExtensionSlot" }, { type: "azurerm:web/v20180201:WebAppSiteExtensionSlot" }, { type: "azurerm:web/v20181101:WebAppSiteExtensionSlot" }, { type: "azurerm:web/v20200601:WebAppSiteExtensionSlot" }] };
