...
export class WebAppInstanceFunctionSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppInstanceFunctionSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppInstanceFunctionSlot" }, { type: "azurerm:web/preview:WebAppInstanceFunctionSlot" }, { type: "azurerm:web/v20160801:WebAppInstanceFunctionSlot" }, { type: "azurerm:web/v20180201:WebAppInstanceFunctionSlot" }, { type: "azurerm:web/v20181101:WebAppInstanceFunctionSlot" }, { type: "azurerm:web/v20200601:WebAppInstanceFunctionSlot" }] };
