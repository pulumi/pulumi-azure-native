 ...
 */
/** @deprecated azure-native:web/v20190801:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppVnetConnectionSlot to guarantee forwards compatibility. */
export function getWebAppVnetConnectionSlot(args: GetWebAppVnetConnectionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppVnetConnectionSlotResult> {
    pulumi.log.warn("getWebAppVnetConnectionSlot is deprecated: azure-native:web/v20190801:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppVnetConnectionSlot to guarantee forwards compatibility.")
