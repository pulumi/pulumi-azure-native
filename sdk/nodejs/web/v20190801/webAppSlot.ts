...
export class WebAppSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["siteConfig"] = args ? (args.siteConfig ? pulumi.output(args.siteConfig).apply(inputs.web.v20190801.siteConfigArgsProvideDefaults) : undefined) : undefined;
