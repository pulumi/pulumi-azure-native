...
export class WebAppFunction extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppFunction" }, { type: "azurerm:web/preview:WebAppFunction" }, { type: "azurerm:web/v20160801:WebAppFunction" }, { type: "azurerm:web/v20180201:WebAppFunction" }, { type: "azurerm:web/v20181101:WebAppFunction" }, { type: "azurerm:web/v20200601:WebAppFunction" }] };
