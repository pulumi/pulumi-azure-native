...
export class ServerFarm extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerFarmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:ServerFarm" }, { type: "azurerm:web/v20160901:ServerFarm" }, { type: "azurerm:web/v20180201:ServerFarm" }, { type: "azurerm:web/v20190801:ServerFarm" }, { type: "azurerm:web/v20200601:ServerFarm" }] };
