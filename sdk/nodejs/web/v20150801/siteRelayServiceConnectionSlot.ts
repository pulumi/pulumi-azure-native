...
export class SiteRelayServiceConnectionSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SiteRelayServiceConnectionSlot {
        return new SiteRelayServiceConnectionSlot(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20150801:SiteRelayServiceConnectionSlot';
    ...
    constructor(name: string, argsOrState?: SiteRelayServiceConnectionSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20160801:SiteRelayServiceConnectionSlot" }, { type: "azurerm:web/v20180201:SiteRelayServiceConnectionSlot" }, { type: "azurerm:web/v20181101:SiteRelayServiceConnectionSlot" }, { type: "azurerm:web/v20190801:SiteRelayServiceConnectionSlot" }] };
