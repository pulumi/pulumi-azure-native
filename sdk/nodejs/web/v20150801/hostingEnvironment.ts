...
export class HostingEnvironment extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: HostingEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:HostingEnvironment" }, { type: "azurerm:web/preview:HostingEnvironment" }, { type: "azurerm:web/v20160901:HostingEnvironment" }, { type: "azurerm:web/v20180201:HostingEnvironment" }, { type: "azurerm:web/v20190801:HostingEnvironment" }, { type: "azurerm:web/v20200601:HostingEnvironment" }] };
