 ...
 *
 * ```sh
 * $ pulumi import azure-native:web/v20150801:SiteSlot myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot} 
 * ```
 *
...
export class SiteSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SiteSlot {
        pulumi.log.warn("SiteSlot is deprecated: Version 2015-08-01 will be removed in v2 of the provider.")
