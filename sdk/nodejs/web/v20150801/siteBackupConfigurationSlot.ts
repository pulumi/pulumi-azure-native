 ...
 *
 * ```sh
 * $ pulumi import azure-native:web/v20150801:SiteBackupConfigurationSlot myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/backup 
 * ```
 *
...
export class SiteBackupConfigurationSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SiteBackupConfigurationSlot {
        pulumi.log.warn("SiteBackupConfigurationSlot is deprecated: Version 2015-08-01 will be removed in v2 of the provider.")
