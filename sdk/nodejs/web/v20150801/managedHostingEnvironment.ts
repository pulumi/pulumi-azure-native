...
export class ManagedHostingEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedHostingEnvironment {
        return new ManagedHostingEnvironment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20150801:ManagedHostingEnvironment';
    ...
    constructor(name: string, argsOrState?: ManagedHostingEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
