...
export class CertificateCsr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20150801:CertificateCsr';
    ...
    constructor(name: string, argsOrState?: CertificateCsrArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:CertificateCsr" }, { type: "azurerm:web/preview:CertificateCsr" }] };
