...
export class SiteDeploymentSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SiteDeploymentSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20160801:SiteDeploymentSlot" }, { type: "azurerm:web/v20180201:SiteDeploymentSlot" }, { type: "azurerm:web/v20181101:SiteDeploymentSlot" }, { type: "azurerm:web/v20190801:SiteDeploymentSlot" }] };
