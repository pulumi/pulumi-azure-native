...
export class SiteHostNameBindingSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SiteHostNameBindingSlot {
        return new SiteHostNameBindingSlot(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20150801:SiteHostNameBindingSlot';
    ...
    constructor(name: string, argsOrState?: SiteHostNameBindingSlotArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SiteHostNameBindingSlotArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20160801:SiteHostNameBindingSlot" }, { type: "azurerm:web/v20180201:SiteHostNameBindingSlot" }, { type: "azurerm:web/v20181101:SiteHostNameBindingSlot" }, { type: "azurerm:web/v20190801:SiteHostNameBindingSlot" }, { type: "azurerm:web/v20200601:SiteHostNameBindingSlot" }] };
