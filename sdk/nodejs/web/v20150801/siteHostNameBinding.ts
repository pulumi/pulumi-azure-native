...
export class SiteHostNameBinding extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SiteHostNameBindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:SiteHostNameBinding" }, { type: "azurerm:web/preview:SiteHostNameBinding" }, { type: "azurerm:web/v20160801:SiteHostNameBinding" }, { type: "azurerm:web/v20180201:SiteHostNameBinding" }, { type: "azurerm:web/v20181101:SiteHostNameBinding" }, { type: "azurerm:web/v20190801:SiteHostNameBinding" }, { type: "azurerm:web/v20200601:SiteHostNameBinding" }] };
