 ...
 *
 * ```sh
 * $ pulumi import azure-native:web/v20150801:SiteSlotConfigNames myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/config/slotConfigNames 
 * ```
 *
