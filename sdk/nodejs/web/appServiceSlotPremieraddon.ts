...
export class AppServiceSlotPremieraddon extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppServiceSlotPremieraddonState, opts?: pulumi.CustomResourceOptions): AppServiceSlotPremieraddon {
        return new AppServiceSlotPremieraddon(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: AppServiceSlotPremieraddonArgs | AppServiceSlotPremieraddonState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as AppServiceSlotPremieraddonState | undefined;
