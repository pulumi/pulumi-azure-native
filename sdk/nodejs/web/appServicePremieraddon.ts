...
export class AppServicePremieraddon extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServicePremieraddon {
        return new AppServicePremieraddon(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: AppServicePremieraddonArgs, opts?: pulumi.CustomResourceOptions) {
