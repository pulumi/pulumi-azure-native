...
export class WebAppPublicCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppPublicCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppPublicCertificate" }, { type: "azurerm:web/v20180201:WebAppPublicCertificate" }, { type: "azurerm:web/v20181101:WebAppPublicCertificate" }, { type: "azurerm:web/v20190801:WebAppPublicCertificate" }, { type: "azurerm:web/v20200601:WebAppPublicCertificate" }] };
