...
export class WebAppVnetConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppVnetConnection {
        return new WebAppVnetConnection(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20160801:WebAppVnetConnection';
    ...
    constructor(name: string, argsOrState?: WebAppVnetConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as WebAppVnetConnectionArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppVnetConnection" }, { type: "azurerm:web/preview:WebAppVnetConnection" }, { type: "azurerm:web/v20150801:WebAppVnetConnection" }, { type: "azurerm:web/v20180201:WebAppVnetConnection" }, { type: "azurerm:web/v20181101:WebAppVnetConnection" }, { type: "azurerm:web/v20190801:WebAppVnetConnection" }, { type: "azurerm:web/v20200601:WebAppVnetConnection" }] };
