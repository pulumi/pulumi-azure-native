...
export class WebAppDomainOwnershipIdentifier extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppDomainOwnershipIdentifier {
        return new WebAppDomainOwnershipIdentifier(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20160801:WebAppDomainOwnershipIdentifier';
    ...
    constructor(name: string, argsOrState?: WebAppDomainOwnershipIdentifierArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as WebAppDomainOwnershipIdentifierArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/preview:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/v20180201:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/v20181101:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/v20190801:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/v20200601:WebAppDomainOwnershipIdentifier" }] };
