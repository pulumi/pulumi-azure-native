...
export class WebAppDeployment extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20150801:WebAppDeployment" }, { type: "azurerm:web/v20180201:WebAppDeployment" }, { type: "azurerm:web/v20181101:WebAppDeployment" }, { type: "azurerm:web/v20190801:WebAppDeployment" }] };
