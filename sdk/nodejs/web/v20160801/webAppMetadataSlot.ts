...
export class WebAppMetadataSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppMetadataSlot {
        pulumi.log.warn("WebAppMetadataSlot is deprecated: azure-native:web/v20160801:WebAppMetadataSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppMetadataSlot to guarantee forwards compatibility.")
