...
export function listWebAppBackupConfiguration(args: ListWebAppBackupConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<ListWebAppBackupConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:web/v20160801:listWebAppBackupConfiguration", {
        "name": args.name,
...
export interface ListWebAppBackupConfigurationResult {
     ...
     */
    readonly backupSchedule?: outputs.web.v20160801.BackupScheduleInvokeResponse;
    /**
     * Databases included in the backup.
     */
    readonly databases?: outputs.web.v20160801.DatabaseBackupSettingInvokeResponse[];
    /**
