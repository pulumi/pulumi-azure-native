 ...
 *
 * @deprecated azure-native:web/v20160801:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppConnectionStrings to guarantee forwards compatibility.
 */
export class WebAppConnectionStrings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppConnectionStrings {
        pulumi.log.warn("WebAppConnectionStrings is deprecated: azure-native:web/v20160801:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppConnectionStrings to guarantee forwards compatibility.")
        return new WebAppConnectionStrings(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20160801:WebAppConnectionStrings';
     ...
     * Connection strings.
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.web.v20160801.ConnStringValueTypePairResponse}>;
    /**
     * Resource type.
     */
...
export interface WebAppConnectionStringsArgs {
     ...
     * Connection strings.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20160801.ConnStringValueTypePairArgs>}>;
    /**
