...
export function getWebAppHostNameBindingSlot(args: GetWebAppHostNameBindingSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppHostNameBindingSlotResult> {
    pulumi.log.warn("getWebAppHostNameBindingSlot is deprecated: azure-native:web/v20160801:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHostNameBindingSlot to guarantee forwards compatibility.")
