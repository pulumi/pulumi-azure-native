...
export interface GetAppServicePlanResult {
     ...
     */
    readonly kubeEnvironmentProfile?: outputs.web.v20230101.KubeEnvironmentProfileResponse;
    /**
     * Resource Location.
     */
     ...
     */
    readonly sku?: outputs.web.v20230101.SkuDescriptionResponse;
    /**
...
export function getAppServicePlanOutput(args: GetAppServicePlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppServicePlanResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:web/v20230101:getAppServicePlan", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
