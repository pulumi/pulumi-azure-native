...
export class StaticSiteBuildDatabaseConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StaticSiteBuildDatabaseConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSiteBuildDatabaseConnection" }, { type: "azure-native:web/v20220901:StaticSiteBuildDatabaseConnection" }, { type: "azure-native:web/v20231201:StaticSiteBuildDatabaseConnection" }, { type: "azure-native:web/v20240401:StaticSiteBuildDatabaseConnection" }] };
