...
export class WebAppAzureStorageAccounts extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.web.v20230101.AzureStorageInfoValueResponse}>;
    /**
     * Resource type.
     */
...
export interface WebAppAzureStorageAccountsArgs {
     ...
     * Azure storage accounts.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20230101.AzureStorageInfoValueArgs>}>;
    /**
