...
export class StaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20230101:StaticSite';
     ...
     */
    public readonly buildProperties!: pulumi.Output<outputs.web.v20230101.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly databaseConnections!: pulumi.Output<outputs.web.v20230101.DatabaseConnectionOverviewResponse[]>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.web.v20230101.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly linkedBackends!: pulumi.Output<outputs.web.v20230101.StaticSiteLinkedBackendResponse[]>;
    /**
     * Resource Location.
     */
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.web.v20230101.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.web.v20230101.SkuDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly templateProperties!: pulumi.Output<outputs.web.v20230101.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly userProvidedFunctionApps!: pulumi.Output<outputs.web.v20230101.StaticSiteUserProvidedFunctionAppResponse[]>;
    ...
    constructor(name: string, args: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSite" }, { type: "azure-native:web/v20190801:StaticSite" }, { type: "azure-native:web/v20200601:StaticSite" }, { type: "azure-native:web/v20200901:StaticSite" }, { type: "azure-native:web/v20201001:StaticSite" }, { type: "azure-native:web/v20201201:StaticSite" }, { type: "azure-native:web/v20210101:StaticSite" }, { type: "azure-native:web/v20210115:StaticSite" }, { type: "azure-native:web/v20210201:StaticSite" }, { type: "azure-native:web/v20210301:StaticSite" }, { type: "azure-native:web/v20220301:StaticSite" }, { type: "azure-native:web/v20220901:StaticSite" }] };
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    buildProperties?: pulumi.Input<inputs.web.v20230101.StaticSiteBuildPropertiesArgs>;
    /**
     * State indicating the status of the enterprise grade CDN serving traffic to the static web app.
     */
    enterpriseGradeCdnStatus?: pulumi.Input<string | enums.web.v20230101.EnterpriseGradeCdnStatus>;
    /**
     * Managed service identity.
     */
    identity?: pulumi.Input<inputs.web.v20230101.ManagedServiceIdentityArgs>;
    /**
     * Kind of resource.
     */
     ...
     * State indicating whether staging environments are allowed or not allowed for a static web app.
     */
    stagingEnvironmentPolicy?: pulumi.Input<enums.web.v20230101.StagingEnvironmentPolicy>;
    /**
     * Resource tags.
     */
     ...
     * Template options for generating a new repository.
     */
    templateProperties?: pulumi.Input<inputs.web.v20230101.StaticSiteTemplateOptionsArgs>;
}
