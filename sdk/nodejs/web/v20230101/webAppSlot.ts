...
export class WebAppSlot extends pulumi.CustomResource {
     ...
     */
    public readonly daprConfig!: pulumi.Output<outputs.web.v20230101.DaprConfigResponse | undefined>;
    /**
     ...
     * Extended Location.
     */
    public readonly extendedLocation!: pulumi.Output<outputs.web.v20230101.ExtendedLocationResponse | undefined>;
    /**
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    public readonly hostNameSslStates!: pulumi.Output<outputs.web.v20230101.HostNameSslStateResponse[] | undefined>;
    /**
     ...
     */
    public readonly hostingEnvironmentProfile!: pulumi.Output<outputs.web.v20230101.HostingEnvironmentProfileResponse | undefined>;
    /**
     ...
     */
    public readonly resourceConfig!: pulumi.Output<outputs.web.v20230101.ResourceConfigResponse | undefined>;
    /**
     ...
     */
    public readonly siteConfig!: pulumi.Output<outputs.web.v20230101.SiteConfigResponse | undefined>;
    /**
     * Status of the last deployment slot swap operation.
     */
    public /*out*/ readonly slotSwapStatus!: pulumi.Output<outputs.web.v20230101.SlotSwapStatusResponse>;
    /**
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["daprConfig"] = args ? (args.daprConfig ? pulumi.output(args.daprConfig).apply(inputs.web.v20230101.daprConfigArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["siteConfig"] = args ? (args.siteConfig ? pulumi.output(args.siteConfig).apply(inputs.web.v20230101.siteConfigArgsProvideDefaults) : undefined) : undefined;
...
export interface WebAppSlotArgs {
     ...
     * - ClientCertEnabled: true and ClientCertMode: Optional means ClientCert is optional or accepted.
     */
    clientCertMode?: pulumi.Input<enums.web.v20230101.ClientCertMode>;
    /**
     * If specified during app creation, the app is cloned from a source app.
     */
    cloningInfo?: pulumi.Input<inputs.web.v20230101.CloningInfoArgs>;
    /**
     * Size of the function container.
     */
     ...
     * Dapr configuration of the app.
     */
    daprConfig?: pulumi.Input<inputs.web.v20230101.DaprConfigArgs>;
    /**
     * <code>true</code> if the app is enabled; otherwise, <code>false</code>. Setting this value to false disables the app (takes the app offline).
     */
     ...
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    hostNameSslStates?: pulumi.Input<pulumi.Input<inputs.web.v20230101.HostNameSslStateArgs>[]>;
    /**
     * <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
     *  If <code>true</code>, the app is only accessible via API management process.
     */
     ...
     * Site redundancy mode
     */
    redundancyMode?: pulumi.Input<enums.web.v20230101.RedundancyMode>;
    /**
     * <code>true</code> if reserved; otherwise, <code>false</code>.
     */
     ...
     * Function app resource requirements.
     */
    resourceConfig?: pulumi.Input<inputs.web.v20230101.ResourceConfigArgs>;
    /**
     ...
     * Configuration of the app.
     */
    siteConfig?: pulumi.Input<inputs.web.v20230101.SiteConfigArgs>;
    /**
