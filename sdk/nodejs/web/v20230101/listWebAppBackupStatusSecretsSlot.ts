...
export function listWebAppBackupStatusSecretsSlot(args: ListWebAppBackupStatusSecretsSlotArgs, opts?: pulumi.InvokeOptions): Promise<ListWebAppBackupStatusSecretsSlotResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20230101:listWebAppBackupStatusSecretsSlot", {
        ...
        "backupSchedule": args.backupSchedule ? inputs.web.v20230101.backupScheduleProvideDefaults(args.backupSchedule) : undefined,
...
export interface ListWebAppBackupStatusSecretsSlotArgs {
     ...
     */
    backupSchedule?: inputs.web.v20230101.BackupSchedule;
    /**
     * Databases included in the backup.
     */
    databases?: inputs.web.v20230101.DatabaseBackupSetting[];
    /**
...
export function listWebAppBackupStatusSecretsSlotOutput(args: ListWebAppBackupStatusSecretsSlotOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListWebAppBackupStatusSecretsSlotResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:web/v20230101:listWebAppBackupStatusSecretsSlot", {
        "backupId": args.backupId,
        "backupName": args.backupName,
        "backupSchedule": args.backupSchedule ? pulumi.output(args.backupSchedule).apply(inputs.web.v20230101.backupScheduleProvideDefaults) : undefined,
        "databases": args.databases,
        "enabled": args.enabled,
        "kind": args.kind,
        "name": args.name,
...
export interface ListWebAppBackupStatusSecretsSlotOutputArgs {
     ...
     * Schedule for the backup if it is executed periodically.
     */
    backupSchedule?: pulumi.Input<inputs.web.v20230101.BackupScheduleArgs>;
    /**
     * Databases included in the backup.
     */
    databases?: pulumi.Input<pulumi.Input<inputs.web.v20230101.DatabaseBackupSettingArgs>[]>;
    /**
     * True if the backup schedule is enabled (must be included in that case), false if the backup schedule should be disabled.
     */
