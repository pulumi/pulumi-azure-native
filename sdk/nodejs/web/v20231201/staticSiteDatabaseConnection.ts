...
export class StaticSiteDatabaseConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20231201:StaticSiteDatabaseConnection';
     ...
     */
    public /*out*/ readonly configurationFiles!: pulumi.Output<outputs.web.v20231201.StaticSiteDatabaseConnectionConfigurationFileOverviewResponse[]>;
    /**
    ...
    constructor(name: string, args: StaticSiteDatabaseConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSiteDatabaseConnection" }, { type: "azure-native:web/v20220901:StaticSiteDatabaseConnection" }, { type: "azure-native:web/v20230101:StaticSiteDatabaseConnection" }, { type: "azure-native:web/v20240401:StaticSiteDatabaseConnection" }] };
