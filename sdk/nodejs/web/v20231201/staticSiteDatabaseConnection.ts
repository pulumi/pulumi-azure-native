...
export class StaticSiteDatabaseConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StaticSiteDatabaseConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSiteDatabaseConnection" }, { type: "azure-native:web/v20220901:StaticSiteDatabaseConnection" }, { type: "azure-native:web/v20230101:StaticSiteDatabaseConnection" }] };
