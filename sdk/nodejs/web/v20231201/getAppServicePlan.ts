...
export function getAppServicePlan(args: GetAppServicePlanArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServicePlanResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20231201:getAppServicePlan", {
        "name": args.name,
...
export interface GetAppServicePlanResult {
     ...
     * Extended Location.
     */
    readonly extendedLocation?: outputs.web.v20231201.ExtendedLocationResponse;
    /**
     ...
     */
    readonly hostingEnvironmentProfile?: outputs.web.v20231201.HostingEnvironmentProfileResponse;
    /**
     ...
     */
    readonly kubeEnvironmentProfile?: outputs.web.v20231201.KubeEnvironmentProfileResponse;
    /**
     * Resource Location.
     */
...
export function getAppServicePlanOutput(args: GetAppServicePlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppServicePlanResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:web/v20231201:getAppServicePlan", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
