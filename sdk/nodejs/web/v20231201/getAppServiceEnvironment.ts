...
export function getAppServiceEnvironment(args: GetAppServiceEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceEnvironmentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20231201:getAppServiceEnvironment", {
        "name": args.name,
...
export interface GetAppServiceEnvironmentResult {
     ...
     */
    readonly clusterSettings?: outputs.web.v20231201.NameValuePairResponse[];
    /**
     * Full view of the custom domain suffix configuration for ASEv3.
     */
    readonly customDnsSuffixConfiguration?: outputs.web.v20231201.CustomDnsSuffixConfigurationResponse;
    /**
     ...
     */
    readonly networkingConfiguration?: outputs.web.v20231201.AseV3NetworkingConfigurationResponse;
    /**
     ...
     */
    readonly virtualNetwork: outputs.web.v20231201.VirtualNetworkProfileResponse;
    /**
...
export function getAppServiceEnvironmentOutput(args: GetAppServiceEnvironmentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAppServiceEnvironmentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:web/v20231201:getAppServiceEnvironment", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
