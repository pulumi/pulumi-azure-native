...
export class WebAppSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20231201:WebAppSlot';
     ...
     */
    public readonly daprConfig!: pulumi.Output<outputs.web.v20231201.DaprConfigResponse | undefined>;
    /**
     ...
     */
    public readonly dnsConfiguration!: pulumi.Output<outputs.web.v20231201.SiteDnsConfigResponse | undefined>;
    /**
     ...
     */
    public readonly functionAppConfig!: pulumi.Output<outputs.web.v20231201.FunctionAppConfigResponse | undefined>;
    /**
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    public readonly hostNameSslStates!: pulumi.Output<outputs.web.v20231201.HostNameSslStateResponse[] | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.web.v20231201.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly resourceConfig!: pulumi.Output<outputs.web.v20231201.ResourceConfigResponse | undefined>;
    /**
     ...
     */
    public readonly siteConfig!: pulumi.Output<outputs.web.v20231201.SiteConfigResponse | undefined>;
    /**
     * Status of the last deployment slot swap operation.
     */
    public /*out*/ readonly slotSwapStatus!: pulumi.Output<outputs.web.v20231201.SlotSwapStatusResponse>;
    /**
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["siteConfig"] = args ? (args.siteConfig ? pulumi.output(args.siteConfig).apply(inputs.web.v20231201.siteConfigArgsProvideDefaults) : undefined) : undefined;
...
export interface WebAppSlotArgs {
     ...
     * - ClientCertEnabled: true and ClientCertMode: Optional means ClientCert is optional or accepted.
     */
    clientCertMode?: pulumi.Input<enums.web.v20231201.ClientCertMode>;
    /**
     * If specified during app creation, the app is cloned from a source app.
     */
    cloningInfo?: pulumi.Input<inputs.web.v20231201.CloningInfoArgs>;
    /**
     * Size of the function container.
     */
     ...
     * Dapr configuration of the app.
     */
    daprConfig?: pulumi.Input<inputs.web.v20231201.DaprConfigArgs>;
    /**
     * Property to configure various DNS related settings for a site.
     */
    dnsConfiguration?: pulumi.Input<inputs.web.v20231201.SiteDnsConfigArgs>;
    /**
     * <code>true</code> if the app is enabled; otherwise, <code>false</code>. Setting this value to false disables the app (takes the app offline).
     */
     ...
     * Configuration specific of the Azure Function app.
     */
    functionAppConfig?: pulumi.Input<inputs.web.v20231201.FunctionAppConfigArgs>;
    /**
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    hostNameSslStates?: pulumi.Input<pulumi.Input<inputs.web.v20231201.HostNameSslStateArgs>[]>;
    /**
     * <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
     *  If <code>true</code>, the app is only accessible via API management process.
     */
     ...
     * Managed service identity.
     */
    identity?: pulumi.Input<inputs.web.v20231201.ManagedServiceIdentityArgs>;
    /**
     * Obsolete: Hyper-V sandbox.
     */
     ...
     * Site redundancy mode
     */
    redundancyMode?: pulumi.Input<enums.web.v20231201.RedundancyMode>;
    /**
     * <code>true</code> if reserved; otherwise, <code>false</code>.
     */
     ...
     * Function app resource requirements.
     */
    resourceConfig?: pulumi.Input<inputs.web.v20231201.ResourceConfigArgs>;
    /**
     ...
     * Configuration of the app.
     */
    siteConfig?: pulumi.Input<inputs.web.v20231201.SiteConfigArgs>;
    /**
