...
export class WebAppSiteContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20231201:WebAppSiteContainer';
    ...
    constructor(name: string, args: WebAppSiteContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppSiteContainer" }, { type: "azure-native:web/v20240401:WebAppSiteContainer" }] };
