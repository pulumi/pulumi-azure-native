...
export class WebAppBackupConfigurationSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20231201:WebAppBackupConfigurationSlot';
     ...
     */
    public readonly backupSchedule!: pulumi.Output<outputs.web.v20231201.BackupScheduleResponse | undefined>;
    /**
     * Databases included in the backup.
     */
    public readonly databases!: pulumi.Output<outputs.web.v20231201.DatabaseBackupSettingResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppBackupConfigurationSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["backupSchedule"] = args ? (args.backupSchedule ? pulumi.output(args.backupSchedule).apply(inputs.web.v20231201.backupScheduleArgsProvideDefaults) : undefined) : undefined;
...
export interface WebAppBackupConfigurationSlotArgs {
     ...
     * Schedule for the backup if it is executed periodically.
     */
    backupSchedule?: pulumi.Input<inputs.web.v20231201.BackupScheduleArgs>;
    /**
     * Databases included in the backup.
     */
    databases?: pulumi.Input<pulumi.Input<inputs.web.v20231201.DatabaseBackupSettingArgs>[]>;
    /**
     * True if the backup schedule is enabled (must be included in that case), false if the backup schedule should be disabled.
     */
