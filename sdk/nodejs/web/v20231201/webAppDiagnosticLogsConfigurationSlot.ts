...
export class WebAppDiagnosticLogsConfigurationSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20231201:WebAppDiagnosticLogsConfigurationSlot';
     ...
     */
    public readonly applicationLogs!: pulumi.Output<outputs.web.v20231201.ApplicationLogsConfigResponse | undefined>;
    /**
     * Detailed error messages configuration.
     */
    public readonly detailedErrorMessages!: pulumi.Output<outputs.web.v20231201.EnabledConfigResponse | undefined>;
    /**
     * Failed requests tracing configuration.
     */
    public readonly failedRequestsTracing!: pulumi.Output<outputs.web.v20231201.EnabledConfigResponse | undefined>;
    /**
     * HTTP logs configuration.
     */
    public readonly httpLogs!: pulumi.Output<outputs.web.v20231201.HttpLogsConfigResponse | undefined>;
    /**
     * Kind of resource.
     */
    ...
    constructor(name: string, args: WebAppDiagnosticLogsConfigurationSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["applicationLogs"] = args ? (args.applicationLogs ? pulumi.output(args.applicationLogs).apply(inputs.web.v20231201.applicationLogsConfigArgsProvideDefaults) : undefined) : undefined;
...
export interface WebAppDiagnosticLogsConfigurationSlotArgs {
     ...
     * Application logs configuration.
     */
    applicationLogs?: pulumi.Input<inputs.web.v20231201.ApplicationLogsConfigArgs>;
    /**
     * Detailed error messages configuration.
     */
    detailedErrorMessages?: pulumi.Input<inputs.web.v20231201.EnabledConfigArgs>;
    /**
     * Failed requests tracing configuration.
     */
    failedRequestsTracing?: pulumi.Input<inputs.web.v20231201.EnabledConfigArgs>;
    /**
     * HTTP logs configuration.
     */
    httpLogs?: pulumi.Input<inputs.web.v20231201.HttpLogsConfigArgs>;
    /**
     * Kind of resource.
     */
