...
export class WebAppConnectionStringsSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20231201:WebAppConnectionStringsSlot';
     ...
     * Connection strings.
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.web.v20231201.ConnStringValueTypePairResponse}>;
    /**
     * Resource type.
     */
...
export interface WebAppConnectionStringsSlotArgs {
     ...
     * Connection strings.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20231201.ConnStringValueTypePairArgs>}>;
    /**
