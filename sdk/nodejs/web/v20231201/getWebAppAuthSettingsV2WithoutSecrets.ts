...
export function getWebAppAuthSettingsV2WithoutSecrets(args: GetWebAppAuthSettingsV2WithoutSecretsArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppAuthSettingsV2WithoutSecretsResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20231201:getWebAppAuthSettingsV2WithoutSecrets", {
        "name": args.name,
...
export interface GetWebAppAuthSettingsV2WithoutSecretsResult {
     ...
     */
    readonly globalValidation?: outputs.web.v20231201.GlobalValidationResponse;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against App Service Authentication/Authorization.
     */
    readonly httpSettings?: outputs.web.v20231201.HttpSettingsResponse;
    /**
     * Resource Id.
     */
    readonly id: string;
     ...
     */
    readonly identityProviders?: outputs.web.v20231201.IdentityProvidersResponse;
    /**
     * Kind of resource.
     */
     ...
     */
    readonly login?: outputs.web.v20231201.LoginResponse;
    /**
     * Resource Name.
     */
     ...
     */
    readonly platform?: outputs.web.v20231201.AuthPlatformResponse;
    /**
     * Resource type.
     */
...
export function getWebAppAuthSettingsV2WithoutSecretsOutput(args: GetWebAppAuthSettingsV2WithoutSecretsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebAppAuthSettingsV2WithoutSecretsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:web/v20231201:getWebAppAuthSettingsV2WithoutSecrets", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
