...
export function listWebAppConnectionStringsSlot(args: ListWebAppConnectionStringsSlotArgs, opts?: pulumi.InvokeOptions): Promise<ListWebAppConnectionStringsSlotResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:web/v20180201:listWebAppConnectionStringsSlot", {
        "name": args.name,
...
export interface ListWebAppConnectionStringsSlotResult {
     ...
     * Connection strings.
     */
    readonly properties: {[key: string]: outputs.web.v20180201.ConnStringValueTypePairInvokeResponse};
    /**
     * Resource type.
     */
