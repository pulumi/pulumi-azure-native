 ...
 *
 * @deprecated azure-native:web/v20180201:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppConnectionStringsSlot to guarantee forwards compatibility.
 */
export class WebAppConnectionStringsSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppConnectionStringsSlot {
        pulumi.log.warn("WebAppConnectionStringsSlot is deprecated: azure-native:web/v20180201:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppConnectionStringsSlot to guarantee forwards compatibility.")
