...
export class WebAppSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSlot {
        pulumi.log.warn("WebAppSlot is deprecated: azure-native:web/v20180201:WebAppSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20181101:WebAppSlot to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["siteConfig"] = args ? (args.siteConfig ? pulumi.output(args.siteConfig).apply(inputs.web.v20180201.siteConfigArgsProvideDefaults) : undefined) : undefined;
