...
export class WebAppSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppSlot" }, { type: "azurerm:web/preview:WebAppSlot" }, { type: "azurerm:web/v20150801:WebAppSlot" }, { type: "azurerm:web/v20160801:WebAppSlot" }, { type: "azurerm:web/v20181101:WebAppSlot" }, { type: "azurerm:web/v20190801:WebAppSlot" }, { type: "azurerm:web/v20200601:WebAppSlot" }] };
