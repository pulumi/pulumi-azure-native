 ...
 * App Service plan.
 *
 * @deprecated azure-native:web/v20180201:AppServicePlan is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:AppServicePlan to guarantee forwards compatibility.
 */
export class AppServicePlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServicePlan {
        pulumi.log.warn("AppServicePlan is deprecated: azure-native:web/v20180201:AppServicePlan is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:AppServicePlan to guarantee forwards compatibility.")
        return new AppServicePlan(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20180201:AppServicePlan';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.web.v20180201.SkuDescriptionResponse | undefined>;
    /**
...
export interface AppServicePlanArgs {
     ...
     * Description of a SKU for a scalable resource.
     */
    sku?: pulumi.Input<inputs.web.v20180201.SkuDescriptionArgs>;
    /**
     * The time when the server farm expires. Valid only if it is a spot server farm.
     */
