 ...
 *
 * const appServicePlan = new azurerm.web.v20180201.AppServicePlan("appServicePlan", {
 *     kind: "app",
 *     location: "East US",
 *     name: "testsf6141",
...
export class AppServicePlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20180201:AppServicePlan';
    ...
    constructor(name: string, args: AppServicePlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:AppServicePlan" }, { type: "azurerm:web/v20150801:AppServicePlan" }, { type: "azurerm:web/v20160901:AppServicePlan" }, { type: "azurerm:web/v20190801:AppServicePlan" }, { type: "azurerm:web/v20200601:AppServicePlan" }] };
