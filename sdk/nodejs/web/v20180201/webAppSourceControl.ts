...
export class WebAppSourceControl extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppSourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20150801:WebAppSourceControl" }, { type: "azurerm:web/v20160801:WebAppSourceControl" }, { type: "azurerm:web/v20181101:WebAppSourceControl" }, { type: "azurerm:web/v20190801:WebAppSourceControl" }] };
