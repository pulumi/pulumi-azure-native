...
export function getAppServiceEnvironment(args: GetAppServiceEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceEnvironmentResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:web/v20180201:getAppServiceEnvironment", {
        "name": args.name,
...
export interface GetAppServiceEnvironmentResult {
     ...
     */
    readonly clusterSettings?: outputs.web.v20180201.NameValuePairInvokeResponse[];
    /**
     ...
     */
    readonly environmentCapacities: outputs.web.v20180201.StampCapacityInvokeResponse[];
    /**
     ...
     */
    readonly networkAccessControlList?: outputs.web.v20180201.NetworkAccessControlEntryInvokeResponse[];
    /**
     ...
     */
    readonly vipMappings: outputs.web.v20180201.VirtualIPMappingInvokeResponse[];
    /**
     * Description of the Virtual Network.
     */
    readonly virtualNetwork: outputs.web.v20180201.VirtualNetworkProfileInvokeResponse;
    /**
     ...
     */
    readonly workerPools: outputs.web.v20180201.WorkerPoolInvokeResponse[];
}
