...
export function getWebAppRelayServiceConnectionSlot(args: GetWebAppRelayServiceConnectionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppRelayServiceConnectionSlotResult> {
    pulumi.log.warn("getWebAppRelayServiceConnectionSlot is deprecated: azure-native:web/v20180201:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:web/v20180201:getWebAppRelayServiceConnectionSlot", {
