 ...
 */
/** @deprecated azure-native:web/v20180201:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSiteExtensionSlot to guarantee forwards compatibility. */
export function getWebAppSiteExtensionSlot(args: GetWebAppSiteExtensionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSiteExtensionSlotResult> {
    pulumi.log.warn("getWebAppSiteExtensionSlot is deprecated: azure-native:web/v20180201:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSiteExtensionSlot to guarantee forwards compatibility.")
