 ...
 *
 * @deprecated azure-native:web/v20180201:WebAppSitePushSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSitePushSettings to guarantee forwards compatibility.
 */
export class WebAppSitePushSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSitePushSettings {
        pulumi.log.warn("WebAppSitePushSettings is deprecated: azure-native:web/v20180201:WebAppSitePushSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSitePushSettings to guarantee forwards compatibility.")
