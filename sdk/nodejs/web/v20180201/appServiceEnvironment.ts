...
export class AppServiceEnvironment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AppServiceEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:AppServiceEnvironment" }, { type: "azurerm:web/preview:AppServiceEnvironment" }, { type: "azurerm:web/v20150801:AppServiceEnvironment" }, { type: "azurerm:web/v20160901:AppServiceEnvironment" }, { type: "azurerm:web/v20190801:AppServiceEnvironment" }, { type: "azurerm:web/v20200601:AppServiceEnvironment" }] };
