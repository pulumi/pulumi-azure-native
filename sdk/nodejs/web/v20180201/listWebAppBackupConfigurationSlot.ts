...
export function listWebAppBackupConfigurationSlot(args: ListWebAppBackupConfigurationSlotArgs, opts?: pulumi.InvokeOptions): Promise<ListWebAppBackupConfigurationSlotResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:web/v20180201:listWebAppBackupConfigurationSlot", {
        "name": args.name,
...
export interface ListWebAppBackupConfigurationSlotResult {
     ...
     */
    readonly backupSchedule?: outputs.web.v20180201.BackupScheduleInvokeResponse;
    /**
     * Databases included in the backup.
     */
    readonly databases?: outputs.web.v20180201.DatabaseBackupSettingInvokeResponse[];
    /**
