...
export class WebAppPublicCertificateSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppPublicCertificateSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppPublicCertificateSlot" }, { type: "azurerm:web/v20160801:WebAppPublicCertificateSlot" }, { type: "azurerm:web/v20181101:WebAppPublicCertificateSlot" }, { type: "azurerm:web/v20190801:WebAppPublicCertificateSlot" }, { type: "azurerm:web/v20200601:WebAppPublicCertificateSlot" }] };
