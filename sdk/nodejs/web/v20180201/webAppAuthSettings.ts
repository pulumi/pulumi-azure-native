 ...
 *
 * @deprecated azure-native:web/v20180201:WebAppAuthSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAuthSettings to guarantee forwards compatibility.
 */
export class WebAppAuthSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAuthSettings {
        pulumi.log.warn("WebAppAuthSettings is deprecated: azure-native:web/v20180201:WebAppAuthSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAuthSettings to guarantee forwards compatibility.")
