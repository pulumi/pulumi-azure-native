...
export class WebAppBackupConfigurationSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppBackupConfigurationSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20180201:WebAppBackupConfigurationSlot" }, { type: "azure-native:web:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/latest:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web/latest:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20150801:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web/v20150801:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20160801:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web/v20160801:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20181101:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web/v20181101:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20190801:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web/v20190801:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20200601:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web/v20200601:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20200901:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web/v20200901:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20201001:WebAppBackupConfigurationSlot" }, { type: "azure-nextgen:web/v20201001:WebAppBackupConfigurationSlot" }] };
...
export interface WebAppBackupConfigurationSlotArgs {
     ...
     * Schedule for the backup if it is executed periodically.
     */
    readonly backupSchedule?: pulumi.Input<inputs.web.v20180201.BackupSchedule>;
    /**
     * Databases included in the backup.
     */
    readonly databases?: pulumi.Input<pulumi.Input<inputs.web.v20180201.DatabaseBackupSetting>[]>;
    /**
     * True if the backup schedule is enabled (must be included in that case), false if the backup schedule should be disabled.
     */
