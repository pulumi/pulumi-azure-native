...
export function getWebAppConfiguration(args: GetWebAppConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20180201:getWebAppConfiguration", {
        "name": args.name,
...
export interface GetWebAppConfigurationResult {
     ...
     */
    readonly apiDefinition?: outputs.web.v20180201.ApiDefinitionInfoResponse;
    /**
     ...
     */
    readonly appSettings?: outputs.web.v20180201.NameValuePairResponse[];
    /**
     ...
     * Auto Heal rules.
     */
    readonly autoHealRules?: outputs.web.v20180201.AutoHealRulesResponse;
    /**
     * Auto-swap slot name.
     */
     ...
     */
    readonly azureStorageAccounts?: {[key: string]: outputs.web.v20180201.AzureStorageInfoValueResponse};
    /**
     * Connection strings.
     */
    readonly connectionStrings?: outputs.web.v20180201.ConnStringInfoResponse[];
    /**
     * Cross-Origin Resource Sharing (CORS) settings.
     */
    readonly cors?: outputs.web.v20180201.CorsSettingsResponse;
    /**
     * Default documents.
     */
     ...
     */
    readonly experiments?: outputs.web.v20180201.ExperimentsResponse;
    /**
     ...
     * Handler mappings.
     */
    readonly handlerMappings?: outputs.web.v20180201.HandlerMappingResponse[];
    /**
     ...
     */
    readonly ipSecurityRestrictions?: outputs.web.v20180201.IpSecurityRestrictionResponse[];
    /**
     * Java container.
     */
     ...
     * Site limits.
     */
    readonly limits?: outputs.web.v20180201.SiteLimitsResponse;
    /**
     ...
     * Site MachineKey.
     */
    readonly machineKey: outputs.web.v20180201.SiteMachineKeyResponse;
    /**
     ...
     */
    readonly push?: outputs.web.v20180201.PushSettingsResponse;
    /**
     * Version of Python.
     */
     ...
     */
    readonly scmIpSecurityRestrictions?: outputs.web.v20180201.IpSecurityRestrictionResponse[];
    /**
     ...
     */
    readonly virtualApplications?: outputs.web.v20180201.VirtualApplicationResponse[];
    /**
