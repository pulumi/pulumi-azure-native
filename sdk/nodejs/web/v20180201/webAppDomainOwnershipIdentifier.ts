 ...
 *
 * @deprecated azure-native:web/v20180201:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20181101:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.
 */
export class WebAppDomainOwnershipIdentifier extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppDomainOwnershipIdentifier {
        pulumi.log.warn("WebAppDomainOwnershipIdentifier is deprecated: azure-native:web/v20180201:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20181101:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.")
        return new WebAppDomainOwnershipIdentifier(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20180201:WebAppDomainOwnershipIdentifier';
