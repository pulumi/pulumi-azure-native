...
export class WebAppSwiftVirtualNetworkConnectionSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppSwiftVirtualNetworkConnectionSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20181101:WebAppSwiftVirtualNetworkConnectionSlot" }, { type: "azurerm:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot" }] };
