 ...
 */
/** @deprecated azure-native:web/v20180201:WebAppHostNameBinding is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppHostNameBinding to guarantee forwards compatibility. */
export function getWebAppHostNameBinding(args: GetWebAppHostNameBindingArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppHostNameBindingResult> {
    pulumi.log.warn("getWebAppHostNameBinding is deprecated: azure-native:web/v20180201:WebAppHostNameBinding is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppHostNameBinding to guarantee forwards compatibility.")
