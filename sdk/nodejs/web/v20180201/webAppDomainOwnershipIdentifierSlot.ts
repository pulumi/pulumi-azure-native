...
export class WebAppDomainOwnershipIdentifierSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppDomainOwnershipIdentifierSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppDomainOwnershipIdentifierSlot" }, { type: "azurerm:web/v20160801:WebAppDomainOwnershipIdentifierSlot" }, { type: "azurerm:web/v20181101:WebAppDomainOwnershipIdentifierSlot" }, { type: "azurerm:web/v20190801:WebAppDomainOwnershipIdentifierSlot" }, { type: "azurerm:web/v20200601:WebAppDomainOwnershipIdentifierSlot" }] };
