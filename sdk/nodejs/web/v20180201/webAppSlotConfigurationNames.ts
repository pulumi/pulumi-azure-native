...
export class WebAppSlotConfigurationNames extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSlotConfigurationNames {
        pulumi.log.warn("WebAppSlotConfigurationNames is deprecated: azure-native:web/v20180201:WebAppSlotConfigurationNames is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSlotConfigurationNames to guarantee forwards compatibility.")
