...
export class WebAppRelayServiceConnectionSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppRelayServiceConnectionSlot {
        pulumi.log.warn("WebAppRelayServiceConnectionSlot is deprecated: azure-native:web/v20180201:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.")
