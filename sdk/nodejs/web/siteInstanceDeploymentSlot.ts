...
export class SiteInstanceDeploymentSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:web:SiteInstanceDeploymentSlot';
    ...
    constructor(name: string, args: SiteInstanceDeploymentSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:SiteInstanceDeploymentSlot" }, { type: "azure-nextgen:web/v20150801:SiteInstanceDeploymentSlot" }] };
