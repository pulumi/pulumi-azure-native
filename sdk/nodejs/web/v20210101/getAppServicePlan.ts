 ...
 */
/** @deprecated azure-native:web/v20210101:AppServicePlan is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility. */
export function getAppServicePlan(args: GetAppServicePlanArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServicePlanResult> {
    pulumi.log.warn("getAppServicePlan is deprecated: azure-native:web/v20210101:AppServicePlan is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.")
