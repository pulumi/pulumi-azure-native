 ...
 *
 * @deprecated azure-native:web/v20210101:WebAppMetadata is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppMetadata to guarantee forwards compatibility.
 */
export class WebAppMetadata extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppMetadata {
        pulumi.log.warn("WebAppMetadata is deprecated: azure-native:web/v20210101:WebAppMetadata is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppMetadata to guarantee forwards compatibility.")
