 ...
 */
/** @deprecated azure-native:web/v20210101:WebAppSourceControlSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSourceControlSlot to guarantee forwards compatibility. */
export function getWebAppSourceControlSlot(args: GetWebAppSourceControlSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSourceControlSlotResult> {
    pulumi.log.warn("getWebAppSourceControlSlot is deprecated: azure-native:web/v20210101:WebAppSourceControlSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSourceControlSlot to guarantee forwards compatibility.")
