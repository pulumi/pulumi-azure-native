 ...
 *
 * @deprecated azure-native:web/v20210101:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210115:AppServiceEnvironment to guarantee forwards compatibility.
 */
export class AppServiceEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServiceEnvironment {
        pulumi.log.warn("AppServiceEnvironment is deprecated: azure-native:web/v20210101:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210115:AppServiceEnvironment to guarantee forwards compatibility.")
