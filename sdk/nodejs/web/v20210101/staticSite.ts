 ...
 *
 * @deprecated azure-native:web/v20210101:StaticSite is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:StaticSite to guarantee forwards compatibility.
 */
export class StaticSite extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticSite {
        pulumi.log.warn("StaticSite is deprecated: azure-native:web/v20210101:StaticSite is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:StaticSite to guarantee forwards compatibility.")
        return new StaticSite(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210101:StaticSite';
     ...
     */
    public readonly buildProperties!: pulumi.Output<outputs.web.v20210101.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.web.v20210101.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.web.v20210101.SkuDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly templateProperties!: pulumi.Output<outputs.web.v20210101.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly userProvidedFunctionApps!: pulumi.Output<outputs.web.v20210101.StaticSiteUserProvidedFunctionAppResponse[]>;
    ...
    constructor(name: string, args: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSite" }, { type: "azure-native:web/v20190801:StaticSite" }, { type: "azure-native:web/v20200601:StaticSite" }, { type: "azure-native:web/v20200901:StaticSite" }, { type: "azure-native:web/v20201001:StaticSite" }, { type: "azure-native:web/v20201201:StaticSite" }, { type: "azure-native:web/v20210115:StaticSite" }, { type: "azure-native:web/v20210201:StaticSite" }, { type: "azure-native:web/v20210301:StaticSite" }, { type: "azure-native:web/v20220301:StaticSite" }, { type: "azure-native:web/v20220901:StaticSite" }] };
