...
export class WebAppSiteExtensionSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSiteExtensionSlot {
        pulumi.log.warn("WebAppSiteExtensionSlot is deprecated: azure-native:web/v20210101:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSiteExtensionSlot to guarantee forwards compatibility.")
