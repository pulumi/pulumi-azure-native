...
export class ConnectionGateway extends pulumi.CustomResource {
    ...
    declare public readonly properties: pulumi.Output<outputs.web.ConnectionGatewayDefinitionResponseProperties>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: ConnectionGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.connectionGatewayName === undefined && !opts.urn) {
