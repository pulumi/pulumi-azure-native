...
export class ConnectionGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectionGatewayState, opts?: pulumi.CustomResourceOptions): ConnectionGateway {
        return new ConnectionGateway(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web:ConnectionGateway';
    ...
    constructor(name: string, argsOrState?: ConnectionGatewayArgs | ConnectionGatewayState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ConnectionGatewayState | undefined;
 ...
 * The gateway definition
 */
export interface ConnectionGatewayState {
    /**
     * Resource ETag
     */
    ...
    readonly properties: pulumi.Input<inputs.web.ConnectionGatewayDefinitionResponseProperties>;
    /**
     * Resource tags
     */
