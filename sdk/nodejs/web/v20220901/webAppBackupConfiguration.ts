...
export class WebAppBackupConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly backupSchedule!: pulumi.Output<outputs.web.v20220901.BackupScheduleResponse | undefined>;
    /**
     * Databases included in the backup.
     */
    public readonly databases!: pulumi.Output<outputs.web.v20220901.DatabaseBackupSettingResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppBackupConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["backupSchedule"] = args ? (args.backupSchedule ? pulumi.output(args.backupSchedule).apply(inputs.web.v20220901.backupScheduleArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppBackupConfiguration" }, { type: "azure-native:web/v20160801:WebAppBackupConfiguration" }, { type: "azure-native:web/v20181101:WebAppBackupConfiguration" }, { type: "azure-native:web/v20190801:WebAppBackupConfiguration" }, { type: "azure-native:web/v20201001:WebAppBackupConfiguration" }, { type: "azure-native:web/v20201201:WebAppBackupConfiguration" }, { type: "azure-native:web/v20210101:WebAppBackupConfiguration" }, { type: "azure-native:web/v20210115:WebAppBackupConfiguration" }, { type: "azure-native:web/v20210201:WebAppBackupConfiguration" }, { type: "azure-native:web/v20220301:WebAppBackupConfiguration" }] };
