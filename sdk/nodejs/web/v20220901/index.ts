...
// Export enums:
export * from "../../types/enums/web/v20220901";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:web/v20220901:WebAppAuthSettingsV2WithoutSecrets":
                return new WebAppAuthSettingsV2WithoutSecrets(name, <any>undefined, { urn })
            case "azure-native:web/v20220901:WebAppAuthSettingsV2WithoutSecretsSlot":
