...
export class StaticSite extends pulumi.CustomResource {
     ...
     */
    public readonly buildProperties!: pulumi.Output<outputs.web.v20220901.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly databaseConnections!: pulumi.Output<outputs.web.v20220901.DatabaseConnectionOverviewResponse[]>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.web.v20220901.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly linkedBackends!: pulumi.Output<outputs.web.v20220901.StaticSiteLinkedBackendResponse[]>;
    /**
     * Resource Location.
     */
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.web.v20220901.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.web.v20220901.SkuDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly templateProperties!: pulumi.Output<outputs.web.v20220901.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly userProvidedFunctionApps!: pulumi.Output<outputs.web.v20220901.StaticSiteUserProvidedFunctionAppResponse[]>;
    ...
    constructor(name: string, args: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSite" }, { type: "azure-native:web/v20190801:StaticSite" }, { type: "azure-native:web/v20201001:StaticSite" }, { type: "azure-native:web/v20201201:StaticSite" }, { type: "azure-native:web/v20210101:StaticSite" }, { type: "azure-native:web/v20210115:StaticSite" }, { type: "azure-native:web/v20210201:StaticSite" }, { type: "azure-native:web/v20220301:StaticSite" }] };
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    buildProperties?: pulumi.Input<inputs.web.v20220901.StaticSiteBuildPropertiesArgs>;
    /**
     * State indicating the status of the enterprise grade CDN serving traffic to the static web app.
     */
    enterpriseGradeCdnStatus?: pulumi.Input<string | enums.web.v20220901.EnterpriseGradeCdnStatus>;
    /**
     * Managed service identity.
     */
     ...
     * Description of a SKU for a scalable resource.
     */
    sku?: pulumi.Input<inputs.web.v20220901.SkuDescriptionArgs>;
    /**
     * State indicating whether staging environments are allowed or not allowed for a static web app.
     */
    stagingEnvironmentPolicy?: pulumi.Input<enums.web.v20220901.StagingEnvironmentPolicy>;
    /**
     * Resource tags.
     */
     ...
     * Template options for generating a new repository.
     */
    templateProperties?: pulumi.Input<inputs.web.v20220901.StaticSiteTemplateOptionsArgs>;
}
