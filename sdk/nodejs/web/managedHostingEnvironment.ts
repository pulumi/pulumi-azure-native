...
export class ManagedHostingEnvironment extends pulumi.CustomResource {
     ...
     */
    public readonly environmentCapacities!: pulumi.Output<outputs.web.StampCapacityResponse[] | undefined>;
    /**
     ...
     */
    public readonly networkAccessControlList!: pulumi.Output<outputs.web.NetworkAccessControlEntryResponse[] | undefined>;
    /**
     ...
     */
    public readonly vipMappings!: pulumi.Output<outputs.web.VirtualIPMappingResponse[] | undefined>;
    /**
     * Description of the hostingEnvironment's (App Service Environment) virtual network
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.web.VirtualNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly workerPools!: pulumi.Output<outputs.web.WorkerPoolResponse[] | undefined>;
    ...
    constructor(name: string, args: ManagedHostingEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web:ManagedHostingEnvironment" }, { type: "azure-native:web/latest:ManagedHostingEnvironment" }, { type: "azure-nextgen:web/latest:ManagedHostingEnvironment" }, { type: "azure-native:web/v20150801:ManagedHostingEnvironment" }, { type: "azure-nextgen:web/v20150801:ManagedHostingEnvironment" }] };
...
export interface ManagedHostingEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the hosting environment
     */
    readonly clusterSettings?: pulumi.Input<pulumi.Input<inputs.web.NameValuePair>[]>;
    /**
     * Edition of the metadata database for the hostingEnvironment (App Service Environment) e.g. "Standard"
     */
     ...
     * Current total, used, and available worker capacities
     */
    readonly environmentCapacities?: pulumi.Input<pulumi.Input<inputs.web.StampCapacity>[]>;
    /**
     * True/false indicating whether the hostingEnvironment (App Service Environment) is healthy
     */
     ...
     * Specifies which endpoints to serve internally in the hostingEnvironment's (App Service Environment) VNET
     */
    readonly internalLoadBalancingMode?: pulumi.Input<enums.web.InternalLoadBalancingMode>;
    /**
     * Number of IP SSL addresses reserved for this hostingEnvironment (App Service Environment)
     */
     ...
     * Access control list for controlling traffic to the hostingEnvironment (App Service Environment)
     */
    readonly networkAccessControlList?: pulumi.Input<pulumi.Input<inputs.web.NetworkAccessControlEntry>[]>;
    /**
     * Provisioning state of the hostingEnvironment (App Service Environment)
     */
    readonly provisioningState?: pulumi.Input<enums.web.ProvisioningState>;
    /**
     * Resource group of the hostingEnvironment (App Service Environment)
     */
     ...
     * Current status of the hostingEnvironment (App Service Environment)
     */
    readonly status: pulumi.Input<enums.web.HostingEnvironmentStatus>;
    /**
     * Subscription of the hostingEnvironment (App Service Environment)
     */
     ...
     * Description of IP SSL mapping for this hostingEnvironment (App Service Environment)
     */
    readonly vipMappings?: pulumi.Input<pulumi.Input<inputs.web.VirtualIPMapping>[]>;
    /**
     * Description of the hostingEnvironment's (App Service Environment) virtual network
     */
    readonly virtualNetwork?: pulumi.Input<inputs.web.VirtualNetworkProfile>;
    /**
     * Name of the hostingEnvironment's (App Service Environment) virtual network
     */
     ...
     * Description of worker pools with worker size ids, VM sizes, and number of workers in each pool
     */
    readonly workerPools?: pulumi.Input<pulumi.Input<inputs.web.WorkerPool>[]>;
}
