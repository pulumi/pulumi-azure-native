...
export class StaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:StaticSite';
     ...
     */
    public readonly buildProperties!: pulumi.Output<outputs.web.preview.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.web.preview.SkuDescriptionResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:StaticSite" }, { type: "azurerm:web/v20190801:StaticSite" }, { type: "azurerm:web/v20200601:StaticSite" }] };
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    readonly buildProperties?: pulumi.Input<inputs.web.preview.StaticSiteBuildProperties>;
    /**
     * Kind of resource.
     */
     ...
     * Description of a SKU for a scalable resource.
     */
    readonly sku?: pulumi.Input<inputs.web.preview.SkuDescription>;
    /**
     * Resource tags.
     */
