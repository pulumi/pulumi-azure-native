...
export class SiteInstanceDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:SiteInstanceDeployment';
    ...
    constructor(name: string, argsOrState?: SiteInstanceDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:SiteInstanceDeployment" }, { type: "azurerm:web/v20150801:SiteInstanceDeployment" }] };
