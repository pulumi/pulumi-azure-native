...
export class WebAppSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:WebAppSlot';
     ...
     */
    public readonly cloningInfo!: pulumi.Output<outputs.web.preview.CloningInfoResponse | undefined>;
    /**
     ...
     */
    public readonly hostNameSslStates!: pulumi.Output<outputs.web.preview.HostNameSslStateResponse[] | undefined>;
    /**
     ...
     */
    public readonly hostingEnvironmentProfile!: pulumi.Output<outputs.web.preview.HostingEnvironmentProfileResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.web.preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly siteConfig!: pulumi.Output<outputs.web.preview.SiteConfigResponse | undefined>;
    /**
     * Status of the last deployment slot swap operation.
     */
    public /*out*/ readonly slotSwapStatus!: pulumi.Output<outputs.web.preview.SlotSwapStatusResponse>;
    /**
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppSlot" }, { type: "azurerm:web/v20150801:WebAppSlot" }, { type: "azurerm:web/v20160801:WebAppSlot" }, { type: "azurerm:web/v20180201:WebAppSlot" }, { type: "azurerm:web/v20181101:WebAppSlot" }, { type: "azurerm:web/v20190801:WebAppSlot" }, { type: "azurerm:web/v20200601:WebAppSlot" }] };
...
export interface WebAppSlotArgs {
     ...
     * If specified during app creation, the app is cloned from a source app.
     */
    readonly cloningInfo?: pulumi.Input<inputs.web.preview.CloningInfo>;
    /**
     * Size of the function container.
     */
     ...
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    readonly hostNameSslStates?: pulumi.Input<pulumi.Input<inputs.web.preview.HostNameSslState>[]>;
    /**
     * <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
     *  If <code>true</code>, the app is only accessible via API management process.
     */
     ...
     * App Service Environment to use for the app.
     */
    readonly hostingEnvironmentProfile?: pulumi.Input<inputs.web.preview.HostingEnvironmentProfile>;
    /**
     * HttpsOnly: configures a web site to accept only https requests. Issues redirect for
     * http requests
     */
     ...
     * Managed service identity.
     */
    readonly identity?: pulumi.Input<inputs.web.preview.ManagedServiceIdentity>;
    /**
     * Obsolete: Hyper-V sandbox.
     */
     ...
     * Configuration of the app.
     */
    readonly siteConfig?: pulumi.Input<inputs.web.preview.SiteConfig>;
    /**
