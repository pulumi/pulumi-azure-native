...
export class ConnectionGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:ConnectionGateway';
    ...
    public readonly properties!: pulumi.Output<outputs.web.preview.ConnectionGatewayDefinitionResponseProperties>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: ConnectionGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:ConnectionGateway" }, { type: "azurerm:web/v20160601:ConnectionGateway" }] };
...
export interface ConnectionGatewayArgs {
    ...
    readonly properties?: pulumi.Input<inputs.web.preview.ConnectionGatewayDefinitionProperties>;
    /**
     * The resource group
     */
