...
export function getWebAppPrivateEndpointConnection(args: GetWebAppPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppPrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:web/preview:getWebAppPrivateEndpointConnection", {
        "name": args.name,
...
export interface GetWebAppPrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: outputs.web.preview.ArmIdWrapperResponse;
    /**
     * The state of a private link connection
     */
    readonly privateLinkServiceConnectionState?: outputs.web.preview.PrivateLinkConnectionStateResponse;
