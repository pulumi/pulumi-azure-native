...
export function getStaticSite(args: GetStaticSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetStaticSiteResult> {
    ...
    return pulumi.runtime.invoke("azurerm:web/preview:getStaticSite", {
        "name": args.name,
...
export interface GetStaticSiteResult {
     ...
     */
    readonly buildProperties?: outputs.web.preview.StaticSiteBuildPropertiesResponse;
    /**
     ...
     */
    readonly sku?: outputs.web.preview.SkuDescriptionResponse;
    /**
     * Resource tags.
     */
