...
export class WebAppSourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:WebAppSourceControl';
    ...
    constructor(name: string, args: WebAppSourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppSourceControl" }, { type: "azurerm:web/v20150801:WebAppSourceControl" }, { type: "azurerm:web/v20160801:WebAppSourceControl" }, { type: "azurerm:web/v20180201:WebAppSourceControl" }, { type: "azurerm:web/v20181101:WebAppSourceControl" }, { type: "azurerm:web/v20190801:WebAppSourceControl" }, { type: "azurerm:web/v20200601:WebAppSourceControl" }] };
