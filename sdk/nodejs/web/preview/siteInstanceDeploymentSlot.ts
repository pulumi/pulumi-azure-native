...
export class SiteInstanceDeploymentSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:SiteInstanceDeploymentSlot';
    ...
    constructor(name: string, args: SiteInstanceDeploymentSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:SiteInstanceDeploymentSlot" }, { type: "azurerm:web/v20150801:SiteInstanceDeploymentSlot" }] };
