...
export class CustomApi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:CustomApi';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.web.preview.CustomApiPropertiesDefinitionResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: CustomApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:CustomApi" }, { type: "azurerm:web/v20160601:CustomApi" }] };
...
export interface CustomApiArgs {
     ...
     * Custom API properties
     */
    readonly properties?: pulumi.Input<inputs.web.preview.CustomApiPropertiesDefinition>;
    /**
     * The resource group
     */
