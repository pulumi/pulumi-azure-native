...
export class WebAppPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:WebAppPrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.web.preview.ArmIdWrapperResponse | undefined>;
    /**
     * The state of a private link connection
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.web.preview.PrivateLinkConnectionStateResponse | undefined>;
    ...
    constructor(name: string, argsOrState?: WebAppPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppPrivateEndpointConnection" }, { type: "azurerm:web/v20190801:WebAppPrivateEndpointConnection" }, { type: "azurerm:web/v20200601:WebAppPrivateEndpointConnection" }] };
...
export interface WebAppPrivateEndpointConnectionArgs {
     ...
     * The state of a private link connection
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.web.preview.PrivateLinkConnectionState>;
    /**
