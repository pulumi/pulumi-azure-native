...
export class WebAppSourceControlSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:WebAppSourceControlSlot';
