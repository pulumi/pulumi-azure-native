...
export function getAppServiceEnvironment(args: GetAppServiceEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceEnvironmentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:web/preview:getAppServiceEnvironment", {
        "name": args.name,
...
export interface GetAppServiceEnvironmentResult {
     ...
     */
    readonly clusterSettings?: outputs.web.preview.NameValuePairResponse[];
    /**
     ...
     */
    readonly environmentCapacities: outputs.web.preview.StampCapacityResponse[];
    /**
     ...
     */
    readonly networkAccessControlList?: outputs.web.preview.NetworkAccessControlEntryResponse[];
    /**
     ...
     */
    readonly vipMappings: outputs.web.preview.VirtualIPMappingResponse[];
    /**
     * Description of the Virtual Network.
     */
    readonly virtualNetwork: outputs.web.preview.VirtualNetworkProfileResponse;
    /**
     ...
     */
    readonly workerPools: outputs.web.preview.WorkerPoolResponse[];
}
