...
export class WebAppDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:WebAppDeployment';
    ...
    constructor(name: string, args: WebAppDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppDeployment" }, { type: "azurerm:web/v20150801:WebAppDeployment" }, { type: "azurerm:web/v20160801:WebAppDeployment" }, { type: "azurerm:web/v20180201:WebAppDeployment" }, { type: "azurerm:web/v20181101:WebAppDeployment" }, { type: "azurerm:web/v20190801:WebAppDeployment" }, { type: "azurerm:web/v20200601:WebAppDeployment" }] };
