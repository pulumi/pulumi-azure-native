...
export class AppServiceEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:AppServiceEnvironment';
     ...
     */
    public readonly clusterSettings!: pulumi.Output<outputs.web.preview.NameValuePairResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly environmentCapacities!: pulumi.Output<outputs.web.preview.StampCapacityResponse[]>;
    /**
     ...
     */
    public readonly networkAccessControlList!: pulumi.Output<outputs.web.preview.NetworkAccessControlEntryResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vipMappings!: pulumi.Output<outputs.web.preview.VirtualIPMappingResponse[]>;
    /**
     * Description of the Virtual Network.
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.web.preview.VirtualNetworkProfileResponse>;
    /**
     ...
     */
    public readonly workerPools!: pulumi.Output<outputs.web.preview.WorkerPoolResponse[]>;
    ...
    constructor(name: string, argsOrState?: AppServiceEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:AppServiceEnvironment" }, { type: "azurerm:web/v20150801:AppServiceEnvironment" }, { type: "azurerm:web/v20160901:AppServiceEnvironment" }, { type: "azurerm:web/v20180201:AppServiceEnvironment" }, { type: "azurerm:web/v20190801:AppServiceEnvironment" }, { type: "azurerm:web/v20200601:AppServiceEnvironment" }] };
...
export interface AppServiceEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the App Service Environment.
     */
    readonly clusterSettings?: pulumi.Input<pulumi.Input<inputs.web.preview.NameValuePair>[]>;
    /**
     * DNS suffix of the App Service Environment.
     */
     ...
     * Access control list for controlling traffic to the App Service Environment.
     */
    readonly networkAccessControlList?: pulumi.Input<pulumi.Input<inputs.web.preview.NetworkAccessControlEntry>[]>;
    /**
     ...
     * Description of the Virtual Network.
     */
    readonly virtualNetwork: pulumi.Input<inputs.web.preview.VirtualNetworkProfile>;
    /**
     * Name of the Virtual Network for the App Service Environment.
     */
     ...
     * Description of worker pools with worker size IDs, VM sizes, and number of workers in each pool.
     */
    readonly workerPools: pulumi.Input<pulumi.Input<inputs.web.preview.WorkerPool>[]>;
}
