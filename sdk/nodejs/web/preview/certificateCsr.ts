...
export class CertificateCsr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:CertificateCsr';
    ...
    constructor(name: string, args: CertificateCsrArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:CertificateCsr" }, { type: "azurerm:web/v20150801:CertificateCsr" }] };
