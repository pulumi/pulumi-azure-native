...
export class ManagedHostingEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/preview:ManagedHostingEnvironment';
     ...
     */
    public readonly environmentCapacities!: pulumi.Output<outputs.web.preview.StampCapacityResponse[] | undefined>;
    /**
     ...
     */
    public readonly vipMappings!: pulumi.Output<outputs.web.preview.VirtualIPMappingResponse[] | undefined>;
    /**
     * Description of the hostingEnvironment's (App Service Environment) virtual network
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.web.preview.VirtualNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly workerPools!: pulumi.Output<outputs.web.preview.WorkerPoolResponse[] | undefined>;
    ...
    constructor(name: string, args: ManagedHostingEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:ManagedHostingEnvironment" }, { type: "azurerm:web/v20150801:ManagedHostingEnvironment" }] };
...
export interface ManagedHostingEnvironmentArgs {
     ...
     * Current total, used, and available worker capacities
     */
    readonly environmentCapacities?: pulumi.Input<pulumi.Input<inputs.web.preview.StampCapacity>[]>;
    /**
     * True/false indicating whether the hostingEnvironment (App Service Environment) is healthy
     */
     ...
     * Description of IP SSL mapping for this hostingEnvironment (App Service Environment)
     */
    readonly vipMappings?: pulumi.Input<pulumi.Input<inputs.web.preview.VirtualIPMapping>[]>;
    /**
     * Description of the hostingEnvironment's (App Service Environment) virtual network
     */
