 ...
 * Premier add-on.
 *
 * @deprecated azure-native:web/v20200601:WebAppPremierAddOn is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility.
 */
export class WebAppPremierAddOn extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppPremierAddOn {
        pulumi.log.warn("WebAppPremierAddOn is deprecated: azure-native:web/v20200601:WebAppPremierAddOn is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility.")
