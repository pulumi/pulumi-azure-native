...
export class WebAppDomainOwnershipIdentifier extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppDomainOwnershipIdentifierArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/v20160801:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/v20180201:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/v20181101:WebAppDomainOwnershipIdentifier" }, { type: "azurerm:web/v20190801:WebAppDomainOwnershipIdentifier" }] };
