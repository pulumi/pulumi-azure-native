 ...
 */
/** @deprecated azure-native:web/v20200601:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:AppServiceEnvironment to guarantee forwards compatibility. */
export function getAppServiceEnvironment(args: GetAppServiceEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceEnvironmentResult> {
    pulumi.log.warn("getAppServiceEnvironment is deprecated: azure-native:web/v20200601:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:AppServiceEnvironment to guarantee forwards compatibility.")
