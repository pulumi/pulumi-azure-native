...
export function listWebAppConnectionStrings(args: ListWebAppConnectionStringsArgs, opts?: pulumi.InvokeOptions): Promise<ListWebAppConnectionStringsResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:web/v20200601:listWebAppConnectionStrings", {
        "name": args.name,
...
export interface ListWebAppConnectionStringsResult {
     ...
     * Connection strings.
     */
    readonly properties: {[key: string]: outputs.web.v20200601.ConnStringValueTypePairInvokeResponse};
    /**
     * Resource type.
     */
