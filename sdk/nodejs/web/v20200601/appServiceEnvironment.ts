...
export class AppServiceEnvironment extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: AppServiceEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:AppServiceEnvironment" }, { type: "azurerm:web/v20150801:AppServiceEnvironment" }, { type: "azurerm:web/v20160901:AppServiceEnvironment" }, { type: "azurerm:web/v20180201:AppServiceEnvironment" }, { type: "azurerm:web/v20190801:AppServiceEnvironment" }] };
