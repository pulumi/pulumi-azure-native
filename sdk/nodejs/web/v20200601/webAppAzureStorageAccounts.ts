...
export class WebAppAzureStorageAccounts extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAzureStorageAccounts {
        pulumi.log.warn("WebAppAzureStorageAccounts is deprecated: azure-native:web/v20200601:WebAppAzureStorageAccounts is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAzureStorageAccounts to guarantee forwards compatibility.")
...
export interface WebAppAzureStorageAccountsArgs {
     ...
     * Azure storage accounts.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20200601.AzureStorageInfoValueArgs>}>;
    /**
