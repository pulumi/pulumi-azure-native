...
export class WebAppSiteExtension extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppSiteExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppSiteExtension" }, { type: "azurerm:web/preview:WebAppSiteExtension" }, { type: "azurerm:web/v20160801:WebAppSiteExtension" }, { type: "azurerm:web/v20180201:WebAppSiteExtension" }, { type: "azurerm:web/v20181101:WebAppSiteExtension" }, { type: "azurerm:web/v20190801:WebAppSiteExtension" }] };
