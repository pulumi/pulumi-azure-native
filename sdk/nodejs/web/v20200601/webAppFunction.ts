...
export class WebAppFunction extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20160801:WebAppFunction" }, { type: "azurerm:web/v20180201:WebAppFunction" }, { type: "azurerm:web/v20181101:WebAppFunction" }, { type: "azurerm:web/v20190801:WebAppFunction" }] };
