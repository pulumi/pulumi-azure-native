...
export class WebAppHostNameBinding extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppHostNameBindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppHostNameBinding" }, { type: "azurerm:web/preview:WebAppHostNameBinding" }, { type: "azurerm:web/v20150801:WebAppHostNameBinding" }, { type: "azurerm:web/v20160801:WebAppHostNameBinding" }, { type: "azurerm:web/v20180201:WebAppHostNameBinding" }, { type: "azurerm:web/v20181101:WebAppHostNameBinding" }, { type: "azurerm:web/v20190801:WebAppHostNameBinding" }] };
