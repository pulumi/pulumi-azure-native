...
export class WebAppDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20200601:WebAppDeployment';
    ...
    constructor(name: string, argsOrState?: WebAppDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppDeployment" }, { type: "azurerm:web/preview:WebAppDeployment" }, { type: "azurerm:web/v20150801:WebAppDeployment" }, { type: "azurerm:web/v20160801:WebAppDeployment" }, { type: "azurerm:web/v20180201:WebAppDeployment" }, { type: "azurerm:web/v20181101:WebAppDeployment" }, { type: "azurerm:web/v20190801:WebAppDeployment" }] };
