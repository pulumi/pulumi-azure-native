...
export function getWebAppHybridConnection(args: GetWebAppHybridConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppHybridConnectionResult> {
    pulumi.log.warn("getWebAppHybridConnection is deprecated: azure-native:web/v20200601:WebAppHybridConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppHybridConnection to guarantee forwards compatibility.")
