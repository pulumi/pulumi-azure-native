 ...
 *
 * @deprecated azure-native:web/v20200601:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppAuthSettingsSlot to guarantee forwards compatibility.
 */
export class WebAppAuthSettingsSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAuthSettingsSlot {
        pulumi.log.warn("WebAppAuthSettingsSlot is deprecated: azure-native:web/v20200601:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppAuthSettingsSlot to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: WebAppAuthSettingsSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20150801:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20160801:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20180201:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20181101:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20190801:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20200901:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20201001:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20201201:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20210101:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20210115:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20210201:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20210301:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20220301:WebAppAuthSettingsSlot" }, { type: "azure-native:web/v20220901:WebAppAuthSettingsSlot" }] };
...
export interface WebAppAuthSettingsSlotArgs {
     ...
     * action is set to "RedirectToLoginPage".
     */
    defaultProvider?: pulumi.Input<enums.web.v20200601.BuiltInAuthenticationProvider>;
    /**
     * <code>true</code> if the Authentication / Authorization feature is enabled for the current app; otherwise, <code>false</code>.
     */
     ...
     * The action to take when an unauthenticated client attempts to access the app.
     */
    unauthenticatedClientAction?: pulumi.Input<enums.web.v20200601.UnauthenticatedClientAction>;
    /**
     * Gets a value indicating whether the issuer should be a valid HTTPS url and be validated as such.
     */
