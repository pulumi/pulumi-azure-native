...
export class WebAppSourceControlSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSourceControlSlot {
        return new WebAppSourceControlSlot(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20200601:WebAppSourceControlSlot';
    ...
    constructor(name: string, argsOrState?: WebAppSourceControlSlotArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as WebAppSourceControlSlotArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppSourceControlSlot" }, { type: "azurerm:web/preview:WebAppSourceControlSlot" }, { type: "azurerm:web/v20150801:WebAppSourceControlSlot" }, { type: "azurerm:web/v20160801:WebAppSourceControlSlot" }, { type: "azurerm:web/v20180201:WebAppSourceControlSlot" }, { type: "azurerm:web/v20181101:WebAppSourceControlSlot" }, { type: "azurerm:web/v20190801:WebAppSourceControlSlot" }] };
