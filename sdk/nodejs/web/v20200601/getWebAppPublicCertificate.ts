...
export function getWebAppPublicCertificate(args: GetWebAppPublicCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppPublicCertificateResult> {
    pulumi.log.warn("getWebAppPublicCertificate is deprecated: azure-native:web/v20200601:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPublicCertificate to guarantee forwards compatibility.")
