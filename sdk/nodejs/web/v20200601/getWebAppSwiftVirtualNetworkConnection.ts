 ...
 */
/** @deprecated azure-native:web/v20200601:WebAppSwiftVirtualNetworkConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnection to guarantee forwards compatibility. */
export function getWebAppSwiftVirtualNetworkConnection(args: GetWebAppSwiftVirtualNetworkConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSwiftVirtualNetworkConnectionResult> {
    pulumi.log.warn("getWebAppSwiftVirtualNetworkConnection is deprecated: azure-native:web/v20200601:WebAppSwiftVirtualNetworkConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnection to guarantee forwards compatibility.")
