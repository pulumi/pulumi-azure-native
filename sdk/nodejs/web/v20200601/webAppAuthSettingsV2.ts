...
export class WebAppAuthSettingsV2 extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppAuthSettingsV2Args, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20200601:WebAppAuthSettingsV2" }, { type: "azure-native:web:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web:WebAppAuthSettingsV2" }, { type: "azure-native:web/v20200901:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web/v20200901:WebAppAuthSettingsV2" }, { type: "azure-native:web/v20201001:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web/v20201001:WebAppAuthSettingsV2" }, { type: "azure-native:web/v20201201:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web/v20201201:WebAppAuthSettingsV2" }, { type: "azure-native:web/v20210101:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web/v20210101:WebAppAuthSettingsV2" }, { type: "azure-native:web/v20210115:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web/v20210115:WebAppAuthSettingsV2" }, { type: "azure-native:web/v20210201:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web/v20210201:WebAppAuthSettingsV2" }] };
...
export interface WebAppAuthSettingsV2Args {
    globalValidation?: pulumi.Input<inputs.web.v20200601.GlobalValidationArgs>;
    httpSettings?: pulumi.Input<inputs.web.v20200601.HttpSettingsArgs>;
    identityProviders?: pulumi.Input<inputs.web.v20200601.IdentityProvidersArgs>;
    /**
     * Kind of resource.
     */
    kind?: pulumi.Input<string>;
    login?: pulumi.Input<inputs.web.v20200601.LoginArgs>;
    /**
     * Name of web app.
     */
    name: pulumi.Input<string>;
    platform?: pulumi.Input<inputs.web.v20200601.AuthPlatformArgs>;
    /**
