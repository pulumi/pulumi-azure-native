...
export class WebAppAuthSettingsV2 extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppAuthSettingsV2Args, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web/v20200901:WebAppAuthSettingsV2" }, { type: "azure-nextgen:web/v20201001:WebAppAuthSettingsV2" }] };
