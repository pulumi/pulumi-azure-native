...
export class WebAppVnetConnectionSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppVnetConnectionSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppVnetConnectionSlot" }, { type: "azurerm:web/v20150801:WebAppVnetConnectionSlot" }, { type: "azurerm:web/v20160801:WebAppVnetConnectionSlot" }, { type: "azurerm:web/v20180201:WebAppVnetConnectionSlot" }, { type: "azurerm:web/v20181101:WebAppVnetConnectionSlot" }, { type: "azurerm:web/v20190801:WebAppVnetConnectionSlot" }] };
