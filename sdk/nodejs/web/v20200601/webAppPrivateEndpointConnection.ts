...
export class WebAppPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppPrivateEndpointConnection" }, { type: "azurerm:web/preview:WebAppPrivateEndpointConnection" }, { type: "azurerm:web/v20190801:WebAppPrivateEndpointConnection" }] };
