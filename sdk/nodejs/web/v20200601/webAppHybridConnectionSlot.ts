...
export class WebAppHybridConnectionSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppHybridConnectionSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppHybridConnectionSlot" }, { type: "azurerm:web/v20160801:WebAppHybridConnectionSlot" }, { type: "azurerm:web/v20180201:WebAppHybridConnectionSlot" }, { type: "azurerm:web/v20181101:WebAppHybridConnectionSlot" }, { type: "azurerm:web/v20190801:WebAppHybridConnectionSlot" }] };
