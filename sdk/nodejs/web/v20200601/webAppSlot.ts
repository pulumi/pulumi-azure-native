 ...
 *
 * @deprecated azure-native:web/v20200601:WebAppSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSlot to guarantee forwards compatibility.
 */
export class WebAppSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSlot {
        pulumi.log.warn("WebAppSlot is deprecated: azure-native:web/v20200601:WebAppSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSlot to guarantee forwards compatibility.")
