...
export class WebAppSlot extends pulumi.CustomResource {
     ...
     */
    public readonly cloningInfo!: pulumi.Output<outputs.web.v20200601.CloningInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppSlot" }, { type: "azure-nextgen:web:WebAppSlot" }, { type: "azure-native:web/latest:WebAppSlot" }, { type: "azure-nextgen:web/latest:WebAppSlot" }, { type: "azure-native:web/v20150801:WebAppSlot" }, { type: "azure-nextgen:web/v20150801:WebAppSlot" }, { type: "azure-native:web/v20160801:WebAppSlot" }, { type: "azure-nextgen:web/v20160801:WebAppSlot" }, { type: "azure-native:web/v20180201:WebAppSlot" }, { type: "azure-nextgen:web/v20180201:WebAppSlot" }, { type: "azure-native:web/v20181101:WebAppSlot" }, { type: "azure-nextgen:web/v20181101:WebAppSlot" }, { type: "azure-native:web/v20190801:WebAppSlot" }, { type: "azure-nextgen:web/v20190801:WebAppSlot" }, { type: "azure-native:web/v20200901:WebAppSlot" }, { type: "azure-nextgen:web/v20200901:WebAppSlot" }, { type: "azure-native:web/v20201001:WebAppSlot" }, { type: "azure-nextgen:web/v20201001:WebAppSlot" }] };
...
export interface WebAppSlotArgs {
     ...
     * If specified during app creation, the app is cloned from a source app.
     */
    readonly cloningInfo?: pulumi.Input<inputs.web.v20200601.CloningInfo>;
    /**
     * Size of the function container.
     */
     ...
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    readonly hostNameSslStates?: pulumi.Input<pulumi.Input<inputs.web.v20200601.HostNameSslState>[]>;
    /**
     * <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
     *  If <code>true</code>, the app is only accessible via API management process.
     */
     ...
     * Managed service identity.
     */
    readonly identity?: pulumi.Input<inputs.web.v20200601.ManagedServiceIdentity>;
    /**
     * Obsolete: Hyper-V sandbox.
     */
