...
export class StaticSiteCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StaticSiteCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web:StaticSiteCustomDomain" }, { type: "azure-native:web/v20201201:StaticSiteCustomDomain" }, { type: "azure-nextgen:web/v20201201:StaticSiteCustomDomain" }] };
