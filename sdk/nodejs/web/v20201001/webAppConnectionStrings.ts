 ...
 *
 * ```sh
 * $ pulumi import azure-native:web/v20201001:WebAppConnectionStrings myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/config/connectionstrings 
 * ```
 */
