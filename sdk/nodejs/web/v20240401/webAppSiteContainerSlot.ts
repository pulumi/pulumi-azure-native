...
export class WebAppSiteContainerSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20240401:WebAppSiteContainerSlot';
     ...
     */
    public readonly environmentVariables!: pulumi.Output<outputs.web.v20240401.EnvironmentVariableResponse[] | undefined>;
    /**
     * Image Name
     */
     ...
     */
    public readonly volumeMounts!: pulumi.Output<outputs.web.v20240401.VolumeMountResponse[] | undefined>;
    ...
    constructor(name: string, args: WebAppSiteContainerSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web/v20231201:WebAppSiteContainerSlot" }, { type: "azure-native:web:WebAppSiteContainerSlot" }] };
