...
export class StaticSiteBuildDatabaseConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20240401:StaticSiteBuildDatabaseConnection';
     ...
     */
    public /*out*/ readonly configurationFiles!: pulumi.Output<outputs.web.v20240401.StaticSiteDatabaseConnectionConfigurationFileOverviewResponse[]>;
    /**
    ...
    constructor(name: string, args: StaticSiteBuildDatabaseConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSiteBuildDatabaseConnection" }, { type: "azure-native:web/v20220901:StaticSiteBuildDatabaseConnection" }, { type: "azure-native:web/v20230101:StaticSiteBuildDatabaseConnection" }, { type: "azure-native:web/v20231201:StaticSiteBuildDatabaseConnection" }] };
