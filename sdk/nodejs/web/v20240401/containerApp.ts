...
export class ContainerApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20240401:ContainerApp';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.web.v20240401.ConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly template!: pulumi.Output<outputs.web.v20240401.TemplateResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["configuration"] = args ? (args.configuration ? pulumi.output(args.configuration).apply(inputs.web.v20240401.configurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:ContainerApp" }, { type: "azure-native:web/v20210301:ContainerApp" }, { type: "azure-native:web/v20220301:ContainerApp" }, { type: "azure-native:web/v20220901:ContainerApp" }, { type: "azure-native:web/v20230101:ContainerApp" }, { type: "azure-native:web/v20231201:ContainerApp" }] };
...
export interface ContainerAppArgs {
     ...
     * Non versioned Container App configuration properties.
     */
    configuration?: pulumi.Input<inputs.web.v20240401.ConfigurationArgs>;
    /**
     * Kind of resource. If the resource is an app, you can refer to https://github.com/Azure/app-service-linux-docs/blob/master/Things_You_Should_Know/kind_property.md#app-service-resource-kind-reference for details supported values for kind.
     */
     ...
     * Container App versioned application definition.
     */
    template?: pulumi.Input<inputs.web.v20240401.TemplateArgs>;
}
