...
export class WebApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20240401:WebApp';
     ...
     */
    public readonly daprConfig!: pulumi.Output<outputs.web.v20240401.DaprConfigResponse | undefined>;
    /**
     ...
     */
    public readonly dnsConfiguration!: pulumi.Output<outputs.web.v20240401.SiteDnsConfigResponse | undefined>;
    /**
     ...
     * Extended Location.
     */
    public readonly extendedLocation!: pulumi.Output<outputs.web.v20240401.ExtendedLocationResponse | undefined>;
    /**
     * Configuration specific of the Azure Function app.
     */
    public readonly functionAppConfig!: pulumi.Output<outputs.web.v20240401.FunctionAppConfigResponse | undefined>;
    /**
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    public readonly hostNameSslStates!: pulumi.Output<outputs.web.v20240401.HostNameSslStateResponse[] | undefined>;
    /**
     ...
     */
    public readonly hostingEnvironmentProfile!: pulumi.Output<outputs.web.v20240401.HostingEnvironmentProfileResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.web.v20240401.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly resourceConfig!: pulumi.Output<outputs.web.v20240401.ResourceConfigResponse | undefined>;
    /**
     ...
     */
    public readonly siteConfig!: pulumi.Output<outputs.web.v20240401.SiteConfigResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly slotSwapStatus!: pulumi.Output<outputs.web.v20240401.SlotSwapStatusResponse>;
    /**
    ...
    constructor(name: string, args: WebAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["daprConfig"] = args ? (args.daprConfig ? pulumi.output(args.daprConfig).apply(inputs.web.v20240401.daprConfigArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["siteConfig"] = args ? (args.siteConfig ? pulumi.output(args.siteConfig).apply(inputs.web.v20240401.siteConfigArgsProvideDefaults) : undefined) : undefined;
...
export interface WebAppArgs {
     ...
     * Specifies the scope of uniqueness for the default hostname during resource creation
     */
    autoGeneratedDomainNameLabelScope?: pulumi.Input<enums.web.v20240401.AutoGeneratedDomainNameLabelScope>;
    /**
     * <code>true</code> to enable client affinity; <code>false</code> to stop sending session affinity cookies, which route client requests in the same session to the same instance. Default is <code>true</code>.
     */
     ...
     * - ClientCertEnabled: true and ClientCertMode: Optional means ClientCert is optional or accepted.
     */
    clientCertMode?: pulumi.Input<enums.web.v20240401.ClientCertMode>;
    /**
     * If specified during app creation, the app is cloned from a source app.
     */
    cloningInfo?: pulumi.Input<inputs.web.v20240401.CloningInfoArgs>;
    /**
     * Size of the function container.
     */
     ...
     * Dapr configuration of the app.
     */
    daprConfig?: pulumi.Input<inputs.web.v20240401.DaprConfigArgs>;
    /**
     * Property to configure various DNS related settings for a site.
     */
    dnsConfiguration?: pulumi.Input<inputs.web.v20240401.SiteDnsConfigArgs>;
    /**
     * <code>true</code> if the app is enabled; otherwise, <code>false</code>. Setting this value to false disables the app (takes the app offline).
     */
     ...
     * Extended Location.
     */
    extendedLocation?: pulumi.Input<inputs.web.v20240401.ExtendedLocationArgs>;
    /**
     * Configuration specific of the Azure Function app.
     */
    functionAppConfig?: pulumi.Input<inputs.web.v20240401.FunctionAppConfigArgs>;
    /**
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    hostNameSslStates?: pulumi.Input<pulumi.Input<inputs.web.v20240401.HostNameSslStateArgs>[]>;
    /**
     * <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
     *  If <code>true</code>, the app is only accessible via API management process.
     */
     ...
     * App Service Environment to use for the app.
     */
    hostingEnvironmentProfile?: pulumi.Input<inputs.web.v20240401.HostingEnvironmentProfileArgs>;
    /**
     * HttpsOnly: configures a web site to accept only https requests. Issues redirect for
     * http requests
     */
     ...
     * Managed service identity.
     */
    identity?: pulumi.Input<inputs.web.v20240401.ManagedServiceIdentityArgs>;
    /**
     * Specifies the IP mode of the app.
     */
    ipMode?: pulumi.Input<enums.web.v20240401.IPMode>;
    /**
     * Obsolete: Hyper-V sandbox.
     */
     ...
     * Site redundancy mode
     */
    redundancyMode?: pulumi.Input<enums.web.v20240401.RedundancyMode>;
    /**
     * <code>true</code> if reserved; otherwise, <code>false</code>.
     */
     ...
     * Function app resource requirements.
     */
    resourceConfig?: pulumi.Input<inputs.web.v20240401.ResourceConfigArgs>;
    /**
     ...
     * Configuration of the app.
     */
    siteConfig?: pulumi.Input<inputs.web.v20240401.SiteConfigArgs>;
    /**
     * Checks if Customer provided storage account is required
     */
