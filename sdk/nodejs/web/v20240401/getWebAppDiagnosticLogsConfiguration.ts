...
export function getWebAppDiagnosticLogsConfiguration(args: GetWebAppDiagnosticLogsConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppDiagnosticLogsConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20240401:getWebAppDiagnosticLogsConfiguration", {
        "name": args.name,
...
export interface GetWebAppDiagnosticLogsConfigurationResult {
     ...
     */
    readonly applicationLogs?: outputs.web.v20240401.ApplicationLogsConfigResponse;
    /**
     * Detailed error messages configuration.
     */
    readonly detailedErrorMessages?: outputs.web.v20240401.EnabledConfigResponse;
    /**
     * Failed requests tracing configuration.
     */
    readonly failedRequestsTracing?: outputs.web.v20240401.EnabledConfigResponse;
    /**
     * HTTP logs configuration.
     */
    readonly httpLogs?: outputs.web.v20240401.HttpLogsConfigResponse;
    /**
     * Resource Id.
     */
    readonly id: string;
...
export function getWebAppDiagnosticLogsConfigurationOutput(args: GetWebAppDiagnosticLogsConfigurationOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetWebAppDiagnosticLogsConfigurationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:web/v20240401:getWebAppDiagnosticLogsConfiguration", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
