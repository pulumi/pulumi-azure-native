 ...
 *
 * @deprecated azure-native:web/v20210201:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServiceEnvironment to guarantee forwards compatibility.
 */
export class AppServiceEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServiceEnvironment {
        pulumi.log.warn("AppServiceEnvironment is deprecated: azure-native:web/v20210201:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServiceEnvironment to guarantee forwards compatibility.")
        return new AppServiceEnvironment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210201:AppServiceEnvironment';
     ...
     */
    public readonly clusterSettings!: pulumi.Output<outputs.web.v20210201.NameValuePairResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.web.v20210201.VirtualNetworkProfileResponse>;
    /**
...
export interface AppServiceEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the App Service Environment.
     */
    clusterSettings?: pulumi.Input<pulumi.Input<inputs.web.v20210201.NameValuePairArgs>[]>;
    /**
     * Dedicated Host Count
     */
     ...
     * Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment.
     */
    internalLoadBalancingMode?: pulumi.Input<string | enums.web.v20210201.LoadBalancingMode>;
    /**
     * Number of IP SSL addresses reserved for the App Service Environment.
     */
     ...
     * Description of the Virtual Network.
     */
    virtualNetwork: pulumi.Input<inputs.web.v20210201.VirtualNetworkProfileArgs>;
    /**
     * Whether or not this App Service Environment is zone-redundant.
     */
