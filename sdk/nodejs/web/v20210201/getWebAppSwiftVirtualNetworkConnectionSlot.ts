...
export function getWebAppSwiftVirtualNetworkConnectionSlot(args: GetWebAppSwiftVirtualNetworkConnectionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSwiftVirtualNetworkConnectionSlotResult> {
    pulumi.log.warn("getWebAppSwiftVirtualNetworkConnectionSlot is deprecated: azure-native:web/v20210201:WebAppSwiftVirtualNetworkConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSwiftVirtualNetworkConnectionSlot to guarantee forwards compatibility.")
