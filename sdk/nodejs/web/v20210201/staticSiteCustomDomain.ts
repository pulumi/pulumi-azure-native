...
export class StaticSiteCustomDomain extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticSiteCustomDomain {
        pulumi.log.warn("StaticSiteCustomDomain is deprecated: azure-native:web/v20210201:StaticSiteCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSiteCustomDomain to guarantee forwards compatibility.")
        return new StaticSiteCustomDomain(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210201:StaticSiteCustomDomain';
    ...
    constructor(name: string, args: StaticSiteCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSiteCustomDomain" }, { type: "azure-native:web/v20201201:StaticSiteCustomDomain" }, { type: "azure-native:web/v20210101:StaticSiteCustomDomain" }, { type: "azure-native:web/v20210115:StaticSiteCustomDomain" }, { type: "azure-native:web/v20210301:StaticSiteCustomDomain" }, { type: "azure-native:web/v20220301:StaticSiteCustomDomain" }, { type: "azure-native:web/v20220901:StaticSiteCustomDomain" }] };
