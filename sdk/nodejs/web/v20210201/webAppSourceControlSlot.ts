 ...
 *
 * @deprecated azure-native:web/v20210201:WebAppSourceControlSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSourceControlSlot to guarantee forwards compatibility.
 */
export class WebAppSourceControlSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210201:WebAppSourceControlSlot';
     ...
     */
    public readonly gitHubActionConfiguration!: pulumi.Output<outputs.web.v20210201.GitHubActionConfigurationResponse | undefined>;
    /**
...
export interface WebAppSourceControlSlotArgs {
     ...
     * If GitHub Action is selected, than the associated configuration.
     */
    gitHubActionConfiguration?: pulumi.Input<inputs.web.v20210201.GitHubActionConfigurationArgs>;
    /**
     * <code>true</code> if this is deployed via GitHub action.
     */
