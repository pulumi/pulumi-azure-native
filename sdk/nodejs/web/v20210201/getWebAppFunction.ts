 ...
 */
/** @deprecated azure-native:web/v20210201:WebAppFunction is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppFunction to guarantee forwards compatibility. */
export function getWebAppFunction(args: GetWebAppFunctionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppFunctionResult> {
    pulumi.log.warn("getWebAppFunction is deprecated: azure-native:web/v20210201:WebAppFunction is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppFunction to guarantee forwards compatibility.")
