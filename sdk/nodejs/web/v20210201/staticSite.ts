...
export class StaticSite extends pulumi.CustomResource {
     ...
     */
    public readonly buildProperties!: pulumi.Output<outputs.web.v20210201.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.web.v20210201.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.web.v20210201.SkuDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly templateProperties!: pulumi.Output<outputs.web.v20210201.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly userProvidedFunctionApps!: pulumi.Output<outputs.web.v20210201.StaticSiteUserProvidedFunctionAppResponse[]>;
    ...
    constructor(name: string, args: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20210201:StaticSite" }, { type: "azure-native:web:StaticSite" }, { type: "azure-nextgen:web:StaticSite" }, { type: "azure-native:web/v20190801:StaticSite" }, { type: "azure-nextgen:web/v20190801:StaticSite" }, { type: "azure-native:web/v20200601:StaticSite" }, { type: "azure-nextgen:web/v20200601:StaticSite" }, { type: "azure-native:web/v20200901:StaticSite" }, { type: "azure-nextgen:web/v20200901:StaticSite" }, { type: "azure-native:web/v20201001:StaticSite" }, { type: "azure-nextgen:web/v20201001:StaticSite" }, { type: "azure-native:web/v20201201:StaticSite" }, { type: "azure-nextgen:web/v20201201:StaticSite" }, { type: "azure-native:web/v20210101:StaticSite" }, { type: "azure-nextgen:web/v20210101:StaticSite" }, { type: "azure-native:web/v20210115:StaticSite" }, { type: "azure-nextgen:web/v20210115:StaticSite" }] };
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    buildProperties?: pulumi.Input<inputs.web.v20210201.StaticSiteBuildPropertiesArgs>;
    /**
     * Managed service identity.
     */
     ...
     * Description of a SKU for a scalable resource.
     */
    sku?: pulumi.Input<inputs.web.v20210201.SkuDescriptionArgs>;
    /**
     * State indicating whether staging environments are allowed or not allowed for a static web app.
     */
    stagingEnvironmentPolicy?: pulumi.Input<enums.web.v20210201.StagingEnvironmentPolicy>;
    /**
     * Resource tags.
     */
     ...
     * Template options for generating a new repository.
     */
    templateProperties?: pulumi.Input<inputs.web.v20210201.StaticSiteTemplateOptionsArgs>;
}
