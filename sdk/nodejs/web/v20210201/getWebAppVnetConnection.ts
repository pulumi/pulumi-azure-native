 ...
 */
/** @deprecated azure-native:web/v20210201:WebAppVnetConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppVnetConnection to guarantee forwards compatibility. */
export function getWebAppVnetConnection(args: GetWebAppVnetConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppVnetConnectionResult> {
    pulumi.log.warn("getWebAppVnetConnection is deprecated: azure-native:web/v20210201:WebAppVnetConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppVnetConnection to guarantee forwards compatibility.")
