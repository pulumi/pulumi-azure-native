...
export function getWebAppSlot(args: GetWebAppSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSlotResult> {
    pulumi.log.warn("getWebAppSlot is deprecated: azure-native:web/v20210201:WebAppSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSlot to guarantee forwards compatibility.")
