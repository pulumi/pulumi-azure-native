...
export class ConnectionGateway extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectionGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20160601:ConnectionGateway" }, { type: "azure-native:web:ConnectionGateway" }, { type: "azure-nextgen:web:ConnectionGateway" }, { type: "azure-native:web/latest:ConnectionGateway" }, { type: "azure-nextgen:web/latest:ConnectionGateway" }] };
