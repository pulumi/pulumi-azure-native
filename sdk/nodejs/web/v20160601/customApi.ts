...
export class CustomApi extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CustomApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20160601:CustomApi" }, { type: "azure-native:web:CustomApi" }, { type: "azure-nextgen:web:CustomApi" }] };
...
export interface CustomApiArgs {
     ...
     * Custom API properties
     */
    readonly properties?: pulumi.Input<inputs.web.v20160601.CustomApiPropertiesDefinitionArgs>;
    /**
     * The resource group
     */
