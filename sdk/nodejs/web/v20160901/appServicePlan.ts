 ...
 *
 * const appServicePlan = new azurerm.web.v20160901.AppServicePlan("appServicePlan", {
 *     kind: "app",
 *     location: "East US",
 *     name: "testsf6141",
...
export class AppServicePlan extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: AppServicePlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:AppServicePlan" }, { type: "azurerm:web/v20150801:AppServicePlan" }, { type: "azurerm:web/v20180201:AppServicePlan" }, { type: "azurerm:web/v20190801:AppServicePlan" }, { type: "azurerm:web/v20200601:AppServicePlan" }] };
