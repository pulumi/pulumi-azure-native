...
export class Csr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web:Csr';
    ...
    public readonly properties!: pulumi.Output<outputs.web.CsrResponseProperties>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: CsrArgs | CsrState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Csr.__pulumiType, name, inputs, opts);
    }
}
...
export interface CsrState {
    ...
    readonly properties: pulumi.Input<inputs.web.CsrResponseProperties>;
    /**
     * Resource tags
     */
...
export interface CsrArgs {
     ...
     */
    readonly name: pulumi.Input<string>;
    readonly properties?: pulumi.Input<inputs.web.CsrProperties>;
    /**
