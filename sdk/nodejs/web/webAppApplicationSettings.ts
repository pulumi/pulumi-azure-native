...
export class WebAppApplicationSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:web:WebAppApplicationSettings';
