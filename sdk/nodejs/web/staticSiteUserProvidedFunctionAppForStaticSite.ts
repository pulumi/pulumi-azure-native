...
export class StaticSiteUserProvidedFunctionAppForStaticSite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StaticSiteUserProvidedFunctionAppForStaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web:StaticSiteUserProvidedFunctionAppForStaticSite" }, { type: "azure-native:web/latest:StaticSiteUserProvidedFunctionAppForStaticSite" }, { type: "azure-nextgen:web/latest:StaticSiteUserProvidedFunctionAppForStaticSite" }, { type: "azure-native:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSite" }, { type: "azure-nextgen:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSite" }] };
