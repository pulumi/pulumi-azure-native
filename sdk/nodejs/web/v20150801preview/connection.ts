...
export class Connection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20150801preview:Connection';
    ...
    constructor(name: string, args: ConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:Connection" }, { type: "azurerm:web/preview:Connection" }, { type: "azurerm:web/v20160601:Connection" }] };
