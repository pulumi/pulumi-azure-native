...
export class CustomApi extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomApiState, opts?: pulumi.CustomResourceOptions): CustomApi {
        return new CustomApi(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web:CustomApi';
     ...
     * Resource tags
     */
    public readonly tags!: pulumi.Output<outputs.web.TagsDictionaryResponse | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, argsOrState?: CustomApiArgs | CustomApiState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as CustomApiState | undefined;
...
export interface CustomApiState {
     ...
     * Custom API properties
     */
    readonly properties: pulumi.Input<inputs.web.CustomApiPropertiesDefinitionResponse>;
    /**
     * Resource tags
     */
    readonly tags?: pulumi.Input<inputs.web.TagsDictionaryResponse>;
    /**
     * Resource type
     */
...
export interface CustomApiArgs {
     ...
     * Resource tags
     */
    readonly tags?: pulumi.Input<inputs.web.TagsDictionary>;
}
