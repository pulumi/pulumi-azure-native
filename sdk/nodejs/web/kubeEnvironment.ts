...
export class KubeEnvironment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KubeEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web:KubeEnvironment" }, { type: "azure-native:web/v20210101:KubeEnvironment" }, { type: "azure-nextgen:web/v20210101:KubeEnvironment" }] };
...
export interface KubeEnvironmentArgs {
     ...
     * supported
     */
    readonly appLogsConfiguration?: pulumi.Input<inputs.web.AppLogsConfigurationArgs>;
    /**
     * Cluster configuration which determines the ARC cluster
     * components types. Eg: Choosing between BuildService kind,
     * FrontEnd Service ArtifactsStorageType etc.
     */
    readonly arcConfiguration?: pulumi.Input<inputs.web.ArcConfigurationArgs>;
    /**
     * Extended Location.
     */
    readonly extendedLocation?: pulumi.Input<inputs.web.ExtendedLocationArgs>;
    /**
     * Only visible within Vnet/Subnet
     */
