...
export class StaticSite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20201201:StaticSite" }, { type: "azure-native:web:StaticSite" }, { type: "azure-nextgen:web:StaticSite" }, { type: "azure-native:web/latest:StaticSite" }, { type: "azure-nextgen:web/latest:StaticSite" }, { type: "azure-native:web/v20190801:StaticSite" }, { type: "azure-nextgen:web/v20190801:StaticSite" }, { type: "azure-native:web/v20200601:StaticSite" }, { type: "azure-nextgen:web/v20200601:StaticSite" }, { type: "azure-native:web/v20200901:StaticSite" }, { type: "azure-nextgen:web/v20200901:StaticSite" }, { type: "azure-native:web/v20201001:StaticSite" }, { type: "azure-nextgen:web/v20201001:StaticSite" }] };
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    readonly buildProperties?: pulumi.Input<inputs.web.v20201201.StaticSiteBuildProperties>;
    /**
     * Managed service identity.
     */
     ...
     * Template options for generating a new repository.
     */
    readonly templateProperties?: pulumi.Input<inputs.web.v20201201.StaticSiteTemplateOptions>;
}
