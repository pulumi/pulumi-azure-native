...
export class WebAppPremierAddOn extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppPremierAddOn {
        pulumi.log.warn("WebAppPremierAddOn is deprecated: azure-native:web/v20201201:WebAppPremierAddOn is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPremierAddOn to guarantee forwards compatibility.")
