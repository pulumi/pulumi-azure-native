...
export class WebAppBackupConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppBackupConfiguration {
        pulumi.log.warn("WebAppBackupConfiguration is deprecated: azure-native:web/v20201201:WebAppBackupConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppBackupConfiguration to guarantee forwards compatibility.")
