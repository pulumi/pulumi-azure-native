...
export class WebAppDiagnosticLogsConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppDiagnosticLogsConfiguration {
        pulumi.log.warn("WebAppDiagnosticLogsConfiguration is deprecated: azure-native:web/v20201201:WebAppDiagnosticLogsConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDiagnosticLogsConfiguration to guarantee forwards compatibility.")
        return new WebAppDiagnosticLogsConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20201201:WebAppDiagnosticLogsConfiguration';
     ...
     */
    public readonly applicationLogs!: pulumi.Output<outputs.web.v20201201.ApplicationLogsConfigResponse | undefined>;
    /**
     * Detailed error messages configuration.
     */
    public readonly detailedErrorMessages!: pulumi.Output<outputs.web.v20201201.EnabledConfigResponse | undefined>;
    /**
     * Failed requests tracing configuration.
     */
    public readonly failedRequestsTracing!: pulumi.Output<outputs.web.v20201201.EnabledConfigResponse | undefined>;
    /**
     * HTTP logs configuration.
     */
    public readonly httpLogs!: pulumi.Output<outputs.web.v20201201.HttpLogsConfigResponse | undefined>;
    /**
     * Kind of resource.
     */
    ...
    constructor(name: string, args: WebAppDiagnosticLogsConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20150801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20160801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20180201:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20181101:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20190801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20200601:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20200901:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20201001:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20210101:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20210115:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20210201:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20210301:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20220301:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20220901:WebAppDiagnosticLogsConfiguration" }] };
...
export interface WebAppDiagnosticLogsConfigurationArgs {
     ...
     * Application logs configuration.
     */
    applicationLogs?: pulumi.Input<inputs.web.v20201201.ApplicationLogsConfigArgs>;
    /**
     * Detailed error messages configuration.
     */
    detailedErrorMessages?: pulumi.Input<inputs.web.v20201201.EnabledConfigArgs>;
    /**
     * Failed requests tracing configuration.
     */
    failedRequestsTracing?: pulumi.Input<inputs.web.v20201201.EnabledConfigArgs>;
    /**
     * HTTP logs configuration.
     */
    httpLogs?: pulumi.Input<inputs.web.v20201201.HttpLogsConfigArgs>;
    /**
     * Kind of resource.
     */
