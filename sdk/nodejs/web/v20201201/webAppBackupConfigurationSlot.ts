...
export class WebAppBackupConfigurationSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20201201:WebAppBackupConfigurationSlot';
     ...
     */
    public readonly backupSchedule!: pulumi.Output<outputs.web.v20201201.BackupScheduleResponse | undefined>;
    /**
     * Databases included in the backup.
     */
    public readonly databases!: pulumi.Output<outputs.web.v20201201.DatabaseBackupSettingResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppBackupConfigurationSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["backupSchedule"] = args ? (args.backupSchedule ? pulumi.output(args.backupSchedule).apply(inputs.web.v20201201.backupScheduleArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20160801:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20181101:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20190801:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20201001:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20210101:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20210115:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20210201:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20220301:WebAppBackupConfigurationSlot" }, { type: "azure-native:web/v20220901:WebAppBackupConfigurationSlot" }] };
