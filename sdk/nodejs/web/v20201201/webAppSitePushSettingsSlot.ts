...
export class WebAppSitePushSettingsSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSitePushSettingsSlot {
        pulumi.log.warn("WebAppSitePushSettingsSlot is deprecated: azure-native:web/v20201201:WebAppSitePushSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettingsSlot to guarantee forwards compatibility.")
