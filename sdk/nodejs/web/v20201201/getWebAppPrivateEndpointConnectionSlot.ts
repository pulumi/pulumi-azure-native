...
export function getWebAppPrivateEndpointConnectionSlot(args: GetWebAppPrivateEndpointConnectionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppPrivateEndpointConnectionSlotResult> {
    pulumi.log.warn("getWebAppPrivateEndpointConnectionSlot is deprecated: azure-native:web/v20201201:WebAppPrivateEndpointConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPrivateEndpointConnectionSlot to guarantee forwards compatibility.")
