 ...
 *
 * ```sh
 * $ pulumi import azure-native:web/v20201201:WebAppSourceControl myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/sourcecontrols/web 
 * ```
 */
