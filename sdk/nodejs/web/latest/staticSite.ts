 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSite'.
 */
export class StaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:StaticSite';
     ...
     */
    public readonly templateProperties!: pulumi.Output<outputs.web.latest.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly userProvidedFunctionApps!: pulumi.Output<outputs.web.latest.StaticSiteUserProvidedFunctionAppResponse[]>;
...
export interface StaticSiteArgs {
     ...
     * Template options for generating a new repository.
     */
    readonly templateProperties?: pulumi.Input<inputs.web.latest.StaticSiteTemplateOptions>;
}
