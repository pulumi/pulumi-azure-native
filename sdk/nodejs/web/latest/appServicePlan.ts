...
export class AppServicePlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:AppServicePlan';
     ...
     */
    public readonly kubeEnvironmentProfile!: pulumi.Output<outputs.web.latest.KubeEnvironmentProfileResponse | undefined>;
    /**
     * Resource Location.
     */
...
export interface AppServicePlanArgs {
     ...
     * Specification for the Kubernetes Environment to use for the App Service plan.
     */
    readonly kubeEnvironmentProfile?: pulumi.Input<inputs.web.latest.KubeEnvironmentProfile>;
    /**
     * Resource Location.
     */
