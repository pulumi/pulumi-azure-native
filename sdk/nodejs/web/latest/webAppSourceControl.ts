...
export class WebAppSourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/latest:WebAppSourceControl';
    ...
    constructor(name: string, argsOrState?: WebAppSourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/preview:WebAppSourceControl" }, { type: "azurerm:web/v20150801:WebAppSourceControl" }, { type: "azurerm:web/v20160801:WebAppSourceControl" }, { type: "azurerm:web/v20180201:WebAppSourceControl" }, { type: "azurerm:web/v20181101:WebAppSourceControl" }, { type: "azurerm:web/v20190801:WebAppSourceControl" }, { type: "azurerm:web/v20200601:WebAppSourceControl" }] };
