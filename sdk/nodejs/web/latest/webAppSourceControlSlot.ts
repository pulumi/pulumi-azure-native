...
export class WebAppSourceControlSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:WebAppSourceControlSlot';
