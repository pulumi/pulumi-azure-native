...
export class StaticSiteUserProvidedFunctionAppForStaticSiteBuild extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticSiteUserProvidedFunctionAppForStaticSiteBuild {
        pulumi.log.warn("StaticSiteUserProvidedFunctionAppForStaticSiteBuild is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSiteBuild'.")
        return new StaticSiteUserProvidedFunctionAppForStaticSiteBuild(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:StaticSiteUserProvidedFunctionAppForStaticSiteBuild';
    ...
    constructor(name: string, args: StaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:StaticSiteUserProvidedFunctionAppForStaticSiteBuild" }, { type: "azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSiteBuild" }, { type: "azure-nextgen:web:StaticSiteUserProvidedFunctionAppForStaticSiteBuild" }, { type: "azure-native:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild" }, { type: "azure-nextgen:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild" }] };
