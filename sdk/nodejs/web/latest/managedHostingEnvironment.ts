...
export class ManagedHostingEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/latest:ManagedHostingEnvironment';
    ...
    constructor(name: string, argsOrState?: ManagedHostingEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/preview:ManagedHostingEnvironment" }, { type: "azurerm:web/v20150801:ManagedHostingEnvironment" }] };
