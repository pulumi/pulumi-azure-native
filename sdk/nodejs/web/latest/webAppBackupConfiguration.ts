...
export class WebAppBackupConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:web/latest:WebAppBackupConfiguration';
     ...
     */
    public readonly backupSchedule!: pulumi.Output<outputs.web.latest.BackupScheduleResponse | undefined>;
    /**
     * Databases included in the backup.
     */
    public readonly databases!: pulumi.Output<outputs.web.latest.DatabaseBackupSettingResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppBackupConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20150801:WebAppBackupConfiguration" }, { type: "azure-nextgen:web/v20160801:WebAppBackupConfiguration" }, { type: "azure-nextgen:web/v20180201:WebAppBackupConfiguration" }, { type: "azure-nextgen:web/v20181101:WebAppBackupConfiguration" }, { type: "azure-nextgen:web/v20190801:WebAppBackupConfiguration" }, { type: "azure-nextgen:web/v20200601:WebAppBackupConfiguration" }, { type: "azure-nextgen:web/v20200901:WebAppBackupConfiguration" }] };
...
export interface WebAppBackupConfigurationArgs {
     ...
     * Schedule for the backup if it is executed periodically.
     */
    readonly backupSchedule?: pulumi.Input<inputs.web.latest.BackupSchedule>;
    /**
     * Databases included in the backup.
     */
    readonly databases?: pulumi.Input<pulumi.Input<inputs.web.latest.DatabaseBackupSetting>[]>;
    /**
     * True if the backup schedule is enabled (must be included in that case), false if the backup schedule should be disabled.
     */
