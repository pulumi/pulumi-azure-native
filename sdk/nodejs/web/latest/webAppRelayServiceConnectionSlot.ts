...
export class WebAppRelayServiceConnectionSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:WebAppRelayServiceConnectionSlot';
