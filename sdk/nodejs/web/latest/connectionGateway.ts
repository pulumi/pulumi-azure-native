...
export class ConnectionGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/latest:ConnectionGateway';
    ...
    constructor(name: string, argsOrState?: ConnectionGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/preview:ConnectionGateway" }, { type: "azurerm:web/v20160601:ConnectionGateway" }] };
