...
export class ConnectionGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:ConnectionGateway';
    ...
    public readonly properties!: pulumi.Output<outputs.web.latest.ConnectionGatewayDefinitionResponseProperties>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: ConnectionGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:ConnectionGateway" }, { type: "azure-native:web:ConnectionGateway" }, { type: "azure-nextgen:web:ConnectionGateway" }, { type: "azure-native:web/v20160601:ConnectionGateway" }, { type: "azure-nextgen:web/v20160601:ConnectionGateway" }] };
...
export interface ConnectionGatewayArgs {
    ...
    readonly properties?: pulumi.Input<inputs.web.latest.ConnectionGatewayDefinitionProperties>;
    /**
     * The resource group
     */
