...
export class WebAppSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:WebAppSlot';
     ...
     */
    public readonly cloningInfo!: pulumi.Output<outputs.web.latest.CloningInfoResponse | undefined>;
    /**
     ...
     */
    public readonly hostNameSslStates!: pulumi.Output<outputs.web.latest.HostNameSslStateResponse[] | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.web.latest.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly siteConfig!: pulumi.Output<outputs.web.latest.SiteConfigResponse | undefined>;
    /**
     * Status of the last deployment slot swap operation.
     */
    public /*out*/ readonly slotSwapStatus!: pulumi.Output<outputs.web.latest.SlotSwapStatusResponse>;
    /**
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppSlot" }, { type: "azure-nextgen:web:WebAppSlot" }, { type: "azure-native:web/v20150801:WebAppSlot" }, { type: "azure-nextgen:web/v20150801:WebAppSlot" }, { type: "azure-native:web/v20160801:WebAppSlot" }, { type: "azure-nextgen:web/v20160801:WebAppSlot" }, { type: "azure-native:web/v20180201:WebAppSlot" }, { type: "azure-nextgen:web/v20180201:WebAppSlot" }, { type: "azure-native:web/v20181101:WebAppSlot" }, { type: "azure-nextgen:web/v20181101:WebAppSlot" }, { type: "azure-native:web/v20190801:WebAppSlot" }, { type: "azure-nextgen:web/v20190801:WebAppSlot" }, { type: "azure-native:web/v20200601:WebAppSlot" }, { type: "azure-nextgen:web/v20200601:WebAppSlot" }, { type: "azure-native:web/v20200901:WebAppSlot" }, { type: "azure-nextgen:web/v20200901:WebAppSlot" }, { type: "azure-native:web/v20201001:WebAppSlot" }, { type: "azure-nextgen:web/v20201001:WebAppSlot" }] };
...
export interface WebAppSlotArgs {
     ...
     * - ClientCertEnabled: true and ClientCertMode: Optional means ClientCert is optional or accepted.
     */
    readonly clientCertMode?: pulumi.Input<enums.web.latest.ClientCertMode>;
    /**
     * If specified during app creation, the app is cloned from a source app.
     */
    readonly cloningInfo?: pulumi.Input<inputs.web.latest.CloningInfo>;
    /**
     * Size of the function container.
     */
     ...
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    readonly hostNameSslStates?: pulumi.Input<pulumi.Input<inputs.web.latest.HostNameSslState>[]>;
    /**
     * <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
     *  If <code>true</code>, the app is only accessible via API management process.
     */
     ...
     * Managed service identity.
     */
    readonly identity?: pulumi.Input<inputs.web.latest.ManagedServiceIdentity>;
    /**
     * Obsolete: Hyper-V sandbox.
     */
     ...
     * Site redundancy mode
     */
    readonly redundancyMode?: pulumi.Input<enums.web.latest.RedundancyMode>;
    /**
     * <code>true</code> if reserved; otherwise, <code>false</code>.
     */
