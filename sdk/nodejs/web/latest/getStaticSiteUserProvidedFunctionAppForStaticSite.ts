...
export function getStaticSiteUserProvidedFunctionAppForStaticSite(args: GetStaticSiteUserProvidedFunctionAppForStaticSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetStaticSiteUserProvidedFunctionAppForStaticSiteResult> {
    pulumi.log.warn("getStaticSiteUserProvidedFunctionAppForStaticSite is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSiteUserProvidedFunctionAppForStaticSite'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:web/latest:getStaticSiteUserProvidedFunctionAppForStaticSite", {
