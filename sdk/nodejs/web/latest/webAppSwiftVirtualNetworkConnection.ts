...
export class WebAppSwiftVirtualNetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/latest:WebAppSwiftVirtualNetworkConnection';
    ...
    constructor(name: string, args: WebAppSwiftVirtualNetworkConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20180201:WebAppSwiftVirtualNetworkConnection" }, { type: "azurerm:web/v20181101:WebAppSwiftVirtualNetworkConnection" }, { type: "azurerm:web/v20190801:WebAppSwiftVirtualNetworkConnection" }, { type: "azurerm:web/v20200601:WebAppSwiftVirtualNetworkConnection" }] };
