 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSitePrivateEndpointConnection'.
 */
export class StaticSitePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:StaticSitePrivateEndpointConnection';
    ...
    constructor(name: string, args: StaticSitePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:StaticSitePrivateEndpointConnection" }, { type: "azure-native:web:StaticSitePrivateEndpointConnection" }, { type: "azure-nextgen:web:StaticSitePrivateEndpointConnection" }, { type: "azure-native:web/v20201201:StaticSitePrivateEndpointConnection" }, { type: "azure-nextgen:web/v20201201:StaticSitePrivateEndpointConnection" }] };
