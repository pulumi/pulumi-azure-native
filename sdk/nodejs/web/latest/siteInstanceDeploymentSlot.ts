...
export class SiteInstanceDeploymentSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:SiteInstanceDeploymentSlot';
    ...
    constructor(name: string, args: SiteInstanceDeploymentSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:SiteInstanceDeploymentSlot" }, { type: "azure-native:web:SiteInstanceDeploymentSlot" }, { type: "azure-nextgen:web:SiteInstanceDeploymentSlot" }, { type: "azure-native:web/v20150801:SiteInstanceDeploymentSlot" }, { type: "azure-nextgen:web/v20150801:SiteInstanceDeploymentSlot" }] };
