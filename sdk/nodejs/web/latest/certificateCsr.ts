...
export class CertificateCsr extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CertificateCsr {
        return new CertificateCsr(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/latest:CertificateCsr';
    ...
    constructor(name: string, argsOrState?: CertificateCsrArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CertificateCsrArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/preview:CertificateCsr" }, { type: "azurerm:web/v20150801:CertificateCsr" }] };
