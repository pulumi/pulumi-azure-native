...
export class CertificateCsr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:CertificateCsr';
    ...
    constructor(name: string, args: CertificateCsrArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:CertificateCsr" }, { type: "azure-native:web:CertificateCsr" }, { type: "azure-nextgen:web:CertificateCsr" }, { type: "azure-native:web/v20150801:CertificateCsr" }, { type: "azure-nextgen:web/v20150801:CertificateCsr" }] };
