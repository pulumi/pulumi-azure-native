...
export class WebAppConnectionStringsSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:web/latest:WebAppConnectionStringsSlot';
