...
export class Connection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:Connection';
    ...
    constructor(name: string, args: ConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:Connection" }, { type: "azure-native:web:Connection" }, { type: "azure-nextgen:web:Connection" }, { type: "azure-native:web/v20150801preview:Connection" }, { type: "azure-nextgen:web/v20150801preview:Connection" }, { type: "azure-native:web/v20160601:Connection" }, { type: "azure-nextgen:web/v20160601:Connection" }] };
