...
export class WebAppDiagnosticLogsConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:web/latest:WebAppDiagnosticLogsConfiguration';
     ...
     */
    public readonly applicationLogs!: pulumi.Output<outputs.web.latest.ApplicationLogsConfigResponse | undefined>;
    /**
     * Detailed error messages configuration.
     */
    public readonly detailedErrorMessages!: pulumi.Output<outputs.web.latest.EnabledConfigResponse | undefined>;
    /**
     * Failed requests tracing configuration.
     */
    public readonly failedRequestsTracing!: pulumi.Output<outputs.web.latest.EnabledConfigResponse | undefined>;
    /**
     * HTTP logs configuration.
     */
    public readonly httpLogs!: pulumi.Output<outputs.web.latest.HttpLogsConfigResponse | undefined>;
    /**
     * Kind of resource.
     */
    ...
    constructor(name: string, args: WebAppDiagnosticLogsConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20150801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-nextgen:web/v20160801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-nextgen:web/v20180201:WebAppDiagnosticLogsConfiguration" }, { type: "azure-nextgen:web/v20181101:WebAppDiagnosticLogsConfiguration" }, { type: "azure-nextgen:web/v20190801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-nextgen:web/v20200601:WebAppDiagnosticLogsConfiguration" }, { type: "azure-nextgen:web/v20200901:WebAppDiagnosticLogsConfiguration" }] };
...
export interface WebAppDiagnosticLogsConfigurationArgs {
     ...
     * Application logs configuration.
     */
    readonly applicationLogs?: pulumi.Input<inputs.web.latest.ApplicationLogsConfig>;
    /**
     * Detailed error messages configuration.
     */
    readonly detailedErrorMessages?: pulumi.Input<inputs.web.latest.EnabledConfig>;
    /**
     * Failed requests tracing configuration.
     */
    readonly failedRequestsTracing?: pulumi.Input<inputs.web.latest.EnabledConfig>;
    /**
     * HTTP logs configuration.
     */
    readonly httpLogs?: pulumi.Input<inputs.web.latest.HttpLogsConfig>;
    /**
     * Kind of resource.
     */
