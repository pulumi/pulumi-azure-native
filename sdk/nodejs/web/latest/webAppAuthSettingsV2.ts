...
export class WebAppAuthSettingsV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/latest:WebAppAuthSettingsV2';
