...
export class SiteInstanceDeployment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SiteInstanceDeployment {
        return new SiteInstanceDeployment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/latest:SiteInstanceDeployment';
    ...
    constructor(name: string, argsOrState?: SiteInstanceDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SiteInstanceDeploymentArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/preview:SiteInstanceDeployment" }, { type: "azurerm:web/v20150801:SiteInstanceDeployment" }] };
