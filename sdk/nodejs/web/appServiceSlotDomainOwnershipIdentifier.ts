 ...
 */
export class AppServiceSlotDomainOwnershipIdentifier extends pulumi.CustomResource {
    /**
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web:AppServiceSlotDomainOwnershipIdentifier';

    /**
     * Returns true if the given object is an instance of AppServiceSlotDomainOwnershipIdentifier.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppServiceSlotDomainOwnershipIdentifier {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppServiceSlotDomainOwnershipIdentifier.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: AppServiceSlotDomainOwnershipIdentifierArgs, opts?: pulumi.CustomResourceOptions) {
