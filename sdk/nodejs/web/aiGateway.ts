...
export class AiGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AiGateway {
        return new AiGateway(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web:AiGateway';
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<outputs.web.AiGatewayPropertiesResponse>;
    /**
