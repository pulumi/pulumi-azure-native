...
export class AppServiceSlotFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web:AppServiceSlotFunction';

    /**
     * Returns true if the given object is an instance of AppServiceSlotFunction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppServiceSlotFunction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppServiceSlotFunction.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: AppServiceSlotFunctionArgs, opts?: pulumi.CustomResourceOptions) {
