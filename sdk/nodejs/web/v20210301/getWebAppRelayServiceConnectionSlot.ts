 ...
 */
/** @deprecated azure-native:web/v20210301:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility. */
export function getWebAppRelayServiceConnectionSlot(args: GetWebAppRelayServiceConnectionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppRelayServiceConnectionSlotResult> {
    pulumi.log.warn("getWebAppRelayServiceConnectionSlot is deprecated: azure-native:web/v20210301:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.")
