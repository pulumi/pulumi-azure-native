...
export function getWebApp(args: GetWebAppArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppResult> {
    pulumi.log.warn("getWebApp is deprecated: azure-native:web/v20210301:WebApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebApp to guarantee forwards compatibility.")
