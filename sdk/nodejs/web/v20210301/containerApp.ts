...
export class ContainerApp extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContainerApp {
        pulumi.log.warn("ContainerApp is deprecated: azure-native:web/v20210301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:ContainerApp to guarantee forwards compatibility.")
