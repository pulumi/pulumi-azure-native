 ...
 */
/** @deprecated azure-native:web/v20210301:WebAppDeploymentSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppDeploymentSlot to guarantee forwards compatibility. */
export function getWebAppDeploymentSlot(args: GetWebAppDeploymentSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppDeploymentSlotResult> {
    pulumi.log.warn("getWebAppDeploymentSlot is deprecated: azure-native:web/v20210301:WebAppDeploymentSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppDeploymentSlot to guarantee forwards compatibility.")
