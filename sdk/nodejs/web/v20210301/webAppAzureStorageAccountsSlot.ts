 ...
 *
 * @deprecated azure-native:web/v20210301:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.
 */
export class WebAppAzureStorageAccountsSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAzureStorageAccountsSlot {
        pulumi.log.warn("WebAppAzureStorageAccountsSlot is deprecated: azure-native:web/v20210301:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.")
        return new WebAppAzureStorageAccountsSlot(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210301:WebAppAzureStorageAccountsSlot';
     ...
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.web.v20210301.AzureStorageInfoValueResponse}>;
    /**
     * Resource type.
     */
...
export interface WebAppAzureStorageAccountsSlotArgs {
     ...
     * Azure storage accounts.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20210301.AzureStorageInfoValueArgs>}>;
    /**
