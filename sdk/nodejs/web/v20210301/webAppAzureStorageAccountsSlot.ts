...
export class WebAppAzureStorageAccountsSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAzureStorageAccountsSlot {
        pulumi.log.warn("WebAppAzureStorageAccountsSlot is deprecated: azure-native:web/v20210301:WebAppAzureStorageAccountsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAzureStorageAccountsSlot to guarantee forwards compatibility.")
