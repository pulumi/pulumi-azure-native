...
export class WebAppHybridConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppHybridConnection {
        pulumi.log.warn("WebAppHybridConnection is deprecated: azure-native:web/v20210301:WebAppHybridConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHybridConnection to guarantee forwards compatibility.")
        return new WebAppHybridConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210301:WebAppHybridConnection';
