 ...
 */
/** @deprecated azure-native:web/v20210301:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHybridConnectionSlot to guarantee forwards compatibility. */
export function getWebAppHybridConnectionSlot(args: GetWebAppHybridConnectionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppHybridConnectionSlotResult> {
    pulumi.log.warn("getWebAppHybridConnectionSlot is deprecated: azure-native:web/v20210301:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHybridConnectionSlot to guarantee forwards compatibility.")
