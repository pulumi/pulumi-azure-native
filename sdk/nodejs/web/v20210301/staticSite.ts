 ...
 *
 * @deprecated azure-native:web/v20210301:StaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSite to guarantee forwards compatibility.
 */
export class StaticSite extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticSite {
        pulumi.log.warn("StaticSite is deprecated: azure-native:web/v20210301:StaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSite to guarantee forwards compatibility.")
        return new StaticSite(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210301:StaticSite';
     ...
     */
    public readonly buildProperties!: pulumi.Output<outputs.web.v20210301.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.web.v20210301.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.web.v20210301.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.web.v20210301.SkuDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly templateProperties!: pulumi.Output<outputs.web.v20210301.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly userProvidedFunctionApps!: pulumi.Output<outputs.web.v20210301.StaticSiteUserProvidedFunctionAppResponse[]>;
    ...
    constructor(name: string, args: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSite" }, { type: "azure-native:web/v20190801:StaticSite" }, { type: "azure-native:web/v20200601:StaticSite" }, { type: "azure-native:web/v20200901:StaticSite" }, { type: "azure-native:web/v20201001:StaticSite" }, { type: "azure-native:web/v20201201:StaticSite" }, { type: "azure-native:web/v20210101:StaticSite" }, { type: "azure-native:web/v20210115:StaticSite" }, { type: "azure-native:web/v20210201:StaticSite" }, { type: "azure-native:web/v20220301:StaticSite" }, { type: "azure-native:web/v20220901:StaticSite" }] };
