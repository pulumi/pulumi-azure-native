 ...
 *
 * @deprecated azure-native:web/v20210301:StaticSite is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSite to guarantee forwards compatibility.
 */
export class StaticSite extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticSite {
        pulumi.log.warn("StaticSite is deprecated: azure-native:web/v20210301:StaticSite is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:StaticSite to guarantee forwards compatibility.")
