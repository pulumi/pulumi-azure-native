 ...
 *
 * @deprecated azure-native:web/v20210301:WebAppMetadata is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppMetadata to guarantee forwards compatibility.
 */
export class WebAppMetadata extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppMetadata {
        pulumi.log.warn("WebAppMetadata is deprecated: azure-native:web/v20210301:WebAppMetadata is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppMetadata to guarantee forwards compatibility.")
        return new WebAppMetadata(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210301:WebAppMetadata';
