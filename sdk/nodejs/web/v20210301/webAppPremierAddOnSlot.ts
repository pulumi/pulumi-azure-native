 ...
 * Premier add-on.
 *
 * @deprecated azure-native:web/v20210301:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppPremierAddOnSlot to guarantee forwards compatibility.
 */
export class WebAppPremierAddOnSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppPremierAddOnSlot {
        pulumi.log.warn("WebAppPremierAddOnSlot is deprecated: azure-native:web/v20210301:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppPremierAddOnSlot to guarantee forwards compatibility.")
        return new WebAppPremierAddOnSlot(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210301:WebAppPremierAddOnSlot';
