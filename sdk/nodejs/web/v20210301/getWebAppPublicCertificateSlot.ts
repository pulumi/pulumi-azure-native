 ...
 */
/** @deprecated azure-native:web/v20210301:WebAppPublicCertificateSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppPublicCertificateSlot to guarantee forwards compatibility. */
export function getWebAppPublicCertificateSlot(args: GetWebAppPublicCertificateSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppPublicCertificateSlotResult> {
    pulumi.log.warn("getWebAppPublicCertificateSlot is deprecated: azure-native:web/v20210301:WebAppPublicCertificateSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppPublicCertificateSlot to guarantee forwards compatibility.")
