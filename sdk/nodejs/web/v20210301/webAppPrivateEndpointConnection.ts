 ...
 *
 * @deprecated azure-native:web/v20210301:WebAppPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPrivateEndpointConnection to guarantee forwards compatibility.
 */
export class WebAppPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppPrivateEndpointConnection {
        pulumi.log.warn("WebAppPrivateEndpointConnection is deprecated: azure-native:web/v20210301:WebAppPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPrivateEndpointConnection to guarantee forwards compatibility.")
        return new WebAppPrivateEndpointConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210301:WebAppPrivateEndpointConnection';
