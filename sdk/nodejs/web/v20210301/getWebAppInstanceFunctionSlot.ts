 ...
 */
/** @deprecated azure-native:web/v20210301:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppInstanceFunctionSlot to guarantee forwards compatibility. */
export function getWebAppInstanceFunctionSlot(args: GetWebAppInstanceFunctionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppInstanceFunctionSlotResult> {
    pulumi.log.warn("getWebAppInstanceFunctionSlot is deprecated: azure-native:web/v20210301:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppInstanceFunctionSlot to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:web/v20210301:getWebAppInstanceFunctionSlot", {
