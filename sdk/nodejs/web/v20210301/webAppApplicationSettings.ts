 ...
 *
 * @deprecated azure-native:web/v20210301:WebAppApplicationSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppApplicationSettings to guarantee forwards compatibility.
 */
export class WebAppApplicationSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppApplicationSettings {
        pulumi.log.warn("WebAppApplicationSettings is deprecated: azure-native:web/v20210301:WebAppApplicationSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppApplicationSettings to guarantee forwards compatibility.")
        return new WebAppApplicationSettings(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210301:WebAppApplicationSettings';
