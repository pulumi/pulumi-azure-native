 ...
 *
 * @deprecated azure-native:web/v20210301:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServiceEnvironment to guarantee forwards compatibility.
 */
export class AppServiceEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServiceEnvironment {
        pulumi.log.warn("AppServiceEnvironment is deprecated: azure-native:web/v20210301:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:AppServiceEnvironment to guarantee forwards compatibility.")
        return new AppServiceEnvironment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20210301:AppServiceEnvironment';
     ...
     */
    public readonly clusterSettings!: pulumi.Output<outputs.web.v20210301.NameValuePairResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.web.v20210301.VirtualNetworkProfileResponse>;
    /**
