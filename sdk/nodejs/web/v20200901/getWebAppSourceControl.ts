 ...
 */
/** @deprecated azure-native:web/v20200901:WebAppSourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSourceControl to guarantee forwards compatibility. */
export function getWebAppSourceControl(args: GetWebAppSourceControlArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSourceControlResult> {
    pulumi.log.warn("getWebAppSourceControl is deprecated: azure-native:web/v20200901:WebAppSourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSourceControl to guarantee forwards compatibility.")
