...
export function getStaticSite(args: GetStaticSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetStaticSiteResult> {
    pulumi.log.warn("getStaticSite is deprecated: azure-native:web/v20200901:StaticSite is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:StaticSite to guarantee forwards compatibility.")
