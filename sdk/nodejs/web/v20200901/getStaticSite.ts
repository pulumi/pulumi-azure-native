...
export function getStaticSite(args: GetStaticSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetStaticSiteResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:web/v20200901:getStaticSite", {
        "name": args.name,
...
export interface GetStaticSiteResult {
     ...
     */
    readonly buildProperties?: outputs.web.v20200901.StaticSiteBuildPropertiesInvokeResponse;
    /**
     ...
     */
    readonly sku?: outputs.web.v20200901.SkuDescriptionInvokeResponse;
    /**
