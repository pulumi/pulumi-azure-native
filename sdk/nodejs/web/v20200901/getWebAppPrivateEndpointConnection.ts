...
export function getWebAppPrivateEndpointConnection(args: GetWebAppPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppPrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:web/v20200901:getWebAppPrivateEndpointConnection", {
        "name": args.name,
...
export interface GetWebAppPrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: outputs.web.v20200901.ArmIdWrapperInvokeResponse;
    /**
     * The state of a private link connection
     */
    readonly privateLinkServiceConnectionState?: outputs.web.v20200901.PrivateLinkConnectionStateInvokeResponse;
