...
export function getWebAppPremierAddOnSlot(args: GetWebAppPremierAddOnSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppPremierAddOnSlotResult> {
    pulumi.log.warn("getWebAppPremierAddOnSlot is deprecated: azure-native:web/v20200901:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOnSlot to guarantee forwards compatibility.")
