...
export class WebAppAuthSettingsV2Slot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAuthSettingsV2Slot {
        pulumi.log.warn("WebAppAuthSettingsV2Slot is deprecated: azure-native:web/v20200901:WebAppAuthSettingsV2Slot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAuthSettingsV2Slot to guarantee forwards compatibility.")
