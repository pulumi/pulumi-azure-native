 ...
 *
 * @deprecated azure-native:web/v20200901:WebAppSitePushSettingsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSitePushSettingsSlot to guarantee forwards compatibility.
 */
export class WebAppSitePushSettingsSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSitePushSettingsSlot {
        pulumi.log.warn("WebAppSitePushSettingsSlot is deprecated: azure-native:web/v20200901:WebAppSitePushSettingsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSitePushSettingsSlot to guarantee forwards compatibility.")
