...
export class WebAppRelayServiceConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppRelayServiceConnection {
        pulumi.log.warn("WebAppRelayServiceConnection is deprecated: azure-native:web/v20200901:WebAppRelayServiceConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppRelayServiceConnection to guarantee forwards compatibility.")
