...
export class StaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:web/v20200901:StaticSite';
    ...
    constructor(name: string, args: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web:StaticSite" }, { type: "azure-nextgen:web/latest:StaticSite" }, { type: "azure-nextgen:web/v20190801:StaticSite" }, { type: "azure-nextgen:web/v20200601:StaticSite" }, { type: "azure-nextgen:web/v20201001:StaticSite" }] };
