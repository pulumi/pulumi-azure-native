 ...
 */
/** @deprecated azure-native:web/v20200901:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHybridConnectionSlot to guarantee forwards compatibility. */
export function getWebAppHybridConnectionSlot(args: GetWebAppHybridConnectionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppHybridConnectionSlotResult> {
    pulumi.log.warn("getWebAppHybridConnectionSlot is deprecated: azure-native:web/v20200901:WebAppHybridConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppHybridConnectionSlot to guarantee forwards compatibility.")
