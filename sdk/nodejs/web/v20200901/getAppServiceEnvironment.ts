...
export function getAppServiceEnvironment(args: GetAppServiceEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceEnvironmentResult> {
    pulumi.log.warn("getAppServiceEnvironment is deprecated: azure-native:web/v20200901:AppServiceEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:AppServiceEnvironment to guarantee forwards compatibility.")
