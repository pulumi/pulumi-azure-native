...
export class WebAppPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20200901:WebAppPrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.web.v20200901.ArmIdWrapperResponse | undefined>;
    /**
     * The state of a private link connection
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.web.v20200901.PrivateLinkConnectionStateResponse | undefined>;
    ...
    constructor(name: string, args: WebAppPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/v20200901:WebAppPrivateEndpointConnection" }, { type: "azure-native:web:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web:WebAppPrivateEndpointConnection" }, { type: "azure-native:web/v20190801:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20190801:WebAppPrivateEndpointConnection" }, { type: "azure-native:web/v20200601:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20200601:WebAppPrivateEndpointConnection" }, { type: "azure-native:web/v20201001:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20201001:WebAppPrivateEndpointConnection" }, { type: "azure-native:web/v20201201:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20201201:WebAppPrivateEndpointConnection" }, { type: "azure-native:web/v20210101:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20210101:WebAppPrivateEndpointConnection" }, { type: "azure-native:web/v20210115:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20210115:WebAppPrivateEndpointConnection" }, { type: "azure-native:web/v20210201:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20210201:WebAppPrivateEndpointConnection" }] };
...
export interface WebAppPrivateEndpointConnectionArgs {
     ...
     * The state of a private link connection
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.web.v20200901.PrivateLinkConnectionStateArgs>;
    /**
