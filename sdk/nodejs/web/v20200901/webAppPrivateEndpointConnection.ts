...
export class WebAppPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:web/latest:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20190801:WebAppPrivateEndpointConnection" }, { type: "azure-nextgen:web/v20200601:WebAppPrivateEndpointConnection" }] };
