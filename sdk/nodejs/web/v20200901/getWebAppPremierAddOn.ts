 ...
 */
/** @deprecated azure-native:web/v20200901:WebAppPremierAddOn is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility. */
export function getWebAppPremierAddOn(args: GetWebAppPremierAddOnArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppPremierAddOnResult> {
    pulumi.log.warn("getWebAppPremierAddOn is deprecated: azure-native:web/v20200901:WebAppPremierAddOn is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility.")
