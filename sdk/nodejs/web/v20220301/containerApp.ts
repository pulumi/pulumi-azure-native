...
export class ContainerApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220301:ContainerApp';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.web.v20220301.ConfigurationResponse | undefined>;
    /**
     * Kind of resource.
     */
     ...
     */
    public readonly template!: pulumi.Output<outputs.web.v20220301.TemplateResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["configuration"] = args ? (args.configuration ? pulumi.output(args.configuration).apply(inputs.web.v20220301.configurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:ContainerApp" }, { type: "azure-native:web/v20210301:ContainerApp" }, { type: "azure-native:web/v20220901:ContainerApp" }, { type: "azure-native:web/v20230101:ContainerApp" }, { type: "azure-native:web/v20231201:ContainerApp" }, { type: "azure-native:web/v20240401:ContainerApp" }] };
...
export interface ContainerAppArgs {
     ...
     * Non versioned Container App configuration properties.
     */
    configuration?: pulumi.Input<inputs.web.v20220301.ConfigurationArgs>;
    /**
     * Kind of resource.
     */
     ...
     * Container App versioned application definition.
     */
    template?: pulumi.Input<inputs.web.v20220301.TemplateArgs>;
}
