 ...
 */
/** @deprecated azure-native:web/v20220301:WebAppSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSlot to guarantee forwards compatibility. */
export function getWebAppSlot(args: GetWebAppSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSlotResult> {
    pulumi.log.warn("getWebAppSlot is deprecated: azure-native:web/v20220301:WebAppSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSlot to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:web/v20220301:getWebAppSlot", {
        "name": args.name,
