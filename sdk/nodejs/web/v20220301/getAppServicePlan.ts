...
export function getAppServicePlan(args: GetAppServicePlanArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServicePlanResult> {
    pulumi.log.warn("getAppServicePlan is deprecated: azure-native:web/v20220301:AppServicePlan is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.")
...
export interface GetAppServicePlanResult {
     ...
     */
    readonly kubeEnvironmentProfile?: outputs.web.v20220301.KubeEnvironmentProfileResponse;
    /**
     * Resource Location.
     */
     ...
     */
    readonly sku?: outputs.web.v20220301.SkuDescriptionResponse;
    /**
