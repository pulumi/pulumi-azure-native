 ...
 *
 * const staticSiteLinkedBackend = new azure_native.web.v20220301.StaticSiteLinkedBackend("staticSiteLinkedBackend", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:web/v20220301:StaticSiteLinkedBackend testBackend /subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/rg/providers/Microsoft.Web/staticSites/testStaticSite0/builds/default/linkedBackends/testBackend 
 * ```
 */
export class StaticSiteLinkedBackend extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220301:StaticSiteLinkedBackend';
    ...
    constructor(name: string, args: StaticSiteLinkedBackendArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSiteLinkedBackend" }, { type: "azure-native:web/v20220901:StaticSiteLinkedBackend" }] };
