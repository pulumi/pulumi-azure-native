...
export function getWebAppSiteExtensionSlot(args: GetWebAppSiteExtensionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSiteExtensionSlotResult> {
    pulumi.log.warn("getWebAppSiteExtensionSlot is deprecated: azure-native:web/v20220301:WebAppSiteExtensionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSiteExtensionSlot to guarantee forwards compatibility.")
