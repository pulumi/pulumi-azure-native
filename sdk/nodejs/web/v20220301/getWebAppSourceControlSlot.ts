...
export function getWebAppSourceControlSlot(args: GetWebAppSourceControlSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSourceControlSlotResult> {
    pulumi.log.warn("getWebAppSourceControlSlot is deprecated: azure-native:web/v20220301:WebAppSourceControlSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSourceControlSlot to guarantee forwards compatibility.")
...
export interface GetWebAppSourceControlSlotResult {
     ...
     */
    readonly gitHubActionConfiguration?: outputs.web.v20220301.GitHubActionConfigurationResponse;
    /**
     * Resource Id.
     */
    readonly id: string;
