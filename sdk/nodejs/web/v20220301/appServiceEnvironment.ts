...
export class AppServiceEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServiceEnvironment {
        pulumi.log.warn("AppServiceEnvironment is deprecated: azure-native:web/v20220301:AppServiceEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServiceEnvironment to guarantee forwards compatibility.")
        return new AppServiceEnvironment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220301:AppServiceEnvironment';
     ...
     */
    public readonly clusterSettings!: pulumi.Output<outputs.web.v20220301.NameValuePairResponse[] | undefined>;
    /**
     * Full view of the custom domain suffix configuration for ASEv3.
     */
    public readonly customDnsSuffixConfiguration!: pulumi.Output<outputs.web.v20220301.CustomDnsSuffixConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly networkingConfiguration!: pulumi.Output<outputs.web.v20220301.AseV3NetworkingConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.web.v20220301.VirtualNetworkProfileResponse>;
    /**
...
export interface AppServiceEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the App Service Environment.
     */
    clusterSettings?: pulumi.Input<pulumi.Input<inputs.web.v20220301.NameValuePairArgs>[]>;
    /**
     * Full view of the custom domain suffix configuration for ASEv3.
     */
    customDnsSuffixConfiguration?: pulumi.Input<inputs.web.v20220301.CustomDnsSuffixConfigurationArgs>;
    /**
     * Dedicated Host Count
     */
     ...
     * Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment.
     */
    internalLoadBalancingMode?: pulumi.Input<string | enums.web.v20220301.LoadBalancingMode>;
    /**
     * Number of IP SSL addresses reserved for the App Service Environment.
     */
     ...
     * Full view of networking configuration for an ASE.
     */
    networkingConfiguration?: pulumi.Input<inputs.web.v20220301.AseV3NetworkingConfigurationArgs>;
    /**
     ...
     * Upgrade Preference
     */
    upgradePreference?: pulumi.Input<string | enums.web.v20220301.UpgradePreference>;
    /**
     * User added list of IP Ranges allowed on ASE db
     */
     ...
     * Description of the Virtual Network.
     */
    virtualNetwork: pulumi.Input<inputs.web.v20220301.VirtualNetworkProfileArgs>;
    /**
     * Whether or not this App Service Environment is zone-redundant.
     */
