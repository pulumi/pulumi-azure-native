 ...
 *
 * @deprecated azure-native:web/v20220301:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppConnectionStrings to guarantee forwards compatibility.
 */
export class WebAppConnectionStrings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppConnectionStrings {
        pulumi.log.warn("WebAppConnectionStrings is deprecated: azure-native:web/v20220301:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppConnectionStrings to guarantee forwards compatibility.")
        return new WebAppConnectionStrings(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220301:WebAppConnectionStrings';
     ...
     * Connection strings.
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.web.v20220301.ConnStringValueTypePairResponse}>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: WebAppConnectionStringsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppConnectionStrings" }, { type: "azure-native:web/v20150801:WebAppConnectionStrings" }, { type: "azure-native:web/v20160801:WebAppConnectionStrings" }, { type: "azure-native:web/v20180201:WebAppConnectionStrings" }, { type: "azure-native:web/v20181101:WebAppConnectionStrings" }, { type: "azure-native:web/v20190801:WebAppConnectionStrings" }, { type: "azure-native:web/v20200601:WebAppConnectionStrings" }, { type: "azure-native:web/v20200901:WebAppConnectionStrings" }, { type: "azure-native:web/v20201001:WebAppConnectionStrings" }, { type: "azure-native:web/v20201201:WebAppConnectionStrings" }, { type: "azure-native:web/v20210101:WebAppConnectionStrings" }, { type: "azure-native:web/v20210115:WebAppConnectionStrings" }, { type: "azure-native:web/v20210201:WebAppConnectionStrings" }, { type: "azure-native:web/v20210301:WebAppConnectionStrings" }, { type: "azure-native:web/v20220901:WebAppConnectionStrings" }] };
...
export interface WebAppConnectionStringsArgs {
     ...
     * Connection strings.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20220301.ConnStringValueTypePairArgs>}>;
    /**
