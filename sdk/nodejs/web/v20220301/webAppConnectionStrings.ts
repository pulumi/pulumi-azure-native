 ...
 *
 * @deprecated azure-native:web/v20220301:WebAppConnectionStrings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppConnectionStrings to guarantee forwards compatibility.
 */
export class WebAppConnectionStrings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppConnectionStrings {
        pulumi.log.warn("WebAppConnectionStrings is deprecated: azure-native:web/v20220301:WebAppConnectionStrings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppConnectionStrings to guarantee forwards compatibility.")
