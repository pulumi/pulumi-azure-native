...
export function getContainerApp(args: GetContainerAppArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerAppResult> {
    pulumi.log.warn("getContainerApp is deprecated: azure-native:web/v20220301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least \"\" to guarantee forwards compatibility.")
