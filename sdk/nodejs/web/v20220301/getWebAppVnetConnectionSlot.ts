 ...
 */
/** @deprecated azure-native:web/v20220301:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppVnetConnectionSlot to guarantee forwards compatibility. */
export function getWebAppVnetConnectionSlot(args: GetWebAppVnetConnectionSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppVnetConnectionSlotResult> {
    pulumi.log.warn("getWebAppVnetConnectionSlot is deprecated: azure-native:web/v20220301:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppVnetConnectionSlot to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:web/v20220301:getWebAppVnetConnectionSlot", {
        "name": args.name,
...
export interface GetWebAppVnetConnectionSlotResult {
     ...
     */
    readonly routes: outputs.web.v20220301.VnetRouteResponse[];
    /**
     * Resource type.
     */
