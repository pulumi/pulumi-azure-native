...
export class WebAppAzureStorageAccounts extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220301:WebAppAzureStorageAccounts';
     ...
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.web.v20220301.AzureStorageInfoValueResponse}>;
    /**
     * Resource type.
     */
...
export interface WebAppAzureStorageAccountsArgs {
     ...
     * Azure storage accounts.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20220301.AzureStorageInfoValueArgs>}>;
    /**
