...
export function listWebAppBackupStatusSecrets(args: ListWebAppBackupStatusSecretsArgs, opts?: pulumi.InvokeOptions): Promise<ListWebAppBackupStatusSecretsResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20220301:listWebAppBackupStatusSecrets", {
        "backupId": args.backupId,
        "backupName": args.backupName,
        "backupSchedule": args.backupSchedule ? inputs.web.v20220301.backupScheduleProvideDefaults(args.backupSchedule) : undefined,
...
export interface ListWebAppBackupStatusSecretsArgs {
     ...
     */
    backupSchedule?: inputs.web.v20220301.BackupSchedule;
    /**
     * Databases included in the backup.
     */
    databases?: inputs.web.v20220301.DatabaseBackupSetting[];
    /**
...
export interface ListWebAppBackupStatusSecretsResult {
     ...
     */
    readonly databases: outputs.web.v20220301.DatabaseBackupSettingResponse[];
    /**
...
export function listWebAppBackupStatusSecretsOutput(args: ListWebAppBackupStatusSecretsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListWebAppBackupStatusSecretsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:web/v20220301:listWebAppBackupStatusSecrets", {
        "backupId": args.backupId,
        "backupName": args.backupName,
        "backupSchedule": args.backupSchedule ? pulumi.output(args.backupSchedule).apply(inputs.web.v20220301.backupScheduleProvideDefaults) : undefined,
        "databases": args.databases,
        "enabled": args.enabled,
        "kind": args.kind,
        "name": args.name,
