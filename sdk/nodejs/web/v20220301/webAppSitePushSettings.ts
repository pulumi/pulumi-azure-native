 ...
 *
 * @deprecated azure-native:web/v20220301:WebAppSitePushSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettings to guarantee forwards compatibility.
 */
export class WebAppSitePushSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSitePushSettings {
        pulumi.log.warn("WebAppSitePushSettings is deprecated: azure-native:web/v20220301:WebAppSitePushSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSitePushSettings to guarantee forwards compatibility.")
        return new WebAppSitePushSettings(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220301:WebAppSitePushSettings';
