...
export class WebAppAuthSettingsSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppAuthSettingsSlot {
        pulumi.log.warn("WebAppAuthSettingsSlot is deprecated: azure-native:web/v20220301:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAuthSettingsSlot to guarantee forwards compatibility.")
