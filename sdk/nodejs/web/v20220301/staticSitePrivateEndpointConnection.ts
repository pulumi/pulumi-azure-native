...
export class StaticSitePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticSitePrivateEndpointConnection {
        pulumi.log.warn("StaticSitePrivateEndpointConnection is deprecated: azure-native:web/v20220301:StaticSitePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSitePrivateEndpointConnection to guarantee forwards compatibility.")
