...
export class WebAppDeployment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppDeployment {
        pulumi.log.warn("WebAppDeployment is deprecated: azure-native:web/v20220301:WebAppDeployment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppDeployment to guarantee forwards compatibility.")
