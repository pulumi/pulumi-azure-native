 ...
 *
 * @deprecated azure-native:web/v20220301:KubeEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:KubeEnvironment to guarantee forwards compatibility.
 */
export class KubeEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KubeEnvironment {
        pulumi.log.warn("KubeEnvironment is deprecated: azure-native:web/v20220301:KubeEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:KubeEnvironment to guarantee forwards compatibility.")
        return new KubeEnvironment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220301:KubeEnvironment';
     ...
     * supported
     */
    public readonly appLogsConfiguration!: pulumi.Output<outputs.web.v20220301.AppLogsConfigurationResponse | undefined>;
    /**
     * Cluster configuration which determines the ARC cluster
     * components types. Eg: Choosing between BuildService kind,
     * FrontEnd Service ArtifactsStorageType etc.
     */
    public readonly arcConfiguration!: pulumi.Output<outputs.web.v20220301.ArcConfigurationResponse | undefined>;
    /**
     * Cluster configuration for Container Apps Environments to configure Dapr Instrumentation Key and VNET Configuration
     */
    public readonly containerAppsConfiguration!: pulumi.Output<outputs.web.v20220301.ContainerAppsConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: KubeEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:KubeEnvironment" }, { type: "azure-native:web/v20210101:KubeEnvironment" }, { type: "azure-native:web/v20210115:KubeEnvironment" }, { type: "azure-native:web/v20210201:KubeEnvironment" }, { type: "azure-native:web/v20210301:KubeEnvironment" }, { type: "azure-native:web/v20220901:KubeEnvironment" }] };
...
export interface KubeEnvironmentArgs {
     ...
     * supported
     */
    appLogsConfiguration?: pulumi.Input<inputs.web.v20220301.AppLogsConfigurationArgs>;
    /**
     * Cluster configuration which determines the ARC cluster
     * components types. Eg: Choosing between BuildService kind,
     * FrontEnd Service ArtifactsStorageType etc.
     */
    arcConfiguration?: pulumi.Input<inputs.web.v20220301.ArcConfigurationArgs>;
    /**
     * Cluster configuration for Container Apps Environments to configure Dapr Instrumentation Key and VNET Configuration
     */
    containerAppsConfiguration?: pulumi.Input<inputs.web.v20220301.ContainerAppsConfigurationArgs>;
    /**
     * Type of Kubernetes Environment. Only supported for Container App Environments with value as Managed
     */
