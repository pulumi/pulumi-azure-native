...
export class AppServiceHostNameBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppServiceHostNameBindingState, opts?: pulumi.CustomResourceOptions): AppServiceHostNameBinding {
        return new AppServiceHostNameBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:web:AppServiceHostNameBinding';

    /**
     * Returns true if the given object is an instance of AppServiceHostNameBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppServiceHostNameBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppServiceHostNameBinding.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AppServiceHostNameBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppServiceHostNameBindingArgs | AppServiceHostNameBindingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AppServiceHostNameBinding.__pulumiType, name, inputs, opts);
    }
}
