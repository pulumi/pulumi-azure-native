 ...
 *
 * @deprecated azure-native:web/v20181101:WebAppApplicationSettingsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppApplicationSettingsSlot to guarantee forwards compatibility.
 */
export class WebAppApplicationSettingsSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppApplicationSettingsSlot {
        pulumi.log.warn("WebAppApplicationSettingsSlot is deprecated: azure-native:web/v20181101:WebAppApplicationSettingsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppApplicationSettingsSlot to guarantee forwards compatibility.")
