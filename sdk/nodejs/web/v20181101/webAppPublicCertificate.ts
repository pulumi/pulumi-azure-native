...
export class WebAppPublicCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppPublicCertificate {
        pulumi.log.warn("WebAppPublicCertificate is deprecated: azure-native:web/v20181101:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPublicCertificate to guarantee forwards compatibility.")
        return new WebAppPublicCertificate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20181101:WebAppPublicCertificate';
...
export interface WebAppPublicCertificateArgs {
     ...
     * Public Certificate Location
     */
    publicCertificateLocation?: pulumi.Input<enums.web.v20181101.PublicCertificateLocation>;
    /**
