...
export class WebAppPublicCertificateSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppPublicCertificateSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppPublicCertificateSlot" }, { type: "azurerm:web/preview:WebAppPublicCertificateSlot" }, { type: "azurerm:web/v20160801:WebAppPublicCertificateSlot" }, { type: "azurerm:web/v20180201:WebAppPublicCertificateSlot" }, { type: "azurerm:web/v20190801:WebAppPublicCertificateSlot" }, { type: "azurerm:web/v20200601:WebAppPublicCertificateSlot" }] };
