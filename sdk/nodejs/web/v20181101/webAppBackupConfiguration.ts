 ...
 *
 * @deprecated azure-native:web/v20181101:WebAppBackupConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppBackupConfiguration to guarantee forwards compatibility.
 */
export class WebAppBackupConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppBackupConfiguration {
        pulumi.log.warn("WebAppBackupConfiguration is deprecated: azure-native:web/v20181101:WebAppBackupConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppBackupConfiguration to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: WebAppBackupConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["backupSchedule"] = args ? (args.backupSchedule ? pulumi.output(args.backupSchedule).apply(inputs.web.v20181101.backupScheduleArgsProvideDefaults) : undefined) : undefined;
