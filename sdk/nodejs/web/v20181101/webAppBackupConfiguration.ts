 ...
 *
 * @deprecated azure-native:web/v20181101:WebAppBackupConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppBackupConfiguration to guarantee forwards compatibility.
 */
export class WebAppBackupConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppBackupConfiguration {
        pulumi.log.warn("WebAppBackupConfiguration is deprecated: azure-native:web/v20181101:WebAppBackupConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppBackupConfiguration to guarantee forwards compatibility.")
