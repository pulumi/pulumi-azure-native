 ...
 *
 * @deprecated azure-native:web/v20181101:WebAppBackupConfigurationSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppBackupConfigurationSlot to guarantee forwards compatibility.
 */
export class WebAppBackupConfigurationSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppBackupConfigurationSlot {
        pulumi.log.warn("WebAppBackupConfigurationSlot is deprecated: azure-native:web/v20181101:WebAppBackupConfigurationSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppBackupConfigurationSlot to guarantee forwards compatibility.")
