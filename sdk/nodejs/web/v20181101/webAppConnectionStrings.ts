...
export class WebAppConnectionStrings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppConnectionStrings {
        pulumi.log.warn("WebAppConnectionStrings is deprecated: azure-native:web/v20181101:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppConnectionStrings to guarantee forwards compatibility.")
