...
export class WebAppDiagnosticLogsConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppDiagnosticLogsConfiguration {
        pulumi.log.warn("WebAppDiagnosticLogsConfiguration is deprecated: azure-native:web/v20181101:WebAppDiagnosticLogsConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppDiagnosticLogsConfiguration to guarantee forwards compatibility.")
