...
export function listWebAppBackupStatusSecretsSlot(args: ListWebAppBackupStatusSecretsSlotArgs, opts?: pulumi.InvokeOptions): Promise<ListWebAppBackupStatusSecretsSlotResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20181101:listWebAppBackupStatusSecretsSlot", {
        ...
        "backupSchedule": args.backupSchedule ? inputs.web.v20181101.backupScheduleProvideDefaults(args.backupSchedule) : undefined,
...
export function listWebAppBackupStatusSecretsSlotOutput(args: ListWebAppBackupStatusSecretsSlotOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListWebAppBackupStatusSecretsSlotResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:web/v20181101:listWebAppBackupStatusSecretsSlot", {
        "backupId": args.backupId,
        "backupName": args.backupName,
        "backupSchedule": args.backupSchedule ? pulumi.output(args.backupSchedule).apply(inputs.web.v20181101.backupScheduleProvideDefaults) : undefined,
        "databases": args.databases,
        "enabled": args.enabled,
        "kind": args.kind,
        "name": args.name,
