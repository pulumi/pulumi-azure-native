...
export class WebAppSlotConfigurationNames extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppSlotConfigurationNames {
        pulumi.log.warn("WebAppSlotConfigurationNames is deprecated: azure-native:web/v20181101:WebAppSlotConfigurationNames is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSlotConfigurationNames to guarantee forwards compatibility.")
