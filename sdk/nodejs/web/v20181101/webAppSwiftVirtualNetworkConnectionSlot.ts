...
export class WebAppSwiftVirtualNetworkConnectionSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:web/v20181101:WebAppSwiftVirtualNetworkConnectionSlot';
    ...
    constructor(name: string, args: WebAppSwiftVirtualNetworkConnectionSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/latest:WebAppSwiftVirtualNetworkConnectionSlot" }, { type: "azurerm:web/v20180201:WebAppSwiftVirtualNetworkConnectionSlot" }, { type: "azurerm:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot" }, { type: "azurerm:web/v20200601:WebAppSwiftVirtualNetworkConnectionSlot" }] };
