...
export class WebAppSlot extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20150801:WebAppSlot" }, { type: "azurerm:web/v20160801:WebAppSlot" }, { type: "azurerm:web/v20180201:WebAppSlot" }, { type: "azurerm:web/v20190801:WebAppSlot" }] };
