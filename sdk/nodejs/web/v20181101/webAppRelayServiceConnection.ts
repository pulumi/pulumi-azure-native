...
export class WebAppRelayServiceConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WebAppRelayServiceConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:web/v20150801:WebAppRelayServiceConnection" }, { type: "azurerm:web/v20160801:WebAppRelayServiceConnection" }, { type: "azurerm:web/v20180201:WebAppRelayServiceConnection" }, { type: "azurerm:web/v20190801:WebAppRelayServiceConnection" }] };
