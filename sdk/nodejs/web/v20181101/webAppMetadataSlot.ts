 ...
 *
 * @deprecated azure-native:web/v20181101:WebAppMetadataSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppMetadataSlot to guarantee forwards compatibility.
 */
export class WebAppMetadataSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppMetadataSlot {
        pulumi.log.warn("WebAppMetadataSlot is deprecated: azure-native:web/v20181101:WebAppMetadataSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppMetadataSlot to guarantee forwards compatibility.")
