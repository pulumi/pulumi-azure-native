 ...
 *
 * ```sh
 * $ pulumi import azure-native:web/v20181101:WebApp myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name} 
 * ```
 */
