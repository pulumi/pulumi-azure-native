...
export class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GuestConfigurationHCRPAssignment {
        pulumi.log.warn("GuestConfigurationHCRPAssignment is deprecated: Version v20181120 will be removed in the next major version of the provider. Upgrade to version v20220125 or later.")
        return new GuestConfigurationHCRPAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:guestconfiguration/v20181120:GuestConfigurationHCRPAssignment';
