...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GuestConfigurationAssignment {
        pulumi.log.warn("GuestConfigurationAssignment is deprecated: Version v20181120 will be removed in the next major version of the provider. Upgrade to version v20200625 or later.")
        return new GuestConfigurationAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:guestconfiguration/v20181120:GuestConfigurationAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.guestconfiguration.v20181120.GuestConfigurationAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.guestconfiguration.v20181120.guestConfigurationAssignmentPropertiesArgsProvideDefaults) : undefined) : undefined;
