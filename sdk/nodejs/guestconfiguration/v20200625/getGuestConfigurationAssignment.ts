...
export function getGuestConfigurationAssignment(args: GetGuestConfigurationAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetGuestConfigurationAssignmentResult> {
    pulumi.log.warn("getGuestConfigurationAssignment is deprecated: Version v20200625 will be removed in the next major version of the provider. Upgrade to version v20220125 or later.")
    if (!opts) {
        opts = {}
    }
