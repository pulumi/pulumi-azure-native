...
export class GuestConfigurationConnectedVMwarevSphereAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GuestConfigurationConnectedVMwarevSphereAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:guestconfiguration:GuestConfigurationConnectedVMwarevSphereAssignment" }, { type: "azure-native:guestconfiguration/v20220125:GuestConfigurationConnectedVMwarevSphereAssignment" }, { type: "azure-native:guestconfiguration/v20240405:GuestConfigurationConnectedVMwarevSphereAssignment" }] };
