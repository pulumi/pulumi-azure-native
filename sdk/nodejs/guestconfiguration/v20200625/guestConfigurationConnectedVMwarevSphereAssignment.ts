 ...
 *
 * const guestConfigurationConnectedVMwarevSphereAssignment = new azure_native.guestconfiguration.v20200625.GuestConfigurationConnectedVMwarevSphereAssignment("guestConfigurationConnectedVMwarevSphereAssignment", {
...
export class GuestConfigurationConnectedVMwarevSphereAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:guestconfiguration/v20200625:GuestConfigurationConnectedVMwarevSphereAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.guestconfiguration.v20200625.GuestConfigurationAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GuestConfigurationConnectedVMwarevSphereAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.guestconfiguration.v20200625.guestConfigurationAssignmentPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:guestconfiguration:GuestConfigurationConnectedVMwarevSphereAssignment" }, { type: "azure-native:guestconfiguration/v20220125:GuestConfigurationConnectedVMwarevSphereAssignment" }] };
