...
export class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GuestConfigurationHCRPAssignment {
        pulumi.log.warn("GuestConfigurationHCRPAssignment is deprecated: Version v20200625 will be removed in the next major version of the provider. Upgrade to version v20220125 or later.")
        return new GuestConfigurationHCRPAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:guestconfiguration/v20200625:GuestConfigurationHCRPAssignment';
    ...
    constructor(name: string, args: GuestConfigurationHCRPAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:guestconfiguration:GuestConfigurationHCRPAssignment" }, { type: "azure-native:guestconfiguration/v20181120:GuestConfigurationHCRPAssignment" }, { type: "azure-native:guestconfiguration/v20210125:GuestConfigurationHCRPAssignment" }, { type: "azure-native:guestconfiguration/v20220125:GuestConfigurationHCRPAssignment" }] };
