...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.guestconfiguration.v20180630preview.GuestConfigurationAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:guestconfiguration/latest:GuestConfigurationAssignment" }, { type: "azure-nextgen:guestconfiguration/v20181120:GuestConfigurationAssignment" }, { type: "azure-nextgen:guestconfiguration/v20200625:GuestConfigurationAssignment" }] };
...
export interface GuestConfigurationAssignmentArgs {
     ...
     * Properties of the Guest configuration assignment.
     */
    readonly properties?: pulumi.Input<inputs.guestconfiguration.v20180630preview.GuestConfigurationAssignmentProperties>;
    /**
