...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.guestconfiguration.v20180630preview.guestConfigurationAssignmentPropertiesArgsProvideDefaults) : undefined) : undefined;
