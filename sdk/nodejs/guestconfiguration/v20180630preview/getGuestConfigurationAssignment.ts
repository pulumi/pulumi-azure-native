...
export function getGuestConfigurationAssignment(args: GetGuestConfigurationAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetGuestConfigurationAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:guestconfiguration/v20180630preview:getGuestConfigurationAssignment", {
...
export interface GetGuestConfigurationAssignmentResult {
     ...
     */
    readonly properties: outputs.guestconfiguration.v20180630preview.GuestConfigurationAssignmentPropertiesInvokeResponse;
    /**
