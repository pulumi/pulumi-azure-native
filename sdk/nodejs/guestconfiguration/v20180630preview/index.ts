...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:guestconfiguration/v20180630preview:GuestConfigurationAssignment":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "guestconfiguration/v20180630preview", _module)
