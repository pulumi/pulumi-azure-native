...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GuestConfigurationAssignment {
        pulumi.log.warn("GuestConfigurationAssignment is deprecated: azure-native:guestconfiguration/v20210125:GuestConfigurationAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:guestconfiguration/v20220125:GuestConfigurationAssignment to guarantee forwards compatibility.")
