...
export class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GuestConfigurationHCRPAssignment {
        pulumi.log.warn("GuestConfigurationHCRPAssignment is deprecated: azure-native:guestconfiguration/v20210125:GuestConfigurationHCRPAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:guestconfiguration/v20220125:GuestConfigurationHCRPAssignment to guarantee forwards compatibility.")
