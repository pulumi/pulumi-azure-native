...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:guestconfiguration/latest:GuestConfigurationAssignment';
