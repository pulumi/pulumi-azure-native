...
// Export enums:
export * from "../../types/enums/guestconfiguration/v20240405";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:guestconfiguration/v20240405:GuestConfigurationAssignment":
                return new GuestConfigurationAssignment(name, <any>undefined, { urn })
            case "azure-native:guestconfiguration/v20240405:GuestConfigurationAssignmentsVMSS":
                return new GuestConfigurationAssignmentsVMSS(name, <any>undefined, { urn })
            case "azure-native:guestconfiguration/v20240405:GuestConfigurationConnectedVMwarevSphereAssignment":
                return new GuestConfigurationConnectedVMwarevSphereAssignment(name, <any>undefined, { urn })
            case "azure-native:guestconfiguration/v20240405:GuestConfigurationHCRPAssignment":
...
pulumi.runtime.registerResourceModule("azure-native", "guestconfiguration/v20240405", _module)
