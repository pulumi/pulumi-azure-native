...
export class DedicatedCloudNode extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:vmwarecloudsimple/v20190401:DedicatedCloudNode';
    ...
    constructor(name: string, args: DedicatedCloudNodeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:vmwarecloudsimple/latest:DedicatedCloudNode" }, { type: "azurerm:vmwarecloudsimple/preview:DedicatedCloudNode" }] };
