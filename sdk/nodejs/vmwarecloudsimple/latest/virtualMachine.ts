...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:vmwarecloudsimple/latest:VirtualMachine';
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:vmwarecloudsimple/latest:VirtualMachine" }, { type: "azure-native:vmwarecloudsimple:VirtualMachine" }, { type: "azure-nextgen:vmwarecloudsimple:VirtualMachine" }, { type: "azure-native:vmwarecloudsimple/v20190401:VirtualMachine" }, { type: "azure-nextgen:vmwarecloudsimple/v20190401:VirtualMachine" }] };
