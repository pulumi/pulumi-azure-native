...
export class DedicatedCloudNode extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:vmwarecloudsimple/latest:DedicatedCloudNode';
    ...
    constructor(name: string, argsOrState?: DedicatedCloudNodeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:vmwarecloudsimple/preview:DedicatedCloudNode" }, { type: "azurerm:vmwarecloudsimple/v20190401:DedicatedCloudNode" }] };
