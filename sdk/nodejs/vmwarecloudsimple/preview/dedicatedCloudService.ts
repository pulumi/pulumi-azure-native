...
export class DedicatedCloudService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:vmwarecloudsimple/preview:DedicatedCloudService';
    ...
    constructor(name: string, args: DedicatedCloudServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:vmwarecloudsimple/latest:DedicatedCloudService" }, { type: "azurerm:vmwarecloudsimple/v20190401:DedicatedCloudService" }] };
