...
export class DedicatedCloudNode extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:vmwarecloudsimple/preview:DedicatedCloudNode';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.vmwarecloudsimple.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DedicatedCloudNodeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:vmwarecloudsimple/latest:DedicatedCloudNode" }, { type: "azurerm:vmwarecloudsimple/v20190401:DedicatedCloudNode" }] };
...
export interface DedicatedCloudNodeArgs {
     ...
     * Dedicated Cloud Nodes SKU
     */
    readonly sku?: pulumi.Input<inputs.vmwarecloudsimple.preview.Sku>;
    /**
     * Dedicated Cloud Nodes tags
     */
