 ...
 *
 * const extension = new azurerm.visualstudio.v20140401preview.Extension("extension", {
...
export class Extension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:visualstudio/v20140401preview:Extension';
    ...
    constructor(name: string, args: ExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:visualstudio/v20171101preview:Extension" }] };
