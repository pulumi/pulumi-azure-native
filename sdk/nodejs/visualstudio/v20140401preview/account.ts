...
export class Account extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Account {
        pulumi.log.warn("Account is deprecated: azure-native:visualstudio/v20140401preview:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:visualstudio/v20171101preview:Account to guarantee forwards compatibility.")
        return new Account(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:visualstudio/v20140401preview:Account';
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:visualstudio:Account" }, { type: "azure-native:visualstudio/v20171101preview:Account" }] };
...
export interface AccountArgs {
     ...
     */
    operationType?: pulumi.Input<string | enums.visualstudio.v20140401preview.AccountResourceRequestOperationType>;
    /**
