 ...
 *
 * const account = new azurerm.visualstudio.v20140401preview.Account("account", {
 *     accountName: "Example",
 *     location: "Central US",
...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:visualstudio/v20140401preview:Account';
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:visualstudio/v20171101preview:Account" }] };
