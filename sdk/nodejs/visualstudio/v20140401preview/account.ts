...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:visualstudio:Account" }, { type: "azure-nextgen:visualstudio:Account" }, { type: "azure-native:visualstudio/v20171101preview:Account" }, { type: "azure-nextgen:visualstudio/v20171101preview:Account" }] };
