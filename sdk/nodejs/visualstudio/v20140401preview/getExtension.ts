...
export function getExtension(args: GetExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:visualstudio/v20140401preview:getExtension", {
...
export interface GetExtensionResult {
     ...
     */
    readonly plan?: outputs.visualstudio.v20140401preview.ExtensionResourcePlanInvokeResponse;
    /**
     * Resource properties.
     */
