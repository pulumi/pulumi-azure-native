...
export class Extension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Extension {
        return new Extension(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:visualstudio/v20171101preview:Extension';
    ...
    constructor(name: string, argsOrState?: ExtensionArgs, opts?: pulumi.CustomResourceOptions) {
