...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:visualstudio/v20171101preview:Account';
    ...
    constructor(name: string, argsOrState?: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:visualstudio/preview:Account" }, { type: "azurerm:visualstudio/v20140401preview:Account" }] };
