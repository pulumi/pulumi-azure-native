...
export class Site extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/preview:Site';
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/latest:Site" }, { type: "azurerm:offazure/v20200101:Site" }, { type: "azurerm:offazure/v20200707:Site" }] };
