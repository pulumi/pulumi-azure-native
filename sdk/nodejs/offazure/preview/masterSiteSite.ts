 ...
 * Site REST Resource.
 */
export class MasterSiteSite extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MasterSiteSite {
        return new MasterSiteSite(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/preview:MasterSiteSite';

    /**
     * Returns true if the given object is an instance of MasterSiteSite.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MasterSiteSite {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MasterSiteSite.__pulumiType;
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.offazure.preview.MasterSitePropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: MasterSiteSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/latest:MasterSiteSite" }, { type: "azurerm:offazure/v20200707:MasterSiteSite" }] };
...
export interface MasterSiteSiteArgs {
     ...
     * Nested properties of Master site.
     */
    readonly properties?: pulumi.Input<inputs.offazure.preview.MasterSiteProperties>;
    /**
