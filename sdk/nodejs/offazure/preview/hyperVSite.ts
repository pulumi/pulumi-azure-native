...
export class HyperVSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/preview:HyperVSite';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.offazure.preview.SitePropertiesResponse>;
    ...
    constructor(name: string, args: HyperVSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/latest:HyperVSite" }, { type: "azurerm:offazure/v20200101:HyperVSite" }, { type: "azurerm:offazure/v20200707:HyperVSite" }] };
...
export interface HyperVSiteArgs {
     ...
     * Nested properties of Hyper-V site.
     */
    readonly properties?: pulumi.Input<inputs.offazure.preview.SiteProperties>;
    /**
