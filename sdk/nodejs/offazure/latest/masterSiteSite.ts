...
export class MasterSiteSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/latest:MasterSiteSite';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.offazure.latest.MasterSitePropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: MasterSiteSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/preview:MasterSiteSite" }, { type: "azurerm:offazure/v20200707:MasterSiteSite" }] };
...
export interface MasterSiteSiteArgs {
     ...
     * Nested properties of Master site.
     */
    readonly properties?: pulumi.Input<inputs.offazure.latest.MasterSiteProperties>;
    /**
