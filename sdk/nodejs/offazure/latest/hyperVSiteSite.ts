...
export class HyperVSiteSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/latest:HyperVSiteSite';
    ...
    constructor(name: string, argsOrState?: HyperVSiteSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/preview:HyperVSiteSite" }, { type: "azurerm:offazure/v20200101:HyperVSiteSite" }, { type: "azurerm:offazure/v20200707:HyperVSiteSite" }] };
