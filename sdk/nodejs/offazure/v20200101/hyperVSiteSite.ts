...
export class HyperVSiteSite extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: HyperVSiteSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/latest:HyperVSiteSite" }, { type: "azurerm:offazure/preview:HyperVSiteSite" }, { type: "azurerm:offazure/v20200707:HyperVSiteSite" }] };
