...
export class HyperVSiteSite extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HyperVSiteSite {
        return new HyperVSiteSite(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/v20200101:HyperVSiteSite';
    ...
    constructor(name: string, args: HyperVSiteSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/latest:HyperVSiteSite" }, { type: "azurerm:offazure/v20200707:HyperVSiteSite" }] };
