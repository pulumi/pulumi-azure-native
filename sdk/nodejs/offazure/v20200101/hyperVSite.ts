...
export class HyperVSite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HyperVSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:offazure/v20200101:HyperVSite" }, { type: "azure-native:offazure:HyperVSite" }, { type: "azure-nextgen:offazure:HyperVSite" }, { type: "azure-native:offazure/v20200707:HyperVSite" }, { type: "azure-nextgen:offazure/v20200707:HyperVSite" }] };
...
export interface HyperVSiteArgs {
     ...
     * Nested properties of Hyper-V site.
     */
    readonly properties?: pulumi.Input<inputs.offazure.v20200101.SitePropertiesArgs>;
    /**
