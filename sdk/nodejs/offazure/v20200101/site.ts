...
export class Site extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:offazure/v20200101:Site';
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:offazure:Site" }, { type: "azure-nextgen:offazure/latest:Site" }, { type: "azure-nextgen:offazure/v20200707:Site" }] };
