...
export class HypervClusterControllerCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HypervClusterControllerClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:HypervClusterControllerCluster" }, { type: "azure-native:offazure/v20231001preview:HypervClusterControllerCluster" }, { type: "azure-native:offazure/v20240501preview:HypervClusterControllerCluster" }] };
