...
export class PrivateEndpointConnectionController extends pulumi.CustomResource {
     ...
     * private endpoints
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.offazure.v20230606.ResourceIdResponse>;
    /**
     * private endpoints connection state
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.offazure.v20230606.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:PrivateEndpointConnectionController" }, { type: "azure-native:offazure/v20200707:PrivateEndpointConnectionController" }, { type: "azure-native:offazure/v20231001preview:PrivateEndpointConnectionController" }, { type: "azure-native:offazure/v20240501preview:PrivateEndpointConnectionController" }] };
...
export interface PrivateEndpointConnectionControllerArgs {
     ...
     * private endpoints connection state
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.offazure.v20230606.PrivateLinkServiceConnectionStateArgs>;
    /**
