...
export class SqlSitesController extends pulumi.CustomResource {
     ...
     * to the appliance.
     */
    public readonly siteAppliancePropertiesCollection!: pulumi.Output<outputs.offazure.v20230606.SiteAppliancePropertiesResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SqlSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20231001preview:SqlSitesController" }, { type: "azure-native:offazure/v20240501preview:SqlSitesController" }, { type: "azure-native:offazure:SqlSitesController" }] };
...
export interface SqlSitesControllerArgs {
     ...
     * Gets or sets the discovery scenario.
     */
    discoveryScenario?: pulumi.Input<string | enums.offazure.v20230606.SqlSitePropertiesDiscoveryScenario>;
    /**
     ...
     * to the appliance.
     */
    siteAppliancePropertiesCollection?: pulumi.Input<pulumi.Input<inputs.offazure.v20230606.SiteAppliancePropertiesArgs>[]>;
    /**
     * Site name
     */
