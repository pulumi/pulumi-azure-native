...
export class HyperVSite extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HyperVSite {
        return new HyperVSite(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure:HyperVSite';
    ...
    constructor(name: string, argsOrState?: HyperVSiteArgs, opts?: pulumi.CustomResourceOptions) {
