...
export class ServerSitesController extends pulumi.CustomResource {
     ...
     */
    declare public readonly agentDetails: pulumi.Output<outputs.offazure.SiteAgentPropertiesResponse | undefined>;
    /**
     ...
     *             to the service.
     */
    declare public readonly servicePrincipalIdentityDetails: pulumi.Output<outputs.offazure.SiteSpnPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServerSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:ServerSitesController" }, { type: "azure-native:offazure/v20231001preview:ServerSitesController" }, { type: "azure-native:offazure/v20240501preview:ServerSitesController" }, { type: "azure-native:offazure/v20240701preview:ServerSitesController" }, { type: "azure-native:offazure/v20241201preview:ServerSitesController" }] };
