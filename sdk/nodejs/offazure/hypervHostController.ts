...
export class HypervHostController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HypervHostControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:HypervHostController" }, { type: "azure-native:offazure/v20231001preview:HypervHostController" }, { type: "azure-native:offazure/v20240501preview:HypervHostController" }, { type: "azure-native_offazure_v20230606:offazure:HypervHostController" }, { type: "azure-native_offazure_v20231001preview:offazure:HypervHostController" }, { type: "azure-native_offazure_v20240501preview:offazure:HypervHostController" }] };
