 ...
 *
 * const hyperVSite = new azurerm.offazure.v20200707.HyperVSite("hyperVSite", {
 *     location: "eastus",
...
export class HyperVSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/v20200707:HyperVSite';
    ...
    constructor(name: string, args: HyperVSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/latest:HyperVSite" }, { type: "azurerm:offazure/v20200101:HyperVSite" }] };
