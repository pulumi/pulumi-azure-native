...
export class HyperVSite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HyperVSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:offazure:HyperVSite" }, { type: "azure-nextgen:offazure/latest:HyperVSite" }, { type: "azure-nextgen:offazure/v20200101:HyperVSite" }] };
