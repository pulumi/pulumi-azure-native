...
export class MasterSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/v20200707:MasterSite';
    ...
    constructor(name: string, args: MasterSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:offazure/latest:MasterSite" }, { type: "azurerm:offazure/preview:MasterSite" }] };
