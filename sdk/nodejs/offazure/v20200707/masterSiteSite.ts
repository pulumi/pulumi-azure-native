...
export class MasterSiteSite extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MasterSiteSite {
        return new MasterSiteSite(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:offazure/v20200707:MasterSiteSite';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.offazure.v20200707.MasterSitePropertiesResponse>;
    /**
