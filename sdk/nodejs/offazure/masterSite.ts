...
export class MasterSite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MasterSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:offazure:MasterSite" }, { type: "azure-native:offazure/v20200707:MasterSite" }, { type: "azure-nextgen:offazure/v20200707:MasterSite" }] };
...
export interface MasterSiteArgs {
     ...
     * Nested properties of Master site.
     */
    readonly properties?: pulumi.Input<inputs.offazure.MasterSitePropertiesArgs>;
    /**
