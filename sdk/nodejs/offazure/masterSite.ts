...
export class MasterSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:offazure:MasterSite';
    ...
    constructor(name: string, args: MasterSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:offazure/latest:MasterSite" }, { type: "azure-nextgen:offazure/v20200707:MasterSite" }] };
