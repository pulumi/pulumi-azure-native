...
export class MasterSitesController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20240501preview:MasterSitesController';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.offazure.v20240501preview.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: MasterSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:MasterSitesController" }, { type: "azure-native:offazure/v20200707:MasterSitesController" }, { type: "azure-native:offazure/v20230606:MasterSitesController" }, { type: "azure-native:offazure/v20231001preview:MasterSitesController" }] };
...
export interface MasterSitesControllerArgs {
     ...
     * Gets or sets the state of public network access.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.offazure.v20240501preview.MasterSitePropertiesPublicNetworkAccess>;
    /**
