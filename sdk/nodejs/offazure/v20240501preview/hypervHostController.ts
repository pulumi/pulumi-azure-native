...
export class HypervHostController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20240501preview:HypervHostController';
    ...
    constructor(name: string, args: HypervHostControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:HypervHostController" }, { type: "azure-native:offazure/v20231001preview:HypervHostController" }, { type: "azure-native:offazure:HypervHostController" }] };
