...
export class PrivateEndpointConnectionController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20240501preview:PrivateEndpointConnectionController';
     ...
     * private endpoints
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.offazure.v20240501preview.ResourceIdResponse>;
    /**
     * private endpoints connection state
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.offazure.v20240501preview.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
