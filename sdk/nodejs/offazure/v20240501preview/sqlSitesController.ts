...
export class SqlSitesController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20240501preview:SqlSitesController';
     ...
     * to the appliance.
     */
    public readonly siteAppliancePropertiesCollection!: pulumi.Output<outputs.offazure.v20240501preview.SiteAppliancePropertiesResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SqlSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:SqlSitesController" }, { type: "azure-native:offazure/v20231001preview:SqlSitesController" }, { type: "azure-native:offazure:SqlSitesController" }] };
...
export interface SqlSitesControllerArgs {
     ...
     * Gets or sets the discovery scenario.
     */
    discoveryScenario?: pulumi.Input<string | enums.offazure.v20240501preview.SqlSitePropertiesDiscoveryScenario>;
    /**
     ...
     * to the appliance.
     */
    siteAppliancePropertiesCollection?: pulumi.Input<pulumi.Input<inputs.offazure.v20240501preview.SiteAppliancePropertiesArgs>[]>;
    /**
     * Site name
     */
