...
export function getHypervSitesController(args: GetHypervSitesControllerArgs, opts?: pulumi.InvokeOptions): Promise<GetHypervSitesControllerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:offazure/v20240501preview:getHypervSitesController", {
...
export interface GetHypervSitesControllerResult {
     ...
     */
    readonly agentDetails?: outputs.offazure.v20240501preview.SiteAgentPropertiesResponse;
    /**
     ...
     *             to the service.
     */
    readonly servicePrincipalIdentityDetails?: outputs.offazure.v20240501preview.SiteSpnPropertiesResponse;
    /**
...
export function getHypervSitesControllerOutput(args: GetHypervSitesControllerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHypervSitesControllerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:offazure/v20240501preview:getHypervSitesController", {
        "resourceGroupName": args.resourceGroupName,
        "siteName": args.siteName,
    }, opts);
}
