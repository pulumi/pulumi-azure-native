...
export class ImportSitesController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20240501preview:ImportSitesController';
    ...
    constructor(name: string, args: ImportSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:ImportSitesController" }, { type: "azure-native:offazure/v20230606:ImportSitesController" }, { type: "azure-native:offazure/v20231001preview:ImportSitesController" }] };
...
export interface ImportSitesControllerArgs {
     ...
     * The status of the last operation.
     */
    provisioningState?: pulumi.Input<string | enums.offazure.v20240501preview.ProvisioningState>;
    /**
