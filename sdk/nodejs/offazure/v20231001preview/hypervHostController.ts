...
export class HypervHostController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HypervHostControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:HypervHostController" }, { type: "azure-native:offazure/v20240501preview:HypervHostController" }, { type: "azure-native:offazure:HypervHostController" }] };
