...
export class AzureTrafficCollector extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly collectorPolicies!: pulumi.Output<outputs.networkfunction.v20221101.ResourceReferenceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly virtualHub!: pulumi.Output<outputs.networkfunction.v20221101.ResourceReferenceResponse | undefined>;
    ...
    constructor(name: string, args: AzureTrafficCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkfunction/v20210901preview:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20220501:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20220801:AzureTrafficCollector" }, { type: "azure-native:networkfunction:AzureTrafficCollector" }] };
