...
export class AzureTrafficCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkfunction/v20210901preview:AzureTrafficCollector';
     ...
     */
    public readonly collectorPolicies!: pulumi.Output<outputs.networkfunction.v20210901preview.CollectorPolicyResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.networkfunction.v20210901preview.TrackedResourceResponseSystemData>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly virtualHub!: pulumi.Output<outputs.networkfunction.v20210901preview.ResourceReferenceResponse | undefined>;
    ...
    constructor(name: string, args: AzureTrafficCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkfunction:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20220501:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20220801:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20221101:AzureTrafficCollector" }] };
...
export interface AzureTrafficCollectorArgs {
     ...
     * Collector Policies for Azure Traffic Collector.
     */
    collectorPolicies?: pulumi.Input<pulumi.Input<inputs.networkfunction.v20210901preview.CollectorPolicyArgs>[]>;
    /**
     * Resource location.
     */
