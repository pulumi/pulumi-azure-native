...
export class CollectorPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CollectorPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkfunction/v20210901preview:CollectorPolicy" }, { type: "azure-native:networkfunction/v20220501:CollectorPolicy" }] };
