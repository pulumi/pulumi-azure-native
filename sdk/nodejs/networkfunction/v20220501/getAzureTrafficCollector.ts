...
export function getAzureTrafficCollector(args: GetAzureTrafficCollectorArgs, opts?: pulumi.InvokeOptions): Promise<GetAzureTrafficCollectorResult> {
    pulumi.log.warn("getAzureTrafficCollector is deprecated: azure-native:networkfunction/v20220501:AzureTrafficCollector is being removed in the next major version of this provider. Upgrade to at least azure-native:networkfunction/v20220801:AzureTrafficCollector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:networkfunction/v20220501:getAzureTrafficCollector", {
...
export interface GetAzureTrafficCollectorResult {
     ...
     */
    readonly collectorPolicies?: outputs.networkfunction.v20220501.CollectorPolicyResponse[];
    /**
     ...
     */
    readonly systemData: outputs.networkfunction.v20220501.TrackedResourceResponseSystemData;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualHub?: outputs.networkfunction.v20220501.ResourceReferenceResponse;
}
/**
 * Gets the specified Azure Traffic Collector in a specified resource group
 */
