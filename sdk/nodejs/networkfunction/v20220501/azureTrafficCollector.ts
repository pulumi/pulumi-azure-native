...
export class AzureTrafficCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkfunction/v20220501:AzureTrafficCollector';
     ...
     */
    public readonly collectorPolicies!: pulumi.Output<outputs.networkfunction.v20220501.CollectorPolicyResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.networkfunction.v20220501.TrackedResourceResponseSystemData>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly virtualHub!: pulumi.Output<outputs.networkfunction.v20220501.ResourceReferenceResponse | undefined>;
    ...
    constructor(name: string, args: AzureTrafficCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkfunction:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20210901preview:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20220801:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20221101:AzureTrafficCollector" }] };
...
export interface AzureTrafficCollectorArgs {
     ...
     */
    collectorPolicies?: pulumi.Input<pulumi.Input<inputs.networkfunction.v20220501.CollectorPolicyArgs>[]>;
    /**
     * Resource location.
     */
