 ...
 *
 * @deprecated azure-native:digitaltwins/v20220531:TimeSeriesDatabaseConnection is being removed in the next major version of this provider. Please upgrade to azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection to guarantee forwards compatibility.
 */
export class TimeSeriesDatabaseConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:digitaltwins/v20220531:TimeSeriesDatabaseConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.digitaltwins.v20220531.AzureDataExplorerConnectionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: TimeSeriesDatabaseConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.digitaltwins.v20220531.azureDataExplorerConnectionPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:digitaltwins:TimeSeriesDatabaseConnection" }, { type: "azure-native:digitaltwins/v20210630preview:TimeSeriesDatabaseConnection" }, { type: "azure-native:digitaltwins/v20221031:TimeSeriesDatabaseConnection" }, { type: "azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection" }] };
...
export interface TimeSeriesDatabaseConnectionArgs {
     ...
     * Properties of a specific time series database connection.
     */
    properties?: pulumi.Input<inputs.digitaltwins.v20220531.AzureDataExplorerConnectionPropertiesArgs>;
    /**
