...
export class DigitalTwinsEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:digitaltwins/preview:DigitalTwinsEndpoint';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.digitaltwins.preview.EventGridResponse | outputs.digitaltwins.preview.EventHubResponse | outputs.digitaltwins.preview.ServiceBusResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: DigitalTwinsEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:digitaltwins/v20200301preview:DigitalTwinsEndpoint" }] };
...
export interface DigitalTwinsEndpointArgs {
     ...
     * DigitalTwinsInstance endpoint resource properties.
     */
    readonly properties?: pulumi.Input<inputs.digitaltwins.preview.EventGrid | inputs.digitaltwins.preview.EventHub | inputs.digitaltwins.preview.ServiceBus>;
    /**
