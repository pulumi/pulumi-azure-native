...
export class DigitalTwin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:digitaltwins/preview:DigitalTwin';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.digitaltwins.preview.DigitalTwinsSkuInfoResponse | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, argsOrState?: DigitalTwinArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:digitaltwins/v20200301preview:DigitalTwin" }] };
...
export interface DigitalTwinArgs {
     ...
     * This property is reserved for future use, and will be ignored/omitted
     */
    readonly sku?: pulumi.Input<inputs.digitaltwins.preview.DigitalTwinsSkuInfo>;
    /**
     * The resource tags.
     */
