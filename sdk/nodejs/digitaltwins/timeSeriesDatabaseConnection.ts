...
export class TimeSeriesDatabaseConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.digitaltwins.AzureDataExplorerConnectionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: TimeSeriesDatabaseConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.timeSeriesDatabaseConnectionName === undefined && !opts.urn) {
                throw new Error("Missing required property 'timeSeriesDatabaseConnectionName'");
            }
