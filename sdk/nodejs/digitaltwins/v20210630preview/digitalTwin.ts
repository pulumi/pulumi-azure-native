...
export class DigitalTwin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DigitalTwin {
        pulumi.log.warn("DigitalTwin is deprecated: azure-native:digitaltwins/v20210630preview:DigitalTwin is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:DigitalTwin to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: DigitalTwinArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:digitaltwins:DigitalTwin" }, { type: "azure-native:digitaltwins/v20200301preview:DigitalTwin" }, { type: "azure-native:digitaltwins/v20201031:DigitalTwin" }, { type: "azure-native:digitaltwins/v20201201:DigitalTwin" }, { type: "azure-native:digitaltwins/v20220531:DigitalTwin" }, { type: "azure-native:digitaltwins/v20221031:DigitalTwin" }, { type: "azure-native:digitaltwins/v20230131:DigitalTwin" }] };
