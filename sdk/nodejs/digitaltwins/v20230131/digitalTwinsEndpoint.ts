...
export class DigitalTwinsEndpoint extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.digitaltwins.v20230131.EventGridResponse | outputs.digitaltwins.v20230131.EventHubResponse | outputs.digitaltwins.v20230131.ServiceBusResponse>;
    /**
    ...
    constructor(name: string, args: DigitalTwinsEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:digitaltwins:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20210630preview:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint" }] };
...
export interface DigitalTwinsEndpointArgs {
     ...
     * DigitalTwinsInstance endpoint resource properties.
     */
    properties: pulumi.Input<inputs.digitaltwins.v20230131.EventGridArgs | inputs.digitaltwins.v20230131.EventHubArgs | inputs.digitaltwins.v20230131.ServiceBusArgs>;
    /**
