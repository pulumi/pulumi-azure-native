...
export function getDigitalTwinsEndpoint(args: GetDigitalTwinsEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetDigitalTwinsEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:digitaltwins/v20200301preview:getDigitalTwinsEndpoint", {
...
export interface GetDigitalTwinsEndpointResult {
     ...
     */
    readonly properties: outputs.digitaltwins.v20200301preview.DigitalTwinsEndpointResourcePropertiesResponse;
    /**
     * The resource type.
     */
