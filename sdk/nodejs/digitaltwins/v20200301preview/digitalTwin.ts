...
export class DigitalTwin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DigitalTwin {
        pulumi.log.warn("DigitalTwin is deprecated: Version v20200301preview will be removed in the next major version of the provider. Upgrade to version v20220531 or later.")
    ...
    constructor(name: string, args: DigitalTwinArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:digitaltwins:DigitalTwin" }, { type: "azure-native:digitaltwins/v20201031:DigitalTwin" }, { type: "azure-native:digitaltwins/v20201201:DigitalTwin" }, { type: "azure-native:digitaltwins/v20210630preview:DigitalTwin" }, { type: "azure-native:digitaltwins/v20220531:DigitalTwin" }] };
