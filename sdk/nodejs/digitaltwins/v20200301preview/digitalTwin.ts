...
export class DigitalTwin extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DigitalTwinArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:digitaltwins:DigitalTwin" }, { type: "azure-nextgen:digitaltwins:DigitalTwin" }, { type: "azure-native:digitaltwins/latest:DigitalTwin" }, { type: "azure-nextgen:digitaltwins/latest:DigitalTwin" }, { type: "azure-native:digitaltwins/v20201031:DigitalTwin" }, { type: "azure-nextgen:digitaltwins/v20201031:DigitalTwin" }, { type: "azure-native:digitaltwins/v20201201:DigitalTwin" }, { type: "azure-nextgen:digitaltwins/v20201201:DigitalTwin" }] };
