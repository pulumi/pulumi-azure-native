...
export class DigitalTwinsEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DigitalTwinsEndpoint {
        return new DigitalTwinsEndpoint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:digitaltwins/v20200301preview:DigitalTwinsEndpoint';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.digitaltwins.v20200301preview.DigitalTwinsEndpointResourcePropertiesResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, argsOrState?: DigitalTwinsEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DigitalTwinsEndpointArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:digitaltwins/preview:DigitalTwinsEndpoint" }] };
...
export interface DigitalTwinsEndpointArgs {
     ...
     * DigitalTwinsInstance endpoint resource properties.
     */
    readonly properties?: pulumi.Input<inputs.digitaltwins.v20200301preview.DigitalTwinsEndpointResourceProperties>;
    /**
