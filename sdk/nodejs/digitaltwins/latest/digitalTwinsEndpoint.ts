 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:digitaltwins:DigitalTwinsEndpoint'.
 */
export class DigitalTwinsEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DigitalTwinsEndpoint {
        pulumi.log.warn("DigitalTwinsEndpoint is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:digitaltwins:DigitalTwinsEndpoint'.")
        return new DigitalTwinsEndpoint(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:digitaltwins/latest:DigitalTwinsEndpoint';
    ...
    constructor(name: string, args: DigitalTwinsEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:digitaltwins/latest:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins:DigitalTwinsEndpoint" }, { type: "azure-nextgen:digitaltwins:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20200301preview:DigitalTwinsEndpoint" }, { type: "azure-nextgen:digitaltwins/v20200301preview:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint" }, { type: "azure-nextgen:digitaltwins/v20201031:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint" }, { type: "azure-nextgen:digitaltwins/v20201201:DigitalTwinsEndpoint" }] };
