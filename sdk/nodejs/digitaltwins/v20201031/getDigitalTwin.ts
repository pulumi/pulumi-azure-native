 ...
 */
/** @deprecated Version v20201031 will be removed in the next major version of the provider. Upgrade to version v20220531 or later. */
export function getDigitalTwin(args: GetDigitalTwinArgs, opts?: pulumi.InvokeOptions): Promise<GetDigitalTwinResult> {
    pulumi.log.warn("getDigitalTwin is deprecated: Version v20201031 will be removed in the next major version of the provider. Upgrade to version v20220531 or later.")
    if (!opts) {
        opts = {}
    }
