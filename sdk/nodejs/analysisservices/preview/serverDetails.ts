...
export class ServerDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:analysisservices/preview:ServerDetails';
     ...
     */
    public readonly asAdministrators!: pulumi.Output<outputs.analysisservices.preview.ServerAdministratorsResponse | undefined>;
    /**
     ...
     */
    public readonly gatewayDetails!: pulumi.Output<outputs.analysisservices.preview.GatewayDetailsResponse | undefined>;
    /**
     * The firewall settings for the AS server.
     */
    public readonly ipV4FirewallSettings!: pulumi.Output<outputs.analysisservices.preview.IPv4FirewallSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.analysisservices.preview.ResourceSkuResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: ServerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:analysisservices/latest:ServerDetails" }, { type: "azurerm:analysisservices/v20160516:ServerDetails" }, { type: "azurerm:analysisservices/v20170714:ServerDetails" }, { type: "azurerm:analysisservices/v20170801:ServerDetails" }, { type: "azurerm:analysisservices/v20170801beta:ServerDetails" }] };
...
export interface ServerDetailsArgs {
     ...
     * A collection of AS server administrators
     */
    readonly asAdministrators?: pulumi.Input<inputs.analysisservices.preview.ServerAdministrators>;
    /**
     * The SAS container URI to the backup container.
     */
     ...
     * The gateway details configured for the AS server.
     */
    readonly gatewayDetails?: pulumi.Input<inputs.analysisservices.preview.GatewayDetails>;
    /**
     * The firewall settings for the AS server.
     */
    readonly ipV4FirewallSettings?: pulumi.Input<inputs.analysisservices.preview.IPv4FirewallSettings>;
    /**
     * Location of the Analysis Services resource.
     */
     ...
     * The SKU of the Analysis Services resource.
     */
    readonly sku: pulumi.Input<inputs.analysisservices.preview.ResourceSku>;
    /**
     * Key-value pairs of additional resource provisioning properties.
     */
