...
export class ServerDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:analysisservices:ServerDetails';
    ...
    constructor(name: string, args: ServerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:analysisservices/latest:ServerDetails" }, { type: "azure-nextgen:analysisservices/v20160516:ServerDetails" }, { type: "azure-nextgen:analysisservices/v20170714:ServerDetails" }, { type: "azure-nextgen:analysisservices/v20170801:ServerDetails" }, { type: "azure-nextgen:analysisservices/v20170801beta:ServerDetails" }] };
...
export interface ServerDetailsArgs {
     ...
     * A collection of AS server administrators
     */
    readonly asAdministrators?: pulumi.Input<inputs.analysisservices.ServerAdministrators>;
    /**
     * The SAS container URI to the backup container.
     */
     ...
     * The gateway details configured for the AS server.
     */
    readonly gatewayDetails?: pulumi.Input<inputs.analysisservices.GatewayDetails>;
    /**
     * The firewall settings for the AS server.
     */
    readonly ipV4FirewallSettings?: pulumi.Input<inputs.analysisservices.IPv4FirewallSettings>;
    /**
     * Location of the Analysis Services resource.
     */
     ...
     * The SKU of the Analysis Services resource.
     */
    readonly sku: pulumi.Input<inputs.analysisservices.ResourceSku>;
    /**
     * Key-value pairs of additional resource provisioning properties.
     */
