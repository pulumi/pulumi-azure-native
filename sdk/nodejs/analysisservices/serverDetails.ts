...
export class ServerDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:analysisservices:ServerDetails';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.analysisservices.AnalysisServicesServerPropertiesResponse>;
    /**
...
export interface ServerDetailsArgs {
     ...
     * Properties of the provision operation request.
     */
    readonly properties?: pulumi.Input<inputs.analysisservices.AnalysisServicesServerProperties>;
    /**
