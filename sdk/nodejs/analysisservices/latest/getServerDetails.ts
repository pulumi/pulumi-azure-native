...
export function getServerDetails(args: GetServerDetailsArgs, opts?: pulumi.InvokeOptions): Promise<GetServerDetailsResult> {
    ...
    return pulumi.runtime.invoke("azurerm:analysisservices/latest:getServerDetails", {
...
export interface GetServerDetailsResult {
     ...
     */
    readonly asAdministrators?: outputs.analysisservices.latest.ServerAdministratorsResponse;
    /**
     ...
     */
    readonly sku: outputs.analysisservices.latest.ResourceSkuResponse;
    /**
