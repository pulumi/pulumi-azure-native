...
export class ServerDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:analysisservices/latest:ServerDetails';
     ...
     */
    public readonly asAdministrators!: pulumi.Output<outputs.analysisservices.latest.ServerAdministratorsResponse | undefined>;
    /**
     ...
     */
    public readonly gatewayDetails!: pulumi.Output<outputs.analysisservices.latest.GatewayDetailsResponse | undefined>;
    /**
     * The firewall settings for the AS server.
     */
    public readonly ipV4FirewallSettings!: pulumi.Output<outputs.analysisservices.latest.IPv4FirewallSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.analysisservices.latest.ResourceSkuResponse>;
    /**
    ...
    constructor(name: string, args: ServerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:analysisservices/v20160516:ServerDetails" }, { type: "azure-nextgen:analysisservices/v20170714:ServerDetails" }, { type: "azure-nextgen:analysisservices/v20170801:ServerDetails" }, { type: "azure-nextgen:analysisservices/v20170801beta:ServerDetails" }] };
...
export interface ServerDetailsArgs {
     ...
     * A collection of AS server administrators
     */
    readonly asAdministrators?: pulumi.Input<inputs.analysisservices.latest.ServerAdministrators>;
    /**
     * The SAS container URI to the backup container.
     */
     ...
     * The gateway details configured for the AS server.
     */
    readonly gatewayDetails?: pulumi.Input<inputs.analysisservices.latest.GatewayDetails>;
    /**
     * The firewall settings for the AS server.
     */
    readonly ipV4FirewallSettings?: pulumi.Input<inputs.analysisservices.latest.IPv4FirewallSettings>;
    /**
     * Location of the Analysis Services resource.
     */
     ...
     * The managed mode of the server (0 = not managed, 1 = managed).
     */
    readonly managedMode?: pulumi.Input<enums.analysisservices.latest.ManagedMode>;
    /**
     * How the read-write server's participation in the query pool is controlled.<br/>It can have the following values: <ul><li>readOnly - indicates that the read-write server is intended not to participate in query operations</li><li>all - indicates that the read-write server can participate in query operations</li></ul>Specifying readOnly when capacity is 1 results in error.
     */
    readonly querypoolConnectionMode?: pulumi.Input<enums.analysisservices.latest.ConnectionMode>;
    /**
     ...
     * The server monitor mode for AS server
     */
    readonly serverMonitorMode?: pulumi.Input<enums.analysisservices.latest.ServerMonitorMode>;
    /**
     ...
     * The SKU of the Analysis Services resource.
     */
    readonly sku: pulumi.Input<inputs.analysisservices.latest.ResourceSku>;
    /**
     * Key-value pairs of additional resource provisioning properties.
     */
