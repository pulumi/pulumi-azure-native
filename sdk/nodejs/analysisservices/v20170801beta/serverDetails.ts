 ...
 *
 * const serverDetails = new azurerm.analysisservices.v20170801beta.ServerDetails("serverDetails", {
 *     asAdministrators: {
 *         members: [
...
export class ServerDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:analysisservices/v20170801beta:ServerDetails';
    ...
    constructor(name: string, args: ServerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:analysisservices/latest:ServerDetails" }, { type: "azurerm:analysisservices/v20160516:ServerDetails" }, { type: "azurerm:analysisservices/v20170714:ServerDetails" }, { type: "azurerm:analysisservices/v20170801:ServerDetails" }] };
