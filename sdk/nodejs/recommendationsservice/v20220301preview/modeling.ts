...
export class Modeling extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.recommendationsservice.v20220301preview.ModelingResourceResponseProperties>;
    /**
    ...
    constructor(name: string, args: ModelingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recommendationsservice/v20220201:Modeling" }, { type: "azure-native:recommendationsservice:Modeling" }] };
