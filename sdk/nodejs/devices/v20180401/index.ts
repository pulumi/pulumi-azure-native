...
// Export enums:
export * from "../../types/enums/devices/v20180401";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:devices/v20180401:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20180401:IotHubResource":
                return new IotHubResource(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20180401:IotHubResourceEventHubConsumerGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "devices/v20180401", _module)
