...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:devices/v20200801:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20200801:IotHubResource":
                return new IotHubResource(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20200801:IotHubResourceEventHubConsumerGroup":
                return new IotHubResourceEventHubConsumerGroup(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20200801:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "devices/v20200801", _module)
