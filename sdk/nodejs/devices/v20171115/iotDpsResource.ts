 ...
 *
 * const iotDpsResource = new azurerm.devices.v20171115.IotDpsResource("iotDpsResource", {
 *     location: "East US",
...
export class IotDpsResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices/v20171115:IotDpsResource';
    ...
    constructor(name: string, args: IotDpsResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devices/latest:IotDpsResource" }, { type: "azurerm:devices/v20170821preview:IotDpsResource" }, { type: "azurerm:devices/v20180122:IotDpsResource" }, { type: "azurerm:devices/v20200101:IotDpsResource" }, { type: "azurerm:devices/v20200301:IotDpsResource" }, { type: "azurerm:devices/v20200901preview:IotDpsResource" }] };
