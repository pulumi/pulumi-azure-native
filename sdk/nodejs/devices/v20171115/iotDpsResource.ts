...
export class IotDpsResource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotDpsResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devices/latest:IotDpsResource" }, { type: "azurerm:devices/v20170821preview:IotDpsResource" }, { type: "azurerm:devices/v20180122:IotDpsResource" }, { type: "azurerm:devices/v20200101:IotDpsResource" }] };
