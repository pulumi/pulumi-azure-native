...
export function getDpsCertificate(args: GetDpsCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetDpsCertificateResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:devices/v20171115:getDpsCertificate", {
...
export interface GetDpsCertificateResult {
     ...
     */
    readonly properties: outputs.devices.v20171115.CertificatePropertiesInvokeResponse;
    /**
     * The resource type.
     */
