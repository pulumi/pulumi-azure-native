...
export class IotHubResourceEventHubConsumerGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IotHubResourceEventHubConsumerGroup {
        pulumi.log.warn("IotHubResourceEventHubConsumerGroup is deprecated: azure-native:devices/v20210331:IotHubResourceEventHubConsumerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20221115preview:IotHubResourceEventHubConsumerGroup to guarantee forwards compatibility.")
        return new IotHubResourceEventHubConsumerGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20210331:IotHubResourceEventHubConsumerGroup';
...
export interface IotHubResourceEventHubConsumerGroupArgs {
     ...
     */
    properties: pulumi.Input<inputs.devices.v20210331.EventHubConsumerGroupNameArgs>;
    /**
