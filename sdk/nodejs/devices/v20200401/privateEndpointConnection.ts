 ...
 *
 * const privateEndpointConnection = new azurerm.devices.v20200401.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices/v20200401:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devices/latest:PrivateEndpointConnection" }, { type: "azurerm:devices/v20200301:PrivateEndpointConnection" }, { type: "azurerm:devices/v20200615:PrivateEndpointConnection" }, { type: "azurerm:devices/v20200710preview:PrivateEndpointConnection" }, { type: "azurerm:devices/v20200801:PrivateEndpointConnection" }] };
