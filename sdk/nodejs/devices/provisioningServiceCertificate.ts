 ...
 */
export class ProvisioningServiceCertificate extends pulumi.CustomResource {
    /**
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices:ProvisioningServiceCertificate';

    /**
     * Returns true if the given object is an instance of ProvisioningServiceCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProvisioningServiceCertificate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ProvisioningServiceCertificate.__pulumiType;
    }
 ...
 */
export interface ProvisioningServiceCertificateArgs {
    /**
