...
// Export enums:
export * from "../../types/enums/devices/v20191104";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:devices/v20191104:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20191104:IotHubResource":
                return new IotHubResource(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20191104:IotHubResourceEventHubConsumerGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "devices/v20191104", _module)
