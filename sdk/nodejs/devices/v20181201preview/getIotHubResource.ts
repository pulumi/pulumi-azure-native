...
export function getIotHubResource(args: GetIotHubResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetIotHubResourceResult> {
    pulumi.log.warn("getIotHubResource is deprecated: Version v20181201preview will be removed in the next major version of the provider. Upgrade to version v20200301 or later.")
    if (!opts) {
        opts = {}
    }
