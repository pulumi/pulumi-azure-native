...
export class DpsCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DpsCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devices/latest:DpsCertificate" }, { type: "azure-nextgen:devices/v20170821preview:DpsCertificate" }, { type: "azure-nextgen:devices/v20171115:DpsCertificate" }, { type: "azure-nextgen:devices/v20180122:DpsCertificate" }, { type: "azure-nextgen:devices/v20200301:DpsCertificate" }, { type: "azure-nextgen:devices/v20200901preview:DpsCertificate" }] };
