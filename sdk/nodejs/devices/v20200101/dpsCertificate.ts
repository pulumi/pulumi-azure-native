...
export class DpsCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DpsCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devices/latest:DpsCertificate" }, { type: "azurerm:devices/v20170821preview:DpsCertificate" }, { type: "azurerm:devices/v20171115:DpsCertificate" }, { type: "azurerm:devices/v20180122:DpsCertificate" }] };
