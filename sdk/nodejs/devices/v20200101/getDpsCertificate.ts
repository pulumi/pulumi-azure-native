...
export function getDpsCertificate(args: GetDpsCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetDpsCertificateResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:devices/v20200101:getDpsCertificate", {
...
export interface GetDpsCertificateResult {
     ...
     */
    readonly properties: outputs.devices.v20200101.CertificatePropertiesInvokeResponse;
    /**
     * The resource type.
     */
