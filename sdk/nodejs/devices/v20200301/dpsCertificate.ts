...
export class DpsCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices/v20200301:DpsCertificate';
    ...
    constructor(name: string, args: DpsCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devices/latest:DpsCertificate" }, { type: "azurerm:devices/preview:DpsCertificate" }, { type: "azurerm:devices/v20170821preview:DpsCertificate" }, { type: "azurerm:devices/v20171115:DpsCertificate" }, { type: "azurerm:devices/v20180122:DpsCertificate" }, { type: "azurerm:devices/v20200101:DpsCertificate" }] };
