...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devices/latest:PrivateEndpointConnection" }, { type: "azurerm:devices/preview:PrivateEndpointConnection" }, { type: "azurerm:devices/v20200401:PrivateEndpointConnection" }, { type: "azurerm:devices/v20200615:PrivateEndpointConnection" }, { type: "azurerm:devices/v20200710preview:PrivateEndpointConnection" }] };
