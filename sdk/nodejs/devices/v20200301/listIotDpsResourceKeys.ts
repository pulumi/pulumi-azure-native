...
export function listIotDpsResourceKeys(args: ListIotDpsResourceKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListIotDpsResourceKeysResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:devices/v20200301:listIotDpsResourceKeys", {
...
export interface ListIotDpsResourceKeysResult {
     ...
     */
    readonly value?: outputs.devices.v20200301.SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionInvokeResponse[];
}
