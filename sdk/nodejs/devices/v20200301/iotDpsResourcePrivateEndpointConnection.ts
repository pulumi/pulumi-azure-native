...
export class IotDpsResourcePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20200301:IotDpsResourcePrivateEndpointConnection';
    ...
    constructor(name: string, args: IotDpsResourcePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devices/v20200301:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-native:devices:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-nextgen:devices:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-native:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-nextgen:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-native:devices/v20211015:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-nextgen:devices/v20211015:IotDpsResourcePrivateEndpointConnection" }] };
