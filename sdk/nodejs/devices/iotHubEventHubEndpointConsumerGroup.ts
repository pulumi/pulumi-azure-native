 ...
 */
export class IotHubEventHubEndpointConsumerGroup extends pulumi.CustomResource {
    /**
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices:IotHubEventHubEndpointConsumerGroup';

    /**
     * Returns true if the given object is an instance of IotHubEventHubEndpointConsumerGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IotHubEventHubEndpointConsumerGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IotHubEventHubEndpointConsumerGroup.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: IotHubEventHubEndpointConsumerGroupArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface IotHubEventHubEndpointConsumerGroupArgs {
    /**
