...
export class IotHubResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices/preview:IotHubResource';
     ...
     * IotHub properties
     */
    public readonly properties!: pulumi.Output<outputs.devices.preview.IotHubPropertiesResponse>;
    /**
     * IotHub SKU info
     */
    public readonly sku!: pulumi.Output<outputs.devices.preview.IotHubSkuInfoResponse>;
    /**
     * The resource tags.
     */
...
export interface IotHubResourceArgs {
     ...
     * IotHub properties
     */
    readonly properties?: pulumi.Input<inputs.devices.preview.IotHubProperties>;
    /**
     ...
     * IotHub SKU info
     */
    readonly sku: pulumi.Input<inputs.devices.preview.IotHubSkuInfo>;
    /**
     * The resource tags.
     */
