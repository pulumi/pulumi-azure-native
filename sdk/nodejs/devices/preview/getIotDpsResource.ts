...
export function getIotDpsResource(args: GetIotDpsResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDpsResourceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:devices/preview:getIotDpsResource", {
...
export interface GetIotDpsResourceResult {
     ...
     */
    readonly properties: outputs.devices.preview.IotDpsPropertiesDescriptionResponse;
    /**
     * Sku info for a provisioning Service.
     */
    readonly sku: outputs.devices.preview.IotDpsSkuInfoResponse;
    /**
     * The resource tags.
     */
