...
export class IotDpsResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices/preview:IotDpsResource';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.devices.preview.IotDpsPropertiesDescriptionResponse>;
    /**
     * Sku info for a provisioning Service.
     */
    public readonly sku!: pulumi.Output<outputs.devices.preview.IotDpsSkuInfoResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, argsOrState?: IotDpsResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devices/latest:IotDpsResource" }, { type: "azurerm:devices/v20170821preview:IotDpsResource" }, { type: "azurerm:devices/v20171115:IotDpsResource" }, { type: "azurerm:devices/v20180122:IotDpsResource" }, { type: "azurerm:devices/v20200101:IotDpsResource" }] };
...
export interface IotDpsResourceArgs {
     ...
     * Service specific properties for a provisioning service
     */
    readonly properties: pulumi.Input<inputs.devices.preview.IotDpsPropertiesDescription>;
    /**
     ...
     * Sku info for a provisioning Service.
     */
    readonly sku: pulumi.Input<inputs.devices.preview.IotDpsSkuInfo>;
    /**
     * The resource tags.
     */
