...
export function listIotDpsResourceKeys(args: ListIotDpsResourceKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListIotDpsResourceKeysResult> {
    ...
    return pulumi.runtime.invoke("azurerm:devices/preview:listIotDpsResourceKeys", {
...
export interface ListIotDpsResourceKeysResult {
     ...
     */
    readonly value?: outputs.devices.preview.SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionResponse[];
}
