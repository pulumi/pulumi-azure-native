...
export class DpsCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices/preview:DpsCertificate';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.devices.preview.CertificatePropertiesResponse>;
    /**
     * The resource type.
     */
