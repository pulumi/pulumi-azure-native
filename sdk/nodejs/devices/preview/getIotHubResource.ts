...
export function getIotHubResource(args: GetIotHubResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetIotHubResourceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:devices/preview:getIotHubResource", {
...
export interface GetIotHubResourceResult {
     ...
     * IotHub properties
     */
    readonly properties: outputs.devices.preview.IotHubPropertiesResponse;
    /**
     * IotHub SKU info
     */
    readonly sku: outputs.devices.preview.IotHubSkuInfoResponse;
    /**
     * The resource tags.
     */
