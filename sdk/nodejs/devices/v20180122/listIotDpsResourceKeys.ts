...
export function listIotDpsResourceKeys(args: ListIotDpsResourceKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListIotDpsResourceKeysResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:devices/v20180122:listIotDpsResourceKeys", {
...
export interface ListIotDpsResourceKeysResult {
     ...
     */
    readonly value?: outputs.devices.v20180122.SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionInvokeResponse[];
}
