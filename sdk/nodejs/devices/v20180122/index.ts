...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:devices/v20180122:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20180122:DpsCertificate":
                return new DpsCertificate(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20180122:IotDpsResource":
                return new IotDpsResource(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20180122:IotHubResource":
                return new IotHubResource(name, <any>undefined, { urn })
            case "azure-nextgen:devices/v20180122:IotHubResourceEventHubConsumerGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "devices/v20180122", _module)
