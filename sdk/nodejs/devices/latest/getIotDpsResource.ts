...
export function getIotDpsResource(args: GetIotDpsResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDpsResourceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:devices/latest:getIotDpsResource", {
...
export interface GetIotDpsResourceResult {
     ...
     */
    readonly properties: outputs.devices.latest.IotDpsPropertiesDescriptionResponse;
    /**
     * Sku info for a provisioning Service.
     */
    readonly sku: outputs.devices.latest.IotDpsSkuInfoResponse;
    /**
     * The resource tags.
     */
