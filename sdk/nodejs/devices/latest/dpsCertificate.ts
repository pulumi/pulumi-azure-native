...
export class DpsCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DpsCertificate {
        pulumi.log.warn("DpsCertificate is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devices:DpsCertificate'.")
        return new DpsCertificate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/latest:DpsCertificate';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.devices.latest.CertificatePropertiesResponse>;
    /**
     * The resource type.
     */
