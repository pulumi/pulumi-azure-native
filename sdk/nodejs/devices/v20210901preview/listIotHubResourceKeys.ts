...
export function listIotHubResourceKeys(args: ListIotHubResourceKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListIotHubResourceKeysResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devices/v20210901preview:listIotHubResourceKeys", {
...
export interface ListIotHubResourceKeysResult {
     ...
     */
    readonly value?: outputs.devices.v20210901preview.SharedAccessSignatureAuthorizationRuleResponse[];
}
