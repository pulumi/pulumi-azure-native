...
export function listIotHubResourceKeys(args: ListIotHubResourceKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListIotHubResourceKeysResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:devices/v20190701preview:listIotHubResourceKeys", {
...
export interface ListIotHubResourceKeysResult {
     ...
     */
    readonly value?: outputs.devices.v20190701preview.SharedAccessSignatureAuthorizationRuleInvokeResponse[];
}
