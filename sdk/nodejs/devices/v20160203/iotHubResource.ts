...
azure-native:devices/v20160203:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20170701:IotHubResource to guarantee forwards compatibility.
 */
export class IotHubResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IotHubResource {
        pulumi.log.warn("IotHubResource is deprecated: Version 2016-02-03 will be removed in v2 of the provider.\nazure-native:devices/v20160203:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20170701:IotHubResource to guarantee forwards compatibility.")
