...
export class IotDpsResourcePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection';
    ...
    constructor(name: string, args: IotDpsResourcePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devices/latest:IotDpsResourcePrivateEndpointConnection" }, { type: "azurerm:devices/v20200301:IotDpsResourcePrivateEndpointConnection" }] };
