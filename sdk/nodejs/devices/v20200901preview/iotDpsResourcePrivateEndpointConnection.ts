...
export class IotDpsResourcePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.devices.v20200901preview.PrivateEndpointConnectionPropertiesResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: IotDpsResourcePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-native:devices:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-nextgen:devices:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-native:devices/latest:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-nextgen:devices/latest:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-native:devices/v20200301:IotDpsResourcePrivateEndpointConnection" }, { type: "azure-nextgen:devices/v20200301:IotDpsResourcePrivateEndpointConnection" }] };
...
export interface IotDpsResourcePrivateEndpointConnectionArgs {
     ...
     * The properties of a private endpoint connection
     */
    readonly properties: pulumi.Input<inputs.devices.v20200901preview.PrivateEndpointConnectionProperties>;
    /**
