...
export class IotDpsResource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotDpsResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devices:IotDpsResource" }, { type: "azure-native:devices/v20170821preview:IotDpsResource" }, { type: "azure-nextgen:devices/v20170821preview:IotDpsResource" }, { type: "azure-native:devices/v20171115:IotDpsResource" }, { type: "azure-nextgen:devices/v20171115:IotDpsResource" }, { type: "azure-native:devices/v20180122:IotDpsResource" }, { type: "azure-nextgen:devices/v20180122:IotDpsResource" }, { type: "azure-native:devices/v20200101:IotDpsResource" }, { type: "azure-nextgen:devices/v20200101:IotDpsResource" }, { type: "azure-native:devices/v20200301:IotDpsResource" }, { type: "azure-nextgen:devices/v20200301:IotDpsResource" }, { type: "azure-native:devices/v20200901preview:IotDpsResource" }, { type: "azure-nextgen:devices/v20200901preview:IotDpsResource" }] };
...
export interface IotDpsResourceArgs {
     ...
     * Service specific properties for a provisioning service
     */
    readonly properties: pulumi.Input<inputs.devices.IotDpsPropertiesDescriptionArgs>;
    /**
     ...
     * Sku info for a provisioning Service.
     */
    readonly sku: pulumi.Input<inputs.devices.IotDpsSkuInfoArgs>;
    /**
     * The resource tags.
     */
