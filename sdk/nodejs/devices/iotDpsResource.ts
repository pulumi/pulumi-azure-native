...
export class IotDpsResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:devices:IotDpsResource';
    ...
    constructor(name: string, args: IotDpsResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devices/latest:IotDpsResource" }, { type: "azure-nextgen:devices/v20170821preview:IotDpsResource" }, { type: "azure-nextgen:devices/v20171115:IotDpsResource" }, { type: "azure-nextgen:devices/v20180122:IotDpsResource" }, { type: "azure-nextgen:devices/v20200101:IotDpsResource" }, { type: "azure-nextgen:devices/v20200301:IotDpsResource" }, { type: "azure-nextgen:devices/v20200901preview:IotDpsResource" }] };
