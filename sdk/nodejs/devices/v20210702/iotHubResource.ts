...
export class IotHubResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IotHubResource {
        pulumi.log.warn("IotHubResource is deprecated: azure-native:devices/v20210702:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:IotHubResource to guarantee forwards compatibility.")
        return new IotHubResource(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20210702:IotHubResource';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.devices.v20210702.ArmIdentityResponse | undefined>;
    /**
     ...
     * IotHub properties
     */
    public readonly properties!: pulumi.Output<outputs.devices.v20210702.IotHubPropertiesResponse>;
    /**
     * IotHub SKU info
     */
    public readonly sku!: pulumi.Output<outputs.devices.v20210702.IotHubSkuInfoResponse>;
    /**
     * The system meta data relating to this resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.devices.v20210702.SystemDataResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IotHubResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.devices.v20210702.iotHubPropertiesArgsProvideDefaults) : undefined) : undefined;
