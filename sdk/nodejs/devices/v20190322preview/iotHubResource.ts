 ...
 *
 * const iotHubResource = new azurerm.devices.v20190322preview.IotHubResource("iotHubResource", {
 *     etag: "AAAAAAFD6M4=",
...
export class IotHubResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devices/v20190322preview:IotHubResource';
...
export interface IotHubResourceArgs {
     ...
     * IotHub properties
     */
    readonly properties?: pulumi.Input<inputs.devices.v20190322preview.IotHubProperties>;
    /**
     ...
     * IotHub SKU info
     */
    readonly sku: pulumi.Input<inputs.devices.v20190322preview.IotHubSkuInfo>;
    /**
     * The resource tags.
     */
