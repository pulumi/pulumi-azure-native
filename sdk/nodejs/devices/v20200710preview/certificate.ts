 ...
 *
 * @deprecated Version 2020-07-10-preview will be removed in v2 of the provider.
 */
export class Certificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Certificate {
        pulumi.log.warn("Certificate is deprecated: Version 2020-07-10-preview will be removed in v2 of the provider.")
