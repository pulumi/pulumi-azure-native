...
export class IotHubResourceEventHubConsumerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:devices/v20200710preview:IotHubResourceEventHubConsumerGroup';
