...
export function getIotHubResource(args: GetIotHubResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetIotHubResourceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:devices/v20170701:getIotHubResource", {
...
export interface GetIotHubResourceResult {
     ...
     */
    readonly properties: outputs.devices.v20170701.IotHubPropertiesInvokeResponse;
    /**
     ...
     */
    readonly sku: outputs.devices.v20170701.IotHubSkuInfoInvokeResponse;
    /**
