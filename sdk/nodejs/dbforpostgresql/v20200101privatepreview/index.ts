...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dbforpostgresql/v20200101privatepreview:SingleServerServerKey":
...
pulumi.runtime.registerResourceModule("azure-native", "dbforpostgresql/v20200101privatepreview", _module)
