 ...
 *
 * const serverKey = new azurerm.dbforpostgresql.v20200101privatepreview.ServerKey("serverKey", {
...
export class ServerKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/v20200101privatepreview:ServerKey';
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:ServerKey" }, { type: "azurerm:dbforpostgresql/v20200101:ServerKey" }] };
