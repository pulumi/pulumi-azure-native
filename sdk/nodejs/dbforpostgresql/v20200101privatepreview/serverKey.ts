...
export class ServerKey extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:ServerKey" }, { type: "azurerm:dbforpostgresql/preview:ServerKey" }, { type: "azurerm:dbforpostgresql/v20200101:ServerKey" }] };
