 ...
 */
/** @deprecated azure-native:dbforpostgresql/v20200101privatepreview:ServerKey is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20200214privatepreview:ServerKey to guarantee forwards compatibility. */
export function getServerKey(args: GetServerKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetServerKeyResult> {
    pulumi.log.warn("getServerKey is deprecated: azure-native:dbforpostgresql/v20200101privatepreview:ServerKey is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20200214privatepreview:ServerKey to guarantee forwards compatibility.")
