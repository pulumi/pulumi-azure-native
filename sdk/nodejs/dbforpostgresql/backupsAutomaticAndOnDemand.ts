...
export class BackupsAutomaticAndOnDemand extends pulumi.CustomResource {
    /**
     * Get an existing BackupsAutomaticAndOnDemand resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupsAutomaticAndOnDemand {
        return new BackupsAutomaticAndOnDemand(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql:BackupsAutomaticAndOnDemand';

    /**
     * Returns true if the given object is an instance of BackupsAutomaticAndOnDemand.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BackupsAutomaticAndOnDemand {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === BackupsAutomaticAndOnDemand.__pulumiType;
    }
    ...
    /**
     * Create a BackupsAutomaticAndOnDemand resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: BackupsAutomaticAndOnDemandArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface BackupsAutomaticAndOnDemandArgs {
    /**
     * Name of the backup.
     */
