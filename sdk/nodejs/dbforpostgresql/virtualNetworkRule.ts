...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbforpostgresql:VirtualNetworkRule';
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql/latest:VirtualNetworkRule" }, { type: "azure-nextgen:dbforpostgresql/v20171201:VirtualNetworkRule" }, { type: "azure-nextgen:dbforpostgresql/v20171201preview:VirtualNetworkRule" }] };
