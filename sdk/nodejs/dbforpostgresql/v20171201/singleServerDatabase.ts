...
export class SingleServerDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20171201:SingleServerDatabase';
    ...
    constructor(name: string, args: SingleServerDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbforpostgresql/v20171201:Database" }, { type: "azure-native:dbforpostgresql/v20171201preview:SingleServerDatabase" }, { type: "azure-native:dbforpostgresql:SingleServerDatabase" }] };
