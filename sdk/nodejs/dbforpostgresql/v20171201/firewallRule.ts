...
export class FirewallRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:FirewallRule" }, { type: "azurerm:dbforpostgresql/preview:FirewallRule" }, { type: "azurerm:dbforpostgresql/v20171201preview:FirewallRule" }] };
