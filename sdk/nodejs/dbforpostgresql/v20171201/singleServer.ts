...
export class SingleServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20171201:SingleServer';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.dbforpostgresql.v20171201.SingleServerSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SingleServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbforpostgresql/v20171201:Server" }, { type: "azure-native:dbforpostgresql/v20171201preview:Server" }, { type: "azure-native:dbforpostgresql/v20171201preview:SingleServer" }, { type: "azure-native:dbforpostgresql:SingleServer" }] };
...
export interface SingleServerArgs {
     ...
     * The SKU (pricing tier) of the server.
     */
    sku?: pulumi.Input<inputs.dbforpostgresql.v20171201.SingleServerSkuArgs>;
    /**
