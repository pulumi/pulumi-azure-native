...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:ServerAdministrator" }, { type: "azurerm:dbforpostgresql/preview:ServerAdministrator" }, { type: "azurerm:dbforpostgresql/v20171201preview:ServerAdministrator" }] };
