 ...
 *
 * const serverAdministrator = new azurerm.dbforpostgresql.v20171201.ServerAdministrator("serverAdministrator", {
...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/v20171201:ServerAdministrator';
    ...
    constructor(name: string, argsOrState?: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:ServerAdministrator" }, { type: "azurerm:dbforpostgresql/v20171201preview:ServerAdministrator" }] };
