...
export class ServerAdministrator extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.dbforpostgresql.v20171201.ServerAdministratorPropertiesResponse>;
    /**
...
export interface ServerAdministratorArgs {
     ...
     * Properties of the server AAD administrator.
     */
    readonly properties?: pulumi.Input<inputs.dbforpostgresql.v20171201.ServerAdministratorProperties>;
    /**
