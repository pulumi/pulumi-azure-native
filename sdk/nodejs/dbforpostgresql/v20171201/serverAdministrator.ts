...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql/latest:ServerAdministrator" }, { type: "azure-nextgen:dbforpostgresql/v20171201preview:ServerAdministrator" }] };
