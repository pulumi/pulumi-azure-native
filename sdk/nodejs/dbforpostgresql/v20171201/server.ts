...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbforpostgresql/v20171201:Server';
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql:Server" }, { type: "azure-nextgen:dbforpostgresql/latest:Server" }, { type: "azure-nextgen:dbforpostgresql/v20171201preview:Server" }] };
