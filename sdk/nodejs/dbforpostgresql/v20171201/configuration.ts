...
export class Configuration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbforpostgresql/v20171201:Configuration';
    ...
    constructor(name: string, args: ConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql:Configuration" }, { type: "azure-nextgen:dbforpostgresql/latest:Configuration" }, { type: "azure-nextgen:dbforpostgresql/v20171201preview:Configuration" }] };
