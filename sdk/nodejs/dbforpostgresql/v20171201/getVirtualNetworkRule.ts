...
export function getVirtualNetworkRule(args: GetVirtualNetworkRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:dbforpostgresql/v20171201:getVirtualNetworkRule", {
        "name": args.name,
...
export interface GetVirtualNetworkRuleResult {
     ...
     * Resource properties.
     */
    readonly properties: outputs.dbforpostgresql.v20171201.VirtualNetworkRulePropertiesResponse;
    /**
