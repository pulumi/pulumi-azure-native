...
export function getVirtualNetworkRule(args: GetVirtualNetworkRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkRuleResult> {
    pulumi.log.warn("getVirtualNetworkRule is deprecated: azure-native:dbforpostgresql/v20171201:VirtualNetworkRule is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20171201preview:VirtualNetworkRule to guarantee forwards compatibility.")
