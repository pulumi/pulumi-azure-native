...
export class ServerKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbforpostgresql:ServerKey';
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql/latest:ServerKey" }, { type: "azure-nextgen:dbforpostgresql/v20200101:ServerKey" }, { type: "azure-nextgen:dbforpostgresql/v20200101privatepreview:ServerKey" }] };
