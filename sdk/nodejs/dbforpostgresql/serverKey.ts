...
export class ServerKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql:ServerKey';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.dbforpostgresql.ServerKeyPropertiesResponse>;
    /**
...
export interface ServerKeyState {
     ...
     * Properties of the ServerKey Resource.
     */
    readonly properties: pulumi.Input<inputs.dbforpostgresql.ServerKeyPropertiesResponse>;
    /**
     * The type of the resource. Ex- Microsoft.Compute/virtualMachines or Microsoft.Storage/storageAccounts.
     */
...
export interface ServerKeyArgs {
     ...
     * Properties of the ServerKey Resource.
     */
    readonly properties?: pulumi.Input<inputs.dbforpostgresql.ServerKeyProperties>;
    /**
