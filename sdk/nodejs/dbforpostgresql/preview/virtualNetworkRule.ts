...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/preview:VirtualNetworkRule';
    ...
    constructor(name: string, argsOrState?: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:VirtualNetworkRule" }, { type: "azurerm:dbforpostgresql/v20171201:VirtualNetworkRule" }, { type: "azurerm:dbforpostgresql/v20171201preview:VirtualNetworkRule" }] };
