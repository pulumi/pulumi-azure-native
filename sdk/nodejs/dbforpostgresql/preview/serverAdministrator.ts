...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/preview:ServerAdministrator';
    ...
    constructor(name: string, args: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:ServerAdministrator" }, { type: "azurerm:dbforpostgresql/v20171201:ServerAdministrator" }, { type: "azurerm:dbforpostgresql/v20171201preview:ServerAdministrator" }] };
