...
export class CustomerMaintenanceWindow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/preview:CustomerMaintenanceWindow';
    ...
    constructor(name: string, argsOrState?: CustomerMaintenanceWindowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/v20200214privatepreview:CustomerMaintenanceWindow" }] };
