...
export class FirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/preview:FirewallRule';
    ...
    constructor(name: string, argsOrState?: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:FirewallRule" }, { type: "azurerm:dbforpostgresql/v20171201:FirewallRule" }, { type: "azurerm:dbforpostgresql/v20171201preview:FirewallRule" }] };
