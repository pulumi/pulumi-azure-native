...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/preview:Database';
    ...
    constructor(name: string, argsOrState?: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:Database" }, { type: "azurerm:dbforpostgresql/v20171201:Database" }, { type: "azurerm:dbforpostgresql/v20171201preview:Database" }] };
