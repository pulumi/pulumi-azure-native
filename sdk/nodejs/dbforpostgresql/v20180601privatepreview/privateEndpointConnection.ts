 ...
 *
 * const privateEndpointConnection = new azurerm.dbforpostgresql.v20180601privatepreview.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:PrivateEndpointConnection" }, { type: "azurerm:dbforpostgresql/v20180601:PrivateEndpointConnection" }] };
