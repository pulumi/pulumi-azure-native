...
export class ServerSecurityAlertPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql:ServerSecurityAlertPolicy';
    ...
    constructor(name: string, args: ServerSecurityAlertPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql:ServerSecurityAlertPolicy" }, { type: "azure-native:dbforpostgresql/v20171201:ServerSecurityAlertPolicy" }, { type: "azure-nextgen:dbforpostgresql/v20171201:ServerSecurityAlertPolicy" }, { type: "azure-native:dbforpostgresql/v20171201preview:ServerSecurityAlertPolicy" }, { type: "azure-nextgen:dbforpostgresql/v20171201preview:ServerSecurityAlertPolicy" }] };
...
export interface ServerSecurityAlertPolicyArgs {
     ...
     * Specifies the state of the policy, whether it is enabled or disabled.
     */
    readonly state: pulumi.Input<enums.dbforpostgresql.ServerSecurityAlertPolicyState>;
    /**
     * Specifies the identifier key of the Threat Detection audit storage account.
     */
