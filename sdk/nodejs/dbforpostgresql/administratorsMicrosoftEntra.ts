...
export class AdministratorsMicrosoftEntra extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AdministratorsMicrosoftEntra {
        return new AdministratorsMicrosoftEntra(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql:AdministratorsMicrosoftEntra';

    /**
     * Returns true if the given object is an instance of AdministratorsMicrosoftEntra.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AdministratorsMicrosoftEntra {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AdministratorsMicrosoftEntra.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AdministratorsMicrosoftEntraArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface AdministratorsMicrosoftEntraArgs {
    /**
     * Object identifier of the Microsoft Entra principal.
     */
