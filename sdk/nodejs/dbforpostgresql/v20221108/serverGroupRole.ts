...
export class ServerGroupRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20221108:ServerGroupRole';
    ...
    constructor(name: string, args: ServerGroupRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbforpostgresql:ServerGroupRole" }, { type: "azure-native:dbforpostgresql/v20230302preview:ServerGroupRole" }] };
