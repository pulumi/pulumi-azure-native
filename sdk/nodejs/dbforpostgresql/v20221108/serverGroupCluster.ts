...
export class ServerGroupCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20221108:ServerGroupCluster';
    ...
    constructor(name: string, args: ServerGroupClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbforpostgresql:ServerGroupCluster" }, { type: "azure-native:dbforpostgresql/v20201005privatepreview:ServerGroupCluster" }, { type: "azure-native:dbforpostgresql/v20230302preview:ServerGroupCluster" }] };
