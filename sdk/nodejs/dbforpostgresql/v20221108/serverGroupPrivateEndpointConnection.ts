...
export class ServerGroupPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20221108:ServerGroupPrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.dbforpostgresql.v20221108.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.dbforpostgresql.v20221108.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: ServerGroupPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbforpostgresql:ServerGroupPrivateEndpointConnection" }, { type: "azure-native:dbforpostgresql/v20230302preview:ServerGroupPrivateEndpointConnection" }] };
...
export interface ServerGroupPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.dbforpostgresql.v20221108.PrivateLinkServiceConnectionStateArgs>;
    /**
