...
export function getVirtualNetworkRule(args: GetVirtualNetworkRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:dbforpostgresql:getVirtualNetworkRule", {
        "name": args.name,
...
export interface GetVirtualNetworkRuleResult {
     ...
     * Resource properties.
     */
    readonly properties: outputs.dbforpostgresql.VirtualNetworkRulePropertiesResponse;
    /**
