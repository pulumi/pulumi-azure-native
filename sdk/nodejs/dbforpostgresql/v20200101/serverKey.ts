...
export class ServerKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerKey {
        pulumi.log.warn("ServerKey is deprecated: azure-native:dbforpostgresql/v20200101:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20200214privatepreview:ServerKey to guarantee forwards compatibility.")
        return new ServerKey(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20200101:ServerKey';
...
export interface ServerKeyArgs {
     ...
     * The key type like 'AzureKeyVault'.
     */
    serverKeyType: pulumi.Input<string | enums.dbforpostgresql.v20200101.ServerKeyType>;
    /**
