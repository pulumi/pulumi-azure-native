...
export function getServerKey(args: GetServerKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetServerKeyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:dbforpostgresql/v20200101:getServerKey", {
        "name": args.name,
...
export interface GetServerKeyResult {
     ...
     */
    readonly properties: outputs.dbforpostgresql.v20200101.ServerKeyPropertiesResponse;
    /**
