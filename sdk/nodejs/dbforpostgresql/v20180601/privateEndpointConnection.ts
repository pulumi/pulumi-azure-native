...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/v20180601:PrivateEndpointConnection';
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:PrivateEndpointConnection" }, { type: "azurerm:dbforpostgresql/preview:PrivateEndpointConnection" }, { type: "azurerm:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection" }] };
