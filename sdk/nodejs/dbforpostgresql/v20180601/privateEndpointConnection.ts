...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql/v20180601:PrivateEndpointConnection" }, { type: "azure-native:dbforpostgresql:PrivateEndpointConnection" }, { type: "azure-nextgen:dbforpostgresql:PrivateEndpointConnection" }, { type: "azure-native:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection" }, { type: "azure-nextgen:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.dbforpostgresql.v20180601.PrivateEndpointPropertyArgs>;
    readonly privateEndpointConnectionName?: pulumi.Input<string>;
    /**
     * Connection state of the private endpoint connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.dbforpostgresql.v20180601.PrivateLinkServiceConnectionStatePropertyArgs>;
    /**
