...
export function getMigration(args: GetMigrationArgs, opts?: pulumi.InvokeOptions): Promise<GetMigrationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dbforpostgresql/v20231201preview:getMigration", {
...
export interface GetMigrationResult {
     ...
     */
    readonly currentStatus: outputs.dbforpostgresql.v20231201preview.MigrationStatusResponse;
    /**
     ...
     */
    readonly sourceDbServerMetadata: outputs.dbforpostgresql.v20231201preview.DbServerMetadataResponse;
    /**
     ...
     */
    readonly systemData: outputs.dbforpostgresql.v20231201preview.SystemDataResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly targetDbServerMetadata: outputs.dbforpostgresql.v20231201preview.DbServerMetadataResponse;
    /**
...
export function getMigrationOutput(args: GetMigrationOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMigrationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:dbforpostgresql/v20231201preview:getMigration", {
        "migrationName": args.migrationName,
        "resourceGroupName": args.resourceGroupName,
        "subscriptionId": args.subscriptionId,
        "targetDbServerName": args.targetDbServerName,
