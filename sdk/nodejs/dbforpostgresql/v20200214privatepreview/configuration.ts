...
export class Configuration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql/v20200214privatepreview:Configuration" }, { type: "azure-native:dbforpostgresql/v20200214preview:Configuration" }, { type: "azure-nextgen:dbforpostgresql/v20200214preview:Configuration" }] };
