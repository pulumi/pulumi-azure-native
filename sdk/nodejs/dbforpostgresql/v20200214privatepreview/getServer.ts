...
export function getServer(args: GetServerArgs, opts?: pulumi.InvokeOptions): Promise<GetServerResult> {
    pulumi.log.warn("getServer is deprecated: azure-native:dbforpostgresql/v20200214privatepreview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20210410privatepreview:Server to guarantee forwards compatibility.")
