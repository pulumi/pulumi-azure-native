...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkRule {
        pulumi.log.warn("VirtualNetworkRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:dbforpostgresql:VirtualNetworkRule'.")
        return new VirtualNetworkRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbforpostgresql/latest:VirtualNetworkRule';
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql:VirtualNetworkRule" }, { type: "azure-nextgen:dbforpostgresql/v20171201:VirtualNetworkRule" }, { type: "azure-nextgen:dbforpostgresql/v20171201preview:VirtualNetworkRule" }] };
