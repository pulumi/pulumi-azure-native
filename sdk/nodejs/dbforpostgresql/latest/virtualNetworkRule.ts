...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql/v20171201:VirtualNetworkRule" }, { type: "azure-nextgen:dbforpostgresql/v20171201preview:VirtualNetworkRule" }] };
