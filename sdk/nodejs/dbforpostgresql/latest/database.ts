...
export class Database extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/preview:Database" }, { type: "azurerm:dbforpostgresql/v20171201:Database" }, { type: "azurerm:dbforpostgresql/v20171201preview:Database" }] };
