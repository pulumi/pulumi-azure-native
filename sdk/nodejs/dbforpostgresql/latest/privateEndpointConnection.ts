...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbforpostgresql/latest:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.dbforpostgresql.latest.PrivateEndpointPropertyResponse | undefined>;
    /**
     * Connection state of the private endpoint connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.dbforpostgresql.latest.PrivateLinkServiceConnectionStatePropertyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql:PrivateEndpointConnection" }, { type: "azure-nextgen:dbforpostgresql/v20180601:PrivateEndpointConnection" }, { type: "azure-nextgen:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.dbforpostgresql.latest.PrivateEndpointProperty>;
    readonly privateEndpointConnectionName: pulumi.Input<string>;
    /**
     * Connection state of the private endpoint connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.dbforpostgresql.latest.PrivateLinkServiceConnectionStateProperty>;
    /**
