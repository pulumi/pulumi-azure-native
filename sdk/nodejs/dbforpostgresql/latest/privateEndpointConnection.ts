...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/v20180601:PrivateEndpointConnection" }, { type: "azurerm:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection" }] };
