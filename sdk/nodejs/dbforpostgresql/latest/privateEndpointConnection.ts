...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/latest:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/preview:PrivateEndpointConnection" }, { type: "azurerm:dbforpostgresql/v20180601:PrivateEndpointConnection" }, { type: "azurerm:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection" }] };
