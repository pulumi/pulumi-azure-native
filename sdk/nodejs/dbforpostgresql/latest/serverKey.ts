...
export class ServerKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/latest:ServerKey';
    ...
    constructor(name: string, argsOrState?: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/preview:ServerKey" }, { type: "azurerm:dbforpostgresql/v20200101:ServerKey" }, { type: "azurerm:dbforpostgresql/v20200101privatepreview:ServerKey" }] };
