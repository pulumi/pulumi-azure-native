...
export class ServerKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerKey {
        pulumi.log.warn("ServerKey is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbforpostgresql:ServerKey'.")
        return new ServerKey(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/latest:ServerKey';
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql/latest:ServerKey" }, { type: "azure-native:dbforpostgresql:ServerKey" }, { type: "azure-nextgen:dbforpostgresql:ServerKey" }, { type: "azure-native:dbforpostgresql/v20200101:ServerKey" }, { type: "azure-nextgen:dbforpostgresql/v20200101:ServerKey" }, { type: "azure-native:dbforpostgresql/v20200101privatepreview:ServerKey" }, { type: "azure-nextgen:dbforpostgresql/v20200101privatepreview:ServerKey" }] };
...
export interface ServerKeyArgs {
     ...
     * The key type like 'AzureKeyVault'.
     */
    readonly serverKeyType: pulumi.Input<string | enums.dbforpostgresql.latest.ServerKeyType>;
    /**
