...
export class Server extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/preview:Server" }, { type: "azurerm:dbforpostgresql/v20171201:Server" }, { type: "azurerm:dbforpostgresql/v20171201preview:Server" }] };
