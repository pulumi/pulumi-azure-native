...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/latest:ServerAdministrator';
...
export interface ServerAdministratorArgs {
     ...
     * The type of administrator.
     */
    readonly administratorType: pulumi.Input<string | enums.dbforpostgresql.latest.AdministratorType>;
    /**
     * The server administrator login account name.
     */
