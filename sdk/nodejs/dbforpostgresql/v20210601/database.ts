 ...
 *
 * @deprecated azure-native:dbforpostgresql/v20210601:Database is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20221201:Database to guarantee forwards compatibility.
 */
export class Database extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Database {
        pulumi.log.warn("Database is deprecated: azure-native:dbforpostgresql/v20210601:Database is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20221201:Database to guarantee forwards compatibility.")
        return new Database(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20210601:Database';
