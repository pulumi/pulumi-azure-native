...
export class FirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbforpostgresql/v20200214preview:FirewallRule';
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbforpostgresql/v20200214privatepreview:FirewallRule" }] };
