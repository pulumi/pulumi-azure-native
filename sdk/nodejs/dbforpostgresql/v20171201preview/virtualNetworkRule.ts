 ...
 *
 * const virtualNetworkRule = new azure_native.dbforpostgresql.v20171201preview.VirtualNetworkRule("virtualNetworkRule", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:dbforpostgresql/v20171201preview:VirtualNetworkRule vnet-firewall-rule /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforPostgreSQL/servers/vnet-test-svr/virtualNetworkRules/vnet-firewall-rule 
 * ```
 */
