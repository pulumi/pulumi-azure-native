...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbforpostgresql/v20171201preview:Database';
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbforpostgresql/latest:Database" }, { type: "azurerm:dbforpostgresql/preview:Database" }, { type: "azurerm:dbforpostgresql/v20171201:Database" }] };
