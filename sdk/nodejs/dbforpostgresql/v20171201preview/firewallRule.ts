 ...
 *
 * @deprecated azure-native:dbforpostgresql/v20171201preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20201005privatepreview:FirewallRule to guarantee forwards compatibility.
 */
export class FirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FirewallRule {
        pulumi.log.warn("FirewallRule is deprecated: azure-native:dbforpostgresql/v20171201preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20201005privatepreview:FirewallRule to guarantee forwards compatibility.")
        return new FirewallRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20171201preview:FirewallRule';
