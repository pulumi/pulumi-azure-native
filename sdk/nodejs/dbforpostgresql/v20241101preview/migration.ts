...
export class Migration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20241101preview:Migration';
     ...
     */
    public /*out*/ readonly currentStatus!: pulumi.Output<outputs.dbforpostgresql.v20241101preview.MigrationStatusResponse>;
    /**
     ...
     */
    public /*out*/ readonly sourceDbServerMetadata!: pulumi.Output<outputs.dbforpostgresql.v20241101preview.DbServerMetadataResponse>;
    /**
     ...
     */
    public /*out*/ readonly targetDbServerMetadata!: pulumi.Output<outputs.dbforpostgresql.v20241101preview.DbServerMetadataResponse>;
    /**
...
export interface MigrationArgs {
     ...
     * To trigger cancel for entire migration we need to send this flag as True
     */
    cancel?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.CancelEnum>;
    /**
     * When you want to trigger cancel for specific databases send cancel flag as True and database names in this array
     */
     ...
     * To migrate roles and permissions we need to send this flag as True
     */
    migrateRoles?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.MigrateRolesEnum>;
    /**
     * ResourceId of the private endpoint migration instance
     */
     ...
     * There are two types of migration modes Online and Offline
     */
    migrationMode?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.MigrationMode>;
    /**
     ...
     * This indicates the supported Migration option for the migration
     */
    migrationOption?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.MigrationOption>;
    /**
     * End time in UTC for migration window
     */
     ...
     * Indicates whether the databases on the target server can be overwritten, if already present. If set to False, the migration workflow will wait for a confirmation, if it detects that the database already exists.
     */
    overwriteDbsInTarget?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.OverwriteDbsInTargetEnum>;
    /**
     ...
     */
    secretParameters?: pulumi.Input<inputs.dbforpostgresql.v20241101preview.MigrationSecretParametersArgs>;
    /**
     * Indicates whether to setup LogicalReplicationOnSourceDb, if needed
     */
    setupLogicalReplicationOnSourceDbIfNeeded?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.LogicalReplicationOnSourceDbEnum>;
    /**
     * Source server fully qualified domain name (FQDN) or IP address. It is a optional value, if customer provide it, migration service will always use it for connection
     */
     ...
     * migration source server type : OnPremises, AWS, GCP, AzureVM, PostgreSQLSingleServer, AWS_RDS, AWS_AURORA, AWS_EC2, GCP_CloudSQL, GCP_AlloyDB, GCP_Compute, EDB, EDB_Oracle_Server, EDB_PostgreSQL, PostgreSQLFlexibleServer, PostgreSQLCosmosDB, Huawei_RDS, Huawei_Compute, Heroku_PostgreSQL, Crunchy_PostgreSQL, ApsaraDB_RDS, Digital_Ocean_Droplets, Digital_Ocean_PostgreSQL, or Supabase_PostgreSQL
     */
    sourceType?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.SourceType>;
    /**
     * SSL modes for migration. Default SSL mode for PostgreSQLSingleServer is VerifyFull and Prefer for other source types
     */
    sslMode?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.SslMode>;
    /**
     * Indicates whether the data migration should start right away
     */
    startDataMigration?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.StartDataMigrationEnum>;
    /**
     ...
     * To trigger cutover for entire migration we need to send this flag as True
     */
    triggerCutover?: pulumi.Input<string | enums.dbforpostgresql.v20241101preview.TriggerCutoverEnum>;
}
