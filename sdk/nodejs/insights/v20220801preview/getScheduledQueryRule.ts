...
export interface GetScheduledQueryRuleResult {
     ...
     */
    readonly actions?: outputs.insights.v20220801preview.ActionsResponse;
    /**
     ...
     */
    readonly criteria: outputs.insights.v20220801preview.ScheduledQueryRuleCriteriaResponse;
    /**
     ...
     */
    readonly identity?: outputs.insights.v20220801preview.IdentityResponse;
    /**
     ...
     */
    readonly ruleResolveConfiguration?: outputs.insights.v20220801preview.RuleResolveConfigurationResponse;
    /**
     ...
     */
    readonly systemData: outputs.insights.v20220801preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getScheduledQueryRuleOutput(args: GetScheduledQueryRuleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScheduledQueryRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:insights/v20220801preview:getScheduledQueryRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleName": args.ruleName,
    }, opts);
}
