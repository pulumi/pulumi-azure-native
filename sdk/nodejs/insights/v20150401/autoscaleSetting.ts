...
export class AutoscaleSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AutoscaleSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:AutoscaleSetting" }, { type: "azure-native:insights/v20210501preview:AutoscaleSetting" }, { type: "azure-native:insights/v20221001:AutoscaleSetting" }] };
