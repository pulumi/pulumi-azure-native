...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ActivityLogAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/preview:ActivityLogAlert" }, { type: "azurerm:insights/v20170301preview:ActivityLogAlert" }, { type: "azurerm:insights/v20170401:ActivityLogAlert" }] };
