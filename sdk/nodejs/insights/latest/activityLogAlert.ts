...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/latest:ActivityLogAlert';
