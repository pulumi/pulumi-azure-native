...
export class MetricAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/latest:MetricAlert';
    ...
    constructor(name: string, args: MetricAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/latest:MetricAlert" }, { type: "azure-native:insights:MetricAlert" }, { type: "azure-nextgen:insights:MetricAlert" }, { type: "azure-native:insights/v20180301:MetricAlert" }, { type: "azure-nextgen:insights/v20180301:MetricAlert" }] };
