...
export class Workbook extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/preview:Workbook" }, { type: "azurerm:insights/v20150501:Workbook" }, { type: "azurerm:insights/v20180617preview:Workbook" }] };
