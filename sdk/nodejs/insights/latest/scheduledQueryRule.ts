...
export class ScheduledQueryRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ScheduledQueryRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/preview:ScheduledQueryRule" }, { type: "azurerm:insights/v20180416:ScheduledQueryRule" }, { type: "azurerm:insights/v20200501preview:ScheduledQueryRule" }] };
