...
export class ExportConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/latest:ExportConfiguration';
    ...
    constructor(name: string, argsOrState?: ExportConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/preview:ExportConfiguration" }, { type: "azurerm:insights/v20150501:ExportConfiguration" }] };
