...
export class ActionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/latest:ActionGroup';
     ...
     */
    public readonly armRoleReceivers!: pulumi.Output<outputs.insights.latest.ArmRoleReceiverResponse[] | undefined>;
    /**
     * The list of AutomationRunbook receivers that are part of this action group.
     */
    public readonly automationRunbookReceivers!: pulumi.Output<outputs.insights.latest.AutomationRunbookReceiverResponse[] | undefined>;
    /**
     * The list of AzureAppPush receivers that are part of this action group.
     */
    public readonly azureAppPushReceivers!: pulumi.Output<outputs.insights.latest.AzureAppPushReceiverResponse[] | undefined>;
    /**
     * The list of azure function receivers that are part of this action group.
     */
    public readonly azureFunctionReceivers!: pulumi.Output<outputs.insights.latest.AzureFunctionReceiverResponse[] | undefined>;
    /**
     * The list of email receivers that are part of this action group.
     */
    public readonly emailReceivers!: pulumi.Output<outputs.insights.latest.EmailReceiverResponse[] | undefined>;
    /**
     ...
     */
    public readonly logicAppReceivers!: pulumi.Output<outputs.insights.latest.LogicAppReceiverResponse[] | undefined>;
    /**
     * Azure resource name
     */
     ...
     */
    public readonly smsReceivers!: pulumi.Output<outputs.insights.latest.SmsReceiverResponse[] | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly voiceReceivers!: pulumi.Output<outputs.insights.latest.VoiceReceiverResponse[] | undefined>;
    /**
     * The list of webhook receivers that are part of this action group.
     */
    public readonly webhookReceivers!: pulumi.Output<outputs.insights.latest.WebhookReceiverResponse[] | undefined>;
    ...
    constructor(name: string, args: ActionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/latest:ActionGroup" }, { type: "azure-native:insights:ActionGroup" }, { type: "azure-nextgen:insights:ActionGroup" }, { type: "azure-native:insights/v20170401:ActionGroup" }, { type: "azure-nextgen:insights/v20170401:ActionGroup" }, { type: "azure-native:insights/v20180301:ActionGroup" }, { type: "azure-nextgen:insights/v20180301:ActionGroup" }, { type: "azure-native:insights/v20180901:ActionGroup" }, { type: "azure-nextgen:insights/v20180901:ActionGroup" }, { type: "azure-native:insights/v20190301:ActionGroup" }, { type: "azure-nextgen:insights/v20190301:ActionGroup" }, { type: "azure-native:insights/v20190601:ActionGroup" }, { type: "azure-nextgen:insights/v20190601:ActionGroup" }] };
...
export interface ActionGroupArgs {
     ...
     * The list of ARM role receivers that are part of this action group. Roles are Azure RBAC roles and only built-in roles are supported.
     */
    readonly armRoleReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.ArmRoleReceiver>[]>;
    /**
     * The list of AutomationRunbook receivers that are part of this action group.
     */
    readonly automationRunbookReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.AutomationRunbookReceiver>[]>;
    /**
     * The list of AzureAppPush receivers that are part of this action group.
     */
    readonly azureAppPushReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.AzureAppPushReceiver>[]>;
    /**
     * The list of azure function receivers that are part of this action group.
     */
    readonly azureFunctionReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.AzureFunctionReceiver>[]>;
    /**
     * The list of email receivers that are part of this action group.
     */
    readonly emailReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.EmailReceiver>[]>;
    /**
     * Indicates whether this action group is enabled. If an action group is not enabled, then none of its receivers will receive communications.
     */
     ...
     * The list of ITSM receivers that are part of this action group.
     */
    readonly itsmReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.ItsmReceiver>[]>;
    /**
     * Resource location
     */
     ...
     * The list of logic app receivers that are part of this action group.
     */
    readonly logicAppReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.LogicAppReceiver>[]>;
    /**
     ...
     * The list of SMS receivers that are part of this action group.
     */
    readonly smsReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.SmsReceiver>[]>;
    /**
     * Resource tags
     */
     ...
     * The list of voice receivers that are part of this action group.
     */
    readonly voiceReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.VoiceReceiver>[]>;
    /**
     * The list of webhook receivers that are part of this action group.
     */
    readonly webhookReceivers?: pulumi.Input<pulumi.Input<inputs.insights.latest.WebhookReceiver>[]>;
}
