...
export class Component extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/latest:Component';
     ...
     */
    public /*out*/ readonly privateLinkScopedResources!: pulumi.Output<outputs.insights.latest.PrivateLinkScopedResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: ComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/latest:Component" }, { type: "azure-native:insights:Component" }, { type: "azure-nextgen:insights:Component" }, { type: "azure-native:insights/v20150501:Component" }, { type: "azure-nextgen:insights/v20150501:Component" }, { type: "azure-native:insights/v20180501preview:Component" }, { type: "azure-nextgen:insights/v20180501preview:Component" }, { type: "azure-native:insights/v20200202preview:Component" }, { type: "azure-nextgen:insights/v20200202preview:Component" }] };
...
export interface ComponentArgs {
     ...
     * Type of application being monitored.
     */
    readonly applicationType: pulumi.Input<string | enums.insights.latest.ApplicationType>;
    /**
     * Disable IP masking.
     */
     ...
     * Used by the Application Insights system to determine what kind of flow this component was created by. This is to be set to 'Bluefield' when creating/updating a component via the REST API.
     */
    readonly flowType?: pulumi.Input<string | enums.insights.latest.FlowType>;
    /**
     * The unique application ID created when a new application is added to HockeyApp, used for communications with HockeyApp.
     */
     ...
     * Indicates the flow of the ingestion.
     */
    readonly ingestionMode?: pulumi.Input<string | enums.insights.latest.IngestionMode>;
    /**
     * The kind of application that this component refers to, used to customize UI. This value is a freeform string, values should typically be one of the following: web, ios, other, store, java, phone.
     */
     ...
     * Describes what tool created this Application Insights component. Customers using this API should set this to the default 'rest'.
     */
    readonly requestSource?: pulumi.Input<string | enums.insights.latest.RequestSource>;
    /**
