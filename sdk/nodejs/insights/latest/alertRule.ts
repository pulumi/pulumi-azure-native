...
export class AlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/latest:AlertRule';
     ...
     */
    public readonly action!: pulumi.Output<outputs.insights.latest.RuleEmailActionResponse | outputs.insights.latest.RuleWebhookActionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/latest:AlertRule" }, { type: "azure-native:insights:AlertRule" }, { type: "azure-nextgen:insights:AlertRule" }, { type: "azure-native:insights/v20140401:AlertRule" }, { type: "azure-nextgen:insights/v20140401:AlertRule" }, { type: "azure-native:insights/v20160301:AlertRule" }, { type: "azure-nextgen:insights/v20160301:AlertRule" }] };
...
export interface AlertRuleArgs {
     ...
     * action that is performed when the alert rule becomes active, and when an alert condition is resolved.
     */
    readonly action?: pulumi.Input<inputs.insights.latest.RuleEmailAction | inputs.insights.latest.RuleWebhookAction>;
    /**
     * the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
     */
