...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:PrivateLinkScope" }, { type: "azure-native:insights/v20191017preview:PrivateLinkScope" }, { type: "azure-nextgen:insights/v20191017preview:PrivateLinkScope" }] };
