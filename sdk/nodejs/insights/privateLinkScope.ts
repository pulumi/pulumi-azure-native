...
export class PrivateLinkScope extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.AzureMonitorPrivateLinkScopePropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface PrivateLinkScopeArgs {
     ...
     * Properties that define a Azure Monitor PrivateLinkScope resource.
     */
    properties: pulumi.Input<inputs.insights.AzureMonitorPrivateLinkScopePropertiesArgs>;
    /**
