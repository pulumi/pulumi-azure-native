...
export class ActionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20220601:ActionGroup';
     ...
     */
    public readonly armRoleReceivers!: pulumi.Output<outputs.insights.v20220601.ArmRoleReceiverResponse[] | undefined>;
    /**
     * The list of AutomationRunbook receivers that are part of this action group.
     */
    public readonly automationRunbookReceivers!: pulumi.Output<outputs.insights.v20220601.AutomationRunbookReceiverResponse[] | undefined>;
    /**
     * The list of AzureAppPush receivers that are part of this action group.
     */
    public readonly azureAppPushReceivers!: pulumi.Output<outputs.insights.v20220601.AzureAppPushReceiverResponse[] | undefined>;
    /**
     * The list of azure function receivers that are part of this action group.
     */
    public readonly azureFunctionReceivers!: pulumi.Output<outputs.insights.v20220601.AzureFunctionReceiverResponse[] | undefined>;
    /**
     * The list of email receivers that are part of this action group.
     */
    public readonly emailReceivers!: pulumi.Output<outputs.insights.v20220601.EmailReceiverResponse[] | undefined>;
    /**
     ...
     */
    public readonly eventHubReceivers!: pulumi.Output<outputs.insights.v20220601.EventHubReceiverResponse[] | undefined>;
    /**
     ...
     */
    public readonly itsmReceivers!: pulumi.Output<outputs.insights.v20220601.ItsmReceiverResponse[] | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly logicAppReceivers!: pulumi.Output<outputs.insights.v20220601.LogicAppReceiverResponse[] | undefined>;
    /**
     * Azure resource name
     */
     ...
     */
    public readonly smsReceivers!: pulumi.Output<outputs.insights.v20220601.SmsReceiverResponse[] | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly voiceReceivers!: pulumi.Output<outputs.insights.v20220601.VoiceReceiverResponse[] | undefined>;
    /**
     * The list of webhook receivers that are part of this action group.
     */
    public readonly webhookReceivers!: pulumi.Output<outputs.insights.v20220601.WebhookReceiverResponse[] | undefined>;
    ...
    constructor(name: string, args: ActionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:ActionGroup" }, { type: "azure-native:insights/v20170401:ActionGroup" }, { type: "azure-native:insights/v20180301:ActionGroup" }, { type: "azure-native:insights/v20180901:ActionGroup" }, { type: "azure-native:insights/v20190301:ActionGroup" }, { type: "azure-native:insights/v20190601:ActionGroup" }, { type: "azure-native:insights/v20210901:ActionGroup" }, { type: "azure-native:insights/v20220401:ActionGroup" }, { type: "azure-native:insights/v20230101:ActionGroup" }, { type: "azure-native:insights/v20230901preview:ActionGroup" }, { type: "azure-native:insights/v20241001preview:ActionGroup" }] };
...
export interface ActionGroupArgs {
     ...
     * The list of ARM role receivers that are part of this action group. Roles are Azure RBAC roles and only built-in roles are supported.
     */
    armRoleReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.ArmRoleReceiverArgs>[]>;
    /**
     * The list of AutomationRunbook receivers that are part of this action group.
     */
    automationRunbookReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.AutomationRunbookReceiverArgs>[]>;
    /**
     * The list of AzureAppPush receivers that are part of this action group.
     */
    azureAppPushReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.AzureAppPushReceiverArgs>[]>;
    /**
     * The list of azure function receivers that are part of this action group.
     */
    azureFunctionReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.AzureFunctionReceiverArgs>[]>;
    /**
     * The list of email receivers that are part of this action group.
     */
    emailReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.EmailReceiverArgs>[]>;
    /**
     * Indicates whether this action group is enabled. If an action group is not enabled, then none of its receivers will receive communications.
     */
     ...
     * The list of event hub receivers that are part of this action group.
     */
    eventHubReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.EventHubReceiverArgs>[]>;
    /**
     * The short name of the action group. This will be used in SMS messages.
     */
     ...
     * The list of ITSM receivers that are part of this action group.
     */
    itsmReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.ItsmReceiverArgs>[]>;
    /**
     * Resource location
     */
     ...
     * The list of logic app receivers that are part of this action group.
     */
    logicAppReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.LogicAppReceiverArgs>[]>;
    /**
     ...
     * The list of SMS receivers that are part of this action group.
     */
    smsReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.SmsReceiverArgs>[]>;
    /**
     * Resource tags
     */
     ...
     * The list of voice receivers that are part of this action group.
     */
    voiceReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.VoiceReceiverArgs>[]>;
    /**
     * The list of webhook receivers that are part of this action group.
     */
    webhookReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20220601.WebhookReceiverArgs>[]>;
}
