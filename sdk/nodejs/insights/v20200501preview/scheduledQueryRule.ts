...
export class ScheduledQueryRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/v20200501preview:ScheduledQueryRule';
    ...
    constructor(name: string, args: ScheduledQueryRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:ScheduledQueryRule" }, { type: "azurerm:insights/preview:ScheduledQueryRule" }, { type: "azurerm:insights/v20180416:ScheduledQueryRule" }] };
