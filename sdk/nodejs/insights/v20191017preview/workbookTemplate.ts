...
export class WorkbookTemplate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkbookTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20191017preview:WorkbookTemplate" }, { type: "azure-native:insights:WorkbookTemplate" }, { type: "azure-nextgen:insights:WorkbookTemplate" }, { type: "azure-native:insights/v20201120:WorkbookTemplate" }, { type: "azure-nextgen:insights/v20201120:WorkbookTemplate" }] };
...
export interface WorkbookTemplateArgs {
     ...
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    localized?: pulumi.Input<{[key: string]: pulumi.Input<pulumi.Input<inputs.insights.v20191017preview.WorkbookTemplateLocalizedGalleryArgs>[]>}>;
    /**
     * Resource location
     */
