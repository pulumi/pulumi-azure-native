...
export class AlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights:AlertRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.AlertRuleResponse>;
    /**
     * Resource tags
     */
...
export interface AlertRuleArgs {
     ...
     * The alert rule properties of the resource.
     */
    readonly properties: pulumi.Input<inputs.insights.AlertRuleDefinition>;
    /**
