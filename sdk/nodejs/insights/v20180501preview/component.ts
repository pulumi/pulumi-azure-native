...
export class Component extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:Component" }, { type: "azure-nextgen:insights/latest:Component" }, { type: "azure-nextgen:insights/v20150501:Component" }, { type: "azure-nextgen:insights/v20200202preview:Component" }] };
