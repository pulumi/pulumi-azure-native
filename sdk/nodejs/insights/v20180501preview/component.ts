...
export class Component extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Component {
        pulumi.log.warn("Component is deprecated: azure-native:insights/v20180501preview:Component is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20200202:Component to guarantee forwards compatibility.")
