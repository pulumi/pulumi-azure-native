...
export class WebTest extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebTest {
        pulumi.log.warn("WebTest is deprecated: azure-native:insights/v20180501preview:WebTest is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20201005preview:WebTest to guarantee forwards compatibility.")
        return new WebTest(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20180501preview:WebTest';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.insights.v20180501preview.WebTestPropertiesResponseConfiguration | undefined>;
    /**
     ...
     */
    public readonly locations!: pulumi.Output<outputs.insights.v20180501preview.WebTestGeolocationResponse[]>;
    /**
     * Azure resource name
     */
     ...
     */
    public readonly request!: pulumi.Output<outputs.insights.v20180501preview.WebTestPropertiesResponseRequest | undefined>;
    /**
     ...
     */
    public readonly validationRules!: pulumi.Output<outputs.insights.v20180501preview.WebTestPropertiesResponseValidationRules | undefined>;
    /**
    ...
    constructor(name: string, args: WebTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:WebTest" }, { type: "azure-native:insights/v20150501:WebTest" }, { type: "azure-native:insights/v20201005preview:WebTest" }, { type: "azure-native:insights/v20220615:WebTest" }] };
