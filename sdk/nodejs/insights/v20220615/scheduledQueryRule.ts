...
export class ScheduledQueryRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScheduledQueryRule {
        pulumi.log.warn("ScheduledQueryRule is deprecated: azure-native:insights/v20220615:ScheduledQueryRule is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220801preview:ScheduledQueryRule to guarantee forwards compatibility.")
        return new ScheduledQueryRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20220615:ScheduledQueryRule';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.insights.v20220615.ActionsResponse | undefined>;
    /**
     ...
     */
    public readonly criteria!: pulumi.Output<outputs.insights.v20220615.ScheduledQueryRuleCriteriaResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.insights.v20220615.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ScheduledQueryRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:ScheduledQueryRule" }, { type: "azure-native:insights/v20180416:ScheduledQueryRule" }, { type: "azure-native:insights/v20200501preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20210201preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20210801:ScheduledQueryRule" }, { type: "azure-native:insights/v20220801preview:ScheduledQueryRule" }] };
...
export interface ScheduledQueryRuleArgs {
     ...
     * Actions to invoke when the alert fires.
     */
    actions?: pulumi.Input<inputs.insights.v20220615.ActionsArgs>;
    /**
     * The flag that indicates whether the alert should be automatically resolved or not. The default is true. Relevant only for rules of the kind LogAlert.
     */
     ...
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    criteria: pulumi.Input<inputs.insights.v20220615.ScheduledQueryRuleCriteriaArgs>;
    /**
     * The description of the scheduled query rule.
     */
     ...
     * Indicates the type of scheduled query rule. The default is LogAlert.
     */
    kind?: pulumi.Input<string | enums.insights.v20220615.Kind>;
    /**
     * The geo-location where the resource lives
     */
