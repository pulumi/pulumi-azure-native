...
export class ScheduledQueryRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.v20220615.ScheduledQueryRulePropertiesResponse>;
    /**
...
export interface ScheduledQueryRuleArgs {
     ...
     * The rule properties of the resource.
     */
    properties: pulumi.Input<inputs.insights.v20220615.ScheduledQueryRulePropertiesArgs>;
    /**
