 ...
 */
/** @deprecated azure-native:insights/v20220615:ScheduledQueryRule is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220801preview:ScheduledQueryRule to guarantee forwards compatibility. */
export function getScheduledQueryRule(args: GetScheduledQueryRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledQueryRuleResult> {
    pulumi.log.warn("getScheduledQueryRule is deprecated: azure-native:insights/v20220615:ScheduledQueryRule is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220801preview:ScheduledQueryRule to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:insights/v20220615:getScheduledQueryRule", {
...
export interface GetScheduledQueryRuleResult {
     ...
     */
    readonly actions?: outputs.insights.v20220615.ActionsResponse;
    /**
     ...
     */
    readonly criteria: outputs.insights.v20220615.ScheduledQueryRuleCriteriaResponse;
    /**
     ...
     */
    readonly systemData: outputs.insights.v20220615.SystemDataResponse;
    /**
     * Resource tags.
     */
