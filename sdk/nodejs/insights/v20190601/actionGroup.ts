...
export class ActionGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ActionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:ActionGroup" }, { type: "azurerm:insights/preview:ActionGroup" }, { type: "azurerm:insights/v20170401:ActionGroup" }, { type: "azurerm:insights/v20180301:ActionGroup" }, { type: "azurerm:insights/v20180901:ActionGroup" }, { type: "azurerm:insights/v20190301:ActionGroup" }] };
