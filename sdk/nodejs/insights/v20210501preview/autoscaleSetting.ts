...
export class AutoscaleSetting extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.v20210501preview.AutoscaleSettingResponse>;
    /**
    ...
    constructor(name: string, args: AutoscaleSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.insights.v20210501preview.autoscaleSettingArgsProvideDefaults) : undefined) : undefined;
...
export interface AutoscaleSettingArgs {
     ...
     * The autoscale setting of the resource.
     */
    properties: pulumi.Input<inputs.insights.v20210501preview.AutoscaleSettingArgs>;
    /**
