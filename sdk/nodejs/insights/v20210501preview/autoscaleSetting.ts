...
export class AutoscaleSetting extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AutoscaleSetting {
        pulumi.log.warn("AutoscaleSetting is deprecated: azure-native:insights/v20210501preview:AutoscaleSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20221001:AutoscaleSetting to guarantee forwards compatibility.")
