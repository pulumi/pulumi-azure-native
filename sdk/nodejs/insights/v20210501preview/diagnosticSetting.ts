 ...
 *
 * const diagnosticSetting = new azure_native.insights.v20210501preview.DiagnosticSetting("diagnosticSetting", {
...
export class DiagnosticSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20170501preview:DiagnosticSetting" }] };
