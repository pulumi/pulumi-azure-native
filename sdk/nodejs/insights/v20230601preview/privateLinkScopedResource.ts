...
export class PrivateLinkScopedResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20230601preview:PrivateLinkScopedResource';
     ...
     * System data
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.insights.v20230601preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: PrivateLinkScopedResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20191017preview:PrivateLinkScopedResource" }, { type: "azure-native:insights/v20210701preview:PrivateLinkScopedResource" }, { type: "azure-native:insights/v20210901:PrivateLinkScopedResource" }, { type: "azure-native:insights:PrivateLinkScopedResource" }] };
...
export interface PrivateLinkScopedResourceArgs {
     ...
     * The kind of scoped Azure monitor resource.
     */
    kind?: pulumi.Input<string | enums.insights.v20230601preview.ScopedResourceKind>;
    /**
     * The resource id of the scoped Azure monitor resource.
     */
