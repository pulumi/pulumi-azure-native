...
export function getPrivateLinkScope(args: GetPrivateLinkScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateLinkScopeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:insights/v20230601preview:getPrivateLinkScope", {
...
export interface GetPrivateLinkScopeResult {
     ...
     */
    readonly accessModeSettings: outputs.insights.v20230601preview.AccessModeSettingsResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.insights.v20230601preview.PrivateEndpointConnectionResponse[];
    /**
...
export function getPrivateLinkScopeOutput(args: GetPrivateLinkScopeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateLinkScopeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:insights/v20230601preview:getPrivateLinkScope", {
        "resourceGroupName": args.resourceGroupName,
        "scopeName": args.scopeName,
    }, opts);
}
