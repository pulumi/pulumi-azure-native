...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20230601preview:PrivateLinkScope';
     ...
     */
    public readonly accessModeSettings!: pulumi.Output<outputs.insights.v20230601preview.AccessModeSettingsResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.insights.v20230601preview.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:PrivateLinkScope" }, { type: "azure-native:insights/v20191017preview:PrivateLinkScope" }, { type: "azure-native:insights/v20210701preview:PrivateLinkScope" }, { type: "azure-native:insights/v20210901:PrivateLinkScope" }] };
