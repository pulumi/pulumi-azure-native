...
export class LogProfile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LogProfile {
        return new LogProfile(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights:LogProfile';
    ...
    constructor(name: string, argsOrState?: LogProfileArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LogProfileArgs {
     ...
     * The log profile properties of the resource.
     */
    readonly properties: pulumi.Input<inputs.insights.LogProfileProperties>;
    /**
     * Resource tags
     */
