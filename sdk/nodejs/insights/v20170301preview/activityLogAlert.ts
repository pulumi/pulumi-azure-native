 ...
 *
 * const activityLogAlert = new azurerm.insights.v20170301preview.ActivityLogAlert("activityLogAlert", {
 *     actions: {
 *         actionGroups: [{
...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/v20170301preview:ActivityLogAlert';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.insights.v20170301preview.ActivityLogAlertActionListResponse>;
    /**
     * The condition that will cause this alert to activate.
     */
    public readonly condition!: pulumi.Output<outputs.insights.v20170301preview.ActivityLogAlertAllOfConditionResponse>;
    /**
    ...
    constructor(name: string, args: ActivityLogAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:ActivityLogAlert" }, { type: "azurerm:insights/v20170401:ActivityLogAlert" }] };
...
export interface ActivityLogAlertArgs {
     ...
     * The actions that will activate when the condition is met.
     */
    readonly actions: pulumi.Input<inputs.insights.v20170301preview.ActivityLogAlertActionList>;
    /**
     ...
     * The condition that will cause this alert to activate.
     */
    readonly condition: pulumi.Input<inputs.insights.v20170301preview.ActivityLogAlertAllOfCondition>;
    /**
     * A description of this activity log alert.
     */
