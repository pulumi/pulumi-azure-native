...
export class ComponentCurrentBillingFeature extends pulumi.CustomResource {
     ...
     */
    public readonly dataVolumeCap!: pulumi.Output<outputs.insights.ApplicationInsightsComponentDataVolumeCapResponse | undefined>;
    ...
    constructor(name: string, args: ComponentCurrentBillingFeatureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:ComponentCurrentBillingFeature" }, { type: "azure-native:insights/latest:ComponentCurrentBillingFeature" }, { type: "azure-nextgen:insights/latest:ComponentCurrentBillingFeature" }, { type: "azure-native:insights/v20150501:ComponentCurrentBillingFeature" }, { type: "azure-nextgen:insights/v20150501:ComponentCurrentBillingFeature" }] };
...
export interface ComponentCurrentBillingFeatureArgs {
     ...
     * An Application Insights component daily data volume cap
     */
    readonly dataVolumeCap?: pulumi.Input<inputs.insights.ApplicationInsightsComponentDataVolumeCap>;
    /**
