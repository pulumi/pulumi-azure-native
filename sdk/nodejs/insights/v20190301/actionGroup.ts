...
export class ActionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20190301:ActionGroup';
    ...
    constructor(name: string, args: ActionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20190301:ActionGroup" }, { type: "azure-native:insights:ActionGroup" }, { type: "azure-nextgen:insights:ActionGroup" }, { type: "azure-native:insights/latest:ActionGroup" }, { type: "azure-nextgen:insights/latest:ActionGroup" }, { type: "azure-native:insights/v20170401:ActionGroup" }, { type: "azure-nextgen:insights/v20170401:ActionGroup" }, { type: "azure-native:insights/v20180301:ActionGroup" }, { type: "azure-nextgen:insights/v20180301:ActionGroup" }, { type: "azure-native:insights/v20180901:ActionGroup" }, { type: "azure-nextgen:insights/v20180901:ActionGroup" }, { type: "azure-native:insights/v20190601:ActionGroup" }, { type: "azure-nextgen:insights/v20190601:ActionGroup" }] };
...
export interface ActionGroupArgs {
     ...
     * The list of ARM role receivers that are part of this action group. Roles are Azure RBAC roles and only built-in roles are supported.
     */
    readonly armRoleReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.ArmRoleReceiver>[]>;
    /**
     * The list of AutomationRunbook receivers that are part of this action group.
     */
    readonly automationRunbookReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.AutomationRunbookReceiver>[]>;
    /**
     * The list of AzureAppPush receivers that are part of this action group.
     */
    readonly azureAppPushReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.AzureAppPushReceiver>[]>;
    /**
     * The list of azure function receivers that are part of this action group.
     */
    readonly azureFunctionReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.AzureFunctionReceiver>[]>;
    /**
     * The list of email receivers that are part of this action group.
     */
    readonly emailReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.EmailReceiver>[]>;
    /**
     * Indicates whether this action group is enabled. If an action group is not enabled, then none of its receivers will receive communications.
     */
     ...
     * The list of ITSM receivers that are part of this action group.
     */
    readonly itsmReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.ItsmReceiver>[]>;
    /**
     * Resource location
     */
     ...
     * The list of logic app receivers that are part of this action group.
     */
    readonly logicAppReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.LogicAppReceiver>[]>;
    /**
     ...
     * The list of SMS receivers that are part of this action group.
     */
    readonly smsReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.SmsReceiver>[]>;
    /**
     * Resource tags
     */
     ...
     * The list of voice receivers that are part of this action group.
     */
    readonly voiceReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.VoiceReceiver>[]>;
    /**
     * The list of webhook receivers that are part of this action group.
     */
    readonly webhookReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20190301.WebhookReceiver>[]>;
}
