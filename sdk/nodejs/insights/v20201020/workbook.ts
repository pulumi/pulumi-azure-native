...
export class Workbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20201020:Workbook';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.insights.v20201020.WorkbookManagedIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20201020:Workbook" }, { type: "azure-native:insights:Workbook" }, { type: "azure-nextgen:insights:Workbook" }, { type: "azure-native:insights/v20150501:Workbook" }, { type: "azure-nextgen:insights/v20150501:Workbook" }, { type: "azure-native:insights/v20180617preview:Workbook" }, { type: "azure-nextgen:insights/v20180617preview:Workbook" }, { type: "azure-native:insights/v20210308:Workbook" }, { type: "azure-nextgen:insights/v20210308:Workbook" }] };
...
export interface WorkbookArgs {
     ...
     * Identity used for BYOS
     */
    readonly identity?: pulumi.Input<inputs.insights.v20201020.WorkbookManagedIdentityArgs>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
