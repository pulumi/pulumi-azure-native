...
export class MyWorkbook extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MyWorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20201020:MyWorkbook" }, { type: "azure-native:insights:MyWorkbook" }, { type: "azure-nextgen:insights:MyWorkbook" }, { type: "azure-native:insights/v20150501:MyWorkbook" }, { type: "azure-nextgen:insights/v20150501:MyWorkbook" }] };
...
export interface MyWorkbookArgs {
     ...
     * Identity used for BYOS
     */
    readonly identity?: pulumi.Input<inputs.insights.v20201020.MyManagedIdentityArgs>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
