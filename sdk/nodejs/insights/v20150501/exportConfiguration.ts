 ...
 *
 * const exportConfiguration = new azurerm.insights.v20150501.ExportConfiguration("exportConfiguration", {
...
export class ExportConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ExportConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:ExportConfiguration" }] };
