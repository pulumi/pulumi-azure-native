...
export class Favorite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/v20150501:Favorite';
    ...
    constructor(name: string, argsOrState?: FavoriteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:Favorite" }, { type: "azurerm:insights/preview:Favorite" }] };
