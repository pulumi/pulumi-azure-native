 ...
 *
 * const component = new azurerm.insights.v20150501.Component("component", {
 *     applicationType: "web",
 *     flowType: "Bluefield",
 *     kind: "web",
...
export class Component extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:Component" }, { type: "azurerm:insights/v20180501preview:Component" }, { type: "azurerm:insights/v20200202preview:Component" }] };
