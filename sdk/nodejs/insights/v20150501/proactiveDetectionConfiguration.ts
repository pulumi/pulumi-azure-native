...
export class ProactiveDetectionConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly ruleDefinitions!: pulumi.Output<outputs.insights.v20150501.ApplicationInsightsComponentProactiveDetectionConfigurationResponseRuleDefinitions | undefined>;
    /**
    ...
    constructor(name: string, args: ProactiveDetectionConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20180501preview:ProactiveDetectionConfiguration" }, { type: "azure-native:insights:ProactiveDetectionConfiguration" }] };
...
export interface ProactiveDetectionConfigurationArgs {
     ...
     * Static definitions of the ProactiveDetection configuration rule (same values for all components).
     */
    ruleDefinitions?: pulumi.Input<inputs.insights.v20150501.ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgs>;
    /**
     * A flag that indicated whether notifications on this rule should be sent to subscription owners
     */
