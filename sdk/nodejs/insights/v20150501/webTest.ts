 ...
 *
 * const webTest = new azure_native.insights.v20150501.WebTest("webTest", {
 *     configuration: {
 ...
 *     enabled: true,
 *     frequency: 900,
 *     kind: azure_native.insights.v20150501.WebTestKind.Ping,
 ...
 *     timeout: 120,
 *     webTestKind: azure_native.insights.v20150501.WebTestKind.Ping,
 ...
 *
 * ```sh
 * $ pulumi import azure-native:insights/v20150501:WebTest my-webtest-my-component /subscriptions/subid/resourceGroups/my-resource-group/providers/Microsoft.Insights/webtests/my-webtest-my-component 
 * ```
 */
export class WebTest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20150501:WebTest';
    ...
    constructor(name: string, args: WebTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:WebTest" }, { type: "azure-native:insights/v20180501preview:WebTest" }, { type: "azure-native:insights/v20201005preview:WebTest" }, { type: "azure-native:insights/v20220615:WebTest" }] };
...
export interface WebTestArgs {
     ...
     * An XML configuration specification for a WebTest.
     */
    configuration?: pulumi.Input<inputs.insights.v20150501.WebTestPropertiesConfigurationArgs>;
    /**
     * Purpose/user defined descriptive test for this WebTest.
     */
     ...
     * The kind of web test that this web test watches. Choices are ping and multistep.
     */
    kind?: pulumi.Input<enums.insights.v20150501.WebTestKind>;
    /**
     * Resource location
     */
     ...
     * A list of where to physically run the tests from to give global coverage for accessibility of your application.
     */
    locations: pulumi.Input<pulumi.Input<inputs.insights.v20150501.WebTestGeolocationArgs>[]>;
    /**
     ...
     * The kind of web test this is, valid choices are ping and multistep.
     */
    webTestKind: pulumi.Input<enums.insights.v20150501.WebTestKind>;
    /**
     * User defined name if this WebTest.
     */
