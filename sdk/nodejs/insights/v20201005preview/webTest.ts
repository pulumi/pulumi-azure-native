...
export class WebTest extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20201005preview:WebTest" }, { type: "azure-native:insights:WebTest" }, { type: "azure-nextgen:insights:WebTest" }, { type: "azure-native:insights/v20150501:WebTest" }, { type: "azure-nextgen:insights/v20150501:WebTest" }] };
