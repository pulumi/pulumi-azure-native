...
export function getComponent(args: GetComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:insights/v20200202preview:getComponent", {
...
export interface GetComponentResult {
     ...
     */
    readonly privateLinkScopedResources: outputs.insights.v20200202preview.PrivateLinkScopedResourceInvokeResponse[];
    /**
