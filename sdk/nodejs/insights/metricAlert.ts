...
export class MetricAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:insights:MetricAlert';
    ...
    constructor(name: string, args: MetricAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/latest:MetricAlert" }, { type: "azure-nextgen:insights/v20180301:MetricAlert" }] };
...
export interface MetricAlertArgs {
     ...
     * the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputs.insights.MetricAlertAction>[]>;
    /**
     * the flag that indicates whether the alert should be auto resolved or not. The default is true.
     */
     ...
     * defines the specific alert criteria information.
     */
    readonly criteria: pulumi.Input<inputs.insights.MetricAlertMultipleResourceMultipleMetricCriteria | inputs.insights.MetricAlertSingleResourceMultipleMetricCriteria | inputs.insights.WebtestLocationAvailabilityCriteria>;
    /**
     * the description of the metric alert that will be included in the alert email.
     */
