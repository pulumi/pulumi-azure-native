...
export class ScheduledQueryRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.LogSearchRuleResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: ScheduledQueryRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.insights.logSearchRuleArgsProvideDefaults) : undefined) : undefined;
...
export interface ScheduledQueryRuleArgs {
     ...
     * The rule properties of the resource.
     */
    properties: pulumi.Input<inputs.insights.LogSearchRuleArgs>;
    /**
