...
export class ScheduledQueryRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ScheduledQueryRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:ScheduledQueryRule" }, { type: "azure-native:insights/latest:ScheduledQueryRule" }, { type: "azure-nextgen:insights/latest:ScheduledQueryRule" }, { type: "azure-native:insights/v20180416:ScheduledQueryRule" }, { type: "azure-nextgen:insights/v20180416:ScheduledQueryRule" }, { type: "azure-native:insights/v20200501preview:ScheduledQueryRule" }, { type: "azure-nextgen:insights/v20200501preview:ScheduledQueryRule" }] };
...
export interface ScheduledQueryRuleArgs {
     ...
     * Action needs to be taken on rule execution.
     */
    readonly action: pulumi.Input<inputs.insights.AlertingAction | inputs.insights.LogToMetricAction>;
    /**
     * The description of the Log Search rule.
     */
     ...
     * Schedule (Frequency, Time Window) for rule. Required for action type - AlertingAction
     */
    readonly schedule?: pulumi.Input<inputs.insights.Schedule>;
    /**
     * Data Source against which rule will Query Data
     */
    readonly source: pulumi.Input<inputs.insights.Source>;
    /**
     * Resource tags
     */
