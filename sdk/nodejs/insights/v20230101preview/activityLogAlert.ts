 ...
 *
 * const activityLogAlert = new azure_native.insights.v20230101preview.ActivityLogAlert("activityLogAlert", {
 *     actions: {
 *         actionGroups: [{
...
export class ActivityLogAlert extends pulumi.CustomResource {
     ...
     */
    public readonly actions!: pulumi.Output<outputs.insights.v20230101preview.ActionListResponse>;
    /**
     * The condition that will cause this alert to activate.
     */
    public readonly condition!: pulumi.Output<outputs.insights.v20230101preview.AlertRuleAllOfConditionResponse>;
    /**
...
export interface ActivityLogAlertArgs {
     ...
     * The actions that will activate when the condition is met.
     */
    actions: pulumi.Input<inputs.insights.v20230101preview.ActionListArgs>;
    /**
     ...
     * The condition that will cause this alert to activate.
     */
    condition: pulumi.Input<inputs.insights.v20230101preview.AlertRuleAllOfConditionArgs>;
    /**
     * A description of this Activity Log Alert rule.
     */
