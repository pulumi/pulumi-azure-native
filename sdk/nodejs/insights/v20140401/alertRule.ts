...
export class AlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:insights/v20140401:AlertRule';
    ...
    constructor(name: string, args: AlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:AlertRule" }, { type: "azure-nextgen:insights/latest:AlertRule" }, { type: "azure-nextgen:insights/v20160301:AlertRule" }] };
