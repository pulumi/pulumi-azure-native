...
export class AlertRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20140401:AlertRule" }, { type: "azure-native:insights:AlertRule" }, { type: "azure-nextgen:insights:AlertRule" }, { type: "azure-native:insights/latest:AlertRule" }, { type: "azure-nextgen:insights/latest:AlertRule" }, { type: "azure-native:insights/v20160301:AlertRule" }, { type: "azure-nextgen:insights/v20160301:AlertRule" }] };
...
export interface AlertRuleArgs {
     ...
     * the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputs.insights.v20140401.RuleEmailAction | inputs.insights.v20140401.RuleWebhookAction>[]>;
    /**
     * the condition that results in the alert rule being activated.
     */
    readonly condition: pulumi.Input<inputs.insights.v20140401.LocationThresholdRuleCondition | inputs.insights.v20140401.ManagementEventRuleCondition | inputs.insights.v20140401.ThresholdRuleCondition>;
    /**
     * the description of the alert rule that will be included in the alert email.
     */
