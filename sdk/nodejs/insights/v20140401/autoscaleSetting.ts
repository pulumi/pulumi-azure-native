...
export class AutoscaleSetting extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.v20140401.AutoscaleSettingResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: AutoscaleSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.insights.v20140401.autoscaleSettingArgsProvideDefaults) : undefined) : undefined;
...
export interface AutoscaleSettingArgs {
     ...
     * The autoscale setting of the resource.
     */
    properties: pulumi.Input<inputs.insights.v20140401.AutoscaleSettingArgs>;
    /**
