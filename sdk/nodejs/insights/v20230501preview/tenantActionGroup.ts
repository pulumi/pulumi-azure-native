...
export class TenantActionGroup extends pulumi.CustomResource {
     ...
     */
    public readonly azureAppPushReceivers!: pulumi.Output<outputs.insights.v20230501preview.AzureAppPushReceiverResponse[] | undefined>;
    /**
     * The list of email receivers that are part of this tenant action group.
     */
    public readonly emailReceivers!: pulumi.Output<outputs.insights.v20230501preview.EmailReceiverResponse[] | undefined>;
    /**
     ...
     */
    public readonly smsReceivers!: pulumi.Output<outputs.insights.v20230501preview.SmsReceiverResponse[] | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly voiceReceivers!: pulumi.Output<outputs.insights.v20230501preview.VoiceReceiverResponse[] | undefined>;
    /**
     * The list of webhook receivers that are part of this tenant action group.
     */
    public readonly webhookReceivers!: pulumi.Output<outputs.insights.v20230501preview.WebhookReceiverResponse[] | undefined>;
    ...
    constructor(name: string, args: TenantActionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20230301preview:TenantActionGroup" }] };
...
export interface TenantActionGroupArgs {
     ...
     * The list of AzureAppPush receivers that are part of this tenant action group.
     */
    azureAppPushReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20230501preview.AzureAppPushReceiverArgs>[]>;
    /**
     * The list of email receivers that are part of this tenant action group.
     */
    emailReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20230501preview.EmailReceiverArgs>[]>;
    /**
     * Indicates whether this tenant action group is enabled. If a tenant action group is not enabled, then none of its receivers will receive communications.
     */
     ...
     * The list of SMS receivers that are part of this tenant action group.
     */
    smsReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20230501preview.SmsReceiverArgs>[]>;
    /**
     * Resource tags
     */
     ...
     * The list of voice receivers that are part of this tenant action group.
     */
    voiceReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20230501preview.VoiceReceiverArgs>[]>;
    /**
     * The list of webhook receivers that are part of this tenant action group.
     */
    webhookReceivers?: pulumi.Input<pulumi.Input<inputs.insights.v20230501preview.WebhookReceiverArgs>[]>;
}
