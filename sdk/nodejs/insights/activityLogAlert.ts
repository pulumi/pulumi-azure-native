...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights:ActivityLogAlert';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.ActivityLogAlertResponse>;
    /**
     * Resource tags
     */
...
export interface ActivityLogAlertArgs {
     ...
     * The activity log alert properties of the resource.
     */
    readonly properties?: pulumi.Input<inputs.insights.ActivityLogAlertDefinition>;
    /**
