...
export class Workbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights:Workbook';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.WorkbookPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface WorkbookArgs {
     ...
     * Metadata describing a web test for an Azure resource.
     */
    readonly properties?: pulumi.Input<inputs.insights.WorkbookProperties>;
    /**
