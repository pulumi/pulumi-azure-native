...
export class Workbook extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:Workbook" }, { type: "azure-native:insights/latest:Workbook" }, { type: "azure-nextgen:insights/latest:Workbook" }, { type: "azure-native:insights/v20150501:Workbook" }, { type: "azure-nextgen:insights/v20150501:Workbook" }, { type: "azure-native:insights/v20180617preview:Workbook" }, { type: "azure-nextgen:insights/v20180617preview:Workbook" }, { type: "azure-native:insights/v20201020:Workbook" }, { type: "azure-nextgen:insights/v20201020:Workbook" }] };
...
export interface WorkbookArgs {
     ...
     * Identity used for BYOS
     */
    readonly identity?: pulumi.Input<inputs.insights.ManagedIdentity>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
