...
export class PrivateLinkScopedResource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateLinkScopedResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:PrivateLinkScopedResource" }, { type: "azure-native:insights/v20191017preview:PrivateLinkScopedResource" }, { type: "azure-native:insights/v20210701preview:PrivateLinkScopedResource" }, { type: "azure-native:insights/v20230601preview:PrivateLinkScopedResource" }] };
