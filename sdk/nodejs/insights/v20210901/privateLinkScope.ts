...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20210901:PrivateLinkScope';
     ...
     */
    public readonly accessModeSettings!: pulumi.Output<outputs.insights.v20210901.AccessModeSettingsResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.insights.v20210901.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20191017preview:PrivateLinkScope" }, { type: "azure-native:insights/v20210701preview:PrivateLinkScope" }, { type: "azure-native:insights/v20230601preview:PrivateLinkScope" }, { type: "azure-native:insights:PrivateLinkScope" }] };
