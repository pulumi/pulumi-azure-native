...
export class ManagementGroupDiagnosticSetting extends pulumi.CustomResource {
     ...
     */
    public readonly logs!: pulumi.Output<outputs.insights.v20200101preview.ManagementGroupLogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, args: ManagementGroupDiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20200101preview:ManagementGroupDiagnosticSetting" }, { type: "azure-native:insights:ManagementGroupDiagnosticSetting" }, { type: "azure-nextgen:insights:ManagementGroupDiagnosticSetting" }, { type: "azure-native:insights/v20210501preview:ManagementGroupDiagnosticSetting" }, { type: "azure-nextgen:insights/v20210501preview:ManagementGroupDiagnosticSetting" }] };
