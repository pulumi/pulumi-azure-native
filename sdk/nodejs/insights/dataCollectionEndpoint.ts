...
export class DataCollectionEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataCollectionEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:DataCollectionEndpoint" }, { type: "azure-native:insights/v20210401:DataCollectionEndpoint" }, { type: "azure-nextgen:insights/v20210401:DataCollectionEndpoint" }] };
