...
export class DataCollectionRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataCollectionRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20191101preview:DataCollectionRule" }, { type: "azure-native:insights/v20210901preview:DataCollectionRule" }, { type: "azure-native:insights/v20220601:DataCollectionRule" }] };
