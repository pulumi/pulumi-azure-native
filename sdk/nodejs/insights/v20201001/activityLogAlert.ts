...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ActivityLogAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20170401:ActivityLogAlert" }, { type: "azure-native:insights/v20230101preview:ActivityLogAlert" }, { type: "azure-native:insights:ActivityLogAlert" }] };
