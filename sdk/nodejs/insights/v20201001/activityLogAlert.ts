...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ActivityLogAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20201001:ActivityLogAlert" }, { type: "azure-native:insights:ActivityLogAlert" }, { type: "azure-nextgen:insights:ActivityLogAlert" }, { type: "azure-native:insights/v20170401:ActivityLogAlert" }, { type: "azure-nextgen:insights/v20170401:ActivityLogAlert" }] };
...
export interface ActivityLogAlertArgs {
     ...
     * The actions that will activate when the condition is met.
     */
    readonly actions: pulumi.Input<inputs.insights.v20201001.ActionListArgs>;
    /**
     ...
     * The condition that will cause this alert to activate.
     */
    readonly condition: pulumi.Input<inputs.insights.v20201001.AlertRuleAllOfConditionArgs>;
    /**
     * A description of this Activity Log Alert rule.
     */
