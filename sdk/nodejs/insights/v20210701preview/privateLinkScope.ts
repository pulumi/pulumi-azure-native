 ...
 *
 * const privateLinkScope = new azure_native.insights.v20210701preview.PrivateLinkScope("privateLinkScope", {
 *     accessModeSettings: {
 *         exclusions: [],
...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20191017preview:PrivateLinkScope" }] };
