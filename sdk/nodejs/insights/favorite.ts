...
export class Favorite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FavoriteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:Favorite" }, { type: "azure-native:insights/latest:Favorite" }, { type: "azure-nextgen:insights/latest:Favorite" }, { type: "azure-native:insights/v20150501:Favorite" }, { type: "azure-nextgen:insights/v20150501:Favorite" }] };
