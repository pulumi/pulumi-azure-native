...
export class WorkbookTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:insights:WorkbookTemplate';
    ...
    constructor(name: string, args: WorkbookTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if ((!args || args.templateData === undefined) && !(opts && opts.urn)) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20191017preview:WorkbookTemplate" }] };
...
export interface WorkbookTemplateArgs {
     ...
     * Workbook galleries supported by the template.
     */
    readonly galleries: pulumi.Input<pulumi.Input<inputs.insights.WorkbookTemplateGallery>[]>;
    /**
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    readonly localized?: pulumi.Input<{[key: string]: pulumi.Input<pulumi.Input<inputs.insights.WorkbookTemplateLocalizedGallery>[]>}>;
    /**
     * Resource location
     */
