...
export class AutoscaleSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:insights:AutoscaleSetting';
    ...
    constructor(name: string, args: AutoscaleSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/latest:AutoscaleSetting" }, { type: "azure-nextgen:insights/v20150401:AutoscaleSetting" }] };
