...
export class AutoscaleSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AutoscaleSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:AutoscaleSetting" }, { type: "azure-native:insights/latest:AutoscaleSetting" }, { type: "azure-nextgen:insights/latest:AutoscaleSetting" }, { type: "azure-native:insights/v20150401:AutoscaleSetting" }, { type: "azure-nextgen:insights/v20150401:AutoscaleSetting" }] };
...
export interface AutoscaleSettingArgs {
     ...
     * the collection of notifications.
     */
    readonly notifications?: pulumi.Input<pulumi.Input<inputs.insights.AutoscaleNotification>[]>;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    readonly profiles: pulumi.Input<pulumi.Input<inputs.insights.AutoscaleProfile>[]>;
    /**
