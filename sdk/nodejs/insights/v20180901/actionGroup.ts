...
export class ActionGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.v20180901.ActionGroupResponse>;
    /**
     * Resource tags
     */
...
export interface ActionGroupArgs {
     ...
     * The action groups properties of the resource.
     */
    readonly properties?: pulumi.Input<inputs.insights.v20180901.ActionGroupDefinition>;
    /**
