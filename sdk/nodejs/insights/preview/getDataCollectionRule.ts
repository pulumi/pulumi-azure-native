...
export function getDataCollectionRule(args: GetDataCollectionRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetDataCollectionRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:insights/preview:getDataCollectionRule", {
...
export interface GetDataCollectionRuleResult {
     ...
     */
    readonly dataFlows: outputs.insights.preview.DataFlowResponse[];
    /**
     * The specification of data sources. 
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    readonly dataSources?: outputs.insights.preview.DataCollectionRuleResponseDataSources;
    /**
     ...
     */
    readonly destinations: outputs.insights.preview.DataCollectionRuleResponseDestinations;
    /**
