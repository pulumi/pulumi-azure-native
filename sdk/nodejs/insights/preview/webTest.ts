...
export class WebTest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:WebTest';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.insights.preview.WebTestPropertiesResponseConfiguration | undefined>;
    /**
     ...
     */
    public readonly locations!: pulumi.Output<outputs.insights.preview.WebTestGeolocationResponse[]>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, argsOrState?: WebTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:WebTest" }, { type: "azurerm:insights/v20150501:WebTest" }] };
...
export interface WebTestArgs {
     ...
     * An XML configuration specification for a WebTest.
     */
    readonly configuration?: pulumi.Input<inputs.insights.preview.WebTestPropertiesConfiguration>;
    /**
     * Purpose/user defined descriptive test for this WebTest.
     */
     ...
     * A list of where to physically run the tests from to give global coverage for accessibility of your application.
     */
    readonly locations: pulumi.Input<pulumi.Input<inputs.insights.preview.WebTestGeolocation>[]>;
    /**
