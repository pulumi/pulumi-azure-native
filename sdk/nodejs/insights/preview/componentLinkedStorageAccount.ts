...
export class ComponentLinkedStorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:ComponentLinkedStorageAccount';
    ...
    constructor(name: string, argsOrState?: ComponentLinkedStorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20200301preview:ComponentLinkedStorageAccount" }] };
