...
export class Favorite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:Favorite';
    ...
    constructor(name: string, args: FavoriteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:Favorite" }, { type: "azurerm:insights/v20150501:Favorite" }] };
