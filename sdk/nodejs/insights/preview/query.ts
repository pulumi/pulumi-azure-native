...
export class Query extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Query {
        return new Query(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:Query';
     ...
     */
    public readonly related!: pulumi.Output<outputs.insights.preview.LogAnalyticsQueryPackQueryPropertiesResponseRelated | undefined>;
    /**
     * Read only system data
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.insights.preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: QueryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20190901preview:Query" }] };
...
export interface QueryArgs {
     ...
     * The related metadata items for the function.
     */
    readonly related?: pulumi.Input<inputs.insights.preview.LogAnalyticsQueryPackQueryPropertiesRelated>;
    /**
