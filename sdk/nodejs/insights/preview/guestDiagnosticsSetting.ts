...
export class GuestDiagnosticsSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:guestDiagnosticsSetting';
     ...
     */
    public readonly dataSources!: pulumi.Output<outputs.insights.preview.DataSourceResponse[] | undefined>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, argsOrState?: GuestDiagnosticsSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20180601preview:guestDiagnosticsSetting" }] };
...
export interface GuestDiagnosticsSettingArgs {
     ...
     * the array of data source object which are configured to collect and send data
     */
    readonly dataSources?: pulumi.Input<pulumi.Input<inputs.insights.preview.DataSource>[]>;
    /**
