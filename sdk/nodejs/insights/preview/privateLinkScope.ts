...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateLinkScope {
        return new PrivateLinkScope(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:PrivateLinkScope';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.insights.preview.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20191017preview:PrivateLinkScope" }] };
