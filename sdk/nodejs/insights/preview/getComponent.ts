...
export function getComponent(args: GetComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:insights/preview:getComponent", {
...
export interface GetComponentResult {
     ...
     */
    readonly privateLinkScopedResources: outputs.insights.preview.PrivateLinkScopedResourceResponse[];
    /**
