...
export function getDiagnosticSetting(args: GetDiagnosticSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetDiagnosticSettingResult> {
    ...
    return pulumi.runtime.invoke("azurerm:insights/preview:getDiagnosticSetting", {
        "name": args.name,
...
export interface GetDiagnosticSettingResult {
     ...
     */
    readonly logs?: outputs.insights.preview.LogSettingsResponse[];
    /**
     * The list of metric settings.
     */
    readonly metrics?: outputs.insights.preview.MetricSettingsResponse[];
    /**
     * Azure resource name
     */
    readonly name: string;
