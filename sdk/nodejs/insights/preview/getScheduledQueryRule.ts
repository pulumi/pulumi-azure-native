...
export function getScheduledQueryRule(args: GetScheduledQueryRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledQueryRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:insights/preview:getScheduledQueryRule", {
...
export interface GetScheduledQueryRuleResult {
    readonly actions?: outputs.insights.preview.ActionResponse[];
    /**
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    readonly criteria?: outputs.insights.preview.ScheduledQueryRuleCriteriaResponse;
    /**
