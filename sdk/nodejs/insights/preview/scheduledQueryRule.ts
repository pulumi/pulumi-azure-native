...
export class ScheduledQueryRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:ScheduledQueryRule';
    ...
    public readonly actions!: pulumi.Output<outputs.insights.preview.ActionResponse[] | undefined>;
    /**
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    public readonly criteria!: pulumi.Output<outputs.insights.preview.ScheduledQueryRuleCriteriaResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ScheduledQueryRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:ScheduledQueryRule" }, { type: "azurerm:insights/v20180416:ScheduledQueryRule" }, { type: "azurerm:insights/v20200501preview:ScheduledQueryRule" }] };
...
export interface ScheduledQueryRuleArgs {
    readonly actions?: pulumi.Input<pulumi.Input<inputs.insights.preview.Action>[]>;
    /**
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    readonly criteria?: pulumi.Input<inputs.insights.preview.ScheduledQueryRuleCriteria>;
    /**
     * The description of the scheduled query rule.
     */
