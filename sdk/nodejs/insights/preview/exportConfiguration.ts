...
export class ExportConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:ExportConfiguration';
    ...
    constructor(name: string, args: ExportConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:ExportConfiguration" }, { type: "azurerm:insights/v20150501:ExportConfiguration" }] };
