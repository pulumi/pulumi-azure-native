...
export function getAutoscaleSetting(args: GetAutoscaleSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoscaleSettingResult> {
    ...
    return pulumi.runtime.invoke("azurerm:insights/preview:getAutoscaleSetting", {
...
export interface GetAutoscaleSettingResult {
     ...
     */
    readonly notifications?: outputs.insights.preview.AutoscaleNotificationResponse[];
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    readonly profiles: outputs.insights.preview.AutoscaleProfileResponse[];
    /**
     * Resource tags
     */
