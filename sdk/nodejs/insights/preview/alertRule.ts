...
export class AlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:AlertRule';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.insights.preview.RuleEmailActionResponse | outputs.insights.preview.RuleWebhookActionResponse[] | undefined>;
    /**
     * the condition that results in the alert rule being activated.
     */
    public readonly condition!: pulumi.Output<outputs.insights.preview.LocationThresholdRuleConditionResponse | outputs.insights.preview.ManagementEventRuleConditionResponse | outputs.insights.preview.ThresholdRuleConditionResponse>;
    /**
    ...
    constructor(name: string, args: AlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:AlertRule" }, { type: "azurerm:insights/v20160301:AlertRule" }] };
...
export interface AlertRuleArgs {
     ...
     * the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputs.insights.preview.RuleEmailAction | inputs.insights.preview.RuleWebhookAction>[]>;
    /**
     * the condition that results in the alert rule being activated.
     */
    readonly condition: pulumi.Input<inputs.insights.preview.LocationThresholdRuleCondition | inputs.insights.preview.ManagementEventRuleCondition | inputs.insights.preview.ThresholdRuleCondition>;
    /**
     * the description of the alert rule that will be included in the alert email.
     */
