...
export class DiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:DiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<outputs.insights.preview.LogSettingsResponse[] | undefined>;
    /**
     * The list of metric settings.
     */
    public readonly metrics!: pulumi.Output<outputs.insights.preview.MetricSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, argsOrState?: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20170501preview:DiagnosticSetting" }] };
...
export interface DiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    readonly logs?: pulumi.Input<pulumi.Input<inputs.insights.preview.LogSettings>[]>;
    /**
     * The list of metric settings.
     */
    readonly metrics?: pulumi.Input<pulumi.Input<inputs.insights.preview.MetricSettings>[]>;
    /**
