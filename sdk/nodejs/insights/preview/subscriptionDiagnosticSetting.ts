...
export class SubscriptionDiagnosticSetting extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubscriptionDiagnosticSetting {
        return new SubscriptionDiagnosticSetting(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:SubscriptionDiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<outputs.insights.preview.SubscriptionLogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, argsOrState?: SubscriptionDiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SubscriptionDiagnosticSettingArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20170501preview:SubscriptionDiagnosticSetting" }] };
...
export interface SubscriptionDiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    readonly logs?: pulumi.Input<pulumi.Input<inputs.insights.preview.SubscriptionLogSettings>[]>;
    /**
