...
export class MetricAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:MetricAlert';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.insights.preview.MetricAlertActionResponse[] | undefined>;
    /**
     ...
     */
    public readonly criteria!: pulumi.Output<outputs.insights.preview.MetricAlertMultipleResourceMultipleMetricCriteriaResponse | outputs.insights.preview.MetricAlertSingleResourceMultipleMetricCriteriaResponse | outputs.insights.preview.WebtestLocationAvailabilityCriteriaResponse>;
    /**
    ...
    constructor(name: string, args: MetricAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:MetricAlert" }, { type: "azurerm:insights/v20180301:MetricAlert" }] };
...
export interface MetricAlertArgs {
     ...
     * the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputs.insights.preview.MetricAlertAction>[]>;
    /**
     * the flag that indicates whether the alert should be auto resolved or not. The default is true.
     */
     ...
     * defines the specific alert criteria information.
     */
    readonly criteria: pulumi.Input<inputs.insights.preview.MetricAlertMultipleResourceMultipleMetricCriteria | inputs.insights.preview.MetricAlertSingleResourceMultipleMetricCriteria | inputs.insights.preview.WebtestLocationAvailabilityCriteria>;
    /**
     * the description of the metric alert that will be included in the alert email.
     */
