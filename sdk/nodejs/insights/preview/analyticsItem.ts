...
export class AnalyticsItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:AnalyticsItem';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.preview.ApplicationInsightsComponentAnalyticsItemPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AnalyticsItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:AnalyticsItem" }, { type: "azurerm:insights/v20150501:AnalyticsItem" }] };
...
export interface AnalyticsItemArgs {
     ...
     * A set of properties that can be defined in the context of a specific item type. Each type may have its own properties.
     */
    readonly properties?: pulumi.Input<inputs.insights.preview.ApplicationInsightsComponentAnalyticsItemProperties>;
    /**
