...
export class PrivateLinkScopedResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateLinkScopedResource {
        return new PrivateLinkScopedResource(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:PrivateLinkScopedResource';
    ...
    constructor(name: string, argsOrState?: PrivateLinkScopedResourceArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PrivateLinkScopedResourceArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20191017preview:PrivateLinkScopedResource" }] };
