...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.insights.preview.PrivateEndpointPropertyResponse | undefined>;
    /**
     * Connection state of the private endpoint connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.insights.preview.PrivateLinkServiceConnectionStatePropertyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20191017preview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.insights.preview.PrivateEndpointProperty>;
    /**
     ...
     * Connection state of the private endpoint connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.insights.preview.PrivateLinkServiceConnectionStateProperty>;
    /**
