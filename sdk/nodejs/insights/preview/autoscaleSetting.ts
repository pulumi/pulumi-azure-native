...
export class AutoscaleSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:AutoscaleSetting';
     ...
     */
    public readonly notifications!: pulumi.Output<outputs.insights.preview.AutoscaleNotificationResponse[] | undefined>;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    public readonly profiles!: pulumi.Output<outputs.insights.preview.AutoscaleProfileResponse[]>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: AutoscaleSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:AutoscaleSetting" }, { type: "azurerm:insights/v20150401:AutoscaleSetting" }] };
...
export interface AutoscaleSettingArgs {
     ...
     * the collection of notifications.
     */
    readonly notifications?: pulumi.Input<pulumi.Input<inputs.insights.preview.AutoscaleNotification>[]>;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    readonly profiles: pulumi.Input<pulumi.Input<inputs.insights.preview.AutoscaleProfile>[]>;
    /**
