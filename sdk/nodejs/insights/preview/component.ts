...
export class Component extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:Component';
     ...
     */
    public /*out*/ readonly privateLinkScopedResources!: pulumi.Output<outputs.insights.preview.PrivateLinkScopedResourceResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:Component" }, { type: "azurerm:insights/v20150501:Component" }, { type: "azurerm:insights/v20180501preview:Component" }, { type: "azurerm:insights/v20200202preview:Component" }] };
