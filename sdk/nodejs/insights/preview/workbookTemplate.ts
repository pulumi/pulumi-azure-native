...
export class WorkbookTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:WorkbookTemplate';
     ...
     */
    public readonly galleries!: pulumi.Output<outputs.insights.preview.WorkbookTemplateGalleryResponse[]>;
    /**
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    public readonly localized!: pulumi.Output<{[key: string]: outputs.insights.preview.WorkbookTemplateLocalizedGalleryResponse[]} | undefined>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, argsOrState?: WorkbookTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20191017preview:WorkbookTemplate" }] };
...
export interface WorkbookTemplateArgs {
     ...
     * Workbook galleries supported by the template.
     */
    readonly galleries: pulumi.Input<pulumi.Input<inputs.insights.preview.WorkbookTemplateGallery>[]>;
    /**
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    readonly localized?: pulumi.Input<{[key: string]: pulumi.Input<pulumi.Input<inputs.insights.preview.WorkbookTemplateLocalizedGallery>[]>}>;
    /**
     * Resource location
     */
