...
export function getWebTest(args: GetWebTestArgs, opts?: pulumi.InvokeOptions): Promise<GetWebTestResult> {
    ...
    return pulumi.runtime.invoke("azurerm:insights/preview:getWebTest", {
...
export interface GetWebTestResult {
     ...
     */
    readonly configuration?: outputs.insights.preview.WebTestPropertiesResponseConfiguration;
    /**
     ...
     */
    readonly locations: outputs.insights.preview.WebTestGeolocationResponse[];
    /**
     * Azure resource name
     */
