...
export class DataCollectionRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataCollectionRule {
        return new DataCollectionRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:DataCollectionRule';
     ...
     */
    public readonly dataFlows!: pulumi.Output<outputs.insights.preview.DataFlowResponse[]>;
    /**
     * The specification of data sources. 
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    public readonly dataSources!: pulumi.Output<outputs.insights.preview.DataCollectionRuleResponseDataSources | undefined>;
    /**
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.insights.preview.DataCollectionRuleResponseDestinations>;
    /**
    ...
    constructor(name: string, argsOrState?: DataCollectionRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20191101preview:DataCollectionRule" }] };
...
export interface DataCollectionRuleArgs {
     ...
     * The specification of data flows.
     */
    readonly dataFlows: pulumi.Input<pulumi.Input<inputs.insights.preview.DataFlow>[]>;
    /**
     * The specification of data sources. 
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    readonly dataSources?: pulumi.Input<inputs.insights.preview.DataCollectionRuleDataSources>;
    /**
     * Description of the data collection rule.
     */
     ...
     * The specification of destinations.
     */
    readonly destinations: pulumi.Input<inputs.insights.preview.DataCollectionRuleDestinations>;
    /**
     * The geo-location where the resource lives.
     */
