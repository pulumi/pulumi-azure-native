...
export class GuestDiagnosticsSettingsAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/preview:GuestDiagnosticsSettingsAssociation';
    ...
    constructor(name: string, argsOrState?: GuestDiagnosticsSettingsAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/v20180601preview:GuestDiagnosticsSettingsAssociation" }] };
