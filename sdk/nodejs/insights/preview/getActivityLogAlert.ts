...
export function getActivityLogAlert(args: GetActivityLogAlertArgs, opts?: pulumi.InvokeOptions): Promise<GetActivityLogAlertResult> {
    ...
    return pulumi.runtime.invoke("azurerm:insights/preview:getActivityLogAlert", {
...
export interface GetActivityLogAlertResult {
     ...
     */
    readonly actions: outputs.insights.preview.ActivityLogAlertActionListResponse;
    /**
     * The condition that will cause this alert to activate.
     */
    readonly condition: outputs.insights.preview.ActivityLogAlertAllOfConditionResponse;
    /**
