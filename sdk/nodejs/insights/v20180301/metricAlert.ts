...
export class MetricAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/v20180301:MetricAlert';
    ...
    constructor(name: string, argsOrState?: MetricAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:MetricAlert" }, { type: "azurerm:insights/preview:MetricAlert" }] };
