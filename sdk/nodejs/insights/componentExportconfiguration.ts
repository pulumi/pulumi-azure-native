...
export class ComponentExportconfiguration extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ComponentExportconfiguration {
        return new ComponentExportconfiguration(name, undefined, { ...opts, id: id });
    }
