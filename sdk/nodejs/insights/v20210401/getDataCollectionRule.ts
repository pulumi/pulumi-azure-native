...
export function getDataCollectionRule(args: GetDataCollectionRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetDataCollectionRuleResult> {
    pulumi.log.warn("getDataCollectionRule is deprecated: azure-native:insights/v20210401:DataCollectionRule is being removed in the next major version of this provider. Please upgrade to azure-native:insights/v20220601:DataCollectionRule to guarantee forwards compatibility.")
