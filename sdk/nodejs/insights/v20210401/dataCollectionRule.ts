...
export class DataCollectionRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20210401:DataCollectionRule';
     ...
     */
    public readonly dataFlows!: pulumi.Output<outputs.insights.v20210401.DataFlowResponse[] | undefined>;
    /**
     * The specification of data sources. 
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    public readonly dataSources!: pulumi.Output<outputs.insights.v20210401.DataCollectionRuleResponseDataSources | undefined>;
    /**
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.insights.v20210401.DataCollectionRuleResponseDestinations | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.insights.v20210401.DataCollectionRuleResourceResponseSystemData>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: DataCollectionRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20210401:DataCollectionRule" }, { type: "azure-native:insights:DataCollectionRule" }, { type: "azure-nextgen:insights:DataCollectionRule" }, { type: "azure-native:insights/v20191101preview:DataCollectionRule" }, { type: "azure-nextgen:insights/v20191101preview:DataCollectionRule" }] };
...
export interface DataCollectionRuleArgs {
     ...
     * The specification of data flows.
     */
    readonly dataFlows?: pulumi.Input<pulumi.Input<inputs.insights.v20210401.DataFlowArgs>[]>;
    /**
     * The specification of data sources. 
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    readonly dataSources?: pulumi.Input<inputs.insights.v20210401.DataCollectionRuleDataSourcesArgs>;
    /**
     * Description of the data collection rule.
     */
     ...
     * The specification of destinations.
     */
    readonly destinations?: pulumi.Input<inputs.insights.v20210401.DataCollectionRuleDestinationsArgs>;
    /**
     * The kind of the resource.
     */
    readonly kind?: pulumi.Input<string | enums.insights.v20210401.KnownDataCollectionRuleResourceKind>;
    /**
     * The geo-location where the resource lives.
     */
