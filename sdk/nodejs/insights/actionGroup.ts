...
export class ActionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights:ActionGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.ActionGroupResponse>;
    /**
     * Resource tags
     */
...
export interface ActionGroupArgs {
     ...
     * The action groups properties of the resource.
     */
    readonly properties?: pulumi.Input<inputs.insights.ActionGroupDefinition>;
    /**
