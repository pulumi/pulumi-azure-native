...
export class DiagnosticSetting extends pulumi.CustomResource {
     ...
     */
    public readonly logs!: pulumi.Output<outputs.insights.v20170501preview.LogSettingsResponse[] | undefined>;
    /**
     * The list of metric settings.
     */
    public readonly metrics!: pulumi.Output<outputs.insights.v20170501preview.MetricSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, args: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20170501preview:DiagnosticSetting" }, { type: "azure-native:insights:DiagnosticSetting" }, { type: "azure-nextgen:insights:DiagnosticSetting" }, { type: "azure-native:insights/v20210501preview:DiagnosticSetting" }, { type: "azure-nextgen:insights/v20210501preview:DiagnosticSetting" }] };
...
export interface DiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<inputs.insights.v20170501preview.LogSettingsArgs>[]>;
    /**
     * The list of metric settings.
     */
    metrics?: pulumi.Input<pulumi.Input<inputs.insights.v20170501preview.MetricSettingsArgs>[]>;
    /**
