...
export class DiagnosticSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/preview:DiagnosticSetting" }] };
...
export interface DiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    readonly logs?: pulumi.Input<pulumi.Input<inputs.insights.v20170501preview.LogSettings>[]>;
    /**
     * The list of metric settings.
     */
    readonly metrics?: pulumi.Input<pulumi.Input<inputs.insights.v20170501preview.MetricSettings>[]>;
    /**
