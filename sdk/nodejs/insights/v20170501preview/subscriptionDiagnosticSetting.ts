...
export class SubscriptionDiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/v20170501preview:SubscriptionDiagnosticSetting';
    ...
    constructor(name: string, args: SubscriptionDiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:SubscriptionDiagnosticSetting" }] };
