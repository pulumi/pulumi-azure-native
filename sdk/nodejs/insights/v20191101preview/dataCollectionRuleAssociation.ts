...
export class DataCollectionRuleAssociation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataCollectionRuleAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20191101preview:DataCollectionRuleAssociation" }, { type: "azure-native:insights:DataCollectionRuleAssociation" }, { type: "azure-nextgen:insights:DataCollectionRuleAssociation" }, { type: "azure-native:insights/v20210401:DataCollectionRuleAssociation" }, { type: "azure-nextgen:insights/v20210401:DataCollectionRuleAssociation" }] };
