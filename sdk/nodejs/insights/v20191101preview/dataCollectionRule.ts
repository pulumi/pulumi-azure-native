...
export class DataCollectionRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataCollectionRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20191101preview:DataCollectionRule" }, { type: "azure-native:insights:DataCollectionRule" }, { type: "azure-nextgen:insights:DataCollectionRule" }] };
