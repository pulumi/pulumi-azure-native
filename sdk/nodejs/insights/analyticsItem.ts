...
export class AnalyticsItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AnalyticsItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:AnalyticsItem" }, { type: "azure-native:insights/v20150501:AnalyticsItem" }, { type: "azure-nextgen:insights/v20150501:AnalyticsItem" }] };
...
export interface AnalyticsItemArgs {
     ...
     * A set of properties that can be defined in the context of a specific item type. Each type may have its own properties.
     */
    properties?: pulumi.Input<inputs.insights.ApplicationInsightsComponentAnalyticsItemPropertiesArgs>;
    /**
     ...
     * Enum indicating if this item definition is owned by a specific user or is shared between all users with access to the Application Insights component.
     */
    scope?: pulumi.Input<string | enums.insights.ItemScope>;
    /**
     * Enum indicating if this item definition is owned by a specific user or is shared between all users with access to the Application Insights component.
     */
     ...
     * Enum indicating the type of the Analytics item.
     */
    type?: pulumi.Input<string | enums.insights.ItemType>;
}
