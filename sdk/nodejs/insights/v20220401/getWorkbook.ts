...
export interface GetWorkbookResult {
     ...
     */
    readonly identity?: outputs.insights.v20220401.WorkbookResourceResponseIdentity;
    /**
     ...
     */
    readonly systemData: outputs.insights.v20220401.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getWorkbookOutput(args: GetWorkbookOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkbookResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:insights/v20220401:getWorkbook", {
        "canFetchContent": args.canFetchContent,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
