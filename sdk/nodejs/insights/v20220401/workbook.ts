 ...
 *
 * const workbook = new azure_native.insights.v20220401.Workbook("workbook", {
 *     category: "workbook",
...
export class Workbook extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.insights.v20220401.WorkbookResourceResponseIdentity | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.insights.v20220401.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: WorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:Workbook" }, { type: "azure-native:insights/v20150501:Workbook" }, { type: "azure-native:insights/v20180617preview:Workbook" }, { type: "azure-native:insights/v20201020:Workbook" }, { type: "azure-native:insights/v20210308:Workbook" }, { type: "azure-native:insights/v20210801:Workbook" }] };
...
export interface WorkbookArgs {
     ...
     * Identity used for BYOS
     */
    identity?: pulumi.Input<inputs.insights.v20220401.WorkbookResourceIdentityArgs>;
    /**
     * The kind of workbook. Only valid value is shared.
     */
    kind?: pulumi.Input<string | enums.insights.v20220401.WorkbookSharedTypeKind>;
    /**
     * The geo-location where the resource lives
     */
