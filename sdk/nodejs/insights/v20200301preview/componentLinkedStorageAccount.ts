...
export class ComponentLinkedStorageAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ComponentLinkedStorageAccount {
        return new ComponentLinkedStorageAccount(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: ComponentLinkedStorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ComponentLinkedStorageAccountArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/preview:ComponentLinkedStorageAccount" }] };
