...
export function getScheduledQueryRule(args: GetScheduledQueryRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledQueryRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:insights/v20250101preview:getScheduledQueryRule", {
...
export interface GetScheduledQueryRuleResult {
     ...
     */
    readonly actions?: outputs.insights.v20250101preview.ActionsResponse;
    /**
     ...
     */
    readonly criteria: outputs.insights.v20250101preview.ScheduledQueryRuleCriteriaResponse;
    /**
     ...
     */
    readonly identity?: outputs.insights.v20250101preview.IdentityResponse;
    /**
     ...
     */
    readonly resolveConfiguration?: outputs.insights.v20250101preview.RuleResolveConfigurationResponse;
    /**
     ...
     */
    readonly systemData: outputs.insights.v20250101preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getScheduledQueryRuleOutput(args: GetScheduledQueryRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledQueryRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:insights/v20250101preview:getScheduledQueryRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleName": args.ruleName,
    }, opts);
}
