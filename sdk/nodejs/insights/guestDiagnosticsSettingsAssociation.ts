...
export class GuestDiagnosticsSettingsAssociation extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.GuestDiagnosticSettingsAssociationResponse>;
    /**
     * Resource tags
     */
...
export interface GuestDiagnosticsSettingsAssociationArgs {
     ...
     * The diagnostics settings associations of the resource.
     */
    properties: pulumi.Input<inputs.insights.GuestDiagnosticSettingsAssociationArgs>;
    /**
