...
export class GuestDiagnosticsSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GuestDiagnosticsSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20180601preview:guestDiagnosticsSetting" }, { type: "azure-native:insights:guestDiagnosticsSetting" }, { type: "azure-nextgen:insights:guestDiagnosticsSetting" }] };
...
export interface GuestDiagnosticsSettingArgs {
     ...
     * the array of data source object which are configured to collect and send data
     */
    readonly dataSources?: pulumi.Input<pulumi.Input<inputs.insights.v20180601preview.DataSource>[]>;
    /**
