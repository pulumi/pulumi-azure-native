...
export class GuestDiagnosticsSetting extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.insights.v20180601preview.GuestDiagnosticSettingsResponse>;
    /**
     * Resource tags
     */
...
export interface GuestDiagnosticsSettingArgs {
     ...
     * The diagnostic settings to be applied to azure resources.
     */
    properties: pulumi.Input<inputs.insights.v20180601preview.GuestDiagnosticSettingsArgs>;
    /**
