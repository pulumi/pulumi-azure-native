...
export class GuestDiagnosticsSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:insights/v20180601preview:guestDiagnosticsSetting';
    ...
    constructor(name: string, args: GuestDiagnosticsSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:guestDiagnosticsSetting" }] };
