...
export class ScheduledQueryRule extends pulumi.CustomResource {
     ...
     */
    public readonly actions!: pulumi.Output<outputs.insights.v20231201.ActionsResponse | undefined>;
    /**
     ...
     */
    public readonly criteria!: pulumi.Output<outputs.insights.v20231201.ScheduledQueryRuleCriteriaResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.insights.v20231201.IdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.insights.v20231201.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ScheduledQueryRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20180416:ScheduledQueryRule" }, { type: "azure-native:insights/v20200501preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20210201preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20210801:ScheduledQueryRule" }, { type: "azure-native:insights/v20220615:ScheduledQueryRule" }, { type: "azure-native:insights/v20220801preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20230315preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20240101preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20250101preview:ScheduledQueryRule" }, { type: "azure-native:insights:ScheduledQueryRule" }] };
...
export interface ScheduledQueryRuleArgs {
     ...
     * Actions to invoke when the alert fires.
     */
    actions?: pulumi.Input<inputs.insights.v20231201.ActionsArgs>;
    /**
     * The flag that indicates whether the alert should be automatically resolved or not. The default is true. Relevant only for rules of the kind LogAlert.
     */
     ...
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    criteria: pulumi.Input<inputs.insights.v20231201.ScheduledQueryRuleCriteriaArgs>;
    /**
     * The description of the scheduled query rule.
     */
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.insights.v20231201.IdentityArgs>;
    /**
     * Indicates the type of scheduled query rule. The default is LogAlert.
     */
    kind?: pulumi.Input<string | enums.insights.v20231201.Kind>;
    /**
     * The geo-location where the resource lives
     */
