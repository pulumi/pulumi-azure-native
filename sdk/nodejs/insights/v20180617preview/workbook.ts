...
export class Workbook extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/latest:Workbook" }, { type: "azure-nextgen:insights/v20150501:Workbook" }, { type: "azure-nextgen:insights/v20201020:Workbook" }] };
