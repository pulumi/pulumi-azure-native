 ...
 *
 * const workbook = new azurerm.insights.v20180617preview.Workbook("workbook", {
 *     category: "workbook",
...
export class Workbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:insights/v20180617preview:Workbook';
    ...
    constructor(name: string, args: WorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:insights/latest:Workbook" }, { type: "azurerm:insights/v20150501:Workbook" }] };
