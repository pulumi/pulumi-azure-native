...
export class SaasSubscriptionLevel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:saas:SaasSubscriptionLevel';
    ...
    constructor(name: string, args: SaasSubscriptionLevelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:saas/v20180301beta:SaasSubscriptionLevel" }] };
