...
export class SchemaRegistry extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SchemaRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry/v20240901preview:SchemaRegistry" }, { type: "azure-native:deviceregistry/v20250701preview:SchemaRegistry" }, { type: "azure-native:deviceregistry/v20251001:SchemaRegistry" }] };
