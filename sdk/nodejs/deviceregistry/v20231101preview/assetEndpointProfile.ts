...
export class AssetEndpointProfile extends pulumi.CustomResource {
     ...
     */
    public readonly transportAuthentication!: pulumi.Output<outputs.deviceregistry.v20231101preview.TransportAuthenticationResponse | undefined>;
    /**
     ...
     */
    public readonly userAuthentication!: pulumi.Output<outputs.deviceregistry.v20231101preview.UserAuthenticationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AssetEndpointProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["userAuthentication"] = args ? (args.userAuthentication ? pulumi.output(args.userAuthentication).apply(inputs.deviceregistry.v20231101preview.userAuthenticationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry:AssetEndpointProfile" }, { type: "azure-native:deviceregistry/v20240901preview:AssetEndpointProfile" }, { type: "azure-native:deviceregistry/v20241101:AssetEndpointProfile" }] };
...
export interface AssetEndpointProfileArgs {
     ...
     * Defines the authentication mechanism for the southbound connector connecting to the shop floor/OT device.
     */
    transportAuthentication?: pulumi.Input<inputs.deviceregistry.v20231101preview.TransportAuthenticationArgs>;
    /**
     * Defines the client authentication mechanism to the server.
     */
    userAuthentication?: pulumi.Input<inputs.deviceregistry.v20231101preview.UserAuthenticationArgs>;
}
