...
export class AssetEndpointProfile extends pulumi.CustomResource {
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.deviceregistry.v20231101preview.AssetEndpointProfileResponseExtendedLocation>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deviceregistry.v20231101preview.AssetEndpointProfilePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AssetEndpointProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.deviceregistry.v20231101preview.assetEndpointProfilePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface AssetEndpointProfileArgs {
     ...
     * The extended location.
     */
    extendedLocation: pulumi.Input<inputs.deviceregistry.v20231101preview.AssetEndpointProfileExtendedLocationArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Asset Endpoint Profile resource properties.
     */
    properties?: pulumi.Input<inputs.deviceregistry.v20231101preview.AssetEndpointProfilePropertiesArgs>;
    /**
