...
export class Asset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deviceregistry/v20241101:Asset';
     ...
     */
    public readonly datasets!: pulumi.Output<outputs.deviceregistry.v20241101.DatasetResponse[] | undefined>;
    /**
     ...
     */
    public readonly defaultTopic!: pulumi.Output<outputs.deviceregistry.v20241101.TopicResponse | undefined>;
    /**
     ...
     */
    public readonly events!: pulumi.Output<outputs.deviceregistry.v20241101.EventResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.deviceregistry.v20241101.AssetStatusResponse>;
    /**
    ...
    constructor(name: string, args: AssetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["defaultTopic"] = args ? (args.defaultTopic ? pulumi.output(args.defaultTopic).apply(inputs.deviceregistry.v20241101.topicArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry/v20231101preview:Asset" }, { type: "azure-native:deviceregistry/v20240901preview:Asset" }, { type: "azure-native:deviceregistry:Asset" }] };
