...
export class AssetEndpointProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deviceregistry/v20241101:AssetEndpointProfile';
     ...
     */
    public readonly authentication!: pulumi.Output<outputs.deviceregistry.v20241101.AuthenticationResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.deviceregistry.v20241101.ExtendedLocationResponse>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.deviceregistry.v20241101.AssetEndpointProfileStatusResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.deviceregistry.v20241101.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: AssetEndpointProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["authentication"] = args ? (args.authentication ? pulumi.output(args.authentication).apply(inputs.deviceregistry.v20241101.authenticationArgsProvideDefaults) : undefined) : undefined;
...
export interface AssetEndpointProfileArgs {
     ...
     * Defines the client authentication mechanism to the server.
     */
    authentication?: pulumi.Input<inputs.deviceregistry.v20241101.AuthenticationArgs>;
    /**
     * Reference to a discovered asset endpoint profile. Populated only if the asset endpoint profile has been created from discovery flow. Discovered asset endpoint profile name must be provided.
     */
     ...
     * The extended location.
     */
    extendedLocation: pulumi.Input<inputs.deviceregistry.v20241101.ExtendedLocationArgs>;
    /**
     * The geo-location where the resource lives
     */
