...
export class SchemaVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SchemaVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry/v20240901preview:SchemaVersion" }, { type: "azure-native:deviceregistry/v20250701preview:SchemaVersion" }, { type: "azure-native:deviceregistry/v20251001:SchemaVersion" }] };
