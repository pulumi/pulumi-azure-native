...
export class Asset extends pulumi.CustomResource {
     ...
     */
    declare public readonly datasets: pulumi.Output<outputs.deviceregistry.DatasetResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly events: pulumi.Output<outputs.deviceregistry.EventResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.deviceregistry.AssetStatusResponse>;
    /**
    ...
    constructor(name: string, args: AssetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry/v20231101preview:Asset" }, { type: "azure-native:deviceregistry/v20240901preview:Asset" }, { type: "azure-native:deviceregistry/v20241101:Asset" }, { type: "azure-native:deviceregistry/v20250701preview:Asset" }, { type: "azure-native:deviceregistry/v20251001:Asset" }] };
