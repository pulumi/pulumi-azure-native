...
export class Asset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deviceregistry/v20240901preview:Asset';
     ...
     */
    public readonly datasets!: pulumi.Output<outputs.deviceregistry.v20240901preview.DatasetResponse[] | undefined>;
    /**
     ...
     */
    public readonly defaultTopic!: pulumi.Output<outputs.deviceregistry.v20240901preview.TopicResponse | undefined>;
    /**
     ...
     */
    public readonly events!: pulumi.Output<outputs.deviceregistry.v20240901preview.EventResponse[] | undefined>;
    /**
     * The extended location.
     */
    public readonly extendedLocation!: pulumi.Output<outputs.deviceregistry.v20240901preview.ExtendedLocationResponse>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.deviceregistry.v20240901preview.AssetStatusResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.deviceregistry.v20240901preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: AssetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["defaultTopic"] = args ? (args.defaultTopic ? pulumi.output(args.defaultTopic).apply(inputs.deviceregistry.v20240901preview.topicArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry:Asset" }, { type: "azure-native:deviceregistry/v20231101preview:Asset" }, { type: "azure-native:deviceregistry/v20241101:Asset" }] };
...
export interface AssetArgs {
     ...
     * Array of datasets that are part of the asset. Each dataset describes the data points that make up the set.
     */
    datasets?: pulumi.Input<pulumi.Input<inputs.deviceregistry.v20240901preview.DatasetArgs>[]>;
    /**
     * Stringified JSON that contains connector-specific default configuration for all datasets. Each dataset can have its own configuration that overrides the default settings here.
     */
     ...
     * Object that describes the default topic information for the asset.
     */
    defaultTopic?: pulumi.Input<inputs.deviceregistry.v20240901preview.TopicArgs>;
    /**
     * Human-readable description of the asset.
     */
     ...
     * Array of events that are part of the asset. Each event can have per-event configuration.
     */
    events?: pulumi.Input<pulumi.Input<inputs.deviceregistry.v20240901preview.EventArgs>[]>;
    /**
     * The extended location.
     */
    extendedLocation: pulumi.Input<inputs.deviceregistry.v20240901preview.ExtendedLocationArgs>;
    /**
     * Asset id provided by the customer.
     */
