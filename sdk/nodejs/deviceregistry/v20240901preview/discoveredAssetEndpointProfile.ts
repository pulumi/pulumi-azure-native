...
export class DiscoveredAssetEndpointProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deviceregistry/v20240901preview:DiscoveredAssetEndpointProfile';
...
export interface DiscoveredAssetEndpointProfileArgs {
     ...
     * List of supported authentication methods supported by the target server.
     */
    supportedAuthenticationMethods?: pulumi.Input<pulumi.Input<string | enums.deviceregistry.v20240901preview.AuthenticationMethod>[]>;
    /**
     * Resource tags.
     */
