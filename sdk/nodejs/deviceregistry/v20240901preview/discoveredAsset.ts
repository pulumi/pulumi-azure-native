...
export class DiscoveredAsset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deviceregistry/v20240901preview:DiscoveredAsset';
     ...
     */
    public readonly datasets!: pulumi.Output<outputs.deviceregistry.v20240901preview.DiscoveredDatasetResponse[] | undefined>;
    /**
     ...
     */
    public readonly events!: pulumi.Output<outputs.deviceregistry.v20240901preview.DiscoveredEventResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: DiscoveredAssetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry:DiscoveredAsset" }] };
