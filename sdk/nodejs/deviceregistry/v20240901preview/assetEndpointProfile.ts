...
export class AssetEndpointProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deviceregistry/v20240901preview:AssetEndpointProfile';
     ...
     */
    public readonly authentication!: pulumi.Output<outputs.deviceregistry.v20240901preview.AuthenticationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.deviceregistry.v20240901preview.AssetEndpointProfileStatusResponse>;
    /**
    ...
    constructor(name: string, args: AssetEndpointProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["authentication"] = args ? (args.authentication ? pulumi.output(args.authentication).apply(inputs.deviceregistry.v20240901preview.authenticationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry:AssetEndpointProfile" }, { type: "azure-native:deviceregistry/v20231101preview:AssetEndpointProfile" }, { type: "azure-native:deviceregistry/v20241101:AssetEndpointProfile" }] };
