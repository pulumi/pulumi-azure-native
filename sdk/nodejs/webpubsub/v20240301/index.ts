...
// Export enums:
export * from "../../types/enums/webpubsub/v20240301";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:webpubsub/v20240301:WebPubSub":
                return new WebPubSub(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240301:WebPubSubCustomCertificate":
                return new WebPubSubCustomCertificate(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240301:WebPubSubCustomDomain":
                return new WebPubSubCustomDomain(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240301:WebPubSubHub":
                return new WebPubSubHub(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240301:WebPubSubPrivateEndpointConnection":
                return new WebPubSubPrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240301:WebPubSubReplica":
                return new WebPubSubReplica(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240301:WebPubSubSharedPrivateLinkResource":
...
pulumi.runtime.registerResourceModule("azure-native", "webpubsub/v20240301", _module)
