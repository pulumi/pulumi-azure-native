...
export class WebPubSub extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebPubSubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:webpubsub:WebPubSub" }, { type: "azure-native:webpubsub/v20210401preview:WebPubSub" }, { type: "azure-nextgen:webpubsub/v20210401preview:WebPubSub" }, { type: "azure-native:webpubsub/v20210601preview:WebPubSub" }, { type: "azure-nextgen:webpubsub/v20210601preview:WebPubSub" }] };
