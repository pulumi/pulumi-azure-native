...
export class WebPubSubHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20241001preview:WebPubSubHub';
     ...
     * Properties of a hub.
     */
    public readonly properties!: pulumi.Output<outputs.webpubsub.v20241001preview.WebPubSubHubPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: WebPubSubHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.webpubsub.v20241001preview.webPubSubHubPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:webpubsub/v20211001:WebPubSubHub" }, { type: "azure-native:webpubsub/v20220801preview:WebPubSubHub" }, { type: "azure-native:webpubsub/v20230201:WebPubSubHub" }, { type: "azure-native:webpubsub/v20230301preview:WebPubSubHub" }, { type: "azure-native:webpubsub/v20230601preview:WebPubSubHub" }, { type: "azure-native:webpubsub/v20230801preview:WebPubSubHub" }, { type: "azure-native:webpubsub/v20240101preview:WebPubSubHub" }, { type: "azure-native:webpubsub/v20240301:WebPubSubHub" }, { type: "azure-native:webpubsub/v20240401preview:WebPubSubHub" }, { type: "azure-native:webpubsub/v20240801preview:WebPubSubHub" }, { type: "azure-native:webpubsub:WebPubSubHub" }] };
...
export interface WebPubSubHubArgs {
     ...
     * Properties of a hub.
     */
    properties: pulumi.Input<inputs.webpubsub.v20241001preview.WebPubSubHubPropertiesArgs>;
    /**
