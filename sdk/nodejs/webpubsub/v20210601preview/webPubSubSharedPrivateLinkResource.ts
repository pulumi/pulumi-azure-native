...
export class WebPubSubSharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20210601preview:WebPubSubSharedPrivateLinkResource';
    ...
    constructor(name: string, args: WebPubSubSharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:webpubsub/v20210601preview:WebPubSubSharedPrivateLinkResource" }, { type: "azure-native:webpubsub:WebPubSubSharedPrivateLinkResource" }, { type: "azure-nextgen:webpubsub:WebPubSubSharedPrivateLinkResource" }, { type: "azure-native:webpubsub/v20210401preview:WebPubSubSharedPrivateLinkResource" }, { type: "azure-nextgen:webpubsub/v20210401preview:WebPubSubSharedPrivateLinkResource" }] };
