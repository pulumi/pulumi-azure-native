...
export class WebPubSubPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20210601preview:WebPubSubPrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.webpubsub.v20210601preview.PrivateEndpointResponse | undefined>;
    /**
     * Connection state
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.webpubsub.v20210601preview.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
