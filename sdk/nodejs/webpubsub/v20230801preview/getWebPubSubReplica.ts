...
export interface GetWebPubSubReplicaResult {
     ...
     */
    readonly sku?: outputs.webpubsub.v20230801preview.ResourceSkuResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.webpubsub.v20230801preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getWebPubSubReplicaOutput(args: GetWebPubSubReplicaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebPubSubReplicaResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:webpubsub/v20230801preview:getWebPubSubReplica", {
        "replicaName": args.replicaName,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
