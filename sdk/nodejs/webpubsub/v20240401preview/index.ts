...
// Export enums:
export * from "../../types/enums/webpubsub/v20240401preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:webpubsub/v20240401preview:WebPubSub":
                return new WebPubSub(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240401preview:WebPubSubCustomCertificate":
                return new WebPubSubCustomCertificate(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240401preview:WebPubSubCustomDomain":
                return new WebPubSubCustomDomain(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240401preview:WebPubSubHub":
                return new WebPubSubHub(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240401preview:WebPubSubPrivateEndpointConnection":
                return new WebPubSubPrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240401preview:WebPubSubReplica":
                return new WebPubSubReplica(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240401preview:WebPubSubSharedPrivateLinkResource":
...
pulumi.runtime.registerResourceModule("azure-native", "webpubsub/v20240401preview", _module)
