...
export interface WebPubSubPrivateEndpointConnectionArgs {
     ...
     * Private endpoint associated with the private endpoint connection
     */
    readonly privateEndpoint?: pulumi.Input<inputs.webpubsub.v20210401preview.PrivateEndpoint>;
    /**
     ...
     * Connection state
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.webpubsub.v20210401preview.PrivateLinkServiceConnectionState>;
    /**
