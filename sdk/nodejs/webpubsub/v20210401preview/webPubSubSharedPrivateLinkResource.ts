 ...
 *
 * const webPubSubSharedPrivateLinkResource = new azure_native.webpubsub.v20210401preview.WebPubSubSharedPrivateLinkResource("webPubSubSharedPrivateLinkResource", {
 *     groupId: "sites",
