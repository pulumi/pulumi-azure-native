...
export function getWebPubSubHub(args: GetWebPubSubHubArgs, opts?: pulumi.InvokeOptions): Promise<GetWebPubSubHubResult> {
    pulumi.log.warn("getWebPubSubHub is deprecated: azure-native:webpubsub/v20220801preview:WebPubSubHub is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230301preview:WebPubSubHub to guarantee forwards compatibility.")
...
export interface GetWebPubSubHubResult {
     ...
     * Properties of a hub.
     */
    readonly properties: outputs.webpubsub.v20220801preview.WebPubSubHubPropertiesResponse;
    /**
