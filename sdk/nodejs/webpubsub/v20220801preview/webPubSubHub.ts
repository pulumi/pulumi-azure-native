...
export class WebPubSubHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20220801preview:WebPubSubHub';
     ...
     * Properties of a hub.
     */
    public readonly properties!: pulumi.Output<outputs.webpubsub.v20220801preview.WebPubSubHubPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: WebPubSubHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.webpubsub.v20220801preview.webPubSubHubPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:webpubsub:WebPubSubHub" }, { type: "azure-native:webpubsub/v20211001:WebPubSubHub" }, { type: "azure-native:webpubsub/v20230201:WebPubSubHub" }, { type: "azure-native:webpubsub/v20230301preview:WebPubSubHub" }] };
...
export interface WebPubSubHubArgs {
     ...
     * Properties of a hub.
     */
    properties: pulumi.Input<inputs.webpubsub.v20220801preview.WebPubSubHubPropertiesArgs>;
    /**
