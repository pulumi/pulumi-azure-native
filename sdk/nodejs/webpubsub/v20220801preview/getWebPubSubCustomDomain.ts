...
export function getWebPubSubCustomDomain(args: GetWebPubSubCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetWebPubSubCustomDomainResult> {
    pulumi.log.warn("getWebPubSubCustomDomain is deprecated: azure-native:webpubsub/v20220801preview:WebPubSubCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:webpubsub/v20230201:WebPubSubCustomDomain to guarantee forwards compatibility.")
