 ...
 *
 * const webPubSubCustomDomain = new azure_native.webpubsub.v20230301preview.WebPubSubCustomDomain("webPubSubCustomDomain", {
 *     customCertificate: {
...
export class WebPubSubCustomDomain extends pulumi.CustomResource {
     ...
     */
    public readonly customCertificate!: pulumi.Output<outputs.webpubsub.v20230301preview.ResourceReferenceResponse>;
    /**
    ...
    constructor(name: string, args: WebPubSubCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:webpubsub:WebPubSubCustomDomain" }, { type: "azure-native:webpubsub/v20220801preview:WebPubSubCustomDomain" }, { type: "azure-native:webpubsub/v20230201:WebPubSubCustomDomain" }] };
...
export interface WebPubSubCustomDomainArgs {
     ...
     * Reference to a resource.
     */
    customCertificate: pulumi.Input<inputs.webpubsub.v20230301preview.ResourceReferenceArgs>;
    /**
     * The custom domain name.
     */
