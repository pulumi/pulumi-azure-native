...
export function getWebPubSubPrivateEndpointConnection(args: GetWebPubSubPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebPubSubPrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:webpubsub/v20240801preview:getWebPubSubPrivateEndpointConnection", {
...
export interface GetWebPubSubPrivateEndpointConnectionResult {
     ...
     * Private endpoint
     */
    readonly privateEndpoint?: outputs.webpubsub.v20240801preview.PrivateEndpointResponse;
    /**
     * Connection state of the private endpoint connection
     */
    readonly privateLinkServiceConnectionState?: outputs.webpubsub.v20240801preview.PrivateLinkServiceConnectionStateResponse;
    /**
...
export function getWebPubSubPrivateEndpointConnectionOutput(args: GetWebPubSubPrivateEndpointConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebPubSubPrivateEndpointConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:webpubsub/v20240801preview:getWebPubSubPrivateEndpointConnection", {
        "privateEndpointConnectionName": args.privateEndpointConnectionName,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
