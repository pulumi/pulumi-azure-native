...
export function getWebPubSubHub(args: GetWebPubSubHubArgs, opts?: pulumi.InvokeOptions): Promise<GetWebPubSubHubResult> {
    ...
    return pulumi.runtime.invoke("azure-native:webpubsub/v20240801preview:getWebPubSubHub", {
...
export interface GetWebPubSubHubResult {
     ...
     * Properties of a hub.
     */
    readonly properties: outputs.webpubsub.v20240801preview.WebPubSubHubPropertiesResponse;
    /**
