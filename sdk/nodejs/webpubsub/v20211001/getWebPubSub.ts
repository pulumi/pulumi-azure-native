...
export function getWebPubSub(args: GetWebPubSubArgs, opts?: pulumi.InvokeOptions): Promise<GetWebPubSubResult> {
    pulumi.log.warn("getWebPubSub is deprecated: azure-native:webpubsub/v20211001:WebPubSub is being removed in the next major version of this provider. Please upgrade to azure-native:webpubsub/v20230201:WebPubSub to guarantee forwards compatibility.")
