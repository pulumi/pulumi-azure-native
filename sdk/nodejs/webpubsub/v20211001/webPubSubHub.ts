 ...
 *
 * const webPubSubHub = new azure_native.webpubsub.v20211001.WebPubSubHub("webPubSubHub", {
 *     hubName: "exampleHub",
 *     properties: {
 *         eventHandlers: [{
 *             auth: {
...
export class WebPubSubHub extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebPubSubHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:webpubsub:WebPubSubHub" }, { type: "azure-native:webpubsub/v20220801preview:WebPubSubHub" }, { type: "azure-native:webpubsub/v20230201:WebPubSubHub" }, { type: "azure-native:webpubsub/v20230301preview:WebPubSubHub" }] };
