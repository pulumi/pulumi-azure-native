...
export function getWebPubSubCustomDomain(args: GetWebPubSubCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetWebPubSubCustomDomainResult> {
    pulumi.log.warn("getWebPubSubCustomDomain is deprecated: azure-native:webpubsub/v20230201:WebPubSubCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230301preview:WebPubSubCustomDomain to guarantee forwards compatibility.")
...
export interface GetWebPubSubCustomDomainResult {
     ...
     */
    readonly customCertificate: outputs.webpubsub.v20230201.ResourceReferenceResponse;
    /**
