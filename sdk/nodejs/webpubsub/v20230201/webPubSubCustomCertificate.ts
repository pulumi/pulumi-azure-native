...
export class WebPubSubCustomCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebPubSubCustomCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:webpubsub:WebPubSubCustomCertificate" }, { type: "azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate" }, { type: "azure-native:webpubsub/v20230301preview:WebPubSubCustomCertificate" }] };
