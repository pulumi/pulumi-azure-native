...
export class AzureMonitorWorkspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzureMonitorWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:monitor/v20230403:AzureMonitorWorkspace" }, { type: "azure-native:monitor/v20231001preview:AzureMonitorWorkspace" }, { type: "azure-native_monitor_v20210603preview:monitor:AzureMonitorWorkspace" }, { type: "azure-native_monitor_v20230403:monitor:AzureMonitorWorkspace" }, { type: "azure-native_monitor_v20231001preview:monitor:AzureMonitorWorkspace" }] };
