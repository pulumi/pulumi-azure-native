...
export class ScheduledQueryRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20200501preview:ScheduledQueryRule';
    ...
    public readonly actions!: pulumi.Output<outputs.monitor.v20200501preview.ActionResponse[] | undefined>;
    /**
     ...
     */
    public readonly criteria!: pulumi.Output<outputs.monitor.v20200501preview.ScheduledQueryRuleCriteriaResponse>;
    /**
    ...
    constructor(name: string, args: ScheduledQueryRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20180416:ScheduledQueryRule" }, { type: "azure-native:insights/v20200501preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20220801preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20230315preview:ScheduledQueryRule" }, { type: "azure-native:insights/v20231201:ScheduledQueryRule" }, { type: "azure-native:insights/v20240101preview:ScheduledQueryRule" }, { type: "azure-native:insights:ScheduledQueryRule" }, { type: "azure-native:monitor/v20180416:ScheduledQueryRule" }, { type: "azure-native:monitor/v20210201preview:ScheduledQueryRule" }, { type: "azure-native:monitor/v20210801:ScheduledQueryRule" }, { type: "azure-native:monitor/v20220615:ScheduledQueryRule" }, { type: "azure-native:monitor/v20220801preview:ScheduledQueryRule" }, { type: "azure-native:monitor/v20230315preview:ScheduledQueryRule" }, { type: "azure-native:monitor/v20231201:ScheduledQueryRule" }, { type: "azure-native:monitor/v20240101preview:ScheduledQueryRule" }, { type: "azure-native:monitor:ScheduledQueryRule" }] };
...
export interface ScheduledQueryRuleArgs {
    actions?: pulumi.Input<pulumi.Input<inputs.monitor.v20200501preview.ActionArgs>[]>;
    /**
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    criteria: pulumi.Input<inputs.monitor.v20200501preview.ScheduledQueryRuleCriteriaArgs>;
    /**
     * The description of the scheduled query rule.
     */
