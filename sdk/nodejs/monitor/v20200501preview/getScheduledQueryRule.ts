...
export function getScheduledQueryRule(args: GetScheduledQueryRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledQueryRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor/v20200501preview:getScheduledQueryRule", {
...
export interface GetScheduledQueryRuleResult {
    readonly actions?: outputs.monitor.v20200501preview.ActionResponse[];
    /**
     ...
     */
    readonly criteria: outputs.monitor.v20200501preview.ScheduledQueryRuleCriteriaResponse;
    /**
...
export function getScheduledQueryRuleOutput(args: GetScheduledQueryRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledQueryRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:monitor/v20200501preview:getScheduledQueryRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleName": args.ruleName,
    }, opts);
}
