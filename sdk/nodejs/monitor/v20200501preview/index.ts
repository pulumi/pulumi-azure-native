...
// Export enums:
export * from "../../types/enums/monitor/v20200501preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20200501preview:ScheduledQueryRule":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20200501preview", _module)
