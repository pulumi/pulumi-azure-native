...
export class MetricAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20180301:MetricAlert';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.monitor.v20180301.MetricAlertActionResponse[] | undefined>;
    /**
     ...
     */
    public readonly criteria!: pulumi.Output<outputs.monitor.v20180301.MetricAlertMultipleResourceMultipleMetricCriteriaResponse | outputs.monitor.v20180301.MetricAlertSingleResourceMultipleMetricCriteriaResponse | outputs.monitor.v20180301.WebtestLocationAvailabilityCriteriaResponse>;
    /**
    ...
    constructor(name: string, args: MetricAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20180301:MetricAlert" }, { type: "azure-native:insights:MetricAlert" }, { type: "azure-native:monitor:MetricAlert" }] };
...
export interface MetricAlertArgs {
     ...
     * the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
     */
    actions?: pulumi.Input<pulumi.Input<inputs.monitor.v20180301.MetricAlertActionArgs>[]>;
    /**
     * the flag that indicates whether the alert should be auto resolved or not. The default is true.
     */
     ...
     * defines the specific alert criteria information.
     */
    criteria: pulumi.Input<inputs.monitor.v20180301.MetricAlertMultipleResourceMultipleMetricCriteriaArgs | inputs.monitor.v20180301.MetricAlertSingleResourceMultipleMetricCriteriaArgs | inputs.monitor.v20180301.WebtestLocationAvailabilityCriteriaArgs>;
    /**
     * the description of the metric alert that will be included in the alert email.
     */
