...
export class PipelineGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PipelineGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:monitor/v20231001preview:PipelineGroup" }, { type: "azure-native:monitor/v20241001preview:PipelineGroup" }, { type: "azure-native_monitor_v20231001preview:monitor:PipelineGroup" }, { type: "azure-native_monitor_v20241001preview:monitor:PipelineGroup" }] };
