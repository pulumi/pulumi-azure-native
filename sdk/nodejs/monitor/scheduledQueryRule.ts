...
export class ScheduledQueryRule extends pulumi.CustomResource {
     ...
     */
    public readonly criteria!: pulumi.Output<outputs.monitor.ScheduledQueryRuleCriteriaResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.monitor.IdentityResponse | undefined>;
    /**
