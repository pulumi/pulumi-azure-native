...
// Export enums:
export * from "../../types/enums/monitor/v20180416";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20180416:ScheduledQueryRule":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20180416", _module)
