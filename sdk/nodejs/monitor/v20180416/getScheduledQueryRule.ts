...
export function getScheduledQueryRule(args: GetScheduledQueryRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledQueryRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor/v20180416:getScheduledQueryRule", {
...
export interface GetScheduledQueryRuleResult {
     ...
     */
    readonly action: outputs.monitor.v20180416.AlertingActionResponse | outputs.monitor.v20180416.LogToMetricActionResponse;
    /**
     ...
     */
    readonly schedule?: outputs.monitor.v20180416.ScheduleResponse;
    /**
     * Data Source against which rule will Query Data
     */
    readonly source: outputs.monitor.v20180416.SourceResponse;
    /**
     * Resource tags
     */
...
export function getScheduledQueryRuleOutput(args: GetScheduledQueryRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledQueryRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:monitor/v20180416:getScheduledQueryRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleName": args.ruleName,
    }, opts);
}
