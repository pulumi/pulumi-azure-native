...
export class ScheduledQueryRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20180416:ScheduledQueryRule';
     ...
     */
    public readonly action!: pulumi.Output<outputs.monitor.v20180416.AlertingActionResponse | outputs.monitor.v20180416.LogToMetricActionResponse>;
    /**
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.monitor.v20180416.ScheduleResponse | undefined>;
    /**
     * Data Source against which rule will Query Data
     */
    public readonly source!: pulumi.Output<outputs.monitor.v20180416.SourceResponse>;
    /**
     * Resource tags
     */
...
export interface ScheduledQueryRuleArgs {
     ...
     * Action needs to be taken on rule execution.
     */
    action: pulumi.Input<inputs.monitor.v20180416.AlertingActionArgs | inputs.monitor.v20180416.LogToMetricActionArgs>;
    /**
     * The flag that indicates whether the alert should be automatically resolved or not. The default is false.
     */
     ...
     * The flag which indicates whether the Log Search rule is enabled. Value should be true or false
     */
    enabled?: pulumi.Input<string | enums.monitor.v20180416.Enabled>;
    /**
     * Resource location
     */
     ...
     * Schedule (Frequency, Time Window) for rule. Required for action type - AlertingAction
     */
    schedule?: pulumi.Input<inputs.monitor.v20180416.ScheduleArgs>;
    /**
     * Data Source against which rule will Query Data
     */
    source: pulumi.Input<inputs.monitor.v20180416.SourceArgs>;
    /**
     * Resource tags
     */
