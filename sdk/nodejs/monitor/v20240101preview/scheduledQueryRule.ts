...
export class ScheduledQueryRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20240101preview:ScheduledQueryRule';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.monitor.v20240101preview.ActionsResponse | undefined>;
    /**
     ...
     */
    public readonly criteria!: pulumi.Output<outputs.monitor.v20240101preview.ScheduledQueryRuleCriteriaResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.monitor.v20240101preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly resolveConfiguration!: pulumi.Output<outputs.monitor.v20240101preview.RuleResolveConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.monitor.v20240101preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ScheduledQueryRuleArgs {
     ...
     * Actions to invoke when the alert fires.
     */
    actions?: pulumi.Input<inputs.monitor.v20240101preview.ActionsArgs>;
    /**
     * The flag that indicates whether the alert should be automatically resolved or not. The default is true. Relevant only for rules of the kind LogAlert.
     */
     ...
     * The rule criteria that defines the conditions of the scheduled query rule.
     */
    criteria: pulumi.Input<inputs.monitor.v20240101preview.ScheduledQueryRuleCriteriaArgs>;
    /**
     * The description of the scheduled query rule.
     */
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.monitor.v20240101preview.IdentityArgs>;
    /**
     * Indicates the type of scheduled query rule. The default is LogAlert.
     */
    kind?: pulumi.Input<string | enums.monitor.v20240101preview.Kind>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Defines the configuration for resolving fired alerts. Relevant only for rules of the kind LogAlert.
     */
    resolveConfiguration?: pulumi.Input<inputs.monitor.v20240101preview.RuleResolveConfigurationArgs>;
    /**
