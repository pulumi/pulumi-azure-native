...
export function getScheduledQueryRule(args: GetScheduledQueryRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledQueryRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor/v20240101preview:getScheduledQueryRule", {
...
export interface GetScheduledQueryRuleResult {
     ...
     */
    readonly actions?: outputs.monitor.v20240101preview.ActionsResponse;
    /**
     ...
     */
    readonly criteria: outputs.monitor.v20240101preview.ScheduledQueryRuleCriteriaResponse;
    /**
     ...
     */
    readonly identity?: outputs.monitor.v20240101preview.IdentityResponse;
    /**
     ...
     */
    readonly resolveConfiguration?: outputs.monitor.v20240101preview.RuleResolveConfigurationResponse;
    /**
     ...
     */
    readonly systemData: outputs.monitor.v20240101preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getScheduledQueryRuleOutput(args: GetScheduledQueryRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledQueryRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:monitor/v20240101preview:getScheduledQueryRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleName": args.ruleName,
    }, opts);
}
