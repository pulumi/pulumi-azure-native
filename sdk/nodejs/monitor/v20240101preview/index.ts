...
// Export enums:
export * from "../../types/enums/monitor/v20240101preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20240101preview:ScheduledQueryRule":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20240101preview", _module)
