...
// Export enums:
export * from "../../types/enums/monitor/v20231001preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20231001preview:AzureMonitorWorkspace":
                return new AzureMonitorWorkspace(name, <any>undefined, { urn })
            case "azure-native:monitor/v20231001preview:PipelineGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20231001preview", _module)
