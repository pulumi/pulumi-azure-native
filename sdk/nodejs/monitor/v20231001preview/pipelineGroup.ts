...
export class PipelineGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20231001preview:PipelineGroup';
     ...
     */
    public readonly exporters!: pulumi.Output<outputs.monitor.v20231001preview.ExporterResponse[]>;
    /**
     * The extended location for given pipeline group.
     */
    public readonly extendedLocation!: pulumi.Output<outputs.monitor.v20231001preview.AzureResourceManagerCommonTypesExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly networkingConfigurations!: pulumi.Output<outputs.monitor.v20231001preview.NetworkingConfigurationResponse[] | undefined>;
    /**
     * The processors specified for a pipeline group instance.
     */
    public readonly processors!: pulumi.Output<outputs.monitor.v20231001preview.ProcessorResponse[]>;
    /**
     ...
     */
    public readonly receivers!: pulumi.Output<outputs.monitor.v20231001preview.ReceiverResponse[]>;
    /**
     ...
     */
    public readonly service!: pulumi.Output<outputs.monitor.v20231001preview.ServiceResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.monitor.v20231001preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: PipelineGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:monitor/v20241001preview:PipelineGroup" }, { type: "azure-native:monitor:PipelineGroup" }] };
...
export interface PipelineGroupArgs {
     ...
     * The exporters specified for a pipeline group instance.
     */
    exporters: pulumi.Input<pulumi.Input<inputs.monitor.v20231001preview.ExporterArgs>[]>;
    /**
     * The extended location for given pipeline group.
     */
    extendedLocation?: pulumi.Input<inputs.monitor.v20231001preview.AzureResourceManagerCommonTypesExtendedLocationArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Networking configurations for the pipeline group instance.
     */
    networkingConfigurations?: pulumi.Input<pulumi.Input<inputs.monitor.v20231001preview.NetworkingConfigurationArgs>[]>;
    /**
     ...
     * The processors specified for a pipeline group instance.
     */
    processors: pulumi.Input<pulumi.Input<inputs.monitor.v20231001preview.ProcessorArgs>[]>;
    /**
     * The receivers specified for a pipeline group instance.
     */
    receivers: pulumi.Input<pulumi.Input<inputs.monitor.v20231001preview.ReceiverArgs>[]>;
    /**
     * Defines the amount of replicas of the pipeline group instance.
     */
     ...
     * The service section for a given pipeline group instance.
     */
    service: pulumi.Input<inputs.monitor.v20231001preview.ServiceArgs>;
    /**
     * Resource tags.
     */
