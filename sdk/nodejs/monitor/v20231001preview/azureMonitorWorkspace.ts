...
export class AzureMonitorWorkspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20231001preview:AzureMonitorWorkspace';
     ...
     */
    public /*out*/ readonly metrics!: pulumi.Output<outputs.monitor.v20231001preview.MetricsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AzureMonitorWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:monitor:AzureMonitorWorkspace" }, { type: "azure-native:monitor/v20210603preview:AzureMonitorWorkspace" }, { type: "azure-native:monitor/v20230403:AzureMonitorWorkspace" }] };
