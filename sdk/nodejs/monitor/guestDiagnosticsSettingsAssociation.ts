...
export class GuestDiagnosticsSettingsAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor:GuestDiagnosticsSettingsAssociation';
    ...
    constructor(name: string, args: GuestDiagnosticsSettingsAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20180601preview:GuestDiagnosticsSettingsAssociation" }, { type: "azure-native:insights:GuestDiagnosticsSettingsAssociation" }, { type: "azure-native:monitor/v20180601preview:GuestDiagnosticsSettingsAssociation" }] };
