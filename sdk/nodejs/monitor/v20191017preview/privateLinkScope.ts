...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20191017preview:PrivateLinkScope';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.monitor.v20191017preview.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20191017preview:PrivateLinkScope" }, { type: "azure-native:insights/v20210701preview:PrivateLinkScope" }, { type: "azure-native:insights/v20210901:PrivateLinkScope" }, { type: "azure-native:insights/v20230601preview:PrivateLinkScope" }, { type: "azure-native:insights:PrivateLinkScope" }, { type: "azure-native:monitor/v20210701preview:PrivateLinkScope" }, { type: "azure-native:monitor/v20210901:PrivateLinkScope" }, { type: "azure-native:monitor/v20230601preview:PrivateLinkScope" }, { type: "azure-native:monitor:PrivateLinkScope" }] };
