...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20191017preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:monitor/v20191017preview:PrivateLinkScope":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20191017preview", _module)
