...
export class DataCollectionRule extends pulumi.CustomResource {
     ...
     */
    public readonly agentSettings!: pulumi.Output<outputs.monitor.DataCollectionRuleResponseAgentSettings | undefined>;
    /**
     ...
     */
    public readonly dataFlows!: pulumi.Output<outputs.monitor.DataFlowResponse[] | undefined>;
    /**
     * The specification of data sources. 
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    public readonly dataSources!: pulumi.Output<outputs.monitor.DataCollectionRuleResponseDataSources | undefined>;
    /**
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.monitor.DataCollectionRuleResponseDestinations | undefined>;
    /**
     * Defines the ingestion endpoints to send data to via this rule.
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.monitor.DataCollectionRuleResponseEndpoints>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.monitor.DataCollectionRuleResourceResponseIdentity | undefined>;
    /**
     ...
     */
    public /*out*/ readonly metadata!: pulumi.Output<outputs.monitor.DataCollectionRuleResponseMetadata>;
    /**
     ...
     */
    public readonly references!: pulumi.Output<outputs.monitor.DataCollectionRuleResponseReferences | undefined>;
    /**
     * Declaration of custom streams used in this rule.
     */
    public readonly streamDeclarations!: pulumi.Output<{[key: string]: outputs.monitor.StreamDeclarationResponse} | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.monitor.DataCollectionRuleResourceResponseSystemData>;
    /**
     * Resource tags.
     */
...
export interface DataCollectionRuleArgs {
     ...
     * Agent settings used to modify agent behavior on a given host
     */
    agentSettings?: pulumi.Input<inputs.monitor.DataCollectionRuleAgentSettingsArgs>;
    /**
     * The resource ID of the data collection endpoint that this rule can be used with.
     */
     ...
     * Defines all the references that may be used in other sections of the DCR
     */
    references?: pulumi.Input<inputs.monitor.DataCollectionRuleReferencesArgs>;
    /**
