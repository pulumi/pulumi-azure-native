...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20170401:ActivityLogAlert';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.monitor.v20170401.ActivityLogAlertActionListResponse>;
    /**
     * The condition that will cause this alert to activate.
     */
    public readonly condition!: pulumi.Output<outputs.monitor.v20170401.ActivityLogAlertAllOfConditionResponse>;
    /**
...
export interface ActivityLogAlertArgs {
     ...
     * The actions that will activate when the condition is met.
     */
    actions: pulumi.Input<inputs.monitor.v20170401.ActivityLogAlertActionListArgs>;
    /**
     ...
     * The condition that will cause this alert to activate.
     */
    condition: pulumi.Input<inputs.monitor.v20170401.ActivityLogAlertAllOfConditionArgs>;
    /**
     * A description of this activity log alert.
     */
