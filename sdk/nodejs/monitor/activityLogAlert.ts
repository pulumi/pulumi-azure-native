...
export class ActivityLogAlert extends pulumi.CustomResource {
     ...
     */
    declare public readonly actions: pulumi.Output<outputs.monitor.ActionListResponse>;
    /**
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.monitor.AlertRuleAllOfConditionResponse>;
    /**
    ...
    constructor(name: string, args: ActivityLogAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.activityLogAlertName === undefined && !opts.urn) {
