...
export class GuestDiagnosticsSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20180601preview:GuestDiagnosticsSetting';
     ...
     */
    public readonly dataSources!: pulumi.Output<outputs.monitor.v20180601preview.DataSourceResponse[] | undefined>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, args: GuestDiagnosticsSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20180601preview:GuestDiagnosticsSetting" }, { type: "azure-native:insights:GuestDiagnosticsSetting" }, { type: "azure-native:monitor:GuestDiagnosticsSetting" }] };
...
export interface GuestDiagnosticsSettingArgs {
     ...
     * the array of data source object which are configured to collect and send data
     */
    dataSources?: pulumi.Input<pulumi.Input<inputs.monitor.v20180601preview.DataSourceArgs>[]>;
    /**
