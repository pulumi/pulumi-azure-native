...
export function getGuestDiagnosticsSetting(args: GetGuestDiagnosticsSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetGuestDiagnosticsSettingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor/v20180601preview:getGuestDiagnosticsSetting", {
...
export interface GetGuestDiagnosticsSettingResult {
     ...
     */
    readonly dataSources?: outputs.monitor.v20180601preview.DataSourceResponse[];
    /**
     * Azure resource Id
     */
    readonly id: string;
...
export function getGuestDiagnosticsSettingOutput(args: GetGuestDiagnosticsSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGuestDiagnosticsSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:monitor/v20180601preview:getGuestDiagnosticsSetting", {
        "diagnosticSettingsName": args.diagnosticSettingsName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
