...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20180601preview:GuestDiagnosticsSetting":
                return new GuestDiagnosticsSetting(name, <any>undefined, { urn })
            case "azure-native:monitor/v20180601preview:GuestDiagnosticsSettingsAssociation":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20180601preview", _module)
