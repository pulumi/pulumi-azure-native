...
export class LogProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20160301:LogProfile';
     ...
     */
    public readonly retentionPolicy!: pulumi.Output<outputs.monitor.v20160301.RetentionPolicyResponse>;
    /**
    ...
    constructor(name: string, args: LogProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20160301:LogProfile" }, { type: "azure-native:insights:LogProfile" }, { type: "azure-native:monitor:LogProfile" }] };
...
export interface LogProfileArgs {
     ...
     * the retention policy for the events in the log.
     */
    retentionPolicy: pulumi.Input<inputs.monitor.v20160301.RetentionPolicyArgs>;
    /**
     * The service bus rule ID of the service bus namespace in which you would like to have Event Hubs created for streaming the Activity Log. The rule ID is of the format: '{service bus resource ID}/authorizationrules/{key name}'.
     */
