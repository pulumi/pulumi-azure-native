...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20201001:ActivityLogAlert';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.monitor.v20201001.ActionListResponse>;
    /**
     * The condition that will cause this alert to activate.
     */
    public readonly condition!: pulumi.Output<outputs.monitor.v20201001.AlertRuleAllOfConditionResponse>;
    /**
...
export interface ActivityLogAlertArgs {
     ...
     * The actions that will activate when the condition is met.
     */
    actions: pulumi.Input<inputs.monitor.v20201001.ActionListArgs>;
    /**
     ...
     * The condition that will cause this alert to activate.
     */
    condition: pulumi.Input<inputs.monitor.v20201001.AlertRuleAllOfConditionArgs>;
    /**
     * A description of this Activity Log Alert rule.
     */
