...
export function getScheduledQueryRule(args: GetScheduledQueryRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledQueryRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor/v20220801preview:getScheduledQueryRule", {
...
export interface GetScheduledQueryRuleResult {
     ...
     */
    readonly actions?: outputs.monitor.v20220801preview.ActionsResponse;
    /**
     ...
     */
    readonly criteria: outputs.monitor.v20220801preview.ScheduledQueryRuleCriteriaResponse;
    /**
     ...
     */
    readonly identity?: outputs.monitor.v20220801preview.IdentityResponse;
    /**
     ...
     */
    readonly resolveConfiguration?: outputs.monitor.v20220801preview.RuleResolveConfigurationResponse;
    /**
     ...
     */
    readonly systemData: outputs.monitor.v20220801preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getScheduledQueryRuleOutput(args: GetScheduledQueryRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledQueryRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:monitor/v20220801preview:getScheduledQueryRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleName": args.ruleName,
    }, opts);
}
