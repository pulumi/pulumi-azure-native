...
// Export enums:
export * from "../../types/enums/monitor/v20221001";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20221001:AutoscaleSetting":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20221001", _module)
