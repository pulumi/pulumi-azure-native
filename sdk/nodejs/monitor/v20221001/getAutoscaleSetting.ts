...
export function getAutoscaleSetting(args: GetAutoscaleSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoscaleSettingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor/v20221001:getAutoscaleSetting", {
...
export interface GetAutoscaleSettingResult {
     ...
     */
    readonly notifications?: outputs.monitor.v20221001.AutoscaleNotificationResponse[];
    /**
     * the predictive autoscale policy mode.
     */
    readonly predictiveAutoscalePolicy?: outputs.monitor.v20221001.PredictiveAutoscalePolicyResponse;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    readonly profiles: outputs.monitor.v20221001.AutoscaleProfileResponse[];
    /**
     * The system metadata related to the response.
     */
    readonly systemData: outputs.monitor.v20221001.SystemDataResponse;
    /**
...
export function getAutoscaleSettingOutput(args: GetAutoscaleSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutoscaleSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:monitor/v20221001:getAutoscaleSetting", {
        "autoscaleSettingName": args.autoscaleSettingName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
