...
export class AutoscaleSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20221001:AutoscaleSetting';
     ...
     */
    public readonly notifications!: pulumi.Output<outputs.monitor.v20221001.AutoscaleNotificationResponse[] | undefined>;
    /**
     * the predictive autoscale policy mode.
     */
    public readonly predictiveAutoscalePolicy!: pulumi.Output<outputs.monitor.v20221001.PredictiveAutoscalePolicyResponse | undefined>;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    public readonly profiles!: pulumi.Output<outputs.monitor.v20221001.AutoscaleProfileResponse[]>;
    /**
     * The system metadata related to the response.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.monitor.v20221001.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: AutoscaleSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20221001:AutoscaleSetting" }, { type: "azure-native:insights:AutoscaleSetting" }, { type: "azure-native:monitor/v20140401:AutoscaleSetting" }, { type: "azure-native:monitor/v20150401:AutoscaleSetting" }, { type: "azure-native:monitor/v20210501preview:AutoscaleSetting" }, { type: "azure-native:monitor:AutoscaleSetting" }] };
...
export interface AutoscaleSettingArgs {
     ...
     * the collection of notifications.
     */
    notifications?: pulumi.Input<pulumi.Input<inputs.monitor.v20221001.AutoscaleNotificationArgs>[]>;
    /**
     * the predictive autoscale policy mode.
     */
    predictiveAutoscalePolicy?: pulumi.Input<inputs.monitor.v20221001.PredictiveAutoscalePolicyArgs>;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    profiles: pulumi.Input<pulumi.Input<inputs.monitor.v20221001.AutoscaleProfileArgs>[]>;
    /**
