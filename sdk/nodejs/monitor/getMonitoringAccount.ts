...
export function getMonitoringAccount(args: GetMonitoringAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetMonitoringAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor:getMonitoringAccount", {
...
export interface GetMonitoringAccountResult {
     ...
     */
    readonly defaultIngestionSettings: outputs.monitor.MonitoringAccountResponseDefaultIngestionSettings;
    /**
     ...
     */
    readonly metrics: outputs.monitor.MonitoringAccountResponseMetrics;
    /**
