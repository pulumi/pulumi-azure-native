...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20230101preview:ActivityLogAlert';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.monitor.v20230101preview.ActionListResponse>;
    /**
     * The condition that will cause this alert to activate.
     */
    public readonly condition!: pulumi.Output<outputs.monitor.v20230101preview.AlertRuleAllOfConditionResponse>;
    /**
...
export interface ActivityLogAlertArgs {
     ...
     * The actions that will activate when the condition is met.
     */
    actions: pulumi.Input<inputs.monitor.v20230101preview.ActionListArgs>;
    /**
     ...
     * The condition that will cause this alert to activate.
     */
    condition: pulumi.Input<inputs.monitor.v20230101preview.AlertRuleAllOfConditionArgs>;
    /**
     * A description of this Activity Log Alert rule.
     */
