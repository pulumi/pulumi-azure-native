...
export class AutoscaleSetting extends pulumi.CustomResource {
     ...
     */
    public readonly notifications!: pulumi.Output<outputs.monitor.AutoscaleNotificationResponse[] | undefined>;
    /**
     * the predictive autoscale policy mode.
     */
    public readonly predictiveAutoscalePolicy!: pulumi.Output<outputs.monitor.PredictiveAutoscalePolicyResponse | undefined>;
    /**
     * the collection of automatic scaling profiles that specify different scaling parameters for different time periods. A maximum of 20 profiles can be specified.
     */
    public readonly profiles!: pulumi.Output<outputs.monitor.AutoscaleProfileResponse[]>;
    /**
