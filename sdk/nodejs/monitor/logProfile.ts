...
export class LogProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor:LogProfile';
     ...
     */
    public readonly retentionPolicy!: pulumi.Output<outputs.monitor.RetentionPolicyResponse>;
    /**
    ...
    constructor(name: string, args: LogProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20160301:LogProfile" }, { type: "azure-native:insights:LogProfile" }, { type: "azure-native:monitor/v20160301:LogProfile" }] };
