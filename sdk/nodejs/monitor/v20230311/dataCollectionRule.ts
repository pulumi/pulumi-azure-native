...
export class DataCollectionRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20230311:DataCollectionRule';
     ...
     */
    public readonly agentSettings!: pulumi.Output<outputs.monitor.v20230311.DataCollectionRuleResponseAgentSettings | undefined>;
    /**
     ...
     */
    public readonly dataFlows!: pulumi.Output<outputs.monitor.v20230311.DataFlowResponse[] | undefined>;
    /**
     * The specification of data sources. 
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    public readonly dataSources!: pulumi.Output<outputs.monitor.v20230311.DataCollectionRuleResponseDataSources | undefined>;
    /**
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.monitor.v20230311.DataCollectionRuleResponseDestinations | undefined>;
    /**
     * Defines the ingestion endpoints to send data to via this rule.
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.monitor.v20230311.DataCollectionRuleResponseEndpoints>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.monitor.v20230311.DataCollectionRuleResourceResponseIdentity | undefined>;
    /**
     ...
     */
    public /*out*/ readonly metadata!: pulumi.Output<outputs.monitor.v20230311.DataCollectionRuleResponseMetadata>;
    /**
     ...
     */
    public readonly references!: pulumi.Output<outputs.monitor.v20230311.DataCollectionRuleResponseReferences | undefined>;
    /**
     * Declaration of custom streams used in this rule.
     */
    public readonly streamDeclarations!: pulumi.Output<{[key: string]: outputs.monitor.v20230311.StreamDeclarationResponse} | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.monitor.v20230311.DataCollectionRuleResourceResponseSystemData>;
    /**
     * Resource tags.
     */
...
export interface DataCollectionRuleArgs {
     ...
     * Agent settings used to modify agent behavior on a given host
     */
    agentSettings?: pulumi.Input<inputs.monitor.v20230311.DataCollectionRuleAgentSettingsArgs>;
    /**
     * The resource ID of the data collection endpoint that this rule can be used with.
     */
     ...
     * The specification of data flows.
     */
    dataFlows?: pulumi.Input<pulumi.Input<inputs.monitor.v20230311.DataFlowArgs>[]>;
    /**
     * The specification of data sources. 
     * This property is optional and can be omitted if the rule is meant to be used via direct calls to the provisioned endpoint.
     */
    dataSources?: pulumi.Input<inputs.monitor.v20230311.DataCollectionRuleDataSourcesArgs>;
    /**
     * Description of the data collection rule.
     */
     ...
     * The specification of destinations.
     */
    destinations?: pulumi.Input<inputs.monitor.v20230311.DataCollectionRuleDestinationsArgs>;
    /**
     * Managed service identity of the resource.
     */
    identity?: pulumi.Input<inputs.monitor.v20230311.DataCollectionRuleResourceIdentityArgs>;
    /**
     * The kind of the resource.
     */
    kind?: pulumi.Input<string | enums.monitor.v20230311.KnownDataCollectionRuleResourceKind>;
    /**
     * The geo-location where the resource lives.
     */
     ...
     * Defines all the references that may be used in other sections of the DCR
     */
    references?: pulumi.Input<inputs.monitor.v20230311.DataCollectionRuleReferencesArgs>;
    /**
     ...
     * Declaration of custom streams used in this rule.
     */
    streamDeclarations?: pulumi.Input<{[key: string]: pulumi.Input<inputs.monitor.v20230311.StreamDeclarationArgs>}>;
    /**
     * Resource tags.
     */
