...
// Export enums:
export * from "../../types/enums/monitor/v20230311";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20230311:DataCollectionEndpoint":
                return new DataCollectionEndpoint(name, <any>undefined, { urn })
            case "azure-native:monitor/v20230311:DataCollectionRule":
                return new DataCollectionRule(name, <any>undefined, { urn })
            case "azure-native:monitor/v20230311:DataCollectionRuleAssociation":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20230311", _module)
