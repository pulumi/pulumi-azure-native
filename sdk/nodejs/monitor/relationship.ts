...
export class Relationship extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.monitor.RelationshipPropertiesResponse>;
    /**
...
export interface RelationshipArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.monitor.RelationshipPropertiesArgs | undefined>;
    /**
