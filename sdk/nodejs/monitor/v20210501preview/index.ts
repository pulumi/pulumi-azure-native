...
// Export enums:
export * from "../../types/enums/monitor/v20210501preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20210501preview:AutoscaleSetting":
                return new AutoscaleSetting(name, <any>undefined, { urn })
            case "azure-native:monitor/v20210501preview:DiagnosticSetting":
                return new DiagnosticSetting(name, <any>undefined, { urn })
            case "azure-native:monitor/v20210501preview:ManagementGroupDiagnosticSetting":
                return new ManagementGroupDiagnosticSetting(name, <any>undefined, { urn })
            case "azure-native:monitor/v20210501preview:SubscriptionDiagnosticSetting":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20210501preview", _module)
