...
export function getDiagnosticSetting(args: GetDiagnosticSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetDiagnosticSettingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor/v20210501preview:getDiagnosticSetting", {
        "name": args.name,
...
export interface GetDiagnosticSettingResult {
     ...
     */
    readonly logs?: outputs.monitor.v20210501preview.LogSettingsResponse[];
    /**
     ...
     */
    readonly metrics?: outputs.monitor.v20210501preview.MetricSettingsResponse[];
    /**
...
export function getDiagnosticSettingOutput(args: GetDiagnosticSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDiagnosticSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:monitor/v20210501preview:getDiagnosticSetting", {
        "name": args.name,
        "resourceUri": args.resourceUri,
    }, opts);
}
