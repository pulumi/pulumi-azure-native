...
export class DiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20210501preview:DiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<outputs.monitor.v20210501preview.LogSettingsResponse[] | undefined>;
    /**
     ...
     */
    public readonly metrics!: pulumi.Output<outputs.monitor.v20210501preview.MetricSettingsResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20210501preview:DiagnosticSetting" }, { type: "azure-native:insights:DiagnosticSetting" }, { type: "azure-native:monitor/v20170501preview:DiagnosticSetting" }, { type: "azure-native:monitor:DiagnosticSetting" }] };
...
export interface DiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<inputs.monitor.v20210501preview.LogSettingsArgs>[]>;
    /**
     * The full ARM resource ID of the Marketplace resource to which you would like to send Diagnostic Logs.
     */
     ...
     * The list of metric settings.
     */
    metrics?: pulumi.Input<pulumi.Input<inputs.monitor.v20210501preview.MetricSettingsArgs>[]>;
    /**
