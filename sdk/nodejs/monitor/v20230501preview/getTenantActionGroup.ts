...
export function getTenantActionGroup(args: GetTenantActionGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetTenantActionGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:monitor/v20230501preview:getTenantActionGroup", {
...
export interface GetTenantActionGroupResult {
     ...
     */
    readonly azureAppPushReceivers?: outputs.monitor.v20230501preview.AzureAppPushReceiverResponse[];
    /**
     * The list of email receivers that are part of this tenant action group.
     */
    readonly emailReceivers?: outputs.monitor.v20230501preview.EmailReceiverResponse[];
    /**
     ...
     */
    readonly smsReceivers?: outputs.monitor.v20230501preview.SmsReceiverResponse[];
    /**
     * Resource tags
     */
     ...
     */
    readonly voiceReceivers?: outputs.monitor.v20230501preview.VoiceReceiverResponse[];
    /**
     * The list of webhook receivers that are part of this tenant action group.
     */
    readonly webhookReceivers?: outputs.monitor.v20230501preview.WebhookReceiverResponse[];
}
/**
 * Get a tenant action group.
 */
export function getTenantActionGroupOutput(args: GetTenantActionGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTenantActionGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:monitor/v20230501preview:getTenantActionGroup", {
        "managementGroupId": args.managementGroupId,
        "tenantActionGroupName": args.tenantActionGroupName,
    }, opts);
}
