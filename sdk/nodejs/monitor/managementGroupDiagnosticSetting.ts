...
export class ManagementGroupDiagnosticSetting extends pulumi.CustomResource {
     ...
     */
    declare public readonly logs: pulumi.Output<outputs.monitor.ManagementGroupLogSettingsResponse[] | undefined>;
    /**
...
export interface ManagementGroupDiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<inputs.monitor.ManagementGroupLogSettingsArgs>[] | undefined>;
    /**
