...
// Export enums:
export * from "../../types/enums/monitor/v20230601preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:monitor/v20230601preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:monitor/v20230601preview:PrivateLinkScope":
                return new PrivateLinkScope(name, <any>undefined, { urn })
            case "azure-native:monitor/v20230601preview:PrivateLinkScopedResource":
...
pulumi.runtime.registerResourceModule("azure-native", "monitor/v20230601preview", _module)
