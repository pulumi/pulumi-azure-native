...
export class SubscriptionDiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20170501preview:SubscriptionDiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<outputs.monitor.v20170501preview.SubscriptionLogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, args?: SubscriptionDiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20170501preview:SubscriptionDiagnosticSetting" }, { type: "azure-native:insights/v20210501preview:SubscriptionDiagnosticSetting" }, { type: "azure-native:insights:SubscriptionDiagnosticSetting" }, { type: "azure-native:monitor/v20210501preview:SubscriptionDiagnosticSetting" }, { type: "azure-native:monitor:SubscriptionDiagnosticSetting" }] };
...
export interface SubscriptionDiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<inputs.monitor.v20170501preview.SubscriptionLogSettingsArgs>[]>;
    /**
