...
export class Dataflow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperations/v20241101:Dataflow';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.iotoperations.v20241101.DataflowPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DataflowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.iotoperations.v20241101.dataflowPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperations/v20240701preview:DataFlow" }, { type: "azure-native:iotoperations/v20240701preview:Dataflow" }, { type: "azure-native:iotoperations/v20240815preview:Dataflow" }, { type: "azure-native:iotoperations/v20240915preview:Dataflow" }, { type: "azure-native:iotoperations:DataFlow" }, { type: "azure-native:iotoperations:Dataflow" }] };
...
export interface DataflowArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.iotoperations.v20241101.DataflowPropertiesArgs>;
    /**
