...
export class Dataflow extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataflowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperations:Dataflow" }, { type: "azure-native:iotoperations/v20240701preview:Dataflow" }, { type: "azure-native:iotoperations/v20240815preview:Dataflow" }] };
