...
export class DataflowProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperations/v20250401:DataflowProfile';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.iotoperations.v20250401.DataflowProfilePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DataflowProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.iotoperations.v20250401.dataflowProfilePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface DataflowProfileArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.iotoperations.v20250401.DataflowProfilePropertiesArgs>;
    /**
