...
export class BrokerAuthorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperations/v20250401:BrokerAuthorization';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.iotoperations.v20250401.BrokerAuthorizationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BrokerAuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.iotoperations.v20250401.brokerAuthorizationPropertiesArgsProvideDefaults) : undefined) : undefined;
