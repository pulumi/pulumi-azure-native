...
export class BrokerListener extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperations/v20250401:BrokerListener';
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.iotoperations.v20250401.ExtendedLocationResponse>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.iotoperations.v20250401.BrokerListenerPropertiesResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.iotoperations.v20250401.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: BrokerListenerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.iotoperations.v20250401.brokerListenerPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperations/v20240701preview:BrokerListener" }, { type: "azure-native:iotoperations/v20240815preview:BrokerListener" }, { type: "azure-native:iotoperations/v20240915preview:BrokerListener" }, { type: "azure-native:iotoperations/v20241101:BrokerListener" }, { type: "azure-native:iotoperations:BrokerListener" }] };
...
export interface BrokerListenerArgs {
     ...
     * Edge location of the resource.
     */
    extendedLocation: pulumi.Input<inputs.iotoperations.v20250401.ExtendedLocationArgs>;
    /**
     * Name of instance.
     */
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.iotoperations.v20250401.BrokerListenerPropertiesArgs>;
    /**
