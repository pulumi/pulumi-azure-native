...
export function getDataflowProfile(args: GetDataflowProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetDataflowProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:iotoperations/v20250401:getDataflowProfile", {
...
export interface GetDataflowProfileResult {
     ...
     */
    readonly extendedLocation: outputs.iotoperations.v20250401.ExtendedLocationResponse;
    /**
     ...
     */
    readonly properties: outputs.iotoperations.v20250401.DataflowProfilePropertiesResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.iotoperations.v20250401.SystemDataResponse;
    /**
...
export function getDataflowProfileOutput(args: GetDataflowProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataflowProfileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:iotoperations/v20250401:getDataflowProfile", {
        "dataflowProfileName": args.dataflowProfileName,
        "instanceName": args.instanceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
