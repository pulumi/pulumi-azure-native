...
export class DataflowEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataflowEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.dataflowEndpointName === undefined && !opts.urn) {
                throw new Error("Missing required property 'dataflowEndpointName'");
            }
            ...
            resourceInputs["properties"] = args ? pulumi.output(args.properties).apply(v => v === undefined ? undefined : inputs.iotoperations.dataflowEndpointPropertiesArgsProvideDefaults(v)) : undefined;
...
export interface DataflowEndpointArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.iotoperations.DataflowEndpointPropertiesArgs | undefined>;
    /**
