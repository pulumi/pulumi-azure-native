...
export class DataflowEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataflowEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperations:DataflowEndpoint" }, { type: "azure-native:iotoperations/v20240701preview:DataflowEndpoint" }, { type: "azure-native:iotoperations/v20240915preview:DataflowEndpoint" }] };
