...
export function getBrokerListener(args: GetBrokerListenerArgs, opts?: pulumi.InvokeOptions): Promise<GetBrokerListenerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:iotoperations/v20240815preview:getBrokerListener", {
...
export interface GetBrokerListenerResult {
     ...
     */
    readonly extendedLocation: outputs.iotoperations.v20240815preview.ExtendedLocationResponse;
    /**
     ...
     */
    readonly properties: outputs.iotoperations.v20240815preview.BrokerListenerPropertiesResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.iotoperations.v20240815preview.SystemDataResponse;
    /**
...
export function getBrokerListenerOutput(args: GetBrokerListenerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBrokerListenerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:iotoperations/v20240815preview:getBrokerListener", {
        "brokerName": args.brokerName,
        "instanceName": args.instanceName,
        "listenerName": args.listenerName,
        "resourceGroupName": args.resourceGroupName,
