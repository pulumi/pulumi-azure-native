...
export class BrokerAuthentication extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BrokerAuthenticationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperations:BrokerAuthentication" }, { type: "azure-native:iotoperations/v20240701preview:BrokerAuthentication" }, { type: "azure-native:iotoperations/v20240915preview:BrokerAuthentication" }, { type: "azure-native:iotoperations/v20241101:BrokerAuthentication" }] };
