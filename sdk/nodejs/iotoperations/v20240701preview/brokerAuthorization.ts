...
export class BrokerAuthorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperations/v20240701preview:BrokerAuthorization';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.iotoperations.v20240701preview.BrokerAuthorizationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BrokerAuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.iotoperations.v20240701preview.brokerAuthorizationPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperations:BrokerAuthorization" }, { type: "azure-native:iotoperations/v20240815preview:BrokerAuthorization" }, { type: "azure-native:iotoperations/v20240915preview:BrokerAuthorization" }, { type: "azure-native:iotoperations/v20241101:BrokerAuthorization" }] };
