...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridcompute/v20200815preview:PrivateLinkScope';
    ...
    constructor(name: string, argsOrState?: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridcompute/preview:PrivateLinkScope" }] };
