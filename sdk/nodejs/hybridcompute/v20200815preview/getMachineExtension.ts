...
export function getMachineExtension(args: GetMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:hybridcompute/v20200815preview:getMachineExtension", {
...
export interface GetMachineExtensionResult {
     ...
     */
    readonly instanceView?: outputs.hybridcompute.v20200815preview.MachineExtensionPropertiesInvokeResponseInstanceView;
    /**
