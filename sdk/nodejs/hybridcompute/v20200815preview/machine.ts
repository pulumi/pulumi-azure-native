 ...
 *
 * @deprecated Version 2020-08-15-preview will be removed in v2 of the provider.
 */
export class Machine extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Machine {
        pulumi.log.warn("Machine is deprecated: Version 2020-08-15-preview will be removed in v2 of the provider.")
