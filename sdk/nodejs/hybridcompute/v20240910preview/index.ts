...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:hybridcompute/v20240910preview:Gateway":
                return new Gateway(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20240910preview:License":
                return new License(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20240910preview:LicenseProfile":
                return new LicenseProfile(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20240910preview:Machine":
                return new Machine(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20240910preview:MachineExtension":
                return new MachineExtension(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20240910preview:MachineRunCommand":
                return new MachineRunCommand(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20240910preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20240910preview:PrivateLinkScope":
...
pulumi.runtime.registerResourceModule("azure-native", "hybridcompute/v20240910preview", _module)
