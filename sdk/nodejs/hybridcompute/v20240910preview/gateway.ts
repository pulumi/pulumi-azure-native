...
export class Gateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20240910preview:Gateway';
    ...
    constructor(name: string, args: GatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:Gateway" }, { type: "azure-native:hybridcompute/v20240331preview:Gateway" }, { type: "azure-native:hybridcompute/v20240520preview:Gateway" }, { type: "azure-native:hybridcompute/v20240731preview:Gateway" }] };
...
export interface GatewayArgs {
     ...
     * The type of the Gateway resource.
     */
    gatewayType?: pulumi.Input<string | enums.hybridcompute.v20240910preview.GatewayType>;
    /**
     * The geo-location where the resource lives
     */
