...
export class Machine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridcompute/v20190802preview:Machine';
     ...
     */
    public /*out*/ readonly osProfile!: pulumi.Output<outputs.hybridcompute.v20190802preview.OSProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridcompute/latest:Machine" }, { type: "azurerm:hybridcompute/preview:Machine" }, { type: "azurerm:hybridcompute/v20190318preview:Machine" }, { type: "azurerm:hybridcompute/v20191212:Machine" }, { type: "azurerm:hybridcompute/v20200730preview:Machine" }, { type: "azurerm:hybridcompute/v20200802:Machine" }, { type: "azurerm:hybridcompute/v20200815preview:Machine" }] };
