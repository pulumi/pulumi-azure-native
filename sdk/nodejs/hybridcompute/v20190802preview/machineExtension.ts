...
export class MachineExtension extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MachineExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridcompute/latest:MachineExtension" }, { type: "azurerm:hybridcompute/preview:MachineExtension" }, { type: "azurerm:hybridcompute/v20191212:MachineExtension" }, { type: "azurerm:hybridcompute/v20200730preview:MachineExtension" }, { type: "azurerm:hybridcompute/v20200802:MachineExtension" }, { type: "azurerm:hybridcompute/v20200815preview:MachineExtension" }] };
