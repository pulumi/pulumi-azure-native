...
export class MachineExtension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MachineExtension {
        pulumi.log.warn("MachineExtension is deprecated: Version v20190802preview will be removed in the next major version of the provider. Upgrade to version v20200802 or later.")
