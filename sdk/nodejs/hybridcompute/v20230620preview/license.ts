...
export class License extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:License" }, { type: "azure-native:hybridcompute/v20231003preview:License" }, { type: "azure-native:hybridcompute/v20240331preview:License" }] };
