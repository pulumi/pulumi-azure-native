...
export class LicenseProfile extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly esuKeys!: pulumi.Output<outputs.hybridcompute.v20230620preview.EsuKeyResponse[]>;
    /**
    ...
    constructor(name: string, args: LicenseProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:LicenseProfile" }, { type: "azure-native:hybridcompute/v20231003preview:LicenseProfile" }, { type: "azure-native:hybridcompute/v20240331preview:LicenseProfile" }, { type: "azure-native:hybridcompute/v20240520preview:LicenseProfile" }, { type: "azure-native:hybridcompute/v20240710:LicenseProfile" }] };
