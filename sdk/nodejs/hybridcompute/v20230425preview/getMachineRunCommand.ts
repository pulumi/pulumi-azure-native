...
export function getMachineRunCommand(args: GetMachineRunCommandArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineRunCommandResult> {
    ...
    return pulumi.runtime.invoke("azure-native:hybridcompute/v20230425preview:getMachineRunCommand", {
...
export interface GetMachineRunCommandResult {
     ...
     */
    readonly errorBlobManagedIdentity?: outputs.hybridcompute.v20230425preview.RunCommandManagedIdentityResponse;
    /**
     ...
     */
    readonly instanceView: outputs.hybridcompute.v20230425preview.MachineRunCommandInstanceViewResponse;
    /**
     ...
     */
    readonly outputBlobManagedIdentity?: outputs.hybridcompute.v20230425preview.RunCommandManagedIdentityResponse;
    /**
     ...
     */
    readonly parameters?: outputs.hybridcompute.v20230425preview.RunCommandInputParameterResponse[];
    /**
     * The parameters used by the script.
     */
    readonly protectedParameters?: outputs.hybridcompute.v20230425preview.RunCommandInputParameterResponse[];
    /**
