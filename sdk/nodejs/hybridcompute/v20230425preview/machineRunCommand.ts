...
export class MachineRunCommand extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20230425preview:MachineRunCommand';
     ...
     */
    public readonly errorBlobManagedIdentity!: pulumi.Output<outputs.hybridcompute.v20230425preview.RunCommandManagedIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.hybridcompute.v20230425preview.MachineRunCommandInstanceViewResponse>;
    /**
     ...
     */
    public readonly outputBlobManagedIdentity!: pulumi.Output<outputs.hybridcompute.v20230425preview.RunCommandManagedIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.hybridcompute.v20230425preview.RunCommandInputParameterResponse[] | undefined>;
    /**
     * The parameters used by the script.
     */
    public readonly protectedParameters!: pulumi.Output<outputs.hybridcompute.v20230425preview.RunCommandInputParameterResponse[] | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.hybridcompute.v20230425preview.MachineRunCommandScriptSourceResponse | undefined>;
    /**
...
export interface MachineRunCommandArgs {
     ...
     * User-assigned managed identity that has access to errorBlobUri storage blob. Use an empty object in case of system-assigned identity. Make sure managed identity has been given access to blob's container with 'Storage Blob Data Contributor' role assignment. In case of user-assigned identity, make sure you add it under VM's identity. For more info on managed identity and Run Command, refer https://aka.ms/ManagedIdentity and https://aka.ms/RunCommandManaged 
     */
    errorBlobManagedIdentity?: pulumi.Input<inputs.hybridcompute.v20230425preview.RunCommandManagedIdentityArgs>;
    /**
     * Specifies the Azure storage blob where script error stream will be uploaded. Use a SAS URI with read, append, create, write access OR use managed identity to provide the VM access to the blob. Refer errorBlobManagedIdentity parameter.
     */
     ...
     * User-assigned managed identity that has access to outputBlobUri storage blob. Use an empty object in case of system-assigned identity. Make sure managed identity has been given access to blob's container with 'Storage Blob Data Contributor' role assignment. In case of user-assigned identity, make sure you add it under VM's identity. For more info on managed identity and Run Command, refer https://aka.ms/ManagedIdentity and https://aka.ms/RunCommandManaged 
     */
    outputBlobManagedIdentity?: pulumi.Input<inputs.hybridcompute.v20230425preview.RunCommandManagedIdentityArgs>;
    /**
     * Specifies the Azure storage blob where script output stream will be uploaded. Use a SAS URI with read, append, create, write access OR use managed identity to provide the VM access to the blob. Refer outputBlobManagedIdentity parameter. 
     */
     ...
     * The parameters used by the script.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.hybridcompute.v20230425preview.RunCommandInputParameterArgs>[]>;
    /**
     * The parameters used by the script.
     */
    protectedParameters?: pulumi.Input<pulumi.Input<inputs.hybridcompute.v20230425preview.RunCommandInputParameterArgs>[]>;
    /**
     ...
     * The source of the run command script.
     */
    source?: pulumi.Input<inputs.hybridcompute.v20230425preview.MachineRunCommandScriptSourceArgs>;
    /**
     * Resource tags.
     */
