...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20230425preview:PrivateLinkScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridcompute.v20230425preview.HybridComputePrivateLinkScopePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20200815preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20210325preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20220510preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20221227:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20221227preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20230315preview:PrivateLinkScope" }] };
...
export interface PrivateLinkScopeArgs {
     ...
     * Properties that define a Azure Arc PrivateLinkScope resource.
     */
    properties?: pulumi.Input<inputs.hybridcompute.v20230425preview.HybridComputePrivateLinkScopePropertiesArgs>;
    /**
