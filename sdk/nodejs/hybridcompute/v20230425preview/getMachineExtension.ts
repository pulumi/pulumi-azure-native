...
export function getMachineExtension(args: GetMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:hybridcompute/v20230425preview:getMachineExtension", {
...
export interface GetMachineExtensionResult {
     ...
     */
    readonly instanceView?: outputs.hybridcompute.v20230425preview.MachineExtensionInstanceViewResponse;
    /**
