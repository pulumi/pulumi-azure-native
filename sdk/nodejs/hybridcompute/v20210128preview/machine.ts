 ...
 *
 * @deprecated azure-native:hybridcompute/v20210128preview:Machine is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20220510preview:Machine to guarantee forwards compatibility.
 */
export class Machine extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Machine {
        pulumi.log.warn("Machine is deprecated: azure-native:hybridcompute/v20210128preview:Machine is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20220510preview:Machine to guarantee forwards compatibility.")
        return new Machine(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20210128preview:Machine';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.hybridcompute.v20210128preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridcompute.v20210128preview.MachinePropertiesResponse>;
    /**
...
export interface MachineArgs {
     ...
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.hybridcompute.v20210128preview.IdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Hybrid Compute Machine properties
     */
    properties?: pulumi.Input<inputs.hybridcompute.v20210128preview.MachinePropertiesArgs>;
    /**
