...
export class MachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20221227preview:MachineExtension';
     ...
     */
    public readonly instanceView!: pulumi.Output<outputs.hybridcompute.v20221227preview.MachineExtensionInstanceViewResponse | undefined>;
    /**
    ...
    constructor(name: string, args: MachineExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:MachineExtension" }, { type: "azure-native:hybridcompute/v20190802preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20191212:MachineExtension" }, { type: "azure-native:hybridcompute/v20200730preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20200802:MachineExtension" }, { type: "azure-native:hybridcompute/v20200815preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20210128preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20210325preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20210422preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20210517preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20210520:MachineExtension" }, { type: "azure-native:hybridcompute/v20210610preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20211210preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20220310:MachineExtension" }, { type: "azure-native:hybridcompute/v20220510preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20220811preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20221110:MachineExtension" }, { type: "azure-native:hybridcompute/v20221227:MachineExtension" }, { type: "azure-native:hybridcompute/v20230315preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20230620preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20231003preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20240331preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20240520preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20240710:MachineExtension" }, { type: "azure-native:hybridcompute/v20240731preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20240910preview:MachineExtension" }, { type: "azure-native:hybridcompute/v20241110preview:MachineExtension" }] };
...
export interface MachineExtensionArgs {
     ...
     * The machine extension instance view.
     */
    instanceView?: pulumi.Input<inputs.hybridcompute.v20221227preview.MachineExtensionInstanceViewArgs>;
    /**
     * The geo-location where the resource lives
     */
