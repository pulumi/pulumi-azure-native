...
export class MachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridcompute/v20200730preview:MachineExtension';
