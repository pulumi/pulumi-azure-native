...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20221110:PrivateLinkScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridcompute.v20221110.HybridComputePrivateLinkScopePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20200815preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20210128preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20210325preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20210422preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20210517preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20210520:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20210610preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20211210preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20220310:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20220510preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20220811preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20221227:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20221227preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20230315preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20230620preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20231003preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20240331preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20240520preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20240710:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20240731preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20240910preview:PrivateLinkScope" }, { type: "azure-native:hybridcompute/v20241110preview:PrivateLinkScope" }] };
...
export interface PrivateLinkScopeArgs {
     ...
     * Properties that define a Azure Arc PrivateLinkScope resource.
     */
    properties?: pulumi.Input<inputs.hybridcompute.v20221110.HybridComputePrivateLinkScopePropertiesArgs>;
    /**
