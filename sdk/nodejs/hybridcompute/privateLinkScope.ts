...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:hybridcompute:PrivateLinkScope';
    ...
    constructor(name: string, args: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybridcompute/v20200815preview:PrivateLinkScope" }] };
