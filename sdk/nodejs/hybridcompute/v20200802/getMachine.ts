 ...
 */
/** @deprecated Version 2020-08-02 will be removed in v2 of the provider. */
export function getMachine(args: GetMachineArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineResult> {
    pulumi.log.warn("getMachine is deprecated: Version 2020-08-02 will be removed in v2 of the provider.")
