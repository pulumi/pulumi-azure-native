...
// Export enums:
export * from "../../types/enums/hybridcompute/v20250113";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:hybridcompute/v20250113:Gateway":
                return new Gateway(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20250113:License":
                return new License(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20250113:LicenseProfile":
                return new LicenseProfile(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20250113:Machine":
                return new Machine(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20250113:MachineExtension":
                return new MachineExtension(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20250113:MachineRunCommand":
                return new MachineRunCommand(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20250113:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:hybridcompute/v20250113:PrivateLinkScope":
...
pulumi.runtime.registerResourceModule("azure-native", "hybridcompute/v20250113", _module)
