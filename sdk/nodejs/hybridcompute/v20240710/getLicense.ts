...
export function getLicense(args: GetLicenseArgs, opts?: pulumi.InvokeOptions): Promise<GetLicenseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:hybridcompute/v20240710:getLicense", {
...
export interface GetLicenseResult {
     ...
     */
    readonly licenseDetails?: outputs.hybridcompute.v20240710.LicenseDetailsResponse;
    /**
     ...
     */
    readonly systemData: outputs.hybridcompute.v20240710.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getLicenseOutput(args: GetLicenseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLicenseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:hybridcompute/v20240710:getLicense", {
        "licenseName": args.licenseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
