...
export class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:hybridcompute/latest:GuestConfigurationHCRPAssignment';
    ...
    constructor(name: string, args: GuestConfigurationHCRPAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hybridcompute/v20181120:GuestConfigurationHCRPAssignment" }, { type: "azure-nextgen:hybridcompute/v20200625:GuestConfigurationHCRPAssignment" }] };
