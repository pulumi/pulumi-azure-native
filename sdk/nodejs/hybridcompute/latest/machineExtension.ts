...
export class MachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridcompute/latest:MachineExtension';
    ...
    constructor(name: string, argsOrState?: MachineExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridcompute/v20191212:MachineExtension" }, { type: "azurerm:hybridcompute/v20200802:MachineExtension" }] };
