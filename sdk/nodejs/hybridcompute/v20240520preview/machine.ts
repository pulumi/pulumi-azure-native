...
export class Machine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20240520preview:Machine';
     ...
     */
    public /*out*/ readonly agentConfiguration!: pulumi.Output<outputs.hybridcompute.v20240520preview.AgentConfigurationResponse>;
    /**
     * The info of the machine w.r.t Agent Upgrade
     */
    public readonly agentUpgrade!: pulumi.Output<outputs.hybridcompute.v20240520preview.AgentUpgradeResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly cloudMetadata!: pulumi.Output<outputs.hybridcompute.v20240520preview.CloudMetadataResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly errorDetails!: pulumi.Output<outputs.hybridcompute.v20240520preview.ErrorDetailResponse[]>;
    /**
     * Machine Extensions information (deprecated field)
     */
    public readonly extensions!: pulumi.Output<outputs.hybridcompute.v20240520preview.MachineExtensionInstanceViewResponse[] | undefined>;
    /**
     * Identity for the resource.
     */
    public readonly identity!: pulumi.Output<outputs.hybridcompute.v20240520preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly licenseProfile!: pulumi.Output<outputs.hybridcompute.v20240520preview.LicenseProfileMachineInstanceViewResponse | undefined>;
    /**
     ...
     */
    public readonly locationData!: pulumi.Output<outputs.hybridcompute.v20240520preview.LocationDataResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly networkProfile!: pulumi.Output<outputs.hybridcompute.v20240520preview.NetworkProfileResponse>;
    /**
     ...
     */
    public readonly osProfile!: pulumi.Output<outputs.hybridcompute.v20240520preview.OSProfileResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly resources!: pulumi.Output<outputs.hybridcompute.v20240520preview.MachineExtensionResponse[]>;
    /**
     * Statuses of dependent services that are reported back to ARM.
     */
    public readonly serviceStatuses!: pulumi.Output<outputs.hybridcompute.v20240520preview.ServiceStatusesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: MachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:Machine" }, { type: "azure-native:hybridcompute/v20190318preview:Machine" }, { type: "azure-native:hybridcompute/v20190802preview:Machine" }, { type: "azure-native:hybridcompute/v20191212:Machine" }, { type: "azure-native:hybridcompute/v20200730preview:Machine" }, { type: "azure-native:hybridcompute/v20200802:Machine" }, { type: "azure-native:hybridcompute/v20200815preview:Machine" }, { type: "azure-native:hybridcompute/v20210128preview:Machine" }, { type: "azure-native:hybridcompute/v20210325preview:Machine" }, { type: "azure-native:hybridcompute/v20210422preview:Machine" }, { type: "azure-native:hybridcompute/v20210517preview:Machine" }, { type: "azure-native:hybridcompute/v20210520:Machine" }, { type: "azure-native:hybridcompute/v20210610preview:Machine" }, { type: "azure-native:hybridcompute/v20211210preview:Machine" }, { type: "azure-native:hybridcompute/v20220310:Machine" }, { type: "azure-native:hybridcompute/v20220510preview:Machine" }, { type: "azure-native:hybridcompute/v20220811preview:Machine" }, { type: "azure-native:hybridcompute/v20221110:Machine" }, { type: "azure-native:hybridcompute/v20221227:Machine" }, { type: "azure-native:hybridcompute/v20221227preview:Machine" }, { type: "azure-native:hybridcompute/v20230315preview:Machine" }, { type: "azure-native:hybridcompute/v20230620preview:Machine" }, { type: "azure-native:hybridcompute/v20231003preview:Machine" }, { type: "azure-native:hybridcompute/v20240331preview:Machine" }, { type: "azure-native:hybridcompute/v20240710:Machine" }, { type: "azure-native:hybridcompute/v20240731preview:Machine" }, { type: "azure-native:hybridcompute/v20240910preview:Machine" }, { type: "azure-native:hybridcompute/v20241110preview:Machine" }] };
...
export interface MachineArgs {
     ...
     * The info of the machine w.r.t Agent Upgrade
     */
    agentUpgrade?: pulumi.Input<inputs.hybridcompute.v20240520preview.AgentUpgradeArgs>;
    /**
     * Public Key that the client provides to be used during initial resource onboarding
     */
     ...
     * Machine Extensions information (deprecated field)
     */
    extensions?: pulumi.Input<pulumi.Input<inputs.hybridcompute.v20240520preview.MachineExtensionInstanceViewArgs>[]>;
    /**
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.hybridcompute.v20240520preview.IdentityArgs>;
    /**
     * Indicates which kind of Arc machine placement on-premises, such as HCI, SCVMM or VMware etc.
     */
    kind?: pulumi.Input<string | enums.hybridcompute.v20240520preview.ArcKindEnum>;
    /**
     * Specifies the License related properties for a machine.
     */
    licenseProfile?: pulumi.Input<inputs.hybridcompute.v20240520preview.LicenseProfileMachineInstanceViewArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Metadata pertaining to the geographic location of the resource.
     */
    locationData?: pulumi.Input<inputs.hybridcompute.v20240520preview.LocationDataArgs>;
    /**
     ...
     * Specifies the operating system settings for the hybrid machine.
     */
    osProfile?: pulumi.Input<inputs.hybridcompute.v20240520preview.OSProfileArgs>;
    /**
     * The type of Operating System (windows/linux).
     */
     ...
     * Statuses of dependent services that are reported back to ARM.
     */
    serviceStatuses?: pulumi.Input<inputs.hybridcompute.v20240520preview.ServiceStatusesArgs>;
    /**
     * Resource tags.
     */
