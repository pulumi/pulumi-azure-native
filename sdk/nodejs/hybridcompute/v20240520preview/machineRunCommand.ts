...
export class MachineRunCommand extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MachineRunCommandArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:MachineRunCommand" }, { type: "azure-native:hybridcompute/v20231003preview:MachineRunCommand" }, { type: "azure-native:hybridcompute/v20240331preview:MachineRunCommand" }] };
