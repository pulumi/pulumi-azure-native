...
export class PrivateLinkScopedResource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateLinkScopedResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute/v20200815preview:PrivateLinkScopedResource" }, { type: "azure-native_hybridcompute_v20200815preview:hybridcompute:PrivateLinkScopedResource" }] };
