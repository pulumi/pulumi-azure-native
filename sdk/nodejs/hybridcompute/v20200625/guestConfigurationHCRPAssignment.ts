...
export class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridcompute/v20200625:GuestConfigurationHCRPAssignment';
    ...
    constructor(name: string, argsOrState?: GuestConfigurationHCRPAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridcompute/latest:GuestConfigurationHCRPAssignment" }, { type: "azurerm:hybridcompute/preview:GuestConfigurationHCRPAssignment" }, { type: "azurerm:hybridcompute/v20181120:GuestConfigurationHCRPAssignment" }] };
