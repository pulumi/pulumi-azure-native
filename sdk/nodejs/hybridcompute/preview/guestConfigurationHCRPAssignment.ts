...
export class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridcompute/preview:GuestConfigurationHCRPAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridcompute.preview.GuestConfigurationAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: GuestConfigurationHCRPAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridcompute/latest:GuestConfigurationHCRPAssignment" }, { type: "azurerm:hybridcompute/v20181120:GuestConfigurationHCRPAssignment" }, { type: "azurerm:hybridcompute/v20200625:GuestConfigurationHCRPAssignment" }] };
...
export interface GuestConfigurationHCRPAssignmentArgs {
     ...
     * Properties of the Guest configuration assignment.
     */
    readonly properties?: pulumi.Input<inputs.hybridcompute.preview.GuestConfigurationAssignmentProperties>;
    /**
