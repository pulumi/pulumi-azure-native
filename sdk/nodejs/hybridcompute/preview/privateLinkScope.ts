...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hybridcompute/preview:PrivateLinkScope';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.hybridcompute.preview.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: PrivateLinkScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridcompute/v20200815preview:PrivateLinkScope" }] };
