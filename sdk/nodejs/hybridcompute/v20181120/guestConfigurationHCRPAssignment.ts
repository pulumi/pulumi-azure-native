...
export class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: GuestConfigurationHCRPAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hybridcompute/latest:GuestConfigurationHCRPAssignment" }, { type: "azurerm:hybridcompute/preview:GuestConfigurationHCRPAssignment" }, { type: "azurerm:hybridcompute/v20200625:GuestConfigurationHCRPAssignment" }] };
