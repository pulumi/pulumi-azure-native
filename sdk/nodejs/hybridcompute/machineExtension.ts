...
export class MachineExtension extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MachineExtensionState, opts?: pulumi.CustomResourceOptions): MachineExtension {
        return new MachineExtension(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: MachineExtensionArgs | MachineExtensionState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as MachineExtensionState | undefined;
 ...
 * Describes a Machine Extension.
 */
export interface MachineExtensionState {
    /**
     * The geo-location where the resource lives
     */
