...
export class ManufacturingDataService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:manufacturingplatform/v20250301:ManufacturingDataService';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.manufacturingplatform.v20250301.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.manufacturingplatform.v20250301.MdsResourcePropertiesResponse>;
    /**
     * The SKU (Stock Keeping Unit) assigned to this resource.
     */
    public readonly sku!: pulumi.Output<outputs.manufacturingplatform.v20250301.SkuResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.manufacturingplatform.v20250301.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ManufacturingDataServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.manufacturingplatform.v20250301.mdsResourcePropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:manufacturingplatform:ManufacturingDataService" }] };
...
export interface ManufacturingDataServiceArgs {
     ...
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.manufacturingplatform.v20250301.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.manufacturingplatform.v20250301.MdsResourcePropertiesArgs>;
    /**
     ...
     * The SKU (Stock Keeping Unit) assigned to this resource.
     */
    sku?: pulumi.Input<inputs.manufacturingplatform.v20250301.SkuArgs>;
    /**
     * Resource tags.
     */
