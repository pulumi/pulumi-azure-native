...
export function getManufacturingDataService(args: GetManufacturingDataServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetManufacturingDataServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:manufacturingplatform/v20250301:getManufacturingDataService", {
...
export interface GetManufacturingDataServiceResult {
     ...
     */
    readonly identity?: outputs.manufacturingplatform.v20250301.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.manufacturingplatform.v20250301.MdsResourcePropertiesResponse;
    /**
     * The SKU (Stock Keeping Unit) assigned to this resource.
     */
    readonly sku?: outputs.manufacturingplatform.v20250301.SkuResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.manufacturingplatform.v20250301.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getManufacturingDataServiceOutput(args: GetManufacturingDataServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManufacturingDataServiceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:manufacturingplatform/v20250301:getManufacturingDataService", {
        "mdsResourceName": args.mdsResourceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
