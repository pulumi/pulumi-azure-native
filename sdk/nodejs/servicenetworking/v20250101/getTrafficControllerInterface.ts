...
export function getTrafficControllerInterface(args: GetTrafficControllerInterfaceArgs, opts?: pulumi.InvokeOptions): Promise<GetTrafficControllerInterfaceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicenetworking/v20250101:getTrafficControllerInterface", {
...
export interface GetTrafficControllerInterfaceResult {
     ...
     */
    readonly associations: outputs.servicenetworking.v20250101.ResourceIdResponse[];
    /**
     ...
     */
    readonly frontends: outputs.servicenetworking.v20250101.ResourceIdResponse[];
    /**
     ...
     */
    readonly securityPolicies: outputs.servicenetworking.v20250101.ResourceIdResponse[];
    /**
     * Security Policy Configuration
     */
    readonly securityPolicyConfigurations?: outputs.servicenetworking.v20250101.SecurityPolicyConfigurationsResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.servicenetworking.v20250101.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getTrafficControllerInterfaceOutput(args: GetTrafficControllerInterfaceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTrafficControllerInterfaceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:servicenetworking/v20250101:getTrafficControllerInterface", {
        "resourceGroupName": args.resourceGroupName,
        "trafficControllerName": args.trafficControllerName,
    }, opts);
}
