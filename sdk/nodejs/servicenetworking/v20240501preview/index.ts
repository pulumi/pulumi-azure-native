...
// Export enums:
export * from "../../types/enums/servicenetworking/v20240501preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:servicenetworking/v20240501preview:AssociationsInterface":
                return new AssociationsInterface(name, <any>undefined, { urn })
            case "azure-native:servicenetworking/v20240501preview:FrontendsInterface":
            ...
            case "azure-native:servicenetworking/v20240501preview:TrafficControllerInterface":
