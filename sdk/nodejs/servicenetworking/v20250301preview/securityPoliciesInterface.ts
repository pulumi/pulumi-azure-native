...
export class SecurityPoliciesInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicenetworking/v20250301preview:SecurityPoliciesInterface';
     ...
     */
    public readonly ipAccessRulesPolicy!: pulumi.Output<outputs.servicenetworking.v20250301preview.IpAccessRulesPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly wafPolicy!: pulumi.Output<outputs.servicenetworking.v20250301preview.WafPolicyResponse | undefined>;
    ...
    constructor(name: string, args: SecurityPoliciesInterfaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["ipAccessRulesPolicy"] = args ? args.ipAccessRulesPolicy : undefined;
            ...
            resourceInputs["ipAccessRulesPolicy"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicenetworking/v20240501preview:SecurityPoliciesInterface" }, { type: "azure-native:servicenetworking/v20250101:SecurityPoliciesInterface" }, { type: "azure-native:servicenetworking:SecurityPoliciesInterface" }] };
...
export interface SecurityPoliciesInterfaceArgs {
     ...
     * Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
     */
    ipAccessRulesPolicy?: pulumi.Input<inputs.servicenetworking.v20250301preview.IpAccessRulesPolicyArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Web Application Firewall Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
     */
    wafPolicy?: pulumi.Input<inputs.servicenetworking.v20250301preview.WafPolicyArgs>;
}
