...
export interface GetTrafficControllerInterfaceResult {
     ...
     */
    readonly associations: outputs.servicenetworking.v20230501preview.ResourceIdResponse[];
    /**
     ...
     */
    readonly frontends: outputs.servicenetworking.v20230501preview.ResourceIdResponse[];
    /**
...
export function getTrafficControllerInterfaceOutput(args: GetTrafficControllerInterfaceOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetTrafficControllerInterfaceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:servicenetworking/v20230501preview:getTrafficControllerInterface", {
        "resourceGroupName": args.resourceGroupName,
        "trafficControllerName": args.trafficControllerName,
    }, opts);
}
