...
export interface GetTrafficControllerInterfaceResult {
     ...
     */
    readonly associations: outputs.servicenetworking.v20231101.ResourceIdResponse[];
    /**
     ...
     */
    readonly frontends: outputs.servicenetworking.v20231101.ResourceIdResponse[];
    /**
     ...
     */
    readonly systemData: outputs.servicenetworking.v20231101.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getTrafficControllerInterfaceOutput(args: GetTrafficControllerInterfaceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTrafficControllerInterfaceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:servicenetworking/v20231101:getTrafficControllerInterface", {
        "resourceGroupName": args.resourceGroupName,
        "trafficControllerName": args.trafficControllerName,
    }, opts);
}
