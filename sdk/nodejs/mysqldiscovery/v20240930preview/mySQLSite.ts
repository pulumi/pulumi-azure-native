...
export class MySQLSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mysqldiscovery/v20240930preview:MySQLSite';
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.mysqldiscovery.v20240930preview.ExtendedLocationResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.mysqldiscovery.v20240930preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: MySQLSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mysqldiscovery:MySQLSite" }] };
