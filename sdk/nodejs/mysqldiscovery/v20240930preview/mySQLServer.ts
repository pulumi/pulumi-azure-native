...
export class MySQLServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mysqldiscovery/v20240930preview:MySQLServer';
     ...
     * The list of errors.
     */
    public readonly errors!: pulumi.Output<outputs.mysqldiscovery.v20240930preview.ErrorResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: MySQLServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mysqldiscovery:MySQLServer" }] };
...
export interface MySQLServerArgs {
     ...
     * mysql server edition.
     */
    edition?: pulumi.Input<string | enums.mysqldiscovery.v20240930preview.Edition>;
    /**
     * The list of errors.
     */
    errors?: pulumi.Input<pulumi.Input<inputs.mysqldiscovery.v20240930preview.ErrorArgs>[]>;
    /**
     * The Server IP/host name.
     */
     ...
     * mysql version support status.
     */
    supportStatus?: pulumi.Input<string | enums.mysqldiscovery.v20240930preview.SupportStatus>;
    /**
     * Resource tags
     */
