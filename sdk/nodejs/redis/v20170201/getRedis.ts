...
export function getRedis(args: GetRedisArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisResult> {
    ...
    return pulumi.runtime.invoke("azure-native:redis/v20170201:getRedis", {
        "name": args.name,
...
export interface GetRedisResult {
     ...
     */
    readonly accessKeys: outputs.redis.v20170201.RedisAccessKeysResponse;
    /**
     ...
     */
    readonly linkedServers: outputs.redis.v20170201.RedisLinkedServerListResponse;
    /**
     ...
     */
    readonly sku?: outputs.redis.v20170201.SkuResponse;
    /**
     * Redis SSL port.
     */
...
export function getRedisOutput(args: GetRedisOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRedisResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:redis/v20170201:getRedis", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
