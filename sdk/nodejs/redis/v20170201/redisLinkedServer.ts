...
export class RedisLinkedServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redis/v20170201:RedisLinkedServer';
    ...
    constructor(name: string, args: RedisLinkedServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache/v20230401:LinkedServer" }, { type: "azure-native:cache/v20230501preview:LinkedServer" }, { type: "azure-native:cache/v20230801:LinkedServer" }, { type: "azure-native:cache/v20240301:LinkedServer" }, { type: "azure-native:cache/v20240401preview:LinkedServer" }, { type: "azure-native:cache/v20241101:LinkedServer" }, { type: "azure-native:cache:LinkedServer" }, { type: "azure-native:redis/v20171001:RedisLinkedServer" }, { type: "azure-native:redis/v20180301:RedisLinkedServer" }, { type: "azure-native:redis/v20190701:RedisLinkedServer" }, { type: "azure-native:redis/v20200601:RedisLinkedServer" }, { type: "azure-native:redis/v20201201:RedisLinkedServer" }, { type: "azure-native:redis/v20210601:RedisLinkedServer" }, { type: "azure-native:redis/v20220501:RedisLinkedServer" }, { type: "azure-native:redis/v20220601:RedisLinkedServer" }, { type: "azure-native:redis/v20230401:RedisLinkedServer" }, { type: "azure-native:redis/v20230501preview:RedisLinkedServer" }, { type: "azure-native:redis/v20230801:RedisLinkedServer" }, { type: "azure-native:redis/v20240301:RedisLinkedServer" }, { type: "azure-native:redis/v20240401preview:RedisLinkedServer" }, { type: "azure-native:redis/v20241101:RedisLinkedServer" }, { type: "azure-native:redis:RedisLinkedServer" }] };
...
export interface RedisLinkedServerArgs {
     ...
     * Role of the linked server.
     */
    serverRole: pulumi.Input<enums.redis.v20170201.ReplicationRole>;
}
