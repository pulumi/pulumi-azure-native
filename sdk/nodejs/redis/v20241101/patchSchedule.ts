...
export class PatchSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redis/v20241101:PatchSchedule';
     ...
     */
    public readonly scheduleEntries!: pulumi.Output<outputs.redis.v20241101.ScheduleEntryResponse[]>;
    /**
...
export interface PatchScheduleArgs {
     ...
     * List of patch schedules for a Redis cache.
     */
    scheduleEntries: pulumi.Input<pulumi.Input<inputs.redis.v20241101.ScheduleEntryArgs>[]>;
}
