...
// Export enums:
export * from "../../types/enums/redis/v20241101";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redis/v20241101:AccessPolicy":
                return new AccessPolicy(name, <any>undefined, { urn })
            case "azure-native:redis/v20241101:AccessPolicyAssignment":
                return new AccessPolicyAssignment(name, <any>undefined, { urn })
            case "azure-native:redis/v20241101:FirewallRule":
                return new FirewallRule(name, <any>undefined, { urn })
            case "azure-native:redis/v20241101:LinkedServer":
                return new LinkedServer(name, <any>undefined, { urn })
            case "azure-native:redis/v20241101:PatchSchedule":
                return new PatchSchedule(name, <any>undefined, { urn })
            case "azure-native:redis/v20241101:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:redis/v20241101:Redis":
...
pulumi.runtime.registerResourceModule("azure-native", "redis/v20241101", _module)
