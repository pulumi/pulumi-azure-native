...
export class LinkedServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redis/v20241101:LinkedServer';
    ...
    constructor(name: string, args: LinkedServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache/v20230401:LinkedServer" }, { type: "azure-native:cache/v20230501preview:LinkedServer" }, { type: "azure-native:cache/v20230801:LinkedServer" }, { type: "azure-native:cache/v20240301:LinkedServer" }, { type: "azure-native:cache/v20240401preview:LinkedServer" }, { type: "azure-native:cache/v20241101:LinkedServer" }, { type: "azure-native:cache:LinkedServer" }, { type: "azure-native:redis/v20170201:LinkedServer" }, { type: "azure-native:redis/v20171001:LinkedServer" }, { type: "azure-native:redis/v20180301:LinkedServer" }, { type: "azure-native:redis/v20190701:LinkedServer" }, { type: "azure-native:redis/v20200601:LinkedServer" }, { type: "azure-native:redis/v20201201:LinkedServer" }, { type: "azure-native:redis/v20210601:LinkedServer" }, { type: "azure-native:redis/v20220501:LinkedServer" }, { type: "azure-native:redis/v20220601:LinkedServer" }, { type: "azure-native:redis/v20230401:LinkedServer" }, { type: "azure-native:redis/v20230501preview:LinkedServer" }, { type: "azure-native:redis/v20230801:LinkedServer" }, { type: "azure-native:redis/v20240301:LinkedServer" }, { type: "azure-native:redis/v20240401preview:LinkedServer" }, { type: "azure-native:redis:LinkedServer" }] };
...
export interface LinkedServerArgs {
     ...
     * Role of the linked server.
     */
    serverRole: pulumi.Input<enums.redis.v20241101.ReplicationRole>;
}
