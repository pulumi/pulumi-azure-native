...
export class Redis extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redis/v20150801:Redis';
     ...
     */
    public /*out*/ readonly accessKeys!: pulumi.Output<outputs.redis.v20150801.RedisAccessKeysResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.redis.v20150801.SkuResponse>;
    /**
     * Redis SSL port.
     */
    ...
    constructor(name: string, args: RedisArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache/v20200601:Redis" }, { type: "azure-native:cache/v20230401:Redis" }, { type: "azure-native:cache/v20230501preview:Redis" }, { type: "azure-native:cache/v20230801:Redis" }, { type: "azure-native:cache/v20240301:Redis" }, { type: "azure-native:cache/v20240401preview:Redis" }, { type: "azure-native:cache/v20241101:Redis" }, { type: "azure-native:cache:Redis" }, { type: "azure-native:redis/v20160401:Redis" }, { type: "azure-native:redis/v20170201:Redis" }, { type: "azure-native:redis/v20171001:Redis" }, { type: "azure-native:redis/v20180301:Redis" }, { type: "azure-native:redis/v20190701:Redis" }, { type: "azure-native:redis/v20200601:Redis" }, { type: "azure-native:redis/v20201201:Redis" }, { type: "azure-native:redis/v20210601:Redis" }, { type: "azure-native:redis/v20220501:Redis" }, { type: "azure-native:redis/v20220601:Redis" }, { type: "azure-native:redis/v20230401:Redis" }, { type: "azure-native:redis/v20230501preview:Redis" }, { type: "azure-native:redis/v20230801:Redis" }, { type: "azure-native:redis/v20240301:Redis" }, { type: "azure-native:redis/v20240401preview:Redis" }, { type: "azure-native:redis/v20241101:Redis" }, { type: "azure-native:redis:Redis" }] };
...
export interface RedisArgs {
     ...
     * What SKU of Redis cache to deploy.
     */
    sku: pulumi.Input<inputs.redis.v20150801.SkuArgs>;
    /**
     * Required when deploying a Redis cache inside an existing Azure Virtual Network.
     */
