...
// Export enums:
export * from "../../types/enums/redis/v20150801";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redis/v20150801:Redis":
...
pulumi.runtime.registerResourceModule("azure-native", "redis/v20150801", _module)
