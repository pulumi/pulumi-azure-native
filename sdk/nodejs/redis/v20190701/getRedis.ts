...
export function getRedis(args: GetRedisArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisResult> {
    ...
    return pulumi.runtime.invoke("azure-native:redis/v20190701:getRedis", {
        "name": args.name,
...
export interface GetRedisResult {
     ...
     */
    readonly accessKeys: outputs.redis.v20190701.RedisAccessKeysResponse;
    /**
     ...
     */
    readonly instances: outputs.redis.v20190701.RedisInstanceDetailsResponse[];
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: outputs.redis.v20190701.RedisLinkedServerResponse[];
    /**
     ...
     */
    readonly sku: outputs.redis.v20190701.SkuResponse;
    /**
     * Redis SSL port.
     */
...
export function getRedisOutput(args: GetRedisOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRedisResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:redis/v20190701:getRedis", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
