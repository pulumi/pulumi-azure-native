...
export class Redis extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redis/v20190701:Redis';
     ...
     */
    public /*out*/ readonly accessKeys!: pulumi.Output<outputs.redis.v20190701.RedisAccessKeysResponse>;
    /**
     ...
     */
    public /*out*/ readonly instances!: pulumi.Output<outputs.redis.v20190701.RedisInstanceDetailsResponse[]>;
    /**
     * List of the linked servers associated with the cache
     */
    public /*out*/ readonly linkedServers!: pulumi.Output<outputs.redis.v20190701.RedisLinkedServerResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.redis.v20190701.SkuResponse>;
    /**
     * Redis SSL port.
     */
    ...
    constructor(name: string, args: RedisArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache/v20200601:Redis" }, { type: "azure-native:cache/v20230401:Redis" }, { type: "azure-native:cache/v20230501preview:Redis" }, { type: "azure-native:cache/v20230801:Redis" }, { type: "azure-native:cache/v20240301:Redis" }, { type: "azure-native:cache/v20240401preview:Redis" }, { type: "azure-native:cache/v20241101:Redis" }, { type: "azure-native:cache:Redis" }, { type: "azure-native:redis/v20150801:Redis" }, { type: "azure-native:redis/v20160401:Redis" }, { type: "azure-native:redis/v20170201:Redis" }, { type: "azure-native:redis/v20171001:Redis" }, { type: "azure-native:redis/v20180301:Redis" }, { type: "azure-native:redis/v20200601:Redis" }, { type: "azure-native:redis/v20201201:Redis" }, { type: "azure-native:redis/v20210601:Redis" }, { type: "azure-native:redis/v20220501:Redis" }, { type: "azure-native:redis/v20220601:Redis" }, { type: "azure-native:redis/v20230401:Redis" }, { type: "azure-native:redis/v20230501preview:Redis" }, { type: "azure-native:redis/v20230801:Redis" }, { type: "azure-native:redis/v20240301:Redis" }, { type: "azure-native:redis/v20240401preview:Redis" }, { type: "azure-native:redis/v20241101:Redis" }, { type: "azure-native:redis:Redis" }] };
...
export interface RedisArgs {
     ...
     * Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.0', '1.1', '1.2')
     */
    minimumTlsVersion?: pulumi.Input<string | enums.redis.v20190701.TlsVersion>;
    /**
     ...
     * The SKU of the Redis cache to deploy.
     */
    sku: pulumi.Input<inputs.redis.v20190701.SkuArgs>;
    /**
     * Static IP address. Required when deploying a Redis cache inside an existing Azure Virtual Network.
     */
