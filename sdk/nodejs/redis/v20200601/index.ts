...
// Export enums:
export * from "../../types/enums/redis/v20200601";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redis/v20200601:Redis":
...
pulumi.runtime.registerResourceModule("azure-native", "redis/v20200601", _module)
