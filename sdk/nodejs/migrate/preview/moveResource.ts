...
export class MoveResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/preview:MoveResource';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.preview.MoveResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MoveResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/v20191001preview:MoveResource" }] };
...
export interface MoveResourceArgs {
     ...
     * Defines the move resource properties.
     */
    readonly properties?: pulumi.Input<inputs.migrate.preview.MoveResourceProperties>;
    /**
