...
export class Assessment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/preview:Assessment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.preview.AssessmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/latest:Assessment" }, { type: "azurerm:migrate/v20191001:Assessment" }] };
...
export interface AssessmentArgs {
     ...
     * Properties of the assessment.
     */
    readonly properties: pulumi.Input<inputs.migrate.preview.AssessmentProperties>;
    /**
