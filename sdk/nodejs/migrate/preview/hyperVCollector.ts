...
export class HyperVCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/preview:HyperVCollector';
    ...
    public readonly properties!: pulumi.Output<outputs.migrate.preview.CollectorPropertiesResponse>;
    ...
    constructor(name: string, args: HyperVCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/latest:HyperVCollector" }, { type: "azurerm:migrate/v20191001:HyperVCollector" }] };
...
export interface HyperVCollectorArgs {
    ...
    readonly properties?: pulumi.Input<inputs.migrate.preview.CollectorProperties>;
    /**
