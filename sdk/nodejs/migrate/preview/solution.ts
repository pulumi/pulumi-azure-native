...
export class Solution extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Solution {
        return new Solution(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/preview:Solution';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.preview.SolutionPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: SolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/v20180901preview:Solution" }] };
...
export interface SolutionArgs {
     ...
     * Gets or sets the properties of the solution.
     */
    readonly properties?: pulumi.Input<inputs.migrate.preview.SolutionProperties>;
    /**
