...
export class Group extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/preview:Group';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.migrate.preview.GroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: GroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/latest:Group" }, { type: "azurerm:migrate/v20191001:Group" }] };
