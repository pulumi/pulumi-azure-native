...
export function getMoveCollection(args: GetMoveCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetMoveCollectionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:migrate/preview:getMoveCollection", {
...
export interface GetMoveCollectionResult {
     ...
     */
    readonly identity?: outputs.migrate.preview.IdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.migrate.preview.MoveCollectionPropertiesResponse;
    /**
     * Resource tags.
     */
