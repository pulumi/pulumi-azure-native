...
export class MoveCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/preview:MoveCollection';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.migrate.preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.preview.MoveCollectionPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: MoveCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/v20191001preview:MoveCollection" }] };
...
export interface MoveCollectionArgs {
     ...
     * Defines the MSI properties of the Move Collection.
     */
    readonly identity?: pulumi.Input<inputs.migrate.preview.Identity>;
    /**
     * The geo-location where the resource lives.
     */
     ...
     * Defines the move collection properties.
     */
    readonly properties?: pulumi.Input<inputs.migrate.preview.MoveCollectionProperties>;
    /**
