...
export class VMwareCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/preview:VMwareCollector';
    ...
    constructor(name: string, argsOrState?: VMwareCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/latest:VMwareCollector" }, { type: "azurerm:migrate/v20191001:VMwareCollector" }] };
