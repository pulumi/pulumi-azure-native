...
export class MigrateProject extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/preview:MigrateProject';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.preview.MigrateProjectPropertiesResponse>;
    /**
     * Gets or sets the tags.
     */
    public readonly tags!: pulumi.Output<outputs.migrate.preview.MigrateProjectResponseTags | undefined>;
    /**
    ...
    constructor(name: string, args: MigrateProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/v20180901preview:MigrateProject" }] };
...
export interface MigrateProjectArgs {
     ...
     * Gets or sets the nested properties.
     */
    readonly properties?: pulumi.Input<inputs.migrate.preview.MigrateProjectProperties>;
    /**
     ...
     * Gets or sets the tags.
     */
    readonly tags?: pulumi.Input<inputs.migrate.preview.MigrateProjectTags>;
}
