...
export function getMigrateProject(args: GetMigrateProjectArgs, opts?: pulumi.InvokeOptions): Promise<GetMigrateProjectResult> {
    ...
    return pulumi.runtime.invoke("azurerm:migrate/preview:getMigrateProject", {
...
export interface GetMigrateProjectResult {
     ...
     */
    readonly properties: outputs.migrate.preview.MigrateProjectPropertiesResponse;
    /**
     * Gets or sets the tags.
     */
    readonly tags?: outputs.migrate.preview.MigrateProjectResponseTags;
    /**
