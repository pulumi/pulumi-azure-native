...
export class MoveCollection extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<outputs.migrate.IdentityResponse | undefined>;
    /**
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.migrate.MoveCollectionPropertiesResponse>;
    /**
...
export interface MoveCollectionArgs {
     ...
     * Defines the MSI properties of the Move Collection.
     */
    identity?: pulumi.Input<inputs.migrate.IdentityArgs | undefined>;
    /**
     * The geo-location where the resource lives.
     */
     ...
     * Defines the move collection properties.
     */
    properties?: pulumi.Input<inputs.migrate.MoveCollectionPropertiesArgs | undefined>;
    /**
