...
export class MoveCollection extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.migrate.v20220801.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.v20220801.MoveCollectionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MoveCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001preview:MoveCollection" }, { type: "azure-native:migrate/v20210101:MoveCollection" }, { type: "azure-native:migrate/v20210801:MoveCollection" }, { type: "azure-native:migrate/v20230801:MoveCollection" }, { type: "azure-native:migrate:MoveCollection" }] };
...
export interface MoveCollectionArgs {
     ...
     * Defines the MSI properties of the Move Collection.
     */
    identity?: pulumi.Input<inputs.migrate.v20220801.IdentityArgs>;
    /**
     * The geo-location where the resource lives.
     */
     ...
     * Defines the move collection properties.
     */
    properties?: pulumi.Input<inputs.migrate.v20220801.MoveCollectionPropertiesArgs>;
    /**
