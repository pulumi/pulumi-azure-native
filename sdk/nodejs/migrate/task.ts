...
export class Task extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate:Task';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.migrate.TaskPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20250330preview:Task" }, { type: "azure-native:migrate/v20251201preview:Task" }, { type: "azure-native:migrate/v20260201preview:Task" }] };
