...
export class ImportCollector extends pulumi.CustomResource {
    ...
    public readonly properties!: pulumi.Output<outputs.migrate.ImportCollectorPropertiesResponse>;
    ...
    constructor(name: string, args: ImportCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001:ImportCollector" }, { type: "azure-native:migrate/v20230315:ImportCollectorsOperation" }, { type: "azure-native:migrate/v20230401preview:ImportCollectorsOperation" }, { type: "azure-native:migrate/v20230501preview:ImportCollectorsOperation" }, { type: "azure-native:migrate/v20230909preview:ImportCollectorsOperation" }, { type: "azure-native:migrate/v20240101preview:ImportCollectorsOperation" }, { type: "azure-native:migrate:ImportCollectorsOperation" }, { type: "azure-native_migrate_v20191001:migrate:ImportCollector" }, { type: "azure-native_migrate_v20230315:migrate:ImportCollector" }, { type: "azure-native_migrate_v20230401preview:migrate:ImportCollector" }, { type: "azure-native_migrate_v20230501preview:migrate:ImportCollector" }, { type: "azure-native_migrate_v20230909preview:migrate:ImportCollector" }, { type: "azure-native_migrate_v20240101preview:migrate:ImportCollector" }] };
