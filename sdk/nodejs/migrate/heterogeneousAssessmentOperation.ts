...
export class HeterogeneousAssessmentOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.migrate.HeterogeneousAssessmentPropertiesResponse>;
    /**
...
export interface HeterogeneousAssessmentOperationArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.migrate.HeterogeneousAssessmentPropertiesArgs | undefined>;
    /**
