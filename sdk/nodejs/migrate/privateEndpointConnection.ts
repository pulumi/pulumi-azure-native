...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate:PrivateEndpointConnection" }, { type: "azure-native:migrate/v20191001:PrivateEndpointConnection" }, { type: "azure-nextgen:migrate/v20191001:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Properties of the private endpoint endpoint connection.
     */
    readonly properties: pulumi.Input<inputs.migrate.PrivateEndpointConnectionPropertiesArgs>;
    /**
