...
export class SqlAssessmentV2Operation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230501preview:SqlAssessmentV2Operation';
     ...
     */
    public readonly azureSqlDatabaseSettings!: pulumi.Output<outputs.migrate.v20230501preview.SqlDbSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    public readonly azureSqlManagedInstanceSettings!: pulumi.Output<outputs.migrate.v20230501preview.SqlMiSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    public readonly azureSqlVmSettings!: pulumi.Output<outputs.migrate.v20230501preview.SqlVmSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly entityUptime!: pulumi.Output<outputs.migrate.v20230501preview.EntityUptimeResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SqlAssessmentV2OperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230315:SqlAssessmentV2Operation" }, { type: "azure-native:migrate/v20230401preview:SqlAssessmentV2Operation" }, { type: "azure-native:migrate/v20230909preview:SqlAssessmentV2Operation" }, { type: "azure-native:migrate:SqlAssessmentV2Operation" }] };
...
export interface SqlAssessmentV2OperationArgs {
     ...
     * Assessment type of the assessment.
     */
    assessmentType?: pulumi.Input<string | enums.migrate.v20230501preview.AssessmentType>;
    /**
     * Gets or sets user preference indicating intent of async commit mode.
     */
    asyncCommitModeIntent?: pulumi.Input<string | enums.migrate.v20230501preview.AsyncCommitModeIntent>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
     ...
     * Gets or sets Azure Offer Code for VM.
     */
    azureOfferCodeForVm?: pulumi.Input<string | enums.migrate.v20230501preview.AzureOfferCode>;
    /**
     * Gets or sets a value indicating azure security offering type.
     */
    azureSecurityOfferingType?: pulumi.Input<string | enums.migrate.v20230501preview.AzureSecurityOfferingType>;
    /**
     * Gets or sets user configurable SQL database settings.
     */
    azureSqlDatabaseSettings?: pulumi.Input<inputs.migrate.v20230501preview.SqlDbSettingsArgs>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    azureSqlManagedInstanceSettings?: pulumi.Input<inputs.migrate.v20230501preview.SqlMiSettingsArgs>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    azureSqlVmSettings?: pulumi.Input<inputs.migrate.v20230501preview.SqlVmSettingsArgs>;
    /**
     * Confidence Rating in Percentage.
     */
     ...
     * will be migrated.
     */
    disasterRecoveryLocation?: pulumi.Input<string | enums.migrate.v20230501preview.AzureLocation>;
    /**
     * Custom discount percentage.
     */
     ...
     * on-premises environment.
     */
    entityUptime?: pulumi.Input<inputs.migrate.v20230501preview.EntityUptimeArgs>;
    /**
     * Gets or sets user configurable setting to display the environment type.
     */
    environmentType?: pulumi.Input<string | enums.migrate.v20230501preview.EnvironmentType>;
    /**
     * Group ARM name
     */
     ...
     * Gets the group type for the assessment.
     */
    groupType?: pulumi.Input<string | enums.migrate.v20230501preview.GroupType>;
    /**
     * Gets or sets a value indicating whether internet access is available.
     */
     ...
     * Gets or sets user preference indicating intent of multi-subnet configuration.
     */
    multiSubnetIntent?: pulumi.Input<string | enums.migrate.v20230501preview.MultiSubnetIntent>;
    /**
     * Gets or sets SQL optimization logic.
     */
    optimizationLogic?: pulumi.Input<string | enums.migrate.v20230501preview.OptimizationLogic>;
    /**
     * Gets or sets user configurable setting to display the azure hybrid use benefit.
     */
    osLicense?: pulumi.Input<string | enums.migrate.v20230501preview.OsLicense>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
     ...
     * Gets or sets azure reserved instance for VM.
     */
    reservedInstanceForVm?: pulumi.Input<string | enums.migrate.v20230501preview.AzureReservedInstance>;
    /**
     ...
     * SQL server license.
     */
    sqlServerLicense?: pulumi.Input<string | enums.migrate.v20230501preview.SqlServerLicense>;
    /**
     * Time Range for which the historic utilization data should be considered for
     * assessment.
     */
