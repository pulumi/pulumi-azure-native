...
export class BusinessCaseOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BusinessCaseOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:BusinessCaseOperation" }, { type: "azure-native:migrate/v20230401preview:BusinessCaseOperation" }, { type: "azure-native:migrate/v20230909preview:BusinessCaseOperation" }] };
