...
export function getAvsAssessmentsOperation(args: GetAvsAssessmentsOperationArgs, opts?: pulumi.InvokeOptions): Promise<GetAvsAssessmentsOperationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:migrate/v20230501preview:getAvsAssessmentsOperation", {
...
export interface GetAvsAssessmentsOperationResult {
     ...
     */
    readonly avsEstimatedExternalStorages: outputs.migrate.v20230501preview.AvsEstimatedExternalStorageResponse[];
    /**
     * Estimated External Storage for Assessment.
     */
    readonly avsEstimatedNetworks: outputs.migrate.v20230501preview.AvsEstimatedNetworkResponse[];
    /**
     * EstimatedNodes AVS SKU for Assessment.
     */
    readonly avsEstimatedNodes: outputs.migrate.v20230501preview.AvsEstimatedNodeResponse[];
    /**
     ...
     */
    readonly costComponents: outputs.migrate.v20230501preview.CostComponentResponse[];
    /**
...
export function getAvsAssessmentsOperationOutput(args: GetAvsAssessmentsOperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAvsAssessmentsOperationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:migrate/v20230501preview:getAvsAssessmentsOperation", {
        "assessmentName": args.assessmentName,
        "groupName": args.groupName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
