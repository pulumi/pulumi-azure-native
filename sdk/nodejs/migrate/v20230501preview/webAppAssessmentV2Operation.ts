...
export class WebAppAssessmentV2Operation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppAssessmentV2OperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230401preview:WebAppAssessmentV2Operation" }, { type: "azure-native:migrate/v20230909preview:WebAppAssessmentV2Operation" }, { type: "azure-native:migrate:WebAppAssessmentV2Operation" }] };
