...
export class PrivateEndpointConnectionOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230501preview:PrivateEndpointConnectionOperation';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.migrate.v20230501preview.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.migrate.v20230501preview.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001:PrivateEndpointConnectionOperation" }, { type: "azure-native:migrate/v20230315:PrivateEndpointConnectionOperation" }, { type: "azure-native:migrate/v20230401preview:PrivateEndpointConnectionOperation" }, { type: "azure-native:migrate/v20230909preview:PrivateEndpointConnectionOperation" }, { type: "azure-native:migrate/v20240101preview:PrivateEndpointConnectionOperation" }, { type: "azure-native:migrate:PrivateEndpointConnectionOperation" }] };
...
export interface PrivateEndpointConnectionOperationArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.migrate.v20230501preview.PrivateLinkServiceConnectionStateArgs>;
    /**
