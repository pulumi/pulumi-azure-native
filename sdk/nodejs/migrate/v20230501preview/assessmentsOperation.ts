...
export class AssessmentsOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230501preview:AssessmentsOperation';
     ...
     */
    public /*out*/ readonly costComponents!: pulumi.Output<outputs.migrate.v20230501preview.CostComponentResponse[]>;
    /**
     ...
     * environment.
     */
    public readonly vmUptime!: pulumi.Output<outputs.migrate.v20230501preview.VmUptimeResponse | undefined>;
    ...
    constructor(name: string, args: AssessmentsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:AssessmentsOperation" }, { type: "azure-native:migrate/v20191001:AssessmentsOperation" }, { type: "azure-native:migrate/v20230315:AssessmentsOperation" }, { type: "azure-native:migrate/v20230401preview:AssessmentsOperation" }] };
...
export interface AssessmentsOperationArgs {
     ...
     * Gets or sets the azure storage type. Premium, Standard etc.
     */
    azureDiskTypes?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230501preview.AzureDiskType>[]>;
    /**
     * Gets or sets the user configurable setting to display the azure hybrid use
     * benefit.
     */
    azureHybridUseBenefit?: pulumi.Input<string | enums.migrate.v20230501preview.AzureHybridUseBenefit>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
     ...
     * Azure Offer Code.
     */
    azureOfferCode?: pulumi.Input<string | enums.migrate.v20230501preview.AzureOfferCode>;
    /**
     * Gets or sets Azure Pricing Tier - Free, Basic, etc.
     */
    azurePricingTier?: pulumi.Input<string | enums.migrate.v20230501preview.AzurePricingTier>;
    /**
     * Gets or sets the Azure Storage Redundancy. Example: Locally Redundant Storage.
     */
    azureStorageRedundancy?: pulumi.Input<string | enums.migrate.v20230501preview.AzureStorageRedundancy>;
    /**
     * Gets or sets the Azure VM families.
     */
    azureVmFamilies?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230501preview.AzureVmFamily>[]>;
    /**
     * Currency in which prices should be reported.
     */
    currency?: pulumi.Input<string | enums.migrate.v20230501preview.AzureCurrency>;
    /**
     * Custom discount percentage.
     */
     ...
     * benefit.
     */
    linuxAzureHybridUseBenefit?: pulumi.Input<string | enums.migrate.v20230501preview.AzureHybridUseBenefit>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
    percentile?: pulumi.Input<string | enums.migrate.v20230501preview.Percentile>;
    /**
     * Gets or sets the end time to consider performance data for assessment.
     */
     ...
     * Gets or sets the Azure Reserved Instance - 1-Year, 3-Year.
     */
    reservedInstance?: pulumi.Input<string | enums.migrate.v20230501preview.AzureReservedInstance>;
    /**
     ...
     * Assessment sizing criterion.
     */
    sizingCriterion?: pulumi.Input<string | enums.migrate.v20230501preview.AssessmentSizingCriterion>;
    /**
     * Time Range for which the historic utilization data should be considered for
     * assessment.
     */
    timeRange?: pulumi.Input<string | enums.migrate.v20230501preview.TimeRange>;
    /**
     * Gets or sets the duration for which the VMs are up in the on-premises
     * environment.
     */
    vmUptime?: pulumi.Input<inputs.migrate.v20230501preview.VmUptimeArgs>;
}
