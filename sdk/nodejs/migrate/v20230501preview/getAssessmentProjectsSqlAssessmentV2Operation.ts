...
export function getAssessmentProjectsSqlAssessmentV2Operation(args: GetAssessmentProjectsSqlAssessmentV2OperationArgs, opts?: pulumi.InvokeOptions): Promise<GetAssessmentProjectsSqlAssessmentV2OperationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:migrate/v20230501preview:getAssessmentProjectsSqlAssessmentV2Operation", {
...
export interface GetAssessmentProjectsSqlAssessmentV2OperationArgs {
    /**
 ...
 */
export interface GetAssessmentProjectsSqlAssessmentV2OperationResult {
    /**
     ...
     */
    readonly azureSqlDatabaseSettings?: outputs.migrate.v20230501preview.SqlDbSettingsResponse;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    readonly azureSqlManagedInstanceSettings?: outputs.migrate.v20230501preview.SqlMiSettingsResponse;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    readonly azureSqlVmSettings?: outputs.migrate.v20230501preview.SqlVmSettingsResponse;
    /**
...
export function getAssessmentProjectsSqlAssessmentV2OperationOutput(args: GetAssessmentProjectsSqlAssessmentV2OperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAssessmentProjectsSqlAssessmentV2OperationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:migrate/v20230501preview:getAssessmentProjectsSqlAssessmentV2Operation", {
        "assessmentName": args.assessmentName,
        "groupName": args.groupName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
...
export interface GetAssessmentProjectsSqlAssessmentV2OperationOutputArgs {
    /**
     * SQL Assessment arm name.
     */
