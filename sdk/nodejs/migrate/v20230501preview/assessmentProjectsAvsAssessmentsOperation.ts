...
export class AssessmentProjectsAvsAssessmentsOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230501preview:AssessmentProjectsAvsAssessmentsOperation';
    ...
    constructor(name: string, args: AssessmentProjectsAvsAssessmentsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:AssessmentProjectsAvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230315:AssessmentProjectsAvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230401preview:AssessmentProjectsAvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230909preview:AssessmentProjectsAvsAssessmentsOperation" }] };
