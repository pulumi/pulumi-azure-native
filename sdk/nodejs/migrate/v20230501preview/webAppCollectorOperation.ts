...
export class WebAppCollectorOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppCollectorOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:WebAppCollectorOperation" }, { type: "azure-native:migrate/v20230401preview:WebAppCollectorOperation" }, { type: "azure-native:migrate/v20230909preview:WebAppCollectorOperation" }] };
