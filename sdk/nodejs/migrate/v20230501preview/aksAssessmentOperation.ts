...
export class AksAssessmentOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AksAssessmentOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:AksAssessmentOperation" }, { type: "azure-native:migrate/v20230401preview:AksAssessmentOperation" }, { type: "azure-native:migrate/v20230909preview:AksAssessmentOperation" }] };
