...
export class MoveResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MoveResource {
        pulumi.log.warn("MoveResource is deprecated: azure-native:migrate/v20210801:MoveResource is being removed in the next major version of this provider. Please upgrade to azure-native:migrate/v20220801:MoveResource to guarantee forwards compatibility.")
