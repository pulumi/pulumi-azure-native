...
export class ModernizeProject extends pulumi.CustomResource {
    ...
    declare public readonly identity: pulumi.Output<outputs.migrate.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.migrate.ModernizeProjectModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<outputs.migrate.ModernizeProjectModelResponseSystemData>;
    /**
