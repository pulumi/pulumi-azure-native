...
export class SolutionsControllerSolution extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.v20230101.SolutionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SolutionsControllerSolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20180901preview:Solution" }, { type: "azure-native:migrate/v20180901preview:SolutionsControllerSolution" }, { type: "azure-native:migrate:Solution" }, { type: "azure-native:migrate:SolutionsControllerSolution" }] };
