...
export class MigrateProjectsControllerMigrateProject extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.v20200501.MigrateProjectPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MigrateProjectsControllerMigrateProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20180901preview:MigrateProjectsControllerMigrateProject" }, { type: "azure-native:migrate/v20230101:MigrateProjectsControllerMigrateProject" }, { type: "azure-native:migrate:MigrateProjectsControllerMigrateProject" }] };
