...
export class AssessmentProjectsOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssessmentProjectsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001:Project" }, { type: "azure-native:migrate/v20230315:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20230401preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20230501preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20230909preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20240101preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate:Project" }, { type: "azure-native_migrate_v20191001:migrate:AssessmentProjectsOperation" }, { type: "azure-native_migrate_v20230315:migrate:AssessmentProjectsOperation" }, { type: "azure-native_migrate_v20230401preview:migrate:AssessmentProjectsOperation" }, { type: "azure-native_migrate_v20230501preview:migrate:AssessmentProjectsOperation" }, { type: "azure-native_migrate_v20230909preview:migrate:AssessmentProjectsOperation" }, { type: "azure-native_migrate_v20240101preview:migrate:AssessmentProjectsOperation" }] };
