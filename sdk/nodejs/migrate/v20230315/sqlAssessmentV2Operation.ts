...
export class SqlAssessmentV2Operation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230315:SqlAssessmentV2Operation';
     ...
     */
    public readonly azureSqlDatabaseSettings!: pulumi.Output<outputs.migrate.v20230315.SqlDbSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    public readonly azureSqlManagedInstanceSettings!: pulumi.Output<outputs.migrate.v20230315.SqlMiSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    public readonly azureSqlVmSettings!: pulumi.Output<outputs.migrate.v20230315.SqlVmSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly entityUptime!: pulumi.Output<outputs.migrate.v20230315.EntityUptimeResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SqlAssessmentV2OperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:SqlAssessmentV2Operation" }, { type: "azure-native:migrate/v20230401preview:SqlAssessmentV2Operation" }, { type: "azure-native:migrate/v20230501preview:SqlAssessmentV2Operation" }, { type: "azure-native:migrate/v20230909preview:SqlAssessmentV2Operation" }] };
