...
export class AssessmentProjectsSqlAssessmentV2Operation extends pulumi.CustomResource {
    /**
     * Get an existing AssessmentProjectsSqlAssessmentV2Operation resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AssessmentProjectsSqlAssessmentV2Operation {
        return new AssessmentProjectsSqlAssessmentV2Operation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230315:AssessmentProjectsSqlAssessmentV2Operation';

    /**
     * Returns true if the given object is an instance of AssessmentProjectsSqlAssessmentV2Operation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AssessmentProjectsSqlAssessmentV2Operation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AssessmentProjectsSqlAssessmentV2Operation.__pulumiType;
    }
    ...
    /**
     * Create a AssessmentProjectsSqlAssessmentV2Operation resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AssessmentProjectsSqlAssessmentV2OperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:AssessmentProjectsSqlAssessmentV2Operation" }, { type: "azure-native:migrate/v20230401preview:AssessmentProjectsSqlAssessmentV2Operation" }, { type: "azure-native:migrate/v20230501preview:AssessmentProjectsSqlAssessmentV2Operation" }, { type: "azure-native:migrate/v20230909preview:AssessmentProjectsSqlAssessmentV2Operation" }] };
...
/**
 * The set of arguments for constructing a AssessmentProjectsSqlAssessmentV2Operation resource.
 */
export interface AssessmentProjectsSqlAssessmentV2OperationArgs {
    /**
