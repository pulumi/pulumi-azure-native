...
export class AssessmentProjectsAvsAssessmentsOperation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AssessmentProjectsAvsAssessmentsOperation {
        return new AssessmentProjectsAvsAssessmentsOperation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230315:AssessmentProjectsAvsAssessmentsOperation';

    /**
     * Returns true if the given object is an instance of AssessmentProjectsAvsAssessmentsOperation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AssessmentProjectsAvsAssessmentsOperation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AssessmentProjectsAvsAssessmentsOperation.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AssessmentProjectsAvsAssessmentsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:AssessmentProjectsAvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230401preview:AssessmentProjectsAvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230501preview:AssessmentProjectsAvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230909preview:AssessmentProjectsAvsAssessmentsOperation" }] };
 ...
 */
export interface AssessmentProjectsAvsAssessmentsOperationArgs {
    /**
