...
export class ServerCollectorsOperation extends pulumi.CustomResource {
     ...
     */
    public readonly agentProperties!: pulumi.Output<outputs.migrate.v20230315.CollectorAgentPropertiesBaseResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServerCollectorsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:ServerCollectorsOperation" }, { type: "azure-native:migrate/v20191001:ServerCollectorsOperation" }, { type: "azure-native:migrate/v20230401preview:ServerCollectorsOperation" }, { type: "azure-native:migrate/v20230501preview:ServerCollectorsOperation" }] };
...
export interface ServerCollectorsOperationArgs {
     ...
     * Gets or sets the collector agent properties.
     */
    agentProperties?: pulumi.Input<inputs.migrate.v20230315.CollectorAgentPropertiesBaseArgs>;
    /**
     * Gets the discovery site id.
     */
