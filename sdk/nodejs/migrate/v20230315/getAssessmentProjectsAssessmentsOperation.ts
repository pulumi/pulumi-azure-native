...
export function getAssessmentProjectsAssessmentsOperation(args: GetAssessmentProjectsAssessmentsOperationArgs, opts?: pulumi.InvokeOptions): Promise<GetAssessmentProjectsAssessmentsOperationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:migrate/v20230315:getAssessmentProjectsAssessmentsOperation", {
...
export interface GetAssessmentProjectsAssessmentsOperationArgs {
    /**
 ...
 */
export interface GetAssessmentProjectsAssessmentsOperationResult {
    /**
     ...
     */
    readonly costComponents: outputs.migrate.v20230315.CostComponentResponse[];
    /**
     ...
     * environment.
     */
    readonly vmUptime?: outputs.migrate.v20230315.VmUptimeResponse;
}
/**
 * Get a Assessment
 */
export function getAssessmentProjectsAssessmentsOperationOutput(args: GetAssessmentProjectsAssessmentsOperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAssessmentProjectsAssessmentsOperationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:migrate/v20230315:getAssessmentProjectsAssessmentsOperation", {
        "assessmentName": args.assessmentName,
        "groupName": args.groupName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
...
export interface GetAssessmentProjectsAssessmentsOperationOutputArgs {
    /**
     * Machine Assessment ARM name
     */
