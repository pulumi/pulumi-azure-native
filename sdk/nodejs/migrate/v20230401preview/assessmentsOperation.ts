...
export class AssessmentsOperation extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly costComponents!: pulumi.Output<outputs.migrate.v20230401preview.CostComponentResponse[]>;
    /**
     ...
     * environment.
     */
    public readonly vmUptime!: pulumi.Output<outputs.migrate.v20230401preview.VmUptimeResponse | undefined>;
    ...
    constructor(name: string, args: AssessmentsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:AssessmentsOperation" }, { type: "azure-native:migrate/v20191001:AssessmentsOperation" }, { type: "azure-native:migrate/v20230315:AssessmentsOperation" }, { type: "azure-native:migrate/v20230501preview:AssessmentsOperation" }] };
...
export interface AssessmentsOperationArgs {
     ...
     * Gets or sets the azure storage type. Premium, Standard etc.
     */
    azureDiskTypes?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230401preview.AzureDiskType>[]>;
    /**
     * Gets or sets the user configurable setting to display the azure hybrid use
     * benefit.
     */
    azureHybridUseBenefit?: pulumi.Input<string | enums.migrate.v20230401preview.AzureHybridUseBenefit>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
     ...
     * Gets or sets Azure Pricing Tier - Free, Basic, etc.
     */
    azurePricingTier?: pulumi.Input<string | enums.migrate.v20230401preview.AzurePricingTier>;
    /**
     * Gets or sets the Azure Storage Redundancy. Example: Locally Redundant Storage.
     */
    azureStorageRedundancy?: pulumi.Input<string | enums.migrate.v20230401preview.AzureStorageRedundancy>;
    /**
     * Gets or sets the Azure VM families.
     */
    azureVmFamilies?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230401preview.AzureVmFamily>[]>;
    /**
     * Currency in which prices should be reported.
     */
     ...
     * benefit.
     */
    linuxAzureHybridUseBenefit?: pulumi.Input<string | enums.migrate.v20230401preview.AzureHybridUseBenefit>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
     ...
     * environment.
     */
    vmUptime?: pulumi.Input<inputs.migrate.v20230401preview.VmUptimeArgs>;
}
