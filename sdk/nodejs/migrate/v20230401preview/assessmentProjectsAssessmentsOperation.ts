...
export class AssessmentProjectsAssessmentsOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230401preview:AssessmentProjectsAssessmentsOperation';
