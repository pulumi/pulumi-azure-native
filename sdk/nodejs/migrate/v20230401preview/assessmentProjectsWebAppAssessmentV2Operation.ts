 ...
 */
export class AssessmentProjectsWebAppAssessmentV2Operation extends pulumi.CustomResource {
    /**
     * Get an existing AssessmentProjectsWebAppAssessmentV2Operation resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AssessmentProjectsWebAppAssessmentV2Operation {
        return new AssessmentProjectsWebAppAssessmentV2Operation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230401preview:AssessmentProjectsWebAppAssessmentV2Operation';

    /**
     * Returns true if the given object is an instance of AssessmentProjectsWebAppAssessmentV2Operation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AssessmentProjectsWebAppAssessmentV2Operation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AssessmentProjectsWebAppAssessmentV2Operation.__pulumiType;
    }

    /**
     * Gets or sets user configurable app service container database settings.
     */
    public readonly appSvcContainerSettings!: pulumi.Output<outputs.migrate.v20230401preview.AppSvcContainerSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable app service native settings.
     */
    public readonly appSvcNativeSettings!: pulumi.Output<outputs.migrate.v20230401preview.AppSvcNativeSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly discoveredEntityLightSummary!: pulumi.Output<outputs.migrate.v20230401preview.DiscoveredEntityLightSummaryResponse | undefined>;
    /**
    ...
    /**
     * Create a AssessmentProjectsWebAppAssessmentV2Operation resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AssessmentProjectsWebAppAssessmentV2OperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:AssessmentProjectsWebAppAssessmentV2Operation" }, { type: "azure-native:migrate/v20230501preview:AssessmentProjectsWebAppAssessmentV2Operation" }, { type: "azure-native:migrate/v20230909preview:AssessmentProjectsWebAppAssessmentV2Operation" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(AssessmentProjectsWebAppAssessmentV2Operation.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * The set of arguments for constructing a AssessmentProjectsWebAppAssessmentV2Operation resource.
 */
export interface AssessmentProjectsWebAppAssessmentV2OperationArgs {
    /**
     * Gets or sets user configurable app service container database settings.
     */
    appSvcContainerSettings?: pulumi.Input<inputs.migrate.v20230401preview.AppSvcContainerSettingsArgs>;
    /**
     * Gets or sets user configurable app service native settings.
     */
    appSvcNativeSettings?: pulumi.Input<inputs.migrate.v20230401preview.AppSvcNativeSettingsArgs>;
    /**
     ...
     * Gets or sets user configurable discovered entity settings.
     */
    discoveredEntityLightSummary?: pulumi.Input<inputs.migrate.v20230401preview.DiscoveredEntityLightSummaryArgs>;
    /**
     * Gets or sets the Enterprise agreement subscription id.
     */
