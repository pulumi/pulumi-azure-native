...
export interface GetWebAppAssessmentV2OperationResult {
     ...
     */
    readonly appSvcContainerSettings?: outputs.migrate.v20230401preview.AppSvcContainerSettingsResponse;
    /**
     * Gets or sets user configurable app service native settings.
     */
    readonly appSvcNativeSettings?: outputs.migrate.v20230401preview.AppSvcNativeSettingsResponse;
    /**
     ...
     */
    readonly discoveredEntityLightSummary?: outputs.migrate.v20230401preview.DiscoveredEntityLightSummaryResponse;
    /**
...
export function getWebAppAssessmentV2OperationOutput(args: GetWebAppAssessmentV2OperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebAppAssessmentV2OperationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:migrate/v20230401preview:getWebAppAssessmentV2Operation", {
        "assessmentName": args.assessmentName,
        "groupName": args.groupName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
