...
export class ServerCollectorsOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerCollectorsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:ServerCollectorsOperation" }, { type: "azure-native:migrate/v20191001:ServerCollectorsOperation" }, { type: "azure-native:migrate/v20230315:ServerCollectorsOperation" }, { type: "azure-native:migrate/v20230501preview:ServerCollectorsOperation" }] };
