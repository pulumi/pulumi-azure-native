...
export class WebAppCollectorOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppCollectorOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230501preview:WebAppCollectorOperation" }, { type: "azure-native:migrate/v20230909preview:WebAppCollectorOperation" }, { type: "azure-native:migrate:WebAppCollectorOperation" }] };
