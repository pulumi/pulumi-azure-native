...
export class VmwareCollectorsOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VmwareCollectorsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:VmwareCollectorsOperation" }, { type: "azure-native:migrate/v20191001:VmwareCollectorsOperation" }, { type: "azure-native:migrate/v20230315:VmwareCollectorsOperation" }, { type: "azure-native:migrate/v20230501preview:VmwareCollectorsOperation" }] };
