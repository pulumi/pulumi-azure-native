...
export class WorkloadDeployment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.WorkloadDeploymentModelPropertiesResponse>;
    public /*out*/ readonly systemData!: pulumi.Output<outputs.migrate.WorkloadDeploymentModelResponseSystemData>;
    /**
