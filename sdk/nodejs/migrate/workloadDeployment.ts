...
export class WorkloadDeployment extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.migrate.WorkloadDeploymentModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<outputs.migrate.WorkloadDeploymentModelResponseSystemData>;
    /**
...
export interface WorkloadDeploymentArgs {
     ...
     * Workload deployment model properties.
     */
    properties?: pulumi.Input<inputs.migrate.WorkloadDeploymentModelPropertiesArgs | undefined>;
    /**
