...
export class Group extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/latest:Group';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.migrate.latest.GroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate/latest:Group" }, { type: "azure-native:migrate:Group" }, { type: "azure-nextgen:migrate:Group" }, { type: "azure-native:migrate/v20191001:Group" }, { type: "azure-nextgen:migrate/v20191001:Group" }] };
