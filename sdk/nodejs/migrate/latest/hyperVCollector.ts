...
export class HyperVCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/latest:HyperVCollector';
    ...
    constructor(name: string, argsOrState?: HyperVCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/preview:HyperVCollector" }, { type: "azurerm:migrate/v20191001:HyperVCollector" }] };
