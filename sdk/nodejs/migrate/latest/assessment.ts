...
export class Assessment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/latest:Assessment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.latest.AssessmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate/latest:Assessment" }, { type: "azure-native:migrate:Assessment" }, { type: "azure-nextgen:migrate:Assessment" }, { type: "azure-native:migrate/v20191001:Assessment" }, { type: "azure-nextgen:migrate/v20191001:Assessment" }] };
...
export interface AssessmentArgs {
     ...
     * Properties of the assessment.
     */
    readonly properties: pulumi.Input<inputs.migrate.latest.AssessmentProperties>;
    /**
