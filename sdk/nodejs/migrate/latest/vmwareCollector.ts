...
export class VMwareCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/latest:VMwareCollector';
    ...
    public readonly properties!: pulumi.Output<outputs.migrate.latest.CollectorPropertiesResponse>;
    ...
    constructor(name: string, args: VMwareCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate/latest:VMwareCollector" }, { type: "azure-native:migrate:VMwareCollector" }, { type: "azure-nextgen:migrate:VMwareCollector" }, { type: "azure-native:migrate/v20191001:VMwareCollector" }, { type: "azure-nextgen:migrate/v20191001:VMwareCollector" }] };
...
export interface VMwareCollectorArgs {
    ...
    readonly properties?: pulumi.Input<inputs.migrate.latest.CollectorProperties>;
    /**
