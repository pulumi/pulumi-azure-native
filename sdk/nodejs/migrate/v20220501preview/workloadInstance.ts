...
export class WorkloadInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20220501preview:WorkloadInstance';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.v20220501preview.WorkloadInstanceModelPropertiesResponse>;
    public /*out*/ readonly systemData!: pulumi.Output<outputs.migrate.v20220501preview.WorkloadInstanceModelResponseSystemData>;
    /**
    ...
    constructor(name: string, args: WorkloadInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:WorkloadInstance" }] };
...
export interface WorkloadInstanceArgs {
     ...
     * Workload instance model properties.
     */
    properties?: pulumi.Input<inputs.migrate.v20220501preview.WorkloadInstanceModelPropertiesArgs>;
    /**
