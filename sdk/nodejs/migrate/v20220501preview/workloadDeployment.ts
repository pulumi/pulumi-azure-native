...
export class WorkloadDeployment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.v20220501preview.WorkloadDeploymentModelPropertiesResponse>;
    public /*out*/ readonly systemData!: pulumi.Output<outputs.migrate.v20220501preview.WorkloadDeploymentModelResponseSystemData>;
    /**
...
export interface WorkloadDeploymentArgs {
     ...
     * Workload deployment model properties.
     */
    properties?: pulumi.Input<inputs.migrate.v20220501preview.WorkloadDeploymentModelPropertiesArgs>;
    /**
