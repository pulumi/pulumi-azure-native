...
export class MoveResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MoveResource {
        return new MoveResource(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:migrate/v20191001preview:MoveResource';
    ...
    constructor(name: string, argsOrState?: MoveResourceArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as MoveResourceArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:migrate/preview:MoveResource" }] };
