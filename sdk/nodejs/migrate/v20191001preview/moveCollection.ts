 ...
 *
 * @deprecated azure-native:migrate/v20191001preview:MoveCollection is being removed in the next major version of this provider. Please upgrade to azure-native:migrate/v20220801:MoveCollection to guarantee forwards compatibility.
 */
export class MoveCollection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MoveCollection {
        pulumi.log.warn("MoveCollection is deprecated: azure-native:migrate/v20191001preview:MoveCollection is being removed in the next major version of this provider. Please upgrade to azure-native:migrate/v20220801:MoveCollection to guarantee forwards compatibility.")
        return new MoveCollection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20191001preview:MoveCollection';
    ...
    constructor(name: string, args: MoveCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:MoveCollection" }, { type: "azure-native:migrate/v20210101:MoveCollection" }, { type: "azure-native:migrate/v20210801:MoveCollection" }, { type: "azure-native:migrate/v20220801:MoveCollection" }] };
...
export interface MoveCollectionArgs {
     ...
     * Defines the MSI properties of the Move Collection.
     */
    identity?: pulumi.Input<inputs.migrate.v20191001preview.IdentityArgs>;
    /**
     * The geo-location where the resource lives.
     */
     ...
     * Defines the move collection properties.
     */
    properties?: pulumi.Input<inputs.migrate.v20191001preview.MoveCollectionPropertiesArgs>;
    /**
