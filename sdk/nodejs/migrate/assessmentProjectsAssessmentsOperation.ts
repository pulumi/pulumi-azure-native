...
export class AssessmentProjectsAssessmentsOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate:AssessmentProjectsAssessmentsOperation';
