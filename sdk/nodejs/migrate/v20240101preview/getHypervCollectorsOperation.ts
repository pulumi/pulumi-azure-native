...
export function getHypervCollectorsOperation(args: GetHypervCollectorsOperationArgs, opts?: pulumi.InvokeOptions): Promise<GetHypervCollectorsOperationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:migrate/v20240101preview:getHypervCollectorsOperation", {
...
export function getHypervCollectorsOperationOutput(args: GetHypervCollectorsOperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHypervCollectorsOperationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:migrate/v20240101preview:getHypervCollectorsOperation", {
        "hypervCollectorName": args.hypervCollectorName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
