...
export class AssessmentProjectsAvsAssessmentsOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20240101preview:AssessmentProjectsAvsAssessmentsOperation';
