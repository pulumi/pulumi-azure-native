...
export class AvsAssessmentsOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20240101preview:AvsAssessmentsOperation';
     ...
     */
    public /*out*/ readonly avsEstimatedExternalStorages!: pulumi.Output<outputs.migrate.v20240101preview.AvsEstimatedExternalStorageResponse[]>;
    /**
     * Estimated External Storage for Assessment.
     */
    public /*out*/ readonly avsEstimatedNetworks!: pulumi.Output<outputs.migrate.v20240101preview.AvsEstimatedNetworkResponse[]>;
    /**
     * Estimated AVS SKU for Assessment.
     */
    public /*out*/ readonly avsEstimatedNodes!: pulumi.Output<outputs.migrate.v20240101preview.AvsEstimatedNodeResponse[]>;
    /**
    ...
    constructor(name: string, args: AvsAssessmentsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230315:AvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230401preview:AvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230501preview:AvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230909preview:AvsAssessmentsOperation" }, { type: "azure-native:migrate:AvsAssessmentsOperation" }] };
...
export interface AvsAssessmentsOperationArgs {
     ...
     * AVS Assessment Scenario.
     */
    avsAssessmentScenario?: pulumi.Input<string | enums.migrate.v20240101preview.AvsAssessmentScenario>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
    azureLocation?: pulumi.Input<string | enums.migrate.v20240101preview.AzureLocation>;
    /**
     * Azure Offer code according to which cost estimation is done.
     */
     ...
     * List of AVS external storage types.
     */
    externalStorageTypes?: pulumi.Input<pulumi.Input<string | enums.migrate.v20240101preview.ExternalStorageType>[]>;
    /**
     * Failures to tolerate and RAID level in a common property.
     */
    failuresToTolerateAndRaidLevel?: pulumi.Input<string | enums.migrate.v20240101preview.FttAndRaidLevel>;
    /**
     * List of Failures to tolerate and RAID levels in a common property.
     */
    failuresToTolerateAndRaidLevelList?: pulumi.Input<pulumi.Input<string | enums.migrate.v20240101preview.FttAndRaidLevel>[]>;
    /**
     * Group ARM name
     */
     ...
     * AVS node type.
     */
    nodeType?: pulumi.Input<string | enums.migrate.v20240101preview.AzureAvsNodeType>;
    /**
     * AVS node types.
     */
    nodeTypes?: pulumi.Input<pulumi.Input<string | enums.migrate.v20240101preview.AzureAvsNodeType>[]>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
