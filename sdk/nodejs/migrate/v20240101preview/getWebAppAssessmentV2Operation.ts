...
export function getWebAppAssessmentV2Operation(args: GetWebAppAssessmentV2OperationArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppAssessmentV2OperationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:migrate/v20240101preview:getWebAppAssessmentV2Operation", {
...
export interface GetWebAppAssessmentV2OperationResult {
     ...
     */
    readonly appSvcContainerSettings?: outputs.migrate.v20240101preview.AppSvcContainerSettingsResponse;
    /**
     * Gets or sets user configurable app service native settings.
     */
    readonly appSvcNativeSettings?: outputs.migrate.v20240101preview.AppSvcNativeSettingsResponse;
    /**
     ...
     */
    readonly discoveredEntityLightSummary?: outputs.migrate.v20240101preview.DiscoveredEntityLightSummaryResponse;
    /**
     ...
     */
    readonly entityUptime?: outputs.migrate.v20240101preview.EntityUptimeResponse;
    /**
...
export function getWebAppAssessmentV2OperationOutput(args: GetWebAppAssessmentV2OperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebAppAssessmentV2OperationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:migrate/v20240101preview:getWebAppAssessmentV2Operation", {
        "assessmentName": args.assessmentName,
        "groupName": args.groupName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
