...
export class AssessmentProjectsSqlAssessmentV2Operation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20240101preview:AssessmentProjectsSqlAssessmentV2Operation';
     ...
     */
    public readonly azureSqlDatabaseSettings!: pulumi.Output<outputs.migrate.v20240101preview.SqlDbSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    public readonly azureSqlManagedInstanceSettings!: pulumi.Output<outputs.migrate.v20240101preview.SqlMiSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    public readonly azureSqlVmSettings!: pulumi.Output<outputs.migrate.v20240101preview.SqlVmSettingsResponse | undefined>;
    /**
...
export interface AssessmentProjectsSqlAssessmentV2OperationArgs {
     ...
     * Gets or sets user preference indicating intent of async commit mode.
     */
    asyncCommitModeIntent?: pulumi.Input<string | enums.migrate.v20240101preview.AsyncCommitModeIntent>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
     ...
     * Gets or sets Azure Offer Code for VM.
     */
    azureOfferCodeForVm?: pulumi.Input<string | enums.migrate.v20240101preview.AzureOfferCode>;
    /**
     * Gets or sets a value indicating azure security offering type.
     */
     ...
     * Gets or sets user configurable SQL database settings.
     */
    azureSqlDatabaseSettings?: pulumi.Input<inputs.migrate.v20240101preview.SqlDbSettingsArgs>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    azureSqlManagedInstanceSettings?: pulumi.Input<inputs.migrate.v20240101preview.SqlMiSettingsArgs>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    azureSqlVmSettings?: pulumi.Input<inputs.migrate.v20240101preview.SqlVmSettingsArgs>;
    /**
     * Confidence Rating in Percentage.
     */
     ...
     * will be migrated.
     */
    disasterRecoveryLocation?: pulumi.Input<string | enums.migrate.v20240101preview.AzureLocation>;
    /**
     * Custom discount percentage.
     */
     ...
     * Gets or sets user preference indicating intent of multi-subnet configuration.
     */
    multiSubnetIntent?: pulumi.Input<string | enums.migrate.v20240101preview.MultiSubnetIntent>;
    /**
     * Gets or sets SQL optimization logic.
     */
    optimizationLogic?: pulumi.Input<string | enums.migrate.v20240101preview.OptimizationLogic>;
    /**
     * Gets or sets user configurable setting to display the azure hybrid use benefit.
     */
    osLicense?: pulumi.Input<string | enums.migrate.v20240101preview.OsLicense>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
     ...
     * Gets or sets azure reserved instance for VM.
     */
    reservedInstanceForVm?: pulumi.Input<string | enums.migrate.v20240101preview.AzureReservedInstance>;
    /**
     ...
     * SQL server license.
     */
    sqlServerLicense?: pulumi.Input<string | enums.migrate.v20240101preview.SqlServerLicense>;
    /**
     * Time Range for which the historic utilization data should be considered for
     * assessment.
     */
