...
export function getAvsAssessmentsOperation(args: GetAvsAssessmentsOperationArgs, opts?: pulumi.InvokeOptions): Promise<GetAvsAssessmentsOperationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:migrate/v20240101preview:getAvsAssessmentsOperation", {
...
export interface GetAvsAssessmentsOperationResult {
     ...
     */
    readonly avsEstimatedExternalStorages: outputs.migrate.v20240101preview.AvsEstimatedExternalStorageResponse[];
    /**
     * Estimated External Storage for Assessment.
     */
    readonly avsEstimatedNetworks: outputs.migrate.v20240101preview.AvsEstimatedNetworkResponse[];
    /**
     * Estimated AVS SKU for Assessment.
     */
    readonly avsEstimatedNodes: outputs.migrate.v20240101preview.AvsEstimatedNodeResponse[];
    /**
     ...
     */
    readonly costComponents: outputs.migrate.v20240101preview.CostComponentResponse[];
    /**
...
export function getAvsAssessmentsOperationOutput(args: GetAvsAssessmentsOperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAvsAssessmentsOperationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:migrate/v20240101preview:getAvsAssessmentsOperation", {
        "assessmentName": args.assessmentName,
        "groupName": args.groupName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
