...
export class AksAssessmentOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20240101preview:AksAssessmentOperation';
     ...
     */
    public /*out*/ readonly details!: pulumi.Output<outputs.migrate.v20240101preview.AKSAssessmentDetailsResponse>;
    /**
     ...
     */
    public readonly scope!: pulumi.Output<outputs.migrate.v20240101preview.AssessmentScopeParametersResponse | undefined>;
    /**
     * Gets or sets AKS Assessment Settings.
     */
    public readonly settings!: pulumi.Output<outputs.migrate.v20240101preview.AKSAssessmentSettingsResponse>;
    /**
    ...
    constructor(name: string, args: AksAssessmentOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230401preview:AksAssessmentOperation" }, { type: "azure-native:migrate/v20230501preview:AksAssessmentOperation" }, { type: "azure-native:migrate/v20230909preview:AksAssessmentOperation" }, { type: "azure-native:migrate:AksAssessmentOperation" }] };
...
export interface AksAssessmentOperationArgs {
     ...
     * Gets or sets scope parameters to identify inventory items for assessment.
     */
    scope?: pulumi.Input<inputs.migrate.v20240101preview.AssessmentScopeParametersArgs>;
    /**
     * Gets or sets AKS Assessment Settings.
     */
    settings: pulumi.Input<inputs.migrate.v20240101preview.AKSAssessmentSettingsArgs>;
}
