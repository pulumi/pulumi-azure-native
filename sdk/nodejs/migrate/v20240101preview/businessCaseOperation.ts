...
export class BusinessCaseOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20240101preview:BusinessCaseOperation';
     ...
     */
    public /*out*/ readonly reportStatusDetails!: pulumi.Output<outputs.migrate.v20240101preview.ReportDetailsResponse[]>;
    /**
     * Business case settings.
     */
    public readonly settings!: pulumi.Output<outputs.migrate.v20240101preview.SettingsResponse | undefined>;
    /**
     * Business case state.
     */
    ...
    constructor(name: string, args: BusinessCaseOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["settings"] = args ? (args.settings ? pulumi.output(args.settings).apply(inputs.migrate.v20240101preview.settingsArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230401preview:BusinessCaseOperation" }, { type: "azure-native:migrate/v20230501preview:BusinessCaseOperation" }, { type: "azure-native:migrate/v20230909preview:BusinessCaseOperation" }, { type: "azure-native:migrate:BusinessCaseOperation" }] };
...
export interface BusinessCaseOperationArgs {
     ...
     * Business case settings.
     */
    settings?: pulumi.Input<inputs.migrate.v20240101preview.SettingsArgs>;
}
