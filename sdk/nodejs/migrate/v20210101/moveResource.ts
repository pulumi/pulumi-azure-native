...
export class MoveResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MoveResource {
        pulumi.log.warn("MoveResource is deprecated: azure-native:migrate/v20210101:MoveResource is being removed in the next major version of this provider. Upgrade to at least azure-native:migrate/v20220801:MoveResource to guarantee forwards compatibility.")
        return new MoveResource(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20210101:MoveResource';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.v20210101.MoveResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MoveResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:MoveResource" }, { type: "azure-native:migrate/v20191001preview:MoveResource" }, { type: "azure-native:migrate/v20210801:MoveResource" }, { type: "azure-native:migrate/v20220801:MoveResource" }] };
...
export interface MoveResourceArgs {
     ...
     * Defines the move resource properties.
     */
    properties?: pulumi.Input<inputs.migrate.v20210101.MoveResourcePropertiesArgs>;
    /**
