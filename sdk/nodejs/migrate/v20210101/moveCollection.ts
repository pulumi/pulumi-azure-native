...
export class MoveCollection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MoveCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate/v20210101:MoveCollection" }, { type: "azure-native:migrate:MoveCollection" }, { type: "azure-nextgen:migrate:MoveCollection" }, { type: "azure-native:migrate/v20191001preview:MoveCollection" }, { type: "azure-nextgen:migrate/v20191001preview:MoveCollection" }] };
