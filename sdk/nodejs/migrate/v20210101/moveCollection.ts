 ...
 *
 * const moveCollection = new azure_native.migrate.v20210101.MoveCollection("moveCollection", {
 *     identity: {
 *         type: "SystemAssigned",
 *     },
 *     location: "eastus2",
...
export class MoveCollection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MoveCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:MoveCollection" }, { type: "azure-native:migrate/v20191001preview:MoveCollection" }, { type: "azure-native:migrate/v20210801:MoveCollection" }, { type: "azure-native:migrate/v20220801:MoveCollection" }] };
