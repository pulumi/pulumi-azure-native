...
export class MoveCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20210101:MoveCollection';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.migrate.v20210101.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.migrate.v20210101.MoveCollectionPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: MoveCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate/v20210101:MoveCollection" }, { type: "azure-native:migrate:MoveCollection" }, { type: "azure-nextgen:migrate:MoveCollection" }, { type: "azure-native:migrate/latest:MoveCollection" }, { type: "azure-nextgen:migrate/latest:MoveCollection" }, { type: "azure-native:migrate/v20191001preview:MoveCollection" }, { type: "azure-nextgen:migrate/v20191001preview:MoveCollection" }] };
...
export interface MoveCollectionArgs {
     ...
     * Defines the MSI properties of the Move Collection.
     */
    readonly identity?: pulumi.Input<inputs.migrate.v20210101.Identity>;
    /**
     * The geo-location where the resource lives.
     */
     ...
     * Defines the move collection properties.
     */
    readonly properties?: pulumi.Input<inputs.migrate.v20210101.MoveCollectionProperties>;
    /**
