...
export class AssessmentProjectsWebAppAssessmentV2Operation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssessmentProjectsWebAppAssessmentV2OperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230401preview:AssessmentProjectsWebAppAssessmentV2Operation" }, { type: "azure-native:migrate/v20230501preview:AssessmentProjectsWebAppAssessmentV2Operation" }, { type: "azure-native:migrate:AssessmentProjectsWebAppAssessmentV2Operation" }] };
