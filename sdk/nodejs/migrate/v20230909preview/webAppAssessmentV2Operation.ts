...
export class WebAppAssessmentV2Operation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230909preview:WebAppAssessmentV2Operation';
     ...
     */
    public readonly appSvcContainerSettings!: pulumi.Output<outputs.migrate.v20230909preview.AppSvcContainerSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable app service native settings.
     */
    public readonly appSvcNativeSettings!: pulumi.Output<outputs.migrate.v20230909preview.AppSvcNativeSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly discoveredEntityLightSummary!: pulumi.Output<outputs.migrate.v20230909preview.DiscoveredEntityLightSummaryResponse | undefined>;
    /**
     ...
     */
    public readonly entityUptime!: pulumi.Output<outputs.migrate.v20230909preview.EntityUptimeResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppAssessmentV2OperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230401preview:WebAppAssessmentV2Operation" }, { type: "azure-native:migrate/v20230501preview:WebAppAssessmentV2Operation" }, { type: "azure-native:migrate/v20240101preview:WebAppAssessmentV2Operation" }, { type: "azure-native:migrate:WebAppAssessmentV2Operation" }] };
...
export interface WebAppAssessmentV2OperationArgs {
     ...
     * Gets or sets user configurable app service container database settings.
     */
    appSvcContainerSettings?: pulumi.Input<inputs.migrate.v20230909preview.AppSvcContainerSettingsArgs>;
    /**
     * Gets or sets user configurable app service native settings.
     */
    appSvcNativeSettings?: pulumi.Input<inputs.migrate.v20230909preview.AppSvcNativeSettingsArgs>;
    /**
     ...
     * Assessment type of the assessment.
     */
    assessmentType?: pulumi.Input<string | enums.migrate.v20230909preview.AssessmentType>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
     ...
     * Gets or sets a value indicating azure security offering type.
     */
    azureSecurityOfferingType?: pulumi.Input<string | enums.migrate.v20230909preview.AzureSecurityOfferingType>;
    /**
     * Confidence Rating in Percentage.
     */
     ...
     * Gets or sets user configurable discovered entity settings.
     */
    discoveredEntityLightSummary?: pulumi.Input<inputs.migrate.v20230909preview.DiscoveredEntityLightSummaryArgs>;
    /**
     * Gets or sets the Enterprise agreement subscription id.
     */
     ...
     * on-premises environment.
     */
    entityUptime?: pulumi.Input<inputs.migrate.v20230909preview.EntityUptimeArgs>;
    /**
     * Gets or sets user configurable setting to display the environment type.
     */
    environmentType?: pulumi.Input<string | enums.migrate.v20230909preview.EnvironmentType>;
    /**
     * Group ARM name
     */
     ...
     * Gets the group type for the assessment.
     */
    groupType?: pulumi.Input<string | enums.migrate.v20230909preview.GroupType>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
