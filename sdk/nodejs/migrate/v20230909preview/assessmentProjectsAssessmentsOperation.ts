 ...
 */
export class AssessmentProjectsAssessmentsOperation extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AssessmentProjectsAssessmentsOperation {
        return new AssessmentProjectsAssessmentsOperation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230909preview:AssessmentProjectsAssessmentsOperation';

    /**
     * Returns true if the given object is an instance of AssessmentProjectsAssessmentsOperation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AssessmentProjectsAssessmentsOperation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AssessmentProjectsAssessmentsOperation.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly costComponents!: pulumi.Output<outputs.migrate.v20230909preview.CostComponentResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.migrate.v20230909preview.SystemDataResponse>;
    /**
     ...
     * environment.
     */
    public readonly vmUptime!: pulumi.Output<outputs.migrate.v20230909preview.VmUptimeResponse | undefined>;
     ...
     */
    constructor(name: string, args: AssessmentProjectsAssessmentsOperationArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface AssessmentProjectsAssessmentsOperationArgs {
    /**
     ...
     * Gets or sets the azure storage type. Premium, Standard etc.
     */
    azureDiskTypes?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230909preview.AzureDiskType>[]>;
    /**
     * Gets or sets the user configurable setting to display the azure hybrid use
     * benefit.
     */
    azureHybridUseBenefit?: pulumi.Input<string | enums.migrate.v20230909preview.AzureHybridUseBenefit>;
    /**
     * Azure Location or Azure region where to which the machines will be migrated.
     */
     ...
     * Azure Offer Code.
     */
    azureOfferCode?: pulumi.Input<string | enums.migrate.v20230909preview.AzureOfferCode>;
    /**
     * Gets or sets Azure Pricing Tier - Free, Basic, etc.
     */
    azurePricingTier?: pulumi.Input<string | enums.migrate.v20230909preview.AzurePricingTier>;
    /**
     * Gets or sets the Azure Storage Redundancy. Example: Locally Redundant Storage.
     */
    azureStorageRedundancy?: pulumi.Input<string | enums.migrate.v20230909preview.AzureStorageRedundancy>;
    /**
     * Gets or sets the Azure VM families.
     */
    azureVmFamilies?: pulumi.Input<pulumi.Input<string | enums.migrate.v20230909preview.AzureVmFamily>[]>;
    /**
     * Currency in which prices should be reported.
     */
    currency?: pulumi.Input<string | enums.migrate.v20230909preview.AzureCurrency>;
    /**
     * Custom discount percentage.
     */
     ...
     * benefit.
     */
    linuxAzureHybridUseBenefit?: pulumi.Input<string | enums.migrate.v20230909preview.AzureHybridUseBenefit>;
    /**
     * Percentile of the utilization data values to be considered while assessing
     * machines.
     */
    percentile?: pulumi.Input<string | enums.migrate.v20230909preview.Percentile>;
    /**
     * Gets or sets the end time to consider performance data for assessment.
     */
     ...
     * The status of the last operation.
     */
    provisioningState?: pulumi.Input<string | enums.migrate.v20230909preview.ProvisioningState>;
    /**
     * Gets or sets the Azure Reserved Instance - 1-Year, 3-Year.
     */
    reservedInstance?: pulumi.Input<string | enums.migrate.v20230909preview.AzureReservedInstance>;
    /**
     ...
     * Assessment sizing criterion.
     */
    sizingCriterion?: pulumi.Input<string | enums.migrate.v20230909preview.AssessmentSizingCriterion>;
    /**
     * Time Range for which the historic utilization data should be considered for
     * assessment.
     */
    timeRange?: pulumi.Input<string | enums.migrate.v20230909preview.TimeRange>;
    /**
     * Gets or sets the duration for which the VMs are up in the on-premises
     * environment.
     */
    vmUptime?: pulumi.Input<inputs.migrate.v20230909preview.VmUptimeArgs>;
}
