...
export function getAssessmentsOperation(args: GetAssessmentsOperationArgs, opts?: pulumi.InvokeOptions): Promise<GetAssessmentsOperationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:migrate/v20230909preview:getAssessmentsOperation", {
...
export interface GetAssessmentsOperationResult {
     ...
     */
    readonly costComponents: outputs.migrate.v20230909preview.CostComponentResponse[];
    /**
     ...
     * environment.
     */
    readonly vmUptime?: outputs.migrate.v20230909preview.VmUptimeResponse;
}
/**
 * Get a Assessment
 */
export function getAssessmentsOperationOutput(args: GetAssessmentsOperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAssessmentsOperationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:migrate/v20230909preview:getAssessmentsOperation", {
        "assessmentName": args.assessmentName,
        "groupName": args.groupName,
        "projectName": args.projectName,
        "resourceGroupName": args.resourceGroupName,
