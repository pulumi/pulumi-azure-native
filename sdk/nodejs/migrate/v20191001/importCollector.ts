...
export class ImportCollector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ImportCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate/v20191001:ImportCollector" }, { type: "azure-native:migrate:ImportCollector" }, { type: "azure-nextgen:migrate:ImportCollector" }] };
...
export interface ImportCollectorArgs {
    ...
    readonly properties?: pulumi.Input<inputs.migrate.v20191001.ImportCollectorProperties>;
    /**
