...
export class VMwareCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:migrate/v20191001:VMwareCollector';
    ...
    constructor(name: string, args: VMwareCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if ((!args || args.vmWareCollectorName === undefined) && !(opts && opts.urn)) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate:VMwareCollector" }, { type: "azure-nextgen:migrate/latest:VMwareCollector" }] };
