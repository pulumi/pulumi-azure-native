...
export class Solution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:migrate:Solution';
    ...
    constructor(name: string, args: SolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:migrate/v20180901preview:Solution" }] };
...
export interface SolutionArgs {
     ...
     * Gets or sets the properties of the solution.
     */
    readonly properties?: pulumi.Input<inputs.migrate.SolutionProperties>;
    /**
