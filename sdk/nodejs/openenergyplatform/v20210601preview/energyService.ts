...
export class EnergyService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnergyService {
        pulumi.log.warn("EnergyService is deprecated: azure-native:openenergyplatform/v20210601preview:EnergyService is being removed in the next major version of this provider. Upgrade to at least azure-native:openenergyplatform/v20220404preview:EnergyService to guarantee forwards compatibility.")
