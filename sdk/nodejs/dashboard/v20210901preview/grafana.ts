...
export class Grafana extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.dashboard.v20210901preview.ManagedIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.dashboard.v20210901preview.ResourceSkuResponse | undefined>;
    /**
     * The system meta data relating to this grafana resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.dashboard.v20210901preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: GrafanaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dashboard/v20220501preview:Grafana" }, { type: "azure-native:dashboard/v20220801:Grafana" }, { type: "azure-native:dashboard/v20221001preview:Grafana" }, { type: "azure-native:dashboard/v20230901:Grafana" }, { type: "azure-native:dashboard/v20231001preview:Grafana" }, { type: "azure-native:dashboard/v20241001:Grafana" }, { type: "azure-native:dashboard:Grafana" }] };
