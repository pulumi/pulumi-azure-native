...
export interface GetGrafanaResult {
     ...
     */
    readonly identity?: outputs.dashboard.v20220501preview.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.dashboard.v20220501preview.ManagedGrafanaPropertiesResponse;
    /**
     * The Sku of the grafana resource.
     */
    readonly sku?: outputs.dashboard.v20220501preview.ResourceSkuResponse;
    /**
...
export function getGrafanaOutput(args: GetGrafanaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGrafanaResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:dashboard/v20220501preview:getGrafana", {
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
}
