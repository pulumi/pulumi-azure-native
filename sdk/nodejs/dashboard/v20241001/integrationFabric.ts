...
export class IntegrationFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dashboard/v20241001:IntegrationFabric';
    ...
    public readonly properties!: pulumi.Output<outputs.dashboard.v20241001.IntegrationFabricPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: IntegrationFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dashboard:IntegrationFabric" }, { type: "azure-native:dashboard/v20231001preview:IntegrationFabric" }] };
...
export interface IntegrationFabricArgs {
    ...
    properties?: pulumi.Input<inputs.dashboard.v20241001.IntegrationFabricPropertiesArgs>;
    /**
