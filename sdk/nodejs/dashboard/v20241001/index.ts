...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dashboard/v20241001:Grafana":
                return new Grafana(name, <any>undefined, { urn })
            case "azure-native:dashboard/v20241001:IntegrationFabric":
                return new IntegrationFabric(name, <any>undefined, { urn })
            case "azure-native:dashboard/v20241001:ManagedPrivateEndpoint":
                return new ManagedPrivateEndpoint(name, <any>undefined, { urn })
            case "azure-native:dashboard/v20241001:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "dashboard/v20241001", _module)
