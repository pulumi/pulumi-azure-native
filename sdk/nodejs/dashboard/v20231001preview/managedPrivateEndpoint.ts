...
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dashboard/v20231001preview:ManagedPrivateEndpoint';
     ...
     */
    public /*out*/ readonly connectionState!: pulumi.Output<outputs.dashboard.v20231001preview.ManagedPrivateEndpointConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: ManagedPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dashboard/v20221001preview:ManagedPrivateEndpoint" }, { type: "azure-native:dashboard/v20230901:ManagedPrivateEndpoint" }, { type: "azure-native:dashboard/v20241001:ManagedPrivateEndpoint" }, { type: "azure-native:dashboard:ManagedPrivateEndpoint" }] };
