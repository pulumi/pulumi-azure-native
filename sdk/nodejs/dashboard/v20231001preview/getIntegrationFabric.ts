...
export function getIntegrationFabric(args: GetIntegrationFabricArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationFabricResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dashboard/v20231001preview:getIntegrationFabric", {
...
export interface GetIntegrationFabricResult {
    ...
    readonly properties: outputs.dashboard.v20231001preview.IntegrationFabricPropertiesResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.dashboard.v20231001preview.SystemDataResponse;
    /**
     * Resource tags.
     */
