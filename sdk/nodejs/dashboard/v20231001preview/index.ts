...
// Export enums:
export * from "../../types/enums/dashboard/v20231001preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dashboard/v20231001preview:Grafana":
            ...
            case "azure-native:dashboard/v20231001preview:ManagedPrivateEndpoint":
                return new ManagedPrivateEndpoint(name, <any>undefined, { urn })
            case "azure-native:dashboard/v20231001preview:PrivateEndpointConnection":
