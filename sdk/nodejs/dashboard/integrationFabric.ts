...
export class IntegrationFabric extends pulumi.CustomResource {
    ...
    declare public readonly properties: pulumi.Output<outputs.dashboard.IntegrationFabricPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: IntegrationFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["integrationFabricName"] = args?.integrationFabricName;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dashboard/v20231001preview:IntegrationFabric" }, { type: "azure-native:dashboard/v20241001:IntegrationFabric" }, { type: "azure-native:dashboard/v20241101preview:IntegrationFabric" }, { type: "azure-native:dashboard/v20250801:IntegrationFabric" }, { type: "azure-native:dashboard/v20250901preview:IntegrationFabric" }] };
