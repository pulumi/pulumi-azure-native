...
export class Disk extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DiskArgs | DiskState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            inputs["managedByExtended"] = state ? state.managedByExtended : undefined;
...
export interface DiskState {
     ...
     * List of relative URIs containing the IDs of the VMs that have the disk attached. maxShares should be set to a value greater than one for disks to allow attaching them to multiple VMs.
     */
    readonly managedByExtended: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * Resource name
     */
     ...
     * Disk resource properties.
     */
    readonly properties: pulumi.Input<inputs.compute.DiskPropertiesResponse>;
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, or UltraSSD_LRS.
     */
    readonly sku?: pulumi.Input<inputs.compute.DiskSkuResponse>;
    /**
     * Resource tags
     */
