...
export function getGalleryApplicationVersion(args: GetGalleryApplicationVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetGalleryApplicationVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20200930:getGalleryApplicationVersion", {
        "expand": args.expand,
...
export interface GetGalleryApplicationVersionResult {
     ...
     */
    readonly publishingProfile: outputs.compute.v20200930.GalleryApplicationVersionPublishingProfileInvokeResponse;
    /**
