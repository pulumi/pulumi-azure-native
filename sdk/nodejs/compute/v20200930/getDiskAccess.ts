...
export function getDiskAccess(args: GetDiskAccessArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskAccessResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20200930:getDiskAccess", {
...
export interface GetDiskAccessResult {
     ...
     */
    readonly privateEndpointConnections: outputs.compute.v20200930.PrivateEndpointConnectionInvokeResponse[];
    /**
