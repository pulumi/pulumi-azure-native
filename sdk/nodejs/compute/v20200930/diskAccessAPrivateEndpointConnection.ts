...
export class DiskAccessAPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DiskAccessAPrivateEndpointConnection {
        pulumi.log.warn("DiskAccessAPrivateEndpointConnection is deprecated: azure-native:compute/v20200930:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.")
        return new DiskAccessAPrivateEndpointConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20200930:DiskAccessAPrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.compute.v20200930.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.compute.v20200930.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface DiskAccessAPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.compute.v20200930.PrivateLinkServiceConnectionStateArgs>;
    /**
