...
export class DiskAccessAPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DiskAccessAPrivateEndpointConnection {
        pulumi.log.warn("DiskAccessAPrivateEndpointConnection is deprecated: azure-native:compute/v20200930:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.")
