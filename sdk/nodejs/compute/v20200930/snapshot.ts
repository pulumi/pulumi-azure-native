 ...
 * Snapshot resource.
 *
 * @deprecated Version 2020-09-30 will be removed in v2 of the provider.
 */
export class Snapshot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Snapshot {
        pulumi.log.warn("Snapshot is deprecated: Version 2020-09-30 will be removed in v2 of the provider.")
