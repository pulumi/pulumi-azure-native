...
export class Snapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20200930:Snapshot';
     ...
     */
    public readonly creationData!: pulumi.Output<outputs.compute.v20200930.CreationDataResponse>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.compute.v20200930.EncryptionResponse | undefined>;
    /**
     * Encryption settings collection used be Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    public readonly encryptionSettingsCollection!: pulumi.Output<outputs.compute.v20200930.EncryptionSettingsCollectionResponse | undefined>;
    /**
     * The extended location where the snapshot will be created. Extended location cannot be changed.
     */
    public readonly extendedLocation!: pulumi.Output<outputs.compute.v20200930.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly purchasePlan!: pulumi.Output<outputs.compute.v20200930.PurchasePlanResponse | undefined>;
    /**
     * The snapshots sku name. Can be Standard_LRS, Premium_LRS, or Standard_ZRS. This is an optional parameter for incremental snapshot and the default behavior is the SKU will be set to the same sku as the previous snapshot
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20200930.SnapshotSkuResponse | undefined>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: SnapshotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20200930:Snapshot" }, { type: "azure-native:compute:Snapshot" }, { type: "azure-nextgen:compute:Snapshot" }, { type: "azure-native:compute/latest:Snapshot" }, { type: "azure-nextgen:compute/latest:Snapshot" }, { type: "azure-native:compute/v20160430preview:Snapshot" }, { type: "azure-nextgen:compute/v20160430preview:Snapshot" }, { type: "azure-native:compute/v20170330:Snapshot" }, { type: "azure-nextgen:compute/v20170330:Snapshot" }, { type: "azure-native:compute/v20180401:Snapshot" }, { type: "azure-nextgen:compute/v20180401:Snapshot" }, { type: "azure-native:compute/v20180601:Snapshot" }, { type: "azure-nextgen:compute/v20180601:Snapshot" }, { type: "azure-native:compute/v20180930:Snapshot" }, { type: "azure-nextgen:compute/v20180930:Snapshot" }, { type: "azure-native:compute/v20190301:Snapshot" }, { type: "azure-nextgen:compute/v20190301:Snapshot" }, { type: "azure-native:compute/v20190701:Snapshot" }, { type: "azure-nextgen:compute/v20190701:Snapshot" }, { type: "azure-native:compute/v20191101:Snapshot" }, { type: "azure-nextgen:compute/v20191101:Snapshot" }, { type: "azure-native:compute/v20200501:Snapshot" }, { type: "azure-nextgen:compute/v20200501:Snapshot" }, { type: "azure-native:compute/v20200630:Snapshot" }, { type: "azure-nextgen:compute/v20200630:Snapshot" }, { type: "azure-native:compute/v20201201:Snapshot" }, { type: "azure-nextgen:compute/v20201201:Snapshot" }] };
...
export interface SnapshotArgs {
     ...
     * Policy for accessing the disk via network.
     */
    readonly networkAccessPolicy?: pulumi.Input<string | enums.compute.v20200930.NetworkAccessPolicy>;
    /**
     * The Operating System type.
     */
     ...
     * The snapshots sku name. Can be Standard_LRS, Premium_LRS, or Standard_ZRS. This is an optional parameter for incremental snapshot and the default behavior is the SKU will be set to the same sku as the previous snapshot
     */
    readonly sku?: pulumi.Input<inputs.compute.v20200930.SnapshotSku>;
    /**
