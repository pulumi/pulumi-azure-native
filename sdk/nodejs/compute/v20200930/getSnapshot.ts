...
export function getSnapshot(args: GetSnapshotArgs, opts?: pulumi.InvokeOptions): Promise<GetSnapshotResult> {
    pulumi.log.warn("getSnapshot is deprecated: azure-native:compute/v20200930:Snapshot is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:Snapshot to guarantee forwards compatibility.")
