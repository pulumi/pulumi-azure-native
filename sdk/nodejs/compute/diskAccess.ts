...
export class DiskAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:compute:DiskAccess';
    ...
    constructor(name: string, args: DiskAccessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/latest:DiskAccess" }, { type: "azure-nextgen:compute/v20200501:DiskAccess" }, { type: "azure-nextgen:compute/v20200630:DiskAccess" }, { type: "azure-nextgen:compute/v20200930:DiskAccess" }] };
