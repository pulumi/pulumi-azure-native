...
export class VirtualMachineScaleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20230901:VirtualMachineScaleSet';
     ...
     */
    public readonly additionalCapabilities!: pulumi.Output<outputs.compute.v20230901.AdditionalCapabilitiesResponse | undefined>;
    /**
     * Policy for automatic repairs.
     */
    public readonly automaticRepairsPolicy!: pulumi.Output<outputs.compute.v20230901.AutomaticRepairsPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly hostGroup!: pulumi.Output<outputs.compute.v20230901.SubResourceResponse | undefined>;
    /**
     * The identity of the virtual machine scale set, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.compute.v20230901.VirtualMachineScaleSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly plan!: pulumi.Output<outputs.compute.v20230901.PlanResponse | undefined>;
    /**
     ...
     */
    public readonly priorityMixPolicy!: pulumi.Output<outputs.compute.v20230901.PriorityMixPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly proximityPlacementGroup!: pulumi.Output<outputs.compute.v20230901.SubResourceResponse | undefined>;
    /**
     * Policy for Resiliency
     */
    public readonly resiliencyPolicy!: pulumi.Output<outputs.compute.v20230901.ResiliencyPolicyResponse | undefined>;
    /**
     * Specifies the policies applied when scaling in Virtual Machines in the Virtual Machine Scale Set.
     */
    public readonly scaleInPolicy!: pulumi.Output<outputs.compute.v20230901.ScaleInPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20230901.SkuResponse | undefined>;
    /**
     * Specifies the Spot Restore properties for the virtual machine scale set.
     */
    public readonly spotRestorePolicy!: pulumi.Output<outputs.compute.v20230901.SpotRestorePolicyResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    public readonly upgradePolicy!: pulumi.Output<outputs.compute.v20230901.UpgradePolicyResponse | undefined>;
    /**
     * The virtual machine profile.
     */
    public readonly virtualMachineProfile!: pulumi.Output<outputs.compute.v20230901.VirtualMachineScaleSetVMProfileResponse | undefined>;
    /**
...
export interface VirtualMachineScaleSetArgs {
     ...
     * Policy for automatic repairs.
     */
    automaticRepairsPolicy?: pulumi.Input<inputs.compute.v20230901.AutomaticRepairsPolicyArgs>;
    /**
     * Optional property which must either be set to True or omitted.
     */
     ...
     * Specifies information about the dedicated host group that the virtual machine scale set resides in. Minimum api-version: 2020-06-01.
     */
    hostGroup?: pulumi.Input<inputs.compute.v20230901.SubResourceArgs>;
    /**
     * The identity of the virtual machine scale set, if configured.
     */
    identity?: pulumi.Input<inputs.compute.v20230901.VirtualMachineScaleSetIdentityArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the orchestration mode for the virtual machine scale set.
     */
    orchestrationMode?: pulumi.Input<string | enums.compute.v20230901.OrchestrationMode>;
    /**
     * Specifies whether the Virtual Machine Scale Set should be overprovisioned.
     */
     ...
     * Specifies the desired targets for mixing Spot and Regular priority VMs within the same VMSS Flex instance.
     */
    priorityMixPolicy?: pulumi.Input<inputs.compute.v20230901.PriorityMixPolicyArgs>;
    /**
     * Specifies information about the proximity placement group that the virtual machine scale set should be assigned to. Minimum api-version: 2018-04-01.
     */
    proximityPlacementGroup?: pulumi.Input<inputs.compute.v20230901.SubResourceArgs>;
    /**
     * Policy for Resiliency
     */
    resiliencyPolicy?: pulumi.Input<inputs.compute.v20230901.ResiliencyPolicyArgs>;
    /**
     ...
     * Specifies the policies applied when scaling in Virtual Machines in the Virtual Machine Scale Set.
     */
    scaleInPolicy?: pulumi.Input<inputs.compute.v20230901.ScaleInPolicyArgs>;
    /**
     * When true this limits the scale set to a single placement group, of max size 100 virtual machines. NOTE: If singlePlacementGroup is true, it may be modified to false. However, if singlePlacementGroup is false, it may not be modified to true.
     */
     ...
     * Specifies the Spot Restore properties for the virtual machine scale set.
     */
    spotRestorePolicy?: pulumi.Input<inputs.compute.v20230901.SpotRestorePolicyArgs>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    upgradePolicy?: pulumi.Input<inputs.compute.v20230901.UpgradePolicyArgs>;
    /**
     * The virtual machine profile.
     */
    virtualMachineProfile?: pulumi.Input<inputs.compute.v20230901.VirtualMachineScaleSetVMProfileArgs>;
    /**
