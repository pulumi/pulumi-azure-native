...
export class CapacityReservationGroup extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly capacityReservations!: pulumi.Output<outputs.compute.v20230901.SubResourceReadOnlyResponse[]>;
    /**
     * The capacity reservation group instance view which has the list of instance views for all the capacity reservations that belong to the capacity reservation group.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20230901.CapacityReservationGroupInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly sharingProfile!: pulumi.Output<outputs.compute.v20230901.ResourceSharingProfileResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public /*out*/ readonly virtualMachinesAssociated!: pulumi.Output<outputs.compute.v20230901.SubResourceReadOnlyResponse[]>;
    /**
...
export interface CapacityReservationGroupArgs {
     ...
     * Specifies the settings to enable sharing across subscriptions for the capacity reservation group resource. Pls. keep in mind the capacity reservation group resource generally can be shared across subscriptions belonging to a single azure AAD tenant or cross AAD tenant if there is a trust relationship established between the AAD tenants. **Note:** Minimum api-version: 2023-09-01. Please refer to https://aka.ms/computereservationsharing for more details.
     */
    sharingProfile?: pulumi.Input<inputs.compute.v20230901.ResourceSharingProfileArgs>;
    /**
     * Resource tags
     */
