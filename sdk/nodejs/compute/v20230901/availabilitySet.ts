...
export class AvailabilitySet extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.compute.v20230901.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.compute.v20230901.SubResourceResponse[] | undefined>;
...
export interface AvailabilitySetArgs {
     ...
     * A list of references to all virtual machines in the availability set.
     */
    virtualMachines?: pulumi.Input<pulumi.Input<inputs.compute.v20230901.SubResourceArgs>[]>;
}
