...
export class GalleryApplicationVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute:GalleryApplicationVersion';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.GalleryApplicationVersionPropertiesResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: GalleryApplicationVersionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface GalleryApplicationVersionArgs {
     ...
     * Describes the properties of a gallery Image Version.
     */
    readonly properties?: pulumi.Input<inputs.compute.GalleryApplicationVersionProperties>;
    /**
