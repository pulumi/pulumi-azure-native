...
export class VirtualMachineScaleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute:VirtualMachineScaleSet';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.VirtualMachineScaleSetPropertiesResponse>;
    /**
...
export interface VirtualMachineScaleSetState {
     ...
     * The identity of the virtual machine scale set, if configured.
     */
    readonly identity?: pulumi.Input<inputs.compute.VirtualMachineScaleSetIdentityResponse>;
    /**
     * Resource location
     */
     ...
     * Describes the properties of a Virtual Machine Scale Set.
     */
    readonly properties: pulumi.Input<inputs.compute.VirtualMachineScaleSetPropertiesResponse>;
    /**
     * The virtual machine scale set sku.
     */
...
export interface VirtualMachineScaleSetArgs {
     ...
     * Describes the properties of a Virtual Machine Scale Set.
     */
    readonly properties?: pulumi.Input<inputs.compute.VirtualMachineScaleSetProperties>;
    /**
