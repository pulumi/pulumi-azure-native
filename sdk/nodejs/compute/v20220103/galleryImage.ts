 ...
 *
 * @deprecated azure-native:compute/v20220103:GalleryImage is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220303:GalleryImage to guarantee forwards compatibility.
 */
export class GalleryImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220103:GalleryImage';
     ...
     */
    public readonly disallowed!: pulumi.Output<outputs.compute.v20220103.DisallowedResponse | undefined>;
    /**
     ...
     */
    public readonly features!: pulumi.Output<outputs.compute.v20220103.GalleryImageFeatureResponse[] | undefined>;
    /**
     ...
     */
    public readonly identifier!: pulumi.Output<outputs.compute.v20220103.GalleryImageIdentifierResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly purchasePlan!: pulumi.Output<outputs.compute.v20220103.ImagePurchasePlanResponse | undefined>;
    /**
     * The properties describe the recommended machine configuration for this Image Definition. These properties are updatable.
     */
    public readonly recommended!: pulumi.Output<outputs.compute.v20220103.RecommendedMachineConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: GalleryImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:GalleryImage" }, { type: "azure-native:compute/v20180601:GalleryImage" }, { type: "azure-native:compute/v20190301:GalleryImage" }, { type: "azure-native:compute/v20190701:GalleryImage" }, { type: "azure-native:compute/v20191201:GalleryImage" }, { type: "azure-native:compute/v20200930:GalleryImage" }, { type: "azure-native:compute/v20210701:GalleryImage" }, { type: "azure-native:compute/v20211001:GalleryImage" }, { type: "azure-native:compute/v20220303:GalleryImage" }] };
...
export interface GalleryImageArgs {
     ...
     * The architecture of the image. Applicable to OS disks only.
     */
    architecture?: pulumi.Input<string | enums.compute.v20220103.Architecture>;
    /**
     * The description of this gallery image definition resource. This property is updatable.
     */
     ...
     * Describes the disallowed disk types.
     */
    disallowed?: pulumi.Input<inputs.compute.v20220103.DisallowedArgs>;
    /**
     * The end of life date of the gallery image definition. This property can be used for decommissioning purposes. This property is updatable.
     */
     ...
     * A list of gallery image features.
     */
    features?: pulumi.Input<pulumi.Input<inputs.compute.v20220103.GalleryImageFeatureArgs>[]>;
    /**
     ...
     * The hypervisor generation of the Virtual Machine. Applicable to OS disks only.
     */
    hyperVGeneration?: pulumi.Input<string | enums.compute.v20220103.HyperVGeneration>;
    /**
     * This is the gallery image definition identifier.
     */
    identifier: pulumi.Input<inputs.compute.v20220103.GalleryImageIdentifierArgs>;
    /**
     * Resource location
     */
     ...
     * This property allows the user to specify whether the virtual machines created under this image are 'Generalized' or 'Specialized'.
     */
    osState: pulumi.Input<enums.compute.v20220103.OperatingSystemStateTypes>;
    /**
     * This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. <br><br> Possible values are: <br><br> **Windows** <br><br> **Linux**
     */
    osType: pulumi.Input<enums.compute.v20220103.OperatingSystemTypes>;
    /**
     * The privacy statement uri.
     */
     ...
     * Describes the gallery image definition purchase plan. This is used by marketplace images.
     */
    purchasePlan?: pulumi.Input<inputs.compute.v20220103.ImagePurchasePlanArgs>;
    /**
     * The properties describe the recommended machine configuration for this Image Definition. These properties are updatable.
     */
    recommended?: pulumi.Input<inputs.compute.v20220103.RecommendedMachineConfigurationArgs>;
    /**
     * The release note uri.
     */
