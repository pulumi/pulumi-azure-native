 ...
 */
/** @deprecated azure-native:compute/v20220103:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility. */
export function getGalleryApplicationVersion(args: GetGalleryApplicationVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetGalleryApplicationVersionResult> {
    pulumi.log.warn("getGalleryApplicationVersion is deprecated: azure-native:compute/v20220103:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20220103:getGalleryApplicationVersion", {
        "expand": args.expand,
...
export interface GetGalleryApplicationVersionResult {
     ...
     */
    readonly publishingProfile: outputs.compute.v20220103.GalleryApplicationVersionPublishingProfileResponse;
    /**
