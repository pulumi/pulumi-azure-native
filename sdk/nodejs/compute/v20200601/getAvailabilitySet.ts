...
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilitySetResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20200601:getAvailabilitySet", {
...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly statuses: outputs.compute.v20200601.InstanceViewStatusInvokeResponse[];
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachines?: outputs.compute.v20200601.SubResourceInvokeResponse[];
}
