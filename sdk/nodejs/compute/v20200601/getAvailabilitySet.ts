...
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilitySetResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20200601:getAvailabilitySet", {
        "name": args.name,
...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly properties: outputs.compute.v20200601.AvailabilitySetPropertiesResponse;
    /**
