 ...
 *
 * const sshPublicKey = new azurerm.compute.v20200601.SshPublicKey("sshPublicKey", {
 *     location: "westus",
...
export class SshPublicKey extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SshPublicKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:SshPublicKey" }, { type: "azurerm:compute/v20191201:SshPublicKey" }] };
