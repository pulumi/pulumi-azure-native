...
export class SshPublicKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20200601:SshPublicKey';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.v20200601.SshPublicKeyResourcePropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface SshPublicKeyArgs {
     ...
     * Properties of the SSH public key.
     */
    readonly properties?: pulumi.Input<inputs.compute.v20200601.SshPublicKeyResourceProperties>;
    /**
