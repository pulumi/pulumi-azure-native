...
azure-native:compute/v20200601:DedicatedHostGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHostGroup to guarantee forwards compatibility.
 */
export class DedicatedHostGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DedicatedHostGroup {
        pulumi.log.warn("DedicatedHostGroup is deprecated: Version 2020-06-01 will be removed in v2 of the provider.\nazure-native:compute/v20200601:DedicatedHostGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHostGroup to guarantee forwards compatibility.")
