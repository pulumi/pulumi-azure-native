...
export class DedicatedHost extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20200601.DedicatedHostInstanceViewResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20200601.SkuResponse>;
    /**
     * Resource tags
     */
     ...
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.v20200601.SubResourceReadOnlyResponse[]>;
    ...
    constructor(name: string, args: DedicatedHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/latest:DedicatedHost" }, { type: "azure-nextgen:compute/v20190301:DedicatedHost" }, { type: "azure-nextgen:compute/v20190701:DedicatedHost" }, { type: "azure-nextgen:compute/v20191201:DedicatedHost" }, { type: "azure-nextgen:compute/v20201201:DedicatedHost" }] };
...
export interface DedicatedHostArgs {
     ...
     * SKU of the dedicated host for Hardware Generation and VM family. Only name is required to be set. List Microsoft.Compute SKUs for a list of possible values.
     */
    readonly sku: pulumi.Input<inputs.compute.v20200601.Sku>;
    /**
     * Resource tags
     */
