...
export class DedicatedHost extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DedicatedHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/v20190301:DedicatedHost" }, { type: "azurerm:compute/v20190701:DedicatedHost" }, { type: "azurerm:compute/v20191201:DedicatedHost" }] };
