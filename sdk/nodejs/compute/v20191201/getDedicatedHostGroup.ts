...
export function getDedicatedHostGroup(args: GetDedicatedHostGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20191201:getDedicatedHostGroup", {
        "name": args.name,
...
export interface GetDedicatedHostGroupResult {
     ...
     */
    readonly properties: outputs.compute.v20191201.DedicatedHostGroupPropertiesResponse;
    /**
     * Resource tags
     */
