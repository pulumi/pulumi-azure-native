...
export class VirtualMachineScaleSetVMExtension extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VirtualMachineScaleSetVMExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/preview:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20190701:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20200601:VirtualMachineScaleSetVMExtension" }] };
