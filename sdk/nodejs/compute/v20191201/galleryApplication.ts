...
export class GalleryApplication extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GalleryApplication {
        pulumi.log.warn("GalleryApplication is deprecated: Version 2019-12-01 will be removed in v2 of the provider.\nazure-native:compute/v20191201:GalleryApplication is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplication to guarantee forwards compatibility.")
        return new GalleryApplication(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20191201:GalleryApplication';
