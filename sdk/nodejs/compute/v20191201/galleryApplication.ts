...
export class GalleryApplication extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: GalleryApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:GalleryApplication" }, { type: "azurerm:compute/preview:GalleryApplication" }, { type: "azurerm:compute/v20190301:GalleryApplication" }, { type: "azurerm:compute/v20190701:GalleryApplication" }] };
