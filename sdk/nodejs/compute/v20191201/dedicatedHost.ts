 ...
 *
 * const dedicatedHost = new azurerm.compute.v20191201.DedicatedHost("dedicatedHost", {
...
export class DedicatedHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20191201:DedicatedHost';
    ...
    constructor(name: string, args: DedicatedHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:DedicatedHost" }, { type: "azurerm:compute/v20190301:DedicatedHost" }, { type: "azurerm:compute/v20190701:DedicatedHost" }, { type: "azurerm:compute/v20200601:DedicatedHost" }] };
