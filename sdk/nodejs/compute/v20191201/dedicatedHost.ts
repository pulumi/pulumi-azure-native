...
export class DedicatedHost extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.v20191201.DedicatedHostPropertiesResponse>;
    /**
...
export interface DedicatedHostArgs {
     ...
     * Properties of the dedicated host.
     */
    readonly properties?: pulumi.Input<inputs.compute.v20191201.DedicatedHostProperties>;
    /**
