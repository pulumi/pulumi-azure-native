...
export function getProximityPlacementGroup(args: GetProximityPlacementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetProximityPlacementGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20191201:getProximityPlacementGroup", {
...
export interface GetProximityPlacementGroupResult {
     ...
     */
    readonly availabilitySets: outputs.compute.v20191201.SubResourceWithColocationStatusInvokeResponse[];
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    readonly colocationStatus?: outputs.compute.v20191201.InstanceViewStatusInvokeResponse;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly virtualMachineScaleSets: outputs.compute.v20191201.SubResourceWithColocationStatusInvokeResponse[];
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    readonly virtualMachines: outputs.compute.v20191201.SubResourceWithColocationStatusInvokeResponse[];
}
