...
export class VirtualMachineExtension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineExtension {
        pulumi.log.warn("VirtualMachineExtension is deprecated: azure-native:compute/v20220301:VirtualMachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:VirtualMachineExtension to guarantee forwards compatibility.")
