 ...
 *
 * @deprecated azure-native:compute/v20220301:VirtualMachineExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineExtension to guarantee forwards compatibility.
 */
export class VirtualMachineExtension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineExtension {
        pulumi.log.warn("VirtualMachineExtension is deprecated: azure-native:compute/v20220301:VirtualMachineExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineExtension to guarantee forwards compatibility.")
        return new VirtualMachineExtension(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220301:VirtualMachineExtension';
     ...
     */
    public readonly instanceView!: pulumi.Output<outputs.compute.v20220301.VirtualMachineExtensionInstanceViewResponse | undefined>;
    /**
     * Resource location
     */
...
export interface VirtualMachineExtensionArgs {
     ...
     * The virtual machine extension instance view.
     */
    instanceView?: pulumi.Input<inputs.compute.v20220301.VirtualMachineExtensionInstanceViewArgs>;
    /**
     * Resource location
     */
