...
export class VirtualMachineScaleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220301:VirtualMachineScaleSet';
     ...
     */
    public readonly automaticRepairsPolicy!: pulumi.Output<outputs.compute.v20220301.AutomaticRepairsPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.compute.v20220301.VirtualMachineScaleSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly scaleInPolicy!: pulumi.Output<outputs.compute.v20220301.ScaleInPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly spotRestorePolicy!: pulumi.Output<outputs.compute.v20220301.SpotRestorePolicyResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    public readonly upgradePolicy!: pulumi.Output<outputs.compute.v20220301.UpgradePolicyResponse | undefined>;
    /**
     * The virtual machine profile.
     */
    public readonly virtualMachineProfile!: pulumi.Output<outputs.compute.v20220301.VirtualMachineScaleSetVMProfileResponse | undefined>;
    /**
...
export interface VirtualMachineScaleSetArgs {
     ...
     * Policy for automatic repairs.
     */
    automaticRepairsPolicy?: pulumi.Input<inputs.compute.v20220301.AutomaticRepairsPolicyArgs>;
    /**
     * When Overprovision is enabled, extensions are launched only on the requested number of VMs which are finally kept. This property will hence ensure that the extensions do not run on the extra overprovisioned VMs.
     */
     ...
     * The identity of the virtual machine scale set, if configured.
     */
    identity?: pulumi.Input<inputs.compute.v20220301.VirtualMachineScaleSetIdentityArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the orchestration mode for the virtual machine scale set.
     */
    orchestrationMode?: pulumi.Input<string | enums.compute.v20220301.OrchestrationMode>;
    /**
     * Specifies whether the Virtual Machine Scale Set should be overprovisioned.
     */
     ...
     * Specifies the policies applied when scaling in Virtual Machines in the Virtual Machine Scale Set.
     */
    scaleInPolicy?: pulumi.Input<inputs.compute.v20220301.ScaleInPolicyArgs>;
    /**
     * When true this limits the scale set to a single placement group, of max size 100 virtual machines. NOTE: If singlePlacementGroup is true, it may be modified to false. However, if singlePlacementGroup is false, it may not be modified to true.
     */
     ...
     * Specifies the Spot Restore properties for the virtual machine scale set.
     */
    spotRestorePolicy?: pulumi.Input<inputs.compute.v20220301.SpotRestorePolicyArgs>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    upgradePolicy?: pulumi.Input<inputs.compute.v20220301.UpgradePolicyArgs>;
    /**
     * The virtual machine profile.
     */
    virtualMachineProfile?: pulumi.Input<inputs.compute.v20220301.VirtualMachineScaleSetVMProfileArgs>;
    /**
