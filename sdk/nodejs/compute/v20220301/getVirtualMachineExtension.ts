...
export function getVirtualMachineExtension(args: GetVirtualMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineExtensionResult> {
    pulumi.log.warn("getVirtualMachineExtension is deprecated: azure-native:compute/v20220301:VirtualMachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:VirtualMachineExtension to guarantee forwards compatibility.")
