...
export class RestorePoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RestorePoint {
        pulumi.log.warn("RestorePoint is deprecated: azure-native:compute/v20220301:RestorePoint is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:RestorePoint to guarantee forwards compatibility.")
        return new RestorePoint(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220301:RestorePoint';
     ...
     */
    public readonly excludeDisks!: pulumi.Output<outputs.compute.v20220301.ApiEntityReferenceResponse[] | undefined>;
    /**
     * The restore point instance view.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20220301.RestorePointInstanceViewResponse>;
    /**
     * Resource name
     */
     ...
     */
    public /*out*/ readonly sourceMetadata!: pulumi.Output<outputs.compute.v20220301.RestorePointSourceMetadataResponse>;
    /**
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    public readonly sourceRestorePoint!: pulumi.Output<outputs.compute.v20220301.ApiEntityReferenceResponse | undefined>;
    /**
...
export interface RestorePointArgs {
     ...
     * ConsistencyMode of the RestorePoint. Can be specified in the input while creating a restore point. For now, only CrashConsistent is accepted as a valid input. Please refer to https://aka.ms/RestorePoints for more details.
     */
    consistencyMode?: pulumi.Input<string | enums.compute.v20220301.ConsistencyModeTypes>;
    /**
     * List of disk resource ids that the customer wishes to exclude from the restore point. If no disks are specified, all disks will be included.
     */
    excludeDisks?: pulumi.Input<pulumi.Input<inputs.compute.v20220301.ApiEntityReferenceArgs>[]>;
    /**
     ...
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    sourceRestorePoint?: pulumi.Input<inputs.compute.v20220301.ApiEntityReferenceArgs>;
    /**
     * Gets the creation time of the restore point.
     */
