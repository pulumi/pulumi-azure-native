 ...
 *
 * @deprecated azure-native:compute/v20220301:CapacityReservation is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:CapacityReservation to guarantee forwards compatibility.
 */
export class CapacityReservation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CapacityReservation {
        pulumi.log.warn("CapacityReservation is deprecated: azure-native:compute/v20220301:CapacityReservation is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:CapacityReservation to guarantee forwards compatibility.")
        return new CapacityReservation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220301:CapacityReservation';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20220301.CapacityReservationInstanceViewResponse>;
    /**
     * Resource location
     */
