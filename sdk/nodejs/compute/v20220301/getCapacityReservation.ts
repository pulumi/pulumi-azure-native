...
export function getCapacityReservation(args: GetCapacityReservationArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityReservationResult> {
    pulumi.log.warn("getCapacityReservation is deprecated: azure-native:compute/v20220301:CapacityReservation is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:CapacityReservation to guarantee forwards compatibility.")
...
export interface GetCapacityReservationResult {
     ...
     */
    readonly instanceView: outputs.compute.v20220301.CapacityReservationInstanceViewResponse;
    /**
     * Resource location
     */
