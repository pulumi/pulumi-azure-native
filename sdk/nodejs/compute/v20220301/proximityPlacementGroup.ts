...
export class ProximityPlacementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220301:ProximityPlacementGroup';
     ...
     */
    public /*out*/ readonly availabilitySets!: pulumi.Output<outputs.compute.v20220301.SubResourceWithColocationStatusResponse[]>;
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    public readonly colocationStatus!: pulumi.Output<outputs.compute.v20220301.InstanceViewStatusResponse | undefined>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    public readonly intent!: pulumi.Output<outputs.compute.v20220301.ProximityPlacementGroupPropertiesResponseIntent | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly virtualMachineScaleSets!: pulumi.Output<outputs.compute.v20220301.SubResourceWithColocationStatusResponse[]>;
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.v20220301.SubResourceWithColocationStatusResponse[]>;
    /**
...
export interface ProximityPlacementGroupArgs {
     ...
     * Describes colocation status of the Proximity Placement Group.
     */
    colocationStatus?: pulumi.Input<inputs.compute.v20220301.InstanceViewStatusArgs>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    intent?: pulumi.Input<inputs.compute.v20220301.ProximityPlacementGroupPropertiesIntentArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the type of the proximity placement group. <br><br> Possible values are: <br><br> **Standard** : Co-locate resources within an Azure region or Availability Zone. <br><br> **Ultra** : For future use.
     */
    proximityPlacementGroupType?: pulumi.Input<string | enums.compute.v20220301.ProximityPlacementGroupType>;
    /**
