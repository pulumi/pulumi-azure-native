...
export class GalleryInVMAccessControlProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20240303:GalleryInVMAccessControlProfile';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.v20240303.GalleryInVMAccessControlProfilePropertiesResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: GalleryInVMAccessControlProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:GalleryInVMAccessControlProfile" }] };
