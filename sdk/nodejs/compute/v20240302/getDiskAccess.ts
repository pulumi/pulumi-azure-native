...
export function getDiskAccess(args: GetDiskAccessArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskAccessResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20240302:getDiskAccess", {
...
export interface GetDiskAccessResult {
     ...
     */
    readonly extendedLocation?: outputs.compute.v20240302.ExtendedLocationResponse;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly privateEndpointConnections: outputs.compute.v20240302.PrivateEndpointConnectionResponse[];
    /**
...
export function getDiskAccessOutput(args: GetDiskAccessOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDiskAccessResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20240302:getDiskAccess", {
        "diskAccessName": args.diskAccessName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
