...
export class DedicatedHost extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20240301.DedicatedHostInstanceViewResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20240301.SkuResponse>;
    /**
     * Resource tags
     */
     ...
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.v20240301.SubResourceReadOnlyResponse[]>;
...
export interface DedicatedHostArgs {
     ...
     * Specifies the software license type that will be applied to the VMs deployed on the dedicated host. Possible values are: **None,** **Windows_Server_Hybrid,** **Windows_Server_Perpetual.** The default value is: **None.**
     */
    licenseType?: pulumi.Input<enums.compute.v20240301.DedicatedHostLicenseTypes>;
    /**
     * Resource location
     */
