...
export interface GetVirtualMachineExtensionResult {
     ...
     */
    readonly instanceView?: outputs.compute.v20240301.VirtualMachineExtensionInstanceViewResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly protectedSettingsFromKeyVault?: outputs.compute.v20240301.KeyVaultSecretReferenceResponse;
    /**
...
export function getVirtualMachineExtensionOutput(args: GetVirtualMachineExtensionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVirtualMachineExtensionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20240301:getVirtualMachineExtension", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "vmExtensionName": args.vmExtensionName,
        "vmName": args.vmName,
