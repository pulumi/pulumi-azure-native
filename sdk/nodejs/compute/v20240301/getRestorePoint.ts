...
export interface GetRestorePointResult {
     ...
     */
    readonly excludeDisks?: outputs.compute.v20240301.ApiEntityReferenceResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: outputs.compute.v20240301.RestorePointInstanceViewResponse;
    /**
     * Resource name
     */
     ...
     */
    readonly sourceMetadata?: outputs.compute.v20240301.RestorePointSourceMetadataResponse;
    /**
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    readonly sourceRestorePoint?: outputs.compute.v20240301.ApiEntityReferenceResponse;
    /**
...
export function getRestorePointOutput(args: GetRestorePointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRestorePointResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20240301:getRestorePoint", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "restorePointCollectionName": args.restorePointCollectionName,
        "restorePointName": args.restorePointName,
