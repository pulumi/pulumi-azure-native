...
export function getDedicatedHost(args: GetDedicatedHostArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20240301:getDedicatedHost", {
        "expand": args.expand,
...
export interface GetDedicatedHostResult {
     ...
     */
    readonly instanceView: outputs.compute.v20240301.DedicatedHostInstanceViewResponse;
    /**
     ...
     */
    readonly sku: outputs.compute.v20240301.SkuResponse;
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachines: outputs.compute.v20240301.SubResourceReadOnlyResponse[];
}
/**
 * Retrieves information about a dedicated host.
 */
export function getDedicatedHostOutput(args: GetDedicatedHostOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedHostResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20240301:getDedicatedHost", {
        "expand": args.expand,
        "hostGroupName": args.hostGroupName,
        "hostName": args.hostName,
        "resourceGroupName": args.resourceGroupName,
