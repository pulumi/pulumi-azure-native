...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly proximityPlacementGroup?: outputs.compute.v20240301.SubResourceResponse;
    /**
     ...
     */
    readonly statuses: outputs.compute.v20240301.InstanceViewStatusResponse[];
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachines?: outputs.compute.v20240301.SubResourceResponse[];
}
/**
 * Retrieves information about an availability set.
 */
export function getAvailabilitySetOutput(args: GetAvailabilitySetOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAvailabilitySetResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20240301:getAvailabilitySet", {
        "availabilitySetName": args.availabilitySetName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
