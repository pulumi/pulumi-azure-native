...
export class CloudService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CloudServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:CloudService" }, { type: "azure-native:compute/v20201001preview:CloudService" }, { type: "azure-native:compute/v20220404:CloudService" }] };
