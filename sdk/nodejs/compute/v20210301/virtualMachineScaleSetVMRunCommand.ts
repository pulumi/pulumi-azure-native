...
export class VirtualMachineScaleSetVMRunCommand extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineScaleSetVMRunCommand {
        pulumi.log.warn("VirtualMachineScaleSetVMRunCommand is deprecated: azure-native:compute/v20210301:VirtualMachineScaleSetVMRunCommand is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVMRunCommand to guarantee forwards compatibility.")
        return new VirtualMachineScaleSetVMRunCommand(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20210301:VirtualMachineScaleSetVMRunCommand';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20210301.VirtualMachineRunCommandInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.compute.v20210301.RunCommandInputParameterResponse[] | undefined>;
    /**
     * The parameters used by the script.
     */
    public readonly protectedParameters!: pulumi.Output<outputs.compute.v20210301.RunCommandInputParameterResponse[] | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.compute.v20210301.VirtualMachineRunCommandScriptSourceResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface VirtualMachineScaleSetVMRunCommandArgs {
     ...
     * The parameters used by the script.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.compute.v20210301.RunCommandInputParameterArgs>[]>;
    /**
     * The parameters used by the script.
     */
    protectedParameters?: pulumi.Input<pulumi.Input<inputs.compute.v20210301.RunCommandInputParameterArgs>[]>;
    /**
     ...
     * The source of the run command script.
     */
    source?: pulumi.Input<inputs.compute.v20210301.VirtualMachineRunCommandScriptSourceArgs>;
    /**
     * Resource tags
     */
