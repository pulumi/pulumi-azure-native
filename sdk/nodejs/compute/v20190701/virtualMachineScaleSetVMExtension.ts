 ...
 *
 * const virtualMachineScaleSetVMExtension = new azurerm.compute.v20190701.VirtualMachineScaleSetVMExtension("virtualMachineScaleSetVMExtension", {
...
export class VirtualMachineScaleSetVMExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20190701:VirtualMachineScaleSetVMExtension';
    ...
    constructor(name: string, argsOrState?: VirtualMachineScaleSetVMExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20191201:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20200601:VirtualMachineScaleSetVMExtension" }] };
