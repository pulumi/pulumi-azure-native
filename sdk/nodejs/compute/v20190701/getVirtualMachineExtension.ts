...
export function getVirtualMachineExtension(args: GetVirtualMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20190701:getVirtualMachineExtension", {
        "expand": args.expand,
...
export interface GetVirtualMachineExtensionResult {
     ...
     */
    readonly instanceView?: outputs.compute.v20190701.VirtualMachineExtensionInstanceViewInvokeResponse;
    /**
     * Resource location
     */
