...
export function getDedicatedHost(args: GetDedicatedHostArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20190701:getDedicatedHost", {
        "expand": args.expand,
...
export interface GetDedicatedHostResult {
     ...
     */
    readonly instanceView: outputs.compute.v20190701.DedicatedHostInstanceViewInvokeResponse;
    /**
     ...
     */
    readonly virtualMachines: outputs.compute.v20190701.SubResourceReadOnlyInvokeResponse[];
}
