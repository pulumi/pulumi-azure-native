 ...
 *
 * const galleryApplication = new azurerm.compute.v20190701.GalleryApplication("galleryApplication", {
...
export class GalleryApplication extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GalleryApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:GalleryApplication" }, { type: "azurerm:compute/v20190301:GalleryApplication" }, { type: "azurerm:compute/v20191201:GalleryApplication" }] };
