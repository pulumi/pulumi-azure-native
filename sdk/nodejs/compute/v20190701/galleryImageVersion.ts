...
export class GalleryImageVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20190701:GalleryImageVersion';
     ...
     */
    public readonly publishingProfile!: pulumi.Output<outputs.compute.v20190701.GalleryImageVersionPublishingProfileResponse | undefined>;
    /**
     ...
     */
    public readonly storageProfile!: pulumi.Output<outputs.compute.v20190701.GalleryImageVersionStorageProfileResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: GalleryImageVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20190701:GalleryImageVersion" }, { type: "azure-native:compute:GalleryImageVersion" }, { type: "azure-nextgen:compute:GalleryImageVersion" }, { type: "azure-native:compute/latest:GalleryImageVersion" }, { type: "azure-nextgen:compute/latest:GalleryImageVersion" }, { type: "azure-native:compute/v20180601:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20180601:GalleryImageVersion" }, { type: "azure-native:compute/v20190301:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20190301:GalleryImageVersion" }, { type: "azure-native:compute/v20191201:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20191201:GalleryImageVersion" }, { type: "azure-native:compute/v20200930:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20200930:GalleryImageVersion" }] };
...
export interface GalleryImageVersionArgs {
     ...
     * The publishing profile of a gallery Image Version.
     */
    readonly publishingProfile?: pulumi.Input<inputs.compute.v20190701.GalleryImageVersionPublishingProfile>;
    /**
     ...
     * This is the storage profile of a Gallery Image Version.
     */
    readonly storageProfile: pulumi.Input<inputs.compute.v20190701.GalleryImageVersionStorageProfile>;
    /**
     * Resource tags
     */
