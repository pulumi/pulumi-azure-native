 ...
 *
 * const dedicatedHostGroup = new azurerm.compute.v20190701.DedicatedHostGroup("dedicatedHostGroup", {
...
export class DedicatedHostGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DedicatedHostGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:DedicatedHostGroup" }, { type: "azurerm:compute/v20190301:DedicatedHostGroup" }, { type: "azurerm:compute/v20191201:DedicatedHostGroup" }, { type: "azurerm:compute/v20200601:DedicatedHostGroup" }] };
