...
export class GalleryImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20190701:GalleryImage';
     ...
     */
    public readonly disallowed!: pulumi.Output<outputs.compute.v20190701.DisallowedResponse | undefined>;
    /**
     ...
     */
    public readonly identifier!: pulumi.Output<outputs.compute.v20190701.GalleryImageIdentifierResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly purchasePlan!: pulumi.Output<outputs.compute.v20190701.ImagePurchasePlanResponse | undefined>;
    /**
     * The properties describe the recommended machine configuration for this Image Definition. These properties are updatable.
     */
    public readonly recommended!: pulumi.Output<outputs.compute.v20190701.RecommendedMachineConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: GalleryImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20190701:GalleryImage" }, { type: "azure-native:compute:GalleryImage" }, { type: "azure-nextgen:compute:GalleryImage" }, { type: "azure-native:compute/latest:GalleryImage" }, { type: "azure-nextgen:compute/latest:GalleryImage" }, { type: "azure-native:compute/v20180601:GalleryImage" }, { type: "azure-nextgen:compute/v20180601:GalleryImage" }, { type: "azure-native:compute/v20190301:GalleryImage" }, { type: "azure-nextgen:compute/v20190301:GalleryImage" }, { type: "azure-native:compute/v20191201:GalleryImage" }, { type: "azure-nextgen:compute/v20191201:GalleryImage" }, { type: "azure-native:compute/v20200930:GalleryImage" }, { type: "azure-nextgen:compute/v20200930:GalleryImage" }] };
...
export interface GalleryImageArgs {
     ...
     * Describes the disallowed disk types.
     */
    readonly disallowed?: pulumi.Input<inputs.compute.v20190701.Disallowed>;
    /**
     * The end of life date of the gallery Image Definition. This property can be used for decommissioning purposes. This property is updatable.
     */
     ...
     * This is the gallery Image Definition identifier.
     */
    readonly identifier: pulumi.Input<inputs.compute.v20190701.GalleryImageIdentifier>;
    /**
     * Resource location
     */
     ...
     * Describes the gallery Image Definition purchase plan. This is used by marketplace images.
     */
    readonly purchasePlan?: pulumi.Input<inputs.compute.v20190701.ImagePurchasePlan>;
    /**
     * The properties describe the recommended machine configuration for this Image Definition. These properties are updatable.
     */
    readonly recommended?: pulumi.Input<inputs.compute.v20190701.RecommendedMachineConfiguration>;
    /**
     * The release note uri.
     */
