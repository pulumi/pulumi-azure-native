...
export function getDedicatedHostGroup(args: GetDedicatedHostGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20190701:getDedicatedHostGroup", {
...
export interface GetDedicatedHostGroupResult {
     ...
     */
    readonly hosts: outputs.compute.v20190701.SubResourceReadOnlyInvokeResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
