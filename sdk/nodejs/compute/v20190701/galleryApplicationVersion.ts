...
azure-native:compute/v20190701:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.
 */
export class GalleryApplicationVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GalleryApplicationVersion {
        pulumi.log.warn("GalleryApplicationVersion is deprecated: Version 2019-07-01 will be removed in v2 of the provider.\nazure-native:compute/v20190701:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.")
