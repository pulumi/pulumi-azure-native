...
export function getGalleryImageVersion(args: GetGalleryImageVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetGalleryImageVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20190701:getGalleryImageVersion", {
        "expand": args.expand,
...
export interface GetGalleryImageVersionResult {
     ...
     */
    readonly publishingProfile?: outputs.compute.v20190701.GalleryImageVersionPublishingProfileInvokeResponse;
    /**
     ...
     */
    readonly storageProfile: outputs.compute.v20190701.GalleryImageVersionStorageProfileInvokeResponse;
    /**
     * Resource tags
     */
