...
export class GalleryApplication extends pulumi.CustomResource {
     ...
     */
    public readonly customActions!: pulumi.Output<outputs.compute.v20220303.GalleryApplicationCustomActionResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: GalleryApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:GalleryApplication" }, { type: "azure-native:compute/v20200930:GalleryApplication" }, { type: "azure-native:compute/v20210701:GalleryApplication" }, { type: "azure-native:compute/v20211001:GalleryApplication" }, { type: "azure-native:compute/v20220103:GalleryApplication" }] };
...
export interface GalleryApplicationArgs {
     ...
     * This property allows you to specify the supported type of the OS that application is built for. <br><br> Possible values are: <br><br> **Windows** <br><br> **Linux**
     */
    supportedOSType: pulumi.Input<enums.compute.v20220303.OperatingSystemTypes>;
    /**
     * Resource tags
     */
