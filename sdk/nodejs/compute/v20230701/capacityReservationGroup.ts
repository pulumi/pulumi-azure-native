...
export class CapacityReservationGroup extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly capacityReservations!: pulumi.Output<outputs.compute.v20230701.SubResourceReadOnlyResponse[]>;
    /**
     * The capacity reservation group instance view which has the list of instance views for all the capacity reservations that belong to the capacity reservation group.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20230701.CapacityReservationGroupInstanceViewResponse>;
    /**
     * Resource location
     */
