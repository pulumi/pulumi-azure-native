...
export function getVirtualMachine(args: GetVirtualMachineArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20150615:getVirtualMachine", {
        "name": args.name,
...
export interface GetVirtualMachineResult {
     ...
     */
    readonly properties: outputs.compute.v20150615.VirtualMachinePropertiesResponse;
    /**
