...
export function getGalleryApplicationVersion(args: GetGalleryApplicationVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetGalleryApplicationVersionResult> {
    pulumi.log.warn("getGalleryApplicationVersion is deprecated: azure-native:compute/v20210701:GalleryApplicationVersion is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.")
