...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20210701:AvailabilitySet';
     ...
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.compute.v20210701.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.compute.v20210701.SubResourceResponse[] | undefined>;
    ...
    constructor(name: string, args: AvailabilitySetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:AvailabilitySet" }, { type: "azure-native:compute/v20201201:AvailabilitySet" }, { type: "azure-native:compute/v20210301:AvailabilitySet" }, { type: "azure-native:compute/v20210401:AvailabilitySet" }, { type: "azure-native:compute/v20211101:AvailabilitySet" }] };
