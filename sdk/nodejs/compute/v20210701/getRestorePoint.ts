...
export function getRestorePoint(args: GetRestorePointArgs, opts?: pulumi.InvokeOptions): Promise<GetRestorePointResult> {
    pulumi.log.warn("getRestorePoint is deprecated: azure-native:compute/v20210701:RestorePoint is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20211101:RestorePoint to guarantee forwards compatibility.")
