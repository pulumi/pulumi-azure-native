 ...
 *
 * @deprecated azure-native:compute/v20210701:RestorePointCollection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:RestorePointCollection to guarantee forwards compatibility.
 */
export class RestorePointCollection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RestorePointCollection {
        pulumi.log.warn("RestorePointCollection is deprecated: azure-native:compute/v20210701:RestorePointCollection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:RestorePointCollection to guarantee forwards compatibility.")
        return new RestorePointCollection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20210701:RestorePointCollection';
     ...
     */
    public /*out*/ readonly restorePoints!: pulumi.Output<outputs.compute.v20210701.RestorePointResponse[]>;
    /**
     * The properties of the source resource that this restore point collection is created from.
     */
    public readonly source!: pulumi.Output<outputs.compute.v20210701.RestorePointCollectionSourcePropertiesResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface RestorePointCollectionArgs {
     ...
     * The properties of the source resource that this restore point collection is created from.
     */
    source?: pulumi.Input<inputs.compute.v20210701.RestorePointCollectionSourcePropertiesArgs>;
    /**
     * Resource tags
     */
