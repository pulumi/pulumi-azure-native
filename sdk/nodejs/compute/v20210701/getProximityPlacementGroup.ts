 ...
 */
/** @deprecated azure-native:compute/v20210701:ProximityPlacementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:ProximityPlacementGroup to guarantee forwards compatibility. */
export function getProximityPlacementGroup(args: GetProximityPlacementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetProximityPlacementGroupResult> {
    pulumi.log.warn("getProximityPlacementGroup is deprecated: azure-native:compute/v20210701:ProximityPlacementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:ProximityPlacementGroup to guarantee forwards compatibility.")
