 ...
 *
 * const diskAccess = new azurerm.compute.v20200501.DiskAccess("diskAccess", {
...
export class DiskAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20200501:DiskAccess';
    ...
    constructor(name: string, argsOrState?: DiskAccessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:DiskAccess" }, { type: "azurerm:compute/v20200630:DiskAccess" }] };
