...
export class DiskAccess extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DiskAccessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:DiskAccess" }, { type: "azure-nextgen:compute:DiskAccess" }, { type: "azure-native:compute/latest:DiskAccess" }, { type: "azure-nextgen:compute/latest:DiskAccess" }, { type: "azure-native:compute/v20200630:DiskAccess" }, { type: "azure-nextgen:compute/v20200630:DiskAccess" }, { type: "azure-native:compute/v20200930:DiskAccess" }, { type: "azure-nextgen:compute/v20200930:DiskAccess" }] };
