...
export function getDiskEncryptionSet(args: GetDiskEncryptionSetArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskEncryptionSetResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20191101:getDiskEncryptionSet", {
        "name": args.name,
...
export interface GetDiskEncryptionSetResult {
     ...
     */
    readonly name: string;
    readonly properties: outputs.compute.v20191101.EncryptionSetPropertiesResponse;
    /**
     * Resource tags
     */
