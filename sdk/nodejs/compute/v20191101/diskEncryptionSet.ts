...
export class DiskEncryptionSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20191101:DiskEncryptionSet';
     ...
     */
    public readonly activeKey!: pulumi.Output<outputs.compute.v20191101.KeyVaultAndKeyReferenceResponse | undefined>;
    /**
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    public readonly identity!: pulumi.Output<outputs.compute.v20191101.EncryptionSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly previousKeys!: pulumi.Output<outputs.compute.v20191101.KeyVaultAndKeyReferenceResponse[]>;
    /**
    ...
    constructor(name: string, args: DiskEncryptionSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:DiskEncryptionSet" }, { type: "azurerm:compute/preview:DiskEncryptionSet" }, { type: "azurerm:compute/v20190701:DiskEncryptionSet" }, { type: "azurerm:compute/v20200501:DiskEncryptionSet" }, { type: "azurerm:compute/v20200630:DiskEncryptionSet" }] };
...
export interface DiskEncryptionSetArgs {
     ...
     * The key vault key which is currently used by this disk encryption set.
     */
    readonly activeKey?: pulumi.Input<inputs.compute.v20191101.KeyVaultAndKeyReference>;
    /**
     ...
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    readonly identity?: pulumi.Input<inputs.compute.v20191101.EncryptionSetIdentity>;
    /**
     * Resource location
     */
