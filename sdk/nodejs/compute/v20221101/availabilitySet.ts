 ...
 *
 * const availabilitySet = new azure_native.compute.v20221101.AvailabilitySet("availabilitySet", {
...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20221101:AvailabilitySet';
     ...
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.compute.v20221101.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.compute.v20221101.SubResourceResponse[] | undefined>;
...
export interface AvailabilitySetArgs {
     ...
     * A list of references to all virtual machines in the availability set.
     */
    virtualMachines?: pulumi.Input<pulumi.Input<inputs.compute.v20221101.SubResourceArgs>[]>;
}
