 ...
 *
 * @deprecated azure-native:compute/v20221101:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHost to guarantee forwards compatibility.
 */
export class DedicatedHost extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DedicatedHost {
        pulumi.log.warn("DedicatedHost is deprecated: azure-native:compute/v20221101:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHost to guarantee forwards compatibility.")
        return new DedicatedHost(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20221101:DedicatedHost';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20221101.DedicatedHostInstanceViewResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20221101.SkuResponse>;
    /**
     * Resource tags
     */
     ...
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.v20221101.SubResourceReadOnlyResponse[]>;
...
export interface DedicatedHostArgs {
     ...
     * Specifies the software license type that will be applied to the VMs deployed on the dedicated host. <br><br> Possible values are: <br><br> **None** <br><br> **Windows_Server_Hybrid** <br><br> **Windows_Server_Perpetual** <br><br> Default: **None**
     */
    licenseType?: pulumi.Input<enums.compute.v20221101.DedicatedHostLicenseTypes>;
    /**
     * Resource location
     */
     ...
     * SKU of the dedicated host for Hardware Generation and VM family. Only name is required to be set. List Microsoft.Compute SKUs for a list of possible values.
     */
    sku: pulumi.Input<inputs.compute.v20221101.SkuArgs>;
    /**
     * Resource tags
     */
