 ...
 */
/** @deprecated azure-native:compute/v20221101:CapacityReservationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:CapacityReservationGroup to guarantee forwards compatibility. */
export function getCapacityReservationGroup(args: GetCapacityReservationGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityReservationGroupResult> {
    pulumi.log.warn("getCapacityReservationGroup is deprecated: azure-native:compute/v20221101:CapacityReservationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:CapacityReservationGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20221101:getCapacityReservationGroup", {
...
export interface GetCapacityReservationGroupResult {
     ...
     */
    readonly capacityReservations: outputs.compute.v20221101.SubResourceReadOnlyResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: outputs.compute.v20221101.CapacityReservationGroupInstanceViewResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly virtualMachinesAssociated: outputs.compute.v20221101.SubResourceReadOnlyResponse[];
    /**
