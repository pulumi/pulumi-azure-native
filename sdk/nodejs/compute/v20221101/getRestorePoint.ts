...
export interface GetRestorePointResult {
     ...
     */
    readonly excludeDisks?: outputs.compute.v20221101.ApiEntityReferenceResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: outputs.compute.v20221101.RestorePointInstanceViewResponse;
    /**
     * Resource name
     */
     ...
     */
    readonly sourceMetadata: outputs.compute.v20221101.RestorePointSourceMetadataResponse;
    /**
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    readonly sourceRestorePoint?: outputs.compute.v20221101.ApiEntityReferenceResponse;
    /**
...
export function getRestorePointOutput(args: GetRestorePointOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRestorePointResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20221101:getRestorePoint", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "restorePointCollectionName": args.restorePointCollectionName,
        "restorePointName": args.restorePointName,
