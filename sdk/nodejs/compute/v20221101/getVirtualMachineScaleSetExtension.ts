...
export function getVirtualMachineScaleSetExtension(args: GetVirtualMachineScaleSetExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineScaleSetExtensionResult> {
    pulumi.log.warn("getVirtualMachineScaleSetExtension is deprecated: azure-native:compute/v20221101:VirtualMachineScaleSetExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetExtension to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20221101:getVirtualMachineScaleSetExtension", {
        "expand": args.expand,
...
export interface GetVirtualMachineScaleSetExtensionResult {
     ...
     */
    readonly protectedSettingsFromKeyVault?: outputs.compute.v20221101.KeyVaultSecretReferenceResponse;
    /**
