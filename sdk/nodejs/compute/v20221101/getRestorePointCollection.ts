...
export function getRestorePointCollection(args: GetRestorePointCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetRestorePointCollectionResult> {
    pulumi.log.warn("getRestorePointCollection is deprecated: azure-native:compute/v20221101:RestorePointCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:RestorePointCollection to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20221101:getRestorePointCollection", {
        "expand": args.expand,
...
export interface GetRestorePointCollectionResult {
     ...
     */
    readonly restorePoints: outputs.compute.v20221101.RestorePointResponse[];
    /**
     * The properties of the source resource that this restore point collection is created from.
     */
    readonly source?: outputs.compute.v20221101.RestorePointCollectionSourcePropertiesResponse;
    /**
     * Resource tags
     */
