 ...
 *
 * @deprecated azure-native:compute/v20221101:VirtualMachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineExtension to guarantee forwards compatibility.
 */
export class VirtualMachineExtension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineExtension {
        pulumi.log.warn("VirtualMachineExtension is deprecated: azure-native:compute/v20221101:VirtualMachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineExtension to guarantee forwards compatibility.")
        return new VirtualMachineExtension(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20221101:VirtualMachineExtension';
     ...
     */
    public readonly instanceView!: pulumi.Output<outputs.compute.v20221101.VirtualMachineExtensionInstanceViewResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly protectedSettingsFromKeyVault!: pulumi.Output<outputs.compute.v20221101.KeyVaultSecretReferenceResponse | undefined>;
    /**
...
export interface VirtualMachineExtensionArgs {
     ...
     * The virtual machine extension instance view.
     */
    instanceView?: pulumi.Input<inputs.compute.v20221101.VirtualMachineExtensionInstanceViewArgs>;
    /**
     * Resource location
     */
     ...
     * The extensions protected settings that are passed by reference, and consumed from key vault
     */
    protectedSettingsFromKeyVault?: pulumi.Input<inputs.compute.v20221101.KeyVaultSecretReferenceArgs>;
    /**
     * The name of the extension handler publisher.
     */
