...
export function getDedicatedHostGroup(args: GetDedicatedHostGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostGroupResult> {
    pulumi.log.warn("getDedicatedHostGroup is deprecated: azure-native:compute/v20221101:DedicatedHostGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHostGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20221101:getDedicatedHostGroup", {
        "expand": args.expand,
...
export interface GetDedicatedHostGroupResult {
     ...
     */
    readonly additionalCapabilities?: outputs.compute.v20221101.DedicatedHostGroupPropertiesResponseAdditionalCapabilities;
    /**
     * A list of references to all dedicated hosts in the dedicated host group.
     */
    readonly hosts: outputs.compute.v20221101.SubResourceReadOnlyResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: outputs.compute.v20221101.DedicatedHostGroupInstanceViewResponse;
    /**
     * Resource location
     */
