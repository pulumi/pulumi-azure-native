 ...
 *
 * const capacityReservationGroup = new azure_native.compute.v20221101.CapacityReservationGroup("capacityReservationGroup", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:compute/v20221101:CapacityReservationGroup myCapacityReservationGroup /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/CapacityReservationGroups/myCapacityReservationGroup 
 * ```
 */
export class CapacityReservationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20221101:CapacityReservationGroup';
     ...
     */
    public /*out*/ readonly capacityReservations!: pulumi.Output<outputs.compute.v20221101.SubResourceReadOnlyResponse[]>;
    /**
     * The capacity reservation group instance view which has the list of instance views for all the capacity reservations that belong to the capacity reservation group.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20221101.CapacityReservationGroupInstanceViewResponse>;
    /**
     * Resource location
     */
