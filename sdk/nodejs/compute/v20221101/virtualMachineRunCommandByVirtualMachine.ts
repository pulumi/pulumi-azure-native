 ...
 *
 * @deprecated azure-native:compute/v20221101:VirtualMachineRunCommandByVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineRunCommandByVirtualMachine to guarantee forwards compatibility.
 */
export class VirtualMachineRunCommandByVirtualMachine extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineRunCommandByVirtualMachine {
        pulumi.log.warn("VirtualMachineRunCommandByVirtualMachine is deprecated: azure-native:compute/v20221101:VirtualMachineRunCommandByVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineRunCommandByVirtualMachine to guarantee forwards compatibility.")
        return new VirtualMachineRunCommandByVirtualMachine(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20221101:VirtualMachineRunCommandByVirtualMachine';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20221101.VirtualMachineRunCommandInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.compute.v20221101.RunCommandInputParameterResponse[] | undefined>;
    /**
     * The parameters used by the script.
     */
    public readonly protectedParameters!: pulumi.Output<outputs.compute.v20221101.RunCommandInputParameterResponse[] | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.compute.v20221101.VirtualMachineRunCommandScriptSourceResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface VirtualMachineRunCommandByVirtualMachineArgs {
     ...
     * The parameters used by the script.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.compute.v20221101.RunCommandInputParameterArgs>[]>;
    /**
     * The parameters used by the script.
     */
    protectedParameters?: pulumi.Input<pulumi.Input<inputs.compute.v20221101.RunCommandInputParameterArgs>[]>;
    /**
     ...
     * The source of the run command script.
     */
    source?: pulumi.Input<inputs.compute.v20221101.VirtualMachineRunCommandScriptSourceArgs>;
    /**
     * Resource tags
     */
