...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20181120:GuestConfigurationAssignment';
    ...
    constructor(name: string, argsOrState?: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:GuestConfigurationAssignment" }, { type: "azurerm:compute/preview:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20180630preview:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20200625:GuestConfigurationAssignment" }] };
