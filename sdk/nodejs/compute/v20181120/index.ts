...
// Export enums:
export * from "../../types/enums/compute/v20181120";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:compute/v20181120:GuestConfigurationAssignment":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "compute/v20181120", _module)
