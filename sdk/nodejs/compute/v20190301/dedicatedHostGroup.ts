...
export class DedicatedHostGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DedicatedHostGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:DedicatedHostGroup" }, { type: "azurerm:compute/preview:DedicatedHostGroup" }, { type: "azurerm:compute/v20190701:DedicatedHostGroup" }, { type: "azurerm:compute/v20191201:DedicatedHostGroup" }, { type: "azurerm:compute/v20200601:DedicatedHostGroup" }] };
