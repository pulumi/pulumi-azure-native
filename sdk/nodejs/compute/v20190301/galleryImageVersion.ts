...
export class GalleryImageVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: GalleryImageVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:GalleryImageVersion" }, { type: "azurerm:compute/preview:GalleryImageVersion" }, { type: "azurerm:compute/v20180601:GalleryImageVersion" }, { type: "azurerm:compute/v20190701:GalleryImageVersion" }, { type: "azurerm:compute/v20191201:GalleryImageVersion" }] };
