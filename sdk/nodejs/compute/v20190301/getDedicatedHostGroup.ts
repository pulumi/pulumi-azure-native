...
export function getDedicatedHostGroup(args: GetDedicatedHostGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20190301:getDedicatedHostGroup", {
        "name": args.name,
...
export interface GetDedicatedHostGroupResult {
     ...
     */
    readonly properties: outputs.compute.v20190301.DedicatedHostGroupPropertiesResponse;
    /**
     * Resource tags
     */
