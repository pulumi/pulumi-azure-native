...
export class GalleryImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20190301:GalleryImage';
    ...
    constructor(name: string, args: GalleryImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20190301:GalleryImage" }, { type: "azure-native:compute:GalleryImage" }, { type: "azure-nextgen:compute:GalleryImage" }, { type: "azure-native:compute/latest:GalleryImage" }, { type: "azure-nextgen:compute/latest:GalleryImage" }, { type: "azure-native:compute/v20180601:GalleryImage" }, { type: "azure-nextgen:compute/v20180601:GalleryImage" }, { type: "azure-native:compute/v20190701:GalleryImage" }, { type: "azure-nextgen:compute/v20190701:GalleryImage" }, { type: "azure-native:compute/v20191201:GalleryImage" }, { type: "azure-nextgen:compute/v20191201:GalleryImage" }, { type: "azure-native:compute/v20200930:GalleryImage" }, { type: "azure-nextgen:compute/v20200930:GalleryImage" }] };
...
export interface GalleryImageArgs {
     ...
     * This property allows the user to specify whether the virtual machines created under this image are 'Generalized' or 'Specialized'.
     */
    readonly osState: pulumi.Input<enums.compute.v20190301.OperatingSystemStateTypes>;
    /**
     * This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. <br><br> Possible values are: <br><br> **Windows** <br><br> **Linux**
     */
