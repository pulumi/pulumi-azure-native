...
export function getProximityPlacementGroup(args: GetProximityPlacementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetProximityPlacementGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20190301:getProximityPlacementGroup", {
        "name": args.name,
...
export interface GetProximityPlacementGroupResult {
     ...
     */
    readonly properties: outputs.compute.v20190301.ProximityPlacementGroupPropertiesResponse;
    /**
     * Resource tags
     */
