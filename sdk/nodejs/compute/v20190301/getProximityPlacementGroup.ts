...
export function getProximityPlacementGroup(args: GetProximityPlacementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetProximityPlacementGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20190301:getProximityPlacementGroup", {
...
export interface GetProximityPlacementGroupResult {
     ...
     */
    readonly availabilitySets: outputs.compute.v20190301.SubResourceInvokeResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly virtualMachineScaleSets: outputs.compute.v20190301.SubResourceInvokeResponse[];
    /**
