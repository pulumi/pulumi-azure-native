...
azure-native:compute/v20190301:VirtualMachineScaleSetExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:VirtualMachineScaleSetExtension to guarantee forwards compatibility.
 */
export class VirtualMachineScaleSetExtension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineScaleSetExtension {
        pulumi.log.warn("VirtualMachineScaleSetExtension is deprecated: Version 2019-03-01 will be removed in v2 of the provider.\nazure-native:compute/v20190301:VirtualMachineScaleSetExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:VirtualMachineScaleSetExtension to guarantee forwards compatibility.")
