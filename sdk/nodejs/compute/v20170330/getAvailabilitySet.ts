...
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilitySetResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20170330:getAvailabilitySet", {
...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly statuses: outputs.compute.v20170330.InstanceViewStatusInvokeResponse[];
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachines?: outputs.compute.v20170330.SubResourceInvokeResponse[];
}
