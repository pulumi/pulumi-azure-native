...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute:GuestConfigurationAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.GuestConfigurationAssignmentPropertiesResponse>;
    /**
...
export interface GuestConfigurationAssignmentArgs {
     ...
     * Properties of the Guest configuration assignment.
     */
    readonly properties?: pulumi.Input<inputs.compute.GuestConfigurationAssignmentProperties>;
    /**
