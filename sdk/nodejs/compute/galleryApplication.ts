...
export class GalleryApplication extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GalleryApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute/v20200930:GalleryApplication" }, { type: "azure-native:compute/v20210701:GalleryApplication" }, { type: "azure-native:compute/v20211001:GalleryApplication" }] };
