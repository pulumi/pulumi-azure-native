...
export function getVirtualMachineExtension(args: GetVirtualMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20181001:getVirtualMachineExtension", {
        "expand": args.expand,
...
export interface GetVirtualMachineExtensionResult {
     ...
     */
    readonly instanceView?: outputs.compute.v20181001.VirtualMachineExtensionInstanceViewInvokeResponse;
    /**
     * Resource location
     */
