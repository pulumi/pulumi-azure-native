...
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilitySetResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20181001:getAvailabilitySet", {
...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly statuses: outputs.compute.v20181001.InstanceViewStatusInvokeResponse[];
    /**
     * Resource tags
     */
