...
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilitySetResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20181001:getAvailabilitySet", {
        "name": args.name,
...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly properties: outputs.compute.v20181001.AvailabilitySetPropertiesResponse;
    /**
