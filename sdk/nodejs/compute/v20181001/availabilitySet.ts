...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20181001:AvailabilitySet';
     ...
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.compute.v20181001.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.compute.v20181001.SubResourceResponse[] | undefined>;
    ...
    constructor(name: string, args: AvailabilitySetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20181001:AvailabilitySet" }, { type: "azure-native:compute:AvailabilitySet" }, { type: "azure-nextgen:compute:AvailabilitySet" }, { type: "azure-native:compute/v20150615:AvailabilitySet" }, { type: "azure-nextgen:compute/v20150615:AvailabilitySet" }, { type: "azure-native:compute/v20160330:AvailabilitySet" }, { type: "azure-nextgen:compute/v20160330:AvailabilitySet" }, { type: "azure-native:compute/v20160430preview:AvailabilitySet" }, { type: "azure-nextgen:compute/v20160430preview:AvailabilitySet" }, { type: "azure-native:compute/v20170330:AvailabilitySet" }, { type: "azure-nextgen:compute/v20170330:AvailabilitySet" }, { type: "azure-native:compute/v20171201:AvailabilitySet" }, { type: "azure-nextgen:compute/v20171201:AvailabilitySet" }, { type: "azure-native:compute/v20180401:AvailabilitySet" }, { type: "azure-nextgen:compute/v20180401:AvailabilitySet" }, { type: "azure-native:compute/v20180601:AvailabilitySet" }, { type: "azure-nextgen:compute/v20180601:AvailabilitySet" }, { type: "azure-native:compute/v20190301:AvailabilitySet" }, { type: "azure-nextgen:compute/v20190301:AvailabilitySet" }, { type: "azure-native:compute/v20190701:AvailabilitySet" }, { type: "azure-nextgen:compute/v20190701:AvailabilitySet" }, { type: "azure-native:compute/v20191201:AvailabilitySet" }, { type: "azure-nextgen:compute/v20191201:AvailabilitySet" }, { type: "azure-native:compute/v20200601:AvailabilitySet" }, { type: "azure-nextgen:compute/v20200601:AvailabilitySet" }, { type: "azure-native:compute/v20201201:AvailabilitySet" }, { type: "azure-nextgen:compute/v20201201:AvailabilitySet" }, { type: "azure-native:compute/v20210301:AvailabilitySet" }, { type: "azure-nextgen:compute/v20210301:AvailabilitySet" }] };
...
export interface AvailabilitySetArgs {
     ...
     * Specifies information about the proximity placement group that the availability set should be assigned to. <br><br>Minimum api-version: 2018-04-01.
     */
    readonly proximityPlacementGroup?: pulumi.Input<inputs.compute.v20181001.SubResourceArgs>;
    /**
     ...
     * Sku of the availability set, only name is required to be set. See AvailabilitySetSkuTypes for possible set of values. Use 'Aligned' for virtual machines with managed disks and 'Classic' for virtual machines with unmanaged disks. Default value is 'Classic'.
     */
    readonly sku?: pulumi.Input<inputs.compute.v20181001.SkuArgs>;
    /**
     * Resource tags
     */
     ...
     * A list of references to all virtual machines in the availability set.
     */
    readonly virtualMachines?: pulumi.Input<pulumi.Input<inputs.compute.v20181001.SubResourceArgs>[]>;
}
