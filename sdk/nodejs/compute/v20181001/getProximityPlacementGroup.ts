...
export function getProximityPlacementGroup(args: GetProximityPlacementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetProximityPlacementGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20181001:getProximityPlacementGroup", {
        "name": args.name,
...
export interface GetProximityPlacementGroupResult {
     ...
     */
    readonly properties: outputs.compute.v20181001.ProximityPlacementGroupPropertiesResponse;
    /**
     * Resource tags
     */
