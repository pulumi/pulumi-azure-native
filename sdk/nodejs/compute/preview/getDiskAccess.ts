...
export function getDiskAccess(args: GetDiskAccessArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskAccessResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/preview:getDiskAccess", {
...
export interface GetDiskAccessResult {
     ...
     */
    readonly privateEndpointConnections: outputs.compute.preview.PrivateEndpointConnectionResponse[];
    /**
