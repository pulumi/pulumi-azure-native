...
export class DedicatedHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/preview:DedicatedHost';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.preview.DedicatedHostInstanceViewResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.compute.preview.SkuResponse>;
    /**
     * Resource tags
     */
     ...
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.preview.SubResourceReadOnlyResponse[]>;
    ...
    constructor(name: string, args: DedicatedHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:DedicatedHost" }, { type: "azurerm:compute/v20190301:DedicatedHost" }, { type: "azurerm:compute/v20190701:DedicatedHost" }, { type: "azurerm:compute/v20191201:DedicatedHost" }, { type: "azurerm:compute/v20200601:DedicatedHost" }] };
