...
export function getDedicatedHost(args: GetDedicatedHostArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/preview:getDedicatedHost", {
        "expand": args.expand,
...
export interface GetDedicatedHostResult {
     ...
     */
    readonly instanceView: outputs.compute.preview.DedicatedHostInstanceViewResponse;
    /**
     ...
     */
    readonly sku: outputs.compute.preview.SkuResponse;
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachines: outputs.compute.preview.SubResourceReadOnlyResponse[];
}
