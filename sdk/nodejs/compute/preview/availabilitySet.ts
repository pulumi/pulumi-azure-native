...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/preview:AvailabilitySet';
     ...
     */
    public readonly proximityPlacementGroup!: pulumi.Output<outputs.compute.preview.SubResourceResponse | undefined>;
    /**
     * Sku of the availability set, only name is required to be set. See AvailabilitySetSkuTypes for possible set of values. Use 'Aligned' for virtual machines with managed disks and 'Classic' for virtual machines with unmanaged disks. Default value is 'Classic'.
     */
    public readonly sku!: pulumi.Output<outputs.compute.preview.SkuResponse | undefined>;
    /**
     * The resource status information.
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.compute.preview.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.compute.preview.SubResourceResponse[] | undefined>;
...
export interface AvailabilitySetArgs {
     ...
     * Specifies information about the proximity placement group that the availability set should be assigned to. <br><br>Minimum api-version: 2018-04-01.
     */
    readonly proximityPlacementGroup?: pulumi.Input<inputs.compute.preview.SubResource>;
    /**
     ...
     * Sku of the availability set, only name is required to be set. See AvailabilitySetSkuTypes for possible set of values. Use 'Aligned' for virtual machines with managed disks and 'Classic' for virtual machines with unmanaged disks. Default value is 'Classic'.
     */
    readonly sku?: pulumi.Input<inputs.compute.preview.Sku>;
    /**
     * Resource tags
     */
     ...
     * A list of references to all virtual machines in the availability set.
     */
    readonly virtualMachines?: pulumi.Input<pulumi.Input<inputs.compute.preview.SubResource>[]>;
}
