...
export class DedicatedHostGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/preview:DedicatedHostGroup';
     ...
     */
    public /*out*/ readonly hosts!: pulumi.Output<outputs.compute.preview.SubResourceReadOnlyResponse[]>;
    /**
     * The dedicated host group instance view, which has the list of instance view of the dedicated hosts under the dedicated host group.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.preview.DedicatedHostGroupInstanceViewResponse>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, argsOrState?: DedicatedHostGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:DedicatedHostGroup" }, { type: "azurerm:compute/v20190301:DedicatedHostGroup" }, { type: "azurerm:compute/v20190701:DedicatedHostGroup" }, { type: "azurerm:compute/v20191201:DedicatedHostGroup" }, { type: "azurerm:compute/v20200601:DedicatedHostGroup" }] };
