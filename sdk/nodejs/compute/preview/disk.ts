...
export class Disk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/preview:Disk';
     ...
     */
    public readonly creationData!: pulumi.Output<outputs.compute.preview.CreationDataResponse>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.compute.preview.EncryptionResponse | undefined>;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    public readonly encryptionSettingsCollection!: pulumi.Output<outputs.compute.preview.EncryptionSettingsCollectionResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly shareInfo!: pulumi.Output<outputs.compute.preview.ShareInfoElementResponse[]>;
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, or UltraSSD_LRS.
     */
    public readonly sku!: pulumi.Output<outputs.compute.preview.DiskSkuResponse | undefined>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: DiskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:Disk" }, { type: "azurerm:compute/v20160430preview:Disk" }, { type: "azurerm:compute/v20170330:Disk" }, { type: "azurerm:compute/v20180401:Disk" }, { type: "azurerm:compute/v20180601:Disk" }, { type: "azurerm:compute/v20180930:Disk" }, { type: "azurerm:compute/v20190301:Disk" }, { type: "azurerm:compute/v20190701:Disk" }, { type: "azurerm:compute/v20191101:Disk" }, { type: "azurerm:compute/v20200501:Disk" }, { type: "azurerm:compute/v20200630:Disk" }] };
...
export interface DiskArgs {
     ...
     * Disk source information. CreationData information cannot be changed after the disk has been created.
     */
    readonly creationData: pulumi.Input<inputs.compute.preview.CreationData>;
    /**
     * ARM id of the DiskAccess resource for using private endpoints on disks.
     */
     ...
     * Encryption property can be used to encrypt data at rest with customer managed keys or platform managed keys.
     */
    readonly encryption?: pulumi.Input<inputs.compute.preview.Encryption>;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    readonly encryptionSettingsCollection?: pulumi.Input<inputs.compute.preview.EncryptionSettingsCollection>;
    /**
     * The hypervisor generation of the Virtual Machine. Applicable to OS disks only.
     */
     ...
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, or UltraSSD_LRS.
     */
    readonly sku?: pulumi.Input<inputs.compute.preview.DiskSku>;
    /**
     * Resource tags
     */
