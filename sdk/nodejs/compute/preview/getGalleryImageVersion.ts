...
export function getGalleryImageVersion(args: GetGalleryImageVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetGalleryImageVersionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/preview:getGalleryImageVersion", {
        "expand": args.expand,
...
export interface GetGalleryImageVersionResult {
     ...
     */
    readonly publishingProfile?: outputs.compute.preview.GalleryImageVersionPublishingProfileResponse;
    /**
     ...
     */
    readonly storageProfile: outputs.compute.preview.GalleryImageVersionStorageProfileResponse;
    /**
     * Resource tags
     */
