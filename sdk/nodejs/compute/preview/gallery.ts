...
export class Gallery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/preview:Gallery';
     ...
     */
    public /*out*/ readonly identifier!: pulumi.Output<outputs.compute.preview.GalleryIdentifierResponse | undefined>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, argsOrState?: GalleryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:Gallery" }, { type: "azurerm:compute/v20180601:Gallery" }, { type: "azurerm:compute/v20190301:Gallery" }, { type: "azurerm:compute/v20190701:Gallery" }, { type: "azurerm:compute/v20191201:Gallery" }] };
