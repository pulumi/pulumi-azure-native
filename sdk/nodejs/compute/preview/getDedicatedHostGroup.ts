...
export function getDedicatedHostGroup(args: GetDedicatedHostGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/preview:getDedicatedHostGroup", {
        "expand": args.expand,
...
export interface GetDedicatedHostGroupResult {
     ...
     */
    readonly hosts: outputs.compute.preview.SubResourceReadOnlyResponse[];
    /**
     * The dedicated host group instance view, which has the list of instance view of the dedicated hosts under the dedicated host group.
     */
    readonly instanceView: outputs.compute.preview.DedicatedHostGroupInstanceViewResponse;
    /**
     * Resource location
     */
