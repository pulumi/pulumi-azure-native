...
export class ProximityPlacementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/preview:ProximityPlacementGroup';
     ...
     */
    public /*out*/ readonly availabilitySets!: pulumi.Output<outputs.compute.preview.SubResourceWithColocationStatusResponse[]>;
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    public readonly colocationStatus!: pulumi.Output<outputs.compute.preview.InstanceViewStatusResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly virtualMachineScaleSets!: pulumi.Output<outputs.compute.preview.SubResourceWithColocationStatusResponse[]>;
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.preview.SubResourceWithColocationStatusResponse[]>;
    ...
    constructor(name: string, argsOrState?: ProximityPlacementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:ProximityPlacementGroup" }, { type: "azurerm:compute/v20180401:ProximityPlacementGroup" }, { type: "azurerm:compute/v20180601:ProximityPlacementGroup" }, { type: "azurerm:compute/v20181001:ProximityPlacementGroup" }, { type: "azurerm:compute/v20190301:ProximityPlacementGroup" }, { type: "azurerm:compute/v20190701:ProximityPlacementGroup" }, { type: "azurerm:compute/v20191201:ProximityPlacementGroup" }, { type: "azurerm:compute/v20200601:ProximityPlacementGroup" }] };
...
export interface ProximityPlacementGroupArgs {
     ...
     * Describes colocation status of the Proximity Placement Group.
     */
    readonly colocationStatus?: pulumi.Input<inputs.compute.preview.InstanceViewStatus>;
    /**
     * Resource location
     */
