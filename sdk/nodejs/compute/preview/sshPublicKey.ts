...
export class SshPublicKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/preview:SshPublicKey';
    ...
    constructor(name: string, args: SshPublicKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:SshPublicKey" }, { type: "azurerm:compute/v20191201:SshPublicKey" }, { type: "azurerm:compute/v20200601:SshPublicKey" }] };
