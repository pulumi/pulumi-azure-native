...
export function getGalleryApplicationVersion(args: GetGalleryApplicationVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetGalleryApplicationVersionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/preview:getGalleryApplicationVersion", {
        "expand": args.expand,
...
export interface GetGalleryApplicationVersionResult {
     ...
     */
    readonly publishingProfile: outputs.compute.preview.GalleryApplicationVersionPublishingProfileResponse;
    /**
     * This is the replication status of the gallery Image Version.
     */
    readonly replicationStatus: outputs.compute.preview.ReplicationStatusResponse;
    /**
     * Resource tags
     */
