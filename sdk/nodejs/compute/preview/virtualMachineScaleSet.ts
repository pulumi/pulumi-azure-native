...
export class VirtualMachineScaleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/preview:VirtualMachineScaleSet';
     ...
     */
    public readonly additionalCapabilities!: pulumi.Output<outputs.compute.preview.AdditionalCapabilitiesResponse | undefined>;
    /**
     * Policy for automatic repairs.
     */
    public readonly automaticRepairsPolicy!: pulumi.Output<outputs.compute.preview.AutomaticRepairsPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly hostGroup!: pulumi.Output<outputs.compute.preview.SubResourceResponse | undefined>;
    /**
     * The identity of the virtual machine scale set, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.compute.preview.VirtualMachineScaleSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly plan!: pulumi.Output<outputs.compute.preview.PlanResponse | undefined>;
    /**
     ...
     */
    public readonly scaleInPolicy!: pulumi.Output<outputs.compute.preview.ScaleInPolicyResponse | undefined>;
    /**
     ...
     * The upgrade policy.
     */
    public readonly upgradePolicy!: pulumi.Output<outputs.compute.preview.UpgradePolicyResponse | undefined>;
    /**
     * The virtual machine profile.
     */
    public readonly virtualMachineProfile!: pulumi.Output<outputs.compute.preview.VirtualMachineScaleSetVMProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VirtualMachineScaleSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20150615:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20160330:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20160430preview:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20170330:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20171201:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20180401:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20180601:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20181001:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20190301:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20190701:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20191201:VirtualMachineScaleSet" }, { type: "azurerm:compute/v20200601:VirtualMachineScaleSet" }] };
...
export interface VirtualMachineScaleSetArgs {
     ...
     * Specifies additional capabilities enabled or disabled on the Virtual Machines in the Virtual Machine Scale Set. For instance: whether the Virtual Machines have the capability to support attaching managed data disks with UltraSSD_LRS storage account type.
     */
    readonly additionalCapabilities?: pulumi.Input<inputs.compute.preview.AdditionalCapabilities>;
    /**
     * Policy for automatic repairs.
     */
    readonly automaticRepairsPolicy?: pulumi.Input<inputs.compute.preview.AutomaticRepairsPolicy>;
    /**
     * When Overprovision is enabled, extensions are launched only on the requested number of VMs which are finally kept. This property will hence ensure that the extensions do not run on the extra overprovisioned VMs.
     */
     ...
     * Specifies information about the dedicated host group that the virtual machine scale set resides in. <br><br>Minimum api-version: 2020-06-01.
     */
    readonly hostGroup?: pulumi.Input<inputs.compute.preview.SubResource>;
    /**
     * The identity of the virtual machine scale set, if configured.
     */
    readonly identity?: pulumi.Input<inputs.compute.preview.VirtualMachineScaleSetIdentity>;
    /**
     * Resource location
     */
     ...
     * Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use.  In the Azure portal, find the marketplace image that you want to use and then click **Want to deploy programmatically, Get Started ->**. Enter any required information and then click **Save**.
     */
    readonly plan?: pulumi.Input<inputs.compute.preview.Plan>;
    /**
     * Fault Domain count for each placement group.
     */
     ...
     * Specifies the scale-in policy that decides which virtual machines are chosen for removal when a Virtual Machine Scale Set is scaled-in.
     */
    readonly scaleInPolicy?: pulumi.Input<inputs.compute.preview.ScaleInPolicy>;
    /**
     * When true this limits the scale set to a single placement group, of max size 100 virtual machines. NOTE: If singlePlacementGroup is true, it may be modified to false. However, if singlePlacementGroup is false, it may not be modified to true.
     */
     ...
     * The upgrade policy.
     */
    readonly upgradePolicy?: pulumi.Input<inputs.compute.preview.UpgradePolicy>;
    /**
     * The virtual machine profile.
     */
    readonly virtualMachineProfile?: pulumi.Input<inputs.compute.preview.VirtualMachineScaleSetVMProfile>;
    /**
