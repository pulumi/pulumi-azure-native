...
export function getDiskEncryptionSet(args: GetDiskEncryptionSetArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskEncryptionSetResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/preview:getDiskEncryptionSet", {
...
export interface GetDiskEncryptionSetResult {
     ...
     */
    readonly activeKey?: outputs.compute.preview.KeyVaultAndKeyReferenceResponse;
    /**
     ...
     */
    readonly identity?: outputs.compute.preview.EncryptionSetIdentityResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly previousKeys: outputs.compute.preview.KeyVaultAndKeyReferenceResponse[];
    /**
