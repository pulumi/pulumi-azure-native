...
export class DedicatedHostGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute:DedicatedHostGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.DedicatedHostGroupPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface DedicatedHostGroupArgs {
     ...
     * Dedicated Host Group Properties.
     */
    readonly properties?: pulumi.Input<inputs.compute.DedicatedHostGroupProperties>;
    /**
