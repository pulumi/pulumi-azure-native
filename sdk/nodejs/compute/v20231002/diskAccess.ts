...
export class DiskAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20231002:DiskAccess';
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.compute.v20231002.ExtendedLocationResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.compute.v20231002.PrivateEndpointConnectionResponse[]>;
    /**
...
export interface DiskAccessArgs {
     ...
     * The extended location where the disk access will be created. Extended location cannot be changed.
     */
    extendedLocation?: pulumi.Input<inputs.compute.v20231002.ExtendedLocationArgs>;
    /**
     * Resource location
     */
