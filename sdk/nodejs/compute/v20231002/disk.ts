...
export class Disk extends pulumi.CustomResource {
     ...
     */
    public readonly creationData!: pulumi.Output<outputs.compute.v20231002.CreationDataResponse>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.compute.v20231002.EncryptionResponse | undefined>;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    public readonly encryptionSettingsCollection!: pulumi.Output<outputs.compute.v20231002.EncryptionSettingsCollectionResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly propertyUpdatesInProgress!: pulumi.Output<outputs.compute.v20231002.PropertyUpdatesInProgressResponse>;
    /**
     ...
     */
    public readonly purchasePlan!: pulumi.Output<outputs.compute.v20231002.PurchasePlanResponse | undefined>;
    /**
     * Contains the security related information for the resource.
     */
    public readonly securityProfile!: pulumi.Output<outputs.compute.v20231002.DiskSecurityProfileResponse | undefined>;
    /**
     * Details of the list of all VMs that have the disk attached. maxShares should be set to a value greater than one for disks to allow attaching them to multiple VMs.
     */
    public /*out*/ readonly shareInfo!: pulumi.Output<outputs.compute.v20231002.ShareInfoElementResponse[]>;
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, UltraSSD_LRS, Premium_ZRS, StandardSSD_ZRS, or PremiumV2_LRS.
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20231002.DiskSkuResponse | undefined>;
    /**
     * List of supported capabilities for the image from which the OS disk was created.
     */
    public readonly supportedCapabilities!: pulumi.Output<outputs.compute.v20231002.SupportedCapabilitiesResponse | undefined>;
    /**
...
export interface DiskArgs {
     ...
     * Disk source information. CreationData information cannot be changed after the disk has been created.
     */
    creationData: pulumi.Input<inputs.compute.v20231002.CreationDataArgs>;
    /**
     * Additional authentication requirements when exporting or uploading to a disk or snapshot.
     */
    dataAccessAuthMode?: pulumi.Input<string | enums.compute.v20231002.DataAccessAuthMode>;
    /**
     * ARM id of the DiskAccess resource for using private endpoints on disks.
     */
     ...
     * Encryption property can be used to encrypt data at rest with customer managed keys or platform managed keys.
     */
    encryption?: pulumi.Input<inputs.compute.v20231002.EncryptionArgs>;
    /**
     * Encryption settings collection used for Azure Disk Encryption, can contain multiple encryption settings per disk or snapshot.
     */
    encryptionSettingsCollection?: pulumi.Input<inputs.compute.v20231002.EncryptionSettingsCollectionArgs>;
    /**
     * The extended location where the disk will be created. Extended location cannot be changed.
     */
     ...
     * The hypervisor generation of the Virtual Machine. Applicable to OS disks only.
     */
    hyperVGeneration?: pulumi.Input<string | enums.compute.v20231002.HyperVGeneration>;
    /**
     * Resource location
     */
     ...
     * Policy for accessing the disk via network.
     */
    networkAccessPolicy?: pulumi.Input<string | enums.compute.v20231002.NetworkAccessPolicy>;
    /**
     * Setting this property to true improves reliability and performance of data disks that are frequently (more than 5 times a day) by detached from one virtual machine and attached to another. This property should not be set for disks that are not detached and attached frequently as it causes the disks to not align with the fault domain of the virtual machine.
     */
     ...
     * The Operating System type.
     */
    osType?: pulumi.Input<enums.compute.v20231002.OperatingSystemTypes>;
    /**
     * Policy for controlling export on the disk.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.compute.v20231002.PublicNetworkAccess>;
    /**
     * Purchase plan information for the the image from which the OS disk was created. E.g. - {name: 2019-Datacenter, publisher: MicrosoftWindowsServer, product: WindowsServer}
     */
    purchasePlan?: pulumi.Input<inputs.compute.v20231002.PurchasePlanArgs>;
    /**
     ...
     * Contains the security related information for the resource.
     */
    securityProfile?: pulumi.Input<inputs.compute.v20231002.DiskSecurityProfileArgs>;
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, UltraSSD_LRS, Premium_ZRS, StandardSSD_ZRS, or PremiumV2_LRS.
     */
    sku?: pulumi.Input<inputs.compute.v20231002.DiskSkuArgs>;
    /**
     * List of supported capabilities for the image from which the OS disk was created.
     */
    supportedCapabilities?: pulumi.Input<inputs.compute.v20231002.SupportedCapabilitiesArgs>;
    /**
     * Indicates the OS on a disk supports hibernation.
     */
