...
export class DiskAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/latest:DiskAccess';
    ...
    constructor(name: string, argsOrState?: DiskAccessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/preview:DiskAccess" }, { type: "azurerm:compute/v20200501:DiskAccess" }, { type: "azurerm:compute/v20200630:DiskAccess" }] };
