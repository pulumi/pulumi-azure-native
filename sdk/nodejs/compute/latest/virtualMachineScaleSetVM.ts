...
export class VirtualMachineScaleSetVM extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineScaleSetVM {
        pulumi.log.warn("VirtualMachineScaleSetVM is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:compute:VirtualMachineScaleSetVM'.")
        return new VirtualMachineScaleSetVM(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/latest:VirtualMachineScaleSetVM';
     ...
     */
    public readonly availabilitySet!: pulumi.Output<outputs.compute.latest.SubResourceResponse | undefined>;
    /**
     * Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.
     */
    public readonly diagnosticsProfile!: pulumi.Output<outputs.compute.latest.DiagnosticsProfileResponse | undefined>;
    /**
     * Specifies the hardware settings for the virtual machine.
     */
    public readonly hardwareProfile!: pulumi.Output<outputs.compute.latest.HardwareProfileResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.latest.VirtualMachineScaleSetVMInstanceViewResponse>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.compute.latest.NetworkProfileResponse | undefined>;
    /**
     * Specifies the network profile configuration of the virtual machine.
     */
    public readonly networkProfileConfiguration!: pulumi.Output<outputs.compute.latest.VirtualMachineScaleSetVMNetworkProfileConfigurationResponse | undefined>;
    /**
     * Specifies the operating system settings for the virtual machine.
     */
    public readonly osProfile!: pulumi.Output<outputs.compute.latest.OSProfileResponse | undefined>;
    /**
     ...
     */
    public readonly protectionPolicy!: pulumi.Output<outputs.compute.latest.VirtualMachineScaleSetVMProtectionPolicyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly resources!: pulumi.Output<outputs.compute.latest.VirtualMachineExtensionResponse[]>;
    /**
     * Specifies the Security related profile settings for the virtual machine.
     */
    public readonly securityProfile!: pulumi.Output<outputs.compute.latest.SecurityProfileResponse | undefined>;
    /**
     * The virtual machine SKU.
     */
    public /*out*/ readonly sku!: pulumi.Output<outputs.compute.latest.SkuResponse>;
    /**
     * Specifies the storage settings for the virtual machine disks.
     */
    public readonly storageProfile!: pulumi.Output<outputs.compute.latest.StorageProfileResponse | undefined>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: VirtualMachineScaleSetVMArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/latest:VirtualMachineScaleSetVM" }, { type: "azure-native:compute:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20171201:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20171201:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20180401:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20180401:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20180601:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20180601:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20181001:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20181001:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20190301:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20190301:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20190701:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20190701:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20191201:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20191201:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20200601:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20200601:VirtualMachineScaleSetVM" }, { type: "azure-native:compute/v20201201:VirtualMachineScaleSetVM" }, { type: "azure-nextgen:compute/v20201201:VirtualMachineScaleSetVM" }] };
...
export interface VirtualMachineScaleSetVMArgs {
     ...
     * Specifies information about the availability set that the virtual machine should be assigned to. Virtual machines specified in the same availability set are allocated to different nodes to maximize availability. For more information about availability sets, see [Manage the availability of virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-manage-availability?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). <br><br> For more information on Azure planned maintenance, see [Planned maintenance for virtual machines in Azure](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-planned-maintenance?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) <br><br> Currently, a VM can only be added to availability set at creation time. An existing VM cannot be added to an availability set.
     */
    readonly availabilitySet?: pulumi.Input<inputs.compute.latest.SubResource>;
    /**
     * Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.
     */
    readonly diagnosticsProfile?: pulumi.Input<inputs.compute.latest.DiagnosticsProfile>;
    /**
     * Specifies the hardware settings for the virtual machine.
     */
    readonly hardwareProfile?: pulumi.Input<inputs.compute.latest.HardwareProfile>;
    /**
     ...
     * Specifies the network interfaces of the virtual machine.
     */
    readonly networkProfile?: pulumi.Input<inputs.compute.latest.NetworkProfile>;
    /**
     * Specifies the network profile configuration of the virtual machine.
     */
    readonly networkProfileConfiguration?: pulumi.Input<inputs.compute.latest.VirtualMachineScaleSetVMNetworkProfileConfiguration>;
    /**
     * Specifies the operating system settings for the virtual machine.
     */
    readonly osProfile?: pulumi.Input<inputs.compute.latest.OSProfile>;
    /**
     * Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use.  In the Azure portal, find the marketplace image that you want to use and then click **Want to deploy programmatically, Get Started ->**. Enter any required information and then click **Save**.
     */
     ...
     * Specifies the protection policy of the virtual machine.
     */
    readonly protectionPolicy?: pulumi.Input<inputs.compute.latest.VirtualMachineScaleSetVMProtectionPolicy>;
    /**
     ...
     * Specifies the Security related profile settings for the virtual machine.
     */
    readonly securityProfile?: pulumi.Input<inputs.compute.latest.SecurityProfile>;
    /**
     * Specifies the storage settings for the virtual machine disks.
     */
    readonly storageProfile?: pulumi.Input<inputs.compute.latest.StorageProfile>;
    /**
     * Resource tags
     */
