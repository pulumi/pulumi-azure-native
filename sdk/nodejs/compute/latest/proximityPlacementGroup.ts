...
export class ProximityPlacementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/latest:ProximityPlacementGroup';
    ...
    constructor(name: string, args: ProximityPlacementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/preview:ProximityPlacementGroup" }, { type: "azurerm:compute/v20180401:ProximityPlacementGroup" }, { type: "azurerm:compute/v20180601:ProximityPlacementGroup" }, { type: "azurerm:compute/v20181001:ProximityPlacementGroup" }, { type: "azurerm:compute/v20190301:ProximityPlacementGroup" }, { type: "azurerm:compute/v20190701:ProximityPlacementGroup" }, { type: "azurerm:compute/v20191201:ProximityPlacementGroup" }, { type: "azurerm:compute/v20200601:ProximityPlacementGroup" }] };
