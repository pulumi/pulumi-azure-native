...
export interface GetDedicatedHostResult {
     ...
     */
    readonly instanceView: outputs.compute.latest.DedicatedHostInstanceViewInvokeResponse;
    /**
     ...
     */
    readonly virtualMachines: outputs.compute.latest.SubResourceReadOnlyInvokeResponse[];
}
