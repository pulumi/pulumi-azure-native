...
export function getDedicatedHost(args: GetDedicatedHostArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostResult> {
    pulumi.log.warn("getDedicatedHost is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:compute:getDedicatedHost'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/latest:getDedicatedHost", {
        "expand": args.expand,
...
export interface GetDedicatedHostResult {
     ...
     */
    readonly instanceView: outputs.compute.latest.DedicatedHostInstanceViewResponse;
    /**
     ...
     */
    readonly virtualMachines: outputs.compute.latest.SubResourceReadOnlyResponse[];
}
