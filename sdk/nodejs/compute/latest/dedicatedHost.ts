...
export class DedicatedHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/latest:DedicatedHost';
    ...
    constructor(name: string, argsOrState?: DedicatedHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/preview:DedicatedHost" }, { type: "azurerm:compute/v20190301:DedicatedHost" }, { type: "azurerm:compute/v20190701:DedicatedHost" }, { type: "azurerm:compute/v20191201:DedicatedHost" }, { type: "azurerm:compute/v20200601:DedicatedHost" }] };
