...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.latest.GuestConfigurationAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/preview:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20180630preview:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20181120:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20200625:GuestConfigurationAssignment" }] };
...
export interface GuestConfigurationAssignmentArgs {
     ...
     * Properties of the Guest configuration assignment.
     */
    readonly properties?: pulumi.Input<inputs.compute.latest.GuestConfigurationAssignmentProperties>;
    /**
