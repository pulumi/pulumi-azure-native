...
export class Gallery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/latest:Gallery';
     ...
     */
    public /*out*/ readonly identifier!: pulumi.Output<outputs.compute.latest.GalleryIdentifierResponse | undefined>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, args: GalleryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/latest:Gallery" }, { type: "azure-native:compute:Gallery" }, { type: "azure-nextgen:compute:Gallery" }, { type: "azure-native:compute/v20180601:Gallery" }, { type: "azure-nextgen:compute/v20180601:Gallery" }, { type: "azure-native:compute/v20190301:Gallery" }, { type: "azure-nextgen:compute/v20190301:Gallery" }, { type: "azure-native:compute/v20190701:Gallery" }, { type: "azure-nextgen:compute/v20190701:Gallery" }, { type: "azure-native:compute/v20191201:Gallery" }, { type: "azure-nextgen:compute/v20191201:Gallery" }, { type: "azure-native:compute/v20200930:Gallery" }, { type: "azure-nextgen:compute/v20200930:Gallery" }] };
