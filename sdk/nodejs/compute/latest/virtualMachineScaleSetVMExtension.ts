...
export class VirtualMachineScaleSetVMExtension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineScaleSetVMExtension {
        return new VirtualMachineScaleSetVMExtension(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/latest:VirtualMachineScaleSetVMExtension';
    ...
    constructor(name: string, argsOrState?: VirtualMachineScaleSetVMExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as VirtualMachineScaleSetVMExtensionArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/preview:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20190701:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20191201:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20200601:VirtualMachineScaleSetVMExtension" }] };
