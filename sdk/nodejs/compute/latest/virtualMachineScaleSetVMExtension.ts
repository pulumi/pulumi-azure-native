...
export class VirtualMachineScaleSetVMExtension extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VirtualMachineScaleSetVMExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/v20190701:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20191201:VirtualMachineScaleSetVMExtension" }, { type: "azurerm:compute/v20200601:VirtualMachineScaleSetVMExtension" }] };
