...
export function getVirtualMachineScaleSet(args: GetVirtualMachineScaleSetArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineScaleSetResult> {
    pulumi.log.warn("getVirtualMachineScaleSet is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getVirtualMachineScaleSet'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:compute/latest:getVirtualMachineScaleSet", {
...
export interface GetVirtualMachineScaleSetResult {
     ...
     */
    readonly automaticRepairsPolicy?: outputs.compute.latest.AutomaticRepairsPolicyResponse;
    /**
     ...
     */
    readonly identity?: outputs.compute.latest.VirtualMachineScaleSetIdentityResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly scaleInPolicy?: outputs.compute.latest.ScaleInPolicyResponse;
    /**
     ...
     */
    readonly sku?: outputs.compute.latest.SkuResponse;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    readonly upgradePolicy?: outputs.compute.latest.UpgradePolicyResponse;
    /**
     * The virtual machine profile.
     */
    readonly virtualMachineProfile?: outputs.compute.latest.VirtualMachineScaleSetVMProfileResponse;
    /**
