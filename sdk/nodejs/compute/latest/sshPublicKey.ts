...
export class SshPublicKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/latest:SshPublicKey';
    ...
    constructor(name: string, argsOrState?: SshPublicKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/preview:SshPublicKey" }, { type: "azurerm:compute/v20191201:SshPublicKey" }, { type: "azurerm:compute/v20200601:SshPublicKey" }] };
