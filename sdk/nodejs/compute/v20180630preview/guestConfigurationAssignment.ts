...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:compute/v20180630preview:GuestConfigurationAssignment';
    ...
    constructor(name: string, args: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/latest:GuestConfigurationAssignment" }, { type: "azure-nextgen:compute/v20181120:GuestConfigurationAssignment" }, { type: "azure-nextgen:compute/v20200625:GuestConfigurationAssignment" }] };
