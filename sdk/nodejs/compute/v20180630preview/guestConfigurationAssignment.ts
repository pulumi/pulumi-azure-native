...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20181120:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20200625:GuestConfigurationAssignment" }] };
