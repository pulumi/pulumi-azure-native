...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20180630preview:GuestConfigurationAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.v20180630preview.GuestConfigurationAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:GuestConfigurationAssignment" }, { type: "azurerm:compute/preview:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20181120:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20200625:GuestConfigurationAssignment" }] };
...
export interface GuestConfigurationAssignmentArgs {
     ...
     * Properties of the Guest configuration assignment.
     */
    readonly properties?: pulumi.Input<inputs.compute.v20180630preview.GuestConfigurationAssignmentProperties>;
    /**
