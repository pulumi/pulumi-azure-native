 ...
 *
 * @deprecated azure-native:compute/v20220302:DiskEncryptionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskEncryptionSet to guarantee forwards compatibility.
 */
export class DiskEncryptionSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DiskEncryptionSet {
        pulumi.log.warn("DiskEncryptionSet is deprecated: azure-native:compute/v20220302:DiskEncryptionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskEncryptionSet to guarantee forwards compatibility.")
        return new DiskEncryptionSet(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220302:DiskEncryptionSet';
     ...
     */
    public readonly activeKey!: pulumi.Output<outputs.compute.v20220302.KeyForDiskEncryptionSetResponse | undefined>;
    /**
     * The error that was encountered during auto-key rotation. If an error is present, then auto-key rotation will not be attempted until the error on this disk encryption set is fixed.
     */
    public /*out*/ readonly autoKeyRotationError!: pulumi.Output<outputs.compute.v20220302.ApiErrorResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.compute.v20220302.EncryptionSetIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly previousKeys!: pulumi.Output<outputs.compute.v20220302.KeyForDiskEncryptionSetResponse[]>;
    /**
...
export interface DiskEncryptionSetArgs {
     ...
     * The key vault key which is currently used by this disk encryption set.
     */
    activeKey?: pulumi.Input<inputs.compute.v20220302.KeyForDiskEncryptionSetArgs>;
    /**
     ...
     * The type of key used to encrypt the data of the disk.
     */
    encryptionType?: pulumi.Input<string | enums.compute.v20220302.DiskEncryptionSetType>;
    /**
     * Multi-tenant application client id to access key vault in a different tenant. Setting the value to 'None' will clear the property.
     */
     ...
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    identity?: pulumi.Input<inputs.compute.v20220302.EncryptionSetIdentityArgs>;
    /**
     * Resource location
     */
