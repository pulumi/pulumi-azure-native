 ...
 *
 * @deprecated azure-native:compute/v20220302:DiskAccess is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskAccess to guarantee forwards compatibility.
 */
export class DiskAccess extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DiskAccess {
        pulumi.log.warn("DiskAccess is deprecated: azure-native:compute/v20220302:DiskAccess is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskAccess to guarantee forwards compatibility.")
        return new DiskAccess(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220302:DiskAccess';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.compute.v20220302.PrivateEndpointConnectionResponse[]>;
    /**
