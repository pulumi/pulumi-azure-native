...
export function getDiskAccessAPrivateEndpointConnection(args: GetDiskAccessAPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskAccessAPrivateEndpointConnectionResult> {
    pulumi.log.warn("getDiskAccessAPrivateEndpointConnection is deprecated: azure-native:compute/v20220302:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.")
...
export interface GetDiskAccessAPrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint: outputs.compute.v20220302.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    readonly privateLinkServiceConnectionState: outputs.compute.v20220302.PrivateLinkServiceConnectionStateResponse;
    /**
