...
export function getVirtualMachineExtension(args: GetVirtualMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20180601:getVirtualMachineExtension", {
        "name": args.name,
...
export interface GetVirtualMachineExtensionResult {
     ...
     */
    readonly properties: outputs.compute.v20180601.VirtualMachineExtensionPropertiesResponse;
    /**
     * Resource tags
     */
