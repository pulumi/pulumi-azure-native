...
azure-native:compute/v20180601:ProximityPlacementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20190301:ProximityPlacementGroup to guarantee forwards compatibility.
 */
export class ProximityPlacementGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProximityPlacementGroup {
        pulumi.log.warn("ProximityPlacementGroup is deprecated: Version 2018-06-01 will be removed in v2 of the provider.\nazure-native:compute/v20180601:ProximityPlacementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20190301:ProximityPlacementGroup to guarantee forwards compatibility.")
