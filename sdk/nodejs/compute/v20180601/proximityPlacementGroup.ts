...
export class ProximityPlacementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20180601:ProximityPlacementGroup';
     ...
     */
    public /*out*/ readonly availabilitySets!: pulumi.Output<outputs.compute.v20180601.SubResourceResponse[]>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly virtualMachineScaleSets!: pulumi.Output<outputs.compute.v20180601.SubResourceResponse[]>;
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.v20180601.SubResourceResponse[]>;
    ...
    constructor(name: string, args: ProximityPlacementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20180601:ProximityPlacementGroup" }, { type: "azure-native:compute:ProximityPlacementGroup" }, { type: "azure-nextgen:compute:ProximityPlacementGroup" }, { type: "azure-native:compute/latest:ProximityPlacementGroup" }, { type: "azure-nextgen:compute/latest:ProximityPlacementGroup" }, { type: "azure-native:compute/v20180401:ProximityPlacementGroup" }, { type: "azure-nextgen:compute/v20180401:ProximityPlacementGroup" }, { type: "azure-native:compute/v20181001:ProximityPlacementGroup" }, { type: "azure-nextgen:compute/v20181001:ProximityPlacementGroup" }, { type: "azure-native:compute/v20190301:ProximityPlacementGroup" }, { type: "azure-nextgen:compute/v20190301:ProximityPlacementGroup" }, { type: "azure-native:compute/v20190701:ProximityPlacementGroup" }, { type: "azure-nextgen:compute/v20190701:ProximityPlacementGroup" }, { type: "azure-native:compute/v20191201:ProximityPlacementGroup" }, { type: "azure-nextgen:compute/v20191201:ProximityPlacementGroup" }, { type: "azure-native:compute/v20200601:ProximityPlacementGroup" }, { type: "azure-nextgen:compute/v20200601:ProximityPlacementGroup" }, { type: "azure-native:compute/v20201201:ProximityPlacementGroup" }, { type: "azure-nextgen:compute/v20201201:ProximityPlacementGroup" }] };
