...
export class Gallery extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: GalleryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:Gallery" }, { type: "azurerm:compute/v20190301:Gallery" }, { type: "azurerm:compute/v20190701:Gallery" }, { type: "azurerm:compute/v20191201:Gallery" }] };
