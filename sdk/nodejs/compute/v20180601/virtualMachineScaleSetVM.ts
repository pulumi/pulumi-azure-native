...
export class VirtualMachineScaleSetVM extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.v20180601.VirtualMachineScaleSetVMPropertiesResponse>;
    /**
...
export interface VirtualMachineScaleSetVMArgs {
     ...
     * Describes the properties of a virtual machine scale set virtual machine.
     */
    readonly properties?: pulumi.Input<inputs.compute.v20180601.VirtualMachineScaleSetVMProperties>;
    /**
