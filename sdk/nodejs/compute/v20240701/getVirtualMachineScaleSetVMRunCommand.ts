...
export function getVirtualMachineScaleSetVMRunCommand(args: GetVirtualMachineScaleSetVMRunCommandArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineScaleSetVMRunCommandResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20240701:getVirtualMachineScaleSetVMRunCommand", {
        "expand": args.expand,
...
export interface GetVirtualMachineScaleSetVMRunCommandResult {
     ...
     */
    readonly errorBlobManagedIdentity?: outputs.compute.v20240701.RunCommandManagedIdentityResponse;
    /**
     ...
     */
    readonly instanceView: outputs.compute.v20240701.VirtualMachineRunCommandInstanceViewResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly outputBlobManagedIdentity?: outputs.compute.v20240701.RunCommandManagedIdentityResponse;
    /**
     ...
     */
    readonly parameters?: outputs.compute.v20240701.RunCommandInputParameterResponse[];
    /**
     * The parameters used by the script.
     */
    readonly protectedParameters?: outputs.compute.v20240701.RunCommandInputParameterResponse[];
    /**
     ...
     */
    readonly source?: outputs.compute.v20240701.VirtualMachineRunCommandScriptSourceResponse;
    /**
     * Resource tags
     */
...
export function getVirtualMachineScaleSetVMRunCommandOutput(args: GetVirtualMachineScaleSetVMRunCommandOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVirtualMachineScaleSetVMRunCommandResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20240701:getVirtualMachineScaleSetVMRunCommand", {
        "expand": args.expand,
        "instanceId": args.instanceId,
        "resourceGroupName": args.resourceGroupName,
        "runCommandName": args.runCommandName,
