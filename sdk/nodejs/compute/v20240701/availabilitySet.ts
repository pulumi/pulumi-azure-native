...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20240701:AvailabilitySet';
     ...
     */
    public readonly proximityPlacementGroup!: pulumi.Output<outputs.compute.v20240701.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly scheduledEventsPolicy!: pulumi.Output<outputs.compute.v20240701.ScheduledEventsPolicyResponse | undefined>;
    /**
     * Sku of the availability set, only name is required to be set. See AvailabilitySetSkuTypes for possible set of values. Use 'Aligned' for virtual machines with managed disks and 'Classic' for virtual machines with unmanaged disks. Default value is 'Classic'.
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20240701.SkuResponse | undefined>;
    /**
     * The resource status information.
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.compute.v20240701.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.compute.v20240701.SubResourceResponse[] | undefined>;
...
export interface AvailabilitySetArgs {
     ...
     * Specifies information about the proximity placement group that the availability set should be assigned to. Minimum api-version: 2018-04-01.
     */
    proximityPlacementGroup?: pulumi.Input<inputs.compute.v20240701.SubResourceArgs>;
    /**
     ...
     * Specifies Redeploy, Reboot and ScheduledEventsAdditionalPublishingTargets Scheduled Event related configurations for the availability set.
     */
    scheduledEventsPolicy?: pulumi.Input<inputs.compute.v20240701.ScheduledEventsPolicyArgs>;
    /**
     * Sku of the availability set, only name is required to be set. See AvailabilitySetSkuTypes for possible set of values. Use 'Aligned' for virtual machines with managed disks and 'Classic' for virtual machines with unmanaged disks. Default value is 'Classic'.
     */
    sku?: pulumi.Input<inputs.compute.v20240701.SkuArgs>;
    /**
     * Resource tags
     */
     ...
     * A list of references to all virtual machines in the availability set.
     */
    virtualMachines?: pulumi.Input<pulumi.Input<inputs.compute.v20240701.SubResourceArgs>[]>;
}
