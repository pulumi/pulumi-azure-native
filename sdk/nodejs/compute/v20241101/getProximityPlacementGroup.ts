...
export function getProximityPlacementGroup(args: GetProximityPlacementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetProximityPlacementGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20241101:getProximityPlacementGroup", {
...
export interface GetProximityPlacementGroupResult {
     ...
     */
    readonly availabilitySets: outputs.compute.v20241101.SubResourceWithColocationStatusResponse[];
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    readonly colocationStatus?: outputs.compute.v20241101.InstanceViewStatusResponse;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly intent?: outputs.compute.v20241101.ProximityPlacementGroupPropertiesResponseIntent;
    /**
     * Resource location
     */
     ...
     */
    readonly virtualMachineScaleSets: outputs.compute.v20241101.SubResourceWithColocationStatusResponse[];
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    readonly virtualMachines: outputs.compute.v20241101.SubResourceWithColocationStatusResponse[];
    /**
...
export function getProximityPlacementGroupOutput(args: GetProximityPlacementGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProximityPlacementGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20241101:getProximityPlacementGroup", {
        "includeColocationStatus": args.includeColocationStatus,
        "proximityPlacementGroupName": args.proximityPlacementGroupName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
