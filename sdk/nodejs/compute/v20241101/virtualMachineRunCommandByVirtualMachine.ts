...
export class VirtualMachineRunCommandByVirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20241101:VirtualMachineRunCommandByVirtualMachine';
     ...
     */
    public readonly errorBlobManagedIdentity!: pulumi.Output<outputs.compute.v20241101.RunCommandManagedIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20241101.VirtualMachineRunCommandInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly outputBlobManagedIdentity!: pulumi.Output<outputs.compute.v20241101.RunCommandManagedIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.compute.v20241101.RunCommandInputParameterResponse[] | undefined>;
    /**
     * The parameters used by the script.
     */
    public readonly protectedParameters!: pulumi.Output<outputs.compute.v20241101.RunCommandInputParameterResponse[] | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.compute.v20241101.VirtualMachineRunCommandScriptSourceResponse | undefined>;
    /**
     * Resource tags
     */
...
export interface VirtualMachineRunCommandByVirtualMachineArgs {
     ...
     * User-assigned managed identity that has access to errorBlobUri storage blob. Use an empty object in case of system-assigned identity. Make sure managed identity has been given access to blob's container with 'Storage Blob Data Contributor' role assignment. In case of user-assigned identity, make sure you add it under VM's identity. For more info on managed identity and Run Command, refer https://aka.ms/ManagedIdentity and https://aka.ms/RunCommandManaged 
     */
    errorBlobManagedIdentity?: pulumi.Input<inputs.compute.v20241101.RunCommandManagedIdentityArgs>;
    /**
     * Specifies the Azure storage blob where script error stream will be uploaded. Use a SAS URI with read, append, create, write access OR use managed identity to provide the VM access to the blob. Refer errorBlobManagedIdentity parameter.
     */
     ...
     * User-assigned managed identity that has access to outputBlobUri storage blob. Use an empty object in case of system-assigned identity. Make sure managed identity has been given access to blob's container with 'Storage Blob Data Contributor' role assignment. In case of user-assigned identity, make sure you add it under VM's identity. For more info on managed identity and Run Command, refer https://aka.ms/ManagedIdentity and https://aka.ms/RunCommandManaged 
     */
    outputBlobManagedIdentity?: pulumi.Input<inputs.compute.v20241101.RunCommandManagedIdentityArgs>;
    /**
     * Specifies the Azure storage blob where script output stream will be uploaded. Use a SAS URI with read, append, create, write access OR use managed identity to provide the VM access to the blob. Refer outputBlobManagedIdentity parameter. 
     */
     ...
     * The parameters used by the script.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.compute.v20241101.RunCommandInputParameterArgs>[]>;
    /**
     * The parameters used by the script.
     */
    protectedParameters?: pulumi.Input<pulumi.Input<inputs.compute.v20241101.RunCommandInputParameterArgs>[]>;
    /**
     ...
     * The source of the run command script.
     */
    source?: pulumi.Input<inputs.compute.v20241101.VirtualMachineRunCommandScriptSourceArgs>;
    /**
     * Resource tags
     */
