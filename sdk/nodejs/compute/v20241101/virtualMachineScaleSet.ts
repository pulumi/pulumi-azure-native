...
export class VirtualMachineScaleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20241101:VirtualMachineScaleSet';
     ...
     */
    public readonly automaticRepairsPolicy!: pulumi.Output<outputs.compute.v20241101.AutomaticRepairsPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.compute.v20241101.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly hostGroup!: pulumi.Output<outputs.compute.v20241101.SubResourceResponse | undefined>;
    /**
     * The identity of the virtual machine scale set, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.compute.v20241101.VirtualMachineScaleSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly priorityMixPolicy!: pulumi.Output<outputs.compute.v20241101.PriorityMixPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly proximityPlacementGroup!: pulumi.Output<outputs.compute.v20241101.SubResourceResponse | undefined>;
    /**
     * Policy for Resiliency
     */
    public readonly resiliencyPolicy!: pulumi.Output<outputs.compute.v20241101.ResiliencyPolicyResponse | undefined>;
    /**
     * Specifies the policies applied when scaling in Virtual Machines in the Virtual Machine Scale Set.
     */
    public readonly scaleInPolicy!: pulumi.Output<outputs.compute.v20241101.ScaleInPolicyResponse | undefined>;
    /**
     * The ScheduledEventsPolicy.
     */
    public readonly scheduledEventsPolicy!: pulumi.Output<outputs.compute.v20241101.ScheduledEventsPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20241101.SkuResponse | undefined>;
    /**
     * Specifies the sku profile for the virtual machine scale set.
     */
    public readonly skuProfile!: pulumi.Output<outputs.compute.v20241101.SkuProfileResponse | undefined>;
    /**
     * Specifies the Spot Restore properties for the virtual machine scale set.
     */
    public readonly spotRestorePolicy!: pulumi.Output<outputs.compute.v20241101.SpotRestorePolicyResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    public readonly upgradePolicy!: pulumi.Output<outputs.compute.v20241101.UpgradePolicyResponse | undefined>;
    /**
     * The virtual machine profile.
     */
    public readonly virtualMachineProfile!: pulumi.Output<outputs.compute.v20241101.VirtualMachineScaleSetVMProfileResponse | undefined>;
    /**
...
export interface VirtualMachineScaleSetArgs {
     ...
     * Policy for automatic repairs.
     */
    automaticRepairsPolicy?: pulumi.Input<inputs.compute.v20241101.AutomaticRepairsPolicyArgs>;
    /**
     * Optional property which must either be set to True or omitted.
     */
     ...
     * The extended location of the Virtual Machine Scale Set.
     */
    extendedLocation?: pulumi.Input<inputs.compute.v20241101.ExtendedLocationArgs>;
    /**
     * Specifies information about the dedicated host group that the virtual machine scale set resides in. Minimum api-version: 2020-06-01.
     */
    hostGroup?: pulumi.Input<inputs.compute.v20241101.SubResourceArgs>;
    /**
     * The identity of the virtual machine scale set, if configured.
     */
    identity?: pulumi.Input<inputs.compute.v20241101.VirtualMachineScaleSetIdentityArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the orchestration mode for the virtual machine scale set.
     */
    orchestrationMode?: pulumi.Input<string | enums.compute.v20241101.OrchestrationMode>;
    /**
     * Specifies whether the Virtual Machine Scale Set should be overprovisioned.
     */
     ...
     * Specifies the desired targets for mixing Spot and Regular priority VMs within the same VMSS Flex instance.
     */
    priorityMixPolicy?: pulumi.Input<inputs.compute.v20241101.PriorityMixPolicyArgs>;
    /**
     * Specifies information about the proximity placement group that the virtual machine scale set should be assigned to. Minimum api-version: 2018-04-01.
     */
    proximityPlacementGroup?: pulumi.Input<inputs.compute.v20241101.SubResourceArgs>;
    /**
     * Policy for Resiliency
     */
    resiliencyPolicy?: pulumi.Input<inputs.compute.v20241101.ResiliencyPolicyArgs>;
    /**
     ...
     * Specifies the policies applied when scaling in Virtual Machines in the Virtual Machine Scale Set.
     */
    scaleInPolicy?: pulumi.Input<inputs.compute.v20241101.ScaleInPolicyArgs>;
    /**
     * The ScheduledEventsPolicy.
     */
    scheduledEventsPolicy?: pulumi.Input<inputs.compute.v20241101.ScheduledEventsPolicyArgs>;
    /**
     * When true this limits the scale set to a single placement group, of max size 100 virtual machines. NOTE: If singlePlacementGroup is true, it may be modified to false. However, if singlePlacementGroup is false, it may not be modified to true.
     */
     ...
     * Specifies the sku profile for the virtual machine scale set.
     */
    skuProfile?: pulumi.Input<inputs.compute.v20241101.SkuProfileArgs>;
    /**
     * Specifies the Spot Restore properties for the virtual machine scale set.
     */
    spotRestorePolicy?: pulumi.Input<inputs.compute.v20241101.SpotRestorePolicyArgs>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    upgradePolicy?: pulumi.Input<inputs.compute.v20241101.UpgradePolicyArgs>;
    /**
     * The virtual machine profile.
     */
    virtualMachineProfile?: pulumi.Input<inputs.compute.v20241101.VirtualMachineScaleSetVMProfileArgs>;
    /**
     ...
     * Specifies the align mode between Virtual Machine Scale Set compute and storage Fault Domain count.
     */
    zonalPlatformFaultDomainAlignMode?: pulumi.Input<string | enums.compute.v20241101.ZonalPlatformFaultDomainAlignMode>;
    /**
     * Whether to force strictly even Virtual Machine distribution cross x-zones in case there is zone outage. zoneBalance property can only be set if the zones property of the scale set contains more than one zone. If there are no zones or only one zone specified, then zoneBalance property should not be set.
     */
