...
export function getCapacityReservationGroup(args: GetCapacityReservationGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityReservationGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20241101:getCapacityReservationGroup", {
...
export interface GetCapacityReservationGroupResult {
     ...
     */
    readonly capacityReservations: outputs.compute.v20241101.SubResourceReadOnlyResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: outputs.compute.v20241101.CapacityReservationGroupInstanceViewResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly sharingProfile?: outputs.compute.v20241101.ResourceSharingProfileResponse;
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachinesAssociated: outputs.compute.v20241101.SubResourceReadOnlyResponse[];
    /**
...
export function getCapacityReservationGroupOutput(args: GetCapacityReservationGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCapacityReservationGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20241101:getCapacityReservationGroup", {
        "capacityReservationGroupName": args.capacityReservationGroupName,
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
