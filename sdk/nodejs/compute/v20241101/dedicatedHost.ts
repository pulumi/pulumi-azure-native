...
export class DedicatedHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20241101:DedicatedHost';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20241101.DedicatedHostInstanceViewResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20241101.SkuResponse>;
    /**
     * Resource tags
     */
     ...
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.v20241101.SubResourceReadOnlyResponse[]>;
...
export interface DedicatedHostArgs {
     ...
     * Specifies the software license type that will be applied to the VMs deployed on the dedicated host. Possible values are: **None,** **Windows_Server_Hybrid,** **Windows_Server_Perpetual.** The default value is: **None.**
     */
    licenseType?: pulumi.Input<enums.compute.v20241101.DedicatedHostLicenseTypes>;
    /**
     * Resource location
     */
     ...
     * SKU of the dedicated host for Hardware Generation and VM family. Only name is required to be set. List Microsoft.Compute SKUs for a list of possible values.
     */
    sku: pulumi.Input<inputs.compute.v20241101.SkuArgs>;
    /**
     * Resource tags
     */
