...
export function getVirtualMachineRunCommandByVirtualMachine(args: GetVirtualMachineRunCommandByVirtualMachineArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineRunCommandByVirtualMachineResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20241101:getVirtualMachineRunCommandByVirtualMachine", {
        "expand": args.expand,
...
export interface GetVirtualMachineRunCommandByVirtualMachineResult {
     ...
     */
    readonly errorBlobManagedIdentity?: outputs.compute.v20241101.RunCommandManagedIdentityResponse;
    /**
     ...
     */
    readonly instanceView: outputs.compute.v20241101.VirtualMachineRunCommandInstanceViewResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly outputBlobManagedIdentity?: outputs.compute.v20241101.RunCommandManagedIdentityResponse;
    /**
     ...
     */
    readonly parameters?: outputs.compute.v20241101.RunCommandInputParameterResponse[];
    /**
     * The parameters used by the script.
     */
    readonly protectedParameters?: outputs.compute.v20241101.RunCommandInputParameterResponse[];
    /**
     ...
     */
    readonly source?: outputs.compute.v20241101.VirtualMachineRunCommandScriptSourceResponse;
    /**
     * Resource tags
     */
...
export function getVirtualMachineRunCommandByVirtualMachineOutput(args: GetVirtualMachineRunCommandByVirtualMachineOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualMachineRunCommandByVirtualMachineResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20241101:getVirtualMachineRunCommandByVirtualMachine", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "runCommandName": args.runCommandName,
        "vmName": args.vmName,
