...
export class HostGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HostGroup {
        return new HostGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute:HostGroup';
    ...
    constructor(name: string, argsOrState?: HostGroupArgs, opts?: pulumi.CustomResourceOptions) {
