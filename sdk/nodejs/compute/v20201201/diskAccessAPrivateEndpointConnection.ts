...
export class DiskAccessAPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DiskAccessAPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20201201:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute:DiskAccessAPrivateEndpointConnection" }, { type: "azure-nextgen:compute:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute/latest:DiskAccessAPrivateEndpointConnection" }, { type: "azure-nextgen:compute/latest:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute/v20200930:DiskAccessAPrivateEndpointConnection" }, { type: "azure-nextgen:compute/v20200930:DiskAccessAPrivateEndpointConnection" }] };
...
export interface DiskAccessAPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.compute.v20201201.PrivateLinkServiceConnectionState>;
    /**
