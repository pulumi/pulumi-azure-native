...
export class SshPublicKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:compute/v20201201:SshPublicKey';
    ...
    constructor(name: string, args: SshPublicKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute:SshPublicKey" }, { type: "azure-nextgen:compute/latest:SshPublicKey" }, { type: "azure-nextgen:compute/v20191201:SshPublicKey" }, { type: "azure-nextgen:compute/v20200601:SshPublicKey" }] };
