...
export interface GetDiskEncryptionSetResult {
     ...
     */
    readonly activeKey?: outputs.compute.v20230402.KeyForDiskEncryptionSetResponse;
    /**
     * The error that was encountered during auto-key rotation. If an error is present, then auto-key rotation will not be attempted until the error on this disk encryption set is fixed.
     */
    readonly autoKeyRotationError: outputs.compute.v20230402.ApiErrorResponse;
    /**
     ...
     */
    readonly identity?: outputs.compute.v20230402.EncryptionSetIdentityResponse;
    /**
     ...
     */
    readonly previousKeys: outputs.compute.v20230402.KeyForDiskEncryptionSetResponse[];
    /**
...
export function getDiskEncryptionSetOutput(args: GetDiskEncryptionSetOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDiskEncryptionSetResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20230402:getDiskEncryptionSet", {
        "diskEncryptionSetName": args.diskEncryptionSetName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
