...
export class GalleryImageVersion extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GalleryImageVersionState, opts?: pulumi.CustomResourceOptions): GalleryImageVersion {
        return new GalleryImageVersion(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute:GalleryImageVersion';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.GalleryImageVersionPropertiesResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: GalleryImageVersionArgs | GalleryImageVersionState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as GalleryImageVersionState | undefined;
 ...
 * Specifies information about the gallery Image Version that you want to create or update.
 */
export interface GalleryImageVersionState {
    /**
     * Resource location
     */
     ...
     * Describes the properties of a gallery Image Version.
     */
    readonly properties: pulumi.Input<inputs.compute.GalleryImageVersionPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface GalleryImageVersionArgs {
     ...
     * Describes the properties of a gallery Image Version.
     */
    readonly properties?: pulumi.Input<inputs.compute.GalleryImageVersionProperties>;
    /**
