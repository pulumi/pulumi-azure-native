...
export class GalleryImageVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GalleryImageVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute:GalleryImageVersion" }, { type: "azure-native:compute/latest:GalleryImageVersion" }, { type: "azure-nextgen:compute/latest:GalleryImageVersion" }, { type: "azure-native:compute/v20180601:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20180601:GalleryImageVersion" }, { type: "azure-native:compute/v20190301:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20190301:GalleryImageVersion" }, { type: "azure-native:compute/v20190701:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20190701:GalleryImageVersion" }, { type: "azure-native:compute/v20191201:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20191201:GalleryImageVersion" }, { type: "azure-native:compute/v20200930:GalleryImageVersion" }, { type: "azure-nextgen:compute/v20200930:GalleryImageVersion" }] };
...
export interface GalleryImageVersionArgs {
     ...
     * The publishing profile of a gallery image Version.
     */
    readonly publishingProfile?: pulumi.Input<inputs.compute.GalleryImageVersionPublishingProfile>;
    /**
     ...
     * This is the storage profile of a Gallery Image Version.
     */
    readonly storageProfile: pulumi.Input<inputs.compute.GalleryImageVersionStorageProfile>;
    /**
     * Resource tags
     */
