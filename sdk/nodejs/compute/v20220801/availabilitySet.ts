...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220801:AvailabilitySet';
     ...
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.compute.v20220801.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.compute.v20220801.SubResourceResponse[] | undefined>;
...
export interface AvailabilitySetArgs {
     ...
     * A list of references to all virtual machines in the availability set.
     */
    virtualMachines?: pulumi.Input<pulumi.Input<inputs.compute.v20220801.SubResourceArgs>[]>;
}
