 ...
 *
 * @deprecated azure-native:compute/v20220801:ProximityPlacementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:ProximityPlacementGroup to guarantee forwards compatibility.
 */
export class ProximityPlacementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220801:ProximityPlacementGroup';
     ...
     */
    public /*out*/ readonly availabilitySets!: pulumi.Output<outputs.compute.v20220801.SubResourceWithColocationStatusResponse[]>;
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    public readonly colocationStatus!: pulumi.Output<outputs.compute.v20220801.InstanceViewStatusResponse | undefined>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    public readonly intent!: pulumi.Output<outputs.compute.v20220801.ProximityPlacementGroupPropertiesResponseIntent | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly virtualMachineScaleSets!: pulumi.Output<outputs.compute.v20220801.SubResourceWithColocationStatusResponse[]>;
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.v20220801.SubResourceWithColocationStatusResponse[]>;
    /**
...
export interface ProximityPlacementGroupArgs {
     ...
     * Describes colocation status of the Proximity Placement Group.
     */
    colocationStatus?: pulumi.Input<inputs.compute.v20220801.InstanceViewStatusArgs>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    intent?: pulumi.Input<inputs.compute.v20220801.ProximityPlacementGroupPropertiesIntentArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the type of the proximity placement group. <br><br> Possible values are: <br><br> **Standard** : Co-locate resources within an Azure region or Availability Zone. <br><br> **Ultra** : For future use.
     */
    proximityPlacementGroupType?: pulumi.Input<string | enums.compute.v20220801.ProximityPlacementGroupType>;
    /**
