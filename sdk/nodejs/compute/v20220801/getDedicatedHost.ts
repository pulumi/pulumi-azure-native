 ...
 */
/** @deprecated azure-native:compute/v20220801:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHost to guarantee forwards compatibility. */
export function getDedicatedHost(args: GetDedicatedHostArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostResult> {
    pulumi.log.warn("getDedicatedHost is deprecated: azure-native:compute/v20220801:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHost to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20220801:getDedicatedHost", {
        "expand": args.expand,
...
export interface GetDedicatedHostResult {
     ...
     */
    readonly instanceView: outputs.compute.v20220801.DedicatedHostInstanceViewResponse;
    /**
     ...
     */
    readonly virtualMachines: outputs.compute.v20220801.SubResourceReadOnlyResponse[];
}
/**
 * Retrieves information about a dedicated host.
 */
