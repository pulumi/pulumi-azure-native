...
export class CapacityReservationGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CapacityReservationGroup {
        pulumi.log.warn("CapacityReservationGroup is deprecated: azure-native:compute/v20220801:CapacityReservationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:CapacityReservationGroup to guarantee forwards compatibility.")
