...
export function getVirtualMachineScaleSetVMExtension(args: GetVirtualMachineScaleSetVMExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineScaleSetVMExtensionResult> {
    pulumi.log.warn("getVirtualMachineScaleSetVMExtension is deprecated: azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20220801:getVirtualMachineScaleSetVMExtension", {
        "expand": args.expand,
...
export interface GetVirtualMachineScaleSetVMExtensionResult {
     ...
     */
    readonly instanceView?: outputs.compute.v20220801.VirtualMachineExtensionInstanceViewResponse;
    /**
     ...
     */
    readonly protectedSettingsFromKeyVault?: outputs.compute.v20220801.KeyVaultSecretReferenceResponse;
    /**
