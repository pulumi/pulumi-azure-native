 ...
 */
/** @deprecated azure-native:compute/v20220801:CapacityReservation is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:CapacityReservation to guarantee forwards compatibility. */
export function getCapacityReservation(args: GetCapacityReservationArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityReservationResult> {
    pulumi.log.warn("getCapacityReservation is deprecated: azure-native:compute/v20220801:CapacityReservation is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:CapacityReservation to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20220801:getCapacityReservation", {
...
export interface GetCapacityReservationResult {
     ...
     */
    readonly instanceView: outputs.compute.v20220801.CapacityReservationInstanceViewResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly virtualMachinesAssociated: outputs.compute.v20220801.SubResourceReadOnlyResponse[];
    /**
