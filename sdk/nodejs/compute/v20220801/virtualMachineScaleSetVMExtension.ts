 ...
 *
 * @deprecated azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension to guarantee forwards compatibility.
 */
export class VirtualMachineScaleSetVMExtension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineScaleSetVMExtension {
        pulumi.log.warn("VirtualMachineScaleSetVMExtension is deprecated: azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension to guarantee forwards compatibility.")
        return new VirtualMachineScaleSetVMExtension(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension';
     ...
     */
    public readonly instanceView!: pulumi.Output<outputs.compute.v20220801.VirtualMachineExtensionInstanceViewResponse | undefined>;
    /**
     ...
     */
    public readonly protectedSettingsFromKeyVault!: pulumi.Output<outputs.compute.v20220801.KeyVaultSecretReferenceResponse | undefined>;
    /**
...
export interface VirtualMachineScaleSetVMExtensionArgs {
     ...
     * The virtual machine extension instance view.
     */
    instanceView?: pulumi.Input<inputs.compute.v20220801.VirtualMachineExtensionInstanceViewArgs>;
    /**
     * The extension can contain either protectedSettings or protectedSettingsFromKeyVault or no protected settings at all.
     */
     ...
     * The extensions protected settings that are passed by reference, and consumed from key vault
     */
    protectedSettingsFromKeyVault?: pulumi.Input<inputs.compute.v20220801.KeyVaultSecretReferenceArgs>;
    /**
     * The name of the extension handler publisher.
     */
