...
export function getVirtualMachineScaleSetVMRunCommand(args: GetVirtualMachineScaleSetVMRunCommandArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineScaleSetVMRunCommandResult> {
    pulumi.log.warn("getVirtualMachineScaleSetVMRunCommand is deprecated: azure-native:compute/v20220801:VirtualMachineScaleSetVMRunCommand is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVMRunCommand to guarantee forwards compatibility.")
...
export interface GetVirtualMachineScaleSetVMRunCommandResult {
     ...
     */
    readonly instanceView: outputs.compute.v20220801.VirtualMachineRunCommandInstanceViewResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly parameters?: outputs.compute.v20220801.RunCommandInputParameterResponse[];
    /**
     * The parameters used by the script.
     */
    readonly protectedParameters?: outputs.compute.v20220801.RunCommandInputParameterResponse[];
    /**
     ...
     */
    readonly source?: outputs.compute.v20220801.VirtualMachineRunCommandScriptSourceResponse;
    /**
     * Resource tags
     */
