...
export function getCapacityReservationGroup(args: GetCapacityReservationGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityReservationGroupResult> {
    pulumi.log.warn("getCapacityReservationGroup is deprecated: azure-native:compute/v20220801:CapacityReservationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:CapacityReservationGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:compute/v20220801:getCapacityReservationGroup", {
...
export interface GetCapacityReservationGroupResult {
     ...
     */
    readonly capacityReservations: outputs.compute.v20220801.SubResourceReadOnlyResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: outputs.compute.v20220801.CapacityReservationGroupInstanceViewResponse;
    /**
     * Resource location
     */
