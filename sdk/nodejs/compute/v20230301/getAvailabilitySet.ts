...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly proximityPlacementGroup?: outputs.compute.v20230301.SubResourceResponse;
    /**
     * Sku of the availability set, only name is required to be set. See AvailabilitySetSkuTypes for possible set of values. Use 'Aligned' for virtual machines with managed disks and 'Classic' for virtual machines with unmanaged disks. Default value is 'Classic'.
     */
    readonly sku?: outputs.compute.v20230301.SkuResponse;
    /**
     * The resource status information.
     */
    readonly statuses: outputs.compute.v20230301.InstanceViewStatusResponse[];
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachines?: outputs.compute.v20230301.SubResourceResponse[];
}
/**
 * Retrieves information about an availability set.
 */
export function getAvailabilitySetOutput(args: GetAvailabilitySetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAvailabilitySetResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:compute/v20230301:getAvailabilitySet", {
        "availabilitySetName": args.availabilitySetName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
