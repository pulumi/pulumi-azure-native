 ...
 *
 * const proximityPlacementGroup = new azure_native.compute.v20230301.ProximityPlacementGroup("proximityPlacementGroup", {
 *     intent: {
 *         vmSizes: [
 *             "Basic_A0",
 *             "Basic_A2",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:compute/v20230301:ProximityPlacementGroup myProximityPlacementGroup /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/proximityPlacementGroups/myProximityPlacementGroup 
 * ```
 */
export class ProximityPlacementGroup extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly availabilitySets!: pulumi.Output<outputs.compute.v20230301.SubResourceWithColocationStatusResponse[]>;
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    public readonly colocationStatus!: pulumi.Output<outputs.compute.v20230301.InstanceViewStatusResponse | undefined>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    public readonly intent!: pulumi.Output<outputs.compute.v20230301.ProximityPlacementGroupPropertiesResponseIntent | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly virtualMachineScaleSets!: pulumi.Output<outputs.compute.v20230301.SubResourceWithColocationStatusResponse[]>;
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<outputs.compute.v20230301.SubResourceWithColocationStatusResponse[]>;
    /**
...
export interface ProximityPlacementGroupArgs {
     ...
     * Describes colocation status of the Proximity Placement Group.
     */
    colocationStatus?: pulumi.Input<inputs.compute.v20230301.InstanceViewStatusArgs>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    intent?: pulumi.Input<inputs.compute.v20230301.ProximityPlacementGroupPropertiesIntentArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the type of the proximity placement group. Possible values are: **Standard** : Co-locate resources within an Azure region or Availability Zone. **Ultra** : For future use.
     */
    proximityPlacementGroupType?: pulumi.Input<string | enums.compute.v20230301.ProximityPlacementGroupType>;
    /**
