 ...
 *
 * const availabilitySet = new azure_native.compute.v20230301.AvailabilitySet("availabilitySet", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:compute/v20230301:AvailabilitySet myAvailabilitySet /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/availabilitySets/myAvailabilitySet 
 * ```
 */
export class AvailabilitySet extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.compute.v20230301.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<outputs.compute.v20230301.SubResourceResponse[] | undefined>;
