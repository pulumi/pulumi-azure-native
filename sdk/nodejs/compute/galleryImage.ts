...
export class GalleryImage extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GalleryImageState, opts?: pulumi.CustomResourceOptions): GalleryImage {
        return new GalleryImage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute:GalleryImage';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.GalleryImagePropertiesResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: GalleryImageArgs | GalleryImageState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as GalleryImageState | undefined;
...
export interface GalleryImageState {
     ...
     * Describes the properties of a gallery Image Definition.
     */
    readonly properties: pulumi.Input<inputs.compute.GalleryImagePropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface GalleryImageArgs {
     ...
     * Describes the properties of a gallery Image Definition.
     */
    readonly properties?: pulumi.Input<inputs.compute.GalleryImageProperties>;
    /**
