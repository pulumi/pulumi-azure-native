...
export class GalleryImage extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GalleryImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute:GalleryImage" }, { type: "azure-native:compute/latest:GalleryImage" }, { type: "azure-nextgen:compute/latest:GalleryImage" }, { type: "azure-native:compute/v20180601:GalleryImage" }, { type: "azure-nextgen:compute/v20180601:GalleryImage" }, { type: "azure-native:compute/v20190301:GalleryImage" }, { type: "azure-nextgen:compute/v20190301:GalleryImage" }, { type: "azure-native:compute/v20190701:GalleryImage" }, { type: "azure-nextgen:compute/v20190701:GalleryImage" }, { type: "azure-native:compute/v20191201:GalleryImage" }, { type: "azure-nextgen:compute/v20191201:GalleryImage" }, { type: "azure-native:compute/v20200930:GalleryImage" }, { type: "azure-nextgen:compute/v20200930:GalleryImage" }] };
...
export interface GalleryImageArgs {
     ...
     * Describes the disallowed disk types.
     */
    readonly disallowed?: pulumi.Input<inputs.compute.Disallowed>;
    /**
     * The end of life date of the gallery image definition. This property can be used for decommissioning purposes. This property is updatable.
     */
     ...
     * A list of gallery image features.
     */
    readonly features?: pulumi.Input<pulumi.Input<inputs.compute.GalleryImageFeature>[]>;
    /**
     ...
     * This is the gallery image definition identifier.
     */
    readonly identifier: pulumi.Input<inputs.compute.GalleryImageIdentifier>;
    /**
     * Resource location
     */
     ...
     * Describes the gallery image definition purchase plan. This is used by marketplace images.
     */
    readonly purchasePlan?: pulumi.Input<inputs.compute.ImagePurchasePlan>;
    /**
     * The properties describe the recommended machine configuration for this Image Definition. These properties are updatable.
     */
    readonly recommended?: pulumi.Input<inputs.compute.RecommendedMachineConfiguration>;
    /**
     * The release note uri.
     */
