...
export class ProximityPlacementGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProximityPlacementGroupState, opts?: pulumi.CustomResourceOptions): ProximityPlacementGroup {
        return new ProximityPlacementGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute:ProximityPlacementGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.ProximityPlacementGroupPropertiesResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: ProximityPlacementGroupArgs | ProximityPlacementGroupState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ProximityPlacementGroupState | undefined;
...
export interface ProximityPlacementGroupState {
     ...
     * Describes the properties of a Proximity Placement Group.
     */
    readonly properties: pulumi.Input<inputs.compute.ProximityPlacementGroupPropertiesResponse>;
    /**
     * Resource tags
     */
