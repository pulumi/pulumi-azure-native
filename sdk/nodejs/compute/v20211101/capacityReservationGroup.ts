 ...
 *
 * @deprecated azure-native:compute/v20211101:CapacityReservationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:CapacityReservationGroup to guarantee forwards compatibility.
 */
export class CapacityReservationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20211101:CapacityReservationGroup';
     ...
     */
    public /*out*/ readonly capacityReservations!: pulumi.Output<outputs.compute.v20211101.SubResourceReadOnlyResponse[]>;
    /**
     * The capacity reservation group instance view which has the list of instance views for all the capacity reservations that belong to the capacity reservation group.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20211101.CapacityReservationGroupInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly virtualMachinesAssociated!: pulumi.Output<outputs.compute.v20211101.SubResourceReadOnlyResponse[]>;
    /**
    ...
    constructor(name: string, args: CapacityReservationGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:CapacityReservationGroup" }, { type: "azure-native:compute/v20210401:CapacityReservationGroup" }, { type: "azure-native:compute/v20210701:CapacityReservationGroup" }, { type: "azure-native:compute/v20220301:CapacityReservationGroup" }, { type: "azure-native:compute/v20220801:CapacityReservationGroup" }, { type: "azure-native:compute/v20221101:CapacityReservationGroup" }, { type: "azure-native:compute/v20230301:CapacityReservationGroup" }] };
