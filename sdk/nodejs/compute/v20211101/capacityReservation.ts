...
export class CapacityReservation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CapacityReservation {
        pulumi.log.warn("CapacityReservation is deprecated: azure-native:compute/v20211101:CapacityReservation is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:CapacityReservation to guarantee forwards compatibility.")
        return new CapacityReservation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20211101:CapacityReservation';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20211101.CapacityReservationInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly sku!: pulumi.Output<outputs.compute.v20211101.SkuResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: CapacityReservationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:CapacityReservation" }, { type: "azure-native:compute/v20210401:CapacityReservation" }, { type: "azure-native:compute/v20210701:CapacityReservation" }, { type: "azure-native:compute/v20220301:CapacityReservation" }, { type: "azure-native:compute/v20220801:CapacityReservation" }, { type: "azure-native:compute/v20221101:CapacityReservation" }, { type: "azure-native:compute/v20230301:CapacityReservation" }] };
