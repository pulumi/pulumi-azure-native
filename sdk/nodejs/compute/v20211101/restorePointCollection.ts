 ...
 *
 * @deprecated azure-native:compute/v20211101:RestorePointCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:RestorePointCollection to guarantee forwards compatibility.
 */
export class RestorePointCollection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RestorePointCollection {
        pulumi.log.warn("RestorePointCollection is deprecated: azure-native:compute/v20211101:RestorePointCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:RestorePointCollection to guarantee forwards compatibility.")
        return new RestorePointCollection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20211101:RestorePointCollection';
     ...
     */
    public /*out*/ readonly restorePoints!: pulumi.Output<outputs.compute.v20211101.RestorePointResponse[]>;
    /**
     * The properties of the source resource that this restore point collection is created from.
     */
    public readonly source!: pulumi.Output<outputs.compute.v20211101.RestorePointCollectionSourcePropertiesResponse | undefined>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: RestorePointCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:RestorePointCollection" }, { type: "azure-native:compute/v20210301:RestorePointCollection" }, { type: "azure-native:compute/v20210401:RestorePointCollection" }, { type: "azure-native:compute/v20210701:RestorePointCollection" }, { type: "azure-native:compute/v20220301:RestorePointCollection" }, { type: "azure-native:compute/v20220801:RestorePointCollection" }, { type: "azure-native:compute/v20221101:RestorePointCollection" }, { type: "azure-native:compute/v20230301:RestorePointCollection" }] };
