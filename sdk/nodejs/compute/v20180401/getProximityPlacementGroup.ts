...
export function getProximityPlacementGroup(args: GetProximityPlacementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetProximityPlacementGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20180401:getProximityPlacementGroup", {
        "name": args.name,
...
export interface GetProximityPlacementGroupResult {
     ...
     */
    readonly properties: outputs.compute.v20180401.ProximityPlacementGroupPropertiesResponse;
    /**
     * Resource tags
     */
