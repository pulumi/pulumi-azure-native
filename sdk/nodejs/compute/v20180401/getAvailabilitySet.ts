...
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilitySetResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20180401:getAvailabilitySet", {
        "name": args.name,
...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly properties: outputs.compute.v20180401.AvailabilitySetPropertiesResponse;
    /**
