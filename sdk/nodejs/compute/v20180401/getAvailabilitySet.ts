...
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilitySetResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:compute/v20180401:getAvailabilitySet", {
...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly proximityPlacementGroup?: outputs.compute.v20180401.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly statuses: outputs.compute.v20180401.InstanceViewStatusInvokeResponse[];
    /**
     * Resource tags
     */
