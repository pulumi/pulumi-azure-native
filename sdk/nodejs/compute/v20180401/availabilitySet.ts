...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20180401:AvailabilitySet';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.v20180401.AvailabilitySetPropertiesResponse>;
    /**
...
export interface AvailabilitySetArgs {
     ...
     * The instance view of a resource.
     */
    readonly properties?: pulumi.Input<inputs.compute.v20180401.AvailabilitySetProperties>;
    /**
