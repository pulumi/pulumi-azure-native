...
export class VirtualMachineScaleSetExtension extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.v20180401.VirtualMachineScaleSetExtensionPropertiesResponse>;
...
export interface VirtualMachineScaleSetExtensionArgs {
     ...
     * Describes the properties of a Virtual Machine Scale Set Extension.
     */
    readonly properties?: pulumi.Input<inputs.compute.v20180401.VirtualMachineScaleSetExtensionProperties>;
    /**
