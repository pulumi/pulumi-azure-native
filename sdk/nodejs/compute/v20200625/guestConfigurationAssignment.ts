 ...
 *
 * const guestConfigurationAssignment = new azurerm.compute.v20200625.GuestConfigurationAssignment("guestConfigurationAssignment", {
...
export class GuestConfigurationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:compute/v20200625:GuestConfigurationAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.compute.v20200625.GuestConfigurationAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: GuestConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:compute/latest:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20180630preview:GuestConfigurationAssignment" }, { type: "azurerm:compute/v20181120:GuestConfigurationAssignment" }] };
...
export interface GuestConfigurationAssignmentArgs {
     ...
     * Properties of the Guest configuration assignment.
     */
    readonly properties?: pulumi.Input<inputs.compute.v20200625.GuestConfigurationAssignmentProperties>;
    /**
