...
export function getDiskEncryptionSet(args: GetDiskEncryptionSetArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskEncryptionSetResult> {
    pulumi.log.warn("getDiskEncryptionSet is deprecated: azure-native:compute/v20210401:DiskEncryptionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskEncryptionSet to guarantee forwards compatibility.")
