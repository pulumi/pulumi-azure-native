...
export class CapacityReservation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CapacityReservationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20210401:CapacityReservation" }, { type: "azure-native:compute:CapacityReservation" }, { type: "azure-nextgen:compute:CapacityReservation" }] };
