 ...
 *
 * @deprecated azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.
 */
export class DiskAccessAPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DiskAccessAPrivateEndpointConnection {
        pulumi.log.warn("DiskAccessAPrivateEndpointConnection is deprecated: azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.")
        return new DiskAccessAPrivateEndpointConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.compute.v20210401.PrivateEndpointResponse>;
    /**
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.compute.v20210401.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: DiskAccessAPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:compute:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute/v20200930:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute/v20201201:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute/v20210801:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute/v20211201:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute/v20220302:DiskAccessAPrivateEndpointConnection" }, { type: "azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection" }] };
