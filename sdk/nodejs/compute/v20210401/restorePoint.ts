 ...
 *
 * @deprecated azure-native:compute/v20210401:RestorePoint is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:RestorePoint to guarantee forwards compatibility.
 */
export class RestorePoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RestorePoint {
        pulumi.log.warn("RestorePoint is deprecated: azure-native:compute/v20210401:RestorePoint is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:RestorePoint to guarantee forwards compatibility.")
        return new RestorePoint(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20210401:RestorePoint';
     ...
     */
    public readonly excludeDisks!: pulumi.Output<outputs.compute.v20210401.ApiEntityReferenceResponse[] | undefined>;
    /**
     * Resource name
     */
