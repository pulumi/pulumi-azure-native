...
export function getRestorePoint(args: GetRestorePointArgs, opts?: pulumi.InvokeOptions): Promise<GetRestorePointResult> {
    pulumi.log.warn("getRestorePoint is deprecated: azure-native:compute/v20210401:RestorePoint is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20211101:RestorePoint to guarantee forwards compatibility.")
