...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20210401:VirtualMachine';
     ...
     */
    public readonly additionalCapabilities!: pulumi.Output<outputs.compute.v20210401.AdditionalCapabilitiesResponse | undefined>;
    /**
     ...
     */
    public readonly availabilitySet!: pulumi.Output<outputs.compute.v20210401.SubResourceResponse | undefined>;
    /**
     * Specifies the billing related details of a Azure Spot virtual machine. <br><br>Minimum api-version: 2019-03-01.
     */
    public readonly billingProfile!: pulumi.Output<outputs.compute.v20210401.BillingProfileResponse | undefined>;
    /**
     ...
     */
    public readonly capacityReservation!: pulumi.Output<outputs.compute.v20210401.CapacityReservationProfileResponse | undefined>;
    /**
     * Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.
     */
    public readonly diagnosticsProfile!: pulumi.Output<outputs.compute.v20210401.DiagnosticsProfileResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.compute.v20210401.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly hardwareProfile!: pulumi.Output<outputs.compute.v20210401.HardwareProfileResponse | undefined>;
    /**
     * Specifies information about the dedicated host that the virtual machine resides in. <br><br>Minimum api-version: 2018-10-01.
     */
    public readonly host!: pulumi.Output<outputs.compute.v20210401.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly hostGroup!: pulumi.Output<outputs.compute.v20210401.SubResourceResponse | undefined>;
    /**
     * The identity of the virtual machine, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.compute.v20210401.VirtualMachineIdentityResponse | undefined>;
    /**
     * The virtual machine instance view.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20210401.VirtualMachineInstanceViewResponse>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.compute.v20210401.NetworkProfileResponse | undefined>;
    /**
     * Specifies the operating system settings used while creating the virtual machine. Some of the settings cannot be changed once VM is provisioned.
     */
    public readonly osProfile!: pulumi.Output<outputs.compute.v20210401.OSProfileResponse | undefined>;
    /**
     * Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use.  In the Azure portal, find the marketplace image that you want to use and then click **Want to deploy programmatically, Get Started ->**. Enter any required information and then click **Save**.
     */
    public readonly plan!: pulumi.Output<outputs.compute.v20210401.PlanResponse | undefined>;
    /**
     ...
     */
    public readonly proximityPlacementGroup!: pulumi.Output<outputs.compute.v20210401.SubResourceResponse | undefined>;
    /**
     * The virtual machine child extension resources.
     */
    public /*out*/ readonly resources!: pulumi.Output<outputs.compute.v20210401.VirtualMachineExtensionResponse[]>;
    /**
     * Specifies Scheduled Event related configurations.
     */
    public readonly scheduledEventsProfile!: pulumi.Output<outputs.compute.v20210401.ScheduledEventsProfileResponse | undefined>;
    /**
     * Specifies the Security related profile settings for the virtual machine.
     */
    public readonly securityProfile!: pulumi.Output<outputs.compute.v20210401.SecurityProfileResponse | undefined>;
    /**
     * Specifies the storage settings for the virtual machine disks.
     */
    public readonly storageProfile!: pulumi.Output<outputs.compute.v20210401.StorageProfileResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachineScaleSet!: pulumi.Output<outputs.compute.v20210401.SubResourceResponse | undefined>;
    /**
...
export interface VirtualMachineArgs {
     ...
     * Specifies additional capabilities enabled or disabled on the virtual machine.
     */
    additionalCapabilities?: pulumi.Input<inputs.compute.v20210401.AdditionalCapabilitiesArgs>;
    /**
     * Specifies information about the availability set that the virtual machine should be assigned to. Virtual machines specified in the same availability set are allocated to different nodes to maximize availability. For more information about availability sets, see [Availability sets overview](https://docs.microsoft.com/azure/virtual-machines/availability-set-overview). <br><br> For more information on Azure planned maintenance, see [Maintenance and updates for Virtual Machines in Azure](https://docs.microsoft.com/azure/virtual-machines/maintenance-and-updates) <br><br> Currently, a VM can only be added to availability set at creation time. The availability set to which the VM is being added should be under the same resource group as the availability set resource. An existing VM cannot be added to an availability set. <br><br>This property cannot exist along with a non-null properties.virtualMachineScaleSet reference.
     */
    availabilitySet?: pulumi.Input<inputs.compute.v20210401.SubResourceArgs>;
    /**
     * Specifies the billing related details of a Azure Spot virtual machine. <br><br>Minimum api-version: 2019-03-01.
     */
     ...
     * Specifies the hardware settings for the virtual machine.
     */
    hardwareProfile?: pulumi.Input<inputs.compute.v20210401.HardwareProfileArgs>;
    /**
     * Specifies information about the dedicated host that the virtual machine resides in. <br><br>Minimum api-version: 2018-10-01.
     */
    host?: pulumi.Input<inputs.compute.v20210401.SubResourceArgs>;
    /**
     * Specifies information about the dedicated host group that the virtual machine resides in. <br><br>Minimum api-version: 2020-06-01. <br><br>NOTE: User cannot specify both host and hostGroup properties.
     */
    hostGroup?: pulumi.Input<inputs.compute.v20210401.SubResourceArgs>;
    /**
     * The identity of the virtual machine, if configured.
     */
    identity?: pulumi.Input<inputs.compute.v20210401.VirtualMachineIdentityArgs>;
    /**
     * Specifies that the image or disk that is being used was licensed on-premises. <br><br> Possible values for Windows Server operating system are: <br><br> Windows_Client <br><br> Windows_Server <br><br> Possible values for Linux Server operating system are: <br><br> RHEL_BYOS (for RHEL) <br><br> SLES_BYOS (for SUSE) <br><br> For more information, see [Azure Hybrid Use Benefit for Windows Server](https://docs.microsoft.com/azure/virtual-machines/windows/hybrid-use-benefit-licensing) <br><br> [Azure Hybrid Use Benefit for Linux Server](https://docs.microsoft.com/azure/virtual-machines/linux/azure-hybrid-benefit-linux) <br><br> Minimum api-version: 2015-06-15
     */
     ...
     * Specifies the network interfaces of the virtual machine.
     */
    networkProfile?: pulumi.Input<inputs.compute.v20210401.NetworkProfileArgs>;
    /**
     * Specifies the operating system settings used while creating the virtual machine. Some of the settings cannot be changed once VM is provisioned.
     */
    osProfile?: pulumi.Input<inputs.compute.v20210401.OSProfileArgs>;
    /**
     * Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use.  In the Azure portal, find the marketplace image that you want to use and then click **Want to deploy programmatically, Get Started ->**. Enter any required information and then click **Save**.
     */
    plan?: pulumi.Input<inputs.compute.v20210401.PlanArgs>;
    /**
     * Specifies the scale set logical fault domain into which the Virtual Machine will be created. By default, the Virtual Machine will by automatically assigned to a fault domain that best maintains balance across available fault domains.<br><li>This is applicable only if the 'virtualMachineScaleSet' property of this Virtual Machine is set.<li>The Virtual Machine Scale Set that is referenced, must have 'platformFaultDomainCount' &gt; 1.<li>This property cannot be updated once the Virtual Machine is created.<li>Fault domain assignment can be viewed in the Virtual Machine Instance View.<br><br>Minimum api‐version: 2020‐12‐01
     */
     ...
     * Specifies information about the proximity placement group that the virtual machine should be assigned to. <br><br>Minimum api-version: 2018-04-01.
     */
    proximityPlacementGroup?: pulumi.Input<inputs.compute.v20210401.SubResourceArgs>;
    /**
     ...
     * Specifies the storage settings for the virtual machine disks.
     */
    storageProfile?: pulumi.Input<inputs.compute.v20210401.StorageProfileArgs>;
    /**
     * Resource tags
     */
     ...
     * Specifies information about the virtual machine scale set that the virtual machine should be assigned to. Virtual machines specified in the same virtual machine scale set are allocated to different nodes to maximize availability. Currently, a VM can only be added to virtual machine scale set at creation time. An existing VM cannot be added to a virtual machine scale set. <br><br>This property cannot exist along with a non-null properties.availabilitySet reference. <br><br>Minimum api‐version: 2019‐03‐01
     */
    virtualMachineScaleSet?: pulumi.Input<inputs.compute.v20210401.SubResourceArgs>;
    /**
