...
export class VirtualMachineScaleSetVMRunCommand extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualMachineScaleSetVMRunCommand {
        pulumi.log.warn("VirtualMachineScaleSetVMRunCommand is deprecated: azure-native:compute/v20210401:VirtualMachineScaleSetVMRunCommand is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:VirtualMachineScaleSetVMRunCommand to guarantee forwards compatibility.")
