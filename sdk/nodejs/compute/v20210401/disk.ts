 ...
 * Disk resource.
 *
 * @deprecated azure-native:compute/v20210401:Disk is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:Disk to guarantee forwards compatibility.
 */
export class Disk extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Disk {
        pulumi.log.warn("Disk is deprecated: azure-native:compute/v20210401:Disk is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:Disk to guarantee forwards compatibility.")
