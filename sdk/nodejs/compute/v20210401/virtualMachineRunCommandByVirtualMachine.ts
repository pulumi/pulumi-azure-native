...
export class VirtualMachineRunCommandByVirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20210401:VirtualMachineRunCommandByVirtualMachine';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.compute.v20210401.VirtualMachineRunCommandInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.compute.v20210401.RunCommandInputParameterResponse[] | undefined>;
    /**
     * The parameters used by the script.
     */
    public readonly protectedParameters!: pulumi.Output<outputs.compute.v20210401.RunCommandInputParameterResponse[] | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.compute.v20210401.VirtualMachineRunCommandScriptSourceResponse | undefined>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: VirtualMachineRunCommandByVirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute/v20210401:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-native:compute:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-nextgen:compute:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-native:compute/v20200601:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-nextgen:compute/v20200601:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-native:compute/v20201201:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-nextgen:compute/v20201201:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-native:compute/v20210301:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-nextgen:compute/v20210301:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-native:compute/v20210701:VirtualMachineRunCommandByVirtualMachine" }, { type: "azure-nextgen:compute/v20210701:VirtualMachineRunCommandByVirtualMachine" }] };
...
export interface VirtualMachineRunCommandByVirtualMachineArgs {
     ...
     * The parameters used by the script.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.compute.v20210401.RunCommandInputParameterArgs>[]>;
    /**
     * The parameters used by the script.
     */
    protectedParameters?: pulumi.Input<pulumi.Input<inputs.compute.v20210401.RunCommandInputParameterArgs>[]>;
    /**
     ...
     * The source of the run command script.
     */
    source?: pulumi.Input<inputs.compute.v20210401.VirtualMachineRunCommandScriptSourceArgs>;
    /**
     * Resource tags
     */
