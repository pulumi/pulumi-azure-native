 ...
 *
 * @deprecated azure-native:compute/v20210401:AvailabilitySet is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:AvailabilitySet to guarantee forwards compatibility.
 */
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AvailabilitySet {
        pulumi.log.warn("AvailabilitySet is deprecated: azure-native:compute/v20210401:AvailabilitySet is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:AvailabilitySet to guarantee forwards compatibility.")
