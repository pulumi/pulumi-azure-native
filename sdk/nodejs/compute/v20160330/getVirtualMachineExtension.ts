...
export function getVirtualMachineExtension(args: GetVirtualMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:compute/v20160330:getVirtualMachineExtension", {
        "name": args.name,
...
export interface GetVirtualMachineExtensionResult {
     ...
     */
    readonly properties: outputs.compute.v20160330.VirtualMachineExtensionPropertiesResponse;
    /**
     * Resource tags
     */
