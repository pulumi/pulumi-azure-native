...
export function getCloudService(args: GetCloudServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudServiceResult> {
    pulumi.log.warn("getCloudService is deprecated: azure-native:compute/v20201001preview:CloudService is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220904:CloudService to guarantee forwards compatibility.")
