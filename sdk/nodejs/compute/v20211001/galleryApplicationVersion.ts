 ...
 *
 * @deprecated azure-native:compute/v20211001:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.
 */
export class GalleryApplicationVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GalleryApplicationVersion {
        pulumi.log.warn("GalleryApplicationVersion is deprecated: azure-native:compute/v20211001:GalleryApplicationVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryApplicationVersion to guarantee forwards compatibility.")
        return new GalleryApplicationVersion(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20211001:GalleryApplicationVersion';
     ...
     */
    public readonly publishingProfile!: pulumi.Output<outputs.compute.v20211001.GalleryApplicationVersionPublishingProfileResponse>;
    /**
     * This is the replication status of the gallery image version.
     */
    public /*out*/ readonly replicationStatus!: pulumi.Output<outputs.compute.v20211001.ReplicationStatusResponse>;
    /**
     * Resource tags
     */
