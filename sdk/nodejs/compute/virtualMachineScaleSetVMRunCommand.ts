...
export class VirtualMachineScaleSetVMRunCommand extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualMachineScaleSetVMRunCommandArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:compute:VirtualMachineScaleSetVMRunCommand" }, { type: "azure-native:compute/latest:VirtualMachineScaleSetVMRunCommand" }, { type: "azure-nextgen:compute/latest:VirtualMachineScaleSetVMRunCommand" }, { type: "azure-native:compute/v20200601:VirtualMachineScaleSetVMRunCommand" }, { type: "azure-nextgen:compute/v20200601:VirtualMachineScaleSetVMRunCommand" }, { type: "azure-native:compute/v20201201:VirtualMachineScaleSetVMRunCommand" }, { type: "azure-nextgen:compute/v20201201:VirtualMachineScaleSetVMRunCommand" }] };
...
export interface VirtualMachineScaleSetVMRunCommandArgs {
     ...
     * The parameters used by the script.
     */
    readonly parameters?: pulumi.Input<pulumi.Input<inputs.compute.RunCommandInputParameter>[]>;
    /**
     * The parameters used by the script.
     */
    readonly protectedParameters?: pulumi.Input<pulumi.Input<inputs.compute.RunCommandInputParameter>[]>;
    /**
     ...
     * The source of the run command script.
     */
    readonly source?: pulumi.Input<inputs.compute.VirtualMachineRunCommandScriptSource>;
    /**
     * Resource tags
     */
