 ...
 *
 * ```sh
 * $ pulumi import azure-native:compute/v20160430preview:AvailabilitySet myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName} 
 * ```
 *
