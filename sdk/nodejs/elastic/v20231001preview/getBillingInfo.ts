...
export interface GetBillingInfoResult {
     ...
     */
    readonly marketplaceSaasInfo?: outputs.elastic.v20231001preview.MarketplaceSaaSInfoResponse;
    /**
     * Partner Billing Entity details: Organization Info
     */
    readonly partnerBillingEntity?: outputs.elastic.v20231001preview.PartnerBillingEntityResponse;
}
/**
 * Marketplace Subscription and Organization details to which resource gets billed into.
 */
export function getBillingInfoOutput(args: GetBillingInfoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBillingInfoResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:elastic/v20231001preview:getBillingInfo", {
        "monitorName": args.monitorName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
