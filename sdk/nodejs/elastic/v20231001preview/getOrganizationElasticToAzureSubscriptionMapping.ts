...
export interface GetOrganizationElasticToAzureSubscriptionMappingResult {
     ...
     */
    readonly properties: outputs.elastic.v20231001preview.ElasticOrganizationToAzureSubscriptionMappingResponsePropertiesResponse;
}
/**
 * Get Elastic Organization To Azure Subscription Mapping details for the logged-in user.
 */
export function getOrganizationElasticToAzureSubscriptionMappingOutput(opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrganizationElasticToAzureSubscriptionMappingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:elastic/v20231001preview:getOrganizationElasticToAzureSubscriptionMapping", {
    }, opts);
}
