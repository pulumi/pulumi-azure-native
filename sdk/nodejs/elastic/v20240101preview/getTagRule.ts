...
export interface GetTagRuleResult {
     ...
     */
    readonly properties: outputs.elastic.v20240101preview.MonitoringTagRulesPropertiesResponse;
    /**
     * The system metadata relating to this resource
     */
    readonly systemData: outputs.elastic.v20240101preview.SystemDataResponse;
    /**
...
export function getTagRuleOutput(args: GetTagRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTagRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:elastic/v20240101preview:getTagRule", {
        "monitorName": args.monitorName,
        "resourceGroupName": args.resourceGroupName,
        "ruleSetName": args.ruleSetName,
    }, opts);
