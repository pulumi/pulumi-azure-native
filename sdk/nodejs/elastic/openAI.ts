...
export class OpenAI extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.elastic.OpenAIIntegrationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: OpenAIArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elastic/v20240101preview:OpenAI" }] };
