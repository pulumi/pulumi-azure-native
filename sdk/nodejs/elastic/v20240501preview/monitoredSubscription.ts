...
export class MonitoredSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MonitoredSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elastic/v20240615preview:MonitoredSubscription" }, { type: "azure-native:elastic/v20241001preview:MonitoredSubscription" }, { type: "azure-native:elastic:MonitoredSubscription" }] };
