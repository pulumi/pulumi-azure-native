...
export class TagRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elastic:TagRule" }, { type: "azure-native:elastic/v20200701:TagRule" }, { type: "azure-native:elastic/v20220901preview:TagRule" }, { type: "azure-native:elastic/v20230501preview:TagRule" }, { type: "azure-native:elastic/v20230601:TagRule" }] };
