...
export class MonitoredSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elastic/v20241001preview:MonitoredSubscription';
     ...
     * The request to update subscriptions needed to be monitored by the Elastic monitor resource.
     */
    public readonly properties!: pulumi.Output<outputs.elastic.v20241001preview.SubscriptionListResponse>;
    /**
