...
export class MonitoredSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elastic/v20240615preview:MonitoredSubscription';
     ...
     * The request to update subscriptions needed to be monitored by the Elastic monitor resource.
     */
    public readonly properties!: pulumi.Output<outputs.elastic.v20240615preview.SubscriptionListResponse>;
    /**
    ...
    constructor(name: string, args: MonitoredSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elastic:MonitoredSubscription" }, { type: "azure-native:elastic/v20240501preview:MonitoredSubscription" }] };
