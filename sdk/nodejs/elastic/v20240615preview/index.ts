...
// Export enums:
export * from "../../types/enums/elastic/v20240615preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:elastic/v20240615preview:Monitor":
                return new Monitor(name, <any>undefined, { urn })
            case "azure-native:elastic/v20240615preview:MonitoredSubscription":
                return new MonitoredSubscription(name, <any>undefined, { urn })
            case "azure-native:elastic/v20240615preview:OpenAI":
                return new OpenAI(name, <any>undefined, { urn })
            case "azure-native:elastic/v20240615preview:TagRule":
...
pulumi.runtime.registerResourceModule("azure-native", "elastic/v20240615preview", _module)
