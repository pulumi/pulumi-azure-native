...
// Export enums:
export * from "../../types/enums/elastic/v20230701preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:elastic/v20230701preview:Monitor":
                return new Monitor(name, <any>undefined, { urn })
            case "azure-native:elastic/v20230701preview:TagRule":
...
pulumi.runtime.registerResourceModule("azure-native", "elastic/v20230701preview", _module)
