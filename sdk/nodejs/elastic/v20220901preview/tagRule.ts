...
export class TagRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elastic/v20220901preview:TagRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.elastic.v20220901preview.MonitoringTagRulesPropertiesResponse>;
    /**
...
export interface TagRuleArgs {
     ...
     * Properties of the monitoring tag rules.
     */
    properties?: pulumi.Input<inputs.elastic.v20220901preview.MonitoringTagRulesPropertiesArgs>;
    /**
