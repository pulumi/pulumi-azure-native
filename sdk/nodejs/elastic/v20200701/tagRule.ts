...
export class TagRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:elastic/v20200701:TagRule" }, { type: "azure-native:elastic:TagRule" }, { type: "azure-nextgen:elastic:TagRule" }, { type: "azure-native:elastic/v20200701preview:TagRule" }, { type: "azure-nextgen:elastic/v20200701preview:TagRule" }] };
