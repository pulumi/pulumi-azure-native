...
export class PrivateEndpointConnectionProxy extends pulumi.CustomResource {
     ...
     */
    public readonly remotePrivateEndpoint!: pulumi.Output<outputs.deviceupdate.v20230701.RemotePrivateEndpointResponse | undefined>;
    /**
     * Operation status.
     */
    ...
    constructor(name: string, args: PrivateEndpointConnectionProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceupdate/v20200301preview:PrivateEndpointConnectionProxy" }, { type: "azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy" }, { type: "azure-native:deviceupdate/v20221001:PrivateEndpointConnectionProxy" }, { type: "azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy" }, { type: "azure-native:deviceupdate:PrivateEndpointConnectionProxy" }] };
...
export interface PrivateEndpointConnectionProxyArgs {
     ...
     * Remote private endpoint details.
     */
    remotePrivateEndpoint?: pulumi.Input<inputs.deviceupdate.v20230701.RemotePrivateEndpointArgs>;
    /**
