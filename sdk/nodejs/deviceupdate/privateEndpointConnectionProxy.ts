...
export class PrivateEndpointConnectionProxy extends pulumi.CustomResource {
     ...
     */
    declare public readonly remotePrivateEndpoint: pulumi.Output<outputs.deviceupdate.RemotePrivateEndpointResponse | undefined>;
    /**
     * Operation status.
     */
    ...
    constructor(name: string, args: PrivateEndpointConnectionProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.privateEndpointConnectionProxyId === undefined && !opts.urn) {
                throw new Error("Missing required property 'privateEndpointConnectionProxyId'");
            }
