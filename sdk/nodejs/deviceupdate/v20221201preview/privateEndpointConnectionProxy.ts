...
export class PrivateEndpointConnectionProxy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpointConnectionProxy {
        pulumi.log.warn("PrivateEndpointConnectionProxy is deprecated: azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy to guarantee forwards compatibility.")
        return new PrivateEndpointConnectionProxy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy';
     ...
     */
    public readonly remotePrivateEndpoint!: pulumi.Output<outputs.deviceupdate.v20221201preview.RemotePrivateEndpointResponse | undefined>;
    /**
     * Operation status.
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.deviceupdate.v20221201preview.SystemDataResponse>;
    /**
...
export interface PrivateEndpointConnectionProxyArgs {
     ...
     * Remote private endpoint details.
     */
    remotePrivateEndpoint?: pulumi.Input<inputs.deviceupdate.v20221201preview.RemotePrivateEndpointArgs>;
    /**
