...
// Export enums:
export * from "../../types/enums/deviceupdate/v20221201preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:deviceupdate/v20221201preview:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:deviceupdate/v20221201preview:Instance":
                return new Instance(name, <any>undefined, { urn })
            case "azure-native:deviceupdate/v20221201preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy":
...
pulumi.runtime.registerResourceModule("azure-native", "deviceupdate/v20221201preview", _module)
