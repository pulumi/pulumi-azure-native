...
export class Controller extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devspaces/v20190401:Controller';
    ...
    constructor(name: string, args: ControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devspaces/latest:Controller" }, { type: "azurerm:devspaces/preview:Controller" }] };
