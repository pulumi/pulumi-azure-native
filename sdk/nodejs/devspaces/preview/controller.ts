...
export class Controller extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devspaces/preview:Controller';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.devspaces.preview.SkuResponse>;
    /**
    ...
    constructor(name: string, args: ControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devspaces/latest:Controller" }, { type: "azurerm:devspaces/v20190401:Controller" }] };
...
export interface ControllerArgs {
     ...
     * Model representing SKU for Azure Dev Spaces Controller.
     */
    readonly sku: pulumi.Input<inputs.devspaces.preview.Sku>;
    /**
     * Tags for the Azure resource.
     */
