...
export interface GetGuestAgentResult {
     ...
     */
    readonly credentials?: outputs.azurestackhci.v20230701preview.GuestCredentialResponse;
    /**
     * HTTP Proxy configuration for the VM.
     */
    readonly httpProxyConfig?: outputs.azurestackhci.v20230701preview.HttpProxyConfigurationResponse;
    /**
...
export function getGuestAgentOutput(args: GetGuestAgentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGuestAgentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20230701preview:getGuestAgent", {
        "resourceUri": args.resourceUri,
    }, opts);
}
