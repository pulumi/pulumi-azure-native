...
export class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.azurestackhci.NetworkInterfaceArmReferenceResponse[]>;
    /**
    ...
    constructor(name: string, args: NetworkSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20240201preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240501preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240715preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240801preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20241001preview:NetworkSecurityGroup" }, { type: "azure-native_azurestackhci_v20240201preview:azurestackhci:NetworkSecurityGroup" }, { type: "azure-native_azurestackhci_v20240501preview:azurestackhci:NetworkSecurityGroup" }, { type: "azure-native_azurestackhci_v20240715preview:azurestackhci:NetworkSecurityGroup" }, { type: "azure-native_azurestackhci_v20240801preview:azurestackhci:NetworkSecurityGroup" }, { type: "azure-native_azurestackhci_v20241001preview:azurestackhci:NetworkSecurityGroup" }, { type: "azure-native_azurestackhci_v20250201preview:azurestackhci:NetworkSecurityGroup" }, { type: "azure-native_azurestackhci_v20250401preview:azurestackhci:NetworkSecurityGroup" }] };
