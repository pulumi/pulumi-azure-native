...
export class DevicePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci:DevicePool';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.azurestackhci.DevicePoolPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DevicePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["devicePoolName"] = args?.devicePoolName;
