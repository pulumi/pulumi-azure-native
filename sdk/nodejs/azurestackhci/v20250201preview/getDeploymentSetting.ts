...
export function getDeploymentSetting(args: GetDeploymentSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentSettingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20250201preview:getDeploymentSetting", {
...
export interface GetDeploymentSettingResult {
     ...
     */
    readonly deploymentConfiguration: outputs.azurestackhci.v20250201preview.DeploymentConfigurationResponse;
    /**
     ...
     */
    readonly reportedProperties: outputs.azurestackhci.v20250201preview.EceReportedPropertiesResponse;
    /**
...
export function getDeploymentSettingOutput(args: GetDeploymentSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20250201preview:getDeploymentSetting", {
        "clusterName": args.clusterName,
        "deploymentSettingsName": args.deploymentSettingsName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
