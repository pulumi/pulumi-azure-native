...
export class DeploymentSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20250201preview:DeploymentSetting';
     ...
     */
    public readonly deploymentConfiguration!: pulumi.Output<outputs.azurestackhci.v20250201preview.DeploymentConfigurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly reportedProperties!: pulumi.Output<outputs.azurestackhci.v20250201preview.EceReportedPropertiesResponse>;
    /**
...
export interface DeploymentSettingArgs {
     ...
     * Scale units will contains list of deployment data
     */
    deploymentConfiguration: pulumi.Input<inputs.azurestackhci.v20250201preview.DeploymentConfigurationArgs>;
    /**
     * The deployment mode for cluster deployment.
     */
    deploymentMode: pulumi.Input<string | enums.azurestackhci.v20250201preview.DeploymentMode>;
    /**
     ...
     * The intended operation for a cluster.
     */
    operationType?: pulumi.Input<string | enums.azurestackhci.v20250201preview.OperationType>;
    /**
