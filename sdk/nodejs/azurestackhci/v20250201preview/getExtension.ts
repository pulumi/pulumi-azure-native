...
export function getExtension(args: GetExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20250201preview:getExtension", {
...
export interface GetExtensionResult {
     ...
     */
    readonly perNodeExtensionDetails: outputs.azurestackhci.v20250201preview.PerNodeExtensionStateResponse[];
    /**
...
export function getExtensionOutput(args: GetExtensionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExtensionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20250201preview:getExtension", {
        "arcSettingName": args.arcSettingName,
        "clusterName": args.clusterName,
        "extensionName": args.extensionName,
        "resourceGroupName": args.resourceGroupName,
