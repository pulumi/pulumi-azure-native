...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20250201preview:NetworkSecurityGroup';
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.azurestackhci.v20250201preview.NetworkInterfaceArmReferenceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20250201preview.NetworkSecurityGroupStatusResponse>;
    /**
     * A collection of references to logical networks that are currently using this NSG
     */
    public /*out*/ readonly subnets!: pulumi.Output<outputs.azurestackhci.v20250201preview.LogicalNetworkArmReferenceResponse[]>;
    /**
    ...
    constructor(name: string, args: NetworkSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20240201preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240501preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240715preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240801preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20241001preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci:NetworkSecurityGroup" }] };
