...
export function getHciEdgeDeviceJob(args: GetHciEdgeDeviceJobArgs, opts?: pulumi.InvokeOptions): Promise<GetHciEdgeDeviceJobResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20250201preview:getHciEdgeDeviceJob", {
...
export interface GetHciEdgeDeviceJobResult {
     ...
     */
    readonly properties: outputs.azurestackhci.v20250201preview.HciCollectLogJobPropertiesResponse | outputs.azurestackhci.v20250201preview.HciRemoteSupportJobPropertiesResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.azurestackhci.v20250201preview.SystemDataResponse;
    /**
...
export function getHciEdgeDeviceJobOutput(args: GetHciEdgeDeviceJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHciEdgeDeviceJobResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20250201preview:getHciEdgeDeviceJob", {
        "edgeDeviceName": args.edgeDeviceName,
        "jobsName": args.jobsName,
        "resourceUri": args.resourceUri,
    }, opts);
