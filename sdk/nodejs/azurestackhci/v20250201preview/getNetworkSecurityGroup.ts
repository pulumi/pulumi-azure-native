...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20250201preview:getNetworkSecurityGroup", {
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly extendedLocation?: outputs.azurestackhci.v20250201preview.ExtendedLocationResponse;
    /**
     ...
     */
    readonly networkInterfaces: outputs.azurestackhci.v20250201preview.NetworkInterfaceArmReferenceResponse[];
    /**
     ...
     */
    readonly status: outputs.azurestackhci.v20250201preview.NetworkSecurityGroupStatusResponse;
    /**
     * A collection of references to logical networks that are currently using this NSG
     */
    readonly subnets: outputs.azurestackhci.v20250201preview.LogicalNetworkArmReferenceResponse[];
    /**
...
export function getNetworkSecurityGroupOutput(args: GetNetworkSecurityGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkSecurityGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20250201preview:getNetworkSecurityGroup", {
        "networkSecurityGroupName": args.networkSecurityGroupName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
