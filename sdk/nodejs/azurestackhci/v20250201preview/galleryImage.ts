...
export class GalleryImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20250201preview:GalleryImage';
     ...
     */
    public readonly identifier!: pulumi.Output<outputs.azurestackhci.v20250201preview.GalleryImageIdentifierResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20250201preview.GalleryImageStatusResponse>;
    /**
     ...
     */
    public readonly version!: pulumi.Output<outputs.azurestackhci.v20250201preview.GalleryImageVersionResponse | undefined>;
    /**
     * The credentials used to login to the image repository that has access to the specified image
     */
    public readonly vmImageRepositoryCredentials!: pulumi.Output<outputs.azurestackhci.v20250201preview.VmImageRepositoryCredentialsResponse | undefined>;
    ...
    constructor(name: string, args: GalleryImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210701preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20210901preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20221215preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20230701preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20230901preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20240101:GalleryImage" }, { type: "azure-native:azurestackhci/v20240201preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20240501preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20240715preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20240801preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20241001preview:GalleryImage" }, { type: "azure-native:azurestackhci/v20250401preview:GalleryImage" }, { type: "azure-native:azurestackhci:GalleryImage" }] };
...
export interface GalleryImageArgs {
     ...
     * Datasource for the gallery image when provisioning with cloud-init [NoCloud, Azure]
     */
    cloudInitDataSource?: pulumi.Input<string | enums.azurestackhci.v20250201preview.CloudInitDataSource>;
    /**
     * Storage ContainerID of the storage container to be used for gallery image
     */
     ...
     * This is the gallery image definition identifier.
     */
    identifier?: pulumi.Input<inputs.azurestackhci.v20250201preview.GalleryImageIdentifierArgs>;
    /**
     * location of the image the gallery image should be created from
     */
     ...
     * Operating system type that the gallery image uses [Windows, Linux]
     */
    osType: pulumi.Input<string | enums.azurestackhci.v20250201preview.OperatingSystemTypes>;
    /**
     ...
     * Specifies information about the gallery image version that you want to create or update.
     */
    version?: pulumi.Input<inputs.azurestackhci.v20250201preview.GalleryImageVersionArgs>;
    /**
     * The credentials used to login to the image repository that has access to the specified image
     */
    vmImageRepositoryCredentials?: pulumi.Input<inputs.azurestackhci.v20250201preview.VmImageRepositoryCredentialsArgs>;
}
