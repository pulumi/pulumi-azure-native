...
export class UpdateSummary extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20250201preview:UpdateSummary';
...
export interface UpdateSummaryArgs {
     ...
     * Overall update state of the stamp.
     */
    state?: pulumi.Input<string | enums.azurestackhci.v20250201preview.UpdateSummariesPropertiesState>;
}
