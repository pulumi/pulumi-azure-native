...
export function getUpdateSummary(args: GetUpdateSummaryArgs, opts?: pulumi.InvokeOptions): Promise<GetUpdateSummaryResult> {
    pulumi.log.warn("getUpdateSummary is deprecated: azure-native:azurestackhci/v20221201:UpdateSummary is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:UpdateSummary to guarantee forwards compatibility.")
