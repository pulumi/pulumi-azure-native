...
export class ArcSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20221201:ArcSetting';
     ...
     */
    public readonly connectivityProperties!: pulumi.Output<outputs.azurestackhci.v20221201.ArcConnectivityPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly perNodeDetails!: pulumi.Output<outputs.azurestackhci.v20221201.PerNodeStateResponse[]>;
    /**
...
export interface ArcSettingArgs {
     ...
     * contains connectivity related configuration for ARC resources
     */
    connectivityProperties?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20221201.ArcConnectivityPropertiesArgs>[]>;
    /**
