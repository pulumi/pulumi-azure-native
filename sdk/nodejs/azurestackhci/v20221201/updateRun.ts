...
export class UpdateRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20221201:UpdateRun';
     ...
     */
    public readonly steps!: pulumi.Output<outputs.azurestackhci.v20221201.StepResponse[] | undefined>;
    /**
...
export interface UpdateRunArgs {
     ...
     * State of the update run.
     */
    state?: pulumi.Input<string | enums.azurestackhci.v20221201.UpdateRunPropertiesState>;
    /**
     * Status of the step, bubbled up from the ECE action plan for installation attempts. Values are: 'Success', 'Error', 'InProgress', and 'Unknown status'.
     */
