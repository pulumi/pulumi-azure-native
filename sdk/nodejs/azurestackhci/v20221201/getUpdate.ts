 ...
 */
/** @deprecated azure-native:azurestackhci/v20221201:Update is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20230201:Update to guarantee forwards compatibility. */
export function getUpdate(args: GetUpdateArgs, opts?: pulumi.InvokeOptions): Promise<GetUpdateResult> {
    pulumi.log.warn("getUpdate is deprecated: azure-native:azurestackhci/v20221201:Update is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20230201:Update to guarantee forwards compatibility.")
