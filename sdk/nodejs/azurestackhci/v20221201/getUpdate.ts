...
export function getUpdate(args: GetUpdateArgs, opts?: pulumi.InvokeOptions): Promise<GetUpdateResult> {
    pulumi.log.warn("getUpdate is deprecated: azure-native:azurestackhci/v20221201:Update is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Update to guarantee forwards compatibility.")
