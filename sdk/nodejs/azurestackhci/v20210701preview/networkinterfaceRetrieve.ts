...
export class NetworkinterfaceRetrieve extends pulumi.CustomResource {
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.azurestackhci.v20210701preview.InterfaceDNSSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.azurestackhci.v20210701preview.IpConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20210701preview.NetworkInterfaceStatusResponse>;
    /**
    ...
    constructor(name: string, args: NetworkinterfaceRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210701preview:networkinterfaceRetrieve" }, { type: "azure-native:azurestackhci:NetworkinterfaceRetrieve" }, { type: "azure-native:azurestackhci:networkinterfaceRetrieve" }, { type: "azure-native:azurestackhci/v20210901preview:NetworkinterfaceRetrieve" }, { type: "azure-native:azurestackhci/v20210901preview:networkinterfaceRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:NetworkinterfaceRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:networkinterfaceRetrieve" }] };
...
export interface NetworkinterfaceRetrieveArgs {
     ...
     * DNS Settings for the interface
     */
    dnsSettings?: pulumi.Input<inputs.azurestackhci.v20210701preview.InterfaceDNSSettingsArgs>;
    /**
     * The extendedLocation of the resource.
     */
     ...
     * IPConfigurations - A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20210701preview.IpConfigurationArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
