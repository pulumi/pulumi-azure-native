 ...
 *
 * @deprecated azure-native:azurestackhci/v20210901preview:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.
 */
export class Extension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Extension {
        pulumi.log.warn("Extension is deprecated: azure-native:azurestackhci/v20210901preview:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.")
        return new Extension(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20210901preview:Extension';
     ...
     */
    public /*out*/ readonly perNodeExtensionDetails!: pulumi.Output<outputs.azurestackhci.v20210901preview.PerNodeExtensionStateResponse[]>;
    /**
...
export interface ExtensionArgs {
     ...
     * The type of identity that created the resource.
     */
    createdByType?: pulumi.Input<string | enums.azurestackhci.v20210901preview.CreatedByType>;
    /**
     ...
     * The type of identity that last modified the resource.
     */
    lastModifiedByType?: pulumi.Input<string | enums.azurestackhci.v20210901preview.CreatedByType>;
    /**
     * Protected settings (may contain secrets).
     */
