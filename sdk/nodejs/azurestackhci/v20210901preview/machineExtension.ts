...
export class MachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20210901preview:MachineExtension';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.azurestackhci.v20210901preview.MachineExtensionPropertiesResponseInstanceView | undefined>;
    /**
    ...
    constructor(name: string, args: MachineExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:MachineExtension" }, { type: "azure-native:azurestackhci/v20221215preview:MachineExtension" }] };
