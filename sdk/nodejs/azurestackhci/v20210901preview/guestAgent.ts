...
export class GuestAgent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GuestAgent {
        pulumi.log.warn("GuestAgent is deprecated: azure-native:azurestackhci/v20210901preview:GuestAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:GuestAgent to guarantee forwards compatibility.")
