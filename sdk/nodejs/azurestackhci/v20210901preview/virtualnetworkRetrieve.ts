...
export class VirtualnetworkRetrieve extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20210901preview.VirtualNetworkStatusResponse>;
    /**
     * Subnet - list of subnets under the virtual network
     */
    public readonly subnets!: pulumi.Output<outputs.azurestackhci.v20210901preview.VirtualnetworksPropertiesResponseSubnets[] | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualnetworkRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210701preview:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20210701preview:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20210901preview:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20230701preview:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20230701preview:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci:virtualnetworkRetrieve" }] };
...
export interface VirtualnetworkRetrieveArgs {
     ...
     * Type of the network
     */
    networkType?: pulumi.Input<string | enums.azurestackhci.v20210901preview.NetworkTypeEnum>;
    /**
     ...
     * Subnet - list of subnets under the virtual network
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20210901preview.VirtualnetworksPropertiesSubnetsArgs>[]>;
    /**
     * Resource tags.
     */
