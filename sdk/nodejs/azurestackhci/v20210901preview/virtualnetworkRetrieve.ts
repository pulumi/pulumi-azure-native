...
export class VirtualnetworkRetrieve extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualnetworkRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210901preview:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:virtualnetworkRetrieve" }] };
