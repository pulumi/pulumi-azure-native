...
export interface GetMarketplaceGalleryImageResult {
     ...
     */
    readonly identifier?: outputs.azurestackhci.v20221215preview.GalleryImageIdentifierResponse;
    /**
     ...
     */
    readonly status: outputs.azurestackhci.v20221215preview.MarketplaceGalleryImageStatusResponse;
    /**
     ...
     */
    readonly version?: outputs.azurestackhci.v20221215preview.GalleryImageVersionResponse;
}
/**
 * Gets a marketplace gallery image
 */
export function getMarketplaceGalleryImageOutput(args: GetMarketplaceGalleryImageOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMarketplaceGalleryImageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20221215preview:getMarketplaceGalleryImage", {
        "marketplaceGalleryImageName": args.marketplaceGalleryImageName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
