...
export interface GetArcSettingResult {
     ...
     */
    readonly connectivityProperties?: outputs.azurestackhci.v20221215preview.ArcConnectivityPropertiesResponse[];
    /**
     ...
     */
    readonly defaultExtensions: outputs.azurestackhci.v20221215preview.DefaultExtensionDetailsResponse[];
    /**
     ...
     */
    readonly perNodeDetails: outputs.azurestackhci.v20221215preview.PerNodeStateResponse[];
    /**
...
export function getArcSettingOutput(args: GetArcSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetArcSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20221215preview:getArcSetting", {
        "arcSettingName": args.arcSettingName,
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
