...
export class HybridIdentityMetadatum extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly identity!: pulumi.Output<outputs.azurestackhci.v20221215preview.IdentityResponse>;
    /**
    ...
    constructor(name: string, args: HybridIdentityMetadatumArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210901preview:HybridIdentityMetadatum" }] };
