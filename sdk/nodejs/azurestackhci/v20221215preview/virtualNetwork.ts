...
export class VirtualNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly dhcpOptions!: pulumi.Output<outputs.azurestackhci.v20221215preview.VirtualNetworkPropertiesResponseDhcpOptions | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20221215preview.VirtualNetworkStatusResponse>;
    /**
     * Subnet - list of subnets under the virtual network
     */
    public readonly subnets!: pulumi.Output<outputs.azurestackhci.v20221215preview.VirtualNetworkPropertiesResponseSubnets[] | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210701preview:VirtualNetwork" }, { type: "azure-native:azurestackhci/v20210901preview:VirtualNetwork" }, { type: "azure-native:azurestackhci/v20230701preview:VirtualNetwork" }, { type: "azure-native:azurestackhci:VirtualNetwork" }] };
...
export interface VirtualNetworkArgs {
     ...
     * DhcpOptions contains an array of DNS servers available to VMs deployed in the virtual network. Standard DHCP option for a subnet overrides VNET DHCP options.
     */
    dhcpOptions?: pulumi.Input<inputs.azurestackhci.v20221215preview.VirtualNetworkPropertiesDhcpOptionsArgs>;
    /**
     * The extendedLocation of the resource.
     */
     ...
     * Type of the network
     */
    networkType?: pulumi.Input<string | enums.azurestackhci.v20221215preview.NetworkTypeEnum>;
    /**
     ...
     * Subnet - list of subnets under the virtual network
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20221215preview.VirtualNetworkPropertiesSubnetsArgs>[]>;
    /**
     * Resource tags.
     */
