...
export class ArcSetting extends pulumi.CustomResource {
     ...
     */
    public readonly connectivityProperties!: pulumi.Output<outputs.azurestackhci.v20221215preview.ArcConnectivityPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly defaultExtensions!: pulumi.Output<outputs.azurestackhci.v20221215preview.DefaultExtensionDetailsResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly perNodeDetails!: pulumi.Output<outputs.azurestackhci.v20221215preview.PerNodeStateResponse[]>;
    /**
    ...
    constructor(name: string, args: ArcSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:ArcSetting" }, { type: "azure-native:azurestackhci/v20210101preview:ArcSetting" }, { type: "azure-native:azurestackhci/v20210901preview:ArcSetting" }, { type: "azure-native:azurestackhci/v20220101:ArcSetting" }, { type: "azure-native:azurestackhci/v20220901:ArcSetting" }, { type: "azure-native:azurestackhci/v20221001:ArcSetting" }, { type: "azure-native:azurestackhci/v20230201:ArcSetting" }, { type: "azure-native:azurestackhci/v20230301:ArcSetting" }] };
...
export interface ArcSettingArgs {
     ...
     * contains connectivity related configuration for ARC resources
     */
    connectivityProperties?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20221215preview.ArcConnectivityPropertiesArgs>[]>;
    /**
     * The timestamp of resource creation (UTC).
     */
