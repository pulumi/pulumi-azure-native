...
export class Extension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Extension {
        pulumi.log.warn("Extension is deprecated: azure-native:azurestackhci/v20220501:Extension is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20221001:Extension to guarantee forwards compatibility.")
