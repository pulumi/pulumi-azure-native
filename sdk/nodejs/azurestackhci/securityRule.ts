...
export class SecurityRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SecurityRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20240201preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20240501preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20240715preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20240801preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20241001preview:SecurityRule" }, { type: "azure-native_azurestackhci_v20240201preview:azurestackhci:SecurityRule" }, { type: "azure-native_azurestackhci_v20240501preview:azurestackhci:SecurityRule" }, { type: "azure-native_azurestackhci_v20240715preview:azurestackhci:SecurityRule" }, { type: "azure-native_azurestackhci_v20240801preview:azurestackhci:SecurityRule" }, { type: "azure-native_azurestackhci_v20241001preview:azurestackhci:SecurityRule" }, { type: "azure-native_azurestackhci_v20250201preview:azurestackhci:SecurityRule" }, { type: "azure-native_azurestackhci_v20250401preview:azurestackhci:SecurityRule" }] };
