...
export function getMarketplaceGalleryImage(args: GetMarketplaceGalleryImageArgs, opts?: pulumi.InvokeOptions): Promise<GetMarketplaceGalleryImageResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20240715preview:getMarketplaceGalleryImage", {
...
export interface GetMarketplaceGalleryImageResult {
     ...
     */
    readonly identifier?: outputs.azurestackhci.v20240715preview.GalleryImageIdentifierResponse;
    /**
     ...
     */
    readonly status: outputs.azurestackhci.v20240715preview.MarketplaceGalleryImageStatusResponse;
    /**
     ...
     */
    readonly version?: outputs.azurestackhci.v20240715preview.GalleryImageVersionResponse;
}
/**
 * Gets a marketplace gallery image
 */
export function getMarketplaceGalleryImageOutput(args: GetMarketplaceGalleryImageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMarketplaceGalleryImageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20240715preview:getMarketplaceGalleryImage", {
        "marketplaceGalleryImageName": args.marketplaceGalleryImageName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
