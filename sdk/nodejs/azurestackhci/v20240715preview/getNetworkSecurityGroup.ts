...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20240715preview:getNetworkSecurityGroup", {
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly networkInterfaces: outputs.azurestackhci.v20240715preview.NetworkInterfaceArmReferenceResponse[];
    /**
     ...
     */
    readonly subnets: outputs.azurestackhci.v20240715preview.LogicalNetworkArmReferenceResponse[];
    /**
