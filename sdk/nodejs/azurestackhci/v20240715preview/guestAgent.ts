...
export class GuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240715preview:GuestAgent';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.azurestackhci.v20240715preview.GuestCredentialResponse | undefined>;
    /**
    ...
    constructor(name: string, args: GuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:GuestAgent" }, { type: "azure-native:azurestackhci/v20230701preview:GuestAgent" }, { type: "azure-native:azurestackhci/v20230901preview:GuestAgent" }, { type: "azure-native:azurestackhci/v20240101:GuestAgent" }, { type: "azure-native:azurestackhci/v20240201preview:GuestAgent" }, { type: "azure-native:azurestackhci/v20240501preview:GuestAgent" }, { type: "azure-native:azurestackhci/v20240801preview:GuestAgent" }, { type: "azure-native:azurestackhci/v20241001preview:GuestAgent" }] };
...
export interface GuestAgentArgs {
     ...
     * Username / Password Credentials to provision guest agent.
     */
    credentials?: pulumi.Input<inputs.azurestackhci.v20240715preview.GuestCredentialArgs>;
    /**
     * The guest agent provisioning action.
     */
    provisioningAction?: pulumi.Input<string | enums.azurestackhci.v20240715preview.ProvisioningAction>;
    /**
