...
export class SecurityRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240715preview:SecurityRule';
    ...
    constructor(name: string, args: SecurityRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20240201preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20240501preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20240801preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20241001preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20250201preview:SecurityRule" }, { type: "azure-native:azurestackhci/v20250401preview:SecurityRule" }, { type: "azure-native:azurestackhci:SecurityRule" }] };
...
export interface SecurityRuleArgs {
     ...
     * The network traffic is allowed or denied.
     */
    access: pulumi.Input<string | enums.azurestackhci.v20240715preview.SecurityRuleAccess>;
    /**
     * A description for this rule. Restricted to 140 chars.
     */
     ...
     * The direction of the rule. The direction specifies if rule will be evaluated on incoming or outgoing traffic.
     */
    direction: pulumi.Input<string | enums.azurestackhci.v20240715preview.SecurityRuleDirection>;
    /**
     * The extendedLocation of the resource.
     */
     ...
     * Network protocol this rule applies to.
     */
    protocol: pulumi.Input<string | enums.azurestackhci.v20240715preview.SecurityRuleProtocol>;
    /**
