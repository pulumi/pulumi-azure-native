...
export function getUpdateRun(args: GetUpdateRunArgs, opts?: pulumi.InvokeOptions): Promise<GetUpdateRunResult> {
    pulumi.log.warn("getUpdateRun is deprecated: azure-native:azurestackhci/v20230201:UpdateRun is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20230301:UpdateRun to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20230201:getUpdateRun", {
...
export interface GetUpdateRunResult {
     ...
     */
    readonly steps?: outputs.azurestackhci.v20230201.StepResponse[];
    /**
