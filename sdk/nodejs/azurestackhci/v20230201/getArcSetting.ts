...
export function getArcSetting(args: GetArcSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetArcSettingResult> {
    pulumi.log.warn("getArcSetting is deprecated: azure-native:azurestackhci/v20230201:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20230301:ArcSetting to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20230201:getArcSetting", {
...
export interface GetArcSettingResult {
     ...
     */
    readonly connectivityProperties?: outputs.azurestackhci.v20230201.ArcConnectivityPropertiesResponse[];
    /**
     ...
     */
    readonly perNodeDetails: outputs.azurestackhci.v20230201.PerNodeStateResponse[];
    /**
