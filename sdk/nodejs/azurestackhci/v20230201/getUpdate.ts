...
export function getUpdate(args: GetUpdateArgs, opts?: pulumi.InvokeOptions): Promise<GetUpdateResult> {
    pulumi.log.warn("getUpdate is deprecated: azure-native:azurestackhci/v20230201:Update is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20230301:Update to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20230201:getUpdate", {
...
export interface GetUpdateResult {
     ...
     */
    readonly prerequisites?: outputs.azurestackhci.v20230201.UpdatePrerequisiteResponse[];
    /**
     ...
     */
    readonly systemData: outputs.azurestackhci.v20230201.SystemDataResponse;
    /**
