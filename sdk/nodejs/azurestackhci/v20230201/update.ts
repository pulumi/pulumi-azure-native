 ...
 *
 * const update = new azure_native.azurestackhci.v20230201.Update("update", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:azurestackhci/v20230201:Update Microsoft4.2203.2.32 /subscriptions/b8d594e5-51f3-4c11-9c54-a7771b81c712/resourceGroups/testrg/providers/Microsoft.AzureStackHCI/clusters/testcluster/updates/Microsoft4.2203.2.32 
 * ```
 */
export class Update extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20230201:Update';
     ...
     */
    public readonly prerequisites!: pulumi.Output<outputs.azurestackhci.v20230201.UpdatePrerequisiteResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: UpdateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:Update" }, { type: "azure-native:azurestackhci/v20221201:Update" }, { type: "azure-native:azurestackhci/v20230301:Update" }] };
...
export interface UpdateArgs {
     ...
     * Indicates the way the update content can be downloaded.
     */
    availabilityType?: pulumi.Input<string | enums.azurestackhci.v20230201.AvailabilityType>;
    /**
     ...
     * If update State is HasPrerequisite, this property contains an array of objects describing prerequisite updates before installing this update. Otherwise, it is empty.
     */
    prerequisites?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20230201.UpdatePrerequisiteArgs>[]>;
    /**
     * Progress percentage of ongoing operation. Currently this property is only valid when the update is in the Downloading state, where it maps to how much of the update content has been downloaded.
     */
     ...
     * State of the update as it relates to this stamp.
     */
    state?: pulumi.Input<string | enums.azurestackhci.v20230201.State>;
    /**
