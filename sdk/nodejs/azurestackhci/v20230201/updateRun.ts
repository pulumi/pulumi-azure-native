 ...
 *
 * const updateRun = new azure_native.azurestackhci.v20230201.UpdateRun("updateRun", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:azurestackhci/v20230201:UpdateRun Microsoft4.2203.2.32/23b779ba-0d52-4a80-8571-45ca74664ec3 /subscriptions/b8d594e5-51f3-4c11-9c54-a7771b81c712/resourceGroups/testrg/providers/Microsoft.AzureStackHCI/clusters/testcluster/updates/Microsoft4.2203.2.32/updateRuns/23b779ba-0d52-4a80-8571-45ca74664ec3 
 * ```
 */
export class UpdateRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20230201:UpdateRun';
     ...
     */
    public readonly steps!: pulumi.Output<outputs.azurestackhci.v20230201.StepResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: UpdateRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:UpdateRun" }, { type: "azure-native:azurestackhci/v20221201:UpdateRun" }, { type: "azure-native:azurestackhci/v20230301:UpdateRun" }] };
...
export interface UpdateRunArgs {
     ...
     * State of the update run.
     */
    state?: pulumi.Input<string | enums.azurestackhci.v20230201.UpdateRunPropertiesState>;
    /**
     * Status of the step, bubbled up from the ECE action plan for installation attempts. Values are: 'Success', 'Error', 'InProgress', and 'Unknown status'.
     */
     ...
     * Recursive model for child steps of this step.
     */
    steps?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20230201.StepArgs>[]>;
    /**
     * Timestamp of the update run was started.
     */
