...
export class UpdateRun extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UpdateRun {
        pulumi.log.warn("UpdateRun is deprecated: azure-native:azurestackhci/v20230201:UpdateRun is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20230301:UpdateRun to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: UpdateRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20221201:UpdateRun" }] };
