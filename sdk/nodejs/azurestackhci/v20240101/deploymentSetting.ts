...
export class DeploymentSetting extends pulumi.CustomResource {
     ...
     */
    public readonly deploymentConfiguration!: pulumi.Output<outputs.azurestackhci.v20240101.DeploymentConfigurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly reportedProperties!: pulumi.Output<outputs.azurestackhci.v20240101.ReportedPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DeploymentSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:DeploymentSetting" }, { type: "azure-native:azurestackhci/v20230801preview:DeploymentSetting" }, { type: "azure-native:azurestackhci/v20231101preview:DeploymentSetting" }] };
