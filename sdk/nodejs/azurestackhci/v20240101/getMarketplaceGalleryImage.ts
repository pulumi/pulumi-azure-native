...
export interface GetMarketplaceGalleryImageResult {
     ...
     */
    readonly identifier?: outputs.azurestackhci.v20240101.GalleryImageIdentifierResponse;
    /**
     ...
     */
    readonly status: outputs.azurestackhci.v20240101.MarketplaceGalleryImageStatusResponse;
    /**
     ...
     */
    readonly version?: outputs.azurestackhci.v20240101.GalleryImageVersionResponse;
}
/**
 * Gets a marketplace gallery image
 */
export function getMarketplaceGalleryImageOutput(args: GetMarketplaceGalleryImageOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMarketplaceGalleryImageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20240101:getMarketplaceGalleryImage", {
        "marketplaceGalleryImageName": args.marketplaceGalleryImageName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
