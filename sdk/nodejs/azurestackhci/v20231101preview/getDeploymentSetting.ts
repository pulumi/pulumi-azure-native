...
export interface GetDeploymentSettingResult {
     ...
     */
    readonly deploymentConfiguration: outputs.azurestackhci.v20231101preview.DeploymentConfigurationResponse;
    /**
     ...
     */
    readonly reportedProperties: outputs.azurestackhci.v20231101preview.ReportedPropertiesResponse;
    /**
...
export function getDeploymentSettingOutput(args: GetDeploymentSettingOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDeploymentSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20231101preview:getDeploymentSetting", {
        "clusterName": args.clusterName,
        "deploymentSettingsName": args.deploymentSettingsName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
