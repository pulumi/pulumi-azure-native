...
export class LogicalNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240501preview:LogicalNetwork';
     ...
     */
    public readonly dhcpOptions!: pulumi.Output<outputs.azurestackhci.v20240501preview.LogicalNetworkPropertiesDhcpOptionsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20240501preview.LogicalNetworkStatusResponse>;
    /**
     * Subnet - list of subnets under the logical network
     */
    public readonly subnets!: pulumi.Output<outputs.azurestackhci.v20240501preview.SubnetResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: LogicalNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20230901preview:LogicalNetwork" }, { type: "azure-native:azurestackhci/v20240101:LogicalNetwork" }, { type: "azure-native:azurestackhci/v20240201preview:LogicalNetwork" }, { type: "azure-native:azurestackhci/v20240715preview:LogicalNetwork" }, { type: "azure-native:azurestackhci/v20240801preview:LogicalNetwork" }, { type: "azure-native:azurestackhci/v20241001preview:LogicalNetwork" }, { type: "azure-native:azurestackhci/v20250201preview:LogicalNetwork" }, { type: "azure-native:azurestackhci/v20250401preview:LogicalNetwork" }, { type: "azure-native:azurestackhci:LogicalNetwork" }] };
...
export interface LogicalNetworkArgs {
     ...
     * DhcpOptions contains an array of DNS servers available to VMs deployed in the logical network. Standard DHCP option for a subnet overrides logical network DHCP options.
     */
    dhcpOptions?: pulumi.Input<inputs.azurestackhci.v20240501preview.LogicalNetworkPropertiesDhcpOptionsArgs>;
    /**
     * The extendedLocation of the resource.
     */
     ...
     * Subnet - list of subnets under the logical network
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20240501preview.SubnetArgs>[]>;
    /**
     * Resource tags.
     */
