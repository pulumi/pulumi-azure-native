...
export class VirtualHardDisk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20250401preview:VirtualHardDisk';
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20250401preview.VirtualHardDiskStatusResponse>;
    /**
...
export interface VirtualHardDiskArgs {
     ...
     * The format of the actual VHD file [vhd, vhdx]
     */
    diskFileFormat?: pulumi.Input<string | enums.azurestackhci.v20250401preview.DiskFileFormat>;
    /**
     * Size of the disk in GB
     */
     ...
     * The hypervisor generation of the Virtual Machine [V1, V2]
     */
    hyperVGeneration?: pulumi.Input<string | enums.azurestackhci.v20250401preview.HyperVGeneration>;
    /**
     * The geo-location where the resource lives
     */
