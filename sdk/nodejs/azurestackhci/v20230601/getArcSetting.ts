...
export interface GetArcSettingResult {
     ...
     */
    readonly connectivityProperties?: outputs.azurestackhci.v20230601.ArcConnectivityPropertiesResponse[];
    /**
     * Properties for each of the default extensions category
     */
    readonly defaultExtensions: outputs.azurestackhci.v20230601.DefaultExtensionDetailsResponse[];
    /**
     ...
     */
    readonly perNodeDetails: outputs.azurestackhci.v20230601.PerNodeStateResponse[];
    /**
...
export function getArcSettingOutput(args: GetArcSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetArcSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20230601:getArcSetting", {
        "arcSettingName": args.arcSettingName,
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
