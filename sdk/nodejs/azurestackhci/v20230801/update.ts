...
export class Update extends pulumi.CustomResource {
     ...
     */
    public readonly prerequisites!: pulumi.Output<outputs.azurestackhci.v20230801.UpdatePrerequisiteResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: UpdateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:Update" }, { type: "azure-native:azurestackhci/v20221201:Update" }, { type: "azure-native:azurestackhci/v20221215preview:Update" }, { type: "azure-native:azurestackhci/v20230201:Update" }, { type: "azure-native:azurestackhci/v20230301:Update" }, { type: "azure-native:azurestackhci/v20230601:Update" }, { type: "azure-native:azurestackhci/v20230801preview:Update" }, { type: "azure-native:azurestackhci/v20231101preview:Update" }, { type: "azure-native:azurestackhci/v20240101:Update" }, { type: "azure-native:azurestackhci/v20240215preview:Update" }, { type: "azure-native:azurestackhci/v20240401:Update" }, { type: "azure-native:azurestackhci/v20240901preview:Update" }, { type: "azure-native:azurestackhci/v20241201preview:Update" }] };
...
export interface UpdateArgs {
     ...
     * Indicates the way the update content can be downloaded.
     */
    availabilityType?: pulumi.Input<string | enums.azurestackhci.v20230801.AvailabilityType>;
    /**
     ...
     * If update State is HasPrerequisite, this property contains an array of objects describing prerequisite updates before installing this update. Otherwise, it is empty.
     */
    prerequisites?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20230801.UpdatePrerequisiteArgs>[]>;
    /**
     * Progress percentage of ongoing operation. Currently this property is only valid when the update is in the Downloading state, where it maps to how much of the update content has been downloaded.
     */
     ...
     * State of the update as it relates to this stamp.
     */
    state?: pulumi.Input<string | enums.azurestackhci.v20230801.State>;
    /**
