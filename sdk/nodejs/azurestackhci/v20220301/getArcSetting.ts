...
export function getArcSetting(args: GetArcSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetArcSettingResult> {
    pulumi.log.warn("getArcSetting is deprecated: azure-native:azurestackhci/v20220301:ArcSetting is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20221001:ArcSetting to guarantee forwards compatibility.")
