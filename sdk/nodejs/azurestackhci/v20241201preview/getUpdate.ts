...
export function getUpdate(args: GetUpdateArgs, opts?: pulumi.InvokeOptions): Promise<GetUpdateResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20241201preview:getUpdate", {
...
export interface GetUpdateResult {
     ...
     */
    readonly prerequisites?: outputs.azurestackhci.v20241201preview.UpdatePrerequisiteResponse[];
    /**
     ...
     */
    readonly systemData: outputs.azurestackhci.v20241201preview.SystemDataResponse;
    /**
...
export function getUpdateOutput(args: GetUpdateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUpdateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20241201preview:getUpdate", {
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
        "updateName": args.updateName,
    }, opts);
