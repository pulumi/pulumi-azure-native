...
export function getArcSetting(args: GetArcSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetArcSettingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20241201preview:getArcSetting", {
...
export interface GetArcSettingResult {
     ...
     */
    readonly connectivityProperties?: outputs.azurestackhci.v20241201preview.ArcConnectivityPropertiesResponse[];
    /**
     * Properties for each of the default extensions category
     */
    readonly defaultExtensions: outputs.azurestackhci.v20241201preview.DefaultExtensionDetailsResponse[];
    /**
     ...
     */
    readonly perNodeDetails: outputs.azurestackhci.v20241201preview.PerNodeStateResponse[];
    /**
...
export function getArcSettingOutput(args: GetArcSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetArcSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20241201preview:getArcSetting", {
        "arcSettingName": args.arcSettingName,
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
