...
export class UpdateRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20241201preview:UpdateRun';
     ...
     */
    public readonly steps!: pulumi.Output<outputs.azurestackhci.v20241201preview.StepResponse[] | undefined>;
    /**
...
export interface UpdateRunArgs {
     ...
     * State of the update run.
     */
    state?: pulumi.Input<string | enums.azurestackhci.v20241201preview.UpdateRunPropertiesState>;
    /**
     * Status of the step, bubbled up from the ECE action plan for installation attempts. Values are: 'Success', 'Error', 'InProgress', and 'Unknown status'.
     */
     ...
     * Recursive model for child steps of this step.
     */
    steps?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20241201preview.StepArgs>[]>;
    /**
     * Timestamp of the update run was started.
     */
