...
export class ArcSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ArcSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azurestackhci/v20210101preview:ArcSetting" }, { type: "azure-native:azurestackhci:ArcSetting" }, { type: "azure-nextgen:azurestackhci:ArcSetting" }] };
