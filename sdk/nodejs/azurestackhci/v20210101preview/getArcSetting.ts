...
export function getArcSetting(args: GetArcSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetArcSettingResult> {
    pulumi.log.warn("getArcSetting is deprecated: azure-native:azurestackhci/v20210101preview:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20210901preview:ArcSetting to guarantee forwards compatibility.")
