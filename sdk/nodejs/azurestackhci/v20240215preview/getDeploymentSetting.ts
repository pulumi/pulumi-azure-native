...
export interface GetDeploymentSettingResult {
     ...
     */
    readonly deploymentConfiguration: outputs.azurestackhci.v20240215preview.DeploymentConfigurationResponse;
    /**
     ...
     */
    readonly reportedProperties: outputs.azurestackhci.v20240215preview.EceReportedPropertiesResponse;
    /**
...
export function getDeploymentSettingOutput(args: GetDeploymentSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20240215preview:getDeploymentSetting", {
        "clusterName": args.clusterName,
        "deploymentSettingsName": args.deploymentSettingsName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
