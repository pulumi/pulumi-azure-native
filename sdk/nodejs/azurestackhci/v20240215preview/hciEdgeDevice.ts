...
export class HciEdgeDevice extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurestackhci.v20240215preview.HciEdgeDevicePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: HciEdgeDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20230801preview:HciEdgeDevice" }, { type: "azure-native:azurestackhci/v20231101preview:HciEdgeDevice" }, { type: "azure-native:azurestackhci/v20240101:HciEdgeDevice" }, { type: "azure-native:azurestackhci/v20240401:HciEdgeDevice" }, { type: "azure-native:azurestackhci/v20240901preview:HciEdgeDevice" }, { type: "azure-native:azurestackhci/v20241201preview:HciEdgeDevice" }, { type: "azure-native:azurestackhci/v20250201preview:HciEdgeDevice" }, { type: "azure-native:azurestackhci:HciEdgeDevice" }] };
