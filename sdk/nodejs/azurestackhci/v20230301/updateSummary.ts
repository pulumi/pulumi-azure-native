...
export class UpdateSummary extends pulumi.CustomResource {
    ...
    constructor(name: string, args: UpdateSummaryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:UpdateSummary" }, { type: "azure-native:azurestackhci/v20221215preview:UpdateSummary" }, { type: "azure-native:azurestackhci/v20230201:UpdateSummary" }] };
