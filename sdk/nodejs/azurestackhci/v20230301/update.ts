 ...
 *
 * const update = new azure_native.azurestackhci.v20230301.Update("update", {
...
export class Update extends pulumi.CustomResource {
    ...
    constructor(name: string, args: UpdateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:Update" }, { type: "azure-native:azurestackhci/v20221201:Update" }, { type: "azure-native:azurestackhci/v20230201:Update" }] };
