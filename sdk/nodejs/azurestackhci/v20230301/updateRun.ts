 ...
 *
 * const updateRun = new azure_native.azurestackhci.v20230301.UpdateRun("updateRun", {
...
export class UpdateRun extends pulumi.CustomResource {
     ...
     */
    public readonly steps!: pulumi.Output<outputs.azurestackhci.v20230301.StepResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: UpdateRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:UpdateRun" }, { type: "azure-native:azurestackhci/v20221201:UpdateRun" }, { type: "azure-native:azurestackhci/v20230201:UpdateRun" }] };
