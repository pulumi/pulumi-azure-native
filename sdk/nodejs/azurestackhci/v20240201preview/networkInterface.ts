...
export class NetworkInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240201preview:NetworkInterface';
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.azurestackhci.v20240201preview.InterfaceDNSSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.azurestackhci.v20240201preview.IPConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public readonly networkSecurityGroup!: pulumi.Output<outputs.azurestackhci.v20240201preview.NetworkSecurityGroupArmReferenceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20240201preview.NetworkInterfaceStatusResponse>;
    /**
    ...
    constructor(name: string, args: NetworkInterfaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210701preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20210901preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20221215preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20230701preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20230901preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20240101:NetworkInterface" }, { type: "azure-native:azurestackhci/v20240501preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20240715preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20240801preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20241001preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20250201preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20250401preview:NetworkInterface" }, { type: "azure-native:azurestackhci:NetworkInterface" }] };
...
export interface NetworkInterfaceArgs {
     ...
     * DNS Settings for the interface
     */
    dnsSettings?: pulumi.Input<inputs.azurestackhci.v20240201preview.InterfaceDNSSettingsArgs>;
    /**
     * The extendedLocation of the resource.
     */
     ...
     * IPConfigurations - A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20240201preview.IPConfigurationArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * NetworkSecurityGroup - Network Security Group attached to the network interface.
     */
    networkSecurityGroup?: pulumi.Input<inputs.azurestackhci.v20240201preview.NetworkSecurityGroupArmReferenceArgs>;
    /**
