...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20240201preview:getNetworkSecurityGroup", {
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly networkInterfaces: outputs.azurestackhci.v20240201preview.NetworkInterfaceArmReferenceResponse[];
    /**
     ...
     */
    readonly subnets: outputs.azurestackhci.v20240201preview.LogicalNetworkArmReferenceResponse[];
    /**
...
export function getNetworkSecurityGroupOutput(args: GetNetworkSecurityGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNetworkSecurityGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurestackhci/v20240201preview:getNetworkSecurityGroup", {
        "networkSecurityGroupName": args.networkSecurityGroupName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
