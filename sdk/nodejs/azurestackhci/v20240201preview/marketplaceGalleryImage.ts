...
export class MarketplaceGalleryImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240201preview:MarketplaceGalleryImage';
     ...
     */
    public readonly identifier!: pulumi.Output<outputs.azurestackhci.v20240201preview.GalleryImageIdentifierResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.azurestackhci.v20240201preview.MarketplaceGalleryImageStatusResponse>;
    /**
     ...
     */
    public readonly version!: pulumi.Output<outputs.azurestackhci.v20240201preview.GalleryImageVersionResponse | undefined>;
    ...
    constructor(name: string, args: MarketplaceGalleryImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210901preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20221215preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20230701preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20230901preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20240101:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20240501preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20240715preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20240801preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20241001preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20250201preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20250401preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci:MarketplaceGalleryImage" }] };
...
export interface MarketplaceGalleryImageArgs {
     ...
     * Datasource for the gallery image when provisioning with cloud-init [NoCloud, Azure]
     */
    cloudInitDataSource?: pulumi.Input<string | enums.azurestackhci.v20240201preview.CloudInitDataSource>;
    /**
     * Storage ContainerID of the storage container to be used for marketplace gallery image
     */
     ...
     * The hypervisor generation of the Virtual Machine [V1, V2]
     */
    hyperVGeneration?: pulumi.Input<string | enums.azurestackhci.v20240201preview.HyperVGeneration>;
    /**
     * This is the gallery image definition identifier.
     */
    identifier?: pulumi.Input<inputs.azurestackhci.v20240201preview.GalleryImageIdentifierArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Operating system type that the gallery image uses [Windows, Linux]
     */
    osType: pulumi.Input<string | enums.azurestackhci.v20240201preview.OperatingSystemTypes>;
    /**
     ...
     * Specifies information about the gallery image version that you want to create or update.
     */
    version?: pulumi.Input<inputs.azurestackhci.v20240201preview.GalleryImageVersionArgs>;
}
