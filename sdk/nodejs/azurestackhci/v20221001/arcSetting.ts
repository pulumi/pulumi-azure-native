 ...
 * ArcSetting details.
 *
 * @deprecated azure-native:azurestackhci/v20221001:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:ArcSetting to guarantee forwards compatibility.
 */
export class ArcSetting extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ArcSetting {
        pulumi.log.warn("ArcSetting is deprecated: azure-native:azurestackhci/v20221001:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:ArcSetting to guarantee forwards compatibility.")
        return new ArcSetting(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20221001:ArcSetting';
     ...
     */
    public readonly connectivityProperties!: pulumi.Output<outputs.azurestackhci.v20221001.ArcConnectivityPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly perNodeDetails!: pulumi.Output<outputs.azurestackhci.v20221001.PerNodeStateResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.azurestackhci.v20221001.SystemDataResponse>;
    /**
...
export interface ArcSettingArgs {
     ...
     * contains connectivity related configuration for ARC resources
     */
    connectivityProperties?: pulumi.Input<pulumi.Input<inputs.azurestackhci.v20221001.ArcConnectivityPropertiesArgs>[]>;
    /**
     * The timestamp of resource creation (UTC).
     */
     ...
     * The type of identity that created the resource.
     */
    createdByType?: pulumi.Input<string | enums.azurestackhci.v20221001.CreatedByType>;
    /**
     * The timestamp of resource last modification (UTC)
     */
     ...
     * The type of identity that last modified the resource.
     */
    lastModifiedByType?: pulumi.Input<string | enums.azurestackhci.v20221001.CreatedByType>;
    /**
