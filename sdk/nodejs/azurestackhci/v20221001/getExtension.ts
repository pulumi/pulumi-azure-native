...
export function getExtension(args: GetExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetExtensionResult> {
    pulumi.log.warn("getExtension is deprecated: azure-native:azurestackhci/v20221001:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20221001:getExtension", {
...
export interface GetExtensionResult {
     ...
     */
    readonly perNodeExtensionDetails: outputs.azurestackhci.v20221001.PerNodeExtensionStateResponse[];
    /**
