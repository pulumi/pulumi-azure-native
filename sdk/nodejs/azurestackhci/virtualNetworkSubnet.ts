...
export class VirtualNetworkSubnet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkSubnet {
        return new VirtualNetworkSubnet(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci:VirtualNetworkSubnet';

    /**
     * Returns true if the given object is an instance of VirtualNetworkSubnet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualNetworkSubnet {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.azurestackhci.VirtualNetworkSubnetPropertiesResponse>;
    /**
