...
export function getUpdate(args: GetUpdateArgs, opts?: pulumi.InvokeOptions): Promise<GetUpdateResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20240901preview:getUpdate", {
...
export interface GetUpdateResult {
     ...
     */
    readonly prerequisites?: outputs.azurestackhci.v20240901preview.UpdatePrerequisiteResponse[];
    /**
