...
export class UpdateSummary extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240901preview:UpdateSummary';
