...
export class SecuritySetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240901preview:SecuritySetting';
     ...
     */
    public /*out*/ readonly securityComplianceStatus!: pulumi.Output<outputs.azurestackhci.v20240901preview.SecurityComplianceStatusResponse>;
    /**
    ...
    constructor(name: string, args: SecuritySettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20231101preview:SecuritySetting" }, { type: "azure-native:azurestackhci/v20240101:SecuritySetting" }, { type: "azure-native:azurestackhci/v20240215preview:SecuritySetting" }, { type: "azure-native:azurestackhci/v20240401:SecuritySetting" }, { type: "azure-native:azurestackhci/v20241201preview:SecuritySetting" }, { type: "azure-native:azurestackhci/v20250201preview:SecuritySetting" }, { type: "azure-native:azurestackhci:SecuritySetting" }] };
...
export interface SecuritySettingArgs {
     ...
     * Secured Core Compliance Assignment
     */
    securedCoreComplianceAssignment?: pulumi.Input<string | enums.azurestackhci.v20240901preview.ComplianceAssignmentType>;
    /**
     ...
     * SMB encryption for intra-cluster traffic Compliance Assignment
     */
    smbEncryptionForIntraClusterTrafficComplianceAssignment?: pulumi.Input<string | enums.azurestackhci.v20240901preview.ComplianceAssignmentType>;
    /**
     * WDAC Compliance Assignment
     */
    wdacComplianceAssignment?: pulumi.Input<string | enums.azurestackhci.v20240901preview.ComplianceAssignmentType>;
}
