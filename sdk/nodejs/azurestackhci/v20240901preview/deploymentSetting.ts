...
export class DeploymentSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240901preview:DeploymentSetting';
     ...
     */
    public readonly deploymentConfiguration!: pulumi.Output<outputs.azurestackhci.v20240901preview.DeploymentConfigurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly reportedProperties!: pulumi.Output<outputs.azurestackhci.v20240901preview.EceReportedPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DeploymentSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20230801preview:DeploymentSetting" }, { type: "azure-native:azurestackhci/v20231101preview:DeploymentSetting" }, { type: "azure-native:azurestackhci/v20240101:DeploymentSetting" }, { type: "azure-native:azurestackhci/v20240215preview:DeploymentSetting" }, { type: "azure-native:azurestackhci/v20240401:DeploymentSetting" }, { type: "azure-native:azurestackhci/v20241201preview:DeploymentSetting" }, { type: "azure-native:azurestackhci/v20250201preview:DeploymentSetting" }, { type: "azure-native:azurestackhci:DeploymentSetting" }] };
...
export interface DeploymentSettingArgs {
     ...
     * Scale units will contains list of deployment data
     */
    deploymentConfiguration: pulumi.Input<inputs.azurestackhci.v20240901preview.DeploymentConfigurationArgs>;
    /**
     * The deployment mode for cluster deployment.
     */
    deploymentMode: pulumi.Input<string | enums.azurestackhci.v20240901preview.DeploymentMode>;
    /**
     ...
     * The intended operation for a cluster.
     */
    operationType?: pulumi.Input<string | enums.azurestackhci.v20240901preview.OperationType>;
    /**
