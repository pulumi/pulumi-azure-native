...
export class HciEdgeDeviceJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240901preview:HciEdgeDeviceJob';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurestackhci.v20240901preview.HciCollectLogJobPropertiesResponse | outputs.azurestackhci.v20240901preview.HciRemoteSupportJobPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: HciEdgeDeviceJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20241201preview:HciEdgeDeviceJob" }, { type: "azure-native:azurestackhci/v20250201preview:HciEdgeDeviceJob" }, { type: "azure-native:azurestackhci:HciEdgeDeviceJob" }] };
...
export interface HciEdgeDeviceJobArgs {
     ...
     * HCI Edge device job properties
     */
    properties: pulumi.Input<inputs.azurestackhci.v20240901preview.HciCollectLogJobPropertiesArgs | inputs.azurestackhci.v20240901preview.HciRemoteSupportJobPropertiesArgs>;
    /**
