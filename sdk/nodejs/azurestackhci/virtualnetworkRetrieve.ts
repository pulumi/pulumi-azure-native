...
export class VirtualnetworkRetrieve extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci:VirtualnetworkRetrieve';
     ...
     */
    public readonly subnets!: pulumi.Output<outputs.azurestackhci.VirtualnetworksPropertiesResponseSubnets[] | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualnetworkRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20210701preview:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20210701preview:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20210901preview:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20210901preview:virtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:VirtualnetworkRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:virtualnetworkRetrieve" }] };
...
export interface VirtualnetworkRetrieveArgs {
     ...
     * Subnet - list of subnets under the virtual network
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.azurestackhci.VirtualnetworksPropertiesSubnetsArgs>[]>;
    /**
     * Resource tags.
     */
