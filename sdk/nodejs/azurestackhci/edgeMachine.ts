...
export class EdgeMachine extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EdgeMachine {
        return new EdgeMachine(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci:EdgeMachine';

    /**
     * Returns true if the given object is an instance of EdgeMachine.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EdgeMachine {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EdgeMachine.__pulumiType;
    }
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.azurestackhci.EdgeMachinePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EdgeMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20251201preview:EdgeMachine" }, { type: "azure-native:azurestackhci/v20260215preview:EdgeMachine" }, { type: "azure-native:azurestackhci/v20260301preview:EdgeMachine" }, { type: "azure-native:azurestackhci/v20260401preview:EdgeMachine" }, { type: "azure-native:azurestackhci/v20260501preview:EdgeMachine" }] };
