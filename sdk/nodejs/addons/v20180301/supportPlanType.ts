...
export class SupportPlanType extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SupportPlanTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:addons:SupportPlanType" }, { type: "azure-nextgen:addons:SupportPlanType" }, { type: "azure-native:addons/latest:SupportPlanType" }, { type: "azure-nextgen:addons/latest:SupportPlanType" }, { type: "azure-native:addons/v20170515:SupportPlanType" }, { type: "azure-nextgen:addons/v20170515:SupportPlanType" }] };
