...
export class SupportPlanType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:addons/latest:SupportPlanType';
    ...
    constructor(name: string, args: SupportPlanTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:addons/latest:SupportPlanType" }, { type: "azure-native:addons:SupportPlanType" }, { type: "azure-nextgen:addons:SupportPlanType" }, { type: "azure-native:addons/v20170515:SupportPlanType" }, { type: "azure-nextgen:addons/v20170515:SupportPlanType" }, { type: "azure-native:addons/v20180301:SupportPlanType" }, { type: "azure-nextgen:addons/v20180301:SupportPlanType" }] };
