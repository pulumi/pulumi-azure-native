...
export class SupportPlanType extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SupportPlanTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:addons/v20180301:SupportPlanType" }, { type: "azure-native_addons_v20170515:addons:SupportPlanType" }, { type: "azure-native_addons_v20180301:addons:SupportPlanType" }] };
