...
export class SupportPlanType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:addons:SupportPlanType';
    ...
    constructor(name: string, args: SupportPlanTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:addons/latest:SupportPlanType" }, { type: "azure-nextgen:addons/v20170515:SupportPlanType" }, { type: "azure-nextgen:addons/v20180301:SupportPlanType" }] };
