 ...
 *
 * const supportPlanType = new azurerm.addons.v20170515.SupportPlanType("supportPlanType", {
...
export class SupportPlanType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:addons/v20170515:SupportPlanType';
    ...
    constructor(name: string, args: SupportPlanTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:addons/latest:SupportPlanType" }, { type: "azurerm:addons/v20180301:SupportPlanType" }] };
