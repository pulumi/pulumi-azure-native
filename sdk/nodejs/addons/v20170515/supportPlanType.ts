...
export class SupportPlanType extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.addons.v20170515.CanonicalSupportPlanPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SupportPlanTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:addons:SupportPlanType" }, { type: "azure-native:addons/v20180301:SupportPlanType" }] };
