...
export class SupportPlanType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:addons/preview:SupportPlanType';
    ...
    constructor(name: string, argsOrState?: SupportPlanTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:addons/latest:SupportPlanType" }, { type: "azurerm:addons/v20170515:SupportPlanType" }, { type: "azurerm:addons/v20180301:SupportPlanType" }] };
