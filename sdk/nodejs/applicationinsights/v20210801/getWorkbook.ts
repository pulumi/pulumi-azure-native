...
export function getWorkbook(args: GetWorkbookArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkbookResult> {
    ...
    return pulumi.runtime.invoke("azure-native:applicationinsights/v20210801:getWorkbook", {
...
export interface GetWorkbookResult {
     ...
     */
    readonly identity?: outputs.applicationinsights.v20210801.WorkbookResourceResponseIdentity;
    /**
     ...
     */
    readonly systemData: outputs.applicationinsights.v20210801.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getWorkbookOutput(args: GetWorkbookOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkbookResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:applicationinsights/v20210801:getWorkbook", {
        "canFetchContent": args.canFetchContent,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
