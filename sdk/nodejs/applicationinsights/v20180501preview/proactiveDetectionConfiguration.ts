...
export class ProactiveDetectionConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights/v20180501preview:ProactiveDetectionConfiguration';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.applicationinsights.v20180501preview.ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesResponse>;
    /**
     * Azure resource type
     */
    ...
    constructor(name: string, args: ProactiveDetectionConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights/v20150501:ProactiveDetectionConfiguration" }, { type: "azure-native:applicationinsights:ProactiveDetectionConfiguration" }, { type: "azure-native:insights/v20150501:ProactiveDetectionConfiguration" }, { type: "azure-native:insights/v20180501preview:ProactiveDetectionConfiguration" }, { type: "azure-native:insights:ProactiveDetectionConfiguration" }] };
...
export interface ProactiveDetectionConfigurationArgs {
     ...
     */
    ruleDefinitions?: pulumi.Input<inputs.applicationinsights.v20180501preview.ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesRuleDefinitionsArgs>;
    /**
