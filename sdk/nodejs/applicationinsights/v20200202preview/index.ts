...
// Export enums:
export * from "../../types/enums/applicationinsights/v20200202preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:applicationinsights/v20200202preview:Component":
...
pulumi.runtime.registerResourceModule("azure-native", "applicationinsights/v20200202preview", _module)
