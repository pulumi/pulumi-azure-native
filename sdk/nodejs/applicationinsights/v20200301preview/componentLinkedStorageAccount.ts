...
export class ComponentLinkedStorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights/v20200301preview:ComponentLinkedStorageAccount';
    ...
    constructor(name: string, args: ComponentLinkedStorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights:ComponentLinkedStorageAccount" }, { type: "azure-native:insights/v20200301preview:ComponentLinkedStorageAccount" }, { type: "azure-native:insights:ComponentLinkedStorageAccount" }] };
