...
export function getComponent(args: GetComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:applicationinsights/v20200202:getComponent", {
...
export interface GetComponentResult {
     ...
     */
    readonly privateLinkScopedResources: outputs.applicationinsights.v20200202.PrivateLinkScopedResourceResponse[];
    /**
...
export function getComponentOutput(args: GetComponentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComponentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:applicationinsights/v20200202:getComponent", {
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
}
