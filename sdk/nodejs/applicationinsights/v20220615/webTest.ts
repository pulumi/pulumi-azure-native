...
export class WebTest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights/v20220615:WebTest';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.applicationinsights.v20220615.WebTestPropertiesResponseConfiguration | undefined>;
    /**
     ...
     */
    public readonly locations!: pulumi.Output<outputs.applicationinsights.v20220615.WebTestGeolocationResponse[]>;
    /**
     * Azure resource name
     */
     ...
     */
    public readonly request!: pulumi.Output<outputs.applicationinsights.v20220615.WebTestPropertiesResponseRequest | undefined>;
    /**
     ...
     */
    public readonly validationRules!: pulumi.Output<outputs.applicationinsights.v20220615.WebTestPropertiesResponseValidationRules | undefined>;
    /**
    ...
    constructor(name: string, args: WebTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights/v20150501:WebTest" }, { type: "azure-native:applicationinsights/v20180501preview:WebTest" }, { type: "azure-native:applicationinsights/v20201005preview:WebTest" }, { type: "azure-native:applicationinsights:WebTest" }, { type: "azure-native:insights/v20201005preview:WebTest" }, { type: "azure-native:insights/v20220615:WebTest" }, { type: "azure-native:insights:WebTest" }] };
...
export interface WebTestArgs {
     ...
     * An XML configuration specification for a WebTest.
     */
    configuration?: pulumi.Input<inputs.applicationinsights.v20220615.WebTestPropertiesConfigurationArgs>;
    /**
     * User defined description for this WebTest.
     */
     ...
     * The kind of WebTest that this web test watches. Choices are ping, multistep and standard.
     */
    kind?: pulumi.Input<enums.applicationinsights.v20220615.WebTestKind>;
    /**
     * Resource location
     */
     ...
     * A list of where to physically run the tests from to give global coverage for accessibility of your application.
     */
    locations: pulumi.Input<pulumi.Input<inputs.applicationinsights.v20220615.WebTestGeolocationArgs>[]>;
    /**
     * The collection of request properties
     */
    request?: pulumi.Input<inputs.applicationinsights.v20220615.WebTestPropertiesRequestArgs>;
    /**
     ...
     * The collection of validation rule properties
     */
    validationRules?: pulumi.Input<inputs.applicationinsights.v20220615.WebTestPropertiesValidationRulesArgs>;
    /**
     * The kind of web test this is, valid choices are ping, multistep and standard.
     */
    webTestKind: pulumi.Input<enums.applicationinsights.v20220615.WebTestKind>;
    /**
     * User defined name if this WebTest.
     */
