...
// Export enums:
export * from "../../types/enums/applicationinsights/v20210308";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:applicationinsights/v20210308:MyWorkbook":
                return new MyWorkbook(name, <any>undefined, { urn })
            case "azure-native:applicationinsights/v20210308:Workbook":
...
pulumi.runtime.registerResourceModule("azure-native", "applicationinsights/v20210308", _module)
