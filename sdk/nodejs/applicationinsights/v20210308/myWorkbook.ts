...
export class MyWorkbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights/v20210308:MyWorkbook';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.applicationinsights.v20210308.MyWorkbookManagedIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: MyWorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights/v20150501:MyWorkbook" }, { type: "azure-native:applicationinsights/v20201020:MyWorkbook" }, { type: "azure-native:applicationinsights:MyWorkbook" }, { type: "azure-native:insights/v20210308:MyWorkbook" }, { type: "azure-native:insights:MyWorkbook" }] };
...
export interface MyWorkbookArgs {
     ...
     * Identity used for BYOS
     */
    identity?: pulumi.Input<inputs.applicationinsights.v20210308.MyWorkbookManagedIdentityArgs>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
