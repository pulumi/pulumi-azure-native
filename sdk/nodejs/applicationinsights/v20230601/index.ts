...
// Export enums:
export * from "../../types/enums/applicationinsights/v20230601";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:applicationinsights/v20230601:Workbook":
...
pulumi.runtime.registerResourceModule("azure-native", "applicationinsights/v20230601", _module)
