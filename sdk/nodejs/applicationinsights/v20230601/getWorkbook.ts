...
export function getWorkbook(args: GetWorkbookArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkbookResult> {
    ...
    return pulumi.runtime.invoke("azure-native:applicationinsights/v20230601:getWorkbook", {
...
export interface GetWorkbookResult {
     ...
     */
    readonly identity?: outputs.applicationinsights.v20230601.WorkbookResourceResponseIdentity;
    /**
     ...
     */
    readonly systemData: outputs.applicationinsights.v20230601.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getWorkbookOutput(args: GetWorkbookOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkbookResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:applicationinsights/v20230601:getWorkbook", {
        "canFetchContent": args.canFetchContent,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
