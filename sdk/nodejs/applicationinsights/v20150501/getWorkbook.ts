...
export function getWorkbook(args: GetWorkbookArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkbookResult> {
    ...
    return pulumi.runtime.invoke("azure-native:applicationinsights/v20150501:getWorkbook", {
...
export interface GetWorkbookResult {
     ...
     */
    readonly properties: outputs.applicationinsights.v20150501.WorkbookPropertiesResponse;
    /**
     * Resource tags
     */
...
export function getWorkbookOutput(args: GetWorkbookOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkbookResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:applicationinsights/v20150501:getWorkbook", {
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
}
