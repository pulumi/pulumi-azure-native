...
export class ProactiveDetectionConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights/v20150501:ProactiveDetectionConfiguration';
     ...
     */
    public readonly ruleDefinitions!: pulumi.Output<outputs.applicationinsights.v20150501.ApplicationInsightsComponentProactiveDetectionConfigurationResponseRuleDefinitions | undefined>;
    /**
    ...
    constructor(name: string, args: ProactiveDetectionConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights/v20180501preview:ProactiveDetectionConfiguration" }, { type: "azure-native:applicationinsights:ProactiveDetectionConfiguration" }, { type: "azure-native:insights/v20150501:ProactiveDetectionConfiguration" }, { type: "azure-native:insights/v20180501preview:ProactiveDetectionConfiguration" }, { type: "azure-native:insights:ProactiveDetectionConfiguration" }] };
...
export interface ProactiveDetectionConfigurationArgs {
     ...
     * Static definitions of the ProactiveDetection configuration rule (same values for all components).
     */
    ruleDefinitions?: pulumi.Input<inputs.applicationinsights.v20150501.ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitionsArgs>;
    /**
     * A flag that indicated whether notifications on this rule should be sent to subscription owners
     */
