...
export class ComponentCurrentBillingFeature extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights/v20150501:ComponentCurrentBillingFeature';
     ...
     */
    public readonly dataVolumeCap!: pulumi.Output<outputs.applicationinsights.v20150501.ApplicationInsightsComponentDataVolumeCapResponse | undefined>;
    ...
    constructor(name: string, args: ComponentCurrentBillingFeatureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights:ComponentCurrentBillingFeature" }, { type: "azure-native:insights/v20150501:ComponentCurrentBillingFeature" }, { type: "azure-native:insights:ComponentCurrentBillingFeature" }] };
...
export interface ComponentCurrentBillingFeatureArgs {
     ...
     * An Application Insights component daily data volume cap
     */
    dataVolumeCap?: pulumi.Input<inputs.applicationinsights.v20150501.ApplicationInsightsComponentDataVolumeCapArgs>;
    /**
