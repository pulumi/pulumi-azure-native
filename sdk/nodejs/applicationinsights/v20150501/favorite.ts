...
export class Favorite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights/v20150501:Favorite';
    ...
    constructor(name: string, args: FavoriteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights:Favorite" }, { type: "azure-native:insights/v20150501:Favorite" }, { type: "azure-native:insights:Favorite" }] };
...
export interface FavoriteArgs {
     ...
     * Enum indicating if this favorite definition is owned by a specific user or is shared between all users with access to the Application Insights component.
     */
    favoriteType?: pulumi.Input<enums.applicationinsights.v20150501.FavoriteType>;
    /**
     * Flag denoting wether or not this favorite was generated from a template.
     */
