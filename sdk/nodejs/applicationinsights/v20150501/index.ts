...
// Export enums:
export * from "../../types/enums/applicationinsights/v20150501";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:applicationinsights/v20150501:AnalyticsItem":
                return new AnalyticsItem(name, <any>undefined, { urn })
            case "azure-native:applicationinsights/v20150501:ComponentCurrentBillingFeature":
                return new ComponentCurrentBillingFeature(name, <any>undefined, { urn })
            case "azure-native:applicationinsights/v20150501:ExportConfiguration":
                return new ExportConfiguration(name, <any>undefined, { urn })
            case "azure-native:applicationinsights/v20150501:Favorite":
                return new Favorite(name, <any>undefined, { urn })
            case "azure-native:applicationinsights/v20150501:ProactiveDetectionConfiguration":
                return new ProactiveDetectionConfiguration(name, <any>undefined, { urn })
            case "azure-native:applicationinsights/v20150501:Workbook":
...
pulumi.runtime.registerResourceModule("azure-native", "applicationinsights/v20150501", _module)
