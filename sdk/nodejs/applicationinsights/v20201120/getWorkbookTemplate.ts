...
export function getWorkbookTemplate(args: GetWorkbookTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkbookTemplateResult> {
    ...
    return pulumi.runtime.invoke("azure-native:applicationinsights/v20201120:getWorkbookTemplate", {
...
export interface GetWorkbookTemplateResult {
     ...
     */
    readonly galleries: outputs.applicationinsights.v20201120.WorkbookTemplateGalleryResponse[];
    /**
     * Azure resource Id
     */
    readonly id: string;
     ...
     */
    readonly localized?: {[key: string]: outputs.applicationinsights.v20201120.WorkbookTemplateLocalizedGalleryResponse[]};
    /**
     * Resource location
     */
...
export function getWorkbookTemplateOutput(args: GetWorkbookTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkbookTemplateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:applicationinsights/v20201120:getWorkbookTemplate", {
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
}
