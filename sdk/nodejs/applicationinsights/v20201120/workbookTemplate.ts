...
export class WorkbookTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights/v20201120:WorkbookTemplate';
     ...
     */
    public readonly galleries!: pulumi.Output<outputs.applicationinsights.v20201120.WorkbookTemplateGalleryResponse[]>;
    /**
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    public readonly localized!: pulumi.Output<{[key: string]: outputs.applicationinsights.v20201120.WorkbookTemplateLocalizedGalleryResponse[]} | undefined>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, args: WorkbookTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights/v20191017preview:WorkbookTemplate" }, { type: "azure-native:applicationinsights:WorkbookTemplate" }, { type: "azure-native:insights/v20201120:WorkbookTemplate" }, { type: "azure-native:insights:WorkbookTemplate" }] };
...
export interface WorkbookTemplateArgs {
     ...
     * Workbook galleries supported by the template.
     */
    galleries: pulumi.Input<pulumi.Input<inputs.applicationinsights.v20201120.WorkbookTemplateGalleryArgs>[]>;
    /**
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    localized?: pulumi.Input<{[key: string]: pulumi.Input<pulumi.Input<inputs.applicationinsights.v20201120.WorkbookTemplateLocalizedGalleryArgs>[]>}>;
    /**
     * Resource location
     */
