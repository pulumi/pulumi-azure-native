...
export function getWebTest(args: GetWebTestArgs, opts?: pulumi.InvokeOptions): Promise<GetWebTestResult> {
    ...
    return pulumi.runtime.invoke("azure-native:applicationinsights/v20201005preview:getWebTest", {
...
export interface GetWebTestResult {
     ...
     */
    readonly configuration?: outputs.applicationinsights.v20201005preview.WebTestPropertiesResponseConfiguration;
    /**
     ...
     */
    readonly locations: outputs.applicationinsights.v20201005preview.WebTestGeolocationResponse[];
    /**
     * Azure resource name
     */
     ...
     */
    readonly request?: outputs.applicationinsights.v20201005preview.WebTestPropertiesResponseRequest;
    /**
     ...
     */
    readonly validationRules?: outputs.applicationinsights.v20201005preview.WebTestPropertiesResponseValidationRules;
    /**
...
export function getWebTestOutput(args: GetWebTestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebTestResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:applicationinsights/v20201005preview:getWebTest", {
        "resourceGroupName": args.resourceGroupName,
        "webTestName": args.webTestName,
    }, opts);
}
