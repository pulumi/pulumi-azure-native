...
// Export enums:
export * from "../../types/enums/applicationinsights/v20201005preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:applicationinsights/v20201005preview:WebTest":
...
pulumi.runtime.registerResourceModule("azure-native", "applicationinsights/v20201005preview", _module)
