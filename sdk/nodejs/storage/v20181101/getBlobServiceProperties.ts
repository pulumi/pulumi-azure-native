...
export function getBlobServiceProperties(args: GetBlobServicePropertiesArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobServicePropertiesResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storage/v20181101:getBlobServiceProperties", {
...
export interface GetBlobServicePropertiesResult {
     ...
     */
    readonly cors?: outputs.storage.v20181101.CorsRulesInvokeResponse;
    /**
     ...
     */
    readonly deleteRetentionPolicy?: outputs.storage.v20181101.DeleteRetentionPolicyInvokeResponse;
    /**
