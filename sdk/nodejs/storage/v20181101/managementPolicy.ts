...
export class ManagementPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/v20181101:ManagementPolicy';
    ...
    constructor(name: string, args: ManagementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/latest:ManagementPolicy" }, { type: "azurerm:storage/v20180301preview:ManagementPolicy" }, { type: "azurerm:storage/v20190401:ManagementPolicy" }, { type: "azurerm:storage/v20190601:ManagementPolicy" }, { type: "azurerm:storage/v20200801preview:ManagementPolicy" }] };
