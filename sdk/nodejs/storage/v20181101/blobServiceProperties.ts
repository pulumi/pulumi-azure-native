...
export class BlobServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20181101:BlobServiceProperties';
     ...
     */
    public readonly cors!: pulumi.Output<outputs.storage.v20181101.CorsRulesResponse | undefined>;
    /**
     ...
     */
    public readonly deleteRetentionPolicy!: pulumi.Output<outputs.storage.v20181101.DeleteRetentionPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: BlobServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20181101:BlobServiceProperties" }, { type: "azure-native:storage:BlobServiceProperties" }, { type: "azure-nextgen:storage:BlobServiceProperties" }, { type: "azure-native:storage/latest:BlobServiceProperties" }, { type: "azure-nextgen:storage/latest:BlobServiceProperties" }, { type: "azure-native:storage/v20180701:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20180701:BlobServiceProperties" }, { type: "azure-native:storage/v20190401:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20190401:BlobServiceProperties" }, { type: "azure-native:storage/v20190601:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20190601:BlobServiceProperties" }, { type: "azure-native:storage/v20200801preview:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20200801preview:BlobServiceProperties" }, { type: "azure-native:storage/v20210101:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20210101:BlobServiceProperties" }] };
...
export interface BlobServicePropertiesArgs {
     ...
     * Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service.
     */
    readonly cors?: pulumi.Input<inputs.storage.v20181101.CorsRules>;
    /**
     * DefaultServiceVersion indicates the default version to use for requests to the Blob service if an incoming request’s version is not specified. Possible values include version 2008-10-27 and all more recent versions.
     */
     ...
     * The blob service properties for soft delete.
     */
    readonly deleteRetentionPolicy?: pulumi.Input<inputs.storage.v20181101.DeleteRetentionPolicy>;
    /**
