...
export class BlobInventoryPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobInventoryPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage/v20210201:BlobInventoryPolicy" }, { type: "azure-native:storage/v20210801:BlobInventoryPolicy" }, { type: "azure-native:storage/v20220901:BlobInventoryPolicy" }] };
