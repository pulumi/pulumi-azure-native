...
export class Table extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/v20200801preview:Table';
    ...
    constructor(name: string, args: TableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/latest:Table" }, { type: "azurerm:storage/v20190601:Table" }] };
