...
export class Table extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:storage/v20200801preview:Table';
    ...
    constructor(name: string, args: TableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/latest:Table" }, { type: "azure-nextgen:storage/v20190601:Table" }] };
