...
export class EncryptionScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EncryptionScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20200801preview:EncryptionScope" }, { type: "azure-native:storage:EncryptionScope" }, { type: "azure-nextgen:storage:EncryptionScope" }, { type: "azure-native:storage/latest:EncryptionScope" }, { type: "azure-nextgen:storage/latest:EncryptionScope" }, { type: "azure-native:storage/v20190601:EncryptionScope" }, { type: "azure-nextgen:storage/v20190601:EncryptionScope" }, { type: "azure-native:storage/v20210101:EncryptionScope" }, { type: "azure-nextgen:storage/v20210101:EncryptionScope" }] };
