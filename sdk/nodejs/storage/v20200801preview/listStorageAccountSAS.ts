...
export function listStorageAccountSAS(args: ListStorageAccountSASArgs, opts?: pulumi.InvokeOptions): Promise<ListStorageAccountSASResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storage/v20200801preview:listStorageAccountSAS", {
...
export interface ListStorageAccountSASArgs {
     ...
     */
    readonly permissions: string | enums.storage.v20200801preview.Permissions;
    /**
     * The protocol permitted for a request made with the account SAS.
     */
    readonly protocols?: enums.storage.v20200801preview.HttpProtocol;
    /**
     ...
     */
    readonly resourceTypes: string | enums.storage.v20200801preview.SignedResourceTypes;
    /**
     * The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
     */
    readonly services: string | enums.storage.v20200801preview.Services;
    /**
