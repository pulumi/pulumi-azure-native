...
export class ManagementPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagementPolicy {
        pulumi.log.warn("ManagementPolicy is deprecated: azure-native:storage/v20210601:ManagementPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:ManagementPolicy to guarantee forwards compatibility.")
