...
export class StorageAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["defaultToOAuthAuthentication"] = args ? args.defaultToOAuthAuthentication : undefined;
            ...
            inputs["defaultToOAuthAuthentication"] = undefined /*out*/;
