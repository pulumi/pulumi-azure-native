...
export function getBlobContainer(args: GetBlobContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storage/latest:getBlobContainer", {
...
export interface GetBlobContainerResult {
     ...
     */
    readonly immutabilityPolicy: outputs.storage.latest.ImmutabilityPolicyPropertiesResponse;
    /**
     ...
     */
    readonly legalHold: outputs.storage.latest.LegalHoldPropertiesResponse;
    /**
