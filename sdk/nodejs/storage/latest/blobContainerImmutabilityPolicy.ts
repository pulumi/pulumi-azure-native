...
export class BlobContainerImmutabilityPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/latest:BlobContainerImmutabilityPolicy';
