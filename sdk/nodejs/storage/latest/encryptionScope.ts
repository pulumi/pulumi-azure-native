...
export class EncryptionScope extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EncryptionScope {
        pulumi.log.warn("EncryptionScope is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storage:EncryptionScope'.")
        return new EncryptionScope(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/latest:EncryptionScope';
     ...
     */
    public readonly keyVaultProperties!: pulumi.Output<outputs.storage.latest.EncryptionScopeKeyVaultPropertiesResponse | undefined>;
    /**
...
export interface EncryptionScopeArgs {
     ...
     * The key vault properties for the encryption scope. This is a required field if encryption scope 'source' attribute is set to 'Microsoft.KeyVault'.
     */
    readonly keyVaultProperties?: pulumi.Input<inputs.storage.latest.EncryptionScopeKeyVaultProperties>;
    /**
     * A boolean indicating whether or not the service applies a secondary layer of encryption with platform managed keys for data at rest.
     */
     ...
     * The provider for the encryption scope. Possible values (case-insensitive):  Microsoft.Storage, Microsoft.KeyVault.
     */
    readonly source?: pulumi.Input<string | enums.storage.latest.EncryptionScopeSource>;
    /**
     * The state of the encryption scope. Possible values (case-insensitive):  Enabled, Disabled.
     */
    readonly state?: pulumi.Input<string | enums.storage.latest.EncryptionScopeState>;
}
