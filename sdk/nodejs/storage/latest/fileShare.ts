...
export class FileShare extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/latest:FileShare';
    ...
    constructor(name: string, args: FileShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/v20190401:FileShare" }, { type: "azurerm:storage/v20190601:FileShare" }, { type: "azurerm:storage/v20200801preview:FileShare" }] };
