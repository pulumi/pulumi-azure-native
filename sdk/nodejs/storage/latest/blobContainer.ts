 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storage:BlobContainer'.
 */
export class BlobContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/latest:BlobContainer';
...
export interface BlobContainerArgs {
     ...
     * Specifies whether data in the container may be accessed publicly and the level of access.
     */
    readonly publicAccess?: pulumi.Input<enums.storage.latest.PublicAccess>;
    /**
