...
export class FileShare extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage:FileShare" }, { type: "azure-native:storage/v20210201:FileShare" }, { type: "azure-native:storage/v20210801:FileShare" }] };
