...
export interface GetLocalUserResult {
     ...
     */
    readonly permissionScopes?: outputs.storage.v20220901.PermissionScopeResponse[];
    /**
     ...
     */
    readonly systemData: outputs.storage.v20220901.SystemDataResponse;
    /**
...
export function getLocalUserOutput(args: GetLocalUserOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLocalUserResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:storage/v20220901:getLocalUser", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "username": args.username,
    }, opts);
