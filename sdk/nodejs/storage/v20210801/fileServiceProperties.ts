 ...
 *
 * @deprecated azure-native:storage/v20210801:FileServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileServiceProperties to guarantee forwards compatibility.
 */
export class FileServiceProperties extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FileServiceProperties {
        pulumi.log.warn("FileServiceProperties is deprecated: azure-native:storage/v20210801:FileServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileServiceProperties to guarantee forwards compatibility.")
        return new FileServiceProperties(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210801:FileServiceProperties';
     ...
     */
    public readonly cors!: pulumi.Output<outputs.storage.v20210801.CorsRulesResponse | undefined>;
    /**
     ...
     */
    public readonly protocolSettings!: pulumi.Output<outputs.storage.v20210801.ProtocolSettingsResponse | undefined>;
    /**
     * The file service properties for share soft delete.
     */
    public readonly shareDeleteRetentionPolicy!: pulumi.Output<outputs.storage.v20210801.DeleteRetentionPolicyResponse | undefined>;
    /**
     * Sku name and tier.
     */
    public /*out*/ readonly sku!: pulumi.Output<outputs.storage.v20210801.SkuResponse>;
    /**
    ...
    constructor(name: string, args: FileServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage:FileServiceProperties" }, { type: "azure-native:storage/v20190401:FileServiceProperties" }, { type: "azure-native:storage/v20190601:FileServiceProperties" }, { type: "azure-native:storage/v20200801preview:FileServiceProperties" }, { type: "azure-native:storage/v20210101:FileServiceProperties" }, { type: "azure-native:storage/v20210201:FileServiceProperties" }, { type: "azure-native:storage/v20210401:FileServiceProperties" }, { type: "azure-native:storage/v20210601:FileServiceProperties" }, { type: "azure-native:storage/v20210901:FileServiceProperties" }, { type: "azure-native:storage/v20220501:FileServiceProperties" }, { type: "azure-native:storage/v20220901:FileServiceProperties" }] };
