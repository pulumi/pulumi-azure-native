 ...
 */
/** @deprecated azure-native:storage/v20210801:BlobContainer is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobContainer to guarantee forwards compatibility. */
export function getBlobContainer(args: GetBlobContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerResult> {
    pulumi.log.warn("getBlobContainer is deprecated: azure-native:storage/v20210801:BlobContainer is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobContainer to guarantee forwards compatibility.")
