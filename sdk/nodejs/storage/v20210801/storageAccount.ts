 ...
 * The storage account.
 *
 * @deprecated azure-native:storage/v20210801:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:StorageAccount to guarantee forwards compatibility.
 */
export class StorageAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageAccount {
        pulumi.log.warn("StorageAccount is deprecated: azure-native:storage/v20210801:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:StorageAccount to guarantee forwards compatibility.")
        return new StorageAccount(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210801:StorageAccount';
     ...
     */
    public readonly azureFilesIdentityBasedAuthentication!: pulumi.Output<outputs.storage.v20210801.AzureFilesIdentityBasedAuthenticationResponse | undefined>;
    /**
     * Blob restore status
     */
    public /*out*/ readonly blobRestoreStatus!: pulumi.Output<outputs.storage.v20210801.BlobRestoreStatusResponse>;
    /**
     ...
     */
    public readonly customDomain!: pulumi.Output<outputs.storage.v20210801.CustomDomainResponse>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.storage.v20210801.EncryptionResponse>;
    /**
     * The extendedLocation of the resource.
     */
    public readonly extendedLocation!: pulumi.Output<outputs.storage.v20210801.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly geoReplicationStats!: pulumi.Output<outputs.storage.v20210801.GeoReplicationStatsResponse>;
    /**
     * The identity of the resource.
     */
    public readonly identity!: pulumi.Output<outputs.storage.v20210801.IdentityResponse | undefined>;
    /**
     * The property is immutable and can only be set to true at the account creation time. When set to true, it enables object level immutability for all the containers in the account by default.
     */
    public readonly immutableStorageWithVersioning!: pulumi.Output<outputs.storage.v20210801.ImmutableStorageAccountResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly keyCreationTime!: pulumi.Output<outputs.storage.v20210801.KeyCreationTimeResponse>;
    /**
     * KeyPolicy assigned to the storage account.
     */
    public readonly keyPolicy!: pulumi.Output<outputs.storage.v20210801.KeyPolicyResponse>;
    /**
     * Gets the Kind.
     */
     ...
     * Network rule set
     */
    public readonly networkRuleSet!: pulumi.Output<outputs.storage.v20210801.NetworkRuleSetResponse>;
    /**
     * Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object. Note that Standard_ZRS and Premium_LRS accounts only return the blob endpoint.
     */
    public /*out*/ readonly primaryEndpoints!: pulumi.Output<outputs.storage.v20210801.EndpointsResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.storage.v20210801.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly routingPreference!: pulumi.Output<outputs.storage.v20210801.RoutingPreferenceResponse | undefined>;
    /**
     * SasPolicy assigned to the storage account.
     */
    public readonly sasPolicy!: pulumi.Output<outputs.storage.v20210801.SasPolicyResponse>;
    /**
     * Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object from the secondary location of the storage account. Only available if the SKU name is Standard_RAGRS.
     */
    public /*out*/ readonly secondaryEndpoints!: pulumi.Output<outputs.storage.v20210801.EndpointsResponse>;
    /**
     ...
     * Gets the SKU.
     */
    public readonly sku!: pulumi.Output<outputs.storage.v20210801.SkuResponse>;
    /**
    ...
    constructor(name: string, args: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["encryption"] = args ? (args.encryption ? pulumi.output(args.encryption).apply(inputs.storage.v20210801.encryptionArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["networkRuleSet"] = args ? (args.networkRuleSet ? pulumi.output(args.networkRuleSet).apply(inputs.storage.v20210801.networkRuleSetArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["publicNetworkAccess"] = args ? args.publicNetworkAccess : undefined;
            resourceInputs["resourceGroupName"] = args ? args.resourceGroupName : undefined;
            resourceInputs["routingPreference"] = args ? args.routingPreference : undefined;
            resourceInputs["sasPolicy"] = args ? (args.sasPolicy ? pulumi.output(args.sasPolicy).apply(inputs.storage.v20210801.sasPolicyArgsProvideDefaults) : undefined) : undefined;
