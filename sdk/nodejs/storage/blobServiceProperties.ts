...
export class BlobServiceProperties extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage/v20210201:BlobServiceProperties" }, { type: "azure-native:storage/v20210801:BlobServiceProperties" }, { type: "azure-native:storage/v20220901:BlobServiceProperties" }] };
