...
azure-native:storage/v20160501:StorageAccount is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20181101:StorageAccount to guarantee forwards compatibility.
 */
export class StorageAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageAccount {
        pulumi.log.warn("StorageAccount is deprecated: Version 2016-05-01 will be removed in v2 of the provider.\nazure-native:storage/v20160501:StorageAccount is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20181101:StorageAccount to guarantee forwards compatibility.")
