...
export interface ListStorageAccountSASArgs {
     ...
     */
    readonly permissions: string | enums.storage.v20210401.Permissions;
    /**
     * The protocol permitted for a request made with the account SAS.
     */
    readonly protocols?: enums.storage.v20210401.HttpProtocol;
    /**
     ...
     */
    readonly resourceTypes: string | enums.storage.v20210401.SignedResourceTypes;
    /**
     * The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
     */
    readonly services: string | enums.storage.v20210401.Services;
    /**
