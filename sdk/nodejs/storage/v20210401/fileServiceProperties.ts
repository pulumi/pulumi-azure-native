...
export class FileServiceProperties extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FileServiceProperties {
        pulumi.log.warn("FileServiceProperties is deprecated: azure-native:storage/v20210401:FileServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileServiceProperties to guarantee forwards compatibility.")
