 ...
 * The storage account.
 *
 * @deprecated azure-native:storage/v20210401:StorageAccount is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:StorageAccount to guarantee forwards compatibility.
 */
export class StorageAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageAccount {
        pulumi.log.warn("StorageAccount is deprecated: azure-native:storage/v20210401:StorageAccount is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:StorageAccount to guarantee forwards compatibility.")
