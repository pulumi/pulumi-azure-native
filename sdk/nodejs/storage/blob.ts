...
export class Blob extends pulumi.CustomResource {
     ...
     */
    declare public readonly accessTier: pulumi.Output<enums.storage.BlobAccessTier | undefined>;
    /**
     ...
     */
    declare public readonly type: pulumi.Output<enums.storage.BlobType>;
    /**
     * The URL of the blob.
     */
