...
export function getBlobContainer(args: GetBlobContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storage/v20180301preview:getBlobContainer", {
...
export interface GetBlobContainerResult {
     ...
     */
    readonly immutabilityPolicy: outputs.storage.v20180301preview.ImmutabilityPolicyPropertiesInvokeResponse;
    /**
     ...
     */
    readonly legalHold: outputs.storage.v20180301preview.LegalHoldPropertiesInvokeResponse;
    /**
