...
export class StorageAccountManagementPolicies extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageAccountManagementPolicies {
        return new StorageAccountManagementPolicies(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: StorageAccountManagementPoliciesArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as StorageAccountManagementPoliciesArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/latest:StorageAccountManagementPolicies" }, { type: "azurerm:storage/preview:StorageAccountManagementPolicies" }, { type: "azurerm:storage/v20181101:StorageAccountManagementPolicies" }, { type: "azurerm:storage/v20190401:StorageAccountManagementPolicies" }, { type: "azurerm:storage/v20190601:StorageAccountManagementPolicies" }] };
