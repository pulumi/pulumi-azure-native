 ...
 *
 * const blobContainer = new azurerm.storage.v20180301preview.BlobContainer("blobContainer", {
 *     accountName: "sto328",
...
export class BlobContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/v20180301preview:BlobContainer';
    ...
    constructor(name: string, args: BlobContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/latest:BlobContainer" }, { type: "azurerm:storage/v20180201:BlobContainer" }, { type: "azurerm:storage/v20180701:BlobContainer" }, { type: "azurerm:storage/v20181101:BlobContainer" }, { type: "azurerm:storage/v20190401:BlobContainer" }, { type: "azurerm:storage/v20190601:BlobContainer" }] };
