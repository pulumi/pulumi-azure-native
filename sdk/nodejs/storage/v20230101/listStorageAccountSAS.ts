...
export interface ListStorageAccountSASArgs {
     ...
     */
    permissions: string | enums.storage.v20230101.Permissions;
    /**
     * The protocol permitted for a request made with the account SAS.
     */
    protocols?: enums.storage.v20230101.HttpProtocol;
    /**
     ...
     */
    resourceTypes: string | enums.storage.v20230101.SignedResourceTypes;
    /**
     * The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
     */
    services: string | enums.storage.v20230101.Services;
    /**
...
export function listStorageAccountSASOutput(args: ListStorageAccountSASOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListStorageAccountSASResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:storage/v20230101:listStorageAccountSAS", {
        "accountName": args.accountName,
        "iPAddressOrRange": args.iPAddressOrRange,
        "keyToSign": args.keyToSign,
        "permissions": args.permissions,
...
export interface ListStorageAccountSASOutputArgs {
     ...
     * The signed permissions for the account SAS. Possible values include: Read (r), Write (w), Delete (d), List (l), Add (a), Create (c), Update (u) and Process (p).
     */
    permissions: pulumi.Input<string | enums.storage.v20230101.Permissions>;
    /**
     * The protocol permitted for a request made with the account SAS.
     */
    protocols?: pulumi.Input<enums.storage.v20230101.HttpProtocol>;
    /**
     * The name of the resource group within the user's subscription. The name is case insensitive.
     */
     ...
     * The signed resource types that are accessible with the account SAS. Service (s): Access to service-level APIs; Container (c): Access to container-level APIs; Object (o): Access to object-level APIs for blobs, queue messages, table entities, and files.
     */
    resourceTypes: pulumi.Input<string | enums.storage.v20230101.SignedResourceTypes>;
    /**
     * The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
     */
    services: pulumi.Input<string | enums.storage.v20230101.Services>;
    /**
     * The time at which the shared access signature becomes invalid.
     */
