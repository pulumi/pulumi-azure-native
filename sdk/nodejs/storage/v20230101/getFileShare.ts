...
export interface GetFileShareResult {
     ...
     */
    readonly signedIdentifiers?: outputs.storage.v20230101.SignedIdentifierResponse[];
    /**
...
export function getFileShareOutput(args: GetFileShareOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFileShareResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:storage/v20230101:getFileShare", {
        "accountName": args.accountName,
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "shareName": args.shareName,
