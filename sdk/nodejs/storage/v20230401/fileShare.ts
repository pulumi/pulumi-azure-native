...
export class FileShare extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20230401:FileShare';
     ...
     */
    public readonly signedIdentifiers!: pulumi.Output<outputs.storage.v20230401.SignedIdentifierResponse[] | undefined>;
    /**
...
export interface FileShareArgs {
     ...
     * Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium.
     */
    accessTier?: pulumi.Input<string | enums.storage.v20230401.ShareAccessTier>;
    /**
     ...
     * The authentication protocol that is used for the file share. Can only be specified when creating a share.
     */
    enabledProtocols?: pulumi.Input<string | enums.storage.v20230401.EnabledProtocols>;
    /**
     ...
     * The property is for NFS share only. The default is NoRootSquash.
     */
    rootSquash?: pulumi.Input<string | enums.storage.v20230401.RootSquashType>;
    /**
     ...
     * List of stored access policies specified on the share.
     */
    signedIdentifiers?: pulumi.Input<pulumi.Input<inputs.storage.v20230401.SignedIdentifierArgs>[]>;
}
