...
export class LocalUser extends pulumi.CustomResource {
     ...
     */
    declare public readonly permissionScopes: pulumi.Output<outputs.storage.PermissionScopeResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly sshAuthorizedKeys: pulumi.Output<outputs.storage.SshPublicKeyResponse[] | undefined>;
    /**
