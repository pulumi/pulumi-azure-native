...
export class BlobContainerImmutabilityPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobContainerImmutabilityPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/latest:BlobContainerImmutabilityPolicy" }, { type: "azurerm:storage/v20180201:BlobContainerImmutabilityPolicy" }, { type: "azurerm:storage/v20180301preview:BlobContainerImmutabilityPolicy" }, { type: "azurerm:storage/v20181101:BlobContainerImmutabilityPolicy" }, { type: "azurerm:storage/v20190401:BlobContainerImmutabilityPolicy" }, { type: "azurerm:storage/v20190601:BlobContainerImmutabilityPolicy" }, { type: "azurerm:storage/v20200801preview:BlobContainerImmutabilityPolicy" }] };
