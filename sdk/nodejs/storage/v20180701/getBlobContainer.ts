...
export function getBlobContainer(args: GetBlobContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storage/v20180701:getBlobContainer", {
...
export interface GetBlobContainerResult {
     ...
     */
    readonly immutabilityPolicy: outputs.storage.v20180701.ImmutabilityPolicyPropertiesInvokeResponse;
    /**
     ...
     */
    readonly legalHold: outputs.storage.v20180701.LegalHoldPropertiesInvokeResponse;
    /**
