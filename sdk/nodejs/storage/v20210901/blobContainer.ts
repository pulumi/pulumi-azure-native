 ...
 *
 * @deprecated azure-native:storage/v20210901:BlobContainer is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobContainer to guarantee forwards compatibility.
 */
export class BlobContainer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobContainer {
        pulumi.log.warn("BlobContainer is deprecated: azure-native:storage/v20210901:BlobContainer is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobContainer to guarantee forwards compatibility.")
        return new BlobContainer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210901:BlobContainer';
     ...
     */
    public /*out*/ readonly immutabilityPolicy!: pulumi.Output<outputs.storage.v20210901.ImmutabilityPolicyPropertiesResponse>;
    /**
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    public readonly immutableStorageWithVersioning!: pulumi.Output<outputs.storage.v20210901.ImmutableStorageWithVersioningResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly legalHold!: pulumi.Output<outputs.storage.v20210901.LegalHoldPropertiesResponse>;
    /**
