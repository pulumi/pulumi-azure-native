...
export class FileShare extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210901:FileShare';
     ...
     */
    public readonly signedIdentifiers!: pulumi.Output<outputs.storage.v20210901.SignedIdentifierResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: FileShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage:FileShare" }, { type: "azure-native:storage/v20210101:FileShare" }, { type: "azure-native:storage/v20210201:FileShare" }, { type: "azure-native:storage/v20210401:FileShare" }, { type: "azure-native:storage/v20210601:FileShare" }, { type: "azure-native:storage/v20210801:FileShare" }] };
