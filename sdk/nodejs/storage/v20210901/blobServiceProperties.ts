...
export class BlobServiceProperties extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobServiceProperties {
        pulumi.log.warn("BlobServiceProperties is deprecated: azure-native:storage/v20210901:BlobServiceProperties is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobServiceProperties to guarantee forwards compatibility.")
