...
export class LocalUser extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalUser {
        pulumi.log.warn("LocalUser is deprecated: azure-native:storage/v20210901:LocalUser is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:LocalUser to guarantee forwards compatibility.")
