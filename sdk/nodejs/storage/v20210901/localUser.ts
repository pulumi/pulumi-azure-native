...
export class LocalUser extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalUser {
        pulumi.log.warn("LocalUser is deprecated: azure-native:storage/v20210901:LocalUser is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:LocalUser to guarantee forwards compatibility.")
        return new LocalUser(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210901:LocalUser';
     ...
     */
    public readonly permissionScopes!: pulumi.Output<outputs.storage.v20210901.PermissionScopeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshAuthorizedKeys!: pulumi.Output<outputs.storage.v20210901.SshPublicKeyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: LocalUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage:LocalUser" }, { type: "azure-native:storage/v20210801:LocalUser" }, { type: "azure-native:storage/v20220501:LocalUser" }, { type: "azure-native:storage/v20220901:LocalUser" }] };
