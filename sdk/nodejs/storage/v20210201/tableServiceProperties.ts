...
export class TableServiceProperties extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TableServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20210201:TableServiceProperties" }, { type: "azure-native:storage:TableServiceProperties" }, { type: "azure-nextgen:storage:TableServiceProperties" }, { type: "azure-native:storage/v20190601:TableServiceProperties" }, { type: "azure-nextgen:storage/v20190601:TableServiceProperties" }, { type: "azure-native:storage/v20200801preview:TableServiceProperties" }, { type: "azure-nextgen:storage/v20200801preview:TableServiceProperties" }, { type: "azure-native:storage/v20210101:TableServiceProperties" }, { type: "azure-nextgen:storage/v20210101:TableServiceProperties" }, { type: "azure-native:storage/v20210401:TableServiceProperties" }, { type: "azure-nextgen:storage/v20210401:TableServiceProperties" }] };
