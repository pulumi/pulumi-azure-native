...
export class BlobServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210201:BlobServiceProperties';
     ...
     */
    public readonly changeFeed!: pulumi.Output<outputs.storage.v20210201.ChangeFeedResponse | undefined>;
    /**
     * The blob service properties for container soft delete.
     */
    public readonly containerDeleteRetentionPolicy!: pulumi.Output<outputs.storage.v20210201.DeleteRetentionPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly deleteRetentionPolicy!: pulumi.Output<outputs.storage.v20210201.DeleteRetentionPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly lastAccessTimeTrackingPolicy!: pulumi.Output<outputs.storage.v20210201.LastAccessTimeTrackingPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly restorePolicy!: pulumi.Output<outputs.storage.v20210201.RestorePolicyPropertiesResponse | undefined>;
    /**
     * Sku name and tier.
     */
    public /*out*/ readonly sku!: pulumi.Output<outputs.storage.v20210201.SkuResponse>;
    /**
...
export interface BlobServicePropertiesArgs {
     ...
     * The blob service properties for change feed events.
     */
    readonly changeFeed?: pulumi.Input<inputs.storage.v20210201.ChangeFeed>;
    /**
     * The blob service properties for container soft delete.
     */
    readonly containerDeleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210201.DeleteRetentionPolicy>;
    /**
     * Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service.
     */
    readonly cors?: pulumi.Input<inputs.storage.v20210201.CorsRules>;
    /**
     * DefaultServiceVersion indicates the default version to use for requests to the Blob service if an incoming request’s version is not specified. Possible values include version 2008-10-27 and all more recent versions.
     */
     ...
     * The blob service properties for blob soft delete.
     */
    readonly deleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210201.DeleteRetentionPolicy>;
    /**
     * Versioning is enabled if set to true.
     */
     ...
     * The blob service property to configure last access time based tracking policy.
     */
    readonly lastAccessTimeTrackingPolicy?: pulumi.Input<inputs.storage.v20210201.LastAccessTimeTrackingPolicy>;
    /**
     ...
     * The blob service properties for blob restore policy.
     */
    readonly restorePolicy?: pulumi.Input<inputs.storage.v20210201.RestorePolicyProperties>;
}
