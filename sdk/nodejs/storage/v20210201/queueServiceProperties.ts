...
export class QueueServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210201:QueueServiceProperties';
    ...
    constructor(name: string, args: QueueServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20210201:QueueServiceProperties" }, { type: "azure-native:storage:QueueServiceProperties" }, { type: "azure-nextgen:storage:QueueServiceProperties" }, { type: "azure-native:storage/v20190601:QueueServiceProperties" }, { type: "azure-nextgen:storage/v20190601:QueueServiceProperties" }, { type: "azure-native:storage/v20200801preview:QueueServiceProperties" }, { type: "azure-nextgen:storage/v20200801preview:QueueServiceProperties" }, { type: "azure-native:storage/v20210101:QueueServiceProperties" }, { type: "azure-nextgen:storage/v20210101:QueueServiceProperties" }, { type: "azure-native:storage/v20210401:QueueServiceProperties" }, { type: "azure-nextgen:storage/v20210401:QueueServiceProperties" }, { type: "azure-native:storage/v20210601:QueueServiceProperties" }, { type: "azure-nextgen:storage/v20210601:QueueServiceProperties" }] };
