...
export class ManagementPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage:ManagementPolicy" }, { type: "azure-native:storage/v20210801:ManagementPolicy" }, { type: "azure-native:storage/v20220901:ManagementPolicy" }] };
