...
export class ManagementPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20210201:ManagementPolicy" }, { type: "azure-native:storage:ManagementPolicy" }, { type: "azure-nextgen:storage:ManagementPolicy" }, { type: "azure-native:storage/latest:ManagementPolicy" }, { type: "azure-nextgen:storage/latest:ManagementPolicy" }, { type: "azure-native:storage/v20180301preview:ManagementPolicy" }, { type: "azure-nextgen:storage/v20180301preview:ManagementPolicy" }, { type: "azure-native:storage/v20181101:ManagementPolicy" }, { type: "azure-nextgen:storage/v20181101:ManagementPolicy" }, { type: "azure-native:storage/v20190401:ManagementPolicy" }, { type: "azure-nextgen:storage/v20190401:ManagementPolicy" }, { type: "azure-native:storage/v20190601:ManagementPolicy" }, { type: "azure-nextgen:storage/v20190601:ManagementPolicy" }, { type: "azure-native:storage/v20200801preview:ManagementPolicy" }, { type: "azure-nextgen:storage/v20200801preview:ManagementPolicy" }, { type: "azure-native:storage/v20210101:ManagementPolicy" }, { type: "azure-nextgen:storage/v20210101:ManagementPolicy" }] };
...
export interface ManagementPolicyArgs {
     ...
     * The Storage Account ManagementPolicy, in JSON format. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    readonly policy: pulumi.Input<inputs.storage.v20210201.ManagementPolicySchema>;
    /**
