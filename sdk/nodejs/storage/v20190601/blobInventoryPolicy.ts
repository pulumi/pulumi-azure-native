...
export class BlobInventoryPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobInventoryPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20190601:BlobInventoryPolicy" }, { type: "azure-native:storage:BlobInventoryPolicy" }, { type: "azure-nextgen:storage:BlobInventoryPolicy" }, { type: "azure-native:storage/latest:BlobInventoryPolicy" }, { type: "azure-nextgen:storage/latest:BlobInventoryPolicy" }, { type: "azure-native:storage/v20200801preview:BlobInventoryPolicy" }, { type: "azure-nextgen:storage/v20200801preview:BlobInventoryPolicy" }, { type: "azure-native:storage/v20210101:BlobInventoryPolicy" }, { type: "azure-nextgen:storage/v20210101:BlobInventoryPolicy" }, { type: "azure-native:storage/v20210201:BlobInventoryPolicy" }, { type: "azure-nextgen:storage/v20210201:BlobInventoryPolicy" }] };
...
export interface BlobInventoryPolicyArgs {
     ...
     * The storage account blob inventory policy object. It is composed of policy rules.
     */
    readonly policy: pulumi.Input<inputs.storage.v20190601.BlobInventoryPolicySchema>;
    /**
