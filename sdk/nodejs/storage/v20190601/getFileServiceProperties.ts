...
export function getFileServiceProperties(args: GetFileServicePropertiesArgs, opts?: pulumi.InvokeOptions): Promise<GetFileServicePropertiesResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storage/v20190601:getFileServiceProperties", {
...
export interface GetFileServicePropertiesResult {
     ...
     */
    readonly shareDeleteRetentionPolicy?: outputs.storage.v20190601.DeleteRetentionPolicyInvokeResponse;
    /**
     * Sku name and tier.
     */
    readonly sku: outputs.storage.v20190601.SkuInvokeResponse;
    /**
