...
export class BlobContainerImmutabilityPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/v20190601:BlobContainerImmutabilityPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.storage.v20190601.ImmutabilityPolicyPropertyResponse>;
    /**
...
export interface BlobContainerImmutabilityPolicyArgs {
     ...
     * The properties of an ImmutabilityPolicy of a blob container.
     */
    readonly properties: pulumi.Input<inputs.storage.v20190601.ImmutabilityPolicyProperty>;
    /**
