 ...
 *
 * const privateEndpointConnection = new azurerm.storage.v20190601.PrivateEndpointConnection("privateEndpointConnection", {
 *     accountName: "sto9699",
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/v20190601:PrivateEndpointConnection';
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/latest:PrivateEndpointConnection" }] };
