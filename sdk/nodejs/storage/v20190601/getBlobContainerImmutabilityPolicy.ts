...
azure-native:storage/v20190601:BlobContainerImmutabilityPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobContainerImmutabilityPolicy to guarantee forwards compatibility. */
export function getBlobContainerImmutabilityPolicy(args: GetBlobContainerImmutabilityPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerImmutabilityPolicyResult> {
    pulumi.log.warn("getBlobContainerImmutabilityPolicy is deprecated: Version 2019-06-01 will be removed in v2 of the provider.\nazure-native:storage/v20190601:BlobContainerImmutabilityPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobContainerImmutabilityPolicy to guarantee forwards compatibility.")
