...
export class FileShare extends pulumi.CustomResource {
     ...
     */
    public readonly accessTier!: pulumi.Output<ShareAccessTier | undefined>;
    /**
     ...
     */
    public readonly enabledProtocols!: pulumi.Output<EnabledProtocols | undefined>;
    /**
     * Resource Etag.
     */
     ...
     */
    public readonly rootSquash!: pulumi.Output<RootSquashType | undefined>;
    /**
...
export interface FileShareArgs {
     ...
     * Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium.
     */
    readonly accessTier?: pulumi.Input<ShareAccessTier>;
    /**
     ...
     * The authentication protocol that is used for the file share. Can only be specified when creating a share.
     */
    readonly enabledProtocols?: pulumi.Input<EnabledProtocols>;
    /**
     * A name-value pair to associate with the share as metadata.
     */
     ...
     * The property is for NFS share only. The default is NoRootSquash.
     */
    readonly rootSquash?: pulumi.Input<RootSquashType>;
    /**
