...
export class BlobContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/preview:BlobContainer';
     ...
     */
    public /*out*/ readonly immutabilityPolicy!: pulumi.Output<outputs.storage.preview.ImmutabilityPolicyPropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly legalHold!: pulumi.Output<outputs.storage.preview.LegalHoldPropertiesResponse>;
    /**
