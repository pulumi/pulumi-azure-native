...
export class ManagementPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/preview:ManagementPolicy';
     ...
     */
    public readonly policy!: pulumi.Output<outputs.storage.preview.ManagementPolicySchemaResponse>;
    /**
...
export interface ManagementPolicyArgs {
     ...
     * The Storage Account ManagementPolicy, in JSON format. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    readonly policy: pulumi.Input<inputs.storage.preview.ManagementPolicySchema>;
    /**
