...
export class Queue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/preview:Queue';
    ...
    constructor(name: string, args: QueueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/latest:Queue" }, { type: "azurerm:storage/v20190601:Queue" }] };
