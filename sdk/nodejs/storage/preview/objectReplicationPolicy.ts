...
export class ObjectReplicationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/preview:ObjectReplicationPolicy';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.storage.preview.ObjectReplicationPolicyRuleResponse[] | undefined>;
    /**
...
export interface ObjectReplicationPolicyArgs {
     ...
     * The storage account object replication rules.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.storage.preview.ObjectReplicationPolicyRule>[]>;
    /**
     * Required. Source account name.
     */
