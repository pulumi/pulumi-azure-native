...
export function getBlobContainer(args: GetBlobContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storage/preview:getBlobContainer", {
...
export interface GetBlobContainerResult {
     ...
     */
    readonly immutabilityPolicy: outputs.storage.preview.ImmutabilityPolicyPropertiesResponse;
    /**
     ...
     */
    readonly legalHold: outputs.storage.preview.LegalHoldPropertiesResponse;
    /**
