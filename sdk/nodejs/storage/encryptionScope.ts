...
export class EncryptionScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EncryptionScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage/v20220901:EncryptionScope" }, { type: "azure-native:storage/v20230101:EncryptionScope" }, { type: "azure-native:storage/v20230401:EncryptionScope" }, { type: "azure-native:storage/v20230501:EncryptionScope" }, { type: "azure-native_storage_v20190601:storage:EncryptionScope" }, { type: "azure-native_storage_v20200801preview:storage:EncryptionScope" }, { type: "azure-native_storage_v20210101:storage:EncryptionScope" }, { type: "azure-native_storage_v20210201:storage:EncryptionScope" }, { type: "azure-native_storage_v20210401:storage:EncryptionScope" }, { type: "azure-native_storage_v20210601:storage:EncryptionScope" }, { type: "azure-native_storage_v20210801:storage:EncryptionScope" }, { type: "azure-native_storage_v20210901:storage:EncryptionScope" }, { type: "azure-native_storage_v20220501:storage:EncryptionScope" }, { type: "azure-native_storage_v20220901:storage:EncryptionScope" }, { type: "azure-native_storage_v20230101:storage:EncryptionScope" }, { type: "azure-native_storage_v20230401:storage:EncryptionScope" }, { type: "azure-native_storage_v20230501:storage:EncryptionScope" }, { type: "azure-native_storage_v20240101:storage:EncryptionScope" }] };
