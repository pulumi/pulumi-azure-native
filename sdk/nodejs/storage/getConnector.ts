...
export function getConnector(args: GetConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage:getConnector", {
...
export interface GetConnectorResult {
     ...
     */
    readonly properties: outputs.storage.StorageConnectorPropertiesResponse;
    /**
...
export function getConnectorOutput(args: GetConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:storage:getConnector", {
        "accountName": args.accountName,
        "connectorName": args.connectorName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
