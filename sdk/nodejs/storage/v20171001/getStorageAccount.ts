...
export function getStorageAccount(args: GetStorageAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageAccountResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storage/v20171001:getStorageAccount", {
        "name": args.name,
...
export interface GetStorageAccountResult {
     ...
     */
    readonly properties: outputs.storage.v20171001.StorageAccountPropertiesResponse;
    /**
     * Gets the SKU.
     */
