...
export class StorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210101:StorageAccount';
     ...
     */
    public readonly azureFilesIdentityBasedAuthentication!: pulumi.Output<outputs.storage.v20210101.AzureFilesIdentityBasedAuthenticationResponse | undefined>;
    /**
     * Blob restore status
     */
    public /*out*/ readonly blobRestoreStatus!: pulumi.Output<outputs.storage.v20210101.BlobRestoreStatusResponse>;
    /**
     ...
     */
    public readonly customDomain!: pulumi.Output<outputs.storage.v20210101.CustomDomainResponse>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.storage.v20210101.EncryptionResponse>;
    /**
     * The extendedLocation of the resource.
     */
    public readonly extendedLocation!: pulumi.Output<outputs.storage.v20210101.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly geoReplicationStats!: pulumi.Output<outputs.storage.v20210101.GeoReplicationStatsResponse>;
    /**
     * The identity of the resource.
     */
    public readonly identity!: pulumi.Output<outputs.storage.v20210101.IdentityResponse | undefined>;
    /**
     ...
     * Network rule set
     */
    public readonly networkRuleSet!: pulumi.Output<outputs.storage.v20210101.NetworkRuleSetResponse>;
    /**
     * Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object. Note that Standard_ZRS and Premium_LRS accounts only return the blob endpoint.
     */
    public /*out*/ readonly primaryEndpoints!: pulumi.Output<outputs.storage.v20210101.EndpointsResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.storage.v20210101.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly routingPreference!: pulumi.Output<outputs.storage.v20210101.RoutingPreferenceResponse | undefined>;
    /**
     * Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object from the secondary location of the storage account. Only available if the SKU name is Standard_RAGRS.
     */
    public /*out*/ readonly secondaryEndpoints!: pulumi.Output<outputs.storage.v20210101.EndpointsResponse>;
    /**
     ...
     * Gets the SKU.
     */
    public readonly sku!: pulumi.Output<outputs.storage.v20210101.SkuResponse>;
    /**
    ...
    constructor(name: string, args: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20210101:StorageAccount" }, { type: "azure-native:storage:StorageAccount" }, { type: "azure-nextgen:storage:StorageAccount" }, { type: "azure-native:storage/v20150501preview:StorageAccount" }, { type: "azure-nextgen:storage/v20150501preview:StorageAccount" }, { type: "azure-native:storage/v20150615:StorageAccount" }, { type: "azure-nextgen:storage/v20150615:StorageAccount" }, { type: "azure-native:storage/v20160101:StorageAccount" }, { type: "azure-nextgen:storage/v20160101:StorageAccount" }, { type: "azure-native:storage/v20160501:StorageAccount" }, { type: "azure-nextgen:storage/v20160501:StorageAccount" }, { type: "azure-native:storage/v20161201:StorageAccount" }, { type: "azure-nextgen:storage/v20161201:StorageAccount" }, { type: "azure-native:storage/v20170601:StorageAccount" }, { type: "azure-nextgen:storage/v20170601:StorageAccount" }, { type: "azure-native:storage/v20171001:StorageAccount" }, { type: "azure-nextgen:storage/v20171001:StorageAccount" }, { type: "azure-native:storage/v20180201:StorageAccount" }, { type: "azure-nextgen:storage/v20180201:StorageAccount" }, { type: "azure-native:storage/v20180301preview:StorageAccount" }, { type: "azure-nextgen:storage/v20180301preview:StorageAccount" }, { type: "azure-native:storage/v20180701:StorageAccount" }, { type: "azure-nextgen:storage/v20180701:StorageAccount" }, { type: "azure-native:storage/v20181101:StorageAccount" }, { type: "azure-nextgen:storage/v20181101:StorageAccount" }, { type: "azure-native:storage/v20190401:StorageAccount" }, { type: "azure-nextgen:storage/v20190401:StorageAccount" }, { type: "azure-native:storage/v20190601:StorageAccount" }, { type: "azure-nextgen:storage/v20190601:StorageAccount" }, { type: "azure-native:storage/v20200801preview:StorageAccount" }, { type: "azure-nextgen:storage/v20200801preview:StorageAccount" }, { type: "azure-native:storage/v20210201:StorageAccount" }, { type: "azure-nextgen:storage/v20210201:StorageAccount" }, { type: "azure-native:storage/v20210401:StorageAccount" }, { type: "azure-nextgen:storage/v20210401:StorageAccount" }] };
...
export interface StorageAccountArgs {
     ...
     * Required for storage accounts where kind = BlobStorage. The access tier used for billing.
     */
    readonly accessTier?: pulumi.Input<enums.storage.v20210101.AccessTier>;
    /**
     ...
     * Provides the identity based authentication settings for Azure Files.
     */
    readonly azureFilesIdentityBasedAuthentication?: pulumi.Input<inputs.storage.v20210101.AzureFilesIdentityBasedAuthenticationArgs>;
    /**
     * User domain assigned to the storage account. Name is the CNAME source. Only one custom domain is supported per storage account at this time. To clear the existing custom domain, use an empty string for the custom domain name property.
     */
    readonly customDomain?: pulumi.Input<inputs.storage.v20210101.CustomDomainArgs>;
    /**
     ...
     */
    readonly encryption?: pulumi.Input<inputs.storage.v20210101.EncryptionArgs>;
    /**
     * Optional. Set the extended location of the resource. If not set, the storage account will be created in Azure main region. Otherwise it will be created in the specified extended location
     */
    readonly extendedLocation?: pulumi.Input<inputs.storage.v20210101.ExtendedLocationArgs>;
    /**
     * The identity of the resource.
     */
    readonly identity?: pulumi.Input<inputs.storage.v20210101.IdentityArgs>;
    /**
     * Account HierarchicalNamespace enabled if sets to true.
     */
     ...
     */
    readonly kind: pulumi.Input<string | enums.storage.v20210101.Kind>;
    /**
     * Allow large file shares if sets to Enabled. It cannot be disabled once it is enabled.
     */
    readonly largeFileSharesState?: pulumi.Input<string | enums.storage.v20210101.LargeFileSharesState>;
    /**
     ...
     * Set the minimum TLS version to be permitted on requests to storage. The default interpretation is TLS 1.0 for this property.
     */
    readonly minimumTlsVersion?: pulumi.Input<string | enums.storage.v20210101.MinimumTlsVersion>;
    /**
     * Network rule set
     */
    readonly networkRuleSet?: pulumi.Input<inputs.storage.v20210101.NetworkRuleSetArgs>;
    /**
     ...
     * Maintains information about the network routing choice opted by the user for data transfer
     */
    readonly routingPreference?: pulumi.Input<inputs.storage.v20210101.RoutingPreferenceArgs>;
    /**
     * Required. Gets or sets the SKU name.
     */
    readonly sku: pulumi.Input<inputs.storage.v20210101.SkuArgs>;
    /**
