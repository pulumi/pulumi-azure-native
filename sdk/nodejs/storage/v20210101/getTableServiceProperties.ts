 ...
 */
/** @deprecated azure-native:storage/v20210101:TableServiceProperties is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:TableServiceProperties to guarantee forwards compatibility. */
export function getTableServiceProperties(args: GetTableServicePropertiesArgs, opts?: pulumi.InvokeOptions): Promise<GetTableServicePropertiesResult> {
    pulumi.log.warn("getTableServiceProperties is deprecated: azure-native:storage/v20210101:TableServiceProperties is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:TableServiceProperties to guarantee forwards compatibility.")
