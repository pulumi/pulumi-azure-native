...
export class BlobServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210101:BlobServiceProperties';
     ...
     */
    public readonly changeFeed!: pulumi.Output<outputs.storage.v20210101.ChangeFeedResponse | undefined>;
    /**
     * The blob service properties for container soft delete.
     */
    public readonly containerDeleteRetentionPolicy!: pulumi.Output<outputs.storage.v20210101.DeleteRetentionPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly deleteRetentionPolicy!: pulumi.Output<outputs.storage.v20210101.DeleteRetentionPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly lastAccessTimeTrackingPolicy!: pulumi.Output<outputs.storage.v20210101.LastAccessTimeTrackingPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly restorePolicy!: pulumi.Output<outputs.storage.v20210101.RestorePolicyPropertiesResponse | undefined>;
    /**
     * Sku name and tier.
     */
    public /*out*/ readonly sku!: pulumi.Output<outputs.storage.v20210101.SkuResponse>;
    /**
    ...
    constructor(name: string, args: BlobServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20210101:BlobServiceProperties" }, { type: "azure-native:storage:BlobServiceProperties" }, { type: "azure-nextgen:storage:BlobServiceProperties" }, { type: "azure-native:storage/latest:BlobServiceProperties" }, { type: "azure-nextgen:storage/latest:BlobServiceProperties" }, { type: "azure-native:storage/v20180701:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20180701:BlobServiceProperties" }, { type: "azure-native:storage/v20181101:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20181101:BlobServiceProperties" }, { type: "azure-native:storage/v20190401:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20190401:BlobServiceProperties" }, { type: "azure-native:storage/v20190601:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20190601:BlobServiceProperties" }, { type: "azure-native:storage/v20200801preview:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20200801preview:BlobServiceProperties" }, { type: "azure-native:storage/v20210201:BlobServiceProperties" }, { type: "azure-nextgen:storage/v20210201:BlobServiceProperties" }] };
...
export interface BlobServicePropertiesArgs {
     ...
     * The blob service properties for change feed events.
     */
    readonly changeFeed?: pulumi.Input<inputs.storage.v20210101.ChangeFeed>;
    /**
     * The blob service properties for container soft delete.
     */
    readonly containerDeleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210101.DeleteRetentionPolicy>;
    /**
     * Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service.
     */
     ...
     * The blob service properties for blob soft delete.
     */
    readonly deleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210101.DeleteRetentionPolicy>;
    /**
     * Versioning is enabled if set to true.
     */
     ...
     * The blob service property to configure last access time based tracking policy.
     */
    readonly lastAccessTimeTrackingPolicy?: pulumi.Input<inputs.storage.v20210101.LastAccessTimeTrackingPolicy>;
    /**
     ...
     * The blob service properties for blob restore policy.
     */
    readonly restorePolicy?: pulumi.Input<inputs.storage.v20210101.RestorePolicyProperties>;
}
