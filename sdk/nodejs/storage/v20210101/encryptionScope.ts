...
export class EncryptionScope extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EncryptionScope {
        pulumi.log.warn("EncryptionScope is deprecated: azure-native:storage/v20210101:EncryptionScope is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:EncryptionScope to guarantee forwards compatibility.")
