...
export class FileServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20220501:FileServiceProperties';
     ...
     */
    public readonly cors!: pulumi.Output<outputs.storage.v20220501.CorsRulesResponse | undefined>;
    /**
     ...
     */
    public readonly protocolSettings!: pulumi.Output<outputs.storage.v20220501.ProtocolSettingsResponse | undefined>;
    /**
     * The file service properties for share soft delete.
     */
    public readonly shareDeleteRetentionPolicy!: pulumi.Output<outputs.storage.v20220501.DeleteRetentionPolicyResponse | undefined>;
    /**
     * Sku name and tier.
     */
    public /*out*/ readonly sku!: pulumi.Output<outputs.storage.v20220501.SkuResponse>;
    /**
...
export interface FileServicePropertiesArgs {
     ...
     * Specifies CORS rules for the File service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the File service.
     */
    cors?: pulumi.Input<inputs.storage.v20220501.CorsRulesArgs>;
    /**
     ...
     * Protocol settings for file service
     */
    protocolSettings?: pulumi.Input<inputs.storage.v20220501.ProtocolSettingsArgs>;
    /**
     ...
     * The file service properties for share soft delete.
     */
    shareDeleteRetentionPolicy?: pulumi.Input<inputs.storage.v20220501.DeleteRetentionPolicyArgs>;
}
