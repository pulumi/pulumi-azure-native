 ...
 *
 * @deprecated azure-native:storage/v20220501:BlobInventoryPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobInventoryPolicy to guarantee forwards compatibility.
 */
export class BlobInventoryPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobInventoryPolicy {
        pulumi.log.warn("BlobInventoryPolicy is deprecated: azure-native:storage/v20220501:BlobInventoryPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:BlobInventoryPolicy to guarantee forwards compatibility.")
        return new BlobInventoryPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20220501:BlobInventoryPolicy';
     ...
     */
    public readonly policy!: pulumi.Output<outputs.storage.v20220501.BlobInventoryPolicySchemaResponse>;
    /**
...
export interface BlobInventoryPolicyArgs {
     ...
     * The storage account blob inventory policy object. It is composed of policy rules.
     */
    policy: pulumi.Input<inputs.storage.v20220501.BlobInventoryPolicySchemaArgs>;
    /**
