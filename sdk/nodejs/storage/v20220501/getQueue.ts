...
export function getQueue(args: GetQueueArgs, opts?: pulumi.InvokeOptions): Promise<GetQueueResult> {
    pulumi.log.warn("getQueue is deprecated: azure-native:storage/v20220501:Queue is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:Queue to guarantee forwards compatibility.")
