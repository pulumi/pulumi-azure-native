...
export class LocalUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20230501:LocalUser';
     ...
     */
    public readonly permissionScopes!: pulumi.Output<outputs.storage.v20230501.PermissionScopeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshAuthorizedKeys!: pulumi.Output<outputs.storage.v20230501.SshPublicKeyResponse[] | undefined>;
    /**
...
export interface LocalUserArgs {
     ...
     * The permission scopes of the local user.
     */
    permissionScopes?: pulumi.Input<pulumi.Input<inputs.storage.v20230501.PermissionScopeArgs>[]>;
    /**
     ...
     * Optional, local user ssh authorized keys for SFTP.
     */
    sshAuthorizedKeys?: pulumi.Input<pulumi.Input<inputs.storage.v20230501.SshPublicKeyArgs>[]>;
    /**
