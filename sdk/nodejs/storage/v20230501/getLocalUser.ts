...
export function getLocalUser(args: GetLocalUserArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalUserResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20230501:getLocalUser", {
...
export interface GetLocalUserResult {
     ...
     */
    readonly permissionScopes?: outputs.storage.v20230501.PermissionScopeResponse[];
    /**
     ...
     */
    readonly sshAuthorizedKeys?: outputs.storage.v20230501.SshPublicKeyResponse[];
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: outputs.storage.v20230501.SystemDataResponse;
    /**
...
export function getLocalUserOutput(args: GetLocalUserOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLocalUserResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:storage/v20230501:getLocalUser", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "username": args.username,
    }, opts);
