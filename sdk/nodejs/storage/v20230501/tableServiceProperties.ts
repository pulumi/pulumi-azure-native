...
export class TableServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20230501:TableServiceProperties';
     ...
     */
    public readonly cors!: pulumi.Output<outputs.storage.v20230501.CorsRulesResponse | undefined>;
    /**
...
export interface TableServicePropertiesArgs {
     ...
     * Specifies CORS rules for the Table service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Table service.
     */
    cors?: pulumi.Input<inputs.storage.v20230501.CorsRulesArgs>;
    /**
