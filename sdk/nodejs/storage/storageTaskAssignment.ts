...
export class StorageTaskAssignment extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.storage.StorageTaskAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: StorageTaskAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.storageTaskAssignmentName === undefined && !opts.urn) {
                throw new Error("Missing required property 'storageTaskAssignmentName'");
            }
