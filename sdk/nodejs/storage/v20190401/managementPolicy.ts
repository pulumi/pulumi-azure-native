...
export class ManagementPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ManagementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storage/latest:ManagementPolicy" }, { type: "azurerm:storage/v20181101:ManagementPolicy" }, { type: "azurerm:storage/v20190601:ManagementPolicy" }] };
