...
export function listStorageAccountSAS(args: ListStorageAccountSASArgs, opts?: pulumi.InvokeOptions): Promise<ListStorageAccountSASResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storage/v20190401:listStorageAccountSAS", {
...
export interface ListStorageAccountSASArgs {
     ...
     */
    readonly resourceTypes: string | enums.storage.v20190401.SignedResourceTypes;
    /**
     * The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
     */
    readonly services: string | enums.storage.v20190401.Services;
    /**
