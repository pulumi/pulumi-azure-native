...
export class FileServiceProperties extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20190401:FileServiceProperties" }, { type: "azure-native:storage:FileServiceProperties" }, { type: "azure-nextgen:storage:FileServiceProperties" }, { type: "azure-native:storage/latest:FileServiceProperties" }, { type: "azure-nextgen:storage/latest:FileServiceProperties" }, { type: "azure-native:storage/v20190601:FileServiceProperties" }, { type: "azure-nextgen:storage/v20190601:FileServiceProperties" }, { type: "azure-native:storage/v20200801preview:FileServiceProperties" }, { type: "azure-nextgen:storage/v20200801preview:FileServiceProperties" }, { type: "azure-native:storage/v20210101:FileServiceProperties" }, { type: "azure-nextgen:storage/v20210101:FileServiceProperties" }, { type: "azure-native:storage/v20210201:FileServiceProperties" }, { type: "azure-nextgen:storage/v20210201:FileServiceProperties" }] };
...
export interface FileServicePropertiesArgs {
     ...
     * Specifies CORS rules for the File service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the File service.
     */
    readonly cors?: pulumi.Input<inputs.storage.v20190401.CorsRules>;
    /**
