...
export function getStorageAccount(args: GetStorageAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageAccountResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storage/v20190401:getStorageAccount", {
        "name": args.name,
...
export interface GetStorageAccountResult {
     ...
     */
    readonly properties: outputs.storage.v20190401.StorageAccountPropertiesResponse;
    /**
     * Gets the SKU.
     */
