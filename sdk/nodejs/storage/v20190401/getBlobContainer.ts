...
export function getBlobContainer(args: GetBlobContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storage/v20190401:getBlobContainer", {
...
export interface GetBlobContainerResult {
     ...
     */
    readonly immutabilityPolicy: outputs.storage.v20190401.ImmutabilityPolicyPropertiesInvokeResponse;
    /**
     ...
     */
    readonly legalHold: outputs.storage.v20190401.LegalHoldPropertiesInvokeResponse;
    /**
