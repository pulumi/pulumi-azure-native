...
export class FileShare extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storage/v20190401:FileShare';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.storage.v20190401.FileSharePropertiesResponse>;
    /**
...
export interface FileShareArgs {
     ...
     * Properties of the file share.
     */
    readonly properties?: pulumi.Input<inputs.storage.v20190401.FileShareProperties>;
    /**
