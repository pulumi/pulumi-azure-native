...
azure-native:storage/v20190401:FileShare is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.
 */
export class FileShare extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FileShare {
        pulumi.log.warn("FileShare is deprecated: Version 2019-04-01 will be removed in v2 of the provider.\nazure-native:storage/v20190401:FileShare is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.")
