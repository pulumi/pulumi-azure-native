...
export class ObjectReplicationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20240101:ObjectReplicationPolicy';
     ...
     */
    public readonly metrics!: pulumi.Output<outputs.storage.v20240101.ObjectReplicationPolicyPropertiesResponseMetrics | undefined>;
    /**
     ...
     */
    public readonly rules!: pulumi.Output<outputs.storage.v20240101.ObjectReplicationPolicyRuleResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ObjectReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage/v20190601:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20200801preview:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210101:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210201:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210401:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210601:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210801:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210901:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20220501:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20220901:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20230101:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20230401:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20230501:ObjectReplicationPolicy" }, { type: "azure-native:storage:ObjectReplicationPolicy" }] };
...
export interface ObjectReplicationPolicyArgs {
     ...
     * Optional. The object replication policy metrics feature options.
     */
    metrics?: pulumi.Input<inputs.storage.v20240101.ObjectReplicationPolicyPropertiesMetricsArgs>;
    /**
     ...
     * The storage account object replication rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.storage.v20240101.ObjectReplicationPolicyRuleArgs>[]>;
    /**
     * Required. Source account name. It should be full resource id if allowCrossTenantReplication set to false.
     */
