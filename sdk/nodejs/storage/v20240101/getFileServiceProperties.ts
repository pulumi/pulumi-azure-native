...
export function getFileServiceProperties(args: GetFileServicePropertiesArgs, opts?: pulumi.InvokeOptions): Promise<GetFileServicePropertiesResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20240101:getFileServiceProperties", {
...
export interface GetFileServicePropertiesResult {
     ...
     */
    readonly cors?: outputs.storage.v20240101.CorsRulesResponse;
    /**
     ...
     */
    readonly protocolSettings?: outputs.storage.v20240101.ProtocolSettingsResponse;
    /**
     * The file service properties for share soft delete.
     */
    readonly shareDeleteRetentionPolicy?: outputs.storage.v20240101.DeleteRetentionPolicyResponse;
    /**
     * Sku name and tier.
     */
    readonly sku: outputs.storage.v20240101.SkuResponse;
    /**
...
export function getFileServicePropertiesOutput(args: GetFileServicePropertiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileServicePropertiesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:storage/v20240101:getFileServiceProperties", {
        "accountName": args.accountName,
        "fileServicesName": args.fileServicesName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
