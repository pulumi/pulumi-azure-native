...
export class QueueServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20240101:QueueServiceProperties';
     ...
     */
    public readonly cors!: pulumi.Output<outputs.storage.v20240101.CorsRulesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: QueueServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage/v20190601:QueueServiceProperties" }, { type: "azure-native:storage/v20200801preview:QueueServiceProperties" }, { type: "azure-native:storage/v20210101:QueueServiceProperties" }, { type: "azure-native:storage/v20210201:QueueServiceProperties" }, { type: "azure-native:storage/v20210401:QueueServiceProperties" }, { type: "azure-native:storage/v20210601:QueueServiceProperties" }, { type: "azure-native:storage/v20210801:QueueServiceProperties" }, { type: "azure-native:storage/v20210901:QueueServiceProperties" }, { type: "azure-native:storage/v20220501:QueueServiceProperties" }, { type: "azure-native:storage/v20220901:QueueServiceProperties" }, { type: "azure-native:storage/v20230101:QueueServiceProperties" }, { type: "azure-native:storage/v20230401:QueueServiceProperties" }, { type: "azure-native:storage/v20230501:QueueServiceProperties" }, { type: "azure-native:storage:QueueServiceProperties" }] };
...
export interface QueueServicePropertiesArgs {
     ...
     * Specifies CORS rules for the Queue service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Queue service.
     */
    cors?: pulumi.Input<inputs.storage.v20240101.CorsRulesArgs>;
    /**
