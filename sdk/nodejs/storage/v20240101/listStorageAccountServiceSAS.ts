...
export function listStorageAccountServiceSAS(args: ListStorageAccountServiceSASArgs, opts?: pulumi.InvokeOptions): Promise<ListStorageAccountServiceSASResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20240101:listStorageAccountServiceSAS", {
...
export interface ListStorageAccountServiceSASArgs {
     ...
     */
    permissions?: string | enums.storage.v20240101.Permissions;
    /**
     * The protocol permitted for a request made with the account SAS.
     */
    protocols?: enums.storage.v20240101.HttpProtocol;
    /**
     * The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
     */
    resource?: string | enums.storage.v20240101.SignedResource;
    /**
...
export function listStorageAccountServiceSASOutput(args: ListStorageAccountServiceSASOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListStorageAccountServiceSASResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:storage/v20240101:listStorageAccountServiceSAS", {
        "accountName": args.accountName,
        "cacheControl": args.cacheControl,
        "canonicalizedResource": args.canonicalizedResource,
        "contentDisposition": args.contentDisposition,
...
export interface ListStorageAccountServiceSASOutputArgs {
     ...
     * The signed permissions for the service SAS. Possible values include: Read (r), Write (w), Delete (d), List (l), Add (a), Create (c), Update (u) and Process (p).
     */
    permissions?: pulumi.Input<string | enums.storage.v20240101.Permissions>;
    /**
     * The protocol permitted for a request made with the account SAS.
     */
    protocols?: pulumi.Input<enums.storage.v20240101.HttpProtocol>;
    /**
     * The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
     */
    resource?: pulumi.Input<string | enums.storage.v20240101.SignedResource>;
    /**
     * The name of the resource group within the user's subscription. The name is case insensitive.
     */
