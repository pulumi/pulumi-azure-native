...
export class Share extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/preview:Share';
     ...
     */
    public readonly azureContainerInfo!: pulumi.Output<outputs.databoxedge.preview.AzureContainerInfoResponse | undefined>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    public readonly clientAccessRights!: pulumi.Output<outputs.databoxedge.preview.ClientAccessRightResponse[] | undefined>;
    /**
     ...
     */
    public readonly refreshDetails!: pulumi.Output<outputs.databoxedge.preview.RefreshDetailsResponse | undefined>;
    /**
     * Share mount point to the role.
     */
    public /*out*/ readonly shareMappings!: pulumi.Output<outputs.databoxedge.preview.MountPointMapResponse[]>;
    /**
     ...
     */
    public readonly userAccessRights!: pulumi.Output<outputs.databoxedge.preview.UserAccessRightResponse[] | undefined>;
    ...
    constructor(name: string, args: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:Share" }, { type: "azurerm:databoxedge/v20190301:Share" }, { type: "azurerm:databoxedge/v20190701:Share" }, { type: "azurerm:databoxedge/v20190801:Share" }, { type: "azurerm:databoxedge/v20200501preview:Share" }] };
...
export interface ShareArgs {
     ...
     * Azure container mapping for the share.
     */
    readonly azureContainerInfo?: pulumi.Input<inputs.databoxedge.preview.AzureContainerInfo>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    readonly clientAccessRights?: pulumi.Input<pulumi.Input<inputs.databoxedge.preview.ClientAccessRight>[]>;
    /**
     * Data policy of the share.
     */
     ...
     * Details of the refresh job on this share.
     */
    readonly refreshDetails?: pulumi.Input<inputs.databoxedge.preview.RefreshDetails>;
    /**
     ...
     * Mapping of users and corresponding access rights on the share (required for SMB protocol).
     */
    readonly userAccessRights?: pulumi.Input<pulumi.Input<inputs.databoxedge.preview.UserAccessRight>[]>;
}
