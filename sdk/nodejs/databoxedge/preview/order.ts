...
export class Order extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/preview:Order';
     ...
     * The contact details.
     */
    public readonly contactInformation!: pulumi.Output<outputs.databoxedge.preview.ContactDetailsResponse>;
    /**
     * Current status of the order.
     */
    public readonly currentStatus!: pulumi.Output<outputs.databoxedge.preview.OrderStatusResponse | undefined>;
    /**
     * Tracking information for the package delivered to the customer whether it has an original or a replacement device.
     */
    public /*out*/ readonly deliveryTrackingInfo!: pulumi.Output<outputs.databoxedge.preview.TrackingInfoResponse[]>;
    /**
     * The object name.
     */
     ...
     */
    public /*out*/ readonly orderHistory!: pulumi.Output<outputs.databoxedge.preview.OrderStatusResponse[]>;
    /**
     * Tracking information for the package returned from the customer whether it has an original or a replacement device.
     */
    public /*out*/ readonly returnTrackingInfo!: pulumi.Output<outputs.databoxedge.preview.TrackingInfoResponse[]>;
    /**
     ...
     */
    public readonly shippingAddress!: pulumi.Output<outputs.databoxedge.preview.AddressResponse>;
    /**
    ...
    constructor(name: string, args: OrderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:Order" }, { type: "azurerm:databoxedge/v20190301:Order" }, { type: "azurerm:databoxedge/v20190701:Order" }, { type: "azurerm:databoxedge/v20190801:Order" }, { type: "azurerm:databoxedge/v20200501preview:Order" }] };
...
export interface OrderArgs {
     ...
     * The contact details.
     */
    readonly contactInformation: pulumi.Input<inputs.databoxedge.preview.ContactDetails>;
    /**
     * Current status of the order.
     */
    readonly currentStatus?: pulumi.Input<inputs.databoxedge.preview.OrderStatus>;
    /**
     ...
     * The shipping address.
     */
    readonly shippingAddress: pulumi.Input<inputs.databoxedge.preview.Address>;
}
