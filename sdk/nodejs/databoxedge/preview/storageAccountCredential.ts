...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/preview:StorageAccountCredential';
     ...
     */
    public readonly accountKey!: pulumi.Output<outputs.databoxedge.preview.AsymmetricEncryptedSecretResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190301:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190701:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190801:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20200501preview:StorageAccountCredential" }] };
...
export interface StorageAccountCredentialArgs {
     ...
     * Encrypted storage key.
     */
    readonly accountKey?: pulumi.Input<inputs.databoxedge.preview.AsymmetricEncryptedSecret>;
    /**
     * Type of storage accessed on the storage account.
     */
