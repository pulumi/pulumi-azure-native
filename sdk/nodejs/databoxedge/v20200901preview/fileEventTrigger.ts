...
export class FileEventTrigger extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileEventTriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20200901preview:FileEventTrigger" }, { type: "azure-native:databoxedge:FileEventTrigger" }, { type: "azure-nextgen:databoxedge:FileEventTrigger" }, { type: "azure-native:databoxedge/v20190301:FileEventTrigger" }, { type: "azure-nextgen:databoxedge/v20190301:FileEventTrigger" }, { type: "azure-native:databoxedge/v20190701:FileEventTrigger" }, { type: "azure-nextgen:databoxedge/v20190701:FileEventTrigger" }, { type: "azure-native:databoxedge/v20190801:FileEventTrigger" }, { type: "azure-nextgen:databoxedge/v20190801:FileEventTrigger" }, { type: "azure-native:databoxedge/v20200501preview:FileEventTrigger" }, { type: "azure-nextgen:databoxedge/v20200501preview:FileEventTrigger" }, { type: "azure-native:databoxedge/v20200901:FileEventTrigger" }, { type: "azure-nextgen:databoxedge/v20200901:FileEventTrigger" }, { type: "azure-native:databoxedge/v20201201:FileEventTrigger" }, { type: "azure-nextgen:databoxedge/v20201201:FileEventTrigger" }, { type: "azure-native:databoxedge/v20210201preview:FileEventTrigger" }, { type: "azure-nextgen:databoxedge/v20210201preview:FileEventTrigger" }] };
...
export interface FileEventTriggerArgs {
     ...
     * A custom context tag typically used to correlate the trigger against its usage. For example, if a periodic timer trigger is intended for certain specific IoT modules in the device, the tag can be the name or the image URL of the module.
     */
    readonly customContextTag?: pulumi.Input<string>;
    /**
     ...
     * Expected value is 'FileEvent'.
     */
    readonly kind: pulumi.Input<"FileEvent">;
    /**
     * The trigger name.
     */
     ...
     * Role sink info.
     */
    readonly sinkInfo: pulumi.Input<inputs.databoxedge.v20200901preview.RoleSinkInfoArgs>;
    /**
     * File event source details.
     */
    readonly sourceInfo: pulumi.Input<inputs.databoxedge.v20200901preview.FileSourceInfoArgs>;
}
