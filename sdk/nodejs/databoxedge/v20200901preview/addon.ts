...
export class Addon extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:databoxedge/v20200901preview:Addon';
    ...
    constructor(name: string, args: AddonArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge:Addon" }, { type: "azure-nextgen:databoxedge/latest:Addon" }, { type: "azure-nextgen:databoxedge/v20200901:Addon" }] };
