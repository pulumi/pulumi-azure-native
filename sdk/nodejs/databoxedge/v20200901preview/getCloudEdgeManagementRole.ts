 ...
 */
/** @deprecated azure-native:databoxedge/v20200901preview:CloudEdgeManagementRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility. */
export function getCloudEdgeManagementRole(args: GetCloudEdgeManagementRoleArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudEdgeManagementRoleResult> {
    pulumi.log.warn("getCloudEdgeManagementRole is deprecated: azure-native:databoxedge/v20200901preview:CloudEdgeManagementRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility.")
