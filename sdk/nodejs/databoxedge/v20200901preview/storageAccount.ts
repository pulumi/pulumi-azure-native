...
export class StorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20200901preview:StorageAccount';
    ...
    constructor(name: string, args: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20200901preview:StorageAccount" }, { type: "azure-native:databoxedge:StorageAccount" }, { type: "azure-nextgen:databoxedge:StorageAccount" }, { type: "azure-native:databoxedge/latest:StorageAccount" }, { type: "azure-nextgen:databoxedge/latest:StorageAccount" }, { type: "azure-native:databoxedge/v20190801:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20190801:StorageAccount" }, { type: "azure-native:databoxedge/v20200501preview:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20200501preview:StorageAccount" }, { type: "azure-native:databoxedge/v20200901:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20200901:StorageAccount" }, { type: "azure-native:databoxedge/v20201201:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20201201:StorageAccount" }] };
...
export interface StorageAccountArgs {
     ...
     * Current status of the storage account
     */
    readonly storageAccountStatus?: pulumi.Input<string | enums.databoxedge.v20200901preview.StorageAccountStatus>;
}
