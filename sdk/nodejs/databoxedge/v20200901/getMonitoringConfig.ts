...
export function getMonitoringConfig(args: GetMonitoringConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetMonitoringConfigResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:databoxedge/v20200901:getMonitoringConfig", {
...
export interface GetMonitoringConfigResult {
     ...
     */
    readonly metricConfigurations: outputs.databoxedge.v20200901.MetricConfigurationInvokeResponse[];
    /**
     * The object name.
     */
