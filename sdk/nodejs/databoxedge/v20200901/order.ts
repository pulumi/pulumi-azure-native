...
export class Order extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:databoxedge/v20200901:Order';
     ...
     */
    public readonly currentStatus!: pulumi.Output<outputs.databoxedge.v20200901.OrderStatusResponse | undefined>;
    /**
    ...
    constructor(name: string, args: OrderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/latest:Order" }, { type: "azure-nextgen:databoxedge/v20190301:Order" }, { type: "azure-nextgen:databoxedge/v20190701:Order" }, { type: "azure-nextgen:databoxedge/v20190801:Order" }, { type: "azure-nextgen:databoxedge/v20200501preview:Order" }, { type: "azure-nextgen:databoxedge/v20200901preview:Order" }] };
...
export interface OrderArgs {
     ...
     * Current status of the order.
     */
    readonly currentStatus?: pulumi.Input<inputs.databoxedge.v20200901.OrderStatus>;
    /**
