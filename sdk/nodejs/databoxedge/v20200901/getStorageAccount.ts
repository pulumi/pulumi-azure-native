...
export function getStorageAccount(args: GetStorageAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageAccountResult> {
    pulumi.log.warn("getStorageAccount is deprecated: Version 2020-09-01 will be removed in v2 of the provider.")
...
export interface GetStorageAccountResult {
     ...
     */
    readonly properties: outputs.databoxedge.v20200901.StorageAccountPropertiesResponse;
    /**
