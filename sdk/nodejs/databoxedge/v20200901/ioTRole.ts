...
export interface IoTRoleArgs {
     ...
     * Resource allocation
     */
    readonly computeResource?: pulumi.Input<inputs.databoxedge.v20200901.ComputeResourceArgs>;
    /**
     * The device name.
     */
     ...
     * Host OS supported by the IoT role.
     */
    readonly hostPlatform: pulumi.Input<string | enums.databoxedge.v20200901.PlatformType>;
    /**
     * IoT device metadata to which data box edge device needs to be connected.
     */
     ...
     * Iot edge agent details to download the agent and bootstrap iot runtime.
     */
    readonly ioTEdgeAgentInfo?: pulumi.Input<inputs.databoxedge.v20200901.IoTEdgeAgentInfoArgs>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
     ...
     * Mount points of shares in role(s).
     */
    readonly shareMappings?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20200901.MountPointMapArgs>[]>;
}
