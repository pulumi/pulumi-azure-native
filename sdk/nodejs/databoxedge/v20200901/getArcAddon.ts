 ...
 */
/** @deprecated azure-native:databoxedge/v20200901:ArcAddon is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:ArcAddon to guarantee forwards compatibility. */
export function getArcAddon(args: GetArcAddonArgs, opts?: pulumi.InvokeOptions): Promise<GetArcAddonResult> {
    pulumi.log.warn("getArcAddon is deprecated: azure-native:databoxedge/v20200901:ArcAddon is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:ArcAddon to guarantee forwards compatibility.")
