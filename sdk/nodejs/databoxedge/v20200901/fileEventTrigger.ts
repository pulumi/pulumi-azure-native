 ...
 * Trigger details.
 *
 * @deprecated azure-native:databoxedge/v20200901:FileEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.
 */
export class FileEventTrigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FileEventTrigger {
        pulumi.log.warn("FileEventTrigger is deprecated: azure-native:databoxedge/v20200901:FileEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.")
     ...
     * Role sink info.
     */
    public readonly sinkInfo!: pulumi.Output<outputs.databoxedge.v20200901.RoleSinkInfoResponse>;
    /**
     * File event source details.
     */
    public readonly sourceInfo!: pulumi.Output<outputs.databoxedge.v20200901.FileSourceInfoResponse>;
    /**
...
export interface FileEventTriggerArgs {
     ...
     * Role sink info.
     */
    sinkInfo: pulumi.Input<inputs.databoxedge.v20200901.RoleSinkInfoArgs>;
    /**
     * File event source details.
     */
    sourceInfo: pulumi.Input<inputs.databoxedge.v20200901.FileSourceInfoArgs>;
}
