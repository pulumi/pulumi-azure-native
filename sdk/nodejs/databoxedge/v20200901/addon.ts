...
export class Addon extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Addon {
        pulumi.log.warn("Addon is deprecated: Version 2020-09-01 will be removed in v2 of the provider.")
    ...
    constructor(name: string, args: AddonArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databoxedge:Addon" }, { type: "azure-native:databoxedge/v20200901preview:Addon" }, { type: "azure-native:databoxedge/v20201201:Addon" }, { type: "azure-native:databoxedge/v20210201:Addon" }, { type: "azure-native:databoxedge/v20210201preview:Addon" }, { type: "azure-native:databoxedge/v20210601:Addon" }, { type: "azure-native:databoxedge/v20210601preview:Addon" }, { type: "azure-native:databoxedge/v20220301:Addon" }, { type: "azure-native:databoxedge/v20220401preview:Addon" }, { type: "azure-native:databoxedge/v20221201preview:Addon" }, { type: "azure-native:databoxedge/v20230101preview:Addon" }] };
