...
export class MECRole extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MECRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20200901:MECRole" }, { type: "azure-native:databoxedge:MECRole" }, { type: "azure-nextgen:databoxedge:MECRole" }, { type: "azure-native:databoxedge/v20190301:MECRole" }, { type: "azure-nextgen:databoxedge/v20190301:MECRole" }, { type: "azure-native:databoxedge/v20190701:MECRole" }, { type: "azure-nextgen:databoxedge/v20190701:MECRole" }, { type: "azure-native:databoxedge/v20190801:MECRole" }, { type: "azure-nextgen:databoxedge/v20190801:MECRole" }, { type: "azure-native:databoxedge/v20200501preview:MECRole" }, { type: "azure-nextgen:databoxedge/v20200501preview:MECRole" }, { type: "azure-native:databoxedge/v20200901preview:MECRole" }, { type: "azure-nextgen:databoxedge/v20200901preview:MECRole" }, { type: "azure-native:databoxedge/v20201201:MECRole" }, { type: "azure-nextgen:databoxedge/v20201201:MECRole" }, { type: "azure-native:databoxedge/v20210201preview:MECRole" }, { type: "azure-nextgen:databoxedge/v20210201preview:MECRole" }] };
...
export interface MECRoleArgs {
     ...
     * Activation key of the MEC.
     */
    readonly connectionString?: pulumi.Input<inputs.databoxedge.v20200901.AsymmetricEncryptedSecretArgs>;
    /**
     * The device name.
     */
