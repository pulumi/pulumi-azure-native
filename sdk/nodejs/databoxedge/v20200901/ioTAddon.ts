...
export class IoTAddon extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20200901:IoTAddon';
     ...
     */
    public readonly ioTDeviceDetails!: pulumi.Output<outputs.databoxedge.v20200901.IoTDeviceInfoResponse>;
    /**
     * IoT edge device to which the IoT Addon needs to be configured.
     */
    public readonly ioTEdgeDeviceDetails!: pulumi.Output<outputs.databoxedge.v20200901.IoTDeviceInfoResponse>;
    /**
     * Addon type.
    ...
    constructor(name: string, args: IoTAddonArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20200901:IoTAddon" }, { type: "azure-native:databoxedge:IoTAddon" }, { type: "azure-nextgen:databoxedge:IoTAddon" }, { type: "azure-native:databoxedge/v20200901preview:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20200901preview:IoTAddon" }, { type: "azure-native:databoxedge/v20201201:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20201201:IoTAddon" }, { type: "azure-native:databoxedge/v20210201:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20210201:IoTAddon" }, { type: "azure-native:databoxedge/v20210201preview:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20210201preview:IoTAddon" }, { type: "azure-native:databoxedge/v20210601:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20210601:IoTAddon" }, { type: "azure-native:databoxedge/v20210601preview:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20210601preview:IoTAddon" }] };
...
export interface IoTAddonArgs {
     ...
     * IoT device metadata to which appliance needs to be connected.
     */
    ioTDeviceDetails: pulumi.Input<inputs.databoxedge.v20200901.IoTDeviceInfoArgs>;
    /**
     * IoT edge device to which the IoT Addon needs to be configured.
     */
    ioTEdgeDeviceDetails: pulumi.Input<inputs.databoxedge.v20200901.IoTDeviceInfoArgs>;
    /**
     * Addon type.
     * Expected value is 'IotEdge'.
     */
