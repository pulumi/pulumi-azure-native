...
export class IoTAddon extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IoTAddonArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20200901:IoTAddon" }, { type: "azure-native:databoxedge:IoTAddon" }, { type: "azure-nextgen:databoxedge:IoTAddon" }, { type: "azure-native:databoxedge/v20200901preview:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20200901preview:IoTAddon" }, { type: "azure-native:databoxedge/v20201201:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20201201:IoTAddon" }, { type: "azure-native:databoxedge/v20210201preview:IoTAddon" }, { type: "azure-nextgen:databoxedge/v20210201preview:IoTAddon" }] };
...
export interface IoTAddonArgs {
     ...
     * IoT device metadata to which appliance needs to be connected.
     */
    readonly ioTDeviceDetails: pulumi.Input<inputs.databoxedge.v20200901.IoTDeviceInfoArgs>;
    /**
     * IoT edge device to which the IoT Addon needs to be configured.
     */
    readonly ioTEdgeDeviceDetails: pulumi.Input<inputs.databoxedge.v20200901.IoTDeviceInfoArgs>;
    /**
     * Addon type.
     * Expected value is 'IotEdge'.
     */
