...
export class StorageAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageAccount {
        pulumi.log.warn("StorageAccount is deprecated: azure-native:databoxedge/v20221201preview:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:StorageAccount to guarantee forwards compatibility.")
        return new StorageAccount(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20221201preview:StorageAccount';
...
export interface StorageAccountArgs {
     ...
     * Data policy of the storage Account.
     */
    dataPolicy: pulumi.Input<string | enums.databoxedge.v20221201preview.DataPolicy>;
    /**
     * Description for the storage Account.
     */
     ...
     * Current status of the storage account
     */
    storageAccountStatus?: pulumi.Input<string | enums.databoxedge.v20221201preview.StorageAccountStatus>;
}
