 ...
 *
 * @deprecated azure-native:databoxedge/v20221201preview:KubernetesRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:KubernetesRole to guarantee forwards compatibility.
 */
export class KubernetesRole extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KubernetesRole {
        pulumi.log.warn("KubernetesRole is deprecated: azure-native:databoxedge/v20221201preview:KubernetesRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:KubernetesRole to guarantee forwards compatibility.")
        return new KubernetesRole(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20221201preview:KubernetesRole';
     ...
     */
    public readonly kubernetesClusterInfo!: pulumi.Output<outputs.databoxedge.v20221201preview.KubernetesClusterInfoResponse>;
    /**
     * Kubernetes role resources
     */
    public readonly kubernetesRoleResources!: pulumi.Output<outputs.databoxedge.v20221201preview.KubernetesRoleResourcesResponse>;
    /**
     * The object name.
     */
...
export interface KubernetesRoleArgs {
     ...
     * Host OS supported by the Kubernetes role.
     */
    hostPlatform: pulumi.Input<string | enums.databoxedge.v20221201preview.PlatformType>;
    /**
     * Role type.
     * Expected value is 'Kubernetes'.
     */
     ...
     * Kubernetes cluster configuration
     */
    kubernetesClusterInfo: pulumi.Input<inputs.databoxedge.v20221201preview.KubernetesClusterInfoArgs>;
    /**
     * Kubernetes role resources
     */
    kubernetesRoleResources: pulumi.Input<inputs.databoxedge.v20221201preview.KubernetesRoleResourcesArgs>;
    /**
     * The role name.
     */
     ...
     * Role status.
     */
    roleStatus: pulumi.Input<string | enums.databoxedge.v20221201preview.RoleStatus>;
}
