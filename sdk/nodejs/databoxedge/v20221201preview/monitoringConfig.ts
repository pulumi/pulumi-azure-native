 ...
 *
 * @deprecated azure-native:databoxedge/v20221201preview:MonitoringConfig is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.
 */
export class MonitoringConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MonitoringConfig {
        pulumi.log.warn("MonitoringConfig is deprecated: azure-native:databoxedge/v20221201preview:MonitoringConfig is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.")
     ...
     */
    public readonly metricConfigurations!: pulumi.Output<outputs.databoxedge.v20221201preview.MetricConfigurationResponse[]>;
    /**
     * The object name.
     */
...
export interface MonitoringConfigArgs {
     ...
     * The metrics configuration details
     */
    metricConfigurations: pulumi.Input<pulumi.Input<inputs.databoxedge.v20221201preview.MetricConfigurationArgs>[]>;
    /**
