...
export class BandwidthSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20221201preview:BandwidthSchedule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.databoxedge.v20221201preview.BandwidthSchedulePropertiesResponse>;
    /**
...
export interface BandwidthScheduleArgs {
     ...
     * The properties of the bandwidth schedule.
     */
    properties: pulumi.Input<inputs.databoxedge.v20221201preview.BandwidthSchedulePropertiesArgs>;
    /**
