...
export interface GetMECRoleResult {
     ...
     */
    readonly connectionString?: outputs.databoxedge.v20221201preview.AsymmetricEncryptedSecretResponse;
    /**
     * Controller Endpoint.
     */
...
export function getMECRoleOutput(args: GetMECRoleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMECRoleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:databoxedge/v20221201preview:getMECRole", {
        "deviceName": args.deviceName,
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
