...
export function getKubernetesRole(args: GetKubernetesRoleArgs, opts?: pulumi.InvokeOptions): Promise<GetKubernetesRoleResult> {
    pulumi.log.warn("getKubernetesRole is deprecated: azure-native:databoxedge/v20221201preview:KubernetesRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:KubernetesRole to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:databoxedge/v20221201preview:getKubernetesRole", {
...
export interface GetKubernetesRoleResult {
     ...
     */
    readonly kubernetesClusterInfo: outputs.databoxedge.v20221201preview.KubernetesClusterInfoResponse;
    /**
     * Kubernetes role resources
     */
    readonly kubernetesRoleResources: outputs.databoxedge.v20221201preview.KubernetesRoleResourcesResponse;
    /**
     * The object name.
     */
