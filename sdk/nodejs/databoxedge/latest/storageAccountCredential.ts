 ...
 *
 * const storageAccountCredential = new azurerm.databoxedge.latest.StorageAccountCredential("storageAccountCredential", {
 *     accountKey: {
...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/latest:StorageAccountCredential';
    ...
    constructor(name: string, args: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/v20190301:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190701:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190801:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20200501preview:StorageAccountCredential" }] };
