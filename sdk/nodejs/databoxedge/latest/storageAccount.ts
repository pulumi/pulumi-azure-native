...
export class StorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/latest:StorageAccount';
    ...
    constructor(name: string, argsOrState?: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/preview:StorageAccount" }, { type: "azurerm:databoxedge/v20190801:StorageAccount" }, { type: "azurerm:databoxedge/v20200501preview:StorageAccount" }] };
