 ...
 *
 * const container = new azurerm.databoxedge.latest.Container("container", {
...
export class Container extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/latest:Container';
    ...
    constructor(name: string, argsOrState?: ContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/v20190801:Container" }, { type: "azurerm:databoxedge/v20200501preview:Container" }] };
