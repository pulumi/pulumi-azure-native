...
export class Container extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/preview:Container" }, { type: "azurerm:databoxedge/v20190801:Container" }, { type: "azurerm:databoxedge/v20200501preview:Container" }] };
