...
export class BandwidthSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: BandwidthScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/v20190301:BandwidthSchedule" }, { type: "azurerm:databoxedge/v20190701:BandwidthSchedule" }, { type: "azurerm:databoxedge/v20190801:BandwidthSchedule" }, { type: "azurerm:databoxedge/v20200501preview:BandwidthSchedule" }] };
