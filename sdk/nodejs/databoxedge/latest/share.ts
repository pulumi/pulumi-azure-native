...
export class Share extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/latest:Share';
    ...
    constructor(name: string, argsOrState?: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/preview:Share" }, { type: "azurerm:databoxedge/v20190301:Share" }, { type: "azurerm:databoxedge/v20190701:Share" }, { type: "azurerm:databoxedge/v20190801:Share" }, { type: "azurerm:databoxedge/v20200501preview:Share" }] };
