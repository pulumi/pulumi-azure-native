...
export class User extends pulumi.CustomResource {
     ...
     */
    public readonly encryptedPassword!: pulumi.Output<outputs.databoxedge.latest.AsymmetricEncryptedSecretResponse | undefined>;
    /**
     * The object name.
     */
    ...
    constructor(name: string, args: UserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if (!args || args.userType === undefined) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/preview:User" }, { type: "azurerm:databoxedge/v20190301:User" }, { type: "azurerm:databoxedge/v20190701:User" }, { type: "azurerm:databoxedge/v20190801:User" }, { type: "azurerm:databoxedge/v20200501preview:User" }] };
...
export interface UserArgs {
     ...
     * The password details.
     */
    readonly encryptedPassword?: pulumi.Input<inputs.databoxedge.latest.AsymmetricEncryptedSecret>;
    /**
     * The user name.
     */
