 ...
 * IoT Addon.
 *
 * @deprecated azure-native:databoxedge/v20210601preview:IoTAddon is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20220301:IoTAddon to guarantee forwards compatibility.
 */
export class IoTAddon extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IoTAddon {
        pulumi.log.warn("IoTAddon is deprecated: azure-native:databoxedge/v20210601preview:IoTAddon is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20220301:IoTAddon to guarantee forwards compatibility.")
