...
export class CloudEdgeManagementRole extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CloudEdgeManagementRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20190301:CloudEdgeManagementRole" }, { type: "azure-nextgen:databoxedge/v20190301:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20190701:CloudEdgeManagementRole" }, { type: "azure-nextgen:databoxedge/v20190701:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20190801:CloudEdgeManagementRole" }, { type: "azure-nextgen:databoxedge/v20190801:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20200501preview:CloudEdgeManagementRole" }, { type: "azure-nextgen:databoxedge/v20200501preview:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20200901:CloudEdgeManagementRole" }, { type: "azure-nextgen:databoxedge/v20200901:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20200901preview:CloudEdgeManagementRole" }, { type: "azure-nextgen:databoxedge/v20200901preview:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20201201:CloudEdgeManagementRole" }, { type: "azure-nextgen:databoxedge/v20201201:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20210201preview:CloudEdgeManagementRole" }, { type: "azure-nextgen:databoxedge/v20210201preview:CloudEdgeManagementRole" }] };
...
export interface CloudEdgeManagementRoleArgs {
     ...
     * Role status.
     */
    readonly roleStatus: pulumi.Input<string | enums.databoxedge.RoleStatus>;
}
