...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge:StorageAccountCredential';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.databoxedge.StorageAccountCredentialPropertiesResponse>;
    /**
...
export interface StorageAccountCredentialArgs {
     ...
     * The storage account credential properties.
     */
    readonly properties: pulumi.Input<inputs.databoxedge.StorageAccountCredentialProperties>;
    /**
