...
export class ArcAddon extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ArcAddonArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20201201:ArcAddon" }, { type: "azure-native:databoxedge:ArcAddon" }, { type: "azure-nextgen:databoxedge:ArcAddon" }, { type: "azure-native:databoxedge/v20200901:ArcAddon" }, { type: "azure-nextgen:databoxedge/v20200901:ArcAddon" }, { type: "azure-native:databoxedge/v20200901preview:ArcAddon" }, { type: "azure-nextgen:databoxedge/v20200901preview:ArcAddon" }, { type: "azure-native:databoxedge/v20210201preview:ArcAddon" }, { type: "azure-nextgen:databoxedge/v20210201preview:ArcAddon" }] };
