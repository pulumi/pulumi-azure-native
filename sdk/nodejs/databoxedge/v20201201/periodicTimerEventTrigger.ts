 ...
 * Trigger details.
 *
 * @deprecated azure-native:databoxedge/v20201201:PeriodicTimerEventTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger to guarantee forwards compatibility.
 */
export class PeriodicTimerEventTrigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PeriodicTimerEventTrigger {
        pulumi.log.warn("PeriodicTimerEventTrigger is deprecated: azure-native:databoxedge/v20201201:PeriodicTimerEventTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger to guarantee forwards compatibility.")
