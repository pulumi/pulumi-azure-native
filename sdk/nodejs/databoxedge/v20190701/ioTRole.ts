...
export interface IoTRoleArgs {
     ...
     * Host OS supported by the IoT role.
     */
    readonly hostPlatform: pulumi.Input<string | enums.databoxedge.v20190701.PlatformType>;
    /**
     * IoT device metadata to which data box edge device needs to be connected.
     */
    readonly ioTDeviceDetails: pulumi.Input<inputs.databoxedge.v20190701.IoTDeviceInfoArgs>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    readonly ioTEdgeDeviceDetails: pulumi.Input<inputs.databoxedge.v20190701.IoTDeviceInfoArgs>;
    /**
     * Role type.
     * Expected value is 'IOT'.
     */
     ...
     * Role status.
     */
    readonly roleStatus: pulumi.Input<string | enums.databoxedge.v20190701.RoleStatus>;
    /**
     * Mount points of shares in role(s).
     */
    readonly shareMappings?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20190701.MountPointMapArgs>[]>;
}
