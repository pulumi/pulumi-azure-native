...
export class BandwidthSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BandwidthScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:BandwidthSchedule" }, { type: "azurerm:databoxedge/preview:BandwidthSchedule" }, { type: "azurerm:databoxedge/v20190301:BandwidthSchedule" }, { type: "azurerm:databoxedge/v20190801:BandwidthSchedule" }, { type: "azurerm:databoxedge/v20200501preview:BandwidthSchedule" }] };
