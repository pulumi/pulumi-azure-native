...
export function getBandwidthSchedule(args: GetBandwidthScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetBandwidthScheduleResult> {
    pulumi.log.warn("getBandwidthSchedule is deprecated: Version 2019-07-01 will be removed in v2 of the provider.")
...
export interface GetBandwidthScheduleResult {
     ...
     */
    readonly properties: outputs.databoxedge.v20190701.BandwidthSchedulePropertiesResponse;
    /**
