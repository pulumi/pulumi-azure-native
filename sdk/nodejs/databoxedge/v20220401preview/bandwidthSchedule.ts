...
export class BandwidthSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20220401preview:BandwidthSchedule';
