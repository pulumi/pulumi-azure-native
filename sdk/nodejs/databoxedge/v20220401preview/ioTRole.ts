 ...
 * Compute role.
 *
 * @deprecated azure-native:databoxedge/v20220401preview:IoTRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.
 */
export class IoTRole extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IoTRole {
        pulumi.log.warn("IoTRole is deprecated: azure-native:databoxedge/v20220401preview:IoTRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.")
        return new IoTRole(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20220401preview:IoTRole';
     ...
     * Resource allocation
     */
    public readonly computeResource!: pulumi.Output<outputs.databoxedge.v20220401preview.ComputeResourceResponse | undefined>;
    /**
     ...
     */
    public readonly ioTDeviceDetails!: pulumi.Output<outputs.databoxedge.v20220401preview.IoTDeviceInfoResponse>;
    /**
     * Iot edge agent details to download the agent and bootstrap iot runtime.
     */
    public readonly ioTEdgeAgentInfo!: pulumi.Output<outputs.databoxedge.v20220401preview.IoTEdgeAgentInfoResponse | undefined>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    public readonly ioTEdgeDeviceDetails!: pulumi.Output<outputs.databoxedge.v20220401preview.IoTDeviceInfoResponse>;
    /**
     * Role type.
     ...
     */
    public readonly shareMappings!: pulumi.Output<outputs.databoxedge.v20220401preview.MountPointMapResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: IoTRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databoxedge:IoTRole" }, { type: "azure-native:databoxedge/v20190301:IoTRole" }, { type: "azure-native:databoxedge/v20190701:IoTRole" }, { type: "azure-native:databoxedge/v20190801:IoTRole" }, { type: "azure-native:databoxedge/v20200501preview:IoTRole" }, { type: "azure-native:databoxedge/v20200901:IoTRole" }, { type: "azure-native:databoxedge/v20200901preview:IoTRole" }, { type: "azure-native:databoxedge/v20201201:IoTRole" }, { type: "azure-native:databoxedge/v20210201:IoTRole" }, { type: "azure-native:databoxedge/v20210201preview:IoTRole" }, { type: "azure-native:databoxedge/v20210601:IoTRole" }, { type: "azure-native:databoxedge/v20210601preview:IoTRole" }, { type: "azure-native:databoxedge/v20220301:IoTRole" }, { type: "azure-native:databoxedge/v20221201preview:IoTRole" }, { type: "azure-native:databoxedge/v20230101preview:IoTRole" }] };
