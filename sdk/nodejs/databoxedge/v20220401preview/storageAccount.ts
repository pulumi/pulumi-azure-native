...
export class StorageAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageAccount {
        pulumi.log.warn("StorageAccount is deprecated: azure-native:databoxedge/v20220401preview:StorageAccount is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:StorageAccount to guarantee forwards compatibility.")
