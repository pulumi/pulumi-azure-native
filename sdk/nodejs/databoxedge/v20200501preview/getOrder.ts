...
export function getOrder(args: GetOrderArgs, opts?: pulumi.InvokeOptions): Promise<GetOrderResult> {
    pulumi.log.warn("getOrder is deprecated: Version v20200501preview will be removed in the next major version of the provider. Upgrade to version v20201201 or later.")
    if (!opts) {
        opts = {}
    }
