...
export function getContainer(args: GetContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerResult> {
    pulumi.log.warn("getContainer is deprecated: Version 2020-05-01-preview will be removed in v2 of the provider.")
...
export interface GetContainerResult {
     ...
     */
    readonly properties: outputs.databoxedge.v20200501preview.ContainerPropertiesResponse;
    /**
