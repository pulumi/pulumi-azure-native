...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/v20200501preview:StorageAccountCredential';
    ...
    constructor(name: string, argsOrState?: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:StorageAccountCredential" }, { type: "azurerm:databoxedge/preview:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190301:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190701:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190801:StorageAccountCredential" }] };
