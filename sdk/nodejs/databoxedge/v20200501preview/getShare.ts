...
export function getShare(args: GetShareArgs, opts?: pulumi.InvokeOptions): Promise<GetShareResult> {
    pulumi.log.warn("getShare is deprecated: Version 2020-05-01-preview will be removed in v2 of the provider.")
...
export interface GetShareResult {
     ...
     */
    readonly properties: outputs.databoxedge.v20200501preview.SharePropertiesResponse;
    /**
