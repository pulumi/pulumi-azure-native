...
export class IoTRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20200501preview:IoTRole';
     ...
     */
    public readonly ioTDeviceDetails!: pulumi.Output<outputs.databoxedge.v20200501preview.IoTDeviceInfoResponse>;
    /**
     * Iot edge agent details to download the agent and bootstrap iot runtime.
     */
    public readonly ioTEdgeAgentInfo!: pulumi.Output<outputs.databoxedge.v20200501preview.IoTEdgeAgentInfoResponse | undefined>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    public readonly ioTEdgeDeviceDetails!: pulumi.Output<outputs.databoxedge.v20200501preview.IoTDeviceInfoResponse>;
    /**
     * Role type.
     ...
     */
    public readonly shareMappings!: pulumi.Output<outputs.databoxedge.v20200501preview.MountPointMapResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: IoTRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20200501preview:IoTRole" }, { type: "azure-native:databoxedge:IoTRole" }, { type: "azure-nextgen:databoxedge:IoTRole" }, { type: "azure-native:databoxedge/v20190301:IoTRole" }, { type: "azure-nextgen:databoxedge/v20190301:IoTRole" }, { type: "azure-native:databoxedge/v20190701:IoTRole" }, { type: "azure-nextgen:databoxedge/v20190701:IoTRole" }, { type: "azure-native:databoxedge/v20190801:IoTRole" }, { type: "azure-nextgen:databoxedge/v20190801:IoTRole" }, { type: "azure-native:databoxedge/v20200901:IoTRole" }, { type: "azure-nextgen:databoxedge/v20200901:IoTRole" }, { type: "azure-native:databoxedge/v20200901preview:IoTRole" }, { type: "azure-nextgen:databoxedge/v20200901preview:IoTRole" }, { type: "azure-native:databoxedge/v20201201:IoTRole" }, { type: "azure-nextgen:databoxedge/v20201201:IoTRole" }, { type: "azure-native:databoxedge/v20210201:IoTRole" }, { type: "azure-nextgen:databoxedge/v20210201:IoTRole" }, { type: "azure-native:databoxedge/v20210201preview:IoTRole" }, { type: "azure-nextgen:databoxedge/v20210201preview:IoTRole" }, { type: "azure-native:databoxedge/v20210601:IoTRole" }, { type: "azure-nextgen:databoxedge/v20210601:IoTRole" }, { type: "azure-native:databoxedge/v20210601preview:IoTRole" }, { type: "azure-nextgen:databoxedge/v20210601preview:IoTRole" }] };
