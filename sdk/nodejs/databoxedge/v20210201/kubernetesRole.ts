...
export class KubernetesRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20210201:KubernetesRole';
     ...
     */
    public readonly kubernetesClusterInfo!: pulumi.Output<outputs.databoxedge.v20210201.KubernetesClusterInfoResponse>;
    /**
     * Kubernetes role resources
     */
    public readonly kubernetesRoleResources!: pulumi.Output<outputs.databoxedge.v20210201.KubernetesRoleResourcesResponse>;
    /**
     * The object name.
     */
    ...
    constructor(name: string, args: KubernetesRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20210201:KubernetesRole" }, { type: "azure-native:databoxedge:KubernetesRole" }, { type: "azure-nextgen:databoxedge:KubernetesRole" }, { type: "azure-native:databoxedge/v20190301:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20190301:KubernetesRole" }, { type: "azure-native:databoxedge/v20190701:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20190701:KubernetesRole" }, { type: "azure-native:databoxedge/v20190801:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20190801:KubernetesRole" }, { type: "azure-native:databoxedge/v20200501preview:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20200501preview:KubernetesRole" }, { type: "azure-native:databoxedge/v20200901:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20200901:KubernetesRole" }, { type: "azure-native:databoxedge/v20200901preview:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20200901preview:KubernetesRole" }, { type: "azure-native:databoxedge/v20201201:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20201201:KubernetesRole" }, { type: "azure-native:databoxedge/v20210201preview:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20210201preview:KubernetesRole" }, { type: "azure-native:databoxedge/v20210601:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20210601:KubernetesRole" }, { type: "azure-native:databoxedge/v20210601preview:KubernetesRole" }, { type: "azure-nextgen:databoxedge/v20210601preview:KubernetesRole" }] };
...
export interface KubernetesRoleArgs {
     ...
     * Host OS supported by the Kubernetes role.
     */
    hostPlatform: pulumi.Input<string | enums.databoxedge.v20210201.PlatformType>;
    /**
     * Role type.
     * Expected value is 'Kubernetes'.
     */
     ...
     * Kubernetes cluster configuration
     */
    kubernetesClusterInfo: pulumi.Input<inputs.databoxedge.v20210201.KubernetesClusterInfoArgs>;
    /**
     * Kubernetes role resources
     */
    kubernetesRoleResources: pulumi.Input<inputs.databoxedge.v20210201.KubernetesRoleResourcesArgs>;
    /**
     * The role name.
     */
     ...
     * Role status.
     */
    roleStatus: pulumi.Input<string | enums.databoxedge.v20210201.RoleStatus>;
}
