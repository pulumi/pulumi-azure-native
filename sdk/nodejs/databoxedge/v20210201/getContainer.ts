 ...
 */
/** @deprecated azure-native:databoxedge/v20210201:Container is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility. */
export function getContainer(args: GetContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerResult> {
    pulumi.log.warn("getContainer is deprecated: azure-native:databoxedge/v20210201:Container is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.")
