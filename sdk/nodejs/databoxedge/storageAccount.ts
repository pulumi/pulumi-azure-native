...
export class StorageAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge:StorageAccount" }, { type: "azure-native:databoxedge/latest:StorageAccount" }, { type: "azure-nextgen:databoxedge/latest:StorageAccount" }, { type: "azure-native:databoxedge/v20190801:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20190801:StorageAccount" }, { type: "azure-native:databoxedge/v20200501preview:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20200501preview:StorageAccount" }, { type: "azure-native:databoxedge/v20200901:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20200901:StorageAccount" }, { type: "azure-native:databoxedge/v20200901preview:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20200901preview:StorageAccount" }, { type: "azure-native:databoxedge/v20201201:StorageAccount" }, { type: "azure-nextgen:databoxedge/v20201201:StorageAccount" }] };
...
export interface StorageAccountArgs {
     ...
     * Data policy of the storage Account.
     */
    readonly dataPolicy: pulumi.Input<string | enums.databoxedge.DataPolicy>;
    /**
     * Description for the storage Account.
     */
     ...
     * Current status of the storage account
     */
    readonly storageAccountStatus?: pulumi.Input<string | enums.databoxedge.StorageAccountStatus>;
}
