...
export interface GetKubernetesRoleResult {
     ...
     */
    readonly kubernetesClusterInfo: outputs.databoxedge.v20230101preview.KubernetesClusterInfoResponse;
    /**
     * Kubernetes role resources
     */
    readonly kubernetesRoleResources: outputs.databoxedge.v20230101preview.KubernetesRoleResourcesResponse;
    /**
     * The object name.
     */
...
export function getKubernetesRoleOutput(args: GetKubernetesRoleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetKubernetesRoleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:databoxedge/v20230101preview:getKubernetesRole", {
        "deviceName": args.deviceName,
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
