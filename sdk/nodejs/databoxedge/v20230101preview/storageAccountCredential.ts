...
export class StorageAccountCredential extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.databoxedge.v20230101preview.StorageAccountCredentialPropertiesResponse>;
    /**
...
export interface StorageAccountCredentialArgs {
     ...
     * The storage account credential properties.
     */
    properties: pulumi.Input<inputs.databoxedge.v20230101preview.StorageAccountCredentialPropertiesArgs>;
    /**
