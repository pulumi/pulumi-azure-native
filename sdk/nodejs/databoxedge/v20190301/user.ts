...
export class User extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: UserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:User" }, { type: "azurerm:databoxedge/v20190701:User" }, { type: "azurerm:databoxedge/v20190801:User" }, { type: "azurerm:databoxedge/v20200501preview:User" }] };
