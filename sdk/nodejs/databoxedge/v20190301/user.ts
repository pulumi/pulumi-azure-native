...
export class User extends pulumi.CustomResource {
    ...
    constructor(name: string, args: UserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge:User" }, { type: "azure-nextgen:databoxedge/latest:User" }, { type: "azure-nextgen:databoxedge/v20190701:User" }, { type: "azure-nextgen:databoxedge/v20190801:User" }, { type: "azure-nextgen:databoxedge/v20200501preview:User" }, { type: "azure-nextgen:databoxedge/v20200901:User" }, { type: "azure-nextgen:databoxedge/v20200901preview:User" }] };
