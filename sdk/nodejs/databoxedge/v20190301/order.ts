...
export class Order extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:databoxedge/v20190301:Order';
    ...
    constructor(name: string, args: OrderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge:Order" }, { type: "azure-nextgen:databoxedge/latest:Order" }, { type: "azure-nextgen:databoxedge/v20190701:Order" }, { type: "azure-nextgen:databoxedge/v20190801:Order" }, { type: "azure-nextgen:databoxedge/v20200501preview:Order" }, { type: "azure-nextgen:databoxedge/v20200901:Order" }, { type: "azure-nextgen:databoxedge/v20200901preview:Order" }] };
