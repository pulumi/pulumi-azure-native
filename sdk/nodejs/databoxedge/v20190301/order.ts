...
export class Order extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/v20190301:Order';
    ...
    constructor(name: string, args: OrderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:Order" }, { type: "azurerm:databoxedge/preview:Order" }, { type: "azurerm:databoxedge/v20190701:Order" }, { type: "azurerm:databoxedge/v20190801:Order" }, { type: "azurerm:databoxedge/v20200501preview:Order" }] };
