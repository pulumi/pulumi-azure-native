...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190701:StorageAccountCredential" }, { type: "azurerm:databoxedge/v20190801:StorageAccountCredential" }] };
