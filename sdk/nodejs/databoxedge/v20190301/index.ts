...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:databoxedge/v20190301:BandwidthSchedule":
                return new BandwidthSchedule(name, <any>undefined, { urn })
            case "azure-nextgen:databoxedge/v20190301:Device":
                return new Device(name, <any>undefined, { urn })
            case "azure-nextgen:databoxedge/v20190301:Order":
                return new Order(name, <any>undefined, { urn })
            case "azure-nextgen:databoxedge/v20190301:Role":
                return new Role(name, <any>undefined, { urn })
            case "azure-nextgen:databoxedge/v20190301:Share":
                return new Share(name, <any>undefined, { urn })
            case "azure-nextgen:databoxedge/v20190301:StorageAccountCredential":
                return new StorageAccountCredential(name, <any>undefined, { urn })
            case "azure-nextgen:databoxedge/v20190301:Trigger":
                return new Trigger(name, <any>undefined, { urn })
            case "azure-nextgen:databoxedge/v20190301:User":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "databoxedge/v20190301", _module)
