...
export class Order extends pulumi.CustomResource {
     ...
     * The contact details.
     */
    public readonly contactInformation!: pulumi.Output<outputs.databoxedge.ContactDetailsResponse>;
    /**
     * Current status of the order.
     */
    public /*out*/ readonly currentStatus!: pulumi.Output<outputs.databoxedge.OrderStatusResponse>;
    /**
     ...
     */
    public /*out*/ readonly returnTrackingInfo!: pulumi.Output<outputs.databoxedge.TrackingInfoResponse[]>;
    /**
    ...
    constructor(name: string, args: OrderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge:Order" }, { type: "azure-native:databoxedge/v20190301:Order" }, { type: "azure-nextgen:databoxedge/v20190301:Order" }, { type: "azure-native:databoxedge/v20190701:Order" }, { type: "azure-nextgen:databoxedge/v20190701:Order" }, { type: "azure-native:databoxedge/v20190801:Order" }, { type: "azure-nextgen:databoxedge/v20190801:Order" }, { type: "azure-native:databoxedge/v20200501preview:Order" }, { type: "azure-nextgen:databoxedge/v20200501preview:Order" }, { type: "azure-native:databoxedge/v20200901:Order" }, { type: "azure-nextgen:databoxedge/v20200901:Order" }, { type: "azure-native:databoxedge/v20200901preview:Order" }, { type: "azure-nextgen:databoxedge/v20200901preview:Order" }, { type: "azure-native:databoxedge/v20201201:Order" }, { type: "azure-nextgen:databoxedge/v20201201:Order" }, { type: "azure-native:databoxedge/v20210201:Order" }, { type: "azure-nextgen:databoxedge/v20210201:Order" }, { type: "azure-native:databoxedge/v20210201preview:Order" }, { type: "azure-nextgen:databoxedge/v20210201preview:Order" }, { type: "azure-native:databoxedge/v20210601:Order" }, { type: "azure-nextgen:databoxedge/v20210601:Order" }, { type: "azure-native:databoxedge/v20210601preview:Order" }, { type: "azure-nextgen:databoxedge/v20210601preview:Order" }] };
