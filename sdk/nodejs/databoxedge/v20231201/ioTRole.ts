...
export class IoTRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20231201:IoTRole';
     ...
     * Resource allocation
     */
    public readonly computeResource!: pulumi.Output<outputs.databoxedge.v20231201.ComputeResourceResponse | undefined>;
    /**
     ...
     */
    public readonly ioTDeviceDetails!: pulumi.Output<outputs.databoxedge.v20231201.IoTDeviceInfoResponse>;
    /**
     * Iot edge agent details to download the agent and bootstrap iot runtime.
     */
    public readonly ioTEdgeAgentInfo!: pulumi.Output<outputs.databoxedge.v20231201.IoTEdgeAgentInfoResponse | undefined>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    public readonly ioTEdgeDeviceDetails!: pulumi.Output<outputs.databoxedge.v20231201.IoTDeviceInfoResponse>;
    /**
     * Role type.
     ...
     */
    public readonly shareMappings!: pulumi.Output<outputs.databoxedge.v20231201.MountPointMapResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: IoTRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databoxedge/v20190301:IoTRole" }, { type: "azure-native:databoxedge/v20190701:IoTRole" }, { type: "azure-native:databoxedge/v20190801:IoTRole" }, { type: "azure-native:databoxedge/v20200501preview:IoTRole" }, { type: "azure-native:databoxedge/v20200901:IoTRole" }, { type: "azure-native:databoxedge/v20200901preview:IoTRole" }, { type: "azure-native:databoxedge/v20201201:IoTRole" }, { type: "azure-native:databoxedge/v20210201:IoTRole" }, { type: "azure-native:databoxedge/v20210201preview:IoTRole" }, { type: "azure-native:databoxedge/v20210601:IoTRole" }, { type: "azure-native:databoxedge/v20210601preview:IoTRole" }, { type: "azure-native:databoxedge/v20220301:IoTRole" }, { type: "azure-native:databoxedge/v20220401preview:IoTRole" }, { type: "azure-native:databoxedge/v20221201preview:IoTRole" }, { type: "azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20230101preview:IoTRole" }, { type: "azure-native:databoxedge/v20230101preview:KubernetesRole" }, { type: "azure-native:databoxedge/v20230101preview:MECRole" }, { type: "azure-native:databoxedge/v20230701:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20230701:IoTRole" }, { type: "azure-native:databoxedge/v20230701:KubernetesRole" }, { type: "azure-native:databoxedge/v20230701:MECRole" }, { type: "azure-native:databoxedge/v20231201:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge/v20231201:KubernetesRole" }, { type: "azure-native:databoxedge/v20231201:MECRole" }, { type: "azure-native:databoxedge:CloudEdgeManagementRole" }, { type: "azure-native:databoxedge:IoTRole" }, { type: "azure-native:databoxedge:KubernetesRole" }, { type: "azure-native:databoxedge:MECRole" }] };
...
export interface IoTRoleArgs {
     ...
     * Resource allocation
     */
    computeResource?: pulumi.Input<inputs.databoxedge.v20231201.ComputeResourceArgs>;
    /**
     * The device name.
     */
     ...
     * Host OS supported by the IoT role.
     */
    hostPlatform: pulumi.Input<string | enums.databoxedge.v20231201.PlatformType>;
    /**
     * IoT device metadata to which data box edge device needs to be connected.
     */
    ioTDeviceDetails: pulumi.Input<inputs.databoxedge.v20231201.IoTDeviceInfoArgs>;
    /**
     * Iot edge agent details to download the agent and bootstrap iot runtime.
     */
    ioTEdgeAgentInfo?: pulumi.Input<inputs.databoxedge.v20231201.IoTEdgeAgentInfoArgs>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    ioTEdgeDeviceDetails: pulumi.Input<inputs.databoxedge.v20231201.IoTDeviceInfoArgs>;
    /**
     * Role type.
     * Expected value is 'IOT'.
     */
     ...
     * Role status.
     */
    roleStatus: pulumi.Input<string | enums.databoxedge.v20231201.RoleStatus>;
    /**
     * Mount points of shares in role(s).
     */
    shareMappings?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20231201.MountPointMapArgs>[]>;
}
