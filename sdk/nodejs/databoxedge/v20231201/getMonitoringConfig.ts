...
export interface GetMonitoringConfigResult {
     ...
     */
    readonly metricConfigurations: outputs.databoxedge.v20231201.MetricConfigurationResponse[];
    /**
     * The object name.
     */
...
export function getMonitoringConfigOutput(args: GetMonitoringConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMonitoringConfigResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:databoxedge/v20231201:getMonitoringConfig", {
        "deviceName": args.deviceName,
        "resourceGroupName": args.resourceGroupName,
        "roleName": args.roleName,
    }, opts);
