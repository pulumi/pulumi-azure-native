...
export class PeriodicTimerEventTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20220301:PeriodicTimerEventTrigger';
     ...
     */
    public readonly sourceInfo!: pulumi.Output<outputs.databoxedge.v20220301.PeriodicTimerSourceInfoResponse>;
    /**
    ...
    constructor(name: string, args: PeriodicTimerEventTriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databoxedge:PeriodicTimerEventTrigger" }, { type: "azure-native:databoxedge/v20201201:PeriodicTimerEventTrigger" }, { type: "azure-native:databoxedge/v20210201:PeriodicTimerEventTrigger" }, { type: "azure-native:databoxedge/v20210201preview:PeriodicTimerEventTrigger" }, { type: "azure-native:databoxedge/v20210601:PeriodicTimerEventTrigger" }, { type: "azure-native:databoxedge/v20210601preview:PeriodicTimerEventTrigger" }, { type: "azure-native:databoxedge/v20220401preview:PeriodicTimerEventTrigger" }] };
