...
export class Share extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge:Share" }, { type: "azure-native:databoxedge/v20190301:Share" }, { type: "azure-nextgen:databoxedge/v20190301:Share" }, { type: "azure-native:databoxedge/v20190701:Share" }, { type: "azure-nextgen:databoxedge/v20190701:Share" }, { type: "azure-native:databoxedge/v20190801:Share" }, { type: "azure-nextgen:databoxedge/v20190801:Share" }, { type: "azure-native:databoxedge/v20200501preview:Share" }, { type: "azure-nextgen:databoxedge/v20200501preview:Share" }, { type: "azure-native:databoxedge/v20200901:Share" }, { type: "azure-nextgen:databoxedge/v20200901:Share" }, { type: "azure-native:databoxedge/v20200901preview:Share" }, { type: "azure-nextgen:databoxedge/v20200901preview:Share" }, { type: "azure-native:databoxedge/v20201201:Share" }, { type: "azure-nextgen:databoxedge/v20201201:Share" }, { type: "azure-native:databoxedge/v20210201preview:Share" }, { type: "azure-nextgen:databoxedge/v20210201preview:Share" }] };
...
export interface ShareArgs {
     ...
     * Access protocol to be used by the share.
     */
    readonly accessProtocol: pulumi.Input<string | enums.databoxedge.ShareAccessProtocol>;
    /**
     * Azure container mapping for the share.
     */
    readonly azureContainerInfo?: pulumi.Input<inputs.databoxedge.AzureContainerInfoArgs>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    readonly clientAccessRights?: pulumi.Input<pulumi.Input<inputs.databoxedge.ClientAccessRightArgs>[]>;
    /**
     * Data policy of the share.
     */
     ...
     * Current monitoring status of the share.
     */
    readonly monitoringStatus: pulumi.Input<string | enums.databoxedge.MonitoringStatus>;
    /**
     * The share name.
     */
     ...
     * Details of the refresh job on this share.
     */
    readonly refreshDetails?: pulumi.Input<inputs.databoxedge.RefreshDetailsArgs>;
    /**
     ...
     * Current status of the share.
     */
    readonly shareStatus: pulumi.Input<string | enums.databoxedge.ShareStatus>;
    /**
     * Mapping of users and corresponding access rights on the share (required for SMB protocol).
     */
    readonly userAccessRights?: pulumi.Input<pulumi.Input<inputs.databoxedge.UserAccessRightArgs>[]>;
}
