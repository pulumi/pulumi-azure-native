 ...
 * Trigger details.
 *
 * @deprecated azure-native:databoxedge/v20210601:FileEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.
 */
export class FileEventTrigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FileEventTrigger {
        pulumi.log.warn("FileEventTrigger is deprecated: azure-native:databoxedge/v20210601:FileEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.")
        return new FileEventTrigger(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20210601:FileEventTrigger';
     ...
     * Role sink info.
     */
    public readonly sinkInfo!: pulumi.Output<outputs.databoxedge.v20210601.RoleSinkInfoResponse>;
    /**
     * File event source details.
     */
    public readonly sourceInfo!: pulumi.Output<outputs.databoxedge.v20210601.FileSourceInfoResponse>;
    /**
