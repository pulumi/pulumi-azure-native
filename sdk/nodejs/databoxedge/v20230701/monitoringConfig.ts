...
export class MonitoringConfig extends pulumi.CustomResource {
     ...
     */
    public readonly metricConfigurations!: pulumi.Output<outputs.databoxedge.v20230701.MetricConfigurationResponse[]>;
    /**
     * The object name.
     */
    ...
    constructor(name: string, args: MonitoringConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databoxedge/v20200901:MonitoringConfig" }, { type: "azure-native:databoxedge/v20200901preview:MonitoringConfig" }, { type: "azure-native:databoxedge/v20201201:MonitoringConfig" }, { type: "azure-native:databoxedge/v20210201:MonitoringConfig" }, { type: "azure-native:databoxedge/v20210201preview:MonitoringConfig" }, { type: "azure-native:databoxedge/v20210601:MonitoringConfig" }, { type: "azure-native:databoxedge/v20210601preview:MonitoringConfig" }, { type: "azure-native:databoxedge/v20220301:MonitoringConfig" }, { type: "azure-native:databoxedge/v20220401preview:MonitoringConfig" }, { type: "azure-native:databoxedge/v20221201preview:MonitoringConfig" }, { type: "azure-native:databoxedge/v20230101preview:MonitoringConfig" }, { type: "azure-native:databoxedge/v20231201:MonitoringConfig" }, { type: "azure-native:databoxedge:MonitoringConfig" }] };
...
export interface MonitoringConfigArgs {
     ...
     * The metrics configuration details
     */
    metricConfigurations: pulumi.Input<pulumi.Input<inputs.databoxedge.v20230701.MetricConfigurationArgs>[]>;
    /**
