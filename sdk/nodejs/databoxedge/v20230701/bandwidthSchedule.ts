...
export class BandwidthSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20230701:BandwidthSchedule';
...
export interface BandwidthScheduleArgs {
     ...
     * The days of the week when this schedule is applicable.
     */
    days: pulumi.Input<pulumi.Input<string | enums.databoxedge.v20230701.DayOfWeek>[]>;
    /**
     * The device name.
     */
