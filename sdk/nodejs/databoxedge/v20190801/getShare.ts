...
export function getShare(args: GetShareArgs, opts?: pulumi.InvokeOptions): Promise<GetShareResult> {
    pulumi.log.warn("getShare is deprecated: Version 2019-08-01 will be removed in v2 of the provider.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:databoxedge/v20190801:getShare", {
...
export interface GetShareResult {
     ...
     */
    readonly properties: outputs.databoxedge.v20190801.SharePropertiesResponse;
    /**
