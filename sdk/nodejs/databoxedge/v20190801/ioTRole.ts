...
export class IoTRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20190801:IoTRole';
     ...
     */
    public readonly ioTDeviceDetails!: pulumi.Output<outputs.databoxedge.v20190801.IoTDeviceInfoResponse>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    public readonly ioTEdgeDeviceDetails!: pulumi.Output<outputs.databoxedge.v20190801.IoTDeviceInfoResponse>;
    /**
     * Role type.
     ...
     */
    public readonly shareMappings!: pulumi.Output<outputs.databoxedge.v20190801.MountPointMapResponse[] | undefined>;
    /**
...
export interface IoTRoleArgs {
     ...
     * Host OS supported by the IoT role.
     */
    readonly hostPlatform: pulumi.Input<string | enums.databoxedge.v20190801.PlatformType>;
    /**
     * IoT device metadata to which data box edge device needs to be connected.
     */
    readonly ioTDeviceDetails: pulumi.Input<inputs.databoxedge.v20190801.IoTDeviceInfoArgs>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    readonly ioTEdgeDeviceDetails: pulumi.Input<inputs.databoxedge.v20190801.IoTDeviceInfoArgs>;
    /**
     * Role type.
     * Expected value is 'IOT'.
     */
     ...
     * Role status.
     */
    readonly roleStatus: pulumi.Input<string | enums.databoxedge.v20190801.RoleStatus>;
    /**
     * Mount points of shares in role(s).
     */
    readonly shareMappings?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20190801.MountPointMapArgs>[]>;
}
