...
export class StorageAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:StorageAccount" }, { type: "azurerm:databoxedge/preview:StorageAccount" }, { type: "azurerm:databoxedge/v20200501preview:StorageAccount" }] };
