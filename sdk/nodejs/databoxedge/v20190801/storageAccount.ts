 ...
 *
 * const storageAccount = new azurerm.databoxedge.v20190801.StorageAccount("storageAccount", {
 *     dataPolicy: "Cloud",
...
export class StorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/v20190801:StorageAccount';
    ...
    constructor(name: string, argsOrState?: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:StorageAccount" }, { type: "azurerm:databoxedge/v20200501preview:StorageAccount" }] };
