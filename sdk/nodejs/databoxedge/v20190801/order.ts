...
export class Order extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OrderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:Order" }, { type: "azurerm:databoxedge/v20190301:Order" }, { type: "azurerm:databoxedge/v20190701:Order" }, { type: "azurerm:databoxedge/v20200501preview:Order" }] };
