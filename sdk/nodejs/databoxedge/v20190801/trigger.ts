...
export class Trigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/v20190801:Trigger';
    ...
    constructor(name: string, args: TriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:Trigger" }, { type: "azurerm:databoxedge/preview:Trigger" }, { type: "azurerm:databoxedge/v20190301:Trigger" }, { type: "azurerm:databoxedge/v20190701:Trigger" }, { type: "azurerm:databoxedge/v20200501preview:Trigger" }] };
