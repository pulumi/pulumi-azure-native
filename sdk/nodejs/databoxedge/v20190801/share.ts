 ...
 *
 * const share = new azurerm.databoxedge.v20190801.Share("share", {
 *     accessProtocol: "SMB",
 *     azureContainerInfo: {
...
export class Share extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/v20190801:Share';
    ...
    constructor(name: string, argsOrState?: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:Share" }, { type: "azurerm:databoxedge/v20190301:Share" }, { type: "azurerm:databoxedge/v20190701:Share" }, { type: "azurerm:databoxedge/v20200501preview:Share" }] };
