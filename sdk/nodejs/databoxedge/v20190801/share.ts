...
export class Share extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20190801:Share';
     ...
     */
    public readonly azureContainerInfo!: pulumi.Output<outputs.databoxedge.v20190801.AzureContainerInfoResponse | undefined>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    public readonly clientAccessRights!: pulumi.Output<outputs.databoxedge.v20190801.ClientAccessRightResponse[] | undefined>;
    /**
     ...
     */
    public readonly refreshDetails!: pulumi.Output<outputs.databoxedge.v20190801.RefreshDetailsResponse | undefined>;
    /**
     * Share mount point to the role.
     */
    public /*out*/ readonly shareMappings!: pulumi.Output<outputs.databoxedge.v20190801.MountPointMapResponse[]>;
    /**
     ...
     */
    public readonly userAccessRights!: pulumi.Output<outputs.databoxedge.v20190801.UserAccessRightResponse[] | undefined>;
    ...
    constructor(name: string, args: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databoxedge/v20190801:Share" }, { type: "azure-native:databoxedge:Share" }, { type: "azure-nextgen:databoxedge:Share" }, { type: "azure-native:databoxedge/v20190301:Share" }, { type: "azure-nextgen:databoxedge/v20190301:Share" }, { type: "azure-native:databoxedge/v20190701:Share" }, { type: "azure-nextgen:databoxedge/v20190701:Share" }, { type: "azure-native:databoxedge/v20200501preview:Share" }, { type: "azure-nextgen:databoxedge/v20200501preview:Share" }, { type: "azure-native:databoxedge/v20200901:Share" }, { type: "azure-nextgen:databoxedge/v20200901:Share" }, { type: "azure-native:databoxedge/v20200901preview:Share" }, { type: "azure-nextgen:databoxedge/v20200901preview:Share" }, { type: "azure-native:databoxedge/v20201201:Share" }, { type: "azure-nextgen:databoxedge/v20201201:Share" }, { type: "azure-native:databoxedge/v20210201preview:Share" }, { type: "azure-nextgen:databoxedge/v20210201preview:Share" }] };
...
export interface ShareArgs {
     ...
     * Azure container mapping for the share.
     */
    readonly azureContainerInfo?: pulumi.Input<inputs.databoxedge.v20190801.AzureContainerInfoArgs>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    readonly clientAccessRights?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20190801.ClientAccessRightArgs>[]>;
    /**
     * Data policy of the share.
     */
     ...
     * Details of the refresh job on this share.
     */
    readonly refreshDetails?: pulumi.Input<inputs.databoxedge.v20190801.RefreshDetailsArgs>;
    /**
     ...
     * Mapping of users and corresponding access rights on the share (required for SMB protocol).
     */
    readonly userAccessRights?: pulumi.Input<pulumi.Input<inputs.databoxedge.v20190801.UserAccessRightArgs>[]>;
}
