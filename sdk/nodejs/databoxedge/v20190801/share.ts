...
export class Share extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:Share" }, { type: "azurerm:databoxedge/preview:Share" }, { type: "azurerm:databoxedge/v20190301:Share" }, { type: "azurerm:databoxedge/v20190701:Share" }, { type: "azurerm:databoxedge/v20200501preview:Share" }] };
