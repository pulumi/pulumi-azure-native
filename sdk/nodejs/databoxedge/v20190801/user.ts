 ...
 *
 * const user = new azurerm.databoxedge.v20190801.User("user", {
...
export class User extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:databoxedge/v20190801:User';
    ...
    constructor(name: string, argsOrState?: UserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:databoxedge/latest:User" }, { type: "azurerm:databoxedge/v20190301:User" }, { type: "azurerm:databoxedge/v20190701:User" }] };
