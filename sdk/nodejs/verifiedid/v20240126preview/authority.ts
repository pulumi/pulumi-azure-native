...
export class Authority extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:verifiedid/v20240126preview:Authority';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.verifiedid.v20240126preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: AuthorityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:verifiedid:Authority" }] };
