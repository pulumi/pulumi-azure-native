...
// Export enums:
export * from "../../types/enums/purview/v20240401preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:purview/v20240401preview:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:purview/v20240401preview:KafkaConfiguration":
                return new KafkaConfiguration(name, <any>undefined, { urn })
            case "azure-native:purview/v20240401preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "purview/v20240401preview", _module)
