...
export class KafkaConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:purview/v20240401preview:KafkaConfiguration';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.purview.v20240401preview.CredentialsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.purview.v20240401preview.ProxyResourceResponseSystemData>;
    /**
    ...
    constructor(name: string, args: KafkaConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:purview/v20211201:KafkaConfiguration" }, { type: "azure-native:purview/v20230501preview:KafkaConfiguration" }, { type: "azure-native:purview:KafkaConfiguration" }] };
...
export interface KafkaConfigurationArgs {
     ...
     * Credentials to access the event streaming service attached to the purview account.
     */
    credentials?: pulumi.Input<inputs.purview.v20240401preview.CredentialsArgs>;
    /**
     * Optional partition Id for notification event hub. If not set, all partitions will be leveraged.
     */
     ...
     * The event hub type.
     */
    eventHubType?: pulumi.Input<string | enums.purview.v20240401preview.EventHubType>;
    /**
     * The state of the event streaming service
     */
    eventStreamingState?: pulumi.Input<string | enums.purview.v20240401preview.EventStreamingState>;
    /**
     * The event streaming service type
     */
    eventStreamingType?: pulumi.Input<string | enums.purview.v20240401preview.EventStreamingType>;
    /**
