...
export class KafkaConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.purview.v20230501preview.CredentialsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.purview.v20230501preview.ProxyResourceResponseSystemData>;
    /**
    ...
    constructor(name: string, args: KafkaConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:purview:KafkaConfiguration" }, { type: "azure-native:purview/v20211201:KafkaConfiguration" }, { type: "azure-native:purview/v20240401preview:KafkaConfiguration" }] };
...
export interface KafkaConfigurationArgs {
     ...
     * Credentials to access the event streaming service attached to the purview account.
     */
    credentials?: pulumi.Input<inputs.purview.v20230501preview.CredentialsArgs>;
    /**
     * Optional partition Id for notification event hub. If not set, all partitions will be leveraged.
     */
     ...
     * The event hub type.
     */
    eventHubType?: pulumi.Input<string | enums.purview.v20230501preview.EventHubType>;
    /**
     * The state of the event streaming service
     */
    eventStreamingState?: pulumi.Input<string | enums.purview.v20230501preview.EventStreamingState>;
    /**
     * The event streaming service type
     */
    eventStreamingType?: pulumi.Input<string | enums.purview.v20230501preview.EventStreamingType>;
    /**
