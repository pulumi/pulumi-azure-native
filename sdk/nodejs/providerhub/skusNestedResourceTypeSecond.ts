...
export class SkusNestedResourceTypeSecond extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:providerhub:SkusNestedResourceTypeSecond';
    ...
    constructor(name: string, args: SkusNestedResourceTypeSecondArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/latest:SkusNestedResourceTypeSecond" }, { type: "azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeSecond" }] };
