...
export class ResourceTypeRegistration extends pulumi.CustomResource {
    ...
    public readonly properties!: pulumi.Output<outputs.providerhub.ResourceTypeRegistrationResponseProperties>;
    /**
    ...
    constructor(name: string, args: ResourceTypeRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub:ResourceTypeRegistration" }, { type: "azure-native:providerhub/v20201120:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub/v20201120:ResourceTypeRegistration" }, { type: "azure-native:providerhub/v20210501preview:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub/v20210501preview:ResourceTypeRegistration" }, { type: "azure-native:providerhub/v20210601preview:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub/v20210601preview:ResourceTypeRegistration" }, { type: "azure-native:providerhub/v20210901preview:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub/v20210901preview:ResourceTypeRegistration" }] };
