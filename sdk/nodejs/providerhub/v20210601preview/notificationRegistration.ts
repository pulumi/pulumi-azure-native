...
export class NotificationRegistration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:providerhub/v20210601preview:NotificationRegistration';
    ...
    public readonly properties!: pulumi.Output<outputs.providerhub.v20210601preview.NotificationRegistrationResponseProperties>;
    /**
    ...
    constructor(name: string, args: NotificationRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:providerhub:NotificationRegistration" }, { type: "azure-native:providerhub/v20201120:NotificationRegistration" }, { type: "azure-native:providerhub/v20210501preview:NotificationRegistration" }, { type: "azure-native:providerhub/v20210901preview:NotificationRegistration" }] };
