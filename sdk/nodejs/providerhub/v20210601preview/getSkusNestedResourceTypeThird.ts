...
export function getSkusNestedResourceTypeThird(args: GetSkusNestedResourceTypeThirdArgs, opts?: pulumi.InvokeOptions): Promise<GetSkusNestedResourceTypeThirdResult> {
    pulumi.log.warn("getSkusNestedResourceTypeThird is deprecated: azure-native:providerhub/v20210601preview:SkusNestedResourceTypeThird is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird to guarantee forwards compatibility.")
