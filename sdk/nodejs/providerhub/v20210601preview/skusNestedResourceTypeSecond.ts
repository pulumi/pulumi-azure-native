...
export class SkusNestedResourceTypeSecond extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:providerhub/v20210601preview:SkusNestedResourceTypeSecond';
    ...
    constructor(name: string, args: SkusNestedResourceTypeSecondArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/v20210601preview:SkusNestedResourceTypeSecond" }, { type: "azure-native:providerhub:SkusNestedResourceTypeSecond" }, { type: "azure-nextgen:providerhub:SkusNestedResourceTypeSecond" }, { type: "azure-native:providerhub/v20201120:SkusNestedResourceTypeSecond" }, { type: "azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeSecond" }, { type: "azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond" }, { type: "azure-nextgen:providerhub/v20210501preview:SkusNestedResourceTypeSecond" }, { type: "azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond" }, { type: "azure-nextgen:providerhub/v20210901preview:SkusNestedResourceTypeSecond" }] };
