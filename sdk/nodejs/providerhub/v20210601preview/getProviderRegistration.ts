 ...
 */
/** @deprecated azure-native:providerhub/v20210601preview:ProviderRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:ProviderRegistration to guarantee forwards compatibility. */
export function getProviderRegistration(args: GetProviderRegistrationArgs, opts?: pulumi.InvokeOptions): Promise<GetProviderRegistrationResult> {
    pulumi.log.warn("getProviderRegistration is deprecated: azure-native:providerhub/v20210601preview:ProviderRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:ProviderRegistration to guarantee forwards compatibility.")
