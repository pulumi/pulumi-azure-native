...
export class SkusNestedResourceTypeThird extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:providerhub/latest:SkusNestedResourceTypeThird';
    ...
    constructor(name: string, args: SkusNestedResourceTypeThirdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/latest:SkusNestedResourceTypeThird" }, { type: "azure-native:providerhub:SkusNestedResourceTypeThird" }, { type: "azure-nextgen:providerhub:SkusNestedResourceTypeThird" }, { type: "azure-native:providerhub/v20201120:SkusNestedResourceTypeThird" }, { type: "azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeThird" }] };
