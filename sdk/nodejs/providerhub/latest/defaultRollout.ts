...
export class DefaultRollout extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.providerhub.latest.DefaultRolloutResponseProperties>;
    /**
    ...
    constructor(name: string, args: DefaultRolloutArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/latest:DefaultRollout" }, { type: "azure-native:providerhub:DefaultRollout" }, { type: "azure-nextgen:providerhub:DefaultRollout" }, { type: "azure-native:providerhub/v20201120:DefaultRollout" }, { type: "azure-nextgen:providerhub/v20201120:DefaultRollout" }] };
...
export interface DefaultRolloutArgs {
     ...
     * Properties of the rollout.
     */
    readonly properties?: pulumi.Input<inputs.providerhub.latest.DefaultRolloutProperties>;
    /**
