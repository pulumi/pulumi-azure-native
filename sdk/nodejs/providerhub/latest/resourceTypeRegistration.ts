 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:ResourceTypeRegistration'.
 */
export class ResourceTypeRegistration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceTypeRegistration {
        pulumi.log.warn("ResourceTypeRegistration is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:ResourceTypeRegistration'.")
        return new ResourceTypeRegistration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:providerhub/latest:ResourceTypeRegistration';
    ...
    public readonly properties!: pulumi.Output<outputs.providerhub.latest.ResourceTypeRegistrationResponseProperties>;
    /**
    ...
    constructor(name: string, args: ResourceTypeRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/latest:ResourceTypeRegistration" }, { type: "azure-native:providerhub:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub:ResourceTypeRegistration" }, { type: "azure-native:providerhub/v20201120:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub/v20201120:ResourceTypeRegistration" }] };
...
export interface ResourceTypeRegistrationArgs {
    readonly properties?: pulumi.Input<inputs.providerhub.latest.ResourceTypeRegistrationProperties>;
    /**
