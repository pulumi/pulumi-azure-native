...
export class OperationByProviderRegistration extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly display!: pulumi.Output<outputs.providerhub.v20210501preview.OperationsDefinitionResponseDisplay>;
    /**
    ...
    constructor(name: string, args: OperationByProviderRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/v20210501preview:OperationByProviderRegistration" }, { type: "azure-native:providerhub:OperationByProviderRegistration" }, { type: "azure-nextgen:providerhub:OperationByProviderRegistration" }, { type: "azure-native:providerhub/v20201120:OperationByProviderRegistration" }, { type: "azure-nextgen:providerhub/v20201120:OperationByProviderRegistration" }, { type: "azure-native:providerhub/v20210601preview:OperationByProviderRegistration" }, { type: "azure-nextgen:providerhub/v20210601preview:OperationByProviderRegistration" }, { type: "azure-native:providerhub/v20210901preview:OperationByProviderRegistration" }, { type: "azure-nextgen:providerhub/v20210901preview:OperationByProviderRegistration" }] };
...
export interface OperationByProviderRegistrationArgs {
    contents: pulumi.Input<pulumi.Input<inputs.providerhub.v20210501preview.OperationsDefinitionArgs>[]>;
    /**
