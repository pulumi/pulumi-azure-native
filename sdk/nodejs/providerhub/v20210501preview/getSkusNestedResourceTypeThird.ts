 ...
 */
/** @deprecated azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird to guarantee forwards compatibility. */
export function getSkusNestedResourceTypeThird(args: GetSkusNestedResourceTypeThirdArgs, opts?: pulumi.InvokeOptions): Promise<GetSkusNestedResourceTypeThirdResult> {
    pulumi.log.warn("getSkusNestedResourceTypeThird is deprecated: azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird to guarantee forwards compatibility.")
