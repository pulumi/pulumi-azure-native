...
export class ResourceTypeRegistration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:providerhub/v20210501preview:ResourceTypeRegistration';
    ...
    public readonly properties!: pulumi.Output<outputs.providerhub.v20210501preview.ResourceTypeRegistrationResponseProperties>;
    /**
    ...
    constructor(name: string, args: ResourceTypeRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/v20210501preview:ResourceTypeRegistration" }, { type: "azure-native:providerhub:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub:ResourceTypeRegistration" }, { type: "azure-native:providerhub/v20201120:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub/v20201120:ResourceTypeRegistration" }, { type: "azure-native:providerhub/v20210601preview:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub/v20210601preview:ResourceTypeRegistration" }, { type: "azure-native:providerhub/v20210901preview:ResourceTypeRegistration" }, { type: "azure-nextgen:providerhub/v20210901preview:ResourceTypeRegistration" }] };
