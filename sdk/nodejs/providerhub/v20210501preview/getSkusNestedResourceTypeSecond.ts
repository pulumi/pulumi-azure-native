 ...
 */
/** @deprecated azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond to guarantee forwards compatibility. */
export function getSkusNestedResourceTypeSecond(args: GetSkusNestedResourceTypeSecondArgs, opts?: pulumi.InvokeOptions): Promise<GetSkusNestedResourceTypeSecondResult> {
    pulumi.log.warn("getSkusNestedResourceTypeSecond is deprecated: azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond to guarantee forwards compatibility.")
