...
export class SkusNestedResourceTypeFirst extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:providerhub:SkusNestedResourceTypeFirst';
    ...
    constructor(name: string, args: SkusNestedResourceTypeFirstArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/latest:SkusNestedResourceTypeFirst" }, { type: "azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeFirst" }] };
