 ...
 *
 * const skusNestedResourceTypeThird = new azure_native.providerhub.v20201120.SkusNestedResourceTypeThird("skusNestedResourceTypeThird", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:providerhub/v20201120:SkusNestedResourceTypeThird Microsoft.Contoso/ /subscriptions/ab7a8701-f7ef-471a-a2f4-d0ebbf494f77providers/Microsoft.ProviderHub/providerRegistrations/Microsoft.Contoso/ 
 * ```
 */
export class SkusNestedResourceTypeThird extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:providerhub/v20201120:SkusNestedResourceTypeThird';
    ...
    constructor(name: string, args: SkusNestedResourceTypeThirdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:providerhub:SkusNestedResourceTypeThird" }, { type: "azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird" }, { type: "azure-native:providerhub/v20210601preview:SkusNestedResourceTypeThird" }, { type: "azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird" }] };
