...
export class SkusNestedResourceTypeThird extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SkusNestedResourceTypeThirdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeThird" }, { type: "azure-native:providerhub:SkusNestedResourceTypeThird" }, { type: "azure-nextgen:providerhub:SkusNestedResourceTypeThird" }, { type: "azure-native:providerhub/latest:SkusNestedResourceTypeThird" }, { type: "azure-nextgen:providerhub/latest:SkusNestedResourceTypeThird" }] };
