...
export class NotificationRegistration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotificationRegistration {
        pulumi.log.warn("NotificationRegistration is deprecated: azure-native:providerhub/v20201120:NotificationRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:NotificationRegistration to guarantee forwards compatibility.")
    ...
    public readonly properties!: pulumi.Output<outputs.providerhub.v20201120.NotificationRegistrationResponseProperties>;
    /**
    ...
    constructor(name: string, args: NotificationRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:providerhub:NotificationRegistration" }, { type: "azure-native:providerhub/v20210501preview:NotificationRegistration" }, { type: "azure-native:providerhub/v20210601preview:NotificationRegistration" }, { type: "azure-native:providerhub/v20210901preview:NotificationRegistration" }] };
...
export interface NotificationRegistrationArgs {
    ...
    properties?: pulumi.Input<inputs.providerhub.v20201120.NotificationRegistrationPropertiesArgs>;
    /**
