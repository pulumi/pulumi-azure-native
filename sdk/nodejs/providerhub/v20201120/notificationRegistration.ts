...
export class NotificationRegistration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NotificationRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/v20201120:NotificationRegistration" }, { type: "azure-native:providerhub:NotificationRegistration" }, { type: "azure-nextgen:providerhub:NotificationRegistration" }, { type: "azure-native:providerhub/v20210501preview:NotificationRegistration" }, { type: "azure-nextgen:providerhub/v20210501preview:NotificationRegistration" }] };
...
export interface NotificationRegistrationArgs {
    ...
    readonly properties?: pulumi.Input<inputs.providerhub.v20201120.NotificationRegistrationPropertiesArgs>;
    /**
