...
export class ProviderRegistration extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: ProviderRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/v20201120:ProviderRegistration" }, { type: "azure-native:providerhub:ProviderRegistration" }, { type: "azure-nextgen:providerhub:ProviderRegistration" }] };
...
export interface ProviderRegistrationArgs {
    readonly properties?: pulumi.Input<inputs.providerhub.v20201120.ProviderRegistrationProperties>;
    /**
