 ...
 */
/** @deprecated azure-native:providerhub/v20201120:Skus is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:Skus to guarantee forwards compatibility. */
export function getSkus(args: GetSkusArgs, opts?: pulumi.InvokeOptions): Promise<GetSkusResult> {
    pulumi.log.warn("getSkus is deprecated: azure-native:providerhub/v20201120:Skus is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:Skus to guarantee forwards compatibility.")
