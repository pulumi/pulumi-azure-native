 ...
 *
 * const skusNestedResourceTypeSecond = new azure_native.providerhub.v20201120.SkusNestedResourceTypeSecond("skusNestedResourceTypeSecond", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:providerhub/v20201120:SkusNestedResourceTypeSecond Microsoft.Contoso/ /subscriptions/ab7a8701-f7ef-471a-a2f4-d0ebbf494f77providers/Microsoft.ProviderHub/providerRegistrations/Microsoft.Contoso/ 
 * ```
 */
export class SkusNestedResourceTypeSecond extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SkusNestedResourceTypeSecondArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:providerhub:SkusNestedResourceTypeSecond" }, { type: "azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond" }, { type: "azure-native:providerhub/v20210601preview:SkusNestedResourceTypeSecond" }, { type: "azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond" }] };
