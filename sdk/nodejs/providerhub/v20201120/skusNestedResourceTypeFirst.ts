...
export class SkusNestedResourceTypeFirst extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SkusNestedResourceTypeFirst {
        pulumi.log.warn("SkusNestedResourceTypeFirst is deprecated: azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:SkusNestedResourceTypeFirst to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: SkusNestedResourceTypeFirstArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:providerhub:SkusNestedResourceTypeFirst" }, { type: "azure-native:providerhub/v20210501preview:SkusNestedResourceTypeFirst" }, { type: "azure-native:providerhub/v20210601preview:SkusNestedResourceTypeFirst" }, { type: "azure-native:providerhub/v20210901preview:SkusNestedResourceTypeFirst" }] };
