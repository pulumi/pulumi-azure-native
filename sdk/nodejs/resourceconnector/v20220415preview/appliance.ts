...
export class Appliance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Appliance {
        pulumi.log.warn("Appliance is deprecated: azure-native:resourceconnector/v20220415preview:Appliance is being removed in the next major version of this provider. Please upgrade to azure-native:resourceconnector/v20221027:Appliance to guarantee forwards compatibility.")
        return new Appliance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:resourceconnector/v20220415preview:Appliance';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.resourceconnector.v20220415preview.IdentityResponse | undefined>;
    /**
     * Contains infrastructure information about the Appliance
     */
    public readonly infrastructureConfig!: pulumi.Output<outputs.resourceconnector.v20220415preview.AppliancePropertiesResponseInfrastructureConfig | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.resourceconnector.v20220415preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resourceconnector:Appliance" }, { type: "azure-native:resourceconnector/v20211031preview:Appliance" }, { type: "azure-native:resourceconnector/v20221027:Appliance" }] };
...
export interface ApplianceArgs {
     ...
     * Represents a supported Fabric/Infra. (AKSEdge etc...).
     */
    distro?: pulumi.Input<string | enums.resourceconnector.v20220415preview.Distro>;
    /**
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.resourceconnector.v20220415preview.IdentityArgs>;
    /**
     * Contains infrastructure information about the Appliance
     */
    infrastructureConfig?: pulumi.Input<inputs.resourceconnector.v20220415preview.AppliancePropertiesInfrastructureConfigArgs>;
    /**
     * The geo-location where the resource lives
     */
