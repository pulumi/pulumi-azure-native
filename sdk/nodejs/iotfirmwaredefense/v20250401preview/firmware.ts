...
export class Firmware extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotfirmwaredefense/v20250401preview:Firmware';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.iotfirmwaredefense.v20250401preview.FirmwarePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FirmwareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotfirmwaredefense/v20230208preview:Firmware" }, { type: "azure-native:iotfirmwaredefense/v20240110:Firmware" }, { type: "azure-native:iotfirmwaredefense:Firmware" }] };
...
export interface FirmwareArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.iotfirmwaredefense.v20250401preview.FirmwarePropertiesArgs>;
    /**
