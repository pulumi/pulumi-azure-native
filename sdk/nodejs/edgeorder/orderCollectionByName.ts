...
export class OrderCollectionByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edgeorder:OrderCollectionByName';
    ...
    constructor(name: string, args: OrderCollectionByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if ((!args || args.orderIds === undefined) && !opts.urn) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:edgeorder:OrderCollectionByName" }, { type: "azure-native:edgeorder/v20201201preview:OrderCollectionByName" }, { type: "azure-nextgen:edgeorder/v20201201preview:OrderCollectionByName" }] };
