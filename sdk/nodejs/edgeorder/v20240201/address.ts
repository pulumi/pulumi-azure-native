...
export class Address extends pulumi.CustomResource {
     ...
     */
    public readonly contactDetails!: pulumi.Output<outputs.edgeorder.v20240201.ContactDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly shippingAddress!: pulumi.Output<outputs.edgeorder.v20240201.ShippingAddressResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AddressArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edgeorder/v20201201preview:Address" }, { type: "azure-native:edgeorder/v20211201:Address" }, { type: "azure-native:edgeorder/v20220501preview:Address" }, { type: "azure-native:edgeorder:Address" }] };
...
export interface AddressArgs {
     ...
     * Type of address based on its usage context.
     */
    addressClassification?: pulumi.Input<string | enums.edgeorder.v20240201.AddressClassification>;
    /**
     ...
     * Contact details for the address.
     */
    contactDetails?: pulumi.Input<inputs.edgeorder.v20240201.ContactDetailsArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Shipping details for the address.
     */
    shippingAddress?: pulumi.Input<inputs.edgeorder.v20240201.ShippingAddressArgs>;
    /**
     * Resource tags.
     */
