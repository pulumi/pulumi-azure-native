...
export class OrderByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edgeorder/v20201201preview:OrderByName';
    ...
    constructor(name: string, args: OrderByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:edgeorder/v20201201preview:OrderByName" }, { type: "azure-native:edgeorder:OrderByName" }, { type: "azure-nextgen:edgeorder:OrderByName" }] };
