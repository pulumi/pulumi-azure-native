...
export class OrderItemByName extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OrderItemByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:edgeorder/v20201201preview:OrderItemByName" }, { type: "azure-native:edgeorder:OrderItemByName" }, { type: "azure-nextgen:edgeorder:OrderItemByName" }] };
...
export interface OrderItemByNameArgs {
     ...
     * Represents shipping and return address for order
     */
    readonly addressDetails: pulumi.Input<inputs.edgeorder.v20201201preview.AddressDetailsArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Represents order item details.
     */
    readonly orderItemDetails: pulumi.Input<inputs.edgeorder.v20201201preview.OrderItemDetailsArgs>;
    /**
