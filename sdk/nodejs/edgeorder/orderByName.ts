...
export class OrderByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edgeorder:OrderByName';
     ...
     */
    public readonly orderDetails!: pulumi.Output<outputs.edgeorder.OrderDetailsResponse>;
    /**
     * Start time of order
     */
    ...
    constructor(name: string, args: OrderByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:edgeorder:OrderByName" }, { type: "azure-native:edgeorder/v20201201preview:OrderByName" }, { type: "azure-nextgen:edgeorder/v20201201preview:OrderByName" }] };
...
export interface OrderByNameArgs {
     ...
     * Represents order details.
     */
    readonly orderDetails: pulumi.Input<inputs.edgeorder.OrderDetails>;
    /**
