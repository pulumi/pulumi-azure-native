...
export class SecretValue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabricmesh/preview:SecretValue';
    ...
    constructor(name: string, argsOrState?: SecretValueArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SecretValueArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicefabricmesh/v20180901preview:SecretValue" }] };
