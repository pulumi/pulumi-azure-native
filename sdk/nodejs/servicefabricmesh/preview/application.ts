...
export class Application extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabricmesh/preview:Application';
     ...
     */
    public readonly diagnostics!: pulumi.Output<outputs.servicefabricmesh.preview.DiagnosticsDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly services!: pulumi.Output<outputs.servicefabricmesh.preview.ServiceResourceDescriptionResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicefabricmesh/v20180701preview:Application" }, { type: "azurerm:servicefabricmesh/v20180901preview:Application" }] };
...
export interface ApplicationArgs {
     ...
     * Describes the diagnostics definition and usage for an application resource.
     */
    readonly diagnostics?: pulumi.Input<inputs.servicefabricmesh.preview.DiagnosticsDescription>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Describes the services in the application. This property is used to create or modify services of the application. On get only the name of the service is returned. The service description can be obtained by querying for the service resource.
     */
    readonly services?: pulumi.Input<pulumi.Input<inputs.servicefabricmesh.preview.ServiceResourceDescription>[]>;
    /**
     * Resource tags.
     */
