 ...
 *
 * const application = new azurerm.servicefabricmesh.v20180701preview.Application("application", {
...
export class Application extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabricmesh/v20180701preview:Application';
    ...
    constructor(name: string, args: ApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicefabricmesh/v20180901preview:Application" }] };
