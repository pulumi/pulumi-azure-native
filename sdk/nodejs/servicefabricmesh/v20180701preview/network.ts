...
export class Network extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabricmesh/v20180701preview:Network';
    ...
    constructor(name: string, args: NetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabricmesh/v20180701preview:Network" }, { type: "azure-native:servicefabricmesh:Network" }, { type: "azure-nextgen:servicefabricmesh:Network" }, { type: "azure-native:servicefabricmesh/v20180901preview:Network" }, { type: "azure-nextgen:servicefabricmesh/v20180901preview:Network" }] };
