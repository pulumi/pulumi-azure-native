...
export class Enrollment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Enrollment {
        return new Enrollment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:azureresiliencemanagement:Enrollment';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.azureresiliencemanagement.EnrollmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EnrollmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureresiliencemanagement/v20260301preview:Enrollment" }, { type: "azure-native:azureresiliencemanagement/v20260401preview:Enrollment" }, { type: "azure-native:azureresiliencemanagement/v20260601preview:Enrollment" }] };
