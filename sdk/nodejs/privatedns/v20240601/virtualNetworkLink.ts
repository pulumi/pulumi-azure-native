...
export class VirtualNetworkLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:privatedns/v20240601:VirtualNetworkLink';
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.privatedns.v20240601.SubResourceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20240601:VirtualNetworkLink" }, { type: "azure-native:privatedns:VirtualNetworkLink" }, { type: "azure-native:network:VirtualNetworkLink" }, { type: "azure-native:privatedns/v20180901:VirtualNetworkLink" }, { type: "azure-native:network/v20180901:VirtualNetworkLink" }, { type: "azure-native:privatedns/v20200101:VirtualNetworkLink" }, { type: "azure-native:network/v20200101:VirtualNetworkLink" }, { type: "azure-native:privatedns/v20200601:VirtualNetworkLink" }, { type: "azure-native:network/v20200601:VirtualNetworkLink" }] };
...
export interface VirtualNetworkLinkArgs {
     ...
     * The resolution policy on the virtual network link. Only applicable for virtual network links to privatelink zones, and for A,AAAA,CNAME queries. When set to 'NxDomainRedirect', Azure DNS resolver falls back to public resolution if private dns query resolution results in non-existent domain response.
     */
    resolutionPolicy?: pulumi.Input<string | enums.privatedns.v20240601.ResolutionPolicy>;
    /**
     ...
     * The reference of the virtual network.
     */
    virtualNetwork?: pulumi.Input<inputs.privatedns.v20240601.SubResourceArgs>;
    /**
