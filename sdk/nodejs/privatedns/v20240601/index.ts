...
// Export enums:
export * from "../../types/enums/privatedns/v20240601";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:privatedns/v20240601:PrivateRecordSet":
                return new PrivateRecordSet(name, <any>undefined, { urn })
            case "azure-native:privatedns/v20240601:PrivateZone":
                return new PrivateZone(name, <any>undefined, { urn })
            case "azure-native:privatedns/v20240601:VirtualNetworkLink":
...
pulumi.runtime.registerResourceModule("azure-native", "privatedns/v20240601", _module)
