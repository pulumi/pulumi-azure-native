...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:privatedns/v20200601:PrivateRecordSet":
                return new PrivateRecordSet(name, <any>undefined, { urn })
            case "azure-native:privatedns/v20200601:PrivateZone":
                return new PrivateZone(name, <any>undefined, { urn })
            case "azure-native:privatedns/v20200601:VirtualNetworkLink":
...
pulumi.runtime.registerResourceModule("azure-native", "privatedns/v20200601", _module)
