...
export class PrivateRecordSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:privatedns/v20180901:PrivateRecordSet';
     ...
     */
    public readonly aRecords!: pulumi.Output<outputs.privatedns.v20180901.ARecordResponse[] | undefined>;
    /**
     * The list of AAAA records in the record set.
     */
    public readonly aaaaRecords!: pulumi.Output<outputs.privatedns.v20180901.AaaaRecordResponse[] | undefined>;
    /**
     * The CNAME record in the record set.
     */
    public readonly cnameRecord!: pulumi.Output<outputs.privatedns.v20180901.CnameRecordResponse | undefined>;
    /**
     ...
     */
    public readonly mxRecords!: pulumi.Output<outputs.privatedns.v20180901.MxRecordResponse[] | undefined>;
    /**
     ...
     */
    public readonly ptrRecords!: pulumi.Output<outputs.privatedns.v20180901.PtrRecordResponse[] | undefined>;
    /**
     * The SOA record in the record set.
     */
    public readonly soaRecord!: pulumi.Output<outputs.privatedns.v20180901.SoaRecordResponse | undefined>;
    /**
     * The list of SRV records in the record set.
     */
    public readonly srvRecords!: pulumi.Output<outputs.privatedns.v20180901.SrvRecordResponse[] | undefined>;
    /**
     ...
     */
    public readonly txtRecords!: pulumi.Output<outputs.privatedns.v20180901.TxtRecordResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateRecordSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20180901:PrivateRecordSet" }, { type: "azure-native:privatedns:PrivateRecordSet" }, { type: "azure-native:network:PrivateRecordSet" }, { type: "azure-native:privatedns/v20200101:PrivateRecordSet" }, { type: "azure-native:network/v20200101:PrivateRecordSet" }, { type: "azure-native:privatedns/v20200601:PrivateRecordSet" }, { type: "azure-native:network/v20200601:PrivateRecordSet" }, { type: "azure-native:privatedns/v20240601:PrivateRecordSet" }, { type: "azure-native:network/v20240601:PrivateRecordSet" }] };
...
export interface PrivateRecordSetArgs {
     ...
     * The list of A records in the record set.
     */
    aRecords?: pulumi.Input<pulumi.Input<inputs.privatedns.v20180901.ARecordArgs>[]>;
    /**
     * The list of AAAA records in the record set.
     */
    aaaaRecords?: pulumi.Input<pulumi.Input<inputs.privatedns.v20180901.AaaaRecordArgs>[]>;
    /**
     * The CNAME record in the record set.
     */
    cnameRecord?: pulumi.Input<inputs.privatedns.v20180901.CnameRecordArgs>;
    /**
     * The metadata attached to the record set.
     */
     ...
     * The list of MX records in the record set.
     */
    mxRecords?: pulumi.Input<pulumi.Input<inputs.privatedns.v20180901.MxRecordArgs>[]>;
    /**
     ...
     * The list of PTR records in the record set.
     */
    ptrRecords?: pulumi.Input<pulumi.Input<inputs.privatedns.v20180901.PtrRecordArgs>[]>;
    /**
     ...
     * The SOA record in the record set.
     */
    soaRecord?: pulumi.Input<inputs.privatedns.v20180901.SoaRecordArgs>;
    /**
     * The list of SRV records in the record set.
     */
    srvRecords?: pulumi.Input<pulumi.Input<inputs.privatedns.v20180901.SrvRecordArgs>[]>;
    /**
     * The TTL (time-to-live) of the records in the record set.
     */
     ...
     * The list of TXT records in the record set.
     */
    txtRecords?: pulumi.Input<pulumi.Input<inputs.privatedns.v20180901.TxtRecordArgs>[]>;
}
