...
export class PrivateStoreOffer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:marketplace/latest:PrivateStoreOffer';
    ...
    constructor(name: string, args: PrivateStoreOfferArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:marketplace/preview:PrivateStoreOffer" }, { type: "azurerm:marketplace/v20200101:PrivateStoreOffer" }] };
