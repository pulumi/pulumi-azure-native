...
export class PrivateStoreOffer extends pulumi.CustomResource {
     ...
     * Offer plans
     */
    public readonly plans!: pulumi.Output<outputs.marketplace.latest.PlanResponse[] | undefined>;
    /**
...
export interface PrivateStoreOfferArgs {
     ...
     * Offer plans
     */
    readonly plans?: pulumi.Input<pulumi.Input<inputs.marketplace.latest.Plan>[]>;
    /**
