...
export class PrivateStoreOffer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateStoreOfferArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:marketplace:PrivateStoreOffer" }, { type: "azure-native:marketplace/latest:PrivateStoreOffer" }, { type: "azure-nextgen:marketplace/latest:PrivateStoreOffer" }, { type: "azure-native:marketplace/v20200101:PrivateStoreOffer" }, { type: "azure-nextgen:marketplace/v20200101:PrivateStoreOffer" }] };
...
export interface PrivateStoreOfferArgs {
     ...
     * Offer plans
     */
    readonly plans?: pulumi.Input<pulumi.Input<inputs.marketplace.Plan>[]>;
    /**
