 ...
 *
 * @deprecated azure-native:marketplace/v20220901:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Please upgrade to azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.
 */
export class PrivateStoreCollectionOffer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:marketplace/v20220901:PrivateStoreCollectionOffer';
     ...
     * Offer plans
     */
    public readonly plans!: pulumi.Output<outputs.marketplace.v20220901.PlanResponse[] | undefined>;
    /**
...
export interface PrivateStoreCollectionOfferArgs {
     ...
     * Offer plans
     */
    plans?: pulumi.Input<pulumi.Input<inputs.marketplace.v20220901.PlanArgs>[]>;
    /**
