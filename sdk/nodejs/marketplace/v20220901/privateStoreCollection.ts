...
export class PrivateStoreCollection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateStoreCollection {
        pulumi.log.warn("PrivateStoreCollection is deprecated: azure-native:marketplace/v20220901:PrivateStoreCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollection to guarantee forwards compatibility.")
        return new PrivateStoreCollection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:marketplace/v20220901:PrivateStoreCollection';
     ...
     */
    public /*out*/ readonly appliedRules!: pulumi.Output<outputs.marketplace.v20220901.RuleResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.marketplace.v20220901.SystemDataResponse>;
    /**
