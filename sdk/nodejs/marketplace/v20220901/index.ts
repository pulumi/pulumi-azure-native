...
// Export enums:
export * from "../../types/enums/marketplace/v20220901";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:marketplace/v20220901:PrivateStoreCollection":
                return new PrivateStoreCollection(name, <any>undefined, { urn })
            case "azure-native:marketplace/v20220901:PrivateStoreCollectionOffer":
...
pulumi.runtime.registerResourceModule("azure-native", "marketplace/v20220901", _module)
