...
export function getPrivateStoreCollectionOffer(args: GetPrivateStoreCollectionOfferArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateStoreCollectionOfferResult> {
    pulumi.log.warn("getPrivateStoreCollectionOffer is deprecated: azure-native:marketplace/v20220901:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Please upgrade to azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.")
...
export interface GetPrivateStoreCollectionOfferResult {
     ...
     * Offer plans
     */
    readonly plans?: outputs.marketplace.v20220901.PlanResponse[];
    /**
