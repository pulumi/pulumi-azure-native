 ...
 *
 * @deprecated azure-native:marketplace/v20220301:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Please upgrade to azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.
 */
export class PrivateStoreCollectionOffer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateStoreCollectionOffer {
        pulumi.log.warn("PrivateStoreCollectionOffer is deprecated: azure-native:marketplace/v20220301:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Please upgrade to azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.")
        return new PrivateStoreCollectionOffer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:marketplace/v20220301:PrivateStoreCollectionOffer';
     ...
     * Offer plans
     */
    public readonly plans!: pulumi.Output<outputs.marketplace.v20220301.PlanResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.marketplace.v20220301.SystemDataResponse>;
    /**
...
export interface PrivateStoreCollectionOfferArgs {
     ...
     * Offer plans
     */
    plans?: pulumi.Input<pulumi.Input<inputs.marketplace.v20220301.PlanArgs>[]>;
    /**
