...
export class PrivateStoreOffer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:marketplace/preview:PrivateStoreOffer';
    ...
    constructor(name: string, argsOrState?: PrivateStoreOfferArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:marketplace/latest:PrivateStoreOffer" }, { type: "azurerm:marketplace/v20200101:PrivateStoreOffer" }] };
