...
export class IoMAMPolicyByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:intune/v20150114privatepreview:IoMAMPolicyByName';
    ...
    constructor(name: string, args: IoMAMPolicyByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:intune/preview:IoMAMPolicyByName" }, { type: "azurerm:intune/v20150114preview:IoMAMPolicyByName" }] };
