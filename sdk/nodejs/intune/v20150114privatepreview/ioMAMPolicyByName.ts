...
export class IoMAMPolicyByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:intune/v20150114privatepreview:IoMAMPolicyByName';
    ...
    constructor(name: string, args: IoMAMPolicyByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:intune:IoMAMPolicyByName" }, { type: "azure-nextgen:intune/v20150114preview:IoMAMPolicyByName" }] };
