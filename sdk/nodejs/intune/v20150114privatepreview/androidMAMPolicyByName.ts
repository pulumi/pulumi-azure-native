...
export class AndroidMAMPolicyByName extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AndroidMAMPolicyByName {
        return new AndroidMAMPolicyByName(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:intune/v20150114privatepreview:AndroidMAMPolicyByName';
    ...
    constructor(name: string, argsOrState?: AndroidMAMPolicyByNameArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as AndroidMAMPolicyByNameArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:intune/preview:AndroidMAMPolicyByName" }, { type: "azurerm:intune/v20150114preview:AndroidMAMPolicyByName" }] };
