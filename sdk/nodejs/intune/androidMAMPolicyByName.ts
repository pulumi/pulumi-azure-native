...
export class AndroidMAMPolicyByName extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AndroidMAMPolicyByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:intune:AndroidMAMPolicyByName" }, { type: "azure-native:intune/v20150114preview:AndroidMAMPolicyByName" }, { type: "azure-nextgen:intune/v20150114preview:AndroidMAMPolicyByName" }, { type: "azure-native:intune/v20150114privatepreview:AndroidMAMPolicyByName" }, { type: "azure-nextgen:intune/v20150114privatepreview:AndroidMAMPolicyByName" }] };
