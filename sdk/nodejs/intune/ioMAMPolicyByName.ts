...
export class IoMAMPolicyByName extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IoMAMPolicyByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["fileEncryptionLevel"] = (args ? args.fileEncryptionLevel : undefined) ?? "deviceLocked";
            ...
            inputs["touchId"] = (args ? args.touchId : undefined) ?? "enable";
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:intune:IoMAMPolicyByName" }, { type: "azure-native:intune/v20150114preview:IoMAMPolicyByName" }, { type: "azure-nextgen:intune/v20150114preview:IoMAMPolicyByName" }, { type: "azure-native:intune/v20150114privatepreview:IoMAMPolicyByName" }, { type: "azure-nextgen:intune/v20150114privatepreview:IoMAMPolicyByName" }] };
