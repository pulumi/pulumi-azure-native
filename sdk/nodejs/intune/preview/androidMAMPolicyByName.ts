...
export class AndroidMAMPolicyByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:intune/preview:AndroidMAMPolicyByName';
    ...
    constructor(name: string, argsOrState?: AndroidMAMPolicyByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:intune/v20150114preview:AndroidMAMPolicyByName" }, { type: "azurerm:intune/v20150114privatepreview:AndroidMAMPolicyByName" }] };
