...
export class IoMAMPolicyByName extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IoMAMPolicyByName {
        return new IoMAMPolicyByName(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:intune/preview:IoMAMPolicyByName';
    ...
    constructor(name: string, argsOrState?: IoMAMPolicyByNameArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as IoMAMPolicyByNameArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:intune/v20150114preview:IoMAMPolicyByName" }, { type: "azurerm:intune/v20150114privatepreview:IoMAMPolicyByName" }] };
