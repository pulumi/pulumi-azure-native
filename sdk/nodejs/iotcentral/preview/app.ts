...
export class App extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:iotcentral/preview:App';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.iotcentral.preview.AppSkuInfoResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: AppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:iotcentral/latest:App" }, { type: "azurerm:iotcentral/v20170701privatepreview:App" }, { type: "azurerm:iotcentral/v20180901:App" }] };
...
export interface AppArgs {
     ...
     * A valid instance SKU.
     */
    readonly sku: pulumi.Input<inputs.iotcentral.preview.AppSkuInfo>;
    /**
     * The subdomain of the application.
     */
