...
export class App extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:iotcentral:App" }, { type: "azure-nextgen:iotcentral/latest:App" }, { type: "azure-nextgen:iotcentral/v20170701privatepreview:App" }] };
