...
export class Prefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20201001:Prefix';
     ...
     */
    public /*out*/ readonly events!: pulumi.Output<outputs.peering.v20201001.PeeringServicePrefixEventResponse[]>;
    /**
    ...
    constructor(name: string, args: PrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:peering/v20201001:Prefix" }, { type: "azure-native:peering:Prefix" }, { type: "azure-nextgen:peering:Prefix" }, { type: "azure-native:peering/v20190801preview:Prefix" }, { type: "azure-nextgen:peering/v20190801preview:Prefix" }, { type: "azure-native:peering/v20190901preview:Prefix" }, { type: "azure-nextgen:peering/v20190901preview:Prefix" }, { type: "azure-native:peering/v20200101preview:Prefix" }, { type: "azure-nextgen:peering/v20200101preview:Prefix" }, { type: "azure-native:peering/v20200401:Prefix" }, { type: "azure-nextgen:peering/v20200401:Prefix" }, { type: "azure-native:peering/v20210101:Prefix" }, { type: "azure-nextgen:peering/v20210101:Prefix" }, { type: "azure-native:peering/v20210601:Prefix" }, { type: "azure-nextgen:peering/v20210601:Prefix" }] };
