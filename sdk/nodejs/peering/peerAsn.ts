...
export class PeerAsn extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering:PeerAsn';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.peering.PeerAsnPropertiesResponse>;
    /**
...
export interface PeerAsnArgs {
     ...
     * The properties that define a peer's ASN.
     */
    readonly properties?: pulumi.Input<inputs.peering.PeerAsnProperties>;
}
