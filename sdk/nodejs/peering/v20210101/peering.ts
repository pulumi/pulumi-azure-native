...
export interface PeeringArgs {
     ...
     * The properties that define a direct peering.
     */
    readonly direct?: pulumi.Input<inputs.peering.v20210101.PeeringPropertiesDirect>;
    /**
     * The properties that define an exchange peering.
     */
    readonly exchange?: pulumi.Input<inputs.peering.v20210101.PeeringPropertiesExchange>;
    /**
     * The kind of the peering.
     */
     ...
     * The SKU that defines the tier and kind of the peering.
     */
    readonly sku: pulumi.Input<inputs.peering.v20210101.PeeringSku>;
    /**
     * The resource tags.
     */
