...
export class RegisteredAsn extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20210101:RegisteredAsn';
    ...
    constructor(name: string, args: RegisteredAsnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:peering/v20210101:RegisteredAsn" }, { type: "azure-native:peering:RegisteredAsn" }, { type: "azure-nextgen:peering:RegisteredAsn" }, { type: "azure-native:peering/latest:RegisteredAsn" }, { type: "azure-nextgen:peering/latest:RegisteredAsn" }, { type: "azure-native:peering/v20200101preview:RegisteredAsn" }, { type: "azure-nextgen:peering/v20200101preview:RegisteredAsn" }, { type: "azure-native:peering/v20200401:RegisteredAsn" }, { type: "azure-nextgen:peering/v20200401:RegisteredAsn" }, { type: "azure-native:peering/v20201001:RegisteredAsn" }, { type: "azure-nextgen:peering/v20201001:RegisteredAsn" }] };
