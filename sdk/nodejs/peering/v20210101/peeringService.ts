 ...
 *
 * const peeringService = new azure_native.peering.v20210101.PeeringService("peeringService", {
 *     location: "eastus",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:peering/v20210101:PeeringService peeringServiceName /subscriptions/subId/resourceGroups/rgName/providers/Microsoft.Peering/peeringServices/peeringServiceName 
 * ```
 */
...
export interface PeeringServiceArgs {
     ...
     * The SKU that defines the type of the peering service.
     */
    sku?: pulumi.Input<inputs.peering.v20210101.PeeringServiceSkuArgs>;
    /**
     * The resource tags.
     */
