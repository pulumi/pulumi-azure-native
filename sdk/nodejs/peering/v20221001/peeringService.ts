...
export class PeeringService extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly logAnalyticsWorkspaceProperties!: pulumi.Output<outputs.peering.v20221001.LogAnalyticsWorkspacePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.peering.v20221001.PeeringServiceSkuResponse | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: PeeringServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:PeeringService" }, { type: "azure-native:peering/v20210101:PeeringService" }, { type: "azure-native:peering/v20210601:PeeringService" }, { type: "azure-native:peering/v20220101:PeeringService" }, { type: "azure-native:peering/v20220601:PeeringService" }] };
