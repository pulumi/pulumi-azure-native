...
export class Prefix extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly events!: pulumi.Output<outputs.peering.v20221001.PeeringServicePrefixEventResponse[]>;
    /**
    ...
    constructor(name: string, args: PrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:Prefix" }, { type: "azure-native:peering/v20210101:Prefix" }, { type: "azure-native:peering/v20210601:Prefix" }, { type: "azure-native:peering/v20220101:Prefix" }, { type: "azure-native:peering/v20220601:Prefix" }] };
