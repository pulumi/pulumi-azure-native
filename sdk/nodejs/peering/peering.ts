...
export class Peering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:peering:Peering';
...
export interface PeeringArgs {
     ...
     * The properties that define a direct peering.
     */
    readonly direct?: pulumi.Input<inputs.peering.PeeringPropertiesDirect>;
    /**
     * The properties that define an exchange peering.
     */
    readonly exchange?: pulumi.Input<inputs.peering.PeeringPropertiesExchange>;
    /**
     * The kind of the peering.
     */
    readonly kind: pulumi.Input<string | enums.peering.Kind>;
    /**
     * The location of the resource.
     */
