...
export class PeeringService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/latest:PeeringService';
    ...
    constructor(name: string, argsOrState?: PeeringServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/preview:PeeringService" }, { type: "azurerm:peering/v20190801preview:PeeringService" }, { type: "azurerm:peering/v20190901preview:PeeringService" }, { type: "azurerm:peering/v20200101preview:PeeringService" }, { type: "azurerm:peering/v20200401:PeeringService" }] };
