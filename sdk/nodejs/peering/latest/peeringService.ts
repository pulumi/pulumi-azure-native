...
export class PeeringService extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PeeringServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/v20190801preview:PeeringService" }, { type: "azurerm:peering/v20190901preview:PeeringService" }, { type: "azurerm:peering/v20200101preview:PeeringService" }, { type: "azurerm:peering/v20200401:PeeringService" }] };
