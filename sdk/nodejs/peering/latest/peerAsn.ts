...
export class PeerAsn extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/latest:PeerAsn';
    ...
    constructor(name: string, args: PeerAsnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/preview:PeerAsn" }, { type: "azurerm:peering/v20190801preview:PeerAsn" }, { type: "azurerm:peering/v20190901preview:PeerAsn" }, { type: "azurerm:peering/v20200101preview:PeerAsn" }, { type: "azurerm:peering/v20200401:PeerAsn" }] };
