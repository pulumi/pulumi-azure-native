...
export class PeerAsn extends pulumi.CustomResource {
     ...
     */
    public readonly peerContactDetail!: pulumi.Output<outputs.peering.latest.ContactDetailResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args?: PeerAsnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:peering/latest:PeerAsn" }, { type: "azure-native:peering:PeerAsn" }, { type: "azure-nextgen:peering:PeerAsn" }, { type: "azure-native:peering/v20190801preview:PeerAsn" }, { type: "azure-nextgen:peering/v20190801preview:PeerAsn" }, { type: "azure-native:peering/v20190901preview:PeerAsn" }, { type: "azure-nextgen:peering/v20190901preview:PeerAsn" }, { type: "azure-native:peering/v20200101preview:PeerAsn" }, { type: "azure-nextgen:peering/v20200101preview:PeerAsn" }, { type: "azure-native:peering/v20200401:PeerAsn" }, { type: "azure-nextgen:peering/v20200401:PeerAsn" }, { type: "azure-native:peering/v20201001:PeerAsn" }, { type: "azure-nextgen:peering/v20201001:PeerAsn" }, { type: "azure-native:peering/v20210101:PeerAsn" }, { type: "azure-nextgen:peering/v20210101:PeerAsn" }] };
...
export interface PeerAsnArgs {
     ...
     * The contact details of the peer.
     */
    readonly peerContactDetail?: pulumi.Input<pulumi.Input<inputs.peering.latest.ContactDetail>[]>;
    /**
     * The name of the peer.
     */
