...
export class RegisteredAsn extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegisteredAsnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/preview:RegisteredAsn" }, { type: "azurerm:peering/v20200101preview:RegisteredAsn" }, { type: "azurerm:peering/v20200401:RegisteredAsn" }] };
