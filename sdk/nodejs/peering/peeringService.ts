...
export class PeeringService extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PeeringServiceState, opts?: pulumi.CustomResourceOptions): PeeringService {
        return new PeeringService(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: PeeringServiceArgs | PeeringServiceState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PeeringServiceState | undefined;
 ...
 * Peering Service
 */
export interface PeeringServiceState {
    /**
     * The location of the resource.
     */
     ...
     * The properties that define a peering service.
     */
    readonly properties: pulumi.Input<inputs.peering.PeeringServicePropertiesResponse>;
    /**
     * The SKU that defines the type of the peering service.
     */
    readonly sku?: pulumi.Input<inputs.peering.PeeringServiceSkuResponse>;
    /**
     * The resource tags.
     */
