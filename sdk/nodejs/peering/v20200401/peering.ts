...
export class Peering extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:peering/latest:Peering" }, { type: "azure-nextgen:peering/v20190801preview:Peering" }, { type: "azure-nextgen:peering/v20190901preview:Peering" }, { type: "azure-nextgen:peering/v20200101preview:Peering" }] };
