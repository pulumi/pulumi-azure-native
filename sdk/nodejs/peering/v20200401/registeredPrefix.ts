...
export class RegisteredPrefix extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegisteredPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:RegisteredPrefix" }, { type: "azure-nextgen:peering:RegisteredPrefix" }, { type: "azure-native:peering/latest:RegisteredPrefix" }, { type: "azure-nextgen:peering/latest:RegisteredPrefix" }, { type: "azure-native:peering/v20200101preview:RegisteredPrefix" }, { type: "azure-nextgen:peering/v20200101preview:RegisteredPrefix" }, { type: "azure-native:peering/v20201001:RegisteredPrefix" }, { type: "azure-nextgen:peering/v20201001:RegisteredPrefix" }] };
