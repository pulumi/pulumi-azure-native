...
export class RegisteredPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/v20200401:RegisteredPrefix';
    ...
    constructor(name: string, argsOrState?: RegisteredPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:RegisteredPrefix" }, { type: "azurerm:peering/preview:RegisteredPrefix" }, { type: "azurerm:peering/v20200101preview:RegisteredPrefix" }] };
