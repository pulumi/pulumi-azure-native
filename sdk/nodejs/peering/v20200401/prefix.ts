...
export class Prefix extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:Prefix" }, { type: "azure-nextgen:peering:Prefix" }, { type: "azure-native:peering/latest:Prefix" }, { type: "azure-nextgen:peering/latest:Prefix" }, { type: "azure-native:peering/v20190801preview:Prefix" }, { type: "azure-nextgen:peering/v20190801preview:Prefix" }, { type: "azure-native:peering/v20190901preview:Prefix" }, { type: "azure-nextgen:peering/v20190901preview:Prefix" }, { type: "azure-native:peering/v20200101preview:Prefix" }, { type: "azure-nextgen:peering/v20200101preview:Prefix" }, { type: "azure-native:peering/v20201001:Prefix" }, { type: "azure-nextgen:peering/v20201001:Prefix" }] };
