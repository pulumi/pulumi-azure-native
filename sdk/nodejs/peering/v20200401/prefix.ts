...
export class Prefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/v20200401:Prefix';
    ...
    constructor(name: string, argsOrState?: PrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:Prefix" }, { type: "azurerm:peering/preview:Prefix" }, { type: "azurerm:peering/v20190801preview:Prefix" }, { type: "azurerm:peering/v20190901preview:Prefix" }, { type: "azurerm:peering/v20200101preview:Prefix" }] };
