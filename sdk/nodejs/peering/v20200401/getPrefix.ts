...
export function getPrefix(args: GetPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:peering/v20200401:getPrefix", {
        "expand": args.expand,
...
export interface GetPrefixResult {
     ...
     */
    readonly events: outputs.peering.v20200401.PeeringServicePrefixEventInvokeResponse[];
    /**
