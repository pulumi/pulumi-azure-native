...
export function getPeerAsn(args: GetPeerAsnArgs, opts?: pulumi.InvokeOptions): Promise<GetPeerAsnResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:peering/v20200401:getPeerAsn", {
...
export interface GetPeerAsnResult {
     ...
     */
    readonly peerContactDetail?: outputs.peering.v20200401.ContactDetailInvokeResponse[];
    /**
