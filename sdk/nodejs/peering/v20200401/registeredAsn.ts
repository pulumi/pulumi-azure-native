...
azure-native:peering/v20200401:RegisteredAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:RegisteredAsn to guarantee forwards compatibility.
 */
export class RegisteredAsn extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegisteredAsn {
        pulumi.log.warn("RegisteredAsn is deprecated: Version 2020-04-01 will be removed in v2 of the provider.\nazure-native:peering/v20200401:RegisteredAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:RegisteredAsn to guarantee forwards compatibility.")
