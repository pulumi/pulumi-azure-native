...
export class Peering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:peering/v20200101preview:Peering';
    ...
    constructor(name: string, args: PeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:peering:Peering" }, { type: "azure-nextgen:peering/latest:Peering" }, { type: "azure-nextgen:peering/v20190801preview:Peering" }, { type: "azure-nextgen:peering/v20190901preview:Peering" }, { type: "azure-nextgen:peering/v20200401:Peering" }, { type: "azure-nextgen:peering/v20201001:Peering" }] };
...
export interface PeeringArgs {
     ...
     * The properties that define a direct peering.
     */
    readonly direct?: pulumi.Input<inputs.peering.v20200101preview.PeeringPropertiesDirect>;
    /**
     * The properties that define an exchange peering.
     */
    readonly exchange?: pulumi.Input<inputs.peering.v20200101preview.PeeringPropertiesExchange>;
    /**
     * The kind of the peering.
     */
     ...
     * The SKU that defines the tier and kind of the peering.
     */
    readonly sku: pulumi.Input<inputs.peering.v20200101preview.PeeringSku>;
    /**
     * The resource tags.
     */
