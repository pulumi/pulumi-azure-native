...
export class RegisteredPrefix extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegisteredPrefix {
        return new RegisteredPrefix(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/v20200101preview:RegisteredPrefix';
    ...
    constructor(name: string, argsOrState?: RegisteredPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:RegisteredPrefix" }, { type: "azurerm:peering/preview:RegisteredPrefix" }, { type: "azurerm:peering/v20200401:RegisteredPrefix" }] };
