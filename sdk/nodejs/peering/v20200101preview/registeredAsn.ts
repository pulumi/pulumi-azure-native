...
export class RegisteredAsn extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/v20200101preview:RegisteredAsn';
    ...
    constructor(name: string, argsOrState?: RegisteredAsnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:RegisteredAsn" }, { type: "azurerm:peering/preview:RegisteredAsn" }, { type: "azurerm:peering/v20200401:RegisteredAsn" }] };
