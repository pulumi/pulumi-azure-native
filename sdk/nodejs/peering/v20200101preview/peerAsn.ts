...
export class PeerAsn extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PeerAsnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:PeerAsn" }, { type: "azurerm:peering/preview:PeerAsn" }, { type: "azurerm:peering/v20190801preview:PeerAsn" }, { type: "azurerm:peering/v20190901preview:PeerAsn" }, { type: "azurerm:peering/v20200401:PeerAsn" }] };
