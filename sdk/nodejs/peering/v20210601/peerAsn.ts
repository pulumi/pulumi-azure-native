 ...
 *
 * @deprecated azure-native:peering/v20210601:PeerAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:PeerAsn to guarantee forwards compatibility.
 */
export class PeerAsn extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PeerAsn {
        pulumi.log.warn("PeerAsn is deprecated: azure-native:peering/v20210601:PeerAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:PeerAsn to guarantee forwards compatibility.")
