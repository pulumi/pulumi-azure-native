...
export class RegisteredPrefix extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegisteredPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:RegisteredPrefix" }, { type: "azure-native:peering/v20210101:RegisteredPrefix" }, { type: "azure-native:peering/v20220101:RegisteredPrefix" }] };
