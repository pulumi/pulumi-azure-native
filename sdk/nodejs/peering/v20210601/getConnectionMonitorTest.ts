...
export function getConnectionMonitorTest(args: GetConnectionMonitorTestArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionMonitorTestResult> {
    pulumi.log.warn("getConnectionMonitorTest is deprecated: azure-native:peering/v20210601:ConnectionMonitorTest is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:ConnectionMonitorTest to guarantee forwards compatibility.")
