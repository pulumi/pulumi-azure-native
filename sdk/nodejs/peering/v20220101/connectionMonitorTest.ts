 ...
 *
 * @deprecated azure-native:peering/v20220101:ConnectionMonitorTest is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:ConnectionMonitorTest to guarantee forwards compatibility.
 */
export class ConnectionMonitorTest extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectionMonitorTest {
        pulumi.log.warn("ConnectionMonitorTest is deprecated: azure-native:peering/v20220101:ConnectionMonitorTest is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:ConnectionMonitorTest to guarantee forwards compatibility.")
        return new ConnectionMonitorTest(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20220101:ConnectionMonitorTest';
    ...
    constructor(name: string, args: ConnectionMonitorTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:ConnectionMonitorTest" }, { type: "azure-native:peering/v20210601:ConnectionMonitorTest" }, { type: "azure-native:peering/v20220601:ConnectionMonitorTest" }, { type: "azure-native:peering/v20221001:ConnectionMonitorTest" }] };
