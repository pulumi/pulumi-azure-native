...
export class ConnectionMonitorTest extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectionMonitorTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:ConnectionMonitorTest" }, { type: "azure-native:peering/v20210601:ConnectionMonitorTest" }, { type: "azure-native:peering/v20220601:ConnectionMonitorTest" }] };
