...
export class PeeringService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20220101:PeeringService';
     ...
     */
    public /*out*/ readonly logAnalyticsWorkspaceProperties!: pulumi.Output<outputs.peering.v20220101.LogAnalyticsWorkspacePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.peering.v20220101.PeeringServiceSkuResponse | undefined>;
    /**
     * The resource tags.
     */
