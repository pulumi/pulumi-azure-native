 ...
 *
 * @deprecated azure-native:peering/v20220101:Prefix is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:Prefix to guarantee forwards compatibility.
 */
export class Prefix extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Prefix {
        pulumi.log.warn("Prefix is deprecated: azure-native:peering/v20220101:Prefix is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:Prefix to guarantee forwards compatibility.")
        return new Prefix(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20220101:Prefix';
     ...
     */
    public /*out*/ readonly events!: pulumi.Output<outputs.peering.v20220101.PeeringServicePrefixEventResponse[]>;
    /**
