...
export class Prefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/preview:Prefix';
     ...
     */
    public /*out*/ readonly events!: pulumi.Output<outputs.peering.preview.PeeringServicePrefixEventResponse[]>;
    /**
    ...
    constructor(name: string, args: PrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:Prefix" }, { type: "azurerm:peering/v20190801preview:Prefix" }, { type: "azurerm:peering/v20190901preview:Prefix" }, { type: "azurerm:peering/v20200101preview:Prefix" }, { type: "azurerm:peering/v20200401:Prefix" }] };
