...
export class Peering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/preview:Peering';
     ...
     */
    public readonly direct!: pulumi.Output<outputs.peering.preview.PeeringPropertiesDirectResponse | undefined>;
    /**
     * The properties that define an exchange peering.
     */
    public readonly exchange!: pulumi.Output<outputs.peering.preview.PeeringPropertiesExchangeResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.peering.preview.PeeringSkuResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: PeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:Peering" }, { type: "azurerm:peering/v20190801preview:Peering" }, { type: "azurerm:peering/v20190901preview:Peering" }, { type: "azurerm:peering/v20200101preview:Peering" }, { type: "azurerm:peering/v20200401:Peering" }] };
...
export interface PeeringArgs {
     ...
     * The properties that define a direct peering.
     */
    readonly direct?: pulumi.Input<inputs.peering.preview.PeeringPropertiesDirect>;
    /**
     * The properties that define an exchange peering.
     */
    readonly exchange?: pulumi.Input<inputs.peering.preview.PeeringPropertiesExchange>;
    /**
     * The kind of the peering.
     */
     ...
     * The SKU that defines the tier and kind of the peering.
     */
    readonly sku: pulumi.Input<inputs.peering.preview.PeeringSku>;
    /**
     * The resource tags.
     */
