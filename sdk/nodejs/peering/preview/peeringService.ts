...
export class PeeringService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/preview:PeeringService';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.peering.preview.PeeringServiceSkuResponse | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: PeeringServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:PeeringService" }, { type: "azurerm:peering/v20190801preview:PeeringService" }, { type: "azurerm:peering/v20190901preview:PeeringService" }, { type: "azurerm:peering/v20200101preview:PeeringService" }, { type: "azurerm:peering/v20200401:PeeringService" }] };
...
export interface PeeringServiceArgs {
     ...
     * The SKU that defines the type of the peering service.
     */
    readonly sku?: pulumi.Input<inputs.peering.preview.PeeringServiceSku>;
    /**
     * The resource tags.
     */
