...
export class Peering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:peering/v20190901preview:Peering';
    ...
    constructor(name: string, args: PeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:peering:Peering" }, { type: "azure-nextgen:peering/latest:Peering" }, { type: "azure-nextgen:peering/v20190801preview:Peering" }, { type: "azure-nextgen:peering/v20200101preview:Peering" }, { type: "azure-nextgen:peering/v20200401:Peering" }, { type: "azure-nextgen:peering/v20201001:Peering" }] };
