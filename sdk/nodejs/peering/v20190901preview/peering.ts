...
export class Peering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20190901preview:Peering';
     ...
     */
    public readonly direct!: pulumi.Output<outputs.peering.v20190901preview.PeeringPropertiesDirectResponse | undefined>;
    /**
     * The properties that define an exchange peering.
     */
    public readonly exchange!: pulumi.Output<outputs.peering.v20190901preview.PeeringPropertiesExchangeResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.peering.v20190901preview.PeeringSkuResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: PeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:peering/v20190901preview:Peering" }, { type: "azure-native:peering:Peering" }, { type: "azure-nextgen:peering:Peering" }, { type: "azure-native:peering/latest:Peering" }, { type: "azure-nextgen:peering/latest:Peering" }, { type: "azure-native:peering/v20190801preview:Peering" }, { type: "azure-nextgen:peering/v20190801preview:Peering" }, { type: "azure-native:peering/v20200101preview:Peering" }, { type: "azure-nextgen:peering/v20200101preview:Peering" }, { type: "azure-native:peering/v20200401:Peering" }, { type: "azure-nextgen:peering/v20200401:Peering" }, { type: "azure-native:peering/v20201001:Peering" }, { type: "azure-nextgen:peering/v20201001:Peering" }] };
...
export interface PeeringArgs {
     ...
     * The properties that define a direct peering.
     */
    readonly direct?: pulumi.Input<inputs.peering.v20190901preview.PeeringPropertiesDirect>;
    /**
     * The properties that define an exchange peering.
     */
    readonly exchange?: pulumi.Input<inputs.peering.v20190901preview.PeeringPropertiesExchange>;
    /**
     * The kind of the peering.
     */
    readonly kind: pulumi.Input<string | enums.peering.v20190901preview.Kind>;
    /**
     * The location of the resource.
     */
     ...
     * The SKU that defines the tier and kind of the peering.
     */
    readonly sku: pulumi.Input<inputs.peering.v20190901preview.PeeringSku>;
    /**
     * The resource tags.
     */
