 ...
 *
 * const peering = new azurerm.peering.v20190901preview.Peering("peering", {
 *     direct: {
 *         connections: [
 *             {
...
export class Peering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:peering/v20190901preview:Peering';
    ...
    constructor(name: string, args: PeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:Peering" }, { type: "azurerm:peering/v20190801preview:Peering" }, { type: "azurerm:peering/v20200101preview:Peering" }, { type: "azurerm:peering/v20200401:Peering" }] };
