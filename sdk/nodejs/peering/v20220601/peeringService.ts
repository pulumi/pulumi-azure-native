...
export class PeeringService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PeeringService {
        pulumi.log.warn("PeeringService is deprecated: azure-native:peering/v20220601:PeeringService is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:PeeringService to guarantee forwards compatibility.")
        return new PeeringService(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20220601:PeeringService';
     ...
     */
    public /*out*/ readonly logAnalyticsWorkspaceProperties!: pulumi.Output<outputs.peering.v20220601.LogAnalyticsWorkspacePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.peering.v20220601.PeeringServiceSkuResponse | undefined>;
    /**
     * The resource tags.
     */
...
export interface PeeringServiceArgs {
     ...
     * The SKU that defines the type of the peering service.
     */
    sku?: pulumi.Input<inputs.peering.v20220601.PeeringServiceSkuArgs>;
    /**
     * The resource tags.
     */
