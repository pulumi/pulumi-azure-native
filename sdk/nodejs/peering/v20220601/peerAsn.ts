 ...
 *
 * @deprecated azure-native:peering/v20220601:PeerAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:PeerAsn to guarantee forwards compatibility.
 */
export class PeerAsn extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20220601:PeerAsn';
     ...
     */
    public readonly peerContactDetail!: pulumi.Output<outputs.peering.v20220601.ContactDetailResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args?: PeerAsnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:PeerAsn" }, { type: "azure-native:peering/v20190801preview:PeerAsn" }, { type: "azure-native:peering/v20190901preview:PeerAsn" }, { type: "azure-native:peering/v20200101preview:PeerAsn" }, { type: "azure-native:peering/v20200401:PeerAsn" }, { type: "azure-native:peering/v20201001:PeerAsn" }, { type: "azure-native:peering/v20210101:PeerAsn" }, { type: "azure-native:peering/v20210601:PeerAsn" }, { type: "azure-native:peering/v20220101:PeerAsn" }, { type: "azure-native:peering/v20221001:PeerAsn" }] };
...
export interface PeerAsnArgs {
     ...
     * The contact details of the peer.
     */
    peerContactDetail?: pulumi.Input<pulumi.Input<inputs.peering.v20220601.ContactDetailArgs>[]>;
    /**
     * The name of the peer.
     */
