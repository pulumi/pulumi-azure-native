...
export class PeerAsn extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:peering/v20190801preview:PeerAsn';
     ...
     */
    public readonly peerContactInfo!: pulumi.Output<outputs.peering.v20190801preview.ContactInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args?: PeerAsnArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:peering/v20190801preview:PeerAsn" }, { type: "azure-native:peering:PeerAsn" }, { type: "azure-nextgen:peering:PeerAsn" }, { type: "azure-native:peering/latest:PeerAsn" }, { type: "azure-nextgen:peering/latest:PeerAsn" }, { type: "azure-native:peering/v20190901preview:PeerAsn" }, { type: "azure-nextgen:peering/v20190901preview:PeerAsn" }, { type: "azure-native:peering/v20200101preview:PeerAsn" }, { type: "azure-nextgen:peering/v20200101preview:PeerAsn" }, { type: "azure-native:peering/v20200401:PeerAsn" }, { type: "azure-nextgen:peering/v20200401:PeerAsn" }, { type: "azure-native:peering/v20201001:PeerAsn" }, { type: "azure-nextgen:peering/v20201001:PeerAsn" }, { type: "azure-native:peering/v20210101:PeerAsn" }, { type: "azure-nextgen:peering/v20210101:PeerAsn" }] };
...
export interface PeerAsnArgs {
     ...
     * The contact information of the peer.
     */
    readonly peerContactInfo?: pulumi.Input<inputs.peering.v20190801preview.ContactInfo>;
    /**
     * The name of the peer.
     */
