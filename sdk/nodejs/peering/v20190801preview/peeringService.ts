...
export class PeeringService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PeeringServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:peering:PeeringService" }, { type: "azure-nextgen:peering:PeeringService" }, { type: "azure-native:peering/latest:PeeringService" }, { type: "azure-nextgen:peering/latest:PeeringService" }, { type: "azure-native:peering/v20190901preview:PeeringService" }, { type: "azure-nextgen:peering/v20190901preview:PeeringService" }, { type: "azure-native:peering/v20200101preview:PeeringService" }, { type: "azure-nextgen:peering/v20200101preview:PeeringService" }, { type: "azure-native:peering/v20200401:PeeringService" }, { type: "azure-nextgen:peering/v20200401:PeeringService" }, { type: "azure-native:peering/v20201001:PeeringService" }, { type: "azure-nextgen:peering/v20201001:PeeringService" }] };
