...
export class PeeringService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PeeringServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:peering/latest:PeeringService" }, { type: "azurerm:peering/preview:PeeringService" }, { type: "azurerm:peering/v20190901preview:PeeringService" }, { type: "azurerm:peering/v20200101preview:PeeringService" }, { type: "azurerm:peering/v20200401:PeeringService" }] };
