...
export function getPeerAsn(args: GetPeerAsnArgs, opts?: pulumi.InvokeOptions): Promise<GetPeerAsnResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:peering/v20190801preview:getPeerAsn", {
...
export interface GetPeerAsnResult {
     ...
     */
    readonly peerContactInfo?: outputs.peering.v20190801preview.ContactInfoInvokeResponse;
    /**
