...
export class WorkflowVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkflowVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:WorkflowVersion" }, { type: "azure-native:edge/v20250801:WorkflowVersion" }, { type: "azure-native:edge/v20250815preview:WorkflowVersion" }, { type: "azure-native:edge/v20260301:WorkflowVersion" }] };
...
export interface WorkflowVersionArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.edge.WorkflowVersionPropertiesArgs | undefined>;
    /**
