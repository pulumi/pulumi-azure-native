...
export class Solution extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<outputs.edge.SolutionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:Solution" }, { type: "azure-native:edge/v20250801:Solution" }, { type: "azure-native:edge/v20250815preview:Solution" }, { type: "azure-native:edge/v20260301:Solution" }] };
