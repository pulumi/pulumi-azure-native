...
export class SitesBySubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edge/v20240201preview:SitesBySubscription';
    ...
    constructor(name: string, args?: SitesBySubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge:SitesBySubscription" }] };
