...
export class SolutionVersion extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.edge.SolutionVersionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SolutionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:SolutionVersion" }, { type: "azure-native:edge/v20250801:SolutionVersion" }, { type: "azure-native:edge/v20250815preview:SolutionVersion" }, { type: "azure-native:edge/v20260301:SolutionVersion" }] };
