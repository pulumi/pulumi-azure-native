...
export class SchemaVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SchemaVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:SchemaVersion" }, { type: "azure-native:edge/v20250801:SchemaVersion" }, { type: "azure-native:edge/v20250815preview:SchemaVersion" }, { type: "azure-native:edge/v20260301:SchemaVersion" }] };
