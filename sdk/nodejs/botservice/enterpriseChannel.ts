...
export class EnterpriseChannel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:botservice:EnterpriseChannel';
    ...
    constructor(name: string, args: EnterpriseChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice/latest:EnterpriseChannel" }, { type: "azure-nextgen:botservice/v20180712:EnterpriseChannel" }] };
