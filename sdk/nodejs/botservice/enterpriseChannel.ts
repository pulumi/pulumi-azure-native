...
export class EnterpriseChannel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:botservice:EnterpriseChannel';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.botservice.EnterpriseChannelPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EnterpriseChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice:EnterpriseChannel" }, { type: "azure-native:botservice/latest:EnterpriseChannel" }, { type: "azure-nextgen:botservice/latest:EnterpriseChannel" }, { type: "azure-native:botservice/v20180712:EnterpriseChannel" }, { type: "azure-nextgen:botservice/v20180712:EnterpriseChannel" }] };
