...
export class Bot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:botservice/latest:Bot';
    ...
    constructor(name: string, argsOrState?: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:botservice/preview:Bot" }, { type: "azurerm:botservice/v20171201:Bot" }, { type: "azurerm:botservice/v20180712:Bot" }, { type: "azurerm:botservice/v20200602:Bot" }] };
