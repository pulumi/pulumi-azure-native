...
export class Channel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Channel {
        pulumi.log.warn("Channel is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:botservice:Channel'.")
        return new Channel(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:botservice/latest:Channel';
    ...
    constructor(name: string, args: ChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:botservice:Channel" }, { type: "azure-nextgen:botservice:Channel" }, { type: "azure-native:botservice/v20171201:Channel" }, { type: "azure-nextgen:botservice/v20171201:Channel" }, { type: "azure-native:botservice/v20180712:Channel" }, { type: "azure-nextgen:botservice/v20180712:Channel" }, { type: "azure-native:botservice/v20200602:Channel" }, { type: "azure-nextgen:botservice/v20200602:Channel" }] };
