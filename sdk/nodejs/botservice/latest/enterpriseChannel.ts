...
export class EnterpriseChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnterpriseChannel {
        pulumi.log.warn("EnterpriseChannel is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:botservice:EnterpriseChannel'.")
        return new EnterpriseChannel(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:botservice/latest:EnterpriseChannel';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.botservice.latest.EnterpriseChannelPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EnterpriseChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice/latest:EnterpriseChannel" }, { type: "azure-native:botservice:EnterpriseChannel" }, { type: "azure-nextgen:botservice:EnterpriseChannel" }, { type: "azure-native:botservice/v20180712:EnterpriseChannel" }, { type: "azure-nextgen:botservice/v20180712:EnterpriseChannel" }] };
...
export interface EnterpriseChannelArgs {
     ...
     * The set of properties specific to an Enterprise Channel resource.
     */
    readonly properties?: pulumi.Input<inputs.botservice.latest.EnterpriseChannelProperties>;
    /**
