...
export class Bot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice/v20200602:Bot" }, { type: "azure-native:botservice:Bot" }, { type: "azure-nextgen:botservice:Bot" }, { type: "azure-native:botservice/latest:Bot" }, { type: "azure-nextgen:botservice/latest:Bot" }, { type: "azure-native:botservice/v20171201:Bot" }, { type: "azure-nextgen:botservice/v20171201:Bot" }, { type: "azure-native:botservice/v20180712:Bot" }, { type: "azure-nextgen:botservice/v20180712:Bot" }] };
