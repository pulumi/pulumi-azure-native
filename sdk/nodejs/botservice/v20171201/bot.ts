 ...
 *
 * const bot = new azurerm.botservice.v20171201.Bot("bot", {
 *     etag: "etag1",
 *     kind: "sdk",
 *     location: "West US",
...
export class Bot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:botservice/v20171201:Bot';
    ...
    constructor(name: string, args: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:botservice/latest:Bot" }, { type: "azurerm:botservice/v20180712:Bot" }, { type: "azurerm:botservice/v20200602:Bot" }] };
