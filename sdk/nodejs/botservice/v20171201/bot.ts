...
export class Bot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice/latest:Bot" }, { type: "azure-nextgen:botservice/v20180712:Bot" }, { type: "azure-nextgen:botservice/v20200602:Bot" }] };
