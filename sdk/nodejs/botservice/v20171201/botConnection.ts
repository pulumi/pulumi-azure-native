...
export class BotConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:botservice/v20171201:BotConnection';
    ...
    constructor(name: string, args: BotConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:botservice/latest:BotConnection" }, { type: "azurerm:botservice/preview:BotConnection" }, { type: "azurerm:botservice/v20180712:BotConnection" }, { type: "azurerm:botservice/v20200602:BotConnection" }] };
