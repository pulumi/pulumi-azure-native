...
export function getChannel(args: GetChannelArgs, opts?: pulumi.InvokeOptions): Promise<GetChannelResult> {
    pulumi.log.warn("getChannel is deprecated: azure-native:botservice/v20180712:Channel is being removed in the next major version of this provider. Please upgrade to azure-native:botservice/v20220915:Channel to guarantee forwards compatibility.")
