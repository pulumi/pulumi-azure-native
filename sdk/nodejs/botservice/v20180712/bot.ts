...
export class Bot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Bot {
        return new Bot(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:botservice/v20180712:Bot';
    ...
    constructor(name: string, argsOrState?: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:botservice/latest:Bot" }, { type: "azurerm:botservice/preview:Bot" }, { type: "azurerm:botservice/v20171201:Bot" }, { type: "azurerm:botservice/v20200602:Bot" }] };
