...
export class Bot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice/v20180712:Bot" }, { type: "azure-native:botservice:Bot" }, { type: "azure-nextgen:botservice:Bot" }, { type: "azure-native:botservice/latest:Bot" }, { type: "azure-nextgen:botservice/latest:Bot" }, { type: "azure-native:botservice/v20171201:Bot" }, { type: "azure-nextgen:botservice/v20171201:Bot" }, { type: "azure-native:botservice/v20200602:Bot" }, { type: "azure-nextgen:botservice/v20200602:Bot" }, { type: "azure-native:botservice/v20210301:Bot" }, { type: "azure-nextgen:botservice/v20210301:Bot" }] };
...
export interface BotArgs {
     ...
     * The set of properties specific to bot resource
     */
    readonly properties?: pulumi.Input<inputs.botservice.v20180712.BotProperties>;
    /**
