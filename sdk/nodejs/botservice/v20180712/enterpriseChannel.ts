...
export class EnterpriseChannel extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EnterpriseChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice/v20180712:EnterpriseChannel" }, { type: "azure-native:botservice:EnterpriseChannel" }, { type: "azure-nextgen:botservice:EnterpriseChannel" }] };
...
export interface EnterpriseChannelArgs {
     ...
     * The set of properties specific to an Enterprise Channel resource.
     */
    readonly properties?: pulumi.Input<inputs.botservice.v20180712.EnterpriseChannelPropertiesArgs>;
    /**
