...
export class EnterpriseChannel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:botservice/v20180712:EnterpriseChannel';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.botservice.v20180712.EnterpriseChannelPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EnterpriseChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice:EnterpriseChannel" }, { type: "azure-nextgen:botservice/latest:EnterpriseChannel" }] };
...
export interface EnterpriseChannelArgs {
     ...
     * The set of properties specific to an Enterprise Channel resource.
     */
    readonly properties?: pulumi.Input<inputs.botservice.v20180712.EnterpriseChannelProperties>;
    /**
