...
export class BotConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BotConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice/v20180712:BotConnection" }, { type: "azure-native:botservice:BotConnection" }, { type: "azure-nextgen:botservice:BotConnection" }, { type: "azure-native:botservice/latest:BotConnection" }, { type: "azure-nextgen:botservice/latest:BotConnection" }, { type: "azure-native:botservice/v20171201:BotConnection" }, { type: "azure-nextgen:botservice/v20171201:BotConnection" }, { type: "azure-native:botservice/v20200602:BotConnection" }, { type: "azure-nextgen:botservice/v20200602:BotConnection" }, { type: "azure-native:botservice/v20210301:BotConnection" }, { type: "azure-nextgen:botservice/v20210301:BotConnection" }] };
...
export interface BotConnectionArgs {
     ...
     * The set of properties specific to bot channel resource
     */
    readonly properties?: pulumi.Input<inputs.botservice.v20180712.ConnectionSettingProperties>;
    /**
