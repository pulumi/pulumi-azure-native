...
export class BotConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BotConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice/latest:BotConnection" }, { type: "azure-nextgen:botservice/v20171201:BotConnection" }, { type: "azure-nextgen:botservice/v20200602:BotConnection" }] };
