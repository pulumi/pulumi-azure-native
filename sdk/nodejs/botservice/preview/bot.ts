...
export class Bot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:botservice/preview:Bot';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.botservice.preview.BotPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:botservice/latest:Bot" }, { type: "azurerm:botservice/v20171201:Bot" }, { type: "azurerm:botservice/v20180712:Bot" }, { type: "azurerm:botservice/v20200602:Bot" }] };
...
export interface BotArgs {
     ...
     * The set of properties specific to bot resource
     */
    readonly properties?: pulumi.Input<inputs.botservice.preview.BotProperties>;
    /**
