...
export class BotConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:botservice/preview:BotConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.botservice.preview.ConnectionSettingPropertiesResponse>;
    /**
     * Gets or sets the SKU of the resource.
     */
    public readonly sku!: pulumi.Output<outputs.botservice.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: BotConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:botservice/latest:BotConnection" }, { type: "azurerm:botservice/v20171201:BotConnection" }, { type: "azurerm:botservice/v20180712:BotConnection" }, { type: "azurerm:botservice/v20200602:BotConnection" }] };
...
export interface BotConnectionArgs {
     ...
     * The set of properties specific to bot channel resource
     */
    readonly properties?: pulumi.Input<inputs.botservice.preview.ConnectionSettingProperties>;
    /**
     ...
     * Gets or sets the SKU of the resource.
     */
    readonly sku?: pulumi.Input<inputs.botservice.preview.Sku>;
    /**
     * Contains resource tags defined as key/value pairs.
     */
