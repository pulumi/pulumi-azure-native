...
export class BotConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BotConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:botservice:BotConnection" }, { type: "azure-native:botservice/v20171201:BotConnection" }, { type: "azure-nextgen:botservice/v20171201:BotConnection" }, { type: "azure-native:botservice/v20180712:BotConnection" }, { type: "azure-nextgen:botservice/v20180712:BotConnection" }, { type: "azure-native:botservice/v20200602:BotConnection" }, { type: "azure-nextgen:botservice/v20200602:BotConnection" }, { type: "azure-native:botservice/v20210301:BotConnection" }, { type: "azure-nextgen:botservice/v20210301:BotConnection" }, { type: "azure-native:botservice/v20210501preview:BotConnection" }, { type: "azure-nextgen:botservice/v20210501preview:BotConnection" }] };
...
export interface BotConnectionArgs {
     ...
     * Required. Gets or sets the Kind of the resource.
     */
    readonly kind?: pulumi.Input<string | enums.botservice.Kind>;
    /**
     * Specifies the location of the resource.
     */
     ...
     * The set of properties specific to bot channel resource
     */
    readonly properties?: pulumi.Input<inputs.botservice.ConnectionSettingPropertiesArgs>;
    /**
