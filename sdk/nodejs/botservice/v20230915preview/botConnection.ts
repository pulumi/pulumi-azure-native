...
export class BotConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.botservice.v20230915preview.ConnectionSettingPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BotConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.botservice.v20230915preview.connectionSettingPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface BotConnectionArgs {
     ...
     * The set of properties specific to bot channel resource
     */
    properties?: pulumi.Input<inputs.botservice.v20230915preview.ConnectionSettingPropertiesArgs>;
    /**
