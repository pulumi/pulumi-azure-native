...
export function getIacProfile(args: GetIacProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetIacProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devhub/v20240801preview:getIacProfile", {
...
export interface GetIacProfileResult {
    ...
    readonly stages?: outputs.devhub.v20240801preview.StagePropertiesResponse[];
    /**
    ...
    readonly templates?: outputs.devhub.v20240801preview.IacTemplatePropertiesResponse[];
    /**
