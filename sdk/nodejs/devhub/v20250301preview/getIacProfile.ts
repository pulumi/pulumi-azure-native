...
export function getIacProfile(args: GetIacProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetIacProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devhub/v20250301preview:getIacProfile", {
...
export interface GetIacProfileResult {
    ...
    readonly stages?: outputs.devhub.v20250301preview.StagePropertiesResponse[];
    /**
    ...
    readonly templates?: outputs.devhub.v20250301preview.IacTemplatePropertiesResponse[];
    /**
...
export function getIacProfileOutput(args: GetIacProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIacProfileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:devhub/v20250301preview:getIacProfile", {
        "iacProfileName": args.iacProfileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
