...
// Export enums:
export * from "../../types/enums/devhub/v20250301preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:devhub/v20250301preview:IacProfile":
                return new IacProfile(name, <any>undefined, { urn })
            case "azure-native:devhub/v20250301preview:Workflow":
...
pulumi.runtime.registerResourceModule("azure-native", "devhub/v20250301preview", _module)
