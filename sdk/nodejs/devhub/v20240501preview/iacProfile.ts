...
export class IacProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devhub/v20240501preview:IacProfile';
    ...
    public readonly stages!: pulumi.Output<outputs.devhub.v20240501preview.StagePropertiesResponse[] | undefined>;
    /**
    ...
    public readonly templates!: pulumi.Output<outputs.devhub.v20240501preview.IacTemplatePropertiesResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: IacProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devhub/v20240801preview:IacProfile" }, { type: "azure-native:devhub/v20250301preview:IacProfile" }, { type: "azure-native:devhub:IacProfile" }] };
...
export interface IacProfileArgs {
    ...
    stages?: pulumi.Input<pulumi.Input<inputs.devhub.v20240501preview.StagePropertiesArgs>[]>;
    /**
     * Terraform Storage Account Name
     */
    ...
    templates?: pulumi.Input<pulumi.Input<inputs.devhub.v20240501preview.IacTemplatePropertiesArgs>[]>;
}
