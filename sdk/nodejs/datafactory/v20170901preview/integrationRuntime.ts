...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/v20170901preview:IntegrationRuntime';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.v20170901preview.IntegrationRuntimeResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, argsOrState?: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/latest:IntegrationRuntime" }, { type: "azurerm:datafactory/preview:IntegrationRuntime" }, { type: "azurerm:datafactory/v20180601:IntegrationRuntime" }] };
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    readonly properties: pulumi.Input<inputs.datafactory.v20170901preview.IntegrationRuntime>;
    /**
