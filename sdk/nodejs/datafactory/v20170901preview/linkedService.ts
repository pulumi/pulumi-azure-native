...
export class LinkedService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/v20170901preview:LinkedService';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.v20170901preview.LinkedServiceResponse>;
    /**
     * The resource type.
     */
...
export interface LinkedServiceArgs {
     ...
     * Properties of linked service.
     */
    readonly properties: pulumi.Input<inputs.datafactory.v20170901preview.LinkedService>;
    /**
