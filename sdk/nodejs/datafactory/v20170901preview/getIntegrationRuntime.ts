...
export function getIntegrationRuntime(args: GetIntegrationRuntimeArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationRuntimeResult> {
    ...
    return pulumi.runtime.invoke("azurerm:datafactory/v20170901preview:getIntegrationRuntime", {
...
export interface GetIntegrationRuntimeResult {
     ...
     */
    readonly properties: outputs.datafactory.v20170901preview.IntegrationRuntimeResponse;
    /**
     * The resource type.
     */
