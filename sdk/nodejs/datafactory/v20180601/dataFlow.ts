...
export class DataFlow extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.v20180601.MappingDataFlowResponse | outputs.datafactory.v20180601.WranglingDataFlowResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: DataFlowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datafactory/v20180601:DataFlow" }, { type: "azure-native:datafactory:DataFlow" }, { type: "azure-nextgen:datafactory:DataFlow" }] };
...
export interface DataFlowArgs {
     ...
     * Data flow properties.
     */
    properties: pulumi.Input<inputs.datafactory.v20180601.MappingDataFlowArgs | inputs.datafactory.v20180601.WranglingDataFlowArgs>;
    /**
