...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/latest:IntegrationRuntime" }, { type: "azurerm:datafactory/preview:IntegrationRuntime" }, { type: "azurerm:datafactory/v20170901preview:IntegrationRuntime" }] };
