...
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.v20180601.ManagedPrivateEndpointResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: ManagedPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datafactory/v20180601:ManagedPrivateEndpoint" }, { type: "azure-native:datafactory:ManagedPrivateEndpoint" }, { type: "azure-nextgen:datafactory:ManagedPrivateEndpoint" }] };
...
export interface ManagedPrivateEndpointArgs {
     ...
     * Managed private endpoint properties.
     */
    properties: pulumi.Input<inputs.datafactory.v20180601.ManagedPrivateEndpointArgs>;
    /**
