...
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedPrivateEndpoint {
        return new ManagedPrivateEndpoint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/v20180601:ManagedPrivateEndpoint';
    ...
    constructor(name: string, argsOrState?: ManagedPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
