...
export class Factory extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/v20180601:Factory';
    ...
    constructor(name: string, args: FactoryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/latest:Factory" }, { type: "azurerm:datafactory/preview:Factory" }, { type: "azurerm:datafactory/v20170901preview:Factory" }] };
