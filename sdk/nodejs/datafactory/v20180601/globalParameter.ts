 ...
 *
 * const globalParameter = new azure_native.datafactory.v20180601.GlobalParameter("globalParameter", {
...
export class GlobalParameter extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.datafactory.v20180601.GlobalParameterSpecificationResponse}>;
    /**
     * The resource type.
     */
...
export interface GlobalParameterArgs {
     ...
     * Properties of the global parameter.
     */
    properties: pulumi.Input<{[key: string]: pulumi.Input<inputs.datafactory.v20180601.GlobalParameterSpecificationArgs>}>;
    /**
