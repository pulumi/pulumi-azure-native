...
export class Trigger extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datafactory/v20170901preview:Trigger" }, { type: "azure-nextgen:datafactory/v20180601:Trigger" }] };
...
export interface TriggerArgs {
     ...
     * Properties of the trigger.
     */
    readonly properties: pulumi.Input<inputs.datafactory.latest.BlobEventsTrigger | inputs.datafactory.latest.BlobTrigger | inputs.datafactory.latest.ChainingTrigger | inputs.datafactory.latest.CustomEventsTrigger | inputs.datafactory.latest.MultiplePipelineTrigger | inputs.datafactory.latest.RerunTumblingWindowTrigger | inputs.datafactory.latest.ScheduleTrigger | inputs.datafactory.latest.TumblingWindowTrigger>;
    /**
