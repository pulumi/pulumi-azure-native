...
export class Dataset extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatasetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/preview:Dataset" }, { type: "azurerm:datafactory/v20170901preview:Dataset" }, { type: "azurerm:datafactory/v20180601:Dataset" }] };
