...
export class DataFlow extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.latest.MappingDataFlowResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: DataFlowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datafactory/latest:DataFlow" }, { type: "azure-native:datafactory:DataFlow" }, { type: "azure-nextgen:datafactory:DataFlow" }, { type: "azure-native:datafactory/v20180601:DataFlow" }, { type: "azure-nextgen:datafactory/v20180601:DataFlow" }] };
...
export interface DataFlowArgs {
     ...
     * Data flow properties.
     */
    readonly properties: pulumi.Input<inputs.datafactory.latest.MappingDataFlow>;
    /**
