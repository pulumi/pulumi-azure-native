...
export class Factory extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/latest:Factory';
     ...
     */
    public readonly repoConfiguration!: pulumi.Output<outputs.datafactory.latest.FactoryRepoConfigurationResponse | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, argsOrState?: FactoryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/preview:Factory" }, { type: "azurerm:datafactory/v20170901preview:Factory" }, { type: "azurerm:datafactory/v20180601:Factory" }] };
...
export interface FactoryArgs {
     ...
     * Git repo information of the factory.
     */
    readonly repoConfiguration?: pulumi.Input<inputs.datafactory.latest.FactoryRepoConfiguration>;
    /**
