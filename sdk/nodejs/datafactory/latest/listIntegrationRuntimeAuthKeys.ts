...
export function listIntegrationRuntimeAuthKeys(args: ListIntegrationRuntimeAuthKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListIntegrationRuntimeAuthKeysResult> {
    pulumi.log.warn("listIntegrationRuntimeAuthKeys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-nextgen:datafactory:listIntegrationRuntimeAuthKeys'.")
    if (!opts) {
        opts = {}
    }
