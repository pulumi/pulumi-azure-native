...
export class LinkedService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkedServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/preview:LinkedService" }, { type: "azurerm:datafactory/v20170901preview:LinkedService" }, { type: "azurerm:datafactory/v20180601:LinkedService" }] };
