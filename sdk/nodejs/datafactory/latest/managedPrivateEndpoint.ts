...
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datafactory/latest:ManagedPrivateEndpoint';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.latest.ManagedPrivateEndpointResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: ManagedPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datafactory/latest:ManagedPrivateEndpoint" }, { type: "azure-native:datafactory:ManagedPrivateEndpoint" }, { type: "azure-nextgen:datafactory:ManagedPrivateEndpoint" }, { type: "azure-native:datafactory/v20180601:ManagedPrivateEndpoint" }, { type: "azure-nextgen:datafactory/v20180601:ManagedPrivateEndpoint" }] };
...
export interface ManagedPrivateEndpointArgs {
     ...
     * Managed private endpoint properties.
     */
    readonly properties: pulumi.Input<inputs.datafactory.latest.ManagedPrivateEndpoint>;
    /**
