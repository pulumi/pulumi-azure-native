...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datafactory/v20180601:IntegrationRuntime" }, { type: "azure-native_datafactory_v20170901preview:datafactory:IntegrationRuntime" }, { type: "azure-native_datafactory_v20180601:datafactory:IntegrationRuntime" }] };
