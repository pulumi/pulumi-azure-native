...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:datafactory:IntegrationRuntime';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.ManagedIntegrationRuntimeResponse | outputs.datafactory.SelfHostedIntegrationRuntimeResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datafactory/latest:IntegrationRuntime" }, { type: "azure-nextgen:datafactory/v20170901preview:IntegrationRuntime" }, { type: "azure-nextgen:datafactory/v20180601:IntegrationRuntime" }] };
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    readonly properties: pulumi.Input<inputs.datafactory.ManagedIntegrationRuntime | inputs.datafactory.SelfHostedIntegrationRuntime>;
    /**
