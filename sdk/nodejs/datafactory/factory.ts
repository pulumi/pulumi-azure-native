...
export class Factory extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:datafactory:Factory';
    ...
    constructor(name: string, args: FactoryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datafactory/latest:Factory" }, { type: "azure-nextgen:datafactory/v20170901preview:Factory" }, { type: "azure-nextgen:datafactory/v20180601:Factory" }] };
