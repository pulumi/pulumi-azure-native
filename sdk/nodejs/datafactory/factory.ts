...
export class Factory extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FactoryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datafactory:Factory" }, { type: "azure-native:datafactory/v20170901preview:Factory" }, { type: "azure-nextgen:datafactory/v20170901preview:Factory" }, { type: "azure-native:datafactory/v20180601:Factory" }, { type: "azure-nextgen:datafactory/v20180601:Factory" }] };
...
export interface FactoryArgs {
     ...
     * Properties to enable Customer Managed Key for the factory.
     */
    readonly encryption?: pulumi.Input<inputs.datafactory.EncryptionConfiguration>;
    /**
     * The factory name.
     */
     ...
     * List of parameters for factory.
     */
    readonly globalParameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.datafactory.GlobalParameterSpecification>}>;
    /**
     * Managed service identity of the factory.
     */
     ...
     * Git repo information of the factory.
     */
    readonly repoConfiguration?: pulumi.Input<inputs.datafactory.FactoryGitHubConfiguration | inputs.datafactory.FactoryVSTSConfiguration>;
    /**
