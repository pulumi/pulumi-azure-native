...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/preview:IntegrationRuntime';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.preview.ManagedIntegrationRuntimeResponse | outputs.datafactory.preview.SelfHostedIntegrationRuntimeResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/latest:IntegrationRuntime" }, { type: "azurerm:datafactory/v20170901preview:IntegrationRuntime" }, { type: "azurerm:datafactory/v20180601:IntegrationRuntime" }] };
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    readonly properties: pulumi.Input<inputs.datafactory.preview.ManagedIntegrationRuntime | inputs.datafactory.preview.SelfHostedIntegrationRuntime>;
    /**
