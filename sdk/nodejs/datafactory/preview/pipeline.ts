...
export class Pipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/preview:Pipeline';
     ...
     */
    public readonly activities!: pulumi.Output<outputs.datafactory.preview.ControlActivityResponse | outputs.datafactory.preview.ExecutionActivityResponse[] | undefined>;
    /**
     ...
     */
    public readonly folder!: pulumi.Output<outputs.datafactory.preview.PipelineResponseFolder | undefined>;
    /**
     * The resource name.
     */
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.datafactory.preview.ParameterSpecificationResponse} | undefined>;
    /**
     ...
     */
    public readonly variables!: pulumi.Output<{[key: string]: outputs.datafactory.preview.VariableSpecificationResponse} | undefined>;
    ...
    constructor(name: string, args: PipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/latest:Pipeline" }, { type: "azurerm:datafactory/v20170901preview:Pipeline" }, { type: "azurerm:datafactory/v20180601:Pipeline" }] };
...
export interface PipelineArgs {
     ...
     * List of activities in pipeline.
     */
    readonly activities?: pulumi.Input<pulumi.Input<inputs.datafactory.preview.ControlActivity | inputs.datafactory.preview.ExecutionActivity>[]>;
    /**
     * List of tags that can be used for describing the Pipeline.
     */
     ...
     * The folder that this Pipeline is in. If not specified, Pipeline will appear at the root level.
     */
    readonly folder?: pulumi.Input<inputs.datafactory.preview.PipelineFolder>;
    /**
     * List of parameters for pipeline.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.datafactory.preview.ParameterSpecification>}>;
    /**
     * The pipeline name.
     */
     ...
     * List of variables for pipeline.
     */
    readonly variables?: pulumi.Input<{[key: string]: pulumi.Input<inputs.datafactory.preview.VariableSpecification>}>;
}
