...
export class DataFlow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/preview:DataFlow';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.preview.MappingDataFlowResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: DataFlowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/latest:DataFlow" }, { type: "azurerm:datafactory/v20180601:DataFlow" }] };
...
export interface DataFlowArgs {
     ...
     * Data flow properties.
     */
    readonly properties: pulumi.Input<inputs.datafactory.preview.MappingDataFlow>;
    /**
