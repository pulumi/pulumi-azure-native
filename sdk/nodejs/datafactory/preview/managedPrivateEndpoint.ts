...
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory/preview:ManagedPrivateEndpoint';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datafactory.preview.ManagedPrivateEndpointResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, argsOrState?: ManagedPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datafactory/latest:ManagedPrivateEndpoint" }, { type: "azurerm:datafactory/v20180601:ManagedPrivateEndpoint" }] };
...
export interface ManagedPrivateEndpointArgs {
     ...
     * Managed private endpoint properties.
     */
    readonly properties: pulumi.Input<inputs.datafactory.preview.ManagedPrivateEndpoint>;
    /**
