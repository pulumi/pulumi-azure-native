...
export class DataFlow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datafactory:DataFlow';
    ...
    constructor(name: string, argsOrState?: DataFlowArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DataFlowArgs {
     ...
     * Data flow properties.
     */
    readonly properties: pulumi.Input<inputs.datafactory.DataFlowDefinition>;
    /**
