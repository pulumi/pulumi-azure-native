...
export class CopilotSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:portalservices/v20240401:CopilotSetting';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.portalservices.v20240401.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: CopilotSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:portalservices/v20240401preview:CopilotSetting" }, { type: "azure-native:portalservices:CopilotSetting" }] };
