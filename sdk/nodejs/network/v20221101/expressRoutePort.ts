...
export class ExpressRoutePort extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:ExpressRoutePort';
     ...
     */
    public /*out*/ readonly circuits!: pulumi.Output<outputs.network.v20221101.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly links!: pulumi.Output<outputs.network.v20221101.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */
    ...
    constructor(name: string, args: ExpressRoutePortArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ExpressRoutePort" }, { type: "azure-native:network/v20180801:ExpressRoutePort" }, { type: "azure-native:network/v20181201:ExpressRoutePort" }, { type: "azure-native:network/v20190201:ExpressRoutePort" }, { type: "azure-native:network/v20190601:ExpressRoutePort" }, { type: "azure-native:network/v20190701:ExpressRoutePort" }, { type: "azure-native:network/v20190801:ExpressRoutePort" }, { type: "azure-native:network/v20190901:ExpressRoutePort" }, { type: "azure-native:network/v20191101:ExpressRoutePort" }, { type: "azure-native:network/v20200401:ExpressRoutePort" }, { type: "azure-native:network/v20200501:ExpressRoutePort" }, { type: "azure-native:network/v20200601:ExpressRoutePort" }, { type: "azure-native:network/v20201101:ExpressRoutePort" }, { type: "azure-native:network/v20210201:ExpressRoutePort" }, { type: "azure-native:network/v20210301:ExpressRoutePort" }, { type: "azure-native:network/v20210801:ExpressRoutePort" }, { type: "azure-native:network/v20220101:ExpressRoutePort" }, { type: "azure-native:network/v20220501:ExpressRoutePort" }, { type: "azure-native:network/v20220701:ExpressRoutePort" }, { type: "azure-native:network/v20220901:ExpressRoutePort" }] };
...
export interface ExpressRoutePortArgs {
     ...
     * The billing type of the ExpressRoutePort resource.
     */
    billingType?: pulumi.Input<string | enums.network.v20221101.ExpressRoutePortsBillingType>;
    /**
     * Encapsulation method on physical ports.
     */
    encapsulation?: pulumi.Input<string | enums.network.v20221101.ExpressRoutePortsEncapsulation>;
    /**
     ...
     * The set of physical links of the ExpressRoutePort resource.
     */
    links?: pulumi.Input<pulumi.Input<inputs.network.v20221101.ExpressRouteLinkArgs>[]>;
    /**
     * Resource location.
     */
