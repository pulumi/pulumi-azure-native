...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:NetworkSecurityGroup';
     ...
     */
    public /*out*/ readonly defaultSecurityRules!: pulumi.Output<outputs.network.v20221101.SecurityRuleResponse[]>;
    /**
     ...
     */
    public readonly securityRules!: pulumi.Output<outputs.network.v20221101.SecurityRuleResponse[] | undefined>;
    /**
     * A collection of references to subnets.
     */
    public /*out*/ readonly subnets!: pulumi.Output<outputs.network.v20221101.SubnetResponse[]>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: NetworkSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkSecurityGroup" }, { type: "azure-native:network/v20180601:NetworkSecurityGroup" }, { type: "azure-native:network/v20180701:NetworkSecurityGroup" }, { type: "azure-native:network/v20180801:NetworkSecurityGroup" }, { type: "azure-native:network/v20181201:NetworkSecurityGroup" }, { type: "azure-native:network/v20190201:NetworkSecurityGroup" }, { type: "azure-native:network/v20190601:NetworkSecurityGroup" }, { type: "azure-native:network/v20190701:NetworkSecurityGroup" }, { type: "azure-native:network/v20190801:NetworkSecurityGroup" }, { type: "azure-native:network/v20190901:NetworkSecurityGroup" }, { type: "azure-native:network/v20191101:NetworkSecurityGroup" }, { type: "azure-native:network/v20200401:NetworkSecurityGroup" }, { type: "azure-native:network/v20200501:NetworkSecurityGroup" }, { type: "azure-native:network/v20200601:NetworkSecurityGroup" }, { type: "azure-native:network/v20201101:NetworkSecurityGroup" }, { type: "azure-native:network/v20210201:NetworkSecurityGroup" }, { type: "azure-native:network/v20210301:NetworkSecurityGroup" }, { type: "azure-native:network/v20210801:NetworkSecurityGroup" }, { type: "azure-native:network/v20220101:NetworkSecurityGroup" }, { type: "azure-native:network/v20220501:NetworkSecurityGroup" }, { type: "azure-native:network/v20220701:NetworkSecurityGroup" }, { type: "azure-native:network/v20220901:NetworkSecurityGroup" }] };
...
export interface NetworkSecurityGroupArgs {
     ...
     * A collection of security rules of the network security group.
     */
    securityRules?: pulumi.Input<pulumi.Input<inputs.network.v20221101.SecurityRuleArgs>[]>;
    /**
     * Resource tags.
     */
