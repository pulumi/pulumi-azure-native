...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:BastionHost';
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20221101.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20221101.SkuResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: BastionHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.network.v20221101.skuArgsProvideDefaults) : undefined) : undefined;
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20221101.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The sku of this Bastion Host.
     */
    sku?: pulumi.Input<inputs.network.v20221101.SkuArgs>;
    /**
     * Resource tags.
     */
