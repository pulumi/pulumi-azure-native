...
export function getRouteFilter(args: GetRouteFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getRouteFilter", {
        "expand": args.expand,
...
export interface GetRouteFilterResult {
     ...
     */
    readonly ipv6Peerings: outputs.network.v20221101.ExpressRouteCircuitPeeringResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly rules?: outputs.network.v20221101.RouteFilterRuleResponse[];
    /**
     * Resource tags.
     */
...
export function getRouteFilterOutput(args: GetRouteFilterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRouteFilterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getRouteFilter", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "routeFilterName": args.routeFilterName,
    }, opts);
