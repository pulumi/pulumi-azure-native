...
export function getNetworkManager(args: GetNetworkManagerArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkManagerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getNetworkManager", {
...
export interface GetNetworkManagerResult {
     ...
     */
    readonly networkManagerScopes: outputs.network.v20221101.NetworkManagerPropertiesResponseNetworkManagerScopes;
    /**
     ...
     */
    readonly systemData: outputs.network.v20221101.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getNetworkManagerOutput(args: GetNetworkManagerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkManagerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getNetworkManager", {
        "networkManagerName": args.networkManagerName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
