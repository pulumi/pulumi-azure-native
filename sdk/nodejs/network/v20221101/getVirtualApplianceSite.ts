...
export function getVirtualApplianceSite(args: GetVirtualApplianceSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualApplianceSiteResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getVirtualApplianceSite", {
...
export interface GetVirtualApplianceSiteResult {
     ...
     * Office 365 Policy.
     */
    readonly o365Policy?: outputs.network.v20221101.Office365PolicyPropertiesResponse;
    /**
...
export function getVirtualApplianceSiteOutput(args: GetVirtualApplianceSiteOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualApplianceSiteResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getVirtualApplianceSite", {
        "networkVirtualApplianceName": args.networkVirtualApplianceName,
        "resourceGroupName": args.resourceGroupName,
        "siteName": args.siteName,
    }, opts);
