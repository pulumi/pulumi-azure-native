...
export class VirtualRouter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:VirtualRouter';
     ...
     */
    public readonly hostedGateway!: pulumi.Output<outputs.network.v20221101.SubResourceResponse | undefined>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    public readonly hostedSubnet!: pulumi.Output<outputs.network.v20221101.SubResourceResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly peerings!: pulumi.Output<outputs.network.v20221101.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: VirtualRouterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VirtualRouter" }, { type: "azure-native:network/v20190701:VirtualRouter" }, { type: "azure-native:network/v20190801:VirtualRouter" }, { type: "azure-native:network/v20190901:VirtualRouter" }, { type: "azure-native:network/v20191101:VirtualRouter" }, { type: "azure-native:network/v20200401:VirtualRouter" }, { type: "azure-native:network/v20200501:VirtualRouter" }, { type: "azure-native:network/v20200601:VirtualRouter" }, { type: "azure-native:network/v20201101:VirtualRouter" }, { type: "azure-native:network/v20210201:VirtualRouter" }, { type: "azure-native:network/v20210301:VirtualRouter" }, { type: "azure-native:network/v20210801:VirtualRouter" }, { type: "azure-native:network/v20220101:VirtualRouter" }, { type: "azure-native:network/v20220501:VirtualRouter" }, { type: "azure-native:network/v20220701:VirtualRouter" }, { type: "azure-native:network/v20220901:VirtualRouter" }] };
...
export interface VirtualRouterArgs {
     ...
     * The Gateway on which VirtualRouter is hosted.
     */
    hostedGateway?: pulumi.Input<inputs.network.v20221101.SubResourceArgs>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    hostedSubnet?: pulumi.Input<inputs.network.v20221101.SubResourceArgs>;
    /**
     * Resource ID.
     */
