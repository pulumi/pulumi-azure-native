...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:LocalNetworkGateway';
     ...
     */
    public readonly bgpSettings!: pulumi.Output<outputs.network.v20221101.BgpSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.v20221101.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
    ...
    constructor(name: string, args: LocalNetworkGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:LocalNetworkGateway" }, { type: "azure-native:network/v20180601:LocalNetworkGateway" }, { type: "azure-native:network/v20180701:LocalNetworkGateway" }, { type: "azure-native:network/v20180801:LocalNetworkGateway" }, { type: "azure-native:network/v20181201:LocalNetworkGateway" }, { type: "azure-native:network/v20190201:LocalNetworkGateway" }, { type: "azure-native:network/v20190601:LocalNetworkGateway" }, { type: "azure-native:network/v20190701:LocalNetworkGateway" }, { type: "azure-native:network/v20190801:LocalNetworkGateway" }, { type: "azure-native:network/v20190901:LocalNetworkGateway" }, { type: "azure-native:network/v20191101:LocalNetworkGateway" }, { type: "azure-native:network/v20200401:LocalNetworkGateway" }, { type: "azure-native:network/v20200501:LocalNetworkGateway" }, { type: "azure-native:network/v20200601:LocalNetworkGateway" }, { type: "azure-native:network/v20201101:LocalNetworkGateway" }, { type: "azure-native:network/v20210201:LocalNetworkGateway" }, { type: "azure-native:network/v20210301:LocalNetworkGateway" }, { type: "azure-native:network/v20210801:LocalNetworkGateway" }, { type: "azure-native:network/v20220101:LocalNetworkGateway" }, { type: "azure-native:network/v20220501:LocalNetworkGateway" }, { type: "azure-native:network/v20220701:LocalNetworkGateway" }, { type: "azure-native:network/v20220901:LocalNetworkGateway" }] };
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network gateway's BGP speaker settings.
     */
    bgpSettings?: pulumi.Input<inputs.network.v20221101.BgpSettingsArgs>;
    /**
     * FQDN of local network gateway.
     */
     ...
     * Local network site address space.
     */
    localNetworkAddressSpace?: pulumi.Input<inputs.network.v20221101.AddressSpaceArgs>;
    /**
