...
export class NetworkProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:NetworkProfile';
     ...
     */
    public readonly containerNetworkInterfaceConfigurations!: pulumi.Output<outputs.network.v20221101.ContainerNetworkInterfaceConfigurationResponse[] | undefined>;
    /**
     * List of child container network interfaces.
     */
    public /*out*/ readonly containerNetworkInterfaces!: pulumi.Output<outputs.network.v20221101.ContainerNetworkInterfaceResponse[]>;
    /**
    ...
    constructor(name: string, args: NetworkProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkProfile" }, { type: "azure-native:network/v20180801:NetworkProfile" }, { type: "azure-native:network/v20181201:NetworkProfile" }, { type: "azure-native:network/v20190201:NetworkProfile" }, { type: "azure-native:network/v20190601:NetworkProfile" }, { type: "azure-native:network/v20190701:NetworkProfile" }, { type: "azure-native:network/v20190801:NetworkProfile" }, { type: "azure-native:network/v20190901:NetworkProfile" }, { type: "azure-native:network/v20191101:NetworkProfile" }, { type: "azure-native:network/v20200401:NetworkProfile" }, { type: "azure-native:network/v20200501:NetworkProfile" }, { type: "azure-native:network/v20200601:NetworkProfile" }, { type: "azure-native:network/v20201101:NetworkProfile" }, { type: "azure-native:network/v20210201:NetworkProfile" }, { type: "azure-native:network/v20210301:NetworkProfile" }, { type: "azure-native:network/v20210801:NetworkProfile" }, { type: "azure-native:network/v20220101:NetworkProfile" }, { type: "azure-native:network/v20220501:NetworkProfile" }, { type: "azure-native:network/v20220701:NetworkProfile" }, { type: "azure-native:network/v20220901:NetworkProfile" }] };
...
export interface NetworkProfileArgs {
     ...
     * List of chid container network interface configurations.
     */
    containerNetworkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20221101.ContainerNetworkInterfaceConfigurationArgs>[]>;
    /**
     * Resource ID.
     */
