...
export function getDscpConfiguration(args: GetDscpConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscpConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getDscpConfiguration", {
...
export interface GetDscpConfigurationResult {
     ...
     */
    readonly associatedNetworkInterfaces: outputs.network.v20221101.NetworkInterfaceResponse[];
    /**
     * Destination IP ranges.
     */
    readonly destinationIpRanges?: outputs.network.v20221101.QosIpRangeResponse[];
    /**
     * Destination port ranges.
     */
    readonly destinationPortRanges?: outputs.network.v20221101.QosPortRangeResponse[];
    /**
     ...
     */
    readonly qosDefinitionCollection?: outputs.network.v20221101.QosDefinitionResponse[];
    /**
     ...
     * Source IP ranges.
     */
    readonly sourceIpRanges?: outputs.network.v20221101.QosIpRangeResponse[];
    /**
     * Sources port ranges.
     */
    readonly sourcePortRanges?: outputs.network.v20221101.QosPortRangeResponse[];
    /**
     * Resource tags.
     */
...
export function getDscpConfigurationOutput(args: GetDscpConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDscpConfigurationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getDscpConfiguration", {
        "dscpConfigurationName": args.dscpConfigurationName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
