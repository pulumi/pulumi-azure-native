...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getExpressRouteCircuit", {
...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly authorizations?: outputs.network.v20221101.ExpressRouteCircuitAuthorizationResponse[];
    /**
     ...
     */
    readonly expressRoutePort?: outputs.network.v20221101.SubResourceResponse;
    /**
     ...
     */
    readonly peerings?: outputs.network.v20221101.ExpressRouteCircuitPeeringResponse[];
    /**
     ...
     */
    readonly serviceProviderProperties?: outputs.network.v20221101.ExpressRouteCircuitServiceProviderPropertiesResponse;
    /**
     ...
     * The SKU.
     */
    readonly sku?: outputs.network.v20221101.ExpressRouteCircuitSkuResponse;
    /**
...
export function getExpressRouteCircuitOutput(args: GetExpressRouteCircuitOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExpressRouteCircuitResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getExpressRouteCircuit", {
        "circuitName": args.circuitName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
