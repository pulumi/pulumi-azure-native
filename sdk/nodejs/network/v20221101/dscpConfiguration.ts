...
export class DscpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:DscpConfiguration';
     ...
     */
    public /*out*/ readonly associatedNetworkInterfaces!: pulumi.Output<outputs.network.v20221101.NetworkInterfaceResponse[]>;
    /**
     * Destination IP ranges.
     */
    public readonly destinationIpRanges!: pulumi.Output<outputs.network.v20221101.QosIpRangeResponse[] | undefined>;
    /**
     * Destination port ranges.
     */
    public readonly destinationPortRanges!: pulumi.Output<outputs.network.v20221101.QosPortRangeResponse[] | undefined>;
    /**
     ...
     */
    public readonly qosDefinitionCollection!: pulumi.Output<outputs.network.v20221101.QosDefinitionResponse[] | undefined>;
    /**
     ...
     * Source IP ranges.
     */
    public readonly sourceIpRanges!: pulumi.Output<outputs.network.v20221101.QosIpRangeResponse[] | undefined>;
    /**
     * Sources port ranges.
     */
    public readonly sourcePortRanges!: pulumi.Output<outputs.network.v20221101.QosPortRangeResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface DscpConfigurationArgs {
     ...
     * Destination IP ranges.
     */
    destinationIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20221101.QosIpRangeArgs>[]>;
    /**
     * Destination port ranges.
     */
    destinationPortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20221101.QosPortRangeArgs>[]>;
    /**
     ...
     * RNM supported protocol types.
     */
    protocol?: pulumi.Input<string | enums.network.v20221101.ProtocolType>;
    /**
     * QoS object definitions
     */
    qosDefinitionCollection?: pulumi.Input<pulumi.Input<inputs.network.v20221101.QosDefinitionArgs>[]>;
    /**
     ...
     * Source IP ranges.
     */
    sourceIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20221101.QosIpRangeArgs>[]>;
    /**
     * Sources port ranges.
     */
    sourcePortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20221101.QosPortRangeArgs>[]>;
    /**
     * Resource tags.
     */
