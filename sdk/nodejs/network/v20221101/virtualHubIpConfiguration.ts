...
export class VirtualHubIpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:VirtualHubIpConfiguration';
     ...
     */
    public readonly publicIPAddress!: pulumi.Output<outputs.network.v20221101.PublicIPAddressResponse | undefined>;
    /**
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    privateIPAllocationMethod?: pulumi.Input<string | enums.network.v20221101.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    publicIPAddress?: pulumi.Input<inputs.network.v20221101.PublicIPAddressArgs>;
    /**
