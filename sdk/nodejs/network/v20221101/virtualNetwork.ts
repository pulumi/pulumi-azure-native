...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:VirtualNetwork';
     ...
     */
    public readonly addressSpace!: pulumi.Output<outputs.network.v20221101.AddressSpaceResponse | undefined>;
    /**
     * Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
     */
    public readonly bgpCommunities!: pulumi.Output<outputs.network.v20221101.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    public readonly ddosProtectionPlan!: pulumi.Output<outputs.network.v20221101.SubResourceResponse | undefined>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    public readonly dhcpOptions!: pulumi.Output<outputs.network.v20221101.DhcpOptionsResponse | undefined>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.network.v20221101.VirtualNetworkEncryptionResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly flowLogs!: pulumi.Output<outputs.network.v20221101.FlowLogResponse[]>;
    /**
     ...
     */
    public readonly ipAllocations!: pulumi.Output<outputs.network.v20221101.SubResourceResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly subnets!: pulumi.Output<outputs.network.v20221101.SubnetResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetworkPeerings!: pulumi.Output<outputs.network.v20221101.VirtualNetworkPeeringResponse[] | undefined>;
...
export interface VirtualNetworkArgs {
     ...
     * The AddressSpace that contains an array of IP address ranges that can be used by subnets.
     */
    addressSpace?: pulumi.Input<inputs.network.v20221101.AddressSpaceArgs>;
    /**
     * Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
     */
    bgpCommunities?: pulumi.Input<inputs.network.v20221101.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    ddosProtectionPlan?: pulumi.Input<inputs.network.v20221101.SubResourceArgs>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    dhcpOptions?: pulumi.Input<inputs.network.v20221101.DhcpOptionsArgs>;
    /**
     * Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
     */
     ...
     * Indicates if encryption is enabled on virtual network and if VM without encryption is allowed in encrypted VNet.
     */
    encryption?: pulumi.Input<inputs.network.v20221101.VirtualNetworkEncryptionArgs>;
    /**
     * The extended location of the virtual network.
     */
     ...
     * Array of IpAllocation which reference this VNET.
     */
    ipAllocations?: pulumi.Input<pulumi.Input<inputs.network.v20221101.SubResourceArgs>[]>;
    /**
     * Resource location.
     */
     ...
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.network.v20221101.SubnetArgs>[]>;
    /**
     * Resource tags.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    virtualNetworkPeerings?: pulumi.Input<pulumi.Input<inputs.network.v20221101.VirtualNetworkPeeringArgs>[]>;
}
