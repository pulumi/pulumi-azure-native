...
export function getNetworkProfile(args: GetNetworkProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getNetworkProfile", {
        "expand": args.expand,
...
export interface GetNetworkProfileResult {
     ...
     */
    readonly containerNetworkInterfaceConfigurations?: outputs.network.v20221101.ContainerNetworkInterfaceConfigurationResponse[];
    /**
     * List of child container network interfaces.
     */
    readonly containerNetworkInterfaces: outputs.network.v20221101.ContainerNetworkInterfaceResponse[];
    /**
...
export function getNetworkProfileOutput(args: GetNetworkProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkProfileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getNetworkProfile", {
        "expand": args.expand,
        "networkProfileName": args.networkProfileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
