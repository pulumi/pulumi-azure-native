...
export function getExpressRouteCircuitConnection(args: GetExpressRouteCircuitConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getExpressRouteCircuitConnection", {
...
export interface GetExpressRouteCircuitConnectionResult {
     ...
     */
    readonly expressRouteCircuitPeering?: outputs.network.v20221101.SubResourceResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly ipv6CircuitConnectionConfig?: outputs.network.v20221101.Ipv6CircuitConnectionConfigResponse;
    /**
     ...
     */
    readonly peerExpressRouteCircuitPeering?: outputs.network.v20221101.SubResourceResponse;
    /**
...
export function getExpressRouteCircuitConnectionOutput(args: GetExpressRouteCircuitConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExpressRouteCircuitConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getExpressRouteCircuitConnection", {
        "circuitName": args.circuitName,
        "connectionName": args.connectionName,
        "peeringName": args.peeringName,
        "resourceGroupName": args.resourceGroupName,
