...
export class P2sVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:P2sVpnGateway';
     ...
     */
    public readonly p2SConnectionConfigurations!: pulumi.Output<outputs.network.v20221101.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vpnClientConnectionHealth!: pulumi.Output<outputs.network.v20221101.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    public readonly vpnServerConfiguration!: pulumi.Output<outputs.network.v20221101.SubResourceResponse | undefined>;
...
export interface P2sVpnGatewayArgs {
     ...
     * List of all p2s connection configurations of the gateway.
     */
    p2SConnectionConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20221101.P2SConnectionConfigurationArgs>[]>;
    /**
     ...
     * The VpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    vpnServerConfiguration?: pulumi.Input<inputs.network.v20221101.SubResourceArgs>;
}
