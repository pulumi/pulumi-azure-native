...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:NetworkVirtualApplianceConnection';
     ...
     */
    public readonly routingConfiguration!: pulumi.Output<outputs.network.v20221101.RoutingConfigurationNfvResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkVirtualApplianceConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkVirtualApplianceConnection" }] };
...
export interface NetworkVirtualApplianceConnectionArgs {
     ...
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    routingConfiguration?: pulumi.Input<inputs.network.v20221101.RoutingConfigurationNfvArgs>;
    /**
     * Unique identifier for the connection.
     */
