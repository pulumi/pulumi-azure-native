...
export class VpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:VpnGateway';
     ...
     */
    public readonly connections!: pulumi.Output<outputs.network.v20221101.VpnConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.v20221101.VpnGatewayIpConfigurationResponse[]>;
    /**
     ...
     */
    public readonly natRules!: pulumi.Output<outputs.network.v20221101.VpnGatewayNatRuleResponse[] | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.network.v20221101.VpnConnectionArgs>[]>;
    /**
     * Enable BGP routes translation for NAT on this VpnGateway.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    natRules?: pulumi.Input<pulumi.Input<inputs.network.v20221101.VpnGatewayNatRuleArgs>[]>;
    /**
