...
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:ExpressRouteConnection';
     ...
     */
    public readonly expressRouteCircuitPeering!: pulumi.Output<outputs.network.v20221101.ExpressRouteCircuitPeeringIdResponse>;
    /**
     ...
     */
    public readonly routingConfiguration!: pulumi.Output<outputs.network.v20221101.RoutingConfigurationResponse | undefined>;
    /**
...
export interface ExpressRouteConnectionArgs {
     ...
     * The ExpressRoute circuit peering.
     */
    expressRouteCircuitPeering: pulumi.Input<inputs.network.v20221101.ExpressRouteCircuitPeeringIdArgs>;
    /**
     * Enable FastPath to vWan Firewall hub.
     */
     ...
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    routingConfiguration?: pulumi.Input<inputs.network.v20221101.RoutingConfigurationArgs>;
    /**
     * The routing weight associated to the connection.
     */
