...
export function getIpGroup(args: GetIpGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetIpGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getIpGroup", {
        "expand": args.expand,
...
export interface GetIpGroupResult {
     ...
     */
    readonly firewallPolicies: outputs.network.v20221101.SubResourceResponse[];
    /**
     * List of references to Firewall resources that this IpGroups is associated with.
     */
    readonly firewalls: outputs.network.v20221101.SubResourceResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
...
export function getIpGroupOutput(args: GetIpGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getIpGroup", {
        "expand": args.expand,
        "ipGroupsName": args.ipGroupsName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
