...
export function listActiveSecurityAdminRules(args: ListActiveSecurityAdminRulesArgs, opts?: pulumi.InvokeOptions): Promise<ListActiveSecurityAdminRulesResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:listActiveSecurityAdminRules", {
...
export interface ListActiveSecurityAdminRulesResult {
     ...
     */
    readonly value?: (outputs.network.v20221101.ActiveDefaultSecurityAdminRuleResponse | outputs.network.v20221101.ActiveSecurityAdminRuleResponse)[];
}
/**
 * Lists active security admin rules in a network manager.
 */
export function listActiveSecurityAdminRulesOutput(args: ListActiveSecurityAdminRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListActiveSecurityAdminRulesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:listActiveSecurityAdminRules", {
        "networkManagerName": args.networkManagerName,
        "regions": args.regions,
        "resourceGroupName": args.resourceGroupName,
        "skipToken": args.skipToken,
