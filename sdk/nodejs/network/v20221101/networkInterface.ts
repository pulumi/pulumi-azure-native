...
export class NetworkInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20221101:NetworkInterface';
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.network.v20221101.NetworkInterfaceDnsSettingsResponse | undefined>;
    /**
     * A reference to the dscp configuration to which the network interface is linked.
     */
    public /*out*/ readonly dscpConfiguration!: pulumi.Output<outputs.network.v20221101.SubResourceResponse>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20221101.NetworkInterfaceIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly networkSecurityGroup!: pulumi.Output<outputs.network.v20221101.NetworkSecurityGroupResponse | undefined>;
    /**
     ...
     */
    public readonly privateLinkService!: pulumi.Output<outputs.network.v20221101.PrivateLinkServiceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly tapConfigurations!: pulumi.Output<outputs.network.v20221101.NetworkInterfaceTapConfigurationResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly virtualMachine!: pulumi.Output<outputs.network.v20221101.SubResourceResponse>;
    /**
...
export interface NetworkInterfaceArgs {
     ...
     * Auxiliary mode of Network Interface resource.
     */
    auxiliaryMode?: pulumi.Input<string | enums.network.v20221101.NetworkInterfaceAuxiliaryMode>;
    /**
     * Auxiliary sku of Network Interface resource.
     */
    auxiliarySku?: pulumi.Input<string | enums.network.v20221101.NetworkInterfaceAuxiliarySku>;
    /**
     * Indicates whether to disable tcp state tracking.
     */
     ...
     * The DNS settings in network interface.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20221101.NetworkInterfaceDnsSettingsArgs>;
    /**
     * If the network interface is configured for accelerated networking. Not applicable to VM sizes which require accelerated networking.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20221101.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * Migration phase of Network Interface resource.
     */
    migrationPhase?: pulumi.Input<string | enums.network.v20221101.NetworkInterfaceMigrationPhase>;
    /**
     ...
     * The reference to the NetworkSecurityGroup resource.
     */
    networkSecurityGroup?: pulumi.Input<inputs.network.v20221101.NetworkSecurityGroupArgs>;
    /**
     * Type of Network Interface resource.
     */
    nicType?: pulumi.Input<string | enums.network.v20221101.NetworkInterfaceNicType>;
    /**
     * Privatelinkservice of the network interface resource.
     */
    privateLinkService?: pulumi.Input<inputs.network.v20221101.PrivateLinkServiceArgs>;
    /**
