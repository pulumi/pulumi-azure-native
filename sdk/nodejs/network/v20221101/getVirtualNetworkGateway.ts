...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20221101:getVirtualNetworkGateway", {
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly customRoutes?: outputs.network.v20221101.AddressSpaceResponse;
    /**
     ...
     */
    readonly gatewayDefaultSite?: outputs.network.v20221101.SubResourceResponse;
    /**
     ...
     */
    readonly ipConfigurations?: outputs.network.v20221101.VirtualNetworkGatewayIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly natRules?: outputs.network.v20221101.VirtualNetworkGatewayNatRuleResponse[];
    /**
     ...
     */
    readonly sku?: outputs.network.v20221101.VirtualNetworkGatewaySkuResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetworkGatewayPolicyGroups?: outputs.network.v20221101.VirtualNetworkGatewayPolicyGroupResponse[];
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    readonly vpnClientConfiguration?: outputs.network.v20221101.VpnClientConfigurationResponse;
    /**
...
export function getVirtualNetworkGatewayOutput(args: GetVirtualNetworkGatewayOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualNetworkGatewayResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20221101:getVirtualNetworkGateway", {
        "resourceGroupName": args.resourceGroupName,
        "virtualNetworkGatewayName": args.virtualNetworkGatewayName,
    }, opts);
}
