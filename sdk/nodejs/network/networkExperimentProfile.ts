...
export class NetworkExperimentProfile extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkExperimentProfileState, opts?: pulumi.CustomResourceOptions): NetworkExperimentProfile {
        return new NetworkExperimentProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:NetworkExperimentProfile';
    ...
    constructor(name: string, argsOrState?: NetworkExperimentProfileArgs | NetworkExperimentProfileState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as NetworkExperimentProfileState | undefined;
 ...
 * Defines an Network Experiment Profile and lists of Experiments
 */
export interface NetworkExperimentProfileState {
    /**
     * Gets a unique read-only string that changes whenever the resource is updated.
     */
