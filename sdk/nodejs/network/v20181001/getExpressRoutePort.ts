...
export function getExpressRoutePort(args: GetExpressRoutePortArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20181001:getExpressRoutePort", {
...
export interface GetExpressRoutePortResult {
     ...
     */
    readonly circuits: outputs.network.v20181001.SubResourceInvokeResponse[];
    /**
     ...
     */
    readonly links?: outputs.network.v20181001.ExpressRouteLinkInvokeResponse[];
    /**
     * Resource location.
     */
