...
export function getExpressRoutePort(args: GetExpressRoutePortArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortResult> {
    pulumi.log.warn("getExpressRoutePort is deprecated: azure-native:network/v20181001:ExpressRoutePort is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:ExpressRoutePort to guarantee forwards compatibility.")
