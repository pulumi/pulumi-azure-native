 ...
 */
/** @deprecated azure-native:network/v20181001:DdosProtectionPlan is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility. */
export function getDdosProtectionPlan(args: GetDdosProtectionPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosProtectionPlanResult> {
    pulumi.log.warn("getDdosProtectionPlan is deprecated: azure-native:network/v20181001:DdosProtectionPlan is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.")
