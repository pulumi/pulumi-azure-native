...
export function getRouteFilter(args: GetRouteFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterResult> {
    pulumi.log.warn("getRouteFilter is deprecated: azure-native:network/v20181001:RouteFilter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:RouteFilter to guarantee forwards compatibility.")
