 ...
 *
 * const expressRouteConnection = new azurerm.network.v20181001.ExpressRouteConnection("expressRouteConnection", {
...
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181001:ExpressRouteConnection';
...
export interface ExpressRouteConnectionArgs {
     ...
     * The ExpressRoute circuit peering.
     */
    readonly expressRouteCircuitPeering: pulumi.Input<inputs.network.v20181001.ExpressRouteCircuitPeeringId>;
    /**
