 ...
 */
/** @deprecated azure-native:network/v20181001:InterfaceEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:InterfaceEndpoint to guarantee forwards compatibility. */
export function getInterfaceEndpoint(args: GetInterfaceEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfaceEndpointResult> {
    pulumi.log.warn("getInterfaceEndpoint is deprecated: azure-native:network/v20181001:InterfaceEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:InterfaceEndpoint to guarantee forwards compatibility.")
