...
export class ExpressRouteCrossConnectionPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181001:ExpressRouteCrossConnectionPeering';
    ...
    public readonly properties!: pulumi.Output<outputs.network.v20181001.ExpressRouteCrossConnectionPeeringPropertiesResponse>;
...
export interface ExpressRouteCrossConnectionPeeringArgs {
    ...
    readonly properties?: pulumi.Input<inputs.network.v20181001.ExpressRouteCrossConnectionPeeringProperties>;
    /**
