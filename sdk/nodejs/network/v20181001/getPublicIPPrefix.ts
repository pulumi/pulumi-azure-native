...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    pulumi.log.warn("getPublicIPPrefix is deprecated: azure-native:network/v20181001:PublicIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:PublicIPPrefix to guarantee forwards compatibility.")
