...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20181001:getPublicIPPrefix", {
        "name": args.name,
...
export interface GetPublicIPPrefixResult {
     ...
     */
    readonly properties: outputs.network.v20181001.PublicIPPrefixPropertiesFormatResponse;
    /**
