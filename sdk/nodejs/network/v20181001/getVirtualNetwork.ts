...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20181001:getVirtualNetwork", {
        "name": args.name,
...
export interface GetVirtualNetworkResult {
     ...
     */
    readonly properties: outputs.network.v20181001.VirtualNetworkPropertiesFormatResponse;
    /**
     * Resource tags.
     */
