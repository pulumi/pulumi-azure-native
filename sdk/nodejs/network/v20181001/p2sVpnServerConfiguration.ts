...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): P2sVpnServerConfiguration {
        pulumi.log.warn("P2sVpnServerConfiguration is deprecated: azure-native:network/v20181001:P2sVpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190701:P2sVpnServerConfiguration to guarantee forwards compatibility.")
        return new P2sVpnServerConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20181001:P2sVpnServerConfiguration';
