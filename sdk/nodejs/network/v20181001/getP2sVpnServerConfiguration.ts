...
export function getP2sVpnServerConfiguration(args: GetP2sVpnServerConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetP2sVpnServerConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20181001:getP2sVpnServerConfiguration", {
...
export interface GetP2sVpnServerConfigurationResult {
    ...
    readonly p2SVpnGateways: outputs.network.v20181001.SubResourceInvokeResponse[];
    /**
     * Radius client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusClientRootCertificates?: outputs.network.v20181001.P2SVpnServerConfigRadiusClientRootCertificateInvokeResponse[];
    /**
     * Radius Server root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusServerRootCertificates?: outputs.network.v20181001.P2SVpnServerConfigRadiusServerRootCertificateInvokeResponse[];
    /**
     * VPN client revoked certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRevokedCertificates?: outputs.network.v20181001.P2SVpnServerConfigVpnClientRevokedCertificateInvokeResponse[];
    /**
     * VPN client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRootCertificates?: outputs.network.v20181001.P2SVpnServerConfigVpnClientRootCertificateInvokeResponse[];
    /**
     ...
     */
    readonly vpnClientIpsecPolicies?: outputs.network.v20181001.IpsecPolicyInvokeResponse[];
    /**
