...
export class InboundNatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181001:InboundNatRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20181001.InboundNatRulePropertiesFormatResponse>;
...
export interface InboundNatRuleArgs {
     ...
     * Properties of load balancer inbound nat rule.
     */
    readonly properties?: pulumi.Input<inputs.network.v20181001.InboundNatRulePropertiesFormat>;
    /**
