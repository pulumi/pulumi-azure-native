...
export function getPublicIPAddress(args: GetPublicIPAddressArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPAddressResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20181001:getPublicIPAddress", {
        "expand": args.expand,
...
export interface GetPublicIPAddressResult {
     ...
     */
    readonly dnsSettings?: outputs.network.v20181001.PublicIPAddressDnsSettingsInvokeResponse;
    /**
     ...
     */
    readonly ipConfiguration: outputs.network.v20181001.IPConfigurationInvokeResponse;
    /**
     ...
     */
    readonly publicIPPrefix?: outputs.network.v20181001.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly sku?: outputs.network.v20181001.PublicIPAddressSkuInvokeResponse;
    /**
     * Resource tags.
     */
