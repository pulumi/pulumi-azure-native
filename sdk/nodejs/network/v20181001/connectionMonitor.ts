...
export class ConnectionMonitor extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly destination!: pulumi.Output<outputs.network.v20181001.ConnectionMonitorDestinationResponse>;
     ...
     */
    public /*out*/ readonly source!: pulumi.Output<outputs.network.v20181001.ConnectionMonitorSourceResponse>;
    /**
    ...
    constructor(name: string, args: ConnectionMonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.network.v20181001.connectionMonitorParametersArgsProvideDefaults) : undefined) : undefined;
...
export interface ConnectionMonitorArgs {
     ...
     */
    properties: pulumi.Input<inputs.network.v20181001.ConnectionMonitorParametersArgs>;
    /**
