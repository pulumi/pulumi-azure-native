 ...
 *
 * const expressRouteCircuitConnection = new azurerm.network.v20181001.ExpressRouteCircuitConnection("expressRouteCircuitConnection", {
...
export class ExpressRouteCircuitConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181001:ExpressRouteCircuitConnection';
...
export interface ExpressRouteCircuitConnectionArgs {
     ...
     * Reference to Express Route Circuit Private Peering Resource of the circuit initiating connection.
     */
    readonly expressRouteCircuitPeering?: pulumi.Input<inputs.network.v20181001.SubResource>;
    /**
     * Resource ID.
     */
     ...
     * Reference to Express Route Circuit Private Peering Resource of the peered circuit.
     */
    readonly peerExpressRouteCircuitPeering?: pulumi.Input<inputs.network.v20181001.SubResource>;
    /**
