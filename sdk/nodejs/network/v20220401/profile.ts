...
export class Profile extends pulumi.CustomResource {
     ...
     */
    public readonly dnsConfig!: pulumi.Output<outputs.network.v20220401.DnsConfigResponse | undefined>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    public readonly endpoints!: pulumi.Output<outputs.network.v20220401.EndpointResponse[] | undefined>;
    /**
     ...
     */
    public readonly monitorConfig!: pulumi.Output<outputs.network.v20220401.MonitorConfigResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:Profile" }, { type: "azure-native:network/v20180801:Profile" }, { type: "azure-native:network/v20220401preview:Profile" }] };
...
export interface ProfileArgs {
     ...
     * The list of allowed endpoint record types.
     */
    allowedEndpointRecordTypes?: pulumi.Input<pulumi.Input<string | enums.network.v20220401.AllowedEndpointRecordType>[]>;
    /**
     * The DNS settings of the Traffic Manager profile.
     */
    dnsConfig?: pulumi.Input<inputs.network.v20220401.DnsConfigArgs>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    endpoints?: pulumi.Input<pulumi.Input<inputs.network.v20220401.EndpointArgs>[]>;
    /**
     ...
     * The endpoint monitoring settings of the Traffic Manager profile.
     */
    monitorConfig?: pulumi.Input<inputs.network.v20220401.MonitorConfigArgs>;
    /**
     * The name of the resource
     */
     ...
     * The status of the Traffic Manager profile.
     */
    profileStatus?: pulumi.Input<string | enums.network.v20220401.ProfileStatus>;
    /**
     ...
     * The traffic routing method of the Traffic Manager profile.
     */
    trafficRoutingMethod?: pulumi.Input<string | enums.network.v20220401.TrafficRoutingMethod>;
    /**
     * Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
     */
    trafficViewEnrollmentStatus?: pulumi.Input<string | enums.network.v20220401.TrafficViewEnrollmentStatus>;
    /**
     * The type of the resource. Ex- Microsoft.Network/trafficManagerProfiles.
     */
