...
export class VpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:VpnServerConfiguration';
...
export interface VpnServerConfigurationState {
     ...
     * Properties of the P2SVpnServer configuration.
     */
    readonly properties: pulumi.Input<inputs.network.VpnServerConfigurationPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface VpnServerConfigurationArgs {
     ...
     * Properties of the P2SVpnServer configuration.
     */
    readonly properties?: pulumi.Input<inputs.network.VpnServerConfigurationProperties>;
    /**
