 ...
 *
 * @deprecated azure-native:network/v20200801:P2sVpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:P2sVpnGateway to guarantee forwards compatibility.
 */
export class P2sVpnGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): P2sVpnGateway {
        pulumi.log.warn("P2sVpnGateway is deprecated: azure-native:network/v20200801:P2sVpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:P2sVpnGateway to guarantee forwards compatibility.")
