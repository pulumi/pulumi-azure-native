 ...
 * Route resource.
 *
 * @deprecated azure-native:network/v20200801:Route is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:Route to guarantee forwards compatibility.
 */
export class Route extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Route {
        pulumi.log.warn("Route is deprecated: azure-native:network/v20200801:Route is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:Route to guarantee forwards compatibility.")
