...
export function getNetworkInterfaceTapConfiguration(args: GetNetworkInterfaceTapConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkInterfaceTapConfigurationResult> {
    pulumi.log.warn("getNetworkInterfaceTapConfiguration is deprecated: azure-native:network/v20200801:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.")
