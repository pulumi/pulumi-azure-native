 ...
 *
 * @deprecated azure-native:network/v20200801:VirtualRouter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualRouter to guarantee forwards compatibility.
 */
export class VirtualRouter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualRouter {
        pulumi.log.warn("VirtualRouter is deprecated: azure-native:network/v20200801:VirtualRouter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualRouter to guarantee forwards compatibility.")
