 ...
 *
 * @deprecated azure-native:network/v20200801:RouteFilter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteFilter to guarantee forwards compatibility.
 */
export class RouteFilter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RouteFilter {
        pulumi.log.warn("RouteFilter is deprecated: azure-native:network/v20200801:RouteFilter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteFilter to guarantee forwards compatibility.")
        return new RouteFilter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200801:RouteFilter';
     ...
     */
    public /*out*/ readonly ipv6Peerings!: pulumi.Output<outputs.network.v20200801.ExpressRouteCircuitPeeringResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly peerings!: pulumi.Output<outputs.network.v20200801.ExpressRouteCircuitPeeringResponse[]>;
    /**
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20200801.RouteFilterRuleResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20200801.RouteFilterRuleArgs>[]>;
    /**
     * Resource tags.
     */
