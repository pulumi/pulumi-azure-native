 ...
 */
/** @deprecated azure-native:network/v20200801:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnGateway to guarantee forwards compatibility. */
export function getVpnGateway(args: GetVpnGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnGatewayResult> {
    pulumi.log.warn("getVpnGateway is deprecated: azure-native:network/v20200801:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnGateway to guarantee forwards compatibility.")
