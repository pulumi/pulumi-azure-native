...
export function getNetworkVirtualAppliance(args: GetNetworkVirtualApplianceArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkVirtualApplianceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200801:getNetworkVirtualAppliance", {
        "expand": args.expand,
...
export interface GetNetworkVirtualApplianceResult {
     ...
     */
    readonly inboundSecurityRules: outputs.network.v20200801.SubResourceInvokeResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly nvaSku?: outputs.network.v20200801.VirtualApplianceSkuPropertiesInvokeResponse;
    /**
     ...
     */
    readonly virtualApplianceNics: outputs.network.v20200801.VirtualApplianceNicPropertiesInvokeResponse[];
    /**
     * List of references to VirtualApplianceSite.
     */
    readonly virtualApplianceSites: outputs.network.v20200801.SubResourceInvokeResponse[];
    /**
