...
export class VirtualHubIpConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualHubIpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200801:VirtualHubIpConfiguration" }, { type: "azure-native:network:VirtualHubIpConfiguration" }, { type: "azure-nextgen:network:VirtualHubIpConfiguration" }, { type: "azure-native:network/v20200501:VirtualHubIpConfiguration" }, { type: "azure-nextgen:network/v20200501:VirtualHubIpConfiguration" }, { type: "azure-native:network/v20200601:VirtualHubIpConfiguration" }, { type: "azure-nextgen:network/v20200601:VirtualHubIpConfiguration" }, { type: "azure-native:network/v20200701:VirtualHubIpConfiguration" }, { type: "azure-nextgen:network/v20200701:VirtualHubIpConfiguration" }, { type: "azure-native:network/v20201101:VirtualHubIpConfiguration" }, { type: "azure-nextgen:network/v20201101:VirtualHubIpConfiguration" }, { type: "azure-native:network/v20210201:VirtualHubIpConfiguration" }, { type: "azure-nextgen:network/v20210201:VirtualHubIpConfiguration" }] };
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    readonly privateIPAllocationMethod?: pulumi.Input<string | enums.network.v20200801.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    readonly publicIPAddress?: pulumi.Input<inputs.network.v20200801.PublicIPAddressArgs>;
    /**
     ...
     * The reference to the subnet resource.
     */
    readonly subnet?: pulumi.Input<inputs.network.v20200801.SubnetArgs>;
    /**
