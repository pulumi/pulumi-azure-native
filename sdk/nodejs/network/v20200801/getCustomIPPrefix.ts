...
export function getCustomIPPrefix(args: GetCustomIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomIPPrefixResult> {
    pulumi.log.warn("getCustomIPPrefix is deprecated: azure-native:network/v20200801:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:CustomIPPrefix to guarantee forwards compatibility.")
