...
export function getDdosCustomPolicy(args: GetDdosCustomPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosCustomPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200801:getDdosCustomPolicy", {
...
export interface GetDdosCustomPolicyResult {
     ...
     */
    readonly protocolCustomSettings?: outputs.network.v20200801.ProtocolCustomSettingsFormatInvokeResponse[];
    /**
     ...
     */
    readonly publicIPAddresses: outputs.network.v20200801.SubResourceInvokeResponse[];
    /**
