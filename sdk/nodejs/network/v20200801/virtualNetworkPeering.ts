...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200801:VirtualNetworkPeering';
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.network.v20200801.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    public readonly remoteBgpCommunities!: pulumi.Output<outputs.network.v20200801.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering.
     */
    peeringState?: pulumi.Input<string | enums.network.v20200801.VirtualNetworkPeeringState>;
    /**
     * The reference to the remote virtual network address space.
     */
    remoteAddressSpace?: pulumi.Input<inputs.network.v20200801.AddressSpaceArgs>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    remoteBgpCommunities?: pulumi.Input<inputs.network.v20200801.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
