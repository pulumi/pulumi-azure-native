 ...
 *
 * @deprecated azure-native:network/v20200801:VirtualNetworkPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkPeering to guarantee forwards compatibility.
 */
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkPeering {
        pulumi.log.warn("VirtualNetworkPeering is deprecated: azure-native:network/v20200801:VirtualNetworkPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkPeering to guarantee forwards compatibility.")
