...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200801:getNetworkSecurityGroup", {
        "expand": args.expand,
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules: outputs.network.v20200801.SecurityRuleInvokeResponse[];
    /**
     ...
     */
    readonly flowLogs: outputs.network.v20200801.FlowLogInvokeResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly securityRules?: outputs.network.v20200801.SecurityRuleInvokeResponse[];
    /**
