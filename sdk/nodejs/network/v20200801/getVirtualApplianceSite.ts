...
export function getVirtualApplianceSite(args: GetVirtualApplianceSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualApplianceSiteResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200801:getVirtualApplianceSite", {
...
export interface GetVirtualApplianceSiteResult {
     ...
     * Office 365 Policy.
     */
    readonly o365Policy?: outputs.network.v20200801.Office365PolicyPropertiesInvokeResponse;
    /**
