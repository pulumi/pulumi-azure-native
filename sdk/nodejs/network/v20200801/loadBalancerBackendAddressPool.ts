...
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LoadBalancerBackendAddressPool {
        pulumi.log.warn("LoadBalancerBackendAddressPool is deprecated: azure-native:network/v20200801:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LoadBalancerBackendAddressPool to guarantee forwards compatibility.")
