...
export interface LoadBalancerBackendAddressPoolArgs {
     ...
     * An array of backend addresses.
     */
    readonly loadBalancerBackendAddresses?: pulumi.Input<pulumi.Input<inputs.network.v20200801.LoadBalancerBackendAddress>[]>;
    /**
