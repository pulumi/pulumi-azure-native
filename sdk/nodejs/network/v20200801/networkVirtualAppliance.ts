...
export class NetworkVirtualAppliance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200801:NetworkVirtualAppliance';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.network.v20200801.ManagedServiceIdentityResponse | undefined>;
    /**
     * List of references to InboundSecurityRules.
     */
    public /*out*/ readonly inboundSecurityRules!: pulumi.Output<outputs.network.v20200801.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly nvaSku!: pulumi.Output<outputs.network.v20200801.VirtualApplianceSkuPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly virtualApplianceNics!: pulumi.Output<outputs.network.v20200801.VirtualApplianceNicPropertiesResponse[]>;
    /**
     * List of references to VirtualApplianceSite.
     */
    public /*out*/ readonly virtualApplianceSites!: pulumi.Output<outputs.network.v20200801.SubResourceResponse[]>;
    /**
     * The Virtual Hub where Network Virtual Appliance is being deployed.
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.v20200801.SubResourceResponse | undefined>;
    ...
    constructor(name: string, args: NetworkVirtualApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200801:NetworkVirtualAppliance" }, { type: "azure-native:network:NetworkVirtualAppliance" }, { type: "azure-nextgen:network:NetworkVirtualAppliance" }, { type: "azure-native:network/v20191201:NetworkVirtualAppliance" }, { type: "azure-nextgen:network/v20191201:NetworkVirtualAppliance" }, { type: "azure-native:network/v20200301:NetworkVirtualAppliance" }, { type: "azure-nextgen:network/v20200301:NetworkVirtualAppliance" }, { type: "azure-native:network/v20200401:NetworkVirtualAppliance" }, { type: "azure-nextgen:network/v20200401:NetworkVirtualAppliance" }, { type: "azure-native:network/v20200501:NetworkVirtualAppliance" }, { type: "azure-nextgen:network/v20200501:NetworkVirtualAppliance" }, { type: "azure-native:network/v20200601:NetworkVirtualAppliance" }, { type: "azure-nextgen:network/v20200601:NetworkVirtualAppliance" }, { type: "azure-native:network/v20200701:NetworkVirtualAppliance" }, { type: "azure-nextgen:network/v20200701:NetworkVirtualAppliance" }, { type: "azure-native:network/v20201101:NetworkVirtualAppliance" }, { type: "azure-nextgen:network/v20201101:NetworkVirtualAppliance" }, { type: "azure-native:network/v20210201:NetworkVirtualAppliance" }, { type: "azure-nextgen:network/v20210201:NetworkVirtualAppliance" }] };
...
export interface NetworkVirtualApplianceArgs {
     ...
     * The service principal that has read access to cloud-init and config blob.
     */
    identity?: pulumi.Input<inputs.network.v20200801.ManagedServiceIdentityArgs>;
    /**
     * Resource location.
     */
     ...
     * Network Virtual Appliance SKU.
     */
    nvaSku?: pulumi.Input<inputs.network.v20200801.VirtualApplianceSkuPropertiesArgs>;
    /**
     ...
     * The Virtual Hub where Network Virtual Appliance is being deployed.
     */
    virtualHub?: pulumi.Input<inputs.network.v20200801.SubResourceArgs>;
}
