...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetwork {
        pulumi.log.warn("VirtualNetwork is deprecated: azure-native:network/v20200801:VirtualNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetwork to guarantee forwards compatibility.")
