...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20161201:VirtualNetworkPeering';
    ...
    public readonly properties!: pulumi.Output<outputs.network.v20161201.VirtualNetworkPeeringPropertiesFormatResponse>;
...
export interface VirtualNetworkPeeringArgs {
    ...
    readonly properties?: pulumi.Input<inputs.network.v20161201.VirtualNetworkPeeringPropertiesFormat>;
    /**
