...
export function getNetworkWatcher(args: GetNetworkWatcherArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkWatcherResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20161201:getNetworkWatcher", {
        "name": args.name,
...
export interface GetNetworkWatcherResult {
     ...
     */
    readonly properties: outputs.network.v20161201.NetworkWatcherPropertiesFormatResponse;
    /**
     * Resource tags.
     */
