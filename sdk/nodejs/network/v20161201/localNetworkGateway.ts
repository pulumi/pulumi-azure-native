...
azure-native:network/v20161201:LocalNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:LocalNetworkGateway to guarantee forwards compatibility.
 */
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalNetworkGateway {
        pulumi.log.warn("LocalNetworkGateway is deprecated: Version 2016-12-01 will be removed in v2 of the provider.\nazure-native:network/v20161201:LocalNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:LocalNetworkGateway to guarantee forwards compatibility.")
        return new LocalNetworkGateway(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20161201:LocalNetworkGateway';
     ...
     */
    public readonly bgpSettings!: pulumi.Output<outputs.network.v20161201.BgpSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.v20161201.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
