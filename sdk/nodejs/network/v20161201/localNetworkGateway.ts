...
export class LocalNetworkGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20161201.LocalNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * LocalNetworkGateway properties
     */
    properties: pulumi.Input<inputs.network.v20161201.LocalNetworkGatewayPropertiesFormatArgs>;
    /**
