...
export class RouteFilterRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20161201:RouteFilterRule';
     ...
     * Route Filter Rule Resource
     */
    public readonly properties!: pulumi.Output<outputs.network.v20161201.RouteFilterRulePropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterRuleArgs {
     ...
     * Route Filter Rule Resource
     */
    readonly properties?: pulumi.Input<inputs.network.v20161201.RouteFilterRulePropertiesFormat>;
    /**
