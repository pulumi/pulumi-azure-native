...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20161201:VirtualNetworkGatewayConnection';
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * Gateway connection type. Possible values are: 'IPsec','Vnet2Vnet','ExpressRoute', and 'VPNClient.
     */
    readonly connectionType: pulumi.Input<string | enums.network.v20161201.VirtualNetworkGatewayConnectionType>;
    /**
     * EnableBgp flag
     */
