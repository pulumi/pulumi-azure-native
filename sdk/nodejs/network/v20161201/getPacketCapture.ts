...
export function getPacketCapture(args: GetPacketCaptureArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCaptureResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20161201:getPacketCapture", {
...
export interface GetPacketCaptureResult {
    ...
    readonly filters?: outputs.network.v20161201.PacketCaptureFilterInvokeResponse[];
    /**
     ...
     */
    readonly storageLocation: outputs.network.v20161201.PacketCaptureStorageLocationInvokeResponse;
    /**
