...
export function getExpressRouteCircuitPeering(args: GetExpressRouteCircuitPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20161201:getExpressRouteCircuitPeering", {
...
export interface GetExpressRouteCircuitPeeringResult {
     ...
     */
    readonly microsoftPeeringConfig?: outputs.network.v20161201.ExpressRouteCircuitPeeringConfigInvokeResponse;
    /**
     ...
     */
    readonly routeFilter?: outputs.network.v20161201.RouteFilterInvokeResponse;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    readonly stats?: outputs.network.v20161201.ExpressRouteCircuitStatsInvokeResponse;
    /**
     * The VLAN ID.
     */
