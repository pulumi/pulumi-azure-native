...
export class NspProfile extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NspProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:NspProfile" }, { type: "azure-native:network/v20230701preview:NspProfile" }, { type: "azure-native:network/v20240601preview:NspProfile" }, { type: "azure-native:network:NspProfile" }] };
