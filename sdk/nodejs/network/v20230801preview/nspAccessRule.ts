...
export class NspAccessRule extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly networkSecurityPerimeters!: pulumi.Output<outputs.network.v20230801preview.PerimeterBasedAccessRuleResponse[]>;
    /**
     ...
     */
    public readonly subscriptions!: pulumi.Output<outputs.network.v20230801preview.SubscriptionIdResponse[] | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: NspAccessRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:NspAccessRule" }, { type: "azure-native:network/v20230701preview:NspAccessRule" }, { type: "azure-native:network/v20240601preview:NspAccessRule" }, { type: "azure-native:network:NspAccessRule" }] };
...
export interface NspAccessRuleArgs {
     ...
     * Direction that specifies whether the access rules is inbound/outbound.
     */
    direction?: pulumi.Input<string | enums.network.v20230801preview.AccessRuleDirection>;
    /**
     * Outbound rules email address format.
     */
     ...
     * List of subscription ids
     */
    subscriptions?: pulumi.Input<pulumi.Input<inputs.network.v20230801preview.SubscriptionIdArgs>[]>;
    /**
     * Resource tags.
     */
