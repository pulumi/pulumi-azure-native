 ...
 *
 * const virtualNetworkLink = new azurerm.network.v20180901.VirtualNetworkLink("virtualNetworkLink", {
 *     location: "Global",
...
export class VirtualNetworkLink extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkLink {
        return new VirtualNetworkLink(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180901:VirtualNetworkLink';
