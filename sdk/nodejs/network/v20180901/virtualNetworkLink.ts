 ...
 *
 * @deprecated azure-native:network/v20180901:VirtualNetworkLink is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401preview:VirtualNetworkLink to guarantee forwards compatibility.
 */
export class VirtualNetworkLink extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkLink {
        pulumi.log.warn("VirtualNetworkLink is deprecated: azure-native:network/v20180901:VirtualNetworkLink is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401preview:VirtualNetworkLink to guarantee forwards compatibility.")
