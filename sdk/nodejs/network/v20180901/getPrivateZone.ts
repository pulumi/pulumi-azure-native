 ...
 */
/** @deprecated azure-native:network/v20180901:PrivateZone is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200601:PrivateZone to guarantee forwards compatibility. */
export function getPrivateZone(args: GetPrivateZoneArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateZoneResult> {
    pulumi.log.warn("getPrivateZone is deprecated: azure-native:network/v20180901:PrivateZone is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200601:PrivateZone to guarantee forwards compatibility.")
