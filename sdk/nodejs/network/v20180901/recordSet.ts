...
export class RecordSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RecordSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:RecordSet" }, { type: "azure-nextgen:network/latest:RecordSet" }, { type: "azure-nextgen:network/v20200101:RecordSet" }, { type: "azure-nextgen:network/v20200601:RecordSet" }] };
