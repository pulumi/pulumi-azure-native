...
export function getVirtualNetworkLink(args: GetVirtualNetworkLinkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkLinkResult> {
    pulumi.log.warn("getVirtualNetworkLink is deprecated: azure-native:network/v20180901:VirtualNetworkLink is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:VirtualNetworkLink to guarantee forwards compatibility.")
