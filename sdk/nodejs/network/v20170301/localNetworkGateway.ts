...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170301:LocalNetworkGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20170301.LocalNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * LocalNetworkGateway properties
     */
    readonly properties: pulumi.Input<inputs.network.v20170301.LocalNetworkGatewayPropertiesFormat>;
    /**
