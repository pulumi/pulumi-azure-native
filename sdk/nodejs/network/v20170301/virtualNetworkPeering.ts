...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20170301:VirtualNetworkPeering';
     ...
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.network.v20170301.SubResourceResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering. Possible values are 'Initiated', 'Connected', and 'Disconnected'.
     */
    readonly peeringState?: pulumi.Input<string | enums.network.v20170301.VirtualNetworkPeeringState>;
    /**
     * The provisioning state of the resource.
     */
     ...
     * The reference of the remote virtual network.
     */
    readonly remoteVirtualNetwork?: pulumi.Input<inputs.network.v20170301.SubResourceArgs>;
    /**
