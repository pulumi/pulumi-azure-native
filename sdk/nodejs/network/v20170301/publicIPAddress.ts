...
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20170301:PublicIPAddress';
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.network.v20170301.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     * IPConfiguration
     */
    public /*out*/ readonly ipConfiguration!: pulumi.Output<outputs.network.v20170301.IPConfigurationResponse>;
    /**
     * Resource location.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20170301.PublicIPAddressDnsSettings>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
