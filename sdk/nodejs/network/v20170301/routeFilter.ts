...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170301:RouteFilter';
     ...
     * Route Filter Resource
     */
    public readonly properties!: pulumi.Output<outputs.network.v20170301.RouteFilterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Route Filter Resource
     */
    readonly properties?: pulumi.Input<inputs.network.v20170301.RouteFilterPropertiesFormat>;
    /**
