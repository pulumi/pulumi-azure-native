...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20170301:getLocalNetworkGateway", {
...
export interface GetLocalNetworkGatewayResult {
     ...
     */
    readonly bgpSettings?: outputs.network.v20170301.BgpSettingsInvokeResponse;
    /**
     ...
     */
    readonly localNetworkAddressSpace?: outputs.network.v20170301.AddressSpaceInvokeResponse;
    /**
     * Resource location.
     */
