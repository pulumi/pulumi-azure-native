...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    pulumi.log.warn("getLocalNetworkGateway is deprecated: Version 2017-03-01 will be removed in v2 of the provider.")
...
export interface GetLocalNetworkGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20170301.LocalNetworkGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
