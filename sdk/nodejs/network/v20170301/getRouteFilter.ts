...
export function getRouteFilter(args: GetRouteFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20170301:getRouteFilter", {
        "expand": args.expand,
...
export interface GetRouteFilterResult {
     ...
     */
    readonly peerings: outputs.network.v20170301.ExpressRouteCircuitPeeringInvokeResponse[];
    /**
     ...
     */
    readonly rules?: outputs.network.v20170301.RouteFilterRuleInvokeResponse[];
    /**
     * Resource tags.
     */
