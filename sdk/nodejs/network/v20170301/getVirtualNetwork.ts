...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20170301:getVirtualNetwork", {
        "name": args.name,
...
export interface GetVirtualNetworkResult {
     ...
     */
    readonly name: string;
    readonly properties: outputs.network.v20170301.VirtualNetworkPropertiesFormatResponse;
    /**
     * Resource tags.
     */
