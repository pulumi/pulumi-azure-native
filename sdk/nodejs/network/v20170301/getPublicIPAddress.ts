...
export function getPublicIPAddress(args: GetPublicIPAddressArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPAddressResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20170301:getPublicIPAddress", {
        "name": args.name,
...
export interface GetPublicIPAddressResult {
     ...
     */
    readonly properties: outputs.network.v20170301.PublicIPAddressPropertiesFormatResponse;
    /**
     * Resource tags.
     */
