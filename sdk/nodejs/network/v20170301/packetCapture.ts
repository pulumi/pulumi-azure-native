...
export class PacketCapture extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20170301:PacketCapture';
    ...
    public readonly filters!: pulumi.Output<outputs.network.v20170301.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    public readonly storageLocation!: pulumi.Output<outputs.network.v20170301.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
    ...
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20170301.PacketCaptureFilter>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20170301.PacketCaptureStorageLocation>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
