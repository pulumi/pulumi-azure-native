...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    pulumi.log.warn("getVpnConnection is deprecated: azure-native:network/v20220501:VpnConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnConnection to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220501:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly remoteVpnSite?: outputs.network.v20220501.SubResourceResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: outputs.network.v20220501.VpnSiteLinkConnectionResponse[];
}
/**
 * Retrieves the details of a vpn connection.
 */
