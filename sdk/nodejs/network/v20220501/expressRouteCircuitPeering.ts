...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuitPeering {
        pulumi.log.warn("ExpressRouteCircuitPeering is deprecated: azure-native:network/v20220501:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitPeering to guarantee forwards compatibility.")
        return new ExpressRouteCircuitPeering(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:ExpressRouteCircuitPeering';
     ...
     */
    public readonly connections!: pulumi.Output<outputs.network.v20220501.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly expressRouteConnection!: pulumi.Output<outputs.network.v20220501.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    public readonly ipv6PeeringConfig!: pulumi.Output<outputs.network.v20220501.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    public readonly microsoftPeeringConfig!: pulumi.Output<outputs.network.v20220501.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly peeredConnections!: pulumi.Output<outputs.network.v20220501.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    public readonly routeFilter!: pulumi.Output<outputs.network.v20220501.SubResourceResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     */
    public readonly stats!: pulumi.Output<outputs.network.v20220501.ExpressRouteCircuitStatsResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The list of circuit connections associated with Azure Private Peering for this circuit.
     */
    connections?: pulumi.Input<pulumi.Input<inputs.network.v20220501.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The IPv6 peering configuration.
     */
    ipv6PeeringConfig?: pulumi.Input<inputs.network.v20220501.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The Microsoft peering configuration.
     */
    microsoftPeeringConfig?: pulumi.Input<inputs.network.v20220501.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    peeringType?: pulumi.Input<string | enums.network.v20220501.ExpressRoutePeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference to the RouteFilter resource.
     */
    routeFilter?: pulumi.Input<inputs.network.v20220501.SubResourceArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering state.
     */
    state?: pulumi.Input<string | enums.network.v20220501.ExpressRoutePeeringState>;
    /**
     * The peering stats of express route circuit.
     */
    stats?: pulumi.Input<inputs.network.v20220501.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */
