 ...
 *
 * @deprecated azure-native:network/v20220501:NetworkInterface is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterface to guarantee forwards compatibility.
 */
export class NetworkInterface extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkInterface {
        pulumi.log.warn("NetworkInterface is deprecated: azure-native:network/v20220501:NetworkInterface is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterface to guarantee forwards compatibility.")
        return new NetworkInterface(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:NetworkInterface';
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.network.v20220501.NetworkInterfaceDnsSettingsResponse | undefined>;
    /**
     * A reference to the dscp configuration to which the network interface is linked.
     */
    public /*out*/ readonly dscpConfiguration!: pulumi.Output<outputs.network.v20220501.SubResourceResponse>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20220501.NetworkInterfaceIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly privateLinkService!: pulumi.Output<outputs.network.v20220501.PrivateLinkServiceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly tapConfigurations!: pulumi.Output<outputs.network.v20220501.NetworkInterfaceTapConfigurationResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly virtualMachine!: pulumi.Output<outputs.network.v20220501.SubResourceResponse>;
    /**
...
export interface NetworkInterfaceArgs {
     ...
     * Auxiliary mode of Network Interface resource.
     */
    auxiliaryMode?: pulumi.Input<string | enums.network.v20220501.NetworkInterfaceAuxiliaryMode>;
    /**
     * Indicates whether to disable tcp state tracking.
     */
     ...
     * The DNS settings in network interface.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20220501.NetworkInterfaceDnsSettingsArgs>;
    /**
     * If the network interface is configured for accelerated networking. Not applicable to VM sizes which require accelerated networking.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20220501.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * Migration phase of Network Interface resource.
     */
    migrationPhase?: pulumi.Input<string | enums.network.v20220501.NetworkInterfaceMigrationPhase>;
    /**
     ...
     * Type of Network Interface resource.
     */
    nicType?: pulumi.Input<string | enums.network.v20220501.NetworkInterfaceNicType>;
    /**
     * Privatelinkservice of the network interface resource.
     */
    privateLinkService?: pulumi.Input<inputs.network.v20220501.PrivateLinkServiceArgs>;
    /**
