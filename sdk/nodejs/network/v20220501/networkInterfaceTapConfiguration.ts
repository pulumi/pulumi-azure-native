 ...
 *
 * @deprecated azure-native:network/v20220501:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.
 */
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkInterfaceTapConfiguration {
        pulumi.log.warn("NetworkInterfaceTapConfiguration is deprecated: azure-native:network/v20220501:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.")
        return new NetworkInterfaceTapConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:NetworkInterfaceTapConfiguration';
     ...
     */
    public readonly virtualNetworkTap!: pulumi.Output<outputs.network.v20220501.VirtualNetworkTapResponse | undefined>;
    ...
    constructor(name: string, args: NetworkInterfaceTapConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["virtualNetworkTap"] = args ? (args.virtualNetworkTap ? pulumi.output(args.virtualNetworkTap).apply(inputs.network.v20220501.virtualNetworkTapArgsProvideDefaults) : undefined) : undefined;
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * The reference to the Virtual Network Tap resource.
     */
    virtualNetworkTap?: pulumi.Input<inputs.network.v20220501.VirtualNetworkTapArgs>;
}
