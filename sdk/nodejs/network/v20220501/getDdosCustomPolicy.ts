 ...
 */
/** @deprecated azure-native:network/v20220501:DdosCustomPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DdosCustomPolicy to guarantee forwards compatibility. */
export function getDdosCustomPolicy(args: GetDdosCustomPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosCustomPolicyResult> {
    pulumi.log.warn("getDdosCustomPolicy is deprecated: azure-native:network/v20220501:DdosCustomPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DdosCustomPolicy to guarantee forwards compatibility.")
