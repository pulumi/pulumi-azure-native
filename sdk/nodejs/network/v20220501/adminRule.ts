 ...
 * Network admin rule.
 *
 * @deprecated azure-native:network/v20220501:AdminRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:AdminRule to guarantee forwards compatibility.
 */
export class AdminRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AdminRule {
        pulumi.log.warn("AdminRule is deprecated: azure-native:network/v20220501:AdminRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:AdminRule to guarantee forwards compatibility.")
        return new AdminRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:AdminRule';
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.network.v20220501.AddressPrefixItemResponse[] | undefined>;
    /**
     ...
     */
    public readonly sources!: pulumi.Output<outputs.network.v20220501.AddressPrefixItemResponse[] | undefined>;
    /**
...
export interface AdminRuleArgs {
     ...
     * Indicates the access allowed for this particular rule
     */
    access: pulumi.Input<string | enums.network.v20220501.SecurityConfigurationRuleAccess>;
    /**
     ...
     * The destination address prefixes. CIDR or destination IP ranges.
     */
    destinations?: pulumi.Input<pulumi.Input<inputs.network.v20220501.AddressPrefixItemArgs>[]>;
    /**
     * Indicates if the traffic matched against the rule in inbound or outbound.
     */
    direction: pulumi.Input<string | enums.network.v20220501.SecurityConfigurationRuleDirection>;
    /**
     * Whether the rule is custom or default.
     * Expected value is 'Custom'.
     */
     ...
     * Network protocol this rule applies to.
     */
    protocol: pulumi.Input<string | enums.network.v20220501.SecurityConfigurationRuleProtocol>;
    /**
     ...
     * The CIDR or source IP ranges.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.network.v20220501.AddressPrefixItemArgs>[]>;
}
