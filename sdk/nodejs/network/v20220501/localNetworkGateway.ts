...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:LocalNetworkGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20220501.LocalNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Properties of the local network gateway.
     */
    properties: pulumi.Input<inputs.network.v20220501.LocalNetworkGatewayPropertiesFormatArgs>;
    /**
