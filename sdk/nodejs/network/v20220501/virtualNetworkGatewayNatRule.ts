 ...
 *
 * @deprecated azure-native:network/v20220501:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.
 */
export class VirtualNetworkGatewayNatRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkGatewayNatRule {
        pulumi.log.warn("VirtualNetworkGatewayNatRule is deprecated: azure-native:network/v20220501:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.")
        return new VirtualNetworkGatewayNatRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:VirtualNetworkGatewayNatRule';
     ...
     */
    public readonly externalMappings!: pulumi.Output<outputs.network.v20220501.VpnNatRuleMappingResponse[] | undefined>;
    /**
     * The private IP address internal mapping for NAT.
     */
    public readonly internalMappings!: pulumi.Output<outputs.network.v20220501.VpnNatRuleMappingResponse[] | undefined>;
    /**
...
export interface VirtualNetworkGatewayNatRuleArgs {
     ...
     * The private IP address external mapping for NAT.
     */
    externalMappings?: pulumi.Input<pulumi.Input<inputs.network.v20220501.VpnNatRuleMappingArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * The private IP address internal mapping for NAT.
     */
    internalMappings?: pulumi.Input<pulumi.Input<inputs.network.v20220501.VpnNatRuleMappingArgs>[]>;
    /**
     * The IP Configuration ID this NAT rule applies to.
     */
     ...
     * The Source NAT direction of a VPN NAT.
     */
    mode?: pulumi.Input<string | enums.network.v20220501.VpnNatRuleMode>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     */
    type?: pulumi.Input<string | enums.network.v20220501.VpnNatRuleType>;
    /**
