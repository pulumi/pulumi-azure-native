 ...
 *
 * @deprecated azure-native:network/v20220501:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkProfile to guarantee forwards compatibility.
 */
export class NetworkProfile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkProfile {
        pulumi.log.warn("NetworkProfile is deprecated: azure-native:network/v20220501:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkProfile to guarantee forwards compatibility.")
        return new NetworkProfile(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:NetworkProfile';
     ...
     */
    public readonly containerNetworkInterfaceConfigurations!: pulumi.Output<outputs.network.v20220501.ContainerNetworkInterfaceConfigurationResponse[] | undefined>;
    /**
     * List of child container network interfaces.
     */
    public /*out*/ readonly containerNetworkInterfaces!: pulumi.Output<outputs.network.v20220501.ContainerNetworkInterfaceResponse[]>;
    /**
...
export interface NetworkProfileArgs {
     ...
     * List of chid container network interface configurations.
     */
    containerNetworkInterfaceConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20220501.ContainerNetworkInterfaceConfigurationArgs>[]>;
    /**
     * Resource ID.
     */
