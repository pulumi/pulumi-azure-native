 ...
 */
/** @deprecated azure-native:network/v20220501:ConfigurationPolicyGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConfigurationPolicyGroup to guarantee forwards compatibility. */
export function getConfigurationPolicyGroup(args: GetConfigurationPolicyGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetConfigurationPolicyGroupResult> {
    pulumi.log.warn("getConfigurationPolicyGroup is deprecated: azure-native:network/v20220501:ConfigurationPolicyGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConfigurationPolicyGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220501:getConfigurationPolicyGroup", {
...
export interface GetConfigurationPolicyGroupResult {
     ...
     */
    readonly p2SConnectionConfigurations: outputs.network.v20220501.SubResourceResponse[];
    /**
     * Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
     */
    readonly policyMembers?: outputs.network.v20220501.VpnServerConfigurationPolicyGroupMemberResponse[];
    /**
