 ...
 *
 * @deprecated azure-native:network/v20220501:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteConnection to guarantee forwards compatibility.
 */
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteConnection {
        pulumi.log.warn("ExpressRouteConnection is deprecated: azure-native:network/v20220501:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteConnection to guarantee forwards compatibility.")
        return new ExpressRouteConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:ExpressRouteConnection';
     ...
     */
    public readonly expressRouteCircuitPeering!: pulumi.Output<outputs.network.v20220501.ExpressRouteCircuitPeeringIdResponse>;
    /**
...
export interface ExpressRouteConnectionArgs {
     ...
     * The ExpressRoute circuit peering.
     */
    expressRouteCircuitPeering: pulumi.Input<inputs.network.v20220501.ExpressRouteCircuitPeeringIdArgs>;
    /**
     * Enable FastPath to vWan Firewall hub.
     */
