 ...
 *
 * @deprecated azure-native:network/v20220501:ExpressRouteConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteConnection to guarantee forwards compatibility.
 */
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteConnection {
        pulumi.log.warn("ExpressRouteConnection is deprecated: azure-native:network/v20220501:ExpressRouteConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteConnection to guarantee forwards compatibility.")
