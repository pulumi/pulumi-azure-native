 ...
 *
 * @deprecated azure-native:network/v20220501:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.
 */
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PublicIPAddress {
        pulumi.log.warn("PublicIPAddress is deprecated: azure-native:network/v20220501:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.")
        return new PublicIPAddress(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:PublicIPAddress';
     ...
     */
    public readonly ddosSettings!: pulumi.Output<outputs.network.v20220501.DdosSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.network.v20220501.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfiguration!: pulumi.Output<outputs.network.v20220501.IPConfigurationResponse>;
    /**
     * The list of tags associated with the public IP address.
     */
    public readonly ipTags!: pulumi.Output<outputs.network.v20220501.IpTagResponse[] | undefined>;
    /**
     * The linked public IP address of the public IP address resource.
     */
    public readonly linkedPublicIPAddress!: pulumi.Output<outputs.network.v20220501.PublicIPAddressResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly natGateway!: pulumi.Output<outputs.network.v20220501.NatGatewayResponse | undefined>;
    /**
     ...
     */
    public readonly publicIPPrefix!: pulumi.Output<outputs.network.v20220501.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly servicePublicIPAddress!: pulumi.Output<outputs.network.v20220501.PublicIPAddressResponse | undefined>;
    /**
     * The public IP address SKU.
     */
    public readonly sku!: pulumi.Output<outputs.network.v20220501.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The DDoS protection custom policy associated with the public IP address.
     */
    ddosSettings?: pulumi.Input<inputs.network.v20220501.DdosSettingsArgs>;
    /**
     * Specify what happens to the public IP address when the VM using it is deleted
     */
    deleteOption?: pulumi.Input<string | enums.network.v20220501.DeleteOptions>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20220501.PublicIPAddressDnsSettingsArgs>;
    /**
     * The extended location of the public ip address.
     */
     ...
     * The list of tags associated with the public IP address.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.network.v20220501.IpTagArgs>[]>;
    /**
     * The linked public IP address of the public IP address resource.
     */
    linkedPublicIPAddress?: pulumi.Input<inputs.network.v20220501.PublicIPAddressArgs>;
    /**
     * Resource location.
     */
     ...
     * Migration phase of Public IP Address.
     */
    migrationPhase?: pulumi.Input<string | enums.network.v20220501.PublicIPAddressMigrationPhase>;
    /**
     * The NatGateway for the Public IP address.
     */
    natGateway?: pulumi.Input<inputs.network.v20220501.NatGatewayArgs>;
    /**
     * The public IP address version.
     */
    publicIPAddressVersion?: pulumi.Input<string | enums.network.v20220501.IPVersion>;
    /**
     * The public IP address allocation method.
     */
    publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20220501.IPAllocationMethod>;
    /**
     * The Public IP Prefix this Public IP Address should be allocated from.
     */
    publicIPPrefix?: pulumi.Input<inputs.network.v20220501.SubResourceArgs>;
    /**
     ...
     * The service public IP address of the public IP address resource.
     */
    servicePublicIPAddress?: pulumi.Input<inputs.network.v20220501.PublicIPAddressArgs>;
    /**
     * The public IP address SKU.
     */
    sku?: pulumi.Input<inputs.network.v20220501.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */
