...
export function getSecurityAdminConfiguration(args: GetSecurityAdminConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAdminConfigurationResult> {
    pulumi.log.warn("getSecurityAdminConfiguration is deprecated: azure-native:network/v20220501:SecurityAdminConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SecurityAdminConfiguration to guarantee forwards compatibility.")
