...
export class ConfigurationPolicyGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationPolicyGroup {
        pulumi.log.warn("ConfigurationPolicyGroup is deprecated: azure-native:network/v20220501:ConfigurationPolicyGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ConfigurationPolicyGroup to guarantee forwards compatibility.")
        return new ConfigurationPolicyGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:ConfigurationPolicyGroup';
     ...
     */
    public /*out*/ readonly p2SConnectionConfigurations!: pulumi.Output<outputs.network.v20220501.SubResourceResponse[]>;
    /**
     * Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
     */
    public readonly policyMembers!: pulumi.Output<outputs.network.v20220501.VpnServerConfigurationPolicyGroupMemberResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConfigurationPolicyGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ConfigurationPolicyGroup" }, { type: "azure-native:network/v20210801:ConfigurationPolicyGroup" }, { type: "azure-native:network/v20220101:ConfigurationPolicyGroup" }, { type: "azure-native:network/v20220701:ConfigurationPolicyGroup" }, { type: "azure-native:network/v20220901:ConfigurationPolicyGroup" }] };
