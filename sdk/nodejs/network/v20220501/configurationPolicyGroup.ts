...
export class ConfigurationPolicyGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationPolicyGroup {
        pulumi.log.warn("ConfigurationPolicyGroup is deprecated: azure-native:network/v20220501:ConfigurationPolicyGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConfigurationPolicyGroup to guarantee forwards compatibility.")
