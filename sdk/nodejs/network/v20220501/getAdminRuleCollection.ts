...
export function getAdminRuleCollection(args: GetAdminRuleCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetAdminRuleCollectionResult> {
    pulumi.log.warn("getAdminRuleCollection is deprecated: azure-native:network/v20220501:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRuleCollection to guarantee forwards compatibility.")
...
export interface GetAdminRuleCollectionResult {
     ...
     */
    readonly appliesToGroups: outputs.network.v20220501.NetworkManagerSecurityGroupItemResponse[];
    /**
