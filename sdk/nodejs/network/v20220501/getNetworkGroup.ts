 ...
 */
/** @deprecated azure-native:network/v20220501:NetworkGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkGroup to guarantee forwards compatibility. */
export function getNetworkGroup(args: GetNetworkGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkGroupResult> {
    pulumi.log.warn("getNetworkGroup is deprecated: azure-native:network/v20220501:NetworkGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkGroup to guarantee forwards compatibility.")
