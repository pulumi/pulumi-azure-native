...
export class NetworkGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkGroup {
        pulumi.log.warn("NetworkGroup is deprecated: azure-native:network/v20220501:NetworkGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkGroup to guarantee forwards compatibility.")
