 ...
 *
 * @deprecated azure-native:network/v20220501:WebApplicationFirewallPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:WebApplicationFirewallPolicy to guarantee forwards compatibility.
 */
export class WebApplicationFirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:WebApplicationFirewallPolicy';
     ...
     */
    public /*out*/ readonly applicationGateways!: pulumi.Output<outputs.network.v20220501.ApplicationGatewayResponse[]>;
    /**
     * The custom rules inside the policy.
     */
    public readonly customRules!: pulumi.Output<outputs.network.v20220501.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly httpListeners!: pulumi.Output<outputs.network.v20220501.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly managedRules!: pulumi.Output<outputs.network.v20220501.ManagedRulesDefinitionResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly pathBasedRules!: pulumi.Output<outputs.network.v20220501.SubResourceResponse[]>;
    /**
     * The PolicySettings for policy.
     */
    public readonly policySettings!: pulumi.Output<outputs.network.v20220501.PolicySettingsResponse | undefined>;
    /**
...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * The custom rules inside the policy.
     */
    customRules?: pulumi.Input<pulumi.Input<inputs.network.v20220501.WebApplicationFirewallCustomRuleArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Describes the managedRules structure.
     */
    managedRules: pulumi.Input<inputs.network.v20220501.ManagedRulesDefinitionArgs>;
    /**
     ...
     * The PolicySettings for policy.
     */
    policySettings?: pulumi.Input<inputs.network.v20220501.PolicySettingsArgs>;
    /**
