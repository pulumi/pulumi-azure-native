 ...
 *
 * @deprecated azure-native:network/v20220501:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:LoadBalancerBackendAddressPool to guarantee forwards compatibility.
 */
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LoadBalancerBackendAddressPool {
        pulumi.log.warn("LoadBalancerBackendAddressPool is deprecated: azure-native:network/v20220501:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:LoadBalancerBackendAddressPool to guarantee forwards compatibility.")
        return new LoadBalancerBackendAddressPool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:LoadBalancerBackendAddressPool';
     ...
     */
    public /*out*/ readonly backendIPConfigurations!: pulumi.Output<outputs.network.v20220501.NetworkInterfaceIPConfigurationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly inboundNatRules!: pulumi.Output<outputs.network.v20220501.SubResourceResponse[]>;
    /**
     * An array of backend addresses.
     */
    public readonly loadBalancerBackendAddresses!: pulumi.Output<outputs.network.v20220501.LoadBalancerBackendAddressResponse[] | undefined>;
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    public /*out*/ readonly loadBalancingRules!: pulumi.Output<outputs.network.v20220501.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly outboundRule!: pulumi.Output<outputs.network.v20220501.SubResourceResponse>;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    public /*out*/ readonly outboundRules!: pulumi.Output<outputs.network.v20220501.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly tunnelInterfaces!: pulumi.Output<outputs.network.v20220501.GatewayLoadBalancerTunnelInterfaceResponse[] | undefined>;
    /**
...
export interface LoadBalancerBackendAddressPoolArgs {
     ...
     * An array of backend addresses.
     */
    loadBalancerBackendAddresses?: pulumi.Input<pulumi.Input<inputs.network.v20220501.LoadBalancerBackendAddressArgs>[]>;
    /**
     ...
     * An array of gateway load balancer tunnel interfaces.
     */
    tunnelInterfaces?: pulumi.Input<pulumi.Input<inputs.network.v20220501.GatewayLoadBalancerTunnelInterfaceArgs>[]>;
}
