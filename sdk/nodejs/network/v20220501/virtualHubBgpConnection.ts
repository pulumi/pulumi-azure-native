 ...
 *
 * @deprecated azure-native:network/v20220501:VirtualHubBgpConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubBgpConnection to guarantee forwards compatibility.
 */
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHubBgpConnection {
        pulumi.log.warn("VirtualHubBgpConnection is deprecated: azure-native:network/v20220501:VirtualHubBgpConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubBgpConnection to guarantee forwards compatibility.")
        return new VirtualHubBgpConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:VirtualHubBgpConnection';
     ...
     */
    public readonly hubVirtualNetworkConnection!: pulumi.Output<outputs.network.v20220501.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<inputs.network.v20220501.SubResourceArgs>;
    /**
     * Resource ID.
     */
