...
export class VpnServerConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VpnServerConfiguration {
        pulumi.log.warn("VpnServerConfiguration is deprecated: azure-native:network/v20220501:VpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnServerConfiguration to guarantee forwards compatibility.")
        return new VpnServerConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:VpnServerConfiguration';
     ...
     */
    public readonly aadAuthenticationParameters!: pulumi.Output<outputs.network.v20220501.AadAuthenticationParametersResponse | undefined>;
    /**
     * List of all VpnServerConfigurationPolicyGroups.
     */
    public readonly configurationPolicyGroups!: pulumi.Output<outputs.network.v20220501.VpnServerConfigurationPolicyGroupResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly p2SVpnGateways!: pulumi.Output<outputs.network.v20220501.P2SVpnGatewayResponse[]>;
    /**
     ...
     */
    public readonly radiusClientRootCertificates!: pulumi.Output<outputs.network.v20220501.VpnServerConfigRadiusClientRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServerRootCertificates!: pulumi.Output<outputs.network.v20220501.VpnServerConfigRadiusServerRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServers!: pulumi.Output<outputs.network.v20220501.RadiusServerResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly vpnClientIpsecPolicies!: pulumi.Output<outputs.network.v20220501.IpsecPolicyResponse[] | undefined>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRevokedCertificates!: pulumi.Output<outputs.network.v20220501.VpnServerConfigVpnClientRevokedCertificateResponse[] | undefined>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRootCertificates!: pulumi.Output<outputs.network.v20220501.VpnServerConfigVpnClientRootCertificateResponse[] | undefined>;
    /**
...
export interface VpnServerConfigurationArgs {
     ...
     * The set of aad vpn authentication parameters.
     */
    aadAuthenticationParameters?: pulumi.Input<inputs.network.v20220501.AadAuthenticationParametersArgs>;
    /**
     * List of all VpnServerConfigurationPolicyGroups.
     */
    configurationPolicyGroups?: pulumi.Input<pulumi.Input<inputs.network.v20220501.VpnServerConfigurationPolicyGroupArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Radius client root certificate of VpnServerConfiguration.
     */
    radiusClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20220501.VpnServerConfigRadiusClientRootCertificateArgs>[]>;
    /**
     * The radius server address property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Radius Server root certificate of VpnServerConfiguration.
     */
    radiusServerRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20220501.VpnServerConfigRadiusServerRootCertificateArgs>[]>;
    /**
     * The radius secret property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Multiple Radius Server configuration for VpnServerConfiguration.
     */
    radiusServers?: pulumi.Input<pulumi.Input<inputs.network.v20220501.RadiusServerArgs>[]>;
    /**
     ...
     * VPN authentication types for the VpnServerConfiguration.
     */
    vpnAuthenticationTypes?: pulumi.Input<pulumi.Input<string | enums.network.v20220501.VpnAuthenticationType>[]>;
    /**
     * VpnClientIpsecPolicies for VpnServerConfiguration.
     */
    vpnClientIpsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20220501.IpsecPolicyArgs>[]>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    vpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20220501.VpnServerConfigVpnClientRevokedCertificateArgs>[]>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    vpnClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20220501.VpnServerConfigVpnClientRootCertificateArgs>[]>;
    /**
     * VPN protocols for the VpnServerConfiguration.
     */
    vpnProtocols?: pulumi.Input<pulumi.Input<string | enums.network.v20220501.VpnGatewayTunnelingProtocol>[]>;
    /**
