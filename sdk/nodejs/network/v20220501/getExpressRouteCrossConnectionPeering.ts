 ...
 */
/** @deprecated azure-native:network/v20220501:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility. */
export function getExpressRouteCrossConnectionPeering(args: GetExpressRouteCrossConnectionPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCrossConnectionPeeringResult> {
    pulumi.log.warn("getExpressRouteCrossConnectionPeering is deprecated: azure-native:network/v20220501:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220501:getExpressRouteCrossConnectionPeering", {
