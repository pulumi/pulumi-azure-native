 ...
 *
 * @deprecated azure-native:network/v20220501:RouteMap is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteMap to guarantee forwards compatibility.
 */
export class RouteMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:RouteMap';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20220501.RouteMapRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: RouteMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20220701:RouteMap" }, { type: "azure-native:network/v20220901:RouteMap" }] };
...
export interface RouteMapArgs {
     ...
     * List of RouteMap rules to be applied.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20220501.RouteMapRuleArgs>[]>;
    /**
