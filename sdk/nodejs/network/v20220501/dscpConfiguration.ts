 ...
 *
 * @deprecated azure-native:network/v20220501:DscpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.
 */
export class DscpConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DscpConfiguration {
        pulumi.log.warn("DscpConfiguration is deprecated: azure-native:network/v20220501:DscpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.")
        return new DscpConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:DscpConfiguration';
     ...
     */
    public /*out*/ readonly associatedNetworkInterfaces!: pulumi.Output<outputs.network.v20220501.NetworkInterfaceResponse[]>;
    /**
     * Destination IP ranges.
     */
    public readonly destinationIpRanges!: pulumi.Output<outputs.network.v20220501.QosIpRangeResponse[] | undefined>;
    /**
     * Destination port ranges.
     */
    public readonly destinationPortRanges!: pulumi.Output<outputs.network.v20220501.QosPortRangeResponse[] | undefined>;
    /**
     ...
     */
    public readonly qosDefinitionCollection!: pulumi.Output<outputs.network.v20220501.QosDefinitionResponse[] | undefined>;
    /**
     ...
     * Source IP ranges.
     */
    public readonly sourceIpRanges!: pulumi.Output<outputs.network.v20220501.QosIpRangeResponse[] | undefined>;
    /**
     * Sources port ranges.
     */
    public readonly sourcePortRanges!: pulumi.Output<outputs.network.v20220501.QosPortRangeResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface DscpConfigurationArgs {
     ...
     * Destination IP ranges.
     */
    destinationIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20220501.QosIpRangeArgs>[]>;
    /**
     * Destination port ranges.
     */
    destinationPortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20220501.QosPortRangeArgs>[]>;
    /**
     ...
     * RNM supported protocol types.
     */
    protocol?: pulumi.Input<string | enums.network.v20220501.ProtocolType>;
    /**
     * QoS object definitions
     */
    qosDefinitionCollection?: pulumi.Input<pulumi.Input<inputs.network.v20220501.QosDefinitionArgs>[]>;
    /**
     ...
     * Source IP ranges.
     */
    sourceIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20220501.QosIpRangeArgs>[]>;
    /**
     * Sources port ranges.
     */
    sourcePortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20220501.QosPortRangeArgs>[]>;
    /**
     * Resource tags.
     */
