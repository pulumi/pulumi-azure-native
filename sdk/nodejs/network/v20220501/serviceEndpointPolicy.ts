 ...
 *
 * @deprecated azure-native:network/v20220501:ServiceEndpointPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ServiceEndpointPolicy to guarantee forwards compatibility.
 */
export class ServiceEndpointPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceEndpointPolicy {
        pulumi.log.warn("ServiceEndpointPolicy is deprecated: azure-native:network/v20220501:ServiceEndpointPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ServiceEndpointPolicy to guarantee forwards compatibility.")
        return new ServiceEndpointPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:ServiceEndpointPolicy';
     ...
     */
    public readonly serviceEndpointPolicyDefinitions!: pulumi.Output<outputs.network.v20220501.ServiceEndpointPolicyDefinitionResponse[] | undefined>;
    /**
     * A collection of references to subnets.
     */
    public /*out*/ readonly subnets!: pulumi.Output<outputs.network.v20220501.SubnetResponse[]>;
    /**
     * Resource tags.
     */
...
export interface ServiceEndpointPolicyArgs {
     ...
     * A collection of service endpoint policy definitions of the service endpoint policy.
     */
    serviceEndpointPolicyDefinitions?: pulumi.Input<pulumi.Input<inputs.network.v20220501.ServiceEndpointPolicyDefinitionArgs>[]>;
    /**
