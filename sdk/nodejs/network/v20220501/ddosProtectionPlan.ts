...
export class DdosProtectionPlan extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly publicIpAddresses!: pulumi.Output<outputs.network.v20220501.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly virtualNetworks!: pulumi.Output<outputs.network.v20220501.SubResourceResponse[]>;
