...
export function getIpAllocation(args: GetIpAllocationArgs, opts?: pulumi.InvokeOptions): Promise<GetIpAllocationResult> {
    pulumi.log.warn("getIpAllocation is deprecated: azure-native:network/v20220501:IpAllocation is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:IpAllocation to guarantee forwards compatibility.")
...
export interface GetIpAllocationResult {
     ...
     */
    readonly subnet: outputs.network.v20220501.SubResourceResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetwork: outputs.network.v20220501.SubResourceResponse;
}
/**
 * Gets the specified IpAllocation by resource group.
 */
