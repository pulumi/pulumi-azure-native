...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkGatewayConnection {
        pulumi.log.warn("VirtualNetworkGatewayConnection is deprecated: azure-native:network/v20220501:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkGatewayConnection to guarantee forwards compatibility.")
