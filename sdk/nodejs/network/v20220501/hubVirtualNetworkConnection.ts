...
export class HubVirtualNetworkConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HubVirtualNetworkConnection {
        pulumi.log.warn("HubVirtualNetworkConnection is deprecated: azure-native:network/v20220501:HubVirtualNetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:HubVirtualNetworkConnection to guarantee forwards compatibility.")
        return new HubVirtualNetworkConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:HubVirtualNetworkConnection';
     ...
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.network.v20220501.SubResourceResponse | undefined>;
    /**
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    public readonly routingConfiguration!: pulumi.Output<outputs.network.v20220501.RoutingConfigurationResponse | undefined>;
...
export interface HubVirtualNetworkConnectionArgs {
     ...
     * Reference to the remote virtual network.
     */
    remoteVirtualNetwork?: pulumi.Input<inputs.network.v20220501.SubResourceArgs>;
    /**
     ...
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    routingConfiguration?: pulumi.Input<inputs.network.v20220501.RoutingConfigurationArgs>;
    /**
