...
export class DefaultAdminRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DefaultAdminRule {
        pulumi.log.warn("DefaultAdminRule is deprecated: azure-native:network/v20220501:DefaultAdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:DefaultAdminRule to guarantee forwards compatibility.")
        return new DefaultAdminRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:DefaultAdminRule';
     ...
     */
    public /*out*/ readonly destinations!: pulumi.Output<outputs.network.v20220501.AddressPrefixItemResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sources!: pulumi.Output<outputs.network.v20220501.AddressPrefixItemResponse[]>;
    /**
