...
export function getIpAllocation(args: GetIpAllocationArgs, opts?: pulumi.InvokeOptions): Promise<GetIpAllocationResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200701:getIpAllocation", {
        "expand": args.expand,
...
export interface GetIpAllocationResult {
     ...
     */
    readonly subnet: outputs.network.v20200701.SubResourceInvokeResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetwork: outputs.network.v20200701.SubResourceInvokeResponse;
}
