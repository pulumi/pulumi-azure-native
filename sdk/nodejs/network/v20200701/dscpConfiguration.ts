...
export class DscpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20200701:DscpConfiguration';
    ...
    constructor(name: string, args: DscpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:DscpConfiguration" }, { type: "azure-nextgen:network/latest:DscpConfiguration" }, { type: "azure-nextgen:network/v20200601:DscpConfiguration" }, { type: "azure-nextgen:network/v20200801:DscpConfiguration" }] };
