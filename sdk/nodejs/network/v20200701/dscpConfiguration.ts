 ...
 *
 * @deprecated azure-native:network/v20200701:DscpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.
 */
export class DscpConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DscpConfiguration {
        pulumi.log.warn("DscpConfiguration is deprecated: azure-native:network/v20200701:DscpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.")
