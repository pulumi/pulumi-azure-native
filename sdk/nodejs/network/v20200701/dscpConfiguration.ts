...
export class DscpConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DscpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200701:DscpConfiguration" }, { type: "azure-native:network:DscpConfiguration" }, { type: "azure-nextgen:network:DscpConfiguration" }, { type: "azure-native:network/latest:DscpConfiguration" }, { type: "azure-nextgen:network/latest:DscpConfiguration" }, { type: "azure-native:network/v20200601:DscpConfiguration" }, { type: "azure-nextgen:network/v20200601:DscpConfiguration" }, { type: "azure-native:network/v20200801:DscpConfiguration" }, { type: "azure-nextgen:network/v20200801:DscpConfiguration" }, { type: "azure-native:network/v20201101:DscpConfiguration" }, { type: "azure-nextgen:network/v20201101:DscpConfiguration" }] };
...
export interface DscpConfigurationArgs {
     ...
     * Destination IP ranges.
     */
    readonly destinationIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20200701.QosIpRange>[]>;
    /**
     * Destination port ranges.
     */
    readonly destinationPortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20200701.QosPortRange>[]>;
    /**
     ...
     * Source IP ranges.
     */
    readonly sourceIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20200701.QosIpRange>[]>;
    /**
     * Sources port ranges.
     */
    readonly sourcePortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20200701.QosPortRange>[]>;
    /**
     * Resource tags.
     */
