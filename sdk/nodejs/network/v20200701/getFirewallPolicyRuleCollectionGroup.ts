...
export function getFirewallPolicyRuleCollectionGroup(args: GetFirewallPolicyRuleCollectionGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleCollectionGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200701:getFirewallPolicyRuleCollectionGroup", {
...
export interface GetFirewallPolicyRuleCollectionGroupResult {
     ...
     */
    readonly ruleCollections?: outputs.network.v20200701.FirewallPolicyFilterRuleCollectionInvokeResponse | outputs.network.v20200701.FirewallPolicyNatRuleCollectionInvokeResponse[];
    /**
     * Rule Group type.
     */
