...
export function getPrivateLinkServicePrivateEndpointConnection(args: GetPrivateLinkServicePrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateLinkServicePrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200701:getPrivateLinkServicePrivateEndpointConnection", {
        "expand": args.expand,
...
export interface GetPrivateLinkServicePrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint: outputs.network.v20200701.PrivateEndpointInvokeResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState?: outputs.network.v20200701.PrivateLinkServiceConnectionStateInvokeResponse;
    /**
