...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly autoScaleConfiguration?: outputs.network.v20200701.ExpressRouteGatewayPropertiesInvokeResponseAutoScaleConfiguration;
    /**
     ...
     */
    readonly expressRouteConnections: outputs.network.v20200701.ExpressRouteConnectionInvokeResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly virtualHub: outputs.network.v20200701.VirtualHubIdInvokeResponse;
}
