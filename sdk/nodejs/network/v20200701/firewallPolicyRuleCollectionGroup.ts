 ...
 *
 * @deprecated azure-native:network/v20200701:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.
 */
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FirewallPolicyRuleCollectionGroup {
        pulumi.log.warn("FirewallPolicyRuleCollectionGroup is deprecated: azure-native:network/v20200701:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.")
