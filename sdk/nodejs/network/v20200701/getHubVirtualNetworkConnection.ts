...
export function getHubVirtualNetworkConnection(args: GetHubVirtualNetworkConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetHubVirtualNetworkConnectionResult> {
    pulumi.log.warn("getHubVirtualNetworkConnection is deprecated: azure-native:network/v20200701:HubVirtualNetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:HubVirtualNetworkConnection to guarantee forwards compatibility.")
