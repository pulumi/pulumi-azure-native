...
export function getFlowLog(args: GetFlowLogArgs, opts?: pulumi.InvokeOptions): Promise<GetFlowLogResult> {
    pulumi.log.warn("getFlowLog is deprecated: azure-native:network/v20200701:FlowLog is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FlowLog to guarantee forwards compatibility.")
