...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    pulumi.log.warn("getExpressRouteCircuit is deprecated: azure-native:network/v20200701:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuit to guarantee forwards compatibility.")
