...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200701:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly remoteVpnSite?: outputs.network.v20200701.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: outputs.network.v20200701.VpnSiteLinkConnectionInvokeResponse[];
}
