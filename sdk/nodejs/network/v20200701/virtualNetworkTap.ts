 ...
 *
 * @deprecated azure-native:network/v20200701:VirtualNetworkTap is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkTap to guarantee forwards compatibility.
 */
export class VirtualNetworkTap extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkTapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["destinationLoadBalancerFrontEndIPConfiguration"] = args ? (args.destinationLoadBalancerFrontEndIPConfiguration ? pulumi.output(args.destinationLoadBalancerFrontEndIPConfiguration).apply(inputs.network.v20200701.frontendIPConfigurationArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["destinationNetworkInterfaceIPConfiguration"] = args ? (args.destinationNetworkInterfaceIPConfiguration ? pulumi.output(args.destinationNetworkInterfaceIPConfiguration).apply(inputs.network.v20200701.networkInterfaceIPConfigurationArgsProvideDefaults) : undefined) : undefined;
