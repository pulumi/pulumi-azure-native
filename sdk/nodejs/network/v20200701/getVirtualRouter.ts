...
export function getVirtualRouter(args: GetVirtualRouterArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200701:getVirtualRouter", {
        "expand": args.expand,
...
export interface GetVirtualRouterResult {
     ...
     */
    readonly hostedGateway?: outputs.network.v20200701.SubResourceInvokeResponse;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    readonly hostedSubnet?: outputs.network.v20200701.SubResourceInvokeResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly peerings: outputs.network.v20200701.SubResourceInvokeResponse[];
    /**
