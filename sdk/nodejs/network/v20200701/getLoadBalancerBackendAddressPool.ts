...
export interface GetLoadBalancerBackendAddressPoolResult {
     ...
     */
    readonly backendIPConfigurations: outputs.network.v20200701.NetworkInterfaceIPConfigurationInvokeResponse[];
    /**
     ...
     */
    readonly loadBalancerBackendAddresses?: outputs.network.v20200701.LoadBalancerBackendAddressInvokeResponse[];
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    readonly loadBalancingRules: outputs.network.v20200701.SubResourceInvokeResponse[];
    /**
     ...
     */
    readonly outboundRule: outputs.network.v20200701.SubResourceInvokeResponse;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    readonly outboundRules: outputs.network.v20200701.SubResourceInvokeResponse[];
    /**
