...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20200701:VirtualNetworkPeering';
     ...
     */
    public readonly remoteVirtualNetworkAddressSpace!: pulumi.Output<outputs.network.v20200701.AddressSpaceResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The reference to the current address space of the remote virtual network.
     */
    readonly remoteVirtualNetworkAddressSpace?: pulumi.Input<inputs.network.v20200701.AddressSpace>;
    /**
