 ...
 *
 * @deprecated azure-native:network/v20200701:DdosProtectionPlan is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.
 */
export class DdosProtectionPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200701:DdosProtectionPlan';
     ...
     */
    public /*out*/ readonly virtualNetworks!: pulumi.Output<outputs.network.v20200701.SubResourceResponse[]>;
