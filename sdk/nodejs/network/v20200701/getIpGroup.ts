...
export function getIpGroup(args: GetIpGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetIpGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200701:getIpGroup", {
        "expand": args.expand,
...
export interface GetIpGroupResult {
     ...
     */
    readonly firewallPolicies: outputs.network.v20200701.SubResourceInvokeResponse[];
    /**
     * List of references to Firewall resources that this IpGroups is associated with.
     */
    readonly firewalls: outputs.network.v20200701.SubResourceInvokeResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
