...
export function getPrivateDnsZoneGroup(args: GetPrivateDnsZoneGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateDnsZoneGroupResult> {
    pulumi.log.warn("getPrivateDnsZoneGroup is deprecated: azure-native:network/v20200701:PrivateDnsZoneGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210201:PrivateDnsZoneGroup to guarantee forwards compatibility.")
