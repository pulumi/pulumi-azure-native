...
export function getSecurityRule(args: GetSecurityRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200701:getSecurityRule", {
...
export interface GetSecurityRuleResult {
     ...
     */
    readonly destinationApplicationSecurityGroups?: outputs.network.v20200701.ApplicationSecurityGroupInvokeResponse[];
    /**
     ...
     */
    readonly sourceApplicationSecurityGroups?: outputs.network.v20200701.ApplicationSecurityGroupInvokeResponse[];
    /**
