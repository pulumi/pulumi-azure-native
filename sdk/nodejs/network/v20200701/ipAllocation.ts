...
export class IpAllocation extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly subnet!: pulumi.Output<outputs.network.v20200701.SubResourceResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly virtualNetwork!: pulumi.Output<outputs.network.v20200701.SubResourceResponse>;
    ...
    constructor(name: string, args: IpAllocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200701:IpAllocation" }, { type: "azure-native:network:IpAllocation" }, { type: "azure-nextgen:network:IpAllocation" }, { type: "azure-native:network/v20200301:IpAllocation" }, { type: "azure-nextgen:network/v20200301:IpAllocation" }, { type: "azure-native:network/v20200401:IpAllocation" }, { type: "azure-nextgen:network/v20200401:IpAllocation" }, { type: "azure-native:network/v20200501:IpAllocation" }, { type: "azure-nextgen:network/v20200501:IpAllocation" }, { type: "azure-native:network/v20200601:IpAllocation" }, { type: "azure-nextgen:network/v20200601:IpAllocation" }, { type: "azure-native:network/v20200801:IpAllocation" }, { type: "azure-nextgen:network/v20200801:IpAllocation" }, { type: "azure-native:network/v20201101:IpAllocation" }, { type: "azure-nextgen:network/v20201101:IpAllocation" }, { type: "azure-native:network/v20210201:IpAllocation" }, { type: "azure-nextgen:network/v20210201:IpAllocation" }, { type: "azure-native:network/v20210301:IpAllocation" }, { type: "azure-nextgen:network/v20210301:IpAllocation" }, { type: "azure-native:network/v20210501:IpAllocation" }, { type: "azure-nextgen:network/v20210501:IpAllocation" }] };
...
export interface IpAllocationArgs {
     ...
     * The address prefix Type for the IpAllocation.
     */
    prefixType?: pulumi.Input<string | enums.network.v20200701.IPVersion>;
    /**
     ...
     */
    type?: pulumi.Input<string | enums.network.v20200701.IpAllocationType>;
}
