...
export class ExpressRouteCircuitConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:ExpressRouteCircuitConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.ExpressRouteCircuitConnectionPropertiesFormatResponse>;
    /**
...
export interface ExpressRouteCircuitConnectionArgs {
     ...
     * Properties of the express route circuit connection.
     */
    readonly properties?: pulumi.Input<inputs.network.ExpressRouteCircuitConnectionPropertiesFormat>;
    /**
