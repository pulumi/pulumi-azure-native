...
export class NetworkVirtualApplianceVirtualApplianceSite extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkVirtualApplianceVirtualApplianceSiteState, opts?: pulumi.CustomResourceOptions): NetworkVirtualApplianceVirtualApplianceSite {
        return new NetworkVirtualApplianceVirtualApplianceSite(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: NetworkVirtualApplianceVirtualApplianceSiteArgs | NetworkVirtualApplianceVirtualApplianceSiteState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as NetworkVirtualApplianceVirtualApplianceSiteState | undefined;
 ...
 * Virtual Appliance Site resource.
 */
export interface NetworkVirtualApplianceVirtualApplianceSiteState {
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The properties of the Virtual Appliance Sites.
     */
    readonly properties: pulumi.Input<inputs.network.VirtualApplianceSitePropertiesResponse>;
    /**
     * Site type.
     */
