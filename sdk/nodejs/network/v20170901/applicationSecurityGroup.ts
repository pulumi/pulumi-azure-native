 ...
 *
 * const applicationSecurityGroup = new azurerm.network.v20170901.ApplicationSecurityGroup("applicationSecurityGroup", {
...
export class ApplicationSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170901:ApplicationSecurityGroup';
