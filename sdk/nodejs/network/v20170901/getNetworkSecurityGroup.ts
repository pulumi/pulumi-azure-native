...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20170901:getNetworkSecurityGroup", {
        "expand": args.expand,
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules?: outputs.network.v20170901.SecurityRuleInvokeResponse[];
    /**
     ...
     */
    readonly networkInterfaces: outputs.network.v20170901.NetworkInterfaceInvokeResponse[];
    /**
     ...
     */
    readonly securityRules?: outputs.network.v20170901.SecurityRuleInvokeResponse[];
    /**
