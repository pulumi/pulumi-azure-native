...
export class RecordSet extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: RecordSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20150504preview:RecordSet" }, { type: "azurerm:network/v20160401:RecordSet" }, { type: "azurerm:network/v20171001:RecordSet" }, { type: "azurerm:network/v20180301preview:RecordSet" }, { type: "azurerm:network/v20180501:RecordSet" }] };
