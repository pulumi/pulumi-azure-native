...
export class Zone extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ZoneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Zone" }, { type: "azurerm:network/preview:Zone" }, { type: "azurerm:network/v20150504preview:Zone" }, { type: "azurerm:network/v20160401:Zone" }, { type: "azurerm:network/v20171001:Zone" }, { type: "azurerm:network/v20180301preview:Zone" }, { type: "azurerm:network/v20180501:Zone" }] };
