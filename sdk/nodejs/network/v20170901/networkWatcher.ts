...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170901:NetworkWatcher';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20170901.NetworkWatcherPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkWatcherArgs {
     ...
     * The network watcher properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20170901.NetworkWatcherPropertiesFormat>;
    /**
