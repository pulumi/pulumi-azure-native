...
export function getPacketCapture(args: GetPacketCaptureArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCaptureResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20170901:getPacketCapture", {
        "name": args.name,
...
export interface GetPacketCaptureResult {
     ...
     */
    readonly properties: outputs.network.v20170901.PacketCaptureResultPropertiesResponse;
}
