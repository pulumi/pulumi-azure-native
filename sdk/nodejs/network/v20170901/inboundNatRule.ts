...
azure-native:network/v20170901:InboundNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:InboundNatRule to guarantee forwards compatibility.
 */
export class InboundNatRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InboundNatRule {
        pulumi.log.warn("InboundNatRule is deprecated: Version 2017-09-01 will be removed in v2 of the provider.\nazure-native:network/v20170901:InboundNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:InboundNatRule to guarantee forwards compatibility.")
