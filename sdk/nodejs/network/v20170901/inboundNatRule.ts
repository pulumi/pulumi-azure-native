...
export class InboundNatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20170901:InboundNatRule';
     ...
     */
    public /*out*/ readonly backendIPConfiguration!: pulumi.Output<outputs.network.v20170901.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    public readonly frontendIPConfiguration!: pulumi.Output<outputs.network.v20170901.SubResourceResponse | undefined>;
    /**
...
export interface InboundNatRuleArgs {
     ...
     * A reference to frontend IP addresses.
     */
    readonly frontendIPConfiguration?: pulumi.Input<inputs.network.v20170901.SubResourceArgs>;
    /**
     * The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values range from 1 to 65534.
     */
     ...
     * The transport protocol for the endpoint. Possible values are 'Udp' or 'Tcp' or 'All.'
     */
    readonly protocol?: pulumi.Input<string | enums.network.v20170901.TransportProtocol>;
    /**
     * Gets the provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
