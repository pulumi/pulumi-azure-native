...
export function getPublicIPAddress(args: GetPublicIPAddressArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPAddressResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20170901:getPublicIPAddress", {
        "expand": args.expand,
...
export interface GetPublicIPAddressResult {
     ...
     */
    readonly dnsSettings?: outputs.network.v20170901.PublicIPAddressDnsSettingsInvokeResponse;
    /**
     ...
     */
    readonly ipConfiguration: outputs.network.v20170901.IPConfigurationInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.v20170901.PublicIPAddressSkuInvokeResponse;
    /**
     * Resource tags.
     */
