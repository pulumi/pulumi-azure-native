...
export function getApplicationSecurityGroup(args: GetApplicationSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20170901:getApplicationSecurityGroup", {
        "name": args.name,
...
export interface GetApplicationSecurityGroupResult {
     ...
     */
    readonly properties: outputs.network.v20170901.ApplicationSecurityGroupPropertiesFormatResponse;
    /**
     * Resource tags.
     */
