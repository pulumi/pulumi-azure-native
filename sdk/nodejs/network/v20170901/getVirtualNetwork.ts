...
azure-native:network/v20170901:VirtualNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:VirtualNetwork to guarantee forwards compatibility. */
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    pulumi.log.warn("getVirtualNetwork is deprecated: Version 2017-09-01 will be removed in v2 of the provider.\nazure-native:network/v20170901:VirtualNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:VirtualNetwork to guarantee forwards compatibility.")
