...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20160330:getLocalNetworkGateway", {
...
export interface GetLocalNetworkGatewayResult {
     ...
     */
    readonly bgpSettings?: outputs.network.v20160330.BgpSettingsInvokeResponse;
    /**
     ...
     */
    readonly localNetworkAddressSpace?: outputs.network.v20160330.AddressSpaceInvokeResponse;
    /**
     * Resource location
     */
