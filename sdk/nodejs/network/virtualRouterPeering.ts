...
export class VirtualRouterPeering extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualRouterPeeringState, opts?: pulumi.CustomResourceOptions): VirtualRouterPeering {
        return new VirtualRouterPeering(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: VirtualRouterPeeringArgs | VirtualRouterPeeringState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as VirtualRouterPeeringState | undefined;
 ...
 * Virtual Router Peering resource.
 */
export interface VirtualRouterPeeringState {
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The properties of the Virtual Router Peering.
     */
    readonly properties: pulumi.Input<inputs.network.VirtualRouterPeeringPropertiesResponse>;
    /**
     * Peering type.
     */
