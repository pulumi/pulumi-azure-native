...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:ExpressRouteCircuitPeering';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.ExpressRouteCircuitPeeringPropertiesFormatResponse>;
    /**
...
export interface ExpressRouteCircuitPeeringState {
     ...
     * Properties of the express route circuit peering.
     */
    readonly properties: pulumi.Input<inputs.network.ExpressRouteCircuitPeeringPropertiesFormatResponse>;
    /**
     * Type of the resource.
     */
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * Properties of the express route circuit peering.
     */
    readonly properties?: pulumi.Input<inputs.network.ExpressRouteCircuitPeeringPropertiesFormat>;
    /**
