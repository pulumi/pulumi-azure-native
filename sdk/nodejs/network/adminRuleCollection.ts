...
export class AdminRuleCollection extends pulumi.CustomResource {
     ...
     */
    declare public readonly appliesToGroups: pulumi.Output<outputs.network.NetworkManagerSecurityGroupItemResponse[]>;
    /**
