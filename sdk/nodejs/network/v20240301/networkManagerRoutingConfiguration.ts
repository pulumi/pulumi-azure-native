...
export class NetworkManagerRoutingConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:NetworkManagerRoutingConfiguration';
    ...
    constructor(name: string, args: NetworkManagerRoutingConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkManagerRoutingConfiguration" }, { type: "azure-native:network/v20240501:NetworkManagerRoutingConfiguration" }] };
