...
export function getExpressRoutePort(args: GetExpressRoutePortArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240301:getExpressRoutePort", {
...
export interface GetExpressRoutePortResult {
     ...
     */
    readonly circuits: outputs.network.v20240301.SubResourceResponse[];
    /**
     ...
     */
    readonly identity?: outputs.network.v20240301.ManagedServiceIdentityResponse;
    /**
     * The set of physical links of the ExpressRoutePort resource.
     */
    readonly links?: outputs.network.v20240301.ExpressRouteLinkResponse[];
    /**
     * Resource location.
     */
...
export function getExpressRoutePortOutput(args: GetExpressRoutePortOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetExpressRoutePortResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240301:getExpressRoutePort", {
        "expressRoutePortName": args.expressRoutePortName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
