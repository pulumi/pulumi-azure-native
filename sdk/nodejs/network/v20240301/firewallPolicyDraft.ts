...
export class FirewallPolicyDraft extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FirewallPolicyDraftArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:FirewallPolicyDraft" }, { type: "azure-native:network/v20231101:FirewallPolicyDraft" }, { type: "azure-native:network/v20240101:FirewallPolicyDraft" }] };
