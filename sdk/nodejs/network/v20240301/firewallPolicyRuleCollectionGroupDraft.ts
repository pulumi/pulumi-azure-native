...
export class FirewallPolicyRuleCollectionGroupDraft extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:FirewallPolicyRuleCollectionGroupDraft';
     ...
     */
    public readonly ruleCollections!: pulumi.Output<(outputs.network.v20240301.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20240301.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
    ...
    constructor(name: string, args: FirewallPolicyRuleCollectionGroupDraftArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:FirewallPolicyRuleCollectionGroupDraft" }, { type: "azure-native:network/v20231101:FirewallPolicyRuleCollectionGroupDraft" }, { type: "azure-native:network/v20240101:FirewallPolicyRuleCollectionGroupDraft" }] };
