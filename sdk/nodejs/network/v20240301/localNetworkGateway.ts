...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:LocalNetworkGateway';
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.v20240301.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    localNetworkAddressSpace?: pulumi.Input<inputs.network.v20240301.AddressSpaceArgs>;
    /**
