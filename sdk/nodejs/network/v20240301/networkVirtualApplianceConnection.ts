...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20240301.NetworkVirtualApplianceConnectionPropertiesResponse>;
...
export interface NetworkVirtualApplianceConnectionArgs {
     ...
     * Properties of the express route connection.
     */
    properties?: pulumi.Input<inputs.network.v20240301.NetworkVirtualApplianceConnectionPropertiesArgs>;
    /**
