...
export class ConnectivityConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:ConnectivityConfiguration';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20240301.ConnectivityGroupItemResponse[]>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<outputs.network.v20240301.HubResponse[] | undefined>;
    /**
