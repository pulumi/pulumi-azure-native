...
export class SecurityUserRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:SecurityUserRuleCollection';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20240301.SecurityUserGroupItemResponse[]>;
    /**
    ...
    constructor(name: string, args: SecurityUserRuleCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:SecurityUserRuleCollection" }, { type: "azure-native:network/v20210201preview:SecurityUserRuleCollection" }, { type: "azure-native:network/v20210501preview:SecurityUserRuleCollection" }, { type: "azure-native:network/v20220201preview:SecurityUserRuleCollection" }, { type: "azure-native:network/v20220401preview:SecurityUserRuleCollection" }, { type: "azure-native:network/v20240501:SecurityUserRuleCollection" }] };
...
export interface SecurityUserRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20240301.SecurityUserGroupItemArgs>[]>;
    /**
