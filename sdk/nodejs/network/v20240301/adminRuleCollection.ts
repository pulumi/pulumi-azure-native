...
export class AdminRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:AdminRuleCollection';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20240301.NetworkManagerSecurityGroupItemResponse[]>;
    /**
