...
export class WebApplicationFirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:WebApplicationFirewallPolicy';
     ...
     */
    public /*out*/ readonly applicationGatewayForContainers!: pulumi.Output<outputs.network.v20240301.ApplicationGatewayForContainersReferenceDefinitionResponse[]>;
    /**
     * A collection of references to application gateways.
     */
    public /*out*/ readonly applicationGateways!: pulumi.Output<outputs.network.v20240301.ApplicationGatewayResponse[]>;
    /**
     * The custom rules inside the policy.
     */
    public readonly customRules!: pulumi.Output<outputs.network.v20240301.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly httpListeners!: pulumi.Output<outputs.network.v20240301.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly managedRules!: pulumi.Output<outputs.network.v20240301.ManagedRulesDefinitionResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly pathBasedRules!: pulumi.Output<outputs.network.v20240301.SubResourceResponse[]>;
    /**
     * The PolicySettings for policy.
     */
    public readonly policySettings!: pulumi.Output<outputs.network.v20240301.PolicySettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WebApplicationFirewallPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["policySettings"] = args ? (args.policySettings ? pulumi.output(args.policySettings).apply(inputs.network.v20240301.policySettingsArgsProvideDefaults) : undefined) : undefined;
