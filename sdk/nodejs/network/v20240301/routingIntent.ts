...
export class RoutingIntent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:RoutingIntent';
     ...
     */
    public readonly routingPolicies!: pulumi.Output<outputs.network.v20240301.RoutingPolicyResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface RoutingIntentArgs {
     ...
     * List of routing policies.
     */
    routingPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20240301.RoutingPolicyArgs>[]>;
    /**
