...
export class PacketCapture extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:PacketCapture';
     ...
     */
    public readonly captureSettings!: pulumi.Output<outputs.network.v20240301.PacketCaptureSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly filters!: pulumi.Output<outputs.network.v20240301.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    public readonly scope!: pulumi.Output<outputs.network.v20240301.PacketCaptureMachineScopeResponse | undefined>;
    /**
     * The storage location for a packet capture session.
     */
    public readonly storageLocation!: pulumi.Output<outputs.network.v20240301.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * The capture setting holds the 'FileCount', 'FileSizeInBytes', 'SessionTimeLimitInSeconds' values.
     */
    captureSettings?: pulumi.Input<inputs.network.v20240301.PacketCaptureSettingsArgs>;
    /**
     * This continuous capture is a nullable boolean, which can hold 'null', 'true' or 'false' value. If we do not pass this parameter, it would be consider as 'null', default value is 'null'.
     */
     ...
     * A list of packet capture filters.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.network.v20240301.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * A list of AzureVMSS instances which can be included or excluded to run packet capture. If both included and excluded are empty, then the packet capture will run on all instances of AzureVMSS.
     */
    scope?: pulumi.Input<inputs.network.v20240301.PacketCaptureMachineScopeArgs>;
    /**
     * The storage location for a packet capture session.
     */
    storageLocation: pulumi.Input<inputs.network.v20240301.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
     */
     ...
     * Target type of the resource provided.
     */
    targetType?: pulumi.Input<enums.network.v20240301.PacketCaptureTargetType>;
    /**
     * Maximum duration of the capture session in seconds.
     */
