...
export class ExpressRoutePortAuthorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:ExpressRoutePortAuthorization';
