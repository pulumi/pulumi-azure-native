...
export class RoutingRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240301:RoutingRule';
     ...
     */
    public readonly destination!: pulumi.Output<outputs.network.v20240301.RoutingRuleRouteDestinationResponse>;
    /**
     ...
     */
    public readonly nextHop!: pulumi.Output<outputs.network.v20240301.RoutingRuleNextHopResponse>;
    /**
    ...
    constructor(name: string, args: RoutingRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:RoutingRule" }] };
