...
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly ruleCollections: pulumi.Output<(outputs.network.FirewallPolicyFilterRuleCollectionResponse | outputs.network.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.FirewallPolicyFilterRuleCollectionArgs | inputs.network.FirewallPolicyNatRuleCollectionArgs>[] | undefined>;
}
