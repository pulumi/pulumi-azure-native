...
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:FirewallPolicyRuleCollectionGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.FirewallPolicyRuleCollectionGroupPropertiesResponse>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleCollectionGroupState {
     ...
     * The properties of the firewall policy rule collection group.
     */
    readonly properties: pulumi.Input<inputs.network.FirewallPolicyRuleCollectionGroupPropertiesResponse>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * The properties of the firewall policy rule collection group.
     */
    readonly properties?: pulumi.Input<inputs.network.FirewallPolicyRuleCollectionGroupProperties>;
    /**
