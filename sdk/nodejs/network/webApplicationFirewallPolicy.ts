...
export class WebApplicationFirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network:WebApplicationFirewallPolicy';
...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * The custom rules inside the policy.
     */
    readonly customRules?: pulumi.Input<pulumi.Input<inputs.network.WebApplicationFirewallCustomRule>[]>;
    /**
     * Resource ID.
     */
     ...
     * Describes the managedRules structure.
     */
    readonly managedRules: pulumi.Input<inputs.network.ManagedRulesDefinition>;
    /**
