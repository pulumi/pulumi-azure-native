...
export class RoutingRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:RoutingRuleCollection';
     ...
     */
    public readonly appliesTo!: pulumi.Output<outputs.network.v20240501.NetworkManagerRoutingGroupItemResponse[]>;
    /**
    ...
    constructor(name: string, args: RoutingRuleCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20240301:RoutingRuleCollection" }, { type: "azure-native:network:RoutingRuleCollection" }] };
