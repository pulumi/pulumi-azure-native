...
export class StaticCidr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:StaticCidr';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20240501.StaticCidrPropertiesResponse>;
    /**
...
export interface StaticCidrArgs {
     ...
     * Properties of static CIDR resource.
     */
    properties?: pulumi.Input<inputs.network.v20240501.StaticCidrPropertiesArgs>;
    /**
