...
export class RoutingRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:RoutingRule';
     ...
     */
    public readonly destination!: pulumi.Output<outputs.network.v20240501.RoutingRuleRouteDestinationResponse>;
    /**
     ...
     */
    public readonly nextHop!: pulumi.Output<outputs.network.v20240501.RoutingRuleNextHopResponse>;
    /**
    ...
    constructor(name: string, args: RoutingRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20240301:RoutingRule" }, { type: "azure-native:network:RoutingRule" }] };
...
export interface RoutingRuleArgs {
     ...
     * Indicates the destination for this particular rule.
     */
    destination: pulumi.Input<inputs.network.v20240501.RoutingRuleRouteDestinationArgs>;
    /**
     ...
     * Indicates the next hop for this particular rule.
     */
    nextHop: pulumi.Input<inputs.network.v20240501.RoutingRuleNextHopArgs>;
    /**
