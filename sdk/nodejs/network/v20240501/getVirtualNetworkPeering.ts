...
export function getVirtualNetworkPeering(args: GetVirtualNetworkPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240501:getVirtualNetworkPeering", {
...
export interface GetVirtualNetworkPeeringResult {
     ...
     */
    readonly localAddressSpace?: outputs.network.v20240501.AddressSpaceResponse;
    /**
     ...
     */
    readonly localVirtualNetworkAddressSpace?: outputs.network.v20240501.AddressSpaceResponse;
    /**
     ...
     */
    readonly remoteAddressSpace?: outputs.network.v20240501.AddressSpaceResponse;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    readonly remoteBgpCommunities?: outputs.network.v20240501.VirtualNetworkBgpCommunitiesResponse;
    /**
     ...
     */
    readonly remoteVirtualNetworkAddressSpace?: outputs.network.v20240501.AddressSpaceResponse;
    /**
     * The reference to the remote virtual network's encryption
     */
    readonly remoteVirtualNetworkEncryption: outputs.network.v20240501.VirtualNetworkEncryptionResponse;
    /**
...
export function getVirtualNetworkPeeringOutput(args: GetVirtualNetworkPeeringOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVirtualNetworkPeeringResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240501:getVirtualNetworkPeering", {
        "resourceGroupName": args.resourceGroupName,
        "virtualNetworkName": args.virtualNetworkName,
        "virtualNetworkPeeringName": args.virtualNetworkPeeringName,
    }, opts);
