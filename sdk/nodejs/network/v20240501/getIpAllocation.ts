...
export function getIpAllocation(args: GetIpAllocationArgs, opts?: pulumi.InvokeOptions): Promise<GetIpAllocationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240501:getIpAllocation", {
        "expand": args.expand,
...
export interface GetIpAllocationResult {
     ...
     */
    readonly subnet: outputs.network.v20240501.SubResourceResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetwork: outputs.network.v20240501.SubResourceResponse;
}
/**
 * Gets the specified IpAllocation by resource group.
 */
export function getIpAllocationOutput(args: GetIpAllocationOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetIpAllocationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240501:getIpAllocation", {
        "expand": args.expand,
        "ipAllocationName": args.ipAllocationName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
