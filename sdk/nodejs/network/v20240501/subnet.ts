...
export class Subnet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:Subnet';
     ...
     */
    public readonly applicationGatewayIPConfigurations!: pulumi.Output<outputs.network.v20240501.ApplicationGatewayIPConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public readonly delegations!: pulumi.Output<outputs.network.v20240501.DelegationResponse[] | undefined>;
    /**
     ...
     */
    public readonly ipAllocations!: pulumi.Output<outputs.network.v20240501.SubResourceResponse[] | undefined>;
    /**
     * Array of IP configuration profiles which reference this subnet.
     */
    public /*out*/ readonly ipConfigurationProfiles!: pulumi.Output<outputs.network.v20240501.IPConfigurationProfileResponse[]>;
    /**
     * An array of references to the network interface IP configurations using subnet.
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.v20240501.IPConfigurationResponse[]>;
    /**
     * A list of IPAM Pools for allocating IP address prefixes.
     */
    public readonly ipamPoolPrefixAllocations!: pulumi.Output<outputs.network.v20240501.IpamPoolPrefixAllocationResponse[] | undefined>;
    /**
     ...
     */
    public readonly natGateway!: pulumi.Output<outputs.network.v20240501.SubResourceResponse | undefined>;
    /**
     * The reference to the NetworkSecurityGroup resource.
     */
    public readonly networkSecurityGroup!: pulumi.Output<outputs.network.v20240501.NetworkSecurityGroupResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpoints!: pulumi.Output<outputs.network.v20240501.PrivateEndpointResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly resourceNavigationLinks!: pulumi.Output<outputs.network.v20240501.ResourceNavigationLinkResponse[]>;
    /**
     * The reference to the RouteTable resource.
     */
    public readonly routeTable!: pulumi.Output<outputs.network.v20240501.RouteTableResponse | undefined>;
    /**
     * An array of references to services injecting into this subnet.
     */
    public /*out*/ readonly serviceAssociationLinks!: pulumi.Output<outputs.network.v20240501.ServiceAssociationLinkResponse[]>;
    /**
     * An array of service endpoint policies.
     */
    public readonly serviceEndpointPolicies!: pulumi.Output<outputs.network.v20240501.ServiceEndpointPolicyResponse[] | undefined>;
    /**
     * An array of service endpoints.
     */
    public readonly serviceEndpoints!: pulumi.Output<outputs.network.v20240501.ServiceEndpointPropertiesFormatResponse[] | undefined>;
    /**
...
export interface SubnetArgs {
     ...
     * Application gateway IP configurations of virtual network resource.
     */
    applicationGatewayIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20240501.ApplicationGatewayIPConfigurationArgs>[]>;
    /**
     * Set this property to false to disable default outbound connectivity for all VMs in the subnet. This property can only be set at the time of subnet creation and cannot be updated for an existing subnet.
     */
     ...
     * An array of references to the delegations on the subnet.
     */
    delegations?: pulumi.Input<pulumi.Input<inputs.network.v20240501.DelegationArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Array of IpAllocation which reference this subnet.
     */
    ipAllocations?: pulumi.Input<pulumi.Input<inputs.network.v20240501.SubResourceArgs>[]>;
    /**
     * A list of IPAM Pools for allocating IP address prefixes.
     */
    ipamPoolPrefixAllocations?: pulumi.Input<pulumi.Input<inputs.network.v20240501.IpamPoolPrefixAllocationArgs>[]>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * Nat gateway associated with this subnet.
     */
    natGateway?: pulumi.Input<inputs.network.v20240501.SubResourceArgs>;
    /**
     * The reference to the NetworkSecurityGroup resource.
     */
    networkSecurityGroup?: pulumi.Input<inputs.network.v20240501.NetworkSecurityGroupArgs>;
    /**
     * Enable or Disable apply network policies on private end point in the subnet.
     */
    privateEndpointNetworkPolicies?: pulumi.Input<string | enums.network.v20240501.VirtualNetworkPrivateEndpointNetworkPolicies>;
    /**
     * Enable or Disable apply network policies on private link service in the subnet.
     */
    privateLinkServiceNetworkPolicies?: pulumi.Input<string | enums.network.v20240501.VirtualNetworkPrivateLinkServiceNetworkPolicies>;
    /**
     ...
     * The reference to the RouteTable resource.
     */
    routeTable?: pulumi.Input<inputs.network.v20240501.RouteTableArgs>;
    /**
     * An array of service endpoint policies.
     */
    serviceEndpointPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20240501.ServiceEndpointPolicyArgs>[]>;
    /**
     * An array of service endpoints.
     */
    serviceEndpoints?: pulumi.Input<pulumi.Input<inputs.network.v20240501.ServiceEndpointPropertiesFormatArgs>[]>;
    /**
     * Set this property to Tenant to allow sharing subnet with other subscriptions in your AAD tenant. This property can only be set if defaultOutboundAccess is set to false, both properties can only be set if subnet is empty.
     */
    sharingScope?: pulumi.Input<string | enums.network.v20240501.SharingScope>;
    /**
