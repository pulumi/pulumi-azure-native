...
export class PacketCapture extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:PacketCapture';
     ...
     */
    public readonly captureSettings!: pulumi.Output<outputs.network.v20240501.PacketCaptureSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly filters!: pulumi.Output<outputs.network.v20240501.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    public readonly scope!: pulumi.Output<outputs.network.v20240501.PacketCaptureMachineScopeResponse | undefined>;
    /**
     * The storage location for a packet capture session.
     */
    public readonly storageLocation!: pulumi.Output<outputs.network.v20240501.PacketCaptureStorageLocationResponse>;
    /**
    ...
    constructor(name: string, args: PacketCaptureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["captureSettings"] = args ? (args.captureSettings ? pulumi.output(args.captureSettings).apply(inputs.network.v20240501.packetCaptureSettingsArgsProvideDefaults) : undefined) : undefined;
