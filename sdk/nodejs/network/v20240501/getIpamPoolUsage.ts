...
export function getIpamPoolUsage(args: GetIpamPoolUsageArgs, opts?: pulumi.InvokeOptions): Promise<GetIpamPoolUsageResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240501:getIpamPoolUsage", {
...
export interface GetIpamPoolUsageResult {
     ...
     */
    readonly childPools: outputs.network.v20240501.ResourceBasicsResponse[];
    /**
...
export function getIpamPoolUsageOutput(args: GetIpamPoolUsageOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetIpamPoolUsageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240501:getIpamPoolUsage", {
        "networkManagerName": args.networkManagerName,
        "poolName": args.poolName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
