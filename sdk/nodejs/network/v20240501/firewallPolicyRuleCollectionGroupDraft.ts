...
export class FirewallPolicyRuleCollectionGroupDraft extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:FirewallPolicyRuleCollectionGroupDraft';
