...
export function getExpressRouteCircuitConnection(args: GetExpressRouteCircuitConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240501:getExpressRouteCircuitConnection", {
...
export interface GetExpressRouteCircuitConnectionResult {
     ...
     */
    readonly expressRouteCircuitPeering?: outputs.network.v20240501.SubResourceResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly ipv6CircuitConnectionConfig?: outputs.network.v20240501.Ipv6CircuitConnectionConfigResponse;
    /**
     ...
     */
    readonly peerExpressRouteCircuitPeering?: outputs.network.v20240501.SubResourceResponse;
    /**
...
export function getExpressRouteCircuitConnectionOutput(args: GetExpressRouteCircuitConnectionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetExpressRouteCircuitConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240501:getExpressRouteCircuitConnection", {
        "circuitName": args.circuitName,
        "connectionName": args.connectionName,
        "peeringName": args.peeringName,
        "resourceGroupName": args.resourceGroupName,
