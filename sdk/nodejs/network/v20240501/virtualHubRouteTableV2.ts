...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:VirtualHubRouteTableV2';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.v20240501.VirtualHubRouteV2Response[] | undefined>;
