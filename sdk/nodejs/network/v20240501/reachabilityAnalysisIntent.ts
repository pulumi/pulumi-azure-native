...
export class ReachabilityAnalysisIntent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:ReachabilityAnalysisIntent';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20240501.ReachabilityAnalysisIntentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ReachabilityAnalysisIntentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ReachabilityAnalysisIntent" }, { type: "azure-native:network/v20240101preview:ReachabilityAnalysisIntent" }] };
...
export interface ReachabilityAnalysisIntentArgs {
     ...
     * Represents the Reachability Analysis Intent properties.
     */
    properties: pulumi.Input<inputs.network.v20240501.ReachabilityAnalysisIntentPropertiesArgs>;
    /**
