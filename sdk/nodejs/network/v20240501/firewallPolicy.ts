...
export class FirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:FirewallPolicy';
     ...
     */
    public /*out*/ readonly childPolicies!: pulumi.Output<outputs.network.v20240501.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly firewalls!: pulumi.Output<outputs.network.v20240501.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly ruleCollectionGroups!: pulumi.Output<outputs.network.v20240501.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20240501.FirewallPolicySkuResponse | undefined>;
    /**
     ...
     */
    public readonly transportSecurity!: pulumi.Output<outputs.network.v20240501.FirewallPolicyTransportSecurityResponse | undefined>;
    /**
     * Resource type.
     */
...
export interface FirewallPolicyArgs {
     ...
     * The Firewall Policy SKU.
     */
    sku?: pulumi.Input<inputs.network.v20240501.FirewallPolicySkuArgs>;
    /**
     * The private IP addresses/IP ranges to which traffic will not be SNAT.
     */
     ...
     * TLS Configuration definition.
     */
    transportSecurity?: pulumi.Input<inputs.network.v20240501.FirewallPolicyTransportSecurityArgs>;
}
