...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:NetworkVirtualApplianceConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20240501.NetworkVirtualApplianceConnectionPropertiesResponse>;
...
export interface NetworkVirtualApplianceConnectionArgs {
     ...
     * Properties of the express route connection.
     */
    properties?: pulumi.Input<inputs.network.v20240501.NetworkVirtualApplianceConnectionPropertiesArgs>;
    /**
