...
export class SecurityUserRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:SecurityUserRuleCollection';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20240501.SecurityUserGroupItemResponse[]>;
    /**
...
export interface SecurityUserRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20240501.SecurityUserGroupItemArgs>[]>;
    /**
