...
export class VerifierWorkspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:VerifierWorkspace';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20240501.VerifierWorkspacePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: VerifierWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VerifierWorkspace" }, { type: "azure-native:network/v20240101preview:VerifierWorkspace" }] };
...
export interface VerifierWorkspaceArgs {
     ...
     * Properties of Verifier Workspace resource.
     */
    properties?: pulumi.Input<inputs.network.v20240501.VerifierWorkspacePropertiesArgs>;
    /**
