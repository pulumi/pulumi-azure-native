...
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240501:ExpressRouteCircuit';
     ...
     */
    public readonly authorizations!: pulumi.Output<outputs.network.v20240501.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly expressRoutePort!: pulumi.Output<outputs.network.v20240501.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly peerings!: pulumi.Output<outputs.network.v20240501.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceProviderProperties!: pulumi.Output<outputs.network.v20240501.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    public readonly sku!: pulumi.Output<outputs.network.v20240501.ExpressRouteCircuitSkuResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitArgs {
     ...
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.network.v20240501.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    expressRoutePort?: pulumi.Input<inputs.network.v20240501.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    peerings?: pulumi.Input<pulumi.Input<inputs.network.v20240501.ExpressRouteCircuitPeeringArgs>[]>;
    /**
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<inputs.network.v20240501.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource.
     */
    serviceProviderProvisioningState?: pulumi.Input<string | enums.network.v20240501.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    sku?: pulumi.Input<inputs.network.v20240501.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */
