...
export function getDscpConfiguration(args: GetDscpConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscpConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240501:getDscpConfiguration", {
...
export interface GetDscpConfigurationResult {
     ...
     */
    readonly associatedNetworkInterfaces: outputs.network.v20240501.NetworkInterfaceResponse[];
    /**
     * Destination IP ranges.
     */
    readonly destinationIpRanges?: outputs.network.v20240501.QosIpRangeResponse[];
    /**
     * Destination port ranges.
     */
    readonly destinationPortRanges?: outputs.network.v20240501.QosPortRangeResponse[];
    /**
     ...
     */
    readonly qosDefinitionCollection?: outputs.network.v20240501.QosDefinitionResponse[];
    /**
     ...
     * Source IP ranges.
     */
    readonly sourceIpRanges?: outputs.network.v20240501.QosIpRangeResponse[];
    /**
     * Sources port ranges.
     */
    readonly sourcePortRanges?: outputs.network.v20240501.QosPortRangeResponse[];
    /**
     * Resource tags.
     */
...
export function getDscpConfigurationOutput(args: GetDscpConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDscpConfigurationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240501:getDscpConfiguration", {
        "dscpConfigurationName": args.dscpConfigurationName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
