...
export class Zone extends pulumi.CustomResource {
     ...
     */
    public readonly registrationVirtualNetworks!: pulumi.Output<outputs.network.SubResourceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ZoneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:Zone" }, { type: "azure-native:network/latest:Zone" }, { type: "azure-nextgen:network/latest:Zone" }, { type: "azure-native:network/v20150504preview:Zone" }, { type: "azure-nextgen:network/v20150504preview:Zone" }, { type: "azure-native:network/v20160401:Zone" }, { type: "azure-nextgen:network/v20160401:Zone" }, { type: "azure-native:network/v20170901:Zone" }, { type: "azure-nextgen:network/v20170901:Zone" }, { type: "azure-native:network/v20171001:Zone" }, { type: "azure-nextgen:network/v20171001:Zone" }, { type: "azure-native:network/v20180301preview:Zone" }, { type: "azure-nextgen:network/v20180301preview:Zone" }, { type: "azure-native:network/v20180501:Zone" }, { type: "azure-nextgen:network/v20180501:Zone" }] };
...
export interface ZoneArgs {
     ...
     * A list of references to virtual networks that register hostnames in this DNS zone. This is a only when ZoneType is Private.
     */
    readonly registrationVirtualNetworks?: pulumi.Input<pulumi.Input<inputs.network.SubResource>[]>;
    /**
     * A list of references to virtual networks that resolve records in this DNS zone. This is a only when ZoneType is Private.
     */
    readonly resolutionVirtualNetworks?: pulumi.Input<pulumi.Input<inputs.network.SubResource>[]>;
    /**
