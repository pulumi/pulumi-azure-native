...
export class FirewallPolicyDraft extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FirewallPolicyDraftArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20231101:FirewallPolicyDraft" }, { type: "azure-native:network/v20240101:FirewallPolicyDraft" }, { type: "azure-native:network/v20240301:FirewallPolicyDraft" }, { type: "azure-native:network/v20240501:FirewallPolicyDraft" }, { type: "azure-native:network/v20240701:FirewallPolicyDraft" }, { type: "azure-native:network/v20241001:FirewallPolicyDraft" }, { type: "azure-native:network/v20250101:FirewallPolicyDraft" }] };
