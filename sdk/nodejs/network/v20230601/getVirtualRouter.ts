...
export interface GetVirtualRouterResult {
     ...
     */
    readonly hostedGateway?: outputs.network.v20230601.SubResourceResponse;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    readonly hostedSubnet?: outputs.network.v20230601.SubResourceResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly peerings: outputs.network.v20230601.SubResourceResponse[];
    /**
...
export function getVirtualRouterOutput(args: GetVirtualRouterOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVirtualRouterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230601:getVirtualRouter", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "virtualRouterName": args.virtualRouterName,
    }, opts);
