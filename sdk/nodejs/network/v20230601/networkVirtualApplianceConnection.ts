...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20230601.NetworkVirtualApplianceConnectionPropertiesResponse>;
    ...
    constructor(name: string, args: NetworkVirtualApplianceConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20230901:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20231101:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20240101:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20240301:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20240501:NetworkVirtualApplianceConnection" }] };
...
export interface NetworkVirtualApplianceConnectionArgs {
     ...
     * Properties of the express route connection.
     */
    properties?: pulumi.Input<inputs.network.v20230601.NetworkVirtualApplianceConnectionPropertiesArgs>;
    /**
