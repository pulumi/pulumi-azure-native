...
export class P2sVpnGateway extends pulumi.CustomResource {
     ...
     */
    public readonly p2SConnectionConfigurations!: pulumi.Output<outputs.network.v20230601.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vpnClientConnectionHealth!: pulumi.Output<outputs.network.v20230601.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    public readonly vpnServerConfiguration!: pulumi.Output<outputs.network.v20230601.SubResourceResponse | undefined>;
