...
export class LocalNetworkGateway extends pulumi.CustomResource {
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.v20230601.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    localNetworkAddressSpace?: pulumi.Input<inputs.network.v20230601.AddressSpaceArgs>;
    /**
