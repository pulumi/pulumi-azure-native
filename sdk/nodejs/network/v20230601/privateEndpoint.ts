...
export class PrivateEndpoint extends pulumi.CustomResource {
     ...
     */
    public readonly applicationSecurityGroups!: pulumi.Output<outputs.network.v20230601.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     * An array of custom dns configurations.
     */
    public readonly customDnsConfigs!: pulumi.Output<outputs.network.v20230601.CustomDnsConfigPropertiesFormatResponse[] | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20230601.PrivateEndpointIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly manualPrivateLinkServiceConnections!: pulumi.Output<outputs.network.v20230601.PrivateLinkServiceConnectionResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.network.v20230601.NetworkInterfaceResponse[]>;
    /**
     * A grouping of information about the connection to the remote resource.
     */
    public readonly privateLinkServiceConnections!: pulumi.Output<outputs.network.v20230601.PrivateLinkServiceConnectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly subnet!: pulumi.Output<outputs.network.v20230601.SubnetResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: PrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["subnet"] = args ? (args.subnet ? pulumi.output(args.subnet).apply(inputs.network.v20230601.subnetArgsProvideDefaults) : undefined) : undefined;
...
export interface PrivateEndpointArgs {
     ...
     * Application security groups in which the private endpoint IP configuration is included.
     */
    applicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20230601.ApplicationSecurityGroupArgs>[]>;
    /**
     * An array of custom dns configurations.
     */
    customDnsConfigs?: pulumi.Input<pulumi.Input<inputs.network.v20230601.CustomDnsConfigPropertiesFormatArgs>[]>;
    /**
     * The custom name of the network interface attached to the private endpoint.
     */
     ...
     * A list of IP configurations of the private endpoint. This will be used to map to the First Party Service's endpoints.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20230601.PrivateEndpointIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * A grouping of information about the connection to the remote resource. Used when the network admin does not have access to approve connections to the remote resource.
     */
    manualPrivateLinkServiceConnections?: pulumi.Input<pulumi.Input<inputs.network.v20230601.PrivateLinkServiceConnectionArgs>[]>;
    /**
     ...
     * A grouping of information about the connection to the remote resource.
     */
    privateLinkServiceConnections?: pulumi.Input<pulumi.Input<inputs.network.v20230601.PrivateLinkServiceConnectionArgs>[]>;
    /**
     ...
     * The ID of the subnet from which the private IP will be allocated.
     */
    subnet?: pulumi.Input<inputs.network.v20230601.SubnetArgs>;
    /**
     * Resource tags.
     */
