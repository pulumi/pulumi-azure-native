...
export class Subnet extends pulumi.CustomResource {
     ...
     */
    public readonly applicationGatewayIPConfigurations!: pulumi.Output<outputs.network.v20230601.ApplicationGatewayIPConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public readonly delegations!: pulumi.Output<outputs.network.v20230601.DelegationResponse[] | undefined>;
    /**
     ...
     */
    public readonly ipAllocations!: pulumi.Output<outputs.network.v20230601.SubResourceResponse[] | undefined>;
    /**
     * Array of IP configuration profiles which reference this subnet.
     */
    public /*out*/ readonly ipConfigurationProfiles!: pulumi.Output<outputs.network.v20230601.IPConfigurationProfileResponse[]>;
    /**
     * An array of references to the network interface IP configurations using subnet.
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.v20230601.IPConfigurationResponse[]>;
    /**
     ...
     */
    public readonly natGateway!: pulumi.Output<outputs.network.v20230601.SubResourceResponse | undefined>;
    /**
     * The reference to the NetworkSecurityGroup resource.
     */
    public readonly networkSecurityGroup!: pulumi.Output<outputs.network.v20230601.NetworkSecurityGroupResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpoints!: pulumi.Output<outputs.network.v20230601.PrivateEndpointResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly resourceNavigationLinks!: pulumi.Output<outputs.network.v20230601.ResourceNavigationLinkResponse[]>;
    /**
     * The reference to the RouteTable resource.
     */
    public readonly routeTable!: pulumi.Output<outputs.network.v20230601.RouteTableResponse | undefined>;
    /**
     * An array of references to services injecting into this subnet.
     */
    public /*out*/ readonly serviceAssociationLinks!: pulumi.Output<outputs.network.v20230601.ServiceAssociationLinkResponse[]>;
    /**
     * An array of service endpoint policies.
     */
    public readonly serviceEndpointPolicies!: pulumi.Output<outputs.network.v20230601.ServiceEndpointPolicyResponse[] | undefined>;
    /**
     * An array of service endpoints.
     */
    public readonly serviceEndpoints!: pulumi.Output<outputs.network.v20230601.ServiceEndpointPropertiesFormatResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface SubnetArgs {
     ...
     * Application gateway IP configurations of virtual network resource.
     */
    applicationGatewayIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20230601.ApplicationGatewayIPConfigurationArgs>[]>;
    /**
     * Set this property to false to disable default outbound connectivity for all VMs in the subnet. This property can only be set at the time of subnet creation and cannot be updated for an existing subnet.
     */
     ...
     * An array of references to the delegations on the subnet.
     */
    delegations?: pulumi.Input<pulumi.Input<inputs.network.v20230601.DelegationArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Array of IpAllocation which reference this subnet.
     */
    ipAllocations?: pulumi.Input<pulumi.Input<inputs.network.v20230601.SubResourceArgs>[]>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * Nat gateway associated with this subnet.
     */
    natGateway?: pulumi.Input<inputs.network.v20230601.SubResourceArgs>;
    /**
     * The reference to the NetworkSecurityGroup resource.
     */
    networkSecurityGroup?: pulumi.Input<inputs.network.v20230601.NetworkSecurityGroupArgs>;
    /**
     * Enable or Disable apply network policies on private end point in the subnet.
     */
    privateEndpointNetworkPolicies?: pulumi.Input<string | enums.network.v20230601.VirtualNetworkPrivateEndpointNetworkPolicies>;
    /**
     * Enable or Disable apply network policies on private link service in the subnet.
     */
    privateLinkServiceNetworkPolicies?: pulumi.Input<string | enums.network.v20230601.VirtualNetworkPrivateLinkServiceNetworkPolicies>;
    /**
     ...
     * The reference to the RouteTable resource.
     */
    routeTable?: pulumi.Input<inputs.network.v20230601.RouteTableArgs>;
    /**
     * An array of service endpoint policies.
     */
    serviceEndpointPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20230601.ServiceEndpointPolicyArgs>[]>;
    /**
     * An array of service endpoints.
     */
    serviceEndpoints?: pulumi.Input<pulumi.Input<inputs.network.v20230601.ServiceEndpointPropertiesFormatArgs>[]>;
    /**
