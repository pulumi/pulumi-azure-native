...
export class SecurityPartnerProvider extends pulumi.CustomResource {
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.v20230601.SubResourceResponse | undefined>;
...
export interface SecurityPartnerProviderArgs {
     ...
     * The security provider name.
     */
    securityProviderName?: pulumi.Input<string | enums.network.v20230601.SecurityProviderName>;
    /**
     * Resource tags.
     */
     ...
     * The virtualHub to which the Security Partner Provider belongs.
     */
    virtualHub?: pulumi.Input<inputs.network.v20230601.SubResourceArgs>;
}
