...
export class AdminRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230601:AdminRule';
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.network.v20230601.AddressPrefixItemResponse[] | undefined>;
    /**
     ...
     */
    public readonly sources!: pulumi.Output<outputs.network.v20230601.AddressPrefixItemResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: AdminRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:AdminRule" }, { type: "azure-native:network/v20210201preview:AdminRule" }, { type: "azure-native:network/v20210501preview:AdminRule" }, { type: "azure-native:network/v20220101:AdminRule" }, { type: "azure-native:network/v20220201preview:AdminRule" }, { type: "azure-native:network/v20220401preview:AdminRule" }, { type: "azure-native:network/v20220501:AdminRule" }, { type: "azure-native:network/v20220701:AdminRule" }, { type: "azure-native:network/v20220901:AdminRule" }, { type: "azure-native:network/v20221101:AdminRule" }, { type: "azure-native:network/v20230201:AdminRule" }, { type: "azure-native:network/v20230401:AdminRule" }, { type: "azure-native:network/v20230501:AdminRule" }, { type: "azure-native:network/v20230901:AdminRule" }, { type: "azure-native:network/v20231101:AdminRule" }, { type: "azure-native:network/v20240101:AdminRule" }, { type: "azure-native:network/v20240101preview:AdminRule" }, { type: "azure-native:network/v20240301:AdminRule" }, { type: "azure-native:network/v20240501:AdminRule" }] };
...
export interface AdminRuleArgs {
     ...
     * Indicates the access allowed for this particular rule
     */
    access: pulumi.Input<string | enums.network.v20230601.SecurityConfigurationRuleAccess>;
    /**
     ...
     * The destination address prefixes. CIDR or destination IP ranges.
     */
    destinations?: pulumi.Input<pulumi.Input<inputs.network.v20230601.AddressPrefixItemArgs>[]>;
    /**
     * Indicates if the traffic matched against the rule in inbound or outbound.
     */
    direction: pulumi.Input<string | enums.network.v20230601.SecurityConfigurationRuleDirection>;
    /**
     * Whether the rule is custom or default.
     * Expected value is 'Custom'.
     */
     ...
     * Network protocol this rule applies to.
     */
    protocol: pulumi.Input<string | enums.network.v20230601.SecurityConfigurationRuleProtocol>;
    /**
     ...
     * The CIDR or source IP ranges.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.network.v20230601.AddressPrefixItemArgs>[]>;
}
