 ...
 *
 * @deprecated azure-native:network/v20210801:PrivateDnsZoneGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateDnsZoneGroup to guarantee forwards compatibility.
 */
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateDnsZoneGroup {
        pulumi.log.warn("PrivateDnsZoneGroup is deprecated: azure-native:network/v20210801:PrivateDnsZoneGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateDnsZoneGroup to guarantee forwards compatibility.")
