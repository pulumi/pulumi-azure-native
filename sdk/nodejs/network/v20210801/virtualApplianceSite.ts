 ...
 *
 * @deprecated azure-native:network/v20210801:VirtualApplianceSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualApplianceSite to guarantee forwards compatibility.
 */
export class VirtualApplianceSite extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualApplianceSite {
        pulumi.log.warn("VirtualApplianceSite is deprecated: azure-native:network/v20210801:VirtualApplianceSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualApplianceSite to guarantee forwards compatibility.")
        return new VirtualApplianceSite(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:VirtualApplianceSite';
     ...
     * Office 365 Policy.
     */
    public readonly o365Policy!: pulumi.Output<outputs.network.v20210801.Office365PolicyPropertiesResponse | undefined>;
    /**
