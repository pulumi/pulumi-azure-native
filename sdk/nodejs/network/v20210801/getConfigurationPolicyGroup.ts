...
export function getConfigurationPolicyGroup(args: GetConfigurationPolicyGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetConfigurationPolicyGroupResult> {
    pulumi.log.warn("getConfigurationPolicyGroup is deprecated: azure-native:network/v20210801:ConfigurationPolicyGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConfigurationPolicyGroup to guarantee forwards compatibility.")
