 ...
 *
 * @deprecated azure-native:network/v20210801:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AzureFirewall to guarantee forwards compatibility.
 */
export class AzureFirewall extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AzureFirewall {
        pulumi.log.warn("AzureFirewall is deprecated: azure-native:network/v20210801:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AzureFirewall to guarantee forwards compatibility.")
