 ...
 *
 * @deprecated azure-native:network/v20210801:ConfigurationPolicyGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConfigurationPolicyGroup to guarantee forwards compatibility.
 */
export class ConfigurationPolicyGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationPolicyGroup {
        pulumi.log.warn("ConfigurationPolicyGroup is deprecated: azure-native:network/v20210801:ConfigurationPolicyGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConfigurationPolicyGroup to guarantee forwards compatibility.")
        return new ConfigurationPolicyGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:ConfigurationPolicyGroup';
     ...
     */
    public /*out*/ readonly p2SConnectionConfigurations!: pulumi.Output<outputs.network.v20210801.SubResourceResponse[]>;
    /**
     * Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
     */
    public readonly policyMembers!: pulumi.Output<outputs.network.v20210801.VpnServerConfigurationPolicyGroupMemberResponse[] | undefined>;
    /**
