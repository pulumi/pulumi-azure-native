 ...
 */
/** @deprecated azure-native:network/v20210801:VirtualNetworkPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkPeering to guarantee forwards compatibility. */
export function getVirtualNetworkPeering(args: GetVirtualNetworkPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkPeeringResult> {
    pulumi.log.warn("getVirtualNetworkPeering is deprecated: azure-native:network/v20210801:VirtualNetworkPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkPeering to guarantee forwards compatibility.")
