 ...
 *
 * @deprecated azure-native:network/v20210801:ServiceEndpointPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ServiceEndpointPolicy to guarantee forwards compatibility.
 */
export class ServiceEndpointPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceEndpointPolicy {
        pulumi.log.warn("ServiceEndpointPolicy is deprecated: azure-native:network/v20210801:ServiceEndpointPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ServiceEndpointPolicy to guarantee forwards compatibility.")
        return new ServiceEndpointPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:ServiceEndpointPolicy';
     ...
     */
    public readonly serviceEndpointPolicyDefinitions!: pulumi.Output<outputs.network.v20210801.ServiceEndpointPolicyDefinitionResponse[] | undefined>;
    /**
