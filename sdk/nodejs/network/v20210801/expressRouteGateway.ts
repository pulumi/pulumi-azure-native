...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteGateway {
        pulumi.log.warn("ExpressRouteGateway is deprecated: azure-native:network/v20210801:ExpressRouteGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteGateway to guarantee forwards compatibility.")
