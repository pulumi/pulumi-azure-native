 ...
 *
 * @deprecated azure-native:network/v20210801:VirtualRouter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualRouter to guarantee forwards compatibility.
 */
export class VirtualRouter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualRouter {
        pulumi.log.warn("VirtualRouter is deprecated: azure-native:network/v20210801:VirtualRouter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualRouter to guarantee forwards compatibility.")
        return new VirtualRouter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:VirtualRouter';
     ...
     */
    public readonly hostedGateway!: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    public readonly hostedSubnet!: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly peerings!: pulumi.Output<outputs.network.v20210801.SubResourceResponse[]>;
    /**
