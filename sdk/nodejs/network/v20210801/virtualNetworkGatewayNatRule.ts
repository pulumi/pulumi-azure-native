 ...
 *
 * @deprecated azure-native:network/v20210801:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.
 */
export class VirtualNetworkGatewayNatRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkGatewayNatRule {
        pulumi.log.warn("VirtualNetworkGatewayNatRule is deprecated: azure-native:network/v20210801:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.")
        return new VirtualNetworkGatewayNatRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:VirtualNetworkGatewayNatRule';
    ...
    constructor(name: string, args: VirtualNetworkGatewayNatRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210201:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210301:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210501:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20220101:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20220501:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20220701:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20220901:VirtualNetworkGatewayNatRule" }] };
