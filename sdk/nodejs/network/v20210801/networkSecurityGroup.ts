 ...
 *
 * @deprecated azure-native:network/v20210801:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.
 */
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkSecurityGroup {
        pulumi.log.warn("NetworkSecurityGroup is deprecated: azure-native:network/v20210801:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.")
        return new NetworkSecurityGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:NetworkSecurityGroup';
     ...
     */
    public /*out*/ readonly defaultSecurityRules!: pulumi.Output<outputs.network.v20210801.SecurityRuleResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly flowLogs!: pulumi.Output<outputs.network.v20210801.FlowLogResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.network.v20210801.NetworkInterfaceResponse[]>;
    /**
     ...
     */
    public readonly securityRules!: pulumi.Output<outputs.network.v20210801.SecurityRuleResponse[] | undefined>;
    /**
     * A collection of references to subnets.
     */
    public /*out*/ readonly subnets!: pulumi.Output<outputs.network.v20210801.SubnetResponse[]>;
    /**
     * Resource tags.
     */
