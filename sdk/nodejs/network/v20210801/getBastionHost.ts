...
export function getBastionHost(args: GetBastionHostArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionHostResult> {
    pulumi.log.warn("getBastionHost is deprecated: azure-native:network/v20210801:BastionHost is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:BastionHost to guarantee forwards compatibility.")
