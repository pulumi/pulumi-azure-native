 ...
 * VirtualHub Resource.
 *
 * @deprecated azure-native:network/v20210801:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHub to guarantee forwards compatibility.
 */
export class VirtualHub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHub {
        pulumi.log.warn("VirtualHub is deprecated: azure-native:network/v20210801:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHub to guarantee forwards compatibility.")
        return new VirtualHub(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:VirtualHub';
     ...
     */
    public readonly azureFirewall!: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
    /**
     * List of references to Bgp Connections.
     */
    public /*out*/ readonly bgpConnections!: pulumi.Output<outputs.network.v20210801.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly expressRouteGateway!: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.v20210801.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly p2SVpnGateway!: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly routeTable!: pulumi.Output<outputs.network.v20210801.VirtualHubRouteTableResponse | undefined>;
    /**
     * The routing state.
     */
     ...
     */
    public readonly securityPartnerProvider!: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly virtualHubRouteTableV2s!: pulumi.Output<outputs.network.v20210801.VirtualHubRouteTableV2Response[] | undefined>;
    /**
     * VirtualRouter ASN.
     */
     ...
     */
    public readonly virtualWan!: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
    /**
     * The VpnGateway associated with this VirtualHub.
     */
    public readonly vpnGateway!: pulumi.Output<outputs.network.v20210801.SubResourceResponse | undefined>;
