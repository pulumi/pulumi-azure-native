...
export class ExpressRouteCircuitAuthorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:ExpressRouteCircuitAuthorization';
