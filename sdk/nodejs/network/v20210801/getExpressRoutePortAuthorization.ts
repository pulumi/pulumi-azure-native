...
export function getExpressRoutePortAuthorization(args: GetExpressRoutePortAuthorizationArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortAuthorizationResult> {
    pulumi.log.warn("getExpressRoutePortAuthorization is deprecated: azure-native:network/v20210801:ExpressRoutePortAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRoutePortAuthorization to guarantee forwards compatibility.")
