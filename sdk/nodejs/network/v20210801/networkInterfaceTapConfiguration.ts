 ...
 *
 * @deprecated azure-native:network/v20210801:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.
 */
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:NetworkInterfaceTapConfiguration';
     ...
     */
    public readonly virtualNetworkTap!: pulumi.Output<outputs.network.v20210801.VirtualNetworkTapResponse | undefined>;
    ...
    constructor(name: string, args: NetworkInterfaceTapConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["virtualNetworkTap"] = args ? (args.virtualNetworkTap ? pulumi.output(args.virtualNetworkTap).apply(inputs.network.v20210801.virtualNetworkTapArgsProvideDefaults) : undefined) : undefined;
