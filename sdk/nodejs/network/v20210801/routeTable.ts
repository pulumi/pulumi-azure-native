 ...
 *
 * @deprecated azure-native:network/v20210801:RouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteTable to guarantee forwards compatibility.
 */
export class RouteTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RouteTable {
        pulumi.log.warn("RouteTable is deprecated: azure-native:network/v20210801:RouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteTable to guarantee forwards compatibility.")
        return new RouteTable(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210801:RouteTable';
     ...
     */
    public readonly routes!: pulumi.Output<outputs.network.v20210801.RouteResponse[] | undefined>;
    /**
