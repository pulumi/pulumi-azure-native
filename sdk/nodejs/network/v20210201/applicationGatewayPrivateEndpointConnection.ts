 ...
 *
 * @deprecated azure-native:network/v20210201:ApplicationGatewayPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ApplicationGatewayPrivateEndpointConnection to guarantee forwards compatibility.
 */
export class ApplicationGatewayPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201:ApplicationGatewayPrivateEndpointConnection';
