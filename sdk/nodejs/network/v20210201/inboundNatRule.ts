...
export class InboundNatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201:InboundNatRule';
     ...
     */
    public /*out*/ readonly backendIPConfiguration!: pulumi.Output<outputs.network.v20210201.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    public readonly frontendIPConfiguration!: pulumi.Output<outputs.network.v20210201.SubResourceResponse | undefined>;
    /**
...
export interface InboundNatRuleArgs {
     ...
     * A reference to frontend IP addresses.
     */
    frontendIPConfiguration?: pulumi.Input<inputs.network.v20210201.SubResourceArgs>;
    /**
     * The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values range from 1 to 65534.
     */
     ...
     * The reference to the transport protocol used by the load balancing rule.
     */
    protocol?: pulumi.Input<string | enums.network.v20210201.TransportProtocol>;
    /**
