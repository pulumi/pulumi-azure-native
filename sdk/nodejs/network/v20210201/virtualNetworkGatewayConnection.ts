...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20210201.VirtualNetworkGatewayConnectionPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * Properties of the virtual network gateway connection.
     */
    properties: pulumi.Input<inputs.network.v20210201.VirtualNetworkGatewayConnectionPropertiesFormatArgs>;
    /**
