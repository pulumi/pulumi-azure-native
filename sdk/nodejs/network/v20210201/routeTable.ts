...
export class RouteTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RouteTable {
        pulumi.log.warn("RouteTable is deprecated: azure-native:network/v20210201:RouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteTable to guarantee forwards compatibility.")
