 ...
 *
 * @deprecated azure-native:network/v20210201:BastionHost is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:BastionHost to guarantee forwards compatibility.
 */
export class BastionHost extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BastionHost {
        pulumi.log.warn("BastionHost is deprecated: azure-native:network/v20210201:BastionHost is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:BastionHost to guarantee forwards compatibility.")
        return new BastionHost(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201:BastionHost';
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20210201.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20210201.SkuResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: BastionHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.network.v20210201.skuArgsProvideDefaults) : undefined) : undefined;
