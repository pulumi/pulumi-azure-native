 ...
 *
 * @deprecated azure-native:network/v20210201:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatRule to guarantee forwards compatibility.
 */
export class NatRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NatRule {
        pulumi.log.warn("NatRule is deprecated: azure-native:network/v20210201:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatRule to guarantee forwards compatibility.")
        return new NatRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201:NatRule';
     ...
     */
    public /*out*/ readonly egressVpnSiteLinkConnections!: pulumi.Output<outputs.network.v20210201.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly externalMappings!: pulumi.Output<outputs.network.v20210201.VpnNatRuleMappingResponse[] | undefined>;
    /**
     * List of ingress VpnSiteLinkConnections.
     */
    public /*out*/ readonly ingressVpnSiteLinkConnections!: pulumi.Output<outputs.network.v20210201.SubResourceResponse[]>;
    /**
     * The private IP address internal mapping for NAT.
     */
    public readonly internalMappings!: pulumi.Output<outputs.network.v20210201.VpnNatRuleMappingResponse[] | undefined>;
    /**
...
export interface NatRuleArgs {
     ...
     * The private IP address external mapping for NAT.
     */
    externalMappings?: pulumi.Input<pulumi.Input<inputs.network.v20210201.VpnNatRuleMappingArgs>[]>;
    /**
     ...
     * The private IP address internal mapping for NAT.
     */
    internalMappings?: pulumi.Input<pulumi.Input<inputs.network.v20210201.VpnNatRuleMappingArgs>[]>;
    /**
     * The IP Configuration ID this NAT rule applies to.
     */
     ...
     * The Source NAT direction of a VPN NAT.
     */
    mode?: pulumi.Input<string | enums.network.v20210201.VpnNatRuleMode>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     */
    type?: pulumi.Input<string | enums.network.v20210201.VpnNatRuleType>;
}
