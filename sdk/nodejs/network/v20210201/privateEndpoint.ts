 ...
 *
 * const privateEndpoint = new azure_native.network.v20210201.PrivateEndpoint("privateEndpoint", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20210201:PrivateEndpoint testPe /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/privateEndpoints/testPe 
 * ```
 */
