...
export class PrivateLinkServicePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:PrivateLinkServicePrivateEndpointConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.PrivateEndpointConnectionPropertiesResponse>;
    /**
     * The resource type.
     */
...
export interface PrivateLinkServicePrivateEndpointConnectionArgs {
     ...
     * Properties of the private end point connection.
     */
    readonly properties?: pulumi.Input<inputs.network.PrivateEndpointConnectionProperties>;
    /**
