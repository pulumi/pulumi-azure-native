...
export class VirtualRouter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:VirtualRouter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.VirtualRouterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualRouterArgs {
     ...
     * Properties of the Virtual Router.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.VirtualRouterPropertiesFormat>;
    /**
