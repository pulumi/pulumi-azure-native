...
export class VirtualRouterPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:VirtualRouterPeering';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.VirtualRouterPeeringPropertiesResponse>;
    /**
     * Peering type.
     */
...
export interface VirtualRouterPeeringArgs {
     ...
     * The properties of the Virtual Router Peering.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.VirtualRouterPeeringProperties>;
    /**
