...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VirtualHubBgpConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VirtualHubBgpConnection" }, { type: "azurerm:network/preview:VirtualHubBgpConnection" }, { type: "azurerm:network/v20200601:VirtualHubBgpConnection" }] };
