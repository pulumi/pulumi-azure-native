...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualHubBgpConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/latest:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200601:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200701:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200801:VirtualHubBgpConnection" }] };
