 ...
 *
 * const ddosCustomPolicy = new azurerm.network.v20200501.DdosCustomPolicy("ddosCustomPolicy", {
...
export class DdosCustomPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:DdosCustomPolicy';
