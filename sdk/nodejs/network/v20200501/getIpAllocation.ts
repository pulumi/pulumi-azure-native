...
export function getIpAllocation(args: GetIpAllocationArgs, opts?: pulumi.InvokeOptions): Promise<GetIpAllocationResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200501:getIpAllocation", {
        "expand": args.expand,
...
export interface GetIpAllocationResult {
     ...
     */
    readonly subnet: outputs.network.v20200501.SubResourceInvokeResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetwork: outputs.network.v20200501.SubResourceInvokeResponse;
}
