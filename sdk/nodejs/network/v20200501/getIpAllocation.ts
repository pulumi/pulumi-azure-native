...
export function getIpAllocation(args: GetIpAllocationArgs, opts?: pulumi.InvokeOptions): Promise<GetIpAllocationResult> {
    pulumi.log.warn("getIpAllocation is deprecated: azure-native:network/v20200501:IpAllocation is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpAllocation to guarantee forwards compatibility.")
