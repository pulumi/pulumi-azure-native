 ...
 */
/** @deprecated azure-native:network/v20200501:VirtualApplianceSite is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualApplianceSite to guarantee forwards compatibility. */
export function getVirtualApplianceSite(args: GetVirtualApplianceSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualApplianceSiteResult> {
    pulumi.log.warn("getVirtualApplianceSite is deprecated: azure-native:network/v20200501:VirtualApplianceSite is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualApplianceSite to guarantee forwards compatibility.")
