 ...
 *
 * const ipAllocation = new azurerm.network.v20200501.IpAllocation("ipAllocation", {
 *     allocationTags: {
...
export class IpAllocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:IpAllocation';
    ...
    constructor(name: string, argsOrState?: IpAllocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:IpAllocation" }, { type: "azurerm:network/v20200301:IpAllocation" }, { type: "azurerm:network/v20200401:IpAllocation" }, { type: "azurerm:network/v20200601:IpAllocation" }] };
