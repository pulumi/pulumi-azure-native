...
export function getApplicationGateway(args: GetApplicationGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200501:getApplicationGateway", {
        "name": args.name,
...
export interface GetApplicationGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20200501.ApplicationGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
