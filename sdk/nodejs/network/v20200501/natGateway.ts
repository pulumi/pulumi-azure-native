 ...
 *
 * const natGateway = new azurerm.network.v20200501.NatGateway("natGateway", {
 *     location: "westus",
...
export class NatGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:NatGateway';
