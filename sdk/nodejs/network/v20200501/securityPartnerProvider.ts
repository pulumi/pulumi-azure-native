...
export class SecurityPartnerProvider extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SecurityPartnerProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20200301:SecurityPartnerProvider" }, { type: "azurerm:network/v20200401:SecurityPartnerProvider" }, { type: "azurerm:network/v20200601:SecurityPartnerProvider" }] };
