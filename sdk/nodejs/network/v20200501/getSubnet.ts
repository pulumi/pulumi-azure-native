 ...
 */
/** @deprecated azure-native:network/v20200501:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200601:Subnet to guarantee forwards compatibility. */
export function getSubnet(args: GetSubnetArgs, opts?: pulumi.InvokeOptions): Promise<GetSubnetResult> {
    pulumi.log.warn("getSubnet is deprecated: azure-native:network/v20200501:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200601:Subnet to guarantee forwards compatibility.")
