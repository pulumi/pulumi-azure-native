...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:NetworkWatcher';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.NetworkWatcherPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkWatcherArgs {
     ...
     * Properties of the network watcher.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.NetworkWatcherPropertiesFormat>;
    /**
