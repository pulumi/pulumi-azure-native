...
export function getPrivateLinkService(args: GetPrivateLinkServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateLinkServiceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200501:getPrivateLinkService", {
        "name": args.name,
...
export interface GetPrivateLinkServiceResult {
     ...
     */
    readonly properties: outputs.network.v20200501.PrivateLinkServicePropertiesResponse;
    /**
     * Resource tags.
     */
