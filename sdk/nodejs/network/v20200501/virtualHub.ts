...
export class VirtualHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:VirtualHub';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.VirtualHubPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualHubArgs {
     ...
     * Properties of the virtual hub.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.VirtualHubProperties>;
    /**
