...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20200501:VirtualHubRouteTableV2';
