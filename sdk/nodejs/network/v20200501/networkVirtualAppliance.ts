 ...
 *
 * @deprecated azure-native:network/v20200501:NetworkVirtualAppliance is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.
 */
export class NetworkVirtualAppliance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkVirtualAppliance {
        pulumi.log.warn("NetworkVirtualAppliance is deprecated: azure-native:network/v20200501:NetworkVirtualAppliance is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.")
