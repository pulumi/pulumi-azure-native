 ...
 *
 * const privateDnsZoneGroup = new azurerm.network.v20200501.PrivateDnsZoneGroup("privateDnsZoneGroup", {
...
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:PrivateDnsZoneGroup';
    ...
    constructor(name: string, argsOrState?: PrivateDnsZoneGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:PrivateDnsZoneGroup" }, { type: "azurerm:network/v20200301:PrivateDnsZoneGroup" }, { type: "azurerm:network/v20200401:PrivateDnsZoneGroup" }, { type: "azurerm:network/v20200601:PrivateDnsZoneGroup" }] };
