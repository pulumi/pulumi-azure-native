...
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200501:PrivateDnsZoneGroup';
    ...
    constructor(name: string, args: PrivateDnsZoneGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200501:PrivateDnsZoneGroup" }, { type: "azure-native:network:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20200301:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20200301:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20200401:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20200401:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20200601:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20200601:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20200701:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20200701:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20200801:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20200801:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20201101:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20201101:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20210201:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20210201:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20210301:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20210301:PrivateDnsZoneGroup" }, { type: "azure-native:network/v20210501:PrivateDnsZoneGroup" }, { type: "azure-nextgen:network/v20210501:PrivateDnsZoneGroup" }] };
...
export interface PrivateDnsZoneGroupArgs {
     ...
     * A collection of private dns zone configurations of the private dns zone group.
     */
    privateDnsZoneConfigs?: pulumi.Input<pulumi.Input<inputs.network.v20200501.PrivateDnsZoneConfigArgs>[]>;
    /**
