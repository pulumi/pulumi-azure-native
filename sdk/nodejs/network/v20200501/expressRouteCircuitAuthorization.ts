...
export class ExpressRouteCircuitAuthorization extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.AuthorizationPropertiesFormatResponse>;
    /**
...
export interface ExpressRouteCircuitAuthorizationArgs {
     ...
     * Properties of the express route circuit authorization.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.AuthorizationPropertiesFormat>;
    /**
