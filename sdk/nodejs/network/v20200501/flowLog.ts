...
export class FlowLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:FlowLog';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.FlowLogPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface FlowLogArgs {
     ...
     * Properties of the flow log.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.FlowLogPropertiesFormat>;
    /**
