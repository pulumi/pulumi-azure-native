...
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.BackendAddressPoolPropertiesFormatResponse>;
    /**
...
export interface LoadBalancerBackendAddressPoolArgs {
     ...
     * Properties of load balancer backend address pool.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.BackendAddressPoolPropertiesFormat>;
    /**
