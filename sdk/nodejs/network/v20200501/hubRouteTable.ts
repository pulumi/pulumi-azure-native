...
export class HubRouteTable extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HubRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:HubRouteTable" }, { type: "azure-nextgen:network/latest:HubRouteTable" }, { type: "azure-nextgen:network/v20200401:HubRouteTable" }, { type: "azure-nextgen:network/v20200601:HubRouteTable" }, { type: "azure-nextgen:network/v20200701:HubRouteTable" }, { type: "azure-nextgen:network/v20200801:HubRouteTable" }] };
