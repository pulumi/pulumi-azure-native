...
export class HubRouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200501:HubRouteTable';
    ...
    constructor(name: string, argsOrState?: HubRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:HubRouteTable" }, { type: "azurerm:network/preview:HubRouteTable" }, { type: "azurerm:network/v20200401:HubRouteTable" }, { type: "azurerm:network/v20200601:HubRouteTable" }] };
