 ...
 *
 * const rulesEngine = new azure_native.network.v20200501.RulesEngine("rulesEngine", {
...
export class RulesEngine extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RulesEngineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:RulesEngine" }, { type: "azure-native:network/v20200101:RulesEngine" }, { type: "azure-native:network/v20200401:RulesEngine" }, { type: "azure-native:network/v20210601:RulesEngine" }] };
