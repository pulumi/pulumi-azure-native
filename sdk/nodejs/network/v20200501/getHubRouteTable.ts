...
export function getHubRouteTable(args: GetHubRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetHubRouteTableResult> {
    pulumi.log.warn("getHubRouteTable is deprecated: azure-native:network/v20200501:HubRouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:HubRouteTable to guarantee forwards compatibility.")
