...
export class PrivateLinkServicePrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.PrivateEndpointConnectionPropertiesResponse>;
    /**
     * The resource type.
     */
...
export interface PrivateLinkServicePrivateEndpointConnectionArgs {
     ...
     * Properties of the private end point connection.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.PrivateEndpointConnectionProperties>;
    /**
