...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200501.ExpressRouteCircuitPeeringPropertiesFormatResponse>;
    /**
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * Properties of the express route circuit peering.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200501.ExpressRouteCircuitPeeringPropertiesFormat>;
    /**
