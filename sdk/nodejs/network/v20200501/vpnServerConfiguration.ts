...
export class VpnServerConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly aadAuthenticationParameters!: pulumi.Output<outputs.network.v20200501.AadAuthenticationParametersResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly p2SVpnGateways!: pulumi.Output<outputs.network.v20200501.P2SVpnGatewayResponse[]>;
    /**
     ...
     */
    public readonly radiusClientRootCertificates!: pulumi.Output<outputs.network.v20200501.VpnServerConfigRadiusClientRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServerRootCertificates!: pulumi.Output<outputs.network.v20200501.VpnServerConfigRadiusServerRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServers!: pulumi.Output<outputs.network.v20200501.RadiusServerResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly vpnClientIpsecPolicies!: pulumi.Output<outputs.network.v20200501.IpsecPolicyResponse[] | undefined>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRevokedCertificates!: pulumi.Output<outputs.network.v20200501.VpnServerConfigVpnClientRevokedCertificateResponse[] | undefined>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRootCertificates!: pulumi.Output<outputs.network.v20200501.VpnServerConfigVpnClientRootCertificateResponse[] | undefined>;
    /**
...
export interface VpnServerConfigurationArgs {
     ...
     * The set of aad vpn authentication parameters.
     */
    readonly aadAuthenticationParameters?: pulumi.Input<inputs.network.v20200501.AadAuthenticationParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Radius client root certificate of VpnServerConfiguration.
     */
    readonly radiusClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200501.VpnServerConfigRadiusClientRootCertificateArgs>[]>;
    /**
     * The radius server address property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Radius Server root certificate of VpnServerConfiguration.
     */
    readonly radiusServerRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200501.VpnServerConfigRadiusServerRootCertificateArgs>[]>;
    /**
     * The radius secret property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Multiple Radius Server configuration for VpnServerConfiguration.
     */
    readonly radiusServers?: pulumi.Input<pulumi.Input<inputs.network.v20200501.RadiusServerArgs>[]>;
    /**
     ...
     * VPN authentication types for the VpnServerConfiguration.
     */
    readonly vpnAuthenticationTypes?: pulumi.Input<pulumi.Input<string | enums.network.v20200501.VpnAuthenticationType>[]>;
    /**
     * VpnClientIpsecPolicies for VpnServerConfiguration.
     */
    readonly vpnClientIpsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20200501.IpsecPolicyArgs>[]>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    readonly vpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200501.VpnServerConfigVpnClientRevokedCertificateArgs>[]>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    readonly vpnClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200501.VpnServerConfigVpnClientRootCertificateArgs>[]>;
    /**
     * VPN protocols for the VpnServerConfiguration.
     */
    readonly vpnProtocols?: pulumi.Input<pulumi.Input<string | enums.network.v20200501.VpnGatewayTunnelingProtocol>[]>;
    /**
