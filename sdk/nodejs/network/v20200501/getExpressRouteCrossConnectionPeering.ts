...
export function getExpressRouteCrossConnectionPeering(args: GetExpressRouteCrossConnectionPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCrossConnectionPeeringResult> {
    pulumi.log.warn("getExpressRouteCrossConnectionPeering is deprecated: azure-native:network/v20200501:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.")
