...
export function getSecurityPartnerProvider(args: GetSecurityPartnerProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityPartnerProviderResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200501:getSecurityPartnerProvider", {
        "name": args.name,
...
export interface GetSecurityPartnerProviderResult {
     ...
     */
    readonly properties: outputs.network.v20200501.SecurityPartnerProviderPropertiesFormatResponse;
    /**
     * Resource tags.
     */
