...
export function getVirtualHub(args: GetVirtualHubArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualHubResult> {
    pulumi.log.warn("getVirtualHub is deprecated: azure-native:network/v20200501:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:VirtualHub to guarantee forwards compatibility.")
