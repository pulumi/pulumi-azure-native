...
export class PrivateEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpoint {
        pulumi.log.warn("PrivateEndpoint is deprecated: azure-native:network/v20210301:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateEndpoint to guarantee forwards compatibility.")
