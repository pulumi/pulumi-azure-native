...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkInterfaceTapConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["virtualNetworkTap"] = args ? (args.virtualNetworkTap ? pulumi.output(args.virtualNetworkTap).apply(inputs.network.v20210301.virtualNetworkTapArgsProvideDefaults) : undefined) : undefined;
