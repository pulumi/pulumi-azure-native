...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210301:VirtualHubBgpConnection';
     ...
     */
    public readonly hubVirtualNetworkConnection!: pulumi.Output<outputs.network.v20210301.SubResourceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualHubBgpConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["hubVirtualNetworkConnection"] = args ? args.hubVirtualNetworkConnection : undefined;
            ...
            inputs["connectionState"] = undefined /*out*/;
            inputs["etag"] = undefined /*out*/;
            inputs["hubVirtualNetworkConnection"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20210301:VirtualHubBgpConnection" }, { type: "azure-native:network:VirtualHubBgpConnection" }, { type: "azure-nextgen:network:VirtualHubBgpConnection" }, { type: "azure-native:network/v20200501:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200501:VirtualHubBgpConnection" }, { type: "azure-native:network/v20200601:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200601:VirtualHubBgpConnection" }, { type: "azure-native:network/v20200701:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200701:VirtualHubBgpConnection" }, { type: "azure-native:network/v20200801:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200801:VirtualHubBgpConnection" }, { type: "azure-native:network/v20201101:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20201101:VirtualHubBgpConnection" }, { type: "azure-native:network/v20210201:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20210201:VirtualHubBgpConnection" }, { type: "azure-native:network/v20210501:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20210501:VirtualHubBgpConnection" }] };
