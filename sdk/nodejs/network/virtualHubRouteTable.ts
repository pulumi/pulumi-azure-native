...
export class VirtualHubRouteTable extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHubRouteTable {
        return new VirtualHubRouteTable(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:VirtualHubRouteTable';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.VirtualHubRouteTableV2PropertiesResponse>;
    ...
    constructor(name: string, argsOrState?: VirtualHubRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VirtualHubRouteTableArgs {
     ...
     * Properties of the virtual hub route table v2.
     */
    readonly properties?: pulumi.Input<inputs.network.VirtualHubRouteTableV2Properties>;
    /**
