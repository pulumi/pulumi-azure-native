...
export class ExpressRouteCircuitAuthorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:ExpressRouteCircuitAuthorization';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.AuthorizationPropertiesFormatResponse>;
    /**
...
export interface ExpressRouteCircuitAuthorizationState {
     ...
     * Properties of the express route circuit authorization.
     */
    readonly properties: pulumi.Input<inputs.network.AuthorizationPropertiesFormatResponse>;
    /**
     * Type of the resource.
     */
...
export interface ExpressRouteCircuitAuthorizationArgs {
     ...
     * Properties of the express route circuit authorization.
     */
    readonly properties?: pulumi.Input<inputs.network.AuthorizationPropertiesFormat>;
    /**
