...
export class PrivateEndpointPrivateDnsZoneGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivateEndpointPrivateDnsZoneGroupState, opts?: pulumi.CustomResourceOptions): PrivateEndpointPrivateDnsZoneGroup {
        return new PrivateEndpointPrivateDnsZoneGroup(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: PrivateEndpointPrivateDnsZoneGroupArgs | PrivateEndpointPrivateDnsZoneGroupState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PrivateEndpointPrivateDnsZoneGroupState | undefined;
 ...
 * Private dns zone group resource.
 */
export interface PrivateEndpointPrivateDnsZoneGroupState {
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * Properties of the private dns zone group.
     */
    readonly properties: pulumi.Input<inputs.network.PrivateDnsZoneGroupPropertiesFormatResponse>;
}
