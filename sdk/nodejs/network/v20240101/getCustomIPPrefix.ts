...
export function getCustomIPPrefix(args: GetCustomIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240101:getCustomIPPrefix", {
...
export interface GetCustomIPPrefixResult {
     ...
     */
    readonly childCustomIpPrefixes: outputs.network.v20240101.SubResourceResponse[];
    /**
     ...
     */
    readonly customIpPrefixParent?: outputs.network.v20240101.SubResourceResponse;
    /**
     ...
     */
    readonly publicIpPrefixes: outputs.network.v20240101.SubResourceResponse[];
    /**
...
export function getCustomIPPrefixOutput(args: GetCustomIPPrefixOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCustomIPPrefixResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240101:getCustomIPPrefix", {
        "customIpPrefixName": args.customIpPrefixName,
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
