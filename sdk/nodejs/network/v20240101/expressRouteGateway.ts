...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:ExpressRouteGateway';
     ...
     */
    public readonly autoScaleConfiguration!: pulumi.Output<outputs.network.v20240101.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    public readonly expressRouteConnections!: pulumi.Output<outputs.network.v20240101.ExpressRouteConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.v20240101.VirtualHubIdResponse>;
