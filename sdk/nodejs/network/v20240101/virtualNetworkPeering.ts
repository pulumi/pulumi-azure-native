...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:VirtualNetworkPeering';
     ...
     */
    public readonly localAddressSpace!: pulumi.Output<outputs.network.v20240101.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    public readonly localVirtualNetworkAddressSpace!: pulumi.Output<outputs.network.v20240101.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.network.v20240101.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    public readonly remoteBgpCommunities!: pulumi.Output<outputs.network.v20240101.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     ...
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.network.v20240101.SubResourceResponse | undefined>;
    /**
     * The reference to the current address space of the remote virtual network.
     */
    public readonly remoteVirtualNetworkAddressSpace!: pulumi.Output<outputs.network.v20240101.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's encryption
     */
    public /*out*/ readonly remoteVirtualNetworkEncryption!: pulumi.Output<outputs.network.v20240101.VirtualNetworkEncryptionResponse>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The local address space of the local virtual network that is peered.
     */
    localAddressSpace?: pulumi.Input<inputs.network.v20240101.AddressSpaceArgs>;
    /**
     * List of local subnet names that are subnet peered with remote virtual network.
     */
     ...
     * The current local address space of the local virtual network that is peered.
     */
    localVirtualNetworkAddressSpace?: pulumi.Input<inputs.network.v20240101.AddressSpaceArgs>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The status of the virtual network peering.
     */
    peeringState?: pulumi.Input<string | enums.network.v20240101.VirtualNetworkPeeringState>;
    /**
     * The peering sync status of the virtual network peering.
     */
    peeringSyncLevel?: pulumi.Input<string | enums.network.v20240101.VirtualNetworkPeeringLevel>;
    /**
     * The reference to the address space peered with the remote virtual network.
     */
    remoteAddressSpace?: pulumi.Input<inputs.network.v20240101.AddressSpaceArgs>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    remoteBgpCommunities?: pulumi.Input<inputs.network.v20240101.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * List of remote subnet names from remote virtual network that are subnet peered.
     */
     ...
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    remoteVirtualNetwork?: pulumi.Input<inputs.network.v20240101.SubResourceArgs>;
    /**
     * The reference to the current address space of the remote virtual network.
     */
    remoteVirtualNetworkAddressSpace?: pulumi.Input<inputs.network.v20240101.AddressSpaceArgs>;
    /**
