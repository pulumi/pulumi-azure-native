...
export class PublicIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:PublicIPPrefix';
     ...
     */
    public readonly customIPPrefix!: pulumi.Output<outputs.network.v20240101.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly loadBalancerFrontendIpConfiguration!: pulumi.Output<outputs.network.v20240101.SubResourceResponse>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<outputs.network.v20240101.ReferencedPublicIpAddressResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20240101.PublicIPPrefixSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPPrefixArgs {
     ...
     * The customIpPrefix that this prefix is associated with.
     */
    customIPPrefix?: pulumi.Input<inputs.network.v20240101.SubResourceArgs>;
    /**
     * The extended location of the public ip address.
     */
     ...
     * The public IP prefix SKU.
     */
    sku?: pulumi.Input<inputs.network.v20240101.PublicIPPrefixSkuArgs>;
    /**
     * Resource tags.
     */
