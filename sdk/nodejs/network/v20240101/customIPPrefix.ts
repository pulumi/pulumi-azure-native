...
export class CustomIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:CustomIPPrefix';
     ...
     */
    public /*out*/ readonly childCustomIpPrefixes!: pulumi.Output<outputs.network.v20240101.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly customIpPrefixParent!: pulumi.Output<outputs.network.v20240101.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly publicIpPrefixes!: pulumi.Output<outputs.network.v20240101.SubResourceResponse[]>;
    /**
...
export interface CustomIPPrefixArgs {
     ...
     * The commissioned state of the Custom IP Prefix.
     */
    commissionedState?: pulumi.Input<string | enums.network.v20240101.CommissionedState>;
    /**
     ...
     * The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
     */
    customIpPrefixParent?: pulumi.Input<inputs.network.v20240101.SubResourceArgs>;
    /**
     * Whether to do express route advertise.
     */
     ...
     * The Geo for CIDR advertising. Should be an Geo code.
     */
    geo?: pulumi.Input<string | enums.network.v20240101.Geo>;
    /**
     * Resource ID.
     */
     ...
     * Type of custom IP prefix. Should be Singular, Parent, or Child.
     */
    prefixType?: pulumi.Input<string | enums.network.v20240101.CustomIpPrefixType>;
    /**
