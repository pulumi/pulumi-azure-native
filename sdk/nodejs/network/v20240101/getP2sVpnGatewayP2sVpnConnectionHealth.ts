...
export function getP2sVpnGatewayP2sVpnConnectionHealth(args: GetP2sVpnGatewayP2sVpnConnectionHealthArgs, opts?: pulumi.InvokeOptions): Promise<GetP2sVpnGatewayP2sVpnConnectionHealthResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240101:getP2sVpnGatewayP2sVpnConnectionHealth", {
...
export interface GetP2sVpnGatewayP2sVpnConnectionHealthResult {
     ...
     */
    readonly p2SConnectionConfigurations?: outputs.network.v20240101.P2SConnectionConfigurationResponse[];
    /**
     ...
     */
    readonly virtualHub?: outputs.network.v20240101.SubResourceResponse;
    /**
     * All P2S VPN clients' connection health status.
     */
    readonly vpnClientConnectionHealth: outputs.network.v20240101.VpnClientConnectionHealthResponse;
    /**
     ...
     */
    readonly vpnServerConfiguration?: outputs.network.v20240101.SubResourceResponse;
}
/**
 * Gets the connection health of P2S clients of the virtual wan P2SVpnGateway in the specified resource group.
 */
export function getP2sVpnGatewayP2sVpnConnectionHealthOutput(args: GetP2sVpnGatewayP2sVpnConnectionHealthOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetP2sVpnGatewayP2sVpnConnectionHealthResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240101:getP2sVpnGatewayP2sVpnConnectionHealth", {
        "gatewayName": args.gatewayName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
