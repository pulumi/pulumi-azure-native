...
export function getExpressRouteGateway(args: GetExpressRouteGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20240101:getExpressRouteGateway", {
...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly autoScaleConfiguration?: outputs.network.v20240101.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration;
    /**
     ...
     */
    readonly expressRouteConnections?: outputs.network.v20240101.ExpressRouteConnectionResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly virtualHub: outputs.network.v20240101.VirtualHubIdResponse;
}
/**
 * Fetches the details of a ExpressRoute gateway in a resource group.
 */
export function getExpressRouteGatewayOutput(args: GetExpressRouteGatewayOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExpressRouteGatewayResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20240101:getExpressRouteGateway", {
        "expressRouteGatewayName": args.expressRouteGatewayName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
