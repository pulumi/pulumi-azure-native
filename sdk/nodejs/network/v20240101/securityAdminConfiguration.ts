...
export class SecurityAdminConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:SecurityAdminConfiguration';
