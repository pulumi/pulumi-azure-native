...
export class HubRouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:HubRouteTable';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.v20240101.HubRouteResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface HubRouteTableArgs {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20240101.HubRouteArgs>[]>;
    /**
