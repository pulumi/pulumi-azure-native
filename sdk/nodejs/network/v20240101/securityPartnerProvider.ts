...
export class SecurityPartnerProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:SecurityPartnerProvider';
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.v20240101.SubResourceResponse | undefined>;
...
export interface SecurityPartnerProviderArgs {
     ...
     * The security provider name.
     */
    securityProviderName?: pulumi.Input<string | enums.network.v20240101.SecurityProviderName>;
    /**
     * Resource tags.
     */
     ...
     * The virtualHub to which the Security Partner Provider belongs.
     */
    virtualHub?: pulumi.Input<inputs.network.v20240101.SubResourceArgs>;
}
