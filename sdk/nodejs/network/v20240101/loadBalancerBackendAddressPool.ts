...
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:LoadBalancerBackendAddressPool';
     ...
     */
    public /*out*/ readonly backendIPConfigurations!: pulumi.Output<outputs.network.v20240101.NetworkInterfaceIPConfigurationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly inboundNatRules!: pulumi.Output<outputs.network.v20240101.SubResourceResponse[]>;
    /**
     * An array of backend addresses.
     */
    public readonly loadBalancerBackendAddresses!: pulumi.Output<outputs.network.v20240101.LoadBalancerBackendAddressResponse[] | undefined>;
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    public /*out*/ readonly loadBalancingRules!: pulumi.Output<outputs.network.v20240101.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly outboundRule!: pulumi.Output<outputs.network.v20240101.SubResourceResponse>;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    public /*out*/ readonly outboundRules!: pulumi.Output<outputs.network.v20240101.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly tunnelInterfaces!: pulumi.Output<outputs.network.v20240101.GatewayLoadBalancerTunnelInterfaceResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.network.v20240101.SubResourceResponse | undefined>;
...
export interface LoadBalancerBackendAddressPoolArgs {
     ...
     * An array of backend addresses.
     */
    loadBalancerBackendAddresses?: pulumi.Input<pulumi.Input<inputs.network.v20240101.LoadBalancerBackendAddressArgs>[]>;
    /**
     ...
     * Backend address synchronous mode for the backend pool
     */
    syncMode?: pulumi.Input<string | enums.network.v20240101.SyncMode>;
    /**
     * An array of gateway load balancer tunnel interfaces.
     */
    tunnelInterfaces?: pulumi.Input<pulumi.Input<inputs.network.v20240101.GatewayLoadBalancerTunnelInterfaceArgs>[]>;
    /**
     * A reference to a virtual network.
     */
    virtualNetwork?: pulumi.Input<inputs.network.v20240101.SubResourceArgs>;
}
