...
export class NatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101:NatRule';
     ...
     */
    public /*out*/ readonly egressVpnSiteLinkConnections!: pulumi.Output<outputs.network.v20240101.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly ingressVpnSiteLinkConnections!: pulumi.Output<outputs.network.v20240101.SubResourceResponse[]>;
    /**
