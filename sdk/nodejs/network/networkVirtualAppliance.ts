...
export class NetworkVirtualAppliance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkVirtualApplianceState, opts?: pulumi.CustomResourceOptions): NetworkVirtualAppliance {
        return new NetworkVirtualAppliance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:NetworkVirtualAppliance';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.NetworkVirtualAppliancePropertiesFormatResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: NetworkVirtualApplianceArgs | NetworkVirtualApplianceState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as NetworkVirtualApplianceState | undefined;
 ...
 * NetworkVirtualAppliance Resource.
 */
export interface NetworkVirtualApplianceState {
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * Properties of the Network Virtual Appliance.
     */
    readonly properties: pulumi.Input<inputs.network.NetworkVirtualAppliancePropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkVirtualApplianceArgs {
     ...
     * Properties of the Network Virtual Appliance.
     */
    readonly properties?: pulumi.Input<inputs.network.NetworkVirtualAppliancePropertiesFormat>;
    /**
