...
export class FrontDoorRulesEngine extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FrontDoorRulesEngine {
        return new FrontDoorRulesEngine(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:FrontDoorRulesEngine';
    ...
    constructor(name: string, argsOrState?: FrontDoorRulesEngineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FrontDoorRulesEngine.__pulumiType, name, inputs, opts);
    }
}
