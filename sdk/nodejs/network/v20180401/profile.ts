 ...
 *
 * const profile = new azurerm.network.v20180401.Profile("profile", {
 *     dnsConfig: {
...
export class Profile extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Profile" }, { type: "azurerm:network/v20151101:Profile" }, { type: "azurerm:network/v20170301:Profile" }, { type: "azurerm:network/v20170501:Profile" }, { type: "azurerm:network/v20180201:Profile" }, { type: "azurerm:network/v20180301:Profile" }] };
