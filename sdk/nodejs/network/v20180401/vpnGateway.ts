 ...
 *
 * const vpnGateway = new azurerm.network.v20180401.VpnGateway("vpnGateway", {
 *     bgpSettings: {
 *         asn: 65515,
...
export class VpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180401:VpnGateway';
