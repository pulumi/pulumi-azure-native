...
export class VirtualNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180401.VirtualNetworkPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkArgs {
     ...
     * Properties of the virtual network.
     */
    readonly properties?: pulumi.Input<inputs.network.v20180401.VirtualNetworkPropertiesFormat>;
    /**
