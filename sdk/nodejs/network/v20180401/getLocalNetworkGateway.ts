...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    pulumi.log.warn("getLocalNetworkGateway is deprecated: Version 2018-04-01 will be removed in v2 of the provider.")
...
export interface GetLocalNetworkGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20180401.LocalNetworkGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
