 ...
 *
 * const routeFilterRule = new azurerm.network.v20180401.RouteFilterRule("routeFilterRule", {
 *     access: "Allow",
 *     communities: [
 *         "12076:5030",
 *         "12076:5040",
...
export class RouteFilterRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180401:RouteFilterRule';
    ...
    constructor(name: string, argsOrState?: RouteFilterRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:RouteFilterRule" }, { type: "azurerm:network/v20161201:RouteFilterRule" }, { type: "azurerm:network/v20170301:RouteFilterRule" }, { type: "azurerm:network/v20170601:RouteFilterRule" }, { type: "azurerm:network/v20170801:RouteFilterRule" }, { type: "azurerm:network/v20170901:RouteFilterRule" }, { type: "azurerm:network/v20171001:RouteFilterRule" }, { type: "azurerm:network/v20171101:RouteFilterRule" }, { type: "azurerm:network/v20180101:RouteFilterRule" }, { type: "azurerm:network/v20180201:RouteFilterRule" }, { type: "azurerm:network/v20180601:RouteFilterRule" }, { type: "azurerm:network/v20180701:RouteFilterRule" }, { type: "azurerm:network/v20180801:RouteFilterRule" }, { type: "azurerm:network/v20181001:RouteFilterRule" }, { type: "azurerm:network/v20181101:RouteFilterRule" }, { type: "azurerm:network/v20181201:RouteFilterRule" }, { type: "azurerm:network/v20190201:RouteFilterRule" }, { type: "azurerm:network/v20190401:RouteFilterRule" }, { type: "azurerm:network/v20190601:RouteFilterRule" }, { type: "azurerm:network/v20190701:RouteFilterRule" }, { type: "azurerm:network/v20190801:RouteFilterRule" }, { type: "azurerm:network/v20190901:RouteFilterRule" }, { type: "azurerm:network/v20191101:RouteFilterRule" }, { type: "azurerm:network/v20191201:RouteFilterRule" }, { type: "azurerm:network/v20200301:RouteFilterRule" }, { type: "azurerm:network/v20200401:RouteFilterRule" }, { type: "azurerm:network/v20200501:RouteFilterRule" }, { type: "azurerm:network/v20200601:RouteFilterRule" }] };
