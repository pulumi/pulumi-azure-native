...
export class LocalNetworkGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180401.LocalNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Properties of the local network gateway.
     */
    properties: pulumi.Input<inputs.network.v20180401.LocalNetworkGatewayPropertiesFormatArgs>;
    /**
