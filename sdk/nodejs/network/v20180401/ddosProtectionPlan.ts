...
export class DdosProtectionPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180401:DdosProtectionPlan';
    ...
    constructor(name: string, argsOrState?: DdosProtectionPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:DdosProtectionPlan" }, { type: "azurerm:network/preview:DdosProtectionPlan" }, { type: "azurerm:network/v20180201:DdosProtectionPlan" }, { type: "azurerm:network/v20180601:DdosProtectionPlan" }, { type: "azurerm:network/v20180701:DdosProtectionPlan" }, { type: "azurerm:network/v20180801:DdosProtectionPlan" }, { type: "azurerm:network/v20181001:DdosProtectionPlan" }, { type: "azurerm:network/v20181101:DdosProtectionPlan" }, { type: "azurerm:network/v20181201:DdosProtectionPlan" }, { type: "azurerm:network/v20190201:DdosProtectionPlan" }, { type: "azurerm:network/v20190401:DdosProtectionPlan" }, { type: "azurerm:network/v20190601:DdosProtectionPlan" }, { type: "azurerm:network/v20190701:DdosProtectionPlan" }, { type: "azurerm:network/v20190801:DdosProtectionPlan" }, { type: "azurerm:network/v20190901:DdosProtectionPlan" }, { type: "azurerm:network/v20191101:DdosProtectionPlan" }, { type: "azurerm:network/v20191201:DdosProtectionPlan" }, { type: "azurerm:network/v20200301:DdosProtectionPlan" }, { type: "azurerm:network/v20200401:DdosProtectionPlan" }, { type: "azurerm:network/v20200501:DdosProtectionPlan" }, { type: "azurerm:network/v20200601:DdosProtectionPlan" }] };
