...
export function getVirtualNetworkGatewayConnection(args: GetVirtualNetworkGatewayConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180401:getVirtualNetworkGatewayConnection", {
...
export interface GetVirtualNetworkGatewayConnectionResult {
     ...
     */
    readonly ipsecPolicies?: outputs.network.v20180401.IpsecPolicyInvokeResponse[];
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: outputs.network.v20180401.LocalNetworkGatewayInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly peer?: outputs.network.v20180401.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly tunnelConnectionStatus: outputs.network.v20180401.TunnelConnectionHealthInvokeResponse[];
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualNetworkGateway1: outputs.network.v20180401.VirtualNetworkGatewayInvokeResponse;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: outputs.network.v20180401.VirtualNetworkGatewayInvokeResponse;
}
