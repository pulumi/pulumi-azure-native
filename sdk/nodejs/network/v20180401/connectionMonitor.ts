 ...
 *
 * const connectionMonitor = new azurerm.network.v20180401.ConnectionMonitor("connectionMonitor", {
...
export class ConnectionMonitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180401:ConnectionMonitor';
