 ...
 *
 * const endpoint = new azurerm.network.v20180401.Endpoint("endpoint", {
 *     customHeaders: [
 *         {
 *             name: "header-1",
 *             value: "value-1",
...
export class Endpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Endpoint" }, { type: "azurerm:network/v20151101:Endpoint" }, { type: "azurerm:network/v20170301:Endpoint" }, { type: "azurerm:network/v20170501:Endpoint" }, { type: "azurerm:network/v20180201:Endpoint" }, { type: "azurerm:network/v20180301:Endpoint" }] };
