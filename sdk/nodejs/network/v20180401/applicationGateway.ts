...
export class ApplicationGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180401.ApplicationGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationGatewayArgs {
     ...
     * Properties of the application gateway.
     */
    readonly properties?: pulumi.Input<inputs.network.v20180401.ApplicationGatewayPropertiesFormat>;
    /**
