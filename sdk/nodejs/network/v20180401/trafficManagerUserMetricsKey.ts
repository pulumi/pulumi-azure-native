 ...
 *
 * const trafficManagerUserMetricsKey = new azurerm.network.v20180401.TrafficManagerUserMetricsKey("trafficManagerUserMetricsKey", {});
 *
 * ```
 */
export class TrafficManagerUserMetricsKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrafficManagerUserMetricsKey {
        return new TrafficManagerUserMetricsKey(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180401:TrafficManagerUserMetricsKey';
    ...
    constructor(name: string, argsOrState?: TrafficManagerUserMetricsKeyArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as TrafficManagerUserMetricsKeyArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:TrafficManagerUserMetricsKey" }] };
