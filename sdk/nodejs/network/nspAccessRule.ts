...
export class NspAccessRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NspAccessRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:NspAccessRule" }, { type: "azure-native:network/v20230701preview:NspAccessRule" }, { type: "azure-native:network/v20230801preview:NspAccessRule" }, { type: "azure-native_network_v20210201preview:network:NspAccessRule" }, { type: "azure-native_network_v20230701preview:network:NspAccessRule" }, { type: "azure-native_network_v20230801preview:network:NspAccessRule" }, { type: "azure-native_network_v20240601preview:network:NspAccessRule" }] };
