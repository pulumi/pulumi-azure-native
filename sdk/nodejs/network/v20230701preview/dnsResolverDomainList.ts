...
export class DnsResolverDomainList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230701preview:DnsResolverDomainList';
    ...
    constructor(name: string, args: DnsResolverDomainListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:DnsResolverDomainList" }] };
