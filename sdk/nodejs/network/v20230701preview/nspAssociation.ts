...
export class NspAssociation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NspAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:NspAssociation" }, { type: "azure-native:network/v20230801preview:NspAssociation" }, { type: "azure-native:network:NspAssociation" }] };
