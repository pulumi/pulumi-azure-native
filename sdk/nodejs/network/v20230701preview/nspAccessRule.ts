...
export class NspAccessRule extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly networkSecurityPerimeters!: pulumi.Output<outputs.network.v20230701preview.PerimeterBasedAccessRuleResponse[]>;
    /**
     ...
     */
    public readonly subscriptions!: pulumi.Output<outputs.network.v20230701preview.SubscriptionIdResponse[] | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: NspAccessRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:NspAccessRule" }, { type: "azure-native:network/v20230801preview:NspAccessRule" }, { type: "azure-native:network:NspAccessRule" }] };
