...
export class ForwardingRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ForwardingRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ForwardingRule" }, { type: "azure-native:network/v20200401preview:ForwardingRule" }, { type: "azure-native:network/v20220701:ForwardingRule" }] };
