...
export class DnsForwardingRuleset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230701preview:DnsForwardingRuleset';
     ...
     */
    public readonly dnsResolverOutboundEndpoints!: pulumi.Output<outputs.network.v20230701preview.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: DnsForwardingRulesetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20200401preview:DnsForwardingRuleset" }, { type: "azure-native:network/v20220701:DnsForwardingRuleset" }, { type: "azure-native:network:DnsForwardingRuleset" }] };
...
export interface DnsForwardingRulesetArgs {
     ...
     * The reference to the DNS resolver outbound endpoints that are used to route DNS queries matching the forwarding rules in the ruleset to the target DNS servers.
     */
    dnsResolverOutboundEndpoints: pulumi.Input<pulumi.Input<inputs.network.v20230701preview.SubResourceArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
