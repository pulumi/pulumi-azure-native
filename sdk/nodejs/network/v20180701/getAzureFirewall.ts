...
export function getAzureFirewall(args: GetAzureFirewallArgs, opts?: pulumi.InvokeOptions): Promise<GetAzureFirewallResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180701:getAzureFirewall", {
        "name": args.name,
...
export interface GetAzureFirewallResult {
     ...
     */
    readonly properties: outputs.network.v20180701.AzureFirewallPropertiesFormatResponse;
    /**
     * Resource tags.
     */
