 ...
 *
 * const ddosProtectionPlan = new azurerm.network.v20180701.DdosProtectionPlan("ddosProtectionPlan", {
...
export class DdosProtectionPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180701:DdosProtectionPlan';
