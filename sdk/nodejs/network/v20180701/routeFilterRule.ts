...
export class RouteFilterRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20180701:RouteFilterRule';
