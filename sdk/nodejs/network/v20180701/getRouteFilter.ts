...
export function getRouteFilter(args: GetRouteFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180701:getRouteFilter", {
        "name": args.name,
...
export interface GetRouteFilterResult {
     ...
     * Route Filter Resource
     */
    readonly properties: outputs.network.v20180701.RouteFilterPropertiesFormatResponse;
    /**
     * Resource tags.
     */
