 ...
 *
 * const virtualNetworkGateway = new azurerm.network.v20180701.VirtualNetworkGateway("virtualNetworkGateway", {
 *     activeActive: false,
 *     bgpSettings: {
 *         asn: 65515,
