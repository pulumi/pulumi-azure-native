...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuitPeering {
        pulumi.log.warn("ExpressRouteCircuitPeering is deprecated: azure-native:network/v20180701:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:ExpressRouteCircuitPeering to guarantee forwards compatibility.")
