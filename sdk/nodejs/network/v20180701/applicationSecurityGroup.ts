...
export class ApplicationSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180701:ApplicationSecurityGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180701.ApplicationSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationSecurityGroupArgs {
     ...
     * Properties of the application security group.
     */
    readonly properties?: pulumi.Input<inputs.network.v20180701.ApplicationSecurityGroupPropertiesFormat>;
    /**
