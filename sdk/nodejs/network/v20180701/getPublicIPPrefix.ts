...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    pulumi.log.warn("getPublicIPPrefix is deprecated: azure-native:network/v20180701:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:PublicIPPrefix to guarantee forwards compatibility.")
