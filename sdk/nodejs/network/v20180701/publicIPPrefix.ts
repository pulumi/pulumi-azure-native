...
export class PublicIPPrefix extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180701.PublicIPPrefixPropertiesFormatResponse>;
    /**
...
export interface PublicIPPrefixArgs {
     ...
     * Public IP prefix properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20180701.PublicIPPrefixPropertiesFormat>;
    /**
