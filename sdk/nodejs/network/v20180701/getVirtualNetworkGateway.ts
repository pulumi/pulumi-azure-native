...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180701:getVirtualNetworkGateway", {
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly gatewayDefaultSite?: outputs.network.v20180701.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly ipConfigurations?: outputs.network.v20180701.VirtualNetworkGatewayIPConfigurationInvokeResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.v20180701.VirtualNetworkGatewaySkuInvokeResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly vpnClientConfiguration?: outputs.network.v20180701.VpnClientConfigurationInvokeResponse;
    /**
