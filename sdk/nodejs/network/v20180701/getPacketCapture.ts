...
export function getPacketCapture(args: GetPacketCaptureArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCaptureResult> {
    pulumi.log.warn("getPacketCapture is deprecated: azure-native:network/v20180701:PacketCapture is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:PacketCapture to guarantee forwards compatibility.")
