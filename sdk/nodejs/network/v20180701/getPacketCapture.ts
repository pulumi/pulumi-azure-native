...
export function getPacketCapture(args: GetPacketCaptureArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCaptureResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180701:getPacketCapture", {
        "name": args.name,
...
export interface GetPacketCaptureResult {
     ...
     */
    readonly properties: outputs.network.v20180701.PacketCaptureResultPropertiesResponse;
}
