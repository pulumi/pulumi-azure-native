...
export function getVirtualWAN(args: GetVirtualWANArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualWANResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180701:getVirtualWAN", {
...
export interface GetVirtualWANResult {
     ...
     */
    readonly virtualHubs: outputs.network.v20180701.SubResourceInvokeResponse[];
    readonly vpnSites: outputs.network.v20180701.SubResourceInvokeResponse[];
}
