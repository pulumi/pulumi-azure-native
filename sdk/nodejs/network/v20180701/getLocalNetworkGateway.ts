...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    pulumi.log.warn("getLocalNetworkGateway is deprecated: azure-native:network/v20180701:LocalNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:LocalNetworkGateway to guarantee forwards compatibility.")
