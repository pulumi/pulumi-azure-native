...
export class InboundNatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:InboundNatRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.InboundNatRulePropertiesFormatResponse>;
    /**
...
export interface InboundNatRuleArgs {
     ...
     * Properties of load balancer inbound nat rule.
     */
    readonly properties?: pulumi.Input<inputs.network.InboundNatRulePropertiesFormat>;
    /**
