...
export class P2svpnGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: P2svpnGatewayState, opts?: pulumi.CustomResourceOptions): P2svpnGateway {
        return new P2svpnGateway(name, <any>state, { ...opts, id: id });
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.P2SVpnGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: P2svpnGatewayArgs | P2svpnGatewayState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as P2svpnGatewayState | undefined;
 ...
 * P2SVpnGateway Resource.
 */
export interface P2svpnGatewayState {
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * Properties of the P2SVpnGateway.
     */
    readonly properties: pulumi.Input<inputs.network.P2SVpnGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface P2svpnGatewayArgs {
     ...
     * Properties of the P2SVpnGateway.
     */
    readonly properties?: pulumi.Input<inputs.network.P2SVpnGatewayProperties>;
    /**
