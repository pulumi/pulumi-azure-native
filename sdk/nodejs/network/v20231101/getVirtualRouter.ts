...
export function getVirtualRouter(args: GetVirtualRouterArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20231101:getVirtualRouter", {
        "expand": args.expand,
...
export interface GetVirtualRouterResult {
     ...
     */
    readonly hostedGateway?: outputs.network.v20231101.SubResourceResponse;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    readonly hostedSubnet?: outputs.network.v20231101.SubResourceResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly peerings: outputs.network.v20231101.SubResourceResponse[];
    /**
...
export function getVirtualRouterOutput(args: GetVirtualRouterOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetVirtualRouterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20231101:getVirtualRouter", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "virtualRouterName": args.virtualRouterName,
    }, opts);
