...
export class PrivateLinkService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20231101:PrivateLinkService';
     ...
     */
    public readonly autoApproval!: pulumi.Output<outputs.network.v20231101.PrivateLinkServicePropertiesResponseAutoApproval | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.network.v20231101.ExtendedLocationResponse | undefined>;
    /**
     * The list of Fqdn.
     */
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20231101.PrivateLinkServiceIpConfigurationResponse[] | undefined>;
    /**
     * An array of references to the load balancer IP configurations.
     */
    public readonly loadBalancerFrontendIpConfigurations!: pulumi.Output<outputs.network.v20231101.FrontendIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.network.v20231101.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly visibility!: pulumi.Output<outputs.network.v20231101.PrivateLinkServicePropertiesResponseVisibility | undefined>;
...
export interface PrivateLinkServiceArgs {
     ...
     * The auto-approval list of the private link service.
     */
    autoApproval?: pulumi.Input<inputs.network.v20231101.PrivateLinkServicePropertiesAutoApprovalArgs>;
    /**
     * Whether the private link service is enabled for proxy protocol or not.
     */
     ...
     * An array of private link service IP configurations.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20231101.PrivateLinkServiceIpConfigurationArgs>[]>;
    /**
     * An array of references to the load balancer IP configurations.
     */
    loadBalancerFrontendIpConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20231101.FrontendIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The visibility list of the private link service.
     */
    visibility?: pulumi.Input<inputs.network.v20231101.PrivateLinkServicePropertiesVisibilityArgs>;
}
