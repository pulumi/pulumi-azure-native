...
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20231101:PublicIPAddress';
     ...
     */
    public readonly ddosSettings!: pulumi.Output<outputs.network.v20231101.DdosSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.network.v20231101.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfiguration!: pulumi.Output<outputs.network.v20231101.IPConfigurationResponse>;
    /**
     * The list of tags associated with the public IP address.
     */
    public readonly ipTags!: pulumi.Output<outputs.network.v20231101.IpTagResponse[] | undefined>;
    /**
     * The linked public IP address of the public IP address resource.
     */
    public readonly linkedPublicIPAddress!: pulumi.Output<outputs.network.v20231101.PublicIPAddressResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly natGateway!: pulumi.Output<outputs.network.v20231101.NatGatewayResponse | undefined>;
    /**
     ...
     */
    public readonly publicIPPrefix!: pulumi.Output<outputs.network.v20231101.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly servicePublicIPAddress!: pulumi.Output<outputs.network.v20231101.PublicIPAddressResponse | undefined>;
    /**
     * The public IP address SKU.
     */
    public readonly sku!: pulumi.Output<outputs.network.v20231101.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The DDoS protection custom policy associated with the public IP address.
     */
    ddosSettings?: pulumi.Input<inputs.network.v20231101.DdosSettingsArgs>;
    /**
     * Specify what happens to the public IP address when the VM using it is deleted
     */
    deleteOption?: pulumi.Input<string | enums.network.v20231101.DeleteOptions>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20231101.PublicIPAddressDnsSettingsArgs>;
    /**
     * The extended location of the public ip address.
     */
     ...
     * The linked public IP address of the public IP address resource.
     */
    linkedPublicIPAddress?: pulumi.Input<inputs.network.v20231101.PublicIPAddressArgs>;
    /**
     * Resource location.
     */
     ...
     * Migration phase of Public IP Address.
     */
    migrationPhase?: pulumi.Input<string | enums.network.v20231101.PublicIPAddressMigrationPhase>;
    /**
     * The NatGateway for the Public IP address.
     */
     ...
     * The public IP address allocation method.
     */
    publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20231101.IPAllocationMethod>;
    /**
     * The Public IP Prefix this Public IP Address should be allocated from.
     */
    publicIPPrefix?: pulumi.Input<inputs.network.v20231101.SubResourceArgs>;
    /**
     ...
     * The service public IP address of the public IP address resource.
     */
    servicePublicIPAddress?: pulumi.Input<inputs.network.v20231101.PublicIPAddressArgs>;
    /**
     * The public IP address SKU.
     */
    sku?: pulumi.Input<inputs.network.v20231101.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */
