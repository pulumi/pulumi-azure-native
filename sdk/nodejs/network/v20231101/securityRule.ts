...
export class SecurityRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20231101:SecurityRule';
     ...
     */
    public readonly destinationApplicationSecurityGroups!: pulumi.Output<outputs.network.v20231101.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     ...
     */
    public readonly sourceApplicationSecurityGroups!: pulumi.Output<outputs.network.v20231101.ApplicationSecurityGroupResponse[] | undefined>;
    /**
