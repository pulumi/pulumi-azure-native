...
export function getBastionHost(args: GetBastionHostArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionHostResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20231101:getBastionHost", {
...
export interface GetBastionHostResult {
     ...
     */
    readonly ipConfigurations?: outputs.network.v20231101.BastionHostIPConfigurationResponse[];
    /**
     * Resource location.
     */
    ...
    readonly networkAcls?: outputs.network.v20231101.BastionHostPropertiesFormatResponseNetworkAcls;
    /**
     ...
     */
    readonly sku?: outputs.network.v20231101.SkuResponse;
    /**
     * Resource tags.
     */
...
export function getBastionHostOutput(args: GetBastionHostOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetBastionHostResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20231101:getBastionHost", {
        "bastionHostName": args.bastionHostName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
