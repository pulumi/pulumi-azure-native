...
export function getInboundNatRule(args: GetInboundNatRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetInboundNatRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20231101:getInboundNatRule", {
        "expand": args.expand,
...
export interface GetInboundNatRuleResult {
     ...
     */
    readonly backendAddressPool?: outputs.network.v20231101.SubResourceResponse;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    readonly backendIPConfiguration: outputs.network.v20231101.NetworkInterfaceIPConfigurationResponse;
    /**
     ...
     */
    readonly frontendIPConfiguration?: outputs.network.v20231101.SubResourceResponse;
    /**
...
export function getInboundNatRuleOutput(args: GetInboundNatRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInboundNatRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20231101:getInboundNatRule", {
        "expand": args.expand,
        "inboundNatRuleName": args.inboundNatRuleName,
        "loadBalancerName": args.loadBalancerName,
        "resourceGroupName": args.resourceGroupName,
