...
export class DdosProtectionPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20231101:DdosProtectionPlan';
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<outputs.network.v20231101.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly virtualNetworks!: pulumi.Output<outputs.network.v20231101.SubResourceResponse[]>;
