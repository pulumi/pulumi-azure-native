...
export function getVpnGateway(args: GetVpnGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20231101:getVpnGateway", {
...
export interface GetVpnGatewayResult {
     ...
     */
    readonly bgpSettings?: outputs.network.v20231101.BgpSettingsResponse;
    /**
     * List of all vpn connections to the gateway.
     */
    readonly connections?: outputs.network.v20231101.VpnConnectionResponse[];
    /**
     ...
     */
    readonly ipConfigurations: outputs.network.v20231101.VpnGatewayIpConfigurationResponse[];
    /**
     ...
     */
    readonly natRules?: outputs.network.v20231101.VpnGatewayNatRuleResponse[];
    /**
