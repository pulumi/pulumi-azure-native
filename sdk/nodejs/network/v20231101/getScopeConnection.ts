...
export function getScopeConnection(args: GetScopeConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetScopeConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20231101:getScopeConnection", {
...
export interface GetScopeConnectionResult {
     ...
     */
    readonly systemData: outputs.network.v20231101.SystemDataResponse;
    /**
     * Tenant ID.
     */
...
export function getScopeConnectionOutput(args: GetScopeConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScopeConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20231101:getScopeConnection", {
        "networkManagerName": args.networkManagerName,
        "resourceGroupName": args.resourceGroupName,
        "scopeConnectionName": args.scopeConnectionName,
    }, opts);
