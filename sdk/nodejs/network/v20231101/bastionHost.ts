...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20231101:BastionHost';
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20231101.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
    ...
    public readonly networkAcls!: pulumi.Output<outputs.network.v20231101.BastionHostPropertiesFormatResponseNetworkAcls | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20231101.SkuResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.network.v20231101.SubResourceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: BastionHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.network.v20231101.skuArgsProvideDefaults) : undefined) : undefined;
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20231101.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
    location?: pulumi.Input<string>;
    networkAcls?: pulumi.Input<inputs.network.v20231101.BastionHostPropertiesFormatNetworkAclsArgs>;
    /**
     ...
     * The sku of this Bastion Host.
     */
    sku?: pulumi.Input<inputs.network.v20231101.SkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * Reference to an existing virtual network required for Developer Bastion Host only.
     */
    virtualNetwork?: pulumi.Input<inputs.network.v20231101.SubResourceArgs>;
    /**
     * A list of availability zones denoting where the resource needs to come from.
     */
