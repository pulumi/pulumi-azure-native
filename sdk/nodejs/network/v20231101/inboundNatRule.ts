...
export class InboundNatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20231101:InboundNatRule';
     ...
     */
    public readonly backendAddressPool!: pulumi.Output<outputs.network.v20231101.SubResourceResponse | undefined>;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    public /*out*/ readonly backendIPConfiguration!: pulumi.Output<outputs.network.v20231101.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    public readonly frontendIPConfiguration!: pulumi.Output<outputs.network.v20231101.SubResourceResponse | undefined>;
    /**
...
export interface InboundNatRuleArgs {
     ...
     * A reference to backendAddressPool resource.
     */
    backendAddressPool?: pulumi.Input<inputs.network.v20231101.SubResourceArgs>;
    /**
     * The port used for the internal endpoint. Acceptable values range from 1 to 65535.
     */
     ...
     * A reference to frontend IP addresses.
     */
    frontendIPConfiguration?: pulumi.Input<inputs.network.v20231101.SubResourceArgs>;
    /**
     * The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values range from 1 to 65534.
     */
     ...
     * The reference to the transport protocol used by the load balancing rule.
     */
    protocol?: pulumi.Input<string | enums.network.v20231101.TransportProtocol>;
    /**
