...
export class RoutingIntent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20231101:RoutingIntent';
     ...
     */
    public readonly routingPolicies!: pulumi.Output<outputs.network.v20231101.RoutingPolicyResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface RoutingIntentArgs {
     ...
     * List of routing policies.
     */
    routingPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20231101.RoutingPolicyArgs>[]>;
    /**
