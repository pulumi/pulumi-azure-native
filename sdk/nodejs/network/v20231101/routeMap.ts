...
export class RouteMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20231101:RouteMap';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20231101.RouteMapRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface RouteMapArgs {
     ...
     * List of RouteMap rules to be applied.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20231101.RouteMapRuleArgs>[]>;
    /**
