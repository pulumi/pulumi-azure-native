...
export class UserRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: UserRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:UserRule" }, { type: "azure-native:network/v20210201preview:UserRule" }, { type: "azure-native:network/v20220201preview:UserRule" }, { type: "azure-native:network/v20220401preview:UserRule" }, { type: "azure-native:network/v20240301:UserRule" }] };
