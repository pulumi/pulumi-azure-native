 ...
 *
 * const userRuleCollection = new azure_native.network.v20210501preview.UserRuleCollection("userRuleCollection", {
 *     appliesToGroups: [{
...
export class UserRuleCollection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: UserRuleCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:UserRuleCollection" }, { type: "azure-native:network/v20220201preview:UserRuleCollection" }, { type: "azure-native:network/v20220401preview:UserRuleCollection" }] };
