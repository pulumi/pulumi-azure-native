 ...
 */
/** @deprecated azure-native:network/v20210501preview:ScopeConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ScopeConnection to guarantee forwards compatibility. */
export function getScopeConnection(args: GetScopeConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetScopeConnectionResult> {
    pulumi.log.warn("getScopeConnection is deprecated: azure-native:network/v20210501preview:ScopeConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ScopeConnection to guarantee forwards compatibility.")
