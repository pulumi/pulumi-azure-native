...
export function getStaticMember(args: GetStaticMemberArgs, opts?: pulumi.InvokeOptions): Promise<GetStaticMemberResult> {
    pulumi.log.warn("getStaticMember is deprecated: azure-native:network/v20210501preview:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:StaticMember to guarantee forwards compatibility.")
