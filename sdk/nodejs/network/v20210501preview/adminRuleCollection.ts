...
export class AdminRuleCollection extends pulumi.CustomResource {
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20210501preview.NetworkManagerSecurityGroupItemResponse[]>;
    /**
    ...
    constructor(name: string, args: AdminRuleCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:AdminRuleCollection" }, { type: "azure-native:network/v20220101:AdminRuleCollection" }, { type: "azure-native:network/v20220201preview:AdminRuleCollection" }, { type: "azure-native:network/v20220401preview:AdminRuleCollection" }] };
