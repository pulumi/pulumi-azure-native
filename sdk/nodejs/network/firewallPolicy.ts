...
export class FirewallPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly explicitProxySettings!: pulumi.Output<outputs.network.ExplicitProxySettingsResponse | undefined>;
    /**
...
export interface FirewallPolicyArgs {
     ...
     * Explicit Proxy Settings definition.
     */
    explicitProxySettings?: pulumi.Input<inputs.network.ExplicitProxySettingsArgs>;
    /**
