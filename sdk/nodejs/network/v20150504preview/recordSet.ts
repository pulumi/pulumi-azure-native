...
export class RecordSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RecordSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20150504preview:RecordSet" }, { type: "azure-native:network/v20160401:RecordSet" }, { type: "azure-nextgen:network/v20160401:RecordSet" }, { type: "azure-native:network/v20170901:RecordSet" }, { type: "azure-nextgen:network/v20170901:RecordSet" }, { type: "azure-native:network/v20171001:RecordSet" }, { type: "azure-nextgen:network/v20171001:RecordSet" }, { type: "azure-native:network/v20180301preview:RecordSet" }, { type: "azure-nextgen:network/v20180301preview:RecordSet" }, { type: "azure-native:network/v20180501:RecordSet" }, { type: "azure-nextgen:network/v20180501:RecordSet" }] };
