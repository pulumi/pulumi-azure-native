...
export class RecordSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20150504preview:RecordSet';
    ...
    constructor(name: string, args: RecordSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20160401:RecordSet" }, { type: "azurerm:network/v20170901:RecordSet" }, { type: "azurerm:network/v20171001:RecordSet" }, { type: "azurerm:network/v20180301preview:RecordSet" }, { type: "azurerm:network/v20180501:RecordSet" }] };
