...
export function getVirtualRouterPeering(args: GetVirtualRouterPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterPeeringResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20191201:getVirtualRouterPeering", {
        "name": args.name,
...
export interface GetVirtualRouterPeeringResult {
     ...
     */
    readonly properties: outputs.network.v20191201.VirtualRouterPeeringPropertiesResponse;
    /**
     * Peering type.
     */
