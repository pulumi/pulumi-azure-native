...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VirtualHubRouteTableV2Args, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20190901:VirtualHubRouteTableV2" }, { type: "azurerm:network/v20191101:VirtualHubRouteTableV2" }, { type: "azurerm:network/v20200301:VirtualHubRouteTableV2" }, { type: "azurerm:network/v20200401:VirtualHubRouteTableV2" }, { type: "azurerm:network/v20200501:VirtualHubRouteTableV2" }] };
