...
export function getApplicationGatewayBackendHealthOnDemand(args: GetApplicationGatewayBackendHealthOnDemandArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGatewayBackendHealthOnDemandResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20191201:getApplicationGatewayBackendHealthOnDemand", {
...
export interface GetApplicationGatewayBackendHealthOnDemandArgs {
     ...
     */
    readonly backendAddressPool?: inputs.network.v20191201.SubResourceInvoke;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    readonly backendHttpSettings?: inputs.network.v20191201.SubResourceInvoke;
    /**
     ...
     */
    readonly match?: inputs.network.v20191201.ApplicationGatewayProbeHealthResponseMatchInvoke;
    /**
     ...
     */
    readonly protocol?: string | enums.network.v20191201.ApplicationGatewayProtocol;
    /**
...
export interface GetApplicationGatewayBackendHealthOnDemandResult {
     ...
     */
    readonly backendAddressPool?: outputs.network.v20191201.ApplicationGatewayBackendAddressPoolInvokeResponse;
    /**
     * Application gateway BackendHealthHttp settings.
     */
    readonly backendHealthHttpSettings?: outputs.network.v20191201.ApplicationGatewayBackendHealthHttpSettingsInvokeResponse;
}
