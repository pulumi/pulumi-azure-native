...
export function getConnectionMonitor(args: GetConnectionMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionMonitorResult> {
    pulumi.log.warn("getConnectionMonitor is deprecated: azure-native:network/v20191201:ConnectionMonitor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConnectionMonitor to guarantee forwards compatibility.")
