 ...
 *
 * const flowLog = new azurerm.network.v20191201.FlowLog("flowLog", {
 *     enabled: true,
 *     flowLogName: "fl",
 *     format: {
 *         type: "JSON",
...
export class FlowLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20191201:FlowLog';
    ...
    constructor(name: string, argsOrState?: FlowLogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:FlowLog" }, { type: "azurerm:network/v20191101:FlowLog" }, { type: "azurerm:network/v20200301:FlowLog" }, { type: "azurerm:network/v20200401:FlowLog" }, { type: "azurerm:network/v20200501:FlowLog" }, { type: "azurerm:network/v20200601:FlowLog" }] };
