...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20191201:NetworkInterfaceTapConfiguration';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20191201.NetworkInterfaceTapConfigurationPropertiesFormatResponse>;
    /**
     * Sub Resource type.
     */
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * Properties of the Virtual Network Tap configuration.
     */
    readonly properties?: pulumi.Input<inputs.network.v20191201.NetworkInterfaceTapConfigurationPropertiesFormat>;
    /**
