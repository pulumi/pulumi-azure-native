...
export function getPrivateEndpoint(args: GetPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20191201:getPrivateEndpoint", {
        "name": args.name,
...
export interface GetPrivateEndpointResult {
     ...
     */
    readonly properties: outputs.network.v20191201.PrivateEndpointPropertiesResponse;
    /**
     * Resource tags.
     */
