 ...
 *
 * const localNetworkGateway = new azurerm.network.v20191201.LocalNetworkGateway("localNetworkGateway", {
...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20191201:LocalNetworkGateway';
