...
export class FirewallPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20191201.FirewallPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface FirewallPolicyArgs {
     ...
     * Properties of the firewall policy.
     */
    readonly properties?: pulumi.Input<inputs.network.v20191201.FirewallPolicyPropertiesFormat>;
    /**
