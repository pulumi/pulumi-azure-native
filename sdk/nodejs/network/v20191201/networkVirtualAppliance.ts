...
export class NetworkVirtualAppliance extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: NetworkVirtualApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20200301:NetworkVirtualAppliance" }, { type: "azurerm:network/v20200401:NetworkVirtualAppliance" }, { type: "azurerm:network/v20200501:NetworkVirtualAppliance" }] };
