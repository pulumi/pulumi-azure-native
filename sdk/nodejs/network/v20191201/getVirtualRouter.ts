...
export function getVirtualRouter(args: GetVirtualRouterArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20191201:getVirtualRouter", {
        "name": args.name,
...
export interface GetVirtualRouterResult {
     ...
     */
    readonly properties: outputs.network.v20191201.VirtualRouterPropertiesFormatResponse;
    /**
     * Resource tags.
     */
