...
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuit {
        pulumi.log.warn("ExpressRouteCircuit is deprecated: azure-native:network/v20191201:ExpressRouteCircuit is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCircuit to guarantee forwards compatibility.")
