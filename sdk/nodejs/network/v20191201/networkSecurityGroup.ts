...
export class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20191201.NetworkSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityGroupArgs {
     ...
     * Properties of the network security group.
     */
    readonly properties?: pulumi.Input<inputs.network.v20191201.NetworkSecurityGroupPropertiesFormat>;
    /**
