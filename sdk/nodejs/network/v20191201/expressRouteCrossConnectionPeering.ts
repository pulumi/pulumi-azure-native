...
export class ExpressRouteCrossConnectionPeering extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20191201.ExpressRouteCrossConnectionPeeringPropertiesResponse>;
...
export interface ExpressRouteCrossConnectionPeeringArgs {
     ...
     * Properties of the express route cross connection peering.
     */
    readonly properties?: pulumi.Input<inputs.network.v20191201.ExpressRouteCrossConnectionPeeringProperties>;
    /**
