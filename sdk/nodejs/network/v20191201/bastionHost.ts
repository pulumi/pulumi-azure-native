...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20191201:BastionHost';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.network.v20191201.BastionHostPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface BastionHostArgs {
     ...
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20191201.BastionHostIPConfiguration>[]>;
    /**
     * Resource location.
     */
