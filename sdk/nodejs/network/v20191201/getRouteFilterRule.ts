...
export function getRouteFilterRule(args: GetRouteFilterRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20191201:getRouteFilterRule", {
        "name": args.name,
...
export interface GetRouteFilterRuleResult {
     ...
     */
    readonly properties: outputs.network.v20191201.RouteFilterRulePropertiesFormatResponse;
}
