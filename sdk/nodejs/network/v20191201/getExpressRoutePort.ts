...
export function getExpressRoutePort(args: GetExpressRoutePortArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20191201:getExpressRoutePort", {
...
export interface GetExpressRoutePortResult {
     ...
     */
    readonly circuits: outputs.network.v20191201.SubResourceInvokeResponse[];
    /**
     ...
     */
    readonly identity?: outputs.network.v20191201.ManagedServiceIdentityInvokeResponse;
    /**
     * The set of physical links of the ExpressRoutePort resource.
     */
    readonly links?: outputs.network.v20191201.ExpressRouteLinkInvokeResponse[];
    /**
     * Resource location.
     */
