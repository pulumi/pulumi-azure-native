...
export class FirewallPolicyRuleGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20191201:FirewallPolicyRuleGroup';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20191201.FirewallPolicyFilterRuleResponse | outputs.network.v20191201.FirewallPolicyNatRuleResponse[] | undefined>;
    /**
     * Rule Group type.
     */
    ...
    constructor(name: string, args: FirewallPolicyRuleGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20191201:FirewallPolicyRuleGroup" }, { type: "azure-native:network:FirewallPolicyRuleGroup" }, { type: "azure-nextgen:network:FirewallPolicyRuleGroup" }, { type: "azure-native:network/v20190601:FirewallPolicyRuleGroup" }, { type: "azure-nextgen:network/v20190601:FirewallPolicyRuleGroup" }, { type: "azure-native:network/v20190701:FirewallPolicyRuleGroup" }, { type: "azure-nextgen:network/v20190701:FirewallPolicyRuleGroup" }, { type: "azure-native:network/v20190801:FirewallPolicyRuleGroup" }, { type: "azure-nextgen:network/v20190801:FirewallPolicyRuleGroup" }, { type: "azure-native:network/v20190901:FirewallPolicyRuleGroup" }, { type: "azure-nextgen:network/v20190901:FirewallPolicyRuleGroup" }, { type: "azure-native:network/v20191101:FirewallPolicyRuleGroup" }, { type: "azure-nextgen:network/v20191101:FirewallPolicyRuleGroup" }, { type: "azure-native:network/v20200301:FirewallPolicyRuleGroup" }, { type: "azure-nextgen:network/v20200301:FirewallPolicyRuleGroup" }, { type: "azure-native:network/v20200401:FirewallPolicyRuleGroup" }, { type: "azure-nextgen:network/v20200401:FirewallPolicyRuleGroup" }] };
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * Group of Firewall Policy rules.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.v20191201.FirewallPolicyFilterRule | inputs.network.v20191201.FirewallPolicyNatRule>[]>;
}
