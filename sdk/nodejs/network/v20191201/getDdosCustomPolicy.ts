...
export function getDdosCustomPolicy(args: GetDdosCustomPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosCustomPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20191201:getDdosCustomPolicy", {
        "name": args.name,
...
export interface GetDdosCustomPolicyResult {
     ...
     */
    readonly properties: outputs.network.v20191201.DdosCustomPolicyPropertiesFormatResponse;
    /**
     * Resource tags.
     */
