...
export function getServiceEndpointPolicy(args: GetServiceEndpointPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceEndpointPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20191201:getServiceEndpointPolicy", {
        "name": args.name,
...
export interface GetServiceEndpointPolicyResult {
     ...
     */
    readonly properties: outputs.network.v20191201.ServiceEndpointPolicyPropertiesFormatResponse;
    /**
     * Resource tags.
     */
