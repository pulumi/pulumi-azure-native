 ...
 *
 * @deprecated azure-native:network/v20191201:PrivateLinkService is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210201:PrivateLinkService to guarantee forwards compatibility.
 */
export class PrivateLinkService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateLinkService {
        pulumi.log.warn("PrivateLinkService is deprecated: azure-native:network/v20191201:PrivateLinkService is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210201:PrivateLinkService to guarantee forwards compatibility.")
