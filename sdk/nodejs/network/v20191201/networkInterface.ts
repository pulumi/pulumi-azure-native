 ...
 *
 * @deprecated azure-native:network/v20191201:NetworkInterface is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterface to guarantee forwards compatibility.
 */
export class NetworkInterface extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkInterface {
        pulumi.log.warn("NetworkInterface is deprecated: azure-native:network/v20191201:NetworkInterface is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterface to guarantee forwards compatibility.")
