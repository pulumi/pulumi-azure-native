...
export class VpnSite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VpnSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20191201:VpnSite" }, { type: "azure-native:network:VpnSite" }, { type: "azure-nextgen:network:VpnSite" }, { type: "azure-native:network/latest:VpnSite" }, { type: "azure-nextgen:network/latest:VpnSite" }, { type: "azure-native:network/v20180401:VpnSite" }, { type: "azure-nextgen:network/v20180401:VpnSite" }, { type: "azure-native:network/v20180601:VpnSite" }, { type: "azure-nextgen:network/v20180601:VpnSite" }, { type: "azure-native:network/v20180701:VpnSite" }, { type: "azure-nextgen:network/v20180701:VpnSite" }, { type: "azure-native:network/v20180801:VpnSite" }, { type: "azure-nextgen:network/v20180801:VpnSite" }, { type: "azure-native:network/v20181001:VpnSite" }, { type: "azure-nextgen:network/v20181001:VpnSite" }, { type: "azure-native:network/v20181101:VpnSite" }, { type: "azure-nextgen:network/v20181101:VpnSite" }, { type: "azure-native:network/v20181201:VpnSite" }, { type: "azure-nextgen:network/v20181201:VpnSite" }, { type: "azure-native:network/v20190201:VpnSite" }, { type: "azure-nextgen:network/v20190201:VpnSite" }, { type: "azure-native:network/v20190401:VpnSite" }, { type: "azure-nextgen:network/v20190401:VpnSite" }, { type: "azure-native:network/v20190601:VpnSite" }, { type: "azure-nextgen:network/v20190601:VpnSite" }, { type: "azure-native:network/v20190701:VpnSite" }, { type: "azure-nextgen:network/v20190701:VpnSite" }, { type: "azure-native:network/v20190801:VpnSite" }, { type: "azure-nextgen:network/v20190801:VpnSite" }, { type: "azure-native:network/v20190901:VpnSite" }, { type: "azure-nextgen:network/v20190901:VpnSite" }, { type: "azure-native:network/v20191101:VpnSite" }, { type: "azure-nextgen:network/v20191101:VpnSite" }, { type: "azure-native:network/v20200301:VpnSite" }, { type: "azure-nextgen:network/v20200301:VpnSite" }, { type: "azure-native:network/v20200401:VpnSite" }, { type: "azure-nextgen:network/v20200401:VpnSite" }, { type: "azure-native:network/v20200501:VpnSite" }, { type: "azure-nextgen:network/v20200501:VpnSite" }, { type: "azure-native:network/v20200601:VpnSite" }, { type: "azure-nextgen:network/v20200601:VpnSite" }, { type: "azure-native:network/v20200701:VpnSite" }, { type: "azure-nextgen:network/v20200701:VpnSite" }, { type: "azure-native:network/v20200801:VpnSite" }, { type: "azure-nextgen:network/v20200801:VpnSite" }] };
...
export interface VpnSiteArgs {
     ...
     * The set of bgp properties.
     */
    readonly bgpProperties?: pulumi.Input<inputs.network.v20191201.BgpSettings>;
    /**
     * The device properties.
     */
    readonly deviceProperties?: pulumi.Input<inputs.network.v20191201.DeviceProperties>;
    /**
     * Resource ID.
     */
     ...
     * List of all vpn site links.
     */
    readonly vpnSiteLinks?: pulumi.Input<pulumi.Input<inputs.network.v20191201.VpnSiteLink>[]>;
    /**
