 ...
 *
 * const securityUserConfiguration = new azure_native.network.v20210201preview.SecurityUserConfiguration("securityUserConfiguration", {
...
export class SecurityUserConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SecurityUserConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210501preview:SecurityUserConfiguration" }, { type: "azure-native:network/v20220201preview:SecurityUserConfiguration" }, { type: "azure-native:network/v20220401preview:SecurityUserConfiguration" }] };
