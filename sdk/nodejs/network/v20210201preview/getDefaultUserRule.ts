...
export function getDefaultUserRule(args: GetDefaultUserRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetDefaultUserRuleResult> {
    pulumi.log.warn("getDefaultUserRule is deprecated: azure-native:network/v20210201preview:DefaultUserRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210501preview:DefaultUserRule to guarantee forwards compatibility.")
