 ...
 *
 * const defaultAdminRule = new azure_native.network.v20210201preview.DefaultAdminRule("defaultAdminRule", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20210201preview:DefaultAdminRule SampleAdminRule /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/networkManagers/testNetworkManager/securityAdminConfigurations/myTestSecurityConfig/ruleCollections/testRuleCollection/rules/SampleAdminRule 
 * ```
 */
