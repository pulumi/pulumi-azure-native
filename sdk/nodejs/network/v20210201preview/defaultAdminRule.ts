 ...
 *
 * @deprecated azure-native:network/v20210201preview:DefaultAdminRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210501preview:DefaultAdminRule to guarantee forwards compatibility.
 */
export class DefaultAdminRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DefaultAdminRule {
        pulumi.log.warn("DefaultAdminRule is deprecated: azure-native:network/v20210201preview:DefaultAdminRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210501preview:DefaultAdminRule to guarantee forwards compatibility.")
