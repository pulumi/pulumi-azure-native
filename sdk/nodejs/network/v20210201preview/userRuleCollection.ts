 ...
 *
 * const userRuleCollection = new azure_native.network.v20210201preview.UserRuleCollection("userRuleCollection", {
 *     appliesToGroups: [{
...
export class UserRuleCollection extends pulumi.CustomResource {
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20210201preview.NetworkManagerSecurityGroupItemResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: UserRuleCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210501preview:UserRuleCollection" }, { type: "azure-native:network/v20220201preview:UserRuleCollection" }, { type: "azure-native:network/v20220401preview:UserRuleCollection" }] };
...
export interface UserRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups?: pulumi.Input<pulumi.Input<inputs.network.v20210201preview.NetworkManagerSecurityGroupItemArgs>[]>;
    /**
