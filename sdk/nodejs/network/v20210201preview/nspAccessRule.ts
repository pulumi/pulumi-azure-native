...
export class NspAccessRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NspAccessRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20230701preview:NspAccessRule" }, { type: "azure-native:network/v20230801preview:NspAccessRule" }, { type: "azure-native:network:NspAccessRule" }] };
