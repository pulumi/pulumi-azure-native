...
export class NspAccessRule extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly networkSecurityPerimeters!: pulumi.Output<outputs.network.v20210201preview.PerimeterBasedAccessRuleResponse[]>;
    /**
     ...
     */
    public readonly subscriptions!: pulumi.Output<outputs.network.v20210201preview.SubscriptionIdResponse[] | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: NspAccessRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20230701preview:NspAccessRule" }, { type: "azure-native:network/v20230801preview:NspAccessRule" }, { type: "azure-native:network/v20240601preview:NspAccessRule" }, { type: "azure-native:network:NspAccessRule" }] };
