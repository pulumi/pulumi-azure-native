...
export class NetworkManager extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20210201preview:NetworkManager" }, { type: "azure-native:network:NetworkManager" }, { type: "azure-nextgen:network:NetworkManager" }] };
...
export interface NetworkManagerArgs {
     ...
     * Scope of Network Manager.
     */
    readonly networkManagerScopes?: pulumi.Input<inputs.network.v20210201preview.NetworkManagerPropertiesNetworkManagerScopes>;
    /**
