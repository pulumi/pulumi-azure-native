 ...
 *
 * const networkSecurityPerimeter = new azure_native.network.v20210201preview.NetworkSecurityPerimeter("networkSecurityPerimeter", {
...
export class NetworkSecurityPerimeter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkSecurityPerimeterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210301preview:NetworkSecurityPerimeter" }] };
