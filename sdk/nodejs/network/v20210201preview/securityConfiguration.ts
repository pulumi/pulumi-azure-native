...
export class SecurityConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201preview:SecurityConfiguration';
    ...
    constructor(name: string, args: SecurityConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20210201preview:SecurityConfiguration" }, { type: "azure-native:network:SecurityConfiguration" }, { type: "azure-nextgen:network:SecurityConfiguration" }] };
