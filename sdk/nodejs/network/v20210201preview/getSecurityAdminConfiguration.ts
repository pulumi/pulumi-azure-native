...
export function getSecurityAdminConfiguration(args: GetSecurityAdminConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAdminConfigurationResult> {
    pulumi.log.warn("getSecurityAdminConfiguration is deprecated: azure-native:network/v20210201preview:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210501preview:SecurityAdminConfiguration to guarantee forwards compatibility.")
