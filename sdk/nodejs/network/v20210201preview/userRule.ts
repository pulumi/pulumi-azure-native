...
export class UserRule extends pulumi.CustomResource {
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.network.v20210201preview.AddressPrefixItemResponse[] | undefined>;
    /**
     ...
     */
    public readonly sources!: pulumi.Output<outputs.network.v20210201preview.AddressPrefixItemResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: UserRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:UserRule" }, { type: "azure-native:network/v20210501preview:UserRule" }, { type: "azure-native:network/v20220201preview:UserRule" }, { type: "azure-native:network/v20220401preview:UserRule" }] };
...
export interface UserRuleArgs {
     ...
     * The destination address prefixes. CIDR or destination IP ranges.
     */
    destinations?: pulumi.Input<pulumi.Input<inputs.network.v20210201preview.AddressPrefixItemArgs>[]>;
    /**
     * Indicates if the traffic matched against the rule in inbound or outbound.
     */
    direction: pulumi.Input<string | enums.network.v20210201preview.SecurityConfigurationRuleDirection>;
    /**
     * A friendly name for the rule.
     */
     ...
     * Network protocol this rule applies to.
     */
    protocol: pulumi.Input<string | enums.network.v20210201preview.SecurityConfigurationRuleProtocol>;
    /**
     ...
     * The CIDR or source IP ranges.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.network.v20210201preview.AddressPrefixItemArgs>[]>;
}
