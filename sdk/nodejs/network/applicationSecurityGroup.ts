...
export class ApplicationSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:ApplicationSecurityGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.ApplicationSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationSecurityGroupState {
     ...
     * Properties of the application security group.
     */
    readonly properties: pulumi.Input<inputs.network.ApplicationSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationSecurityGroupArgs {
     ...
     * Properties of the application security group.
     */
    readonly properties?: pulumi.Input<inputs.network.ApplicationSecurityGroupPropertiesFormat>;
    /**
