...
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:LoadBalancerBackendAddressPool';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.BackendAddressPoolPropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: LoadBalancerBackendAddressPoolArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LoadBalancerBackendAddressPoolArgs {
     ...
     * Properties of load balancer backend address pool.
     */
    readonly properties?: pulumi.Input<inputs.network.BackendAddressPoolPropertiesFormat>;
    /**
