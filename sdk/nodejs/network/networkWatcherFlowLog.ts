...
export class NetworkWatcherFlowLog extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkWatcherFlowLog {
        return new NetworkWatcherFlowLog(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:NetworkWatcherFlowLog';
    ...
    constructor(name: string, argsOrState?: NetworkWatcherFlowLogArgs, opts?: pulumi.CustomResourceOptions) {
