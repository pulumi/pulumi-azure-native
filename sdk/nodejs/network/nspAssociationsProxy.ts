...
export class NspAssociationsProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network:NspAssociationsProxy';
    ...
    constructor(name: string, args: NspAssociationsProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:NspAssociationsProxy" }] };
