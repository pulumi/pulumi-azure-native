...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:NetworkSecurityGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.NetworkSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityGroupState {
     ...
     * Properties of the network security group.
     */
    readonly properties: pulumi.Input<inputs.network.NetworkSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityGroupArgs {
     ...
     * Properties of the network security group.
     */
    readonly properties?: pulumi.Input<inputs.network.NetworkSecurityGroupPropertiesFormat>;
    /**
