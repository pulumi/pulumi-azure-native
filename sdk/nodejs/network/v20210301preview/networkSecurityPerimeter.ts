...
export class NetworkSecurityPerimeter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkSecurityPerimeterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20210301preview:NetworkSecurityPerimeter" }, { type: "azure-native:network:NetworkSecurityPerimeter" }, { type: "azure-nextgen:network:NetworkSecurityPerimeter" }] };
