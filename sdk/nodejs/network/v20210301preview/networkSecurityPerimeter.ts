...
export class NetworkSecurityPerimeter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkSecurityPerimeterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["networkSecurityPerimeterName"] = args ? args.networkSecurityPerimeterName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20210301preview:NetworkSecurityPerimeter" }, { type: "azure-native:network:NetworkSecurityPerimeter" }, { type: "azure-nextgen:network:NetworkSecurityPerimeter" }, { type: "azure-native:network/v20210201preview:NetworkSecurityPerimeter" }, { type: "azure-nextgen:network/v20210201preview:NetworkSecurityPerimeter" }] };
