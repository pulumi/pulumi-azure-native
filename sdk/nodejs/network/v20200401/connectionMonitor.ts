...
export class ConnectionMonitor extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly destination!: pulumi.Output<outputs.network.v20200401.ConnectionMonitorDestinationResponse | undefined>;
    /**
     * List of connection monitor endpoints.
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.network.v20200401.ConnectionMonitorEndpointResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly outputs!: pulumi.Output<outputs.network.v20200401.ConnectionMonitorOutputResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly source!: pulumi.Output<outputs.network.v20200401.ConnectionMonitorSourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly testConfigurations!: pulumi.Output<outputs.network.v20200401.ConnectionMonitorTestConfigurationResponse[] | undefined>;
    /**
     * List of connection monitor test groups.
     */
    public /*out*/ readonly testGroups!: pulumi.Output<outputs.network.v20200401.ConnectionMonitorTestGroupResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectionMonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.network.v20200401.connectionMonitorParametersArgsProvideDefaults) : undefined) : undefined;
...
export interface ConnectionMonitorArgs {
     ...
     */
    properties: pulumi.Input<inputs.network.v20200401.ConnectionMonitorParametersArgs>;
    /**
