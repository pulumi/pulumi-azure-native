...
export class ConnectionMonitor extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.ConnectionMonitorResultPropertiesResponse>;
    /**
...
export interface ConnectionMonitorArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.network.v20200401.ConnectionMonitorParameters>;
    /**
