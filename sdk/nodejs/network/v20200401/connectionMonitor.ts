...
export class ConnectionMonitor extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectionMonitor {
        pulumi.log.warn("ConnectionMonitor is deprecated: azure-native:network/v20200401:ConnectionMonitor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConnectionMonitor to guarantee forwards compatibility.")
