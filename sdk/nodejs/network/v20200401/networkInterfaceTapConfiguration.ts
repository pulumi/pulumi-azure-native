...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:NetworkInterfaceTapConfiguration';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.NetworkInterfaceTapConfigurationPropertiesFormatResponse>;
    /**
     * Sub Resource type.
     */
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * Properties of the Virtual Network Tap configuration.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.NetworkInterfaceTapConfigurationPropertiesFormat>;
    /**
