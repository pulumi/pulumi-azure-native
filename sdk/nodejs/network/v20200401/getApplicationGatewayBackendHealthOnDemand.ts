...
export function getApplicationGatewayBackendHealthOnDemand(args: GetApplicationGatewayBackendHealthOnDemandArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGatewayBackendHealthOnDemandResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200401:getApplicationGatewayBackendHealthOnDemand", {
...
export interface GetApplicationGatewayBackendHealthOnDemandArgs {
     ...
     */
    readonly backendAddressPool?: inputs.network.v20200401.SubResourceInvoke;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    readonly backendHttpSettings?: inputs.network.v20200401.SubResourceInvoke;
    /**
     ...
     */
    readonly match?: inputs.network.v20200401.ApplicationGatewayProbeHealthResponseMatchInvoke;
    /**
...
export interface GetApplicationGatewayBackendHealthOnDemandResult {
     ...
     */
    readonly backendAddressPool?: outputs.network.v20200401.ApplicationGatewayBackendAddressPoolInvokeResponse;
    /**
     * Application gateway BackendHealthHttp settings.
     */
    readonly backendHealthHttpSettings?: outputs.network.v20200401.ApplicationGatewayBackendHealthHttpSettingsInvokeResponse;
}
