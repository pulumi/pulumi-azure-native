 ...
 *
 * const expressRouteConnection = new azurerm.network.v20200401.ExpressRouteConnection("expressRouteConnection", {
...
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:ExpressRouteConnection';
