...
export class VpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:VpnServerConfiguration';
...
export interface VpnServerConfigurationArgs {
     ...
     * Properties of the P2SVpnServer configuration.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.VpnServerConfigurationProperties>;
    /**
