...
export class FirewallPolicyRuleGroup extends pulumi.CustomResource {
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20200401.FirewallPolicyRuleResponse[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * Group of Firewall Policy rules.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.v20200401.FirewallPolicyRule>[]>;
}
