...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:ExpressRouteGateway';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.network.v20200401.ExpressRouteGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ExpressRouteGatewayArgs {
     ...
     */
    readonly autoScaleConfiguration?: pulumi.Input<inputs.network.v20200401.ExpressRouteGatewayPropertiesProperties>;
    /**
     * Resource ID.
     */
