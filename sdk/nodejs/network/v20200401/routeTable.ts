...
export class RouteTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RouteTable {
        pulumi.log.warn("RouteTable is deprecated: azure-native:network/v20200401:RouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteTable to guarantee forwards compatibility.")
        return new RouteTable(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200401:RouteTable';
     ...
     */
    public readonly routes!: pulumi.Output<outputs.network.v20200401.RouteResponse[] | undefined>;
    /**
