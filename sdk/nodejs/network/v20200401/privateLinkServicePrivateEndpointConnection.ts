...
export class PrivateLinkServicePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateLinkServicePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:PrivateLinkServicePrivateEndpointConnection" }, { type: "azurerm:network/preview:PrivateLinkServicePrivateEndpointConnection" }, { type: "azurerm:network/v20190901:PrivateLinkServicePrivateEndpointConnection" }, { type: "azurerm:network/v20191101:PrivateLinkServicePrivateEndpointConnection" }, { type: "azurerm:network/v20191201:PrivateLinkServicePrivateEndpointConnection" }, { type: "azurerm:network/v20200301:PrivateLinkServicePrivateEndpointConnection" }, { type: "azurerm:network/v20200501:PrivateLinkServicePrivateEndpointConnection" }, { type: "azurerm:network/v20200601:PrivateLinkServicePrivateEndpointConnection" }] };
