...
export class IpAllocation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IpAllocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/latest:IpAllocation" }, { type: "azure-nextgen:network/v20200301:IpAllocation" }, { type: "azure-nextgen:network/v20200501:IpAllocation" }, { type: "azure-nextgen:network/v20200601:IpAllocation" }] };
