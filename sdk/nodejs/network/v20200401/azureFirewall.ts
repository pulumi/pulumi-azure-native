...
export class AzureFirewall extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.AzureFirewallPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface AzureFirewallArgs {
     ...
     * Properties of the azure firewall.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.AzureFirewallPropertiesFormat>;
    /**
