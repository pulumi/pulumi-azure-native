...
export class VirtualRouterPeering extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.VirtualRouterPeeringPropertiesResponse>;
    /**
     * Peering type.
     */
...
export interface VirtualRouterPeeringArgs {
     ...
     * The properties of the Virtual Router Peering.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.VirtualRouterPeeringProperties>;
    /**
