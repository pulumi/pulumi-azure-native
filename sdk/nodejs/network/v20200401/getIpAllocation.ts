...
export function getIpAllocation(args: GetIpAllocationArgs, opts?: pulumi.InvokeOptions): Promise<GetIpAllocationResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200401:getIpAllocation", {
        "name": args.name,
...
export interface GetIpAllocationResult {
     ...
     */
    readonly properties: outputs.network.v20200401.IpAllocationPropertiesFormatResponse;
    /**
     * Resource tags.
     */
