...
export function getFirewallPolicyRuleGroup(args: GetFirewallPolicyRuleGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200401:getFirewallPolicyRuleGroup", {
...
export interface GetFirewallPolicyRuleGroupResult {
     ...
     */
    readonly rules?: outputs.network.v20200401.FirewallPolicyFilterRuleInvokeResponse | outputs.network.v20200401.FirewallPolicyNatRuleInvokeResponse[];
    /**
     * Rule Group type.
     */
