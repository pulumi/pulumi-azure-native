...
export function getDdosProtectionPlan(args: GetDdosProtectionPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosProtectionPlanResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200401:getDdosProtectionPlan", {
        "name": args.name,
...
export interface GetDdosProtectionPlanResult {
     ...
     */
    readonly properties: outputs.network.v20200401.DdosProtectionPlanPropertiesFormatResponse;
    /**
     * Resource tags.
     */
