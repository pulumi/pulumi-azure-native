 ...
 *
 * const hubRouteTable = new azurerm.network.v20200401.HubRouteTable("hubRouteTable", {
 *     labels: [
 *         "label1",
 *         "label2",
 *     ],
...
export class HubRouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:HubRouteTable';
    ...
    constructor(name: string, args: HubRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:HubRouteTable" }, { type: "azurerm:network/v20200501:HubRouteTable" }, { type: "azurerm:network/v20200601:HubRouteTable" }] };
