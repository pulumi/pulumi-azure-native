...
export class IpGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.IpGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface IpGroupArgs {
     ...
     * Properties of the IpGroups.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.IpGroupPropertiesFormat>;
    /**
