...
export class ApplicationSecurityGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.ApplicationSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationSecurityGroupArgs {
     ...
     * Properties of the application security group.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.ApplicationSecurityGroupPropertiesFormat>;
    /**
