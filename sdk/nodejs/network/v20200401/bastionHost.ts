...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:BastionHost';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.BastionHostPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface BastionHostArgs {
     ...
     * Represents the bastion host resource.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.BastionHostPropertiesFormat>;
    /**
