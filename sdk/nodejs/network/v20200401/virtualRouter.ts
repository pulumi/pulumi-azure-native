...
export class VirtualRouter extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.VirtualRouterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualRouterArgs {
     ...
     * Properties of the Virtual Router.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.VirtualRouterPropertiesFormat>;
    /**
