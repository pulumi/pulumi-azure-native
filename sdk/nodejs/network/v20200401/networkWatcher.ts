...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:NetworkWatcher';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.NetworkWatcherPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkWatcherArgs {
     ...
     * Properties of the network watcher.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.NetworkWatcherPropertiesFormat>;
    /**
