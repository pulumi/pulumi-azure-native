...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:RouteFilter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.RouteFilterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Properties of the route filter.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.RouteFilterPropertiesFormat>;
    /**
