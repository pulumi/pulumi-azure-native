...
export function getNetworkWatcher(args: GetNetworkWatcherArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkWatcherResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200401:getNetworkWatcher", {
        "name": args.name,
...
export interface GetNetworkWatcherResult {
     ...
     */
    readonly properties: outputs.network.v20200401.NetworkWatcherPropertiesFormatResponse;
    /**
     * Resource tags.
     */
