...
export function getBastionHost(args: GetBastionHostArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionHostResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200401:getBastionHost", {
        "name": args.name,
...
export interface GetBastionHostResult {
     ...
     */
    readonly properties: outputs.network.v20200401.BastionHostPropertiesFormatResponse;
    /**
     * Resource tags.
     */
