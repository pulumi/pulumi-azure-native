...
export class DdosProtectionPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:DdosProtectionPlan';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.DdosProtectionPlanPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface DdosProtectionPlanArgs {
     ...
     * Properties of the DDoS protection plan.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.DdosProtectionPlanPropertiesFormat>;
    /**
