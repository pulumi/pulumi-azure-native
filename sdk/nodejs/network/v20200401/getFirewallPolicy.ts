...
export function getFirewallPolicy(args: GetFirewallPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200401:getFirewallPolicy", {
        "name": args.name,
...
export interface GetFirewallPolicyResult {
     ...
     */
    readonly properties: outputs.network.v20200401.FirewallPolicyPropertiesFormatResponse;
    /**
     * Resource tags.
     */
