...
export class FrontDoor extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FrontDoorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:FrontDoor" }, { type: "azurerm:network/preview:FrontDoor" }, { type: "azurerm:network/v20180801:FrontDoor" }, { type: "azurerm:network/v20190401:FrontDoor" }, { type: "azurerm:network/v20190501:FrontDoor" }, { type: "azurerm:network/v20200101:FrontDoor" }, { type: "azurerm:network/v20200501:FrontDoor" }] };
