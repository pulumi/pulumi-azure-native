...
export class FrontDoor extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FrontDoorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200401:FrontDoor" }, { type: "azure-native:network:FrontDoor" }, { type: "azure-nextgen:network:FrontDoor" }, { type: "azure-native:network/latest:FrontDoor" }, { type: "azure-nextgen:network/latest:FrontDoor" }, { type: "azure-native:network/v20190401:FrontDoor" }, { type: "azure-nextgen:network/v20190401:FrontDoor" }, { type: "azure-native:network/v20190501:FrontDoor" }, { type: "azure-nextgen:network/v20190501:FrontDoor" }, { type: "azure-native:network/v20200101:FrontDoor" }, { type: "azure-nextgen:network/v20200101:FrontDoor" }, { type: "azure-native:network/v20200501:FrontDoor" }, { type: "azure-nextgen:network/v20200501:FrontDoor" }] };
...
export interface FrontDoorArgs {
     ...
     * Operational status of the Front Door load balancer. Permitted values are 'Enabled' or 'Disabled'
     */
    readonly enabledState?: pulumi.Input<string | enums.network.v20200401.FrontDoorEnabledState>;
    /**
     * A friendly name for the frontDoor
     */
