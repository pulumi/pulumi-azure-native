...
export class SecurityPartnerProvider extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.SecurityPartnerProviderPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface SecurityPartnerProviderArgs {
     ...
     * Properties of the Security Partner Provider.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.SecurityPartnerProviderPropertiesFormat>;
    /**
