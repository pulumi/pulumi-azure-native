...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200401:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly ipsecPolicies?: outputs.network.v20200401.IpsecPolicyInvokeResponse[];
    /**
     ...
     */
    readonly remoteVpnSite?: outputs.network.v20200401.SubResourceInvokeResponse;
    /**
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    readonly routingConfiguration?: outputs.network.v20200401.RoutingConfigurationInvokeResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: outputs.network.v20200401.VpnSiteLinkConnectionInvokeResponse[];
}
