...
export function getPrivateEndpoint(args: GetPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointResult> {
    pulumi.log.warn("getPrivateEndpoint is deprecated: azure-native:network/v20200401:PrivateEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210201:PrivateEndpoint to guarantee forwards compatibility.")
