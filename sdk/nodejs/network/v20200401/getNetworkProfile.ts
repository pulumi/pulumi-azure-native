...
export function getNetworkProfile(args: GetNetworkProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkProfileResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200401:getNetworkProfile", {
        "name": args.name,
...
export interface GetNetworkProfileResult {
     ...
     */
    readonly properties: outputs.network.v20200401.NetworkProfilePropertiesFormatResponse;
    /**
     * Resource tags.
     */
