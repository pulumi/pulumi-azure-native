...
export class NetworkVirtualAppliance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkVirtualApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:NetworkVirtualAppliance" }, { type: "azurerm:network/preview:NetworkVirtualAppliance" }, { type: "azurerm:network/v20191201:NetworkVirtualAppliance" }, { type: "azurerm:network/v20200301:NetworkVirtualAppliance" }, { type: "azurerm:network/v20200501:NetworkVirtualAppliance" }, { type: "azurerm:network/v20200601:NetworkVirtualAppliance" }] };
