...
export class PrivateLinkService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:PrivateLinkService';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.PrivateLinkServicePropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface PrivateLinkServiceArgs {
     ...
     * Properties of the private link service.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.PrivateLinkServiceProperties>;
    /**
