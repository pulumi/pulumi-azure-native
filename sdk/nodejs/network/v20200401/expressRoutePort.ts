...
export class ExpressRoutePort extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.ExpressRoutePortPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ExpressRoutePortArgs {
     ...
     * ExpressRoutePort properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.ExpressRoutePortPropertiesFormat>;
    /**
