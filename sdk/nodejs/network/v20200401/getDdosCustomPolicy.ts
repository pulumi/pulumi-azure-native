...
export function getDdosCustomPolicy(args: GetDdosCustomPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosCustomPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200401:getDdosCustomPolicy", {
        "name": args.name,
...
export interface GetDdosCustomPolicyResult {
     ...
     */
    readonly properties: outputs.network.v20200401.DdosCustomPolicyPropertiesFormatResponse;
    /**
     * Resource tags.
     */
