...
export class VirtualNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:VirtualNetworkGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.VirtualNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkGatewayArgs {
     ...
     * Properties of the virtual network gateway.
     */
    readonly properties: pulumi.Input<inputs.network.v20200401.VirtualNetworkGatewayPropertiesFormat>;
    /**
