 ...
 *
 * @deprecated azure-native:network/v20200401:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatGateway to guarantee forwards compatibility.
 */
export class NatGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NatGateway {
        pulumi.log.warn("NatGateway is deprecated: azure-native:network/v20200401:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatGateway to guarantee forwards compatibility.")
