...
export class WebApplicationFirewallPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.WebApplicationFirewallPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * Properties of the web application firewall policy.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.WebApplicationFirewallPolicyPropertiesFormat>;
    /**
