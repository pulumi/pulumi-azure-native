...
export class FlowLog extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200401.FlowLogPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface FlowLogArgs {
     ...
     * Properties of the flow log.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200401.FlowLogPropertiesFormat>;
    /**
