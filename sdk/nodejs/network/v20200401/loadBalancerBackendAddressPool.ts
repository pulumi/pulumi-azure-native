...
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: LoadBalancerBackendAddressPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:LoadBalancerBackendAddressPool" }, { type: "azurerm:network/preview:LoadBalancerBackendAddressPool" }, { type: "azurerm:network/v20200501:LoadBalancerBackendAddressPool" }, { type: "azurerm:network/v20200601:LoadBalancerBackendAddressPool" }] };
