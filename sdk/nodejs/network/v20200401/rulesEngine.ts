 ...
 *
 * const rulesEngine = new azurerm.network.v20200401.RulesEngine("rulesEngine", {
...
export class RulesEngine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200401:RulesEngine';
    ...
    constructor(name: string, args: RulesEngineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:RulesEngine" }, { type: "azurerm:network/v20200101:RulesEngine" }, { type: "azurerm:network/v20200501:RulesEngine" }] };
