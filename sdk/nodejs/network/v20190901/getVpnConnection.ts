...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190901:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly remoteVpnSite?: outputs.network.v20190901.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: outputs.network.v20190901.VpnSiteLinkConnectionInvokeResponse[];
}
