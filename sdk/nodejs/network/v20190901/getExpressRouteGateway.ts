...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly autoScaleConfiguration?: outputs.network.v20190901.ExpressRouteGatewayPropertiesInvokeResponseAutoScaleConfiguration;
    /**
     ...
     */
    readonly expressRouteConnections: outputs.network.v20190901.ExpressRouteConnectionInvokeResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly virtualHub: outputs.network.v20190901.VirtualHubIdInvokeResponse;
}
