...
export class PrivateLinkServicePrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190901.PrivateEndpointConnectionPropertiesResponse>;
    /**
     * The resource type.
     */
...
export interface PrivateLinkServicePrivateEndpointConnectionArgs {
     ...
     * Properties of the private end point connection.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190901.PrivateEndpointConnectionProperties>;
    /**
