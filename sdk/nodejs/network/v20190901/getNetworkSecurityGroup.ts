...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190901:getNetworkSecurityGroup", {
        "expand": args.expand,
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules: outputs.network.v20190901.SecurityRuleInvokeResponse[];
    /**
     ...
     */
    readonly securityRules?: outputs.network.v20190901.SecurityRuleInvokeResponse[];
    /**
