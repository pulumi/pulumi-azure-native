...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190901.VirtualHubRouteTableV2PropertiesResponse>;
...
export interface VirtualHubRouteTableV2Args {
     ...
     * Properties of the virtual hub route table v2.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190901.VirtualHubRouteTableV2Properties>;
    /**
