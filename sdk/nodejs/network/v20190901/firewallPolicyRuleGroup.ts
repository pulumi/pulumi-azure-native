...
export class FirewallPolicyRuleGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FirewallPolicyRuleGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20190601:FirewallPolicyRuleGroup" }, { type: "azurerm:network/v20190701:FirewallPolicyRuleGroup" }, { type: "azurerm:network/v20190801:FirewallPolicyRuleGroup" }, { type: "azurerm:network/v20191101:FirewallPolicyRuleGroup" }, { type: "azurerm:network/v20191201:FirewallPolicyRuleGroup" }, { type: "azurerm:network/v20200301:FirewallPolicyRuleGroup" }, { type: "azurerm:network/v20200401:FirewallPolicyRuleGroup" }] };
