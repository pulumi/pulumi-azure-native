...
export class FirewallPolicyRuleGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190901.FirewallPolicyRuleGroupPropertiesResponse>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * The properties of the firewall policy rule group.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190901.FirewallPolicyRuleGroupProperties>;
    /**
