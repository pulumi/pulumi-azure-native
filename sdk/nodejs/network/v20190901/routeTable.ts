 ...
 *
 * @deprecated azure-native:network/v20190901:RouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteTable to guarantee forwards compatibility.
 */
export class RouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190901:RouteTable';
     ...
     */
    public readonly routes!: pulumi.Output<outputs.network.v20190901.RouteResponse[] | undefined>;
    /**
...
export interface RouteTableArgs {
     ...
     * Collection of routes contained within a route table.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20190901.RouteArgs>[]>;
    /**
     * Resource tags.
     */
