 ...
 *
 * const natGateway = new azurerm.network.v20190901.NatGateway("natGateway", {
 *     location: "westus",
...
export class NatGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190901:NatGateway';
    ...
    constructor(name: string, argsOrState?: NatGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:NatGateway" }, { type: "azurerm:network/v20190201:NatGateway" }, { type: "azurerm:network/v20190401:NatGateway" }, { type: "azurerm:network/v20190601:NatGateway" }, { type: "azurerm:network/v20190701:NatGateway" }, { type: "azurerm:network/v20190801:NatGateway" }, { type: "azurerm:network/v20191101:NatGateway" }, { type: "azurerm:network/v20191201:NatGateway" }, { type: "azurerm:network/v20200301:NatGateway" }, { type: "azurerm:network/v20200401:NatGateway" }, { type: "azurerm:network/v20200501:NatGateway" }, { type: "azurerm:network/v20200601:NatGateway" }] };
...
export interface NatGatewayArgs {
     ...
     * An array of public ip addresses associated with the nat gateway resource.
     */
    readonly publicIpAddresses?: pulumi.Input<pulumi.Input<inputs.network.v20190901.SubResource>[]>;
    /**
     * An array of public ip prefixes associated with the nat gateway resource.
     */
    readonly publicIpPrefixes?: pulumi.Input<pulumi.Input<inputs.network.v20190901.SubResource>[]>;
    /**
     ...
     * The nat gateway SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20190901.NatGatewaySku>;
    /**
     * Resource tags.
     */
