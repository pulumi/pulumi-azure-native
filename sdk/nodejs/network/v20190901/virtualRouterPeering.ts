 ...
 *
 * const virtualRouterPeering = new azurerm.network.v20190901.VirtualRouterPeering("virtualRouterPeering", {
 *     peerAsn: 20000,
 *     peerIp: "192.168.1.5",
...
export class VirtualRouterPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190901:VirtualRouterPeering';
    ...
    constructor(name: string, argsOrState?: VirtualRouterPeeringArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VirtualRouterPeering" }, { type: "azurerm:network/v20190701:VirtualRouterPeering" }, { type: "azurerm:network/v20190801:VirtualRouterPeering" }, { type: "azurerm:network/v20191101:VirtualRouterPeering" }, { type: "azurerm:network/v20191201:VirtualRouterPeering" }, { type: "azurerm:network/v20200301:VirtualRouterPeering" }, { type: "azurerm:network/v20200401:VirtualRouterPeering" }, { type: "azurerm:network/v20200501:VirtualRouterPeering" }, { type: "azurerm:network/v20200601:VirtualRouterPeering" }] };
