...
export class BastionHost extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BastionHost {
        pulumi.log.warn("BastionHost is deprecated: azure-native:network/v20190901:BastionHost is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:BastionHost to guarantee forwards compatibility.")
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20190901.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190901.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
