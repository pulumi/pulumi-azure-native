...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190901:getVirtualNetworkGateway", {
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly bgpSettings?: outputs.network.v20190901.BgpSettingsInvokeResponse;
    /**
     ...
     */
    readonly customRoutes?: outputs.network.v20190901.AddressSpaceInvokeResponse;
    /**
     ...
     */
    readonly gatewayDefaultSite?: outputs.network.v20190901.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly ipConfigurations?: outputs.network.v20190901.VirtualNetworkGatewayIPConfigurationInvokeResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.v20190901.VirtualNetworkGatewaySkuInvokeResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly vpnClientConfiguration?: outputs.network.v20190901.VpnClientConfigurationInvokeResponse;
    /**
