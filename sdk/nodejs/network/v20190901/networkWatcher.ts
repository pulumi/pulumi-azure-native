 ...
 *
 * const networkWatcher = new azurerm.network.v20190901.NetworkWatcher("networkWatcher", {
 *     location: "eastus",
...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190901:NetworkWatcher';
