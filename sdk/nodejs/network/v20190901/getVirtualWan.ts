...
export function getVirtualWan(args: GetVirtualWanArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualWanResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190901:getVirtualWan", {
...
export interface GetVirtualWanResult {
     ...
     */
    readonly virtualHubs: outputs.network.v20190901.SubResourceInvokeResponse[];
    /**
     * List of VpnSites in the VirtualWAN.
     */
    readonly vpnSites: outputs.network.v20190901.SubResourceInvokeResponse[];
}
