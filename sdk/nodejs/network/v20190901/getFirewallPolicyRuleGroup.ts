...
export function getFirewallPolicyRuleGroup(args: GetFirewallPolicyRuleGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190901:getFirewallPolicyRuleGroup", {
...
export interface GetFirewallPolicyRuleGroupResult {
     ...
     */
    readonly rules?: outputs.network.v20190901.FirewallPolicyFilterRuleInvokeResponse | outputs.network.v20190901.FirewallPolicyNatRuleInvokeResponse[];
    /**
     * Rule Group type.
     */
