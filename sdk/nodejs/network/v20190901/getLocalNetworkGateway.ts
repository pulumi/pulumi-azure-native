...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190901:getLocalNetworkGateway", {
        "name": args.name,
...
export interface GetLocalNetworkGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20190901.LocalNetworkGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
