...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    pulumi.log.warn("getLocalNetworkGateway is deprecated: azure-native:network/v20190901:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LocalNetworkGateway to guarantee forwards compatibility.")
