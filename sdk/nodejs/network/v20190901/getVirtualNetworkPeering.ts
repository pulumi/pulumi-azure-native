...
export function getVirtualNetworkPeering(args: GetVirtualNetworkPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190901:getVirtualNetworkPeering", {
...
export interface GetVirtualNetworkPeeringResult {
     ...
     */
    readonly remoteAddressSpace?: outputs.network.v20190901.AddressSpaceInvokeResponse;
    /**
     ...
     */
    readonly remoteVirtualNetwork?: outputs.network.v20190901.SubResourceInvokeResponse;
    /**
