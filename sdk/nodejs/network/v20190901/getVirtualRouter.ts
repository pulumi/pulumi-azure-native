...
export function getVirtualRouter(args: GetVirtualRouterArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190901:getVirtualRouter", {
        "expand": args.expand,
...
export interface GetVirtualRouterResult {
     ...
     */
    readonly hostedGateway?: outputs.network.v20190901.SubResourceInvokeResponse;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    readonly hostedSubnet?: outputs.network.v20190901.SubResourceInvokeResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly peerings: outputs.network.v20190901.SubResourceInvokeResponse[];
    /**
