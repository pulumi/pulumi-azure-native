...
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20190901:PublicIPAddress';
