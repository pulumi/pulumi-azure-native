...
export function getExpressRouteCircuitPeering(args: GetExpressRouteCircuitPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20171101:getExpressRouteCircuitPeering", {
...
export interface GetExpressRouteCircuitPeeringResult {
     ...
     */
    readonly ipv6PeeringConfig?: outputs.network.v20171101.Ipv6ExpressRouteCircuitPeeringConfigInvokeResponse;
    /**
     ...
     */
    readonly microsoftPeeringConfig?: outputs.network.v20171101.ExpressRouteCircuitPeeringConfigInvokeResponse;
    /**
     ...
     */
    readonly routeFilter?: outputs.network.v20171101.RouteFilterInvokeResponse;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    readonly stats?: outputs.network.v20171101.ExpressRouteCircuitStatsInvokeResponse;
    /**
     * The VLAN ID.
     */
