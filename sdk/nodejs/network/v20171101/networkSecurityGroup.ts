...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20171101:NetworkSecurityGroup';
