...
export class PacketCapture extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20171101:PacketCapture';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20171101.PacketCaptureResultPropertiesResponse>;
...
export interface PacketCaptureArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.network.v20171101.PacketCaptureParameters>;
    /**
