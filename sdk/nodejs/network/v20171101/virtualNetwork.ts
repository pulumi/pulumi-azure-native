...
azure-native:network/v20171101:VirtualNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:VirtualNetwork to guarantee forwards compatibility.
 */
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetwork {
        pulumi.log.warn("VirtualNetwork is deprecated: Version 2017-11-01 will be removed in v2 of the provider.\nazure-native:network/v20171101:VirtualNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:VirtualNetwork to guarantee forwards compatibility.")
