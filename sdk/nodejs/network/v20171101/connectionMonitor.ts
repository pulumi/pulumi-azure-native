...
export class ConnectionMonitor extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectionMonitor {
        pulumi.log.warn("ConnectionMonitor is deprecated: Version 2017-11-01 will be removed in v2 of the provider.")
     ...
     */
    public /*out*/ readonly destination!: pulumi.Output<outputs.network.v20171101.ConnectionMonitorDestinationResponse>;
     ...
     */
    public /*out*/ readonly source!: pulumi.Output<outputs.network.v20171101.ConnectionMonitorSourceResponse>;
    /**
    ...
    constructor(name: string, args: ConnectionMonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.network.v20171101.connectionMonitorParametersArgsProvideDefaults) : undefined) : undefined;
...
export interface ConnectionMonitorArgs {
     ...
     */
    properties: pulumi.Input<inputs.network.v20171101.ConnectionMonitorParametersArgs>;
    /**
