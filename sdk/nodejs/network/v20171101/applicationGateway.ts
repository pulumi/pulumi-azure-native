...
export class ApplicationGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20171101.ApplicationGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationGatewayArgs {
     ...
     * Properties of the application gateway.
     */
    readonly properties?: pulumi.Input<inputs.network.v20171101.ApplicationGatewayPropertiesFormat>;
    /**
