...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20171101:VirtualNetworkGatewayConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20171101.VirtualNetworkGatewayConnectionPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * Properties of the virtual network gateway connection.
     */
    readonly properties: pulumi.Input<inputs.network.v20171101.VirtualNetworkGatewayConnectionPropertiesFormat>;
    /**
