...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    pulumi.log.warn("getVirtualNetworkGateway is deprecated: Version 2017-11-01 will be removed in v2 of the provider.")
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20171101.VirtualNetworkGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
