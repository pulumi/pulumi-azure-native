...
export class DdosProtectionPlan extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly publicIPAddresses: pulumi.Output<outputs.network.SubResourceResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly virtualNetworks: pulumi.Output<outputs.network.SubResourceResponse[]>;
