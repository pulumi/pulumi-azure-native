...
export class ApplicationGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:ApplicationGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.ApplicationGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationGatewayState {
     ...
     * Properties of the application gateway.
     */
    readonly properties: pulumi.Input<inputs.network.ApplicationGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationGatewayArgs {
     ...
     * Properties of the application gateway.
     */
    readonly properties?: pulumi.Input<inputs.network.ApplicationGatewayPropertiesFormat>;
    /**
