...
export class VpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20201101:VpnServerConfiguration';
     ...
     */
    public readonly aadAuthenticationParameters!: pulumi.Output<outputs.network.v20201101.AadAuthenticationParametersResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly p2SVpnGateways!: pulumi.Output<outputs.network.v20201101.P2SVpnGatewayResponse[]>;
    /**
     ...
     */
    public readonly radiusClientRootCertificates!: pulumi.Output<outputs.network.v20201101.VpnServerConfigRadiusClientRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServerRootCertificates!: pulumi.Output<outputs.network.v20201101.VpnServerConfigRadiusServerRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServers!: pulumi.Output<outputs.network.v20201101.RadiusServerResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly vpnClientIpsecPolicies!: pulumi.Output<outputs.network.v20201101.IpsecPolicyResponse[] | undefined>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRevokedCertificates!: pulumi.Output<outputs.network.v20201101.VpnServerConfigVpnClientRevokedCertificateResponse[] | undefined>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRootCertificates!: pulumi.Output<outputs.network.v20201101.VpnServerConfigVpnClientRootCertificateResponse[] | undefined>;
    /**
...
export interface VpnServerConfigurationArgs {
     ...
     * The set of aad vpn authentication parameters.
     */
    aadAuthenticationParameters?: pulumi.Input<inputs.network.v20201101.AadAuthenticationParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Radius client root certificate of VpnServerConfiguration.
     */
    radiusClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20201101.VpnServerConfigRadiusClientRootCertificateArgs>[]>;
    /**
     * The radius server address property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Radius Server root certificate of VpnServerConfiguration.
     */
    radiusServerRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20201101.VpnServerConfigRadiusServerRootCertificateArgs>[]>;
    /**
     * The radius secret property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Multiple Radius Server configuration for VpnServerConfiguration.
     */
    radiusServers?: pulumi.Input<pulumi.Input<inputs.network.v20201101.RadiusServerArgs>[]>;
    /**
     ...
     * VPN authentication types for the VpnServerConfiguration.
     */
    vpnAuthenticationTypes?: pulumi.Input<pulumi.Input<string | enums.network.v20201101.VpnAuthenticationType>[]>;
    /**
     * VpnClientIpsecPolicies for VpnServerConfiguration.
     */
    vpnClientIpsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20201101.IpsecPolicyArgs>[]>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    vpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20201101.VpnServerConfigVpnClientRevokedCertificateArgs>[]>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    vpnClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20201101.VpnServerConfigVpnClientRootCertificateArgs>[]>;
    /**
     * VPN protocols for the VpnServerConfiguration.
     */
    vpnProtocols?: pulumi.Input<pulumi.Input<string | enums.network.v20201101.VpnGatewayTunnelingProtocol>[]>;
    /**
