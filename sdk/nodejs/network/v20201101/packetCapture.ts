...
export interface PacketCaptureArgs {
     ...
     * A list of packet capture filters.
     */
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20201101.PacketCaptureFilter>[]>;
    /**
     ...
     * The storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20201101.PacketCaptureStorageLocation>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
