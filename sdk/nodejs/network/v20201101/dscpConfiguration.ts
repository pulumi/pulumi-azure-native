...
export class DscpConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DscpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20201101:DscpConfiguration" }, { type: "azure-native:network:DscpConfiguration" }, { type: "azure-nextgen:network:DscpConfiguration" }, { type: "azure-native:network/v20200601:DscpConfiguration" }, { type: "azure-nextgen:network/v20200601:DscpConfiguration" }, { type: "azure-native:network/v20200701:DscpConfiguration" }, { type: "azure-nextgen:network/v20200701:DscpConfiguration" }, { type: "azure-native:network/v20200801:DscpConfiguration" }, { type: "azure-nextgen:network/v20200801:DscpConfiguration" }, { type: "azure-native:network/v20210201:DscpConfiguration" }, { type: "azure-nextgen:network/v20210201:DscpConfiguration" }] };
...
export interface DscpConfigurationArgs {
     ...
     * Destination IP ranges.
     */
    readonly destinationIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20201101.QosIpRangeArgs>[]>;
    /**
     * Destination port ranges.
     */
    readonly destinationPortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20201101.QosPortRangeArgs>[]>;
    /**
     ...
     * RNM supported protocol types.
     */
    readonly protocol?: pulumi.Input<string | enums.network.v20201101.ProtocolType>;
    /**
     ...
     * Source IP ranges.
     */
    readonly sourceIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20201101.QosIpRangeArgs>[]>;
    /**
     * Sources port ranges.
     */
    readonly sourcePortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20201101.QosPortRangeArgs>[]>;
    /**
     * Resource tags.
     */
