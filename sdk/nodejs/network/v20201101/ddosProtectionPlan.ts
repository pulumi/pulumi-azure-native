 ...
 *
 * const ddosProtectionPlan = new azure_native.network.v20201101.DdosProtectionPlan("ddosProtectionPlan", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20201101:DdosProtectionPlan test-plan /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/ddosProtectionPlans/test-plan 
 * ```
 */
