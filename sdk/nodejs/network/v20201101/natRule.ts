...
export class NatRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NatRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20201101:NatRule" }, { type: "azure-native:network:NatRule" }, { type: "azure-nextgen:network:NatRule" }, { type: "azure-native:network/latest:NatRule" }, { type: "azure-nextgen:network/latest:NatRule" }, { type: "azure-native:network/v20200801:NatRule" }, { type: "azure-nextgen:network/v20200801:NatRule" }] };
...
export interface NatRuleArgs {
     ...
     * The private IP address external mapping for NAT.
     */
    readonly externalMappings?: pulumi.Input<pulumi.Input<inputs.network.v20201101.VpnNatRuleMapping>[]>;
    /**
     ...
     * The private IP address internal mapping for NAT.
     */
    readonly internalMappings?: pulumi.Input<pulumi.Input<inputs.network.v20201101.VpnNatRuleMapping>[]>;
    /**
     * The IP Configuration ID this NAT rule applies to.
     */
