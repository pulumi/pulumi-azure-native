 ...
 *
 * const applicationGatewayPrivateEndpointConnection = new azure_native.network.v20201101.ApplicationGatewayPrivateEndpointConnection("applicationGatewayPrivateEndpointConnection", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20201101:ApplicationGatewayPrivateEndpointConnection testPlePeConnection /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/privateEndpointConnections/{connectionName} 
 * ```
 */
