 ...
 *
 * const virtualNetwork = new azure_native.network.v20201101.VirtualNetwork("virtualNetwork", {
 *     addressSpace: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20201101:VirtualNetwork test-vnet /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/test-vnet 
 * ```
 */
