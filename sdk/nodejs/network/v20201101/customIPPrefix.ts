 ...
 *
 * const customIPPrefix = new azure_native.network.v20201101.CustomIPPrefix("customIPPrefix", {
 *     cidr: "0.0.0.0/24",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20201101:CustomIPPrefix test-customipprefix /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/customIpPrefixes/test-customipprefix 
 * ```
 */
