 ...
 *
 * const networkInterface = new azure_native.network.v20201101.NetworkInterface("networkInterface", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20201101:NetworkInterface test-nic /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkInterfaces/test-nic 
 * ```
 */
