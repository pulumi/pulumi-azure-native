...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputs.network.v20201101.VirtualHubRouteV2Args>[]>;
    /**
