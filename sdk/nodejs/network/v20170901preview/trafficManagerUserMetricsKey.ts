 ...
 *
 * const trafficManagerUserMetricsKey = new azure_native.network.v20170901preview.TrafficManagerUserMetricsKey("trafficManagerUserMetricsKey", {});
 *
 * ```
 *
 * ## Import
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20170901preview:TrafficManagerUserMetricsKey default /providers/Microsoft.Network/trafficManagerUserMetricsKeys/default 
 * ```
 *
...
export class TrafficManagerUserMetricsKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20170901preview:TrafficManagerUserMetricsKey';
