...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190801.VirtualNetworkGatewayConnectionPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * Properties of the virtual network gateway connection.
     */
    readonly properties: pulumi.Input<inputs.network.v20190801.VirtualNetworkGatewayConnectionPropertiesFormat>;
    /**
