...
export function getConnectionMonitor(args: GetConnectionMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionMonitorResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190801:getConnectionMonitor", {
        "name": args.name,
...
export interface GetConnectionMonitorResult {
     ...
     */
    readonly properties: outputs.network.v20190801.ConnectionMonitorResultPropertiesResponse;
    /**
