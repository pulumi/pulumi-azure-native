...
export class ServiceEndpointPolicyDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190801:ServiceEndpointPolicyDefinition';
    ...
    constructor(name: string, argsOrState?: ServiceEndpointPolicyDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/preview:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20180701:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20180801:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20181001:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20181101:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20181201:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20190201:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20190401:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20190601:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20190701:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20190901:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20191101:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20191201:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20200301:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20200401:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20200501:ServiceEndpointPolicyDefinition" }, { type: "azurerm:network/v20200601:ServiceEndpointPolicyDefinition" }] };
