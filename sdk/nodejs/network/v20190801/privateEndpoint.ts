 ...
 *
 * @deprecated azure-native:network/v20190801:PrivateEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210201:PrivateEndpoint to guarantee forwards compatibility.
 */
export class PrivateEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpoint {
        pulumi.log.warn("PrivateEndpoint is deprecated: azure-native:network/v20190801:PrivateEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210201:PrivateEndpoint to guarantee forwards compatibility.")
