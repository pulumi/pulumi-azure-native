...
export function getExpressRouteGateway(args: GetExpressRouteGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190801:getExpressRouteGateway", {
        "name": args.name,
...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20190801.ExpressRouteGatewayPropertiesResponse;
    /**
     * Resource tags.
     */
