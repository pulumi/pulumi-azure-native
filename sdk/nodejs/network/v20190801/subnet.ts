 ...
 *
 * const subnet = new azure_native.network.v20190801.Subnet("subnet", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20190801:Subnet subnet1 /subscriptions/subid/resourceGroups/subnet-test/providers/Microsoft.Network/virtualNetworks/vnetname/subnets/subnet1 
 * ```
 */
