...
export class VirtualNetworkTap extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkTap {
        return new VirtualNetworkTap(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190801:VirtualNetworkTap';
    ...
    constructor(name: string, argsOrState?: VirtualNetworkTapArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as VirtualNetworkTapArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VirtualNetworkTap" }, { type: "azurerm:network/preview:VirtualNetworkTap" }, { type: "azurerm:network/v20180801:VirtualNetworkTap" }, { type: "azurerm:network/v20181001:VirtualNetworkTap" }, { type: "azurerm:network/v20181101:VirtualNetworkTap" }, { type: "azurerm:network/v20181201:VirtualNetworkTap" }, { type: "azurerm:network/v20190201:VirtualNetworkTap" }, { type: "azurerm:network/v20190401:VirtualNetworkTap" }, { type: "azurerm:network/v20190601:VirtualNetworkTap" }, { type: "azurerm:network/v20190701:VirtualNetworkTap" }, { type: "azurerm:network/v20190901:VirtualNetworkTap" }, { type: "azurerm:network/v20191101:VirtualNetworkTap" }, { type: "azurerm:network/v20191201:VirtualNetworkTap" }, { type: "azurerm:network/v20200301:VirtualNetworkTap" }, { type: "azurerm:network/v20200401:VirtualNetworkTap" }, { type: "azurerm:network/v20200501:VirtualNetworkTap" }, { type: "azurerm:network/v20200601:VirtualNetworkTap" }] };
