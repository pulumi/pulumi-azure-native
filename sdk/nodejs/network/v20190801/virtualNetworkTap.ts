...
export class VirtualNetworkTap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190801:VirtualNetworkTap';
     ...
     */
    public readonly destinationLoadBalancerFrontEndIPConfiguration!: pulumi.Output<outputs.network.v20190801.FrontendIPConfigurationResponse | undefined>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    public readonly destinationNetworkInterfaceIPConfiguration!: pulumi.Output<outputs.network.v20190801.NetworkInterfaceIPConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaceTapConfigurations!: pulumi.Output<outputs.network.v20190801.NetworkInterfaceTapConfigurationResponse[]>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkTapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20190801:VirtualNetworkTap" }, { type: "azure-native:network:VirtualNetworkTap" }, { type: "azure-nextgen:network:VirtualNetworkTap" }, { type: "azure-native:network/v20180801:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20180801:VirtualNetworkTap" }, { type: "azure-native:network/v20181001:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20181001:VirtualNetworkTap" }, { type: "azure-native:network/v20181101:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20181101:VirtualNetworkTap" }, { type: "azure-native:network/v20181201:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20181201:VirtualNetworkTap" }, { type: "azure-native:network/v20190201:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20190201:VirtualNetworkTap" }, { type: "azure-native:network/v20190401:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20190401:VirtualNetworkTap" }, { type: "azure-native:network/v20190601:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20190601:VirtualNetworkTap" }, { type: "azure-native:network/v20190701:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20190701:VirtualNetworkTap" }, { type: "azure-native:network/v20190901:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20190901:VirtualNetworkTap" }, { type: "azure-native:network/v20191101:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20191101:VirtualNetworkTap" }, { type: "azure-native:network/v20191201:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20191201:VirtualNetworkTap" }, { type: "azure-native:network/v20200301:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20200301:VirtualNetworkTap" }, { type: "azure-native:network/v20200401:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20200401:VirtualNetworkTap" }, { type: "azure-native:network/v20200501:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20200501:VirtualNetworkTap" }, { type: "azure-native:network/v20200601:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20200601:VirtualNetworkTap" }, { type: "azure-native:network/v20200701:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20200701:VirtualNetworkTap" }, { type: "azure-native:network/v20200801:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20200801:VirtualNetworkTap" }, { type: "azure-native:network/v20201101:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20201101:VirtualNetworkTap" }, { type: "azure-native:network/v20210201:VirtualNetworkTap" }, { type: "azure-nextgen:network/v20210201:VirtualNetworkTap" }] };
...
export interface VirtualNetworkTapArgs {
     ...
     * The reference to the private IP address on the internal Load Balancer that will receive the tap.
     */
    readonly destinationLoadBalancerFrontEndIPConfiguration?: pulumi.Input<inputs.network.v20190801.FrontendIPConfigurationArgs>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    readonly destinationNetworkInterfaceIPConfiguration?: pulumi.Input<inputs.network.v20190801.NetworkInterfaceIPConfigurationArgs>;
    /**
     * The VXLAN destination port that will receive the tapped traffic.
     */
