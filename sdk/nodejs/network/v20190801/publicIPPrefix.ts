...
export class PublicIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20190801:PublicIPPrefix';
    ...
    constructor(name: string, args: PublicIPPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:PublicIPPrefix" }, { type: "azure-nextgen:network/latest:PublicIPPrefix" }, { type: "azure-nextgen:network/v20180701:PublicIPPrefix" }, { type: "azure-nextgen:network/v20180801:PublicIPPrefix" }, { type: "azure-nextgen:network/v20181001:PublicIPPrefix" }, { type: "azure-nextgen:network/v20181101:PublicIPPrefix" }, { type: "azure-nextgen:network/v20181201:PublicIPPrefix" }, { type: "azure-nextgen:network/v20190201:PublicIPPrefix" }, { type: "azure-nextgen:network/v20190401:PublicIPPrefix" }, { type: "azure-nextgen:network/v20190601:PublicIPPrefix" }, { type: "azure-nextgen:network/v20190701:PublicIPPrefix" }, { type: "azure-nextgen:network/v20190901:PublicIPPrefix" }, { type: "azure-nextgen:network/v20191101:PublicIPPrefix" }, { type: "azure-nextgen:network/v20191201:PublicIPPrefix" }, { type: "azure-nextgen:network/v20200301:PublicIPPrefix" }, { type: "azure-nextgen:network/v20200401:PublicIPPrefix" }, { type: "azure-nextgen:network/v20200501:PublicIPPrefix" }, { type: "azure-nextgen:network/v20200601:PublicIPPrefix" }, { type: "azure-nextgen:network/v20200701:PublicIPPrefix" }, { type: "azure-nextgen:network/v20200801:PublicIPPrefix" }] };
...
export interface PublicIPPrefixArgs {
     ...
     * The list of tags associated with the public IP prefix.
     */
    readonly ipTags?: pulumi.Input<pulumi.Input<inputs.network.v20190801.IpTag>[]>;
    /**
     * Resource location.
     */
     ...
     * The list of all referenced PublicIPAddresses.
     */
    readonly publicIPAddresses?: pulumi.Input<pulumi.Input<inputs.network.v20190801.ReferencedPublicIpAddress>[]>;
    /**
     ...
     * The public IP prefix SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20190801.PublicIPPrefixSku>;
    /**
     * Resource tags.
     */
