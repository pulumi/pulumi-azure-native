...
export class PrivateLinkService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateLinkServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20190801:PrivateLinkService" }, { type: "azure-native:network:PrivateLinkService" }, { type: "azure-nextgen:network:PrivateLinkService" }, { type: "azure-native:network/v20190401:PrivateLinkService" }, { type: "azure-nextgen:network/v20190401:PrivateLinkService" }, { type: "azure-native:network/v20190601:PrivateLinkService" }, { type: "azure-nextgen:network/v20190601:PrivateLinkService" }, { type: "azure-native:network/v20190701:PrivateLinkService" }, { type: "azure-nextgen:network/v20190701:PrivateLinkService" }, { type: "azure-native:network/v20190901:PrivateLinkService" }, { type: "azure-nextgen:network/v20190901:PrivateLinkService" }, { type: "azure-native:network/v20191101:PrivateLinkService" }, { type: "azure-nextgen:network/v20191101:PrivateLinkService" }, { type: "azure-native:network/v20191201:PrivateLinkService" }, { type: "azure-nextgen:network/v20191201:PrivateLinkService" }, { type: "azure-native:network/v20200301:PrivateLinkService" }, { type: "azure-nextgen:network/v20200301:PrivateLinkService" }, { type: "azure-native:network/v20200401:PrivateLinkService" }, { type: "azure-nextgen:network/v20200401:PrivateLinkService" }, { type: "azure-native:network/v20200501:PrivateLinkService" }, { type: "azure-nextgen:network/v20200501:PrivateLinkService" }, { type: "azure-native:network/v20200601:PrivateLinkService" }, { type: "azure-nextgen:network/v20200601:PrivateLinkService" }, { type: "azure-native:network/v20200701:PrivateLinkService" }, { type: "azure-nextgen:network/v20200701:PrivateLinkService" }, { type: "azure-native:network/v20200801:PrivateLinkService" }, { type: "azure-nextgen:network/v20200801:PrivateLinkService" }, { type: "azure-native:network/v20201101:PrivateLinkService" }, { type: "azure-nextgen:network/v20201101:PrivateLinkService" }, { type: "azure-native:network/v20210201:PrivateLinkService" }, { type: "azure-nextgen:network/v20210201:PrivateLinkService" }] };
...
export interface PrivateLinkServiceArgs {
     ...
     * The auto-approval list of the private link service.
     */
    readonly autoApproval?: pulumi.Input<inputs.network.v20190801.PrivateLinkServicePropertiesAutoApprovalArgs>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * An array of private link service IP configurations.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190801.PrivateLinkServiceIpConfigurationArgs>[]>;
    /**
     * An array of references to the load balancer IP configurations.
     */
    readonly loadBalancerFrontendIpConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190801.FrontendIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * An array of list about connections to the private endpoint.
     */
    readonly privateEndpointConnections?: pulumi.Input<pulumi.Input<inputs.network.v20190801.PrivateEndpointConnectionArgs>[]>;
    /**
     ...
     * The visibility list of the private link service.
     */
    readonly visibility?: pulumi.Input<inputs.network.v20190801.PrivateLinkServicePropertiesVisibilityArgs>;
}
