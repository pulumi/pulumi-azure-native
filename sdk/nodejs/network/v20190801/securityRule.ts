...
export class SecurityRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190801.SecurityRulePropertiesFormatResponse>;
...
export interface SecurityRuleArgs {
     ...
     * Properties of the security rule.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190801.SecurityRulePropertiesFormat>;
    /**
