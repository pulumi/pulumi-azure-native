...
export function getServiceEndpointPolicy(args: GetServiceEndpointPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceEndpointPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190801:getServiceEndpointPolicy", {
        "expand": args.expand,
...
export interface GetServiceEndpointPolicyResult {
     ...
     */
    readonly serviceEndpointPolicyDefinitions?: outputs.network.v20190801.ServiceEndpointPolicyDefinitionInvokeResponse[];
    /**
