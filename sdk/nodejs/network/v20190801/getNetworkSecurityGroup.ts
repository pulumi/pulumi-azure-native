...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190801:getNetworkSecurityGroup", {
        "name": args.name,
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly properties: outputs.network.v20190801.NetworkSecurityGroupPropertiesFormatResponse;
    /**
     * Resource tags.
     */
