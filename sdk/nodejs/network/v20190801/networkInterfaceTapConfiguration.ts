...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190801.NetworkInterfaceTapConfigurationPropertiesFormatResponse>;
    /**
     * Sub Resource type.
     */
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * Properties of the Virtual Network Tap configuration.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190801.NetworkInterfaceTapConfigurationPropertiesFormat>;
    /**
