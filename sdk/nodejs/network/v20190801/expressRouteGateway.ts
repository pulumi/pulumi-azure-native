 ...
 *
 * const expressRouteGateway = new azurerm.network.v20190801.ExpressRouteGateway("expressRouteGateway", {
...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190801:ExpressRouteGateway';
