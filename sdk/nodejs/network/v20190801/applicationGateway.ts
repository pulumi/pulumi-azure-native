 ...
 *
 * const applicationGateway = new azure_native.network.v20190801.ApplicationGateway("applicationGateway", {
 ...
 *     ],
 *     identity: {
 *         type: azure_native.network.v20190801.ResourceIdentityType.UserAssigned,
