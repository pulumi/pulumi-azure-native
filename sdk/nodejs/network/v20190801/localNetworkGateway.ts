 ...
 *
 * const localNetworkGateway = new azurerm.network.v20190801.LocalNetworkGateway("localNetworkGateway", {
...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190801:LocalNetworkGateway';
