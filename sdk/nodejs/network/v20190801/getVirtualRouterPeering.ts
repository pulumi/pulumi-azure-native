...
export function getVirtualRouterPeering(args: GetVirtualRouterPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterPeeringResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190801:getVirtualRouterPeering", {
        "name": args.name,
...
export interface GetVirtualRouterPeeringResult {
     ...
     */
    readonly properties: outputs.network.v20190801.VirtualRouterPeeringPropertiesResponse;
    /**
     * Peering type.
     */
