...
export function getExpressRouteConnection(args: GetExpressRouteConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190801:getExpressRouteConnection", {
...
export interface GetExpressRouteConnectionResult {
     ...
     */
    readonly expressRouteCircuitPeering: outputs.network.v20190801.ExpressRouteCircuitPeeringIdInvokeResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
