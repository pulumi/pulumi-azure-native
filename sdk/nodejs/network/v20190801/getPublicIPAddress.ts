...
export function getPublicIPAddress(args: GetPublicIPAddressArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPAddressResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190801:getPublicIPAddress", {
        "name": args.name,
...
export interface GetPublicIPAddressResult {
     ...
     */
    readonly properties: outputs.network.v20190801.PublicIPAddressPropertiesFormatResponse;
    /**
