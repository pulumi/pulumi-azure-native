...
export function getVpnGateway(args: GetVpnGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190801:getVpnGateway", {
...
export interface GetVpnGatewayResult {
     ...
     */
    readonly connections?: outputs.network.v20190801.VpnConnectionInvokeResponse[];
    /**
     ...
     */
    readonly virtualHub?: outputs.network.v20190801.SubResourceInvokeResponse;
    /**
