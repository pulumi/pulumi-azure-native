...
export class ExpressRouteCircuitConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190801:ExpressRouteCircuitConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190801.ExpressRouteCircuitConnectionPropertiesFormatResponse>;
    /**
...
export interface ExpressRouteCircuitConnectionArgs {
     ...
     * Properties of the express route circuit connection.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190801.ExpressRouteCircuitConnectionPropertiesFormat>;
    /**
