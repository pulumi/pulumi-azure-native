...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190801:getVirtualNetworkGateway", {
        "name": args.name,
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20190801.VirtualNetworkGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
