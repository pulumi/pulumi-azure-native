 ...
 *
 * const vpnServerConfiguration = new azurerm.network.v20190801.VpnServerConfiguration("vpnServerConfiguration", {
 *     location: "West US",
...
export class VpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190801:VpnServerConfiguration';
