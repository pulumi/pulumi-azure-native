...
export class FrontDoor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:FrontDoor';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.FrontDoorPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface FrontDoorState {
     ...
     * Properties of the Front Door Load Balancer
     */
    readonly properties: pulumi.Input<inputs.network.FrontDoorPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface FrontDoorArgs {
     ...
     * Properties of the Front Door Load Balancer
     */
    readonly properties?: pulumi.Input<inputs.network.FrontDoorProperties>;
    /**
