...
export class SecurityConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network:SecurityConfiguration';
     ...
     */
    public readonly deleteExistingNSGs!: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, args: SecurityConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:SecurityConfiguration" }, { type: "azure-native:network/v20210201preview:SecurityConfiguration" }, { type: "azure-nextgen:network/v20210201preview:SecurityConfiguration" }] };
...
export interface SecurityConfigurationArgs {
     ...
     * Flag if need to delete existing network security groups.
     */
    readonly deleteExistingNSGs?: pulumi.Input<boolean>;
    /**
     * A description of the security Configuration.
     */
