...
export class SecurityConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SecurityConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:SecurityConfiguration" }, { type: "azure-nextgen:network/v20210201preview:SecurityConfiguration" }] };
