...
export class RecordSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:RecordSet';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.RecordSetPropertiesResponse>;
    /**
...
export interface RecordSetArgs {
     ...
     * The properties of the record set.
     */
    readonly properties?: pulumi.Input<inputs.network.RecordSetProperties>;
    /**
