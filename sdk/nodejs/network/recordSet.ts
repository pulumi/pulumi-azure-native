...
export class RecordSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RecordSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:RecordSet" }, { type: "azure-native:network/latest:RecordSet" }, { type: "azure-nextgen:network/latest:RecordSet" }, { type: "azure-native:network/v20180901:RecordSet" }, { type: "azure-nextgen:network/v20180901:RecordSet" }, { type: "azure-native:network/v20200101:RecordSet" }, { type: "azure-nextgen:network/v20200101:RecordSet" }, { type: "azure-native:network/v20200601:RecordSet" }, { type: "azure-nextgen:network/v20200601:RecordSet" }] };
...
export interface RecordSetArgs {
     ...
     * The list of A records in the record set.
     */
    readonly aRecords?: pulumi.Input<pulumi.Input<inputs.network.ARecord>[]>;
    /**
     * The list of AAAA records in the record set.
     */
     ...
     * The SOA record in the record set.
     */
    readonly soaRecord?: pulumi.Input<inputs.network.SoaRecord>;
    /**
     * The list of SRV records in the record set.
     */
