...
export class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PublicIPAddressState, opts?: pulumi.CustomResourceOptions): PublicIPAddress {
        return new PublicIPAddress(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:PublicIPAddress';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.PublicIPAddressPropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: PublicIPAddressArgs | PublicIPAddressState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PublicIPAddressState | undefined;
...
export interface PublicIPAddressState {
     ...
     * Public IP address properties.
     */
    readonly properties: pulumi.Input<inputs.network.PublicIPAddressPropertiesFormatResponse>;
    /**
     * The public IP address SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.PublicIPAddressSkuResponse>;
    /**
     * Resource tags.
     */
