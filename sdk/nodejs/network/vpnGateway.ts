...
export class VpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:VpnGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.VpnGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface VpnGatewayState {
     ...
     * Properties of the VPN gateway.
     */
    readonly properties: pulumi.Input<inputs.network.VpnGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface VpnGatewayArgs {
     ...
     * Properties of the VPN gateway.
     */
    readonly properties?: pulumi.Input<inputs.network.VpnGatewayProperties>;
    /**
