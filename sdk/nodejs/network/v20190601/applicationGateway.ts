 ...
 *
 * const applicationGateway = new azure_native.network.v20190601.ApplicationGateway("applicationGateway", {
 ...
 *     ],
 *     identity: {
 *         type: azure_native.network.v20190601.ResourceIdentityType.UserAssigned,
