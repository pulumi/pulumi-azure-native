...
export function getVirtualWan(args: GetVirtualWanArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualWanResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190601:getVirtualWan", {
...
export interface GetVirtualWanResult {
     ...
     */
    readonly p2SVpnServerConfigurations?: outputs.network.v20190601.P2SVpnServerConfigurationInvokeResponse[];
    /**
     ...
     */
    readonly virtualHubs: outputs.network.v20190601.SubResourceInvokeResponse[];
    /**
     * List of VpnSites in the VirtualWAN.
     */
    readonly vpnSites: outputs.network.v20190601.SubResourceInvokeResponse[];
}
