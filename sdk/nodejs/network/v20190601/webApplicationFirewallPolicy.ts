...
export class WebApplicationFirewallPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebApplicationFirewallPolicy {
        pulumi.log.warn("WebApplicationFirewallPolicy is deprecated: azure-native:network/v20190601:WebApplicationFirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190701:WebApplicationFirewallPolicy to guarantee forwards compatibility.")
