...
export class VirtualWan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualWan {
        pulumi.log.warn("VirtualWan is deprecated: azure-native:network/v20190601:VirtualWan is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190701:VirtualWan to guarantee forwards compatibility.")
