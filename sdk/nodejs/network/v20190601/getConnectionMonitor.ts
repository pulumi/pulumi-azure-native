...
export function getConnectionMonitor(args: GetConnectionMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionMonitorResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190601:getConnectionMonitor", {
...
export interface GetConnectionMonitorResult {
     ...
     */
    readonly destination: outputs.network.v20190601.ConnectionMonitorDestinationInvokeResponse;
    /**
     ...
     */
    readonly source: outputs.network.v20190601.ConnectionMonitorSourceInvokeResponse;
    /**
