...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190601:getPublicIPPrefix", {
        "expand": args.expand,
...
export interface GetPublicIPPrefixResult {
     ...
     */
    readonly ipTags?: outputs.network.v20190601.IpTagInvokeResponse[];
    /**
     * The reference to load balancer frontend IP configuration associated with the public IP prefix.
     */
    readonly loadBalancerFrontendIpConfiguration: outputs.network.v20190601.SubResourceInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPAddresses?: outputs.network.v20190601.ReferencedPublicIpAddressInvokeResponse[];
    /**
     ...
     */
    readonly sku?: outputs.network.v20190601.PublicIPPrefixSkuInvokeResponse;
    /**
     * Resource tags.
     */
