 ...
 *
 * const inboundNatRule = new azure_native.network.v20190601.InboundNatRule("inboundNatRule", {
 *     backendPort: 3389,
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20190601:InboundNatRule natRule1.1 /subscriptions/subid/resourceGroups/testrg/providers/Microsoft.Network/loadBalancers/lb1/inboundNatRules/natRule1.1 
 * ```
 */
