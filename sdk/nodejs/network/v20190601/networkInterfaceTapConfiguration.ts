...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20190601:NetworkInterfaceTapConfiguration';
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * The reference of the Virtual Network Tap resource.
     */
    readonly virtualNetworkTap?: pulumi.Input<inputs.network.v20190601.VirtualNetworkTap>;
}
