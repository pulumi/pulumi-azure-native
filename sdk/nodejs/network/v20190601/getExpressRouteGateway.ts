...
export function getExpressRouteGateway(args: GetExpressRouteGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190601:getExpressRouteGateway", {
        "name": args.name,
...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20190601.ExpressRouteGatewayPropertiesResponse;
    /**
     * Resource tags.
     */
