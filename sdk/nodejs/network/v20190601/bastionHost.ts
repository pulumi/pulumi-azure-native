 ...
 *
 * @deprecated azure-native:network/v20190601:BastionHost is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:BastionHost to guarantee forwards compatibility.
 */
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190601:BastionHost';
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20190601.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190601.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
