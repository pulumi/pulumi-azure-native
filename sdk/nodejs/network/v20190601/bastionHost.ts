...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20190601.BastionHostIPConfiguration>[]>;
    /**
     * Resource location.
     */
