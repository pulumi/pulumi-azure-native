...
export class VirtualNetworkTap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190601:VirtualNetworkTap';
