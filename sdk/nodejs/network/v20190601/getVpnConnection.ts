...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190601:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly remoteVpnSite?: outputs.network.v20190601.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: outputs.network.v20190601.VpnSiteLinkConnectionInvokeResponse[];
}
