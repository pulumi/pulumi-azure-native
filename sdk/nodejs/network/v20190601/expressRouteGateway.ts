...
export class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190601.ExpressRouteGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ExpressRouteGatewayArgs {
     ...
     * Properties of the express route gateway.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190601.ExpressRouteGatewayProperties>;
    /**
