...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20190601:RouteFilter';
...
export interface RouteFilterArgs {
     ...
     * A collection of references to express route circuit ipv6 peerings.
     */
    readonly ipv6Peerings?: pulumi.Input<pulumi.Input<inputs.network.v20190601.ExpressRouteCircuitPeering>[]>;
    /**
     * Resource location.
     */
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.v20190601.RouteFilterRule>[]>;
    /**
     * Resource tags.
     */
