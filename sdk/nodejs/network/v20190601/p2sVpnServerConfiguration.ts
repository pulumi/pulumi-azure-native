...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190601.P2SVpnServerConfigurationPropertiesResponse>;
...
export interface P2sVpnServerConfigurationArgs {
     ...
     * Properties of the P2SVpnServer configuration.
     */
    properties?: pulumi.Input<inputs.network.v20190601.P2SVpnServerConfigurationPropertiesArgs>;
    /**
