...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190601:P2sVpnServerConfiguration';
