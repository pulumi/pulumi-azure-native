...
export class Route extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190601:Route';
    ...
    constructor(name: string, args: RouteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Route" }, { type: "azurerm:network/preview:Route" }, { type: "azurerm:network/v20150501preview:Route" }, { type: "azurerm:network/v20150615:Route" }, { type: "azurerm:network/v20160330:Route" }, { type: "azurerm:network/v20160601:Route" }, { type: "azurerm:network/v20160901:Route" }, { type: "azurerm:network/v20161201:Route" }, { type: "azurerm:network/v20170301:Route" }, { type: "azurerm:network/v20170601:Route" }, { type: "azurerm:network/v20170801:Route" }, { type: "azurerm:network/v20170901:Route" }, { type: "azurerm:network/v20171001:Route" }, { type: "azurerm:network/v20171101:Route" }, { type: "azurerm:network/v20180101:Route" }, { type: "azurerm:network/v20180201:Route" }, { type: "azurerm:network/v20180401:Route" }, { type: "azurerm:network/v20180601:Route" }, { type: "azurerm:network/v20180701:Route" }, { type: "azurerm:network/v20180801:Route" }, { type: "azurerm:network/v20181001:Route" }, { type: "azurerm:network/v20181101:Route" }, { type: "azurerm:network/v20181201:Route" }, { type: "azurerm:network/v20190201:Route" }, { type: "azurerm:network/v20190401:Route" }, { type: "azurerm:network/v20190701:Route" }, { type: "azurerm:network/v20190801:Route" }, { type: "azurerm:network/v20190901:Route" }, { type: "azurerm:network/v20191101:Route" }, { type: "azurerm:network/v20191201:Route" }, { type: "azurerm:network/v20200301:Route" }, { type: "azurerm:network/v20200401:Route" }, { type: "azurerm:network/v20200501:Route" }, { type: "azurerm:network/v20200601:Route" }] };
