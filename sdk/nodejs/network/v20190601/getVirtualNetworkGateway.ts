...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190601:getVirtualNetworkGateway", {
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly bgpSettings?: outputs.network.v20190601.BgpSettingsInvokeResponse;
    /**
     ...
     */
    readonly customRoutes?: outputs.network.v20190601.AddressSpaceInvokeResponse;
    /**
     ...
     */
    readonly gatewayDefaultSite?: outputs.network.v20190601.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly ipConfigurations?: outputs.network.v20190601.VirtualNetworkGatewayIPConfigurationInvokeResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.v20190601.VirtualNetworkGatewaySkuInvokeResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly vpnClientConfiguration?: outputs.network.v20190601.VpnClientConfigurationInvokeResponse;
    /**
     * The type of this virtual network gateway.
     */
