...
export class VpnSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:VpnSite';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.VpnSitePropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface VpnSiteState {
     ...
     * Properties of the VPN site.
     */
    readonly properties: pulumi.Input<inputs.network.VpnSitePropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface VpnSiteArgs {
     ...
     * Properties of the VPN site.
     */
    readonly properties?: pulumi.Input<inputs.network.VpnSiteProperties>;
    /**
