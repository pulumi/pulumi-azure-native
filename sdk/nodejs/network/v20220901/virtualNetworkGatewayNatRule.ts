 ...
 *
 * @deprecated azure-native:network/v20220901:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.
 */
export class VirtualNetworkGatewayNatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:VirtualNetworkGatewayNatRule';
     ...
     */
    public readonly externalMappings!: pulumi.Output<outputs.network.v20220901.VpnNatRuleMappingResponse[] | undefined>;
    /**
     * The private IP address internal mapping for NAT.
     */
    public readonly internalMappings!: pulumi.Output<outputs.network.v20220901.VpnNatRuleMappingResponse[] | undefined>;
    /**
...
export interface VirtualNetworkGatewayNatRuleArgs {
     ...
     * The private IP address external mapping for NAT.
     */
    externalMappings?: pulumi.Input<pulumi.Input<inputs.network.v20220901.VpnNatRuleMappingArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * The private IP address internal mapping for NAT.
     */
    internalMappings?: pulumi.Input<pulumi.Input<inputs.network.v20220901.VpnNatRuleMappingArgs>[]>;
    /**
     * The IP Configuration ID this NAT rule applies to.
     */
     ...
     * The Source NAT direction of a VPN NAT.
     */
    mode?: pulumi.Input<string | enums.network.v20220901.VpnNatRuleMode>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     */
    type?: pulumi.Input<string | enums.network.v20220901.VpnNatRuleType>;
    /**
