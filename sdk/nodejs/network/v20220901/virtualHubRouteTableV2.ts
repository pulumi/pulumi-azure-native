...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:VirtualHubRouteTableV2';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.v20220901.VirtualHubRouteV2Response[] | undefined>;
    ...
    constructor(name: string, args: VirtualHubRouteTableV2Args, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20190901:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20191101:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20200401:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20200501:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20200601:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20201101:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20210201:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20210301:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20210801:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20220101:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20220501:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20220701:VirtualHubRouteTableV2" }, { type: "azure-native:network/v20221101:VirtualHubRouteTableV2" }] };
...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20220901.VirtualHubRouteV2Args>[]>;
    /**
