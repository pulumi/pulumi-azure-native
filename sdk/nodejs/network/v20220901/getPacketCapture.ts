...
export function getPacketCapture(args: GetPacketCaptureArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCaptureResult> {
    pulumi.log.warn("getPacketCapture is deprecated: azure-native:network/v20220901:PacketCapture is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PacketCapture to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220901:getPacketCapture", {
...
export interface GetPacketCaptureResult {
     ...
     */
    readonly filters?: outputs.network.v20220901.PacketCaptureFilterResponse[];
    /**
     ...
     */
    readonly scope?: outputs.network.v20220901.PacketCaptureMachineScopeResponse;
    /**
     * The storage location for a packet capture session.
     */
    readonly storageLocation: outputs.network.v20220901.PacketCaptureStorageLocationResponse;
    /**
