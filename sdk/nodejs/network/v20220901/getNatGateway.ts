...
export interface GetNatGatewayResult {
     ...
     */
    readonly publicIpPrefixes?: outputs.network.v20220901.SubResourceResponse[];
    /**
     ...
     * The nat gateway SKU.
     */
    readonly sku?: outputs.network.v20220901.NatGatewaySkuResponse;
    /**
     * An array of references to the subnets using this nat gateway resource.
     */
    readonly subnets: outputs.network.v20220901.SubResourceResponse[];
    /**
     * Resource tags.
     */
...
export function getNatGatewayOutput(args: GetNatGatewayOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNatGatewayResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20220901:getNatGateway", {
        "expand": args.expand,
        "natGatewayName": args.natGatewayName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
