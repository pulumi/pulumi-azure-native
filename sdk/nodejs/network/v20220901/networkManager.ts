...
export class NetworkManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:NetworkManager';
     ...
     */
    public readonly networkManagerScopes!: pulumi.Output<outputs.network.v20220901.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.network.v20220901.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: NetworkManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkManager" }, { type: "azure-native:network/v20210201preview:NetworkManager" }, { type: "azure-native:network/v20210501preview:NetworkManager" }, { type: "azure-native:network/v20220101:NetworkManager" }, { type: "azure-native:network/v20220201preview:NetworkManager" }, { type: "azure-native:network/v20220401preview:NetworkManager" }, { type: "azure-native:network/v20220501:NetworkManager" }, { type: "azure-native:network/v20220701:NetworkManager" }, { type: "azure-native:network/v20221101:NetworkManager" }, { type: "azure-native:network/v20230201:NetworkManager" }, { type: "azure-native:network/v20230401:NetworkManager" }, { type: "azure-native:network/v20230501:NetworkManager" }, { type: "azure-native:network/v20230601:NetworkManager" }, { type: "azure-native:network/v20230901:NetworkManager" }, { type: "azure-native:network/v20231101:NetworkManager" }, { type: "azure-native:network/v20240101:NetworkManager" }, { type: "azure-native:network/v20240101preview:NetworkManager" }, { type: "azure-native:network/v20240301:NetworkManager" }, { type: "azure-native:network/v20240501:NetworkManager" }] };
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | enums.network.v20220901.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<inputs.network.v20220901.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**
