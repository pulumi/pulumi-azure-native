...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:VirtualNetworkPeering';
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.network.v20220901.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    public readonly remoteBgpCommunities!: pulumi.Output<outputs.network.v20220901.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     ...
     */
    public readonly remoteVirtualNetworkAddressSpace!: pulumi.Output<outputs.network.v20220901.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's encryption
     */
    public /*out*/ readonly remoteVirtualNetworkEncryption!: pulumi.Output<outputs.network.v20220901.VirtualNetworkEncryptionResponse>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering.
     */
    peeringState?: pulumi.Input<string | enums.network.v20220901.VirtualNetworkPeeringState>;
    /**
     * The peering sync status of the virtual network peering.
     */
    peeringSyncLevel?: pulumi.Input<string | enums.network.v20220901.VirtualNetworkPeeringLevel>;
    /**
     * The reference to the address space peered with the remote virtual network.
     */
    remoteAddressSpace?: pulumi.Input<inputs.network.v20220901.AddressSpaceArgs>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    remoteBgpCommunities?: pulumi.Input<inputs.network.v20220901.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
     ...
     * The reference to the current address space of the remote virtual network.
     */
    remoteVirtualNetworkAddressSpace?: pulumi.Input<inputs.network.v20220901.AddressSpaceArgs>;
    /**
