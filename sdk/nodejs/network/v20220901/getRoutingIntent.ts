...
export function getRoutingIntent(args: GetRoutingIntentArgs, opts?: pulumi.InvokeOptions): Promise<GetRoutingIntentResult> {
    pulumi.log.warn("getRoutingIntent is deprecated: azure-native:network/v20220901:RoutingIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RoutingIntent to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220901:getRoutingIntent", {
...
export interface GetRoutingIntentResult {
     ...
     */
    readonly routingPolicies?: outputs.network.v20220901.RoutingPolicyResponse[];
    /**
     * Resource type.
     */
