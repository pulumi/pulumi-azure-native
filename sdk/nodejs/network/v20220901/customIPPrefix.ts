...
export class CustomIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:CustomIPPrefix';
     ...
     */
    public /*out*/ readonly childCustomIpPrefixes!: pulumi.Output<outputs.network.v20220901.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly customIpPrefixParent!: pulumi.Output<outputs.network.v20220901.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly publicIpPrefixes!: pulumi.Output<outputs.network.v20220901.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: CustomIPPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:CustomIPPrefix" }, { type: "azure-native:network/v20200601:CustomIPPrefix" }, { type: "azure-native:network/v20200701:CustomIPPrefix" }, { type: "azure-native:network/v20200801:CustomIPPrefix" }, { type: "azure-native:network/v20201101:CustomIPPrefix" }, { type: "azure-native:network/v20210201:CustomIPPrefix" }, { type: "azure-native:network/v20210301:CustomIPPrefix" }, { type: "azure-native:network/v20210501:CustomIPPrefix" }, { type: "azure-native:network/v20210801:CustomIPPrefix" }, { type: "azure-native:network/v20220101:CustomIPPrefix" }, { type: "azure-native:network/v20220501:CustomIPPrefix" }, { type: "azure-native:network/v20220701:CustomIPPrefix" }, { type: "azure-native:network/v20221101:CustomIPPrefix" }, { type: "azure-native:network/v20230201:CustomIPPrefix" }, { type: "azure-native:network/v20230401:CustomIPPrefix" }, { type: "azure-native:network/v20230501:CustomIPPrefix" }, { type: "azure-native:network/v20230601:CustomIPPrefix" }, { type: "azure-native:network/v20230901:CustomIPPrefix" }, { type: "azure-native:network/v20231101:CustomIPPrefix" }, { type: "azure-native:network/v20240101:CustomIPPrefix" }, { type: "azure-native:network/v20240301:CustomIPPrefix" }, { type: "azure-native:network/v20240501:CustomIPPrefix" }] };
...
export interface CustomIPPrefixArgs {
     ...
     * The commissioned state of the Custom IP Prefix.
     */
    commissionedState?: pulumi.Input<string | enums.network.v20220901.CommissionedState>;
    /**
     ...
     * The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
     */
    customIpPrefixParent?: pulumi.Input<inputs.network.v20220901.SubResourceArgs>;
    /**
     * Whether to do express route advertise.
     */
     ...
     * The Geo for CIDR advertising. Should be an Geo code.
     */
    geo?: pulumi.Input<string | enums.network.v20220901.Geo>;
    /**
     * Resource ID.
     */
     ...
     * Type of custom IP prefix. Should be Singular, Parent, or Child.
     */
    prefixType?: pulumi.Input<string | enums.network.v20220901.CustomIpPrefixType>;
    /**
