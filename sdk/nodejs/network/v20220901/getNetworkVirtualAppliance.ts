...
export function getNetworkVirtualAppliance(args: GetNetworkVirtualApplianceArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkVirtualApplianceResult> {
    pulumi.log.warn("getNetworkVirtualAppliance is deprecated: azure-native:network/v20220901:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkVirtualAppliance to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220901:getNetworkVirtualAppliance", {
        "expand": args.expand,
...
export interface GetNetworkVirtualApplianceResult {
     ...
     */
    readonly delegation?: outputs.network.v20220901.DelegationPropertiesResponse;
    /**
     ...
     */
    readonly inboundSecurityRules: outputs.network.v20220901.SubResourceResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly nvaSku?: outputs.network.v20220901.VirtualApplianceSkuPropertiesResponse;
    /**
     * The delegation for the Virtual Appliance
     */
    readonly partnerManagedResource?: outputs.network.v20220901.PartnerManagedResourcePropertiesResponse;
    /**
     ...
     */
    readonly virtualApplianceNics: outputs.network.v20220901.VirtualApplianceNicPropertiesResponse[];
    /**
     * List of references to VirtualApplianceSite.
     */
    readonly virtualApplianceSites: outputs.network.v20220901.SubResourceResponse[];
    /**
