...
export class ExpressRoutePort extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:ExpressRoutePort';
     ...
     */
    public /*out*/ readonly circuits!: pulumi.Output<outputs.network.v20220901.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly links!: pulumi.Output<outputs.network.v20220901.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface ExpressRoutePortArgs {
     ...
     * The billing type of the ExpressRoutePort resource.
     */
    billingType?: pulumi.Input<string | enums.network.v20220901.ExpressRoutePortsBillingType>;
    /**
     * Encapsulation method on physical ports.
     */
    encapsulation?: pulumi.Input<string | enums.network.v20220901.ExpressRoutePortsEncapsulation>;
    /**
     ...
     * The set of physical links of the ExpressRoutePort resource.
     */
    links?: pulumi.Input<pulumi.Input<inputs.network.v20220901.ExpressRouteLinkArgs>[]>;
    /**
     * Resource location.
     */
