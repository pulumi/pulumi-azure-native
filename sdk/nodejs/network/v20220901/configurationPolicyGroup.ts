 ...
 *
 * const configurationPolicyGroup = new azure_native.network.v20220901.ConfigurationPolicyGroup("configurationPolicyGroup", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20220901:ConfigurationPolicyGroup policyGroup1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/vpnServerConfigurations/vpnServerConfiguration1/vpnServerConfigurationPolicyGroups/policyGroup1 
 * ```
 */
export class ConfigurationPolicyGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:ConfigurationPolicyGroup';
     ...
     */
    public /*out*/ readonly p2SConnectionConfigurations!: pulumi.Output<outputs.network.v20220901.SubResourceResponse[]>;
    /**
     * Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
     */
    public readonly policyMembers!: pulumi.Output<outputs.network.v20220901.VpnServerConfigurationPolicyGroupMemberResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConfigurationPolicyGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ConfigurationPolicyGroup" }, { type: "azure-native:network/v20210801:ConfigurationPolicyGroup" }, { type: "azure-native:network/v20220101:ConfigurationPolicyGroup" }, { type: "azure-native:network/v20220501:ConfigurationPolicyGroup" }, { type: "azure-native:network/v20220701:ConfigurationPolicyGroup" }] };
...
export interface ConfigurationPolicyGroupArgs {
     ...
     * Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
     */
    policyMembers?: pulumi.Input<pulumi.Input<inputs.network.v20220901.VpnServerConfigurationPolicyGroupMemberArgs>[]>;
    /**
     * Priority for VpnServerConfigurationPolicyGroup.
     */
