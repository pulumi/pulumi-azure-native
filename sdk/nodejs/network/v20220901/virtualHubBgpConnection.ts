...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:VirtualHubBgpConnection';
     ...
     */
    public readonly hubVirtualNetworkConnection!: pulumi.Output<outputs.network.v20220901.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<inputs.network.v20220901.SubResourceArgs>;
    /**
     * Resource ID.
     */
