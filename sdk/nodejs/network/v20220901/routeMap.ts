...
export class RouteMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:RouteMap';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20220901.RouteMapRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: RouteMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:RouteMap" }, { type: "azure-native:network/v20220501:RouteMap" }, { type: "azure-native:network/v20220701:RouteMap" }, { type: "azure-native:network/v20221101:RouteMap" }, { type: "azure-native:network/v20230201:RouteMap" }, { type: "azure-native:network/v20230401:RouteMap" }, { type: "azure-native:network/v20230501:RouteMap" }, { type: "azure-native:network/v20230601:RouteMap" }, { type: "azure-native:network/v20230901:RouteMap" }, { type: "azure-native:network/v20231101:RouteMap" }, { type: "azure-native:network/v20240101:RouteMap" }, { type: "azure-native:network/v20240301:RouteMap" }, { type: "azure-native:network/v20240501:RouteMap" }] };
...
export interface RouteMapArgs {
     ...
     * List of RouteMap rules to be applied.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20220901.RouteMapRuleArgs>[]>;
    /**
