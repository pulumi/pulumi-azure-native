...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:VirtualNetworkGatewayConnection';
     ...
     */
    public readonly egressNatRules!: pulumi.Output<outputs.network.v20220901.SubResourceResponse[] | undefined>;
    /**
     * EnableBgp flag.
     */
     ...
     */
    public readonly gatewayCustomBgpIpAddresses!: pulumi.Output<outputs.network.v20220901.GatewayCustomBgpIpAddressIpConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public readonly ingressNatRules!: pulumi.Output<outputs.network.v20220901.SubResourceResponse[] | undefined>;
    /**
     * The IPSec Policies to be considered by this connection.
     */
    public readonly ipsecPolicies!: pulumi.Output<outputs.network.v20220901.IpsecPolicyResponse[] | undefined>;
    /**
     * The reference to local network gateway resource.
     */
    public readonly localNetworkGateway2!: pulumi.Output<outputs.network.v20220901.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly peer!: pulumi.Output<outputs.network.v20220901.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly trafficSelectorPolicies!: pulumi.Output<outputs.network.v20220901.TrafficSelectorPolicyResponse[] | undefined>;
    /**
     * Collection of all tunnels' connection health status.
     */
    public /*out*/ readonly tunnelConnectionStatus!: pulumi.Output<outputs.network.v20220901.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    public readonly virtualNetworkGateway1!: pulumi.Output<outputs.network.v20220901.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    public readonly virtualNetworkGateway2!: pulumi.Output<outputs.network.v20220901.VirtualNetworkGatewayResponse | undefined>;
    ...
    constructor(name: string, args: VirtualNetworkGatewayConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20180601:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20180701:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20180801:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20181201:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20190201:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20190601:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20190701:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20190801:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20190901:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20191101:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20200401:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20200501:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20200601:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20201101:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20210201:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20210301:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20210801:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20220101:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20220501:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20220701:VirtualNetworkGatewayConnection" }, { type: "azure-native:network/v20221101:VirtualNetworkGatewayConnection" }] };
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * The connection mode for this connection.
     */
    connectionMode?: pulumi.Input<string | enums.network.v20220901.VirtualNetworkGatewayConnectionMode>;
    /**
     * Connection protocol used for this connection.
     */
    connectionProtocol?: pulumi.Input<string | enums.network.v20220901.VirtualNetworkGatewayConnectionProtocol>;
    /**
     * Gateway connection type.
     */
    connectionType: pulumi.Input<string | enums.network.v20220901.VirtualNetworkGatewayConnectionType>;
    /**
     * The dead peer detection timeout of this connection in seconds.
     */
     ...
     * List of egress NatRules.
     */
    egressNatRules?: pulumi.Input<pulumi.Input<inputs.network.v20220901.SubResourceArgs>[]>;
    /**
     * EnableBgp flag.
     */
     ...
     * GatewayCustomBgpIpAddresses to be used for virtual network gateway Connection.
     */
    gatewayCustomBgpIpAddresses?: pulumi.Input<pulumi.Input<inputs.network.v20220901.GatewayCustomBgpIpAddressIpConfigurationArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * List of ingress NatRules.
     */
    ingressNatRules?: pulumi.Input<pulumi.Input<inputs.network.v20220901.SubResourceArgs>[]>;
    /**
     * The IPSec Policies to be considered by this connection.
     */
    ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20220901.IpsecPolicyArgs>[]>;
    /**
     * The reference to local network gateway resource.
     */
    localNetworkGateway2?: pulumi.Input<inputs.network.v20220901.LocalNetworkGatewayArgs>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    peer?: pulumi.Input<inputs.network.v20220901.SubResourceArgs>;
    /**
     ...
     * The Traffic Selector Policies to be considered by this connection.
     */
    trafficSelectorPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20220901.TrafficSelectorPolicyArgs>[]>;
    /**
     * Use private local Azure IP for the connection.
     */
     ...
     * The reference to virtual network gateway resource.
     */
    virtualNetworkGateway1: pulumi.Input<inputs.network.v20220901.VirtualNetworkGatewayArgs>;
    /**
     * The reference to virtual network gateway resource.
     */
    virtualNetworkGateway2?: pulumi.Input<inputs.network.v20220901.VirtualNetworkGatewayArgs>;
    /**
