...
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup';
     ...
     */
    public readonly ruleCollections!: pulumi.Output<(outputs.network.v20220901.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20220901.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
    ...
    constructor(name: string, args: FirewallPolicyRuleCollectionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20200501:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20200601:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20201101:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20210201:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20210301:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20210801:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20220101:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20220501:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20220701:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20221101:FirewallPolicyRuleCollectionGroup" }] };
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20220901.FirewallPolicyFilterRuleCollectionArgs | inputs.network.v20220901.FirewallPolicyNatRuleCollectionArgs>[]>;
}
