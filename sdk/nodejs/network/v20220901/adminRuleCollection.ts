...
export class AdminRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:AdminRuleCollection';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20220901.NetworkManagerSecurityGroupItemResponse[]>;
    /**
...
export interface AdminRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20220901.NetworkManagerSecurityGroupItemArgs>[]>;
    /**
