...
export function getNetworkGroup(args: GetNetworkGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkGroupResult> {
    pulumi.log.warn("getNetworkGroup is deprecated: azure-native:network/v20220901:NetworkGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220901:getNetworkGroup", {
...
export interface GetNetworkGroupResult {
     ...
     */
    readonly systemData: outputs.network.v20220901.SystemDataResponse;
    /**
     * Resource type.
     */
