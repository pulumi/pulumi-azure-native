...
export class VirtualHubIpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:VirtualHubIpConfiguration';
     ...
     */
    public readonly publicIPAddress!: pulumi.Output<outputs.network.v20220901.PublicIPAddressResponse | undefined>;
    /**
     * The reference to the subnet resource.
     */
    public readonly subnet!: pulumi.Output<outputs.network.v20220901.SubnetResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualHubIpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["subnet"] = args ? (args.subnet ? pulumi.output(args.subnet).apply(inputs.network.v20220901.subnetArgsProvideDefaults) : undefined) : undefined;
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    privateIPAllocationMethod?: pulumi.Input<string | enums.network.v20220901.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    publicIPAddress?: pulumi.Input<inputs.network.v20220901.PublicIPAddressArgs>;
    /**
     ...
     * The reference to the subnet resource.
     */
    subnet?: pulumi.Input<inputs.network.v20220901.SubnetArgs>;
    /**
