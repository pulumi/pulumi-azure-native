 ...
 *
 * const virtualNetwork = new azure_native.network.v20220901.VirtualNetwork("virtualNetwork", {
 *     addressSpace: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20220901:VirtualNetwork test-vnet /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/test-vnet 
 * ```
 */
