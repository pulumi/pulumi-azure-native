...
export class VirtualNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:VirtualNetworkGateway';
     ...
     */
    public readonly bgpSettings!: pulumi.Output<outputs.network.v20220901.BgpSettingsResponse | undefined>;
    /**
     * The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
     */
    public readonly customRoutes!: pulumi.Output<outputs.network.v20220901.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.network.v20220901.ExtendedLocationResponse | undefined>;
    /**
     * The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    public readonly gatewayDefaultSite!: pulumi.Output<outputs.network.v20220901.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20220901.VirtualNetworkGatewayIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly natRules!: pulumi.Output<outputs.network.v20220901.VirtualNetworkGatewayNatRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20220901.VirtualNetworkGatewaySkuResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetworkGatewayPolicyGroups!: pulumi.Output<outputs.network.v20220901.VirtualNetworkGatewayPolicyGroupResponse[] | undefined>;
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    public readonly vpnClientConfiguration!: pulumi.Output<outputs.network.v20220901.VpnClientConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VirtualNetworkGateway" }, { type: "azure-native:network/v20180601:VirtualNetworkGateway" }, { type: "azure-native:network/v20180701:VirtualNetworkGateway" }, { type: "azure-native:network/v20180801:VirtualNetworkGateway" }, { type: "azure-native:network/v20181201:VirtualNetworkGateway" }, { type: "azure-native:network/v20190201:VirtualNetworkGateway" }, { type: "azure-native:network/v20190601:VirtualNetworkGateway" }, { type: "azure-native:network/v20190701:VirtualNetworkGateway" }, { type: "azure-native:network/v20190801:VirtualNetworkGateway" }, { type: "azure-native:network/v20190901:VirtualNetworkGateway" }, { type: "azure-native:network/v20191101:VirtualNetworkGateway" }, { type: "azure-native:network/v20200401:VirtualNetworkGateway" }, { type: "azure-native:network/v20200501:VirtualNetworkGateway" }, { type: "azure-native:network/v20200601:VirtualNetworkGateway" }, { type: "azure-native:network/v20201101:VirtualNetworkGateway" }, { type: "azure-native:network/v20210201:VirtualNetworkGateway" }, { type: "azure-native:network/v20210301:VirtualNetworkGateway" }, { type: "azure-native:network/v20210801:VirtualNetworkGateway" }, { type: "azure-native:network/v20220101:VirtualNetworkGateway" }, { type: "azure-native:network/v20220501:VirtualNetworkGateway" }, { type: "azure-native:network/v20220701:VirtualNetworkGateway" }, { type: "azure-native:network/v20221101:VirtualNetworkGateway" }] };
...
export interface VirtualNetworkGatewayArgs {
     ...
     * Virtual network gateway's BGP speaker settings.
     */
    bgpSettings?: pulumi.Input<inputs.network.v20220901.BgpSettingsArgs>;
    /**
     * The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
     */
    customRoutes?: pulumi.Input<inputs.network.v20220901.AddressSpaceArgs>;
    /**
     * disableIPSecReplayProtection flag.
     */
     ...
     * The extended location of type local virtual network gateway.
     */
    extendedLocation?: pulumi.Input<inputs.network.v20220901.ExtendedLocationArgs>;
    /**
     * The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    gatewayDefaultSite?: pulumi.Input<inputs.network.v20220901.SubResourceArgs>;
    /**
     * The type of this virtual network gateway.
     */
    gatewayType?: pulumi.Input<string | enums.network.v20220901.VirtualNetworkGatewayType>;
    /**
     * Resource ID.
     */
     ...
     * IP configurations for virtual network gateway.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20220901.VirtualNetworkGatewayIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * NatRules for virtual network gateway.
     */
    natRules?: pulumi.Input<pulumi.Input<inputs.network.v20220901.VirtualNetworkGatewayNatRuleArgs>[]>;
    /**
     ...
     * The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
     */
    sku?: pulumi.Input<inputs.network.v20220901.VirtualNetworkGatewaySkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * The reference to the VirtualNetworkGatewayPolicyGroup resource which represents the available VirtualNetworkGatewayPolicyGroup for the gateway.
     */
    virtualNetworkGatewayPolicyGroups?: pulumi.Input<pulumi.Input<inputs.network.v20220901.VirtualNetworkGatewayPolicyGroupArgs>[]>;
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    vpnClientConfiguration?: pulumi.Input<inputs.network.v20220901.VpnClientConfigurationArgs>;
    /**
     * The generation for this VirtualNetworkGateway. Must be None if gatewayType is not VPN.
     */
    vpnGatewayGeneration?: pulumi.Input<string | enums.network.v20220901.VpnGatewayGeneration>;
    /**
     * The type of this virtual network gateway.
     */
    vpnType?: pulumi.Input<string | enums.network.v20220901.VpnType>;
}
