 ...
 *
 * const applicationGateway = new azure_native.network.v20220901.ApplicationGateway("applicationGateway", {
 ...
 *     ],
 *     identity: {
 *         type: azure_native.network.v20220901.ResourceIdentityType.UserAssigned,
