 ...
 *
 * @deprecated azure-native:network/v20220901:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.
 */
export class ExpressRouteCrossConnectionPeering extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCrossConnectionPeering {
        pulumi.log.warn("ExpressRouteCrossConnectionPeering is deprecated: azure-native:network/v20220901:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.")
        return new ExpressRouteCrossConnectionPeering(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:ExpressRouteCrossConnectionPeering';
     ...
     */
    public readonly ipv6PeeringConfig!: pulumi.Output<outputs.network.v20220901.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    public readonly microsoftPeeringConfig!: pulumi.Output<outputs.network.v20220901.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
...
export interface ExpressRouteCrossConnectionPeeringArgs {
     ...
     * The IPv6 peering configuration.
     */
    ipv6PeeringConfig?: pulumi.Input<inputs.network.v20220901.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The Microsoft peering configuration.
     */
    microsoftPeeringConfig?: pulumi.Input<inputs.network.v20220901.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    peeringType?: pulumi.Input<string | enums.network.v20220901.ExpressRoutePeeringType>;
    /**
     * The primary address prefix.
     */
     ...
     * The peering state.
     */
    state?: pulumi.Input<string | enums.network.v20220901.ExpressRoutePeeringState>;
    /**
     * The VLAN ID.
     */
