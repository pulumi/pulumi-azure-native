 ...
 *
 * const natRule = new azure_native.network.v20220901.NatRule("natRule", {
 *     externalMappings: [{
...
export class NatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220901:NatRule';
     ...
     */
    public /*out*/ readonly egressVpnSiteLinkConnections!: pulumi.Output<outputs.network.v20220901.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly ingressVpnSiteLinkConnections!: pulumi.Output<outputs.network.v20220901.SubResourceResponse[]>;
    /**
