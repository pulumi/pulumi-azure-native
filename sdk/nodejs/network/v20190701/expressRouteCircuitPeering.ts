 ...
 *
 * @deprecated azure-native:network/v20190701:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:ExpressRouteCircuitPeering to guarantee forwards compatibility.
 */
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuitPeering {
        pulumi.log.warn("ExpressRouteCircuitPeering is deprecated: azure-native:network/v20190701:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:ExpressRouteCircuitPeering to guarantee forwards compatibility.")
