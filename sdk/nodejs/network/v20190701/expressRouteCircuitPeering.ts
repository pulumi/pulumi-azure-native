...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20190701:ExpressRouteCircuitPeering';
