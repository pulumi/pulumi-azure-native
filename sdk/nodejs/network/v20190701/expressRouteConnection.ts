...
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190701:ExpressRouteConnection';
    ...
    constructor(name: string, argsOrState?: ExpressRouteConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20180801:ExpressRouteConnection" }, { type: "azurerm:network/v20181001:ExpressRouteConnection" }, { type: "azurerm:network/v20181101:ExpressRouteConnection" }, { type: "azurerm:network/v20181201:ExpressRouteConnection" }, { type: "azurerm:network/v20190201:ExpressRouteConnection" }, { type: "azurerm:network/v20190401:ExpressRouteConnection" }, { type: "azurerm:network/v20190601:ExpressRouteConnection" }, { type: "azurerm:network/v20190801:ExpressRouteConnection" }, { type: "azurerm:network/v20190901:ExpressRouteConnection" }, { type: "azurerm:network/v20191101:ExpressRouteConnection" }, { type: "azurerm:network/v20191201:ExpressRouteConnection" }, { type: "azurerm:network/v20200301:ExpressRouteConnection" }, { type: "azurerm:network/v20200401:ExpressRouteConnection" }, { type: "azurerm:network/v20200501:ExpressRouteConnection" }] };
