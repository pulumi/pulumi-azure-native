...
export class PrivateEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:PrivateEndpoint" }, { type: "azurerm:network/v20190401:PrivateEndpoint" }, { type: "azurerm:network/v20190601:PrivateEndpoint" }, { type: "azurerm:network/v20190801:PrivateEndpoint" }, { type: "azurerm:network/v20190901:PrivateEndpoint" }, { type: "azurerm:network/v20191101:PrivateEndpoint" }, { type: "azurerm:network/v20191201:PrivateEndpoint" }, { type: "azurerm:network/v20200301:PrivateEndpoint" }, { type: "azurerm:network/v20200401:PrivateEndpoint" }, { type: "azurerm:network/v20200501:PrivateEndpoint" }, { type: "azurerm:network/v20200601:PrivateEndpoint" }] };
