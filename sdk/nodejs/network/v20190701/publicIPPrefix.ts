...
export class PublicIPPrefix extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PublicIPPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20180701:PublicIPPrefix" }, { type: "azurerm:network/v20180801:PublicIPPrefix" }, { type: "azurerm:network/v20181001:PublicIPPrefix" }, { type: "azurerm:network/v20181101:PublicIPPrefix" }, { type: "azurerm:network/v20181201:PublicIPPrefix" }, { type: "azurerm:network/v20190201:PublicIPPrefix" }, { type: "azurerm:network/v20190401:PublicIPPrefix" }, { type: "azurerm:network/v20190601:PublicIPPrefix" }, { type: "azurerm:network/v20190801:PublicIPPrefix" }, { type: "azurerm:network/v20190901:PublicIPPrefix" }, { type: "azurerm:network/v20191101:PublicIPPrefix" }, { type: "azurerm:network/v20191201:PublicIPPrefix" }, { type: "azurerm:network/v20200301:PublicIPPrefix" }, { type: "azurerm:network/v20200401:PublicIPPrefix" }, { type: "azurerm:network/v20200501:PublicIPPrefix" }] };
