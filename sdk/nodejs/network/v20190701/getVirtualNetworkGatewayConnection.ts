...
export function getVirtualNetworkGatewayConnection(args: GetVirtualNetworkGatewayConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayConnectionResult> {
    pulumi.log.warn("getVirtualNetworkGatewayConnection is deprecated: azure-native:network/v20190701:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:VirtualNetworkGatewayConnection to guarantee forwards compatibility.")
