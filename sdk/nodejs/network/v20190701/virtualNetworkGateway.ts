 ...
 *
 * @deprecated azure-native:network/v20190701:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:VirtualNetworkGateway to guarantee forwards compatibility.
 */
export class VirtualNetworkGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkGateway {
        pulumi.log.warn("VirtualNetworkGateway is deprecated: azure-native:network/v20190701:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:VirtualNetworkGateway to guarantee forwards compatibility.")
