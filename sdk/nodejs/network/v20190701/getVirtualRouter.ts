...
export function getVirtualRouter(args: GetVirtualRouterArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190701:getVirtualRouter", {
        "name": args.name,
...
export interface GetVirtualRouterResult {
     ...
     */
    readonly properties: outputs.network.v20190701.VirtualRouterPropertiesFormatResponse;
    /**
     * Resource tags.
     */
