 ...
 *
 * @deprecated azure-native:network/v20190701:FirewallPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401:FirewallPolicy to guarantee forwards compatibility.
 */
export class FirewallPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FirewallPolicy {
        pulumi.log.warn("FirewallPolicy is deprecated: azure-native:network/v20190701:FirewallPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401:FirewallPolicy to guarantee forwards compatibility.")
        return new FirewallPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190701:FirewallPolicy';
     ...
     */
    public readonly basePolicy!: pulumi.Output<outputs.network.v20190701.SubResourceResponse | undefined>;
    /**
     * List of references to Child Firewall Policies.
     */
    public /*out*/ readonly childPolicies!: pulumi.Output<outputs.network.v20190701.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly firewalls!: pulumi.Output<outputs.network.v20190701.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly ruleGroups!: pulumi.Output<outputs.network.v20190701.SubResourceResponse[]>;
    /**
     * Resource tags.
     */
...
export interface FirewallPolicyArgs {
     ...
     * The parent firewall policy from which rules are inherited.
     */
    basePolicy?: pulumi.Input<inputs.network.v20190701.SubResourceArgs>;
    /**
