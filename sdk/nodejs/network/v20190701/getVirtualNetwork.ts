...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    pulumi.log.warn("getVirtualNetwork is deprecated: azure-native:network/v20190701:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:VirtualNetwork to guarantee forwards compatibility.")
