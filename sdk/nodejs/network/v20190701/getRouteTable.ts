...
export function getRouteTable(args: GetRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteTableResult> {
    pulumi.log.warn("getRouteTable is deprecated: azure-native:network/v20190701:RouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteTable to guarantee forwards compatibility.")
