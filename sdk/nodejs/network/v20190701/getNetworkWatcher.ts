...
export function getNetworkWatcher(args: GetNetworkWatcherArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkWatcherResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190701:getNetworkWatcher", {
        "name": args.name,
...
export interface GetNetworkWatcherResult {
     ...
     */
    readonly properties: outputs.network.v20190701.NetworkWatcherPropertiesFormatResponse;
    /**
     * Resource tags.
     */
