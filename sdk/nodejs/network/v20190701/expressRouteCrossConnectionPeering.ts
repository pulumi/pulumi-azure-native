...
export class ExpressRouteCrossConnectionPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190701:ExpressRouteCrossConnectionPeering';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190701.ExpressRouteCrossConnectionPeeringPropertiesResponse>;
...
export interface ExpressRouteCrossConnectionPeeringArgs {
     ...
     * Properties of the express route cross connection peering.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190701.ExpressRouteCrossConnectionPeeringProperties>;
    /**
