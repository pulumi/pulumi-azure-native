...
export class VirtualRouterPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190701:VirtualRouterPeering';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190701.VirtualRouterPeeringPropertiesResponse>;
    /**
     * Peering type.
     */
...
export interface VirtualRouterPeeringArgs {
     ...
     * The properties of the Virtual Router Peering.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190701.VirtualRouterPeeringProperties>;
    /**
