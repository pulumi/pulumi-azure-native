...
export class ApplicationSecurityGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationSecurityGroup {
        return new ApplicationSecurityGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190701:ApplicationSecurityGroup';
    ...
    constructor(name: string, argsOrState?: ApplicationSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20170901:ApplicationSecurityGroup" }, { type: "azurerm:network/v20171001:ApplicationSecurityGroup" }, { type: "azurerm:network/v20171101:ApplicationSecurityGroup" }, { type: "azurerm:network/v20180101:ApplicationSecurityGroup" }, { type: "azurerm:network/v20180201:ApplicationSecurityGroup" }, { type: "azurerm:network/v20180401:ApplicationSecurityGroup" }, { type: "azurerm:network/v20180601:ApplicationSecurityGroup" }, { type: "azurerm:network/v20180701:ApplicationSecurityGroup" }, { type: "azurerm:network/v20180801:ApplicationSecurityGroup" }, { type: "azurerm:network/v20181001:ApplicationSecurityGroup" }, { type: "azurerm:network/v20181101:ApplicationSecurityGroup" }, { type: "azurerm:network/v20181201:ApplicationSecurityGroup" }, { type: "azurerm:network/v20190201:ApplicationSecurityGroup" }, { type: "azurerm:network/v20190401:ApplicationSecurityGroup" }, { type: "azurerm:network/v20190601:ApplicationSecurityGroup" }, { type: "azurerm:network/v20190801:ApplicationSecurityGroup" }, { type: "azurerm:network/v20190901:ApplicationSecurityGroup" }, { type: "azurerm:network/v20191101:ApplicationSecurityGroup" }, { type: "azurerm:network/v20191201:ApplicationSecurityGroup" }, { type: "azurerm:network/v20200301:ApplicationSecurityGroup" }, { type: "azurerm:network/v20200401:ApplicationSecurityGroup" }, { type: "azurerm:network/v20200501:ApplicationSecurityGroup" }] };
