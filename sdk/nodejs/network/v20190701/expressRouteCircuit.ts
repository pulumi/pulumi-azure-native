 ...
 *
 * @deprecated azure-native:network/v20190701:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCircuit to guarantee forwards compatibility.
 */
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuit {
        pulumi.log.warn("ExpressRouteCircuit is deprecated: azure-native:network/v20190701:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCircuit to guarantee forwards compatibility.")
        return new ExpressRouteCircuit(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190701:ExpressRouteCircuit';
     ...
     */
    public readonly authorizations!: pulumi.Output<outputs.network.v20190701.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly expressRoutePort!: pulumi.Output<outputs.network.v20190701.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly serviceProviderProperties!: pulumi.Output<outputs.network.v20190701.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    public readonly sku!: pulumi.Output<outputs.network.v20190701.ExpressRouteCircuitSkuResponse | undefined>;
    /**
