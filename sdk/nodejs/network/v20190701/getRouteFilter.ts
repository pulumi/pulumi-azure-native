...
export function getRouteFilter(args: GetRouteFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190701:getRouteFilter", {
        "name": args.name,
...
export interface GetRouteFilterResult {
     ...
     */
    readonly properties: outputs.network.v20190701.RouteFilterPropertiesFormatResponse;
    /**
     * Resource tags.
     */
