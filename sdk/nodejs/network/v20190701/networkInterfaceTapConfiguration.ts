...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190701:NetworkInterfaceTapConfiguration';
    ...
    constructor(name: string, argsOrState?: NetworkInterfaceTapConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20180801:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20181001:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20181101:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20181201:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20190201:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20190401:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20190601:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20190801:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20190901:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20191101:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20191201:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20200301:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20200401:NetworkInterfaceTapConfiguration" }, { type: "azurerm:network/v20200501:NetworkInterfaceTapConfiguration" }] };
