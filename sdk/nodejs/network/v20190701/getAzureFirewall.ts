...
export function getAzureFirewall(args: GetAzureFirewallArgs, opts?: pulumi.InvokeOptions): Promise<GetAzureFirewallResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190701:getAzureFirewall", {
        "name": args.name,
...
export interface GetAzureFirewallResult {
     ...
     */
    readonly properties: outputs.network.v20190701.AzureFirewallPropertiesFormatResponse;
    /**
     * Resource tags.
     */
