...
export class SecurityRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityRule {
        pulumi.log.warn("SecurityRule is deprecated: azure-native:network/v20190701:SecurityRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.")
