...
export class IpGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:IpGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.IpGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface IpGroupState {
     ...
     * Properties of the IpGroups.
     */
    readonly properties: pulumi.Input<inputs.network.IpGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface IpGroupArgs {
     ...
     * Properties of the IpGroups.
     */
    readonly properties?: pulumi.Input<inputs.network.IpGroupPropertiesFormat>;
    /**
