...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20180601:RouteFilter';
...
export interface RouteFilterArgs {
     ...
     * A collection of references to express route circuit peerings.
     */
    readonly peerings?: pulumi.Input<pulumi.Input<inputs.network.v20180601.ExpressRouteCircuitPeering>[]>;
    /**
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.v20180601.RouteFilterRule>[]>;
    /**
     * Resource tags.
     */
