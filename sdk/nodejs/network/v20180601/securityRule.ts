...
export class SecurityRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20180601:SecurityRule';
     ...
     */
    public readonly destinationApplicationSecurityGroups!: pulumi.Output<outputs.network.v20180601.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     ...
     */
    public readonly sourceApplicationSecurityGroups!: pulumi.Output<outputs.network.v20180601.ApplicationSecurityGroupResponse[] | undefined>;
    /**
...
export interface SecurityRuleArgs {
     ...
     * The application security group specified as destination.
     */
    readonly destinationApplicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20180601.ApplicationSecurityGroup>[]>;
    /**
     * The destination port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
     */
     ...
     * The application security group specified as source.
     */
    readonly sourceApplicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20180601.ApplicationSecurityGroup>[]>;
    /**
     * The source port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
     */
