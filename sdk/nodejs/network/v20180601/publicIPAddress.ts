...
export class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180601.PublicIPAddressPropertiesFormatResponse>;
    /**
...
export interface PublicIPAddressArgs {
     ...
     * Public IP address properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20180601.PublicIPAddressPropertiesFormat>;
    /**
