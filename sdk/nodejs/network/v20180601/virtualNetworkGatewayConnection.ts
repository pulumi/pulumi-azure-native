...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180601:VirtualNetworkGatewayConnection';
