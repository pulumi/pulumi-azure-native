...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20180601:VirtualNetworkGatewayConnection';
     ...
     */
    public readonly localNetworkGateway2!: pulumi.Output<outputs.network.v20180601.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly peer!: pulumi.Output<outputs.network.v20180601.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly tunnelConnectionStatus!: pulumi.Output<outputs.network.v20180601.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    public readonly virtualNetworkGateway1!: pulumi.Output<outputs.network.v20180601.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    public readonly virtualNetworkGateway2!: pulumi.Output<outputs.network.v20180601.VirtualNetworkGatewayResponse | undefined>;
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * Gateway connection type. Possible values are: 'IPsec','Vnet2Vnet','ExpressRoute', and 'VPNClient.
     */
    readonly connectionType: pulumi.Input<string | enums.network.v20180601.VirtualNetworkGatewayConnectionType>;
    /**
     * EnableBgp flag
     */
     ...
     * The IPSec Policies to be considered by this connection.
     */
    readonly ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20180601.IpsecPolicyArgs>[]>;
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: pulumi.Input<inputs.network.v20180601.LocalNetworkGatewayArgs>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    readonly peer?: pulumi.Input<inputs.network.v20180601.SubResourceArgs>;
    /**
     ...
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway1: pulumi.Input<inputs.network.v20180601.VirtualNetworkGatewayArgs>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: pulumi.Input<inputs.network.v20180601.VirtualNetworkGatewayArgs>;
    /**
