...
export function getDdosProtectionPlan(args: GetDdosProtectionPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosProtectionPlanResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180601:getDdosProtectionPlan", {
        "name": args.name,
...
export interface GetDdosProtectionPlanResult {
     ...
     */
    readonly properties: outputs.network.v20180601.DdosProtectionPlanPropertiesFormatResponse;
    /**
     * Resource tags.
     */
