...
export class PacketCapture extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PacketCapture {
        pulumi.log.warn("PacketCapture is deprecated: azure-native:network/v20180601:PacketCapture is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200601:PacketCapture to guarantee forwards compatibility.")
