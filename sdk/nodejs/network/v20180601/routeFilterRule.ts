...
export class RouteFilterRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180601:RouteFilterRule';
     ...
     * Route Filter Rule Resource
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180601.RouteFilterRulePropertiesFormatResponse>;
...
export interface RouteFilterRuleArgs {
     ...
     * Route Filter Rule Resource
     */
    readonly properties?: pulumi.Input<inputs.network.v20180601.RouteFilterRulePropertiesFormat>;
    /**
