...
export function getVirtualNetworkGatewayConnection(args: GetVirtualNetworkGatewayConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180601:getVirtualNetworkGatewayConnection", {
...
export interface GetVirtualNetworkGatewayConnectionResult {
     ...
     */
    readonly localNetworkGateway2?: outputs.network.v20180601.LocalNetworkGatewayInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly peer?: outputs.network.v20180601.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly tunnelConnectionStatus: outputs.network.v20180601.TunnelConnectionHealthInvokeResponse[];
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualNetworkGateway1: outputs.network.v20180601.VirtualNetworkGatewayInvokeResponse;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: outputs.network.v20180601.VirtualNetworkGatewayInvokeResponse;
}
