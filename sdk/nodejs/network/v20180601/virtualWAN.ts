...
export class VirtualWAN extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualWAN {
        pulumi.log.warn("VirtualWAN is deprecated: azure-native:network/v20180601:VirtualWAN is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180701:VirtualWAN to guarantee forwards compatibility.")
