...
export class AzureFirewall extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AzureFirewall {
        pulumi.log.warn("AzureFirewall is deprecated: azure-native:network/v20180601:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:AzureFirewall to guarantee forwards compatibility.")
        return new AzureFirewall(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20180601:AzureFirewall';
...
export interface AzureFirewallArgs {
     ...
     * Collection of application rule collections used by a Azure Firewall.
     */
    applicationRuleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20180601.AzureFirewallApplicationRuleCollectionArgs>[]>;
    /**
     ...
     * IP configuration of the Azure Firewall resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20180601.AzureFirewallIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * Collection of network rule collections used by a Azure Firewall.
     */
    networkRuleCollections?: pulumi.Input<pulumi.Input<inputs.network.v20180601.AzureFirewallNetworkRuleCollectionArgs>[]>;
    /**
