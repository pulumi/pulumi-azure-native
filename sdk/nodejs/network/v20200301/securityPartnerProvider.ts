...
export class SecurityPartnerProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200301:SecurityPartnerProvider';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200301.SecurityPartnerProviderPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface SecurityPartnerProviderArgs {
     ...
     * Properties of the Security Partner Provider.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200301.SecurityPartnerProviderPropertiesFormat>;
    /**
