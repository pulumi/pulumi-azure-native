 ...
 */
/** @deprecated azure-native:network/v20200301:ApplicationGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ApplicationGateway to guarantee forwards compatibility. */
export function getApplicationGateway(args: GetApplicationGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGatewayResult> {
    pulumi.log.warn("getApplicationGateway is deprecated: azure-native:network/v20200301:ApplicationGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ApplicationGateway to guarantee forwards compatibility.")
