...
export function getPrivateDnsZoneGroup(args: GetPrivateDnsZoneGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateDnsZoneGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200301:getPrivateDnsZoneGroup", {
        "name": args.name,
...
export interface GetPrivateDnsZoneGroupResult {
     ...
     */
    readonly properties: outputs.network.v20200301.PrivateDnsZoneGroupPropertiesFormatResponse;
}
