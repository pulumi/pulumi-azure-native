...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    pulumi.log.warn("getVirtualNetworkGateway is deprecated: azure-native:network/v20200301:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGateway to guarantee forwards compatibility.")
