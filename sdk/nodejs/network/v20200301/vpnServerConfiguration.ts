 ...
 *
 * const vpnServerConfiguration = new azurerm.network.v20200301.VpnServerConfiguration("vpnServerConfiguration", {
 *     location: "West US",
...
export class VpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200301:VpnServerConfiguration';
