...
export class VpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200301:VpnServerConfiguration';
     ...
     */
    public readonly aadAuthenticationParameters!: pulumi.Output<outputs.network.v20200301.AadAuthenticationParametersResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly p2SVpnGateways!: pulumi.Output<outputs.network.v20200301.P2SVpnGatewayResponse[]>;
    /**
     ...
     */
    public readonly radiusClientRootCertificates!: pulumi.Output<outputs.network.v20200301.VpnServerConfigRadiusClientRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServerRootCertificates!: pulumi.Output<outputs.network.v20200301.VpnServerConfigRadiusServerRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServers!: pulumi.Output<outputs.network.v20200301.RadiusServerResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly vpnClientIpsecPolicies!: pulumi.Output<outputs.network.v20200301.IpsecPolicyResponse[] | undefined>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRevokedCertificates!: pulumi.Output<outputs.network.v20200301.VpnServerConfigVpnClientRevokedCertificateResponse[] | undefined>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRootCertificates!: pulumi.Output<outputs.network.v20200301.VpnServerConfigVpnClientRootCertificateResponse[] | undefined>;
    /**
...
export interface VpnServerConfigurationArgs {
     ...
     * The set of aad vpn authentication parameters.
     */
    readonly aadAuthenticationParameters?: pulumi.Input<inputs.network.v20200301.AadAuthenticationParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Radius client root certificate of VpnServerConfiguration.
     */
    readonly radiusClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200301.VpnServerConfigRadiusClientRootCertificateArgs>[]>;
    /**
     * The radius server address property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Radius Server root certificate of VpnServerConfiguration.
     */
    readonly radiusServerRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200301.VpnServerConfigRadiusServerRootCertificateArgs>[]>;
    /**
     * The radius secret property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Multiple Radius Server configuration for VpnServerConfiguration.
     */
    readonly radiusServers?: pulumi.Input<pulumi.Input<inputs.network.v20200301.RadiusServerArgs>[]>;
    /**
     ...
     * VPN authentication types for the VpnServerConfiguration.
     */
    readonly vpnAuthenticationTypes?: pulumi.Input<pulumi.Input<string | enums.network.v20200301.VpnAuthenticationType>[]>;
    /**
     * VpnClientIpsecPolicies for VpnServerConfiguration.
     */
    readonly vpnClientIpsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20200301.IpsecPolicyArgs>[]>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    readonly vpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200301.VpnServerConfigVpnClientRevokedCertificateArgs>[]>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    readonly vpnClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200301.VpnServerConfigVpnClientRootCertificateArgs>[]>;
    /**
     * VPN protocols for the VpnServerConfiguration.
     */
    readonly vpnProtocols?: pulumi.Input<pulumi.Input<string | enums.network.v20200301.VpnGatewayTunnelingProtocol>[]>;
    /**
