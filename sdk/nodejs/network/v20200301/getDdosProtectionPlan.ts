...
export function getDdosProtectionPlan(args: GetDdosProtectionPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosProtectionPlanResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200301:getDdosProtectionPlan", {
        "name": args.name,
...
export interface GetDdosProtectionPlanResult {
     ...
     */
    readonly properties: outputs.network.v20200301.DdosProtectionPlanPropertiesFormatResponse;
    /**
     * Resource tags.
     */
