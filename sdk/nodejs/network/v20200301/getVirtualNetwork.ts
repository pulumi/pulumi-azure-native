...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    pulumi.log.warn("getVirtualNetwork is deprecated: azure-native:network/v20200301:VirtualNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetwork to guarantee forwards compatibility.")
