 ...
 *
 * const firewallPolicy = new azurerm.network.v20200301.FirewallPolicy("firewallPolicy", {
...
export class FirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200301:FirewallPolicy';
...
export interface FirewallPolicyArgs {
     ...
     * The parent firewall policy from which rules are inherited.
     */
    readonly basePolicy?: pulumi.Input<inputs.network.v20200301.SubResource>;
    /**
