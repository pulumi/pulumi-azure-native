...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200301:VirtualNetwork';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200301.VirtualNetworkPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkArgs {
     ...
     * Properties of the virtual network.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200301.VirtualNetworkPropertiesFormat>;
    /**
