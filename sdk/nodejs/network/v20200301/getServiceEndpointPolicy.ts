...
export function getServiceEndpointPolicy(args: GetServiceEndpointPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceEndpointPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200301:getServiceEndpointPolicy", {
        "name": args.name,
...
export interface GetServiceEndpointPolicyResult {
     ...
     */
    readonly properties: outputs.network.v20200301.ServiceEndpointPolicyPropertiesFormatResponse;
    /**
     * Resource tags.
     */
