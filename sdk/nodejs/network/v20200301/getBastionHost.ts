...
export function getBastionHost(args: GetBastionHostArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionHostResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20200301:getBastionHost", {
        "name": args.name,
...
export interface GetBastionHostResult {
     ...
     */
    readonly properties: outputs.network.v20200301.BastionHostPropertiesFormatResponse;
    /**
     * Resource tags.
     */
