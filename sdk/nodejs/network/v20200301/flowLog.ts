 ...
 * A flow log resource.
 *
 * @deprecated azure-native:network/v20200301:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FlowLog to guarantee forwards compatibility.
 */
export class FlowLog extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FlowLog {
        pulumi.log.warn("FlowLog is deprecated: azure-native:network/v20200301:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FlowLog to guarantee forwards compatibility.")
