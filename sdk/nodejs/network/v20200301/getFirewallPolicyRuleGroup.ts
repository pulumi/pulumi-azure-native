...
export function getFirewallPolicyRuleGroup(args: GetFirewallPolicyRuleGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200301:getFirewallPolicyRuleGroup", {
...
export interface GetFirewallPolicyRuleGroupResult {
     ...
     */
    readonly rules?: outputs.network.v20200301.FirewallPolicyFilterRuleInvokeResponse | outputs.network.v20200301.FirewallPolicyNatRuleInvokeResponse[];
    /**
     * Rule Group type.
     */
