...
export class NetworkProfile extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: NetworkProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20180801:NetworkProfile" }, { type: "azurerm:network/v20181001:NetworkProfile" }, { type: "azurerm:network/v20181101:NetworkProfile" }, { type: "azurerm:network/v20181201:NetworkProfile" }, { type: "azurerm:network/v20190201:NetworkProfile" }, { type: "azurerm:network/v20190401:NetworkProfile" }, { type: "azurerm:network/v20190601:NetworkProfile" }, { type: "azurerm:network/v20190701:NetworkProfile" }, { type: "azurerm:network/v20190801:NetworkProfile" }, { type: "azurerm:network/v20190901:NetworkProfile" }, { type: "azurerm:network/v20191101:NetworkProfile" }, { type: "azurerm:network/v20191201:NetworkProfile" }, { type: "azurerm:network/v20200401:NetworkProfile" }, { type: "azurerm:network/v20200501:NetworkProfile" }] };
