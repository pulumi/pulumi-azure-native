...
export function getNetworkVirtualAppliance(args: GetNetworkVirtualApplianceArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkVirtualApplianceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200301:getNetworkVirtualAppliance", {
        "expand": args.expand,
...
export interface GetNetworkVirtualApplianceResult {
     ...
     */
    readonly sku?: outputs.network.v20200301.VirtualApplianceSkuPropertiesInvokeResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualApplianceNics: outputs.network.v20200301.VirtualApplianceNicPropertiesInvokeResponse[];
    /**
