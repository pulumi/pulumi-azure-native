...
export function getNetworkVirtualAppliance(args: GetNetworkVirtualApplianceArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkVirtualApplianceResult> {
    pulumi.log.warn("getNetworkVirtualAppliance is deprecated: azure-native:network/v20200301:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:NetworkVirtualAppliance to guarantee forwards compatibility.")
