 ...
 *
 * const securityRule = new azurerm.network.v20200301.SecurityRule("securityRule", {
 *     access: "Deny",
...
export class SecurityRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200301:SecurityRule';
