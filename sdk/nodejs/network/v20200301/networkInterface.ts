...
export class NetworkInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200301:NetworkInterface';
...
export interface NetworkInterfaceArgs {
     ...
     * The DNS settings in network interface.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20200301.NetworkInterfaceDnsSettingsArgs>;
    /**
     * If the network interface is accelerated networking enabled.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20200301.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference to the NetworkSecurityGroup resource.
     */
    readonly networkSecurityGroup?: pulumi.Input<inputs.network.v20200301.NetworkSecurityGroupArgs>;
    /**
