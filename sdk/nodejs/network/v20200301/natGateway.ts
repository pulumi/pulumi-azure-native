 ...
 *
 * const natGateway = new azurerm.network.v20200301.NatGateway("natGateway", {
 *     location: "westus",
...
export class NatGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NatGateway {
        return new NatGateway(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200301:NatGateway';
    ...
    constructor(name: string, argsOrState?: NatGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:NatGateway" }, { type: "azurerm:network/v20190201:NatGateway" }, { type: "azurerm:network/v20190401:NatGateway" }, { type: "azurerm:network/v20190601:NatGateway" }, { type: "azurerm:network/v20190701:NatGateway" }, { type: "azurerm:network/v20190801:NatGateway" }, { type: "azurerm:network/v20190901:NatGateway" }, { type: "azurerm:network/v20191101:NatGateway" }, { type: "azurerm:network/v20191201:NatGateway" }, { type: "azurerm:network/v20200401:NatGateway" }, { type: "azurerm:network/v20200501:NatGateway" }, { type: "azurerm:network/v20200601:NatGateway" }] };
