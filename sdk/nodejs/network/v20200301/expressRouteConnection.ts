 ...
 *
 * const expressRouteConnection = new azurerm.network.v20200301.ExpressRouteConnection("expressRouteConnection", {
...
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200301:ExpressRouteConnection';
