...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHubRouteTableV2 {
        pulumi.log.warn("VirtualHubRouteTableV2 is deprecated: azure-native:network/v20200301:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHubRouteTableV2 to guarantee forwards compatibility.")
