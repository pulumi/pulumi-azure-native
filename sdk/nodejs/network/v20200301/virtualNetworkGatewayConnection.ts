 ...
 *
 * const virtualNetworkGatewayConnection = new azurerm.network.v20200301.VirtualNetworkGatewayConnection("virtualNetworkGatewayConnection", {
...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200301:VirtualNetworkGatewayConnection';
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: pulumi.Input<inputs.network.v20200301.LocalNetworkGateway>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    readonly peer?: pulumi.Input<inputs.network.v20200301.SubResource>;
    /**
     ...
     * The Traffic Selector Policies to be considered by this connection.
     */
    readonly trafficSelectorPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20200301.TrafficSelectorPolicy>[]>;
    /**
     * Use private local Azure IP for the connection.
     */
     ...
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway1: pulumi.Input<inputs.network.v20200301.VirtualNetworkGateway>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: pulumi.Input<inputs.network.v20200301.VirtualNetworkGateway>;
    /**
