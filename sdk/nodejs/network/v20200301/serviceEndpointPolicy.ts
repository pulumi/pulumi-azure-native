...
export class ServiceEndpointPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200301.ServiceEndpointPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ServiceEndpointPolicyArgs {
     ...
     * Properties of the service end point policy.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200301.ServiceEndpointPolicyPropertiesFormat>;
    /**
