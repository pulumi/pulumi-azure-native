 ...
 *
 * @deprecated azure-native:network/v20200301:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:Subnet to guarantee forwards compatibility.
 */
export class Subnet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Subnet {
        pulumi.log.warn("Subnet is deprecated: azure-native:network/v20200301:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:Subnet to guarantee forwards compatibility.")
