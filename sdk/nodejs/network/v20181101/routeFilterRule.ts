 ...
 *
 * const routeFilterRule = new azurerm.network.v20181101.RouteFilterRule("routeFilterRule", {
 *     access: "Allow",
 *     communities: [
 *         "12076:5030",
 *         "12076:5040",
...
export class RouteFilterRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181101:RouteFilterRule';
