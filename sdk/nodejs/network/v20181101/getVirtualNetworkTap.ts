...
export function getVirtualNetworkTap(args: GetVirtualNetworkTapArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkTapResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20181101:getVirtualNetworkTap", {
        "name": args.name,
...
export interface GetVirtualNetworkTapResult {
     ...
     */
    readonly properties: outputs.network.v20181101.VirtualNetworkTapPropertiesFormatResponse;
    /**
     * Resource tags.
     */
