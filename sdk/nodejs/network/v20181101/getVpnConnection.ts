...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20181101:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly ipsecPolicies?: outputs.network.v20181101.IpsecPolicyInvokeResponse[];
    /**
     ...
     */
    readonly remoteVpnSite?: outputs.network.v20181101.SubResourceInvokeResponse;
    /**
