 ...
 *
 * const ddosCustomPolicy = new azurerm.network.v20181101.DdosCustomPolicy("ddosCustomPolicy", {
...
export class DdosCustomPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181101:DdosCustomPolicy';
