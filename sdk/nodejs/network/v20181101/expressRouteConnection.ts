 ...
 *
 * const expressRouteConnection = new azurerm.network.v20181101.ExpressRouteConnection("expressRouteConnection", {
...
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181101:ExpressRouteConnection';
