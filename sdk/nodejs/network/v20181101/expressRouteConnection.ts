...
export class ExpressRouteConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20181101.ExpressRouteConnectionPropertiesResponse>;
...
export interface ExpressRouteConnectionArgs {
     ...
     * Properties of the ExpressRouteConnection subresource.
     */
    readonly properties?: pulumi.Input<inputs.network.v20181101.ExpressRouteConnectionProperties>;
    /**
