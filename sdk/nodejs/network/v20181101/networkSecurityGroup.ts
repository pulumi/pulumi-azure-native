...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20181101:NetworkSecurityGroup';
...
export interface NetworkSecurityGroupArgs {
     ...
     * The default security rules of network security group.
     */
    readonly defaultSecurityRules?: pulumi.Input<pulumi.Input<inputs.network.v20181101.SecurityRule>[]>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * A collection of security rules of the network security group.
     */
    readonly securityRules?: pulumi.Input<pulumi.Input<inputs.network.v20181101.SecurityRule>[]>;
    /**
     * Resource tags.
     */
