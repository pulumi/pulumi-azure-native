...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20181101:RouteFilter';
...
export interface RouteFilterArgs {
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.v20181101.RouteFilterRule>[]>;
    /**
     * Resource tags.
     */
