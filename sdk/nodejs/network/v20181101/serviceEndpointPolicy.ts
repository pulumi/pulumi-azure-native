...
export class ServiceEndpointPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20181101:ServiceEndpointPolicy';
...
export interface ServiceEndpointPolicyArgs {
     ...
     * A collection of service endpoint policy definitions of the service endpoint policy.
     */
    readonly serviceEndpointPolicyDefinitions?: pulumi.Input<pulumi.Input<inputs.network.v20181101.ServiceEndpointPolicyDefinition>[]>;
    /**
