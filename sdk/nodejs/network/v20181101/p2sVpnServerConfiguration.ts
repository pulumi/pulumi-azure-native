...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: P2sVpnServerConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20181101:P2sVpnServerConfiguration" }, { type: "azure-native:network:P2sVpnServerConfiguration" }, { type: "azure-nextgen:network:P2sVpnServerConfiguration" }, { type: "azure-native:network/v20180801:P2sVpnServerConfiguration" }, { type: "azure-nextgen:network/v20180801:P2sVpnServerConfiguration" }, { type: "azure-native:network/v20181001:P2sVpnServerConfiguration" }, { type: "azure-nextgen:network/v20181001:P2sVpnServerConfiguration" }, { type: "azure-native:network/v20181201:P2sVpnServerConfiguration" }, { type: "azure-nextgen:network/v20181201:P2sVpnServerConfiguration" }, { type: "azure-native:network/v20190201:P2sVpnServerConfiguration" }, { type: "azure-nextgen:network/v20190201:P2sVpnServerConfiguration" }, { type: "azure-native:network/v20190401:P2sVpnServerConfiguration" }, { type: "azure-nextgen:network/v20190401:P2sVpnServerConfiguration" }, { type: "azure-native:network/v20190601:P2sVpnServerConfiguration" }, { type: "azure-nextgen:network/v20190601:P2sVpnServerConfiguration" }, { type: "azure-native:network/v20190701:P2sVpnServerConfiguration" }, { type: "azure-nextgen:network/v20190701:P2sVpnServerConfiguration" }] };
...
export interface P2sVpnServerConfigurationArgs {
     ...
     * Radius client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20181101.P2SVpnServerConfigRadiusClientRootCertificateArgs>[]>;
    /**
     * Radius Server root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusServerRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20181101.P2SVpnServerConfigRadiusServerRootCertificateArgs>[]>;
    /**
     * VPN client revoked certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20181101.P2SVpnServerConfigVpnClientRevokedCertificateArgs>[]>;
    /**
     * VPN client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20181101.P2SVpnServerConfigVpnClientRootCertificateArgs>[]>;
    /**
     ...
     * VpnClientIpsecPolicies for P2SVpnServerConfiguration.
     */
    readonly vpnClientIpsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20181101.IpsecPolicyArgs>[]>;
    /**
     * vpnProtocols for the P2SVpnServerConfiguration.
     */
    readonly vpnProtocols?: pulumi.Input<pulumi.Input<string | enums.network.v20181101.VpnGatewayTunnelingProtocol>[]>;
}
