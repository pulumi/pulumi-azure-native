...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20181101.P2SVpnServerConfigurationPropertiesResponse>;
...
export interface P2sVpnServerConfigurationArgs {
     ...
     * Parameters for P2SVpnServerConfiguration
     */
    readonly properties?: pulumi.Input<inputs.network.v20181101.P2SVpnServerConfigurationProperties>;
    /**
