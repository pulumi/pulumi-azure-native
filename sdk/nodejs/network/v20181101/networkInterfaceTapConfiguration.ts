...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20181101:NetworkInterfaceTapConfiguration';
    ...
    constructor(name: string, args: NetworkInterfaceTapConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if ((!args || args.tapConfigurationName === undefined) && !(opts && opts.urn)) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/latest:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20180801:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20181001:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20181201:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20190201:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20190401:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20190601:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20190701:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20190801:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20190901:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20191101:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20191201:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20200301:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20200401:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20200501:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20200601:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20200701:NetworkInterfaceTapConfiguration" }, { type: "azure-nextgen:network/v20200801:NetworkInterfaceTapConfiguration" }] };
