...
export class ExpressRouteCrossConnectionPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181101:ExpressRouteCrossConnectionPeering';
