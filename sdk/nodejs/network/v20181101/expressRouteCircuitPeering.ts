...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    public /*out*/ readonly properties!: pulumi.Output<outputs.network.v20181101.ExpressRouteCircuitPeeringPropertiesFormatResponse>;
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     */
    readonly expressRouteConnection?: pulumi.Input<inputs.network.v20181101.ExpressRouteConnectionId>;
    /**
