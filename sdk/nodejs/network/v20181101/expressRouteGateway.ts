 ...
 *
 * const expressRouteGateway = new azurerm.network.v20181101.ExpressRouteGateway("expressRouteGateway", {
...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181101:ExpressRouteGateway';
...
export interface ExpressRouteGatewayArgs {
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    readonly virtualHub: pulumi.Input<inputs.network.v20181101.VirtualHubId>;
}
