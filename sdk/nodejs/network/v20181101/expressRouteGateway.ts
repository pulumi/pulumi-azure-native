...
export class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20181101.ExpressRouteGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ExpressRouteGatewayArgs {
     ...
     * ExpressRoute gateway resource properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20181101.ExpressRouteGatewayProperties>;
    /**
