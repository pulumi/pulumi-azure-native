...
export class InterfaceEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InterfaceEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:InterfaceEndpoint" }, { type: "azurerm:network/preview:InterfaceEndpoint" }, { type: "azurerm:network/v20180801:InterfaceEndpoint" }, { type: "azurerm:network/v20181001:InterfaceEndpoint" }, { type: "azurerm:network/v20181201:InterfaceEndpoint" }, { type: "azurerm:network/v20190201:InterfaceEndpoint" }] };
