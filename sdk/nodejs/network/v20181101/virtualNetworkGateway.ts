...
export class VirtualNetworkGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20181101.VirtualNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkGatewayArgs {
     ...
     * Properties of the virtual network gateway.
     */
    readonly properties: pulumi.Input<inputs.network.v20181101.VirtualNetworkGatewayPropertiesFormat>;
    /**
