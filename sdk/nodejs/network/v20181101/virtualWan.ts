 ...
 *
 * const virtualWan = new azurerm.network.v20181101.VirtualWan("virtualWan", {
...
export interface VirtualWanArgs {
     ...
     * list of all P2SVpnServerConfigurations associated with the virtual wan.
     */
    readonly p2SVpnServerConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20181101.P2SVpnServerConfiguration>[]>;
    /**
     * The provisioning state of the resource.
     */
