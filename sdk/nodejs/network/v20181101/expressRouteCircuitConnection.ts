...
export class ExpressRouteCircuitConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20181101:ExpressRouteCircuitConnection';
