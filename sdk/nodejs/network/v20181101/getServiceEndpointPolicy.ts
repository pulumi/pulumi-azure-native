...
export function getServiceEndpointPolicy(args: GetServiceEndpointPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceEndpointPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20181101:getServiceEndpointPolicy", {
        "expand": args.expand,
...
export interface GetServiceEndpointPolicyResult {
     ...
     */
    readonly serviceEndpointPolicyDefinitions?: outputs.network.v20181101.ServiceEndpointPolicyDefinitionInvokeResponse[];
    /**
