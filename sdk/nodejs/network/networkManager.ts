...
export class NetworkManager extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:NetworkManager" }, { type: "azure-native:network/v20210501preview:NetworkManager" }, { type: "azure-native:network/v20220201preview:NetworkManager" }] };
