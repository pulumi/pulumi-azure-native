...
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20160901:PublicIPAddress';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20160901.PublicIPAddressPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * Public IP address properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20160901.PublicIPAddressPropertiesFormat>;
    /**
