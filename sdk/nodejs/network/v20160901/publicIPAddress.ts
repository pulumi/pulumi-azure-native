...
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20160901:PublicIPAddress';
...
export interface PublicIPAddressArgs {
     ...
     * The FQDN of the DNS record associated with the public IP address.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.v20160901.PublicIPAddressDnsSettingsArgs>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The public IP address version. Possible values are: 'IPv4' and 'IPv6'.
     */
    readonly publicIPAddressVersion?: pulumi.Input<string | enums.network.v20160901.IPVersion>;
    /**
     * The public IP allocation method. Possible values are: 'Static' and 'Dynamic'.
     */
    readonly publicIPAllocationMethod?: pulumi.Input<string | enums.network.v20160901.IPAllocationMethod>;
    /**
