...
azure-native:network/v20160901:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.
 */
export class Subnet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Subnet {
        pulumi.log.warn("Subnet is deprecated: Version 2016-09-01 will be removed in v2 of the provider.\nazure-native:network/v20160901:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.")
