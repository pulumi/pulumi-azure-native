...
export function getExpressRouteCircuitPeering(args: GetExpressRouteCircuitPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20160901:getExpressRouteCircuitPeering", {
...
export interface GetExpressRouteCircuitPeeringResult {
     ...
     */
    readonly microsoftPeeringConfig?: outputs.network.v20160901.ExpressRouteCircuitPeeringConfigInvokeResponse;
    /**
     ...
     * Gets peering stats.
     */
    readonly stats?: outputs.network.v20160901.ExpressRouteCircuitStatsInvokeResponse;
    /**
     * The VLAN ID.
     */
