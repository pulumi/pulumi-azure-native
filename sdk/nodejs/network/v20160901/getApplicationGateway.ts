...
export function getApplicationGateway(args: GetApplicationGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20160901:getApplicationGateway", {
        "name": args.name,
...
export interface GetApplicationGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20160901.ApplicationGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
