...
export class ApplicationGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20160901:ApplicationGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20160901.ApplicationGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationGatewayArgs {
     ...
     * Properties of the application gateway.
     */
    readonly properties?: pulumi.Input<inputs.network.v20160901.ApplicationGatewayPropertiesFormat>;
    /**
