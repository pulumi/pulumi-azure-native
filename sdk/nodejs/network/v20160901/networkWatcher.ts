...
azure-native:network/v20160901:NetworkWatcher is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180101:NetworkWatcher to guarantee forwards compatibility.
 */
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkWatcher {
        pulumi.log.warn("NetworkWatcher is deprecated: Version 2016-09-01 will be removed in v2 of the provider.\nazure-native:network/v20160901:NetworkWatcher is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180101:NetworkWatcher to guarantee forwards compatibility.")
