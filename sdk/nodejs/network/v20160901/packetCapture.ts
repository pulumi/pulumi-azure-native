...
export class PacketCapture extends pulumi.CustomResource {
    ...
    public readonly filters!: pulumi.Output<outputs.network.v20160901.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    public readonly storageLocation!: pulumi.Output<outputs.network.v20160901.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
    ...
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20160901.PacketCaptureFilter>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20160901.PacketCaptureStorageLocation>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
