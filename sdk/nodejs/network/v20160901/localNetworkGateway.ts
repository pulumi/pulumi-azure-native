 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20160901:LocalNetworkGateway myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName} 
 * ```
 *
...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalNetworkGateway {
        pulumi.log.warn("LocalNetworkGateway is deprecated: Version 2016-09-01 will be removed in v2 of the provider.")
        return new LocalNetworkGateway(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20160901:LocalNetworkGateway';
     ...
     */
    public readonly bgpSettings!: pulumi.Output<outputs.network.v20160901.BgpSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.v20160901.AddressSpaceResponse>;
    /**
     * Resource location.
     */
