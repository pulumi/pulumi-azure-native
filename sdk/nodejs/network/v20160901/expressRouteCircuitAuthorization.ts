...
export class ExpressRouteCircuitAuthorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20160901:ExpressRouteCircuitAuthorization';
    ...
    public readonly properties!: pulumi.Output<outputs.network.v20160901.AuthorizationPropertiesFormatResponse>;
...
export interface ExpressRouteCircuitAuthorizationArgs {
    ...
    readonly properties?: pulumi.Input<inputs.network.v20160901.AuthorizationPropertiesFormat>;
    /**
