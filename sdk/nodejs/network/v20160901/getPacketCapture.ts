...
export function getPacketCapture(args: GetPacketCaptureArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCaptureResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20160901:getPacketCapture", {
...
export interface GetPacketCaptureResult {
    ...
    readonly filters?: outputs.network.v20160901.PacketCaptureFilterInvokeResponse[];
    /**
     ...
     */
    readonly storageLocation: outputs.network.v20160901.PacketCaptureStorageLocationInvokeResponse;
    /**
