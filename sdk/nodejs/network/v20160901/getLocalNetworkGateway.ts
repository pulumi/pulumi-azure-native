...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20160901:getLocalNetworkGateway", {
...
export interface GetLocalNetworkGatewayResult {
     ...
     */
    readonly bgpSettings?: outputs.network.v20160901.BgpSettingsInvokeResponse;
    /**
     ...
     */
    readonly localNetworkAddressSpace: outputs.network.v20160901.AddressSpaceInvokeResponse;
    /**
     * Resource location.
     */
