...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:ExpressRouteGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.ExpressRouteGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ExpressRouteGatewayState {
     ...
     * Properties of the express route gateway.
     */
    readonly properties: pulumi.Input<inputs.network.ExpressRouteGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ExpressRouteGatewayArgs {
     ...
     * Properties of the express route gateway.
     */
    readonly properties?: pulumi.Input<inputs.network.ExpressRouteGatewayProperties>;
    /**
