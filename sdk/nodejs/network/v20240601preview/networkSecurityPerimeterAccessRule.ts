...
export class NetworkSecurityPerimeterAccessRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240601preview:NetworkSecurityPerimeterAccessRule';
     ...
     */
    public /*out*/ readonly networkSecurityPerimeters!: pulumi.Output<outputs.network.v20240601preview.PerimeterBasedAccessRuleResponse[]>;
    /**
     ...
     */
    public readonly subscriptions!: pulumi.Output<outputs.network.v20240601preview.SubscriptionIdResponse[] | undefined>;
    /**
     * Resource tags.
     */
