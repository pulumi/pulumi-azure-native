...
export class NetworkSecurityPerimeterProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240601preview:NetworkSecurityPerimeterProfile';
