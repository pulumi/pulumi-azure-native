...
export class FlowLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:FlowLog';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.FlowLogPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface FlowLogArgs {
     ...
     * Properties of the flow log.
     */
    readonly properties?: pulumi.Input<inputs.network.FlowLogPropertiesFormat>;
    /**
