...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules: outputs.network.v20230401.SecurityRuleResponse[];
    /**
     ...
     */
    readonly flowLogs: outputs.network.v20230401.FlowLogResponse[];
    /**
     ...
     */
    readonly networkInterfaces: outputs.network.v20230401.NetworkInterfaceResponse[];
    /**
     ...
     */
    readonly securityRules?: outputs.network.v20230401.SecurityRuleResponse[];
    /**
     * A collection of references to subnets.
     */
    readonly subnets: outputs.network.v20230401.SubnetResponse[];
    /**
     * Resource tags.
     */
...
export function getNetworkSecurityGroupOutput(args: GetNetworkSecurityGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNetworkSecurityGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230401:getNetworkSecurityGroup", {
        "expand": args.expand,
        "networkSecurityGroupName": args.networkSecurityGroupName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
