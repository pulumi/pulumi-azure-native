...
export class DdosProtectionPlan extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<outputs.network.v20230401.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly virtualNetworks!: pulumi.Output<outputs.network.v20230401.SubResourceResponse[]>;
