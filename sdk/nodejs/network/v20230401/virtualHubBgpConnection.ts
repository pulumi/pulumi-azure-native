...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
     ...
     */
    public readonly hubVirtualNetworkConnection!: pulumi.Output<outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<inputs.network.v20230401.SubResourceArgs>;
    /**
     * Resource ID.
     */
