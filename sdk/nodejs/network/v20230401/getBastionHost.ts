...
export interface GetBastionHostResult {
     ...
     */
    readonly ipConfigurations?: outputs.network.v20230401.BastionHostIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.v20230401.SkuResponse;
    /**
     * Resource tags.
     */
...
export function getBastionHostOutput(args: GetBastionHostOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBastionHostResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230401:getBastionHost", {
        "bastionHostName": args.bastionHostName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
