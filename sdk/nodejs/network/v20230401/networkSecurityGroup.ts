...
export class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly defaultSecurityRules!: pulumi.Output<outputs.network.v20230401.SecurityRuleResponse[]>;
    /**
     ...
     */
    public readonly securityRules!: pulumi.Output<outputs.network.v20230401.SecurityRuleResponse[] | undefined>;
    /**
...
export interface NetworkSecurityGroupArgs {
     ...
     * A collection of security rules of the network security group.
     */
    securityRules?: pulumi.Input<pulumi.Input<inputs.network.v20230401.SecurityRuleArgs>[]>;
    /**
     * Resource tags.
     */
