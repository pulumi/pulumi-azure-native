...
export class WebApplicationFirewallPolicy extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly applicationGateways!: pulumi.Output<outputs.network.v20230401.ApplicationGatewayResponse[]>;
    /**
     * The custom rules inside the policy.
     */
    public readonly customRules!: pulumi.Output<outputs.network.v20230401.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly httpListeners!: pulumi.Output<outputs.network.v20230401.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly managedRules!: pulumi.Output<outputs.network.v20230401.ManagedRulesDefinitionResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly pathBasedRules!: pulumi.Output<outputs.network.v20230401.SubResourceResponse[]>;
    /**
     * The PolicySettings for policy.
     */
    public readonly policySettings!: pulumi.Output<outputs.network.v20230401.PolicySettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WebApplicationFirewallPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["policySettings"] = args ? (args.policySettings ? pulumi.output(args.policySettings).apply(inputs.network.v20230401.policySettingsArgsProvideDefaults) : undefined) : undefined;
