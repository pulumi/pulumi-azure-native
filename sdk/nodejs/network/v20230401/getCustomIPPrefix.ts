...
export interface GetCustomIPPrefixResult {
     ...
     */
    readonly childCustomIpPrefixes: outputs.network.v20230401.SubResourceResponse[];
    /**
     ...
     */
    readonly customIpPrefixParent?: outputs.network.v20230401.SubResourceResponse;
    /**
...
export function getCustomIPPrefixOutput(args: GetCustomIPPrefixOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomIPPrefixResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230401:getCustomIPPrefix", {
        "customIpPrefixName": args.customIpPrefixName,
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
