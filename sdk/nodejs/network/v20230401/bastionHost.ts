...
export class BastionHost extends pulumi.CustomResource {
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20230401.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20230401.SkuResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: BastionHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.network.v20230401.skuArgsProvideDefaults) : undefined) : undefined;
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20230401.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The sku of this Bastion Host.
     */
    sku?: pulumi.Input<inputs.network.v20230401.SkuArgs>;
    /**
     * Resource tags.
     */
