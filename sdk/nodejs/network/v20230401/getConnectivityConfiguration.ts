...
export interface GetConnectivityConfigurationResult {
     ...
     */
    readonly appliesToGroups: outputs.network.v20230401.ConnectivityGroupItemResponse[];
    /**
     ...
     * List of hubItems
     */
    readonly hubs?: outputs.network.v20230401.HubResponse[];
    /**
     * Resource ID.
     */
    readonly id: string;
...
export function getConnectivityConfigurationOutput(args: GetConnectivityConfigurationOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetConnectivityConfigurationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230401:getConnectivityConfiguration", {
        "configurationName": args.configurationName,
        "networkManagerName": args.networkManagerName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
