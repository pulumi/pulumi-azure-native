...
export class VirtualRouter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:VirtualRouter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.VirtualRouterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualRouterState {
     ...
     * Properties of the Virtual Router.
     */
    readonly properties: pulumi.Input<inputs.network.VirtualRouterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualRouterArgs {
     ...
     * Properties of the Virtual Router.
     */
    readonly properties?: pulumi.Input<inputs.network.VirtualRouterPropertiesFormat>;
    /**
