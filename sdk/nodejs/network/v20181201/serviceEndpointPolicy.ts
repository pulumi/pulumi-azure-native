...
export class ServiceEndpointPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181201:ServiceEndpointPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20181201.ServiceEndpointPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ServiceEndpointPolicyArgs {
     ...
     * Properties of the service end point policy
     */
    readonly properties?: pulumi.Input<inputs.network.v20181201.ServiceEndpointPolicyPropertiesFormat>;
    /**
