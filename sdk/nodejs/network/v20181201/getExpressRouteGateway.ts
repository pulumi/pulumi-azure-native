...
export function getExpressRouteGateway(args: GetExpressRouteGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20181201:getExpressRouteGateway", {
        "name": args.name,
...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20181201.ExpressRouteGatewayPropertiesResponse;
    /**
     * Resource tags.
     */
