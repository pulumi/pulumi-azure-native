...
export function getExpressRouteCircuitConnection(args: GetExpressRouteCircuitConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20181201:getExpressRouteCircuitConnection", {
...
export interface GetExpressRouteCircuitConnectionResult {
     ...
     */
    readonly expressRouteCircuitPeering?: outputs.network.v20181201.SubResourceInvokeResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly peerExpressRouteCircuitPeering?: outputs.network.v20181201.SubResourceInvokeResponse;
    /**
