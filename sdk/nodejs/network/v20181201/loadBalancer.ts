...
export class LoadBalancer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20181201:LoadBalancer';
     ...
     */
    public readonly backendAddressPools!: pulumi.Output<outputs.network.v20181201.BackendAddressPoolResponse[] | undefined>;
    /**
     ...
     */
    public readonly frontendIPConfigurations!: pulumi.Output<outputs.network.v20181201.FrontendIPConfigurationResponse[] | undefined>;
    /**
     * Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound Nat rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    public readonly inboundNatPools!: pulumi.Output<outputs.network.v20181201.InboundNatPoolResponse[] | undefined>;
    /**
     * Collection of inbound NAT Rules used by a load balancer. Defining inbound NAT rules on your load balancer is mutually exclusive with defining an inbound NAT pool. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an Inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    public readonly inboundNatRules!: pulumi.Output<outputs.network.v20181201.InboundNatRuleResponse[] | undefined>;
    /**
     * Object collection representing the load balancing rules Gets the provisioning 
     */
    public readonly loadBalancingRules!: pulumi.Output<outputs.network.v20181201.LoadBalancingRuleResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     * The outbound rules.
     */
    public readonly outboundRules!: pulumi.Output<outputs.network.v20181201.OutboundRuleResponse[] | undefined>;
    /**
     * Collection of probe objects used in the load balancer
     */
    public readonly probes!: pulumi.Output<outputs.network.v20181201.ProbeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20181201.LoadBalancerSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface LoadBalancerArgs {
     ...
     * Collection of backend address pools used by a load balancer
     */
    readonly backendAddressPools?: pulumi.Input<pulumi.Input<inputs.network.v20181201.BackendAddressPoolArgs>[]>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * Object representing the frontend IPs to be used for the load balancer
     */
    readonly frontendIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20181201.FrontendIPConfigurationArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound Nat rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    readonly inboundNatPools?: pulumi.Input<pulumi.Input<inputs.network.v20181201.InboundNatPoolArgs>[]>;
    /**
     * Collection of inbound NAT Rules used by a load balancer. Defining inbound NAT rules on your load balancer is mutually exclusive with defining an inbound NAT pool. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an Inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    readonly inboundNatRules?: pulumi.Input<pulumi.Input<inputs.network.v20181201.InboundNatRuleArgs>[]>;
    /**
     ...
     * Object collection representing the load balancing rules Gets the provisioning 
     */
    readonly loadBalancingRules?: pulumi.Input<pulumi.Input<inputs.network.v20181201.LoadBalancingRuleArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The outbound rules.
     */
    readonly outboundRules?: pulumi.Input<pulumi.Input<inputs.network.v20181201.OutboundRuleArgs>[]>;
    /**
     * Collection of probe objects used in the load balancer
     */
    readonly probes?: pulumi.Input<pulumi.Input<inputs.network.v20181201.ProbeArgs>[]>;
    /**
     * Gets the provisioning state of the PublicIP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
     ...
     * The load balancer SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20181201.LoadBalancerSkuArgs>;
    /**
     * Resource tags.
     */
