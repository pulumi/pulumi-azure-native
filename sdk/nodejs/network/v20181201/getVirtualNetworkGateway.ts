...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20181201:getVirtualNetworkGateway", {
        "name": args.name,
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20181201.VirtualNetworkGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
