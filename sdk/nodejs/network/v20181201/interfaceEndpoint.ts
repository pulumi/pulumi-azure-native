...
export class InterfaceEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InterfaceEndpoint {
        pulumi.log.warn("InterfaceEndpoint is deprecated: azure-native:network/v20181201:InterfaceEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190201:InterfaceEndpoint to guarantee forwards compatibility.")
