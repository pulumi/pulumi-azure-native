...
export class InterfaceEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: InterfaceEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20180801:InterfaceEndpoint" }, { type: "azurerm:network/v20181001:InterfaceEndpoint" }, { type: "azurerm:network/v20181101:InterfaceEndpoint" }, { type: "azurerm:network/v20190201:InterfaceEndpoint" }] };
