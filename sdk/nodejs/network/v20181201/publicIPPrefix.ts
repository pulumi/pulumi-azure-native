 ...
 *
 * const publicIPPrefix = new azurerm.network.v20181201.PublicIPPrefix("publicIPPrefix", {
 *     location: "westus",
 *     prefixLength: 30,
...
export class PublicIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20181201:PublicIPPrefix';
...
export interface PublicIPPrefixArgs {
     ...
     * The list of all referenced PublicIPAddresses
     */
    readonly publicIPAddresses?: pulumi.Input<pulumi.Input<inputs.network.v20181201.ReferencedPublicIpAddress>[]>;
    /**
     ...
     * The public IP prefix SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.v20181201.PublicIPPrefixSku>;
    /**
     * Resource tags.
     */
