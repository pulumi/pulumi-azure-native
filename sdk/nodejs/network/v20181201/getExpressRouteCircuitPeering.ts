...
export function getExpressRouteCircuitPeering(args: GetExpressRouteCircuitPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20181201:getExpressRouteCircuitPeering", {
...
export interface GetExpressRouteCircuitPeeringResult {
     ...
     */
    readonly connections?: outputs.network.v20181201.ExpressRouteCircuitConnectionInvokeResponse[];
    /**
     ...
     */
    readonly expressRouteConnection?: outputs.network.v20181201.ExpressRouteConnectionIdInvokeResponse;
    /**
     ...
     */
    readonly peeredConnections: outputs.network.v20181201.PeerExpressRouteCircuitConnectionInvokeResponse[];
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter?: outputs.network.v20181201.RouteFilterInvokeResponse;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    readonly stats?: outputs.network.v20181201.ExpressRouteCircuitStatsInvokeResponse;
    /**
     * The VLAN ID.
     */
