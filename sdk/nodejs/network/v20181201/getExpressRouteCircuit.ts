...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20181201:getExpressRouteCircuit", {
        "name": args.name,
...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly properties: outputs.network.v20181201.ExpressRouteCircuitPropertiesFormatResponse;
    /**
     * The SKU.
     */
