 ...
 *
 * @deprecated azure-native:network/v20181201:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:VirtualNetworkGatewayConnection to guarantee forwards compatibility.
 */
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkGatewayConnection {
        pulumi.log.warn("VirtualNetworkGatewayConnection is deprecated: azure-native:network/v20181201:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:VirtualNetworkGatewayConnection to guarantee forwards compatibility.")
