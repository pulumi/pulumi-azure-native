...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:RouteFilter';
     ...
     */
    public /*out*/ readonly ipv6Peerings!: pulumi.Output<outputs.network.v20220101.ExpressRouteCircuitPeeringResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly peerings!: pulumi.Output<outputs.network.v20220101.ExpressRouteCircuitPeeringResponse[]>;
    /**
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20220101.RouteFilterRuleResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20220101.RouteFilterRuleArgs>[]>;
    /**
     * Resource tags.
     */
