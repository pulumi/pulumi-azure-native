 ...
 *
 * @deprecated azure-native:network/v20220101:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:SecurityAdminConfiguration to guarantee forwards compatibility.
 */
export class SecurityAdminConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityAdminConfiguration {
        pulumi.log.warn("SecurityAdminConfiguration is deprecated: azure-native:network/v20220101:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:SecurityAdminConfiguration to guarantee forwards compatibility.")
        return new SecurityAdminConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:SecurityAdminConfiguration';
...
export interface SecurityAdminConfigurationArgs {
     ...
     * Enum list of network intent policy based services.
     */
    applyOnNetworkIntentPolicyBasedServices?: pulumi.Input<pulumi.Input<string | enums.network.v20220101.NetworkIntentPolicyBasedService>[]>;
    /**
