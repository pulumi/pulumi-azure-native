...
export class StaticMember extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticMember {
        pulumi.log.warn("StaticMember is deprecated: azure-native:network/v20220101:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:StaticMember to guarantee forwards compatibility.")
        return new StaticMember(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:StaticMember';
