...
export class StaticMember extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticMember {
        pulumi.log.warn("StaticMember is deprecated: azure-native:network/v20220101:StaticMember is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:StaticMember to guarantee forwards compatibility.")
