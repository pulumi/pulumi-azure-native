 ...
 *
 * @deprecated azure-native:network/v20220101:IpGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpGroup to guarantee forwards compatibility.
 */
export class IpGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IpGroup {
        pulumi.log.warn("IpGroup is deprecated: azure-native:network/v20220101:IpGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpGroup to guarantee forwards compatibility.")
        return new IpGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:IpGroup';
     ...
     */
    public /*out*/ readonly firewallPolicies!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
     * List of references to Firewall resources that this IpGroups is associated with.
     */
    public /*out*/ readonly firewalls!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
