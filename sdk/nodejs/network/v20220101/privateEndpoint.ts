 ...
 *
 * @deprecated azure-native:network/v20220101:PrivateEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PrivateEndpoint to guarantee forwards compatibility.
 */
export class PrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:PrivateEndpoint';
     ...
     */
    public readonly applicationSecurityGroups!: pulumi.Output<outputs.network.v20220101.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     * An array of custom dns configurations.
     */
    public readonly customDnsConfigs!: pulumi.Output<outputs.network.v20220101.CustomDnsConfigPropertiesFormatResponse[] | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20220101.PrivateEndpointIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly manualPrivateLinkServiceConnections!: pulumi.Output<outputs.network.v20220101.PrivateLinkServiceConnectionResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.network.v20220101.NetworkInterfaceResponse[]>;
    /**
     * A grouping of information about the connection to the remote resource.
     */
    public readonly privateLinkServiceConnections!: pulumi.Output<outputs.network.v20220101.PrivateLinkServiceConnectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly subnet!: pulumi.Output<outputs.network.v20220101.SubnetResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: PrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["subnet"] = args ? (args.subnet ? pulumi.output(args.subnet).apply(inputs.network.v20220101.subnetArgsProvideDefaults) : undefined) : undefined;
...
export interface PrivateEndpointArgs {
     ...
     * An array of custom dns configurations.
     */
    customDnsConfigs?: pulumi.Input<pulumi.Input<inputs.network.v20220101.CustomDnsConfigPropertiesFormatArgs>[]>;
    /**
     * The custom name of the network interface attached to the private endpoint.
     */
     ...
     * A list of IP configurations of the private endpoint. This will be used to map to the First Party Service's endpoints.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20220101.PrivateEndpointIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * A grouping of information about the connection to the remote resource. Used when the network admin does not have access to approve connections to the remote resource.
     */
    manualPrivateLinkServiceConnections?: pulumi.Input<pulumi.Input<inputs.network.v20220101.PrivateLinkServiceConnectionArgs>[]>;
    /**
     ...
     * A grouping of information about the connection to the remote resource.
     */
    privateLinkServiceConnections?: pulumi.Input<pulumi.Input<inputs.network.v20220101.PrivateLinkServiceConnectionArgs>[]>;
    /**
