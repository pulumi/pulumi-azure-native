 ...
 */
/** @deprecated azure-native:network/v20220101:VpnConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnConnection to guarantee forwards compatibility. */
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    pulumi.log.warn("getVpnConnection is deprecated: azure-native:network/v20220101:VpnConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnConnection to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220101:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly remoteVpnSite?: outputs.network.v20220101.SubResourceResponse;
    /**
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    readonly routingConfiguration?: outputs.network.v20220101.RoutingConfigurationResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: outputs.network.v20220101.VpnSiteLinkConnectionResponse[];
}
/**
 * Retrieves the details of a vpn connection.
 */
