 ...
 *
 * @deprecated azure-native:network/v20220101:PacketCapture is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PacketCapture to guarantee forwards compatibility.
 */
export class PacketCapture extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PacketCapture {
        pulumi.log.warn("PacketCapture is deprecated: azure-native:network/v20220101:PacketCapture is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PacketCapture to guarantee forwards compatibility.")
        return new PacketCapture(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:PacketCapture';
     ...
     */
    public readonly filters!: pulumi.Output<outputs.network.v20220101.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    public readonly scope!: pulumi.Output<outputs.network.v20220101.PacketCaptureMachineScopeResponse | undefined>;
    /**
     * The storage location for a packet capture session.
     */
    public readonly storageLocation!: pulumi.Output<outputs.network.v20220101.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * A list of packet capture filters.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.network.v20220101.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * A list of AzureVMSS instances which can be included or excluded to run packet capture. If both included and excluded are empty, then the packet capture will run on all instances of AzureVMSS.
     */
    scope?: pulumi.Input<inputs.network.v20220101.PacketCaptureMachineScopeArgs>;
    /**
     * The storage location for a packet capture session.
     */
    storageLocation: pulumi.Input<inputs.network.v20220101.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
     */
     ...
     * Target type of the resource provided.
     */
    targetType?: pulumi.Input<enums.network.v20220101.PacketCaptureTargetType>;
    /**
     * Maximum duration of the capture session in seconds.
     */
