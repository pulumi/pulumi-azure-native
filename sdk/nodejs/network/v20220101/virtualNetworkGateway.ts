...
export class VirtualNetworkGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20220101.VirtualNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualNetworkGatewayArgs {
     ...
     * Properties of the virtual network gateway.
     */
    properties: pulumi.Input<inputs.network.v20220101.VirtualNetworkGatewayPropertiesFormatArgs>;
    /**
