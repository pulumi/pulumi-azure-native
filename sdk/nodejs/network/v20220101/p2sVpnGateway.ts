 ...
 *
 * @deprecated azure-native:network/v20220101:P2sVpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:P2sVpnGateway to guarantee forwards compatibility.
 */
export class P2sVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:P2sVpnGateway';
     ...
     */
    public readonly p2SConnectionConfigurations!: pulumi.Output<outputs.network.v20220101.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vpnClientConnectionHealth!: pulumi.Output<outputs.network.v20220101.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    public readonly vpnServerConfiguration!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
...
export interface P2sVpnGatewayArgs {
     ...
     * List of all p2s connection configurations of the gateway.
     */
    p2SConnectionConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20220101.P2SConnectionConfigurationArgs>[]>;
    /**
     ...
     * The VpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    vpnServerConfiguration?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
}
