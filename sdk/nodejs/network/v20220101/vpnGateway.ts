 ...
 * VpnGateway Resource.
 *
 * @deprecated azure-native:network/v20220101:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnGateway to guarantee forwards compatibility.
 */
export class VpnGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VpnGateway {
        pulumi.log.warn("VpnGateway is deprecated: azure-native:network/v20220101:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnGateway to guarantee forwards compatibility.")
        return new VpnGateway(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:VpnGateway';
     ...
     */
    public readonly bgpSettings!: pulumi.Output<outputs.network.v20220101.BgpSettingsResponse | undefined>;
    /**
     * List of all vpn connections to the gateway.
     */
    public readonly connections!: pulumi.Output<outputs.network.v20220101.VpnConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.v20220101.VpnGatewayIpConfigurationResponse[]>;
    /**
     ...
     */
    public readonly natRules!: pulumi.Output<outputs.network.v20220101.VpnGatewayNatRuleResponse[] | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     * List of all vpn connections to the gateway.
     */
    connections?: pulumi.Input<pulumi.Input<inputs.network.v20220101.VpnConnectionArgs>[]>;
    /**
     * Enable BGP routes translation for NAT on this VpnGateway.
     */
     ...
     * List of all the nat Rules associated with the gateway.
     */
    natRules?: pulumi.Input<pulumi.Input<inputs.network.v20220101.VpnGatewayNatRuleArgs>[]>;
    /**
