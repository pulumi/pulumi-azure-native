 ...
 *
 * @deprecated azure-native:network/v20220101:NetworkVirtualAppliance is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.
 */
export class NetworkVirtualAppliance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkVirtualAppliance {
        pulumi.log.warn("NetworkVirtualAppliance is deprecated: azure-native:network/v20220101:NetworkVirtualAppliance is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.")
        return new NetworkVirtualAppliance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:NetworkVirtualAppliance';
     ...
     */
    public /*out*/ readonly inboundSecurityRules!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly nvaSku!: pulumi.Output<outputs.network.v20220101.VirtualApplianceSkuPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly virtualApplianceNics!: pulumi.Output<outputs.network.v20220101.VirtualApplianceNicPropertiesResponse[]>;
    /**
     * List of references to VirtualApplianceSite.
     */
    public /*out*/ readonly virtualApplianceSites!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
...
export interface NetworkVirtualApplianceArgs {
     ...
     * Network Virtual Appliance SKU.
     */
    nvaSku?: pulumi.Input<inputs.network.v20220101.VirtualApplianceSkuPropertiesArgs>;
    /**
