...
export class ExpressRouteCircuitAuthorization extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuitAuthorization {
        pulumi.log.warn("ExpressRouteCircuitAuthorization is deprecated: azure-native:network/v20220101:ExpressRouteCircuitAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitAuthorization to guarantee forwards compatibility.")
        return new ExpressRouteCircuitAuthorization(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:ExpressRouteCircuitAuthorization';
