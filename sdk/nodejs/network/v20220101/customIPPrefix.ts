 ...
 *
 * @deprecated azure-native:network/v20220101:CustomIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.
 */
export class CustomIPPrefix extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomIPPrefix {
        pulumi.log.warn("CustomIPPrefix is deprecated: azure-native:network/v20220101:CustomIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.")
