...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:VirtualNetworkPeering';
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.network.v20220101.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    public readonly remoteBgpCommunities!: pulumi.Output<outputs.network.v20220101.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     * The reference to the current address space of the remote virtual network.
     */
    public readonly remoteVirtualNetworkAddressSpace!: pulumi.Output<outputs.network.v20220101.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's encryption
     */
    public /*out*/ readonly remoteVirtualNetworkEncryption!: pulumi.Output<outputs.network.v20220101.VirtualNetworkEncryptionResponse>;
    /**
