 ...
 */
/** @deprecated azure-native:network/v20220101:NetworkGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220401preview:NetworkGroup to guarantee forwards compatibility. */
export function getNetworkGroup(args: GetNetworkGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkGroupResult> {
    pulumi.log.warn("getNetworkGroup is deprecated: azure-native:network/v20220101:NetworkGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220401preview:NetworkGroup to guarantee forwards compatibility.")
