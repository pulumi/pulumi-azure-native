 ...
 *
 * @deprecated azure-native:network/v20220101:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatGateway to guarantee forwards compatibility.
 */
export class NatGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NatGateway {
        pulumi.log.warn("NatGateway is deprecated: azure-native:network/v20220101:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatGateway to guarantee forwards compatibility.")
        return new NatGateway(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:NatGateway';
     ...
     */
    public readonly publicIpAddresses!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[] | undefined>;
    /**
     * An array of public ip prefixes associated with the nat gateway resource.
     */
    public readonly publicIpPrefixes!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[] | undefined>;
    /**
     ...
     * The nat gateway SKU.
     */
    public readonly sku!: pulumi.Output<outputs.network.v20220101.NatGatewaySkuResponse | undefined>;
    /**
     * An array of references to the subnets using this nat gateway resource.
     */
    public /*out*/ readonly subnets!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
     * Resource tags.
     */
