 ...
 *
 * const virtualRouter = new azure_native.network.v20220101.VirtualRouter("virtualRouter", {
 *     hostedGateway: {
...
export class VirtualRouter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:VirtualRouter';
     ...
     */
    public readonly hostedGateway!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    public readonly hostedSubnet!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly peerings!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
...
export interface VirtualRouterArgs {
     ...
     * The Gateway on which VirtualRouter is hosted.
     */
    hostedGateway?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    hostedSubnet?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
    /**
     * Resource ID.
     */
