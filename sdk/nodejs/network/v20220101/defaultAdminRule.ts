 ...
 *
 * @deprecated azure-native:network/v20220101:DefaultAdminRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DefaultAdminRule to guarantee forwards compatibility.
 */
export class DefaultAdminRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:DefaultAdminRule';
     ...
     */
    public /*out*/ readonly destinations!: pulumi.Output<outputs.network.v20220101.AddressPrefixItemResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sources!: pulumi.Output<outputs.network.v20220101.AddressPrefixItemResponse[]>;
    /**
