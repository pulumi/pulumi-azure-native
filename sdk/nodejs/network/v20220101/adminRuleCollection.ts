 ...
 *
 * @deprecated azure-native:network/v20220101:AdminRuleCollection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:AdminRuleCollection to guarantee forwards compatibility.
 */
export class AdminRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:AdminRuleCollection';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20220101.NetworkManagerSecurityGroupItemResponse[]>;
    /**
    ...
    constructor(name: string, args: AdminRuleCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:AdminRuleCollection" }, { type: "azure-native:network/v20210201preview:AdminRuleCollection" }, { type: "azure-native:network/v20210501preview:AdminRuleCollection" }, { type: "azure-native:network/v20220201preview:AdminRuleCollection" }, { type: "azure-native:network/v20220401preview:AdminRuleCollection" }, { type: "azure-native:network/v20220501:AdminRuleCollection" }, { type: "azure-native:network/v20220701:AdminRuleCollection" }, { type: "azure-native:network/v20220901:AdminRuleCollection" }] };
...
export interface AdminRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20220101.NetworkManagerSecurityGroupItemArgs>[]>;
    /**
