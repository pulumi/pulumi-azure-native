...
export class RoutingIntent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:RoutingIntent';
     ...
     */
    public readonly routingPolicies!: pulumi.Output<outputs.network.v20220101.RoutingPolicyResponse[] | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: RoutingIntentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:RoutingIntent" }, { type: "azure-native:network/v20210501:RoutingIntent" }, { type: "azure-native:network/v20210801:RoutingIntent" }, { type: "azure-native:network/v20220501:RoutingIntent" }, { type: "azure-native:network/v20220701:RoutingIntent" }] };
...
export interface RoutingIntentArgs {
     ...
     * List of routing policies.
     */
    routingPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20220101.RoutingPolicyArgs>[]>;
    /**
