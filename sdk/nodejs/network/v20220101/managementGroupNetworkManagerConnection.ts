...
export class ManagementGroupNetworkManagerConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:ManagementGroupNetworkManagerConnection';
