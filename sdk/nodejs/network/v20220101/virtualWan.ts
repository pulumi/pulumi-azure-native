 ...
 * VirtualWAN Resource.
 *
 * @deprecated azure-native:network/v20220101:VirtualWan is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualWan to guarantee forwards compatibility.
 */
export class VirtualWan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualWan {
        pulumi.log.warn("VirtualWan is deprecated: azure-native:network/v20220101:VirtualWan is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualWan to guarantee forwards compatibility.")
        return new VirtualWan(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:VirtualWan';
     ...
     */
    public /*out*/ readonly virtualHubs!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
     * List of VpnSites in the VirtualWAN.
     */
    public /*out*/ readonly vpnSites!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
