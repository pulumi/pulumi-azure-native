 ...
 *
 * @deprecated azure-native:network/v20220101:IpAllocation is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:IpAllocation to guarantee forwards compatibility.
 */
export class IpAllocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:IpAllocation';
     ...
     */
    public /*out*/ readonly subnet!: pulumi.Output<outputs.network.v20220101.SubResourceResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly virtualNetwork!: pulumi.Output<outputs.network.v20220101.SubResourceResponse>;
...
export interface IpAllocationArgs {
     ...
     * The address prefix Type for the IpAllocation.
     */
    prefixType?: pulumi.Input<string | enums.network.v20220101.IPVersion>;
    /**
     ...
     */
    type?: pulumi.Input<string | enums.network.v20220101.IpAllocationType>;
}
