 ...
 *
 * @deprecated azure-native:network/v20220101:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.
 */
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PublicIPAddress {
        pulumi.log.warn("PublicIPAddress is deprecated: azure-native:network/v20220101:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.")
        return new PublicIPAddress(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:PublicIPAddress';
     ...
     */
    public readonly ddosSettings!: pulumi.Output<outputs.network.v20220101.DdosSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly dnsSettings!: pulumi.Output<outputs.network.v20220101.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfiguration!: pulumi.Output<outputs.network.v20220101.IPConfigurationResponse>;
    /**
     ...
     */
    public readonly linkedPublicIPAddress!: pulumi.Output<outputs.network.v20220101.PublicIPAddressResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly publicIPPrefix!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly servicePublicIPAddress!: pulumi.Output<outputs.network.v20220101.PublicIPAddressResponse | undefined>;
    /**
     * The public IP address SKU.
     */
    public readonly sku!: pulumi.Output<outputs.network.v20220101.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
