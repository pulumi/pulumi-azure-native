...
export function getHubRouteTable(args: GetHubRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetHubRouteTableResult> {
    pulumi.log.warn("getHubRouteTable is deprecated: azure-native:network/v20220101:HubRouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:HubRouteTable to guarantee forwards compatibility.")
...
export interface GetHubRouteTableResult {
     ...
     * List of all routes.
     */
    readonly routes?: outputs.network.v20220101.HubRouteResponse[];
    /**
     * Resource type.
     */
