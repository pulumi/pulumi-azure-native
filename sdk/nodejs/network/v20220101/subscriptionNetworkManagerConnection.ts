 ...
 *
 * @deprecated azure-native:network/v20220101:SubscriptionNetworkManagerConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SubscriptionNetworkManagerConnection to guarantee forwards compatibility.
 */
export class SubscriptionNetworkManagerConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubscriptionNetworkManagerConnection {
        pulumi.log.warn("SubscriptionNetworkManagerConnection is deprecated: azure-native:network/v20220101:SubscriptionNetworkManagerConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SubscriptionNetworkManagerConnection to guarantee forwards compatibility.")
