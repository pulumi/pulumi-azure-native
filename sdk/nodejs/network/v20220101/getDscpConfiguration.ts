...
export function getDscpConfiguration(args: GetDscpConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscpConfigurationResult> {
    pulumi.log.warn("getDscpConfiguration is deprecated: azure-native:network/v20220101:DscpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DscpConfiguration to guarantee forwards compatibility.")
...
export interface GetDscpConfigurationResult {
     ...
     */
    readonly associatedNetworkInterfaces: outputs.network.v20220101.NetworkInterfaceResponse[];
    /**
     * Destination IP ranges.
     */
    readonly destinationIpRanges?: outputs.network.v20220101.QosIpRangeResponse[];
    /**
     * Destination port ranges.
     */
    readonly destinationPortRanges?: outputs.network.v20220101.QosPortRangeResponse[];
    /**
     ...
     */
    readonly qosDefinitionCollection?: outputs.network.v20220101.QosDefinitionResponse[];
    /**
     ...
     * Source IP ranges.
     */
    readonly sourceIpRanges?: outputs.network.v20220101.QosIpRangeResponse[];
    /**
     * Sources port ranges.
     */
    readonly sourcePortRanges?: outputs.network.v20220101.QosPortRangeResponse[];
    /**
     * Resource tags.
     */
