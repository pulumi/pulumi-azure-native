...
export class ConnectivityConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectivityConfiguration {
        pulumi.log.warn("ConnectivityConfiguration is deprecated: azure-native:network/v20220101:ConnectivityConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ConnectivityConfiguration to guarantee forwards compatibility.")
        return new ConnectivityConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:ConnectivityConfiguration';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20220101.ConnectivityGroupItemResponse[]>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<outputs.network.v20220101.HubResponse[] | undefined>;
    /**
...
export interface ConnectivityConfigurationArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20220101.ConnectivityGroupItemArgs>[]>;
    /**
     ...
     * Connectivity topology type.
     */
    connectivityTopology: pulumi.Input<string | enums.network.v20220101.ConnectivityTopology>;
    /**
     * Flag if need to remove current existing peerings.
     */
    deleteExistingPeering?: pulumi.Input<string | enums.network.v20220101.DeleteExistingPeering>;
    /**
     * A description of the connectivity configuration.
     */
     ...
     * List of hubItems
     */
    hubs?: pulumi.Input<pulumi.Input<inputs.network.v20220101.HubArgs>[]>;
    /**
     * Flag if global mesh is supported.
     */
