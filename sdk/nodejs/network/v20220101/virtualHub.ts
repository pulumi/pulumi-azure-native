 ...
 * VirtualHub Resource.
 *
 * @deprecated azure-native:network/v20220101:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHub to guarantee forwards compatibility.
 */
export class VirtualHub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHub {
        pulumi.log.warn("VirtualHub is deprecated: azure-native:network/v20220101:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHub to guarantee forwards compatibility.")
        return new VirtualHub(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220101:VirtualHub';
     ...
     */
    public readonly azureFirewall!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     * List of references to Bgp Connections.
     */
    public /*out*/ readonly bgpConnections!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly expressRouteGateway!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.v20220101.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly p2SVpnGateway!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly routeTable!: pulumi.Output<outputs.network.v20220101.VirtualHubRouteTableResponse | undefined>;
    /**
     * The routing state.
     */
     ...
     */
    public readonly securityPartnerProvider!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly virtualHubRouteTableV2s!: pulumi.Output<outputs.network.v20220101.VirtualHubRouteTableV2Response[] | undefined>;
    /**
     * VirtualRouter ASN.
     */
     ...
     */
    public readonly virtualRouterAutoScaleConfiguration!: pulumi.Output<outputs.network.v20220101.VirtualRouterAutoScaleConfigurationResponse | undefined>;
    /**
     * VirtualRouter IPs.
     */
     ...
     */
    public readonly virtualWan!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
    /**
     * The VpnGateway associated with this VirtualHub.
     */
    public readonly vpnGateway!: pulumi.Output<outputs.network.v20220101.SubResourceResponse | undefined>;
...
export interface VirtualHubArgs {
     ...
     * The azureFirewall associated with this VirtualHub.
     */
    azureFirewall?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
    /**
     * The expressRouteGateway associated with this VirtualHub.
     */
    expressRouteGateway?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
    /**
     * The hubRoutingPreference of this VirtualHub.
     */
    hubRoutingPreference?: pulumi.Input<string | enums.network.v20220101.HubRoutingPreference>;
    /**
     * Resource ID.
     */
     ...
     * The P2SVpnGateway associated with this VirtualHub.
     */
    p2SVpnGateway?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
    /**
     * The preferred gateway to route on-prem traffic
     */
    preferredRoutingGateway?: pulumi.Input<string | enums.network.v20220101.PreferredRoutingGateway>;
    /**
     ...
     * The routeTable associated with this virtual hub.
     */
    routeTable?: pulumi.Input<inputs.network.v20220101.VirtualHubRouteTableArgs>;
    /**
     * The securityPartnerProvider associated with this VirtualHub.
     */
    securityPartnerProvider?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
    /**
     * The Security Provider name.
     */
     ...
     * List of all virtual hub route table v2s associated with this VirtualHub.
     */
    virtualHubRouteTableV2s?: pulumi.Input<pulumi.Input<inputs.network.v20220101.VirtualHubRouteTableV2Args>[]>;
    /**
     * VirtualRouter ASN.
     */
     ...
     * The VirtualHub Router autoscale configuration.
     */
    virtualRouterAutoScaleConfiguration?: pulumi.Input<inputs.network.v20220101.VirtualRouterAutoScaleConfigurationArgs>;
    /**
     * VirtualRouter IPs.
     */
     ...
     * The VirtualWAN to which the VirtualHub belongs.
     */
    virtualWan?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
    /**
     * The VpnGateway associated with this VirtualHub.
     */
    vpnGateway?: pulumi.Input<inputs.network.v20220101.SubResourceArgs>;
}
