...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/latest:VirtualHubBgpConnection';
    ...
    constructor(name: string, argsOrState?: VirtualHubBgpConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/preview:VirtualHubBgpConnection" }, { type: "azurerm:network/v20200501:VirtualHubBgpConnection" }, { type: "azurerm:network/v20200601:VirtualHubBgpConnection" }] };
