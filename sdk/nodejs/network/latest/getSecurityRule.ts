...
export function getSecurityRule(args: GetSecurityRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/latest:getSecurityRule", {
...
export interface GetSecurityRuleResult {
     ...
     */
    readonly destinationApplicationSecurityGroups?: outputs.network.latest.ApplicationSecurityGroupResponse[];
    /**
     ...
     */
    readonly sourceApplicationSecurityGroups?: outputs.network.latest.ApplicationSecurityGroupResponse[];
    /**
