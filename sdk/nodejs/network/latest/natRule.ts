...
export class NatRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NatRule {
        pulumi.log.warn("NatRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:network:NatRule'.")
        return new NatRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/latest:NatRule';
     ...
     */
    public /*out*/ readonly egressVpnSiteLinkConnections!: pulumi.Output<outputs.network.latest.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly externalMappings!: pulumi.Output<outputs.network.latest.VpnNatRuleMappingResponse[] | undefined>;
    /**
     * List of ingress VpnSiteLinkConnections.
     */
    public /*out*/ readonly ingressVpnSiteLinkConnections!: pulumi.Output<outputs.network.latest.SubResourceResponse[]>;
    /**
     * The private IP address internal mapping for NAT.
     */
    public readonly internalMappings!: pulumi.Output<outputs.network.latest.VpnNatRuleMappingResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: NatRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if ((!args || args.natRuleName === undefined) && !(opts && opts.urn)) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:NatRule" }, { type: "azure-nextgen:network/v20200801:NatRule" }] };
...
export interface NatRuleArgs {
     ...
     * The private IP address external mapping for NAT.
     */
    readonly externalMappings?: pulumi.Input<pulumi.Input<inputs.network.latest.VpnNatRuleMapping>[]>;
    /**
     ...
     * The private IP address internal mapping for NAT.
     */
    readonly internalMappings?: pulumi.Input<pulumi.Input<inputs.network.latest.VpnNatRuleMapping>[]>;
    /**
     * The IP Configuration ID this NAT rule applies to.
     */
     ...
     * The Source NAT direction of a VPN NAT.
     */
    readonly mode?: pulumi.Input<string | enums.network.latest.VpnNatRuleMode>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     */
    readonly type?: pulumi.Input<string | enums.network.latest.VpnNatRuleType>;
}
