...
export interface SecurityPartnerProviderArgs {
     ...
     * The security provider name.
     */
    readonly securityProviderName?: pulumi.Input<string | enums.network.latest.SecurityProviderName>;
    /**
     * Resource tags.
     */
