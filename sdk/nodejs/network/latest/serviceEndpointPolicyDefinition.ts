...
export class ServiceEndpointPolicyDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/latest:ServiceEndpointPolicyDefinition';
