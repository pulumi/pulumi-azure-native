...
export class Experiment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExperimentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:Experiment" }, { type: "azure-nextgen:network:Experiment" }, { type: "azure-native:network/v20191101:Experiment" }, { type: "azure-nextgen:network/v20191101:Experiment" }] };
