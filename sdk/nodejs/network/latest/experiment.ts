...
export class Experiment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Experiment {
        pulumi.log.warn("Experiment is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:Experiment'.")
        return new Experiment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:Experiment';
     ...
     */
    public readonly endpointA!: pulumi.Output<outputs.network.latest.ExperimentEndpointResponse | undefined>;
    /**
     * The endpoint B of an experiment
     */
    public readonly endpointB!: pulumi.Output<outputs.network.latest.ExperimentEndpointResponse | undefined>;
    /**
     * Resource location.
     */
    ...
    constructor(name: string, args: ExperimentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/latest:Experiment" }, { type: "azure-native:network:Experiment" }, { type: "azure-nextgen:network:Experiment" }, { type: "azure-native:network/v20191101:Experiment" }, { type: "azure-nextgen:network/v20191101:Experiment" }] };
...
export interface ExperimentArgs {
     ...
     * The endpoint A of an experiment
     */
    readonly endpointA?: pulumi.Input<inputs.network.latest.ExperimentEndpoint>;
    /**
     * The endpoint B of an experiment
     */
    readonly endpointB?: pulumi.Input<inputs.network.latest.ExperimentEndpoint>;
    /**
