...
export class LoadBalancer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:LoadBalancer';
     ...
     */
    public readonly backendAddressPools!: pulumi.Output<outputs.network.latest.BackendAddressPoolResponse[] | undefined>;
    /**
     ...
     */
    public readonly frontendIPConfigurations!: pulumi.Output<outputs.network.latest.FrontendIPConfigurationResponse[] | undefined>;
    /**
     * Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound Nat rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    public readonly inboundNatPools!: pulumi.Output<outputs.network.latest.InboundNatPoolResponse[] | undefined>;
    /**
     * Collection of inbound NAT Rules used by a load balancer. Defining inbound NAT rules on your load balancer is mutually exclusive with defining an inbound NAT pool. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an Inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    public readonly inboundNatRules!: pulumi.Output<outputs.network.latest.InboundNatRuleResponse[] | undefined>;
    /**
     * Object collection representing the load balancing rules Gets the provisioning.
     */
    public readonly loadBalancingRules!: pulumi.Output<outputs.network.latest.LoadBalancingRuleResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     * The outbound rules.
     */
    public readonly outboundRules!: pulumi.Output<outputs.network.latest.OutboundRuleResponse[] | undefined>;
    /**
     * Collection of probe objects used in the load balancer.
     */
    public readonly probes!: pulumi.Output<outputs.network.latest.ProbeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.latest.LoadBalancerSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface LoadBalancerArgs {
     ...
     * Object representing the frontend IPs to be used for the load balancer.
     */
    readonly frontendIPConfigurations?: pulumi.Input<pulumi.Input<inputs.network.latest.FrontendIPConfiguration>[]>;
    /**
     * Resource ID.
     */
     ...
     * Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound Nat rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    readonly inboundNatPools?: pulumi.Input<pulumi.Input<inputs.network.latest.InboundNatPool>[]>;
    /**
     * Collection of inbound NAT Rules used by a load balancer. Defining inbound NAT rules on your load balancer is mutually exclusive with defining an inbound NAT pool. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an Inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    readonly inboundNatRules?: pulumi.Input<pulumi.Input<inputs.network.latest.InboundNatRule>[]>;
    /**
     ...
     * Object collection representing the load balancing rules Gets the provisioning.
     */
    readonly loadBalancingRules?: pulumi.Input<pulumi.Input<inputs.network.latest.LoadBalancingRule>[]>;
    /**
     * Resource location.
     */
     ...
     * The outbound rules.
     */
    readonly outboundRules?: pulumi.Input<pulumi.Input<inputs.network.latest.OutboundRule>[]>;
    /**
     * Collection of probe objects used in the load balancer.
     */
    readonly probes?: pulumi.Input<pulumi.Input<inputs.network.latest.Probe>[]>;
    /**
     ...
     * The load balancer SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.latest.LoadBalancerSku>;
    /**
     * Resource tags.
     */
