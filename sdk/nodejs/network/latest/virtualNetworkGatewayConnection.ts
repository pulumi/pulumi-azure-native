...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:VirtualNetworkGatewayConnection';
     ...
     */
    public readonly ipsecPolicies!: pulumi.Output<outputs.network.latest.IpsecPolicyResponse[] | undefined>;
    /**
     * The reference to local network gateway resource.
     */
    public readonly localNetworkGateway2!: pulumi.Output<outputs.network.latest.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly peer!: pulumi.Output<outputs.network.latest.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly tunnelConnectionStatus!: pulumi.Output<outputs.network.latest.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    public readonly virtualNetworkGateway1!: pulumi.Output<outputs.network.latest.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    public readonly virtualNetworkGateway2!: pulumi.Output<outputs.network.latest.VirtualNetworkGatewayResponse | undefined>;
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * The IPSec Policies to be considered by this connection.
     */
    readonly ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.latest.IpsecPolicy>[]>;
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: pulumi.Input<inputs.network.latest.LocalNetworkGateway>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    readonly peer?: pulumi.Input<inputs.network.latest.SubResource>;
    /**
     ...
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway1: pulumi.Input<inputs.network.latest.VirtualNetworkGateway>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: pulumi.Input<inputs.network.latest.VirtualNetworkGateway>;
    /**
