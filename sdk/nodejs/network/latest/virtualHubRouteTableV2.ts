...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:VirtualHubRouteTableV2';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.latest.VirtualHubRouteV2Response[] | undefined>;
...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputs.network.latest.VirtualHubRouteV2>[]>;
    /**
