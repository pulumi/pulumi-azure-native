 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ExpressRouteCrossConnectionPeering'.
 */
export class ExpressRouteCrossConnectionPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:ExpressRouteCrossConnectionPeering';
     ...
     */
    public readonly ipv6PeeringConfig!: pulumi.Output<outputs.network.latest.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    public readonly microsoftPeeringConfig!: pulumi.Output<outputs.network.latest.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
...
export interface ExpressRouteCrossConnectionPeeringArgs {
     ...
     * The IPv6 peering configuration.
     */
    readonly ipv6PeeringConfig?: pulumi.Input<inputs.network.latest.Ipv6ExpressRouteCircuitPeeringConfig>;
    /**
     * The Microsoft peering configuration.
     */
    readonly microsoftPeeringConfig?: pulumi.Input<inputs.network.latest.ExpressRouteCircuitPeeringConfig>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    readonly peeringType?: pulumi.Input<string | enums.network.latest.ExpressRoutePeeringType>;
    /**
     * The primary address prefix.
     */
     ...
     * The peering state.
     */
    readonly state?: pulumi.Input<string | enums.network.latest.ExpressRoutePeeringState>;
    /**
     * The VLAN ID.
     */
