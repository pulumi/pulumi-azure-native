...
export class IpAllocation extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IpAllocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20200301:IpAllocation" }, { type: "azurerm:network/v20200401:IpAllocation" }, { type: "azurerm:network/v20200501:IpAllocation" }, { type: "azurerm:network/v20200601:IpAllocation" }] };
