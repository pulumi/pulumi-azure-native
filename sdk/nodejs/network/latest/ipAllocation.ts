...
export class IpAllocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/latest:IpAllocation';
     ...
     */
    public /*out*/ readonly subnet!: pulumi.Output<outputs.network.latest.SubResourceResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly virtualNetwork!: pulumi.Output<outputs.network.latest.SubResourceResponse>;
    ...
    constructor(name: string, args: IpAllocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/preview:IpAllocation" }, { type: "azurerm:network/v20200301:IpAllocation" }, { type: "azurerm:network/v20200401:IpAllocation" }, { type: "azurerm:network/v20200501:IpAllocation" }, { type: "azurerm:network/v20200601:IpAllocation" }] };
