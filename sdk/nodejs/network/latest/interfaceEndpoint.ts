...
export class InterfaceEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/latest:InterfaceEndpoint';
    ...
    constructor(name: string, argsOrState?: InterfaceEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/preview:InterfaceEndpoint" }, { type: "azurerm:network/v20180801:InterfaceEndpoint" }, { type: "azurerm:network/v20181001:InterfaceEndpoint" }, { type: "azurerm:network/v20181101:InterfaceEndpoint" }, { type: "azurerm:network/v20181201:InterfaceEndpoint" }, { type: "azurerm:network/v20190201:InterfaceEndpoint" }] };
