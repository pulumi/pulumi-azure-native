 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:DdosProtectionPlan'.
 */
export class DdosProtectionPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:DdosProtectionPlan';
     ...
     */
    public /*out*/ readonly virtualNetworks!: pulumi.Output<outputs.network.latest.SubResourceResponse[]>;
