...
export class VpnConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:VpnConnection';
     ...
     */
    public readonly remoteVpnSite!: pulumi.Output<outputs.network.latest.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly vpnLinkConnections!: pulumi.Output<outputs.network.latest.VpnSiteLinkConnectionResponse[] | undefined>;
...
export interface VpnConnectionArgs {
     ...
     * Id of the connected vpn site.
     */
    readonly remoteVpnSite?: pulumi.Input<inputs.network.latest.SubResource>;
    /**
     ...
     * Connection protocol used for this connection.
     */
    readonly vpnConnectionProtocolType?: pulumi.Input<string | enums.network.latest.VirtualNetworkGatewayConnectionProtocol>;
    /**
     * List of all vpn site link connections to the gateway.
     */
    readonly vpnLinkConnections?: pulumi.Input<pulumi.Input<inputs.network.latest.VpnSiteLinkConnection>[]>;
}
