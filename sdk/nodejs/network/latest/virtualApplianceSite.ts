...
export class VirtualApplianceSite extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VirtualApplianceSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/preview:VirtualApplianceSite" }, { type: "azurerm:network/v20200501:VirtualApplianceSite" }, { type: "azurerm:network/v20200601:VirtualApplianceSite" }] };
