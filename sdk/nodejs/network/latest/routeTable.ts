...
export class RouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/latest:RouteTable';
     ...
     */
    public readonly routes!: pulumi.Output<outputs.network.latest.RouteResponse[] | undefined>;
    /**
...
export interface RouteTableArgs {
     ...
     * Collection of routes contained within a route table.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputs.network.latest.Route>[]>;
    /**
     * Resource tags.
     */
