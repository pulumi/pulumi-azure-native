...
export class FirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:FirewallPolicy';
...
export interface FirewallPolicyArgs {
     ...
     * The operation mode for Threat Intelligence.
     */
    readonly threatIntelMode?: pulumi.Input<string | enums.network.latest.AzureFirewallThreatIntelMode>;
    /**
     * ThreatIntel Whitelist for Firewall Policy.
     */
