...
export class DdosCustomPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:DdosCustomPolicy';
     ...
     */
    public readonly protocolCustomSettings!: pulumi.Output<outputs.network.latest.ProtocolCustomSettingsFormatResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<outputs.network.latest.SubResourceResponse[]>;
    /**
...
export interface DdosCustomPolicyArgs {
     ...
     * The protocol-specific DDoS policy customization parameters.
     */
    readonly protocolCustomSettings?: pulumi.Input<pulumi.Input<inputs.network.latest.ProtocolCustomSettingsFormat>[]>;
    /**
