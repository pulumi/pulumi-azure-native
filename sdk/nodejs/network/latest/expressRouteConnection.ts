...
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:ExpressRouteConnection';
