...
export class AzureFirewall extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/latest:AzureFirewall';
     ...
     */
    public readonly applicationRuleCollections!: pulumi.Output<outputs.network.latest.AzureFirewallApplicationRuleCollectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly hubIPAddresses!: pulumi.Output<outputs.network.latest.HubIPAddressesResponse | undefined>;
    /**
     * IP configuration of the Azure Firewall resource.
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.latest.AzureFirewallIPConfigurationResponse[] | undefined>;
    /**
     * IpGroups associated with AzureFirewall.
     */
    public /*out*/ readonly ipGroups!: pulumi.Output<outputs.network.latest.AzureFirewallIpGroupsResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly managementIpConfiguration!: pulumi.Output<outputs.network.latest.AzureFirewallIPConfigurationResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly natRuleCollections!: pulumi.Output<outputs.network.latest.AzureFirewallNatRuleCollectionResponse[] | undefined>;
    /**
     * Collection of network rule collections used by Azure Firewall.
     */
    public readonly networkRuleCollections!: pulumi.Output<outputs.network.latest.AzureFirewallNetworkRuleCollectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.latest.AzureFirewallSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface AzureFirewallArgs {
     ...
     * Collection of application rule collections used by Azure Firewall.
     */
    readonly applicationRuleCollections?: pulumi.Input<pulumi.Input<inputs.network.latest.AzureFirewallApplicationRuleCollection>[]>;
    /**
     ...
     * IP addresses associated with AzureFirewall.
     */
    readonly hubIPAddresses?: pulumi.Input<inputs.network.latest.HubIPAddresses>;
    /**
     * Resource ID.
     */
     ...
     * IP configuration of the Azure Firewall resource.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.latest.AzureFirewallIPConfiguration>[]>;
    /**
     * Resource location.
     */
     ...
     * IP configuration of the Azure Firewall used for management traffic.
     */
    readonly managementIpConfiguration?: pulumi.Input<inputs.network.latest.AzureFirewallIPConfiguration>;
    /**
     * Collection of NAT rule collections used by Azure Firewall.
     */
    readonly natRuleCollections?: pulumi.Input<pulumi.Input<inputs.network.latest.AzureFirewallNatRuleCollection>[]>;
    /**
     * Collection of network rule collections used by Azure Firewall.
     */
    readonly networkRuleCollections?: pulumi.Input<pulumi.Input<inputs.network.latest.AzureFirewallNetworkRuleCollection>[]>;
    /**
     ...
     * The Azure Firewall Resource SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.latest.AzureFirewallSku>;
    /**
     * Resource tags.
     */
