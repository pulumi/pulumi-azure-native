...
export class HubRouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/latest:HubRouteTable';
     ...
     */
    public /*out*/ readonly associatedConnections!: pulumi.Output<outputs.network.latest.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly propagatingConnections!: pulumi.Output<outputs.network.latest.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: HubRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/preview:HubRouteTable" }, { type: "azurerm:network/v20200401:HubRouteTable" }, { type: "azurerm:network/v20200501:HubRouteTable" }, { type: "azurerm:network/v20200601:HubRouteTable" }] };
