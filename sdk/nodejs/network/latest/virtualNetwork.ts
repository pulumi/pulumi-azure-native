...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:VirtualNetwork';
     ...
     */
    public readonly addressSpace!: pulumi.Output<outputs.network.latest.AddressSpaceResponse | undefined>;
    /**
     * Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
     */
    public readonly bgpCommunities!: pulumi.Output<outputs.network.latest.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    public readonly ddosProtectionPlan!: pulumi.Output<outputs.network.latest.SubResourceResponse | undefined>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    public readonly dhcpOptions!: pulumi.Output<outputs.network.latest.DhcpOptionsResponse | undefined>;
    /**
     ...
     */
    public readonly subnets!: pulumi.Output<outputs.network.latest.SubnetResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetworkPeerings!: pulumi.Output<outputs.network.latest.VirtualNetworkPeeringResponse[] | undefined>;
...
export interface VirtualNetworkArgs {
     ...
     * The AddressSpace that contains an array of IP address ranges that can be used by subnets.
     */
    readonly addressSpace?: pulumi.Input<inputs.network.latest.AddressSpace>;
    /**
     * Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
     */
    readonly bgpCommunities?: pulumi.Input<inputs.network.latest.VirtualNetworkBgpCommunities>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    readonly ddosProtectionPlan?: pulumi.Input<inputs.network.latest.SubResource>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    readonly dhcpOptions?: pulumi.Input<inputs.network.latest.DhcpOptions>;
    /**
     * Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
     */
     ...
     * A list of subnets in a Virtual Network.
     */
    readonly subnets?: pulumi.Input<pulumi.Input<inputs.network.latest.Subnet>[]>;
    /**
     * Resource tags.
     */
     ...
     * A list of peerings in a Virtual Network.
     */
    readonly virtualNetworkPeerings?: pulumi.Input<pulumi.Input<inputs.network.latest.VirtualNetworkPeering>[]>;
}
