 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualNetworkPeering'.
 */
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:VirtualNetworkPeering';
     ...
     */
    public readonly remoteBgpCommunities!: pulumi.Output<outputs.network.latest.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The reference to the remote virtual network's Bgp Communities.
     */
    readonly remoteBgpCommunities?: pulumi.Input<inputs.network.latest.VirtualNetworkBgpCommunities>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
