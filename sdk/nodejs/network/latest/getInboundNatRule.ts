...
export function getInboundNatRule(args: GetInboundNatRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetInboundNatRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/latest:getInboundNatRule", {
        "expand": args.expand,
...
export interface GetInboundNatRuleResult {
     ...
     */
    readonly backendIPConfiguration: outputs.network.latest.NetworkInterfaceIPConfigurationResponse;
    /**
     ...
     */
    readonly frontendIPConfiguration?: outputs.network.latest.SubResourceResponse;
    /**
