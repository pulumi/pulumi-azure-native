...
export class NetworkExperimentProfile extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkExperimentProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/latest:NetworkExperimentProfile" }, { type: "azure-native:network:NetworkExperimentProfile" }, { type: "azure-nextgen:network:NetworkExperimentProfile" }, { type: "azure-native:network/v20191101:NetworkExperimentProfile" }, { type: "azure-nextgen:network/v20191101:NetworkExperimentProfile" }] };
