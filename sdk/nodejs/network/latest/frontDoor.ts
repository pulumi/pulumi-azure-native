...
export class FrontDoor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:FrontDoor';
     ...
     */
    public readonly backendPools!: pulumi.Output<outputs.network.latest.BackendPoolResponse[] | undefined>;
    /**
     * Settings for all backendPools
     */
    public readonly backendPoolsSettings!: pulumi.Output<outputs.network.latest.BackendPoolsSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly frontendEndpoints!: pulumi.Output<outputs.network.latest.FrontendEndpointResponse[] | undefined>;
    /**
     * Health probe settings associated with this Front Door instance.
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.network.latest.HealthProbeSettingsModelResponse[] | undefined>;
    /**
     * Load balancing settings associated with this Front Door instance.
     */
    public readonly loadBalancingSettings!: pulumi.Output<outputs.network.latest.LoadBalancingSettingsModelResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly routingRules!: pulumi.Output<outputs.network.latest.RoutingRuleResponse[] | undefined>;
    /**
     * Rules Engine Configurations available to routing rules.
     */
    public /*out*/ readonly rulesEngines!: pulumi.Output<outputs.network.latest.RulesEngineResponse[]>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: FrontDoorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:FrontDoor" }, { type: "azure-nextgen:network:FrontDoor" }, { type: "azure-native:network/v20180801:FrontDoor" }, { type: "azure-nextgen:network/v20180801:FrontDoor" }, { type: "azure-native:network/v20190401:FrontDoor" }, { type: "azure-nextgen:network/v20190401:FrontDoor" }, { type: "azure-native:network/v20190501:FrontDoor" }, { type: "azure-nextgen:network/v20190501:FrontDoor" }, { type: "azure-native:network/v20200101:FrontDoor" }, { type: "azure-nextgen:network/v20200101:FrontDoor" }, { type: "azure-native:network/v20200401:FrontDoor" }, { type: "azure-nextgen:network/v20200401:FrontDoor" }, { type: "azure-native:network/v20200501:FrontDoor" }, { type: "azure-nextgen:network/v20200501:FrontDoor" }] };
...
export interface FrontDoorArgs {
     ...
     * Backend pools available to routing rules.
     */
    readonly backendPools?: pulumi.Input<pulumi.Input<inputs.network.latest.BackendPool>[]>;
    /**
     * Settings for all backendPools
     */
    readonly backendPoolsSettings?: pulumi.Input<inputs.network.latest.BackendPoolsSettings>;
    /**
     * Operational status of the Front Door load balancer. Permitted values are 'Enabled' or 'Disabled'
     */
    readonly enabledState?: pulumi.Input<string | enums.network.latest.FrontDoorEnabledState>;
    /**
     * A friendly name for the frontDoor
     */
     ...
     * Frontend endpoints available to routing rules.
     */
    readonly frontendEndpoints?: pulumi.Input<pulumi.Input<inputs.network.latest.FrontendEndpoint>[]>;
    /**
     * Health probe settings associated with this Front Door instance.
     */
    readonly healthProbeSettings?: pulumi.Input<pulumi.Input<inputs.network.latest.HealthProbeSettingsModel>[]>;
    /**
     * Load balancing settings associated with this Front Door instance.
     */
    readonly loadBalancingSettings?: pulumi.Input<pulumi.Input<inputs.network.latest.LoadBalancingSettingsModel>[]>;
    /**
     * Resource location.
     */
     ...
     * Routing rules associated with this Front Door.
     */
    readonly routingRules?: pulumi.Input<pulumi.Input<inputs.network.latest.RoutingRule>[]>;
    /**
     * Resource tags.
     */
