...
export class CustomIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:CustomIPPrefix';
     ...
     */
    public /*out*/ readonly publicIpPrefixes!: pulumi.Output<outputs.network.latest.SubResourceResponse[]>;
    /**
...
export interface CustomIPPrefixArgs {
     ...
     * The commissioned state of the Custom IP Prefix.
     */
    readonly commissionedState?: pulumi.Input<string | enums.network.latest.CommissionedState>;
    /**
