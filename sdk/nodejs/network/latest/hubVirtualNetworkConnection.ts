...
export class HubVirtualNetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/latest:HubVirtualNetworkConnection';
    ...
    constructor(name: string, args: HubVirtualNetworkConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/preview:HubVirtualNetworkConnection" }, { type: "azurerm:network/v20200501:HubVirtualNetworkConnection" }, { type: "azurerm:network/v20200601:HubVirtualNetworkConnection" }] };
