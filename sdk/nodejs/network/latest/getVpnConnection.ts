...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/latest:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly remoteVpnSite?: outputs.network.latest.SubResourceResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: outputs.network.latest.VpnSiteLinkConnectionResponse[];
}
