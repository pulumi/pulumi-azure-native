...
export class VirtualHubIpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/latest:VirtualHubIpConfiguration';
     ...
     */
    public readonly publicIPAddress!: pulumi.Output<outputs.network.latest.PublicIPAddressResponse | undefined>;
    /**
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    readonly privateIPAllocationMethod?: pulumi.Input<string | enums.network.latest.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    readonly publicIPAddress?: pulumi.Input<inputs.network.latest.PublicIPAddress>;
    /**
