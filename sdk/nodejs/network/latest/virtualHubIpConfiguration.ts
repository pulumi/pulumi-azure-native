...
export class VirtualHubIpConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VirtualHubIpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as VirtualHubIpConfigurationArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/preview:VirtualHubIpConfiguration" }, { type: "azurerm:network/v20200501:VirtualHubIpConfiguration" }, { type: "azurerm:network/v20200601:VirtualHubIpConfiguration" }] };
