 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:network:VpnSite'.
 */
export class VpnSite extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VpnSite {
        pulumi.log.warn("VpnSite is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:network:VpnSite'.")
        return new VpnSite(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/latest:VpnSite';
     ...
     */
    public readonly bgpProperties!: pulumi.Output<outputs.network.latest.BgpSettingsResponse | undefined>;
    /**
     * The device properties.
     */
    public readonly deviceProperties!: pulumi.Output<outputs.network.latest.DevicePropertiesResponse | undefined>;
    /**
     ...
     * Office365 Policy.
     */
    public readonly o365Policy!: pulumi.Output<outputs.network.latest.O365PolicyPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly vpnSiteLinks!: pulumi.Output<outputs.network.latest.VpnSiteLinkResponse[] | undefined>;
...
export interface VpnSiteArgs {
     ...
     * The set of bgp properties.
     */
    readonly bgpProperties?: pulumi.Input<inputs.network.latest.BgpSettings>;
    /**
     * The device properties.
     */
    readonly deviceProperties?: pulumi.Input<inputs.network.latest.DeviceProperties>;
    /**
     * Resource ID.
     */
     ...
     * Office365 Policy.
     */
    readonly o365Policy?: pulumi.Input<inputs.network.latest.O365PolicyProperties>;
    /**
     ...
     * List of all vpn site links.
     */
    readonly vpnSiteLinks?: pulumi.Input<pulumi.Input<inputs.network.latest.VpnSiteLink>[]>;
    /**
