...
export class RecordSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:RecordSet';
    ...
    constructor(name: string, args: RecordSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200601:RecordSet" }, { type: "azure-native:network:RecordSet" }, { type: "azure-nextgen:network:RecordSet" }, { type: "azure-native:network/latest:RecordSet" }, { type: "azure-nextgen:network/latest:RecordSet" }, { type: "azure-native:network/v20180901:RecordSet" }, { type: "azure-nextgen:network/v20180901:RecordSet" }, { type: "azure-native:network/v20200101:RecordSet" }, { type: "azure-nextgen:network/v20200101:RecordSet" }] };
...
export interface RecordSetArgs {
     ...
     * The list of A records in the record set.
     */
    readonly aRecords?: pulumi.Input<pulumi.Input<inputs.network.v20200601.ARecord>[]>;
    /**
     * The list of AAAA records in the record set.
     */
    readonly aaaaRecords?: pulumi.Input<pulumi.Input<inputs.network.v20200601.AaaaRecord>[]>;
    /**
     * The CNAME record in the record set.
     */
    readonly cnameRecord?: pulumi.Input<inputs.network.v20200601.CnameRecord>;
    /**
     * The ETag of the record set.
     */
     ...
     * The list of MX records in the record set.
     */
    readonly mxRecords?: pulumi.Input<pulumi.Input<inputs.network.v20200601.MxRecord>[]>;
    /**
     ...
     * The list of PTR records in the record set.
     */
    readonly ptrRecords?: pulumi.Input<pulumi.Input<inputs.network.v20200601.PtrRecord>[]>;
    /**
     ...
     * The SOA record in the record set.
     */
    readonly soaRecord?: pulumi.Input<inputs.network.v20200601.SoaRecord>;
    /**
     * The list of SRV records in the record set.
     */
    readonly srvRecords?: pulumi.Input<pulumi.Input<inputs.network.v20200601.SrvRecord>[]>;
    /**
     * The TTL (time-to-live) of the records in the record set.
     */
     ...
     * The list of TXT records in the record set.
     */
    readonly txtRecords?: pulumi.Input<pulumi.Input<inputs.network.v20200601.TxtRecord>[]>;
}
