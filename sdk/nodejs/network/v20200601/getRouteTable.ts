...
export function getRouteTable(args: GetRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteTableResult> {
    pulumi.log.warn("getRouteTable is deprecated: azure-native:network/v20200601:RouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteTable to guarantee forwards compatibility.")
