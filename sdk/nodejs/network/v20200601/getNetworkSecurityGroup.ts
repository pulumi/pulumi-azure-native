...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    pulumi.log.warn("getNetworkSecurityGroup is deprecated: azure-native:network/v20200601:NetworkSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkSecurityGroup to guarantee forwards compatibility.")
