...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200601:getNetworkSecurityGroup", {
        "expand": args.expand,
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules: outputs.network.v20200601.SecurityRuleInvokeResponse[];
    /**
     ...
     */
    readonly flowLogs: outputs.network.v20200601.FlowLogInvokeResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly securityRules?: outputs.network.v20200601.SecurityRuleInvokeResponse[];
    /**
