...
export class HubRouteTable extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HubRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:HubRouteTable" }, { type: "azurerm:network/preview:HubRouteTable" }, { type: "azurerm:network/v20200401:HubRouteTable" }, { type: "azurerm:network/v20200501:HubRouteTable" }] };
