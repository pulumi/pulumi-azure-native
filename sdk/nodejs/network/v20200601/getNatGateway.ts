...
export function getNatGateway(args: GetNatGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetNatGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200601:getNatGateway", {
        "expand": args.expand,
...
export interface GetNatGatewayResult {
     ...
     * The nat gateway SKU.
     */
    readonly sku?: outputs.network.v20200601.NatGatewaySkuInvokeResponse;
    /**
     * An array of references to the subnets using this nat gateway resource.
     */
    readonly subnets: outputs.network.v20200601.SubResourceInvokeResponse[];
    /**
     * Resource tags.
     */
