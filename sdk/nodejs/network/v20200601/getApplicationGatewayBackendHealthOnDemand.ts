...
export function getApplicationGatewayBackendHealthOnDemand(args: GetApplicationGatewayBackendHealthOnDemandArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGatewayBackendHealthOnDemandResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200601:getApplicationGatewayBackendHealthOnDemand", {
...
export interface GetApplicationGatewayBackendHealthOnDemandArgs {
     ...
     */
    readonly backendAddressPool?: inputs.network.v20200601.SubResourceInvoke;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    readonly backendHttpSettings?: inputs.network.v20200601.SubResourceInvoke;
    /**
     ...
     */
    readonly match?: inputs.network.v20200601.ApplicationGatewayProbeHealthResponseMatchInvoke;
    /**
     ...
     */
    readonly protocol?: string | enums.network.v20200601.ApplicationGatewayProtocol;
    /**
...
export interface GetApplicationGatewayBackendHealthOnDemandResult {
     ...
     */
    readonly backendAddressPool?: outputs.network.v20200601.ApplicationGatewayBackendAddressPoolInvokeResponse;
    /**
     * Application gateway BackendHealthHttp settings.
     */
    readonly backendHealthHttpSettings?: outputs.network.v20200601.ApplicationGatewayBackendHealthHttpSettingsInvokeResponse;
}
