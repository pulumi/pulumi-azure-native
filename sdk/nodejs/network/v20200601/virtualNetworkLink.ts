...
export class VirtualNetworkLink extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200601:VirtualNetworkLink" }, { type: "azure-native:network:VirtualNetworkLink" }, { type: "azure-nextgen:network:VirtualNetworkLink" }, { type: "azure-native:network/v20180901:VirtualNetworkLink" }, { type: "azure-nextgen:network/v20180901:VirtualNetworkLink" }, { type: "azure-native:network/v20200101:VirtualNetworkLink" }, { type: "azure-nextgen:network/v20200101:VirtualNetworkLink" }] };
...
export interface VirtualNetworkLinkArgs {
     ...
     * The reference of the virtual network.
     */
    readonly virtualNetwork?: pulumi.Input<inputs.network.v20200601.SubResourceArgs>;
    /**
