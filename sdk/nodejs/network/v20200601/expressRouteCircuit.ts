...
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuit {
        pulumi.log.warn("ExpressRouteCircuit is deprecated: azure-native:network/v20200601:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuit to guarantee forwards compatibility.")
