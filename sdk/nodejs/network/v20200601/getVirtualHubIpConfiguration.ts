 ...
 */
/** @deprecated azure-native:network/v20200601:VirtualHubIpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHubIpConfiguration to guarantee forwards compatibility. */
export function getVirtualHubIpConfiguration(args: GetVirtualHubIpConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualHubIpConfigurationResult> {
    pulumi.log.warn("getVirtualHubIpConfiguration is deprecated: azure-native:network/v20200601:VirtualHubIpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHubIpConfiguration to guarantee forwards compatibility.")
