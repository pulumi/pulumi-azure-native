...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:VirtualHubRouteTableV2';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.v20200601.VirtualHubRouteV2Response[] | undefined>;
...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputs.network.v20200601.VirtualHubRouteV2Args>[]>;
    /**
