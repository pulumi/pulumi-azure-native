 ...
 *
 * const hubVirtualNetworkConnection = new azurerm.network.v20200601.HubVirtualNetworkConnection("hubVirtualNetworkConnection", {
...
export class HubVirtualNetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200601:HubVirtualNetworkConnection';
    ...
    constructor(name: string, argsOrState?: HubVirtualNetworkConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:HubVirtualNetworkConnection" }, { type: "azurerm:network/v20200501:HubVirtualNetworkConnection" }] };
