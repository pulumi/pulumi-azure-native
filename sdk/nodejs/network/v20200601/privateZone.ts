...
export class PrivateZone extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateZoneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20180901:PrivateZone" }, { type: "azure-native:network/v20200101:PrivateZone" }, { type: "azure-native:network/v20240601:PrivateZone" }, { type: "azure-native:network:PrivateZone" }] };
