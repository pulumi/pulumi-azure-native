 ...
 */
/** @deprecated azure-native:network/v20200601:DscpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility. */
export function getDscpConfiguration(args: GetDscpConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscpConfigurationResult> {
    pulumi.log.warn("getDscpConfiguration is deprecated: azure-native:network/v20200601:DscpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.")
