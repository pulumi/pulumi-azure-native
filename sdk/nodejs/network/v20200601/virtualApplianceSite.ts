...
export class VirtualApplianceSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200601:VirtualApplianceSite';
    ...
    constructor(name: string, argsOrState?: VirtualApplianceSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VirtualApplianceSite" }, { type: "azurerm:network/preview:VirtualApplianceSite" }, { type: "azurerm:network/v20200501:VirtualApplianceSite" }] };
