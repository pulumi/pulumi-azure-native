...
export class DdosCustomPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20200601:DdosCustomPolicy';
