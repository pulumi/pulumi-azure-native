...
export function getBastionHost(args: GetBastionHostArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionHostResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200601:getBastionHost", {
...
export interface GetBastionHostResult {
     ...
     */
    readonly ipConfigurations?: outputs.network.v20200601.BastionHostIPConfigurationInvokeResponse[];
    /**
     * Resource location.
     */
