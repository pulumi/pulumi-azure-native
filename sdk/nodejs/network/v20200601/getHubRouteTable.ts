...
export function getHubRouteTable(args: GetHubRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetHubRouteTableResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200601:getHubRouteTable", {
...
export interface GetHubRouteTableResult {
     ...
     */
    readonly associatedConnections: outputs.network.v20200601.SubResourceResponse[];
    /**
     ...
     */
    readonly propagatingConnections: outputs.network.v20200601.SubResourceResponse[];
    /**
