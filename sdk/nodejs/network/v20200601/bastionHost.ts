...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20200601:BastionHost';
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20200601.BastionHostIPConfiguration>[]>;
    /**
     * Resource location.
     */
