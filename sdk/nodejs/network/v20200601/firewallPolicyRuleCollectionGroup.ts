 ...
 *
 * const firewallPolicyRuleCollectionGroup = new azurerm.network.v20200601.FirewallPolicyRuleCollectionGroup("firewallPolicyRuleCollectionGroup", {
...
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200601:FirewallPolicyRuleCollectionGroup';
    ...
    constructor(name: string, args: FirewallPolicyRuleCollectionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:FirewallPolicyRuleCollectionGroup" }, { type: "azurerm:network/v20200501:FirewallPolicyRuleCollectionGroup" }] };
