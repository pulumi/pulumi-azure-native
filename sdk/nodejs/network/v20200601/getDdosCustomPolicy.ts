...
export function getDdosCustomPolicy(args: GetDdosCustomPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosCustomPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200601:getDdosCustomPolicy", {
...
export interface GetDdosCustomPolicyResult {
     ...
     */
    readonly protocolCustomSettings?: outputs.network.v20200601.ProtocolCustomSettingsFormatInvokeResponse[];
    /**
     ...
     */
    readonly publicIPAddresses: outputs.network.v20200601.SubResourceInvokeResponse[];
    /**
