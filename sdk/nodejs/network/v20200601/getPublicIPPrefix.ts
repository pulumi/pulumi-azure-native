 ...
 */
/** @deprecated azure-native:network/v20200601:PublicIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PublicIPPrefix to guarantee forwards compatibility. */
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    pulumi.log.warn("getPublicIPPrefix is deprecated: azure-native:network/v20200601:PublicIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PublicIPPrefix to guarantee forwards compatibility.")
