...
export class IpGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IpGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:IpGroup" }, { type: "azurerm:network/preview:IpGroup" }, { type: "azurerm:network/v20190901:IpGroup" }, { type: "azurerm:network/v20191101:IpGroup" }, { type: "azurerm:network/v20191201:IpGroup" }, { type: "azurerm:network/v20200301:IpGroup" }, { type: "azurerm:network/v20200401:IpGroup" }, { type: "azurerm:network/v20200501:IpGroup" }] };
