...
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PrivateDnsZoneGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20200301:PrivateDnsZoneGroup" }, { type: "azurerm:network/v20200401:PrivateDnsZoneGroup" }, { type: "azurerm:network/v20200501:PrivateDnsZoneGroup" }] };
