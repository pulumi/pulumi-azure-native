 ...
 *
 * const virtualHubBgpConnection = new azurerm.network.v20200601.VirtualHubBgpConnection("virtualHubBgpConnection", {
...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHubBgpConnection {
        return new VirtualHubBgpConnection(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20200601:VirtualHubBgpConnection';
