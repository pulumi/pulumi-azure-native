 ...
 *
 * @deprecated azure-native:network/v20200601:IpAllocation is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:IpAllocation to guarantee forwards compatibility.
 */
export class IpAllocation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IpAllocation {
        pulumi.log.warn("IpAllocation is deprecated: azure-native:network/v20200601:IpAllocation is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:IpAllocation to guarantee forwards compatibility.")
        return new IpAllocation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:IpAllocation';
     ...
     */
    public /*out*/ readonly subnet!: pulumi.Output<outputs.network.v20200601.SubResourceResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly virtualNetwork!: pulumi.Output<outputs.network.v20200601.SubResourceResponse>;
...
export interface IpAllocationArgs {
     ...
     * The address prefix Type for the IpAllocation.
     */
    prefixType?: pulumi.Input<string | enums.network.v20200601.IPVersion>;
    /**
     ...
     */
    type?: pulumi.Input<string | enums.network.v20200601.IpAllocationType>;
}
