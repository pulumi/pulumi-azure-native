...
export class SecurityPartnerProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:SecurityPartnerProvider';
...
export interface SecurityPartnerProviderArgs {
     ...
     * The security provider name.
     */
    readonly securityProviderName?: pulumi.Input<string | enums.network.v20200601.SecurityProviderName>;
    /**
     * Resource tags.
     */
