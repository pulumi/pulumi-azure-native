...
export function getExpressRouteConnection(args: GetExpressRouteConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20200601:getExpressRouteConnection", {
...
export interface GetExpressRouteConnectionResult {
     ...
     */
    readonly expressRouteCircuitPeering: outputs.network.v20200601.ExpressRouteCircuitPeeringIdInvokeResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly routingConfiguration?: outputs.network.v20200601.RoutingConfigurationInvokeResponse;
    /**
