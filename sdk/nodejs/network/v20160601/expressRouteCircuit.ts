...
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20160601:ExpressRouteCircuit';
