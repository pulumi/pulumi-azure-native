...
export class DdosCustomPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosCustomPolicyState, opts?: pulumi.CustomResourceOptions): DdosCustomPolicy {
        return new DdosCustomPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:DdosCustomPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.DdosCustomPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: DdosCustomPolicyArgs | DdosCustomPolicyState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as DdosCustomPolicyState | undefined;
 ...
 * A DDoS custom policy in a resource group.
 */
export interface DdosCustomPolicyState {
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * Properties of the DDoS custom policy.
     */
    readonly properties: pulumi.Input<inputs.network.DdosCustomPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface DdosCustomPolicyArgs {
     ...
     * Properties of the DDoS custom policy.
     */
    readonly properties?: pulumi.Input<inputs.network.DdosCustomPolicyPropertiesFormat>;
    /**
