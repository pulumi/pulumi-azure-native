...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180201:getVirtualNetwork", {
        "name": args.name,
...
export interface GetVirtualNetworkResult {
     ...
     */
    readonly properties: outputs.network.v20180201.VirtualNetworkPropertiesFormatResponse;
    /**
     * Resource tags.
     */
