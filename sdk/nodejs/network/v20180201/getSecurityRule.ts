...
export function getSecurityRule(args: GetSecurityRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180201:getSecurityRule", {
        "name": args.name,
...
export interface GetSecurityRuleResult {
     ...
     */
    readonly properties: outputs.network.v20180201.SecurityRulePropertiesFormatResponse;
}
