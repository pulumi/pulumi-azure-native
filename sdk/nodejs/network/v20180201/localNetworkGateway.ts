 ...
 *
 * const localNetworkGateway = new azurerm.network.v20180201.LocalNetworkGateway("localNetworkGateway", {
...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180201:LocalNetworkGateway';
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    readonly localNetworkAddressSpace?: pulumi.Input<inputs.network.v20180201.AddressSpace>;
    /**
