...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalNetworkGateway {
        pulumi.log.warn("LocalNetworkGateway is deprecated: Version 2018-02-01 will be removed in v2 of the provider.")
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180201.LocalNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Properties of the local network gateway.
     */
    properties: pulumi.Input<inputs.network.v20180201.LocalNetworkGatewayPropertiesFormatArgs>;
    /**
