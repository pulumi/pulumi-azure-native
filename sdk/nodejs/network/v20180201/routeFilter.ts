...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180201:RouteFilter';
     ...
     * Route Filter Resource
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180201.RouteFilterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Route Filter Resource
     */
    readonly properties?: pulumi.Input<inputs.network.v20180201.RouteFilterPropertiesFormat>;
    /**
