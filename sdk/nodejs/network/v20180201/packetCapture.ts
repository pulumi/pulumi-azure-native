 ...
 *
 * const packetCapture = new azurerm.network.v20180201.PacketCapture("packetCapture", {
...
export class PacketCapture extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180201:PacketCapture';
...
export interface PacketCaptureArgs {
    ...
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.v20180201.PacketCaptureFilter>[]>;
    /**
     ...
     * Describes the storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.v20180201.PacketCaptureStorageLocation>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
