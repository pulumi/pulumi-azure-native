...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180201:ExpressRouteCircuitPeering';
