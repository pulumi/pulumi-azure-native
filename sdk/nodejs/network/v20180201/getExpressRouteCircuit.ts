...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180201:getExpressRouteCircuit", {
...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly authorizations?: outputs.network.v20180201.ExpressRouteCircuitAuthorizationInvokeResponse[];
    /**
     ...
     */
    readonly serviceProviderProperties?: outputs.network.v20180201.ExpressRouteCircuitServiceProviderPropertiesInvokeResponse;
    /**
     ...
     * The SKU.
     */
    readonly sku?: outputs.network.v20180201.ExpressRouteCircuitSkuInvokeResponse;
    /**
     * Resource tags.
     */
