...
export class IpAllocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:IpAllocation';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.IpAllocationPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface IpAllocationState {
     ...
     * Properties of the IpAllocation.
     */
    readonly properties: pulumi.Input<inputs.network.IpAllocationPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface IpAllocationArgs {
     ...
     * Properties of the IpAllocation.
     */
    readonly properties?: pulumi.Input<inputs.network.IpAllocationPropertiesFormat>;
    /**
