...
export class RulesEngine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:RulesEngine';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.RulesEnginePropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface RulesEngineArgs {
     ...
     * Properties of the Rules Engine Configuration.
     */
    readonly properties?: pulumi.Input<inputs.network.RulesEngineProperties>;
    /**
