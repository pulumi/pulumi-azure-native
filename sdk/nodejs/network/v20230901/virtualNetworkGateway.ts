...
export class VirtualNetworkGateway extends pulumi.CustomResource {
     ...
     */
    public readonly autoScaleConfiguration!: pulumi.Output<outputs.network.v20230901.VirtualNetworkGatewayAutoScaleConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly customRoutes!: pulumi.Output<outputs.network.v20230901.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    public readonly gatewayDefaultSite!: pulumi.Output<outputs.network.v20230901.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20230901.VirtualNetworkGatewayIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly natRules!: pulumi.Output<outputs.network.v20230901.VirtualNetworkGatewayNatRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20230901.VirtualNetworkGatewaySkuResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetworkGatewayPolicyGroups!: pulumi.Output<outputs.network.v20230901.VirtualNetworkGatewayPolicyGroupResponse[] | undefined>;
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    public readonly vpnClientConfiguration!: pulumi.Output<outputs.network.v20230901.VpnClientConfigurationResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayArgs {
     ...
     * Property to indicate if the Express Route Gateway serves traffic when there are multiple Express Route Gateways in the vnet
     */
    adminState?: pulumi.Input<string | enums.network.v20230901.AdminState>;
    /**
     * Configure this gateway to accept traffic from other Azure Virtual Networks. This configuration does not support connectivity to Azure Virtual WAN.
     */
     ...
     * Autoscale configuration for virutal network gateway
     */
    autoScaleConfiguration?: pulumi.Input<inputs.network.v20230901.VirtualNetworkGatewayAutoScaleConfigurationArgs>;
    /**
     * Virtual network gateway's BGP speaker settings.
     */
     ...
     * The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
     */
    customRoutes?: pulumi.Input<inputs.network.v20230901.AddressSpaceArgs>;
    /**
     * disableIPSecReplayProtection flag.
     */
     ...
     * The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    gatewayDefaultSite?: pulumi.Input<inputs.network.v20230901.SubResourceArgs>;
    /**
     * The type of this virtual network gateway.
     */
    gatewayType?: pulumi.Input<string | enums.network.v20230901.VirtualNetworkGatewayType>;
    /**
     * Resource ID.
     */
     ...
     * IP configurations for virtual network gateway.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20230901.VirtualNetworkGatewayIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     */
    natRules?: pulumi.Input<pulumi.Input<inputs.network.v20230901.VirtualNetworkGatewayNatRuleArgs>[]>;
    /**
     ...
     * The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
     */
    sku?: pulumi.Input<inputs.network.v20230901.VirtualNetworkGatewaySkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * The reference to the VirtualNetworkGatewayPolicyGroup resource which represents the available VirtualNetworkGatewayPolicyGroup for the gateway.
     */
    virtualNetworkGatewayPolicyGroups?: pulumi.Input<pulumi.Input<inputs.network.v20230901.VirtualNetworkGatewayPolicyGroupArgs>[]>;
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    vpnClientConfiguration?: pulumi.Input<inputs.network.v20230901.VpnClientConfigurationArgs>;
    /**
     * The generation for this VirtualNetworkGateway. Must be None if gatewayType is not VPN.
     */
    vpnGatewayGeneration?: pulumi.Input<string | enums.network.v20230901.VpnGatewayGeneration>;
    /**
     * The type of this virtual network gateway.
     */
    vpnType?: pulumi.Input<string | enums.network.v20230901.VpnType>;
}
