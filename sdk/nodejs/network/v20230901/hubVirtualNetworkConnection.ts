...
export class HubVirtualNetworkConnection extends pulumi.CustomResource {
     ...
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.network.v20230901.SubResourceResponse | undefined>;
    /**
...
export interface HubVirtualNetworkConnectionArgs {
     ...
     * Reference to the remote virtual network.
     */
    remoteVirtualNetwork?: pulumi.Input<inputs.network.v20230901.SubResourceArgs>;
    /**
