...
export interface GetP2sVpnGatewayP2sVpnConnectionHealthResult {
     ...
     */
    readonly p2SConnectionConfigurations?: outputs.network.v20230901.P2SConnectionConfigurationResponse[];
    /**
     ...
     */
    readonly vpnClientConnectionHealth: outputs.network.v20230901.VpnClientConnectionHealthResponse;
    /**
     ...
     */
    readonly vpnServerConfiguration?: outputs.network.v20230901.SubResourceResponse;
}
/**
 * Gets the connection health of P2S clients of the virtual wan P2SVpnGateway in the specified resource group.
 */
export function getP2sVpnGatewayP2sVpnConnectionHealthOutput(args: GetP2sVpnGatewayP2sVpnConnectionHealthOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetP2sVpnGatewayP2sVpnConnectionHealthResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230901:getP2sVpnGatewayP2sVpnConnectionHealth", {
        "gatewayName": args.gatewayName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
