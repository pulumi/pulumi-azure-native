...
export interface GetCustomIPPrefixResult {
     ...
     */
    readonly childCustomIpPrefixes: outputs.network.v20230901.SubResourceResponse[];
    /**
     ...
     */
    readonly customIpPrefixParent?: outputs.network.v20230901.SubResourceResponse;
    /**
     ...
     */
    readonly publicIpPrefixes: outputs.network.v20230901.SubResourceResponse[];
    /**
...
export function getCustomIPPrefixOutput(args: GetCustomIPPrefixOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCustomIPPrefixResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230901:getCustomIPPrefix", {
        "customIpPrefixName": args.customIpPrefixName,
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
