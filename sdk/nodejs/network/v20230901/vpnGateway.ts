...
export class VpnGateway extends pulumi.CustomResource {
     ...
     */
    public readonly connections!: pulumi.Output<outputs.network.v20230901.VpnConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.v20230901.VpnGatewayIpConfigurationResponse[]>;
    /**
     ...
     */
    public readonly natRules!: pulumi.Output<outputs.network.v20230901.VpnGatewayNatRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.v20230901.SubResourceResponse | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<inputs.network.v20230901.VpnConnectionArgs>[]>;
    /**
     * Enable BGP routes translation for NAT on this VpnGateway.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    natRules?: pulumi.Input<pulumi.Input<inputs.network.v20230901.VpnGatewayNatRuleArgs>[]>;
    /**
     ...
     * The VirtualHub to which the gateway belongs.
     */
    virtualHub?: pulumi.Input<inputs.network.v20230901.SubResourceArgs>;
    /**
     * The scale unit for this vpn gateway.
     */
