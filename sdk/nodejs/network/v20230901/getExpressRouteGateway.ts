...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly autoScaleConfiguration?: outputs.network.v20230901.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration;
    /**
     ...
     */
    readonly expressRouteConnections?: outputs.network.v20230901.ExpressRouteConnectionResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly virtualHub: outputs.network.v20230901.VirtualHubIdResponse;
}
/**
 * Fetches the details of a ExpressRoute gateway in a resource group.
 */
export function getExpressRouteGatewayOutput(args: GetExpressRouteGatewayOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetExpressRouteGatewayResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230901:getExpressRouteGateway", {
        "expressRouteGatewayName": args.expressRouteGatewayName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
