...
export interface GetApplicationGatewayBackendHealthOnDemandArgs {
     ...
     */
    backendAddressPool?: inputs.network.v20230901.SubResource;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: inputs.network.v20230901.SubResource;
    /**
     ...
     */
    match?: inputs.network.v20230901.ApplicationGatewayProbeHealthResponseMatch;
    /**
     ...
     */
    protocol?: string | enums.network.v20230901.ApplicationGatewayProtocol;
    /**
...
export interface GetApplicationGatewayBackendHealthOnDemandResult {
     ...
     */
    readonly backendAddressPool?: outputs.network.v20230901.ApplicationGatewayBackendAddressPoolResponse;
    /**
     * Application gateway BackendHealthHttp settings.
     */
    readonly backendHealthHttpSettings?: outputs.network.v20230901.ApplicationGatewayBackendHealthHttpSettingsResponse;
}
/**
 * Gets the backend health for given combination of backend pool and http setting of the specified application gateway in a resource group.
 */
export function getApplicationGatewayBackendHealthOnDemandOutput(args: GetApplicationGatewayBackendHealthOnDemandOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplicationGatewayBackendHealthOnDemandResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230901:getApplicationGatewayBackendHealthOnDemand", {
        "applicationGatewayName": args.applicationGatewayName,
        "backendAddressPool": args.backendAddressPool,
        "backendHttpSettings": args.backendHttpSettings,
        "expand": args.expand,
...
export interface GetApplicationGatewayBackendHealthOnDemandOutputArgs {
     ...
     * Reference to backend pool of application gateway to which probe request will be sent.
     */
    backendAddressPool?: pulumi.Input<inputs.network.v20230901.SubResourceArgs>;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: pulumi.Input<inputs.network.v20230901.SubResourceArgs>;
    /**
     * Expands BackendAddressPool and BackendHttpSettings referenced in backend health.
     */
     ...
     * Criterion for classifying a healthy probe response.
     */
    match?: pulumi.Input<inputs.network.v20230901.ApplicationGatewayProbeHealthResponseMatchArgs>;
    /**
     * Relative path of probe. Valid path starts from '/'. Probe is sent to <Protocol>://<host>:<port><path>.
     */
     ...
     * The protocol used for the probe.
     */
    protocol?: pulumi.Input<string | enums.network.v20230901.ApplicationGatewayProtocol>;
    /**
     * The name of the resource group.
     */
