...
export interface GetRouteFilterResult {
     ...
     */
    readonly ipv6Peerings: outputs.network.v20230901.ExpressRouteCircuitPeeringResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly peerings: outputs.network.v20230901.ExpressRouteCircuitPeeringResponse[];
    /**
     ...
     */
    readonly rules?: outputs.network.v20230901.RouteFilterRuleResponse[];
    /**
     * Resource tags.
     */
...
export function getRouteFilterOutput(args: GetRouteFilterOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRouteFilterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230901:getRouteFilter", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "routeFilterName": args.routeFilterName,
    }, opts);
