...
export class ExpressRouteConnection extends pulumi.CustomResource {
     ...
     */
    public readonly expressRouteCircuitPeering!: pulumi.Output<outputs.network.v20230901.ExpressRouteCircuitPeeringIdResponse>;
    /**
...
export interface ExpressRouteConnectionArgs {
     ...
     * The ExpressRoute circuit peering.
     */
    expressRouteCircuitPeering: pulumi.Input<inputs.network.v20230901.ExpressRouteCircuitPeeringIdArgs>;
    /**
     * Enable FastPath to vWan Firewall hub.
     */
