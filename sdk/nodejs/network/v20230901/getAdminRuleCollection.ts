...
export interface GetAdminRuleCollectionResult {
     ...
     */
    readonly appliesToGroups: outputs.network.v20230901.NetworkManagerSecurityGroupItemResponse[];
    /**
...
export function getAdminRuleCollectionOutput(args: GetAdminRuleCollectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAdminRuleCollectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230901:getAdminRuleCollection", {
        "configurationName": args.configurationName,
        "networkManagerName": args.networkManagerName,
        "resourceGroupName": args.resourceGroupName,
        "ruleCollectionName": args.ruleCollectionName,
