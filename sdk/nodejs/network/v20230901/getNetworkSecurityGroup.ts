...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules: outputs.network.v20230901.SecurityRuleResponse[];
    /**
     ...
     */
    readonly flowLogs: outputs.network.v20230901.FlowLogResponse[];
    /**
     ...
     */
    readonly networkInterfaces: outputs.network.v20230901.NetworkInterfaceResponse[];
    /**
     ...
     */
    readonly securityRules?: outputs.network.v20230901.SecurityRuleResponse[];
    /**
...
export function getNetworkSecurityGroupOutput(args: GetNetworkSecurityGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNetworkSecurityGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230901:getNetworkSecurityGroup", {
        "expand": args.expand,
        "networkSecurityGroupName": args.networkSecurityGroupName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
