...
export interface ExpressRouteCircuitAuthorizationArgs {
     ...
     * The authorization use status.
     */
    authorizationUseStatus?: pulumi.Input<string | enums.network.v20230901.AuthorizationUseStatus>;
    /**
