...
export class IpamPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101preview:IpamPool';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20240101preview.IpamPoolPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: IpamPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:IpamPool" }, { type: "azure-native:network/v20240501:IpamPool" }] };
...
export interface IpamPoolArgs {
     ...
     * Properties of IpamPool resource properties which are specific to the Pool resource.
     */
    properties: pulumi.Input<inputs.network.v20240101preview.IpamPoolPropertiesArgs>;
    /**
