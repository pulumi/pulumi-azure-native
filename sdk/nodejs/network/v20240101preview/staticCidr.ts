...
export class StaticCidr extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101preview:StaticCidr';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20240101preview.StaticCidrPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: StaticCidrArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20240501:StaticCidr" }, { type: "azure-native:network:StaticCidr" }] };
