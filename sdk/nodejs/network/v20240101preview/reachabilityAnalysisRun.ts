...
export class ReachabilityAnalysisRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101preview:ReachabilityAnalysisRun';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20240101preview.ReachabilityAnalysisRunPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ReachabilityAnalysisRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ReachabilityAnalysisRun" }] };
...
export interface ReachabilityAnalysisRunArgs {
     ...
     * Represents the Reachability Analysis Run properties.
     */
    properties: pulumi.Input<inputs.network.v20240101preview.ReachabilityAnalysisRunPropertiesArgs>;
    /**
