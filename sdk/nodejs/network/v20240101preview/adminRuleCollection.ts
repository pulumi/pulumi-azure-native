...
export class AdminRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101preview:AdminRuleCollection';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20240101preview.NetworkManagerSecurityGroupItemResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.network.v20240101preview.SystemDataResponse>;
    /**
...
export interface AdminRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20240101preview.NetworkManagerSecurityGroupItemArgs>[]>;
    /**
