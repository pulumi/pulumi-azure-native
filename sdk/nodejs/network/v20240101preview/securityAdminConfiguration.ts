...
export class SecurityAdminConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240101preview:SecurityAdminConfiguration';
...
export interface SecurityAdminConfigurationArgs {
     ...
     * Enum list of network intent policy based services.
     */
    applyOnNetworkIntentPolicyBasedServices?: pulumi.Input<pulumi.Input<string | enums.network.v20240101preview.NetworkIntentPolicyBasedService>[]>;
    /**
     ...
     * Determine update behavior for changes to network groups referenced within the rules in this configuration.
     */
    networkGroupAddressSpaceAggregationOption?: pulumi.Input<string | enums.network.v20240101preview.AddressSpaceAggregationOption>;
    /**
