...
azure-native:network/v20180101:ExpressRouteCircuit is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20181201:ExpressRouteCircuit to guarantee forwards compatibility. */
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    pulumi.log.warn("getExpressRouteCircuit is deprecated: Version 2018-01-01 will be removed in v2 of the provider.\nazure-native:network/v20180101:ExpressRouteCircuit is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20181201:ExpressRouteCircuit to guarantee forwards compatibility.")
