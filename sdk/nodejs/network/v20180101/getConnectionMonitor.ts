...
export function getConnectionMonitor(args: GetConnectionMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionMonitorResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180101:getConnectionMonitor", {
        "name": args.name,
...
export interface GetConnectionMonitorResult {
     ...
     */
    readonly properties: outputs.network.v20180101.ConnectionMonitorResultPropertiesResponse;
    /**
