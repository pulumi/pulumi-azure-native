 ...
 *
 * const route = new azurerm.network.v20180101.Route("route", {
...
export class Route extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180101:Route';
