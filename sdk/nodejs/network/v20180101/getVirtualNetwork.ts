...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180101:getVirtualNetwork", {
        "expand": args.expand,
...
export interface GetVirtualNetworkResult {
     ...
     */
    readonly addressSpace?: outputs.network.v20180101.AddressSpaceInvokeResponse;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    readonly dhcpOptions?: outputs.network.v20180101.DhcpOptionsInvokeResponse;
    /**
     ...
     */
    readonly virtualNetworkPeerings?: outputs.network.v20180101.VirtualNetworkPeeringInvokeResponse[];
}
