...
export function getApplicationGateway(args: GetApplicationGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180101:getApplicationGateway", {
        "name": args.name,
...
export interface GetApplicationGatewayResult {
     ...
     */
    readonly properties: outputs.network.v20180101.ApplicationGatewayPropertiesFormatResponse;
    /**
     * Resource tags.
     */
