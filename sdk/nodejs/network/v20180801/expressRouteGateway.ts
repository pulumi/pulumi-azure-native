...
export class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20180801.ExpressRouteGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ExpressRouteGatewayArgs {
     ...
     * ExpressRoute gateway resource properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20180801.ExpressRouteGatewayProperties>;
    /**
