 ...
 *
 * const packetCapture = new azurerm.network.v20180801.PacketCapture("packetCapture", {
...
export class PacketCapture extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180801:PacketCapture';
    ...
    constructor(name: string, args: PacketCaptureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:PacketCapture" }, { type: "azurerm:network/v20160901:PacketCapture" }, { type: "azurerm:network/v20161201:PacketCapture" }, { type: "azurerm:network/v20170301:PacketCapture" }, { type: "azurerm:network/v20170601:PacketCapture" }, { type: "azurerm:network/v20170801:PacketCapture" }, { type: "azurerm:network/v20170901:PacketCapture" }, { type: "azurerm:network/v20171001:PacketCapture" }, { type: "azurerm:network/v20171101:PacketCapture" }, { type: "azurerm:network/v20180101:PacketCapture" }, { type: "azurerm:network/v20180201:PacketCapture" }, { type: "azurerm:network/v20180401:PacketCapture" }, { type: "azurerm:network/v20180601:PacketCapture" }, { type: "azurerm:network/v20180701:PacketCapture" }, { type: "azurerm:network/v20181001:PacketCapture" }, { type: "azurerm:network/v20181101:PacketCapture" }, { type: "azurerm:network/v20181201:PacketCapture" }, { type: "azurerm:network/v20190201:PacketCapture" }, { type: "azurerm:network/v20190401:PacketCapture" }, { type: "azurerm:network/v20190601:PacketCapture" }, { type: "azurerm:network/v20190701:PacketCapture" }, { type: "azurerm:network/v20190801:PacketCapture" }, { type: "azurerm:network/v20190901:PacketCapture" }, { type: "azurerm:network/v20191101:PacketCapture" }, { type: "azurerm:network/v20191201:PacketCapture" }, { type: "azurerm:network/v20200301:PacketCapture" }, { type: "azurerm:network/v20200401:PacketCapture" }, { type: "azurerm:network/v20200501:PacketCapture" }, { type: "azurerm:network/v20200601:PacketCapture" }] };
