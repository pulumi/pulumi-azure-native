...
export class ServiceEndpointPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ServiceEndpointPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20180701:ServiceEndpointPolicy" }, { type: "azurerm:network/v20181001:ServiceEndpointPolicy" }, { type: "azurerm:network/v20181101:ServiceEndpointPolicy" }, { type: "azurerm:network/v20181201:ServiceEndpointPolicy" }, { type: "azurerm:network/v20190201:ServiceEndpointPolicy" }, { type: "azurerm:network/v20190401:ServiceEndpointPolicy" }, { type: "azurerm:network/v20190601:ServiceEndpointPolicy" }, { type: "azurerm:network/v20190701:ServiceEndpointPolicy" }, { type: "azurerm:network/v20190801:ServiceEndpointPolicy" }, { type: "azurerm:network/v20190901:ServiceEndpointPolicy" }, { type: "azurerm:network/v20191101:ServiceEndpointPolicy" }, { type: "azurerm:network/v20191201:ServiceEndpointPolicy" }, { type: "azurerm:network/v20200301:ServiceEndpointPolicy" }, { type: "azurerm:network/v20200401:ServiceEndpointPolicy" }, { type: "azurerm:network/v20200501:ServiceEndpointPolicy" }] };
