 ...
 *
 * const trafficManagerUserMetricsKey = new azure_native.network.v20180801.TrafficManagerUserMetricsKey("trafficManagerUserMetricsKey", {});
 *
 * ```
 *
 * ## Import
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20180801:TrafficManagerUserMetricsKey default /providers/Microsoft.Network/trafficManagerUserMetricsKeys/default 
 * ```
 */
export class TrafficManagerUserMetricsKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20180801:TrafficManagerUserMetricsKey';
    ...
    constructor(name: string, args?: TrafficManagerUserMetricsKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:TrafficManagerUserMetricsKey" }, { type: "azure-native:network/v20180401:TrafficManagerUserMetricsKey" }, { type: "azure-native:network/v20220401preview:TrafficManagerUserMetricsKey" }] };
