...
export function getP2sVpnServerConfiguration(args: GetP2sVpnServerConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetP2sVpnServerConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180801:getP2sVpnServerConfiguration", {
...
export interface GetP2sVpnServerConfigurationResult {
    ...
    readonly p2SVpnGateways: outputs.network.v20180801.SubResourceInvokeResponse[];
    /**
     * Radius client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusClientRootCertificates?: outputs.network.v20180801.P2SVpnServerConfigRadiusClientRootCertificateInvokeResponse[];
    /**
     * Radius Server root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusServerRootCertificates?: outputs.network.v20180801.P2SVpnServerConfigRadiusServerRootCertificateInvokeResponse[];
    /**
     * VPN client revoked certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRevokedCertificates?: outputs.network.v20180801.P2SVpnServerConfigVpnClientRevokedCertificateInvokeResponse[];
    /**
     * VPN client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRootCertificates?: outputs.network.v20180801.P2SVpnServerConfigVpnClientRootCertificateInvokeResponse[];
    /**
     ...
     */
    readonly vpnClientIpsecPolicies?: outputs.network.v20180801.IpsecPolicyInvokeResponse[];
    /**
