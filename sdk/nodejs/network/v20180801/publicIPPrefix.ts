 ...
 *
 * @deprecated azure-native:network/v20180801:PublicIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:PublicIPPrefix to guarantee forwards compatibility.
 */
export class PublicIPPrefix extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PublicIPPrefix {
        pulumi.log.warn("PublicIPPrefix is deprecated: azure-native:network/v20180801:PublicIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:PublicIPPrefix to guarantee forwards compatibility.")
