 ...
 *
 * const publicIPPrefix = new azurerm.network.v20180801.PublicIPPrefix("publicIPPrefix", {
 *     location: "westus",
 *     prefixLength: 30,
...
export class PublicIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180801:PublicIPPrefix';
