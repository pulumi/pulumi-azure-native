...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20180801:Profile';
     ...
     */
    public readonly dnsConfig!: pulumi.Output<outputs.network.v20180801.DnsConfigResponse | undefined>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    public readonly endpoints!: pulumi.Output<outputs.network.v20180801.EndpointResponse[] | undefined>;
    /**
     ...
     */
    public readonly monitorConfig!: pulumi.Output<outputs.network.v20180801.MonitorConfigResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20180801:Profile" }, { type: "azure-native:network:Profile" }, { type: "azure-nextgen:network:Profile" }, { type: "azure-native:network/v20151101:Profile" }, { type: "azure-nextgen:network/v20151101:Profile" }, { type: "azure-native:network/v20170301:Profile" }, { type: "azure-nextgen:network/v20170301:Profile" }, { type: "azure-native:network/v20170501:Profile" }, { type: "azure-nextgen:network/v20170501:Profile" }, { type: "azure-native:network/v20180201:Profile" }, { type: "azure-nextgen:network/v20180201:Profile" }, { type: "azure-native:network/v20180301:Profile" }, { type: "azure-nextgen:network/v20180301:Profile" }, { type: "azure-native:network/v20180401:Profile" }, { type: "azure-nextgen:network/v20180401:Profile" }] };
...
export interface ProfileArgs {
     ...
     * The list of allowed endpoint record types.
     */
    readonly allowedEndpointRecordTypes?: pulumi.Input<pulumi.Input<string | enums.network.v20180801.AllowedEndpointRecordType>[]>;
    /**
     * The DNS settings of the Traffic Manager profile.
     */
    readonly dnsConfig?: pulumi.Input<inputs.network.v20180801.DnsConfigArgs>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    readonly endpoints?: pulumi.Input<pulumi.Input<inputs.network.v20180801.EndpointArgs>[]>;
    /**
     ...
     * The endpoint monitoring settings of the Traffic Manager profile.
     */
    readonly monitorConfig?: pulumi.Input<inputs.network.v20180801.MonitorConfigArgs>;
    /**
     * The name of the resource
     */
     ...
     * The status of the Traffic Manager profile.
     */
    readonly profileStatus?: pulumi.Input<string | enums.network.v20180801.ProfileStatus>;
    /**
     ...
     * The traffic routing method of the Traffic Manager profile.
     */
    readonly trafficRoutingMethod?: pulumi.Input<string | enums.network.v20180801.TrafficRoutingMethod>;
    /**
     * Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
     */
    readonly trafficViewEnrollmentStatus?: pulumi.Input<string | enums.network.v20180801.TrafficViewEnrollmentStatus>;
    /**
     * The type of the resource. Ex- Microsoft.Network/trafficManagerProfiles.
     */
