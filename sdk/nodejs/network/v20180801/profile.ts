...
export class Profile extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:Profile" }, { type: "azure-native:network/v20220401:Profile" }, { type: "azure-native:network/v20220401preview:Profile" }] };
