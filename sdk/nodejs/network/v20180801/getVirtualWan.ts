...
export function getVirtualWan(args: GetVirtualWanArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualWanResult> {
    pulumi.log.warn("getVirtualWan is deprecated: azure-native:network/v20180801:VirtualWan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190701:VirtualWan to guarantee forwards compatibility.")
