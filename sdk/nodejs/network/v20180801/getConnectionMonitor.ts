...
export function getConnectionMonitor(args: GetConnectionMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionMonitorResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180801:getConnectionMonitor", {
...
export interface GetConnectionMonitorResult {
     ...
     */
    readonly destination: outputs.network.v20180801.ConnectionMonitorDestinationInvokeResponse;
     ...
     */
    readonly source: outputs.network.v20180801.ConnectionMonitorSourceInvokeResponse;
    /**
