...
export class VpnSite extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VpnSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VpnSite" }, { type: "azurerm:network/preview:VpnSite" }, { type: "azurerm:network/v20180401:VpnSite" }, { type: "azurerm:network/v20180601:VpnSite" }, { type: "azurerm:network/v20180701:VpnSite" }, { type: "azurerm:network/v20181001:VpnSite" }, { type: "azurerm:network/v20181101:VpnSite" }, { type: "azurerm:network/v20181201:VpnSite" }, { type: "azurerm:network/v20190201:VpnSite" }, { type: "azurerm:network/v20190401:VpnSite" }, { type: "azurerm:network/v20190601:VpnSite" }, { type: "azurerm:network/v20190701:VpnSite" }, { type: "azurerm:network/v20190801:VpnSite" }, { type: "azurerm:network/v20190901:VpnSite" }, { type: "azurerm:network/v20191101:VpnSite" }, { type: "azurerm:network/v20191201:VpnSite" }, { type: "azurerm:network/v20200301:VpnSite" }, { type: "azurerm:network/v20200401:VpnSite" }, { type: "azurerm:network/v20200501:VpnSite" }, { type: "azurerm:network/v20200601:VpnSite" }] };
