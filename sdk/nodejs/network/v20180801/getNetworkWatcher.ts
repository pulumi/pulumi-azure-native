...
export function getNetworkWatcher(args: GetNetworkWatcherArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkWatcherResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180801:getNetworkWatcher", {
        "name": args.name,
...
export interface GetNetworkWatcherResult {
     ...
     */
    readonly properties: outputs.network.v20180801.NetworkWatcherPropertiesFormatResponse;
    /**
     * Resource tags.
     */
