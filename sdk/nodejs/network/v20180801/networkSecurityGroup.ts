...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180801:NetworkSecurityGroup';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.network.v20180801.NetworkSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityGroupArgs {
     ...
     */
    readonly defaultSecurityRules?: pulumi.Input<pulumi.Input<inputs.network.v20180801.SecurityRule>[]>;
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     */
    readonly securityRules?: pulumi.Input<pulumi.Input<inputs.network.v20180801.SecurityRule>[]>;
    /**
     * Resource tags.
     */
