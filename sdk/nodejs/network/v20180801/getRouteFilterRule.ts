...
export function getRouteFilterRule(args: GetRouteFilterRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180801:getRouteFilterRule", {
        "name": args.name,
...
export interface GetRouteFilterRuleResult {
     ...
     * Route Filter Rule Resource
     */
    readonly properties: outputs.network.v20180801.RouteFilterRulePropertiesFormatResponse;
}
