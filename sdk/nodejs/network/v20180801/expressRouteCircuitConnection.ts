...
export class ExpressRouteCircuitConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180801:ExpressRouteCircuitConnection';
    ...
    public readonly properties!: pulumi.Output<outputs.network.v20180801.ExpressRouteCircuitConnectionPropertiesFormatResponse>;
...
export interface ExpressRouteCircuitConnectionArgs {
    ...
    readonly properties?: pulumi.Input<inputs.network.v20180801.ExpressRouteCircuitConnectionPropertiesFormat>;
    /**
