...
export function getRouteTable(args: GetRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteTableResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180801:getRouteTable", {
        "expand": args.expand,
...
export interface GetRouteTableResult {
     ...
     */
    readonly routes?: outputs.network.v20180801.RouteInvokeResponse[];
    /**
     * A collection of references to subnets.
     */
    readonly subnets: outputs.network.v20180801.SubnetInvokeResponse[];
    /**
     * Resource tags.
     */
