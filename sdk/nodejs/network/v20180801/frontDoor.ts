 ...
 *
 * const frontDoor = new azurerm.network.v20180801.FrontDoor("frontDoor", {
 *     backendPools: [{
 *         name: "backendPool1",
 *     }],
...
export class FrontDoor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180801:FrontDoor';
    ...
    constructor(name: string, args: FrontDoorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:FrontDoor" }, { type: "azurerm:network/v20190401:FrontDoor" }, { type: "azurerm:network/v20190501:FrontDoor" }, { type: "azurerm:network/v20200101:FrontDoor" }, { type: "azurerm:network/v20200401:FrontDoor" }, { type: "azurerm:network/v20200501:FrontDoor" }] };
