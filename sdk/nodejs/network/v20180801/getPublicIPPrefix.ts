...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20180801:getPublicIPPrefix", {
        "expand": args.expand,
...
export interface GetPublicIPPrefixResult {
     ...
     */
    readonly loadBalancerFrontendIpConfiguration: outputs.network.v20180801.SubResourceInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPAddresses?: outputs.network.v20180801.ReferencedPublicIpAddressInvokeResponse[];
    /**
     ...
     */
    readonly sku?: outputs.network.v20180801.PublicIPPrefixSkuInvokeResponse;
    /**
     * Resource tags.
     */
