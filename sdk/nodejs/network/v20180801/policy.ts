 ...
 *
 * const policy = new azurerm.network.v20180801.Policy("policy", {
 *     customRules: {
 *         rules: [
 *             {
 *                 action: "Block",
...
export class Policy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20180801:Policy';
    ...
    constructor(name: string, args: PolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Policy" }, { type: "azurerm:network/v20190301:Policy" }, { type: "azurerm:network/v20191001:Policy" }, { type: "azurerm:network/v20200401:Policy" }] };
