 ...
 *
 * @deprecated azure-native:network/v20180801:P2sVpnServerConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190701:P2sVpnServerConfiguration to guarantee forwards compatibility.
 */
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): P2sVpnServerConfiguration {
        pulumi.log.warn("P2sVpnServerConfiguration is deprecated: azure-native:network/v20180801:P2sVpnServerConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190701:P2sVpnServerConfiguration to guarantee forwards compatibility.")
