...
export function getInterfaceEndpoint(args: GetInterfaceEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfaceEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20180801:getInterfaceEndpoint", {
        "name": args.name,
...
export interface GetInterfaceEndpointResult {
     ...
     */
    readonly properties: outputs.network.v20180801.InterfaceEndpointPropertiesResponse;
    /**
     * Resource tags.
     */
