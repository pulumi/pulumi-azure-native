 ...
 *
 * @deprecated azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.
 */
export class ManagementGroupNetworkManagerConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagementGroupNetworkManagerConnection {
        pulumi.log.warn("ManagementGroupNetworkManagerConnection is deprecated: azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.")
        return new ManagementGroupNetworkManagerConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.network.v20220401preview.SystemDataResponse>;
    /**
     * Resource type.
     */
