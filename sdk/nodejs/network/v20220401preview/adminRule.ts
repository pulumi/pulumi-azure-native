...
export class AdminRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AdminRule {
        pulumi.log.warn("AdminRule is deprecated: azure-native:network/v20220401preview:AdminRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:AdminRule to guarantee forwards compatibility.")
        return new AdminRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220401preview:AdminRule';
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.network.v20220401preview.AddressPrefixItemResponse[] | undefined>;
    /**
     ...
     */
    public readonly sources!: pulumi.Output<outputs.network.v20220401preview.AddressPrefixItemResponse[] | undefined>;
    /**
...
export interface AdminRuleArgs {
     ...
     * Indicates the access allowed for this particular rule
     */
    access: pulumi.Input<string | enums.network.v20220401preview.SecurityConfigurationRuleAccess>;
    /**
