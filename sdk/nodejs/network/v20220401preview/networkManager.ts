...
export class NetworkManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220401preview:NetworkManager';
     ...
     */
    public readonly networkManagerScopes!: pulumi.Output<outputs.network.v20220401preview.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
    ...
    constructor(name: string, args: NetworkManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkManager" }, { type: "azure-native:network/v20210201preview:NetworkManager" }, { type: "azure-native:network/v20210501preview:NetworkManager" }, { type: "azure-native:network/v20220101:NetworkManager" }, { type: "azure-native:network/v20220201preview:NetworkManager" }] };
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | enums.network.v20220401preview.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<inputs.network.v20220401preview.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**
