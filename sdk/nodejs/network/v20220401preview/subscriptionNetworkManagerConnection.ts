...
export class SubscriptionNetworkManagerConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubscriptionNetworkManagerConnection {
        pulumi.log.warn("SubscriptionNetworkManagerConnection is deprecated: azure-native:network/v20220401preview:SubscriptionNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SubscriptionNetworkManagerConnection to guarantee forwards compatibility.")
