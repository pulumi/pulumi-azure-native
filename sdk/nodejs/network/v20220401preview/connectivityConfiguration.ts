...
export class ConnectivityConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220401preview:ConnectivityConfiguration';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20220401preview.ConnectivityGroupItemResponse[]>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<outputs.network.v20220401preview.HubResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectivityConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20210201preview:ConnectivityConfiguration" }, { type: "azure-native:network/v20210501preview:ConnectivityConfiguration" }, { type: "azure-native:network/v20220101:ConnectivityConfiguration" }, { type: "azure-native:network/v20220201preview:ConnectivityConfiguration" }] };
...
export interface ConnectivityConfigurationArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20220401preview.ConnectivityGroupItemArgs>[]>;
    /**
     ...
     * Connectivity topology type.
     */
    connectivityTopology: pulumi.Input<string | enums.network.v20220401preview.ConnectivityTopology>;
    /**
     * Flag if need to remove current existing peerings.
     */
    deleteExistingPeering?: pulumi.Input<string | enums.network.v20220401preview.DeleteExistingPeering>;
    /**
     * A description of the connectivity configuration.
     */
     ...
     * List of hubItems
     */
    hubs?: pulumi.Input<pulumi.Input<inputs.network.v20220401preview.HubArgs>[]>;
    /**
     * Flag if global mesh is supported.
     */
