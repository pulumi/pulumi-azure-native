...
export function getPublicIPAddress(args: GetPublicIPAddressArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPAddressResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20150615:getPublicIPAddress", {
        "expand": args.expand,
...
export interface GetPublicIPAddressResult {
     ...
     */
    readonly dnsSettings?: outputs.network.v20150615.PublicIPAddressDnsSettingsInvokeResponse;
    /**
     ...
     * IPConfiguration
     */
    readonly ipConfiguration?: outputs.network.v20150615.IPConfigurationInvokeResponse;
    /**
     * Resource location.
     */
