...
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20150615:PublicIPAddress';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20150615.PublicIPAddressPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * Public IP address properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20150615.PublicIPAddressPropertiesFormat>;
    /**
