...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20150615:getNetworkSecurityGroup", {
        "name": args.name,
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly properties: outputs.network.v20150615.NetworkSecurityGroupPropertiesFormatResponse;
    /**
     * Resource tags.
     */
