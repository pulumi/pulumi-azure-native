...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20150615:LocalNetworkGateway';
     ...
     */
    public readonly bgpSettings!: pulumi.Output<outputs.network.v20150615.BgpSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.v20150615.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network gateway's BGP speaker settings.
     */
    readonly bgpSettings?: pulumi.Input<inputs.network.v20150615.BgpSettings>;
    /**
     * Gets a unique read-only string that changes whenever the resource is updated
     */
     ...
     * Local network site address space.
     */
    readonly localNetworkAddressSpace?: pulumi.Input<inputs.network.v20150615.AddressSpace>;
    /**
