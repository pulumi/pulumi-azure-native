...
export class RulesEngine extends pulumi.CustomResource {
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20210601.RulesEngineRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: RulesEngineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20200101:RulesEngine" }, { type: "azure-native:network/v20200401:RulesEngine" }, { type: "azure-native:network/v20200501:RulesEngine" }, { type: "azure-native:network:RulesEngine" }] };
...
export interface RulesEngineArgs {
     ...
     * A list of rules that define a particular Rules Engine Configuration.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20210601.RulesEngineRuleArgs>[]>;
    /**
