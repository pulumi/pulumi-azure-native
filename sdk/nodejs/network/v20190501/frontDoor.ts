...
export class FrontDoor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190501:FrontDoor';
     ...
     */
    public readonly backendPools!: pulumi.Output<outputs.network.v20190501.BackendPoolResponse[] | undefined>;
    /**
     * Settings for all backendPools
     */
    public readonly backendPoolsSettings!: pulumi.Output<outputs.network.v20190501.BackendPoolsSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly frontendEndpoints!: pulumi.Output<outputs.network.v20190501.FrontendEndpointResponse[] | undefined>;
    /**
     * Health probe settings associated with this Front Door instance.
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.network.v20190501.HealthProbeSettingsModelResponse[] | undefined>;
    /**
     * Load balancing settings associated with this Front Door instance.
     */
    public readonly loadBalancingSettings!: pulumi.Output<outputs.network.v20190501.LoadBalancingSettingsModelResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly routingRules!: pulumi.Output<outputs.network.v20190501.RoutingRuleResponse[] | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: FrontDoorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20190501:FrontDoor" }, { type: "azure-native:network:FrontDoor" }, { type: "azure-nextgen:network:FrontDoor" }, { type: "azure-native:network/latest:FrontDoor" }, { type: "azure-nextgen:network/latest:FrontDoor" }, { type: "azure-native:network/v20190401:FrontDoor" }, { type: "azure-nextgen:network/v20190401:FrontDoor" }, { type: "azure-native:network/v20200101:FrontDoor" }, { type: "azure-nextgen:network/v20200101:FrontDoor" }, { type: "azure-native:network/v20200401:FrontDoor" }, { type: "azure-nextgen:network/v20200401:FrontDoor" }, { type: "azure-native:network/v20200501:FrontDoor" }, { type: "azure-nextgen:network/v20200501:FrontDoor" }] };
...
export interface FrontDoorArgs {
     ...
     * Backend pools available to routing rules.
     */
    readonly backendPools?: pulumi.Input<pulumi.Input<inputs.network.v20190501.BackendPool>[]>;
    /**
     * Settings for all backendPools
     */
    readonly backendPoolsSettings?: pulumi.Input<inputs.network.v20190501.BackendPoolsSettings>;
    /**
     * Operational status of the Front Door load balancer. Permitted values are 'Enabled' or 'Disabled'
     */
     ...
     * Health probe settings associated with this Front Door instance.
     */
    readonly healthProbeSettings?: pulumi.Input<pulumi.Input<inputs.network.v20190501.HealthProbeSettingsModel>[]>;
    /**
     * Load balancing settings associated with this Front Door instance.
     */
    readonly loadBalancingSettings?: pulumi.Input<pulumi.Input<inputs.network.v20190501.LoadBalancingSettingsModel>[]>;
    /**
     * Resource location.
     */
     ...
     * Routing rules associated with this Front Door.
     */
    readonly routingRules?: pulumi.Input<pulumi.Input<inputs.network.v20190501.RoutingRule>[]>;
    /**
     * Resource tags.
     */
