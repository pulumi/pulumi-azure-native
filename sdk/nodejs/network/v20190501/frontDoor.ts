 ...
 *
 * @deprecated azure-native:network/v20190501:FrontDoor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:FrontDoor to guarantee forwards compatibility.
 */
export class FrontDoor extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FrontDoor {
        pulumi.log.warn("FrontDoor is deprecated: azure-native:network/v20190501:FrontDoor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:FrontDoor to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: FrontDoorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["backendPoolsSettings"] = args ? (args.backendPoolsSettings ? pulumi.output(args.backendPoolsSettings).apply(inputs.network.v20190501.backendPoolsSettingsArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:FrontDoor" }, { type: "azure-native:network/v20190401:FrontDoor" }, { type: "azure-native:network/v20200101:FrontDoor" }, { type: "azure-native:network/v20200401:FrontDoor" }, { type: "azure-native:network/v20200501:FrontDoor" }, { type: "azure-native:network/v20210601:FrontDoor" }] };
