...
export class VirtualNetworkLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200101:VirtualNetworkLink';
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.network.v20200101.SubResourceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200101:VirtualNetworkLink" }, { type: "azure-native:network:VirtualNetworkLink" }, { type: "azure-nextgen:network:VirtualNetworkLink" }, { type: "azure-native:network/latest:VirtualNetworkLink" }, { type: "azure-nextgen:network/latest:VirtualNetworkLink" }, { type: "azure-native:network/v20180901:VirtualNetworkLink" }, { type: "azure-nextgen:network/v20180901:VirtualNetworkLink" }, { type: "azure-native:network/v20200601:VirtualNetworkLink" }, { type: "azure-nextgen:network/v20200601:VirtualNetworkLink" }] };
