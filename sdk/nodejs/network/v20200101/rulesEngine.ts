...
export class RulesEngine extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20200101.RulesEnginePropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface RulesEngineArgs {
     ...
     * Properties of the Rules Engine Configuration.
     */
    readonly properties?: pulumi.Input<inputs.network.v20200101.RulesEngineProperties>;
    /**
