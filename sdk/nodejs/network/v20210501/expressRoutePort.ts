 ...
 *
 * @deprecated azure-native:network/v20210501:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRoutePort to guarantee forwards compatibility.
 */
export class ExpressRoutePort extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRoutePort {
        pulumi.log.warn("ExpressRoutePort is deprecated: azure-native:network/v20210501:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRoutePort to guarantee forwards compatibility.")
