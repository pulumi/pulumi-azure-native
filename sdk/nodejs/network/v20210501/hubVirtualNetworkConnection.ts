...
export class HubVirtualNetworkConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HubVirtualNetworkConnection {
        pulumi.log.warn("HubVirtualNetworkConnection is deprecated: azure-native:network/v20210501:HubVirtualNetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:HubVirtualNetworkConnection to guarantee forwards compatibility.")
        return new HubVirtualNetworkConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210501:HubVirtualNetworkConnection';
