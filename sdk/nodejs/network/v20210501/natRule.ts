...
export class NatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210501:NatRule';
     ...
     */
    public /*out*/ readonly egressVpnSiteLinkConnections!: pulumi.Output<outputs.network.v20210501.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly ingressVpnSiteLinkConnections!: pulumi.Output<outputs.network.v20210501.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: NatRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20210501:NatRule" }, { type: "azure-native:network:NatRule" }, { type: "azure-nextgen:network:NatRule" }, { type: "azure-native:network/v20200801:NatRule" }, { type: "azure-nextgen:network/v20200801:NatRule" }, { type: "azure-native:network/v20201101:NatRule" }, { type: "azure-nextgen:network/v20201101:NatRule" }, { type: "azure-native:network/v20210201:NatRule" }, { type: "azure-nextgen:network/v20210201:NatRule" }, { type: "azure-native:network/v20210301:NatRule" }, { type: "azure-nextgen:network/v20210301:NatRule" }] };
