 ...
 *
 * @deprecated azure-native:network/v20210501:RoutingIntent is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RoutingIntent to guarantee forwards compatibility.
 */
export class RoutingIntent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RoutingIntent {
        pulumi.log.warn("RoutingIntent is deprecated: azure-native:network/v20210501:RoutingIntent is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RoutingIntent to guarantee forwards compatibility.")
        return new RoutingIntent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210501:RoutingIntent';
     ...
     */
    public readonly routingPolicies!: pulumi.Output<outputs.network.v20210501.RoutingPolicyResponse[] | undefined>;
    /**
     * Resource type.
     */
