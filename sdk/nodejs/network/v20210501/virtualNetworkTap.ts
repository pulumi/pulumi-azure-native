...
export class VirtualNetworkTap extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetworkTap {
        pulumi.log.warn("VirtualNetworkTap is deprecated: azure-native:network/v20210501:VirtualNetworkTap is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkTap to guarantee forwards compatibility.")
