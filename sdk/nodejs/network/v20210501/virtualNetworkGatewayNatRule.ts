...
export class VirtualNetworkGatewayNatRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkGatewayNatRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210201:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210301:VirtualNetworkGatewayNatRule" }] };
