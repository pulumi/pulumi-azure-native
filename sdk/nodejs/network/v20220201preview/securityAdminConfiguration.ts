...
export class SecurityAdminConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityAdminConfiguration {
        pulumi.log.warn("SecurityAdminConfiguration is deprecated: azure-native:network/v20220201preview:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:SecurityAdminConfiguration to guarantee forwards compatibility.")
