...
export class DefaultUserRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DefaultUserRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:DefaultUserRule" }, { type: "azure-native:network/v20210201preview:DefaultUserRule" }, { type: "azure-native:network/v20210501preview:DefaultUserRule" }, { type: "azure-native:network/v20220401preview:DefaultUserRule" }, { type: "azure-native:network/v20240301:DefaultUserRule" }, { type: "azure-native:network/v20240501:DefaultUserRule" }] };
