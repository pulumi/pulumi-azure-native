 ...
 *
 * @deprecated azure-native:network/v20220201preview:ConnectivityConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConnectivityConfiguration to guarantee forwards compatibility.
 */
export class ConnectivityConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectivityConfiguration {
        pulumi.log.warn("ConnectivityConfiguration is deprecated: azure-native:network/v20220201preview:ConnectivityConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConnectivityConfiguration to guarantee forwards compatibility.")
        return new ConnectivityConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220201preview:ConnectivityConfiguration';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20220201preview.ConnectivityGroupItemResponse[]>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<outputs.network.v20220201preview.HubResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectivityConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ConnectivityConfiguration" }, { type: "azure-native:network/v20210201preview:ConnectivityConfiguration" }, { type: "azure-native:network/v20210501preview:ConnectivityConfiguration" }, { type: "azure-native:network/v20220101:ConnectivityConfiguration" }, { type: "azure-native:network/v20220401preview:ConnectivityConfiguration" }, { type: "azure-native:network/v20220501:ConnectivityConfiguration" }, { type: "azure-native:network/v20220701:ConnectivityConfiguration" }, { type: "azure-native:network/v20220901:ConnectivityConfiguration" }] };
