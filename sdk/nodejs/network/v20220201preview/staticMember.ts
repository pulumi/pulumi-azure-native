 ...
 * StaticMember Item.
 *
 * @deprecated azure-native:network/v20220201preview:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:StaticMember to guarantee forwards compatibility.
 */
export class StaticMember extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticMember {
        pulumi.log.warn("StaticMember is deprecated: azure-native:network/v20220201preview:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:StaticMember to guarantee forwards compatibility.")
        return new StaticMember(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220201preview:StaticMember';
    ...
    constructor(name: string, args: StaticMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:StaticMember" }, { type: "azure-native:network/v20210501preview:StaticMember" }, { type: "azure-native:network/v20220101:StaticMember" }, { type: "azure-native:network/v20220401preview:StaticMember" }, { type: "azure-native:network/v20220501:StaticMember" }, { type: "azure-native:network/v20220701:StaticMember" }, { type: "azure-native:network/v20220901:StaticMember" }] };
