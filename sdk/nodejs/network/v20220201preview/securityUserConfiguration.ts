 ...
 *
 * @deprecated azure-native:network/v20220201preview:SecurityUserConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:SecurityUserConfiguration to guarantee forwards compatibility.
 */
export class SecurityUserConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityUserConfiguration {
        pulumi.log.warn("SecurityUserConfiguration is deprecated: azure-native:network/v20220201preview:SecurityUserConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:SecurityUserConfiguration to guarantee forwards compatibility.")
