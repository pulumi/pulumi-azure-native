...
export class SecurityUserConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SecurityUserConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:SecurityUserConfiguration" }, { type: "azure-native:network/v20210201preview:SecurityUserConfiguration" }, { type: "azure-native:network/v20210501preview:SecurityUserConfiguration" }, { type: "azure-native:network/v20220401preview:SecurityUserConfiguration" }, { type: "azure-native:network/v20240301:SecurityUserConfiguration" }, { type: "azure-native:network/v20240501:SecurityUserConfiguration" }] };
