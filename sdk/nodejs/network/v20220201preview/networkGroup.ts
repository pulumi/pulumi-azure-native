...
export class NetworkGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkGroup" }, { type: "azure-native:network/v20210201preview:NetworkGroup" }, { type: "azure-native:network/v20210501preview:NetworkGroup" }] };
