...
export class ServiceEndpointPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceEndpointPolicyState, opts?: pulumi.CustomResourceOptions): ServiceEndpointPolicy {
        return new ServiceEndpointPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:ServiceEndpointPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.ServiceEndpointPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ServiceEndpointPolicyArgs | ServiceEndpointPolicyState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ServiceEndpointPolicyState | undefined;
 ...
 * Service End point policy resource.
 */
export interface ServiceEndpointPolicyState {
    /**
     * A unique read-only string that changes whenever the resource is updated.
     */
     ...
     * Properties of the service end point policy.
     */
    readonly properties: pulumi.Input<inputs.network.ServiceEndpointPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ServiceEndpointPolicyArgs {
     ...
     * Properties of the service end point policy.
     */
    readonly properties?: pulumi.Input<inputs.network.ServiceEndpointPolicyPropertiesFormat>;
    /**
