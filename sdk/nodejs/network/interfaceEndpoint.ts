...
export class InterfaceEndpoint extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceEndpointState, opts?: pulumi.CustomResourceOptions): InterfaceEndpoint {
        return new InterfaceEndpoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:InterfaceEndpoint';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.InterfaceEndpointPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: InterfaceEndpointArgs | InterfaceEndpointState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as InterfaceEndpointState | undefined;
 ...
 * Interface endpoint resource.
 */
export interface InterfaceEndpointState {
    /**
     * Gets a unique read-only string that changes whenever the resource is updated.
     */
     ...
     * Properties of the interface endpoint.
     */
    readonly properties: pulumi.Input<inputs.network.InterfaceEndpointPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface InterfaceEndpointArgs {
     ...
     * Properties of the interface endpoint.
     */
    readonly properties?: pulumi.Input<inputs.network.InterfaceEndpointProperties>;
    /**
