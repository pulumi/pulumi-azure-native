...
export function getVirtualNetworkGatewayNatRule(args: GetVirtualNetworkGatewayNatRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayNatRuleResult> {
    pulumi.log.warn("getVirtualNetworkGatewayNatRule is deprecated: azure-native:network/v20220701:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220701:getVirtualNetworkGatewayNatRule", {
...
export interface GetVirtualNetworkGatewayNatRuleResult {
     ...
     */
    readonly externalMappings?: outputs.network.v20220701.VpnNatRuleMappingResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly internalMappings?: outputs.network.v20220701.VpnNatRuleMappingResponse[];
    /**
