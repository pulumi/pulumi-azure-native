 ...
 *
 * @deprecated azure-native:network/v20220701:PrivateDnsZoneGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PrivateDnsZoneGroup to guarantee forwards compatibility.
 */
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:PrivateDnsZoneGroup';
     ...
     */
    public readonly privateDnsZoneConfigs!: pulumi.Output<outputs.network.v20220701.PrivateDnsZoneConfigResponse[] | undefined>;
    /**
...
export interface PrivateDnsZoneGroupArgs {
     ...
     * A collection of private dns zone configurations of the private dns zone group.
     */
    privateDnsZoneConfigs?: pulumi.Input<pulumi.Input<inputs.network.v20220701.PrivateDnsZoneConfigArgs>[]>;
    /**
