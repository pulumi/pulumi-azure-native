...
export interface GetSecurityRuleResult {
     ...
     */
    readonly destinationApplicationSecurityGroups?: outputs.network.v20220701.ApplicationSecurityGroupResponse[];
    /**
     ...
     */
    readonly sourceApplicationSecurityGroups?: outputs.network.v20220701.ApplicationSecurityGroupResponse[];
    /**
...
export function getSecurityRuleOutput(args: GetSecurityRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20220701:getSecurityRule", {
        "networkSecurityGroupName": args.networkSecurityGroupName,
        "resourceGroupName": args.resourceGroupName,
        "securityRuleName": args.securityRuleName,
    }, opts);
