...
export class VirtualNetworkTap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:VirtualNetworkTap';
     ...
     */
    public readonly destinationLoadBalancerFrontEndIPConfiguration!: pulumi.Output<outputs.network.v20220701.FrontendIPConfigurationResponse | undefined>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    public readonly destinationNetworkInterfaceIPConfiguration!: pulumi.Output<outputs.network.v20220701.NetworkInterfaceIPConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaceTapConfigurations!: pulumi.Output<outputs.network.v20220701.NetworkInterfaceTapConfigurationResponse[]>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkTapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["destinationLoadBalancerFrontEndIPConfiguration"] = args ? (args.destinationLoadBalancerFrontEndIPConfiguration ? pulumi.output(args.destinationLoadBalancerFrontEndIPConfiguration).apply(inputs.network.v20220701.frontendIPConfigurationArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["destinationNetworkInterfaceIPConfiguration"] = args ? (args.destinationNetworkInterfaceIPConfiguration ? pulumi.output(args.destinationNetworkInterfaceIPConfiguration).apply(inputs.network.v20220701.networkInterfaceIPConfigurationArgsProvideDefaults) : undefined) : undefined;
