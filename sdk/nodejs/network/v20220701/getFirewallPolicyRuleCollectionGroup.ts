 ...
 */
/** @deprecated azure-native:network/v20220701:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility. */
export function getFirewallPolicyRuleCollectionGroup(args: GetFirewallPolicyRuleCollectionGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleCollectionGroupResult> {
    pulumi.log.warn("getFirewallPolicyRuleCollectionGroup is deprecated: azure-native:network/v20220701:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20220701:getFirewallPolicyRuleCollectionGroup", {
...
export interface GetFirewallPolicyRuleCollectionGroupResult {
     ...
     */
    readonly ruleCollections?: (outputs.network.v20220701.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20220701.FirewallPolicyNatRuleCollectionResponse)[];
    /**
     * Rule Group type.
     */
