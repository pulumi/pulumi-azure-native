 ...
 *
 * @deprecated azure-native:network/v20220701:ConnectivityConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConnectivityConfiguration to guarantee forwards compatibility.
 */
export class ConnectivityConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:ConnectivityConfiguration';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20220701.ConnectivityGroupItemResponse[]>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<outputs.network.v20220701.HubResponse[] | undefined>;
    /**
...
export interface ConnectivityConfigurationArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.v20220701.ConnectivityGroupItemArgs>[]>;
    /**
     ...
     * Connectivity topology type.
     */
    connectivityTopology: pulumi.Input<string | enums.network.v20220701.ConnectivityTopology>;
    /**
     * Flag if need to remove current existing peerings.
     */
    deleteExistingPeering?: pulumi.Input<string | enums.network.v20220701.DeleteExistingPeering>;
    /**
     * A description of the connectivity configuration.
     */
     ...
     * List of hubItems
     */
    hubs?: pulumi.Input<pulumi.Input<inputs.network.v20220701.HubArgs>[]>;
    /**
     * Flag if global mesh is supported.
     */
