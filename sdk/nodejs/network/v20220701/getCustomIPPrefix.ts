...
export function getCustomIPPrefix(args: GetCustomIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomIPPrefixResult> {
    pulumi.log.warn("getCustomIPPrefix is deprecated: azure-native:network/v20220701:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.")
...
export interface GetCustomIPPrefixResult {
     ...
     */
    readonly childCustomIpPrefixes: outputs.network.v20220701.SubResourceResponse[];
    /**
     ...
     */
    readonly customIpPrefixParent?: outputs.network.v20220701.SubResourceResponse;
    /**
