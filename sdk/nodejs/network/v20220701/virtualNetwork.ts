...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNetwork {
        pulumi.log.warn("VirtualNetwork is deprecated: azure-native:network/v20220701:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetwork to guarantee forwards compatibility.")
        return new VirtualNetwork(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:VirtualNetwork';
     ...
     */
    public readonly addressSpace!: pulumi.Output<outputs.network.v20220701.AddressSpaceResponse | undefined>;
    /**
     * Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
     */
    public readonly bgpCommunities!: pulumi.Output<outputs.network.v20220701.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    public readonly ddosProtectionPlan!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    public readonly dhcpOptions!: pulumi.Output<outputs.network.v20220701.DhcpOptionsResponse | undefined>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.network.v20220701.VirtualNetworkEncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly subnets!: pulumi.Output<outputs.network.v20220701.SubnetResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetworkPeerings!: pulumi.Output<outputs.network.v20220701.VirtualNetworkPeeringResponse[] | undefined>;
...
export interface VirtualNetworkArgs {
     ...
     * The AddressSpace that contains an array of IP address ranges that can be used by subnets.
     */
    addressSpace?: pulumi.Input<inputs.network.v20220701.AddressSpaceArgs>;
    /**
     * Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
     */
    bgpCommunities?: pulumi.Input<inputs.network.v20220701.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
     ...
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    dhcpOptions?: pulumi.Input<inputs.network.v20220701.DhcpOptionsArgs>;
    /**
     * Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
     */
     ...
     * Indicates if encryption is enabled on virtual network and if VM without encryption is allowed in encrypted VNet.
     */
    encryption?: pulumi.Input<inputs.network.v20220701.VirtualNetworkEncryptionArgs>;
    /**
     * The extended location of the virtual network.
     */
     ...
     * A list of subnets in a Virtual Network.
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.network.v20220701.SubnetArgs>[]>;
    /**
     * Resource tags.
     */
     ...
     * A list of peerings in a Virtual Network.
     */
    virtualNetworkPeerings?: pulumi.Input<pulumi.Input<inputs.network.v20220701.VirtualNetworkPeeringArgs>[]>;
}
