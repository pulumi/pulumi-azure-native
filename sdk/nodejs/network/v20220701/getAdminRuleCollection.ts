...
export function getAdminRuleCollection(args: GetAdminRuleCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetAdminRuleCollectionResult> {
    pulumi.log.warn("getAdminRuleCollection is deprecated: azure-native:network/v20220701:AdminRuleCollection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:AdminRuleCollection to guarantee forwards compatibility.")
...
export interface GetAdminRuleCollectionResult {
     ...
     */
    readonly appliesToGroups: outputs.network.v20220701.NetworkManagerSecurityGroupItemResponse[];
    /**
