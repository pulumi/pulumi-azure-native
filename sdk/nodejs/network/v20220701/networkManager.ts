...
export class NetworkManager extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkManager {
        pulumi.log.warn("NetworkManager is deprecated: azure-native:network/v20220701:NetworkManager is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkManager to guarantee forwards compatibility.")
        return new NetworkManager(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:NetworkManager';
     ...
     */
    public readonly networkManagerScopes!: pulumi.Output<outputs.network.v20220701.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | enums.network.v20220701.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<inputs.network.v20220701.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**
