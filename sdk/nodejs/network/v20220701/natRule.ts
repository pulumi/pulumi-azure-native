 ...
 *
 * @deprecated azure-native:network/v20220701:NatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NatRule to guarantee forwards compatibility.
 */
export class NatRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NatRule {
        pulumi.log.warn("NatRule is deprecated: azure-native:network/v20220701:NatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NatRule to guarantee forwards compatibility.")
