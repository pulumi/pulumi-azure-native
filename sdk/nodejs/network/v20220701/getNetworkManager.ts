...
export function getNetworkManager(args: GetNetworkManagerArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkManagerResult> {
    pulumi.log.warn("getNetworkManager is deprecated: azure-native:network/v20220701:NetworkManager is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkManager to guarantee forwards compatibility.")
...
export interface GetNetworkManagerResult {
     ...
     */
    readonly networkManagerScopes: outputs.network.v20220701.NetworkManagerPropertiesResponseNetworkManagerScopes;
    /**
