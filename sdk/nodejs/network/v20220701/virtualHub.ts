...
export class VirtualHub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHub {
        pulumi.log.warn("VirtualHub is deprecated: azure-native:network/v20220701:VirtualHub is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualHub to guarantee forwards compatibility.")
