 ...
 * A flow log resource.
 *
 * @deprecated azure-native:network/v20220701:FlowLog is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FlowLog to guarantee forwards compatibility.
 */
export class FlowLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:FlowLog';
     ...
     */
    public readonly flowAnalyticsConfiguration!: pulumi.Output<outputs.network.v20220701.TrafficAnalyticsPropertiesResponse | undefined>;
    /**
     * Parameters that define the flow log format.
     */
    public readonly format!: pulumi.Output<outputs.network.v20220701.FlowLogFormatParametersResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly retentionPolicy!: pulumi.Output<outputs.network.v20220701.RetentionPolicyParametersResponse | undefined>;
    /**
    ...
    constructor(name: string, args: FlowLogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["format"] = args ? (args.format ? pulumi.output(args.format).apply(inputs.network.v20220701.flowLogFormatParametersArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["id"] = args ? args.id : undefined;
            resourceInputs["location"] = args ? args.location : undefined;
            resourceInputs["networkWatcherName"] = args ? args.networkWatcherName : undefined;
            resourceInputs["resourceGroupName"] = args ? args.resourceGroupName : undefined;
            resourceInputs["retentionPolicy"] = args ? (args.retentionPolicy ? pulumi.output(args.retentionPolicy).apply(inputs.network.v20220701.retentionPolicyParametersArgsProvideDefaults) : undefined) : undefined;
...
export interface FlowLogArgs {
     ...
     * Parameters that define the configuration of traffic analytics.
     */
    flowAnalyticsConfiguration?: pulumi.Input<inputs.network.v20220701.TrafficAnalyticsPropertiesArgs>;
    /**
     ...
     * Parameters that define the flow log format.
     */
    format?: pulumi.Input<inputs.network.v20220701.FlowLogFormatParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Parameters that define the retention policy for flow log.
     */
    retentionPolicy?: pulumi.Input<inputs.network.v20220701.RetentionPolicyParametersArgs>;
    /**
     * ID of the storage account which is used to store the flow log.
     */
