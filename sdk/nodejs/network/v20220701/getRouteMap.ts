...
export function getRouteMap(args: GetRouteMapArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteMapResult> {
    pulumi.log.warn("getRouteMap is deprecated: azure-native:network/v20220701:RouteMap is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteMap to guarantee forwards compatibility.")
