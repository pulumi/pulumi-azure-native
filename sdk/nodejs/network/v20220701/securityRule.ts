 ...
 *
 * const securityRule = new azure_native.network.v20220701.SecurityRule("securityRule", {
 *     access: "Deny",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20220701:SecurityRule rule1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkSecurityGroups/testnsg/securityRules/rule1 
 * ```
 */
