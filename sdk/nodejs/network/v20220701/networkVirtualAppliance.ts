...
export class NetworkVirtualAppliance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkVirtualAppliance {
        pulumi.log.warn("NetworkVirtualAppliance is deprecated: azure-native:network/v20220701:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkVirtualAppliance to guarantee forwards compatibility.")
        return new NetworkVirtualAppliance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:NetworkVirtualAppliance';
     ...
     */
    public readonly delegation!: pulumi.Output<outputs.network.v20220701.DelegationPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly inboundSecurityRules!: pulumi.Output<outputs.network.v20220701.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly nvaSku!: pulumi.Output<outputs.network.v20220701.VirtualApplianceSkuPropertiesResponse | undefined>;
    /**
     * The delegation for the Virtual Appliance
     */
    public /*out*/ readonly partnerManagedResource!: pulumi.Output<outputs.network.v20220701.PartnerManagedResourcePropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly virtualApplianceNics!: pulumi.Output<outputs.network.v20220701.VirtualApplianceNicPropertiesResponse[]>;
    /**
     * List of references to VirtualApplianceSite.
     */
    public /*out*/ readonly virtualApplianceSites!: pulumi.Output<outputs.network.v20220701.SubResourceResponse[]>;
    /**
...
export interface NetworkVirtualApplianceArgs {
     ...
     * The delegation for the Virtual Appliance
     */
    delegation?: pulumi.Input<inputs.network.v20220701.DelegationPropertiesArgs>;
    /**
     * Resource ID.
     */
     ...
     * Network Virtual Appliance SKU.
     */
    nvaSku?: pulumi.Input<inputs.network.v20220701.VirtualApplianceSkuPropertiesArgs>;
    /**
