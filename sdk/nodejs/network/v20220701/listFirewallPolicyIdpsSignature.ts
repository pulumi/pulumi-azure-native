...
export function listFirewallPolicyIdpsSignature(args: ListFirewallPolicyIdpsSignatureArgs, opts?: pulumi.InvokeOptions): Promise<ListFirewallPolicyIdpsSignatureResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20220701:listFirewallPolicyIdpsSignature", {
...
export interface ListFirewallPolicyIdpsSignatureArgs {
     ...
     */
    filters?: inputs.network.v20220701.FilterItems[];
    /**
     ...
     */
    orderBy?: inputs.network.v20220701.OrderBy;
    /**
...
export interface ListFirewallPolicyIdpsSignatureResult {
     ...
     */
    readonly signatures?: outputs.network.v20220701.SingleQueryResultResponse[];
}
/**
 * Retrieves the current status of IDPS signatures for the relevant policy
 */
export function listFirewallPolicyIdpsSignatureOutput(args: ListFirewallPolicyIdpsSignatureOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListFirewallPolicyIdpsSignatureResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20220701:listFirewallPolicyIdpsSignature", {
        "filters": args.filters,
        "firewallPolicyName": args.firewallPolicyName,
        "orderBy": args.orderBy,
        "resourceGroupName": args.resourceGroupName,
...
export interface ListFirewallPolicyIdpsSignatureOutputArgs {
     ...
     * Contain all filters names and values
     */
    filters?: pulumi.Input<pulumi.Input<inputs.network.v20220701.FilterItemsArgs>[]>;
    /**
     * The name of the Firewall Policy.
     */
     ...
     * Column to sort response by
     */
    orderBy?: pulumi.Input<inputs.network.v20220701.OrderByArgs>;
    /**
     * The name of the resource group.
     */
