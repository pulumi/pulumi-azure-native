 ...
 *
 * @deprecated azure-native:network/v20220701:HubRouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:HubRouteTable to guarantee forwards compatibility.
 */
export class HubRouteTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HubRouteTable {
        pulumi.log.warn("HubRouteTable is deprecated: azure-native:network/v20220701:HubRouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:HubRouteTable to guarantee forwards compatibility.")
        return new HubRouteTable(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:HubRouteTable';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.v20220701.HubRouteResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface HubRouteTableArgs {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20220701.HubRouteArgs>[]>;
    /**
