...
export class SecurityPartnerProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityPartnerProvider {
        pulumi.log.warn("SecurityPartnerProvider is deprecated: azure-native:network/v20220701:SecurityPartnerProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:SecurityPartnerProvider to guarantee forwards compatibility.")
        return new SecurityPartnerProvider(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:SecurityPartnerProvider';
...
export interface SecurityPartnerProviderArgs {
     ...
     * The security provider name.
     */
    securityProviderName?: pulumi.Input<string | enums.network.v20220701.SecurityProviderName>;
    /**
     * Resource tags.
     */
