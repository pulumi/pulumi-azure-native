 ...
 *
 * @deprecated azure-native:network/v20220701:ExpressRouteGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteGateway to guarantee forwards compatibility.
 */
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteGateway {
        pulumi.log.warn("ExpressRouteGateway is deprecated: azure-native:network/v20220701:ExpressRouteGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteGateway to guarantee forwards compatibility.")
        return new ExpressRouteGateway(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:ExpressRouteGateway';
     ...
     */
    public readonly autoScaleConfiguration!: pulumi.Output<outputs.network.v20220701.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    public readonly expressRouteConnections!: pulumi.Output<outputs.network.v20220701.ExpressRouteConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.v20220701.VirtualHubIdResponse>;
...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    autoScaleConfiguration?: pulumi.Input<inputs.network.v20220701.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>;
    /**
     * List of ExpressRoute connections to the ExpressRoute gateway.
     */
    expressRouteConnections?: pulumi.Input<pulumi.Input<inputs.network.v20220701.ExpressRouteConnectionArgs>[]>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    virtualHub: pulumi.Input<inputs.network.v20220701.VirtualHubIdArgs>;
}
