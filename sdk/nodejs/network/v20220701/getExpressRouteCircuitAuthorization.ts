...
export function getExpressRouteCircuitAuthorization(args: GetExpressRouteCircuitAuthorizationArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitAuthorizationResult> {
    pulumi.log.warn("getExpressRouteCircuitAuthorization is deprecated: azure-native:network/v20220701:ExpressRouteCircuitAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitAuthorization to guarantee forwards compatibility.")
