 ...
 *
 * @deprecated azure-native:network/v20220701:ExpressRouteCircuitConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCircuitConnection to guarantee forwards compatibility.
 */
export class ExpressRouteCircuitConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuitConnection {
        pulumi.log.warn("ExpressRouteCircuitConnection is deprecated: azure-native:network/v20220701:ExpressRouteCircuitConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCircuitConnection to guarantee forwards compatibility.")
        return new ExpressRouteCircuitConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:ExpressRouteCircuitConnection';
     ...
     */
    public readonly expressRouteCircuitPeering!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
     * IPv6 Address PrefixProperties of the express route circuit connection.
     */
    public readonly ipv6CircuitConnectionConfig!: pulumi.Output<outputs.network.v20220701.Ipv6CircuitConnectionConfigResponse | undefined>;
    /**
     ...
     */
    public readonly peerExpressRouteCircuitPeering!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
