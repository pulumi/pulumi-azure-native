 ...
 *
 * @deprecated azure-native:network/v20220701:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRoutePort to guarantee forwards compatibility.
 */
export class ExpressRoutePort extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRoutePort {
        pulumi.log.warn("ExpressRoutePort is deprecated: azure-native:network/v20220701:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRoutePort to guarantee forwards compatibility.")
        return new ExpressRoutePort(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:ExpressRoutePort';
     ...
     */
    public /*out*/ readonly circuits!: pulumi.Output<outputs.network.v20220701.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly links!: pulumi.Output<outputs.network.v20220701.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface ExpressRoutePortArgs {
     ...
     * The billing type of the ExpressRoutePort resource.
     */
    billingType?: pulumi.Input<string | enums.network.v20220701.ExpressRoutePortsBillingType>;
    /**
     * Encapsulation method on physical ports.
     */
    encapsulation?: pulumi.Input<string | enums.network.v20220701.ExpressRoutePortsEncapsulation>;
    /**
     ...
     * The set of physical links of the ExpressRoutePort resource.
     */
    links?: pulumi.Input<pulumi.Input<inputs.network.v20220701.ExpressRouteLinkArgs>[]>;
    /**
     * Resource location.
     */
