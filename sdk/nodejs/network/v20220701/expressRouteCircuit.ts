 ...
 *
 * @deprecated azure-native:network/v20220701:ExpressRouteCircuit is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCircuit to guarantee forwards compatibility.
 */
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuit {
        pulumi.log.warn("ExpressRouteCircuit is deprecated: azure-native:network/v20220701:ExpressRouteCircuit is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCircuit to guarantee forwards compatibility.")
        return new ExpressRouteCircuit(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:ExpressRouteCircuit';
     ...
     */
    public readonly authorizations!: pulumi.Output<outputs.network.v20220701.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly expressRoutePort!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly peerings!: pulumi.Output<outputs.network.v20220701.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceProviderProperties!: pulumi.Output<outputs.network.v20220701.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    public readonly sku!: pulumi.Output<outputs.network.v20220701.ExpressRouteCircuitSkuResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitArgs {
     ...
     * The list of authorizations.
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.network.v20220701.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    expressRoutePort?: pulumi.Input<inputs.network.v20220701.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The list of peerings.
     */
    peerings?: pulumi.Input<pulumi.Input<inputs.network.v20220701.ExpressRouteCircuitPeeringArgs>[]>;
    /**
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<inputs.network.v20220701.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource.
     */
    serviceProviderProvisioningState?: pulumi.Input<string | enums.network.v20220701.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    sku?: pulumi.Input<inputs.network.v20220701.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */
