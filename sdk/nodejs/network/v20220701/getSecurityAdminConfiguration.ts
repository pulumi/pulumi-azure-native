 ...
 */
/** @deprecated azure-native:network/v20220701:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityAdminConfiguration to guarantee forwards compatibility. */
export function getSecurityAdminConfiguration(args: GetSecurityAdminConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAdminConfigurationResult> {
    pulumi.log.warn("getSecurityAdminConfiguration is deprecated: azure-native:network/v20220701:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityAdminConfiguration to guarantee forwards compatibility.")
