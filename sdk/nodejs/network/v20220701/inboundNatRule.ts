...
export class InboundNatRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InboundNatRule {
        pulumi.log.warn("InboundNatRule is deprecated: azure-native:network/v20220701:InboundNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:InboundNatRule to guarantee forwards compatibility.")
        return new InboundNatRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:InboundNatRule';
     ...
     */
    public readonly backendAddressPool!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    public /*out*/ readonly backendIPConfiguration!: pulumi.Output<outputs.network.v20220701.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    public readonly frontendIPConfiguration!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
