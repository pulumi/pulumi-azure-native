 ...
 *
 * @deprecated azure-native:network/v20220701:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.
 */
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkSecurityGroup {
        pulumi.log.warn("NetworkSecurityGroup is deprecated: azure-native:network/v20220701:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.")
        return new NetworkSecurityGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:NetworkSecurityGroup';
     ...
     */
    public /*out*/ readonly defaultSecurityRules!: pulumi.Output<outputs.network.v20220701.SecurityRuleResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly flowLogs!: pulumi.Output<outputs.network.v20220701.FlowLogResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.network.v20220701.NetworkInterfaceResponse[]>;
    /**
     ...
     */
    public readonly securityRules!: pulumi.Output<outputs.network.v20220701.SecurityRuleResponse[] | undefined>;
    /**
     * A collection of references to subnets.
     */
    public /*out*/ readonly subnets!: pulumi.Output<outputs.network.v20220701.SubnetResponse[]>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityGroupArgs {
     ...
     * A collection of security rules of the network security group.
     */
    securityRules?: pulumi.Input<pulumi.Input<inputs.network.v20220701.SecurityRuleArgs>[]>;
    /**
     * Resource tags.
     */
