 ...
 *
 * @deprecated azure-native:network/v20220701:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PublicIPPrefix to guarantee forwards compatibility.
 */
export class PublicIPPrefix extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PublicIPPrefix {
        pulumi.log.warn("PublicIPPrefix is deprecated: azure-native:network/v20220701:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PublicIPPrefix to guarantee forwards compatibility.")
        return new PublicIPPrefix(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:PublicIPPrefix';
     ...
     */
    public readonly customIPPrefix!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.network.v20220701.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly ipTags!: pulumi.Output<outputs.network.v20220701.IpTagResponse[] | undefined>;
    /**
     * The reference to load balancer frontend IP configuration associated with the public IP prefix.
     */
    public /*out*/ readonly loadBalancerFrontendIpConfiguration!: pulumi.Output<outputs.network.v20220701.SubResourceResponse>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly natGateway!: pulumi.Output<outputs.network.v20220701.NatGatewayResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<outputs.network.v20220701.ReferencedPublicIpAddressResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.v20220701.PublicIPPrefixSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPPrefixArgs {
     ...
     * The customIpPrefix that this prefix is associated with.
     */
    customIPPrefix?: pulumi.Input<inputs.network.v20220701.SubResourceArgs>;
    /**
     * The extended location of the public ip address.
     */
     ...
     * The public IP prefix SKU.
     */
    sku?: pulumi.Input<inputs.network.v20220701.PublicIPPrefixSkuArgs>;
    /**
     * Resource tags.
     */
