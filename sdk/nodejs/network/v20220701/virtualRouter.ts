 ...
 *
 * @deprecated azure-native:network/v20220701:VirtualRouter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualRouter to guarantee forwards compatibility.
 */
export class VirtualRouter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualRouter {
        pulumi.log.warn("VirtualRouter is deprecated: azure-native:network/v20220701:VirtualRouter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualRouter to guarantee forwards compatibility.")
        return new VirtualRouter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:VirtualRouter';
     ...
     */
    public readonly hostedGateway!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    public readonly hostedSubnet!: pulumi.Output<outputs.network.v20220701.SubResourceResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly peerings!: pulumi.Output<outputs.network.v20220701.SubResourceResponse[]>;
    /**
...
export interface VirtualRouterArgs {
     ...
     * The Gateway on which VirtualRouter is hosted.
     */
    hostedGateway?: pulumi.Input<inputs.network.v20220701.SubResourceArgs>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    hostedSubnet?: pulumi.Input<inputs.network.v20220701.SubResourceArgs>;
    /**
     * Resource ID.
     */
