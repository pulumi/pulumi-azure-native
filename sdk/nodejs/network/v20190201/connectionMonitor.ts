 ...
 *
 * const connectionMonitor = new azurerm.network.v20190201.ConnectionMonitor("connectionMonitor", {
...
export class ConnectionMonitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190201:ConnectionMonitor';
...
export interface ConnectionMonitorArgs {
     ...
     * Describes the destination of connection monitor.
     */
    readonly destination: pulumi.Input<inputs.network.v20190201.ConnectionMonitorDestination>;
    /**
     * Connection monitor location.
     */
     ...
     * Describes the source of connection monitor.
     */
    readonly source: pulumi.Input<inputs.network.v20190201.ConnectionMonitorSource>;
    /**
     * Connection monitor tags.
     */
