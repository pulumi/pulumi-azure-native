...
export class P2sVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190201:P2sVpnGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190201.P2SVpnGatewayPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface P2sVpnGatewayArgs {
     ...
     * Properties of the P2SVpnGateway.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190201.P2SVpnGatewayProperties>;
    /**
