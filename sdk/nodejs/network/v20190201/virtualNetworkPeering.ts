...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190201:VirtualNetworkPeering';
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.network.v20190201.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.network.v20190201.SubResourceResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering. Possible values are 'Initiated', 'Connected', and 'Disconnected'.
     */
    readonly peeringState?: pulumi.Input<string | enums.network.v20190201.VirtualNetworkPeeringState>;
    /**
     * The provisioning state of the resource.
     */
     ...
     * The reference of the remote virtual network address space.
     */
    readonly remoteAddressSpace?: pulumi.Input<inputs.network.v20190201.AddressSpaceArgs>;
    /**
     * The reference of the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    readonly remoteVirtualNetwork?: pulumi.Input<inputs.network.v20190201.SubResourceArgs>;
    /**
