...
export function getVirtualNetworkTap(args: GetVirtualNetworkTapArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkTapResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190201:getVirtualNetworkTap", {
        "name": args.name,
...
export interface GetVirtualNetworkTapResult {
     ...
     */
    readonly properties: outputs.network.v20190201.VirtualNetworkTapPropertiesFormatResponse;
    /**
     * Resource tags.
     */
