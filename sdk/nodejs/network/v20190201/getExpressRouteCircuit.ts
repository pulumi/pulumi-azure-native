...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190201:getExpressRouteCircuit", {
        "name": args.name,
...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly properties: outputs.network.v20190201.ExpressRouteCircuitPropertiesFormatResponse;
    /**
     * The SKU.
     */
