...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190201:getPublicIPPrefix", {
        "expand": args.expand,
...
export interface GetPublicIPPrefixResult {
     ...
     */
    readonly loadBalancerFrontendIpConfiguration: outputs.network.v20190201.SubResourceInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPAddresses?: outputs.network.v20190201.ReferencedPublicIpAddressInvokeResponse[];
    /**
     ...
     */
    readonly sku?: outputs.network.v20190201.PublicIPPrefixSkuInvokeResponse;
    /**
     * Resource tags.
     */
