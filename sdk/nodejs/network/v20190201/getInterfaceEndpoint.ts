...
export function getInterfaceEndpoint(args: GetInterfaceEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfaceEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190201:getInterfaceEndpoint", {
        "name": args.name,
...
export interface GetInterfaceEndpointResult {
     ...
     */
    readonly properties: outputs.network.v20190201.InterfaceEndpointPropertiesResponse;
    /**
     * Resource tags.
     */
