 ...
 *
 * const p2sVpnServerConfiguration = new azurerm.network.v20190201.P2sVpnServerConfiguration("p2sVpnServerConfiguration", {
...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190201:P2sVpnServerConfiguration';
