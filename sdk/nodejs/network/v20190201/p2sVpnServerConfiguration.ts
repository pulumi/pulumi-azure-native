...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190201.P2SVpnServerConfigurationPropertiesResponse>;
...
export interface P2sVpnServerConfigurationArgs {
     ...
     * Properties of the P2SVpnServer configuration.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190201.P2SVpnServerConfigurationProperties>;
    /**
