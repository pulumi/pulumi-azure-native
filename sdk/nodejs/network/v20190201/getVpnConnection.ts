...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190201:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly ipsecPolicies?: outputs.network.v20190201.IpsecPolicyInvokeResponse[];
    /**
     ...
     */
    readonly remoteVpnSite?: outputs.network.v20190201.SubResourceInvokeResponse;
    /**
