...
export class ExpressRouteCircuitConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190201.ExpressRouteCircuitConnectionPropertiesFormatResponse>;
...
export interface ExpressRouteCircuitConnectionArgs {
     ...
     * Properties of the express route circuit connection.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190201.ExpressRouteCircuitConnectionPropertiesFormat>;
    /**
