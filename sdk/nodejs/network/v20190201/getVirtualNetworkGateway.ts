...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    pulumi.log.warn("getVirtualNetworkGateway is deprecated: azure-native:network/v20190201:VirtualNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:VirtualNetworkGateway to guarantee forwards compatibility.")
