...
export function getNatGateway(args: GetNatGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetNatGatewayResult> {
    pulumi.log.warn("getNatGateway is deprecated: azure-native:network/v20190201:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:NatGateway to guarantee forwards compatibility.")
