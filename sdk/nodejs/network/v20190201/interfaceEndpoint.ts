...
export class InterfaceEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InterfaceEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20190201:InterfaceEndpoint" }, { type: "azure-native:network:InterfaceEndpoint" }, { type: "azure-nextgen:network:InterfaceEndpoint" }, { type: "azure-native:network/latest:InterfaceEndpoint" }, { type: "azure-nextgen:network/latest:InterfaceEndpoint" }, { type: "azure-native:network/v20180801:InterfaceEndpoint" }, { type: "azure-nextgen:network/v20180801:InterfaceEndpoint" }, { type: "azure-native:network/v20181001:InterfaceEndpoint" }, { type: "azure-nextgen:network/v20181001:InterfaceEndpoint" }, { type: "azure-native:network/v20181101:InterfaceEndpoint" }, { type: "azure-nextgen:network/v20181101:InterfaceEndpoint" }, { type: "azure-native:network/v20181201:InterfaceEndpoint" }, { type: "azure-nextgen:network/v20181201:InterfaceEndpoint" }] };
...
export interface InterfaceEndpointArgs {
     ...
     * A reference to the service being brought into the virtual network.
     */
    readonly endpointService?: pulumi.Input<inputs.network.v20190201.EndpointService>;
    /**
     * Gets a unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The ID of the subnet from which the private IP will be allocated.
     */
    readonly subnet?: pulumi.Input<inputs.network.v20190201.Subnet>;
    /**
     * Resource tags.
     */
