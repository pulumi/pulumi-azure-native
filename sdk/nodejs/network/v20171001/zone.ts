...
export class Zone extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ZoneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Zone" }, { type: "azurerm:network/preview:Zone" }, { type: "azurerm:network/v20150504preview:Zone" }, { type: "azurerm:network/v20160401:Zone" }, { type: "azurerm:network/v20170901:Zone" }, { type: "azurerm:network/v20180301preview:Zone" }, { type: "azurerm:network/v20180501:Zone" }] };
