...
export class SecurityRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20171001.SecurityRulePropertiesFormatResponse>;
...
export interface SecurityRuleArgs {
     ...
     * Properties of the security rule
     */
    readonly properties?: pulumi.Input<inputs.network.v20171001.SecurityRulePropertiesFormat>;
    /**
