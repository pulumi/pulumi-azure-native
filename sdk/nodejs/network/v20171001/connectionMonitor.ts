 ...
 *
 * const connectionMonitor = new azurerm.network.v20171001.ConnectionMonitor("connectionMonitor", {
...
export class ConnectionMonitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20171001:ConnectionMonitor';
