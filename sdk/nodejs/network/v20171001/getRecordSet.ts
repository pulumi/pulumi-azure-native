...
azure-native:network/v20171001:RecordSet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180501:RecordSet to guarantee forwards compatibility. */
export function getRecordSet(args: GetRecordSetArgs, opts?: pulumi.InvokeOptions): Promise<GetRecordSetResult> {
    pulumi.log.warn("getRecordSet is deprecated: Version 2017-10-01 will be removed in v2 of the provider.\nazure-native:network/v20171001:RecordSet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180501:RecordSet to guarantee forwards compatibility.")
