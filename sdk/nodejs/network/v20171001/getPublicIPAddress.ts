...
export function getPublicIPAddress(args: GetPublicIPAddressArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPAddressResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20171001:getPublicIPAddress", {
        "expand": args.expand,
...
export interface GetPublicIPAddressResult {
     ...
     */
    readonly dnsSettings?: outputs.network.v20171001.PublicIPAddressDnsSettingsInvokeResponse;
    /**
     ...
     */
    readonly ipConfiguration: outputs.network.v20171001.IPConfigurationInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.v20171001.PublicIPAddressSkuInvokeResponse;
    /**
     * Resource tags.
     */
