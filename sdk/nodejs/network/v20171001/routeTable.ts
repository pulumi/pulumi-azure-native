...
export class RouteTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RouteTable {
        pulumi.log.warn("RouteTable is deprecated: Version v20171001 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.")
        return new RouteTable(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20171001:RouteTable';
     ...
     */
    public readonly routes!: pulumi.Output<outputs.network.v20171001.RouteResponse[] | undefined>;
    /**
     * A collection of references to subnets.
     */
    public /*out*/ readonly subnets!: pulumi.Output<outputs.network.v20171001.SubnetResponse[]>;
    /**
     * Resource tags.
     */
