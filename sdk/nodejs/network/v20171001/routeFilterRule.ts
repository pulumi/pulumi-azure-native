...
export class RouteFilterRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20171001:RouteFilterRule';
...
export interface RouteFilterRuleArgs {
     ...
     * The access type of the rule. Valid values are: 'Allow', 'Deny'
     */
    readonly access: pulumi.Input<string | enums.network.v20171001.Access>;
    /**
     * The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020']
     */
     ...
     * The rule type of the rule. Valid value is: 'Community'
     */
    readonly routeFilterRuleType: pulumi.Input<string | enums.network.v20171001.RouteFilterRuleType>;
    /**
