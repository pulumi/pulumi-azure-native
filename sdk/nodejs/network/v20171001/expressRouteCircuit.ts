...
azure-native:network/v20171001:ExpressRouteCircuit is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20181201:ExpressRouteCircuit to guarantee forwards compatibility.
 */
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExpressRouteCircuit {
        pulumi.log.warn("ExpressRouteCircuit is deprecated: Version 2017-10-01 will be removed in v2 of the provider.\nazure-native:network/v20171001:ExpressRouteCircuit is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20181201:ExpressRouteCircuit to guarantee forwards compatibility.")
