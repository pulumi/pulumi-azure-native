...
export class InboundNatRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20171001.InboundNatRulePropertiesFormatResponse>;
...
export interface InboundNatRuleArgs {
     ...
     * Properties of load balancer inbound nat rule.
     */
    readonly properties?: pulumi.Input<inputs.network.v20171001.InboundNatRulePropertiesFormat>;
    /**
