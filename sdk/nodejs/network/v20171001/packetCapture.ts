...
export class PacketCapture extends pulumi.CustomResource {
    ...
    public /*out*/ readonly filters!: pulumi.Output<outputs.network.v20171001.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly storageLocation!: pulumi.Output<outputs.network.v20171001.PacketCaptureStorageLocationResponse>;
    /**
    ...
    constructor(name: string, args: PacketCaptureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.network.v20171001.packetCaptureParametersArgsProvideDefaults) : undefined) : undefined;
...
export interface PacketCaptureArgs {
     ...
     */
    properties: pulumi.Input<inputs.network.v20171001.PacketCaptureParametersArgs>;
    /**
