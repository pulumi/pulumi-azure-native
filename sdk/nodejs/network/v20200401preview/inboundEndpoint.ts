...
export class InboundEndpoint extends pulumi.CustomResource {
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20200401preview.InboundEndpointIPConfigurationResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: InboundEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20220701:InboundEndpoint" }, { type: "azure-native:network/v20230701preview:InboundEndpoint" }, { type: "azure-native:network:InboundEndpoint" }] };
