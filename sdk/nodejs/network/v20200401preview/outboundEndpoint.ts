...
export class OutboundEndpoint extends pulumi.CustomResource {
     ...
     */
    public readonly subnet!: pulumi.Output<outputs.network.v20200401preview.SubResourceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: OutboundEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20220701:OutboundEndpoint" }] };
