 ...
 *
 * const virtualNetworkLink = new azure_native.network.v20200401preview.VirtualNetworkLink("virtualNetworkLink", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:network/v20200401preview:VirtualNetworkLink sampleVirtualNetworkLink /subscriptions/abdd4249-9f34-4cc6-8e42-c2e32110603e/resourceGroups/sampleResourceGroup/providers/Microsoft.Network/dnsForwardingRuleset/sampleDnsForwardingRuleset/virtualNetworkLinks/sampleVirtualNetworkLink 
 * ```
 */
export class VirtualNetworkLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200401preview:VirtualNetworkLink';
    ...
    constructor(name: string, args: VirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VirtualNetworkLink" }, { type: "azure-native:network/v20220701:VirtualNetworkLink" }] };
