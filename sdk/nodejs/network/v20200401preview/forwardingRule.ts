...
export class ForwardingRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200401preview:ForwardingRule';
     ...
     */
    public readonly targetDnsServers!: pulumi.Output<outputs.network.v20200401preview.TargetDnsServerResponse[]>;
    /**
    ...
    constructor(name: string, args: ForwardingRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ForwardingRule" }, { type: "azure-native:network/v20220701:ForwardingRule" }] };
