 ...
 *
 * const dnsForwardingRuleset = new azure_native.network.v20200401preview.DnsForwardingRuleset("dnsForwardingRuleset", {
...
export class DnsForwardingRuleset extends pulumi.CustomResource {
     ...
     */
    public readonly dnsResolverOutboundEndpoints!: pulumi.Output<outputs.network.v20200401preview.SubResourceResponse[] | undefined>;
    /**
