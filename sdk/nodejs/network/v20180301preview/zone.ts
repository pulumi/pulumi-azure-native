...
export class Zone extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Zone {
        pulumi.log.warn("Zone is deprecated: Version 2018-03-01-preview will be removed in v2 of the provider.")
    ...
    constructor(name: string, args: ZoneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:Zone" }, { type: "azure-native:network/v20150504preview:Zone" }, { type: "azure-native:network/v20160401:Zone" }, { type: "azure-native:network/v20170901:Zone" }, { type: "azure-native:network/v20171001:Zone" }, { type: "azure-native:network/v20180501:Zone" }] };
