...
export function getAdminRule(args: GetAdminRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetAdminRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getAdminRule", {
...
export interface GetAdminRuleResult {
     ...
     */
    readonly destinations?: outputs.network.v20230201.AddressPrefixItemResponse[];
    /**
     ...
     */
    readonly sources?: outputs.network.v20230201.AddressPrefixItemResponse[];
    /**
     * The system metadata related to this resource.
     */
    readonly systemData: outputs.network.v20230201.SystemDataResponse;
    /**
     * Resource type.
     */
...
export function getAdminRuleOutput(args: GetAdminRuleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAdminRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230201:getAdminRule", {
        "configurationName": args.configurationName,
        "networkManagerName": args.networkManagerName,
        "resourceGroupName": args.resourceGroupName,
        "ruleCollectionName": args.ruleCollectionName,
