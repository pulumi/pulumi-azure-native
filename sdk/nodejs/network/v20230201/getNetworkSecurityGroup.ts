...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules: outputs.network.v20230201.SecurityRuleResponse[];
    /**
     ...
     */
    readonly flowLogs: outputs.network.v20230201.FlowLogResponse[];
    /**
     ...
     */
    readonly securityRules?: outputs.network.v20230201.SecurityRuleResponse[];
    /**
     * A collection of references to subnets.
     */
    readonly subnets: outputs.network.v20230201.SubnetResponse[];
    /**
     * Resource tags.
     */
...
export function getNetworkSecurityGroupOutput(args: GetNetworkSecurityGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNetworkSecurityGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230201:getNetworkSecurityGroup", {
        "expand": args.expand,
        "networkSecurityGroupName": args.networkSecurityGroupName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
