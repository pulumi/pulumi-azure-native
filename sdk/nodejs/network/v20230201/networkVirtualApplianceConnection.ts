...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
     ...
     */
    public readonly routingConfiguration!: pulumi.Output<outputs.network.v20230201.RoutingConfigurationNfvResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkVirtualApplianceConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20221101:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20230401:NetworkVirtualApplianceConnection" }] };
...
export interface NetworkVirtualApplianceConnectionArgs {
     ...
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    routingConfiguration?: pulumi.Input<inputs.network.v20230201.RoutingConfigurationNfvArgs>;
    /**
     * Unique identifier for the connection.
     */
