...
export interface GetExpressRouteConnectionResult {
     ...
     */
    readonly expressRouteCircuitPeering: outputs.network.v20230201.ExpressRouteCircuitPeeringIdResponse;
    /**
     ...
     */
    readonly routingConfiguration?: outputs.network.v20230201.RoutingConfigurationResponse;
    /**
...
export function getExpressRouteConnectionOutput(args: GetExpressRouteConnectionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetExpressRouteConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network/v20230201:getExpressRouteConnection", {
        "connectionName": args.connectionName,
        "expressRouteGatewayName": args.expressRouteGatewayName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
