...
export class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    public readonly autoScaleConfiguration!: pulumi.Output<outputs.network.v20230201.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    public readonly expressRouteConnections!: pulumi.Output<outputs.network.v20230201.ExpressRouteConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.v20230201.VirtualHubIdResponse>;
