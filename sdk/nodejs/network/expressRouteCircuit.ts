...
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:ExpressRouteCircuit';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.ExpressRouteCircuitPropertiesFormatResponse>;
    /**
     * The SKU.
     */
...
export interface ExpressRouteCircuitState {
     ...
     * Properties of the express route circuit.
     */
    readonly properties: pulumi.Input<inputs.network.ExpressRouteCircuitPropertiesFormatResponse>;
    /**
     * The SKU.
     */
    readonly sku?: pulumi.Input<inputs.network.ExpressRouteCircuitSkuResponse>;
    /**
     * Resource tags.
     */
...
export interface ExpressRouteCircuitArgs {
     ...
     * Properties of the express route circuit.
     */
    readonly properties?: pulumi.Input<inputs.network.ExpressRouteCircuitPropertiesFormat>;
    /**
