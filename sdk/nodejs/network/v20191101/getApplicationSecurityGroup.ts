...
export function getApplicationSecurityGroup(args: GetApplicationSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20191101:getApplicationSecurityGroup", {
        "name": args.name,
...
export interface GetApplicationSecurityGroupResult {
     ...
     */
    readonly properties: outputs.network.v20191101.ApplicationSecurityGroupPropertiesFormatResponse;
    /**
     * Resource tags.
     */
