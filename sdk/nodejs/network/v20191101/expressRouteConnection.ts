...
export class ExpressRouteConnection extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20191101.ExpressRouteConnectionPropertiesResponse>;
...
export interface ExpressRouteConnectionArgs {
     ...
     * Properties of the express route connection.
     */
    readonly properties?: pulumi.Input<inputs.network.v20191101.ExpressRouteConnectionProperties>;
    /**
