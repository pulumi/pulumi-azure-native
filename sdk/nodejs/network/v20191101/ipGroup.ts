...
export class IpGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20191101:IpGroup';
    ...
    constructor(name: string, args: IpGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            if ((!args || args.ipGroupsName === undefined) && !(opts && opts.urn)) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:IpGroup" }, { type: "azure-nextgen:network/latest:IpGroup" }, { type: "azure-nextgen:network/v20190901:IpGroup" }, { type: "azure-nextgen:network/v20191201:IpGroup" }, { type: "azure-nextgen:network/v20200301:IpGroup" }, { type: "azure-nextgen:network/v20200401:IpGroup" }, { type: "azure-nextgen:network/v20200501:IpGroup" }, { type: "azure-nextgen:network/v20200601:IpGroup" }, { type: "azure-nextgen:network/v20200701:IpGroup" }, { type: "azure-nextgen:network/v20200801:IpGroup" }] };
