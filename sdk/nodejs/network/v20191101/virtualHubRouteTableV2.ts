 ...
 *
 * @deprecated azure-native:network/v20191101:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualHubRouteTableV2 to guarantee forwards compatibility.
 */
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHubRouteTableV2 {
        pulumi.log.warn("VirtualHubRouteTableV2 is deprecated: azure-native:network/v20191101:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualHubRouteTableV2 to guarantee forwards compatibility.")
        return new VirtualHubRouteTableV2(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20191101:VirtualHubRouteTableV2';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.v20191101.VirtualHubRouteV2Response[] | undefined>;
...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20191101.VirtualHubRouteV2Args>[]>;
    /**
