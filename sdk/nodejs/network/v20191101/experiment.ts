...
export class Experiment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExperimentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20191101:Experiment" }, { type: "azure-native:network:Experiment" }, { type: "azure-nextgen:network:Experiment" }, { type: "azure-native:network/latest:Experiment" }, { type: "azure-nextgen:network/latest:Experiment" }] };
...
export interface ExperimentArgs {
     ...
     * The endpoint A of an experiment
     */
    readonly endpointA?: pulumi.Input<inputs.network.v20191101.ExperimentEndpoint>;
    /**
     * The endpoint B of an experiment
     */
    readonly endpointB?: pulumi.Input<inputs.network.v20191101.ExperimentEndpoint>;
    /**
