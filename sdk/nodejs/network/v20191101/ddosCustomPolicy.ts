 ...
 *
 * const ddosCustomPolicy = new azurerm.network.v20191101.DdosCustomPolicy("ddosCustomPolicy", {
...
export class DdosCustomPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20191101:DdosCustomPolicy';
...
export interface DdosCustomPolicyArgs {
     ...
     * The protocol-specific DDoS policy customization parameters.
     */
    readonly protocolCustomSettings?: pulumi.Input<pulumi.Input<inputs.network.v20191101.ProtocolCustomSettingsFormat>[]>;
    /**
