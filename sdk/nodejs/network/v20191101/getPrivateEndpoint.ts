...
export function getPrivateEndpoint(args: GetPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20191101:getPrivateEndpoint", {
        "name": args.name,
...
export interface GetPrivateEndpointResult {
     ...
     */
    readonly properties: outputs.network.v20191101.PrivateEndpointPropertiesResponse;
    /**
     * Resource tags.
     */
