...
export function getExperiment(args: GetExperimentArgs, opts?: pulumi.InvokeOptions): Promise<GetExperimentResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20191101:getExperiment", {
...
export interface GetExperimentResult {
     ...
     */
    readonly endpointA?: outputs.network.v20191101.EndpointInvokeResponse;
    /**
     * The endpoint B of an experiment
     */
    readonly endpointB?: outputs.network.v20191101.EndpointInvokeResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
