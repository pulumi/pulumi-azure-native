...
export function getFirewallPolicyRuleGroup(args: GetFirewallPolicyRuleGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20191101:getFirewallPolicyRuleGroup", {
...
export interface GetFirewallPolicyRuleGroupResult {
     ...
     */
    readonly rules?: outputs.network.v20191101.FirewallPolicyFilterRuleInvokeResponse | outputs.network.v20191101.FirewallPolicyNatRuleInvokeResponse[];
    /**
     * Rule Group type.
     */
