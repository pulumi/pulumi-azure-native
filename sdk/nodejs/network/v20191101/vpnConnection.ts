...
export interface VpnConnectionArgs {
     ...
     * The IPSec Policies to be considered by this connection.
     */
    ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.v20191101.IpsecPolicyArgs>[]>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * Id of the connected vpn site.
     */
    remoteVpnSite?: pulumi.Input<inputs.network.v20191101.SubResourceArgs>;
    /**
     ...
     * Connection protocol used for this connection.
     */
    vpnConnectionProtocolType?: pulumi.Input<string | enums.network.v20191101.VirtualNetworkGatewayConnectionProtocol>;
    /**
     * List of all vpn site link connections to the gateway.
     */
    vpnLinkConnections?: pulumi.Input<pulumi.Input<inputs.network.v20191101.VpnSiteLinkConnectionArgs>[]>;
}
