...
export function getFlowLog(args: GetFlowLogArgs, opts?: pulumi.InvokeOptions): Promise<GetFlowLogResult> {
    pulumi.log.warn("getFlowLog is deprecated: azure-native:network/v20191101:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FlowLog to guarantee forwards compatibility.")
