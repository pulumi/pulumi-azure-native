 ...
 */
/** @deprecated azure-native:network/v20191101:P2sVpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:P2sVpnGateway to guarantee forwards compatibility. */
export function getP2sVpnGateway(args: GetP2sVpnGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetP2sVpnGatewayResult> {
    pulumi.log.warn("getP2sVpnGateway is deprecated: azure-native:network/v20191101:P2sVpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:P2sVpnGateway to guarantee forwards compatibility.")
