 ...
 * VirtualHub Resource.
 *
 * @deprecated azure-native:network/v20191101:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:VirtualHub to guarantee forwards compatibility.
 */
export class VirtualHub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualHub {
        pulumi.log.warn("VirtualHub is deprecated: azure-native:network/v20191101:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:VirtualHub to guarantee forwards compatibility.")
