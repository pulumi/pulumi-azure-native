...
export class ExpressRouteCrossConnectionPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20191101:ExpressRouteCrossConnectionPeering';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20191101.ExpressRouteCrossConnectionPeeringPropertiesResponse>;
...
export interface ExpressRouteCrossConnectionPeeringArgs {
     ...
     * Properties of the express route cross connection peering.
     */
    readonly properties?: pulumi.Input<inputs.network.v20191101.ExpressRouteCrossConnectionPeeringProperties>;
    /**
