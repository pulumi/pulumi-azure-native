...
azure-native:network/v20170601:VirtualNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:VirtualNetworkGateway to guarantee forwards compatibility. */
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    pulumi.log.warn("getVirtualNetworkGateway is deprecated: Version 2017-06-01 will be removed in v2 of the provider.\nazure-native:network/v20170601:VirtualNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:VirtualNetworkGateway to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:network/v20170601:getVirtualNetworkGateway", {
