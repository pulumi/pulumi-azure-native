...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170601:LocalNetworkGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20170601.LocalNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Properties of the local network gateway.
     */
    readonly properties: pulumi.Input<inputs.network.v20170601.LocalNetworkGatewayPropertiesFormat>;
    /**
