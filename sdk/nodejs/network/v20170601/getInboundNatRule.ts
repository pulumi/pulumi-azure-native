...
export function getInboundNatRule(args: GetInboundNatRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetInboundNatRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20170601:getInboundNatRule", {
        "expand": args.expand,
...
export interface GetInboundNatRuleResult {
     ...
     */
    readonly backendIPConfiguration: outputs.network.v20170601.NetworkInterfaceIPConfigurationInvokeResponse;
    /**
     ...
     */
    readonly frontendIPConfiguration?: outputs.network.v20170601.SubResourceInvokeResponse;
    /**
