...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20170601:getExpressRouteCircuit", {
        "name": args.name,
...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly properties: outputs.network.v20170601.ExpressRouteCircuitPropertiesFormatResponse;
    /**
     * The SKU.
     */
