...
export class SecurityRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170601:SecurityRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20170601.SecurityRulePropertiesFormatResponse>;
...
export interface SecurityRuleArgs {
     ...
     * Properties of the security rule
     */
    readonly properties?: pulumi.Input<inputs.network.v20170601.SecurityRulePropertiesFormat>;
    /**
