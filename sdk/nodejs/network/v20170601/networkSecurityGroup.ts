...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170601:NetworkSecurityGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20170601.NetworkSecurityGroupPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkSecurityGroupArgs {
     ...
     * Properties of the network security group
     */
    readonly properties?: pulumi.Input<inputs.network.v20170601.NetworkSecurityGroupPropertiesFormat>;
    /**
