...
export function getSecurityRule(args: GetSecurityRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20170601:getSecurityRule", {
        "name": args.name,
...
export interface GetSecurityRuleResult {
     ...
     */
    readonly properties: outputs.network.v20170601.SecurityRulePropertiesFormatResponse;
}
