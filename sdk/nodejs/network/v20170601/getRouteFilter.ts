...
export function getRouteFilter(args: GetRouteFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20170601:getRouteFilter", {
        "expand": args.expand,
...
export interface GetRouteFilterResult {
     ...
     */
    readonly peerings?: outputs.network.v20170601.ExpressRouteCircuitPeeringInvokeResponse[];
    /**
     ...
     */
    readonly rules?: outputs.network.v20170601.RouteFilterRuleInvokeResponse[];
    /**
     * Resource tags.
     */
