...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170601:NetworkWatcher';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20170601.NetworkWatcherPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkWatcherArgs {
     ...
     * The network watcher properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20170601.NetworkWatcherPropertiesFormat>;
    /**
