...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:RouteFilter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.RouteFilterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterState {
     ...
     * Properties of the route filter.
     */
    readonly properties: pulumi.Input<inputs.network.RouteFilterPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Properties of the route filter.
     */
    readonly properties?: pulumi.Input<inputs.network.RouteFilterPropertiesFormat>;
    /**
