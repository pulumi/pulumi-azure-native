...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.network.NetworkVirtualApplianceConnectionPropertiesResponse>;
    ...
    constructor(name: string, args: NetworkVirtualApplianceConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20230601:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20230901:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20231101:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20240101:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20240301:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20240501:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20240701:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20241001:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20250101:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20250301:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20250501:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20250701:NetworkVirtualApplianceConnection" }] };
