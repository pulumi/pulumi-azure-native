...
export class VirtualWan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:VirtualWan';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.VirtualWanPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface VirtualWanArgs {
     ...
     * Properties of the virtual WAN.
     */
    readonly properties?: pulumi.Input<inputs.network.VirtualWanProperties>;
    /**
