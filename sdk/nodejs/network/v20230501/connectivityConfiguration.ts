...
export class ConnectivityConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<outputs.network.v20230501.ConnectivityGroupItemResponse[]>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<outputs.network.v20230501.HubResponse[] | undefined>;
    /**
