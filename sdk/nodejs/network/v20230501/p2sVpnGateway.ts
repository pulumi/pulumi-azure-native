...
export class P2sVpnGateway extends pulumi.CustomResource {
     ...
     */
    public readonly p2SConnectionConfigurations!: pulumi.Output<outputs.network.v20230501.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vpnClientConnectionHealth!: pulumi.Output<outputs.network.v20230501.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    public readonly vpnServerConfiguration!: pulumi.Output<outputs.network.v20230501.SubResourceResponse | undefined>;
