...
export class RouteMap extends pulumi.CustomResource {
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.v20230501.RouteMapRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface RouteMapArgs {
     ...
     * List of RouteMap rules to be applied.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.v20230501.RouteMapRuleArgs>[]>;
    /**
