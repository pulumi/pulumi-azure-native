...
export class VirtualHubIpConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly publicIPAddress!: pulumi.Output<outputs.network.v20230501.PublicIPAddressResponse | undefined>;
    /**
     * The reference to the subnet resource.
     */
    public readonly subnet!: pulumi.Output<outputs.network.v20230501.SubnetResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualHubIpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["subnet"] = args ? (args.subnet ? pulumi.output(args.subnet).apply(inputs.network.v20230501.subnetArgsProvideDefaults) : undefined) : undefined;
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    privateIPAllocationMethod?: pulumi.Input<string | enums.network.v20230501.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    publicIPAddress?: pulumi.Input<inputs.network.v20230501.PublicIPAddressArgs>;
    /**
     ...
     * The reference to the subnet resource.
     */
    subnet?: pulumi.Input<inputs.network.v20230501.SubnetArgs>;
    /**
