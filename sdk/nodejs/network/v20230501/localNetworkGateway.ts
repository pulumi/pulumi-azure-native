...
export class LocalNetworkGateway extends pulumi.CustomResource {
     ...
     */
    public readonly bgpSettings!: pulumi.Output<outputs.network.v20230501.BgpSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.v20230501.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network gateway's BGP speaker settings.
     */
    bgpSettings?: pulumi.Input<inputs.network.v20230501.BgpSettingsArgs>;
    /**
     * FQDN of local network gateway.
     */
     ...
     * Local network site address space.
     */
    localNetworkAddressSpace?: pulumi.Input<inputs.network.v20230501.AddressSpaceArgs>;
    /**
