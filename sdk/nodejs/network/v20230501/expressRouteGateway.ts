...
export class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    public readonly autoScaleConfiguration!: pulumi.Output<outputs.network.v20230501.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    public readonly expressRouteConnections!: pulumi.Output<outputs.network.v20230501.ExpressRouteConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.v20230501.VirtualHubIdResponse>;
