...
export function getRouteTable(args: GetRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteTableResult> {
    pulumi.log.warn("getRouteTable is deprecated: Version 2017-08-01 will be removed in v2 of the provider.\nazure-native:network/v20170801:RouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:RouteTable to guarantee forwards compatibility.")
...
export interface GetRouteTableResult {
     ...
     */
    readonly routes?: outputs.network.v20170801.RouteResponse[];
    /**
