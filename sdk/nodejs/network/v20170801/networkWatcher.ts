 ...
 *
 * const networkWatcher = new azurerm.network.v20170801.NetworkWatcher("networkWatcher", {
 *     location: "eastus",
...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20170801:NetworkWatcher';
