...
export class RouteTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RouteTable {
        pulumi.log.warn("RouteTable is deprecated: Version 2017-08-01 will be removed in v2 of the provider.")
        return new RouteTable(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20170801:RouteTable';
     ...
     */
    public readonly routes!: pulumi.Output<outputs.network.v20170801.RouteResponse[] | undefined>;
    /**
