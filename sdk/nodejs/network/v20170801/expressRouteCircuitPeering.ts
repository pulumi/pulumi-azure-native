...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20170801:ExpressRouteCircuitPeering';
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The IPv6 peering configuration.
     */
    readonly ipv6PeeringConfig?: pulumi.Input<inputs.network.v20170801.Ipv6ExpressRouteCircuitPeeringConfig>;
    /**
     * Gets whether the provider or the customer last modified the peering.
     */
     ...
     * The Microsoft peering configuration.
     */
    readonly microsoftPeeringConfig?: pulumi.Input<inputs.network.v20170801.ExpressRouteCircuitPeeringConfig>;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The reference of the RouteFilter resource.
     */
    readonly routeFilter?: pulumi.Input<inputs.network.v20170801.RouteFilter>;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    readonly stats?: pulumi.Input<inputs.network.v20170801.ExpressRouteCircuitStats>;
    /**
     * The VLAN ID.
     */
