...
export function getVirtualNetworkGatewayConnection(args: GetVirtualNetworkGatewayConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayConnectionResult> {
    pulumi.log.warn("getVirtualNetworkGatewayConnection is deprecated: Version 2017-08-01 will be removed in v2 of the provider.")
...
export interface GetVirtualNetworkGatewayConnectionResult {
     ...
     */
    readonly properties: outputs.network.v20170801.VirtualNetworkGatewayConnectionPropertiesFormatResponse;
    /**
     * Resource tags.
     */
