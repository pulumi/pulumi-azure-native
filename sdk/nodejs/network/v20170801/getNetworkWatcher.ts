...
export function getNetworkWatcher(args: GetNetworkWatcherArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkWatcherResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20170801:getNetworkWatcher", {
        "name": args.name,
...
export interface GetNetworkWatcherResult {
     ...
     */
    readonly properties: outputs.network.v20170801.NetworkWatcherPropertiesFormatResponse;
    /**
     * Resource tags.
     */
