...
export function getPublicIPAddress(args: GetPublicIPAddressArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPAddressResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20170801:getPublicIPAddress", {
        "expand": args.expand,
...
export interface GetPublicIPAddressResult {
     ...
     */
    readonly dnsSettings?: outputs.network.v20170801.PublicIPAddressDnsSettingsInvokeResponse;
    /**
     ...
     */
    readonly ipConfiguration: outputs.network.v20170801.IPConfigurationInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.v20170801.PublicIPAddressSkuInvokeResponse;
    /**
     * Resource tags.
     */
