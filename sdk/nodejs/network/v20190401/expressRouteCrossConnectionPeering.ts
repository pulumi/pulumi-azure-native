...
export class ExpressRouteCrossConnectionPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190401:ExpressRouteCrossConnectionPeering';
...
export interface ExpressRouteCrossConnectionPeeringArgs {
     ...
     * The IPv6 peering configuration.
     */
    readonly ipv6PeeringConfig?: pulumi.Input<inputs.network.v20190401.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets whether the provider or the customer last modified the peering.
     */
     ...
     * The Microsoft peering configuration.
     */
    readonly microsoftPeeringConfig?: pulumi.Input<inputs.network.v20190401.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    readonly peeringType?: pulumi.Input<string | enums.network.v20190401.ExpressRoutePeeringType>;
    /**
     * The primary address prefix.
     */
     ...
     * The peering state.
     */
    readonly state?: pulumi.Input<string | enums.network.v20190401.ExpressRoutePeeringState>;
    /**
     * The VLAN ID.
     */
