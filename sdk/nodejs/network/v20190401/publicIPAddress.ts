...
export class PublicIPAddress extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190401.PublicIPAddressPropertiesFormatResponse>;
    /**
...
export interface PublicIPAddressArgs {
     ...
     * Public IP address properties.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190401.PublicIPAddressPropertiesFormat>;
    /**
