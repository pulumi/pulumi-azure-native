 ...
 *
 * const p2sVpnGateway = new azurerm.network.v20190401.P2sVpnGateway("p2sVpnGateway", {
 *     customRoutes: {
...
export class P2sVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190401:P2sVpnGateway';
    ...
    constructor(name: string, args: P2sVpnGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:P2sVpnGateway" }, { type: "azurerm:network/v20180801:P2sVpnGateway" }, { type: "azurerm:network/v20181001:P2sVpnGateway" }, { type: "azurerm:network/v20181101:P2sVpnGateway" }, { type: "azurerm:network/v20181201:P2sVpnGateway" }, { type: "azurerm:network/v20190201:P2sVpnGateway" }, { type: "azurerm:network/v20190601:P2sVpnGateway" }, { type: "azurerm:network/v20190701:P2sVpnGateway" }, { type: "azurerm:network/v20190801:P2sVpnGateway" }, { type: "azurerm:network/v20190901:P2sVpnGateway" }, { type: "azurerm:network/v20191101:P2sVpnGateway" }, { type: "azurerm:network/v20191201:P2sVpnGateway" }, { type: "azurerm:network/v20200301:P2sVpnGateway" }, { type: "azurerm:network/v20200401:P2sVpnGateway" }, { type: "azurerm:network/v20200501:P2sVpnGateway" }, { type: "azurerm:network/v20200601:P2sVpnGateway" }] };
