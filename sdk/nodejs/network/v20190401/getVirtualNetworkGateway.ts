...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190401:getVirtualNetworkGateway", {
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly bgpSettings?: outputs.network.v20190401.BgpSettingsInvokeResponse;
    /**
     ...
     */
    readonly customRoutes?: outputs.network.v20190401.AddressSpaceInvokeResponse;
    /**
     ...
     */
    readonly gatewayDefaultSite?: outputs.network.v20190401.SubResourceInvokeResponse;
    /**
     ...
     */
    readonly ipConfigurations?: outputs.network.v20190401.VirtualNetworkGatewayIPConfigurationInvokeResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.v20190401.VirtualNetworkGatewaySkuInvokeResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly vpnClientConfiguration?: outputs.network.v20190401.VpnClientConfigurationInvokeResponse;
    /**
     * The type of this virtual network gateway.
     */
