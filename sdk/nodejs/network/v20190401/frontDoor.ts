...
export class FrontDoor extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190401.FrontDoorPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface FrontDoorArgs {
     ...
     * Properties of the Front Door Load Balancer
     */
    readonly properties?: pulumi.Input<inputs.network.v20190401.FrontDoorProperties>;
    /**
