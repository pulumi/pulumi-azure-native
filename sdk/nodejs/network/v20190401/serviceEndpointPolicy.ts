...
export class ServiceEndpointPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:network/v20190401:ServiceEndpointPolicy';
