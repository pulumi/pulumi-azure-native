...
export class ServiceEndpointPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190401.ServiceEndpointPolicyPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface ServiceEndpointPolicyArgs {
     ...
     * Properties of the service end point policy.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190401.ServiceEndpointPolicyPropertiesFormat>;
    /**
