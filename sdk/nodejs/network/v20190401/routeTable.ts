...
export interface RouteTableArgs {
     ...
     * Collection of routes contained within a route table.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputs.network.v20190401.RouteArgs>[]>;
    /**
     * Resource tags.
     */
