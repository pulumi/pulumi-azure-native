...
export function getServiceEndpointPolicy(args: GetServiceEndpointPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceEndpointPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190401:getServiceEndpointPolicy", {
        "expand": args.expand,
...
export interface GetServiceEndpointPolicyResult {
     ...
     */
    readonly serviceEndpointPolicyDefinitions?: outputs.network.v20190401.ServiceEndpointPolicyDefinitionInvokeResponse[];
    /**
     * A collection of references to subnets.
     */
    readonly subnets: outputs.network.v20190401.SubnetInvokeResponse[];
    /**
     * Resource tags.
     */
