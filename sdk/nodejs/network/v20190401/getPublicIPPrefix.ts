...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20190401:getPublicIPPrefix", {
        "expand": args.expand,
...
export interface GetPublicIPPrefixResult {
     ...
     */
    readonly loadBalancerFrontendIpConfiguration: outputs.network.v20190401.SubResourceInvokeResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPAddresses?: outputs.network.v20190401.ReferencedPublicIpAddressInvokeResponse[];
    /**
     ...
     */
    readonly sku?: outputs.network.v20190401.PublicIPPrefixSkuInvokeResponse;
    /**
     * Resource tags.
     */
