...
export class PrivateLinkService extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PrivateLinkServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20190601:PrivateLinkService" }, { type: "azurerm:network/v20190701:PrivateLinkService" }, { type: "azurerm:network/v20190801:PrivateLinkService" }, { type: "azurerm:network/v20190901:PrivateLinkService" }, { type: "azurerm:network/v20191101:PrivateLinkService" }, { type: "azurerm:network/v20191201:PrivateLinkService" }, { type: "azurerm:network/v20200301:PrivateLinkService" }, { type: "azurerm:network/v20200401:PrivateLinkService" }, { type: "azurerm:network/v20200501:PrivateLinkService" }, { type: "azurerm:network/v20200601:PrivateLinkService" }] };
