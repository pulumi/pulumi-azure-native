...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20190401:VirtualNetworkPeering';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.v20190401.VirtualNetworkPeeringPropertiesFormatResponse>;
...
export interface VirtualNetworkPeeringArgs {
     ...
     * Properties of the virtual network peering.
     */
    readonly properties?: pulumi.Input<inputs.network.v20190401.VirtualNetworkPeeringPropertiesFormat>;
    /**
