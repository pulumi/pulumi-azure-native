...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    pulumi.log.warn("getExpressRouteCircuit is deprecated: azure-native:network/v20190401:ExpressRouteCircuit is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:ExpressRouteCircuit to guarantee forwards compatibility.")
