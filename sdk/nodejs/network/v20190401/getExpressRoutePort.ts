...
export function getExpressRoutePort(args: GetExpressRoutePortArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/v20190401:getExpressRoutePort", {
        "name": args.name,
...
export interface GetExpressRoutePortResult {
     ...
     */
    readonly properties: outputs.network.v20190401.ExpressRoutePortPropertiesFormatResponse;
    /**
     * Resource tags.
     */
