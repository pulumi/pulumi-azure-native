...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:NetworkWatcher';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.NetworkWatcherPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkWatcherState {
     ...
     * Properties of the network watcher.
     */
    readonly properties: pulumi.Input<inputs.network.NetworkWatcherPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface NetworkWatcherArgs {
     ...
     * Properties of the network watcher.
     */
    readonly properties?: pulumi.Input<inputs.network.NetworkWatcherPropertiesFormat>;
    /**
