...
export class CustomIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:CustomIPPrefix';
     ...
     */
    public /*out*/ readonly publicIpPrefixes!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: CustomIPPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:CustomIPPrefix" }, { type: "azurerm:network/v20200601:CustomIPPrefix" }] };
