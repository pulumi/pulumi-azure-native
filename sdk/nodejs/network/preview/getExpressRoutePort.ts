...
export function getExpressRoutePort(args: GetExpressRoutePortArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getExpressRoutePort", {
...
export interface GetExpressRoutePortResult {
     ...
     */
    readonly circuits: outputs.network.preview.SubResourceResponse[];
    /**
     ...
     */
    readonly links?: outputs.network.preview.ExpressRouteLinkResponse[];
    /**
     * Resource location.
     */
