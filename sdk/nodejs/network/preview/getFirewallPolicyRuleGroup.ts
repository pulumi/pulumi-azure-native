...
export function getFirewallPolicyRuleGroup(args: GetFirewallPolicyRuleGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getFirewallPolicyRuleGroup", {
...
export interface GetFirewallPolicyRuleGroupResult {
     ...
     */
    readonly rules?: outputs.network.preview.FirewallPolicyFilterRuleResponse | outputs.network.preview.FirewallPolicyNatRuleResponse[];
    /**
     * Rule Group type.
     */
