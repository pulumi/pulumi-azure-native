...
export class HubVirtualNetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:HubVirtualNetworkConnection';
     ...
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    public readonly routingConfiguration!: pulumi.Output<outputs.network.preview.RoutingConfigurationResponse | undefined>;
    ...
    constructor(name: string, args: HubVirtualNetworkConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:HubVirtualNetworkConnection" }, { type: "azurerm:network/v20200501:HubVirtualNetworkConnection" }, { type: "azurerm:network/v20200601:HubVirtualNetworkConnection" }] };
...
export interface HubVirtualNetworkConnectionArgs {
     ...
     * Reference to the remote virtual network.
     */
    readonly remoteVirtualNetwork?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     ...
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    readonly routingConfiguration?: pulumi.Input<inputs.network.preview.RoutingConfiguration>;
    /**
