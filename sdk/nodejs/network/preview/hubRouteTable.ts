...
export class HubRouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:HubRouteTable';
     ...
     */
    public /*out*/ readonly associatedConnections!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly propagatingConnections!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.preview.HubRouteResponse[] | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: HubRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:HubRouteTable" }, { type: "azurerm:network/v20200401:HubRouteTable" }, { type: "azurerm:network/v20200501:HubRouteTable" }, { type: "azurerm:network/v20200601:HubRouteTable" }] };
...
export interface HubRouteTableArgs {
     ...
     * List of all routes.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputs.network.preview.HubRoute>[]>;
    /**
