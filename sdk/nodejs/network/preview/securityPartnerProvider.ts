...
export class SecurityPartnerProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:SecurityPartnerProvider';
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    ...
    constructor(name: string, args: SecurityPartnerProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:SecurityPartnerProvider" }, { type: "azurerm:network/v20200301:SecurityPartnerProvider" }, { type: "azurerm:network/v20200401:SecurityPartnerProvider" }, { type: "azurerm:network/v20200501:SecurityPartnerProvider" }, { type: "azurerm:network/v20200601:SecurityPartnerProvider" }] };
...
export interface SecurityPartnerProviderArgs {
     ...
     * The virtualHub to which the Security Partner Provider belongs.
     */
    readonly virtualHub?: pulumi.Input<inputs.network.preview.SubResource>;
}
