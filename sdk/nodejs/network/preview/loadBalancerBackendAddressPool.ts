...
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:LoadBalancerBackendAddressPool';
     ...
     */
    public /*out*/ readonly backendIPConfigurations!: pulumi.Output<outputs.network.preview.NetworkInterfaceIPConfigurationResponse[]>;
    /**
     ...
     */
    public readonly loadBalancerBackendAddresses!: pulumi.Output<outputs.network.preview.LoadBalancerBackendAddressResponse[] | undefined>;
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    public /*out*/ readonly loadBalancingRules!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly outboundRule!: pulumi.Output<outputs.network.preview.SubResourceResponse>;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    public /*out*/ readonly outboundRules!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: LoadBalancerBackendAddressPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:LoadBalancerBackendAddressPool" }, { type: "azurerm:network/v20200401:LoadBalancerBackendAddressPool" }, { type: "azurerm:network/v20200501:LoadBalancerBackendAddressPool" }, { type: "azurerm:network/v20200601:LoadBalancerBackendAddressPool" }] };
...
export interface LoadBalancerBackendAddressPoolArgs {
     ...
     * An array of backend addresses.
     */
    readonly loadBalancerBackendAddresses?: pulumi.Input<pulumi.Input<inputs.network.preview.LoadBalancerBackendAddress>[]>;
    /**
