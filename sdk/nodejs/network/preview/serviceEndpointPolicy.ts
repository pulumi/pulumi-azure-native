...
export class ServiceEndpointPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:ServiceEndpointPolicy';
     ...
     */
    public readonly serviceEndpointPolicyDefinitions!: pulumi.Output<outputs.network.preview.ServiceEndpointPolicyDefinitionResponse[] | undefined>;
    /**
...
export interface ServiceEndpointPolicyArgs {
     ...
     * A collection of service endpoint policy definitions of the service endpoint policy.
     */
    readonly serviceEndpointPolicyDefinitions?: pulumi.Input<pulumi.Input<inputs.network.preview.ServiceEndpointPolicyDefinition>[]>;
    /**
