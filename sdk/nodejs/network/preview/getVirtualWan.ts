...
export function getVirtualWan(args: GetVirtualWanArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualWanResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getVirtualWan", {
...
export interface GetVirtualWanResult {
     ...
     */
    readonly virtualHubs: outputs.network.preview.SubResourceResponse[];
    /**
     * List of VpnSites in the VirtualWAN.
     */
    readonly vpnSites: outputs.network.preview.SubResourceResponse[];
}
