...
export class InterfaceEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:InterfaceEndpoint';
     ...
     */
    public readonly endpointService!: pulumi.Output<outputs.network.preview.EndpointServiceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.network.preview.NetworkInterfaceResponse[]>;
    /**
     ...
     */
    public readonly subnet!: pulumi.Output<outputs.network.preview.SubnetResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface InterfaceEndpointArgs {
     ...
     * A reference to the service being brought into the virtual network.
     */
    readonly endpointService?: pulumi.Input<inputs.network.preview.EndpointService>;
    /**
     * Gets a unique read-only string that changes whenever the resource is updated.
     */
     ...
     * The ID of the subnet from which the private IP will be allocated.
     */
    readonly subnet?: pulumi.Input<inputs.network.preview.Subnet>;
    /**
     * Resource tags.
     */
