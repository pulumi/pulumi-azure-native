...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VirtualNetworkGatewayConnection';
     ...
     */
    public readonly ipsecPolicies!: pulumi.Output<outputs.network.preview.IpsecPolicyResponse[] | undefined>;
    /**
     * The reference to local network gateway resource.
     */
    public readonly localNetworkGateway2!: pulumi.Output<outputs.network.preview.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly peer!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly trafficSelectorPolicies!: pulumi.Output<outputs.network.preview.TrafficSelectorPolicyResponse[] | undefined>;
    /**
     * Collection of all tunnels' connection health status.
     */
    public /*out*/ readonly tunnelConnectionStatus!: pulumi.Output<outputs.network.preview.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    public readonly virtualNetworkGateway1!: pulumi.Output<outputs.network.preview.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    public readonly virtualNetworkGateway2!: pulumi.Output<outputs.network.preview.VirtualNetworkGatewayResponse | undefined>;
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * The IPSec Policies to be considered by this connection.
     */
    readonly ipsecPolicies?: pulumi.Input<pulumi.Input<inputs.network.preview.IpsecPolicy>[]>;
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: pulumi.Input<inputs.network.preview.LocalNetworkGateway>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    readonly peer?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     ...
     * The Traffic Selector Policies to be considered by this connection.
     */
    readonly trafficSelectorPolicies?: pulumi.Input<pulumi.Input<inputs.network.preview.TrafficSelectorPolicy>[]>;
    /**
     * Use private local Azure IP for the connection.
     */
     ...
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway1: pulumi.Input<inputs.network.preview.VirtualNetworkGateway>;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: pulumi.Input<inputs.network.preview.VirtualNetworkGateway>;
    /**
