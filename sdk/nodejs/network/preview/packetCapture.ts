...
export class PacketCapture extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:PacketCapture';
     ...
     */
    public readonly filters!: pulumi.Output<outputs.network.preview.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    public readonly storageLocation!: pulumi.Output<outputs.network.preview.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * A list of packet capture filters.
     */
    readonly filters?: pulumi.Input<pulumi.Input<inputs.network.preview.PacketCaptureFilter>[]>;
    /**
     ...
     * The storage location for a packet capture session.
     */
    readonly storageLocation: pulumi.Input<inputs.network.preview.PacketCaptureStorageLocation>;
    /**
     * The ID of the targeted resource, only VM is currently supported.
     */
