...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:Profile';
     ...
     */
    public readonly dnsConfig!: pulumi.Output<outputs.network.preview.DnsConfigResponse | undefined>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    public readonly endpoints!: pulumi.Output<outputs.network.preview.EndpointResponse[] | undefined>;
    /**
     ...
     */
    public readonly monitorConfig!: pulumi.Output<outputs.network.preview.MonitorConfigResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Profile" }, { type: "azurerm:network/v20151101:Profile" }, { type: "azurerm:network/v20170301:Profile" }, { type: "azurerm:network/v20170501:Profile" }, { type: "azurerm:network/v20180201:Profile" }, { type: "azurerm:network/v20180301:Profile" }, { type: "azurerm:network/v20180401:Profile" }] };
...
export interface ProfileArgs {
     ...
     * The DNS settings of the Traffic Manager profile.
     */
    readonly dnsConfig?: pulumi.Input<inputs.network.preview.DnsConfig>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    readonly endpoints?: pulumi.Input<pulumi.Input<inputs.network.preview.Endpoint>[]>;
    /**
     ...
     * The endpoint monitoring settings of the Traffic Manager profile.
     */
    readonly monitorConfig?: pulumi.Input<inputs.network.preview.MonitorConfig>;
    /**
     * The name of the resource
     */
