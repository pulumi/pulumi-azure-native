...
export class P2sVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:P2sVpnGateway';
     ...
     */
    public readonly p2SConnectionConfigurations!: pulumi.Output<outputs.network.preview.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vpnClientConnectionHealth!: pulumi.Output<outputs.network.preview.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    public readonly vpnServerConfiguration!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
...
export interface P2sVpnGatewayArgs {
     ...
     * List of all p2s connection configurations of the gateway.
     */
    readonly p2SConnectionConfigurations?: pulumi.Input<pulumi.Input<inputs.network.preview.P2SConnectionConfiguration>[]>;
    /**
     ...
     * The VpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    readonly vpnServerConfiguration?: pulumi.Input<inputs.network.preview.SubResource>;
}
