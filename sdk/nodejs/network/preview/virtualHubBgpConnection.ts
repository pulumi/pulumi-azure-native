...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VirtualHubBgpConnection';
    ...
    constructor(name: string, argsOrState?: VirtualHubBgpConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VirtualHubBgpConnection" }, { type: "azurerm:network/v20200501:VirtualHubBgpConnection" }, { type: "azurerm:network/v20200601:VirtualHubBgpConnection" }] };
