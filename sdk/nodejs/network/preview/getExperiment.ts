...
export function getExperiment(args: GetExperimentArgs, opts?: pulumi.InvokeOptions): Promise<GetExperimentResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getExperiment", {
...
export interface GetExperimentResult {
     ...
     */
    readonly endpointA?: outputs.network.preview.EndpointResponse;
    /**
     * The endpoint B of an experiment
     */
    readonly endpointB?: outputs.network.preview.EndpointResponse;
    /**
     * Resource location.
     */
