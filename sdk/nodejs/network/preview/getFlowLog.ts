...
export function getFlowLog(args: GetFlowLogArgs, opts?: pulumi.InvokeOptions): Promise<GetFlowLogResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getFlowLog", {
...
export interface GetFlowLogResult {
     ...
     */
    readonly flowAnalyticsConfiguration?: outputs.network.preview.TrafficAnalyticsPropertiesResponse;
    /**
     * Parameters that define the flow log format.
     */
    readonly format?: outputs.network.preview.FlowLogFormatParametersResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly retentionPolicy?: outputs.network.preview.RetentionPolicyParametersResponse;
    /**
