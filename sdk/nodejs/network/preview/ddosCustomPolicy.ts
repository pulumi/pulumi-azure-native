...
export class DdosCustomPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:DdosCustomPolicy';
     ...
     */
    public readonly protocolCustomSettings!: pulumi.Output<outputs.network.preview.ProtocolCustomSettingsFormatResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
...
export interface DdosCustomPolicyArgs {
     ...
     * The protocol-specific DDoS policy customization parameters.
     */
    readonly protocolCustomSettings?: pulumi.Input<pulumi.Input<inputs.network.preview.ProtocolCustomSettingsFormat>[]>;
    /**
