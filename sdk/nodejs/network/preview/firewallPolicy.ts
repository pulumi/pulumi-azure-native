...
export class FirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:FirewallPolicy';
     ...
     */
    public readonly basePolicy!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     * List of references to Child Firewall Policies.
     */
    public /*out*/ readonly childPolicies!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     * DNS Proxy Settings definition.
     */
    public readonly dnsSettings!: pulumi.Output<outputs.network.preview.DnsSettingsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly firewalls!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly ruleCollectionGroups!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly threatIntelWhitelist!: pulumi.Output<outputs.network.preview.FirewallPolicyThreatIntelWhitelistResponse | undefined>;
    /**
     * Resource type.
     */
...
export interface FirewallPolicyArgs {
     ...
     * The parent firewall policy from which rules are inherited.
     */
    readonly basePolicy?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     * DNS Proxy Settings definition.
     */
    readonly dnsSettings?: pulumi.Input<inputs.network.preview.DnsSettings>;
    /**
     ...
     * ThreatIntel Whitelist for Firewall Policy.
     */
    readonly threatIntelWhitelist?: pulumi.Input<inputs.network.preview.FirewallPolicyThreatIntelWhitelist>;
}
