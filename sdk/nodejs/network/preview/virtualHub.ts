...
export class VirtualHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VirtualHub';
     ...
     */
    public readonly azureFirewall!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     * List of references to Bgp Connections.
     */
    public /*out*/ readonly bgpConnections!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly expressRouteGateway!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     * List of references to IpConfigurations.
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly p2SVpnGateway!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly routeTable!: pulumi.Output<outputs.network.preview.VirtualHubRouteTableResponse | undefined>;
    /**
     * The routing state.
     */
     ...
     */
    public readonly securityPartnerProvider!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly virtualHubRouteTableV2s!: pulumi.Output<outputs.network.preview.VirtualHubRouteTableV2Response[] | undefined>;
    /**
     * VirtualRouter ASN.
     */
     ...
     */
    public readonly vpnGateway!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
...
export interface VirtualHubArgs {
     ...
     * The azureFirewall associated with this VirtualHub.
     */
    readonly azureFirewall?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     * Flag to control route propogation for VirtualRouter hub.
     */
     ...
     * The expressRouteGateway associated with this VirtualHub.
     */
    readonly expressRouteGateway?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     * Resource ID.
     */
     ...
     * The P2SVpnGateway associated with this VirtualHub.
     */
    readonly p2SVpnGateway?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     ...
     * The routeTable associated with this virtual hub.
     */
    readonly routeTable?: pulumi.Input<inputs.network.preview.VirtualHubRouteTable>;
    /**
     * The routing state.
     */
     ...
     * The securityPartnerProvider associated with this VirtualHub.
     */
    readonly securityPartnerProvider?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     * The Security Provider name.
     */
     ...
     * List of all virtual hub route table v2s associated with this VirtualHub.
     */
    readonly virtualHubRouteTableV2s?: pulumi.Input<pulumi.Input<inputs.network.preview.VirtualHubRouteTableV2>[]>;
    /**
     * VirtualRouter ASN.
     */
     ...
     * The VpnGateway associated with this VirtualHub.
     */
    readonly vpnGateway?: pulumi.Input<inputs.network.preview.SubResource>;
}
