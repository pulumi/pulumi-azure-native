...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:P2sVpnServerConfiguration';
     ...
     */
    public /*out*/ readonly p2SVpnGateways!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     * Radius client root certificate of P2SVpnServerConfiguration.
     */
    public readonly p2SVpnServerConfigRadiusClientRootCertificates!: pulumi.Output<outputs.network.preview.P2SVpnServerConfigRadiusClientRootCertificateResponse[] | undefined>;
    /**
     * Radius Server root certificate of P2SVpnServerConfiguration.
     */
    public readonly p2SVpnServerConfigRadiusServerRootCertificates!: pulumi.Output<outputs.network.preview.P2SVpnServerConfigRadiusServerRootCertificateResponse[] | undefined>;
    /**
     * VPN client revoked certificate of P2SVpnServerConfiguration.
     */
    public readonly p2SVpnServerConfigVpnClientRevokedCertificates!: pulumi.Output<outputs.network.preview.P2SVpnServerConfigVpnClientRevokedCertificateResponse[] | undefined>;
    /**
     * VPN client root certificate of P2SVpnServerConfiguration.
     */
    public readonly p2SVpnServerConfigVpnClientRootCertificates!: pulumi.Output<outputs.network.preview.P2SVpnServerConfigVpnClientRootCertificateResponse[] | undefined>;
    /**
...
export interface P2sVpnServerConfigurationArgs {
     ...
     * Radius client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.preview.P2SVpnServerConfigRadiusClientRootCertificate>[]>;
    /**
     * Radius Server root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigRadiusServerRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.preview.P2SVpnServerConfigRadiusServerRootCertificate>[]>;
    /**
     * VPN client revoked certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<inputs.network.preview.P2SVpnServerConfigVpnClientRevokedCertificate>[]>;
    /**
     * VPN client root certificate of P2SVpnServerConfiguration.
     */
    readonly p2SVpnServerConfigVpnClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.preview.P2SVpnServerConfigVpnClientRootCertificate>[]>;
    /**
