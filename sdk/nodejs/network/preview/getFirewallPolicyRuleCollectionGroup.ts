...
export function getFirewallPolicyRuleCollectionGroup(args: GetFirewallPolicyRuleCollectionGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleCollectionGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getFirewallPolicyRuleCollectionGroup", {
...
export interface GetFirewallPolicyRuleCollectionGroupResult {
     ...
     */
    readonly ruleCollections?: outputs.network.preview.FirewallPolicyFilterRuleCollectionResponse | outputs.network.preview.FirewallPolicyNatRuleCollectionResponse[];
    /**
     * Rule Group type.
     */
