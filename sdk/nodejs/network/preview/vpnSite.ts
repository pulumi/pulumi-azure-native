...
export class VpnSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VpnSite';
     ...
     */
    public readonly addressSpace!: pulumi.Output<outputs.network.preview.AddressSpaceResponse | undefined>;
    /**
     * The set of bgp properties.
     */
    public readonly bgpProperties!: pulumi.Output<outputs.network.preview.BgpSettingsResponse | undefined>;
    /**
     * The device properties.
     */
    public readonly deviceProperties!: pulumi.Output<outputs.network.preview.DevicePropertiesResponse | undefined>;
    /**
     ...
     * Office365 Policy.
     */
    public readonly o365Policy!: pulumi.Output<outputs.network.preview.O365PolicyPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly virtualWan!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     * List of all vpn site links.
     */
    public readonly vpnSiteLinks!: pulumi.Output<outputs.network.preview.VpnSiteLinkResponse[] | undefined>;
...
export interface VpnSiteArgs {
     ...
     * The AddressSpace that contains an array of IP address ranges.
     */
    readonly addressSpace?: pulumi.Input<inputs.network.preview.AddressSpace>;
    /**
     * The set of bgp properties.
     */
    readonly bgpProperties?: pulumi.Input<inputs.network.preview.BgpSettings>;
    /**
     * The device properties.
     */
    readonly deviceProperties?: pulumi.Input<inputs.network.preview.DeviceProperties>;
    /**
     * Resource ID.
     */
     ...
     * Office365 Policy.
     */
    readonly o365Policy?: pulumi.Input<inputs.network.preview.O365PolicyProperties>;
    /**
     ...
     * The VirtualWAN to which the vpnSite belongs.
     */
    readonly virtualWan?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     * List of all vpn site links.
     */
    readonly vpnSiteLinks?: pulumi.Input<pulumi.Input<inputs.network.preview.VpnSiteLink>[]>;
    /**
