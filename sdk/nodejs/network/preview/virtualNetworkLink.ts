...
export class VirtualNetworkLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VirtualNetworkLink';
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VirtualNetworkLink" }, { type: "azurerm:network/v20180901:VirtualNetworkLink" }] };
...
export interface VirtualNetworkLinkArgs {
     ...
     * The reference of the virtual network.
     */
    readonly virtualNetwork?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
