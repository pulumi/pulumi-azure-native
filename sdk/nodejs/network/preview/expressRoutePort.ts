...
export class ExpressRoutePort extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:ExpressRoutePort';
     ...
     */
    public /*out*/ readonly circuits!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly links!: pulumi.Output<outputs.network.preview.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface ExpressRoutePortArgs {
     ...
     * The set of physical links of the ExpressRoutePort resource.
     */
    readonly links?: pulumi.Input<pulumi.Input<inputs.network.preview.ExpressRouteLink>[]>;
    /**
     * Resource location.
     */
