...
export function getVirtualRouter(args: GetVirtualRouterArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getVirtualRouter", {
        "expand": args.expand,
...
export interface GetVirtualRouterResult {
     ...
     */
    readonly hostedGateway?: outputs.network.preview.SubResourceResponse;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    readonly hostedSubnet?: outputs.network.preview.SubResourceResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly peerings: outputs.network.preview.SubResourceResponse[];
    /**
