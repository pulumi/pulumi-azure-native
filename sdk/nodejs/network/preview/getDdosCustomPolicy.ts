...
export function getDdosCustomPolicy(args: GetDdosCustomPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDdosCustomPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getDdosCustomPolicy", {
...
export interface GetDdosCustomPolicyResult {
     ...
     */
    readonly protocolCustomSettings?: outputs.network.preview.ProtocolCustomSettingsFormatResponse[];
    /**
     ...
     */
    readonly publicIPAddresses: outputs.network.preview.SubResourceResponse[];
    /**
