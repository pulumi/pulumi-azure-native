...
export class FirewallPolicyRuleGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:FirewallPolicyRuleGroup';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.preview.FirewallPolicyFilterRuleResponse | outputs.network.preview.FirewallPolicyNatRuleResponse[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleGroupArgs {
     ...
     * Group of Firewall Policy rules.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.preview.FirewallPolicyFilterRule | inputs.network.preview.FirewallPolicyNatRule>[]>;
}
