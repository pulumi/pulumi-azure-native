...
export class Zone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:Zone';
     ...
     */
    public readonly registrationVirtualNetworks!: pulumi.Output<outputs.network.preview.SubResourceResponse[] | undefined>;
    /**
     * A list of references to virtual networks that resolve records in this DNS zone. This is a only when ZoneType is Private.
     */
    public readonly resolutionVirtualNetworks!: pulumi.Output<outputs.network.preview.SubResourceResponse[] | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ZoneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Zone" }, { type: "azurerm:network/v20150504preview:Zone" }, { type: "azurerm:network/v20160401:Zone" }, { type: "azurerm:network/v20170901:Zone" }, { type: "azurerm:network/v20171001:Zone" }, { type: "azurerm:network/v20180301preview:Zone" }, { type: "azurerm:network/v20180501:Zone" }] };
...
export interface ZoneArgs {
     ...
     * A list of references to virtual networks that register hostnames in this DNS zone. This is a only when ZoneType is Private.
     */
    readonly registrationVirtualNetworks?: pulumi.Input<pulumi.Input<inputs.network.preview.SubResource>[]>;
    /**
     * A list of references to virtual networks that resolve records in this DNS zone. This is a only when ZoneType is Private.
     */
    readonly resolutionVirtualNetworks?: pulumi.Input<pulumi.Input<inputs.network.preview.SubResource>[]>;
    /**
