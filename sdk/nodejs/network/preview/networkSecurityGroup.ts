...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:NetworkSecurityGroup';
     ...
     */
    public /*out*/ readonly defaultSecurityRules!: pulumi.Output<outputs.network.preview.SecurityRuleResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly flowLogs!: pulumi.Output<outputs.network.preview.FlowLogResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly securityRules!: pulumi.Output<outputs.network.preview.SecurityRuleResponse[] | undefined>;
    /**
...
export interface NetworkSecurityGroupArgs {
     ...
     * A collection of security rules of the network security group.
     */
    readonly securityRules?: pulumi.Input<pulumi.Input<inputs.network.preview.SecurityRule>[]>;
    /**
     * Resource tags.
     */
