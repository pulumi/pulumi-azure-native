...
export class TrafficManagerUserMetricsKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:TrafficManagerUserMetricsKey';
    ...
    constructor(name: string, argsOrState?: TrafficManagerUserMetricsKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:TrafficManagerUserMetricsKey" }, { type: "azurerm:network/v20180401:TrafficManagerUserMetricsKey" }] };
