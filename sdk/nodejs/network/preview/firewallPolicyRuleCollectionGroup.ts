...
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:FirewallPolicyRuleCollectionGroup';
     ...
     */
    public readonly ruleCollections!: pulumi.Output<outputs.network.preview.FirewallPolicyFilterRuleCollectionResponse | outputs.network.preview.FirewallPolicyNatRuleCollectionResponse[] | undefined>;
    /**
     * Rule Group type.
     */
    ...
    constructor(name: string, args: FirewallPolicyRuleCollectionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:FirewallPolicyRuleCollectionGroup" }, { type: "azurerm:network/v20200501:FirewallPolicyRuleCollectionGroup" }, { type: "azurerm:network/v20200601:FirewallPolicyRuleCollectionGroup" }] };
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    readonly ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.preview.FirewallPolicyFilterRuleCollection | inputs.network.preview.FirewallPolicyNatRuleCollection>[]>;
}
