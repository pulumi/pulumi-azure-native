...
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
     ...
     */
    public readonly ruleCollections!: pulumi.Output<outputs.network.preview.FirewallPolicyRuleCollectionResponse[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    readonly ruleCollections?: pulumi.Input<pulumi.Input<inputs.network.preview.FirewallPolicyRuleCollection>[]>;
}
