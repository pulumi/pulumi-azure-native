...
export class DelegatedSubnetServiceDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:DelegatedSubnetServiceDetails';
    ...
    constructor(name: string, argsOrState?: DelegatedSubnetServiceDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DelegatedSubnetServiceDetailsArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/v20200808preview:DelegatedSubnetServiceDetails" }] };
