...
export class WebApplicationFirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:WebApplicationFirewallPolicy';
     ...
     */
    public /*out*/ readonly applicationGateways!: pulumi.Output<outputs.network.preview.ApplicationGatewayResponse[]>;
    /**
     * The custom rules inside the policy.
     */
    public readonly customRules!: pulumi.Output<outputs.network.preview.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly httpListeners!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly managedRules!: pulumi.Output<outputs.network.preview.ManagedRulesDefinitionResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly pathBasedRules!: pulumi.Output<outputs.network.preview.SubResourceResponse[]>;
    /**
     * The PolicySettings for policy.
     */
    public readonly policySettings!: pulumi.Output<outputs.network.preview.PolicySettingsResponse | undefined>;
    /**
...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * The custom rules inside the policy.
     */
    readonly customRules?: pulumi.Input<pulumi.Input<inputs.network.preview.WebApplicationFirewallCustomRule>[]>;
    /**
     * Resource ID.
     */
     ...
     * Describes the managedRules structure.
     */
    readonly managedRules: pulumi.Input<inputs.network.preview.ManagedRulesDefinition>;
    /**
     ...
     * The PolicySettings for policy.
     */
    readonly policySettings?: pulumi.Input<inputs.network.preview.PolicySettings>;
    /**
