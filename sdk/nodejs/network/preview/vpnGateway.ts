...
export class VpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VpnGateway';
     ...
     */
    public readonly bgpSettings!: pulumi.Output<outputs.network.preview.BgpSettingsResponse | undefined>;
    /**
     * List of all vpn connections to the gateway.
     */
    public readonly connections!: pulumi.Output<outputs.network.preview.VpnConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.preview.VpnGatewayIpConfigurationResponse[]>;
    /**
     * Resource location.
     */
...
export interface VpnGatewayArgs {
     ...
     * Local network gateway's BGP speaker settings.
     */
    readonly bgpSettings?: pulumi.Input<inputs.network.preview.BgpSettings>;
    /**
     * List of all vpn connections to the gateway.
     */
    readonly connections?: pulumi.Input<pulumi.Input<inputs.network.preview.VpnConnection>[]>;
    /**
