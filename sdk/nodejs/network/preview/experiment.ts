...
export class Experiment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:Experiment';
     ...
     */
    public readonly endpointA!: pulumi.Output<outputs.network.preview.EndpointResponse | undefined>;
    /**
     * The endpoint B of an experiment
     */
    public readonly endpointB!: pulumi.Output<outputs.network.preview.EndpointResponse | undefined>;
    /**
     * Resource location.
     */
    ...
    constructor(name: string, argsOrState?: ExperimentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Experiment" }, { type: "azurerm:network/v20191101:Experiment" }] };
...
export interface ExperimentArgs {
     ...
     * The endpoint A of an experiment
     */
    readonly endpointA?: pulumi.Input<inputs.network.preview.Endpoint>;
    /**
     * The endpoint B of an experiment
     */
    readonly endpointB?: pulumi.Input<inputs.network.preview.Endpoint>;
    /**
