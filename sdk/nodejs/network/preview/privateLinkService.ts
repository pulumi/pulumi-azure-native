...
export class PrivateLinkService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:PrivateLinkService';
     ...
     */
    public readonly autoApproval!: pulumi.Output<outputs.network.preview.PrivateLinkServicePropertiesResponseAutoApproval | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.preview.PrivateLinkServiceIpConfigurationResponse[] | undefined>;
    /**
     * An array of references to the load balancer IP configurations.
     */
    public readonly loadBalancerFrontendIpConfigurations!: pulumi.Output<outputs.network.preview.FrontendIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.network.preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly visibility!: pulumi.Output<outputs.network.preview.PrivateLinkServicePropertiesResponseVisibility | undefined>;
...
export interface PrivateLinkServiceArgs {
     ...
     * The auto-approval list of the private link service.
     */
    readonly autoApproval?: pulumi.Input<inputs.network.preview.PrivateLinkServicePropertiesAutoApproval>;
    /**
     * Whether the private link service is enabled for proxy protocol or not.
     */
     ...
     * An array of private link service IP configurations.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.preview.PrivateLinkServiceIpConfiguration>[]>;
    /**
     * An array of references to the load balancer IP configurations.
     */
    readonly loadBalancerFrontendIpConfigurations?: pulumi.Input<pulumi.Input<inputs.network.preview.FrontendIPConfiguration>[]>;
    /**
     * Resource location.
     */
     ...
     * The visibility list of the private link service.
     */
    readonly visibility?: pulumi.Input<inputs.network.preview.PrivateLinkServicePropertiesVisibility>;
}
