...
export class VirtualNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VirtualNetworkGateway';
     ...
     */
    public readonly customRoutes!: pulumi.Output<outputs.network.preview.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    public readonly gatewayDefaultSite!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.preview.VirtualNetworkGatewayIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly sku!: pulumi.Output<outputs.network.preview.VirtualNetworkGatewaySkuResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly vpnClientConfiguration!: pulumi.Output<outputs.network.preview.VpnClientConfigurationResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayArgs {
     ...
     * The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
     */
    readonly customRoutes?: pulumi.Input<inputs.network.preview.AddressSpace>;
    /**
     * Whether BGP is enabled for this virtual network gateway or not.
     */
     ...
     * The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    readonly gatewayDefaultSite?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     * The type of this virtual network gateway.
     */
     ...
     * IP configurations for virtual network gateway.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.preview.VirtualNetworkGatewayIPConfiguration>[]>;
    /**
     * Resource location.
     */
     ...
     * The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
     */
    readonly sku?: pulumi.Input<inputs.network.preview.VirtualNetworkGatewaySku>;
    /**
     * Resource tags.
     */
     ...
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    readonly vpnClientConfiguration?: pulumi.Input<inputs.network.preview.VpnClientConfiguration>;
    /**
     * The generation for this VirtualNetworkGateway. Must be None if gatewayType is not VPN.
     */
