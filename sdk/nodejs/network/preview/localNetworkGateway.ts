...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:LocalNetworkGateway';
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.preview.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    readonly localNetworkAddressSpace?: pulumi.Input<inputs.network.preview.AddressSpace>;
    /**
