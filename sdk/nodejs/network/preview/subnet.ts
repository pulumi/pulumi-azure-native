...
export class Subnet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:Subnet';
     ...
     */
    public readonly delegations!: pulumi.Output<outputs.network.preview.DelegationResponse[] | undefined>;
    /**
     ...
     */
    public readonly ipAllocations!: pulumi.Output<outputs.network.preview.SubResourceResponse[] | undefined>;
    /**
     * Array of IP configuration profiles which reference this subnet.
     */
    public /*out*/ readonly ipConfigurationProfiles!: pulumi.Output<outputs.network.preview.IPConfigurationProfileResponse[]>;
    /**
     * An array of references to the network interface IP configurations using subnet.
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<outputs.network.preview.IPConfigurationResponse[]>;
    /**
     ...
     */
    public readonly natGateway!: pulumi.Output<outputs.network.preview.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpoints!: pulumi.Output<outputs.network.preview.PrivateEndpointResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly resourceNavigationLinks!: pulumi.Output<outputs.network.preview.ResourceNavigationLinkResponse[]>;
    /**
     * The reference to the RouteTable resource.
     */
    public readonly routeTable!: pulumi.Output<outputs.network.preview.RouteTableResponse | undefined>;
    /**
     * An array of references to services injecting into this subnet.
     */
    public /*out*/ readonly serviceAssociationLinks!: pulumi.Output<outputs.network.preview.ServiceAssociationLinkResponse[]>;
    /**
     * An array of service endpoint policies.
     */
    public readonly serviceEndpointPolicies!: pulumi.Output<outputs.network.preview.ServiceEndpointPolicyResponse[] | undefined>;
    /**
     * An array of service endpoints.
     */
    public readonly serviceEndpoints!: pulumi.Output<outputs.network.preview.ServiceEndpointPropertiesFormatResponse[] | undefined>;
...
export interface SubnetArgs {
     ...
     * An array of references to the delegations on the subnet.
     */
    readonly delegations?: pulumi.Input<pulumi.Input<inputs.network.preview.Delegation>[]>;
    /**
     * Resource ID.
     */
     ...
     * Array of IpAllocation which reference this subnet.
     */
    readonly ipAllocations?: pulumi.Input<pulumi.Input<inputs.network.preview.SubResource>[]>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * Nat gateway associated with this subnet.
     */
    readonly natGateway?: pulumi.Input<inputs.network.preview.SubResource>;
    /**
     * The reference to the NetworkSecurityGroup resource.
     */
     ...
     * The reference to the RouteTable resource.
     */
    readonly routeTable?: pulumi.Input<inputs.network.preview.RouteTable>;
    /**
     * An array of service endpoint policies.
     */
    readonly serviceEndpointPolicies?: pulumi.Input<pulumi.Input<inputs.network.preview.ServiceEndpointPolicy>[]>;
    /**
     * An array of service endpoints.
     */
    readonly serviceEndpoints?: pulumi.Input<pulumi.Input<inputs.network.preview.ServiceEndpointPropertiesFormat>[]>;
    /**
