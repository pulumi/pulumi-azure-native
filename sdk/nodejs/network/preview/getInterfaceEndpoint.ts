...
export function getInterfaceEndpoint(args: GetInterfaceEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfaceEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getInterfaceEndpoint", {
        "expand": args.expand,
...
export interface GetInterfaceEndpointResult {
     ...
     */
    readonly endpointService?: outputs.network.preview.EndpointServiceResponse;
    /**
     ...
     */
    readonly subnet?: outputs.network.preview.SubnetResponse;
    /**
     * Resource tags.
     */
