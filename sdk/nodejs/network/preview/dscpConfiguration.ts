...
export class DscpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:DscpConfiguration';
     ...
     */
    public /*out*/ readonly associatedNetworkInterfaces!: pulumi.Output<outputs.network.preview.NetworkInterfaceResponse[]>;
    /**
     * Destination IP ranges.
     */
    public readonly destinationIpRanges!: pulumi.Output<outputs.network.preview.QosIpRangeResponse[] | undefined>;
    /**
     * Destination port ranges.
     */
    public readonly destinationPortRanges!: pulumi.Output<outputs.network.preview.QosPortRangeResponse[] | undefined>;
    /**
     ...
     * Source IP ranges.
     */
    public readonly sourceIpRanges!: pulumi.Output<outputs.network.preview.QosIpRangeResponse[] | undefined>;
    /**
     * Sources port ranges.
     */
    public readonly sourcePortRanges!: pulumi.Output<outputs.network.preview.QosPortRangeResponse[] | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: DscpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:DscpConfiguration" }, { type: "azurerm:network/v20200601:DscpConfiguration" }] };
...
export interface DscpConfigurationArgs {
     ...
     * Destination IP ranges.
     */
    readonly destinationIpRanges?: pulumi.Input<pulumi.Input<inputs.network.preview.QosIpRange>[]>;
    /**
     * Destination port ranges.
     */
    readonly destinationPortRanges?: pulumi.Input<pulumi.Input<inputs.network.preview.QosPortRange>[]>;
    /**
     ...
     * Source IP ranges.
     */
    readonly sourceIpRanges?: pulumi.Input<pulumi.Input<inputs.network.preview.QosIpRange>[]>;
    /**
     * Sources port ranges.
     */
    readonly sourcePortRanges?: pulumi.Input<pulumi.Input<inputs.network.preview.QosPortRange>[]>;
    /**
     * Resource tags.
     */
