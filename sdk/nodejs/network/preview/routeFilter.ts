...
export class RouteFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:RouteFilter';
     ...
     */
    public /*out*/ readonly ipv6Peerings!: pulumi.Output<outputs.network.preview.ExpressRouteCircuitPeeringResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly peerings!: pulumi.Output<outputs.network.preview.ExpressRouteCircuitPeeringResponse[]>;
    /**
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.preview.RouteFilterRuleResponse[] | undefined>;
    /**
     * Resource tags.
     */
...
export interface RouteFilterArgs {
     ...
     * Collection of RouteFilterRules contained within a route filter.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.preview.RouteFilterRule>[]>;
    /**
     * Resource tags.
     */
