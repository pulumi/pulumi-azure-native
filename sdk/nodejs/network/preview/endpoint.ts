...
export class Endpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:Endpoint';
     ...
     */
    public readonly customHeaders!: pulumi.Output<outputs.network.preview.EndpointPropertiesResponseCustomHeaders[] | undefined>;
    /**
     ...
     */
    public readonly subnets!: pulumi.Output<outputs.network.preview.EndpointPropertiesResponseSubnets[] | undefined>;
    /**
    ...
    constructor(name: string, args: EndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:Endpoint" }, { type: "azurerm:network/v20151101:Endpoint" }, { type: "azurerm:network/v20170301:Endpoint" }, { type: "azurerm:network/v20170501:Endpoint" }, { type: "azurerm:network/v20180201:Endpoint" }, { type: "azurerm:network/v20180301:Endpoint" }, { type: "azurerm:network/v20180401:Endpoint" }] };
...
export interface EndpointArgs {
     ...
     * List of custom headers.
     */
    readonly customHeaders?: pulumi.Input<pulumi.Input<inputs.network.preview.EndpointPropertiesCustomHeaders>[]>;
    /**
     * Specifies the location of the external or nested endpoints when using the 'Performance' traffic routing method.
     */
     ...
     * The list of subnets, IP addresses, and/or address ranges mapped to this endpoint when using the 'Subnet' traffic routing method. An empty list will match all ranges not covered by other endpoints.
     */
    readonly subnets?: pulumi.Input<pulumi.Input<inputs.network.preview.EndpointPropertiesSubnets>[]>;
    /**
     * The fully-qualified DNS name or IP address of the endpoint. Traffic Manager returns this value in DNS responses to direct traffic to this endpoint.
     */
