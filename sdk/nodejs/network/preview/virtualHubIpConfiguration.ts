...
export class VirtualHubIpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VirtualHubIpConfiguration';
     ...
     */
    public readonly publicIPAddress!: pulumi.Output<outputs.network.preview.PublicIPAddressResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VirtualHubIpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VirtualHubIpConfiguration" }, { type: "azurerm:network/v20200501:VirtualHubIpConfiguration" }, { type: "azurerm:network/v20200601:VirtualHubIpConfiguration" }] };
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The reference to the public IP resource.
     */
    readonly publicIPAddress?: pulumi.Input<inputs.network.preview.PublicIPAddress>;
    /**
