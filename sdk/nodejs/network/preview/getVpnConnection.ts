...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly ipsecPolicies?: outputs.network.preview.IpsecPolicyResponse[];
    /**
     ...
     */
    readonly remoteVpnSite?: outputs.network.preview.SubResourceResponse;
    /**
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    readonly routingConfiguration?: outputs.network.preview.RoutingConfigurationResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: outputs.network.preview.VpnSiteLinkConnectionResponse[];
}
