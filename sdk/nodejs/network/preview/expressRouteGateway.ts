...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:ExpressRouteGateway';
     ...
     */
    public readonly autoScaleConfiguration!: pulumi.Output<outputs.network.preview.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    public /*out*/ readonly expressRouteConnections!: pulumi.Output<outputs.network.preview.ExpressRouteConnectionResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly virtualHub!: pulumi.Output<outputs.network.preview.VirtualHubIdResponse>;
...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    readonly autoScaleConfiguration?: pulumi.Input<inputs.network.preview.ExpressRouteGatewayPropertiesAutoScaleConfiguration>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    readonly virtualHub: pulumi.Input<inputs.network.preview.VirtualHubId>;
}
