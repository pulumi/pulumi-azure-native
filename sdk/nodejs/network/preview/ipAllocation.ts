...
export class IpAllocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:IpAllocation';
     ...
     */
    public /*out*/ readonly subnet!: pulumi.Output<outputs.network.preview.SubResourceResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public /*out*/ readonly virtualNetwork!: pulumi.Output<outputs.network.preview.SubResourceResponse>;
    ...
    constructor(name: string, argsOrState?: IpAllocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:IpAllocation" }, { type: "azurerm:network/v20200301:IpAllocation" }, { type: "azurerm:network/v20200401:IpAllocation" }, { type: "azurerm:network/v20200501:IpAllocation" }, { type: "azurerm:network/v20200601:IpAllocation" }] };
