...
export class PrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:PrivateEndpoint';
     ...
     */
    public readonly customDnsConfigs!: pulumi.Output<outputs.network.preview.CustomDnsConfigPropertiesFormatResponse[] | undefined>;
    /**
     ...
     */
    public readonly manualPrivateLinkServiceConnections!: pulumi.Output<outputs.network.preview.PrivateLinkServiceConnectionResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly privateLinkServiceConnections!: pulumi.Output<outputs.network.preview.PrivateLinkServiceConnectionResponse[] | undefined>;
    /**
...
export interface PrivateEndpointArgs {
     ...
     * An array of custom dns configurations.
     */
    readonly customDnsConfigs?: pulumi.Input<pulumi.Input<inputs.network.preview.CustomDnsConfigPropertiesFormat>[]>;
    /**
     * Resource ID.
     */
     ...
     * A grouping of information about the connection to the remote resource. Used when the network admin does not have access to approve connections to the remote resource.
     */
    readonly manualPrivateLinkServiceConnections?: pulumi.Input<pulumi.Input<inputs.network.preview.PrivateLinkServiceConnection>[]>;
    /**
     ...
     * A grouping of information about the connection to the remote resource.
     */
    readonly privateLinkServiceConnections?: pulumi.Input<pulumi.Input<inputs.network.preview.PrivateLinkServiceConnection>[]>;
    /**
