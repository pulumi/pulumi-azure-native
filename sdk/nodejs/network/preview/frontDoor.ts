...
export class FrontDoor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:FrontDoor';
     ...
     */
    public readonly backendPools!: pulumi.Output<outputs.network.preview.BackendPoolResponse[] | undefined>;
    /**
     * Settings for all backendPools
     */
    public readonly backendPoolsSettings!: pulumi.Output<outputs.network.preview.BackendPoolsSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly frontendEndpoints!: pulumi.Output<outputs.network.preview.FrontendEndpointResponse[] | undefined>;
    /**
     * Health probe settings associated with this Front Door instance.
     */
    public readonly healthProbeSettings!: pulumi.Output<outputs.network.preview.HealthProbeSettingsModelResponse[] | undefined>;
    /**
     * Load balancing settings associated with this Front Door instance.
     */
    public readonly loadBalancingSettings!: pulumi.Output<outputs.network.preview.LoadBalancingSettingsModelResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly routingRules!: pulumi.Output<outputs.network.preview.RoutingRuleResponse[] | undefined>;
    /**
     * Rules Engine Configurations available to routing rules.
     */
    public /*out*/ readonly rulesEngines!: pulumi.Output<outputs.network.preview.RulesEngineResponse[]>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: FrontDoorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:FrontDoor" }, { type: "azurerm:network/v20180801:FrontDoor" }, { type: "azurerm:network/v20190401:FrontDoor" }, { type: "azurerm:network/v20190501:FrontDoor" }, { type: "azurerm:network/v20200101:FrontDoor" }, { type: "azurerm:network/v20200401:FrontDoor" }, { type: "azurerm:network/v20200501:FrontDoor" }] };
...
export interface FrontDoorArgs {
     ...
     * Backend pools available to routing rules.
     */
    readonly backendPools?: pulumi.Input<pulumi.Input<inputs.network.preview.BackendPool>[]>;
    /**
     * Settings for all backendPools
     */
    readonly backendPoolsSettings?: pulumi.Input<inputs.network.preview.BackendPoolsSettings>;
    /**
     * Operational status of the Front Door load balancer. Permitted values are 'Enabled' or 'Disabled'
     */
     ...
     * Frontend endpoints available to routing rules.
     */
    readonly frontendEndpoints?: pulumi.Input<pulumi.Input<inputs.network.preview.FrontendEndpoint>[]>;
    /**
     * Health probe settings associated with this Front Door instance.
     */
    readonly healthProbeSettings?: pulumi.Input<pulumi.Input<inputs.network.preview.HealthProbeSettingsModel>[]>;
    /**
     * Load balancing settings associated with this Front Door instance.
     */
    readonly loadBalancingSettings?: pulumi.Input<pulumi.Input<inputs.network.preview.LoadBalancingSettingsModel>[]>;
    /**
     * Resource location.
     */
     ...
     * Routing rules associated with this Front Door.
     */
    readonly routingRules?: pulumi.Input<pulumi.Input<inputs.network.preview.RoutingRule>[]>;
    /**
     * Resource tags.
     */
