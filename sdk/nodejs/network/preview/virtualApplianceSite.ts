...
export class VirtualApplianceSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:VirtualApplianceSite';
     ...
     * Office 365 Policy.
     */
    public readonly o365Policy!: pulumi.Output<outputs.network.preview.Office365PolicyPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VirtualApplianceSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:VirtualApplianceSite" }, { type: "azurerm:network/v20200501:VirtualApplianceSite" }, { type: "azurerm:network/v20200601:VirtualApplianceSite" }] };
...
export interface VirtualApplianceSiteArgs {
     ...
     * Office 365 Policy.
     */
    readonly o365Policy?: pulumi.Input<inputs.network.preview.Office365PolicyProperties>;
    /**
