...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getExpressRouteCircuit", {
...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly authorizations?: outputs.network.preview.ExpressRouteCircuitAuthorizationResponse[];
    /**
     ...
     */
    readonly expressRoutePort?: outputs.network.preview.SubResourceResponse;
    /**
     ...
     */
    readonly peerings?: outputs.network.preview.ExpressRouteCircuitPeeringResponse[];
    /**
     ...
     */
    readonly serviceProviderProperties?: outputs.network.preview.ExpressRouteCircuitServiceProviderPropertiesResponse;
    /**
     ...
     * The SKU.
     */
    readonly sku?: outputs.network.preview.ExpressRouteCircuitSkuResponse;
    /**
