...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getVirtualNetworkGateway", {
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly customRoutes?: outputs.network.preview.AddressSpaceResponse;
    /**
     ...
     */
    readonly gatewayDefaultSite?: outputs.network.preview.SubResourceResponse;
    /**
     ...
     */
    readonly ipConfigurations?: outputs.network.preview.VirtualNetworkGatewayIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: outputs.network.preview.VirtualNetworkGatewaySkuResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly vpnClientConfiguration?: outputs.network.preview.VpnClientConfigurationResponse;
    /**
