...
export class RulesEngine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:RulesEngine';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.network.preview.RulesEngineRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: RulesEngineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:network/latest:RulesEngine" }, { type: "azurerm:network/v20200101:RulesEngine" }, { type: "azurerm:network/v20200401:RulesEngine" }, { type: "azurerm:network/v20200501:RulesEngine" }] };
...
export interface RulesEngineArgs {
     ...
     * A list of rules that define a particular Rules Engine Configuration.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.network.preview.RulesEngineRule>[]>;
    /**
