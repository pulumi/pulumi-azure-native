...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/preview:NetworkInterfaceTapConfiguration';
     ...
     */
    public readonly virtualNetworkTap!: pulumi.Output<outputs.network.preview.VirtualNetworkTapResponse | undefined>;
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * The reference to the Virtual Network Tap resource.
     */
    readonly virtualNetworkTap?: pulumi.Input<inputs.network.preview.VirtualNetworkTap>;
}
