...
export function getHubRouteTable(args: GetHubRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetHubRouteTableResult> {
    ...
    return pulumi.runtime.invoke("azurerm:network/preview:getHubRouteTable", {
...
export interface GetHubRouteTableResult {
     ...
     */
    readonly associatedConnections: outputs.network.preview.SubResourceResponse[];
    /**
     ...
     */
    readonly propagatingConnections: outputs.network.preview.SubResourceResponse[];
    /**
     ...
     * List of all routes.
     */
    readonly routes?: outputs.network.preview.HubRouteResponse[];
    /**
     * Resource type.
     */
