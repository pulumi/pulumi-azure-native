...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:BastionHost';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.BastionHostPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface BastionHostState {
     ...
     * Represents the bastion host resource.
     */
    readonly properties: pulumi.Input<inputs.network.BastionHostPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface BastionHostArgs {
     ...
     * Represents the bastion host resource.
     */
    readonly properties?: pulumi.Input<inputs.network.BastionHostPropertiesFormat>;
    /**
