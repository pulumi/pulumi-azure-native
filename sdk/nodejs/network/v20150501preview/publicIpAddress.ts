...
export class PublicIpAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20150501preview:PublicIpAddress';
