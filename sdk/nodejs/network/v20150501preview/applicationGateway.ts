...
export class ApplicationGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network/v20150501preview:ApplicationGateway';
