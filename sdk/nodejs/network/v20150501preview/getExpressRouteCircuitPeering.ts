...
export function getExpressRouteCircuitPeering(args: GetExpressRouteCircuitPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:network/v20150501preview:getExpressRouteCircuitPeering", {
...
export interface GetExpressRouteCircuitPeeringResult {
     ...
     */
    readonly microsoftPeeringConfig?: outputs.network.v20150501preview.ExpressRouteCircuitPeeringConfigInvokeResponse;
    /**
     ...
     */
    readonly stats?: outputs.network.v20150501preview.ExpressRouteCircuitStatsInvokeResponse;
    /**
