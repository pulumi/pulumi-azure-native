...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    readonly localNetworkAddressSpace?: pulumi.Input<inputs.network.AddressSpace>;
    /**
