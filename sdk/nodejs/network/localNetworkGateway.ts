...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:network:LocalNetworkGateway';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.network.LocalNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface LocalNetworkGatewayState {
     ...
     * Properties of the local network gateway.
     */
    readonly properties: pulumi.Input<inputs.network.LocalNetworkGatewayPropertiesFormatResponse>;
    /**
     * Resource tags.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Properties of the local network gateway.
     */
    readonly properties: pulumi.Input<inputs.network.LocalNetworkGatewayPropertiesFormat>;
    /**
