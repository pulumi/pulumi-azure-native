...
export class ProviderInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hanaonazure/preview:ProviderInstance';
    ...
    constructor(name: string, args: ProviderInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hanaonazure/v20200207preview:ProviderInstance" }] };
