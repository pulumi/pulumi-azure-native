...
export class SapMonitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hanaonazure/preview:SapMonitor';
    ...
    constructor(name: string, argsOrState?: SapMonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hanaonazure/v20171103preview:SapMonitor" }, { type: "azurerm:hanaonazure/v20200207preview:SapMonitor" }] };
