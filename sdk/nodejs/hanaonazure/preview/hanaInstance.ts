...
export class HanaInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hanaonazure/preview:HanaInstance';
     ...
     */
    public /*out*/ readonly hardwareProfile!: pulumi.Output<outputs.hanaonazure.preview.HardwareProfileResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.hanaonazure.preview.NetworkProfileResponse | undefined>;
    /**
     * Specifies the operating system settings for the HANA instance.
     */
    public readonly osProfile!: pulumi.Output<outputs.hanaonazure.preview.OSProfileResponse | undefined>;
    /**
     ...
     */
    public readonly storageProfile!: pulumi.Output<outputs.hanaonazure.preview.StorageProfileResponse | undefined>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: HanaInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hanaonazure/v20171103preview:HanaInstance" }] };
...
export interface HanaInstanceArgs {
     ...
     * Specifies the network settings for the HANA instance.
     */
    readonly networkProfile?: pulumi.Input<inputs.hanaonazure.preview.NetworkProfile>;
    /**
     * Specifies the operating system settings for the HANA instance.
     */
    readonly osProfile?: pulumi.Input<inputs.hanaonazure.preview.OSProfile>;
    /**
     * ARM ID of another HanaInstance that will share a network with this HanaInstance
     */
     ...
     * Specifies the storage settings for the HANA instance disks.
     */
    readonly storageProfile?: pulumi.Input<inputs.hanaonazure.preview.StorageProfile>;
}
