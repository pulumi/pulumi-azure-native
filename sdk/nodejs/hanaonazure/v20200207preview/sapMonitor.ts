...
export class SapMonitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hanaonazure/v20200207preview:SapMonitor';
    ...
    constructor(name: string, args: SapMonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:hanaonazure/v20200207preview:SapMonitor" }, { type: "azure-native:hanaonazure:SapMonitor" }, { type: "azure-nextgen:hanaonazure:SapMonitor" }] };
