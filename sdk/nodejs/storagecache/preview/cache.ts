...
export class Cache extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagecache/preview:Cache';
     ...
     */
    public readonly encryptionSettings!: pulumi.Output<outputs.storagecache.preview.CacheEncryptionSettingsResponse | undefined>;
    /**
     * Health of the Cache.
     */
    public /*out*/ readonly health!: pulumi.Output<outputs.storagecache.preview.CacheHealthResponse>;
    /**
     * The identity of the cache, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.storagecache.preview.CacheIdentityResponse | undefined>;
    /**
     * Region name string.
     */
     ...
     */
    public readonly networkSettings!: pulumi.Output<outputs.storagecache.preview.CacheNetworkSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly securitySettings!: pulumi.Output<outputs.storagecache.preview.CacheSecuritySettingsResponse | undefined>;
    /**
     * SKU for the Cache.
     */
    public readonly sku!: pulumi.Output<outputs.storagecache.preview.CacheResponseSku | undefined>;
    /**
     ...
     */
    public /*out*/ readonly upgradeStatus!: pulumi.Output<outputs.storagecache.preview.CacheUpgradeStatusResponse | undefined>;
    ...
    constructor(name: string, argsOrState?: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagecache/latest:Cache" }, { type: "azurerm:storagecache/v20190801preview:Cache" }, { type: "azurerm:storagecache/v20191101:Cache" }, { type: "azurerm:storagecache/v20200301:Cache" }] };
...
export interface CacheArgs {
     ...
     * Specifies encryption settings of the cache.
     */
    readonly encryptionSettings?: pulumi.Input<inputs.storagecache.preview.CacheEncryptionSettings>;
    /**
     * The identity of the cache, if configured.
     */
    readonly identity?: pulumi.Input<inputs.storagecache.preview.CacheIdentity>;
    /**
     * Region name string.
     */
     ...
     * Specifies network settings of the cache.
     */
    readonly networkSettings?: pulumi.Input<inputs.storagecache.preview.CacheNetworkSettings>;
    /**
     * ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property
     */
     ...
     * Specifies security settings of the cache.
     */
    readonly securitySettings?: pulumi.Input<inputs.storagecache.preview.CacheSecuritySettings>;
    /**
     * SKU for the Cache.
     */
    readonly sku?: pulumi.Input<inputs.storagecache.preview.CacheSku>;
    /**
     * Subnet used for the Cache.
     */
