...
export class StorageTarget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagecache/preview:StorageTarget';
     ...
     */
    public readonly clfs!: pulumi.Output<outputs.storagecache.preview.ClfsTargetResponse | undefined>;
    /**
     * List of Cache namespace junctions to target for namespace associations.
     */
    public readonly junctions!: pulumi.Output<outputs.storagecache.preview.NamespaceJunctionResponse[] | undefined>;
    /**
     ...
     */
    public readonly nfs3!: pulumi.Output<outputs.storagecache.preview.Nfs3TargetResponse | undefined>;
    /**
     ...
     */
    public readonly unknown!: pulumi.Output<outputs.storagecache.preview.UnknownTargetResponse | undefined>;
    ...
    constructor(name: string, args: StorageTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagecache/latest:StorageTarget" }, { type: "azurerm:storagecache/v20190801preview:StorageTarget" }, { type: "azurerm:storagecache/v20191101:StorageTarget" }, { type: "azurerm:storagecache/v20200301:StorageTarget" }] };
...
export interface StorageTargetArgs {
     ...
     * Properties when targetType is clfs.
     */
    readonly clfs?: pulumi.Input<inputs.storagecache.preview.ClfsTarget>;
    /**
     * List of Cache namespace junctions to target for namespace associations.
     */
    readonly junctions?: pulumi.Input<pulumi.Input<inputs.storagecache.preview.NamespaceJunction>[]>;
    /**
     * Properties when targetType is nfs3.
     */
    readonly nfs3?: pulumi.Input<inputs.storagecache.preview.Nfs3Target>;
    /**
     * ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property
     */
     ...
     * Properties when targetType is unknown.
     */
    readonly unknown?: pulumi.Input<inputs.storagecache.preview.UnknownTarget>;
}
