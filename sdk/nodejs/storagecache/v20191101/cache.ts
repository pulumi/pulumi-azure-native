...
export class Cache extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagecache/latest:Cache" }, { type: "azure-nextgen:storagecache/v20190801preview:Cache" }, { type: "azure-nextgen:storagecache/v20200301:Cache" }] };
