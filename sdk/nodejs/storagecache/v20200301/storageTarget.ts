 ...
 *
 * const storageTarget = new azurerm.storagecache.v20200301.StorageTarget("storageTarget", {
 *     cacheName: "sc1",
 *     junctions: [
 *         {
...
export class StorageTarget extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagecache/latest:StorageTarget" }, { type: "azurerm:storagecache/v20190801preview:StorageTarget" }, { type: "azurerm:storagecache/v20191101:StorageTarget" }] };
