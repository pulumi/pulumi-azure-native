...
export class Cache extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagecache/latest:Cache" }, { type: "azurerm:storagecache/v20190801preview:Cache" }, { type: "azurerm:storagecache/v20191101:Cache" }] };
