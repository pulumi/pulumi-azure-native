...
export class StorageTarget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageTarget {
        pulumi.log.warn("StorageTarget is deprecated: azure-native:storagecache/v20230101:StorageTarget is being removed in the next major version of this provider. Upgrade to at least azure-native:storagecache/v20230301preview:StorageTarget to guarantee forwards compatibility.")
        return new StorageTarget(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagecache/v20230101:StorageTarget';
     ...
     */
    public readonly blobNfs!: pulumi.Output<outputs.storagecache.v20230101.BlobNfsTargetResponse | undefined>;
    /**
     * Properties when targetType is clfs.
     */
    public readonly clfs!: pulumi.Output<outputs.storagecache.v20230101.ClfsTargetResponse | undefined>;
    /**
     * List of Cache namespace junctions to target for namespace associations.
     */
    public readonly junctions!: pulumi.Output<outputs.storagecache.v20230101.NamespaceJunctionResponse[] | undefined>;
    /**
     * Region name string.
     */
     ...
     */
    public readonly nfs3!: pulumi.Output<outputs.storagecache.v20230101.Nfs3TargetResponse | undefined>;
    /**
     ...
     */
    public readonly unknown!: pulumi.Output<outputs.storagecache.v20230101.UnknownTargetResponse | undefined>;
    ...
    constructor(name: string, args: StorageTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagecache:StorageTarget" }, { type: "azure-native:storagecache/v20190801preview:StorageTarget" }, { type: "azure-native:storagecache/v20191101:StorageTarget" }, { type: "azure-native:storagecache/v20200301:StorageTarget" }, { type: "azure-native:storagecache/v20201001:StorageTarget" }, { type: "azure-native:storagecache/v20210301:StorageTarget" }, { type: "azure-native:storagecache/v20210501:StorageTarget" }, { type: "azure-native:storagecache/v20210901:StorageTarget" }, { type: "azure-native:storagecache/v20220101:StorageTarget" }, { type: "azure-native:storagecache/v20220501:StorageTarget" }, { type: "azure-native:storagecache/v20230301preview:StorageTarget" }] };
...
export interface StorageTargetArgs {
     ...
     * Properties when targetType is blobNfs.
     */
    blobNfs?: pulumi.Input<inputs.storagecache.v20230101.BlobNfsTargetArgs>;
    /**
     ...
     * Properties when targetType is clfs.
     */
    clfs?: pulumi.Input<inputs.storagecache.v20230101.ClfsTargetArgs>;
    /**
     * List of Cache namespace junctions to target for namespace associations.
     */
    junctions?: pulumi.Input<pulumi.Input<inputs.storagecache.v20230101.NamespaceJunctionArgs>[]>;
    /**
     * Properties when targetType is nfs3.
     */
    nfs3?: pulumi.Input<inputs.storagecache.v20230101.Nfs3TargetArgs>;
    /**
     ...
     * Storage target operational state.
     */
    state?: pulumi.Input<string | enums.storagecache.v20230101.OperationalStateType>;
    /**
     ...
     * Type of the Storage Target.
     */
    targetType: pulumi.Input<string | enums.storagecache.v20230101.StorageTargetType>;
    /**
     * Properties when targetType is unknown.
     */
    unknown?: pulumi.Input<inputs.storagecache.v20230101.UnknownTargetArgs>;
}
