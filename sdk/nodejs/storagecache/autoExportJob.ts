...
export class AutoExportJob extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AutoExportJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagecache/v20240701:AutoExportJob" }, { type: "azure-native:storagecache/v20240701:autoExportJob" }, { type: "azure-native:storagecache:autoExportJob" }] };
