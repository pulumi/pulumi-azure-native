...
export class StorageTarget extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagecache/latest:StorageTarget" }, { type: "azurerm:storagecache/preview:StorageTarget" }, { type: "azurerm:storagecache/v20191101:StorageTarget" }, { type: "azurerm:storagecache/v20200301:StorageTarget" }] };
