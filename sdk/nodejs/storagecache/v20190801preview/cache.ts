 ...
 *
 * const cache = new azurerm.storagecache.v20190801preview.Cache("cache", {
 *     cacheName: "sc1",
 *     cacheSizeGB: 3072,
 *     location: "westus",
...
export class Cache extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagecache/v20190801preview:Cache';
    ...
    constructor(name: string, args: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagecache/latest:Cache" }, { type: "azurerm:storagecache/v20191101:Cache" }, { type: "azurerm:storagecache/v20200301:Cache" }] };
