...
export class AmlFilesystem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagecache/v20240301:AmlFilesystem';
     ...
     */
    public /*out*/ readonly clientInfo!: pulumi.Output<outputs.storagecache.v20240301.AmlFilesystemClientInfoResponse>;
    /**
     * Specifies encryption settings of the AML file system.
     */
    public readonly encryptionSettings!: pulumi.Output<outputs.storagecache.v20240301.AmlFilesystemEncryptionSettingsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly health!: pulumi.Output<outputs.storagecache.v20240301.AmlFilesystemHealthResponse>;
    /**
     * Hydration and archive settings and status
     */
    public readonly hsm!: pulumi.Output<outputs.storagecache.v20240301.AmlFilesystemResponseHsm | undefined>;
    /**
     * The managed identity used by the AML file system, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.storagecache.v20240301.AmlFilesystemIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<outputs.storagecache.v20240301.AmlFilesystemResponseMaintenanceWindow>;
    /**
     ...
     */
    public readonly rootSquashSettings!: pulumi.Output<outputs.storagecache.v20240301.AmlFilesystemRootSquashSettingsResponse | undefined>;
    /**
     * SKU for the resource.
     */
    public readonly sku!: pulumi.Output<outputs.storagecache.v20240301.SkuNameResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AmlFilesystemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["hsm"] = args ? (args.hsm ? pulumi.output(args.hsm).apply(inputs.storagecache.v20240301.amlFilesystemHsmArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagecache:AmlFilesystem" }, { type: "azure-native:storagecache/v20230301preview:AmlFilesystem" }, { type: "azure-native:storagecache/v20230501:AmlFilesystem" }, { type: "azure-native:storagecache/v20231101preview:AmlFilesystem" }] };
...
export interface AmlFilesystemArgs {
     ...
     * Specifies encryption settings of the AML file system.
     */
    encryptionSettings?: pulumi.Input<inputs.storagecache.v20240301.AmlFilesystemEncryptionSettingsArgs>;
    /**
     * Subnet used for managing the AML file system and for client-facing operations. This subnet should have at least a /24 subnet mask within the VNET's address space.
     */
     ...
     * Hydration and archive settings and status
     */
    hsm?: pulumi.Input<inputs.storagecache.v20240301.AmlFilesystemHsmArgs>;
    /**
     * The managed identity used by the AML file system, if configured.
     */
    identity?: pulumi.Input<inputs.storagecache.v20240301.AmlFilesystemIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Start time of a 30-minute weekly maintenance window.
     */
    maintenanceWindow: pulumi.Input<inputs.storagecache.v20240301.AmlFilesystemMaintenanceWindowArgs>;
    /**
     ...
     * Specifies root squash settings of the AML file system.
     */
    rootSquashSettings?: pulumi.Input<inputs.storagecache.v20240301.AmlFilesystemRootSquashSettingsArgs>;
    /**
     * SKU for the resource.
     */
    sku?: pulumi.Input<inputs.storagecache.v20240301.SkuNameArgs>;
    /**
     * The size of the AML file system, in TiB. This might be rounded up.
     */
