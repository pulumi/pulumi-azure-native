...
export class Cache extends pulumi.CustomResource {
     ...
     */
    public readonly encryptionSettings!: pulumi.Output<outputs.storagecache.latest.CacheEncryptionSettingsResponse | undefined>;
    /**
     * Health of the Cache.
     */
    public /*out*/ readonly health!: pulumi.Output<outputs.storagecache.latest.CacheHealthResponse>;
    /**
     * The identity of the cache, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.storagecache.latest.CacheIdentityResponse | undefined>;
    /**
     * Region name string.
     */
     ...
     */
    public readonly networkSettings!: pulumi.Output<outputs.storagecache.latest.CacheNetworkSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly securitySettings!: pulumi.Output<outputs.storagecache.latest.CacheSecuritySettingsResponse | undefined>;
    /**
     * SKU for the Cache.
     */
    public readonly sku!: pulumi.Output<outputs.storagecache.latest.CacheResponseSku | undefined>;
    /**
     ...
     */
    public /*out*/ readonly upgradeStatus!: pulumi.Output<outputs.storagecache.latest.CacheUpgradeStatusResponse | undefined>;
    ...
    constructor(name: string, args: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagecache/latest:Cache" }, { type: "azure-native:storagecache:Cache" }, { type: "azure-nextgen:storagecache:Cache" }, { type: "azure-native:storagecache/v20190801preview:Cache" }, { type: "azure-nextgen:storagecache/v20190801preview:Cache" }, { type: "azure-native:storagecache/v20191101:Cache" }, { type: "azure-nextgen:storagecache/v20191101:Cache" }, { type: "azure-native:storagecache/v20200301:Cache" }, { type: "azure-nextgen:storagecache/v20200301:Cache" }, { type: "azure-native:storagecache/v20201001:Cache" }, { type: "azure-nextgen:storagecache/v20201001:Cache" }, { type: "azure-native:storagecache/v20210301:Cache" }, { type: "azure-nextgen:storagecache/v20210301:Cache" }] };
...
export interface CacheArgs {
     ...
     * Specifies encryption settings of the cache.
     */
    readonly encryptionSettings?: pulumi.Input<inputs.storagecache.latest.CacheEncryptionSettings>;
    /**
     * The identity of the cache, if configured.
     */
    readonly identity?: pulumi.Input<inputs.storagecache.latest.CacheIdentity>;
    /**
     * Region name string.
     */
     ...
     * Specifies network settings of the cache.
     */
    readonly networkSettings?: pulumi.Input<inputs.storagecache.latest.CacheNetworkSettings>;
    /**
     * ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property
     */
     ...
     * Specifies security settings of the cache.
     */
    readonly securitySettings?: pulumi.Input<inputs.storagecache.latest.CacheSecuritySettings>;
    /**
     * SKU for the Cache.
     */
    readonly sku?: pulumi.Input<inputs.storagecache.latest.CacheSku>;
    /**
     * Subnet used for the Cache.
     */
