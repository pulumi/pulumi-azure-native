...
export class Cache extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagecache/latest:Cache';
    ...
    constructor(name: string, argsOrState?: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagecache/preview:Cache" }, { type: "azurerm:storagecache/v20190801preview:Cache" }, { type: "azurerm:storagecache/v20191101:Cache" }, { type: "azurerm:storagecache/v20200301:Cache" }] };
