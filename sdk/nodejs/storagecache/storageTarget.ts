...
export class StorageTarget extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagecache:StorageTarget" }, { type: "azure-native:storagecache/v20190801preview:StorageTarget" }, { type: "azure-nextgen:storagecache/v20190801preview:StorageTarget" }, { type: "azure-native:storagecache/v20191101:StorageTarget" }, { type: "azure-nextgen:storagecache/v20191101:StorageTarget" }, { type: "azure-native:storagecache/v20200301:StorageTarget" }, { type: "azure-nextgen:storagecache/v20200301:StorageTarget" }, { type: "azure-native:storagecache/v20201001:StorageTarget" }, { type: "azure-nextgen:storagecache/v20201001:StorageTarget" }, { type: "azure-native:storagecache/v20210301:StorageTarget" }, { type: "azure-nextgen:storagecache/v20210301:StorageTarget" }] };
...
export interface StorageTargetArgs {
     ...
     * Properties when targetType is blobNfs.
     */
    readonly blobNfs?: pulumi.Input<inputs.storagecache.BlobNfsTargetArgs>;
    /**
     ...
     * Properties when targetType is clfs.
     */
    readonly clfs?: pulumi.Input<inputs.storagecache.ClfsTargetArgs>;
    /**
     * List of Cache namespace junctions to target for namespace associations.
     */
    readonly junctions?: pulumi.Input<pulumi.Input<inputs.storagecache.NamespaceJunctionArgs>[]>;
    /**
     * Properties when targetType is nfs3.
     */
    readonly nfs3?: pulumi.Input<inputs.storagecache.Nfs3TargetArgs>;
    /**
     * ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property
     */
     ...
     * Properties when targetType is unknown.
     */
    readonly unknown?: pulumi.Input<inputs.storagecache.UnknownTargetArgs>;
}
