...
export class Cache extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagecache:Cache" }, { type: "azure-native:storagecache/latest:Cache" }, { type: "azure-nextgen:storagecache/latest:Cache" }, { type: "azure-native:storagecache/v20190801preview:Cache" }, { type: "azure-nextgen:storagecache/v20190801preview:Cache" }, { type: "azure-native:storagecache/v20191101:Cache" }, { type: "azure-nextgen:storagecache/v20191101:Cache" }, { type: "azure-native:storagecache/v20200301:Cache" }, { type: "azure-nextgen:storagecache/v20200301:Cache" }, { type: "azure-native:storagecache/v20201001:Cache" }, { type: "azure-nextgen:storagecache/v20201001:Cache" }] };
...
export interface CacheArgs {
     ...
     * Specifies Directory Services settings of the cache.
     */
    readonly directoryServicesSettings?: pulumi.Input<inputs.storagecache.CacheDirectorySettings>;
    /**
     * Specifies encryption settings of the cache.
     */
    readonly encryptionSettings?: pulumi.Input<inputs.storagecache.CacheEncryptionSettings>;
    /**
     * The identity of the cache, if configured.
     */
     ...
     * Specifies network settings of the cache.
     */
    readonly networkSettings?: pulumi.Input<inputs.storagecache.CacheNetworkSettings>;
    /**
     * ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property
     */
     ...
     * Specifies security settings of the cache.
     */
    readonly securitySettings?: pulumi.Input<inputs.storagecache.CacheSecuritySettings>;
    /**
     * SKU for the Cache.
     */
    readonly sku?: pulumi.Input<inputs.storagecache.CacheSku>;
    /**
     * Subnet used for the Cache.
     */
