...
// Export enums:
export * from "../../types/enums/storagecache/v20220501";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:storagecache/v20220501:Cache":
                return new Cache(name, <any>undefined, { urn })
            case "azure-native:storagecache/v20220501:StorageTarget":
...
pulumi.runtime.registerResourceModule("azure-native", "storagecache/v20220501", _module)
