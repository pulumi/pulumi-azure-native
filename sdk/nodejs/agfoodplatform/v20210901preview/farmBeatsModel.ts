...
export class FarmBeatsModel extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.agfoodplatform.v20210901preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly sensorIntegration!: pulumi.Output<outputs.agfoodplatform.v20210901preview.SensorIntegrationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: FarmBeatsModelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:agfoodplatform/v20200512preview:FarmBeatsModel" }, { type: "azure-native:agfoodplatform/v20230601preview:FarmBeatsModel" }, { type: "azure-native:agfoodplatform:FarmBeatsModel" }] };
...
export interface FarmBeatsModelArgs {
     ...
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.agfoodplatform.v20210901preview.IdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Property to allow or block public traffic for an Azure FarmBeats resource.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.agfoodplatform.v20210901preview.PublicNetworkAccess>;
    /**
     ...
     * Sensor integration request model.
     */
    sensorIntegration?: pulumi.Input<inputs.agfoodplatform.v20210901preview.SensorIntegrationArgs>;
    /**
     * Resource tags.
     */
