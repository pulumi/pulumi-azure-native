 ...
 *
 * const extension = new azure_native.agfoodplatform.v20210901preview.Extension("extension", {
...
export class Extension extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:agfoodplatform:Extension" }, { type: "azure-native:agfoodplatform/v20200512preview:Extension" }] };
