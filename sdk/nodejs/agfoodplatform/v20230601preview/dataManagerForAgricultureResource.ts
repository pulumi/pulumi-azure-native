...
export class DataManagerForAgricultureResource extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.agfoodplatform.v20230601preview.IdentityResponse | undefined>;
    /**
     ...
     * Private endpoints.
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.agfoodplatform.v20230601preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sensorIntegration!: pulumi.Output<outputs.agfoodplatform.v20230601preview.SensorIntegrationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DataManagerForAgricultureResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:agfoodplatform/v20200512preview:DataManagerForAgricultureResource" }, { type: "azure-native:agfoodplatform/v20200512preview:FarmBeatsModel" }, { type: "azure-native:agfoodplatform/v20210901preview:DataManagerForAgricultureResource" }, { type: "azure-native:agfoodplatform/v20210901preview:FarmBeatsModel" }, { type: "azure-native:agfoodplatform:DataManagerForAgricultureResource" }] };
