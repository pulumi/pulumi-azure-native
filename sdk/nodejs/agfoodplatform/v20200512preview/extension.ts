...
export class Extension extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:agfoodplatform:Extension" }, { type: "azure-native:agfoodplatform/v20210901preview:Extension" }, { type: "azure-native:agfoodplatform/v20230601preview:Extension" }] };
