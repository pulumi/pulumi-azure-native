...
export class FarmBeatsModel extends pulumi.CustomResource {
     ...
     */
    public readonly sku!: pulumi.Output<outputs.agfoodplatform.v20200512preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: FarmBeatsModelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:agfoodplatform/v20210901preview:FarmBeatsModel" }, { type: "azure-native:agfoodplatform/v20230601preview:DataManagerForAgricultureResource" }, { type: "azure-native:agfoodplatform/v20230601preview:FarmBeatsModel" }, { type: "azure-native:agfoodplatform:DataManagerForAgricultureResource" }, { type: "azure-native:agfoodplatform:FarmBeatsModel" }] };
