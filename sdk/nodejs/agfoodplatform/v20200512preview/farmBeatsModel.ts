 ...
 *
 * const farmBeatsModel = new azure_native.agfoodplatform.v20200512preview.FarmBeatsModel("farmBeatsModel", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:agfoodplatform/v20200512preview:FarmBeatsModel examples-farmbeatsResourceName /subscriptions/11111111-2222-3333-4444-555555555555/resourceGroups/examples-rg/Microsoft.AgFoodPlatform/farmBeats/examples-farmbeatsResourceName 
 * ```
 */
