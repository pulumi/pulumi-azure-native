...
export class LabAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices/latest:LabAccount';
    ...
    constructor(name: string, args: LabAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:labservices/preview:LabAccount" }, { type: "azurerm:labservices/v20181015:LabAccount" }] };
