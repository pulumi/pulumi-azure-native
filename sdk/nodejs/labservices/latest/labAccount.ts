...
export class LabAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:labservices/latest:LabAccount';
     ...
     */
    public /*out*/ readonly sizeConfiguration!: pulumi.Output<outputs.labservices.latest.SizeConfigurationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LabAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:labservices/latest:LabAccount" }, { type: "azure-native:labservices:LabAccount" }, { type: "azure-nextgen:labservices:LabAccount" }, { type: "azure-native:labservices/v20181015:LabAccount" }, { type: "azure-nextgen:labservices/v20181015:LabAccount" }] };
