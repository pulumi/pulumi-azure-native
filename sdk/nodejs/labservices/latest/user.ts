...
export class User extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:labservices/latest:User';
    ...
    constructor(name: string, args: UserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:labservices/latest:User" }, { type: "azure-native:labservices:User" }, { type: "azure-nextgen:labservices:User" }, { type: "azure-native:labservices/v20181015:User" }, { type: "azure-nextgen:labservices/v20181015:User" }] };
