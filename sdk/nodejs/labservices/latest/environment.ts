 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:labservices:Environment'.
 */
export class Environment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:labservices/latest:Environment';
     ...
     */
    public /*out*/ readonly networkInterface!: pulumi.Output<outputs.labservices.latest.NetworkInterfaceResponse>;
    /**
     ...
     */
    public readonly resourceSets!: pulumi.Output<outputs.labservices.latest.ResourceSetResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:labservices/latest:Environment" }, { type: "azure-native:labservices:Environment" }, { type: "azure-nextgen:labservices:Environment" }, { type: "azure-native:labservices/v20181015:Environment" }, { type: "azure-nextgen:labservices/v20181015:Environment" }] };
...
export interface EnvironmentArgs {
     ...
     * The set of a VM and the setting id it was created for
     */
    readonly resourceSets?: pulumi.Input<inputs.labservices.latest.ResourceSet>;
    /**
     * The tags of the resource.
     */
