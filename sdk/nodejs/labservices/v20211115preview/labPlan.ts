...
export class LabPlan extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.labservices.v20211115preview.LabPlanPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LabPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.labservices.v20211115preview.labPlanPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface LabPlanArgs {
     ...
     * Lab plan resource properties
     */
    properties: pulumi.Input<inputs.labservices.v20211115preview.LabPlanPropertiesArgs>;
    /**
