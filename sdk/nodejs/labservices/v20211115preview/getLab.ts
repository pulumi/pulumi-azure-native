...
export function getLab(args: GetLabArgs, opts?: pulumi.InvokeOptions): Promise<GetLabResult> {
    pulumi.log.warn("getLab is deprecated: azure-native:labservices/v20211115preview:Lab is being removed in the next major version of this provider. Upgrade to at least azure-native:labservices/v20220801:Lab to guarantee forwards compatibility.")
