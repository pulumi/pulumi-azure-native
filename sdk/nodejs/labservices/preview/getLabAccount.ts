...
export function getLabAccount(args: GetLabAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetLabAccountResult> {
    ...
    return pulumi.runtime.invoke("azurerm:labservices/preview:getLabAccount", {
        "expand": args.expand,
...
export interface GetLabAccountResult {
     ...
     */
    readonly sizeConfiguration: outputs.labservices.preview.SizeConfigurationPropertiesResponse;
    /**
