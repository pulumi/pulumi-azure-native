...
export class LabAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices/preview:LabAccount';
     ...
     */
    public /*out*/ readonly sizeConfiguration!: pulumi.Output<outputs.labservices.preview.SizeConfigurationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LabAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:labservices/latest:LabAccount" }, { type: "azurerm:labservices/v20181015:LabAccount" }] };
