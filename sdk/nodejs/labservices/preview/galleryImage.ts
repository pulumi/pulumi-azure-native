...
export class GalleryImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices/preview:GalleryImage';
     ...
     */
    public /*out*/ readonly imageReference!: pulumi.Output<outputs.labservices.preview.GalleryImageReferenceResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: GalleryImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:labservices/latest:GalleryImage" }, { type: "azurerm:labservices/v20181015:GalleryImage" }] };
