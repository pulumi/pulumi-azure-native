...
export class Environment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices/preview:Environment';
     ...
     */
    public /*out*/ readonly networkInterface!: pulumi.Output<outputs.labservices.preview.NetworkInterfaceResponse>;
    /**
     ...
     */
    public readonly resourceSets!: pulumi.Output<outputs.labservices.preview.ResourceSetResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:labservices/latest:Environment" }, { type: "azurerm:labservices/v20181015:Environment" }] };
...
export interface EnvironmentArgs {
     ...
     * The set of a VM and the setting id it was created for
     */
    readonly resourceSets?: pulumi.Input<inputs.labservices.preview.ResourceSet>;
    /**
     * The tags of the resource.
     */
