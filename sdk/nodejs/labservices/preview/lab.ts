...
export class Lab extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices/preview:Lab';
     ...
     */
    public /*out*/ readonly latestOperationResult!: pulumi.Output<outputs.labservices.preview.LatestOperationResultResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:labservices/latest:Lab" }, { type: "azurerm:labservices/v20181015:Lab" }] };
