...
export function getGalleryImage(args: GetGalleryImageArgs, opts?: pulumi.InvokeOptions): Promise<GetGalleryImageResult> {
    ...
    return pulumi.runtime.invoke("azurerm:labservices/preview:getGalleryImage", {
        "expand": args.expand,
...
export interface GetGalleryImageResult {
     ...
     */
    readonly imageReference: outputs.labservices.preview.GalleryImageReferenceResponse;
    /**
