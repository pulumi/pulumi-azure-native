...
export class EnvironmentSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices/preview:EnvironmentSetting';
     ...
     */
    public readonly resourceSettings!: pulumi.Output<outputs.labservices.preview.ResourceSettingsResponse>;
    /**
    ...
    constructor(name: string, args: EnvironmentSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:labservices/latest:EnvironmentSetting" }, { type: "azurerm:labservices/v20181015:EnvironmentSetting" }] };
...
export interface EnvironmentSettingArgs {
     ...
     * The resource specific settings
     */
    readonly resourceSettings: pulumi.Input<inputs.labservices.preview.ResourceSettings>;
    /**
     * The tags of the resource.
     */
