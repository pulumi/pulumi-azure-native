...
export class Lab extends pulumi.CustomResource {
     ...
     */
    public readonly autoShutdownProfile!: pulumi.Output<outputs.labservices.v20230607.AutoShutdownProfileResponse>;
    /**
     * The connection profile for the lab. This controls settings such as web access to lab resources or whether RDP or SSH ports are open.
     */
    public readonly connectionProfile!: pulumi.Output<outputs.labservices.v20230607.ConnectionProfileResponse>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.labservices.v20230607.LabNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly rosterProfile!: pulumi.Output<outputs.labservices.v20230607.RosterProfileResponse | undefined>;
    /**
     * The lab security profile.
     */
    public readonly securityProfile!: pulumi.Output<outputs.labservices.v20230607.SecurityProfileResponse>;
    /**
     * The lab state.
     */
     ...
     */
    public readonly virtualMachineProfile!: pulumi.Output<outputs.labservices.v20230607.VirtualMachineProfileResponse>;
    ...
    constructor(name: string, args: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["autoShutdownProfile"] = args ? (args.autoShutdownProfile ? pulumi.output(args.autoShutdownProfile).apply(inputs.labservices.v20230607.autoShutdownProfileArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["connectionProfile"] = args ? (args.connectionProfile ? pulumi.output(args.connectionProfile).apply(inputs.labservices.v20230607.connectionProfileArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["virtualMachineProfile"] = args ? (args.virtualMachineProfile ? pulumi.output(args.virtualMachineProfile).apply(inputs.labservices.v20230607.virtualMachineProfileArgsProvideDefaults) : undefined) : undefined;
...
export interface LabArgs {
     ...
     * The resource auto shutdown configuration for the lab. This controls whether actions are taken on resources that are sitting idle.
     */
    autoShutdownProfile: pulumi.Input<inputs.labservices.v20230607.AutoShutdownProfileArgs>;
    /**
     * The connection profile for the lab. This controls settings such as web access to lab resources or whether RDP or SSH ports are open.
     */
    connectionProfile: pulumi.Input<inputs.labservices.v20230607.ConnectionProfileArgs>;
    /**
     * The description of the lab.
     */
     ...
     * The network profile for the lab, typically applied via a lab plan. This profile cannot be modified once a lab has been created.
     */
    networkProfile?: pulumi.Input<inputs.labservices.v20230607.LabNetworkProfileArgs>;
    /**
     ...
     * The lab user list management profile.
     */
    rosterProfile?: pulumi.Input<inputs.labservices.v20230607.RosterProfileArgs>;
    /**
     * The lab security profile.
     */
    securityProfile: pulumi.Input<inputs.labservices.v20230607.SecurityProfileArgs>;
    /**
     * Resource tags.
     */
     ...
     * The profile used for creating lab virtual machines.
     */
    virtualMachineProfile: pulumi.Input<inputs.labservices.v20230607.VirtualMachineProfileArgs>;
}
