...
export class Lab extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:labservices/latest:Lab" }, { type: "azure-nextgen:labservices/latest:Lab" }, { type: "azure-native:labservices/v20181015:Lab" }, { type: "azure-nextgen:labservices/v20181015:Lab" }] };
