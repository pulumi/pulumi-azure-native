...
export class Labaccount extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LabaccountState, opts?: pulumi.CustomResourceOptions): Labaccount {
        return new Labaccount(name, <any>state, { ...opts, id: id });
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.labservices.LabAccountPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: LabaccountArgs | LabaccountState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as LabaccountState | undefined;
...
export interface LabaccountState {
     ...
     * The properties of the resource.
     */
    readonly properties: pulumi.Input<inputs.labservices.LabAccountPropertiesResponse>;
    /**
     * The tags of the resource.
     */
...
export interface LabaccountArgs {
     ...
     * The properties of the resource.
     */
    readonly properties?: pulumi.Input<inputs.labservices.LabAccountProperties>;
    /**
