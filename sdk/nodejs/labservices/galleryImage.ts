...
export class GalleryImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices:GalleryImage';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.labservices.GalleryImagePropertiesResponse>;
    /**
...
export interface GalleryImageArgs {
     ...
     * The gallery image properties
     */
    readonly properties?: pulumi.Input<inputs.labservices.GalleryImageProperties>;
    /**
