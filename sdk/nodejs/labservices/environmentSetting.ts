...
export class EnvironmentSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices:EnvironmentSetting';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.labservices.EnvironmentSettingPropertiesResponse>;
    /**
...
export interface EnvironmentSettingArgs {
     ...
     * The properties of the Environment Setting resource
     */
    readonly properties?: pulumi.Input<inputs.labservices.EnvironmentSettingProperties>;
    /**
