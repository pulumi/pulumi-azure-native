 ...
 *
 * @deprecated azure-native:labservices/v20211001preview:User is being removed in the next major version of this provider. Please upgrade to azure-native:labservices/v20220801:User to guarantee forwards compatibility.
 */
export class User extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): User {
        pulumi.log.warn("User is deprecated: azure-native:labservices/v20211001preview:User is being removed in the next major version of this provider. Please upgrade to azure-native:labservices/v20220801:User to guarantee forwards compatibility.")
        return new User(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:labservices/v20211001preview:User';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.labservices.v20211001preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: UserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:labservices/v20211115preview:User" }, { type: "azure-native:labservices/v20220801:User" }] };
