...
export class LabAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LabAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:labservices:LabAccount" }, { type: "azure-native:labservices/v20181015:LabAccount" }, { type: "azure-nextgen:labservices/v20181015:LabAccount" }] };
