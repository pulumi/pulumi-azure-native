...
export class LabAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:labservices:LabAccount';
    ...
    constructor(name: string, args: LabAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:labservices/latest:LabAccount" }, { type: "azure-nextgen:labservices/v20181015:LabAccount" }] };
