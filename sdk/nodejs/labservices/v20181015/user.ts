...
export class User extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices/v20181015:User';
    ...
    constructor(name: string, argsOrState?: UserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:labservices/latest:User" }, { type: "azurerm:labservices/preview:User" }] };
