...
export class EnvironmentSetting extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvironmentSetting {
        return new EnvironmentSetting(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:labservices/v20181015:EnvironmentSetting';
    ...
    constructor(name: string, argsOrState?: EnvironmentSettingArgs, opts?: pulumi.CustomResourceOptions) {
