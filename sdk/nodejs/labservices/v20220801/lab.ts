...
export class Lab extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.labservices.v20220801.LabPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.labservices.v20220801.labPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface LabArgs {
     ...
     * Lab resource properties
     */
    properties: pulumi.Input<inputs.labservices.v20220801.LabPropertiesArgs>;
    /**
