...
export function getRedisEnterprise(args: GetRedisEnterpriseArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisEnterpriseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:redisenterprise/v20201001preview:getRedisEnterprise", {
...
export interface GetRedisEnterpriseResult {
     ...
     */
    readonly privateEndpointConnections: outputs.redisenterprise.v20201001preview.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly sku: outputs.redisenterprise.v20201001preview.SkuResponse;
    /**
     * Resource tags.
     */
...
export function getRedisEnterpriseOutput(args: GetRedisEnterpriseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRedisEnterpriseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:redisenterprise/v20201001preview:getRedisEnterprise", {
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
