...
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redisenterprise/v20201001preview:RedisEnterprise';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.redisenterprise.v20201001preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.redisenterprise.v20201001preview.SkuResponse>;
    /**
     * Resource tags.
     */
...
export interface RedisEnterpriseArgs {
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<inputs.redisenterprise.v20201001preview.SkuArgs>;
    /**
     * Resource tags.
     */
