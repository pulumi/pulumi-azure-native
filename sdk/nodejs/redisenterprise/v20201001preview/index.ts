...
// Export enums:
export * from "../../types/enums/redisenterprise/v20201001preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redisenterprise/v20201001preview:RedisEnterprise":
...
pulumi.runtime.registerResourceModule("azure-native", "redisenterprise/v20201001preview", _module)
