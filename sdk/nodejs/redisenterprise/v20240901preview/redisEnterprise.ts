...
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redisenterprise/v20240901preview:RedisEnterprise';
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.redisenterprise.v20240901preview.ClusterPropertiesResponseEncryption | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.redisenterprise.v20240901preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.redisenterprise.v20240901preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.redisenterprise.v20240901preview.SkuResponse>;
    /**
     * Resource tags.
     */
...
export interface RedisEnterpriseArgs {
     ...
     * Encryption-at-rest configuration for the cluster.
     */
    encryption?: pulumi.Input<inputs.redisenterprise.v20240901preview.ClusterPropertiesEncryptionArgs>;
    /**
     * Enabled by default. If highAvailability is disabled, the data set is not replicated. This affects the availability SLA, and increases the risk of data loss.
     */
    highAvailability?: pulumi.Input<string | enums.redisenterprise.v20240901preview.HighAvailability>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.redisenterprise.v20240901preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'. Newer versions can be added in the future. Note that TLS 1.0 and TLS 1.1 are now completely obsolete -- you cannot use them. They are mentioned only for the sake of consistency with old API versions.
     */
    minimumTlsVersion?: pulumi.Input<string | enums.redisenterprise.v20240901preview.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<inputs.redisenterprise.v20240901preview.SkuArgs>;
    /**
     * Resource tags.
     */
