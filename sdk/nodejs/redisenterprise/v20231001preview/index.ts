...
// Export enums:
export * from "../../types/enums/redisenterprise/v20231001preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redisenterprise/v20231001preview:EnterprisePrivateEndpointConnection":
                return new EnterprisePrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:redisenterprise/v20231001preview:RedisEnterprise":
...
pulumi.runtime.registerResourceModule("azure-native", "redisenterprise/v20231001preview", _module)
