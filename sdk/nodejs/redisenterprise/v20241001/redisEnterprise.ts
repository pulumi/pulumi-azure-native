...
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redisenterprise/v20241001:RedisEnterprise';
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.redisenterprise.v20241001.ClusterPropertiesResponseEncryption | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.redisenterprise.v20241001.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.redisenterprise.v20241001.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.redisenterprise.v20241001.SkuResponse>;
    /**
     * Resource tags.
     */
...
export interface RedisEnterpriseArgs {
     ...
     * Encryption-at-rest configuration for the cluster.
     */
    encryption?: pulumi.Input<inputs.redisenterprise.v20241001.ClusterPropertiesEncryptionArgs>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.redisenterprise.v20241001.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'
     */
    minimumTlsVersion?: pulumi.Input<string | enums.redisenterprise.v20241001.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<inputs.redisenterprise.v20241001.SkuArgs>;
    /**
     * Resource tags.
     */
