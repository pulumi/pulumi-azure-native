...
// Export enums:
export * from "../../types/enums/redisenterprise/v20241001";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redisenterprise/v20241001:EnterpriseDatabase":
                return new EnterpriseDatabase(name, <any>undefined, { urn })
            case "azure-native:redisenterprise/v20241001:EnterprisePrivateEndpointConnection":
                return new EnterprisePrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:redisenterprise/v20241001:RedisEnterprise":
...
pulumi.runtime.registerResourceModule("azure-native", "redisenterprise/v20241001", _module)
