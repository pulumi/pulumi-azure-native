...
export function getEnterpriseDatabase(args: GetEnterpriseDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetEnterpriseDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:redisenterprise/v20240201:getEnterpriseDatabase", {
...
export interface GetEnterpriseDatabaseResult {
     ...
     */
    readonly geoReplication?: outputs.redisenterprise.v20240201.DatabasePropertiesResponseGeoReplication;
    /**
     ...
     */
    readonly modules?: outputs.redisenterprise.v20240201.ModuleResponse[];
    /**
     ...
     */
    readonly persistence?: outputs.redisenterprise.v20240201.PersistenceResponse;
    /**
...
export function getEnterpriseDatabaseOutput(args: GetEnterpriseDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnterpriseDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:redisenterprise/v20240201:getEnterpriseDatabase", {
        "clusterName": args.clusterName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
