...
export class DatabasePrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20240413:DatabasePrincipalAssignment';
...
export interface DatabasePrincipalAssignmentArgs {
     ...
     * Principal type.
     */
    principalType: pulumi.Input<string | enums.kusto.v20240413.PrincipalType>;
    /**
     ...
     * Database principal role.
     */
    role: pulumi.Input<string | enums.kusto.v20240413.DatabasePrincipalRole>;
    /**
     * The tenant id of the principal
     */
