...
export class Script extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20240413:Script';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kusto.v20240413.SystemDataResponse>;
    /**
...
export interface ScriptArgs {
     ...
     * Indicates if the permissions for the script caller are kept following completion of the script.
     */
    principalPermissionsAction?: pulumi.Input<string | enums.kusto.v20240413.PrincipalPermissionsAction>;
    /**
     ...
     * Differentiates between the type of script commands included - Database or Cluster. The default is Database.
     */
    scriptLevel?: pulumi.Input<string | enums.kusto.v20240413.ScriptLevel>;
    /**
