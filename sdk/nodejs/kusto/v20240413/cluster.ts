...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20240413:Cluster';
     ...
     */
    public readonly acceptedAudiences!: pulumi.Output<outputs.kusto.v20240413.AcceptedAudiencesResponse[] | undefined>;
    /**
     ...
     */
    public readonly calloutPolicies!: pulumi.Output<outputs.kusto.v20240413.CalloutPolicyResponse[] | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.kusto.v20240413.IdentityResponse | undefined>;
    /**
     * KeyVault properties for the cluster encryption.
     */
    public readonly keyVaultProperties!: pulumi.Output<outputs.kusto.v20240413.KeyVaultPropertiesResponse | undefined>;
    /**
     * List of the cluster's language extensions.
     */
    public readonly languageExtensions!: pulumi.Output<outputs.kusto.v20240413.LanguageExtensionsListResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly migrationCluster!: pulumi.Output<outputs.kusto.v20240413.MigrationClusterPropertiesResponse>;
    /**
     ...
     */
    public readonly optimizedAutoscale!: pulumi.Output<outputs.kusto.v20240413.OptimizedAutoscaleResponse | undefined>;
    /**
     * A list of private endpoint connections.
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.kusto.v20240413.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.kusto.v20240413.AzureSkuResponse>;
    /**
     ...
     */
    public readonly trustedExternalTenants!: pulumi.Output<outputs.kusto.v20240413.TrustedExternalTenantResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkConfiguration!: pulumi.Output<outputs.kusto.v20240413.VirtualNetworkConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["virtualNetworkConfiguration"] = args ? (args.virtualNetworkConfiguration ? pulumi.output(args.virtualNetworkConfiguration).apply(inputs.kusto.v20240413.virtualNetworkConfigurationArgsProvideDefaults) : undefined) : undefined;
...
export interface ClusterArgs {
     ...
     * The cluster's accepted audiences.
     */
    acceptedAudiences?: pulumi.Input<pulumi.Input<inputs.kusto.v20240413.AcceptedAudiencesArgs>[]>;
    /**
     * List of allowed FQDNs(Fully Qualified Domain Name) for egress from Cluster.
     */
     ...
     * List of callout policies for egress from Cluster.
     */
    calloutPolicies?: pulumi.Input<pulumi.Input<inputs.kusto.v20240413.CalloutPolicyArgs>[]>;
    /**
     ...
     * The engine type
     */
    engineType?: pulumi.Input<string | enums.kusto.v20240413.EngineType>;
    /**
     * The identity of the cluster, if configured.
     */
    identity?: pulumi.Input<inputs.kusto.v20240413.IdentityArgs>;
    /**
     * KeyVault properties for the cluster encryption.
     */
    keyVaultProperties?: pulumi.Input<inputs.kusto.v20240413.KeyVaultPropertiesArgs>;
    /**
     * List of the cluster's language extensions.
     */
    languageExtensions?: pulumi.Input<inputs.kusto.v20240413.LanguageExtensionsListArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Optimized auto scale definition.
     */
    optimizedAutoscale?: pulumi.Input<inputs.kusto.v20240413.OptimizedAutoscaleArgs>;
    /**
     * Indicates what public IP type to create - IPv4 (default), or DualStack (both IPv4 and IPv6)
     */
    publicIPType?: pulumi.Input<string | enums.kusto.v20240413.PublicIPType>;
    /**
     * Public network access to the cluster is enabled by default. When disabled, only private endpoint connection to the cluster is allowed
     */
    publicNetworkAccess?: pulumi.Input<string | enums.kusto.v20240413.PublicNetworkAccess>;
    /**
     ...
     * Whether or not to restrict outbound network access.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    restrictOutboundNetworkAccess?: pulumi.Input<string | enums.kusto.v20240413.ClusterNetworkAccessFlag>;
    /**
     * The SKU of the cluster.
     */
    sku: pulumi.Input<inputs.kusto.v20240413.AzureSkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * The cluster's external tenants.
     */
    trustedExternalTenants?: pulumi.Input<pulumi.Input<inputs.kusto.v20240413.TrustedExternalTenantArgs>[]>;
    /**
     ...
     * Virtual network definition.
     */
    virtualNetworkConfiguration?: pulumi.Input<inputs.kusto.v20240413.VirtualNetworkConfigurationArgs>;
    /**
     * The availability zones of the cluster.
     */
