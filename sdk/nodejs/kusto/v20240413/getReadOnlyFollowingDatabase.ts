...
export function getReadOnlyFollowingDatabase(args: GetReadOnlyFollowingDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetReadOnlyFollowingDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:kusto/v20240413:getReadOnlyFollowingDatabase", {
...
export interface GetReadOnlyFollowingDatabaseResult {
     ...
     */
    readonly statistics: outputs.kusto.v20240413.DatabaseStatisticsResponse;
    /**
     * The database suspension details. If the database is suspended, this object contains information related to the database's suspension state.
     */
    readonly suspensionDetails: outputs.kusto.v20240413.SuspensionDetailsResponse;
    /**
     * Table level sharing specifications
     */
    readonly tableLevelSharingProperties: outputs.kusto.v20240413.TableLevelSharingPropertiesResponse;
    /**
...
export function getReadOnlyFollowingDatabaseOutput(args: GetReadOnlyFollowingDatabaseOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetReadOnlyFollowingDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:kusto/v20240413:getReadOnlyFollowingDatabase", {
        "clusterName": args.clusterName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
