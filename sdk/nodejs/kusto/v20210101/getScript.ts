...
export function getScript(args: GetScriptArgs, opts?: pulumi.InvokeOptions): Promise<GetScriptResult> {
    pulumi.log.warn("getScript is deprecated: azure-native:kusto/v20210101:Script is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20210827:Script to guarantee forwards compatibility.")
