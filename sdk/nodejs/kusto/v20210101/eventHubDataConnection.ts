...
export interface EventHubDataConnectionArgs {
     ...
     * The event hub messages compression type
     */
    readonly compression?: pulumi.Input<string | enums.kusto.v20210101.Compression>;
    /**
     * The event hub consumer group.
     */
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    readonly dataFormat?: pulumi.Input<string | enums.kusto.v20210101.EventHubDataFormat>;
    /**
     ...
     * The resource ID of a managed identity (system or user assigned) to be used to authenticate with event hub.
     */
    readonly managedIdentityResourceId?: pulumi.Input<string>;
    /**
     * The mapping rule to be used to ingest the data. Optionally the mapping information can be added to each message.
     */
