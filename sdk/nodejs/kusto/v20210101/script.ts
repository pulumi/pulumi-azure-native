 ...
 *
 * const script = new azure_native.kusto.v20210101.Script("script", {
...
export class Script extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20210101:Script';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kusto.v20210101.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: ScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kusto:Script" }, { type: "azure-native:kusto/v20210827:Script" }, { type: "azure-native:kusto/v20220201:Script" }, { type: "azure-native:kusto/v20220707:Script" }, { type: "azure-native:kusto/v20221111:Script" }, { type: "azure-native:kusto/v20221229:Script" }] };
