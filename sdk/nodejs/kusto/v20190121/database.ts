 ...
 *
 * @deprecated Version 2019-01-21 will be removed in v2 of the provider.
 */
export class Database extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Database {
        pulumi.log.warn("Database is deprecated: Version 2019-01-21 will be removed in v2 of the provider.")
