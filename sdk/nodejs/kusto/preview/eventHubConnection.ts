...
export class EventHubConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:kusto/preview:EventHubConnection';
    ...
    constructor(name: string, argsOrState?: EventHubConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:kusto/v20170907privatepreview:EventHubConnection" }, { type: "azurerm:kusto/v20180907preview:EventHubConnection" }] };
