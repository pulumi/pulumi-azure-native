...
export class DataConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataConnection {
        return new DataConnection(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:kusto/preview:DataConnection';
    ...
    constructor(name: string, argsOrState?: DataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            const args = argsOrState as DataConnectionArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:kusto/latest:DataConnection" }, { type: "azurerm:kusto/v20190121:DataConnection" }, { type: "azurerm:kusto/v20190515:DataConnection" }, { type: "azurerm:kusto/v20190907:DataConnection" }, { type: "azurerm:kusto/v20191109:DataConnection" }, { type: "azurerm:kusto/v20200215:DataConnection" }, { type: "azurerm:kusto/v20200614:DataConnection" }] };
