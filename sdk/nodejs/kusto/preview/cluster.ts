...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:kusto/preview:Cluster';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.kusto.preview.IdentityResponse | undefined>;
    /**
     * KeyVault properties for the cluster encryption.
     */
    public readonly keyVaultProperties!: pulumi.Output<outputs.kusto.preview.KeyVaultPropertiesResponse | undefined>;
    /**
     * List of the cluster's language extensions.
     */
    public /*out*/ readonly languageExtensions!: pulumi.Output<outputs.kusto.preview.LanguageExtensionsListResponse>;
    /**
     ...
     */
    public readonly optimizedAutoscale!: pulumi.Output<outputs.kusto.preview.OptimizedAutoscaleResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.kusto.preview.AzureSkuResponse>;
    /**
     ...
     */
    public readonly trustedExternalTenants!: pulumi.Output<outputs.kusto.preview.TrustedExternalTenantResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkConfiguration!: pulumi.Output<outputs.kusto.preview.VirtualNetworkConfigurationResponse | undefined>;
    /**
...
export interface ClusterArgs {
     ...
     * The identity of the cluster, if configured.
     */
    readonly identity?: pulumi.Input<inputs.kusto.preview.Identity>;
    /**
     * KeyVault properties for the cluster encryption.
     */
    readonly keyVaultProperties?: pulumi.Input<inputs.kusto.preview.KeyVaultProperties>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Optimized auto scale definition.
     */
    readonly optimizedAutoscale?: pulumi.Input<inputs.kusto.preview.OptimizedAutoscale>;
    /**
     ...
     * The SKU of the cluster.
     */
    readonly sku: pulumi.Input<inputs.kusto.preview.AzureSku>;
    /**
     * Resource tags.
     */
     ...
     * The cluster's external tenants.
     */
    readonly trustedExternalTenants?: pulumi.Input<pulumi.Input<inputs.kusto.preview.TrustedExternalTenant>[]>;
    /**
     * Virtual network definition.
     */
    readonly virtualNetworkConfiguration?: pulumi.Input<inputs.kusto.preview.VirtualNetworkConfiguration>;
    /**
     * The availability zones of the cluster.
     */
