...
export class AttachedDatabaseConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:kusto/preview:AttachedDatabaseConfiguration';
