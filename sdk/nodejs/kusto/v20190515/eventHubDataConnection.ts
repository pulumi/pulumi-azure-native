 ...
 *
 * @deprecated azure-native:kusto/v20190515:EventHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:EventHubDataConnection to guarantee forwards compatibility.
 */
export class EventHubDataConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventHubDataConnection {
        pulumi.log.warn("EventHubDataConnection is deprecated: azure-native:kusto/v20190515:EventHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:EventHubDataConnection to guarantee forwards compatibility.")
        return new EventHubDataConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20190515:EventHubDataConnection';
