 ...
 *
 * const iotHubDataConnection = new azure_native.kusto.v20200918.IotHubDataConnection("iotHubDataConnection", {
...
export class IotHubDataConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20200918:IotHubDataConnection';
...
export interface IotHubDataConnectionArgs {
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    dataFormat?: pulumi.Input<string | enums.kusto.v20200918.IotHubDataFormat>;
    /**
