 ...
 */
/** @deprecated Version 2020-09-18 will be removed in v2 of the provider. */
export function getDatabasePrincipalAssignment(args: GetDatabasePrincipalAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabasePrincipalAssignmentResult> {
    pulumi.log.warn("getDatabasePrincipalAssignment is deprecated: Version 2020-09-18 will be removed in v2 of the provider.")
