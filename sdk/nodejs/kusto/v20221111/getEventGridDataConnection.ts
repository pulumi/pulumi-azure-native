...
export function getEventGridDataConnection(args: GetEventGridDataConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetEventGridDataConnectionResult> {
    pulumi.log.warn("getEventGridDataConnection is deprecated: azure-native:kusto/v20221111:EventGridDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:EventGridDataConnection to guarantee forwards compatibility.")
