...
export class CosmosDbDataConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CosmosDbDataConnection {
        pulumi.log.warn("CosmosDbDataConnection is deprecated: azure-native:kusto/v20221111:CosmosDbDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:CosmosDbDataConnection to guarantee forwards compatibility.")
        return new CosmosDbDataConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20221111:CosmosDbDataConnection';
