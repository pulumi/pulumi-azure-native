 ...
 *
 * const readOnlyFollowingDatabase = new azure_native.kusto.v20221111.ReadOnlyFollowingDatabase("readOnlyFollowingDatabase", {
...
export class ReadOnlyFollowingDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20221111:ReadOnlyFollowingDatabase';
     ...
     */
    public /*out*/ readonly tableLevelSharingProperties!: pulumi.Output<outputs.kusto.v20221111.TableLevelSharingPropertiesResponse>;
    /**
