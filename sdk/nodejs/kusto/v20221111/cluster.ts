 ...
 *
 * @deprecated azure-native:kusto/v20221111:Cluster is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:Cluster to guarantee forwards compatibility.
 */
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20221111:Cluster';
     ...
     */
    public readonly acceptedAudiences!: pulumi.Output<outputs.kusto.v20221111.AcceptedAudiencesResponse[] | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.kusto.v20221111.IdentityResponse | undefined>;
    /**
     * KeyVault properties for the cluster encryption.
     */
    public readonly keyVaultProperties!: pulumi.Output<outputs.kusto.v20221111.KeyVaultPropertiesResponse | undefined>;
    /**
     * List of the cluster's language extensions.
     */
    public readonly languageExtensions!: pulumi.Output<outputs.kusto.v20221111.LanguageExtensionsListResponse | undefined>;
    /**
     ...
     */
    public readonly optimizedAutoscale!: pulumi.Output<outputs.kusto.v20221111.OptimizedAutoscaleResponse | undefined>;
    /**
     * A list of private endpoint connections.
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.kusto.v20221111.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.kusto.v20221111.AzureSkuResponse>;
    /**
     ...
     */
    public readonly trustedExternalTenants!: pulumi.Output<outputs.kusto.v20221111.TrustedExternalTenantResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkConfiguration!: pulumi.Output<outputs.kusto.v20221111.VirtualNetworkConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kusto:Cluster" }, { type: "azure-native:kusto/v20170907privatepreview:Cluster" }, { type: "azure-native:kusto/v20180907preview:Cluster" }, { type: "azure-native:kusto/v20190121:Cluster" }, { type: "azure-native:kusto/v20190515:Cluster" }, { type: "azure-native:kusto/v20190907:Cluster" }, { type: "azure-native:kusto/v20191109:Cluster" }, { type: "azure-native:kusto/v20200215:Cluster" }, { type: "azure-native:kusto/v20200614:Cluster" }, { type: "azure-native:kusto/v20200918:Cluster" }, { type: "azure-native:kusto/v20210101:Cluster" }, { type: "azure-native:kusto/v20210827:Cluster" }, { type: "azure-native:kusto/v20220201:Cluster" }, { type: "azure-native:kusto/v20220707:Cluster" }, { type: "azure-native:kusto/v20221229:Cluster" }] };
...
export interface ClusterArgs {
     ...
     * The cluster's accepted audiences.
     */
    acceptedAudiences?: pulumi.Input<pulumi.Input<inputs.kusto.v20221111.AcceptedAudiencesArgs>[]>;
    /**
     * List of allowed FQDNs(Fully Qualified Domain Name) for egress from Cluster.
     */
     ...
     * The engine type
     */
    engineType?: pulumi.Input<string | enums.kusto.v20221111.EngineType>;
    /**
     * The identity of the cluster, if configured.
     */
    identity?: pulumi.Input<inputs.kusto.v20221111.IdentityArgs>;
    /**
     * KeyVault properties for the cluster encryption.
     */
    keyVaultProperties?: pulumi.Input<inputs.kusto.v20221111.KeyVaultPropertiesArgs>;
    /**
     * List of the cluster's language extensions.
     */
    languageExtensions?: pulumi.Input<inputs.kusto.v20221111.LanguageExtensionsListArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Optimized auto scale definition.
     */
    optimizedAutoscale?: pulumi.Input<inputs.kusto.v20221111.OptimizedAutoscaleArgs>;
    /**
     * Indicates what public IP type to create - IPv4 (default), or DualStack (both IPv4 and IPv6)
     */
    publicIPType?: pulumi.Input<string | enums.kusto.v20221111.PublicIPType>;
    /**
     * Public network access to the cluster is enabled by default. When disabled, only private endpoint connection to the cluster is allowed
     */
    publicNetworkAccess?: pulumi.Input<string | enums.kusto.v20221111.PublicNetworkAccess>;
    /**
     ...
     * Whether or not to restrict outbound network access.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    restrictOutboundNetworkAccess?: pulumi.Input<string | enums.kusto.v20221111.ClusterNetworkAccessFlag>;
    /**
     * The SKU of the cluster.
     */
    sku: pulumi.Input<inputs.kusto.v20221111.AzureSkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * The cluster's external tenants.
     */
    trustedExternalTenants?: pulumi.Input<pulumi.Input<inputs.kusto.v20221111.TrustedExternalTenantArgs>[]>;
    /**
     ...
     * Virtual network definition.
     */
    virtualNetworkConfiguration?: pulumi.Input<inputs.kusto.v20221111.VirtualNetworkConfigurationArgs>;
    /**
     * The availability zones of the cluster.
     */
