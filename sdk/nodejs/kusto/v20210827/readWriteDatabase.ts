 ...
 *
 * @deprecated azure-native:kusto/v20210827:ReadWriteDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ReadWriteDatabase to guarantee forwards compatibility.
 */
export class ReadWriteDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReadWriteDatabase {
        pulumi.log.warn("ReadWriteDatabase is deprecated: azure-native:kusto/v20210827:ReadWriteDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ReadWriteDatabase to guarantee forwards compatibility.")
