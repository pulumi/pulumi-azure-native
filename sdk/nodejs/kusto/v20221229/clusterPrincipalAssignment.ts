 ...
 *
 * const clusterPrincipalAssignment = new azure_native.kusto.v20221229.ClusterPrincipalAssignment("clusterPrincipalAssignment", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:kusto/v20221229:ClusterPrincipalAssignment kustoCluster/kustoprincipal1 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/kustoCluster/PrincipalAssignments/kustoprincipal1 
 * ```
 */
...
export interface ClusterPrincipalAssignmentArgs {
     ...
     * Principal type.
     */
    principalType: pulumi.Input<string | enums.kusto.v20221229.PrincipalType>;
    /**
     ...
     * Cluster principal role.
     */
    role: pulumi.Input<string | enums.kusto.v20221229.ClusterPrincipalRole>;
    /**
     * The tenant id of the principal
     */
