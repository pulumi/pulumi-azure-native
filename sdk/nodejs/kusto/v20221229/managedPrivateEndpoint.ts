 ...
 *
 * const managedPrivateEndpoint = new azure_native.kusto.v20221229.ManagedPrivateEndpoint("managedPrivateEndpoint", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:kusto/v20221229:ManagedPrivateEndpoint kustoCluster/KustoDatabase8/managedPrivateEndpointTest /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/kustoCluster/ManagedPrivateEndpoints/managedPrivateEndpointTest 
 * ```
 */
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kusto:ManagedPrivateEndpoint" }, { type: "azure-native:kusto/v20210827:ManagedPrivateEndpoint" }, { type: "azure-native:kusto/v20220201:ManagedPrivateEndpoint" }, { type: "azure-native:kusto/v20220707:ManagedPrivateEndpoint" }, { type: "azure-native:kusto/v20221111:ManagedPrivateEndpoint" }] };
