...
export class ClusterPrincipalAssignment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.kusto.v20200215.ClusterPrincipalPropertiesResponse>;
    /**
...
export interface ClusterPrincipalAssignmentArgs {
     ...
     * The cluster principal.
     */
    readonly properties?: pulumi.Input<inputs.kusto.v20200215.ClusterPrincipalProperties>;
    /**
