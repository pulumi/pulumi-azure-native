 ...
 *
 * const dataConnection = new azurerm.kusto.v20200215.DataConnection("dataConnection", {
...
export class DataConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:kusto/v20200215:DataConnection';
    ...
    constructor(name: string, argsOrState?: DataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:kusto/latest:DataConnection" }, { type: "azurerm:kusto/v20190121:DataConnection" }, { type: "azurerm:kusto/v20190515:DataConnection" }, { type: "azurerm:kusto/v20190907:DataConnection" }, { type: "azurerm:kusto/v20191109:DataConnection" }, { type: "azurerm:kusto/v20200614:DataConnection" }] };
