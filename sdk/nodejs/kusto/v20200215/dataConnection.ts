...
export class DataConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:kusto/v20200215:DataConnection" }, { type: "azure-native:kusto:DataConnection" }, { type: "azure-nextgen:kusto:DataConnection" }, { type: "azure-native:kusto/v20190121:DataConnection" }, { type: "azure-nextgen:kusto/v20190121:DataConnection" }, { type: "azure-native:kusto/v20190515:DataConnection" }, { type: "azure-nextgen:kusto/v20190515:DataConnection" }, { type: "azure-native:kusto/v20190907:DataConnection" }, { type: "azure-nextgen:kusto/v20190907:DataConnection" }, { type: "azure-native:kusto/v20191109:DataConnection" }, { type: "azure-nextgen:kusto/v20191109:DataConnection" }, { type: "azure-native:kusto/v20200614:DataConnection" }, { type: "azure-nextgen:kusto/v20200614:DataConnection" }, { type: "azure-native:kusto/v20200918:DataConnection" }, { type: "azure-nextgen:kusto/v20200918:DataConnection" }, { type: "azure-native:kusto/v20210101:DataConnection" }, { type: "azure-nextgen:kusto/v20210101:DataConnection" }] };
...
export interface DataConnectionArgs {
     ...
     * Kind of the endpoint for the data connection
     */
    readonly kind: pulumi.Input<string | enums.kusto.v20200215.Kind>;
    /**
     * Resource location.
     */
