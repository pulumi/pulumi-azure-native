...
export function getReadOnlyFollowingDatabase(args: GetReadOnlyFollowingDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetReadOnlyFollowingDatabaseResult> {
    pulumi.log.warn("getReadOnlyFollowingDatabase is deprecated: azure-native:kusto/v20220707:ReadOnlyFollowingDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ReadOnlyFollowingDatabase to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:kusto/v20220707:getReadOnlyFollowingDatabase", {
...
export interface GetReadOnlyFollowingDatabaseResult {
     ...
     */
    readonly statistics: outputs.kusto.v20220707.DatabaseStatisticsResponse;
    /**
     * Table level sharing specifications
     */
    readonly tableLevelSharingProperties: outputs.kusto.v20220707.TableLevelSharingPropertiesResponse;
    /**
