...
export class AttachedDatabaseConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AttachedDatabaseConfiguration {
        pulumi.log.warn("AttachedDatabaseConfiguration is deprecated: azure-native:kusto/v20220707:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility.")
        return new AttachedDatabaseConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20220707:AttachedDatabaseConfiguration';
     ...
     */
    public readonly tableLevelSharingProperties!: pulumi.Output<outputs.kusto.v20220707.TableLevelSharingPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AttachedDatabaseConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kusto:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20190907:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20191109:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20200215:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20200614:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20200918:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20210101:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20210827:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20220201:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20221111:AttachedDatabaseConfiguration" }, { type: "azure-native:kusto/v20221229:AttachedDatabaseConfiguration" }] };
...
export interface AttachedDatabaseConfigurationArgs {
     ...
     * The default principals modification kind
     */
    defaultPrincipalsModificationKind: pulumi.Input<string | enums.kusto.v20220707.DefaultPrincipalsModificationKind>;
    /**
     * Resource location.
     */
     ...
     * Table level sharing specifications
     */
    tableLevelSharingProperties?: pulumi.Input<inputs.kusto.v20220707.TableLevelSharingPropertiesArgs>;
}
