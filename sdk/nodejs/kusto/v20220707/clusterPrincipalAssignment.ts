 ...
 *
 * @deprecated azure-native:kusto/v20220707:ClusterPrincipalAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ClusterPrincipalAssignment to guarantee forwards compatibility.
 */
export class ClusterPrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20220707:ClusterPrincipalAssignment';
...
export interface ClusterPrincipalAssignmentArgs {
     ...
     * Cluster principal role.
     */
    role: pulumi.Input<string | enums.kusto.v20220707.ClusterPrincipalRole>;
    /**
     * The tenant id of the principal
     */
