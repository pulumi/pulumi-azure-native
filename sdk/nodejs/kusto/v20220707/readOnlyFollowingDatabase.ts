 ...
 *
 * @deprecated azure-native:kusto/v20220707:ReadOnlyFollowingDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ReadOnlyFollowingDatabase to guarantee forwards compatibility.
 */
export class ReadOnlyFollowingDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReadOnlyFollowingDatabase {
        pulumi.log.warn("ReadOnlyFollowingDatabase is deprecated: azure-native:kusto/v20220707:ReadOnlyFollowingDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ReadOnlyFollowingDatabase to guarantee forwards compatibility.")
        return new ReadOnlyFollowingDatabase(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20220707:ReadOnlyFollowingDatabase';
     ...
     */
    public /*out*/ readonly statistics!: pulumi.Output<outputs.kusto.v20220707.DatabaseStatisticsResponse>;
    /**
     * Table level sharing specifications
     */
    public /*out*/ readonly tableLevelSharingProperties!: pulumi.Output<outputs.kusto.v20220707.TableLevelSharingPropertiesResponse>;
    /**
