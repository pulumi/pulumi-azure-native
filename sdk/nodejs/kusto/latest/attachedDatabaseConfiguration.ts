...
export class AttachedDatabaseConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/latest:AttachedDatabaseConfiguration';
...
export interface AttachedDatabaseConfigurationArgs {
     ...
     * The default principals modification kind
     */
    readonly defaultPrincipalsModificationKind: pulumi.Input<string | enums.kusto.latest.DefaultPrincipalsModificationKind>;
    /**
     * Resource location.
     */
