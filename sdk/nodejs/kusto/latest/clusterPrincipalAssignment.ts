...
export class ClusterPrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/latest:ClusterPrincipalAssignment';
    ...
    constructor(name: string, args: ClusterPrincipalAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:kusto/latest:ClusterPrincipalAssignment" }, { type: "azure-native:kusto:ClusterPrincipalAssignment" }, { type: "azure-nextgen:kusto:ClusterPrincipalAssignment" }, { type: "azure-native:kusto/v20191109:ClusterPrincipalAssignment" }, { type: "azure-nextgen:kusto/v20191109:ClusterPrincipalAssignment" }, { type: "azure-native:kusto/v20200215:ClusterPrincipalAssignment" }, { type: "azure-nextgen:kusto/v20200215:ClusterPrincipalAssignment" }, { type: "azure-native:kusto/v20200614:ClusterPrincipalAssignment" }, { type: "azure-nextgen:kusto/v20200614:ClusterPrincipalAssignment" }, { type: "azure-native:kusto/v20200918:ClusterPrincipalAssignment" }, { type: "azure-nextgen:kusto/v20200918:ClusterPrincipalAssignment" }] };
...
export interface ClusterPrincipalAssignmentArgs {
     ...
     * Cluster principal role.
     */
    readonly role: pulumi.Input<string | enums.kusto.latest.ClusterPrincipalRole>;
    /**
     * The tenant id of the principal
     */
