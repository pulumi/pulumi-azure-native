...
export class Database extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Database {
        pulumi.log.warn("Database is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:kusto:Database'.")
        return new Database(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:kusto/latest:Database';
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:kusto:Database" }, { type: "azure-nextgen:kusto/v20170907privatepreview:Database" }, { type: "azure-nextgen:kusto/v20180907preview:Database" }, { type: "azure-nextgen:kusto/v20190121:Database" }, { type: "azure-nextgen:kusto/v20190515:Database" }, { type: "azure-nextgen:kusto/v20190907:Database" }, { type: "azure-nextgen:kusto/v20191109:Database" }, { type: "azure-nextgen:kusto/v20200215:Database" }, { type: "azure-nextgen:kusto/v20200614:Database" }, { type: "azure-nextgen:kusto/v20200918:Database" }] };
