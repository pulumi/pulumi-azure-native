...
export function listClusterLanguageExtensions(args: ListClusterLanguageExtensionsArgs, opts?: pulumi.InvokeOptions): Promise<ListClusterLanguageExtensionsResult> {
    pulumi.log.warn("listClusterLanguageExtensions is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kusto:listClusterLanguageExtensions'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:kusto/latest:listClusterLanguageExtensions", {
