...
export interface GetReadWriteDatabaseResult {
     ...
     */
    readonly keyVaultProperties?: outputs.kusto.v20230815.KeyVaultPropertiesResponse;
    /**
     ...
     */
    readonly statistics: outputs.kusto.v20230815.DatabaseStatisticsResponse;
    /**
     * The database suspension details. If the database is suspended, this object contains information related to the database's suspension state.
     */
    readonly suspensionDetails: outputs.kusto.v20230815.SuspensionDetailsResponse;
    /**
...
export function getReadWriteDatabaseOutput(args: GetReadWriteDatabaseOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetReadWriteDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:kusto/v20230815:getReadWriteDatabase", {
        "clusterName": args.clusterName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
