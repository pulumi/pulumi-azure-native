...
export class Script extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Script {
        pulumi.log.warn("Script is deprecated: azure-native:kusto/v20220201:Script is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:Script to guarantee forwards compatibility.")
        return new Script(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20220201:Script';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kusto.v20220201.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: ScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kusto:Script" }, { type: "azure-native:kusto/v20210101:Script" }, { type: "azure-native:kusto/v20210827:Script" }, { type: "azure-native:kusto/v20220707:Script" }, { type: "azure-native:kusto/v20221111:Script" }, { type: "azure-native:kusto/v20221229:Script" }] };
