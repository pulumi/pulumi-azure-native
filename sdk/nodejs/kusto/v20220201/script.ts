...
export class Script extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kusto:Script" }, { type: "azure-native:kusto/v20210101:Script" }, { type: "azure-native:kusto/v20210827:Script" }, { type: "azure-native:kusto/v20220707:Script" }] };
