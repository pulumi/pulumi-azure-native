 ...
 */
/** @deprecated azure-native:kusto/v20220201:ManagedPrivateEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ManagedPrivateEndpoint to guarantee forwards compatibility. */
export function getManagedPrivateEndpoint(args: GetManagedPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedPrivateEndpointResult> {
    pulumi.log.warn("getManagedPrivateEndpoint is deprecated: azure-native:kusto/v20220201:ManagedPrivateEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ManagedPrivateEndpoint to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:kusto/v20220201:getManagedPrivateEndpoint", {
