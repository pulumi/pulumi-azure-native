...
export class Cluster extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:kusto/latest:Cluster" }, { type: "azurerm:kusto/preview:Cluster" }, { type: "azurerm:kusto/v20170907privatepreview:Cluster" }, { type: "azurerm:kusto/v20180907preview:Cluster" }, { type: "azurerm:kusto/v20190121:Cluster" }, { type: "azurerm:kusto/v20190515:Cluster" }, { type: "azurerm:kusto/v20190907:Cluster" }, { type: "azurerm:kusto/v20200215:Cluster" }, { type: "azurerm:kusto/v20200614:Cluster" }] };
