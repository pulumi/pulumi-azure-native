...
export class DatabasePrincipalAssignment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.kusto.v20191109.DatabasePrincipalPropertiesResponse>;
    /**
...
export interface DatabasePrincipalAssignmentArgs {
     ...
     * The database principal.
     */
    readonly properties?: pulumi.Input<inputs.kusto.v20191109.DatabasePrincipalProperties>;
    /**
