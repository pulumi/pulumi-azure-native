 ...
 *
 * @deprecated azure-native:kusto/v20191109:DatabasePrincipalAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:DatabasePrincipalAssignment to guarantee forwards compatibility.
 */
export class DatabasePrincipalAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabasePrincipalAssignment {
        pulumi.log.warn("DatabasePrincipalAssignment is deprecated: azure-native:kusto/v20191109:DatabasePrincipalAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:DatabasePrincipalAssignment to guarantee forwards compatibility.")
        return new DatabasePrincipalAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20191109:DatabasePrincipalAssignment';
...
export interface DatabasePrincipalAssignmentArgs {
     ...
     * Principal type.
     */
    principalType: pulumi.Input<string | enums.kusto.v20191109.PrincipalType>;
    /**
     ...
     * Database principal role.
     */
    role: pulumi.Input<string | enums.kusto.v20191109.DatabasePrincipalRole>;
    /**
     * The tenant id of the principal
     */
