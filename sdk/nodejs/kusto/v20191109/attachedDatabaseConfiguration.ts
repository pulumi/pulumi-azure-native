...
export class AttachedDatabaseConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: AttachedDatabaseConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:kusto/v20190907:AttachedDatabaseConfiguration" }, { type: "azurerm:kusto/v20200215:AttachedDatabaseConfiguration" }, { type: "azurerm:kusto/v20200614:AttachedDatabaseConfiguration" }] };
