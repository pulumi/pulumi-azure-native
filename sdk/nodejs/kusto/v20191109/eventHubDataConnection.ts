...
export class EventHubDataConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20191109:EventHubDataConnection';
    ...
    constructor(name: string, args: EventHubDataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:kusto/v20191109:EventHubDataConnection" }, { type: "azure-native:kusto:EventHubDataConnection" }, { type: "azure-nextgen:kusto:EventHubDataConnection" }, { type: "azure-native:kusto/v20190121:EventHubDataConnection" }, { type: "azure-nextgen:kusto/v20190121:EventHubDataConnection" }, { type: "azure-native:kusto/v20190515:EventHubDataConnection" }, { type: "azure-nextgen:kusto/v20190515:EventHubDataConnection" }, { type: "azure-native:kusto/v20190907:EventHubDataConnection" }, { type: "azure-nextgen:kusto/v20190907:EventHubDataConnection" }, { type: "azure-native:kusto/v20200215:EventHubDataConnection" }, { type: "azure-nextgen:kusto/v20200215:EventHubDataConnection" }, { type: "azure-native:kusto/v20200614:EventHubDataConnection" }, { type: "azure-nextgen:kusto/v20200614:EventHubDataConnection" }, { type: "azure-native:kusto/v20200918:EventHubDataConnection" }, { type: "azure-nextgen:kusto/v20200918:EventHubDataConnection" }, { type: "azure-native:kusto/v20210101:EventHubDataConnection" }, { type: "azure-nextgen:kusto/v20210101:EventHubDataConnection" }] };
...
export interface EventHubDataConnectionArgs {
     ...
     * The event hub messages compression type
     */
    readonly compression?: pulumi.Input<string | enums.kusto.v20191109.Compression>;
    /**
     * The event hub consumer group.
     */
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    readonly dataFormat?: pulumi.Input<string | enums.kusto.v20191109.EventHubDataFormat>;
    /**
