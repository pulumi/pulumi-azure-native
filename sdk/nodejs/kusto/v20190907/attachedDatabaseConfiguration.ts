...
export class AttachedDatabaseConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.kusto.v20190907.AttachedDatabaseConfigurationPropertiesResponse>;
    /**
...
export interface AttachedDatabaseConfigurationArgs {
     ...
     * The properties of the attached database configuration.
     */
    readonly properties?: pulumi.Input<inputs.kusto.v20190907.AttachedDatabaseConfigurationProperties>;
    /**
