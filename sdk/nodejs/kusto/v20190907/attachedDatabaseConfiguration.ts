 ...
 *
 * @deprecated azure-native:kusto/v20190907:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility.
 */
export class AttachedDatabaseConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AttachedDatabaseConfiguration {
        pulumi.log.warn("AttachedDatabaseConfiguration is deprecated: azure-native:kusto/v20190907:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility.")
...
export interface AttachedDatabaseConfigurationArgs {
     ...
     * The default principals modification kind
     */
    defaultPrincipalsModificationKind: pulumi.Input<string | enums.kusto.v20190907.DefaultPrincipalsModificationKind>;
    /**
     * Resource location.
     */
