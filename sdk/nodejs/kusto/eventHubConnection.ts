...
export class EventHubConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventHubConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kusto/v20180907preview:EventHubConnection" }, { type: "azure-native_kusto_v20170907privatepreview:kusto:EventHubConnection" }, { type: "azure-native_kusto_v20180907preview:kusto:EventHubConnection" }] };
