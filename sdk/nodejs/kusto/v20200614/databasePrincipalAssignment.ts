...
export class DatabasePrincipalAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DatabasePrincipalAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:kusto/latest:DatabasePrincipalAssignment" }, { type: "azurerm:kusto/v20191109:DatabasePrincipalAssignment" }, { type: "azurerm:kusto/v20200215:DatabasePrincipalAssignment" }] };
