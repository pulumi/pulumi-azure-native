 ...
 */
/** @deprecated azure-native:kusto/v20200614:IotHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility. */
export function getIotHubDataConnection(args: GetIotHubDataConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetIotHubDataConnectionResult> {
    pulumi.log.warn("getIotHubDataConnection is deprecated: azure-native:kusto/v20200614:IotHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.")
