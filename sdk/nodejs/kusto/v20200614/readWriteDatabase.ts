...
export class ReadWriteDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20200614:ReadWriteDatabase';
    ...
    constructor(name: string, args: ReadWriteDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:kusto/v20200614:ReadWriteDatabase" }, { type: "azure-native:kusto:ReadWriteDatabase" }, { type: "azure-nextgen:kusto:ReadWriteDatabase" }, { type: "azure-native:kusto/v20170907privatepreview:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20170907privatepreview:ReadWriteDatabase" }, { type: "azure-native:kusto/v20180907preview:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20180907preview:ReadWriteDatabase" }, { type: "azure-native:kusto/v20190121:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20190121:ReadWriteDatabase" }, { type: "azure-native:kusto/v20190515:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20190515:ReadWriteDatabase" }, { type: "azure-native:kusto/v20190907:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20190907:ReadWriteDatabase" }, { type: "azure-native:kusto/v20191109:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20191109:ReadWriteDatabase" }, { type: "azure-native:kusto/v20200215:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20200215:ReadWriteDatabase" }, { type: "azure-native:kusto/v20200918:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20200918:ReadWriteDatabase" }, { type: "azure-native:kusto/v20210101:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20210101:ReadWriteDatabase" }, { type: "azure-native:kusto/v20210827:ReadWriteDatabase" }, { type: "azure-nextgen:kusto/v20210827:ReadWriteDatabase" }] };
