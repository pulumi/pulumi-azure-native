 ...
 */
/** @deprecated azure-native:kusto/v20200614:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility. */
export function getAttachedDatabaseConfiguration(args: GetAttachedDatabaseConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetAttachedDatabaseConfigurationResult> {
    pulumi.log.warn("getAttachedDatabaseConfiguration is deprecated: azure-native:kusto/v20200614:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility.")
