...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:signalrservice/v20240301:SignalR":
                return new SignalR(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20240301:SignalRCustomCertificate":
                return new SignalRCustomCertificate(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20240301:SignalRCustomDomain":
                return new SignalRCustomDomain(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20240301:SignalRPrivateEndpointConnection":
                return new SignalRPrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20240301:SignalRReplica":
                return new SignalRReplica(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20240301:SignalRSharedPrivateLinkResource":
...
pulumi.runtime.registerResourceModule("azure-native", "signalrservice/v20240301", _module)
