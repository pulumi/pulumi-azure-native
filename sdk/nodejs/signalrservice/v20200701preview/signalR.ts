...
export class SignalR extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SignalRArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:signalrservice/latest:SignalR" }, { type: "azurerm:signalrservice/v20180301preview:SignalR" }, { type: "azurerm:signalrservice/v20181001:SignalR" }, { type: "azurerm:signalrservice/v20200501:SignalR" }] };
