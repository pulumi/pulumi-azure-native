...
export class SignalRPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SignalRPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:signalrservice/v20200701preview:SignalRPrivateEndpointConnection" }, { type: "azure-native:signalrservice:SignalRPrivateEndpointConnection" }, { type: "azure-nextgen:signalrservice:SignalRPrivateEndpointConnection" }, { type: "azure-native:signalrservice/latest:SignalRPrivateEndpointConnection" }, { type: "azure-nextgen:signalrservice/latest:SignalRPrivateEndpointConnection" }, { type: "azure-native:signalrservice/v20200501:SignalRPrivateEndpointConnection" }, { type: "azure-nextgen:signalrservice/v20200501:SignalRPrivateEndpointConnection" }] };
...
export interface SignalRPrivateEndpointConnectionArgs {
     ...
     * Private endpoint associated with the private endpoint connection
     */
    readonly privateEndpoint?: pulumi.Input<inputs.signalrservice.v20200701preview.PrivateEndpoint>;
    /**
     ...
     * Connection state
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.signalrservice.v20200701preview.PrivateLinkServiceConnectionState>;
    /**
