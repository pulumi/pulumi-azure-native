...
export class SignalRSharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SignalRSharedPrivateLinkResource {
        pulumi.log.warn("SignalRSharedPrivateLinkResource is deprecated: azure-native:signalrservice/v20210601preview:SignalRSharedPrivateLinkResource is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230201:SignalRSharedPrivateLinkResource to guarantee forwards compatibility.")
