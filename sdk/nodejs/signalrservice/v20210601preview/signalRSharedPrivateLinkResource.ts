...
export class SignalRSharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SignalRSharedPrivateLinkResource {
        pulumi.log.warn("SignalRSharedPrivateLinkResource is deprecated: azure-native:signalrservice/v20210601preview:SignalRSharedPrivateLinkResource is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRSharedPrivateLinkResource to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: SignalRSharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:signalrservice:SignalRSharedPrivateLinkResource" }, { type: "azure-native:signalrservice/v20210401preview:SignalRSharedPrivateLinkResource" }, { type: "azure-native:signalrservice/v20210901preview:SignalRSharedPrivateLinkResource" }, { type: "azure-native:signalrservice/v20211001:SignalRSharedPrivateLinkResource" }, { type: "azure-native:signalrservice/v20220201:SignalRSharedPrivateLinkResource" }, { type: "azure-native:signalrservice/v20220801preview:SignalRSharedPrivateLinkResource" }, { type: "azure-native:signalrservice/v20230201:SignalRSharedPrivateLinkResource" }] };
