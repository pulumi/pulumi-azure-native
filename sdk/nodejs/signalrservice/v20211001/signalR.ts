 ...
 *
 * @deprecated azure-native:signalrservice/v20211001:SignalR is being removed in the next major version of this provider. Please upgrade to azure-native:signalrservice/v20230201:SignalR to guarantee forwards compatibility.
 */
export class SignalR extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SignalR {
        pulumi.log.warn("SignalR is deprecated: azure-native:signalrservice/v20211001:SignalR is being removed in the next major version of this provider. Please upgrade to azure-native:signalrservice/v20230201:SignalR to guarantee forwards compatibility.")
        return new SignalR(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20211001:SignalR';
     ...
     */
    public readonly cors!: pulumi.Output<outputs.signalrservice.v20211001.SignalRCorsSettingsResponse | undefined>;
    /**
     * DisableLocalAuth
     ...
     */
    public readonly features!: pulumi.Output<outputs.signalrservice.v20211001.SignalRFeatureResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.signalrservice.v20211001.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: SignalRArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["tls"] = args ? (args.tls ? pulumi.output(args.tls).apply(inputs.signalrservice.v20211001.signalRTlsSettingsArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:signalrservice:SignalR" }, { type: "azure-native:signalrservice/v20180301preview:SignalR" }, { type: "azure-native:signalrservice/v20181001:SignalR" }, { type: "azure-native:signalrservice/v20200501:SignalR" }, { type: "azure-native:signalrservice/v20200701preview:SignalR" }, { type: "azure-native:signalrservice/v20210401preview:SignalR" }, { type: "azure-native:signalrservice/v20210601preview:SignalR" }, { type: "azure-native:signalrservice/v20210901preview:SignalR" }, { type: "azure-native:signalrservice/v20220201:SignalR" }, { type: "azure-native:signalrservice/v20220801preview:SignalR" }, { type: "azure-native:signalrservice/v20230201:SignalR" }] };
