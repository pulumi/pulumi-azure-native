...
export class SignalRCustomDomain extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.signalrservice.v20220201.CustomDomainPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SignalRCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:signalrservice:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20220801preview:SignalRCustomDomain" }] };
...
export interface SignalRCustomDomainArgs {
     ...
     * Properties of a custom domain.
     */
    properties: pulumi.Input<inputs.signalrservice.v20220201.CustomDomainPropertiesArgs>;
    /**
