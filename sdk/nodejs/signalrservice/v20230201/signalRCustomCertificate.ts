 ...
 *
 * const signalRCustomCertificate = new azure_native.signalrservice.v20230201.SignalRCustomCertificate("signalRCustomCertificate", {
...
export class SignalRCustomCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SignalRCustomCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:signalrservice:SignalRCustomCertificate" }, { type: "azure-native:signalrservice/v20220201:SignalRCustomCertificate" }, { type: "azure-native:signalrservice/v20220801preview:SignalRCustomCertificate" }, { type: "azure-native:signalrservice/v20230301preview:SignalRCustomCertificate" }] };
