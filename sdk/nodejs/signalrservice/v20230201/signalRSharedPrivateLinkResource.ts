 ...
 *
 * const signalRSharedPrivateLinkResource = new azure_native.signalrservice.v20230201.SignalRSharedPrivateLinkResource("signalRSharedPrivateLinkResource", {
 *     groupId: "sites",
