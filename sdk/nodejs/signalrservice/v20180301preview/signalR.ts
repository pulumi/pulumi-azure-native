...
export class SignalR extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:signalrservice/v20180301preview:SignalR';
    ...
    constructor(name: string, argsOrState?: SignalRArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:signalrservice/latest:SignalR" }, { type: "azurerm:signalrservice/preview:SignalR" }, { type: "azurerm:signalrservice/v20181001:SignalR" }, { type: "azurerm:signalrservice/v20200501:SignalR" }, { type: "azurerm:signalrservice/v20200701preview:SignalR" }] };
