...
export class SignalRCustomCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20240401preview:SignalRCustomCertificate';
