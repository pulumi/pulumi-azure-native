...
export function getSignalR(args: GetSignalRArgs, opts?: pulumi.InvokeOptions): Promise<GetSignalRResult> {
    pulumi.log.warn("getSignalR is deprecated: azure-native:signalrservice/v20200501:SignalR is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalR to guarantee forwards compatibility.")
