...
export class SignalRPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SignalRPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:signalrservice/v20200501:SignalRPrivateEndpointConnection" }, { type: "azure-native:signalrservice:SignalRPrivateEndpointConnection" }, { type: "azure-nextgen:signalrservice:SignalRPrivateEndpointConnection" }, { type: "azure-native:signalrservice/v20200701preview:SignalRPrivateEndpointConnection" }, { type: "azure-nextgen:signalrservice/v20200701preview:SignalRPrivateEndpointConnection" }] };
