 ...
 *
 * @deprecated azure-native:signalrservice/v20220801preview:SignalRCustomCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:signalrservice/v20230201:SignalRCustomCertificate to guarantee forwards compatibility.
 */
export class SignalRCustomCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SignalRCustomCertificate {
        pulumi.log.warn("SignalRCustomCertificate is deprecated: azure-native:signalrservice/v20220801preview:SignalRCustomCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:signalrservice/v20230201:SignalRCustomCertificate to guarantee forwards compatibility.")
        return new SignalRCustomCertificate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20220801preview:SignalRCustomCertificate';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.signalrservice.v20220801preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: SignalRCustomCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:signalrservice:SignalRCustomCertificate" }, { type: "azure-native:signalrservice/v20220201:SignalRCustomCertificate" }, { type: "azure-native:signalrservice/v20230201:SignalRCustomCertificate" }] };
