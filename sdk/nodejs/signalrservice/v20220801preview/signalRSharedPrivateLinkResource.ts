...
export class SignalRSharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20220801preview:SignalRSharedPrivateLinkResource';
