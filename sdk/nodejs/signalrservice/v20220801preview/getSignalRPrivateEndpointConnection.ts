...
export function getSignalRPrivateEndpointConnection(args: GetSignalRPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetSignalRPrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:signalrservice/v20220801preview:getSignalRPrivateEndpointConnection", {
...
export interface GetSignalRPrivateEndpointConnectionResult {
     ...
     * Private endpoint
     */
    readonly privateEndpoint?: outputs.signalrservice.v20220801preview.PrivateEndpointResponse;
    /**
     * Connection state of the private endpoint connection
     */
    readonly privateLinkServiceConnectionState?: outputs.signalrservice.v20220801preview.PrivateLinkServiceConnectionStateResponse;
    /**
...
export function getSignalRPrivateEndpointConnectionOutput(args: GetSignalRPrivateEndpointConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSignalRPrivateEndpointConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:signalrservice/v20220801preview:getSignalRPrivateEndpointConnection", {
        "privateEndpointConnectionName": args.privateEndpointConnectionName,
        "resourceGroupName": args.resourceGroupName,
        "resourceName": args.resourceName,
    }, opts);
