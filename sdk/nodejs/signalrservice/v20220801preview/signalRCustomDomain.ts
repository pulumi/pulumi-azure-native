...
export class SignalRCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20220801preview:SignalRCustomDomain';
     ...
     */
    public readonly customCertificate!: pulumi.Output<outputs.signalrservice.v20220801preview.ResourceReferenceResponse>;
    /**
...
export interface SignalRCustomDomainArgs {
     ...
     * Reference to a resource.
     */
    customCertificate: pulumi.Input<inputs.signalrservice.v20220801preview.ResourceReferenceArgs>;
    /**
     * The custom domain name.
     */
