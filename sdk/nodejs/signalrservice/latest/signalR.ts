...
export class SignalR extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/latest:SignalR';
     ...
     */
    public readonly cors!: pulumi.Output<outputs.signalrservice.latest.SignalRCorsSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly features!: pulumi.Output<outputs.signalrservice.latest.SignalRFeatureResponse[] | undefined>;
    /**
     ...
     * Network ACLs
     */
    public readonly networkACLs!: pulumi.Output<outputs.signalrservice.latest.SignalRNetworkACLsResponse | undefined>;
    /**
     * Private endpoint connections to the SignalR resource.
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.signalrservice.latest.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.signalrservice.latest.ResourceSkuResponse | undefined>;
    /**
     ...
     */
    public readonly upstream!: pulumi.Output<outputs.signalrservice.latest.ServerlessUpstreamSettingsResponse | undefined>;
    /**
...
export interface SignalRArgs {
     ...
     * Cross-Origin Resource Sharing (CORS) settings.
     */
    readonly cors?: pulumi.Input<inputs.signalrservice.latest.SignalRCorsSettings>;
    /**
     * List of SignalR featureFlags. e.g. ServiceMode.
     * 
     * FeatureFlags that are not included in the parameters for the update operation will not be modified.
     ...
     * The kind of the service - e.g. "SignalR", or "RawWebSockets" for "Microsoft.SignalRService/SignalR"
     */
    readonly kind?: pulumi.Input<string | enums.signalrservice.latest.ServiceKind>;
    /**
     * The GEO location of the SignalR service. e.g. West US | East US | North Central US | South Central US.
     */
     ...
     * Network ACLs
     */
    readonly networkACLs?: pulumi.Input<inputs.signalrservice.latest.SignalRNetworkACLs>;
    /**
     ...
     * The billing information of the resource.(e.g. Free, Standard)
     */
    readonly sku?: pulumi.Input<inputs.signalrservice.latest.ResourceSku>;
    /**
     * Tags of the service which is a list of key value pairs that describe the resource.
     */
     ...
     * Upstream settings when the Azure SignalR is in server-less mode.
     */
    readonly upstream?: pulumi.Input<inputs.signalrservice.latest.ServerlessUpstreamSettings>;
}
