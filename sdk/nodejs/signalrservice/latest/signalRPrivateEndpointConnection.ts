...
export class SignalRPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:signalrservice/latest:SignalRPrivateEndpointConnection';
    ...
    constructor(name: string, argsOrState?: SignalRPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:signalrservice/preview:SignalRPrivateEndpointConnection" }, { type: "azurerm:signalrservice/v20200501:SignalRPrivateEndpointConnection" }, { type: "azurerm:signalrservice/v20200701preview:SignalRPrivateEndpointConnection" }] };
