...
export function getSignalRPrivateEndpointConnection(args: GetSignalRPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetSignalRPrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:signalrservice/preview:getSignalRPrivateEndpointConnection", {
...
export interface GetSignalRPrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: outputs.signalrservice.preview.PrivateEndpointResponse;
    /**
     * Connection state
     */
    readonly privateLinkServiceConnectionState?: outputs.signalrservice.preview.PrivateLinkServiceConnectionStateResponse;
    /**
