...
export class SignalRPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SignalRPrivateEndpointConnection {
        return new SignalRPrivateEndpointConnection(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:signalrservice/preview:SignalRPrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.signalrservice.preview.PrivateEndpointResponse | undefined>;
    /**
     * Connection state
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.signalrservice.preview.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SignalRPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:signalrservice/latest:SignalRPrivateEndpointConnection" }, { type: "azurerm:signalrservice/v20200501:SignalRPrivateEndpointConnection" }, { type: "azurerm:signalrservice/v20200701preview:SignalRPrivateEndpointConnection" }] };
...
export interface SignalRPrivateEndpointConnectionArgs {
     ...
     * Private endpoint associated with the private endpoint connection
     */
    readonly privateEndpoint?: pulumi.Input<inputs.signalrservice.preview.PrivateEndpoint>;
    /**
     ...
     * Connection state
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.signalrservice.preview.PrivateLinkServiceConnectionState>;
    /**
