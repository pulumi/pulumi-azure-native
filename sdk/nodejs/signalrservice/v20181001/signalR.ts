...
export class SignalR extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SignalRArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:signalrservice/latest:SignalR" }, { type: "azure-nextgen:signalrservice/v20180301preview:SignalR" }, { type: "azure-nextgen:signalrservice/v20200501:SignalR" }, { type: "azure-nextgen:signalrservice/v20200701preview:SignalR" }] };
