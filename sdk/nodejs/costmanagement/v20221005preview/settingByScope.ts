...
export class SettingByScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20221005preview:SettingByScope';
    ...
    constructor(name: string, args: SettingByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20221001preview:SettingByScope" }] };
...
export interface SettingByScopeArgs {
     ...
     * Specifies the kind of settings.
     */
    kind: pulumi.Input<string | enums.costmanagement.v20221005preview.SettingsKind>;
    /**
