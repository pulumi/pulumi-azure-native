...
export interface GetTagInheritanceSettingResult {
     ...
     */
    readonly properties: outputs.costmanagement.v20231101.TagInheritancePropertiesResponse;
    /**
...
export function getTagInheritanceSettingOutput(args: GetTagInheritanceSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTagInheritanceSettingResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:costmanagement/v20231101:getTagInheritanceSetting", {
        "scope": args.scope,
        "type": args.type,
    }, opts);
}
