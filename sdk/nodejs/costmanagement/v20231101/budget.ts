...
export class Budget extends pulumi.CustomResource {
     ...
     *  Supported for CategoryType(s): Cost.
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.costmanagement.v20231101.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.costmanagement.v20231101.BudgetFilterResponse | undefined>;
    /**
     * The forecasted cost which is being tracked for a budget.
     *
     *  Supported for CategoryType(s): Cost.
     */
    public /*out*/ readonly forecastSpend!: pulumi.Output<outputs.costmanagement.v20231101.ForecastSpendResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.costmanagement.v20231101.NotificationResponse} | undefined>;
    /**
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    public readonly timePeriod!: pulumi.Output<outputs.costmanagement.v20231101.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20190401preview:Budget" }, { type: "azure-native:costmanagement/v20230401preview:Budget" }, { type: "azure-native:costmanagement/v20230801:Budget" }, { type: "azure-native:costmanagement/v20230901:Budget" }, { type: "azure-native:costmanagement/v20240801:Budget" }, { type: "azure-native:costmanagement/v20241001preview:Budget" }, { type: "azure-native:costmanagement:Budget" }] };
...
export interface BudgetArgs {
     ...
     * - 'ReservationUtilization' defines a Reservation Utilization Alert Rule.
     */
    category: pulumi.Input<string | enums.costmanagement.v20231101.CategoryType>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
     */
    filter?: pulumi.Input<inputs.costmanagement.v20231101.BudgetFilterArgs>;
    /**
     * Dictionary of notifications associated with the budget.
     *
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
     ...
     * - Constraints for **CategoryType: ReservationUtilization** - Only one notification allowed. thresholdType is not applicable.
     */
    notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.costmanagement.v20231101.NotificationArgs>}>;
    /**
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    timeGrain: pulumi.Input<string | enums.costmanagement.v20231101.TimeGrainType>;
    /**
     * The time period that defines the active period of the budget. The budget will evaluate data on or after the startDate and will expire on the endDate.
     *
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    timePeriod: pulumi.Input<inputs.costmanagement.v20231101.BudgetTimePeriodArgs>;
}
