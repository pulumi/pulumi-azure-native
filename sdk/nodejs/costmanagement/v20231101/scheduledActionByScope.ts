...
export class ScheduledActionByScope extends pulumi.CustomResource {
     ...
     */
    public readonly fileDestination!: pulumi.Output<outputs.costmanagement.v20231101.FileDestinationResponse | undefined>;
    /**
     ...
     */
    public readonly notification!: pulumi.Output<outputs.costmanagement.v20231101.NotificationPropertiesResponse>;
    /**
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.costmanagement.v20231101.SchedulePropertiesResponse>;
    /**
     ...
     * Kind of the scheduled action.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.costmanagement.v20231101.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: ScheduledActionByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20220401preview:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20220601preview:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20221001:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20230301:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20230401preview:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20230701preview:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20230801:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20230901:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20240801:ScheduledActionByScope" }, { type: "azure-native:costmanagement/v20241001preview:ScheduledActionByScope" }, { type: "azure-native:costmanagement:ScheduledActionByScope" }] };
...
export interface ScheduledActionByScopeArgs {
     ...
     * Destination format of the view data. This is optional.
     */
    fileDestination?: pulumi.Input<inputs.costmanagement.v20231101.FileDestinationArgs>;
    /**
     * Kind of the scheduled action.
     */
    kind?: pulumi.Input<string | enums.costmanagement.v20231101.ScheduledActionKind>;
    /**
     * Scheduled action name.
     */
     ...
     * Notification properties based on scheduled action kind.
     */
    notification: pulumi.Input<inputs.costmanagement.v20231101.NotificationPropertiesArgs>;
    /**
     * Email address of the point of contact that should get the unsubscribe requests and notification emails.
     */
     ...
     * Schedule of the scheduled action.
     */
    schedule: pulumi.Input<inputs.costmanagement.v20231101.SchedulePropertiesArgs>;
    /**
     * For private scheduled action(Create or Update), scope will be empty.<br /> For shared scheduled action(Create or Update By Scope), Cost Management scope can be 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}' for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}' for EnrollmentAccount scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}' for BillingProfile scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}' for InvoiceSection scope, '/providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}' for ExternalBillingAccount scope, and '/providers/Microsoft.CostManagement/externalSubscriptions/{externalSubscriptionName}' for ExternalSubscription scope.
     */
     ...
     * Status of the scheduled action.
     */
    status: pulumi.Input<string | enums.costmanagement.v20231101.ScheduledActionStatus>;
    /**
     * Cost analysis viewId used for scheduled action. For example, '/providers/Microsoft.CostManagement/views/swaggerExample'
     */
