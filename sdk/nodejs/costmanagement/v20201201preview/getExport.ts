...
export function getExport(args: GetExportArgs, opts?: pulumi.InvokeOptions): Promise<GetExportResult> {
    pulumi.log.warn("getExport is deprecated: azure-native:costmanagement/v20201201preview:Export is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221001:Export to guarantee forwards compatibility.")
