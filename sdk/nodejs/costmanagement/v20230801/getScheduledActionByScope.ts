...
export interface GetScheduledActionByScopeResult {
     ...
     */
    readonly fileDestination?: outputs.costmanagement.v20230801.FileDestinationResponse;
    /**
     ...
     */
    readonly notification: outputs.costmanagement.v20230801.NotificationPropertiesResponse;
    /**
     ...
     */
    readonly schedule: outputs.costmanagement.v20230801.SchedulePropertiesResponse;
    /**
     ...
     * Kind of the scheduled action.
     */
    readonly systemData: outputs.costmanagement.v20230801.SystemDataResponse;
    /**
...
export function getScheduledActionByScopeOutput(args: GetScheduledActionByScopeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledActionByScopeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:costmanagement/v20230801:getScheduledActionByScope", {
        "name": args.name,
        "scope": args.scope,
    }, opts);
}
