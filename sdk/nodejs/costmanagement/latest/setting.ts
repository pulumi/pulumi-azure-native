 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:costmanagement:Setting'.
 */
export class Setting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/latest:Setting';
    ...
    constructor(name: string, args?: SettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/latest:Setting" }, { type: "azure-native:costmanagement:Setting" }, { type: "azure-nextgen:costmanagement:Setting" }, { type: "azure-native:costmanagement/v20191101:Setting" }, { type: "azure-nextgen:costmanagement/v20191101:Setting" }] };
