...
export class Export extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/latest:Export';
     ...
     */
    public readonly definition!: pulumi.Output<outputs.costmanagement.latest.ExportDefinitionResponse>;
    /**
     * Has delivery information for the export.
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.costmanagement.latest.ExportDeliveryInfoResponse>;
    /**
     ...
     */
    public /*out*/ readonly runHistory!: pulumi.Output<outputs.costmanagement.latest.ExportExecutionListResultResponse | undefined>;
    /**
     * Has schedule information for the export.
     */
    public readonly schedule!: pulumi.Output<outputs.costmanagement.latest.ExportScheduleResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: ExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/latest:Export" }, { type: "azure-native:costmanagement:Export" }, { type: "azure-nextgen:costmanagement:Export" }, { type: "azure-native:costmanagement/v20190101:Export" }, { type: "azure-nextgen:costmanagement/v20190101:Export" }, { type: "azure-native:costmanagement/v20190901:Export" }, { type: "azure-nextgen:costmanagement/v20190901:Export" }, { type: "azure-native:costmanagement/v20191001:Export" }, { type: "azure-nextgen:costmanagement/v20191001:Export" }, { type: "azure-native:costmanagement/v20191101:Export" }, { type: "azure-nextgen:costmanagement/v20191101:Export" }, { type: "azure-native:costmanagement/v20200601:Export" }, { type: "azure-nextgen:costmanagement/v20200601:Export" }] };
...
export interface ExportArgs {
     ...
     * Has the definition for the export.
     */
    readonly definition: pulumi.Input<inputs.costmanagement.latest.ExportDefinition>;
    /**
     * Has delivery information for the export.
     */
    readonly deliveryInfo: pulumi.Input<inputs.costmanagement.latest.ExportDeliveryInfo>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * Has schedule information for the export.
     */
    readonly schedule?: pulumi.Input<inputs.costmanagement.latest.ExportSchedule>;
    /**
