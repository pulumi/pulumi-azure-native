...
export class Export extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["partitionData"] = args ? args.partitionData : undefined;
            ...
            inputs["name"] = undefined /*out*/;
            inputs["nextRunTimeEstimate"] = undefined /*out*/;
            inputs["partitionData"] = undefined /*out*/;
            inputs["runHistory"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement:Export" }, { type: "azure-native:costmanagement/v20190101:Export" }, { type: "azure-nextgen:costmanagement/v20190101:Export" }, { type: "azure-native:costmanagement/v20190901:Export" }, { type: "azure-nextgen:costmanagement/v20190901:Export" }, { type: "azure-native:costmanagement/v20191001:Export" }, { type: "azure-nextgen:costmanagement/v20191001:Export" }, { type: "azure-native:costmanagement/v20191101:Export" }, { type: "azure-nextgen:costmanagement/v20191101:Export" }, { type: "azure-native:costmanagement/v20200601:Export" }, { type: "azure-nextgen:costmanagement/v20200601:Export" }, { type: "azure-native:costmanagement/v20201201preview:Export" }, { type: "azure-nextgen:costmanagement/v20201201preview:Export" }, { type: "azure-native:costmanagement/v20210101:Export" }, { type: "azure-nextgen:costmanagement/v20210101:Export" }] };
...
export interface ExportArgs {
     ...
     * Has the definition for the export.
     */
    readonly definition: pulumi.Input<inputs.costmanagement.ExportDefinitionArgs>;
    /**
     * Has delivery information for the export.
     */
    readonly deliveryInfo: pulumi.Input<inputs.costmanagement.ExportDeliveryInfoArgs>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * Has schedule information for the export.
     */
    readonly schedule?: pulumi.Input<inputs.costmanagement.ExportScheduleArgs>;
    /**
