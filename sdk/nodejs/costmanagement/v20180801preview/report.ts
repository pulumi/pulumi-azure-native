...
export class Report extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/v20180801preview:Report" }, { type: "azure-native:costmanagement:Report" }, { type: "azure-nextgen:costmanagement:Report" }] };
