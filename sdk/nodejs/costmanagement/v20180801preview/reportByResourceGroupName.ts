...
export class ReportByResourceGroupName extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReportByResourceGroupName {
        return new ReportByResourceGroupName(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: ReportByResourceGroupNameArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReportByResourceGroupNameArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/preview:ReportByResourceGroupName" }] };
