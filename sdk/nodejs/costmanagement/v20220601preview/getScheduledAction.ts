...
export function getScheduledAction(args: GetScheduledActionArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledActionResult> {
    pulumi.log.warn("getScheduledAction is deprecated: azure-native:costmanagement/v20220601preview:ScheduledAction is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221001:ScheduledAction to guarantee forwards compatibility.")
