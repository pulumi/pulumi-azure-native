...
export class View extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20230701preview:View';
     ...
     */
    public readonly dataSet!: pulumi.Output<outputs.costmanagement.v20230701preview.ReportConfigDatasetResponse | undefined>;
    /**
     ...
     */
    public readonly kpis!: pulumi.Output<outputs.costmanagement.v20230701preview.KpiPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public readonly pivots!: pulumi.Output<outputs.costmanagement.v20230701preview.PivotPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.costmanagement.v20230701preview.ReportConfigTimePeriodResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20190401preview:View" }, { type: "azure-native:costmanagement/v20191101:View" }, { type: "azure-native:costmanagement/v20200601:View" }, { type: "azure-native:costmanagement/v20211001:View" }, { type: "azure-native:costmanagement/v20220801preview:View" }, { type: "azure-native:costmanagement/v20221001:View" }, { type: "azure-native:costmanagement/v20221001preview:View" }, { type: "azure-native:costmanagement/v20221005preview:View" }, { type: "azure-native:costmanagement/v20230301:View" }, { type: "azure-native:costmanagement/v20230401preview:View" }, { type: "azure-native:costmanagement/v20230801:View" }, { type: "azure-native:costmanagement/v20230901:View" }, { type: "azure-native:costmanagement/v20231101:View" }, { type: "azure-native:costmanagement/v20240801:View" }, { type: "azure-native:costmanagement/v20241001preview:View" }, { type: "azure-native:costmanagement:View" }] };
...
export interface ViewArgs {
     ...
     * Show costs accumulated over time.
     */
    accumulated?: pulumi.Input<string | enums.costmanagement.v20230701preview.AccumulatedType>;
    /**
     * Chart type of the main view in Cost Analysis. Required.
     */
    chart?: pulumi.Input<string | enums.costmanagement.v20230701preview.ChartType>;
    /**
     * Has definition for data in this report config.
     */
    dataSet?: pulumi.Input<inputs.costmanagement.v20230701preview.ReportConfigDatasetArgs>;
    /**
     * Date range of the current view.
     */
     ...
     * List of KPIs to show in Cost Analysis UI.
     */
    kpis?: pulumi.Input<pulumi.Input<inputs.costmanagement.v20230701preview.KpiPropertiesArgs>[]>;
    /**
     * Metric to use when displaying costs.
     */
    metric?: pulumi.Input<string | enums.costmanagement.v20230701preview.MetricType>;
    /**
     * Date when the user last modified this view.
     */
     ...
     * Configuration of 3 sub-views in the Cost Analysis UI.
     */
    pivots?: pulumi.Input<pulumi.Input<inputs.costmanagement.v20230701preview.PivotPropertiesArgs>[]>;
    /**
     * Cost Management scope to save the view on. This includes 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}' for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}' for EnrollmentAccount scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}' for BillingProfile scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}' for InvoiceSection scope, 'providers/Microsoft.Management/managementGroups/{managementGroupId}' for Management Group scope, '/providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}' for ExternalBillingAccount scope, and '/providers/Microsoft.CostManagement/externalSubscriptions/{externalSubscriptionName}' for ExternalSubscription scope.
     */
     ...
     * Has time period for pulling data for the report.
     */
    timePeriod?: pulumi.Input<inputs.costmanagement.v20230701preview.ReportConfigTimePeriodArgs>;
    /**
     * The time frame for pulling data for the report. If custom, then a specific time period must be provided.
     */
    timeframe: pulumi.Input<string | enums.costmanagement.v20230701preview.ReportTimeframeType>;
    /**
     * The type of the report. Usage represents actual usage, forecast represents forecasted data and UsageAndForecast represents both usage and forecasted data. Actual usage and forecasted data can be differentiated based on dates.
     */
    type: pulumi.Input<string | enums.costmanagement.v20230701preview.ReportType>;
    /**
     * View name
     */
