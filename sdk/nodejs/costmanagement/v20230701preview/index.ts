...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:costmanagement/v20230701preview:Export":
                return new Export(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230701preview:ScheduledAction":
                return new ScheduledAction(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230701preview:ScheduledActionByScope":
                return new ScheduledActionByScope(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230701preview:View":
                return new View(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230701preview:ViewByScope":
...
pulumi.runtime.registerResourceModule("azure-native", "costmanagement/v20230701preview", _module)
