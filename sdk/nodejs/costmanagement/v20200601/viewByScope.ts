...
export class ViewByScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:costmanagement/v20200601:ViewByScope';
    ...
    constructor(name: string, args: ViewByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement:ViewByScope" }, { type: "azure-nextgen:costmanagement/latest:ViewByScope" }, { type: "azure-nextgen:costmanagement/v20190401preview:ViewByScope" }, { type: "azure-nextgen:costmanagement/v20191101:ViewByScope" }] };
