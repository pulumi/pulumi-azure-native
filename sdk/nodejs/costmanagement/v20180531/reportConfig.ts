...
export class ReportConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20180531:ReportConfig';
    ...
    constructor(name: string, args: ReportConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/v20180531:ReportConfig" }, { type: "azure-native:costmanagement:ReportConfig" }, { type: "azure-nextgen:costmanagement:ReportConfig" }, { type: "azure-native:costmanagement/latest:ReportConfig" }, { type: "azure-nextgen:costmanagement/latest:ReportConfig" }] };
