...
export class ReportConfigByResourceGroupName extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReportConfigByResourceGroupNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/v20180531:ReportConfigByResourceGroupName" }, { type: "azure-native:costmanagement:ReportConfigByResourceGroupName" }, { type: "azure-nextgen:costmanagement:ReportConfigByResourceGroupName" }, { type: "azure-native:costmanagement/latest:ReportConfigByResourceGroupName" }, { type: "azure-nextgen:costmanagement/latest:ReportConfigByResourceGroupName" }] };
