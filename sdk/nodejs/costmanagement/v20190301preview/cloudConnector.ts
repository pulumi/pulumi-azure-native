...
export class CloudConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: CloudConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20180801preview:CloudConnector" }, { type: "azure-native:costmanagement/v20180801preview:Connector" }, { type: "azure-native:costmanagement:CloudConnector" }, { type: "azure-native:costmanagement:Connector" }] };
...
export interface CloudConnectorArgs {
     ...
     * Connector billing model
     */
    billingModel?: pulumi.Input<string | enums.costmanagement.v20190301preview.ConnectorBillingModel>;
    /**
     * Connector Name.
     */
