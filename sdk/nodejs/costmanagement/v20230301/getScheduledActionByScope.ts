...
export interface GetScheduledActionByScopeResult {
     ...
     */
    readonly fileDestination?: outputs.costmanagement.v20230301.FileDestinationResponse;
    /**
     ...
     */
    readonly notification: outputs.costmanagement.v20230301.NotificationPropertiesResponse;
    /**
     ...
     */
    readonly schedule: outputs.costmanagement.v20230301.SchedulePropertiesResponse;
    /**
     ...
     * Kind of the scheduled action.
     */
    readonly systemData: outputs.costmanagement.v20230301.SystemDataResponse;
    /**
...
export function getScheduledActionByScopeOutput(args: GetScheduledActionByScopeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledActionByScopeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:costmanagement/v20230301:getScheduledActionByScope", {
        "name": args.name,
        "scope": args.scope,
    }, opts);
}
