...
export function getViewByScope(args: GetViewByScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetViewByScopeResult> {
    pulumi.log.warn("getViewByScope is deprecated: azure-native:costmanagement/v20211001:ViewByScope is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221005preview:ViewByScope to guarantee forwards compatibility.")
