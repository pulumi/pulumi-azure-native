...
export function getViewByScope(args: GetViewByScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetViewByScopeResult> {
    pulumi.log.warn("getViewByScope is deprecated: azure-native:costmanagement/v20211001:ViewByScope is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221001:ViewByScope to guarantee forwards compatibility.")
