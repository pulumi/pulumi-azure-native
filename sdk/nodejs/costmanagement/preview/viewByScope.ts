...
export class ViewByScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement/preview:ViewByScope';
    ...
    constructor(name: string, args: ViewByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:ViewByScope" }, { type: "azurerm:costmanagement/v20190401preview:ViewByScope" }, { type: "azurerm:costmanagement/v20191101:ViewByScope" }, { type: "azurerm:costmanagement/v20200601:ViewByScope" }] };
