...
export class CloudConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement/preview:CloudConnector';
     ...
     */
    public /*out*/ readonly collectionInfo!: pulumi.Output<outputs.costmanagement.preview.ConnectorCollectionInfoResponse>;
    /**
    ...
    constructor(name: string, args: CloudConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/v20190301preview:CloudConnector" }] };
