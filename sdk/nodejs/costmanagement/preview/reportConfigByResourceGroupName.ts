...
export class ReportConfigByResourceGroupName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement/preview:ReportConfigByResourceGroupName';
     ...
     */
    public readonly definition!: pulumi.Output<outputs.costmanagement.preview.ReportConfigDefinitionResponse>;
    /**
     * Has delivery information for the report config.
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.costmanagement.preview.ReportConfigDeliveryInfoResponse>;
    /**
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.costmanagement.preview.ReportConfigScheduleResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ReportConfigByResourceGroupNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:ReportConfigByResourceGroupName" }, { type: "azurerm:costmanagement/v20180531:ReportConfigByResourceGroupName" }] };
...
export interface ReportConfigByResourceGroupNameArgs {
     ...
     * Has definition for the report config.
     */
    readonly definition: pulumi.Input<inputs.costmanagement.preview.ReportConfigDefinition>;
    /**
     * Has delivery information for the report config.
     */
    readonly deliveryInfo: pulumi.Input<inputs.costmanagement.preview.ReportConfigDeliveryInfo>;
    /**
     * The format of the report being delivered.
     */
     ...
     * Has schedule information for the report config.
     */
    readonly schedule?: pulumi.Input<inputs.costmanagement.preview.ReportConfigSchedule>;
}
