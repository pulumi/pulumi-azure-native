...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement/preview:Budget';
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.costmanagement.preview.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.costmanagement.preview.ReportConfigFilterResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.costmanagement.preview.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<outputs.costmanagement.preview.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/v20190401preview:Budget" }] };
...
export interface BudgetArgs {
     ...
     * May be used to filter budgets.
     */
    readonly filter?: pulumi.Input<inputs.costmanagement.preview.ReportConfigFilter>;
    /**
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    readonly notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.costmanagement.preview.Notification>}>;
    /**
     ...
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than three months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
    readonly timePeriod: pulumi.Input<inputs.costmanagement.preview.BudgetTimePeriod>;
}
