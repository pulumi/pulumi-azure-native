...
export class Export extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement/preview:Export';
     ...
     */
    public readonly definition!: pulumi.Output<outputs.costmanagement.preview.ExportDefinitionResponse>;
    /**
     * Has delivery information for the export.
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.costmanagement.preview.ExportDeliveryInfoResponse>;
    /**
     ...
     */
    public /*out*/ readonly runHistory!: pulumi.Output<outputs.costmanagement.preview.ExportExecutionListResultResponse | undefined>;
    /**
     * Has schedule information for the export.
     */
    public readonly schedule!: pulumi.Output<outputs.costmanagement.preview.ExportScheduleResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: ExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:Export" }, { type: "azurerm:costmanagement/v20190101:Export" }, { type: "azurerm:costmanagement/v20190901:Export" }, { type: "azurerm:costmanagement/v20191001:Export" }, { type: "azurerm:costmanagement/v20191101:Export" }, { type: "azurerm:costmanagement/v20200601:Export" }] };
...
export interface ExportArgs {
     ...
     * Has the definition for the export.
     */
    readonly definition: pulumi.Input<inputs.costmanagement.preview.ExportDefinition>;
    /**
     * Has delivery information for the export.
     */
    readonly deliveryInfo: pulumi.Input<inputs.costmanagement.preview.ExportDeliveryInfo>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * Has schedule information for the export.
     */
    readonly schedule?: pulumi.Input<inputs.costmanagement.preview.ExportSchedule>;
    /**
