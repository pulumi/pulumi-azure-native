...
export class ReportConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement/preview:ReportConfig';
    ...
    constructor(name: string, args: ReportConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:ReportConfig" }, { type: "azurerm:costmanagement/v20180531:ReportConfig" }] };
