...
export class Report extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement/preview:Report';
     ...
     */
    public readonly definition!: pulumi.Output<outputs.costmanagement.preview.ReportDefinitionResponse>;
    /**
     * Has delivery information for the report.
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.costmanagement.preview.ReportDeliveryInfoResponse>;
    /**
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.costmanagement.preview.ReportScheduleResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ReportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/v20180801preview:Report" }] };
...
export interface ReportArgs {
     ...
     * Has definition for the report.
     */
    readonly definition: pulumi.Input<inputs.costmanagement.preview.ReportDefinition>;
    /**
     * Has delivery information for the report.
     */
    readonly deliveryInfo: pulumi.Input<inputs.costmanagement.preview.ReportDeliveryInfo>;
    /**
     * The format of the report being delivered.
     */
     ...
     * Has schedule information for the report.
     */
    readonly schedule?: pulumi.Input<inputs.costmanagement.preview.ReportSchedule>;
}
