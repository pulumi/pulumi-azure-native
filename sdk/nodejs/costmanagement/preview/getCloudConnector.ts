...
export function getCloudConnector(args: GetCloudConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudConnectorResult> {
    ...
    return pulumi.runtime.invoke("azurerm:costmanagement/preview:getCloudConnector", {
...
export interface GetCloudConnectorResult {
     ...
     */
    readonly collectionInfo: outputs.costmanagement.preview.ConnectorCollectionInfoResponse;
    /**
