...
export function getReportConfig(args: GetReportConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetReportConfigResult> {
    ...
    return pulumi.runtime.invoke("azurerm:costmanagement/preview:getReportConfig", {
...
export interface GetReportConfigResult {
     ...
     */
    readonly definition: outputs.costmanagement.preview.ReportConfigDefinitionResponse;
    /**
     * Has delivery information for the report config.
     */
    readonly deliveryInfo: outputs.costmanagement.preview.ReportConfigDeliveryInfoResponse;
    /**
     ...
     */
    readonly schedule?: outputs.costmanagement.preview.ReportConfigScheduleResponse;
    /**
     * Resource tags.
     */
