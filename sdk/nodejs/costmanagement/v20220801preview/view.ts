...
export class View extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): View {
        pulumi.log.warn("View is deprecated: azure-native:costmanagement/v20220801preview:View is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221001:View to guarantee forwards compatibility.")
