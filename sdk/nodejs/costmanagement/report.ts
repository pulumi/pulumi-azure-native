...
export class Report extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:costmanagement:Report';
    ...
    constructor(name: string, args: ReportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/v20180801preview:Report" }] };
