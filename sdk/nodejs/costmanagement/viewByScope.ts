...
export class ViewByScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement:ViewByScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.costmanagement.ViewPropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface ViewByScopeArgs {
     ...
     * The properties of the view.
     */
    readonly properties?: pulumi.Input<inputs.costmanagement.ViewProperties>;
    /**
