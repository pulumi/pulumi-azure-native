...
export class CostAllocationRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CostAllocationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/v20200301preview:CostAllocationRule" }, { type: "azure-native:costmanagement:CostAllocationRule" }, { type: "azure-nextgen:costmanagement:CostAllocationRule" }] };
...
export interface CostAllocationRuleArgs {
     ...
     * Cost allocation rule properties
     */
    readonly properties?: pulumi.Input<inputs.costmanagement.v20200301preview.CostAllocationRulePropertiesArgs>;
    /**
