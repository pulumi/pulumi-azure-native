...
export class CostAllocationRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.costmanagement.v20200301preview.CostAllocationRulePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CostAllocationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20230801:CostAllocationRule" }, { type: "azure-native:costmanagement/v20230901:CostAllocationRule" }, { type: "azure-native:costmanagement/v20231101:CostAllocationRule" }, { type: "azure-native:costmanagement/v20240801:CostAllocationRule" }, { type: "azure-native:costmanagement/v20241001preview:CostAllocationRule" }, { type: "azure-native:costmanagement:CostAllocationRule" }] };
...
export interface CostAllocationRuleArgs {
     ...
     * Cost allocation rule properties
     */
    properties?: pulumi.Input<inputs.costmanagement.v20200301preview.CostAllocationRulePropertiesArgs>;
    /**
