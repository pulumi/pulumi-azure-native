...
export function getCostAllocationRule(args: GetCostAllocationRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetCostAllocationRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:costmanagement/v20200301preview:getCostAllocationRule", {
...
export interface GetCostAllocationRuleResult {
     ...
     */
    readonly properties: outputs.costmanagement.v20200301preview.CostAllocationRulePropertiesInvokeResponse;
    /**
