...
export class Budget extends pulumi.CustomResource {
     ...
     */
    public readonly filter!: pulumi.Output<outputs.costmanagement.ReportConfigFilterResponse | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement:Budget" }, { type: "azure-native:costmanagement/v20190401preview:Budget" }, { type: "azure-nextgen:costmanagement/v20190401preview:Budget" }] };
...
export interface BudgetArgs {
     ...
     * The category of the budget, whether the budget tracks cost or usage.
     */
    readonly category: pulumi.Input<string | enums.costmanagement.CategoryType>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * May be used to filter budgets.
     */
    readonly filter?: pulumi.Input<inputs.costmanagement.ReportConfigFilter>;
    /**
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    readonly notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.costmanagement.Notification>}>;
    /**
     ...
     * The time covered by a budget. Tracking of the amount will be reset based on the time grain.
     */
    readonly timeGrain: pulumi.Input<string | enums.costmanagement.TimeGrainType>;
    /**
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than three months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
    readonly timePeriod: pulumi.Input<inputs.costmanagement.BudgetTimePeriod>;
}
