...
export class Export extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20221001:Export';
     ...
     */
    public readonly definition!: pulumi.Output<outputs.costmanagement.v20221001.ExportDefinitionResponse>;
    /**
     * Has delivery information for the export.
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.costmanagement.v20221001.ExportDeliveryInfoResponse>;
    /**
     ...
     */
    public /*out*/ readonly runHistory!: pulumi.Output<outputs.costmanagement.v20221001.ExportExecutionListResultResponse | undefined>;
    /**
     * Has schedule information for the export.
     */
    public readonly schedule!: pulumi.Output<outputs.costmanagement.v20221001.ExportScheduleResponse | undefined>;
    /**
     * Resource type.
     */
...
export interface ExportArgs {
     ...
     * Has the definition for the export.
     */
    definition: pulumi.Input<inputs.costmanagement.v20221001.ExportDefinitionArgs>;
    /**
     * Has delivery information for the export.
     */
    deliveryInfo: pulumi.Input<inputs.costmanagement.v20221001.ExportDeliveryInfoArgs>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * The format of the export being delivered. Currently only 'Csv' is supported.
     */
    format?: pulumi.Input<string | enums.costmanagement.v20221001.FormatType>;
    /**
     * If set to true, exported data will be partitioned by size and placed in a blob directory together with a manifest file. Note: this option is currently available only for Microsoft Customer Agreement commerce scopes.
     */
     ...
     * Has schedule information for the export.
     */
    schedule?: pulumi.Input<inputs.costmanagement.v20221001.ExportScheduleArgs>;
    /**
