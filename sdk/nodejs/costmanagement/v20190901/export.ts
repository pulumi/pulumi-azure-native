...
export class Export extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:Export" }, { type: "azurerm:costmanagement/v20190101:Export" }, { type: "azurerm:costmanagement/v20191001:Export" }, { type: "azurerm:costmanagement/v20191101:Export" }, { type: "azurerm:costmanagement/v20200601:Export" }] };
