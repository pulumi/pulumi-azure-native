...
export class Export extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:costmanagement/v20190901:Export';
    ...
    constructor(name: string, args: ExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement:Export" }, { type: "azure-nextgen:costmanagement/latest:Export" }, { type: "azure-nextgen:costmanagement/v20190101:Export" }, { type: "azure-nextgen:costmanagement/v20191001:Export" }, { type: "azure-nextgen:costmanagement/v20191101:Export" }, { type: "azure-nextgen:costmanagement/v20200601:Export" }] };
