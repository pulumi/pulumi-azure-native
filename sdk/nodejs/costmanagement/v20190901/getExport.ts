 ...
 */
/** @deprecated azure-native:costmanagement/v20190901:Export is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20191001:Export to guarantee forwards compatibility. */
export function getExport(args: GetExportArgs, opts?: pulumi.InvokeOptions): Promise<GetExportResult> {
    pulumi.log.warn("getExport is deprecated: azure-native:costmanagement/v20190901:Export is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20191001:Export to guarantee forwards compatibility.")
