...
export class ReportConfigByResourceGroupName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement:ReportConfigByResourceGroupName';
     ...
     */
    public readonly definition!: pulumi.Output<outputs.costmanagement.ReportConfigDefinitionResponse>;
    /**
     * Has delivery information for the report config.
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.costmanagement.ReportConfigDeliveryInfoResponse>;
    /**
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.costmanagement.ReportConfigScheduleResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ReportConfigByResourceGroupNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement:ReportConfigByResourceGroupName" }, { type: "azure-native:costmanagement/latest:ReportConfigByResourceGroupName" }, { type: "azure-nextgen:costmanagement/latest:ReportConfigByResourceGroupName" }, { type: "azure-native:costmanagement/v20180531:ReportConfigByResourceGroupName" }, { type: "azure-nextgen:costmanagement/v20180531:ReportConfigByResourceGroupName" }] };
...
export interface ReportConfigByResourceGroupNameArgs {
     ...
     * Has definition for the report config.
     */
    readonly definition: pulumi.Input<inputs.costmanagement.ReportConfigDefinition>;
    /**
     * Has delivery information for the report config.
     */
    readonly deliveryInfo: pulumi.Input<inputs.costmanagement.ReportConfigDeliveryInfo>;
    /**
     * The format of the report being delivered.
     */
     ...
     * Has schedule information for the report config.
     */
    readonly schedule?: pulumi.Input<inputs.costmanagement.ReportConfigSchedule>;
}
