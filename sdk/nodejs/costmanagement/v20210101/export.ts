...
export class Export extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Export {
        pulumi.log.warn("Export is deprecated: azure-native:costmanagement/v20210101:Export is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221001:Export to guarantee forwards compatibility.")
