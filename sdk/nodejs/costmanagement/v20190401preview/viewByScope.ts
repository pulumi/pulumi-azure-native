...
export class ViewByScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ViewByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:ViewByScope" }, { type: "azurerm:costmanagement/v20191101:ViewByScope" }, { type: "azurerm:costmanagement/v20200601:ViewByScope" }] };
