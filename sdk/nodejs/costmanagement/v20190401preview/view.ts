...
export class View extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:costmanagement/v20190401preview:View';
    ...
    constructor(name: string, args: ViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:View" }, { type: "azurerm:costmanagement/preview:View" }, { type: "azurerm:costmanagement/v20191101:View" }, { type: "azurerm:costmanagement/v20200601:View" }] };
