...
export class Export extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20240801:Export';
     ...
     */
    public readonly definition!: pulumi.Output<outputs.costmanagement.v20240801.ExportDefinitionResponse>;
    /**
     * Has delivery information for the export.
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.costmanagement.v20240801.ExportDeliveryInfoResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.costmanagement.v20240801.SystemAssignedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly runHistory!: pulumi.Output<outputs.costmanagement.v20240801.ExportExecutionListResultResponse | undefined>;
    /**
     * Has schedule information for the export.
     */
    public readonly schedule!: pulumi.Output<outputs.costmanagement.v20240801.ExportScheduleResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: ExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20190101:Export" }, { type: "azure-native:costmanagement/v20190901:Export" }, { type: "azure-native:costmanagement/v20191001:Export" }, { type: "azure-native:costmanagement/v20191101:Export" }, { type: "azure-native:costmanagement/v20200601:Export" }, { type: "azure-native:costmanagement/v20201201preview:Export" }, { type: "azure-native:costmanagement/v20210101:Export" }, { type: "azure-native:costmanagement/v20211001:Export" }, { type: "azure-native:costmanagement/v20221001:Export" }, { type: "azure-native:costmanagement/v20230301:Export" }, { type: "azure-native:costmanagement/v20230401preview:Export" }, { type: "azure-native:costmanagement/v20230701preview:Export" }, { type: "azure-native:costmanagement/v20230801:Export" }, { type: "azure-native:costmanagement/v20230901:Export" }, { type: "azure-native:costmanagement/v20231101:Export" }, { type: "azure-native:costmanagement/v20241001preview:Export" }, { type: "azure-native:costmanagement:Export" }] };
...
export interface ExportArgs {
     ...
     * Has the definition for the export.
     */
    definition: pulumi.Input<inputs.costmanagement.v20240801.ExportDefinitionArgs>;
    /**
     * Has delivery information for the export.
     */
    deliveryInfo: pulumi.Input<inputs.costmanagement.v20240801.ExportDeliveryInfoArgs>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * The format of the export being delivered. Currently only 'Csv' is supported.
     */
    format?: pulumi.Input<string | enums.costmanagement.v20240801.FormatType>;
    /**
     * The managed identity associated with Export
     */
    identity?: pulumi.Input<inputs.costmanagement.v20240801.SystemAssignedServiceIdentityArgs>;
    /**
     * The location of the Export's managed identity. Only required when utilizing managed identity.
     */
     ...
     * Has schedule information for the export.
     */
    schedule?: pulumi.Input<inputs.costmanagement.v20240801.ExportScheduleArgs>;
    /**
