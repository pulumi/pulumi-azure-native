...
export function getViewByScope(args: GetViewByScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetViewByScopeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:costmanagement/v20240801:getViewByScope", {
        "scope": args.scope,
...
export interface GetViewByScopeResult {
     ...
     */
    readonly dataSet?: outputs.costmanagement.v20240801.ReportConfigDatasetResponse;
    /**
     ...
     */
    readonly kpis?: outputs.costmanagement.v20240801.KpiPropertiesResponse[];
    /**
     ...
     */
    readonly pivots?: outputs.costmanagement.v20240801.PivotPropertiesResponse[];
    /**
     ...
     */
    readonly timePeriod?: outputs.costmanagement.v20240801.ReportConfigTimePeriodResponse;
    /**
...
export function getViewByScopeOutput(args: GetViewByScopeOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetViewByScopeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:costmanagement/v20240801:getViewByScope", {
        "scope": args.scope,
        "viewName": args.viewName,
    }, opts);
}
