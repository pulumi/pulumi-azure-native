...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20240801:Budget';
     ...
     *  Supported for CategoryType(s): Cost.
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<outputs.costmanagement.v20240801.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputs.costmanagement.v20240801.BudgetFilterResponse | undefined>;
    /**
     * The forecasted cost which is being tracked for a budget.
     *
     *  Supported for CategoryType(s): Cost.
     */
    public /*out*/ readonly forecastSpend!: pulumi.Output<outputs.costmanagement.v20240801.ForecastSpendResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: outputs.costmanagement.v20240801.NotificationResponse} | undefined>;
    /**
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    public readonly timePeriod!: pulumi.Output<outputs.costmanagement.v20240801.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20190401preview:Budget" }, { type: "azure-native:costmanagement/v20230401preview:Budget" }, { type: "azure-native:costmanagement/v20230801:Budget" }, { type: "azure-native:costmanagement/v20230901:Budget" }, { type: "azure-native:costmanagement/v20231101:Budget" }, { type: "azure-native:costmanagement/v20241001preview:Budget" }, { type: "azure-native:costmanagement:Budget" }] };
...
export interface BudgetArgs {
     ...
     * - Constraints for **CategoryType: ReservationUtilization** - Only one notification allowed. thresholdType is not applicable.
     */
    notifications?: pulumi.Input<{[key: string]: pulumi.Input<inputs.costmanagement.v20240801.NotificationArgs>}>;
    /**
