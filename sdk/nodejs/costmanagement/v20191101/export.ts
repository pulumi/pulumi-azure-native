...
export class Export extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/v20191101:Export" }, { type: "azure-native:costmanagement:Export" }, { type: "azure-nextgen:costmanagement:Export" }, { type: "azure-native:costmanagement/v20190101:Export" }, { type: "azure-nextgen:costmanagement/v20190101:Export" }, { type: "azure-native:costmanagement/v20190901:Export" }, { type: "azure-nextgen:costmanagement/v20190901:Export" }, { type: "azure-native:costmanagement/v20191001:Export" }, { type: "azure-nextgen:costmanagement/v20191001:Export" }, { type: "azure-native:costmanagement/v20200601:Export" }, { type: "azure-nextgen:costmanagement/v20200601:Export" }, { type: "azure-native:costmanagement/v20201201preview:Export" }, { type: "azure-nextgen:costmanagement/v20201201preview:Export" }, { type: "azure-native:costmanagement/v20210101:Export" }, { type: "azure-nextgen:costmanagement/v20210101:Export" }] };
...
export interface ExportArgs {
     ...
     * Has definition for the export.
     */
    readonly definition: pulumi.Input<inputs.costmanagement.v20191101.ExportDefinitionArgs>;
    /**
     * Has delivery information for the export.
     */
    readonly deliveryInfo: pulumi.Input<inputs.costmanagement.v20191101.ExportDeliveryInfoArgs>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * The format of the export being delivered.
     */
    readonly format?: pulumi.Input<string | enums.costmanagement.v20191101.FormatType>;
    /**
     * Has schedule information for the export.
     */
    readonly schedule?: pulumi.Input<inputs.costmanagement.v20191101.ExportScheduleArgs>;
    /**
