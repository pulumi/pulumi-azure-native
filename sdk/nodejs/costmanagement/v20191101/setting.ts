...
export class Setting extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: SettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement/v20191101:Setting" }, { type: "azure-native:costmanagement:Setting" }, { type: "azure-nextgen:costmanagement:Setting" }, { type: "azure-native:costmanagement/latest:Setting" }, { type: "azure-nextgen:costmanagement/latest:Setting" }] };
