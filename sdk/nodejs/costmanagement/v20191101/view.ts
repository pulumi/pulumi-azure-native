...
export class View extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:costmanagement/v20191101:View';
    ...
    constructor(name: string, args: ViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:costmanagement:View" }, { type: "azure-nextgen:costmanagement/latest:View" }, { type: "azure-nextgen:costmanagement/v20190401preview:View" }, { type: "azure-nextgen:costmanagement/v20200601:View" }] };
