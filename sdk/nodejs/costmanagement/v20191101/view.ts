...
export class View extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:View" }, { type: "azurerm:costmanagement/v20190401preview:View" }, { type: "azurerm:costmanagement/v20200601:View" }] };
