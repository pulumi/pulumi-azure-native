...
export class ViewByScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ViewByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement:ViewByScope" }, { type: "azure-nextgen:costmanagement:ViewByScope" }, { type: "azure-native:costmanagement/latest:ViewByScope" }, { type: "azure-nextgen:costmanagement/latest:ViewByScope" }, { type: "azure-native:costmanagement/v20190401preview:ViewByScope" }, { type: "azure-nextgen:costmanagement/v20190401preview:ViewByScope" }, { type: "azure-native:costmanagement/v20200601:ViewByScope" }, { type: "azure-nextgen:costmanagement/v20200601:ViewByScope" }] };
