...
export class ViewByScope extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ViewByScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:costmanagement/latest:ViewByScope" }, { type: "azurerm:costmanagement/v20190401preview:ViewByScope" }, { type: "azurerm:costmanagement/v20200601:ViewByScope" }] };
