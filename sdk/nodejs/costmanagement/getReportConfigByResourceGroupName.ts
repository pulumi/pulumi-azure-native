...
export function getReportConfigByResourceGroupName(args: GetReportConfigByResourceGroupNameArgs, opts?: pulumi.InvokeOptions): Promise<GetReportConfigByResourceGroupNameResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:costmanagement:getReportConfigByResourceGroupName", {
...
export interface GetReportConfigByResourceGroupNameResult {
     ...
     */
    readonly definition: outputs.costmanagement.ReportConfigDefinitionResponse;
    /**
     * Has delivery information for the report config.
     */
    readonly deliveryInfo: outputs.costmanagement.ReportConfigDeliveryInfoResponse;
    /**
     ...
     */
    readonly schedule?: outputs.costmanagement.ReportConfigScheduleResponse;
    /**
     * Resource tags.
     */
