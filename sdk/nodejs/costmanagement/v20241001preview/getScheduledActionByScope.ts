...
export function getScheduledActionByScope(args: GetScheduledActionByScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledActionByScopeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:costmanagement/v20241001preview:getScheduledActionByScope", {
        "name": args.name,
        "scope": args.scope,
    }, opts);
}
...
export interface GetScheduledActionByScopeResult {
     ...
     */
    readonly fileDestination?: outputs.costmanagement.v20241001preview.FileDestinationResponse;
    /**
     ...
     */
    readonly notification: outputs.costmanagement.v20241001preview.NotificationPropertiesResponse;
    /**
     ...
     */
    readonly schedule: outputs.costmanagement.v20241001preview.SchedulePropertiesResponse;
    /**
     ...
     * Kind of the scheduled action.
     */
    readonly systemData: outputs.costmanagement.v20241001preview.SystemDataResponse;
    /**
...
export function getScheduledActionByScopeOutput(args: GetScheduledActionByScopeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledActionByScopeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:costmanagement/v20241001preview:getScheduledActionByScope", {
        "name": args.name,
        "scope": args.scope,
    }, opts);
}
