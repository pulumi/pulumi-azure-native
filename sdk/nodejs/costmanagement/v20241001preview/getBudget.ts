...
export function getBudget(args: GetBudgetArgs, opts?: pulumi.InvokeOptions): Promise<GetBudgetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:costmanagement/v20241001preview:getBudget", {
...
export interface GetBudgetResult {
     ...
     */
    readonly notifications?: {[key: string]: outputs.costmanagement.v20241001preview.NotificationResponse};
    /**
...
export function getBudgetOutput(args: GetBudgetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBudgetResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:costmanagement/v20241001preview:getBudget", {
        "budgetName": args.budgetName,
        "scope": args.scope,
    }, opts);
}
