...
export class TagInheritanceSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20241001preview:TagInheritanceSetting';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.costmanagement.v20241001preview.TagInheritancePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: TagInheritanceSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement/v20221001preview:TagInheritanceSetting" }, { type: "azure-native:costmanagement/v20221005preview:TagInheritanceSetting" }, { type: "azure-native:costmanagement/v20230801:TagInheritanceSetting" }, { type: "azure-native:costmanagement/v20230901:TagInheritanceSetting" }, { type: "azure-native:costmanagement/v20231101:TagInheritanceSetting" }, { type: "azure-native:costmanagement/v20240801:TagInheritanceSetting" }, { type: "azure-native:costmanagement:TagInheritanceSetting" }] };
...
export interface TagInheritanceSettingArgs {
     ...
     * The properties of the tag inheritance setting.
     */
    properties?: pulumi.Input<inputs.costmanagement.v20241001preview.TagInheritancePropertiesArgs>;
    /**
