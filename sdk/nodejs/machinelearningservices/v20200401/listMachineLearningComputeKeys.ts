 ...
 * Gets secrets related to Machine Learning compute (storage keys, service credentials, etc).
 */
export function listMachineLearningComputeKeysOutput(args: ListMachineLearningComputeKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListMachineLearningComputeKeysResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20200401:listMachineLearningComputeKeys", {
        "computeName": args.computeName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
