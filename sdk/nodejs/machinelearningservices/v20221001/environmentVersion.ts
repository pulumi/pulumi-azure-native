 ...
 *
 * @deprecated azure-native:machinelearningservices/v20221001:EnvironmentVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:EnvironmentVersion to guarantee forwards compatibility.
 */
export class EnvironmentVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvironmentVersion {
        pulumi.log.warn("EnvironmentVersion is deprecated: azure-native:machinelearningservices/v20221001:EnvironmentVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:EnvironmentVersion to guarantee forwards compatibility.")
        return new EnvironmentVersion(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20221001:EnvironmentVersion';
     ...
     */
    public readonly environmentVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20221001.EnvironmentVersionResponse>;
    /**
    ...
    constructor(name: string, args: EnvironmentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["environmentVersionProperties"] = args ? (args.environmentVersionProperties ? pulumi.output(args.environmentVersionProperties).apply(inputs.machinelearningservices.v20221001.environmentVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface EnvironmentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    environmentVersionProperties: pulumi.Input<inputs.machinelearningservices.v20221001.EnvironmentVersionArgs>;
    /**
