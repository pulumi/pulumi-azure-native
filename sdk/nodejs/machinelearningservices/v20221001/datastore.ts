...
export class Datastore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20221001:Datastore';
     ...
     */
    public readonly datastoreProperties!: pulumi.Output<outputs.machinelearningservices.v20221001.AzureBlobDatastoreResponse | outputs.machinelearningservices.v20221001.AzureDataLakeGen1DatastoreResponse | outputs.machinelearningservices.v20221001.AzureDataLakeGen2DatastoreResponse | outputs.machinelearningservices.v20221001.AzureFileDatastoreResponse>;
    /**
    ...
    constructor(name: string, args: DatastoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:Datastore" }, { type: "azure-native:machinelearningservices/v20200501preview:Datastore" }, { type: "azure-native:machinelearningservices/v20210301preview:Datastore" }, { type: "azure-native:machinelearningservices/v20220201preview:Datastore" }, { type: "azure-native:machinelearningservices/v20220501:Datastore" }, { type: "azure-native:machinelearningservices/v20220601preview:Datastore" }, { type: "azure-native:machinelearningservices/v20221001preview:Datastore" }, { type: "azure-native:machinelearningservices/v20221201preview:Datastore" }, { type: "azure-native:machinelearningservices/v20230201preview:Datastore" }, { type: "azure-native:machinelearningservices/v20230401:Datastore" }, { type: "azure-native:machinelearningservices/v20230401preview:Datastore" }, { type: "azure-native:machinelearningservices/v20230601preview:Datastore" }, { type: "azure-native:machinelearningservices/v20230801preview:Datastore" }, { type: "azure-native:machinelearningservices/v20231001:Datastore" }, { type: "azure-native:machinelearningservices/v20240101preview:Datastore" }, { type: "azure-native:machinelearningservices/v20240401:Datastore" }, { type: "azure-native:machinelearningservices/v20240401preview:Datastore" }, { type: "azure-native:machinelearningservices/v20240701preview:Datastore" }, { type: "azure-native:machinelearningservices/v20241001:Datastore" }, { type: "azure-native:machinelearningservices/v20241001preview:Datastore" }] };
...
export interface DatastoreArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    datastoreProperties: pulumi.Input<inputs.machinelearningservices.v20221001.AzureBlobDatastoreArgs | inputs.machinelearningservices.v20221001.AzureDataLakeGen1DatastoreArgs | inputs.machinelearningservices.v20221001.AzureDataLakeGen2DatastoreArgs | inputs.machinelearningservices.v20221001.AzureFileDatastoreArgs>;
    /**
     * Datastore name.
     */
