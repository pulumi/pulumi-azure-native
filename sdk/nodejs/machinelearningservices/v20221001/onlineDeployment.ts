...
export class OnlineDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20221001:OnlineDeployment';
     ...
     */
    public readonly onlineDeploymentProperties!: pulumi.Output<outputs.machinelearningservices.v20221001.KubernetesOnlineDeploymentResponse | outputs.machinelearningservices.v20221001.ManagedOnlineDeploymentResponse>;
    /**
...
export interface OnlineDeploymentArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    onlineDeploymentProperties: pulumi.Input<inputs.machinelearningservices.v20221001.KubernetesOnlineDeploymentArgs | inputs.machinelearningservices.v20221001.ManagedOnlineDeploymentArgs>;
    /**
