...
export interface GetEnvironmentContainerResult {
     ...
     */
    readonly environmentContainerProperties: outputs.machinelearningservices.v20230401preview.EnvironmentContainerResponse;
    /**
...
export function getEnvironmentContainerOutput(args: GetEnvironmentContainerOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetEnvironmentContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230401preview:getEnvironmentContainer", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
