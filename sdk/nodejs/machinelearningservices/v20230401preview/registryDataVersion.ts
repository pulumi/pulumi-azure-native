 ...
 *
 * const registryDataVersion = new azure_native.machinelearningservices.v20230401preview.RegistryDataVersion("registryDataVersion", {
...
export class RegistryDataVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegistryDataVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20230201preview:RegistryDataVersion" }] };
