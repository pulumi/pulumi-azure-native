...
export class RegistryDataVersion extends pulumi.CustomResource {
     ...
     */
    public readonly dataVersionBaseProperties!: pulumi.Output<outputs.machinelearningservices.v20230401preview.DataImportResponse | outputs.machinelearningservices.v20230401preview.MLTableDataResponse | outputs.machinelearningservices.v20230401preview.UriFileDataVersionResponse | outputs.machinelearningservices.v20230401preview.UriFolderDataVersionResponse>;
    /**
...
export interface RegistryDataVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataVersionBaseProperties: pulumi.Input<inputs.machinelearningservices.v20230401preview.DataImportArgs | inputs.machinelearningservices.v20230401preview.MLTableDataArgs | inputs.machinelearningservices.v20230401preview.UriFileDataVersionArgs | inputs.machinelearningservices.v20230401preview.UriFolderDataVersionArgs>;
    /**
     * Container name.
     */
