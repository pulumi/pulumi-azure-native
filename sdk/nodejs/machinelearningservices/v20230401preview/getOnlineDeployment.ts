...
export interface GetOnlineDeploymentResult {
     ...
     */
    readonly onlineDeploymentProperties: outputs.machinelearningservices.v20230401preview.KubernetesOnlineDeploymentResponse | outputs.machinelearningservices.v20230401preview.ManagedOnlineDeploymentResponse;
    /**
...
export function getOnlineDeploymentOutput(args: GetOnlineDeploymentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetOnlineDeploymentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230401preview:getOnlineDeployment", {
        "deploymentName": args.deploymentName,
        "endpointName": args.endpointName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
