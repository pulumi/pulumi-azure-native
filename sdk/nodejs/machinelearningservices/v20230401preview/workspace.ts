 ...
 *
 * const workspace = new azure_native.machinelearningservices.v20230401preview.Workspace("workspace", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:machinelearningservices/v20230401preview:Workspace testworkspace /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.MachineLearningServices/workspaces/testworkspace 
 * ```
 */
export class Workspace extends pulumi.CustomResource {
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.machinelearningservices.v20230401preview.EncryptionPropertyResponse | undefined>;
    /**
     ...
     */
    public readonly featureStoreSettings!: pulumi.Output<outputs.machinelearningservices.v20230401preview.FeatureStoreSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly managedNetwork!: pulumi.Output<outputs.machinelearningservices.v20230401preview.ManagedNetworkSettingsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly notebookInfo!: pulumi.Output<outputs.machinelearningservices.v20230401preview.NotebookResourceInfoResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.machinelearningservices.v20230401preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly serviceManagedResourcesSettings!: pulumi.Output<outputs.machinelearningservices.v20230401preview.ServiceManagedResourcesSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly sharedPrivateLinkResources!: pulumi.Output<outputs.machinelearningservices.v20230401preview.SharedPrivateLinkResourceResponse[] | undefined>;
    /**
...
export interface WorkspaceArgs {
     ...
     * The encryption settings of Azure ML workspace.
     */
    encryption?: pulumi.Input<inputs.machinelearningservices.v20230401preview.EncryptionPropertyArgs>;
    /**
     * A list of existing workspaces used by Hub to perform convert.
     */
     ...
     * Settings for feature store type workspace.
     */
    featureStoreSettings?: pulumi.Input<inputs.machinelearningservices.v20230401preview.FeatureStoreSettingsArgs>;
    /**
     * The friendly name for this workspace. This name in mutable
     */
     ...
     * Managed Network settings for a machine learning workspace.
     */
    managedNetwork?: pulumi.Input<inputs.machinelearningservices.v20230401preview.ManagedNetworkSettingsArgs>;
    /**
     * The user assigned identity resource id that represents the workspace identity.
     */
     ...
     * Whether requests from Public Network are allowed.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.machinelearningservices.v20230401preview.PublicNetworkAccess>;
    /**
     ...
     * The service managed resource settings.
     */
    serviceManagedResourcesSettings?: pulumi.Input<inputs.machinelearningservices.v20230401preview.ServiceManagedResourcesSettingsArgs>;
    /**
     * The list of shared private link resources in this workspace.
     */
    sharedPrivateLinkResources?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20230401preview.SharedPrivateLinkResourceArgs>[]>;
    /**
     * The sku of the workspace.
     */
