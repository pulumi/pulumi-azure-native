...
export class CodeVersion extends pulumi.CustomResource {
     ...
     */
    public readonly codeVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20230401preview.CodeVersionResponse>;
    /**
    ...
    constructor(name: string, args: CodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeVersionProperties"] = args ? (args.codeVersionProperties ? pulumi.output(args.codeVersionProperties).apply(inputs.machinelearningservices.v20230401preview.codeVersionArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:CodeVersion" }, { type: "azure-native:machinelearningservices/v20210301preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20220201preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20221201preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20230401:CodeVersion" }] };
...
export interface CodeVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeVersionProperties: pulumi.Input<inputs.machinelearningservices.v20230401preview.CodeVersionArgs>;
    /**
