...
export interface GetFeaturestoreEntityContainerEntityResult {
     ...
     */
    readonly featurestoreEntityContainerProperties: outputs.machinelearningservices.v20230401preview.FeaturestoreEntityContainerResponse;
    /**
...
export function getFeaturestoreEntityContainerEntityOutput(args: GetFeaturestoreEntityContainerEntityOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFeaturestoreEntityContainerEntityResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230401preview:getFeaturestoreEntityContainerEntity", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
