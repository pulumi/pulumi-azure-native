 ...
 *
 * const registryComponentContainer = new azure_native.machinelearningservices.v20230401preview.RegistryComponentContainer("registryComponentContainer", {
...
export class RegistryComponentContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegistryComponentContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20221001preview:RegistryComponentContainer" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryComponentContainer" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryComponentContainer" }] };
