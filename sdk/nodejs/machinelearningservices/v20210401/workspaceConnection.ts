...
export interface WorkspaceConnectionArgs {
     ...
     * format for the workspace connection value
     */
    readonly valueFormat?: pulumi.Input<string | enums.machinelearningservices.v20210401.ValueFormat>;
    /**
