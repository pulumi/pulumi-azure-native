...
export class WorkspaceConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices/v20210401:WorkspaceConnection" }, { type: "azure-native:machinelearningservices:WorkspaceConnection" }, { type: "azure-nextgen:machinelearningservices:WorkspaceConnection" }, { type: "azure-native:machinelearningservices/v20200601:WorkspaceConnection" }, { type: "azure-nextgen:machinelearningservices/v20200601:WorkspaceConnection" }, { type: "azure-native:machinelearningservices/v20200801:WorkspaceConnection" }, { type: "azure-nextgen:machinelearningservices/v20200801:WorkspaceConnection" }, { type: "azure-native:machinelearningservices/v20200901preview:WorkspaceConnection" }, { type: "azure-nextgen:machinelearningservices/v20200901preview:WorkspaceConnection" }, { type: "azure-native:machinelearningservices/v20210101:WorkspaceConnection" }, { type: "azure-nextgen:machinelearningservices/v20210101:WorkspaceConnection" }, { type: "azure-native:machinelearningservices/v20210301preview:WorkspaceConnection" }, { type: "azure-nextgen:machinelearningservices/v20210301preview:WorkspaceConnection" }, { type: "azure-native:machinelearningservices/v20210701:WorkspaceConnection" }, { type: "azure-nextgen:machinelearningservices/v20210701:WorkspaceConnection" }] };
...
export interface WorkspaceConnectionArgs {
     ...
     * format for the workspace connection value
     */
    valueFormat?: pulumi.Input<string | enums.machinelearningservices.v20210401.ValueFormat>;
    /**
