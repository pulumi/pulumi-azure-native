...
export class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.machinelearningservices.FeaturestoreEntityContainerPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FeaturestoreEntityContainerEntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? pulumi.output(args.properties).apply(inputs.machinelearningservices.featurestoreEntityContainerPropertiesArgsProvideDefaults) : undefined;
...
export interface FeaturestoreEntityContainerEntityArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<inputs.machinelearningservices.FeaturestoreEntityContainerPropertiesArgs>;
    /**
