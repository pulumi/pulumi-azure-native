...
export class ComponentVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ComponentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ComponentVersion" }, { type: "azure-native:machinelearningservices/v20220201preview:ComponentVersion" }] };
