...
export class DataVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:DataVersion" }, { type: "azure-native:machinelearningservices/v20210301preview:DataVersion" }, { type: "azure-native:machinelearningservices/v20220201preview:DataVersion" }] };
