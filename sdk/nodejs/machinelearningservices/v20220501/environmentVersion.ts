...
export class EnvironmentVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EnvironmentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:EnvironmentVersion" }, { type: "azure-native:machinelearningservices/v20210301preview:EnvironmentVersion" }, { type: "azure-native:machinelearningservices/v20220201preview:EnvironmentVersion" }] };
