...
export function getComponentContainer(args: GetComponentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentContainerResult> {
    pulumi.log.warn("getComponentContainer is deprecated: azure-native:machinelearningservices/v20220501:ComponentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:ComponentContainer to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20220501:getComponentContainer", {
        "name": args.name,
...
export interface GetComponentContainerResult {
     ...
     */
    readonly componentContainerProperties: outputs.machinelearningservices.v20220501.ComponentContainerResponse;
    /**
