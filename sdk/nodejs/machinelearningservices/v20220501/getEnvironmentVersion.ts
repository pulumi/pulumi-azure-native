...
export interface GetEnvironmentVersionResult {
     ...
     */
    readonly environmentVersionProperties: outputs.machinelearningservices.v20220501.EnvironmentVersionResponse;
    /**
...
export function getEnvironmentVersionOutput(args: GetEnvironmentVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnvironmentVersionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20220501:getEnvironmentVersion", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "version": args.version,
        "workspaceName": args.workspaceName,
