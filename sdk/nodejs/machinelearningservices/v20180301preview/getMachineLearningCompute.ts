...
export function getMachineLearningCompute(args: GetMachineLearningComputeArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineLearningComputeResult> {
    ...
    return pulumi.runtime.invoke("azurerm:machinelearningservices/v20180301preview:getMachineLearningCompute", {
...
export interface GetMachineLearningComputeResult {
     ...
     * Compute properties
     */
    readonly properties: outputs.machinelearningservices.v20180301preview.ComputeResponse;
    /**
