...
export class BatchDeployment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BatchDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20220201preview:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20220501:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20220601preview:BatchDeployment" }] };
