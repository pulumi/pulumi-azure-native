 ...
 *
 * const modelContainer = new azure_native.machinelearningservices.v20210301preview.ModelContainer("modelContainer", {
 *     name: "testContainer",
 *     properties: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:machinelearningservices/v20210301preview:ModelContainer testContainer /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspace123/models/testContainer 
 * ```
 */
export class ModelContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ModelContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ModelContainer" }, { type: "azure-native:machinelearningservices/v20220201preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20220501:ModelContainer" }, { type: "azure-native:machinelearningservices/v20220601preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20221001:ModelContainer" }, { type: "azure-native:machinelearningservices/v20221001preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20221201preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20230201preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20230401preview:ModelContainer" }] };
