...
export class BatchEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BatchEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:BatchEndpoint" }, { type: "azure-native:machinelearningservices/v20220201preview:BatchEndpoint" }, { type: "azure-native:machinelearningservices/v20220501:BatchEndpoint" }] };
