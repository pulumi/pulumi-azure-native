...
export class DataContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices/v20210301preview:DataContainer" }] };
...
export interface DataContainerArgs {
     ...
     * Additional attributes of the entity.
     */
    readonly properties: pulumi.Input<inputs.machinelearningservices.v20210301preview.DataContainerArgs>;
    /**
