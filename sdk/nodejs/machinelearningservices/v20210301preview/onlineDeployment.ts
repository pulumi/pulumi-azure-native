...
export class OnlineDeployment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OnlineDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices/v20210301preview:OnlineDeployment" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(OnlineDeployment.__pulumiType, name, inputs, opts);
    }
}
...
export interface OnlineDeploymentArgs {
     ...
     * Additional attributes of the entity.
     */
    readonly properties: pulumi.Input<inputs.machinelearningservices.v20210301preview.K8sOnlineDeploymentArgs | inputs.machinelearningservices.v20210301preview.ManagedOnlineDeploymentArgs>;
    /**
