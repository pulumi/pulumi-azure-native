...
export class LabelingJob extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20210301preview.LabelingJobResponse>;
    /**
    ...
    constructor(name: string, args: LabelingJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:LabelingJob" }, { type: "azure-native:machinelearningservices/v20200901preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20220601preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20221001preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20221201preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20230201preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20230401preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20230601preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20230801preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20240101preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20240401preview:LabelingJob" }] };
