...
export class CodeVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices/v20210301preview:CodeVersion" }, { type: "azure-native:machinelearningservices:CodeVersion" }, { type: "azure-nextgen:machinelearningservices:CodeVersion" }] };
