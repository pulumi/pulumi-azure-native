...
export class LabelingJob extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LabelingJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices:LabelingJob" }, { type: "azure-native:machinelearningservices/v20200901preview:LabelingJob" }, { type: "azure-nextgen:machinelearningservices/v20200901preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20210301preview:LabelingJob" }, { type: "azure-nextgen:machinelearningservices/v20210301preview:LabelingJob" }] };
...
export interface LabelingJobArgs {
     ...
     * Definition of a labeling job.
     */
    readonly properties?: pulumi.Input<inputs.machinelearningservices.LabelingJobPropertiesArgs>;
    /**
