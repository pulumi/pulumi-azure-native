...
export class CodeVersion extends pulumi.CustomResource {
     ...
     */
    public readonly codeVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20230801preview.CodeVersionResponse>;
    /**
    ...
    constructor(name: string, args: CodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeVersionProperties"] = args ? (args.codeVersionProperties ? pulumi.output(args.codeVersionProperties).apply(inputs.machinelearningservices.v20230801preview.codeVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface CodeVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeVersionProperties: pulumi.Input<inputs.machinelearningservices.v20230801preview.CodeVersionArgs>;
    /**
