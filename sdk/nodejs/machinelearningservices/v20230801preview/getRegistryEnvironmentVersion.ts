...
export interface GetRegistryEnvironmentVersionResult {
     ...
     */
    readonly environmentVersionProperties: outputs.machinelearningservices.v20230801preview.EnvironmentVersionResponse;
    /**
...
export function getRegistryEnvironmentVersionOutput(args: GetRegistryEnvironmentVersionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRegistryEnvironmentVersionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230801preview:getRegistryEnvironmentVersion", {
        "environmentName": args.environmentName,
        "registryName": args.registryName,
        "resourceGroupName": args.resourceGroupName,
        "version": args.version,
