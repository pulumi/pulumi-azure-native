...
export class RegistryModelVersion extends pulumi.CustomResource {
     ...
     */
    public readonly modelVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20230801preview.ModelVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryModelVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelVersionProperties"] = args ? (args.modelVersionProperties ? pulumi.output(args.modelVersionProperties).apply(inputs.machinelearningservices.v20230801preview.modelVersionArgsProvideDefaults) : undefined) : undefined;
