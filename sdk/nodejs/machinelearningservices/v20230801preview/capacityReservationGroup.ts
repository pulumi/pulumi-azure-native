...
export class CapacityReservationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230801preview:CapacityReservationGroup';
     ...
     */
    public readonly capacityReservationGroupProperties!: pulumi.Output<outputs.machinelearningservices.v20230801preview.CapacityReservationGroupResponse>;
    /**
    ...
    constructor(name: string, args: CapacityReservationGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:CapacityReservationGroup" }, { type: "azure-native:machinelearningservices/v20240101preview:CapacityReservationGroup" }, { type: "azure-native:machinelearningservices/v20240401preview:CapacityReservationGroup" }] };
...
export interface CapacityReservationGroupArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    capacityReservationGroupProperties: pulumi.Input<inputs.machinelearningservices.v20230801preview.CapacityReservationGroupArgs>;
