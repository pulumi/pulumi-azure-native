...
export interface GetServerlessEndpointResult {
     ...
     */
    readonly serverlessEndpointProperties: outputs.machinelearningservices.v20230801preview.ServerlessEndpointResponse;
    /**
...
export function getServerlessEndpointOutput(args: GetServerlessEndpointOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetServerlessEndpointResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230801preview:getServerlessEndpoint", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
