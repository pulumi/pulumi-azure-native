...
export function getOnlineDeployment(args: GetOnlineDeploymentArgs, opts?: pulumi.InvokeOptions): Promise<GetOnlineDeploymentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20250101preview:getOnlineDeployment", {
...
export interface GetOnlineDeploymentResult {
     ...
     */
    readonly onlineDeploymentProperties: outputs.machinelearningservices.v20250101preview.KubernetesOnlineDeploymentResponse | outputs.machinelearningservices.v20250101preview.ManagedOnlineDeploymentResponse;
    /**
...
export function getOnlineDeploymentOutput(args: GetOnlineDeploymentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOnlineDeploymentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20250101preview:getOnlineDeployment", {
        "deploymentName": args.deploymentName,
        "endpointName": args.endpointName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
