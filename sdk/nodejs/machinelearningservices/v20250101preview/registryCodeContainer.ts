...
export class RegistryCodeContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20250101preview:RegistryCodeContainer';
     ...
     */
    public readonly codeContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20250101preview.CodeContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryCodeContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeContainerProperties"] = args ? (args.codeContainerProperties ? pulumi.output(args.codeContainerProperties).apply(inputs.machinelearningservices.v20250101preview.codeContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryCodeContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeContainerProperties: pulumi.Input<inputs.machinelearningservices.v20250101preview.CodeContainerArgs>;
    /**
     * Container name.
     */
