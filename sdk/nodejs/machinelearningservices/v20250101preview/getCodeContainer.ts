...
export function getCodeContainer(args: GetCodeContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetCodeContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20250101preview:getCodeContainer", {
        "name": args.name,
...
export interface GetCodeContainerResult {
     ...
     */
    readonly codeContainerProperties: outputs.machinelearningservices.v20250101preview.CodeContainerResponse;
    /**
...
export function getCodeContainerOutput(args: GetCodeContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCodeContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20250101preview:getCodeContainer", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
