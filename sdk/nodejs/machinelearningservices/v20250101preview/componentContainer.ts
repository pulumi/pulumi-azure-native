...
export class ComponentContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20250101preview:ComponentContainer';
     ...
     */
    public readonly componentContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20250101preview.ComponentContainerResponse>;
    /**
    ...
    constructor(name: string, args: ComponentContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["componentContainerProperties"] = args ? (args.componentContainerProperties ? pulumi.output(args.componentContainerProperties).apply(inputs.machinelearningservices.v20250101preview.componentContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface ComponentContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    componentContainerProperties: pulumi.Input<inputs.machinelearningservices.v20250101preview.ComponentContainerArgs>;
    /**
     * Container name.
     */
