...
export class RaiPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20250101preview:RaiPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20250101preview.RaiPolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RaiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20240401preview:RaiPolicy" }, { type: "azure-native:machinelearningservices/v20240701preview:RaiPolicy" }, { type: "azure-native:machinelearningservices/v20241001preview:RaiPolicy" }, { type: "azure-native:machinelearningservices:RaiPolicy" }] };
...
export interface RaiPolicyArgs {
     ...
     * Azure OpenAI Content Filters properties.
     */
    properties: pulumi.Input<inputs.machinelearningservices.v20250101preview.RaiPolicyPropertiesArgs>;
    /**
