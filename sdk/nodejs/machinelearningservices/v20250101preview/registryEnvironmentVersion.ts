...
export class RegistryEnvironmentVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20250101preview:RegistryEnvironmentVersion';
     ...
     */
    public readonly environmentVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20250101preview.EnvironmentVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryEnvironmentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["environmentVersionProperties"] = args ? (args.environmentVersionProperties ? pulumi.output(args.environmentVersionProperties).apply(inputs.machinelearningservices.v20250101preview.environmentVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryEnvironmentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    environmentVersionProperties: pulumi.Input<inputs.machinelearningservices.v20250101preview.EnvironmentVersionArgs>;
    /**
