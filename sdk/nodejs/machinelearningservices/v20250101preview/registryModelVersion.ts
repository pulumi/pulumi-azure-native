...
export class RegistryModelVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20250101preview:RegistryModelVersion';
     ...
     */
    public readonly modelVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20250101preview.ModelVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryModelVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelVersionProperties"] = args ? (args.modelVersionProperties ? pulumi.output(args.modelVersionProperties).apply(inputs.machinelearningservices.v20250101preview.modelVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryModelVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelVersionProperties: pulumi.Input<inputs.machinelearningservices.v20250101preview.ModelVersionArgs>;
    /**
