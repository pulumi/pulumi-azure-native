...
export function getComponentVersion(args: GetComponentVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20250101preview:getComponentVersion", {
        "name": args.name,
...
export interface GetComponentVersionResult {
     ...
     */
    readonly componentVersionProperties: outputs.machinelearningservices.v20250101preview.ComponentVersionResponse;
    /**
...
export function getComponentVersionOutput(args: GetComponentVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComponentVersionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20250101preview:getComponentVersion", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "version": args.version,
        "workspaceName": args.workspaceName,
