...
export function listWorkspaceKeys(args: ListWorkspaceKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListWorkspaceKeysResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20250101preview:listWorkspaceKeys", {
...
export interface ListWorkspaceKeysResult {
    ...
    readonly containerRegistryCredentials?: outputs.machinelearningservices.v20250101preview.RegistryListCredentialsResultResponse;
    readonly notebookAccessKeys?: outputs.machinelearningservices.v20250101preview.ListNotebookKeysResultResponse;
    /**
...
export function listWorkspaceKeysOutput(args: ListWorkspaceKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListWorkspaceKeysResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20250101preview:listWorkspaceKeys", {
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
}
