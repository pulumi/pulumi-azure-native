...
export function getCodeVersion(args: GetCodeVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetCodeVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20250101preview:getCodeVersion", {
        "name": args.name,
...
export interface GetCodeVersionResult {
     ...
     */
    readonly codeVersionProperties: outputs.machinelearningservices.v20250101preview.CodeVersionResponse;
    /**
...
export function getCodeVersionOutput(args: GetCodeVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCodeVersionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20250101preview:getCodeVersion", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "version": args.version,
        "workspaceName": args.workspaceName,
