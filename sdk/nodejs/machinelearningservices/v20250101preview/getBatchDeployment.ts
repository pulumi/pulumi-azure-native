...
export function getBatchDeployment(args: GetBatchDeploymentArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchDeploymentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20250101preview:getBatchDeployment", {
...
export interface GetBatchDeploymentResult {
     ...
     */
    readonly batchDeploymentProperties: outputs.machinelearningservices.v20250101preview.BatchDeploymentResponse;
    /**
...
export function getBatchDeploymentOutput(args: GetBatchDeploymentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBatchDeploymentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20250101preview:getBatchDeployment", {
        "deploymentName": args.deploymentName,
        "endpointName": args.endpointName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
