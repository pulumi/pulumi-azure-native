...
export class BatchDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20250101preview:BatchDeployment';
     ...
     */
    public readonly batchDeploymentProperties!: pulumi.Output<outputs.machinelearningservices.v20250101preview.BatchDeploymentResponse>;
    /**
...
export interface BatchDeploymentArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    batchDeploymentProperties: pulumi.Input<inputs.machinelearningservices.v20250101preview.BatchDeploymentArgs>;
    /**
