...
export class CapabilityHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20250101preview:CapabilityHost';
     ...
     */
    public readonly capabilityHostProperties!: pulumi.Output<outputs.machinelearningservices.v20250101preview.CapabilityHostResponse>;
    /**
    ...
    constructor(name: string, args: CapabilityHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["capabilityHostProperties"] = args ? (args.capabilityHostProperties ? pulumi.output(args.capabilityHostProperties).apply(inputs.machinelearningservices.v20250101preview.capabilityHostArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20241001preview:CapabilityHost" }, { type: "azure-native:machinelearningservices:CapabilityHost" }] };
...
export interface CapabilityHostArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    capabilityHostProperties: pulumi.Input<inputs.machinelearningservices.v20250101preview.CapabilityHostArgs>;
    /**
     * CapabilityHost name.
     */
