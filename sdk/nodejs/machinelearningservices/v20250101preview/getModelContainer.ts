...
export function getModelContainer(args: GetModelContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetModelContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20250101preview:getModelContainer", {
        "name": args.name,
...
export function getModelContainerOutput(args: GetModelContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20250101preview:getModelContainer", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
