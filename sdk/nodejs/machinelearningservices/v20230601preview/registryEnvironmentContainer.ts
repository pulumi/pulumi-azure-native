...
export class RegistryEnvironmentContainer extends pulumi.CustomResource {
     ...
     */
    public readonly environmentContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20230601preview.EnvironmentContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryEnvironmentContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["environmentContainerProperties"] = args ? (args.environmentContainerProperties ? pulumi.output(args.environmentContainerProperties).apply(inputs.machinelearningservices.v20230601preview.environmentContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryEnvironmentContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    environmentContainerProperties: pulumi.Input<inputs.machinelearningservices.v20230601preview.EnvironmentContainerArgs>;
    /**
     * Container name.
     */
