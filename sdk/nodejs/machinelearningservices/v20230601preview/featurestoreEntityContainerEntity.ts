...
export class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
     ...
     */
    public readonly featurestoreEntityContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20230601preview.FeaturestoreEntityContainerResponse>;
    /**
    ...
    constructor(name: string, args: FeaturestoreEntityContainerEntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["featurestoreEntityContainerProperties"] = args ? (args.featurestoreEntityContainerProperties ? pulumi.output(args.featurestoreEntityContainerProperties).apply(inputs.machinelearningservices.v20230601preview.featurestoreEntityContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface FeaturestoreEntityContainerEntityArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    featurestoreEntityContainerProperties: pulumi.Input<inputs.machinelearningservices.v20230601preview.FeaturestoreEntityContainerArgs>;
    /**
