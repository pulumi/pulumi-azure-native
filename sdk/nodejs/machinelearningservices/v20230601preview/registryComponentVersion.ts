...
export class RegistryComponentVersion extends pulumi.CustomResource {
     ...
     */
    public readonly componentVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20230601preview.ComponentVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryComponentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["componentVersionProperties"] = args ? (args.componentVersionProperties ? pulumi.output(args.componentVersionProperties).apply(inputs.machinelearningservices.v20230601preview.componentVersionArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20221001preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230401:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230801preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20231001:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20240101preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20240401:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20240401preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20240701preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20241001:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20241001preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20250101preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices:RegistryComponentVersion" }] };
...
export interface RegistryComponentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    componentVersionProperties: pulumi.Input<inputs.machinelearningservices.v20230601preview.ComponentVersionArgs>;
    /**
