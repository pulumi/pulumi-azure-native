...
export class ManagedNetworkSettingsRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20230601preview.FqdnOutboundRuleResponse | outputs.machinelearningservices.v20230601preview.PrivateEndpointOutboundRuleResponse | outputs.machinelearningservices.v20230601preview.ServiceTagOutboundRuleResponse>;
    /**
    ...
    constructor(name: string, args: ManagedNetworkSettingsRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20230401preview:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20230801preview:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20231001:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20240101preview:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20240401:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20240401preview:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20240701preview:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20241001:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20241001preview:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20250101preview:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices:ManagedNetworkSettingsRule" }] };
...
export interface ManagedNetworkSettingsRuleArgs {
     ...
     * Outbound Rule for the managed network of a machine learning workspace.
     */
    properties: pulumi.Input<inputs.machinelearningservices.v20230601preview.FqdnOutboundRuleArgs | inputs.machinelearningservices.v20230601preview.PrivateEndpointOutboundRuleArgs | inputs.machinelearningservices.v20230601preview.ServiceTagOutboundRuleArgs>;
    /**
