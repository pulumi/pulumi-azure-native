...
export class WorkspaceConnection extends pulumi.CustomResource {
    ...
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20230601preview.AccessKeyAuthTypeWorkspaceConnectionPropertiesResponse | outputs.machinelearningservices.v20230601preview.ApiKeyAuthWorkspaceConnectionPropertiesResponse | outputs.machinelearningservices.v20230601preview.CustomKeysWorkspaceConnectionPropertiesResponse | outputs.machinelearningservices.v20230601preview.ManagedIdentityAuthTypeWorkspaceConnectionPropertiesResponse | outputs.machinelearningservices.v20230601preview.NoneAuthTypeWorkspaceConnectionPropertiesResponse | outputs.machinelearningservices.v20230601preview.PATAuthTypeWorkspaceConnectionPropertiesResponse | outputs.machinelearningservices.v20230601preview.SASAuthTypeWorkspaceConnectionPropertiesResponse | outputs.machinelearningservices.v20230601preview.ServicePrincipalAuthTypeWorkspaceConnectionPropertiesResponse | outputs.machinelearningservices.v20230601preview.UsernamePasswordAuthTypeWorkspaceConnectionPropertiesResponse>;
    /**
...
export interface WorkspaceConnectionArgs {
    ...
    properties: pulumi.Input<inputs.machinelearningservices.v20230601preview.AccessKeyAuthTypeWorkspaceConnectionPropertiesArgs | inputs.machinelearningservices.v20230601preview.ApiKeyAuthWorkspaceConnectionPropertiesArgs | inputs.machinelearningservices.v20230601preview.CustomKeysWorkspaceConnectionPropertiesArgs | inputs.machinelearningservices.v20230601preview.ManagedIdentityAuthTypeWorkspaceConnectionPropertiesArgs | inputs.machinelearningservices.v20230601preview.NoneAuthTypeWorkspaceConnectionPropertiesArgs | inputs.machinelearningservices.v20230601preview.PATAuthTypeWorkspaceConnectionPropertiesArgs | inputs.machinelearningservices.v20230601preview.SASAuthTypeWorkspaceConnectionPropertiesArgs | inputs.machinelearningservices.v20230601preview.ServicePrincipalAuthTypeWorkspaceConnectionPropertiesArgs | inputs.machinelearningservices.v20230601preview.UsernamePasswordAuthTypeWorkspaceConnectionPropertiesArgs>;
    /**
