...
export interface GetManagedNetworkSettingsRuleResult {
     ...
     */
    readonly properties: outputs.machinelearningservices.v20231001.FqdnOutboundRuleResponse | outputs.machinelearningservices.v20231001.PrivateEndpointOutboundRuleResponse | outputs.machinelearningservices.v20231001.ServiceTagOutboundRuleResponse;
    /**
...
export function getManagedNetworkSettingsRuleOutput(args: GetManagedNetworkSettingsRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedNetworkSettingsRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20231001:getManagedNetworkSettingsRule", {
        "resourceGroupName": args.resourceGroupName,
        "ruleName": args.ruleName,
        "workspaceName": args.workspaceName,
    }, opts);
