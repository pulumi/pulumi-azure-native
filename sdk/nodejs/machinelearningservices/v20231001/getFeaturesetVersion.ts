...
export interface GetFeaturesetVersionResult {
     ...
     */
    readonly featuresetVersionProperties: outputs.machinelearningservices.v20231001.FeaturesetVersionResponse;
    /**
...
export function getFeaturesetVersionOutput(args: GetFeaturesetVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFeaturesetVersionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20231001:getFeaturesetVersion", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "version": args.version,
        "workspaceName": args.workspaceName,
