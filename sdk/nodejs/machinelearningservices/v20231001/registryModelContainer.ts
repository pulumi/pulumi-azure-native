...
export class RegistryModelContainer extends pulumi.CustomResource {
     ...
     */
    public readonly modelContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20231001.ModelContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryModelContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelContainerProperties"] = args ? (args.modelContainerProperties ? pulumi.output(args.modelContainerProperties).apply(inputs.machinelearningservices.v20231001.modelContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryModelContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelContainerProperties: pulumi.Input<inputs.machinelearningservices.v20231001.ModelContainerArgs>;
    /**
     * Container name.
     */
