...
export class ServerlessEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401:ServerlessEndpoint';
     ...
     */
    public readonly serverlessEndpointProperties!: pulumi.Output<outputs.machinelearningservices.v20240401.ServerlessEndpointResponse>;
    /**
...
export interface ServerlessEndpointArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    serverlessEndpointProperties: pulumi.Input<inputs.machinelearningservices.v20240401.ServerlessEndpointArgs>;
    /**
     * Sku details required for ARM contract for Autoscaling.
     */
