...
export class BatchDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401:BatchDeployment';
     ...
     */
    public readonly batchDeploymentProperties!: pulumi.Output<outputs.machinelearningservices.v20240401.BatchDeploymentResponse>;
    /**
    ...
    constructor(name: string, args: BatchDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["batchDeploymentProperties"] = args ? (args.batchDeploymentProperties ? pulumi.output(args.batchDeploymentProperties).apply(inputs.machinelearningservices.v20240401.batchDeploymentArgsProvideDefaults) : undefined) : undefined;
...
export interface BatchDeploymentArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    batchDeploymentProperties: pulumi.Input<inputs.machinelearningservices.v20240401.BatchDeploymentArgs>;
    /**
