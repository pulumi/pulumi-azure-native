...
export class RegistryEnvironmentContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401:RegistryEnvironmentContainer';
     ...
     */
    public readonly environmentContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20240401.EnvironmentContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryEnvironmentContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["environmentContainerProperties"] = args ? (args.environmentContainerProperties ? pulumi.output(args.environmentContainerProperties).apply(inputs.machinelearningservices.v20240401.environmentContainerArgsProvideDefaults) : undefined) : undefined;
