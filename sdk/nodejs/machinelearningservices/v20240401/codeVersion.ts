...
export class CodeVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401:CodeVersion';
     ...
     */
    public readonly codeVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20240401.CodeVersionResponse>;
    /**
    ...
    constructor(name: string, args: CodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeVersionProperties"] = args ? (args.codeVersionProperties ? pulumi.output(args.codeVersionProperties).apply(inputs.machinelearningservices.v20240401.codeVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface CodeVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeVersionProperties: pulumi.Input<inputs.machinelearningservices.v20240401.CodeVersionArgs>;
    /**
