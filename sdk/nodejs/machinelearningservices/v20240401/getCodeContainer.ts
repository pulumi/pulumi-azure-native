...
export function getCodeContainer(args: GetCodeContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetCodeContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20240401:getCodeContainer", {
        "name": args.name,
...
export interface GetCodeContainerResult {
     ...
     */
    readonly codeContainerProperties: outputs.machinelearningservices.v20240401.CodeContainerResponse;
    /**
...
export function getCodeContainerOutput(args: GetCodeContainerOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCodeContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20240401:getCodeContainer", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
