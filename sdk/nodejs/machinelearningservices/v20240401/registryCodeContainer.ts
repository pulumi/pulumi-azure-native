...
export class RegistryCodeContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401:RegistryCodeContainer';
     ...
     */
    public readonly codeContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20240401.CodeContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryCodeContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeContainerProperties"] = args ? (args.codeContainerProperties ? pulumi.output(args.codeContainerProperties).apply(inputs.machinelearningservices.v20240401.codeContainerArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20221001preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20230401:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20230601preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20230801preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20231001:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20240101preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20240401preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20240701preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20241001:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20241001preview:RegistryCodeContainer" }] };
...
export interface RegistryCodeContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeContainerProperties: pulumi.Input<inputs.machinelearningservices.v20240401.CodeContainerArgs>;
    /**
     * Container name.
     */
