...
export function listEndpointKeys(args: ListEndpointKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListEndpointKeysResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20240701preview:listEndpointKeys", {
...
export interface ListEndpointKeysResult {
     ...
     */
    readonly keys?: outputs.machinelearningservices.v20240701preview.AccountApiKeysResponse;
}
export function listEndpointKeysOutput(args: ListEndpointKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListEndpointKeysResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20240701preview:listEndpointKeys", {
        "endpointName": args.endpointName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
