...
export class BatchDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240701preview:BatchDeployment';
     ...
     */
    public readonly batchDeploymentProperties!: pulumi.Output<outputs.machinelearningservices.v20240701preview.BatchDeploymentResponse>;
    /**
    ...
    constructor(name: string, args: BatchDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["batchDeploymentProperties"] = args ? (args.batchDeploymentProperties ? pulumi.output(args.batchDeploymentProperties).apply(inputs.machinelearningservices.v20240701preview.batchDeploymentArgsProvideDefaults) : undefined) : undefined;
