...
export class RegistryModelVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240701preview:RegistryModelVersion';
