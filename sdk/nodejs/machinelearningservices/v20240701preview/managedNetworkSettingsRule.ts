...
export class ManagedNetworkSettingsRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240701preview:ManagedNetworkSettingsRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20240701preview.FqdnOutboundRuleResponse | outputs.machinelearningservices.v20240701preview.PrivateEndpointOutboundRuleResponse | outputs.machinelearningservices.v20240701preview.ServiceTagOutboundRuleResponse>;
    /**
...
export interface ManagedNetworkSettingsRuleArgs {
     ...
     * Outbound Rule for the managed network of a machine learning workspace.
     */
    properties: pulumi.Input<inputs.machinelearningservices.v20240701preview.FqdnOutboundRuleArgs | inputs.machinelearningservices.v20240701preview.PrivateEndpointOutboundRuleArgs | inputs.machinelearningservices.v20240701preview.ServiceTagOutboundRuleArgs>;
    /**
