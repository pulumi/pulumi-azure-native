...
export class OnlineEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OnlineEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20210301preview:OnlineEndpoint" }, { type: "azure-native:machinelearningservices/v20220201preview:OnlineEndpoint" }, { type: "azure-native:machinelearningservices/v20220501:OnlineEndpoint" }] };
