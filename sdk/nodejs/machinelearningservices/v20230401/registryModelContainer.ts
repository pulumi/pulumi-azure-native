...
export class RegistryModelContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegistryModelContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryModelContainer" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryModelContainer" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryModelContainer" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryModelContainer" }] };
