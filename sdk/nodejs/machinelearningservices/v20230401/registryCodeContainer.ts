...
export class RegistryCodeContainer extends pulumi.CustomResource {
     ...
     */
    public readonly codeContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20230401.CodeContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryCodeContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeContainerProperties"] = args ? (args.codeContainerProperties ? pulumi.output(args.codeContainerProperties).apply(inputs.machinelearningservices.v20230401.codeContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryCodeContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeContainerProperties: pulumi.Input<inputs.machinelearningservices.v20230401.CodeContainerArgs>;
    /**
     * Container name.
     */
