...
export interface GetComponentContainerResult {
     ...
     */
    readonly componentContainerProperties: outputs.machinelearningservices.v20230401.ComponentContainerResponse;
    /**
...
export function getComponentContainerOutput(args: GetComponentContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComponentContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230401:getComponentContainer", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
