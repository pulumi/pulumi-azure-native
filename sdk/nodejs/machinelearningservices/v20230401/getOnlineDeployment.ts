...
export interface GetOnlineDeploymentResult {
     ...
     */
    readonly onlineDeploymentProperties: outputs.machinelearningservices.v20230401.KubernetesOnlineDeploymentResponse | outputs.machinelearningservices.v20230401.ManagedOnlineDeploymentResponse;
    /**
...
export function getOnlineDeploymentOutput(args: GetOnlineDeploymentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOnlineDeploymentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230401:getOnlineDeployment", {
        "deploymentName": args.deploymentName,
        "endpointName": args.endpointName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
