...
export class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401preview:FeaturestoreEntityContainerEntity';
     ...
     */
    public readonly featurestoreEntityContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20240401preview.FeaturestoreEntityContainerResponse>;
    /**
    ...
    constructor(name: string, args: FeaturestoreEntityContainerEntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["featurestoreEntityContainerProperties"] = args ? (args.featurestoreEntityContainerProperties ? pulumi.output(args.featurestoreEntityContainerProperties).apply(inputs.machinelearningservices.v20240401preview.featurestoreEntityContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface FeaturestoreEntityContainerEntityArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    featurestoreEntityContainerProperties: pulumi.Input<inputs.machinelearningservices.v20240401preview.FeaturestoreEntityContainerArgs>;
    /**
