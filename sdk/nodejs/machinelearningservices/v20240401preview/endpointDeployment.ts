...
export class EndpointDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401preview:EndpointDeployment';
    ...
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20240401preview.EndpointDeploymentResourcePropertiesResponse>;
    public readonly sku!: pulumi.Output<outputs.machinelearningservices.v20240401preview.CognitiveServicesSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EndpointDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:EndpointDeployment" }, { type: "azure-native:machinelearningservices/v20240101preview:EndpointDeployment" }, { type: "azure-native:machinelearningservices/v20240701preview:EndpointDeployment" }] };
...
export interface EndpointDeploymentArgs {
    ...
    properties: pulumi.Input<inputs.machinelearningservices.v20240401preview.EndpointDeploymentResourcePropertiesArgs>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
    resourceGroupName: pulumi.Input<string>;
    sku?: pulumi.Input<inputs.machinelearningservices.v20240401preview.CognitiveServicesSkuArgs>;
    /**
