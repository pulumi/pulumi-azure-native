...
export class RegistryDataContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401preview:RegistryDataContainer';
     ...
     */
    public readonly dataContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20240401preview.DataContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryDataContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dataContainerProperties"] = args ? (args.dataContainerProperties ? pulumi.output(args.dataContainerProperties).apply(inputs.machinelearningservices.v20240401preview.dataContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryDataContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataContainerProperties: pulumi.Input<inputs.machinelearningservices.v20240401preview.DataContainerArgs>;
    /**
     * Container name.
     */
