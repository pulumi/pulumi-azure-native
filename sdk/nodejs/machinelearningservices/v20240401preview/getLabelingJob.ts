...
export function getLabelingJob(args: GetLabelingJobArgs, opts?: pulumi.InvokeOptions): Promise<GetLabelingJobResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20240401preview:getLabelingJob", {
        "id": args.id,
...
export interface GetLabelingJobResult {
     ...
     */
    readonly labelingJobProperties: outputs.machinelearningservices.v20240401preview.LabelingJobResponse;
    /**
...
export function getLabelingJobOutput(args: GetLabelingJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLabelingJobResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20240401preview:getLabelingJob", {
        "id": args.id,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
