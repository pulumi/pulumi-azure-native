...
export function getRegistryEnvironmentVersion(args: GetRegistryEnvironmentVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryEnvironmentVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20240401preview:getRegistryEnvironmentVersion", {
...
export interface GetRegistryEnvironmentVersionResult {
     ...
     */
    readonly environmentVersionProperties: outputs.machinelearningservices.v20240401preview.EnvironmentVersionResponse;
    /**
...
export function getRegistryEnvironmentVersionOutput(args: GetRegistryEnvironmentVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegistryEnvironmentVersionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20240401preview:getRegistryEnvironmentVersion", {
        "environmentName": args.environmentName,
        "registryName": args.registryName,
        "resourceGroupName": args.resourceGroupName,
        "version": args.version,
