...
export class ModelContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401preview:ModelContainer';
     ...
     */
    public readonly modelContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20240401preview.ModelContainerResponse>;
    /**
    ...
    constructor(name: string, args: ModelContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelContainerProperties"] = args ? (args.modelContainerProperties ? pulumi.output(args.modelContainerProperties).apply(inputs.machinelearningservices.v20240401preview.modelContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface ModelContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelContainerProperties: pulumi.Input<inputs.machinelearningservices.v20240401preview.ModelContainerArgs>;
    /**
