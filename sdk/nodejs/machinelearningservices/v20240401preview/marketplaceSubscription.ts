...
export class MarketplaceSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240401preview:MarketplaceSubscription';
     ...
     */
    public readonly marketplaceSubscriptionProperties!: pulumi.Output<outputs.machinelearningservices.v20240401preview.MarketplaceSubscriptionResponse>;
    /**
    ...
    constructor(name: string, args: MarketplaceSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20240101preview:MarketplaceSubscription" }, { type: "azure-native:machinelearningservices/v20240401:MarketplaceSubscription" }, { type: "azure-native:machinelearningservices/v20240701preview:MarketplaceSubscription" }, { type: "azure-native:machinelearningservices/v20241001:MarketplaceSubscription" }, { type: "azure-native:machinelearningservices/v20241001preview:MarketplaceSubscription" }, { type: "azure-native:machinelearningservices/v20250101preview:MarketplaceSubscription" }, { type: "azure-native:machinelearningservices:MarketplaceSubscription" }] };
...
export interface MarketplaceSubscriptionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    marketplaceSubscriptionProperties: pulumi.Input<inputs.machinelearningservices.v20240401preview.MarketplaceSubscriptionArgs>;
    /**
