...
export function getRegistryCodeVersion(args: GetRegistryCodeVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryCodeVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20240401preview:getRegistryCodeVersion", {
...
export interface GetRegistryCodeVersionResult {
     ...
     */
    readonly codeVersionProperties: outputs.machinelearningservices.v20240401preview.CodeVersionResponse;
    /**
