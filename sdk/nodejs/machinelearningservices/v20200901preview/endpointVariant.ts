 ...
 *
 * @deprecated azure-native:machinelearningservices/v20200901preview:EndpointVariant is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility.
 */
export class EndpointVariant extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EndpointVariant {
        pulumi.log.warn("EndpointVariant is deprecated: azure-native:machinelearningservices/v20200901preview:EndpointVariant is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility.")
