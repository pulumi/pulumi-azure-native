...
export class LinkedWorkspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkedWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices/v20200301:LinkedWorkspace" }, { type: "azure-native:machinelearningservices:LinkedWorkspace" }, { type: "azure-nextgen:machinelearningservices:LinkedWorkspace" }] };
...
export interface LinkedWorkspaceArgs {
     ...
     * LinkedWorkspace specific properties.
     */
    readonly properties?: pulumi.Input<inputs.machinelearningservices.v20200301.LinkedWorkspacePropsArgs>;
    /**
