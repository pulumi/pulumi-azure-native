...
export class LinkedWorkspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LinkedWorkspace {
        pulumi.log.warn("LinkedWorkspace is deprecated: azure-native:machinelearningservices/v20200301:LinkedWorkspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20200515preview:LinkedWorkspace to guarantee forwards compatibility.")
...
export interface LinkedWorkspaceArgs {
     ...
     * LinkedWorkspace specific properties.
     */
    properties?: pulumi.Input<inputs.machinelearningservices.v20200301.LinkedWorkspacePropsArgs>;
    /**
