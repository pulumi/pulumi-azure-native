...
export function getDataContainer(args: GetDataContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetDataContainerResult> {
    pulumi.log.warn("getDataContainer is deprecated: azure-native:machinelearningservices/v20221001preview:DataContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:DataContainer to guarantee forwards compatibility.")
