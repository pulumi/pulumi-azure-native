...
export class OnlineDeployment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OnlineDeployment {
        pulumi.log.warn("OnlineDeployment is deprecated: azure-native:machinelearningservices/v20221001preview:OnlineDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:OnlineDeployment to guarantee forwards compatibility.")
