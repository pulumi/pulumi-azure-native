...
export class DataVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20221001preview:DataVersion';
     ...
     */
    public readonly dataVersionBaseProperties!: pulumi.Output<outputs.machinelearningservices.v20221001preview.MLTableDataResponse | outputs.machinelearningservices.v20221001preview.UriFileDataVersionResponse | outputs.machinelearningservices.v20221001preview.UriFolderDataVersionResponse>;
    /**
...
export interface DataVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataVersionBaseProperties: pulumi.Input<inputs.machinelearningservices.v20221001preview.MLTableDataArgs | inputs.machinelearningservices.v20221001preview.UriFileDataVersionArgs | inputs.machinelearningservices.v20221001preview.UriFolderDataVersionArgs>;
    /**
     * Container name.
     */
