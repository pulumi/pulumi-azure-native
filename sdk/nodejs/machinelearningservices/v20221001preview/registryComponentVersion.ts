...
export class RegistryComponentVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegistryComponentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20221201preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryComponentVersion" }] };
