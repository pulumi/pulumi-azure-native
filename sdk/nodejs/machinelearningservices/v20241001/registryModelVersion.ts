...
export class RegistryModelVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001:RegistryModelVersion';
     ...
     */
    public readonly modelVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20241001.ModelVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryModelVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelVersionProperties"] = args ? (args.modelVersionProperties ? pulumi.output(args.modelVersionProperties).apply(inputs.machinelearningservices.v20241001.modelVersionArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20221001preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20230401:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20230601preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20230801preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20231001:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20240101preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20240401:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20240401preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20240701preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20241001preview:RegistryModelVersion" }] };
...
export interface RegistryModelVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelVersionProperties: pulumi.Input<inputs.machinelearningservices.v20241001.ModelVersionArgs>;
    /**
