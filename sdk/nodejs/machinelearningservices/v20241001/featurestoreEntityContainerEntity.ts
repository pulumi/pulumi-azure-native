...
export class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001:FeaturestoreEntityContainerEntity';
     ...
     */
    public readonly featurestoreEntityContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20241001.FeaturestoreEntityContainerResponse>;
    /**
    ...
    constructor(name: string, args: FeaturestoreEntityContainerEntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["featurestoreEntityContainerProperties"] = args ? (args.featurestoreEntityContainerProperties ? pulumi.output(args.featurestoreEntityContainerProperties).apply(inputs.machinelearningservices.v20241001.featurestoreEntityContainerArgsProvideDefaults) : undefined) : undefined;
