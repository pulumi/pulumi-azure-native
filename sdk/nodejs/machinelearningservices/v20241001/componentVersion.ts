...
export class ComponentVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001:ComponentVersion';
     ...
     */
    public readonly componentVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20241001.ComponentVersionResponse>;
    /**
    ...
    constructor(name: string, args: ComponentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["componentVersionProperties"] = args ? (args.componentVersionProperties ? pulumi.output(args.componentVersionProperties).apply(inputs.machinelearningservices.v20241001.componentVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface ComponentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    componentVersionProperties: pulumi.Input<inputs.machinelearningservices.v20241001.ComponentVersionArgs>;
    /**
     * Container name.
     */
