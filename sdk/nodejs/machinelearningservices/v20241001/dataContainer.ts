...
export class DataContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001:DataContainer';
     ...
     */
    public readonly dataContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20241001.DataContainerResponse>;
    /**
    ...
    constructor(name: string, args: DataContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dataContainerProperties"] = args ? (args.dataContainerProperties ? pulumi.output(args.dataContainerProperties).apply(inputs.machinelearningservices.v20241001.dataContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface DataContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataContainerProperties: pulumi.Input<inputs.machinelearningservices.v20241001.DataContainerArgs>;
    /**
     * Container name.
     */
