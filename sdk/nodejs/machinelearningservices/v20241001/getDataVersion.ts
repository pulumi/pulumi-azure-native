...
export function getDataVersion(args: GetDataVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetDataVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20241001:getDataVersion", {
        "name": args.name,
...
export interface GetDataVersionResult {
     ...
     */
    readonly dataVersionBaseProperties: outputs.machinelearningservices.v20241001.MLTableDataResponse | outputs.machinelearningservices.v20241001.UriFileDataVersionResponse | outputs.machinelearningservices.v20241001.UriFolderDataVersionResponse;
    /**
