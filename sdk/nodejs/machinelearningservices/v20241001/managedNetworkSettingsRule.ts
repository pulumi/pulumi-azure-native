...
export class ManagedNetworkSettingsRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001:ManagedNetworkSettingsRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20241001.FqdnOutboundRuleResponse | outputs.machinelearningservices.v20241001.PrivateEndpointOutboundRuleResponse | outputs.machinelearningservices.v20241001.ServiceTagOutboundRuleResponse>;
    /**
...
export interface ManagedNetworkSettingsRuleArgs {
     ...
     * Outbound Rule for the managed network of a machine learning workspace.
     */
    properties: pulumi.Input<inputs.machinelearningservices.v20241001.FqdnOutboundRuleArgs | inputs.machinelearningservices.v20241001.PrivateEndpointOutboundRuleArgs | inputs.machinelearningservices.v20241001.ServiceTagOutboundRuleArgs>;
    /**
