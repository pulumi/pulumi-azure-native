...
export function getRegistryDataContainer(args: GetRegistryDataContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryDataContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20241001:getRegistryDataContainer", {
        "name": args.name,
...
export interface GetRegistryDataContainerResult {
     ...
     */
    readonly dataContainerProperties: outputs.machinelearningservices.v20241001.DataContainerResponse;
    /**
...
export function getRegistryDataContainerOutput(args: GetRegistryDataContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegistryDataContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20241001:getRegistryDataContainer", {
        "name": args.name,
        "registryName": args.registryName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
