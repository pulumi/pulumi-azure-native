...
export class RegistryModelContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001:RegistryModelContainer';
     ...
     */
    public readonly modelContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20241001.ModelContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryModelContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelContainerProperties"] = args ? (args.modelContainerProperties ? pulumi.output(args.modelContainerProperties).apply(inputs.machinelearningservices.v20241001.modelContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryModelContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelContainerProperties: pulumi.Input<inputs.machinelearningservices.v20241001.ModelContainerArgs>;
    /**
     * Container name.
     */
