...
export class LinkedService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkedServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices:LinkedService" }, { type: "azure-native:machinelearningservices/v20200901preview:LinkedService" }, { type: "azure-nextgen:machinelearningservices/v20200901preview:LinkedService" }] };
...
export interface LinkedServiceArgs {
     ...
     * LinkedService specific properties.
     */
    readonly properties?: pulumi.Input<inputs.machinelearningservices.LinkedServiceProps>;
    /**
