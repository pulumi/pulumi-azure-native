...
export class EnvironmentVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001preview:EnvironmentVersion';
     ...
     */
    public readonly environmentVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20241001preview.EnvironmentVersionResponse>;
    /**
    ...
    constructor(name: string, args: EnvironmentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["environmentVersionProperties"] = args ? (args.environmentVersionProperties ? pulumi.output(args.environmentVersionProperties).apply(inputs.machinelearningservices.v20241001preview.environmentVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface EnvironmentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    environmentVersionProperties: pulumi.Input<inputs.machinelearningservices.v20241001preview.EnvironmentVersionArgs>;
    /**
