...
export class RegistryComponentContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001preview:RegistryComponentContainer';
