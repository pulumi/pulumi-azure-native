...
export class ServerlessEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001preview:ServerlessEndpoint';
     ...
     */
    public readonly serverlessEndpointProperties!: pulumi.Output<outputs.machinelearningservices.v20241001preview.ServerlessEndpointResponse>;
    /**
...
export interface ServerlessEndpointArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    serverlessEndpointProperties: pulumi.Input<inputs.machinelearningservices.v20241001preview.ServerlessEndpointArgs>;
    /**
     * Sku details required for ARM contract for Autoscaling.
     */
