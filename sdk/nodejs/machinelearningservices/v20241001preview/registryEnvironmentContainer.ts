...
export class RegistryEnvironmentContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001preview:RegistryEnvironmentContainer';
     ...
     */
    public readonly environmentContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20241001preview.EnvironmentContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryEnvironmentContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["environmentContainerProperties"] = args ? (args.environmentContainerProperties ? pulumi.output(args.environmentContainerProperties).apply(inputs.machinelearningservices.v20241001preview.environmentContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryEnvironmentContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    environmentContainerProperties: pulumi.Input<inputs.machinelearningservices.v20241001preview.EnvironmentContainerArgs>;
    /**
     * Container name.
     */
