...
export class ConnectionRaiPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20241001preview:ConnectionRaiPolicy';
    ...
    constructor(name: string, args: ConnectionRaiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ConnectionRaiPolicy" }, { type: "azure-native:machinelearningservices/v20240401preview:ConnectionRaiPolicy" }, { type: "azure-native:machinelearningservices/v20240701preview:ConnectionRaiPolicy" }] };
