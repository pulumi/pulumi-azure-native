...
export class LinkedWorkspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningservices/preview:LinkedWorkspace';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.preview.LinkedWorkspacePropsResponse>;
    /**
...
export interface LinkedWorkspaceArgs {
     ...
     * LinkedWorkspace specific properties.
     */
    readonly properties?: pulumi.Input<inputs.machinelearningservices.preview.LinkedWorkspaceProps>;
    /**
