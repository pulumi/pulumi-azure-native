...
export class MachineLearningService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningservices/preview:MachineLearningService';
     ...
     */
    public /*out*/ readonly identity!: pulumi.Output<outputs.machinelearningservices.preview.IdentityResponse | undefined>;
    /**
     ...
     * Service properties
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.preview.ACIServiceResponseResponse | outputs.machinelearningservices.preview.AKSVariantResponseResponse>;
    /**
     * The sku of the workspace.
     */
    public /*out*/ readonly sku!: pulumi.Output<outputs.machinelearningservices.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: MachineLearningServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/v20200501preview:MachineLearningService" }, { type: "azurerm:machinelearningservices/v20200515preview:MachineLearningService" }, { type: "azurerm:machinelearningservices/v20200901preview:MachineLearningService" }] };
...
export interface MachineLearningServiceArgs {
     ...
     */
    readonly environmentImageRequest?: pulumi.Input<inputs.machinelearningservices.preview.CreateServiceRequestEnvironmentImageRequest>;
    /**
     * The authentication keys.
     */
    readonly keys?: pulumi.Input<inputs.machinelearningservices.preview.CreateServiceRequestKeys>;
    /**
