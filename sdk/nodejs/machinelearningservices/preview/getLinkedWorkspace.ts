...
export function getLinkedWorkspace(args: GetLinkedWorkspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetLinkedWorkspaceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:machinelearningservices/preview:getLinkedWorkspace", {
...
export interface GetLinkedWorkspaceResult {
     ...
     */
    readonly properties: outputs.machinelearningservices.preview.LinkedWorkspacePropsResponse;
    /**
