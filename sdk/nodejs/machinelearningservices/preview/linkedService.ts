...
export class LinkedService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningservices/preview:LinkedService';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.machinelearningservices.preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.preview.LinkedServicePropsResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: LinkedServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/v20200901preview:LinkedService" }] };
...
export interface LinkedServiceArgs {
     ...
     * Identity for the resource.
     */
    readonly identity?: pulumi.Input<inputs.machinelearningservices.preview.Identity>;
    /**
     ...
     * LinkedService specific properties.
     */
    readonly properties?: pulumi.Input<inputs.machinelearningservices.preview.LinkedServiceProps>;
    /**
