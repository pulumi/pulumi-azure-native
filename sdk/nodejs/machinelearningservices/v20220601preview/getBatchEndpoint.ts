...
export function getBatchEndpoint(args: GetBatchEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchEndpointResult> {
    pulumi.log.warn("getBatchEndpoint is deprecated: azure-native:machinelearningservices/v20220601preview:BatchEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:BatchEndpoint to guarantee forwards compatibility.")
...
export interface GetBatchEndpointResult {
     ...
     */
    readonly batchEndpointProperties: outputs.machinelearningservices.v20220601preview.BatchEndpointResponse;
    /**
