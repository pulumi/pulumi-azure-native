...
export function getEnvironmentContainer(args: GetEnvironmentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetEnvironmentContainerResult> {
    pulumi.log.warn("getEnvironmentContainer is deprecated: azure-native:machinelearningservices/v20220601preview:EnvironmentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:EnvironmentContainer to guarantee forwards compatibility.")
...
export interface GetEnvironmentContainerResult {
     ...
     */
    readonly environmentContainerProperties: outputs.machinelearningservices.v20220601preview.EnvironmentContainerResponse;
    /**
