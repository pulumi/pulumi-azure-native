 ...
 */
/** @deprecated azure-native:machinelearningservices/v20200515preview:AKSService is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:AKSService to guarantee forwards compatibility. */
export function getAKSService(args: GetAKSServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetAKSServiceResult> {
    pulumi.log.warn("getAKSService is deprecated: azure-native:machinelearningservices/v20200515preview:AKSService is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:AKSService to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20200515preview:getAKSService", {
        "expand": args.expand,
