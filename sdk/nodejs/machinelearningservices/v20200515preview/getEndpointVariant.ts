 ...
 */
/** @deprecated azure-native:machinelearningservices/v20200515preview:EndpointVariant is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility. */
export function getEndpointVariant(args: GetEndpointVariantArgs, opts?: pulumi.InvokeOptions): Promise<GetEndpointVariantResult> {
    pulumi.log.warn("getEndpointVariant is deprecated: azure-native:machinelearningservices/v20200515preview:EndpointVariant is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20200515preview:getEndpointVariant", {
        "expand": args.expand,
