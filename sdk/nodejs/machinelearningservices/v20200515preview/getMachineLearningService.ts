...
export function getMachineLearningService(args: GetMachineLearningServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineLearningServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:machinelearningservices/v20200515preview:getMachineLearningService", {
        "expand": args.expand,
...
export interface GetMachineLearningServiceResult {
     ...
     * Service properties
     */
    readonly properties: outputs.machinelearningservices.v20200515preview.ACIServiceResponseInvokeResponse | outputs.machinelearningservices.v20200515preview.AKSServiceResponseInvokeResponse | outputs.machinelearningservices.v20200515preview.AKSVariantResponseInvokeResponse;
    /**
