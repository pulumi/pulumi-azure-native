...
export class LinkedWorkspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkedWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/latest:LinkedWorkspace" }, { type: "azurerm:machinelearningservices/v20200501preview:LinkedWorkspace" }] };
