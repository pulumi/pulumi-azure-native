...
export class LinkedWorkspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LinkedWorkspace {
        return new LinkedWorkspace(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: LinkedWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as LinkedWorkspaceArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/preview:LinkedWorkspace" }, { type: "azurerm:machinelearningservices/v20200501preview:LinkedWorkspace" }] };
