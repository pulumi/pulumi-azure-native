 ...
 *
 * const linkedWorkspace = new azure_native.machinelearningservices.v20200515preview.LinkedWorkspace("linkedWorkspace", {
 *     linkName: "link-1",
 *     name: "link-1",
 *     properties: {
...
export class LinkedWorkspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkedWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20200501preview:LinkedWorkspace" }] };
