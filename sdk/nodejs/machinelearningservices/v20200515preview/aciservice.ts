 ...
 *
 * @deprecated azure-native:machinelearningservices/v20200515preview:ACIService is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:ACIService to guarantee forwards compatibility.
 */
export class ACIService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ACIService {
        pulumi.log.warn("ACIService is deprecated: azure-native:machinelearningservices/v20200515preview:ACIService is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:ACIService to guarantee forwards compatibility.")
        return new ACIService(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20200515preview:ACIService';
    ...
    constructor(name: string, args: ACIServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ACIService" }, { type: "azure-native:machinelearningservices/v20200501preview:ACIService" }, { type: "azure-native:machinelearningservices/v20200901preview:ACIService" }, { type: "azure-native:machinelearningservices/v20210101:ACIService" }, { type: "azure-native:machinelearningservices/v20210401:ACIService" }] };
...
export interface ACIServiceArgs {
     ...
     */
    containerResourceRequirements?: pulumi.Input<inputs.machinelearningservices.v20200515preview.ContainerResourceRequirementsArgs>;
    /**
     * Details of the data collection options specified.
     */
    dataCollection?: pulumi.Input<inputs.machinelearningservices.v20200515preview.ACIServiceCreateRequestDataCollectionArgs>;
    /**
     ...
     */
    encryptionProperties?: pulumi.Input<inputs.machinelearningservices.v20200515preview.ACIServiceCreateRequestEncryptionPropertiesArgs>;
    /**
     * The Environment, models and assets needed for inferencing.
     */
    environmentImageRequest?: pulumi.Input<inputs.machinelearningservices.v20200515preview.CreateServiceRequestEnvironmentImageRequestArgs>;
    /**
     * The authentication keys.
     */
    keys?: pulumi.Input<inputs.machinelearningservices.v20200515preview.CreateServiceRequestKeysArgs>;
    /**
     ...
     */
    vnetConfiguration?: pulumi.Input<inputs.machinelearningservices.v20200515preview.ACIServiceCreateRequestVnetConfigurationArgs>;
    /**
