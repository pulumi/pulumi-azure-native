 ...
 *
 * @deprecated azure-native:machinelearningservices/v20200515preview:ACIService is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:ACIService to guarantee forwards compatibility.
 */
export class ACIService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ACIService {
        pulumi.log.warn("ACIService is deprecated: azure-native:machinelearningservices/v20200515preview:ACIService is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:ACIService to guarantee forwards compatibility.")
