...
export class ACIService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ACIServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices/v20200515preview:ACIService" }, { type: "azure-native:machinelearningservices:ACIService" }, { type: "azure-nextgen:machinelearningservices:ACIService" }, { type: "azure-native:machinelearningservices/v20200501preview:ACIService" }, { type: "azure-nextgen:machinelearningservices/v20200501preview:ACIService" }, { type: "azure-native:machinelearningservices/v20200901preview:ACIService" }, { type: "azure-nextgen:machinelearningservices/v20200901preview:ACIService" }, { type: "azure-native:machinelearningservices/v20210101:ACIService" }, { type: "azure-nextgen:machinelearningservices/v20210101:ACIService" }, { type: "azure-native:machinelearningservices/v20210301preview:ACIService" }, { type: "azure-nextgen:machinelearningservices/v20210301preview:ACIService" }, { type: "azure-native:machinelearningservices/v20210401:ACIService" }, { type: "azure-nextgen:machinelearningservices/v20210401:ACIService" }] };
...
export interface ACIServiceArgs {
     ...
     */
    readonly containerResourceRequirements?: pulumi.Input<inputs.machinelearningservices.v20200515preview.ContainerResourceRequirementsArgs>;
    /**
     * Details of the data collection options specified.
     */
    readonly dataCollection?: pulumi.Input<inputs.machinelearningservices.v20200515preview.ACIServiceCreateRequestDataCollectionArgs>;
    /**
     ...
     */
    readonly encryptionProperties?: pulumi.Input<inputs.machinelearningservices.v20200515preview.ACIServiceCreateRequestEncryptionPropertiesArgs>;
    /**
     * The Environment, models and assets needed for inferencing.
     */
    readonly environmentImageRequest?: pulumi.Input<inputs.machinelearningservices.v20200515preview.CreateServiceRequestEnvironmentImageRequestArgs>;
    /**
     * The authentication keys.
     */
    readonly keys?: pulumi.Input<inputs.machinelearningservices.v20200515preview.CreateServiceRequestKeysArgs>;
    /**
     ...
     */
    readonly vnetConfiguration?: pulumi.Input<inputs.machinelearningservices.v20200515preview.ACIServiceCreateRequestVnetConfigurationArgs>;
    /**
