...
export class MachineLearningService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MachineLearningServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/latest:MachineLearningService" }, { type: "azurerm:machinelearningservices/v20200501preview:MachineLearningService" }, { type: "azurerm:machinelearningservices/v20200901preview:MachineLearningService" }] };
