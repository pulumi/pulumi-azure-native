...
export class MachineLearningService extends pulumi.CustomResource {
     ...
     * Service properties
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20200515preview.ServiceResponseBaseResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: MachineLearningServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/preview:MachineLearningService" }, { type: "azurerm:machinelearningservices/v20200501preview:MachineLearningService" }, { type: "azurerm:machinelearningservices/v20200901preview:MachineLearningService" }] };
