 ...
 *
 * const endpointVariant = new azure_native.machinelearningservices.v20200515preview.EndpointVariant("endpointVariant", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:machinelearningservices/v20200515preview:EndpointVariant service456 subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspaces123/services/service456 
 * ```
 */
export class EndpointVariant extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EndpointVariantArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20200501preview:EndpointVariant" }, { type: "azure-native:machinelearningservices/v20200901preview:EndpointVariant" }, { type: "azure-native:machinelearningservices/v20210101:EndpointVariant" }, { type: "azure-native:machinelearningservices/v20210401:EndpointVariant" }] };
