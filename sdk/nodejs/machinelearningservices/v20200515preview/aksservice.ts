 ...
 *
 * const aksService = new azure_native.machinelearningservices.v20200515preview.AKSService("aksService", {
...
export class AKSService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AKSServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20200501preview:AKSService" }, { type: "azure-native:machinelearningservices/v20200901preview:AKSService" }, { type: "azure-native:machinelearningservices/v20210101:AKSService" }, { type: "azure-native:machinelearningservices/v20210401:AKSService" }] };
