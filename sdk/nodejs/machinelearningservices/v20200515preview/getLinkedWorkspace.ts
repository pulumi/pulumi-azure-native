...
export function getLinkedWorkspace(args: GetLinkedWorkspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetLinkedWorkspaceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:machinelearningservices/v20200515preview:getLinkedWorkspace", {
...
export interface GetLinkedWorkspaceResult {
     ...
     */
    readonly properties: outputs.machinelearningservices.v20200515preview.LinkedWorkspacePropsInvokeResponse;
    /**
