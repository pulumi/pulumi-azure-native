...
export class LinkedWorkspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningservices/latest:LinkedWorkspace';
    ...
    constructor(name: string, args: LinkedWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/v20200501preview:LinkedWorkspace" }, { type: "azurerm:machinelearningservices/v20200515preview:LinkedWorkspace" }] };
