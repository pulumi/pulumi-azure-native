...
export class CodeVersion extends pulumi.CustomResource {
     ...
     */
    public readonly codeVersionDetails!: pulumi.Output<outputs.machinelearningservices.v20220201preview.CodeVersionResponse>;
    /**
    ...
    constructor(name: string, args: CodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeVersionDetails"] = args ? (args.codeVersionDetails ? pulumi.output(args.codeVersionDetails).apply(inputs.machinelearningservices.v20220201preview.codeVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface CodeVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeVersionDetails: pulumi.Input<inputs.machinelearningservices.v20220201preview.CodeVersionArgs>;
    /**
