...
export interface ListComputeNodesResult {
     ...
     */
    readonly nodes: outputs.machinelearningservices.v20220201preview.AmlComputeNodeInformationResponse[];
}
/**
 * Get the details (e.g IP address, port etc) of all the compute nodes in the compute.
 */
export function listComputeNodesOutput(args: ListComputeNodesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListComputeNodesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20220201preview:listComputeNodes", {
        "computeName": args.computeName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
