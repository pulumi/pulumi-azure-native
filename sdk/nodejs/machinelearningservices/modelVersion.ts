...
export class ModelVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ModelVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices:ModelVersion" }, { type: "azure-native:machinelearningservices/v20210301preview:ModelVersion" }, { type: "azure-nextgen:machinelearningservices/v20210301preview:ModelVersion" }] };
