 ...
 *
 * @deprecated azure-native:machinelearningservices/v20200601:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20200801:Workspace to guarantee forwards compatibility.
 */
export class Workspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Workspace {
        pulumi.log.warn("Workspace is deprecated: azure-native:machinelearningservices/v20200601:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20200801:Workspace to guarantee forwards compatibility.")
        return new Workspace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20200601:Workspace';
...
export interface WorkspaceArgs {
     ...
     * The encryption settings of Azure ML workspace.
     */
    encryption?: pulumi.Input<inputs.machinelearningservices.v20200601.EncryptionPropertyArgs>;
    /**
     * The friendly name for this workspace. This name in mutable
     */
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.machinelearningservices.v20200601.IdentityArgs>;
    /**
     * The compute name for image build
     */
     ...
     * The list of shared private link resources in this workspace.
     */
    sharedPrivateLinkResources?: pulumi.Input<pulumi.Input<inputs.machinelearningservices.v20200601.SharedPrivateLinkResourceArgs>[]>;
    /**
     * The sku of the workspace.
     */
    sku?: pulumi.Input<inputs.machinelearningservices.v20200601.SkuArgs>;
    /**
     * ARM id of the storage account associated with this workspace. This cannot be changed once the workspace has been created
     */
