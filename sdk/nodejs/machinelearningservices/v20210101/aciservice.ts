 ...
 *
 * const aciService = new azure_native.machinelearningservices.v20210101.ACIService("aciService", {
...
export class ACIService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ACIServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20200501preview:ACIService" }, { type: "azure-native:machinelearningservices/v20200515preview:ACIService" }, { type: "azure-native:machinelearningservices/v20200901preview:ACIService" }, { type: "azure-native:machinelearningservices/v20210401:ACIService" }] };
