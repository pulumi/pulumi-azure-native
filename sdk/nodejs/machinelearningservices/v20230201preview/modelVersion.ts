...
export class ModelVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230201preview:ModelVersion';
     ...
     */
    public readonly modelVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20230201preview.ModelVersionResponse>;
    /**
    ...
    constructor(name: string, args: ModelVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelVersionProperties"] = args ? (args.modelVersionProperties ? pulumi.output(args.modelVersionProperties).apply(inputs.machinelearningservices.v20230201preview.modelVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface ModelVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelVersionProperties: pulumi.Input<inputs.machinelearningservices.v20230201preview.ModelVersionArgs>;
    /**
