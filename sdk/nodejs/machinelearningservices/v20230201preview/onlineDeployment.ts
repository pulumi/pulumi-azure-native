...
export class OnlineDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230201preview:OnlineDeployment';
     ...
     */
    public readonly onlineDeploymentProperties!: pulumi.Output<outputs.machinelearningservices.v20230201preview.KubernetesOnlineDeploymentResponse | outputs.machinelearningservices.v20230201preview.ManagedOnlineDeploymentResponse>;
    /**
...
export interface OnlineDeploymentArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    onlineDeploymentProperties: pulumi.Input<inputs.machinelearningservices.v20230201preview.KubernetesOnlineDeploymentArgs | inputs.machinelearningservices.v20230201preview.ManagedOnlineDeploymentArgs>;
    /**
