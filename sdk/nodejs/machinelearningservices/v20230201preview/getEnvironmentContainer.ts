...
export function getEnvironmentContainer(args: GetEnvironmentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetEnvironmentContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230201preview:getEnvironmentContainer", {
        "name": args.name,
...
export interface GetEnvironmentContainerResult {
     ...
     */
    readonly environmentContainerProperties: outputs.machinelearningservices.v20230201preview.EnvironmentContainerResponse;
    /**
...
export function getEnvironmentContainerOutput(args: GetEnvironmentContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnvironmentContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230201preview:getEnvironmentContainer", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
