...
export function getComponentContainer(args: GetComponentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230201preview:getComponentContainer", {
        "name": args.name,
...
export interface GetComponentContainerResult {
     ...
     */
    readonly componentContainerProperties: outputs.machinelearningservices.v20230201preview.ComponentContainerResponse;
    /**
...
export function getComponentContainerOutput(args: GetComponentContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComponentContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230201preview:getComponentContainer", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
