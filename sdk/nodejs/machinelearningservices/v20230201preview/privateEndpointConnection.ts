 ...
 *
 * const privateEndpointConnection = new azure_native.machinelearningservices.v20230201preview.PrivateEndpointConnection("privateEndpointConnection", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:machinelearningservices/v20230201preview:PrivateEndpointConnection {privateEndpointConnectionName} /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/rg-1234/providers/Microsoft.MachineLearningServices/workspaces/testworkspace/privateEndpointConnections/{privateEndpointConnectionName} 
 * ```
 */
