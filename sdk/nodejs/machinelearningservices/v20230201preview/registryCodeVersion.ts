 ...
 *
 * const registryCodeVersion = new azure_native.machinelearningservices.v20230201preview.RegistryCodeVersion("registryCodeVersion", {
 *     codeName: "string",
...
export class RegistryCodeVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230201preview:RegistryCodeVersion';
     ...
     */
    public readonly codeVersionProperties!: pulumi.Output<outputs.machinelearningservices.v20230201preview.CodeVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryCodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeVersionProperties"] = args ? (args.codeVersionProperties ? pulumi.output(args.codeVersionProperties).apply(inputs.machinelearningservices.v20230201preview.codeVersionArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20221001preview:RegistryCodeVersion" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryCodeVersion" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryCodeVersion" }] };
...
export interface RegistryCodeVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeVersionProperties: pulumi.Input<inputs.machinelearningservices.v20230201preview.CodeVersionArgs>;
    /**
