 ...
 *
 * const registryComponentContainer = new azure_native.machinelearningservices.v20230201preview.RegistryComponentContainer("registryComponentContainer", {
...
export class RegistryComponentContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230201preview:RegistryComponentContainer';
     ...
     */
    public readonly componentContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20230201preview.ComponentContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryComponentContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["componentContainerProperties"] = args ? (args.componentContainerProperties ? pulumi.output(args.componentContainerProperties).apply(inputs.machinelearningservices.v20230201preview.componentContainerArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20221001preview:RegistryComponentContainer" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryComponentContainer" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryComponentContainer" }] };
...
export interface RegistryComponentContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    componentContainerProperties: pulumi.Input<inputs.machinelearningservices.v20230201preview.ComponentContainerArgs>;
    /**
     * Container name.
     */
