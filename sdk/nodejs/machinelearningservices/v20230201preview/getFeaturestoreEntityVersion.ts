...
export function getFeaturestoreEntityVersion(args: GetFeaturestoreEntityVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetFeaturestoreEntityVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230201preview:getFeaturestoreEntityVersion", {
        "name": args.name,
...
export interface GetFeaturestoreEntityVersionResult {
     ...
     */
    readonly featurestoreEntityVersionProperties: outputs.machinelearningservices.v20230201preview.FeaturestoreEntityVersionResponse;
    /**
...
export function getFeaturestoreEntityVersionOutput(args: GetFeaturestoreEntityVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFeaturestoreEntityVersionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20230201preview:getFeaturestoreEntityVersion", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "version": args.version,
        "workspaceName": args.workspaceName,
