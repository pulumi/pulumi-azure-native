 ...
 *
 * const featurestoreEntityContainerEntity = new azure_native.machinelearningservices.v20230201preview.FeaturestoreEntityContainerEntity("featurestoreEntityContainerEntity", {
...
export class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230201preview:FeaturestoreEntityContainerEntity';
     ...
     */
    public readonly featurestoreEntityContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20230201preview.FeaturestoreEntityContainerResponse>;
    /**
    ...
    constructor(name: string, args: FeaturestoreEntityContainerEntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["featurestoreEntityContainerProperties"] = args ? (args.featurestoreEntityContainerProperties ? pulumi.output(args.featurestoreEntityContainerProperties).apply(inputs.machinelearningservices.v20230201preview.featurestoreEntityContainerArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20230401preview:FeaturestoreEntityContainerEntity" }] };
...
export interface FeaturestoreEntityContainerEntityArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    featurestoreEntityContainerProperties: pulumi.Input<inputs.machinelearningservices.v20230201preview.FeaturestoreEntityContainerArgs>;
    /**
