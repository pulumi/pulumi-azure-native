 ...
 *
 * const dataVersion = new azure_native.machinelearningservices.v20230201preview.DataVersion("dataVersion", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:machinelearningservices/v20230201preview:DataVersion string string 
 * ```
 */
