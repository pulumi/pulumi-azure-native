...
export class WorkspaceConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceConnection {
        pulumi.log.warn("WorkspaceConnection is deprecated: azure-native:machinelearningservices/v20210701:WorkspaceConnection is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20220201preview:WorkspaceConnection to guarantee forwards compatibility.")
