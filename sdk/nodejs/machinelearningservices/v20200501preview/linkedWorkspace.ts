 ...
 *
 * const linkedWorkspace = new azurerm.machinelearningservices.v20200501preview.LinkedWorkspace("linkedWorkspace", {
 *     linkName: "link-1",
 *     name: "link-1",
...
export class LinkedWorkspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningservices/v20200501preview:LinkedWorkspace';
    ...
    constructor(name: string, args: LinkedWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/v20200515preview:LinkedWorkspace" }] };
