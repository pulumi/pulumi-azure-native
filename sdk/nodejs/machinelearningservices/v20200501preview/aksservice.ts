 ...
 *
 * const aksService = new azure_native.machinelearningservices.v20200501preview.AKSService("aksService", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:machinelearningservices/v20200501preview:AKSService service456 subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspaces123/services/service456 
 * ```
 */
export class AKSService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AKSServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20200515preview:AKSService" }, { type: "azure-native:machinelearningservices/v20200901preview:AKSService" }, { type: "azure-native:machinelearningservices/v20210101:AKSService" }, { type: "azure-native:machinelearningservices/v20210401:AKSService" }] };
