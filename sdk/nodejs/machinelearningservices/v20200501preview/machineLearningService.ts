...
export class MachineLearningService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MachineLearningServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices/v20200501preview:MachineLearningService" }, { type: "azure-native:machinelearningservices:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20200515preview:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20200515preview:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20200901preview:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20200901preview:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20210101:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20210101:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20210301preview:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20210301preview:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20210401:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20210401:MachineLearningService" }] };
