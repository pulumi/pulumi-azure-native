...
export class MachineLearningService extends pulumi.CustomResource {
     ...
     * Service properties
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20200501preview.ACIServiceResponseResponse | outputs.machinelearningservices.v20200501preview.AKSVariantResponseResponse>;
    /**
    ...
    constructor(name: string, args: MachineLearningServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices/v20200515preview:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20200901preview:MachineLearningService" }] };
