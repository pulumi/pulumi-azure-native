...
export function getMachineLearningService(args: GetMachineLearningServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineLearningServiceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:machinelearningservices/v20200501preview:getMachineLearningService", {
        "expand": args.expand,
...
export interface GetMachineLearningServiceResult {
     ...
     * Service properties
     */
    readonly properties: outputs.machinelearningservices.v20200501preview.ServiceResponseBaseResponse;
    /**
