 ...
 */
/** @deprecated azure-native:machinelearningservices/v20200501preview:EndpointVariant is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility. */
export function getEndpointVariant(args: GetEndpointVariantArgs, opts?: pulumi.InvokeOptions): Promise<GetEndpointVariantResult> {
    pulumi.log.warn("getEndpointVariant is deprecated: azure-native:machinelearningservices/v20200501preview:EndpointVariant is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility.")
