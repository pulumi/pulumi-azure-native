...
export function getWorkspace(args: GetWorkspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:machinelearningservices:getWorkspace", {
        "name": args.name,
...
export interface GetWorkspaceResult {
     ...
     */
    readonly properties: outputs.machinelearningservices.WorkspacePropertiesResponse;
    /**
