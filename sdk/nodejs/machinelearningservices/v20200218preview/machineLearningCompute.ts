...
export class MachineLearningCompute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningservices/v20200218preview:MachineLearningCompute';
     ...
     * Compute properties
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.v20200218preview.ComputeResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: MachineLearningComputeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningservices/latest:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/preview:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20180301preview:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20181119:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20190501:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20190601:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20191101:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20200101:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20200301:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20200401:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20200501preview:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20200515preview:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20200601:MachineLearningCompute" }, { type: "azurerm:machinelearningservices/v20200901preview:MachineLearningCompute" }] };
...
export interface MachineLearningComputeArgs {
     ...
     * Compute properties
     */
    readonly properties?: pulumi.Input<inputs.machinelearningservices.v20200218preview.Compute>;
    /**
