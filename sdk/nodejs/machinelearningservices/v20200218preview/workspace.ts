 ...
 *
 * const workspace = new azurerm.machinelearningservices.v20200218preview.Workspace("workspace", {
...
export class Workspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningservices/v20200218preview:Workspace';
...
export interface WorkspaceArgs {
     ...
     * The encryption settings of Azure ML workspace.
     */
    readonly encryption?: pulumi.Input<inputs.machinelearningservices.v20200218preview.EncryptionProperty>;
    /**
     * The friendly name for this workspace. This name in mutable
     */
