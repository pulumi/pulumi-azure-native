...
export interface GetMarketplaceSubscriptionResult {
     ...
     */
    readonly marketplaceSubscriptionProperties: outputs.machinelearningservices.v20240101preview.MarketplaceSubscriptionResponse;
    /**
...
export function getMarketplaceSubscriptionOutput(args: GetMarketplaceSubscriptionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMarketplaceSubscriptionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20240101preview:getMarketplaceSubscription", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
