...
export interface GetModelContainerResult {
     ...
     */
    readonly modelContainerProperties: outputs.machinelearningservices.v20240101preview.ModelContainerResponse;
    /**
...
export function getModelContainerOutput(args: GetModelContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices/v20240101preview:getModelContainer", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
