...
export class ServerlessEndpoint extends pulumi.CustomResource {
     ...
     */
    public readonly serverlessEndpointProperties!: pulumi.Output<outputs.machinelearningservices.v20240101preview.ServerlessEndpointResponse>;
    /**
    ...
    constructor(name: string, args: ServerlessEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ServerlessEndpoint" }, { type: "azure-native:machinelearningservices/v20230801preview:ServerlessEndpoint" }, { type: "azure-native:machinelearningservices/v20240401preview:ServerlessEndpoint" }] };
...
export interface ServerlessEndpointArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    serverlessEndpointProperties: pulumi.Input<inputs.machinelearningservices.v20240101preview.ServerlessEndpointArgs>;
    /**
     * Sku details required for ARM contract for Autoscaling.
     */
