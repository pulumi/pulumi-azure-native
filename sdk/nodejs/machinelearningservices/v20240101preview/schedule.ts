...
export class Schedule extends pulumi.CustomResource {
     ...
     */
    public readonly scheduleProperties!: pulumi.Output<outputs.machinelearningservices.v20240101preview.ScheduleResponse>;
    /**
    ...
    constructor(name: string, args: ScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["scheduleProperties"] = args ? (args.scheduleProperties ? pulumi.output(args.scheduleProperties).apply(inputs.machinelearningservices.v20240101preview.scheduleArgsProvideDefaults) : undefined) : undefined;
...
export interface ScheduleArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    scheduleProperties: pulumi.Input<inputs.machinelearningservices.v20240101preview.ScheduleArgs>;
    /**
