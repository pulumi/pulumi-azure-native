...
export class EndpointDeployment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EndpointDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:EndpointDeployment" }, { type: "azure-native:machinelearningservices/v20240401preview:EndpointDeployment" }, { type: "azure-native:machinelearningservices/v20240701preview:EndpointDeployment" }] };
...
export interface EndpointDeploymentArgs {
    ...
    properties: pulumi.Input<inputs.machinelearningservices.v20240101preview.ContentSafetyEndpointDeploymentResourcePropertiesArgs | inputs.machinelearningservices.v20240101preview.ManagedOnlineEndpointDeploymentResourcePropertiesArgs | inputs.machinelearningservices.v20240101preview.OpenAIEndpointDeploymentResourcePropertiesArgs | inputs.machinelearningservices.v20240101preview.SpeechEndpointDeploymentResourcePropertiesArgs>;
    /**
