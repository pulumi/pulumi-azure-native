...
export class MachineLearningService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices:MachineLearningService';
     ...
     * Service properties
     */
    public readonly properties!: pulumi.Output<outputs.machinelearningservices.ACIServiceResponseResponse | outputs.machinelearningservices.AKSServiceResponseResponse | outputs.machinelearningservices.AKSVariantResponseResponse>;
    /**
    ...
    constructor(name: string, args: MachineLearningServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningservices:MachineLearningService" }, { type: "azure-native:machinelearningservices/latest:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/latest:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20200501preview:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20200501preview:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20200515preview:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20200515preview:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20200901preview:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20200901preview:MachineLearningService" }, { type: "azure-native:machinelearningservices/v20210101:MachineLearningService" }, { type: "azure-nextgen:machinelearningservices/v20210101:MachineLearningService" }] };
...
export interface MachineLearningServiceArgs {
     ...
     */
    readonly environmentImageRequest?: pulumi.Input<inputs.machinelearningservices.CreateServiceRequestEnvironmentImageRequest>;
    /**
     * The authentication keys.
     */
    readonly keys?: pulumi.Input<inputs.machinelearningservices.CreateServiceRequestKeys>;
    /**
