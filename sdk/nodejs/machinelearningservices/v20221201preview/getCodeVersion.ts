...
export function getCodeVersion(args: GetCodeVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetCodeVersionResult> {
    pulumi.log.warn("getCodeVersion is deprecated: azure-native:machinelearningservices/v20221201preview:CodeVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:CodeVersion to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20221201preview:getCodeVersion", {
        "name": args.name,
...
export interface GetCodeVersionResult {
     ...
     */
    readonly codeVersionProperties: outputs.machinelearningservices.v20221201preview.CodeVersionResponse;
    /**
