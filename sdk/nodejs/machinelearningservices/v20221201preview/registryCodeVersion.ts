...
export class RegistryCodeVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegistryCodeVersion {
        pulumi.log.warn("RegistryCodeVersion is deprecated: azure-native:machinelearningservices/v20221201preview:RegistryCodeVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:RegistryCodeVersion to guarantee forwards compatibility.")
