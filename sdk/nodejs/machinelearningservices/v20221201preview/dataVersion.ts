...
export class DataVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20221201preview:DataVersion';
     ...
     */
    public readonly dataVersionBaseProperties!: pulumi.Output<outputs.machinelearningservices.v20221201preview.MLTableDataResponse | outputs.machinelearningservices.v20221201preview.UriFileDataVersionResponse | outputs.machinelearningservices.v20221201preview.UriFolderDataVersionResponse>;
    /**
...
export interface DataVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataVersionBaseProperties: pulumi.Input<inputs.machinelearningservices.v20221201preview.MLTableDataArgs | inputs.machinelearningservices.v20221201preview.UriFileDataVersionArgs | inputs.machinelearningservices.v20221201preview.UriFolderDataVersionArgs>;
    /**
     * Container name.
     */
