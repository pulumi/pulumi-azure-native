 ...
 */
/** @deprecated azure-native:machinelearningservices/v20221201preview:LabelingJob is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:LabelingJob to guarantee forwards compatibility. */
export function getLabelingJob(args: GetLabelingJobArgs, opts?: pulumi.InvokeOptions): Promise<GetLabelingJobResult> {
    pulumi.log.warn("getLabelingJob is deprecated: azure-native:machinelearningservices/v20221201preview:LabelingJob is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:LabelingJob to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20221201preview:getLabelingJob", {
        "id": args.id,
...
export interface GetLabelingJobResult {
     ...
     */
    readonly labelingJobProperties: outputs.machinelearningservices.v20221201preview.LabelingJobResponse;
    /**
