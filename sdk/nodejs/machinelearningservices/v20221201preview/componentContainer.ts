 ...
 *
 * const componentContainer = new azure_native.machinelearningservices.v20221201preview.ComponentContainer("componentContainer", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:machinelearningservices/v20221201preview:ComponentContainer string string 
 * ```
 */
