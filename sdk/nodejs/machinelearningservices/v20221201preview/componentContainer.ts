...
export class ComponentContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20221201preview:ComponentContainer';
     ...
     */
    public readonly componentContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20221201preview.ComponentContainerResponse>;
    /**
    ...
    constructor(name: string, args: ComponentContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["componentContainerProperties"] = args ? (args.componentContainerProperties ? pulumi.output(args.componentContainerProperties).apply(inputs.machinelearningservices.v20221201preview.componentContainerArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20220201preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20220501:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20220601preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20221001:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20221001preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20230201preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20230401:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20230401preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20230601preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20230801preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20231001:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20240101preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20240401:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20240401preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20240701preview:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20241001:ComponentContainer" }, { type: "azure-native:machinelearningservices/v20241001preview:ComponentContainer" }] };
...
export interface ComponentContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    componentContainerProperties: pulumi.Input<inputs.machinelearningservices.v20221201preview.ComponentContainerArgs>;
    /**
     * Container name.
     */
