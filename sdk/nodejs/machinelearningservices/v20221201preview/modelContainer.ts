 ...
 *
 * const modelContainer = new azure_native.machinelearningservices.v20221201preview.ModelContainer("modelContainer", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:machinelearningservices/v20221201preview:ModelContainer testContainer /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspace123/models/testContainer 
 * ```
 */
export class ModelContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20221201preview:ModelContainer';
     ...
     */
    public readonly modelContainerProperties!: pulumi.Output<outputs.machinelearningservices.v20221201preview.ModelContainerResponse>;
    /**
    ...
    constructor(name: string, args: ModelContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelContainerProperties"] = args ? (args.modelContainerProperties ? pulumi.output(args.modelContainerProperties).apply(inputs.machinelearningservices.v20221201preview.modelContainerArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ModelContainer" }, { type: "azure-native:machinelearningservices/v20210301preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20220201preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20220501:ModelContainer" }, { type: "azure-native:machinelearningservices/v20220601preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20221001:ModelContainer" }, { type: "azure-native:machinelearningservices/v20221001preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20230201preview:ModelContainer" }, { type: "azure-native:machinelearningservices/v20230401preview:ModelContainer" }] };
...
export interface ModelContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelContainerProperties: pulumi.Input<inputs.machinelearningservices.v20221201preview.ModelContainerArgs>;
    /**
