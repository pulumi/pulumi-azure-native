...
export function getModelContainer(args: GetModelContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetModelContainerResult> {
    pulumi.log.warn("getModelContainer is deprecated: azure-native:machinelearningservices/v20221201preview:ModelContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:ModelContainer to guarantee forwards compatibility.")
