...
export class VolumeSnapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elasticsan/v20240601preview:VolumeSnapshot';
     ...
     */
    public readonly creationData!: pulumi.Output<outputs.elasticsan.v20240601preview.SnapshotCreationDataResponse>;
    /**
    ...
    constructor(name: string, args: VolumeSnapshotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elasticsan/v20230101:VolumeSnapshot" }, { type: "azure-native:elasticsan/v20240501:VolumeSnapshot" }, { type: "azure-native:elasticsan:VolumeSnapshot" }] };
...
export interface VolumeSnapshotArgs {
     ...
     * Data used when creating a volume snapshot.
     */
    creationData: pulumi.Input<inputs.elasticsan.v20240601preview.SnapshotCreationDataArgs>;
    /**
