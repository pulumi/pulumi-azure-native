...
// Export enums:
export * from "../../types/enums/elasticsan/v20240601preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:elasticsan/v20240601preview:ElasticSan":
                return new ElasticSan(name, <any>undefined, { urn })
            case "azure-native:elasticsan/v20240601preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:elasticsan/v20240601preview:Volume":
                return new Volume(name, <any>undefined, { urn })
            case "azure-native:elasticsan/v20240601preview:VolumeGroup":
                return new VolumeGroup(name, <any>undefined, { urn })
            case "azure-native:elasticsan/v20240601preview:VolumeSnapshot":
...
pulumi.runtime.registerResourceModule("azure-native", "elasticsan/v20240601preview", _module)
