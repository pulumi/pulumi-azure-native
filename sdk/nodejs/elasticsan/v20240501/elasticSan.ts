...
export class ElasticSan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elasticsan/v20240501:ElasticSan';
     ...
     * resource sku
     */
    public readonly sku!: pulumi.Output<outputs.elasticsan.v20240501.SkuResponse>;
    /**
    ...
    constructor(name: string, args: ElasticSanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elasticsan/v20211120preview:ElasticSan" }, { type: "azure-native:elasticsan/v20221201preview:ElasticSan" }, { type: "azure-native:elasticsan/v20230101:ElasticSan" }, { type: "azure-native:elasticsan/v20240601preview:ElasticSan" }, { type: "azure-native:elasticsan:ElasticSan" }] };
