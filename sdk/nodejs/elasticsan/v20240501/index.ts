...
// Export enums:
export * from "../../types/enums/elasticsan/v20240501";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:elasticsan/v20240501:ElasticSan":
                return new ElasticSan(name, <any>undefined, { urn })
            case "azure-native:elasticsan/v20240501:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:elasticsan/v20240501:Volume":
                return new Volume(name, <any>undefined, { urn })
            case "azure-native:elasticsan/v20240501:VolumeGroup":
                return new VolumeGroup(name, <any>undefined, { urn })
            case "azure-native:elasticsan/v20240501:VolumeSnapshot":
...
pulumi.runtime.registerResourceModule("azure-native", "elasticsan/v20240501", _module)
