...
export class VolumeSnapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elasticsan/v20240501:VolumeSnapshot';
     ...
     */
    public readonly creationData!: pulumi.Output<outputs.elasticsan.v20240501.SnapshotCreationDataResponse>;
    /**
    ...
    constructor(name: string, args: VolumeSnapshotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elasticsan:VolumeSnapshot" }, { type: "azure-native:elasticsan/v20230101:VolumeSnapshot" }] };
