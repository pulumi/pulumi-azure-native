...
export class VolumeGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elasticsan/v20240501:VolumeGroup';
     ...
     */
    public readonly encryptionProperties!: pulumi.Output<outputs.elasticsan.v20240501.EncryptionPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.elasticsan.v20240501.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly networkAcls!: pulumi.Output<outputs.elasticsan.v20240501.NetworkRuleSetResponse | undefined>;
    /**
     * The list of Private Endpoint Connections.
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.elasticsan.v20240501.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: VolumeGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elasticsan/v20211120preview:VolumeGroup" }, { type: "azure-native:elasticsan/v20221201preview:VolumeGroup" }, { type: "azure-native:elasticsan/v20230101:VolumeGroup" }, { type: "azure-native:elasticsan/v20240601preview:VolumeGroup" }, { type: "azure-native:elasticsan:VolumeGroup" }] };
...
export interface VolumeGroupArgs {
     ...
     * Type of encryption
     */
    encryption?: pulumi.Input<string | enums.elasticsan.v20240501.EncryptionType>;
    /**
     * Encryption Properties describing Key Vault and Identity information
     */
    encryptionProperties?: pulumi.Input<inputs.elasticsan.v20240501.EncryptionPropertiesArgs>;
    /**
     * A boolean indicating whether or not Data Integrity Check is enabled
     */
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.elasticsan.v20240501.IdentityArgs>;
    /**
     * A collection of rules governing the accessibility from specific network locations.
     */
    networkAcls?: pulumi.Input<inputs.elasticsan.v20240501.NetworkRuleSetArgs>;
    /**
     * Type of storage target
     */
    protocolType?: pulumi.Input<string | enums.elasticsan.v20240501.StorageTargetType>;
    /**
