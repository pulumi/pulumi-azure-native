...
export class VolumeSnapshot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VolumeSnapshotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elasticsan/v20230101:VolumeSnapshot" }, { type: "azure-native:elasticsan/v20240501:VolumeSnapshot" }, { type: "azure-native:elasticsan/v20240601preview:VolumeSnapshot" }, { type: "azure-native:elasticsan/v20240701preview:VolumeSnapshot" }, { type: "azure-native:elasticsan/v20250901:VolumeSnapshot" }, { type: "azure-native:elasticsan/v20260401preview:VolumeSnapshot" }] };
