...
export class ElasticSan extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.elasticsan.v20211120preview.ElasticSanPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ElasticSanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elasticsan:ElasticSan" }] };
...
export interface ElasticSanArgs {
     ...
     * Properties of ElasticSan.
     */
    properties: pulumi.Input<inputs.elasticsan.v20211120preview.ElasticSanPropertiesArgs>;
    /**
