...
export class ElasticSan extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ElasticSanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elasticsan/v20211120preview:ElasticSan" }, { type: "azure-native:elasticsan/v20221201preview:ElasticSan" }, { type: "azure-native:elasticsan/v20230101:ElasticSan" }, { type: "azure-native:elasticsan/v20240501:ElasticSan" }, { type: "azure-native:elasticsan/v20240601preview:ElasticSan" }, { type: "azure-native:elasticsan/v20240701preview:ElasticSan" }, { type: "azure-native:elasticsan/v20250901:ElasticSan" }, { type: "azure-native:elasticsan/v20260401preview:ElasticSan" }] };
