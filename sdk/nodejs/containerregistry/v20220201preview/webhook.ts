...
export class Webhook extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Webhook {
        pulumi.log.warn("Webhook is deprecated: azure-native:containerregistry/v20220201preview:Webhook is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Webhook to guarantee forwards compatibility.")
        return new Webhook(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20220201preview:Webhook';
...
export interface WebhookArgs {
     ...
     * The list of actions that trigger the webhook to post notifications.
     */
    actions: pulumi.Input<pulumi.Input<string | enums.containerregistry.v20220201preview.WebhookAction>[]>;
    /**
     ...
     * The status of the webhook at the time the operation was called.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20220201preview.WebhookStatus>;
    /**
