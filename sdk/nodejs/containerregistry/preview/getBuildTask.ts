...
export function getBuildTask(args: GetBuildTaskArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildTaskResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerregistry/preview:getBuildTask", {
...
export interface GetBuildTaskResult {
     ...
     */
    readonly platform: outputs.containerregistry.preview.PlatformPropertiesResponse;
    /**
     ...
     */
    readonly sourceRepository: outputs.containerregistry.preview.SourceRepositoryPropertiesResponse;
    /**
