...
export class PipelineRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry/preview:PipelineRun';
     ...
     */
    public readonly request!: pulumi.Output<outputs.containerregistry.preview.PipelineRunRequestResponse | undefined>;
    /**
     * The response of a pipeline run.
     */
    public /*out*/ readonly response!: pulumi.Output<outputs.containerregistry.preview.PipelineRunResponseResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/v20191201preview:PipelineRun" }] };
...
export interface PipelineRunArgs {
     ...
     * The request parameters for a pipeline run.
     */
    readonly request?: pulumi.Input<inputs.containerregistry.preview.PipelineRunRequest>;
    /**
