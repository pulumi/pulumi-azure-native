...
export function getBuildStep(args: GetBuildStepArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildStepResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerregistry/preview:getBuildStep", {
...
export interface GetBuildStepResult {
     ...
     */
    readonly properties: outputs.containerregistry.preview.BuildStepPropertiesResponse;
    /**
