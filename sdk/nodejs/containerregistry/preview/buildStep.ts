...
export class BuildStep extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BuildStep {
        return new BuildStep(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry/preview:BuildStep';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.containerregistry.preview.BuildStepPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: BuildStepArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as BuildStepArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/v20180201preview:BuildStep" }] };
