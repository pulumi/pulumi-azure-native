...
export class BuildTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry/preview:BuildTask';
     ...
     */
    public readonly sourceRepository!: pulumi.Output<outputs.containerregistry.preview.SourceRepositoryPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BuildTaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/v20180201preview:BuildTask" }] };
...
export interface BuildTaskArgs {
     ...
     * The properties that describes the source(code) for the build task.
     */
    readonly sourceRepository: pulumi.Input<inputs.containerregistry.preview.SourceRepositoryProperties>;
    /**
     * The current status of build task.
     */
