...
export class ExportPipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry/preview:ExportPipeline';
     ...
     */
    public readonly target!: pulumi.Output<outputs.containerregistry.preview.ExportPipelineTargetPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ExportPipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/v20191201preview:ExportPipeline" }] };
...
export interface ExportPipelineArgs {
     ...
     * The target properties of the export pipeline.
     */
    readonly target: pulumi.Input<inputs.containerregistry.preview.ExportPipelineTargetProperties>;
}
