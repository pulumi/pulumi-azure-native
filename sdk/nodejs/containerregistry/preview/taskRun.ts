...
export class TaskRun extends pulumi.CustomResource {
     ...
     */
    public readonly runRequest!: pulumi.Output<outputs.containerregistry.preview.RunRequestResponse | undefined>;
    /**
...
export interface TaskRunArgs {
     ...
     * The request (parameters) for the run
     */
    readonly runRequest?: pulumi.Input<inputs.containerregistry.preview.RunRequest>;
    /**
