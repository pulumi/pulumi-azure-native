...
export class TaskRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry/preview:TaskRun';
     ...
     */
    public readonly runRequest!: pulumi.Output<outputs.containerregistry.preview.DockerBuildRequestResponse | outputs.containerregistry.preview.EncodedTaskRunRequestResponse | outputs.containerregistry.preview.FileTaskRunRequestResponse | outputs.containerregistry.preview.TaskRunRequestResponse | undefined>;
    /**
     * The result of this task run
     */
    public /*out*/ readonly runResult!: pulumi.Output<outputs.containerregistry.preview.RunResponse>;
    /**
    ...
    constructor(name: string, args: TaskRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/v20190601preview:TaskRun" }] };
...
export interface TaskRunArgs {
     ...
     * The request (parameters) for the run
     */
    readonly runRequest?: pulumi.Input<inputs.containerregistry.preview.DockerBuildRequest | inputs.containerregistry.preview.EncodedTaskRunRequest | inputs.containerregistry.preview.FileTaskRunRequest | inputs.containerregistry.preview.TaskRunRequest>;
    /**
