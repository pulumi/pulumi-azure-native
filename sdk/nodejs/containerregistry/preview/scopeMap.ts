...
export class ScopeMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry/preview:ScopeMap';
    ...
    constructor(name: string, argsOrState?: ScopeMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/v20190501preview:ScopeMap" }] };
