...
export function getPipelineRun(args: GetPipelineRunArgs, opts?: pulumi.InvokeOptions): Promise<GetPipelineRunResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerregistry/preview:getPipelineRun", {
...
export interface GetPipelineRunResult {
     ...
     */
    readonly request?: outputs.containerregistry.preview.PipelineRunRequestResponse;
    /**
     * The response of a pipeline run.
     */
    readonly response: outputs.containerregistry.preview.PipelineRunResponseResponse;
    /**
