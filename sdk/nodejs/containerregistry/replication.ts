...
export class Replication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry:Replication';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.containerregistry.ReplicationPropertiesResponse>;
    /**
...
export interface ReplicationArgs {
     ...
     * The properties of the replication.
     */
    readonly properties?: pulumi.Input<inputs.containerregistry.ReplicationProperties>;
    /**
