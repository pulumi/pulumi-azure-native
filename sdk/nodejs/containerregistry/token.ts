...
export class Token extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TokenArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry:Token" }, { type: "azure-native:containerregistry/v20190501preview:Token" }, { type: "azure-nextgen:containerregistry/v20190501preview:Token" }, { type: "azure-native:containerregistry/v20201101preview:Token" }, { type: "azure-nextgen:containerregistry/v20201101preview:Token" }, { type: "azure-native:containerregistry/v20210601preview:Token" }, { type: "azure-nextgen:containerregistry/v20210601preview:Token" }, { type: "azure-native:containerregistry/v20210801preview:Token" }, { type: "azure-nextgen:containerregistry/v20210801preview:Token" }] };
