...
export class Archife extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ArchifeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry/v20230601preview:Archife" }, { type: "azure-native:containerregistry/v20230801preview:Archife" }, { type: "azure-native:containerregistry/v20231101preview:Archife" }, { type: "azure-native:containerregistry/v20241101preview:Archife" }, { type: "azure-native:containerregistry/v20250301preview:Archife" }, { type: "azure-native:containerregistry/v20250501preview:Archife" }, { type: "azure-native:containerregistry/v20250601preview:Archife" }] };
