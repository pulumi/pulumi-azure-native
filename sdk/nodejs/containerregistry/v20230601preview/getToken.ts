...
export interface GetTokenResult {
     ...
     */
    readonly credentials?: outputs.containerregistry.v20230601preview.TokenCredentialsPropertiesResponse;
    /**
     * The resource ID.
     */
    readonly id: string;
...
export function getTokenOutput(args: GetTokenOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetTokenResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerregistry/v20230601preview:getToken", {
        "registryName": args.registryName,
        "resourceGroupName": args.resourceGroupName,
        "tokenName": args.tokenName,
    }, opts);
