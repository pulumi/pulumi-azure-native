...
export class Token extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TokenArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:Token" }, { type: "azure-nextgen:containerregistry:Token" }, { type: "azure-native:containerregistry/v20201101preview:Token" }, { type: "azure-nextgen:containerregistry/v20201101preview:Token" }] };
...
export interface TokenArgs {
     ...
     * The status of the token example enabled or disabled.
     */
    readonly status?: pulumi.Input<string | enums.containerregistry.v20190501preview.TokenStatus>;
    /**
