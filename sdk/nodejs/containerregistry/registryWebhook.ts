...
export class RegistryWebhook extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegistryWebhook {
        return new RegistryWebhook(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry:RegistryWebhook';
    ...
    constructor(name: string, argsOrState?: RegistryWebhookArgs, opts?: pulumi.CustomResourceOptions) {
