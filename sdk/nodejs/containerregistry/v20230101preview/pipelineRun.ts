...
export class PipelineRun extends pulumi.CustomResource {
     ...
     */
    public readonly request!: pulumi.Output<outputs.containerregistry.v20230101preview.PipelineRunRequestResponse | undefined>;
    /**
     * The response of a pipeline run.
     */
    public /*out*/ readonly response!: pulumi.Output<outputs.containerregistry.v20230101preview.PipelineRunResponseResponse>;
    /**
    ...
    constructor(name: string, args: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:PipelineRun" }, { type: "azure-native:containerregistry/v20201101preview:PipelineRun" }] };
