...
export class Token extends pulumi.CustomResource {
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.containerregistry.v20230101preview.TokenCredentialsPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: TokenArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:Token" }, { type: "azure-native:containerregistry/v20201101preview:Token" }] };
