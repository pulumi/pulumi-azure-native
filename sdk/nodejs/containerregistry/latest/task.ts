...
export class Task extends pulumi.CustomResource {
     ...
     */
    public readonly step!: pulumi.Output<outputs.containerregistry.latest.TaskStepPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/preview:Task" }, { type: "azurerm:containerregistry/v20180901:Task" }, { type: "azurerm:containerregistry/v20190401:Task" }, { type: "azurerm:containerregistry/v20190601preview:Task" }] };
