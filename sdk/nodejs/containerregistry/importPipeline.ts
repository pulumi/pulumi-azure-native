...
export class ImportPipeline extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ImportPipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry:ImportPipeline" }, { type: "azure-native:containerregistry/v20191201preview:ImportPipeline" }, { type: "azure-nextgen:containerregistry/v20191201preview:ImportPipeline" }, { type: "azure-native:containerregistry/v20201101preview:ImportPipeline" }, { type: "azure-nextgen:containerregistry/v20201101preview:ImportPipeline" }, { type: "azure-native:containerregistry/v20210601preview:ImportPipeline" }, { type: "azure-nextgen:containerregistry/v20210601preview:ImportPipeline" }, { type: "azure-native:containerregistry/v20210801preview:ImportPipeline" }, { type: "azure-nextgen:containerregistry/v20210801preview:ImportPipeline" }] };
