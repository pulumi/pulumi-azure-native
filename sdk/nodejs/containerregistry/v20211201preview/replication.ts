...
export class Replication extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Replication {
        pulumi.log.warn("Replication is deprecated: azure-native:containerregistry/v20211201preview:Replication is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Replication to guarantee forwards compatibility.")
        return new Replication(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20211201preview:Replication';
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.containerregistry.v20211201preview.StatusResponse>;
    /**
