...
export class Task extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry/v20180901:Task';
    ...
    constructor(name: string, args: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/latest:Task" }, { type: "azurerm:containerregistry/preview:Task" }, { type: "azurerm:containerregistry/v20190401:Task" }, { type: "azurerm:containerregistry/v20190601preview:Task" }] };
