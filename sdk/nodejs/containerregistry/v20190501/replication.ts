...
export class Replication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:containerregistry/v20190501:Replication';
    ...
    constructor(name: string, args: ReplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/latest:Replication" }, { type: "azure-nextgen:containerregistry/v20170601preview:Replication" }, { type: "azure-nextgen:containerregistry/v20171001:Replication" }, { type: "azure-nextgen:containerregistry/v20191201preview:Replication" }, { type: "azure-nextgen:containerregistry/v20201101preview:Replication" }] };
