...
export class Webhook extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebhookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:Webhook" }, { type: "azure-native:containerregistry/v20201101preview:Webhook" }, { type: "azure-native:containerregistry/v20230101preview:Webhook" }] };
