...
export class CredentialSet extends pulumi.CustomResource {
     ...
     */
    public readonly authCredentials!: pulumi.Output<outputs.containerregistry.v20230701.AuthCredentialResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: CredentialSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:CredentialSet" }, { type: "azure-native:containerregistry/v20230101preview:CredentialSet" }, { type: "azure-native:containerregistry/v20230601preview:CredentialSet" }] };
