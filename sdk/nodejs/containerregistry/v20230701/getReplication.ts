...
export interface GetReplicationResult {
     ...
     */
    readonly status: outputs.containerregistry.v20230701.StatusResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: outputs.containerregistry.v20230701.SystemDataResponse;
    /**
...
export function getReplicationOutput(args: GetReplicationOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetReplicationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerregistry/v20230701:getReplication", {
        "registryName": args.registryName,
        "replicationName": args.replicationName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
