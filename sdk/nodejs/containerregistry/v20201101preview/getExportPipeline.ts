...
export function getExportPipeline(args: GetExportPipelineArgs, opts?: pulumi.InvokeOptions): Promise<GetExportPipelineResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:containerregistry/v20201101preview:getExportPipeline", {
...
export interface GetExportPipelineResult {
     ...
     */
    readonly target: outputs.containerregistry.v20201101preview.ExportPipelineTargetPropertiesInvokeResponse;
    /**
