...
export class PipelineRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20201101preview:PipelineRun';
     ...
     */
    public readonly request!: pulumi.Output<outputs.containerregistry.v20201101preview.PipelineRunRequestResponse | undefined>;
    /**
     * The response of a pipeline run.
     */
    public /*out*/ readonly response!: pulumi.Output<outputs.containerregistry.v20201101preview.PipelineRunResponseResponse>;
    /**
    ...
    constructor(name: string, args: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20201101preview:PipelineRun" }, { type: "azure-native:containerregistry:PipelineRun" }, { type: "azure-nextgen:containerregistry:PipelineRun" }, { type: "azure-native:containerregistry/v20191201preview:PipelineRun" }, { type: "azure-nextgen:containerregistry/v20191201preview:PipelineRun" }, { type: "azure-native:containerregistry/v20210601preview:PipelineRun" }, { type: "azure-nextgen:containerregistry/v20210601preview:PipelineRun" }, { type: "azure-native:containerregistry/v20210801preview:PipelineRun" }, { type: "azure-nextgen:containerregistry/v20210801preview:PipelineRun" }] };
