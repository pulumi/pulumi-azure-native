...
export class PipelineRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:containerregistry/v20201101preview:PipelineRun';
    ...
    constructor(name: string, args: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry:PipelineRun" }, { type: "azure-nextgen:containerregistry/v20191201preview:PipelineRun" }] };
