...
export class ExportPipeline extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExportPipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20201101preview:ExportPipeline" }, { type: "azure-native:containerregistry:ExportPipeline" }, { type: "azure-nextgen:containerregistry:ExportPipeline" }, { type: "azure-native:containerregistry/v20191201preview:ExportPipeline" }, { type: "azure-nextgen:containerregistry/v20191201preview:ExportPipeline" }] };
...
export interface ExportPipelineArgs {
     ...
     * The target properties of the export pipeline.
     */
    readonly target: pulumi.Input<inputs.containerregistry.v20201101preview.ExportPipelineTargetProperties>;
}
