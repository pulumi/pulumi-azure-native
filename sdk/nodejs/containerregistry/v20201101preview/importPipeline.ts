 ...
 *
 * const importPipeline = new azure_native.containerregistry.v20201101preview.ImportPipeline("importPipeline", {
 *     identity: {
 *         type: azure_native.containerregistry.v20201101preview.ResourceIdentityType.UserAssigned,
...
export class ImportPipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20201101preview:ImportPipeline';
     ...
     */
    public readonly source!: pulumi.Output<outputs.containerregistry.v20201101preview.ImportPipelineSourcePropertiesResponse>;
    /**
     ...
     */
    public readonly trigger!: pulumi.Output<outputs.containerregistry.v20201101preview.PipelineTriggerPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ImportPipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["source"] = args ? (args.source ? pulumi.output(args.source).apply(inputs.containerregistry.v20201101preview.importPipelineSourcePropertiesArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["trigger"] = args ? (args.trigger ? pulumi.output(args.trigger).apply(inputs.containerregistry.v20201101preview.pipelineTriggerPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry/v20191201preview:ImportPipeline" }, { type: "azure-native:containerregistry/v20210601preview:ImportPipeline" }, { type: "azure-native:containerregistry/v20210801preview:ImportPipeline" }, { type: "azure-native:containerregistry/v20211201preview:ImportPipeline" }, { type: "azure-native:containerregistry/v20220201preview:ImportPipeline" }, { type: "azure-native:containerregistry/v20230101preview:ImportPipeline" }] };
