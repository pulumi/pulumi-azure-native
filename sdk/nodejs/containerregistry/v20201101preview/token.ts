 ...
 *
 * const token = new azure_native.containerregistry.v20201101preview.Token("token", {
 *     credentials: {
 *         certificates: [{
...
export class Token extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TokenArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:Token" }, { type: "azure-native:containerregistry/v20190501preview:Token" }, { type: "azure-native:containerregistry/v20210601preview:Token" }, { type: "azure-native:containerregistry/v20210801preview:Token" }, { type: "azure-native:containerregistry/v20211201preview:Token" }, { type: "azure-native:containerregistry/v20220201preview:Token" }, { type: "azure-native:containerregistry/v20221201:Token" }, { type: "azure-native:containerregistry/v20230101preview:Token" }] };
