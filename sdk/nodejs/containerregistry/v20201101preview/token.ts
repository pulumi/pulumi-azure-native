...
export class Token extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20201101preview:Token';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.containerregistry.v20201101preview.TokenCredentialsPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: TokenArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20201101preview:Token" }, { type: "azure-native:containerregistry:Token" }, { type: "azure-nextgen:containerregistry:Token" }, { type: "azure-native:containerregistry/v20190501preview:Token" }, { type: "azure-nextgen:containerregistry/v20190501preview:Token" }, { type: "azure-native:containerregistry/v20210601preview:Token" }, { type: "azure-nextgen:containerregistry/v20210601preview:Token" }, { type: "azure-native:containerregistry/v20210801preview:Token" }, { type: "azure-nextgen:containerregistry/v20210801preview:Token" }] };
