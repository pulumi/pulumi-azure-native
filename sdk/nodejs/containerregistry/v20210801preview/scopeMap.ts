 ...
 *
 * @deprecated azure-native:containerregistry/v20210801preview:ScopeMap is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ScopeMap to guarantee forwards compatibility.
 */
export class ScopeMap extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScopeMap {
        pulumi.log.warn("ScopeMap is deprecated: azure-native:containerregistry/v20210801preview:ScopeMap is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ScopeMap to guarantee forwards compatibility.")
