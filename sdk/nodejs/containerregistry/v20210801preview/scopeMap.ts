...
export class ScopeMap extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ScopeMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20210801preview:ScopeMap" }, { type: "azure-native:containerregistry:ScopeMap" }, { type: "azure-nextgen:containerregistry:ScopeMap" }, { type: "azure-native:containerregistry/v20190501preview:ScopeMap" }, { type: "azure-nextgen:containerregistry/v20190501preview:ScopeMap" }, { type: "azure-native:containerregistry/v20201101preview:ScopeMap" }, { type: "azure-nextgen:containerregistry/v20201101preview:ScopeMap" }, { type: "azure-native:containerregistry/v20210601preview:ScopeMap" }, { type: "azure-nextgen:containerregistry/v20210601preview:ScopeMap" }] };
