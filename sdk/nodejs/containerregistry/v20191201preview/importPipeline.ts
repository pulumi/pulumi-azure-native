...
export class ImportPipeline extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ImportPipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20191201preview:ImportPipeline" }, { type: "azure-native:containerregistry:ImportPipeline" }, { type: "azure-nextgen:containerregistry:ImportPipeline" }, { type: "azure-native:containerregistry/v20201101preview:ImportPipeline" }, { type: "azure-nextgen:containerregistry/v20201101preview:ImportPipeline" }] };
...
export interface ImportPipelineArgs {
     ...
     * The source properties of the import pipeline.
     */
    readonly source: pulumi.Input<inputs.containerregistry.v20191201preview.ImportPipelineSourcePropertiesArgs>;
    /**
     * The properties that describe the trigger of the import pipeline.
     */
    readonly trigger?: pulumi.Input<inputs.containerregistry.v20191201preview.PipelineTriggerPropertiesArgs>;
}
