...
export function getImportPipeline(args: GetImportPipelineArgs, opts?: pulumi.InvokeOptions): Promise<GetImportPipelineResult> {
    pulumi.log.warn("getImportPipeline is deprecated: azure-native:containerregistry/v20191201preview:ImportPipeline is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ImportPipeline to guarantee forwards compatibility.")
