 ...
 *
 * @deprecated azure-native:containerregistry/v20191201preview:PipelineRun is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:PipelineRun to guarantee forwards compatibility.
 */
export class PipelineRun extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["request"] = args ? (args.request ? pulumi.output(args.request).apply(inputs.containerregistry.v20191201preview.pipelineRunRequestArgsProvideDefaults) : undefined) : undefined;
