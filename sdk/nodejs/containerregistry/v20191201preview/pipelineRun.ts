...
export class PipelineRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20191201preview:PipelineRun';
    ...
    constructor(name: string, args: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20191201preview:PipelineRun" }, { type: "azure-native:containerregistry:PipelineRun" }, { type: "azure-nextgen:containerregistry:PipelineRun" }, { type: "azure-native:containerregistry/v20201101preview:PipelineRun" }, { type: "azure-nextgen:containerregistry/v20201101preview:PipelineRun" }, { type: "azure-native:containerregistry/v20210601preview:PipelineRun" }, { type: "azure-nextgen:containerregistry/v20210601preview:PipelineRun" }, { type: "azure-native:containerregistry/v20210801preview:PipelineRun" }, { type: "azure-nextgen:containerregistry/v20210801preview:PipelineRun" }] };
...
export interface PipelineRunArgs {
     ...
     * The request parameters for a pipeline run.
     */
    request?: pulumi.Input<inputs.containerregistry.v20191201preview.PipelineRunRequestArgs>;
    /**
