...
export class ExportPipeline extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExportPipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20191201preview:ExportPipeline" }, { type: "azure-native:containerregistry:ExportPipeline" }, { type: "azure-nextgen:containerregistry:ExportPipeline" }, { type: "azure-native:containerregistry/v20201101preview:ExportPipeline" }, { type: "azure-nextgen:containerregistry/v20201101preview:ExportPipeline" }] };
...
export interface ExportPipelineArgs {
     ...
     * The list of all options configured for the pipeline.
     */
    readonly options?: pulumi.Input<pulumi.Input<string | enums.containerregistry.v20191201preview.PipelineOptions>[]>;
    /**
     ...
     * The target properties of the export pipeline.
     */
    readonly target: pulumi.Input<inputs.containerregistry.v20191201preview.ExportPipelineTargetPropertiesArgs>;
}
