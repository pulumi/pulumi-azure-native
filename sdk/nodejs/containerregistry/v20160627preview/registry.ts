 ...
 *
 * @deprecated Version 2016-06-27-preview will be removed in v2 of the provider.
 */
export class Registry extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Registry {
        pulumi.log.warn("Registry is deprecated: Version 2016-06-27-preview will be removed in v2 of the provider.")
