...
export interface GetPipelineRunResult {
     ...
     */
    readonly request?: outputs.containerregistry.v20231101preview.PipelineRunRequestResponse;
    /**
     * The response of a pipeline run.
     */
    readonly response: outputs.containerregistry.v20231101preview.PipelineRunResponseResponse;
    /**
...
export function getPipelineRunOutput(args: GetPipelineRunOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPipelineRunResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerregistry/v20231101preview:getPipelineRun", {
        "pipelineRunName": args.pipelineRunName,
        "registryName": args.registryName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
