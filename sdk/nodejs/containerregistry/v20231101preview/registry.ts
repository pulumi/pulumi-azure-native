...
export class Registry extends pulumi.CustomResource {
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.containerregistry.v20231101preview.EncryptionPropertyResponse | undefined>;
    /**
     ...
     */
    public readonly networkRuleSet!: pulumi.Output<outputs.containerregistry.v20231101preview.NetworkRuleSetResponse | undefined>;
    /**
     * The policies for a container registry.
     */
    public readonly policies!: pulumi.Output<outputs.containerregistry.v20231101preview.PoliciesResponse | undefined>;
    /**
     * List of private endpoint connections for a container registry.
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.containerregistry.v20231101preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.containerregistry.v20231101preview.SkuResponse>;
    /**
     * The status of the container registry at the time the operation was called.
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.containerregistry.v20231101preview.StatusResponse>;
    /**
    ...
    constructor(name: string, args: RegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkRuleSet"] = args ? (args.networkRuleSet ? pulumi.output(args.networkRuleSet).apply(inputs.containerregistry.v20231101preview.networkRuleSetArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["policies"] = args ? (args.policies ? pulumi.output(args.policies).apply(inputs.containerregistry.v20231101preview.policiesArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryArgs {
     ...
     * The encryption settings of container registry.
     */
    encryption?: pulumi.Input<inputs.containerregistry.v20231101preview.EncryptionPropertyArgs>;
    /**
     * The identity of the container registry.
     */
     ...
     * Determines whether registry artifacts are indexed for metadata search.
     */
    metadataSearch?: pulumi.Input<string | enums.containerregistry.v20231101preview.MetadataSearch>;
    /**
     * Whether to allow trusted Azure services to access a network restricted registry.
     */
    networkRuleBypassOptions?: pulumi.Input<string | enums.containerregistry.v20231101preview.NetworkRuleBypassOptions>;
    /**
     * The network rule set for a container registry.
     */
    networkRuleSet?: pulumi.Input<inputs.containerregistry.v20231101preview.NetworkRuleSetArgs>;
    /**
     * The policies for a container registry.
     */
    policies?: pulumi.Input<inputs.containerregistry.v20231101preview.PoliciesArgs>;
    /**
     * Whether or not public network access is allowed for the container registry.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.containerregistry.v20231101preview.PublicNetworkAccess>;
    /**
     ...
     * The SKU of the container registry.
     */
    sku: pulumi.Input<inputs.containerregistry.v20231101preview.SkuArgs>;
    /**
     * The tags of the resource.
     */
     ...
     * Whether or not zone redundancy is enabled for this container registry
     */
    zoneRedundancy?: pulumi.Input<string | enums.containerregistry.v20231101preview.ZoneRedundancy>;
}
