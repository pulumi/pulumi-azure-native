...
export class ConnectedRegistry extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly activation!: pulumi.Output<outputs.containerregistry.v20231101preview.ActivationPropertiesResponse>;
    /**
     ...
     */
    public readonly logging!: pulumi.Output<outputs.containerregistry.v20231101preview.LoggingPropertiesResponse | undefined>;
    /**
     * The login server properties of the connected registry.
     */
    public /*out*/ readonly loginServer!: pulumi.Output<outputs.containerregistry.v20231101preview.LoginServerPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly parent!: pulumi.Output<outputs.containerregistry.v20231101preview.ParentPropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly statusDetails!: pulumi.Output<outputs.containerregistry.v20231101preview.StatusDetailPropertiesResponse[]>;
    /**
    ...
    constructor(name: string, args: ConnectedRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["logging"] = args ? (args.logging ? pulumi.output(args.logging).apply(inputs.containerregistry.v20231101preview.loggingPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface ConnectedRegistryArgs {
     ...
     * The logging properties of the connected registry.
     */
    logging?: pulumi.Input<inputs.containerregistry.v20231101preview.LoggingPropertiesArgs>;
    /**
     * The mode of the connected registry resource that indicates the permissions of the registry.
     */
    mode: pulumi.Input<string | enums.containerregistry.v20231101preview.ConnectedRegistryMode>;
    /**
     * The list of notifications subscription information for the connected registry.
     */
     ...
     * The parent of the connected registry.
     */
    parent: pulumi.Input<inputs.containerregistry.v20231101preview.ParentPropertiesArgs>;
    /**
