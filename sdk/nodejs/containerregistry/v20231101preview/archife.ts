...
export class Archife extends pulumi.CustomResource {
     ...
     */
    public readonly packageSource!: pulumi.Output<outputs.containerregistry.v20231101preview.ArchivePackageSourcePropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ArchifeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:Archife" }, { type: "azure-native:containerregistry/v20230601preview:Archife" }, { type: "azure-native:containerregistry/v20230801preview:Archife" }, { type: "azure-native:containerregistry/v20241101preview:Archife" }] };
