...
export class PipelineRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20231101preview:PipelineRun';
     ...
     */
    public readonly request!: pulumi.Output<outputs.containerregistry.v20231101preview.PipelineRunRequestResponse | undefined>;
    /**
     * The response of a pipeline run.
     */
    public /*out*/ readonly response!: pulumi.Output<outputs.containerregistry.v20231101preview.PipelineRunResponseResponse>;
    /**
    ...
    constructor(name: string, args: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["request"] = args ? (args.request ? pulumi.output(args.request).apply(inputs.containerregistry.v20231101preview.pipelineRunRequestArgsProvideDefaults) : undefined) : undefined;
...
export interface PipelineRunArgs {
     ...
     * The request parameters for a pipeline run.
     */
    request?: pulumi.Input<inputs.containerregistry.v20231101preview.PipelineRunRequestArgs>;
    /**
