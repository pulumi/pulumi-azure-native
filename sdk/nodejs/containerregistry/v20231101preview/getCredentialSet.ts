...
export function getCredentialSet(args: GetCredentialSetArgs, opts?: pulumi.InvokeOptions): Promise<GetCredentialSetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerregistry/v20231101preview:getCredentialSet", {
...
export interface GetCredentialSetResult {
     ...
     */
    readonly authCredentials?: outputs.containerregistry.v20231101preview.AuthCredentialResponse[];
    /**
     ...
     */
    readonly identity?: outputs.containerregistry.v20231101preview.IdentityPropertiesResponse;
    /**
     ...
     */
    readonly systemData: outputs.containerregistry.v20231101preview.SystemDataResponse;
    /**
...
export function getCredentialSetOutput(args: GetCredentialSetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCredentialSetResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerregistry/v20231101preview:getCredentialSet", {
        "credentialSetName": args.credentialSetName,
        "registryName": args.registryName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
