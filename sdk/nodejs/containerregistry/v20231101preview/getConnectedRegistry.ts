...
export interface GetConnectedRegistryResult {
     ...
     */
    readonly activation: outputs.containerregistry.v20231101preview.ActivationPropertiesResponse;
    /**
     ...
     */
    readonly logging?: outputs.containerregistry.v20231101preview.LoggingPropertiesResponse;
    /**
     * The login server properties of the connected registry.
     */
    readonly loginServer?: outputs.containerregistry.v20231101preview.LoginServerPropertiesResponse;
    /**
     ...
     */
    readonly parent: outputs.containerregistry.v20231101preview.ParentPropertiesResponse;
    /**
     ...
     */
    readonly statusDetails: outputs.containerregistry.v20231101preview.StatusDetailPropertiesResponse[];
    /**
...
export function getConnectedRegistryOutput(args: GetConnectedRegistryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConnectedRegistryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:containerregistry/v20231101preview:getConnectedRegistry", {
        "connectedRegistryName": args.connectedRegistryName,
        "registryName": args.registryName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
