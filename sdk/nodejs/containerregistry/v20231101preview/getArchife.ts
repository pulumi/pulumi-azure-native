...
export function getArchife(args: GetArchifeArgs, opts?: pulumi.InvokeOptions): Promise<GetArchifeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerregistry/v20231101preview:getArchife", {
...
export interface GetArchifeResult {
     ...
     */
    readonly packageSource?: outputs.containerregistry.v20231101preview.ArchivePackageSourcePropertiesResponse;
    /**
