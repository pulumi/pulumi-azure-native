...
export function listWebhookEvents(args: ListWebhookEventsArgs, opts?: pulumi.InvokeOptions): Promise<ListWebhookEventsResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:containerregistry/v20170601preview:listWebhookEvents", {
...
export interface ListWebhookEventsResult {
     ...
     */
    readonly value?: outputs.containerregistry.v20170601preview.EventInvokeResponse[];
}
