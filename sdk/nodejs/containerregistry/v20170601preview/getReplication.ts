...
export function getReplication(args: GetReplicationArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:containerregistry/v20170601preview:getReplication", {
...
export interface GetReplicationResult {
     ...
     */
    readonly status: outputs.containerregistry.v20170601preview.StatusInvokeResponse;
    /**
