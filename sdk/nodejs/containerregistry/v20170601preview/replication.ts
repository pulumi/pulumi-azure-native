...
export class Replication extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ReplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/latest:Replication" }, { type: "azurerm:containerregistry/preview:Replication" }, { type: "azurerm:containerregistry/v20171001:Replication" }, { type: "azurerm:containerregistry/v20190501:Replication" }, { type: "azurerm:containerregistry/v20191201preview:Replication" }] };
