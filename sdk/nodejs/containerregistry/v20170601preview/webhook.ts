 ...
 *
 * const webhook = new azurerm.containerregistry.v20170601preview.Webhook("webhook", {
 *     actions: ["push"],
 *     customHeaders: {
...
export class Webhook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerregistry/v20170601preview:Webhook';
    ...
    constructor(name: string, args: WebhookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerregistry/latest:Webhook" }, { type: "azurerm:containerregistry/v20171001:Webhook" }, { type: "azurerm:containerregistry/v20190501:Webhook" }, { type: "azurerm:containerregistry/v20191201preview:Webhook" }] };
