...
export function listRegistryCredentials(args: ListRegistryCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<ListRegistryCredentialsResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:containerregistry/v20170601preview:listRegistryCredentials", {
...
export interface ListRegistryCredentialsResult {
     ...
     */
    readonly passwords?: outputs.containerregistry.v20170601preview.RegistryPasswordInvokeResponse[];
    /**
