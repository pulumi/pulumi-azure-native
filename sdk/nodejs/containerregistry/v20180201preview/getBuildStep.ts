...
export function getBuildStep(args: GetBuildStepArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildStepResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerregistry/v20180201preview:getBuildStep", {
...
export interface GetBuildStepResult {
     ...
     */
    readonly properties: outputs.containerregistry.v20180201preview.BuildStepPropertiesResponse;
    /**
