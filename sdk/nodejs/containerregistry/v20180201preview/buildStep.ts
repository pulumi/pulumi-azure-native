...
export class BuildStep extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BuildStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20180201preview:BuildStep" }, { type: "azure-native:containerregistry:BuildStep" }, { type: "azure-nextgen:containerregistry:BuildStep" }] };
