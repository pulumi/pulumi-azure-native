...
export class ExportPipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:containerregistry:ExportPipeline';
    ...
    constructor(name: string, args: ExportPipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/v20191201preview:ExportPipeline" }, { type: "azure-nextgen:containerregistry/v20201101preview:ExportPipeline" }] };
