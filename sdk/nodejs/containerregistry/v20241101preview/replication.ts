...
export class Replication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20241101preview:Replication';
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.containerregistry.v20241101preview.StatusResponse>;
    /**
...
export interface ReplicationArgs {
     ...
     * Whether or not zone redundancy is enabled for this container registry replication
     */
    zoneRedundancy?: pulumi.Input<string | enums.containerregistry.v20241101preview.ZoneRedundancy>;
}
