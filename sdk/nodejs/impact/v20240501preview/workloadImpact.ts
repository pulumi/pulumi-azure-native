...
export class WorkloadImpact extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:impact/v20240501preview:WorkloadImpact';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.impact.v20240501preview.WorkloadImpactPropertiesResponse>;
    /**
...
export interface WorkloadImpactArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.impact.v20240501preview.WorkloadImpactPropertiesArgs>;
    /**
