...
export class DiscoverySource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dependencymap/v20250131preview:DiscoverySource';
    ...
    constructor(name: string, args: DiscoverySourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dependencymap:DiscoverySource" }] };
