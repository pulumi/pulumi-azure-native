...
// Export enums:
export * from "../../types/enums/devopsinfrastructure/v20241019";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:devopsinfrastructure/v20241019:Pool":
...
pulumi.runtime.registerResourceModule("azure-native", "devopsinfrastructure/v20241019", _module)
