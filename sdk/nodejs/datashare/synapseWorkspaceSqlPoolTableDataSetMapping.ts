...
export class SynapseWorkspaceSqlPoolTableDataSetMapping extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.SynapseWorkspaceSqlPoolTableDataSetMappingPropertiesResponse>;
    /**
...
export interface SynapseWorkspaceSqlPoolTableDataSetMappingArgs {
     ...
     * A Synapse Workspace Sql Pool Table data set mapping properties.
     */
    properties: pulumi.Input<inputs.datashare.SynapseWorkspaceSqlPoolTableDataSetMappingPropertiesArgs>;
    /**
