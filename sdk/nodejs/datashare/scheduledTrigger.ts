...
export class ScheduledTrigger extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.ScheduledTriggerPropertiesResponse>;
    /**
...
export interface ScheduledTriggerArgs {
     ...
     * Properties of scheduled synchronization
     */
    properties: pulumi.Input<inputs.datashare.ScheduledTriggerPropertiesArgs>;
    /**
