...
export class KustoTableDataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KustoTableDataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare:KustoTableDataSetMapping" }, { type: "azure-native:datashare/v20181101preview:KustoTableDataSetMapping" }, { type: "azure-nextgen:datashare/v20181101preview:KustoTableDataSetMapping" }, { type: "azure-native:datashare/v20191101:KustoTableDataSetMapping" }, { type: "azure-nextgen:datashare/v20191101:KustoTableDataSetMapping" }, { type: "azure-native:datashare/v20200901:KustoTableDataSetMapping" }, { type: "azure-nextgen:datashare/v20200901:KustoTableDataSetMapping" }, { type: "azure-native:datashare/v20201001preview:KustoTableDataSetMapping" }, { type: "azure-nextgen:datashare/v20201001preview:KustoTableDataSetMapping" }, { type: "azure-native:datashare/v20210801:KustoTableDataSetMapping" }, { type: "azure-nextgen:datashare/v20210801:KustoTableDataSetMapping" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(KustoTableDataSetMapping.__pulumiType, name, inputs, opts);
    }
}
