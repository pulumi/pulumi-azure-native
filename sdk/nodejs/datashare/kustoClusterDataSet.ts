...
export class KustoClusterDataSet extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.KustoClusterDataSetPropertiesResponse>;
    /**
...
export interface KustoClusterDataSetArgs {
     ...
     * Kusto cluster data set properties.
     */
    properties: pulumi.Input<inputs.datashare.KustoClusterDataSetPropertiesArgs>;
    /**
