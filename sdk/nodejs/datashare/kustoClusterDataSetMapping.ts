...
export class KustoClusterDataSetMapping extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.KustoClusterDataSetMappingPropertiesResponse>;
    /**
...
export interface KustoClusterDataSetMappingArgs {
     ...
     * Kusto cluster data set mapping properties.
     */
    properties: pulumi.Input<inputs.datashare.KustoClusterDataSetMappingPropertiesArgs>;
    /**
