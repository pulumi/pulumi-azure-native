...
export class BlobContainerDataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobContainerDataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare/v20200901:BlobContainerDataSetMapping" }, { type: "azure-native:datashare/v20201001preview:BlobContainerDataSetMapping" }, { type: "azure-native:datashare/v20210801:BlobContainerDataSetMapping" }] };
