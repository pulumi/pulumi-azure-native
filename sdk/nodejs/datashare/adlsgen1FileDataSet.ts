...
export class ADLSGen1FileDataSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ADLSGen1FileDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare/v20200901:ADLSGen1FileDataSet" }, { type: "azure-native:datashare/v20201001preview:ADLSGen1FileDataSet" }, { type: "azure-native:datashare/v20210801:ADLSGen1FileDataSet" }] };
