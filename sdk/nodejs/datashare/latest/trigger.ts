...
export class Trigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Trigger {
        pulumi.log.warn("Trigger is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:datashare:Trigger'.")
    ...
    constructor(name: string, args: TriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare:Trigger" }, { type: "azure-nextgen:datashare/v20181101preview:Trigger" }, { type: "azure-nextgen:datashare/v20191101:Trigger" }, { type: "azure-nextgen:datashare/v20200901:Trigger" }, { type: "azure-nextgen:datashare/v20201001preview:Trigger" }] };
