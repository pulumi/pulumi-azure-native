...
export class Trigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Trigger {
        pulumi.log.warn("Trigger is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datashare:Trigger'.")
        return new Trigger(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/latest:Trigger';
    ...
    constructor(name: string, args: TriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/latest:Trigger" }, { type: "azure-native:datashare:Trigger" }, { type: "azure-nextgen:datashare:Trigger" }, { type: "azure-native:datashare/v20181101preview:Trigger" }, { type: "azure-nextgen:datashare/v20181101preview:Trigger" }, { type: "azure-native:datashare/v20191101:Trigger" }, { type: "azure-nextgen:datashare/v20191101:Trigger" }, { type: "azure-native:datashare/v20200901:Trigger" }, { type: "azure-nextgen:datashare/v20200901:Trigger" }, { type: "azure-native:datashare/v20201001preview:Trigger" }, { type: "azure-nextgen:datashare/v20201001preview:Trigger" }] };
