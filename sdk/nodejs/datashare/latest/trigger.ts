 ...
 *
 * const trigger = new azurerm.datashare.latest.Trigger("trigger", {
...
export class Trigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Trigger {
        return new Trigger(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/latest:Trigger';
    ...
    constructor(name: string, argsOrState?: TriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/v20191101:Trigger" }] };
