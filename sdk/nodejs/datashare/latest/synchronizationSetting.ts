...
export class SynchronizationSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SynchronizationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/preview:SynchronizationSetting" }, { type: "azurerm:datashare/v20181101preview:SynchronizationSetting" }, { type: "azurerm:datashare/v20191101:SynchronizationSetting" }] };
