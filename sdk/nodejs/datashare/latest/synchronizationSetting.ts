...
export class SynchronizationSetting extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SynchronizationSetting {
        pulumi.log.warn("SynchronizationSetting is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datashare:SynchronizationSetting'.")
        return new SynchronizationSetting(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/latest:SynchronizationSetting';
...
export interface SynchronizationSettingArgs {
     ...
     * Kind of synchronization setting.
     */
    readonly kind: pulumi.Input<string | enums.datashare.latest.SynchronizationSettingKind>;
    /**
