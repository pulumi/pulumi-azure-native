...
export class Share extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/latest:Share';
    ...
    constructor(name: string, args: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/latest:Share" }, { type: "azure-native:datashare:Share" }, { type: "azure-nextgen:datashare:Share" }, { type: "azure-native:datashare/v20181101preview:Share" }, { type: "azure-nextgen:datashare/v20181101preview:Share" }, { type: "azure-native:datashare/v20191101:Share" }, { type: "azure-nextgen:datashare/v20191101:Share" }, { type: "azure-native:datashare/v20200901:Share" }, { type: "azure-nextgen:datashare/v20200901:Share" }, { type: "azure-native:datashare/v20201001preview:Share" }, { type: "azure-nextgen:datashare/v20201001preview:Share" }] };
