...
export class Invitation extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: InvitationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/preview:Invitation" }, { type: "azurerm:datashare/v20181101preview:Invitation" }, { type: "azurerm:datashare/v20191101:Invitation" }] };
