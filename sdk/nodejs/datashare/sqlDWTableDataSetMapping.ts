...
export class SqlDWTableDataSetMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare:SqlDWTableDataSetMapping';
     ...
     */
    declare public readonly dataWarehouseName: pulumi.Output<string>;
    /**
     * Kind of data set mapping.
     * Expected value is 'SqlDWTable'.
     */
    declare public readonly kind: pulumi.Output<"SqlDWTable">;
    /**
    ...
    constructor(name: string, args: SqlDWTableDataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dataWarehouseName"] = args?.dataWarehouseName;
