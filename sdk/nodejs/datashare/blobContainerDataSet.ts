...
export class BlobContainerDataSet extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.BlobContainerPropertiesResponse>;
    /**
...
export interface BlobContainerDataSetArgs {
     ...
     * Blob container data set properties.
     */
    properties: pulumi.Input<inputs.datashare.BlobContainerPropertiesArgs>;
    /**
