...
export class KustoTableDataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KustoTableDataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:KustoTableDataSetMapping" }, { type: "azure-native:datashare/v20200901:KustoTableDataSetMapping" }, { type: "azure-native:datashare/v20201001preview:KustoTableDataSetMapping" }] };
