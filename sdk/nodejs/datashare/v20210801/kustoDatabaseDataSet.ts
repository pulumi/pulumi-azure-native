...
export class KustoDatabaseDataSet extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.v20210801.KustoDatabaseDataSetPropertiesResponse>;
    /**
...
export interface KustoDatabaseDataSetArgs {
     ...
     * Kusto database data set properties.
     */
    properties: pulumi.Input<inputs.datashare.v20210801.KustoDatabaseDataSetPropertiesArgs>;
    /**
