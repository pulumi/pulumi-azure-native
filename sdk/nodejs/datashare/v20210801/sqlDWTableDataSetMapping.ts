...
export class SqlDWTableDataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlDWTableDataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:SqlDWTableDataSetMapping" }, { type: "azure-native:datashare/v20200901:SqlDWTableDataSetMapping" }, { type: "azure-native:datashare/v20201001preview:SqlDWTableDataSetMapping" }] };
