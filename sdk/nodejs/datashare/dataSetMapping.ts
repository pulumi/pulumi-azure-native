...
export class DataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare/latest:DataSetMapping" }, { type: "azure-nextgen:datashare/latest:DataSetMapping" }, { type: "azure-native:datashare/v20181101preview:DataSetMapping" }, { type: "azure-nextgen:datashare/v20181101preview:DataSetMapping" }, { type: "azure-native:datashare/v20191101:DataSetMapping" }, { type: "azure-nextgen:datashare/v20191101:DataSetMapping" }, { type: "azure-native:datashare/v20200901:DataSetMapping" }, { type: "azure-nextgen:datashare/v20200901:DataSetMapping" }, { type: "azure-native:datashare/v20201001preview:DataSetMapping" }, { type: "azure-nextgen:datashare/v20201001preview:DataSetMapping" }] };
