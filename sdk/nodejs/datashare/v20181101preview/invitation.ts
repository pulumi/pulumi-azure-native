...
export class Invitation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Invitation {
        return new Invitation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/v20181101preview:Invitation';
    ...
    constructor(name: string, argsOrState?: InvitationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:Invitation" }, { type: "azurerm:datashare/preview:Invitation" }, { type: "azurerm:datashare/v20191101:Invitation" }] };
