...
export class SqlDBTableDataSetMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlDBTableDataSetMapping {
        pulumi.log.warn("SqlDBTableDataSetMapping is deprecated: azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSetMapping to guarantee forwards compatibility.")
