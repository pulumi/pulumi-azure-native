...
export class SqlDBTableDataSetMapping extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.v20181101preview.SqlDBTableDataSetMappingPropertiesResponse>;
    /**
...
export interface SqlDBTableDataSetMappingArgs {
     ...
     * Sql DB data set mapping properties.
     */
    properties: pulumi.Input<inputs.datashare.v20181101preview.SqlDBTableDataSetMappingPropertiesArgs>;
    /**
