...
export class SqlDBTableDataSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/v20181101preview:SqlDBTableDataSet';
    ...
    constructor(name: string, args: SqlDBTableDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/v20181101preview:SqlDBTableDataSet" }, { type: "azure-native:datashare:SqlDBTableDataSet" }, { type: "azure-nextgen:datashare:SqlDBTableDataSet" }, { type: "azure-native:datashare/v20191101:SqlDBTableDataSet" }, { type: "azure-nextgen:datashare/v20191101:SqlDBTableDataSet" }, { type: "azure-native:datashare/v20200901:SqlDBTableDataSet" }, { type: "azure-nextgen:datashare/v20200901:SqlDBTableDataSet" }, { type: "azure-native:datashare/v20201001preview:SqlDBTableDataSet" }, { type: "azure-nextgen:datashare/v20201001preview:SqlDBTableDataSet" }, { type: "azure-native:datashare/v20210801:SqlDBTableDataSet" }, { type: "azure-nextgen:datashare/v20210801:SqlDBTableDataSet" }] };
