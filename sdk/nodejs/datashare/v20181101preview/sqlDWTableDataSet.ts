 ...
 *
 * @deprecated azure-native:datashare/v20181101preview:SqlDWTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDWTableDataSet to guarantee forwards compatibility.
 */
export class SqlDWTableDataSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlDWTableDataSet {
        pulumi.log.warn("SqlDWTableDataSet is deprecated: azure-native:datashare/v20181101preview:SqlDWTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDWTableDataSet to guarantee forwards compatibility.")
