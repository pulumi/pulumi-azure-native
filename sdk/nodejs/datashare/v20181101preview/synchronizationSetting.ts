 ...
 *
 * const synchronizationSetting = new azurerm.datashare.v20181101preview.SynchronizationSetting("synchronizationSetting", {
...
export class SynchronizationSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/v20181101preview:SynchronizationSetting';
    ...
    constructor(name: string, args: SynchronizationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:SynchronizationSetting" }, { type: "azurerm:datashare/v20191101:SynchronizationSetting" }] };
