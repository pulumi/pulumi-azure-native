...
export class SynchronizationSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SynchronizationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/v20181101preview:SynchronizationSetting" }, { type: "azure-native:datashare:SynchronizationSetting" }, { type: "azure-nextgen:datashare:SynchronizationSetting" }, { type: "azure-native:datashare/latest:SynchronizationSetting" }, { type: "azure-nextgen:datashare/latest:SynchronizationSetting" }, { type: "azure-native:datashare/v20191101:SynchronizationSetting" }, { type: "azure-nextgen:datashare/v20191101:SynchronizationSetting" }, { type: "azure-native:datashare/v20200901:SynchronizationSetting" }, { type: "azure-nextgen:datashare/v20200901:SynchronizationSetting" }, { type: "azure-native:datashare/v20201001preview:SynchronizationSetting" }, { type: "azure-nextgen:datashare/v20201001preview:SynchronizationSetting" }] };
...
export interface SynchronizationSettingArgs {
     ...
     * Kind of synchronization setting.
     */
    readonly kind: pulumi.Input<string | enums.datashare.v20181101preview.SynchronizationSettingKind>;
    /**
