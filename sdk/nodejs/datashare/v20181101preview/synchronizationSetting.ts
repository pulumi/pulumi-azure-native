...
export class SynchronizationSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SynchronizationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:SynchronizationSetting" }, { type: "azurerm:datashare/preview:SynchronizationSetting" }, { type: "azurerm:datashare/v20191101:SynchronizationSetting" }] };
