 ...
 *
 * @deprecated azure-native:datashare/v20181101preview:ScheduledSynchronizationSetting is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ScheduledSynchronizationSetting to guarantee forwards compatibility.
 */
export class ScheduledSynchronizationSetting extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScheduledSynchronizationSetting {
        pulumi.log.warn("ScheduledSynchronizationSetting is deprecated: azure-native:datashare/v20181101preview:ScheduledSynchronizationSetting is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ScheduledSynchronizationSetting to guarantee forwards compatibility.")
