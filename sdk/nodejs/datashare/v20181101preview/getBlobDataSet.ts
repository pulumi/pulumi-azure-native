 ...
 */
/** @deprecated azure-native:datashare/v20181101preview:BlobDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility. */
export function getBlobDataSet(args: GetBlobDataSetArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobDataSetResult> {
    pulumi.log.warn("getBlobDataSet is deprecated: azure-native:datashare/v20181101preview:BlobDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility.")
