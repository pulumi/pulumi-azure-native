...
export class SynapseWorkspaceSqlPoolTableDataSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SynapseWorkspaceSqlPoolTableDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet" }, { type: "azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSet" }, { type: "azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet" }] };
