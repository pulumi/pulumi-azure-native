 ...
 *
 * @deprecated azure-native:datashare/v20191101:ADLSGen2FolderDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FolderDataSet to guarantee forwards compatibility.
 */
export class ADLSGen2FolderDataSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ADLSGen2FolderDataSet {
        pulumi.log.warn("ADLSGen2FolderDataSet is deprecated: azure-native:datashare/v20191101:ADLSGen2FolderDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FolderDataSet to guarantee forwards compatibility.")
