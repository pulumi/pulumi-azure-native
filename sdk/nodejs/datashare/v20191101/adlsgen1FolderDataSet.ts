...
export class ADLSGen1FolderDataSet extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.v20191101.ADLSGen1FolderPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ADLSGen1FolderDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:ADLSGen1FolderDataSet" }, { type: "azure-native:datashare/v20181101preview:ADLSGen1FolderDataSet" }, { type: "azure-native:datashare/v20200901:ADLSGen1FolderDataSet" }, { type: "azure-native:datashare/v20201001preview:ADLSGen1FolderDataSet" }, { type: "azure-native:datashare/v20210801:ADLSGen1FolderDataSet" }] };
...
export interface ADLSGen1FolderDataSetArgs {
     ...
     * ADLS Gen 1 folder data set properties.
     */
    properties: pulumi.Input<inputs.datashare.v20191101.ADLSGen1FolderPropertiesArgs>;
    /**
