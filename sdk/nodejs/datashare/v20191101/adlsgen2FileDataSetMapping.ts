...
export class ADLSGen2FileDataSetMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ADLSGen2FileDataSetMapping {
        pulumi.log.warn("ADLSGen2FileDataSetMapping is deprecated: azure-native:datashare/v20191101:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.")
