 ...
 */
/** @deprecated azure-native:datashare/v20191101:BlobDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobDataSetMapping to guarantee forwards compatibility. */
export function getBlobDataSetMapping(args: GetBlobDataSetMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobDataSetMappingResult> {
    pulumi.log.warn("getBlobDataSetMapping is deprecated: azure-native:datashare/v20191101:BlobDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobDataSetMapping to guarantee forwards compatibility.")
