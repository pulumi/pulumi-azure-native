...
export class DataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:DataSetMapping" }, { type: "azurerm:datashare/preview:DataSetMapping" }, { type: "azurerm:datashare/v20181101preview:DataSetMapping" }] };
