...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/latest:Account" }, { type: "azure-nextgen:datashare/v20181101preview:Account" }, { type: "azure-nextgen:datashare/v20200901:Account" }] };
