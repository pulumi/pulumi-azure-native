...
export function getSqlDWTableDataSetMapping(args: GetSqlDWTableDataSetMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlDWTableDataSetMappingResult> {
    pulumi.log.warn("getSqlDWTableDataSetMapping is deprecated: azure-native:datashare/v20191101:SqlDWTableDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDWTableDataSetMapping to guarantee forwards compatibility.")
