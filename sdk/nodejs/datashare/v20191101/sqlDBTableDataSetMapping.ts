 ...
 *
 * @deprecated azure-native:datashare/v20191101:SqlDBTableDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDBTableDataSetMapping to guarantee forwards compatibility.
 */
export class SqlDBTableDataSetMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlDBTableDataSetMapping {
        pulumi.log.warn("SqlDBTableDataSetMapping is deprecated: azure-native:datashare/v20191101:SqlDBTableDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDBTableDataSetMapping to guarantee forwards compatibility.")
        return new SqlDBTableDataSetMapping(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/v20191101:SqlDBTableDataSetMapping';
