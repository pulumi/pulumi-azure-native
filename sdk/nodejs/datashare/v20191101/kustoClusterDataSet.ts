...
export class KustoClusterDataSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KustoClusterDataSet {
        pulumi.log.warn("KustoClusterDataSet is deprecated: azure-native:datashare/v20191101:KustoClusterDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.")
