...
export class SynchronizationSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SynchronizationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/latest:SynchronizationSetting" }, { type: "azure-nextgen:datashare/v20181101preview:SynchronizationSetting" }, { type: "azure-nextgen:datashare/v20200901:SynchronizationSetting" }, { type: "azure-nextgen:datashare/v20201001preview:SynchronizationSetting" }] };
