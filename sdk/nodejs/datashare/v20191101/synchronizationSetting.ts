 ...
 *
 * const synchronizationSetting = new azurerm.datashare.v20191101.SynchronizationSetting("synchronizationSetting", {
...
export class SynchronizationSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/v20191101:SynchronizationSetting';
    ...
    constructor(name: string, argsOrState?: SynchronizationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:SynchronizationSetting" }] };
