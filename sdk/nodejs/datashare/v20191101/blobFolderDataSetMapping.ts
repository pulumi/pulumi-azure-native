...
export class BlobFolderDataSetMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobFolderDataSetMapping {
        pulumi.log.warn("BlobFolderDataSetMapping is deprecated: azure-native:datashare/v20191101:BlobFolderDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobFolderDataSetMapping to guarantee forwards compatibility.")
