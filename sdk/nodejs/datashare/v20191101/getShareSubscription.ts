...
export function getShareSubscription(args: GetShareSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetShareSubscriptionResult> {
    pulumi.log.warn("getShareSubscription is deprecated: Version v20191101 will be removed in the next major version of the provider. Upgrade to version v20200901 or later.")
    if (!opts) {
        opts = {}
    }
