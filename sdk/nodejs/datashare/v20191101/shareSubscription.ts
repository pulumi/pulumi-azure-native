...
export class ShareSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ShareSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:ShareSubscription" }, { type: "azurerm:datashare/preview:ShareSubscription" }, { type: "azurerm:datashare/v20181101preview:ShareSubscription" }] };
