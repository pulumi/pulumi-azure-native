...
export class ShareSubscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ShareSubscription {
        pulumi.log.warn("ShareSubscription is deprecated: Version 2019-11-01 will be removed in v2 of the provider.")
    ...
    constructor(name: string, args: ShareSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:ShareSubscription" }, { type: "azure-native:datashare/v20181101preview:ShareSubscription" }, { type: "azure-native:datashare/v20200901:ShareSubscription" }, { type: "azure-native:datashare/v20201001preview:ShareSubscription" }, { type: "azure-native:datashare/v20210801:ShareSubscription" }] };
...
export interface ShareSubscriptionArgs {
     ...
     * Properties on the share subscription
     */
    properties: pulumi.Input<inputs.datashare.v20191101.ShareSubscriptionPropertiesArgs>;
    /**
