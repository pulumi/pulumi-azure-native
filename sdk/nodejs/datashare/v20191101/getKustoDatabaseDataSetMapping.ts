 ...
 */
/** @deprecated azure-native:datashare/v20191101:KustoDatabaseDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:KustoDatabaseDataSetMapping to guarantee forwards compatibility. */
export function getKustoDatabaseDataSetMapping(args: GetKustoDatabaseDataSetMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetKustoDatabaseDataSetMappingResult> {
    pulumi.log.warn("getKustoDatabaseDataSetMapping is deprecated: azure-native:datashare/v20191101:KustoDatabaseDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:KustoDatabaseDataSetMapping to guarantee forwards compatibility.")
