...
export function getBlobContainerDataSetMapping(args: GetBlobContainerDataSetMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerDataSetMappingResult> {
    pulumi.log.warn("getBlobContainerDataSetMapping is deprecated: azure-native:datashare/v20191101:BlobContainerDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobContainerDataSetMapping to guarantee forwards compatibility.")
