 ...
 *
 * const share = new azurerm.datashare.v20191101.Share("share", {
...
export class Share extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/v20191101:Share';
    ...
    constructor(name: string, args: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:Share" }, { type: "azurerm:datashare/v20181101preview:Share" }] };
