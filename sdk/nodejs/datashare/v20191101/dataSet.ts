...
export class DataSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/latest:DataSet" }, { type: "azure-nextgen:datashare/v20181101preview:DataSet" }, { type: "azure-nextgen:datashare/v20200901:DataSet" }] };
