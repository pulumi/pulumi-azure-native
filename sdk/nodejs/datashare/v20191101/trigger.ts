...
export class Trigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/v20191101:Trigger';
    ...
    constructor(name: string, args: TriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:Trigger" }, { type: "azurerm:datashare/preview:Trigger" }, { type: "azurerm:datashare/v20181101preview:Trigger" }] };
