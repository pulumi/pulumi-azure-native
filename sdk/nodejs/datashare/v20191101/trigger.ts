...
export class Trigger extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/latest:Trigger" }, { type: "azure-nextgen:datashare/v20181101preview:Trigger" }, { type: "azure-nextgen:datashare/v20200901:Trigger" }] };
