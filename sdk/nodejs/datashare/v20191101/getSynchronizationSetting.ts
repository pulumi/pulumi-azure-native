...
export function getSynchronizationSetting(args: GetSynchronizationSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetSynchronizationSettingResult> {
    pulumi.log.warn("getSynchronizationSetting is deprecated: Version v20191101 will be removed in the next major version of the provider. Upgrade to version v20200901 or later.")
    if (!opts) {
        opts = {}
    }
