 ...
 *
 * @deprecated azure-native:datashare/v20191101:BlobContainerDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobContainerDataSetMapping to guarantee forwards compatibility.
 */
export class BlobContainerDataSetMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobContainerDataSetMapping {
        pulumi.log.warn("BlobContainerDataSetMapping is deprecated: azure-native:datashare/v20191101:BlobContainerDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobContainerDataSetMapping to guarantee forwards compatibility.")
