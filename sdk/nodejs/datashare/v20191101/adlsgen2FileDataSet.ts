...
export class ADLSGen2FileDataSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ADLSGen2FileDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/v20191101:ADLSGen2FileDataSet" }, { type: "azure-native:datashare:ADLSGen2FileDataSet" }, { type: "azure-nextgen:datashare:ADLSGen2FileDataSet" }, { type: "azure-native:datashare/v20181101preview:ADLSGen2FileDataSet" }, { type: "azure-nextgen:datashare/v20181101preview:ADLSGen2FileDataSet" }, { type: "azure-native:datashare/v20200901:ADLSGen2FileDataSet" }, { type: "azure-nextgen:datashare/v20200901:ADLSGen2FileDataSet" }, { type: "azure-native:datashare/v20201001preview:ADLSGen2FileDataSet" }, { type: "azure-nextgen:datashare/v20201001preview:ADLSGen2FileDataSet" }, { type: "azure-native:datashare/v20210801:ADLSGen2FileDataSet" }, { type: "azure-nextgen:datashare/v20210801:ADLSGen2FileDataSet" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(ADLSGen2FileDataSet.__pulumiType, name, inputs, opts);
    }
}
