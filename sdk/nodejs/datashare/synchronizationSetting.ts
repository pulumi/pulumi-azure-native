...
export class SynchronizationSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SynchronizationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare/v20200901:SynchronizationSetting" }, { type: "azure-native:datashare/v20201001preview:SynchronizationSetting" }, { type: "azure-native:datashare/v20210801:SynchronizationSetting" }] };
...
export interface SynchronizationSettingArgs {
     ...
     * Kind of synchronization setting.
     */
    kind: pulumi.Input<string | enums.datashare.SynchronizationSettingKind>;
    /**
