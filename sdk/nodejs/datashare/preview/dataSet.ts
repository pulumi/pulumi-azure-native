...
export class DataSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/preview:DataSet';
    ...
    constructor(name: string, args: DataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:DataSet" }, { type: "azurerm:datashare/v20181101preview:DataSet" }, { type: "azurerm:datashare/v20191101:DataSet" }] };
