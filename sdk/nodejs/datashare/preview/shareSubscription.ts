...
export class ShareSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/preview:ShareSubscription';
    ...
    constructor(name: string, args: ShareSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:ShareSubscription" }, { type: "azurerm:datashare/v20181101preview:ShareSubscription" }, { type: "azurerm:datashare/v20191101:ShareSubscription" }] };
