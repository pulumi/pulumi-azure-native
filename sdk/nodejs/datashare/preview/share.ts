...
export class Share extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/preview:Share';
    ...
    constructor(name: string, argsOrState?: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:Share" }, { type: "azurerm:datashare/v20181101preview:Share" }, { type: "azurerm:datashare/v20191101:Share" }] };
