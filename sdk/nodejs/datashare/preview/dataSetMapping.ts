...
export class DataSetMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datashare/preview:DataSetMapping';
    ...
    constructor(name: string, argsOrState?: DataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datashare/latest:DataSetMapping" }, { type: "azurerm:datashare/v20181101preview:DataSetMapping" }, { type: "azurerm:datashare/v20191101:DataSetMapping" }] };
