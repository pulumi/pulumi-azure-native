 ...
 *
 * @deprecated azure-native:datashare/v20200901:ADLSGen2FileSystemDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileSystemDataSetMapping to guarantee forwards compatibility.
 */
export class ADLSGen2FileSystemDataSetMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ADLSGen2FileSystemDataSetMapping {
        pulumi.log.warn("ADLSGen2FileSystemDataSetMapping is deprecated: azure-native:datashare/v20200901:ADLSGen2FileSystemDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileSystemDataSetMapping to guarantee forwards compatibility.")
        return new ADLSGen2FileSystemDataSetMapping(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/v20200901:ADLSGen2FileSystemDataSetMapping';
