 ...
 *
 * @deprecated azure-native:datashare/v20200901:ADLSGen1FolderDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen1FolderDataSet to guarantee forwards compatibility.
 */
export class ADLSGen1FolderDataSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ADLSGen1FolderDataSet {
        pulumi.log.warn("ADLSGen1FolderDataSet is deprecated: azure-native:datashare/v20200901:ADLSGen1FolderDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen1FolderDataSet to guarantee forwards compatibility.")
