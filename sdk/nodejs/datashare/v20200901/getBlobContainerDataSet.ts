 ...
 */
/** @deprecated azure-native:datashare/v20200901:BlobContainerDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobContainerDataSet to guarantee forwards compatibility. */
export function getBlobContainerDataSet(args: GetBlobContainerDataSetArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerDataSetResult> {
    pulumi.log.warn("getBlobContainerDataSet is deprecated: azure-native:datashare/v20200901:BlobContainerDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobContainerDataSet to guarantee forwards compatibility.")
