...
export class DataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/latest:DataSetMapping" }, { type: "azure-nextgen:datashare/v20181101preview:DataSetMapping" }, { type: "azure-nextgen:datashare/v20191101:DataSetMapping" }] };
