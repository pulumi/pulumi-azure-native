 ...
 *
 * @deprecated azure-native:datashare/v20200901:SqlDBTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.
 */
export class SqlDBTableDataSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlDBTableDataSet {
        pulumi.log.warn("SqlDBTableDataSet is deprecated: azure-native:datashare/v20200901:SqlDBTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: SqlDBTableDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:SqlDBTableDataSet" }, { type: "azure-native:datashare/v20181101preview:SqlDBTableDataSet" }, { type: "azure-native:datashare/v20191101:SqlDBTableDataSet" }, { type: "azure-native:datashare/v20201001preview:SqlDBTableDataSet" }, { type: "azure-native:datashare/v20210801:SqlDBTableDataSet" }] };
