...
export class BlobFolderDataSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobFolderDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:BlobFolderDataSet" }, { type: "azure-native:datashare/v20201001preview:BlobFolderDataSet" }, { type: "azure-native:datashare/v20210801:BlobFolderDataSet" }] };
