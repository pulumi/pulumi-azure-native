 ...
 */
/** @deprecated azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet to guarantee forwards compatibility. */
export function getSynapseWorkspaceSqlPoolTableDataSet(args: GetSynapseWorkspaceSqlPoolTableDataSetArgs, opts?: pulumi.InvokeOptions): Promise<GetSynapseWorkspaceSqlPoolTableDataSetResult> {
    pulumi.log.warn("getSynapseWorkspaceSqlPoolTableDataSet is deprecated: azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet to guarantee forwards compatibility.")
