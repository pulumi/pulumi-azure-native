...
export function getKustoDatabaseDataSetMapping(args: GetKustoDatabaseDataSetMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetKustoDatabaseDataSetMappingResult> {
    pulumi.log.warn("getKustoDatabaseDataSetMapping is deprecated: azure-native:datashare/v20200901:KustoDatabaseDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:KustoDatabaseDataSetMapping to guarantee forwards compatibility.")
