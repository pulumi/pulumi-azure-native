 ...
 *
 * @deprecated azure-native:datashare/v20200901:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.
 */
export class ADLSGen2FileDataSetMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ADLSGen2FileDataSetMapping {
        pulumi.log.warn("ADLSGen2FileDataSetMapping is deprecated: azure-native:datashare/v20200901:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.")
        return new ADLSGen2FileDataSetMapping(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/v20200901:ADLSGen2FileDataSetMapping';
...
export interface ADLSGen2FileDataSetMappingArgs {
     ...
     * Type of output file
     */
    outputType?: pulumi.Input<string | enums.datashare.v20200901.OutputType>;
    /**
     * Resource group of storage account.
     */
