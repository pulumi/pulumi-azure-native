...
export class ADLSGen2FolderDataSetMapping extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.ADLSGen2FolderDataSetMappingPropertiesResponse>;
    /**
...
export interface ADLSGen2FolderDataSetMappingArgs {
     ...
     * ADLS Gen2 folder data set mapping properties.
     */
    properties: pulumi.Input<inputs.datashare.ADLSGen2FolderDataSetMappingPropertiesArgs>;
    /**
