...
export class BlobStorageAccountDataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobStorageAccountDataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["kind"] = "BlobStorageAccount";
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/v20201001preview:BlobStorageAccountDataSetMapping" }, { type: "azure-native:datashare:BlobStorageAccountDataSetMapping" }, { type: "azure-nextgen:datashare:BlobStorageAccountDataSetMapping" }, { type: "azure-native:datashare/v20181101preview:BlobStorageAccountDataSetMapping" }, { type: "azure-nextgen:datashare/v20181101preview:BlobStorageAccountDataSetMapping" }, { type: "azure-native:datashare/v20191101:BlobStorageAccountDataSetMapping" }, { type: "azure-nextgen:datashare/v20191101:BlobStorageAccountDataSetMapping" }, { type: "azure-native:datashare/v20200901:BlobStorageAccountDataSetMapping" }, { type: "azure-nextgen:datashare/v20200901:BlobStorageAccountDataSetMapping" }, { type: "azure-native:datashare/v20210801:BlobStorageAccountDataSetMapping" }, { type: "azure-nextgen:datashare/v20210801:BlobStorageAccountDataSetMapping" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(BlobStorageAccountDataSetMapping.__pulumiType, name, inputs, opts);
    }
}
