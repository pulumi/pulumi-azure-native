...
export class BlobStorageAccountDataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobStorageAccountDataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:BlobStorageAccountDataSetMapping" }, { type: "azure-native:datashare/v20200901:BlobStorageAccountDataSetMapping" }, { type: "azure-native:datashare/v20210801:BlobStorageAccountDataSetMapping" }] };
