...
export class ShareSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:datashare/v20201001preview:ShareSubscription';
    ...
    constructor(name: string, args: ShareSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare:ShareSubscription" }, { type: "azure-nextgen:datashare/latest:ShareSubscription" }, { type: "azure-nextgen:datashare/v20181101preview:ShareSubscription" }, { type: "azure-nextgen:datashare/v20191101:ShareSubscription" }, { type: "azure-nextgen:datashare/v20200901:ShareSubscription" }] };
