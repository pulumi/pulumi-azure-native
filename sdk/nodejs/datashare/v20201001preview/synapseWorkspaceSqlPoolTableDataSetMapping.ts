...
export class SynapseWorkspaceSqlPoolTableDataSetMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SynapseWorkspaceSqlPoolTableDataSetMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:SynapseWorkspaceSqlPoolTableDataSetMapping" }, { type: "azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSetMapping" }, { type: "azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSetMapping" }] };
