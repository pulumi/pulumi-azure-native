...
export function getShareSubscription(args: GetShareSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetShareSubscriptionResult> {
    pulumi.log.warn("getShareSubscription is deprecated: azure-native:datashare/v20201001preview:ShareSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ShareSubscription to guarantee forwards compatibility.")
