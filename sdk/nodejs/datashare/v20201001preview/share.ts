...
export class Share extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/latest:Share" }, { type: "azure-nextgen:datashare/v20181101preview:Share" }, { type: "azure-nextgen:datashare/v20191101:Share" }, { type: "azure-nextgen:datashare/v20200901:Share" }] };
