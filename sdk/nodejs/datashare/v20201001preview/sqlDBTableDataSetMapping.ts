...
export class SqlDBTableDataSetMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/v20201001preview:SqlDBTableDataSetMapping';
