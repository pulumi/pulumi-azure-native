...
export class BlobStorageAccountDataSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobStorageAccountDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datashare:BlobStorageAccountDataSet" }, { type: "azure-native:datashare/v20200901:BlobStorageAccountDataSet" }, { type: "azure-native:datashare/v20210801:BlobStorageAccountDataSet" }] };
