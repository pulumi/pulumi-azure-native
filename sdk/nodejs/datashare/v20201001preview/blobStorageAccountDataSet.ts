...
export interface BlobStorageAccountDataSetArgs {
     ...
     * A list of storage account paths.
     */
    readonly paths: pulumi.Input<pulumi.Input<inputs.datashare.v20201001preview.BlobStorageAccountPathArgs>[]>;
    /**
