...
export class BlobStorageAccountDataSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BlobStorageAccountDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datashare/v20201001preview:BlobStorageAccountDataSet" }, { type: "azure-native:datashare:BlobStorageAccountDataSet" }, { type: "azure-nextgen:datashare:BlobStorageAccountDataSet" }, { type: "azure-native:datashare/v20181101preview:BlobStorageAccountDataSet" }, { type: "azure-nextgen:datashare/v20181101preview:BlobStorageAccountDataSet" }, { type: "azure-native:datashare/v20191101:BlobStorageAccountDataSet" }, { type: "azure-nextgen:datashare/v20191101:BlobStorageAccountDataSet" }, { type: "azure-native:datashare/v20200901:BlobStorageAccountDataSet" }, { type: "azure-nextgen:datashare/v20200901:BlobStorageAccountDataSet" }, { type: "azure-native:datashare/v20210801:BlobStorageAccountDataSet" }, { type: "azure-nextgen:datashare/v20210801:BlobStorageAccountDataSet" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(BlobStorageAccountDataSet.__pulumiType, name, inputs, opts);
    }
}
