...
export function getBlobFolderDataSet(args: GetBlobFolderDataSetArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobFolderDataSetResult> {
    pulumi.log.warn("getBlobFolderDataSet is deprecated: azure-native:datashare/v20201001preview:BlobFolderDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobFolderDataSet to guarantee forwards compatibility.")
