...
export class ADLSGen1FolderDataSet extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.ADLSGen1FolderPropertiesResponse>;
    /**
...
export interface ADLSGen1FolderDataSetArgs {
     ...
     * ADLS Gen 1 folder data set properties.
     */
    properties: pulumi.Input<inputs.datashare.ADLSGen1FolderPropertiesArgs>;
    /**
