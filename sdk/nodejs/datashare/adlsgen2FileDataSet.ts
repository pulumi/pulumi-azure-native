...
export class ADLSGen2FileDataSet extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datashare.ADLSGen2FilePropertiesResponse>;
    /**
...
export interface ADLSGen2FileDataSetArgs {
     ...
     * ADLS Gen 2 file data set properties.
     */
    properties: pulumi.Input<inputs.datashare.ADLSGen2FilePropertiesArgs>;
    /**
