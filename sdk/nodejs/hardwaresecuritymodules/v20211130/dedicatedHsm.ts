...
export class DedicatedHsm extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DedicatedHsmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hardwaresecuritymodules:DedicatedHsm" }, { type: "azure-native:hardwaresecuritymodules/v20181031preview:DedicatedHsm" }, { type: "azure-native:hardwaresecuritymodules/v20240630preview:DedicatedHsm" }] };
