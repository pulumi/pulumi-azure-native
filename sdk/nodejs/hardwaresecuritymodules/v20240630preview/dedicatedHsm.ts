...
export class DedicatedHsm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hardwaresecuritymodules/v20240630preview:DedicatedHsm';
     ...
     */
    public readonly managementNetworkProfile!: pulumi.Output<outputs.hardwaresecuritymodules.v20240630preview.NetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.hardwaresecuritymodules.v20240630preview.NetworkProfileResponse | undefined>;
    /**
     * Provisioning state.
     */
     ...
     * SKU details
     */
    public readonly sku!: pulumi.Output<outputs.hardwaresecuritymodules.v20240630preview.SkuResponse>;
    /**
    ...
    constructor(name: string, args: DedicatedHsmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hardwaresecuritymodules/v20181031preview:DedicatedHsm" }, { type: "azure-native:hardwaresecuritymodules/v20211130:DedicatedHsm" }, { type: "azure-native:hardwaresecuritymodules:DedicatedHsm" }] };
...
export interface DedicatedHsmArgs {
     ...
     * Specifies the management network interfaces of the dedicated hsm.
     */
    managementNetworkProfile?: pulumi.Input<inputs.hardwaresecuritymodules.v20240630preview.NetworkProfileArgs>;
    /**
     ...
     * Specifies the network interfaces of the dedicated hsm.
     */
    networkProfile?: pulumi.Input<inputs.hardwaresecuritymodules.v20240630preview.NetworkProfileArgs>;
    /**
     ...
     * SKU details
     */
    sku: pulumi.Input<inputs.hardwaresecuritymodules.v20240630preview.SkuArgs>;
    /**
     * This field will be used when RP does not support Availability zones.
     */
