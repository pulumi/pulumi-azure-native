...
export class CloudHsmCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CloudHsmClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hardwaresecuritymodules/v20220831preview:CloudHsmCluster" }, { type: "azure-native:hardwaresecuritymodules/v20231210preview:CloudHsmCluster" }, { type: "azure-native:hardwaresecuritymodules/v20240630preview:CloudHsmCluster" }, { type: "azure-native:hardwaresecuritymodules/v20250331:CloudHsmCluster" }, { type: "azure-native:hardwaresecuritymodules/v20251201preview:CloudHsmCluster" }] };
...
export interface CloudHsmClusterArgs {
     ...
     * The Cloud HSM Cluster's auto-generated Domain Name Label Scope
     */
    autoGeneratedDomainNameLabelScope?: pulumi.Input<string | enums.hardwaresecuritymodules.AutoGeneratedDomainNameLabelScope | undefined>;
    /**
     ...
     * Managed service identity (system assigned and/or user assigned identities)
     */
    identity?: pulumi.Input<inputs.hardwaresecuritymodules.ManagedServiceIdentityArgs | undefined>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The Cloud HSM Cluster public network access
     */
    publicNetworkAccess?: pulumi.Input<string | enums.hardwaresecuritymodules.PublicNetworkAccess | undefined>;
    /**
     ...
     * SKU details
     */
    sku?: pulumi.Input<inputs.hardwaresecuritymodules.CloudHsmClusterSkuArgs | undefined>;
    /**
     * Resource tags.
     */
