...
export function getDedicatedHsm(args: GetDedicatedHsmArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHsmResult> {
    ...
    return pulumi.runtime.invoke("azurerm:hardwaresecuritymodules/preview:getDedicatedHsm", {
        "name": args.name,
...
export interface GetDedicatedHsmResult {
     ...
     */
    readonly networkProfile?: outputs.hardwaresecuritymodules.preview.NetworkProfileResponse;
    /**
     * Provisioning state.
     */
     ...
     * SKU details
     */
    readonly sku: outputs.hardwaresecuritymodules.preview.SkuResponse;
    /**
