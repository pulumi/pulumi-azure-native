 ...
 */
/** @deprecated Version 2018-10-31-preview will be removed in v2 of the provider. */
export function getDedicatedHsm(args: GetDedicatedHsmArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHsmResult> {
    pulumi.log.warn("getDedicatedHsm is deprecated: Version 2018-10-31-preview will be removed in v2 of the provider.")
