 ...
 *
 * const attachedDataNetwork = new azure_native.mobilenetwork.v20221101.AttachedDataNetwork("attachedDataNetwork", {
...
export class AttachedDataNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AttachedDataNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20220401preview:AttachedDataNetwork" }] };
