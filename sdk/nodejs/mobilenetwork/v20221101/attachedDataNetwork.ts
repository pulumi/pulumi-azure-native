...
export class AttachedDataNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.mobilenetwork.v20221101.AttachedDataNetworkPropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: AttachedDataNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.mobilenetwork.v20221101.attachedDataNetworkPropertiesFormatArgsProvideDefaults) : undefined) : undefined;
...
export interface AttachedDataNetworkArgs {
     ...
     * Attached data network properties.
     */
    properties: pulumi.Input<inputs.mobilenetwork.v20221101.AttachedDataNetworkPropertiesFormatArgs>;
    /**
