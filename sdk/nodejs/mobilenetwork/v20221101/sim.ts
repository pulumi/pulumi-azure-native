 ...
 *
 * const sim = new azure_native.mobilenetwork.v20221101.Sim("sim", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:mobilenetwork/v20221101:Sim testSim /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.MobileNetwork/simGroups/testSimGroup/sims/testSim 
 * ```
 */
export class Sim extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SimArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Sim" }, { type: "azure-native:mobilenetwork/v20220401preview:Sim" }] };
