...
export function getSimGroupSim(args: GetSimGroupSimArgs, opts?: pulumi.InvokeOptions): Promise<GetSimGroupSimResult> {
    ...
    return pulumi.runtime.invoke("azure-native:mobilenetwork/v20221101:getSimGroupSim", {
...
export function getSimGroupSimOutput(args: GetSimGroupSimOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSimGroupSimResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:mobilenetwork/v20221101:getSimGroupSim", {
        "resourceGroupName": args.resourceGroupName,
        "simGroupName": args.simGroupName,
        "simName": args.simName,
    }, opts);
