...
export interface GetSimResult {
     ...
     */
    readonly simPolicy?: outputs.mobilenetwork.v20240201.SimPolicyResourceIdResponse;
    /**
     ...
     */
    readonly staticIpConfiguration?: outputs.mobilenetwork.v20240201.SimStaticIpPropertiesResponse[];
    /**
...
export function getSimOutput(args: GetSimOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSimResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:mobilenetwork/v20240201:getSim", {
        "resourceGroupName": args.resourceGroupName,
        "simGroupName": args.simGroupName,
        "simName": args.simName,
    }, opts);
