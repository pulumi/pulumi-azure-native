...
export class SimGroup extends pulumi.CustomResource {
     ...
     */
    public readonly encryptionKey!: pulumi.Output<outputs.mobilenetwork.v20240201.KeyVaultKeyResponse | undefined>;
    /**
     ...
     */
    public readonly mobileNetwork!: pulumi.Output<outputs.mobilenetwork.v20240201.MobileNetworkResourceIdResponse | undefined>;
    /**
...
export interface SimGroupArgs {
     ...
     * A key to encrypt the SIM data that belongs to this SIM group.
     */
    encryptionKey?: pulumi.Input<inputs.mobilenetwork.v20240201.KeyVaultKeyArgs>;
    /**
     * The identity used to retrieve the encryption key from Azure key vault.
     */
     ...
     * Mobile network that this SIM group belongs to. The mobile network must be in the same location as the SIM group.
     */
    mobileNetwork?: pulumi.Input<inputs.mobilenetwork.v20240201.MobileNetworkResourceIdArgs>;
    /**
