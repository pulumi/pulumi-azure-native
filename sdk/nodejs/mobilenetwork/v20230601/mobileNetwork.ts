...
export class MobileNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20230601:MobileNetwork';
     ...
     */
    public readonly publicLandMobileNetworkIdentifier!: pulumi.Output<outputs.mobilenetwork.v20230601.PlmnIdResponse>;
    /**
    ...
    constructor(name: string, args: MobileNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220401preview:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20221101:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20230901:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20240201:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20240401:MobileNetwork" }] };
...
export interface MobileNetworkArgs {
     ...
     * The unique public land mobile network identifier for the network. This is made up of the mobile country code and mobile network code, as defined in https://www.itu.int/rec/T-REC-E.212. The values 001-01 and 001-001 can be used for testing and the values 999-99 and 999-999 can be used on internal private networks.
     */
    publicLandMobileNetworkIdentifier: pulumi.Input<inputs.mobilenetwork.v20230601.PlmnIdArgs>;
    /**
