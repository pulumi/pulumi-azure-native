...
export class PacketCoreDataPlane extends pulumi.CustomResource {
     ...
     */
    public readonly userPlaneAccessInterface!: pulumi.Output<outputs.mobilenetwork.v20230601.InterfacePropertiesResponse>;
    ...
    constructor(name: string, args: PacketCoreDataPlaneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20220401preview:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20221101:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20230901:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20240201:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20240401:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork:PacketCoreDataPlane" }] };
...
export interface PacketCoreDataPlaneArgs {
     ...
     * The user plane interface on the access network. For 5G networks, this is the N3 interface. For 4G networks, this is the S1-U interface.
     */
    userPlaneAccessInterface: pulumi.Input<inputs.mobilenetwork.v20230601.InterfacePropertiesArgs>;
}
