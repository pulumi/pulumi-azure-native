...
export interface GetSimPolicyResult {
     ...
     */
    readonly defaultSlice: outputs.mobilenetwork.v20230601.SliceResourceIdResponse;
    /**
     ...
     */
    readonly sliceConfigurations: outputs.mobilenetwork.v20230601.SliceConfigurationResponse[];
    /**
     ...
     */
    readonly ueAmbr: outputs.mobilenetwork.v20230601.AmbrResponse;
}
/**
 * Gets information about the specified SIM policy.
 */
export function getSimPolicyOutput(args: GetSimPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSimPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:mobilenetwork/v20230601:getSimPolicy", {
        "mobileNetworkName": args.mobileNetworkName,
        "resourceGroupName": args.resourceGroupName,
        "simPolicyName": args.simPolicyName,
    }, opts);
