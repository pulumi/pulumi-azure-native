...
export class PacketCoreControlPlane extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20240401:PacketCoreControlPlane';
     ...
     */
    public readonly controlPlaneAccessInterface!: pulumi.Output<outputs.mobilenetwork.v20240401.InterfacePropertiesResponse>;
    /**
     ...
     */
    public readonly diagnosticsUpload!: pulumi.Output<outputs.mobilenetwork.v20240401.DiagnosticsUploadConfigurationResponse | undefined>;
    /**
     * Configuration for sending packet core events to an Azure Event Hub.
     */
    public readonly eventHub!: pulumi.Output<outputs.mobilenetwork.v20240401.EventHubConfigurationResponse | undefined>;
    /**
     * The provisioning state of the secret containing private keys and keyIds for SUPI concealment.
     */
    public /*out*/ readonly homeNetworkPrivateKeysProvisioning!: pulumi.Output<outputs.mobilenetwork.v20240401.HomeNetworkPrivateKeysProvisioningResponse>;
    /**
     * The identity used to retrieve the ingress certificate from Azure key vault.
     */
    public readonly identity!: pulumi.Output<outputs.mobilenetwork.v20240401.ManagedServiceIdentityResponse | undefined>;
    /**
     * The installation state of the packet core control plane resource.
     */
    public readonly installation!: pulumi.Output<outputs.mobilenetwork.v20240401.InstallationResponse | undefined>;
    /**
     ...
     */
    public readonly localDiagnosticsAccess!: pulumi.Output<outputs.mobilenetwork.v20240401.LocalDiagnosticsAccessConfigurationResponse>;
    /**
     ...
     */
    public readonly platform!: pulumi.Output<outputs.mobilenetwork.v20240401.PlatformConfigurationResponse>;
    /**
     ...
     */
    public readonly signaling!: pulumi.Output<outputs.mobilenetwork.v20240401.SignalingConfigurationResponse | undefined>;
    /**
     * Site(s) under which this packet core control plane should be deployed. The sites must be in the same location as the packet core control plane.
     */
    public readonly sites!: pulumi.Output<outputs.mobilenetwork.v20240401.SiteResourceIdResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.mobilenetwork.v20240401.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly userConsent!: pulumi.Output<outputs.mobilenetwork.v20240401.UserConsentConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PacketCoreControlPlaneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["eventHub"] = args ? (args.eventHub ? pulumi.output(args.eventHub).apply(inputs.mobilenetwork.v20240401.eventHubConfigurationArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["identity"] = args ? args.identity : undefined;
            resourceInputs["installation"] = args ? (args.installation ? pulumi.output(args.installation).apply(inputs.mobilenetwork.v20240401.installationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork/v20220301preview:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20220401preview:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20221101:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20230601:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20230901:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20240201:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork:PacketCoreControlPlane" }] };
...
export interface PacketCoreControlPlaneArgs {
     ...
     * The control plane interface on the access network. For 5G networks, this is the N2 interface. For 4G networks, this is the S1-MME interface.
     */
    controlPlaneAccessInterface: pulumi.Input<inputs.mobilenetwork.v20240401.InterfacePropertiesArgs>;
    /**
     * The virtual IP address(es) for the control plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to anycast traffic for this address to the control plane access interfaces on the active and standby nodes. In non-HA system this list should be omitted or empty.
     */
     ...
     * The core network technology generation (5G core or EPC / 4G core).
     */
    coreNetworkTechnology?: pulumi.Input<string | enums.mobilenetwork.v20240401.CoreNetworkType>;
    /**
     * Configuration for uploading packet core diagnostics
     */
    diagnosticsUpload?: pulumi.Input<inputs.mobilenetwork.v20240401.DiagnosticsUploadConfigurationArgs>;
    /**
     * Configuration for sending packet core events to an Azure Event Hub.
     */
    eventHub?: pulumi.Input<inputs.mobilenetwork.v20240401.EventHubConfigurationArgs>;
    /**
     * The identity used to retrieve the ingress certificate from Azure key vault.
     */
    identity?: pulumi.Input<inputs.mobilenetwork.v20240401.ManagedServiceIdentityArgs>;
    /**
     * The installation state of the packet core control plane resource.
     */
    installation?: pulumi.Input<inputs.mobilenetwork.v20240401.InstallationArgs>;
    /**
     * Settings to allow interoperability with third party components e.g. RANs and UEs.
     */
    interopSettings?: any;
     ...
     * The kubernetes ingress configuration to control access to packet core diagnostics over local APIs.
     */
    localDiagnosticsAccess: pulumi.Input<inputs.mobilenetwork.v20240401.LocalDiagnosticsAccessConfigurationArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The platform where the packet core is deployed.
     */
    platform: pulumi.Input<inputs.mobilenetwork.v20240401.PlatformConfigurationArgs>;
    /**
     ...
     * Signaling configuration for the packet core.
     */
    signaling?: pulumi.Input<inputs.mobilenetwork.v20240401.SignalingConfigurationArgs>;
    /**
     * Site(s) under which this packet core control plane should be deployed. The sites must be in the same location as the packet core control plane.
     */
    sites: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20240401.SiteResourceIdArgs>[]>;
    /**
     * The SKU defining the throughput and SIM allowances for this packet core control plane deployment.
     */
    sku: pulumi.Input<string | enums.mobilenetwork.v20240401.BillingSku>;
    /**
     * Resource tags.
     */
     ...
     * The user consent configuration for the packet core.
     */
    userConsent?: pulumi.Input<inputs.mobilenetwork.v20240401.UserConsentConfigurationArgs>;
    /**
     * The desired version of the packet core software.
     */
