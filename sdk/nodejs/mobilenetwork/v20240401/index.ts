...
// Export enums:
export * from "../../types/enums/mobilenetwork/v20240401";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:mobilenetwork/v20240401:SimGroupSim":
...
pulumi.runtime.registerResourceModule("azure-native", "mobilenetwork/v20240401", _module)
