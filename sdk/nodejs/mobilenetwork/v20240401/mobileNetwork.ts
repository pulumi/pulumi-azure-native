...
export class MobileNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20240401:MobileNetwork';
     ...
     */
    public readonly publicLandMobileNetworkIdentifier!: pulumi.Output<outputs.mobilenetwork.v20240401.PlmnIdResponse>;
    /**
     ...
     */
    public readonly publicLandMobileNetworks!: pulumi.Output<outputs.mobilenetwork.v20240401.PublicLandMobileNetworkResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: MobileNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220401preview:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20221101:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20230601:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20230901:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20240201:MobileNetwork" }] };
...
export interface MobileNetworkArgs {
     ...
     * The unique public land mobile network identifier for the network. If both 'publicLandMobileNetworks' and 'publicLandMobileNetworkIdentifier' are specified, then the 'publicLandMobileNetworks' will take precedence.
     */
    publicLandMobileNetworkIdentifier: pulumi.Input<inputs.mobilenetwork.v20240401.PlmnIdArgs>;
    /**
     * A list of public land mobile networks including their identifiers. If both 'publicLandMobileNetworks' and 'publicLandMobileNetworkIdentifier' are specified, then the 'publicLandMobileNetworks' will take precedence.
     */
    publicLandMobileNetworks?: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20240401.PublicLandMobileNetworkArgs>[]>;
    /**
