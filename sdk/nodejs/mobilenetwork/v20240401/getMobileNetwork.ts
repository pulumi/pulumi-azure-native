...
export function getMobileNetwork(args: GetMobileNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetMobileNetworkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:mobilenetwork/v20240401:getMobileNetwork", {
...
export interface GetMobileNetworkResult {
     ...
     */
    readonly publicLandMobileNetworkIdentifier: outputs.mobilenetwork.v20240401.PlmnIdResponse;
    /**
     ...
     */
    readonly publicLandMobileNetworks?: outputs.mobilenetwork.v20240401.PublicLandMobileNetworkResponse[];
    /**
...
export function getMobileNetworkOutput(args: GetMobileNetworkOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMobileNetworkResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:mobilenetwork/v20240401:getMobileNetwork", {
        "mobileNetworkName": args.mobileNetworkName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
