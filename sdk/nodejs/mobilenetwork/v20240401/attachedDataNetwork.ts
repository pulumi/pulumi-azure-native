...
export class AttachedDataNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20240401:AttachedDataNetwork';
     ...
     */
    public readonly naptConfiguration!: pulumi.Output<outputs.mobilenetwork.v20240401.NaptConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly userPlaneDataInterface!: pulumi.Output<outputs.mobilenetwork.v20240401.InterfacePropertiesResponse>;
...
export interface AttachedDataNetworkArgs {
     ...
     * If this is not specified, the attached data network will use a default NAPT configuration with NAPT enabled.
     */
    naptConfiguration?: pulumi.Input<inputs.mobilenetwork.v20240401.NaptConfigurationArgs>;
    /**
     ...
     * The user plane interface on the data network. For 5G networks, this is the N6 interface. For 4G networks, this is the SGi interface.
     */
    userPlaneDataInterface: pulumi.Input<inputs.mobilenetwork.v20240401.InterfacePropertiesArgs>;
}
