...
export class SimGroupSim extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20240401:SimGroupSim';
     ...
     */
    public readonly simPolicy!: pulumi.Output<outputs.mobilenetwork.v20240401.SimPolicyResourceIdResponse | undefined>;
    /**
     ...
     */
    public readonly staticIpConfiguration!: pulumi.Output<outputs.mobilenetwork.v20240401.SimStaticIpPropertiesResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SimGroupSimArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:SimGroupSim" }, { type: "azure-native:mobilenetwork/v20220401preview:SimGroupSim" }, { type: "azure-native:mobilenetwork/v20221101:SimGroupSim" }, { type: "azure-native:mobilenetwork/v20230601:SimGroupSim" }, { type: "azure-native:mobilenetwork/v20230901:SimGroupSim" }, { type: "azure-native:mobilenetwork/v20240201:SimGroupSim" }] };
...
export interface SimGroupSimArgs {
     ...
     * The SIM policy used by this SIM. The SIM policy must be in the same location as the SIM.
     */
    simPolicy?: pulumi.Input<inputs.mobilenetwork.v20240401.SimPolicyResourceIdArgs>;
    /**
     * A list of static IP addresses assigned to this SIM. Each address is assigned at a defined network scope, made up of {attached data network, slice}.
     */
    staticIpConfiguration?: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20240401.SimStaticIpPropertiesArgs>[]>;
}
