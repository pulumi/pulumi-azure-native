...
export class Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20240401:Service';
     ...
     */
    public readonly pccRules!: pulumi.Output<outputs.mobilenetwork.v20240401.PccRuleConfigurationResponse[]>;
    /**
     ...
     */
    public readonly serviceQosPolicy!: pulumi.Output<outputs.mobilenetwork.v20240401.QosPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Service" }, { type: "azure-native:mobilenetwork/v20220301preview:Service" }, { type: "azure-native:mobilenetwork/v20220401preview:Service" }, { type: "azure-native:mobilenetwork/v20221101:Service" }, { type: "azure-native:mobilenetwork/v20230601:Service" }, { type: "azure-native:mobilenetwork/v20230901:Service" }, { type: "azure-native:mobilenetwork/v20240201:Service" }] };
...
export interface ServiceArgs {
     ...
     * The set of data flow policy rules that make up this service.
     */
    pccRules: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20240401.PccRuleConfigurationArgs>[]>;
    /**
     ...
     * The QoS policy to use for packets matching this service. This can be overridden for particular flows using the ruleQosPolicy field in a PccRuleConfiguration. If this field is null then the UE's SIM policy will define the QoS settings.
     */
    serviceQosPolicy?: pulumi.Input<inputs.mobilenetwork.v20240401.QosPolicyArgs>;
    /**
     * Resource tags.
     */
