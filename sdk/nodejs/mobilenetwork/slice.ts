...
export class Slice extends pulumi.CustomResource {
     ...
     * Slice properties.
     */
    public readonly properties!: pulumi.Output<outputs.mobilenetwork.SlicePropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: SliceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork/v20220301preview:Slice" }, { type: "azure-native:mobilenetwork/v20220401preview:Slice" }, { type: "azure-native:mobilenetwork/v20221101:Slice" }] };
...
export interface SliceArgs {
     ...
     * Slice properties.
     */
    properties: pulumi.Input<inputs.mobilenetwork.SlicePropertiesFormatArgs>;
    /**
