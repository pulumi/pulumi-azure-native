...
export class SimPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20220101preview:SimPolicy';
     ...
     */
    public readonly defaultSlice!: pulumi.Output<outputs.mobilenetwork.v20220101preview.SliceResourceIdResponse>;
    /**
     ...
     */
    public readonly sliceConfigurations!: pulumi.Output<outputs.mobilenetwork.v20220101preview.SliceConfigurationResponse[]>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly ueAmbr!: pulumi.Output<outputs.mobilenetwork.v20220101preview.AmbrResponse>;
    ...
    constructor(name: string, args: SimPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:SimPolicy" }] };
