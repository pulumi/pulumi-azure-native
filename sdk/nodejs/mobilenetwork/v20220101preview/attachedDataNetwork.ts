...
export class AttachedDataNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20220101preview:AttachedDataNetwork';
     ...
     */
    public readonly naptConfiguration!: pulumi.Output<outputs.mobilenetwork.v20220101preview.NaptConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly userPlaneDataInterface!: pulumi.Output<outputs.mobilenetwork.v20220101preview.InterfacePropertiesResponse>;
    ...
    constructor(name: string, args: AttachedDataNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["naptConfiguration"] = args ? (args.naptConfiguration ? pulumi.output(args.naptConfiguration).apply(inputs.mobilenetwork.v20220101preview.naptConfigurationArgsProvideDefaults) : undefined) : undefined;
...
export interface AttachedDataNetworkArgs {
     ...
     * If not specified the attached data network uses a default NAPT configuration with NAPT enabled.
     */
    naptConfiguration?: pulumi.Input<inputs.mobilenetwork.v20220101preview.NaptConfigurationArgs>;
    /**
     ...
     * The user plane interface on the data network. In 5G networks this is called as N6 interface whereas in 4G networks this is called as SGi interface.
     */
    userPlaneDataInterface: pulumi.Input<inputs.mobilenetwork.v20220101preview.InterfacePropertiesArgs>;
}
