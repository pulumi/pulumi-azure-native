...
export class Slice extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20220101preview:Slice';
     ...
     */
    public readonly snssai!: pulumi.Output<outputs.mobilenetwork.v20220101preview.SnssaiResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: SliceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Slice" }, { type: "azure-native:mobilenetwork/v20220301preview:Slice" }, { type: "azure-native:mobilenetwork/v20220401preview:Slice" }] };
