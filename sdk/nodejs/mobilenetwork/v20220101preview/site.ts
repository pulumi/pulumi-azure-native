...
export class Site extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20220101preview:Site';
     ...
     */
    public readonly networkFunctions!: pulumi.Output<outputs.mobilenetwork.v20220101preview.SubResourceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Site" }] };
