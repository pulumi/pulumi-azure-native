...
export class PacketCoreDataPlane extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20220101preview:PacketCoreDataPlane';
     ...
     */
    public readonly userPlaneAccessInterface!: pulumi.Output<outputs.mobilenetwork.v20220101preview.InterfacePropertiesResponse>;
    ...
    constructor(name: string, args: PacketCoreDataPlaneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:PacketCoreDataPlane" }] };
