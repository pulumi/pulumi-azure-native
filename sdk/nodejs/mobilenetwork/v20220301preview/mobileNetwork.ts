...
export class MobileNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.mobilenetwork.v20220301preview.MobileNetworkPropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: MobileNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220401preview:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20221101:MobileNetwork" }] };
...
export interface MobileNetworkArgs {
     ...
     * Mobile network properties.
     */
    properties: pulumi.Input<inputs.mobilenetwork.v20220301preview.MobileNetworkPropertiesFormatArgs>;
    /**
