...
export function getSlice(args: GetSliceArgs, opts?: pulumi.InvokeOptions): Promise<GetSliceResult> {
    pulumi.log.warn("getSlice is deprecated: azure-native:mobilenetwork/v20220301preview:Slice is being removed in the next major version of this provider. Upgrade to at least azure-native:mobilenetwork/v20220401preview:Slice to guarantee forwards compatibility.")
