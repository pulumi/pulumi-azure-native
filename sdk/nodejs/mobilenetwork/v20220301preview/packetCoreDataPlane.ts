...
export class PacketCoreDataPlane extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PacketCoreDataPlane {
        pulumi.log.warn("PacketCoreDataPlane is deprecated: azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane is being removed in the next major version of this provider. Please upgrade to azure-native:mobilenetwork/v20220401preview:PacketCoreDataPlane to guarantee forwards compatibility.")
        return new PacketCoreDataPlane(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane';
     ...
     */
    public readonly userPlaneAccessInterface!: pulumi.Output<outputs.mobilenetwork.v20220301preview.InterfacePropertiesResponse>;
    ...
    constructor(name: string, args: PacketCoreDataPlaneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20220401preview:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20221101:PacketCoreDataPlane" }] };
