...
export function getDataNetwork(args: GetDataNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetDataNetworkResult> {
    pulumi.log.warn("getDataNetwork is deprecated: azure-native:mobilenetwork/v20220301preview:DataNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:mobilenetwork/v20220401preview:DataNetwork to guarantee forwards compatibility.")
