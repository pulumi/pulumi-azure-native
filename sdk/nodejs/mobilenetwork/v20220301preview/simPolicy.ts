...
export class SimPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.mobilenetwork.v20220301preview.SimPolicyPropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: SimPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.mobilenetwork.v20220301preview.simPolicyPropertiesFormatArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:SimPolicy" }, { type: "azure-native:mobilenetwork/v20220401preview:SimPolicy" }, { type: "azure-native:mobilenetwork/v20221101:SimPolicy" }] };
...
export interface SimPolicyArgs {
     ...
     * Sim policy Properties.
     */
    properties: pulumi.Input<inputs.mobilenetwork.v20220301preview.SimPolicyPropertiesFormatArgs>;
    /**
