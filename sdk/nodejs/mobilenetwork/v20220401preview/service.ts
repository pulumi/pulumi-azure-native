...
export class Service extends pulumi.CustomResource {
     ...
     * Service Properties.
     */
    public readonly properties!: pulumi.Output<outputs.mobilenetwork.v20220401preview.ServicePropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.mobilenetwork.v20220401preview.servicePropertiesFormatArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Service" }, { type: "azure-native:mobilenetwork/v20220301preview:Service" }, { type: "azure-native:mobilenetwork/v20221101:Service" }] };
...
export interface ServiceArgs {
     ...
     * Service Properties.
     */
    properties: pulumi.Input<inputs.mobilenetwork.v20220401preview.ServicePropertiesFormatArgs>;
    /**
