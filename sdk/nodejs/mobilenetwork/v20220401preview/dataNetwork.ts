...
export class DataNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:DataNetwork" }, { type: "azure-native:mobilenetwork/v20220101preview:DataNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:DataNetwork" }] };
