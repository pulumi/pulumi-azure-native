...
export class MobileNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MobileNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220101preview:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:MobileNetwork" }] };
