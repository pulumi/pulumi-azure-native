...
export class Site extends pulumi.CustomResource {
     ...
     */
    public readonly networkFunctions!: pulumi.Output<outputs.mobilenetwork.v20220401preview.SubResourceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork/v20220301preview:Site" }, { type: "azure-native:mobilenetwork/v20221101:Site" }, { type: "azure-native:mobilenetwork/v20230601:Site" }, { type: "azure-native:mobilenetwork/v20230901:Site" }, { type: "azure-native:mobilenetwork/v20240201:Site" }, { type: "azure-native:mobilenetwork/v20240401:Site" }, { type: "azure-native:mobilenetwork:Site" }] };
...
export interface SiteArgs {
     ...
     * An array of IDs of the network functions deployed on the site, maintained by the user.
     */
    networkFunctions?: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20220401preview.SubResourceArgs>[]>;
    /**
