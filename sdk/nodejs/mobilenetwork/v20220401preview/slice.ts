 ...
 *
 * const slice = new azure_native.mobilenetwork.v20220401preview.Slice("slice", {
...
export class Slice extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SliceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Slice" }, { type: "azure-native:mobilenetwork/v20220301preview:Slice" }, { type: "azure-native:mobilenetwork/v20221101:Slice" }] };
