 ...
 *
 * const packetCoreDataPlane = new azure_native.mobilenetwork.v20220401preview.PacketCoreDataPlane("packetCoreDataPlane", {
 *     location: "eastus",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:mobilenetwork/v20220401preview:PacketCoreDataPlane TestPacketCoreDP /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/TestPacketCoreCP/packetCoreDataPlanes/TestPacketCoreDP 
 * ```
 */
export class PacketCoreDataPlane extends pulumi.CustomResource {
     ...
     */
    public readonly userPlaneAccessInterface!: pulumi.Output<outputs.mobilenetwork.v20220401preview.InterfacePropertiesResponse>;
    ...
    constructor(name: string, args: PacketCoreDataPlaneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20221101:PacketCoreDataPlane" }] };
...
export interface PacketCoreDataPlaneArgs {
     ...
     * The user plane interface on the access network. For 5G networks, this is the N3 interface. For 4G networks, this is the S1-U interface.
     */
    userPlaneAccessInterface: pulumi.Input<inputs.mobilenetwork.v20220401preview.InterfacePropertiesArgs>;
}
