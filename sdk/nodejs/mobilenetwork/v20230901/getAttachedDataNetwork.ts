...
export function getAttachedDataNetwork(args: GetAttachedDataNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetAttachedDataNetworkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:mobilenetwork/v20230901:getAttachedDataNetwork", {
...
export interface GetAttachedDataNetworkResult {
     ...
     */
    readonly naptConfiguration?: outputs.mobilenetwork.v20230901.NaptConfigurationResponse;
    /**
     ...
     */
    readonly systemData: outputs.mobilenetwork.v20230901.SystemDataResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly userPlaneDataInterface: outputs.mobilenetwork.v20230901.InterfacePropertiesResponse;
}
/**
 * Gets information about the specified attached data network.
 */
export function getAttachedDataNetworkOutput(args: GetAttachedDataNetworkOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAttachedDataNetworkResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:mobilenetwork/v20230901:getAttachedDataNetwork", {
        "attachedDataNetworkName": args.attachedDataNetworkName,
        "packetCoreControlPlaneName": args.packetCoreControlPlaneName,
        "packetCoreDataPlaneName": args.packetCoreDataPlaneName,
        "resourceGroupName": args.resourceGroupName,
