...
export class Site extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly networkFunctions!: pulumi.Output<outputs.mobilenetwork.v20230901.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork/v20220301preview:Site" }, { type: "azure-native:mobilenetwork/v20220401preview:Site" }, { type: "azure-native:mobilenetwork/v20221101:Site" }, { type: "azure-native:mobilenetwork/v20230601:Site" }, { type: "azure-native:mobilenetwork/v20240201:Site" }, { type: "azure-native:mobilenetwork/v20240401:Site" }, { type: "azure-native:mobilenetwork:Site" }] };
