...
export class PacketCoreControlPlane extends pulumi.CustomResource {
     ...
     */
    public readonly controlPlaneAccessInterface!: pulumi.Output<outputs.mobilenetwork.v20230901.InterfacePropertiesResponse>;
    /**
     ...
     */
    public readonly diagnosticsUpload!: pulumi.Output<outputs.mobilenetwork.v20230901.DiagnosticsUploadConfigurationResponse | undefined>;
    /**
     * Configuration for sending packet core events to an Azure Event Hub.
     */
    public readonly eventHub!: pulumi.Output<outputs.mobilenetwork.v20230901.EventHubConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly installation!: pulumi.Output<outputs.mobilenetwork.v20230901.InstallationResponse | undefined>;
    /**
     ...
     */
    public readonly localDiagnosticsAccess!: pulumi.Output<outputs.mobilenetwork.v20230901.LocalDiagnosticsAccessConfigurationResponse>;
    /**
     ...
     */
    public readonly platform!: pulumi.Output<outputs.mobilenetwork.v20230901.PlatformConfigurationResponse>;
    /**
     ...
     */
    public readonly signaling!: pulumi.Output<outputs.mobilenetwork.v20230901.SignalingConfigurationResponse | undefined>;
    /**
     * Site(s) under which this packet core control plane should be deployed. The sites must be in the same location as the packet core control plane.
     */
    public readonly sites!: pulumi.Output<outputs.mobilenetwork.v20230901.SiteResourceIdResponse[]>;
    /**
    ...
    constructor(name: string, args: PacketCoreControlPlaneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["eventHub"] = args ? (args.eventHub ? pulumi.output(args.eventHub).apply(inputs.mobilenetwork.v20230901.eventHubConfigurationArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["identity"] = args ? args.identity : undefined;
            resourceInputs["installation"] = args ? (args.installation ? pulumi.output(args.installation).apply(inputs.mobilenetwork.v20230901.installationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork/v20220301preview:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20220401preview:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20221101:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20230601:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20240201:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork/v20240401:PacketCoreControlPlane" }, { type: "azure-native:mobilenetwork:PacketCoreControlPlane" }] };
...
export interface PacketCoreControlPlaneArgs {
     ...
     * The control plane interface on the access network. For 5G networks, this is the N2 interface. For 4G networks, this is the S1-MME interface.
     */
    controlPlaneAccessInterface: pulumi.Input<inputs.mobilenetwork.v20230901.InterfacePropertiesArgs>;
    /**
     * The virtual IP address(es) for the control plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to anycast traffic for this address to the control plane access interfaces on the active and standby nodes. In non-HA system this list should be omitted or empty.
     */
     ...
     * The core network technology generation (5G core or EPC / 4G core).
     */
    coreNetworkTechnology?: pulumi.Input<string | enums.mobilenetwork.v20230901.CoreNetworkType>;
    /**
     * Configuration for uploading packet core diagnostics
     */
    diagnosticsUpload?: pulumi.Input<inputs.mobilenetwork.v20230901.DiagnosticsUploadConfigurationArgs>;
    /**
     * Configuration for sending packet core events to an Azure Event Hub.
     */
    eventHub?: pulumi.Input<inputs.mobilenetwork.v20230901.EventHubConfigurationArgs>;
    /**
     * The identity used to retrieve the ingress certificate from Azure key vault.
     */
     ...
     * The installation state of the packet core control plane resource.
     */
    installation?: pulumi.Input<inputs.mobilenetwork.v20230901.InstallationArgs>;
    /**
     * Settings to allow interoperability with third party components e.g. RANs and UEs.
     */
    interopSettings?: any;
     ...
     * The kubernetes ingress configuration to control access to packet core diagnostics over local APIs.
     */
    localDiagnosticsAccess: pulumi.Input<inputs.mobilenetwork.v20230901.LocalDiagnosticsAccessConfigurationArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The platform where the packet core is deployed.
     */
    platform: pulumi.Input<inputs.mobilenetwork.v20230901.PlatformConfigurationArgs>;
    /**
     ...
     * Signaling configuration for the packet core.
     */
    signaling?: pulumi.Input<inputs.mobilenetwork.v20230901.SignalingConfigurationArgs>;
    /**
     * Site(s) under which this packet core control plane should be deployed. The sites must be in the same location as the packet core control plane.
     */
    sites: pulumi.Input<pulumi.Input<inputs.mobilenetwork.v20230901.SiteResourceIdArgs>[]>;
    /**
     * The SKU defining the throughput and SIM allowances for this packet core control plane deployment.
     */
    sku: pulumi.Input<string | enums.mobilenetwork.v20230901.BillingSku>;
    /**
     * Resource tags.
     */
