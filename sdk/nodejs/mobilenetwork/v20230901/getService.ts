...
export interface GetServiceResult {
     ...
     */
    readonly pccRules: outputs.mobilenetwork.v20230901.PccRuleConfigurationResponse[];
    /**
     ...
     */
    readonly serviceQosPolicy?: outputs.mobilenetwork.v20230901.QosPolicyResponse;
    /**
...
export function getServiceOutput(args: GetServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:mobilenetwork/v20230901:getService", {
        "mobileNetworkName": args.mobileNetworkName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
