...
export class CustomLocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:extendedlocation/v20200715privatepreview:customLocation';
     ...
     */
    public readonly authentication!: pulumi.Output<outputs.extendedlocation.v20200715privatepreview.CustomLocationPropertiesResponseAuthentication | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.extendedlocation.v20200715privatepreview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: CustomLocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:extendedlocation/v20200715privatepreview:customLocation" }, { type: "azure-native:extendedlocation:customLocation" }, { type: "azure-nextgen:extendedlocation:customLocation" }, { type: "azure-native:extendedlocation/v20210315preview:customLocation" }, { type: "azure-nextgen:extendedlocation/v20210315preview:customLocation" }] };
...
export interface CustomLocationArgs {
     ...
     * Type of host the Custom Locations is referencing (Kubernetes, etc...).
     */
    readonly hostType?: pulumi.Input<string | enums.extendedlocation.v20200715privatepreview.HostType>;
    /**
     * The geo-location where the resource lives
     */
