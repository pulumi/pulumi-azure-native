...
export class OperationalizationCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OperationalizationClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningcompute:OperationalizationCluster" }, { type: "azure-nextgen:machinelearningcompute/v20170801preview:OperationalizationCluster" }] };
...
export interface OperationalizationClusterArgs {
     ...
     * The cluster type.
     */
    readonly clusterType: pulumi.Input<string | enums.machinelearningcompute.v20170601preview.ClusterType>;
    /**
     * Container Registry properties.
     */
