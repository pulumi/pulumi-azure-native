...
export class OperationalizationCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningcompute/v20170801preview:OperationalizationCluster';
    ...
    constructor(name: string, argsOrState?: OperationalizationClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningcompute/preview:OperationalizationCluster" }, { type: "azurerm:machinelearningcompute/v20170601preview:OperationalizationCluster" }] };
