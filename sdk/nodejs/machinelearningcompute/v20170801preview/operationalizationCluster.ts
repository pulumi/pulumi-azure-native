...
export class OperationalizationCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:machinelearningcompute/v20170801preview:OperationalizationCluster';
    ...
    constructor(name: string, args: OperationalizationClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:machinelearningcompute:OperationalizationCluster" }, { type: "azure-nextgen:machinelearningcompute/v20170601preview:OperationalizationCluster" }] };
