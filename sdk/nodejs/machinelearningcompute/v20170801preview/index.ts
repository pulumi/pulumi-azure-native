...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:machinelearningcompute/v20170801preview:OperationalizationCluster":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "machinelearningcompute/v20170801preview", _module)
