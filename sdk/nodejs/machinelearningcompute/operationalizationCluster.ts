...
export class OperationalizationCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OperationalizationClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["containerService"] = args ? (args.containerService ? pulumi.output(args.containerService).apply(inputs.machinelearningcompute.acsClusterPropertiesArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["description"] = args ? args.description : undefined;
            resourceInputs["globalServiceConfiguration"] = args ? (args.globalServiceConfiguration ? pulumi.output(args.globalServiceConfiguration).apply(inputs.machinelearningcompute.globalServiceConfigurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningcompute/v20170801preview:OperationalizationCluster" }] };
