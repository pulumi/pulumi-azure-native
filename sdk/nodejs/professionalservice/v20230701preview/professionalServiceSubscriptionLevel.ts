...
export class ProfessionalServiceSubscriptionLevel extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.professionalservice.v20230701preview.ProfessionalServiceResourceResponseProperties>;
    /**
     * the resource tags.
     */
...
export interface ProfessionalServiceSubscriptionLevelArgs {
     ...
     */
    properties?: pulumi.Input<inputs.professionalservice.v20230701preview.ProfessionalServiceCreationPropertiesArgs>;
    /**
