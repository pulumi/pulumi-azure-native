...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azureplaywrightservice/v20240201:Account';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.azureplaywrightservice.v20240201.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface AccountArgs {
     ...
     * This property sets the connection region for Playwright client workers to cloud-hosted browsers. If enabled, workers connect to browsers in the closest Azure region, ensuring lower latency. If disabled, workers connect to browsers in the Azure region in which the workspace was initially created.
     */
    regionalAffinity?: pulumi.Input<string | enums.azureplaywrightservice.v20240201.EnablementStatus>;
    /**
     * When enabled, this feature allows the workspace to upload and display test results, including artifacts like traces and screenshots, in the Playwright portal. This enables faster and more efficient troubleshooting.
     */
    reporting?: pulumi.Input<string | enums.azureplaywrightservice.v20240201.EnablementStatus>;
    /**
     ...
     * When enabled, Playwright client workers can connect to cloud-hosted browsers. This can increase the number of parallel workers for a test run, significantly minimizing test completion durations.
     */
    scalableExecution?: pulumi.Input<string | enums.azureplaywrightservice.v20240201.EnablementStatus>;
    /**
     * Resource tags.
     */
