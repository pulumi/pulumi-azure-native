...
export class ConfigurationProfilePreference extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.automanage.ConfigurationProfilePreferencePropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ConfigurationProfilePreferenceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automanage:ConfigurationProfilePreference" }, { type: "azure-native:automanage/v20200630preview:ConfigurationProfilePreference" }, { type: "azure-nextgen:automanage/v20200630preview:ConfigurationProfilePreference" }] };
...
export interface ConfigurationProfilePreferenceArgs {
     ...
     * Properties of the configuration profile preference.
     */
    readonly properties?: pulumi.Input<inputs.automanage.ConfigurationProfilePreferenceProperties>;
    /**
