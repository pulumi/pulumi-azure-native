...
export class ConfigurationProfilePreference extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationProfilePreference {
        return new ConfigurationProfilePreference(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:automanage/preview:ConfigurationProfilePreference';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.automanage.preview.ConfigurationProfilePreferencePropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ConfigurationProfilePreferenceArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ConfigurationProfilePreferenceArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automanage/v20200630preview:ConfigurationProfilePreference" }] };
...
export interface ConfigurationProfilePreferenceArgs {
     ...
     * Properties of the configuration profile preference.
     */
    readonly properties?: pulumi.Input<inputs.automanage.preview.ConfigurationProfilePreferenceProperties>;
    /**
