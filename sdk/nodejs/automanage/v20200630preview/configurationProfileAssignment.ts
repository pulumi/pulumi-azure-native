...
export class ConfigurationProfileAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:automanage/v20200630preview:ConfigurationProfileAssignment';
    ...
    constructor(name: string, args: ConfigurationProfileAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automanage:ConfigurationProfileAssignment" }] };
...
export interface ConfigurationProfileAssignmentArgs {
     ...
     * Properties of the configuration profile assignment.
     */
    readonly properties?: pulumi.Input<inputs.automanage.v20200630preview.ConfigurationProfileAssignmentProperties>;
    /**
