...
export class ConfigurationProfile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationProfile {
        pulumi.log.warn("ConfigurationProfile is deprecated: azure-native:automanage/v20210430preview:ConfigurationProfile is being removed in the next major version of this provider. Please upgrade to azure-native:automanage/v20220504:ConfigurationProfile to guarantee forwards compatibility.")
