...
export class ConfigurationProfile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationProfile {
        pulumi.log.warn("ConfigurationProfile is deprecated: azure-native:automanage/v20210430preview:ConfigurationProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:automanage/v20220504:ConfigurationProfile to guarantee forwards compatibility.")
        return new ConfigurationProfile(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:automanage/v20210430preview:ConfigurationProfile';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.automanage.v20210430preview.ConfigurationProfilePropertiesResponse>;
    /**
