...
export class ConfigurationProfileAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationProfileAssignment {
        pulumi.log.warn("ConfigurationProfileAssignment is deprecated: azure-native:automanage/v20210430preview:ConfigurationProfileAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:automanage/v20220504:ConfigurationProfileAssignment to guarantee forwards compatibility.")
