...
export class ConfigurationProfileAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationProfileAssignment {
        pulumi.log.warn("ConfigurationProfileAssignment is deprecated: azure-native:automanage/v20210430preview:ConfigurationProfileAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:automanage/v20220504:ConfigurationProfileAssignment to guarantee forwards compatibility.")
        return new ConfigurationProfileAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:automanage/v20210430preview:ConfigurationProfileAssignment';
    ...
    constructor(name: string, args: ConfigurationProfileAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automanage:ConfigurationProfileAssignment" }, { type: "azure-native:automanage/v20200630preview:ConfigurationProfileAssignment" }, { type: "azure-native:automanage/v20220504:ConfigurationProfileAssignment" }] };
