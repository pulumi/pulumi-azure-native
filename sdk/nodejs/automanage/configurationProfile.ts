...
export class ConfigurationProfile extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.automanage.ConfigurationProfilePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ConfigurationProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["configurationProfileName"] = args ? args.configurationProfileName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automanage:ConfigurationProfile" }, { type: "azure-native:automanage/v20210430preview:ConfigurationProfile" }, { type: "azure-nextgen:automanage/v20210430preview:ConfigurationProfile" }] };
