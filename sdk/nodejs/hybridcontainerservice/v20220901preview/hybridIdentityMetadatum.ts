...
export class HybridIdentityMetadatum extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HybridIdentityMetadatumArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice/v20220501preview:HybridIdentityMetadatum" }, { type: "azure-native:hybridcontainerservice/v20231115preview:HybridIdentityMetadatum" }, { type: "azure-native:hybridcontainerservice/v20240101:HybridIdentityMetadatum" }, { type: "azure-native:hybridcontainerservice:HybridIdentityMetadatum" }] };
