...
export class StorageSpaceRetrieve extends pulumi.CustomResource {
    ...
    public readonly extendedLocation!: pulumi.Output<outputs.hybridcontainerservice.v20220901preview.StorageSpacesResponseExtendedLocation | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridcontainerservice.v20220901preview.StorageSpacesPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: StorageSpaceRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice:storageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220501preview:storageSpaceRetrieve" }] };
