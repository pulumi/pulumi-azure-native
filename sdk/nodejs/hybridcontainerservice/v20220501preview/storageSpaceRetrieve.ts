...
export class StorageSpaceRetrieve extends pulumi.CustomResource {
    ...
    public readonly extendedLocation!: pulumi.Output<outputs.hybridcontainerservice.v20220501preview.StorageSpacesResponseExtendedLocation | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridcontainerservice.v20220501preview.StorageSpacesPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: StorageSpaceRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice/v20220501preview:storageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice:StorageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice:storageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220901preview:StorageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220901preview:storageSpaceRetrieve" }] };
