...
export class VirtualNetworkRetrieve extends pulumi.CustomResource {
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.hybridcontainerservice.v20240101.VirtualNetworkResponseExtendedLocation | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridcontainerservice.v20240101.VirtualNetworkPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice:VirtualNetworkRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220501preview:VirtualNetworkRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220901preview:VirtualNetworkRetrieve" }, { type: "azure-native:hybridcontainerservice/v20231115preview:VirtualNetworkRetrieve" }] };
