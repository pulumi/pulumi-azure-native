...
// Export enums:
export * from "../../types/enums/hybridcontainerservice/v20240101";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:hybridcontainerservice/v20240101:ClusterInstanceAgentPool":
                return new ClusterInstanceAgentPool(name, <any>undefined, { urn })
            case "azure-native:hybridcontainerservice/v20240101:ClusterInstanceHybridIdentityMetadatum":
