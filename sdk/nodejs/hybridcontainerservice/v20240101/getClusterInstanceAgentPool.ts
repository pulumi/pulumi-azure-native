...
export function getClusterInstanceAgentPool(args: GetClusterInstanceAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterInstanceAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:hybridcontainerservice/v20240101:getClusterInstanceAgentPool", {
...
export function getClusterInstanceAgentPoolOutput(args: GetClusterInstanceAgentPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterInstanceAgentPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:hybridcontainerservice/v20240101:getClusterInstanceAgentPool", {
        "agentPoolName": args.agentPoolName,
        "connectedClusterResourceUri": args.connectedClusterResourceUri,
    }, opts);
}
