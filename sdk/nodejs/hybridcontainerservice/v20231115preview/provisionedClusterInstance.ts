...
export class ProvisionedClusterInstance extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.hybridcontainerservice.v20231115preview.ProvisionedClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ProvisionedClusterInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.hybridcontainerservice.v20231115preview.provisionedClusterPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice/v20240101:ProvisionedClusterInstance" }] };
...
export interface ProvisionedClusterInstanceArgs {
     ...
     * All properties of the provisioned cluster
     */
    properties?: pulumi.Input<inputs.hybridcontainerservice.v20231115preview.ProvisionedClusterPropertiesArgs>;
}
