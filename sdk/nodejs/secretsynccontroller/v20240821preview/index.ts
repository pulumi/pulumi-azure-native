...
// Export enums:
export * from "../../types/enums/secretsynccontroller/v20240821preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:secretsynccontroller/v20240821preview:AzureKeyVaultSecretProviderClass":
                return new AzureKeyVaultSecretProviderClass(name, <any>undefined, { urn })
            case "azure-native:secretsynccontroller/v20240821preview:SecretSync":
...
pulumi.runtime.registerResourceModule("azure-native", "secretsynccontroller/v20240821preview", _module)
