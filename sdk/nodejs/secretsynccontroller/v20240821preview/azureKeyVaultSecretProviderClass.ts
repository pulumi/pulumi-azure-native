...
export class AzureKeyVaultSecretProviderClass extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:secretsynccontroller/v20240821preview:AzureKeyVaultSecretProviderClass';
    ...
    constructor(name: string, args: AzureKeyVaultSecretProviderClassArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:secretsynccontroller:AzureKeyVaultSecretProviderClass" }] };
