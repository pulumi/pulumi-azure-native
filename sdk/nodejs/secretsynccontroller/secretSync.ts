...
export class SecretSync extends pulumi.CustomResource {
     ...
     */
    declare public readonly objectSecretMapping: pulumi.Output<outputs.secretsynccontroller.KubernetesSecretObjectMappingResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.secretsynccontroller.SecretSyncStatusResponse>;
    /**
