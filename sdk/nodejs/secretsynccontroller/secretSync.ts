...
export class SecretSync extends pulumi.CustomResource {
     ...
     */
    public readonly objectSecretMapping!: pulumi.Output<outputs.secretsynccontroller.KubernetesSecretObjectMappingResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.secretsynccontroller.SecretSyncStatusResponse>;
    /**
