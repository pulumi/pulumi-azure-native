...
export class EventHubAuthorizationRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.eventhub.v20140901.SharedAccessAuthorizationRulePropertiesResponse>;
    /**
     * Resource type
     */
...
export interface EventHubAuthorizationRuleArgs {
     ...
     * Properties supplied to create or update SharedAccessAuthorizationRule
     */
    readonly properties?: pulumi.Input<inputs.eventhub.v20140901.SharedAccessAuthorizationRuleProperties>;
    /**
