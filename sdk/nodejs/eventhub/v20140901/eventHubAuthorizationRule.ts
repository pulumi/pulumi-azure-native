...
export class EventHubAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub/v20140901:EventHubAuthorizationRule';
    ...
    constructor(name: string, argsOrState?: EventHubAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/latest:EventHubAuthorizationRule" }, { type: "azurerm:eventhub/preview:EventHubAuthorizationRule" }, { type: "azurerm:eventhub/v20150801:EventHubAuthorizationRule" }, { type: "azurerm:eventhub/v20170401:EventHubAuthorizationRule" }] };
