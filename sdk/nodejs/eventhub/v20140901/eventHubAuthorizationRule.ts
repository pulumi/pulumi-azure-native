...
export class EventHubAuthorizationRule extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: EventHubAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/latest:EventHubAuthorizationRule" }, { type: "azurerm:eventhub/v20150801:EventHubAuthorizationRule" }, { type: "azurerm:eventhub/v20170401:EventHubAuthorizationRule" }] };
