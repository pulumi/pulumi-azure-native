...
export class ConsumerGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConsumerGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventhub/latest:ConsumerGroup" }, { type: "azure-nextgen:eventhub/v20140901:ConsumerGroup" }, { type: "azure-nextgen:eventhub/v20150801:ConsumerGroup" }, { type: "azure-nextgen:eventhub/v20180101preview:ConsumerGroup" }] };
