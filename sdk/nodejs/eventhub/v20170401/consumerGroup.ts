...
export class ConsumerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub/v20170401:ConsumerGroup';
    ...
    constructor(name: string, args: ConsumerGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/latest:ConsumerGroup" }, { type: "azurerm:eventhub/preview:ConsumerGroup" }, { type: "azurerm:eventhub/v20140901:ConsumerGroup" }, { type: "azurerm:eventhub/v20150801:ConsumerGroup" }] };
