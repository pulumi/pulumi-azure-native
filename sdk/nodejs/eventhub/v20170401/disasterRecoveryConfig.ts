...
export class DisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20170401:DisasterRecoveryConfig';
    ...
    constructor(name: string, args: DisasterRecoveryConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventhub:DisasterRecoveryConfig" }, { type: "azure-native:eventhub/v20180101preview:DisasterRecoveryConfig" }, { type: "azure-native:eventhub/v20220101preview:DisasterRecoveryConfig" }, { type: "azure-native:eventhub/v20221001preview:DisasterRecoveryConfig" }] };
