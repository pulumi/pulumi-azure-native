...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20170401:NamespaceAuthorizationRule';
    ...
    constructor(name: string, args: NamespaceAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventhub:NamespaceAuthorizationRule" }, { type: "azure-native:eventhub/v20180101preview:NamespaceAuthorizationRule" }, { type: "azure-native:eventhub/v20220101preview:NamespaceAuthorizationRule" }, { type: "azure-native:eventhub/v20221001preview:NamespaceAuthorizationRule" }] };
