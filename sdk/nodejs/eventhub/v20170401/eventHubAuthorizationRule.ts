...
export class EventHubAuthorizationRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventHubAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventhub:EventHubAuthorizationRule" }, { type: "azure-nextgen:eventhub/latest:EventHubAuthorizationRule" }, { type: "azure-nextgen:eventhub/v20140901:EventHubAuthorizationRule" }, { type: "azure-nextgen:eventhub/v20150801:EventHubAuthorizationRule" }, { type: "azure-nextgen:eventhub/v20180101preview:EventHubAuthorizationRule" }] };
...
export interface EventHubAuthorizationRuleArgs {
     ...
     * The rights associated with the rule.
     */
    readonly rights: pulumi.Input<pulumi.Input<string | enums.eventhub.v20170401.AccessRights>[]>;
}
