...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:eventhub/v20170401:NamespaceNetworkRuleSet';
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<outputs.eventhub.v20170401.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.eventhub.v20170401.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
    ...
    constructor(name: string, args: NamespaceNetworkRuleSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventhub:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:eventhub/latest:NamespaceNetworkRuleSet" }, { type: "azure-nextgen:eventhub/v20180101preview:NamespaceNetworkRuleSet" }] };
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * List of IpRules
     */
    readonly ipRules?: pulumi.Input<pulumi.Input<inputs.eventhub.v20170401.NWRuleSetIpRules>[]>;
    /**
     * The Namespace name
     */
     ...
     * List VirtualNetwork Rules
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.eventhub.v20170401.NWRuleSetVirtualNetworkRules>[]>;
}
