...
export class EventHub extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventhub/latest:EventHub" }, { type: "azure-nextgen:eventhub/v20140901:EventHub" }, { type: "azure-nextgen:eventhub/v20150801:EventHub" }, { type: "azure-nextgen:eventhub/v20180101preview:EventHub" }] };
