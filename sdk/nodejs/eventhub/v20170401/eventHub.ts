...
export class EventHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub/v20170401:EventHub';
    ...
    constructor(name: string, argsOrState?: EventHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/latest:EventHub" }, { type: "azurerm:eventhub/preview:EventHub" }, { type: "azurerm:eventhub/v20140901:EventHub" }, { type: "azurerm:eventhub/v20150801:EventHub" }] };
