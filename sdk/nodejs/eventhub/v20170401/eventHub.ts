...
export class EventHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:eventhub/v20170401:EventHub';
    ...
    constructor(name: string, args: EventHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventhub:EventHub" }, { type: "azure-nextgen:eventhub/latest:EventHub" }, { type: "azure-nextgen:eventhub/v20140901:EventHub" }, { type: "azure-nextgen:eventhub/v20150801:EventHub" }, { type: "azure-nextgen:eventhub/v20180101preview:EventHub" }] };
...
export interface EventHubArgs {
     ...
     * Enumerates the possible values for the status of the Event Hub.
     */
    readonly status?: pulumi.Input<enums.eventhub.v20170401.EntityStatus>;
}
