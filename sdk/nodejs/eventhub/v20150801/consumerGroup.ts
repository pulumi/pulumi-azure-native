...
export class ConsumerGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConsumerGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/latest:ConsumerGroup" }, { type: "azurerm:eventhub/v20140901:ConsumerGroup" }, { type: "azurerm:eventhub/v20170401:ConsumerGroup" }] };
