...
export class DisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DisasterRecoveryConfig {
        pulumi.log.warn("DisasterRecoveryConfig is deprecated: azure-native:eventhub/v20180101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.")
        return new DisasterRecoveryConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20180101preview:DisasterRecoveryConfig';
