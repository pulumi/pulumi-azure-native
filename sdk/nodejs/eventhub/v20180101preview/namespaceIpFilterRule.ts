...
export class NamespaceIpFilterRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NamespaceIpFilterRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventhub/v20180101preview:NamespaceIpFilterRule" }, { type: "azure-native:eventhub:NamespaceIpFilterRule" }, { type: "azure-nextgen:eventhub:NamespaceIpFilterRule" }] };
