 ...
 *
 * @deprecated azure-native:eventhub/v20180101preview:Namespace is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:Namespace to guarantee forwards compatibility.
 */
export class Namespace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Namespace {
        pulumi.log.warn("Namespace is deprecated: azure-native:eventhub/v20180101preview:Namespace is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:Namespace to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: NamespaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["encryption"] = args ? (args.encryption ? pulumi.output(args.encryption).apply(inputs.eventhub.v20180101preview.encryptionArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["identity"] = args ? (args.identity ? pulumi.output(args.identity).apply(inputs.eventhub.v20180101preview.identityArgsProvideDefaults) : undefined) : undefined;
