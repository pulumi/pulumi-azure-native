 ...
 *
 * @deprecated azure-native:eventhub/v20180101preview:EventHubAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHubAuthorizationRule to guarantee forwards compatibility.
 */
export class EventHubAuthorizationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventHubAuthorizationRule {
        pulumi.log.warn("EventHubAuthorizationRule is deprecated: azure-native:eventhub/v20180101preview:EventHubAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHubAuthorizationRule to guarantee forwards compatibility.")
