...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamespaceNetworkRuleSet {
        pulumi.log.warn("NamespaceNetworkRuleSet is deprecated: azure-native:eventhub/v20210101preview:NamespaceNetworkRuleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:NamespaceNetworkRuleSet to guarantee forwards compatibility.")
        return new NamespaceNetworkRuleSet(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20210101preview:NamespaceNetworkRuleSet';
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<outputs.eventhub.v20210101preview.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.eventhub.v20210101preview.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
