...
export class EventHub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventHub {
        pulumi.log.warn("EventHub is deprecated: azure-native:eventhub/v20210101preview:EventHub is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.")
        return new EventHub(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20210101preview:EventHub';
     ...
     */
    public readonly captureDescription!: pulumi.Output<outputs.eventhub.v20210101preview.CaptureDescriptionResponse | undefined>;
    /**
