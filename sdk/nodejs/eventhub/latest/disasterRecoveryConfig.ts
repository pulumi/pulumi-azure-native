...
export class DisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub/latest:DisasterRecoveryConfig';
    ...
    constructor(name: string, argsOrState?: DisasterRecoveryConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/preview:DisasterRecoveryConfig" }, { type: "azurerm:eventhub/v20170401:DisasterRecoveryConfig" }] };
