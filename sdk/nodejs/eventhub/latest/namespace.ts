 ...
 *
 * const namespace = new azurerm.eventhub.latest.Namespace("namespace", {
...
export class Namespace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub/latest:Namespace';
    ...
    constructor(name: string, argsOrState?: NamespaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/v20140901:Namespace" }, { type: "azurerm:eventhub/v20150801:Namespace" }, { type: "azurerm:eventhub/v20170401:Namespace" }] };
