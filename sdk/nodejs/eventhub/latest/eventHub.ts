...
export class EventHub extends pulumi.CustomResource {
     ...
     */
    public readonly captureDescription!: pulumi.Output<outputs.eventhub.latest.CaptureDescriptionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EventHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:eventhub/v20140901:EventHub" }, { type: "azure-nextgen:eventhub/v20150801:EventHub" }, { type: "azure-nextgen:eventhub/v20170401:EventHub" }, { type: "azure-nextgen:eventhub/v20180101preview:EventHub" }] };
...
export interface EventHubArgs {
     ...
     * Properties of capture description
     */
    readonly captureDescription?: pulumi.Input<inputs.eventhub.latest.CaptureDescription>;
    /**
     * The Event Hub name
     */
     ...
     * Enumerates the possible values for the status of the Event Hub.
     */
    readonly status?: pulumi.Input<enums.eventhub.latest.EntityStatus>;
}
