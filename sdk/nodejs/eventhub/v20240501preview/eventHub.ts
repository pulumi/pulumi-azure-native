...
export class EventHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20240501preview:EventHub';
     ...
     */
    public readonly captureDescription!: pulumi.Output<outputs.eventhub.v20240501preview.CaptureDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly retentionDescription!: pulumi.Output<outputs.eventhub.v20240501preview.RetentionDescriptionResponse | undefined>;
    /**
