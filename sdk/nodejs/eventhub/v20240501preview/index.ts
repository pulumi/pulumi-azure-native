...
// Export enums:
export * from "../../types/enums/eventhub/v20240501preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:eventhub/v20240501preview:ApplicationGroup":
                return new ApplicationGroup(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:ConsumerGroup":
                return new ConsumerGroup(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:DisasterRecoveryConfig":
                return new DisasterRecoveryConfig(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:EventHub":
                return new EventHub(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:EventHubAuthorizationRule":
                return new EventHubAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:Namespace":
                return new Namespace(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:NamespaceAuthorizationRule":
                return new NamespaceAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:NamespaceNetworkRuleSet":
                return new NamespaceNetworkRuleSet(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:eventhub/v20240501preview:SchemaRegistry":
...
pulumi.runtime.registerResourceModule("azure-native", "eventhub/v20240501preview", _module)
