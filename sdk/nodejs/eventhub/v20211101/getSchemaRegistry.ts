 ...
 */
/** @deprecated azure-native:eventhub/v20211101:SchemaRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:SchemaRegistry to guarantee forwards compatibility. */
export function getSchemaRegistry(args: GetSchemaRegistryArgs, opts?: pulumi.InvokeOptions): Promise<GetSchemaRegistryResult> {
    pulumi.log.warn("getSchemaRegistry is deprecated: azure-native:eventhub/v20211101:SchemaRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:SchemaRegistry to guarantee forwards compatibility.")
