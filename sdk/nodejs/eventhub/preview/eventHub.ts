...
export class EventHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub/preview:EventHub';
     ...
     */
    public readonly captureDescription!: pulumi.Output<outputs.eventhub.preview.CaptureDescriptionResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EventHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/latest:EventHub" }, { type: "azurerm:eventhub/v20140901:EventHub" }, { type: "azurerm:eventhub/v20150801:EventHub" }, { type: "azurerm:eventhub/v20170401:EventHub" }] };
...
export interface EventHubArgs {
     ...
     * Properties of capture description
     */
    readonly captureDescription?: pulumi.Input<inputs.eventhub.preview.CaptureDescription>;
    /**
     * The Event Hub name
     */
