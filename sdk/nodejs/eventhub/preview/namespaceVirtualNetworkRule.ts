...
export class NamespaceVirtualNetworkRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamespaceVirtualNetworkRule {
        return new NamespaceVirtualNetworkRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub/preview:NamespaceVirtualNetworkRule';
    ...
    constructor(name: string, argsOrState?: NamespaceVirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as NamespaceVirtualNetworkRuleArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/v20180101preview:NamespaceVirtualNetworkRule" }] };
