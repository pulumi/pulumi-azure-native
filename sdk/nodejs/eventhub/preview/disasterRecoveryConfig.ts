...
export class DisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub/preview:DisasterRecoveryConfig';
    ...
    constructor(name: string, args: DisasterRecoveryConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:eventhub/latest:DisasterRecoveryConfig" }, { type: "azurerm:eventhub/v20170401:DisasterRecoveryConfig" }] };
