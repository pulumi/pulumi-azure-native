...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20210601preview:NamespaceAuthorizationRule';
