...
export class Namespace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Namespace {
        pulumi.log.warn("Namespace is deprecated: azure-native:eventhub/v20210601preview:Namespace is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:Namespace to guarantee forwards compatibility.")
        return new Namespace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20210601preview:Namespace';
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.eventhub.v20210601preview.EncryptionResponse | undefined>;
    /**
     * Properties of BYOK Identity description
     */
    public readonly identity!: pulumi.Output<outputs.eventhub.v20210601preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly privateEndpointConnections!: pulumi.Output<outputs.eventhub.v20210601preview.PrivateEndpointConnectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.eventhub.v20210601preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NamespaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["encryption"] = args ? (args.encryption ? pulumi.output(args.encryption).apply(inputs.eventhub.v20210601preview.encryptionArgsProvideDefaults) : undefined) : undefined;
