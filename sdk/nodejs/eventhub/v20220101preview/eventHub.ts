...
export class EventHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20220101preview:EventHub';
     ...
     */
    public readonly captureDescription!: pulumi.Output<outputs.eventhub.v20220101preview.CaptureDescriptionResponse | undefined>;
    /**
...
export interface EventHubArgs {
     ...
     * Properties of capture description
     */
    captureDescription?: pulumi.Input<inputs.eventhub.v20220101preview.CaptureDescriptionArgs>;
    /**
     * The Event Hub name
     */
     ...
     * Enumerates the possible values for the status of the Event Hub.
     */
    status?: pulumi.Input<enums.eventhub.v20220101preview.EntityStatus>;
}
