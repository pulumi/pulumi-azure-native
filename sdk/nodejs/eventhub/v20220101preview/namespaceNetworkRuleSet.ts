...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20220101preview:NamespaceNetworkRuleSet';
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<outputs.eventhub.v20220101preview.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.eventhub.v20220101preview.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * Default Action for Network Rule Set
     */
    defaultAction?: pulumi.Input<string | enums.eventhub.v20220101preview.DefaultAction>;
    /**
     * List of IpRules
     */
    ipRules?: pulumi.Input<pulumi.Input<inputs.eventhub.v20220101preview.NWRuleSetIpRulesArgs>[]>;
    /**
     * The Namespace name
     */
     ...
     * This determines if traffic is allowed over public network. By default it is enabled. If value is SecuredByPerimeter then Inbound and Outbound communication is controlled by the network security perimeter and profile's access rules. 
     */
    publicNetworkAccess?: pulumi.Input<string | enums.eventhub.v20220101preview.PublicNetworkAccessFlag>;
    /**
     ...
     * List VirtualNetwork Rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.eventhub.v20220101preview.NWRuleSetVirtualNetworkRulesArgs>[]>;
}
