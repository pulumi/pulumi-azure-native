...
export class EventHubAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20220101preview:EventHubAuthorizationRule';
...
export interface EventHubAuthorizationRuleArgs {
     ...
     * The rights associated with the rule.
     */
    rights: pulumi.Input<pulumi.Input<string | enums.eventhub.v20220101preview.AccessRights>[]>;
}
