...
export class NamespaceDisasterRecoveryConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:eventhub:NamespaceDisasterRecoveryConfig';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.eventhub.ArmDisasterRecoveryResponseProperties>;
    /**
     * Resource type.
     */
...
export interface NamespaceDisasterRecoveryConfigState {
     ...
     * Properties required to the Create Or Update Alias(Disaster Recovery configurations)
     */
    readonly properties: pulumi.Input<inputs.eventhub.ArmDisasterRecoveryResponseProperties>;
    /**
     * Resource type.
     */
...
export interface NamespaceDisasterRecoveryConfigArgs {
     ...
     * Properties required to the Create Or Update Alias(Disaster Recovery configurations)
     */
    readonly properties?: pulumi.Input<inputs.eventhub.ArmDisasterRecoveryProperties>;
    /**
