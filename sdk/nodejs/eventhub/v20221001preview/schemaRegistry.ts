 ...
 *
 * const schemaRegistry = new azure_native.eventhub.v20221001preview.SchemaRegistry("schemaRegistry", {
 *     groupProperties: {},
 ...
 *
 * ```sh
 * $ pulumi import azure-native:eventhub/v20221001preview:SchemaRegistry testSchemaGroup1 /subscriptions/e8baea74-64ce-459b-bee3-5aa4c47b3ae3/resourceGroups/alitest/providers/Microsoft.EventHub/namespaces/ali-ua-test-eh-system-1/schemagroups/testSchemaGroup1 
 * ```
 */
export class SchemaRegistry extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SchemaRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventhub:SchemaRegistry" }, { type: "azure-native:eventhub/v20211101:SchemaRegistry" }, { type: "azure-native:eventhub/v20220101preview:SchemaRegistry" }] };
