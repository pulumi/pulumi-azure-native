 ...
 *
 * const applicationGroup = new azure_native.eventhub.v20221001preview.ApplicationGroup("applicationGroup", {
...
export class ApplicationGroup extends pulumi.CustomResource {
     ...
     */
    public readonly policies!: pulumi.Output<outputs.eventhub.v20221001preview.ThrottlingPolicyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ApplicationGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventhub/v20220101preview:ApplicationGroup" }] };
...
export interface ApplicationGroupArgs {
     ...
     * List of group policies that define the behavior of application group. The policies can support resource governance scenarios such as limiting ingress or egress traffic.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.eventhub.v20221001preview.ThrottlingPolicyArgs>[]>;
    /**
