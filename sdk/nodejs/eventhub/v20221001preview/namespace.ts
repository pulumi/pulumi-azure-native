 ...
 *
 * const namespace = new azure_native.eventhub.v20221001preview.Namespace("namespace", {
 ...
 *     encryption: {
 *         keySource: azure_native.eventhub.v20221001preview.KeySource.Microsoft_KeyVault,
 *         keyVaultProperties: [{
 *             identity: {
 ...
 *     },
 *     identity: {
 *         type: azure_native.eventhub.v20221001preview.ManagedServiceIdentityType.SystemAssigned_UserAssigned,
...
export class Namespace extends pulumi.CustomResource {
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.eventhub.v20221001preview.EncryptionResponse | undefined>;
    /**
     * Properties of BYOK Identity description
     */
    public readonly identity!: pulumi.Output<outputs.eventhub.v20221001preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly privateEndpointConnections!: pulumi.Output<outputs.eventhub.v20221001preview.PrivateEndpointConnectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.eventhub.v20221001preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NamespaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["encryption"] = args ? (args.encryption ? pulumi.output(args.encryption).apply(inputs.eventhub.v20221001preview.encryptionArgsProvideDefaults) : undefined) : undefined;
