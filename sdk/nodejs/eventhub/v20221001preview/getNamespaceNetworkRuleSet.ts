...
export interface GetNamespaceNetworkRuleSetResult {
     ...
     * List of IpRules
     */
    readonly ipRules?: outputs.eventhub.v20221001preview.NWRuleSetIpRulesResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: outputs.eventhub.v20221001preview.NWRuleSetVirtualNetworkRulesResponse[];
}
/**
 * Gets NetworkRuleSet for a Namespace.
 */
export function getNamespaceNetworkRuleSetOutput(args: GetNamespaceNetworkRuleSetOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNamespaceNetworkRuleSetResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:eventhub/v20221001preview:getNamespaceNetworkRuleSet", {
        "namespaceName": args.namespaceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
