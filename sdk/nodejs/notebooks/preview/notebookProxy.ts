...
export class NotebookProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:notebooks/preview:NotebookProxy';
    ...
    constructor(name: string, args: NotebookProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:notebooks/v20191011preview:NotebookProxy" }] };
