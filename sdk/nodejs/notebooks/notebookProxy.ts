...
export class NotebookProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:notebooks:NotebookProxy';
     ...
     */
    public readonly systemData!: pulumi.Output<outputs.notebooks.NotebookResourceSystemDataResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NotebookProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:notebooks:NotebookProxy" }, { type: "azure-native:notebooks/v20191011preview:NotebookProxy" }, { type: "azure-nextgen:notebooks/v20191011preview:NotebookProxy" }] };
...
export interface NotebookProxyArgs {
     ...
     * System data for notebook resource
     */
    systemData?: pulumi.Input<inputs.notebooks.NotebookResourceSystemDataArgs>;
}
