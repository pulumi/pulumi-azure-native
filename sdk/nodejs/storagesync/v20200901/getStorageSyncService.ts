...
export function getStorageSyncService(args: GetStorageSyncServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageSyncServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storagesync/v20200901:getStorageSyncService", {
...
export interface GetStorageSyncServiceResult {
     ...
     */
    readonly privateEndpointConnections: outputs.storagesync.v20200901.PrivateEndpointConnectionInvokeResponse[];
    /**
