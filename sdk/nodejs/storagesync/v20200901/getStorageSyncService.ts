...
export function getStorageSyncService(args: GetStorageSyncServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageSyncServiceResult> {
    pulumi.log.warn("getStorageSyncService is deprecated: azure-native:storagesync/v20200901:StorageSyncService is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20220601:StorageSyncService to guarantee forwards compatibility.")
