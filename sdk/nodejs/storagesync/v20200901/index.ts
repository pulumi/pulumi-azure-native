...
// Export enums:
export * from "../../types/enums/storagesync/v20200901";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:storagesync/v20200901:CloudEndpoint":
                return new CloudEndpoint(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20200901:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20200901:RegisteredServer":
                return new RegisteredServer(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20200901:ServerEndpoint":
                return new ServerEndpoint(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20200901:StorageSyncService":
                return new StorageSyncService(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20200901:SyncGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "storagesync/v20200901", _module)
