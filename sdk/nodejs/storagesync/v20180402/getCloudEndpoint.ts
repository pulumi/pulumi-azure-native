...
export function getCloudEndpoint(args: GetCloudEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storagesync/v20180402:getCloudEndpoint", {
        "name": args.name,
...
export interface GetCloudEndpointResult {
     ...
     */
    readonly properties: outputs.storagesync.v20180402.CloudEndpointPropertiesResponse;
    /**
