...
export function getServerEndpoint(args: GetServerEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetServerEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storagesync/v20180402:getServerEndpoint", {
        "name": args.name,
...
export interface GetServerEndpointResult {
     ...
     */
    readonly properties: outputs.storagesync.v20180402.ServerEndpointPropertiesResponse;
    /**
