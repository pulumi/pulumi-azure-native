...
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.storagesync.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagesync:PrivateEndpointConnection" }, { type: "azure-native:storagesync/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:storagesync/latest:PrivateEndpointConnection" }, { type: "azure-native:storagesync/v20200301:PrivateEndpointConnection" }, { type: "azure-nextgen:storagesync/v20200301:PrivateEndpointConnection" }, { type: "azure-native:storagesync/v20200901:PrivateEndpointConnection" }, { type: "azure-nextgen:storagesync/v20200901:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.storagesync.PrivateLinkServiceConnectionState>;
    /**
