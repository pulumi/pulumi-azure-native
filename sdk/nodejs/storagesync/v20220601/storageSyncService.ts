...
export class StorageSyncService extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.storagesync.v20220601.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: StorageSyncServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagesync:StorageSyncService" }, { type: "azure-native:storagesync/v20200301:StorageSyncService" }, { type: "azure-native:storagesync/v20200901:StorageSyncService" }] };
