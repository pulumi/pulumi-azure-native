...
export class CloudEndpoint extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly changeEnumerationStatus!: pulumi.Output<outputs.storagesync.v20220601.CloudEndpointChangeEnumerationStatusResponse>;
    /**
     * Friendly Name
     */
    ...
    constructor(name: string, args: CloudEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagesync:CloudEndpoint" }, { type: "azure-native:storagesync/v20200301:CloudEndpoint" }, { type: "azure-native:storagesync/v20200901:CloudEndpoint" }] };
