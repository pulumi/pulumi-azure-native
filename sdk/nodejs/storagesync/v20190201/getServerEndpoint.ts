...
export function getServerEndpoint(args: GetServerEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetServerEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storagesync/v20190201:getServerEndpoint", {
...
export interface GetServerEndpointResult {
     ...
     */
    readonly syncStatus: outputs.storagesync.v20190201.ServerEndpointSyncStatusInvokeResponse;
    /**
