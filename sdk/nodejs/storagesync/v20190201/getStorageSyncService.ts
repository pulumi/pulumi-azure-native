...
export function getStorageSyncService(args: GetStorageSyncServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageSyncServiceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storagesync/v20190201:getStorageSyncService", {
        "name": args.name,
...
export interface GetStorageSyncServiceResult {
     ...
     */
    readonly properties: outputs.storagesync.v20190201.StorageSyncServicePropertiesResponse;
    /**
     * Resource tags.
     */
