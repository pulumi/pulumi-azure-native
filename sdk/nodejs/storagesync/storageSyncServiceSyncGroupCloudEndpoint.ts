...
export class StorageSyncServiceSyncGroupCloudEndpoint extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StorageSyncServiceSyncGroupCloudEndpointState, opts?: pulumi.CustomResourceOptions): StorageSyncServiceSyncGroupCloudEndpoint {
        return new StorageSyncServiceSyncGroupCloudEndpoint(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: StorageSyncServiceSyncGroupCloudEndpointArgs | StorageSyncServiceSyncGroupCloudEndpointState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as StorageSyncServiceSyncGroupCloudEndpointState | undefined;
            inputs["name"] = state ? state.name : undefined;
            inputs["properties"] = state ? state.properties : undefined;
            inputs["type"] = state ? state.type : undefined;
        } else {
            const args = argsOrState as StorageSyncServiceSyncGroupCloudEndpointArgs | undefined;
 ...
 * Cloud Endpoint object.
 */
export interface StorageSyncServiceSyncGroupCloudEndpointState {
    /**
     * The name of the resource
     */
     ...
     * Cloud Endpoint properties.
     */
    readonly properties: pulumi.Input<inputs.storagesync.CloudEndpointPropertiesResponse>;
    /**
     * The type of the resource. Ex- Microsoft.Compute/virtualMachines or Microsoft.Storage/storageAccounts.
     */
