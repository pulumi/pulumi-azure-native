...
export class CloudEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:storagesync/v20181001:CloudEndpoint';
    ...
    constructor(name: string, args: CloudEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagesync:CloudEndpoint" }, { type: "azure-nextgen:storagesync/latest:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20170605preview:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20180402:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20180701:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20190201:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20190301:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20190601:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20191001:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20200301:CloudEndpoint" }, { type: "azure-nextgen:storagesync/v20200901:CloudEndpoint" }] };
