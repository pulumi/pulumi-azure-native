...
export function getServerEndpoint(args: GetServerEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetServerEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storagesync/v20181001:getServerEndpoint", {
...
export interface GetServerEndpointResult {
     ...
     */
    readonly syncStatus?: outputs.storagesync.v20181001.ServerEndpointHealthInvokeResponse;
    /**
