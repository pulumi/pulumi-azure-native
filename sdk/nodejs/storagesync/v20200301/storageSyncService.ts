...
export class StorageSyncService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageSyncServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagesync/v20200301:StorageSyncService" }, { type: "azure-native:storagesync:StorageSyncService" }, { type: "azure-nextgen:storagesync:StorageSyncService" }, { type: "azure-native:storagesync/v20170605preview:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20170605preview:StorageSyncService" }, { type: "azure-native:storagesync/v20180402:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20180402:StorageSyncService" }, { type: "azure-native:storagesync/v20180701:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20180701:StorageSyncService" }, { type: "azure-native:storagesync/v20181001:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20181001:StorageSyncService" }, { type: "azure-native:storagesync/v20190201:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20190201:StorageSyncService" }, { type: "azure-native:storagesync/v20190301:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20190301:StorageSyncService" }, { type: "azure-native:storagesync/v20190601:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20190601:StorageSyncService" }, { type: "azure-native:storagesync/v20191001:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20191001:StorageSyncService" }, { type: "azure-native:storagesync/v20200901:StorageSyncService" }, { type: "azure-nextgen:storagesync/v20200901:StorageSyncService" }] };
...
export interface StorageSyncServiceArgs {
     ...
     * Incoming Traffic Policy
     */
    incomingTrafficPolicy?: pulumi.Input<string | enums.storagesync.v20200301.IncomingTrafficPolicy>;
    /**
