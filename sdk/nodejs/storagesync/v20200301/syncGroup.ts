...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagesync/v20200301:SyncGroup';
    ...
    constructor(name: string, args: SyncGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagesync/latest:SyncGroup" }, { type: "azurerm:storagesync/preview:SyncGroup" }, { type: "azurerm:storagesync/v20170605preview:SyncGroup" }, { type: "azurerm:storagesync/v20180402:SyncGroup" }, { type: "azurerm:storagesync/v20180701:SyncGroup" }, { type: "azurerm:storagesync/v20181001:SyncGroup" }, { type: "azurerm:storagesync/v20190201:SyncGroup" }, { type: "azurerm:storagesync/v20190301:SyncGroup" }, { type: "azurerm:storagesync/v20190601:SyncGroup" }, { type: "azurerm:storagesync/v20191001:SyncGroup" }] };
