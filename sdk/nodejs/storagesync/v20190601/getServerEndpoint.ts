...
export function getServerEndpoint(args: GetServerEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetServerEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storagesync/v20190601:getServerEndpoint", {
...
export interface GetServerEndpointResult {
     ...
     */
    readonly cloudTieringStatus: outputs.storagesync.v20190601.ServerEndpointCloudTieringStatusInvokeResponse;
    /**
     * Friendly Name
     */
     ...
     */
    readonly recallStatus: outputs.storagesync.v20190601.ServerEndpointRecallStatusInvokeResponse;
    /**
     * Server Local path.
     */
     ...
     */
    readonly syncStatus: outputs.storagesync.v20190601.ServerEndpointSyncStatusInvokeResponse;
    /**
