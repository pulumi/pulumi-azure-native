...
export function getServerEndpoint(args: GetServerEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetServerEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storagesync/preview:getServerEndpoint", {
...
export interface GetServerEndpointResult {
     ...
     */
    readonly cloudTieringStatus: outputs.storagesync.preview.ServerEndpointCloudTieringStatusResponse;
    /**
     * Friendly Name
     */
     ...
     */
    readonly recallStatus: outputs.storagesync.preview.ServerEndpointRecallStatusResponse;
    /**
     * Server Local path.
     */
     ...
     */
    readonly syncStatus: outputs.storagesync.preview.ServerEndpointSyncStatusResponse;
    /**
