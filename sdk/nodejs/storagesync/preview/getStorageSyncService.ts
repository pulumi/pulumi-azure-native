...
export function getStorageSyncService(args: GetStorageSyncServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageSyncServiceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storagesync/preview:getStorageSyncService", {
...
export interface GetStorageSyncServiceResult {
     ...
     */
    readonly privateEndpointConnections: outputs.storagesync.preview.PrivateEndpointConnectionResponse[];
    /**
