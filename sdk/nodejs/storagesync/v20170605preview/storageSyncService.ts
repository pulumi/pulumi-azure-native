 ...
 *
 * const storageSyncService = new azurerm.storagesync.v20170605preview.StorageSyncService("storageSyncService", {
 *     location: "WestUS",
...
export class StorageSyncService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagesync/v20170605preview:StorageSyncService';
    ...
    constructor(name: string, args: StorageSyncServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagesync/latest:StorageSyncService" }, { type: "azurerm:storagesync/v20180402:StorageSyncService" }, { type: "azurerm:storagesync/v20180701:StorageSyncService" }, { type: "azurerm:storagesync/v20181001:StorageSyncService" }, { type: "azurerm:storagesync/v20190201:StorageSyncService" }, { type: "azurerm:storagesync/v20190301:StorageSyncService" }, { type: "azurerm:storagesync/v20190601:StorageSyncService" }, { type: "azurerm:storagesync/v20191001:StorageSyncService" }, { type: "azurerm:storagesync/v20200301:StorageSyncService" }] };
