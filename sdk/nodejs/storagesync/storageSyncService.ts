...
export class StorageSyncService extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StorageSyncServiceState, opts?: pulumi.CustomResourceOptions): StorageSyncService {
        return new StorageSyncService(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagesync:StorageSyncService';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.storagesync.StorageSyncServicePropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: StorageSyncServiceArgs | StorageSyncServiceState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as StorageSyncServiceState | undefined;
...
export interface StorageSyncServiceState {
     ...
     * Storage Sync Service properties.
     */
    readonly properties: pulumi.Input<inputs.storagesync.StorageSyncServicePropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface StorageSyncServiceArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.storagesync.StorageSyncServiceCreateParametersProperties>;
    /**
