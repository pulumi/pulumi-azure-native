...
export class RegisteredServer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegisteredServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagesync/latest:RegisteredServer" }, { type: "azurerm:storagesync/preview:RegisteredServer" }, { type: "azurerm:storagesync/v20170605preview:RegisteredServer" }, { type: "azurerm:storagesync/v20180402:RegisteredServer" }, { type: "azurerm:storagesync/v20180701:RegisteredServer" }, { type: "azurerm:storagesync/v20181001:RegisteredServer" }, { type: "azurerm:storagesync/v20190201:RegisteredServer" }, { type: "azurerm:storagesync/v20190601:RegisteredServer" }, { type: "azurerm:storagesync/v20191001:RegisteredServer" }, { type: "azurerm:storagesync/v20200301:RegisteredServer" }] };
