...
export class ServerEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ServerEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagesync/v20180402:ServerEndpoint" }, { type: "azurerm:storagesync/v20180701:ServerEndpoint" }, { type: "azurerm:storagesync/v20181001:ServerEndpoint" }, { type: "azurerm:storagesync/v20190201:ServerEndpoint" }, { type: "azurerm:storagesync/v20190601:ServerEndpoint" }, { type: "azurerm:storagesync/v20191001:ServerEndpoint" }, { type: "azurerm:storagesync/v20200301:ServerEndpoint" }] };
