...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagesync:SyncGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.storagesync.SyncGroupPropertiesResponse>;
    /**
...
export interface SyncGroupArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.storagesync.SyncGroupCreateParametersProperties>;
    /**
