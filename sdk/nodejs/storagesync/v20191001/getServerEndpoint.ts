...
export function getServerEndpoint(args: GetServerEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetServerEndpointResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storagesync/v20191001:getServerEndpoint", {
        "name": args.name,
...
export interface GetServerEndpointResult {
     ...
     */
    readonly properties: outputs.storagesync.v20191001.ServerEndpointPropertiesResponse;
    /**
