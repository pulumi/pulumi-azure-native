...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:storagesync/v20191001:SyncGroup';
    ...
    constructor(name: string, args: SyncGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagesync:SyncGroup" }, { type: "azure-nextgen:storagesync/latest:SyncGroup" }, { type: "azure-nextgen:storagesync/v20170605preview:SyncGroup" }, { type: "azure-nextgen:storagesync/v20180402:SyncGroup" }, { type: "azure-nextgen:storagesync/v20180701:SyncGroup" }, { type: "azure-nextgen:storagesync/v20181001:SyncGroup" }, { type: "azure-nextgen:storagesync/v20190201:SyncGroup" }, { type: "azure-nextgen:storagesync/v20190301:SyncGroup" }, { type: "azure-nextgen:storagesync/v20190601:SyncGroup" }, { type: "azure-nextgen:storagesync/v20200301:SyncGroup" }, { type: "azure-nextgen:storagesync/v20200901:SyncGroup" }] };
