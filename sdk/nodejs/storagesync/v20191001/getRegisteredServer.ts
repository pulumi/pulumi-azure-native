...
export function getRegisteredServer(args: GetRegisteredServerArgs, opts?: pulumi.InvokeOptions): Promise<GetRegisteredServerResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storagesync/v20191001:getRegisteredServer", {
        "name": args.name,
...
export interface GetRegisteredServerResult {
     ...
     */
    readonly properties: outputs.storagesync.v20191001.RegisteredServerPropertiesResponse;
    /**
