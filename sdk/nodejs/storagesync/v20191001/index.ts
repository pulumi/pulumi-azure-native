...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:storagesync/v20191001:CloudEndpoint":
                return new CloudEndpoint(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20191001:RegisteredServer":
                return new RegisteredServer(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20191001:ServerEndpoint":
                return new ServerEndpoint(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20191001:StorageSyncService":
                return new StorageSyncService(name, <any>undefined, { urn })
            case "azure-nextgen:storagesync/v20191001:SyncGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "storagesync/v20191001", _module)
