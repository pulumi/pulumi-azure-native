 ...
 *
 * const cloudEndpoint = new azurerm.storagesync.latest.CloudEndpoint("cloudEndpoint", {
...
export class CloudEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storagesync/latest:CloudEndpoint';
