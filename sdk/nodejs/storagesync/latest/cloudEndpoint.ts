...
export class CloudEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CloudEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storagesync/preview:CloudEndpoint" }, { type: "azurerm:storagesync/v20170605preview:CloudEndpoint" }, { type: "azurerm:storagesync/v20180402:CloudEndpoint" }, { type: "azurerm:storagesync/v20180701:CloudEndpoint" }, { type: "azurerm:storagesync/v20181001:CloudEndpoint" }, { type: "azurerm:storagesync/v20190201:CloudEndpoint" }, { type: "azurerm:storagesync/v20190301:CloudEndpoint" }, { type: "azurerm:storagesync/v20190601:CloudEndpoint" }, { type: "azurerm:storagesync/v20191001:CloudEndpoint" }, { type: "azurerm:storagesync/v20200301:CloudEndpoint" }] };
