 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storagesync:ServerEndpoint'.
 */
export class ServerEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagesync/latest:ServerEndpoint';
     ...
     */
    public /*out*/ readonly cloudTieringStatus!: pulumi.Output<outputs.storagesync.latest.ServerEndpointCloudTieringStatusResponse>;
    /**
     * Friendly Name
     */
     ...
     */
    public /*out*/ readonly recallStatus!: pulumi.Output<outputs.storagesync.latest.ServerEndpointRecallStatusResponse>;
    /**
     * Server Local path.
     */
     ...
     */
    public /*out*/ readonly syncStatus!: pulumi.Output<outputs.storagesync.latest.ServerEndpointSyncStatusResponse>;
    /**
    ...
    constructor(name: string, args: ServerEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagesync/latest:ServerEndpoint" }, { type: "azure-native:storagesync:ServerEndpoint" }, { type: "azure-nextgen:storagesync:ServerEndpoint" }, { type: "azure-native:storagesync/v20170605preview:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20170605preview:ServerEndpoint" }, { type: "azure-native:storagesync/v20180402:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20180402:ServerEndpoint" }, { type: "azure-native:storagesync/v20180701:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20180701:ServerEndpoint" }, { type: "azure-native:storagesync/v20181001:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20181001:ServerEndpoint" }, { type: "azure-native:storagesync/v20190201:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20190201:ServerEndpoint" }, { type: "azure-native:storagesync/v20190301:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20190301:ServerEndpoint" }, { type: "azure-native:storagesync/v20190601:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20190601:ServerEndpoint" }, { type: "azure-native:storagesync/v20191001:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20191001:ServerEndpoint" }, { type: "azure-native:storagesync/v20200301:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20200301:ServerEndpoint" }, { type: "azure-native:storagesync/v20200901:ServerEndpoint" }, { type: "azure-nextgen:storagesync/v20200901:ServerEndpoint" }] };
...
export interface ServerEndpointArgs {
     ...
     * Cloud Tiering.
     */
    readonly cloudTiering?: pulumi.Input<string | enums.storagesync.latest.FeatureStatus>;
    /**
     * Friendly Name
     */
     ...
     * Policy for how namespace and files are recalled during FastDr.
     */
    readonly initialDownloadPolicy?: pulumi.Input<string | enums.storagesync.latest.InitialDownloadPolicy>;
    /**
     * Policy for enabling follow-the-sun business models: link local cache to cloud behavior to pre-populate before local access.
     */
    readonly localCacheMode?: pulumi.Input<string | enums.storagesync.latest.LocalCacheMode>;
    /**
     * Offline data transfer
     */
    readonly offlineDataTransfer?: pulumi.Input<string | enums.storagesync.latest.FeatureStatus>;
    /**
     * Offline data transfer share name
     */
