 ...
 */
/** @deprecated The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storagesync:getServerEndpoint'. */
export function getServerEndpoint(args: GetServerEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetServerEndpointResult> {
    pulumi.log.warn("getServerEndpoint is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storagesync:getServerEndpoint'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:storagesync/latest:getServerEndpoint", {
...
export interface GetServerEndpointResult {
     ...
     */
    readonly cloudTieringStatus: outputs.storagesync.latest.ServerEndpointCloudTieringStatusResponse;
    /**
     * Friendly Name
     */
     ...
     */
    readonly recallStatus: outputs.storagesync.latest.ServerEndpointRecallStatusResponse;
    /**
     * Server Local path.
     */
     ...
     */
    readonly syncStatus: outputs.storagesync.latest.ServerEndpointSyncStatusResponse;
    /**
