 ...
 *
 * const cloudEndpoint = new azure_native.storagesync.v20180701.CloudEndpoint("cloudEndpoint", {
...
export class CloudEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CloudEndpoint {
        pulumi.log.warn("CloudEndpoint is deprecated: Version 2018-07-01 will be removed in v2 of the provider.")
