...
export function getStorageSyncService(args: GetStorageSyncServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageSyncServiceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storagesync/v20180701:getStorageSyncService", {
        "name": args.name,
...
export interface GetStorageSyncServiceResult {
     ...
     */
    readonly properties: outputs.storagesync.v20180701.StorageSyncServicePropertiesResponse;
    /**
     * Resource tags.
     */
