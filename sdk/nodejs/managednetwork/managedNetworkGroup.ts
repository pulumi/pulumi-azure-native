...
export class ManagedNetworkGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedNetworkGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:managednetwork:ManagedNetworkGroup" }, { type: "azure-native:managednetwork/v20190601preview:ManagedNetworkGroup" }, { type: "azure-nextgen:managednetwork/v20190601preview:ManagedNetworkGroup" }] };
...
export interface ManagedNetworkGroupArgs {
     ...
     * Responsibility role under which this Managed Network Group will be created
     */
    readonly kind?: pulumi.Input<string | enums.managednetwork.Kind>;
    /**
     * The geo-location where the resource lives
     */
