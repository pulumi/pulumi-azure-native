...
export class ManagedNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managednetwork/preview:ManagedNetwork';
     ...
     */
    public /*out*/ readonly connectivity!: pulumi.Output<outputs.managednetwork.preview.ConnectivityCollectionResponse>;
    /**
     ...
     */
    public readonly scope!: pulumi.Output<outputs.managednetwork.preview.ScopeResponse | undefined>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: ManagedNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managednetwork/v20190601preview:ManagedNetwork" }] };
...
export interface ManagedNetworkArgs {
     ...
     * The collection of management groups, subscriptions, virtual networks, and subnets by the Managed Network. This is a read-only property that is reflective of all ScopeAssignments for this Managed Network
     */
    readonly scope?: pulumi.Input<inputs.managednetwork.preview.Scope>;
    /**
     * Resource tags
     */
