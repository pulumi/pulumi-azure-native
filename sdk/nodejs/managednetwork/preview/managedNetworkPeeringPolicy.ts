...
export class ManagedNetworkPeeringPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedNetworkPeeringPolicy {
        return new ManagedNetworkPeeringPolicy(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:managednetwork/preview:ManagedNetworkPeeringPolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.managednetwork.preview.ManagedNetworkPeeringPolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagedNetworkPeeringPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ManagedNetworkPeeringPolicyArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managednetwork/v20190601preview:ManagedNetworkPeeringPolicy" }] };
...
export interface ManagedNetworkPeeringPolicyArgs {
     ...
     * Gets or sets the properties of a Managed Network Policy
     */
    readonly properties?: pulumi.Input<inputs.managednetwork.preview.ManagedNetworkPeeringPolicyProperties>;
    /**
