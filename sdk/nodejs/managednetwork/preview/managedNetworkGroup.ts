...
export class ManagedNetworkGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managednetwork/preview:ManagedNetworkGroup';
     ...
     */
    public readonly managementGroups!: pulumi.Output<outputs.managednetwork.preview.ResourceIdResponse[] | undefined>;
    /**
     ...
     */
    public readonly subnets!: pulumi.Output<outputs.managednetwork.preview.ResourceIdResponse[] | undefined>;
    /**
     * The collection of subscriptions covered by the Managed Network
     */
    public readonly subscriptions!: pulumi.Output<outputs.managednetwork.preview.ResourceIdResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworks!: pulumi.Output<outputs.managednetwork.preview.ResourceIdResponse[] | undefined>;
    ...
    constructor(name: string, argsOrState?: ManagedNetworkGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managednetwork/v20190601preview:ManagedNetworkGroup" }] };
...
export interface ManagedNetworkGroupArgs {
     ...
     * The collection of management groups covered by the Managed Network
     */
    readonly managementGroups?: pulumi.Input<pulumi.Input<inputs.managednetwork.preview.ResourceId>[]>;
    /**
     ...
     * The collection of  subnets covered by the Managed Network
     */
    readonly subnets?: pulumi.Input<pulumi.Input<inputs.managednetwork.preview.ResourceId>[]>;
    /**
     * The collection of subscriptions covered by the Managed Network
     */
    readonly subscriptions?: pulumi.Input<pulumi.Input<inputs.managednetwork.preview.ResourceId>[]>;
    /**
     * The collection of virtual nets covered by the Managed Network
     */
    readonly virtualNetworks?: pulumi.Input<pulumi.Input<inputs.managednetwork.preview.ResourceId>[]>;
}
