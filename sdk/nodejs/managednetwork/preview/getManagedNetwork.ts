...
export function getManagedNetwork(args: GetManagedNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedNetworkResult> {
    ...
    return pulumi.runtime.invoke("azurerm:managednetwork/preview:getManagedNetwork", {
...
export interface GetManagedNetworkResult {
     ...
     */
    readonly connectivity: outputs.managednetwork.preview.ConnectivityCollectionResponse;
    /**
     ...
     */
    readonly scope?: outputs.managednetwork.preview.ScopeResponse;
    /**
     * Resource tags
     */
