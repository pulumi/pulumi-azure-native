...
export class ManagedNetworkPeeringPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedNetworkPeeringPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:managednetwork/v20190601preview:ManagedNetworkPeeringPolicy" }, { type: "azure-native:managednetwork:ManagedNetworkPeeringPolicy" }, { type: "azure-nextgen:managednetwork:ManagedNetworkPeeringPolicy" }] };
...
export interface ManagedNetworkPeeringPolicyArgs {
     ...
     * Gets or sets the properties of a Managed Network Policy
     */
    readonly properties?: pulumi.Input<inputs.managednetwork.v20190601preview.ManagedNetworkPeeringPolicyPropertiesArgs>;
    /**
