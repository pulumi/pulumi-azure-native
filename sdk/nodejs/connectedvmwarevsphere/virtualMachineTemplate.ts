...
export class VirtualMachineTemplate extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly disks: pulumi.Output<outputs.connectedvmwarevsphere.VirtualDiskResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly networkInterfaces: pulumi.Output<outputs.connectedvmwarevsphere.NetworkInterfaceResponse[]>;
    /**
