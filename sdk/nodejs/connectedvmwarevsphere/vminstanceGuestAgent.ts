...
export class VMInstanceGuestAgent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VMInstanceGuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere/v20230301preview:VMInstanceGuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20231001:VMInstanceGuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20231201:VMInstanceGuestAgent" }, { type: "azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:VMInstanceGuestAgent" }, { type: "azure-native_connectedvmwarevsphere_v20231001:connectedvmwarevsphere:VMInstanceGuestAgent" }, { type: "azure-native_connectedvmwarevsphere_v20231201:connectedvmwarevsphere:VMInstanceGuestAgent" }] };
