...
export class GuestAgent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20230301preview:GuestAgent" }, { type: "azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:GuestAgent" }, { type: "azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:GuestAgent" }, { type: "azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:GuestAgent" }, { type: "azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:GuestAgent" }] };
