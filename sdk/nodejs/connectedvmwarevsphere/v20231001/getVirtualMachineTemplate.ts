...
export interface GetVirtualMachineTemplateResult {
     ...
     */
    readonly disks: outputs.connectedvmwarevsphere.v20231001.VirtualDiskResponse[];
    /**
     ...
     */
    readonly networkInterfaces: outputs.connectedvmwarevsphere.v20231001.NetworkInterfaceResponse[];
    /**
...
export function getVirtualMachineTemplateOutput(args: GetVirtualMachineTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualMachineTemplateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:connectedvmwarevsphere/v20231001:getVirtualMachineTemplate", {
        "resourceGroupName": args.resourceGroupName,
        "virtualMachineTemplateName": args.virtualMachineTemplateName,
    }, opts);
}
