...
export interface GetGuestAgentResult {
     ...
     */
    readonly credentials?: outputs.connectedvmwarevsphere.v20230301preview.GuestCredentialResponse;
    /**
     ...
     */
    readonly httpProxyConfig?: outputs.connectedvmwarevsphere.v20230301preview.HttpProxyConfigurationResponse;
    /**
...
export function getGuestAgentOutput(args: GetGuestAgentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGuestAgentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:connectedvmwarevsphere/v20230301preview:getGuestAgent", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
        "virtualMachineName": args.virtualMachineName,
    }, opts);
