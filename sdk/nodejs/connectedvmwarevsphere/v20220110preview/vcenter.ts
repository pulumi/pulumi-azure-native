...
export class VCenter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VCenter {
        pulumi.log.warn("VCenter is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:VCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:VCenter to guarantee forwards compatibility.")
        return new VCenter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20220110preview:VCenter';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.connectedvmwarevsphere.v20220110preview.VICredentialResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VCenterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VCenter" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:VCenter" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:VCenter" }] };
...
export interface VCenterArgs {
     ...
     * Username / Password Credentials to connect to vcenter.
     */
    credentials?: pulumi.Input<inputs.connectedvmwarevsphere.v20220110preview.VICredentialArgs>;
    /**
     * Gets or sets the extended location.
     */
