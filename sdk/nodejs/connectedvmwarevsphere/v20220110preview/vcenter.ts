...
export class VCenter extends pulumi.CustomResource {
     ...
     * Resource properties.
     */
    public readonly properties!: pulumi.Output<outputs.connectedvmwarevsphere.v20220110preview.VCenterPropertiesResponse>;
    /**
     * The system data.
     */
...
export interface VCenterArgs {
     ...
     * Resource properties.
     */
    properties: pulumi.Input<inputs.connectedvmwarevsphere.v20220110preview.VCenterPropertiesArgs>;
    /**
