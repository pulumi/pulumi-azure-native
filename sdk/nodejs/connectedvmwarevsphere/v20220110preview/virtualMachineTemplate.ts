...
export class VirtualMachineTemplate extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly disks!: pulumi.Output<outputs.connectedvmwarevsphere.v20220110preview.VirtualDiskResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.connectedvmwarevsphere.v20220110preview.NetworkInterfaceResponse[]>;
    /**
    ...
    constructor(name: string, args: VirtualMachineTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VirtualMachineTemplate" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachineTemplate" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachineTemplate" }] };
