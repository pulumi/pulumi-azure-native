 ...
 *
 * @deprecated azure-native:connectedvmwarevsphere/v20220110preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Datastore to guarantee forwards compatibility.
 */
export class Datastore extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Datastore {
        pulumi.log.warn("Datastore is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Datastore to guarantee forwards compatibility.")
        return new Datastore(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20220110preview:Datastore';
    ...
    constructor(name: string, args: DatastoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:Datastore" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:Datastore" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:Datastore" }] };
