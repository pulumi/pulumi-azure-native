...
export class Host extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Host {
        pulumi.log.warn("Host is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:Host is being removed in the next major version of this provider. Please upgrade to azure-native:connectedvmwarevsphere/v20220715preview:Host to guarantee forwards compatibility.")
