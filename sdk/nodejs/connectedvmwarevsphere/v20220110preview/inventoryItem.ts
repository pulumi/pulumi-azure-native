...
export class InventoryItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InventoryItem {
        pulumi.log.warn("InventoryItem is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:InventoryItem is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:InventoryItem to guarantee forwards compatibility.")
...
export interface InventoryItemArgs {
     ...
     * They inventory type.
     */
    inventoryType: pulumi.Input<string | enums.connectedvmwarevsphere.v20220110preview.InventoryType>;
    /**
     * Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type; e.g. ApiApps are a kind of Microsoft.Web/sites type.  If supported, the resource provider must validate and persist this value.
     */
