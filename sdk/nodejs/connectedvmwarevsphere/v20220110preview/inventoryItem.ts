...
export class InventoryItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InventoryItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:InventoryItem" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:InventoryItem" }] };
