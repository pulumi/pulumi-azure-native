...
export interface GetVirtualMachineTemplateResult {
     ...
     */
    readonly disks: outputs.connectedvmwarevsphere.v20220110preview.VirtualDiskResponse[];
    /**
     ...
     */
    readonly networkInterfaces: outputs.connectedvmwarevsphere.v20220110preview.NetworkInterfaceResponse[];
    /**
...
export function getVirtualMachineTemplateOutput(args: GetVirtualMachineTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualMachineTemplateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:connectedvmwarevsphere/v20220110preview:getVirtualMachineTemplate", {
        "resourceGroupName": args.resourceGroupName,
        "virtualMachineTemplateName": args.virtualMachineTemplateName,
    }, opts);
}
