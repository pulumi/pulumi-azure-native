 ...
 *
 * @deprecated azure-native:connectedvmwarevsphere/v20220110preview:GuestAgent is being removed in the next major version of this provider. Please upgrade to azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent to guarantee forwards compatibility.
 */
export class GuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20220110preview:GuestAgent';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.connectedvmwarevsphere.v20220110preview.GuestCredentialResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<outputs.connectedvmwarevsphere.v20220110preview.HttpProxyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: GuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent" }] };
...
export interface GuestAgentArgs {
     ...
     * Username / Password Credentials to provision guest agent.
     */
    credentials?: pulumi.Input<inputs.connectedvmwarevsphere.v20220110preview.GuestCredentialArgs>;
    /**
     * HTTP Proxy configuration for the VM.
     */
    httpProxyConfig?: pulumi.Input<inputs.connectedvmwarevsphere.v20220110preview.HttpProxyConfigurationArgs>;
    /**
     ...
     * Gets or sets the guest agent provisioning action.
     */
    provisioningAction?: pulumi.Input<string | enums.connectedvmwarevsphere.v20220110preview.ProvisioningAction>;
    /**
