...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VirtualNetwork" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:VirtualNetwork" }] };
