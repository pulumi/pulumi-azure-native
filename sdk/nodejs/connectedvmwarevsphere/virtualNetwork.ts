...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere/v20220715preview:VirtualNetwork" }, { type: "azure-native:connectedvmwarevsphere/v20230301preview:VirtualNetwork" }, { type: "azure-native:connectedvmwarevsphere/v20231001:VirtualNetwork" }, { type: "azure-native:connectedvmwarevsphere/v20231201:VirtualNetwork" }, { type: "azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:VirtualNetwork" }, { type: "azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:VirtualNetwork" }, { type: "azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:VirtualNetwork" }, { type: "azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:VirtualNetwork" }, { type: "azure-native_connectedvmwarevsphere_v20231001:connectedvmwarevsphere:VirtualNetwork" }, { type: "azure-native_connectedvmwarevsphere_v20231201:connectedvmwarevsphere:VirtualNetwork" }] };
