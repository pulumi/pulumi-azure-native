...
export class VirtualNetwork extends pulumi.CustomResource {
     ...
     * Resource properties.
     */
    public readonly properties!: pulumi.Output<outputs.connectedvmwarevsphere.VirtualNetworkPropertiesResponse>;
    /**
     * The system data.
     */
...
export interface VirtualNetworkArgs {
     ...
     * Resource properties.
     */
    properties: pulumi.Input<inputs.connectedvmwarevsphere.VirtualNetworkPropertiesArgs>;
    /**
