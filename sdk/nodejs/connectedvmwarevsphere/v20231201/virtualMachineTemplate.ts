...
export class VirtualMachineTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20231201:VirtualMachineTemplate';
     ...
     */
    public /*out*/ readonly disks!: pulumi.Output<outputs.connectedvmwarevsphere.v20231201.VirtualDiskResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.connectedvmwarevsphere.v20231201.NetworkInterfaceResponse[]>;
    /**
