...
export class VMInstanceGuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20231201:VMInstanceGuestAgent';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.connectedvmwarevsphere.v20231201.GuestCredentialResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<outputs.connectedvmwarevsphere.v20231201.HttpProxyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VMInstanceGuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VMInstanceGuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20230301preview:VMInstanceGuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20231001:VMInstanceGuestAgent" }] };
