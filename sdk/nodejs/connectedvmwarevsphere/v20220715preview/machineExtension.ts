 ...
 *
 * const machineExtension = new azure_native.connectedvmwarevsphere.v20220715preview.MachineExtension("machineExtension", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:connectedvmwarevsphere/v20220715preview:MachineExtension CustomScriptExtension /subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.HybridCompute/Machines/myMachine/Extensions/CustomScriptExtension 
 * ```
 */
export class MachineExtension extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.connectedvmwarevsphere.v20220715preview.MachineExtensionPropertiesResponseInstanceView | undefined>;
    /**
    ...
    constructor(name: string, args: MachineExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:MachineExtension" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:MachineExtension" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:MachineExtension" }] };
