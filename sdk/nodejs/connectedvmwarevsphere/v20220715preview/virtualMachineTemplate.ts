 ...
 *
 * const virtualMachineTemplate = new azure_native.connectedvmwarevsphere.v20220715preview.VirtualMachineTemplate("virtualMachineTemplate", {
 *     extendedLocation: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachineTemplate WebFrontEndTemplate /subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/testrg/providers/Microsoft.ConnectedVMwarevSphere/VirtualMachineTemplates/WebFrontEndTemplate 
 * ```
 */
export class VirtualMachineTemplate extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly disks!: pulumi.Output<outputs.connectedvmwarevsphere.v20220715preview.VirtualDiskResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<outputs.connectedvmwarevsphere.v20220715preview.NetworkInterfaceResponse[]>;
    /**
    ...
    constructor(name: string, args: VirtualMachineTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VirtualMachineTemplate" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachineTemplate" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:VirtualMachineTemplate" }] };
