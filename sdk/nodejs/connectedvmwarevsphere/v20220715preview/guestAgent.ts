 ...
 *
 * const guestAgent = new azure_native.connectedvmwarevsphere.v20220715preview.GuestAgent("guestAgent", {
 *     credentials: {
 *         password: "<password>",
 *         username: "tempuser",
 *     },
...
export class GuestAgent extends pulumi.CustomResource {
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.connectedvmwarevsphere.v20220715preview.GuestCredentialResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<outputs.connectedvmwarevsphere.v20220715preview.HttpProxyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: GuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:GuestAgent" }] };
