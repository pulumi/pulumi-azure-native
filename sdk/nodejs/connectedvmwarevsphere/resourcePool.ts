...
export class ResourcePool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ResourcePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool" }, { type: "azure-native:connectedvmwarevsphere/v20230301preview:ResourcePool" }, { type: "azure-native:connectedvmwarevsphere/v20231001:ResourcePool" }, { type: "azure-native:connectedvmwarevsphere/v20231201:ResourcePool" }, { type: "azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:ResourcePool" }, { type: "azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:ResourcePool" }, { type: "azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:ResourcePool" }, { type: "azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:ResourcePool" }, { type: "azure-native_connectedvmwarevsphere_v20231001:connectedvmwarevsphere:ResourcePool" }, { type: "azure-native_connectedvmwarevsphere_v20231201:connectedvmwarevsphere:ResourcePool" }] };
