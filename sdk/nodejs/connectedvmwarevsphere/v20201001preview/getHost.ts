...
export function getHost(args: GetHostArgs, opts?: pulumi.InvokeOptions): Promise<GetHostResult> {
    pulumi.log.warn("getHost is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:Host is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Host to guarantee forwards compatibility.")
