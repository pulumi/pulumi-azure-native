 ...
 *
 * const virtualMachine = new azure_native.connectedvmwarevsphere.v20201001preview.VirtualMachine("virtualMachine", {
 *     extendedLocation: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachine DemoVM /subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/testrg/providers/Microsoft.ConnectedVMwarevSphere/VirtualMachines/DemoVM 
 * ```
 */
export class VirtualMachine extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VirtualMachine" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:VirtualMachine" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachine" }] };
