 ...
 * Define the cluster.
 *
 * @deprecated azure-native:connectedvmwarevsphere/v20201001preview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Cluster to guarantee forwards compatibility.
 */
export class Cluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Cluster {
        pulumi.log.warn("Cluster is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Cluster to guarantee forwards compatibility.")
        return new Cluster(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20201001preview:Cluster';
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:Cluster" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:Cluster" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:Cluster" }] };
