...
export class Host extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:connectedvmwarevsphere/v20201001preview:Host" }, { type: "azure-native:connectedvmwarevsphere:Host" }, { type: "azure-nextgen:connectedvmwarevsphere:Host" }] };
