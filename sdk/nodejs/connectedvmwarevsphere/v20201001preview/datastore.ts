...
export class Datastore extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatastoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:connectedvmwarevsphere/v20201001preview:Datastore" }, { type: "azure-native:connectedvmwarevsphere:Datastore" }, { type: "azure-nextgen:connectedvmwarevsphere:Datastore" }] };
