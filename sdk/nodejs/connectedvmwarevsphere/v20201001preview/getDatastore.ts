...
export function getDatastore(args: GetDatastoreArgs, opts?: pulumi.InvokeOptions): Promise<GetDatastoreResult> {
    pulumi.log.warn("getDatastore is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Datastore to guarantee forwards compatibility.")
