...
export function getInventoryItem(args: GetInventoryItemArgs, opts?: pulumi.InvokeOptions): Promise<GetInventoryItemResult> {
    pulumi.log.warn("getInventoryItem is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:InventoryItem is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:InventoryItem to guarantee forwards compatibility.")
