 ...
 *
 * const guestAgent = new azure_native.connectedvmwarevsphere.v20201001preview.GuestAgent("guestAgent", {
 *     credentials: {
 *         password: "<password>",
 *         username: "tempuser",
 *     },
...
export class GuestAgent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent" }] };
