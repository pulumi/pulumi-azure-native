...
export function getEmployee(args: GetEmployeeArgs, opts?: pulumi.InvokeOptions): Promise<GetEmployeeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:contoso/v20211101:getEmployee", {
...
export interface GetEmployeeResult {
     ...
     */
    readonly properties: outputs.contoso.v20211101.EmployeePropertiesResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.contoso.v20211101.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getEmployeeOutput(args: GetEmployeeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEmployeeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:contoso/v20211101:getEmployee", {
        "employeeName": args.employeeName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
