...
export class ServiceFabricSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:ServiceFabricSchedule';
    ...
    constructor(name: string, argsOrState?: ServiceFabricScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:ServiceFabricSchedule" }, { type: "azurerm:devtestlab/v20180915:ServiceFabricSchedule" }] };
