...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:VirtualNetwork';
     ...
     */
    public readonly allowedSubnets!: pulumi.Output<outputs.devtestlab.preview.SubnetResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly externalSubnets!: pulumi.Output<outputs.devtestlab.preview.ExternalSubnetResponse[]>;
    /**
     ...
     */
    public readonly subnetOverrides!: pulumi.Output<outputs.devtestlab.preview.SubnetOverrideResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:VirtualNetwork" }, { type: "azurerm:devtestlab/v20150521preview:VirtualNetwork" }, { type: "azurerm:devtestlab/v20160515:VirtualNetwork" }, { type: "azurerm:devtestlab/v20180915:VirtualNetwork" }] };
...
export interface VirtualNetworkArgs {
     ...
     * The allowed subnets of the virtual network.
     */
    readonly allowedSubnets?: pulumi.Input<pulumi.Input<inputs.devtestlab.preview.Subnet>[]>;
    /**
     * The description of the virtual network.
     */
     ...
     * The subnet overrides of the virtual network.
     */
    readonly subnetOverrides?: pulumi.Input<pulumi.Input<inputs.devtestlab.preview.SubnetOverride>[]>;
    /**
     * The tags of the resource.
     */
