...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    ...
    return pulumi.runtime.invoke("azurerm:devtestlab/preview:getVirtualNetwork", {
        "expand": args.expand,
...
export interface GetVirtualNetworkResult {
     ...
     */
    readonly allowedSubnets?: outputs.devtestlab.preview.SubnetResponse[];
    /**
     ...
     */
    readonly externalSubnets: outputs.devtestlab.preview.ExternalSubnetResponse[];
    /**
     ...
     */
    readonly subnetOverrides?: outputs.devtestlab.preview.SubnetOverrideResponse[];
    /**
