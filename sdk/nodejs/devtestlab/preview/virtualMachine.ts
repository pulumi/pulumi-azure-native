...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:VirtualMachine';
     ...
     */
    public readonly artifactDeploymentStatus!: pulumi.Output<outputs.devtestlab.preview.ArtifactDeploymentStatusPropertiesResponse | undefined>;
    /**
     * The artifacts to be installed on the virtual machine.
     */
    public readonly artifacts!: pulumi.Output<outputs.devtestlab.preview.ArtifactInstallPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly computeVm!: pulumi.Output<outputs.devtestlab.preview.ComputeVmPropertiesResponse>;
    /**
     ...
     */
    public readonly dataDiskParameters!: pulumi.Output<outputs.devtestlab.preview.DataDiskPropertiesResponse[] | undefined>;
    /**
     ...
     */
    public readonly galleryImageReference!: pulumi.Output<outputs.devtestlab.preview.GalleryImageReferenceResponse | undefined>;
    /**
     ...
     */
    public readonly networkInterface!: pulumi.Output<outputs.devtestlab.preview.NetworkInterfacePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly scheduleParameters!: pulumi.Output<outputs.devtestlab.preview.ScheduleCreationParameterResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:VirtualMachine" }, { type: "azurerm:devtestlab/v20150521preview:VirtualMachine" }, { type: "azurerm:devtestlab/v20160515:VirtualMachine" }, { type: "azurerm:devtestlab/v20180915:VirtualMachine" }] };
...
export interface VirtualMachineArgs {
     ...
     * The artifact deployment status for the virtual machine.
     */
    readonly artifactDeploymentStatus?: pulumi.Input<inputs.devtestlab.preview.ArtifactDeploymentStatusProperties>;
    /**
     * The artifacts to be installed on the virtual machine.
     */
    readonly artifacts?: pulumi.Input<pulumi.Input<inputs.devtestlab.preview.ArtifactInstallProperties>[]>;
    /**
     * The resource identifier (Microsoft.Compute) of the virtual machine.
     */
     ...
     * New or existing data disks to attach to the virtual machine after creation
     */
    readonly dataDiskParameters?: pulumi.Input<pulumi.Input<inputs.devtestlab.preview.DataDiskProperties>[]>;
    /**
     * Indicates whether the virtual machine is to be created without a public IP address.
     */
     ...
     * The Microsoft Azure Marketplace image reference of the virtual machine.
     */
    readonly galleryImageReference?: pulumi.Input<inputs.devtestlab.preview.GalleryImageReference>;
    /**
     * Indicates whether this virtual machine uses an SSH key for authentication.
     */
     ...
     * The network interface properties.
     */
    readonly networkInterface?: pulumi.Input<inputs.devtestlab.preview.NetworkInterfaceProperties>;
    /**
     * The notes of the virtual machine.
     */
     ...
     * Virtual Machine schedules to be created
     */
    readonly scheduleParameters?: pulumi.Input<pulumi.Input<inputs.devtestlab.preview.ScheduleCreationParameter>[]>;
    /**
     * The size of the virtual machine.
     */
