...
export class GlobalSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:GlobalSchedule';
     ...
     */
    public readonly dailyRecurrence!: pulumi.Output<outputs.devtestlab.preview.DayDetailsResponse | undefined>;
    /**
     * If the schedule will occur multiple times a day, specify the hourly recurrence.
     */
    public readonly hourlyRecurrence!: pulumi.Output<outputs.devtestlab.preview.HourDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly notificationSettings!: pulumi.Output<outputs.devtestlab.preview.NotificationSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly weeklyRecurrence!: pulumi.Output<outputs.devtestlab.preview.WeekDetailsResponse | undefined>;
    ...
    constructor(name: string, args: GlobalScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:GlobalSchedule" }, { type: "azurerm:devtestlab/v20160515:GlobalSchedule" }, { type: "azurerm:devtestlab/v20180915:GlobalSchedule" }] };
...
export interface GlobalScheduleArgs {
     ...
     * If the schedule will occur once each day of the week, specify the daily recurrence.
     */
    readonly dailyRecurrence?: pulumi.Input<inputs.devtestlab.preview.DayDetails>;
    /**
     * If the schedule will occur multiple times a day, specify the hourly recurrence.
     */
    readonly hourlyRecurrence?: pulumi.Input<inputs.devtestlab.preview.HourDetails>;
    /**
     * The location of the resource.
     */
     ...
     * Notification settings.
     */
    readonly notificationSettings?: pulumi.Input<inputs.devtestlab.preview.NotificationSettings>;
    /**
     ...
     * If the schedule will occur only some days of the week, specify the weekly recurrence.
     */
    readonly weeklyRecurrence?: pulumi.Input<inputs.devtestlab.preview.WeekDetails>;
}
