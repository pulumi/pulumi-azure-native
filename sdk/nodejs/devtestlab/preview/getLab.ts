...
export function getLab(args: GetLabArgs, opts?: pulumi.InvokeOptions): Promise<GetLabResult> {
    ...
    return pulumi.runtime.invoke("azurerm:devtestlab/preview:getLab", {
        "expand": args.expand,
        "name": args.name,
...
export interface GetLabResult {
     ...
     */
    readonly announcement?: outputs.devtestlab.preview.LabAnnouncementPropertiesResponse;
    /**
     ...
     */
    readonly support?: outputs.devtestlab.preview.LabSupportPropertiesResponse;
    /**
