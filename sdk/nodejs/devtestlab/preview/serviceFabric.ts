...
export class ServiceFabric extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceFabric {
        return new ServiceFabric(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:ServiceFabric';
     ...
     */
    public /*out*/ readonly applicableSchedule!: pulumi.Output<outputs.devtestlab.preview.ApplicableScheduleResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceFabricArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ServiceFabricArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:ServiceFabric" }, { type: "azurerm:devtestlab/v20180915:ServiceFabric" }] };
