...
export class Lab extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:Lab';
     ...
     */
    public readonly announcement!: pulumi.Output<outputs.devtestlab.preview.LabAnnouncementPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly support!: pulumi.Output<outputs.devtestlab.preview.LabSupportPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:Lab" }, { type: "azurerm:devtestlab/v20150521preview:Lab" }, { type: "azurerm:devtestlab/v20160515:Lab" }, { type: "azurerm:devtestlab/v20180915:Lab" }] };
...
export interface LabArgs {
     ...
     * The properties of any lab announcement associated with this lab
     */
    readonly announcement?: pulumi.Input<inputs.devtestlab.preview.LabAnnouncementProperties>;
    /**
     * The access rights to be granted to the user when provisioning an environment
     */
     ...
     * The properties of any lab support message associated with this lab
     */
    readonly support?: pulumi.Input<inputs.devtestlab.preview.LabSupportProperties>;
    /**
     * The tags of the resource.
     */
