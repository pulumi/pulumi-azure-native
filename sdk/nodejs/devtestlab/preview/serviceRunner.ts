...
export class ServiceRunner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:ServiceRunner';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.devtestlab.preview.IdentityPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceRunnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:ServiceRunner" }, { type: "azurerm:devtestlab/v20160515:ServiceRunner" }, { type: "azurerm:devtestlab/v20180915:ServiceRunner" }] };
...
export interface ServiceRunnerArgs {
     ...
     * The identity of the resource.
     */
    readonly identity?: pulumi.Input<inputs.devtestlab.preview.IdentityProperties>;
    /**
     * The name of the lab.
     */
