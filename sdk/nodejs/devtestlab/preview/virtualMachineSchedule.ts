...
export class VirtualMachineSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:VirtualMachineSchedule';
    ...
    constructor(name: string, args: VirtualMachineScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:VirtualMachineSchedule" }, { type: "azurerm:devtestlab/v20160515:VirtualMachineSchedule" }, { type: "azurerm:devtestlab/v20180915:VirtualMachineSchedule" }] };
