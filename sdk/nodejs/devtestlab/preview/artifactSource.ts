...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:ArtifactSource';
    ...
    constructor(name: string, args: ArtifactSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:ArtifactSource" }, { type: "azurerm:devtestlab/v20150521preview:ArtifactSource" }, { type: "azurerm:devtestlab/v20160515:ArtifactSource" }, { type: "azurerm:devtestlab/v20180915:ArtifactSource" }] };
