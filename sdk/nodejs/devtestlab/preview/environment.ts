...
export class Environment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:Environment';
     ...
     */
    public readonly deploymentProperties!: pulumi.Output<outputs.devtestlab.preview.EnvironmentDeploymentPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:Environment" }, { type: "azurerm:devtestlab/v20160515:Environment" }, { type: "azurerm:devtestlab/v20180915:Environment" }] };
...
export interface EnvironmentArgs {
     ...
     * The deployment properties of the environment.
     */
    readonly deploymentProperties?: pulumi.Input<inputs.devtestlab.preview.EnvironmentDeploymentProperties>;
    /**
     * The name of the lab.
     */
