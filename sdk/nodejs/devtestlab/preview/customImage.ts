...
export class CustomImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:CustomImage';
     ...
     */
    public readonly customImagePlan!: pulumi.Output<outputs.devtestlab.preview.CustomImagePropertiesFromPlanResponse | undefined>;
    /**
     * Storage information about the data disks present in the custom image
     */
    public readonly dataDiskStorageInfo!: pulumi.Output<outputs.devtestlab.preview.DataDiskStorageTypeInfoResponse[] | undefined>;
    /**
     ...
     */
    public readonly vhd!: pulumi.Output<outputs.devtestlab.preview.CustomImagePropertiesCustomResponse | undefined>;
    /**
     * The virtual machine from which the image is to be created.
     */
    public readonly vm!: pulumi.Output<outputs.devtestlab.preview.CustomImagePropertiesFromVmResponse | undefined>;
    ...
    constructor(name: string, argsOrState?: CustomImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:CustomImage" }, { type: "azurerm:devtestlab/v20150521preview:CustomImage" }, { type: "azurerm:devtestlab/v20160515:CustomImage" }, { type: "azurerm:devtestlab/v20180915:CustomImage" }] };
...
export interface CustomImageArgs {
     ...
     * Storage information about the plan related to this custom image
     */
    readonly customImagePlan?: pulumi.Input<inputs.devtestlab.preview.CustomImagePropertiesFromPlan>;
    /**
     * Storage information about the data disks present in the custom image
     */
    readonly dataDiskStorageInfo?: pulumi.Input<pulumi.Input<inputs.devtestlab.preview.DataDiskStorageTypeInfo>[]>;
    /**
     * The description of the custom image.
     */
     ...
     * The VHD from which the image is to be created.
     */
    readonly vhd?: pulumi.Input<inputs.devtestlab.preview.CustomImagePropertiesCustom>;
    /**
     * The virtual machine from which the image is to be created.
     */
    readonly vm?: pulumi.Input<inputs.devtestlab.preview.CustomImagePropertiesFromVm>;
}
