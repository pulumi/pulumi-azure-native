...
export class NotificationChannel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/preview:NotificationChannel';
     ...
     */
    public readonly events!: pulumi.Output<outputs.devtestlab.preview.EventResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: NotificationChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:NotificationChannel" }, { type: "azurerm:devtestlab/v20160515:NotificationChannel" }, { type: "azurerm:devtestlab/v20180915:NotificationChannel" }] };
...
export interface NotificationChannelArgs {
     ...
     * The list of event for which this notification is enabled.
     */
    readonly events?: pulumi.Input<pulumi.Input<inputs.devtestlab.preview.Event>[]>;
    /**
     * The name of the lab.
     */
