...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/latest:ArtifactSource';
    ...
    constructor(name: string, argsOrState?: ArtifactSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/preview:ArtifactSource" }, { type: "azurerm:devtestlab/v20150521preview:ArtifactSource" }, { type: "azurerm:devtestlab/v20160515:ArtifactSource" }, { type: "azurerm:devtestlab/v20180915:ArtifactSource" }] };
