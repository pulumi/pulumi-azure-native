...
export class CustomImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/latest:CustomImage';
    ...
    constructor(name: string, argsOrState?: CustomImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/preview:CustomImage" }, { type: "azurerm:devtestlab/v20150521preview:CustomImage" }, { type: "azurerm:devtestlab/v20160515:CustomImage" }, { type: "azurerm:devtestlab/v20180915:CustomImage" }] };
