...
export class CustomImage extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CustomImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/v20150521preview:CustomImage" }, { type: "azurerm:devtestlab/v20160515:CustomImage" }, { type: "azurerm:devtestlab/v20180915:CustomImage" }] };
