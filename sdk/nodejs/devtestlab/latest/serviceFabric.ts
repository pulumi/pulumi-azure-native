...
export class ServiceFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/latest:ServiceFabric';
    ...
    constructor(name: string, args: ServiceFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/preview:ServiceFabric" }, { type: "azurerm:devtestlab/v20180915:ServiceFabric" }] };
