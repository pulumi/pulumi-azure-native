...
export class ServiceRunner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/latest:ServiceRunner';
    ...
    constructor(name: string, argsOrState?: ServiceRunnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/preview:ServiceRunner" }, { type: "azurerm:devtestlab/v20160515:ServiceRunner" }, { type: "azurerm:devtestlab/v20180915:ServiceRunner" }] };
