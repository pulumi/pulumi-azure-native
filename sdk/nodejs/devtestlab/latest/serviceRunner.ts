...
export class ServiceRunner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devtestlab/latest:ServiceRunner';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.devtestlab.latest.IdentityPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServiceRunnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/latest:ServiceRunner" }, { type: "azure-native:devtestlab:ServiceRunner" }, { type: "azure-nextgen:devtestlab:ServiceRunner" }, { type: "azure-native:devtestlab/v20160515:ServiceRunner" }, { type: "azure-nextgen:devtestlab/v20160515:ServiceRunner" }, { type: "azure-native:devtestlab/v20180915:ServiceRunner" }, { type: "azure-nextgen:devtestlab/v20180915:ServiceRunner" }] };
...
export interface ServiceRunnerArgs {
     ...
     * The identity of the resource.
     */
    readonly identity?: pulumi.Input<inputs.devtestlab.latest.IdentityProperties>;
    /**
     * The name of the lab.
     */
