...
export class Lab extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devtestlab/latest:Lab';
    ...
    constructor(name: string, args: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/latest:Lab" }, { type: "azure-native:devtestlab:Lab" }, { type: "azure-nextgen:devtestlab:Lab" }, { type: "azure-native:devtestlab/v20150521preview:Lab" }, { type: "azure-nextgen:devtestlab/v20150521preview:Lab" }, { type: "azure-native:devtestlab/v20160515:Lab" }, { type: "azure-nextgen:devtestlab/v20160515:Lab" }, { type: "azure-native:devtestlab/v20180915:Lab" }, { type: "azure-nextgen:devtestlab/v20180915:Lab" }] };
...
export interface LabArgs {
     ...
     * The access rights to be granted to the user when provisioning an environment
     */
    readonly environmentPermission?: pulumi.Input<string | enums.devtestlab.latest.EnvironmentPermission>;
    /**
     * Extended properties of the lab used for experimental features
     */
     ...
     * Type of storage used by the lab. It can be either Premium or Standard. Default is Premium.
     */
    readonly labStorageType?: pulumi.Input<string | enums.devtestlab.latest.StorageType>;
    /**
     * The location of the resource.
     */
     ...
     * When its value is 'Disabled', only creation of standard data disks is allowed.
     */
    readonly premiumDataDisks?: pulumi.Input<string | enums.devtestlab.latest.PremiumDataDisk>;
    /**
