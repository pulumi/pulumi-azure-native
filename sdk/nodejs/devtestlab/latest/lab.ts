...
export class Lab extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/preview:Lab" }, { type: "azurerm:devtestlab/v20150521preview:Lab" }, { type: "azurerm:devtestlab/v20160515:Lab" }, { type: "azurerm:devtestlab/v20180915:Lab" }] };
