...
export class Formula extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FormulaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/v20150521preview:Formula" }, { type: "azurerm:devtestlab/v20160515:Formula" }, { type: "azurerm:devtestlab/v20180915:Formula" }] };
