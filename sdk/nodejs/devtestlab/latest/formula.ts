...
export class Formula extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FormulaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/v20150521preview:Formula" }, { type: "azure-nextgen:devtestlab/v20160515:Formula" }, { type: "azure-nextgen:devtestlab/v20180915:Formula" }] };
