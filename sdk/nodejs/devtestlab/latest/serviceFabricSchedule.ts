...
export class ServiceFabricSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devtestlab/latest:ServiceFabricSchedule';
     ...
     */
    public readonly dailyRecurrence!: pulumi.Output<outputs.devtestlab.latest.DayDetailsResponse | undefined>;
    /**
     * If the schedule will occur multiple times a day, specify the hourly recurrence.
     */
    public readonly hourlyRecurrence!: pulumi.Output<outputs.devtestlab.latest.HourDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly notificationSettings!: pulumi.Output<outputs.devtestlab.latest.NotificationSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly weeklyRecurrence!: pulumi.Output<outputs.devtestlab.latest.WeekDetailsResponse | undefined>;
    ...
    constructor(name: string, args: ServiceFabricScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/latest:ServiceFabricSchedule" }, { type: "azure-native:devtestlab:ServiceFabricSchedule" }, { type: "azure-nextgen:devtestlab:ServiceFabricSchedule" }, { type: "azure-native:devtestlab/v20180915:ServiceFabricSchedule" }, { type: "azure-nextgen:devtestlab/v20180915:ServiceFabricSchedule" }] };
...
export interface ServiceFabricScheduleArgs {
     ...
     * If the schedule will occur once each day of the week, specify the daily recurrence.
     */
    readonly dailyRecurrence?: pulumi.Input<inputs.devtestlab.latest.DayDetails>;
    /**
     * If the schedule will occur multiple times a day, specify the hourly recurrence.
     */
    readonly hourlyRecurrence?: pulumi.Input<inputs.devtestlab.latest.HourDetails>;
    /**
     * The name of the lab.
     */
     ...
     * Notification settings.
     */
    readonly notificationSettings?: pulumi.Input<inputs.devtestlab.latest.NotificationSettings>;
    /**
     ...
     * The status of the schedule (i.e. Enabled, Disabled)
     */
    readonly status?: pulumi.Input<string | enums.devtestlab.latest.EnableStatus>;
    /**
     * The tags of the resource.
     */
     ...
     * If the schedule will occur only some days of the week, specify the weekly recurrence.
     */
    readonly weeklyRecurrence?: pulumi.Input<inputs.devtestlab.latest.WeekDetails>;
}
