...
export class ServiceFabricSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/latest:ServiceFabricSchedule';
    ...
    constructor(name: string, args: ServiceFabricScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/preview:ServiceFabricSchedule" }, { type: "azurerm:devtestlab/v20180915:ServiceFabricSchedule" }] };
