...
export class VirtualNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly allowedSubnets!: pulumi.Output<outputs.devtestlab.latest.SubnetResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly externalSubnets!: pulumi.Output<outputs.devtestlab.latest.ExternalSubnetResponse[]>;
    /**
     ...
     */
    public readonly subnetOverrides!: pulumi.Output<outputs.devtestlab.latest.SubnetOverrideResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/latest:VirtualNetwork" }, { type: "azure-native:devtestlab:VirtualNetwork" }, { type: "azure-nextgen:devtestlab:VirtualNetwork" }, { type: "azure-native:devtestlab/v20150521preview:VirtualNetwork" }, { type: "azure-nextgen:devtestlab/v20150521preview:VirtualNetwork" }, { type: "azure-native:devtestlab/v20160515:VirtualNetwork" }, { type: "azure-nextgen:devtestlab/v20160515:VirtualNetwork" }, { type: "azure-native:devtestlab/v20180915:VirtualNetwork" }, { type: "azure-nextgen:devtestlab/v20180915:VirtualNetwork" }] };
...
export interface VirtualNetworkArgs {
     ...
     * The allowed subnets of the virtual network.
     */
    readonly allowedSubnets?: pulumi.Input<pulumi.Input<inputs.devtestlab.latest.Subnet>[]>;
    /**
     * The description of the virtual network.
     */
     ...
     * The subnet overrides of the virtual network.
     */
    readonly subnetOverrides?: pulumi.Input<pulumi.Input<inputs.devtestlab.latest.SubnetOverride>[]>;
    /**
     * The tags of the resource.
     */
