 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:Disk'.
 */
export class Disk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devtestlab/latest:Disk';
    ...
    constructor(name: string, args: DiskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/latest:Disk" }, { type: "azure-native:devtestlab:Disk" }, { type: "azure-nextgen:devtestlab:Disk" }, { type: "azure-native:devtestlab/v20160515:Disk" }, { type: "azure-nextgen:devtestlab/v20160515:Disk" }, { type: "azure-native:devtestlab/v20180915:Disk" }, { type: "azure-nextgen:devtestlab/v20180915:Disk" }] };
...
export interface DiskArgs {
     ...
     * The storage type for the disk (i.e. Standard, Premium).
     */
    readonly diskType?: pulumi.Input<string | enums.devtestlab.latest.StorageType>;
    /**
     * When backed by a blob, the URI of underlying blob.
     */
