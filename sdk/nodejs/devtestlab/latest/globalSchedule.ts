...
export class GlobalSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/latest:GlobalSchedule';
    ...
    constructor(name: string, args: GlobalScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/preview:GlobalSchedule" }, { type: "azurerm:devtestlab/v20160515:GlobalSchedule" }, { type: "azurerm:devtestlab/v20180915:GlobalSchedule" }] };
