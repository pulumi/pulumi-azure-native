...
export class ServiceFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:devtestlab:ServiceFabric';
    ...
    constructor(name: string, args: ServiceFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/latest:ServiceFabric" }, { type: "azure-nextgen:devtestlab/v20180915:ServiceFabric" }] };
