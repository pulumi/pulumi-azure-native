...
export class ServiceFabric extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devtestlab/latest:ServiceFabric" }, { type: "azure-nextgen:devtestlab/latest:ServiceFabric" }, { type: "azure-native:devtestlab/v20180915:ServiceFabric" }, { type: "azure-nextgen:devtestlab/v20180915:ServiceFabric" }] };
