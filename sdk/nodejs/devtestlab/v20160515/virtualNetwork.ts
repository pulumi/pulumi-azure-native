...
export class VirtualNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly allowedSubnets!: pulumi.Output<outputs.devtestlab.v20160515.SubnetResponse[] | undefined>;
    /**
     ...
     */
    public readonly externalSubnets!: pulumi.Output<outputs.devtestlab.v20160515.ExternalSubnetResponse[] | undefined>;
    /**
     ...
     */
    public readonly subnetOverrides!: pulumi.Output<outputs.devtestlab.v20160515.SubnetOverrideResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/v20160515:VirtualNetwork" }, { type: "azure-native:devtestlab:VirtualNetwork" }, { type: "azure-nextgen:devtestlab:VirtualNetwork" }, { type: "azure-native:devtestlab/latest:VirtualNetwork" }, { type: "azure-nextgen:devtestlab/latest:VirtualNetwork" }, { type: "azure-native:devtestlab/v20150521preview:VirtualNetwork" }, { type: "azure-nextgen:devtestlab/v20150521preview:VirtualNetwork" }, { type: "azure-native:devtestlab/v20180915:VirtualNetwork" }, { type: "azure-nextgen:devtestlab/v20180915:VirtualNetwork" }] };
