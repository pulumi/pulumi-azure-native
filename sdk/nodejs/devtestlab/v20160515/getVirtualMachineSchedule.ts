...
export function getVirtualMachineSchedule(args: GetVirtualMachineScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineScheduleResult> {
    pulumi.log.warn("getVirtualMachineSchedule is deprecated: Version v20160515 will be removed in the next major version of the provider. Upgrade to version v20180915 or later.")
    if (!opts) {
        opts = {}
    }
