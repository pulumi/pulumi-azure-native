...
export class ServiceRunner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/v20160515:ServiceRunner';
    ...
    constructor(name: string, argsOrState?: ServiceRunnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:ServiceRunner" }, { type: "azurerm:devtestlab/preview:ServiceRunner" }, { type: "azurerm:devtestlab/v20180915:ServiceRunner" }] };
