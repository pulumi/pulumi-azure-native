...
export class ServiceRunner extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceRunnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:ServiceRunner" }, { type: "azure-nextgen:devtestlab/latest:ServiceRunner" }, { type: "azure-nextgen:devtestlab/v20180915:ServiceRunner" }] };
