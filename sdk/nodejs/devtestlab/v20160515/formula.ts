...
export class Formula extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devtestlab/v20160515:Formula';
    ...
    constructor(name: string, args: FormulaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/v20160515:Formula" }, { type: "azure-native:devtestlab:Formula" }, { type: "azure-nextgen:devtestlab:Formula" }, { type: "azure-native:devtestlab/v20150521preview:Formula" }, { type: "azure-nextgen:devtestlab/v20150521preview:Formula" }, { type: "azure-native:devtestlab/v20180915:Formula" }, { type: "azure-nextgen:devtestlab/v20180915:Formula" }] };
...
export interface FormulaArgs {
     ...
     * The content of the formula.
     */
    readonly formulaContent?: pulumi.Input<inputs.devtestlab.v20160515.LabVirtualMachineCreationParameterArgs>;
    /**
     * The name of the lab.
     */
     ...
     * Information about a VM from which a formula is to be created.
     */
    readonly vm?: pulumi.Input<inputs.devtestlab.v20160515.FormulaPropertiesFromVmArgs>;
}
