 ...
 *
 * ```sh
 * $ pulumi import azure-native:devtestlab/v20160515:Schedule myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/schedules/{name} 
 * ```
 *
...
export class Schedule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Schedule {
        pulumi.log.warn("Schedule is deprecated: Version 2016-05-15 will be removed in v2 of the provider.")
        return new Schedule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:devtestlab/v20160515:Schedule';
    ...
    constructor(name: string, args: ScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devtestlab:Schedule" }, { type: "azure-native:devtestlab/v20150521preview:Schedule" }, { type: "azure-native:devtestlab/v20180915:Schedule" }] };
