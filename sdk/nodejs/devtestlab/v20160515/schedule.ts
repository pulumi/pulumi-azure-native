...
export class Schedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:Schedule" }, { type: "azurerm:devtestlab/v20150521preview:Schedule" }, { type: "azurerm:devtestlab/v20180915:Schedule" }] };
