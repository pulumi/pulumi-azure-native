...
export class GlobalSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:devtestlab/v20160515:GlobalSchedule';
    ...
    constructor(name: string, args: GlobalScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:GlobalSchedule" }, { type: "azure-nextgen:devtestlab/latest:GlobalSchedule" }, { type: "azure-nextgen:devtestlab/v20180915:GlobalSchedule" }] };
