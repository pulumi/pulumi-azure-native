 ...
 *
 * ```sh
 * $ pulumi import azure-native:devtestlab/v20160515:NotificationChannel myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/notificationchannels/{name} 
 * ```
 *
