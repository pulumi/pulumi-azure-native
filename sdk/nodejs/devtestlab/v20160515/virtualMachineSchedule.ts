...
export class VirtualMachineSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:devtestlab/v20160515:VirtualMachineSchedule';
    ...
    constructor(name: string, args: VirtualMachineScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:VirtualMachineSchedule" }, { type: "azure-nextgen:devtestlab/latest:VirtualMachineSchedule" }, { type: "azure-nextgen:devtestlab/v20180915:VirtualMachineSchedule" }] };
