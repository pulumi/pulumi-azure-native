...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ArtifactSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/latest:ArtifactSource" }, { type: "azure-nextgen:devtestlab/v20150521preview:ArtifactSource" }, { type: "azure-nextgen:devtestlab/v20180915:ArtifactSource" }] };
