...
export class Lab extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/v20160515:Lab';
    ...
    constructor(name: string, argsOrState?: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:Lab" }, { type: "azurerm:devtestlab/preview:Lab" }, { type: "azurerm:devtestlab/v20150521preview:Lab" }, { type: "azurerm:devtestlab/v20180915:Lab" }] };
