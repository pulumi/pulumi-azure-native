...
export class Environment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:Environment" }, { type: "azure-nextgen:devtestlab/latest:Environment" }, { type: "azure-nextgen:devtestlab/v20180915:Environment" }] };
