...
export class ServiceFabricSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:devtestlab:ServiceFabricSchedule';
    ...
    constructor(name: string, args: ServiceFabricScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab/latest:ServiceFabricSchedule" }, { type: "azure-nextgen:devtestlab/v20180915:ServiceFabricSchedule" }] };
