...
export class NotificationChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotificationChannel {
        return new NotificationChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab:NotificationChannel';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.devtestlab.NotificationChannelPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: NotificationChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface NotificationChannelArgs {
     ...
     * The properties of the resource.
     */
    readonly properties: pulumi.Input<inputs.devtestlab.NotificationChannelProperties>;
    /**
