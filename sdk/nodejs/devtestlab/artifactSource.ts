...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ArtifactSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:ArtifactSource" }, { type: "azure-native:devtestlab/latest:ArtifactSource" }, { type: "azure-nextgen:devtestlab/latest:ArtifactSource" }, { type: "azure-native:devtestlab/v20150521preview:ArtifactSource" }, { type: "azure-nextgen:devtestlab/v20150521preview:ArtifactSource" }, { type: "azure-native:devtestlab/v20160515:ArtifactSource" }, { type: "azure-nextgen:devtestlab/v20160515:ArtifactSource" }, { type: "azure-native:devtestlab/v20180915:ArtifactSource" }, { type: "azure-nextgen:devtestlab/v20180915:ArtifactSource" }] };
...
export interface ArtifactSourceArgs {
     ...
     * The artifact source's type.
     */
    readonly sourceType?: pulumi.Input<string | enums.devtestlab.SourceControlType>;
    /**
     * Indicates if the artifact source is enabled (values: Enabled, Disabled).
     */
