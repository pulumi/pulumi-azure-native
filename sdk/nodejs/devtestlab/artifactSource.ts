...
export class ArtifactSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab:ArtifactSource';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.devtestlab.ArtifactSourcePropertiesResponse>;
    /**
...
export interface ArtifactSourceArgs {
     ...
     * The properties of the resource.
     */
    readonly properties: pulumi.Input<inputs.devtestlab.ArtifactSourceProperties>;
    /**
