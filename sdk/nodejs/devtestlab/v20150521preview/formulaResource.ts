...
export class FormulaResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:devtestlab/v20150521preview:FormulaResource';
    ...
    constructor(name: string, args: FormulaResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:FormulaResource" }, { type: "azure-nextgen:devtestlab/latest:FormulaResource" }, { type: "azure-nextgen:devtestlab/v20160515:FormulaResource" }, { type: "azure-nextgen:devtestlab/v20180915:FormulaResource" }] };
