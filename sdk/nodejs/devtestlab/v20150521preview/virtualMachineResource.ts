...
export class VirtualMachineResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/v20150521preview:VirtualMachineResource';
    ...
    constructor(name: string, argsOrState?: VirtualMachineResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:VirtualMachineResource" }, { type: "azurerm:devtestlab/preview:VirtualMachineResource" }, { type: "azurerm:devtestlab/v20160515:VirtualMachineResource" }, { type: "azurerm:devtestlab/v20180915:VirtualMachineResource" }] };
