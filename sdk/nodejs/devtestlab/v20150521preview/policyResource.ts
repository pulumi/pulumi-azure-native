...
export class PolicyResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyResource {
        return new PolicyResource(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: PolicyResourceArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PolicyResourceArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:PolicyResource" }, { type: "azurerm:devtestlab/preview:PolicyResource" }, { type: "azurerm:devtestlab/v20160515:PolicyResource" }, { type: "azurerm:devtestlab/v20180915:PolicyResource" }] };
