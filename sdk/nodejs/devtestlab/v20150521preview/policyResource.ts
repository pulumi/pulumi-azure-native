 ...
 *
 * ```sh
 * $ pulumi import azure-native:devtestlab/v20150521preview:PolicyResource myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/policysets/{policySetName}/policies/{name} 
 * ```
 *
