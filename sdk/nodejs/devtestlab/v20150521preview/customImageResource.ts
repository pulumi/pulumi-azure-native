...
export class CustomImageResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomImageResource {
        return new CustomImageResource(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: CustomImageResourceArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CustomImageResourceArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:CustomImageResource" }, { type: "azurerm:devtestlab/preview:CustomImageResource" }, { type: "azurerm:devtestlab/v20160515:CustomImageResource" }, { type: "azurerm:devtestlab/v20180915:CustomImageResource" }] };
