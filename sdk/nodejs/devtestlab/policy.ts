...
export class Policy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:Policy" }, { type: "azure-native:devtestlab/latest:Policy" }, { type: "azure-nextgen:devtestlab/latest:Policy" }, { type: "azure-native:devtestlab/v20150521preview:Policy" }, { type: "azure-nextgen:devtestlab/v20150521preview:Policy" }, { type: "azure-native:devtestlab/v20160515:Policy" }, { type: "azure-nextgen:devtestlab/v20160515:Policy" }, { type: "azure-native:devtestlab/v20180915:Policy" }, { type: "azure-nextgen:devtestlab/v20180915:Policy" }] };
...
export interface PolicyArgs {
     ...
     * The evaluator type of the policy (i.e. AllowedValuesPolicy, MaxValuePolicy).
     */
    readonly evaluatorType?: pulumi.Input<string | enums.devtestlab.PolicyEvaluatorType>;
    /**
     * The fact data of the policy.
     */
     ...
     * The fact name of the policy (e.g. LabVmCount, LabVmSize, MaxVmsAllowedPerLab, etc.
     */
    readonly factName?: pulumi.Input<string | enums.devtestlab.PolicyFactName>;
    /**
     * The name of the lab.
     */
     ...
     * The status of the policy.
     */
    readonly status?: pulumi.Input<string | enums.devtestlab.PolicyStatus>;
    /**
     * The tags of the resource.
     */
