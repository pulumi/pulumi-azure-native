...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab:VirtualNetwork';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.devtestlab.VirtualNetworkPropertiesResponse>;
    /**
...
export interface VirtualNetworkArgs {
     ...
     * The properties of the resource.
     */
    readonly properties?: pulumi.Input<inputs.devtestlab.VirtualNetworkProperties>;
    /**
