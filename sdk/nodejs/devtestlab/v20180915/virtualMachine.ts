...
export class VirtualMachine extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.devtestlab.v20180915.LabVirtualMachinePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.devtestlab.v20180915.labVirtualMachinePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface VirtualMachineArgs {
     ...
     * The properties of the resource.
     */
    properties: pulumi.Input<inputs.devtestlab.v20180915.LabVirtualMachinePropertiesArgs>;
    /**
