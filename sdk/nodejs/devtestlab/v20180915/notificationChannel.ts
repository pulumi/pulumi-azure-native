...
export class NotificationChannel extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NotificationChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:NotificationChannel" }, { type: "azurerm:devtestlab/preview:NotificationChannel" }, { type: "azurerm:devtestlab/v20160515:NotificationChannel" }] };
