...
export class VirtualMachineSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualMachineScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devtestlab:VirtualMachineSchedule" }, { type: "azure-nextgen:devtestlab:VirtualMachineSchedule" }, { type: "azure-native:devtestlab/latest:VirtualMachineSchedule" }, { type: "azure-nextgen:devtestlab/latest:VirtualMachineSchedule" }, { type: "azure-native:devtestlab/v20160515:VirtualMachineSchedule" }, { type: "azure-nextgen:devtestlab/v20160515:VirtualMachineSchedule" }] };
