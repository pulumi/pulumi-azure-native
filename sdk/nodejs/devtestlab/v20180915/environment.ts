...
export class Environment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devtestlab:Environment" }, { type: "azure-nextgen:devtestlab:Environment" }, { type: "azure-native:devtestlab/latest:Environment" }, { type: "azure-nextgen:devtestlab/latest:Environment" }, { type: "azure-native:devtestlab/v20160515:Environment" }, { type: "azure-nextgen:devtestlab/v20160515:Environment" }] };
