...
export class CustomImage extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CustomImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:CustomImage" }, { type: "azure-nextgen:devtestlab/latest:CustomImage" }, { type: "azure-nextgen:devtestlab/v20150521preview:CustomImage" }, { type: "azure-nextgen:devtestlab/v20160515:CustomImage" }] };
