...
export class CustomImage extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomImage {
        return new CustomImage(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.devtestlab.v20180915.CustomImagePropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: CustomImageArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CustomImageArgs {
     ...
     * The properties of the resource.
     */
    readonly properties: pulumi.Input<inputs.devtestlab.v20180915.CustomImageProperties>;
    /**
