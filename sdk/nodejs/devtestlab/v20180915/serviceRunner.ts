...
export class ServiceRunner extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceRunner {
        return new ServiceRunner(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/v20180915:ServiceRunner';
    ...
    constructor(name: string, argsOrState?: ServiceRunnerArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ServiceRunnerArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:ServiceRunner" }, { type: "azurerm:devtestlab/preview:ServiceRunner" }, { type: "azurerm:devtestlab/v20160515:ServiceRunner" }] };
