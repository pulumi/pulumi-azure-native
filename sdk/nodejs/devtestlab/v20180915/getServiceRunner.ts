...
export function getServiceRunner(args: GetServiceRunnerArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceRunnerResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:devtestlab/v20180915:getServiceRunner", {
...
export interface GetServiceRunnerResult {
     ...
     */
    readonly identity?: outputs.devtestlab.v20180915.IdentityPropertiesInvokeResponse;
    /**
