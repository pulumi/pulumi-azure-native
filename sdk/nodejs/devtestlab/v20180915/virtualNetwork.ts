...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:VirtualNetwork" }, { type: "azurerm:devtestlab/preview:VirtualNetwork" }, { type: "azurerm:devtestlab/v20150521preview:VirtualNetwork" }, { type: "azurerm:devtestlab/v20160515:VirtualNetwork" }] };
