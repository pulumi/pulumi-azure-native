...
export class Formula extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:devtestlab/v20180915:Formula';
    ...
    constructor(name: string, args: FormulaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:Formula" }, { type: "azurerm:devtestlab/preview:Formula" }, { type: "azurerm:devtestlab/v20150521preview:Formula" }, { type: "azurerm:devtestlab/v20160515:Formula" }] };
