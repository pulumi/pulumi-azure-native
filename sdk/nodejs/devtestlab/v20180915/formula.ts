...
export class Formula extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FormulaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:devtestlab/latest:Formula" }, { type: "azurerm:devtestlab/v20150521preview:Formula" }, { type: "azurerm:devtestlab/v20160515:Formula" }] };
