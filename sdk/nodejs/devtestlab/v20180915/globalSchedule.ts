...
export class GlobalSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GlobalScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devtestlab:GlobalSchedule" }, { type: "azure-nextgen:devtestlab:GlobalSchedule" }, { type: "azure-native:devtestlab/latest:GlobalSchedule" }, { type: "azure-nextgen:devtestlab/latest:GlobalSchedule" }, { type: "azure-native:devtestlab/v20160515:GlobalSchedule" }, { type: "azure-nextgen:devtestlab/v20160515:GlobalSchedule" }] };
