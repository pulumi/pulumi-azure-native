...
export class Lab extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LabArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:devtestlab:Lab" }, { type: "azure-native:devtestlab/latest:Lab" }, { type: "azure-nextgen:devtestlab/latest:Lab" }, { type: "azure-native:devtestlab/v20150521preview:Lab" }, { type: "azure-nextgen:devtestlab/v20150521preview:Lab" }, { type: "azure-native:devtestlab/v20160515:Lab" }, { type: "azure-nextgen:devtestlab/v20160515:Lab" }, { type: "azure-native:devtestlab/v20180915:Lab" }, { type: "azure-nextgen:devtestlab/v20180915:Lab" }] };
...
export interface LabArgs {
     ...
     * The properties of any lab announcement associated with this lab
     */
    readonly announcement?: pulumi.Input<inputs.devtestlab.LabAnnouncementProperties>;
    /**
     * The access rights to be granted to the user when provisioning an environment
     */
     ...
     * The properties of any lab support message associated with this lab
     */
    readonly support?: pulumi.Input<inputs.devtestlab.LabSupportProperties>;
    /**
     * The tags of the resource.
     */
