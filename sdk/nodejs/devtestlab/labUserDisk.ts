...
export class LabUserDisk extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LabUserDiskState, opts?: pulumi.CustomResourceOptions): LabUserDisk {
        return new LabUserDisk(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: LabUserDiskArgs | LabUserDiskState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as LabUserDiskState | undefined;
            ...
            const args = argsOrState as LabUserDiskArgs | undefined;
 ...
 * A Disk.
 */
export interface LabUserDiskState {
    /**
     * The location of the resource.
     */
     ...
     * The properties of the resource.
     */
    readonly properties: pulumi.Input<inputs.devtestlab.DiskPropertiesResponse>;
    /**
     * The tags of the resource.
     */
