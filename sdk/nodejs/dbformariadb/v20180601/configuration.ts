...
export class Configuration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbformariadb/v20180601:Configuration';
    ...
    constructor(name: string, args: ConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformariadb:Configuration" }, { type: "azure-nextgen:dbformariadb/latest:Configuration" }, { type: "azure-nextgen:dbformariadb/v20180601preview:Configuration" }] };
