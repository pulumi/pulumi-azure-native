 ...
 *
 * const virtualNetworkRule = new azurerm.dbformariadb.v20180601.VirtualNetworkRule("virtualNetworkRule", {
...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformariadb/v20180601:VirtualNetworkRule';
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/latest:VirtualNetworkRule" }, { type: "azurerm:dbformariadb/v20180601preview:VirtualNetworkRule" }] };
