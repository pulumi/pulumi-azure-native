...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/latest:PrivateEndpointConnection" }, { type: "azurerm:dbformariadb/preview:PrivateEndpointConnection" }, { type: "azurerm:dbformariadb/v20180601privatepreview:PrivateEndpointConnection" }] };
