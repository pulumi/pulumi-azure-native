...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformariadb/v20180601:Server';
    ...
    constructor(name: string, argsOrState?: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/latest:Server" }, { type: "azurerm:dbformariadb/preview:Server" }, { type: "azurerm:dbformariadb/v20180601preview:Server" }] };
