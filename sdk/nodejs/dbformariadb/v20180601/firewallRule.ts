...
export class FirewallRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformariadb:FirewallRule" }, { type: "azure-nextgen:dbformariadb:FirewallRule" }, { type: "azure-native:dbformariadb/latest:FirewallRule" }, { type: "azure-nextgen:dbformariadb/latest:FirewallRule" }, { type: "azure-native:dbformariadb/v20180601preview:FirewallRule" }, { type: "azure-nextgen:dbformariadb/v20180601preview:FirewallRule" }] };
