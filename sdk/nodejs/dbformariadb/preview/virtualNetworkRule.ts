...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformariadb/preview:VirtualNetworkRule';
    ...
    constructor(name: string, argsOrState?: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/latest:VirtualNetworkRule" }, { type: "azurerm:dbformariadb/v20180601:VirtualNetworkRule" }, { type: "azurerm:dbformariadb/v20180601preview:VirtualNetworkRule" }] };
