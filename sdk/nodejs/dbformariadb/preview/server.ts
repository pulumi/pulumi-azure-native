...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformariadb/preview:Server';
     ...
     */
    public /*out*/ readonly identity!: pulumi.Output<outputs.dbformariadb.preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.dbformariadb.preview.SkuResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly storageProfile!: pulumi.Output<outputs.dbformariadb.preview.StorageProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/latest:Server" }, { type: "azurerm:dbformariadb/v20180601:Server" }, { type: "azurerm:dbformariadb/v20180601preview:Server" }] };
...
export interface ServerArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.dbformariadb.preview.ServerPropertiesForDefaultCreate | inputs.dbformariadb.preview.ServerPropertiesForGeoRestore | inputs.dbformariadb.preview.ServerPropertiesForReplica | inputs.dbformariadb.preview.ServerPropertiesForRestore>;
    /**
     ...
     * The SKU (pricing tier) of the server.
     */
    readonly sku?: pulumi.Input<inputs.dbformariadb.preview.Sku>;
    /**
     * Application-specific metadata in the form of key-value pairs.
     */
