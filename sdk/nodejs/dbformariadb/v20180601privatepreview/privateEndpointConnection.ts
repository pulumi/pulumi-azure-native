...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformariadb/v20180601privatepreview:PrivateEndpointConnection';
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/latest:PrivateEndpointConnection" }, { type: "azurerm:dbformariadb/preview:PrivateEndpointConnection" }, { type: "azurerm:dbformariadb/v20180601:PrivateEndpointConnection" }] };
