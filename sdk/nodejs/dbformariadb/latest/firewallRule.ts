 ...
 *
 * const firewallRule = new azurerm.dbformariadb.latest.FirewallRule("firewallRule", {
...
export class FirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformariadb/latest:FirewallRule';
    ...
    constructor(name: string, argsOrState?: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/v20180601:FirewallRule" }, { type: "azurerm:dbformariadb/v20180601preview:FirewallRule" }] };
