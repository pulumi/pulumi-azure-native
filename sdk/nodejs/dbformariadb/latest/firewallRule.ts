 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbformariadb:FirewallRule'.
 */
export class FirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FirewallRule {
        pulumi.log.warn("FirewallRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbformariadb:FirewallRule'.")
        return new FirewallRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbformariadb/latest:FirewallRule';
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformariadb/latest:FirewallRule" }, { type: "azure-native:dbformariadb:FirewallRule" }, { type: "azure-nextgen:dbformariadb:FirewallRule" }, { type: "azure-native:dbformariadb/v20180601:FirewallRule" }, { type: "azure-nextgen:dbformariadb/v20180601:FirewallRule" }, { type: "azure-native:dbformariadb/v20180601preview:FirewallRule" }, { type: "azure-nextgen:dbformariadb/v20180601preview:FirewallRule" }] };
