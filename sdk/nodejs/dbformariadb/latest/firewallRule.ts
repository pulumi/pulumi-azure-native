 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:dbformariadb:FirewallRule'.
 */
export class FirewallRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformariadb:FirewallRule" }, { type: "azure-nextgen:dbformariadb/v20180601:FirewallRule" }, { type: "azure-nextgen:dbformariadb/v20180601preview:FirewallRule" }] };
