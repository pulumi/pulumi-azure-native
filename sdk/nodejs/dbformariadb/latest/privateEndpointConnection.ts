 ...
 *
 * const privateEndpointConnection = new azurerm.dbformariadb.latest.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformariadb/latest:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/v20180601:PrivateEndpointConnection" }, { type: "azurerm:dbformariadb/v20180601privatepreview:PrivateEndpointConnection" }] };
