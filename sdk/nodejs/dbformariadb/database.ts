...
export class Database extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformariadb:Database" }, { type: "azure-native:dbformariadb/latest:Database" }, { type: "azure-nextgen:dbformariadb/latest:Database" }, { type: "azure-native:dbformariadb/v20180601:Database" }, { type: "azure-nextgen:dbformariadb/v20180601:Database" }, { type: "azure-native:dbformariadb/v20180601preview:Database" }, { type: "azure-nextgen:dbformariadb/v20180601preview:Database" }] };
