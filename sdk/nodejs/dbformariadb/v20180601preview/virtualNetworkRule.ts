 ...
 *
 * const virtualNetworkRule = new azure_native.dbformariadb.v20180601preview.VirtualNetworkRule("virtualNetworkRule", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:dbformariadb/v20180601preview:VirtualNetworkRule vnet-firewall-rule /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforMariaDB/servers/vnet-test-svr/virtualNetworkRules/vnet-firewall-rule 
 * ```
 */
