...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformariadb/v20180601preview:VirtualNetworkRule" }, { type: "azure-native:dbformariadb:VirtualNetworkRule" }, { type: "azure-nextgen:dbformariadb:VirtualNetworkRule" }, { type: "azure-native:dbformariadb/latest:VirtualNetworkRule" }, { type: "azure-nextgen:dbformariadb/latest:VirtualNetworkRule" }, { type: "azure-native:dbformariadb/v20180601:VirtualNetworkRule" }, { type: "azure-nextgen:dbformariadb/v20180601:VirtualNetworkRule" }] };
