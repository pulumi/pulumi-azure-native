...
export class Server extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformariadb/v20180601preview:Server" }, { type: "azure-native:dbformariadb:Server" }, { type: "azure-nextgen:dbformariadb:Server" }, { type: "azure-native:dbformariadb/latest:Server" }, { type: "azure-nextgen:dbformariadb/latest:Server" }, { type: "azure-native:dbformariadb/v20180601:Server" }, { type: "azure-nextgen:dbformariadb/v20180601:Server" }] };
