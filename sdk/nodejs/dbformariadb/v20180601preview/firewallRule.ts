...
export class FirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbformariadb/v20180601preview:FirewallRule';
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformariadb:FirewallRule" }, { type: "azure-nextgen:dbformariadb/latest:FirewallRule" }, { type: "azure-nextgen:dbformariadb/v20180601:FirewallRule" }] };
