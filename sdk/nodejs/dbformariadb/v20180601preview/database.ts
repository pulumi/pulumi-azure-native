 ...
 *
 * const database = new azurerm.dbformariadb.v20180601preview.Database("database", {
 *     charset: "utf8",
...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformariadb/v20180601preview:Database';
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/latest:Database" }, { type: "azurerm:dbformariadb/v20180601:Database" }] };
