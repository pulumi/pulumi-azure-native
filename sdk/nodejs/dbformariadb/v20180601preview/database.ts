...
export class Database extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformariadb/latest:Database" }, { type: "azurerm:dbformariadb/preview:Database" }, { type: "azurerm:dbformariadb/v20180601:Database" }] };
