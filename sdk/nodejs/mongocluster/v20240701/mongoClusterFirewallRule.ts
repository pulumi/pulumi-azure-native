...
export class MongoClusterFirewallRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MongoClusterFirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20240701:MongoClusterFirewallRule" }, { type: "azure-native:mongocluster:MongoClusterFirewallRule" }, { type: "azure-native:documentdb:MongoClusterFirewallRule" }, { type: "azure-native:mongocluster/v20240301preview:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20240301preview:MongoClusterFirewallRule" }, { type: "azure-native:mongocluster/v20240601preview:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20240601preview:MongoClusterFirewallRule" }, { type: "azure-native:mongocluster/v20241001preview:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20241001preview:MongoClusterFirewallRule" }] };
