...
export class MongoCluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.mongocluster.MongoClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MongoClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20230315preview:MongoCluster" }, { type: "azure-native:documentdb/v20230915preview:MongoCluster" }, { type: "azure-native:documentdb/v20231115preview:MongoCluster" }, { type: "azure-native:documentdb/v20240215preview:MongoCluster" }, { type: "azure-native:documentdb/v20240301preview:MongoCluster" }, { type: "azure-native:documentdb/v20240601preview:MongoCluster" }, { type: "azure-native:documentdb/v20240701:MongoCluster" }, { type: "azure-native:documentdb/v20241001preview:MongoCluster" }, { type: "azure-native:documentdb:MongoCluster" }, { type: "azure-native:mongocluster/v20240301preview:MongoCluster" }, { type: "azure-native:mongocluster/v20240601preview:MongoCluster" }, { type: "azure-native:mongocluster/v20240701:MongoCluster" }, { type: "azure-native:mongocluster/v20241001preview:MongoCluster" }, { type: "azure-native:mongocluster/v20250401preview:MongoCluster" }, { type: "azure-native:mongocluster/v20250701preview:MongoCluster" }, { type: "azure-native:mongocluster/v20250801preview:MongoCluster" }, { type: "azure-native:mongocluster/v20250901:MongoCluster" }, { type: "azure-native:mongocluster/v20260201preview:MongoCluster" }, { type: "azure-native:mongocluster/v20260601:MongoCluster" }, { type: "azure-native:mongocluster/v20260615preview:MongoCluster" }] };
...
export interface MongoClusterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.mongocluster.MongoClusterPropertiesArgs | undefined>;
    /**
