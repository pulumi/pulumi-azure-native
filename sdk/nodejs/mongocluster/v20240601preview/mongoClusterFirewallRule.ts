...
export class MongoClusterFirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mongocluster/v20240601preview:MongoClusterFirewallRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.mongocluster.v20240601preview.FirewallRulePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MongoClusterFirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20240601preview:MongoClusterFirewallRule" }, { type: "azure-native:mongocluster:MongoClusterFirewallRule" }, { type: "azure-native:documentdb:MongoClusterFirewallRule" }, { type: "azure-native:mongocluster/v20240301preview:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20240301preview:MongoClusterFirewallRule" }, { type: "azure-native:mongocluster/v20240701:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20240701:MongoClusterFirewallRule" }, { type: "azure-native:mongocluster/v20241001preview:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20241001preview:MongoClusterFirewallRule" }] };
...
export interface MongoClusterFirewallRuleArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.mongocluster.v20240601preview.FirewallRulePropertiesArgs>;
    /**
