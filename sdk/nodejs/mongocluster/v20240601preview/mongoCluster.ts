...
export class MongoCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mongocluster/v20240601preview:MongoCluster';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.mongocluster.v20240601preview.MongoClusterPropertiesResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.mongocluster.v20240601preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: MongoClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20240601preview:MongoCluster" }, { type: "azure-native:mongocluster:MongoCluster" }, { type: "azure-native:documentdb:MongoCluster" }, { type: "azure-native:mongocluster/v20240301preview:MongoCluster" }, { type: "azure-native:documentdb/v20240301preview:MongoCluster" }, { type: "azure-native:mongocluster/v20240701:MongoCluster" }, { type: "azure-native:documentdb/v20240701:MongoCluster" }, { type: "azure-native:mongocluster/v20241001preview:MongoCluster" }, { type: "azure-native:documentdb/v20241001preview:MongoCluster" }] };
...
export interface MongoClusterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.mongocluster.v20240601preview.MongoClusterPropertiesArgs>;
    /**
