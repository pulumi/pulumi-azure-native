...
// Export enums:
export * from "../../types/enums/mongocluster/v20240601preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:mongocluster/v20240601preview:MongoCluster":
                return new MongoCluster(name, <any>undefined, { urn })
            case "azure-native:mongocluster/v20240601preview:MongoClusterFirewallRule":
                return new MongoClusterFirewallRule(name, <any>undefined, { urn })
            case "azure-native:mongocluster/v20240601preview:MongoClusterPrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "mongocluster/v20240601preview", _module)
