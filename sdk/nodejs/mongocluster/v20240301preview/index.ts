...
// Export enums:
export * from "../../types/enums/mongocluster/v20240301preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:mongocluster/v20240301preview:MongoCluster":
                return new MongoCluster(name, <any>undefined, { urn })
            case "azure-native:mongocluster/v20240301preview:MongoClusterFirewallRule":
                return new MongoClusterFirewallRule(name, <any>undefined, { urn })
            case "azure-native:mongocluster/v20240301preview:MongoClusterPrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "mongocluster/v20240301preview", _module)
