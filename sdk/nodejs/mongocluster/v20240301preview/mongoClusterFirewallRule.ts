...
export class MongoClusterFirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mongocluster/v20240301preview:MongoClusterFirewallRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.mongocluster.v20240301preview.FirewallRulePropertiesResponse>;
    /**
...
export interface MongoClusterFirewallRuleArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.mongocluster.v20240301preview.FirewallRulePropertiesArgs>;
    /**
