...
export interface AppServiceCertificateOrderArgs {
     ...
     * State of the Key Vault secret.
     */
    readonly certificates?: pulumi.Input<{[key: string]: pulumi.Input<inputs.certificateregistration.v20210101.AppServiceCertificateArgs>}>;
    /**
     * Last CSR that was created for this order.
     */
     ...
     * Certificate product type.
     */
    readonly productType: pulumi.Input<enums.certificateregistration.v20210101.CertificateProductType>;
    /**
