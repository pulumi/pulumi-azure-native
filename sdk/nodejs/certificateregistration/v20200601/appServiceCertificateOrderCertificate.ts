...
export class AppServiceCertificateOrderCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AppServiceCertificateOrderCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:certificateregistration/latest:AppServiceCertificateOrderCertificate" }, { type: "azurerm:certificateregistration/preview:AppServiceCertificateOrderCertificate" }, { type: "azurerm:certificateregistration/v20150801:AppServiceCertificateOrderCertificate" }, { type: "azurerm:certificateregistration/v20180201:AppServiceCertificateOrderCertificate" }, { type: "azurerm:certificateregistration/v20190801:AppServiceCertificateOrderCertificate" }] };
