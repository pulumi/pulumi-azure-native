...
export interface AppServiceCertificateOrderArgs {
     ...
     * State of the Key Vault secret.
     */
    readonly certificates?: pulumi.Input<{[key: string]: pulumi.Input<inputs.certificateregistration.v20200901.AppServiceCertificateArgs>}>;
    /**
     * Last CSR that was created for this order.
     */
