...
export class AppServiceCertificateOrderCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:certificateregistration/preview:AppServiceCertificateOrderCertificate';
