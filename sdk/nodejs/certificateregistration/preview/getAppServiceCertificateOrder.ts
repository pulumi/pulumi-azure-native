...
export function getAppServiceCertificateOrder(args: GetAppServiceCertificateOrderArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceCertificateOrderResult> {
    ...
    return pulumi.runtime.invoke("azurerm:certificateregistration/preview:getAppServiceCertificateOrder", {
...
export interface GetAppServiceCertificateOrderResult {
     ...
     */
    readonly certificates?: {[key: string]: outputs.certificateregistration.preview.AppServiceCertificateResponse};
    /**
     ...
     */
    readonly intermediate: outputs.certificateregistration.preview.CertificateDetailsResponse;
    /**
     ...
     * Root certificate.
     */
    readonly root: outputs.certificateregistration.preview.CertificateDetailsResponse;
    /**
     ...
     * Signed certificate.
     */
    readonly signedCertificate: outputs.certificateregistration.preview.CertificateDetailsResponse;
    /**
