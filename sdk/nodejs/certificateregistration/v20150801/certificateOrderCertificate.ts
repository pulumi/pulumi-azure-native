...
export class CertificateOrderCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CertificateOrderCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:certificateregistration/latest:CertificateOrderCertificate" }, { type: "azurerm:certificateregistration/preview:CertificateOrderCertificate" }, { type: "azurerm:certificateregistration/v20180201:CertificateOrderCertificate" }, { type: "azurerm:certificateregistration/v20190801:CertificateOrderCertificate" }, { type: "azurerm:certificateregistration/v20200601:CertificateOrderCertificate" }] };
