...
export function getAppServiceCertificateOrder(args: GetAppServiceCertificateOrderArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceCertificateOrderResult> {
    pulumi.log.warn("getAppServiceCertificateOrder is deprecated: Version 2020-10-01 will be removed in v2 of the provider.")
...
export interface GetAppServiceCertificateOrderResult {
     ...
     */
    readonly certificates?: {[key: string]: outputs.certificateregistration.v20201001.AppServiceCertificateResponse};
    /**
