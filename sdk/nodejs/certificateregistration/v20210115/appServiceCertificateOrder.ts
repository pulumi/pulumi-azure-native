...
export class AppServiceCertificateOrder extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServiceCertificateOrder {
        pulumi.log.warn("AppServiceCertificateOrder is deprecated: azure-native:certificateregistration/v20210115:AppServiceCertificateOrder is being removed in the next major version of this provider. Please upgrade to azure-native:certificateregistration/v20220901:AppServiceCertificateOrder to guarantee forwards compatibility.")
