...
export function getAppServiceCertificateOrder(args: GetAppServiceCertificateOrderArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceCertificateOrderResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:certificateregistration/v20190801:getAppServiceCertificateOrder", {
...
export interface GetAppServiceCertificateOrderResult {
     ...
     */
    readonly certificates?: {[key: string]: outputs.certificateregistration.v20190801.AppServiceCertificateInvokeResponse};
    /**
     ...
     */
    readonly intermediate: outputs.certificateregistration.v20190801.CertificateDetailsInvokeResponse;
    /**
     ...
     * Root certificate.
     */
    readonly root: outputs.certificateregistration.v20190801.CertificateDetailsInvokeResponse;
    /**
     ...
     * Signed certificate.
     */
    readonly signedCertificate: outputs.certificateregistration.v20190801.CertificateDetailsInvokeResponse;
    /**
