...
export function getAppServiceCertificateOrder(args: GetAppServiceCertificateOrderArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceCertificateOrderResult> {
    pulumi.log.warn("getAppServiceCertificateOrder is deprecated: Version 2019-08-01 will be removed in v2 of the provider.\nazure-native:certificateregistration/v20190801:AppServiceCertificateOrder is being removed in the next major version of this provider. Upgrade to at least azure-native:certificateregistration/v20201001:AppServiceCertificateOrder to guarantee forwards compatibility.")
...
export interface GetAppServiceCertificateOrderResult {
     ...
     */
    readonly certificates?: {[key: string]: outputs.certificateregistration.v20190801.AppServiceCertificateResponse};
    /**
