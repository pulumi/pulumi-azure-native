...
export function getAppServiceCertificateOrder(args: GetAppServiceCertificateOrderArgs, opts?: pulumi.InvokeOptions): Promise<GetAppServiceCertificateOrderResult> {
    ...
    return pulumi.runtime.invoke("azure-native:certificateregistration/v20231201:getAppServiceCertificateOrder", {
...
export interface GetAppServiceCertificateOrderResult {
     ...
     */
    readonly certificates?: {[key: string]: outputs.certificateregistration.v20231201.AppServiceCertificateResponse};
    /**
     * Contact info
     */
    readonly contact: outputs.certificateregistration.v20231201.CertificateOrderContactResponse;
    /**
     ...
     */
    readonly intermediate: outputs.certificateregistration.v20231201.CertificateDetailsResponse;
    /**
     ...
     * Root certificate.
     */
    readonly root: outputs.certificateregistration.v20231201.CertificateDetailsResponse;
    /**
     ...
     * Signed certificate.
     */
    readonly signedCertificate: outputs.certificateregistration.v20231201.CertificateDetailsResponse;
    /**
...
export function getAppServiceCertificateOrderOutput(args: GetAppServiceCertificateOrderOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppServiceCertificateOrderResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:certificateregistration/v20231201:getAppServiceCertificateOrder", {
        "certificateOrderName": args.certificateOrderName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
