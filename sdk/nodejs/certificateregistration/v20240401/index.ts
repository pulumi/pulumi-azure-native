...
// Export enums:
export * from "../../types/enums/certificateregistration/v20240401";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:certificateregistration/v20240401:AppServiceCertificateOrder":
                return new AppServiceCertificateOrder(name, <any>undefined, { urn })
            case "azure-native:certificateregistration/v20240401:AppServiceCertificateOrderCertificate":
...
pulumi.runtime.registerResourceModule("azure-native", "certificateregistration/v20240401", _module)
