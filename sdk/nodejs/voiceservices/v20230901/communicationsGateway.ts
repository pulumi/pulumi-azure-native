...
export class CommunicationsGateway extends pulumi.CustomResource {
     ...
     */
    public readonly apiBridge!: pulumi.Output<outputs.voiceservices.v20230901.ApiBridgePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly customSipHeaders!: pulumi.Output<outputs.voiceservices.v20230901.CustomSipHeadersPropertiesResponse | undefined>;
    /**
     * Details of DNS Domains to delegate to the Communications Gateway.
     */
    public readonly dnsDelegations!: pulumi.Output<outputs.voiceservices.v20230901.DnsDelegationsPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.voiceservices.v20230901.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly serviceLocations!: pulumi.Output<outputs.voiceservices.v20230901.ServiceRegionPropertiesResponse[]>;
    /**
     * The SKU (Stock Keeping Unit) assigned to this resource.
     */
    public readonly sku!: pulumi.Output<outputs.voiceservices.v20230901.SkuResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.voiceservices.v20230901.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: CommunicationsGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["apiBridge"] = args ? (args.apiBridge ? pulumi.output(args.apiBridge).apply(inputs.voiceservices.v20230901.apiBridgePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface CommunicationsGatewayArgs {
     ...
     * Details of API bridge functionality, if required
     */
    apiBridge?: pulumi.Input<inputs.voiceservices.v20230901.ApiBridgePropertiesArgs>;
    /**
     * The scope at which the auto-generated domain name can be re-used
     */
    autoGeneratedDomainNameLabelScope?: pulumi.Input<string | enums.voiceservices.v20230901.AutoGeneratedDomainNameLabelScope>;
    /**
     * Voice codecs to support
     */
    codecs: pulumi.Input<pulumi.Input<string | enums.voiceservices.v20230901.TeamsCodecs>[]>;
    /**
     ...
     * How to connect back to the operator network, e.g. MAPS
     */
    connectivity: pulumi.Input<string | enums.voiceservices.v20230901.Connectivity>;
    /**
     * Custom SIP Header to add to any subscriber with a custom_header value, if required.
     */
    customSipHeaders?: pulumi.Input<inputs.voiceservices.v20230901.CustomSipHeadersPropertiesArgs>;
    /**
     * Details of DNS Domains to delegate to the Communications Gateway.
     */
    dnsDelegations?: pulumi.Input<inputs.voiceservices.v20230901.DnsDelegationsPropertiesArgs>;
    /**
     * How to handle 911 calls
     */
    e911Type: pulumi.Input<string | enums.voiceservices.v20230901.E911Type>;
    /**
     * A list of dial strings used for emergency calling.
     */
     ...
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.voiceservices.v20230901.ManagedServiceIdentityArgs>;
    /**
     * Whether an integrated Mobile Control Point is in use.
     */
     ...
     * What platforms to support
     */
    platforms: pulumi.Input<pulumi.Input<string | enums.voiceservices.v20230901.CommunicationsPlatform>[]>;
    /**
     ...
     * The regions in which to deploy the resources needed for Teams Calling
     */
    serviceLocations: pulumi.Input<pulumi.Input<inputs.voiceservices.v20230901.ServiceRegionPropertiesArgs>[]>;
    /**
     * The SKU (Stock Keeping Unit) assigned to this resource.
     */
    sku?: pulumi.Input<inputs.voiceservices.v20230901.SkuArgs>;
    /**
     * Resource tags.
     */
