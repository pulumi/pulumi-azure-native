...
export class CommunicationsGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:voiceservices/v20230131:CommunicationsGateway';
     ...
     */
    public readonly serviceLocations!: pulumi.Output<outputs.voiceservices.v20230131.ServiceRegionPropertiesResponse[]>;
    /**
    ...
    constructor(name: string, args: CommunicationsGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:voiceservices:CommunicationsGateway" }, { type: "azure-native:voiceservices/v20221201preview:CommunicationsGateway" }, { type: "azure-native:voiceservices/v20230403:CommunicationsGateway" }, { type: "azure-native:voiceservices/v20230901:CommunicationsGateway" }] };
...
export interface CommunicationsGatewayArgs {
     ...
     * The scope at which the auto-generated domain name can be re-used
     */
    autoGeneratedDomainNameLabelScope?: pulumi.Input<string | enums.voiceservices.v20230131.AutoGeneratedDomainNameLabelScope>;
    /**
     * Voice codecs to support
     */
    codecs: pulumi.Input<pulumi.Input<string | enums.voiceservices.v20230131.TeamsCodecs>[]>;
    /**
     ...
     * How to connect back to the operator network, e.g. MAPS
     */
    connectivity: pulumi.Input<string | enums.voiceservices.v20230131.Connectivity>;
    /**
     * How to handle 911 calls
     */
    e911Type: pulumi.Input<string | enums.voiceservices.v20230131.E911Type>;
    /**
     * A list of dial strings used for emergency calling.
     */
     ...
     * What platforms to support
     */
    platforms: pulumi.Input<pulumi.Input<string | enums.voiceservices.v20230131.CommunicationsPlatform>[]>;
    /**
     ...
     * The regions in which to deploy the resources needed for Teams Calling
     */
    serviceLocations: pulumi.Input<pulumi.Input<inputs.voiceservices.v20230131.ServiceRegionPropertiesArgs>[]>;
    /**
     * Resource tags.
     */
