...
export function getCommunicationsGateway(args: GetCommunicationsGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetCommunicationsGatewayResult> {
    pulumi.log.warn("getCommunicationsGateway is deprecated: azure-native:voiceservices/v20230131:CommunicationsGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:voiceservices/v20230403:CommunicationsGateway to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:voiceservices/v20230131:getCommunicationsGateway", {
...
export interface GetCommunicationsGatewayResult {
     ...
     */
    readonly serviceLocations: outputs.voiceservices.v20230131.ServiceRegionPropertiesResponse[];
    /**
