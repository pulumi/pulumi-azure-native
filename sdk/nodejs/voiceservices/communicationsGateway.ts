...
export class CommunicationsGateway extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly allocatedMediaAddressPrefixes: pulumi.Output<string[]>;
    /**
     * A list of IP allocated prefixes which may be used to receive signaling data from this Communications Gateway.
     */
    declare public /*out*/ readonly allocatedSignalingAddressPrefixes: pulumi.Output<string[]>;
    /**
     * Details of API bridge functionality, if required
     */
    declare public readonly apiBridge: pulumi.Output<outputs.voiceservices.ApiBridgePropertiesResponse | undefined>;
    /**
     * The autogenerated label used as part of the FQDNs for accessing the Communications Gateway
     */
    declare public /*out*/ readonly autoGeneratedDomainNameLabel: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly customSipHeaders: pulumi.Output<outputs.voiceservices.CustomSipHeadersPropertiesResponse | undefined>;
    /**
     * Details of DNS Domains to delegate to the Communications Gateway.
     */
    declare public readonly dnsDelegations: pulumi.Output<outputs.voiceservices.DnsDelegationsPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly integratedMcpEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly serviceLocations: pulumi.Output<outputs.voiceservices.ServiceRegionPropertiesResponse[]>;
    /**
     ...
     */
    declare public readonly teamsVoicemailPilotNumber: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: CommunicationsGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["apiBridge"] = args ? pulumi.output(args.apiBridge).apply(v => v === undefined ? undefined : inputs.voiceservices.apiBridgePropertiesArgsProvideDefaults(v)) : undefined;
            resourceInputs["autoGeneratedDomainNameLabelScope"] = (args?.autoGeneratedDomainNameLabelScope) ?? "TenantReuse";
            ...
            resourceInputs["customSipHeaders"] = args?.customSipHeaders;
            resourceInputs["dnsDelegations"] = args?.dnsDelegations;
            resourceInputs["e911Type"] = args?.e911Type;
            resourceInputs["emergencyDialStrings"] = args?.emergencyDialStrings;
            resourceInputs["identity"] = args?.identity;
            resourceInputs["integratedMcpEnabled"] = (args?.integratedMcpEnabled) ?? false;
            resourceInputs["location"] = args?.location;
            resourceInputs["onPremMcpEnabled"] = (args?.onPremMcpEnabled) ?? false;
            resourceInputs["platforms"] = args?.platforms;
            resourceInputs["resourceGroupName"] = args?.resourceGroupName;
            resourceInputs["serviceLocations"] = args?.serviceLocations;
            resourceInputs["sku"] = args?.sku;
            resourceInputs["tags"] = args?.tags;
            resourceInputs["teamsVoicemailPilotNumber"] = args?.teamsVoicemailPilotNumber;
...
export interface CommunicationsGatewayArgs {
     ...
     * Details of API bridge functionality, if required
     */
    apiBridge?: pulumi.Input<inputs.voiceservices.ApiBridgePropertiesArgs | undefined>;
    /**
     * The scope at which the auto-generated domain name can be re-used
     */
    autoGeneratedDomainNameLabelScope?: pulumi.Input<string | enums.voiceservices.AutoGeneratedDomainNameLabelScope | undefined>;
    /**
     * Voice codecs to support
     */
     ...
     * Custom SIP Header to add to any subscriber with a custom_header value, if required.
     */
    customSipHeaders?: pulumi.Input<inputs.voiceservices.CustomSipHeadersPropertiesArgs | undefined>;
    /**
     * Details of DNS Domains to delegate to the Communications Gateway.
     */
    dnsDelegations?: pulumi.Input<inputs.voiceservices.DnsDelegationsPropertiesArgs | undefined>;
    /**
     * How to handle 911 calls
     */
     ...
     * A list of dial strings used for emergency calling.
     */
    emergencyDialStrings?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.voiceservices.ManagedServiceIdentityArgs | undefined>;
    /**
     * Whether an integrated Mobile Control Point is in use.
     */
    integratedMcpEnabled?: pulumi.Input<boolean | undefined>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Whether an on-premises Mobile Control Point is in use.
     */
    onPremMcpEnabled?: pulumi.Input<boolean | undefined>;
    /**
     * What platforms to support
     */
     ...
     * The SKU (Stock Keeping Unit) assigned to this resource.
     */
    sku?: pulumi.Input<inputs.voiceservices.SkuArgs | undefined>;
    /**
     * Resource tags.
     */
     ...
     * This number is used in Teams Phone Mobile scenarios for access to the voicemail IVR from the native dialer.
     */
    teamsVoicemailPilotNumber?: pulumi.Input<string | undefined>;
}
