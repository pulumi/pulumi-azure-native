...
export class BackupVault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20250101:BackupVault';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.dataprotection.v20250101.DppIdentityDetailsResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly properties!: pulumi.Output<outputs.dataprotection.v20250101.BackupVaultResponse>;
    /**
