...
export class BackupInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupInstance {
        pulumi.log.warn("BackupInstance is deprecated: azure-native:dataprotection/v20220501:BackupInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupInstance to guarantee forwards compatibility.")
        return new BackupInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20220501:BackupInstance';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.dataprotection.v20220501.BackupInstanceResponse>;
    /**
...
export interface BackupInstanceArgs {
     ...
     * BackupInstanceResource properties
     */
    properties?: pulumi.Input<inputs.dataprotection.v20220501.BackupInstanceArgs>;
    /**
