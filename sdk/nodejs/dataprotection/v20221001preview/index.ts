...
// Export enums:
export * from "../../types/enums/dataprotection/v20221001preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dataprotection/v20221001preview:BackupInstance":
                return new BackupInstance(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20221001preview:BackupPolicy":
...
pulumi.runtime.registerResourceModule("azure-native", "dataprotection/v20221001preview", _module)
