...
export class DppResourceGuardProxy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DppResourceGuardProxy {
        pulumi.log.warn("DppResourceGuardProxy is deprecated: azure-native:dataprotection/v20221001preview:DppResourceGuardProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230101:DppResourceGuardProxy to guarantee forwards compatibility.")
