...
export function getResourceGuard(args: GetResourceGuardArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceGuardResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dataprotection/v20230801preview:getResourceGuard", {
...
export interface GetResourceGuardResult {
     ...
     */
    readonly properties: outputs.dataprotection.v20230801preview.ResourceGuardResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: outputs.dataprotection.v20230801preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getResourceGuardOutput(args: GetResourceGuardOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetResourceGuardResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:dataprotection/v20230801preview:getResourceGuard", {
        "resourceGroupName": args.resourceGroupName,
        "resourceGuardsName": args.resourceGuardsName,
    }, opts);
}
