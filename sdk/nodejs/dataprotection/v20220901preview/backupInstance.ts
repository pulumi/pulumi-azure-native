 ...
 *
 * @deprecated azure-native:dataprotection/v20220901preview:BackupInstance is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20230101:BackupInstance to guarantee forwards compatibility.
 */
export class BackupInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupInstance {
        pulumi.log.warn("BackupInstance is deprecated: azure-native:dataprotection/v20220901preview:BackupInstance is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20230101:BackupInstance to guarantee forwards compatibility.")
        return new BackupInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20220901preview:BackupInstance';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.dataprotection.v20220901preview.BackupInstanceResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.dataprotection.v20220901preview.SystemDataResponse>;
    /**
     * Proxy Resource tags.
     */
...
export interface BackupInstanceArgs {
     ...
     * BackupInstanceResource properties
     */
    properties?: pulumi.Input<inputs.dataprotection.v20220901preview.BackupInstanceArgs>;
    /**
