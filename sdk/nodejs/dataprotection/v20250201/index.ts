...
// Export enums:
export * from "../../types/enums/dataprotection/v20250201";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dataprotection/v20250201:BackupInstance":
                return new BackupInstance(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20250201:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20250201:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20250201:DppResourceGuardProxy":
                return new DppResourceGuardProxy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20250201:ResourceGuard":
...
pulumi.runtime.registerResourceModule("azure-native", "dataprotection/v20250201", _module)
