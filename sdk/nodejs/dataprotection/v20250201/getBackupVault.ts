...
export function getBackupVault(args: GetBackupVaultArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupVaultResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dataprotection/v20250201:getBackupVault", {
...
export interface GetBackupVaultResult {
     ...
     */
    readonly identity?: outputs.dataprotection.v20250201.DppIdentityDetailsResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly properties: outputs.dataprotection.v20250201.BackupVaultResponse;
    /**
...
export function getBackupVaultOutput(args: GetBackupVaultOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackupVaultResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:dataprotection/v20250201:getBackupVault", {
        "resourceGroupName": args.resourceGroupName,
        "vaultName": args.vaultName,
    }, opts);
}
