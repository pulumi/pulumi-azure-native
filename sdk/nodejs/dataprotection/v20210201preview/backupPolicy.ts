...
export class BackupPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackupPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dataprotection/v20210201preview:BackupPolicy" }, { type: "azure-native:dataprotection:BackupPolicy" }, { type: "azure-nextgen:dataprotection:BackupPolicy" }] };
