...
export class ResourceGuard extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20230601preview:ResourceGuard';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.dataprotection.v20230601preview.ResourceGuardResponse>;
    /**
...
export interface ResourceGuardArgs {
     ...
     * ResourceGuardResource properties
     */
    properties?: pulumi.Input<inputs.dataprotection.v20230601preview.ResourceGuardArgs>;
    /**
