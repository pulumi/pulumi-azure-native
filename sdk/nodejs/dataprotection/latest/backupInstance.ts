 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dataprotection:BackupInstance'.
 */
export class BackupInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupInstance {
        pulumi.log.warn("BackupInstance is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dataprotection:BackupInstance'.")
        return new BackupInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/latest:BackupInstance';
     ...
     */
    public readonly dataSourceInfo!: pulumi.Output<outputs.dataprotection.latest.DatasourceResponse>;
    /**
     * Gets or sets the data source set information.
     */
    public readonly dataSourceSetInfo!: pulumi.Output<outputs.dataprotection.latest.DatasourceSetResponse | undefined>;
    /**
     ...
     */
    public readonly policyInfo!: pulumi.Output<outputs.dataprotection.latest.PolicyInfoResponse>;
    /**
     * Specifies the protection error of the resource
     */
    public /*out*/ readonly protectionErrorDetails!: pulumi.Output<outputs.dataprotection.latest.UserFacingErrorResponse>;
    /**
     * Specifies the protection status of the resource
     */
    public /*out*/ readonly protectionStatus!: pulumi.Output<outputs.dataprotection.latest.ProtectionStatusDetailsResponse>;
    /**
    ...
    constructor(name: string, args: BackupInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dataprotection/latest:BackupInstance" }, { type: "azure-native:dataprotection:BackupInstance" }, { type: "azure-nextgen:dataprotection:BackupInstance" }, { type: "azure-native:dataprotection/v20210101:BackupInstance" }, { type: "azure-nextgen:dataprotection/v20210101:BackupInstance" }, { type: "azure-native:dataprotection/v20210201preview:BackupInstance" }, { type: "azure-nextgen:dataprotection/v20210201preview:BackupInstance" }] };
...
export interface BackupInstanceArgs {
     ...
     * Gets or sets the data source information.
     */
    readonly dataSourceInfo: pulumi.Input<inputs.dataprotection.latest.Datasource>;
    /**
     * Gets or sets the data source set information.
     */
    readonly dataSourceSetInfo?: pulumi.Input<inputs.dataprotection.latest.DatasourceSet>;
    /**
     * Gets or sets the Backup Instance friendly name.
     */
     ...
     * Gets or sets the policy information.
     */
    readonly policyInfo: pulumi.Input<inputs.dataprotection.latest.PolicyInfo>;
    /**
