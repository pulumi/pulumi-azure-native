...
export class ResourceGuard extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceGuard {
        pulumi.log.warn("ResourceGuard is deprecated: azure-native:dataprotection/v20220401:ResourceGuard is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20221101preview:ResourceGuard to guarantee forwards compatibility.")
        return new ResourceGuard(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20220401:ResourceGuard';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.dataprotection.v20220401.DppIdentityDetailsResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly properties!: pulumi.Output<outputs.dataprotection.v20220401.ResourceGuardResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.dataprotection.v20220401.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ResourceGuardArgs {
     ...
     * Input Managed Identity Details
     */
    identity?: pulumi.Input<inputs.dataprotection.v20220401.DppIdentityDetailsArgs>;
    /**
     * Resource location.
     */
     ...
     * ResourceGuardResource properties
     */
    properties?: pulumi.Input<inputs.dataprotection.v20220401.ResourceGuardArgs>;
    /**
