...
/**
 * @deprecated azure-native:dataprotection/v20220101:ResourceGuard is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20221101preview:ResourceGuard to guarantee forwards compatibility.
 */
export class ResourceGuard extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20220101:ResourceGuard';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.dataprotection.v20220101.DppIdentityDetailsResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.dataprotection.v20220101.ResourceGuardResponse>;
    /**
