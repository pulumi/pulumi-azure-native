...
export class BackupVault extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackupVaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dataprotection/v20210101:BackupVault" }, { type: "azure-native:dataprotection:BackupVault" }, { type: "azure-nextgen:dataprotection:BackupVault" }, { type: "azure-native:dataprotection/v20210201preview:BackupVault" }, { type: "azure-nextgen:dataprotection/v20210201preview:BackupVault" }, { type: "azure-native:dataprotection/v20210601preview:BackupVault" }, { type: "azure-nextgen:dataprotection/v20210601preview:BackupVault" }] };
