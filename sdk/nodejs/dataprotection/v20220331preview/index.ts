...
// Export enums:
export * from "../../types/enums/dataprotection/v20220331preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dataprotection/v20220331preview:BackupInstance":
                return new BackupInstance(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20220331preview:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20220331preview:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20220331preview:ResourceGuard":
...
pulumi.runtime.registerResourceModule("azure-native", "dataprotection/v20220331preview", _module)
