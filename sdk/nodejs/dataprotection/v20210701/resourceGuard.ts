...
export class ResourceGuard extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceGuard {
        pulumi.log.warn("ResourceGuard is deprecated: azure-native:dataprotection/v20210701:ResourceGuard is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20221101preview:ResourceGuard to guarantee forwards compatibility.")
