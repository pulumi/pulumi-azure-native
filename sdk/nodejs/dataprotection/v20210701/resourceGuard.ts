...
/**
 * @deprecated azure-native:dataprotection/v20210701:ResourceGuard is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20221101preview:ResourceGuard to guarantee forwards compatibility.
 */
export class ResourceGuard extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceGuard {
        pulumi.log.warn("ResourceGuard is deprecated: azure-native:dataprotection/v20210701:ResourceGuard is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20221101preview:ResourceGuard to guarantee forwards compatibility.")
        return new ResourceGuard(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20210701:ResourceGuard';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.dataprotection.v20210701.DppIdentityDetailsResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.dataprotection.v20210701.ResourceGuardResponse>;
    /**
...
export interface ResourceGuardArgs {
     ...
     * Input Managed Identity Details
     */
    identity?: pulumi.Input<inputs.dataprotection.v20210701.DppIdentityDetailsArgs>;
    /**
     * Resource location.
     */
