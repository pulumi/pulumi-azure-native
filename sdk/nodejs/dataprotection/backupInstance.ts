...
export class BackupInstance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackupInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dataprotection:BackupInstance" }, { type: "azure-native:dataprotection/latest:BackupInstance" }, { type: "azure-nextgen:dataprotection/latest:BackupInstance" }, { type: "azure-native:dataprotection/v20210101:BackupInstance" }, { type: "azure-nextgen:dataprotection/v20210101:BackupInstance" }, { type: "azure-native:dataprotection/v20210201preview:BackupInstance" }, { type: "azure-nextgen:dataprotection/v20210201preview:BackupInstance" }] };
...
export interface BackupInstanceArgs {
     ...
     * Gets or sets the data source information.
     */
    readonly dataSourceInfo: pulumi.Input<inputs.dataprotection.Datasource>;
    /**
     * Gets or sets the data source set information.
     */
    readonly dataSourceSetInfo?: pulumi.Input<inputs.dataprotection.DatasourceSet>;
    /**
     * Gets or sets the Backup Instance friendly name.
     */
     ...
     * Gets or sets the policy information.
     */
    readonly policyInfo: pulumi.Input<inputs.dataprotection.PolicyInfo>;
    /**
