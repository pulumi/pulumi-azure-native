...
export function getBackupVault(args: GetBackupVaultArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupVaultResult> {
    pulumi.log.warn("getBackupVault is deprecated: azure-native:dataprotection/v20230101:BackupVault is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupVault to guarantee forwards compatibility.")
...
export interface GetBackupVaultResult {
     ...
     */
    readonly identity?: outputs.dataprotection.v20230101.DppIdentityDetailsResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly properties: outputs.dataprotection.v20230101.BackupVaultResponse;
    /**
