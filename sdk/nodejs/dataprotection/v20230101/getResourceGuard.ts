...
export function getResourceGuard(args: GetResourceGuardArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceGuardResult> {
    pulumi.log.warn("getResourceGuard is deprecated: azure-native:dataprotection/v20230101:ResourceGuard is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:ResourceGuard to guarantee forwards compatibility.")
...
export interface GetResourceGuardResult {
     ...
     */
    readonly properties: outputs.dataprotection.v20230101.ResourceGuardResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: outputs.dataprotection.v20230101.SystemDataResponse;
    /**
     * Resource tags.
     */
