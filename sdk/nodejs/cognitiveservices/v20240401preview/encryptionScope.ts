...
export class EncryptionScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cognitiveservices/v20240401preview:EncryptionScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cognitiveservices.v20240401preview.EncryptionScopePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EncryptionScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20231001preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20240601preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20241001:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20250401preview:EncryptionScope" }, { type: "azure-native:cognitiveservices:EncryptionScope" }] };
