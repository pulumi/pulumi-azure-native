...
export class CommitmentPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cognitiveservices/v20221001:CommitmentPlan';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cognitiveservices.v20221001.CommitmentPlanPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CommitmentPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices:CommitmentPlan" }, { type: "azure-native:cognitiveservices/v20211001:CommitmentPlan" }, { type: "azure-native:cognitiveservices/v20220301:CommitmentPlan" }, { type: "azure-native:cognitiveservices/v20221201:CommitmentPlan" }, { type: "azure-native:cognitiveservices/v20230501:CommitmentPlan" }, { type: "azure-native:cognitiveservices/v20231001preview:CommitmentPlan" }, { type: "azure-native:cognitiveservices/v20240401preview:CommitmentPlan" }, { type: "azure-native:cognitiveservices/v20240601preview:CommitmentPlan" }, { type: "azure-native:cognitiveservices/v20241001:CommitmentPlan" }] };
...
export interface CommitmentPlanArgs {
     ...
     * Properties of Cognitive Services account commitment plan.
     */
    properties?: pulumi.Input<inputs.cognitiveservices.v20221001.CommitmentPlanPropertiesArgs>;
    /**
