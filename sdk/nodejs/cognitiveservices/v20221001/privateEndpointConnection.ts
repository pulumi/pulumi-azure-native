 ...
 *
 * @deprecated azure-native:cognitiveservices/v20221001:PrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:cognitiveservices/v20221201:PrivateEndpointConnection to guarantee forwards compatibility.
 */
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpointConnection {
        pulumi.log.warn("PrivateEndpointConnection is deprecated: azure-native:cognitiveservices/v20221001:PrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:cognitiveservices/v20221201:PrivateEndpointConnection to guarantee forwards compatibility.")
