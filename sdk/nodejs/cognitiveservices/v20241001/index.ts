...
// Export enums:
export * from "../../types/enums/cognitiveservices/v20241001";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cognitiveservices/v20241001:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:CommitmentPlan":
                return new CommitmentPlan(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:CommitmentPlanAssociation":
                return new CommitmentPlanAssociation(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:Deployment":
                return new Deployment(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:EncryptionScope":
                return new EncryptionScope(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:RaiBlocklist":
                return new RaiBlocklist(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:RaiBlocklistItem":
                return new RaiBlocklistItem(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:RaiPolicy":
                return new RaiPolicy(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20241001:SharedCommitmentPlan":
...
pulumi.runtime.registerResourceModule("azure-native", "cognitiveservices/v20241001", _module)
