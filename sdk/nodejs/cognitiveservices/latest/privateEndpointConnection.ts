...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cognitiveservices/latest:PrivateEndpointConnection';
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cognitiveservices/preview:PrivateEndpointConnection" }, { type: "azurerm:cognitiveservices/v20170418:PrivateEndpointConnection" }] };
