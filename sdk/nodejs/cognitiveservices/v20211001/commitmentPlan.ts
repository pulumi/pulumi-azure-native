...
export class CommitmentPlan extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CommitmentPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cognitiveservices/v20211001:CommitmentPlan" }, { type: "azure-native:cognitiveservices:CommitmentPlan" }, { type: "azure-nextgen:cognitiveservices:CommitmentPlan" }] };
