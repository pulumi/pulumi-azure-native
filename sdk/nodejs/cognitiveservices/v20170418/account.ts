...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cognitiveservices/latest:Account" }, { type: "azurerm:cognitiveservices/preview:Account" }, { type: "azurerm:cognitiveservices/v20160201preview:Account" }] };
