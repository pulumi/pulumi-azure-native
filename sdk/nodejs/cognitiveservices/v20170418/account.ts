...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices:Account" }, { type: "azure-nextgen:cognitiveservices:Account" }, { type: "azure-native:cognitiveservices/latest:Account" }, { type: "azure-nextgen:cognitiveservices/latest:Account" }, { type: "azure-native:cognitiveservices/v20160201preview:Account" }, { type: "azure-nextgen:cognitiveservices/v20160201preview:Account" }] };
