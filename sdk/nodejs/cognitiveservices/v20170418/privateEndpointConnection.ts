...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:cognitiveservices/v20170418:PrivateEndpointConnection';
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:cognitiveservices/latest:PrivateEndpointConnection" }, { type: "azurerm:cognitiveservices/preview:PrivateEndpointConnection" }] };
