...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:cognitiveservices/v20170418:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:cognitiveservices:PrivateEndpointConnection" }, { type: "azure-nextgen:cognitiveservices/latest:PrivateEndpointConnection" }] };
