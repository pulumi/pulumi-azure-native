...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices:PrivateEndpointConnection" }, { type: "azure-nextgen:cognitiveservices:PrivateEndpointConnection" }, { type: "azure-native:cognitiveservices/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:cognitiveservices/latest:PrivateEndpointConnection" }] };
