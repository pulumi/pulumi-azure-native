...
export class RaiBlocklist extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RaiBlocklistArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices:RaiBlocklist" }, { type: "azure-native:cognitiveservices/v20231001preview:RaiBlocklist" }, { type: "azure-native:cognitiveservices/v20240401preview:RaiBlocklist" }] };
