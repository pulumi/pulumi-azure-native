...
export class EncryptionScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cognitiveservices/v20240601preview:EncryptionScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cognitiveservices.v20240601preview.EncryptionScopePropertiesResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.cognitiveservices.v20240601preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: EncryptionScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.cognitiveservices.v20240601preview.encryptionScopePropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20231001preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20240401preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20241001:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20250401preview:EncryptionScope" }, { type: "azure-native:cognitiveservices:EncryptionScope" }] };
...
export interface EncryptionScopeArgs {
     ...
     * Properties of Cognitive Services EncryptionScope.
     */
    properties?: pulumi.Input<inputs.cognitiveservices.v20240601preview.EncryptionScopePropertiesArgs>;
    /**
