...
export class SharedCommitmentPlan extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cognitiveservices.v20230501.CommitmentPlanPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SharedCommitmentPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20221201:SharedCommitmentPlan" }, { type: "azure-native:cognitiveservices/v20231001preview:SharedCommitmentPlan" }, { type: "azure-native:cognitiveservices/v20240401preview:SharedCommitmentPlan" }, { type: "azure-native:cognitiveservices/v20240601preview:SharedCommitmentPlan" }, { type: "azure-native:cognitiveservices/v20241001:SharedCommitmentPlan" }, { type: "azure-native:cognitiveservices:SharedCommitmentPlan" }] };
