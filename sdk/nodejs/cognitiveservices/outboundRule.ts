...
export class OutboundRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cognitiveservices:OutboundRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cognitiveservices.FqdnOutboundRuleResponse>;
    /**
