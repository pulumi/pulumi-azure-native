...
export class CognitiveServicesAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CognitiveServicesAccount {
        return new CognitiveServicesAccount(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: CognitiveServicesAccountArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CognitiveServicesAccountArgs | undefined;
