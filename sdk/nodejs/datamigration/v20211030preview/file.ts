...
export class File extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): File {
        pulumi.log.warn("File is deprecated: azure-native:datamigration/v20211030preview:File is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:File to guarantee forwards compatibility.")
        return new File(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:datamigration/v20211030preview:File';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datamigration.v20211030preview.ProjectFilePropertiesResponse>;
    /**
