...
export function getFile(args: GetFileArgs, opts?: pulumi.InvokeOptions): Promise<GetFileResult> {
    pulumi.log.warn("getFile is deprecated: azure-native:datamigration/v20211030preview:File is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:File to guarantee forwards compatibility.")
...
export interface GetFileResult {
     ...
     */
    readonly properties: outputs.datamigration.v20211030preview.ProjectFilePropertiesResponse;
    /**
