...
export class Service extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Service {
        pulumi.log.warn("Service is deprecated: azure-native:datamigration/v20211030preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:datamigration/v20220330preview:Service to guarantee forwards compatibility.")
