...
export function getSqlMigrationService(args: GetSqlMigrationServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlMigrationServiceResult> {
    pulumi.log.warn("getSqlMigrationService is deprecated: azure-native:datamigration/v20220130preview:SqlMigrationService is being removed in the next major version of this provider. Upgrade to at least azure-native:datamigration/v20220330preview:SqlMigrationService to guarantee forwards compatibility.")
