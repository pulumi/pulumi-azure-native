...
export function getMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo(args: GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult> {
    ...
    return pulumi.runtime.invoke("azure-native:datamigration/v20230715preview:getMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo", {
...
export function getMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoOutput(args: GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:datamigration/v20230715preview:getMongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo", {
        "migrationName": args.migrationName,
        "resourceGroupName": args.resourceGroupName,
        "targetResourceName": args.targetResourceName,
    }, opts);
