...
export class MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbvCoreMongo" }, { type: "azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbvCoreMongo" }, { type: "azure-native:datamigration:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo" }] };
