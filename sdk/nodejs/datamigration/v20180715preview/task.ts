...
export class Task extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datamigration/v20180715preview:Task" }, { type: "azure-native:datamigration:Task" }, { type: "azure-nextgen:datamigration:Task" }, { type: "azure-native:datamigration/latest:Task" }, { type: "azure-nextgen:datamigration/latest:Task" }, { type: "azure-native:datamigration/v20171115preview:Task" }, { type: "azure-nextgen:datamigration/v20171115preview:Task" }, { type: "azure-native:datamigration/v20180315preview:Task" }, { type: "azure-nextgen:datamigration/v20180315preview:Task" }, { type: "azure-native:datamigration/v20180331preview:Task" }, { type: "azure-nextgen:datamigration/v20180331preview:Task" }, { type: "azure-native:datamigration/v20180419:Task" }, { type: "azure-nextgen:datamigration/v20180419:Task" }] };
...
export interface TaskArgs {
     ...
     * Custom task properties
     */
    readonly properties?: pulumi.Input<inputs.datamigration.v20180715preview.ConnectToMongoDbTaskProperties | inputs.datamigration.v20180715preview.ConnectToSourceOracleSyncTaskProperties | inputs.datamigration.v20180715preview.ConnectToSourcePostgreSqlSyncTaskProperties | inputs.datamigration.v20180715preview.ConnectToSourceSqlServerSyncTaskProperties | inputs.datamigration.v20180715preview.ConnectToSourceSqlServerTaskProperties | inputs.datamigration.v20180715preview.ConnectToTargetAzureDbForMySqlTaskProperties | inputs.datamigration.v20180715preview.ConnectToTargetAzureDbForPostgreSqlSyncTaskProperties | inputs.datamigration.v20180715preview.ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskProperties | inputs.datamigration.v20180715preview.ConnectToTargetSqlDbTaskProperties | inputs.datamigration.v20180715preview.ConnectToTargetSqlMISyncTaskProperties | inputs.datamigration.v20180715preview.ConnectToTargetSqlMITaskProperties | inputs.datamigration.v20180715preview.ConnectToTargetSqlSqlDbSyncTaskProperties | inputs.datamigration.v20180715preview.GetTdeCertificatesSqlTaskProperties | inputs.datamigration.v20180715preview.GetUserTablesOracleTaskProperties | inputs.datamigration.v20180715preview.GetUserTablesPostgreSqlTaskProperties | inputs.datamigration.v20180715preview.GetUserTablesSqlSyncTaskProperties | inputs.datamigration.v20180715preview.GetUserTablesSqlTaskProperties | inputs.datamigration.v20180715preview.MigrateMongoDbTaskProperties | inputs.datamigration.v20180715preview.MigrateMySqlAzureDbForMySqlSyncTaskProperties | inputs.datamigration.v20180715preview.MigrateOracleAzureDbForPostgreSqlSyncTaskProperties | inputs.datamigration.v20180715preview.MigratePostgreSqlAzureDbForPostgreSqlSyncTaskProperties | inputs.datamigration.v20180715preview.MigrateSqlServerSqlDbSyncTaskProperties | inputs.datamigration.v20180715preview.MigrateSqlServerSqlDbTaskProperties | inputs.datamigration.v20180715preview.MigrateSqlServerSqlMISyncTaskProperties | inputs.datamigration.v20180715preview.MigrateSqlServerSqlMITaskProperties | inputs.datamigration.v20180715preview.MigrateSsisTaskProperties | inputs.datamigration.v20180715preview.ValidateMigrationInputSqlServerSqlDbSyncTaskProperties | inputs.datamigration.v20180715preview.ValidateMigrationInputSqlServerSqlMISyncTaskProperties | inputs.datamigration.v20180715preview.ValidateMigrationInputSqlServerSqlMITaskProperties | inputs.datamigration.v20180715preview.ValidateMongoDbTaskProperties | inputs.datamigration.v20180715preview.ValidateOracleAzureDbForPostgreSqlSyncTaskProperties>;
    /**
     * Name of the service
     */
