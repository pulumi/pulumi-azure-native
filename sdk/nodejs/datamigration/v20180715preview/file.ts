...
export class File extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datamigration/v20180715preview:File" }, { type: "azure-native:datamigration:File" }, { type: "azure-nextgen:datamigration:File" }] };
...
export interface FileArgs {
     ...
     * Custom file properties
     */
    readonly properties?: pulumi.Input<inputs.datamigration.v20180715preview.ProjectFilePropertiesArgs>;
    /**
     * Name of the service
     */
