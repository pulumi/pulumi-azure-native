...
export class File extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datamigration/v20180715preview:File" }, { type: "azure-native:datamigration:File" }, { type: "azure-nextgen:datamigration:File" }, { type: "azure-native:datamigration/v20210630:File" }, { type: "azure-nextgen:datamigration/v20210630:File" }] };
