...
export class Task extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datamigration/latest:Task" }, { type: "azurerm:datamigration/v20171115preview:Task" }, { type: "azurerm:datamigration/v20180315preview:Task" }, { type: "azurerm:datamigration/v20180419:Task" }, { type: "azurerm:datamigration/v20180715preview:Task" }] };
