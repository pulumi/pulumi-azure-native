...
export class MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datamigration:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo';
    ...
    constructor(name: string, args: MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbvCoreMongo" }, { type: "azure-native:datamigration/v20230715preview:MongoClusterDatabaseMigrationsMongoToCosmosDbvCoreMongo" }, { type: "azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbvCoreMongo" }] };
