 ...
 *
 * const service = new azurerm.datamigration.v20171115preview.Service("service", {
 *     groupName: "DmsSdkRg",
...
export class Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datamigration/v20171115preview:Service';
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datamigration/latest:Service" }, { type: "azurerm:datamigration/v20180315preview:Service" }, { type: "azurerm:datamigration/v20180331preview:Service" }, { type: "azurerm:datamigration/v20180419:Service" }, { type: "azurerm:datamigration/v20180715preview:Service" }] };
