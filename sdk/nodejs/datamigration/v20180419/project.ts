...
export class Project extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datamigration/latest:Project" }, { type: "azurerm:datamigration/preview:Project" }, { type: "azurerm:datamigration/v20171115preview:Project" }, { type: "azurerm:datamigration/v20180315preview:Project" }, { type: "azurerm:datamigration/v20180331preview:Project" }, { type: "azurerm:datamigration/v20180715preview:Project" }] };
