 ...
 * A project resource
 *
 * @deprecated Version 2018-04-19 will be removed in v2 of the provider.
 */
export class Project extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Project {
        pulumi.log.warn("Project is deprecated: Version 2018-04-19 will be removed in v2 of the provider.")
