...
export class Task extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:datamigration/v20180419:Task';
    ...
    constructor(name: string, args: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datamigration:Task" }, { type: "azure-nextgen:datamigration/latest:Task" }, { type: "azure-nextgen:datamigration/v20171115preview:Task" }, { type: "azure-nextgen:datamigration/v20180315preview:Task" }, { type: "azure-nextgen:datamigration/v20180331preview:Task" }, { type: "azure-nextgen:datamigration/v20180715preview:Task" }] };
