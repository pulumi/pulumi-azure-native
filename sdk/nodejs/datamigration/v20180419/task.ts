...
export class Task extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datamigration/v20180419:Task';
    ...
    constructor(name: string, args: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datamigration/latest:Task" }, { type: "azurerm:datamigration/preview:Task" }, { type: "azurerm:datamigration/v20171115preview:Task" }, { type: "azurerm:datamigration/v20180315preview:Task" }, { type: "azurerm:datamigration/v20180331preview:Task" }, { type: "azurerm:datamigration/v20180715preview:Task" }] };
