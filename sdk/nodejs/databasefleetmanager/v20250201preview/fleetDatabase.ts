...
export class FleetDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databasefleetmanager/v20250201preview:FleetDatabase';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.databasefleetmanager.v20250201preview.FleetDatabasePropertiesResponse>;
    /**
...
export interface FleetDatabaseArgs {
     ...
     * Fleet database properties.
     */
    properties?: pulumi.Input<inputs.databasefleetmanager.v20250201preview.FleetDatabasePropertiesArgs>;
    /**
