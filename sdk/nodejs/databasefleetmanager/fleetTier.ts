...
export class FleetTier extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.databasefleetmanager.FleetTierPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FleetTierArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native_databasefleetmanager_v20250201preview:databasefleetmanager:FleetTier" }] };
