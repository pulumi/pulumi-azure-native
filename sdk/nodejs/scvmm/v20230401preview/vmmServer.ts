...
export class VmmServer extends pulumi.CustomResource {
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.scvmm.v20230401preview.VMMServerPropertiesResponseCredentials | undefined>;
    /**
    ...
    constructor(name: string, args: VmmServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm/v20200605preview:VmmServer" }, { type: "azure-native:scvmm/v20220521preview:VmmServer" }, { type: "azure-native:scvmm/v20231007:VmmServer" }, { type: "azure-native:scvmm/v20240601:VmmServer" }, { type: "azure-native:scvmm:VmmServer" }] };
...
export interface VmmServerArgs {
     ...
     * Credentials to connect to VMMServer.
     */
    credentials?: pulumi.Input<inputs.scvmm.v20230401preview.VMMServerPropertiesCredentialsArgs>;
    /**
     * The extended location.
     */
