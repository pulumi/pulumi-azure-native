...
export class VMInstanceGuestAgent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VMInstanceGuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm/v20231007:VMInstanceGuestAgent" }, { type: "azure-native:scvmm/v20240601:VMInstanceGuestAgent" }, { type: "azure-native:scvmm:VMInstanceGuestAgent" }] };
