...
export class VirtualMachineInstance extends pulumi.CustomResource {
     ...
     */
    public readonly availabilitySets!: pulumi.Output<outputs.scvmm.v20230401preview.VirtualMachineInstancePropertiesResponseAvailabilitySets[] | undefined>;
    /**
     ...
     * Hardware properties.
     */
    public readonly hardwareProfile!: pulumi.Output<outputs.scvmm.v20230401preview.HardwareProfileResponse | undefined>;
    /**
     * Gets the infrastructure profile.
     */
    public readonly infrastructureProfile!: pulumi.Output<outputs.scvmm.v20230401preview.InfrastructureProfileResponse | undefined>;
    /**
     ...
     * Network properties.
     */
    public readonly networkProfile!: pulumi.Output<outputs.scvmm.v20230401preview.NetworkProfileResponse | undefined>;
    /**
     * OS properties.
     */
    public readonly osProfile!: pulumi.Output<outputs.scvmm.v20230401preview.OsProfileForVMInstanceResponse | undefined>;
    /**
     ...
     * Storage properties.
     */
    public readonly storageProfile!: pulumi.Output<outputs.scvmm.v20230401preview.StorageProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualMachineInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:VirtualMachineInstance" }, { type: "azure-native:scvmm/v20231007:VirtualMachineInstance" }, { type: "azure-native:scvmm/v20240601:VirtualMachineInstance" }] };
...
export interface VirtualMachineInstanceArgs {
     ...
     * Availability Sets in vm.
     */
    availabilitySets?: pulumi.Input<pulumi.Input<inputs.scvmm.v20230401preview.VirtualMachineInstancePropertiesAvailabilitySetsArgs>[]>;
    /**
     * Gets or sets the extended location.
     */
     ...
     * Gets the infrastructure profile.
     */
    infrastructureProfile?: pulumi.Input<inputs.scvmm.v20230401preview.InfrastructureProfileArgs>;
    /**
     * Network properties.
     */
     ...
     * OS properties.
     */
    osProfile?: pulumi.Input<inputs.scvmm.v20230401preview.OsProfileForVMInstanceArgs>;
    /**
