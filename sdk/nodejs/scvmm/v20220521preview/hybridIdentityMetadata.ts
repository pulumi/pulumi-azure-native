...
export class HybridIdentityMetadata extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly identity!: pulumi.Output<outputs.scvmm.v20220521preview.IdentityResponse>;
    /**
    ...
    constructor(name: string, args: HybridIdentityMetadataArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm/v20230401preview:HybridIdentityMetadata" }, { type: "azure-native:scvmm:HybridIdentityMetadata" }] };
