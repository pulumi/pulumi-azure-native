...
export class VirtualNetwork extends pulumi.CustomResource {
     ...
     * Resource properties.
     */
    public readonly properties!: pulumi.Output<outputs.scvmm.v20200605preview.VirtualNetworkPropertiesResponse>;
    /**
     * The system data.
     */
    ...
    constructor(name: string, args: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:VirtualNetwork" }] };
...
export interface VirtualNetworkArgs {
     ...
     * Resource properties.
     */
    properties: pulumi.Input<inputs.scvmm.v20200605preview.VirtualNetworkPropertiesArgs>;
    /**
