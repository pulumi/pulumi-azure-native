...
export class GuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20240601:GuestAgent';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.scvmm.v20240601.GuestCredentialResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<outputs.scvmm.v20240601.HttpProxyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: GuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm/v20220521preview:GuestAgent" }, { type: "azure-native:scvmm/v20230401preview:GuestAgent" }, { type: "azure-native:scvmm/v20230401preview:VMInstanceGuestAgent" }, { type: "azure-native:scvmm/v20231007:GuestAgent" }, { type: "azure-native:scvmm:GuestAgent" }, { type: "azure-native:scvmm:VMInstanceGuestAgent" }] };
