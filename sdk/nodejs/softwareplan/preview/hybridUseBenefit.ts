...
export class HybridUseBenefit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:softwareplan/preview:HybridUseBenefit';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.softwareplan.preview.SkuResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: HybridUseBenefitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:softwareplan/latest:HybridUseBenefit" }, { type: "azurerm:softwareplan/v20190601preview:HybridUseBenefit" }, { type: "azurerm:softwareplan/v20191201:HybridUseBenefit" }] };
...
export interface HybridUseBenefitArgs {
     ...
     * Hybrid use benefit SKU
     */
    readonly sku: pulumi.Input<inputs.softwareplan.preview.Sku>;
}
