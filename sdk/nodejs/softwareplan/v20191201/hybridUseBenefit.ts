...
export class HybridUseBenefit extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: HybridUseBenefitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:softwareplan/latest:HybridUseBenefit" }, { type: "azurerm:softwareplan/preview:HybridUseBenefit" }, { type: "azurerm:softwareplan/v20190601preview:HybridUseBenefit" }] };
