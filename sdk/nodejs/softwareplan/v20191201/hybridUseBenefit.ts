...
export class HybridUseBenefit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:softwareplan/v20191201:HybridUseBenefit';
    ...
    constructor(name: string, args: HybridUseBenefitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:softwareplan/latest:HybridUseBenefit" }, { type: "azure-nextgen:softwareplan/v20190601preview:HybridUseBenefit" }] };
