...
export class HybridUseBenefit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:softwareplan:HybridUseBenefit';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.softwareplan.HybridUseBenefitPropertiesResponse>;
    /**
...
export interface HybridUseBenefitArgs {
     ...
     * Property bag for a hybrid use benefit response
     */
    readonly properties?: pulumi.Input<inputs.softwareplan.HybridUseBenefitProperties>;
    /**
