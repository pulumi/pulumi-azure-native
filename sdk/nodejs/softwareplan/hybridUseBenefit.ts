...
export class HybridUseBenefit extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HybridUseBenefitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:softwareplan/v20191201:HybridUseBenefit" }, { type: "azure-native_softwareplan_v20190601preview:softwareplan:HybridUseBenefit" }, { type: "azure-native_softwareplan_v20191201:softwareplan:HybridUseBenefit" }] };
