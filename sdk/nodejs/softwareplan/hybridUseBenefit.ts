...
export class HybridUseBenefit extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HybridUseBenefitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:softwareplan/latest:HybridUseBenefit" }, { type: "azure-nextgen:softwareplan/latest:HybridUseBenefit" }, { type: "azure-native:softwareplan/v20190601preview:HybridUseBenefit" }, { type: "azure-nextgen:softwareplan/v20190601preview:HybridUseBenefit" }, { type: "azure-native:softwareplan/v20191201:HybridUseBenefit" }, { type: "azure-nextgen:softwareplan/v20191201:HybridUseBenefit" }] };
