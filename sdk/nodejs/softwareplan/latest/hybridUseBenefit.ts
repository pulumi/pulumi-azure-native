...
export class HybridUseBenefit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:softwareplan/latest:HybridUseBenefit';
    ...
    constructor(name: string, args: HybridUseBenefitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:softwareplan/preview:HybridUseBenefit" }, { type: "azurerm:softwareplan/v20190601preview:HybridUseBenefit" }, { type: "azurerm:softwareplan/v20191201:HybridUseBenefit" }] };
