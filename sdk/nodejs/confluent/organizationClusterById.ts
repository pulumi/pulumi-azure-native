...
export class OrganizationClusterById extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OrganizationClusterByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:confluent/v20240701:OrganizationClusterById" }, { type: "azure-native:confluent/v20250717preview:OrganizationClusterById" }, { type: "azure-native:confluent/v20250818preview:OrganizationClusterById" }, { type: "azure-native:confluent/v20260501preview:OrganizationClusterById" }] };
