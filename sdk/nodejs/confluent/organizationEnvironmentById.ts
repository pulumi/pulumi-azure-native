...
export class OrganizationEnvironmentById extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OrganizationEnvironmentByIdArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:confluent/v20240701:OrganizationEnvironmentById" }, { type: "azure-native:confluent/v20250717preview:OrganizationEnvironmentById" }, { type: "azure-native:confluent/v20250818preview:OrganizationEnvironmentById" }, { type: "azure-native:confluent/v20260501preview:OrganizationEnvironmentById" }] };
