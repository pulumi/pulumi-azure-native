...
// Export enums:
export * from "../../types/enums/azuresphere/v20240401";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:azuresphere/v20240401:Catalog":
                return new Catalog(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20240401:Deployment":
                return new Deployment(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20240401:Device":
                return new Device(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20240401:DeviceGroup":
                return new DeviceGroup(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20240401:Image":
                return new Image(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20240401:Product":
...
pulumi.runtime.registerResourceModule("azure-native", "azuresphere/v20240401", _module)
