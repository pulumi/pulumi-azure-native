...
export class Catalog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuresphere/v20220901preview:Catalog';
    ...
    constructor(name: string, args: CatalogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuresphere:Catalog" }, { type: "azure-native:azuresphere/v20240401:Catalog" }] };
