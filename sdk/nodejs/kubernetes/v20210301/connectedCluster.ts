...
export class ConnectedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:kubernetes/v20210301:ConnectedCluster';
    ...
    constructor(name: string, args: ConnectedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:kubernetes:ConnectedCluster" }, { type: "azure-nextgen:kubernetes/latest:ConnectedCluster" }, { type: "azure-nextgen:kubernetes/v20200101preview:ConnectedCluster" }, { type: "azure-nextgen:kubernetes/v20210401preview:ConnectedCluster" }] };
...
export interface ConnectedClusterArgs {
     ...
     * The identity of the connected cluster.
     */
    readonly identity: pulumi.Input<inputs.kubernetes.v20210301.ConnectedClusterIdentity>;
    /**
     * The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
     */
