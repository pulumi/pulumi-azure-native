 ...
 *
 * const connectedCluster = new azure_native.kubernetes.v20210301.ConnectedCluster("connectedCluster", {
 ...
 *     identity: {
 *         type: azure_native.kubernetes.v20210301.ResourceIdentityType.SystemAssigned,
 *     },
 *     location: "East US",
...
export class ConnectedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetes/v20210301:ConnectedCluster';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.kubernetes.v20210301.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kubernetes.v20210301.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ConnectedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["identity"] = args ? (args.identity ? pulumi.output(args.identity).apply(inputs.kubernetes.v20210301.connectedClusterIdentityArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kubernetes:ConnectedCluster" }, { type: "azure-native:kubernetes/v20200101preview:ConnectedCluster" }, { type: "azure-native:kubernetes/v20210401preview:ConnectedCluster" }, { type: "azure-native:kubernetes/v20211001:ConnectedCluster" }, { type: "azure-native:kubernetes/v20220501preview:ConnectedCluster" }, { type: "azure-native:kubernetes/v20221001preview:ConnectedCluster" }] };
...
export interface ConnectedClusterArgs {
     ...
     * The identity of the connected cluster.
     */
    identity: pulumi.Input<inputs.kubernetes.v20210301.ConnectedClusterIdentityArgs>;
    /**
     * The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
     */
     ...
     * Provisioning state of the connected cluster resource.
     */
    provisioningState?: pulumi.Input<string | enums.kubernetes.v20210301.ProvisioningState>;
    /**
