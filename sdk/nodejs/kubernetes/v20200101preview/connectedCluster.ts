...
export class ConnectedCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:kubernetes/latest:ConnectedCluster" }, { type: "azure-nextgen:kubernetes/v20210301:ConnectedCluster" }, { type: "azure-nextgen:kubernetes/v20210401preview:ConnectedCluster" }] };
