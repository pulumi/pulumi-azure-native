...
export function getConnectedCluster(args: GetConnectedClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectedClusterResult> {
    ...
    return pulumi.runtime.invoke("azurerm:kubernetes/preview:getConnectedCluster", {
...
export interface GetConnectedClusterResult {
    readonly aadProfile: outputs.kubernetes.preview.ConnectedClusterAADProfileResponse;
    /**
     ...
     */
    readonly identity: outputs.kubernetes.preview.ConnectedClusterIdentityResponse;
    /**
