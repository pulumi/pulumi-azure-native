...
export class ConnectedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:kubernetes/preview:ConnectedCluster';
    ...
    public readonly aadProfile!: pulumi.Output<outputs.kubernetes.preview.ConnectedClusterAADProfileResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.kubernetes.preview.ConnectedClusterIdentityResponse>;
    /**
    ...
    constructor(name: string, args: ConnectedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:kubernetes/v20200101preview:ConnectedCluster" }] };
...
export interface ConnectedClusterArgs {
    readonly aadProfile: pulumi.Input<inputs.kubernetes.preview.ConnectedClusterAADProfile>;
    /**
     * Base64 encoded public certificate used by the agent to do the initial handshake to the backend services in Azure.
     */
     ...
     * The identity of the connected cluster.
     */
    readonly identity: pulumi.Input<inputs.kubernetes.preview.ConnectedClusterIdentity>;
    /**
     * The geo-location where the resource lives
     */
