...
export class ConnectedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetes/v20240601preview:ConnectedCluster';
     ...
     */
    public readonly aadProfile!: pulumi.Output<outputs.kubernetes.v20240601preview.AadProfileResponse | undefined>;
    /**
     ...
     */
    public readonly arcAgentProfile!: pulumi.Output<outputs.kubernetes.v20240601preview.ArcAgentProfileResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.kubernetes.v20240601preview.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    public readonly oidcIssuerProfile!: pulumi.Output<outputs.kubernetes.v20240601preview.OidcIssuerProfileResponse | undefined>;
    /**
     ...
     */
    public readonly securityProfile!: pulumi.Output<outputs.kubernetes.v20240601preview.SecurityProfileResponse | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kubernetes.v20240601preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ConnectedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["arcAgentProfile"] = args ? (args.arcAgentProfile ? pulumi.output(args.arcAgentProfile).apply(inputs.kubernetes.v20240601preview.arcAgentProfileArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["identity"] = args ? (args.identity ? pulumi.output(args.identity).apply(inputs.kubernetes.v20240601preview.connectedClusterIdentityArgsProvideDefaults) : undefined) : undefined;
