...
export class ConnectedCluster extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.kubernetes.ConnectedClusterPropertiesResponse>;
    /**
...
export interface ConnectedClusterArgs {
     ...
     * Describes the connected cluster resource properties.
     */
    properties: pulumi.Input<inputs.kubernetes.ConnectedClusterPropertiesArgs>;
    /**
