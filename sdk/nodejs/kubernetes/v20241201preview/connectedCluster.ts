...
export class ConnectedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetes/v20241201preview:ConnectedCluster';
     ...
     */
    public readonly aadProfile!: pulumi.Output<outputs.kubernetes.v20241201preview.AadProfileResponse | undefined>;
    /**
     ...
     */
    public readonly arcAgentProfile!: pulumi.Output<outputs.kubernetes.v20241201preview.ArcAgentProfileResponse | undefined>;
    /**
     * Configuration settings for customizing the behavior of the connected cluster.
     */
    public readonly arcAgentryConfigurations!: pulumi.Output<outputs.kubernetes.v20241201preview.ArcAgentryConfigurationsResponse[] | undefined>;
    /**
     ...
     */
    public readonly gateway!: pulumi.Output<outputs.kubernetes.v20241201preview.GatewayResponse | undefined>;
    /**
     * The identity of the connected cluster.
     */
    public readonly identity!: pulumi.Output<outputs.kubernetes.v20241201preview.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    public readonly oidcIssuerProfile!: pulumi.Output<outputs.kubernetes.v20241201preview.OidcIssuerProfileResponse | undefined>;
    /**
     ...
     */
    public readonly securityProfile!: pulumi.Output<outputs.kubernetes.v20241201preview.SecurityProfileResponse | undefined>;
    /**
     * Metadata pertaining to creation and last modification of the resource
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kubernetes.v20241201preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ConnectedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["arcAgentProfile"] = args ? (args.arcAgentProfile ? pulumi.output(args.arcAgentProfile).apply(inputs.kubernetes.v20241201preview.arcAgentProfileArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["arcAgentryConfigurations"] = args ? args.arcAgentryConfigurations : undefined;
            ...
            resourceInputs["identity"] = args ? (args.identity ? pulumi.output(args.identity).apply(inputs.kubernetes.v20241201preview.connectedClusterIdentityArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["arcAgentryConfigurations"] = undefined /*out*/;
...
export interface ConnectedClusterArgs {
     ...
     * AAD profile for the connected cluster.
     */
    aadProfile?: pulumi.Input<inputs.kubernetes.v20241201preview.AadProfileArgs>;
    /**
     * Base64 encoded public certificate used by the agent to do the initial handshake to the backend services in Azure.
     */
     ...
     * Arc agentry configuration for the provisioned cluster.
     */
    arcAgentProfile?: pulumi.Input<inputs.kubernetes.v20241201preview.ArcAgentProfileArgs>;
    /**
     * Configuration settings for customizing the behavior of the connected cluster.
     */
    arcAgentryConfigurations?: pulumi.Input<pulumi.Input<inputs.kubernetes.v20241201preview.ArcAgentryConfigurationsArgs>[]>;
    /**
     * Indicates whether Azure Hybrid Benefit is opted in
     */
    azureHybridBenefit?: pulumi.Input<string | enums.kubernetes.v20241201preview.AzureHybridBenefit>;
    /**
     ...
     * Details of the gateway used by the Arc router for connectivity.
     */
    gateway?: pulumi.Input<inputs.kubernetes.v20241201preview.GatewayArgs>;
    /**
     * The identity of the connected cluster.
     */
    identity: pulumi.Input<inputs.kubernetes.v20241201preview.ConnectedClusterIdentityArgs>;
    /**
     * The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
     */
     ...
     * The kind of connected cluster.
     */
    kind?: pulumi.Input<string | enums.kubernetes.v20241201preview.ConnectedClusterKind>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Open ID Connect (OIDC) Issuer Profile for the connected cluster.
     */
    oidcIssuerProfile?: pulumi.Input<inputs.kubernetes.v20241201preview.OidcIssuerProfileArgs>;
    /**
     * This is populated only if privateLinkState is enabled. The resource id of the private link scope this connected cluster is assigned to, if any.
     */
     ...
     * Property which describes the state of private link on a connected cluster resource.
     */
    privateLinkState?: pulumi.Input<string | enums.kubernetes.v20241201preview.PrivateLinkState>;
    /**
     * Provisioning state of the connected cluster resource.
     */
    provisioningState?: pulumi.Input<string | enums.kubernetes.v20241201preview.ProvisioningState>;
    /**
     ...
     * Security profile for the connected cluster.
     */
    securityProfile?: pulumi.Input<inputs.kubernetes.v20241201preview.SecurityProfileArgs>;
    /**
     * Resource tags.
     */
