...
export class ConnectedCluster extends pulumi.CustomResource {
     ...
     */
    public readonly aadProfile!: pulumi.Output<outputs.kubernetes.v20231101preview.AadProfileResponse | undefined>;
    /**
     ...
     */
    public readonly arcAgentProfile!: pulumi.Output<outputs.kubernetes.v20231101preview.ArcAgentProfileResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.kubernetes.v20231101preview.ConnectedClusterIdentityResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kubernetes.v20231101preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ConnectedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["arcAgentProfile"] = args ? (args.arcAgentProfile ? pulumi.output(args.arcAgentProfile).apply(inputs.kubernetes.v20231101preview.arcAgentProfileArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["identity"] = args ? (args.identity ? pulumi.output(args.identity).apply(inputs.kubernetes.v20231101preview.connectedClusterIdentityArgsProvideDefaults) : undefined) : undefined;
