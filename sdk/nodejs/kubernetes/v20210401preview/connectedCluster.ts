...
export class ConnectedCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:kubernetes/v20210401preview:ConnectedCluster" }, { type: "azure-native:kubernetes:ConnectedCluster" }, { type: "azure-nextgen:kubernetes:ConnectedCluster" }, { type: "azure-native:kubernetes/latest:ConnectedCluster" }, { type: "azure-nextgen:kubernetes/latest:ConnectedCluster" }, { type: "azure-native:kubernetes/v20200101preview:ConnectedCluster" }, { type: "azure-nextgen:kubernetes/v20200101preview:ConnectedCluster" }, { type: "azure-native:kubernetes/v20210301:ConnectedCluster" }, { type: "azure-nextgen:kubernetes/v20210301:ConnectedCluster" }] };
...
export interface ConnectedClusterArgs {
     ...
     * Provisioning state of the connected cluster resource.
     */
    readonly provisioningState?: pulumi.Input<string | enums.kubernetes.v20210401preview.ProvisioningState>;
    /**
