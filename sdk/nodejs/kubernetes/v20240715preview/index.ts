...
// Export enums:
export * from "../../types/enums/kubernetes/v20240715preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:kubernetes/v20240715preview:ConnectedCluster":
...
pulumi.runtime.registerResourceModule("azure-native", "kubernetes/v20240715preview", _module)
