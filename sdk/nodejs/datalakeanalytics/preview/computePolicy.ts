...
export class ComputePolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datalakeanalytics/preview:ComputePolicy';
    ...
    constructor(name: string, args: ComputePolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datalakeanalytics/latest:ComputePolicy" }, { type: "azurerm:datalakeanalytics/v20161101:ComputePolicy" }] };
