...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datalakeanalytics/preview:Account';
     ...
     */
    public readonly computePolicies!: pulumi.Output<outputs.datalakeanalytics.preview.ComputePolicyResponse[]>;
    /**
     ...
     */
    public readonly dataLakeStoreAccounts!: pulumi.Output<outputs.datalakeanalytics.preview.DataLakeStoreAccountInformationResponse[]>;
    /**
     ...
     */
    public readonly firewallRules!: pulumi.Output<outputs.datalakeanalytics.preview.FirewallRuleResponse[]>;
    /**
     ...
     */
    public readonly storageAccounts!: pulumi.Output<outputs.datalakeanalytics.preview.StorageAccountInformationResponse[]>;
    /**
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datalakeanalytics/latest:Account" }, { type: "azurerm:datalakeanalytics/v20161101:Account" }] };
...
export interface AccountArgs {
     ...
     * The list of compute policies associated with this account.
     */
    readonly computePolicies?: pulumi.Input<pulumi.Input<inputs.datalakeanalytics.preview.CreateComputePolicyWithAccountParameters>[]>;
    /**
     * The list of Data Lake Store accounts associated with this account.
     */
    readonly dataLakeStoreAccounts: pulumi.Input<pulumi.Input<inputs.datalakeanalytics.preview.AddDataLakeStoreWithAccountParameters>[]>;
    /**
     * The default Data Lake Store account associated with this account.
     */
     ...
     * The list of firewall rules associated with this account.
     */
    readonly firewallRules?: pulumi.Input<pulumi.Input<inputs.datalakeanalytics.preview.CreateFirewallRuleWithAccountParameters>[]>;
    /**
     * The current state of the IP address firewall for this account.
     */
     ...
     * The list of Azure Blob Storage accounts associated with this account.
     */
    readonly storageAccounts?: pulumi.Input<pulumi.Input<inputs.datalakeanalytics.preview.AddStorageAccountWithAccountParameters>[]>;
    /**
     * The resource tags.
     */
