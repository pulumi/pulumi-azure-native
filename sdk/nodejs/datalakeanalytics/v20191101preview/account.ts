...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["defaultDataLakeStoreAccountType"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datalakeanalytics/v20191101preview:Account" }, { type: "azure-native:datalakeanalytics:Account" }, { type: "azure-nextgen:datalakeanalytics:Account" }, { type: "azure-native:datalakeanalytics/v20151001preview:Account" }, { type: "azure-nextgen:datalakeanalytics/v20151001preview:Account" }, { type: "azure-native:datalakeanalytics/v20161101:Account" }, { type: "azure-nextgen:datalakeanalytics/v20161101:Account" }] };
