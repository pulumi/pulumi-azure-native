...
export class AccountComputePolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccountComputePolicyState, opts?: pulumi.CustomResourceOptions): AccountComputePolicy {
        return new AccountComputePolicy(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: AccountComputePolicyArgs | AccountComputePolicyState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as AccountComputePolicyState | undefined;
            inputs["name"] = state ? state.name : undefined;
            inputs["properties"] = state ? state.properties : undefined;
            inputs["type"] = state ? state.type : undefined;
        } else {
            const args = argsOrState as AccountComputePolicyArgs | undefined;
 ...
 * Data Lake Analytics compute policy information.
 */
export interface AccountComputePolicyState {
    /**
     * The resource name.
     */
     ...
     * The compute policy properties.
     */
    readonly properties: pulumi.Input<inputs.datalakeanalytics.ComputePolicyPropertiesResponse>;
    /**
     * The resource type.
     */
