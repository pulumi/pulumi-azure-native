...
export class ComputePolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datalakeanalytics/v20151001preview:ComputePolicy';
    ...
    constructor(name: string, args: ComputePolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datalakeanalytics/v20151001preview:ComputePolicy" }, { type: "azure-native:datalakeanalytics:ComputePolicy" }, { type: "azure-nextgen:datalakeanalytics:ComputePolicy" }, { type: "azure-native:datalakeanalytics/latest:ComputePolicy" }, { type: "azure-nextgen:datalakeanalytics/latest:ComputePolicy" }, { type: "azure-native:datalakeanalytics/v20161101:ComputePolicy" }, { type: "azure-nextgen:datalakeanalytics/v20161101:ComputePolicy" }] };
...
export interface ComputePolicyArgs {
     ...
     * The type of AAD object the object identifier refers to.
     */
    readonly objectType: pulumi.Input<string | enums.datalakeanalytics.v20151001preview.AADObjectType>;
    /**
