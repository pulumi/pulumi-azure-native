...
export class ComputePolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ComputePolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datalakeanalytics:ComputePolicy" }, { type: "azure-nextgen:datalakeanalytics:ComputePolicy" }, { type: "azure-native:datalakeanalytics/latest:ComputePolicy" }, { type: "azure-nextgen:datalakeanalytics/latest:ComputePolicy" }, { type: "azure-native:datalakeanalytics/v20161101:ComputePolicy" }, { type: "azure-nextgen:datalakeanalytics/v20161101:ComputePolicy" }] };
