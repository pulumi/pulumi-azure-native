...
export class FirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:datalakeanalytics:FirewallRule';
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datalakeanalytics/latest:FirewallRule" }, { type: "azure-nextgen:datalakeanalytics/v20151001preview:FirewallRule" }, { type: "azure-nextgen:datalakeanalytics/v20161101:FirewallRule" }] };
