...
export class ContactProfile extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ContactProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital:ContactProfile" }, { type: "azure-native:orbital/v20210404preview:ContactProfile" }, { type: "azure-native:orbital/v20220301:ContactProfile" }] };
