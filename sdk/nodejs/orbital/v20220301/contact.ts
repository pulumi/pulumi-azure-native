...
export class Contact extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ContactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital:Contact" }, { type: "azure-native:orbital/v20210404preview:Contact" }, { type: "azure-native:orbital/v20221101:Contact" }] };
