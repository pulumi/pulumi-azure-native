 ...
 *
 * const contact = new azure_native.orbital.v20220301.Contact("contact", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:orbital/v20220301:Contact contact1 /subscriptions/c1be1141-a7c9-4aac-9608-3c2e2f1152c3/resourceGroups/contoso-Rgp/providers/Microsoft.Orbital/spacecrafts/CONTOSO_SAT/contacts/contact1 
 * ```
 */
export class Contact extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:orbital/v20220301:Contact';
     ...
     */
    public /*out*/ readonly antennaConfiguration!: pulumi.Output<outputs.orbital.v20220301.ContactsPropertiesResponseAntennaConfiguration>;
    /**
     * The reference to the contact profile resource.
     */
    public readonly contactProfile!: pulumi.Output<outputs.orbital.v20220301.ContactsPropertiesResponseContactProfile>;
    /**
    ...
    constructor(name: string, args: ContactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital:Contact" }, { type: "azure-native:orbital/v20221101:Contact" }] };
...
export interface ContactArgs {
     ...
     * The reference to the contact profile resource.
     */
    contactProfile: pulumi.Input<inputs.orbital.v20220301.ContactsPropertiesContactProfileArgs>;
    /**
     * Azure Ground Station name.
     */
