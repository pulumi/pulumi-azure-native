...
export class GroundStation extends pulumi.CustomResource {
     ...
     */
    public readonly globalCommunicationsSite!: pulumi.Output<outputs.orbital.GroundStationsPropertiesResponseGlobalCommunicationsSite>;
    /**
    ...
    constructor(name: string, args: GroundStationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital/v20240301:GroundStation" }, { type: "azure-native:orbital/v20240301preview:GroundStation" }, { type: "azure-native_orbital_v20240301:orbital:GroundStation" }, { type: "azure-native_orbital_v20240301preview:orbital:GroundStation" }] };
