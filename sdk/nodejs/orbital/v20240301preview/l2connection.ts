...
export class L2Connection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:orbital/v20240301preview:L2Connection';
     ...
     */
    public readonly edgeSite!: pulumi.Output<outputs.orbital.v20240301preview.L2ConnectionsPropertiesResponseEdgeSite>;
    /**
    ...
    constructor(name: string, args: L2ConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital/v20240301:L2Connection" }, { type: "azure-native:orbital:L2Connection" }] };
...
export interface L2ConnectionArgs {
     ...
     * A reference to an Microsoft.Orbital/edgeSites resource to route traffic for.
     */
    edgeSite: pulumi.Input<inputs.orbital.v20240301preview.L2ConnectionsPropertiesEdgeSiteArgs>;
    /**
     * A reference to an Microsoft.Orbital/groundStations resource to route traffic for.
     */
