 ...
 *
 * const trustedIdProvider = new azurerm.datalakestore.v20161101.TrustedIdProvider("trustedIdProvider", {
...
export class TrustedIdProvider extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: TrustedIdProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datalakestore/latest:TrustedIdProvider" }] };
