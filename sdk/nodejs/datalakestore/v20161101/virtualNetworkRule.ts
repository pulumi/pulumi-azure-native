...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datalakestore/v20161101:VirtualNetworkRule" }, { type: "azure-native:datalakestore:VirtualNetworkRule" }, { type: "azure-nextgen:datalakestore:VirtualNetworkRule" }, { type: "azure-native:datalakestore/latest:VirtualNetworkRule" }, { type: "azure-nextgen:datalakestore/latest:VirtualNetworkRule" }] };
