...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datalakestore/preview:Account';
     ...
     */
    public readonly encryptionConfig!: pulumi.Output<outputs.datalakestore.preview.EncryptionConfigResponse>;
    /**
     ...
     */
    public readonly firewallRules!: pulumi.Output<outputs.datalakestore.preview.FirewallRuleResponse[]>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.datalakestore.preview.EncryptionIdentityResponse>;
    /**
     ...
     */
    public readonly trustedIdProviders!: pulumi.Output<outputs.datalakestore.preview.TrustedIdProviderResponse[]>;
    /**
     * The resource type.
     */
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.datalakestore.preview.VirtualNetworkRuleResponse[]>;
    ...
    constructor(name: string, argsOrState?: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datalakestore/latest:Account" }, { type: "azurerm:datalakestore/v20161101:Account" }] };
...
export interface AccountArgs {
     ...
     * The Key Vault encryption configuration.
     */
    readonly encryptionConfig?: pulumi.Input<inputs.datalakestore.preview.EncryptionConfig>;
    /**
     * The current state of encryption for this Data Lake Store account.
     */
     ...
     * The list of firewall rules associated with this Data Lake Store account.
     */
    readonly firewallRules?: pulumi.Input<pulumi.Input<inputs.datalakestore.preview.CreateFirewallRuleWithAccountParameters>[]>;
    /**
     * The current state of the IP address firewall for this Data Lake Store account.
     */
     ...
     * The Key Vault encryption identity, if any.
     */
    readonly identity?: pulumi.Input<inputs.datalakestore.preview.EncryptionIdentity>;
    /**
     * The resource location.
     */
     ...
     * The list of trusted identity providers associated with this Data Lake Store account.
     */
    readonly trustedIdProviders?: pulumi.Input<pulumi.Input<inputs.datalakestore.preview.CreateTrustedIdProviderWithAccountParameters>[]>;
    /**
     * The list of virtual network rules associated with this Data Lake Store account.
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.datalakestore.preview.CreateVirtualNetworkRuleWithAccountParameters>[]>;
}
