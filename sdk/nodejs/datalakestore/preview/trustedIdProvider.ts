...
export class TrustedIdProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datalakestore/preview:TrustedIdProvider';
    ...
    constructor(name: string, args: TrustedIdProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datalakestore/latest:TrustedIdProvider" }, { type: "azurerm:datalakestore/v20161101:TrustedIdProvider" }] };
