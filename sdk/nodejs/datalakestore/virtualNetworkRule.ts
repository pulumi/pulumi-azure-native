...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datalakestore:VirtualNetworkRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.datalakestore.VirtualNetworkRulePropertiesResponse>;
    /**
     * The resource type.
     */
...
export interface VirtualNetworkRuleArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.datalakestore.CreateOrUpdateVirtualNetworkRuleProperties>;
    /**
