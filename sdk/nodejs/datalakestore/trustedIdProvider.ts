...
export class TrustedIdProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:datalakestore:TrustedIdProvider';
    ...
    constructor(name: string, args: TrustedIdProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datalakestore/latest:TrustedIdProvider" }, { type: "azure-nextgen:datalakestore/v20161101:TrustedIdProvider" }] };
