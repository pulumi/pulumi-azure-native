...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:datalakestore/latest:VirtualNetworkRule';
    ...
    constructor(name: string, argsOrState?: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:datalakestore/preview:VirtualNetworkRule" }, { type: "azurerm:datalakestore/v20161101:VirtualNetworkRule" }] };
