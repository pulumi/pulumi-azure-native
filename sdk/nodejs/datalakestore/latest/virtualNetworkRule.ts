...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datalakestore/latest:VirtualNetworkRule';
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datalakestore/latest:VirtualNetworkRule" }, { type: "azure-native:datalakestore:VirtualNetworkRule" }, { type: "azure-nextgen:datalakestore:VirtualNetworkRule" }, { type: "azure-native:datalakestore/v20161101:VirtualNetworkRule" }, { type: "azure-nextgen:datalakestore/v20161101:VirtualNetworkRule" }] };
