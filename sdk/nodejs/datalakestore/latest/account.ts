...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datalakestore/latest:Account';
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datalakestore/latest:Account" }, { type: "azure-native:datalakestore:Account" }, { type: "azure-nextgen:datalakestore:Account" }, { type: "azure-native:datalakestore/v20161101:Account" }, { type: "azure-nextgen:datalakestore/v20161101:Account" }] };
...
export interface AccountArgs {
     ...
     * The current state of encryption for this Data Lake Store account.
     */
    readonly encryptionState?: pulumi.Input<enums.datalakestore.latest.EncryptionState>;
    /**
     * The current state of allowing or disallowing IPs originating within Azure through the firewall. If the firewall is disabled, this is not enforced.
     */
    readonly firewallAllowAzureIps?: pulumi.Input<enums.datalakestore.latest.FirewallAllowAzureIpsState>;
    /**
     * The list of firewall rules associated with this Data Lake Store account.
     */
     ...
     * The current state of the IP address firewall for this Data Lake Store account.
     */
    readonly firewallState?: pulumi.Input<enums.datalakestore.latest.FirewallState>;
    /**
     * The Key Vault encryption identity, if any.
     */
     ...
     * The commitment tier to use for next month.
     */
    readonly newTier?: pulumi.Input<enums.datalakestore.latest.TierType>;
    /**
     ...
     * The current state of the trusted identity provider feature for this Data Lake Store account.
     */
    readonly trustedIdProviderState?: pulumi.Input<enums.datalakestore.latest.TrustedIdProviderState>;
    /**
     * The list of trusted identity providers associated with this Data Lake Store account.
     */
