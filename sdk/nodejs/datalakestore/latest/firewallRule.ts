...
export class FirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FirewallRule {
        pulumi.log.warn("FirewallRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datalakestore:FirewallRule'.")
        return new FirewallRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:datalakestore/latest:FirewallRule';
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datalakestore/latest:FirewallRule" }, { type: "azure-native:datalakestore:FirewallRule" }, { type: "azure-nextgen:datalakestore:FirewallRule" }, { type: "azure-native:datalakestore/v20161101:FirewallRule" }, { type: "azure-nextgen:datalakestore/v20161101:FirewallRule" }] };
