...
export class ClusterService extends pulumi.CustomResource {
     ...
     */
    public readonly clusterTypeSpecificData!: pulumi.Output<outputs.mobilepacketcore.v20231015preview.ClusterServiceAksClusterDataResponse | outputs.mobilepacketcore.v20231015preview.ClusterServiceNexusAksClusterDataResponse>;
    /**
     * Azure for Operators 5G Core Local PaaS component parameters.  One set per component type
     */
    public readonly componentParameters!: pulumi.Output<outputs.mobilepacketcore.v20231015preview.QualifiedComponentDeploymentParametersResponse[]>;
    /**
...
export interface ClusterServiceArgs {
     ...
     * Cluster type specific data.  Contents depend on the cluster type
     */
    clusterTypeSpecificData: pulumi.Input<inputs.mobilepacketcore.v20231015preview.ClusterServiceAksClusterDataArgs | inputs.mobilepacketcore.v20231015preview.ClusterServiceNexusAksClusterDataArgs>;
    /**
     * Azure for Operators 5G Core Local PaaS component parameters.  One set per component type
     */
    componentParameters: pulumi.Input<pulumi.Input<inputs.mobilepacketcore.v20231015preview.QualifiedComponentDeploymentParametersArgs>[]>;
    /**
     * Cluster type (Lab or Production)
     */
    deploymentType: pulumi.Input<string | enums.mobilepacketcore.v20231015preview.SkuDeploymentType>;
    /**
     * The geo-location where the resource lives
     */
