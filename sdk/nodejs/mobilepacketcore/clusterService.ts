...
export class ClusterService extends pulumi.CustomResource {
     ...
     */
    public readonly clusterTypeSpecificData!: pulumi.Output<outputs.mobilepacketcore.ClusterServiceAksClusterDataResponse | outputs.mobilepacketcore.ClusterServiceNexusAksClusterDataResponse>;
    /**
     * Azure for Operators 5G Core Local PaaS component parameters.  One set per component type
     */
    public readonly componentParameters!: pulumi.Output<outputs.mobilepacketcore.QualifiedComponentDeploymentParametersResponse[]>;
    /**
     ...
     * Operational status
     */
    public /*out*/ readonly operationalStatus!: pulumi.Output<outputs.mobilepacketcore.OperationalStatusResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.mobilepacketcore.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface ClusterServiceArgs {
     ...
     * Cluster type specific data.  Contents depend on the cluster type
     */
    clusterTypeSpecificData: pulumi.Input<inputs.mobilepacketcore.ClusterServiceAksClusterDataArgs | inputs.mobilepacketcore.ClusterServiceNexusAksClusterDataArgs>;
    /**
     * Azure for Operators 5G Core Local PaaS component parameters.  One set per component type
     */
    componentParameters: pulumi.Input<pulumi.Input<inputs.mobilepacketcore.QualifiedComponentDeploymentParametersArgs>[]>;
    /**
     * Cluster type (Lab or Production)
     */
    deploymentType: pulumi.Input<string | enums.mobilepacketcore.SkuDeploymentType>;
    /**
     * The geo-location where the resource lives
     */
