...
export class VolumeSnapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerstorage:VolumeSnapshot';
    ...
    constructor(name: string, args: VolumeSnapshotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerstorage/v20230301preview:VolumeSnapshot" }] };
