...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerstorage/v20230301preview:Pool';
     ...
     */
    public readonly diskPoolProperties!: pulumi.Output<outputs.containerstorage.v20230301preview.DiskPoolPropertiesResponse | undefined>;
    /**
     * Elastic San Pool Properties
     */
    public readonly elasticSanPoolProperties!: pulumi.Output<outputs.containerstorage.v20230301preview.ElasticSanPoolPropertiesResponse>;
    /**
     * Ephemeral Pool Properties
     */
    public readonly ephemeralPoolProperties!: pulumi.Output<outputs.containerstorage.v20230301preview.EphemeralPoolPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["diskPoolProperties"] = args ? (args.diskPoolProperties ? pulumi.output(args.diskPoolProperties).apply(inputs.containerstorage.v20230301preview.diskPoolPropertiesArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["elasticSanPoolProperties"] = args ? args.elasticSanPoolProperties : undefined;
            resourceInputs["ephemeralPoolProperties"] = args ? (args.ephemeralPoolProperties ? pulumi.output(args.ephemeralPoolProperties).apply(inputs.containerstorage.v20230301preview.ephemeralPoolPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface PoolArgs {
     ...
     * Ephemeral Pool Properties
     */
    ephemeralPoolProperties?: pulumi.Input<inputs.containerstorage.v20230301preview.EphemeralPoolPropertiesArgs>;
    /**
     * The geo-location where the resource lives
     */
