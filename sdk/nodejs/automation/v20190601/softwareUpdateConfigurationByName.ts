...
export class SoftwareUpdateConfigurationByName extends pulumi.CustomResource {
     ...
     * Software update configuration properties.
     */
    public readonly properties!: pulumi.Output<outputs.automation.v20190601.SoftwareUpdateConfigurationPropertiesResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: SoftwareUpdateConfigurationByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.automation.v20190601.softwareUpdateConfigurationPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface SoftwareUpdateConfigurationByNameArgs {
     ...
     * Software update configuration properties.
     */
    properties: pulumi.Input<inputs.automation.v20190601.SoftwareUpdateConfigurationPropertiesArgs>;
    /**
