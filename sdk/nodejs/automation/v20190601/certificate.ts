...
export class Certificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Certificate {
        pulumi.log.warn("Certificate is deprecated: azure-native:automation/v20190601:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Certificate to guarantee forwards compatibility.")
        return new Certificate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20190601:Certificate';
    ...
    constructor(name: string, args: CertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Certificate" }, { type: "azure-native:automation/v20151031:Certificate" }, { type: "azure-native:automation/v20200113preview:Certificate" }, { type: "azure-native:automation/v20220808:Certificate" }] };
