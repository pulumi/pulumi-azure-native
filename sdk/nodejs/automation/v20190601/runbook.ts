...
export class Runbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20190601:Runbook';
     ...
     */
    public readonly draft!: pulumi.Output<outputs.automation.v20190601.RunbookDraftResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly parameters!: pulumi.Output<{[key: string]: outputs.automation.v20190601.RunbookParameterResponse} | undefined>;
    /**
     ...
     */
    public readonly publishContentLink!: pulumi.Output<outputs.automation.v20190601.ContentLinkResponse | undefined>;
    /**
    ...
    constructor(name: string, args: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/v20190601:Runbook" }, { type: "azure-native:automation:Runbook" }, { type: "azure-nextgen:automation:Runbook" }, { type: "azure-native:automation/latest:Runbook" }, { type: "azure-nextgen:automation/latest:Runbook" }, { type: "azure-native:automation/v20151031:Runbook" }, { type: "azure-nextgen:automation/v20151031:Runbook" }, { type: "azure-native:automation/v20180630:Runbook" }, { type: "azure-nextgen:automation/v20180630:Runbook" }] };
...
export interface RunbookArgs {
     ...
     * Gets or sets the draft runbook properties.
     */
    readonly draft?: pulumi.Input<inputs.automation.v20190601.RunbookDraft>;
    /**
     ...
     * Gets or sets the published runbook content link.
     */
    readonly publishContentLink?: pulumi.Input<inputs.automation.v20190601.ContentLink>;
    /**
     ...
     * Gets or sets the type of the runbook.
     */
    readonly runbookType: pulumi.Input<string | enums.automation.v20190601.RunbookTypeEnum>;
    /**
