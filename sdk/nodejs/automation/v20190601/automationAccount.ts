...
export class AutomationAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AutomationAccount {
        pulumi.log.warn("AutomationAccount is deprecated: azure-native:automation/v20190601:AutomationAccount is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:AutomationAccount to guarantee forwards compatibility.")
