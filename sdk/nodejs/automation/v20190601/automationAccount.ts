...
export class AutomationAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20190601:AutomationAccount';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.automation.v20190601.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AutomationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/v20190601:AutomationAccount" }, { type: "azure-native:automation:AutomationAccount" }, { type: "azure-nextgen:automation:AutomationAccount" }, { type: "azure-native:automation/latest:AutomationAccount" }, { type: "azure-nextgen:automation/latest:AutomationAccount" }, { type: "azure-native:automation/v20151031:AutomationAccount" }, { type: "azure-nextgen:automation/v20151031:AutomationAccount" }, { type: "azure-native:automation/v20200113preview:AutomationAccount" }, { type: "azure-nextgen:automation/v20200113preview:AutomationAccount" }] };
...
export interface AutomationAccountArgs {
     ...
     */
    readonly sku?: pulumi.Input<inputs.automation.v20190601.Sku>;
    /**
