...
export class AutomationAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AutomationAccount {
        pulumi.log.warn("AutomationAccount is deprecated: azure-native:automation/v20190601:AutomationAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:AutomationAccount to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: AutomationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:AutomationAccount" }, { type: "azure-native:automation/v20151031:AutomationAccount" }, { type: "azure-native:automation/v20200113preview:AutomationAccount" }, { type: "azure-native:automation/v20210622:AutomationAccount" }, { type: "azure-native:automation/v20220808:AutomationAccount" }] };
...
export interface AutomationAccountArgs {
     ...
     */
    sku?: pulumi.Input<inputs.automation.v20190601.SkuArgs>;
    /**
