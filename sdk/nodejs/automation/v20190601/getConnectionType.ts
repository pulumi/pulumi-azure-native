...
export function getConnectionType(args: GetConnectionTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionTypeResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:automation/v20190601:getConnectionType", {
...
export interface GetConnectionTypeResult {
     ...
     */
    readonly fieldDefinitions: {[key: string]: outputs.automation.v20190601.FieldDefinitionInvokeResponse};
    /**
