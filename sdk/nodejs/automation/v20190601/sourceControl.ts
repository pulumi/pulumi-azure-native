...
export class SourceControl extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/v20190601:SourceControl" }, { type: "azure-native:automation:SourceControl" }, { type: "azure-nextgen:automation:SourceControl" }, { type: "azure-native:automation/latest:SourceControl" }, { type: "azure-nextgen:automation/latest:SourceControl" }, { type: "azure-native:automation/v20170515preview:SourceControl" }, { type: "azure-nextgen:automation/v20170515preview:SourceControl" }, { type: "azure-native:automation/v20200113preview:SourceControl" }, { type: "azure-nextgen:automation/v20200113preview:SourceControl" }] };
...
export interface SourceControlArgs {
     ...
     */
    readonly sourceType?: pulumi.Input<string | enums.automation.v20190601.SourceType>;
}
