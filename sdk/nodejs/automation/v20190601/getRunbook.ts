...
export function getRunbook(args: GetRunbookArgs, opts?: pulumi.InvokeOptions): Promise<GetRunbookResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:automation/v20190601:getRunbook", {
...
export interface GetRunbookResult {
     ...
     */
    readonly draft?: outputs.automation.v20190601.RunbookDraftInvokeResponse;
    /**
     ...
     */
    readonly parameters?: {[key: string]: outputs.automation.v20190601.RunbookParameterInvokeResponse};
    /**
     ...
     */
    readonly publishContentLink?: outputs.automation.v20190601.ContentLinkInvokeResponse;
    /**
