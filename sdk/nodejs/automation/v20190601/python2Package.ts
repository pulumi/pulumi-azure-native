...
export class Python2Package extends pulumi.CustomResource {
    ...
    constructor(name: string, args: Python2PackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Python2Package" }, { type: "azure-native:automation/v20200113preview:Python2Package" }, { type: "azure-native:automation/v20220808:Python2Package" }] };
