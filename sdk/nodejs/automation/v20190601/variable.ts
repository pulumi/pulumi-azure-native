...
export class Variable extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VariableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Variable" }, { type: "azure-native:automation/v20151031:Variable" }, { type: "azure-native:automation/v20200113preview:Variable" }, { type: "azure-native:automation/v20220808:Variable" }] };
