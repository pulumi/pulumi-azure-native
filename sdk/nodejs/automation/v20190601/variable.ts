...
export class Variable extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VariableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/v20190601:Variable" }, { type: "azure-native:automation:Variable" }, { type: "azure-nextgen:automation:Variable" }, { type: "azure-native:automation/latest:Variable" }, { type: "azure-nextgen:automation/latest:Variable" }, { type: "azure-native:automation/v20151031:Variable" }, { type: "azure-nextgen:automation/v20151031:Variable" }, { type: "azure-native:automation/v20200113preview:Variable" }, { type: "azure-nextgen:automation/v20200113preview:Variable" }] };
