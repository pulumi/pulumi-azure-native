...
export class DscConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DscConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:DscConfiguration" }, { type: "azure-nextgen:automation:DscConfiguration" }, { type: "azure-native:automation/latest:DscConfiguration" }, { type: "azure-nextgen:automation/latest:DscConfiguration" }, { type: "azure-native:automation/v20151031:DscConfiguration" }, { type: "azure-nextgen:automation/v20151031:DscConfiguration" }] };
