 ...
 *
 * const dscConfiguration = new azure_native.automation.v20190601.DscConfiguration("dscConfiguration", {
...
export interface DscConfigurationArgs {
     ...
     * Gets or sets the configuration parameters.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.v20190601.DscConfigurationParameterArgs>}>;
    /**
