...
export class DscConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20190601:DscConfiguration';
     ...
     */
    public /*out*/ readonly parameters!: pulumi.Output<{[key: string]: outputs.automation.v20190601.DscConfigurationParameterResponse} | undefined>;
    /**
     ...
     */
    public /*out*/ readonly source!: pulumi.Output<outputs.automation.v20190601.ContentSourceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DscConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:DscConfiguration" }, { type: "azure-native:automation/v20151031:DscConfiguration" }, { type: "azure-native:automation/v20220808:DscConfiguration" }] };
...
export interface DscConfigurationArgs {
     ...
     */
    properties: pulumi.Input<inputs.automation.v20190601.DscConfigurationCreateOrUpdatePropertiesArgs>;
    /**
