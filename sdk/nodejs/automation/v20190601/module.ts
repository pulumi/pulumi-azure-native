...
export class Module extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Module {
        pulumi.log.warn("Module is deprecated: azure-native:automation/v20190601:Module is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Module to guarantee forwards compatibility.")
        return new Module(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20190601:Module';
     ...
     */
    public readonly contentLink!: pulumi.Output<outputs.automation.v20190601.ContentLinkResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly error!: pulumi.Output<outputs.automation.v20190601.ModuleErrorInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ModuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Module" }, { type: "azure-native:automation/v20151031:Module" }, { type: "azure-native:automation/v20200113preview:Module" }, { type: "azure-native:automation/v20220808:Module" }] };
...
export interface ModuleArgs {
     ...
     */
    contentLink: pulumi.Input<inputs.automation.v20190601.ContentLinkArgs>;
    /**
