...
export class Module extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ModuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:Module" }, { type: "azure-nextgen:automation/v20151031:Module" }, { type: "azure-nextgen:automation/v20200113preview:Module" }] };
