...
export class JobSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/v20190601:JobSchedule" }, { type: "azure-native:automation:JobSchedule" }, { type: "azure-nextgen:automation:JobSchedule" }, { type: "azure-native:automation/latest:JobSchedule" }, { type: "azure-nextgen:automation/latest:JobSchedule" }, { type: "azure-native:automation/v20151031:JobSchedule" }, { type: "azure-nextgen:automation/v20151031:JobSchedule" }, { type: "azure-native:automation/v20200113preview:JobSchedule" }, { type: "azure-nextgen:automation/v20200113preview:JobSchedule" }] };
...
export interface JobScheduleArgs {
     ...
     * Gets or sets the runbook.
     */
    readonly runbook: pulumi.Input<inputs.automation.v20190601.RunbookAssociationProperty>;
    /**
     * Gets or sets the schedule.
     */
    readonly schedule: pulumi.Input<inputs.automation.v20190601.ScheduleAssociationProperty>;
}
