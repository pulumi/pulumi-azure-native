...
export class AutomationAccountConnection extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutomationAccountConnectionState, opts?: pulumi.CustomResourceOptions): AutomationAccountConnection {
        return new AutomationAccountConnection(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: AutomationAccountConnectionArgs | AutomationAccountConnectionState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as AutomationAccountConnectionState | undefined;
 ...
 * Definition of the connection.
 */
export interface AutomationAccountConnectionState {
    /**
     * The name of the resource
     */
     ...
     * Gets or sets the properties of the connection.
     */
    readonly properties: pulumi.Input<inputs.automation.ConnectionPropertiesResponse>;
    /**
     * The type of the resource.
     */
