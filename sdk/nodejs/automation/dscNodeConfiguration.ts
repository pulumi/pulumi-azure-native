...
export class DscNodeConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation:DscNodeConfiguration';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.automation.DscNodeConfigurationPropertiesResponse>;
    /**
...
export interface DscNodeConfigurationArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.automation.DscNodeConfigurationCreateOrUpdateParametersProperties>;
    /**
