...
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.automation.PrivateEndpointPropertyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation:PrivateEndpointConnection" }, { type: "azure-native:automation/v20200113preview:PrivateEndpointConnection" }, { type: "azure-nextgen:automation/v20200113preview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.automation.PrivateEndpointProperty>;
    /**
     ...
     * Connection State of the Private Endpoint Connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.automation.PrivateLinkServiceConnectionStateProperty>;
    /**
