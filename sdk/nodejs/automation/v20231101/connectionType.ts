...
export class ConnectionType extends pulumi.CustomResource {
     ...
     */
    public readonly fieldDefinitions!: pulumi.Output<{[key: string]: outputs.automation.v20231101.FieldDefinitionResponse}>;
    /**
...
export interface ConnectionTypeArgs {
     ...
     */
    fieldDefinitions: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.v20231101.FieldDefinitionArgs>}>;
    /**
     * Gets or sets a Boolean value to indicate if the connection type is global.
     */
