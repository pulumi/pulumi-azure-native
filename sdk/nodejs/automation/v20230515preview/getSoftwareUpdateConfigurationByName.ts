...
export interface GetSoftwareUpdateConfigurationByNameResult {
     ...
     */
    readonly error?: outputs.automation.v20230515preview.ErrorResponseResponse;
    /**
     * Resource Id.
     */
    readonly id: string;
     ...
     */
    readonly scheduleInfo: outputs.automation.v20230515preview.SUCSchedulePropertiesResponse;
    /**
     * Tasks information for the Software update configuration.
     */
    readonly tasks?: outputs.automation.v20230515preview.SoftwareUpdateConfigurationTasksResponse;
    /**
     * Resource type
     */
     ...
     */
    readonly updateConfiguration: outputs.automation.v20230515preview.UpdateConfigurationResponse;
}
/**
 * Get a single software update configuration by name.
 */
export function getSoftwareUpdateConfigurationByNameOutput(args: GetSoftwareUpdateConfigurationByNameOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSoftwareUpdateConfigurationByNameResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:automation/v20230515preview:getSoftwareUpdateConfigurationByName", {
        "automationAccountName": args.automationAccountName,
        "resourceGroupName": args.resourceGroupName,
        "softwareUpdateConfigurationName": args.softwareUpdateConfigurationName,
    }, opts);
