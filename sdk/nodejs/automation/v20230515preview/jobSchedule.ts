...
export class JobSchedule extends pulumi.CustomResource {
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.automation.v20230515preview.ScheduleAssociationPropertyResponse | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: JobScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:JobSchedule" }, { type: "azure-native:automation/v20151031:JobSchedule" }, { type: "azure-native:automation/v20190601:JobSchedule" }, { type: "azure-native:automation/v20200113preview:JobSchedule" }, { type: "azure-native:automation/v20220808:JobSchedule" }] };
