 ...
 *
 * @deprecated azure-native:automation/v20180115:DscNodeConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:DscNodeConfiguration to guarantee forwards compatibility.
 */
export class DscNodeConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DscNodeConfiguration {
        pulumi.log.warn("DscNodeConfiguration is deprecated: azure-native:automation/v20180115:DscNodeConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:DscNodeConfiguration to guarantee forwards compatibility.")
        return new DscNodeConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20180115:DscNodeConfiguration';
    ...
    constructor(name: string, args: DscNodeConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:DscNodeConfiguration" }, { type: "azure-native:automation/v20151031:DscNodeConfiguration" }, { type: "azure-native:automation/v20190601:DscNodeConfiguration" }, { type: "azure-native:automation/v20200113preview:DscNodeConfiguration" }, { type: "azure-native:automation/v20220808:DscNodeConfiguration" }] };
...
export interface DscNodeConfigurationArgs {
     ...
     * Gets or sets the configuration of the node.
     */
    configuration: pulumi.Input<inputs.automation.v20180115.DscConfigurationAssociationPropertyArgs>;
    /**
     * If a new build version of NodeConfiguration is required.
     */
     ...
     */
    source: pulumi.Input<inputs.automation.v20180115.ContentSourceArgs>;
    /**
