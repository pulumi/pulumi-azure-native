...
export class DscNodeConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DscNodeConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/v20180115:DscNodeConfiguration" }, { type: "azure-native:automation:DscNodeConfiguration" }, { type: "azure-nextgen:automation:DscNodeConfiguration" }, { type: "azure-native:automation/v20151031:DscNodeConfiguration" }, { type: "azure-nextgen:automation/v20151031:DscNodeConfiguration" }, { type: "azure-native:automation/v20190601:DscNodeConfiguration" }, { type: "azure-nextgen:automation/v20190601:DscNodeConfiguration" }, { type: "azure-native:automation/v20200113preview:DscNodeConfiguration" }, { type: "azure-nextgen:automation/v20200113preview:DscNodeConfiguration" }] };
...
export interface DscNodeConfigurationArgs {
     ...
     * Gets or sets the configuration of the node.
     */
    readonly configuration: pulumi.Input<inputs.automation.v20180115.DscConfigurationAssociationPropertyArgs>;
    /**
     * If a new build version of NodeConfiguration is required.
     */
     ...
     */
    readonly source: pulumi.Input<inputs.automation.v20180115.ContentSourceArgs>;
    /**
