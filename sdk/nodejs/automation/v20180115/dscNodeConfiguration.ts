...
export class DscNodeConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DscNodeConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:DscNodeConfiguration" }, { type: "azure-nextgen:automation/v20151031:DscNodeConfiguration" }, { type: "azure-nextgen:automation/v20190601:DscNodeConfiguration" }, { type: "azure-nextgen:automation/v20200113preview:DscNodeConfiguration" }] };
