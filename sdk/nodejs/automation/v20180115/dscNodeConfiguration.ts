...
export class DscNodeConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DscNodeConfiguration {
        return new DscNodeConfiguration(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public readonly properties!: pulumi.Output<outputs.automation.v20180115.DscNodeConfigurationPropertiesResponse>;
    /**
...
export interface DscNodeConfigurationArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.automation.v20180115.DscNodeConfigurationCreateOrUpdateParametersProperties>;
    /**
