...
export function getDscNodeConfiguration(args: GetDscNodeConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscNodeConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:automation/v20180115:getDscNodeConfiguration", {
...
export interface GetDscNodeConfigurationResult {
     ...
     */
    readonly configuration?: outputs.automation.v20180115.DscConfigurationAssociationPropertyInvokeResponse;
    /**
