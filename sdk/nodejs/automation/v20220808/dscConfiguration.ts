...
export class DscConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DscConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation/v20151031:DscConfiguration" }, { type: "azure-native:automation/v20190601:DscConfiguration" }, { type: "azure-native:automation/v20230515preview:DscConfiguration" }, { type: "azure-native:automation/v20231101:DscConfiguration" }, { type: "azure-native:automation/v20241023:DscConfiguration" }, { type: "azure-native:automation:DscConfiguration" }] };
