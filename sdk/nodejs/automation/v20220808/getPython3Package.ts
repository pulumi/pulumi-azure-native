...
export interface GetPython3PackageResult {
     ...
     */
    readonly contentLink?: outputs.automation.v20220808.ContentLinkResponse;
    /**
     ...
     */
    readonly error?: outputs.automation.v20220808.ModuleErrorInfoResponse;
    /**
...
export function getPython3PackageOutput(args: GetPython3PackageOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPython3PackageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:automation/v20220808:getPython3Package", {
        "automationAccountName": args.automationAccountName,
        "packageName": args.packageName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
