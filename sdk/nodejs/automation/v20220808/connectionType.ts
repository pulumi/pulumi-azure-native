...
export class ConnectionType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20220808:ConnectionType';
     ...
     */
    public readonly fieldDefinitions!: pulumi.Output<{[key: string]: outputs.automation.v20220808.FieldDefinitionResponse}>;
    /**
    ...
    constructor(name: string, args: ConnectionTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:ConnectionType" }, { type: "azure-native:automation/v20151031:ConnectionType" }, { type: "azure-native:automation/v20190601:ConnectionType" }, { type: "azure-native:automation/v20200113preview:ConnectionType" }, { type: "azure-native:automation/v20230515preview:ConnectionType" }, { type: "azure-native:automation/v20231101:ConnectionType" }] };
...
export interface ConnectionTypeArgs {
     ...
     */
    fieldDefinitions: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.v20220808.FieldDefinitionArgs>}>;
    /**
     * Gets or sets a Boolean value to indicate if the connection type is global.
     */
