...
export interface GetJobScheduleResult {
     ...
     */
    readonly runbook?: outputs.automation.v20220808.RunbookAssociationPropertyResponse;
    /**
     * Gets or sets the schedule.
     */
    readonly schedule?: outputs.automation.v20220808.ScheduleAssociationPropertyResponse;
    /**
     * Resource type
     */
...
export function getJobScheduleOutput(args: GetJobScheduleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJobScheduleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:automation/v20220808:getJobSchedule", {
        "automationAccountName": args.automationAccountName,
        "jobScheduleId": args.jobScheduleId,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
