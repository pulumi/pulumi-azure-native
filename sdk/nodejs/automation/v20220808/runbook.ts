...
export class Runbook extends pulumi.CustomResource {
     ...
     */
    public readonly draft!: pulumi.Output<outputs.automation.v20220808.RunbookDraftResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly parameters!: pulumi.Output<{[key: string]: outputs.automation.v20220808.RunbookParameterResponse} | undefined>;
    /**
     ...
     */
    public readonly publishContentLink!: pulumi.Output<outputs.automation.v20220808.ContentLinkResponse | undefined>;
    /**
    ...
    constructor(name: string, args: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation/v20151031:Runbook" }, { type: "azure-native:automation/v20180630:Runbook" }, { type: "azure-native:automation/v20190601:Runbook" }, { type: "azure-native:automation/v20230515preview:Runbook" }, { type: "azure-native:automation/v20231101:Runbook" }, { type: "azure-native:automation/v20241023:Runbook" }, { type: "azure-native:automation:Runbook" }] };
...
export interface RunbookArgs {
     ...
     * Gets or sets the draft runbook properties.
     */
    draft?: pulumi.Input<inputs.automation.v20220808.RunbookDraftArgs>;
    /**
     ...
     * Gets or sets the published runbook content link.
     */
    publishContentLink?: pulumi.Input<inputs.automation.v20220808.ContentLinkArgs>;
    /**
     ...
     * Gets or sets the type of the runbook.
     */
    runbookType: pulumi.Input<string | enums.automation.v20220808.RunbookTypeEnum>;
    /**
