...
export interface GetRunbookResult {
     ...
     */
    readonly draft?: outputs.automation.v20220808.RunbookDraftResponse;
    /**
     ...
     */
    readonly parameters?: {[key: string]: outputs.automation.v20220808.RunbookParameterResponse};
    /**
     ...
     */
    readonly publishContentLink?: outputs.automation.v20220808.ContentLinkResponse;
    /**
...
export function getRunbookOutput(args: GetRunbookOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRunbookResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:automation/v20220808:getRunbook", {
        "automationAccountName": args.automationAccountName,
        "resourceGroupName": args.resourceGroupName,
        "runbookName": args.runbookName,
    }, opts);
