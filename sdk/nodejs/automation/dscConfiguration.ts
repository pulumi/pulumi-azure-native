...
export class DscConfiguration extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly parameters!: pulumi.Output<{[key: string]: outputs.automation.DscConfigurationParameterResponse} | undefined>;
    /**
     ...
     */
    public /*out*/ readonly source!: pulumi.Output<outputs.automation.ContentSourceResponse | undefined>;
    /**
...
export interface DscConfigurationArgs {
     ...
     */
    properties: pulumi.Input<inputs.automation.DscConfigurationCreateOrUpdatePropertiesArgs>;
    /**
