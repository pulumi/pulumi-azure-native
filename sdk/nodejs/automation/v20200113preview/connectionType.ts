...
export class ConnectionType extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly fieldDefinitions!: pulumi.Output<{[key: string]: outputs.automation.v20200113preview.FieldDefinitionResponse}>;
    /**
...
export interface ConnectionTypeArgs {
     ...
     */
    properties: pulumi.Input<inputs.automation.v20200113preview.ConnectionTypeCreateOrUpdatePropertiesArgs>;
    /**
