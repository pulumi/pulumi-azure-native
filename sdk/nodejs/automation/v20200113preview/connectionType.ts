...
export class ConnectionType extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectionType {
        pulumi.log.warn("ConnectionType is deprecated: azure-native:automation/v20200113preview:ConnectionType is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:ConnectionType to guarantee forwards compatibility.")
        return new ConnectionType(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20200113preview:ConnectionType';
     ...
     */
    public readonly fieldDefinitions!: pulumi.Output<{[key: string]: outputs.automation.v20200113preview.FieldDefinitionResponse}>;
    /**
    ...
    constructor(name: string, args: ConnectionTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:ConnectionType" }, { type: "azure-native:automation/v20151031:ConnectionType" }, { type: "azure-native:automation/v20190601:ConnectionType" }, { type: "azure-native:automation/v20220808:ConnectionType" }] };
...
export interface ConnectionTypeArgs {
     ...
     */
    fieldDefinitions: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.v20200113preview.FieldDefinitionArgs>}>;
    /**
     * Gets or sets a Boolean value to indicate if the connection type is global.
     */
