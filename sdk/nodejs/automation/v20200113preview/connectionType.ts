...
export class ConnectionType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:automation/v20200113preview:ConnectionType';
    ...
    constructor(name: string, args: ConnectionTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation:ConnectionType" }, { type: "azure-nextgen:automation/latest:ConnectionType" }, { type: "azure-nextgen:automation/v20151031:ConnectionType" }, { type: "azure-nextgen:automation/v20190601:ConnectionType" }] };
