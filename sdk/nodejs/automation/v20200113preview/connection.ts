...
export class Connection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Connection {
        pulumi.log.warn("Connection is deprecated: azure-native:automation/v20200113preview:Connection is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Connection to guarantee forwards compatibility.")
        return new Connection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20200113preview:Connection';
    ...
    constructor(name: string, args: ConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Connection" }, { type: "azure-native:automation/v20151031:Connection" }, { type: "azure-native:automation/v20190601:Connection" }, { type: "azure-native:automation/v20220808:Connection" }] };
