...
export function getDscNodeConfiguration(args: GetDscNodeConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscNodeConfigurationResult> {
    pulumi.log.warn("getDscNodeConfiguration is deprecated: azure-native:automation/v20200113preview:DscNodeConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:DscNodeConfiguration to guarantee forwards compatibility.")
