...
export class Module extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Module {
        pulumi.log.warn("Module is deprecated: azure-native:automation/v20200113preview:Module is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Module to guarantee forwards compatibility.")
