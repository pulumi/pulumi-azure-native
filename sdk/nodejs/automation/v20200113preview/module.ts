...
export class Module extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Module {
        pulumi.log.warn("Module is deprecated: azure-native:automation/v20200113preview:Module is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Module to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: ModuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Module" }, { type: "azure-native:automation/v20151031:Module" }, { type: "azure-native:automation/v20190601:Module" }, { type: "azure-native:automation/v20220808:Module" }] };
