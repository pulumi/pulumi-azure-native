...
export class Module extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20200113preview:Module';
     ...
     */
    public /*out*/ readonly error!: pulumi.Output<outputs.automation.v20200113preview.ModuleErrorInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ModuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Module" }, { type: "azure-nextgen:automation:Module" }, { type: "azure-native:automation/latest:Module" }, { type: "azure-nextgen:automation/latest:Module" }, { type: "azure-native:automation/v20151031:Module" }, { type: "azure-nextgen:automation/v20151031:Module" }, { type: "azure-native:automation/v20190601:Module" }, { type: "azure-nextgen:automation/v20190601:Module" }] };
...
export interface ModuleArgs {
     ...
     */
    readonly contentLink: pulumi.Input<inputs.automation.v20200113preview.ContentLink>;
    /**
