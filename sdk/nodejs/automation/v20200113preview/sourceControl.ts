 ...
 *
 * @deprecated azure-native:automation/v20200113preview:SourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:SourceControl to guarantee forwards compatibility.
 */
export class SourceControl extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SourceControl {
        pulumi.log.warn("SourceControl is deprecated: azure-native:automation/v20200113preview:SourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:SourceControl to guarantee forwards compatibility.")
        return new SourceControl(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20200113preview:SourceControl';
    ...
    constructor(name: string, args: SourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:SourceControl" }, { type: "azure-native:automation/v20170515preview:SourceControl" }, { type: "azure-native:automation/v20190601:SourceControl" }, { type: "azure-native:automation/v20220808:SourceControl" }] };
...
export interface SourceControlArgs {
     ...
     */
    securityToken?: pulumi.Input<inputs.automation.v20200113preview.SourceControlSecurityTokenPropertiesArgs>;
    /**
     ...
     */
    sourceType?: pulumi.Input<string | enums.automation.v20200113preview.SourceType>;
}
