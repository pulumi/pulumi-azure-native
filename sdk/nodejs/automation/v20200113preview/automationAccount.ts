...
export class AutomationAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AutomationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:AutomationAccount" }, { type: "azure-nextgen:automation/v20151031:AutomationAccount" }, { type: "azure-nextgen:automation/v20190601:AutomationAccount" }] };
