...
export class JobSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20200113preview:JobSchedule';
     ...
     */
    public readonly runbook!: pulumi.Output<outputs.automation.v20200113preview.RunbookAssociationPropertyResponse | undefined>;
    /**
     * Gets or sets the schedule.
     */
    public readonly schedule!: pulumi.Output<outputs.automation.v20200113preview.ScheduleAssociationPropertyResponse | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: JobScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:JobSchedule" }, { type: "azure-nextgen:automation:JobSchedule" }, { type: "azure-native:automation/latest:JobSchedule" }, { type: "azure-nextgen:automation/latest:JobSchedule" }, { type: "azure-native:automation/v20151031:JobSchedule" }, { type: "azure-nextgen:automation/v20151031:JobSchedule" }, { type: "azure-native:automation/v20190601:JobSchedule" }, { type: "azure-nextgen:automation/v20190601:JobSchedule" }] };
...
export interface JobScheduleArgs {
     ...
     * Gets or sets the runbook.
     */
    readonly runbook: pulumi.Input<inputs.automation.v20200113preview.RunbookAssociationProperty>;
    /**
     * Gets or sets the schedule.
     */
    readonly schedule: pulumi.Input<inputs.automation.v20200113preview.ScheduleAssociationProperty>;
}
