...
export class AutomationAccountSchedule extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutomationAccountScheduleState, opts?: pulumi.CustomResourceOptions): AutomationAccountSchedule {
        return new AutomationAccountSchedule(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: AutomationAccountScheduleArgs | AutomationAccountScheduleState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as AutomationAccountScheduleState | undefined;
 ...
 * Definition of the schedule.
 */
export interface AutomationAccountScheduleState {
    /**
     * The name of the resource
     */
     ...
     * Gets or sets the properties of the schedule.
     */
    readonly properties: pulumi.Input<inputs.automation.SchedulePropertiesResponse>;
    /**
     * The type of the resource.
     */
