...
export class JobSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation:JobSchedule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.automation.JobSchedulePropertiesResponse>;
    /**
     * Resource type
     */
...
export interface JobScheduleArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.automation.JobScheduleCreateProperties>;
    /**
