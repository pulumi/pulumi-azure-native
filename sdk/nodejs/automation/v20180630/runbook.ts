 ...
 *
 * @deprecated azure-native:automation/v20180630:Runbook is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Runbook to guarantee forwards compatibility.
 */
export class Runbook extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Runbook {
        pulumi.log.warn("Runbook is deprecated: azure-native:automation/v20180630:Runbook is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Runbook to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Runbook" }, { type: "azure-native:automation/v20151031:Runbook" }, { type: "azure-native:automation/v20190601:Runbook" }, { type: "azure-native:automation/v20220808:Runbook" }] };
...
export interface RunbookArgs {
     ...
     * Gets or sets the draft runbook properties.
     */
    draft?: pulumi.Input<inputs.automation.v20180630.RunbookDraftArgs>;
    /**
     ...
     * Gets or sets the published runbook content link.
     */
    publishContentLink?: pulumi.Input<inputs.automation.v20180630.ContentLinkArgs>;
    /**
     ...
     * Gets or sets the type of the runbook.
     */
    runbookType: pulumi.Input<string | enums.automation.v20180630.RunbookTypeEnum>;
    /**
