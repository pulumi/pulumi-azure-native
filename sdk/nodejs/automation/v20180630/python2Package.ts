...
export class Python2Package extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:automation/v20180630:Python2Package';
    ...
    constructor(name: string, args: Python2PackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation:Python2Package" }, { type: "azure-nextgen:automation/latest:Python2Package" }, { type: "azure-nextgen:automation/v20190601:Python2Package" }, { type: "azure-nextgen:automation/v20200113preview:Python2Package" }] };
