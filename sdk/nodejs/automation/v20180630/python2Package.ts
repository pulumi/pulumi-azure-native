...
export class Python2Package extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly contentLink!: pulumi.Output<outputs.automation.v20180630.ContentLinkResponse | undefined>;
    /**
    ...
    constructor(name: string, args: Python2PackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Python2Package" }, { type: "azure-native:automation/v20190601:Python2Package" }, { type: "azure-native:automation/v20200113preview:Python2Package" }, { type: "azure-native:automation/v20220808:Python2Package" }] };
...
export interface Python2PackageArgs {
     ...
     */
    properties: pulumi.Input<inputs.automation.v20180630.PythonPackageCreatePropertiesArgs>;
    /**
