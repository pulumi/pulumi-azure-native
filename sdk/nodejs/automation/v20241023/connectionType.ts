...
export class ConnectionType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20241023:ConnectionType';
     ...
     */
    public readonly fieldDefinitions!: pulumi.Output<{[key: string]: outputs.automation.v20241023.FieldDefinitionResponse}>;
    /**
...
export interface ConnectionTypeArgs {
     ...
     */
    fieldDefinitions: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.v20241023.FieldDefinitionArgs>}>;
    /**
     * Gets or sets a Boolean value to indicate if the connection type is global.
     */
