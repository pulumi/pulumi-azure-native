...
export function getAutomationAccount(args: GetAutomationAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetAutomationAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-native:automation/v20241023:getAutomationAccount", {
...
export interface GetAutomationAccountResult {
     ...
     */
    readonly encryption?: outputs.automation.v20241023.EncryptionPropertiesResponse;
    /**
     ...
     */
    readonly identity?: outputs.automation.v20241023.IdentityResponse;
    /**
     ...
     */
    readonly privateEndpointConnections?: outputs.automation.v20241023.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly sku?: outputs.automation.v20241023.SkuResponse;
    /**
...
export function getAutomationAccountOutput(args: GetAutomationAccountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutomationAccountResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:automation/v20241023:getAutomationAccount", {
        "automationAccountName": args.automationAccountName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
