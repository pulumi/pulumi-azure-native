...
export class SoftwareUpdateConfigurationByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20241023:SoftwareUpdateConfigurationByName';
     ...
     */
    public readonly error!: pulumi.Output<outputs.automation.v20241023.ErrorResponseResponse | undefined>;
    /**
     ...
     */
    public readonly scheduleInfo!: pulumi.Output<outputs.automation.v20241023.SUCSchedulePropertiesResponse>;
    /**
     * Tasks information for the Software update configuration.
     */
    public readonly tasks!: pulumi.Output<outputs.automation.v20241023.SoftwareUpdateConfigurationTasksResponse | undefined>;
    /**
     * Resource type
     */
     ...
     */
    public readonly updateConfiguration!: pulumi.Output<outputs.automation.v20241023.UpdateConfigurationResponse>;
    ...
    constructor(name: string, args: SoftwareUpdateConfigurationByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["scheduleInfo"] = args ? (args.scheduleInfo ? pulumi.output(args.scheduleInfo).apply(inputs.automation.v20241023.sucschedulePropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:SoftwareUpdateConfigurationByName" }, { type: "azure-native:automation/v20170515preview:SoftwareUpdateConfigurationByName" }, { type: "azure-native:automation/v20190601:SoftwareUpdateConfigurationByName" }, { type: "azure-native:automation/v20230515preview:SoftwareUpdateConfigurationByName" }] };
...
export interface SoftwareUpdateConfigurationByNameArgs {
     ...
     * Details of provisioning error
     */
    error?: pulumi.Input<inputs.automation.v20241023.ErrorResponseArgs>;
    /**
     ...
     * Schedule information for the Software update configuration
     */
    scheduleInfo: pulumi.Input<inputs.automation.v20241023.SUCSchedulePropertiesArgs>;
    /**
     ...
     * Tasks information for the Software update configuration.
     */
    tasks?: pulumi.Input<inputs.automation.v20241023.SoftwareUpdateConfigurationTasksArgs>;
    /**
     * update specific properties for the Software update configuration
     */
    updateConfiguration: pulumi.Input<inputs.automation.v20241023.UpdateConfigurationArgs>;
}
