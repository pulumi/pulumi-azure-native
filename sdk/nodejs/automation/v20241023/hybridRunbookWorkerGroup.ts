...
export class HybridRunbookWorkerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20241023:HybridRunbookWorkerGroup';
     ...
     */
    public readonly credential!: pulumi.Output<outputs.automation.v20241023.RunAsCredentialAssociationPropertyResponse | undefined>;
    /**
...
export interface HybridRunbookWorkerGroupArgs {
     ...
     * Sets the credential of a worker group.
     */
    credential?: pulumi.Input<inputs.automation.v20241023.RunAsCredentialAssociationPropertyArgs>;
    /**
