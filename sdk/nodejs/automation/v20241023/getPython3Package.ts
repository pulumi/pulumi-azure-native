...
export function getPython3Package(args: GetPython3PackageArgs, opts?: pulumi.InvokeOptions): Promise<GetPython3PackageResult> {
    ...
    return pulumi.runtime.invoke("azure-native:automation/v20241023:getPython3Package", {
...
export interface GetPython3PackageResult {
     ...
     */
    readonly contentLink?: outputs.automation.v20241023.ContentLinkResponse;
    /**
     ...
     */
    readonly error?: outputs.automation.v20241023.ModuleErrorInfoResponse;
    /**
...
export function getPython3PackageOutput(args: GetPython3PackageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPython3PackageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:automation/v20241023:getPython3Package", {
        "automationAccountName": args.automationAccountName,
        "packageName": args.packageName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
