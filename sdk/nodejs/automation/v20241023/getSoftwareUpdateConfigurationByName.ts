...
export function getSoftwareUpdateConfigurationByName(args: GetSoftwareUpdateConfigurationByNameArgs, opts?: pulumi.InvokeOptions): Promise<GetSoftwareUpdateConfigurationByNameResult> {
    ...
    return pulumi.runtime.invoke("azure-native:automation/v20241023:getSoftwareUpdateConfigurationByName", {
...
export interface GetSoftwareUpdateConfigurationByNameResult {
     ...
     */
    readonly error?: outputs.automation.v20241023.ErrorResponseResponse;
    /**
     * Resource Id.
     */
    readonly id: string;
     ...
     */
    readonly scheduleInfo: outputs.automation.v20241023.SUCSchedulePropertiesResponse;
    /**
     * Tasks information for the Software update configuration.
     */
    readonly tasks?: outputs.automation.v20241023.SoftwareUpdateConfigurationTasksResponse;
    /**
     * Resource type
     */
     ...
     */
    readonly updateConfiguration: outputs.automation.v20241023.UpdateConfigurationResponse;
}
/**
 * Get a single software update configuration by name.
 */
export function getSoftwareUpdateConfigurationByNameOutput(args: GetSoftwareUpdateConfigurationByNameOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSoftwareUpdateConfigurationByNameResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:automation/v20241023:getSoftwareUpdateConfigurationByName", {
        "automationAccountName": args.automationAccountName,
        "resourceGroupName": args.resourceGroupName,
        "softwareUpdateConfigurationName": args.softwareUpdateConfigurationName,
    }, opts);
