...
export function getConnectionType(args: GetConnectionTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionTypeResult> {
    ...
    return pulumi.runtime.invoke("azurerm:automation/preview:getConnectionType", {
...
export interface GetConnectionTypeResult {
     ...
     */
    readonly fieldDefinitions: {[key: string]: outputs.automation.preview.FieldDefinitionResponse};
    /**
