...
export class Runbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:Runbook';
     ...
     */
    public readonly draft!: pulumi.Output<outputs.automation.preview.RunbookDraftResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly parameters!: pulumi.Output<{[key: string]: outputs.automation.preview.RunbookParameterResponse} | undefined>;
    /**
     ...
     */
    public readonly publishContentLink!: pulumi.Output<outputs.automation.preview.ContentLinkResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:Runbook" }, { type: "azurerm:automation/v20151031:Runbook" }, { type: "azurerm:automation/v20180630:Runbook" }] };
...
export interface RunbookArgs {
     ...
     * Gets or sets the draft runbook properties.
     */
    readonly draft?: pulumi.Input<inputs.automation.preview.RunbookDraft>;
    /**
     ...
     * Gets or sets the published runbook content link.
     */
    readonly publishContentLink?: pulumi.Input<inputs.automation.preview.ContentLink>;
    /**
