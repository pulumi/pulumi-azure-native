...
export function getDscConfiguration(args: GetDscConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azurerm:automation/preview:getDscConfiguration", {
...
export interface GetDscConfigurationResult {
     ...
     */
    readonly parameters?: {[key: string]: outputs.automation.preview.DscConfigurationParameterResponse};
    /**
     ...
     */
    readonly source?: outputs.automation.preview.ContentSourceResponse;
    /**
