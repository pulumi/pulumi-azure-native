...
export class DscConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:DscConfiguration';
     ...
     */
    public readonly parameters!: pulumi.Output<{[key: string]: outputs.automation.preview.DscConfigurationParameterResponse} | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.automation.preview.ContentSourceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DscConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:DscConfiguration" }, { type: "azurerm:automation/v20151031:DscConfiguration" }] };
...
export interface DscConfigurationArgs {
     ...
     * Gets or sets the configuration parameters.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.preview.DscConfigurationParameter>}>;
    /**
