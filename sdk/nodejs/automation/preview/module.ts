...
export class Module extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:Module';
     ...
     */
    public readonly contentLink!: pulumi.Output<outputs.automation.preview.ContentLinkResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly error!: pulumi.Output<outputs.automation.preview.ModuleErrorInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ModuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:Module" }, { type: "azurerm:automation/v20151031:Module" }] };
...
export interface ModuleArgs {
     ...
     */
    readonly contentLink: pulumi.Input<inputs.automation.preview.ContentLink>;
    /**
