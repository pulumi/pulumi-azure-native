...
export class DscNodeConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:DscNodeConfiguration';
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.automation.preview.DscConfigurationAssociationPropertyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DscNodeConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:DscNodeConfiguration" }, { type: "azurerm:automation/v20151031:DscNodeConfiguration" }, { type: "azurerm:automation/v20180115:DscNodeConfiguration" }] };
...
export interface DscNodeConfigurationArgs {
     ...
     * Gets or sets the configuration of the node.
     */
    readonly configuration: pulumi.Input<inputs.automation.preview.DscConfigurationAssociationProperty>;
    /**
     * If a new build version of NodeConfiguration is required.
     */
     ...
     */
    readonly source: pulumi.Input<inputs.automation.preview.ContentSource>;
    /**
