...
export class AutomationAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:AutomationAccount';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.automation.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AutomationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:AutomationAccount" }, { type: "azurerm:automation/v20151031:AutomationAccount" }] };
...
export interface AutomationAccountArgs {
     ...
     */
    readonly sku?: pulumi.Input<inputs.automation.preview.Sku>;
    /**
