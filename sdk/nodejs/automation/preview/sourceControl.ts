...
export class SourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:SourceControl';
    ...
    constructor(name: string, argsOrState?: SourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/v20170515preview:SourceControl" }] };
...
export interface SourceControlArgs {
     ...
     */
    readonly securityToken?: pulumi.Input<inputs.automation.preview.SourceControlSecurityTokenProperties>;
    /**
