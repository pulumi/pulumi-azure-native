...
export function getJobSchedule(args: GetJobScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetJobScheduleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:automation/preview:getJobSchedule", {
...
export interface GetJobScheduleResult {
     ...
     */
    readonly runbook?: outputs.automation.preview.RunbookAssociationPropertyResponse;
    /**
     * Gets or sets the schedule.
     */
    readonly schedule?: outputs.automation.preview.ScheduleAssociationPropertyResponse;
    /**
     * Resource type
     */
