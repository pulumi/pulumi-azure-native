...
export class JobSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:JobSchedule';
     ...
     */
    public readonly runbook!: pulumi.Output<outputs.automation.preview.RunbookAssociationPropertyResponse | undefined>;
    /**
     * Gets or sets the schedule.
     */
    public readonly schedule!: pulumi.Output<outputs.automation.preview.ScheduleAssociationPropertyResponse | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, argsOrState?: JobScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:JobSchedule" }, { type: "azurerm:automation/v20151031:JobSchedule" }] };
...
export interface JobScheduleArgs {
     ...
     * Gets or sets the runbook.
     */
    readonly runbook: pulumi.Input<inputs.automation.preview.RunbookAssociationProperty>;
    /**
     * Gets or sets the schedule.
     */
    readonly schedule: pulumi.Input<inputs.automation.preview.ScheduleAssociationProperty>;
}
