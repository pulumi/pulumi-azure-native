...
export class SoftwareUpdateConfigurationByName extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SoftwareUpdateConfigurationByName {
        return new SoftwareUpdateConfigurationByName(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:SoftwareUpdateConfigurationByName';
     ...
     */
    public readonly error!: pulumi.Output<outputs.automation.preview.ErrorResponseResponse | undefined>;
    /**
     ...
     */
    public readonly scheduleInfo!: pulumi.Output<outputs.automation.preview.SchedulePropertiesResponse>;
    /**
     * Tasks information for the Software update configuration.
     */
    public readonly tasks!: pulumi.Output<outputs.automation.preview.SoftwareUpdateConfigurationTasksResponse | undefined>;
    /**
     * Resource type
     */
     ...
     */
    public readonly updateConfiguration!: pulumi.Output<outputs.automation.preview.UpdateConfigurationResponse>;
    ...
    constructor(name: string, argsOrState?: SoftwareUpdateConfigurationByNameArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SoftwareUpdateConfigurationByNameArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/v20170515preview:SoftwareUpdateConfigurationByName" }] };
...
export interface SoftwareUpdateConfigurationByNameArgs {
     ...
     * Details of provisioning error
     */
    readonly error?: pulumi.Input<inputs.automation.preview.ErrorResponse>;
    /**
     ...
     * Schedule information for the Software update configuration
     */
    readonly scheduleInfo: pulumi.Input<inputs.automation.preview.ScheduleProperties>;
    /**
     ...
     * Tasks information for the Software update configuration.
     */
    readonly tasks?: pulumi.Input<inputs.automation.preview.SoftwareUpdateConfigurationTasks>;
    /**
     * update specific properties for the Software update configuration
     */
    readonly updateConfiguration: pulumi.Input<inputs.automation.preview.UpdateConfiguration>;
}
