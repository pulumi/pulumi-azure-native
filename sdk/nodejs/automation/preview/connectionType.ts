...
export class ConnectionType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:ConnectionType';
     ...
     */
    public readonly fieldDefinitions!: pulumi.Output<{[key: string]: outputs.automation.preview.FieldDefinitionResponse}>;
    /**
    ...
    constructor(name: string, args: ConnectionTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:ConnectionType" }, { type: "azurerm:automation/v20151031:ConnectionType" }] };
...
export interface ConnectionTypeArgs {
     ...
     */
    readonly fieldDefinitions: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.preview.FieldDefinition>}>;
    /**
     * Gets or sets a Boolean value to indicate if the connection type is global.
     */
