...
export class Variable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:Variable';
    ...
    constructor(name: string, argsOrState?: VariableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:Variable" }, { type: "azurerm:automation/v20151031:Variable" }] };
