...
export class Connection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:Connection';
     ...
     */
    public readonly connectionType!: pulumi.Output<outputs.automation.preview.ConnectionTypeAssociationPropertyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:Connection" }, { type: "azurerm:automation/v20151031:Connection" }] };
...
export interface ConnectionArgs {
     ...
     * Gets or sets the connectionType of the connection.
     */
    readonly connectionType: pulumi.Input<inputs.automation.preview.ConnectionTypeAssociationProperty>;
    /**
