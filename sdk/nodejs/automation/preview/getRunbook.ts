...
export function getRunbook(args: GetRunbookArgs, opts?: pulumi.InvokeOptions): Promise<GetRunbookResult> {
    ...
    return pulumi.runtime.invoke("azurerm:automation/preview:getRunbook", {
...
export interface GetRunbookResult {
     ...
     */
    readonly draft?: outputs.automation.preview.RunbookDraftResponse;
    /**
     ...
     */
    readonly parameters?: {[key: string]: outputs.automation.preview.RunbookParameterResponse};
    /**
     ...
     */
    readonly publishContentLink?: outputs.automation.preview.ContentLinkResponse;
    /**
