...
export class Watcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/preview:Watcher';
    ...
    constructor(name: string, argsOrState?: WatcherArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:Watcher" }, { type: "azurerm:automation/v20151031:Watcher" }] };
