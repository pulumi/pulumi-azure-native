...
export class Runbook extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly draft!: pulumi.Output<outputs.automation.RunbookDraftResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly publishContentLink!: pulumi.Output<outputs.automation.ContentLinkResponse | undefined>;
    /**
...
export interface RunbookArgs {
     ...
     */
    properties: pulumi.Input<inputs.automation.RunbookCreateOrUpdatePropertiesArgs>;
    /**
