...
export class Runbook extends pulumi.CustomResource {
     ...
     */
    declare public readonly publishContentLink: pulumi.Output<outputs.automation.ContentLinkResponse | undefined>;
    /**
     ...
     */
    declare public readonly runtimeEnvironment: pulumi.Output<string | undefined>;
    /**
