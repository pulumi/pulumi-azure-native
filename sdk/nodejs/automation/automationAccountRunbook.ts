...
export class AutomationAccountRunbook extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutomationAccountRunbookState, opts?: pulumi.CustomResourceOptions): AutomationAccountRunbook {
        return new AutomationAccountRunbook(name, <any>state, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: AutomationAccountRunbookArgs | AutomationAccountRunbookState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as AutomationAccountRunbookState | undefined;
 ...
 * Definition of the runbook type.
 */
export interface AutomationAccountRunbookState {
    /**
     * Gets or sets the etag of the resource.
     */
     ...
     * Gets or sets the runbook properties.
     */
    readonly properties: pulumi.Input<inputs.automation.RunbookPropertiesResponse>;
    /**
     * Resource tags.
     */
