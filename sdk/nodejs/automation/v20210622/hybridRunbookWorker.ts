 ...
 *
 * const hybridRunbookWorker = new azure_native.automation.v20210622.HybridRunbookWorker("hybridRunbookWorker", {
...
export class HybridRunbookWorker extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20210622:HybridRunbookWorker';
    ...
    constructor(name: string, args: HybridRunbookWorkerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:HybridRunbookWorker" }, { type: "azure-native:automation/v20220808:HybridRunbookWorker" }] };
