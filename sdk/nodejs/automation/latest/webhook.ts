...
export class Webhook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/latest:Webhook';
    ...
    constructor(name: string, argsOrState?: WebhookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/preview:Webhook" }, { type: "azurerm:automation/v20151031:Webhook" }] };
