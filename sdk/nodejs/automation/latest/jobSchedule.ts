...
export class JobSchedule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobSchedule {
        pulumi.log.warn("JobSchedule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:automation:JobSchedule'.")
    ...
    constructor(name: string, args: JobScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation:JobSchedule" }, { type: "azure-nextgen:automation/v20151031:JobSchedule" }, { type: "azure-nextgen:automation/v20190601:JobSchedule" }, { type: "azure-nextgen:automation/v20200113preview:JobSchedule" }] };
