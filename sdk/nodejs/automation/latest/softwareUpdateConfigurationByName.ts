...
export class SoftwareUpdateConfigurationByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/latest:SoftwareUpdateConfigurationByName';
     ...
     */
    public readonly error!: pulumi.Output<outputs.automation.latest.ErrorResponseResponse | undefined>;
    /**
     ...
     */
    public readonly scheduleInfo!: pulumi.Output<outputs.automation.latest.SUCSchedulePropertiesResponse>;
    /**
     * Tasks information for the Software update configuration.
     */
    public readonly tasks!: pulumi.Output<outputs.automation.latest.SoftwareUpdateConfigurationTasksResponse | undefined>;
    /**
     * Resource type
     */
     ...
     */
    public readonly updateConfiguration!: pulumi.Output<outputs.automation.latest.UpdateConfigurationResponse>;
    ...
    constructor(name: string, args: SoftwareUpdateConfigurationByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:SoftwareUpdateConfigurationByName" }, { type: "azure-native:automation:SoftwareUpdateConfigurationByName" }, { type: "azure-nextgen:automation:SoftwareUpdateConfigurationByName" }, { type: "azure-native:automation/v20170515preview:SoftwareUpdateConfigurationByName" }, { type: "azure-nextgen:automation/v20170515preview:SoftwareUpdateConfigurationByName" }, { type: "azure-native:automation/v20190601:SoftwareUpdateConfigurationByName" }, { type: "azure-nextgen:automation/v20190601:SoftwareUpdateConfigurationByName" }] };
...
export interface SoftwareUpdateConfigurationByNameArgs {
     ...
     * Details of provisioning error
     */
    readonly error?: pulumi.Input<inputs.automation.latest.ErrorResponse>;
    /**
     ...
     * Schedule information for the Software update configuration
     */
    readonly scheduleInfo: pulumi.Input<inputs.automation.latest.SUCScheduleProperties>;
    /**
     ...
     * Tasks information for the Software update configuration.
     */
    readonly tasks?: pulumi.Input<inputs.automation.latest.SoftwareUpdateConfigurationTasks>;
    /**
     * update specific properties for the Software update configuration
     */
    readonly updateConfiguration: pulumi.Input<inputs.automation.latest.UpdateConfiguration>;
}
