...
export class AutomationAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/latest:AutomationAccount';
    ...
    constructor(name: string, args: AutomationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/preview:AutomationAccount" }, { type: "azurerm:automation/v20151031:AutomationAccount" }] };
