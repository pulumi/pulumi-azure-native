...
export class Python2Package extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/latest:Python2Package';
    ...
    constructor(name: string, args: Python2PackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/preview:Python2Package" }, { type: "azurerm:automation/v20180630:Python2Package" }] };
