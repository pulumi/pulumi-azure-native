...
export class Schedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/latest:Schedule';
    ...
    constructor(name: string, args: ScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:Schedule" }, { type: "azure-native:automation:Schedule" }, { type: "azure-nextgen:automation:Schedule" }, { type: "azure-native:automation/v20151031:Schedule" }, { type: "azure-nextgen:automation/v20151031:Schedule" }, { type: "azure-native:automation/v20190601:Schedule" }, { type: "azure-nextgen:automation/v20190601:Schedule" }, { type: "azure-native:automation/v20200113preview:Schedule" }, { type: "azure-nextgen:automation/v20200113preview:Schedule" }] };
...
export interface ScheduleArgs {
     ...
     * Gets or sets the frequency of the schedule.
     */
    readonly frequency: pulumi.Input<string | enums.automation.latest.ScheduleFrequency>;
    /**
     * Gets or sets the interval of the schedule.
     */
