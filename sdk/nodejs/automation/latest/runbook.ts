...
export class Runbook extends pulumi.CustomResource {
     ...
     */
    public readonly draft!: pulumi.Output<outputs.automation.latest.RunbookDraftResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly parameters!: pulumi.Output<{[key: string]: outputs.automation.latest.RunbookParameterResponse} | undefined>;
    /**
     ...
     */
    public readonly publishContentLink!: pulumi.Output<outputs.automation.latest.ContentLinkResponse | undefined>;
    /**
    ...
    constructor(name: string, args: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:Runbook" }, { type: "azure-native:automation:Runbook" }, { type: "azure-nextgen:automation:Runbook" }, { type: "azure-native:automation/v20151031:Runbook" }, { type: "azure-nextgen:automation/v20151031:Runbook" }, { type: "azure-native:automation/v20180630:Runbook" }, { type: "azure-nextgen:automation/v20180630:Runbook" }, { type: "azure-native:automation/v20190601:Runbook" }, { type: "azure-nextgen:automation/v20190601:Runbook" }] };
...
export interface RunbookArgs {
     ...
     * Gets or sets the draft runbook properties.
     */
    readonly draft?: pulumi.Input<inputs.automation.latest.RunbookDraft>;
    /**
     ...
     * Gets or sets the published runbook content link.
     */
    readonly publishContentLink?: pulumi.Input<inputs.automation.latest.ContentLink>;
    /**
     ...
     * Gets or sets the type of the runbook.
     */
    readonly runbookType: pulumi.Input<string | enums.automation.latest.RunbookTypeEnum>;
    /**
