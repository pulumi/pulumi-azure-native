...
export class Runbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/latest:Runbook';
    ...
    constructor(name: string, argsOrState?: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/preview:Runbook" }, { type: "azurerm:automation/v20151031:Runbook" }, { type: "azurerm:automation/v20180630:Runbook" }] };
