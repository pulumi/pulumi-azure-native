...
export class Connection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/latest:Connection';
    ...
    constructor(name: string, args: ConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/preview:Connection" }, { type: "azurerm:automation/v20151031:Connection" }] };
