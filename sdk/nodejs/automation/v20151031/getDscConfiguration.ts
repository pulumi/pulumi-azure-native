...
export function getDscConfiguration(args: GetDscConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscConfigurationResult> {
    pulumi.log.warn("getDscConfiguration is deprecated: azure-native:automation/v20151031:DscConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:DscConfiguration to guarantee forwards compatibility.")
