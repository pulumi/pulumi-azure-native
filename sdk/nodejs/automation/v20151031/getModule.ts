...
export function getModule(args: GetModuleArgs, opts?: pulumi.InvokeOptions): Promise<GetModuleResult> {
    pulumi.log.warn("getModule is deprecated: azure-native:automation/v20151031:Module is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Module to guarantee forwards compatibility.")
