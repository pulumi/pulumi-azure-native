...
export class ConnectionType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20151031:ConnectionType';
     ...
     */
    public /*out*/ readonly fieldDefinitions!: pulumi.Output<{[key: string]: outputs.automation.v20151031.FieldDefinitionResponse}>;
    /**
    ...
    constructor(name: string, args: ConnectionTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:ConnectionType" }, { type: "azure-native:automation/v20190601:ConnectionType" }, { type: "azure-native:automation/v20200113preview:ConnectionType" }, { type: "azure-native:automation/v20220808:ConnectionType" }] };
...
export interface ConnectionTypeArgs {
     ...
     */
    properties: pulumi.Input<inputs.automation.v20151031.ConnectionTypeCreateOrUpdatePropertiesArgs>;
    /**
