 ...
 *
 * @deprecated azure-native:automation/v20151031:DscConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:DscConfiguration to guarantee forwards compatibility.
 */
export class DscConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DscConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:DscConfiguration" }, { type: "azure-native:automation/v20190601:DscConfiguration" }, { type: "azure-native:automation/v20220808:DscConfiguration" }] };
...
export interface DscConfigurationArgs {
     ...
     * Gets or sets the configuration parameters.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.v20151031.DscConfigurationParameterArgs>}>;
    /**
