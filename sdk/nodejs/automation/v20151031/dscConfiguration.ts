...
export class DscConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DscConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/v20151031:DscConfiguration" }, { type: "azure-native:automation:DscConfiguration" }, { type: "azure-nextgen:automation:DscConfiguration" }, { type: "azure-native:automation/v20190601:DscConfiguration" }, { type: "azure-nextgen:automation/v20190601:DscConfiguration" }] };
...
export interface DscConfigurationArgs {
     ...
     * Gets or sets the configuration parameters.
     */
    readonly parameters?: pulumi.Input<{[key: string]: pulumi.Input<inputs.automation.v20151031.DscConfigurationParameterArgs>}>;
    /**
