...
export class DscConfiguration extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly parameters!: pulumi.Output<{[key: string]: outputs.automation.v20151031.DscConfigurationParameterResponse} | undefined>;
    /**
     ...
     */
    public /*out*/ readonly source!: pulumi.Output<outputs.automation.v20151031.ContentSourceResponse | undefined>;
    /**
...
export interface DscConfigurationArgs {
     ...
     */
    properties: pulumi.Input<inputs.automation.v20151031.DscConfigurationCreateOrUpdatePropertiesArgs>;
    /**
