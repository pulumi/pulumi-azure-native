...
export class Runbook extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.automation.v20151031.RunbookPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface RunbookArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.automation.v20151031.RunbookCreateOrUpdateProperties>;
    /**
