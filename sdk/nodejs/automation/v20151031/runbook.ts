...
export class Runbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:automation/v20151031:Runbook';
    ...
    constructor(name: string, args: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation:Runbook" }, { type: "azure-nextgen:automation/latest:Runbook" }, { type: "azure-nextgen:automation/v20180630:Runbook" }, { type: "azure-nextgen:automation/v20190601:Runbook" }] };
