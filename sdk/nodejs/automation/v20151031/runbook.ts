...
export class Runbook extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:Runbook" }, { type: "azure-nextgen:automation/v20180630:Runbook" }, { type: "azure-nextgen:automation/v20190601:Runbook" }] };
