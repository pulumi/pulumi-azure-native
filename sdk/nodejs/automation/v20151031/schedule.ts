...
export class Schedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:Schedule" }, { type: "azure-nextgen:automation/v20190601:Schedule" }, { type: "azure-nextgen:automation/v20200113preview:Schedule" }] };
...
export interface ScheduleArgs {
     ...
     * Gets or sets the frequency of the schedule.
     */
    readonly frequency: pulumi.Input<string | enums.automation.v20151031.ScheduleFrequency>;
    /**
     * Gets or sets the interval of the schedule.
     */
