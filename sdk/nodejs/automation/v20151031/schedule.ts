...
export class Schedule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Schedule {
        pulumi.log.warn("Schedule is deprecated: azure-native:automation/v20151031:Schedule is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Schedule to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: ScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Schedule" }, { type: "azure-native:automation/v20190601:Schedule" }, { type: "azure-native:automation/v20200113preview:Schedule" }, { type: "azure-native:automation/v20220808:Schedule" }] };
