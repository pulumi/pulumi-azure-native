 ...
 *
 * const schedule = new azurerm.automation.v20151031.Schedule("schedule", {
 *     advancedSchedule: {},
...
export class Schedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/v20151031:Schedule';
    ...
    constructor(name: string, argsOrState?: ScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:Schedule" }] };
