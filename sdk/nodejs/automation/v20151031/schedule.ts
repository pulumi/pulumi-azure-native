...
export class Schedule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Schedule {
        pulumi.log.warn("Schedule is deprecated: azure-native:automation/v20151031:Schedule is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Schedule to guarantee forwards compatibility.")
