...
export function getConnectionType(args: GetConnectionTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionTypeResult> {
    ...
    return pulumi.runtime.invoke("azurerm:automation/v20151031:getConnectionType", {
...
export interface GetConnectionTypeResult {
     ...
     */
    readonly properties: outputs.automation.v20151031.ConnectionTypePropertiesResponse;
    /**
     * Resource type
     */
