 ...
 */
/** @deprecated azure-native:automation/v20151031:ConnectionType is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:ConnectionType to guarantee forwards compatibility. */
export function getConnectionType(args: GetConnectionTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionTypeResult> {
    pulumi.log.warn("getConnectionType is deprecated: azure-native:automation/v20151031:ConnectionType is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:ConnectionType to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:automation/v20151031:getConnectionType", {
