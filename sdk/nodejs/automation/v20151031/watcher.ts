...
export class Watcher extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WatcherArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation:Watcher" }, { type: "azure-nextgen:automation/latest:Watcher" }, { type: "azure-nextgen:automation/v20190601:Watcher" }, { type: "azure-nextgen:automation/v20200113preview:Watcher" }] };
