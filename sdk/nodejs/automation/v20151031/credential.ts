...
export class Credential extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation:Credential" }, { type: "azure-nextgen:automation/latest:Credential" }, { type: "azure-nextgen:automation/v20190601:Credential" }, { type: "azure-nextgen:automation/v20200113preview:Credential" }] };
