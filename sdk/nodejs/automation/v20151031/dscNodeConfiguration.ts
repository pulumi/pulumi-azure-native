 ...
 *
 * const dscNodeConfiguration = new azurerm.automation.v20151031.DscNodeConfiguration("dscNodeConfiguration", {
...
export class DscNodeConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:automation/v20151031:DscNodeConfiguration';
    ...
    constructor(name: string, args: DscNodeConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:automation/latest:DscNodeConfiguration" }, { type: "azurerm:automation/v20180115:DscNodeConfiguration" }] };
