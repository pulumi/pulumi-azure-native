 ...
 *
 * @deprecated azure-native:automation/v20151031:JobSchedule is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.
 */
export class JobSchedule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobSchedule {
        pulumi.log.warn("JobSchedule is deprecated: azure-native:automation/v20151031:JobSchedule is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.")
...
export interface JobScheduleArgs {
     ...
     * Gets or sets the schedule.
     */
    schedule: pulumi.Input<inputs.automation.v20151031.ScheduleAssociationPropertyArgs>;
}
