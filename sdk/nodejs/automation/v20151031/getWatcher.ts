 ...
 */
/** @deprecated azure-native:automation/v20151031:Watcher is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20200113preview:Watcher to guarantee forwards compatibility. */
export function getWatcher(args: GetWatcherArgs, opts?: pulumi.InvokeOptions): Promise<GetWatcherResult> {
    pulumi.log.warn("getWatcher is deprecated: azure-native:automation/v20151031:Watcher is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20200113preview:Watcher to guarantee forwards compatibility.")
