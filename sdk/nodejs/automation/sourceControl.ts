...
export class SourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:automation:SourceControl';
    ...
    constructor(name: string, args: SourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:automation/latest:SourceControl" }, { type: "azure-nextgen:automation/v20170515preview:SourceControl" }, { type: "azure-nextgen:automation/v20190601:SourceControl" }, { type: "azure-nextgen:automation/v20200113preview:SourceControl" }] };
