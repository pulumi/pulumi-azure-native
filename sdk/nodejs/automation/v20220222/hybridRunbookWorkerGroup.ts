...
export class HybridRunbookWorkerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20220222:HybridRunbookWorkerGroup';
     ...
     */
    public readonly credential!: pulumi.Output<outputs.automation.v20220222.RunAsCredentialAssociationPropertyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.automation.v20220222.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: HybridRunbookWorkerGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:HybridRunbookWorkerGroup" }, { type: "azure-native:automation/v20210622:HybridRunbookWorkerGroup" }, { type: "azure-native:automation/v20220808:HybridRunbookWorkerGroup" }, { type: "azure-native:automation/v20230515preview:HybridRunbookWorkerGroup" }, { type: "azure-native:automation/v20231101:HybridRunbookWorkerGroup" }, { type: "azure-native:automation/v20241023:HybridRunbookWorkerGroup" }] };
...
export interface HybridRunbookWorkerGroupArgs {
     ...
     * Sets the credential of a worker group.
     */
    credential?: pulumi.Input<inputs.automation.v20220222.RunAsCredentialAssociationPropertyArgs>;
    /**
