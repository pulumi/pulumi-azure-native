...
export function getFlow(args: GetFlowArgs, opts?: pulumi.InvokeOptions): Promise<GetFlowResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azuredatatransfer/v20240927:getFlow", {
...
export interface GetFlowResult {
     ...
     */
    readonly identity?: outputs.azuredatatransfer.v20240927.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly plan?: outputs.azuredatatransfer.v20240927.PlanResponse;
    /**
     * Properties of flow
     */
    readonly properties: outputs.azuredatatransfer.v20240927.FlowPropertiesResponse;
    /**
...
export function getFlowOutput(args: GetFlowOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFlowResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azuredatatransfer/v20240927:getFlow", {
        "connectionName": args.connectionName,
        "flowName": args.flowName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
