...
export interface ListListSchemaArgs {
     ...
     */
    status?: string | enums.azuredatatransfer.v20240125.SchemaStatus;
}
...
export interface ListListSchemaResult {
     ...
     * Schemas array.
     */
    readonly value?: outputs.azuredatatransfer.v20240125.SchemaResponse[];
}
/**
 * Lists the schemas for the specified connection in a pipeline.
 */
export function listListSchemaOutput(args: ListListSchemaOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ListListSchemaResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azuredatatransfer/v20240125:listListSchema", {
        "connectionId": args.connectionId,
        "content": args.content,
        "id": args.id,
        "name": args.name,
...
export interface ListListSchemaOutputArgs {
     ...
     * Status of the schema
     */
    status?: pulumi.Input<string | enums.azuredatatransfer.v20240125.SchemaStatus>;
}
