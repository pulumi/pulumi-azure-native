...
export class UserSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/latest:UserSettings';
    ...
    constructor(name: string, argsOrState?: UserSettingsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/preview:UserSettings" }, { type: "azurerm:portal/v20181001:UserSettings" }] };
