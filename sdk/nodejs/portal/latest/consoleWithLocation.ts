...
export class ConsoleWithLocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:portal/latest:ConsoleWithLocation';
    ...
    constructor(name: string, args: ConsoleWithLocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:portal:ConsoleWithLocation" }, { type: "azure-nextgen:portal/v20181001:ConsoleWithLocation" }] };
