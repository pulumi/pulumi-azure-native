...
export class UserSettingsWithLocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/latest:UserSettingsWithLocation';
    ...
    constructor(name: string, args: UserSettingsWithLocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/preview:UserSettingsWithLocation" }, { type: "azurerm:portal/v20181001:UserSettingsWithLocation" }] };
