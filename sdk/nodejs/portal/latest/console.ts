...
export class Console extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:portal/latest:Console';
    ...
    constructor(name: string, args: ConsoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:portal/latest:Console" }, { type: "azure-native:portal:Console" }, { type: "azure-nextgen:portal:Console" }, { type: "azure-native:portal/v20181001:Console" }, { type: "azure-nextgen:portal/v20181001:Console" }] };
