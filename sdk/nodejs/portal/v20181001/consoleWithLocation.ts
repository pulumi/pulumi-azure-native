...
export class ConsoleWithLocation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConsoleWithLocation {
        return new ConsoleWithLocation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/v20181001:ConsoleWithLocation';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.portal.v20181001.ConsolePropertiesResponse>;
    ...
    constructor(name: string, argsOrState?: ConsoleWithLocationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ConsoleWithLocationArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/latest:ConsoleWithLocation" }, { type: "azurerm:portal/preview:ConsoleWithLocation" }] };
