...
export class ConsoleWithLocation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConsoleWithLocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:portal/v20181001:ConsoleWithLocation" }, { type: "azure-native:portal:ConsoleWithLocation" }, { type: "azure-nextgen:portal:ConsoleWithLocation" }] };
