...
export class UserSettingsWithLocation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: UserSettingsWithLocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:portal/v20181001:UserSettingsWithLocation" }, { type: "azure-native:portal:UserSettingsWithLocation" }, { type: "azure-nextgen:portal:UserSettingsWithLocation" }, { type: "azure-native:portal/latest:UserSettingsWithLocation" }, { type: "azure-nextgen:portal/latest:UserSettingsWithLocation" }] };
