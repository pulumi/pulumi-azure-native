...
export class Console extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Console {
        return new Console(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/v20181001:Console';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.portal.v20181001.ConsolePropertiesResponse>;
    ...
    constructor(name: string, argsOrState?: ConsoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/latest:Console" }, { type: "azurerm:portal/preview:Console" }] };
