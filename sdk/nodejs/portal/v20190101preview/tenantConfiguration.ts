...
export class TenantConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: TenantConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:portal:TenantConfiguration" }, { type: "azure-nextgen:portal:TenantConfiguration" }, { type: "azure-native:portal/v20200901preview:TenantConfiguration" }, { type: "azure-nextgen:portal/v20200901preview:TenantConfiguration" }] };
