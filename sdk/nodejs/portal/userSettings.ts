...
export class UserSettings extends pulumi.CustomResource {
    ...
    constructor(name: string, args: UserSettingsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:portal:UserSettings" }, { type: "azure-native:portal/latest:UserSettings" }, { type: "azure-nextgen:portal/latest:UserSettings" }, { type: "azure-native:portal/v20181001:UserSettings" }, { type: "azure-nextgen:portal/v20181001:UserSettings" }] };
...
export interface UserSettingsArgs {
     ...
     * The cloud shell user settings properties.
     */
    readonly properties: pulumi.Input<inputs.portal.UserProperties>;
    /**
