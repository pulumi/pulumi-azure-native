...
export class UserSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/preview:UserSettings';
    ...
    constructor(name: string, argsOrState?: UserSettingsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/latest:UserSettings" }, { type: "azurerm:portal/v20181001:UserSettings" }] };
