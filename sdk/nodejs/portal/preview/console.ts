...
export class Console extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/preview:Console';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.portal.preview.ConsolePropertiesResponse>;
    ...
    constructor(name: string, argsOrState?: ConsoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/latest:Console" }, { type: "azurerm:portal/v20181001:Console" }] };
...
export interface ConsoleArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.portal.preview.ConsoleCreateProperties>;
}
