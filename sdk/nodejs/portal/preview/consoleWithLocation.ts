...
export class ConsoleWithLocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/preview:ConsoleWithLocation';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.portal.preview.ConsolePropertiesResponse>;
    ...
    constructor(name: string, argsOrState?: ConsoleWithLocationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/latest:ConsoleWithLocation" }, { type: "azurerm:portal/v20181001:ConsoleWithLocation" }] };
