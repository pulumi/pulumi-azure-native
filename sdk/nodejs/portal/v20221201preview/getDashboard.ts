...
export function getDashboard(args: GetDashboardArgs, opts?: pulumi.InvokeOptions): Promise<GetDashboardResult> {
    ...
    return pulumi.runtime.invoke("azure-native:portal/v20221201preview:getDashboard", {
...
export interface GetDashboardResult {
     ...
     */
    readonly properties: outputs.portal.v20221201preview.DashboardPropertiesWithProvisioningStateResponse;
    /**
...
export function getDashboardOutput(args: GetDashboardOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDashboardResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:portal/v20221201preview:getDashboard", {
        "dashboardName": args.dashboardName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
