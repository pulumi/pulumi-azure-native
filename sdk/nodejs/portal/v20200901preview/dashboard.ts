...
export class Dashboard extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/v20200901preview:Dashboard';
    ...
    constructor(name: string, args: DashboardArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/latest:Dashboard" }, { type: "azurerm:portal/v20150801preview:Dashboard" }, { type: "azurerm:portal/v20181001preview:Dashboard" }, { type: "azurerm:portal/v20190101preview:Dashboard" }] };
