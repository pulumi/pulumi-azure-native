...
export class TenantConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:portal/v20200901preview:TenantConfiguration';
    ...
    constructor(name: string, args: TenantConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:portal/latest:TenantConfiguration" }, { type: "azurerm:portal/v20190101preview:TenantConfiguration" }] };
