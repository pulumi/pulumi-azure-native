...
export class AzureLargeStorageInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurelargeinstance/v20240801preview:AzureLargeStorageInstance';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.azurelargeinstance.v20240801preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly storageProperties!: pulumi.Output<outputs.azurelargeinstance.v20240801preview.StoragePropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AzureLargeStorageInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurelargeinstance:AzureLargeStorageInstance" }] };
