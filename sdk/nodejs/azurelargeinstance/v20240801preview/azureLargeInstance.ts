...
export class AzureLargeInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurelargeinstance/v20240801preview:AzureLargeInstance';
     ...
     */
    public readonly hardwareProfile!: pulumi.Output<outputs.azurelargeinstance.v20240801preview.HardwareProfileResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.azurelargeinstance.v20240801preview.NetworkProfileResponse | undefined>;
    /**
     * Specifies the operating system settings for the Azure Large Instance.
     */
    public readonly osProfile!: pulumi.Output<outputs.azurelargeinstance.v20240801preview.OsProfileResponse | undefined>;
    /**
     ...
     */
    public readonly storageProfile!: pulumi.Output<outputs.azurelargeinstance.v20240801preview.StorageProfileResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.azurelargeinstance.v20240801preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: AzureLargeInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurelargeinstance:AzureLargeInstance" }] };
...
export interface AzureLargeInstanceArgs {
     ...
     * Specifies the hardware settings for the Azure Large Instance.
     */
    hardwareProfile?: pulumi.Input<inputs.azurelargeinstance.v20240801preview.HardwareProfileArgs>;
    /**
     * Hardware revision of an Azure Large Instance
     */
     ...
     * Specifies the network settings for the Azure Large Instance.
     */
    networkProfile?: pulumi.Input<inputs.azurelargeinstance.v20240801preview.NetworkProfileArgs>;
    /**
     * Specifies the operating system settings for the Azure Large Instance.
     */
    osProfile?: pulumi.Input<inputs.azurelargeinstance.v20240801preview.OsProfileArgs>;
    /**
     * Resource power state
     */
    powerState?: pulumi.Input<string | enums.azurelargeinstance.v20240801preview.AzureLargeInstancePowerStateEnum>;
    /**
     * Resource proximity placement group
     */
     ...
     * Specifies the storage settings for the Azure Large Instance disks.
     */
    storageProfile?: pulumi.Input<inputs.azurelargeinstance.v20240801preview.StorageProfileArgs>;
    /**
     * Resource tags.
     */
