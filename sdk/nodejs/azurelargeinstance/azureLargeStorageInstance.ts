...
export class AzureLargeStorageInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<outputs.azurelargeinstance.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    declare public readonly storageProperties: pulumi.Output<outputs.azurelargeinstance.StoragePropertiesResponse | undefined>;
    /**
