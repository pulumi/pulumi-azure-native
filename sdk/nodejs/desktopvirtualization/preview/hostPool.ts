...
export class HostPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:desktopvirtualization/preview:HostPool';
     ...
     */
    public readonly registrationInfo!: pulumi.Output<outputs.desktopvirtualization.preview.RegistrationInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/v20190123preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20190924preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20191210preview:HostPool" }] };
...
export interface HostPoolArgs {
     ...
     * The registration info of HostPool.
     */
    readonly registrationInfo?: pulumi.Input<inputs.desktopvirtualization.preview.RegistrationInfo>;
    /**
