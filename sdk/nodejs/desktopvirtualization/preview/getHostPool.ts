...
export function getHostPool(args: GetHostPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetHostPoolResult> {
    ...
    return pulumi.runtime.invoke("azurerm:desktopvirtualization/preview:getHostPool", {
...
export interface GetHostPoolResult {
     ...
     */
    readonly registrationInfo?: outputs.desktopvirtualization.preview.RegistrationInfoResponse;
    /**
