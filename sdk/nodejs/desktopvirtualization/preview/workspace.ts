...
export class Workspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:desktopvirtualization/preview:Workspace';
    ...
    constructor(name: string, args: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/v20190123preview:Workspace" }, { type: "azurerm:desktopvirtualization/v20190924preview:Workspace" }, { type: "azurerm:desktopvirtualization/v20191210preview:Workspace" }] };
