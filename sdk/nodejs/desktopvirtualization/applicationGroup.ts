...
export class ApplicationGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.ApplicationGroupPropertiesResponse>;
...
export interface ApplicationGroupArgs {
     ...
     * Detailed properties for ApplicationGroup
     */
    properties: pulumi.Input<inputs.desktopvirtualization.ApplicationGroupPropertiesArgs>;
    /**
