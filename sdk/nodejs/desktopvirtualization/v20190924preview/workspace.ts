...
export class Workspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/preview:Workspace" }, { type: "azurerm:desktopvirtualization/v20190123preview:Workspace" }, { type: "azurerm:desktopvirtualization/v20191210preview:Workspace" }] };
