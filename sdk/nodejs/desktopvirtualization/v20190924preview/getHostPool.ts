...
export function getHostPool(args: GetHostPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetHostPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:desktopvirtualization/v20190924preview:getHostPool", {
...
export interface GetHostPoolResult {
     ...
     */
    readonly registrationInfo?: outputs.desktopvirtualization.v20190924preview.RegistrationInfoInvokeResponse;
    /**
