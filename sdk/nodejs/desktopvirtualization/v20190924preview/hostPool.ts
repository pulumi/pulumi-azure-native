...
export class HostPool extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20190123preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20191210preview:HostPool" }] };
