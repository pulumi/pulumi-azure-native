...
export class HostPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/latest:HostPool" }, { type: "azurerm:desktopvirtualization/v20190123preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20191210preview:HostPool" }] };
