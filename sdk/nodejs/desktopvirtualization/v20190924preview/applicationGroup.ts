...
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:desktopvirtualization/v20190924preview:ApplicationGroup';
    ...
    constructor(name: string, args: ApplicationGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/latest:ApplicationGroup" }, { type: "azurerm:desktopvirtualization/v20190123preview:ApplicationGroup" }, { type: "azurerm:desktopvirtualization/v20191210preview:ApplicationGroup" }] };
