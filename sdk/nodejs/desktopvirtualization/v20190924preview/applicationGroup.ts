...
export class ApplicationGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.v20190924preview.ApplicationGroupPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationGroupArgs {
     ...
     * Detailed properties for ApplicationGroup
     */
    properties: pulumi.Input<inputs.desktopvirtualization.v20190924preview.ApplicationGroupPropertiesArgs>;
    /**
