 ...
 *
 * @deprecated azure-native:desktopvirtualization/v20220909:HostPool is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:HostPool to guarantee forwards compatibility.
 */
export class HostPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HostPool {
        pulumi.log.warn("HostPool is deprecated: azure-native:desktopvirtualization/v20220909:HostPool is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:HostPool to guarantee forwards compatibility.")
     ...
     */
    public readonly agentUpdate!: pulumi.Output<outputs.desktopvirtualization.v20220909.AgentUpdatePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly registrationInfo!: pulumi.Output<outputs.desktopvirtualization.v20220909.RegistrationInfoResponse | undefined>;
    /**
