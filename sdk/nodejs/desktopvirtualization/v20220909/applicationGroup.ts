 ...
 *
 * @deprecated azure-native:desktopvirtualization/v20220909:ApplicationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:ApplicationGroup to guarantee forwards compatibility.
 */
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationGroup {
        pulumi.log.warn("ApplicationGroup is deprecated: azure-native:desktopvirtualization/v20220909:ApplicationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:ApplicationGroup to guarantee forwards compatibility.")
...
export interface ApplicationGroupArgs {
     ...
     * Resource Type of ApplicationGroup.
     */
    applicationGroupType: pulumi.Input<string | enums.desktopvirtualization.v20220909.ApplicationGroupType>;
    /**
     * Description of ApplicationGroup.
     */
