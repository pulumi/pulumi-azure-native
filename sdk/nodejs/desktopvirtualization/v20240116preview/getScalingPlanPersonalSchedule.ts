...
export interface GetScalingPlanPersonalScheduleResult {
     ...
     */
    readonly offPeakStartTime?: outputs.desktopvirtualization.v20240116preview.TimeResponse;
    /**
     ...
     */
    readonly peakStartTime?: outputs.desktopvirtualization.v20240116preview.TimeResponse;
    /**
     ...
     */
    readonly rampDownStartTime?: outputs.desktopvirtualization.v20240116preview.TimeResponse;
    /**
     ...
     */
    readonly rampUpStartTime?: outputs.desktopvirtualization.v20240116preview.TimeResponse;
    /**
...
export function getScalingPlanPersonalScheduleOutput(args: GetScalingPlanPersonalScheduleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScalingPlanPersonalScheduleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20240116preview:getScalingPlanPersonalSchedule", {
        "resourceGroupName": args.resourceGroupName,
        "scalingPlanName": args.scalingPlanName,
        "scalingPlanScheduleName": args.scalingPlanScheduleName,
    }, opts);
