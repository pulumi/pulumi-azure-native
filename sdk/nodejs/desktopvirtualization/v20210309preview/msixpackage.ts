...
export class MSIXPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20210309preview:MSIXPackage';
     ...
     */
    public readonly packageApplications!: pulumi.Output<outputs.desktopvirtualization.v20210309preview.MsixPackageApplicationsResponse[] | undefined>;
    /**
     * List of package dependencies. 
     */
    public readonly packageDependencies!: pulumi.Output<outputs.desktopvirtualization.v20210309preview.MsixPackageDependenciesResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: MSIXPackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:desktopvirtualization/v20210309preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20200921preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20200921preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20201019preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20201019preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20201102preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20201102preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20201110preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20201110preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20210114preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210114preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20210201preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210201preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20210401preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210401preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20210513preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210513preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20210712:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210712:MSIXPackage" }] };
...
export interface MSIXPackageArgs {
     ...
     * List of package applications. 
     */
    packageApplications?: pulumi.Input<pulumi.Input<inputs.desktopvirtualization.v20210309preview.MsixPackageApplicationsArgs>[]>;
    /**
     * List of package dependencies. 
     */
    packageDependencies?: pulumi.Input<pulumi.Input<inputs.desktopvirtualization.v20210309preview.MsixPackageDependenciesArgs>[]>;
    /**
     * Package Family Name from appxmanifest.xml. Contains Package Name and Publisher name. 
     */
