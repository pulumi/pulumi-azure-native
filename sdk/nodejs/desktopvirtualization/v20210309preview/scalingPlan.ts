...
export class ScalingPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20210309preview:ScalingPlan';
     ...
     */
    public readonly hostPoolReferences!: pulumi.Output<outputs.desktopvirtualization.v20210309preview.ScalingHostPoolReferenceResponse[] | undefined>;
    /**
     ...
     */
    public readonly schedules!: pulumi.Output<outputs.desktopvirtualization.v20210309preview.ScalingScheduleResponse[] | undefined>;
    ...
    constructor(name: string, args: ScalingPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:desktopvirtualization/v20210309preview:ScalingPlan" }, { type: "azure-native:desktopvirtualization:ScalingPlan" }, { type: "azure-nextgen:desktopvirtualization:ScalingPlan" }, { type: "azure-native:desktopvirtualization/v20201110preview:ScalingPlan" }, { type: "azure-nextgen:desktopvirtualization/v20201110preview:ScalingPlan" }, { type: "azure-native:desktopvirtualization/v20210114preview:ScalingPlan" }, { type: "azure-nextgen:desktopvirtualization/v20210114preview:ScalingPlan" }, { type: "azure-native:desktopvirtualization/v20210201preview:ScalingPlan" }, { type: "azure-nextgen:desktopvirtualization/v20210201preview:ScalingPlan" }, { type: "azure-native:desktopvirtualization/v20210401preview:ScalingPlan" }, { type: "azure-nextgen:desktopvirtualization/v20210401preview:ScalingPlan" }, { type: "azure-native:desktopvirtualization/v20210513preview:ScalingPlan" }, { type: "azure-nextgen:desktopvirtualization/v20210513preview:ScalingPlan" }, { type: "azure-native:desktopvirtualization/v20210712:ScalingPlan" }, { type: "azure-nextgen:desktopvirtualization/v20210712:ScalingPlan" }] };
...
export interface ScalingPlanArgs {
     ...
     * List of ScalingHostPoolReference definitions.
     */
    hostPoolReferences?: pulumi.Input<pulumi.Input<inputs.desktopvirtualization.v20210309preview.ScalingHostPoolReferenceArgs>[]>;
    /**
     * HostPool type for desktop.
     */
     ...
     * List of ScalingSchedule definitions.
     */
    schedules?: pulumi.Input<pulumi.Input<inputs.desktopvirtualization.v20210309preview.ScalingScheduleArgs>[]>;
