...
export function getScalingPlanPooledSchedule(args: GetScalingPlanPooledScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingPlanPooledScheduleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20240403:getScalingPlanPooledSchedule", {
...
export interface GetScalingPlanPooledScheduleResult {
     ...
     */
    readonly offPeakStartTime?: outputs.desktopvirtualization.v20240403.TimeResponse;
    /**
     ...
     */
    readonly peakStartTime?: outputs.desktopvirtualization.v20240403.TimeResponse;
    /**
     ...
     */
    readonly rampDownStartTime?: outputs.desktopvirtualization.v20240403.TimeResponse;
    /**
     ...
     */
    readonly rampUpStartTime?: outputs.desktopvirtualization.v20240403.TimeResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.desktopvirtualization.v20240403.SystemDataResponse;
    /**
...
export function getScalingPlanPooledScheduleOutput(args: GetScalingPlanPooledScheduleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScalingPlanPooledScheduleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20240403:getScalingPlanPooledSchedule", {
        "resourceGroupName": args.resourceGroupName,
        "scalingPlanName": args.scalingPlanName,
        "scalingPlanScheduleName": args.scalingPlanScheduleName,
    }, opts);
