...
export function getScalingPlan(args: GetScalingPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingPlanResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20240808preview:getScalingPlan", {
...
export interface GetScalingPlanResult {
     ...
     */
    readonly hostPoolReferences?: outputs.desktopvirtualization.v20240808preview.ScalingHostPoolReferenceResponse[];
    /**
     ...
     */
    readonly schedules?: outputs.desktopvirtualization.v20240808preview.ScalingScheduleResponse[];
    /**
...
export function getScalingPlanOutput(args: GetScalingPlanOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScalingPlanResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20240808preview:getScalingPlan", {
        "resourceGroupName": args.resourceGroupName,
        "scalingPlanName": args.scalingPlanName,
    }, opts);
}
