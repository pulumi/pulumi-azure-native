...
export function getScalingPlanPersonalSchedule(args: GetScalingPlanPersonalScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingPlanPersonalScheduleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20240808preview:getScalingPlanPersonalSchedule", {
...
export interface GetScalingPlanPersonalScheduleResult {
     ...
     */
    readonly offPeakStartTime: outputs.desktopvirtualization.v20240808preview.TimeResponse;
    /**
     ...
     */
    readonly peakStartTime: outputs.desktopvirtualization.v20240808preview.TimeResponse;
    /**
     ...
     */
    readonly rampDownStartTime: outputs.desktopvirtualization.v20240808preview.TimeResponse;
    /**
     ...
     */
    readonly rampUpStartTime: outputs.desktopvirtualization.v20240808preview.TimeResponse;
    /**
...
export function getScalingPlanPersonalScheduleOutput(args: GetScalingPlanPersonalScheduleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScalingPlanPersonalScheduleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20240808preview:getScalingPlanPersonalSchedule", {
        "resourceGroupName": args.resourceGroupName,
        "scalingPlanName": args.scalingPlanName,
        "scalingPlanScheduleName": args.scalingPlanScheduleName,
    }, opts);
