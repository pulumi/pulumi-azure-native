...
export class Application extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Application {
        pulumi.log.warn("Application is deprecated: azure-native:desktopvirtualization/v20220401preview:Application is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:Application to guarantee forwards compatibility.")
        return new Application(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20220401preview:Application';
...
export interface ApplicationArgs {
     ...
     * Resource Type of Application.
     */
    applicationType?: pulumi.Input<string | enums.desktopvirtualization.v20220401preview.RemoteApplicationType>;
    /**
     * Command Line Arguments for Application.
     */
     ...
     * Specifies whether this published application can be launched with command line arguments provided by the client, command line arguments specified at publish time, or no command line arguments at all.
     */
    commandLineSetting: pulumi.Input<string | enums.desktopvirtualization.v20220401preview.CommandLineSetting>;
    /**
     * Description of Application.
     */
