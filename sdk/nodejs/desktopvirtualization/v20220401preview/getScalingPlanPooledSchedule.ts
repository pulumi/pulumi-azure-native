 ...
 */
/** @deprecated azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule to guarantee forwards compatibility. */
export function getScalingPlanPooledSchedule(args: GetScalingPlanPooledScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingPlanPooledScheduleResult> {
    pulumi.log.warn("getScalingPlanPooledSchedule is deprecated: azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule to guarantee forwards compatibility.")
...
export interface GetScalingPlanPooledScheduleResult {
     ...
     */
    readonly offPeakStartTime?: outputs.desktopvirtualization.v20220401preview.TimeResponse;
    /**
     ...
     */
    readonly peakStartTime?: outputs.desktopvirtualization.v20220401preview.TimeResponse;
    /**
     ...
     */
    readonly rampDownStartTime?: outputs.desktopvirtualization.v20220401preview.TimeResponse;
    /**
     ...
     */
    readonly rampUpStartTime?: outputs.desktopvirtualization.v20220401preview.TimeResponse;
    /**
