 ...
 *
 * const scalingPlanPooledSchedule = new azure_native.desktopvirtualization.v20220401preview.ScalingPlanPooledSchedule("scalingPlanPooledSchedule", {
 *     daysOfWeek: [
 *         "Monday",
 *         "Tuesday",
 *         "Wednesday",
...
export class ScalingPlanPooledSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule';
     ...
     */
    public readonly offPeakStartTime!: pulumi.Output<outputs.desktopvirtualization.v20220401preview.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly peakStartTime!: pulumi.Output<outputs.desktopvirtualization.v20220401preview.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly rampDownStartTime!: pulumi.Output<outputs.desktopvirtualization.v20220401preview.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly rampUpStartTime!: pulumi.Output<outputs.desktopvirtualization.v20220401preview.TimeResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ScalingPlanPooledScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:desktopvirtualization:ScalingPlanPooledSchedule" }, { type: "azure-native:desktopvirtualization/v20220909:ScalingPlanPooledSchedule" }, { type: "azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule" }] };
...
export interface ScalingPlanPooledScheduleArgs {
     ...
     * Set of days of the week on which this schedule is active.
     */
    daysOfWeek?: pulumi.Input<pulumi.Input<string | enums.desktopvirtualization.v20220401preview.DayOfWeek>[]>;
    /**
     * Load balancing algorithm for off-peak period.
     */
