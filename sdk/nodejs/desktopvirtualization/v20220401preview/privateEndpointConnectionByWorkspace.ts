...
export class PrivateEndpointConnectionByWorkspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpointConnectionByWorkspace {
        pulumi.log.warn("PrivateEndpointConnectionByWorkspace is deprecated: azure-native:desktopvirtualization/v20220401preview:PrivateEndpointConnectionByWorkspace is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:PrivateEndpointConnectionByWorkspace to guarantee forwards compatibility.")
