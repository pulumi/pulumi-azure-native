...
export class AppAttachPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20240408preview:AppAttachPackage';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.v20240408preview.AppAttachPackagePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AppAttachPackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:desktopvirtualization:AppAttachPackage" }, { type: "azure-native:desktopvirtualization/v20231004preview:AppAttachPackage" }, { type: "azure-native:desktopvirtualization/v20231101preview:AppAttachPackage" }, { type: "azure-native:desktopvirtualization/v20240116preview:AppAttachPackage" }, { type: "azure-native:desktopvirtualization/v20240306preview:AppAttachPackage" }, { type: "azure-native:desktopvirtualization/v20240403:AppAttachPackage" }, { type: "azure-native:desktopvirtualization/v20240808preview:AppAttachPackage" }] };
...
export interface AppAttachPackageArgs {
     ...
     * Detailed properties for App Attach Package
     */
    properties: pulumi.Input<inputs.desktopvirtualization.v20240408preview.AppAttachPackagePropertiesArgs>;
    /**
