...
export class ScalingPlanPersonalSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20240408preview:ScalingPlanPersonalSchedule';
