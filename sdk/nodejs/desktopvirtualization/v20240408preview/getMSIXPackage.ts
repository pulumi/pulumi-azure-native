...
export function getMSIXPackage(args: GetMSIXPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetMSIXPackageResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20240408preview:getMSIXPackage", {
...
export interface GetMSIXPackageResult {
     ...
     */
    readonly packageApplications?: outputs.desktopvirtualization.v20240408preview.MsixPackageApplicationsResponse[];
    /**
     * List of package dependencies. 
     */
    readonly packageDependencies?: outputs.desktopvirtualization.v20240408preview.MsixPackageDependenciesResponse[];
    /**
...
export function getMSIXPackageOutput(args: GetMSIXPackageOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMSIXPackageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20240408preview:getMSIXPackage", {
        "hostPoolName": args.hostPoolName,
        "msixPackageFullName": args.msixPackageFullName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
