...
export function getHostPool(args: GetHostPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetHostPoolResult> {
    pulumi.log.warn("getHostPool is deprecated: Version 2020-11-02-preview will be removed in v2 of the provider.")
...
export interface GetHostPoolResult {
     ...
     */
    readonly properties: outputs.desktopvirtualization.v20201102preview.HostPoolPropertiesResponse;
    /**
     * Resource tags.
     */
