...
export class SessionHostConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization:SessionHostConfiguration';
     ...
     */
    public readonly domainInfo!: pulumi.Output<outputs.desktopvirtualization.DomainInfoPropertiesResponse | undefined>;
    /**
     * Image configurations of HostPool.
     */
    public readonly imageInfo!: pulumi.Output<outputs.desktopvirtualization.ImageInfoPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SessionHostConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:desktopvirtualization:SessionHostConfiguration" }, { type: "azure-native:desktopvirtualization/v20210513preview:SessionHostConfiguration" }, { type: "azure-nextgen:desktopvirtualization/v20210513preview:SessionHostConfiguration" }] };
...
export interface SessionHostConfigurationArgs {
     ...
     * The disk type used by virtual machine in hostpool session host.
     */
    diskType?: pulumi.Input<string | enums.desktopvirtualization.VirtualMachineDiskType>;
    /**
     * Domain configurations of session hosts.
     */
    domainInfo?: pulumi.Input<inputs.desktopvirtualization.DomainInfoPropertiesArgs>;
    /**
     ...
     * Image configurations of HostPool.
     */
    imageInfo?: pulumi.Input<inputs.desktopvirtualization.ImageInfoPropertiesArgs>;
    /**
