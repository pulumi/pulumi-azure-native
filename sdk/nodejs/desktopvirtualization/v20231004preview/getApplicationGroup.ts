...
export function getApplicationGroup(args: GetApplicationGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20231004preview:getApplicationGroup", {
...
export interface GetApplicationGroupResult {
     ...
     */
    readonly id: string;
    readonly identity?: outputs.desktopvirtualization.v20231004preview.ResourceModelWithAllowedPropertySetResponseIdentity;
    /**
    ...
    readonly plan?: outputs.desktopvirtualization.v20231004preview.ResourceModelWithAllowedPropertySetResponsePlan;
    /**
     * Boolean representing whether the applicationGroup is show in the feed.
     */
    readonly showInFeed?: boolean;
    readonly sku?: outputs.desktopvirtualization.v20231004preview.ResourceModelWithAllowedPropertySetResponseSku;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: outputs.desktopvirtualization.v20231004preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getApplicationGroupOutput(args: GetApplicationGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetApplicationGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20231004preview:getApplicationGroup", {
        "applicationGroupName": args.applicationGroupName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
