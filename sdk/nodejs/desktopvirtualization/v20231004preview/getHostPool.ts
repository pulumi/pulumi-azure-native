...
export interface GetHostPoolResult {
     ...
     */
    readonly agentUpdate?: outputs.desktopvirtualization.v20231004preview.AgentUpdatePropertiesResponse;
    /**
     ...
     */
    readonly registrationInfo?: outputs.desktopvirtualization.v20231004preview.RegistrationInfoResponse;
    /**
...
export function getHostPoolOutput(args: GetHostPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHostPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20231004preview:getHostPool", {
        "hostPoolName": args.hostPoolName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
