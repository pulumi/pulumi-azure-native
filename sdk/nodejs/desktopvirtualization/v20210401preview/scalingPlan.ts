 ...
 *
 * @deprecated azure-native:desktopvirtualization/v20210401preview:ScalingPlan is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20220210preview:ScalingPlan to guarantee forwards compatibility.
 */
export class ScalingPlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScalingPlan {
        pulumi.log.warn("ScalingPlan is deprecated: azure-native:desktopvirtualization/v20210401preview:ScalingPlan is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20220210preview:ScalingPlan to guarantee forwards compatibility.")
        return new ScalingPlan(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20210401preview:ScalingPlan';
     ...
     */
    public readonly hostPoolReferences!: pulumi.Output<outputs.desktopvirtualization.v20210401preview.ScalingHostPoolReferenceResponse[] | undefined>;
    /**
     ...
     */
    public readonly schedules!: pulumi.Output<outputs.desktopvirtualization.v20210401preview.ScalingScheduleResponse[] | undefined>;
