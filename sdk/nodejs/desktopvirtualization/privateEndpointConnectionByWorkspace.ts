...
export class PrivateEndpointConnectionByWorkspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionByWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:desktopvirtualization:PrivateEndpointConnectionByWorkspace" }, { type: "azure-native:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace" }, { type: "azure-nextgen:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace" }] };
...
export interface PrivateEndpointConnectionByWorkspaceArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.desktopvirtualization.PrivateLinkServiceConnectionStateArgs>;
    /**
