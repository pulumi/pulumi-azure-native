...
export class MSIXPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20200921preview:MSIXPackage';
    ...
    constructor(name: string, args: MSIXPackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:desktopvirtualization/v20200921preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20201019preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20201019preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20201102preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20201102preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20201110preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20201110preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20210114preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210114preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20210201preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210201preview:MSIXPackage" }, { type: "azure-native:desktopvirtualization/v20210309preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210309preview:MSIXPackage" }] };
...
export interface MSIXPackageArgs {
     ...
     * List of package applications. 
     */
    readonly packageApplications?: pulumi.Input<pulumi.Input<inputs.desktopvirtualization.v20200921preview.MsixPackageApplicationsArgs>[]>;
    /**
     * List of package dependencies. 
     */
    readonly packageDependencies?: pulumi.Input<pulumi.Input<inputs.desktopvirtualization.v20200921preview.MsixPackageDependenciesArgs>[]>;
    /**
     * Package Family Name from appxmanifest.xml. Contains Package Name and Publisher name. 
     */
