...
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationGroup {
        pulumi.log.warn("ApplicationGroup is deprecated: Version 2020-09-21-preview will be removed in v2 of the provider.")
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.v20200921preview.ApplicationGroupPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationGroupArgs {
     ...
     * Detailed properties for ApplicationGroup
     */
    properties: pulumi.Input<inputs.desktopvirtualization.v20200921preview.ApplicationGroupPropertiesArgs>;
    /**
