...
export class Workspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/latest:Workspace" }, { type: "azurerm:desktopvirtualization/v20190123preview:Workspace" }, { type: "azurerm:desktopvirtualization/v20190924preview:Workspace" }] };
