...
export class HostPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:desktopvirtualization/v20191210preview:HostPool';
    ...
    constructor(name: string, argsOrState?: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20190123preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20190924preview:HostPool" }] };
