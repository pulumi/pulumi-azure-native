...
export class HostPool extends pulumi.CustomResource {
     ...
     */
    public readonly registrationInfo!: pulumi.Output<outputs.desktopvirtualization.v20191210preview.RegistrationInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:desktopvirtualization/v20191210preview:HostPool" }, { type: "azure-native:desktopvirtualization:HostPool" }, { type: "azure-nextgen:desktopvirtualization:HostPool" }, { type: "azure-native:desktopvirtualization/v20190123preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20190123preview:HostPool" }, { type: "azure-native:desktopvirtualization/v20190924preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20190924preview:HostPool" }, { type: "azure-native:desktopvirtualization/v20200921preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20200921preview:HostPool" }, { type: "azure-native:desktopvirtualization/v20201019preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20201019preview:HostPool" }, { type: "azure-native:desktopvirtualization/v20201102preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20201102preview:HostPool" }, { type: "azure-native:desktopvirtualization/v20201110preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20201110preview:HostPool" }, { type: "azure-native:desktopvirtualization/v20210114preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20210114preview:HostPool" }, { type: "azure-native:desktopvirtualization/v20210201preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20210201preview:HostPool" }, { type: "azure-native:desktopvirtualization/v20210309preview:HostPool" }, { type: "azure-nextgen:desktopvirtualization/v20210309preview:HostPool" }] };
...
export interface HostPoolArgs {
     ...
     * HostPool type for desktop.
     */
    readonly hostPoolType: pulumi.Input<string | enums.desktopvirtualization.v20191210preview.HostPoolType>;
    /**
     * The type of the load balancer.
     */
    readonly loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20191210preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    readonly personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20191210preview.PersonalDesktopAssignmentType>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    readonly preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20191210preview.PreferredAppGroupType>;
    /**
     * The registration info of HostPool.
     */
    readonly registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20191210preview.RegistrationInfoArgs>;
    /**
