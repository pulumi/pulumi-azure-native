...
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationGroup {
        pulumi.log.warn("ApplicationGroup is deprecated: Version 2019-12-10-preview will be removed in v2 of the provider.")
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.v20191210preview.ApplicationGroupPropertiesResponse>;
    /**
     * Resource tags.
     */
...
export interface ApplicationGroupArgs {
     ...
     * Detailed properties for ApplicationGroup
     */
    properties: pulumi.Input<inputs.desktopvirtualization.v20191210preview.ApplicationGroupPropertiesArgs>;
    /**
