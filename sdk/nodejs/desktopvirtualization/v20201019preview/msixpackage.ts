...
export class MSIXPackage extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MSIXPackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:desktopvirtualization/v20200921preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20201102preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20201110preview:MSIXPackage" }, { type: "azure-nextgen:desktopvirtualization/v20210114preview:MSIXPackage" }] };
