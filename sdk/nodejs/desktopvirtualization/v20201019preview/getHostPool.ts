...
export function getHostPool(args: GetHostPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetHostPoolResult> {
    pulumi.log.warn("getHostPool is deprecated: Version 2020-10-19-preview will be removed in v2 of the provider.")
...
export interface GetHostPoolResult {
     ...
     */
    readonly properties: outputs.desktopvirtualization.v20201019preview.HostPoolPropertiesResponse;
    /**
     * Resource tags.
     */
