...
export class ScalingPlanPooledSchedule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.ScalingPlanPooledSchedulePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ScalingPlanPooledScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule" }, { type: "azure-native:desktopvirtualization/v20220909:ScalingPlanPooledSchedule" }, { type: "azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule" }] };
...
export interface ScalingPlanPooledScheduleArgs {
     ...
     * Detailed properties for ScalingPlanPooledSchedule
     */
    properties: pulumi.Input<inputs.desktopvirtualization.ScalingPlanPooledSchedulePropertiesArgs>;
    /**
