...
export class ScalingPlan extends pulumi.CustomResource {
     ...
     */
    declare public readonly hostPoolReferences: pulumi.Output<outputs.desktopvirtualization.ScalingHostPoolReferenceResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly schedules: pulumi.Output<outputs.desktopvirtualization.ScalingScheduleResponse[] | undefined>;
