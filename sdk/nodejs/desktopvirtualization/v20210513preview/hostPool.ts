...
export class HostPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20210513preview:HostPool';
     ...
     * The registration info of HostPool.
     */
    public readonly registrationInfo!: pulumi.Output<outputs.desktopvirtualization.v20210513preview.RegistrationInfoResponse | undefined>;
    /**
     ...
     */
    public readonly sessionHostComponentUpdateConfiguration!: pulumi.Output<outputs.desktopvirtualization.v20210513preview.SessionHostComponentUpdateConfigurationPropertiesResponse | undefined>;
    ...
    constructor(name: string, args: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["sessionHostComponentUpdateConfiguration"] = args ? args.sessionHostComponentUpdateConfiguration : undefined;
            ...
            inputs["sessionHostComponentUpdateConfiguration"] = undefined /*out*/;
...
export interface HostPoolArgs {
     ...
     * The type of the load balancer.
     */
    loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20210513preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20210513preview.PersonalDesktopAssignmentType>;
    plan?: pulumi.Input<inputs.desktopvirtualization.v20210513preview.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20210513preview.PreferredAppGroupType>;
    /**
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
     ...
     * The registration info of HostPool.
     */
    registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20210513preview.RegistrationInfoArgs>;
    /**
     ...
     * The session host configuration for updating agent, monitoring agent, and stack component.
     */
    sessionHostComponentUpdateConfiguration?: pulumi.Input<inputs.desktopvirtualization.v20210513preview.SessionHostComponentUpdateConfigurationPropertiesArgs>;
     ...
     * The type of single sign on Secret Type.
     */
    ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.v20210513preview.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
