...
export class Workspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20210513preview:Workspace';
...
export interface WorkspaceArgs {
     ...
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
    publicNetworkAccess?: pulumi.Input<string | enums.desktopvirtualization.v20210513preview.PublicNetworkAccess>;
    /**
