 ...
 *
 * @deprecated azure-native:desktopvirtualization/v20210712:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:Workspace to guarantee forwards compatibility.
 */
export class Workspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Workspace {
        pulumi.log.warn("Workspace is deprecated: azure-native:desktopvirtualization/v20210712:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:Workspace to guarantee forwards compatibility.")
        return new Workspace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20210712:Workspace';
    ...
    public readonly identity!: pulumi.Output<outputs.desktopvirtualization.v20210712.ResourceModelWithAllowedPropertySetResponseIdentity | undefined>;
    /**
    ...
    public readonly plan!: pulumi.Output<outputs.desktopvirtualization.v20210712.ResourceModelWithAllowedPropertySetResponsePlan | undefined>;
    public readonly sku!: pulumi.Output<outputs.desktopvirtualization.v20210712.ResourceModelWithAllowedPropertySetResponseSku | undefined>;
    /**
     * Resource tags.
     */
...
export interface WorkspaceArgs {
    ...
    identity?: pulumi.Input<inputs.desktopvirtualization.v20210712.ResourceModelWithAllowedPropertySetIdentityArgs>;
    /**
     * Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type; e.g. ApiApps are a kind of Microsoft.Web/sites type.  If supported, the resource provider must validate and persist this value.
     */
    ...
    plan?: pulumi.Input<inputs.desktopvirtualization.v20210712.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
    resourceGroupName: pulumi.Input<string>;
    sku?: pulumi.Input<inputs.desktopvirtualization.v20210712.ResourceModelWithAllowedPropertySetSkuArgs>;
    /**
     * Resource tags.
     */
