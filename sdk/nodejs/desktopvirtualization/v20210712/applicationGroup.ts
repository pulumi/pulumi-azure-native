...
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationGroup {
        pulumi.log.warn("ApplicationGroup is deprecated: azure-native:desktopvirtualization/v20210712:ApplicationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20220401preview:ApplicationGroup to guarantee forwards compatibility.")
