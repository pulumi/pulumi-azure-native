...
export function getScalingPlan(args: GetScalingPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingPlanResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:desktopvirtualization/v20210114preview:getScalingPlan", {
...
export interface GetScalingPlanResult {
     ...
     */
    readonly hostPoolReferences?: outputs.desktopvirtualization.v20210114preview.ScalingHostPoolReferenceInvokeResponse[];
    /**
     ...
     */
    readonly schedules?: outputs.desktopvirtualization.v20210114preview.ScalingScheduleInvokeResponse[];
    /**
     * Resource tags.
     */
