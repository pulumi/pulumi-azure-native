...
export function getPrivateEndpointConnectionByWorkspace(args: GetPrivateEndpointConnectionByWorkspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointConnectionByWorkspaceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20241101preview:getPrivateEndpointConnectionByWorkspace", {
...
export interface GetPrivateEndpointConnectionByWorkspaceResult {
     ...
     */
    readonly privateEndpoint?: outputs.desktopvirtualization.v20241101preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: outputs.desktopvirtualization.v20241101preview.PrivateLinkServiceConnectionStateResponse;
    /**
     ...
     */
    readonly systemData: outputs.desktopvirtualization.v20241101preview.SystemDataResponse;
    /**
...
export function getPrivateEndpointConnectionByWorkspaceOutput(args: GetPrivateEndpointConnectionByWorkspaceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateEndpointConnectionByWorkspaceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20241101preview:getPrivateEndpointConnectionByWorkspace", {
        "privateEndpointConnectionName": args.privateEndpointConnectionName,
        "resourceGroupName": args.resourceGroupName,
        "workspaceName": args.workspaceName,
    }, opts);
