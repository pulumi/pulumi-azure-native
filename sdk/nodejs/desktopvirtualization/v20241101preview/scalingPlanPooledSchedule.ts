...
export class ScalingPlanPooledSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20241101preview:ScalingPlanPooledSchedule';
     ...
     */
    public readonly createDelete!: pulumi.Output<outputs.desktopvirtualization.v20241101preview.CreateDeletePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly rampDownCapacityThresholdPct!: pulumi.Output<number>;
    /**
     ...
     */
    public readonly rampUpCapacityThresholdPct!: pulumi.Output<number>;
    /**
     ...
     */
    public readonly scalingMethod!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: ScalingPlanPooledScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.rampDownCapacityThresholdPct === undefined) && !opts.urn) {
                throw new Error("Missing required property 'rampDownCapacityThresholdPct'");
            }
            if ((!args || args.rampDownStartTime === undefined) && !opts.urn) {
                throw new Error("Missing required property 'rampDownStartTime'");
            }
            if ((!args || args.rampUpCapacityThresholdPct === undefined) && !opts.urn) {
                throw new Error("Missing required property 'rampUpCapacityThresholdPct'");
            }
            ...
            resourceInputs["createDelete"] = args ? args.createDelete : undefined;
            ...
            resourceInputs["scalingMethod"] = args ? args.scalingMethod : undefined;
            ...
            resourceInputs["createDelete"] = undefined /*out*/;
            ...
            resourceInputs["scalingMethod"] = undefined /*out*/;
            resourceInputs["systemData"] = undefined /*out*/;
            resourceInputs["type"] = undefined /*out*/;
        }
