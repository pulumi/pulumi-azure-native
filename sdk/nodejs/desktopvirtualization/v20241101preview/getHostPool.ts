...
export function getHostPool(args: GetHostPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetHostPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20241101preview:getHostPool", {
...
export interface GetHostPoolResult {
     ...
     */
    readonly agentUpdate?: outputs.desktopvirtualization.v20241101preview.AgentUpdatePropertiesResponse;
    /**
     ...
     */
    readonly identity?: outputs.desktopvirtualization.v20241101preview.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly plan?: outputs.desktopvirtualization.v20241101preview.PlanResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.desktopvirtualization.v20241101preview.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly registrationInfo?: outputs.desktopvirtualization.v20241101preview.RegistrationInfoResponse;
    /**
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
     ...
     */
    readonly sku?: outputs.desktopvirtualization.v20241101preview.SkuResponse;
    /**
...
export function getHostPoolOutput(args: GetHostPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHostPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20241101preview:getHostPool", {
        "hostPoolName": args.hostPoolName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
