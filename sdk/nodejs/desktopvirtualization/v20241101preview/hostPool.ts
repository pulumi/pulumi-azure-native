...
export class HostPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20241101preview:HostPool';
     ...
     */
    public readonly agentUpdate!: pulumi.Output<outputs.desktopvirtualization.v20241101preview.AgentUpdatePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly directUDP!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.desktopvirtualization.v20241101preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    public readonly managedPrivateUDP!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly plan!: pulumi.Output<outputs.desktopvirtualization.v20241101preview.PlanResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.desktopvirtualization.v20241101preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    public readonly publicUDP!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly registrationInfo!: pulumi.Output<outputs.desktopvirtualization.v20241101preview.RegistrationInfoResponse | undefined>;
    /**
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    public readonly relayUDP!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.desktopvirtualization.v20241101preview.SkuResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.desktopvirtualization.v20241101preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["directUDP"] = args ? args.directUDP : undefined;
            ...
            resourceInputs["managedPrivateUDP"] = args ? args.managedPrivateUDP : undefined;
            ...
            resourceInputs["publicUDP"] = args ? args.publicUDP : undefined;
            resourceInputs["registrationInfo"] = args ? args.registrationInfo : undefined;
            resourceInputs["relayUDP"] = args ? args.relayUDP : undefined;
            ...
            resourceInputs["directUDP"] = undefined /*out*/;
            resourceInputs["etag"] = undefined /*out*/;
            ...
            resourceInputs["managedPrivateUDP"] = undefined /*out*/;
            ...
            resourceInputs["publicUDP"] = undefined /*out*/;
            resourceInputs["registrationInfo"] = undefined /*out*/;
            resourceInputs["relayUDP"] = undefined /*out*/;
...
export interface HostPoolArgs {
     ...
     * The session host configuration for updating agent, monitoring agent, and stack component.
     */
    agentUpdate?: pulumi.Input<inputs.desktopvirtualization.v20241101preview.AgentUpdatePropertiesArgs>;
    /**
     * Custom rdp property of HostPool.
     */
     ...
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    directUDP?: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.DirectUDP>;
    /**
     * Friendly name of HostPool.
     */
     ...
     * HostPool type for desktop.
     */
    hostPoolType: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.HostPoolType>;
    /**
     * Managed service identity (system assigned and/or user assigned identities)
     */
    identity?: pulumi.Input<inputs.desktopvirtualization.v20241101preview.ManagedServiceIdentityArgs>;
    /**
     * Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type. E.g. ApiApps are a kind of Microsoft.Web/sites type.  If supported, the resource provider must validate and persist this value.
     */
     ...
     * The type of the load balancer.
     */
    loadBalancerType: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    managedPrivateUDP?: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.ManagedPrivateUDP>;
    /**
     * The type of management for this hostpool, Automated or Standard. The default value is Automated.
     */
    managementType?: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.ManagementType>;
    /**
     * The max session limit of HostPool.
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    personalDesktopAssignmentType?: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.PersonalDesktopAssignmentType>;
    /**
     * Plan for the resource.
     */
    plan?: pulumi.Input<inputs.desktopvirtualization.v20241101preview.PlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    preferredAppGroupType: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.PreferredAppGroupType>;
    /**
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
    publicNetworkAccess?: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.HostpoolPublicNetworkAccess>;
    /**
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    publicUDP?: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.PublicUDP>;
    /**
     * The registration info of HostPool. This is not returned on GET. In order to get the registration token use the retrieveRegistrationToken or listRegistrationTokens POST calls.
     */
    registrationInfo?: pulumi.Input<inputs.desktopvirtualization.v20241101preview.RegistrationInfoArgs>;
    /**
     * Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
     */
    relayUDP?: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.RelayUDP>;
    /**
     ...
     * The resource model definition representing SKU
     */
    sku?: pulumi.Input<inputs.desktopvirtualization.v20241101preview.SkuArgs>;
    /**
     * ClientId for the registered Relying Party used to issue WVD SSO certificates.
     */
     ...
     * The type of single sign on Secret Type.
     */
    ssoSecretType?: pulumi.Input<string | enums.desktopvirtualization.v20241101preview.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */
