...
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApplicationGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/latest:ApplicationGroup" }, { type: "azurerm:desktopvirtualization/v20190924preview:ApplicationGroup" }, { type: "azurerm:desktopvirtualization/v20191210preview:ApplicationGroup" }] };
