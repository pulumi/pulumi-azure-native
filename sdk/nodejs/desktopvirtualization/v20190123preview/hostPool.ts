...
export class HostPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/latest:HostPool" }, { type: "azurerm:desktopvirtualization/v20190924preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20191210preview:HostPool" }] };
