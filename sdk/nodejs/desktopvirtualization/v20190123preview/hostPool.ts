 ...
 *
 * const hostPool = new azurerm.desktopvirtualization.v20190123preview.HostPool("hostPool", {
 *     description: "des1",
...
export class HostPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:desktopvirtualization/v20190123preview:HostPool';
    ...
    constructor(name: string, args: HostPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:desktopvirtualization/v20190924preview:HostPool" }, { type: "azurerm:desktopvirtualization/v20191210preview:HostPool" }] };
