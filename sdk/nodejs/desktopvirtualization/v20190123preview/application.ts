...
export class Application extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Application {
        pulumi.log.warn("Application is deprecated: Version 2019-01-23-preview will be removed in v2 of the provider.")
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.v20190123preview.ApplicationPropertiesResponse>;
    /**
...
export interface ApplicationArgs {
     ...
     * Detailed properties for Application
     */
    properties: pulumi.Input<inputs.desktopvirtualization.v20190123preview.ApplicationPropertiesArgs>;
    /**
