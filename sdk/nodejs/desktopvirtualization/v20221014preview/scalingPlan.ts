...
export class ScalingPlan extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.v20221014preview.ScalingPlanPropertiesResponse>;
    ...
    constructor(name: string, args: ScalingPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.desktopvirtualization.v20221014preview.scalingPlanPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface ScalingPlanArgs {
     ...
     * Detailed properties for scaling plan.
     */
    properties: pulumi.Input<inputs.desktopvirtualization.v20221014preview.ScalingPlanPropertiesArgs>;
    /**
