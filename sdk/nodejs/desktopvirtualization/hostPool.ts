...
export class HostPool extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.desktopvirtualization.HostPoolPropertiesResponse>;
...
export interface HostPoolArgs {
     ...
     * Detailed properties for HostPool
     */
    properties: pulumi.Input<inputs.desktopvirtualization.HostPoolPropertiesArgs>;
    /**
