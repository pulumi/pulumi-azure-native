...
export interface GetScalingPlanResult {
     ...
     */
    readonly hostPoolReferences?: outputs.desktopvirtualization.v20230707preview.ScalingHostPoolReferenceResponse[];
    /**
     ...
     */
    readonly schedules?: outputs.desktopvirtualization.v20230707preview.ScalingScheduleResponse[];
...
export function getScalingPlanOutput(args: GetScalingPlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScalingPlanResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:desktopvirtualization/v20230707preview:getScalingPlan", {
        "resourceGroupName": args.resourceGroupName,
        "scalingPlanName": args.scalingPlanName,
    }, opts);
}
