...
export class ScalingPlanPersonalSchedule extends pulumi.CustomResource {
     ...
     */
    public readonly offPeakStartTime!: pulumi.Output<outputs.desktopvirtualization.v20230905.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly peakStartTime!: pulumi.Output<outputs.desktopvirtualization.v20230905.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly rampDownStartTime!: pulumi.Output<outputs.desktopvirtualization.v20230905.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly rampUpStartTime!: pulumi.Output<outputs.desktopvirtualization.v20230905.TimeResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ScalingPlanPersonalScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:desktopvirtualization/v20231004preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20231101preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240116preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240306preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240403:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240408preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240808preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20241101preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization:ScalingPlanPersonalSchedule" }] };
...
export interface ScalingPlanPersonalScheduleArgs {
     ...
     * Set of days of the week on which this schedule is active.
     */
    daysOfWeek?: pulumi.Input<pulumi.Input<string | enums.desktopvirtualization.v20230905.DayOfWeek>[]>;
    /**
     * Action to be taken after a user disconnect during the off-peak period.
     */
    offPeakActionOnDisconnect?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SessionHandlingOperation>;
    /**
     * Action to be taken after a logoff during the off-peak period.
     */
    offPeakActionOnLogoff?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SessionHandlingOperation>;
    /**
     * The time in minutes to wait before performing the desired session handling action when a user disconnects during the off-peak period.
     */
     ...
     * Starting time for off-peak period.
     */
    offPeakStartTime?: pulumi.Input<inputs.desktopvirtualization.v20230905.TimeArgs>;
    /**
     * The desired configuration of Start VM On Connect for the hostpool during the off-peak phase.
     */
    offPeakStartVMOnConnect?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SetStartVMOnConnect>;
    /**
     * Action to be taken after a user disconnect during the peak period.
     */
    peakActionOnDisconnect?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SessionHandlingOperation>;
    /**
     * Action to be taken after a logoff during the peak period.
     */
    peakActionOnLogoff?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SessionHandlingOperation>;
    /**
     * The time in minutes to wait before performing the desired session handling action when a user disconnects during the peak period.
     */
     ...
     * Starting time for peak period.
     */
    peakStartTime?: pulumi.Input<inputs.desktopvirtualization.v20230905.TimeArgs>;
    /**
     * The desired configuration of Start VM On Connect for the hostpool during the peak phase.
     */
    peakStartVMOnConnect?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SetStartVMOnConnect>;
    /**
     * Action to be taken after a user disconnect during the ramp down period.
     */
    rampDownActionOnDisconnect?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SessionHandlingOperation>;
    /**
     * Action to be taken after a logoff during the ramp down period.
     */
    rampDownActionOnLogoff?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SessionHandlingOperation>;
    /**
     * The time in minutes to wait before performing the desired session handling action when a user disconnects during the ramp down period.
     */
     ...
     * Starting time for ramp down period.
     */
    rampDownStartTime?: pulumi.Input<inputs.desktopvirtualization.v20230905.TimeArgs>;
    /**
     * The desired configuration of Start VM On Connect for the hostpool during the ramp down phase.
     */
    rampDownStartVMOnConnect?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SetStartVMOnConnect>;
    /**
     * Action to be taken after a user disconnect during the ramp up period.
     */
    rampUpActionOnDisconnect?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SessionHandlingOperation>;
    /**
     * Action to be taken after a logoff during the ramp up period.
     */
    rampUpActionOnLogoff?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SessionHandlingOperation>;
    /**
     * The desired startup behavior during the ramp up period for personal vms in the hostpool.
     */
    rampUpAutoStartHosts?: pulumi.Input<string | enums.desktopvirtualization.v20230905.StartupBehavior>;
    /**
     * The time in minutes to wait before performing the desired session handling action when a user disconnects during the ramp up period.
     */
     ...
     * Starting time for ramp up period.
     */
    rampUpStartTime?: pulumi.Input<inputs.desktopvirtualization.v20230905.TimeArgs>;
    /**
     * The desired configuration of Start VM On Connect for the hostpool during the ramp up phase. If this is disabled, session hosts must be turned on using rampUpAutoStartHosts or by turning them on manually.
     */
    rampUpStartVMOnConnect?: pulumi.Input<string | enums.desktopvirtualization.v20230905.SetStartVMOnConnect>;
    /**
