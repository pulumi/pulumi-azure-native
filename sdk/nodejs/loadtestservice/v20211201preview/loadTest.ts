...
export class LoadTest extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.loadtestservice.v20211201preview.SystemAssignedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.loadtestservice.v20211201preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: LoadTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:loadtestservice/v20220415preview:LoadTest" }, { type: "azure-native:loadtestservice/v20221201:LoadTest" }, { type: "azure-native:loadtestservice/v20231201preview:LoadTest" }, { type: "azure-native:loadtestservice/v20241201preview:LoadTest" }, { type: "azure-native:loadtestservice:LoadTest" }] };
