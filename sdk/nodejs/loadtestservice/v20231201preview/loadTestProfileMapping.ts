...
export class LoadTestProfileMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:loadtestservice/v20231201preview:LoadTestProfileMapping';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.loadtestservice.v20231201preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: LoadTestProfileMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:loadtestservice/v20241201preview:LoadTestProfileMapping" }, { type: "azure-native:loadtestservice:LoadTestProfileMapping" }] };
