...
export class LoadTest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:loadtestservice/v20241201preview:LoadTest';
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.loadtestservice.v20241201preview.EncryptionPropertiesResponse | undefined>;
    /**
     * The managed service identities assigned to this resource.
     */
    public readonly identity!: pulumi.Output<outputs.loadtestservice.v20241201preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.loadtestservice.v20241201preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: LoadTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:loadtestservice/v20211201preview:LoadTest" }, { type: "azure-native:loadtestservice/v20220415preview:LoadTest" }, { type: "azure-native:loadtestservice/v20221201:LoadTest" }, { type: "azure-native:loadtestservice/v20231201preview:LoadTest" }, { type: "azure-native:loadtestservice:LoadTest" }] };
...
export interface LoadTestArgs {
     ...
     * CMK Encryption property.
     */
    encryption?: pulumi.Input<inputs.loadtestservice.v20241201preview.EncryptionPropertiesArgs>;
    /**
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.loadtestservice.v20241201preview.ManagedServiceIdentityArgs>;
    /**
     * Load Test name
     */
