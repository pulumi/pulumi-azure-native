...
export class LoadTestMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:loadtestservice/v20241201preview:LoadTestMapping';
    ...
    constructor(name: string, args: LoadTestMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:loadtestservice/v20231201preview:LoadTestMapping" }, { type: "azure-native:loadtestservice:LoadTestMapping" }] };
