...
export class LoadTest extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.loadtestservice.v20221201.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: LoadTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:loadtestservice:LoadTest" }, { type: "azure-native:loadtestservice/v20211201preview:LoadTest" }, { type: "azure-native:loadtestservice/v20220415preview:LoadTest" }, { type: "azure-native:loadtestservice/v20231201preview:LoadTest" }] };
