...
export function getLoadTest(args: GetLoadTestArgs, opts?: pulumi.InvokeOptions): Promise<GetLoadTestResult> {
    pulumi.log.warn("getLoadTest is deprecated: azure-native:loadtestservice/v20220415preview:LoadTest is being removed in the next major version of this provider. Upgrade to at least azure-native:loadtestservice/v20221201:LoadTest to guarantee forwards compatibility.")
...
export interface GetLoadTestResult {
     ...
     */
    readonly encryption?: outputs.loadtestservice.v20220415preview.EncryptionPropertiesResponse;
    /**
     ...
     */
    readonly identity?: outputs.loadtestservice.v20220415preview.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly systemData: outputs.loadtestservice.v20220415preview.SystemDataResponse;
    /**
     * Resource tags.
     */
