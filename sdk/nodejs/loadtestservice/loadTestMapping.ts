...
export class LoadTestMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LoadTestMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:loadtestservice/v20231201preview:LoadTestMapping" }, { type: "azure-native_loadtestservice_v20231201preview:loadtestservice:LoadTestMapping" }, { type: "azure-native_loadtestservice_v20241201preview:loadtestservice:LoadTestMapping" }] };
