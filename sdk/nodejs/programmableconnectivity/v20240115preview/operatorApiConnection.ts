...
export class OperatorApiConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:programmableconnectivity/v20240115preview:OperatorApiConnection';
     ...
     */
    public readonly configuredApplication!: pulumi.Output<outputs.programmableconnectivity.v20240115preview.ApplicationPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly saasProperties!: pulumi.Output<outputs.programmableconnectivity.v20240115preview.SaasPropertiesResponse | undefined>;
    /**
     * The status of the OperatorApiConnection resource.
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.programmableconnectivity.v20240115preview.StatusResponse>;
    /**
    ...
    constructor(name: string, args: OperatorApiConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:programmableconnectivity:OperatorApiConnection" }] };
...
export interface OperatorApiConnectionArgs {
     ...
     * Type of the account the user has with the Operator's Network API infrastructure. AzureManaged | UserManaged.
     */
    accountType: pulumi.Input<string | enums.programmableconnectivity.v20240115preview.AccountType>;
    /**
     * Application ID of the App Developer that is registered with the Operator in a specific country/region.
     */
     ...
     * Details about the Application that would use the Operator's Network APIs.
     */
    configuredApplication?: pulumi.Input<inputs.programmableconnectivity.v20240115preview.ApplicationPropertiesArgs>;
    /**
     * Reference to the APC Gateway resource ID.
     */
     ...
     * Details about the SaaS offer purchased from the marketplace.
     */
    saasProperties?: pulumi.Input<inputs.programmableconnectivity.v20240115preview.SaasPropertiesArgs>;
    /**
     * Resource tags.
     */
