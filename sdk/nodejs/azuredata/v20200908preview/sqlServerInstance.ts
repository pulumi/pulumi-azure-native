...
export class SqlServerInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuredata/v20200908preview:SqlServerInstance';
    ...
    constructor(name: string, args: SqlServerInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azuredata/v20200908preview:SqlServerInstance" }, { type: "azure-native:azuredata:SqlServerInstance" }, { type: "azure-nextgen:azuredata:SqlServerInstance" }, { type: "azure-native:azuredata/v20190724preview:SqlServerInstance" }, { type: "azure-nextgen:azuredata/v20190724preview:SqlServerInstance" }] };
