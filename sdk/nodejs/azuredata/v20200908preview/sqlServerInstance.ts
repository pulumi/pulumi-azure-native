...
export class SqlServerInstance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlServerInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuredata:SqlServerInstance" }, { type: "azure-nextgen:azuredata:SqlServerInstance" }, { type: "azure-native:azuredata/v20190724preview:SqlServerInstance" }, { type: "azure-nextgen:azuredata/v20190724preview:SqlServerInstance" }] };
