...
export class SqlServerRegistration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlServerRegistration {
        return new SqlServerRegistration(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:azuredata/v20170301preview:SqlServerRegistration';
    ...
    constructor(name: string, argsOrState?: SqlServerRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SqlServerRegistrationArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azuredata/preview:SqlServerRegistration" }, { type: "azurerm:azuredata/v20190724preview:SqlServerRegistration" }] };
