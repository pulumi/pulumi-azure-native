...
export class SqlManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azuredata/preview:SqlManagedInstance';
     ...
     * null
     */
    public readonly dataControllerId!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly instanceEndpoint!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.azuredata.preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: SqlManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if (!args || args.sqlManagedInstanceName === undefined) {
            ...
            inputs["instanceEndpoint"] = args ? args.instanceEndpoint : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azuredata/v20190724preview:SqlManagedInstance" }] };
...
export interface SqlManagedInstanceArgs {
     ...
     * null
     */
    readonly dataControllerId?: pulumi.Input<string>;
    /**
     * The instance end time
     */
     ...
     * The on premise instance endpoint
     */
    readonly instanceEndpoint?: pulumi.Input<string>;
    /**
     * The geo-location where the resource lives
     */
