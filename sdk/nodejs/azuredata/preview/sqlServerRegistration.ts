...
export class SqlServerRegistration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azuredata/preview:SqlServerRegistration';
    ...
    constructor(name: string, argsOrState?: SqlServerRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azuredata/v20170301preview:SqlServerRegistration" }, { type: "azurerm:azuredata/v20190724preview:SqlServerRegistration" }] };
