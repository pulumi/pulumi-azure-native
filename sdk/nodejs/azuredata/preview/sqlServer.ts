...
export class SqlServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azuredata/preview:SqlServer';
    ...
    constructor(name: string, args: SqlServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azuredata/v20170301preview:SqlServer" }, { type: "azurerm:azuredata/v20190724preview:SqlServer" }] };
