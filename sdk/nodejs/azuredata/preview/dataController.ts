...
export class DataController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azuredata/preview:DataController';
     ...
     */
    public readonly onPremiseProperty!: pulumi.Output<outputs.azuredata.preview.OnPremisePropertyResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: DataControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azuredata/v20190724preview:DataController" }] };
...
export interface DataControllerArgs {
     ...
     * Properties from the on premise data controller
     */
    readonly onPremiseProperty: pulumi.Input<inputs.azuredata.preview.OnPremiseProperty>;
    /**
