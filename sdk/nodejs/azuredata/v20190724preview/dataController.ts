...
export class DataController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuredata/v20190724preview:DataController';
     ...
     */
    public readonly onPremiseProperty!: pulumi.Output<outputs.azuredata.v20190724preview.OnPremisePropertyResponse>;
    /**
    ...
    constructor(name: string, args: DataControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azuredata/v20190724preview:DataController" }, { type: "azure-native:azuredata:DataController" }, { type: "azure-nextgen:azuredata:DataController" }, { type: "azure-native:azuredata/v20200908preview:DataController" }, { type: "azure-nextgen:azuredata/v20200908preview:DataController" }] };
...
export interface DataControllerArgs {
     ...
     * Properties from the on premise data controller
     */
    readonly onPremiseProperty: pulumi.Input<inputs.azuredata.v20190724preview.OnPremiseProperty>;
    /**
