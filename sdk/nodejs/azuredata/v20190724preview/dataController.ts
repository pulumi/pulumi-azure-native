...
export class DataController extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataController {
        return new DataController(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: DataControllerArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DataControllerArgs | undefined;
