...
export class SqlServerInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:azuredata/v20190724preview:SqlServerInstance';
    ...
    constructor(name: string, args: SqlServerInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azuredata:SqlServerInstance" }, { type: "azure-nextgen:azuredata/v20200908preview:SqlServerInstance" }] };
