...
export class SqlServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azuredata/v20190724preview:SqlServer';
    ...
    constructor(name: string, args: SqlServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azuredata/preview:SqlServer" }, { type: "azurerm:azuredata/v20170301preview:SqlServer" }] };
