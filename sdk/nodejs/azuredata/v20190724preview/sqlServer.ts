...
export class SqlServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:azuredata/v20190724preview:SqlServer';
    ...
    constructor(name: string, args: SqlServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azuredata:SqlServer" }, { type: "azure-nextgen:azuredata/v20170301preview:SqlServer" }] };
