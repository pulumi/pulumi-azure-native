...
export class SqlServerRegistration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:azuredata/v20190724preview:SqlServerRegistration';
    ...
    constructor(name: string, args: SqlServerRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:azuredata/latest:SqlServerRegistration" }, { type: "azurerm:azuredata/v20170301preview:SqlServerRegistration" }] };
