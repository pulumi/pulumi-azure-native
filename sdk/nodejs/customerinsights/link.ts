...
export class Link extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:customerinsights/v20170426:Link" }, { type: "azure-native_customerinsights_v20170101:customerinsights:Link" }, { type: "azure-native_customerinsights_v20170426:customerinsights:Link" }] };
