...
export class Link extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:customerinsights:Link';
    ...
    constructor(name: string, args: LinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/latest:Link" }, { type: "azure-nextgen:customerinsights/v20170101:Link" }, { type: "azure-nextgen:customerinsights/v20170426:Link" }] };
