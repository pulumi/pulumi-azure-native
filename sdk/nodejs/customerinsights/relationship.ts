...
export class Relationship extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RelationshipArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:customerinsights/latest:Relationship" }, { type: "azure-nextgen:customerinsights/latest:Relationship" }, { type: "azure-native:customerinsights/v20170101:Relationship" }, { type: "azure-nextgen:customerinsights/v20170101:Relationship" }, { type: "azure-native:customerinsights/v20170426:Relationship" }, { type: "azure-nextgen:customerinsights/v20170426:Relationship" }] };
