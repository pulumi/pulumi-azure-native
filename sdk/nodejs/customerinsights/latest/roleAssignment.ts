...
export class RoleAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/latest:RoleAssignment';
    ...
    constructor(name: string, argsOrState?: RoleAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/preview:RoleAssignment" }, { type: "azurerm:customerinsights/v20170101:RoleAssignment" }, { type: "azurerm:customerinsights/v20170426:RoleAssignment" }] };
