...
export class RelationshipLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/latest:RelationshipLink';
    ...
    constructor(name: string, args: RelationshipLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/preview:RelationshipLink" }, { type: "azurerm:customerinsights/v20170101:RelationshipLink" }, { type: "azurerm:customerinsights/v20170426:RelationshipLink" }] };
