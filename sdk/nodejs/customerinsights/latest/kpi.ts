...
export class Kpi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:customerinsights/latest:Kpi';
    ...
    constructor(name: string, args: KpiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/latest:Kpi" }, { type: "azure-native:customerinsights:Kpi" }, { type: "azure-nextgen:customerinsights:Kpi" }, { type: "azure-native:customerinsights/v20170101:Kpi" }, { type: "azure-nextgen:customerinsights/v20170101:Kpi" }, { type: "azure-native:customerinsights/v20170426:Kpi" }, { type: "azure-nextgen:customerinsights/v20170426:Kpi" }] };
