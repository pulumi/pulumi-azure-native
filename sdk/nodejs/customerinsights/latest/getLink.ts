...
export function getLink(args: GetLinkArgs, opts?: pulumi.InvokeOptions): Promise<GetLinkResult> {
    ...
    return pulumi.runtime.invoke("azurerm:customerinsights/latest:getLink", {
...
export interface GetLinkResult {
     ...
     */
    readonly mappings?: outputs.customerinsights.latest.TypePropertiesMappingResponse[];
    /**
     * Resource name.
     */
     ...
     */
    readonly participantPropertyReferences: outputs.customerinsights.latest.ParticipantPropertyReferenceResponse[];
    /**
     * Provisioning state.
     */
