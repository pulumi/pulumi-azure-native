 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:customerinsights:Hub'.
 */
export class Hub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Hub {
        pulumi.log.warn("Hub is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:customerinsights:Hub'.")
        return new Hub(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:customerinsights/latest:Hub';
    ...
    constructor(name: string, args: HubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/latest:Hub" }, { type: "azure-native:customerinsights:Hub" }, { type: "azure-nextgen:customerinsights:Hub" }, { type: "azure-native:customerinsights/v20170101:Hub" }, { type: "azure-nextgen:customerinsights/v20170101:Hub" }, { type: "azure-native:customerinsights/v20170426:Hub" }, { type: "azure-nextgen:customerinsights/v20170426:Hub" }] };
