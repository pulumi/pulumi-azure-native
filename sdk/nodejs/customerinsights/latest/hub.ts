...
export class Hub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:customerinsights/latest:Hub';
    ...
    constructor(name: string, args: HubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights:Hub" }, { type: "azure-nextgen:customerinsights/v20170101:Hub" }, { type: "azure-nextgen:customerinsights/v20170426:Hub" }] };
