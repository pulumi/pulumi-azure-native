...
export class Hub extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/preview:Hub" }, { type: "azurerm:customerinsights/v20170101:Hub" }, { type: "azurerm:customerinsights/v20170426:Hub" }] };
