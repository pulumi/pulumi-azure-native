...
export class Prediction extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PredictionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/latest:Prediction" }, { type: "azure-native:customerinsights:Prediction" }, { type: "azure-nextgen:customerinsights:Prediction" }, { type: "azure-native:customerinsights/v20170426:Prediction" }, { type: "azure-nextgen:customerinsights/v20170426:Prediction" }] };
