...
export class ConnectorMapping extends pulumi.CustomResource {
     ...
     */
    public readonly mappingProperties!: pulumi.Output<outputs.customerinsights.latest.ConnectorMappingPropertiesResponse>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: ConnectorMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/latest:ConnectorMapping" }, { type: "azure-native:customerinsights:ConnectorMapping" }, { type: "azure-nextgen:customerinsights:ConnectorMapping" }, { type: "azure-native:customerinsights/v20170101:ConnectorMapping" }, { type: "azure-nextgen:customerinsights/v20170101:ConnectorMapping" }, { type: "azure-native:customerinsights/v20170426:ConnectorMapping" }, { type: "azure-nextgen:customerinsights/v20170426:ConnectorMapping" }] };
...
export interface ConnectorMappingArgs {
     ...
     * The properties of the mapping.
     */
    readonly mappingProperties: pulumi.Input<inputs.customerinsights.latest.ConnectorMappingProperties>;
    /**
