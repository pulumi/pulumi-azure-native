...
export class RelationshipLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights:RelationshipLink';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.customerinsights.RelationshipLinkDefinitionResponse>;
    /**
     * Resource type.
     */
...
export interface RelationshipLinkArgs {
     ...
     * The definition of relationship link.
     */
    readonly properties?: pulumi.Input<inputs.customerinsights.RelationshipLinkDefinition>;
    /**
