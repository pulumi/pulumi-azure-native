...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:customerinsights:Profile';
    ...
    constructor(name: string, args: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/latest:Profile" }, { type: "azure-nextgen:customerinsights/v20170101:Profile" }, { type: "azure-nextgen:customerinsights/v20170426:Profile" }] };
...
export interface ProfileArgs {
     ...
     * The strong IDs.
     */
    readonly strongIds?: pulumi.Input<pulumi.Input<inputs.customerinsights.StrongId>[]>;
    /**
     * The timestamp property name. Represents the time when the interaction or profile update happened.
     */
