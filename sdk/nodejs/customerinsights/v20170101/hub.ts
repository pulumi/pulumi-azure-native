...
export class Hub extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: HubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Hub" }, { type: "azurerm:customerinsights/preview:Hub" }, { type: "azurerm:customerinsights/v20170426:Hub" }] };
