 ...
 *
 * const hub = new azurerm.customerinsights.v20170101.Hub("hub", {
 *     hubBillingInfo: {
 *         maxUnits: 5,
 *         minUnits: 1,
 *         skuName: "B0",
...
export class Hub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/v20170101:Hub';
    ...
    constructor(name: string, argsOrState?: HubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Hub" }, { type: "azurerm:customerinsights/v20170426:Hub" }] };
