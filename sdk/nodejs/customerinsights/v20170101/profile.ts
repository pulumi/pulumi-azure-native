...
export class Profile extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Profile" }, { type: "azurerm:customerinsights/preview:Profile" }, { type: "azurerm:customerinsights/v20170426:Profile" }] };
