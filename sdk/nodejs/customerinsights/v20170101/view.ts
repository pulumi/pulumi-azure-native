...
export class View extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/v20170101:View" }, { type: "azure-native:customerinsights:View" }, { type: "azure-nextgen:customerinsights:View" }, { type: "azure-native:customerinsights/latest:View" }, { type: "azure-nextgen:customerinsights/latest:View" }, { type: "azure-native:customerinsights/v20170426:View" }, { type: "azure-nextgen:customerinsights/v20170426:View" }] };
