...
export class View extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:customerinsights/v20170101:View';
    ...
    constructor(name: string, args: ViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights:View" }, { type: "azure-nextgen:customerinsights/latest:View" }, { type: "azure-nextgen:customerinsights/v20170426:View" }] };
