...
export class Link extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/v20170101:Link" }, { type: "azure-native:customerinsights:Link" }, { type: "azure-nextgen:customerinsights:Link" }, { type: "azure-native:customerinsights/latest:Link" }, { type: "azure-nextgen:customerinsights/latest:Link" }, { type: "azure-native:customerinsights/v20170426:Link" }, { type: "azure-nextgen:customerinsights/v20170426:Link" }] };
