...
export function getRelationship(args: GetRelationshipArgs, opts?: pulumi.InvokeOptions): Promise<GetRelationshipResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:customerinsights/v20170101:getRelationship", {
...
export interface GetRelationshipResult {
     ...
     */
    readonly fields?: outputs.customerinsights.v20170101.PropertyDefinitionInvokeResponse[];
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly lookupMappings?: outputs.customerinsights.v20170101.RelationshipTypeMappingInvokeResponse[];
    /**
     * Resource name.
     */
