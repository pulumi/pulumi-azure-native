...
export class ConnectorMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectorMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:ConnectorMapping" }, { type: "azurerm:customerinsights/preview:ConnectorMapping" }, { type: "azurerm:customerinsights/v20170426:ConnectorMapping" }] };
