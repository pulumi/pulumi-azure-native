...
export class Relationship extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:customerinsights/v20170101:Relationship';
    ...
    constructor(name: string, args: RelationshipArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights:Relationship" }, { type: "azure-nextgen:customerinsights/latest:Relationship" }, { type: "azure-nextgen:customerinsights/v20170426:Relationship" }] };
