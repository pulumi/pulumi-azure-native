...
export class Relationship extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RelationshipArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Relationship" }, { type: "azurerm:customerinsights/preview:Relationship" }, { type: "azurerm:customerinsights/v20170426:Relationship" }] };
