...
export class Connector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Connector {
        pulumi.log.warn("Connector is deprecated: Version v20170101 will be removed in the next major version of the provider. Upgrade to version v20170426 or later.")
    ...
    constructor(name: string, args: ConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:customerinsights:Connector" }, { type: "azure-native:customerinsights/v20170426:Connector" }] };
