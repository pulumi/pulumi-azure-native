...
export class Kpi extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: KpiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Kpi" }, { type: "azurerm:customerinsights/preview:Kpi" }, { type: "azurerm:customerinsights/v20170426:Kpi" }] };
