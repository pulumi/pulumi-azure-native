 ...
 *
 * const kpi = new azurerm.customerinsights.v20170101.Kpi("kpi", {
 *     aliases: [{
 *         aliasName: "alias",
 *         expression: "Id+4",
 *     }],
...
export class Kpi extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: KpiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Kpi" }, { type: "azurerm:customerinsights/v20170426:Kpi" }] };
