...
export class RelationshipLink extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RelationshipLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:RelationshipLink" }, { type: "azurerm:customerinsights/preview:RelationshipLink" }, { type: "azurerm:customerinsights/v20170426:RelationshipLink" }] };
