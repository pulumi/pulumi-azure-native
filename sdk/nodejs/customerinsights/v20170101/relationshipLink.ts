...
export class RelationshipLink extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RelationshipLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights:RelationshipLink" }, { type: "azure-nextgen:customerinsights/latest:RelationshipLink" }, { type: "azure-nextgen:customerinsights/v20170426:RelationshipLink" }] };
