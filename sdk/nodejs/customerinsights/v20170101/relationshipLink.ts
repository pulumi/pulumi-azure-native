 ...
 *
 * const relationshipLink = new azurerm.customerinsights.v20170101.RelationshipLink("relationshipLink", {
 *     description: {
...
export class RelationshipLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/v20170101:RelationshipLink';
    ...
    constructor(name: string, args: RelationshipLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:RelationshipLink" }, { type: "azurerm:customerinsights/v20170426:RelationshipLink" }] };
