...
export class RoleAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/v20170101:RoleAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.customerinsights.v20170101.RoleAssignmentResponse>;
    /**
     * Resource type.
     */
...
export interface RoleAssignmentArgs {
     ...
     * The Role Assignment definition.
     */
    readonly properties?: pulumi.Input<inputs.customerinsights.v20170101.RoleAssignmentDefinition>;
    /**
