...
export class ConnectorMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights:ConnectorMapping';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.customerinsights.ConnectorMappingResponse>;
    /**
     * Resource type.
     */
...
export interface ConnectorMappingArgs {
     ...
     * The connector mapping definition.
     */
    readonly properties?: pulumi.Input<inputs.customerinsights.ConnectorMappingDefinition>;
    /**
