...
export class ConnectorMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ConnectorMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:ConnectorMapping" }, { type: "azurerm:customerinsights/preview:ConnectorMapping" }, { type: "azurerm:customerinsights/v20170101:ConnectorMapping" }] };
