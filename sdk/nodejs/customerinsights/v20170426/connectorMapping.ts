...
export class ConnectorMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectorMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/v20170426:ConnectorMapping" }, { type: "azure-native:customerinsights:ConnectorMapping" }, { type: "azure-nextgen:customerinsights:ConnectorMapping" }, { type: "azure-native:customerinsights/latest:ConnectorMapping" }, { type: "azure-nextgen:customerinsights/latest:ConnectorMapping" }, { type: "azure-native:customerinsights/v20170101:ConnectorMapping" }, { type: "azure-nextgen:customerinsights/v20170101:ConnectorMapping" }] };
