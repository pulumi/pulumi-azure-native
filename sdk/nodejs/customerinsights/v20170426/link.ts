...
export class Link extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/v20170426:Link" }, { type: "azure-native:customerinsights:Link" }, { type: "azure-nextgen:customerinsights:Link" }, { type: "azure-native:customerinsights/latest:Link" }, { type: "azure-nextgen:customerinsights/latest:Link" }, { type: "azure-native:customerinsights/v20170101:Link" }, { type: "azure-nextgen:customerinsights/v20170101:Link" }] };
...
export interface LinkArgs {
     ...
     * Determines whether this link is supposed to create or delete instances if Link is NOT Reference Only.
     */
    readonly operationType?: pulumi.Input<enums.customerinsights.v20170426.InstanceOperationType>;
    /**
     * The properties that represent the participating profile.
     */
     ...
     * Type of source entity.
     */
    readonly sourceEntityType: pulumi.Input<enums.customerinsights.v20170426.EntityType>;
    /**
     * Name of the source Entity Type.
     */
     ...
     * Type of target entity.
     */
    readonly targetEntityType: pulumi.Input<enums.customerinsights.v20170426.EntityType>;
    /**
     * Name of the target Entity Type.
     */
