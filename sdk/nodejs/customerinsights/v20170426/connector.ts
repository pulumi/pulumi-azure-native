...
export class Connector extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Connector" }, { type: "azurerm:customerinsights/preview:Connector" }, { type: "azurerm:customerinsights/v20170101:Connector" }] };
