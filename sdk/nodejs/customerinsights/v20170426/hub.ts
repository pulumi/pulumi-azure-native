...
export class Hub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/v20170426:Hub';
    ...
    constructor(name: string, argsOrState?: HubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Hub" }, { type: "azurerm:customerinsights/preview:Hub" }, { type: "azurerm:customerinsights/v20170101:Hub" }] };
