...
export class Hub extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/v20170426:Hub" }, { type: "azure-native:customerinsights:Hub" }, { type: "azure-nextgen:customerinsights:Hub" }, { type: "azure-native:customerinsights/latest:Hub" }, { type: "azure-nextgen:customerinsights/latest:Hub" }, { type: "azure-native:customerinsights/v20170101:Hub" }, { type: "azure-nextgen:customerinsights/v20170101:Hub" }] };
