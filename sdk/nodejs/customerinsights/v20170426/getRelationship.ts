...
export function getRelationship(args: GetRelationshipArgs, opts?: pulumi.InvokeOptions): Promise<GetRelationshipResult> {
    ...
    return pulumi.runtime.invoke("azurerm:customerinsights/v20170426:getRelationship", {
...
export interface GetRelationshipResult {
     ...
     */
    readonly properties: outputs.customerinsights.v20170426.RelationshipDefinitionResponse;
    /**
     * Resource type.
     */
