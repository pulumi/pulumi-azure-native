...
export class Relationship extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/v20170426:Relationship';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.customerinsights.v20170426.RelationshipDefinitionResponse>;
    /**
     * Resource type.
     */
...
export interface RelationshipArgs {
     ...
     * The definition of Relationship.
     */
    readonly properties?: pulumi.Input<inputs.customerinsights.v20170426.RelationshipDefinition>;
    /**
