...
export class Relationship extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RelationshipArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/v20170426:Relationship" }, { type: "azure-native:customerinsights:Relationship" }, { type: "azure-nextgen:customerinsights:Relationship" }, { type: "azure-native:customerinsights/v20170101:Relationship" }, { type: "azure-nextgen:customerinsights/v20170101:Relationship" }] };
...
export interface RelationshipArgs {
     ...
     * The properties of the Relationship.
     */
    readonly fields?: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170426.PropertyDefinitionArgs>[]>;
    /**
     * The name of the hub.
     */
     ...
     * Optional property to be used to map fields in profile to their strong ids in related profile.
     */
    readonly lookupMappings?: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170426.RelationshipTypeMappingArgs>[]>;
    /**
     * Profile type.
     */
