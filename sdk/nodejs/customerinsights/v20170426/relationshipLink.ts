...
export class RelationshipLink extends pulumi.CustomResource {
     ...
     */
    public readonly mappings!: pulumi.Output<outputs.customerinsights.v20170426.RelationshipLinkFieldMappingResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly profilePropertyReferences!: pulumi.Output<outputs.customerinsights.v20170426.ParticipantProfilePropertyReferenceResponse[]>;
    /**
     * Provisioning state.
     */
     ...
     */
    public readonly relatedProfilePropertyReferences!: pulumi.Output<outputs.customerinsights.v20170426.ParticipantProfilePropertyReferenceResponse[]>;
    /**
    ...
    constructor(name: string, args: RelationshipLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/v20170426:RelationshipLink" }, { type: "azure-native:customerinsights:RelationshipLink" }, { type: "azure-nextgen:customerinsights:RelationshipLink" }, { type: "azure-native:customerinsights/v20170101:RelationshipLink" }, { type: "azure-nextgen:customerinsights/v20170101:RelationshipLink" }] };
...
export interface RelationshipLinkArgs {
     ...
     * The mappings between Interaction and Relationship fields.
     */
    mappings?: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170426.RelationshipLinkFieldMappingArgs>[]>;
    /**
     * The property references for the Profile of the Relationship.
     */
    profilePropertyReferences: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170426.ParticipantProfilePropertyReferenceArgs>[]>;
    /**
     * The property references for the Related Profile of the Relationship.
     */
    relatedProfilePropertyReferences: pulumi.Input<pulumi.Input<inputs.customerinsights.v20170426.ParticipantProfilePropertyReferenceArgs>[]>;
    /**
     * The name of the relationship link.
     */
