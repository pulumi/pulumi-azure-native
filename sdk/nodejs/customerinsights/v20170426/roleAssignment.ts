...
export class RoleAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: RoleAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:RoleAssignment" }, { type: "azurerm:customerinsights/preview:RoleAssignment" }, { type: "azurerm:customerinsights/v20170101:RoleAssignment" }] };
