...
export class Profile extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights:Profile" }, { type: "azure-nextgen:customerinsights/latest:Profile" }, { type: "azure-nextgen:customerinsights/v20170101:Profile" }] };
