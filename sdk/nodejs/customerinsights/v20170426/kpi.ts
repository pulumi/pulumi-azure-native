...
export class Kpi extends pulumi.CustomResource {
     ...
     * The aliases.
     */
    public readonly aliases!: pulumi.Output<outputs.customerinsights.v20170426.KpiAliasResponse[] | undefined>;
    /**
     ...
     * The KPI extracts.
     */
    public readonly extracts!: pulumi.Output<outputs.customerinsights.v20170426.KpiExtractResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly groupByMetadata!: pulumi.Output<outputs.customerinsights.v20170426.KpiGroupByMetadataResponse[]>;
    /**
     * The KPI name.
     */
     ...
     */
    public /*out*/ readonly participantProfilesMetadata!: pulumi.Output<outputs.customerinsights.v20170426.KpiParticipantProfilesMetadataResponse[]>;
    /**
     * Provisioning state.
     */
     ...
     * The KPI thresholds.
     */
    public readonly thresHolds!: pulumi.Output<outputs.customerinsights.v20170426.KpiThresholdsResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: KpiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customerinsights/v20170426:Kpi" }, { type: "azure-native:customerinsights:Kpi" }, { type: "azure-nextgen:customerinsights:Kpi" }, { type: "azure-native:customerinsights/latest:Kpi" }, { type: "azure-nextgen:customerinsights/latest:Kpi" }, { type: "azure-native:customerinsights/v20170101:Kpi" }, { type: "azure-nextgen:customerinsights/v20170101:Kpi" }] };
