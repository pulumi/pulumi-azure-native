...
export class Profile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:Profile';
     ...
     */
    public readonly fields!: pulumi.Output<outputs.customerinsights.preview.PropertyDefinitionResponse[] | undefined>;
    /**
     * The instance count.
     */
     ...
     * The strong IDs.
     */
    public readonly strongIds!: pulumi.Output<outputs.customerinsights.preview.StrongIdResponse[] | undefined>;
    /**
     * The hub name.
     */
    ...
    constructor(name: string, args: ProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Profile" }, { type: "azurerm:customerinsights/v20170101:Profile" }, { type: "azurerm:customerinsights/v20170426:Profile" }] };
...
export interface ProfileArgs {
     ...
     * The properties of the Profile.
     */
    readonly fields?: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.PropertyDefinition>[]>;
    /**
     * The name of the hub.
     */
     ...
     * The strong IDs.
     */
    readonly strongIds?: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.StrongId>[]>;
    /**
     * The timestamp property name. Represents the time when the interaction or profile update happened.
     */
