...
export function getRelationship(args: GetRelationshipArgs, opts?: pulumi.InvokeOptions): Promise<GetRelationshipResult> {
    ...
    return pulumi.runtime.invoke("azurerm:customerinsights/preview:getRelationship", {
...
export interface GetRelationshipResult {
     ...
     */
    readonly fields?: outputs.customerinsights.preview.PropertyDefinitionResponse[];
    /**
     * Optional property to be used to map fields in profile to their strong ids in related profile.
     */
    readonly lookupMappings?: outputs.customerinsights.preview.RelationshipTypeMappingResponse[];
    /**
     * Resource name.
     */
