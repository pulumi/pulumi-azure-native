...
export class RelationshipLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:RelationshipLink';
     ...
     */
    public readonly mappings!: pulumi.Output<outputs.customerinsights.preview.RelationshipLinkFieldMappingResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly profilePropertyReferences!: pulumi.Output<outputs.customerinsights.preview.ParticipantProfilePropertyReferenceResponse[]>;
    /**
     * Provisioning state.
     */
     ...
     */
    public readonly relatedProfilePropertyReferences!: pulumi.Output<outputs.customerinsights.preview.ParticipantProfilePropertyReferenceResponse[]>;
    /**
    ...
    constructor(name: string, args: RelationshipLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:RelationshipLink" }, { type: "azurerm:customerinsights/v20170101:RelationshipLink" }, { type: "azurerm:customerinsights/v20170426:RelationshipLink" }] };
...
export interface RelationshipLinkArgs {
     ...
     * The mappings between Interaction and Relationship fields.
     */
    readonly mappings?: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.RelationshipLinkFieldMapping>[]>;
    /**
     * The property references for the Profile of the Relationship.
     */
    readonly profilePropertyReferences: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.ParticipantProfilePropertyReference>[]>;
    /**
     * The property references for the Related Profile of the Relationship.
     */
    readonly relatedProfilePropertyReferences: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.ParticipantProfilePropertyReference>[]>;
    /**
     * The name of the relationship link.
     */
