...
export function getConnectorMapping(args: GetConnectorMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectorMappingResult> {
    ...
    return pulumi.runtime.invoke("azurerm:customerinsights/preview:getConnectorMapping", {
...
export interface GetConnectorMappingResult {
     ...
     */
    readonly mappingProperties: outputs.customerinsights.preview.ConnectorMappingPropertiesResponse;
    /**
     * Resource name.
     */
