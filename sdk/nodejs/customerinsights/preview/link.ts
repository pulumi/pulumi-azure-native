...
export class Link extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:Link';
     ...
     */
    public readonly mappings!: pulumi.Output<outputs.customerinsights.preview.TypePropertiesMappingResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly participantPropertyReferences!: pulumi.Output<outputs.customerinsights.preview.ParticipantPropertyReferenceResponse[]>;
    /**
     * Provisioning state.
     */
    ...
    constructor(name: string, args: LinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Link" }, { type: "azurerm:customerinsights/v20170101:Link" }, { type: "azurerm:customerinsights/v20170426:Link" }] };
...
export interface LinkArgs {
     ...
     * The set of properties mappings between the source and target Types.
     */
    readonly mappings?: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.TypePropertiesMapping>[]>;
    /**
     * Determines whether this link is supposed to create or delete instances if Link is NOT Reference Only.
     */
     ...
     * The properties that represent the participating profile.
     */
    readonly participantPropertyReferences: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.ParticipantPropertyReference>[]>;
    /**
     * Indicating whether the link is reference only link. This flag is ignored if the Mappings are defined. If the mappings are not defined and it is set to true, links processing will not create or update profiles.
     */
