...
export class ConnectorMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:ConnectorMapping';
     ...
     */
    public readonly mappingProperties!: pulumi.Output<outputs.customerinsights.preview.ConnectorMappingPropertiesResponse>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: ConnectorMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:ConnectorMapping" }, { type: "azurerm:customerinsights/v20170101:ConnectorMapping" }, { type: "azurerm:customerinsights/v20170426:ConnectorMapping" }] };
...
export interface ConnectorMappingArgs {
     ...
     * The properties of the mapping.
     */
    readonly mappingProperties: pulumi.Input<inputs.customerinsights.preview.ConnectorMappingProperties>;
    /**
