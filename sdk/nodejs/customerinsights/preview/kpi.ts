...
export class Kpi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:Kpi';
     ...
     * The aliases.
     */
    public readonly aliases!: pulumi.Output<outputs.customerinsights.preview.KpiAliasResponse[] | undefined>;
    /**
     ...
     * The KPI extracts.
     */
    public readonly extracts!: pulumi.Output<outputs.customerinsights.preview.KpiExtractResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly groupByMetadata!: pulumi.Output<outputs.customerinsights.preview.KpiGroupByMetadataResponse[]>;
    /**
     * The KPI name.
     */
     ...
     */
    public /*out*/ readonly participantProfilesMetadata!: pulumi.Output<outputs.customerinsights.preview.KpiParticipantProfilesMetadataResponse[]>;
    /**
     * Provisioning state.
     */
     ...
     * The KPI thresholds.
     */
    public readonly thresHolds!: pulumi.Output<outputs.customerinsights.preview.KpiThresholdsResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: KpiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Kpi" }, { type: "azurerm:customerinsights/v20170101:Kpi" }, { type: "azurerm:customerinsights/v20170426:Kpi" }] };
...
export interface KpiArgs {
     ...
     * The aliases.
     */
    readonly aliases?: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.KpiAlias>[]>;
    /**
     * The calculation window.
     */
     ...
     * The KPI extracts.
     */
    readonly extracts?: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.KpiExtract>[]>;
    /**
     * The filter expression for the KPI.
     */
     ...
     * The KPI thresholds.
     */
    readonly thresHolds?: pulumi.Input<inputs.customerinsights.preview.KpiThresholds>;
    /**
     * The unit of measurement for the KPI.
     */
