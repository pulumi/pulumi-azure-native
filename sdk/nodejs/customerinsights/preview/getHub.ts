...
export function getHub(args: GetHubArgs, opts?: pulumi.InvokeOptions): Promise<GetHubResult> {
    ...
    return pulumi.runtime.invoke("azurerm:customerinsights/preview:getHub", {
...
export interface GetHubResult {
     ...
     */
    readonly hubBillingInfo?: outputs.customerinsights.preview.HubBillingInfoFormatResponse;
    /**
     * Resource location.
     */
