...
export class View extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:View';
    ...
    constructor(name: string, argsOrState?: ViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:View" }, { type: "azurerm:customerinsights/v20170101:View" }, { type: "azurerm:customerinsights/v20170426:View" }] };
