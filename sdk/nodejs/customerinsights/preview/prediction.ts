...
export class Prediction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:Prediction';
     ...
     */
    public readonly grades!: pulumi.Output<outputs.customerinsights.preview.PredictionResponseGrades[] | undefined>;
    /**
     ...
     */
    public readonly mappings!: pulumi.Output<outputs.customerinsights.preview.PredictionResponseMappings>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly systemGeneratedEntities!: pulumi.Output<outputs.customerinsights.preview.PredictionResponseSystemGeneratedEntities>;
    /**
     * The hub name.
     */
    ...
    constructor(name: string, args: PredictionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Prediction" }, { type: "azurerm:customerinsights/v20170426:Prediction" }] };
...
export interface PredictionArgs {
     ...
     * The prediction grades.
     */
    readonly grades?: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.PredictionGrades>[]>;
    /**
     * The name of the hub.
     */
     ...
     * Definition of the link mapping of prediction.
     */
    readonly mappings: pulumi.Input<inputs.customerinsights.preview.PredictionMappings>;
    /**
     * Negative outcome expression.
     */
