...
export class Relationship extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:Relationship';
     ...
     */
    public readonly lookupMappings!: pulumi.Output<outputs.customerinsights.preview.RelationshipTypeMappingResponse[] | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, argsOrState?: RelationshipArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Relationship" }, { type: "azurerm:customerinsights/v20170101:Relationship" }, { type: "azurerm:customerinsights/v20170426:Relationship" }] };
...
export interface RelationshipArgs {
     ...
     * Optional property to be used to map fields in profile to their strong ids in related profile.
     */
    readonly lookupMappings?: pulumi.Input<pulumi.Input<inputs.customerinsights.preview.RelationshipTypeMapping>[]>;
    /**
     * Profile type.
     */
