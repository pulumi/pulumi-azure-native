...
export function getPrediction(args: GetPredictionArgs, opts?: pulumi.InvokeOptions): Promise<GetPredictionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:customerinsights/preview:getPrediction", {
...
export interface GetPredictionResult {
     ...
     */
    readonly grades?: outputs.customerinsights.preview.PredictionResponseGrades[];
    /**
     ...
     */
    readonly mappings: outputs.customerinsights.preview.PredictionResponseMappings;
    /**
     * Resource name.
     */
     ...
     */
    readonly systemGeneratedEntities: outputs.customerinsights.preview.PredictionResponseSystemGeneratedEntities;
    /**
     * The hub name.
     */
