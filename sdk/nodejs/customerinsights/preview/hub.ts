...
export class Hub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customerinsights/preview:Hub';
     ...
     */
    public readonly hubBillingInfo!: pulumi.Output<outputs.customerinsights.preview.HubBillingInfoFormatResponse | undefined>;
    /**
     * Resource location.
     */
    ...
    constructor(name: string, args: HubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customerinsights/latest:Hub" }, { type: "azurerm:customerinsights/v20170101:Hub" }, { type: "azurerm:customerinsights/v20170426:Hub" }] };
...
export interface HubArgs {
     ...
     * Billing settings of the hub.
     */
    readonly hubBillingInfo?: pulumi.Input<inputs.customerinsights.preview.HubBillingInfoFormat>;
    /**
     * The name of the Hub.
     */
