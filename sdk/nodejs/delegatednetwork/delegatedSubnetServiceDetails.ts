...
export class DelegatedSubnetServiceDetails extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.delegatednetwork.DelegatedSubnetPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: DelegatedSubnetServiceDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:delegatednetwork:DelegatedSubnetServiceDetails" }, { type: "azure-native:delegatednetwork/v20200808preview:DelegatedSubnetServiceDetails" }, { type: "azure-nextgen:delegatednetwork/v20200808preview:DelegatedSubnetServiceDetails" }, { type: "azure-native:delegatednetwork/v20210315:DelegatedSubnetServiceDetails" }, { type: "azure-nextgen:delegatednetwork/v20210315:DelegatedSubnetServiceDetails" }] };
...
export interface DelegatedSubnetServiceDetailsArgs {
     ...
     * Properties of the provision operation request.
     */
    readonly properties?: pulumi.Input<inputs.delegatednetwork.DelegatedSubnetPropertiesArgs>;
    /**
