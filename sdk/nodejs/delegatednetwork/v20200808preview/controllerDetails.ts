...
export class ControllerDetails extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ControllerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:delegatednetwork/v20200808preview:ControllerDetails" }, { type: "azure-native:delegatednetwork:ControllerDetails" }, { type: "azure-nextgen:delegatednetwork:ControllerDetails" }, { type: "azure-native:delegatednetwork/latest:ControllerDetails" }, { type: "azure-nextgen:delegatednetwork/latest:ControllerDetails" }, { type: "azure-native:delegatednetwork/v20210315:ControllerDetails" }, { type: "azure-nextgen:delegatednetwork/v20210315:ControllerDetails" }] };
