...
export class ControllerDetails extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ControllerDetails {
        return new ControllerDetails(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: ControllerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ControllerDetailsArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:delegatednetwork/preview:ControllerDetails" }] };
