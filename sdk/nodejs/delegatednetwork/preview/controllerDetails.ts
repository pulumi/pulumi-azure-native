...
export class ControllerDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:delegatednetwork/preview:ControllerDetails';
    ...
    constructor(name: string, argsOrState?: ControllerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:delegatednetwork/v20200808preview:ControllerDetails" }] };
...
export interface ControllerDetailsArgs {
     ...
     */
    readonly kubernetesProperties?: pulumi.Input<pulumi.Input<inputs.delegatednetwork.preview.KubernetesProperties>[]>;
    /**
