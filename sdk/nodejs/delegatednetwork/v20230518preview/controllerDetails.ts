...
export class ControllerDetails extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ControllerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:delegatednetwork:ControllerDetails" }, { type: "azure-native:delegatednetwork/v20200808preview:ControllerDetails" }, { type: "azure-native:delegatednetwork/v20210315:ControllerDetails" }] };
...
export interface ControllerDetailsArgs {
     ...
     * The purpose of the dnc controller resource.
     */
    purpose?: pulumi.Input<string | enums.delegatednetwork.v20230518preview.ControllerPurpose>;
    /**
