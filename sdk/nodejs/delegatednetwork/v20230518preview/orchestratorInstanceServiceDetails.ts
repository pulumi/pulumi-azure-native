...
export class OrchestratorInstanceServiceDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:delegatednetwork/v20230518preview:OrchestratorInstanceServiceDetails';
     ...
     */
    public readonly controllerDetails!: pulumi.Output<outputs.delegatednetwork.v20230518preview.ControllerDetailsResponse>;
    /**
     * The identity of the orchestrator
     */
    public readonly identity!: pulumi.Output<outputs.delegatednetwork.v20230518preview.OrchestratorIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: OrchestratorInstanceServiceDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:delegatednetwork:OrchestratorInstanceServiceDetails" }, { type: "azure-native:delegatednetwork/v20200808preview:OrchestratorInstanceServiceDetails" }, { type: "azure-native:delegatednetwork/v20210315:OrchestratorInstanceServiceDetails" }] };
...
export interface OrchestratorInstanceServiceDetailsArgs {
     ...
     * The identity of the orchestrator
     */
    identity?: pulumi.Input<inputs.delegatednetwork.v20230518preview.OrchestratorIdentityArgs>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
    kind: pulumi.Input<string | enums.delegatednetwork.v20230518preview.OrchestratorKind>;
    /**
     * Location of the resource.
     */
