...
export class OrchestratorInstanceServiceDetails extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrchestratorInstanceServiceDetails {
        pulumi.log.warn("OrchestratorInstanceServiceDetails is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:OrchestratorInstanceServiceDetails'.")
        return new OrchestratorInstanceServiceDetails(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:delegatednetwork/latest:OrchestratorInstanceServiceDetails';
     ...
     */
    public readonly controllerDetails!: pulumi.Output<outputs.delegatednetwork.latest.ControllerDetailsResponse>;
    /**
     * The identity of the orchestrator
     */
    public readonly identity!: pulumi.Output<outputs.delegatednetwork.latest.OrchestratorIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: OrchestratorInstanceServiceDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:delegatednetwork/latest:OrchestratorInstanceServiceDetails" }, { type: "azure-native:delegatednetwork:OrchestratorInstanceServiceDetails" }, { type: "azure-nextgen:delegatednetwork:OrchestratorInstanceServiceDetails" }, { type: "azure-native:delegatednetwork/v20200808preview:OrchestratorInstanceServiceDetails" }, { type: "azure-nextgen:delegatednetwork/v20200808preview:OrchestratorInstanceServiceDetails" }, { type: "azure-native:delegatednetwork/v20210315:OrchestratorInstanceServiceDetails" }, { type: "azure-nextgen:delegatednetwork/v20210315:OrchestratorInstanceServiceDetails" }] };
...
export interface OrchestratorInstanceServiceDetailsArgs {
     ...
     * Properties of the controller.
     */
    readonly controllerDetails: pulumi.Input<inputs.delegatednetwork.latest.ControllerDetails>;
    /**
     * The identity of the orchestrator
     */
    readonly identity?: pulumi.Input<inputs.delegatednetwork.latest.OrchestratorIdentity>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
    readonly kind: pulumi.Input<string | enums.delegatednetwork.latest.OrchestratorKind>;
    /**
     * Location of the resource.
     */
