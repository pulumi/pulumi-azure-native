...
export class StorageTask extends pulumi.CustomResource {
     ...
     */
    public readonly action!: pulumi.Output<outputs.storagetasks.StorageTaskActionResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.storagetasks.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.storagetasks.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface StorageTaskArgs {
     ...
     * The storage task action that is executed
     */
    action: pulumi.Input<inputs.storagetasks.StorageTaskActionArgs>;
    /**
     * Text that describes the purpose of the storage task
     */
     ...
     * The managed service identity of the resource.
     */
    identity?: pulumi.Input<inputs.storagetasks.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
