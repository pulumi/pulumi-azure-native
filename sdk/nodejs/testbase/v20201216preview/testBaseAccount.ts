...
export class TestBaseAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TestBaseAccount {
        pulumi.log.warn("TestBaseAccount is deprecated: Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.")
        return new TestBaseAccount(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20201216preview:TestBaseAccount';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.testbase.v20201216preview.TestBaseAccountSKUResponse>;
    /**
    ...
    constructor(name: string, args: TestBaseAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase:TestBaseAccount" }, { type: "azure-native:testbase/v20220401preview:TestBaseAccount" }] };
...
export interface TestBaseAccountArgs {
     ...
     * The SKU of the Test Base Account.
     */
    sku: pulumi.Input<inputs.testbase.v20201216preview.TestBaseAccountSKUArgs>;
    /**
     * The tags of the resource.
     */
