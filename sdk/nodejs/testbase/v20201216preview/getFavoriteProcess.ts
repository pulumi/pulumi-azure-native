...
export function getFavoriteProcess(args: GetFavoriteProcessArgs, opts?: pulumi.InvokeOptions): Promise<GetFavoriteProcessResult> {
    pulumi.log.warn("getFavoriteProcess is deprecated: Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.")
    if (!opts) {
        opts = {}
    }
