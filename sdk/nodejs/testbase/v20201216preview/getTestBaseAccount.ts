...
export function getTestBaseAccount(args: GetTestBaseAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetTestBaseAccountResult> {
    pulumi.log.warn("getTestBaseAccount is deprecated: Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.")
    if (!opts) {
        opts = {}
    }
