 ...
 *
 * @deprecated Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.
 */
export class CustomerEvent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomerEvent {
        pulumi.log.warn("CustomerEvent is deprecated: Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.")
        return new CustomerEvent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20201216preview:CustomerEvent';
     ...
     */
    public readonly receivers!: pulumi.Output<outputs.testbase.v20201216preview.NotificationEventReceiverResponse[]>;
    /**
...
export interface CustomerEventArgs {
     ...
     * The notification event receivers.
     */
    receivers: pulumi.Input<pulumi.Input<inputs.testbase.v20201216preview.NotificationEventReceiverArgs>[]>;
    /**
