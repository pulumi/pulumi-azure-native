...
export function getPackage(args: GetPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetPackageResult> {
    pulumi.log.warn("getPackage is deprecated: Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.")
    if (!opts) {
        opts = {}
    }
