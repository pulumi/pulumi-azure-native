...
export class TestBaseAccount extends pulumi.CustomResource {
     ...
     */
    declare public readonly sku: pulumi.Output<outputs.testbase.TestBaseAccountSKUResponse>;
    /**
...
export interface TestBaseAccountArgs {
     ...
     * The identity of the testBaseAccount.
     */
    identity?: pulumi.Input<inputs.testbase.SystemAssignedServiceIdentityArgs | undefined>;
    /**
     * The geo-location where the resource lives
     */
