 ...
 *
 * const customerEvent = new azure_native.testbase.v20220401preview.CustomerEvent("customerEvent", {
...
export class CustomerEvent extends pulumi.CustomResource {
     ...
     */
    public readonly receivers!: pulumi.Output<outputs.testbase.v20220401preview.NotificationEventReceiverResponse[]>;
    /**
