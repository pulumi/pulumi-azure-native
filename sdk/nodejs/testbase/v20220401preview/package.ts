...
export class Package extends pulumi.CustomResource {
     ...
     */
    public readonly targetOSList!: pulumi.Output<outputs.testbase.v20220401preview.TargetOSInfoResponse[]>;
    /**
     ...
     */
    public readonly tests!: pulumi.Output<outputs.testbase.v20220401preview.TestResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly validationResults!: pulumi.Output<outputs.testbase.v20220401preview.PackageValidationResultResponse[]>;
    /**
     * Application version
     */
    ...
    constructor(name: string, args: PackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase/v20201216preview:Package" }, { type: "azure-native:testbase/v20231101preview:Package" }, { type: "azure-native:testbase:Package" }] };
