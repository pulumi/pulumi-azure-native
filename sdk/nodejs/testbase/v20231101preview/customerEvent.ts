...
export class CustomerEvent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20231101preview:CustomerEvent';
     ...
     */
    public readonly receivers!: pulumi.Output<outputs.testbase.v20231101preview.NotificationEventReceiverResponse[]>;
    /**
    ...
    constructor(name: string, args: CustomerEventArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase/v20201216preview:CustomerEvent" }, { type: "azure-native:testbase/v20220401preview:CustomerEvent" }, { type: "azure-native:testbase:CustomerEvent" }] };
...
export interface CustomerEventArgs {
     ...
     * The notification event receivers.
     */
    receivers: pulumi.Input<pulumi.Input<inputs.testbase.v20231101preview.NotificationEventReceiverArgs>[]>;
    /**
