...
export class CustomImage extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly validationResults!: pulumi.Output<outputs.testbase.v20231101preview.ImageValidationResultsResponse>;
    /**
     * Image version name.
     */
...
export interface CustomImageArgs {
     ...
     * Custom image source type.
     */
    source: pulumi.Input<string | enums.testbase.v20231101preview.ImageSource>;
    /**
