...
export interface GetTestBaseAccountResult {
     ...
     */
    readonly identity?: outputs.testbase.v20231101preview.SystemAssignedServiceIdentityResponse;
    /**
     ...
     */
    readonly sku: outputs.testbase.v20231101preview.TestBaseAccountSKUResponse;
    /**
...
export function getTestBaseAccountOutput(args: GetTestBaseAccountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTestBaseAccountResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:testbase/v20231101preview:getTestBaseAccount", {
        "resourceGroupName": args.resourceGroupName,
        "testBaseAccountName": args.testBaseAccountName,
    }, opts);
}
