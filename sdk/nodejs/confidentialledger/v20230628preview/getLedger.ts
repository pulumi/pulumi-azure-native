...
export interface GetLedgerResult {
     ...
     */
    readonly properties: outputs.confidentialledger.v20230628preview.LedgerPropertiesResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.confidentialledger.v20230628preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getLedgerOutput(args: GetLedgerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLedgerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:confidentialledger/v20230628preview:getLedger", {
        "ledgerName": args.ledgerName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
