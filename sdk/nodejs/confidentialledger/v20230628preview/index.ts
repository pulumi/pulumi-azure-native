...
// Export enums:
export * from "../../types/enums/confidentialledger/v20230628preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:confidentialledger/v20230628preview:Ledger":
                return new Ledger(name, <any>undefined, { urn })
            case "azure-native:confidentialledger/v20230628preview:ManagedCCF":
...
pulumi.runtime.registerResourceModule("azure-native", "confidentialledger/v20230628preview", _module)
