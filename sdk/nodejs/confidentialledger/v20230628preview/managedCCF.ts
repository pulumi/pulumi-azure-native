...
export class ManagedCCF extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.confidentialledger.v20230628preview.ManagedCCFPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ManagedCCFArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:confidentialledger/v20220908preview:ManagedCCF" }, { type: "azure-native:confidentialledger/v20230126preview:ManagedCCF" }, { type: "azure-native:confidentialledger/v20240709preview:ManagedCCF" }, { type: "azure-native:confidentialledger/v20240919preview:ManagedCCF" }, { type: "azure-native:confidentialledger:ManagedCCF" }] };
...
export interface ManagedCCFArgs {
     ...
     * Properties of Managed CCF Resource.
     */
    properties?: pulumi.Input<inputs.confidentialledger.v20230628preview.ManagedCCFPropertiesArgs>;
    /**
