...
export function getManagedCCF(args: GetManagedCCFArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedCCFResult> {
    ...
    return pulumi.runtime.invoke("azure-native:confidentialledger/v20240709preview:getManagedCCF", {
...
export interface GetManagedCCFResult {
     ...
     */
    readonly properties: outputs.confidentialledger.v20240709preview.ManagedCCFPropertiesResponse;
    /**
