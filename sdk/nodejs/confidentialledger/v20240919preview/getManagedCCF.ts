...
export function getManagedCCF(args: GetManagedCCFArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedCCFResult> {
    ...
    return pulumi.runtime.invoke("azure-native:confidentialledger/v20240919preview:getManagedCCF", {
...
export interface GetManagedCCFResult {
     ...
     */
    readonly properties: outputs.confidentialledger.v20240919preview.ManagedCCFPropertiesResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.confidentialledger.v20240919preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getManagedCCFOutput(args: GetManagedCCFOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedCCFResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:confidentialledger/v20240919preview:getManagedCCF", {
        "appName": args.appName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
