...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:confidentialledger/v20220908preview:Ledger":
                return new Ledger(name, <any>undefined, { urn })
            case "azure-native:confidentialledger/v20220908preview:ManagedCCF":
...
pulumi.runtime.registerResourceModule("azure-native", "confidentialledger/v20220908preview", _module)
