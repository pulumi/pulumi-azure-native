...
export class ManagedCCF extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedCCF {
        pulumi.log.warn("ManagedCCF is deprecated: azure-native:confidentialledger/v20220908preview:ManagedCCF is being removed in the next major version of this provider. Upgrade to at least azure-native:confidentialledger/v20230126preview:ManagedCCF to guarantee forwards compatibility.")
        return new ManagedCCF(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:confidentialledger/v20220908preview:ManagedCCF';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.confidentialledger.v20220908preview.ManagedCCFPropertiesResponse>;
    /**
...
export interface ManagedCCFArgs {
     ...
     * Properties of Managed CCF Resource.
     */
    properties?: pulumi.Input<inputs.confidentialledger.v20220908preview.ManagedCCFPropertiesArgs>;
    /**
