 ...
 *
 * @deprecated azure-native:confidentialledger/v20220513:Ledger is being removed in the next major version of this provider. Please upgrade to azure-native:confidentialledger/v20230126preview:Ledger to guarantee forwards compatibility.
 */
export class Ledger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:confidentialledger/v20220513:Ledger';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.confidentialledger.v20220513.LedgerPropertiesResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.confidentialledger.v20220513.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: LedgerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:confidentialledger:Ledger" }, { type: "azure-native:confidentialledger/v20201201preview:Ledger" }, { type: "azure-native:confidentialledger/v20210513preview:Ledger" }, { type: "azure-native:confidentialledger/v20220908preview:Ledger" }, { type: "azure-native:confidentialledger/v20230126preview:Ledger" }] };
...
export interface LedgerArgs {
     ...
     * Properties of Confidential Ledger Resource.
     */
    properties?: pulumi.Input<inputs.confidentialledger.v20220513.LedgerPropertiesArgs>;
    /**
