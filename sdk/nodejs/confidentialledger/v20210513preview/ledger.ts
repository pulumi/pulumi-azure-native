...
export class Ledger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ledger {
        pulumi.log.warn("Ledger is deprecated: azure-native:confidentialledger/v20210513preview:Ledger is being removed in the next major version of this provider. Upgrade to at least azure-native:confidentialledger/v20230126preview:Ledger to guarantee forwards compatibility.")
        return new Ledger(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:confidentialledger/v20210513preview:Ledger';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.confidentialledger.v20210513preview.LedgerPropertiesResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.confidentialledger.v20210513preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: LedgerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:confidentialledger:Ledger" }, { type: "azure-native:confidentialledger/v20201201preview:Ledger" }, { type: "azure-native:confidentialledger/v20220513:Ledger" }, { type: "azure-native:confidentialledger/v20220908preview:Ledger" }, { type: "azure-native:confidentialledger/v20230126preview:Ledger" }] };
...
export interface LedgerArgs {
     ...
     * Properties of Confidential Ledger Resource.
     */
    properties?: pulumi.Input<inputs.confidentialledger.v20210513preview.LedgerPropertiesArgs>;
    /**
