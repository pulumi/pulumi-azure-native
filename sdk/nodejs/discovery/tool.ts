...
export class Tool extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Tool {
        return new Tool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:discovery:Tool';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.discovery.ToolPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ToolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:discovery/v20260201preview:Tool" }, { type: "azure-native:discovery/v20260601:Tool" }] };
