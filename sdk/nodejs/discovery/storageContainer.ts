...
export class StorageContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:discovery:StorageContainer';
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.discovery.StorageContainerPropertiesResponse>;
    /**
...
export interface StorageContainerArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.discovery.StorageContainerPropertiesArgs | undefined>;
    /**
