...
export class RetentionPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.durabletask.RetentionPolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RetentionPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:durabletask/v20250401preview:RetentionPolicy" }, { type: "azure-native:durabletask/v20251101:RetentionPolicy" }, { type: "azure-native:durabletask/v20260201:RetentionPolicy" }, { type: "azure-native:durabletask/v20260501preview:RetentionPolicy" }] };
