...
export class GroupQuota extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:quota/v20241015preview:GroupQuota';
     ...
     * Properties and filters for ShareQuota. The request parameter is optional, if there are no filters specified.
     */
    public readonly properties!: pulumi.Output<outputs.quota.v20241015preview.GroupQuotasEntityBaseResponse>;
    /**
    ...
    constructor(name: string, args: GroupQuotaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:quota/v20230601preview:GroupQuota" }, { type: "azure-native:quota/v20241218preview:GroupQuota" }, { type: "azure-native:quota/v20250301:GroupQuota" }, { type: "azure-native:quota/v20250315preview:GroupQuota" }, { type: "azure-native:quota:GroupQuota" }] };
...
export interface GroupQuotaArgs {
     ...
     * Properties and filters for ShareQuota. The request parameter is optional, if there are no filters specified.
     */
    properties?: pulumi.Input<inputs.quota.v20241015preview.GroupQuotasEntityBaseArgs>;
}
