...
export class GroupQuotaSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:quota/v20250315preview:GroupQuotaSubscription';
    ...
    public /*out*/ readonly properties!: pulumi.Output<outputs.quota.v20250315preview.GroupQuotaSubscriptionIdResponseProperties>;
    /**
    ...
    constructor(name: string, args: GroupQuotaSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:quota/v20230601preview:GroupQuotaSubscription" }, { type: "azure-native:quota/v20241015preview:GroupQuotaSubscription" }, { type: "azure-native:quota/v20241218preview:GroupQuotaSubscription" }, { type: "azure-native:quota/v20250301:GroupQuotaSubscription" }, { type: "azure-native:quota:GroupQuotaSubscription" }] };
