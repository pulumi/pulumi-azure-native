...
// Export enums:
export * from "../../types/enums/quota/v20250315preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:quota/v20250315preview:GroupQuota":
                return new GroupQuota(name, <any>undefined, { urn })
            case "azure-native:quota/v20250315preview:GroupQuotaSubscription":
...
pulumi.runtime.registerResourceModule("azure-native", "quota/v20250315preview", _module)
