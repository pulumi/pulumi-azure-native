...
export class GroupQuota extends pulumi.CustomResource {
     ...
     * Properties and filters for ShareQuota. The request parameter is optional, if there are no filters specified.
     */
    public readonly properties!: pulumi.Output<outputs.quota.v20230601preview.GroupQuotasEntityBaseResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.quota.v20230601preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: GroupQuotaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:quota/v20241015preview:GroupQuota" }, { type: "azure-native:quota/v20241218preview:GroupQuota" }, { type: "azure-native:quota/v20250301:GroupQuota" }, { type: "azure-native:quota:GroupQuota" }] };
