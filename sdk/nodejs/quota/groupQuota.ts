...
export class GroupQuota extends pulumi.CustomResource {
    ...
    declare public readonly properties: pulumi.Output<outputs.quota.GroupQuotasEntityResponseProperties>;
    /**
    ...
    constructor(name: string, args: GroupQuotaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:quota/v20230601preview:GroupQuota" }, { type: "azure-native:quota/v20241015preview:GroupQuota" }, { type: "azure-native:quota/v20241218preview:GroupQuota" }, { type: "azure-native:quota/v20250301:GroupQuota" }, { type: "azure-native:quota/v20250315preview:GroupQuota" }, { type: "azure-native:quota/v20250715:GroupQuota" }, { type: "azure-native:quota/v20250901:GroupQuota" }, { type: "azure-native:quota/v20260901preview:GroupQuota" }] };
