...
export class GroupQuota extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:quota/v20241218preview:GroupQuota';
    ...
    public readonly properties!: pulumi.Output<outputs.quota.v20241218preview.GroupQuotasEntityResponseProperties>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.quota.v20241218preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: GroupQuotaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:quota/v20230601preview:GroupQuota" }, { type: "azure-native:quota/v20241015preview:GroupQuota" }, { type: "azure-native:quota/v20250301:GroupQuota" }, { type: "azure-native:quota/v20250315preview:GroupQuota" }, { type: "azure-native:quota:GroupQuota" }] };
...
export interface GroupQuotaArgs {
    ...
    properties?: pulumi.Input<inputs.quota.v20241218preview.GroupQuotasEntityPropertiesArgs>;
}
