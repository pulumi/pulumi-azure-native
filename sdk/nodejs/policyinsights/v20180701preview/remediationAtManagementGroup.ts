...
export class RemediationAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:policyinsights/v20180701preview:RemediationAtManagementGroup';
    ...
    constructor(name: string, args: RemediationAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtManagementGroup" }, { type: "azurerm:policyinsights/preview:RemediationAtManagementGroup" }, { type: "azurerm:policyinsights/v20190701:RemediationAtManagementGroup" }] };
