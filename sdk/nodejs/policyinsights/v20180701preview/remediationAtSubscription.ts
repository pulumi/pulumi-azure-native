...
export class RemediationAtSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:policyinsights/v20180701preview:RemediationAtSubscription';
    ...
    constructor(name: string, argsOrState?: RemediationAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtSubscription" }, { type: "azurerm:policyinsights/preview:RemediationAtSubscription" }, { type: "azurerm:policyinsights/v20190701:RemediationAtSubscription" }] };
