...
export class RemediationAtResourceGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RemediationAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtResourceGroup" }, { type: "azurerm:policyinsights/preview:RemediationAtResourceGroup" }, { type: "azurerm:policyinsights/v20190701:RemediationAtResourceGroup" }] };
