 ...
 *
 * const remediationAtResourceGroup = new azurerm.policyinsights.v20180701preview.RemediationAtResourceGroup("remediationAtResourceGroup", {
...
export class RemediationAtResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:policyinsights/v20180701preview:RemediationAtResourceGroup';
    ...
    constructor(name: string, args: RemediationAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtResourceGroup" }, { type: "azurerm:policyinsights/v20190701:RemediationAtResourceGroup" }] };
