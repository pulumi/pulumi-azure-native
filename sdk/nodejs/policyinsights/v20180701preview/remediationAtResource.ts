 ...
 *
 * const remediationAtResource = new azurerm.policyinsights.v20180701preview.RemediationAtResource("remediationAtResource", {
...
export class RemediationAtResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:policyinsights/v20180701preview:RemediationAtResource';
    ...
    constructor(name: string, args: RemediationAtResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtResource" }, { type: "azurerm:policyinsights/v20190701:RemediationAtResource" }] };
