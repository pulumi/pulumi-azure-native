 ...
 *
 * const attestationAtSubscription = new azure_native.policyinsights.v20220901.AttestationAtSubscription("attestationAtSubscription", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:policyinsights/v20220901:AttestationAtSubscription 790996e6-9871-4b1f-9cd9-ec42cd6ced1e /subscriptions/35ee058e-5fa0-414c-8145-3ebb8d09b6e2/providers/microsoft.policyinsights/attestations/790996e6-9871-4b1f-9cd9-ec42cd6ced1e 
 * ```
 */
export class AttestationAtSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:policyinsights/v20220901:AttestationAtSubscription';
     ...
     */
    public readonly evidence!: pulumi.Output<outputs.policyinsights.v20220901.AttestationEvidenceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: AttestationAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights:AttestationAtSubscription" }, { type: "azure-native:policyinsights/v20210101:AttestationAtSubscription" }] };
