...
export class AttestationAtSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AttestationAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights:AttestationAtSubscription" }, { type: "azure-native:policyinsights/v20220901:AttestationAtSubscription" }, { type: "azure-native:policyinsights/v20241001:AttestationAtSubscription" }] };
