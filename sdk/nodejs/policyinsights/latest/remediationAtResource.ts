 ...
 *
 * const remediationAtResource = new azurerm.policyinsights.latest.RemediationAtResource("remediationAtResource", {
...
export class RemediationAtResource extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: RemediationAtResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/v20190701:RemediationAtResource" }] };
