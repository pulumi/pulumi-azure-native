 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtResource'.
 */
export class AttestationAtResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:policyinsights/latest:AttestationAtResource';
    ...
    constructor(name: string, args: AttestationAtResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights:AttestationAtResource" }, { type: "azure-nextgen:policyinsights:AttestationAtResource" }, { type: "azure-native:policyinsights/v20210101:AttestationAtResource" }, { type: "azure-nextgen:policyinsights/v20210101:AttestationAtResource" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(AttestationAtResource.__pulumiType, name, inputs, opts);
    }
}
