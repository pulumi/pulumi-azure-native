 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtSubscription'.
 */
export class AttestationAtSubscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AttestationAtSubscription {
        pulumi.log.warn("AttestationAtSubscription is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtSubscription'.")
        return new AttestationAtSubscription(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:policyinsights/latest:AttestationAtSubscription';
     ...
     */
    public readonly evidence!: pulumi.Output<outputs.policyinsights.latest.AttestationEvidenceResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.policyinsights.latest.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: AttestationAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:policyinsights/latest:AttestationAtSubscription" }, { type: "azure-native:policyinsights:AttestationAtSubscription" }, { type: "azure-nextgen:policyinsights:AttestationAtSubscription" }, { type: "azure-native:policyinsights/v20210101:AttestationAtSubscription" }, { type: "azure-nextgen:policyinsights/v20210101:AttestationAtSubscription" }] };
...
export interface AttestationAtSubscriptionArgs {
     ...
     * The compliance state that should be set on the resource.
     */
    readonly complianceState?: pulumi.Input<string | enums.policyinsights.latest.ComplianceState>;
    /**
     * The evidence supporting the compliance state set in this attestation.
     */
    readonly evidence?: pulumi.Input<pulumi.Input<inputs.policyinsights.latest.AttestationEvidence>[]>;
    /**
     * The time the compliance state should expire.
     */
