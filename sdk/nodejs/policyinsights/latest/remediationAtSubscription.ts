...
export class RemediationAtSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:policyinsights/latest:RemediationAtSubscription';
    ...
    constructor(name: string, args: RemediationAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/preview:RemediationAtSubscription" }, { type: "azurerm:policyinsights/v20180701preview:RemediationAtSubscription" }, { type: "azurerm:policyinsights/v20190701:RemediationAtSubscription" }] };
