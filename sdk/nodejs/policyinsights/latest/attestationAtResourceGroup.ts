...
export class AttestationAtResourceGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AttestationAtResourceGroup {
        pulumi.log.warn("AttestationAtResourceGroup is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtResourceGroup'.")
        return new AttestationAtResourceGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:policyinsights/latest:AttestationAtResourceGroup';
    ...
    constructor(name: string, args: AttestationAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:policyinsights/latest:AttestationAtResourceGroup" }, { type: "azure-native:policyinsights:AttestationAtResourceGroup" }, { type: "azure-nextgen:policyinsights:AttestationAtResourceGroup" }, { type: "azure-native:policyinsights/v20210101:AttestationAtResourceGroup" }, { type: "azure-nextgen:policyinsights/v20210101:AttestationAtResourceGroup" }] };
