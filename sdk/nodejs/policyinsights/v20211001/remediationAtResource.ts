...
export class RemediationAtResource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RemediationAtResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights/v20180701preview:RemediationAtResource" }, { type: "azure-native:policyinsights/v20190701:RemediationAtResource" }, { type: "azure-native:policyinsights/v20241001:RemediationAtResource" }, { type: "azure-native:policyinsights:RemediationAtResource" }] };
