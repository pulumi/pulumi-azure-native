...
export class AttestationAtSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AttestationAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights/latest:AttestationAtSubscription" }, { type: "azure-nextgen:policyinsights/latest:AttestationAtSubscription" }, { type: "azure-native:policyinsights/v20210101:AttestationAtSubscription" }, { type: "azure-nextgen:policyinsights/v20210101:AttestationAtSubscription" }] };
