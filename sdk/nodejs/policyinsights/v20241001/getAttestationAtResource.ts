...
export function getAttestationAtResource(args: GetAttestationAtResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetAttestationAtResourceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:policyinsights/v20241001:getAttestationAtResource", {
...
export interface GetAttestationAtResourceResult {
     ...
     */
    readonly evidence?: outputs.policyinsights.v20241001.AttestationEvidenceResponse[];
    /**
...
export function getAttestationAtResourceOutput(args: GetAttestationAtResourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAttestationAtResourceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:policyinsights/v20241001:getAttestationAtResource", {
        "attestationName": args.attestationName,
        "resourceId": args.resourceId,
    }, opts);
}
