...
export class RemediationAtResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:policyinsights/v20241001:RemediationAtResourceGroup';
     ...
     */
    public /*out*/ readonly deploymentStatus!: pulumi.Output<outputs.policyinsights.v20241001.RemediationDeploymentSummaryResponse>;
    /**
     * The remediation failure threshold settings
     */
    public readonly failureThreshold!: pulumi.Output<outputs.policyinsights.v20241001.RemediationPropertiesResponseFailureThreshold | undefined>;
    /**
     * The filters that will be applied to determine which resources to remediate.
     */
    public readonly filters!: pulumi.Output<outputs.policyinsights.v20241001.RemediationFiltersResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.policyinsights.v20241001.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: RemediationAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights:RemediationAtResourceGroup" }, { type: "azure-native:policyinsights/v20180701preview:RemediationAtResourceGroup" }, { type: "azure-native:policyinsights/v20190701:RemediationAtResourceGroup" }, { type: "azure-native:policyinsights/v20211001:RemediationAtResourceGroup" }] };
...
export interface RemediationAtResourceGroupArgs {
     ...
     * The remediation failure threshold settings
     */
    failureThreshold?: pulumi.Input<inputs.policyinsights.v20241001.RemediationPropertiesFailureThresholdArgs>;
    /**
     * The filters that will be applied to determine which resources to remediate.
     */
    filters?: pulumi.Input<inputs.policyinsights.v20241001.RemediationFiltersArgs>;
    /**
     * Determines how many resources to remediate at any given time. Can be used to increase or reduce the pace of the remediation. If not provided, the default parallel deployments value is used.
     */
     ...
     * The way resources to remediate are discovered. Defaults to ExistingNonCompliant if not specified.
     */
    resourceDiscoveryMode?: pulumi.Input<string | enums.policyinsights.v20241001.ResourceDiscoveryMode>;
    /**
     * Resource group name.
     */
