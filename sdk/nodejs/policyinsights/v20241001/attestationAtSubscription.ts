...
export class AttestationAtSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:policyinsights/v20241001:AttestationAtSubscription';
     ...
     */
    public readonly evidence!: pulumi.Output<outputs.policyinsights.v20241001.AttestationEvidenceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: AttestationAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights:AttestationAtSubscription" }, { type: "azure-native:policyinsights/v20210101:AttestationAtSubscription" }, { type: "azure-native:policyinsights/v20220901:AttestationAtSubscription" }] };
...
export interface AttestationAtSubscriptionArgs {
     ...
     * The compliance state that should be set on the resource.
     */
    complianceState?: pulumi.Input<string | enums.policyinsights.v20241001.ComplianceState>;
    /**
     * The evidence supporting the compliance state set in this attestation.
     */
    evidence?: pulumi.Input<pulumi.Input<inputs.policyinsights.v20241001.AttestationEvidenceArgs>[]>;
    /**
     * The time the compliance state should expire.
     */
