...
export class RemediationAtManagementGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: RemediationAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtManagementGroup" }, { type: "azurerm:policyinsights/preview:RemediationAtManagementGroup" }, { type: "azurerm:policyinsights/v20180701preview:RemediationAtManagementGroup" }] };
