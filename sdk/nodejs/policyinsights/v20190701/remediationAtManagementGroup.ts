...
export class RemediationAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:policyinsights/v20190701:RemediationAtManagementGroup';
    ...
    constructor(name: string, args: RemediationAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:policyinsights/v20190701:RemediationAtManagementGroup" }, { type: "azure-native:policyinsights:RemediationAtManagementGroup" }, { type: "azure-nextgen:policyinsights:RemediationAtManagementGroup" }, { type: "azure-native:policyinsights/latest:RemediationAtManagementGroup" }, { type: "azure-nextgen:policyinsights/latest:RemediationAtManagementGroup" }, { type: "azure-native:policyinsights/v20180701preview:RemediationAtManagementGroup" }, { type: "azure-nextgen:policyinsights/v20180701preview:RemediationAtManagementGroup" }] };
...
export interface RemediationAtManagementGroupArgs {
     ...
     * The way resources to remediate are discovered. Defaults to ExistingNonCompliant if not specified.
     */
    readonly resourceDiscoveryMode?: pulumi.Input<string | enums.policyinsights.v20190701.ResourceDiscoveryMode>;
}
