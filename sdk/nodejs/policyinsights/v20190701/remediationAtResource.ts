...
export class RemediationAtResource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RemediationAtResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtResource" }, { type: "azurerm:policyinsights/preview:RemediationAtResource" }, { type: "azurerm:policyinsights/v20180701preview:RemediationAtResource" }] };
