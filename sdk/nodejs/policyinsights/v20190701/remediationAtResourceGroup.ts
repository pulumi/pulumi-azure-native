...
export class RemediationAtResourceGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RemediationAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights:RemediationAtResourceGroup" }, { type: "azure-native:policyinsights/v20180701preview:RemediationAtResourceGroup" }, { type: "azure-native:policyinsights/v20211001:RemediationAtResourceGroup" }, { type: "azure-native:policyinsights/v20241001:RemediationAtResourceGroup" }] };
