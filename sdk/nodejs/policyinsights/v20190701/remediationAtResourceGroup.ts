 ...
 *
 * const remediationAtResourceGroup = new azurerm.policyinsights.v20190701.RemediationAtResourceGroup("remediationAtResourceGroup", {
...
export class RemediationAtResourceGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: RemediationAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtResourceGroup" }] };
