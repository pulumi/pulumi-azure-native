...
export class Remediation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Remediation {
        return new Remediation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:policyinsights:Remediation';
    ...
    constructor(name: string, argsOrState?: RemediationArgs, opts?: pulumi.CustomResourceOptions) {
