...
export class AttestationAtResourceGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AttestationAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights/latest:AttestationAtResourceGroup" }, { type: "azure-nextgen:policyinsights/latest:AttestationAtResourceGroup" }, { type: "azure-native:policyinsights/v20210101:AttestationAtResourceGroup" }, { type: "azure-nextgen:policyinsights/v20210101:AttestationAtResourceGroup" }] };
