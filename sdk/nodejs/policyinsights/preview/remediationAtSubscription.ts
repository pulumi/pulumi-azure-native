...
export class RemediationAtSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:policyinsights/preview:RemediationAtSubscription';
     ...
     */
    public /*out*/ readonly deploymentStatus!: pulumi.Output<outputs.policyinsights.preview.RemediationDeploymentSummaryResponse>;
    /**
     * The filters that will be applied to determine which resources to remediate.
     */
    public readonly filters!: pulumi.Output<outputs.policyinsights.preview.RemediationFiltersResponse | undefined>;
    /**
    ...
    constructor(name: string, args: RemediationAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:policyinsights/latest:RemediationAtSubscription" }, { type: "azurerm:policyinsights/v20180701preview:RemediationAtSubscription" }, { type: "azurerm:policyinsights/v20190701:RemediationAtSubscription" }] };
...
export interface RemediationAtSubscriptionArgs {
     ...
     * The filters that will be applied to determine which resources to remediate.
     */
    readonly filters?: pulumi.Input<inputs.policyinsights.preview.RemediationFilters>;
    /**
     * The resource ID of the policy assignment that should be remediated.
     */
