...
export function getRemediationAtManagementGroup(args: GetRemediationAtManagementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetRemediationAtManagementGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:policyinsights/preview:getRemediationAtManagementGroup", {
...
export interface GetRemediationAtManagementGroupResult {
     ...
     */
    readonly deploymentStatus: outputs.policyinsights.preview.RemediationDeploymentSummaryResponse;
    /**
     * The filters that will be applied to determine which resources to remediate.
     */
    readonly filters?: outputs.policyinsights.preview.RemediationFiltersResponse;
    /**
