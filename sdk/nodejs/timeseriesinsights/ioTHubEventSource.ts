...
export class IoTHubEventSource extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.timeseriesinsights.IoTHubEventSourceResourcePropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface IoTHubEventSourceArgs {
     ...
     */
    properties: pulumi.Input<inputs.timeseriesinsights.IoTHubEventSourceCreationPropertiesArgs>;
    /**
