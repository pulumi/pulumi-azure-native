...
export class ReferenceDataSet extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly keyProperties!: pulumi.Output<outputs.timeseriesinsights.ReferenceDataSetKeyPropertyResponse[]>;
    /**
     * Resource location
     */
...
export interface ReferenceDataSetArgs {
     ...
     */
    properties: pulumi.Input<inputs.timeseriesinsights.ReferenceDataSetCreationPropertiesArgs>;
    /**
