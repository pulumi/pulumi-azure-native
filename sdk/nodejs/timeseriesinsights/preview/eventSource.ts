...
export class EventSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:timeseriesinsights/preview:EventSource';
    ...
    constructor(name: string, args: EventSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:timeseriesinsights/latest:EventSource" }, { type: "azurerm:timeseriesinsights/v20170228preview:EventSource" }, { type: "azurerm:timeseriesinsights/v20171115:EventSource" }, { type: "azurerm:timeseriesinsights/v20180815preview:EventSource" }, { type: "azurerm:timeseriesinsights/v20200515:EventSource" }] };
...
export interface EventSourceArgs {
     ...
     */
    readonly localTimestamp?: pulumi.Input<inputs.timeseriesinsights.preview.LocalTimestamp>;
    /**
