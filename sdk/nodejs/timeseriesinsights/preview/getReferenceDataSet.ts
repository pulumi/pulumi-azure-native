...
export function getReferenceDataSet(args: GetReferenceDataSetArgs, opts?: pulumi.InvokeOptions): Promise<GetReferenceDataSetResult> {
    ...
    return pulumi.runtime.invoke("azurerm:timeseriesinsights/preview:getReferenceDataSet", {
...
export interface GetReferenceDataSetResult {
     ...
     */
    readonly keyProperties: outputs.timeseriesinsights.preview.ReferenceDataSetKeyPropertyResponse[];
    /**
     * Resource location
     */
