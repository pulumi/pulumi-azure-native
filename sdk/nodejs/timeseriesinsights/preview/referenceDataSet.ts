...
export class ReferenceDataSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:timeseriesinsights/preview:ReferenceDataSet';
     ...
     */
    public readonly keyProperties!: pulumi.Output<outputs.timeseriesinsights.preview.ReferenceDataSetKeyPropertyResponse[]>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, argsOrState?: ReferenceDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:timeseriesinsights/latest:ReferenceDataSet" }, { type: "azurerm:timeseriesinsights/v20170228preview:ReferenceDataSet" }, { type: "azurerm:timeseriesinsights/v20171115:ReferenceDataSet" }, { type: "azurerm:timeseriesinsights/v20180815preview:ReferenceDataSet" }, { type: "azurerm:timeseriesinsights/v20200515:ReferenceDataSet" }] };
...
export interface ReferenceDataSetArgs {
     ...
     * The list of key properties for the reference data set.
     */
    readonly keyProperties: pulumi.Input<pulumi.Input<inputs.timeseriesinsights.preview.ReferenceDataSetKeyProperty>[]>;
    /**
