...
export class EventSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:timeseriesinsights/v20210630preview:EventSource';
    ...
    constructor(name: string, args: EventSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights/v20210630preview:EventSource" }, { type: "azure-native:timeseriesinsights:EventSource" }, { type: "azure-nextgen:timeseriesinsights:EventSource" }, { type: "azure-native:timeseriesinsights/v20170228preview:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:EventSource" }, { type: "azure-native:timeseriesinsights/v20171115:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20171115:EventSource" }, { type: "azure-native:timeseriesinsights/v20180815preview:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20180815preview:EventSource" }, { type: "azure-native:timeseriesinsights/v20200515:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20200515:EventSource" }, { type: "azure-native:timeseriesinsights/v20210331preview:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20210331preview:EventSource" }] };
...
export interface EventSourceArgs {
     ...
     * The kind of the event source.
     */
    kind: pulumi.Input<string | enums.timeseriesinsights.v20210630preview.EventSourceKind>;
    /**
