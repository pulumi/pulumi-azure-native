...
export class Gen1Environment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.timeseriesinsights.v20210630preview.Gen1EnvironmentResourcePropertiesResponse>;
    /**
...
export interface Gen1EnvironmentArgs {
     ...
     */
    properties: pulumi.Input<inputs.timeseriesinsights.v20210630preview.Gen1EnvironmentCreationPropertiesArgs>;
    /**
