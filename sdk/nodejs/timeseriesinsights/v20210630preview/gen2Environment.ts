...
export class Gen2Environment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.timeseriesinsights.v20210630preview.Gen2EnvironmentResourcePropertiesResponse>;
    /**
...
export interface Gen2EnvironmentArgs {
     ...
     */
    properties: pulumi.Input<inputs.timeseriesinsights.v20210630preview.Gen2EnvironmentCreationPropertiesArgs>;
    /**
