...
export class ReferenceDataSet extends pulumi.CustomResource {
     ...
     */
    public readonly keyProperties!: pulumi.Output<outputs.timeseriesinsights.v20210630preview.ReferenceDataSetKeyPropertyResponse[]>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, args: ReferenceDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights/v20210630preview:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20170228preview:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20171115:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/v20171115:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20180815preview:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/v20180815preview:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20200515:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/v20200515:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20210331preview:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/v20210331preview:ReferenceDataSet" }] };
