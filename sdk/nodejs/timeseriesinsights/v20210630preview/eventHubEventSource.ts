...
export class EventHubEventSource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventHubEventSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:timeseriesinsights:EventHubEventSource" }, { type: "azure-native:timeseriesinsights/v20200515:EventHubEventSource" }, { type: "azure-native:timeseriesinsights/v20210331preview:EventHubEventSource" }] };
