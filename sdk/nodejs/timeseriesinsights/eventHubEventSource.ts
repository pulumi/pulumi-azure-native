...
export class EventHubEventSource extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.timeseriesinsights.EventHubEventSourceResourcePropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface EventHubEventSourceArgs {
     ...
     */
    properties: pulumi.Input<inputs.timeseriesinsights.EventHubEventSourceCreationPropertiesArgs>;
    /**
