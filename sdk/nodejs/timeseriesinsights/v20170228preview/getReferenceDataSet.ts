...
export function getReferenceDataSet(args: GetReferenceDataSetArgs, opts?: pulumi.InvokeOptions): Promise<GetReferenceDataSetResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:timeseriesinsights/v20170228preview:getReferenceDataSet", {
...
export interface GetReferenceDataSetResult {
     ...
     */
    readonly keyProperties: outputs.timeseriesinsights.v20170228preview.ReferenceDataSetKeyPropertyInvokeResponse[];
    /**
     * Resource location
     */
