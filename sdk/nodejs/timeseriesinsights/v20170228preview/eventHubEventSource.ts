...
export class EventHubEventSource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventHubEventSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights/v20170228preview:EventHubEventSource" }, { type: "azure-native:timeseriesinsights:EventHubEventSource" }, { type: "azure-nextgen:timeseriesinsights:EventHubEventSource" }, { type: "azure-native:timeseriesinsights/v20171115:EventHubEventSource" }, { type: "azure-nextgen:timeseriesinsights/v20171115:EventHubEventSource" }, { type: "azure-native:timeseriesinsights/v20180815preview:EventHubEventSource" }, { type: "azure-nextgen:timeseriesinsights/v20180815preview:EventHubEventSource" }, { type: "azure-native:timeseriesinsights/v20200515:EventHubEventSource" }, { type: "azure-nextgen:timeseriesinsights/v20200515:EventHubEventSource" }, { type: "azure-native:timeseriesinsights/v20210331preview:EventHubEventSource" }, { type: "azure-nextgen:timeseriesinsights/v20210331preview:EventHubEventSource" }, { type: "azure-native:timeseriesinsights/v20210630preview:EventHubEventSource" }, { type: "azure-nextgen:timeseriesinsights/v20210630preview:EventHubEventSource" }] };
