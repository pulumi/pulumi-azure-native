...
export class EventSource extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: EventSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:timeseriesinsights/latest:EventSource" }, { type: "azurerm:timeseriesinsights/preview:EventSource" }, { type: "azurerm:timeseriesinsights/v20171115:EventSource" }, { type: "azurerm:timeseriesinsights/v20180815preview:EventSource" }, { type: "azurerm:timeseriesinsights/v20200515:EventSource" }] };
