 ...
 *
 * const referenceDataSet = new azurerm.timeseriesinsights.v20170228preview.ReferenceDataSet("referenceDataSet", {
...
export class ReferenceDataSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:timeseriesinsights/v20170228preview:ReferenceDataSet';
    ...
    constructor(name: string, args: ReferenceDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:timeseriesinsights/latest:ReferenceDataSet" }, { type: "azurerm:timeseriesinsights/v20171115:ReferenceDataSet" }, { type: "azurerm:timeseriesinsights/v20180815preview:ReferenceDataSet" }, { type: "azurerm:timeseriesinsights/v20200515:ReferenceDataSet" }] };
