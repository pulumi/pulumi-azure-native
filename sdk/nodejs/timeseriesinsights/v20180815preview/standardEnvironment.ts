...
export class StandardEnvironment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StandardEnvironment {
        return new StandardEnvironment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:timeseriesinsights/v20180815preview:StandardEnvironment';

    /**
     * Returns true if the given object is an instance of StandardEnvironment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StandardEnvironment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StandardEnvironment.__pulumiType;
    }
     ...
     */
    public readonly kind!: pulumi.Output<"Standard">;
    /**
     * Resource location
     */
     ...
     */
    public readonly partitionKeyProperties!: pulumi.Output<outputs.timeseriesinsights.v20180815preview.TimeSeriesIdPropertyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: StandardEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights/v20180815preview:StandardEnvironment" }, { type: "azure-native:timeseriesinsights:StandardEnvironment" }, { type: "azure-nextgen:timeseriesinsights:StandardEnvironment" }, { type: "azure-native:timeseriesinsights/v20170228preview:StandardEnvironment" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:StandardEnvironment" }, { type: "azure-native:timeseriesinsights/v20171115:StandardEnvironment" }, { type: "azure-nextgen:timeseriesinsights/v20171115:StandardEnvironment" }, { type: "azure-native:timeseriesinsights/v20200515:StandardEnvironment" }, { type: "azure-nextgen:timeseriesinsights/v20200515:StandardEnvironment" }, { type: "azure-native:timeseriesinsights/v20210331preview:StandardEnvironment" }, { type: "azure-nextgen:timeseriesinsights/v20210331preview:StandardEnvironment" }, { type: "azure-native:timeseriesinsights/v20210630preview:StandardEnvironment" }, { type: "azure-nextgen:timeseriesinsights/v20210630preview:StandardEnvironment" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(StandardEnvironment.__pulumiType, name, inputs, opts);
    }
}
