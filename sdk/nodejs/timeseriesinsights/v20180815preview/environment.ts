 ...
 *
 * const environment = new azurerm.timeseriesinsights.v20180815preview.Environment("environment", {
...
export class Environment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:timeseriesinsights/v20180815preview:Environment';
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:timeseriesinsights/latest:Environment" }, { type: "azurerm:timeseriesinsights/v20170228preview:Environment" }, { type: "azurerm:timeseriesinsights/v20171115:Environment" }, { type: "azurerm:timeseriesinsights/v20200515:Environment" }] };
