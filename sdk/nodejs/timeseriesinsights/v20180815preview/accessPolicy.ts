...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:timeseriesinsights/v20180815preview:AccessPolicy';
    ...
    constructor(name: string, args: AccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights:AccessPolicy" }, { type: "azure-nextgen:timeseriesinsights/latest:AccessPolicy" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:AccessPolicy" }, { type: "azure-nextgen:timeseriesinsights/v20171115:AccessPolicy" }, { type: "azure-nextgen:timeseriesinsights/v20200515:AccessPolicy" }] };
