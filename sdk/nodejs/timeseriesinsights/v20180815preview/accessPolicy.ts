 ...
 *
 * const accessPolicy = new azurerm.timeseriesinsights.v20180815preview.AccessPolicy("accessPolicy", {
...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:timeseriesinsights/v20180815preview:AccessPolicy';
    ...
    constructor(name: string, args: AccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:timeseriesinsights/latest:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20170228preview:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20171115:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20200515:AccessPolicy" }] };
