...
export class ReferenceDataSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:timeseriesinsights/v20180815preview:ReferenceDataSet';
     ...
     */
    public readonly keyProperties!: pulumi.Output<outputs.timeseriesinsights.v20180815preview.ReferenceDataSetKeyPropertyResponse[]>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, args: ReferenceDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights/v20180815preview:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/latest:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/latest:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20170228preview:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20171115:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/v20171115:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20200515:ReferenceDataSet" }, { type: "azure-nextgen:timeseriesinsights/v20200515:ReferenceDataSet" }] };
...
export interface ReferenceDataSetArgs {
     ...
     * The reference data set key comparison behavior can be set using this property. By default, the value is 'Ordinal' - which means case sensitive key comparison will be performed while joining reference data with events or while adding new reference data. When 'OrdinalIgnoreCase' is set, case insensitive comparison will be used.
     */
    readonly dataStringComparisonBehavior?: pulumi.Input<string | enums.timeseriesinsights.v20180815preview.DataStringComparisonBehavior>;
    /**
     ...
     * The list of key properties for the reference data set.
     */
    readonly keyProperties: pulumi.Input<pulumi.Input<inputs.timeseriesinsights.v20180815preview.ReferenceDataSetKeyProperty>[]>;
    /**
