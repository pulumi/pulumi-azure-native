...
export class ReferenceDataSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReferenceDataSet {
        pulumi.log.warn("ReferenceDataSet is deprecated: Version 2018-08-15-preview will be removed in v2 of the provider.")
     ...
     */
    public /*out*/ readonly keyProperties!: pulumi.Output<outputs.timeseriesinsights.v20180815preview.ReferenceDataSetKeyPropertyResponse[]>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, args: ReferenceDataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:timeseriesinsights:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20170228preview:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20171115:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20200515:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20210331preview:ReferenceDataSet" }, { type: "azure-native:timeseriesinsights/v20210630preview:ReferenceDataSet" }] };
...
export interface ReferenceDataSetArgs {
     ...
     */
    properties: pulumi.Input<inputs.timeseriesinsights.v20180815preview.ReferenceDataSetCreationPropertiesArgs>;
    /**
