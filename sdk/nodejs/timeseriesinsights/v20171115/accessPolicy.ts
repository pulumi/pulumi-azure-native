 ...
 *
 * const accessPolicy = new azure_native.timeseriesinsights.v20171115.AccessPolicy("accessPolicy", {
 *     accessPolicyName: "ap1",
 *     description: "some description",
 *     environmentName: "env1",
 *     principalObjectId: "aGuid",
 *     resourceGroupName: "rg1",
 *     roles: [azure_native.timeseriesinsights.v20171115.AccessPolicyRole.Reader],
 * });
 *
 * ```
 *
 ...
 *
 * ```sh
 * $ pulumi import azure-native:timeseriesinsights/v20171115:AccessPolicy ap1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.TimeSeriesInsights/Environments/env1/accessPolicies/ap1 
 * ```
 *
...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:timeseriesinsights:AccessPolicy" }, { type: "azure-native:timeseriesinsights/v20170228preview:AccessPolicy" }, { type: "azure-native:timeseriesinsights/v20180815preview:AccessPolicy" }, { type: "azure-native:timeseriesinsights/v20200515:AccessPolicy" }, { type: "azure-native:timeseriesinsights/v20210331preview:AccessPolicy" }, { type: "azure-native:timeseriesinsights/v20210630preview:AccessPolicy" }] };
