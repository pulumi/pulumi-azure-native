...
export class EventHubEventSource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventHubEventSource {
        pulumi.log.warn("EventHubEventSource is deprecated: azure-native:timeseriesinsights/v20171115:EventHubEventSource is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:EventHubEventSource to guarantee forwards compatibility.")
