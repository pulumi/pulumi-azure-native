 ...
 */
/** @deprecated azure-native:timeseriesinsights/v20210331preview:Gen1Environment is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:Gen1Environment to guarantee forwards compatibility. */
export function getGen1Environment(args: GetGen1EnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetGen1EnvironmentResult> {
    pulumi.log.warn("getGen1Environment is deprecated: azure-native:timeseriesinsights/v20210331preview:Gen1Environment is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:Gen1Environment to guarantee forwards compatibility.")
