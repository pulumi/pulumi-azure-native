...
export class Gen1Environment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Gen1Environment {
        pulumi.log.warn("Gen1Environment is deprecated: azure-native:timeseriesinsights/v20210331preview:Gen1Environment is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:Gen1Environment to guarantee forwards compatibility.")
