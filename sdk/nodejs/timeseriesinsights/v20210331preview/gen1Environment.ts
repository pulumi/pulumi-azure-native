...
export class Gen1Environment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: Gen1EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:timeseriesinsights:Gen1Environment" }, { type: "azure-native:timeseriesinsights/v20200515:Gen1Environment" }, { type: "azure-native:timeseriesinsights/v20210630preview:Gen1Environment" }] };
