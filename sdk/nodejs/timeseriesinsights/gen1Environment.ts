...
export interface Gen1EnvironmentArgs {
     ...
     * Expected value is 'Gen1'.
     */
    readonly kind: pulumi.Input<"Gen1">;
    /**
     ...
     * The list of event properties which will be used to partition data in the environment. Currently, only a single partition key property is supported.
     */
    readonly partitionKeyProperties?: pulumi.Input<pulumi.Input<inputs.timeseriesinsights.TimeSeriesIdPropertyArgs>[]>;
    /**
     ...
     * The behavior the Time Series Insights service should take when the environment's capacity has been exceeded. If "PauseIngress" is specified, new events will not be read from the event source. If "PurgeOldData" is specified, new events will continue to be read and old events will be deleted from the environment. The default behavior is PurgeOldData.
     */
    readonly storageLimitExceededBehavior?: pulumi.Input<string | enums.timeseriesinsights.StorageLimitExceededBehavior>;
    /**
