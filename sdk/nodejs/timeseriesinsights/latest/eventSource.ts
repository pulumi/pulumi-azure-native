...
export class EventSource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventSource {
        pulumi.log.warn("EventSource is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:timeseriesinsights:EventSource'.")
        return new EventSource(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:timeseriesinsights/latest:EventSource';
    ...
    constructor(name: string, args: EventSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights/latest:EventSource" }, { type: "azure-native:timeseriesinsights:EventSource" }, { type: "azure-nextgen:timeseriesinsights:EventSource" }, { type: "azure-native:timeseriesinsights/v20170228preview:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:EventSource" }, { type: "azure-native:timeseriesinsights/v20171115:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20171115:EventSource" }, { type: "azure-native:timeseriesinsights/v20180815preview:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20180815preview:EventSource" }, { type: "azure-native:timeseriesinsights/v20200515:EventSource" }, { type: "azure-nextgen:timeseriesinsights/v20200515:EventSource" }] };
...
export interface EventSourceArgs {
     ...
     * The kind of the event source.
     */
    readonly kind: pulumi.Input<string | enums.timeseriesinsights.latest.EventSourceKind>;
    /**
     * An object that represents the local timestamp property. It contains the format of local timestamp that needs to be used and the corresponding timezone offset information. If a value isn't specified for localTimestamp, or if null, then the local timestamp will not be ingressed with the events.
     */
    readonly localTimestamp?: pulumi.Input<inputs.timeseriesinsights.latest.LocalTimestamp>;
    /**
