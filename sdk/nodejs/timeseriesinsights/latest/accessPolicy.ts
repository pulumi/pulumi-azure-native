...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:timeseriesinsights/latest:AccessPolicy';
    ...
    constructor(name: string, argsOrState?: AccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:timeseriesinsights/preview:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20170228preview:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20171115:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20180815preview:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20200515:AccessPolicy" }] };
