...
export function getReferenceDataSet(args: GetReferenceDataSetArgs, opts?: pulumi.InvokeOptions): Promise<GetReferenceDataSetResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:timeseriesinsights/v20200515:getReferenceDataSet", {
...
export interface GetReferenceDataSetResult {
     ...
     */
    readonly keyProperties: outputs.timeseriesinsights.v20200515.ReferenceDataSetKeyPropertyInvokeResponse[];
    /**
     * Resource location
     */
