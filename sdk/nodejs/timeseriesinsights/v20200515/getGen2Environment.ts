...
export function getGen2Environment(args: GetGen2EnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetGen2EnvironmentResult> {
    pulumi.log.warn("getGen2Environment is deprecated: azure-native:timeseriesinsights/v20200515:Gen2Environment is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210331preview:Gen2Environment to guarantee forwards compatibility.")
