...
export class Gen1Environment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: Gen1EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights/v20200515:Gen1Environment" }, { type: "azure-native:timeseriesinsights:Gen1Environment" }, { type: "azure-nextgen:timeseriesinsights:Gen1Environment" }, { type: "azure-native:timeseriesinsights/v20170228preview:Gen1Environment" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:Gen1Environment" }, { type: "azure-native:timeseriesinsights/v20171115:Gen1Environment" }, { type: "azure-nextgen:timeseriesinsights/v20171115:Gen1Environment" }, { type: "azure-native:timeseriesinsights/v20180815preview:Gen1Environment" }, { type: "azure-nextgen:timeseriesinsights/v20180815preview:Gen1Environment" }] };
...
export interface Gen1EnvironmentArgs {
     ...
     * The list of event properties which will be used to partition data in the environment. Currently, only a single partition key property is supported.
     */
    readonly partitionKeyProperties?: pulumi.Input<pulumi.Input<inputs.timeseriesinsights.v20200515.TimeSeriesIdPropertyArgs>[]>;
    /**
     ...
     * The behavior the Time Series Insights service should take when the environment's capacity has been exceeded. If "PauseIngress" is specified, new events will not be read from the event source. If "PurgeOldData" is specified, new events will continue to be read and old events will be deleted from the environment. The default behavior is PurgeOldData.
     */
    readonly storageLimitExceededBehavior?: pulumi.Input<string | enums.timeseriesinsights.v20200515.StorageLimitExceededBehavior>;
    /**
