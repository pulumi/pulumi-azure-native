 ...
 *
 * @deprecated Version 2020-05-15 will be removed in v2 of the provider.
 */
export class AccessPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessPolicy {
        pulumi.log.warn("AccessPolicy is deprecated: Version 2020-05-15 will be removed in v2 of the provider.")
