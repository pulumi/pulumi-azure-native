...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:timeseriesinsights/latest:AccessPolicy" }, { type: "azurerm:timeseriesinsights/preview:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20170228preview:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20171115:AccessPolicy" }, { type: "azurerm:timeseriesinsights/v20180815preview:AccessPolicy" }] };
