...
export class Environment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:timeseriesinsights:Environment" }, { type: "azure-nextgen:timeseriesinsights/latest:Environment" }, { type: "azure-nextgen:timeseriesinsights/v20170228preview:Environment" }, { type: "azure-nextgen:timeseriesinsights/v20171115:Environment" }, { type: "azure-nextgen:timeseriesinsights/v20180815preview:Environment" }] };
