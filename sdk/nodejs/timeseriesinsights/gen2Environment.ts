...
export class Gen2Environment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.timeseriesinsights.Gen2EnvironmentResourcePropertiesResponse>;
    /**
...
export interface Gen2EnvironmentArgs {
     ...
     */
    properties: pulumi.Input<inputs.timeseriesinsights.Gen2EnvironmentCreationPropertiesArgs>;
    /**
