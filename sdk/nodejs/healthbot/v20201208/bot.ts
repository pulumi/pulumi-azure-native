...
export class Bot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:healthbot:Bot" }, { type: "azure-nextgen:healthbot/latest:Bot" }, { type: "azure-nextgen:healthbot/v20201020:Bot" }, { type: "azure-nextgen:healthbot/v20201020preview:Bot" }, { type: "azure-nextgen:healthbot/v20201208preview:Bot" }] };
