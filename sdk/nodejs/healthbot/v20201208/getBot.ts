...
export function getBot(args: GetBotArgs, opts?: pulumi.InvokeOptions): Promise<GetBotResult> {
    pulumi.log.warn("getBot is deprecated: azure-native:healthbot/v20201208:Bot is being removed in the next major version of this provider. Upgrade to at least azure-native:healthbot/v20201208preview:Bot to guarantee forwards compatibility.")
