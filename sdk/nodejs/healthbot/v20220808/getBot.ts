...
export interface GetBotResult {
     ...
     */
    readonly identity?: outputs.healthbot.v20220808.IdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.healthbot.v20220808.HealthBotPropertiesResponse;
    /**
     * SKU of the Azure Health Bot.
     */
    readonly sku: outputs.healthbot.v20220808.SkuResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource
     */
    readonly systemData: outputs.healthbot.v20220808.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getBotOutput(args: GetBotOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBotResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:healthbot/v20220808:getBot", {
        "botName": args.botName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
