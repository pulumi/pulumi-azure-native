...
export function getBot(args: GetBotArgs, opts?: pulumi.InvokeOptions): Promise<GetBotResult> {
    pulumi.log.warn("getBot is deprecated: azure-native:healthbot/v20210610:Bot is being removed in the next major version of this provider. Upgrade to at least azure-native:healthbot/v20220808:Bot to guarantee forwards compatibility.")
