...
export class Getbot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Getbot {
        pulumi.log.warn("Getbot is deprecated: Version v20201020 will be removed in the next major version of the provider. Upgrade to version v20201208 or later.")
