 ...
 */
/** @deprecated Version 2020-12-08-preview will be removed in v2 of the provider. */
export function getBot(args: GetBotArgs, opts?: pulumi.InvokeOptions): Promise<GetBotResult> {
    pulumi.log.warn("getBot is deprecated: Version 2020-12-08-preview will be removed in v2 of the provider.")
