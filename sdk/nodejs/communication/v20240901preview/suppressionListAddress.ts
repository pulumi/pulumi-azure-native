...
export class SuppressionListAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:communication/v20240901preview:SuppressionListAddress';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.communication.v20240901preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: SuppressionListAddressArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication/v20230601preview:SuppressionListAddress" }, { type: "azure-native:communication:SuppressionListAddress" }] };
