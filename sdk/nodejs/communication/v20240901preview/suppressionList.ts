...
export class SuppressionList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:communication/v20240901preview:SuppressionList';
    ...
    constructor(name: string, args: SuppressionListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication/v20230601preview:SuppressionList" }, { type: "azure-native:communication:SuppressionList" }] };
