...
export function getSuppressionList(args: GetSuppressionListArgs, opts?: pulumi.InvokeOptions): Promise<GetSuppressionListResult> {
    ...
    return pulumi.runtime.invoke("azure-native:communication/v20240901preview:getSuppressionList", {
...
export function getSuppressionListOutput(args: GetSuppressionListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSuppressionListResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:communication/v20240901preview:getSuppressionList", {
        "domainName": args.domainName,
        "emailServiceName": args.emailServiceName,
        "resourceGroupName": args.resourceGroupName,
        "suppressionListName": args.suppressionListName,
