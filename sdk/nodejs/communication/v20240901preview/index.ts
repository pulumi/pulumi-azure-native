...
// Export enums:
export * from "../../types/enums/communication/v20240901preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:communication/v20240901preview:CommunicationService":
                return new CommunicationService(name, <any>undefined, { urn })
            case "azure-native:communication/v20240901preview:Domain":
                return new Domain(name, <any>undefined, { urn })
            case "azure-native:communication/v20240901preview:EmailService":
                return new EmailService(name, <any>undefined, { urn })
            case "azure-native:communication/v20240901preview:SenderUsername":
                return new SenderUsername(name, <any>undefined, { urn })
            case "azure-native:communication/v20240901preview:SmtpUsername":
                return new SmtpUsername(name, <any>undefined, { urn })
            case "azure-native:communication/v20240901preview:SuppressionList":
                return new SuppressionList(name, <any>undefined, { urn })
            case "azure-native:communication/v20240901preview:SuppressionListAddress":
...
pulumi.runtime.registerResourceModule("azure-native", "communication/v20240901preview", _module)
