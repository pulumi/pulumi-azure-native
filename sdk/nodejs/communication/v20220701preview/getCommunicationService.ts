...
export function getCommunicationService(args: GetCommunicationServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetCommunicationServiceResult> {
    pulumi.log.warn("getCommunicationService is deprecated: azure-native:communication/v20220701preview:CommunicationService is being removed in the next major version of this provider. Upgrade to at least azure-native:communication/v20230331:CommunicationService to guarantee forwards compatibility.")
