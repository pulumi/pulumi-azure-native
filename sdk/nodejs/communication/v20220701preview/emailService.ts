 ...
 *
 * @deprecated azure-native:communication/v20220701preview:EmailService is being removed in the next major version of this provider. Please upgrade to azure-native:communication/v20230331:EmailService to guarantee forwards compatibility.
 */
export class EmailService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EmailService {
        pulumi.log.warn("EmailService is deprecated: azure-native:communication/v20220701preview:EmailService is being removed in the next major version of this provider. Please upgrade to azure-native:communication/v20230331:EmailService to guarantee forwards compatibility.")
