...
export class CommunicationService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CommunicationServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication:CommunicationService" }, { type: "azure-native:communication/v20200820:CommunicationService" }, { type: "azure-native:communication/v20200820preview:CommunicationService" }, { type: "azure-native:communication/v20211001preview:CommunicationService" }, { type: "azure-native:communication/v20220701preview:CommunicationService" }, { type: "azure-native:communication/v20230331:CommunicationService" }, { type: "azure-native:communication/v20230401preview:CommunicationService" }] };
