...
export function getEmailService(args: GetEmailServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetEmailServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:communication/v20230301preview:getEmailService", {
...
export interface GetEmailServiceResult {
     ...
     */
    readonly systemData: outputs.communication.v20230301preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getEmailServiceOutput(args: GetEmailServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEmailServiceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:communication/v20230301preview:getEmailService", {
        "emailServiceName": args.emailServiceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
