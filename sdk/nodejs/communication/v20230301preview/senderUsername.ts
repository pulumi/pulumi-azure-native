...
export class SenderUsername extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:communication/v20230301preview:SenderUsername';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.communication.v20230301preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: SenderUsernameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication:SenderUsername" }, { type: "azure-native:communication/v20230331:SenderUsername" }, { type: "azure-native:communication/v20230401preview:SenderUsername" }] };
