...
export class CommunicationService extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.communication.v20230401preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.communication.v20230401preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: CommunicationServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication:CommunicationService" }, { type: "azure-native:communication/v20200820:CommunicationService" }, { type: "azure-native:communication/v20211001preview:CommunicationService" }, { type: "azure-native:communication/v20220701preview:CommunicationService" }, { type: "azure-native:communication/v20230301preview:CommunicationService" }, { type: "azure-native:communication/v20230331:CommunicationService" }] };
...
export interface CommunicationServiceArgs {
     ...
     * Managed service identity (system assigned and/or user assigned identities)
     */
    identity?: pulumi.Input<inputs.communication.v20230401preview.ManagedServiceIdentityArgs>;
    /**
     * List of email Domain resource Ids.
     */
