...
export interface GetSenderUsernameResult {
     ...
     */
    readonly systemData: outputs.communication.v20230401preview.SystemDataResponse;
    /**
...
export function getSenderUsernameOutput(args: GetSenderUsernameOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSenderUsernameResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:communication/v20230401preview:getSenderUsername", {
        "domainName": args.domainName,
        "emailServiceName": args.emailServiceName,
        "resourceGroupName": args.resourceGroupName,
        "senderUsername": args.senderUsername,
