 ...
 *
 * const senderUsername = new azure_native.communication.v20230331.SenderUsername("senderUsername", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:communication/v20230331:SenderUsername contoso.com /subscriptions/11112222-3333-4444-5555-666677778888/resourceGroups/contosoResourceGroup/providers/Microsoft.Communication/EmailServices/contosoEmailService/Domains/contoso.com/senderUsernames/contosoNewsAlerts 
 * ```
 */
export class SenderUsername extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SenderUsernameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication:SenderUsername" }, { type: "azure-native:communication/v20230301preview:SenderUsername" }] };
