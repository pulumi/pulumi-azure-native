 ...
 *
 * @deprecated Version 2020-08-20 will be removed in v2 of the provider.
 */
export class CommunicationService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CommunicationServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication:CommunicationService" }, { type: "azure-native:communication/v20200820preview:CommunicationService" }, { type: "azure-native:communication/v20211001preview:CommunicationService" }, { type: "azure-native:communication/v20220701preview:CommunicationService" }] };
