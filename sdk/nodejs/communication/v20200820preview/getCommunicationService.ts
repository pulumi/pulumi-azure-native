...
export function getCommunicationService(args: GetCommunicationServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetCommunicationServiceResult> {
    pulumi.log.warn("getCommunicationService is deprecated: azure-native:communication/v20200820preview:CommunicationService is being removed in the next major version of this provider. Please upgrade to azure-native:communication/v20230331:CommunicationService to guarantee forwards compatibility.")
