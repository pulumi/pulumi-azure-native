...
export class CommunicationService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:communication/latest:CommunicationService';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.communication.latest.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: CommunicationServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:communication/latest:CommunicationService" }, { type: "azure-native:communication:CommunicationService" }, { type: "azure-nextgen:communication:CommunicationService" }, { type: "azure-native:communication/v20200820:CommunicationService" }, { type: "azure-nextgen:communication/v20200820:CommunicationService" }, { type: "azure-native:communication/v20200820preview:CommunicationService" }, { type: "azure-nextgen:communication/v20200820preview:CommunicationService" }] };
