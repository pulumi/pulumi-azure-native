...
export class EmailService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EmailService {
        pulumi.log.warn("EmailService is deprecated: azure-native:communication/v20211001preview:EmailService is being removed in the next major version of this provider. Upgrade to at least azure-native:communication/v20230401preview:EmailService to guarantee forwards compatibility.")
        return new EmailService(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:communication/v20211001preview:EmailService';
    ...
    constructor(name: string, args: EmailServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication:EmailService" }, { type: "azure-native:communication/v20220701preview:EmailService" }, { type: "azure-native:communication/v20230331:EmailService" }] };
