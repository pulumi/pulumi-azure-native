...
export class Monitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:datadog:Monitor';
    ...
    constructor(name: string, args: MonitorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:datadog/v20200201preview:Monitor" }] };
...
export interface MonitorArgs {
    readonly identity?: pulumi.Input<inputs.datadog.IdentityProperties>;
