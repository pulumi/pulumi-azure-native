...
export class MonitoredSubscription extends pulumi.CustomResource {
     ...
     * The request to update subscriptions needed to be monitored by the Datadog monitor resource.
     */
    declare public readonly properties: pulumi.Output<outputs.datadog.SubscriptionListResponse>;
    /**
    ...
    constructor(name: string, args: MonitoredSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datadog/v20230101:MonitoredSubscription" }, { type: "azure-native:datadog/v20230707:MonitoredSubscription" }, { type: "azure-native:datadog/v20231020:MonitoredSubscription" }, { type: "azure-native:datadog/v20240301:MonitoredSubscription" }, { type: "azure-native:datadog/v20250107:MonitoredSubscription" }, { type: "azure-native:datadog/v20250611:MonitoredSubscription" }, { type: "azure-native:datadog/v20251103preview:MonitoredSubscription" }, { type: "azure-native:datadog/v20251226preview:MonitoredSubscription" }] };
