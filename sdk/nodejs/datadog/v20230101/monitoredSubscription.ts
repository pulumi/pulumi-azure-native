...
export class MonitoredSubscription extends pulumi.CustomResource {
     ...
     * The request to update subscriptions needed to be monitored by the Datadog monitor resource.
     */
    public readonly properties!: pulumi.Output<outputs.datadog.v20230101.SubscriptionListResponse>;
    /**
    ...
    constructor(name: string, args: MonitoredSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datadog:MonitoredSubscription" }, { type: "azure-native:datadog/v20230707:MonitoredSubscription" }, { type: "azure-native:datadog/v20231020:MonitoredSubscription" }] };
...
export interface MonitoredSubscriptionArgs {
     ...
     * The request to update subscriptions needed to be monitored by the Datadog monitor resource.
     */
    properties?: pulumi.Input<inputs.datadog.v20230101.SubscriptionListArgs>;
    /**
