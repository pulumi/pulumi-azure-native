...
export class MonitoredSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datadog/v20230707:MonitoredSubscription';
     ...
     * The request to update subscriptions needed to be monitored by the Datadog monitor resource.
     */
    public readonly properties!: pulumi.Output<outputs.datadog.v20230707.SubscriptionListResponse>;
    /**
