...
// Export enums:
export * from "../../types/enums/datadog/v20210301";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:datadog/v20210301:Monitor":
...
pulumi.runtime.registerResourceModule("azure-native", "datadog/v20210301", _module)
