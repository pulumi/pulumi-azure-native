...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:videoanalyzer/v20211101preview:PrivateEndpointConnection" }, { type: "azure-native_videoanalyzer_v20211101preview:videoanalyzer:PrivateEndpointConnection" }] };
