...
export class VideoAnalyzer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VideoAnalyzerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:videoanalyzer:VideoAnalyzer" }, { type: "azure-native:videoanalyzer/v20210501preview:VideoAnalyzer" }, { type: "azure-nextgen:videoanalyzer/v20210501preview:VideoAnalyzer" }, { type: "azure-native:videoanalyzer/v20211101preview:VideoAnalyzer" }, { type: "azure-nextgen:videoanalyzer/v20211101preview:VideoAnalyzer" }] };
