...
export class PipelineJob extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PipelineJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:videoanalyzer:PipelineJob" }, { type: "azure-native:videoanalyzer/v20211101preview:PipelineJob" }, { type: "azure-nextgen:videoanalyzer/v20211101preview:PipelineJob" }] };
