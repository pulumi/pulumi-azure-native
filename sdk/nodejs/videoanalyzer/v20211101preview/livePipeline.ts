...
export class LivePipeline extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LivePipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:videoanalyzer/v20211101preview:LivePipeline" }, { type: "azure-native:videoanalyzer:LivePipeline" }, { type: "azure-nextgen:videoanalyzer:LivePipeline" }] };
