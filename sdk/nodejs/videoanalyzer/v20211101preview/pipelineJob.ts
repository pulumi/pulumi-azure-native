...
export class PipelineJob extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly error!: pulumi.Output<outputs.videoanalyzer.v20211101preview.PipelineJobErrorResponse>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.videoanalyzer.v20211101preview.ParameterDefinitionResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: PipelineJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:videoanalyzer/v20211101preview:PipelineJob" }, { type: "azure-native:videoanalyzer:PipelineJob" }, { type: "azure-nextgen:videoanalyzer:PipelineJob" }] };
