...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:videoanalyzer:AccessPolicy" }, { type: "azure-native:videoanalyzer/v20210501preview:AccessPolicy" }, { type: "azure-nextgen:videoanalyzer/v20210501preview:AccessPolicy" }] };
...
export interface AccessPolicyArgs {
     ...
     * Authentication method to be used when validating client API access.
     */
    readonly authentication?: pulumi.Input<inputs.videoanalyzer.JwtAuthenticationArgs>;
    /**
     ...
     * Defines the access level granted by this policy.
     */
    readonly role?: pulumi.Input<string | enums.videoanalyzer.AccessPolicyRole>;
}
