...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:videoanalyzer:AccessPolicy" }, { type: "azure-native:videoanalyzer/v20210501preview:AccessPolicy" }, { type: "azure-nextgen:videoanalyzer/v20210501preview:AccessPolicy" }, { type: "azure-native:videoanalyzer/v20211101preview:AccessPolicy" }, { type: "azure-nextgen:videoanalyzer/v20211101preview:AccessPolicy" }] };
