...
export class ClusterPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hdinsight/v20240501preview:ClusterPool';
     ...
     */
    public /*out*/ readonly aksClusterProfile!: pulumi.Output<outputs.hdinsight.v20240501preview.ClusterPoolResourcePropertiesResponseAksClusterProfile>;
    /**
     ...
     */
    public readonly clusterPoolProfile!: pulumi.Output<outputs.hdinsight.v20240501preview.ClusterPoolResourcePropertiesResponseClusterPoolProfile | undefined>;
    /**
     * CLuster pool compute profile.
     */
    public readonly computeProfile!: pulumi.Output<outputs.hdinsight.v20240501preview.ClusterPoolResourcePropertiesResponseComputeProfile>;
    /**
     ...
     */
    public readonly logAnalyticsProfile!: pulumi.Output<outputs.hdinsight.v20240501preview.ClusterPoolResourcePropertiesResponseLogAnalyticsProfile | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.hdinsight.v20240501preview.ClusterPoolResourcePropertiesResponseNetworkProfile | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(inputs.hdinsight.v20240501preview.clusterPoolResourcePropertiesNetworkProfileArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hdinsight/v20230601preview:ClusterPool" }, { type: "azure-native:hdinsight/v20231101preview:ClusterPool" }, { type: "azure-native:hdinsight:ClusterPool" }] };
