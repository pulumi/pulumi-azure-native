...
export class Cluster extends pulumi.CustomResource {
     ...
     * Cluster profile.
     */
    public readonly clusterProfile!: pulumi.Output<outputs.hdinsight.v20231101preview.ClusterProfileResponse>;
    /**
     * The type of cluster.
     */
     ...
     * The compute profile.
     */
    public readonly computeProfile!: pulumi.Output<outputs.hdinsight.v20231101preview.ComputeProfileResponse>;
    /**
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["clusterProfile"] = args ? (args.clusterProfile ? pulumi.output(args.clusterProfile).apply(inputs.hdinsight.v20231101preview.clusterProfileArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hdinsight/v20230601preview:Cluster" }, { type: "azure-native:hdinsight/v20240501preview:Cluster" }] };
...
export interface ClusterArgs {
     ...
     * Cluster profile.
     */
    clusterProfile: pulumi.Input<inputs.hdinsight.v20231101preview.ClusterProfileArgs>;
    /**
     * The type of cluster.
     */
     ...
     * The compute profile.
     */
    computeProfile: pulumi.Input<inputs.hdinsight.v20231101preview.ComputeProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
