...
export interface GetClusterPoolResult {
     ...
     */
    readonly aksClusterProfile: outputs.hdinsight.v20231101preview.ClusterPoolResourcePropertiesResponseAksClusterProfile;
    /**
     ...
     */
    readonly clusterPoolProfile?: outputs.hdinsight.v20231101preview.ClusterPoolResourcePropertiesResponseClusterPoolProfile;
    /**
     * CLuster pool compute profile.
     */
    readonly computeProfile: outputs.hdinsight.v20231101preview.ClusterPoolResourcePropertiesResponseComputeProfile;
    /**
     ...
     */
    readonly logAnalyticsProfile?: outputs.hdinsight.v20231101preview.ClusterPoolResourcePropertiesResponseLogAnalyticsProfile;
    /**
     ...
     */
    readonly networkProfile?: outputs.hdinsight.v20231101preview.ClusterPoolResourcePropertiesResponseNetworkProfile;
    /**
...
export function getClusterPoolOutput(args: GetClusterPoolOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetClusterPoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:hdinsight/v20231101preview:getClusterPool", {
        "clusterPoolName": args.clusterPoolName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
