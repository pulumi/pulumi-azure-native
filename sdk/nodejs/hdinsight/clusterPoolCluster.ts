...
export class ClusterPoolCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ClusterPoolClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hdinsight/v20230601preview:ClusterPoolCluster" }, { type: "azure-native:hdinsight/v20231101preview:ClusterPoolCluster" }, { type: "azure-native:hdinsight/v20240501preview:ClusterPoolCluster" }] };
