...
export class ClusterPoolCluster extends pulumi.CustomResource {
     ...
     * Cluster profile.
     */
    public readonly clusterProfile!: pulumi.Output<outputs.hdinsight.ClusterProfileResponse>;
    /**
     * The type of cluster.
     */
     ...
     * The compute profile.
     */
    public readonly computeProfile!: pulumi.Output<outputs.hdinsight.ClusterPoolComputeProfileResponse>;
    /**
    ...
    constructor(name: string, args: ClusterPoolClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hdinsight/v20230601preview:Cluster" }, { type: "azure-native:hdinsight/v20231101preview:Cluster" }, { type: "azure-native:hdinsight/v20240501preview:Cluster" }, { type: "azure-native_hdinsight_v20230601preview:hdinsight:ClusterPoolCluster" }, { type: "azure-native_hdinsight_v20231101preview:hdinsight:ClusterPoolCluster" }, { type: "azure-native_hdinsight_v20240501preview:hdinsight:ClusterPoolCluster" }] };
...
export interface ClusterPoolClusterArgs {
     ...
     * Cluster profile.
     */
    clusterProfile: pulumi.Input<inputs.hdinsight.ClusterProfileArgs>;
    /**
     * The type of cluster.
     */
     ...
     * The compute profile.
     */
    computeProfile: pulumi.Input<inputs.hdinsight.ClusterPoolComputeProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
