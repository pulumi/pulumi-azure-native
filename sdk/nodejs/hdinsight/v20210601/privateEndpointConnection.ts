...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpointConnection {
        pulumi.log.warn("PrivateEndpointConnection is deprecated: azure-native:hdinsight/v20210601:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:hdinsight/v20230415preview:PrivateEndpointConnection to guarantee forwards compatibility.")
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.hdinsight.v20210601.PrivateEndpointResponse>;
    /**
     * The private link service connection state.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.hdinsight.v20210601.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hdinsight:PrivateEndpointConnection" }] };
