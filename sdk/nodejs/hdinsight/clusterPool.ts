...
export class ClusterPool extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly aksClusterProfile!: pulumi.Output<outputs.hdinsight.ClusterPoolResourcePropertiesResponseAksClusterProfile>;
    /**
     ...
     */
    public readonly clusterPoolProfile!: pulumi.Output<outputs.hdinsight.ClusterPoolResourcePropertiesResponseClusterPoolProfile | undefined>;
    /**
     * CLuster pool compute profile.
     */
    public readonly computeProfile!: pulumi.Output<outputs.hdinsight.ClusterPoolResourcePropertiesResponseComputeProfile>;
    /**
     ...
     */
    public readonly logAnalyticsProfile!: pulumi.Output<outputs.hdinsight.ClusterPoolResourcePropertiesResponseLogAnalyticsProfile | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.hdinsight.ClusterPoolResourcePropertiesResponseNetworkProfile | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hdinsight/v20230601preview:ClusterPool" }, { type: "azure-native:hdinsight/v20231101preview:ClusterPool" }, { type: "azure-native:hdinsight/v20240501preview:ClusterPool" }, { type: "azure-native_hdinsight_v20230601preview:hdinsight:ClusterPool" }, { type: "azure-native_hdinsight_v20231101preview:hdinsight:ClusterPool" }, { type: "azure-native_hdinsight_v20240501preview:hdinsight:ClusterPool" }] };
...
export interface ClusterPoolArgs {
     ...
     * CLuster pool profile.
     */
    clusterPoolProfile?: pulumi.Input<inputs.hdinsight.ClusterPoolResourcePropertiesClusterPoolProfileArgs>;
    /**
     * CLuster pool compute profile.
     */
    computeProfile: pulumi.Input<inputs.hdinsight.ClusterPoolResourcePropertiesComputeProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Cluster pool log analytics profile to enable OMS agent for AKS cluster.
     */
    logAnalyticsProfile?: pulumi.Input<inputs.hdinsight.ClusterPoolResourcePropertiesLogAnalyticsProfileArgs>;
    /**
     * A resource group created by RP, to hold the resources created by RP on-behalf of customers. It will also be used to generate aksManagedResourceGroupName by pattern: MC_{managedResourceGroupName}_{clusterPoolName}_{region}. Please make sure it meets resource group name restriction.
     */
     ...
     * Cluster pool network profile.
     */
    networkProfile?: pulumi.Input<inputs.hdinsight.ClusterPoolResourcePropertiesNetworkProfileArgs>;
    /**
