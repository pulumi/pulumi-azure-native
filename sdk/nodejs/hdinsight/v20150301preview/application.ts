 ...
 *
 * const application = new azurerm.hdinsight.v20150301preview.Application("application", {
 *     applicationName: "hue",
...
export class Application extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:hdinsight/v20150301preview:Application';
    ...
    constructor(name: string, args: ApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:hdinsight/v20180601preview:Application" }] };
