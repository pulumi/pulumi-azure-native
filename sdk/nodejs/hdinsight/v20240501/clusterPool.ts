...
export class ClusterPool extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly aksClusterProfile!: pulumi.Output<outputs.hdinsight.v20240501.ClusterPoolResourcePropertiesResponseAksClusterProfile>;
    /**
     ...
     */
    public readonly clusterPoolProfile!: pulumi.Output<outputs.hdinsight.v20240501.ClusterPoolResourcePropertiesResponseClusterPoolProfile | undefined>;
    /**
     * CLuster pool compute profile.
     */
    public readonly computeProfile!: pulumi.Output<outputs.hdinsight.v20240501.ClusterPoolResourcePropertiesResponseComputeProfile>;
    /**
     ...
     */
    public readonly logAnalyticsProfile!: pulumi.Output<outputs.hdinsight.v20240501.ClusterPoolResourcePropertiesResponseLogAnalyticsProfile | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.hdinsight.v20240501.ClusterPoolResourcePropertiesResponseNetworkProfile | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(inputs.hdinsight.v20240501.clusterPoolResourcePropertiesNetworkProfileArgsProvideDefaults) : undefined) : undefined;
...
export interface ClusterPoolArgs {
     ...
     * CLuster pool profile.
     */
    clusterPoolProfile?: pulumi.Input<inputs.hdinsight.v20240501.ClusterPoolResourcePropertiesClusterPoolProfileArgs>;
    /**
     * CLuster pool compute profile.
     */
    computeProfile: pulumi.Input<inputs.hdinsight.v20240501.ClusterPoolResourcePropertiesComputeProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Cluster pool log analytics profile to enable OMS agent for AKS cluster.
     */
    logAnalyticsProfile?: pulumi.Input<inputs.hdinsight.v20240501.ClusterPoolResourcePropertiesLogAnalyticsProfileArgs>;
    /**
     * A resource group created by RP, to hold the resources created by RP on-behalf of customers. It will also be used to generate aksManagedResourceGroupName by pattern: MC_{managedResourceGroupName}_{clusterPoolName}_{region}. Please make sure it meets resource group name restriction.
     */
     ...
     * Cluster pool network profile.
     */
    networkProfile?: pulumi.Input<inputs.hdinsight.v20240501.ClusterPoolResourcePropertiesNetworkProfileArgs>;
    /**
