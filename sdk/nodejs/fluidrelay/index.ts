...
// Export members:
export { FluidRelayPrivateEndpointConnectionArgs } from "./fluidRelayPrivateEndpointConnection";
export type FluidRelayPrivateEndpointConnection = import("./fluidRelayPrivateEndpointConnection").FluidRelayPrivateEndpointConnection;
export const FluidRelayPrivateEndpointConnection: typeof import("./fluidRelayPrivateEndpointConnection").FluidRelayPrivateEndpointConnection = null as any;
utilities.lazyLoad(exports, ["FluidRelayPrivateEndpointConnection"], () => require("./fluidRelayPrivateEndpointConnection"));
...
export { GetFluidRelayPrivateEndpointConnectionArgs, GetFluidRelayPrivateEndpointConnectionResult, GetFluidRelayPrivateEndpointConnectionOutputArgs } from "./getFluidRelayPrivateEndpointConnection";
export const getFluidRelayPrivateEndpointConnection: typeof import("./getFluidRelayPrivateEndpointConnection").getFluidRelayPrivateEndpointConnection = null as any;
export const getFluidRelayPrivateEndpointConnectionOutput: typeof import("./getFluidRelayPrivateEndpointConnection").getFluidRelayPrivateEndpointConnectionOutput = null as any;
utilities.lazyLoad(exports, ["getFluidRelayPrivateEndpointConnection","getFluidRelayPrivateEndpointConnectionOutput"], () => require("./getFluidRelayPrivateEndpointConnection"));
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:fluidrelay:FluidRelayPrivateEndpointConnection":
                return new FluidRelayPrivateEndpointConnection(name, <any>undefined, { urn })
