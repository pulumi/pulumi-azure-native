...
export class FluidRelayServer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FluidRelayServer {
        pulumi.log.warn("FluidRelayServer is deprecated: azure-native:fluidrelay/v20210312preview:FluidRelayServer is being removed in the next major version of this provider. Upgrade to at least azure-native:fluidrelay/v20210615preview:FluidRelayServer to guarantee forwards compatibility.")
        return new FluidRelayServer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:fluidrelay/v20210312preview:FluidRelayServer';
     ...
     */
    public /*out*/ readonly fluidRelayEndpoints!: pulumi.Output<outputs.fluidrelay.v20210312preview.FluidRelayEndpointsResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.fluidrelay.v20210312preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface FluidRelayServerArgs {
     ...
     * Provision states for FluidRelay RP
     */
    provisioningState?: pulumi.Input<string | enums.fluidrelay.v20210312preview.ProvisioningState>;
    /**
