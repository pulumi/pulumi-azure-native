...
export class FluidRelayServer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FluidRelayServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:fluidrelay:FluidRelayServer" }, { type: "azure-native:fluidrelay/v20210312preview:FluidRelayServer" }, { type: "azure-native:fluidrelay/v20220601:FluidRelayServer" }] };
