...
export interface GetTriggerResult {
     ...
     * Trigger status
     */
    readonly status: outputs.virtualmachineimages.v20220701.TriggerStatusResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.virtualmachineimages.v20220701.SystemDataResponse;
    /**
...
export function getTriggerOutput(args: GetTriggerOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetTriggerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:virtualmachineimages/v20220701:getTrigger", {
        "imageTemplateName": args.imageTemplateName,
        "resourceGroupName": args.resourceGroupName,
        "triggerName": args.triggerName,
    }, opts);
