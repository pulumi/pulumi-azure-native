 ...
 *
 * const virtualMachineImageTemplate = new azurerm.virtualmachineimages.v20190501preview.VirtualMachineImageTemplate("virtualMachineImageTemplate", {
 *     customize: [{
...
export class VirtualMachineImageTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:virtualmachineimages/v20190501preview:VirtualMachineImageTemplate';
