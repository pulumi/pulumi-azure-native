...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:virtualmachineimages/v20220214:VirtualMachineImageTemplate":
...
pulumi.runtime.registerResourceModule("azure-native", "virtualmachineimages/v20220214", _module)
