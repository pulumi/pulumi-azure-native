...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:virtualmachineimages/v20190201preview:VirtualMachineImageTemplate":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "virtualmachineimages/v20190201preview", _module)
