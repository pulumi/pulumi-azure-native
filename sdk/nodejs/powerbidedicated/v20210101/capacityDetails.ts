...
export class CapacityDetails extends pulumi.CustomResource {
     ...
     */
    public readonly sku!: pulumi.Output<outputs.powerbidedicated.v20210101.CapacitySkuResponse>;
    /**
    ...
    constructor(name: string, args: CapacityDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:powerbidedicated:CapacityDetails" }, { type: "azure-nextgen:powerbidedicated:CapacityDetails" }, { type: "azure-native:powerbidedicated/latest:CapacityDetails" }, { type: "azure-nextgen:powerbidedicated/latest:CapacityDetails" }, { type: "azure-native:powerbidedicated/v20171001:CapacityDetails" }, { type: "azure-nextgen:powerbidedicated/v20171001:CapacityDetails" }] };
...
export interface CapacityDetailsArgs {
     ...
     * A collection of Dedicated capacity administrators
     */
    readonly administration?: pulumi.Input<inputs.powerbidedicated.v20210101.DedicatedCapacityAdministrators>;
    /**
     ...
     * The SKU of the PowerBI Dedicated capacity resource.
     */
    readonly sku: pulumi.Input<inputs.powerbidedicated.v20210101.CapacitySku>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
