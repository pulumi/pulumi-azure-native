...
export class AutoScaleVCore extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AutoScaleVCoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:powerbidedicated:AutoScaleVCore" }, { type: "azure-nextgen:powerbidedicated:AutoScaleVCore" }, { type: "azure-native:powerbidedicated/latest:AutoScaleVCore" }, { type: "azure-nextgen:powerbidedicated/latest:AutoScaleVCore" }] };
...
export interface AutoScaleVCoreArgs {
     ...
     * The SKU of the auto scale v-core resource.
     */
    readonly sku: pulumi.Input<inputs.powerbidedicated.v20210101.AutoScaleVCoreSku>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData?: pulumi.Input<inputs.powerbidedicated.v20210101.SystemData>;
    /**
     * Key-value pairs of additional resource provisioning properties.
     */
