...
export function getCapacityDetails(args: GetCapacityDetailsArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityDetailsResult> {
    ...
    return pulumi.runtime.invoke("azurerm:powerbidedicated/preview:getCapacityDetails", {
...
export interface GetCapacityDetailsResult {
     ...
     */
    readonly administration?: outputs.powerbidedicated.preview.DedicatedCapacityAdministratorsResponse;
    /**
     ...
     */
    readonly sku: outputs.powerbidedicated.preview.ResourceSkuResponse;
    /**
