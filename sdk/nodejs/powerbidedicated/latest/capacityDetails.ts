...
export class CapacityDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:powerbidedicated/latest:CapacityDetails';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.powerbidedicated.latest.ResourceSkuResponse>;
    /**
    ...
    constructor(name: string, args: CapacityDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:powerbidedicated/preview:CapacityDetails" }, { type: "azurerm:powerbidedicated/v20171001:CapacityDetails" }] };
...
export interface CapacityDetailsArgs {
     ...
     * The SKU of the PowerBI Dedicated resource.
     */
    readonly sku: pulumi.Input<inputs.powerbidedicated.latest.ResourceSku>;
    /**
     * Key-value pairs of additional resource provisioning properties.
     */
