...
export class JobDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.storagemover.v20220701preview.JobDefinitionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:JobDefinition" }, { type: "azure-native:storagemover/v20230301:JobDefinition" }] };
...
export interface JobDefinitionArgs {
     ...
     * Job definition properties.
     */
    properties: pulumi.Input<inputs.storagemover.v20220701preview.JobDefinitionPropertiesArgs>;
    /**
