...
export class JobDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:JobDefinition" }, { type: "azure-native:storagemover/v20230301:JobDefinition" }, { type: "azure-native:storagemover/v20230701preview:JobDefinition" }] };
