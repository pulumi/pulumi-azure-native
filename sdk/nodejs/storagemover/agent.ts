...
export class Agent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover/v20220701preview:Agent" }, { type: "azure-native:storagemover/v20230301:Agent" }, { type: "azure-native:storagemover/v20230701preview:Agent" }, { type: "azure-native:storagemover/v20231001:Agent" }, { type: "azure-native:storagemover/v20240701:Agent" }, { type: "azure-native:storagemover/v20250701:Agent" }, { type: "azure-native:storagemover/v20250801:Agent" }, { type: "azure-native:storagemover/v20251201:Agent" }, { type: "azure-native:storagemover/v20260501:Agent" }] };
