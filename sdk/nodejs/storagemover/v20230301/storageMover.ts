 ...
 *
 * const storageMover = new azure_native.storagemover.v20230301.StorageMover("storageMover", {
...
export class StorageMover extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageMoverArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:StorageMover" }, { type: "azure-native:storagemover/v20220701preview:StorageMover" }] };
