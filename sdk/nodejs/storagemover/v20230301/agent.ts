...
export class Agent extends pulumi.CustomResource {
    ...
    public readonly properties!: pulumi.Output<outputs.storagemover.v20230301.AgentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:Agent" }, { type: "azure-native:storagemover/v20220701preview:Agent" }] };
...
export interface AgentArgs {
    ...
    properties: pulumi.Input<inputs.storagemover.v20230301.AgentPropertiesArgs>;
    /**
