 ...
 *
 * const project = new azure_native.storagemover.v20230301.Project("project", {
...
export class Project extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:Project" }, { type: "azure-native:storagemover/v20220701preview:Project" }] };
