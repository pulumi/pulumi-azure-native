 ...
 *
 * const jobDefinition = new azure_native.storagemover.v20230301.JobDefinition("jobDefinition", {
...
export class JobDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:JobDefinition" }, { type: "azure-native:storagemover/v20220701preview:JobDefinition" }] };
