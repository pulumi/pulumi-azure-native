...
// Export enums:
export * from "../../types/enums/storagemover/v20240701";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:storagemover/v20240701:Agent":
                return new Agent(name, <any>undefined, { urn })
            case "azure-native:storagemover/v20240701:Endpoint":
                return new Endpoint(name, <any>undefined, { urn })
            case "azure-native:storagemover/v20240701:JobDefinition":
                return new JobDefinition(name, <any>undefined, { urn })
            case "azure-native:storagemover/v20240701:Project":
                return new Project(name, <any>undefined, { urn })
            case "azure-native:storagemover/v20240701:StorageMover":
...
pulumi.runtime.registerResourceModule("azure-native", "storagemover/v20240701", _module)
