...
export class Agent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagemover/v20240701:Agent';
    ...
    public /*out*/ readonly errorDetails!: pulumi.Output<outputs.storagemover.v20240701.AgentPropertiesResponseErrorDetails>;
    /**
     ...
     */
    public readonly uploadLimitSchedule!: pulumi.Output<outputs.storagemover.v20240701.UploadLimitScheduleResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:Agent" }, { type: "azure-native:storagemover/v20220701preview:Agent" }, { type: "azure-native:storagemover/v20230301:Agent" }, { type: "azure-native:storagemover/v20230701preview:Agent" }, { type: "azure-native:storagemover/v20231001:Agent" }] };
...
export interface AgentArgs {
     ...
     * The WAN-link upload limit schedule that applies to any Job Run the agent executes. Data plane operations (migrating files) are affected. Control plane operations ensure seamless migration functionality and are not limited by this schedule. The schedule is interpreted with the agent's local time.
     */
    uploadLimitSchedule?: pulumi.Input<inputs.storagemover.v20240701.UploadLimitScheduleArgs>;
}
