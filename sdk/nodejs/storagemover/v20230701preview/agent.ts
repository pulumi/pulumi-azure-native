...
export class Agent extends pulumi.CustomResource {
    ...
    public /*out*/ readonly errorDetails!: pulumi.Output<outputs.storagemover.v20230701preview.AgentPropertiesResponseErrorDetails>;
    /**
    ...
    constructor(name: string, args: AgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:Agent" }, { type: "azure-native:storagemover/v20220701preview:Agent" }, { type: "azure-native:storagemover/v20230301:Agent" }, { type: "azure-native:storagemover/v20231001:Agent" }, { type: "azure-native:storagemover/v20240701:Agent" }] };
