...
export class JobDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.storagemover.JobDefinitionPropertiesResponse>;
    /**
...
export interface JobDefinitionArgs {
     ...
     * Job definition properties.
     */
    properties: pulumi.Input<inputs.storagemover.JobDefinitionPropertiesArgs>;
    /**
