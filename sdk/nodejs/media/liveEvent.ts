...
export class LiveEvent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:media:LiveEvent';
    ...
    constructor(name: string, args: LiveEventArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/latest:LiveEvent" }, { type: "azure-nextgen:media/v20180330preview:LiveEvent" }, { type: "azure-nextgen:media/v20180601preview:LiveEvent" }, { type: "azure-nextgen:media/v20180701:LiveEvent" }, { type: "azure-nextgen:media/v20190501preview:LiveEvent" }, { type: "azure-nextgen:media/v20200501:LiveEvent" }] };
...
export interface LiveEventArgs {
     ...
     * Live transcription settings for the live event. See https://go.microsoft.com/fwlink/?linkid=2133742 for more information about the live transcription feature.
     */
    readonly transcriptions?: pulumi.Input<pulumi.Input<inputs.media.LiveEventTranscription>[]>;
    /**
     * Specifies whether a static hostname would be assigned to the live event preview and ingest endpoints. This value can only be updated if the live event is in Standby state
     */
