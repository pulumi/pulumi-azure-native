...
export class MediaService extends pulumi.CustomResource {
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.media.v20230101.AccountEncryptionResponse | undefined>;
    /**
     * The Managed Identity for the Media Services account.
     */
    public readonly identity!: pulumi.Output<outputs.media.v20230101.MediaServiceIdentityResponse | undefined>;
    /**
     * The Key Delivery properties for Media Services account.
     */
    public readonly keyDelivery!: pulumi.Output<outputs.media.v20230101.KeyDeliveryResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.media.v20230101.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly storageAccounts!: pulumi.Output<outputs.media.v20230101.StorageAccountResponse[] | undefined>;
    ...
    constructor(name: string, args: MediaServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media/v20151001:MediaService" }, { type: "azure-native:media/v20180330preview:MediaService" }, { type: "azure-native:media/v20180601preview:MediaService" }, { type: "azure-native:media/v20180701:MediaService" }, { type: "azure-native:media/v20200501:MediaService" }, { type: "azure-native:media/v20210501:MediaService" }, { type: "azure-native:media/v20210601:MediaService" }, { type: "azure-native:media/v20211101:MediaService" }, { type: "azure-native:media:MediaService" }] };
...
export interface MediaServiceArgs {
     ...
     * The account encryption properties.
     */
    encryption?: pulumi.Input<inputs.media.v20230101.AccountEncryptionArgs>;
    /**
     * The Managed Identity for the Media Services account.
     */
    identity?: pulumi.Input<inputs.media.v20230101.MediaServiceIdentityArgs>;
    /**
     * The Key Delivery properties for Media Services account.
     */
    keyDelivery?: pulumi.Input<inputs.media.v20230101.KeyDeliveryArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The minimum TLS version allowed for this account's requests. This is an optional property. If unspecified, a secure default value will be used.
     */
    minimumTlsVersion?: pulumi.Input<string | enums.media.v20230101.MinimumTlsVersion>;
    /**
     * Whether or not public network access is allowed for resources under the Media Services account.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.media.v20230101.PublicNetworkAccess>;
    /**
     ...
     * The storage accounts for this resource.
     */
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.media.v20230101.StorageAccountArgs>[]>;
    storageAuthentication?: pulumi.Input<string | enums.media.v20230101.StorageAuthentication>;
    /**
     * Resource tags.
     */
