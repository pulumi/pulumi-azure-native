...
export class AssetFilter extends pulumi.CustomResource {
     ...
     * The first quality.
     */
    public readonly firstQuality!: pulumi.Output<outputs.media.v20230101.FirstQualityResponse | undefined>;
    /**
     ...
     */
    public readonly presentationTimeRange!: pulumi.Output<outputs.media.v20230101.PresentationTimeRangeResponse | undefined>;
    /**
     ...
     */
    public readonly tracks!: pulumi.Output<outputs.media.v20230101.FilterTrackSelectionResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: AssetFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media/v20180701:AssetFilter" }, { type: "azure-native:media/v20200501:AssetFilter" }, { type: "azure-native:media/v20210601:AssetFilter" }, { type: "azure-native:media/v20211101:AssetFilter" }, { type: "azure-native:media/v20220801:AssetFilter" }, { type: "azure-native:media:AssetFilter" }] };
...
export interface AssetFilterArgs {
     ...
     * The first quality.
     */
    firstQuality?: pulumi.Input<inputs.media.v20230101.FirstQualityArgs>;
    /**
     * The presentation time range.
     */
    presentationTimeRange?: pulumi.Input<inputs.media.v20230101.PresentationTimeRangeArgs>;
    /**
     ...
     * The tracks selection conditions.
     */
    tracks?: pulumi.Input<pulumi.Input<inputs.media.v20230101.FilterTrackSelectionArgs>[]>;
}
