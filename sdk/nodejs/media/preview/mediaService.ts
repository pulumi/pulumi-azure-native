...
export class MediaService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:MediaService';
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.media.preview.AccountEncryptionResponse | undefined>;
    /**
     * The Managed Identity for the Media Services account.
     */
    public readonly identity!: pulumi.Output<outputs.media.preview.MediaServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly storageAccounts!: pulumi.Output<outputs.media.preview.StorageAccountResponse[] | undefined>;
    ...
    constructor(name: string, args: MediaServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:MediaService" }, { type: "azurerm:media/v20151001:MediaService" }, { type: "azurerm:media/v20180330preview:MediaService" }, { type: "azurerm:media/v20180601preview:MediaService" }, { type: "azurerm:media/v20180701:MediaService" }, { type: "azurerm:media/v20200501:MediaService" }] };
...
export interface MediaServiceArgs {
     ...
     * The account encryption properties.
     */
    readonly encryption?: pulumi.Input<inputs.media.preview.AccountEncryption>;
    /**
     * The Managed Identity for the Media Services account.
     */
    readonly identity?: pulumi.Input<inputs.media.preview.MediaServiceIdentity>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The storage accounts for this resource.
     */
    readonly storageAccounts?: pulumi.Input<pulumi.Input<inputs.media.preview.StorageAccount>[]>;
