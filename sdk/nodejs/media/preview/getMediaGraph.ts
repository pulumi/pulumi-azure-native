...
export function getMediaGraph(args: GetMediaGraphArgs, opts?: pulumi.InvokeOptions): Promise<GetMediaGraphResult> {
    ...
    return pulumi.runtime.invoke("azurerm:media/preview:getMediaGraph", {
...
export interface GetMediaGraphResult {
     ...
     * Media Graph sinks.
     */
    readonly sinks: outputs.media.preview.MediaGraphAssetSinkResponse[];
    /**
     * Media Graph sources.
     */
    readonly sources: outputs.media.preview.MediaGraphRtspSourceResponse[];
    /**
