...
export class AccountFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:AccountFilter';
    ...
    constructor(name: string, args: AccountFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:AccountFilter" }, { type: "azurerm:media/v20180701:AccountFilter" }, { type: "azurerm:media/v20200501:AccountFilter" }] };
