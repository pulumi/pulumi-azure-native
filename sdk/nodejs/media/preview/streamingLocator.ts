...
export class StreamingLocator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:StreamingLocator';
     ...
     */
    public readonly contentKeys!: pulumi.Output<outputs.media.preview.StreamingLocatorContentKeyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: StreamingLocatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:StreamingLocator" }, { type: "azurerm:media/v20180330preview:StreamingLocator" }, { type: "azurerm:media/v20180601preview:StreamingLocator" }, { type: "azurerm:media/v20180701:StreamingLocator" }, { type: "azurerm:media/v20200501:StreamingLocator" }] };
...
export interface StreamingLocatorArgs {
     ...
     * The ContentKeys used by this Streaming Locator.
     */
    readonly contentKeys?: pulumi.Input<pulumi.Input<inputs.media.preview.StreamingLocatorContentKey>[]>;
    /**
     * Name of the default ContentKeyPolicy used by this Streaming Locator.
     */
