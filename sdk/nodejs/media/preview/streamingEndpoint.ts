...
export class StreamingEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:StreamingEndpoint';
     ...
     */
    public readonly accessControl!: pulumi.Output<outputs.media.preview.StreamingEndpointAccessControlResponse | undefined>;
    /**
     ...
     */
    public readonly crossSiteAccessPolicies!: pulumi.Output<outputs.media.preview.CrossSiteAccessPoliciesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: StreamingEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:StreamingEndpoint" }, { type: "azurerm:media/v20180330preview:StreamingEndpoint" }, { type: "azurerm:media/v20180601preview:StreamingEndpoint" }, { type: "azurerm:media/v20180701:StreamingEndpoint" }, { type: "azurerm:media/v20190501preview:StreamingEndpoint" }, { type: "azurerm:media/v20200501:StreamingEndpoint" }] };
...
export interface StreamingEndpointArgs {
     ...
     * The access control definition of the StreamingEndpoint.
     */
    readonly accessControl?: pulumi.Input<inputs.media.preview.StreamingEndpointAccessControl>;
    /**
     ...
     * The StreamingEndpoint access policies.
     */
    readonly crossSiteAccessPolicies?: pulumi.Input<inputs.media.preview.CrossSiteAccessPolicies>;
    /**
     * The custom host names of the StreamingEndpoint
     */
