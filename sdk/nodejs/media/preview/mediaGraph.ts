...
export class MediaGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:MediaGraph';
     ...
     * Media Graph sinks.
     */
    public readonly sinks!: pulumi.Output<outputs.media.preview.MediaGraphAssetSinkResponse[]>;
    /**
     * Media Graph sources.
     */
    public readonly sources!: pulumi.Output<outputs.media.preview.MediaGraphRtspSourceResponse[]>;
    /**
    ...
    constructor(name: string, args: MediaGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/v20190901preview:MediaGraph" }, { type: "azurerm:media/v20200201preview:MediaGraph" }] };
...
export interface MediaGraphArgs {
     ...
     * Media Graph sinks.
     */
    readonly sinks: pulumi.Input<pulumi.Input<inputs.media.preview.MediaGraphAssetSink>[]>;
    /**
     * Media Graph sources.
     */
    readonly sources: pulumi.Input<pulumi.Input<inputs.media.preview.MediaGraphRtspSource>[]>;
}
