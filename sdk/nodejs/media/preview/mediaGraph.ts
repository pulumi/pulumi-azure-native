...
export class MediaGraph extends pulumi.CustomResource {
     ...
     * Media Graph sinks.
     */
    public readonly sinks!: pulumi.Output<outputs.media.preview.MediaGraphSinkResponse[]>;
    /**
     * Media Graph sources.
     */
    public readonly sources!: pulumi.Output<outputs.media.preview.MediaGraphSourceResponse[]>;
    /**
...
export interface MediaGraphArgs {
     ...
     * Media Graph sinks.
     */
    readonly sinks: pulumi.Input<pulumi.Input<inputs.media.preview.MediaGraphSink>[]>;
    /**
     * Media Graph sources.
     */
    readonly sources: pulumi.Input<pulumi.Input<inputs.media.preview.MediaGraphSource>[]>;
}
