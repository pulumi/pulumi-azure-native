...
export class ContentKeyPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:ContentKeyPolicy';
     ...
     */
    public readonly options!: pulumi.Output<outputs.media.preview.ContentKeyPolicyOptionResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ContentKeyPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:ContentKeyPolicy" }, { type: "azurerm:media/v20180330preview:ContentKeyPolicy" }, { type: "azurerm:media/v20180601preview:ContentKeyPolicy" }, { type: "azurerm:media/v20180701:ContentKeyPolicy" }, { type: "azurerm:media/v20200501:ContentKeyPolicy" }] };
...
export interface ContentKeyPolicyArgs {
     ...
     * The Key Policy options.
     */
    readonly options: pulumi.Input<pulumi.Input<inputs.media.preview.ContentKeyPolicyOption>[]>;
    /**
