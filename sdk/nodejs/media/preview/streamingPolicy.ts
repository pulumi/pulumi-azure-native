...
export class StreamingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:StreamingPolicy';
     ...
     */
    public readonly commonEncryptionCbcs!: pulumi.Output<outputs.media.preview.CommonEncryptionCbcsResponse | undefined>;
    /**
     * Configuration of CommonEncryptionCenc
     */
    public readonly commonEncryptionCenc!: pulumi.Output<outputs.media.preview.CommonEncryptionCencResponse | undefined>;
    /**
     ...
     */
    public readonly envelopeEncryption!: pulumi.Output<outputs.media.preview.EnvelopeEncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly noEncryption!: pulumi.Output<outputs.media.preview.NoEncryptionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: StreamingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:StreamingPolicy" }, { type: "azurerm:media/v20180330preview:StreamingPolicy" }, { type: "azurerm:media/v20180601preview:StreamingPolicy" }, { type: "azurerm:media/v20180701:StreamingPolicy" }, { type: "azurerm:media/v20200501:StreamingPolicy" }] };
...
export interface StreamingPolicyArgs {
     ...
     * Configuration of CommonEncryptionCbcs
     */
    readonly commonEncryptionCbcs?: pulumi.Input<inputs.media.preview.CommonEncryptionCbcs>;
    /**
     * Configuration of CommonEncryptionCenc
     */
    readonly commonEncryptionCenc?: pulumi.Input<inputs.media.preview.CommonEncryptionCenc>;
    /**
     * Default ContentKey used by current Streaming Policy
     */
     ...
     * Configuration of EnvelopeEncryption
     */
    readonly envelopeEncryption?: pulumi.Input<inputs.media.preview.EnvelopeEncryption>;
    /**
     * Configurations of NoEncryption
     */
    readonly noEncryption?: pulumi.Input<inputs.media.preview.NoEncryption>;
    /**
