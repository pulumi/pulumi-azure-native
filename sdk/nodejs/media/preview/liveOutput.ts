...
export class LiveOutput extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:LiveOutput';
     ...
     */
    public readonly hls!: pulumi.Output<outputs.media.preview.HlsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: LiveOutputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:LiveOutput" }, { type: "azurerm:media/v20180330preview:LiveOutput" }, { type: "azurerm:media/v20180601preview:LiveOutput" }, { type: "azurerm:media/v20180701:LiveOutput" }, { type: "azurerm:media/v20190501preview:LiveOutput" }, { type: "azurerm:media/v20200501:LiveOutput" }] };
...
export interface LiveOutputArgs {
     ...
     * The HLS configuration.
     */
    readonly hls?: pulumi.Input<inputs.media.preview.Hls>;
    /**
