...
export class LiveEvent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:LiveEvent';
     ...
     */
    public readonly encoding!: pulumi.Output<outputs.media.preview.LiveEventEncodingResponse | undefined>;
    /**
     * The Live Event input.
     */
    public readonly input!: pulumi.Output<outputs.media.preview.LiveEventInputResponse>;
    /**
     ...
     */
    public readonly preview!: pulumi.Output<outputs.media.preview.LiveEventPreviewResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LiveEventArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:LiveEvent" }, { type: "azurerm:media/v20180330preview:LiveEvent" }, { type: "azurerm:media/v20180601preview:LiveEvent" }, { type: "azurerm:media/v20180701:LiveEvent" }, { type: "azurerm:media/v20190501preview:LiveEvent" }, { type: "azurerm:media/v20200501:LiveEvent" }] };
...
export interface LiveEventArgs {
     ...
     * The Live Event encoding.
     */
    readonly encoding?: pulumi.Input<inputs.media.preview.LiveEventEncoding>;
    /**
     * The Live Event input.
     */
    readonly input: pulumi.Input<inputs.media.preview.LiveEventInput>;
    /**
     ...
     * The Live Event preview.
     */
    readonly preview?: pulumi.Input<inputs.media.preview.LiveEventPreview>;
    /**
