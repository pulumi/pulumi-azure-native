...
export class AssetFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/preview:AssetFilter';
     ...
     * The first quality.
     */
    public readonly firstQuality!: pulumi.Output<outputs.media.preview.FirstQualityResponse | undefined>;
    /**
     ...
     */
    public readonly presentationTimeRange!: pulumi.Output<outputs.media.preview.PresentationTimeRangeResponse | undefined>;
    /**
     * The tracks selection conditions.
     */
    public readonly tracks!: pulumi.Output<outputs.media.preview.FilterTrackSelectionResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AssetFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:AssetFilter" }, { type: "azurerm:media/v20180701:AssetFilter" }, { type: "azurerm:media/v20200501:AssetFilter" }] };
...
export interface AssetFilterArgs {
     ...
     * The first quality.
     */
    readonly firstQuality?: pulumi.Input<inputs.media.preview.FirstQuality>;
    /**
     * The presentation time range.
     */
    readonly presentationTimeRange?: pulumi.Input<inputs.media.preview.PresentationTimeRange>;
    /**
     ...
     * The tracks selection conditions.
     */
    readonly tracks?: pulumi.Input<pulumi.Input<inputs.media.preview.FilterTrackSelection>[]>;
}
