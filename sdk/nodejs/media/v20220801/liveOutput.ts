...
export class LiveOutput extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LiveOutput {
        pulumi.log.warn("LiveOutput is deprecated: azure-native:media/v20220801:LiveOutput is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveOutput to guarantee forwards compatibility.")
        return new LiveOutput(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20220801:LiveOutput';
     ...
     */
    public readonly hls!: pulumi.Output<outputs.media.v20220801.HlsResponse | undefined>;
    /**
...
export interface LiveOutputArgs {
     ...
     * HTTP Live Streaming (HLS) packing setting for the live output.
     */
    hls?: pulumi.Input<inputs.media.v20220801.HlsArgs>;
    /**
