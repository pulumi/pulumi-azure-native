 ...
 * Gets a live output.
 */
/** @deprecated azure-native:media/v20220801:LiveOutput is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveOutput to guarantee forwards compatibility. */
export function getLiveOutput(args: GetLiveOutputArgs, opts?: pulumi.InvokeOptions): Promise<GetLiveOutputResult> {
    pulumi.log.warn("getLiveOutput is deprecated: azure-native:media/v20220801:LiveOutput is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveOutput to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:media/v20220801:getLiveOutput", {
...
export interface GetLiveOutputResult {
     ...
     */
    readonly hls?: outputs.media.v20220801.HlsResponse;
    /**
