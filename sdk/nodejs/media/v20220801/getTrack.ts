...
export function getTrack(args: GetTrackArgs, opts?: pulumi.InvokeOptions): Promise<GetTrackResult> {
    pulumi.log.warn("getTrack is deprecated: azure-native:media/v20220801:Track is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Track to guarantee forwards compatibility.")
...
export interface GetTrackResult {
     ...
     */
    readonly track?: outputs.media.v20220801.AudioTrackResponse | outputs.media.v20220801.TextTrackResponse | outputs.media.v20220801.VideoTrackResponse;
    /**
