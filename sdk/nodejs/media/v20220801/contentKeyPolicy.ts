...
export class ContentKeyPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20220801:ContentKeyPolicy';
     ...
     */
    public readonly options!: pulumi.Output<outputs.media.v20220801.ContentKeyPolicyOptionResponse[]>;
    /**
...
export interface ContentKeyPolicyArgs {
     ...
     * The Key Policy options.
     */
    options: pulumi.Input<pulumi.Input<inputs.media.v20220801.ContentKeyPolicyOptionArgs>[]>;
    /**
