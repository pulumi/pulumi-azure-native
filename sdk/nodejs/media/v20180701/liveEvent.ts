...
export class LiveEvent extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: LiveEventArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:LiveEvent" }, { type: "azurerm:media/preview:LiveEvent" }, { type: "azurerm:media/v20180330preview:LiveEvent" }, { type: "azurerm:media/v20180601preview:LiveEvent" }, { type: "azurerm:media/v20190501preview:LiveEvent" }, { type: "azurerm:media/v20200501:LiveEvent" }] };
