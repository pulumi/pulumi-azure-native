 ...
 * The Live Event.
 *
 * @deprecated azure-native:media/v20180701:LiveEvent is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20190501preview:LiveEvent to guarantee forwards compatibility.
 */
export class LiveEvent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LiveEvent {
        pulumi.log.warn("LiveEvent is deprecated: azure-native:media/v20180701:LiveEvent is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20190501preview:LiveEvent to guarantee forwards compatibility.")
        return new LiveEvent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20180701:LiveEvent';
