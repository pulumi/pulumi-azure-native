 ...
 *
 * const assetFilter = new azurerm.media.v20180701.AssetFilter("assetFilter", {
...
export class AssetFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20180701:AssetFilter';
    ...
    constructor(name: string, argsOrState?: AssetFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:AssetFilter" }, { type: "azurerm:media/v20200501:AssetFilter" }] };
