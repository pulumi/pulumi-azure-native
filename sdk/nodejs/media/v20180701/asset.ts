 ...
 * An Asset.
 *
 * @deprecated azure-native:media/v20180701:Asset is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Asset to guarantee forwards compatibility.
 */
export class Asset extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Asset {
        pulumi.log.warn("Asset is deprecated: azure-native:media/v20180701:Asset is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Asset to guarantee forwards compatibility.")
        return new Asset(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20180701:Asset';
    ...
    constructor(name: string, args: AssetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:Asset" }, { type: "azure-native:media/v20180330preview:Asset" }, { type: "azure-native:media/v20180601preview:Asset" }, { type: "azure-native:media/v20200501:Asset" }, { type: "azure-native:media/v20210601:Asset" }, { type: "azure-native:media/v20211101:Asset" }, { type: "azure-native:media/v20220801:Asset" }, { type: "azure-native:media/v20230101:Asset" }] };
