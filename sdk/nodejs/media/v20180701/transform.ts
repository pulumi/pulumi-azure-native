...
export class Transform extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:media/v20180701:Transform';
    ...
    constructor(name: string, args: TransformArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:Transform" }, { type: "azure-nextgen:media/latest:Transform" }, { type: "azure-nextgen:media/v20180330preview:Transform" }, { type: "azure-nextgen:media/v20180601preview:Transform" }, { type: "azure-nextgen:media/v20200501:Transform" }] };
