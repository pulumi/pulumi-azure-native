...
export class AccountFilter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:AccountFilter" }, { type: "azure-nextgen:media/latest:AccountFilter" }, { type: "azure-nextgen:media/v20200501:AccountFilter" }] };
