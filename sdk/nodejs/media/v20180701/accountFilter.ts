...
export class AccountFilter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:AccountFilter" }, { type: "azure-nextgen:media:AccountFilter" }, { type: "azure-native:media/latest:AccountFilter" }, { type: "azure-nextgen:media/latest:AccountFilter" }, { type: "azure-native:media/v20200501:AccountFilter" }, { type: "azure-nextgen:media/v20200501:AccountFilter" }] };
