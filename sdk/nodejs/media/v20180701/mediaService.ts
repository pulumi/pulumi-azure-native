...
export class MediaService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:media/v20180701:MediaService';
    ...
    constructor(name: string, args: MediaServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/latest:MediaService" }, { type: "azure-nextgen:media/v20151001:MediaService" }, { type: "azure-nextgen:media/v20180330preview:MediaService" }, { type: "azure-nextgen:media/v20180601preview:MediaService" }, { type: "azure-nextgen:media/v20200501:MediaService" }] };
