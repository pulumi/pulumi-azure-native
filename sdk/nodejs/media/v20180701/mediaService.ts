...
export class MediaService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MediaServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20180701:MediaService" }, { type: "azure-native:media:MediaService" }, { type: "azure-nextgen:media:MediaService" }, { type: "azure-native:media/v20151001:MediaService" }, { type: "azure-nextgen:media/v20151001:MediaService" }, { type: "azure-native:media/v20180330preview:MediaService" }, { type: "azure-nextgen:media/v20180330preview:MediaService" }, { type: "azure-native:media/v20180601preview:MediaService" }, { type: "azure-nextgen:media/v20180601preview:MediaService" }, { type: "azure-native:media/v20200501:MediaService" }, { type: "azure-nextgen:media/v20200501:MediaService" }, { type: "azure-native:media/v20210501:MediaService" }, { type: "azure-nextgen:media/v20210501:MediaService" }] };
...
export interface MediaServiceArgs {
     ...
     * The storage accounts for this resource.
     */
    readonly storageAccounts?: pulumi.Input<pulumi.Input<inputs.media.v20180701.StorageAccountArgs>[]>;
    /**
     * Resource tags.
     */
