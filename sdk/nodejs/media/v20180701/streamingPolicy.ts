...
export class StreamingPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.media.v20180701.StreamingPolicyPropertiesResponse>;
    /**
...
export interface StreamingPolicyArgs {
     ...
     * Class to specify properties of Streaming Policy
     */
    readonly properties?: pulumi.Input<inputs.media.v20180701.StreamingPolicyProperties>;
    /**
