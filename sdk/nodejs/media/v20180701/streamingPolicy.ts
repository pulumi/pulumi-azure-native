 ...
 *
 * const streamingPolicy = new azurerm.media.v20180701.StreamingPolicy("streamingPolicy", {
...
export class StreamingPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: StreamingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:StreamingPolicy" }, { type: "azurerm:media/v20200501:StreamingPolicy" }] };
