 ...
 *
 * @deprecated azure-native:media/v20180701:StreamingLocator is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.
 */
export class StreamingLocator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StreamingLocator {
        pulumi.log.warn("StreamingLocator is deprecated: azure-native:media/v20180701:StreamingLocator is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.")
