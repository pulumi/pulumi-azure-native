...
export class StreamingLocator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StreamingLocatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:StreamingLocator" }, { type: "azurerm:media/preview:StreamingLocator" }, { type: "azurerm:media/v20180330preview:StreamingLocator" }, { type: "azurerm:media/v20180601preview:StreamingLocator" }, { type: "azurerm:media/v20200501:StreamingLocator" }] };
