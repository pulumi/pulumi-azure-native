 ...
 *
 * @deprecated azure-native:media/v20180701:StreamingLocator is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.
 */
export class StreamingLocator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StreamingLocator {
        pulumi.log.warn("StreamingLocator is deprecated: azure-native:media/v20180701:StreamingLocator is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.")
        return new StreamingLocator(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20180701:StreamingLocator';
    ...
    constructor(name: string, args: StreamingLocatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:StreamingLocator" }, { type: "azure-native:media/v20180330preview:StreamingLocator" }, { type: "azure-native:media/v20180601preview:StreamingLocator" }, { type: "azure-native:media/v20200501:StreamingLocator" }, { type: "azure-native:media/v20210601:StreamingLocator" }, { type: "azure-native:media/v20211101:StreamingLocator" }, { type: "azure-native:media/v20220801:StreamingLocator" }, { type: "azure-native:media/v20230101:StreamingLocator" }] };
...
export interface StreamingLocatorArgs {
     ...
     * The ContentKeys used by this Streaming Locator.
     */
    contentKeys?: pulumi.Input<pulumi.Input<inputs.media.v20180701.StreamingLocatorContentKeyArgs>[]>;
    /**
     * Name of the default ContentKeyPolicy used by this Streaming Locator.
     */
