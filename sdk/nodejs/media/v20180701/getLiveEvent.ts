...
export function getLiveEvent(args: GetLiveEventArgs, opts?: pulumi.InvokeOptions): Promise<GetLiveEventResult> {
    pulumi.log.warn("getLiveEvent is deprecated: azure-native:media/v20180701:LiveEvent is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20190501preview:LiveEvent to guarantee forwards compatibility.")
