...
export function getTransform(args: GetTransformArgs, opts?: pulumi.InvokeOptions): Promise<GetTransformResult> {
    pulumi.log.warn("getTransform is deprecated: azure-native:media/v20220501preview:Transform is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Transform to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:media/v20220501preview:getTransform", {
...
export interface GetTransformResult {
     ...
     */
    readonly outputs: outputs.media.v20220501preview.TransformOutputResponse[];
    /**
     * The system metadata relating to this resource.
     */
    readonly systemData: outputs.media.v20220501preview.SystemDataResponse;
    /**
