...
export class Transform extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20220501preview:Transform';
     ...
     */
    public readonly outputs!: pulumi.Output<outputs.media.v20220501preview.TransformOutputResponse[]>;
    /**
    ...
    constructor(name: string, args: TransformArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:Transform" }, { type: "azure-native:media/v20180330preview:Transform" }, { type: "azure-native:media/v20180601preview:Transform" }, { type: "azure-native:media/v20180701:Transform" }, { type: "azure-native:media/v20200501:Transform" }, { type: "azure-native:media/v20210601:Transform" }, { type: "azure-native:media/v20211101:Transform" }, { type: "azure-native:media/v20220701:Transform" }] };
...
export interface TransformArgs {
     ...
     * An array of one or more TransformOutputs that the Transform should generate.
     */
    outputs: pulumi.Input<pulumi.Input<inputs.media.v20220501preview.TransformOutputArgs>[]>;
    /**
