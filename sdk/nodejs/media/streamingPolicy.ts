...
export class StreamingPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly commonEncryptionCbcs!: pulumi.Output<outputs.media.CommonEncryptionCbcsResponse | undefined>;
    /**
     * Configuration of CommonEncryptionCenc
     */
    public readonly commonEncryptionCenc!: pulumi.Output<outputs.media.CommonEncryptionCencResponse | undefined>;
    /**
     ...
     */
    public readonly envelopeEncryption!: pulumi.Output<outputs.media.EnvelopeEncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly noEncryption!: pulumi.Output<outputs.media.NoEncryptionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: StreamingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:StreamingPolicy" }, { type: "azure-native:media/latest:StreamingPolicy" }, { type: "azure-nextgen:media/latest:StreamingPolicy" }, { type: "azure-native:media/v20180330preview:StreamingPolicy" }, { type: "azure-nextgen:media/v20180330preview:StreamingPolicy" }, { type: "azure-native:media/v20180601preview:StreamingPolicy" }, { type: "azure-nextgen:media/v20180601preview:StreamingPolicy" }, { type: "azure-native:media/v20180701:StreamingPolicy" }, { type: "azure-nextgen:media/v20180701:StreamingPolicy" }, { type: "azure-native:media/v20200501:StreamingPolicy" }, { type: "azure-nextgen:media/v20200501:StreamingPolicy" }] };
...
export interface StreamingPolicyArgs {
     ...
     * Configuration of CommonEncryptionCbcs
     */
    readonly commonEncryptionCbcs?: pulumi.Input<inputs.media.CommonEncryptionCbcs>;
    /**
     * Configuration of CommonEncryptionCenc
     */
    readonly commonEncryptionCenc?: pulumi.Input<inputs.media.CommonEncryptionCenc>;
    /**
     * Default ContentKey used by current Streaming Policy
     */
     ...
     * Configuration of EnvelopeEncryption
     */
    readonly envelopeEncryption?: pulumi.Input<inputs.media.EnvelopeEncryption>;
    /**
     * Configurations of NoEncryption
     */
    readonly noEncryption?: pulumi.Input<inputs.media.NoEncryption>;
    /**
