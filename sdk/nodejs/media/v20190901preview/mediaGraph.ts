...
export class MediaGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20190901preview:MediaGraph';
    ...
    constructor(name: string, args: MediaGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20190901preview:MediaGraph" }, { type: "azure-native:media:MediaGraph" }, { type: "azure-nextgen:media:MediaGraph" }, { type: "azure-native:media/v20200201preview:MediaGraph" }, { type: "azure-nextgen:media/v20200201preview:MediaGraph" }] };
...
export interface MediaGraphArgs {
     ...
     * Media Graph sinks
     */
    readonly sinks: pulumi.Input<pulumi.Input<inputs.media.v20190901preview.MediaGraphAssetSinkArgs>[]>;
    /**
     * Media Graph sources
     */
    readonly sources: pulumi.Input<pulumi.Input<inputs.media.v20190901preview.MediaGraphRtspSourceArgs>[]>;
}
