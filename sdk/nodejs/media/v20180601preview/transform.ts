...
export class Transform extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TransformArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:Transform" }, { type: "azurerm:media/preview:Transform" }, { type: "azurerm:media/v20180330preview:Transform" }, { type: "azurerm:media/v20180701:Transform" }, { type: "azurerm:media/v20200501:Transform" }] };
