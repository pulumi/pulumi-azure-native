...
export class Asset extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: AssetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:Asset" }, { type: "azurerm:media/preview:Asset" }, { type: "azurerm:media/v20180330preview:Asset" }, { type: "azurerm:media/v20180701:Asset" }, { type: "azurerm:media/v20200501:Asset" }] };
