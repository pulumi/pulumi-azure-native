 ...
 *
 * const asset = new azurerm.media.v20180601preview.Asset("asset", {
...
export class Asset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20180601preview:Asset';
    ...
    constructor(name: string, args: AssetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:Asset" }, { type: "azurerm:media/v20180330preview:Asset" }, { type: "azurerm:media/v20180701:Asset" }, { type: "azurerm:media/v20200501:Asset" }] };
