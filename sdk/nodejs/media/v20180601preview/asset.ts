...
export class Asset extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20180601preview:Asset" }, { type: "azure-native:media:Asset" }, { type: "azure-nextgen:media:Asset" }, { type: "azure-native:media/latest:Asset" }, { type: "azure-nextgen:media/latest:Asset" }, { type: "azure-native:media/v20180330preview:Asset" }, { type: "azure-nextgen:media/v20180330preview:Asset" }, { type: "azure-native:media/v20180701:Asset" }, { type: "azure-nextgen:media/v20180701:Asset" }, { type: "azure-native:media/v20200501:Asset" }, { type: "azure-nextgen:media/v20200501:Asset" }] };
