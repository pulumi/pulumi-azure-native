...
export function getMediaService(args: GetMediaServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetMediaServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:media/v20180601preview:getMediaService", {
...
export interface GetMediaServiceResult {
     ...
     */
    readonly storageAccounts?: outputs.media.v20180601preview.StorageAccountInvokeResponse[];
    /**
     * Resource tags.
     */
