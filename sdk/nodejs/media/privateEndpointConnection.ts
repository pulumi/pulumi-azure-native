...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:PrivateEndpointConnection" }, { type: "azure-native:media/v20200501:PrivateEndpointConnection" }, { type: "azure-nextgen:media/v20200501:PrivateEndpointConnection" }, { type: "azure-native:media/v20210501:PrivateEndpointConnection" }, { type: "azure-nextgen:media/v20210501:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.media.PrivateLinkServiceConnectionStateArgs>;
    /**
