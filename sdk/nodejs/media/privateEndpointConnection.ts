...
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.media.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.media.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:PrivateEndpointConnection" }, { type: "azure-native:media/v20200501:PrivateEndpointConnection" }, { type: "azure-nextgen:media/v20200501:PrivateEndpointConnection" }, { type: "azure-native:media/v20210501:PrivateEndpointConnection" }, { type: "azure-nextgen:media/v20210501:PrivateEndpointConnection" }, { type: "azure-native:media/v20210601:PrivateEndpointConnection" }, { type: "azure-nextgen:media/v20210601:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.media.PrivateLinkServiceConnectionStateArgs>;
    /**
