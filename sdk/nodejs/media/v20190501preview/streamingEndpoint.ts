 ...
 *
 * const streamingEndpoint = new azurerm.media.v20190501preview.StreamingEndpoint("streamingEndpoint", {
 *     accessControl: {
 *         akamai: {
...
export class StreamingEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20190501preview:StreamingEndpoint';
    ...
    constructor(name: string, args: StreamingEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:StreamingEndpoint" }, { type: "azurerm:media/v20180330preview:StreamingEndpoint" }, { type: "azurerm:media/v20180601preview:StreamingEndpoint" }, { type: "azurerm:media/v20180701:StreamingEndpoint" }, { type: "azurerm:media/v20200501:StreamingEndpoint" }] };
