...
export class StreamingEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StreamingEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20190501preview:StreamingEndpoint" }, { type: "azure-native:media:StreamingEndpoint" }, { type: "azure-nextgen:media:StreamingEndpoint" }, { type: "azure-native:media/latest:StreamingEndpoint" }, { type: "azure-nextgen:media/latest:StreamingEndpoint" }, { type: "azure-native:media/v20180330preview:StreamingEndpoint" }, { type: "azure-nextgen:media/v20180330preview:StreamingEndpoint" }, { type: "azure-native:media/v20180601preview:StreamingEndpoint" }, { type: "azure-nextgen:media/v20180601preview:StreamingEndpoint" }, { type: "azure-native:media/v20180701:StreamingEndpoint" }, { type: "azure-nextgen:media/v20180701:StreamingEndpoint" }, { type: "azure-native:media/v20200501:StreamingEndpoint" }, { type: "azure-nextgen:media/v20200501:StreamingEndpoint" }] };
...
export interface StreamingEndpointArgs {
     ...
     * The access control definition of the StreamingEndpoint.
     */
    readonly accessControl?: pulumi.Input<inputs.media.v20190501preview.StreamingEndpointAccessControl>;
    /**
