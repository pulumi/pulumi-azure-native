 ...
 *
 * @deprecated azure-native:media/v20211101:StreamingEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20221101:StreamingEndpoint to guarantee forwards compatibility.
 */
export class StreamingEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StreamingEndpoint {
        pulumi.log.warn("StreamingEndpoint is deprecated: azure-native:media/v20211101:StreamingEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20221101:StreamingEndpoint to guarantee forwards compatibility.")
        return new StreamingEndpoint(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20211101:StreamingEndpoint';
     ...
     */
    public readonly accessControl!: pulumi.Output<outputs.media.v20211101.StreamingEndpointAccessControlResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.media.v20211101.ArmStreamingEndpointCurrentSkuResponse | undefined>;
    /**
