...
export class StreamingLocator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StreamingLocator {
        pulumi.log.warn("StreamingLocator is deprecated: azure-native:media/v20211101:StreamingLocator is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.")
        return new StreamingLocator(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20211101:StreamingLocator';
     ...
     */
    public readonly contentKeys!: pulumi.Output<outputs.media.v20211101.StreamingLocatorContentKeyResponse[] | undefined>;
    /**
