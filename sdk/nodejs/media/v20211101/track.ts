...
export class Track extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20211101:Track';
     ...
     */
    public readonly track!: pulumi.Output<outputs.media.v20211101.AudioTrackResponse | outputs.media.v20211101.TextTrackResponse | outputs.media.v20211101.VideoTrackResponse | undefined>;
    /**
    ...
    constructor(name: string, args: TrackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:Track" }, { type: "azure-native:media/v20220801:Track" }, { type: "azure-native:media/v20230101:Track" }] };
