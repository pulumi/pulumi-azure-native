...
export function getAsset(args: GetAssetArgs, opts?: pulumi.InvokeOptions): Promise<GetAssetResult> {
    pulumi.log.warn("getAsset is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getAsset'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:media/latest:getAsset", {
