...
export class AssetFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/latest:AssetFilter';
    ...
    constructor(name: string, args: AssetFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/preview:AssetFilter" }, { type: "azurerm:media/v20180701:AssetFilter" }, { type: "azurerm:media/v20200501:AssetFilter" }] };
