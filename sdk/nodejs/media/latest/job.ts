...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/latest:Job';
     ...
     */
    public readonly input!: pulumi.Output<outputs.media.latest.JobInputAssetResponse | outputs.media.latest.JobInputClipResponse | outputs.media.latest.JobInputHttpResponse | outputs.media.latest.JobInputSequenceResponse | outputs.media.latest.JobInputsResponse>;
    /**
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/latest:Job" }, { type: "azure-native:media:Job" }, { type: "azure-nextgen:media:Job" }, { type: "azure-native:media/v20180330preview:Job" }, { type: "azure-nextgen:media/v20180330preview:Job" }, { type: "azure-native:media/v20180601preview:Job" }, { type: "azure-nextgen:media/v20180601preview:Job" }, { type: "azure-native:media/v20180701:Job" }, { type: "azure-nextgen:media/v20180701:Job" }, { type: "azure-native:media/v20200501:Job" }, { type: "azure-nextgen:media/v20200501:Job" }] };
...
export interface JobArgs {
     ...
     * The inputs for the Job.
     */
    readonly input: pulumi.Input<inputs.media.latest.JobInputAsset | inputs.media.latest.JobInputClip | inputs.media.latest.JobInputHttp | inputs.media.latest.JobInputSequence | inputs.media.latest.JobInputs>;
    /**
     * The Job name.
     */
     ...
     * Priority with which the job should be processed. Higher priority jobs are processed before lower priority jobs. If not set, the default is normal.
     */
    readonly priority?: pulumi.Input<string | enums.media.latest.Priority>;
    /**
