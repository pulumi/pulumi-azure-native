 ...
 *
 * const job = new azurerm.media.latest.Job("job", {
...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/latest:Job';
    ...
    constructor(name: string, argsOrState?: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/v20180330preview:Job" }, { type: "azurerm:media/v20180601preview:Job" }, { type: "azurerm:media/v20180701:Job" }, { type: "azurerm:media/v20200501:Job" }] };
