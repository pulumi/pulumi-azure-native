...
export class LiveOutput extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LiveOutputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/v20180330preview:LiveOutput" }, { type: "azurerm:media/v20180601preview:LiveOutput" }, { type: "azurerm:media/v20180701:LiveOutput" }, { type: "azurerm:media/v20190501preview:LiveOutput" }, { type: "azurerm:media/v20200501:LiveOutput" }] };
