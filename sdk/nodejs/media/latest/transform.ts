...
export class Transform extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/latest:Transform';
     ...
     */
    public readonly outputs!: pulumi.Output<outputs.media.latest.TransformOutputResponse[]>;
    /**
    ...
    constructor(name: string, args: TransformArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/latest:Transform" }, { type: "azure-native:media:Transform" }, { type: "azure-nextgen:media:Transform" }, { type: "azure-native:media/v20180330preview:Transform" }, { type: "azure-nextgen:media/v20180330preview:Transform" }, { type: "azure-native:media/v20180601preview:Transform" }, { type: "azure-nextgen:media/v20180601preview:Transform" }, { type: "azure-native:media/v20180701:Transform" }, { type: "azure-nextgen:media/v20180701:Transform" }, { type: "azure-native:media/v20200501:Transform" }, { type: "azure-nextgen:media/v20200501:Transform" }] };
...
export interface TransformArgs {
     ...
     * An array of one or more TransformOutputs that the Transform should generate.
     */
    readonly outputs: pulumi.Input<pulumi.Input<inputs.media.latest.TransformOutput>[]>;
    /**
