...
export class LiveEvent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/latest:LiveEvent';
...
export interface LiveEventArgs {
     ...
     * The options to use for the LiveEvent. This value is specified at creation time and cannot be updated. The valid values for the array entry values are 'Default' and 'LowLatency'.
     */
    readonly streamOptions?: pulumi.Input<pulumi.Input<string | enums.media.latest.StreamOptionsFlag>[]>;
    /**
     * Resource tags.
     */
