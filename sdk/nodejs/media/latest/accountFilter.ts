...
export class AccountFilter extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: AccountFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/preview:AccountFilter" }, { type: "azurerm:media/v20180701:AccountFilter" }, { type: "azurerm:media/v20200501:AccountFilter" }] };
