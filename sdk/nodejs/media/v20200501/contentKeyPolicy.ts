...
export class ContentKeyPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20200501:ContentKeyPolicy';
    ...
    constructor(name: string, args: ContentKeyPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20200501:ContentKeyPolicy" }, { type: "azure-native:media:ContentKeyPolicy" }, { type: "azure-nextgen:media:ContentKeyPolicy" }, { type: "azure-native:media/v20180330preview:ContentKeyPolicy" }, { type: "azure-nextgen:media/v20180330preview:ContentKeyPolicy" }, { type: "azure-native:media/v20180601preview:ContentKeyPolicy" }, { type: "azure-nextgen:media/v20180601preview:ContentKeyPolicy" }, { type: "azure-native:media/v20180701:ContentKeyPolicy" }, { type: "azure-nextgen:media/v20180701:ContentKeyPolicy" }, { type: "azure-native:media/v20210601:ContentKeyPolicy" }, { type: "azure-nextgen:media/v20210601:ContentKeyPolicy" }] };
...
export interface ContentKeyPolicyArgs {
     ...
     * The Key Policy options.
     */
    options: pulumi.Input<pulumi.Input<inputs.media.v20200501.ContentKeyPolicyOptionArgs>[]>;
    /**
