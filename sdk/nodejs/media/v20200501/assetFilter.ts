 ...
 *
 * const assetFilter = new azure_native.media.v20200501.AssetFilter("assetFilter", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:media/v20200501:AssetFilter newAssetFilter /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contoso/providers/Microsoft.Media/mediaservices/contosomedia/assets/ClimbingMountRainer/assetFilters/newAssetFilter 
 * ```
 */
export class AssetFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20200501:AssetFilter';
    ...
    constructor(name: string, args: AssetFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:AssetFilter" }, { type: "azure-native:media/v20180701:AssetFilter" }, { type: "azure-native:media/v20210601:AssetFilter" }, { type: "azure-native:media/v20211101:AssetFilter" }, { type: "azure-native:media/v20220801:AssetFilter" }, { type: "azure-native:media/v20230101:AssetFilter" }] };
