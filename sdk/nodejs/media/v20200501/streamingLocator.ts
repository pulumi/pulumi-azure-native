...
export class StreamingLocator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StreamingLocatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/latest:StreamingLocator" }, { type: "azure-nextgen:media/v20180330preview:StreamingLocator" }, { type: "azure-nextgen:media/v20180601preview:StreamingLocator" }, { type: "azure-nextgen:media/v20180701:StreamingLocator" }] };
