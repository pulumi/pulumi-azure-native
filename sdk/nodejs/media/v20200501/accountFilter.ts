...
export class AccountFilter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccountFilter {
        pulumi.log.warn("AccountFilter is deprecated: azure-native:media/v20200501:AccountFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:AccountFilter to guarantee forwards compatibility.")
        return new AccountFilter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20200501:AccountFilter';
    ...
    constructor(name: string, args: AccountFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:AccountFilter" }, { type: "azure-native:media/v20180701:AccountFilter" }, { type: "azure-native:media/v20210601:AccountFilter" }, { type: "azure-native:media/v20211101:AccountFilter" }, { type: "azure-native:media/v20220801:AccountFilter" }, { type: "azure-native:media/v20230101:AccountFilter" }] };
...
export interface AccountFilterArgs {
     ...
     * The first quality.
     */
    firstQuality?: pulumi.Input<inputs.media.v20200501.FirstQualityArgs>;
    /**
     * The presentation time range.
     */
    presentationTimeRange?: pulumi.Input<inputs.media.v20200501.PresentationTimeRangeArgs>;
    /**
     ...
     * The tracks selection conditions.
     */
    tracks?: pulumi.Input<pulumi.Input<inputs.media.v20200501.FilterTrackSelectionArgs>[]>;
}
