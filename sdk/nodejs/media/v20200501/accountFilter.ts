...
export class AccountFilter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20200501:AccountFilter" }, { type: "azure-native:media:AccountFilter" }, { type: "azure-nextgen:media:AccountFilter" }, { type: "azure-native:media/v20180701:AccountFilter" }, { type: "azure-nextgen:media/v20180701:AccountFilter" }] };
...
export interface AccountFilterArgs {
     ...
     * The first quality.
     */
    readonly firstQuality?: pulumi.Input<inputs.media.v20200501.FirstQualityArgs>;
    /**
     * The presentation time range.
     */
    readonly presentationTimeRange?: pulumi.Input<inputs.media.v20200501.PresentationTimeRangeArgs>;
    /**
     ...
     * The tracks selection conditions.
     */
    readonly tracks?: pulumi.Input<pulumi.Input<inputs.media.v20200501.FilterTrackSelectionArgs>[]>;
}
