...
export class AccountFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20200501:AccountFilter';
    ...
    constructor(name: string, argsOrState?: AccountFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:AccountFilter" }, { type: "azurerm:media/preview:AccountFilter" }, { type: "azurerm:media/v20180701:AccountFilter" }] };
