...
export class AccountFilter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:AccountFilter" }, { type: "azure-native:media/v20211101:AccountFilter" }, { type: "azure-native:media/v20230101:AccountFilter" }] };
