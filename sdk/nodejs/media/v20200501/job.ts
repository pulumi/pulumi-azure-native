 ...
 *
 * const job = new azurerm.media.v20200501.Job("job", {
...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20200501:Job';
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:Job" }, { type: "azurerm:media/v20180330preview:Job" }, { type: "azurerm:media/v20180601preview:Job" }, { type: "azurerm:media/v20180701:Job" }] };
...
export interface JobArgs {
     ...
     * The inputs for the Job.
     */
    readonly input: pulumi.Input<inputs.media.v20200501.JobInputClip | inputs.media.v20200501.JobInputs>;
    /**
     * The Job name.
     */
