...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20200501:Job';
     ...
     */
    public readonly outputs!: pulumi.Output<outputs.media.v20200501.JobOutputAssetResponse[]>;
    /**
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20200501:Job" }, { type: "azure-native:media:Job" }, { type: "azure-nextgen:media:Job" }, { type: "azure-native:media/latest:Job" }, { type: "azure-nextgen:media/latest:Job" }, { type: "azure-native:media/v20180330preview:Job" }, { type: "azure-nextgen:media/v20180330preview:Job" }, { type: "azure-native:media/v20180601preview:Job" }, { type: "azure-nextgen:media/v20180601preview:Job" }, { type: "azure-native:media/v20180701:Job" }, { type: "azure-nextgen:media/v20180701:Job" }] };
...
export interface JobArgs {
     ...
     * The outputs for the Job.
     */
    readonly outputs: pulumi.Input<pulumi.Input<inputs.media.v20200501.JobOutputAsset>[]>;
    /**
     * Priority with which the job should be processed. Higher priority jobs are processed before lower priority jobs. If not set, the default is normal.
     */
