...
export class Job extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:Job" }, { type: "azurerm:media/preview:Job" }, { type: "azurerm:media/v20180330preview:Job" }, { type: "azurerm:media/v20180601preview:Job" }, { type: "azurerm:media/v20180701:Job" }] };
