...
export class MediaService extends pulumi.CustomResource {
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.media.v20200501.AccountEncryptionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: MediaServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20200501:MediaService" }, { type: "azure-native:media:MediaService" }, { type: "azure-nextgen:media:MediaService" }, { type: "azure-native:media/v20151001:MediaService" }, { type: "azure-nextgen:media/v20151001:MediaService" }, { type: "azure-native:media/v20180330preview:MediaService" }, { type: "azure-nextgen:media/v20180330preview:MediaService" }, { type: "azure-native:media/v20180601preview:MediaService" }, { type: "azure-nextgen:media/v20180601preview:MediaService" }, { type: "azure-native:media/v20180701:MediaService" }, { type: "azure-nextgen:media/v20180701:MediaService" }, { type: "azure-native:media/v20210501:MediaService" }, { type: "azure-nextgen:media/v20210501:MediaService" }, { type: "azure-native:media/v20210601:MediaService" }, { type: "azure-nextgen:media/v20210601:MediaService" }] };
...
export interface MediaServiceArgs {
     ...
     * The account encryption properties.
     */
    encryption?: pulumi.Input<inputs.media.v20200501.AccountEncryptionArgs>;
    /**
     * The Managed Identity for the Media Services account.
     */
    identity?: pulumi.Input<inputs.media.v20200501.MediaServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The storage accounts for this resource.
     */
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.media.v20200501.StorageAccountArgs>[]>;
    storageAuthentication?: pulumi.Input<string | enums.media.v20200501.StorageAuthentication>;
    /**
     * Resource tags.
     */
