...
export class LiveOutput extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: LiveOutputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:LiveOutput" }, { type: "azurerm:media/preview:LiveOutput" }, { type: "azurerm:media/v20180330preview:LiveOutput" }, { type: "azurerm:media/v20180601preview:LiveOutput" }, { type: "azurerm:media/v20180701:LiveOutput" }, { type: "azurerm:media/v20190501preview:LiveOutput" }] };
