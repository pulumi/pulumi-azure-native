...
export class LiveOutput extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20200501:LiveOutput';
    ...
    constructor(name: string, args: LiveOutputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20200501:LiveOutput" }, { type: "azure-native:media:LiveOutput" }, { type: "azure-nextgen:media:LiveOutput" }, { type: "azure-native:media/v20180330preview:LiveOutput" }, { type: "azure-nextgen:media/v20180330preview:LiveOutput" }, { type: "azure-native:media/v20180601preview:LiveOutput" }, { type: "azure-nextgen:media/v20180601preview:LiveOutput" }, { type: "azure-native:media/v20180701:LiveOutput" }, { type: "azure-nextgen:media/v20180701:LiveOutput" }, { type: "azure-native:media/v20190501preview:LiveOutput" }, { type: "azure-nextgen:media/v20190501preview:LiveOutput" }, { type: "azure-native:media/v20210601:LiveOutput" }, { type: "azure-nextgen:media/v20210601:LiveOutput" }] };
...
export interface LiveOutputArgs {
     ...
     * HTTP Live Streaming (HLS) packing setting for the live output.
     */
    hls?: pulumi.Input<inputs.media.v20200501.HlsArgs>;
    /**
