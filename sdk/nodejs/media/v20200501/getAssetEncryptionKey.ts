...
export function getAssetEncryptionKey(args: GetAssetEncryptionKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetAssetEncryptionKeyResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:media/v20200501:getAssetEncryptionKey", {
...
export interface GetAssetEncryptionKeyResult {
     ...
     */
    readonly assetFileEncryptionMetadata?: outputs.media.v20200501.AssetFileEncryptionMetadataInvokeResponse[];
    /**
