...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20200501:PrivateEndpointConnection" }, { type: "azure-native:media:PrivateEndpointConnection" }, { type: "azure-nextgen:media:PrivateEndpointConnection" }] };
