...
export class StreamingPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly commonEncryptionCbcs!: pulumi.Output<outputs.media.v20200501.CommonEncryptionCbcsResponse | undefined>;
    /**
     * Configuration of CommonEncryptionCenc
     */
    public readonly commonEncryptionCenc!: pulumi.Output<outputs.media.v20200501.CommonEncryptionCencResponse | undefined>;
    /**
     ...
     */
    public readonly envelopeEncryption!: pulumi.Output<outputs.media.v20200501.EnvelopeEncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly noEncryption!: pulumi.Output<outputs.media.v20200501.NoEncryptionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: StreamingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20200501:StreamingPolicy" }, { type: "azure-native:media:StreamingPolicy" }, { type: "azure-nextgen:media:StreamingPolicy" }, { type: "azure-native:media/v20180330preview:StreamingPolicy" }, { type: "azure-nextgen:media/v20180330preview:StreamingPolicy" }, { type: "azure-native:media/v20180601preview:StreamingPolicy" }, { type: "azure-nextgen:media/v20180601preview:StreamingPolicy" }, { type: "azure-native:media/v20180701:StreamingPolicy" }, { type: "azure-nextgen:media/v20180701:StreamingPolicy" }, { type: "azure-native:media/v20210601:StreamingPolicy" }, { type: "azure-nextgen:media/v20210601:StreamingPolicy" }] };
...
export interface StreamingPolicyArgs {
     ...
     * Configuration of CommonEncryptionCbcs
     */
    commonEncryptionCbcs?: pulumi.Input<inputs.media.v20200501.CommonEncryptionCbcsArgs>;
    /**
     * Configuration of CommonEncryptionCenc
     */
    commonEncryptionCenc?: pulumi.Input<inputs.media.v20200501.CommonEncryptionCencArgs>;
    /**
     * Default ContentKey used by current Streaming Policy
     */
     ...
     * Configuration of EnvelopeEncryption
     */
    envelopeEncryption?: pulumi.Input<inputs.media.v20200501.EnvelopeEncryptionArgs>;
    /**
     * Configurations of NoEncryption
     */
    noEncryption?: pulumi.Input<inputs.media.v20200501.NoEncryptionArgs>;
    /**
