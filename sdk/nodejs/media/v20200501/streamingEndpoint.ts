...
export class StreamingEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20200501:StreamingEndpoint';
...
export interface StreamingEndpointArgs {
     ...
     * The access control definition of the streaming endpoint.
     */
    accessControl?: pulumi.Input<inputs.media.v20200501.StreamingEndpointAccessControlArgs>;
    /**
