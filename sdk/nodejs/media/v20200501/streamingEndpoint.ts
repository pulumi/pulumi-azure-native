 ...
 *
 * const streamingEndpoint = new azure_native.media.v20200501.StreamingEndpoint("streamingEndpoint", {
 *     accessControl: {
 *         akamai: {
