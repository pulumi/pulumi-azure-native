...
export function getStreamingEndpoint(args: GetStreamingEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamingEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:media/v20180330preview:getStreamingEndpoint", {
...
export interface GetStreamingEndpointResult {
     ...
     */
    readonly accessControl?: outputs.media.v20180330preview.StreamingEndpointAccessControlInvokeResponse;
    /**
