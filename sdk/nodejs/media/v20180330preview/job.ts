...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20180330preview:Job';
     ...
     */
    public readonly input!: pulumi.Output<outputs.media.v20180330preview.JobInputResponse>;
    /**
     ...
     */
    public readonly outputs!: pulumi.Output<outputs.media.v20180330preview.JobOutputResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:Job" }, { type: "azurerm:media/preview:Job" }, { type: "azurerm:media/v20180601preview:Job" }, { type: "azurerm:media/v20180701:Job" }, { type: "azurerm:media/v20200501:Job" }] };
...
export interface JobArgs {
     ...
     * The inputs for the Job.
     */
    readonly input: pulumi.Input<inputs.media.v20180330preview.JobInput>;
    /**
     * The Job name.
     */
     ...
     * The outputs for the Job.
     */
    readonly outputs: pulumi.Input<pulumi.Input<inputs.media.v20180330preview.JobOutput>[]>;
    /**
     * Priority with which the job should be processed. Higher priority jobs are processed before lower priority jobs. If not set, the default is normal.
     */
