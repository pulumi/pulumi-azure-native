...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:media/v20180330preview:Job';
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:Job" }, { type: "azure-nextgen:media/latest:Job" }, { type: "azure-nextgen:media/v20180601preview:Job" }, { type: "azure-nextgen:media/v20180701:Job" }, { type: "azure-nextgen:media/v20200501:Job" }] };
