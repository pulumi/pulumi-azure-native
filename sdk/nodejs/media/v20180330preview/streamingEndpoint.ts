...
export class StreamingEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: StreamingEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:StreamingEndpoint" }, { type: "azurerm:media/preview:StreamingEndpoint" }, { type: "azurerm:media/v20180601preview:StreamingEndpoint" }, { type: "azurerm:media/v20180701:StreamingEndpoint" }, { type: "azurerm:media/v20190501preview:StreamingEndpoint" }, { type: "azurerm:media/v20200501:StreamingEndpoint" }] };
