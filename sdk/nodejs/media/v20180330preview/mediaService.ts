...
export class MediaService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MediaServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:MediaService" }, { type: "azurerm:media/v20151001:MediaService" }, { type: "azurerm:media/v20180601preview:MediaService" }, { type: "azurerm:media/v20180701:MediaService" }, { type: "azurerm:media/v20200501:MediaService" }] };
