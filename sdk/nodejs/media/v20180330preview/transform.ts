 ...
 *
 * const transform = new azurerm.media.v20180330preview.Transform("transform", {
...
export class Transform extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20180330preview:Transform';
    ...
    constructor(name: string, args: TransformArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:Transform" }, { type: "azurerm:media/v20180601preview:Transform" }, { type: "azurerm:media/v20180701:Transform" }, { type: "azurerm:media/v20200501:Transform" }] };
