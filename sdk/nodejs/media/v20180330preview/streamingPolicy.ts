...
export class StreamingPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StreamingPolicy {
        pulumi.log.warn("StreamingPolicy is deprecated: azure-native:media/v20180330preview:StreamingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.")
