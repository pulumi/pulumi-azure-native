 ...
 *
 * const streamingLocator = new azurerm.media.v20180330preview.StreamingLocator("streamingLocator", {
...
export class StreamingLocator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20180330preview:StreamingLocator';
    ...
    constructor(name: string, args: StreamingLocatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:StreamingLocator" }, { type: "azurerm:media/v20180601preview:StreamingLocator" }, { type: "azurerm:media/v20180701:StreamingLocator" }, { type: "azurerm:media/v20200501:StreamingLocator" }] };
