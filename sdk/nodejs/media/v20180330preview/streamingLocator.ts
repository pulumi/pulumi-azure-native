...
export class StreamingLocator extends pulumi.CustomResource {
     ...
     */
    public readonly contentKeys!: pulumi.Output<outputs.media.v20180330preview.StreamingLocatorUserDefinedContentKeyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: StreamingLocatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media/v20180601preview:StreamingLocator" }, { type: "azure-native:media/v20180701:StreamingLocator" }, { type: "azure-native:media/v20200501:StreamingLocator" }, { type: "azure-native:media/v20210601:StreamingLocator" }, { type: "azure-native:media/v20211101:StreamingLocator" }, { type: "azure-native:media/v20220801:StreamingLocator" }, { type: "azure-native:media/v20230101:StreamingLocator" }, { type: "azure-native:media:StreamingLocator" }] };
...
export interface StreamingLocatorArgs {
     ...
     * ContentKeys used by this Streaming Locator
     */
    contentKeys?: pulumi.Input<pulumi.Input<inputs.media.v20180330preview.StreamingLocatorUserDefinedContentKeyArgs>[]>;
    /**
     * Default ContentKeyPolicy used by this Streaming Locator
     */
