 ...
 *
 * const contentKeyPolicy = new azurerm.media.v20180330preview.ContentKeyPolicy("contentKeyPolicy", {
...
export class ContentKeyPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media/v20180330preview:ContentKeyPolicy';
    ...
    constructor(name: string, args: ContentKeyPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:media/latest:ContentKeyPolicy" }, { type: "azurerm:media/v20180601preview:ContentKeyPolicy" }, { type: "azurerm:media/v20180701:ContentKeyPolicy" }, { type: "azurerm:media/v20200501:ContentKeyPolicy" }] };
