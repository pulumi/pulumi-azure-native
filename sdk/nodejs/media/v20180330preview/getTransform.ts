...
export function getTransform(args: GetTransformArgs, opts?: pulumi.InvokeOptions): Promise<GetTransformResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:media/v20180330preview:getTransform", {
...
export interface GetTransformResult {
     ...
     */
    readonly outputs: outputs.media.v20180330preview.TransformOutputInvokeResponse[];
    /**
