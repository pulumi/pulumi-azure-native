...
export class LiveEvent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:media/v20180330preview:LiveEvent';
    ...
    constructor(name: string, args: LiveEventArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:LiveEvent" }, { type: "azure-nextgen:media/latest:LiveEvent" }, { type: "azure-nextgen:media/v20180601preview:LiveEvent" }, { type: "azure-nextgen:media/v20180701:LiveEvent" }, { type: "azure-nextgen:media/v20190501preview:LiveEvent" }, { type: "azure-nextgen:media/v20200501:LiveEvent" }] };
...
export interface LiveEventArgs {
     ...
     * The Live Event encoding.
     */
    readonly encoding?: pulumi.Input<inputs.media.v20180330preview.LiveEventEncoding>;
    /**
     * The Live Event input.
     */
    readonly input: pulumi.Input<inputs.media.v20180330preview.LiveEventInput>;
    /**
     ...
     * The Live Event preview.
     */
    readonly preview?: pulumi.Input<inputs.media.v20180330preview.LiveEventPreview>;
    /**
