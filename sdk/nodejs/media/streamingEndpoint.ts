...
export interface StreamingEndpointArgs {
     ...
     * The access control definition of the streaming endpoint.
     */
    readonly accessControl?: pulumi.Input<inputs.media.StreamingEndpointAccessControlArgs>;
    /**
