...
export class StreamingEndpoint extends pulumi.CustomResource {
     ...
     */
    public readonly accessControl!: pulumi.Output<outputs.media.StreamingEndpointAccessControlResponse | undefined>;
    /**
...
export interface StreamingEndpointArgs {
     ...
     * The streaming endpoint access policies.
     */
    readonly crossSiteAccessPolicies?: pulumi.Input<inputs.media.CrossSiteAccessPolicies>;
    /**
     * The custom host names of the streaming endpoint
     */
