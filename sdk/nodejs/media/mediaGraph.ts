...
export class MediaGraph extends pulumi.CustomResource {
     ...
     * Media Graph sinks.
     */
    public readonly sinks!: pulumi.Output<outputs.media.MediaGraphAssetSinkResponse[]>;
    /**
     * Media Graph sources.
     */
    public readonly sources!: pulumi.Output<outputs.media.MediaGraphRtspSourceResponse[]>;
    /**
