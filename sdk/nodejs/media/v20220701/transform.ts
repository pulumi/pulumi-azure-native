 ...
 *
 * const transform = new azure_native.media.v20220701.Transform("transform", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:media/v20220701:Transform createdTransform /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contosoresources/providers/Microsoft.Media/mediaservices/contosomedia/transforms/createdTransform 
 * ```
 */
