...
export class ContentKeyPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ContentKeyPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:ContentKeyPolicy" }, { type: "azure-native:media/latest:ContentKeyPolicy" }, { type: "azure-nextgen:media/latest:ContentKeyPolicy" }, { type: "azure-native:media/v20180330preview:ContentKeyPolicy" }, { type: "azure-nextgen:media/v20180330preview:ContentKeyPolicy" }, { type: "azure-native:media/v20180601preview:ContentKeyPolicy" }, { type: "azure-nextgen:media/v20180601preview:ContentKeyPolicy" }, { type: "azure-native:media/v20180701:ContentKeyPolicy" }, { type: "azure-nextgen:media/v20180701:ContentKeyPolicy" }, { type: "azure-native:media/v20200501:ContentKeyPolicy" }, { type: "azure-nextgen:media/v20200501:ContentKeyPolicy" }] };
...
export interface ContentKeyPolicyArgs {
     ...
     * The Key Policy options.
     */
    readonly options: pulumi.Input<pulumi.Input<inputs.media.ContentKeyPolicyOption>[]>;
    /**
