...
export class StreamingLocator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:media:StreamingLocator';
    ...
    constructor(name: string, args: StreamingLocatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/latest:StreamingLocator" }, { type: "azure-nextgen:media/v20180330preview:StreamingLocator" }, { type: "azure-nextgen:media/v20180601preview:StreamingLocator" }, { type: "azure-nextgen:media/v20180701:StreamingLocator" }, { type: "azure-nextgen:media/v20200501:StreamingLocator" }] };
