...
export class StreamingLocator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:media:StreamingLocator';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.media.StreamingLocatorPropertiesResponse>;
    /**
...
export interface StreamingLocatorArgs {
     ...
     * Properties of the Streaming Locator.
     */
    readonly properties?: pulumi.Input<inputs.media.StreamingLocatorProperties>;
    /**
