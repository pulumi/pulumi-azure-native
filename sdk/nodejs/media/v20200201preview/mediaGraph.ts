...
export class MediaGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:media/v20200201preview:MediaGraph';
    ...
    constructor(name: string, args: MediaGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media/v20190901preview:MediaGraph" }] };
