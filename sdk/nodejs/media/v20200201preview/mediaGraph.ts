...
export class MediaGraph extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MediaGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:MediaGraph" }, { type: "azure-nextgen:media:MediaGraph" }, { type: "azure-native:media/v20190901preview:MediaGraph" }, { type: "azure-nextgen:media/v20190901preview:MediaGraph" }] };
