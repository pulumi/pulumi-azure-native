...
export function getStreamingEndpoint(args: GetStreamingEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamingEndpointResult> {
    pulumi.log.warn("getStreamingEndpoint is deprecated: azure-native:media/v20210601:StreamingEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20221101:StreamingEndpoint to guarantee forwards compatibility.")
