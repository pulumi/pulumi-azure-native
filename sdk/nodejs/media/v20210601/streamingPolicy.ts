 ...
 *
 * @deprecated azure-native:media/v20210601:StreamingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.
 */
export class StreamingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20210601:StreamingPolicy';
     ...
     */
    public readonly commonEncryptionCbcs!: pulumi.Output<outputs.media.v20210601.CommonEncryptionCbcsResponse | undefined>;
    /**
     * Configuration of CommonEncryptionCenc
     */
    public readonly commonEncryptionCenc!: pulumi.Output<outputs.media.v20210601.CommonEncryptionCencResponse | undefined>;
    /**
     ...
     */
    public readonly envelopeEncryption!: pulumi.Output<outputs.media.v20210601.EnvelopeEncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly noEncryption!: pulumi.Output<outputs.media.v20210601.NoEncryptionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: StreamingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:StreamingPolicy" }, { type: "azure-native:media/v20180330preview:StreamingPolicy" }, { type: "azure-native:media/v20180601preview:StreamingPolicy" }, { type: "azure-native:media/v20180701:StreamingPolicy" }, { type: "azure-native:media/v20200501:StreamingPolicy" }, { type: "azure-native:media/v20211101:StreamingPolicy" }, { type: "azure-native:media/v20220801:StreamingPolicy" }, { type: "azure-native:media/v20230101:StreamingPolicy" }] };
...
export interface StreamingPolicyArgs {
     ...
     * Configuration of CommonEncryptionCbcs
     */
    commonEncryptionCbcs?: pulumi.Input<inputs.media.v20210601.CommonEncryptionCbcsArgs>;
    /**
     * Configuration of CommonEncryptionCenc
     */
    commonEncryptionCenc?: pulumi.Input<inputs.media.v20210601.CommonEncryptionCencArgs>;
    /**
     * Default ContentKey used by current Streaming Policy
     */
     ...
     * Configuration of EnvelopeEncryption
     */
    envelopeEncryption?: pulumi.Input<inputs.media.v20210601.EnvelopeEncryptionArgs>;
    /**
     * Configurations of NoEncryption
     */
    noEncryption?: pulumi.Input<inputs.media.v20210601.NoEncryptionArgs>;
    /**
