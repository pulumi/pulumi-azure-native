 ...
 */
/** @deprecated azure-native:media/v20210601:AssetFilter is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:AssetFilter to guarantee forwards compatibility. */
export function getAssetFilter(args: GetAssetFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetAssetFilterResult> {
    pulumi.log.warn("getAssetFilter is deprecated: azure-native:media/v20210601:AssetFilter is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:AssetFilter to guarantee forwards compatibility.")
