...
export class LiveEvent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20210601:LiveEvent';
     ...
     */
    public readonly crossSiteAccessPolicies!: pulumi.Output<outputs.media.v20210601.CrossSiteAccessPoliciesResponse | undefined>;
    /**
     ...
     */
    public readonly encoding!: pulumi.Output<outputs.media.v20210601.LiveEventEncodingResponse | undefined>;
    /**
     ...
     */
    public readonly input!: pulumi.Output<outputs.media.v20210601.LiveEventInputResponse>;
    /**
     ...
     */
    public readonly preview!: pulumi.Output<outputs.media.v20210601.LiveEventPreviewResponse | undefined>;
    /**
     ...
     */
    public readonly transcriptions!: pulumi.Output<outputs.media.v20210601.LiveEventTranscriptionResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: LiveEventArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:LiveEvent" }, { type: "azure-native:media/v20180330preview:LiveEvent" }, { type: "azure-native:media/v20180601preview:LiveEvent" }, { type: "azure-native:media/v20180701:LiveEvent" }, { type: "azure-native:media/v20190501preview:LiveEvent" }, { type: "azure-native:media/v20200501:LiveEvent" }] };
...
export interface LiveEventArgs {
     ...
     * Live event cross site access policies.
     */
    crossSiteAccessPolicies?: pulumi.Input<inputs.media.v20210601.CrossSiteAccessPoliciesArgs>;
    /**
     * A description for the live event.
     */
     ...
     * Encoding settings for the live event. It configures whether a live encoder is used for the live event and settings for the live encoder if it is used.
     */
    encoding?: pulumi.Input<inputs.media.v20210601.LiveEventEncodingArgs>;
    /**
     * When useStaticHostname is set to true, the hostnamePrefix specifies the first part of the hostname assigned to the live event preview and ingest endpoints. The final hostname would be a combination of this prefix, the media service account name and a short code for the Azure Media Services data center.
     */
     ...
     * Live event input settings. It defines how the live event receives input from a contribution encoder.
     */
    input: pulumi.Input<inputs.media.v20210601.LiveEventInputArgs>;
    /**
     ...
     * Live event preview settings. Preview allows live event producers to preview the live streaming content without creating any live output.
     */
    preview?: pulumi.Input<inputs.media.v20210601.LiveEventPreviewArgs>;
    /**
     ...
     * The options to use for the LiveEvent. This value is specified at creation time and cannot be updated. The valid values for the array entry values are 'Default' and 'LowLatency'.
     */
    streamOptions?: pulumi.Input<pulumi.Input<string | enums.media.v20210601.StreamOptionsFlag>[]>;
    /**
     * Resource tags.
     */
     ...
     * Live transcription settings for the live event. See https://go.microsoft.com/fwlink/?linkid=2133742 for more information about the live transcription feature.
     */
    transcriptions?: pulumi.Input<pulumi.Input<inputs.media.v20210601.LiveEventTranscriptionArgs>[]>;
    /**
     * Specifies whether a static hostname would be assigned to the live event preview and ingest endpoints. This value can only be updated if the live event is in Standby state
     */
