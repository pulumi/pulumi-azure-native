...
export function getStreamingLocator(args: GetStreamingLocatorArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamingLocatorResult> {
    pulumi.log.warn("getStreamingLocator is deprecated: azure-native:media/v20210601:StreamingLocator is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.")
