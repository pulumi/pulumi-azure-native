...
export class StreamingLocator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20210601:StreamingLocator';
     ...
     */
    public readonly contentKeys!: pulumi.Output<outputs.media.v20210601.StreamingLocatorContentKeyResponse[] | undefined>;
    /**
...
export interface StreamingLocatorArgs {
     ...
     * The ContentKeys used by this Streaming Locator.
     */
    contentKeys?: pulumi.Input<pulumi.Input<inputs.media.v20210601.StreamingLocatorContentKeyArgs>[]>;
    /**
     * Name of the default ContentKeyPolicy used by this Streaming Locator.
     */
