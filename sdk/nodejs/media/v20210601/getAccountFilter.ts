...
export function getAccountFilter(args: GetAccountFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountFilterResult> {
    pulumi.log.warn("getAccountFilter is deprecated: azure-native:media/v20210601:AccountFilter is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:AccountFilter to guarantee forwards compatibility.")
