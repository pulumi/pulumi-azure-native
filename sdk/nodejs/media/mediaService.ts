...
export class MediaService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MediaServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:media:MediaService" }, { type: "azure-native:media/latest:MediaService" }, { type: "azure-nextgen:media/latest:MediaService" }, { type: "azure-native:media/v20151001:MediaService" }, { type: "azure-nextgen:media/v20151001:MediaService" }, { type: "azure-native:media/v20180330preview:MediaService" }, { type: "azure-nextgen:media/v20180330preview:MediaService" }, { type: "azure-native:media/v20180601preview:MediaService" }, { type: "azure-nextgen:media/v20180601preview:MediaService" }, { type: "azure-native:media/v20180701:MediaService" }, { type: "azure-nextgen:media/v20180701:MediaService" }, { type: "azure-native:media/v20200501:MediaService" }, { type: "azure-nextgen:media/v20200501:MediaService" }] };
...
export interface MediaServiceArgs {
     ...
     * The account encryption properties.
     */
    readonly encryption?: pulumi.Input<inputs.media.AccountEncryption>;
    /**
     * The Managed Identity for the Media Services account.
     */
     ...
     * The storage accounts for this resource.
     */
    readonly storageAccounts?: pulumi.Input<pulumi.Input<inputs.media.StorageAccount>[]>;
