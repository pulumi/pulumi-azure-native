...
export class MediaserviceLiveEvent extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MediaserviceLiveEvent {
        return new MediaserviceLiveEvent(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: MediaserviceLiveEventArgs, opts?: pulumi.CustomResourceOptions) {
