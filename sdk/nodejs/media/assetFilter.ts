...
export class AssetFilter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssetFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media/v20200501:AssetFilter" }, { type: "azure-native:media/v20211101:AssetFilter" }, { type: "azure-native:media/v20230101:AssetFilter" }] };
