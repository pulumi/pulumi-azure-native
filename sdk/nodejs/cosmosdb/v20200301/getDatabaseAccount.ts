...
export function getDatabaseAccount(args: GetDatabaseAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cosmosdb/v20200301:getDatabaseAccount", {
...
export interface GetDatabaseAccountResult {
     ...
     */
    readonly capabilities?: outputs.cosmosdb.v20200301.CapabilityResponse[];
    /**
     ...
     */
    readonly consistencyPolicy?: outputs.cosmosdb.v20200301.ConsistencyPolicyResponse;
    /**
     ...
     */
    readonly failoverPolicies: outputs.cosmosdb.v20200301.FailoverPolicyResponse[];
    /**
     ...
     */
    readonly locations: outputs.cosmosdb.v20200301.LocationResponse[];
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.cosmosdb.v20200301.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly readLocations: outputs.cosmosdb.v20200301.LocationResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: outputs.cosmosdb.v20200301.VirtualNetworkRuleResponse[];
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    readonly writeLocations: outputs.cosmosdb.v20200301.LocationResponse[];
}
/**
 * Retrieves the properties of an existing Azure Cosmos DB database account.
 */
export function getDatabaseAccountOutput(args: GetDatabaseAccountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseAccountResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cosmosdb/v20200301:getDatabaseAccount", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
