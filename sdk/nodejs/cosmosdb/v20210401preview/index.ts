...
// Export enums:
export * from "../../types/enums/cosmosdb/v20210401preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cosmosdb/v20210401preview:DatabaseAccount":
...
pulumi.runtime.registerResourceModule("azure-native", "cosmosdb/v20210401preview", _module)
