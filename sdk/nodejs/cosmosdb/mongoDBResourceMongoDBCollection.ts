...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<outputs.cosmosdb.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<outputs.cosmosdb.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
