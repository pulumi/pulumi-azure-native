...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20241201preview:SqlResourceSqlContainer';
    ...
    public readonly options!: pulumi.Output<outputs.cosmosdb.v20241201preview.SqlContainerGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.cosmosdb.v20241201preview.SqlContainerGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.cosmosdb.v20241201preview.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface SqlResourceSqlContainerArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20241201preview.SqlContainerResourceArgs>;
    /**
