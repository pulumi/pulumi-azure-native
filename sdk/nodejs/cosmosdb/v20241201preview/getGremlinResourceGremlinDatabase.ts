...
export function getGremlinResourceGremlinDatabase(args: GetGremlinResourceGremlinDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetGremlinResourceGremlinDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cosmosdb/v20241201preview:getGremlinResourceGremlinDatabase", {
...
export interface GetGremlinResourceGremlinDatabaseResult {
     ...
     */
    readonly identity?: outputs.cosmosdb.v20241201preview.ManagedServiceIdentityResponse;
    /**
    ...
    readonly options?: outputs.cosmosdb.v20241201preview.GremlinDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.cosmosdb.v20241201preview.GremlinDatabaseGetPropertiesResponseResource;
    /**
...
export function getGremlinResourceGremlinDatabaseOutput(args: GetGremlinResourceGremlinDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGremlinResourceGremlinDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cosmosdb/v20241201preview:getGremlinResourceGremlinDatabase", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
