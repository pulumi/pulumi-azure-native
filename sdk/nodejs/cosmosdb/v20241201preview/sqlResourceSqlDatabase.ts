...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20241201preview:SqlResourceSqlDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.cosmosdb.v20241201preview.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.cosmosdb.v20241201preview.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20241201preview.SqlDatabaseResourceArgs>;
    /**
