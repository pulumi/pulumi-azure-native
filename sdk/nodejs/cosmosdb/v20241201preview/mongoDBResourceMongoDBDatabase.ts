...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20241201preview:MongoDBResourceMongoDBDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.cosmosdb.v20241201preview.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.cosmosdb.v20241201preview.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20241201preview.MongoDBDatabaseResourceArgs>;
    /**
