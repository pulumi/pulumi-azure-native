...
export function getMongoDBResourceMongoRoleDefinition(args: GetMongoDBResourceMongoRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoRoleDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cosmosdb/v20241201preview:getMongoDBResourceMongoRoleDefinition", {
...
export interface GetMongoDBResourceMongoRoleDefinitionResult {
     ...
     */
    readonly privileges?: outputs.cosmosdb.v20241201preview.PrivilegeResponse[];
    /**
     ...
     */
    readonly roles?: outputs.cosmosdb.v20241201preview.RoleResponse[];
    /**
...
export function getMongoDBResourceMongoRoleDefinitionOutput(args: GetMongoDBResourceMongoRoleDefinitionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMongoDBResourceMongoRoleDefinitionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cosmosdb/v20241201preview:getMongoDBResourceMongoRoleDefinition", {
        "accountName": args.accountName,
        "mongoRoleDefinitionId": args.mongoRoleDefinitionId,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
