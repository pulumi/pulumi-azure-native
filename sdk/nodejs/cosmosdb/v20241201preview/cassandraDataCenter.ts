...
export class CassandraDataCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20241201preview:CassandraDataCenter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.cosmosdb.v20241201preview.DataCenterResourceResponseProperties>;
    /**
...
export interface CassandraDataCenterArgs {
     ...
     * Properties of a managed Cassandra data center.
     */
    properties?: pulumi.Input<inputs.cosmosdb.v20241201preview.DataCenterResourcePropertiesArgs>;
    /**
