...
export function getGraphResourceGraph(args: GetGraphResourceGraphArgs, opts?: pulumi.InvokeOptions): Promise<GetGraphResourceGraphResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cosmosdb/v20241201preview:getGraphResourceGraph", {
...
export interface GetGraphResourceGraphResult {
    ...
    readonly options?: outputs.cosmosdb.v20241201preview.GraphResourceGetPropertiesResponseOptions;
    readonly resource?: outputs.cosmosdb.v20241201preview.GraphResourceGetPropertiesResponseResource;
    /**
...
export function getGraphResourceGraphOutput(args: GetGraphResourceGraphOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGraphResourceGraphResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cosmosdb/v20241201preview:getGraphResourceGraph", {
        "accountName": args.accountName,
        "graphName": args.graphName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
