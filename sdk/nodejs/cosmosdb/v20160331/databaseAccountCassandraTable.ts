...
export class DatabaseAccountCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20160331:DatabaseAccountCassandraTable';
     ...
     */
    public /*out*/ readonly schema!: pulumi.Output<outputs.cosmosdb.v20160331.CassandraSchemaResponse | undefined>;
    /**
...
export interface DatabaseAccountCassandraTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20160331.CassandraTableResourceArgs>;
    /**
