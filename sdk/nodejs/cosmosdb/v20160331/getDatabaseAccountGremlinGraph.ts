...
export function getDatabaseAccountGremlinGraph(args: GetDatabaseAccountGremlinGraphArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseAccountGremlinGraphResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cosmosdb/v20160331:getDatabaseAccountGremlinGraph", {
...
export interface GetDatabaseAccountGremlinGraphResult {
     ...
     */
    readonly conflictResolutionPolicy?: outputs.cosmosdb.v20160331.ConflictResolutionPolicyResponse;
    /**
     ...
     */
    readonly indexingPolicy?: outputs.cosmosdb.v20160331.IndexingPolicyResponse;
    /**
     ...
     */
    readonly partitionKey?: outputs.cosmosdb.v20160331.ContainerPartitionKeyResponse;
    /**
     ...
     */
    readonly uniqueKeyPolicy?: outputs.cosmosdb.v20160331.UniqueKeyPolicyResponse;
}
/**
 * Gets the Gremlin graph under an existing Azure Cosmos DB database account.
 */
export function getDatabaseAccountGremlinGraphOutput(args: GetDatabaseAccountGremlinGraphOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseAccountGremlinGraphResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cosmosdb/v20160331:getDatabaseAccountGremlinGraph", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "graphName": args.graphName,
        "resourceGroupName": args.resourceGroupName,
