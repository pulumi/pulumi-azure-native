...
export class DatabaseAccountSqlContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20160331:DatabaseAccountSqlContainer';
     ...
     */
    public /*out*/ readonly conflictResolutionPolicy!: pulumi.Output<outputs.cosmosdb.v20160331.ConflictResolutionPolicyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly indexingPolicy!: pulumi.Output<outputs.cosmosdb.v20160331.IndexingPolicyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly partitionKey!: pulumi.Output<outputs.cosmosdb.v20160331.ContainerPartitionKeyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly uniqueKeyPolicy!: pulumi.Output<outputs.cosmosdb.v20160331.UniqueKeyPolicyResponse | undefined>;
    ...
    constructor(name: string, args: DatabaseAccountSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.cosmosdb.v20160331.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface DatabaseAccountSqlContainerArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20160331.SqlContainerResourceArgs>;
    /**
