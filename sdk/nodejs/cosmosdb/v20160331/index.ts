...
// Export enums:
export * from "../../types/enums/cosmosdb/v20160331";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cosmosdb/v20160331:DatabaseAccountCassandraKeyspace":
                return new DatabaseAccountCassandraKeyspace(name, <any>undefined, { urn })
            case "azure-native:cosmosdb/v20160331:DatabaseAccountCassandraTable":
                return new DatabaseAccountCassandraTable(name, <any>undefined, { urn })
            case "azure-native:cosmosdb/v20160331:DatabaseAccountGremlinDatabase":
                return new DatabaseAccountGremlinDatabase(name, <any>undefined, { urn })
            case "azure-native:cosmosdb/v20160331:DatabaseAccountGremlinGraph":
                return new DatabaseAccountGremlinGraph(name, <any>undefined, { urn })
            case "azure-native:cosmosdb/v20160331:DatabaseAccountMongoDBCollection":
                return new DatabaseAccountMongoDBCollection(name, <any>undefined, { urn })
            case "azure-native:cosmosdb/v20160331:DatabaseAccountMongoDBDatabase":
                return new DatabaseAccountMongoDBDatabase(name, <any>undefined, { urn })
            case "azure-native:cosmosdb/v20160331:DatabaseAccountSqlContainer":
                return new DatabaseAccountSqlContainer(name, <any>undefined, { urn })
            case "azure-native:cosmosdb/v20160331:DatabaseAccountSqlDatabase":
                return new DatabaseAccountSqlDatabase(name, <any>undefined, { urn })
            case "azure-native:cosmosdb/v20160331:DatabaseAccountTable":
...
pulumi.runtime.registerResourceModule("azure-native", "cosmosdb/v20160331", _module)
