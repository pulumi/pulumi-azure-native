...
export class DatabaseAccountGremlinGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20160331:DatabaseAccountGremlinGraph';
    ...
    constructor(name: string, args: DatabaseAccountGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.cosmosdb.v20160331.gremlinGraphResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface DatabaseAccountGremlinGraphArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20160331.GremlinGraphResourceArgs>;
    /**
