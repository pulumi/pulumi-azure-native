...
export class DatabaseAccountMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20160331:DatabaseAccountMongoDBCollection';
     ...
     * List of index keys
     */
    public /*out*/ readonly indexes!: pulumi.Output<outputs.cosmosdb.v20160331.MongoIndexResponse[] | undefined>;
    /**
...
export interface DatabaseAccountMongoDBCollectionArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20160331.MongoDBCollectionResourceArgs>;
    /**
