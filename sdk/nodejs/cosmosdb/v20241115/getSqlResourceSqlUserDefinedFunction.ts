...
export function getSqlResourceSqlUserDefinedFunction(args: GetSqlResourceSqlUserDefinedFunctionArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlUserDefinedFunctionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cosmosdb/v20241115:getSqlResourceSqlUserDefinedFunction", {
...
export interface GetSqlResourceSqlUserDefinedFunctionResult {
    ...
    readonly resource?: outputs.cosmosdb.v20241115.SqlUserDefinedFunctionGetPropertiesResponseResource;
    /**
...
export function getSqlResourceSqlUserDefinedFunctionOutput(args: GetSqlResourceSqlUserDefinedFunctionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlResourceSqlUserDefinedFunctionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cosmosdb/v20241115:getSqlResourceSqlUserDefinedFunction", {
        "accountName": args.accountName,
        "containerName": args.containerName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
