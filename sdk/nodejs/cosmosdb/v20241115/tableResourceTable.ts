...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20241115:TableResourceTable';
    ...
    public readonly options!: pulumi.Output<outputs.cosmosdb.v20241115.TableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.cosmosdb.v20241115.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20241115.TableResourceArgs>;
    /**
