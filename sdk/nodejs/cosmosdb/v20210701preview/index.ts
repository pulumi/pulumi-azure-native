...
// Export enums:
export * from "../../types/enums/cosmosdb/v20210701preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cosmosdb/v20210701preview:CassandraCluster":
...
pulumi.runtime.registerResourceModule("azure-native", "cosmosdb/v20210701preview", _module)
