...
export class MongoClusterFirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20240215preview:MongoClusterFirewallRule';
