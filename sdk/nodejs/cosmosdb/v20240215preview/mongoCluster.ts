...
export class MongoCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20240215preview:MongoCluster';
     ...
     */
    public readonly nodeGroupSpecs!: pulumi.Output<outputs.cosmosdb.v20240215preview.NodeGroupSpecResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.cosmosdb.v20240215preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface MongoClusterArgs {
     ...
     */
    createMode?: pulumi.Input<string | enums.cosmosdb.v20240215preview.CreateMode>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The list of node group specs in the cluster.
     */
    nodeGroupSpecs?: pulumi.Input<pulumi.Input<inputs.cosmosdb.v20240215preview.NodeGroupSpecArgs>[]>;
    /**
     ...
     */
    restoreParameters?: pulumi.Input<inputs.cosmosdb.v20240215preview.MongoClusterRestoreParametersArgs>;
    /**
     * The Mongo DB server version. Defaults to the latest available version if not specified.
     */
