...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<outputs.cosmosdb.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<outputs.cosmosdb.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
