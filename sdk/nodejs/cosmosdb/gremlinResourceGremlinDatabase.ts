...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<outputs.cosmosdb.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<outputs.cosmosdb.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
