...
// Export enums:
export * from "../../types/enums/cosmosdb/v20200901";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cosmosdb/v20200901:DatabaseAccount":
...
pulumi.runtime.registerResourceModule("azure-native", "cosmosdb/v20200901", _module)
