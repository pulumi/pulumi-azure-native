...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<outputs.cosmosdb.GraphResourceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.cosmosdb.GraphResourceGetPropertiesResponseResource | undefined>;
    /**
