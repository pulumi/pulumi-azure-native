...
export class FleetspaceAccount extends pulumi.CustomResource {
     ...
     */
    declare public readonly globalDatabaseAccountProperties: pulumi.Output<outputs.cosmosdb.FleetspaceAccountPropertiesResponseGlobalDatabaseAccountProperties | undefined>;
    /**
    ...
    constructor(name: string, args: FleetspaceAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cosmosdb/v20250501preview:FleetspaceAccount" }, { type: "azure-native:cosmosdb/v20251015:FleetspaceAccount" }] };
