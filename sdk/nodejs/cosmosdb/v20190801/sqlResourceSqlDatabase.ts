...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20190801:SqlResourceSqlDatabase';
    ...
    public readonly resource!: pulumi.Output<outputs.cosmosdb.v20190801.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20190801.SqlDatabaseResourceArgs>;
    /**
