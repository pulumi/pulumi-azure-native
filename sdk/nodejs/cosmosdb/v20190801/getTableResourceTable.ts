...
export function getTableResourceTable(args: GetTableResourceTableArgs, opts?: pulumi.InvokeOptions): Promise<GetTableResourceTableResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cosmosdb/v20190801:getTableResourceTable", {
...
export interface GetTableResourceTableResult {
    ...
    readonly resource?: outputs.cosmosdb.v20190801.TableGetPropertiesResponseResource;
    /**
...
export function getTableResourceTableOutput(args: GetTableResourceTableOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTableResourceTableResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cosmosdb/v20190801:getTableResourceTable", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "tableName": args.tableName,
    }, opts);
