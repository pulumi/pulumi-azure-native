...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb/v20190801:MongoDBResourceMongoDBCollection';
    ...
    public readonly resource!: pulumi.Output<outputs.cosmosdb.v20190801.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBCollectionArgs {
     ...
     */
    resource: pulumi.Input<inputs.cosmosdb.v20190801.MongoDBCollectionResourceArgs>;
    /**
