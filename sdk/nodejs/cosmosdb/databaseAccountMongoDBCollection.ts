...
export class DatabaseAccountMongoDBCollection extends pulumi.CustomResource {
     ...
     * List of index keys
     */
    declare public /*out*/ readonly indexes: pulumi.Output<outputs.cosmosdb.MongoIndexResponse[] | undefined>;
    /**
