...
export class Suppression extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:advisor:Suppression';
    ...
    constructor(name: string, args: SuppressionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:advisor/latest:Suppression" }, { type: "azure-nextgen:advisor/v20160712preview:Suppression" }, { type: "azure-nextgen:advisor/v20170331:Suppression" }, { type: "azure-nextgen:advisor/v20170419:Suppression" }, { type: "azure-nextgen:advisor/v20200101:Suppression" }] };
