...
export class Suppression extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:advisor:Suppression';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.advisor.SuppressionPropertiesResponse>;
    /**
...
export interface SuppressionArgs {
     ...
     * The properties of the suppression.
     */
    readonly properties?: pulumi.Input<inputs.advisor.SuppressionProperties>;
    /**
