...
export function getSuppression(args: GetSuppressionArgs, opts?: pulumi.InvokeOptions): Promise<GetSuppressionResult> {
    pulumi.log.warn("getSuppression is deprecated: Version v20160712preview will be removed in the next major version of the provider. Upgrade to version v20200101 or later.")
    if (!opts) {
        opts = {}
    }
