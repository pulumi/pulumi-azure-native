...
export class Assessment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:advisor/v20230901preview:Assessment';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.advisor.v20230901preview.SystemDataResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args?: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:advisor:Assessment" }] };
