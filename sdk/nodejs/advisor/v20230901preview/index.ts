...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:advisor/v20230901preview:Assessment":
                return new Assessment(name, <any>undefined, { urn })
            case "azure-native:advisor/v20230901preview:Suppression":
...
pulumi.runtime.registerResourceModule("azure-native", "advisor/v20230901preview", _module)
