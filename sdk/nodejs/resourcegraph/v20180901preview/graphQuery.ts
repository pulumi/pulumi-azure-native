 ...
 *
 * const graphQuery = new azurerm.resourcegraph.v20180901preview.GraphQuery("graphQuery", {
...
export class GraphQuery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:resourcegraph/v20180901preview:GraphQuery';
    ...
    constructor(name: string, args: GraphQueryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:resourcegraph/v20200401preview:GraphQuery" }] };
