...
export class GraphQuery extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GraphQueryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resourcegraph:GraphQuery" }, { type: "azure-native:resourcegraph/v20180901preview:GraphQuery" }, { type: "azure-nextgen:resourcegraph/v20180901preview:GraphQuery" }, { type: "azure-native:resourcegraph/v20200401preview:GraphQuery" }, { type: "azure-nextgen:resourcegraph/v20200401preview:GraphQuery" }] };
