...
export class GraphQuery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:resourcegraph/preview:GraphQuery';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.resourcegraph.preview.SystemDataResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: GraphQueryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:resourcegraph/v20180901preview:GraphQuery" }, { type: "azurerm:resourcegraph/v20200401preview:GraphQuery" }] };
