...
export class SourceControlConfiguration extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly complianceStatus!: pulumi.Output<outputs.kubernetesconfiguration.v20230501.ComplianceStatusResponse>;
    /**
     ...
     */
    public readonly helmOperatorProperties!: pulumi.Output<outputs.kubernetesconfiguration.v20230501.HelmOperatorPropertiesResponse | undefined>;
    /**
