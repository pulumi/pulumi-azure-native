...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:kubernetesconfiguration/v20201001preview:SourceControlConfiguration":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "kubernetesconfiguration/v20201001preview", _module)
