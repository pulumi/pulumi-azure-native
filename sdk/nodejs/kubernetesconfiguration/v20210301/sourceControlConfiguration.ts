 ...
 *
 * const sourceControlConfiguration = new azure_native.kubernetesconfiguration.v20210301.SourceControlConfiguration("sourceControlConfiguration", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:kubernetesconfiguration/v20210301:SourceControlConfiguration SRS_GitHubConfig /subscriptions/subId1/resourceGroups/rg1/providers/Microsoft.Kubernetes/connectedClusters/clusterName1/providers/Microsoft.KubernetesConfiguration/sourceControlConfigurations/SRS_GitHubConfig 
 * ```
 */
export class SourceControlConfiguration extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly complianceStatus!: pulumi.Output<outputs.kubernetesconfiguration.v20210301.ComplianceStatusResponse>;
    /**
     ...
     */
    public readonly helmOperatorProperties!: pulumi.Output<outputs.kubernetesconfiguration.v20210301.HelmOperatorPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kubernetesconfiguration.v20210301.SystemDataResponse>;
    /**
...
export interface SourceControlConfigurationArgs {
     ...
     * Properties for Helm operator.
     */
    helmOperatorProperties?: pulumi.Input<inputs.kubernetesconfiguration.v20210301.HelmOperatorPropertiesArgs>;
    /**
     * Instance name of the operator - identifying the specific configuration.
     */
     ...
     * Scope at which the operator will be installed.
     */
    operatorScope?: pulumi.Input<string | enums.kubernetesconfiguration.v20210301.OperatorScopeType>;
    /**
     * Type of the operator
     */
    operatorType?: pulumi.Input<string | enums.kubernetesconfiguration.v20210301.OperatorType>;
    /**
     * Url of the SourceControl Repository.
     */
