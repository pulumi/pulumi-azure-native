 ...
 *
 * const privateLinkScope = new azure_native.kubernetesconfiguration.v20220402preview.PrivateLinkScope("privateLinkScope", {
 *     location: "westus",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:kubernetesconfiguration/v20220402preview:PrivateLinkScope my-privatelinkscope /subscriptions/86dc51d3-92ed-4d7e-947a-775ea79b4919/resourceGroups/my-resource-group/providers/Microsoft.KubernetesConfiguration/privateLinkScopes/my-privatelinkscope 
 * ```
 */
export class PrivateLinkScope extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.kubernetesconfiguration.v20220402preview.KubernetesConfigurationPrivateLinkScopePropertiesResponse>;
    /**
