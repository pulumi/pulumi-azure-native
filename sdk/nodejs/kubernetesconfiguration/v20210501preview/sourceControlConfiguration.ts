...
export class SourceControlConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetesconfiguration/v20210501preview:SourceControlConfiguration';
     ...
     */
    public /*out*/ readonly complianceStatus!: pulumi.Output<outputs.kubernetesconfiguration.v20210501preview.ComplianceStatusResponse>;
    /**
     ...
     */
    public readonly helmOperatorProperties!: pulumi.Output<outputs.kubernetesconfiguration.v20210501preview.HelmOperatorPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kubernetesconfiguration.v20210501preview.SystemDataResponse>;
    /**
...
export interface SourceControlConfigurationArgs {
     ...
     * Properties for Helm operator.
     */
    readonly helmOperatorProperties?: pulumi.Input<inputs.kubernetesconfiguration.v20210501preview.HelmOperatorPropertiesArgs>;
    /**
     * Instance name of the operator - identifying the specific configuration.
     */
     ...
     * Scope at which the operator will be installed.
     */
    readonly operatorScope?: pulumi.Input<string | enums.kubernetesconfiguration.v20210501preview.OperatorScopeType>;
    /**
     * Type of the operator
     */
    readonly operatorType?: pulumi.Input<string | enums.kubernetesconfiguration.v20210501preview.OperatorType>;
    /**
     * Url of the SourceControl Repository.
     */
