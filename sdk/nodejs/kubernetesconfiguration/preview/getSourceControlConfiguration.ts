...
export function getSourceControlConfiguration(args: GetSourceControlConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetSourceControlConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azurerm:kubernetesconfiguration/preview:getSourceControlConfiguration", {
...
export interface GetSourceControlConfigurationResult {
     ...
     */
    readonly complianceStatus: outputs.kubernetesconfiguration.preview.ComplianceStatusResponse;
    /**
     ...
     */
    readonly helmOperatorProperties?: outputs.kubernetesconfiguration.preview.HelmOperatorPropertiesResponse;
    /**
     * Resource name
     */
