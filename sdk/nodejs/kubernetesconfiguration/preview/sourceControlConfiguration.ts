...
export class SourceControlConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:kubernetesconfiguration/preview:SourceControlConfiguration';
     ...
     */
    public /*out*/ readonly complianceStatus!: pulumi.Output<outputs.kubernetesconfiguration.preview.ComplianceStatusResponse>;
    /**
     ...
     */
    public readonly helmOperatorProperties!: pulumi.Output<outputs.kubernetesconfiguration.preview.HelmOperatorPropertiesResponse | undefined>;
    /**
     * Resource name
     */
    ...
    constructor(name: string, args: SourceControlConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:kubernetesconfiguration/v20191101preview:SourceControlConfiguration" }] };
...
export interface SourceControlConfigurationArgs {
     ...
     * Properties for Helm operator.
     */
    readonly helmOperatorProperties?: pulumi.Input<inputs.kubernetesconfiguration.preview.HelmOperatorProperties>;
    /**
     * Instance name of the operator - identifying the specific configuration.
     */
