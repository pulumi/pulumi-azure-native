...
export class FluxConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetesconfiguration/v20240401preview:FluxConfiguration';
     ...
     */
    public readonly azureBlob!: pulumi.Output<outputs.kubernetesconfiguration.v20240401preview.AzureBlobDefinitionResponse | undefined>;
    /**
     * Parameters to reconcile to the Bucket source kind type.
     */
    public readonly bucket!: pulumi.Output<outputs.kubernetesconfiguration.v20240401preview.BucketDefinitionResponse | undefined>;
    /**
     ...
     */
    public readonly gitRepository!: pulumi.Output<outputs.kubernetesconfiguration.v20240401preview.GitRepositoryDefinitionResponse | undefined>;
    /**
     * Array of kustomizations used to reconcile the artifact pulled by the source type on the cluster.
     */
    public readonly kustomizations!: pulumi.Output<{[key: string]: outputs.kubernetesconfiguration.v20240401preview.KustomizationDefinitionResponse} | undefined>;
    /**
     ...
     */
    public readonly ociRepository!: pulumi.Output<outputs.kubernetesconfiguration.v20240401preview.OCIRepositoryDefinitionResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly statuses!: pulumi.Output<outputs.kubernetesconfiguration.v20240401preview.ObjectStatusDefinitionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kubernetesconfiguration.v20240401preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: FluxConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["azureBlob"] = args ? (args.azureBlob ? pulumi.output(args.azureBlob).apply(inputs.kubernetesconfiguration.v20240401preview.azureBlobDefinitionArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["bucket"] = args ? (args.bucket ? pulumi.output(args.bucket).apply(inputs.kubernetesconfiguration.v20240401preview.bucketDefinitionArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["gitRepository"] = args ? (args.gitRepository ? pulumi.output(args.gitRepository).apply(inputs.kubernetesconfiguration.v20240401preview.gitRepositoryDefinitionArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["ociRepository"] = args ? (args.ociRepository ? pulumi.output(args.ociRepository).apply(inputs.kubernetesconfiguration.v20240401preview.ocirepositoryDefinitionArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["ociRepository"] = undefined /*out*/;
            resourceInputs["provisioningState"] = undefined /*out*/;
...
export interface FluxConfigurationArgs {
     ...
     * Parameters to reconcile to the AzureBlob source kind type.
     */
    azureBlob?: pulumi.Input<inputs.kubernetesconfiguration.v20240401preview.AzureBlobDefinitionArgs>;
    /**
     * Parameters to reconcile to the Bucket source kind type.
     */
    bucket?: pulumi.Input<inputs.kubernetesconfiguration.v20240401preview.BucketDefinitionArgs>;
    /**
     ...
     * Parameters to reconcile to the GitRepository source kind type.
     */
    gitRepository?: pulumi.Input<inputs.kubernetesconfiguration.v20240401preview.GitRepositoryDefinitionArgs>;
    /**
     * Array of kustomizations used to reconcile the artifact pulled by the source type on the cluster.
     */
    kustomizations?: pulumi.Input<{[key: string]: pulumi.Input<inputs.kubernetesconfiguration.v20240401preview.KustomizationDefinitionArgs>}>;
    /**
     * The namespace to which this configuration is installed to. Maximum of 253 lower case alphanumeric characters, hyphen and period only.
     */
     ...
     * Parameters to reconcile to the OCIRepository source kind type.
     */
    ociRepository?: pulumi.Input<inputs.kubernetesconfiguration.v20240401preview.OCIRepositoryDefinitionArgs>;
    /**
     * Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D
     */
     ...
     * Scope at which the operator will be installed.
     */
    scope?: pulumi.Input<string | enums.kubernetesconfiguration.v20240401preview.ScopeType>;
    /**
     * Source Kind to pull the configuration data from.
     */
    sourceKind?: pulumi.Input<string | enums.kubernetesconfiguration.v20240401preview.SourceKindType>;
    /**
     * Whether this configuration should suspend its reconciliation of its kustomizations and sources.
     */
