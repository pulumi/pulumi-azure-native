...
export class FluxConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FluxConfiguration {
        pulumi.log.warn("FluxConfiguration is deprecated: azure-native:kubernetesconfiguration/v20220301:FluxConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kubernetesconfiguration/v20221101:FluxConfiguration to guarantee forwards compatibility.")
