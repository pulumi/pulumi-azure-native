...
export function getFluxConfiguration(args: GetFluxConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetFluxConfigurationResult> {
    pulumi.log.warn("getFluxConfiguration is deprecated: azure-native:kubernetesconfiguration/v20220301:FluxConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:FluxConfiguration to guarantee forwards compatibility.")
...
export interface GetFluxConfigurationResult {
     ...
     */
    readonly kustomizations?: {[key: string]: outputs.kubernetesconfiguration.v20220301.KustomizationDefinitionResponse};
    /**
