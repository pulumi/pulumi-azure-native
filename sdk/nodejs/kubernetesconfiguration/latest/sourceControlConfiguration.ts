...
export class SourceControlConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetesconfiguration/latest:SourceControlConfiguration';
     ...
     */
    public /*out*/ readonly complianceStatus!: pulumi.Output<outputs.kubernetesconfiguration.latest.ComplianceStatusResponse>;
    /**
     ...
     */
    public readonly helmOperatorProperties!: pulumi.Output<outputs.kubernetesconfiguration.latest.HelmOperatorPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.kubernetesconfiguration.latest.SystemDataResponse>;
    /**
...
export interface SourceControlConfigurationArgs {
     ...
     * Properties for Helm operator.
     */
    readonly helmOperatorProperties?: pulumi.Input<inputs.kubernetesconfiguration.latest.HelmOperatorProperties>;
    /**
     * Instance name of the operator - identifying the specific configuration.
     */
     ...
     * Scope at which the operator will be installed.
     */
    readonly operatorScope?: pulumi.Input<string | enums.kubernetesconfiguration.latest.OperatorScopeType>;
    /**
     * Type of the operator
     */
    readonly operatorType?: pulumi.Input<string | enums.kubernetesconfiguration.latest.OperatorType>;
    /**
     * Url of the SourceControl Repository.
     */
