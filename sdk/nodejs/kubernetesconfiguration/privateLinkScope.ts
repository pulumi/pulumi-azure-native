...
export class PrivateLinkScope extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.kubernetesconfiguration.KubernetesConfigurationPrivateLinkScopePropertiesResponse>;
    /**
...
export interface PrivateLinkScopeArgs {
     ...
     * Properties that define a Azure Arc PrivateLinkScope resource.
     */
    properties?: pulumi.Input<inputs.kubernetesconfiguration.KubernetesConfigurationPrivateLinkScopePropertiesArgs | undefined>;
    /**
