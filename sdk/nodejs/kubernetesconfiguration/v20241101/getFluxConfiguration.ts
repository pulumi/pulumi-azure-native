...
export function getFluxConfiguration(args: GetFluxConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetFluxConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:kubernetesconfiguration/v20241101:getFluxConfiguration", {
...
export interface GetFluxConfigurationResult {
     ...
     */
    readonly azureBlob?: outputs.kubernetesconfiguration.v20241101.AzureBlobDefinitionResponse;
    /**
     * Parameters to reconcile to the Bucket source kind type.
     */
    readonly bucket?: outputs.kubernetesconfiguration.v20241101.BucketDefinitionResponse;
    /**
     ...
     */
    readonly gitRepository?: outputs.kubernetesconfiguration.v20241101.GitRepositoryDefinitionResponse;
    /**
     ...
     */
    readonly kustomizations?: {[key: string]: outputs.kubernetesconfiguration.v20241101.KustomizationDefinitionResponse};
    /**
     ...
     */
    readonly ociRepository?: outputs.kubernetesconfiguration.v20241101.OCIRepositoryDefinitionResponse;
    /**
     ...
     */
    readonly statuses: outputs.kubernetesconfiguration.v20241101.ObjectStatusDefinitionResponse[];
    /**
     ...
     */
    readonly systemData: outputs.kubernetesconfiguration.v20241101.SystemDataResponse;
    /**
...
export function getFluxConfigurationOutput(args: GetFluxConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFluxConfigurationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:kubernetesconfiguration/v20241101:getFluxConfiguration", {
        "clusterName": args.clusterName,
        "clusterResourceName": args.clusterResourceName,
        "clusterRp": args.clusterRp,
        "fluxConfigurationName": args.fluxConfigurationName,
