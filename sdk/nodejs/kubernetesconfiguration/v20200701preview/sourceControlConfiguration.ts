 ...
 *
 * @deprecated azure-native:kubernetesconfiguration/v20200701preview:SourceControlConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration to guarantee forwards compatibility.
 */
export class SourceControlConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetesconfiguration/v20200701preview:SourceControlConfiguration';
     ...
     */
    public /*out*/ readonly complianceStatus!: pulumi.Output<outputs.kubernetesconfiguration.v20200701preview.ComplianceStatusResponse>;
    /**
     ...
     */
    public readonly helmOperatorProperties!: pulumi.Output<outputs.kubernetesconfiguration.v20200701preview.HelmOperatorPropertiesResponse | undefined>;
    /**
     * Resource name
     */
...
export interface SourceControlConfigurationArgs {
     ...
     * Properties for Helm operator.
     */
    helmOperatorProperties?: pulumi.Input<inputs.kubernetesconfiguration.v20200701preview.HelmOperatorPropertiesArgs>;
    /**
     * Instance name of the operator - identifying the specific configuration.
     */
     ...
     * Scope at which the operator will be installed.
     */
    operatorScope?: pulumi.Input<string | enums.kubernetesconfiguration.v20200701preview.OperatorScopeType>;
    /**
     * Type of the operator
     */
    operatorType?: pulumi.Input<string | enums.kubernetesconfiguration.v20200701preview.OperatorType>;
    /**
     * Url of the SourceControl Repository.
     */
