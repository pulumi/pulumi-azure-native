...
export class DeploymentAtTenantScope extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeploymentAtTenantScope {
        pulumi.log.warn("DeploymentAtTenantScope is deprecated: azure-native:resources/v20190701:DeploymentAtTenantScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.")
        return new DeploymentAtTenantScope(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20190701:DeploymentAtTenantScope';
