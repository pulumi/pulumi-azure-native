 ...
 * Gets a deployment.
 */
/** @deprecated azure-native:resources/v20190701:DeploymentAtScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtScope to guarantee forwards compatibility. */
export function getDeploymentAtScope(args: GetDeploymentAtScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentAtScopeResult> {
    pulumi.log.warn("getDeploymentAtScope is deprecated: azure-native:resources/v20190701:DeploymentAtScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtScope to guarantee forwards compatibility.")
