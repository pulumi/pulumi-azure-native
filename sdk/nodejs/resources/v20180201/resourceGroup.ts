...
export class ResourceGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.resources.v20180201.ResourceGroupPropertiesResponse>;
    /**
...
export interface ResourceGroupArgs {
     ...
     * The resource group properties.
     */
    readonly properties?: pulumi.Input<inputs.resources.v20180201.ResourceGroupProperties>;
    /**
     * The tags attached to the resource group.
     */
