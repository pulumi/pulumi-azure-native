...
export class TemplateSpec extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:resources/preview:TemplateSpec';
    ...
    constructor(name: string, argsOrState?: TemplateSpecArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:resources/v20190601preview:TemplateSpec" }] };
