...
export class TemplateSpecVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TemplateSpecVersion {
        return new TemplateSpecVersion(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:resources/preview:TemplateSpecVersion';
     ...
     */
    public readonly artifacts!: pulumi.Output<outputs.resources.preview.TemplateSpecArtifactResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: TemplateSpecVersionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as TemplateSpecVersionArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:resources/v20190601preview:TemplateSpecVersion" }] };
...
export interface TemplateSpecVersionArgs {
     ...
     * An array of Template Spec artifacts.
     */
    readonly artifacts?: pulumi.Input<pulumi.Input<inputs.resources.preview.TemplateSpecArtifact>[]>;
    /**
     * Template Spec version description.
     */
