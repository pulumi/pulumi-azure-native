...
export class TagAtScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:resources/preview:TagAtScope';
     ...
     * The set of tags.
     */
    public readonly properties!: pulumi.Output<outputs.resources.preview.TagsResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: TagAtScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:resources/latest:TagAtScope" }, { type: "azurerm:resources/v20191001:TagAtScope" }, { type: "azurerm:resources/v20200601:TagAtScope" }] };
...
export interface TagAtScopeArgs {
     ...
     * The set of tags.
     */
    readonly properties: pulumi.Input<inputs.resources.preview.Tags>;
    /**
     * The resource scope.
     */
