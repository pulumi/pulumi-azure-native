...
export class DeploymentAtSubscriptionScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:resources/preview:DeploymentAtSubscriptionScope';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.resources.preview.DeploymentPropertiesExtendedResponse>;
    /**
     * Deployment tags
     */
...
export interface DeploymentAtSubscriptionScopeArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.resources.preview.DeploymentProperties>;
    /**
     * Deployment tags
     */
