...
export class DeploymentScript extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:resources/preview:DeploymentScript';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.resources.preview.ManagedServiceIdentityResponse>;
    /**
     * Type of the script.
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.resources.preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: DeploymentScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:resources/v20191001preview:DeploymentScript" }] };
...
export interface DeploymentScriptArgs {
     ...
     * Managed identity to be used for this deployment script. Currently, only user-assigned MSI is supported.
     */
    readonly identity: pulumi.Input<inputs.resources.preview.ManagedServiceIdentity>;
    /**
     * Type of the script.
     */
