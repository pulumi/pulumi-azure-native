...
export class DeploymentAtScope extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DeploymentAtScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:resources/v20190701:DeploymentAtScope" }, { type: "azurerm:resources/v20191001:DeploymentAtScope" }, { type: "azurerm:resources/v20200601:DeploymentAtScope" }] };
