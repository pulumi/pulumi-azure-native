 ...
 * Gets a deployment.
 */
/** @deprecated azure-native:resources/v20190801:DeploymentAtScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtScope to guarantee forwards compatibility. */
export function getDeploymentAtScope(args: GetDeploymentAtScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentAtScopeResult> {
    pulumi.log.warn("getDeploymentAtScope is deprecated: azure-native:resources/v20190801:DeploymentAtScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtScope to guarantee forwards compatibility.")
