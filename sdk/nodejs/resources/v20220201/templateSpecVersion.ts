...
export class TemplateSpecVersion extends pulumi.CustomResource {
     ...
     */
    public readonly linkedTemplates!: pulumi.Output<outputs.resources.v20220201.LinkedTemplateArtifactResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: TemplateSpecVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources/v20190601preview:TemplateSpecVersion" }, { type: "azure-native:resources/v20210301preview:TemplateSpecVersion" }, { type: "azure-native:resources/v20210501:TemplateSpecVersion" }, { type: "azure-native:resources:TemplateSpecVersion" }] };
