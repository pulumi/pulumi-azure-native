...
export class TemplateSpecVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20210301preview:TemplateSpecVersion';
     ...
     */
    public readonly linkedTemplates!: pulumi.Output<outputs.resources.v20210301preview.LinkedTemplateArtifactResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.resources.v20210301preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: TemplateSpecVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources/v20210301preview:TemplateSpecVersion" }, { type: "azure-native:resources:TemplateSpecVersion" }, { type: "azure-nextgen:resources:TemplateSpecVersion" }, { type: "azure-native:resources/v20190601preview:TemplateSpecVersion" }, { type: "azure-nextgen:resources/v20190601preview:TemplateSpecVersion" }, { type: "azure-native:resources/v20210501:TemplateSpecVersion" }, { type: "azure-nextgen:resources/v20210501:TemplateSpecVersion" }] };
...
export interface TemplateSpecVersionArgs {
     ...
     * An array of linked template artifacts.
     */
    linkedTemplates?: pulumi.Input<pulumi.Input<inputs.resources.v20210301preview.LinkedTemplateArtifactArgs>[]>;
    /**
     * The location of the Template Spec Version. It must match the location of the parent Template Spec.
     */
