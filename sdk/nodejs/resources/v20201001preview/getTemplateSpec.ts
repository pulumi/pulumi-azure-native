...
export function getTemplateSpec(args: GetTemplateSpecArgs, opts?: pulumi.InvokeOptions): Promise<GetTemplateSpecResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:resources/v20201001preview:getTemplateSpec", {
...
export interface GetTemplateSpecResult {
     ...
     */
    readonly systemData: outputs.resources.v20201001preview.SystemDataResponse;
    /**
     * Resource tags.
     */
