...
export class TemplateSpecVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:resources/v20201001preview:TemplateSpecVersion';
     ...
     */
    public readonly artifacts!: pulumi.Output<outputs.resources.v20201001preview.TemplateSpecTemplateArtifactResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.resources.v20201001preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly uiDefinition!: pulumi.Output<any | undefined>;
    ...
    constructor(name: string, args: TemplateSpecVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if (!args || args.templateSpecVersion === undefined) {
            ...
            inputs["uiDefinition"] = args ? args.uiDefinition : undefined;
            ...
            inputs["type"] = undefined /*out*/;
            inputs["uiDefinition"] = undefined /*out*/;
        }
        if (!opts) {
            opts = {}
        }
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources/v20190601preview:TemplateSpecVersion" }] };
...
export interface TemplateSpecVersionArgs {
     ...
     * An array of Template Spec artifacts.
     */
    readonly artifacts?: pulumi.Input<pulumi.Input<inputs.resources.v20201001preview.TemplateSpecTemplateArtifact>[]>;
    /**
     * Template Spec version description.
     */
