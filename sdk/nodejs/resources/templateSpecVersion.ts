...
export class TemplateSpecVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TemplateSpecVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources:TemplateSpecVersion" }, { type: "azure-native:resources/v20190601preview:TemplateSpecVersion" }, { type: "azure-nextgen:resources/v20190601preview:TemplateSpecVersion" }, { type: "azure-native:resources/v20210301preview:TemplateSpecVersion" }, { type: "azure-nextgen:resources/v20210301preview:TemplateSpecVersion" }] };
...
export interface TemplateSpecVersionArgs {
     ...
     * An array of Template Spec artifacts.
     */
    readonly artifacts?: pulumi.Input<pulumi.Input<inputs.resources.TemplateSpecTemplateArtifact>[]>;
    /**
     * Template Spec version description.
     */
