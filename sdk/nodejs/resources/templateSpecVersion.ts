...
export class TemplateSpecVersion extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.resources.TemplateSpecVersionPropertiesResponse>;
    /**
...
export interface TemplateSpecVersionArgs {
     ...
     * Template Spec Version properties.
     */
    properties: pulumi.Input<inputs.resources.TemplateSpecVersionPropertiesArgs>;
    /**
