...
export class AzurePowerShellScript extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.resources.v20201001.AzurePowerShellScriptPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AzurePowerShellScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.resources.v20201001.azurePowerShellScriptPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface AzurePowerShellScriptArgs {
     ...
     * Properties of the Azure PowerShell script object.
     */
    properties: pulumi.Input<inputs.resources.v20201001.AzurePowerShellScriptPropertiesArgs>;
    /**
