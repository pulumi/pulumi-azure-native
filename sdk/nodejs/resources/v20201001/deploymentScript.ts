...
export class DeploymentScript extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DeploymentScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources/v20201001:DeploymentScript" }, { type: "azure-native:resources:DeploymentScript" }, { type: "azure-nextgen:resources:DeploymentScript" }, { type: "azure-native:resources/latest:DeploymentScript" }, { type: "azure-nextgen:resources/latest:DeploymentScript" }, { type: "azure-native:resources/v20191001preview:DeploymentScript" }, { type: "azure-nextgen:resources/v20191001preview:DeploymentScript" }] };
...
export interface DeploymentScriptArgs {
     ...
     * Optional property. Managed identity to be used for this deployment script. Currently, only user-assigned MSI is supported.
     */
    readonly identity?: pulumi.Input<inputs.resources.v20201001.ManagedServiceIdentity>;
    /**
     * Type of the script.
     */
