...
export function getDeploymentAtTenantScope(args: GetDeploymentAtTenantScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentAtTenantScopeResult> {
    pulumi.log.warn("getDeploymentAtTenantScope is deprecated: azure-native:resources/v20201001:DeploymentAtTenantScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.")
