...
export class AzureCliScript extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.resources.v20201001.AzureCliScriptPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AzureCliScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.resources.v20201001.azureCliScriptPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface AzureCliScriptArgs {
     ...
     * Properties of the Azure CLI script object.
     */
    properties: pulumi.Input<inputs.resources.v20201001.AzureCliScriptPropertiesArgs>;
    /**
