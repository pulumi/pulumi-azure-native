...
export class DeploymentStackAtResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20240301:DeploymentStackAtResourceGroup';
    ...
    constructor(name: string, args: DeploymentStackAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources/v20220801preview:DeploymentStackAtResourceGroup" }, { type: "azure-native:resources:DeploymentStackAtResourceGroup" }] };
