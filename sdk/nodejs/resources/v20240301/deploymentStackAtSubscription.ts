...
export class DeploymentStackAtSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20240301:DeploymentStackAtSubscription';
    ...
    constructor(name: string, args: DeploymentStackAtSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources:DeploymentStackAtSubscription" }, { type: "azure-native:resources/v20220801preview:DeploymentStackAtSubscription" }] };
