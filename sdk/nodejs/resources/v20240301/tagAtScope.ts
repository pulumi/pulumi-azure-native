...
export class TagAtScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20240301:TagAtScope';
     ...
     * The set of tags.
     */
    public readonly properties!: pulumi.Output<outputs.resources.v20240301.TagsResponse>;
    /**
...
export interface TagAtScopeArgs {
     ...
     * The set of tags.
     */
    properties: pulumi.Input<inputs.resources.v20240301.TagsArgs>;
    /**
     * The resource scope.
     */
