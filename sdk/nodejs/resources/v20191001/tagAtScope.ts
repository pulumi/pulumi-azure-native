...
export class TagAtScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagAtScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources:TagAtScope" }, { type: "azure-native:resources/v20201001:TagAtScope" }, { type: "azure-native:resources/v20210101:TagAtScope" }, { type: "azure-native:resources/v20220901:TagAtScope" }] };
