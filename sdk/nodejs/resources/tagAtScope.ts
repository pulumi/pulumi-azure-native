...
export class TagAtScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagAtScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources:TagAtScope" }, { type: "azure-native:resources/latest:TagAtScope" }, { type: "azure-nextgen:resources/latest:TagAtScope" }, { type: "azure-native:resources/v20191001:TagAtScope" }, { type: "azure-nextgen:resources/v20191001:TagAtScope" }, { type: "azure-native:resources/v20200601:TagAtScope" }, { type: "azure-nextgen:resources/v20200601:TagAtScope" }, { type: "azure-native:resources/v20200801:TagAtScope" }, { type: "azure-nextgen:resources/v20200801:TagAtScope" }, { type: "azure-native:resources/v20201001:TagAtScope" }, { type: "azure-nextgen:resources/v20201001:TagAtScope" }, { type: "azure-native:resources/v20210101:TagAtScope" }, { type: "azure-nextgen:resources/v20210101:TagAtScope" }] };
...
export interface TagAtScopeArgs {
     ...
     * The set of tags.
     */
    readonly properties: pulumi.Input<inputs.resources.Tags>;
    /**
     * The resource scope.
     */
