...
export interface GetDeploymentAtScopeResult {
     ...
     */
    readonly properties: outputs.resources.v20230701.DeploymentPropertiesExtendedResponse;
    /**
     * Deployment tags
     */
...
export function getDeploymentAtScopeOutput(args: GetDeploymentAtScopeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentAtScopeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:resources/v20230701:getDeploymentAtScope", {
        "deploymentName": args.deploymentName,
        "scope": args.scope,
    }, opts);
}
