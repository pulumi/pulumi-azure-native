...
export class DeploymentAtManagementGroupScope extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeploymentAtManagementGroupScope {
        pulumi.log.warn("DeploymentAtManagementGroupScope is deprecated: azure-native:resources/v20210401:DeploymentAtManagementGroupScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtManagementGroupScope to guarantee forwards compatibility.")
