...
export class DeploymentAtSubscriptionScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:resources/latest:DeploymentAtSubscriptionScope';
