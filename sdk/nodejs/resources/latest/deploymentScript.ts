 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:resources:DeploymentScript'.
 */
export class DeploymentScript extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/latest:DeploymentScript';
    ...
    constructor(name: string, args: DeploymentScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources/latest:DeploymentScript" }, { type: "azure-native:resources:DeploymentScript" }, { type: "azure-nextgen:resources:DeploymentScript" }, { type: "azure-native:resources/v20191001preview:DeploymentScript" }, { type: "azure-nextgen:resources/v20191001preview:DeploymentScript" }, { type: "azure-native:resources/v20201001:DeploymentScript" }, { type: "azure-nextgen:resources/v20201001:DeploymentScript" }] };
...
export interface DeploymentScriptArgs {
     ...
     * Type of the script.
     */
    readonly kind: pulumi.Input<string | enums.resources.latest.ScriptType>;
    /**
     * The location of the ACI and the storage account for the deployment script.
     */
