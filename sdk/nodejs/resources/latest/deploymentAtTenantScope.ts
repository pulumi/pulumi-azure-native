...
export class DeploymentAtTenantScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/latest:DeploymentAtTenantScope';
