...
export class AzurePowerShellScript extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzurePowerShellScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources/v20191001preview:AzurePowerShellScript" }, { type: "azure-native:resources:AzurePowerShellScript" }, { type: "azure-nextgen:resources:AzurePowerShellScript" }, { type: "azure-native:resources/v20201001:AzurePowerShellScript" }, { type: "azure-nextgen:resources/v20201001:AzurePowerShellScript" }] };
...
export interface AzurePowerShellScriptArgs {
     ...
     * Azure PowerShell module version to be used.
     */
    readonly azPowerShellVersion: pulumi.Input<string>;
    /**
     * The clean up preference when the script execution gets in a terminal state. Default setting is 'Always'.
     */
     ...
     * Expected value is 'AzurePowerShell'.
     */
    readonly kind: pulumi.Input<"AzurePowerShell">;
    /**
     * The location of the ACI and the storage account for the deployment script.
     */
