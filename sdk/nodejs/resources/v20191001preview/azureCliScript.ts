...
export class AzureCliScript extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzureCliScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources:AzureCliScript" }, { type: "azure-native:resources/v20201001:AzureCliScript" }, { type: "azure-native:resources/v20230801:AzureCliScript" }] };
