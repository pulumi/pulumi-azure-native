...
export class AzureCliScript extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzureCliScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources/v20191001preview:AzureCliScript" }, { type: "azure-native:resources:AzureCliScript" }, { type: "azure-nextgen:resources:AzureCliScript" }, { type: "azure-native:resources/v20201001:AzureCliScript" }, { type: "azure-nextgen:resources/v20201001:AzureCliScript" }] };
...
export interface AzureCliScriptArgs {
     ...
     * The clean up preference when the script execution gets in a terminal state. Default setting is 'Always'.
     */
    readonly cleanupPreference?: pulumi.Input<string | enums.resources.v20191001preview.CleanupOptions>;
    /**
     * Container settings.
     */
    readonly containerSettings?: pulumi.Input<inputs.resources.v20191001preview.ContainerConfigurationArgs>;
    /**
     * The environment variables to pass over to the script.
     */
    readonly environmentVariables?: pulumi.Input<pulumi.Input<inputs.resources.v20191001preview.EnvironmentVariableArgs>[]>;
    /**
     * Gets or sets how the deployment script should be forced to execute even if the script resource has not changed. Can be current time stamp or a GUID.
     */
     ...
     * Storage Account settings.
     */
    readonly storageAccountSettings?: pulumi.Input<inputs.resources.v20191001preview.StorageAccountConfigurationArgs>;
    /**
     * Supporting files for the external script.
     */
