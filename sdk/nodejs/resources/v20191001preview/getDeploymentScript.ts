...
export function getDeploymentScript(args: GetDeploymentScriptArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentScriptResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:resources/v20191001preview:getDeploymentScript", {
...
export interface GetDeploymentScriptResult {
     ...
     */
    readonly identity: outputs.resources.v20191001preview.ManagedServiceIdentityInvokeResponse;
    /**
     * Type of the script.
     */
     ...
     */
    readonly systemData: outputs.resources.v20191001preview.SystemDataInvokeResponse;
    /**
     * Resource tags.
     */
