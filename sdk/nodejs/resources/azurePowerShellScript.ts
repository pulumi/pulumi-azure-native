...
export class AzurePowerShellScript extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzurePowerShellScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources:AzurePowerShellScript" }, { type: "azure-native:resources/v20191001preview:AzurePowerShellScript" }, { type: "azure-nextgen:resources/v20191001preview:AzurePowerShellScript" }, { type: "azure-native:resources/v20201001:AzurePowerShellScript" }, { type: "azure-nextgen:resources/v20201001:AzurePowerShellScript" }] };
