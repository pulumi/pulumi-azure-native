...
export class AzurePowerShellScript extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.resources.AzurePowerShellScriptPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AzurePowerShellScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.resources.azurePowerShellScriptPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface AzurePowerShellScriptArgs {
     ...
     * Properties of the Azure PowerShell script object.
     */
    properties: pulumi.Input<inputs.resources.AzurePowerShellScriptPropertiesArgs>;
    /**
