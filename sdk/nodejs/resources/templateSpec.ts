...
export class TemplateSpec extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly versions!: pulumi.Output<{[key: string]: outputs.resources.TemplateSpecVersionInfoResponse}>;
    ...
    constructor(name: string, args: TemplateSpecArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources:TemplateSpec" }, { type: "azure-native:resources/v20190601preview:TemplateSpec" }, { type: "azure-nextgen:resources/v20190601preview:TemplateSpec" }, { type: "azure-native:resources/v20210301preview:TemplateSpec" }, { type: "azure-nextgen:resources/v20210301preview:TemplateSpec" }, { type: "azure-native:resources/v20210501:TemplateSpec" }, { type: "azure-nextgen:resources/v20210501:TemplateSpec" }] };
