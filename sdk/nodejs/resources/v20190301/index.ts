...
// Export enums:
export * from "../../types/enums/resources/v20190301";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:resources/v20190301:Deployment":
                return new Deployment(name, <any>undefined, { urn })
            case "azure-nextgen:resources/v20190301:DeploymentAtSubscriptionScope":
                return new DeploymentAtSubscriptionScope(name, <any>undefined, { urn })
            case "azure-nextgen:resources/v20190301:Resource":
                return new Resource(name, <any>undefined, { urn })
            case "azure-nextgen:resources/v20190301:ResourceGroup":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "resources/v20190301", _module)
