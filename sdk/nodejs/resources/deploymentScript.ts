...
export class DeploymentScript extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources:DeploymentScript';
    ...
    constructor(name: string, args: DeploymentScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources:DeploymentScript" }, { type: "azure-native:resources/latest:DeploymentScript" }, { type: "azure-nextgen:resources/latest:DeploymentScript" }, { type: "azure-native:resources/v20191001preview:DeploymentScript" }, { type: "azure-nextgen:resources/v20191001preview:DeploymentScript" }, { type: "azure-native:resources/v20201001:DeploymentScript" }, { type: "azure-nextgen:resources/v20201001:DeploymentScript" }] };
...
export interface DeploymentScriptArgs {
     ...
     * Optional property. Managed identity to be used for this deployment script. Currently, only user-assigned MSI is supported.
     */
    readonly identity?: pulumi.Input<inputs.resources.ManagedServiceIdentity>;
    /**
     * Type of the script.
     */
