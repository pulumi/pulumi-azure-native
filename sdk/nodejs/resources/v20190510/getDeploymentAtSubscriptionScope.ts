 ...
 * Gets a deployment.
 */
/** @deprecated azure-native:resources/v20190510:DeploymentAtSubscriptionScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtSubscriptionScope to guarantee forwards compatibility. */
export function getDeploymentAtSubscriptionScope(args: GetDeploymentAtSubscriptionScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentAtSubscriptionScopeResult> {
    pulumi.log.warn("getDeploymentAtSubscriptionScope is deprecated: azure-native:resources/v20190510:DeploymentAtSubscriptionScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtSubscriptionScope to guarantee forwards compatibility.")
