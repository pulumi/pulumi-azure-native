...
export interface AzureCliScriptArgs {
     ...
     * The clean up preference when the script execution gets in a terminal state. Default setting is 'Always'.
     */
    readonly cleanupPreference?: pulumi.Input<string | enums.resources.CleanupOptions>;
    /**
     * Container settings.
     */
    readonly containerSettings?: pulumi.Input<inputs.resources.ContainerConfigurationArgs>;
    /**
     * The environment variables to pass over to the script.
     */
    readonly environmentVariables?: pulumi.Input<pulumi.Input<inputs.resources.EnvironmentVariableArgs>[]>;
    /**
     * Gets or sets how the deployment script should be forced to execute even if the script resource has not changed. Can be current time stamp or a GUID.
     */
     ...
     * Optional property. Managed identity to be used for this deployment script. Currently, only user-assigned MSI is supported.
     */
    readonly identity?: pulumi.Input<inputs.resources.ManagedServiceIdentityArgs>;
    /**
     * Type of the script.
     * Expected value is 'AzureCLI'.
     */
     ...
     * Storage Account settings.
     */
    readonly storageAccountSettings?: pulumi.Input<inputs.resources.StorageAccountConfigurationArgs>;
    /**
     * Supporting files for the external script.
     */
