...
export class ResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:resources/v20200601:ResourceGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.resources.v20200601.ResourceGroupPropertiesResponse>;
    /**
...
export interface ResourceGroupArgs {
     ...
     * The resource group properties.
     */
    readonly properties?: pulumi.Input<inputs.resources.v20200601.ResourceGroupProperties>;
    /**
     * The tags attached to the resource group.
     */
