...
export class TagAtScope extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagAtScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:resources/latest:TagAtScope" }, { type: "azure-nextgen:resources/v20191001:TagAtScope" }, { type: "azure-nextgen:resources/v20201001:TagAtScope" }] };
