 ...
 * Gets a deployment.
 */
/** @deprecated azure-native:resources/v20200601:DeploymentAtTenantScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility. */
export function getDeploymentAtTenantScope(args: GetDeploymentAtTenantScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentAtTenantScopeResult> {
    pulumi.log.warn("getDeploymentAtTenantScope is deprecated: azure-native:resources/v20200601:DeploymentAtTenantScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.")
