...
export class TagAtScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20241101:TagAtScope';
     ...
     * The set of tags.
     */
    public readonly properties!: pulumi.Output<outputs.resources.v20241101.TagsResponse>;
    /**
...
export interface TagAtScopeArgs {
     ...
     * The set of tags.
     */
    properties: pulumi.Input<inputs.resources.v20241101.TagsArgs>;
    /**
     * The resource scope.
     */
