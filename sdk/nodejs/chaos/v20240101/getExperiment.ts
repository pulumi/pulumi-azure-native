...
export interface GetExperimentResult {
     ...
     */
    readonly identity?: outputs.chaos.v20240101.ResourceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.chaos.v20240101.ExperimentPropertiesResponse;
    /**
     * The system metadata of the experiment resource.
     */
    readonly systemData: outputs.chaos.v20240101.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getExperimentOutput(args: GetExperimentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExperimentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:chaos/v20240101:getExperiment", {
        "experimentName": args.experimentName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
