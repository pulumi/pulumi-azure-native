...
export function getCapability(args: GetCapabilityArgs, opts?: pulumi.InvokeOptions): Promise<GetCapabilityResult> {
    pulumi.log.warn("getCapability is deprecated: azure-native:chaos/v20210915preview:Capability is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Capability to guarantee forwards compatibility.")
