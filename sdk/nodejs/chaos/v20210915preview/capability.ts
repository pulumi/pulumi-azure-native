 ...
 *
 * @deprecated azure-native:chaos/v20210915preview:Capability is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Capability to guarantee forwards compatibility.
 */
export class Capability extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Capability {
        pulumi.log.warn("Capability is deprecated: azure-native:chaos/v20210915preview:Capability is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Capability to guarantee forwards compatibility.")
        return new Capability(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:chaos/v20210915preview:Capability';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.chaos.v20210915preview.CapabilityPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CapabilityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:Capability" }, { type: "azure-native:chaos/v20220701preview:Capability" }, { type: "azure-native:chaos/v20221001preview:Capability" }, { type: "azure-native:chaos/v20230401preview:Capability" }] };
