...
export class Experiment extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.chaos.v20231027preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.chaos.v20231027preview.ExperimentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ExperimentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos/v20210915preview:Experiment" }, { type: "azure-native:chaos/v20220701preview:Experiment" }, { type: "azure-native:chaos/v20221001preview:Experiment" }, { type: "azure-native:chaos/v20230401preview:Experiment" }, { type: "azure-native:chaos/v20230415preview:Experiment" }, { type: "azure-native:chaos/v20230901preview:Experiment" }, { type: "azure-native:chaos/v20231101:Experiment" }, { type: "azure-native:chaos/v20240101:Experiment" }, { type: "azure-native:chaos/v20240322preview:Experiment" }, { type: "azure-native:chaos/v20241101preview:Experiment" }, { type: "azure-native:chaos/v20250101:Experiment" }, { type: "azure-native:chaos:Experiment" }] };
...
export interface ExperimentArgs {
     ...
     * The identity of the experiment resource.
     */
    identity?: pulumi.Input<inputs.chaos.v20231027preview.ResourceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The properties of the experiment resource.
     */
    properties: pulumi.Input<inputs.chaos.v20231027preview.ExperimentPropertiesArgs>;
    /**
