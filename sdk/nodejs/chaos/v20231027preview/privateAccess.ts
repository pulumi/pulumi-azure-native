...
export class PrivateAccess extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.chaos.v20231027preview.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: PrivateAccessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos/v20240322preview:PrivateAccess" }, { type: "azure-native:chaos/v20241101preview:PrivateAccess" }, { type: "azure-native:chaos:PrivateAccess" }] };
