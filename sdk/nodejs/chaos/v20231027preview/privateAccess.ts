...
export class PrivateAccess extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateAccessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:PrivateAccess" }, { type: "azure-native:chaos/v20240322preview:PrivateAccess" }, { type: "azure-native:chaos/v20241101preview:PrivateAccess" }] };
