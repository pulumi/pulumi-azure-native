 ...
 *
 * @deprecated azure-native:chaos/v20221001preview:Target is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Target to guarantee forwards compatibility.
 */
export class Target extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Target {
        pulumi.log.warn("Target is deprecated: azure-native:chaos/v20221001preview:Target is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Target to guarantee forwards compatibility.")
        return new Target(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:chaos/v20221001preview:Target';
    ...
    constructor(name: string, args: TargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:Target" }, { type: "azure-native:chaos/v20210915preview:Target" }, { type: "azure-native:chaos/v20220701preview:Target" }, { type: "azure-native:chaos/v20230401preview:Target" }] };
