...
export function getCapability(args: GetCapabilityArgs, opts?: pulumi.InvokeOptions): Promise<GetCapabilityResult> {
    pulumi.log.warn("getCapability is deprecated: azure-native:chaos/v20221001preview:Capability is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230401preview:Capability to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:chaos/v20221001preview:getCapability", {
...
export interface GetCapabilityResult {
     ...
     */
    readonly properties: outputs.chaos.v20221001preview.CapabilityPropertiesResponse;
    /**
