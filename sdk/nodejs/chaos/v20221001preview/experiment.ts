...
export class Experiment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Experiment {
        pulumi.log.warn("Experiment is deprecated: azure-native:chaos/v20221001preview:Experiment is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Experiment to guarantee forwards compatibility.")
