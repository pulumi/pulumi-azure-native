 ...
 *
 * @deprecated azure-native:chaos/v20221001preview:Capability is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Capability to guarantee forwards compatibility.
 */
export class Capability extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:chaos/v20221001preview:Capability';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.chaos.v20221001preview.CapabilityPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CapabilityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:Capability" }, { type: "azure-native:chaos/v20210915preview:Capability" }, { type: "azure-native:chaos/v20220701preview:Capability" }, { type: "azure-native:chaos/v20230401preview:Capability" }] };
