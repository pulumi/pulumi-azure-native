...
export function getExperiment(args: GetExperimentArgs, opts?: pulumi.InvokeOptions): Promise<GetExperimentResult> {
    pulumi.log.warn("getExperiment is deprecated: azure-native:chaos/v20230401preview:Experiment is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Experiment to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:chaos/v20230401preview:getExperiment", {
...
export interface GetExperimentResult {
     ...
     */
    readonly identity?: outputs.chaos.v20230401preview.ResourceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.chaos.v20230401preview.ExperimentPropertiesResponse;
    /**
