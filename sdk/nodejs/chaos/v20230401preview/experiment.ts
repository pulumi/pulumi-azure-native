...
export class Experiment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Experiment {
        pulumi.log.warn("Experiment is deprecated: azure-native:chaos/v20230401preview:Experiment is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Experiment to guarantee forwards compatibility.")
        return new Experiment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:chaos/v20230401preview:Experiment';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.chaos.v20230401preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.chaos.v20230401preview.ExperimentPropertiesResponse>;
    /**
     * The system metadata of the experiment resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.chaos.v20230401preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ExperimentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:Experiment" }, { type: "azure-native:chaos/v20210915preview:Experiment" }, { type: "azure-native:chaos/v20220701preview:Experiment" }, { type: "azure-native:chaos/v20221001preview:Experiment" }] };
...
export interface ExperimentArgs {
     ...
     * The identity of the experiment resource.
     */
    identity?: pulumi.Input<inputs.chaos.v20230401preview.ResourceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The properties of the experiment resource.
     */
    properties: pulumi.Input<inputs.chaos.v20230401preview.ExperimentPropertiesArgs>;
    /**
