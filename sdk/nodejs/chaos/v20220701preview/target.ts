 ...
 *
 * @deprecated azure-native:chaos/v20220701preview:Target is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Target to guarantee forwards compatibility.
 */
export class Target extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:chaos/v20220701preview:Target';
    ...
    constructor(name: string, args: TargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:Target" }, { type: "azure-native:chaos/v20210915preview:Target" }, { type: "azure-native:chaos/v20221001preview:Target" }, { type: "azure-native:chaos/v20230401preview:Target" }] };
