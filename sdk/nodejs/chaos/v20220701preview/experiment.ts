...
export class Experiment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:chaos/v20220701preview:Experiment';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.chaos.v20220701preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.chaos.v20220701preview.ExperimentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ExperimentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:Experiment" }, { type: "azure-native:chaos/v20210915preview:Experiment" }, { type: "azure-native:chaos/v20221001preview:Experiment" }, { type: "azure-native:chaos/v20230401preview:Experiment" }, { type: "azure-native:chaos/v20230415preview:Experiment" }] };
...
export interface ExperimentArgs {
     ...
     * The identity of the experiment resource.
     */
    identity?: pulumi.Input<inputs.chaos.v20220701preview.ResourceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The properties of the experiment resource.
     */
    properties: pulumi.Input<inputs.chaos.v20220701preview.ExperimentPropertiesArgs>;
    /**
