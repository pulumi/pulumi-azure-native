...
export class Capability extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CapabilityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:Capability" }, { type: "azure-native:chaos/v20210915preview:Capability" }, { type: "azure-native:chaos/v20221001preview:Capability" }] };
