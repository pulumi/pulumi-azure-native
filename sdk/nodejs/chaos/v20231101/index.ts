...
// Export enums:
export * from "../../types/enums/chaos/v20231101";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:chaos/v20231101:Capability":
                return new Capability(name, <any>undefined, { urn })
            case "azure-native:chaos/v20231101:Experiment":
                return new Experiment(name, <any>undefined, { urn })
            case "azure-native:chaos/v20231101:Target":
...
pulumi.runtime.registerResourceModule("azure-native", "chaos/v20231101", _module)
