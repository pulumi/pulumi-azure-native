...
export class PrivateAccess extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly privateEndpointConnections: pulumi.Output<outputs.chaos.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: PrivateAccessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos/v20231027preview:PrivateAccess" }, { type: "azure-native:chaos/v20240322preview:PrivateAccess" }, { type: "azure-native:chaos/v20241101preview:PrivateAccess" }, { type: "azure-native:chaos/v20260501preview:PrivateAccess" }] };
