...
export interface GetExperimentResult {
     ...
     */
    readonly identity?: outputs.chaos.v20230415preview.ResourceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.chaos.v20230415preview.ExperimentPropertiesResponse;
    /**
...
export function getExperimentOutput(args: GetExperimentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExperimentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:chaos/v20230415preview:getExperiment", {
        "experimentName": args.experimentName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
