...
export class Experiment extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.chaos.v20230415preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.chaos.v20230415preview.ExperimentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ExperimentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:Experiment" }, { type: "azure-native:chaos/v20210915preview:Experiment" }, { type: "azure-native:chaos/v20230401preview:Experiment" }] };
