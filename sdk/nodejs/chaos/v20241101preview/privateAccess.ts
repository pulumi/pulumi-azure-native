...
export class PrivateAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:chaos/v20241101preview:PrivateAccess';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.chaos.v20241101preview.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: PrivateAccessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:chaos:PrivateAccess" }, { type: "azure-native:chaos/v20231027preview:PrivateAccess" }, { type: "azure-native:chaos/v20240322preview:PrivateAccess" }] };
...
export interface PrivateAccessArgs {
     ...
     * Public Network Access Control for PrivateAccess resource.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.chaos.v20241101preview.PublicNetworkAccessOption>;
    /**
