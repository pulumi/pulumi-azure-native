...
export class AttestationProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AttestationProvider {
        pulumi.log.warn("AttestationProvider is deprecated: azure-native:attestation/v20201001:AttestationProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:attestation/v20210601:AttestationProvider to guarantee forwards compatibility.")
        return new AttestationProvider(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:attestation/v20201001:AttestationProvider';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.attestation.v20201001.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: AttestationProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:attestation:AttestationProvider" }, { type: "azure-native:attestation/v20180901preview:AttestationProvider" }, { type: "azure-native:attestation/v20210601preview:AttestationProvider" }] };
