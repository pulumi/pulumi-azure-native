...
export class AttestationProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AttestationProvider {
        return new AttestationProvider(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: AttestationProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:attestation/preview:AttestationProvider" }] };
