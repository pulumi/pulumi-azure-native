...
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.attestation.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.attestation.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:attestation/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:attestation/latest:PrivateEndpointConnection" }, { type: "azure-native:attestation/v20201001:PrivateEndpointConnection" }, { type: "azure-nextgen:attestation/v20201001:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Input<inputs.attestation.PrivateLinkServiceConnectionState>;
    /**
