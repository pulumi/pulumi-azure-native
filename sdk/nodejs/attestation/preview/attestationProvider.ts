...
export class AttestationProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:attestation/preview:AttestationProvider';
    ...
    constructor(name: string, args: AttestationProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:attestation/v20180901preview:AttestationProvider" }] };
...
export interface AttestationProviderArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.attestation.preview.AttestationServiceCreationSpecificParams>;
    /**
