...
export class AttestationProvider extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AttestationProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:attestation/v20201001:AttestationProvider" }, { type: "azure-native:attestation/v20210601preview:AttestationProvider" }] };
