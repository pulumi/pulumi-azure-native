...
export class AttestationProvider extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AttestationProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:attestation/latest:AttestationProvider" }, { type: "azure-nextgen:attestation/latest:AttestationProvider" }, { type: "azure-native:attestation/v20180901preview:AttestationProvider" }, { type: "azure-nextgen:attestation/v20180901preview:AttestationProvider" }, { type: "azure-native:attestation/v20201001:AttestationProvider" }, { type: "azure-nextgen:attestation/v20201001:AttestationProvider" }] };
