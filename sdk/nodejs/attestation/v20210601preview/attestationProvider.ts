...
export class AttestationProvider extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.attestation.v20210601preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.attestation.v20210601preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: AttestationProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:attestation/v20180901preview:AttestationProvider" }, { type: "azure-native:attestation/v20201001:AttestationProvider" }, { type: "azure-native:attestation/v20210601:AttestationProvider" }, { type: "azure-native:attestation:AttestationProvider" }] };
...
export interface AttestationProviderArgs {
     ...
     */
    properties: pulumi.Input<inputs.attestation.v20210601preview.AttestationServiceCreationSpecificParamsArgs>;
    /**
