...
export class Sensor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotsecurity/v20210901preview:Sensor';
    ...
    constructor(name: string, args: SensorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:iotsecurity/v20210901preview:Sensor" }, { type: "azure-native:iotsecurity:Sensor" }, { type: "azure-nextgen:iotsecurity:Sensor" }, { type: "azure-native:iotsecurity/v20210201preview:Sensor" }, { type: "azure-nextgen:iotsecurity/v20210201preview:Sensor" }] };
