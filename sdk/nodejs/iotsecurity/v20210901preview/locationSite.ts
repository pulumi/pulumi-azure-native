...
export class LocationSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotsecurity/v20210901preview:LocationSite';
    ...
    constructor(name: string, args: LocationSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:iotsecurity/v20210901preview:LocationSite" }, { type: "azure-native:iotsecurity:LocationSite" }, { type: "azure-nextgen:iotsecurity:LocationSite" }] };
