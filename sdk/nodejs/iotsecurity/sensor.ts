...
export class Sensor extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SensorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:iotsecurity:Sensor" }, { type: "azure-native:iotsecurity/v20210201preview:Sensor" }, { type: "azure-nextgen:iotsecurity/v20210201preview:Sensor" }] };
...
export interface SensorArgs {
     ...
     * Type of sensor
     */
    readonly sensorType?: pulumi.Input<string | enums.iotsecurity.SensorType>;
    /**
     * TI Automatic mode status of the IoT sensor
     */
