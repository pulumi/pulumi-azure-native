...
export class ScopingConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appcomplianceautomation/v20240627:ScopingConfiguration';
     ...
     */
    public readonly answers!: pulumi.Output<outputs.appcomplianceautomation.v20240627.ScopingAnswerResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ScopingConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appcomplianceautomation:ScopingConfiguration" }] };
...
export interface ScopingConfigurationArgs {
     ...
     * List of scoping question answers.
     */
    answers?: pulumi.Input<pulumi.Input<inputs.appcomplianceautomation.v20240627.ScopingAnswerArgs>[]>;
    /**
     * Report Name.
     */
