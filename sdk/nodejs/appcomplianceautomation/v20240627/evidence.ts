...
export class Evidence extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appcomplianceautomation/v20240627:Evidence';
    ...
    constructor(name: string, args: EvidenceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appcomplianceautomation:Evidence" }] };
