...
export class Report extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appcomplianceautomation/v20240627:Report';
     ...
     */
    public /*out*/ readonly certRecords!: pulumi.Output<outputs.appcomplianceautomation.v20240627.CertSyncRecordResponse[]>;
    /**
     * Report compliance status.
     */
    public /*out*/ readonly complianceStatus!: pulumi.Output<outputs.appcomplianceautomation.v20240627.ReportComplianceStatusResponse>;
    /**
     ...
     */
    public readonly resources!: pulumi.Output<outputs.appcomplianceautomation.v20240627.ResourceMetadataResponse[]>;
    /**
     * Report status.
     */
     ...
     */
    public readonly storageInfo!: pulumi.Output<outputs.appcomplianceautomation.v20240627.StorageInfoResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ReportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appcomplianceautomation/v20221116preview:Report" }, { type: "azure-native:appcomplianceautomation:Report" }] };
...
export interface ReportArgs {
     ...
     * List of resource data.
     */
    resources: pulumi.Input<pulumi.Input<inputs.appcomplianceautomation.v20240627.ResourceMetadataArgs>[]>;
    /**
     * The information of 'bring your own storage' binding to the report
     */
    storageInfo?: pulumi.Input<inputs.appcomplianceautomation.v20240627.StorageInfoArgs>;
    /**
     * Report collection trigger time's time zone, the available list can be obtained by executing "Get-TimeZone -ListAvailable" in PowerShell.
     * An example of valid timezone id is "Pacific Standard Time".
     */
