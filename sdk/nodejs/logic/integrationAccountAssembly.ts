...
export class IntegrationAccountAssembly extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:logic:IntegrationAccountAssembly';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.AssemblyPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountAssemblyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic/latest:IntegrationAccountAssembly" }, { type: "azure-nextgen:logic/v20160601:IntegrationAccountAssembly" }, { type: "azure-nextgen:logic/v20180701preview:IntegrationAccountAssembly" }, { type: "azure-nextgen:logic/v20190501:IntegrationAccountAssembly" }] };
...
export interface IntegrationAccountAssemblyArgs {
     ...
     * The assembly properties.
     */
    readonly properties: pulumi.Input<inputs.logic.AssemblyProperties>;
    /**
