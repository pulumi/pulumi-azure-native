...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IntegrationAccountBatchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/v20160601:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/v20190501:IntegrationAccountBatchConfiguration" }] };
