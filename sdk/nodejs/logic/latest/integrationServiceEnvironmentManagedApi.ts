...
export class IntegrationServiceEnvironmentManagedApi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/latest:IntegrationServiceEnvironmentManagedApi';
    ...
    constructor(name: string, argsOrState?: IntegrationServiceEnvironmentManagedApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/preview:IntegrationServiceEnvironmentManagedApi" }, { type: "azurerm:logic/v20190501:IntegrationServiceEnvironmentManagedApi" }] };
