...
export class IntegrationServiceEnvironment extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.latest.IntegrationServiceEnvironmentPropertiesResponse>;
    /**
     * The sku.
     */
    public readonly sku!: pulumi.Output<outputs.logic.latest.IntegrationServiceEnvironmentSkuResponse | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationServiceEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic/latest:IntegrationServiceEnvironment" }, { type: "azure-native:logic:IntegrationServiceEnvironment" }, { type: "azure-nextgen:logic:IntegrationServiceEnvironment" }, { type: "azure-native:logic/v20190501:IntegrationServiceEnvironment" }, { type: "azure-nextgen:logic/v20190501:IntegrationServiceEnvironment" }] };
...
export interface IntegrationServiceEnvironmentArgs {
     ...
     * The integration service environment properties.
     */
    readonly properties?: pulumi.Input<inputs.logic.latest.IntegrationServiceEnvironmentProperties>;
    /**
     * The resource group.
     */
     ...
     * The sku.
     */
    readonly sku?: pulumi.Input<inputs.logic.latest.IntegrationServiceEnvironmentSku>;
    /**
     * The resource tags.
     */
