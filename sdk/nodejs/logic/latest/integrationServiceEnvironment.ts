...
export class IntegrationServiceEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/latest:IntegrationServiceEnvironment';
    ...
    constructor(name: string, argsOrState?: IntegrationServiceEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/preview:IntegrationServiceEnvironment" }, { type: "azurerm:logic/v20190501:IntegrationServiceEnvironment" }] };
