...
export class IntegrationAccountAssembly extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.latest.AssemblyPropertiesResponse>;
    /**
     * The resource tags.
     */
...
export interface IntegrationAccountAssemblyArgs {
     ...
     * The assembly properties.
     */
    readonly properties: pulumi.Input<inputs.logic.latest.AssemblyProperties>;
    /**
