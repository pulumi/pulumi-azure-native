 ...
 *
 * const integrationAccountMap = new azurerm.logic.latest.IntegrationAccountMap("integrationAccountMap", {
...
export class IntegrationAccountMap extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IntegrationAccountMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/v20160601:IntegrationAccountMap" }, { type: "azurerm:logic/v20190501:IntegrationAccountMap" }] };
