...
export class IntegrationAccountAgreement extends pulumi.CustomResource {
     ...
     */
    public readonly content!: pulumi.Output<outputs.logic.latest.AgreementContentResponse>;
    /**
     * The created time.
     */
     ...
     */
    public readonly guestIdentity!: pulumi.Output<outputs.logic.latest.BusinessIdentityResponse>;
    /**
     ...
     */
    public readonly hostIdentity!: pulumi.Output<outputs.logic.latest.BusinessIdentityResponse>;
    /**
    ...
    constructor(name: string, args: IntegrationAccountAgreementArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic/v20150801preview:IntegrationAccountAgreement" }, { type: "azure-nextgen:logic/v20160601:IntegrationAccountAgreement" }, { type: "azure-nextgen:logic/v20180701preview:IntegrationAccountAgreement" }, { type: "azure-nextgen:logic/v20190501:IntegrationAccountAgreement" }] };
...
export interface IntegrationAccountAgreementArgs {
     ...
     * The agreement type.
     */
    readonly agreementType: pulumi.Input<enums.logic.latest.AgreementType>;
    /**
     * The agreement content.
     */
    readonly content: pulumi.Input<inputs.logic.latest.AgreementContent>;
    /**
     * The business identity of the guest partner.
     */
    readonly guestIdentity: pulumi.Input<inputs.logic.latest.BusinessIdentity>;
    /**
     * The integration account partner that is set as guest partner for this agreement.
     */
     ...
     * The business identity of the host partner.
     */
    readonly hostIdentity: pulumi.Input<inputs.logic.latest.BusinessIdentity>;
    /**
     * The integration account partner that is set as host partner for this agreement.
     */
