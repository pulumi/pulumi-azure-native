...
export class IntegrationAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:logic/latest:IntegrationAccount';
     ...
     */
    public readonly integrationServiceEnvironment!: pulumi.Output<outputs.logic.latest.IntegrationServiceEnvironmentResponse | undefined>;
    /**
     ...
     * The sku.
     */
    public readonly sku!: pulumi.Output<outputs.logic.latest.IntegrationAccountSkuResponse | undefined>;
    /**
     * The workflow state.
     */
    ...
    constructor(name: string, args: IntegrationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic:IntegrationAccount" }, { type: "azure-nextgen:logic/v20150801preview:IntegrationAccount" }, { type: "azure-nextgen:logic/v20160601:IntegrationAccount" }, { type: "azure-nextgen:logic/v20180701preview:IntegrationAccount" }, { type: "azure-nextgen:logic/v20190501:IntegrationAccount" }] };
...
export interface IntegrationAccountArgs {
     ...
     * The integration service environment.
     */
    readonly integrationServiceEnvironment?: pulumi.Input<inputs.logic.latest.IntegrationServiceEnvironment>;
    /**
     * The resource location.
     */
     ...
     * The sku.
     */
    readonly sku?: pulumi.Input<inputs.logic.latest.IntegrationAccountSku>;
    /**
     * The workflow state.
     */
