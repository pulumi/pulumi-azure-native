...
export class IntegrationAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IntegrationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccount" }, { type: "azurerm:logic/preview:IntegrationAccount" }, { type: "azurerm:logic/v20150801preview:IntegrationAccount" }, { type: "azurerm:logic/v20180701preview:IntegrationAccount" }, { type: "azurerm:logic/v20190501:IntegrationAccount" }] };
