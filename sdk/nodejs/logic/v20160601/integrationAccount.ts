...
export class IntegrationAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccount {
        pulumi.log.warn("IntegrationAccount is deprecated: azure-native:logic/v20160601:IntegrationAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:logic/v20190501:IntegrationAccount to guarantee forwards compatibility.")
        return new IntegrationAccount(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:logic/v20160601:IntegrationAccount';
    ...
    constructor(name: string, args: IntegrationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logic:IntegrationAccount" }, { type: "azure-native:logic/v20150801preview:IntegrationAccount" }, { type: "azure-native:logic/v20180701preview:IntegrationAccount" }, { type: "azure-native:logic/v20190501:IntegrationAccount" }] };
...
export interface IntegrationAccountArgs {
     ...
     * The sku.
     */
    sku?: pulumi.Input<inputs.logic.v20160601.IntegrationAccountSkuArgs>;
    /**
     * The resource tags.
     */
