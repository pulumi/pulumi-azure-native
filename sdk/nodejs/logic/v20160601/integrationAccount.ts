...
export class IntegrationAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccount {
        pulumi.log.warn("IntegrationAccount is deprecated: azure-native:logic/v20160601:IntegrationAccount is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccount to guarantee forwards compatibility.")
