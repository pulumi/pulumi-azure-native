...
export function getIntegrationAccount(args: GetIntegrationAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:logic/v20160601:getIntegrationAccount", {
...
export interface GetIntegrationAccountResult {
     ...
     * The sku.
     */
    readonly sku?: outputs.logic.v20160601.IntegrationAccountSkuInvokeResponse;
    /**
     * The resource tags.
     */
