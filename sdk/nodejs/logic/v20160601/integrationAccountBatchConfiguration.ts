 ...
 *
 * @deprecated azure-native:logic/v20160601:IntegrationAccountBatchConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountBatchConfiguration to guarantee forwards compatibility.
 */
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountBatchConfiguration {
        pulumi.log.warn("IntegrationAccountBatchConfiguration is deprecated: azure-native:logic/v20160601:IntegrationAccountBatchConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountBatchConfiguration to guarantee forwards compatibility.")
        return new IntegrationAccountBatchConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:logic/v20160601:IntegrationAccountBatchConfiguration';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.v20160601.BatchConfigurationPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountBatchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logic:IntegrationAccountBatchConfiguration" }, { type: "azure-native:logic/v20180701preview:IntegrationAccountBatchConfiguration" }, { type: "azure-native:logic/v20190501:IntegrationAccountBatchConfiguration" }] };
...
export interface IntegrationAccountBatchConfigurationArgs {
     ...
     * The batch configuration properties.
     */
    properties: pulumi.Input<inputs.logic.v20160601.BatchConfigurationPropertiesArgs>;
    /**
