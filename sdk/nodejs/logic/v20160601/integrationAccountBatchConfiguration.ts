...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountBatchConfiguration {
        return new IntegrationAccountBatchConfiguration(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/v20160601:IntegrationAccountBatchConfiguration';
    ...
    constructor(name: string, argsOrState?: IntegrationAccountBatchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/preview:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/v20190501:IntegrationAccountBatchConfiguration" }] };
