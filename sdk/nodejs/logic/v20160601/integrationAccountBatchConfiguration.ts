...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountBatchConfiguration {
        pulumi.log.warn("IntegrationAccountBatchConfiguration is deprecated: azure-native:logic/v20160601:IntegrationAccountBatchConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:logic/v20190501:IntegrationAccountBatchConfiguration to guarantee forwards compatibility.")
