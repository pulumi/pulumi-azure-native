...
export class Session extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SessionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic/v20160601:Session" }, { type: "azure-native:logic:Session" }, { type: "azure-nextgen:logic:Session" }, { type: "azure-native:logic/latest:Session" }, { type: "azure-nextgen:logic/latest:Session" }, { type: "azure-native:logic/v20180701preview:Session" }, { type: "azure-nextgen:logic/v20180701preview:Session" }, { type: "azure-native:logic/v20190501:Session" }, { type: "azure-nextgen:logic/v20190501:Session" }] };
