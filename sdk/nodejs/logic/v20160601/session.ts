...
export class Session extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SessionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logic/v20180701preview:Session" }, { type: "azure-native:logic/v20190501:IntegrationAccountSession" }, { type: "azure-native:logic/v20190501:Session" }, { type: "azure-native:logic:IntegrationAccountSession" }, { type: "azure-native:logic:Session" }] };
