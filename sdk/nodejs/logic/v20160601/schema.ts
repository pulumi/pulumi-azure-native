 ...
 *
 * const schema = new azurerm.logic.v20160601.Schema("schema", {
...
export class Schema extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/v20160601:Schema';
    ...
    constructor(name: string, argsOrState?: SchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:Schema" }, { type: "azurerm:logic/v20190501:Schema" }] };
