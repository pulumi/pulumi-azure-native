...
export class Partner extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PartnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:Partner" }, { type: "azurerm:logic/preview:Partner" }, { type: "azurerm:logic/v20150801preview:Partner" }, { type: "azurerm:logic/v20180701preview:Partner" }, { type: "azurerm:logic/v20190501:Partner" }] };
