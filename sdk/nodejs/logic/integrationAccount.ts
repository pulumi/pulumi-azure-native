...
export class IntegrationAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:logic:IntegrationAccount';
     ...
     */
    public readonly integrationServiceEnvironment!: pulumi.Output<outputs.logic.IntegrationServiceEnvironmentResponse | undefined>;
    /**
    ...
    constructor(name: string, args: IntegrationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic/latest:IntegrationAccount" }, { type: "azure-nextgen:logic/v20150801preview:IntegrationAccount" }, { type: "azure-nextgen:logic/v20160601:IntegrationAccount" }, { type: "azure-nextgen:logic/v20180701preview:IntegrationAccount" }, { type: "azure-nextgen:logic/v20190501:IntegrationAccount" }] };
...
export interface IntegrationAccountArgs {
     ...
     * The integration service environment.
     */
    readonly integrationServiceEnvironment?: pulumi.Input<inputs.logic.IntegrationServiceEnvironment>;
    /**
     * The resource location.
     */
     ...
     * The sku.
     */
    readonly sku?: pulumi.Input<inputs.logic.IntegrationAccountSku>;
    /**
     * The workflow state.
     */
