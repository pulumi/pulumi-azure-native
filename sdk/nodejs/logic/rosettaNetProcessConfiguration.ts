...
export class RosettaNetProcessConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RosettaNetProcessConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic:RosettaNetProcessConfiguration" }, { type: "azure-native:logic/v20160601:RosettaNetProcessConfiguration" }, { type: "azure-nextgen:logic/v20160601:RosettaNetProcessConfiguration" }] };
...
export interface RosettaNetProcessConfigurationArgs {
     ...
     * The RosettaNet process configuration activity settings.
     */
    readonly activitySettings: pulumi.Input<inputs.logic.RosettaNetPipActivitySettingsArgs>;
    /**
     * The integration account RosettaNet ProcessConfiguration properties.
     */
     ...
     * The RosettaNet initiator role settings.
     */
    readonly initiatorRoleSettings: pulumi.Input<inputs.logic.RosettaNetPipRoleSettingsArgs>;
    /**
     ...
     * The RosettaNet responder role settings.
     */
    readonly responderRoleSettings: pulumi.Input<inputs.logic.RosettaNetPipRoleSettingsArgs>;
    /**
