...
export class IntegrationAccountPartner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic:IntegrationAccountPartner';
...
export interface IntegrationAccountPartnerState {
     ...
     * The integration account partner properties.
     */
    readonly properties: pulumi.Input<inputs.logic.IntegrationAccountPartnerPropertiesResponse>;
    /**
     * The resource tags.
     */
...
export interface IntegrationAccountPartnerArgs {
     ...
     * The integration account partner properties.
     */
    readonly properties: pulumi.Input<inputs.logic.IntegrationAccountPartnerProperties>;
    /**
