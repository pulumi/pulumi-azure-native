...
export class IntegrationAccountCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountCertificate {
        return new IntegrationAccountCertificate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic:IntegrationAccountCertificate';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.IntegrationAccountCertificatePropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, argsOrState?: IntegrationAccountCertificateArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface IntegrationAccountCertificateArgs {
     ...
     * The integration account certificate properties.
     */
    readonly properties: pulumi.Input<inputs.logic.IntegrationAccountCertificateProperties>;
    /**
