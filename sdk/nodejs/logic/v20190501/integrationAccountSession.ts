...
export class IntegrationAccountSession extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IntegrationAccountSessionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountSession" }, { type: "azurerm:logic/preview:IntegrationAccountSession" }, { type: "azurerm:logic/v20160601:IntegrationAccountSession" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountSession" }] };
