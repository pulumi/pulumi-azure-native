...
export function getIntegrationAccountAgreement(args: GetIntegrationAccountAgreementArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationAccountAgreementResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:logic/v20190501:getIntegrationAccountAgreement", {
...
export interface GetIntegrationAccountAgreementResult {
     ...
     */
    readonly content: outputs.logic.v20190501.AgreementContentInvokeResponse;
    /**
     * The created time.
     */
     ...
     */
    readonly guestIdentity: outputs.logic.v20190501.BusinessIdentityInvokeResponse;
    /**
     ...
     */
    readonly hostIdentity: outputs.logic.v20190501.BusinessIdentityInvokeResponse;
    /**
