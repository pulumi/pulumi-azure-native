...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/v20190501:IntegrationAccountBatchConfiguration';
    ...
    constructor(name: string, args: IntegrationAccountBatchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/preview:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/v20160601:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountBatchConfiguration" }] };
