...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.v20190501.BatchConfigurationPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountBatchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic/v20190501:IntegrationAccountBatchConfiguration" }, { type: "azure-native:logic:IntegrationAccountBatchConfiguration" }, { type: "azure-nextgen:logic:IntegrationAccountBatchConfiguration" }, { type: "azure-native:logic/latest:IntegrationAccountBatchConfiguration" }, { type: "azure-nextgen:logic/latest:IntegrationAccountBatchConfiguration" }, { type: "azure-native:logic/v20160601:IntegrationAccountBatchConfiguration" }, { type: "azure-nextgen:logic/v20160601:IntegrationAccountBatchConfiguration" }, { type: "azure-native:logic/v20180701preview:IntegrationAccountBatchConfiguration" }, { type: "azure-nextgen:logic/v20180701preview:IntegrationAccountBatchConfiguration" }] };
...
export interface IntegrationAccountBatchConfigurationArgs {
     ...
     * The batch configuration properties.
     */
    readonly properties: pulumi.Input<inputs.logic.v20190501.BatchConfigurationProperties>;
    /**
