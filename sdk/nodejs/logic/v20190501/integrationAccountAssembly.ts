...
export class IntegrationAccountAssembly extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IntegrationAccountAssemblyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic:IntegrationAccountAssembly" }, { type: "azure-nextgen:logic/latest:IntegrationAccountAssembly" }, { type: "azure-nextgen:logic/v20160601:IntegrationAccountAssembly" }, { type: "azure-nextgen:logic/v20180701preview:IntegrationAccountAssembly" }] };
