...
export class Workflow extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkflowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:Workflow" }, { type: "azurerm:logic/v20150201preview:Workflow" }, { type: "azurerm:logic/v20160601:Workflow" }, { type: "azurerm:logic/v20180701preview:Workflow" }] };
