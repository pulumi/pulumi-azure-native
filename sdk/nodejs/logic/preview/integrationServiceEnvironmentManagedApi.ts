...
export class IntegrationServiceEnvironmentManagedApi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:IntegrationServiceEnvironmentManagedApi';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.logic.preview.ApiResourcePropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationServiceEnvironmentManagedApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationServiceEnvironmentManagedApi" }, { type: "azurerm:logic/v20190501:IntegrationServiceEnvironmentManagedApi" }] };
