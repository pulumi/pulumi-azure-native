...
export class IntegrationServiceEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:IntegrationServiceEnvironment';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.preview.IntegrationServiceEnvironmentPropertiesResponse>;
    /**
     * The sku.
     */
    public readonly sku!: pulumi.Output<outputs.logic.preview.IntegrationServiceEnvironmentSkuResponse | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, argsOrState?: IntegrationServiceEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationServiceEnvironment" }, { type: "azurerm:logic/v20190501:IntegrationServiceEnvironment" }] };
...
export interface IntegrationServiceEnvironmentArgs {
     ...
     * The integration service environment properties.
     */
    readonly properties?: pulumi.Input<inputs.logic.preview.IntegrationServiceEnvironmentProperties>;
    /**
     * The resource group.
     */
     ...
     * The sku.
     */
    readonly sku?: pulumi.Input<inputs.logic.preview.IntegrationServiceEnvironmentSku>;
    /**
     * The resource tags.
     */
