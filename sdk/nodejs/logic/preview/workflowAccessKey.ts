...
export class WorkflowAccessKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:WorkflowAccessKey';
    ...
    constructor(name: string, argsOrState?: WorkflowAccessKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/v20150201preview:WorkflowAccessKey" }] };
