...
export function getIntegrationAccountAgreement(args: GetIntegrationAccountAgreementArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationAccountAgreementResult> {
    ...
    return pulumi.runtime.invoke("azurerm:logic/preview:getIntegrationAccountAgreement", {
...
export interface GetIntegrationAccountAgreementResult {
     ...
     */
    readonly content: outputs.logic.preview.AgreementContentResponse;
    /**
     * The created time.
     */
     ...
     */
    readonly guestIdentity: outputs.logic.preview.BusinessIdentityResponse;
    /**
     ...
     */
    readonly hostIdentity: outputs.logic.preview.BusinessIdentityResponse;
    /**
