...
export class IntegrationAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:IntegrationAccount';
     ...
     */
    public readonly integrationServiceEnvironment!: pulumi.Output<outputs.logic.preview.IntegrationServiceEnvironmentResponse | undefined>;
    /**
     ...
     * The sku.
     */
    public readonly sku!: pulumi.Output<outputs.logic.preview.IntegrationAccountSkuResponse | undefined>;
    /**
     * The workflow state.
     */
    ...
    constructor(name: string, argsOrState?: IntegrationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccount" }, { type: "azurerm:logic/v20150801preview:IntegrationAccount" }, { type: "azurerm:logic/v20160601:IntegrationAccount" }, { type: "azurerm:logic/v20180701preview:IntegrationAccount" }, { type: "azurerm:logic/v20190501:IntegrationAccount" }] };
...
export interface IntegrationAccountArgs {
     ...
     * The integration service environment.
     */
    readonly integrationServiceEnvironment?: pulumi.Input<inputs.logic.preview.IntegrationServiceEnvironment>;
    /**
     * The resource location.
     */
     ...
     * The sku.
     */
    readonly sku?: pulumi.Input<inputs.logic.preview.IntegrationAccountSku>;
    /**
     * The workflow state.
     */
