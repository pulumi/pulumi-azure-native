...
export function getRosettaNetProcessConfiguration(args: GetRosettaNetProcessConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetRosettaNetProcessConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azurerm:logic/preview:getRosettaNetProcessConfiguration", {
...
export interface GetRosettaNetProcessConfigurationResult {
     ...
     */
    readonly activitySettings: outputs.logic.preview.RosettaNetPipActivitySettingsResponse;
    /**
     * The changed time.
     */
     ...
     */
    readonly initiatorRoleSettings: outputs.logic.preview.RosettaNetPipRoleSettingsResponse;
    /**
     ...
     */
    readonly responderRoleSettings: outputs.logic.preview.RosettaNetPipRoleSettingsResponse;
    /**
     * The resource tags.
     */
