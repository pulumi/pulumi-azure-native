...
export class IntegrationAccountPartner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:IntegrationAccountPartner';
     ...
     * The partner content.
     */
    public readonly content!: pulumi.Output<outputs.logic.preview.PartnerContentResponse>;
    /**
     * The created time.
     */
    ...
    constructor(name: string, argsOrState?: IntegrationAccountPartnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountPartner" }, { type: "azurerm:logic/v20150801preview:IntegrationAccountPartner" }, { type: "azurerm:logic/v20160601:IntegrationAccountPartner" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountPartner" }, { type: "azurerm:logic/v20190501:IntegrationAccountPartner" }] };
...
export interface IntegrationAccountPartnerArgs {
     ...
     * The partner content.
     */
    readonly content: pulumi.Input<inputs.logic.preview.PartnerContent>;
    /**
