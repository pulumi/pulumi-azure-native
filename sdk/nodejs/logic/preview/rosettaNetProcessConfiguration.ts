...
export class RosettaNetProcessConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:RosettaNetProcessConfiguration';
     ...
     */
    public readonly activitySettings!: pulumi.Output<outputs.logic.preview.RosettaNetPipActivitySettingsResponse>;
    /**
     * The changed time.
     */
     ...
     */
    public readonly initiatorRoleSettings!: pulumi.Output<outputs.logic.preview.RosettaNetPipRoleSettingsResponse>;
    /**
     ...
     */
    public readonly responderRoleSettings!: pulumi.Output<outputs.logic.preview.RosettaNetPipRoleSettingsResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: RosettaNetProcessConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:RosettaNetProcessConfiguration" }, { type: "azurerm:logic/v20160601:RosettaNetProcessConfiguration" }] };
...
export interface RosettaNetProcessConfigurationArgs {
     ...
     * The RosettaNet process configuration activity settings.
     */
    readonly activitySettings: pulumi.Input<inputs.logic.preview.RosettaNetPipActivitySettings>;
    /**
     * The integration account RosettaNet ProcessConfiguration properties.
     */
     ...
     * The RosettaNet initiator role settings.
     */
    readonly initiatorRoleSettings: pulumi.Input<inputs.logic.preview.RosettaNetPipRoleSettings>;
    /**
     ...
     * The RosettaNet responder role settings.
     */
    readonly responderRoleSettings: pulumi.Input<inputs.logic.preview.RosettaNetPipRoleSettings>;
    /**
