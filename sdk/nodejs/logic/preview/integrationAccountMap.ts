...
export class IntegrationAccountMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:IntegrationAccountMap';
     ...
     */
    public readonly parametersSchema!: pulumi.Output<outputs.logic.preview.IntegrationAccountMapPropertiesResponseParametersSchema | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountMap" }, { type: "azurerm:logic/v20150801preview:IntegrationAccountMap" }, { type: "azurerm:logic/v20160601:IntegrationAccountMap" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountMap" }, { type: "azurerm:logic/v20190501:IntegrationAccountMap" }] };
...
export interface IntegrationAccountMapArgs {
     ...
     * The parameters schema of integration account map.
     */
    readonly parametersSchema?: pulumi.Input<inputs.logic.preview.IntegrationAccountMapPropertiesParametersSchema>;
    /**
