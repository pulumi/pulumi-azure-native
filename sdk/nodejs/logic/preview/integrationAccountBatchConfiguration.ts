...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:IntegrationAccountBatchConfiguration';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.preview.BatchConfigurationPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountBatchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/v20160601:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountBatchConfiguration" }, { type: "azurerm:logic/v20190501:IntegrationAccountBatchConfiguration" }] };
...
export interface IntegrationAccountBatchConfigurationArgs {
     ...
     * The batch configuration properties.
     */
    readonly properties: pulumi.Input<inputs.logic.preview.BatchConfigurationProperties>;
    /**
