...
export class IntegrationAccountAssembly extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountAssembly {
        return new IntegrationAccountAssembly(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/preview:IntegrationAccountAssembly';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.preview.AssemblyPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, argsOrState?: IntegrationAccountAssemblyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountAssembly" }, { type: "azurerm:logic/v20160601:IntegrationAccountAssembly" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountAssembly" }, { type: "azurerm:logic/v20190501:IntegrationAccountAssembly" }] };
...
export interface IntegrationAccountAssemblyArgs {
     ...
     * The assembly properties.
     */
    readonly properties: pulumi.Input<inputs.logic.preview.AssemblyProperties>;
    /**
