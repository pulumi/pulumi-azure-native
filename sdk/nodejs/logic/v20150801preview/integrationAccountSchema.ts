...
export class IntegrationAccountSchema extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IntegrationAccountSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountSchema" }, { type: "azurerm:logic/v20160601:IntegrationAccountSchema" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountSchema" }, { type: "azurerm:logic/v20190501:IntegrationAccountSchema" }] };
