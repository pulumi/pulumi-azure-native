...
export class IntegrationAccountPartner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/v20150801preview:IntegrationAccountPartner';
    ...
    constructor(name: string, args: IntegrationAccountPartnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountPartner" }, { type: "azurerm:logic/preview:IntegrationAccountPartner" }, { type: "azurerm:logic/v20160601:IntegrationAccountPartner" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountPartner" }, { type: "azurerm:logic/v20190501:IntegrationAccountPartner" }] };
