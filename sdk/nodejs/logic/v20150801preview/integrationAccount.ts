...
export class IntegrationAccount extends pulumi.CustomResource {
     ...
     * The sku.
     */
    public readonly sku!: pulumi.Output<outputs.logic.v20150801preview.IntegrationAccountSkuResponse | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic/v20150801preview:IntegrationAccount" }, { type: "azure-native:logic:IntegrationAccount" }, { type: "azure-nextgen:logic:IntegrationAccount" }, { type: "azure-native:logic/latest:IntegrationAccount" }, { type: "azure-nextgen:logic/latest:IntegrationAccount" }, { type: "azure-native:logic/v20160601:IntegrationAccount" }, { type: "azure-nextgen:logic/v20160601:IntegrationAccount" }, { type: "azure-native:logic/v20180701preview:IntegrationAccount" }, { type: "azure-nextgen:logic/v20180701preview:IntegrationAccount" }, { type: "azure-native:logic/v20190501:IntegrationAccount" }, { type: "azure-nextgen:logic/v20190501:IntegrationAccount" }] };
...
export interface IntegrationAccountArgs {
     ...
     * The sku.
     */
    readonly sku?: pulumi.Input<inputs.logic.v20150801preview.IntegrationAccountSku>;
    /**
     * The resource tags.
     */
