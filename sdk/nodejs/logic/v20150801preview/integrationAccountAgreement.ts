...
export class IntegrationAccountAgreement extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/v20150801preview:IntegrationAccountAgreement';
    ...
    constructor(name: string, argsOrState?: IntegrationAccountAgreementArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountAgreement" }, { type: "azurerm:logic/v20160601:IntegrationAccountAgreement" }, { type: "azurerm:logic/v20180701preview:IntegrationAccountAgreement" }, { type: "azurerm:logic/v20190501:IntegrationAccountAgreement" }] };
