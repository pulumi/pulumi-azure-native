...
export class IntegrationAccountAgreement extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic:IntegrationAccountAgreement';
...
export interface IntegrationAccountAgreementState {
     ...
     * The integration account agreement properties.
     */
    readonly properties: pulumi.Input<inputs.logic.IntegrationAccountAgreementPropertiesResponse>;
    /**
     * The resource tags.
     */
...
export interface IntegrationAccountAgreementArgs {
     ...
     * The integration account agreement properties.
     */
    readonly properties: pulumi.Input<inputs.logic.IntegrationAccountAgreementProperties>;
    /**
