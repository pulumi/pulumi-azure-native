...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic:IntegrationAccountBatchConfiguration';
...
export interface IntegrationAccountBatchConfigurationState {
     ...
     * The batch configuration properties.
     */
    readonly properties: pulumi.Input<inputs.logic.BatchConfigurationPropertiesResponse>;
    /**
     * The resource tags.
     */
