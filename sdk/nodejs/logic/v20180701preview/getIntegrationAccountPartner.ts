...
export function getIntegrationAccountPartner(args: GetIntegrationAccountPartnerArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationAccountPartnerResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:logic/v20180701preview:getIntegrationAccountPartner", {
...
export interface GetIntegrationAccountPartnerResult {
     ...
     * The partner content.
     */
    readonly content: outputs.logic.v20180701preview.PartnerContentInvokeResponse;
    /**
     * The created time.
     */
