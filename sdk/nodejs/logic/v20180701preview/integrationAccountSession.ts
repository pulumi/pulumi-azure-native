...
export class IntegrationAccountSession extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IntegrationAccountSessionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountSession" }, { type: "azurerm:logic/preview:IntegrationAccountSession" }, { type: "azurerm:logic/v20160601:IntegrationAccountSession" }, { type: "azurerm:logic/v20190501:IntegrationAccountSession" }] };
