 ...
 *
 * const integrationAccountSession = new azurerm.logic.v20180701preview.IntegrationAccountSession("integrationAccountSession", {
 *     content: {
 *         controlNumber: "1234",
...
export class IntegrationAccountSession extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/v20180701preview:IntegrationAccountSession';
    ...
    constructor(name: string, args: IntegrationAccountSessionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountSession" }, { type: "azurerm:logic/v20160601:IntegrationAccountSession" }, { type: "azurerm:logic/v20190501:IntegrationAccountSession" }] };
