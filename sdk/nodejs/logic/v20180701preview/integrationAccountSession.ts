...
export class IntegrationAccountSession extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountSession {
        pulumi.log.warn("IntegrationAccountSession is deprecated: azure-native:logic/v20180701preview:IntegrationAccountSession is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountSession to guarantee forwards compatibility.")
        return new IntegrationAccountSession(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:logic/v20180701preview:IntegrationAccountSession';
    ...
    constructor(name: string, args: IntegrationAccountSessionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logic:IntegrationAccountSession" }, { type: "azure-native:logic/v20160601:IntegrationAccountSession" }, { type: "azure-native:logic/v20190501:IntegrationAccountSession" }] };
