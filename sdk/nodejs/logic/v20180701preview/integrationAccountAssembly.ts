 ...
 *
 * @deprecated azure-native:logic/v20180701preview:IntegrationAccountAssembly is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountAssembly to guarantee forwards compatibility.
 */
export class IntegrationAccountAssembly extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountAssembly {
        pulumi.log.warn("IntegrationAccountAssembly is deprecated: azure-native:logic/v20180701preview:IntegrationAccountAssembly is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountAssembly to guarantee forwards compatibility.")
        return new IntegrationAccountAssembly(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:logic/v20180701preview:IntegrationAccountAssembly';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.v20180701preview.AssemblyPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountAssemblyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logic:IntegrationAccountAssembly" }, { type: "azure-native:logic/v20160601:IntegrationAccountAssembly" }, { type: "azure-native:logic/v20190501:IntegrationAccountAssembly" }] };
