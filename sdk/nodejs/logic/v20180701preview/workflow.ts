 ...
 *
 * const workflow = new azurerm.logic.v20180701preview.Workflow("workflow", {
 *     definition: {
...
export class Workflow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/v20180701preview:Workflow';
    ...
    constructor(name: string, args: WorkflowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:Workflow" }, { type: "azurerm:logic/v20150201preview:Workflow" }, { type: "azurerm:logic/v20160601:Workflow" }, { type: "azurerm:logic/v20190501:Workflow" }] };
