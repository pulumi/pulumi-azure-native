 ...
 *
 * const workflow = new azure_native.logic.v20180701preview.Workflow("workflow", {
 *     definition: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:logic/v20180701preview:Workflow myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName} 
 * ```
 */
