...
export class IntegrationAccountPartner extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountPartner {
        pulumi.log.warn("IntegrationAccountPartner is deprecated: azure-native:logic/v20180701preview:IntegrationAccountPartner is being removed in the next major version of this provider. Upgrade to at least azure-native:logic/v20190501:IntegrationAccountPartner to guarantee forwards compatibility.")
