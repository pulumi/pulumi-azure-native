...
export class IntegrationAccountPartner extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IntegrationAccountPartnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountPartner" }, { type: "azurerm:logic/preview:IntegrationAccountPartner" }, { type: "azurerm:logic/v20150801preview:IntegrationAccountPartner" }, { type: "azurerm:logic/v20160601:IntegrationAccountPartner" }, { type: "azurerm:logic/v20190501:IntegrationAccountPartner" }] };
