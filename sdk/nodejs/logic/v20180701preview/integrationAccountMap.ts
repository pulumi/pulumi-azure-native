...
export class IntegrationAccountMap extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IntegrationAccountMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountMap" }, { type: "azurerm:logic/preview:IntegrationAccountMap" }, { type: "azurerm:logic/v20150801preview:IntegrationAccountMap" }, { type: "azurerm:logic/v20160601:IntegrationAccountMap" }, { type: "azurerm:logic/v20190501:IntegrationAccountMap" }] };
