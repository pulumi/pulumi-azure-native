 ...
 *
 * const integrationAccountMap = new azurerm.logic.v20180701preview.IntegrationAccountMap("integrationAccountMap", {
...
export class IntegrationAccountMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:logic/v20180701preview:IntegrationAccountMap';
    ...
    constructor(name: string, args: IntegrationAccountMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:logic/latest:IntegrationAccountMap" }, { type: "azurerm:logic/v20150801preview:IntegrationAccountMap" }, { type: "azurerm:logic/v20160601:IntegrationAccountMap" }, { type: "azurerm:logic/v20190501:IntegrationAccountMap" }] };
