...
export class IntegrationAccountMap extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountMap {
        pulumi.log.warn("IntegrationAccountMap is deprecated: azure-native:logic/v20180701preview:IntegrationAccountMap is being removed in the next major version of this provider. Upgrade to at least azure-native:logic/v20190501:IntegrationAccountMap to guarantee forwards compatibility.")
