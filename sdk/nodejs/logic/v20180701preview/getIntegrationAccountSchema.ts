 ...
 */
/** @deprecated azure-native:logic/v20180701preview:IntegrationAccountSchema is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountSchema to guarantee forwards compatibility. */
export function getIntegrationAccountSchema(args: GetIntegrationAccountSchemaArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationAccountSchemaResult> {
    pulumi.log.warn("getIntegrationAccountSchema is deprecated: azure-native:logic/v20180701preview:IntegrationAccountSchema is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountSchema to guarantee forwards compatibility.")
