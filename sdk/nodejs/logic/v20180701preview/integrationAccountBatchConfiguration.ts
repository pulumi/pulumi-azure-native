...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:logic/v20180701preview:IntegrationAccountBatchConfiguration';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.logic.v20180701preview.BatchConfigurationPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountBatchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:logic:IntegrationAccountBatchConfiguration" }, { type: "azure-nextgen:logic/latest:IntegrationAccountBatchConfiguration" }, { type: "azure-nextgen:logic/v20160601:IntegrationAccountBatchConfiguration" }, { type: "azure-nextgen:logic/v20190501:IntegrationAccountBatchConfiguration" }] };
...
export interface IntegrationAccountBatchConfigurationArgs {
     ...
     * The batch configuration properties.
     */
    readonly properties: pulumi.Input<inputs.logic.v20180701preview.BatchConfigurationProperties>;
    /**
