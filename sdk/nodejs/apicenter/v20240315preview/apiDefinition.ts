...
export class ApiDefinition extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly specification!: pulumi.Output<outputs.apicenter.v20240315preview.ApiDefinitionPropertiesSpecificationResponse>;
    /**
    ...
    constructor(name: string, args: ApiDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter/v20240301:ApiDefinition" }, { type: "azure-native:apicenter/v20240601preview:ApiDefinition" }, { type: "azure-native:apicenter:ApiDefinition" }] };
