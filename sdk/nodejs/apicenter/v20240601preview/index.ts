...
// Export enums:
export * from "../../types/enums/apicenter/v20240601preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:apicenter/v20240601preview:Api":
                return new Api(name, <any>undefined, { urn })
            case "azure-native:apicenter/v20240601preview:ApiDefinition":
                return new ApiDefinition(name, <any>undefined, { urn })
            case "azure-native:apicenter/v20240601preview:ApiSource":
                return new ApiSource(name, <any>undefined, { urn })
            case "azure-native:apicenter/v20240601preview:ApiVersion":
                return new ApiVersion(name, <any>undefined, { urn })
            case "azure-native:apicenter/v20240601preview:Deployment":
                return new Deployment(name, <any>undefined, { urn })
            case "azure-native:apicenter/v20240601preview:Environment":
                return new Environment(name, <any>undefined, { urn })
            case "azure-native:apicenter/v20240601preview:MetadataSchema":
                return new MetadataSchema(name, <any>undefined, { urn })
            case "azure-native:apicenter/v20240601preview:Service":
                return new Service(name, <any>undefined, { urn })
            case "azure-native:apicenter/v20240601preview:Workspace":
...
pulumi.runtime.registerResourceModule("azure-native", "apicenter/v20240601preview", _module)
