...
export class ApiSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apicenter/v20240601preview:ApiSource';
     ...
     */
    public readonly azureApiManagementSource!: pulumi.Output<outputs.apicenter.v20240601preview.AzureApiManagementSourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly linkState!: pulumi.Output<outputs.apicenter.v20240601preview.LinkStateResponse>;
    /**
    ...
    constructor(name: string, args: ApiSourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter:ApiSource" }] };
...
export interface ApiSourceArgs {
     ...
     * API source configuration for Azure API Management.
     */
    azureApiManagementSource?: pulumi.Input<inputs.apicenter.v20240601preview.AzureApiManagementSourceArgs>;
    /**
     * Indicates if the specification should be imported along with metadata.
     */
    importSpecification?: pulumi.Input<string | enums.apicenter.v20240601preview.ImportSpecificationOptions>;
    /**
     ...
     * The target lifecycle stage.
     */
    targetLifecycleStage?: pulumi.Input<string | enums.apicenter.v20240601preview.LifecycleStage>;
    /**
