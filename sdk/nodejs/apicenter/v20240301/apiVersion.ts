...
export class ApiVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter:ApiVersion" }, { type: "azure-native:apicenter/v20240315preview:ApiVersion" }, { type: "azure-native:apicenter/v20240601preview:ApiVersion" }] };
