...
export class Environment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter:Environment" }, { type: "azure-native:apicenter/v20240315preview:Environment" }, { type: "azure-native:apicenter/v20240601preview:Environment" }] };
