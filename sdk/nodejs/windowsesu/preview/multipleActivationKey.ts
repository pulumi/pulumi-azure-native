...
export class MultipleActivationKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:windowsesu/preview:MultipleActivationKey';
    ...
    constructor(name: string, args: MultipleActivationKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:windowsesu/v20190916preview:MultipleActivationKey" }] };
