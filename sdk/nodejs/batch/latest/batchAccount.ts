...
export interface BatchAccountArgs {
     ...
     */
    readonly poolAllocationMode?: pulumi.Input<enums.batch.latest.PoolAllocationMode>;
    /**
     * If not specified, the default value is 'enabled'.
     */
    readonly publicNetworkAccess?: pulumi.Input<enums.batch.latest.PublicNetworkAccessType>;
    /**
