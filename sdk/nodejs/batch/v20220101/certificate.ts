...
export class Certificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Certificate {
        pulumi.log.warn("Certificate is deprecated: azure-native:batch/v20220101:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20220601:Certificate to guarantee forwards compatibility.")
        return new Certificate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20220101:Certificate';
     ...
     */
    public /*out*/ readonly deleteCertificateError!: pulumi.Output<outputs.batch.v20220101.DeleteCertificateErrorResponse>;
    /**
