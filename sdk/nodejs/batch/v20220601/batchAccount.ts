 ...
 *
 * @deprecated azure-native:batch/v20220601:BatchAccount is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:BatchAccount to guarantee forwards compatibility.
 */
export class BatchAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BatchAccount {
        pulumi.log.warn("BatchAccount is deprecated: azure-native:batch/v20220601:BatchAccount is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:BatchAccount to guarantee forwards compatibility.")
        return new BatchAccount(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20220601:BatchAccount';
     ...
     */
    public readonly autoStorage!: pulumi.Output<outputs.batch.v20220601.AutoStoragePropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly dedicatedCoreQuotaPerVMFamily!: pulumi.Output<outputs.batch.v20220601.VirtualMachineFamilyCoreQuotaResponse[]>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.batch.v20220601.EncryptionPropertiesResponse>;
    /**
     * The identity of the Batch account.
     */
    public readonly identity!: pulumi.Output<outputs.batch.v20220601.BatchAccountIdentityResponse | undefined>;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    public readonly keyVaultReference!: pulumi.Output<outputs.batch.v20220601.KeyVaultReferenceResponse>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.batch.v20220601.NetworkProfileResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.batch.v20220601.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: BatchAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["autoStorage"] = args ? (args.autoStorage ? pulumi.output(args.autoStorage).apply(inputs.batch.v20220601.autoStorageBasePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface BatchAccountArgs {
     ...
     * List of allowed authentication modes for the Batch account that can be used to authenticate with the data plane. This does not affect authentication with the control plane.
     */
    allowedAuthenticationModes?: pulumi.Input<pulumi.Input<enums.batch.v20220601.AuthenticationMode>[]>;
    /**
     * The properties related to the auto-storage account.
     */
    autoStorage?: pulumi.Input<inputs.batch.v20220601.AutoStorageBasePropertiesArgs>;
    /**
     * Configures how customer data is encrypted inside the Batch account. By default, accounts are encrypted using a Microsoft managed key. For additional control, a customer-managed key can be used instead.
     */
    encryption?: pulumi.Input<inputs.batch.v20220601.EncryptionPropertiesArgs>;
    /**
     * The identity of the Batch account.
     */
    identity?: pulumi.Input<inputs.batch.v20220601.BatchAccountIdentityArgs>;
    /**
     * A reference to the Azure key vault associated with the Batch account.
     */
    keyVaultReference?: pulumi.Input<inputs.batch.v20220601.KeyVaultReferenceArgs>;
    /**
     ...
     * The network profile only takes effect when publicNetworkAccess is enabled.
     */
    networkProfile?: pulumi.Input<inputs.batch.v20220601.NetworkProfileArgs>;
    /**
     * The pool allocation mode also affects how clients may authenticate to the Batch Service API. If the mode is BatchService, clients may authenticate using access keys or Azure Active Directory. If the mode is UserSubscription, clients must use Azure Active Directory. The default is BatchService.
     */
    poolAllocationMode?: pulumi.Input<enums.batch.v20220601.PoolAllocationMode>;
    /**
     * If not specified, the default value is 'enabled'.
     */
    publicNetworkAccess?: pulumi.Input<enums.batch.v20220601.PublicNetworkAccessType>;
    /**
