...
export function getBatchAccount(args: GetBatchAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchAccountResult> {
    pulumi.log.warn("getBatchAccount is deprecated: azure-native:batch/v20220601:BatchAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20221001:BatchAccount to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:batch/v20220601:getBatchAccount", {
...
export interface GetBatchAccountResult {
     ...
     */
    readonly autoStorage: outputs.batch.v20220601.AutoStoragePropertiesResponse;
    /**
     ...
     */
    readonly dedicatedCoreQuotaPerVMFamily: outputs.batch.v20220601.VirtualMachineFamilyCoreQuotaResponse[];
    /**
     ...
     */
    readonly encryption: outputs.batch.v20220601.EncryptionPropertiesResponse;
    /**
     ...
     */
    readonly identity?: outputs.batch.v20220601.BatchAccountIdentityResponse;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    readonly keyVaultReference: outputs.batch.v20220601.KeyVaultReferenceResponse;
    /**
     ...
     */
    readonly networkProfile?: outputs.batch.v20220601.NetworkProfileResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.batch.v20220601.PrivateEndpointConnectionResponse[];
    /**
