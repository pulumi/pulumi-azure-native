...
export class ApplicationPackage extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationPackage {
        pulumi.log.warn("ApplicationPackage is deprecated: Version 2020-05-01 will be removed in v2 of the provider.\nazure-native:batch/v20200501:ApplicationPackage is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20221001:ApplicationPackage to guarantee forwards compatibility.")
        return new ApplicationPackage(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20200501:ApplicationPackage';
