...
azure-native:batch/v20200501:BatchAccount is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20220101:BatchAccount to guarantee forwards compatibility. */
export function getBatchAccount(args: GetBatchAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchAccountResult> {
    pulumi.log.warn("getBatchAccount is deprecated: Version 2020-05-01 will be removed in v2 of the provider.\nazure-native:batch/v20200501:BatchAccount is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20220101:BatchAccount to guarantee forwards compatibility.")
