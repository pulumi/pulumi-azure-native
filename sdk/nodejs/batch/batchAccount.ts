...
export class BatchAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:batch:BatchAccount';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.batch.BatchAccountPropertiesResponse>;
    /**
...
export interface BatchAccountState {
     ...
     * The identity of the Batch account.
     */
    readonly identity?: pulumi.Input<inputs.batch.BatchAccountIdentityResponse>;
    /**
     * The location of the resource.
     */
     ...
     * The properties associated with the account.
     */
    readonly properties: pulumi.Input<inputs.batch.BatchAccountPropertiesResponse>;
    /**
     * The tags of the resource.
     */
...
export interface BatchAccountArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.batch.BatchAccountCreateProperties>;
    /**
