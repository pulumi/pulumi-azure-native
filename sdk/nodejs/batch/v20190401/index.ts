...
// Export enums:
export * from "../../types/enums/batch/v20190401";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:batch/v20190401:Application":
                return new Application(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20190401:ApplicationPackage":
                return new ApplicationPackage(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20190401:BatchAccount":
                return new BatchAccount(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20190401:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20190401:Pool":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "batch/v20190401", _module)
