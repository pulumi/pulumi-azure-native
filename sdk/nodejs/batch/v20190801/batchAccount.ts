...
export class BatchAccount extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.batch.v20190801.BatchAccountPropertiesResponse>;
    /**
...
export interface BatchAccountArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.batch.v20190801.BatchAccountCreateProperties>;
    /**
