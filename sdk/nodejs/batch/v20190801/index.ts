...
// Export enums:
export * from "../../types/enums/batch/v20190801";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:batch/v20190801:Application":
                return new Application(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20190801:ApplicationPackage":
                return new ApplicationPackage(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20190801:BatchAccount":
                return new BatchAccount(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20190801:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20190801:Pool":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "batch/v20190801", _module)
