...
azure-native:batch/v20190801:ApplicationPackage is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:ApplicationPackage to guarantee forwards compatibility. */
export function getApplicationPackage(args: GetApplicationPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationPackageResult> {
    pulumi.log.warn("getApplicationPackage is deprecated: Version 2019-08-01 will be removed in v2 of the provider.\nazure-native:batch/v20190801:ApplicationPackage is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:ApplicationPackage to guarantee forwards compatibility.")
