...
export class ApplicationPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:batch/v20190801:ApplicationPackage';
    ...
    constructor(name: string, argsOrState?: ApplicationPackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batch/v20181201:ApplicationPackage" }, { type: "azurerm:batch/v20190401:ApplicationPackage" }, { type: "azurerm:batch/v20200301:ApplicationPackage" }, { type: "azurerm:batch/v20200501:ApplicationPackage" }] };
