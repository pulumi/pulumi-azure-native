...
export class BatchAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20240701:BatchAccount';
     ...
     */
    public readonly autoStorage!: pulumi.Output<outputs.batch.v20240701.AutoStoragePropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly dedicatedCoreQuotaPerVMFamily!: pulumi.Output<outputs.batch.v20240701.VirtualMachineFamilyCoreQuotaResponse[]>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.batch.v20240701.EncryptionPropertiesResponse>;
    /**
     * The identity of the Batch account.
     */
    public readonly identity!: pulumi.Output<outputs.batch.v20240701.BatchAccountIdentityResponse | undefined>;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    public readonly keyVaultReference!: pulumi.Output<outputs.batch.v20240701.KeyVaultReferenceResponse>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.batch.v20240701.NetworkProfileResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.batch.v20240701.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: BatchAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["autoStorage"] = args ? (args.autoStorage ? pulumi.output(args.autoStorage).apply(inputs.batch.v20240701.autoStorageBasePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface BatchAccountArgs {
     ...
     * List of allowed authentication modes for the Batch account that can be used to authenticate with the data plane. This does not affect authentication with the control plane.
     */
    allowedAuthenticationModes?: pulumi.Input<pulumi.Input<enums.batch.v20240701.AuthenticationMode>[]>;
    /**
     * The properties related to the auto-storage account.
     */
    autoStorage?: pulumi.Input<inputs.batch.v20240701.AutoStorageBasePropertiesArgs>;
    /**
     * Configures how customer data is encrypted inside the Batch account. By default, accounts are encrypted using a Microsoft managed key. For additional control, a customer-managed key can be used instead.
     */
    encryption?: pulumi.Input<inputs.batch.v20240701.EncryptionPropertiesArgs>;
    /**
     * The identity of the Batch account.
     */
    identity?: pulumi.Input<inputs.batch.v20240701.BatchAccountIdentityArgs>;
    /**
     * A reference to the Azure key vault associated with the Batch account.
     */
    keyVaultReference?: pulumi.Input<inputs.batch.v20240701.KeyVaultReferenceArgs>;
    /**
     ...
     * The network profile only takes effect when publicNetworkAccess is enabled.
     */
    networkProfile?: pulumi.Input<inputs.batch.v20240701.NetworkProfileArgs>;
    /**
     ...
     */
    poolAllocationMode?: pulumi.Input<enums.batch.v20240701.PoolAllocationMode>;
    /**
     * If not specified, the default value is 'enabled'.
     */
    publicNetworkAccess?: pulumi.Input<enums.batch.v20240701.PublicNetworkAccessType>;
    /**
