...
export class ApplicationPackage extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApplicationPackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batch/v20170101:ApplicationPackage" }, { type: "azurerm:batch/v20170501:ApplicationPackage" }, { type: "azurerm:batch/v20170901:ApplicationPackage" }] };
