...
export class BatchAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20200301:BatchAccount';
     ...
     */
    public readonly autoStorage!: pulumi.Output<outputs.batch.v20200301.AutoStoragePropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly dedicatedCoreQuotaPerVMFamily!: pulumi.Output<outputs.batch.v20200301.VirtualMachineFamilyCoreQuotaResponse[]>;
    /**
    ...
    public readonly encryption!: pulumi.Output<outputs.batch.v20200301.EncryptionPropertiesResponse>;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    public readonly keyVaultReference!: pulumi.Output<outputs.batch.v20200301.KeyVaultReferenceResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.batch.v20200301.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: BatchAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:batch:BatchAccount" }, { type: "azure-nextgen:batch:BatchAccount" }, { type: "azure-native:batch/latest:BatchAccount" }, { type: "azure-nextgen:batch/latest:BatchAccount" }, { type: "azure-native:batch/v20151201:BatchAccount" }, { type: "azure-nextgen:batch/v20151201:BatchAccount" }, { type: "azure-native:batch/v20170101:BatchAccount" }, { type: "azure-nextgen:batch/v20170101:BatchAccount" }, { type: "azure-native:batch/v20170501:BatchAccount" }, { type: "azure-nextgen:batch/v20170501:BatchAccount" }, { type: "azure-native:batch/v20170901:BatchAccount" }, { type: "azure-nextgen:batch/v20170901:BatchAccount" }, { type: "azure-native:batch/v20181201:BatchAccount" }, { type: "azure-nextgen:batch/v20181201:BatchAccount" }, { type: "azure-native:batch/v20190401:BatchAccount" }, { type: "azure-nextgen:batch/v20190401:BatchAccount" }, { type: "azure-native:batch/v20190801:BatchAccount" }, { type: "azure-nextgen:batch/v20190801:BatchAccount" }, { type: "azure-native:batch/v20200501:BatchAccount" }, { type: "azure-nextgen:batch/v20200501:BatchAccount" }, { type: "azure-native:batch/v20200901:BatchAccount" }, { type: "azure-nextgen:batch/v20200901:BatchAccount" }, { type: "azure-native:batch/v20210101:BatchAccount" }, { type: "azure-nextgen:batch/v20210101:BatchAccount" }] };
