...
export class BatchAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: BatchAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batch/v20151201:BatchAccount" }, { type: "azurerm:batch/v20170101:BatchAccount" }, { type: "azurerm:batch/v20170501:BatchAccount" }, { type: "azurerm:batch/v20181201:BatchAccount" }, { type: "azurerm:batch/v20190401:BatchAccount" }, { type: "azurerm:batch/v20190801:BatchAccount" }, { type: "azurerm:batch/v20200301:BatchAccount" }, { type: "azurerm:batch/v20200501:BatchAccount" }] };
