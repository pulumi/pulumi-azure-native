...
export function getBatchAccount(args: GetBatchAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:batch/v20170901:getBatchAccount", {
...
export interface GetBatchAccountResult {
     ...
     */
    readonly autoStorage: outputs.batch.v20170901.AutoStoragePropertiesInvokeResponse;
     ...
     */
    readonly keyVaultReference: outputs.batch.v20170901.KeyVaultReferenceInvokeResponse;
    /**
