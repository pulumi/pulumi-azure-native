...
export class BatchAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:batch/preview:BatchAccount';
     ...
     */
    public readonly autoStorage!: pulumi.Output<outputs.batch.preview.AutoStoragePropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly dedicatedCoreQuotaPerVMFamily!: pulumi.Output<outputs.batch.preview.VirtualMachineFamilyCoreQuotaResponse[]>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<outputs.batch.preview.EncryptionPropertiesResponse>;
    /**
     * The identity of the Batch account.
     */
    public readonly identity!: pulumi.Output<outputs.batch.preview.BatchAccountIdentityResponse | undefined>;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    public readonly keyVaultReference!: pulumi.Output<outputs.batch.preview.KeyVaultReferenceResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.batch.preview.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: BatchAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batch/latest:BatchAccount" }, { type: "azurerm:batch/v20151201:BatchAccount" }, { type: "azurerm:batch/v20170101:BatchAccount" }, { type: "azurerm:batch/v20170501:BatchAccount" }, { type: "azurerm:batch/v20170901:BatchAccount" }, { type: "azurerm:batch/v20181201:BatchAccount" }, { type: "azurerm:batch/v20190401:BatchAccount" }, { type: "azurerm:batch/v20190801:BatchAccount" }, { type: "azurerm:batch/v20200301:BatchAccount" }, { type: "azurerm:batch/v20200501:BatchAccount" }] };
...
export interface BatchAccountArgs {
     ...
     */
    readonly autoStorage?: pulumi.Input<inputs.batch.preview.AutoStorageBaseProperties>;
    /**
     * Configures how customer data is encrypted inside the Batch account. By default, accounts are encrypted using a Microsoft managed key. For additional control, a customer-managed key can be used instead.
     */
    readonly encryption?: pulumi.Input<inputs.batch.preview.EncryptionProperties>;
    /**
     * The identity of the Batch account.
     */
    readonly identity?: pulumi.Input<inputs.batch.preview.BatchAccountIdentity>;
    /**
     * A reference to the Azure key vault associated with the Batch account.
     */
    readonly keyVaultReference?: pulumi.Input<inputs.batch.preview.KeyVaultReference>;
    /**
