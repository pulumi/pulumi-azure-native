...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:batch/preview:Pool';
     ...
     */
    public readonly applicationPackages!: pulumi.Output<outputs.batch.preview.ApplicationPackageReferenceResponse[] | undefined>;
    /**
     * This property is set only if the pool automatically scales, i.e. autoScaleSettings are used.
     */
    public /*out*/ readonly autoScaleRun!: pulumi.Output<outputs.batch.preview.AutoScaleRunResponse>;
    /**
     * For Windows compute nodes, the Batch service installs the certificates to the specified certificate store and location. For Linux compute nodes, the certificates are stored in a directory inside the task working directory and an environment variable AZ_BATCH_CERTIFICATES_DIR is supplied to the task to query for this location. For certificates with visibility of 'remoteUser', a 'certs' directory is created in the user's home directory (e.g., /home/{user-name}/certs) and certificates are placed in that directory.
     */
    public readonly certificates!: pulumi.Output<outputs.batch.preview.CertificateReferenceResponse[] | undefined>;
     ...
     */
    public readonly deploymentConfiguration!: pulumi.Output<outputs.batch.preview.DeploymentConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.batch.preview.MetadataItemResponse[] | undefined>;
    /**
     * This supports Azure Files, NFS, CIFS/SMB, and Blobfuse.
     */
    public readonly mountConfiguration!: pulumi.Output<outputs.batch.preview.MountConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public readonly networkConfiguration!: pulumi.Output<outputs.batch.preview.NetworkConfigurationResponse | undefined>;
    public /*out*/ readonly provisioningState!: pulumi.Output<string>;
    public /*out*/ readonly provisioningStateTransitionTime!: pulumi.Output<string>;
    /**
     * Describes either the current operation (if the pool AllocationState is Resizing) or the previously completed operation (if the AllocationState is Steady).
     */
    public /*out*/ readonly resizeOperationStatus!: pulumi.Output<outputs.batch.preview.ResizeOperationStatusResponse>;
    /**
     * Defines the desired size of the pool. This can either be 'fixedScale' where the requested targetDedicatedNodes is specified, or 'autoScale' which defines a formula which is periodically reevaluated. If this property is not specified, the pool will have a fixed scale with 0 targetDedicatedNodes.
     */
    public readonly scaleSettings!: pulumi.Output<outputs.batch.preview.ScaleSettingsResponse | undefined>;
    /**
     * In an PATCH (update) operation, this property can be set to an empty object to remove the start task from the pool.
     */
    public readonly startTask!: pulumi.Output<outputs.batch.preview.StartTaskResponse | undefined>;
    /**
     * If not specified, the default is spread.
     */
    public readonly taskSchedulingPolicy!: pulumi.Output<outputs.batch.preview.TaskSchedulingPolicyResponse | undefined>;
    /**
     * The type of the resource.
     */
    public /*out*/ readonly type!: pulumi.Output<string>;
    public readonly userAccounts!: pulumi.Output<outputs.batch.preview.UserAccountResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: PoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:batch/latest:Pool" }, { type: "azurerm:batch/v20170901:Pool" }, { type: "azurerm:batch/v20181201:Pool" }, { type: "azurerm:batch/v20190401:Pool" }, { type: "azurerm:batch/v20190801:Pool" }, { type: "azurerm:batch/v20200301:Pool" }, { type: "azurerm:batch/v20200501:Pool" }] };
...
export interface PoolArgs {
     ...
     * Changes to application package references affect all new compute nodes joining the pool, but do not affect compute nodes that are already in the pool until they are rebooted or reimaged. There is a maximum of 10 application package references on any given pool.
     */
    readonly applicationPackages?: pulumi.Input<pulumi.Input<inputs.batch.preview.ApplicationPackageReference>[]>;
    /**
     * For Windows compute nodes, the Batch service installs the certificates to the specified certificate store and location. For Linux compute nodes, the certificates are stored in a directory inside the task working directory and an environment variable AZ_BATCH_CERTIFICATES_DIR is supplied to the task to query for this location. For certificates with visibility of 'remoteUser', a 'certs' directory is created in the user's home directory (e.g., /home/{user-name}/certs) and certificates are placed in that directory.
     */
    readonly certificates?: pulumi.Input<pulumi.Input<inputs.batch.preview.CertificateReference>[]>;
    /**
     * Using CloudServiceConfiguration specifies that the nodes should be creating using Azure Cloud Services (PaaS), while VirtualMachineConfiguration uses Azure Virtual Machines (IaaS).
     */
    readonly deploymentConfiguration?: pulumi.Input<inputs.batch.preview.DeploymentConfiguration>;
    /**
     * The display name need not be unique and can contain any Unicode characters up to a maximum length of 1024.
     */
     ...
     * The Batch service does not assign any meaning to metadata; it is solely for the use of user code.
     */
    readonly metadata?: pulumi.Input<pulumi.Input<inputs.batch.preview.MetadataItem>[]>;
    /**
     * This supports Azure Files, NFS, CIFS/SMB, and Blobfuse.
     */
    readonly mountConfiguration?: pulumi.Input<pulumi.Input<inputs.batch.preview.MountConfiguration>[]>;
    /**
     * The network configuration for a pool.
     */
    readonly networkConfiguration?: pulumi.Input<inputs.batch.preview.NetworkConfiguration>;
    /**
     ...
     * Defines the desired size of the pool. This can either be 'fixedScale' where the requested targetDedicatedNodes is specified, or 'autoScale' which defines a formula which is periodically reevaluated. If this property is not specified, the pool will have a fixed scale with 0 targetDedicatedNodes.
     */
    readonly scaleSettings?: pulumi.Input<inputs.batch.preview.ScaleSettings>;
    /**
     * In an PATCH (update) operation, this property can be set to an empty object to remove the start task from the pool.
     */
    readonly startTask?: pulumi.Input<inputs.batch.preview.StartTask>;
    /**
     * If not specified, the default is spread.
     */
    readonly taskSchedulingPolicy?: pulumi.Input<inputs.batch.preview.TaskSchedulingPolicy>;
    readonly userAccounts?: pulumi.Input<pulumi.Input<inputs.batch.preview.UserAccount>[]>;
    /**
     * For information about available sizes of virtual machines for Cloud Services pools (pools created with cloudServiceConfiguration), see Sizes for Cloud Services (https://azure.microsoft.com/documentation/articles/cloud-services-sizes-specs/). Batch supports all Cloud Services VM sizes except ExtraSmall. For information about available VM sizes for pools using images from the Virtual Machines Marketplace (pools created with virtualMachineConfiguration) see Sizes for Virtual Machines (Linux) (https://azure.microsoft.com/documentation/articles/virtual-machines-linux-sizes/) or Sizes for Virtual Machines (Windows) (https://azure.microsoft.com/documentation/articles/virtual-machines-windows-sizes/). Batch supports all Azure VM sizes except STANDARD_A0 and those with premium storage (STANDARD_GS, STANDARD_DS, and STANDARD_DSV2 series).
     */
