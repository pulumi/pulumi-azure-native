...
// Export enums:
export * from "../../types/enums/batch/v20210101";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:batch/v20210101:Application":
                return new Application(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20210101:ApplicationPackage":
                return new ApplicationPackage(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20210101:BatchAccount":
                return new BatchAccount(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20210101:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-nextgen:batch/v20210101:Pool":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "batch/v20210101", _module)
