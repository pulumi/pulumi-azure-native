 ...
 *
 * const applicationPackage = new azure_native.batch.v20210101.ApplicationPackage("applicationPackage", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:batch/v20210101:ApplicationPackage 1 /subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Batch/batchAccounts/sampleacct/applications/app1/versions/1 
 * ```
 */
export class ApplicationPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20210101:ApplicationPackage';
