...
export class ConfigurationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:changeanalysis/preview:ConfigurationProfile';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.changeanalysis.preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.changeanalysis.preview.ConfigurationProfileResourcePropertiesResponse>;
    /**
     * Top level metadata https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/common-api-contracts.md#system-metadata-for-all-azure-resources
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.changeanalysis.preview.SystemDataResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ConfigurationProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:changeanalysis/v20200401preview:ConfigurationProfile" }] };
...
export interface ConfigurationProfileArgs {
     ...
     * The identity block returned by ARM resource that supports managed identity.
     */
    readonly identity?: pulumi.Input<inputs.changeanalysis.preview.ResourceIdentity>;
    /**
     ...
     * The properties of a configuration profile.
     */
    readonly properties?: pulumi.Input<inputs.changeanalysis.preview.ConfigurationProfileResourceProperties>;
}
