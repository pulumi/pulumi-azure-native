...
export class ObjectAnchorsAccount extends pulumi.CustomResource {
    ...
    public readonly identity!: pulumi.Output<outputs.mixedreality.v20210301preview.ObjectAnchorsAccountResponseIdentity | undefined>;
    /**
    ...
    constructor(name: string, args: ObjectAnchorsAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:mixedreality/v20210301preview:ObjectAnchorsAccount" }, { type: "azure-native:mixedreality:ObjectAnchorsAccount" }, { type: "azure-nextgen:mixedreality:ObjectAnchorsAccount" }] };
...
export interface ObjectAnchorsAccountArgs {
    ...
    readonly identity?: pulumi.Input<inputs.mixedreality.v20210301preview.ObjectAnchorsAccountIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
