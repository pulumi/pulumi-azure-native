...
export class ObjectAnchorsAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:mixedreality/v20210301preview:ObjectAnchorsAccount';
    ...
    constructor(name: string, args: ObjectAnchorsAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:mixedreality:ObjectAnchorsAccount" }] };
