...
export class SpatialAnchorsAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SpatialAnchorsAccount {
        return new SpatialAnchorsAccount(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:mixedreality:SpatialAnchorsAccount';
     ...
     * Property bag.
     */
    public readonly properties!: pulumi.Output<outputs.mixedreality.MixedRealityAccountPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: SpatialAnchorsAccountArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SpatialAnchorsAccountArgs {
     ...
     * Property bag.
     */
    readonly properties?: pulumi.Input<inputs.mixedreality.MixedRealityAccountProperties>;
    /**
