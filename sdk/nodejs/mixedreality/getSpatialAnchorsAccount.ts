...
export function getSpatialAnchorsAccount(args: GetSpatialAnchorsAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetSpatialAnchorsAccountResult> {
    ...
    return pulumi.runtime.invoke("azurerm:mixedreality:getSpatialAnchorsAccount", {
        "name": args.name,
...
export interface GetSpatialAnchorsAccountResult {
     ...
     * Property bag.
     */
    readonly properties: outputs.mixedreality.MixedRealityAccountPropertiesResponse;
    /**
     * Resource tags.
     */
