...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:mixedreality/v20210101:RemoteRenderingAccount":
                return new RemoteRenderingAccount(name, <any>undefined, { urn })
            case "azure-nextgen:mixedreality/v20210101:SpatialAnchorsAccount":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "mixedreality/v20210101", _module)
