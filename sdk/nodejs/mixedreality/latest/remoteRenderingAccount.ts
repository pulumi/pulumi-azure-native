...
export class RemoteRenderingAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mixedreality/latest:RemoteRenderingAccount';
