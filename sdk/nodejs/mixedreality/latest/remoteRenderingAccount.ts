...
export class RemoteRenderingAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:mixedreality/latest:RemoteRenderingAccount';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.mixedreality.latest.IdentityResponse | undefined>;
    /**
     * The kind of account, if supported
     */
    public readonly kind!: pulumi.Output<outputs.mixedreality.latest.SkuResponse | undefined>;
    /**
     ...
     */
    public readonly plan!: pulumi.Output<outputs.mixedreality.latest.IdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: RemoteRenderingAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:mixedreality:RemoteRenderingAccount" }, { type: "azure-nextgen:mixedreality/v20191202preview:RemoteRenderingAccount" }, { type: "azure-nextgen:mixedreality/v20200406preview:RemoteRenderingAccount" }, { type: "azure-nextgen:mixedreality/v20210101:RemoteRenderingAccount" }, { type: "azure-nextgen:mixedreality/v20210301preview:RemoteRenderingAccount" }] };
...
export interface RemoteRenderingAccountArgs {
     ...
     * The identity associated with this account
     */
    readonly identity?: pulumi.Input<inputs.mixedreality.latest.Identity>;
    /**
     * The kind of account, if supported
     */
    readonly kind?: pulumi.Input<inputs.mixedreality.latest.Sku>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The plan associated with this account
     */
    readonly plan?: pulumi.Input<inputs.mixedreality.latest.Identity>;
    /**
