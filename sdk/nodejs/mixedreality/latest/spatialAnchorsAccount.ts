...
export class SpatialAnchorsAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mixedreality/latest:SpatialAnchorsAccount';
