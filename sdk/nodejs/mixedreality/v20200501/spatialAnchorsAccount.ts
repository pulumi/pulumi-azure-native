...
export class SpatialAnchorsAccount extends pulumi.CustomResource {
     ...
     */
    public readonly kind!: pulumi.Output<outputs.mixedreality.v20200501.SkuResponse | undefined>;
    /**
     ...
     */
    public readonly plan!: pulumi.Output<outputs.mixedreality.v20200501.IdentityResponse | undefined>;
    /**
     * The sku associated with this account
     */
    public readonly sku!: pulumi.Output<outputs.mixedreality.v20200501.SkuResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.mixedreality.v20200501.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: SpatialAnchorsAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:mixedreality:SpatialAnchorsAccount" }, { type: "azure-nextgen:mixedreality/latest:SpatialAnchorsAccount" }, { type: "azure-nextgen:mixedreality/v20190228preview:SpatialAnchorsAccount" }, { type: "azure-nextgen:mixedreality/v20191202preview:SpatialAnchorsAccount" }, { type: "azure-nextgen:mixedreality/v20210101:SpatialAnchorsAccount" }, { type: "azure-nextgen:mixedreality/v20210301preview:SpatialAnchorsAccount" }] };
...
export interface SpatialAnchorsAccountArgs {
     ...
     * The kind of account, if supported
     */
    readonly kind?: pulumi.Input<inputs.mixedreality.v20200501.Sku>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The plan associated with this account
     */
    readonly plan?: pulumi.Input<inputs.mixedreality.v20200501.Identity>;
    /**
     ...
     * The sku associated with this account
     */
    readonly sku?: pulumi.Input<inputs.mixedreality.v20200501.Sku>;
    /**
     * The name of the storage account associated with this accountId
     */
