...
export function getRemoteRenderingAccount(args: GetRemoteRenderingAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteRenderingAccountResult> {
    pulumi.log.warn("getRemoteRenderingAccount is deprecated: Version 2020-04-06-preview will be removed in v2 of the provider.\nazure-native:mixedreality/v20200406preview:RemoteRenderingAccount is being removed in the next major version of this provider. Please upgrade to azure-native:mixedreality/v20210301preview:RemoteRenderingAccount to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:mixedreality/v20200406preview:getRemoteRenderingAccount", {
