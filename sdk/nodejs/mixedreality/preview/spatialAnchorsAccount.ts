...
export class SpatialAnchorsAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:mixedreality/preview:SpatialAnchorsAccount';
    ...
    constructor(name: string, argsOrState?: SpatialAnchorsAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:mixedreality/latest:SpatialAnchorsAccount" }, { type: "azurerm:mixedreality/v20190228preview:SpatialAnchorsAccount" }, { type: "azurerm:mixedreality/v20191202preview:SpatialAnchorsAccount" }, { type: "azurerm:mixedreality/v20200501:SpatialAnchorsAccount" }] };
