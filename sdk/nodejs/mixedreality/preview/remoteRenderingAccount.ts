...
export class RemoteRenderingAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RemoteRenderingAccount {
        return new RemoteRenderingAccount(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:mixedreality/preview:RemoteRenderingAccount';
    ...
    public readonly identity!: pulumi.Output<outputs.mixedreality.preview.RemoteRenderingAccountResponseIdentity | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RemoteRenderingAccountArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as RemoteRenderingAccountArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:mixedreality/v20191202preview:RemoteRenderingAccount" }, { type: "azurerm:mixedreality/v20200406preview:RemoteRenderingAccount" }] };
...
export interface RemoteRenderingAccountArgs {
    ...
    readonly identity?: pulumi.Input<inputs.mixedreality.preview.RemoteRenderingAccountIdentity>;
    /**
     * The geo-location where the resource lives
     */
