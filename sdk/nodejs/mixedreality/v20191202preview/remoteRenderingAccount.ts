 ...
 *
 * const remoteRenderingAccount = new azurerm.mixedreality.v20191202preview.RemoteRenderingAccount("remoteRenderingAccount", {
...
export class RemoteRenderingAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:mixedreality/v20191202preview:RemoteRenderingAccount';
    ...
    constructor(name: string, args: RemoteRenderingAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:mixedreality/v20200406preview:RemoteRenderingAccount" }] };
