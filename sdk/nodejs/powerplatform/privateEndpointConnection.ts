...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:powerplatform/v20201030preview:PrivateEndpointConnection" }, { type: "azure-nextgen:powerplatform/v20201030preview:PrivateEndpointConnection" }] };
