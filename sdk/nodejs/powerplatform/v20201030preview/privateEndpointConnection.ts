...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:powerplatform/v20201030preview:PrivateEndpointConnection" }, { type: "azure-native:powerplatform:PrivateEndpointConnection" }, { type: "azure-nextgen:powerplatform:PrivateEndpointConnection" }] };
