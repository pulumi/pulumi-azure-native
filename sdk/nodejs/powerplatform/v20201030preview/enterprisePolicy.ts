 ...
 *
 * const enterprisePolicy = new azure_native.powerplatform.v20201030preview.EnterprisePolicy("enterprisePolicy", {
 *     enterprisePolicyName: "enterprisePolicy",
 *     identity: {
 *         type: azure_native.powerplatform.v20201030preview.ResourceIdentityType.SystemAssigned,
 *     },
 *     kind: "Lockbox",
 *     location: "East US",
...
export class EnterprisePolicy extends pulumi.CustomResource {
     ...
     */
    public readonly networkInjection!: pulumi.Output<outputs.powerplatform.v20201030preview.PropertiesResponseNetworkInjection | undefined>;
    /**
...
export interface EnterprisePolicyArgs {
     ...
     * The health status of the resource.
     */
    healthStatus?: pulumi.Input<string | enums.powerplatform.v20201030preview.HealthStatus>;
    /**
     * The identity of the EnterprisePolicy.
     */
