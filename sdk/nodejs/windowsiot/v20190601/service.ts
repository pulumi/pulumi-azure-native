...
export class Service extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:windowsiot:Service" }, { type: "azure-nextgen:windowsiot/latest:Service" }, { type: "azure-nextgen:windowsiot/v20180216preview:Service" }] };
