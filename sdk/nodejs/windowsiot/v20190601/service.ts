...
export class Service extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:windowsiot/latest:Service" }, { type: "azurerm:windowsiot/preview:Service" }, { type: "azurerm:windowsiot/v20180216preview:Service" }] };
