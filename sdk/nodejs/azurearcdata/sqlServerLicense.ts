...
export class SqlServerLicense extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.azurearcdata.SqlServerLicensePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqlServerLicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata/v20240501preview:SqlServerLicense" }, { type: "azure-native:azurearcdata/v20250301preview:SqlServerLicense" }, { type: "azure-native:azurearcdata/v20260101:SqlServerLicense" }, { type: "azure-native:azurearcdata/v20260301preview:SqlServerLicense" }] };
