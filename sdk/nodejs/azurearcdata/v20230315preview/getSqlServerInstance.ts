...
export function getSqlServerInstance(args: GetSqlServerInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlServerInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230315preview:getSqlServerInstance", {
...
export interface GetSqlServerInstanceResult {
     ...
     * null
     */
    readonly properties: outputs.azurearcdata.v20230315preview.SqlServerInstancePropertiesResponse;
    /**
