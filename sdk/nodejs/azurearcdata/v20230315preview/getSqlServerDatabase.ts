...
export function getSqlServerDatabase(args: GetSqlServerDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlServerDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230315preview:getSqlServerDatabase", {
...
export interface GetSqlServerDatabaseResult {
     ...
     */
    readonly properties: outputs.azurearcdata.v20230315preview.SqlServerDatabaseResourcePropertiesResponse;
    /**
