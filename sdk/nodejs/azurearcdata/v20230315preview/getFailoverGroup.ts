...
export function getFailoverGroup(args: GetFailoverGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFailoverGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230315preview:getFailoverGroup", {
...
export interface GetFailoverGroupResult {
     ...
     * null
     */
    readonly properties: outputs.azurearcdata.v20230315preview.FailoverGroupPropertiesResponse;
    /**
