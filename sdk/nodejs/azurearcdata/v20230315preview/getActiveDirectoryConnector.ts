...
export function getActiveDirectoryConnector(args: GetActiveDirectoryConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetActiveDirectoryConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230315preview:getActiveDirectoryConnector", {
...
export interface GetActiveDirectoryConnectorResult {
     ...
     * null
     */
    readonly properties: outputs.azurearcdata.v20230315preview.ActiveDirectoryConnectorPropertiesResponse;
    /**
