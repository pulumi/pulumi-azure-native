...
export function getDataController(args: GetDataControllerArgs, opts?: pulumi.InvokeOptions): Promise<GetDataControllerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230315preview:getDataController", {
...
export interface GetDataControllerResult {
     ...
     */
    readonly extendedLocation?: outputs.azurearcdata.v20230315preview.ExtendedLocationResponse;
    /**
     ...
     */
    readonly properties: outputs.azurearcdata.v20230315preview.DataControllerPropertiesResponse;
    /**
