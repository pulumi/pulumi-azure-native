 ...
 *
 * const sqlServerInstance = new azure_native.azurearcdata.v20230315preview.SqlServerInstance("sqlServerInstance", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:azurearcdata/v20230315preview:SqlServerInstance testsqlServerInstance /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureArcData/SqlServerInstances/testsqlServerInstance 
 * ```
 */
export class SqlServerInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20230315preview:SqlServerInstance';
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20230315preview.SqlServerInstancePropertiesResponse>;
    /**
...
export interface SqlServerInstanceArgs {
     ...
     * null
     */
    properties?: pulumi.Input<inputs.azurearcdata.v20230315preview.SqlServerInstancePropertiesArgs>;
    /**
