...
export function getPostgresInstance(args: GetPostgresInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetPostgresInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230315preview:getPostgresInstance", {
...
export interface GetPostgresInstanceResult {
     ...
     * null
     */
    readonly properties: outputs.azurearcdata.v20230315preview.PostgresInstancePropertiesResponse;
    /**
     * Resource sku.
     */
    readonly sku?: outputs.azurearcdata.v20230315preview.PostgresInstanceSkuResponse;
    /**
