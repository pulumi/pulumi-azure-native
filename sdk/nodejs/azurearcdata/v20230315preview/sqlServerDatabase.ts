 ...
 *
 * const sqlServerDatabase = new azure_native.azurearcdata.v20230315preview.SqlServerDatabase("sqlServerDatabase", {
 *     databaseName: "testdb",
...
export class SqlServerDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20230315preview:SqlServerDatabase';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20230315preview.SqlServerDatabaseResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqlServerDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata:SqlServerDatabase" }, { type: "azure-native:azurearcdata/v20220615preview:SqlServerDatabase" }, { type: "azure-native:azurearcdata/v20230115preview:SqlServerDatabase" }] };
...
export interface SqlServerDatabaseArgs {
     ...
     * Properties of Arc Sql Server database
     */
    properties: pulumi.Input<inputs.azurearcdata.v20230315preview.SqlServerDatabaseResourcePropertiesArgs>;
    /**
