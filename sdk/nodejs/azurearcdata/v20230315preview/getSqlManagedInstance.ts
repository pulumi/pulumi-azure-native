...
export function getSqlManagedInstance(args: GetSqlManagedInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlManagedInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230315preview:getSqlManagedInstance", {
...
export interface GetSqlManagedInstanceResult {
     ...
     * null
     */
    readonly properties: outputs.azurearcdata.v20230315preview.SqlManagedInstancePropertiesResponse;
    /**
     * Resource sku.
     */
    readonly sku?: outputs.azurearcdata.v20230315preview.SqlManagedInstanceSkuResponse;
    /**
