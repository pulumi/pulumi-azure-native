...
export function getSqlServerAvailabilityGroup(args: GetSqlServerAvailabilityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlServerAvailabilityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230315preview:getSqlServerAvailabilityGroup", {
...
export interface GetSqlServerAvailabilityGroupResult {
     ...
     */
    readonly properties: outputs.azurearcdata.v20230315preview.SqlServerAvailabilityGroupResourcePropertiesResponse;
    /**
