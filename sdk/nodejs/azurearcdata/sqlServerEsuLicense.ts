...
export class SqlServerEsuLicense extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<outputs.azurearcdata.SqlServerEsuLicensePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqlServerEsuLicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata/v20240501preview:SqlServerEsuLicense" }, { type: "azure-native:azurearcdata/v20250301preview:SqlServerEsuLicense" }, { type: "azure-native:azurearcdata/v20260101:SqlServerEsuLicense" }, { type: "azure-native:azurearcdata/v20260301preview:SqlServerEsuLicense" }] };
