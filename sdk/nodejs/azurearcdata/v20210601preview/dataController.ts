...
export class DataController extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataController {
        pulumi.log.warn("DataController is deprecated: azure-native:azurearcdata/v20210601preview:DataController is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:DataController to guarantee forwards compatibility.")
        return new DataController(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20210601preview:DataController';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20210601preview.DataControllerPropertiesResponse>;
    /**
...
export interface DataControllerArgs {
     ...
     * The data controller's properties
     */
    properties: pulumi.Input<inputs.azurearcdata.v20210601preview.DataControllerPropertiesArgs>;
    /**
