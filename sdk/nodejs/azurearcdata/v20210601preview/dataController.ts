...
export class DataController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azurearcdata/v20210601preview:DataController" }, { type: "azure-native:azurearcdata:DataController" }, { type: "azure-nextgen:azurearcdata:DataController" }] };
