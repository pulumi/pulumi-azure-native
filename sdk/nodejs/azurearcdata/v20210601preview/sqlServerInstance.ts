...
export class SqlServerInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlServerInstance {
        pulumi.log.warn("SqlServerInstance is deprecated: azure-native:azurearcdata/v20210601preview:SqlServerInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:SqlServerInstance to guarantee forwards compatibility.")
        return new SqlServerInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20210601preview:SqlServerInstance';
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20210601preview.SqlServerInstancePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqlServerInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata:SqlServerInstance" }, { type: "azure-native:azurearcdata/v20210701preview:SqlServerInstance" }, { type: "azure-native:azurearcdata/v20210801:SqlServerInstance" }, { type: "azure-native:azurearcdata/v20211101:SqlServerInstance" }, { type: "azure-native:azurearcdata/v20220301preview:SqlServerInstance" }, { type: "azure-native:azurearcdata/v20220615preview:SqlServerInstance" }] };
...
export interface SqlServerInstanceArgs {
     ...
     * null
     */
    properties?: pulumi.Input<inputs.azurearcdata.v20210601preview.SqlServerInstancePropertiesArgs>;
    /**
