...
export class PostgresInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20210601preview:PostgresInstance';
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20210601preview.PostgresInstancePropertiesResponse>;
    /**
     * Resource sku.
     */
    public readonly sku!: pulumi.Output<outputs.azurearcdata.v20210601preview.PostgresInstanceSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PostgresInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.azurearcdata.v20210601preview.postgresInstanceSkuArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata:PostgresInstance" }, { type: "azure-native:azurearcdata/v20210701preview:PostgresInstance" }, { type: "azure-native:azurearcdata/v20220301preview:PostgresInstance" }, { type: "azure-native:azurearcdata/v20220615preview:PostgresInstance" }] };
