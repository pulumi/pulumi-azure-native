...
export class SqlManagedInstance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azurearcdata/v20210601preview:SqlManagedInstance" }, { type: "azure-native:azurearcdata:SqlManagedInstance" }, { type: "azure-nextgen:azurearcdata:SqlManagedInstance" }] };
