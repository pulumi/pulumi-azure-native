...
export class SqlServerInstance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlServerInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azurearcdata:SqlServerInstance" }, { type: "azure-native:azurearcdata/v20210601preview:SqlServerInstance" }, { type: "azure-nextgen:azurearcdata/v20210601preview:SqlServerInstance" }, { type: "azure-native:azurearcdata/v20210701preview:SqlServerInstance" }, { type: "azure-nextgen:azurearcdata/v20210701preview:SqlServerInstance" }, { type: "azure-native:azurearcdata/v20210801:SqlServerInstance" }, { type: "azure-nextgen:azurearcdata/v20210801:SqlServerInstance" }] };
