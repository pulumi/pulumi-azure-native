...
export class PostgresInstance extends pulumi.CustomResource {
     ...
     * null
     */
    declare public readonly properties: pulumi.Output<outputs.azurearcdata.PostgresInstancePropertiesResponse>;
    /**
     * Resource sku.
     */
    declare public readonly sku: pulumi.Output<outputs.azurearcdata.PostgresInstanceSkuResponse | undefined>;
    /**
