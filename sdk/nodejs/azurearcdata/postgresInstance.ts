...
export class PostgresInstance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PostgresInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:azurearcdata:PostgresInstance" }, { type: "azure-native:azurearcdata/v20210601preview:PostgresInstance" }, { type: "azure-nextgen:azurearcdata/v20210601preview:PostgresInstance" }] };
