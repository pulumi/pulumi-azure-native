...
export function getActiveDirectoryConnector(args: GetActiveDirectoryConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetActiveDirectoryConnectorResult> {
    pulumi.log.warn("getActiveDirectoryConnector is deprecated: azure-native:azurearcdata/v20220615preview:ActiveDirectoryConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:ActiveDirectoryConnector to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20220615preview:getActiveDirectoryConnector", {
...
export interface GetActiveDirectoryConnectorResult {
     ...
     * null
     */
    readonly properties: outputs.azurearcdata.v20220615preview.ActiveDirectoryConnectorPropertiesResponse;
    /**
