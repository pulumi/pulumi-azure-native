...
export class SqlServerAvailabilityGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.SqlServerAvailabilityGroupResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqlServerAvailabilityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata/v20240101:SqlServerAvailabilityGroup" }, { type: "azure-native:azurearcdata/v20240501preview:SqlServerAvailabilityGroup" }, { type: "azure-native_azurearcdata_v20240101:azurearcdata:SqlServerAvailabilityGroup" }, { type: "azure-native_azurearcdata_v20240501preview:azurearcdata:SqlServerAvailabilityGroup" }, { type: "azure-native_azurearcdata_v20250301preview:azurearcdata:SqlServerAvailabilityGroup" }] };
