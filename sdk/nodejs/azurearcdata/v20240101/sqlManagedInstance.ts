...
export class SqlManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20240101:SqlManagedInstance';
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.azurearcdata.v20240101.ExtendedLocationResponse | undefined>;
    /**
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20240101.SqlManagedInstancePropertiesResponse>;
    /**
     * Resource sku.
     */
    public readonly sku!: pulumi.Output<outputs.azurearcdata.v20240101.SqlManagedInstanceSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SqlManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.azurearcdata.v20240101.sqlManagedInstancePropertiesArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["resourceGroupName"] = args ? args.resourceGroupName : undefined;
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.azurearcdata.v20240101.sqlManagedInstanceSkuArgsProvideDefaults) : undefined) : undefined;
...
export interface SqlManagedInstanceArgs {
     ...
     * The extendedLocation of the resource.
     */
    extendedLocation?: pulumi.Input<inputs.azurearcdata.v20240101.ExtendedLocationArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * null
     */
    properties: pulumi.Input<inputs.azurearcdata.v20240101.SqlManagedInstancePropertiesArgs>;
    /**
     ...
     * Resource sku.
     */
    sku?: pulumi.Input<inputs.azurearcdata.v20240101.SqlManagedInstanceSkuArgs>;
    /**
