 ...
 *
 * const dataController = new azure_native.azurearcdata.v20230115preview.DataController("dataController", {
 ...
 *         infrastructure: azure_native.azurearcdata.v20230115preview.Infrastructure.Onpremises,
 ...
 *
 * ```sh
 * $ pulumi import azure-native:azurearcdata/v20230115preview:DataController testdataController /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureArcData/dataControllers/testdataController 
 * ```
 */
export class DataController extends pulumi.CustomResource {
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.azurearcdata.v20230115preview.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20230115preview.DataControllerPropertiesResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.azurearcdata.v20230115preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: DataControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.azurearcdata.v20230115preview.dataControllerPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface DataControllerArgs {
     ...
     * The extendedLocation of the resource.
     */
    extendedLocation?: pulumi.Input<inputs.azurearcdata.v20230115preview.ExtendedLocationArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The data controller's properties
     */
    properties: pulumi.Input<inputs.azurearcdata.v20230115preview.DataControllerPropertiesArgs>;
    /**
