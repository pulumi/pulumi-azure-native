...
export class FailoverGroup extends pulumi.CustomResource {
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20230115preview.FailoverGroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata/v20240101:FailoverGroup" }, { type: "azure-native:azurearcdata/v20240501preview:FailoverGroup" }, { type: "azure-native:azurearcdata/v20250301preview:FailoverGroup" }, { type: "azure-native:azurearcdata:FailoverGroup" }] };
