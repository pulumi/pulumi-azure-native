 ...
 *
 * const failoverGroup = new azure_native.azurearcdata.v20230115preview.FailoverGroup("failoverGroup", {
...
export class FailoverGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata:FailoverGroup" }, { type: "azure-native:azurearcdata/v20230315preview:FailoverGroup" }] };
