...
export function getSqlManagedInstance(args: GetSqlManagedInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlManagedInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230115preview:getSqlManagedInstance", {
...
export interface GetSqlManagedInstanceResult {
     ...
     * null
     */
    readonly properties: outputs.azurearcdata.v20230115preview.SqlManagedInstancePropertiesResponse;
    /**
     * Resource sku.
     */
    readonly sku?: outputs.azurearcdata.v20230115preview.SqlManagedInstanceSkuResponse;
    /**
...
export function getSqlManagedInstanceOutput(args: GetSqlManagedInstanceOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSqlManagedInstanceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurearcdata/v20230115preview:getSqlManagedInstance", {
        "resourceGroupName": args.resourceGroupName,
        "sqlManagedInstanceName": args.sqlManagedInstanceName,
    }, opts);
}
