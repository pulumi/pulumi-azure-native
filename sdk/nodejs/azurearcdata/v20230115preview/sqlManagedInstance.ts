 ...
 *
 * const sqlManagedInstance = new azure_native.azurearcdata.v20230115preview.SqlManagedInstance("sqlManagedInstance", {
 *     extendedLocation: {
 ...
 *     sku: {
 *         dev: true,
 *         name: azure_native.azurearcdata.v20230115preview.SqlManagedInstanceSkuName.VCore,
 *         tier: azure_native.azurearcdata.v20230115preview.SqlManagedInstanceSkuTier.GeneralPurpose,
 *     },
...
export class SqlManagedInstance extends pulumi.CustomResource {
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20230115preview.SqlManagedInstancePropertiesResponse>;
    /**
     * Resource sku.
     */
    public readonly sku!: pulumi.Output<outputs.azurearcdata.v20230115preview.SqlManagedInstanceSkuResponse | undefined>;
    /**
