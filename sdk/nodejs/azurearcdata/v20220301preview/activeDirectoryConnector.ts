 ...
 *
 * const activeDirectoryConnector = new azure_native.azurearcdata.v20220301preview.ActiveDirectoryConnector("activeDirectoryConnector", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:azurearcdata/v20220301preview:ActiveDirectoryConnector testADConnector /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureArcData/dataControllers/testdataController/activeDirectoryConnectors/testADConnector 
 * ```
 */
export class ActiveDirectoryConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20220301preview:ActiveDirectoryConnector';
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20220301preview.ActiveDirectoryConnectorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ActiveDirectoryConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.azurearcdata.v20220301preview.activeDirectoryConnectorPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20220615preview:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20230115preview:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20230315preview:ActiveDirectoryConnector" }] };
