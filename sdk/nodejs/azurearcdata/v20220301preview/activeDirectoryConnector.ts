...
export class ActiveDirectoryConnector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ActiveDirectoryConnector {
        pulumi.log.warn("ActiveDirectoryConnector is deprecated: azure-native:azurearcdata/v20220301preview:ActiveDirectoryConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:ActiveDirectoryConnector to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: ActiveDirectoryConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20220615preview:ActiveDirectoryConnector" }] };
