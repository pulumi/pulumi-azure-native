...
export class ActiveDirectoryConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20250301preview:ActiveDirectoryConnector';
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20250301preview.ActiveDirectoryConnectorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ActiveDirectoryConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.azurearcdata.v20250301preview.activeDirectoryConnectorPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata/v20220301preview:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20220615preview:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20230115preview:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20240101:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20240501preview:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata:ActiveDirectoryConnector" }] };
...
export interface ActiveDirectoryConnectorArgs {
     ...
     * null
     */
    properties: pulumi.Input<inputs.azurearcdata.v20250301preview.ActiveDirectoryConnectorPropertiesArgs>;
    /**
