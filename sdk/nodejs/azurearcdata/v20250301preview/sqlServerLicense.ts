...
export class SqlServerLicense extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20250301preview:SqlServerLicense';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20250301preview.SqlServerLicensePropertiesResponse>;
    /**
...
export interface SqlServerLicenseArgs {
     ...
     * SQL Server license properties
     */
    properties: pulumi.Input<inputs.azurearcdata.v20250301preview.SqlServerLicensePropertiesArgs>;
    /**
