...
export class FailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20250301preview:FailoverGroup';
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20250301preview.FailoverGroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.azurearcdata.v20250301preview.failoverGroupPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata/v20230115preview:FailoverGroup" }, { type: "azure-native:azurearcdata/v20240101:FailoverGroup" }, { type: "azure-native:azurearcdata/v20240501preview:FailoverGroup" }, { type: "azure-native:azurearcdata:FailoverGroup" }] };
...
export interface FailoverGroupArgs {
     ...
     * null
     */
    properties: pulumi.Input<inputs.azurearcdata.v20250301preview.FailoverGroupPropertiesArgs>;
    /**
