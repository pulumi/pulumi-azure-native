...
export function getPostgresInstance(args: GetPostgresInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetPostgresInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20250301preview:getPostgresInstance", {
...
export interface GetPostgresInstanceResult {
     ...
     */
    readonly extendedLocation?: outputs.azurearcdata.v20250301preview.ExtendedLocationResponse;
    /**
     ...
     * null
     */
    readonly properties: outputs.azurearcdata.v20250301preview.PostgresInstancePropertiesResponse;
    /**
     * Resource sku.
     */
    readonly sku?: outputs.azurearcdata.v20250301preview.PostgresInstanceSkuResponse;
    /**
...
export function getPostgresInstanceOutput(args: GetPostgresInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPostgresInstanceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:azurearcdata/v20250301preview:getPostgresInstance", {
        "postgresInstanceName": args.postgresInstanceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
