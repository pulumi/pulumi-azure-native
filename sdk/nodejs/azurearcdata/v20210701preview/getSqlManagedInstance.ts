...
export function getSqlManagedInstance(args: GetSqlManagedInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlManagedInstanceResult> {
    pulumi.log.warn("getSqlManagedInstance is deprecated: azure-native:azurearcdata/v20210701preview:SqlManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:SqlManagedInstance to guarantee forwards compatibility.")
