...
export class SqlManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20240501preview:SqlManagedInstance';
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20240501preview.SqlManagedInstancePropertiesResponse>;
    /**
     * Resource sku.
     */
    public readonly sku!: pulumi.Output<outputs.azurearcdata.v20240501preview.SqlManagedInstanceSkuResponse | undefined>;
    /**
