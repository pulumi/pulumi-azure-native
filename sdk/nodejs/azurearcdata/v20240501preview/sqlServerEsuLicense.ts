...
export class SqlServerEsuLicense extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20240501preview:SqlServerEsuLicense';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20240501preview.SqlServerEsuLicensePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqlServerEsuLicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata/v20250301preview:SqlServerEsuLicense" }, { type: "azure-native:azurearcdata:SqlServerEsuLicense" }] };
...
export interface SqlServerEsuLicenseArgs {
     ...
     * SQL Server ESU license properties
     */
    properties: pulumi.Input<inputs.azurearcdata.v20240501preview.SqlServerEsuLicensePropertiesArgs>;
    /**
