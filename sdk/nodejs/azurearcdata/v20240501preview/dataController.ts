...
export class DataController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20240501preview:DataController';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20240501preview.DataControllerPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DataControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.azurearcdata.v20240501preview.dataControllerPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface DataControllerArgs {
     ...
     * The data controller's properties
     */
    properties: pulumi.Input<inputs.azurearcdata.v20240501preview.DataControllerPropertiesArgs>;
    /**
