...
export class PostgresInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20240501preview:PostgresInstance';
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.azurearcdata.v20240501preview.ExtendedLocationResponse | undefined>;
    /**
     ...
     * null
     */
    public readonly properties!: pulumi.Output<outputs.azurearcdata.v20240501preview.PostgresInstancePropertiesResponse>;
    /**
     * Resource sku.
     */
    public readonly sku!: pulumi.Output<outputs.azurearcdata.v20240501preview.PostgresInstanceSkuResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.azurearcdata.v20240501preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: PostgresInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(inputs.azurearcdata.v20240501preview.postgresInstanceSkuArgsProvideDefaults) : undefined) : undefined;
...
export interface PostgresInstanceArgs {
     ...
     * The extendedLocation of the resource.
     */
    extendedLocation?: pulumi.Input<inputs.azurearcdata.v20240501preview.ExtendedLocationArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * null
     */
    properties: pulumi.Input<inputs.azurearcdata.v20240501preview.PostgresInstancePropertiesArgs>;
    /**
     ...
     * Resource sku.
     */
    sku?: pulumi.Input<inputs.azurearcdata.v20240501preview.PostgresInstanceSkuArgs>;
    /**
     * Resource tags.
     */
