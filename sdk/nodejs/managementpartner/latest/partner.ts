 ...
 *
 * const partner = new azurerm.managementpartner.latest.Partner("partner", {partnerId: "123456"});
 *
 * ```
 */
export class Partner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managementpartner/latest:Partner';
    ...
    constructor(name: string, args: PartnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managementpartner/v20180201:Partner" }] };
