...
export class Partner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:managementpartner/preview:Partner';
    ...
    constructor(name: string, args: PartnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:managementpartner/latest:Partner" }, { type: "azurerm:managementpartner/v20180201:Partner" }] };
