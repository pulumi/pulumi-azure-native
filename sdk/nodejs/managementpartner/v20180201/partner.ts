...
export class Partner extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: PartnerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:managementpartner/v20180201:Partner" }, { type: "azure-native:managementpartner:Partner" }, { type: "azure-nextgen:managementpartner:Partner" }] };
