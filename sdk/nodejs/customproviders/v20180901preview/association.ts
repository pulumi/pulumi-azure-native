...
export class Association extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customproviders/v20180901preview:Association';
    ...
    constructor(name: string, args: AssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customproviders/preview:Association" }] };
