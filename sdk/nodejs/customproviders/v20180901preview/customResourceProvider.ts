...
export class CustomResourceProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:customproviders/v20180901preview:CustomResourceProvider';
    ...
    constructor(name: string, args: CustomResourceProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customproviders/preview:CustomResourceProvider" }] };
