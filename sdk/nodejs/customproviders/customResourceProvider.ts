...
export class CustomResourceProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:customproviders:CustomResourceProvider';
    ...
    constructor(name: string, args: CustomResourceProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:customproviders/v20180901preview:CustomResourceProvider" }] };
