...
export class CustomResourceProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomResourceProvider {
        return new CustomResourceProvider(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:customproviders/preview:CustomResourceProvider';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.customproviders.preview.CustomRPActionRouteDefinitionResponse[] | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly resourceTypes!: pulumi.Output<outputs.customproviders.preview.CustomRPResourceTypeRouteDefinitionResponse[] | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly validations!: pulumi.Output<outputs.customproviders.preview.CustomRPValidationsResponse[] | undefined>;
    ...
    constructor(name: string, argsOrState?: CustomResourceProviderArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CustomResourceProviderArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:customproviders/v20180901preview:CustomResourceProvider" }] };
...
export interface CustomResourceProviderArgs {
     ...
     * A list of actions that the custom resource provider implements.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputs.customproviders.preview.CustomRPActionRouteDefinition>[]>;
    /**
     * Resource location
     */
     ...
     * A list of resource types that the custom resource provider implements.
     */
    readonly resourceTypes?: pulumi.Input<pulumi.Input<inputs.customproviders.preview.CustomRPResourceTypeRouteDefinition>[]>;
    /**
     * Resource tags
     */
     ...
     * A list of validations to run on the custom resource provider's requests.
     */
    readonly validations?: pulumi.Input<pulumi.Input<inputs.customproviders.preview.CustomRPValidations>[]>;
}
