...
export class Streamingjob extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.streamanalytics.StreamingJobPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface StreamingjobState {
     ...
     * The properties that are associated with a streaming job.  Required on PUT (CreateOrReplace) requests.
     */
    readonly properties: pulumi.Input<inputs.streamanalytics.StreamingJobPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface StreamingjobArgs {
     ...
     * The properties that are associated with a streaming job.  Required on PUT (CreateOrReplace) requests.
     */
    readonly properties?: pulumi.Input<inputs.streamanalytics.StreamingJobProperties>;
    /**
