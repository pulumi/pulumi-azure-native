...
export class Output extends pulumi.CustomResource {
     ...
     */
    public readonly serialization!: pulumi.Output<outputs.streamanalytics.AvroSerializationResponse | outputs.streamanalytics.CsvSerializationResponse | outputs.streamanalytics.CustomClrSerializationResponse | outputs.streamanalytics.JsonSerializationResponse | outputs.streamanalytics.ParquetSerializationResponse | undefined>;
    /**
...
export interface OutputArgs {
     ...
     * Describes how data from an input is serialized or how data is serialized when written to an output. Required on PUT (CreateOrReplace) requests.
     */
    serialization?: pulumi.Input<inputs.streamanalytics.AvroSerializationArgs | inputs.streamanalytics.CsvSerializationArgs | inputs.streamanalytics.CustomClrSerializationArgs | inputs.streamanalytics.JsonSerializationArgs | inputs.streamanalytics.ParquetSerializationArgs>;
    /**
     * The size window to constrain a Stream Analytics output to.
     */
