...
export class Output extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly lastOutputEventTimestamps!: pulumi.Output<outputs.streamanalytics.LastOutputEventTimestampResponse[]>;
    /**
     * Resource name
     */
     ...
     */
    public readonly serialization!: pulumi.Output<outputs.streamanalytics.AvroSerializationResponse | outputs.streamanalytics.CsvSerializationResponse | outputs.streamanalytics.CustomClrSerializationResponse | outputs.streamanalytics.DeltaSerializationResponse | outputs.streamanalytics.JsonSerializationResponse | outputs.streamanalytics.ParquetSerializationResponse | undefined>;
    /**
     ...
     */
    public readonly watermarkSettings!: pulumi.Output<outputs.streamanalytics.OutputWatermarkPropertiesResponse | undefined>;
...
export interface OutputArgs {
     ...
     * Describes the data source that output will be written to. Required on PUT (CreateOrReplace) requests.
     */
    datasource?: pulumi.Input<inputs.streamanalytics.AzureDataLakeStoreOutputDataSourceArgs | inputs.streamanalytics.AzureFunctionOutputDataSourceArgs | inputs.streamanalytics.AzureSqlDatabaseOutputDataSourceArgs | inputs.streamanalytics.AzureSynapseOutputDataSourceArgs | inputs.streamanalytics.AzureTableOutputDataSourceArgs | inputs.streamanalytics.BlobOutputDataSourceArgs | inputs.streamanalytics.DocumentDbOutputDataSourceArgs | inputs.streamanalytics.EventHubOutputDataSourceArgs | inputs.streamanalytics.EventHubV2OutputDataSourceArgs | inputs.streamanalytics.GatewayMessageBusOutputDataSourceArgs | inputs.streamanalytics.PostgreSQLOutputDataSourceArgs | inputs.streamanalytics.PowerBIOutputDataSourceArgs | inputs.streamanalytics.RawOutputDatasourceArgs | inputs.streamanalytics.ServiceBusQueueOutputDataSourceArgs | inputs.streamanalytics.ServiceBusTopicOutputDataSourceArgs>;
    /**
     ...
     * Describes how data from an input is serialized or how data is serialized when written to an output. Required on PUT (CreateOrReplace) requests.
     */
    serialization?: pulumi.Input<inputs.streamanalytics.AvroSerializationArgs | inputs.streamanalytics.CsvSerializationArgs | inputs.streamanalytics.CustomClrSerializationArgs | inputs.streamanalytics.DeltaSerializationArgs | inputs.streamanalytics.JsonSerializationArgs | inputs.streamanalytics.ParquetSerializationArgs>;
    /**
     * The size window to constrain a Stream Analytics output to.
     */
     ...
     * Settings which determine whether to send watermarks to downstream.
     */
    watermarkSettings?: pulumi.Input<inputs.streamanalytics.OutputWatermarkPropertiesArgs>;
}
