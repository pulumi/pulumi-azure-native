...
export class Input extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.streamanalytics.ReferenceInputPropertiesResponse | outputs.streamanalytics.StreamInputPropertiesResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: InputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:streamanalytics:Input" }, { type: "azure-native:streamanalytics/v20160301:Input" }, { type: "azure-nextgen:streamanalytics/v20160301:Input" }, { type: "azure-native:streamanalytics/v20170401preview:Input" }, { type: "azure-nextgen:streamanalytics/v20170401preview:Input" }] };
