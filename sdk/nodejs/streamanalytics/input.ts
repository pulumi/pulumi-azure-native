...
export class Input extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:streamanalytics:Input';
    ...
    constructor(name: string, args: InputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:streamanalytics/latest:Input" }, { type: "azure-nextgen:streamanalytics/v20160301:Input" }, { type: "azure-nextgen:streamanalytics/v20170401preview:Input" }] };
