 ...
 */
/** @deprecated Version 2017-04-01-preview will be removed in v2 of the provider. */
export function getStreamingJob(args: GetStreamingJobArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamingJobResult> {
    pulumi.log.warn("getStreamingJob is deprecated: Version 2017-04-01-preview will be removed in v2 of the provider.")
