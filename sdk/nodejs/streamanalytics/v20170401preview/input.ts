...
export class Input extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:streamanalytics:Input" }, { type: "azure-nextgen:streamanalytics:Input" }, { type: "azure-native:streamanalytics/latest:Input" }, { type: "azure-nextgen:streamanalytics/latest:Input" }, { type: "azure-native:streamanalytics/v20160301:Input" }, { type: "azure-nextgen:streamanalytics/v20160301:Input" }] };
