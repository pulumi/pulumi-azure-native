...
export class Input extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:streamanalytics/v20170401preview:Input';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.streamanalytics.v20170401preview.ReferenceInputPropertiesResponse | outputs.streamanalytics.v20170401preview.StreamInputPropertiesResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: InputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:streamanalytics/v20170401preview:Input" }, { type: "azure-native:streamanalytics:Input" }, { type: "azure-nextgen:streamanalytics:Input" }, { type: "azure-native:streamanalytics/v20160301:Input" }, { type: "azure-nextgen:streamanalytics/v20160301:Input" }, { type: "azure-native:streamanalytics/v20200301:Input" }, { type: "azure-nextgen:streamanalytics/v20200301:Input" }, { type: "azure-native:streamanalytics/v20211001preview:Input" }, { type: "azure-nextgen:streamanalytics/v20211001preview:Input" }] };
...
export interface InputArgs {
     ...
     * The properties that are associated with an input. Required on PUT (CreateOrReplace) requests.
     */
    properties?: pulumi.Input<inputs.streamanalytics.v20170401preview.ReferenceInputPropertiesArgs | inputs.streamanalytics.v20170401preview.StreamInputPropertiesArgs>;
    /**
