...
export class StreamingJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:streamanalytics:StreamingJob';
    ...
    constructor(name: string, args: StreamingJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:streamanalytics/latest:StreamingJob" }, { type: "azure-nextgen:streamanalytics/v20160301:StreamingJob" }, { type: "azure-nextgen:streamanalytics/v20170401preview:StreamingJob" }] };
