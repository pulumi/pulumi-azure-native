...
export class Input extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:streamanalytics/preview:Input';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.streamanalytics.preview.ReferenceInputPropertiesResponse | outputs.streamanalytics.preview.StreamInputPropertiesResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: InputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:streamanalytics/latest:Input" }, { type: "azurerm:streamanalytics/v20160301:Input" }] };
...
export interface InputArgs {
     ...
     * The properties that are associated with an input. Required on PUT (CreateOrReplace) requests.
     */
    readonly properties?: pulumi.Input<inputs.streamanalytics.preview.ReferenceInputProperties | inputs.streamanalytics.preview.StreamInputProperties>;
    /**
