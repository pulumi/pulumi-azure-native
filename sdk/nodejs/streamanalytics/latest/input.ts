...
export class Input extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:streamanalytics/latest:Input';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.streamanalytics.latest.ReferenceInputPropertiesResponse | outputs.streamanalytics.latest.StreamInputPropertiesResponse>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: InputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:streamanalytics/v20160301:Input" }, { type: "azurerm:streamanalytics/v20170401preview:Input" }] };
...
export interface InputArgs {
     ...
     * The properties that are associated with an input. Required on PUT (CreateOrReplace) requests.
     */
    readonly properties?: pulumi.Input<inputs.streamanalytics.latest.ReferenceInputProperties | inputs.streamanalytics.latest.StreamInputProperties>;
    /**
