...
export class Input extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:streamanalytics/latest:Input';
