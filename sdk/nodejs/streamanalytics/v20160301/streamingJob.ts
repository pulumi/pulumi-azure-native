...
export class StreamingJob extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StreamingJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:streamanalytics/v20160301:StreamingJob" }, { type: "azure-native:streamanalytics:StreamingJob" }, { type: "azure-nextgen:streamanalytics:StreamingJob" }, { type: "azure-native:streamanalytics/v20170401preview:StreamingJob" }, { type: "azure-nextgen:streamanalytics/v20170401preview:StreamingJob" }] };
...
export interface StreamingJobArgs {
     ...
     * Controls certain runtime behaviors of the streaming job.
     */
    readonly compatibilityLevel?: pulumi.Input<string | enums.streamanalytics.v20160301.CompatibilityLevel>;
    /**
     * The data locale of the stream analytics job. Value should be the name of a supported .NET Culture from the set https://msdn.microsoft.com/en-us/library/system.globalization.culturetypes(v=vs.110).aspx. Defaults to 'en-US' if none specified.
     */
     ...
     * Indicates the policy to apply to events that arrive out of order in the input event stream.
     */
    readonly eventsOutOfOrderPolicy?: pulumi.Input<string | enums.streamanalytics.v20160301.EventsOutOfOrderPolicy>;
    /**
     * A list of one or more functions for the streaming job. The name property for each function is required when specifying this property in a PUT request. This property cannot be modify via a PATCH operation. You must use the PATCH API available for the individual transformation.
     */
    readonly functions?: pulumi.Input<pulumi.Input<inputs.streamanalytics.v20160301.FunctionArgs>[]>;
    /**
     * A list of one or more inputs to the streaming job. The name property for each input is required when specifying this property in a PUT request. This property cannot be modify via a PATCH operation. You must use the PATCH API available for the individual input.
     */
    readonly inputs?: pulumi.Input<pulumi.Input<inputs.streamanalytics.v20160301.InputArgs>[]>;
    /**
     ...
     * Indicates the policy to apply to events that arrive at the output and cannot be written to the external storage due to being malformed (missing column values, column values of wrong type or size).
     */
    readonly outputErrorPolicy?: pulumi.Input<string | enums.streamanalytics.v20160301.OutputErrorPolicy>;
    /**
     * This property should only be utilized when it is desired that the job be started immediately upon creation. Value may be JobStartTime, CustomTime, or LastOutputEventTime to indicate whether the starting point of the output event stream should start whenever the job is started, start at a custom user time stamp specified via the outputStartTime property, or start from the last event output time.
     */
    readonly outputStartMode?: pulumi.Input<string | enums.streamanalytics.v20160301.OutputStartMode>;
    /**
     * Value is either an ISO-8601 formatted time stamp that indicates the starting point of the output event stream, or null to indicate that the output event stream will start whenever the streaming job is started. This property must have a value if outputStartMode is set to CustomTime.
     */
     ...
     * A list of one or more outputs for the streaming job. The name property for each output is required when specifying this property in a PUT request. This property cannot be modify via a PATCH operation. You must use the PATCH API available for the individual output.
     */
    readonly outputs?: pulumi.Input<pulumi.Input<inputs.streamanalytics.v20160301.OutputArgs>[]>;
    /**
     ...
     * Describes the SKU of the streaming job. Required on PUT (CreateOrReplace) requests.
     */
    readonly sku?: pulumi.Input<inputs.streamanalytics.v20160301.SkuArgs>;
    /**
     * Resource tags
     */
     ...
     * Indicates the query and the number of streaming units to use for the streaming job. The name property of the transformation is required when specifying this property in a PUT request. This property cannot be modify via a PATCH operation. You must use the PATCH API available for the individual transformation.
     */
    readonly transformation?: pulumi.Input<inputs.streamanalytics.v20160301.TransformationArgs>;
}
