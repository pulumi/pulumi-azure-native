...
export class Input extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:streamanalytics/v20160301:Input" }, { type: "azure-native:streamanalytics:Input" }, { type: "azure-nextgen:streamanalytics:Input" }, { type: "azure-native:streamanalytics/v20170401preview:Input" }, { type: "azure-nextgen:streamanalytics/v20170401preview:Input" }] };
...
export interface InputArgs {
     ...
     * The properties that are associated with an input. Required on PUT (CreateOrReplace) requests.
     */
    readonly properties?: pulumi.Input<inputs.streamanalytics.v20160301.ReferenceInputPropertiesArgs | inputs.streamanalytics.v20160301.StreamInputPropertiesArgs>;
    /**
