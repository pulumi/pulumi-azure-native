...
export class Input extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:streamanalytics/v20160301:Input';
    ...
    constructor(name: string, argsOrState?: InputArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:streamanalytics/latest:Input" }, { type: "azurerm:streamanalytics/preview:Input" }] };
