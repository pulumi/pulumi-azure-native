...
// Export enums:
export * from "../../types/enums/frontdoor/v20190501";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:frontdoor/v20190501:FrontDoor":
...
pulumi.runtime.registerResourceModule("azure-native", "frontdoor/v20190501", _module)
