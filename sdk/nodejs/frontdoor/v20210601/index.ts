...
// Export enums:
export * from "../../types/enums/frontdoor/v20210601";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:frontdoor/v20210601:FrontDoor":
                return new FrontDoor(name, <any>undefined, { urn })
            case "azure-native:frontdoor/v20210601:Policy":
                return new Policy(name, <any>undefined, { urn })
            case "azure-native:frontdoor/v20210601:RulesEngine":
...
pulumi.runtime.registerResourceModule("azure-native", "frontdoor/v20210601", _module)
