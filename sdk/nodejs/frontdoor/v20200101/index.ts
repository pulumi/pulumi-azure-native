...
// Export enums:
export * from "../../types/enums/frontdoor/v20200101";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:frontdoor/v20200101:FrontDoor":
                return new FrontDoor(name, <any>undefined, { urn })
            case "azure-native:frontdoor/v20200101:RulesEngine":
...
pulumi.runtime.registerResourceModule("azure-native", "frontdoor/v20200101", _module)
