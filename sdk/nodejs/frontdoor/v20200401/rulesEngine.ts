...
export class RulesEngine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:frontdoor/v20200401:RulesEngine';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.frontdoor.v20200401.RulesEngineRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: RulesEngineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20200401:RulesEngine" }, { type: "azure-native:frontdoor:RulesEngine" }, { type: "azure-native:network:RulesEngine" }, { type: "azure-native:frontdoor/v20200101:RulesEngine" }, { type: "azure-native:network/v20200101:RulesEngine" }, { type: "azure-native:frontdoor/v20200501:RulesEngine" }, { type: "azure-native:network/v20200501:RulesEngine" }, { type: "azure-native:frontdoor/v20210601:RulesEngine" }, { type: "azure-native:network/v20210601:RulesEngine" }] };
...
export interface RulesEngineArgs {
     ...
     * A list of rules that define a particular Rules Engine Configuration.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.frontdoor.v20200401.RulesEngineRuleArgs>[]>;
    /**
