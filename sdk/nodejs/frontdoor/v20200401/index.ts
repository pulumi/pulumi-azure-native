...
// Export enums:
export * from "../../types/enums/frontdoor/v20200401";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:frontdoor/v20200401:FrontDoor":
                return new FrontDoor(name, <any>undefined, { urn })
            case "azure-native:frontdoor/v20200401:Policy":
                return new Policy(name, <any>undefined, { urn })
            case "azure-native:frontdoor/v20200401:RulesEngine":
...
pulumi.runtime.registerResourceModule("azure-native", "frontdoor/v20200401", _module)
