...
export class NetworkExperimentProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:frontdoor/v20191101:NetworkExperimentProfile';
    ...
    constructor(name: string, args: NetworkExperimentProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20191101:NetworkExperimentProfile" }, { type: "azure-native:frontdoor:NetworkExperimentProfile" }, { type: "azure-native:network:NetworkExperimentProfile" }] };
...
export interface NetworkExperimentProfileArgs {
     ...
     * The state of the Experiment
     */
    enabledState?: pulumi.Input<string | enums.frontdoor.v20191101.State>;
    /**
     * Resource location.
     */
