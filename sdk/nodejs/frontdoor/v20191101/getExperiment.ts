...
export function getExperiment(args: GetExperimentArgs, opts?: pulumi.InvokeOptions): Promise<GetExperimentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:frontdoor/v20191101:getExperiment", {
...
export interface GetExperimentResult {
     ...
     */
    readonly endpointA?: outputs.frontdoor.v20191101.EndpointResponse;
    /**
     * The endpoint B of an experiment
     */
    readonly endpointB?: outputs.frontdoor.v20191101.EndpointResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
...
export function getExperimentOutput(args: GetExperimentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExperimentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:frontdoor/v20191101:getExperiment", {
        "experimentName": args.experimentName,
        "profileName": args.profileName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
