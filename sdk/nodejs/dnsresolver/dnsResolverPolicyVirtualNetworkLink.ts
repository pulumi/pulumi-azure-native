...
export class DnsResolverPolicyVirtualNetworkLink extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DnsResolverPolicyVirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:DnsResolverPolicyVirtualNetworkLink" }, { type: "azure-native:dnsresolver/v20230701preview:DnsResolverPolicyVirtualNetworkLink" }, { type: "azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink" }] };
