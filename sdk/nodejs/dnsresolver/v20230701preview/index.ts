...
// Export enums:
export * from "../../types/enums/dnsresolver/v20230701preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dnsresolver/v20230701preview:DnsForwardingRuleset":
                return new DnsForwardingRuleset(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:DnsResolver":
                return new DnsResolver(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:DnsResolverDomainList":
                return new DnsResolverDomainList(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:DnsResolverPolicy":
                return new DnsResolverPolicy(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:DnsResolverPolicyVirtualNetworkLink":
                return new DnsResolverPolicyVirtualNetworkLink(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:DnsSecurityRule":
                return new DnsSecurityRule(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:ForwardingRule":
                return new ForwardingRule(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:InboundEndpoint":
                return new InboundEndpoint(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:OutboundEndpoint":
                return new OutboundEndpoint(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20230701preview:PrivateResolverVirtualNetworkLink":
...
pulumi.runtime.registerResourceModule("azure-native", "dnsresolver/v20230701preview", _module)
