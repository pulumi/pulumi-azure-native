...
export class DnsResolverDomainList extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DnsResolverDomainListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dnsresolver:DnsResolverDomainList" }, { type: "azure-native:network/v20230701preview:DnsResolverDomainList" }, { type: "azure-native:network:DnsResolverDomainList" }] };
