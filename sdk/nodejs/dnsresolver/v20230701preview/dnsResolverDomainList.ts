...
export class DnsResolverDomainList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver/v20230701preview:DnsResolverDomainList';
    ...
    constructor(name: string, args: DnsResolverDomainListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20230701preview:DnsResolverDomainList" }, { type: "azure-native:dnsresolver:DnsResolverDomainList" }, { type: "azure-native:network:DnsResolverDomainList" }] };
