...
export class DnsResolverPolicyVirtualNetworkLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver/v20230701preview:DnsResolverPolicyVirtualNetworkLink';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.dnsresolver.v20230701preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.dnsresolver.v20230701preview.SubResourceResponse>;
    ...
    constructor(name: string, args: DnsResolverPolicyVirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dnsresolver:DnsResolverPolicyVirtualNetworkLink" }, { type: "azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink" }, { type: "azure-native:network:DnsResolverPolicyVirtualNetworkLink" }] };
...
export interface DnsResolverPolicyVirtualNetworkLinkArgs {
     ...
     * The reference to the virtual network. This cannot be changed after creation.
     */
    virtualNetwork: pulumi.Input<inputs.dnsresolver.v20230701preview.SubResourceArgs>;
}
