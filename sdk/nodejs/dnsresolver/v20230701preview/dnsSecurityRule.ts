...
export class DnsSecurityRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DnsSecurityRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20230701preview:DnsSecurityRule" }, { type: "azure-native:dnsresolver:DnsSecurityRule" }, { type: "azure-native:network:DnsSecurityRule" }] };
