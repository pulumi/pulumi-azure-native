...
export class DnsSecurityRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver/v20230701preview:DnsSecurityRule';
     ...
     */
    public readonly action!: pulumi.Output<outputs.dnsresolver.v20230701preview.DnsSecurityRuleActionResponse>;
    /**
     * DNS resolver policy domains lists that the DNS security rule applies to.
     */
    public readonly dnsResolverDomainLists!: pulumi.Output<outputs.dnsresolver.v20230701preview.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: DnsSecurityRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dnsresolver:DnsSecurityRule" }, { type: "azure-native:network/v20230701preview:DnsSecurityRule" }, { type: "azure-native:network:DnsSecurityRule" }] };
...
export interface DnsSecurityRuleArgs {
     ...
     * The action to take on DNS requests that match the DNS security rule.
     */
    action: pulumi.Input<inputs.dnsresolver.v20230701preview.DnsSecurityRuleActionArgs>;
    /**
     * DNS resolver policy domains lists that the DNS security rule applies to.
     */
    dnsResolverDomainLists: pulumi.Input<pulumi.Input<inputs.dnsresolver.v20230701preview.SubResourceArgs>[]>;
    /**
     ...
     * The state of DNS security rule.
     */
    dnsSecurityRuleState?: pulumi.Input<string | enums.dnsresolver.v20230701preview.DnsSecurityRuleState>;
    /**
     * The geo-location where the resource lives
     */
