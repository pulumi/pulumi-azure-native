...
// Export enums:
export * from "../../types/enums/dnsresolver/v20200401preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dnsresolver/v20200401preview:DnsForwardingRuleset":
                return new DnsForwardingRuleset(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20200401preview:DnsResolver":
                return new DnsResolver(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20200401preview:ForwardingRule":
                return new ForwardingRule(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20200401preview:InboundEndpoint":
                return new InboundEndpoint(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20200401preview:OutboundEndpoint":
                return new OutboundEndpoint(name, <any>undefined, { urn })
            case "azure-native:dnsresolver/v20200401preview:PrivateResolverVirtualNetworkLink":
...
pulumi.runtime.registerResourceModule("azure-native", "dnsresolver/v20200401preview", _module)
