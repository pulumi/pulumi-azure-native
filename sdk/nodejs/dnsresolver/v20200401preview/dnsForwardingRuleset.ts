...
export class DnsForwardingRuleset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver/v20200401preview:DnsForwardingRuleset';
     ...
     */
    public readonly dnsResolverOutboundEndpoints!: pulumi.Output<outputs.dnsresolver.v20200401preview.SubResourceResponse[] | undefined>;
    /**
...
export interface DnsForwardingRulesetArgs {
     ...
     * The reference to the DNS resolver outbound endpoints that are used to route DNS queries matching the forwarding rules in the ruleset to the target DNS servers.
     */
    dnsResolverOutboundEndpoints?: pulumi.Input<pulumi.Input<inputs.dnsresolver.v20200401preview.SubResourceArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
