...
export class OutboundEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OutboundEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dnsresolver/v20220701:OutboundEndpoint" }, { type: "azure-native:dnsresolver/v20230701preview:OutboundEndpoint" }, { type: "azure-native:dnsresolver:OutboundEndpoint" }, { type: "azure-native:network/v20200401preview:OutboundEndpoint" }, { type: "azure-native:network/v20220701:OutboundEndpoint" }, { type: "azure-native:network/v20230701preview:OutboundEndpoint" }, { type: "azure-native:network:OutboundEndpoint" }] };
