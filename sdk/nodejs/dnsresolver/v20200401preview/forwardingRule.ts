...
export class ForwardingRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver/v20200401preview:ForwardingRule';
     ...
     */
    public readonly targetDnsServers!: pulumi.Output<outputs.dnsresolver.v20200401preview.TargetDnsServerResponse[]>;
    /**
    ...
    constructor(name: string, args: ForwardingRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20200401preview:ForwardingRule" }, { type: "azure-native:dnsresolver:ForwardingRule" }, { type: "azure-native:network:ForwardingRule" }, { type: "azure-native:dnsresolver/v20220701:ForwardingRule" }, { type: "azure-native:network/v20220701:ForwardingRule" }, { type: "azure-native:dnsresolver/v20230701preview:ForwardingRule" }, { type: "azure-native:network/v20230701preview:ForwardingRule" }] };
...
export interface ForwardingRuleArgs {
     ...
     * The state of forwarding rule.
     */
    forwardingRuleState?: pulumi.Input<string | enums.dnsresolver.v20200401preview.ForwardingRuleState>;
    /**
     * Metadata attached to the forwarding rule.
     */
     ...
     * DNS servers to forward the DNS query to.
     */
    targetDnsServers: pulumi.Input<pulumi.Input<inputs.dnsresolver.v20200401preview.TargetDnsServerArgs>[]>;
}
