...
export class InboundEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InboundEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20200401preview:InboundEndpoint" }, { type: "azure-native:dnsresolver:InboundEndpoint" }, { type: "azure-native:network:InboundEndpoint" }, { type: "azure-native:dnsresolver/v20220701:InboundEndpoint" }, { type: "azure-native:network/v20220701:InboundEndpoint" }, { type: "azure-native:dnsresolver/v20230701preview:InboundEndpoint" }, { type: "azure-native:network/v20230701preview:InboundEndpoint" }] };
