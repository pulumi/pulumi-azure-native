...
export function getOutboundEndpoint(args: GetOutboundEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetOutboundEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dnsresolver/v20200401preview:getOutboundEndpoint", {
...
export interface GetOutboundEndpointResult {
     ...
     */
    readonly subnet?: outputs.dnsresolver.v20200401preview.SubResourceResponse;
    /**
...
export function getOutboundEndpointOutput(args: GetOutboundEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOutboundEndpointResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:dnsresolver/v20200401preview:getOutboundEndpoint", {
        "dnsResolverName": args.dnsResolverName,
        "outboundEndpointName": args.outboundEndpointName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
