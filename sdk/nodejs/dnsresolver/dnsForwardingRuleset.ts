...
export class DnsForwardingRuleset extends pulumi.CustomResource {
     ...
     */
    public readonly dnsResolverOutboundEndpoints!: pulumi.Output<outputs.dnsresolver.SubResourceResponse[]>;
    /**
