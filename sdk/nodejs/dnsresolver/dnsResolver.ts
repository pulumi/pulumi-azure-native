...
export class DnsResolver extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DnsResolverArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:DnsResolver" }, { type: "azure-native:dnsresolver/v20200401preview:DnsResolver" }, { type: "azure-native:network/v20200401preview:DnsResolver" }, { type: "azure-native:dnsresolver/v20220701:DnsResolver" }, { type: "azure-native:network/v20220701:DnsResolver" }, { type: "azure-native:dnsresolver/v20230701preview:DnsResolver" }, { type: "azure-native:network/v20230701preview:DnsResolver" }] };
