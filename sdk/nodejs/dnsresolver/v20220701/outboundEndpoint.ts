...
export class OutboundEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver/v20220701:OutboundEndpoint';
     ...
     */
    public readonly subnet!: pulumi.Output<outputs.dnsresolver.v20220701.SubResourceResponse>;
    /**
    ...
    constructor(name: string, args: OutboundEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20220701:OutboundEndpoint" }, { type: "azure-native:dnsresolver:OutboundEndpoint" }, { type: "azure-native:network:OutboundEndpoint" }, { type: "azure-native:dnsresolver/v20200401preview:OutboundEndpoint" }, { type: "azure-native:network/v20200401preview:OutboundEndpoint" }, { type: "azure-native:dnsresolver/v20230701preview:OutboundEndpoint" }, { type: "azure-native:network/v20230701preview:OutboundEndpoint" }] };
...
export interface OutboundEndpointArgs {
     ...
     * The reference to the subnet used for the outbound endpoint.
     */
    subnet: pulumi.Input<inputs.dnsresolver.v20220701.SubResourceArgs>;
    /**
     * Resource tags.
     */
