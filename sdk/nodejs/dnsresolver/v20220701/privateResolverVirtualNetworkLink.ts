...
export class PrivateResolverVirtualNetworkLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver/v20220701:PrivateResolverVirtualNetworkLink';
     ...
     */
    public readonly virtualNetwork!: pulumi.Output<outputs.dnsresolver.v20220701.SubResourceResponse>;
    ...
    constructor(name: string, args: PrivateResolverVirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20220701:PrivateResolverVirtualNetworkLink" }, { type: "azure-native:dnsresolver:PrivateResolverVirtualNetworkLink" }, { type: "azure-native:network:PrivateResolverVirtualNetworkLink" }, { type: "azure-native:dnsresolver/v20200401preview:PrivateResolverVirtualNetworkLink" }, { type: "azure-native:network/v20200401preview:PrivateResolverVirtualNetworkLink" }, { type: "azure-native:dnsresolver/v20230701preview:PrivateResolverVirtualNetworkLink" }, { type: "azure-native:network/v20230701preview:PrivateResolverVirtualNetworkLink" }] };
...
export interface PrivateResolverVirtualNetworkLinkArgs {
     ...
     * The reference to the virtual network. This cannot be changed after creation.
     */
    virtualNetwork: pulumi.Input<inputs.dnsresolver.v20220701.SubResourceArgs>;
    /**
