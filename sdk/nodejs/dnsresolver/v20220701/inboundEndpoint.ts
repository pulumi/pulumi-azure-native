...
export class InboundEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver/v20220701:InboundEndpoint';
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.dnsresolver.v20220701.IpConfigurationResponse[]>;
    /**
    ...
    constructor(name: string, args: InboundEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20220701:InboundEndpoint" }, { type: "azure-native:dnsresolver:InboundEndpoint" }, { type: "azure-native:network:InboundEndpoint" }, { type: "azure-native:dnsresolver/v20200401preview:InboundEndpoint" }, { type: "azure-native:network/v20200401preview:InboundEndpoint" }, { type: "azure-native:dnsresolver/v20230701preview:InboundEndpoint" }, { type: "azure-native:network/v20230701preview:InboundEndpoint" }] };
...
export interface InboundEndpointArgs {
     ...
     * IP configurations for the inbound endpoint.
     */
    ipConfigurations: pulumi.Input<pulumi.Input<inputs.dnsresolver.v20220701.IpConfigurationArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
