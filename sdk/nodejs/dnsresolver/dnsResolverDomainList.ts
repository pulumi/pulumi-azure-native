...
export class DnsResolverDomainList extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DnsResolverDomainListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:DnsResolverDomainList" }, { type: "azure-native:dnsresolver/v20230701preview:DnsResolverDomainList" }, { type: "azure-native:network/v20230701preview:DnsResolverDomainList" }] };
