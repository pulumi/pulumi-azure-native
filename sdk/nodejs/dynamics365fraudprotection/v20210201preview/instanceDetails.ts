...
export class InstanceDetails extends pulumi.CustomResource {
     ...
     */
    public readonly administration!: pulumi.Output<outputs.dynamics365fraudprotection.v20210201preview.DFPInstanceAdministratorsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.dynamics365fraudprotection.v20210201preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: InstanceDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dynamics365fraudprotection/v20210201preview:InstanceDetails" }, { type: "azure-native:dynamics365fraudprotection:InstanceDetails" }, { type: "azure-nextgen:dynamics365fraudprotection:InstanceDetails" }] };
...
export interface InstanceDetailsArgs {
     ...
     * A collection of DFP instance administrators
     */
    readonly administration?: pulumi.Input<inputs.dynamics365fraudprotection.v20210201preview.DFPInstanceAdministrators>;
    /**
