...
export class NetworkFabricController extends pulumi.CustomResource {
     ...
     */
    public readonly infrastructureExpressRouteConnections!: pulumi.Output<outputs.managednetworkfabric.v20230201preview.ExpressRouteConnectionInformationResponse[] | undefined>;
    /**
     ...
     */
    public readonly workloadExpressRouteConnections!: pulumi.Output<outputs.managednetworkfabric.v20230201preview.ExpressRouteConnectionInformationResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkFabricControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkFabricController" }] };
