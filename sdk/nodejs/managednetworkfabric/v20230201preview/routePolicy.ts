 ...
 *
 * const routePolicy = new azure_native.managednetworkfabric.v20230201preview.RoutePolicy("routePolicy", {
...
export class RoutePolicy extends pulumi.CustomResource {
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.managednetworkfabric.v20230201preview.RoutePolicyPropertiesResponseConditions[] | undefined>;
    /**
    ...
    constructor(name: string, args: RoutePolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:RoutePolicy" }] };
...
export interface RoutePolicyArgs {
     ...
     * Route Policy conditions.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.managednetworkfabric.v20230201preview.RoutePolicyPropertiesConditionsArgs>[]>;
    /**
     * Route Policy description.
     */
