 ...
 *
 * const networkFabric = new azure_native.managednetworkfabric.v20230201preview.NetworkFabric("networkFabric", {
 *     fabricASN: 29249,
...
export class NetworkFabric extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkFabric" }] };
