 ...
 *
 * const networkRack = new azure_native.managednetworkfabric.v20230201preview.NetworkRack("networkRack", {
 *     annotation: "null",
 *     location: "eastus",
...
export class NetworkRack extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkRackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkRack" }] };
