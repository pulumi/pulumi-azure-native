...
export class IpPrefix extends pulumi.CustomResource {
     ...
     */
    public readonly ipPrefixRules!: pulumi.Output<outputs.managednetworkfabric.v20230201preview.IpPrefixPropertiesResponseIpPrefixRules[]>;
    /**
    ...
    constructor(name: string, args: IpPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric/v20230615:IpPrefix" }, { type: "azure-native:managednetworkfabric:IpPrefix" }] };
...
export interface IpPrefixArgs {
     ...
     * IpPrefix contains the list of IP PrefixRules objects.
     */
    ipPrefixRules: pulumi.Input<pulumi.Input<inputs.managednetworkfabric.v20230201preview.IpPrefixPropertiesIpPrefixRulesArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
