 ...
 *
 * const accessControlList = new azure_native.managednetworkfabric.v20230201preview.AccessControlList("accessControlList", {
...
export class AccessControlList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230201preview:AccessControlList';
    ...
    constructor(name: string, args: AccessControlListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:AccessControlList" }] };
...
export interface AccessControlListArgs {
     ...
     * IP address family. Example: ipv4 | ipv6.
     */
    addressFamily: pulumi.Input<string | enums.managednetworkfabric.v20230201preview.AddressFamily>;
    /**
     * Switch configuration description.
     */
