...
export class NetworkDevice extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric/v20230615:NetworkDevice" }, { type: "azure-native:managednetworkfabric:NetworkDevice" }] };
...
export interface NetworkDeviceArgs {
     ...
     * networkDeviceRole is the device role: Example: CE | ToR.
     */
    networkDeviceRole: pulumi.Input<string | enums.managednetworkfabric.v20230201preview.NetworkDeviceRoleTypes>;
    /**
     * Network Device SKU name.
     */
