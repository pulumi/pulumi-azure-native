...
export class AccessControlList extends pulumi.CustomResource {
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.managednetworkfabric.AccessControlListPropertiesResponseConditions[]>;
    /**
    ...
    constructor(name: string, args: AccessControlListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric/v20230201preview:AccessControlList" }] };
...
export interface AccessControlListArgs {
     ...
     * Access Control List conditions.
     */
    conditions: pulumi.Input<pulumi.Input<inputs.managednetworkfabric.AccessControlListPropertiesConditionsArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
