...
export function getIpCommunityList(args: GetIpCommunityListArgs, opts?: pulumi.InvokeOptions): Promise<GetIpCommunityListResult> {
    ...
    return pulumi.runtime.invoke("azure-native:managednetworkfabric:getIpCommunityList", {
...
export interface GetIpCommunityListResult {
     ...
     */
    readonly communityMembers?: outputs.managednetworkfabric.IpCommunityListPropertiesResponseCommunityMembers[];
    /**
     * Ip Community List evpnEsImportRouteTargets.
     */
    readonly evpnEsImportRouteTargets?: outputs.managednetworkfabric.IpCommunityListPropertiesResponseEvpnEsImportRouteTargets[];
    /**
