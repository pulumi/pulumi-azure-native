...
export class NetworkFabricController extends pulumi.CustomResource {
     ...
     */
    declare public readonly infrastructureExpressRouteConnections: pulumi.Output<outputs.managednetworkfabric.ExpressRouteConnectionInformationResponse[] | undefined>;
    /**
     * InfrastructureServices IP ranges.
     */
    declare public /*out*/ readonly infrastructureServices: pulumi.Output<outputs.managednetworkfabric.ControllerServicesResponse>;
    /**
     ...
     */
    declare public readonly managedResourceGroupConfiguration: pulumi.Output<outputs.managednetworkfabric.ManagedResourceGroupConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly workloadExpressRouteConnections: pulumi.Output<outputs.managednetworkfabric.ExpressRouteConnectionInformationResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly workloadServices: pulumi.Output<outputs.managednetworkfabric.ControllerServicesResponse>;
...
export interface NetworkFabricControllerArgs {
     ...
     * As part of an update, the Infrastructure ExpressRoute CircuitID should be provided to create and Provision a NFC. This Express route is dedicated for Infrastructure services. (This is a Mandatory attribute)
     */
    infrastructureExpressRouteConnections?: pulumi.Input<pulumi.Input<inputs.managednetworkfabric.ExpressRouteConnectionInformationArgs>[] | undefined>;
    /**
     * IPv4 Network Fabric Controller Address Space.
     */
     ...
     * A workload management network is required for all the tenant (workload) traffic. This traffic is only dedicated for Tenant workloads which are required to access internet or any other MSFT/Public endpoints.
     */
    isWorkloadManagementNetworkEnabled?: pulumi.Input<string | enums.managednetworkfabric.IsWorkloadManagementNetworkEnabled | undefined>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Managed Resource Group configuration properties.
     */
    managedResourceGroupConfiguration?: pulumi.Input<inputs.managednetworkfabric.ManagedResourceGroupConfigurationArgs | undefined>;
    /**
     ...
     * Network Fabric Controller SKU.
     */
    nfcSku?: pulumi.Input<string | enums.managednetworkfabric.NfcSku | undefined>;
    /**
     ...
     * As part of an update, the workload ExpressRoute CircuitID should be provided to create and Provision a NFC. This Express route is dedicated for Workload services. (This is a Mandatory attribute).
     */
    workloadExpressRouteConnections?: pulumi.Input<pulumi.Input<inputs.managednetworkfabric.ExpressRouteConnectionInformationArgs>[] | undefined>;
}
