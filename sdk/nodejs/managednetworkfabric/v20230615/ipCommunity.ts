...
export class IpCommunity extends pulumi.CustomResource {
     ...
     */
    public readonly ipCommunityRules!: pulumi.Output<outputs.managednetworkfabric.v20230615.IpCommunityRuleResponse[]>;
    /**
    ...
    constructor(name: string, args: IpCommunityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric/v20230201preview:IpCommunity" }, { type: "azure-native:managednetworkfabric:IpCommunity" }] };
...
export interface IpCommunityArgs {
     ...
     * List of IP Community Rules.
     */
    ipCommunityRules: pulumi.Input<pulumi.Input<inputs.managednetworkfabric.v20230615.IpCommunityRuleArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
