...
export class AccessControlList extends pulumi.CustomResource {
     ...
     */
    public readonly matchConfigurations!: pulumi.Output<outputs.managednetworkfabric.v20230615.AccessControlListMatchConfigurationResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: AccessControlListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric/v20230201preview:AccessControlList" }, { type: "azure-native:managednetworkfabric:AccessControlList" }] };
...
export interface AccessControlListArgs {
     ...
     * List of match configurations.
     */
    matchConfigurations?: pulumi.Input<pulumi.Input<inputs.managednetworkfabric.v20230615.AccessControlListMatchConfigurationArgs>[]>;
    /**
