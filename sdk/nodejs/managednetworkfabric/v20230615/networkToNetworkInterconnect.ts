...
export class NetworkToNetworkInterconnect extends pulumi.CustomResource {
     ...
     */
    public readonly exportRoutePolicy!: pulumi.Output<outputs.managednetworkfabric.v20230615.ExportRoutePolicyInformationResponse | undefined>;
    /**
     * Import Route Policy configuration.
     */
    public readonly importRoutePolicy!: pulumi.Output<outputs.managednetworkfabric.v20230615.ImportRoutePolicyInformationResponse | undefined>;
    /**
     ...
     */
    public readonly layer2Configuration!: pulumi.Output<outputs.managednetworkfabric.v20230615.Layer2ConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly npbStaticRouteConfiguration!: pulumi.Output<outputs.managednetworkfabric.v20230615.NpbStaticRouteConfigurationResponse | undefined>;
    /**
     * Common properties for Layer3Configuration.
     */
    public readonly optionBLayer3Configuration!: pulumi.Output<outputs.managednetworkfabric.v20230615.NetworkToNetworkInterconnectPropertiesResponseOptionBLayer3Configuration | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkToNetworkInterconnectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["layer2Configuration"] = args ? (args.layer2Configuration ? pulumi.output(args.layer2Configuration).apply(inputs.managednetworkfabric.v20230615.layer2ConfigurationArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["npbStaticRouteConfiguration"] = args ? (args.npbStaticRouteConfiguration ? pulumi.output(args.npbStaticRouteConfiguration).apply(inputs.managednetworkfabric.v20230615.npbStaticRouteConfigurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric/v20230201preview:NetworkToNetworkInterconnect" }, { type: "azure-native:managednetworkfabric:NetworkToNetworkInterconnect" }] };
...
export interface NetworkToNetworkInterconnectArgs {
     ...
     * Export Route Policy configuration.
     */
    exportRoutePolicy?: pulumi.Input<inputs.managednetworkfabric.v20230615.ExportRoutePolicyInformationArgs>;
    /**
     * Import Route Policy configuration.
     */
    importRoutePolicy?: pulumi.Input<inputs.managednetworkfabric.v20230615.ImportRoutePolicyInformationArgs>;
    /**
     * Ingress Acl. ARM resource ID of Access Control Lists.
     */
     ...
     * Configuration to use NNI for Infrastructure Management. Example: True/False.
     */
    isManagementType?: pulumi.Input<string | enums.managednetworkfabric.v20230615.IsManagementType>;
    /**
     * Common properties for Layer2 Configuration.
     */
    layer2Configuration?: pulumi.Input<inputs.managednetworkfabric.v20230615.Layer2ConfigurationArgs>;
    /**
     ...
     * Type of NNI used. Example: CE | NPB
     */
    nniType?: pulumi.Input<string | enums.managednetworkfabric.v20230615.NniType>;
    /**
     * NPB Static Route Configuration properties.
     */
    npbStaticRouteConfiguration?: pulumi.Input<inputs.managednetworkfabric.v20230615.NpbStaticRouteConfigurationArgs>;
    /**
     * Common properties for Layer3Configuration.
     */
    optionBLayer3Configuration?: pulumi.Input<inputs.managednetworkfabric.v20230615.NetworkToNetworkInterconnectPropertiesOptionBLayer3ConfigurationArgs>;
    /**
     ...
     * Based on this option layer3 parameters are mandatory. Example: True/False
     */
    useOptionB: pulumi.Input<string | enums.managednetworkfabric.v20230615.BooleanEnumProperty>;
}
