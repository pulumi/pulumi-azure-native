...
export class IpExtendedCommunity extends pulumi.CustomResource {
     ...
     */
    public readonly ipExtendedCommunityRules!: pulumi.Output<outputs.managednetworkfabric.v20230615.IpExtendedCommunityRuleResponse[]>;
    /**
    ...
    constructor(name: string, args: IpExtendedCommunityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric/v20230201preview:IpExtendedCommunity" }, { type: "azure-native:managednetworkfabric:IpExtendedCommunity" }] };
