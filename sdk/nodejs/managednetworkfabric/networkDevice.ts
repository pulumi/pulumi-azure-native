...
export class NetworkDevice extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric/v20230201preview:NetworkDevice" }, { type: "azure-native:managednetworkfabric/v20230615:NetworkDevice" }, { type: "azure-native:managednetworkfabric/v20240215preview:NetworkDevice" }, { type: "azure-native:managednetworkfabric/v20240615preview:NetworkDevice" }, { type: "azure-native:managednetworkfabric/v20250715:NetworkDevice" }] };
