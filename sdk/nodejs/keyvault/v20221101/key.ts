 ...
 * The key resource.
 *
 * @deprecated azure-native:keyvault/v20221101:Key is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:Key to guarantee forwards compatibility.
 */
export class Key extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20221101:Key';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.keyvault.v20221101.KeyAttributesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly releasePolicy!: pulumi.Output<outputs.keyvault.v20221101.KeyReleasePolicyResponse | undefined>;
    /**
     * Key rotation policy in response. It will be used for both output and input. Omitted if empty
     */
    public /*out*/ readonly rotationPolicy!: pulumi.Output<outputs.keyvault.v20221101.RotationPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: KeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.keyvault.v20221101.keyPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface KeyArgs {
     ...
     */
    properties: pulumi.Input<inputs.keyvault.v20221101.KeyPropertiesArgs>;
    /**
