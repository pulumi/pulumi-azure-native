 ...
 *
 * @deprecated azure-native:keyvault/v20221101:Secret is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:Secret to guarantee forwards compatibility.
 */
export class Secret extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Secret {
        pulumi.log.warn("Secret is deprecated: azure-native:keyvault/v20221101:Secret is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:Secret to guarantee forwards compatibility.")
        return new Secret(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20221101:Secret';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.keyvault.v20221101.SecretPropertiesResponse>;
    /**
...
export interface SecretArgs {
     ...
     * Properties of the secret
     */
    properties: pulumi.Input<inputs.keyvault.v20221101.SecretPropertiesArgs>;
    /**
