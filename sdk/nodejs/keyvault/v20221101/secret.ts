 ...
 *
 * @deprecated azure-native:keyvault/v20221101:Secret is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:Secret to guarantee forwards compatibility.
 */
export class Secret extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Secret {
        pulumi.log.warn("Secret is deprecated: azure-native:keyvault/v20221101:Secret is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:Secret to guarantee forwards compatibility.")
