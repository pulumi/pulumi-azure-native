...
// Export enums:
export * from "../../types/enums/keyvault/v20241201preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:keyvault/v20241201preview:Key":
                return new Key(name, <any>undefined, { urn })
            case "azure-native:keyvault/v20241201preview:MHSMPrivateEndpointConnection":
                return new MHSMPrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:keyvault/v20241201preview:ManagedHsm":
                return new ManagedHsm(name, <any>undefined, { urn })
            case "azure-native:keyvault/v20241201preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:keyvault/v20241201preview:Secret":
                return new Secret(name, <any>undefined, { urn })
            case "azure-native:keyvault/v20241201preview:Vault":
...
pulumi.runtime.registerResourceModule("azure-native", "keyvault/v20241201preview", _module)
