...
export class Vault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20241201preview:Vault';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.keyvault.v20241201preview.VaultPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.keyvault.v20241201preview.vaultPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface VaultArgs {
     ...
     * Properties of the vault
     */
    properties: pulumi.Input<inputs.keyvault.v20241201preview.VaultPropertiesArgs>;
    /**
