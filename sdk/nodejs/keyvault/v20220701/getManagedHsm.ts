...
export function getManagedHsm(args: GetManagedHsmArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedHsmResult> {
    pulumi.log.warn("getManagedHsm is deprecated: azure-native:keyvault/v20220701:ManagedHsm is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:keyvault/v20220701:getManagedHsm", {
        "name": args.name,
...
export interface GetManagedHsmResult {
     ...
     */
    readonly properties: outputs.keyvault.v20220701.ManagedHsmPropertiesResponse;
    /**
     * SKU details
     */
