...
export class Vault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20200401preview:Vault';
    ...
    constructor(name: string, args: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:keyvault/v20200401preview:Vault" }, { type: "azure-native:keyvault:Vault" }, { type: "azure-nextgen:keyvault:Vault" }, { type: "azure-native:keyvault/latest:Vault" }, { type: "azure-nextgen:keyvault/latest:Vault" }, { type: "azure-native:keyvault/v20150601:Vault" }, { type: "azure-nextgen:keyvault/v20150601:Vault" }, { type: "azure-native:keyvault/v20161001:Vault" }, { type: "azure-nextgen:keyvault/v20161001:Vault" }, { type: "azure-native:keyvault/v20180214:Vault" }, { type: "azure-nextgen:keyvault/v20180214:Vault" }, { type: "azure-native:keyvault/v20180214preview:Vault" }, { type: "azure-nextgen:keyvault/v20180214preview:Vault" }, { type: "azure-native:keyvault/v20190901:Vault" }, { type: "azure-nextgen:keyvault/v20190901:Vault" }] };
