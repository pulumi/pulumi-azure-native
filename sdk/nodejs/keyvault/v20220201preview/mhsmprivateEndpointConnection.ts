...
export class MHSMPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20220201preview:MHSMPrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.keyvault.v20220201preview.MHSMPrivateEndpointResponse | undefined>;
    /**
     * Approval state of the private link connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.keyvault.v20220201preview.MHSMPrivateLinkServiceConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: MHSMPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:keyvault:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20210401preview:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20210601preview:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20211001:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20211101preview:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20220701:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20221101:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20230201:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20230701:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20240401preview:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20241101:MHSMPrivateEndpointConnection" }, { type: "azure-native:keyvault/v20241201preview:MHSMPrivateEndpointConnection" }] };
...
export interface MHSMPrivateEndpointConnectionArgs {
     ...
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.keyvault.v20220201preview.MHSMPrivateLinkServiceConnectionStateArgs>;
    /**
