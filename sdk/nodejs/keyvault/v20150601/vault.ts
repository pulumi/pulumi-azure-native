...
export class Vault extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:keyvault/latest:Vault" }, { type: "azurerm:keyvault/v20161001:Vault" }, { type: "azurerm:keyvault/v20180214:Vault" }, { type: "azurerm:keyvault/v20190901:Vault" }] };
