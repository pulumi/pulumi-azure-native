...
export class Vault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:keyvault/v20150601:Vault';
    ...
    constructor(name: string, argsOrState?: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:keyvault/latest:Vault" }, { type: "azurerm:keyvault/preview:Vault" }, { type: "azurerm:keyvault/v20161001:Vault" }, { type: "azurerm:keyvault/v20180214:Vault" }, { type: "azurerm:keyvault/v20180214preview:Vault" }, { type: "azurerm:keyvault/v20190901:Vault" }, { type: "azurerm:keyvault/v20200401preview:Vault" }] };
