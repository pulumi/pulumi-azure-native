 ...
 * The key resource.
 *
 * @deprecated azure-native:keyvault/v20211101preview:Key is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:Key to guarantee forwards compatibility.
 */
export class Key extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Key {
        pulumi.log.warn("Key is deprecated: azure-native:keyvault/v20211101preview:Key is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:Key to guarantee forwards compatibility.")
        return new Key(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20211101preview:Key';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.keyvault.v20211101preview.KeyAttributesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly releasePolicy!: pulumi.Output<outputs.keyvault.v20211101preview.KeyReleasePolicyResponse | undefined>;
    /**
     * Key rotation policy in response. It will be used for both output and input. Omitted if empty
     */
    public /*out*/ readonly rotationPolicy!: pulumi.Output<outputs.keyvault.v20211101preview.RotationPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: KeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.keyvault.v20211101preview.keyPropertiesArgsProvideDefaults) : undefined) : undefined;
