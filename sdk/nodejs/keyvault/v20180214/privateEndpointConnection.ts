 ...
 *
 * const privateEndpointConnection = new azurerm.keyvault.v20180214.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:keyvault/latest:PrivateEndpointConnection" }, { type: "azurerm:keyvault/v20190901:PrivateEndpointConnection" }, { type: "azurerm:keyvault/v20200401preview:PrivateEndpointConnection" }] };
