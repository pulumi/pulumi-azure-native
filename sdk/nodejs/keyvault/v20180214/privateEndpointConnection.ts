...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20180214:PrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.keyvault.v20180214.PrivateEndpointResponse | undefined>;
    /**
     * Approval state of the private link connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.keyvault.v20180214.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:keyvault/v20180214:PrivateEndpointConnection" }, { type: "azure-native:keyvault:PrivateEndpointConnection" }, { type: "azure-nextgen:keyvault:PrivateEndpointConnection" }, { type: "azure-native:keyvault/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:keyvault/latest:PrivateEndpointConnection" }, { type: "azure-native:keyvault/v20190901:PrivateEndpointConnection" }, { type: "azure-nextgen:keyvault/v20190901:PrivateEndpointConnection" }, { type: "azure-native:keyvault/v20200401preview:PrivateEndpointConnection" }, { type: "azure-nextgen:keyvault/v20200401preview:PrivateEndpointConnection" }] };
