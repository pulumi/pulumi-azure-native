...
export class ManagedHsm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20210401preview:ManagedHsm';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.keyvault.v20210401preview.ManagedHsmPropertiesResponse>;
    /**
     * SKU details
     */
    ...
    constructor(name: string, args: ManagedHsmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.keyvault.v20210401preview.managedHsmPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:keyvault:ManagedHsm" }, { type: "azure-native:keyvault/v20200401preview:ManagedHsm" }, { type: "azure-native:keyvault/v20210601preview:ManagedHsm" }, { type: "azure-native:keyvault/v20211001:ManagedHsm" }, { type: "azure-native:keyvault/v20211101preview:ManagedHsm" }, { type: "azure-native:keyvault/v20220701:ManagedHsm" }] };
