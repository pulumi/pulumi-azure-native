...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:keyvault/preview:PrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.keyvault.preview.PrivateEndpointResponse | undefined>;
    /**
     * Approval state of the private link connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.keyvault.preview.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:keyvault/latest:PrivateEndpointConnection" }, { type: "azurerm:keyvault/v20180214:PrivateEndpointConnection" }, { type: "azurerm:keyvault/v20190901:PrivateEndpointConnection" }, { type: "azurerm:keyvault/v20200401preview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Approval state of the private link connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.keyvault.preview.PrivateLinkServiceConnectionState>;
    /**
     * Provisioning state of the private endpoint connection.
     */
