...
export class ManagedHsm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:keyvault:ManagedHsm';
    ...
    constructor(name: string, args: ManagedHsmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:keyvault/v20200401preview:ManagedHsm" }] };
...
export interface ManagedHsmArgs {
     ...
     * Properties of the managed HSM
     */
    readonly properties?: pulumi.Input<inputs.keyvault.ManagedHsmProperties>;
    /**
