...
export class Key extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:keyvault/v20190901:Key" }, { type: "azure-native:keyvault:Key" }, { type: "azure-nextgen:keyvault:Key" }, { type: "azure-native:keyvault/latest:Key" }, { type: "azure-nextgen:keyvault/latest:Key" }] };
