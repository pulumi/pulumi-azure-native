 ...
 *
 * const key = new azure_native.keyvault.v20190901.Key("key", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:keyvault/v20190901:Key sample-key-name /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/sample-group/providers/Microsoft.KeyVault/vaults/sample-vault-name/keys/sample-key-name 
 * ```
 */
export class Key extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20190901:Key';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.keyvault.v20190901.KeyAttributesResponse | undefined>;
    /**
...
export interface KeyArgs {
     ...
     */
    properties: pulumi.Input<inputs.keyvault.v20190901.KeyPropertiesArgs>;
    /**
