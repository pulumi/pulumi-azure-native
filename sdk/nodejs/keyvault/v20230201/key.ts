...
export class Key extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.keyvault.v20230201.KeyAttributesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly releasePolicy!: pulumi.Output<outputs.keyvault.v20230201.KeyReleasePolicyResponse | undefined>;
    /**
     * Key rotation policy in response. It will be used for both output and input. Omitted if empty
     */
    public /*out*/ readonly rotationPolicy!: pulumi.Output<outputs.keyvault.v20230201.RotationPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: KeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.keyvault.v20230201.keyPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:keyvault:Key" }, { type: "azure-native:keyvault/v20190901:Key" }, { type: "azure-native:keyvault/v20210601preview:Key" }] };
...
export interface KeyArgs {
     ...
     */
    properties: pulumi.Input<inputs.keyvault.v20230201.KeyPropertiesArgs>;
    /**
