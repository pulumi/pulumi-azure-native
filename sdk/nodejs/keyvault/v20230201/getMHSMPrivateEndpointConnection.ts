...
export interface GetMHSMPrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: outputs.keyvault.v20230201.MHSMPrivateEndpointResponse;
    /**
     * Approval state of the private link connection.
     */
    readonly privateLinkServiceConnectionState?: outputs.keyvault.v20230201.MHSMPrivateLinkServiceConnectionStateResponse;
    /**
     ...
     * SKU details
     */
    readonly sku?: outputs.keyvault.v20230201.ManagedHsmSkuResponse;
    /**
     * Metadata pertaining to creation and last modification of the key vault resource.
     */
    readonly systemData: outputs.keyvault.v20230201.SystemDataResponse;
    /**
     * Resource tags
     */
...
export function getMHSMPrivateEndpointConnectionOutput(args: GetMHSMPrivateEndpointConnectionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMHSMPrivateEndpointConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:keyvault/v20230201:getMHSMPrivateEndpointConnection", {
        "name": args.name,
        "privateEndpointConnectionName": args.privateEndpointConnectionName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
