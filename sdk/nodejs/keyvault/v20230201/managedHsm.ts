...
export class ManagedHsm extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.keyvault.v20230201.ManagedHsmPropertiesResponse>;
    /**
     * SKU details
     */
    public readonly sku!: pulumi.Output<outputs.keyvault.v20230201.ManagedHsmSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ManagedHsmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.keyvault.v20230201.managedHsmPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:keyvault/v20200401preview:ManagedHsm" }, { type: "azure-native:keyvault/v20210401preview:ManagedHsm" }, { type: "azure-native:keyvault/v20210601preview:ManagedHsm" }, { type: "azure-native:keyvault/v20211001:ManagedHsm" }, { type: "azure-native:keyvault/v20211101preview:ManagedHsm" }, { type: "azure-native:keyvault/v20220201preview:ManagedHsm" }, { type: "azure-native:keyvault/v20220701:ManagedHsm" }, { type: "azure-native:keyvault/v20221101:ManagedHsm" }, { type: "azure-native:keyvault/v20230701:ManagedHsm" }, { type: "azure-native:keyvault/v20240401preview:ManagedHsm" }, { type: "azure-native:keyvault/v20241101:ManagedHsm" }, { type: "azure-native:keyvault/v20241201preview:ManagedHsm" }, { type: "azure-native:keyvault:ManagedHsm" }] };
