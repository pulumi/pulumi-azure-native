 ...
 *
 * const privateEndpointConnection = new azure_native.keyvault.v20230201.PrivateEndpointConnection("privateEndpointConnection", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:keyvault/v20230201:PrivateEndpointConnection sample-pec /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/sample-group/providers/Microsoft.KeyVault/vaults/sample-vault/privateEndpointConnections/sample-pec 
 * ```
 */
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.keyvault.v20230201.PrivateEndpointResponse | undefined>;
    /**
     * Approval state of the private link connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.keyvault.v20230201.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Approval state of the private link connection.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.keyvault.v20230201.PrivateLinkServiceConnectionStateArgs>;
    /**
