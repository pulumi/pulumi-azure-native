...
export class Vault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20240401preview:Vault';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.keyvault.v20240401preview.VaultPropertiesResponse>;
    /**
     * System metadata for the key vault.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.keyvault.v20240401preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.keyvault.v20240401preview.vaultPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface VaultArgs {
     ...
     * Properties of the vault
     */
    properties: pulumi.Input<inputs.keyvault.v20240401preview.VaultPropertiesArgs>;
    /**
