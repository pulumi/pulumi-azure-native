...
export class Key extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20240401preview:Key';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.keyvault.v20240401preview.KeyAttributesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly releasePolicy!: pulumi.Output<outputs.keyvault.v20240401preview.KeyReleasePolicyResponse | undefined>;
    /**
     * Key rotation policy in response. It will be used for both output and input. Omitted if empty
     */
    public /*out*/ readonly rotationPolicy!: pulumi.Output<outputs.keyvault.v20240401preview.RotationPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: KeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.keyvault.v20240401preview.keyPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface KeyArgs {
     ...
     */
    properties: pulumi.Input<inputs.keyvault.v20240401preview.KeyPropertiesArgs>;
    /**
