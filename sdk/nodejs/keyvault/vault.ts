...
export class Vault extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:keyvault/v20190901:Vault" }, { type: "azure-native:keyvault/v20210601preview:Vault" }, { type: "azure-native:keyvault/v20230201:Vault" }] };
