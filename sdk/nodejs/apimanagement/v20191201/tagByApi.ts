...
export class TagByApi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20191201:TagByApi';
    ...
    constructor(name: string, args: TagByApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:TagByApi" }, { type: "azure-nextgen:apimanagement/latest:TagByApi" }, { type: "azure-nextgen:apimanagement/v20170301:TagByApi" }, { type: "azure-nextgen:apimanagement/v20180101:TagByApi" }, { type: "azure-nextgen:apimanagement/v20180601preview:TagByApi" }, { type: "azure-nextgen:apimanagement/v20190101:TagByApi" }, { type: "azure-nextgen:apimanagement/v20191201preview:TagByApi" }, { type: "azure-nextgen:apimanagement/v20200601preview:TagByApi" }] };
