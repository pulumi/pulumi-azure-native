...
export class ContentType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20191201:ContentType';
    ...
    constructor(name: string, args: ContentTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:ContentType" }, { type: "azure-nextgen:apimanagement/latest:ContentType" }, { type: "azure-nextgen:apimanagement/v20200601preview:ContentType" }] };
