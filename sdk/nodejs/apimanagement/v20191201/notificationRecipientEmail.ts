 ...
 *
 * @deprecated azure-native:apimanagement/v20191201:NotificationRecipientEmail is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NotificationRecipientEmail to guarantee forwards compatibility.
 */
export class NotificationRecipientEmail extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotificationRecipientEmail {
        pulumi.log.warn("NotificationRecipientEmail is deprecated: azure-native:apimanagement/v20191201:NotificationRecipientEmail is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NotificationRecipientEmail to guarantee forwards compatibility.")
