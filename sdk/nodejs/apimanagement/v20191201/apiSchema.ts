...
export class ApiSchema extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiSchema" }, { type: "azurerm:apimanagement/v20170301:ApiSchema" }, { type: "azurerm:apimanagement/v20180101:ApiSchema" }, { type: "azurerm:apimanagement/v20190101:ApiSchema" }] };
