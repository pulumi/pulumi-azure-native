 ...
 * Api details.
 *
 * @deprecated azure-native:apimanagement/v20191201:GatewayApiEntityTag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayApiEntityTag to guarantee forwards compatibility.
 */
export class GatewayApiEntityTag extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayApiEntityTag {
        pulumi.log.warn("GatewayApiEntityTag is deprecated: azure-native:apimanagement/v20191201:GatewayApiEntityTag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayApiEntityTag to guarantee forwards compatibility.")
        return new GatewayApiEntityTag(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20191201:GatewayApiEntityTag';
...
export interface GatewayApiEntityTagArgs {
     ...
     * Provisioning state.
     */
    provisioningState?: pulumi.Input<enums.apimanagement.v20191201.ProvisioningState>;
    /**
