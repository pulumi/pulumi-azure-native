...
export class IdentityProvider extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IdentityProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:IdentityProvider" }, { type: "azurerm:apimanagement/v20160707:IdentityProvider" }, { type: "azurerm:apimanagement/v20161010:IdentityProvider" }, { type: "azurerm:apimanagement/v20170301:IdentityProvider" }, { type: "azurerm:apimanagement/v20180101:IdentityProvider" }, { type: "azurerm:apimanagement/v20180601preview:IdentityProvider" }, { type: "azurerm:apimanagement/v20190101:IdentityProvider" }, { type: "azurerm:apimanagement/v20191201preview:IdentityProvider" }] };
