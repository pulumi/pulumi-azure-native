 ...
 */
/** @deprecated azure-native:apimanagement/v20191201:ApiOperationPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiOperationPolicy to guarantee forwards compatibility. */
export function getApiOperationPolicy(args: GetApiOperationPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetApiOperationPolicyResult> {
    pulumi.log.warn("getApiOperationPolicy is deprecated: azure-native:apimanagement/v20191201:ApiOperationPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiOperationPolicy to guarantee forwards compatibility.")
