...
export class Gateway extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:Gateway" }, { type: "azurerm:apimanagement/preview:Gateway" }, { type: "azurerm:apimanagement/v20191201preview:Gateway" }] };
