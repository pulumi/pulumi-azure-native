 ...
 * Cache details.
 *
 * @deprecated azure-native:apimanagement/v20191201:Cache is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20191201preview:Cache to guarantee forwards compatibility.
 */
export class Cache extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Cache {
        pulumi.log.warn("Cache is deprecated: azure-native:apimanagement/v20191201:Cache is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20191201preview:Cache to guarantee forwards compatibility.")
