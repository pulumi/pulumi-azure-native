...
export class NamedValue extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NamedValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:NamedValue" }, { type: "azurerm:apimanagement/preview:NamedValue" }, { type: "azurerm:apimanagement/v20191201preview:NamedValue" }] };
