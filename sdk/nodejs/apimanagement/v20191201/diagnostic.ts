...
export class Diagnostic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20191201:Diagnostic';
    ...
    constructor(name: string, args: DiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:Diagnostic" }, { type: "azurerm:apimanagement/preview:Diagnostic" }, { type: "azurerm:apimanagement/v20170301:Diagnostic" }, { type: "azurerm:apimanagement/v20180101:Diagnostic" }, { type: "azurerm:apimanagement/v20180601preview:Diagnostic" }, { type: "azurerm:apimanagement/v20190101:Diagnostic" }, { type: "azurerm:apimanagement/v20191201preview:Diagnostic" }] };
