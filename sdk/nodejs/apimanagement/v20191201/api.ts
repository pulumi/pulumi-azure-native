...
export class Api extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:Api" }, { type: "azure-nextgen:apimanagement:Api" }, { type: "azure-native:apimanagement/latest:Api" }, { type: "azure-nextgen:apimanagement/latest:Api" }, { type: "azure-native:apimanagement/v20160707:Api" }, { type: "azure-nextgen:apimanagement/v20160707:Api" }, { type: "azure-native:apimanagement/v20161010:Api" }, { type: "azure-nextgen:apimanagement/v20161010:Api" }, { type: "azure-native:apimanagement/v20170301:Api" }, { type: "azure-nextgen:apimanagement/v20170301:Api" }, { type: "azure-native:apimanagement/v20180101:Api" }, { type: "azure-nextgen:apimanagement/v20180101:Api" }, { type: "azure-native:apimanagement/v20180601preview:Api" }, { type: "azure-nextgen:apimanagement/v20180601preview:Api" }, { type: "azure-native:apimanagement/v20190101:Api" }, { type: "azure-nextgen:apimanagement/v20190101:Api" }, { type: "azure-native:apimanagement/v20191201preview:Api" }, { type: "azure-nextgen:apimanagement/v20191201preview:Api" }, { type: "azure-native:apimanagement/v20200601preview:Api" }, { type: "azure-nextgen:apimanagement/v20200601preview:Api" }] };
