...
export class ApiOperationPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiOperationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20170301:ApiOperationPolicy" }, { type: "azurerm:apimanagement/v20180101:ApiOperationPolicy" }, { type: "azurerm:apimanagement/v20190101:ApiOperationPolicy" }] };
