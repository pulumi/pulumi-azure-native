 ...
 * Logger details.
 *
 * @deprecated azure-native:apimanagement/v20191201:Logger is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20191201preview:Logger to guarantee forwards compatibility.
 */
export class Logger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Logger {
        pulumi.log.warn("Logger is deprecated: azure-native:apimanagement/v20191201:Logger is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20191201preview:Logger to guarantee forwards compatibility.")
