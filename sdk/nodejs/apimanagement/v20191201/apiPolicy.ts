...
export class ApiPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly format!: pulumi.Output<PolicyContentFormat | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, argsOrState?: ApiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20170301:ApiPolicy" }, { type: "azurerm:apimanagement/v20180101:ApiPolicy" }, { type: "azurerm:apimanagement/v20190101:ApiPolicy" }] };
...
export interface ApiPolicyArgs {
     ...
     * Format of the policyContent.
     */
    readonly format?: pulumi.Input<PolicyContentFormat>;
    /**
