...
export class ApiPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiPolicy" }, { type: "azurerm:apimanagement/v20170301:ApiPolicy" }, { type: "azurerm:apimanagement/v20180101:ApiPolicy" }, { type: "azurerm:apimanagement/v20190101:ApiPolicy" }] };
