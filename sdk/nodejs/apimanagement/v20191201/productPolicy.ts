...
export class ProductPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ProductPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20170301:ProductPolicy" }, { type: "azurerm:apimanagement/v20180101:ProductPolicy" }, { type: "azurerm:apimanagement/v20190101:ProductPolicy" }] };
