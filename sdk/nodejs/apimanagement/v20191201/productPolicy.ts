...
export class ProductPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProductPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ProductPolicy" }, { type: "azurerm:apimanagement/preview:ProductPolicy" }, { type: "azurerm:apimanagement/v20170301:ProductPolicy" }, { type: "azurerm:apimanagement/v20180101:ProductPolicy" }, { type: "azurerm:apimanagement/v20180601preview:ProductPolicy" }, { type: "azurerm:apimanagement/v20190101:ProductPolicy" }, { type: "azurerm:apimanagement/v20191201preview:ProductPolicy" }] };
