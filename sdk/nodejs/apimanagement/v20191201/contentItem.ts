...
export class ContentItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20191201:ContentItem';
    ...
    constructor(name: string, args: ContentItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:ContentItem" }, { type: "azure-nextgen:apimanagement/latest:ContentItem" }, { type: "azure-nextgen:apimanagement/v20200601preview:ContentItem" }] };
