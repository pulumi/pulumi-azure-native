...
export function getApiDiagnostic(args: GetApiDiagnosticArgs, opts?: pulumi.InvokeOptions): Promise<GetApiDiagnosticResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20191201:getApiDiagnostic", {
        "apiId": args.apiId,
        "name": args.name,
...
export interface GetApiDiagnosticResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20191201.DiagnosticContractPropertiesResponse;
    /**
