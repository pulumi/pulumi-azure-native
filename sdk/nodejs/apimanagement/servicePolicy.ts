...
export class ServicePolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServicePolicy {
        return new ServicePolicy(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement:ServicePolicy';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.PolicyContractPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: ServicePolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServicePolicy.__pulumiType, name, inputs, opts);
    }
}
...
export interface ServicePolicyArgs {
     ...
     * Properties of the Policy.
     */
    readonly properties?: pulumi.Input<inputs.apimanagement.PolicyContractProperties>;
    /**
