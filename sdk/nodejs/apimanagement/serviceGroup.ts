...
export class ServiceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement:ServiceGroup';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.GroupContractPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceGroup.__pulumiType, name, inputs, opts);
    }
}
...
export interface ServiceGroupArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.apimanagement.GroupCreateParametersProperties>;
    /**
