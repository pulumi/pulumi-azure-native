...
export class ApiManagementService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement:ApiManagementService';
...
export interface ApiManagementServiceArgs {
     ...
     * Properties of the API Management service.
     */
    readonly properties: pulumi.Input<inputs.apimanagement.ApiManagementServiceProperties>;
    /**
