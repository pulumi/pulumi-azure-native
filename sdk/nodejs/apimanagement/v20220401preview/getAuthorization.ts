...
export function getAuthorization(args: GetAuthorizationArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationResult> {
    pulumi.log.warn("getAuthorization is deprecated: azure-native:apimanagement/v20220401preview:Authorization is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Authorization to guarantee forwards compatibility.")
