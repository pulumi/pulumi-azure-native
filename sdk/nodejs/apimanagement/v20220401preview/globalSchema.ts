...
export class GlobalSchema extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GlobalSchema {
        pulumi.log.warn("GlobalSchema is deprecated: azure-native:apimanagement/v20220401preview:GlobalSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GlobalSchema to guarantee forwards compatibility.")
