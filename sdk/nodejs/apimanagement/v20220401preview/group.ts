...
export class Group extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Group {
        pulumi.log.warn("Group is deprecated: azure-native:apimanagement/v20220401preview:Group is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Group to guarantee forwards compatibility.")
