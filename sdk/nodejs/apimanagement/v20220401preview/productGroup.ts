 ...
 * Contract details.
 *
 * @deprecated azure-native:apimanagement/v20220401preview:ProductGroup is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ProductGroup to guarantee forwards compatibility.
 */
export class ProductGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProductGroup {
        pulumi.log.warn("ProductGroup is deprecated: azure-native:apimanagement/v20220401preview:ProductGroup is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ProductGroup to guarantee forwards compatibility.")
        return new ProductGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:ProductGroup';
