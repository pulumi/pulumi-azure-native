 ...
 *
 * @deprecated azure-native:apimanagement/v20220401preview:Authorization is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Authorization to guarantee forwards compatibility.
 */
export class Authorization extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Authorization {
        pulumi.log.warn("Authorization is deprecated: azure-native:apimanagement/v20220401preview:Authorization is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Authorization to guarantee forwards compatibility.")
        return new Authorization(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:Authorization';
     ...
     */
    public readonly error!: pulumi.Output<outputs.apimanagement.v20220401preview.AuthorizationErrorResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220801:Authorization" }] };
...
export interface AuthorizationArgs {
     ...
     * Authorization type options
     */
    authorizationType?: pulumi.Input<string | enums.apimanagement.v20220401preview.AuthorizationType>;
    /**
     * Authorization error details.
     */
    error?: pulumi.Input<inputs.apimanagement.v20220401preview.AuthorizationErrorArgs>;
    /**
     * OAuth2 grant type options
     */
    oAuth2GrantType?: pulumi.Input<string | enums.apimanagement.v20220401preview.OAuth2GrantType>;
    /**
     * Authorization parameters
     */
