...
export class Authorization extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Authorization {
        pulumi.log.warn("Authorization is deprecated: azure-native:apimanagement/v20220401preview:Authorization is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Authorization to guarantee forwards compatibility.")
