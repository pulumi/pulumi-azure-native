...
export class ApiManagementService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiManagementService {
        pulumi.log.warn("ApiManagementService is deprecated: azure-native:apimanagement/v20220401preview:ApiManagementService is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiManagementService to guarantee forwards compatibility.")
