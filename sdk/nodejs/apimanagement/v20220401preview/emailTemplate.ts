...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:EmailTemplate';
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.apimanagement.v20220401preview.EmailTemplateParametersContractPropertiesResponse[] | undefined>;
    /**
...
export interface EmailTemplateArgs {
     ...
     * Email Template Parameter values.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.EmailTemplateParametersContractPropertiesArgs>[]>;
    /**
