 ...
 *
 * @deprecated azure-native:apimanagement/v20220401preview:Tag is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Tag to guarantee forwards compatibility.
 */
export class Tag extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Tag {
        pulumi.log.warn("Tag is deprecated: azure-native:apimanagement/v20220401preview:Tag is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Tag to guarantee forwards compatibility.")
        return new Tag(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:Tag';
