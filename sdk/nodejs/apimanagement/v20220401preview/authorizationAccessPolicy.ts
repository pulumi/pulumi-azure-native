 ...
 *
 * @deprecated azure-native:apimanagement/v20220401preview:AuthorizationAccessPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:AuthorizationAccessPolicy to guarantee forwards compatibility.
 */
export class AuthorizationAccessPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AuthorizationAccessPolicy {
        pulumi.log.warn("AuthorizationAccessPolicy is deprecated: azure-native:apimanagement/v20220401preview:AuthorizationAccessPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:AuthorizationAccessPolicy to guarantee forwards compatibility.")
        return new AuthorizationAccessPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:AuthorizationAccessPolicy';
