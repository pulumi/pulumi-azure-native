 ...
 * User details.
 *
 * @deprecated azure-native:apimanagement/v20220401preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:User to guarantee forwards compatibility.
 */
export class User extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): User {
        pulumi.log.warn("User is deprecated: azure-native:apimanagement/v20220401preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:User to guarantee forwards compatibility.")
        return new User(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:User';
     ...
     */
    public /*out*/ readonly groups!: pulumi.Output<outputs.apimanagement.v20220401preview.GroupContractPropertiesResponse[]>;
    /**
     * Collection of user identities.
     */
    public readonly identities!: pulumi.Output<outputs.apimanagement.v20220401preview.UserIdentityContractResponse[] | undefined>;
    /**
     * Last name.
     */
...
export interface UserArgs {
     ...
     */
    appType?: pulumi.Input<string | enums.apimanagement.v20220401preview.AppType>;
    /**
     * Determines the type of confirmation e-mail that will be sent to the newly created user.
     */
    confirmation?: pulumi.Input<string | enums.apimanagement.v20220401preview.Confirmation>;
    /**
     ...
     * Collection of user identities.
     */
    identities?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20220401preview.UserIdentityContractArgs>[]>;
    /**
     * Last name.
     */
     ...
     * Account state. Specifies whether the user is active or not. Blocked users are unable to sign into the developer portal or call any APIs of subscribed products. Default state is Active.
     */
    state?: pulumi.Input<string | enums.apimanagement.v20220401preview.UserState>;
    /**
