...
export class AuthorizationProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AuthorizationProvider {
        pulumi.log.warn("AuthorizationProvider is deprecated: azure-native:apimanagement/v20220401preview:AuthorizationProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:AuthorizationProvider to guarantee forwards compatibility.")
        return new AuthorizationProvider(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:AuthorizationProvider';
     ...
     * OAuth2 settings
     */
    public readonly oauth2!: pulumi.Output<outputs.apimanagement.v20220401preview.AuthorizationProviderOAuth2SettingsResponse | undefined>;
    /**
...
export interface AuthorizationProviderArgs {
     ...
     * OAuth2 settings
     */
    oauth2?: pulumi.Input<inputs.apimanagement.v20220401preview.AuthorizationProviderOAuth2SettingsArgs>;
    /**
