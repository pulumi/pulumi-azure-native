 ...
 */
/** @deprecated azure-native:apimanagement/v20220401preview:AuthorizationProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:AuthorizationProvider to guarantee forwards compatibility. */
export function getAuthorizationProvider(args: GetAuthorizationProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationProviderResult> {
    pulumi.log.warn("getAuthorizationProvider is deprecated: azure-native:apimanagement/v20220401preview:AuthorizationProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:AuthorizationProvider to guarantee forwards compatibility.")
