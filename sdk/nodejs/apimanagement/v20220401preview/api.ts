...
export class Api extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:Api';
     ...
     * Version set details
     */
    public readonly apiVersionSet!: pulumi.Output<outputs.apimanagement.v20220401preview.ApiVersionSetContractDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly authenticationSettings!: pulumi.Output<outputs.apimanagement.v20220401preview.AuthenticationSettingsContractResponse | undefined>;
    /**
     * Contact information for the API.
     */
    public readonly contact!: pulumi.Output<outputs.apimanagement.v20220401preview.ApiContactInformationResponse | undefined>;
    /**
     ...
     */
    public readonly license!: pulumi.Output<outputs.apimanagement.v20220401preview.ApiLicenseInformationResponse | undefined>;
    /**
     ...
     */
    public readonly subscriptionKeyParameterNames!: pulumi.Output<outputs.apimanagement.v20220401preview.SubscriptionKeyParameterNamesContractResponse | undefined>;
    /**
...
export interface ApiArgs {
     ...
     * Type of API.
     */
    apiType?: pulumi.Input<string | enums.apimanagement.v20220401preview.ApiType>;
    /**
     * Indicates the version identifier of the API if the API is versioned
     */
     ...
     * Version set details
     */
    apiVersionSet?: pulumi.Input<inputs.apimanagement.v20220401preview.ApiVersionSetContractDetailsArgs>;
    /**
     * A resource identifier for the related ApiVersionSet.
     */
     ...
     * Collection of authentication settings included into this API.
     */
    authenticationSettings?: pulumi.Input<inputs.apimanagement.v20220401preview.AuthenticationSettingsContractArgs>;
    /**
     * Contact information for the API.
     */
    contact?: pulumi.Input<inputs.apimanagement.v20220401preview.ApiContactInformationArgs>;
    /**
     * Description of the API. May include HTML formatting tags.
     */
     ...
     */
    format?: pulumi.Input<string | enums.apimanagement.v20220401preview.ContentFormat>;
    /**
     * Indicates if API revision is current api revision.
     */
     ...
     * License information for the API.
     */
    license?: pulumi.Input<inputs.apimanagement.v20220401preview.ApiLicenseInformationArgs>;
    /**
     * Relative URL uniquely identifying this API and all of its resource paths within the API Management service instance. It is appended to the API endpoint base URL specified during the service instance creation to form a public URL for this API.
     */
     ...
     * Describes on which protocols the operations in this API can be invoked.
     */
    protocols?: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20220401preview.Protocol>[]>;
    /**
     ...
     */
    soapApiType?: pulumi.Input<string | enums.apimanagement.v20220401preview.SoapApiType>;
    /**
     * API identifier of the source API.
     */
     ...
     * Protocols over which API is made available.
     */
    subscriptionKeyParameterNames?: pulumi.Input<inputs.apimanagement.v20220401preview.SubscriptionKeyParameterNamesContractArgs>;
    /**
     * Specifies whether an API or Product subscription is required for accessing the API.
     */
     ...
     */
    translateRequiredQueryParametersConduct?: pulumi.Input<string | enums.apimanagement.v20220401preview.TranslateRequiredQueryParametersConduct>;
    /**
     ...
     */
    wsdlSelector?: pulumi.Input<inputs.apimanagement.v20220401preview.ApiCreateOrUpdatePropertiesWsdlSelectorArgs>;
}
