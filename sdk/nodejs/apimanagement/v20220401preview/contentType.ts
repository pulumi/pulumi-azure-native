 ...
 *
 * @deprecated azure-native:apimanagement/v20220401preview:ContentType is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ContentType to guarantee forwards compatibility.
 */
export class ContentType extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContentType {
        pulumi.log.warn("ContentType is deprecated: azure-native:apimanagement/v20220401preview:ContentType is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ContentType to guarantee forwards compatibility.")
        return new ContentType(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:ContentType';
