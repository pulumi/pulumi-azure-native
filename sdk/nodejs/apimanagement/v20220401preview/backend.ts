...
export class Backend extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:Backend';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.apimanagement.v20220401preview.BackendCredentialsContractResponse | undefined>;
    /**
     * Backend Description.
     */
     ...
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.v20220401preview.BackendPropertiesResponse>;
    /**
     ...
     */
    public readonly proxy!: pulumi.Output<outputs.apimanagement.v20220401preview.BackendProxyContractResponse | undefined>;
    /**
     ...
     */
    public readonly tls!: pulumi.Output<outputs.apimanagement.v20220401preview.BackendTlsPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: BackendArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["tls"] = args ? (args.tls ? pulumi.output(args.tls).apply(inputs.apimanagement.v20220401preview.backendTlsPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface BackendArgs {
     ...
     * Backend Credentials Contract Properties
     */
    credentials?: pulumi.Input<inputs.apimanagement.v20220401preview.BackendCredentialsContractArgs>;
    /**
     * Backend Description.
     */
     ...
     * Backend Properties contract
     */
    properties?: pulumi.Input<inputs.apimanagement.v20220401preview.BackendPropertiesArgs>;
    /**
     * Backend communication protocol.
     */
    protocol: pulumi.Input<string | enums.apimanagement.v20220401preview.BackendProtocol>;
    /**
     * Backend gateway Contract Properties
     */
    proxy?: pulumi.Input<inputs.apimanagement.v20220401preview.BackendProxyContractArgs>;
    /**
     ...
     * Backend TLS Properties
     */
    tls?: pulumi.Input<inputs.apimanagement.v20220401preview.BackendTlsPropertiesArgs>;
    /**
     * Runtime Url of the Backend.
     */
