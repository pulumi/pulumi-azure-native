...
export class PolicyFragment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:PolicyFragment';
    ...
    constructor(name: string, args: PolicyFragmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:PolicyFragment" }, { type: "azure-native:apimanagement/v20211201preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20220801:PolicyFragment" }, { type: "azure-native:apimanagement/v20220901preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20230301preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20230501preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20230901preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20240501:PolicyFragment" }, { type: "azure-native:apimanagement/v20240601preview:PolicyFragment" }] };
...
export interface PolicyFragmentArgs {
     ...
     * Format of the policy fragment content.
     */
    format?: pulumi.Input<string | enums.apimanagement.v20220401preview.PolicyFragmentContentFormat>;
    /**
