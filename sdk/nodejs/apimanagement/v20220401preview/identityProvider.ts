 ...
 *
 * @deprecated azure-native:apimanagement/v20220401preview:IdentityProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:IdentityProvider to guarantee forwards compatibility.
 */
export class IdentityProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IdentityProvider {
        pulumi.log.warn("IdentityProvider is deprecated: azure-native:apimanagement/v20220401preview:IdentityProvider is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:IdentityProvider to guarantee forwards compatibility.")
