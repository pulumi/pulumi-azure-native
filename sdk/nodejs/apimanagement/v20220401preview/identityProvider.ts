 ...
 *
 * @deprecated azure-native:apimanagement/v20220401preview:IdentityProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:IdentityProvider to guarantee forwards compatibility.
 */
export class IdentityProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IdentityProvider {
        pulumi.log.warn("IdentityProvider is deprecated: azure-native:apimanagement/v20220401preview:IdentityProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:IdentityProvider to guarantee forwards compatibility.")
        return new IdentityProvider(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220401preview:IdentityProvider';
...
export interface IdentityProviderArgs {
     ...
     * Identity Provider Type identifier.
     */
    type?: pulumi.Input<string | enums.apimanagement.v20220401preview.IdentityProviderType>;
}
