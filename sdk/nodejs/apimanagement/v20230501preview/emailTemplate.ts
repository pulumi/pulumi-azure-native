...
export class EmailTemplate extends pulumi.CustomResource {
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.apimanagement.v20230501preview.EmailTemplateParametersContractPropertiesResponse[] | undefined>;
    /**
...
export interface EmailTemplateArgs {
     ...
     * Email Template Parameter values.
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20230501preview.EmailTemplateParametersContractPropertiesArgs>[]>;
    /**
