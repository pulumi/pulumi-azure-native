...
export class WorkspaceGroupUser extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceGroupUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceGroupUser" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceGroupUser" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceGroupUser" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceGroupUser" }] };
