...
export class WorkspaceProductPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceProductPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceProductPolicy" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceProductPolicy" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceProductPolicy" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceProductPolicy" }] };
