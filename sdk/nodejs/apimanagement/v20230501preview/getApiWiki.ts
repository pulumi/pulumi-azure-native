...
export interface GetApiWikiResult {
     ...
     */
    readonly documents?: outputs.apimanagement.v20230501preview.WikiDocumentationContractResponse[];
    /**
...
export function getApiWikiOutput(args: GetApiWikiOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiWikiResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:apimanagement/v20230501preview:getApiWiki", {
        "apiId": args.apiId,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
