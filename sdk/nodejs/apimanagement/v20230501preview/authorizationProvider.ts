...
export class AuthorizationProvider extends pulumi.CustomResource {
     ...
     * OAuth2 settings
     */
    public readonly oauth2!: pulumi.Output<outputs.apimanagement.v20230501preview.AuthorizationProviderOAuth2SettingsResponse | undefined>;
    /**
...
export interface AuthorizationProviderArgs {
     ...
     * OAuth2 settings
     */
    oauth2?: pulumi.Input<inputs.apimanagement.v20230501preview.AuthorizationProviderOAuth2SettingsArgs>;
    /**
