...
export class NamedValue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement:NamedValue';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.NamedValueContractPropertiesResponse>;
    /**
...
export interface NamedValueArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.apimanagement.NamedValueCreateContractProperties>;
    /**
