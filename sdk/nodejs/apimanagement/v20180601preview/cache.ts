...
export class Cache extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:Cache" }, { type: "azurerm:apimanagement/preview:Cache" }, { type: "azurerm:apimanagement/v20190101:Cache" }, { type: "azurerm:apimanagement/v20191201:Cache" }, { type: "azurerm:apimanagement/v20191201preview:Cache" }] };
