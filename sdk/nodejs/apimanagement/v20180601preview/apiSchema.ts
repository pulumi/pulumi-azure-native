 ...
 *
 * const apiSchema = new azurerm.apimanagement.v20180601preview.ApiSchema("apiSchema", {
...
export class ApiSchema extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20180601preview:ApiSchema';
    ...
    constructor(name: string, args: ApiSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiSchema" }, { type: "azurerm:apimanagement/v20170301:ApiSchema" }, { type: "azurerm:apimanagement/v20180101:ApiSchema" }, { type: "azurerm:apimanagement/v20190101:ApiSchema" }, { type: "azurerm:apimanagement/v20191201:ApiSchema" }, { type: "azurerm:apimanagement/v20191201preview:ApiSchema" }] };
