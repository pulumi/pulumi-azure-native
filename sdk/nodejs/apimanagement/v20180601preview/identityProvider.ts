 ...
 *
 * const identityProvider = new azurerm.apimanagement.v20180601preview.IdentityProvider("identityProvider", {
 *     clientId: "facebookid",
...
export class IdentityProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20180601preview:IdentityProvider';
    ...
    constructor(name: string, args: IdentityProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:IdentityProvider" }, { type: "azurerm:apimanagement/v20160707:IdentityProvider" }, { type: "azurerm:apimanagement/v20161010:IdentityProvider" }, { type: "azurerm:apimanagement/v20170301:IdentityProvider" }, { type: "azurerm:apimanagement/v20180101:IdentityProvider" }, { type: "azurerm:apimanagement/v20190101:IdentityProvider" }, { type: "azurerm:apimanagement/v20191201:IdentityProvider" }, { type: "azurerm:apimanagement/v20191201preview:IdentityProvider" }] };
