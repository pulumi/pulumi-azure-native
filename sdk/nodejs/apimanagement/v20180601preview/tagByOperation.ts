 ...
 *
 * @deprecated azure-native:apimanagement/v20180601preview:TagByOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.
 */
export class TagByOperation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TagByOperation {
        pulumi.log.warn("TagByOperation is deprecated: azure-native:apimanagement/v20180601preview:TagByOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.")
