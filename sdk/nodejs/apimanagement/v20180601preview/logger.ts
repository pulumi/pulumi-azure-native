 ...
 *
 * const logger = new azurerm.apimanagement.v20180601preview.Logger("logger", {
 *     credentials: {
...
export class Logger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20180601preview:Logger';
