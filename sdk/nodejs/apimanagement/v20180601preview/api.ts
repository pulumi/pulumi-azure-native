...
export class Api extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20160707:Api" }, { type: "azure-native:apimanagement/v20161010:Api" }, { type: "azure-native:apimanagement/v20170301:Api" }, { type: "azure-native:apimanagement/v20180101:Api" }, { type: "azure-native:apimanagement/v20190101:Api" }, { type: "azure-native:apimanagement/v20191201:Api" }, { type: "azure-native:apimanagement/v20191201preview:Api" }, { type: "azure-native:apimanagement/v20200601preview:Api" }, { type: "azure-native:apimanagement/v20201201:Api" }, { type: "azure-native:apimanagement/v20210101preview:Api" }, { type: "azure-native:apimanagement/v20210401preview:Api" }, { type: "azure-native:apimanagement/v20210801:Api" }, { type: "azure-native:apimanagement/v20211201preview:Api" }, { type: "azure-native:apimanagement/v20220401preview:Api" }, { type: "azure-native:apimanagement/v20220801:Api" }, { type: "azure-native:apimanagement/v20220901preview:Api" }, { type: "azure-native:apimanagement/v20230301preview:Api" }, { type: "azure-native:apimanagement/v20230501preview:Api" }, { type: "azure-native:apimanagement/v20230901preview:Api" }, { type: "azure-native:apimanagement/v20240501:Api" }, { type: "azure-native:apimanagement/v20240601preview:Api" }, { type: "azure-native:apimanagement:Api" }] };
...
export interface ApiArgs {
     ...
     * Type of API.
     */
    apiType?: pulumi.Input<string | enums.apimanagement.v20180601preview.ApiType>;
    /**
     * Indicates the Version identifier of the API if the API is versioned
     */
     ...
     * An API Version Set contains the common configuration for a set of API Versions relating 
     */
    apiVersionSet?: pulumi.Input<inputs.apimanagement.v20180601preview.ApiVersionSetContractDetailsArgs>;
    /**
     * A resource identifier for the related ApiVersionSet.
     */
     ...
     * Collection of authentication settings included into this API.
     */
    authenticationSettings?: pulumi.Input<inputs.apimanagement.v20180601preview.AuthenticationSettingsContractArgs>;
    /**
     * Format of the Content in which the API is getting imported.
     */
    contentFormat?: pulumi.Input<string | enums.apimanagement.v20180601preview.ContentFormat>;
    /**
     ...
     * Describes on which protocols the operations in this API can be invoked.
     */
    protocols?: pulumi.Input<pulumi.Input<enums.apimanagement.v20180601preview.Protocol>[]>;
    /**
     ...
     */
    soapApiType?: pulumi.Input<string | enums.apimanagement.v20180601preview.SoapApiType>;
    /**
     * Protocols over which API is made available.
     */
    subscriptionKeyParameterNames?: pulumi.Input<inputs.apimanagement.v20180601preview.SubscriptionKeyParameterNamesContractArgs>;
    /**
     * Specifies whether an API or Product subscription is required for accessing the API.
     */
     ...
     */
    wsdlSelector?: pulumi.Input<inputs.apimanagement.v20180601preview.ApiCreateOrUpdatePropertiesWsdlSelectorArgs>;
}
