...
export class ProductGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProductGroup {
        pulumi.log.warn("ProductGroup is deprecated: azure-native:apimanagement/v20180601preview:ProductGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ProductGroup to guarantee forwards compatibility.")
