 ...
 *
 * const apiPolicy = new azurerm.apimanagement.v20180601preview.ApiPolicy("apiPolicy", {
...
export class ApiPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20180601preview:ApiPolicy';
    ...
    constructor(name: string, args: ApiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiPolicy" }, { type: "azurerm:apimanagement/v20170301:ApiPolicy" }, { type: "azurerm:apimanagement/v20180101:ApiPolicy" }, { type: "azurerm:apimanagement/v20190101:ApiPolicy" }, { type: "azurerm:apimanagement/v20191201:ApiPolicy" }, { type: "azurerm:apimanagement/v20191201preview:ApiPolicy" }] };
