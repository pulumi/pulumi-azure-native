 ...
 *
 * const diagnostic = new azurerm.apimanagement.v20180601preview.Diagnostic("diagnostic", {
 *     alwaysLog: "allErrors",
 *     backend: {
 *         request: {
 *             body: {
...
export class Diagnostic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20180601preview:Diagnostic';
