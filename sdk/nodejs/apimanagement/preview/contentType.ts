...
export class ContentType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/preview:ContentType';
    ...
    constructor(name: string, argsOrState?: ContentTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ContentType" }, { type: "azurerm:apimanagement/v20191201:ContentType" }] };
