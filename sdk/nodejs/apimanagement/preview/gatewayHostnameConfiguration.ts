...
export class GatewayHostnameConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/preview:GatewayHostnameConfiguration';
    ...
    constructor(name: string, argsOrState?: GatewayHostnameConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:GatewayHostnameConfiguration" }, { type: "azurerm:apimanagement/v20191201:GatewayHostnameConfiguration" }, { type: "azurerm:apimanagement/v20191201preview:GatewayHostnameConfiguration" }] };
