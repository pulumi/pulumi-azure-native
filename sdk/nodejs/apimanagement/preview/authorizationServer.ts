...
export class AuthorizationServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/preview:AuthorizationServer';
     ...
     */
    public readonly tokenBodyParameters!: pulumi.Output<outputs.apimanagement.preview.TokenBodyParameterContractResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AuthorizationServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:AuthorizationServer" }, { type: "azurerm:apimanagement/v20160707:AuthorizationServer" }, { type: "azurerm:apimanagement/v20161010:AuthorizationServer" }, { type: "azurerm:apimanagement/v20170301:AuthorizationServer" }, { type: "azurerm:apimanagement/v20180101:AuthorizationServer" }, { type: "azurerm:apimanagement/v20180601preview:AuthorizationServer" }, { type: "azurerm:apimanagement/v20190101:AuthorizationServer" }, { type: "azurerm:apimanagement/v20191201:AuthorizationServer" }, { type: "azurerm:apimanagement/v20191201preview:AuthorizationServer" }] };
...
export interface AuthorizationServerArgs {
     ...
     * Additional parameters required by the token endpoint of this authorization server represented as an array of JSON objects with name and value string properties, i.e. {"name" : "name value", "value": "a value"}.
     */
    readonly tokenBodyParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.preview.TokenBodyParameterContract>[]>;
    /**
     * OAuth token endpoint. Contains absolute URI to entity being referenced.
     */
