...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/preview:EmailTemplate';
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.apimanagement.preview.EmailTemplateParametersContractPropertiesResponse[] | undefined>;
    /**
...
export interface EmailTemplateArgs {
     ...
     * Email Template Parameter values.
     */
    readonly parameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.preview.EmailTemplateParametersContractProperties>[]>;
    /**
