...
export class ApiOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/preview:ApiOperation';
     ...
     */
    public readonly request!: pulumi.Output<outputs.apimanagement.preview.RequestContractResponse | undefined>;
    /**
     * Array of Operation responses.
     */
    public readonly responses!: pulumi.Output<outputs.apimanagement.preview.ResponseContractResponse[] | undefined>;
    /**
     * Collection of URL template parameters.
     */
    public readonly templateParameters!: pulumi.Output<outputs.apimanagement.preview.ParameterContractResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ApiOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiOperation" }, { type: "azurerm:apimanagement/v20160707:ApiOperation" }, { type: "azurerm:apimanagement/v20161010:ApiOperation" }, { type: "azurerm:apimanagement/v20170301:ApiOperation" }, { type: "azurerm:apimanagement/v20180101:ApiOperation" }, { type: "azurerm:apimanagement/v20180601preview:ApiOperation" }, { type: "azurerm:apimanagement/v20190101:ApiOperation" }, { type: "azurerm:apimanagement/v20191201:ApiOperation" }, { type: "azurerm:apimanagement/v20191201preview:ApiOperation" }] };
...
export interface ApiOperationArgs {
     ...
     * An entity containing request details.
     */
    readonly request?: pulumi.Input<inputs.apimanagement.preview.RequestContract>;
    /**
     ...
     * Array of Operation responses.
     */
    readonly responses?: pulumi.Input<pulumi.Input<inputs.apimanagement.preview.ResponseContract>[]>;
    /**
     ...
     * Collection of URL template parameters.
     */
    readonly templateParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.preview.ParameterContract>[]>;
    /**
     * Relative URL template identifying the target resource for this operation. May include parameters. Example: /customers/{cid}/orders/{oid}/?date={date}
     */
