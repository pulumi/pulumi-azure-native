...
export function getEmailTemplate(args: GetEmailTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetEmailTemplateResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/preview:getEmailTemplate", {
...
export interface GetEmailTemplateResult {
     ...
     */
    readonly parameters?: outputs.apimanagement.preview.EmailTemplateParametersContractPropertiesResponse[];
    /**
