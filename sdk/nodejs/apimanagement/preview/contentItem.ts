...
export class ContentItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/preview:ContentItem';
    ...
    constructor(name: string, argsOrState?: ContentItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ContentItem" }, { type: "azurerm:apimanagement/v20191201:ContentItem" }] };
