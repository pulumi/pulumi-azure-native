...
export class GatewayApiEntityTag extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GatewayApiEntityTagArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/latest:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/latest:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20191201:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/v20191201:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20191201preview:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/v20191201preview:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20200601preview:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/v20200601preview:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20201201:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/v20201201:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20210101preview:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/v20210101preview:GatewayApiEntityTag" }] };
...
export interface GatewayApiEntityTagArgs {
     ...
     * Provisioning state.
     */
    readonly provisioningState?: pulumi.Input<enums.apimanagement.ProvisioningState>;
    /**
