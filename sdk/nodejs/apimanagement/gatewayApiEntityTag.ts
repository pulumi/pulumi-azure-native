...
export class GatewayApiEntityTag extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GatewayApiEntityTagArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20191201preview:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20201201:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20210401preview:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20211201preview:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20220801:GatewayApiEntityTag" }, { type: "azure-native:apimanagement/v20220901preview:GatewayApiEntityTag" }] };
