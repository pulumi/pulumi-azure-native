...
export class Api extends pulumi.CustomResource {
     ...
     * Version set details
     */
    public readonly apiVersionSet!: pulumi.Output<outputs.apimanagement.v20201201.ApiVersionSetContractDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly authenticationSettings!: pulumi.Output<outputs.apimanagement.v20201201.AuthenticationSettingsContractResponse | undefined>;
    /**
     ...
     */
    public readonly subscriptionKeyParameterNames!: pulumi.Output<outputs.apimanagement.v20201201.SubscriptionKeyParameterNamesContractResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20201201:Api" }, { type: "azure-native:apimanagement:Api" }, { type: "azure-nextgen:apimanagement:Api" }, { type: "azure-native:apimanagement/v20160707:Api" }, { type: "azure-nextgen:apimanagement/v20160707:Api" }, { type: "azure-native:apimanagement/v20161010:Api" }, { type: "azure-nextgen:apimanagement/v20161010:Api" }, { type: "azure-native:apimanagement/v20170301:Api" }, { type: "azure-nextgen:apimanagement/v20170301:Api" }, { type: "azure-native:apimanagement/v20180101:Api" }, { type: "azure-nextgen:apimanagement/v20180101:Api" }, { type: "azure-native:apimanagement/v20180601preview:Api" }, { type: "azure-nextgen:apimanagement/v20180601preview:Api" }, { type: "azure-native:apimanagement/v20190101:Api" }, { type: "azure-nextgen:apimanagement/v20190101:Api" }, { type: "azure-native:apimanagement/v20191201:Api" }, { type: "azure-nextgen:apimanagement/v20191201:Api" }, { type: "azure-native:apimanagement/v20191201preview:Api" }, { type: "azure-nextgen:apimanagement/v20191201preview:Api" }, { type: "azure-native:apimanagement/v20200601preview:Api" }, { type: "azure-nextgen:apimanagement/v20200601preview:Api" }, { type: "azure-native:apimanagement/v20210101preview:Api" }, { type: "azure-nextgen:apimanagement/v20210101preview:Api" }, { type: "azure-native:apimanagement/v20210401preview:Api" }, { type: "azure-nextgen:apimanagement/v20210401preview:Api" }, { type: "azure-native:apimanagement/v20210801:Api" }, { type: "azure-nextgen:apimanagement/v20210801:Api" }] };
...
export interface ApiArgs {
     ...
     * Type of API.
     */
    apiType?: pulumi.Input<string | enums.apimanagement.v20201201.ApiType>;
    /**
     * Indicates the Version identifier of the API if the API is versioned
     */
     ...
     * Version set details
     */
    apiVersionSet?: pulumi.Input<inputs.apimanagement.v20201201.ApiVersionSetContractDetailsArgs>;
    /**
     * A resource identifier for the related ApiVersionSet.
     */
     ...
     * Collection of authentication settings included into this API.
     */
    authenticationSettings?: pulumi.Input<inputs.apimanagement.v20201201.AuthenticationSettingsContractArgs>;
    /**
     * Description of the API. May include HTML formatting tags.
     */
     ...
     */
    format?: pulumi.Input<string | enums.apimanagement.v20201201.ContentFormat>;
    /**
     * Indicates if API revision is current api revision.
     */
     ...
     * Describes on which protocols the operations in this API can be invoked.
     */
    protocols?: pulumi.Input<pulumi.Input<enums.apimanagement.v20201201.Protocol>[]>;
    /**
     ...
     */
    soapApiType?: pulumi.Input<string | enums.apimanagement.v20201201.SoapApiType>;
    /**
     * API identifier of the source API.
     */
     ...
     * Protocols over which API is made available.
     */
    subscriptionKeyParameterNames?: pulumi.Input<inputs.apimanagement.v20201201.SubscriptionKeyParameterNamesContractArgs>;
    /**
     * Specifies whether an API or Product subscription is required for accessing the API.
     */
     ...
     */
    wsdlSelector?: pulumi.Input<inputs.apimanagement.v20201201.ApiCreateOrUpdatePropertiesWsdlSelectorArgs>;
}
