...
export class GatewayHostnameConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20201201:GatewayHostnameConfiguration';
    ...
    constructor(name: string, args: GatewayHostnameConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20201201:GatewayHostnameConfiguration" }, { type: "azure-native:apimanagement:GatewayHostnameConfiguration" }, { type: "azure-nextgen:apimanagement:GatewayHostnameConfiguration" }, { type: "azure-native:apimanagement/latest:GatewayHostnameConfiguration" }, { type: "azure-nextgen:apimanagement/latest:GatewayHostnameConfiguration" }, { type: "azure-native:apimanagement/v20191201:GatewayHostnameConfiguration" }, { type: "azure-nextgen:apimanagement/v20191201:GatewayHostnameConfiguration" }, { type: "azure-native:apimanagement/v20191201preview:GatewayHostnameConfiguration" }, { type: "azure-nextgen:apimanagement/v20191201preview:GatewayHostnameConfiguration" }, { type: "azure-native:apimanagement/v20200601preview:GatewayHostnameConfiguration" }, { type: "azure-nextgen:apimanagement/v20200601preview:GatewayHostnameConfiguration" }, { type: "azure-native:apimanagement/v20210101preview:GatewayHostnameConfiguration" }, { type: "azure-nextgen:apimanagement/v20210101preview:GatewayHostnameConfiguration" }] };
