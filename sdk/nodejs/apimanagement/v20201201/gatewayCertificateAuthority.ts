...
export class GatewayCertificateAuthority extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GatewayCertificateAuthorityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20201201:GatewayCertificateAuthority" }, { type: "azure-native:apimanagement:GatewayCertificateAuthority" }, { type: "azure-nextgen:apimanagement:GatewayCertificateAuthority" }, { type: "azure-native:apimanagement/v20200601preview:GatewayCertificateAuthority" }, { type: "azure-nextgen:apimanagement/v20200601preview:GatewayCertificateAuthority" }, { type: "azure-native:apimanagement/v20210101preview:GatewayCertificateAuthority" }, { type: "azure-nextgen:apimanagement/v20210101preview:GatewayCertificateAuthority" }, { type: "azure-native:apimanagement/v20210401preview:GatewayCertificateAuthority" }, { type: "azure-nextgen:apimanagement/v20210401preview:GatewayCertificateAuthority" }] };
