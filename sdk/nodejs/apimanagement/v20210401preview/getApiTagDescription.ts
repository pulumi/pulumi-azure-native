...
export function getApiTagDescription(args: GetApiTagDescriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetApiTagDescriptionResult> {
    pulumi.log.warn("getApiTagDescription is deprecated: azure-native:apimanagement/v20210401preview:ApiTagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiTagDescription to guarantee forwards compatibility.")
