 ...
 *
 * const schema = new azure_native.apimanagement.v20210401preview.Schema("schema", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:apimanagement/v20210401preview:Schema schema1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/schemas/schema1 
 * ```
 */
export class Schema extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:Schema" }, { type: "azure-native:apimanagement/v20210801:Schema" }, { type: "azure-native:apimanagement/v20211201preview:Schema" }, { type: "azure-native:apimanagement/v20220401preview:Schema" }, { type: "azure-native:apimanagement/v20220801:Schema" }] };
