 ...
 * Contract details.
 *
 * @deprecated azure-native:apimanagement/v20210401preview:ApiTagDescription is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiTagDescription to guarantee forwards compatibility.
 */
export class ApiTagDescription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiTagDescription {
        pulumi.log.warn("ApiTagDescription is deprecated: azure-native:apimanagement/v20210401preview:ApiTagDescription is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiTagDescription to guarantee forwards compatibility.")
