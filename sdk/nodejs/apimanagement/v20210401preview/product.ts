 ...
 * Product details.
 *
 * @deprecated azure-native:apimanagement/v20210401preview:Product is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Product to guarantee forwards compatibility.
 */
export class Product extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Product {
        pulumi.log.warn("Product is deprecated: azure-native:apimanagement/v20210401preview:Product is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Product to guarantee forwards compatibility.")
