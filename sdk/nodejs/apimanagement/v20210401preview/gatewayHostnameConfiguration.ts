 ...
 *
 * @deprecated azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayHostnameConfiguration to guarantee forwards compatibility.
 */
export class GatewayHostnameConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayHostnameConfiguration {
        pulumi.log.warn("GatewayHostnameConfiguration is deprecated: azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayHostnameConfiguration to guarantee forwards compatibility.")
        return new GatewayHostnameConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration';
