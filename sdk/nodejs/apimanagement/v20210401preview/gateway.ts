...
export class Gateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Gateway {
        pulumi.log.warn("Gateway is deprecated: azure-native:apimanagement/v20210401preview:Gateway is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Gateway to guarantee forwards compatibility.")
