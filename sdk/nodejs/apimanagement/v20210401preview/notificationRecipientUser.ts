...
export class NotificationRecipientUser extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotificationRecipientUser {
        pulumi.log.warn("NotificationRecipientUser is deprecated: azure-native:apimanagement/v20210401preview:NotificationRecipientUser is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:NotificationRecipientUser to guarantee forwards compatibility.")
