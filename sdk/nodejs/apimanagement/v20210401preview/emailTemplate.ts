...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EmailTemplate {
        pulumi.log.warn("EmailTemplate is deprecated: azure-native:apimanagement/v20210401preview:EmailTemplate is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:EmailTemplate to guarantee forwards compatibility.")
