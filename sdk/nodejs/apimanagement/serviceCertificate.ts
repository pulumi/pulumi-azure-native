...
export class ServiceCertificate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceCertificate {
        return new ServiceCertificate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement:ServiceCertificate';
    ...
    constructor(name: string, argsOrState?: ServiceCertificateArgs, opts?: pulumi.CustomResourceOptions) {
