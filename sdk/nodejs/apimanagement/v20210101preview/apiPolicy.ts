...
export class ApiPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiPolicy {
        pulumi.log.warn("ApiPolicy is deprecated: azure-native:apimanagement/v20210101preview:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiPolicy to guarantee forwards compatibility.")
