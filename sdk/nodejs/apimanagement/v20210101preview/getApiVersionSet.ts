...
export function getApiVersionSet(args: GetApiVersionSetArgs, opts?: pulumi.InvokeOptions): Promise<GetApiVersionSetResult> {
    pulumi.log.warn("getApiVersionSet is deprecated: azure-native:apimanagement/v20210101preview:ApiVersionSet is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiVersionSet to guarantee forwards compatibility.")
