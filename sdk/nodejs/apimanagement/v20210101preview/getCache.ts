...
export function getCache(args: GetCacheArgs, opts?: pulumi.InvokeOptions): Promise<GetCacheResult> {
    pulumi.log.warn("getCache is deprecated: azure-native:apimanagement/v20210101preview:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Cache to guarantee forwards compatibility.")
