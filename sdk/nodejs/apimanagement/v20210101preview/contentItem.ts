...
export class ContentItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ContentItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20210101preview:ContentItem" }, { type: "azure-native:apimanagement:ContentItem" }, { type: "azure-nextgen:apimanagement:ContentItem" }, { type: "azure-native:apimanagement/v20191201:ContentItem" }, { type: "azure-nextgen:apimanagement/v20191201:ContentItem" }, { type: "azure-native:apimanagement/v20200601preview:ContentItem" }, { type: "azure-nextgen:apimanagement/v20200601preview:ContentItem" }, { type: "azure-native:apimanagement/v20201201:ContentItem" }, { type: "azure-nextgen:apimanagement/v20201201:ContentItem" }, { type: "azure-native:apimanagement/v20210401preview:ContentItem" }, { type: "azure-nextgen:apimanagement/v20210401preview:ContentItem" }] };
