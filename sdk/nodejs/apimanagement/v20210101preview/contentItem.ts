...
export class ContentItem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContentItem {
        pulumi.log.warn("ContentItem is deprecated: azure-native:apimanagement/v20210101preview:ContentItem is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ContentItem to guarantee forwards compatibility.")
