...
export class Product extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20210101preview:Product';
    ...
    constructor(name: string, args: ProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20210101preview:Product" }, { type: "azure-native:apimanagement:Product" }, { type: "azure-nextgen:apimanagement:Product" }, { type: "azure-native:apimanagement/v20160707:Product" }, { type: "azure-nextgen:apimanagement/v20160707:Product" }, { type: "azure-native:apimanagement/v20161010:Product" }, { type: "azure-nextgen:apimanagement/v20161010:Product" }, { type: "azure-native:apimanagement/v20170301:Product" }, { type: "azure-nextgen:apimanagement/v20170301:Product" }, { type: "azure-native:apimanagement/v20180101:Product" }, { type: "azure-nextgen:apimanagement/v20180101:Product" }, { type: "azure-native:apimanagement/v20180601preview:Product" }, { type: "azure-nextgen:apimanagement/v20180601preview:Product" }, { type: "azure-native:apimanagement/v20190101:Product" }, { type: "azure-nextgen:apimanagement/v20190101:Product" }, { type: "azure-native:apimanagement/v20191201:Product" }, { type: "azure-nextgen:apimanagement/v20191201:Product" }, { type: "azure-native:apimanagement/v20191201preview:Product" }, { type: "azure-nextgen:apimanagement/v20191201preview:Product" }, { type: "azure-native:apimanagement/v20200601preview:Product" }, { type: "azure-nextgen:apimanagement/v20200601preview:Product" }, { type: "azure-native:apimanagement/v20201201:Product" }, { type: "azure-nextgen:apimanagement/v20201201:Product" }, { type: "azure-native:apimanagement/v20210401preview:Product" }, { type: "azure-nextgen:apimanagement/v20210401preview:Product" }, { type: "azure-native:apimanagement/v20210801:Product" }, { type: "azure-nextgen:apimanagement/v20210801:Product" }] };
...
export interface ProductArgs {
     ...
     * whether product is published or not. Published products are discoverable by users of developer portal. Non published products are visible only to administrators. Default state of Product is notPublished.
     */
    state?: pulumi.Input<enums.apimanagement.v20210101preview.ProductState>;
    /**
     * Whether a product subscription is required for accessing APIs included in this product. If true, the product is referred to as "protected" and a valid subscription key is required for a request to an API included in the product to succeed. If false, the product is referred to as "open" and requests to an API included in the product can be made without a subscription key. If property is omitted when creating a new product it's value is assumed to be true.
     */
