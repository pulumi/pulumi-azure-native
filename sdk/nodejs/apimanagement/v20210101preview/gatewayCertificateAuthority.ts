...
export class GatewayCertificateAuthority extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayCertificateAuthority {
        pulumi.log.warn("GatewayCertificateAuthority is deprecated: azure-native:apimanagement/v20210101preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GatewayCertificateAuthority to guarantee forwards compatibility.")
