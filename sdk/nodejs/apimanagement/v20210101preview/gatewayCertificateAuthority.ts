 ...
 *
 * @deprecated azure-native:apimanagement/v20210101preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayCertificateAuthority to guarantee forwards compatibility.
 */
export class GatewayCertificateAuthority extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayCertificateAuthority {
        pulumi.log.warn("GatewayCertificateAuthority is deprecated: azure-native:apimanagement/v20210101preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayCertificateAuthority to guarantee forwards compatibility.")
