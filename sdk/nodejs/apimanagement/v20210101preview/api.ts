...
export class Api extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20210101preview:Api';
     ...
     * Version set details
     */
    public readonly apiVersionSet!: pulumi.Output<outputs.apimanagement.v20210101preview.ApiVersionSetContractDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly authenticationSettings!: pulumi.Output<outputs.apimanagement.v20210101preview.AuthenticationSettingsContractResponse | undefined>;
    /**
     * Contact information for the API.
     */
    public readonly contact!: pulumi.Output<outputs.apimanagement.v20210101preview.ApiContactInformationResponse | undefined>;
    /**
     ...
     */
    public readonly license!: pulumi.Output<outputs.apimanagement.v20210101preview.ApiLicenseInformationResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly subscriptionKeyParameterNames!: pulumi.Output<outputs.apimanagement.v20210101preview.SubscriptionKeyParameterNamesContractResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20210101preview:Api" }, { type: "azure-native:apimanagement:Api" }, { type: "azure-nextgen:apimanagement:Api" }, { type: "azure-native:apimanagement/v20160707:Api" }, { type: "azure-nextgen:apimanagement/v20160707:Api" }, { type: "azure-native:apimanagement/v20161010:Api" }, { type: "azure-nextgen:apimanagement/v20161010:Api" }, { type: "azure-native:apimanagement/v20170301:Api" }, { type: "azure-nextgen:apimanagement/v20170301:Api" }, { type: "azure-native:apimanagement/v20180101:Api" }, { type: "azure-nextgen:apimanagement/v20180101:Api" }, { type: "azure-native:apimanagement/v20180601preview:Api" }, { type: "azure-nextgen:apimanagement/v20180601preview:Api" }, { type: "azure-native:apimanagement/v20190101:Api" }, { type: "azure-nextgen:apimanagement/v20190101:Api" }, { type: "azure-native:apimanagement/v20191201:Api" }, { type: "azure-nextgen:apimanagement/v20191201:Api" }, { type: "azure-native:apimanagement/v20191201preview:Api" }, { type: "azure-nextgen:apimanagement/v20191201preview:Api" }, { type: "azure-native:apimanagement/v20200601preview:Api" }, { type: "azure-nextgen:apimanagement/v20200601preview:Api" }, { type: "azure-native:apimanagement/v20201201:Api" }, { type: "azure-nextgen:apimanagement/v20201201:Api" }, { type: "azure-native:apimanagement/v20210401preview:Api" }, { type: "azure-nextgen:apimanagement/v20210401preview:Api" }, { type: "azure-native:apimanagement/v20210801:Api" }, { type: "azure-nextgen:apimanagement/v20210801:Api" }] };
...
export interface ApiArgs {
     ...
     * Type of API.
     */
    apiType?: pulumi.Input<string | enums.apimanagement.v20210101preview.ApiType>;
    /**
     * Indicates the version identifier of the API if the API is versioned
     */
     ...
     * Version set details
     */
    apiVersionSet?: pulumi.Input<inputs.apimanagement.v20210101preview.ApiVersionSetContractDetailsArgs>;
    /**
     * A resource identifier for the related ApiVersionSet.
     */
     ...
     * Collection of authentication settings included into this API.
     */
    authenticationSettings?: pulumi.Input<inputs.apimanagement.v20210101preview.AuthenticationSettingsContractArgs>;
    /**
     * Contact information for the API.
     */
    contact?: pulumi.Input<inputs.apimanagement.v20210101preview.ApiContactInformationArgs>;
    /**
     * Description of the API. May include HTML formatting tags.
     */
     ...
     */
    format?: pulumi.Input<string | enums.apimanagement.v20210101preview.ContentFormat>;
    /**
     * Indicates if API revision is current api revision.
     */
     ...
     * License information for the API.
     */
    license?: pulumi.Input<inputs.apimanagement.v20210101preview.ApiLicenseInformationArgs>;
    /**
     * Relative URL uniquely identifying this API and all of its resource paths within the API Management service instance. It is appended to the API endpoint base URL specified during the service instance creation to form a public URL for this API.
     */
     ...
     * Describes on which protocols the operations in this API can be invoked.
     */
    protocols?: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20210101preview.Protocol>[]>;
    /**
     ...
     */
    soapApiType?: pulumi.Input<string | enums.apimanagement.v20210101preview.SoapApiType>;
    /**
     * API identifier of the source API.
     */
     ...
     * Protocols over which API is made available.
     */
    subscriptionKeyParameterNames?: pulumi.Input<inputs.apimanagement.v20210101preview.SubscriptionKeyParameterNamesContractArgs>;
    /**
     * Specifies whether an API or Product subscription is required for accessing the API.
     */
     ...
     */
    wsdlSelector?: pulumi.Input<inputs.apimanagement.v20210101preview.ApiCreateOrUpdatePropertiesWsdlSelectorArgs>;
}
