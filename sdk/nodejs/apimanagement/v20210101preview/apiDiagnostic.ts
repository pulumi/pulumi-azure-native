...
export class ApiDiagnostic extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiDiagnostic {
        pulumi.log.warn("ApiDiagnostic is deprecated: azure-native:apimanagement/v20210101preview:ApiDiagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiDiagnostic to guarantee forwards compatibility.")
