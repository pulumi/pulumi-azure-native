 ...
 * User details.
 *
 * @deprecated azure-native:apimanagement/v20210101preview:User is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:User to guarantee forwards compatibility.
 */
export class User extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): User {
        pulumi.log.warn("User is deprecated: azure-native:apimanagement/v20210101preview:User is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:User to guarantee forwards compatibility.")
