 ...
 * Logger details.
 *
 * @deprecated azure-native:apimanagement/v20210101preview:Logger is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Logger to guarantee forwards compatibility.
 */
export class Logger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Logger {
        pulumi.log.warn("Logger is deprecated: azure-native:apimanagement/v20210101preview:Logger is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Logger to guarantee forwards compatibility.")
        return new Logger(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20210101preview:Logger';
...
export interface LoggerArgs {
     ...
     * Logger type.
     */
    loggerType: pulumi.Input<string | enums.apimanagement.v20210101preview.LoggerType>;
    /**
