 ...
 *
 * @deprecated azure-native:apimanagement/v20210101preview:ApiVersionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiVersionSet to guarantee forwards compatibility.
 */
export class ApiVersionSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiVersionSet {
        pulumi.log.warn("ApiVersionSet is deprecated: azure-native:apimanagement/v20210101preview:ApiVersionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiVersionSet to guarantee forwards compatibility.")
        return new ApiVersionSet(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20210101preview:ApiVersionSet';
...
export interface ApiVersionSetArgs {
     ...
     * An value that determines where the API Version identifier will be located in a HTTP request.
     */
    versioningScheme: pulumi.Input<string | enums.apimanagement.v20210101preview.VersioningScheme>;
}
