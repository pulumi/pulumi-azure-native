...
export class AuthorizationAccessPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AuthorizationAccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220401preview:AuthorizationAccessPolicy" }, { type: "azure-native:apimanagement/v20220801:AuthorizationAccessPolicy" }] };
