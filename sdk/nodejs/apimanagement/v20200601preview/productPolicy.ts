...
export class ProductPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20200601preview:ProductPolicy';
    ...
    constructor(name: string, args: ProductPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:ProductPolicy" }, { type: "azure-nextgen:apimanagement/latest:ProductPolicy" }, { type: "azure-nextgen:apimanagement/v20170301:ProductPolicy" }, { type: "azure-nextgen:apimanagement/v20180101:ProductPolicy" }, { type: "azure-nextgen:apimanagement/v20180601preview:ProductPolicy" }, { type: "azure-nextgen:apimanagement/v20190101:ProductPolicy" }, { type: "azure-nextgen:apimanagement/v20191201:ProductPolicy" }, { type: "azure-nextgen:apimanagement/v20191201preview:ProductPolicy" }] };
