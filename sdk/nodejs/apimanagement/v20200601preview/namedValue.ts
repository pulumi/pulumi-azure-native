...
export class NamedValue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20200601preview:NamedValue';
     ...
     */
    public readonly keyVault!: pulumi.Output<outputs.apimanagement.v20200601preview.KeyVaultContractPropertiesResponse | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: NamedValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20200601preview:NamedValue" }, { type: "azure-native:apimanagement:NamedValue" }, { type: "azure-nextgen:apimanagement:NamedValue" }, { type: "azure-native:apimanagement/v20191201:NamedValue" }, { type: "azure-nextgen:apimanagement/v20191201:NamedValue" }, { type: "azure-native:apimanagement/v20191201preview:NamedValue" }, { type: "azure-nextgen:apimanagement/v20191201preview:NamedValue" }, { type: "azure-native:apimanagement/v20201201:NamedValue" }, { type: "azure-nextgen:apimanagement/v20201201:NamedValue" }, { type: "azure-native:apimanagement/v20210101preview:NamedValue" }, { type: "azure-nextgen:apimanagement/v20210101preview:NamedValue" }, { type: "azure-native:apimanagement/v20210401preview:NamedValue" }, { type: "azure-nextgen:apimanagement/v20210401preview:NamedValue" }, { type: "azure-native:apimanagement/v20210801:NamedValue" }, { type: "azure-nextgen:apimanagement/v20210801:NamedValue" }] };
...
export interface NamedValueArgs {
     ...
     * KeyVault location details of the namedValue.
     */
    keyVault?: pulumi.Input<inputs.apimanagement.v20200601preview.KeyVaultContractCreatePropertiesArgs>;
    /**
