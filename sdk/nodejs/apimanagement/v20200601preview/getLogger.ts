 ...
 */
/** @deprecated azure-native:apimanagement/v20200601preview:Logger is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Logger to guarantee forwards compatibility. */
export function getLogger(args: GetLoggerArgs, opts?: pulumi.InvokeOptions): Promise<GetLoggerResult> {
    pulumi.log.warn("getLogger is deprecated: azure-native:apimanagement/v20200601preview:Logger is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Logger to guarantee forwards compatibility.")
