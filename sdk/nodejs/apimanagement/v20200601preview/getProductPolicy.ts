...
export function getProductPolicy(args: GetProductPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetProductPolicyResult> {
    pulumi.log.warn("getProductPolicy is deprecated: azure-native:apimanagement/v20200601preview:ProductPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ProductPolicy to guarantee forwards compatibility.")
