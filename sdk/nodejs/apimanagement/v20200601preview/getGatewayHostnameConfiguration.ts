 ...
 */
/** @deprecated azure-native:apimanagement/v20200601preview:GatewayHostnameConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GatewayHostnameConfiguration to guarantee forwards compatibility. */
export function getGatewayHostnameConfiguration(args: GetGatewayHostnameConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayHostnameConfigurationResult> {
    pulumi.log.warn("getGatewayHostnameConfiguration is deprecated: azure-native:apimanagement/v20200601preview:GatewayHostnameConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GatewayHostnameConfiguration to guarantee forwards compatibility.")
