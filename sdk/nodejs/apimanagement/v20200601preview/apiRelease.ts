 ...
 * ApiRelease details.
 *
 * @deprecated azure-native:apimanagement/v20200601preview:ApiRelease is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiRelease to guarantee forwards compatibility.
 */
export class ApiRelease extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiRelease {
        pulumi.log.warn("ApiRelease is deprecated: azure-native:apimanagement/v20200601preview:ApiRelease is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiRelease to guarantee forwards compatibility.")
