...
export class ApiRelease extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20200601preview:ApiRelease';
    ...
    constructor(name: string, args: ApiReleaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if ((!args || args.releaseId === undefined) && !(opts && opts.urn)) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:ApiRelease" }, { type: "azure-nextgen:apimanagement/latest:ApiRelease" }, { type: "azure-nextgen:apimanagement/v20170301:ApiRelease" }, { type: "azure-nextgen:apimanagement/v20180101:ApiRelease" }, { type: "azure-nextgen:apimanagement/v20180601preview:ApiRelease" }, { type: "azure-nextgen:apimanagement/v20190101:ApiRelease" }, { type: "azure-nextgen:apimanagement/v20191201:ApiRelease" }, { type: "azure-nextgen:apimanagement/v20191201preview:ApiRelease" }] };
