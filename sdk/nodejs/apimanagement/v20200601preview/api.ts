...
export class Api extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20200601preview:Api" }, { type: "azure-native:apimanagement:Api" }, { type: "azure-nextgen:apimanagement:Api" }, { type: "azure-native:apimanagement/latest:Api" }, { type: "azure-nextgen:apimanagement/latest:Api" }, { type: "azure-native:apimanagement/v20160707:Api" }, { type: "azure-nextgen:apimanagement/v20160707:Api" }, { type: "azure-native:apimanagement/v20161010:Api" }, { type: "azure-nextgen:apimanagement/v20161010:Api" }, { type: "azure-native:apimanagement/v20170301:Api" }, { type: "azure-nextgen:apimanagement/v20170301:Api" }, { type: "azure-native:apimanagement/v20180101:Api" }, { type: "azure-nextgen:apimanagement/v20180101:Api" }, { type: "azure-native:apimanagement/v20180601preview:Api" }, { type: "azure-nextgen:apimanagement/v20180601preview:Api" }, { type: "azure-native:apimanagement/v20190101:Api" }, { type: "azure-nextgen:apimanagement/v20190101:Api" }, { type: "azure-native:apimanagement/v20191201:Api" }, { type: "azure-nextgen:apimanagement/v20191201:Api" }, { type: "azure-native:apimanagement/v20191201preview:Api" }, { type: "azure-nextgen:apimanagement/v20191201preview:Api" }, { type: "azure-native:apimanagement/v20201201:Api" }, { type: "azure-nextgen:apimanagement/v20201201:Api" }, { type: "azure-native:apimanagement/v20210101preview:Api" }, { type: "azure-nextgen:apimanagement/v20210101preview:Api" }] };
...
export interface ApiArgs {
     ...
     * Type of API.
     */
    readonly apiType?: pulumi.Input<string | enums.apimanagement.v20200601preview.ApiType>;
    /**
     * Indicates the Version identifier of the API if the API is versioned
     */
     ...
     * Version set details
     */
    readonly apiVersionSet?: pulumi.Input<inputs.apimanagement.v20200601preview.ApiVersionSetContractDetails>;
    /**
     * A resource identifier for the related ApiVersionSet.
     */
     ...
     * Collection of authentication settings included into this API.
     */
    readonly authenticationSettings?: pulumi.Input<inputs.apimanagement.v20200601preview.AuthenticationSettingsContract>;
    /**
     * Description of the API. May include HTML formatting tags.
     */
     ...
     */
    readonly format?: pulumi.Input<string | enums.apimanagement.v20200601preview.ContentFormat>;
    /**
     * Indicates if API revision is current api revision.
     */
     ...
     * Describes on which protocols the operations in this API can be invoked.
     */
    readonly protocols?: pulumi.Input<pulumi.Input<enums.apimanagement.v20200601preview.Protocol>[]>;
    /**
     ...
     */
    readonly soapApiType?: pulumi.Input<string | enums.apimanagement.v20200601preview.SoapApiType>;
    /**
     * API identifier of the source API.
     */
     ...
     * Protocols over which API is made available.
     */
    readonly subscriptionKeyParameterNames?: pulumi.Input<inputs.apimanagement.v20200601preview.SubscriptionKeyParameterNamesContract>;
    /**
     * Specifies whether an API or Product subscription is required for accessing the API.
     */
     ...
     */
    readonly wsdlSelector?: pulumi.Input<inputs.apimanagement.v20200601preview.ApiCreateOrUpdatePropertiesWsdlSelector>;
}
