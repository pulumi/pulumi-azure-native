...
export class ApiSchema extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiSchema {
        pulumi.log.warn("ApiSchema is deprecated: azure-native:apimanagement/v20200601preview:ApiSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiSchema to guarantee forwards compatibility.")
