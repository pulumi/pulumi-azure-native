...
export class GroupUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20200601preview:GroupUser';
    ...
    constructor(name: string, args: GroupUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:GroupUser" }, { type: "azure-nextgen:apimanagement/latest:GroupUser" }, { type: "azure-nextgen:apimanagement/v20170301:GroupUser" }, { type: "azure-nextgen:apimanagement/v20180101:GroupUser" }, { type: "azure-nextgen:apimanagement/v20180601preview:GroupUser" }, { type: "azure-nextgen:apimanagement/v20190101:GroupUser" }, { type: "azure-nextgen:apimanagement/v20191201:GroupUser" }, { type: "azure-nextgen:apimanagement/v20191201preview:GroupUser" }] };
