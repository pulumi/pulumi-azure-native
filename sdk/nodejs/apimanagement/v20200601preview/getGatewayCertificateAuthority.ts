 ...
 */
/** @deprecated azure-native:apimanagement/v20200601preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GatewayCertificateAuthority to guarantee forwards compatibility. */
export function getGatewayCertificateAuthority(args: GetGatewayCertificateAuthorityArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayCertificateAuthorityResult> {
    pulumi.log.warn("getGatewayCertificateAuthority is deprecated: azure-native:apimanagement/v20200601preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GatewayCertificateAuthority to guarantee forwards compatibility.")
