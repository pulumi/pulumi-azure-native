...
export class ApiManagementService extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.v20200601preview.ApiManagementServicePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApiManagementServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.apimanagement.v20200601preview.apiManagementServicePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface ApiManagementServiceArgs {
     ...
     * Properties of the API Management service.
     */
    properties: pulumi.Input<inputs.apimanagement.v20200601preview.ApiManagementServicePropertiesArgs>;
    /**
