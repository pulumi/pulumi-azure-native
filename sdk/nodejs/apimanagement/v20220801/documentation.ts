 ...
 *
 * const documentation = new azure_native.apimanagement.v20220801.Documentation("documentation", {
 *     content: "content",
...
export class Documentation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DocumentationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:Documentation" }] };
