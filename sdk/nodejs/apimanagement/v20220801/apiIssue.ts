...
export interface ApiIssueArgs {
     ...
     * Status of the issue.
     */
    state?: pulumi.Input<string | enums.apimanagement.v20220801.State>;
    /**
     * The issue title.
     */
