 ...
 *
 * const authorization = new azure_native.apimanagement.v20220801.Authorization("authorization", {
...
export class Authorization extends pulumi.CustomResource {
     ...
     */
    public readonly error!: pulumi.Output<outputs.apimanagement.v20220801.AuthorizationErrorResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:Authorization" }, { type: "azure-native:apimanagement/v20220401preview:Authorization" }] };
