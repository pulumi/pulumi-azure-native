 ...
 *
 * const policyFragment = new azure_native.apimanagement.v20220801.PolicyFragment("policyFragment", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:apimanagement/v20220801:PolicyFragment policyFragment1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/policyFragments/policyFragment1 
 * ```
 */
export class PolicyFragment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PolicyFragmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:PolicyFragment" }, { type: "azure-native:apimanagement/v20211201preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20220401preview:PolicyFragment" }] };
...
export interface PolicyFragmentArgs {
     ...
     * Format of the policy fragment content.
     */
    format?: pulumi.Input<string | enums.apimanagement.v20220801.PolicyFragmentContentFormat>;
    /**
