...
export function getLogger(args: GetLoggerArgs, opts?: pulumi.InvokeOptions): Promise<GetLoggerResult> {
    pulumi.log.warn("getLogger is deprecated: azure-native:apimanagement/v20220801:Logger is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Logger to guarantee forwards compatibility.")
