...
export function getAuthorizationProvider(args: GetAuthorizationProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationProviderResult> {
    pulumi.log.warn("getAuthorizationProvider is deprecated: azure-native:apimanagement/v20220801:AuthorizationProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:AuthorizationProvider to guarantee forwards compatibility.")
...
export interface GetAuthorizationProviderResult {
     ...
     * OAuth2 settings
     */
    readonly oauth2?: outputs.apimanagement.v20220801.AuthorizationProviderOAuth2SettingsResponse;
    /**
