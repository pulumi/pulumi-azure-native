...
export function getApiIssueAttachment(args: GetApiIssueAttachmentArgs, opts?: pulumi.InvokeOptions): Promise<GetApiIssueAttachmentResult> {
    pulumi.log.warn("getApiIssueAttachment is deprecated: azure-native:apimanagement/v20190101:ApiIssueAttachment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiIssueAttachment to guarantee forwards compatibility.")
