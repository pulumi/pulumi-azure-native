 ...
 * Api details.
 *
 * @deprecated azure-native:apimanagement/v20190101:ProductApi is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ProductApi to guarantee forwards compatibility.
 */
export class ProductApi extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProductApi {
        pulumi.log.warn("ProductApi is deprecated: azure-native:apimanagement/v20190101:ProductApi is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ProductApi to guarantee forwards compatibility.")
