...
export function getApiOperationPolicy(args: GetApiOperationPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetApiOperationPolicyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20190101:getApiOperationPolicy", {
        "apiId": args.apiId,
        "format": args.format,
        "name": args.name,
...
export interface GetApiOperationPolicyResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20190101.PolicyContractPropertiesResponse;
    /**
