 ...
 *
 * @deprecated azure-native:apimanagement/v20190101:TagByProduct is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByProduct to guarantee forwards compatibility.
 */
export class TagByProduct extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TagByProduct {
        pulumi.log.warn("TagByProduct is deprecated: azure-native:apimanagement/v20190101:TagByProduct is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByProduct to guarantee forwards compatibility.")
