 ...
 *
 * const tagByProduct = new azurerm.apimanagement.v20190101.TagByProduct("tagByProduct", {
...
export class TagByProduct extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TagByProduct {
        return new TagByProduct(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20190101:TagByProduct';
    ...
    constructor(name: string, argsOrState?: TagByProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:TagByProduct" }, { type: "azurerm:apimanagement/v20170301:TagByProduct" }, { type: "azurerm:apimanagement/v20180101:TagByProduct" }, { type: "azurerm:apimanagement/v20180601preview:TagByProduct" }, { type: "azurerm:apimanagement/v20191201:TagByProduct" }, { type: "azurerm:apimanagement/v20191201preview:TagByProduct" }] };
