...
export class Cache extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20190101:Cache';
    ...
    constructor(name: string, args: CacheArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/latest:Cache" }, { type: "azure-nextgen:apimanagement/v20180601preview:Cache" }, { type: "azure-nextgen:apimanagement/v20191201:Cache" }, { type: "azure-nextgen:apimanagement/v20191201preview:Cache" }, { type: "azure-nextgen:apimanagement/v20200601preview:Cache" }] };
