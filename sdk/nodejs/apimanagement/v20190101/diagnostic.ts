 ...
 *
 * const diagnostic = new azurerm.apimanagement.v20190101.Diagnostic("diagnostic", {
 *     alwaysLog: "allErrors",
 *     backend: {
 *         request: {
 *             body: {
...
export class Diagnostic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20190101:Diagnostic';
    ...
    constructor(name: string, argsOrState?: DiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:Diagnostic" }, { type: "azurerm:apimanagement/v20170301:Diagnostic" }, { type: "azurerm:apimanagement/v20180101:Diagnostic" }, { type: "azurerm:apimanagement/v20191201:Diagnostic" }] };
