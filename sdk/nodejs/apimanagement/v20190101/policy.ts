 ...
 *
 * @deprecated azure-native:apimanagement/v20190101:Policy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Policy to guarantee forwards compatibility.
 */
export class Policy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Policy {
        pulumi.log.warn("Policy is deprecated: azure-native:apimanagement/v20190101:Policy is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Policy to guarantee forwards compatibility.")
