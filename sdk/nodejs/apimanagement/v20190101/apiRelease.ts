...
export class ApiRelease extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20190101:ApiRelease';
    ...
    constructor(name: string, argsOrState?: ApiReleaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiRelease" }, { type: "azurerm:apimanagement/v20170301:ApiRelease" }, { type: "azurerm:apimanagement/v20180101:ApiRelease" }, { type: "azurerm:apimanagement/v20191201:ApiRelease" }] };
