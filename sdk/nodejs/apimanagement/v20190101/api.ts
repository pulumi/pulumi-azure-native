 ...
 * Api details.
 *
 * @deprecated azure-native:apimanagement/v20190101:Api is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20201201:Api to guarantee forwards compatibility.
 */
export class Api extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Api {
        pulumi.log.warn("Api is deprecated: azure-native:apimanagement/v20190101:Api is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20201201:Api to guarantee forwards compatibility.")
