...
export function getCache(args: GetCacheArgs, opts?: pulumi.InvokeOptions): Promise<GetCacheResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20190101:getCache", {
        "name": args.name,
...
export interface GetCacheResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20190101.CacheContractPropertiesResponse;
    /**
