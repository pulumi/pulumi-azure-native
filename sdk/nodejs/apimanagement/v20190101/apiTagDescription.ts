...
export class ApiTagDescription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiTagDescriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiTagDescription" }, { type: "azurerm:apimanagement/preview:ApiTagDescription" }, { type: "azurerm:apimanagement/v20170301:ApiTagDescription" }, { type: "azurerm:apimanagement/v20180101:ApiTagDescription" }, { type: "azurerm:apimanagement/v20180601preview:ApiTagDescription" }, { type: "azurerm:apimanagement/v20191201:ApiTagDescription" }, { type: "azurerm:apimanagement/v20191201preview:ApiTagDescription" }] };
