 ...
 *
 * const apiTagDescription = new azurerm.apimanagement.v20190101.ApiTagDescription("apiTagDescription", {
...
export class ApiTagDescription extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiTagDescriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiTagDescription" }, { type: "azurerm:apimanagement/v20170301:ApiTagDescription" }, { type: "azurerm:apimanagement/v20180101:ApiTagDescription" }, { type: "azurerm:apimanagement/v20191201:ApiTagDescription" }] };
