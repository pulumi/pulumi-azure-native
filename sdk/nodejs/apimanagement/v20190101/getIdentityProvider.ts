...
export function getIdentityProvider(args: GetIdentityProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetIdentityProviderResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20190101:getIdentityProvider", {
        "name": args.name,
...
export interface GetIdentityProviderResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20190101.IdentityProviderContractPropertiesResponse;
    /**
