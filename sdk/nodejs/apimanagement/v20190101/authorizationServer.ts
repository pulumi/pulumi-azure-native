...
export class AuthorizationServer extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.v20190101.AuthorizationServerContractPropertiesResponse>;
    /**
...
export interface AuthorizationServerArgs {
     ...
     * Properties of the External OAuth authorization server Contract.
     */
    readonly properties?: pulumi.Input<inputs.apimanagement.v20190101.AuthorizationServerContractProperties>;
    /**
