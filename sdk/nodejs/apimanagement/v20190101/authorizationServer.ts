...
export class AuthorizationServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20190101:AuthorizationServer';
    ...
    constructor(name: string, args: AuthorizationServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20190101:AuthorizationServer" }, { type: "azure-native:apimanagement:AuthorizationServer" }, { type: "azure-nextgen:apimanagement:AuthorizationServer" }, { type: "azure-native:apimanagement/v20160707:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20160707:AuthorizationServer" }, { type: "azure-native:apimanagement/v20161010:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20161010:AuthorizationServer" }, { type: "azure-native:apimanagement/v20170301:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20170301:AuthorizationServer" }, { type: "azure-native:apimanagement/v20180101:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20180101:AuthorizationServer" }, { type: "azure-native:apimanagement/v20180601preview:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20180601preview:AuthorizationServer" }, { type: "azure-native:apimanagement/v20191201:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20191201:AuthorizationServer" }, { type: "azure-native:apimanagement/v20191201preview:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20191201preview:AuthorizationServer" }, { type: "azure-native:apimanagement/v20200601preview:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20200601preview:AuthorizationServer" }, { type: "azure-native:apimanagement/v20201201:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20201201:AuthorizationServer" }, { type: "azure-native:apimanagement/v20210101preview:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20210101preview:AuthorizationServer" }] };
...
export interface AuthorizationServerArgs {
     ...
     * HTTP verbs supported by the authorization endpoint. GET must be always present. POST is optional.
     */
    authorizationMethods?: pulumi.Input<pulumi.Input<enums.apimanagement.v20190101.AuthorizationMethod>[]>;
    /**
     ...
     * Specifies the mechanism by which access token is passed to the API. 
     */
    bearerTokenSendingMethods?: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20190101.BearerTokenSendingMethod>[]>;
    /**
     * Method of authentication supported by the token endpoint of this authorization server. Possible values are Basic and/or Body. When Body is specified, client credentials and other parameters are passed within the request body in the application/x-www-form-urlencoded format.
     */
    clientAuthenticationMethod?: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20190101.ClientAuthenticationMethod>[]>;
    /**
     * Client or app id registered with this authorization server.
     */
     ...
     * Form of an authorization grant, which the client uses to request the access token.
     */
    grantTypes: pulumi.Input<pulumi.Input<string | enums.apimanagement.v20190101.GrantType>[]>;
    /**
     ...
     * Additional parameters required by the token endpoint of this authorization server represented as an array of JSON objects with name and value string properties, i.e. {"name" : "name value", "value": "a value"}.
     */
    tokenBodyParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20190101.TokenBodyParameterContractArgs>[]>;
    /**
     * OAuth token endpoint. Contains absolute URI to entity being referenced.
     */
