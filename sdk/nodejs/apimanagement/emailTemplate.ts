...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement:EmailTemplate';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.EmailTemplateContractPropertiesResponse>;
    /**
...
export interface EmailTemplateArgs {
     ...
     */
    readonly properties?: pulumi.Input<inputs.apimanagement.EmailTemplateUpdateParameterProperties>;
    /**
