...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EmailTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/latest:EmailTemplate" }, { type: "azure-nextgen:apimanagement/latest:EmailTemplate" }, { type: "azure-native:apimanagement/v20170301:EmailTemplate" }, { type: "azure-nextgen:apimanagement/v20170301:EmailTemplate" }, { type: "azure-native:apimanagement/v20180101:EmailTemplate" }, { type: "azure-nextgen:apimanagement/v20180101:EmailTemplate" }, { type: "azure-native:apimanagement/v20180601preview:EmailTemplate" }, { type: "azure-nextgen:apimanagement/v20180601preview:EmailTemplate" }, { type: "azure-native:apimanagement/v20190101:EmailTemplate" }, { type: "azure-nextgen:apimanagement/v20190101:EmailTemplate" }, { type: "azure-native:apimanagement/v20191201:EmailTemplate" }, { type: "azure-nextgen:apimanagement/v20191201:EmailTemplate" }, { type: "azure-native:apimanagement/v20191201preview:EmailTemplate" }, { type: "azure-nextgen:apimanagement/v20191201preview:EmailTemplate" }, { type: "azure-native:apimanagement/v20200601preview:EmailTemplate" }, { type: "azure-nextgen:apimanagement/v20200601preview:EmailTemplate" }] };
...
export interface EmailTemplateArgs {
     ...
     * Email Template Parameter values.
     */
    readonly parameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.EmailTemplateParametersContractProperties>[]>;
    /**
