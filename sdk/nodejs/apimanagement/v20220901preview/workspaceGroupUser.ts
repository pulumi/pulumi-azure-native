...
export class WorkspaceGroupUser extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly identities!: pulumi.Output<outputs.apimanagement.v20220901preview.UserIdentityContractResponse[] | undefined>;
    /**
     * Last name.
     */
    ...
    constructor(name: string, args: WorkspaceGroupUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20230301preview:WorkspaceGroupUser" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceGroupUser" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceGroupUser" }, { type: "azure-native:apimanagement/v20240501:WorkspaceGroupUser" }, { type: "azure-native:apimanagement/v20240601preview:WorkspaceGroupUser" }, { type: "azure-native:apimanagement:WorkspaceGroupUser" }] };
