...
export class ApiWiki extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiWikiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ApiWiki" }, { type: "azure-native:apimanagement/v20220801:ApiWiki" }, { type: "azure-native:apimanagement/v20230301preview:ApiWiki" }, { type: "azure-native:apimanagement/v20230501preview:ApiWiki" }, { type: "azure-native:apimanagement/v20230901preview:ApiWiki" }, { type: "azure-native:apimanagement/v20240501:ApiWiki" }] };
