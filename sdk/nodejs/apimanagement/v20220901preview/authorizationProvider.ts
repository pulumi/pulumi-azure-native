...
export class AuthorizationProvider extends pulumi.CustomResource {
     ...
     * OAuth2 settings
     */
    public readonly oauth2!: pulumi.Output<outputs.apimanagement.v20220901preview.AuthorizationProviderOAuth2SettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AuthorizationProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:AuthorizationProvider" }, { type: "azure-native:apimanagement/v20220401preview:AuthorizationProvider" }, { type: "azure-native:apimanagement/v20220801:AuthorizationProvider" }] };
