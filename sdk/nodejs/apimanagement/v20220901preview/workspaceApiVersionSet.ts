...
export class WorkspaceApiVersionSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceApiVersionSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceApiVersionSet" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceApiVersionSet" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApiVersionSet" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceApiVersionSet" }, { type: "azure-native:apimanagement/v20240501:WorkspaceApiVersionSet" }] };
...
export interface WorkspaceApiVersionSetArgs {
     ...
     * An value that determines where the API Version identifier will be located in a HTTP request.
     */
    versioningScheme: pulumi.Input<string | enums.apimanagement.v20220901preview.VersioningScheme>;
    /**
