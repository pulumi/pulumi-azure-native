...
export class TagByProduct extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagByProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/preview:TagByProduct" }, { type: "azurerm:apimanagement/v20170301:TagByProduct" }, { type: "azurerm:apimanagement/v20180101:TagByProduct" }, { type: "azurerm:apimanagement/v20180601preview:TagByProduct" }, { type: "azurerm:apimanagement/v20190101:TagByProduct" }, { type: "azurerm:apimanagement/v20191201:TagByProduct" }, { type: "azurerm:apimanagement/v20191201preview:TagByProduct" }] };
