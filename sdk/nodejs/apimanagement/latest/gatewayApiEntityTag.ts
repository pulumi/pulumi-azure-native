...
export class GatewayApiEntityTag extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayApiEntityTag {
        pulumi.log.warn("GatewayApiEntityTag is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:GatewayApiEntityTag'.")
        return new GatewayApiEntityTag(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/latest:GatewayApiEntityTag';
     ...
     * Version set details
     */
    public /*out*/ readonly apiVersionSet!: pulumi.Output<outputs.apimanagement.latest.ApiVersionSetContractDetailsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly authenticationSettings!: pulumi.Output<outputs.apimanagement.latest.AuthenticationSettingsContractResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly subscriptionKeyParameterNames!: pulumi.Output<outputs.apimanagement.latest.SubscriptionKeyParameterNamesContractResponse | undefined>;
    /**
...
export interface GatewayApiEntityTagArgs {
     ...
     * Provisioning state.
     */
    readonly provisioningState?: pulumi.Input<enums.apimanagement.latest.ProvisioningState>;
    /**
