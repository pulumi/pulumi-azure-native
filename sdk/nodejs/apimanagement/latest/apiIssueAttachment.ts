...
export class ApiIssueAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/latest:ApiIssueAttachment';
    ...
    constructor(name: string, argsOrState?: ApiIssueAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/preview:ApiIssueAttachment" }, { type: "azurerm:apimanagement/v20170301:ApiIssueAttachment" }, { type: "azurerm:apimanagement/v20180101:ApiIssueAttachment" }, { type: "azurerm:apimanagement/v20180601preview:ApiIssueAttachment" }, { type: "azurerm:apimanagement/v20190101:ApiIssueAttachment" }, { type: "azurerm:apimanagement/v20191201:ApiIssueAttachment" }, { type: "azurerm:apimanagement/v20191201preview:ApiIssueAttachment" }] };
