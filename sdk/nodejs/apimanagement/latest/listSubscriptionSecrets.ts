...
export function listSubscriptionSecrets(args: ListSubscriptionSecretsArgs, opts?: pulumi.InvokeOptions): Promise<ListSubscriptionSecretsResult> {
    pulumi.log.warn("listSubscriptionSecrets is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:listSubscriptionSecrets'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/latest:listSubscriptionSecrets", {
