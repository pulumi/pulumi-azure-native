 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:AuthorizationServer'.
 */
export class AuthorizationServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/latest:AuthorizationServer';
     ...
     */
    public readonly tokenBodyParameters!: pulumi.Output<outputs.apimanagement.latest.TokenBodyParameterContractResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: AuthorizationServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/latest:AuthorizationServer" }, { type: "azure-native:apimanagement:AuthorizationServer" }, { type: "azure-nextgen:apimanagement:AuthorizationServer" }, { type: "azure-native:apimanagement/v20160707:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20160707:AuthorizationServer" }, { type: "azure-native:apimanagement/v20161010:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20161010:AuthorizationServer" }, { type: "azure-native:apimanagement/v20170301:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20170301:AuthorizationServer" }, { type: "azure-native:apimanagement/v20180101:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20180101:AuthorizationServer" }, { type: "azure-native:apimanagement/v20180601preview:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20180601preview:AuthorizationServer" }, { type: "azure-native:apimanagement/v20190101:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20190101:AuthorizationServer" }, { type: "azure-native:apimanagement/v20191201:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20191201:AuthorizationServer" }, { type: "azure-native:apimanagement/v20191201preview:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20191201preview:AuthorizationServer" }, { type: "azure-native:apimanagement/v20200601preview:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20200601preview:AuthorizationServer" }, { type: "azure-native:apimanagement/v20201201:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20201201:AuthorizationServer" }, { type: "azure-native:apimanagement/v20210101preview:AuthorizationServer" }, { type: "azure-nextgen:apimanagement/v20210101preview:AuthorizationServer" }] };
...
export interface AuthorizationServerArgs {
     ...
     * Additional parameters required by the token endpoint of this authorization server represented as an array of JSON objects with name and value string properties, i.e. {"name" : "name value", "value": "a value"}.
     */
    readonly tokenBodyParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.latest.TokenBodyParameterContract>[]>;
    /**
     * OAuth token endpoint. Contains absolute URI to entity being referenced.
     */
