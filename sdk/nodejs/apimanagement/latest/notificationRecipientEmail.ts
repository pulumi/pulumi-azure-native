...
export class NotificationRecipientEmail extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/latest:NotificationRecipientEmail';
