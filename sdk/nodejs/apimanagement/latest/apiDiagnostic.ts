 ...
 *
 * const apiDiagnostic = new azurerm.apimanagement.latest.ApiDiagnostic("apiDiagnostic", {
 *     alwaysLog: "allErrors",
...
export class ApiDiagnostic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/latest:ApiDiagnostic';
    ...
    constructor(name: string, argsOrState?: ApiDiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20170301:ApiDiagnostic" }, { type: "azurerm:apimanagement/v20180101:ApiDiagnostic" }, { type: "azurerm:apimanagement/v20190101:ApiDiagnostic" }, { type: "azurerm:apimanagement/v20191201:ApiDiagnostic" }] };
