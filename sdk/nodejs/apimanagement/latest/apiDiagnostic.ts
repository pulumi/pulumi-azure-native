...
export class ApiDiagnostic extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiDiagnostic {
        pulumi.log.warn("ApiDiagnostic is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:ApiDiagnostic'.")
        return new ApiDiagnostic(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/latest:ApiDiagnostic';
...
export interface ApiDiagnosticArgs {
     ...
     * Specifies for what type of messages sampling settings should not apply.
     */
    readonly alwaysLog?: pulumi.Input<string | enums.apimanagement.latest.AlwaysLog>;
    /**
     ...
     * Sets correlation protocol to use for Application Insights diagnostics.
     */
    readonly httpCorrelationProtocol?: pulumi.Input<string | enums.apimanagement.latest.HttpCorrelationProtocol>;
    /**
     * Log the ClientIP. Default is false.
     */
     ...
     * The format of the Operation Name for Application Insights telemetries. Default is Name.
     */
    readonly operationNameFormat?: pulumi.Input<string | enums.apimanagement.latest.OperationNameFormat>;
    /**
     ...
     * The verbosity level applied to traces emitted by trace policies.
     */
    readonly verbosity?: pulumi.Input<string | enums.apimanagement.latest.Verbosity>;
}
