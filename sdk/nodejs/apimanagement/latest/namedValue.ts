...
export class NamedValue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/latest:NamedValue';
    ...
    constructor(name: string, args: NamedValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/preview:NamedValue" }, { type: "azurerm:apimanagement/v20191201:NamedValue" }, { type: "azurerm:apimanagement/v20191201preview:NamedValue" }] };
