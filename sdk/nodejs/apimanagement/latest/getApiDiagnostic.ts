...
export function getApiDiagnostic(args: GetApiDiagnosticArgs, opts?: pulumi.InvokeOptions): Promise<GetApiDiagnosticResult> {
    pulumi.log.warn("getApiDiagnostic is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiDiagnostic'.")
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/latest:getApiDiagnostic", {
        "apiId": args.apiId,
