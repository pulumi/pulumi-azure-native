 ...
 *
 * const emailTemplate = new azurerm.apimanagement.latest.EmailTemplate("emailTemplate", {
...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/latest:EmailTemplate';
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.apimanagement.latest.EmailTemplateParametersContractPropertiesResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: EmailTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20170301:EmailTemplate" }, { type: "azurerm:apimanagement/v20180101:EmailTemplate" }, { type: "azurerm:apimanagement/v20180601preview:EmailTemplate" }, { type: "azurerm:apimanagement/v20190101:EmailTemplate" }, { type: "azurerm:apimanagement/v20191201:EmailTemplate" }, { type: "azurerm:apimanagement/v20191201preview:EmailTemplate" }] };
...
export interface EmailTemplateArgs {
     ...
     * Email Template Parameter values.
     */
    readonly parameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.latest.EmailTemplateParametersContractProperties>[]>;
    /**
