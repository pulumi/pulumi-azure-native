...
export class DiagnosticLogger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/latest:DiagnosticLogger';
    ...
    constructor(name: string, args: DiagnosticLoggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/latest:DiagnosticLogger" }, { type: "azure-native:apimanagement:DiagnosticLogger" }, { type: "azure-nextgen:apimanagement:DiagnosticLogger" }, { type: "azure-native:apimanagement/v20170301:DiagnosticLogger" }, { type: "azure-nextgen:apimanagement/v20170301:DiagnosticLogger" }, { type: "azure-native:apimanagement/v20180101:DiagnosticLogger" }, { type: "azure-nextgen:apimanagement/v20180101:DiagnosticLogger" }] };
