...
export class WorkspaceGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceGroup" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceGroup" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceGroup" }] };
