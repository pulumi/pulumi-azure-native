...
export class WorkspacePolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspacePolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspacePolicy" }, { type: "azure-native:apimanagement/v20220901preview:WorkspacePolicy" }, { type: "azure-native:apimanagement/v20230501preview:WorkspacePolicy" }, { type: "azure-native:apimanagement/v20230901preview:WorkspacePolicy" }, { type: "azure-native:apimanagement/v20240501:WorkspacePolicy" }] };
