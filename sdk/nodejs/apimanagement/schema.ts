...
export class Schema extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:Schema" }, { type: "azure-native:apimanagement/v20210401preview:Schema" }, { type: "azure-nextgen:apimanagement/v20210401preview:Schema" }] };
