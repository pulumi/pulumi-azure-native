...
export class NamedValue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230901preview:NamedValue';
     ...
     */
    public readonly keyVault!: pulumi.Output<outputs.apimanagement.v20230901preview.KeyVaultContractPropertiesResponse | undefined>;
    /**
...
export interface NamedValueArgs {
     ...
     * KeyVault location details of the namedValue.
     */
    keyVault?: pulumi.Input<inputs.apimanagement.v20230901preview.KeyVaultContractCreatePropertiesArgs>;
    /**
