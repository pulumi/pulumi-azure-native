...
export class WorkspaceLogger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230901preview:WorkspaceLogger';
    ...
    constructor(name: string, args: WorkspaceLoggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20240501:WorkspaceLogger" }, { type: "azure-native:apimanagement/v20240601preview:WorkspaceLogger" }, { type: "azure-native:apimanagement:WorkspaceLogger" }] };
...
export interface WorkspaceLoggerArgs {
     ...
     * Logger type.
     */
    loggerType: pulumi.Input<string | enums.apimanagement.v20230901preview.LoggerType>;
    /**
