...
export class WorkspaceApiVersionSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceApiVersionSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceApiVersionSet" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceApiVersionSet" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceApiVersionSet" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApiVersionSet" }] };
