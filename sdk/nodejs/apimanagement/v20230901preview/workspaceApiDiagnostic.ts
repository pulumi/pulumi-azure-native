...
export class WorkspaceApiDiagnostic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230901preview:WorkspaceApiDiagnostic';
     ...
     */
    public readonly backend!: pulumi.Output<outputs.apimanagement.v20230901preview.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    public readonly frontend!: pulumi.Output<outputs.apimanagement.v20230901preview.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly sampling!: pulumi.Output<outputs.apimanagement.v20230901preview.SamplingSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WorkspaceApiDiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20240501:WorkspaceApiDiagnostic" }, { type: "azure-native:apimanagement/v20240601preview:WorkspaceApiDiagnostic" }, { type: "azure-native:apimanagement:WorkspaceApiDiagnostic" }] };
...
export interface WorkspaceApiDiagnosticArgs {
     ...
     * Specifies for what type of messages sampling settings should not apply.
     */
    alwaysLog?: pulumi.Input<string | enums.apimanagement.v20230901preview.AlwaysLog>;
    /**
     ...
     * Diagnostic settings for incoming/outgoing HTTP messages to the Backend
     */
    backend?: pulumi.Input<inputs.apimanagement.v20230901preview.PipelineDiagnosticSettingsArgs>;
    /**
     ...
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    frontend?: pulumi.Input<inputs.apimanagement.v20230901preview.PipelineDiagnosticSettingsArgs>;
    /**
     * Sets correlation protocol to use for Application Insights diagnostics.
     */
    httpCorrelationProtocol?: pulumi.Input<string | enums.apimanagement.v20230901preview.HttpCorrelationProtocol>;
    /**
     * Log the ClientIP. Default is false.
     */
     ...
     * The format of the Operation Name for Application Insights telemetries. Default is Name.
     */
    operationNameFormat?: pulumi.Input<string | enums.apimanagement.v20230901preview.OperationNameFormat>;
    /**
     ...
     * Sampling settings for Diagnostic.
     */
    sampling?: pulumi.Input<inputs.apimanagement.v20230901preview.SamplingSettingsArgs>;
    /**
     ...
     * The verbosity level applied to traces emitted by trace policies.
     */
    verbosity?: pulumi.Input<string | enums.apimanagement.v20230901preview.Verbosity>;
    /**
