...
export class ServiceGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceGateway {
        return new ServiceGateway(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement:ServiceGateway';
     ...
     * Gateway details.
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.GatewayContractPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceGateway.__pulumiType, name, inputs, opts);
    }
}
...
export interface ServiceGatewayArgs {
     ...
     * Gateway details.
     */
    readonly properties?: pulumi.Input<inputs.apimanagement.GatewayContractProperties>;
    /**
