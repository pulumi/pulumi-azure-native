 ...
 * Diagnostic details.
 *
 * @deprecated azure-native:apimanagement/v20170301:ApiDiagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180101:ApiDiagnostic to guarantee forwards compatibility.
 */
export class ApiDiagnostic extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiDiagnostic {
        pulumi.log.warn("ApiDiagnostic is deprecated: azure-native:apimanagement/v20170301:ApiDiagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180101:ApiDiagnostic to guarantee forwards compatibility.")
