...
export function getTagDescription(args: GetTagDescriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetTagDescriptionResult> {
    pulumi.log.warn("getTagDescription is deprecated: azure-native:apimanagement/v20170301:TagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180601preview:TagDescription to guarantee forwards compatibility.")
