...
export function getTagDescription(args: GetTagDescriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetTagDescriptionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20170301:getTagDescription", {
        "apiId": args.apiId,
        "name": args.name,
...
export interface GetTagDescriptionResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20170301.TagDescriptionContractPropertiesResponse;
    /**
