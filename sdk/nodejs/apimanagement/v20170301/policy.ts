...
export class Policy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:Policy" }, { type: "azurerm:apimanagement/preview:Policy" }, { type: "azurerm:apimanagement/v20180101:Policy" }, { type: "azurerm:apimanagement/v20180601preview:Policy" }, { type: "azurerm:apimanagement/v20190101:Policy" }, { type: "azurerm:apimanagement/v20191201:Policy" }, { type: "azurerm:apimanagement/v20191201preview:Policy" }] };
