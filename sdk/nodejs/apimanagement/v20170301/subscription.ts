...
export class Subscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Subscription {
        pulumi.log.warn("Subscription is deprecated: azure-native:apimanagement/v20170301:Subscription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180101:Subscription to guarantee forwards compatibility.")
