...
export class Api extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20160707:Api" }, { type: "azurerm:apimanagement/v20161010:Api" }, { type: "azurerm:apimanagement/v20180101:Api" }, { type: "azurerm:apimanagement/v20190101:Api" }, { type: "azurerm:apimanagement/v20191201:Api" }] };
