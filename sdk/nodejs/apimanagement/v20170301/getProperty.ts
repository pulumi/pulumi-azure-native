...
export function getProperty(args: GetPropertyArgs, opts?: pulumi.InvokeOptions): Promise<GetPropertyResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20170301:getProperty", {
        "name": args.name,
...
export interface GetPropertyResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20170301.PropertyContractPropertiesResponse;
    /**
