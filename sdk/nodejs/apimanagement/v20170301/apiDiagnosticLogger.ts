...
export class ApiDiagnosticLogger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20170301:ApiDiagnosticLogger';
    ...
    constructor(name: string, args: ApiDiagnosticLoggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:ApiDiagnosticLogger" }, { type: "azure-nextgen:apimanagement/latest:ApiDiagnosticLogger" }, { type: "azure-nextgen:apimanagement/v20180101:ApiDiagnosticLogger" }] };
