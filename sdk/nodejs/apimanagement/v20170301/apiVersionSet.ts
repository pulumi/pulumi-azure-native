...
export class ApiVersionSet extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiVersionSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiVersionSet" }, { type: "azurerm:apimanagement/preview:ApiVersionSet" }, { type: "azurerm:apimanagement/v20180101:ApiVersionSet" }, { type: "azurerm:apimanagement/v20180601preview:ApiVersionSet" }, { type: "azurerm:apimanagement/v20190101:ApiVersionSet" }, { type: "azurerm:apimanagement/v20191201:ApiVersionSet" }, { type: "azurerm:apimanagement/v20191201preview:ApiVersionSet" }] };
