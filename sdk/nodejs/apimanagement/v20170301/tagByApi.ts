...
export class TagByApi extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: TagByApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20180101:TagByApi" }, { type: "azurerm:apimanagement/v20190101:TagByApi" }, { type: "azurerm:apimanagement/v20191201:TagByApi" }] };
