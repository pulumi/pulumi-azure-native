...
export class TagDescription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20170301:TagDescription';
    ...
    constructor(name: string, args: TagDescriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:TagDescription" }, { type: "azurerm:apimanagement/preview:TagDescription" }, { type: "azurerm:apimanagement/v20180101:TagDescription" }, { type: "azurerm:apimanagement/v20180601preview:TagDescription" }, { type: "azurerm:apimanagement/v20190101:TagDescription" }, { type: "azurerm:apimanagement/v20191201:TagDescription" }, { type: "azurerm:apimanagement/v20191201preview:TagDescription" }] };
