...
export function getAuthorizationServer(args: GetAuthorizationServerArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationServerResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:apimanagement/v20170301:getAuthorizationServer", {
...
export interface GetAuthorizationServerResult {
     ...
     */
    readonly tokenBodyParameters?: outputs.apimanagement.v20170301.TokenBodyParameterContractInvokeResponse[];
    /**
