...
export function getAuthorizationServer(args: GetAuthorizationServerArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationServerResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20170301:getAuthorizationServer", {
        "name": args.name,
...
export interface GetAuthorizationServerResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20170301.AuthorizationServerContractPropertiesResponse;
    /**
