...
export class Diagnostic extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:Diagnostic" }, { type: "azurerm:apimanagement/v20180101:Diagnostic" }, { type: "azurerm:apimanagement/v20190101:Diagnostic" }, { type: "azurerm:apimanagement/v20191201:Diagnostic" }] };
