...
export class Logger extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: LoggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20160707:Logger" }, { type: "azurerm:apimanagement/v20161010:Logger" }, { type: "azurerm:apimanagement/v20180101:Logger" }] };
