...
export function getBackend(args: GetBackendArgs, opts?: pulumi.InvokeOptions): Promise<GetBackendResult> {
    pulumi.log.warn("getBackend is deprecated: azure-native:apimanagement/v20170301:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180101:Backend to guarantee forwards compatibility.")
