 ...
 * Backend details.
 *
 * @deprecated azure-native:apimanagement/v20170301:Backend is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180101:Backend to guarantee forwards compatibility.
 */
export class Backend extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Backend {
        pulumi.log.warn("Backend is deprecated: azure-native:apimanagement/v20170301:Backend is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180101:Backend to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: BackendArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["tls"] = args ? (args.tls ? pulumi.output(args.tls).apply(inputs.apimanagement.v20170301.backendTlsPropertiesArgsProvideDefaults) : undefined) : undefined;
