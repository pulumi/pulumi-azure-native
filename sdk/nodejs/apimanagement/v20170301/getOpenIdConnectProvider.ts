...
export function getOpenIdConnectProvider(args: GetOpenIdConnectProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetOpenIdConnectProviderResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20170301:getOpenIdConnectProvider", {
        "name": args.name,
...
export interface GetOpenIdConnectProviderResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20170301.OpenidConnectProviderContractPropertiesResponse;
    /**
