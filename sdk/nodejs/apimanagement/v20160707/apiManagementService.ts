...
export class ApiManagementService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiManagementServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiManagementService" }, { type: "azurerm:apimanagement/preview:ApiManagementService" }, { type: "azurerm:apimanagement/v20161010:ApiManagementService" }, { type: "azurerm:apimanagement/v20170301:ApiManagementService" }, { type: "azurerm:apimanagement/v20180101:ApiManagementService" }, { type: "azurerm:apimanagement/v20180601preview:ApiManagementService" }, { type: "azurerm:apimanagement/v20190101:ApiManagementService" }, { type: "azurerm:apimanagement/v20191201:ApiManagementService" }, { type: "azurerm:apimanagement/v20191201preview:ApiManagementService" }] };
