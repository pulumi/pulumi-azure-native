 ...
 *
 * @deprecated azure-native:apimanagement/v20210801:ProductPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ProductPolicy to guarantee forwards compatibility.
 */
export class ProductPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProductPolicy {
        pulumi.log.warn("ProductPolicy is deprecated: azure-native:apimanagement/v20210801:ProductPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ProductPolicy to guarantee forwards compatibility.")
