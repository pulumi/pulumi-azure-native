 ...
 *
 * @deprecated azure-native:apimanagement/v20210801:EmailTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:EmailTemplate to guarantee forwards compatibility.
 */
export class EmailTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EmailTemplate {
        pulumi.log.warn("EmailTemplate is deprecated: azure-native:apimanagement/v20210801:EmailTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:EmailTemplate to guarantee forwards compatibility.")
        return new EmailTemplate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20210801:EmailTemplate';
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.apimanagement.v20210801.EmailTemplateParametersContractPropertiesResponse[] | undefined>;
    /**
