 ...
 *
 * @deprecated azure-native:apimanagement/v20210801:ContentType is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ContentType to guarantee forwards compatibility.
 */
export class ContentType extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContentType {
        pulumi.log.warn("ContentType is deprecated: azure-native:apimanagement/v20210801:ContentType is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ContentType to guarantee forwards compatibility.")
