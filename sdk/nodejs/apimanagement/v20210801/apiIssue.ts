 ...
 *
 * @deprecated azure-native:apimanagement/v20210801:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssue to guarantee forwards compatibility.
 */
export class ApiIssue extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiIssue {
        pulumi.log.warn("ApiIssue is deprecated: azure-native:apimanagement/v20210801:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssue to guarantee forwards compatibility.")
