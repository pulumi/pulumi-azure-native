 ...
 *
 * @deprecated azure-native:apimanagement/v20210801:ApiSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiSchema to guarantee forwards compatibility.
 */
export class ApiSchema extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiSchema {
        pulumi.log.warn("ApiSchema is deprecated: azure-native:apimanagement/v20210801:ApiSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiSchema to guarantee forwards compatibility.")
        return new ApiSchema(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20210801:ApiSchema';
