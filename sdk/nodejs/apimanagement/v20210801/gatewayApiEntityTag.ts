 ...
 * API details.
 *
 * @deprecated azure-native:apimanagement/v20210801:GatewayApiEntityTag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:GatewayApiEntityTag to guarantee forwards compatibility.
 */
export class GatewayApiEntityTag extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayApiEntityTag {
        pulumi.log.warn("GatewayApiEntityTag is deprecated: azure-native:apimanagement/v20210801:GatewayApiEntityTag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:GatewayApiEntityTag to guarantee forwards compatibility.")
