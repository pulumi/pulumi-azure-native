 ...
 */
/** @deprecated azure-native:apimanagement/v20180101:Api is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:Api to guarantee forwards compatibility. */
export function getApi(args: GetApiArgs, opts?: pulumi.InvokeOptions): Promise<GetApiResult> {
    pulumi.log.warn("getApi is deprecated: azure-native:apimanagement/v20180101:Api is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20180601preview:Api to guarantee forwards compatibility.")
