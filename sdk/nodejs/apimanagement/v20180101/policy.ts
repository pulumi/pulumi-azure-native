...
export class Policy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Policy {
        pulumi.log.warn("Policy is deprecated: azure-native:apimanagement/v20180101:Policy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180601preview:Policy to guarantee forwards compatibility.")
