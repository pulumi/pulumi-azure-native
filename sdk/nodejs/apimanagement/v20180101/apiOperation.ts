...
export class ApiOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiOperation" }, { type: "azurerm:apimanagement/preview:ApiOperation" }, { type: "azurerm:apimanagement/v20160707:ApiOperation" }, { type: "azurerm:apimanagement/v20161010:ApiOperation" }, { type: "azurerm:apimanagement/v20170301:ApiOperation" }, { type: "azurerm:apimanagement/v20180601preview:ApiOperation" }, { type: "azurerm:apimanagement/v20190101:ApiOperation" }, { type: "azurerm:apimanagement/v20191201:ApiOperation" }, { type: "azurerm:apimanagement/v20191201preview:ApiOperation" }] };
