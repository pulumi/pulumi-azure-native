 ...
 */
/** @deprecated azure-native:apimanagement/v20180101:ApiOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiOperation to guarantee forwards compatibility. */
export function getApiOperation(args: GetApiOperationArgs, opts?: pulumi.InvokeOptions): Promise<GetApiOperationResult> {
    pulumi.log.warn("getApiOperation is deprecated: azure-native:apimanagement/v20180101:ApiOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiOperation to guarantee forwards compatibility.")
