...
export function getEmailTemplate(args: GetEmailTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetEmailTemplateResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:apimanagement/v20180101:getEmailTemplate", {
...
export interface GetEmailTemplateResult {
     ...
     */
    readonly parameters?: outputs.apimanagement.v20180101.EmailTemplateParametersContractPropertiesInvokeResponse[];
    /**
