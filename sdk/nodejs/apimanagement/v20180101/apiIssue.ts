 ...
 *
 * const apiIssue = new azurerm.apimanagement.v20180101.ApiIssue("apiIssue", {
...
export class ApiIssue extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiIssueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiIssue" }, { type: "azurerm:apimanagement/v20170301:ApiIssue" }, { type: "azurerm:apimanagement/v20190101:ApiIssue" }, { type: "azurerm:apimanagement/v20191201:ApiIssue" }] };
