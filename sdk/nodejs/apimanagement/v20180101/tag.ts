...
export class Tag extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:Tag" }, { type: "azurerm:apimanagement/preview:Tag" }, { type: "azurerm:apimanagement/v20170301:Tag" }, { type: "azurerm:apimanagement/v20180601preview:Tag" }, { type: "azurerm:apimanagement/v20190101:Tag" }, { type: "azurerm:apimanagement/v20191201:Tag" }, { type: "azurerm:apimanagement/v20191201preview:Tag" }] };
