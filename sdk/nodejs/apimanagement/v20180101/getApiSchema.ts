...
export function getApiSchema(args: GetApiSchemaArgs, opts?: pulumi.InvokeOptions): Promise<GetApiSchemaResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20180101:getApiSchema", {
        "apiId": args.apiId,
        "name": args.name,
...
export interface GetApiSchemaResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20180101.SchemaContractPropertiesResponse;
    /**
