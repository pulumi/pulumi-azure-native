...
export function getApiSchema(args: GetApiSchemaArgs, opts?: pulumi.InvokeOptions): Promise<GetApiSchemaResult> {
    pulumi.log.warn("getApiSchema is deprecated: azure-native:apimanagement/v20180101:ApiSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20190101:ApiSchema to guarantee forwards compatibility.")
