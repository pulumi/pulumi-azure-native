...
export class Backend extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackendArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20180101:Backend" }, { type: "azure-native:apimanagement:Backend" }, { type: "azure-nextgen:apimanagement:Backend" }, { type: "azure-native:apimanagement/v20160707:Backend" }, { type: "azure-nextgen:apimanagement/v20160707:Backend" }, { type: "azure-native:apimanagement/v20161010:Backend" }, { type: "azure-nextgen:apimanagement/v20161010:Backend" }, { type: "azure-native:apimanagement/v20170301:Backend" }, { type: "azure-nextgen:apimanagement/v20170301:Backend" }, { type: "azure-native:apimanagement/v20180601preview:Backend" }, { type: "azure-nextgen:apimanagement/v20180601preview:Backend" }, { type: "azure-native:apimanagement/v20190101:Backend" }, { type: "azure-nextgen:apimanagement/v20190101:Backend" }, { type: "azure-native:apimanagement/v20191201:Backend" }, { type: "azure-nextgen:apimanagement/v20191201:Backend" }, { type: "azure-native:apimanagement/v20191201preview:Backend" }, { type: "azure-nextgen:apimanagement/v20191201preview:Backend" }, { type: "azure-native:apimanagement/v20200601preview:Backend" }, { type: "azure-nextgen:apimanagement/v20200601preview:Backend" }, { type: "azure-native:apimanagement/v20201201:Backend" }, { type: "azure-nextgen:apimanagement/v20201201:Backend" }, { type: "azure-native:apimanagement/v20210101preview:Backend" }, { type: "azure-nextgen:apimanagement/v20210101preview:Backend" }] };
...
export interface BackendArgs {
     ...
     * Backend Credentials Contract Properties
     */
    readonly credentials?: pulumi.Input<inputs.apimanagement.v20180101.BackendCredentialsContractArgs>;
    /**
     * Backend Description.
     */
     ...
     * Backend Properties contract
     */
    readonly properties?: pulumi.Input<inputs.apimanagement.v20180101.BackendPropertiesArgs>;
    /**
     * Backend communication protocol.
     */
    readonly protocol: pulumi.Input<string | enums.apimanagement.v20180101.BackendProtocol>;
    /**
     * Backend Proxy Contract Properties
     */
    readonly proxy?: pulumi.Input<inputs.apimanagement.v20180101.BackendProxyContractArgs>;
    /**
     ...
     * Backend TLS Properties
     */
    readonly tls?: pulumi.Input<inputs.apimanagement.v20180101.BackendTlsPropertiesArgs>;
    /**
     * Runtime Url of the Backend.
     */
