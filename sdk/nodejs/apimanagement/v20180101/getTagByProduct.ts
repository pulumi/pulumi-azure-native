...
export function getTagByProduct(args: GetTagByProductArgs, opts?: pulumi.InvokeOptions): Promise<GetTagByProductResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20180101:getTagByProduct", {
        "name": args.name,
...
export interface GetTagByProductResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20180101.TagContractPropertiesResponse;
    /**
