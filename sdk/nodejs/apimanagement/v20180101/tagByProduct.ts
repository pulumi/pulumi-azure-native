...
export class TagByProduct extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:apimanagement/v20180101:TagByProduct';
    ...
    constructor(name: string, args: TagByProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/latest:TagByProduct" }, { type: "azure-nextgen:apimanagement/v20170301:TagByProduct" }, { type: "azure-nextgen:apimanagement/v20180601preview:TagByProduct" }, { type: "azure-nextgen:apimanagement/v20190101:TagByProduct" }, { type: "azure-nextgen:apimanagement/v20191201:TagByProduct" }, { type: "azure-nextgen:apimanagement/v20191201preview:TagByProduct" }, { type: "azure-nextgen:apimanagement/v20200601preview:TagByProduct" }] };
