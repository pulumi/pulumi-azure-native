...
export function getApiVersionSet(args: GetApiVersionSetArgs, opts?: pulumi.InvokeOptions): Promise<GetApiVersionSetResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20180101:getApiVersionSet", {
        "name": args.name,
...
export interface GetApiVersionSetResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20180101.ApiVersionSetContractPropertiesResponse;
    /**
