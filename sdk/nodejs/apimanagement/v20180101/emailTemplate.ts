...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: EmailTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20170301:EmailTemplate" }, { type: "azurerm:apimanagement/v20190101:EmailTemplate" }, { type: "azurerm:apimanagement/v20191201:EmailTemplate" }] };
