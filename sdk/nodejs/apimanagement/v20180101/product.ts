...
export class Product extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Product {
        pulumi.log.warn("Product is deprecated: azure-native:apimanagement/v20180101:Product is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:Product to guarantee forwards compatibility.")
