...
export function getBackend(args: GetBackendArgs, opts?: pulumi.InvokeOptions): Promise<GetBackendResult> {
    ...
    return pulumi.runtime.invoke("azurerm:apimanagement/v20180101:getBackend", {
        "name": args.name,
...
export interface GetBackendResult {
     ...
     */
    readonly properties: outputs.apimanagement.v20180101.BackendContractPropertiesResponse;
    /**
