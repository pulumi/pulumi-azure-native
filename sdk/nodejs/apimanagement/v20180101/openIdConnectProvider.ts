...
export class OpenIdConnectProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20180101:OpenIdConnectProvider';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.apimanagement.v20180101.OpenidConnectProviderContractPropertiesResponse>;
    /**
...
export interface OpenIdConnectProviderArgs {
     ...
     * OpenId Connect Provider contract properties.
     */
    readonly properties?: pulumi.Input<inputs.apimanagement.v20180101.OpenidConnectProviderContractProperties>;
    /**
