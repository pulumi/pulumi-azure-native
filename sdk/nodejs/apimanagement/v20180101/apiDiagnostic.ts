...
export class ApiDiagnostic extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApiDiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/v20170301:ApiDiagnostic" }, { type: "azurerm:apimanagement/v20190101:ApiDiagnostic" }, { type: "azurerm:apimanagement/v20191201:ApiDiagnostic" }] };
