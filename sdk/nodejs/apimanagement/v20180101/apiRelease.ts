...
export class ApiRelease extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiReleaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiRelease" }, { type: "azurerm:apimanagement/v20170301:ApiRelease" }, { type: "azurerm:apimanagement/v20180601preview:ApiRelease" }, { type: "azurerm:apimanagement/v20190101:ApiRelease" }, { type: "azurerm:apimanagement/v20191201:ApiRelease" }, { type: "azurerm:apimanagement/v20191201preview:ApiRelease" }] };
