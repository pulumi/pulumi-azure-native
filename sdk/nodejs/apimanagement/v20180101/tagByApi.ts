...
export class TagByApi extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TagByApi {
        pulumi.log.warn("TagByApi is deprecated: azure-native:apimanagement/v20180101:TagByApi is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByApi to guarantee forwards compatibility.")
