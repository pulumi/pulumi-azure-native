...
export class ApiGatewayConfigConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240601preview:ApiGatewayConfigConnection';
    ...
    constructor(name: string, args: ApiGatewayConfigConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20230901preview:ApiGatewayConfigConnection" }, { type: "azure-native:apimanagement/v20240501:ApiGatewayConfigConnection" }, { type: "azure-native:apimanagement:ApiGatewayConfigConnection" }] };
