...
export function getApiPolicy(args: GetApiPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetApiPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20240601preview:getApiPolicy", {
        "apiId": args.apiId,
        "format": args.format,
...
export function getApiPolicyOutput(args: GetApiPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:apimanagement/v20240601preview:getApiPolicy", {
        "apiId": args.apiId,
        "format": args.format,
        "policyId": args.policyId,
        "resourceGroupName": args.resourceGroupName,
