...
export function getDiagnostic(args: GetDiagnosticArgs, opts?: pulumi.InvokeOptions): Promise<GetDiagnosticResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20240601preview:getDiagnostic", {
...
export interface GetDiagnosticResult {
     ...
     */
    readonly backend?: outputs.apimanagement.v20240601preview.PipelineDiagnosticSettingsResponse;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    readonly frontend?: outputs.apimanagement.v20240601preview.PipelineDiagnosticSettingsResponse;
    /**
     ...
     */
    readonly largeLanguageModel?: outputs.apimanagement.v20240601preview.LLMDiagnosticSettingsResponse;
    /**
     ...
     */
    readonly sampling?: outputs.apimanagement.v20240601preview.SamplingSettingsResponse;
    /**
...
export function getDiagnosticOutput(args: GetDiagnosticOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDiagnosticResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:apimanagement/v20240601preview:getDiagnostic", {
        "diagnosticId": args.diagnosticId,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
