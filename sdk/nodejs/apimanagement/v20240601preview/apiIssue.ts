...
export class ApiIssue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240601preview:ApiIssue';
...
export interface ApiIssueArgs {
     ...
     * Status of the issue.
     */
    state?: pulumi.Input<string | enums.apimanagement.v20240601preview.State>;
    /**
     * The issue title.
     */
