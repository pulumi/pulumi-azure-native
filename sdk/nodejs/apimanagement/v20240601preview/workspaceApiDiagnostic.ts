...
export class WorkspaceApiDiagnostic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240601preview:WorkspaceApiDiagnostic';
    ...
    constructor(name: string, args: WorkspaceApiDiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20230901preview:WorkspaceApiDiagnostic" }, { type: "azure-native:apimanagement/v20240501:WorkspaceApiDiagnostic" }, { type: "azure-native:apimanagement:WorkspaceApiDiagnostic" }] };
