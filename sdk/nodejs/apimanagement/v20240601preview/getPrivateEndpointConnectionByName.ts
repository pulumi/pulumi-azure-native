...
export function getPrivateEndpointConnectionByName(args: GetPrivateEndpointConnectionByNameArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointConnectionByNameResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20240601preview:getPrivateEndpointConnectionByName", {
...
export interface GetPrivateEndpointConnectionByNameResult {
     ...
     */
    readonly privateEndpoint?: outputs.apimanagement.v20240601preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: outputs.apimanagement.v20240601preview.PrivateLinkServiceConnectionStateResponse;
    /**
...
export function getPrivateEndpointConnectionByNameOutput(args: GetPrivateEndpointConnectionByNameOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPrivateEndpointConnectionByNameResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:apimanagement/v20240601preview:getPrivateEndpointConnectionByName", {
        "privateEndpointConnectionName": args.privateEndpointConnectionName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
