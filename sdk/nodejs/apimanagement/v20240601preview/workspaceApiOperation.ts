...
export class WorkspaceApiOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240601preview:WorkspaceApiOperation';
     ...
     */
    public readonly request!: pulumi.Output<outputs.apimanagement.v20240601preview.RequestContractResponse | undefined>;
    /**
     * Array of Operation responses.
     */
    public readonly responses!: pulumi.Output<outputs.apimanagement.v20240601preview.ResponseContractResponse[] | undefined>;
    /**
     * Collection of URL template parameters.
     */
    public readonly templateParameters!: pulumi.Output<outputs.apimanagement.v20240601preview.ParameterContractResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: WorkspaceApiOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220901preview:WorkspaceApiOperation" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceApiOperation" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApiOperation" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceApiOperation" }, { type: "azure-native:apimanagement/v20240501:WorkspaceApiOperation" }, { type: "azure-native:apimanagement:WorkspaceApiOperation" }] };
...
export interface WorkspaceApiOperationArgs {
     ...
     * An entity containing request details.
     */
    request?: pulumi.Input<inputs.apimanagement.v20240601preview.RequestContractArgs>;
    /**
     ...
     * Array of Operation responses.
     */
    responses?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20240601preview.ResponseContractArgs>[]>;
    /**
     ...
     * Collection of URL template parameters.
     */
    templateParameters?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20240601preview.ParameterContractArgs>[]>;
    /**
     * Relative URL template identifying the target resource for this operation. May include parameters. Example: /customers/{cid}/orders/{oid}/?date={date}
     */
