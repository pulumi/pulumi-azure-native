...
export function getProductWiki(args: GetProductWikiArgs, opts?: pulumi.InvokeOptions): Promise<GetProductWikiResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20240601preview:getProductWiki", {
...
export interface GetProductWikiResult {
     ...
     */
    readonly documents?: outputs.apimanagement.v20240601preview.WikiDocumentationContractResponse[];
    /**
...
export function getProductWikiOutput(args: GetProductWikiOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetProductWikiResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:apimanagement/v20240601preview:getProductWiki", {
        "productId": args.productId,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
    }, opts);
