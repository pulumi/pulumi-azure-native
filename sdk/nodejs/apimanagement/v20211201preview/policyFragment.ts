 ...
 *
 * @deprecated azure-native:apimanagement/v20211201preview:PolicyFragment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:PolicyFragment to guarantee forwards compatibility.
 */
export class PolicyFragment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyFragment {
        pulumi.log.warn("PolicyFragment is deprecated: azure-native:apimanagement/v20211201preview:PolicyFragment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:PolicyFragment to guarantee forwards compatibility.")
        return new PolicyFragment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20211201preview:PolicyFragment';
    ...
    constructor(name: string, args: PolicyFragmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:PolicyFragment" }, { type: "azure-native:apimanagement/v20220401preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20220801:PolicyFragment" }] };
