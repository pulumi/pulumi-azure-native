 ...
 * Diagnostic details.
 *
 * @deprecated azure-native:apimanagement/v20211201preview:Diagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Diagnostic to guarantee forwards compatibility.
 */
export class Diagnostic extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Diagnostic {
        pulumi.log.warn("Diagnostic is deprecated: azure-native:apimanagement/v20211201preview:Diagnostic is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Diagnostic to guarantee forwards compatibility.")
        return new Diagnostic(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20211201preview:Diagnostic';
     ...
     */
    public readonly backend!: pulumi.Output<outputs.apimanagement.v20211201preview.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    public readonly frontend!: pulumi.Output<outputs.apimanagement.v20211201preview.PipelineDiagnosticSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly sampling!: pulumi.Output<outputs.apimanagement.v20211201preview.SamplingSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:Diagnostic" }, { type: "azure-native:apimanagement/v20170301:Diagnostic" }, { type: "azure-native:apimanagement/v20180101:Diagnostic" }, { type: "azure-native:apimanagement/v20180601preview:Diagnostic" }, { type: "azure-native:apimanagement/v20190101:Diagnostic" }, { type: "azure-native:apimanagement/v20191201:Diagnostic" }, { type: "azure-native:apimanagement/v20191201preview:Diagnostic" }, { type: "azure-native:apimanagement/v20200601preview:Diagnostic" }, { type: "azure-native:apimanagement/v20201201:Diagnostic" }, { type: "azure-native:apimanagement/v20210101preview:Diagnostic" }, { type: "azure-native:apimanagement/v20210401preview:Diagnostic" }, { type: "azure-native:apimanagement/v20210801:Diagnostic" }, { type: "azure-native:apimanagement/v20220401preview:Diagnostic" }, { type: "azure-native:apimanagement/v20220801:Diagnostic" }] };
