 ...
 *
 * @deprecated azure-native:apimanagement/v20211201preview:GlobalSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GlobalSchema to guarantee forwards compatibility.
 */
export class GlobalSchema extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GlobalSchema {
        pulumi.log.warn("GlobalSchema is deprecated: azure-native:apimanagement/v20211201preview:GlobalSchema is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:GlobalSchema to guarantee forwards compatibility.")
        return new GlobalSchema(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20211201preview:GlobalSchema';
    ...
    constructor(name: string, args: GlobalSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:GlobalSchema" }, { type: "azure-native:apimanagement/v20210401preview:GlobalSchema" }, { type: "azure-native:apimanagement/v20210801:GlobalSchema" }, { type: "azure-native:apimanagement/v20220401preview:GlobalSchema" }, { type: "azure-native:apimanagement/v20220801:GlobalSchema" }] };
