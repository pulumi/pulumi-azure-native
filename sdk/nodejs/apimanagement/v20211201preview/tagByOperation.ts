 ...
 *
 * @deprecated azure-native:apimanagement/v20211201preview:TagByOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.
 */
export class TagByOperation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TagByOperation {
        pulumi.log.warn("TagByOperation is deprecated: azure-native:apimanagement/v20211201preview:TagByOperation is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:TagByOperation to guarantee forwards compatibility.")
        return new TagByOperation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20211201preview:TagByOperation';
    ...
    constructor(name: string, args: TagByOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:TagByOperation" }, { type: "azure-native:apimanagement/v20170301:TagByOperation" }, { type: "azure-native:apimanagement/v20180101:TagByOperation" }, { type: "azure-native:apimanagement/v20180601preview:TagByOperation" }, { type: "azure-native:apimanagement/v20190101:TagByOperation" }, { type: "azure-native:apimanagement/v20191201:TagByOperation" }, { type: "azure-native:apimanagement/v20191201preview:TagByOperation" }, { type: "azure-native:apimanagement/v20200601preview:TagByOperation" }, { type: "azure-native:apimanagement/v20201201:TagByOperation" }, { type: "azure-native:apimanagement/v20210101preview:TagByOperation" }, { type: "azure-native:apimanagement/v20210401preview:TagByOperation" }, { type: "azure-native:apimanagement/v20210801:TagByOperation" }, { type: "azure-native:apimanagement/v20220401preview:TagByOperation" }, { type: "azure-native:apimanagement/v20220801:TagByOperation" }] };
