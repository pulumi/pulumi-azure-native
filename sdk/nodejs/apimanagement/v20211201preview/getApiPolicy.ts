...
export function getApiPolicy(args: GetApiPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetApiPolicyResult> {
    pulumi.log.warn("getApiPolicy is deprecated: azure-native:apimanagement/v20211201preview:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220801:ApiPolicy to guarantee forwards compatibility.")
