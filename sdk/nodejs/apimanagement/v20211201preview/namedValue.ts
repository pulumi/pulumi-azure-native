...
export class NamedValue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20211201preview:NamedValue';
     ...
     */
    public readonly keyVault!: pulumi.Output<outputs.apimanagement.v20211201preview.KeyVaultContractPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NamedValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:NamedValue" }, { type: "azure-native:apimanagement/v20191201:NamedValue" }, { type: "azure-native:apimanagement/v20191201preview:NamedValue" }, { type: "azure-native:apimanagement/v20200601preview:NamedValue" }, { type: "azure-native:apimanagement/v20201201:NamedValue" }, { type: "azure-native:apimanagement/v20210101preview:NamedValue" }, { type: "azure-native:apimanagement/v20210401preview:NamedValue" }, { type: "azure-native:apimanagement/v20210801:NamedValue" }, { type: "azure-native:apimanagement/v20220401preview:NamedValue" }, { type: "azure-native:apimanagement/v20220801:NamedValue" }, { type: "azure-native:apimanagement/v20220901preview:NamedValue" }, { type: "azure-native:apimanagement/v20230301preview:NamedValue" }, { type: "azure-native:apimanagement/v20230501preview:NamedValue" }, { type: "azure-native:apimanagement/v20230901preview:NamedValue" }, { type: "azure-native:apimanagement/v20240501:NamedValue" }, { type: "azure-native:apimanagement/v20240601preview:NamedValue" }] };
