 ...
 *
 * @deprecated azure-native:apimanagement/v20211201preview:ApiIssue is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiIssue to guarantee forwards compatibility.
 */
export class ApiIssue extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiIssue {
        pulumi.log.warn("ApiIssue is deprecated: azure-native:apimanagement/v20211201preview:ApiIssue is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiIssue to guarantee forwards compatibility.")
        return new ApiIssue(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20211201preview:ApiIssue';
    ...
    constructor(name: string, args: ApiIssueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ApiIssue" }, { type: "azure-native:apimanagement/v20170301:ApiIssue" }, { type: "azure-native:apimanagement/v20180101:ApiIssue" }, { type: "azure-native:apimanagement/v20180601preview:ApiIssue" }, { type: "azure-native:apimanagement/v20190101:ApiIssue" }, { type: "azure-native:apimanagement/v20191201:ApiIssue" }, { type: "azure-native:apimanagement/v20191201preview:ApiIssue" }, { type: "azure-native:apimanagement/v20200601preview:ApiIssue" }, { type: "azure-native:apimanagement/v20201201:ApiIssue" }, { type: "azure-native:apimanagement/v20210101preview:ApiIssue" }, { type: "azure-native:apimanagement/v20210401preview:ApiIssue" }, { type: "azure-native:apimanagement/v20210801:ApiIssue" }, { type: "azure-native:apimanagement/v20220401preview:ApiIssue" }, { type: "azure-native:apimanagement/v20220801:ApiIssue" }] };
