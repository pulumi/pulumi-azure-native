...
export class TagApiLink extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagApiLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:TagApiLink" }, { type: "azure-native:apimanagement/v20220901preview:TagApiLink" }, { type: "azure-native:apimanagement/v20230301preview:TagApiLink" }, { type: "azure-native:apimanagement/v20230501preview:TagApiLink" }, { type: "azure-native:apimanagement/v20230901preview:TagApiLink" }] };
