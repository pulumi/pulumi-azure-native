...
export class PolicyFragment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240501:PolicyFragment';
    ...
    constructor(name: string, args: PolicyFragmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20211201preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20220401preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20220801:PolicyFragment" }, { type: "azure-native:apimanagement/v20220901preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20230301preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20230501preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20230901preview:PolicyFragment" }, { type: "azure-native:apimanagement/v20240601preview:PolicyFragment" }, { type: "azure-native:apimanagement:PolicyFragment" }] };
...
export interface PolicyFragmentArgs {
     ...
     * Format of the policy fragment content.
     */
    format?: pulumi.Input<string | enums.apimanagement.v20240501.PolicyFragmentContentFormat>;
    /**
