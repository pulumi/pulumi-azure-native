...
export function getWorkspaceDiagnostic(args: GetWorkspaceDiagnosticArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceDiagnosticResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20240501:getWorkspaceDiagnostic", {
...
export interface GetWorkspaceDiagnosticResult {
     ...
     */
    readonly backend?: outputs.apimanagement.v20240501.PipelineDiagnosticSettingsResponse;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    readonly frontend?: outputs.apimanagement.v20240501.PipelineDiagnosticSettingsResponse;
    /**
     ...
     */
    readonly sampling?: outputs.apimanagement.v20240501.SamplingSettingsResponse;
    /**
...
export function getWorkspaceDiagnosticOutput(args: GetWorkspaceDiagnosticOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceDiagnosticResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:apimanagement/v20240501:getWorkspaceDiagnostic", {
        "diagnosticId": args.diagnosticId,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
        "workspaceId": args.workspaceId,
