...
export class WorkspaceApiDiagnostic extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceApiDiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20230901preview:WorkspaceApiDiagnostic" }, { type: "azure-native:apimanagement/v20240601preview:WorkspaceApiDiagnostic" }, { type: "azure-native:apimanagement:WorkspaceApiDiagnostic" }] };
