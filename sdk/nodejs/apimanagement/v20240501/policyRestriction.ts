...
export class PolicyRestriction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240501:PolicyRestriction';
    ...
    constructor(name: string, args: PolicyRestrictionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:PolicyRestriction" }, { type: "azure-native:apimanagement/v20230501preview:PolicyRestriction" }, { type: "azure-native:apimanagement/v20230901preview:PolicyRestriction" }, { type: "azure-native:apimanagement/v20240601preview:PolicyRestriction" }] };
...
export interface PolicyRestrictionArgs {
     ...
     * Indicates if base policy should be enforced for the policy document.
     */
    requireBase?: pulumi.Input<string | enums.apimanagement.v20240501.PolicyRestrictionRequireBase>;
    /**
