...
export class ProductWiki extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240501:ProductWiki';
     ...
     */
    public readonly documents!: pulumi.Output<outputs.apimanagement.v20240501.WikiDocumentationContractResponse[] | undefined>;
    /**
...
export interface ProductWikiArgs {
     ...
     * Collection wiki documents included into this wiki.
     */
    documents?: pulumi.Input<pulumi.Input<inputs.apimanagement.v20240501.WikiDocumentationContractArgs>[]>;
    /**
