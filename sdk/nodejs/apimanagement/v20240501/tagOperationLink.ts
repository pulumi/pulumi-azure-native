...
export class TagOperationLink extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TagOperationLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:TagOperationLink" }, { type: "azure-native:apimanagement/v20220901preview:TagOperationLink" }, { type: "azure-native:apimanagement/v20230301preview:TagOperationLink" }, { type: "azure-native:apimanagement/v20230501preview:TagOperationLink" }, { type: "azure-native:apimanagement/v20230901preview:TagOperationLink" }] };
