...
export class WorkspaceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240501:WorkspaceGroup';
    ...
    constructor(name: string, args: WorkspaceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceGroup" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceGroup" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceGroup" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceGroup" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceGroup" }, { type: "azure-native:apimanagement/v20240601preview:WorkspaceGroup" }] };
