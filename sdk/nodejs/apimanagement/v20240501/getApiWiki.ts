...
export function getApiWiki(args: GetApiWikiArgs, opts?: pulumi.InvokeOptions): Promise<GetApiWikiResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20240501:getApiWiki", {
        "apiId": args.apiId,
...
export interface GetApiWikiResult {
     ...
     */
    readonly documents?: outputs.apimanagement.v20240501.WikiDocumentationContractResponse[];
    /**
