...
export class ApiGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20240501:ApiGateway';
     ...
     */
    public readonly backend!: pulumi.Output<outputs.apimanagement.v20240501.BackendConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly configurationApi!: pulumi.Output<outputs.apimanagement.v20240501.GatewayConfigurationApiResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly frontend!: pulumi.Output<outputs.apimanagement.v20240501.FrontendConfigurationResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly sku!: pulumi.Output<outputs.apimanagement.v20240501.ApiManagementGatewaySkuPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApiGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20230901preview:ApiGateway" }, { type: "azure-native:apimanagement/v20240601preview:ApiGateway" }, { type: "azure-native:apimanagement:ApiGateway" }] };
