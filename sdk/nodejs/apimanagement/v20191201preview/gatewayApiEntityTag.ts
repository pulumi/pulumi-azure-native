...
export class GatewayApiEntityTag extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GatewayApiEntityTagArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/latest:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/v20191201:GatewayApiEntityTag" }, { type: "azure-nextgen:apimanagement/v20200601preview:GatewayApiEntityTag" }] };
