 ...
 * NamedValue details.
 *
 * @deprecated azure-native:apimanagement/v20191201preview:NamedValue is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NamedValue to guarantee forwards compatibility.
 */
export class NamedValue extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamedValue {
        pulumi.log.warn("NamedValue is deprecated: azure-native:apimanagement/v20191201preview:NamedValue is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:NamedValue to guarantee forwards compatibility.")
        return new NamedValue(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20191201preview:NamedValue';
    ...
    constructor(name: string, args: NamedValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:NamedValue" }, { type: "azure-native:apimanagement/v20191201:NamedValue" }, { type: "azure-native:apimanagement/v20200601preview:NamedValue" }, { type: "azure-native:apimanagement/v20201201:NamedValue" }, { type: "azure-native:apimanagement/v20210101preview:NamedValue" }, { type: "azure-native:apimanagement/v20210401preview:NamedValue" }, { type: "azure-native:apimanagement/v20210801:NamedValue" }, { type: "azure-native:apimanagement/v20211201preview:NamedValue" }, { type: "azure-native:apimanagement/v20220401preview:NamedValue" }, { type: "azure-native:apimanagement/v20220801:NamedValue" }] };
