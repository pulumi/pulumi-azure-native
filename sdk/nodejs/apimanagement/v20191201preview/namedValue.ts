...
export class NamedValue extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NamedValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:NamedValue" }, { type: "azure-nextgen:apimanagement:NamedValue" }, { type: "azure-native:apimanagement/latest:NamedValue" }, { type: "azure-nextgen:apimanagement/latest:NamedValue" }, { type: "azure-native:apimanagement/v20191201:NamedValue" }, { type: "azure-nextgen:apimanagement/v20191201:NamedValue" }, { type: "azure-native:apimanagement/v20200601preview:NamedValue" }, { type: "azure-nextgen:apimanagement/v20200601preview:NamedValue" }] };
