...
export class TagByApi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20191201preview:TagByApi';
    ...
    constructor(name: string, argsOrState?: TagByApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:TagByApi" }, { type: "azurerm:apimanagement/preview:TagByApi" }, { type: "azurerm:apimanagement/v20170301:TagByApi" }, { type: "azurerm:apimanagement/v20180101:TagByApi" }, { type: "azurerm:apimanagement/v20180601preview:TagByApi" }, { type: "azurerm:apimanagement/v20190101:TagByApi" }, { type: "azurerm:apimanagement/v20191201:TagByApi" }] };
