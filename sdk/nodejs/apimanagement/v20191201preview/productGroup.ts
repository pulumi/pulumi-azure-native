...
export class ProductGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProductGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ProductGroup" }, { type: "azure-nextgen:apimanagement:ProductGroup" }, { type: "azure-native:apimanagement/latest:ProductGroup" }, { type: "azure-nextgen:apimanagement/latest:ProductGroup" }, { type: "azure-native:apimanagement/v20170301:ProductGroup" }, { type: "azure-nextgen:apimanagement/v20170301:ProductGroup" }, { type: "azure-native:apimanagement/v20180101:ProductGroup" }, { type: "azure-nextgen:apimanagement/v20180101:ProductGroup" }, { type: "azure-native:apimanagement/v20180601preview:ProductGroup" }, { type: "azure-nextgen:apimanagement/v20180601preview:ProductGroup" }, { type: "azure-native:apimanagement/v20190101:ProductGroup" }, { type: "azure-nextgen:apimanagement/v20190101:ProductGroup" }, { type: "azure-native:apimanagement/v20191201:ProductGroup" }, { type: "azure-nextgen:apimanagement/v20191201:ProductGroup" }, { type: "azure-native:apimanagement/v20200601preview:ProductGroup" }, { type: "azure-nextgen:apimanagement/v20200601preview:ProductGroup" }] };
