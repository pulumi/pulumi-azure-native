 ...
 *
 * @deprecated azure-native:apimanagement/v20191201preview:ApiIssueAttachment is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiIssueAttachment to guarantee forwards compatibility.
 */
export class ApiIssueAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiIssueAttachment {
        pulumi.log.warn("ApiIssueAttachment is deprecated: azure-native:apimanagement/v20191201preview:ApiIssueAttachment is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:ApiIssueAttachment to guarantee forwards compatibility.")
