...
export class GatewayHostnameConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20191201preview:GatewayHostnameConfiguration';
    ...
    constructor(name: string, args: GatewayHostnameConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:GatewayHostnameConfiguration" }, { type: "azurerm:apimanagement/preview:GatewayHostnameConfiguration" }, { type: "azurerm:apimanagement/v20191201:GatewayHostnameConfiguration" }] };
