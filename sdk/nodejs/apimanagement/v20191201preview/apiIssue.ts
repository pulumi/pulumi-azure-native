...
export class ApiIssue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement/v20191201preview:ApiIssue';
    ...
    constructor(name: string, args: ApiIssueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:ApiIssue" }, { type: "azurerm:apimanagement/preview:ApiIssue" }, { type: "azurerm:apimanagement/v20170301:ApiIssue" }, { type: "azurerm:apimanagement/v20180101:ApiIssue" }, { type: "azurerm:apimanagement/v20180601preview:ApiIssue" }, { type: "azurerm:apimanagement/v20190101:ApiIssue" }, { type: "azurerm:apimanagement/v20191201:ApiIssue" }] };
