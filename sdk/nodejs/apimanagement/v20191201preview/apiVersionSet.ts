...
export class ApiVersionSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20191201preview:ApiVersionSet';
    ...
    constructor(name: string, args: ApiVersionSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/v20191201preview:ApiVersionSet" }, { type: "azure-native:apimanagement:ApiVersionSet" }, { type: "azure-nextgen:apimanagement:ApiVersionSet" }, { type: "azure-native:apimanagement/v20170301:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20170301:ApiVersionSet" }, { type: "azure-native:apimanagement/v20180101:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20180101:ApiVersionSet" }, { type: "azure-native:apimanagement/v20180601preview:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20180601preview:ApiVersionSet" }, { type: "azure-native:apimanagement/v20190101:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20190101:ApiVersionSet" }, { type: "azure-native:apimanagement/v20191201:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20191201:ApiVersionSet" }, { type: "azure-native:apimanagement/v20200601preview:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20200601preview:ApiVersionSet" }, { type: "azure-native:apimanagement/v20201201:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20201201:ApiVersionSet" }, { type: "azure-native:apimanagement/v20210101preview:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20210101preview:ApiVersionSet" }, { type: "azure-native:apimanagement/v20210401preview:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20210401preview:ApiVersionSet" }, { type: "azure-native:apimanagement/v20210801:ApiVersionSet" }, { type: "azure-nextgen:apimanagement/v20210801:ApiVersionSet" }] };
...
export interface ApiVersionSetArgs {
     ...
     * An value that determines where the API Version identifier will be located in a HTTP request.
     */
    versioningScheme: pulumi.Input<string | enums.apimanagement.v20191201preview.VersioningScheme>;
}
