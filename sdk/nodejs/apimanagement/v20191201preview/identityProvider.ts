...
export class IdentityProvider extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IdentityProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:apimanagement/latest:IdentityProvider" }, { type: "azure-nextgen:apimanagement/v20160707:IdentityProvider" }, { type: "azure-nextgen:apimanagement/v20161010:IdentityProvider" }, { type: "azure-nextgen:apimanagement/v20170301:IdentityProvider" }, { type: "azure-nextgen:apimanagement/v20180101:IdentityProvider" }, { type: "azure-nextgen:apimanagement/v20180601preview:IdentityProvider" }, { type: "azure-nextgen:apimanagement/v20190101:IdentityProvider" }, { type: "azure-nextgen:apimanagement/v20191201:IdentityProvider" }, { type: "azure-nextgen:apimanagement/v20200601preview:IdentityProvider" }] };
