...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EmailTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:apimanagement/latest:EmailTemplate" }, { type: "azurerm:apimanagement/preview:EmailTemplate" }, { type: "azurerm:apimanagement/v20170301:EmailTemplate" }, { type: "azurerm:apimanagement/v20180101:EmailTemplate" }, { type: "azurerm:apimanagement/v20180601preview:EmailTemplate" }, { type: "azurerm:apimanagement/v20190101:EmailTemplate" }, { type: "azurerm:apimanagement/v20191201:EmailTemplate" }] };
