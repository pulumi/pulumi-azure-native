...
export class ServiceSubscription extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceSubscription {
        return new ServiceSubscription(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:apimanagement:ServiceSubscription';
    ...
    constructor(name: string, argsOrState?: ServiceSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceSubscription.__pulumiType, name, inputs, opts);
    }
}
