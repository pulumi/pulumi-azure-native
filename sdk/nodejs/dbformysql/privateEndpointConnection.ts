...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbformysql:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:dbformysql/v20180601:PrivateEndpointConnection" }, { type: "azure-nextgen:dbformysql/v20180601privatepreview:PrivateEndpointConnection" }] };
