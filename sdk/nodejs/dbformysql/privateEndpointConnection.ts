...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql:PrivateEndpointConnection" }, { type: "azure-native:dbformysql/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:dbformysql/latest:PrivateEndpointConnection" }, { type: "azure-native:dbformysql/v20180601:PrivateEndpointConnection" }, { type: "azure-nextgen:dbformysql/v20180601:PrivateEndpointConnection" }, { type: "azure-native:dbformysql/v20180601privatepreview:PrivateEndpointConnection" }, { type: "azure-nextgen:dbformysql/v20180601privatepreview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.dbformysql.PrivateEndpointProperty>;
    readonly privateEndpointConnectionName?: pulumi.Input<string>;
    /**
     * Connection state of the private endpoint connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.dbformysql.PrivateLinkServiceConnectionStateProperty>;
    /**
