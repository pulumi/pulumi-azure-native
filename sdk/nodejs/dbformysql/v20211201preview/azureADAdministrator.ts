...
export class AzureADAdministrator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AzureADAdministrator {
        pulumi.log.warn("AzureADAdministrator is deprecated: azure-native:dbformysql/v20211201preview:AzureADAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220101:AzureADAdministrator to guarantee forwards compatibility.")
