...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/preview:Database';
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:Database" }, { type: "azurerm:dbformysql/v20171201:Database" }, { type: "azurerm:dbformysql/v20171201preview:Database" }] };
