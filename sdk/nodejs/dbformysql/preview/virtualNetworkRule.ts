...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/preview:VirtualNetworkRule';
    ...
    constructor(name: string, argsOrState?: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:VirtualNetworkRule" }, { type: "azurerm:dbformysql/v20171201:VirtualNetworkRule" }, { type: "azurerm:dbformysql/v20171201preview:VirtualNetworkRule" }] };
