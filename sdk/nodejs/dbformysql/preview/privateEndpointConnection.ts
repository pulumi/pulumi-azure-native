...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/preview:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.dbformysql.preview.PrivateEndpointPropertyResponse | undefined>;
    /**
     * Connection state of the private endpoint connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.dbformysql.preview.PrivateLinkServiceConnectionStatePropertyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:PrivateEndpointConnection" }, { type: "azurerm:dbformysql/v20180601:PrivateEndpointConnection" }, { type: "azurerm:dbformysql/v20180601privatepreview:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.dbformysql.preview.PrivateEndpointProperty>;
    readonly privateEndpointConnectionName: pulumi.Input<string>;
    /**
     * Connection state of the private endpoint connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.dbformysql.preview.PrivateLinkServiceConnectionStateProperty>;
    /**
