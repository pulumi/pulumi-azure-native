...
export class MaintenanceWindow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/preview:MaintenanceWindow';
    ...
    constructor(name: string, args: MaintenanceWindowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/v20200701privatepreview:MaintenanceWindow" }] };
