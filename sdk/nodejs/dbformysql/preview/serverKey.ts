...
export class ServerKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/preview:ServerKey';
    ...
    constructor(name: string, argsOrState?: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:ServerKey" }, { type: "azurerm:dbformysql/v20200101:ServerKey" }, { type: "azurerm:dbformysql/v20200101privatepreview:ServerKey" }] };
