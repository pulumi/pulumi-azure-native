...
export class ServerKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerKey {
        pulumi.log.warn("ServerKey is deprecated: azure-native:dbformysql/v20200101privatepreview:ServerKey is being removed in the next major version of this provider. Please upgrade to azure-native:dbformysql/v20200701privatepreview:ServerKey to guarantee forwards compatibility.")
