...
export class ServerKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbformysql/v20200101privatepreview:ServerKey';
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql/v20200101privatepreview:ServerKey" }, { type: "azure-native:dbformysql:ServerKey" }, { type: "azure-nextgen:dbformysql:ServerKey" }, { type: "azure-native:dbformysql/latest:ServerKey" }, { type: "azure-nextgen:dbformysql/latest:ServerKey" }, { type: "azure-native:dbformysql/v20200101:ServerKey" }, { type: "azure-nextgen:dbformysql/v20200101:ServerKey" }] };
...
export interface ServerKeyArgs {
     ...
     * The key type like 'AzureKeyVault'.
     */
    readonly serverKeyType: pulumi.Input<string | enums.dbformysql.v20200101privatepreview.ServerKeyType>;
    /**
