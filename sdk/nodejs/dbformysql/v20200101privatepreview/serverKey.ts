...
export class ServerKey extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:ServerKey" }, { type: "azurerm:dbformysql/preview:ServerKey" }, { type: "azurerm:dbformysql/v20200101:ServerKey" }] };
