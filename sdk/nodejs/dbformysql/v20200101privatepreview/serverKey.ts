 ...
 *
 * const serverKey = new azurerm.dbformysql.v20200101privatepreview.ServerKey("serverKey", {
...
export class ServerKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/v20200101privatepreview:ServerKey';
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:ServerKey" }, { type: "azurerm:dbformysql/v20200101:ServerKey" }] };
