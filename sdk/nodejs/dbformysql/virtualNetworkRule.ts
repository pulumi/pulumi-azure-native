...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbformysql:VirtualNetworkRule';
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql/latest:VirtualNetworkRule" }, { type: "azure-nextgen:dbformysql/v20171201:VirtualNetworkRule" }, { type: "azure-nextgen:dbformysql/v20171201preview:VirtualNetworkRule" }] };
