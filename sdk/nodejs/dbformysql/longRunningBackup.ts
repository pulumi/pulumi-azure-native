...
export class LongRunningBackup extends pulumi.CustomResource {
     ...
     * Backup name
     */
    declare public readonly backupNameV2: pulumi.Output<string | undefined>;
    declare public readonly backupType: pulumi.Output<string | undefined>;
    /**
     * Backup completed time (ISO8601 format).
     */
    declare public readonly completedTime: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: LongRunningBackupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["backupNameV2"] = args?.backupNameV2;
            resourceInputs["backupType"] = args?.backupType;
            resourceInputs["completedTime"] = args?.completedTime;
