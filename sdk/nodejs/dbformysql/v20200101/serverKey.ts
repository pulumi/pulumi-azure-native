...
export class ServerKey extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql:ServerKey" }, { type: "azure-nextgen:dbformysql:ServerKey" }, { type: "azure-native:dbformysql/latest:ServerKey" }, { type: "azure-nextgen:dbformysql/latest:ServerKey" }, { type: "azure-native:dbformysql/v20200101privatepreview:ServerKey" }, { type: "azure-nextgen:dbformysql/v20200101privatepreview:ServerKey" }] };
