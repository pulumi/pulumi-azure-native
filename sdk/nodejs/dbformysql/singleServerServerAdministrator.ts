...
export class SingleServerServerAdministrator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SingleServerServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql/v20171201:SingleServerServerAdministrator" }, { type: "azure-native:dbformysql/v20171201preview:SingleServerServerAdministrator" }, { type: "azure-native:dbformysql/v20180601privatepreview:SingleServerServerAdministrator" }] };
