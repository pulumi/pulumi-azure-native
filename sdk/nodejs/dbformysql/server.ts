...
export class Server extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql:Server" }, { type: "azure-native:dbformysql/latest:Server" }, { type: "azure-nextgen:dbformysql/latest:Server" }, { type: "azure-native:dbformysql/v20171201:Server" }, { type: "azure-nextgen:dbformysql/v20171201:Server" }, { type: "azure-native:dbformysql/v20171201preview:Server" }, { type: "azure-nextgen:dbformysql/v20171201preview:Server" }] };
...
export interface ServerArgs {
     ...
     * The Azure Active Directory identity of the server.
     */
    readonly identity?: pulumi.Input<inputs.dbformysql.ResourceIdentity>;
    /**
     ...
     */
    readonly properties: pulumi.Input<inputs.dbformysql.ServerPropertiesForDefaultCreate | inputs.dbformysql.ServerPropertiesForGeoRestore | inputs.dbformysql.ServerPropertiesForReplica | inputs.dbformysql.ServerPropertiesForRestore>;
    /**
     ...
     * The SKU (pricing tier) of the server.
     */
    readonly sku?: pulumi.Input<inputs.dbformysql.Sku>;
    /**
