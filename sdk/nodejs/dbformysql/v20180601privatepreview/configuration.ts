 ...
 *
 * const configuration = new azure_native.dbformysql.v20180601privatepreview.Configuration("configuration", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:dbformysql/v20180601privatepreview:Configuration event_scheduler /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforMySQL/servers/testserver/configurations/event_scheduler 
 * ```
 */
export class Configuration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbformysql/v20180601privatepreview:Configuration';
