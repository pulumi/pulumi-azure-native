 ...
 *
 * const serverAdministrator = new azure_native.dbformysql.v20180601privatepreview.ServerAdministrator("serverAdministrator", {
...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql:ServerAdministrator" }, { type: "azure-native:dbformysql/v20171201:ServerAdministrator" }, { type: "azure-native:dbformysql/v20171201preview:ServerAdministrator" }] };
