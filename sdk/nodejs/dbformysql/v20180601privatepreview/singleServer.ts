...
export class SingleServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbformysql/v20180601privatepreview:SingleServer';
     ...
     */
    public /*out*/ readonly identity!: pulumi.Output<outputs.dbformysql.v20180601privatepreview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.dbformysql.v20180601privatepreview.ServerPrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.dbformysql.v20180601privatepreview.SkuResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly storageProfile!: pulumi.Output<outputs.dbformysql.v20180601privatepreview.StorageProfileResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: SingleServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql/v20171201:Server" }, { type: "azure-native:dbformysql/v20171201:SingleServer" }, { type: "azure-native:dbformysql/v20171201preview:SingleServer" }, { type: "azure-native:dbformysql/v20180601privatepreview:Server" }, { type: "azure-native:dbformysql:SingleServer" }] };
...
export interface SingleServerArgs {
     ...
     */
    properties: pulumi.Input<inputs.dbformysql.v20180601privatepreview.ServerPropertiesForDefaultCreateArgs | inputs.dbformysql.v20180601privatepreview.ServerPropertiesForGeoRestoreArgs | inputs.dbformysql.v20180601privatepreview.ServerPropertiesForReplicaArgs | inputs.dbformysql.v20180601privatepreview.ServerPropertiesForRestoreArgs>;
    /**
     ...
     * The SKU (pricing tier) of the server.
     */
    sku?: pulumi.Input<inputs.dbformysql.v20180601privatepreview.SkuArgs>;
    /**
