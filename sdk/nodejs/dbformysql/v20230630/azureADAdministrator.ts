...
export class AzureADAdministrator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzureADAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20211201preview:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20220101:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20230601preview:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20231230:AzureADAdministrator" }] };
...
export interface AzureADAdministratorArgs {
     ...
     * Type of the sever administrator.
     */
    administratorType?: pulumi.Input<string | enums.dbformysql.v20230630.AdministratorType>;
    /**
     * The resource id of the identity used for AAD Authentication.
     */
