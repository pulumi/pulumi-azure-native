...
export class SingleServerVirtualNetworkRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SingleServerVirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql/v20171201:VirtualNetworkRule" }, { type: "azure-native:dbformysql/v20180601privatepreview:VirtualNetworkRule" }, { type: "azure-native_dbformysql_v20171201:dbformysql:SingleServerVirtualNetworkRule" }, { type: "azure-native_dbformysql_v20171201preview:dbformysql:SingleServerVirtualNetworkRule" }, { type: "azure-native_dbformysql_v20180601privatepreview:dbformysql:SingleServerVirtualNetworkRule" }] };
