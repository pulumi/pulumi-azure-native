 ...
 *
 * @deprecated azure-native:dbformysql/v20210501preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:dbformysql/v20220101:FirewallRule to guarantee forwards compatibility.
 */
export class FirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FirewallRule {
        pulumi.log.warn("FirewallRule is deprecated: azure-native:dbformysql/v20210501preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:dbformysql/v20220101:FirewallRule to guarantee forwards compatibility.")
