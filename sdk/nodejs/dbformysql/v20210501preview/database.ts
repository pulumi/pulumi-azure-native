...
export class Database extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql/v20210501preview:Database" }, { type: "azure-native:dbformysql/v20200701preview:Database" }, { type: "azure-nextgen:dbformysql/v20200701preview:Database" }, { type: "azure-native:dbformysql/v20200701privatepreview:Database" }, { type: "azure-nextgen:dbformysql/v20200701privatepreview:Database" }] };
