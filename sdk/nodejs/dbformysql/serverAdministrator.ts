...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql:ServerAdministrator';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.dbformysql.ServerAdministratorPropertiesResponse>;
    /**
...
export interface ServerAdministratorState {
     ...
     * Properties of the server AAD administrator.
     */
    readonly properties: pulumi.Input<inputs.dbformysql.ServerAdministratorPropertiesResponse>;
    /**
     * The type of the resource. Ex- Microsoft.Compute/virtualMachines or Microsoft.Storage/storageAccounts.
     */
...
export interface ServerAdministratorArgs {
     ...
     * Properties of the server AAD administrator.
     */
    readonly properties?: pulumi.Input<inputs.dbformysql.ServerAdministratorProperties>;
    /**
