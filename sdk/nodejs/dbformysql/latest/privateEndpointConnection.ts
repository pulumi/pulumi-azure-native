 ...
 *
 * const privateEndpointConnection = new azurerm.dbformysql.latest.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/latest:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/v20180601:PrivateEndpointConnection" }, { type: "azurerm:dbformysql/v20180601privatepreview:PrivateEndpointConnection" }] };
