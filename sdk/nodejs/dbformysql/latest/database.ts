...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/latest:Database';
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/preview:Database" }, { type: "azurerm:dbformysql/v20171201:Database" }, { type: "azurerm:dbformysql/v20171201preview:Database" }] };
