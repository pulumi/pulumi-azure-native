...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbformysql/latest:Server';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.dbformysql.latest.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.dbformysql.latest.ServerPrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.dbformysql.latest.SkuResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly storageProfile!: pulumi.Output<outputs.dbformysql.latest.StorageProfileResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql/latest:Server" }, { type: "azure-native:dbformysql:Server" }, { type: "azure-nextgen:dbformysql:Server" }, { type: "azure-native:dbformysql/v20171201:Server" }, { type: "azure-nextgen:dbformysql/v20171201:Server" }, { type: "azure-native:dbformysql/v20171201preview:Server" }, { type: "azure-nextgen:dbformysql/v20171201preview:Server" }] };
...
export interface ServerArgs {
     ...
     * The Azure Active Directory identity of the server.
     */
    readonly identity?: pulumi.Input<inputs.dbformysql.latest.ResourceIdentity>;
    /**
     ...
     */
    readonly properties: pulumi.Input<inputs.dbformysql.latest.ServerPropertiesForDefaultCreate | inputs.dbformysql.latest.ServerPropertiesForGeoRestore | inputs.dbformysql.latest.ServerPropertiesForReplica | inputs.dbformysql.latest.ServerPropertiesForRestore>;
    /**
     ...
     * The SKU (pricing tier) of the server.
     */
    readonly sku?: pulumi.Input<inputs.dbformysql.latest.Sku>;
    /**
