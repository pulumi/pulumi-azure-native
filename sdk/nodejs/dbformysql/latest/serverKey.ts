...
export class ServerKey extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/preview:ServerKey" }, { type: "azurerm:dbformysql/v20200101:ServerKey" }, { type: "azurerm:dbformysql/v20200101privatepreview:ServerKey" }] };
