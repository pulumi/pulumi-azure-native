...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/latest:ServerAdministrator';
    ...
    constructor(name: string, args: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/preview:ServerAdministrator" }, { type: "azurerm:dbformysql/v20171201:ServerAdministrator" }, { type: "azurerm:dbformysql/v20171201preview:ServerAdministrator" }] };
