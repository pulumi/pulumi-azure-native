...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/preview:VirtualNetworkRule" }, { type: "azurerm:dbformysql/v20171201:VirtualNetworkRule" }, { type: "azurerm:dbformysql/v20171201preview:VirtualNetworkRule" }] };
