...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbformysql/v20171201:ServerAdministrator';
    ...
    constructor(name: string, args: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql:ServerAdministrator" }, { type: "azure-nextgen:dbformysql/latest:ServerAdministrator" }, { type: "azure-nextgen:dbformysql/v20171201preview:ServerAdministrator" }] };
