...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/v20171201:ServerAdministrator';
    ...
    constructor(name: string, argsOrState?: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:ServerAdministrator" }, { type: "azurerm:dbformysql/preview:ServerAdministrator" }, { type: "azurerm:dbformysql/v20171201preview:ServerAdministrator" }] };
