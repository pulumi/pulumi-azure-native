 ...
 *
 * const server = new azure_native.dbformysql.v20171201.Server("server", {
 ...
 *         createMode: "Default",
 *         sslEnforcement: azure_native.dbformysql.v20171201.SslEnforcementEnum.Enabled,
 *         storageProfile: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:dbformysql/v20171201:Server targetserver /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/providers/Microsoft.DBforMySQL/servers/targetserver 
 * ```
 */
...
export interface ServerArgs {
     ...
     * The Azure Active Directory identity of the server.
     */
    identity?: pulumi.Input<inputs.dbformysql.v20171201.ResourceIdentityArgs>;
    /**
     ...
     */
    properties: pulumi.Input<inputs.dbformysql.v20171201.ServerPropertiesForDefaultCreateArgs | inputs.dbformysql.v20171201.ServerPropertiesForGeoRestoreArgs | inputs.dbformysql.v20171201.ServerPropertiesForReplicaArgs | inputs.dbformysql.v20171201.ServerPropertiesForRestoreArgs>;
    /**
     ...
     * The SKU (pricing tier) of the server.
     */
    sku?: pulumi.Input<inputs.dbformysql.v20171201.SkuArgs>;
    /**
