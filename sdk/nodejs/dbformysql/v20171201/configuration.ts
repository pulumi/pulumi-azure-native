...
export class Configuration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql:Configuration" }, { type: "azure-native:dbformysql/v20171201preview:Configuration" }, { type: "azure-native:dbformysql/v20180601privatepreview:Configuration" }] };
