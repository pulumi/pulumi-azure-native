...
export class FirewallRule extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:FirewallRule" }, { type: "azurerm:dbformysql/preview:FirewallRule" }, { type: "azurerm:dbformysql/v20171201preview:FirewallRule" }] };
