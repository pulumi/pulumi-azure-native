 ...
 *
 * const firewallRule = new azurerm.dbformysql.v20171201.FirewallRule("firewallRule", {
...
export class FirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/v20171201:FirewallRule';
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:FirewallRule" }, { type: "azurerm:dbformysql/v20171201preview:FirewallRule" }] };
