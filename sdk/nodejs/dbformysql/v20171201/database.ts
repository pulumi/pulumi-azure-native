 ...
 *
 * const database = new azurerm.dbformysql.v20171201.Database("database", {
 *     charset: "utf8",
...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/v20171201:Database';
    ...
    constructor(name: string, argsOrState?: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:Database" }, { type: "azurerm:dbformysql/v20171201preview:Database" }] };
