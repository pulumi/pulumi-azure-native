...
export class Database extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql:Database" }, { type: "azure-nextgen:dbformysql:Database" }, { type: "azure-native:dbformysql/latest:Database" }, { type: "azure-nextgen:dbformysql/latest:Database" }, { type: "azure-native:dbformysql/v20171201preview:Database" }, { type: "azure-nextgen:dbformysql/v20171201preview:Database" }] };
