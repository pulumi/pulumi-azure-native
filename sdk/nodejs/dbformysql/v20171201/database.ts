...
export class Database extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:Database" }, { type: "azurerm:dbformysql/preview:Database" }, { type: "azurerm:dbformysql/v20171201preview:Database" }] };
