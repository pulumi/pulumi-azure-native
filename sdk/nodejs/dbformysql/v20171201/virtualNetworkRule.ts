...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql/v20171201:VirtualNetworkRule" }, { type: "azure-native:dbformysql:VirtualNetworkRule" }, { type: "azure-nextgen:dbformysql:VirtualNetworkRule" }, { type: "azure-native:dbformysql/latest:VirtualNetworkRule" }, { type: "azure-nextgen:dbformysql/latest:VirtualNetworkRule" }, { type: "azure-native:dbformysql/v20171201preview:VirtualNetworkRule" }, { type: "azure-nextgen:dbformysql/v20171201preview:VirtualNetworkRule" }] };
