 ...
 *
 * const virtualNetworkRule = new azurerm.dbformysql.v20171201.VirtualNetworkRule("virtualNetworkRule", {
...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/v20171201:VirtualNetworkRule';
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:VirtualNetworkRule" }, { type: "azurerm:dbformysql/v20171201preview:VirtualNetworkRule" }] };
