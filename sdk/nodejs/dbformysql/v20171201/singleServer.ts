...
export class SingleServer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SingleServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql/v20171201preview:SingleServer" }, { type: "azure-native:dbformysql/v20180601privatepreview:SingleServer" }, { type: "azure-native:dbformysql:SingleServer" }] };
