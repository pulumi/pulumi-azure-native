...
export class SingleServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbformysql/v20171201:SingleServer';
    ...
    constructor(name: string, args: SingleServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql/v20171201:Server" }, { type: "azure-native:dbformysql/v20171201preview:SingleServer" }, { type: "azure-native:dbformysql/v20180601privatepreview:Server" }, { type: "azure-native:dbformysql/v20180601privatepreview:SingleServer" }, { type: "azure-native:dbformysql:SingleServer" }] };
