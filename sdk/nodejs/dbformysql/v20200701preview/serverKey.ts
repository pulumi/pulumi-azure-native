...
export class ServerKey extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql/v20200701privatepreview:ServerKey" }, { type: "azure-nextgen:dbformysql/v20200701privatepreview:ServerKey" }] };
