 ...
 *
 * const privateEndpointConnection = new azurerm.dbformysql.v20180601.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:dbformysql/v20180601:PrivateEndpointConnection';
    ...
    constructor(name: string, argsOrState?: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:dbformysql/latest:PrivateEndpointConnection" }, { type: "azurerm:dbformysql/v20180601privatepreview:PrivateEndpointConnection" }] };
