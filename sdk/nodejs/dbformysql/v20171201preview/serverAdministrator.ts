...
export class ServerAdministrator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql/v20171201preview:ServerAdministrator" }, { type: "azure-native:dbformysql:ServerAdministrator" }, { type: "azure-nextgen:dbformysql:ServerAdministrator" }, { type: "azure-native:dbformysql/v20171201:ServerAdministrator" }, { type: "azure-nextgen:dbformysql/v20171201:ServerAdministrator" }] };
...
export interface ServerAdministratorArgs {
     ...
     * The type of administrator.
     */
    administratorType: pulumi.Input<string | enums.dbformysql.v20171201preview.AdministratorType>;
    /**
     * The server administrator login account name.
     */
