...
// Export enums:
export * from "../../types/enums/dbformysql/v20171201preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dbformysql/v20171201preview:SingleServer":
                return new SingleServer(name, <any>undefined, { urn })
            case "azure-native:dbformysql/v20171201preview:SingleServerDatabase":
                return new SingleServerDatabase(name, <any>undefined, { urn })
            case "azure-native:dbformysql/v20171201preview:SingleServerFirewallRule":
                return new SingleServerFirewallRule(name, <any>undefined, { urn })
            case "azure-native:dbformysql/v20171201preview:SingleServerServerAdministrator":
                return new SingleServerServerAdministrator(name, <any>undefined, { urn })
            case "azure-native:dbformysql/v20171201preview:SingleServerVirtualNetworkRule":
