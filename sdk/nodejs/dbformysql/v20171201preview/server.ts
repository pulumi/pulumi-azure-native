...
export class Server extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql/v20171201preview:Server" }, { type: "azure-native:dbformysql:Server" }, { type: "azure-nextgen:dbformysql:Server" }, { type: "azure-native:dbformysql/latest:Server" }, { type: "azure-nextgen:dbformysql/latest:Server" }, { type: "azure-native:dbformysql/v20171201:Server" }, { type: "azure-nextgen:dbformysql/v20171201:Server" }] };
