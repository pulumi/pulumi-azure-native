...
export class Configuration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:dbformysql/v20171201preview:Configuration';
    ...
    constructor(name: string, args: ConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:dbformysql:Configuration" }, { type: "azure-nextgen:dbformysql/latest:Configuration" }, { type: "azure-nextgen:dbformysql/v20171201:Configuration" }] };
