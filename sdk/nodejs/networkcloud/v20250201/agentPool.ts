...
export class AgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20250201:AgentPool';
     ...
     */
    public readonly administratorConfiguration!: pulumi.Output<outputs.networkcloud.v20250201.AdministratorConfigurationResponse | undefined>;
    /**
     * The configurations that will be applied to each agent in this agent pool.
     */
    public readonly agentOptions!: pulumi.Output<outputs.networkcloud.v20250201.AgentOptionsResponse | undefined>;
    /**
     * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
     */
    public readonly attachedNetworkConfiguration!: pulumi.Output<outputs.networkcloud.v20250201.AttachedNetworkConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.networkcloud.v20250201.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<outputs.networkcloud.v20250201.KubernetesLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly taints!: pulumi.Output<outputs.networkcloud.v20250201.KubernetesLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly upgradeSettings!: pulumi.Output<outputs.networkcloud.v20250201.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["agentOptions"] = args ? (args.agentOptions ? pulumi.output(args.agentOptions).apply(inputs.networkcloud.v20250201.agentOptionsArgsProvideDefaults) : undefined) : undefined;
...
export interface AgentPoolArgs {
     ...
     * The configurations that will be applied to each agent in this agent pool.
     */
    agentOptions?: pulumi.Input<inputs.networkcloud.v20250201.AgentOptionsArgs>;
    /**
     ...
     * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
     */
    attachedNetworkConfiguration?: pulumi.Input<inputs.networkcloud.v20250201.AttachedNetworkConfigurationArgs>;
    /**
     * The list of availability zones of the Network Cloud cluster used for the provisioning of nodes in this agent pool. If not specified, all availability zones will be used.
     */
     ...
     * The labels applied to the nodes in this agent pool.
     */
    labels?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20250201.KubernetesLabelArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The selection of how this agent pool is utilized, either as a system pool or a user pool. System pools run the features and critical services for the Kubernetes Cluster, while user pools are dedicated to user workloads. Every Kubernetes cluster must contain at least one system node pool with at least one node.
     */
    mode: pulumi.Input<string | enums.networkcloud.v20250201.AgentPoolMode>;
    /**
     ...
     * The taints applied to the nodes in this agent pool.
     */
    taints?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20250201.KubernetesLabelArgs>[]>;
    /**
     * The configuration of the agent pool.
     */
    upgradeSettings?: pulumi.Input<inputs.networkcloud.v20250201.AgentPoolUpgradeSettingsArgs>;
    /**
     * The name of the VM SKU that determines the size of resources allocated for node VMs.
     */
