...
export function getClusterManager(args: GetClusterManagerArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterManagerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20250201:getClusterManager", {
...
export interface GetClusterManagerResult {
     ...
     */
    readonly clusterVersions: outputs.networkcloud.v20250201.ClusterAvailableVersionResponse[];
    /**
     ...
     */
    readonly managerExtendedLocation: outputs.networkcloud.v20250201.ExtendedLocationResponse;
    /**
...
export function getClusterManagerOutput(args: GetClusterManagerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterManagerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:networkcloud/v20250201:getClusterManager", {
        "clusterManagerName": args.clusterManagerName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
