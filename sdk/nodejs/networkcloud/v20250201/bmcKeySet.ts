...
export class BmcKeySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20250201:BmcKeySet';
     ...
     */
    public readonly userList!: pulumi.Output<outputs.networkcloud.v20250201.KeySetUserResponse[]>;
    /**
     * The status evaluation of each user.
     */
    public /*out*/ readonly userListStatus!: pulumi.Output<outputs.networkcloud.v20250201.KeySetUserStatusResponse[]>;
...
export interface BmcKeySetArgs {
     ...
     * The access level allowed for the users in this key set.
     */
    privilegeLevel: pulumi.Input<string | enums.networkcloud.v20250201.BmcKeySetPrivilegeLevel>;
    /**
     ...
     * The unique list of permitted users.
     */
    userList: pulumi.Input<pulumi.Input<inputs.networkcloud.v20250201.KeySetUserArgs>[]>;
}
