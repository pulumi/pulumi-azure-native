...
export class KubernetesCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20250201:KubernetesCluster';
     ...
     */
    public readonly aadConfiguration!: pulumi.Output<outputs.networkcloud.v20250201.AadConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly availableUpgrades!: pulumi.Output<outputs.networkcloud.v20250201.AvailableUpgradeResponse[]>;
    /**
     ...
     */
    public readonly controlPlaneNodeConfiguration!: pulumi.Output<outputs.networkcloud.v20250201.ControlPlaneNodeConfigurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly featureStatuses!: pulumi.Output<outputs.networkcloud.v20250201.FeatureStatusResponse[]>;
    /**
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    public readonly initialAgentPoolConfigurations!: pulumi.Output<outputs.networkcloud.v20250201.InitialAgentPoolConfigurationResponse[]>;
    /**
     ...
     */
    public readonly networkConfiguration!: pulumi.Output<outputs.networkcloud.v20250201.NetworkConfigurationResponse>;
    /**
     * The details of the nodes in this cluster.
     */
    public /*out*/ readonly nodes!: pulumi.Output<outputs.networkcloud.v20250201.KubernetesClusterNodeResponse[]>;
    /**
    ...
    constructor(name: string, args: KubernetesClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkConfiguration"] = args ? (args.networkConfiguration ? pulumi.output(args.networkConfiguration).apply(inputs.networkcloud.v20250201.networkConfigurationArgsProvideDefaults) : undefined) : undefined;
