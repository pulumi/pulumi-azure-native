...
export function getKubernetesCluster(args: GetKubernetesClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetKubernetesClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20250201:getKubernetesCluster", {
...
export interface GetKubernetesClusterResult {
     ...
     */
    readonly aadConfiguration?: outputs.networkcloud.v20250201.AadConfigurationResponse;
    /**
     ...
     */
    readonly administratorConfiguration?: outputs.networkcloud.v20250201.AdministratorConfigurationResponse;
    /**
     ...
     */
    readonly availableUpgrades: outputs.networkcloud.v20250201.AvailableUpgradeResponse[];
    /**
     ...
     */
    readonly controlPlaneNodeConfiguration: outputs.networkcloud.v20250201.ControlPlaneNodeConfigurationResponse;
    /**
     ...
     */
    readonly featureStatuses: outputs.networkcloud.v20250201.FeatureStatusResponse[];
    /**
     ...
     */
    readonly initialAgentPoolConfigurations: outputs.networkcloud.v20250201.InitialAgentPoolConfigurationResponse[];
    /**
     ...
     */
    readonly networkConfiguration: outputs.networkcloud.v20250201.NetworkConfigurationResponse;
    /**
     * The details of the nodes in this cluster.
     */
    readonly nodes: outputs.networkcloud.v20250201.KubernetesClusterNodeResponse[];
    /**
...
export function getKubernetesClusterOutput(args: GetKubernetesClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetKubernetesClusterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:networkcloud/v20250201:getKubernetesCluster", {
        "kubernetesClusterName": args.kubernetesClusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
