...
export class KubernetesClusterFeature extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20250201:KubernetesClusterFeature';
     ...
     */
    public readonly options!: pulumi.Output<outputs.networkcloud.v20250201.StringKeyValuePairResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.networkcloud.v20250201.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: KubernetesClusterFeatureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20240601preview:KubernetesClusterFeature" }, { type: "azure-native:networkcloud/v20240701:KubernetesClusterFeature" }, { type: "azure-native:networkcloud/v20241001preview:KubernetesClusterFeature" }, { type: "azure-native:networkcloud:KubernetesClusterFeature" }] };
...
export interface KubernetesClusterFeatureArgs {
     ...
     * The configured options for the feature.
     */
    options?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20250201.StringKeyValuePairArgs>[]>;
    /**
