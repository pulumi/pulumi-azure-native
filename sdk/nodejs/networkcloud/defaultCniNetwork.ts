...
export class DefaultCniNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.DefaultCniNetworkPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DefaultCniNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.networkcloud.defaultCniNetworkPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface DefaultCniNetworkArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.DefaultCniNetworkPropertiesArgs>;
    /**
