...
export class BmcKeySet extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.BmcKeySetPropertiesResponse>;
    /**
...
export interface BmcKeySetArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.BmcKeySetPropertiesArgs>;
    /**
