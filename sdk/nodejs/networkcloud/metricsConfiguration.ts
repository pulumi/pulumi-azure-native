...
export class MetricsConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.ClusterMetricsConfigurationPropertiesResponse>;
    /**
...
export interface MetricsConfigurationArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.ClusterMetricsConfigurationPropertiesArgs>;
    /**
