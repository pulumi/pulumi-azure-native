...
export class StorageAppliance extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.StorageAppliancePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: StorageApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20221212preview:StorageAppliance" }] };
...
export interface StorageApplianceArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.StorageAppliancePropertiesArgs>;
    /**
