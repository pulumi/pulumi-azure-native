...
export class Console extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.ConsolePropertiesResponse>;
    /**
...
export interface ConsoleArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.ConsolePropertiesArgs>;
    /**
