...
export class BareMetalMachine extends pulumi.CustomResource {
     ...
     */
    public readonly bmcCredentials!: pulumi.Output<outputs.networkcloud.v20230501preview.AdministrativeCredentialsResponse>;
    /**
     ...
     */
    public /*out*/ readonly hardwareInventory!: pulumi.Output<outputs.networkcloud.v20230501preview.HardwareInventoryResponse>;
    /**
     * The details of the latest hardware validation performed for this bare metal machine.
     */
    public /*out*/ readonly hardwareValidationStatus!: pulumi.Output<outputs.networkcloud.v20230501preview.HardwareValidationStatusResponse>;
    /**
    ...
    constructor(name: string, args: BareMetalMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BareMetalMachine" }, { type: "azure-native:networkcloud/v20221212preview:BareMetalMachine" }] };
