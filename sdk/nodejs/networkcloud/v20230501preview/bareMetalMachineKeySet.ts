...
export class BareMetalMachineKeySet extends pulumi.CustomResource {
     ...
     */
    public readonly userList!: pulumi.Output<outputs.networkcloud.v20230501preview.KeySetUserResponse[]>;
    /**
     * The status evaluation of each user.
     */
    public /*out*/ readonly userListStatus!: pulumi.Output<outputs.networkcloud.v20230501preview.KeySetUserStatusResponse[]>;
    ...
    constructor(name: string, args: BareMetalMachineKeySetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BareMetalMachineKeySet" }, { type: "azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet" }] };
