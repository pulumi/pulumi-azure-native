...
export class StorageAppliance extends pulumi.CustomResource {
     ...
     */
    public readonly administratorCredentials!: pulumi.Output<outputs.networkcloud.v20230501preview.AdministrativeCredentialsResponse>;
    /**
    ...
    constructor(name: string, args: StorageApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:StorageAppliance" }, { type: "azure-native:networkcloud/v20221212preview:StorageAppliance" }] };
...
export interface StorageApplianceArgs {
     ...
     * The credentials of the administrative interface on this storage appliance.
     */
    administratorCredentials: pulumi.Input<inputs.networkcloud.v20230501preview.AdministrativeCredentialsArgs>;
    /**
     * The extended location of the cluster associated with the resource.
     */
