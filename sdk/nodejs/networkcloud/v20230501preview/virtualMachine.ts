...
export class VirtualMachine extends pulumi.CustomResource {
     ...
     */
    public readonly cloudServicesNetworkAttachment!: pulumi.Output<outputs.networkcloud.v20230501preview.NetworkAttachmentResponse>;
    /**
     ...
     */
    public readonly networkAttachments!: pulumi.Output<outputs.networkcloud.v20230501preview.NetworkAttachmentResponse[] | undefined>;
    /**
     ...
     */
    public readonly placementHints!: pulumi.Output<outputs.networkcloud.v20230501preview.VirtualMachinePlacementHintResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshPublicKeys!: pulumi.Output<outputs.networkcloud.v20230501preview.SshPublicKeyResponse[] | undefined>;
    /**
     * The storage profile that specifies size and other parameters about the disks related to the virtual machine.
     */
    public readonly storageProfile!: pulumi.Output<outputs.networkcloud.v20230501preview.StorageProfileResponse>;
    /**
     ...
     */
    public readonly vmImageRepositoryCredentials!: pulumi.Output<outputs.networkcloud.v20230501preview.ImageRepositoryCredentialsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["storageProfile"] = args ? (args.storageProfile ? pulumi.output(args.storageProfile).apply(inputs.networkcloud.v20230501preview.storageProfileArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:VirtualMachine" }, { type: "azure-native:networkcloud/v20221212preview:VirtualMachine" }] };
...
export interface VirtualMachineArgs {
     ...
     * Selects the boot method for the virtual machine.
     */
    bootMethod?: pulumi.Input<string | enums.networkcloud.v20230501preview.VirtualMachineBootMethod>;
    /**
     * The cloud service network that provides platform-level services for the virtual machine.
     */
    cloudServicesNetworkAttachment: pulumi.Input<inputs.networkcloud.v20230501preview.NetworkAttachmentArgs>;
    /**
     * The number of CPU cores in the virtual machine.
     */
     ...
     * Field Deprecated, the value will be ignored if provided. The indicator of whether one of the specified CPU cores is isolated to run the emulator thread for this virtual machine.
     */
    isolateEmulatorThread?: pulumi.Input<string | enums.networkcloud.v20230501preview.VirtualMachineIsolateEmulatorThread>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The list of network attachments to the virtual machine.
     */
    networkAttachments?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20230501preview.NetworkAttachmentArgs>[]>;
    /**
     * The Base64 encoded cloud-init network data.
     */
     ...
     * The scheduling hints for the virtual machine.
     */
    placementHints?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20230501preview.VirtualMachinePlacementHintArgs>[]>;
    /**
     ...
     * The list of ssh public keys. Each key will be added to the virtual machine using the cloud-init ssh_authorized_keys mechanism for the adminUsername.
     */
    sshPublicKeys?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20230501preview.SshPublicKeyArgs>[]>;
    /**
     * The storage profile that specifies size and other parameters about the disks related to the virtual machine.
     */
    storageProfile: pulumi.Input<inputs.networkcloud.v20230501preview.StorageProfileArgs>;
    /**
     * Resource tags.
     */
     ...
     * Field Deprecated, use virtualizationModel instead. The type of the virtio interface.
     */
    virtioInterface?: pulumi.Input<string | enums.networkcloud.v20230501preview.VirtualMachineVirtioInterfaceType>;
    /**
     ...
     * The type of the device model to use.
     */
    vmDeviceModel?: pulumi.Input<string | enums.networkcloud.v20230501preview.VirtualMachineDeviceModelType>;
    /**
     * The virtual machine image that is currently provisioned to the OS disk, using the full url and tag notation used to pull the image.
     */
     ...
     * The credentials used to login to the image repository that has access to the specified image.
     */
    vmImageRepositoryCredentials?: pulumi.Input<inputs.networkcloud.v20230501preview.ImageRepositoryCredentialsArgs>;
}
