...
export class ClusterManager extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly clusterVersions!: pulumi.Output<outputs.networkcloud.v20230501preview.ClusterAvailableVersionResponse[]>;
    /**
     ...
     */
    public readonly managedResourceGroupConfiguration!: pulumi.Output<outputs.networkcloud.v20230501preview.ManagedResourceGroupConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly managerExtendedLocation!: pulumi.Output<outputs.networkcloud.v20230501preview.ExtendedLocationResponse>;
    /**
    ...
    constructor(name: string, args: ClusterManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:ClusterManager" }, { type: "azure-native:networkcloud/v20221212preview:ClusterManager" }] };
...
export interface ClusterManagerArgs {
     ...
     * The configuration of the managed resource group associated with the resource.
     */
    managedResourceGroupConfiguration?: pulumi.Input<inputs.networkcloud.v20230501preview.ManagedResourceGroupConfigurationArgs>;
    /**
