...
export class Console extends pulumi.CustomResource {
     ...
     */
    public readonly sshPublicKey!: pulumi.Output<outputs.networkcloud.v20230501preview.SshPublicKeyResponse>;
    /**
    ...
    constructor(name: string, args: ConsoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:Console" }, { type: "azure-native:networkcloud/v20221212preview:Console" }] };
