...
export class CloudServicesNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly additionalEgressEndpoints!: pulumi.Output<outputs.networkcloud.v20230501preview.EgressEndpointResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly enabledEgressEndpoints!: pulumi.Output<outputs.networkcloud.v20230501preview.EgressEndpointResponse[]>;
    /**
    ...
    constructor(name: string, args: CloudServicesNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:CloudServicesNetwork" }, { type: "azure-native:networkcloud/v20221212preview:CloudServicesNetwork" }] };
...
export interface CloudServicesNetworkArgs {
     ...
     * The list of egress endpoints. This allows for connection from a Hybrid AKS cluster to the specified endpoint.
     */
    additionalEgressEndpoints?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20230501preview.EgressEndpointArgs>[]>;
    /**
     ...
     * The indicator of whether the platform default endpoints are allowed for the egress traffic.
     */
    enableDefaultEgressEndpoints?: pulumi.Input<string | enums.networkcloud.v20230501preview.CloudServicesNetworkEnableDefaultEgressEndpoints>;
    /**
     * The extended location of the cluster associated with the resource.
     */
