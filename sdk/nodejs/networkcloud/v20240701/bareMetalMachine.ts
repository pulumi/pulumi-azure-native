...
export class BareMetalMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20240701:BareMetalMachine';
     ...
     */
    public readonly bmcCredentials!: pulumi.Output<outputs.networkcloud.v20240701.AdministrativeCredentialsResponse>;
    /**
     ...
     */
    public /*out*/ readonly hardwareInventory!: pulumi.Output<outputs.networkcloud.v20240701.HardwareInventoryResponse>;
    /**
     * The details of the latest hardware validation performed for this bare metal machine.
     */
    public /*out*/ readonly hardwareValidationStatus!: pulumi.Output<outputs.networkcloud.v20240701.HardwareValidationStatusResponse>;
    /**
     ...
     */
    public /*out*/ readonly runtimeProtectionStatus!: pulumi.Output<outputs.networkcloud.v20240701.RuntimeProtectionStatusResponse>;
    /**
     * The list of statuses that represent secret rotation activity.
     */
    public /*out*/ readonly secretRotationStatus!: pulumi.Output<outputs.networkcloud.v20240701.SecretRotationStatusResponse[]>;
    /**
    ...
    constructor(name: string, args: BareMetalMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BareMetalMachine" }, { type: "azure-native:networkcloud/v20230701:BareMetalMachine" }, { type: "azure-native:networkcloud/v20231001preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20240601preview:BareMetalMachine" }] };
