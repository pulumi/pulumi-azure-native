...
export class Console extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20240701:Console';
     ...
     */
    public readonly sshPublicKey!: pulumi.Output<outputs.networkcloud.v20240701.SshPublicKeyResponse>;
    /**
    ...
    constructor(name: string, args: ConsoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20230701:Console" }, { type: "azure-native:networkcloud/v20231001preview:Console" }, { type: "azure-native:networkcloud/v20240601preview:Console" }, { type: "azure-native:networkcloud/v20241001preview:Console" }, { type: "azure-native:networkcloud:Console" }] };
...
export interface ConsoleArgs {
     ...
     * The indicator of whether the console access is enabled.
     */
    enabled: pulumi.Input<string | enums.networkcloud.v20240701.ConsoleEnabled>;
    /**
     * The date and time after which the key will be disallowed access.
     */
     ...
     * The SSH public key that will be provisioned for user access. The user is expected to have the corresponding SSH private key for logging in.
     */
    sshPublicKey: pulumi.Input<inputs.networkcloud.v20240701.SshPublicKeyArgs>;
    /**
     * Resource tags.
     */
