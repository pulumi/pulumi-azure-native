...
export function getClusterManager(args: GetClusterManagerArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterManagerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20240701:getClusterManager", {
...
export interface GetClusterManagerResult {
     ...
     */
    readonly clusterVersions: outputs.networkcloud.v20240701.ClusterAvailableVersionResponse[];
    /**
     ...
     */
    readonly identity?: outputs.networkcloud.v20240701.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly managedResourceGroupConfiguration?: outputs.networkcloud.v20240701.ManagedResourceGroupConfigurationResponse;
    /**
     ...
     */
    readonly managerExtendedLocation: outputs.networkcloud.v20240701.ExtendedLocationResponse;
    /**
