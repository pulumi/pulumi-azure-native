...
export class ClusterManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20240701:ClusterManager';
     ...
     */
    public /*out*/ readonly clusterVersions!: pulumi.Output<outputs.networkcloud.v20240701.ClusterAvailableVersionResponse[]>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.networkcloud.v20240701.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly managedResourceGroupConfiguration!: pulumi.Output<outputs.networkcloud.v20240701.ManagedResourceGroupConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly managerExtendedLocation!: pulumi.Output<outputs.networkcloud.v20240701.ExtendedLocationResponse>;
    /**
    ...
    constructor(name: string, args: ClusterManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:ClusterManager" }, { type: "azure-native:networkcloud/v20230701:ClusterManager" }, { type: "azure-native:networkcloud/v20231001preview:ClusterManager" }, { type: "azure-native:networkcloud/v20240601preview:ClusterManager" }, { type: "azure-native:networkcloud/v20241001preview:ClusterManager" }] };
