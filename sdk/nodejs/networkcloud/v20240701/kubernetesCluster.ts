...
export class KubernetesCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20240701:KubernetesCluster';
     ...
     */
    public readonly aadConfiguration!: pulumi.Output<outputs.networkcloud.v20240701.AadConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly administratorConfiguration!: pulumi.Output<outputs.networkcloud.v20240701.AdministratorConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly availableUpgrades!: pulumi.Output<outputs.networkcloud.v20240701.AvailableUpgradeResponse[]>;
    /**
     ...
     */
    public readonly controlPlaneNodeConfiguration!: pulumi.Output<outputs.networkcloud.v20240701.ControlPlaneNodeConfigurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly featureStatuses!: pulumi.Output<outputs.networkcloud.v20240701.FeatureStatusResponse[]>;
    /**
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    public readonly initialAgentPoolConfigurations!: pulumi.Output<outputs.networkcloud.v20240701.InitialAgentPoolConfigurationResponse[]>;
    /**
     ...
     */
    public readonly networkConfiguration!: pulumi.Output<outputs.networkcloud.v20240701.NetworkConfigurationResponse>;
    /**
     * The details of the nodes in this cluster.
     */
    public /*out*/ readonly nodes!: pulumi.Output<outputs.networkcloud.v20240701.KubernetesClusterNodeResponse[]>;
    /**
    ...
    constructor(name: string, args: KubernetesClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:KubernetesCluster" }, { type: "azure-native:networkcloud/v20230701:KubernetesCluster" }, { type: "azure-native:networkcloud/v20231001preview:KubernetesCluster" }, { type: "azure-native:networkcloud/v20240601preview:KubernetesCluster" }] };
