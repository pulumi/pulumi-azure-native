...
// Export enums:
export * from "../../types/enums/networkcloud/v20240701";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:networkcloud/v20240701:AgentPool":
                return new AgentPool(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:BareMetalMachine":
                return new BareMetalMachine(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:BareMetalMachineKeySet":
                return new BareMetalMachineKeySet(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:BmcKeySet":
                return new BmcKeySet(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:CloudServicesNetwork":
                return new CloudServicesNetwork(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:ClusterManager":
                return new ClusterManager(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:Console":
                return new Console(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:KubernetesCluster":
                return new KubernetesCluster(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:KubernetesClusterFeature":
                return new KubernetesClusterFeature(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:L2Network":
                return new L2Network(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:L3Network":
                return new L3Network(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:MetricsConfiguration":
                return new MetricsConfiguration(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:Rack":
                return new Rack(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:StorageAppliance":
                return new StorageAppliance(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:TrunkedNetwork":
                return new TrunkedNetwork(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:VirtualMachine":
                return new VirtualMachine(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20240701:Volume":
...
pulumi.runtime.registerResourceModule("azure-native", "networkcloud/v20240701", _module)
