...
export class KubernetesCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20241001preview:KubernetesCluster';
     ...
     */
    public readonly aadConfiguration!: pulumi.Output<outputs.networkcloud.v20241001preview.AadConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly administratorConfiguration!: pulumi.Output<outputs.networkcloud.v20241001preview.AdministratorConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly availableUpgrades!: pulumi.Output<outputs.networkcloud.v20241001preview.AvailableUpgradeResponse[]>;
    /**
     ...
     */
    public readonly controlPlaneNodeConfiguration!: pulumi.Output<outputs.networkcloud.v20241001preview.ControlPlaneNodeConfigurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly featureStatuses!: pulumi.Output<outputs.networkcloud.v20241001preview.FeatureStatusResponse[]>;
    /**
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    public readonly initialAgentPoolConfigurations!: pulumi.Output<outputs.networkcloud.v20241001preview.InitialAgentPoolConfigurationResponse[]>;
    /**
     ...
     */
    public readonly managedResourceGroupConfiguration!: pulumi.Output<outputs.networkcloud.v20241001preview.ManagedResourceGroupConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly networkConfiguration!: pulumi.Output<outputs.networkcloud.v20241001preview.NetworkConfigurationResponse>;
    /**
     * The details of the nodes in this cluster.
     */
    public /*out*/ readonly nodes!: pulumi.Output<outputs.networkcloud.v20241001preview.KubernetesClusterNodeResponse[]>;
    /**
    ...
    constructor(name: string, args: KubernetesClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkConfiguration"] = args ? (args.networkConfiguration ? pulumi.output(args.networkConfiguration).apply(inputs.networkcloud.v20241001preview.networkConfigurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:KubernetesCluster" }, { type: "azure-native:networkcloud/v20230701:KubernetesCluster" }, { type: "azure-native:networkcloud/v20231001preview:KubernetesCluster" }, { type: "azure-native:networkcloud/v20240601preview:KubernetesCluster" }, { type: "azure-native:networkcloud/v20240701:KubernetesCluster" }] };
...
export interface KubernetesClusterArgs {
     ...
     * The Azure Active Directory Integration properties.
     */
    aadConfiguration?: pulumi.Input<inputs.networkcloud.v20241001preview.AadConfigurationArgs>;
    /**
     * The administrative credentials that will be applied to the control plane and agent pool nodes that do not specify their own values.
     */
    administratorConfiguration?: pulumi.Input<inputs.networkcloud.v20241001preview.AdministratorConfigurationArgs>;
    /**
     * The defining characteristics of the control plane for this Kubernetes Cluster.
     */
    controlPlaneNodeConfiguration: pulumi.Input<inputs.networkcloud.v20241001preview.ControlPlaneNodeConfigurationArgs>;
    /**
     * The extended location of the cluster associated with the resource.
     */
     ...
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    initialAgentPoolConfigurations: pulumi.Input<pulumi.Input<inputs.networkcloud.v20241001preview.InitialAgentPoolConfigurationArgs>[]>;
    /**
     ...
     * The configuration of the managed resource group associated with the resource.
     */
    managedResourceGroupConfiguration?: pulumi.Input<inputs.networkcloud.v20241001preview.ManagedResourceGroupConfigurationArgs>;
    /**
     * The configuration of the Kubernetes cluster networking, including the attachment of networks that span the cluster.
     */
    networkConfiguration: pulumi.Input<inputs.networkcloud.v20241001preview.NetworkConfigurationArgs>;
    /**
