...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20241001preview:VirtualMachine';
     ...
     */
    public readonly cloudServicesNetworkAttachment!: pulumi.Output<outputs.networkcloud.v20241001preview.NetworkAttachmentResponse>;
    /**
     ...
     */
    public readonly consoleExtendedLocation!: pulumi.Output<outputs.networkcloud.v20241001preview.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly networkAttachments!: pulumi.Output<outputs.networkcloud.v20241001preview.NetworkAttachmentResponse[] | undefined>;
    /**
     ...
     */
    public readonly placementHints!: pulumi.Output<outputs.networkcloud.v20241001preview.VirtualMachinePlacementHintResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshPublicKeys!: pulumi.Output<outputs.networkcloud.v20241001preview.SshPublicKeyResponse[] | undefined>;
    /**
     * The storage profile that specifies size and other parameters about the disks related to the virtual machine.
     */
    public readonly storageProfile!: pulumi.Output<outputs.networkcloud.v20241001preview.StorageProfileResponse>;
    /**
     ...
     */
    public readonly vmImageRepositoryCredentials!: pulumi.Output<outputs.networkcloud.v20241001preview.ImageRepositoryCredentialsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["storageProfile"] = args ? (args.storageProfile ? pulumi.output(args.storageProfile).apply(inputs.networkcloud.v20241001preview.storageProfileArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:VirtualMachine" }, { type: "azure-native:networkcloud/v20230701:VirtualMachine" }, { type: "azure-native:networkcloud/v20231001preview:VirtualMachine" }, { type: "azure-native:networkcloud/v20240601preview:VirtualMachine" }, { type: "azure-native:networkcloud/v20240701:VirtualMachine" }] };
...
export interface VirtualMachineArgs {
     ...
     * Selects the boot method for the virtual machine.
     */
    bootMethod?: pulumi.Input<string | enums.networkcloud.v20241001preview.VirtualMachineBootMethod>;
    /**
     * The cloud service network that provides platform-level services for the virtual machine.
     */
    cloudServicesNetworkAttachment: pulumi.Input<inputs.networkcloud.v20241001preview.NetworkAttachmentArgs>;
    /**
     * The extended location to use for creation of a VM console resource.
     */
    consoleExtendedLocation?: pulumi.Input<inputs.networkcloud.v20241001preview.ExtendedLocationArgs>;
    /**
     * The number of CPU cores in the virtual machine.
     */
     ...
     * Field Deprecated, the value will be ignored if provided. The indicator of whether one of the specified CPU cores is isolated to run the emulator thread for this virtual machine.
     */
    isolateEmulatorThread?: pulumi.Input<string | enums.networkcloud.v20241001preview.VirtualMachineIsolateEmulatorThread>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The list of network attachments to the virtual machine.
     */
    networkAttachments?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20241001preview.NetworkAttachmentArgs>[]>;
    /**
     * The Base64 encoded cloud-init network data.
     */
     ...
     * The scheduling hints for the virtual machine.
     */
    placementHints?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20241001preview.VirtualMachinePlacementHintArgs>[]>;
    /**
     ...
     * The list of ssh public keys. Each key will be added to the virtual machine using the cloud-init ssh_authorized_keys mechanism for the adminUsername.
     */
    sshPublicKeys?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20241001preview.SshPublicKeyArgs>[]>;
    /**
     * The storage profile that specifies size and other parameters about the disks related to the virtual machine.
     */
    storageProfile: pulumi.Input<inputs.networkcloud.v20241001preview.StorageProfileArgs>;
    /**
     * Resource tags.
     */
     ...
     * Field Deprecated, use virtualizationModel instead. The type of the virtio interface.
     */
    virtioInterface?: pulumi.Input<string | enums.networkcloud.v20241001preview.VirtualMachineVirtioInterfaceType>;
    /**
     ...
     * The type of the device model to use.
     */
    vmDeviceModel?: pulumi.Input<string | enums.networkcloud.v20241001preview.VirtualMachineDeviceModelType>;
    /**
     * The virtual machine image that is currently provisioned to the OS disk, using the full url and tag notation used to pull the image.
     */
     ...
     * The credentials used to login to the image repository that has access to the specified image.
     */
    vmImageRepositoryCredentials?: pulumi.Input<inputs.networkcloud.v20241001preview.ImageRepositoryCredentialsArgs>;
}
