...
export class KubernetesClusterFeature extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KubernetesClusterFeatureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:KubernetesClusterFeature" }, { type: "azure-native:networkcloud/v20240601preview:KubernetesClusterFeature" }, { type: "azure-native:networkcloud/v20240701:KubernetesClusterFeature" }] };
