...
export class KubernetesVersion extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KubernetesVersion {
        return new KubernetesVersion(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud:KubernetesVersion';
     ...
     */
    declare public /*out*/ readonly values: pulumi.Output<outputs.networkcloud.KubernetesVersionValueResponse[]>;
    ...
    constructor(name: string, args: KubernetesVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kubernetesVersionName"] = args?.kubernetesVersionName;
