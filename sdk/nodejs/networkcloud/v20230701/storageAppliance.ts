...
export class StorageAppliance extends pulumi.CustomResource {
     ...
     */
    public readonly administratorCredentials!: pulumi.Output<outputs.networkcloud.v20230701.AdministrativeCredentialsResponse>;
    /**
    ...
    constructor(name: string, args: StorageApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:StorageAppliance" }, { type: "azure-native:networkcloud/v20231001preview:StorageAppliance" }, { type: "azure-native:networkcloud/v20240601preview:StorageAppliance" }, { type: "azure-native:networkcloud/v20240701:StorageAppliance" }] };
...
export interface StorageApplianceArgs {
     ...
     * The credentials of the administrative interface on this storage appliance.
     */
    administratorCredentials: pulumi.Input<inputs.networkcloud.v20230701.AdministrativeCredentialsArgs>;
    /**
     * The extended location of the cluster associated with the resource.
     */
