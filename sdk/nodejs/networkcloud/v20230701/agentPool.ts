...
export class AgentPool extends pulumi.CustomResource {
     ...
     */
    public readonly administratorConfiguration!: pulumi.Output<outputs.networkcloud.v20230701.AdministratorConfigurationResponse | undefined>;
    /**
     * The configurations that will be applied to each agent in this agent pool.
     */
    public readonly agentOptions!: pulumi.Output<outputs.networkcloud.v20230701.AgentOptionsResponse | undefined>;
    /**
     * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
     */
    public readonly attachedNetworkConfiguration!: pulumi.Output<outputs.networkcloud.v20230701.AttachedNetworkConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<outputs.networkcloud.v20230701.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<outputs.networkcloud.v20230701.KubernetesLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly taints!: pulumi.Output<outputs.networkcloud.v20230701.KubernetesLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly upgradeSettings!: pulumi.Output<outputs.networkcloud.v20230701.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["agentOptions"] = args ? (args.agentOptions ? pulumi.output(args.agentOptions).apply(inputs.networkcloud.v20230701.agentOptionsArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["upgradeSettings"] = args ? (args.upgradeSettings ? pulumi.output(args.upgradeSettings).apply(inputs.networkcloud.v20230701.agentPoolUpgradeSettingsArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20231001preview:AgentPool" }, { type: "azure-native:networkcloud/v20240601preview:AgentPool" }, { type: "azure-native:networkcloud/v20240701:AgentPool" }, { type: "azure-native:networkcloud/v20241001preview:AgentPool" }, { type: "azure-native:networkcloud/v20250201:AgentPool" }, { type: "azure-native:networkcloud:AgentPool" }] };
