...
export class BareMetalMachine extends pulumi.CustomResource {
     ...
     */
    public readonly bmcCredentials!: pulumi.Output<outputs.networkcloud.v20230701.AdministrativeCredentialsResponse>;
    /**
     ...
     */
    public /*out*/ readonly hardwareInventory!: pulumi.Output<outputs.networkcloud.v20230701.HardwareInventoryResponse>;
    /**
     * The details of the latest hardware validation performed for this bare metal machine.
     */
    public /*out*/ readonly hardwareValidationStatus!: pulumi.Output<outputs.networkcloud.v20230701.HardwareValidationStatusResponse>;
    /**
    ...
    constructor(name: string, args: BareMetalMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20231001preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20240601preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20240701:BareMetalMachine" }, { type: "azure-native:networkcloud/v20241001preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20250201:BareMetalMachine" }, { type: "azure-native:networkcloud:BareMetalMachine" }] };
...
export interface BareMetalMachineArgs {
     ...
     * The credentials of the baseboard management controller on this bare metal machine.
     */
    bmcCredentials: pulumi.Input<inputs.networkcloud.v20230701.AdministrativeCredentialsArgs>;
    /**
     * The MAC address of the BMC device.
     */
