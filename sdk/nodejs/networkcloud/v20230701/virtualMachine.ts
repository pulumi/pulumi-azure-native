...
export class VirtualMachine extends pulumi.CustomResource {
     ...
     */
    public readonly cloudServicesNetworkAttachment!: pulumi.Output<outputs.networkcloud.v20230701.NetworkAttachmentResponse>;
    /**
     ...
     */
    public readonly networkAttachments!: pulumi.Output<outputs.networkcloud.v20230701.NetworkAttachmentResponse[] | undefined>;
    /**
     ...
     */
    public readonly placementHints!: pulumi.Output<outputs.networkcloud.v20230701.VirtualMachinePlacementHintResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshPublicKeys!: pulumi.Output<outputs.networkcloud.v20230701.SshPublicKeyResponse[] | undefined>;
    /**
     * The storage profile that specifies size and other parameters about the disks related to the virtual machine.
     */
    public readonly storageProfile!: pulumi.Output<outputs.networkcloud.v20230701.StorageProfileResponse>;
    /**
     ...
     */
    public readonly vmImageRepositoryCredentials!: pulumi.Output<outputs.networkcloud.v20230701.ImageRepositoryCredentialsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["storageProfile"] = args ? (args.storageProfile ? pulumi.output(args.storageProfile).apply(inputs.networkcloud.v20230701.storageProfileArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:VirtualMachine" }, { type: "azure-native:networkcloud/v20231001preview:VirtualMachine" }, { type: "azure-native:networkcloud/v20240601preview:VirtualMachine" }, { type: "azure-native:networkcloud/v20240701:VirtualMachine" }] };
