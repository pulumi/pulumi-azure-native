...
export interface GetKubernetesClusterResult {
     ...
     */
    readonly aadConfiguration?: outputs.networkcloud.v20230701.AadConfigurationResponse;
    /**
     ...
     */
    readonly administratorConfiguration?: outputs.networkcloud.v20230701.AdministratorConfigurationResponse;
    /**
     ...
     */
    readonly availableUpgrades: outputs.networkcloud.v20230701.AvailableUpgradeResponse[];
    /**
     ...
     */
    readonly controlPlaneNodeConfiguration: outputs.networkcloud.v20230701.ControlPlaneNodeConfigurationResponse;
    /**
     ...
     */
    readonly featureStatuses: outputs.networkcloud.v20230701.FeatureStatusResponse[];
    /**
     ...
     */
    readonly initialAgentPoolConfigurations: outputs.networkcloud.v20230701.InitialAgentPoolConfigurationResponse[];
    /**
     ...
     */
    readonly managedResourceGroupConfiguration?: outputs.networkcloud.v20230701.ManagedResourceGroupConfigurationResponse;
    /**
     ...
     */
    readonly networkConfiguration: outputs.networkcloud.v20230701.NetworkConfigurationResponse;
    /**
     * The details of the nodes in this cluster.
     */
    readonly nodes: outputs.networkcloud.v20230701.KubernetesClusterNodeResponse[];
    /**
