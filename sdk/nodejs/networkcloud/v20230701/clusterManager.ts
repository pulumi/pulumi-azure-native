...
export class ClusterManager extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly clusterVersions!: pulumi.Output<outputs.networkcloud.v20230701.ClusterAvailableVersionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly managerExtendedLocation!: pulumi.Output<outputs.networkcloud.v20230701.ExtendedLocationResponse>;
    /**
    ...
    constructor(name: string, args: ClusterManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:ClusterManager" }, { type: "azure-native:networkcloud/v20231001preview:ClusterManager" }, { type: "azure-native:networkcloud/v20240601preview:ClusterManager" }, { type: "azure-native:networkcloud/v20240701:ClusterManager" }] };
