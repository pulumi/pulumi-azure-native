...
export class KubernetesCluster extends pulumi.CustomResource {
     ...
     */
    public readonly aadConfiguration!: pulumi.Output<outputs.networkcloud.v20230701.AadConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly availableUpgrades!: pulumi.Output<outputs.networkcloud.v20230701.AvailableUpgradeResponse[]>;
    /**
     ...
     */
    public readonly controlPlaneNodeConfiguration!: pulumi.Output<outputs.networkcloud.v20230701.ControlPlaneNodeConfigurationResponse>;
    /**
     ...
     */
    public /*out*/ readonly featureStatuses!: pulumi.Output<outputs.networkcloud.v20230701.FeatureStatusResponse[]>;
    /**
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    public readonly initialAgentPoolConfigurations!: pulumi.Output<outputs.networkcloud.v20230701.InitialAgentPoolConfigurationResponse[]>;
    /**
     ...
     */
    public readonly managedResourceGroupConfiguration!: pulumi.Output<outputs.networkcloud.v20230701.ManagedResourceGroupConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly networkConfiguration!: pulumi.Output<outputs.networkcloud.v20230701.NetworkConfigurationResponse>;
    /**
     * The details of the nodes in this cluster.
     */
    public /*out*/ readonly nodes!: pulumi.Output<outputs.networkcloud.v20230701.KubernetesClusterNodeResponse[]>;
    /**
    ...
    constructor(name: string, args: KubernetesClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkConfiguration"] = args ? (args.networkConfiguration ? pulumi.output(args.networkConfiguration).apply(inputs.networkcloud.v20230701.networkConfigurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:KubernetesCluster" }, { type: "azure-native:networkcloud/v20231001preview:KubernetesCluster" }, { type: "azure-native:networkcloud/v20240601preview:KubernetesCluster" }, { type: "azure-native:networkcloud/v20240701:KubernetesCluster" }] };
...
export interface KubernetesClusterArgs {
     ...
     * The Azure Active Directory Integration properties.
     */
    aadConfiguration?: pulumi.Input<inputs.networkcloud.v20230701.AadConfigurationArgs>;
    /**
     * The administrative credentials that will be applied to the control plane and agent pool nodes that do not specify their own values.
     */
     ...
     * The defining characteristics of the control plane for this Kubernetes Cluster.
     */
    controlPlaneNodeConfiguration: pulumi.Input<inputs.networkcloud.v20230701.ControlPlaneNodeConfigurationArgs>;
    /**
     * The extended location of the cluster associated with the resource.
     */
     ...
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    initialAgentPoolConfigurations: pulumi.Input<pulumi.Input<inputs.networkcloud.v20230701.InitialAgentPoolConfigurationArgs>[]>;
    /**
     ...
     * The configuration of the managed resource group associated with the resource.
     */
    managedResourceGroupConfiguration?: pulumi.Input<inputs.networkcloud.v20230701.ManagedResourceGroupConfigurationArgs>;
    /**
     * The configuration of the Kubernetes cluster networking, including the attachment of networks that span the cluster.
     */
    networkConfiguration: pulumi.Input<inputs.networkcloud.v20230701.NetworkConfigurationArgs>;
    /**
