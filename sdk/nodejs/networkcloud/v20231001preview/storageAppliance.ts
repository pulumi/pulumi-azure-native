...
export class StorageAppliance extends pulumi.CustomResource {
     ...
     */
    public readonly administratorCredentials!: pulumi.Output<outputs.networkcloud.v20231001preview.AdministrativeCredentialsResponse>;
    /**
    ...
    constructor(name: string, args: StorageApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:StorageAppliance" }, { type: "azure-native:networkcloud/v20230701:StorageAppliance" }, { type: "azure-native:networkcloud/v20240601preview:StorageAppliance" }, { type: "azure-native:networkcloud/v20240701:StorageAppliance" }] };
