...
export class Cluster extends pulumi.CustomResource {
     ...
     */
    public readonly aggregatorOrSingleRackDefinition!: pulumi.Output<outputs.networkcloud.v20231001preview.RackDefinitionResponse>;
    /**
     ...
     */
    public /*out*/ readonly availableUpgradeVersions!: pulumi.Output<outputs.networkcloud.v20231001preview.ClusterAvailableUpgradeVersionResponse[]>;
    /**
     * The capacity supported by this cluster.
     */
    public /*out*/ readonly clusterCapacity!: pulumi.Output<outputs.networkcloud.v20231001preview.ClusterCapacityResponse>;
    /**
     ...
     */
    public /*out*/ readonly clusterExtendedLocation!: pulumi.Output<outputs.networkcloud.v20231001preview.ExtendedLocationResponse>;
    /**
     ...
     */
    public readonly clusterServicePrincipal!: pulumi.Output<outputs.networkcloud.v20231001preview.ServicePrincipalInformationResponse | undefined>;
    /**
     ...
     */
    public readonly computeDeploymentThreshold!: pulumi.Output<outputs.networkcloud.v20231001preview.ValidationThresholdResponse | undefined>;
    /**
     * The list of rack definitions for the compute racks in a multi-rack
     * cluster, or an empty list in a single-rack cluster.
     */
    public readonly computeRackDefinitions!: pulumi.Output<outputs.networkcloud.v20231001preview.RackDefinitionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly hybridAksExtendedLocation!: pulumi.Output<outputs.networkcloud.v20231001preview.ExtendedLocationResponse>;
    /**
     ...
     */
    public readonly runtimeProtectionConfiguration!: pulumi.Output<outputs.networkcloud.v20231001preview.RuntimeProtectionConfigurationResponse | undefined>;
    /**
     * The configuration for use of a key vault to store secrets for later retrieval by the operator.
     */
    public readonly secretArchive!: pulumi.Output<outputs.networkcloud.v20231001preview.ClusterSecretArchiveResponse | undefined>;
    /**
     ...
     */
    public readonly updateStrategy!: pulumi.Output<outputs.networkcloud.v20231001preview.ClusterUpdateStrategyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["runtimeProtectionConfiguration"] = args ? (args.runtimeProtectionConfiguration ? pulumi.output(args.runtimeProtectionConfiguration).apply(inputs.networkcloud.v20231001preview.runtimeProtectionConfigurationArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["secretArchive"] = args ? (args.secretArchive ? pulumi.output(args.secretArchive).apply(inputs.networkcloud.v20231001preview.clusterSecretArchiveArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["tags"] = args ? args.tags : undefined;
            resourceInputs["updateStrategy"] = args ? (args.updateStrategy ? pulumi.output(args.updateStrategy).apply(inputs.networkcloud.v20231001preview.clusterUpdateStrategyArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20230701:Cluster" }, { type: "azure-native:networkcloud/v20240601preview:Cluster" }, { type: "azure-native:networkcloud/v20240701:Cluster" }, { type: "azure-native:networkcloud/v20241001preview:Cluster" }, { type: "azure-native:networkcloud/v20250201:Cluster" }, { type: "azure-native:networkcloud:Cluster" }] };
