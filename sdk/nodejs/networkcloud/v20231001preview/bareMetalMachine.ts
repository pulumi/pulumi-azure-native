...
export class BareMetalMachine extends pulumi.CustomResource {
     ...
     */
    public readonly bmcCredentials!: pulumi.Output<outputs.networkcloud.v20231001preview.AdministrativeCredentialsResponse>;
    /**
     ...
     */
    public /*out*/ readonly hardwareInventory!: pulumi.Output<outputs.networkcloud.v20231001preview.HardwareInventoryResponse>;
    /**
     * The details of the latest hardware validation performed for this bare metal machine.
     */
    public /*out*/ readonly hardwareValidationStatus!: pulumi.Output<outputs.networkcloud.v20231001preview.HardwareValidationStatusResponse>;
    /**
     ...
     */
    public /*out*/ readonly runtimeProtectionStatus!: pulumi.Output<outputs.networkcloud.v20231001preview.RuntimeProtectionStatusResponse>;
    /**
    ...
    constructor(name: string, args: BareMetalMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BareMetalMachine" }, { type: "azure-native:networkcloud/v20230701:BareMetalMachine" }, { type: "azure-native:networkcloud/v20240601preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20240701:BareMetalMachine" }] };
