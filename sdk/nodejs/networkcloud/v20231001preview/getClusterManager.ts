...
export interface GetClusterManagerResult {
     ...
     */
    readonly clusterVersions: outputs.networkcloud.v20231001preview.ClusterAvailableVersionResponse[];
    /**
     ...
     */
    readonly managerExtendedLocation: outputs.networkcloud.v20231001preview.ExtendedLocationResponse;
    /**
...
export function getClusterManagerOutput(args: GetClusterManagerOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetClusterManagerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:networkcloud/v20231001preview:getClusterManager", {
        "clusterManagerName": args.clusterManagerName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
