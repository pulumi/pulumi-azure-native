...
export class ClusterManager extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterManager {
        pulumi.log.warn("ClusterManager is deprecated: azure-native:networkcloud/v20221212preview:ClusterManager is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:ClusterManager to guarantee forwards compatibility.")
        return new ClusterManager(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:ClusterManager';
     ...
     */
    public /*out*/ readonly clusterVersions!: pulumi.Output<outputs.networkcloud.v20221212preview.ClusterAvailableVersionResponse[]>;
    /**
     ...
     */
    public readonly managedResourceGroupConfiguration!: pulumi.Output<outputs.networkcloud.v20221212preview.ManagedResourceGroupConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly managerExtendedLocation!: pulumi.Output<outputs.networkcloud.v20221212preview.ExtendedLocationResponse>;
    /**
    ...
    constructor(name: string, args: ClusterManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:ClusterManager" }] };
...
export interface ClusterManagerArgs {
     ...
     * The configuration of the managed resource group associated with the resource.
     */
    managedResourceGroupConfiguration?: pulumi.Input<inputs.networkcloud.v20221212preview.ManagedResourceGroupConfigurationArgs>;
    /**
