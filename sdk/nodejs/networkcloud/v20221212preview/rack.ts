...
export class Rack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:Rack';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.v20221212preview.RackPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:Rack" }] };
...
export interface RackArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.v20221212preview.RackPropertiesArgs>;
    /**
