...
export class BareMetalMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:BareMetalMachine';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.v20221212preview.BareMetalMachinePropertiesResponse>;
    /**
...
export interface BareMetalMachineArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.v20221212preview.BareMetalMachinePropertiesArgs>;
    /**
