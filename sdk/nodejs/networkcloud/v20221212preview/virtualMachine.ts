 ...
 *
 * const virtualMachine = new azure_native.networkcloud.v20221212preview.VirtualMachine("virtualMachine", {
...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:VirtualMachine';
     ...
     */
    public readonly networkAttachments!: pulumi.Output<outputs.networkcloud.v20221212preview.NetworkAttachmentResponse[] | undefined>;
    /**
     ...
     */
    public readonly placementHints!: pulumi.Output<outputs.networkcloud.v20221212preview.VirtualMachinePlacementHintResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["storageProfile"] = args ? (args.storageProfile ? pulumi.output(args.storageProfile).apply(inputs.networkcloud.v20221212preview.storageProfileArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:VirtualMachine" }] };
...
export interface VirtualMachineArgs {
     ...
     * Field Deprecated, the value will be ignored if provided. The indicator of whether one of the specified CPU cores is isolated to run the emulator thread for this virtual machine.
     */
    isolateEmulatorThread?: pulumi.Input<string | enums.networkcloud.v20221212preview.VirtualMachineIsolateEmulatorThread>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The list of network attachments to the virtual machine.
     */
    networkAttachments?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20221212preview.NetworkAttachmentArgs>[]>;
    /**
     * The Base64 encoded cloud-init network data.
     */
     ...
     * The scheduling hints for the virtual machine.
     */
    placementHints?: pulumi.Input<pulumi.Input<inputs.networkcloud.v20221212preview.VirtualMachinePlacementHintArgs>[]>;
    /**
     ...
     * Field Deprecated, use virtualizationModel instead. The type of the virtio interface.
     */
    virtioInterface?: pulumi.Input<string | enums.networkcloud.v20221212preview.VirtualMachineVirtioInterfaceType>;
    /**
     ...
     * The type of the device model to use.
     */
    vmDeviceModel?: pulumi.Input<string | enums.networkcloud.v20221212preview.VirtualMachineDeviceModelType>;
    /**
     * The virtual machine image that is currently provisioned to the OS disk, using the full url and tag notation used to pull the image.
     */
