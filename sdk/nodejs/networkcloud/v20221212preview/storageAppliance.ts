...
export class StorageAppliance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageAppliance {
        pulumi.log.warn("StorageAppliance is deprecated: azure-native:networkcloud/v20221212preview:StorageAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:StorageAppliance to guarantee forwards compatibility.")
        return new StorageAppliance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:StorageAppliance';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.networkcloud.v20221212preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: StorageApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:StorageAppliance" }] };
