...
export class L3Network extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:L3Network';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.v20221212preview.L3NetworkPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: L3NetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.networkcloud.v20221212preview.l3networkPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:L3Network" }] };
...
export interface L3NetworkArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.v20221212preview.L3NetworkPropertiesArgs>;
    /**
