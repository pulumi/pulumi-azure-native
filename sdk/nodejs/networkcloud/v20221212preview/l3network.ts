...
export class L3Network extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): L3Network {
        pulumi.log.warn("L3Network is deprecated: azure-native:networkcloud/v20221212preview:L3Network is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:L3Network to guarantee forwards compatibility.")
...
export interface L3NetworkArgs {
     ...
     * The indicator of whether or not to disable IPAM allocation on the network attachment definition injected into the Hybrid AKS Cluster.
     */
    hybridAksIpamEnabled?: pulumi.Input<string | enums.networkcloud.v20221212preview.HybridAksIpamEnabled>;
    /**
     * The network plugin type for Hybrid AKS.
     */
