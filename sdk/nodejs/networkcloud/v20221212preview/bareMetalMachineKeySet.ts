 ...
 *
 * const bareMetalMachineKeySet = new azure_native.networkcloud.v20221212preview.BareMetalMachineKeySet("bareMetalMachineKeySet", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet bareMetalMachineKeySetName /subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.NetworkCloud/clusters/clusterName/bareMetalMachineKeySets/bareMetalMachineKeySetName 
 * ```
 */
export class BareMetalMachineKeySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet';
    ...
    constructor(name: string, args: BareMetalMachineKeySetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BareMetalMachineKeySet" }] };
...
export interface BareMetalMachineKeySetArgs {
     ...
     * The access level allowed for the users in this key set.
     */
    privilegeLevel: pulumi.Input<string | enums.networkcloud.v20221212preview.BareMetalMachineKeySetPrivilegeLevel>;
    /**
