...
export class TrunkedNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:TrunkedNetwork';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.v20221212preview.TrunkedNetworkPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: TrunkedNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.networkcloud.v20221212preview.trunkedNetworkPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:TrunkedNetwork" }] };
...
export interface TrunkedNetworkArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.v20221212preview.TrunkedNetworkPropertiesArgs>;
    /**
