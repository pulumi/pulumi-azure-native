...
export class BareMetalMachineKeySet extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.networkcloud.BareMetalMachineKeySetPropertiesResponse>;
    /**
...
export interface BareMetalMachineKeySetArgs {
     ...
     * The list of the resource properties.
     */
    properties: pulumi.Input<inputs.networkcloud.BareMetalMachineKeySetPropertiesArgs>;
    /**
