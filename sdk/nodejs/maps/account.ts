...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:maps:Account';
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:maps/latest:Account" }, { type: "azure-nextgen:maps/v20170101preview:Account" }, { type: "azure-nextgen:maps/v20180501:Account" }, { type: "azure-nextgen:maps/v20200201preview:Account" }] };
