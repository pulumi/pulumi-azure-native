...
export class Creator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:maps/v20210701preview:Creator';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.maps.v20210701preview.CreatorPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: CreatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:maps/v20210701preview:Creator" }, { type: "azure-native:maps:Creator" }, { type: "azure-nextgen:maps:Creator" }, { type: "azure-native:maps/v20200201preview:Creator" }, { type: "azure-nextgen:maps/v20200201preview:Creator" }, { type: "azure-native:maps/v20210201:Creator" }, { type: "azure-nextgen:maps/v20210201:Creator" }, { type: "azure-native:maps/v20211201preview:Creator" }, { type: "azure-nextgen:maps/v20211201preview:Creator" }] };
