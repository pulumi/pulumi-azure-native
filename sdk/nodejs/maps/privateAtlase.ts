...
export class PrivateAtlase extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.maps.PrivateAtlasPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: PrivateAtlaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:maps:PrivateAtlase" }, { type: "azure-native:maps/v20200201preview:PrivateAtlase" }, { type: "azure-nextgen:maps/v20200201preview:PrivateAtlase" }] };
