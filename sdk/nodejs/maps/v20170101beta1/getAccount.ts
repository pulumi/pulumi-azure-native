...
export function getAccount(args: GetAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountResult> {
    ...
    return pulumi.runtime.invoke("azurerm:maps/v20170101beta1:getAccount", {
        "name": args.name,
...
export interface GetAccountResult {
     ...
     */
    readonly properties: outputs.maps.v20170101beta1.MapsAccountPropertiesResponse;
    /**
     * The SKU of this account.
     */
    readonly sku: outputs.maps.v20170101beta1.SkuResponse;
    /**
