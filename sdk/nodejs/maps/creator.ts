...
export class Creator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CreatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:maps:Creator" }, { type: "azure-native:maps/v20200201preview:Creator" }, { type: "azure-nextgen:maps/v20200201preview:Creator" }, { type: "azure-native:maps/v20210201:Creator" }, { type: "azure-nextgen:maps/v20210201:Creator" }] };
...
export interface CreatorArgs {
     ...
     * The Creator resource properties.
     */
    readonly properties: pulumi.Input<inputs.maps.CreatorPropertiesArgs>;
    /**
