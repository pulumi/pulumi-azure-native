...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:maps/latest:Account" }, { type: "azure-nextgen:maps/v20180501:Account" }, { type: "azure-nextgen:maps/v20200201preview:Account" }] };
