 ...
 *
 * const account = new azurerm.maps.v20170101preview.Account("account", {
...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:maps/v20170101preview:Account';
    ...
    constructor(name: string, argsOrState?: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:maps/latest:Account" }, { type: "azurerm:maps/v20180501:Account" }] };
