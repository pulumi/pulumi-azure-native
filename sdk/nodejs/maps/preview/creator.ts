...
export class Creator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:maps/preview:Creator';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.maps.preview.CreatorPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: CreatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:maps/v20200201preview:Creator" }] };
