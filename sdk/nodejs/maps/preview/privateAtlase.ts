...
export class PrivateAtlase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateAtlase {
        return new PrivateAtlase(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:maps/preview:PrivateAtlase';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<outputs.maps.preview.PrivateAtlasPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: PrivateAtlaseArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PrivateAtlaseArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:maps/v20200201preview:PrivateAtlase" }] };
