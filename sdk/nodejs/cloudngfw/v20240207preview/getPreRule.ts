...
export function getPreRule(args: GetPreRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetPreRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cloudngfw/v20240207preview:getPreRule", {
...
export interface GetPreRuleResult {
     ...
     * rule category
     */
    readonly category?: outputs.cloudngfw.v20240207preview.CategoryResponse;
    /**
     ...
     * destination address
     */
    readonly destination?: outputs.cloudngfw.v20240207preview.DestinationAddrResponse;
    /**
     ...
     * source address
     */
    readonly source?: outputs.cloudngfw.v20240207preview.SourceAddrResponse;
    /**
     ...
     * tag for rule
     */
    readonly tags?: outputs.cloudngfw.v20240207preview.TagInfoResponse[];
    /**
...
export function getPreRuleOutput(args: GetPreRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPreRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cloudngfw/v20240207preview:getPreRule", {
        "globalRulestackName": args.globalRulestackName,
        "priority": args.priority,
    }, opts);
}
