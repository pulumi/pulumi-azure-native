...
export class PreRule extends pulumi.CustomResource {
     ...
     * rule category
     */
    public readonly category!: pulumi.Output<outputs.cloudngfw.v20240119preview.CategoryResponse | undefined>;
    /**
     ...
     * destination address
     */
    public readonly destination!: pulumi.Output<outputs.cloudngfw.v20240119preview.DestinationAddrResponse | undefined>;
    /**
     ...
     * source address
     */
    public readonly source!: pulumi.Output<outputs.cloudngfw.v20240119preview.SourceAddrResponse | undefined>;
    /**
     ...
     * tag for rule
     */
    public readonly tags!: pulumi.Output<outputs.cloudngfw.v20240119preview.TagInfoResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: PreRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw/v20220829:PreRule" }, { type: "azure-native:cloudngfw/v20220829preview:PreRule" }, { type: "azure-native:cloudngfw/v20230901:PreRule" }, { type: "azure-native:cloudngfw/v20230901preview:PreRule" }, { type: "azure-native:cloudngfw/v20231010preview:PreRule" }, { type: "azure-native:cloudngfw/v20240207preview:PreRule" }, { type: "azure-native:cloudngfw:PreRule" }] };
...
export interface PreRuleArgs {
     ...
     * rule action
     */
    actionType?: pulumi.Input<string | enums.cloudngfw.v20240119preview.ActionEnum>;
    /**
     * array of rule applications
     */
     ...
     * rule category
     */
    category?: pulumi.Input<inputs.cloudngfw.v20240119preview.CategoryArgs>;
    /**
     * enable or disable decryption
     */
    decryptionRuleType?: pulumi.Input<string | enums.cloudngfw.v20240119preview.DecryptionRuleTypeEnum>;
    /**
     * rule description
     */
     ...
     * destination address
     */
    destination?: pulumi.Input<inputs.cloudngfw.v20240119preview.DestinationAddrArgs>;
    /**
     * enable or disable logging
     */
    enableLogging?: pulumi.Input<string | enums.cloudngfw.v20240119preview.StateEnum>;
    /**
     ...
     * cidr should not be 'any'
     */
    negateDestination?: pulumi.Input<string | enums.cloudngfw.v20240119preview.BooleanEnum>;
    /**
     * cidr should not be 'any'
     */
    negateSource?: pulumi.Input<string | enums.cloudngfw.v20240119preview.BooleanEnum>;
    /**
     * Pre Rule priority
     */
     ...
     * state of this rule
     */
    ruleState?: pulumi.Input<string | enums.cloudngfw.v20240119preview.StateEnum>;
    /**
     * source address
     */
    source?: pulumi.Input<inputs.cloudngfw.v20240119preview.SourceAddrArgs>;
    /**
     * tag for rule
     */
    tags?: pulumi.Input<pulumi.Input<inputs.cloudngfw.v20240119preview.TagInfoArgs>[]>;
}
