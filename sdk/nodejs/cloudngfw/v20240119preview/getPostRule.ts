...
export interface GetPostRuleResult {
     ...
     * rule category
     */
    readonly category?: outputs.cloudngfw.v20240119preview.CategoryResponse;
    /**
     ...
     * destination address
     */
    readonly destination?: outputs.cloudngfw.v20240119preview.DestinationAddrResponse;
    /**
     ...
     * source address
     */
    readonly source?: outputs.cloudngfw.v20240119preview.SourceAddrResponse;
    /**
     ...
     * tag for rule
     */
    readonly tags?: outputs.cloudngfw.v20240119preview.TagInfoResponse[];
    /**
...
export function getPostRuleOutput(args: GetPostRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPostRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cloudngfw/v20240119preview:getPostRule", {
        "globalRulestackName": args.globalRulestackName,
        "priority": args.priority,
    }, opts);
}
