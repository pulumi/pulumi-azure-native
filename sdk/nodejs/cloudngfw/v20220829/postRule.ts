...
export class PostRule extends pulumi.CustomResource {
     ...
     * rule category
     */
    public readonly category!: pulumi.Output<outputs.cloudngfw.v20220829.CategoryResponse | undefined>;
    /**
     ...
     * destination address
     */
    public readonly destination!: pulumi.Output<outputs.cloudngfw.v20220829.DestinationAddrResponse | undefined>;
    /**
     ...
     * source address
     */
    public readonly source!: pulumi.Output<outputs.cloudngfw.v20220829.SourceAddrResponse | undefined>;
    /**
     ...
     * tag for rule
     */
    public readonly tags!: pulumi.Output<outputs.cloudngfw.v20220829.TagInfoResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: PostRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw/v20220829preview:PostRule" }, { type: "azure-native:cloudngfw/v20230901:PostRule" }, { type: "azure-native:cloudngfw/v20230901preview:PostRule" }, { type: "azure-native:cloudngfw/v20231010preview:PostRule" }, { type: "azure-native:cloudngfw/v20240119preview:PostRule" }, { type: "azure-native:cloudngfw/v20240207preview:PostRule" }, { type: "azure-native:cloudngfw/v20250206preview:PostRule" }, { type: "azure-native:cloudngfw:PostRule" }] };
...
export interface PostRuleArgs {
     ...
     * rule action
     */
    actionType?: pulumi.Input<string | enums.cloudngfw.v20220829.ActionEnum>;
    /**
     * array of rule applications
     */
     ...
     * rule category
     */
    category?: pulumi.Input<inputs.cloudngfw.v20220829.CategoryArgs>;
    /**
     * enable or disable decryption
     */
    decryptionRuleType?: pulumi.Input<string | enums.cloudngfw.v20220829.DecryptionRuleTypeEnum>;
    /**
     * rule description
     */
     ...
     * destination address
     */
    destination?: pulumi.Input<inputs.cloudngfw.v20220829.DestinationAddrArgs>;
    /**
     * enable or disable logging
     */
    enableLogging?: pulumi.Input<string | enums.cloudngfw.v20220829.StateEnum>;
    /**
     ...
     * cidr should not be 'any'
     */
    negateDestination?: pulumi.Input<string | enums.cloudngfw.v20220829.BooleanEnum>;
    /**
     * cidr should not be 'any'
     */
    negateSource?: pulumi.Input<string | enums.cloudngfw.v20220829.BooleanEnum>;
    /**
     * Post Rule priority
     */
     ...
     * state of this rule
     */
    ruleState?: pulumi.Input<string | enums.cloudngfw.v20220829.StateEnum>;
    /**
     * source address
     */
    source?: pulumi.Input<inputs.cloudngfw.v20220829.SourceAddrArgs>;
    /**
     * tag for rule
     */
    tags?: pulumi.Input<pulumi.Input<inputs.cloudngfw.v20220829.TagInfoArgs>[]>;
}
