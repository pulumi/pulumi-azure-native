...
export class LocalRule extends pulumi.CustomResource {
     ...
     * rule category
     */
    public readonly category!: pulumi.Output<outputs.cloudngfw.v20230901.CategoryResponse | undefined>;
    /**
     ...
     * destination address
     */
    public readonly destination!: pulumi.Output<outputs.cloudngfw.v20230901.DestinationAddrResponse | undefined>;
    /**
     ...
     * source address
     */
    public readonly source!: pulumi.Output<outputs.cloudngfw.v20230901.SourceAddrResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.cloudngfw.v20230901.SystemDataResponse>;
    /**
     * tag for rule
     */
    public readonly tags!: pulumi.Output<outputs.cloudngfw.v20230901.TagInfoResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: LocalRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw/v20220829:LocalRule" }, { type: "azure-native:cloudngfw/v20220829preview:LocalRule" }, { type: "azure-native:cloudngfw/v20230901preview:LocalRule" }, { type: "azure-native:cloudngfw/v20231010preview:LocalRule" }, { type: "azure-native:cloudngfw/v20240119preview:LocalRule" }, { type: "azure-native:cloudngfw/v20240207preview:LocalRule" }, { type: "azure-native:cloudngfw/v20250206preview:LocalRule" }, { type: "azure-native:cloudngfw:LocalRule" }] };
...
export interface LocalRuleArgs {
     ...
     * rule action
     */
    actionType?: pulumi.Input<string | enums.cloudngfw.v20230901.ActionEnum>;
    /**
     * array of rule applications
     */
     ...
     * rule category
     */
    category?: pulumi.Input<inputs.cloudngfw.v20230901.CategoryArgs>;
    /**
     * enable or disable decryption
     */
    decryptionRuleType?: pulumi.Input<string | enums.cloudngfw.v20230901.DecryptionRuleTypeEnum>;
    /**
     * rule description
     */
     ...
     * destination address
     */
    destination?: pulumi.Input<inputs.cloudngfw.v20230901.DestinationAddrArgs>;
    /**
     * enable or disable logging
     */
    enableLogging?: pulumi.Input<string | enums.cloudngfw.v20230901.StateEnum>;
    /**
     * inbound Inspection Certificate
     */
     ...
     * cidr should not be 'any'
     */
    negateDestination?: pulumi.Input<string | enums.cloudngfw.v20230901.BooleanEnum>;
    /**
     * cidr should not be 'any'
     */
    negateSource?: pulumi.Input<string | enums.cloudngfw.v20230901.BooleanEnum>;
    /**
     * Local Rule priority
     */
     ...
     * state of this rule
     */
    ruleState?: pulumi.Input<string | enums.cloudngfw.v20230901.StateEnum>;
    /**
     * source address
     */
    source?: pulumi.Input<inputs.cloudngfw.v20230901.SourceAddrArgs>;
    /**
     * tag for rule
     */
    tags?: pulumi.Input<pulumi.Input<inputs.cloudngfw.v20230901.TagInfoArgs>[]>;
}
