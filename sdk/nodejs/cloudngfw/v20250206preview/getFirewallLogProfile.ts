...
export function getFirewallLogProfile(args: GetFirewallLogProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallLogProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cloudngfw/v20250206preview:getFirewallLogProfile", {
...
export interface GetFirewallLogProfileResult {
     ...
     */
    readonly applicationInsights?: outputs.cloudngfw.v20250206preview.ApplicationInsightsResponse;
    /**
     * Common destination configurations
     */
    readonly commonDestination?: outputs.cloudngfw.v20250206preview.LogDestinationResponse;
    /**
     * Decrypt destination configurations
     */
    readonly decryptLogDestination?: outputs.cloudngfw.v20250206preview.LogDestinationResponse;
    /**
     ...
     */
    readonly threatLogDestination?: outputs.cloudngfw.v20250206preview.LogDestinationResponse;
    /**
     * Traffic destination configurations
     */
    readonly trafficLogDestination?: outputs.cloudngfw.v20250206preview.LogDestinationResponse;
}
/**
 * Log Profile for Firewall
 */
export function getFirewallLogProfileOutput(args: GetFirewallLogProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFirewallLogProfileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cloudngfw/v20250206preview:getFirewallLogProfile", {
        "firewallName": args.firewallName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
