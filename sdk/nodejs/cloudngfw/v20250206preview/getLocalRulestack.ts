...
export function getLocalRulestack(args: GetLocalRulestackArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalRulestackResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cloudngfw/v20250206preview:getLocalRulestack", {
...
export interface GetLocalRulestackResult {
     ...
     */
    readonly identity?: outputs.cloudngfw.v20250206preview.AzureResourceManagerManagedIdentityPropertiesResponse;
    /**
     ...
     * Security Profile
     */
    readonly securityServices?: outputs.cloudngfw.v20250206preview.SecurityServicesResponse;
    /**
...
export function getLocalRulestackOutput(args: GetLocalRulestackOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLocalRulestackResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cloudngfw/v20250206preview:getLocalRulestack", {
        "localRulestackName": args.localRulestackName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
