...
export function getPostRule(args: GetPostRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetPostRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cloudngfw/v20250206preview:getPostRule", {
...
export interface GetPostRuleResult {
     ...
     * rule category
     */
    readonly category?: outputs.cloudngfw.v20250206preview.CategoryResponse;
    /**
     ...
     * destination address
     */
    readonly destination?: outputs.cloudngfw.v20250206preview.DestinationAddrResponse;
    /**
     ...
     * source address
     */
    readonly source?: outputs.cloudngfw.v20250206preview.SourceAddrResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: outputs.cloudngfw.v20250206preview.SystemDataResponse;
    /**
     * tag for rule
     */
    readonly tags?: outputs.cloudngfw.v20250206preview.TagInfoResponse[];
    /**
...
export function getPostRuleOutput(args: GetPostRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPostRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cloudngfw/v20250206preview:getPostRule", {
        "globalRulestackName": args.globalRulestackName,
        "priority": args.priority,
    }, opts);
}
