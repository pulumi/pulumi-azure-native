...
export class CertificateObjectGlobalRulestack extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.cloudngfw.v20230901preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: CertificateObjectGlobalRulestackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw/v20220829:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20220829preview:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20230901:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20231010preview:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20240119preview:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20240207preview:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20250206preview:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw:CertificateObjectGlobalRulestack" }] };
...
export interface CertificateObjectGlobalRulestackArgs {
     ...
     * use certificate self signed
     */
    certificateSelfSigned: pulumi.Input<string | enums.cloudngfw.v20230901preview.BooleanEnum>;
    /**
     * Resource Id of certificate signer, to be populated only when certificateSelfSigned is false
     */
