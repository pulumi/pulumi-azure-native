...
export class PreRule extends pulumi.CustomResource {
     ...
     * rule category
     */
    public readonly category!: pulumi.Output<outputs.cloudngfw.v20230901preview.CategoryResponse | undefined>;
    /**
     ...
     * destination address
     */
    public readonly destination!: pulumi.Output<outputs.cloudngfw.v20230901preview.DestinationAddrResponse | undefined>;
    /**
     ...
     * source address
     */
    public readonly source!: pulumi.Output<outputs.cloudngfw.v20230901preview.SourceAddrResponse | undefined>;
    /**
     ...
     * tag for rule
     */
    public readonly tags!: pulumi.Output<outputs.cloudngfw.v20230901preview.TagInfoResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: PreRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw/v20220829:PreRule" }, { type: "azure-native:cloudngfw/v20220829preview:PreRule" }, { type: "azure-native:cloudngfw/v20230901:PreRule" }, { type: "azure-native:cloudngfw/v20231010preview:PreRule" }, { type: "azure-native:cloudngfw/v20240119preview:PreRule" }, { type: "azure-native:cloudngfw/v20240207preview:PreRule" }, { type: "azure-native:cloudngfw:PreRule" }] };
...
export interface PreRuleArgs {
     ...
     * rule action
     */
    actionType?: pulumi.Input<string | enums.cloudngfw.v20230901preview.ActionEnum>;
    /**
     * array of rule applications
     */
     ...
     * rule category
     */
    category?: pulumi.Input<inputs.cloudngfw.v20230901preview.CategoryArgs>;
    /**
     * enable or disable decryption
     */
    decryptionRuleType?: pulumi.Input<string | enums.cloudngfw.v20230901preview.DecryptionRuleTypeEnum>;
    /**
     * rule description
     */
     ...
     * destination address
     */
    destination?: pulumi.Input<inputs.cloudngfw.v20230901preview.DestinationAddrArgs>;
    /**
     * enable or disable logging
     */
    enableLogging?: pulumi.Input<string | enums.cloudngfw.v20230901preview.StateEnum>;
    /**
     ...
     * cidr should not be 'any'
     */
    negateDestination?: pulumi.Input<string | enums.cloudngfw.v20230901preview.BooleanEnum>;
    /**
     * cidr should not be 'any'
     */
    negateSource?: pulumi.Input<string | enums.cloudngfw.v20230901preview.BooleanEnum>;
    /**
     * Pre Rule priority
     */
     ...
     * state of this rule
     */
    ruleState?: pulumi.Input<string | enums.cloudngfw.v20230901preview.StateEnum>;
    /**
     * source address
     */
    source?: pulumi.Input<inputs.cloudngfw.v20230901preview.SourceAddrArgs>;
    /**
     * tag for rule
     */
    tags?: pulumi.Input<pulumi.Input<inputs.cloudngfw.v20230901preview.TagInfoArgs>[]>;
}
