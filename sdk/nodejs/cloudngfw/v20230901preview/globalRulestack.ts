...
export class GlobalRulestack extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.cloudngfw.v20230901preview.AzureResourceManagerManagedIdentityPropertiesResponse | undefined>;
    /**
     * Global Location
     */
     ...
     * Security Profile
     */
    public readonly securityServices!: pulumi.Output<outputs.cloudngfw.v20230901preview.SecurityServicesResponse | undefined>;
    /**
    ...
    constructor(name: string, args?: GlobalRulestackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw/v20220829:GlobalRulestack" }, { type: "azure-native:cloudngfw/v20220829preview:GlobalRulestack" }, { type: "azure-native:cloudngfw/v20230901:GlobalRulestack" }, { type: "azure-native:cloudngfw/v20231010preview:GlobalRulestack" }, { type: "azure-native:cloudngfw/v20240119preview:GlobalRulestack" }, { type: "azure-native:cloudngfw/v20240207preview:GlobalRulestack" }, { type: "azure-native:cloudngfw/v20250206preview:GlobalRulestack" }, { type: "azure-native:cloudngfw:GlobalRulestack" }] };
...
export interface GlobalRulestackArgs {
     ...
     * Mode for default rules creation
     */
    defaultMode?: pulumi.Input<string | enums.cloudngfw.v20230901preview.DefaultMode>;
    /**
     * rulestack description
     */
     ...
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.cloudngfw.v20230901preview.AzureResourceManagerManagedIdentityPropertiesArgs>;
    /**
     * Global Location
     */
     ...
     * Rulestack Type
     */
    scope?: pulumi.Input<string | enums.cloudngfw.v20230901preview.ScopeType>;
    /**
     * Security Profile
     */
    securityServices?: pulumi.Input<inputs.cloudngfw.v20230901preview.SecurityServicesArgs>;
}
