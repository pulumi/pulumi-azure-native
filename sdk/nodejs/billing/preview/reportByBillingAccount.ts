...
export class ReportByBillingAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:billing/preview:ReportByBillingAccount';
    ...
    constructor(name: string, argsOrState?: ReportByBillingAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:billing/v20180801preview:ReportByBillingAccount" }] };
