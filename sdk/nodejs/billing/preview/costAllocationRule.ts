...
export class CostAllocationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CostAllocationRule {
        return new CostAllocationRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:billing/preview:CostAllocationRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.billing.preview.CostAllocationRulePropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: CostAllocationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CostAllocationRuleArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:billing/v20200301preview:CostAllocationRule" }] };
...
export interface CostAllocationRuleArgs {
     ...
     * Cost allocation rule properties
     */
    readonly properties?: pulumi.Input<inputs.billing.preview.CostAllocationRuleProperties>;
    /**
