...
export class BillingRoleAssignmentByEnrollmentAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:billing/preview:BillingRoleAssignmentByEnrollmentAccount';
    ...
    constructor(name: string, argsOrState?: BillingRoleAssignmentByEnrollmentAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:billing/v20191001preview:BillingRoleAssignmentByEnrollmentAccount" }] };
