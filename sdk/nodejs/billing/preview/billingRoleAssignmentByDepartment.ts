...
export class BillingRoleAssignmentByDepartment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BillingRoleAssignmentByDepartment {
        return new BillingRoleAssignmentByDepartment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:billing/preview:BillingRoleAssignmentByDepartment';
    ...
    constructor(name: string, argsOrState?: BillingRoleAssignmentByDepartmentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as BillingRoleAssignmentByDepartmentArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:billing/v20191001preview:BillingRoleAssignmentByDepartment" }] };
