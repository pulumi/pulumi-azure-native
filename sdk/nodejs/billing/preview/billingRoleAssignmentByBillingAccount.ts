...
export class BillingRoleAssignmentByBillingAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:billing/preview:BillingRoleAssignmentByBillingAccount';
    ...
    constructor(name: string, argsOrState?: BillingRoleAssignmentByBillingAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:billing/v20191001preview:BillingRoleAssignmentByBillingAccount" }] };
