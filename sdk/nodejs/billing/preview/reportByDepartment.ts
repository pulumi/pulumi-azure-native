...
export class ReportByDepartment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReportByDepartment {
        return new ReportByDepartment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:billing/preview:ReportByDepartment';
     ...
     */
    public readonly definition!: pulumi.Output<outputs.billing.preview.ReportDefinitionResponse>;
    /**
     * Has delivery information for the report.
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.billing.preview.ReportDeliveryInfoResponse>;
    /**
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.billing.preview.ReportScheduleResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ReportByDepartmentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReportByDepartmentArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:billing/v20180801preview:ReportByDepartment" }] };
...
export interface ReportByDepartmentArgs {
     ...
     * Has definition for the report.
     */
    readonly definition: pulumi.Input<inputs.billing.preview.ReportDefinition>;
    /**
     * Has delivery information for the report.
     */
    readonly deliveryInfo: pulumi.Input<inputs.billing.preview.ReportDeliveryInfo>;
    /**
     * Department ID
     */
     ...
     * Has schedule information for the report.
     */
    readonly schedule?: pulumi.Input<inputs.billing.preview.ReportSchedule>;
}
