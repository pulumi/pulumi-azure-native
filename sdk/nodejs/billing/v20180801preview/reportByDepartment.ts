...
export class ReportByDepartment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:billing/v20180801preview:ReportByDepartment';
    ...
    constructor(name: string, argsOrState?: ReportByDepartmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:billing/preview:ReportByDepartment" }] };
