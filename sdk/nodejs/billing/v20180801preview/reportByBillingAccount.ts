...
export class ReportByBillingAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReportByBillingAccount {
        return new ReportByBillingAccount(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: ReportByBillingAccountArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ReportByBillingAccountArgs | undefined;
