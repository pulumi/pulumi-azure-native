...
export class BillingRoleAssignmentByBillingAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BillingRoleAssignmentByBillingAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:billing/v20191001preview:BillingRoleAssignmentByBillingAccount" }, { type: "azure-native:billing:BillingRoleAssignmentByBillingAccount" }, { type: "azure-nextgen:billing:BillingRoleAssignmentByBillingAccount" }] };
