...
export class BillingRoleAssignmentByEnrollmentAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:billing:BillingRoleAssignmentByEnrollmentAccount';
    ...
    constructor(name: string, args: BillingRoleAssignmentByEnrollmentAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:billing/v20191001preview:BillingRoleAssignmentByEnrollmentAccount" }] };
