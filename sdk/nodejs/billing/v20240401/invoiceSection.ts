...
export class InvoiceSection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:billing/v20240401:InvoiceSection';
     ...
     * An invoice section.
     */
    public readonly properties!: pulumi.Output<outputs.billing.v20240401.InvoiceSectionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: InvoiceSectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:billing:InvoiceSection" }] };
...
export interface InvoiceSectionArgs {
     ...
     * An invoice section.
     */
    properties?: pulumi.Input<inputs.billing.v20240401.InvoiceSectionPropertiesArgs>;
    /**
     * Dictionary of metadata associated with the resource. It may not be populated for all resource types. Maximum key/value length supported of 256 characters. Keys/value should not empty value nor null. Keys can not contain < > % & \ ? /
     */
