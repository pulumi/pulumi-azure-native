...
export class BillingRoleAssignmentByEnrollmentAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:billing/v20240401:BillingRoleAssignmentByEnrollmentAccount';
     ...
     * The properties of the billing role assignment.
     */
    public readonly properties!: pulumi.Output<outputs.billing.v20240401.BillingRoleAssignmentPropertiesResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.billing.v20240401.SystemDataResponse>;
    /**
...
export interface BillingRoleAssignmentByEnrollmentAccountArgs {
     ...
     * The properties of the billing role assignment.
     */
    properties?: pulumi.Input<inputs.billing.v20240401.BillingRoleAssignmentPropertiesArgs>;
    /**
     * Dictionary of metadata associated with the resource. It may not be populated for all resource types. Maximum key/value length supported of 256 characters. Keys/value should not empty value nor null. Keys can not contain < > % & \ ? /
     */
