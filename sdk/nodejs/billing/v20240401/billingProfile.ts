...
export class BillingProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:billing/v20240401:BillingProfile';
     ...
     * A billing profile.
     */
    public readonly properties!: pulumi.Output<outputs.billing.v20240401.BillingProfilePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BillingProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:billing:BillingProfile" }] };
