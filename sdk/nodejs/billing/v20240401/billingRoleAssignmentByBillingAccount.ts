...
export class BillingRoleAssignmentByBillingAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:billing/v20240401:BillingRoleAssignmentByBillingAccount';
    ...
    constructor(name: string, args: BillingRoleAssignmentByBillingAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:billing:BillingRoleAssignmentByBillingAccount" }, { type: "azure-native:billing/v20191001preview:BillingRoleAssignmentByBillingAccount" }] };
