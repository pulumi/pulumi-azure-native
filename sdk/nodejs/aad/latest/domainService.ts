...
export class DomainService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:aad/latest:DomainService';
     ...
     */
    public /*out*/ readonly migrationProperties!: pulumi.Output<outputs.aad.latest.MigrationPropertiesResponse>;
    /**
     * Resource name
     */
