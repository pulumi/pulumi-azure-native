...
export class OuContainer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OuContainer {
        pulumi.log.warn("OuContainer is deprecated: azure-native:aad/v20210301:OuContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:aad/v20221201:OuContainer to guarantee forwards compatibility.")
        return new OuContainer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:aad/v20210301:OuContainer';
     ...
     */
    public /*out*/ readonly accounts!: pulumi.Output<outputs.aad.v20210301.ContainerAccountResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.aad.v20210301.SystemDataResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: OuContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:aad:OuContainer" }, { type: "azure-native:aad/v20170601:OuContainer" }, { type: "azure-native:aad/v20200101:OuContainer" }, { type: "azure-native:aad/v20210501:OuContainer" }, { type: "azure-native:aad/v20220901:OuContainer" }, { type: "azure-native:aad/v20221201:OuContainer" }] };
