...
export class OuContainer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OuContainer {
        pulumi.log.warn("OuContainer is deprecated: azure-native:aad/v20220901:OuContainer is being removed in the next major version of this provider. Please upgrade to azure-native:aad/v20221201:OuContainer to guarantee forwards compatibility.")
        return new OuContainer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:aad/v20220901:OuContainer';
     ...
     */
    public /*out*/ readonly accounts!: pulumi.Output<outputs.aad.v20220901.ContainerAccountResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: OuContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:aad:OuContainer" }, { type: "azure-native:aad/v20170601:OuContainer" }, { type: "azure-native:aad/v20200101:OuContainer" }, { type: "azure-native:aad/v20210301:OuContainer" }, { type: "azure-native:aad/v20210501:OuContainer" }, { type: "azure-native:aad/v20221201:OuContainer" }] };
