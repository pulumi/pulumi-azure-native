...
export class DomainService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DomainService {
        pulumi.log.warn("DomainService is deprecated: azure-native:aad/v20220901:DomainService is being removed in the next major version of this provider. Upgrade to at least azure-native:aad/v20221201:DomainService to guarantee forwards compatibility.")
        return new DomainService(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:aad/v20220901:DomainService';
     ...
     */
    public readonly configDiagnostics!: pulumi.Output<outputs.aad.v20220901.ConfigDiagnosticsResponse | undefined>;
    /**
     * Deployment Id
     */
     ...
     */
    public readonly domainSecuritySettings!: pulumi.Output<outputs.aad.v20220901.DomainSecuritySettingsResponse | undefined>;
    /**
     * Resource etag
     */
     ...
     */
    public readonly ldapsSettings!: pulumi.Output<outputs.aad.v20220901.LdapsSettingsResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly migrationProperties!: pulumi.Output<outputs.aad.v20220901.MigrationPropertiesResponse>;
    /**
     * Resource name
     */
     ...
     */
    public readonly notificationSettings!: pulumi.Output<outputs.aad.v20220901.NotificationSettingsResponse | undefined>;
    /**
     ...
     * List of ReplicaSets
     */
    public readonly replicaSets!: pulumi.Output<outputs.aad.v20220901.ReplicaSetResponse[] | undefined>;
    /**
     * Resource Forest Settings
     */
    public readonly resourceForestSettings!: pulumi.Output<outputs.aad.v20220901.ResourceForestSettingsResponse | undefined>;
    /**
     * Sku Type
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.aad.v20220901.SystemDataResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: DomainServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["domainSecuritySettings"] = args ? (args.domainSecuritySettings ? pulumi.output(args.domainSecuritySettings).apply(inputs.aad.v20220901.domainSecuritySettingsArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["ldapsSettings"] = args ? (args.ldapsSettings ? pulumi.output(args.ldapsSettings).apply(inputs.aad.v20220901.ldapsSettingsArgsProvideDefaults) : undefined) : undefined;
...
export interface DomainServiceArgs {
     ...
     * Configuration diagnostics data containing latest execution from client.
     */
    configDiagnostics?: pulumi.Input<inputs.aad.v20220901.ConfigDiagnosticsArgs>;
    /**
     * Domain Configuration Type
     */
     ...
     * DomainSecurity Settings
     */
    domainSecuritySettings?: pulumi.Input<inputs.aad.v20220901.DomainSecuritySettingsArgs>;
    /**
     ...
     * Enabled or Disabled flag to turn on Group-based filtered sync
     */
    filteredSync?: pulumi.Input<string | enums.aad.v20220901.FilteredSync>;
    /**
     * Secure LDAP Settings
     */
    ldapsSettings?: pulumi.Input<inputs.aad.v20220901.LdapsSettingsArgs>;
    /**
     * Resource location
     */
     ...
     * Notification Settings
     */
    notificationSettings?: pulumi.Input<inputs.aad.v20220901.NotificationSettingsArgs>;
    /**
     * List of ReplicaSets
     */
    replicaSets?: pulumi.Input<pulumi.Input<inputs.aad.v20220901.ReplicaSetArgs>[]>;
    /**
     * Resource Forest Settings
     */
    resourceForestSettings?: pulumi.Input<inputs.aad.v20220901.ResourceForestSettingsArgs>;
    /**
     ...
     * All or CloudOnly, All users in AAD are synced to AAD DS domain or only users actively syncing in the cloud
     */
    syncScope?: pulumi.Input<string | enums.aad.v20220901.SyncScope>;
    /**
     * Resource tags
     */
