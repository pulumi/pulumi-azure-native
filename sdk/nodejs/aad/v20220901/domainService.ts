...
export class DomainService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DomainService {
        pulumi.log.warn("DomainService is deprecated: azure-native:aad/v20220901:DomainService is being removed in the next major version of this provider. Please upgrade to azure-native:aad/v20221201:DomainService to guarantee forwards compatibility.")
