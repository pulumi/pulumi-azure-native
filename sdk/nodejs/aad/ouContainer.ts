...
export class OuContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:aad:OuContainer';
    ...
    constructor(name: string, args: OuContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:aad/latest:OuContainer" }, { type: "azure-nextgen:aad/v20170601:OuContainer" }, { type: "azure-nextgen:aad/v20200101:OuContainer" }] };
