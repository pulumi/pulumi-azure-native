...
export class DomainService extends pulumi.CustomResource {
     ...
     */
    public readonly configDiagnostics!: pulumi.Output<outputs.aad.v20221201.ConfigDiagnosticsResponse | undefined>;
    /**
     * Deployment Id
     */
     ...
     */
    public readonly domainSecuritySettings!: pulumi.Output<outputs.aad.v20221201.DomainSecuritySettingsResponse | undefined>;
    /**
     * Resource etag
     */
     ...
     */
    public readonly ldapsSettings!: pulumi.Output<outputs.aad.v20221201.LdapsSettingsResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly migrationProperties!: pulumi.Output<outputs.aad.v20221201.MigrationPropertiesResponse>;
    /**
     * Resource name
     */
     ...
     */
    public readonly notificationSettings!: pulumi.Output<outputs.aad.v20221201.NotificationSettingsResponse | undefined>;
    /**
     ...
     * List of ReplicaSets
     */
    public readonly replicaSets!: pulumi.Output<outputs.aad.v20221201.ReplicaSetResponse[] | undefined>;
    /**
     * Resource Forest Settings
     */
    public readonly resourceForestSettings!: pulumi.Output<outputs.aad.v20221201.ResourceForestSettingsResponse | undefined>;
    /**
     * Sku Type
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.aad.v20221201.SystemDataResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: DomainServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["domainSecuritySettings"] = args ? (args.domainSecuritySettings ? pulumi.output(args.domainSecuritySettings).apply(inputs.aad.v20221201.domainSecuritySettingsArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["ldapsSettings"] = args ? (args.ldapsSettings ? pulumi.output(args.ldapsSettings).apply(inputs.aad.v20221201.ldapsSettingsArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:aad:DomainService" }, { type: "azure-native:aad/v20210301:DomainService" }, { type: "azure-native:aad/v20210501:DomainService" }, { type: "azure-native:aad/v20220901:DomainService" }] };
...
export interface DomainServiceArgs {
     ...
     * Configuration diagnostics data containing latest execution from client.
     */
    configDiagnostics?: pulumi.Input<inputs.aad.v20221201.ConfigDiagnosticsArgs>;
    /**
     * Domain Configuration Type
     */
     ...
     * DomainSecurity Settings
     */
    domainSecuritySettings?: pulumi.Input<inputs.aad.v20221201.DomainSecuritySettingsArgs>;
    /**
     ...
     * Enabled or Disabled flag to turn on Group-based filtered sync
     */
    filteredSync?: pulumi.Input<string | enums.aad.v20221201.FilteredSync>;
    /**
     * Secure LDAP Settings
     */
    ldapsSettings?: pulumi.Input<inputs.aad.v20221201.LdapsSettingsArgs>;
    /**
     * Resource location
     */
     ...
     * Notification Settings
     */
    notificationSettings?: pulumi.Input<inputs.aad.v20221201.NotificationSettingsArgs>;
    /**
     * List of ReplicaSets
     */
    replicaSets?: pulumi.Input<pulumi.Input<inputs.aad.v20221201.ReplicaSetArgs>[]>;
    /**
     * Resource Forest Settings
     */
    resourceForestSettings?: pulumi.Input<inputs.aad.v20221201.ResourceForestSettingsArgs>;
    /**
     ...
     * All or CloudOnly, All users in AAD are synced to AAD DS domain or only users actively syncing in the cloud
     */
    syncScope?: pulumi.Input<string | enums.aad.v20221201.SyncScope>;
    /**
     * Resource tags
     */
