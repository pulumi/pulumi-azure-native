...
export class DomainService extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainServiceState, opts?: pulumi.CustomResourceOptions): DomainService {
        return new DomainService(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:aad:DomainService';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.aad.DomainServicePropertiesResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: DomainServiceArgs | DomainServiceState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as DomainServiceState | undefined;
...
export interface DomainServiceState {
     ...
     * Domain service properties
     */
    readonly properties: pulumi.Input<inputs.aad.DomainServicePropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface DomainServiceArgs {
     ...
     * Domain service properties
     */
    readonly properties?: pulumi.Input<inputs.aad.DomainServiceProperties>;
    /**
