...
export class DomainService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:aad:DomainService';
    ...
    constructor(name: string, args: DomainServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:aad/latest:DomainService" }, { type: "azure-nextgen:aad/v20170101:DomainService" }, { type: "azure-nextgen:aad/v20170601:DomainService" }, { type: "azure-nextgen:aad/v20200101:DomainService" }] };
...
export interface DomainServiceArgs {
     ...
     * DomainSecurity Settings
     */
    readonly domainSecuritySettings?: pulumi.Input<inputs.aad.DomainSecuritySettings>;
    /**
     ...
     * Secure LDAP Settings
     */
    readonly ldapsSettings?: pulumi.Input<inputs.aad.LdapsSettings>;
    /**
     * Resource location
     */
     ...
     * Notification Settings
     */
    readonly notificationSettings?: pulumi.Input<inputs.aad.NotificationSettings>;
    /**
     * List of ReplicaSets
     */
    readonly replicaSets?: pulumi.Input<pulumi.Input<inputs.aad.ReplicaSet>[]>;
    /**
     * Resource Forest Settings
     */
    readonly resourceForestSettings?: pulumi.Input<inputs.aad.ResourceForestSettings>;
    /**
