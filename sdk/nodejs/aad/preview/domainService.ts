...
export class DomainService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:aad/preview:DomainService';
     ...
     */
    public readonly domainSecuritySettings!: pulumi.Output<outputs.aad.preview.DomainSecuritySettingsResponse | undefined>;
    /**
     * Resource etag
     */
     ...
     */
    public readonly ldapsSettings!: pulumi.Output<outputs.aad.preview.LdapsSettingsResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly notificationSettings!: pulumi.Output<outputs.aad.preview.NotificationSettingsResponse | undefined>;
    /**
     ...
     * List of ReplicaSets
     */
    public readonly replicaSets!: pulumi.Output<outputs.aad.preview.ReplicaSetResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: DomainServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aad/latest:DomainService" }, { type: "azurerm:aad/v20170101:DomainService" }, { type: "azurerm:aad/v20170601:DomainService" }, { type: "azurerm:aad/v20200101:DomainService" }] };
...
export interface DomainServiceArgs {
     ...
     * DomainSecurity Settings
     */
    readonly domainSecuritySettings?: pulumi.Input<inputs.aad.preview.DomainSecuritySettings>;
    /**
     ...
     * Secure LDAP Settings
     */
    readonly ldapsSettings?: pulumi.Input<inputs.aad.preview.LdapsSettings>;
    /**
     * Resource location
     */
     ...
     * Notification Settings
     */
    readonly notificationSettings?: pulumi.Input<inputs.aad.preview.NotificationSettings>;
    /**
     * List of ReplicaSets
     */
    readonly replicaSets?: pulumi.Input<pulumi.Input<inputs.aad.preview.ReplicaSet>[]>;
    /**
