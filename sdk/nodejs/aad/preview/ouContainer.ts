...
export class OuContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:aad/preview:OuContainer';
     ...
     */
    public /*out*/ readonly accounts!: pulumi.Output<outputs.aad.preview.ContainerAccountResponse[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: OuContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aad/latest:OuContainer" }, { type: "azurerm:aad/v20170601:OuContainer" }, { type: "azurerm:aad/v20200101:OuContainer" }] };
