 ...
 *
 * const domainService = new azurerm.aad.v20170601.DomainService("domainService", {
...
export class DomainService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:aad/v20170601:DomainService';
    ...
    constructor(name: string, argsOrState?: DomainServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aad/latest:DomainService" }, { type: "azurerm:aad/v20170101:DomainService" }, { type: "azurerm:aad/v20200101:DomainService" }] };
