...
export class DomainService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DomainServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:aad/latest:DomainService" }, { type: "azure-nextgen:aad/v20170601:DomainService" }, { type: "azure-nextgen:aad/v20200101:DomainService" }] };
