...
export class DomainService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:aad/v20170101:DomainService';
    ...
    constructor(name: string, args: DomainServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:aad:DomainService" }, { type: "azure-nextgen:aad/latest:DomainService" }, { type: "azure-nextgen:aad/v20170601:DomainService" }, { type: "azure-nextgen:aad/v20200101:DomainService" }] };
