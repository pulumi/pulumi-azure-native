...
export class DomainService extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DomainServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:aad/latest:DomainService" }, { type: "azurerm:aad/preview:DomainService" }, { type: "azurerm:aad/v20170101:DomainService" }, { type: "azurerm:aad/v20170601:DomainService" }] };
