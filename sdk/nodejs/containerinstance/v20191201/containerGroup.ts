...
export class ContainerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerinstance/v20191201:ContainerGroup';
    ...
    constructor(name: string, args: ContainerGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerinstance/v20191201:ContainerGroup" }, { type: "azure-native:containerinstance:ContainerGroup" }, { type: "azure-nextgen:containerinstance:ContainerGroup" }, { type: "azure-native:containerinstance/v20170801preview:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20170801preview:ContainerGroup" }, { type: "azure-native:containerinstance/v20171001preview:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20171001preview:ContainerGroup" }, { type: "azure-native:containerinstance/v20171201preview:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20171201preview:ContainerGroup" }, { type: "azure-native:containerinstance/v20180201preview:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20180201preview:ContainerGroup" }, { type: "azure-native:containerinstance/v20180401:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20180401:ContainerGroup" }, { type: "azure-native:containerinstance/v20180601:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20180601:ContainerGroup" }, { type: "azure-native:containerinstance/v20180901:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20180901:ContainerGroup" }, { type: "azure-native:containerinstance/v20181001:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20181001:ContainerGroup" }, { type: "azure-native:containerinstance/v20201101:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20201101:ContainerGroup" }, { type: "azure-native:containerinstance/v20210301:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20210301:ContainerGroup" }] };
...
export interface ContainerGroupArgs {
     ...
     * The containers within the container group.
     */
    readonly containers: pulumi.Input<pulumi.Input<inputs.containerinstance.v20191201.ContainerArgs>[]>;
    /**
     * The diagnostic information for a container group.
     */
    readonly diagnostics?: pulumi.Input<inputs.containerinstance.v20191201.ContainerGroupDiagnosticsArgs>;
    /**
     * The DNS config information for a container group.
     */
    readonly dnsConfig?: pulumi.Input<inputs.containerinstance.v20191201.DnsConfigurationArgs>;
    /**
     * The encryption properties for a container group.
     */
    readonly encryptionProperties?: pulumi.Input<inputs.containerinstance.v20191201.EncryptionPropertiesArgs>;
    /**
     * The identity of the container group, if configured.
     */
    readonly identity?: pulumi.Input<inputs.containerinstance.v20191201.ContainerGroupIdentityArgs>;
    /**
     * The image registry credentials by which the container group is created from.
     */
    readonly imageRegistryCredentials?: pulumi.Input<pulumi.Input<inputs.containerinstance.v20191201.ImageRegistryCredentialArgs>[]>;
    /**
     * The init containers for a container group.
     */
    readonly initContainers?: pulumi.Input<pulumi.Input<inputs.containerinstance.v20191201.InitContainerDefinitionArgs>[]>;
    /**
     * The IP address type of the container group.
     */
    readonly ipAddress?: pulumi.Input<inputs.containerinstance.v20191201.IpAddressArgs>;
    /**
     * The resource location.
     */
     ...
     * The network profile information for a container group.
     */
    readonly networkProfile?: pulumi.Input<inputs.containerinstance.v20191201.ContainerGroupNetworkProfileArgs>;
    /**
     * The operating system type required by the containers in the container group.
     */
     ...
     * The list of volumes that can be mounted by containers in this container group.
     */
    readonly volumes?: pulumi.Input<pulumi.Input<inputs.containerinstance.v20191201.VolumeArgs>[]>;
}
