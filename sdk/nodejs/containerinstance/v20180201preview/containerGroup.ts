...
export class ContainerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:containerinstance/v20180201preview:ContainerGroup';
     ...
     */
    public readonly containers!: pulumi.Output<outputs.containerinstance.v20180201preview.ContainerResponse[]>;
    /**
     * The image registry credentials by which the container group is created from.
     */
    public readonly imageRegistryCredentials!: pulumi.Output<outputs.containerinstance.v20180201preview.ImageRegistryCredentialResponse[] | undefined>;
    /**
     * The instance view of the container group. Only valid in response.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.containerinstance.v20180201preview.ContainerGroupResponseInstanceView>;
    /**
     * The IP address type of the container group.
     */
    public readonly ipAddress!: pulumi.Output<outputs.containerinstance.v20180201preview.IpAddressResponse | undefined>;
    /**
     ...
     */
    public readonly volumes!: pulumi.Output<outputs.containerinstance.v20180201preview.VolumeResponse[] | undefined>;
    ...
    constructor(name: string, args: ContainerGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerinstance/latest:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20170801preview:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20171001preview:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20171201preview:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20180401:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20180601:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20180901:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20181001:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20191201:ContainerGroup" }, { type: "azure-nextgen:containerinstance/v20201101:ContainerGroup" }] };
...
export interface ContainerGroupArgs {
     ...
     * The containers within the container group.
     */
    readonly containers: pulumi.Input<pulumi.Input<inputs.containerinstance.v20180201preview.Container>[]>;
    /**
     * The image registry credentials by which the container group is created from.
     */
    readonly imageRegistryCredentials?: pulumi.Input<pulumi.Input<inputs.containerinstance.v20180201preview.ImageRegistryCredential>[]>;
    /**
     * The IP address type of the container group.
     */
    readonly ipAddress?: pulumi.Input<inputs.containerinstance.v20180201preview.IpAddress>;
    /**
     * The resource location.
     */
     ...
     * The operating system type required by the containers in the container group.
     */
    readonly osType: pulumi.Input<string | enums.containerinstance.v20180201preview.OperatingSystemTypes>;
    /**
     ...
     * - `Never` Never restart
     */
    readonly restartPolicy?: pulumi.Input<string | enums.containerinstance.v20180201preview.ContainerGroupRestartPolicy>;
    /**
     * The resource tags.
     */
     ...
     * The list of volumes that can be mounted by containers in this container group.
     */
    readonly volumes?: pulumi.Input<pulumi.Input<inputs.containerinstance.v20180201preview.Volume>[]>;
}
