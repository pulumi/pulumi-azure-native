...
export function getContainerGroup(args: GetContainerGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerGroupResult> {
    ...
    return pulumi.runtime.invoke("azurerm:containerinstance:getContainerGroup", {
        "name": args.name,
...
export interface GetContainerGroupResult {
     ...
     */
    readonly properties: outputs.containerinstance.ContainerGroupResponseProperties;
    /**
     * The resource tags.
     */
