...
export class ContainerGroup extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.containerinstance.v20181001.ContainerGroupIdentityResponse>;
    /**
...
export interface ContainerGroupArgs {
    ...
    readonly properties: pulumi.Input<inputs.containerinstance.v20181001.ContainerGroupProperties>;
    /**
