 ...
 *
 * const containerGroup = new azurerm.containerinstance.v20181001.ContainerGroup("containerGroup", {
...
export class ContainerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerinstance/v20181001:ContainerGroup';
    ...
    constructor(name: string, argsOrState?: ContainerGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:containerinstance/latest:ContainerGroup" }, { type: "azurerm:containerinstance/v20180401:ContainerGroup" }, { type: "azurerm:containerinstance/v20180601:ContainerGroup" }, { type: "azurerm:containerinstance/v20180901:ContainerGroup" }, { type: "azurerm:containerinstance/v20191201:ContainerGroup" }] };
