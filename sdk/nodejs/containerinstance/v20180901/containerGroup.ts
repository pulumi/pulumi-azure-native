...
export interface ContainerGroupArgs {
     ...
     * The operating system type required by the containers in the container group.
     */
    readonly osType: pulumi.Input<string | enums.containerinstance.v20180901.OperatingSystemTypes>;
    /**
     ...
     * - `Never` Never restart
     */
    readonly restartPolicy?: pulumi.Input<string | enums.containerinstance.v20180901.ContainerGroupRestartPolicy>;
    /**
     * The resource tags.
     */
