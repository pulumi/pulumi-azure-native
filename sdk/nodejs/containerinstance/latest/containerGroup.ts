 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:containerinstance:ContainerGroup'.
 */
export class ContainerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerinstance/latest:ContainerGroup';
     ...
     */
    public readonly containers!: pulumi.Output<outputs.containerinstance.latest.ContainerResponse[]>;
    /**
     * The diagnostic information for a container group.
     */
    public readonly diagnostics!: pulumi.Output<outputs.containerinstance.latest.ContainerGroupDiagnosticsResponse | undefined>;
    /**
     * The DNS config information for a container group.
     */
    public readonly dnsConfig!: pulumi.Output<outputs.containerinstance.latest.DnsConfigurationResponse | undefined>;
    /**
     * The encryption properties for a container group.
     */
    public readonly encryptionProperties!: pulumi.Output<outputs.containerinstance.latest.EncryptionPropertiesResponse | undefined>;
    /**
     * The identity of the container group, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.containerinstance.latest.ContainerGroupIdentityResponse | undefined>;
    /**
     * The image registry credentials by which the container group is created from.
     */
    public readonly imageRegistryCredentials!: pulumi.Output<outputs.containerinstance.latest.ImageRegistryCredentialResponse[] | undefined>;
    /**
     * The init containers for a container group.
     */
    public readonly initContainers!: pulumi.Output<outputs.containerinstance.latest.InitContainerDefinitionResponse[] | undefined>;
    /**
     * The instance view of the container group. Only valid in response.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.containerinstance.latest.ContainerGroupResponseInstanceView>;
    /**
     * The IP address type of the container group.
     */
    public readonly ipAddress!: pulumi.Output<outputs.containerinstance.latest.IpAddressResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.containerinstance.latest.ContainerGroupNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly volumes!: pulumi.Output<outputs.containerinstance.latest.VolumeResponse[] | undefined>;
...
export interface ContainerGroupArgs {
     ...
     * The containers within the container group.
     */
    readonly containers: pulumi.Input<pulumi.Input<inputs.containerinstance.latest.Container>[]>;
    /**
     * The diagnostic information for a container group.
     */
    readonly diagnostics?: pulumi.Input<inputs.containerinstance.latest.ContainerGroupDiagnostics>;
    /**
     * The DNS config information for a container group.
     */
    readonly dnsConfig?: pulumi.Input<inputs.containerinstance.latest.DnsConfiguration>;
    /**
     * The encryption properties for a container group.
     */
    readonly encryptionProperties?: pulumi.Input<inputs.containerinstance.latest.EncryptionProperties>;
    /**
     * The identity of the container group, if configured.
     */
    readonly identity?: pulumi.Input<inputs.containerinstance.latest.ContainerGroupIdentity>;
    /**
     * The image registry credentials by which the container group is created from.
     */
    readonly imageRegistryCredentials?: pulumi.Input<pulumi.Input<inputs.containerinstance.latest.ImageRegistryCredential>[]>;
    /**
     * The init containers for a container group.
     */
    readonly initContainers?: pulumi.Input<pulumi.Input<inputs.containerinstance.latest.InitContainerDefinition>[]>;
    /**
     * The IP address type of the container group.
     */
    readonly ipAddress?: pulumi.Input<inputs.containerinstance.latest.IpAddress>;
    /**
     * The resource location.
     */
     ...
     * The network profile information for a container group.
     */
    readonly networkProfile?: pulumi.Input<inputs.containerinstance.latest.ContainerGroupNetworkProfile>;
    /**
     * The operating system type required by the containers in the container group.
     */
    readonly osType: pulumi.Input<string | enums.containerinstance.latest.OperatingSystemTypes>;
    /**
     ...
     * - `Never` Never restart
     */
    readonly restartPolicy?: pulumi.Input<string | enums.containerinstance.latest.ContainerGroupRestartPolicy>;
    /**
     * The SKU for a container group.
     */
    readonly sku?: pulumi.Input<string | enums.containerinstance.latest.ContainerGroupSku>;
    /**
     * The resource tags.
     */
     ...
     * The list of volumes that can be mounted by containers in this container group.
     */
    readonly volumes?: pulumi.Input<pulumi.Input<inputs.containerinstance.latest.Volume>[]>;
}
