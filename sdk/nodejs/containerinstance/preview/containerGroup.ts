...
export class ContainerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:containerinstance/preview:ContainerGroup';
     ...
     */
    public readonly containers!: pulumi.Output<outputs.containerinstance.preview.ContainerResponse[]>;
    /**
     * The diagnostic information for a container group.
     */
    public readonly diagnostics!: pulumi.Output<outputs.containerinstance.preview.ContainerGroupDiagnosticsResponse | undefined>;
    /**
     * The DNS config information for a container group.
     */
    public readonly dnsConfig!: pulumi.Output<outputs.containerinstance.preview.DnsConfigurationResponse | undefined>;
    /**
     * The encryption properties for a container group.
     */
    public readonly encryptionProperties!: pulumi.Output<outputs.containerinstance.preview.EncryptionPropertiesResponse | undefined>;
    /**
     * The identity of the container group, if configured.
     */
    public readonly identity!: pulumi.Output<outputs.containerinstance.preview.ContainerGroupIdentityResponse | undefined>;
    /**
     * The image registry credentials by which the container group is created from.
     */
    public readonly imageRegistryCredentials!: pulumi.Output<outputs.containerinstance.preview.ImageRegistryCredentialResponse[] | undefined>;
    /**
     * The init containers for a container group.
     */
    public readonly initContainers!: pulumi.Output<outputs.containerinstance.preview.InitContainerDefinitionResponse[] | undefined>;
    /**
     * The instance view of the container group. Only valid in response.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<outputs.containerinstance.preview.ContainerGroupResponseInstanceView>;
    /**
     * The IP address type of the container group.
     */
    public readonly ipAddress!: pulumi.Output<outputs.containerinstance.preview.IpAddressResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<outputs.containerinstance.preview.ContainerGroupNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly volumes!: pulumi.Output<outputs.containerinstance.preview.VolumeResponse[] | undefined>;
...
export interface ContainerGroupArgs {
     ...
     * The containers within the container group.
     */
    readonly containers: pulumi.Input<pulumi.Input<inputs.containerinstance.preview.Container>[]>;
    /**
     * The diagnostic information for a container group.
     */
    readonly diagnostics?: pulumi.Input<inputs.containerinstance.preview.ContainerGroupDiagnostics>;
    /**
     * The DNS config information for a container group.
     */
    readonly dnsConfig?: pulumi.Input<inputs.containerinstance.preview.DnsConfiguration>;
    /**
     * The encryption properties for a container group.
     */
    readonly encryptionProperties?: pulumi.Input<inputs.containerinstance.preview.EncryptionProperties>;
    /**
     * The identity of the container group, if configured.
     */
    readonly identity?: pulumi.Input<inputs.containerinstance.preview.ContainerGroupIdentity>;
    /**
     * The image registry credentials by which the container group is created from.
     */
    readonly imageRegistryCredentials?: pulumi.Input<pulumi.Input<inputs.containerinstance.preview.ImageRegistryCredential>[]>;
    /**
     * The init containers for a container group.
     */
    readonly initContainers?: pulumi.Input<pulumi.Input<inputs.containerinstance.preview.InitContainerDefinition>[]>;
    /**
     * The IP address type of the container group.
     */
    readonly ipAddress?: pulumi.Input<inputs.containerinstance.preview.IpAddress>;
    /**
     * The resource location.
     */
     ...
     * The network profile information for a container group.
     */
    readonly networkProfile?: pulumi.Input<inputs.containerinstance.preview.ContainerGroupNetworkProfile>;
    /**
     * The operating system type required by the containers in the container group.
     */
     ...
     * The list of volumes that can be mounted by containers in this container group.
     */
    readonly volumes?: pulumi.Input<pulumi.Input<inputs.containerinstance.preview.Volume>[]>;
}
