...
export class ContainerGroup extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.containerinstance.v20211001.ContainerGroupPropertiesResponseProperties>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: ContainerGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.containerinstance.v20211001.containerGroupPropertiesPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface ContainerGroupArgs {
     ...
     * The container group properties
     */
    properties: pulumi.Input<inputs.containerinstance.v20211001.ContainerGroupPropertiesPropertiesArgs>;
    /**
