...
export class LoadBalancer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LoadBalancerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kubernetesruntime/v20231001preview:LoadBalancer" }, { type: "azure-native:kubernetesruntime:LoadBalancer" }] };
...
export interface LoadBalancerArgs {
     ...
     * Advertise Mode
     */
    advertiseMode: pulumi.Input<string | enums.kubernetesruntime.v20240301.AdvertiseMode>;
    /**
     * The list of BGP peers it should advertise to. Null or empty means to advertise to all peers.
     */
