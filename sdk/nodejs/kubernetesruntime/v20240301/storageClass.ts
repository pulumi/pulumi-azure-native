...
export class StorageClass extends pulumi.CustomResource {
     ...
     */
    public readonly typeProperties!: pulumi.Output<outputs.kubernetesruntime.v20240301.BlobStorageClassTypePropertiesResponse | outputs.kubernetesruntime.v20240301.NativeStorageClassTypePropertiesResponse | outputs.kubernetesruntime.v20240301.NfsStorageClassTypePropertiesResponse | outputs.kubernetesruntime.v20240301.RwxStorageClassTypePropertiesResponse | outputs.kubernetesruntime.v20240301.SmbStorageClassTypePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: StorageClassArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kubernetesruntime/v20231001preview:StorageClass" }, { type: "azure-native:kubernetesruntime:StorageClass" }] };
...
export interface StorageClassArgs {
     ...
     * The access mode: [ReadWriteOnce, ReadWriteMany] or [ReadWriteOnce]
     */
    accessModes?: pulumi.Input<pulumi.Input<string | enums.kubernetesruntime.v20240301.AccessMode>[]>;
    /**
     * Volume can be expanded or not
     */
    allowVolumeExpansion?: pulumi.Input<string | enums.kubernetesruntime.v20240301.VolumeExpansion>;
    /**
     * Allow single data node failure
     */
    dataResilience?: pulumi.Input<string | enums.kubernetesruntime.v20240301.DataResilienceTier>;
    /**
     * Failover speed: NA, Slow, Fast
     */
    failoverSpeed?: pulumi.Input<string | enums.kubernetesruntime.v20240301.FailoverTier>;
    /**
     * Limitations of the storage class
     */
     ...
     * Performance tier
     */
    performance?: pulumi.Input<string | enums.kubernetesruntime.v20240301.PerformanceTier>;
    /**
     * Selection priority when multiple storage classes meet the criteria. 0: Highest, -1: Never use
     */
     ...
     * Properties of the StorageClass
     */
    typeProperties: pulumi.Input<inputs.kubernetesruntime.v20240301.BlobStorageClassTypePropertiesArgs | inputs.kubernetesruntime.v20240301.NativeStorageClassTypePropertiesArgs | inputs.kubernetesruntime.v20240301.NfsStorageClassTypePropertiesArgs | inputs.kubernetesruntime.v20240301.RwxStorageClassTypePropertiesArgs | inputs.kubernetesruntime.v20240301.SmbStorageClassTypePropertiesArgs>;
    /**
     * Binding mode of volumes: Immediate, WaitForFirstConsumer
     */
    volumeBindingMode?: pulumi.Input<string | enums.kubernetesruntime.v20240301.VolumeBindingMode>;
}
