...
export class SmartDetectorAlertRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SmartDetectorAlertRule {
        pulumi.log.warn("SmartDetectorAlertRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:alertsmanagement:SmartDetectorAlertRule'.")
        return new SmartDetectorAlertRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:alertsmanagement/latest:SmartDetectorAlertRule';
    ...
    constructor(name: string, args: SmartDetectorAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:alertsmanagement/latest:SmartDetectorAlertRule" }, { type: "azure-native:alertsmanagement:SmartDetectorAlertRule" }, { type: "azure-nextgen:alertsmanagement:SmartDetectorAlertRule" }, { type: "azure-native:alertsmanagement/v20190301:SmartDetectorAlertRule" }, { type: "azure-nextgen:alertsmanagement/v20190301:SmartDetectorAlertRule" }, { type: "azure-native:alertsmanagement/v20190601:SmartDetectorAlertRule" }, { type: "azure-nextgen:alertsmanagement/v20190601:SmartDetectorAlertRule" }] };
