...
export function getSmartDetectorAlertRule(args: GetSmartDetectorAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetSmartDetectorAlertRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:alertsmanagement/v20190301:getSmartDetectorAlertRule", {
...
export interface GetSmartDetectorAlertRuleResult {
     ...
     */
    readonly actionGroups: outputs.alertsmanagement.v20190301.ActionGroupsInformationInvokeResponse;
    /**
     ...
     */
    readonly detector: outputs.alertsmanagement.v20190301.DetectorInvokeResponse;
    /**
     ...
     */
    readonly throttling?: outputs.alertsmanagement.v20190301.ThrottlingInformationInvokeResponse;
    /**
     * The resource type.
     */
