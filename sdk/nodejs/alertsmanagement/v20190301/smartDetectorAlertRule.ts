...
export class SmartDetectorAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:alertsmanagement/v20190301:SmartDetectorAlertRule';
    ...
    constructor(name: string, args: SmartDetectorAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:alertsmanagement/latest:SmartDetectorAlertRule" }, { type: "azurerm:alertsmanagement/preview:SmartDetectorAlertRule" }, { type: "azurerm:alertsmanagement/v20190601:SmartDetectorAlertRule" }] };
