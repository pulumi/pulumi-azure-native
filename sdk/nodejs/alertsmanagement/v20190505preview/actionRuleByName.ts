...
export class ActionRuleByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:alertsmanagement/v20190505preview:ActionRuleByName';
    ...
    constructor(name: string, args: ActionRuleByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:alertsmanagement/preview:ActionRuleByName" }, { type: "azurerm:alertsmanagement/v20181102privatepreview:ActionRuleByName" }] };
