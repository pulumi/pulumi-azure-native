...
export class ActionRuleByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:alertsmanagement:ActionRuleByName';
    ...
    constructor(name: string, args: ActionRuleByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:alertsmanagement/v20181102privatepreview:ActionRuleByName" }, { type: "azure-nextgen:alertsmanagement/v20190505preview:ActionRuleByName" }] };
