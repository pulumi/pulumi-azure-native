...
export class ActionRuleByName extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ActionRuleByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:alertsmanagement:ActionRuleByName" }, { type: "azure-native:alertsmanagement/v20181102privatepreview:ActionRuleByName" }, { type: "azure-nextgen:alertsmanagement/v20181102privatepreview:ActionRuleByName" }, { type: "azure-native:alertsmanagement/v20190505preview:ActionRuleByName" }, { type: "azure-nextgen:alertsmanagement/v20190505preview:ActionRuleByName" }] };
