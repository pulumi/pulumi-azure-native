...
export function getAlertProcessingRuleByName(args: GetAlertProcessingRuleByNameArgs, opts?: pulumi.InvokeOptions): Promise<GetAlertProcessingRuleByNameResult> {
    ...
    return pulumi.runtime.invoke("azure-native:alertsmanagement/v20240301preview:getAlertProcessingRuleByName", {
...
export interface GetAlertProcessingRuleByNameResult {
     ...
     */
    readonly properties: outputs.alertsmanagement.v20240301preview.AlertProcessingRulePropertiesResponse;
    /**
     * Alert processing rule system data.
     */
    readonly systemData: outputs.alertsmanagement.v20240301preview.SystemDataResponse;
    /**
     * Resource tags
     */
