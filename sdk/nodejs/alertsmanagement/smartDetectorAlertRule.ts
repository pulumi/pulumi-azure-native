...
export class SmartDetectorAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:alertsmanagement:SmartDetectorAlertRule';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.alertsmanagement.AlertRulePropertiesResponse>;
    /**
     * The resource tags.
     */
...
export interface SmartDetectorAlertRuleArgs {
     ...
     * The properties of the alert rule.
     */
    readonly properties?: pulumi.Input<inputs.alertsmanagement.AlertRuleProperties>;
    /**
