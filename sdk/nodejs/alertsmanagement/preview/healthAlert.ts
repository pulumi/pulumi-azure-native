...
export class HealthAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:alertsmanagement/preview:HealthAlert';
     ...
     */
    public readonly actions!: pulumi.Output<outputs.alertsmanagement.preview.HealthAlertActionResponse[] | undefined>;
    /**
     * defines the specific alert criteria information.
     */
    public readonly criteria!: pulumi.Output<outputs.alertsmanagement.preview.HealthAlertCriteriaResponse>;
    /**
    ...
    constructor(name: string, args: HealthAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:alertsmanagement/v20200804preview:HealthAlert" }] };
...
export interface HealthAlertArgs {
     ...
     * the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputs.alertsmanagement.preview.HealthAlertAction>[]>;
    /**
     * defines the specific alert criteria information.
     */
    readonly criteria: pulumi.Input<inputs.alertsmanagement.preview.HealthAlertCriteria>;
    /**
     * the description of the health alert that will be included in the alert email.
     */
