...
export function getSmartDetectorAlertRule(args: GetSmartDetectorAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetSmartDetectorAlertRuleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:alertsmanagement/preview:getSmartDetectorAlertRule", {
...
export interface GetSmartDetectorAlertRuleResult {
     ...
     */
    readonly actionGroups: outputs.alertsmanagement.preview.ActionGroupsInformationResponse;
    /**
     ...
     */
    readonly detector: outputs.alertsmanagement.preview.DetectorResponse;
    /**
     ...
     */
    readonly throttling?: outputs.alertsmanagement.preview.ThrottlingInformationResponse;
    /**
     * The resource type.
     */
