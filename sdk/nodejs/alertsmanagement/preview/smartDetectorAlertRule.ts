...
export class SmartDetectorAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:alertsmanagement/preview:SmartDetectorAlertRule';
     ...
     */
    public readonly actionGroups!: pulumi.Output<outputs.alertsmanagement.preview.ActionGroupsInformationResponse>;
    /**
     ...
     */
    public readonly detector!: pulumi.Output<outputs.alertsmanagement.preview.DetectorResponse>;
    /**
     ...
     */
    public readonly throttling!: pulumi.Output<outputs.alertsmanagement.preview.ThrottlingInformationResponse | undefined>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, argsOrState?: SmartDetectorAlertRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:alertsmanagement/latest:SmartDetectorAlertRule" }, { type: "azurerm:alertsmanagement/v20190301:SmartDetectorAlertRule" }, { type: "azurerm:alertsmanagement/v20190601:SmartDetectorAlertRule" }] };
...
export interface SmartDetectorAlertRuleArgs {
     ...
     * The alert rule actions.
     */
    readonly actionGroups: pulumi.Input<inputs.alertsmanagement.preview.ActionGroupsInformation>;
    /**
     ...
     * The alert rule's detector.
     */
    readonly detector: pulumi.Input<inputs.alertsmanagement.preview.Detector>;
    /**
     * The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 5 minutes.
     */
     ...
     * The alert rule throttling information.
     */
    readonly throttling?: pulumi.Input<inputs.alertsmanagement.preview.ThrottlingInformation>;
}
