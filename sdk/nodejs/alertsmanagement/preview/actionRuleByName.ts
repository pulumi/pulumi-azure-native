...
export class ActionRuleByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:alertsmanagement/preview:ActionRuleByName';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.alertsmanagement.preview.ActionGroupResponse | outputs.alertsmanagement.preview.DiagnosticsResponse | outputs.alertsmanagement.preview.SuppressionResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: ActionRuleByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:alertsmanagement/v20181102privatepreview:ActionRuleByName" }, { type: "azurerm:alertsmanagement/v20190505preview:ActionRuleByName" }] };
...
export interface ActionRuleByNameArgs {
     ...
     * action rule properties
     */
    readonly properties?: pulumi.Input<inputs.alertsmanagement.preview.ActionGroup | inputs.alertsmanagement.preview.Diagnostics | inputs.alertsmanagement.preview.Suppression>;
    /**
