...
export class AlertProcessingRuleByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:alertsmanagement/v20210808preview:AlertProcessingRuleByName';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.alertsmanagement.v20210808preview.AlertProcessingRulePropertiesResponse>;
    /**
     * Alert processing rule system data.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.alertsmanagement.v20210808preview.SystemDataResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: AlertProcessingRuleByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.alertsmanagement.v20210808preview.alertProcessingRulePropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:alertsmanagement/v20181102privatepreview:AlertProcessingRuleByName" }, { type: "azure-native:alertsmanagement/v20190505preview:ActionRuleByName" }, { type: "azure-native:alertsmanagement/v20190505preview:AlertProcessingRuleByName" }, { type: "azure-native:alertsmanagement/v20210808:AlertProcessingRuleByName" }, { type: "azure-native:alertsmanagement:ActionRuleByName" }, { type: "azure-native:alertsmanagement:AlertProcessingRuleByName" }] };
