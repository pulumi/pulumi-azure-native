...
export class AlertProcessingRuleByName extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AlertProcessingRuleByName {
        pulumi.log.warn("AlertProcessingRuleByName is deprecated: azure-native:alertsmanagement/v20210808preview:AlertProcessingRuleByName is being removed in the next major version of this provider. Upgrade to at least azure-native:alertsmanagement/v20230501preview:AlertProcessingRuleByName to guarantee forwards compatibility.")
