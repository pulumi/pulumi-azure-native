...
export class ActionRuleByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:alertsmanagement/v20210808preview:ActionRuleByName';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.alertsmanagement.v20210808preview.ActionRulePropertiesResponse>;
    /**
...
export interface ActionRuleByNameArgs {
    /**
     * The name of the action rule that needs to be created/updated
     */
     ...
     * Action rule properties
     */
    properties?: pulumi.Input<inputs.alertsmanagement.v20210808preview.ActionRulePropertiesArgs>;
    /**
