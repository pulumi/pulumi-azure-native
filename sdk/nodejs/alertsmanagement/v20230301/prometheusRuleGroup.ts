...
export class PrometheusRuleGroup extends pulumi.CustomResource {
     ...
     */
    public readonly rules!: pulumi.Output<outputs.alertsmanagement.v20230301.PrometheusRuleResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.alertsmanagement.v20230301.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: PrometheusRuleGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:alertsmanagement/v20210722preview:PrometheusRuleGroup" }, { type: "azure-native:alertsmanagement:PrometheusRuleGroup" }] };
