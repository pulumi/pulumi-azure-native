...
export function getDomainOwnershipIdentifier(args: GetDomainOwnershipIdentifierArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainOwnershipIdentifierResult> {
    ...
    return pulumi.runtime.invoke("azurerm:domainregistration/v20180201:getDomainOwnershipIdentifier", {
...
export interface GetDomainOwnershipIdentifierResult {
     ...
     */
    readonly properties: outputs.domainregistration.v20180201.DomainOwnershipIdentifierResponseProperties;
    /**
     * Resource type.
     */
