 ...
 *
 * @deprecated azure-native:domainregistration/v20210115:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20220901:Domain to guarantee forwards compatibility.
 */
export class Domain extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Domain {
        pulumi.log.warn("Domain is deprecated: azure-native:domainregistration/v20210115:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20220901:Domain to guarantee forwards compatibility.")
        return new Domain(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:domainregistration/v20210115:Domain';
     ...
     */
    public /*out*/ readonly managedHostNames!: pulumi.Output<outputs.domainregistration.v20210115.HostNameResponse[]>;
    /**
     * Resource Name.
     */
...
export interface DomainArgs {
     ...
     */
    consent: pulumi.Input<inputs.domainregistration.v20210115.DomainPurchaseConsentArgs>;
    /**
     * Administrative contact.
     */
    contactAdmin: pulumi.Input<inputs.domainregistration.v20210115.ContactArgs>;
    /**
     * Billing contact.
     */
    contactBilling: pulumi.Input<inputs.domainregistration.v20210115.ContactArgs>;
    /**
     * Registrant contact.
     */
    contactRegistrant: pulumi.Input<inputs.domainregistration.v20210115.ContactArgs>;
    /**
     * Technical contact.
     */
    contactTech: pulumi.Input<inputs.domainregistration.v20210115.ContactArgs>;
    /**
     * Current DNS type
     */
    dnsType?: pulumi.Input<enums.domainregistration.v20210115.DnsType>;
    /**
     * Azure DNS Zone to use
     */
     ...
     * Target DNS type (would be used for migration)
     */
    targetDnsType?: pulumi.Input<enums.domainregistration.v20210115.DnsType>;
}
