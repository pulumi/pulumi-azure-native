...
export class DomainOwnershipIdentifier extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:domainregistration/latest:DomainOwnershipIdentifier';
    ...
    constructor(name: string, args: DomainOwnershipIdentifierArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:domainregistration/v20150401:DomainOwnershipIdentifier" }, { type: "azurerm:domainregistration/v20180201:DomainOwnershipIdentifier" }, { type: "azurerm:domainregistration/v20190801:DomainOwnershipIdentifier" }, { type: "azurerm:domainregistration/v20200601:DomainOwnershipIdentifier" }] };
