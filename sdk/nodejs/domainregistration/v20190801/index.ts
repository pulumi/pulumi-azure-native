...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:domainregistration/v20190801:Domain":
                return new Domain(name, <any>undefined, { urn })
            case "azure-nextgen:domainregistration/v20190801:DomainOwnershipIdentifier":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "domainregistration/v20190801", _module)
