...
export function getDomainOwnershipIdentifier(args: GetDomainOwnershipIdentifierArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainOwnershipIdentifierResult> {
    ...
    return pulumi.runtime.invoke("azurerm:domainregistration/v20150401:getDomainOwnershipIdentifier", {
...
export interface GetDomainOwnershipIdentifierResult {
     ...
     */
    readonly properties: outputs.domainregistration.v20150401.DomainOwnershipIdentifierResponseProperties;
    /**
     * Resource type.
     */
