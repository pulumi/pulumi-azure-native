...
export function getDomain(args: GetDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:domainregistration/v20231201:getDomain", {
...
export interface GetDomainResult {
     ...
     */
    readonly managedHostNames: outputs.domainregistration.v20231201.HostNameResponse[];
    /**
     * Resource Name.
     */
...
export function getDomainOutput(args: GetDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:domainregistration/v20231201:getDomain", {
        "domainName": args.domainName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
