...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningexperimentation/preview:Account';
     ...
     */
    public readonly storageAccount!: pulumi.Output<outputs.machinelearningexperimentation.preview.StorageAccountPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningexperimentation/v20170501preview:Account" }] };
...
export interface AccountArgs {
     ...
     * The properties of the storage account for the machine learning team account.
     */
    readonly storageAccount: pulumi.Input<inputs.machinelearningexperimentation.preview.StorageAccountProperties>;
    /**
     * The tags of the resource.
     */
