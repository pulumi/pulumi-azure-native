...
export class Project extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:machinelearningexperimentation/preview:Project';
    ...
    constructor(name: string, argsOrState?: ProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:machinelearningexperimentation/v20170501preview:Project" }] };
