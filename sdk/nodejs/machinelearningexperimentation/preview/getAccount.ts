...
export function getAccount(args: GetAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountResult> {
    ...
    return pulumi.runtime.invoke("azurerm:machinelearningexperimentation/preview:getAccount", {
...
export interface GetAccountResult {
     ...
     */
    readonly storageAccount: outputs.machinelearningexperimentation.preview.StorageAccountPropertiesResponse;
    /**
