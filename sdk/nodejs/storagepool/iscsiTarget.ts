...
export class IscsiTarget extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IscsiTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagepool:IscsiTarget" }, { type: "azure-native:storagepool/v20200315preview:IscsiTarget" }, { type: "azure-nextgen:storagepool/v20200315preview:IscsiTarget" }, { type: "azure-native:storagepool/v20210401preview:IscsiTarget" }, { type: "azure-nextgen:storagepool/v20210401preview:IscsiTarget" }] };
...
export interface IscsiTargetArgs {
     ...
     * Mode for Target connectivity.
     */
    readonly aclMode: pulumi.Input<string | enums.storagepool.IscsiTargetAclMode>;
    /**
     ...
     * List of LUNs to be exposed through iSCSI Target.
     */
    readonly luns?: pulumi.Input<pulumi.Input<inputs.storagepool.IscsiLunArgs>[]>;
    /**
     ...
     * Access Control List (ACL) for an iSCSI Target; defines LUN masking policy
     */
    readonly staticAcls?: pulumi.Input<pulumi.Input<inputs.storagepool.AclArgs>[]>;
    /**
     * iSCSI Target IQN (iSCSI Qualified Name); example: "iqn.2005-03.org.iscsi:server".
     */
