...
export class IscsiTarget extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IscsiTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagepool:IscsiTarget" }, { type: "azure-native:storagepool/v20200315preview:IscsiTarget" }, { type: "azure-nextgen:storagepool/v20200315preview:IscsiTarget" }] };
