...
export class DiskPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DiskPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagepool/v20200315preview:DiskPool" }, { type: "azure-native:storagepool:DiskPool" }, { type: "azure-nextgen:storagepool:DiskPool" }, { type: "azure-native:storagepool/v20210401preview:DiskPool" }, { type: "azure-nextgen:storagepool/v20210401preview:DiskPool" }, { type: "azure-native:storagepool/v20210801:DiskPool" }, { type: "azure-nextgen:storagepool/v20210801:DiskPool" }] };
