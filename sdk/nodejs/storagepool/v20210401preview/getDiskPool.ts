...
export function getDiskPool(args: GetDiskPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskPoolResult> {
    pulumi.log.warn("getDiskPool is deprecated: azure-native:storagepool/v20210401preview:DiskPool is being removed in the next major version of this provider. Upgrade to at least azure-native:storagepool/v20210801:DiskPool to guarantee forwards compatibility.")
