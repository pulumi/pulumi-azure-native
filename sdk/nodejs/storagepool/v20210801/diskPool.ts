...
export class DiskPool extends pulumi.CustomResource {
     ...
     */
    public readonly disks!: pulumi.Output<outputs.storagepool.v20210801.DiskResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: DiskPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["managedByExtended"] = args ? args.managedByExtended : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagepool/v20210801:DiskPool" }, { type: "azure-native:storagepool:DiskPool" }, { type: "azure-nextgen:storagepool:DiskPool" }, { type: "azure-native:storagepool/v20200315preview:DiskPool" }, { type: "azure-nextgen:storagepool/v20200315preview:DiskPool" }, { type: "azure-native:storagepool/v20210401preview:DiskPool" }, { type: "azure-nextgen:storagepool/v20210401preview:DiskPool" }] };
