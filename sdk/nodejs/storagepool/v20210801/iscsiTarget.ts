...
export class IscsiTarget extends pulumi.CustomResource {
     ...
     */
    public readonly luns!: pulumi.Output<outputs.storagepool.v20210801.IscsiLunResponse[] | undefined>;
    /**
     ...
     */
    public readonly staticAcls!: pulumi.Output<outputs.storagepool.v20210801.AclResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: IscsiTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagepool/v20200315preview:IscsiTarget" }, { type: "azure-native:storagepool/v20210401preview:IscsiTarget" }, { type: "azure-native:storagepool:IscsiTarget" }] };
