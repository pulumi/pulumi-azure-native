...
export class AlertRuleResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databasewatcher/v20240719preview:AlertRuleResource';
    ...
    constructor(name: string, args: AlertRuleResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databasewatcher/v20241001preview:AlertRuleResource" }, { type: "azure-native:databasewatcher/v20250102:AlertRuleResource" }, { type: "azure-native:databasewatcher:AlertRuleResource" }] };
...
export interface AlertRuleResourceArgs {
     ...
     * The properties with which the alert rule resource was created.
     */
    createdWithProperties: pulumi.Input<string | enums.databasewatcher.v20240719preview.AlertRuleCreationProperties>;
    /**
     * The creation time of the alert rule resource.
     */
