...
export class Watcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databasewatcher/v20240719preview:Watcher';
     ...
     */
    public readonly datastore!: pulumi.Output<outputs.databasewatcher.v20240719preview.DatastoreResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.databasewatcher.v20240719preview.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WatcherArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databasewatcher/v20230901preview:Watcher" }, { type: "azure-native:databasewatcher/v20241001preview:Watcher" }, { type: "azure-native:databasewatcher/v20250102:Watcher" }, { type: "azure-native:databasewatcher:Watcher" }] };
