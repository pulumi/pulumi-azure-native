...
export function getWatcher(args: GetWatcherArgs, opts?: pulumi.InvokeOptions): Promise<GetWatcherResult> {
    ...
    return pulumi.runtime.invoke("azure-native:databasewatcher/v20241001preview:getWatcher", {
...
export interface GetWatcherResult {
     ...
     */
    readonly datastore?: outputs.databasewatcher.v20241001preview.DatastoreResponse;
    /**
     ...
     */
    readonly identity?: outputs.databasewatcher.v20241001preview.ManagedServiceIdentityResponse;
    /**
...
export function getWatcherOutput(args: GetWatcherOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetWatcherResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:databasewatcher/v20241001preview:getWatcher", {
        "resourceGroupName": args.resourceGroupName,
        "watcherName": args.watcherName,
    }, opts);
}
