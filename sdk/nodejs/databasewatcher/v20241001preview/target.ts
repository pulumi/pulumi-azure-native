...
export class Target extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databasewatcher/v20241001preview:Target';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.databasewatcher.v20241001preview.SystemDataResponse>;
    /**
     ...
     */
    public readonly targetVault!: pulumi.Output<outputs.databasewatcher.v20241001preview.VaultSecretResponse | undefined>;
    /**
    ...
    constructor(name: string, args: TargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databasewatcher/v20230901preview:Target" }, { type: "azure-native:databasewatcher/v20240719preview:Target" }, { type: "azure-native:databasewatcher/v20250102:Target" }, { type: "azure-native:databasewatcher:Target" }] };
...
export interface TargetArgs {
     ...
     * The type of authentication to use when connecting to a target.
     */
    targetAuthenticationType: pulumi.Input<string | enums.databasewatcher.v20241001preview.TargetAuthenticationType>;
    /**
     ...
     * To use SQL authentication when connecting to targets, specify the vault where the login name and password secrets are stored.
     */
    targetVault?: pulumi.Input<inputs.databasewatcher.v20241001preview.VaultSecretArgs>;
    /**
