...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:databasewatcher/v20250102:AlertRuleResource":
                return new AlertRuleResource(name, <any>undefined, { urn })
            case "azure-native:databasewatcher/v20250102:SharedPrivateLinkResource":
                return new SharedPrivateLinkResource(name, <any>undefined, { urn })
            case "azure-native:databasewatcher/v20250102:Target":
                return new Target(name, <any>undefined, { urn })
            case "azure-native:databasewatcher/v20250102:Watcher":
...
pulumi.runtime.registerResourceModule("azure-native", "databasewatcher/v20250102", _module)
