...
export class Watcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databasewatcher/v20250102:Watcher';
     ...
     */
    public readonly datastore!: pulumi.Output<outputs.databasewatcher.v20250102.DatastoreResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.databasewatcher.v20250102.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WatcherArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databasewatcher:Watcher" }, { type: "azure-native:databasewatcher/v20230901preview:Watcher" }, { type: "azure-native:databasewatcher/v20240719preview:Watcher" }, { type: "azure-native:databasewatcher/v20241001preview:Watcher" }] };
...
export interface WatcherArgs {
     ...
     * The data store for collected monitoring data.
     */
    datastore?: pulumi.Input<inputs.databasewatcher.v20250102.DatastoreArgs>;
    /**
     * The resource ID of a user-assigned managed identity that will be assigned to a new alert rule.
     */
     ...
     * The managed service identities assigned to this resource.
     */
    identity?: pulumi.Input<inputs.databasewatcher.v20250102.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
