...
export class Target extends pulumi.CustomResource {
     ...
     */
    public readonly targetVault!: pulumi.Output<outputs.databasewatcher.v20230901preview.VaultSecretResponse | undefined>;
    /**
    ...
    constructor(name: string, args: TargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databasewatcher:Target" }, { type: "azure-native:databasewatcher/v20240719preview:Target" }, { type: "azure-native:databasewatcher/v20241001preview:Target" }, { type: "azure-native:databasewatcher/v20250102:Target" }] };
