...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:deviceprovisioningservices/v20211015:DpsCertificate":
...
pulumi.runtime.registerResourceModule("azure-native", "deviceprovisioningservices/v20211015", _module)
