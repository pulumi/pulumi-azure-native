...
export function getDpsCertificate(args: GetDpsCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetDpsCertificateResult> {
    ...
    return pulumi.runtime.invoke("azure-native:deviceprovisioningservices/v20211015:getDpsCertificate", {
...
export interface GetDpsCertificateResult {
     ...
     */
    readonly properties: outputs.deviceprovisioningservices.v20211015.CertificatePropertiesResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: outputs.deviceprovisioningservices.v20211015.SystemDataResponse;
    /**
     * The resource type.
     */
...
export function getDpsCertificateOutput(args: GetDpsCertificateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDpsCertificateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:deviceprovisioningservices/v20211015:getDpsCertificate", {
        "certificateName": args.certificateName,
        "provisioningServiceName": args.provisioningServiceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
