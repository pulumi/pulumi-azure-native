...
export function getIotDpsResource(args: GetIotDpsResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDpsResourceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:deviceprovisioningservices/v20200901preview:getIotDpsResource", {
...
export interface GetIotDpsResourceResult {
     ...
     */
    readonly identity?: outputs.deviceprovisioningservices.v20200901preview.ArmIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.deviceprovisioningservices.v20200901preview.IotDpsPropertiesDescriptionResponse;
    /**
     * Sku info for a provisioning Service.
     */
    readonly sku: outputs.deviceprovisioningservices.v20200901preview.IotDpsSkuInfoResponse;
    /**
     * The resource tags.
     */
...
export function getIotDpsResourceOutput(args: GetIotDpsResourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotDpsResourceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:deviceprovisioningservices/v20200901preview:getIotDpsResource", {
        "provisioningServiceName": args.provisioningServiceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
