...
// Export enums:
export * from "../../types/enums/deviceprovisioningservices/v20200901preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:deviceprovisioningservices/v20200901preview:IotDpsResource":
...
pulumi.runtime.registerResourceModule("azure-native", "deviceprovisioningservices/v20200901preview", _module)
