...
export class IotDpsResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deviceprovisioningservices/v20250201preview:IotDpsResource';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.deviceprovisioningservices.v20250201preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.deviceprovisioningservices.v20250201preview.IotDpsPropertiesDescriptionResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.deviceprovisioningservices.v20250201preview.IotDpsSkuInfoResponse>;
    /**
    ...
    constructor(name: string, args: IotDpsResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceprovisioningservices/v20170821preview:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20171115:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20180122:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20200101:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20200301:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20200901preview:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20211015:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20220205:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20221212:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices/v20230301preview:IotDpsResource" }, { type: "azure-native:deviceprovisioningservices:IotDpsResource" }, { type: "azure-native:devices/v20200901preview:IotDpsResource" }, { type: "azure-native:devices/v20221212:IotDpsResource" }, { type: "azure-native:devices/v20230301preview:IotDpsResource" }, { type: "azure-native:devices/v20250201preview:IotDpsResource" }, { type: "azure-native:devices:IotDpsResource" }] };
...
export interface IotDpsResourceArgs {
     ...
     * The managed identities for a provisioning service.
     */
    identity?: pulumi.Input<inputs.deviceprovisioningservices.v20250201preview.ManagedServiceIdentityArgs>;
    /**
     * The resource location.
     */
     ...
     * Service specific properties for a provisioning service
     */
    properties: pulumi.Input<inputs.deviceprovisioningservices.v20250201preview.IotDpsPropertiesDescriptionArgs>;
    /**
     ...
     * Sku info for a provisioning Service.
     */
    sku: pulumi.Input<inputs.deviceprovisioningservices.v20250201preview.IotDpsSkuInfoArgs>;
    /**
     * The subscription id of the resource.
     */
