...
// Export enums:
export * from "../../types/enums/deviceprovisioningservices/v20250201preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:deviceprovisioningservices/v20250201preview:DpsCertificate":
                return new DpsCertificate(name, <any>undefined, { urn })
            case "azure-native:deviceprovisioningservices/v20250201preview:IotDpsResource":
                return new IotDpsResource(name, <any>undefined, { urn })
            case "azure-native:deviceprovisioningservices/v20250201preview:IotDpsResourcePrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "deviceprovisioningservices/v20250201preview", _module)
