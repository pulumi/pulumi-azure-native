...
export class ConnectorDryrun extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectorDryrunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicelinker:ConnectorDryrun" }, { type: "azure-native:servicelinker/v20221101preview:ConnectorDryrun" }, { type: "azure-native:servicelinker/v20230401preview:ConnectorDryrun" }] };
