...
export class LinkerDryrun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicelinker/v20240401:LinkerDryrun';
     ...
     */
    public /*out*/ readonly operationPreviews!: pulumi.Output<outputs.servicelinker.v20240401.DryrunOperationPreviewResponse[]>;
    /**
     * The parameters of the dryrun
     */
    public readonly parameters!: pulumi.Output<outputs.servicelinker.v20240401.CreateOrUpdateDryrunParametersResponse | undefined>;
    /**
     * the result of the dryrun
     */
    public /*out*/ readonly prerequisiteResults!: pulumi.Output<(outputs.servicelinker.v20240401.BasicErrorDryrunPrerequisiteResultResponse | outputs.servicelinker.v20240401.PermissionsMissingDryrunPrerequisiteResultResponse)[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.servicelinker.v20240401.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: LinkerDryrunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicelinker:LinkerDryrun" }, { type: "azure-native:servicelinker/v20221101preview:LinkerDryrun" }, { type: "azure-native:servicelinker/v20230401preview:LinkerDryrun" }, { type: "azure-native:servicelinker/v20240701preview:LinkerDryrun" }] };
...
export interface LinkerDryrunArgs {
     ...
     * The parameters of the dryrun
     */
    parameters?: pulumi.Input<inputs.servicelinker.v20240401.CreateOrUpdateDryrunParametersArgs>;
    /**
