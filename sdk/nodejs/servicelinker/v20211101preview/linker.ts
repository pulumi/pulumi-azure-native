...
export class Linker extends pulumi.CustomResource {
     ...
     */
    public readonly secretStore!: pulumi.Output<outputs.servicelinker.v20211101preview.SecretStoreResponse | undefined>;
    /**
     * The system data.
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.servicelinker.v20211101preview.SystemDataResponse>;
    /**
     ...
     * The VNet solution.
     */
    public readonly vNetSolution!: pulumi.Output<outputs.servicelinker.v20211101preview.VNetSolutionResponse | undefined>;
    ...
    constructor(name: string, args: LinkerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicelinker/v20220101preview:Linker" }, { type: "azure-native:servicelinker/v20220501:Linker" }, { type: "azure-native:servicelinker/v20221101preview:Linker" }, { type: "azure-native:servicelinker/v20230401preview:Linker" }, { type: "azure-native:servicelinker/v20240401:Linker" }, { type: "azure-native:servicelinker/v20240701preview:Linker" }, { type: "azure-native:servicelinker:Linker" }] };
