...
export function getApplicationDefinition(args: GetApplicationDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationDefinitionResult> {
    pulumi.log.warn("getApplicationDefinition is deprecated: Version 2018-09-01-preview will be removed in v2 of the provider.\nazure-native:solutions/v20180901preview:ApplicationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:ApplicationDefinition to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:solutions/v20180901preview:getApplicationDefinition", {
...
export interface GetApplicationDefinitionResult {
     ...
     */
    readonly artifacts?: outputs.solutions.v20180901preview.ApplicationDefinitionArtifactResponse[];
    /**
     ...
     */
    readonly policies?: outputs.solutions.v20180901preview.ApplicationPolicyResponse[];
    /**
