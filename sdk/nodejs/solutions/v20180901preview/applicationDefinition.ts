...
export class ApplicationDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:solutions/v20180901preview:ApplicationDefinition';
     ...
     */
    public readonly artifacts!: pulumi.Output<outputs.solutions.v20180901preview.ApplicationDefinitionArtifactResponse[] | undefined>;
    /**
     * The managed application provider authorizations.
     */
    public readonly authorizations!: pulumi.Output<outputs.solutions.v20180901preview.ApplicationAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly policies!: pulumi.Output<outputs.solutions.v20180901preview.ApplicationPolicyResponse[] | undefined>;
    /**
...
export interface ApplicationDefinitionArgs {
     ...
     * The collection of managed application artifacts. The portal will use the files specified as artifacts to construct the user experience of creating a managed application from a managed application definition.
     */
    artifacts?: pulumi.Input<pulumi.Input<inputs.solutions.v20180901preview.ApplicationDefinitionArtifactArgs>[]>;
    /**
     * The managed application provider authorizations.
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.solutions.v20180901preview.ApplicationAuthorizationArgs>[]>;
    /**
     * The createUiDefinition json for the backing template with Microsoft.Solutions/applications resource. It can be a JObject or well-formed JSON string.
     */
     ...
     * The managed application lock level.
     */
    lockLevel: pulumi.Input<enums.solutions.v20180901preview.ApplicationLockLevel>;
    /**
     * The inline main template json which has resources to be provisioned. It can be a JObject or well-formed JSON string.
     */
    mainTemplate?: any;
     ...
     * The managed application provider policies.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.solutions.v20180901preview.ApplicationPolicyArgs>[]>;
    /**
