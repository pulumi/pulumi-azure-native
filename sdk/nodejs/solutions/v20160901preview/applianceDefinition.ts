...
export class ApplianceDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApplianceDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:solutions/v20160901preview:ApplianceDefinition" }, { type: "azure-native:solutions:ApplianceDefinition" }, { type: "azure-nextgen:solutions:ApplianceDefinition" }] };
