...
export class ApplianceDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:solutions/v20160901preview:ApplianceDefinition';
    ...
    constructor(name: string, argsOrState?: ApplianceDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:solutions/preview:ApplianceDefinition" }] };
