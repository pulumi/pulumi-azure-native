...
export class Appliance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Appliance {
        return new Appliance(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:solutions/v20160901preview:Appliance';
    ...
    constructor(name: string, argsOrState?: ApplianceArgs, opts?: pulumi.CustomResourceOptions) {
