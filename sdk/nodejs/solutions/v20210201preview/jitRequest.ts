 ...
 *
 * @deprecated azure-native:solutions/v20210201preview:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.
 */
export class JitRequest extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JitRequest {
        pulumi.log.warn("JitRequest is deprecated: azure-native:solutions/v20210201preview:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.")
        return new JitRequest(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:solutions/v20210201preview:JitRequest';
     ...
     */
    public /*out*/ readonly createdBy!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationClientDetailsResponse>;
    /**
     * The JIT authorization policies.
     */
    public readonly jitAuthorizationPolicies!: pulumi.Output<outputs.solutions.v20210201preview.JitAuthorizationPoliciesResponse[]>;
    /**
     ...
     */
    public readonly jitSchedulingPolicy!: pulumi.Output<outputs.solutions.v20210201preview.JitSchedulingPolicyResponse>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.solutions.v20210201preview.SystemDataResponse>;
    /**
     * Resource tags
     */
     ...
     */
    public /*out*/ readonly updatedBy!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationClientDetailsResponse>;
...
export interface JitRequestArgs {
     ...
     * The JIT authorization policies.
     */
    jitAuthorizationPolicies: pulumi.Input<pulumi.Input<inputs.solutions.v20210201preview.JitAuthorizationPoliciesArgs>[]>;
    /**
     ...
     * The JIT request properties.
     */
    jitSchedulingPolicy: pulumi.Input<inputs.solutions.v20210201preview.JitSchedulingPolicyArgs>;
    /**
     * Resource location
     */
