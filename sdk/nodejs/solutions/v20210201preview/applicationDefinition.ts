...
export class ApplicationDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationDefinition {
        pulumi.log.warn("ApplicationDefinition is deprecated: azure-native:solutions/v20210201preview:ApplicationDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:ApplicationDefinition to guarantee forwards compatibility.")
        return new ApplicationDefinition(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:solutions/v20210201preview:ApplicationDefinition';
     ...
     */
    public readonly artifacts!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationDefinitionArtifactResponse[] | undefined>;
    /**
     * The managed application provider authorizations.
     */
    public readonly authorizations!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly deploymentPolicy!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationDeploymentPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly lockingPolicy!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationPackageLockingPolicyDefinitionResponse | undefined>;
    /**
     ...
     */
    public readonly managementPolicy!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationManagementPolicyResponse | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly notificationPolicy!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationNotificationPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly policies!: pulumi.Output<outputs.solutions.v20210201preview.ApplicationPolicyResponse[] | undefined>;
    /**
     * The SKU of the resource.
     */
    public readonly sku!: pulumi.Output<outputs.solutions.v20210201preview.SkuResponse | undefined>;
    /**
...
export interface ApplicationDefinitionArgs {
     ...
     * The collection of managed application artifacts. The portal will use the files specified as artifacts to construct the user experience of creating a managed application from a managed application definition.
     */
    artifacts?: pulumi.Input<pulumi.Input<inputs.solutions.v20210201preview.ApplicationDefinitionArtifactArgs>[]>;
    /**
     * The managed application provider authorizations.
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.solutions.v20210201preview.ApplicationAuthorizationArgs>[]>;
    /**
     * The createUiDefinition json for the backing template with Microsoft.Solutions/applications resource. It can be a JObject or well-formed JSON string.
     */
     ...
     * The managed application deployment policy.
     */
    deploymentPolicy?: pulumi.Input<inputs.solutions.v20210201preview.ApplicationDeploymentPolicyArgs>;
    /**
     * The managed application definition description.
     */
     ...
     * The managed application lock level.
     */
    lockLevel: pulumi.Input<enums.solutions.v20210201preview.ApplicationLockLevel>;
    /**
     * The managed application locking policy.
     */
    lockingPolicy?: pulumi.Input<inputs.solutions.v20210201preview.ApplicationPackageLockingPolicyDefinitionArgs>;
    /**
     * The inline main template json which has resources to be provisioned. It can be a JObject or well-formed JSON string.
     */
    mainTemplate?: any;
     ...
     * The managed application management policy that determines publisher's access to the managed resource group.
     */
    managementPolicy?: pulumi.Input<inputs.solutions.v20210201preview.ApplicationManagementPolicyArgs>;
    /**
     * The managed application notification policy.
     */
    notificationPolicy?: pulumi.Input<inputs.solutions.v20210201preview.ApplicationNotificationPolicyArgs>;
    /**
     * The managed application definition package file Uri. Use this element
     */
     ...
     * The managed application provider policies.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.solutions.v20210201preview.ApplicationPolicyArgs>[]>;
    /**
     ...
     * The SKU of the resource.
     */
    sku?: pulumi.Input<inputs.solutions.v20210201preview.SkuArgs>;
    /**
     * The storage account id for bring your own storage scenario.
     */
