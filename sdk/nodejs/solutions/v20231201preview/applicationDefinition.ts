...
export class ApplicationDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:solutions/v20231201preview:ApplicationDefinition';
     ...
     */
    public readonly artifacts!: pulumi.Output<outputs.solutions.v20231201preview.ApplicationDefinitionArtifactResponse[] | undefined>;
    /**
     * The managed application provider authorizations.
     */
    public readonly authorizations!: pulumi.Output<outputs.solutions.v20231201preview.ApplicationAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly deploymentPolicy!: pulumi.Output<outputs.solutions.v20231201preview.ApplicationDeploymentPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly lockingPolicy!: pulumi.Output<outputs.solutions.v20231201preview.ApplicationPackageLockingPolicyDefinitionResponse | undefined>;
    /**
     ...
     */
    public readonly managementPolicy!: pulumi.Output<outputs.solutions.v20231201preview.ApplicationManagementPolicyResponse | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly notificationPolicy!: pulumi.Output<outputs.solutions.v20231201preview.ApplicationNotificationPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly policies!: pulumi.Output<outputs.solutions.v20231201preview.ApplicationPolicyResponse[] | undefined>;
    /**
     * The SKU of the resource.
     */
    public readonly sku!: pulumi.Output<outputs.solutions.v20231201preview.SkuResponse | undefined>;
    /**
...
export interface ApplicationDefinitionArgs {
     ...
     * The collection of managed application artifacts. The portal will use the files specified as artifacts to construct the user experience of creating a managed application from a managed application definition.
     */
    artifacts?: pulumi.Input<pulumi.Input<inputs.solutions.v20231201preview.ApplicationDefinitionArtifactArgs>[]>;
    /**
     * The managed application provider authorizations.
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.solutions.v20231201preview.ApplicationAuthorizationArgs>[]>;
    /**
     * The createUiDefinition json for the backing template with Microsoft.Solutions/applications resource. It can be a JObject or well-formed JSON string.
     */
     ...
     * The managed application deployment policy.
     */
    deploymentPolicy?: pulumi.Input<inputs.solutions.v20231201preview.ApplicationDeploymentPolicyArgs>;
    /**
     * The managed application definition description.
     */
     ...
     * The managed application lock level.
     */
    lockLevel: pulumi.Input<enums.solutions.v20231201preview.ApplicationLockLevel>;
    /**
     * The managed application locking policy.
     */
    lockingPolicy?: pulumi.Input<inputs.solutions.v20231201preview.ApplicationPackageLockingPolicyDefinitionArgs>;
    /**
     * The inline main template json which has resources to be provisioned. It can be a JObject or well-formed JSON string.
     */
    mainTemplate?: any;
     ...
     * The managed application management policy that determines publisher's access to the managed resource group.
     */
    managementPolicy?: pulumi.Input<inputs.solutions.v20231201preview.ApplicationManagementPolicyArgs>;
    /**
     * The managed application notification policy.
     */
    notificationPolicy?: pulumi.Input<inputs.solutions.v20231201preview.ApplicationNotificationPolicyArgs>;
    /**
     * The managed application definition package file Uri. Use this element
     */
     ...
     * The managed application provider policies.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.solutions.v20231201preview.ApplicationPolicyArgs>[]>;
    /**
     ...
     * The SKU of the resource.
     */
    sku?: pulumi.Input<inputs.solutions.v20231201preview.SkuArgs>;
    /**
     * The storage account id for bring your own storage scenario.
     */
