...
export function getJitRequest(args: GetJitRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetJitRequestResult> {
    pulumi.log.warn("getJitRequest is deprecated: Version 2018-03-01 will be removed in v2 of the provider.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:solutions/v20180301:getJitRequest", {
...
export interface GetJitRequestResult {
     ...
     */
    readonly jitAuthorizationPolicies: outputs.solutions.v20180301.JitAuthorizationPoliciesResponse[];
    /**
     ...
     */
    readonly jitSchedulingPolicy: outputs.solutions.v20180301.JitSchedulingPolicyResponse;
    /**
     * Resource location
     */
