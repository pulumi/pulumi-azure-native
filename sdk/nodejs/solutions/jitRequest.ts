...
export class JitRequest extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JitRequestState, opts?: pulumi.CustomResourceOptions): JitRequest {
        return new JitRequest(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:solutions:JitRequest';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.solutions.JitRequestPropertiesResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, argsOrState?: JitRequestArgs | JitRequestState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as JitRequestState | undefined;
 ...
 * Information about JIT request definition.
 */
export interface JitRequestState {
    /**
     * Resource location
     */
     ...
     * The JIT request properties.
     */
    readonly properties: pulumi.Input<inputs.solutions.JitRequestPropertiesResponse>;
    /**
     * Resource tags
     */
...
export interface JitRequestArgs {
     ...
     * The JIT request properties.
     */
    readonly properties?: pulumi.Input<inputs.solutions.JitRequestProperties>;
    /**
