...
export class JitRequest extends pulumi.CustomResource {
     ...
     */
    public readonly jitAuthorizationPolicies!: pulumi.Output<outputs.solutions.latest.JitAuthorizationPoliciesResponse[]>;
    /**
     ...
     */
    public readonly jitSchedulingPolicy!: pulumi.Output<outputs.solutions.latest.JitSchedulingPolicyResponse>;
    /**
     * Resource location
     */
    ...
    constructor(name: string, args: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:solutions/latest:JitRequest" }, { type: "azure-native:solutions:JitRequest" }, { type: "azure-nextgen:solutions:JitRequest" }, { type: "azure-native:solutions/v20190701:JitRequest" }, { type: "azure-nextgen:solutions/v20190701:JitRequest" }, { type: "azure-native:solutions/v20200821preview:JitRequest" }, { type: "azure-nextgen:solutions/v20200821preview:JitRequest" }] };
...
export interface JitRequestArgs {
     ...
     * The JIT authorization policies.
     */
    readonly jitAuthorizationPolicies: pulumi.Input<pulumi.Input<inputs.solutions.latest.JitAuthorizationPolicies>[]>;
    /**
     ...
     * The JIT request properties.
     */
    readonly jitSchedulingPolicy: pulumi.Input<inputs.solutions.latest.JitSchedulingPolicy>;
    /**
     * Resource location
     */
