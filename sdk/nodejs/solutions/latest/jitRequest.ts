...
export class JitRequest extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:solutions/preview:JitRequest" }, { type: "azurerm:solutions/v20190701:JitRequest" }, { type: "azurerm:solutions/v20200821preview:JitRequest" }] };
