...
export class ApplicationDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApplicationDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:solutions:ApplicationDefinition" }, { type: "azure-native:solutions/latest:ApplicationDefinition" }, { type: "azure-nextgen:solutions/latest:ApplicationDefinition" }, { type: "azure-native:solutions/v20160901preview:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20160901preview:ApplicationDefinition" }, { type: "azure-native:solutions/v20170901:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20170901:ApplicationDefinition" }, { type: "azure-native:solutions/v20180601:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20180601:ApplicationDefinition" }, { type: "azure-native:solutions/v20190701:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20190701:ApplicationDefinition" }, { type: "azure-native:solutions/v20200821preview:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20200821preview:ApplicationDefinition" }] };
...
export interface ApplicationDefinitionArgs {
     ...
     * The collection of managed application artifacts. The portal will use the files specified as artifacts to construct the user experience of creating a managed application from a managed application definition.
     */
    readonly artifacts?: pulumi.Input<pulumi.Input<inputs.solutions.ApplicationDefinitionArtifact>[]>;
    /**
     * The managed application provider authorizations.
     */
    readonly authorizations?: pulumi.Input<pulumi.Input<inputs.solutions.ApplicationAuthorization>[]>;
    /**
     * The createUiDefinition json for the backing template with Microsoft.Solutions/applications resource. It can be a JObject or well-formed JSON string.
     */
     ...
     * The managed application deployment policy.
     */
    readonly deploymentPolicy?: pulumi.Input<inputs.solutions.ApplicationDeploymentPolicy>;
    /**
     * The managed application definition description.
     */
     ...
     * The managed application locking policy.
     */
    readonly lockingPolicy?: pulumi.Input<inputs.solutions.ApplicationPackageLockingPolicyDefinition>;
    /**
     * The inline main template json which has resources to be provisioned. It can be a JObject or well-formed JSON string.
     */
     ...
     * The managed application management policy that determines publisher's access to the managed resource group.
     */
    readonly managementPolicy?: pulumi.Input<inputs.solutions.ApplicationManagementPolicy>;
    /**
     * The managed application notification policy.
     */
    readonly notificationPolicy?: pulumi.Input<inputs.solutions.ApplicationNotificationPolicy>;
    /**
     * The managed application definition package file Uri. Use this element
     */
     ...
     * The managed application provider policies.
     */
    readonly policies?: pulumi.Input<pulumi.Input<inputs.solutions.ApplicationPolicy>[]>;
    /**
