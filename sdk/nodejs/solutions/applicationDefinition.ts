...
export class ApplicationDefinition extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApplicationDefinitionState, opts?: pulumi.CustomResourceOptions): ApplicationDefinition {
        return new ApplicationDefinition(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:solutions:ApplicationDefinition';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.solutions.ApplicationDefinitionPropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: ApplicationDefinitionArgs | ApplicationDefinitionState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ApplicationDefinitionState | undefined;
...
export interface ApplicationDefinitionState {
     ...
     * The managed application definition properties.
     */
    readonly properties: pulumi.Input<inputs.solutions.ApplicationDefinitionPropertiesResponse>;
    /**
     * The SKU of the resource.
     */
...
export interface ApplicationDefinitionArgs {
     ...
     * The managed application definition properties.
     */
    readonly properties: pulumi.Input<inputs.solutions.ApplicationDefinitionProperties>;
    /**
