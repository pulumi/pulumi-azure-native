...
export class ApplianceDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:solutions:ApplianceDefinition';
    ...
    constructor(name: string, args: ApplianceDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:solutions/v20160901preview:ApplianceDefinition" }] };
