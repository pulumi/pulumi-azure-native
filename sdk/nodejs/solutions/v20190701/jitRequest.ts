...
export class JitRequest extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JitRequest {
        pulumi.log.warn("JitRequest is deprecated: azure-native:solutions/v20190701:JitRequest is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.")
        return new JitRequest(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:solutions/v20190701:JitRequest';
    ...
    constructor(name: string, args: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:solutions:JitRequest" }, { type: "azure-native:solutions/v20180301:JitRequest" }, { type: "azure-native:solutions/v20180601:JitRequest" }, { type: "azure-native:solutions/v20180901preview:JitRequest" }, { type: "azure-native:solutions/v20200821preview:JitRequest" }, { type: "azure-native:solutions/v20210201preview:JitRequest" }, { type: "azure-native:solutions/v20210701:JitRequest" }] };
...
export interface JitRequestArgs {
     ...
     * The JIT authorization policies.
     */
    jitAuthorizationPolicies: pulumi.Input<pulumi.Input<inputs.solutions.v20190701.JitAuthorizationPoliciesArgs>[]>;
    /**
     ...
     * The JIT request properties.
     */
    jitSchedulingPolicy: pulumi.Input<inputs.solutions.v20190701.JitSchedulingPolicyArgs>;
    /**
     * Resource location
     */
