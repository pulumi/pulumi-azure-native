...
export class JitRequest extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:solutions:JitRequest" }, { type: "azure-nextgen:solutions:JitRequest" }, { type: "azure-native:solutions/latest:JitRequest" }, { type: "azure-nextgen:solutions/latest:JitRequest" }, { type: "azure-native:solutions/v20200821preview:JitRequest" }, { type: "azure-nextgen:solutions/v20200821preview:JitRequest" }] };
