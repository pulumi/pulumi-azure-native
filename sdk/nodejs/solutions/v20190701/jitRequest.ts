...
export class JitRequest extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:solutions:JitRequest" }, { type: "azure-nextgen:solutions/latest:JitRequest" }, { type: "azure-nextgen:solutions/v20200821preview:JitRequest" }] };
