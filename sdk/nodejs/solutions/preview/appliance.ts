...
export class Appliance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:solutions/preview:Appliance';
     ...
     */
    public readonly plan!: pulumi.Output<outputs.solutions.preview.PlanResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:solutions/v20160901preview:Appliance" }] };
...
export interface ApplianceArgs {
     ...
     * The plan information.
     */
    readonly plan?: pulumi.Input<inputs.solutions.preview.Plan>;
    /**
