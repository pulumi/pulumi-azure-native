...
export function getAppliance(args: GetApplianceArgs, opts?: pulumi.InvokeOptions): Promise<GetApplianceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:solutions/preview:getAppliance", {
...
export interface GetApplianceResult {
     ...
     */
    readonly identity?: outputs.solutions.preview.IdentityResponse;
    /**
     ...
     */
    readonly plan?: outputs.solutions.preview.PlanResponse;
    /**
     ...
     */
    readonly sku?: outputs.solutions.preview.SkuResponse;
    /**
     * Resource tags
     */
