...
export class JitRequest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:solutions/preview:JitRequest';
     ...
     */
    public /*out*/ readonly createdBy!: pulumi.Output<outputs.solutions.preview.ApplicationClientDetailsResponse>;
    /**
     * The JIT authorization policies.
     */
    public readonly jitAuthorizationPolicies!: pulumi.Output<outputs.solutions.preview.JitAuthorizationPoliciesResponse[]>;
    /**
     ...
     */
    public readonly jitSchedulingPolicy!: pulumi.Output<outputs.solutions.preview.JitSchedulingPolicyResponse>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly updatedBy!: pulumi.Output<outputs.solutions.preview.ApplicationClientDetailsResponse>;
    ...
    constructor(name: string, argsOrState?: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:solutions/latest:JitRequest" }, { type: "azurerm:solutions/v20190701:JitRequest" }, { type: "azurerm:solutions/v20200821preview:JitRequest" }] };
...
export interface JitRequestArgs {
     ...
     * The JIT authorization policies.
     */
    readonly jitAuthorizationPolicies: pulumi.Input<pulumi.Input<inputs.solutions.preview.JitAuthorizationPolicies>[]>;
    /**
     ...
     * The JIT request properties.
     */
    readonly jitSchedulingPolicy: pulumi.Input<inputs.solutions.preview.JitSchedulingPolicy>;
    /**
     * Resource location
     */
