...
export function getApplianceDefinition(args: GetApplianceDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetApplianceDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azurerm:solutions/preview:getApplianceDefinition", {
...
export interface GetApplianceDefinitionResult {
     ...
     */
    readonly artifacts?: outputs.solutions.preview.ApplianceArtifactResponse[];
    /**
     * The appliance provider authorizations.
     */
    readonly authorizations: outputs.solutions.preview.ApplianceProviderAuthorizationResponse[];
    /**
