...
export class JitRequest extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:solutions:JitRequest" }, { type: "azure-native:solutions/v20190701:JitRequest" }, { type: "azure-native:solutions/v20210701:JitRequest" }] };
