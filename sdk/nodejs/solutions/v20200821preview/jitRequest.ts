...
export class JitRequest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:solutions/v20200821preview:JitRequest';
    ...
    constructor(name: string, argsOrState?: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:solutions/latest:JitRequest" }, { type: "azurerm:solutions/preview:JitRequest" }, { type: "azurerm:solutions/v20190701:JitRequest" }] };
