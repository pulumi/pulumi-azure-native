 ...
 *
 * @deprecated azure-native:solutions/v20200821preview:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.
 */
export class JitRequest extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JitRequest {
        pulumi.log.warn("JitRequest is deprecated: azure-native:solutions/v20200821preview:JitRequest is being removed in the next major version of this provider. Please upgrade to azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility.")
        return new JitRequest(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:solutions/v20200821preview:JitRequest';
     ...
     */
    public readonly jitAuthorizationPolicies!: pulumi.Output<outputs.solutions.v20200821preview.JitAuthorizationPoliciesResponse[]>;
    /**
     ...
     */
    public readonly jitSchedulingPolicy!: pulumi.Output<outputs.solutions.v20200821preview.JitSchedulingPolicyResponse>;
    /**
     * Resource location
     */
...
export interface JitRequestArgs {
     ...
     * The JIT authorization policies.
     */
    jitAuthorizationPolicies: pulumi.Input<pulumi.Input<inputs.solutions.v20200821preview.JitAuthorizationPoliciesArgs>[]>;
    /**
     ...
     * The JIT request properties.
     */
    jitSchedulingPolicy: pulumi.Input<inputs.solutions.v20200821preview.JitSchedulingPolicyArgs>;
    /**
     * Resource location
     */
