...
export class JitRequest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:solutions/v20180601:JitRequest';
     ...
     */
    public readonly jitAuthorizationPolicies!: pulumi.Output<outputs.solutions.v20180601.JitAuthorizationPoliciesResponse[]>;
    /**
     ...
     */
    public readonly jitSchedulingPolicy!: pulumi.Output<outputs.solutions.v20180601.JitSchedulingPolicyResponse>;
    /**
     * Resource location
     */
...
azure-native:solutions/v20180601:JitRequest is being removed in the next major version of this provider. Upgrade to at least azure-native:solutions/v20210701:JitRequest to guarantee forwards compatibility. */
    constructor(name: string, args: JitRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:solutions:JitRequest" }, { type: "azure-native:solutions/v20180301:JitRequest" }, { type: "azure-native:solutions/v20180901preview:JitRequest" }, { type: "azure-native:solutions/v20190701:JitRequest" }, { type: "azure-native:solutions/v20200821preview:JitRequest" }, { type: "azure-native:solutions/v20210201preview:JitRequest" }, { type: "azure-native:solutions/v20210701:JitRequest" }] };
...
export interface JitRequestArgs {
     ...
     * The JIT authorization policies.
     */
    jitAuthorizationPolicies: pulumi.Input<pulumi.Input<inputs.solutions.v20180601.JitAuthorizationPoliciesArgs>[]>;
    /**
     ...
     * The JIT request properties.
     */
    jitSchedulingPolicy: pulumi.Input<inputs.solutions.v20180601.JitSchedulingPolicyArgs>;
    /**
     * Resource location
     */
