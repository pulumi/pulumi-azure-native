...
export class ApplicationDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApplicationDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:solutions/latest:ApplicationDefinition" }, { type: "azurerm:solutions/v20170901:ApplicationDefinition" }, { type: "azurerm:solutions/v20190701:ApplicationDefinition" }] };
