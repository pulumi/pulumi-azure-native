...
export class ApplicationDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:solutions/v20180601:ApplicationDefinition';
    ...
    constructor(name: string, args: ApplicationDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:solutions/v20180601:ApplicationDefinition" }, { type: "azure-native:solutions:ApplicationDefinition" }, { type: "azure-nextgen:solutions:ApplicationDefinition" }, { type: "azure-native:solutions/latest:ApplicationDefinition" }, { type: "azure-nextgen:solutions/latest:ApplicationDefinition" }, { type: "azure-native:solutions/v20160901preview:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20160901preview:ApplicationDefinition" }, { type: "azure-native:solutions/v20170901:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20170901:ApplicationDefinition" }, { type: "azure-native:solutions/v20190701:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20190701:ApplicationDefinition" }, { type: "azure-native:solutions/v20200821preview:ApplicationDefinition" }, { type: "azure-nextgen:solutions/v20200821preview:ApplicationDefinition" }] };
...
export interface ApplicationDefinitionArgs {
     ...
     * The collection of managed application artifacts. The portal will use the files specified as artifacts to construct the user experience of creating a managed application from a managed application definition.
     */
    readonly artifacts?: pulumi.Input<pulumi.Input<inputs.solutions.v20180601.ApplicationArtifact>[]>;
    /**
     * The managed application provider authorizations.
     */
    readonly authorizations: pulumi.Input<pulumi.Input<inputs.solutions.v20180601.ApplicationProviderAuthorization>[]>;
    /**
     * The createUiDefinition json for the backing template with Microsoft.Solutions/applications resource. It can be a JObject or well-formed JSON string.
     */
     ...
     * The managed application lock level.
     */
    readonly lockLevel: pulumi.Input<enums.solutions.v20180601.ApplicationLockLevel>;
    /**
     * The inline main template json which has resources to be provisioned. It can be a JObject or well-formed JSON string.
     */
