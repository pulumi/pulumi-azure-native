...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple:StorageAccountCredential';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.storsimple.StorageAccountCredentialPropertiesResponse>;
    /**
...
export interface StorageAccountCredentialArgs {
     ...
     * The storage account credential properties.
     */
    readonly properties: pulumi.Input<inputs.storsimple.StorageAccountCredentialProperties>;
    /**
