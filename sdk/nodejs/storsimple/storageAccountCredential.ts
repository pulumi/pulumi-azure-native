...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple:StorageAccountCredential" }, { type: "azure-native:storsimple/v20161001:StorageAccountCredential" }, { type: "azure-nextgen:storsimple/v20161001:StorageAccountCredential" }, { type: "azure-native:storsimple/v20170601:StorageAccountCredential" }, { type: "azure-nextgen:storsimple/v20170601:StorageAccountCredential" }] };
...
export interface StorageAccountCredentialArgs {
     ...
     * The details of the storage account password.
     */
    accessKey?: pulumi.Input<inputs.storsimple.AsymmetricEncryptedSecretArgs>;
    /**
     * The storage endpoint
     */
     ...
     * Signifies whether SSL needs to be enabled or not.
     */
    sslStatus: pulumi.Input<enums.storsimple.SslStatus>;
    /**
