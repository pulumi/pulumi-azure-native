 ...
 *
 * const fileShare = new azurerm.storsimple.v20161001.FileShare("fileShare", {
...
export class FileShare extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/v20161001:FileShare';
    ...
    constructor(name: string, argsOrState?: FileShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:FileShare" }] };
