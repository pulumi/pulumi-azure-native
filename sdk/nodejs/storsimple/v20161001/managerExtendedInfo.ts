...
export class ManagerExtendedInfo extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagerExtendedInfoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storsimple:ManagerExtendedInfo" }, { type: "azure-nextgen:storsimple:ManagerExtendedInfo" }, { type: "azure-native:storsimple/latest:ManagerExtendedInfo" }, { type: "azure-nextgen:storsimple/latest:ManagerExtendedInfo" }, { type: "azure-native:storsimple/v20170601:ManagerExtendedInfo" }, { type: "azure-nextgen:storsimple/v20170601:ManagerExtendedInfo" }] };
