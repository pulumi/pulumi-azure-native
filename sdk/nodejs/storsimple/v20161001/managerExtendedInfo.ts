...
export class ManagerExtendedInfo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:storsimple/v20161001:ManagerExtendedInfo';
    ...
    constructor(name: string, args: ManagerExtendedInfoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple:ManagerExtendedInfo" }, { type: "azure-nextgen:storsimple/latest:ManagerExtendedInfo" }, { type: "azure-nextgen:storsimple/v20170601:ManagerExtendedInfo" }] };
