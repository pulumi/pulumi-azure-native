...
export class AccessControlRecord extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: AccessControlRecordArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:AccessControlRecord" }, { type: "azurerm:storsimple/preview:AccessControlRecord" }, { type: "azurerm:storsimple/v20170601:AccessControlRecord" }] };
