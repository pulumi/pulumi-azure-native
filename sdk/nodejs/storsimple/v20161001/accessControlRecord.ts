...
export class AccessControlRecord extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccessControlRecordArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/v20161001:AccessControlRecord" }, { type: "azure-native:storsimple:AccessControlRecord" }, { type: "azure-nextgen:storsimple:AccessControlRecord" }, { type: "azure-native:storsimple/latest:AccessControlRecord" }, { type: "azure-nextgen:storsimple/latest:AccessControlRecord" }, { type: "azure-native:storsimple/v20170601:AccessControlRecord" }, { type: "azure-nextgen:storsimple/v20170601:AccessControlRecord" }] };
