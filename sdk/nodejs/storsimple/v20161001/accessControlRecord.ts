 ...
 *
 * const accessControlRecord = new azurerm.storsimple.v20161001.AccessControlRecord("accessControlRecord", {
...
export class AccessControlRecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/v20161001:AccessControlRecord';
    ...
    constructor(name: string, argsOrState?: AccessControlRecordArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:AccessControlRecord" }, { type: "azurerm:storsimple/v20170601:AccessControlRecord" }] };
