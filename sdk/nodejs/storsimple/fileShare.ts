...
export class FileShare extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple:FileShare" }, { type: "azure-native:storsimple/latest:FileShare" }, { type: "azure-nextgen:storsimple/latest:FileShare" }, { type: "azure-native:storsimple/v20161001:FileShare" }, { type: "azure-nextgen:storsimple/v20161001:FileShare" }] };
...
export interface FileShareArgs {
     ...
     * The data policy
     */
    readonly dataPolicy: pulumi.Input<enums.storsimple.DataPolicy>;
    /**
     * Description for file share
     */
     ...
     * The monitoring status
     */
    readonly monitoringStatus: pulumi.Input<enums.storsimple.MonitoringStatus>;
    /**
     * The total provisioned capacity in Bytes
     */
     ...
     * The Share Status
     */
    readonly shareStatus: pulumi.Input<enums.storsimple.ShareStatus>;
}
