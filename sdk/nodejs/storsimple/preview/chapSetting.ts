...
export class ChapSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:ChapSetting';
     ...
     * The chap password.
     */
    public readonly password!: pulumi.Output<outputs.storsimple.preview.AsymmetricEncryptedSecretResponse>;
    /**
     * The type.
     */
    ...
    constructor(name: string, argsOrState?: ChapSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:ChapSetting" }, { type: "azurerm:storsimple/v20161001:ChapSetting" }] };
...
export interface ChapSettingArgs {
     ...
     * The chap password.
     */
    readonly password: pulumi.Input<inputs.storsimple.preview.AsymmetricEncryptedSecret>;
    /**
