...
export function getBackupSchedule(args: GetBackupScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupScheduleResult> {
    ...
    return pulumi.runtime.invoke("azurerm:storsimple/preview:getBackupSchedule", {
...
export interface GetBackupScheduleResult {
     ...
     */
    readonly scheduleRecurrence: outputs.storsimple.preview.ScheduleRecurrenceResponse;
    /**
     * The schedule status.
     */
