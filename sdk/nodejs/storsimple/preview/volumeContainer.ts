...
export class VolumeContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:VolumeContainer';
    ...
    constructor(name: string, argsOrState?: VolumeContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:VolumeContainer" }, { type: "azurerm:storsimple/v20170601:VolumeContainer" }] };
