...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:StorageAccountCredential';
     ...
     */
    public readonly accessKey!: pulumi.Output<outputs.storsimple.preview.AsymmetricEncryptedSecretResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:StorageAccountCredential" }, { type: "azurerm:storsimple/v20161001:StorageAccountCredential" }, { type: "azurerm:storsimple/v20170601:StorageAccountCredential" }] };
...
export interface StorageAccountCredentialArgs {
     ...
     * The details of the storage account password.
     */
    readonly accessKey?: pulumi.Input<inputs.storsimple.preview.AsymmetricEncryptedSecret>;
    /**
     * The storage endpoint
     */
