...
export class Manager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:Manager';
     ...
     */
    public readonly cisIntrinsicSettings!: pulumi.Output<outputs.storsimple.preview.ManagerIntrinsicSettingsResponse | undefined>;
    /**
     ...
     * Specifies the Sku.
     */
    public readonly sku!: pulumi.Output<outputs.storsimple.preview.ManagerSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:Manager" }, { type: "azurerm:storsimple/v20161001:Manager" }, { type: "azurerm:storsimple/v20170601:Manager" }] };
...
export interface ManagerArgs {
     ...
     * Represents the type of StorSimple Manager.
     */
    readonly cisIntrinsicSettings?: pulumi.Input<inputs.storsimple.preview.ManagerIntrinsicSettings>;
    /**
     * The etag of the manager.
     */
     ...
     * Specifies the Sku.
     */
    readonly sku?: pulumi.Input<inputs.storsimple.preview.ManagerSku>;
    /**
     * The tags attached to the resource.
     */
