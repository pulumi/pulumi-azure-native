...
export class BandwidthSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:BandwidthSetting';
     ...
     * The schedules.
     */
    public readonly schedules!: pulumi.Output<outputs.storsimple.preview.BandwidthScheduleResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: BandwidthSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:BandwidthSetting" }, { type: "azurerm:storsimple/v20170601:BandwidthSetting" }] };
...
export interface BandwidthSettingArgs {
     ...
     * The schedules.
     */
    readonly schedules: pulumi.Input<pulumi.Input<inputs.storsimple.preview.BandwidthSchedule>[]>;
}
