...
export class IscsiDisk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:IscsiDisk';
    ...
    constructor(name: string, args: IscsiDiskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:IscsiDisk" }, { type: "azurerm:storsimple/v20161001:IscsiDisk" }] };
