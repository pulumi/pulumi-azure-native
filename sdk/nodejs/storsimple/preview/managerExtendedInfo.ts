...
export class ManagerExtendedInfo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:ManagerExtendedInfo';
    ...
    constructor(name: string, argsOrState?: ManagerExtendedInfoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:ManagerExtendedInfo" }, { type: "azurerm:storsimple/v20161001:ManagerExtendedInfo" }, { type: "azurerm:storsimple/v20170601:ManagerExtendedInfo" }] };
