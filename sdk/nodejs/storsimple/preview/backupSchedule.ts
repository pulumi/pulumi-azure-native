...
export class BackupSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:BackupSchedule';
     ...
     */
    public readonly scheduleRecurrence!: pulumi.Output<outputs.storsimple.preview.ScheduleRecurrenceResponse>;
    /**
     * The schedule status.
     */
    ...
    constructor(name: string, argsOrState?: BackupScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:BackupSchedule" }, { type: "azurerm:storsimple/v20170601:BackupSchedule" }] };
...
export interface BackupScheduleArgs {
     ...
     * The schedule recurrence.
     */
    readonly scheduleRecurrence: pulumi.Input<inputs.storsimple.preview.ScheduleRecurrence>;
    /**
     * The schedule status.
     */
