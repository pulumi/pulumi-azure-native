...
export class StorageDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:StorageDomain';
     ...
     */
    public readonly encryptionKey!: pulumi.Output<outputs.storsimple.preview.AsymmetricEncryptedSecretResponse | undefined>;
    /**
    ...
    constructor(name: string, args: StorageDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:StorageDomain" }, { type: "azurerm:storsimple/v20161001:StorageDomain" }] };
...
export interface StorageDomainArgs {
     ...
     * The encryption key used to encrypt the data. This is a user secret.
     */
    readonly encryptionKey?: pulumi.Input<inputs.storsimple.preview.AsymmetricEncryptedSecret>;
    /**
     * The encryption status "Enabled | Disabled".
     */
