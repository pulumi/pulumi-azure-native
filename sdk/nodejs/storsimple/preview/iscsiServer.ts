...
export class IscsiServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:IscsiServer';
    ...
    constructor(name: string, args: IscsiServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:IscsiServer" }, { type: "azurerm:storsimple/v20161001:IscsiServer" }] };
