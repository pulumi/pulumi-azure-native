...
export class BackupScheduleGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/preview:BackupScheduleGroup';
     ...
     */
    public readonly startTime!: pulumi.Output<outputs.storsimple.preview.TimeResponse>;
    /**
     * The type.
     */
    ...
    constructor(name: string, args: BackupScheduleGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:BackupScheduleGroup" }, { type: "azurerm:storsimple/v20161001:BackupScheduleGroup" }] };
...
export interface BackupScheduleGroupArgs {
     ...
     * The start time. When this field is specified we will generate Default GrandFather Father Son Backup Schedules.
     */
    readonly startTime: pulumi.Input<inputs.storsimple.preview.Time>;
}
