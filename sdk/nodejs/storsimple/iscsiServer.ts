...
export class IscsiServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storsimple:IscsiServer';
    ...
    constructor(name: string, args: IscsiServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple:IscsiServer" }, { type: "azure-native:storsimple/latest:IscsiServer" }, { type: "azure-nextgen:storsimple/latest:IscsiServer" }, { type: "azure-native:storsimple/v20161001:IscsiServer" }, { type: "azure-nextgen:storsimple/v20161001:IscsiServer" }] };
