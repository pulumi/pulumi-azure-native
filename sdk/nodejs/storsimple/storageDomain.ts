...
export class StorageDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:storsimple:StorageDomain';
    ...
    constructor(name: string, args: StorageDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/latest:StorageDomain" }, { type: "azure-nextgen:storsimple/v20161001:StorageDomain" }] };
