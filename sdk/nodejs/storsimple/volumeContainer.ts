...
export class VolumeContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VolumeContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple:VolumeContainer" }, { type: "azure-native:storsimple/v20170601:VolumeContainer" }, { type: "azure-nextgen:storsimple/v20170601:VolumeContainer" }] };
