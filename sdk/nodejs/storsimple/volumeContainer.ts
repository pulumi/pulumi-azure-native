...
export class VolumeContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple:VolumeContainer';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.storsimple.VolumeContainerPropertiesResponse>;
    /**
...
export interface VolumeContainerArgs {
     ...
     * The volume container properties.
     */
    readonly properties: pulumi.Input<inputs.storsimple.VolumeContainerProperties>;
    /**
