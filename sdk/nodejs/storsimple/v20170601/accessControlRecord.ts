...
export class AccessControlRecord extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccessControlRecordArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:AccessControlRecord" }, { type: "azurerm:storsimple/preview:AccessControlRecord" }, { type: "azurerm:storsimple/v20161001:AccessControlRecord" }] };
