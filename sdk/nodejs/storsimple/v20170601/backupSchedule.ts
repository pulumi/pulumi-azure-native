...
export class BackupSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackupScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/v20170601:BackupSchedule" }, { type: "azure-native:storsimple:BackupSchedule" }, { type: "azure-nextgen:storsimple:BackupSchedule" }, { type: "azure-native:storsimple/latest:BackupSchedule" }, { type: "azure-nextgen:storsimple/latest:BackupSchedule" }] };
...
export interface BackupScheduleArgs {
     ...
     * The type of backup which needs to be taken.
     */
    readonly backupType: pulumi.Input<enums.storsimple.v20170601.BackupType>;
    /**
     * The device name
     */
     ...
     * The schedule status.
     */
    readonly scheduleStatus: pulumi.Input<enums.storsimple.v20170601.ScheduleStatus>;
    /**
     * The start time of the schedule.
     */
