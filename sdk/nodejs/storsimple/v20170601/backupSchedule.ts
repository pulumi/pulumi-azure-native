...
export class BackupSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackupScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/v20170601:BackupSchedule" }, { type: "azure-native:storsimple:BackupSchedule" }, { type: "azure-nextgen:storsimple:BackupSchedule" }] };
...
export interface BackupScheduleArgs {
     ...
     * The schedule recurrence.
     */
    readonly scheduleRecurrence: pulumi.Input<inputs.storsimple.v20170601.ScheduleRecurrenceArgs>;
    /**
     * The schedule status.
     */
