 ...
 *
 * const backupSchedule = new azurerm.storsimple.v20170601.BackupSchedule("backupSchedule", {
...
export class BackupSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/v20170601:BackupSchedule';
    ...
    constructor(name: string, argsOrState?: BackupScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:BackupSchedule" }] };
