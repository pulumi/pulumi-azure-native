...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storsimple:StorageAccountCredential" }, { type: "azure-nextgen:storsimple:StorageAccountCredential" }, { type: "azure-native:storsimple/latest:StorageAccountCredential" }, { type: "azure-nextgen:storsimple/latest:StorageAccountCredential" }, { type: "azure-native:storsimple/v20161001:StorageAccountCredential" }, { type: "azure-nextgen:storsimple/v20161001:StorageAccountCredential" }] };
