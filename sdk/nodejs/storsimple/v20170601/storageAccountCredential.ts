 ...
 *
 * const storageAccountCredential = new azurerm.storsimple.v20170601.StorageAccountCredential("storageAccountCredential", {
 *     accessKey: {
...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/v20170601:StorageAccountCredential';
    ...
    constructor(name: string, argsOrState?: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/latest:StorageAccountCredential" }, { type: "azurerm:storsimple/v20161001:StorageAccountCredential" }] };
