...
export function getVolumeContainer(args: GetVolumeContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetVolumeContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:storsimple/v20170601:getVolumeContainer", {
...
export interface GetVolumeContainerResult {
     ...
     */
    readonly encryptionKey?: outputs.storsimple.v20170601.AsymmetricEncryptedSecretInvokeResponse;
    /**
