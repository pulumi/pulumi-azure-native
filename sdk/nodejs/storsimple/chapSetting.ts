...
export class ChapSetting extends pulumi.CustomResource {
     ...
     * The chap password.
     */
    public readonly password!: pulumi.Output<outputs.storsimple.AsymmetricEncryptedSecretResponse>;
    /**
     * The type.
     */
    ...
    constructor(name: string, args: ChapSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple:ChapSetting" }, { type: "azure-native:storsimple/latest:ChapSetting" }, { type: "azure-nextgen:storsimple/latest:ChapSetting" }, { type: "azure-native:storsimple/v20161001:ChapSetting" }, { type: "azure-nextgen:storsimple/v20161001:ChapSetting" }] };
...
export interface ChapSettingArgs {
     ...
     * The chap password.
     */
    readonly password: pulumi.Input<inputs.storsimple.AsymmetricEncryptedSecret>;
    /**
