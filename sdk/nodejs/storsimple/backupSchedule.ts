...
export class BackupSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:storsimple:BackupSchedule';
    ...
    constructor(name: string, args: BackupScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/latest:BackupSchedule" }, { type: "azure-nextgen:storsimple/v20170601:BackupSchedule" }] };
