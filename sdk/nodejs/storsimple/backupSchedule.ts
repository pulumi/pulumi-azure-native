...
export class BackupSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackupScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storsimple/latest:BackupSchedule" }, { type: "azure-nextgen:storsimple/latest:BackupSchedule" }, { type: "azure-native:storsimple/v20170601:BackupSchedule" }, { type: "azure-nextgen:storsimple/v20170601:BackupSchedule" }] };
