...
export class ManagerExtendedInfo extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ManagerExtendedInfoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:ManagerExtendedInfo" }, { type: "azurerm:storsimple/v20161001:ManagerExtendedInfo" }, { type: "azurerm:storsimple/v20170601:ManagerExtendedInfo" }] };
