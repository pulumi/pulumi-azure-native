...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: StorageAccountCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:StorageAccountCredential" }, { type: "azurerm:storsimple/v20161001:StorageAccountCredential" }, { type: "azurerm:storsimple/v20170601:StorageAccountCredential" }] };
