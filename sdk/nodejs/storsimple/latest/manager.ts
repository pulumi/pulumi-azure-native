...
export class Manager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/latest:Manager';
    ...
    constructor(name: string, argsOrState?: ManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:Manager" }, { type: "azurerm:storsimple/v20161001:Manager" }, { type: "azurerm:storsimple/v20170601:Manager" }] };
