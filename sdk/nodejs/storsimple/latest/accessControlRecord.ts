...
export class AccessControlRecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/latest:AccessControlRecord';
    ...
    constructor(name: string, argsOrState?: AccessControlRecordArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:AccessControlRecord" }, { type: "azurerm:storsimple/v20161001:AccessControlRecord" }, { type: "azurerm:storsimple/v20170601:AccessControlRecord" }] };
