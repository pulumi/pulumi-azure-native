...
export class BackupPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/latest:BackupPolicy';
    ...
    constructor(name: string, argsOrState?: BackupPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:BackupPolicy" }, { type: "azurerm:storsimple/v20170601:BackupPolicy" }] };
