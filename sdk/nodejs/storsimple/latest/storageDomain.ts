...
export class StorageDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/latest:StorageDomain';
    ...
    constructor(name: string, args: StorageDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:StorageDomain" }, { type: "azurerm:storsimple/v20161001:StorageDomain" }] };
