...
export class FileServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storsimple/latest:FileServer';
    ...
    constructor(name: string, args: FileServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/latest:FileServer" }, { type: "azure-native:storsimple:FileServer" }, { type: "azure-nextgen:storsimple:FileServer" }, { type: "azure-native:storsimple/v20161001:FileServer" }, { type: "azure-nextgen:storsimple/v20161001:FileServer" }] };
