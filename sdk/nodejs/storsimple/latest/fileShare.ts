...
export class FileShare extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FileShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/latest:FileShare" }, { type: "azure-native:storsimple:FileShare" }, { type: "azure-nextgen:storsimple:FileShare" }, { type: "azure-native:storsimple/v20161001:FileShare" }, { type: "azure-nextgen:storsimple/v20161001:FileShare" }] };
