...
export class BackupSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/latest:BackupSchedule';
    ...
    constructor(name: string, argsOrState?: BackupScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:BackupSchedule" }, { type: "azurerm:storsimple/v20170601:BackupSchedule" }] };
