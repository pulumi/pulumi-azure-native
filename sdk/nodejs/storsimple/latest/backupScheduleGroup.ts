...
export class BackupScheduleGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupScheduleGroup {
        return new BackupScheduleGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/latest:BackupScheduleGroup';
    ...
    constructor(name: string, argsOrState?: BackupScheduleGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as BackupScheduleGroupArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:BackupScheduleGroup" }, { type: "azurerm:storsimple/v20161001:BackupScheduleGroup" }] };
