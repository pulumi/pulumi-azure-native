...
export class ChapSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/latest:ChapSetting';
    ...
    constructor(name: string, argsOrState?: ChapSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:ChapSetting" }, { type: "azurerm:storsimple/v20161001:ChapSetting" }] };
