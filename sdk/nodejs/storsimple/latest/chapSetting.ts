...
export class ChapSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storsimple/latest:ChapSetting';
    ...
    constructor(name: string, args: ChapSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/latest:ChapSetting" }, { type: "azure-native:storsimple:ChapSetting" }, { type: "azure-nextgen:storsimple:ChapSetting" }, { type: "azure-native:storsimple/v20161001:ChapSetting" }, { type: "azure-nextgen:storsimple/v20161001:ChapSetting" }] };
