...
export class IscsiDisk extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IscsiDiskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storsimple/latest:IscsiDisk" }, { type: "azure-native:storsimple:IscsiDisk" }, { type: "azure-nextgen:storsimple:IscsiDisk" }, { type: "azure-native:storsimple/v20161001:IscsiDisk" }, { type: "azure-nextgen:storsimple/v20161001:IscsiDisk" }] };
