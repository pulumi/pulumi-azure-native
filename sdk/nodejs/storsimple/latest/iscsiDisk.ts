...
export class IscsiDisk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:storsimple/latest:IscsiDisk';
    ...
    constructor(name: string, argsOrState?: IscsiDiskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:storsimple/preview:IscsiDisk" }, { type: "azurerm:storsimple/v20161001:IscsiDisk" }] };
