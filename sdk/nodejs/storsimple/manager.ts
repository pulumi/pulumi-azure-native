...
export class Manager extends pulumi.CustomResource {
     ...
     */
    declare public readonly cisIntrinsicSettings: pulumi.Output<outputs.storsimple.ManagerIntrinsicSettingsResponse | undefined>;
    /**
     ...
     * Specifies the Sku.
     */
    declare public readonly sku: pulumi.Output<outputs.storsimple.ManagerSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["cisIntrinsicSettings"] = args?.cisIntrinsicSettings;
