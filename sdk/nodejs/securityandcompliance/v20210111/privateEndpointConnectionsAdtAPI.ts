...
export class PrivateEndpointConnectionsAdtAPI extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsAdtAPI';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<outputs.securityandcompliance.v20210111.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.securityandcompliance.v20210111.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionsAdtAPIArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:securityandcompliance/v20210111:PrivateEndpointConnectionsAdtAPI" }, { type: "azure-native:securityandcompliance:PrivateEndpointConnectionsAdtAPI" }, { type: "azure-nextgen:securityandcompliance:PrivateEndpointConnectionsAdtAPI" }, { type: "azure-native:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI" }, { type: "azure-nextgen:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI" }, { type: "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI" }, { type: "azure-nextgen:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(PrivateEndpointConnectionsAdtAPI.__pulumiType, name, inputs, opts);
    }
}
