...
export class PrivateEndpointConnectionsAdtAPI extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpointConnectionsAdtAPI {
        pulumi.log.warn("PrivateEndpointConnectionsAdtAPI is deprecated: azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsAdtAPI is being removed in the next major version of this provider. Upgrade to at least azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: PrivateEndpointConnectionsAdtAPIArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityandcompliance:PrivateEndpointConnectionsAdtAPI" }, { type: "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI" }] };
