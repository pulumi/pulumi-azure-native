...
export class BlockchainMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:blockchain/preview:BlockchainMember';
     ...
     */
    public readonly firewallRules!: pulumi.Output<outputs.blockchain.preview.FirewallRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.blockchain.preview.SkuResponse | undefined>;
    /**
     ...
     */
    public readonly validatorNodesSku!: pulumi.Output<outputs.blockchain.preview.BlockchainMemberNodesSkuResponse | undefined>;
    ...
    constructor(name: string, args: BlockchainMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:blockchain/v20180601preview:BlockchainMember" }] };
...
export interface BlockchainMemberArgs {
     ...
     * Gets or sets firewall rules
     */
    readonly firewallRules?: pulumi.Input<pulumi.Input<inputs.blockchain.preview.FirewallRule>[]>;
    /**
     * The GEO location of the blockchain service.
     */
     ...
     * Gets or sets the blockchain member Sku.
     */
    readonly sku?: pulumi.Input<inputs.blockchain.preview.Sku>;
    /**
     * Tags of the service which is a list of key value pairs that describes the resource.
     */
     ...
     * Gets or sets the blockchain validator nodes Sku.
     */
    readonly validatorNodesSku?: pulumi.Input<inputs.blockchain.preview.BlockchainMemberNodesSku>;
}
