...
export function getBlockchainMember(args: GetBlockchainMemberArgs, opts?: pulumi.InvokeOptions): Promise<GetBlockchainMemberResult> {
    ...
    return pulumi.runtime.invoke("azurerm:blockchain/preview:getBlockchainMember", {
...
export interface GetBlockchainMemberResult {
     ...
     */
    readonly firewallRules?: outputs.blockchain.preview.FirewallRuleResponse[];
    /**
     ...
     */
    readonly sku?: outputs.blockchain.preview.SkuResponse;
    /**
     ...
     */
    readonly validatorNodesSku?: outputs.blockchain.preview.BlockchainMemberNodesSkuResponse;
}
