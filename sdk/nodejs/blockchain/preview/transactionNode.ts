...
export class TransactionNode extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:blockchain/preview:TransactionNode';
    ...
    constructor(name: string, args: TransactionNodeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:blockchain/v20180601preview:TransactionNode" }] };
