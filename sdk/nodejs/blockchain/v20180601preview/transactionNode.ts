...
export class TransactionNode extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TransactionNodeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:blockchain/v20180601preview:TransactionNode" }, { type: "azure-native:blockchain:TransactionNode" }, { type: "azure-nextgen:blockchain:TransactionNode" }] };
