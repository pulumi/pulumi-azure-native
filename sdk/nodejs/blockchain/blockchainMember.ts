...
export class BlockchainMember extends pulumi.CustomResource {
     ...
     */
    public readonly sku!: pulumi.Output<outputs.blockchain.SkuResponse | undefined>;
    /**
     ...
     */
    public readonly validatorNodesSku!: pulumi.Output<outputs.blockchain.BlockchainMemberNodesSkuResponse | undefined>;
    ...
    constructor(name: string, args: BlockchainMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:blockchain:BlockchainMember" }, { type: "azure-native:blockchain/v20180601preview:BlockchainMember" }, { type: "azure-nextgen:blockchain/v20180601preview:BlockchainMember" }] };
...
export interface BlockchainMemberArgs {
     ...
     * Gets or sets the blockchain member Sku.
     */
    readonly sku?: pulumi.Input<inputs.blockchain.Sku>;
    /**
     * Tags of the service which is a list of key value pairs that describes the resource.
     */
     ...
     * Gets or sets the blockchain validator nodes Sku.
     */
    readonly validatorNodesSku?: pulumi.Input<inputs.blockchain.BlockchainMemberNodesSku>;
}
