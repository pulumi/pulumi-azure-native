...
export function getManagedClusterService(args: GetManagedClusterServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicefabric/v20220801preview:getManagedClusterService", {
...
export interface GetManagedClusterServiceResult {
     ...
     */
    readonly properties: outputs.servicefabric.v20220801preview.StatefulServicePropertiesResponse | outputs.servicefabric.v20220801preview.StatelessServicePropertiesResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: outputs.servicefabric.v20220801preview.SystemDataResponse;
    /**
     * Azure resource tags.
     */
...
export function getManagedClusterServiceOutput(args: GetManagedClusterServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedClusterServiceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:servicefabric/v20220801preview:getManagedClusterService", {
        "applicationName": args.applicationName,
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
        "serviceName": args.serviceName,
