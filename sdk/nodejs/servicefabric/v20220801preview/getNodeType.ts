...
export function getNodeType(args: GetNodeTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeTypeResult> {
    pulumi.log.warn("getNodeType is deprecated: azure-native:servicefabric/v20220801preview:NodeType is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:NodeType to guarantee forwards compatibility.")
