...
export function getNodeType(args: GetNodeTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeTypeResult> {
    pulumi.log.warn("getNodeType is deprecated: azure-native:servicefabric/v20220801preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:NodeType to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:servicefabric/v20220801preview:getNodeType", {
...
export interface GetNodeTypeResult {
     ...
     */
    readonly additionalDataDisks?: outputs.servicefabric.v20220801preview.VmssDataDiskResponse[];
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    readonly applicationPorts?: outputs.servicefabric.v20220801preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    readonly ephemeralPorts?: outputs.servicefabric.v20220801preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    readonly frontendConfigurations?: outputs.servicefabric.v20220801preview.FrontendConfigurationResponse[];
    /**
     ...
     * The node type sku.
     */
    readonly sku?: outputs.servicefabric.v20220801preview.NodeTypeSkuResponse;
    /**
     ...
     */
    readonly vmExtensions?: outputs.servicefabric.v20220801preview.VMSSExtensionResponse[];
    /**
     ...
     */
    readonly vmManagedIdentity?: outputs.servicefabric.v20220801preview.VmManagedIdentityResponse;
    /**
     * The secrets to install in the virtual machines.
     */
    readonly vmSecrets?: outputs.servicefabric.v20220801preview.VaultSecretGroupResponse[];
    /**
