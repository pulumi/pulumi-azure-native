...
export class Service extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric:Service" }, { type: "azure-native:servicefabric/latest:Service" }, { type: "azure-nextgen:servicefabric/latest:Service" }, { type: "azure-native:servicefabric/v20170701preview:Service" }, { type: "azure-nextgen:servicefabric/v20170701preview:Service" }, { type: "azure-native:servicefabric/v20190301:Service" }, { type: "azure-nextgen:servicefabric/v20190301:Service" }, { type: "azure-native:servicefabric/v20190301preview:Service" }, { type: "azure-nextgen:servicefabric/v20190301preview:Service" }, { type: "azure-native:servicefabric/v20190601preview:Service" }, { type: "azure-nextgen:servicefabric/v20190601preview:Service" }, { type: "azure-native:servicefabric/v20191101preview:Service" }, { type: "azure-nextgen:servicefabric/v20191101preview:Service" }, { type: "azure-native:servicefabric/v20200301:Service" }, { type: "azure-nextgen:servicefabric/v20200301:Service" }, { type: "azure-native:servicefabric/v20201201preview:Service" }, { type: "azure-nextgen:servicefabric/v20201201preview:Service" }] };
...
export interface ServiceArgs {
     ...
     * A list that describes the correlation of the service with other services.
     */
    readonly correlationScheme?: pulumi.Input<pulumi.Input<inputs.servicefabric.ServiceCorrelationDescription>[]>;
    /**
     * Specifies the move cost for the service.
     */
    readonly defaultMoveCost?: pulumi.Input<string | enums.servicefabric.MoveCost>;
    /**
     * It will be deprecated in New API, resource location depends on the parent resource.
     */
     ...
     * Describes how the service is partitioned.
     */
    readonly partitionDescription?: pulumi.Input<inputs.servicefabric.NamedPartitionSchemeDescription | inputs.servicefabric.SingletonPartitionSchemeDescription | inputs.servicefabric.UniformInt64RangePartitionSchemeDescription>;
    /**
     * The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: "NodeColor == blue)".
     */
     ...
     * The kind of service (Stateless or Stateful).
     */
    readonly serviceKind: pulumi.Input<string | enums.servicefabric.ServiceKind>;
    /**
     * The service load metrics is given as an array of ServiceLoadMetricDescription objects.
     */
    readonly serviceLoadMetrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.ServiceLoadMetricDescription>[]>;
    /**
     ...
     * The activation Mode of the service package
     */
    readonly servicePackageActivationMode?: pulumi.Input<string | enums.servicefabric.ArmServicePackageActivationMode>;
    /**
     * A list that describes the correlation of the service with other services.
     */
    readonly servicePlacementPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.ServicePlacementPolicyDescription>[]>;
    /**
     * The name of the service type
     */
