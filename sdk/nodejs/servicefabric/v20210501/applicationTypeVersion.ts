...
export class ApplicationTypeVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApplicationTypeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric/v20210501:ApplicationTypeVersion" }, { type: "azure-native:servicefabric/v20210101preview:ApplicationTypeVersion" }, { type: "azure-nextgen:servicefabric/v20210101preview:ApplicationTypeVersion" }, { type: "azure-native:servicefabric/v20210701preview:ApplicationTypeVersion" }, { type: "azure-nextgen:servicefabric/v20210701preview:ApplicationTypeVersion" }] };
