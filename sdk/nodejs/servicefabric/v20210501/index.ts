...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:servicefabric/v20210501:ManagedClusterApplication":
                return new ManagedClusterApplication(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20210501:ManagedClusterApplicationType":
                return new ManagedClusterApplicationType(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20210501:ManagedClusterApplicationTypeVersion":
                return new ManagedClusterApplicationTypeVersion(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20210501:ManagedClusterService":
