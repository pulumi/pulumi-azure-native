...
export class ManagedClusterApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20210501:ManagedClusterApplication';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.servicefabric.v20210501.ManagedIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly managedIdentities!: pulumi.Output<outputs.servicefabric.v20210501.ApplicationUserAssignedIdentityResponse[] | undefined>;
    /**
     * Azure resource name.
     */
     ...
     */
    public readonly upgradePolicy!: pulumi.Output<outputs.servicefabric.v20210501.ApplicationUpgradePolicyResponse | undefined>;
    /**
...
export interface ManagedClusterApplicationArgs {
     ...
     * Describes the managed identities for an Azure resource.
     */
    identity?: pulumi.Input<inputs.servicefabric.v20210501.ManagedIdentityArgs>;
    /**
     * Resource location depends on the parent resource.
     */
     ...
     * List of user assigned identities for the application, each mapped to a friendly name.
     */
    managedIdentities?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20210501.ApplicationUserAssignedIdentityArgs>[]>;
    /**
     * List of application parameters with overridden values from their default values specified in the application manifest.
     */
     ...
     * Describes the policy for a monitored application upgrade.
     */
    upgradePolicy?: pulumi.Input<inputs.servicefabric.v20210501.ApplicationUpgradePolicyArgs>;
    /**
     * The version of the application type as defined in the application manifest.
     * This name must be the full Arm Resource ID for the referenced application type version.
     */
