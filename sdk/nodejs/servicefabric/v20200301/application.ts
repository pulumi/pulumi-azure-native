...
export class Application extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20200301:Application';
    ...
    constructor(name: string, args: ApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric/v20200301:Application" }, { type: "azure-native:servicefabric:Application" }, { type: "azure-nextgen:servicefabric:Application" }, { type: "azure-native:servicefabric/v20170701preview:Application" }, { type: "azure-nextgen:servicefabric/v20170701preview:Application" }, { type: "azure-native:servicefabric/v20190301:Application" }, { type: "azure-nextgen:servicefabric/v20190301:Application" }, { type: "azure-native:servicefabric/v20190301preview:Application" }, { type: "azure-nextgen:servicefabric/v20190301preview:Application" }, { type: "azure-native:servicefabric/v20190601preview:Application" }, { type: "azure-nextgen:servicefabric/v20190601preview:Application" }, { type: "azure-native:servicefabric/v20191101preview:Application" }, { type: "azure-nextgen:servicefabric/v20191101preview:Application" }, { type: "azure-native:servicefabric/v20201201preview:Application" }, { type: "azure-nextgen:servicefabric/v20201201preview:Application" }, { type: "azure-native:servicefabric/v20210601:Application" }, { type: "azure-nextgen:servicefabric/v20210601:Application" }] };
...
export interface ApplicationArgs {
     ...
     * Describes the managed identities for an Azure resource.
     */
    identity?: pulumi.Input<inputs.servicefabric.v20200301.ManagedIdentityArgs>;
    /**
     * It will be deprecated in New API, resource location depends on the parent resource.
     */
     ...
     * List of user assigned identities for the application, each mapped to a friendly name.
     */
    managedIdentities?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20200301.ApplicationUserAssignedIdentityArgs>[]>;
    /**
     * The maximum number of nodes where Service Fabric will reserve capacity for this application. Note that this does not mean that the services of this application will be placed on all of those nodes. By default, the value of this property is zero and it means that the services can be placed on any node.
     */
     ...
     * List of application capacity metric description.
     */
    metrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20200301.ApplicationMetricDescriptionArgs>[]>;
    /**
     * The minimum number of nodes where Service Fabric will reserve capacity for this application. Note that this does not mean that the services of this application will be placed on all of those nodes. If this property is set to zero, no capacity will be reserved. The value of this property cannot be more than the value of the MaximumNodes property.
     */
     ...
     * Describes the policy for a monitored application upgrade.
     */
    upgradePolicy?: pulumi.Input<inputs.servicefabric.v20200301.ApplicationUpgradePolicyArgs>;
}
