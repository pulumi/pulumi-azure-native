...
export function getManagedClusterApplication(args: GetManagedClusterApplicationArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterApplicationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicefabric/v20241101preview:getManagedClusterApplication", {
...
export interface GetManagedClusterApplicationResult {
     ...
     */
    readonly identity?: outputs.servicefabric.v20241101preview.ManagedIdentityResponse;
    /**
     ...
     */
    readonly managedIdentities?: outputs.servicefabric.v20241101preview.ApplicationUserAssignedIdentityResponse[];
    /**
     * Azure resource name.
     */
     ...
     */
    readonly upgradePolicy?: outputs.servicefabric.v20241101preview.ApplicationUpgradePolicyResponse;
    /**
...
export function getManagedClusterApplicationOutput(args: GetManagedClusterApplicationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedClusterApplicationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:servicefabric/v20241101preview:getManagedClusterApplication", {
        "applicationName": args.applicationName,
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
