...
export function getNodeType(args: GetNodeTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeTypeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicefabric/v20241101preview:getNodeType", {
...
export interface GetNodeTypeResult {
     ...
     */
    readonly additionalDataDisks?: outputs.servicefabric.v20241101preview.VmssDataDiskResponse[];
    /**
     * Specifies the settings for any additional secondary network interfaces to attach to the node type.
     */
    readonly additionalNetworkInterfaceConfigurations?: outputs.servicefabric.v20241101preview.AdditionalNetworkInterfaceConfigurationResponse[];
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    readonly applicationPorts?: outputs.servicefabric.v20241101preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    readonly ephemeralPorts?: outputs.servicefabric.v20241101preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    readonly frontendConfigurations?: outputs.servicefabric.v20241101preview.FrontendConfigurationResponse[];
    /**
     ...
     */
    readonly natConfigurations?: outputs.servicefabric.v20241101preview.NodeTypeNatConfigResponse[];
    /**
     ...
     */
    readonly networkSecurityRules?: outputs.servicefabric.v20241101preview.NetworkSecurityRuleResponse[];
    /**
     ...
     * The node type sku.
     */
    readonly sku?: outputs.servicefabric.v20241101preview.NodeTypeSkuResponse;
    /**
     ...
     */
    readonly vmApplications?: outputs.servicefabric.v20241101preview.VmApplicationResponse[];
    /**
     * Set of extensions that should be installed onto the virtual machines.
     */
    readonly vmExtensions?: outputs.servicefabric.v20241101preview.VMSSExtensionResponse[];
    /**
     ...
     */
    readonly vmImagePlan?: outputs.servicefabric.v20241101preview.VmImagePlanResponse;
    /**
     ...
     */
    readonly vmManagedIdentity?: outputs.servicefabric.v20241101preview.VmManagedIdentityResponse;
    /**
     * The secrets to install in the virtual machines.
     */
    readonly vmSecrets?: outputs.servicefabric.v20241101preview.VaultSecretGroupResponse[];
    /**
...
export function getNodeTypeOutput(args: GetNodeTypeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNodeTypeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:servicefabric/v20241101preview:getNodeType", {
        "clusterName": args.clusterName,
        "nodeTypeName": args.nodeTypeName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
