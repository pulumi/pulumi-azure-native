...
export function getApplicationType(args: GetApplicationTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationTypeResult> {
    pulumi.log.warn("getApplicationType is deprecated: Version v20190301preview will be removed in the next major version of the provider. Upgrade to version v20200101preview or later.")
    if (!opts) {
        opts = {}
    }
