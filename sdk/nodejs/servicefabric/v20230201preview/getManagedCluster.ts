...
export function getManagedCluster(args: GetManagedClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterResult> {
    pulumi.log.warn("getManagedCluster is deprecated: azure-native:servicefabric/v20230201preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230301preview:ManagedCluster to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:servicefabric/v20230201preview:getManagedCluster", {
...
export interface GetManagedClusterResult {
     ...
     */
    readonly applicationTypeVersionsCleanupPolicy?: outputs.servicefabric.v20230201preview.ApplicationTypeVersionsCleanupPolicyResponse;
    /**
     * Auxiliary subnets for the cluster.
     */
    readonly auxiliarySubnets?: outputs.servicefabric.v20230201preview.SubnetResponse[];
    /**
     * The AAD authentication settings of the cluster.
     */
    readonly azureActiveDirectory?: outputs.servicefabric.v20230201preview.AzureActiveDirectoryResponse;
    /**
     ...
     */
    readonly clients?: outputs.servicefabric.v20230201preview.ClientCertificateResponse[];
    /**
     ...
     */
    readonly fabricSettings?: outputs.servicefabric.v20230201preview.SettingsSectionDescriptionResponse[];
    /**
     ...
     */
    readonly ipTags?: outputs.servicefabric.v20230201preview.IPTagResponse[];
    /**
     ...
     */
    readonly loadBalancingRules?: outputs.servicefabric.v20230201preview.LoadBalancingRuleResponse[];
    /**
     ...
     */
    readonly serviceEndpoints?: outputs.servicefabric.v20230201preview.ServiceEndpointResponse[];
    /**
     * The sku of the managed cluster
     */
    readonly sku: outputs.servicefabric.v20230201preview.SkuResponse;
    /**
