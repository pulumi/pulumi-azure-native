...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabric/preview:ManagedCluster';
     ...
     */
    public readonly azureActiveDirectory!: pulumi.Output<outputs.servicefabric.preview.AzureActiveDirectoryResponse | undefined>;
    /**
     ...
     */
    public readonly clients!: pulumi.Output<outputs.servicefabric.preview.ClientCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly clusterUpgradeDescription!: pulumi.Output<outputs.servicefabric.preview.ClusterUpgradePolicyResponse | undefined>;
    /**
     ...
     */
    public readonly fabricSettings!: pulumi.Output<outputs.servicefabric.preview.SettingsSectionDescriptionResponse[] | undefined>;
    /**
     ...
     */
    public readonly loadBalancingRules!: pulumi.Output<outputs.servicefabric.preview.LoadBalancingRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputs.servicefabric.preview.SkuResponse | undefined>;
    /**
     * Azure resource tags.
     */
    ...
    constructor(name: string, argsOrState?: ManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicefabric/v20200101preview:ManagedCluster" }] };
...
export interface ManagedClusterArgs {
     ...
     * Azure active directory.
     */
    readonly azureActiveDirectory?: pulumi.Input<inputs.servicefabric.preview.AzureActiveDirectory>;
    /**
     * The port used for client connections to the cluster.
     */
     ...
     * client certificates for the cluster.
     */
    readonly clients?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.ClientCertificate>[]>;
    /**
     * The Service Fabric runtime version of the cluster. This property can only by set the user when **upgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
     */
     ...
     * Describes the policy used when upgrading the cluster.
     */
    readonly clusterUpgradeDescription?: pulumi.Input<inputs.servicefabric.preview.ClusterUpgradePolicy>;
    /**
     * The upgrade mode of the cluster when new Service Fabric runtime version is available.
     *
     *   - Automatic - The cluster will be automatically upgraded to the latest Service Fabric runtime version as soon as it is available.
     ...
     * The list of custom fabric settings to configure the cluster.
     */
    readonly fabricSettings?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.SettingsSectionDescription>[]>;
    /**
     * The port used for http connections to the cluster.
     */
     ...
     * Describes load balancing rules.
     */
    readonly loadBalancingRules?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.LoadBalancingRule>[]>;
    /**
     * Azure resource location.
     */
     ...
     * The sku of the managed cluster
     */
    readonly sku?: pulumi.Input<inputs.servicefabric.preview.Sku>;
    /**
     * Azure resource tags.
     */
