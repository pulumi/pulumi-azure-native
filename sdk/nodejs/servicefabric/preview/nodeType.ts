...
export class NodeType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabric/preview:NodeType';
     ...
     */
    public readonly applicationPorts!: pulumi.Output<outputs.servicefabric.preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly ephemeralPorts!: pulumi.Output<outputs.servicefabric.preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly vmExtensions!: pulumi.Output<outputs.servicefabric.preview.VMSSExtensionResponse[] | undefined>;
    /**
     ...
     */
    public readonly vmSecrets!: pulumi.Output<outputs.servicefabric.preview.VaultSecretGroupResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: NodeTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicefabric/v20200101preview:NodeType" }] };
...
export interface NodeTypeArgs {
     ...
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    readonly applicationPorts?: pulumi.Input<inputs.servicefabric.preview.EndpointRangeDescription>;
    /**
     * The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much resource a node has.
     */
     ...
     * The range of ephemeral ports that nodes in this node type should be configured with.
     */
    readonly ephemeralPorts?: pulumi.Input<inputs.servicefabric.preview.EndpointRangeDescription>;
    /**
     * The node type on which system services will run. Only one node type should be marked as primary. Primary node type cannot be deleted or changed for existing clusters.
     */
     ...
     * Set of extensions that should be installed onto the virtual machines.
     */
    readonly vmExtensions?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.VMSSExtension>[]>;
    /**
     * The offer type of the Azure Virtual Machines Marketplace image. For example, UbuntuServer or WindowsServer.
     */
     ...
     * The secrets to install in the virtual machines.
     */
    readonly vmSecrets?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.VaultSecretGroup>[]>;
    /**
     * The size of virtual machines in the pool. All virtual machines in a pool are the same size. For example, Standard_D3.
     */
