...
export function getNodeType(args: GetNodeTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeTypeResult> {
    ...
    return pulumi.runtime.invoke("azurerm:servicefabric/preview:getNodeType", {
...
export interface GetNodeTypeResult {
     ...
     */
    readonly applicationPorts?: outputs.servicefabric.preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    readonly ephemeralPorts?: outputs.servicefabric.preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    readonly vmExtensions?: outputs.servicefabric.preview.VMSSExtensionResponse[];
    /**
     ...
     */
    readonly vmSecrets?: outputs.servicefabric.preview.VaultSecretGroupResponse[];
    /**
