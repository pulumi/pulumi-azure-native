...
export class Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabric/preview:Service';
     ...
     */
    public readonly correlationScheme!: pulumi.Output<outputs.servicefabric.preview.ServiceCorrelationDescriptionResponse[] | undefined>;
    /**
     ...
     */
    public readonly partitionDescription!: pulumi.Output<outputs.servicefabric.preview.NamedPartitionSchemeDescriptionResponse | outputs.servicefabric.preview.SingletonPartitionSchemeDescriptionResponse | outputs.servicefabric.preview.UniformInt64RangePartitionSchemeDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly serviceLoadMetrics!: pulumi.Output<outputs.servicefabric.preview.ServiceLoadMetricDescriptionResponse[] | undefined>;
    /**
     ...
     * A list that describes the correlation of the service with other services.
     */
    public readonly servicePlacementPolicies!: pulumi.Output<outputs.servicefabric.preview.ServicePlacementPolicyDescriptionResponse[] | undefined>;
    /**
...
export interface ServiceArgs {
     ...
     * A list that describes the correlation of the service with other services.
     */
    readonly correlationScheme?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.ServiceCorrelationDescription>[]>;
    /**
     * Specifies the move cost for the service.
     */
     ...
     * Describes how the service is partitioned.
     */
    readonly partitionDescription?: pulumi.Input<inputs.servicefabric.preview.NamedPartitionSchemeDescription | inputs.servicefabric.preview.SingletonPartitionSchemeDescription | inputs.servicefabric.preview.UniformInt64RangePartitionSchemeDescription>;
    /**
     * The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: "NodeColor == blue)".
     */
     ...
     * The service load metrics is given as an array of ServiceLoadMetricDescription objects.
     */
    readonly serviceLoadMetrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.ServiceLoadMetricDescription>[]>;
    /**
     ...
     * A list that describes the correlation of the service with other services.
     */
    readonly servicePlacementPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.ServicePlacementPolicyDescription>[]>;
    /**
     * The name of the service type
     */
