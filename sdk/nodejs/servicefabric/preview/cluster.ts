...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabric/preview:Cluster';
     ...
     */
    public readonly applicationTypeVersionsCleanupPolicy!: pulumi.Output<outputs.servicefabric.preview.ApplicationTypeVersionsCleanupPolicyResponse | undefined>;
    /**
     * The Service Fabric runtime versions available for this cluster.
     */
    public /*out*/ readonly availableClusterVersions!: pulumi.Output<outputs.servicefabric.preview.ClusterVersionDetailsResponse[]>;
    /**
     ...
     */
    public readonly certificate!: pulumi.Output<outputs.servicefabric.preview.CertificateDescriptionResponse | undefined>;
    /**
     * Describes a list of server certificates referenced by common name that are used to secure the cluster.
     */
    public readonly certificateCommonNames!: pulumi.Output<outputs.servicefabric.preview.ServerCertificateCommonNamesResponse | undefined>;
    /**
     * The list of client certificates referenced by common name that are allowed to manage the cluster.
     */
    public readonly clientCertificateCommonNames!: pulumi.Output<outputs.servicefabric.preview.ClientCertificateCommonNameResponse[] | undefined>;
    /**
     * The list of client certificates referenced by thumbprint that are allowed to manage the cluster.
     */
    public readonly clientCertificateThumbprints!: pulumi.Output<outputs.servicefabric.preview.ClientCertificateThumbprintResponse[] | undefined>;
    /**
     ...
     */
    public readonly diagnosticsStorageAccountConfig!: pulumi.Output<outputs.servicefabric.preview.DiagnosticsStorageAccountConfigResponse | undefined>;
    /**
     * Azure resource etag.
     */
     ...
     */
    public readonly nodeTypes!: pulumi.Output<outputs.servicefabric.preview.NodeTypeDescriptionResponse[]>;
    /**
     ...
     */
    public readonly reverseProxyCertificate!: pulumi.Output<outputs.servicefabric.preview.CertificateDescriptionResponse | undefined>;
    /**
     * Describes a list of server certificates referenced by common name that are used to secure the cluster.
     */
    public readonly reverseProxyCertificateCommonNames!: pulumi.Output<outputs.servicefabric.preview.ServerCertificateCommonNamesResponse | undefined>;
    /**
     * Azure resource tags.
     */
     ...
     */
    public readonly upgradeDescription!: pulumi.Output<outputs.servicefabric.preview.ClusterUpgradePolicyResponse | undefined>;
    /**
...
export interface ClusterArgs {
     ...
     * The policy used to clean up unused versions.
     */
    readonly applicationTypeVersionsCleanupPolicy?: pulumi.Input<inputs.servicefabric.preview.ApplicationTypeVersionsCleanupPolicy>;
    /**
     * The AAD authentication settings of the cluster.
     */
     ...
     * The certificate to use for securing the cluster. The certificate provided will be used for node to node security within the cluster, SSL certificate for cluster management endpoint and default admin client.
     */
    readonly certificate?: pulumi.Input<inputs.servicefabric.preview.CertificateDescription>;
    /**
     * Describes a list of server certificates referenced by common name that are used to secure the cluster.
     */
    readonly certificateCommonNames?: pulumi.Input<inputs.servicefabric.preview.ServerCertificateCommonNames>;
    /**
     * The list of client certificates referenced by common name that are allowed to manage the cluster.
     */
    readonly clientCertificateCommonNames?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.ClientCertificateCommonName>[]>;
    /**
     * The list of client certificates referenced by thumbprint that are allowed to manage the cluster.
     */
    readonly clientCertificateThumbprints?: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.ClientCertificateThumbprint>[]>;
    /**
     * The Service Fabric runtime version of the cluster. This property can only by set the user when **upgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
     */
     ...
     * The storage account information for storing Service Fabric diagnostic logs.
     */
    readonly diagnosticsStorageAccountConfig?: pulumi.Input<inputs.servicefabric.preview.DiagnosticsStorageAccountConfig>;
    /**
     * Indicates if the event store service is enabled.
     */
     ...
     * The list of node types in the cluster.
     */
    readonly nodeTypes: pulumi.Input<pulumi.Input<inputs.servicefabric.preview.NodeTypeDescription>[]>;
    /**
     * The reliability level sets the replica set size of system services. Learn about [ReliabilityLevel](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-capacity).
     *
     *   - None - Run the System services with a target replica set count of 1. This should only be used for test clusters.
     ...
     * The server certificate used by reverse proxy.
     */
    readonly reverseProxyCertificate?: pulumi.Input<inputs.servicefabric.preview.CertificateDescription>;
    /**
     * Describes a list of server certificates referenced by common name that are used to secure the cluster.
     */
    readonly reverseProxyCertificateCommonNames?: pulumi.Input<inputs.servicefabric.preview.ServerCertificateCommonNames>;
    /**
     * Azure resource tags.
     */
     ...
     * The policy to use when upgrading the cluster.
     */
    readonly upgradeDescription?: pulumi.Input<inputs.servicefabric.preview.ClusterUpgradePolicy>;
    /**
     * The upgrade mode of the cluster when new Service Fabric runtime version is available.
     *
     *   - Automatic - The cluster will be automatically upgraded to the latest Service Fabric runtime version as soon as it is available.
