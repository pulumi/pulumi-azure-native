...
export function getApplicationType(args: GetApplicationTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationTypeResult> {
    pulumi.log.warn("getApplicationType is deprecated: azure-native:servicefabric/v20220201preview:ApplicationType is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:ApplicationType to guarantee forwards compatibility.")
