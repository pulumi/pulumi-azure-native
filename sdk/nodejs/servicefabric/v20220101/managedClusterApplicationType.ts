...
export class ManagedClusterApplicationType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20220101:ManagedClusterApplicationType';
    ...
    constructor(name: string, args: ManagedClusterApplicationTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicefabric:ManagedClusterApplicationType" }, { type: "azure-native:servicefabric/v20221001preview:ManagedClusterApplicationType" }, { type: "azure-native:servicefabric/v20230201preview:ManagedClusterApplicationType" }, { type: "azure-native:servicefabric/v20230301preview:ManagedClusterApplicationType" }] };
