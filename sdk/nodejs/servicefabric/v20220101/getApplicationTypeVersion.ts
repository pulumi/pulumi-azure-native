 ...
 */
/** @deprecated azure-native:servicefabric/v20220101:ApplicationTypeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:ApplicationTypeVersion to guarantee forwards compatibility. */
export function getApplicationTypeVersion(args: GetApplicationTypeVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationTypeVersionResult> {
    pulumi.log.warn("getApplicationTypeVersion is deprecated: azure-native:servicefabric/v20220101:ApplicationTypeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:ApplicationTypeVersion to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:servicefabric/v20220101:getApplicationTypeVersion", {
