...
export class Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/latest:Service';
     ...
     */
    public readonly correlationScheme!: pulumi.Output<outputs.servicefabric.latest.ServiceCorrelationDescriptionResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceLoadMetrics!: pulumi.Output<outputs.servicefabric.latest.ServiceLoadMetricDescriptionResponse[] | undefined>;
    /**
     ...
     * A list that describes the correlation of the service with other services.
     */
    public readonly servicePlacementPolicies!: pulumi.Output<outputs.servicefabric.latest.ServicePlacementPolicyDescriptionResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric/latest:Service" }, { type: "azure-native:servicefabric:Service" }, { type: "azure-nextgen:servicefabric:Service" }, { type: "azure-native:servicefabric/v20170701preview:Service" }, { type: "azure-nextgen:servicefabric/v20170701preview:Service" }, { type: "azure-native:servicefabric/v20190301:Service" }, { type: "azure-nextgen:servicefabric/v20190301:Service" }, { type: "azure-native:servicefabric/v20190301preview:Service" }, { type: "azure-nextgen:servicefabric/v20190301preview:Service" }, { type: "azure-native:servicefabric/v20190601preview:Service" }, { type: "azure-nextgen:servicefabric/v20190601preview:Service" }, { type: "azure-native:servicefabric/v20191101preview:Service" }, { type: "azure-nextgen:servicefabric/v20191101preview:Service" }, { type: "azure-native:servicefabric/v20200301:Service" }, { type: "azure-nextgen:servicefabric/v20200301:Service" }, { type: "azure-native:servicefabric/v20201201preview:Service" }, { type: "azure-nextgen:servicefabric/v20201201preview:Service" }] };
...
export interface ServiceArgs {
     ...
     * A list that describes the correlation of the service with other services.
     */
    readonly correlationScheme?: pulumi.Input<pulumi.Input<inputs.servicefabric.latest.ServiceCorrelationDescription>[]>;
    /**
     * Specifies the move cost for the service.
     */
    readonly defaultMoveCost?: pulumi.Input<string | enums.servicefabric.latest.MoveCost>;
    /**
     * It will be deprecated in New API, resource location depends on the parent resource.
     */
     ...
     * The kind of service (Stateless or Stateful).
     */
    readonly serviceKind: pulumi.Input<string | enums.servicefabric.latest.ServiceKind>;
    /**
     * The service load metrics is given as an array of ServiceLoadMetricDescription objects.
     */
    readonly serviceLoadMetrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.latest.ServiceLoadMetricDescription>[]>;
    /**
     ...
     * The activation Mode of the service package
     */
    readonly servicePackageActivationMode?: pulumi.Input<string | enums.servicefabric.latest.ArmServicePackageActivationMode>;
    /**
     * A list that describes the correlation of the service with other services.
     */
    readonly servicePlacementPolicies?: pulumi.Input<pulumi.Input<inputs.servicefabric.latest.ServicePlacementPolicyDescription>[]>;
    /**
     * The name of the service type
     */
