...
export function getService(args: GetServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceResult> {
    ...
    return pulumi.runtime.invoke("azurerm:servicefabric/latest:getService", {
...
export interface GetServiceResult {
     ...
     */
    readonly partitionDescription?: outputs.servicefabric.latest.PartitionSchemeDescriptionResponse;
    /**
