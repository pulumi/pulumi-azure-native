...
export function getNodeType(args: GetNodeTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeTypeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicefabric/v20240901preview:getNodeType", {
...
export interface GetNodeTypeResult {
     ...
     */
    readonly additionalDataDisks?: outputs.servicefabric.v20240901preview.VmssDataDiskResponse[];
    /**
     * Specifies the settings for any additional secondary network interfaces to attach to the node type.
     */
    readonly additionalNetworkInterfaceConfigurations?: outputs.servicefabric.v20240901preview.AdditionalNetworkInterfaceConfigurationResponse[];
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    readonly applicationPorts?: outputs.servicefabric.v20240901preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    readonly ephemeralPorts?: outputs.servicefabric.v20240901preview.EndpointRangeDescriptionResponse;
    /**
     ...
     */
    readonly frontendConfigurations?: outputs.servicefabric.v20240901preview.FrontendConfigurationResponse[];
    /**
     ...
     */
    readonly natConfigurations?: outputs.servicefabric.v20240901preview.NodeTypeNatConfigResponse[];
    /**
     ...
     */
    readonly networkSecurityRules?: outputs.servicefabric.v20240901preview.NetworkSecurityRuleResponse[];
    /**
     ...
     * The node type sku.
     */
    readonly sku?: outputs.servicefabric.v20240901preview.NodeTypeSkuResponse;
    /**
     ...
     */
    readonly vmApplications?: outputs.servicefabric.v20240901preview.VmApplicationResponse[];
    /**
     * Set of extensions that should be installed onto the virtual machines.
     */
    readonly vmExtensions?: outputs.servicefabric.v20240901preview.VMSSExtensionResponse[];
    /**
     ...
     */
    readonly vmImagePlan?: outputs.servicefabric.v20240901preview.VmImagePlanResponse;
    /**
     ...
     */
    readonly vmManagedIdentity?: outputs.servicefabric.v20240901preview.VmManagedIdentityResponse;
    /**
     * The secrets to install in the virtual machines.
     */
    readonly vmSecrets?: outputs.servicefabric.v20240901preview.VaultSecretGroupResponse[];
    /**
...
export function getNodeTypeOutput(args: GetNodeTypeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNodeTypeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:servicefabric/v20240901preview:getNodeType", {
        "clusterName": args.clusterName,
        "nodeTypeName": args.nodeTypeName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
