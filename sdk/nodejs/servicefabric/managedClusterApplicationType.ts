...
export class ManagedClusterApplicationType extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedClusterApplicationTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicefabric/v20220101:ManagedClusterApplicationType" }, { type: "azure-native:servicefabric/v20221001preview:ManagedClusterApplicationType" }, { type: "azure-native:servicefabric/v20230201preview:ManagedClusterApplicationType" }, { type: "azure-native:servicefabric/v20230301preview:ManagedClusterApplicationType" }] };
