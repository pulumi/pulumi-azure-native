 ...
 *
 * const cluster = new azurerm.servicefabric.v20191101preview.Cluster("cluster", {
 *     addOnFeatures: [
 *         "RepairManager",
 *         "DnsService",
...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabric/v20191101preview:Cluster';
