...
azure-native:servicefabric/v20191101preview:ApplicationTypeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:ApplicationTypeVersion to guarantee forwards compatibility.
 */
export class ApplicationTypeVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationTypeVersion {
        pulumi.log.warn("ApplicationTypeVersion is deprecated: Version 2019-11-01-preview will be removed in v2 of the provider.\nazure-native:servicefabric/v20191101preview:ApplicationTypeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:ApplicationTypeVersion to guarantee forwards compatibility.")
