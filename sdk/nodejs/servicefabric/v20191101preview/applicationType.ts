...
export class ApplicationType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:servicefabric/v20191101preview:ApplicationType';
    ...
    constructor(name: string, args: ApplicationTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric:ApplicationType" }, { type: "azure-nextgen:servicefabric/latest:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20170701preview:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20190301:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20190301preview:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20190601preview:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20200301:ApplicationType" }] };
