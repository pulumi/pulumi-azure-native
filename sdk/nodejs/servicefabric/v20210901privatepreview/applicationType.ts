...
export class ApplicationType extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApplicationTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric/v20210901privatepreview:ApplicationType" }, { type: "azure-native:servicefabric/v20210101preview:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20210101preview:ApplicationType" }, { type: "azure-native:servicefabric/v20210501:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20210501:ApplicationType" }, { type: "azure-native:servicefabric/v20210701preview:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20210701preview:ApplicationType" }, { type: "azure-native:servicefabric/v20211101preview:ApplicationType" }, { type: "azure-nextgen:servicefabric/v20211101preview:ApplicationType" }] };
