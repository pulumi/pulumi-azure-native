...
export class ManagedClusterApplication extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedClusterApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicefabric/v20220101:ManagedClusterApplication" }, { type: "azure-native:servicefabric/v20221001preview:ManagedClusterApplication" }, { type: "azure-native:servicefabric/v20230201preview:ManagedClusterApplication" }, { type: "azure-native:servicefabric/v20230301preview:ManagedClusterApplication" }] };
