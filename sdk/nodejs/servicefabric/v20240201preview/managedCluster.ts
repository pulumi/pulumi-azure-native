...
export class ManagedCluster extends pulumi.CustomResource {
     ...
     */
    public readonly applicationTypeVersionsCleanupPolicy!: pulumi.Output<outputs.servicefabric.v20240201preview.ApplicationTypeVersionsCleanupPolicyResponse | undefined>;
    /**
     * Auxiliary subnets for the cluster.
     */
    public readonly auxiliarySubnets!: pulumi.Output<outputs.servicefabric.v20240201preview.SubnetResponse[] | undefined>;
    /**
     * The AAD authentication settings of the cluster.
     */
    public readonly azureActiveDirectory!: pulumi.Output<outputs.servicefabric.v20240201preview.AzureActiveDirectoryResponse | undefined>;
    /**
     ...
     */
    public readonly clients!: pulumi.Output<outputs.servicefabric.v20240201preview.ClientCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly fabricSettings!: pulumi.Output<outputs.servicefabric.v20240201preview.SettingsSectionDescriptionResponse[] | undefined>;
    /**
     ...
     */
    public readonly ipTags!: pulumi.Output<outputs.servicefabric.v20240201preview.IPTagResponse[] | undefined>;
    /**
     ...
     */
    public readonly loadBalancingRules!: pulumi.Output<outputs.servicefabric.v20240201preview.LoadBalancingRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceEndpoints!: pulumi.Output<outputs.servicefabric.v20240201preview.ServiceEndpointResponse[] | undefined>;
    /**
     * The sku of the managed cluster
     */
    public readonly sku!: pulumi.Output<outputs.servicefabric.v20240201preview.SkuResponse>;
    /**
     ...
     */
    public readonly upgradeDescription!: pulumi.Output<outputs.servicefabric.v20240201preview.ClusterUpgradePolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["upgradeDescription"] = args ? (args.upgradeDescription ? pulumi.output(args.upgradeDescription).apply(inputs.servicefabric.v20240201preview.clusterUpgradePolicyArgsProvideDefaults) : undefined) : undefined;
...
export interface ManagedClusterArgs {
     ...
     * List of add-on features to enable on the cluster.
     */
    addonFeatures?: pulumi.Input<pulumi.Input<string | enums.servicefabric.v20240201preview.ManagedClusterAddOnFeature>[]>;
    /**
     * VM admin user password.
     */
     ...
     * The policy used to clean up unused versions.
     */
    applicationTypeVersionsCleanupPolicy?: pulumi.Input<inputs.servicefabric.v20240201preview.ApplicationTypeVersionsCleanupPolicyArgs>;
    /**
     * Auxiliary subnets for the cluster.
     */
    auxiliarySubnets?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240201preview.SubnetArgs>[]>;
    /**
     * The AAD authentication settings of the cluster.
     */
    azureActiveDirectory?: pulumi.Input<inputs.servicefabric.v20240201preview.AzureActiveDirectoryArgs>;
    /**
     * The port used for client connections to the cluster.
     */
     ...
     * Client certificates that are allowed to manage the cluster.
     */
    clients?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240201preview.ClientCertificateArgs>[]>;
    /**
     * The Service Fabric runtime version of the cluster. This property is required when **clusterUpgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
     */
     ...
     * Indicates when new cluster runtime version upgrades will be applied after they are released. By default is Wave0. Only applies when **clusterUpgradeMode** is set to 'Automatic'.
     */
    clusterUpgradeCadence?: pulumi.Input<string | enums.servicefabric.v20240201preview.ClusterUpgradeCadence>;
    /**
     * The upgrade mode of the cluster when new Service Fabric runtime version is available.
     */
    clusterUpgradeMode?: pulumi.Input<string | enums.servicefabric.v20240201preview.ClusterUpgradeMode>;
    /**
     * Specify the resource id of a DDoS network protection plan that will be associated with the virtual network of the cluster.
     */
     ...
     * The list of custom fabric settings to configure the cluster.
     */
    fabricSettings?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240201preview.SettingsSectionDescriptionArgs>[]>;
    /**
     * The port used for HTTP connections to the cluster.
     */
     ...
     * The list of IP tags associated with the default public IP address of the cluster.
     */
    ipTags?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240201preview.IPTagArgs>[]>;
    /**
     * Load balancing rules that are applied to the public load balancer of the cluster.
     */
    loadBalancingRules?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240201preview.LoadBalancingRuleArgs>[]>;
    /**
     * Azure resource location.
     */
     ...
     * Service endpoints for subnets in the cluster.
     */
    serviceEndpoints?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20240201preview.ServiceEndpointArgs>[]>;
    /**
     * The sku of the managed cluster
     */
    sku: pulumi.Input<inputs.servicefabric.v20240201preview.SkuArgs>;
    /**
     * If specified, the node types for the cluster are created in this subnet instead of the default VNet. The **networkSecurityRules** specified for the cluster are also applied to this subnet. This setting cannot be changed once the cluster is created.
     */
     ...
     * The policy to use when upgrading the cluster.
     */
    upgradeDescription?: pulumi.Input<inputs.servicefabric.v20240201preview.ClusterUpgradePolicyArgs>;
    /**
     * For new clusters, this parameter indicates that it uses Bring your own VNet, but the subnet is specified at node type level; and for such clusters, the subnetId property is required for node types.
     */
     ...
     * Indicates the update mode for Cross Az clusters.
     */
    zonalUpdateMode?: pulumi.Input<string | enums.servicefabric.v20240201preview.ZonalUpdateMode>;
}
