...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:servicefabric/v20210101preview:ManagedClusterApplication":
                return new ManagedClusterApplication(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20210101preview:ManagedClusterApplicationType":
                return new ManagedClusterApplicationType(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20210101preview:ManagedClusterApplicationTypeVersion":
                return new ManagedClusterApplicationTypeVersion(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20210101preview:ManagedClusterService":
