...
export function getNodeType(args: GetNodeTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeTypeResult> {
    pulumi.log.warn("getNodeType is deprecated: azure-native:servicefabric/v20210101preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210901privatepreview:NodeType to guarantee forwards compatibility.")
