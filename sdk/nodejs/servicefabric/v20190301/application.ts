 ...
 *
 * const application = new azurerm.servicefabric.v20190301.Application("application", {
...
export class Application extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicefabric/latest:Application" }, { type: "azurerm:servicefabric/v20200301:Application" }] };
