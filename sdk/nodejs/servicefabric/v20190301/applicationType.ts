 ...
 *
 * const applicationType = new azurerm.servicefabric.v20190301.ApplicationType("applicationType", {
...
export class ApplicationType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabric/v20190301:ApplicationType';
    ...
    constructor(name: string, argsOrState?: ApplicationTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicefabric/latest:ApplicationType" }, { type: "azurerm:servicefabric/v20200301:ApplicationType" }] };
