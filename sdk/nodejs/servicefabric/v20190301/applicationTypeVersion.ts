 ...
 *
 * const applicationTypeVersion = new azurerm.servicefabric.v20190301.ApplicationTypeVersion("applicationTypeVersion", {
...
export class ApplicationTypeVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:servicefabric/v20190301:ApplicationTypeVersion';
    ...
    constructor(name: string, argsOrState?: ApplicationTypeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:servicefabric/latest:ApplicationTypeVersion" }, { type: "azurerm:servicefabric/v20200301:ApplicationTypeVersion" }] };
