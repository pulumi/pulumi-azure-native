...
export class Service extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric/v20170701preview:Service" }, { type: "azure-native:servicefabric:Service" }, { type: "azure-nextgen:servicefabric:Service" }, { type: "azure-native:servicefabric/latest:Service" }, { type: "azure-nextgen:servicefabric/latest:Service" }, { type: "azure-native:servicefabric/v20190301:Service" }, { type: "azure-nextgen:servicefabric/v20190301:Service" }, { type: "azure-native:servicefabric/v20190301preview:Service" }, { type: "azure-nextgen:servicefabric/v20190301preview:Service" }, { type: "azure-native:servicefabric/v20190601preview:Service" }, { type: "azure-nextgen:servicefabric/v20190601preview:Service" }, { type: "azure-native:servicefabric/v20191101preview:Service" }, { type: "azure-nextgen:servicefabric/v20191101preview:Service" }, { type: "azure-native:servicefabric/v20200301:Service" }, { type: "azure-nextgen:servicefabric/v20200301:Service" }, { type: "azure-native:servicefabric/v20201201preview:Service" }, { type: "azure-nextgen:servicefabric/v20201201preview:Service" }] };
...
export interface ServiceArgs {
     ...
     * Describes how the service is partitioned.
     */
    readonly partitionDescription?: pulumi.Input<inputs.servicefabric.v20170701preview.NamedPartitionSchemeDescription | inputs.servicefabric.v20170701preview.SingletonPartitionSchemeDescription | inputs.servicefabric.v20170701preview.UniformInt64RangePartitionSchemeDescription>;
    /**
     * The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: "NodeColor == blue)".
     */
