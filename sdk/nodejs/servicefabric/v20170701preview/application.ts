...
export class Application extends pulumi.CustomResource {
     ...
     */
    public readonly metrics!: pulumi.Output<outputs.servicefabric.v20170701preview.ApplicationMetricDescriptionResponse[] | undefined>;
    /**
     ...
     */
    public readonly upgradePolicy!: pulumi.Output<outputs.servicefabric.v20170701preview.ApplicationUpgradePolicyResponse | undefined>;
    ...
    constructor(name: string, args: ApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric/v20170701preview:Application" }, { type: "azure-native:servicefabric:Application" }, { type: "azure-nextgen:servicefabric:Application" }, { type: "azure-native:servicefabric/latest:Application" }, { type: "azure-nextgen:servicefabric/latest:Application" }, { type: "azure-native:servicefabric/v20190301:Application" }, { type: "azure-nextgen:servicefabric/v20190301:Application" }, { type: "azure-native:servicefabric/v20190301preview:Application" }, { type: "azure-nextgen:servicefabric/v20190301preview:Application" }, { type: "azure-native:servicefabric/v20190601preview:Application" }, { type: "azure-nextgen:servicefabric/v20190601preview:Application" }, { type: "azure-native:servicefabric/v20191101preview:Application" }, { type: "azure-nextgen:servicefabric/v20191101preview:Application" }, { type: "azure-native:servicefabric/v20200301:Application" }, { type: "azure-nextgen:servicefabric/v20200301:Application" }, { type: "azure-native:servicefabric/v20201201preview:Application" }, { type: "azure-nextgen:servicefabric/v20201201preview:Application" }] };
...
export interface ApplicationArgs {
     ...
     * List of application capacity metric description.
     */
    readonly metrics?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20170701preview.ApplicationMetricDescription>[]>;
    /**
     * The minimum number of nodes where Service Fabric will reserve capacity for this application. Note that this does not mean that the services of this application will be placed on all of those nodes. If this property is set to zero, no capacity will be reserved. The value of this property cannot be more than the value of the MaximumNodes property.
     */
     ...
     * Describes the policy for a monitored application upgrade.
     */
    readonly upgradePolicy?: pulumi.Input<inputs.servicefabric.v20170701preview.ApplicationUpgradePolicy>;
}
