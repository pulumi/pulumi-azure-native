...
export class ManagedClusterService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedClusterServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicefabric:ManagedClusterService" }, { type: "azure-native:servicefabric/v20220101:ManagedClusterService" }, { type: "azure-native:servicefabric/v20221001preview:ManagedClusterService" }, { type: "azure-native:servicefabric/v20230201preview:ManagedClusterService" }] };
