...
export class ApplicationTypeVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationTypeVersion {
        pulumi.log.warn("ApplicationTypeVersion is deprecated: azure-native:servicefabric/v20210701preview:ApplicationTypeVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:ApplicationTypeVersion to guarantee forwards compatibility.")
