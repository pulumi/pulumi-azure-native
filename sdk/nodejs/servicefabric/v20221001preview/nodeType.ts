...
export class NodeType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20221001preview:NodeType';
     ...
     */
    public readonly additionalDataDisks!: pulumi.Output<outputs.servicefabric.v20221001preview.VmssDataDiskResponse[] | undefined>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    public readonly applicationPorts!: pulumi.Output<outputs.servicefabric.v20221001preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly ephemeralPorts!: pulumi.Output<outputs.servicefabric.v20221001preview.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly frontendConfigurations!: pulumi.Output<outputs.servicefabric.v20221001preview.FrontendConfigurationResponse[] | undefined>;
    /**
     ...
     * The node type sku.
     */
    public readonly sku!: pulumi.Output<outputs.servicefabric.v20221001preview.NodeTypeSkuResponse | undefined>;
    /**
     ...
     */
    public readonly vmExtensions!: pulumi.Output<outputs.servicefabric.v20221001preview.VMSSExtensionResponse[] | undefined>;
    /**
     ...
     */
    public readonly vmManagedIdentity!: pulumi.Output<outputs.servicefabric.v20221001preview.VmManagedIdentityResponse | undefined>;
    /**
     * The secrets to install in the virtual machines.
     */
    public readonly vmSecrets!: pulumi.Output<outputs.servicefabric.v20221001preview.VaultSecretGroupResponse[] | undefined>;
    /**
...
export interface NodeTypeArgs {
     ...
     * Additional managed data disks.
     */
    additionalDataDisks?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20221001preview.VmssDataDiskArgs>[]>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    applicationPorts?: pulumi.Input<inputs.servicefabric.v20221001preview.EndpointRangeDescriptionArgs>;
    /**
     * The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much resource a node has.
     */
     ...
     * Managed data disk type. Specifies the storage account type for the managed disk
     */
    dataDiskType?: pulumi.Input<string | enums.servicefabric.v20221001preview.DiskType>;
    /**
     * Specifies whether the network interface is accelerated networking-enabled.
     */
     ...
     * The range of ephemeral ports that nodes in this node type should be configured with.
     */
    ephemeralPorts?: pulumi.Input<inputs.servicefabric.v20221001preview.EndpointRangeDescriptionArgs>;
    /**
     * Specifies the eviction policy for virtual machines in a SPOT node type. Default is Delete.
     */
    evictionPolicy?: pulumi.Input<string | enums.servicefabric.v20221001preview.EvictionPolicyType>;
    /**
     * Indicates the node type uses its own frontend configurations instead of the default one for the cluster. This setting can only be specified for non-primary node types and can not be added or removed after the node type is created.
     */
    frontendConfigurations?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20221001preview.FrontendConfigurationArgs>[]>;
    /**
     * Specifies the full host group resource Id. This property is used for deploying on azure dedicated hosts.
     */
     ...
     * The node type sku.
     */
    sku?: pulumi.Input<inputs.servicefabric.v20221001preview.NodeTypeSkuArgs>;
    /**
     * Indicates the time duration after which the platform will not try to restore the VMSS SPOT instances specified as ISO 8601.
     */
     ...
     * Set of extensions that should be installed onto the virtual machines.
     */
    vmExtensions?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20221001preview.VMSSExtensionArgs>[]>;
    /**
     * The offer type of the Azure Virtual Machines Marketplace image. For example, UbuntuServer or WindowsServer.
     */
     ...
     * Identities to assign to the virtual machine scale set under the node type.
     */
    vmManagedIdentity?: pulumi.Input<inputs.servicefabric.v20221001preview.VmManagedIdentityArgs>;
    /**
     * The secrets to install in the virtual machines.
     */
    vmSecrets?: pulumi.Input<pulumi.Input<inputs.servicefabric.v20221001preview.VaultSecretGroupArgs>[]>;
    /**
     * Specifies the actions to be performed on the vms before bootstrapping the service fabric runtime.
     */
    vmSetupActions?: pulumi.Input<pulumi.Input<string | enums.servicefabric.v20221001preview.VmSetupAction>[]>;
    /**
     * The size of virtual machines in the pool. All virtual machines in a pool are the same size. For example, Standard_D3.
     */
