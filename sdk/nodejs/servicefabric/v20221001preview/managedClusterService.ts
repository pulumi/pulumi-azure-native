...
export class ManagedClusterService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20221001preview:ManagedClusterService';
