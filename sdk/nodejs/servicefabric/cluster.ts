...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric:Cluster';
     ...
     */
    public /*out*/ readonly availableClusterVersions!: pulumi.Output<outputs.servicefabric.ClusterVersionDetailsResponse[]>;
    /**
     ...
     */
    public readonly certificate!: pulumi.Output<outputs.servicefabric.CertificateDescriptionResponse | undefined>;
    /**
     * Describes a list of server certificates referenced by common name that are used to secure the cluster.
     */
    public readonly certificateCommonNames!: pulumi.Output<outputs.servicefabric.ServerCertificateCommonNamesResponse | undefined>;
    /**
     * The list of client certificates referenced by common name that are allowed to manage the cluster.
     */
    public readonly clientCertificateCommonNames!: pulumi.Output<outputs.servicefabric.ClientCertificateCommonNameResponse[] | undefined>;
    /**
     * The list of client certificates referenced by thumbprint that are allowed to manage the cluster.
     */
    public readonly clientCertificateThumbprints!: pulumi.Output<outputs.servicefabric.ClientCertificateThumbprintResponse[] | undefined>;
    /**
     ...
     */
    public readonly diagnosticsStorageAccountConfig!: pulumi.Output<outputs.servicefabric.DiagnosticsStorageAccountConfigResponse | undefined>;
    /**
     * Azure resource etag.
     */
     ...
     */
    public readonly reverseProxyCertificate!: pulumi.Output<outputs.servicefabric.CertificateDescriptionResponse | undefined>;
    /**
     * Describes a list of server certificates referenced by common name that are used to secure the cluster.
     */
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:servicefabric:Cluster" }, { type: "azure-native:servicefabric/v20160901:Cluster" }, { type: "azure-nextgen:servicefabric/v20160901:Cluster" }, { type: "azure-native:servicefabric/v20170701preview:Cluster" }, { type: "azure-nextgen:servicefabric/v20170701preview:Cluster" }, { type: "azure-native:servicefabric/v20180201:Cluster" }, { type: "azure-nextgen:servicefabric/v20180201:Cluster" }, { type: "azure-native:servicefabric/v20190301:Cluster" }, { type: "azure-nextgen:servicefabric/v20190301:Cluster" }, { type: "azure-native:servicefabric/v20190301preview:Cluster" }, { type: "azure-nextgen:servicefabric/v20190301preview:Cluster" }, { type: "azure-native:servicefabric/v20190601preview:Cluster" }, { type: "azure-nextgen:servicefabric/v20190601preview:Cluster" }, { type: "azure-native:servicefabric/v20191101preview:Cluster" }, { type: "azure-nextgen:servicefabric/v20191101preview:Cluster" }, { type: "azure-native:servicefabric/v20200301:Cluster" }, { type: "azure-nextgen:servicefabric/v20200301:Cluster" }, { type: "azure-native:servicefabric/v20201201preview:Cluster" }, { type: "azure-nextgen:servicefabric/v20201201preview:Cluster" }, { type: "azure-native:servicefabric/v20210601:Cluster" }, { type: "azure-nextgen:servicefabric/v20210601:Cluster" }] };
...
export interface ClusterArgs {
     ...
     * The certificate to use for securing the cluster. The certificate provided will be used for node to node security within the cluster, SSL certificate for cluster management endpoint and default admin client.
     */
    certificate?: pulumi.Input<inputs.servicefabric.CertificateDescriptionArgs>;
    /**
     * Describes a list of server certificates referenced by common name that are used to secure the cluster.
     */
    certificateCommonNames?: pulumi.Input<inputs.servicefabric.ServerCertificateCommonNamesArgs>;
    /**
     * The list of client certificates referenced by common name that are allowed to manage the cluster.
     */
    clientCertificateCommonNames?: pulumi.Input<pulumi.Input<inputs.servicefabric.ClientCertificateCommonNameArgs>[]>;
    /**
     * The list of client certificates referenced by thumbprint that are allowed to manage the cluster.
     */
    clientCertificateThumbprints?: pulumi.Input<pulumi.Input<inputs.servicefabric.ClientCertificateThumbprintArgs>[]>;
    /**
     * The Service Fabric runtime version of the cluster. This property can only by set the user when **upgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
     */
     ...
     * The storage account information for storing Service Fabric diagnostic logs.
     */
    diagnosticsStorageAccountConfig?: pulumi.Input<inputs.servicefabric.DiagnosticsStorageAccountConfigArgs>;
    /**
     * Indicates if the event store service is enabled.
     */
     ...
     * The server certificate used by reverse proxy.
     */
    reverseProxyCertificate?: pulumi.Input<inputs.servicefabric.CertificateDescriptionArgs>;
    /**
     * Describes a list of server certificates referenced by common name that are used to secure the cluster.
     */
