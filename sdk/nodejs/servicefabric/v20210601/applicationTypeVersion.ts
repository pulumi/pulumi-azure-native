...
export class ApplicationTypeVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApplicationTypeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicefabric/v20200301:ApplicationTypeVersion" }, { type: "azure-native:servicefabric/v20201201preview:ApplicationTypeVersion" }] };
