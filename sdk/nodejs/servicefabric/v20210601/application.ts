 ...
 *
 * const application = new azure_native.servicefabric.v20210601.Application("application", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:servicefabric/v20210601:Application myCluster /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/resRg/providers/Microsoft.ServiceFabric/clusters/myCluster/applications/myApp 
 * ```
 */
export class Application extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["upgradePolicy"] = args ? (args.upgradePolicy ? pulumi.output(args.upgradePolicy).apply(inputs.servicefabric.v20210601.applicationUpgradePolicyArgsProvideDefaults) : undefined) : undefined;
