...
export function getFabricCapacity(args: GetFabricCapacityArgs, opts?: pulumi.InvokeOptions): Promise<GetFabricCapacityResult> {
    ...
    return pulumi.runtime.invoke("azure-native:fabric/v20250115preview:getFabricCapacity", {
...
export interface GetFabricCapacityResult {
     ...
     */
    readonly administration: outputs.fabric.v20250115preview.CapacityAdministrationResponse;
    /**
     ...
     * The SKU details
     */
    readonly sku: outputs.fabric.v20250115preview.RpSkuResponse;
    /**
     ...
     */
    readonly systemData: outputs.fabric.v20250115preview.SystemDataResponse;
    /**
     * Resource tags.
     */
...
export function getFabricCapacityOutput(args: GetFabricCapacityOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFabricCapacityResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:fabric/v20250115preview:getFabricCapacity", {
        "capacityName": args.capacityName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
