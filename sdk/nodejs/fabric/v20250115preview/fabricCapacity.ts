...
export class FabricCapacity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:fabric/v20250115preview:FabricCapacity';
     ...
     */
    public readonly administration!: pulumi.Output<outputs.fabric.v20250115preview.CapacityAdministrationResponse>;
    /**
     ...
     * The SKU details
     */
    public readonly sku!: pulumi.Output<outputs.fabric.v20250115preview.RpSkuResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.fabric.v20250115preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: FabricCapacityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:fabric:FabricCapacity" }, { type: "azure-native:fabric/v20231101:FabricCapacity" }] };
...
export interface FabricCapacityArgs {
     ...
     * The capacity administration
     */
    administration: pulumi.Input<inputs.fabric.v20250115preview.CapacityAdministrationArgs>;
    /**
     ...
     * The SKU details
     */
    sku: pulumi.Input<inputs.fabric.v20250115preview.RpSkuArgs>;
    /**
     * Resource tags.
     */
