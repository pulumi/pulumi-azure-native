...
export class FabricCapacity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:fabric/v20231101:FabricCapacity';
     ...
     */
    public readonly administration!: pulumi.Output<outputs.fabric.v20231101.CapacityAdministrationResponse>;
    /**
     ...
     * The SKU details
     */
    public readonly sku!: pulumi.Output<outputs.fabric.v20231101.RpSkuResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.fabric.v20231101.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: FabricCapacityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:fabric:FabricCapacity" }, { type: "azure-native:fabric/v20250115preview:FabricCapacity" }] };
