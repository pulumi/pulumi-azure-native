 ...
 *
 * @deprecated azure-native:synapse/v20210501:WorkspaceSqlAadAdmin is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:WorkspaceSqlAadAdmin to guarantee forwards compatibility.
 */
export class WorkspaceSqlAadAdmin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceSqlAadAdmin {
        pulumi.log.warn("WorkspaceSqlAadAdmin is deprecated: azure-native:synapse/v20210501:WorkspaceSqlAadAdmin is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:WorkspaceSqlAadAdmin to guarantee forwards compatibility.")
