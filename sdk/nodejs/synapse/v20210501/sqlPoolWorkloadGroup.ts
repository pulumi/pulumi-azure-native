...
export class SqlPoolWorkloadGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlPoolWorkloadGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse:SqlPoolWorkloadGroup" }, { type: "azure-native:synapse/v20190601preview:SqlPoolWorkloadGroup" }, { type: "azure-native:synapse/v20201201:SqlPoolWorkloadGroup" }, { type: "azure-native:synapse/v20210301:SqlPoolWorkloadGroup" }, { type: "azure-native:synapse/v20210401preview:SqlPoolWorkloadGroup" }, { type: "azure-native:synapse/v20210601:SqlPoolWorkloadGroup" }, { type: "azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup" }, { type: "azure-native:synapse/v20230501:SqlPoolWorkloadGroup" }] };
