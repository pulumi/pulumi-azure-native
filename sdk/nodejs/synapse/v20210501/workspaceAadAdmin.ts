 ...
 *
 * @deprecated azure-native:synapse/v20210501:WorkspaceAadAdmin is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:WorkspaceAadAdmin to guarantee forwards compatibility.
 */
export class WorkspaceAadAdmin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceAadAdmin {
        pulumi.log.warn("WorkspaceAadAdmin is deprecated: azure-native:synapse/v20210501:WorkspaceAadAdmin is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:WorkspaceAadAdmin to guarantee forwards compatibility.")
