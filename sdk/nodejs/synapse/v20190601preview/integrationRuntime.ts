...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20190601preview:IntegrationRuntime';
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20190601preview:IntegrationRuntime" }, { type: "azure-native:synapse:IntegrationRuntime" }, { type: "azure-nextgen:synapse:IntegrationRuntime" }, { type: "azure-native:synapse/latest:IntegrationRuntime" }, { type: "azure-nextgen:synapse/latest:IntegrationRuntime" }, { type: "azure-native:synapse/v20201201:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20201201:IntegrationRuntime" }, { type: "azure-native:synapse/v20210301:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20210301:IntegrationRuntime" }] };
