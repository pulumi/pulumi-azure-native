...
export class PrivateLinkHub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateLinkHub {
        return new PrivateLinkHub(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: PrivateLinkHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!(opts && opts.id)) {
            ...
            if (!args || args.privateLinkHubName === undefined) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/preview:PrivateLinkHub" }] };
