...
export class BigDataPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BigDataPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:BigDataPool" }, { type: "azure-nextgen:synapse/latest:BigDataPool" }, { type: "azure-nextgen:synapse/v20201201:BigDataPool" }] };
