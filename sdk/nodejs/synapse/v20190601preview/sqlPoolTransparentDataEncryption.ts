...
export class SqlPoolTransparentDataEncryption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:synapse/v20190601preview:SqlPoolTransparentDataEncryption';
    ...
    constructor(name: string, args: SqlPoolTransparentDataEncryptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:SqlPoolTransparentDataEncryption" }, { type: "azure-nextgen:synapse/latest:SqlPoolTransparentDataEncryption" }, { type: "azure-nextgen:synapse/v20201201:SqlPoolTransparentDataEncryption" }] };
