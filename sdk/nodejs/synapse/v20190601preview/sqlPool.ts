...
export class SqlPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/latest:SqlPool" }, { type: "azure-nextgen:synapse/v20200401preview:SqlPool" }, { type: "azure-nextgen:synapse/v20201201:SqlPool" }] };
