...
export class SqlPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:synapse/v20190601preview:SqlPool';
    ...
    constructor(name: string, argsOrState?: SqlPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/preview:SqlPool" }, { type: "azurerm:synapse/v20200401preview:SqlPool" }] };
