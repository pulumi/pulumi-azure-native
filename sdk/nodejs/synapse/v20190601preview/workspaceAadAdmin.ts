...
export class WorkspaceAadAdmin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:synapse/v20190601preview:WorkspaceAadAdmin';
    ...
    constructor(name: string, argsOrState?: WorkspaceAadAdminArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/preview:WorkspaceAadAdmin" }] };
