...
export class WorkspaceAadAdmin extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceAadAdminArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:WorkspaceAadAdmin" }, { type: "azure-nextgen:synapse/latest:WorkspaceAadAdmin" }, { type: "azure-nextgen:synapse/v20201201:WorkspaceAadAdmin" }] };
