...
export class AttachedDatabaseConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse:AttachedDatabaseConfiguration';
    ...
    constructor(name: string, args: AttachedDatabaseConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:AttachedDatabaseConfiguration" }, { type: "azure-native:synapse/v20210601preview:AttachedDatabaseConfiguration" }, { type: "azure-nextgen:synapse/v20210601preview:AttachedDatabaseConfiguration" }] };
