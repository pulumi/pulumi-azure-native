...
export class DataConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse:DataConnection';
    ...
    constructor(name: string, args: DataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:DataConnection" }, { type: "azure-native:synapse/v20210401preview:DataConnection" }, { type: "azure-nextgen:synapse/v20210401preview:DataConnection" }, { type: "azure-native:synapse/v20210601preview:DataConnection" }, { type: "azure-nextgen:synapse/v20210601preview:DataConnection" }] };
...
export interface DataConnectionArgs {
     ...
     * Kind of the endpoint for the data connection
     */
    kind: pulumi.Input<string | enums.synapse.DataConnectionKind>;
    /**
