...
export class SqlPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse/latest:SqlPool" }, { type: "azure-nextgen:synapse/latest:SqlPool" }, { type: "azure-native:synapse/v20190601preview:SqlPool" }, { type: "azure-nextgen:synapse/v20190601preview:SqlPool" }, { type: "azure-native:synapse/v20200401preview:SqlPool" }, { type: "azure-nextgen:synapse/v20200401preview:SqlPool" }, { type: "azure-native:synapse/v20201201:SqlPool" }, { type: "azure-nextgen:synapse/v20201201:SqlPool" }] };
