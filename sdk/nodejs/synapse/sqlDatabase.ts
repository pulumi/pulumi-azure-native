...
export class SqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse:SqlDatabase';
    ...
    constructor(name: string, args: SqlDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:SqlDatabase" }, { type: "azure-native:synapse/v20200401preview:SqlDatabase" }, { type: "azure-nextgen:synapse/v20200401preview:SqlDatabase" }] };
