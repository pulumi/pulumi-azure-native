 ...
 *
 * @deprecated azure-native:synapse/v20210601:SqlPool is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:SqlPool to guarantee forwards compatibility.
 */
export class SqlPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlPool {
        pulumi.log.warn("SqlPool is deprecated: azure-native:synapse/v20210601:SqlPool is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:SqlPool to guarantee forwards compatibility.")
