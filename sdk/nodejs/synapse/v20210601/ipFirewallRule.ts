 ...
 * IP firewall rule
 *
 * @deprecated azure-native:synapse/v20210601:IpFirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:IpFirewallRule to guarantee forwards compatibility.
 */
export class IpFirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IpFirewallRule {
        pulumi.log.warn("IpFirewallRule is deprecated: azure-native:synapse/v20210601:IpFirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:IpFirewallRule to guarantee forwards compatibility.")
