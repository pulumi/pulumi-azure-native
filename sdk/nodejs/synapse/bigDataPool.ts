...
export class BigDataPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BigDataPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:BigDataPool" }, { type: "azure-native:synapse/latest:BigDataPool" }, { type: "azure-nextgen:synapse/latest:BigDataPool" }, { type: "azure-native:synapse/v20190601preview:BigDataPool" }, { type: "azure-nextgen:synapse/v20190601preview:BigDataPool" }, { type: "azure-native:synapse/v20201201:BigDataPool" }, { type: "azure-nextgen:synapse/v20201201:BigDataPool" }, { type: "azure-native:synapse/v20210301:BigDataPool" }, { type: "azure-nextgen:synapse/v20210301:BigDataPool" }] };
