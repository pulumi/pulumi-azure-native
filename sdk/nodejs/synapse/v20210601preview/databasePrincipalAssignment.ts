...
export class DatabasePrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210601preview:DatabasePrincipalAssignment';
    ...
    constructor(name: string, args: DatabasePrincipalAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210601preview:DatabasePrincipalAssignment" }, { type: "azure-native:synapse:DatabasePrincipalAssignment" }, { type: "azure-nextgen:synapse:DatabasePrincipalAssignment" }, { type: "azure-native:synapse/v20210401preview:DatabasePrincipalAssignment" }, { type: "azure-nextgen:synapse/v20210401preview:DatabasePrincipalAssignment" }] };
