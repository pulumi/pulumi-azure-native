 ...
 *
 * const kustoPoolPrincipalAssignment = new azure_native.synapse.v20210601preview.KustoPoolPrincipalAssignment("kustoPoolPrincipalAssignment", {
...
export class KustoPoolPrincipalAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KustoPoolPrincipalAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse/v20210401preview:KustoPoolPrincipalAssignment" }] };
