 ...
 *
 * const readOnlyFollowingDatabase = new azure_native.synapse.v20210601preview.ReadOnlyFollowingDatabase("readOnlyFollowingDatabase", {
...
export class ReadOnlyFollowingDatabase extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReadOnlyFollowingDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse/v20210401preview:ReadOnlyFollowingDatabase" }] };
