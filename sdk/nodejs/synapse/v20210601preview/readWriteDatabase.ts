 ...
 *
 * const readWriteDatabase = new azure_native.synapse.v20210601preview.ReadWriteDatabase("readWriteDatabase", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:synapse/v20210601preview:ReadWriteDatabase KustoClusterRPTest4/KustoDatabase8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Synapse/workspaces/synapseWorkspaceName/kustopools/KustoClusterRPTest4/Databases/KustoDatabase8 
 * ```
 */
export class ReadWriteDatabase extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ReadWriteDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse/v20210401preview:ReadWriteDatabase" }] };
