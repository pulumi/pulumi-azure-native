 ...
 *
 * const iotHubDataConnection = new azure_native.synapse.v20210601preview.IotHubDataConnection("iotHubDataConnection", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:synapse/v20210601preview:IotHubDataConnection KustoClusterRPTest4/KustoDatabase8/DataConnections8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Synapse/workspaces/synapseWorkspaceName/kustopools/KustoClusterRPTest4/Databases/KustoDatabase8/DataConnections/DataConnections8 
 * ```
 */
export class IotHubDataConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotHubDataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse/v20210401preview:IotHubDataConnection" }] };
