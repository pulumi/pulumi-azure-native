...
export class IotHubDataConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotHubDataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210601preview:IotHubDataConnection" }, { type: "azure-native:synapse:IotHubDataConnection" }, { type: "azure-nextgen:synapse:IotHubDataConnection" }, { type: "azure-native:synapse/v20210401preview:IotHubDataConnection" }, { type: "azure-nextgen:synapse/v20210401preview:IotHubDataConnection" }] };
