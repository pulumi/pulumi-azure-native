...
export interface EventGridDataConnectionArgs {
     ...
     * The name of blob storage event type to process.
     */
    readonly blobStorageEventType?: pulumi.Input<string | enums.synapse.BlobStorageEventType>;
    /**
     * The event hub consumer group.
     */
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    readonly dataFormat?: pulumi.Input<string | enums.synapse.EventGridDataFormat>;
    /**
