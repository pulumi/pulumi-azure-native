...
export function getIntegrationRuntime(args: GetIntegrationRuntimeArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationRuntimeResult> {
    ...
    return pulumi.runtime.invoke("azurerm:synapse/preview:getIntegrationRuntime", {
...
export interface GetIntegrationRuntimeResult {
     ...
     */
    readonly properties: outputs.synapse.preview.ManagedIntegrationRuntimeResponse | outputs.synapse.preview.SelfHostedIntegrationRuntimeResponse;
    /**
