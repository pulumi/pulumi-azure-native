...
export class WorkspaceAadAdmin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceAadAdmin {
        return new WorkspaceAadAdmin(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:synapse/preview:WorkspaceAadAdmin';
    ...
    constructor(name: string, argsOrState?: WorkspaceAadAdminArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/v20190601preview:WorkspaceAadAdmin" }] };
