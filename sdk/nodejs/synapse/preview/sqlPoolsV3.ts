...
export class SqlPoolsV3 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:synapse/preview:SqlPoolsV3';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.synapse.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SqlPoolsV3Args, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/v20190601preview:SqlPoolsV3" }, { type: "azurerm:synapse/v20200401preview:SqlPoolsV3" }] };
...
export interface SqlPoolsV3Args {
     ...
     * The sql pool SKU. The list of SKUs may vary by region and support offer.
     */
    readonly sku?: pulumi.Input<inputs.synapse.preview.Sku>;
    /**
