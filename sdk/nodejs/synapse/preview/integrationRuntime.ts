...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:synapse/preview:IntegrationRuntime';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.synapse.preview.ManagedIntegrationRuntimeResponse | outputs.synapse.preview.SelfHostedIntegrationRuntimeResponse>;
    /**
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/v20190601preview:IntegrationRuntime" }] };
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    readonly properties: pulumi.Input<inputs.synapse.preview.ManagedIntegrationRuntime | inputs.synapse.preview.SelfHostedIntegrationRuntime>;
    /**
