...
export class IntegrationRuntime extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.synapse.preview.IntegrationRuntimeResponse>;
    /**
     * The resource type.
     */
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    readonly properties: pulumi.Input<inputs.synapse.preview.IntegrationRuntime>;
    /**
