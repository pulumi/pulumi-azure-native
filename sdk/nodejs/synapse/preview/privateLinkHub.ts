...
export class PrivateLinkHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:synapse/preview:PrivateLinkHub';
    ...
    constructor(name: string, args: PrivateLinkHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/v20190601preview:PrivateLinkHub" }] };
