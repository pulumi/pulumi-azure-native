...
export class SqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:synapse/preview:SqlDatabase';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.synapse.preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, argsOrState?: SqlDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/v20200401preview:SqlDatabase" }] };
