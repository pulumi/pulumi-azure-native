...
export class Workspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:synapse/preview:Workspace';
     ...
     */
    public readonly defaultDataLakeStorage!: pulumi.Output<outputs.synapse.preview.DataLakeStorageAccountDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.synapse.preview.ManagedIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly privateEndpointConnections!: pulumi.Output<outputs.synapse.preview.PrivateEndpointConnectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkProfile!: pulumi.Output<outputs.synapse.preview.VirtualNetworkProfileResponse | undefined>;
    ...
    constructor(name: string, argsOrState?: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:synapse/v20190601preview:Workspace" }] };
...
export interface WorkspaceArgs {
     ...
     * Workspace default data lake storage account details
     */
    readonly defaultDataLakeStorage?: pulumi.Input<inputs.synapse.preview.DataLakeStorageAccountDetails>;
    /**
     * Identity of the workspace
     */
    readonly identity?: pulumi.Input<inputs.synapse.preview.ManagedIdentity>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Private endpoint connections to the workspace
     */
    readonly privateEndpointConnections?: pulumi.Input<pulumi.Input<inputs.synapse.preview.PrivateEndpointConnection>[]>;
    /**
     ...
     * Virtual Network profile
     */
    readonly virtualNetworkProfile?: pulumi.Input<inputs.synapse.preview.VirtualNetworkProfile>;
    /**
