...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20230501:IntegrationRuntime';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.synapse.v20230501.ManagedIntegrationRuntimeResponse | outputs.synapse.v20230501.SelfHostedIntegrationRuntimeResponse>;
    /**
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    properties: pulumi.Input<inputs.synapse.v20230501.ManagedIntegrationRuntimeArgs | inputs.synapse.v20230501.SelfHostedIntegrationRuntimeArgs>;
    /**
