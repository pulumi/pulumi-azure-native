...
export class SqlPoolTransparentDataEncryption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20230501:SqlPoolTransparentDataEncryption';
...
export interface SqlPoolTransparentDataEncryptionArgs {
     ...
     * The status of the database transparent data encryption.
     */
    status?: pulumi.Input<string | enums.synapse.v20230501.TransparentDataEncryptionStatus>;
    /**
