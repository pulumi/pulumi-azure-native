...
export function getIntegrationRuntimeStatus(args: GetIntegrationRuntimeStatusArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationRuntimeStatusResult> {
    ...
    return pulumi.runtime.invoke("azure-native:synapse/v20230501:getIntegrationRuntimeStatus", {
...
export interface GetIntegrationRuntimeStatusResult {
     ...
     */
    readonly properties: outputs.synapse.v20230501.ManagedIntegrationRuntimeStatusResponse | outputs.synapse.v20230501.SelfHostedIntegrationRuntimeStatusResponse;
}
/**
 * Get the integration runtime status
 */
