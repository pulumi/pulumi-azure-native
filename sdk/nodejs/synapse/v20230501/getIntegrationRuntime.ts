...
export function getIntegrationRuntime(args: GetIntegrationRuntimeArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationRuntimeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:synapse/v20230501:getIntegrationRuntime", {
...
export interface GetIntegrationRuntimeResult {
     ...
     */
    readonly properties: outputs.synapse.v20230501.ManagedIntegrationRuntimeResponse | outputs.synapse.v20230501.SelfHostedIntegrationRuntimeResponse;
    /**
