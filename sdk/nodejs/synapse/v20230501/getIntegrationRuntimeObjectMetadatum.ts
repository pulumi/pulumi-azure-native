...
export function getIntegrationRuntimeObjectMetadatum(args: GetIntegrationRuntimeObjectMetadatumArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationRuntimeObjectMetadatumResult> {
    ...
    return pulumi.runtime.invoke("azure-native:synapse/v20230501:getIntegrationRuntimeObjectMetadatum", {
...
export interface GetIntegrationRuntimeObjectMetadatumResult {
     ...
     */
    readonly value?: (outputs.synapse.v20230501.SsisEnvironmentResponse | outputs.synapse.v20230501.SsisFolderResponse | outputs.synapse.v20230501.SsisPackageResponse | outputs.synapse.v20230501.SsisProjectResponse)[];
}
/**
 * Get object metadata from an integration runtime
 */
