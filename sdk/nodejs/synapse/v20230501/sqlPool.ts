...
export class SqlPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20230501:SqlPool';
     ...
     * SQL pool SKU
     */
    public readonly sku!: pulumi.Output<outputs.synapse.v20230501.SkuResponse | undefined>;
    /**
...
export interface SqlPoolArgs {
     ...
     */
    createMode?: pulumi.Input<string | enums.synapse.v20230501.CreateMode>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * SQL pool SKU
     */
    sku?: pulumi.Input<inputs.synapse.v20230501.SkuArgs>;
    /**
     * Specifies the time that the sql pool was deleted
     */
     ...
     * The storage account type used to store backups for this sql pool.
     */
    storageAccountType?: pulumi.Input<string | enums.synapse.v20230501.StorageAccountType>;
    /**
     * Resource tags.
     */
