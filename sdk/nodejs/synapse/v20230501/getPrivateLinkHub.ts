...
export function getPrivateLinkHub(args: GetPrivateLinkHubArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateLinkHubResult> {
    ...
    return pulumi.runtime.invoke("azure-native:synapse/v20230501:getPrivateLinkHub", {
...
export interface GetPrivateLinkHubResult {
     ...
     */
    readonly privateEndpointConnections: outputs.synapse.v20230501.PrivateEndpointConnectionForPrivateLinkHubBasicResponse[];
    /**
