...
// Export enums:
export * from "../../types/enums/synapse/v20230501";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:synapse/v20230501:BigDataPool":
                return new BigDataPool(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:IntegrationRuntime":
                return new IntegrationRuntime(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:IpFirewallRule":
                return new IpFirewallRule(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:Key":
                return new Key(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:PrivateLinkHub":
                return new PrivateLinkHub(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:SqlPool":
                return new SqlPool(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:SqlPoolSensitivityLabel":
                return new SqlPoolSensitivityLabel(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:SqlPoolTransparentDataEncryption":
                return new SqlPoolTransparentDataEncryption(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:SqlPoolVulnerabilityAssessment":
                return new SqlPoolVulnerabilityAssessment(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:SqlPoolVulnerabilityAssessmentRuleBaseline":
                return new SqlPoolVulnerabilityAssessmentRuleBaseline(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:SqlPoolWorkloadClassifier":
                return new SqlPoolWorkloadClassifier(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:SqlPoolWorkloadGroup":
                return new SqlPoolWorkloadGroup(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:Workspace":
                return new Workspace(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:WorkspaceAadAdmin":
                return new WorkspaceAadAdmin(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:WorkspaceManagedSqlServerVulnerabilityAssessment":
                return new WorkspaceManagedSqlServerVulnerabilityAssessment(name, <any>undefined, { urn })
            case "azure-native:synapse/v20230501:WorkspaceSqlAadAdmin":
...
pulumi.runtime.registerResourceModule("azure-native", "synapse/v20230501", _module)
