...
export class SqlPoolWorkloadClassifier extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlPoolWorkloadClassifierArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse:SqlPoolWorkloadClassifier" }, { type: "azure-nextgen:synapse:SqlPoolWorkloadClassifier" }, { type: "azure-native:synapse/latest:SqlPoolWorkloadClassifier" }, { type: "azure-nextgen:synapse/latest:SqlPoolWorkloadClassifier" }, { type: "azure-native:synapse/v20190601preview:SqlPoolWorkloadClassifier" }, { type: "azure-nextgen:synapse/v20190601preview:SqlPoolWorkloadClassifier" }] };
