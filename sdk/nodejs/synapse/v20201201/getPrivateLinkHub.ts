...
export function getPrivateLinkHub(args: GetPrivateLinkHubArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateLinkHubResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:synapse/v20201201:getPrivateLinkHub", {
...
export interface GetPrivateLinkHubResult {
     ...
     */
    readonly privateEndpointConnections: outputs.synapse.v20201201.PrivateEndpointConnectionForPrivateLinkHubBasicInvokeResponse[];
    /**
