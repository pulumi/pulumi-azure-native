...
export class PrivateLinkHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:synapse/v20201201:PrivateLinkHub';
    ...
    constructor(name: string, args: PrivateLinkHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20190601preview:PrivateLinkHub" }] };
