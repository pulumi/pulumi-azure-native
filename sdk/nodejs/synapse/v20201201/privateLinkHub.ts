...
export class PrivateLinkHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20201201:PrivateLinkHub';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.synapse.v20201201.PrivateEndpointConnectionForPrivateLinkHubBasicResponse[]>;
    /**
    ...
    constructor(name: string, args: PrivateLinkHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20201201:PrivateLinkHub" }, { type: "azure-native:synapse:PrivateLinkHub" }, { type: "azure-nextgen:synapse:PrivateLinkHub" }, { type: "azure-native:synapse/latest:PrivateLinkHub" }, { type: "azure-nextgen:synapse/latest:PrivateLinkHub" }, { type: "azure-native:synapse/v20190601preview:PrivateLinkHub" }, { type: "azure-nextgen:synapse/v20190601preview:PrivateLinkHub" }, { type: "azure-native:synapse/v20210301:PrivateLinkHub" }, { type: "azure-nextgen:synapse/v20210301:PrivateLinkHub" }] };
