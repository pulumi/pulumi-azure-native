...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:synapse/v20201201:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:PrivateEndpointConnection" }, { type: "azure-nextgen:synapse/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:synapse/v20190601preview:PrivateEndpointConnection" }] };
