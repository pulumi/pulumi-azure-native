...
export class Workspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse:Workspace" }, { type: "azure-nextgen:synapse:Workspace" }, { type: "azure-native:synapse/latest:Workspace" }, { type: "azure-nextgen:synapse/latest:Workspace" }, { type: "azure-native:synapse/v20190601preview:Workspace" }, { type: "azure-nextgen:synapse/v20190601preview:Workspace" }] };
