...
export class SqlPoolSensitivityLabel extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlPoolSensitivityLabelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:SqlPoolSensitivityLabel" }, { type: "azure-nextgen:synapse/latest:SqlPoolSensitivityLabel" }, { type: "azure-nextgen:synapse/v20190601preview:SqlPoolSensitivityLabel" }] };
