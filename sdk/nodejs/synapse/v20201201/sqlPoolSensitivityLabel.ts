...
export class SqlPoolSensitivityLabel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20201201:SqlPoolSensitivityLabel';
    ...
    constructor(name: string, args: SqlPoolSensitivityLabelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20201201:SqlPoolSensitivityLabel" }, { type: "azure-native:synapse:SqlPoolSensitivityLabel" }, { type: "azure-nextgen:synapse:SqlPoolSensitivityLabel" }, { type: "azure-native:synapse/latest:SqlPoolSensitivityLabel" }, { type: "azure-nextgen:synapse/latest:SqlPoolSensitivityLabel" }, { type: "azure-native:synapse/v20190601preview:SqlPoolSensitivityLabel" }, { type: "azure-nextgen:synapse/v20190601preview:SqlPoolSensitivityLabel" }, { type: "azure-native:synapse/v20210301:SqlPoolSensitivityLabel" }, { type: "azure-nextgen:synapse/v20210301:SqlPoolSensitivityLabel" }] };
