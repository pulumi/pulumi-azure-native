...
export class SqlPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:synapse/v20201201:SqlPool';
    ...
    constructor(name: string, args: SqlPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:SqlPool" }, { type: "azure-nextgen:synapse/latest:SqlPool" }, { type: "azure-nextgen:synapse/v20190601preview:SqlPool" }, { type: "azure-nextgen:synapse/v20200401preview:SqlPool" }] };
