...
export class SqlPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20201201:SqlPool';
     ...
     * SQL pool SKU
     */
    public readonly sku!: pulumi.Output<outputs.synapse.v20201201.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SqlPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20201201:SqlPool" }, { type: "azure-native:synapse:SqlPool" }, { type: "azure-nextgen:synapse:SqlPool" }, { type: "azure-native:synapse/latest:SqlPool" }, { type: "azure-nextgen:synapse/latest:SqlPool" }, { type: "azure-native:synapse/v20190601preview:SqlPool" }, { type: "azure-nextgen:synapse/v20190601preview:SqlPool" }, { type: "azure-native:synapse/v20200401preview:SqlPool" }, { type: "azure-nextgen:synapse/v20200401preview:SqlPool" }, { type: "azure-native:synapse/v20210301:SqlPool" }, { type: "azure-nextgen:synapse/v20210301:SqlPool" }] };
...
export interface SqlPoolArgs {
     ...
     * SQL pool SKU
     */
    readonly sku?: pulumi.Input<inputs.synapse.v20201201.Sku>;
    /**
     * Source database to create from
     */
