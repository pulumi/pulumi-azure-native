...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:IntegrationRuntime" }, { type: "azure-native:synapse/v20190601preview:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20190601preview:IntegrationRuntime" }, { type: "azure-native:synapse/v20201201:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20201201:IntegrationRuntime" }, { type: "azure-native:synapse/v20210301:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20210301:IntegrationRuntime" }] };
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    readonly properties: pulumi.Input<inputs.synapse.ManagedIntegrationRuntimeArgs | inputs.synapse.SelfHostedIntegrationRuntimeArgs>;
    /**
