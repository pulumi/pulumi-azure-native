...
export class WorkspaceSqlAadAdmin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:synapse:WorkspaceSqlAadAdmin';
    ...
    constructor(name: string, args: WorkspaceSqlAadAdminArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/latest:WorkspaceSqlAadAdmin" }, { type: "azure-nextgen:synapse/v20190601preview:WorkspaceSqlAadAdmin" }, { type: "azure-nextgen:synapse/v20201201:WorkspaceSqlAadAdmin" }] };
