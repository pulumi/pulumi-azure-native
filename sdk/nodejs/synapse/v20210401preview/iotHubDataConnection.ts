 ...
 *
 * const iotHubDataConnection = new azure_native.synapse.v20210401preview.IotHubDataConnection("iotHubDataConnection", {
...
export class IotHubDataConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotHubDataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse/v20210601preview:IotHubDataConnection" }] };
