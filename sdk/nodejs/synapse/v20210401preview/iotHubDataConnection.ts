...
export class IotHubDataConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IotHubDataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210401preview:IotHubDataConnection" }, { type: "azure-native:synapse:IotHubDataConnection" }, { type: "azure-nextgen:synapse:IotHubDataConnection" }] };
...
export interface IotHubDataConnectionArgs {
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    readonly dataFormat?: pulumi.Input<string | enums.synapse.v20210401preview.IotHubDataFormat>;
    /**
