...
export class IotHubDataConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IotHubDataConnection {
        pulumi.log.warn("IotHubDataConnection is deprecated: azure-native:synapse/v20210401preview:IotHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:IotHubDataConnection to guarantee forwards compatibility.")
