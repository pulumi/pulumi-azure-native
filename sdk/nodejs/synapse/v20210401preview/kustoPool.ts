...
export class KustoPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KustoPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse/v20210401preview:kustoPool" }, { type: "azure-native:synapse/v20210601preview:KustoPool" }, { type: "azure-native:synapse/v20210601preview:kustoPool" }] };
