 ...
 *
 * const kustoPool = new azure_native.synapse.v20210401preview.KustoPool("kustoPool", {
...
export class KustoPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KustoPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse/v20210601preview:kustoPool" }] };
