...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210401preview:Database';
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210401preview:Database" }, { type: "azure-native:synapse:Database" }, { type: "azure-nextgen:synapse:Database" }] };
...
export interface DatabaseArgs {
     ...
     * Kind of the database
     */
    readonly kind: pulumi.Input<string | enums.synapse.v20210401preview.Kind>;
    /**
