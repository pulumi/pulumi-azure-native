...
export class EventGridDataConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EventGridDataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210401preview:EventGridDataConnection" }, { type: "azure-native:synapse:EventGridDataConnection" }, { type: "azure-nextgen:synapse:EventGridDataConnection" }] };
...
export interface EventGridDataConnectionArgs {
     ...
     * The name of blob storage event type to process.
     */
    readonly blobStorageEventType?: pulumi.Input<string | enums.synapse.v20210401preview.BlobStorageEventType>;
    /**
     * The event hub consumer group.
     */
     ...
     * The data format of the message. Optionally the data format can be added to each message.
     */
    readonly dataFormat?: pulumi.Input<string | enums.synapse.v20210401preview.EventGridDataFormat>;
    /**
