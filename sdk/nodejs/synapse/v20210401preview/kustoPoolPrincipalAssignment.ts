...
export class KustoPoolPrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210401preview:KustoPoolPrincipalAssignment';
    ...
    constructor(name: string, args: KustoPoolPrincipalAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210401preview:KustoPoolPrincipalAssignment" }, { type: "azure-native:synapse:KustoPoolPrincipalAssignment" }, { type: "azure-nextgen:synapse:KustoPoolPrincipalAssignment" }, { type: "azure-native:synapse/v20210601preview:KustoPoolPrincipalAssignment" }, { type: "azure-nextgen:synapse/v20210601preview:KustoPoolPrincipalAssignment" }] };
...
export interface KustoPoolPrincipalAssignmentArgs {
     ...
     * Principal type.
     */
    principalType: pulumi.Input<string | enums.synapse.v20210401preview.PrincipalType>;
    /**
     ...
     * Cluster principal role.
     */
    role: pulumi.Input<string | enums.synapse.v20210401preview.ClusterPrincipalRole>;
    /**
     * The tenant id of the principal
     */
