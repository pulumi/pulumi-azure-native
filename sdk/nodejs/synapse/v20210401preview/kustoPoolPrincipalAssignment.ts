...
export class KustoPoolPrincipalAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: KustoPoolPrincipalAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210401preview:KustoPoolPrincipalAssignment" }, { type: "azure-native:synapse:KustoPoolPrincipalAssignment" }, { type: "azure-nextgen:synapse:KustoPoolPrincipalAssignment" }] };
...
export interface KustoPoolPrincipalAssignmentArgs {
     ...
     * Principal type.
     */
    readonly principalType: pulumi.Input<string | enums.synapse.v20210401preview.PrincipalType>;
    /**
     ...
     * Cluster principal role.
     */
    readonly role: pulumi.Input<string | enums.synapse.v20210401preview.ClusterPrincipalRole>;
    /**
     * The tenant id of the principal
     */
