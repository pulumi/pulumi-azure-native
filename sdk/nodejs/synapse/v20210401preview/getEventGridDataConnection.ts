 ...
 */
/** @deprecated azure-native:synapse/v20210401preview:EventGridDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:EventGridDataConnection to guarantee forwards compatibility. */
export function getEventGridDataConnection(args: GetEventGridDataConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetEventGridDataConnectionResult> {
    pulumi.log.warn("getEventGridDataConnection is deprecated: azure-native:synapse/v20210401preview:EventGridDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:EventGridDataConnection to guarantee forwards compatibility.")
