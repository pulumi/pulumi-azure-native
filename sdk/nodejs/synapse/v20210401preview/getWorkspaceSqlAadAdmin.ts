...
export function getWorkspaceSqlAadAdmin(args: GetWorkspaceSqlAadAdminArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceSqlAadAdminResult> {
    pulumi.log.warn("getWorkspaceSqlAadAdmin is deprecated: azure-native:synapse/v20210401preview:WorkspaceSqlAadAdmin is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:WorkspaceSqlAadAdmin to guarantee forwards compatibility.")
