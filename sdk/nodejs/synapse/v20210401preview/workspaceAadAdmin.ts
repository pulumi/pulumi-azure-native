...
export class WorkspaceAadAdmin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210401preview:WorkspaceAadAdmin';
    ...
    constructor(name: string, args: WorkspaceAadAdminArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse:WorkspaceAadAdmin" }, { type: "azure-native:synapse/v20210301:WorkspaceAadAdmin" }, { type: "azure-native:synapse/v20210501:WorkspaceAadAdmin" }, { type: "azure-native:synapse/v20210601:WorkspaceAadAdmin" }, { type: "azure-native:synapse/v20210601preview:WorkspaceAadAdmin" }] };
