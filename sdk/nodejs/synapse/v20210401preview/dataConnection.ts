...
export class DataConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210401preview:DataConnection" }, { type: "azure-native:synapse:DataConnection" }, { type: "azure-nextgen:synapse:DataConnection" }, { type: "azure-native:synapse/v20210601preview:DataConnection" }, { type: "azure-nextgen:synapse/v20210601preview:DataConnection" }] };
