 ...
 * A privateLinkHub
 *
 * @deprecated azure-native:synapse/v20210401preview:PrivateLinkHub is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.
 */
export class PrivateLinkHub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateLinkHub {
        pulumi.log.warn("PrivateLinkHub is deprecated: azure-native:synapse/v20210401preview:PrivateLinkHub is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.")
        return new PrivateLinkHub(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210401preview:PrivateLinkHub';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.synapse.v20210401preview.PrivateEndpointConnectionForPrivateLinkHubBasicResponse[]>;
    /**
