...
export class WorkspaceAadAdmin extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceAadAdminArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse:WorkspaceAadAdmin" }, { type: "azure-nextgen:synapse:WorkspaceAadAdmin" }, { type: "azure-native:synapse/latest:WorkspaceAadAdmin" }, { type: "azure-nextgen:synapse/latest:WorkspaceAadAdmin" }, { type: "azure-native:synapse/v20190601preview:WorkspaceAadAdmin" }, { type: "azure-nextgen:synapse/v20190601preview:WorkspaceAadAdmin" }, { type: "azure-native:synapse/v20201201:WorkspaceAadAdmin" }, { type: "azure-nextgen:synapse/v20201201:WorkspaceAadAdmin" }] };
