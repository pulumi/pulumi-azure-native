...
export class SqlPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse:SqlPool" }, { type: "azure-native:synapse/v20210401preview:SqlPool" }, { type: "azure-native:synapse/v20210501:SqlPool" }, { type: "azure-native:synapse/v20210601:SqlPool" }, { type: "azure-native:synapse/v20210601preview:SqlPool" }] };
