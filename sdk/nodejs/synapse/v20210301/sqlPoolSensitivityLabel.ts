 ...
 * A sensitivity label.
 *
 * @deprecated azure-native:synapse/v20210301:SqlPoolSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel to guarantee forwards compatibility.
 */
export class SqlPoolSensitivityLabel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlPoolSensitivityLabel {
        pulumi.log.warn("SqlPoolSensitivityLabel is deprecated: azure-native:synapse/v20210301:SqlPoolSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel to guarantee forwards compatibility.")
