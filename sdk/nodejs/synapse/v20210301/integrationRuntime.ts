...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210301:IntegrationRuntime';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.synapse.v20210301.ManagedIntegrationRuntimeResponse | outputs.synapse.v20210301.SelfHostedIntegrationRuntimeResponse>;
    /**
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse:IntegrationRuntime" }, { type: "azure-nextgen:synapse:IntegrationRuntime" }, { type: "azure-native:synapse/latest:IntegrationRuntime" }, { type: "azure-nextgen:synapse/latest:IntegrationRuntime" }, { type: "azure-native:synapse/v20190601preview:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20190601preview:IntegrationRuntime" }, { type: "azure-native:synapse/v20201201:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20201201:IntegrationRuntime" }] };
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    readonly properties: pulumi.Input<inputs.synapse.v20210301.ManagedIntegrationRuntime | inputs.synapse.v20210301.SelfHostedIntegrationRuntime>;
    /**
