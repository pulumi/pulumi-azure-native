 ...
 *
 * const integrationRuntime = new azure_native.synapse.v20210301.IntegrationRuntime("integrationRuntime", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:synapse/v20210301:IntegrationRuntime exampleIntegrationRuntime /subscriptions/12345678-1234-1234-1234-12345678abc/resourceGroups/exampleResourceGroup/providers/Microsoft.Synapse/workspaces/exampleWorkspaceName/integrationruntimes/exampleIntegrationRuntime 
 * ```
 */
