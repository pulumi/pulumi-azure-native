...
export class IpFirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210301:IpFirewallRule';
    ...
    constructor(name: string, args: IpFirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:synapse:IpFirewallRule" }, { type: "azure-nextgen:synapse:IpFirewallRule" }, { type: "azure-native:synapse/latest:IpFirewallRule" }, { type: "azure-nextgen:synapse/latest:IpFirewallRule" }, { type: "azure-native:synapse/v20190601preview:IpFirewallRule" }, { type: "azure-nextgen:synapse/v20190601preview:IpFirewallRule" }, { type: "azure-native:synapse/v20201201:IpFirewallRule" }, { type: "azure-nextgen:synapse/v20201201:IpFirewallRule" }] };
