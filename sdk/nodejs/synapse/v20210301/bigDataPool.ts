...
export class BigDataPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BigDataPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210301:BigDataPool" }, { type: "azure-native:synapse:BigDataPool" }, { type: "azure-nextgen:synapse:BigDataPool" }, { type: "azure-native:synapse/latest:BigDataPool" }, { type: "azure-nextgen:synapse/latest:BigDataPool" }, { type: "azure-native:synapse/v20190601preview:BigDataPool" }, { type: "azure-nextgen:synapse/v20190601preview:BigDataPool" }, { type: "azure-native:synapse/v20201201:BigDataPool" }, { type: "azure-nextgen:synapse/v20201201:BigDataPool" }] };
...
export interface BigDataPoolArgs {
     ...
     * Auto-pausing properties
     */
    readonly autoPause?: pulumi.Input<inputs.synapse.v20210301.AutoPauseProperties>;
    /**
     * Auto-scaling properties
     */
    readonly autoScale?: pulumi.Input<inputs.synapse.v20210301.AutoScaleProperties>;
    /**
     * Big Data pool name
     */
     ...
     * List of custom libraries/packages associated with the spark pool.
     */
    readonly customLibraries?: pulumi.Input<pulumi.Input<inputs.synapse.v20210301.LibraryInfo>[]>;
    /**
     * The default folder where Spark logs will be written.
     */
     ...
     * Dynamic Executor Allocation
     */
    readonly dynamicExecutorAllocation?: pulumi.Input<inputs.synapse.v20210301.DynamicExecutorAllocation>;
    /**
     ...
     * Library version requirements
     */
    readonly libraryRequirements?: pulumi.Input<inputs.synapse.v20210301.LibraryRequirements>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Spark configuration file to specify additional properties
     */
    readonly sparkConfigProperties?: pulumi.Input<inputs.synapse.v20210301.LibraryRequirements>;
    /**
     * The Spark events folder
     */
