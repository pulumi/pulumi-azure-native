...
export class BigDataPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210301:BigDataPool';
     ...
     */
    public readonly autoPause!: pulumi.Output<outputs.synapse.v20210301.AutoPausePropertiesResponse | undefined>;
    /**
     * Auto-scaling properties
     */
    public readonly autoScale!: pulumi.Output<outputs.synapse.v20210301.AutoScalePropertiesResponse | undefined>;
    /**
     * The cache size
     */
     ...
     */
    public readonly customLibraries!: pulumi.Output<outputs.synapse.v20210301.LibraryInfoResponse[] | undefined>;
    /**
     ...
     */
    public readonly dynamicExecutorAllocation!: pulumi.Output<outputs.synapse.v20210301.DynamicExecutorAllocationResponse | undefined>;
    /**
     ...
     */
    public readonly libraryRequirements!: pulumi.Output<outputs.synapse.v20210301.LibraryRequirementsResponse | undefined>;
    /**
     ...
     */
    public readonly sparkConfigProperties!: pulumi.Output<outputs.synapse.v20210301.LibraryRequirementsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: BigDataPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/v20210301:BigDataPool" }, { type: "azure-native:synapse:BigDataPool" }, { type: "azure-nextgen:synapse:BigDataPool" }, { type: "azure-native:synapse/v20190601preview:BigDataPool" }, { type: "azure-nextgen:synapse/v20190601preview:BigDataPool" }, { type: "azure-native:synapse/v20201201:BigDataPool" }, { type: "azure-nextgen:synapse/v20201201:BigDataPool" }, { type: "azure-native:synapse/v20210401preview:BigDataPool" }, { type: "azure-nextgen:synapse/v20210401preview:BigDataPool" }, { type: "azure-native:synapse/v20210501:BigDataPool" }, { type: "azure-nextgen:synapse/v20210501:BigDataPool" }, { type: "azure-native:synapse/v20210601:BigDataPool" }, { type: "azure-nextgen:synapse/v20210601:BigDataPool" }, { type: "azure-native:synapse/v20210601preview:BigDataPool" }, { type: "azure-nextgen:synapse/v20210601preview:BigDataPool" }] };
...
export interface BigDataPoolArgs {
     ...
     * Auto-pausing properties
     */
    autoPause?: pulumi.Input<inputs.synapse.v20210301.AutoPausePropertiesArgs>;
    /**
     * Auto-scaling properties
     */
    autoScale?: pulumi.Input<inputs.synapse.v20210301.AutoScalePropertiesArgs>;
    /**
     * Big Data pool name
     */
     ...
     * List of custom libraries/packages associated with the spark pool.
     */
    customLibraries?: pulumi.Input<pulumi.Input<inputs.synapse.v20210301.LibraryInfoArgs>[]>;
    /**
     * The default folder where Spark logs will be written.
     */
     ...
     * Dynamic Executor Allocation
     */
    dynamicExecutorAllocation?: pulumi.Input<inputs.synapse.v20210301.DynamicExecutorAllocationArgs>;
    /**
     ...
     * Library version requirements
     */
    libraryRequirements?: pulumi.Input<inputs.synapse.v20210301.LibraryRequirementsArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The level of compute power that each node in the Big Data pool has.
     */
    nodeSize?: pulumi.Input<string | enums.synapse.v20210301.NodeSize>;
    /**
     * The kind of nodes that the Big Data pool provides.
     */
    nodeSizeFamily?: pulumi.Input<string | enums.synapse.v20210301.NodeSizeFamily>;
    /**
     * The state of the Big Data pool.
     */
     ...
     * Spark configuration file to specify additional properties
     */
    sparkConfigProperties?: pulumi.Input<inputs.synapse.v20210301.LibraryRequirementsArgs>;
    /**
     * The Spark events folder
     */
