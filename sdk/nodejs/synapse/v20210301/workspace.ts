...
export class Workspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Workspace {
        pulumi.log.warn("Workspace is deprecated: azure-native:synapse/v20210301:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210501:Workspace to guarantee forwards compatibility.")
