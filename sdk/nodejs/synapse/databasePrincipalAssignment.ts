...
export class DatabasePrincipalAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabasePrincipalAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse:DatabasePrincipalAssignment" }, { type: "azure-native:synapse/v20210401preview:DatabasePrincipalAssignment" }, { type: "azure-nextgen:synapse/v20210401preview:DatabasePrincipalAssignment" }, { type: "azure-native:synapse/v20210601preview:DatabasePrincipalAssignment" }, { type: "azure-nextgen:synapse/v20210601preview:DatabasePrincipalAssignment" }] };
