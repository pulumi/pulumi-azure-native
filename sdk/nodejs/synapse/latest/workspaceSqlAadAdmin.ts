 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:synapse:WorkspaceSqlAadAdmin'.
 */
export class WorkspaceSqlAadAdmin extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceSqlAadAdmin {
        pulumi.log.warn("WorkspaceSqlAadAdmin is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:synapse:WorkspaceSqlAadAdmin'.")
        return new WorkspaceSqlAadAdmin(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/latest:WorkspaceSqlAadAdmin';
    ...
    constructor(name: string, args: WorkspaceSqlAadAdminArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/latest:WorkspaceSqlAadAdmin" }, { type: "azure-native:synapse:WorkspaceSqlAadAdmin" }, { type: "azure-nextgen:synapse:WorkspaceSqlAadAdmin" }, { type: "azure-native:synapse/v20190601preview:WorkspaceSqlAadAdmin" }, { type: "azure-nextgen:synapse/v20190601preview:WorkspaceSqlAadAdmin" }, { type: "azure-native:synapse/v20201201:WorkspaceSqlAadAdmin" }, { type: "azure-nextgen:synapse/v20201201:WorkspaceSqlAadAdmin" }, { type: "azure-native:synapse/v20210301:WorkspaceSqlAadAdmin" }, { type: "azure-nextgen:synapse/v20210301:WorkspaceSqlAadAdmin" }] };
