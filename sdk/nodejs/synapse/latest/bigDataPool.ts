...
export class BigDataPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/latest:BigDataPool';
     ...
     */
    public readonly autoPause!: pulumi.Output<outputs.synapse.latest.AutoPausePropertiesResponse | undefined>;
    /**
     * Auto-scaling properties
     */
    public readonly autoScale!: pulumi.Output<outputs.synapse.latest.AutoScalePropertiesResponse | undefined>;
    /**
     * The cache size
     */
     ...
     */
    public readonly customLibraries!: pulumi.Output<outputs.synapse.latest.LibraryInfoResponse[] | undefined>;
    /**
     ...
     */
    public readonly dynamicExecutorAllocation!: pulumi.Output<outputs.synapse.latest.DynamicExecutorAllocationResponse | undefined>;
    /**
     ...
     */
    public readonly libraryRequirements!: pulumi.Output<outputs.synapse.latest.LibraryRequirementsResponse | undefined>;
    /**
     ...
     */
    public readonly sparkConfigProperties!: pulumi.Output<outputs.synapse.latest.LibraryRequirementsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: BigDataPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/latest:BigDataPool" }, { type: "azure-native:synapse:BigDataPool" }, { type: "azure-nextgen:synapse:BigDataPool" }, { type: "azure-native:synapse/v20190601preview:BigDataPool" }, { type: "azure-nextgen:synapse/v20190601preview:BigDataPool" }, { type: "azure-native:synapse/v20201201:BigDataPool" }, { type: "azure-nextgen:synapse/v20201201:BigDataPool" }, { type: "azure-native:synapse/v20210301:BigDataPool" }, { type: "azure-nextgen:synapse/v20210301:BigDataPool" }] };
...
export interface BigDataPoolArgs {
     ...
     * Auto-pausing properties
     */
    readonly autoPause?: pulumi.Input<inputs.synapse.latest.AutoPauseProperties>;
    /**
     * Auto-scaling properties
     */
    readonly autoScale?: pulumi.Input<inputs.synapse.latest.AutoScaleProperties>;
    /**
     * Big Data pool name
     */
     ...
     * List of custom libraries/packages associated with the spark pool.
     */
    readonly customLibraries?: pulumi.Input<pulumi.Input<inputs.synapse.latest.LibraryInfo>[]>;
    /**
     * The default folder where Spark logs will be written.
     */
     ...
     * Dynamic Executor Allocation
     */
    readonly dynamicExecutorAllocation?: pulumi.Input<inputs.synapse.latest.DynamicExecutorAllocation>;
    /**
     ...
     * Library version requirements
     */
    readonly libraryRequirements?: pulumi.Input<inputs.synapse.latest.LibraryRequirements>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The level of compute power that each node in the Big Data pool has.
     */
    readonly nodeSize?: pulumi.Input<string | enums.synapse.latest.NodeSize>;
    /**
     * The kind of nodes that the Big Data pool provides.
     */
    readonly nodeSizeFamily?: pulumi.Input<string | enums.synapse.latest.NodeSizeFamily>;
    /**
     * The state of the Big Data pool.
     */
     ...
     * Spark configuration file to specify additional properties
     */
    readonly sparkConfigProperties?: pulumi.Input<inputs.synapse.latest.LibraryRequirements>;
    /**
     * The Spark events folder
     */
