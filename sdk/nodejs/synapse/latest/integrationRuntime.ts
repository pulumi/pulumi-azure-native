...
export class IntegrationRuntime extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.synapse.latest.ManagedIntegrationRuntimeResponse | outputs.synapse.latest.SelfHostedIntegrationRuntimeResponse>;
    /**
    ...
    constructor(name: string, args: IntegrationRuntimeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:synapse/latest:IntegrationRuntime" }, { type: "azure-native:synapse:IntegrationRuntime" }, { type: "azure-nextgen:synapse:IntegrationRuntime" }, { type: "azure-native:synapse/v20190601preview:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20190601preview:IntegrationRuntime" }, { type: "azure-native:synapse/v20201201:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20201201:IntegrationRuntime" }, { type: "azure-native:synapse/v20210301:IntegrationRuntime" }, { type: "azure-nextgen:synapse/v20210301:IntegrationRuntime" }] };
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    readonly properties: pulumi.Input<inputs.synapse.latest.ManagedIntegrationRuntime | inputs.synapse.latest.SelfHostedIntegrationRuntime>;
    /**
