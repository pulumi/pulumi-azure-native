...
export class SqlPoolTransparentDataEncryption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/latest:SqlPoolTransparentDataEncryption';
