...
export class JobStep extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobStep {
        pulumi.log.warn("JobStep is deprecated: azure-native:sql/v20170301preview:JobStep is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobStep to guarantee forwards compatibility.")
