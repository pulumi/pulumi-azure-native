...
export class JobStep extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:JobStep" }, { type: "azure-nextgen:sql/v20200202preview:JobStep" }, { type: "azure-nextgen:sql/v20200801preview:JobStep" }] };
