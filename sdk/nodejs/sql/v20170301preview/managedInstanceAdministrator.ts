...
export class ManagedInstanceAdministrator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstanceAdministrator {
        return new ManagedInstanceAdministrator(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: ManagedInstanceAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ManagedInstanceAdministratorArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:ManagedInstanceAdministrator" }] };
