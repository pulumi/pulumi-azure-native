...
export class ManagedDatabase extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:ManagedDatabase" }, { type: "azurerm:sql/v20180601preview:ManagedDatabase" }, { type: "azurerm:sql/v20190601preview:ManagedDatabase" }, { type: "azurerm:sql/v20200202preview:ManagedDatabase" }] };
