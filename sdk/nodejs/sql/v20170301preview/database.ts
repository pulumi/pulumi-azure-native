...
export class Database extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:Database" }, { type: "azurerm:sql/preview:Database" }, { type: "azurerm:sql/v20140401:Database" }, { type: "azurerm:sql/v20171001preview:Database" }, { type: "azurerm:sql/v20190601preview:Database" }] };
