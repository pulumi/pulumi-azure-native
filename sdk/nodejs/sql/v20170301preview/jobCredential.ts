...
export class JobCredential extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobCredential {
        pulumi.log.warn("JobCredential is deprecated: azure-native:sql/v20170301preview:JobCredential is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobCredential to guarantee forwards compatibility.")
