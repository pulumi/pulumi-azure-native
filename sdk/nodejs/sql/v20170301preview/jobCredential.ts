...
export class JobCredential extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobCredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:JobCredential" }, { type: "azure-nextgen:sql/v20200202preview:JobCredential" }, { type: "azure-nextgen:sql/v20200801preview:JobCredential" }] };
