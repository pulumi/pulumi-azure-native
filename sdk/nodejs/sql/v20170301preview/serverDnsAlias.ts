...
export class ServerDnsAlias extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerDnsAlias {
        return new ServerDnsAlias(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: ServerDnsAliasArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:ServerDnsAlias" }] };
