...
export class DatabaseBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20170301preview:DatabaseBlobAuditingPolicy';
...
export interface DatabaseBlobAuditingPolicyArgs {
     ...
     * Specifies the state of the policy. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
     */
    readonly state: pulumi.Input<enums.sql.v20170301preview.BlobAuditingPolicyState>;
    /**
