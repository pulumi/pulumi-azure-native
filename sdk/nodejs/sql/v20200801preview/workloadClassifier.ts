...
export class WorkloadClassifier extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200801preview:WorkloadClassifier';
    ...
    constructor(name: string, args: WorkloadClassifierArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:WorkloadClassifier" }, { type: "azure-nextgen:sql/v20190601preview:WorkloadClassifier" }, { type: "azure-nextgen:sql/v20200202preview:WorkloadClassifier" }] };
