...
export class JobAgent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:JobAgent" }, { type: "azure-nextgen:sql:JobAgent" }, { type: "azure-native:sql/v20170301preview:JobAgent" }, { type: "azure-nextgen:sql/v20170301preview:JobAgent" }, { type: "azure-native:sql/v20200202preview:JobAgent" }, { type: "azure-nextgen:sql/v20200202preview:JobAgent" }] };
