...
export function getSyncGroup(args: GetSyncGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetSyncGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:sql/v20200801preview:getSyncGroup", {
...
export interface GetSyncGroupResult {
     ...
     */
    readonly schema?: outputs.sql.v20200801preview.SyncGroupSchemaInvokeResponse;
    /**
