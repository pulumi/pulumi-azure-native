...
export class SensitivityLabel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200801preview:SensitivityLabel';
    ...
    constructor(name: string, args: SensitivityLabelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:SensitivityLabel" }, { type: "azure-nextgen:sql/v20170301preview:SensitivityLabel" }, { type: "azure-nextgen:sql/v20200202preview:SensitivityLabel" }] };
