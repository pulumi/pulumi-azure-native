 ...
 *
 * @deprecated azure-native:sql/v20200801preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerAzureADAdministrator to guarantee forwards compatibility.
 */
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200801preview:ServerAzureADAdministrator';
...
export interface ServerAzureADAdministratorArgs {
     ...
     * Type of the sever administrator.
     */
    administratorType: pulumi.Input<string | enums.sql.v20200801preview.AdministratorType>;
    /**
     * Login name of the server administrator.
     */
