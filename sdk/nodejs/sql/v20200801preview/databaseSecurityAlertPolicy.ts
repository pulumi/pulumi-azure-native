...
export class DatabaseSecurityAlertPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200801preview:DatabaseSecurityAlertPolicy';
    ...
    constructor(name: string, args: DatabaseSecurityAlertPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/latest:DatabaseSecurityAlertPolicy" }, { type: "azure-nextgen:sql/v20140401:DatabaseSecurityAlertPolicy" }, { type: "azure-nextgen:sql/v20180601preview:DatabaseSecurityAlertPolicy" }, { type: "azure-nextgen:sql/v20200202preview:DatabaseSecurityAlertPolicy" }] };
