...
export function getElasticPool(args: GetElasticPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetElasticPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:sql/v20200801preview:getElasticPool", {
...
export interface GetElasticPoolResult {
     ...
     */
    readonly perDatabaseSettings?: outputs.sql.v20200801preview.ElasticPoolPerDatabaseSettingsInvokeResponse;
    /**
