...
export class ManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200801preview:ManagedInstance';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20200801preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20200801preview.ManagedInstancePecPropertyResponse[]>;
    ...
    constructor(name: string, args: ManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200801preview:ManagedInstance" }, { type: "azure-native:sql:ManagedInstance" }, { type: "azure-nextgen:sql:ManagedInstance" }, { type: "azure-native:sql/v20150501preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20150501preview:ManagedInstance" }, { type: "azure-native:sql/v20180601preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20180601preview:ManagedInstance" }, { type: "azure-native:sql/v20200202preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20200202preview:ManagedInstance" }, { type: "azure-native:sql/v20201101preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20201101preview:ManagedInstance" }, { type: "azure-native:sql/v20210201preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20210201preview:ManagedInstance" }, { type: "azure-native:sql/v20210501preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20210501preview:ManagedInstance" }] };
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory identity of the managed instance.
     */
    identity?: pulumi.Input<inputs.sql.v20200801preview.ResourceIdentityArgs>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    licenseType?: pulumi.Input<string | enums.sql.v20200801preview.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    managedInstanceCreateMode?: pulumi.Input<string | enums.sql.v20200801preview.ManagedServerCreateMode>;
    /**
     ...
     * Connection type used for connecting to the instance.
     */
    proxyOverride?: pulumi.Input<string | enums.sql.v20200801preview.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
