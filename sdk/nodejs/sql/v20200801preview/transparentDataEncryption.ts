...
export class TransparentDataEncryption extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TransparentDataEncryptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/latest:TransparentDataEncryption" }, { type: "azure-nextgen:sql/v20140401:TransparentDataEncryption" }, { type: "azure-nextgen:sql/v20200202preview:TransparentDataEncryption" }] };
