...
export class ManagedInstancePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedInstancePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:ManagedInstancePrivateEndpointConnection" }, { type: "azure-nextgen:sql:ManagedInstancePrivateEndpointConnection" }, { type: "azure-native:sql/v20200202preview:ManagedInstancePrivateEndpointConnection" }, { type: "azure-nextgen:sql/v20200202preview:ManagedInstancePrivateEndpointConnection" }] };
...
export interface ManagedInstancePrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.sql.v20200801preview.ManagedInstancePrivateEndpointProperty>;
    readonly privateEndpointConnectionName?: pulumi.Input<string>;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.sql.v20200801preview.ManagedInstancePrivateLinkServiceConnectionStateProperty>;
    /**
