...
export class ManagedInstancePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200801preview:ManagedInstancePrivateEndpointConnection';
    ...
    constructor(name: string, args: ManagedInstancePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:ManagedInstancePrivateEndpointConnection" }, { type: "azure-nextgen:sql/v20200202preview:ManagedInstancePrivateEndpointConnection" }] };
