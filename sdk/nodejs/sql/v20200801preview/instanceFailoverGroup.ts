...
export class InstanceFailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200801preview:InstanceFailoverGroup';
    ...
    constructor(name: string, args: InstanceFailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:InstanceFailoverGroup" }, { type: "azure-nextgen:sql/v20171001preview:InstanceFailoverGroup" }, { type: "azure-nextgen:sql/v20200202preview:InstanceFailoverGroup" }] };
...
export interface InstanceFailoverGroupArgs {
     ...
     * List of managed instance pairs in the failover group.
     */
    readonly managedInstancePairs: pulumi.Input<pulumi.Input<inputs.sql.v20200801preview.ManagedInstancePairInfo>[]>;
    /**
     * Partner region information for the failover group.
     */
    readonly partnerRegions: pulumi.Input<pulumi.Input<inputs.sql.v20200801preview.PartnerRegionInfo>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: pulumi.Input<inputs.sql.v20200801preview.InstanceFailoverGroupReadOnlyEndpoint>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Input<inputs.sql.v20200801preview.InstanceFailoverGroupReadWriteEndpoint>;
    /**
