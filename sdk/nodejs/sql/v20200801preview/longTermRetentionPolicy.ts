...
export class LongTermRetentionPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LongTermRetentionPolicy {
        pulumi.log.warn("LongTermRetentionPolicy is deprecated: azure-native:sql/v20200801preview:LongTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:LongTermRetentionPolicy to guarantee forwards compatibility.")
