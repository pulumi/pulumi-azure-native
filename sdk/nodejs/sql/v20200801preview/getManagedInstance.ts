...
export function getManagedInstance(args: GetManagedInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:sql/v20200801preview:getManagedInstance", {
...
export interface GetManagedInstanceResult {
     ...
     */
    readonly identity?: outputs.sql.v20200801preview.ResourceIdentityInvokeResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.sql.v20200801preview.ManagedInstancePecPropertyInvokeResponse[];
