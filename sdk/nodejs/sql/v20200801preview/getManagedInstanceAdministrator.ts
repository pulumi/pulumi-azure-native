...
export function getManagedInstanceAdministrator(args: GetManagedInstanceAdministratorArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceAdministratorResult> {
    pulumi.log.warn("getManagedInstanceAdministrator is deprecated: azure-native:sql/v20200801preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceAdministrator to guarantee forwards compatibility.")
