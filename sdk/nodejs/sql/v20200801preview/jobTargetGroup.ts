...
export class JobTargetGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200801preview:JobTargetGroup';
    ...
    constructor(name: string, args: JobTargetGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:JobTargetGroup" }, { type: "azure-nextgen:sql/v20170301preview:JobTargetGroup" }, { type: "azure-nextgen:sql/v20200202preview:JobTargetGroup" }] };
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    readonly members: pulumi.Input<pulumi.Input<inputs.sql.v20200801preview.JobTarget>[]>;
    /**
