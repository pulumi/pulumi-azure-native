...
export class ManagedInstanceAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200801preview:ManagedInstanceAdministrator';
    ...
    constructor(name: string, args: ManagedInstanceAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:ManagedInstanceAdministrator" }, { type: "azure-nextgen:sql/v20170301preview:ManagedInstanceAdministrator" }, { type: "azure-nextgen:sql/v20200202preview:ManagedInstanceAdministrator" }] };
