...
export class Database extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly currentSku!: pulumi.Output<outputs.sql.v20200801preview.SkuResponse>;
    /**
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200801preview:Database" }, { type: "azure-native:sql:Database" }, { type: "azure-nextgen:sql:Database" }, { type: "azure-native:sql/v20140401:Database" }, { type: "azure-nextgen:sql/v20140401:Database" }, { type: "azure-native:sql/v20170301preview:Database" }, { type: "azure-nextgen:sql/v20170301preview:Database" }, { type: "azure-native:sql/v20171001preview:Database" }, { type: "azure-nextgen:sql/v20171001preview:Database" }, { type: "azure-native:sql/v20190601preview:Database" }, { type: "azure-nextgen:sql/v20190601preview:Database" }, { type: "azure-native:sql/v20200202preview:Database" }, { type: "azure-nextgen:sql/v20200202preview:Database" }, { type: "azure-native:sql/v20201101preview:Database" }, { type: "azure-nextgen:sql/v20201101preview:Database" }, { type: "azure-native:sql/v20210201preview:Database" }, { type: "azure-nextgen:sql/v20210201preview:Database" }] };
...
export interface DatabaseArgs {
     ...
     * Collation of the metadata catalog.
     */
    readonly catalogCollation?: pulumi.Input<string | enums.sql.v20200801preview.CatalogCollationType>;
    /**
     * The collation of the database.
     */
     ...
     */
    readonly createMode?: pulumi.Input<string | enums.sql.v20200801preview.CreateMode>;
    /**
     ...
     * The license type to apply for this database. `LicenseIncluded` if you need a license, or `BasePrice` if you have a license and are eligible for the Azure Hybrid Benefit.
     */
    readonly licenseType?: pulumi.Input<string | enums.sql.v20200801preview.DatabaseLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region.
     */
    readonly readScale?: pulumi.Input<string | enums.sql.v20200801preview.DatabaseReadScale>;
    /**
     ...
     */
    readonly sampleName?: pulumi.Input<string | enums.sql.v20200801preview.SampleName>;
    /**
     * The secondary type of the database if it is a secondary.  Valid values are Geo and Named.
     */
    readonly secondaryType?: pulumi.Input<string | enums.sql.v20200801preview.SecondaryType>;
    /**
     ...
     * The storage account type used to store backups for this database.
     */
    readonly storageAccountType?: pulumi.Input<string | enums.sql.v20200801preview.StorageAccountType>;
    /**
     * Resource tags.
     */
