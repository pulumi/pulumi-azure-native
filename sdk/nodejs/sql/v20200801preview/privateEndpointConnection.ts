...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200801preview:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:PrivateEndpointConnection" }, { type: "azure-nextgen:sql/v20180601preview:PrivateEndpointConnection" }, { type: "azure-nextgen:sql/v20200202preview:PrivateEndpointConnection" }] };
