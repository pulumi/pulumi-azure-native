...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200801preview:SyncGroup';
     ...
     */
    public readonly schema!: pulumi.Output<outputs.sql.v20200801preview.SyncGroupSchemaResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SyncGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200801preview:SyncGroup" }, { type: "azure-native:sql:SyncGroup" }, { type: "azure-nextgen:sql:SyncGroup" }, { type: "azure-native:sql/v20150501preview:SyncGroup" }, { type: "azure-nextgen:sql/v20150501preview:SyncGroup" }, { type: "azure-native:sql/v20190601preview:SyncGroup" }, { type: "azure-nextgen:sql/v20190601preview:SyncGroup" }, { type: "azure-native:sql/v20200202preview:SyncGroup" }, { type: "azure-nextgen:sql/v20200202preview:SyncGroup" }, { type: "azure-native:sql/v20201101preview:SyncGroup" }, { type: "azure-nextgen:sql/v20201101preview:SyncGroup" }, { type: "azure-native:sql/v20210201preview:SyncGroup" }, { type: "azure-nextgen:sql/v20210201preview:SyncGroup" }] };
...
export interface SyncGroupArgs {
     ...
     * Conflict logging retention period.
     */
    readonly conflictLoggingRetentionInDays?: pulumi.Input<number>;
    /**
     * Conflict resolution policy of the sync group.
     */
    readonly conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20200801preview.SyncConflictResolutionPolicy>;
    /**
     ...
     * If conflict logging is enabled.
     */
    readonly enableConflictLogging?: pulumi.Input<boolean>;
    /**
     ...
     * Sync schema of the sync group.
     */
    readonly schema?: pulumi.Input<inputs.sql.v20200801preview.SyncGroupSchemaArgs>;
    /**
