...
export class SyncMember extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SyncMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20150501preview:SyncMember" }, { type: "azure-nextgen:sql/v20190601preview:SyncMember" }, { type: "azure-nextgen:sql/v20200202preview:SyncMember" }] };
