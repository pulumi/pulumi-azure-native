...
export function getDatabaseSecurityAlertPolicy(args: GetDatabaseSecurityAlertPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseSecurityAlertPolicyResult> {
    pulumi.log.warn("getDatabaseSecurityAlertPolicy is deprecated: azure-native:sql/v20200801preview:DatabaseSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseSecurityAlertPolicy to guarantee forwards compatibility.")
