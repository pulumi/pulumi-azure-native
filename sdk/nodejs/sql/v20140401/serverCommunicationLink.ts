...
export class ServerCommunicationLink extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerCommunicationLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20140401:ServerCommunicationLink" }, { type: "azure-native:sql:ServerCommunicationLink" }, { type: "azure-nextgen:sql:ServerCommunicationLink" }, { type: "azure-native:sql/latest:ServerCommunicationLink" }, { type: "azure-nextgen:sql/latest:ServerCommunicationLink" }] };
