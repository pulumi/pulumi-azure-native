 ...
 *
 * const serverCommunicationLink = new azurerm.sql.v20140401.ServerCommunicationLink("serverCommunicationLink", {
...
export class ServerCommunicationLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/v20140401:ServerCommunicationLink';
    ...
    constructor(name: string, argsOrState?: ServerCommunicationLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:ServerCommunicationLink" }] };
