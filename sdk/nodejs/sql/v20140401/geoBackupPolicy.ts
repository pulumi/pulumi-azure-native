...
export class GeoBackupPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.sql.v20140401.GeoBackupPolicyPropertiesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: GeoBackupPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:GeoBackupPolicy" }, { type: "azure-native:sql/v20211101:GeoBackupPolicy" }, { type: "azure-native:sql/v20220201preview:GeoBackupPolicy" }, { type: "azure-native:sql/v20220501preview:GeoBackupPolicy" }, { type: "azure-native:sql/v20220801preview:GeoBackupPolicy" }] };
...
export interface GeoBackupPolicyArgs {
     ...
     * The properties of the geo backup policy.
     */
    properties: pulumi.Input<inputs.sql.v20140401.GeoBackupPolicyPropertiesArgs>;
    /**
