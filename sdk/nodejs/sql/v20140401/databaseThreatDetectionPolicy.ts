...
export class DatabaseThreatDetectionPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseThreatDetectionPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20140401:DatabaseThreatDetectionPolicy" }, { type: "azure-native:sql:DatabaseThreatDetectionPolicy" }, { type: "azure-nextgen:sql:DatabaseThreatDetectionPolicy" }, { type: "azure-native:sql/v20180601preview:DatabaseThreatDetectionPolicy" }, { type: "azure-nextgen:sql/v20180601preview:DatabaseThreatDetectionPolicy" }, { type: "azure-native:sql/v20200202preview:DatabaseThreatDetectionPolicy" }, { type: "azure-nextgen:sql/v20200202preview:DatabaseThreatDetectionPolicy" }, { type: "azure-native:sql/v20200801preview:DatabaseThreatDetectionPolicy" }, { type: "azure-nextgen:sql/v20200801preview:DatabaseThreatDetectionPolicy" }, { type: "azure-native:sql/v20201101preview:DatabaseThreatDetectionPolicy" }, { type: "azure-nextgen:sql/v20201101preview:DatabaseThreatDetectionPolicy" }, { type: "azure-native:sql/v20210201preview:DatabaseThreatDetectionPolicy" }, { type: "azure-nextgen:sql/v20210201preview:DatabaseThreatDetectionPolicy" }, { type: "azure-native:sql/v20210501preview:DatabaseThreatDetectionPolicy" }, { type: "azure-nextgen:sql/v20210501preview:DatabaseThreatDetectionPolicy" }] };
...
export interface DatabaseThreatDetectionPolicyArgs {
     ...
     * Specifies that the alert is sent to the account administrators.
     */
    emailAccountAdmins?: pulumi.Input<string | enums.sql.v20140401.SecurityAlertPolicyEmailAccountAdmins>;
    /**
     * Specifies the semicolon-separated list of e-mail addresses to which the alert is sent.
     */
     ...
     * Specifies the state of the policy. If state is Enabled, storageEndpoint and storageAccountAccessKey are required.
     */
    state: pulumi.Input<string | enums.sql.v20140401.SecurityAlertPolicyState>;
    /**
     ...
     * Specifies whether to use the default server policy.
     */
    useServerDefault?: pulumi.Input<string | enums.sql.v20140401.SecurityAlertPolicyUseServerDefault>;
}
