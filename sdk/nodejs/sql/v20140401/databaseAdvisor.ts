...
export class DatabaseAdvisor extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseAdvisorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["autoExecuteValue"] = args ? args.autoExecuteValue : undefined;
            ...
            inputs["advisorStatus"] = undefined /*out*/;
            inputs["autoExecuteValue"] = undefined /*out*/;
            inputs["kind"] = undefined /*out*/;
            inputs["lastChecked"] = undefined /*out*/;
            inputs["location"] = undefined /*out*/;
            inputs["name"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20140401:DatabaseAdvisor" }, { type: "azure-native:sql:DatabaseAdvisor" }, { type: "azure-nextgen:sql:DatabaseAdvisor" }, { type: "azure-native:sql/v20150501preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20150501preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20200202preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20200202preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20200801preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20200801preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20201101preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20201101preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20210201preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20210201preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20210501preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20210501preview:DatabaseAdvisor" }] };
