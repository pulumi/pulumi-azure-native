...
export class ElasticPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/v20140401:ElasticPool';
    ...
    constructor(name: string, argsOrState?: ElasticPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:ElasticPool" }, { type: "azurerm:sql/preview:ElasticPool" }, { type: "azurerm:sql/v20171001preview:ElasticPool" }] };
