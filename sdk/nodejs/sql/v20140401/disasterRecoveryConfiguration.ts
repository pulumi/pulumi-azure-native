...
export class DisasterRecoveryConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20140401:DisasterRecoveryConfiguration';
    ...
    constructor(name: string, args: DisasterRecoveryConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:DisasterRecoveryConfiguration" }, { type: "azure-nextgen:sql/latest:DisasterRecoveryConfiguration" }] };
