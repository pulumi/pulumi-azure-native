 ...
 *
 * const serverAzureADAdministrator = new azurerm.sql.v20140401.ServerAzureADAdministrator("serverAzureADAdministrator", {
...
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ServerAzureADAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:ServerAzureADAdministrator" }, { type: "azurerm:sql/v20180601preview:ServerAzureADAdministrator" }, { type: "azurerm:sql/v20190601preview:ServerAzureADAdministrator" }] };
