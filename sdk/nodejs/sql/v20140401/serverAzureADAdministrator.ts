...
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20140401:ServerAzureADAdministrator';
    ...
    constructor(name: string, args: ServerAzureADAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/latest:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql/v20180601preview:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql/v20190601preview:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql/v20200801preview:ServerAzureADAdministrator" }] };
...
export interface ServerAzureADAdministratorArgs {
     ...
     * The type of administrator.
     */
    readonly administratorType: pulumi.Input<string | enums.sql.v20140401.AdministratorType>;
    /**
     * The server administrator login value.
     */
