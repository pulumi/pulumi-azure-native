...
export class ManagedDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql:ManagedDatabase';
    ...
    constructor(name: string, args: ManagedDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20170301preview:ManagedDatabase" }, { type: "azure-nextgen:sql/v20180601preview:ManagedDatabase" }, { type: "azure-nextgen:sql/v20190601preview:ManagedDatabase" }, { type: "azure-nextgen:sql/v20200202preview:ManagedDatabase" }, { type: "azure-nextgen:sql/v20200801preview:ManagedDatabase" }] };
