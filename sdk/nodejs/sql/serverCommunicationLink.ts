...
export class ServerCommunicationLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql:ServerCommunicationLink';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.sql.ServerCommunicationLinkPropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface ServerCommunicationLinkArgs {
     ...
     * The properties of resource.
     */
    readonly properties?: pulumi.Input<inputs.sql.ServerCommunicationLinkProperties>;
    /**
