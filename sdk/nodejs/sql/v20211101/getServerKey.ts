...
export function getServerKey(args: GetServerKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetServerKeyResult> {
    pulumi.log.warn("getServerKey is deprecated: azure-native:sql/v20211101:ServerKey is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerKey to guarantee forwards compatibility.")
