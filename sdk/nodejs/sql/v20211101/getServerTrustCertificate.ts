 ...
 */
/** @deprecated azure-native:sql/v20211101:ServerTrustCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustCertificate to guarantee forwards compatibility. */
export function getServerTrustCertificate(args: GetServerTrustCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetServerTrustCertificateResult> {
    pulumi.log.warn("getServerTrustCertificate is deprecated: azure-native:sql/v20211101:ServerTrustCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustCertificate to guarantee forwards compatibility.")
