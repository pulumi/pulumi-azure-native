...
export class JobTargetGroup extends pulumi.CustomResource {
     ...
     */
    public readonly members!: pulumi.Output<outputs.sql.v20211101.JobTargetResponse[]>;
    /**
     * Resource name.
     */
