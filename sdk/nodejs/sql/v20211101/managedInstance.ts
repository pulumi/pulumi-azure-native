 ...
 *
 * @deprecated azure-native:sql/v20211101:ManagedInstance is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstance to guarantee forwards compatibility.
 */
export class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    public readonly administrators!: pulumi.Output<outputs.sql.v20211101.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20211101.ManagedInstancePecPropertyResponse[]>;
     ...
     */
    public readonly servicePrincipal!: pulumi.Output<outputs.sql.v20211101.ServicePrincipalResponse | undefined>;
    /**
