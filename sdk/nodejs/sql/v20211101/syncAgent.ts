...
export class SyncAgent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SyncAgent {
        pulumi.log.warn("SyncAgent is deprecated: azure-native:sql/v20211101:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncAgent to guarantee forwards compatibility.")
