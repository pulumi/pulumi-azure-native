 ...
 * A database resource.
 *
 * @deprecated azure-native:sql/v20211101:Database is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.
 */
export class Database extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Database {
        pulumi.log.warn("Database is deprecated: azure-native:sql/v20211101:Database is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.")
     ...
     */
    public /*out*/ readonly currentSku!: pulumi.Output<outputs.sql.v20211101.SkuResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20211101.DatabaseIdentityResponse | undefined>;
    /**
