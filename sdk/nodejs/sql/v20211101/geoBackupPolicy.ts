 ...
 * A Geo backup policy.
 *
 * @deprecated azure-native:sql/v20211101:GeoBackupPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:GeoBackupPolicy to guarantee forwards compatibility.
 */
export class GeoBackupPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GeoBackupPolicy {
        pulumi.log.warn("GeoBackupPolicy is deprecated: azure-native:sql/v20211101:GeoBackupPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:GeoBackupPolicy to guarantee forwards compatibility.")
