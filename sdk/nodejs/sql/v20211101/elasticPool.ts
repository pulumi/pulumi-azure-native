...
export class ElasticPool extends pulumi.CustomResource {
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<outputs.sql.v20211101.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
...
export interface ElasticPoolArgs {
     ...
     * The license type to apply for this elastic pool.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20211101.ElasticPoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The per database settings for the elastic pool.
     */
    perDatabaseSettings?: pulumi.Input<inputs.sql.v20211101.ElasticPoolPerDatabaseSettingsArgs>;
    /**
