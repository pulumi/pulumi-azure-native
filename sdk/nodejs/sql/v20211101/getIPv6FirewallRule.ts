...
export function getIPv6FirewallRule(args: GetIPv6FirewallRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetIPv6FirewallRuleResult> {
    pulumi.log.warn("getIPv6FirewallRule is deprecated: azure-native:sql/v20211101:IPv6FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:IPv6FirewallRule to guarantee forwards compatibility.")
