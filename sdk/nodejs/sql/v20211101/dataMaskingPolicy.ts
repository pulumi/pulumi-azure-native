 ...
 *
 * @deprecated azure-native:sql/v20211101:DataMaskingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:DataMaskingPolicy to guarantee forwards compatibility.
 */
export class DataMaskingPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataMaskingPolicy {
        pulumi.log.warn("DataMaskingPolicy is deprecated: azure-native:sql/v20211101:DataMaskingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:DataMaskingPolicy to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: DataMaskingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:DataMaskingPolicy" }, { type: "azure-native:sql/v20140401:DataMaskingPolicy" }, { type: "azure-native:sql/v20220201preview:DataMaskingPolicy" }, { type: "azure-native:sql/v20220501preview:DataMaskingPolicy" }, { type: "azure-native:sql/v20220801preview:DataMaskingPolicy" }] };
...
export interface DataMaskingPolicyArgs {
     ...
     * The state of the data masking policy.
     */
    dataMaskingState: pulumi.Input<enums.sql.v20211101.DataMaskingState>;
    /**
