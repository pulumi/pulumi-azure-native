 ...
 * A job step.
 *
 * @deprecated azure-native:sql/v20211101:JobStep is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobStep to guarantee forwards compatibility.
 */
export class JobStep extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobStep {
        pulumi.log.warn("JobStep is deprecated: azure-native:sql/v20211101:JobStep is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobStep to guarantee forwards compatibility.")
     ...
     */
    public readonly action!: pulumi.Output<outputs.sql.v20211101.JobStepActionResponse>;
    /**
     ...
     */
    public readonly executionOptions!: pulumi.Output<outputs.sql.v20211101.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly output!: pulumi.Output<outputs.sql.v20211101.JobStepOutputResponse | undefined>;
    /**
    ...
    constructor(name: string, args: JobStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["action"] = args ? (args.action ? pulumi.output(args.action).apply(inputs.sql.v20211101.jobStepActionArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["credential"] = args ? args.credential : undefined;
            resourceInputs["executionOptions"] = args ? (args.executionOptions ? pulumi.output(args.executionOptions).apply(inputs.sql.v20211101.jobStepExecutionOptionsArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["jobAgentName"] = args ? args.jobAgentName : undefined;
            resourceInputs["jobName"] = args ? args.jobName : undefined;
            resourceInputs["output"] = args ? (args.output ? pulumi.output(args.output).apply(inputs.sql.v20211101.jobStepOutputArgsProvideDefaults) : undefined) : undefined;
...
export interface JobStepArgs {
     ...
     * The action payload of the job step.
     */
    action: pulumi.Input<inputs.sql.v20211101.JobStepActionArgs>;
    /**
     * The resource ID of the job credential that will be used to connect to the targets.
     */
     ...
     * Execution options for the job step.
     */
    executionOptions?: pulumi.Input<inputs.sql.v20211101.JobStepExecutionOptionsArgs>;
    /**
     ...
     * Output destination properties of the job step.
     */
    output?: pulumi.Input<inputs.sql.v20211101.JobStepOutputArgs>;
    /**
