...
export function getSyncAgent(args: GetSyncAgentArgs, opts?: pulumi.InvokeOptions): Promise<GetSyncAgentResult> {
    pulumi.log.warn("getSyncAgent is deprecated: azure-native:sql/v20211101:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncAgent to guarantee forwards compatibility.")
