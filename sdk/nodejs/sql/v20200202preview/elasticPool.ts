...
export class ElasticPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:ElasticPool';
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<outputs.sql.v20200202preview.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ElasticPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:ElasticPool" }, { type: "azure-native:sql:ElasticPool" }, { type: "azure-nextgen:sql:ElasticPool" }, { type: "azure-native:sql/v20140401:ElasticPool" }, { type: "azure-nextgen:sql/v20140401:ElasticPool" }, { type: "azure-native:sql/v20171001preview:ElasticPool" }, { type: "azure-nextgen:sql/v20171001preview:ElasticPool" }, { type: "azure-native:sql/v20200801preview:ElasticPool" }, { type: "azure-nextgen:sql/v20200801preview:ElasticPool" }, { type: "azure-native:sql/v20201101preview:ElasticPool" }, { type: "azure-nextgen:sql/v20201101preview:ElasticPool" }, { type: "azure-native:sql/v20210201preview:ElasticPool" }, { type: "azure-nextgen:sql/v20210201preview:ElasticPool" }, { type: "azure-native:sql/v20210501preview:ElasticPool" }, { type: "azure-nextgen:sql/v20210501preview:ElasticPool" }] };
...
export interface ElasticPoolArgs {
     ...
     * The license type to apply for this elastic pool.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20200202preview.ElasticPoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The per database settings for the elastic pool.
     */
    perDatabaseSettings?: pulumi.Input<inputs.sql.v20200202preview.ElasticPoolPerDatabaseSettingsArgs>;
    /**
