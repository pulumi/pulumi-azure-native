...
export class ServerAzureADOnlyAuthentication extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ServerAzureADOnlyAuthenticationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ServerAzureADOnlyAuthenticationArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:ServerAzureADOnlyAuthentication" }] };
