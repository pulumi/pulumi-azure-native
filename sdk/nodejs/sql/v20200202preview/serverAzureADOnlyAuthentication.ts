...
export class ServerAzureADOnlyAuthentication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:ServerAzureADOnlyAuthentication';
    ...
    constructor(name: string, args: ServerAzureADOnlyAuthenticationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:ServerAzureADOnlyAuthentication" }, { type: "azure-native:sql:ServerAzureADOnlyAuthentication" }, { type: "azure-nextgen:sql:ServerAzureADOnlyAuthentication" }, { type: "azure-native:sql/v20200801preview:ServerAzureADOnlyAuthentication" }, { type: "azure-nextgen:sql/v20200801preview:ServerAzureADOnlyAuthentication" }, { type: "azure-native:sql/v20201101preview:ServerAzureADOnlyAuthentication" }, { type: "azure-nextgen:sql/v20201101preview:ServerAzureADOnlyAuthentication" }, { type: "azure-native:sql/v20210201preview:ServerAzureADOnlyAuthentication" }, { type: "azure-nextgen:sql/v20210201preview:ServerAzureADOnlyAuthentication" }, { type: "azure-native:sql/v20210501preview:ServerAzureADOnlyAuthentication" }, { type: "azure-nextgen:sql/v20210501preview:ServerAzureADOnlyAuthentication" }] };
