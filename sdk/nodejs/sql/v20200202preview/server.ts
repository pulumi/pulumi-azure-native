...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:Server';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20200202preview.ServerPrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:Server" }, { type: "azure-native:sql:Server" }, { type: "azure-nextgen:sql:Server" }, { type: "azure-native:sql/v20140401:Server" }, { type: "azure-nextgen:sql/v20140401:Server" }, { type: "azure-native:sql/v20150501preview:Server" }, { type: "azure-nextgen:sql/v20150501preview:Server" }, { type: "azure-native:sql/v20190601preview:Server" }, { type: "azure-nextgen:sql/v20190601preview:Server" }, { type: "azure-native:sql/v20200801preview:Server" }, { type: "azure-nextgen:sql/v20200801preview:Server" }, { type: "azure-native:sql/v20201101preview:Server" }, { type: "azure-nextgen:sql/v20201101preview:Server" }, { type: "azure-native:sql/v20210201preview:Server" }, { type: "azure-nextgen:sql/v20210201preview:Server" }, { type: "azure-native:sql/v20210501preview:Server" }, { type: "azure-nextgen:sql/v20210501preview:Server" }] };
...
export interface ServerArgs {
     ...
     * Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    publicNetworkAccess?: pulumi.Input<string | enums.sql.v20200202preview.ServerPublicNetworkAccess>;
    /**
