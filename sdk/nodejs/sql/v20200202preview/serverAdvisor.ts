...
export class ServerAdvisor extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerAdvisor {
        pulumi.log.warn("ServerAdvisor is deprecated: azure-native:sql/v20200202preview:ServerAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerAdvisor to guarantee forwards compatibility.")
