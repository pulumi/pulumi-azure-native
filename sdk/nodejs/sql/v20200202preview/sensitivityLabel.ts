...
export class SensitivityLabel extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SensitivityLabelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:SensitivityLabel" }, { type: "azure-nextgen:sql/v20170301preview:SensitivityLabel" }, { type: "azure-nextgen:sql/v20200801preview:SensitivityLabel" }] };
