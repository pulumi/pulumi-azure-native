...
export class EncryptionProtector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:EncryptionProtector';
    ...
    constructor(name: string, args: EncryptionProtectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:EncryptionProtector" }, { type: "azure-native:sql:EncryptionProtector" }, { type: "azure-nextgen:sql:EncryptionProtector" }, { type: "azure-native:sql/v20150501preview:EncryptionProtector" }, { type: "azure-nextgen:sql/v20150501preview:EncryptionProtector" }, { type: "azure-native:sql/v20200801preview:EncryptionProtector" }, { type: "azure-nextgen:sql/v20200801preview:EncryptionProtector" }, { type: "azure-native:sql/v20201101preview:EncryptionProtector" }, { type: "azure-nextgen:sql/v20201101preview:EncryptionProtector" }, { type: "azure-native:sql/v20210201preview:EncryptionProtector" }, { type: "azure-nextgen:sql/v20210201preview:EncryptionProtector" }, { type: "azure-native:sql/v20210501preview:EncryptionProtector" }, { type: "azure-nextgen:sql/v20210501preview:EncryptionProtector" }] };
