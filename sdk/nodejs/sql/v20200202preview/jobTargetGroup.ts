...
export class JobTargetGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobTargetGroup {
        pulumi.log.warn("JobTargetGroup is deprecated: azure-native:sql/v20200202preview:JobTargetGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:JobTargetGroup to guarantee forwards compatibility.")
