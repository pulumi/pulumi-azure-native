...
export class ManagedInstancePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstancePrivateEndpointConnection {
        pulumi.log.warn("ManagedInstancePrivateEndpointConnection is deprecated: azure-native:sql/v20200202preview:ManagedInstancePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstancePrivateEndpointConnection to guarantee forwards compatibility.")
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<outputs.sql.v20200202preview.ManagedInstancePrivateEndpointPropertyResponse | undefined>;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<outputs.sql.v20200202preview.ManagedInstancePrivateLinkServiceConnectionStatePropertyResponse | undefined>;
    /**
...
export interface ManagedInstancePrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    privateEndpoint?: pulumi.Input<inputs.sql.v20200202preview.ManagedInstancePrivateEndpointPropertyArgs>;
    privateEndpointConnectionName?: pulumi.Input<string>;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    privateLinkServiceConnectionState?: pulumi.Input<inputs.sql.v20200202preview.ManagedInstancePrivateLinkServiceConnectionStatePropertyArgs>;
    /**
