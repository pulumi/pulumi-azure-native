...
export class HybridLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200202preview:HybridLink';
    ...
    constructor(name: string, args: HybridLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200801preview:HybridLink" }] };
...
export interface HybridLinkArgs {
     ...
     * The replication mode of hybrid link. Parameter will be ignored during link creation.
     */
    readonly replicationMode?: pulumi.Input<string | enums.sql.v20200202preview.ReplicationMode>;
    /**
