...
export class ServerSecurityAlertPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerSecurityAlertPolicy {
        pulumi.log.warn("ServerSecurityAlertPolicy is deprecated: azure-native:sql/v20200202preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.")
