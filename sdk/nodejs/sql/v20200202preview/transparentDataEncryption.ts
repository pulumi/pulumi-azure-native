...
export class TransparentDataEncryption extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransparentDataEncryption {
        pulumi.log.warn("TransparentDataEncryption is deprecated: azure-native:sql/v20200202preview:TransparentDataEncryption is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:TransparentDataEncryption to guarantee forwards compatibility.")
