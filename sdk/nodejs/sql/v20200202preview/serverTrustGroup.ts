...
export class ServerTrustGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:ServerTrustGroup';
    ...
    constructor(name: string, args: ServerTrustGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:ServerTrustGroup" }, { type: "azure-native:sql:ServerTrustGroup" }, { type: "azure-nextgen:sql:ServerTrustGroup" }, { type: "azure-native:sql/v20200801preview:ServerTrustGroup" }, { type: "azure-nextgen:sql/v20200801preview:ServerTrustGroup" }, { type: "azure-native:sql/v20201101preview:ServerTrustGroup" }, { type: "azure-nextgen:sql/v20201101preview:ServerTrustGroup" }, { type: "azure-native:sql/v20210201preview:ServerTrustGroup" }, { type: "azure-nextgen:sql/v20210201preview:ServerTrustGroup" }, { type: "azure-native:sql/v20210501preview:ServerTrustGroup" }, { type: "azure-nextgen:sql/v20210501preview:ServerTrustGroup" }] };
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<inputs.sql.v20200202preview.ServerInfoArgs>[]>;
    /**
