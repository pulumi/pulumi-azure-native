...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200202preview:Database';
     ...
     */
    public /*out*/ readonly currentSku!: pulumi.Output<outputs.sql.v20200202preview.SkuResponse>;
    /**
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/latest:Database" }, { type: "azure-nextgen:sql/v20140401:Database" }, { type: "azure-nextgen:sql/v20170301preview:Database" }, { type: "azure-nextgen:sql/v20171001preview:Database" }, { type: "azure-nextgen:sql/v20190601preview:Database" }, { type: "azure-nextgen:sql/v20200801preview:Database" }] };
...
export interface DatabaseArgs {
     ...
     * Collation of the metadata catalog.
     */
    readonly catalogCollation?: pulumi.Input<string | enums.sql.v20200202preview.CatalogCollationType>;
    /**
     * The collation of the database.
     */
     ...
     * Copy, Secondary, and RestoreLongTermRetentionBackup are not supported for DataWarehouse edition.
     */
    readonly createMode?: pulumi.Input<string | enums.sql.v20200202preview.CreateMode>;
    /**
     ...
     * The license type to apply for this database. `LicenseIncluded` if you need a license, or `BasePrice` if you have a license and are eligible for the Azure Hybrid Benefit.
     */
    readonly licenseType?: pulumi.Input<string | enums.sql.v20200202preview.DatabaseLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region.
     */
    readonly readScale?: pulumi.Input<string | enums.sql.v20200202preview.DatabaseReadScale>;
    /**
     * The resource identifier of the recoverable database associated with create operation of this database.
     */
     ...
     * The name of the sample schema to apply when creating this database.
     */
    readonly sampleName?: pulumi.Input<string | enums.sql.v20200202preview.SampleName>;
    /**
     ...
     * The storage account type used to store backups for this database.
     */
    readonly storageAccountType?: pulumi.Input<string | enums.sql.v20200202preview.StorageAccountType>;
    /**
     * Resource tags.
     */
