...
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:ServerAzureADAdministrator';
    ...
    constructor(name: string, args: ServerAzureADAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:ServerAzureADAdministrator" }, { type: "azure-native:sql:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql:ServerAzureADAdministrator" }, { type: "azure-native:sql/latest:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql/latest:ServerAzureADAdministrator" }, { type: "azure-native:sql/v20140401:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql/v20140401:ServerAzureADAdministrator" }, { type: "azure-native:sql/v20180601preview:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql/v20180601preview:ServerAzureADAdministrator" }, { type: "azure-native:sql/v20190601preview:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql/v20190601preview:ServerAzureADAdministrator" }, { type: "azure-native:sql/v20200801preview:ServerAzureADAdministrator" }, { type: "azure-nextgen:sql/v20200801preview:ServerAzureADAdministrator" }] };
...
export interface ServerAzureADAdministratorArgs {
     ...
     * Type of the sever administrator.
     */
    readonly administratorType: pulumi.Input<string | enums.sql.v20200202preview.AdministratorType>;
    /**
     * Login name of the server administrator.
     */
