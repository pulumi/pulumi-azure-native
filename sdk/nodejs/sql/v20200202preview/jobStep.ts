...
export class JobStep extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql/v20200202preview:JobStep';
    ...
    constructor(name: string, args: JobStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:JobStep" }, { type: "azure-nextgen:sql/v20170301preview:JobStep" }, { type: "azure-nextgen:sql/v20200801preview:JobStep" }] };
