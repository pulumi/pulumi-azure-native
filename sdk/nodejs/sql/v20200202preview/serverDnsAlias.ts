...
export class ServerDnsAlias extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerDnsAliasArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["azureDnsRecord"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:ServerDnsAlias" }, { type: "azure-native:sql:ServerDnsAlias" }, { type: "azure-nextgen:sql:ServerDnsAlias" }, { type: "azure-native:sql/v20170301preview:ServerDnsAlias" }, { type: "azure-nextgen:sql/v20170301preview:ServerDnsAlias" }, { type: "azure-native:sql/v20200801preview:ServerDnsAlias" }, { type: "azure-nextgen:sql/v20200801preview:ServerDnsAlias" }, { type: "azure-native:sql/v20201101preview:ServerDnsAlias" }, { type: "azure-nextgen:sql/v20201101preview:ServerDnsAlias" }, { type: "azure-native:sql/v20210201preview:ServerDnsAlias" }, { type: "azure-nextgen:sql/v20210201preview:ServerDnsAlias" }, { type: "azure-native:sql/v20210501preview:ServerDnsAlias" }, { type: "azure-nextgen:sql/v20210501preview:ServerDnsAlias" }] };
