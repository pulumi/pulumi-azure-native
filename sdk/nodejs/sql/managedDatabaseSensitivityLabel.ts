...
export class ManagedDatabaseSensitivityLabel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql:ManagedDatabaseSensitivityLabel';
    ...
    constructor(name: string, args: ManagedDatabaseSensitivityLabelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20180601preview:ManagedDatabaseSensitivityLabel" }, { type: "azure-nextgen:sql/v20200202preview:ManagedDatabaseSensitivityLabel" }, { type: "azure-nextgen:sql/v20200801preview:ManagedDatabaseSensitivityLabel" }] };
