...
export class ServerSecurityAlertPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220801preview:ServerSecurityAlertPolicy';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.sql.v20220801preview.SystemDataResponse>;
    /**
     * Resource type.
     */
...
export interface ServerSecurityAlertPolicyArgs {
     ...
     * Specifies the state of the policy, whether it is enabled or disabled or a policy has not been applied yet on the specific database.
     */
    state: pulumi.Input<enums.sql.v20220801preview.SecurityAlertsPolicyState>;
    /**
     * Specifies the identifier key of the Threat Detection audit storage account.
     */
