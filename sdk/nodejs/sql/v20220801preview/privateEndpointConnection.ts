 ...
 *
 * const privateEndpointConnection = new azure_native.sql.v20220801preview.PrivateEndpointConnection("privateEndpointConnection", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:sql/v20220801preview:PrivateEndpointConnection private-endpoint-connection-name /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/test-svr/privateEndpointConnections/private-endpoint-connection-name 
 * ```
 */
