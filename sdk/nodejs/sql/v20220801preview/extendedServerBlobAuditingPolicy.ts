 ...
 *
 * const extendedServerBlobAuditingPolicy = new azure_native.sql.v20220801preview.ExtendedServerBlobAuditingPolicy("extendedServerBlobAuditingPolicy", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:sql/v20220801preview:ExtendedServerBlobAuditingPolicy default /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/blobauditingtest-4799/providers/Microsoft.Sql/servers/blobauditingtest-6440/extendedAuditingSettings/default 
 * ```
 */
export class ExtendedServerBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220801preview:ExtendedServerBlobAuditingPolicy';
...
export interface ExtendedServerBlobAuditingPolicyArgs {
     ...
     * Specifies the state of the audit. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
     */
    state: pulumi.Input<enums.sql.v20220801preview.BlobAuditingPolicyState>;
    /**
