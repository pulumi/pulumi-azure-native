...
export function getDatabase(args: GetDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseResult> {
    pulumi.log.warn("getDatabase is deprecated: azure-native:sql/v20220801preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Database to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:sql/v20220801preview:getDatabase", {
...
export interface GetDatabaseResult {
     ...
     */
    readonly currentSku: outputs.sql.v20220801preview.SkuResponse;
    /**
     ...
     */
    readonly identity?: outputs.sql.v20220801preview.DatabaseIdentityResponse;
    /**
     ...
     */
    readonly keys?: {[key: string]: outputs.sql.v20220801preview.DatabaseKeyResponse};
    /**
