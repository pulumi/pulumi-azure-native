...
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220801preview:ServerAzureADAdministrator';
...
export interface ServerAzureADAdministratorArgs {
     ...
     * Type of the sever administrator.
     */
    administratorType: pulumi.Input<string | enums.sql.v20220801preview.AdministratorType>;
    /**
     * Login name of the server administrator.
     */
