...
export class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220801preview:StartStopManagedInstanceSchedule';
     ...
     * Schedule list.
     */
    public readonly scheduleList!: pulumi.Output<outputs.sql.v20220801preview.ScheduleItemResponse[]>;
    /**
    ...
    constructor(name: string, args: StartStopManagedInstanceScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20221101preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20230201preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20230501preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20230801preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20240501preview:StartStopManagedInstanceSchedule" }] };
...
export interface StartStopManagedInstanceScheduleArgs {
     ...
     * Schedule list.
     */
    scheduleList: pulumi.Input<pulumi.Input<inputs.sql.v20220801preview.ScheduleItemArgs>[]>;
    /**
