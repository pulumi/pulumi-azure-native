...
export class ElasticPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220801preview:ElasticPool';
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<outputs.sql.v20220801preview.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ElasticPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:ElasticPool" }, { type: "azure-native:sql/v20140401:ElasticPool" }, { type: "azure-native:sql/v20200202preview:ElasticPool" }, { type: "azure-native:sql/v20200801preview:ElasticPool" }, { type: "azure-native:sql/v20201101preview:ElasticPool" }, { type: "azure-native:sql/v20210201preview:ElasticPool" }, { type: "azure-native:sql/v20210501preview:ElasticPool" }, { type: "azure-native:sql/v20210801preview:ElasticPool" }, { type: "azure-native:sql/v20211101preview:ElasticPool" }, { type: "azure-native:sql/v20221101preview:ElasticPool" }] };
...
export interface ElasticPoolArgs {
     ...
     * Specifies the availability zone the pool's primary replica is pinned to.
     */
    availabilityZone?: pulumi.Input<string | enums.sql.v20220801preview.AvailabilityZoneType>;
    /**
     ...
     * The license type to apply for this elastic pool.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20220801preview.ElasticPoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The per database settings for the elastic pool.
     */
    perDatabaseSettings?: pulumi.Input<inputs.sql.v20220801preview.ElasticPoolPerDatabaseSettingsArgs>;
    /**
     * Type of enclave requested on the elastic pool.
     */
    preferredEnclaveType?: pulumi.Input<string | enums.sql.v20220801preview.AlwaysEncryptedEnclaveType>;
    /**
