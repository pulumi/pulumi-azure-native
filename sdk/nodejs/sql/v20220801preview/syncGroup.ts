...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220801preview:SyncGroup';
     ...
     */
    public readonly schema!: pulumi.Output<outputs.sql.v20220801preview.SyncGroupSchemaResponse | undefined>;
    /**
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20220801preview.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    schema?: pulumi.Input<inputs.sql.v20220801preview.SyncGroupSchemaArgs>;
    /**
