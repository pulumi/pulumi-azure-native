...
export class SyncMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220801preview:SyncMember';
...
export interface SyncMemberArgs {
     ...
     * Database type of the sync member.
     */
    databaseType?: pulumi.Input<string | enums.sql.v20220801preview.SyncMemberDbType>;
    /**
     ...
     * Sync direction of the sync member.
     */
    syncDirection?: pulumi.Input<string | enums.sql.v20220801preview.SyncDirection>;
    /**
