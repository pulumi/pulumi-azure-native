...
export function getServerTrustGroup(args: GetServerTrustGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetServerTrustGroupResult> {
    pulumi.log.warn("getServerTrustGroup is deprecated: azure-native:sql/v20220201preview:ServerTrustGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:sql/v20220201preview:getServerTrustGroup", {
...
export interface GetServerTrustGroupResult {
     ...
     */
    readonly groupMembers: outputs.sql.v20220201preview.ServerInfoResponse[];
    /**
     * Resource ID.
     */
    readonly id: string;
