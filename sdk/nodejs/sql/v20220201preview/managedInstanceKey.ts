 ...
 *
 * @deprecated azure-native:sql/v20220201preview:ManagedInstanceKey is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceKey to guarantee forwards compatibility.
 */
export class ManagedInstanceKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220201preview:ManagedInstanceKey';
...
export interface ManagedInstanceKeyArgs {
     ...
     */
    serverKeyType: pulumi.Input<string | enums.sql.v20220201preview.ServerKeyType>;
    /**
