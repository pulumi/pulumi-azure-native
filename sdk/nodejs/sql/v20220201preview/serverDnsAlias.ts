 ...
 * A server DNS alias.
 *
 * @deprecated azure-native:sql/v20220201preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerDnsAlias to guarantee forwards compatibility.
 */
export class ServerDnsAlias extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerDnsAlias {
        pulumi.log.warn("ServerDnsAlias is deprecated: azure-native:sql/v20220201preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerDnsAlias to guarantee forwards compatibility.")
