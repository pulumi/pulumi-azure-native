 ...
 *
 * @deprecated azure-native:sql/v20220201preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.
 */
export class ManagedInstanceAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220201preview:ManagedInstanceAdministrator';
...
export interface ManagedInstanceAdministratorArgs {
     ...
     * Type of the managed instance administrator.
     */
    administratorType: pulumi.Input<string | enums.sql.v20220201preview.ManagedInstanceAdministratorType>;
    /**
     * Login name of the managed instance administrator.
     */
