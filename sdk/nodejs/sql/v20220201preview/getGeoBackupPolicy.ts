...
export function getGeoBackupPolicy(args: GetGeoBackupPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetGeoBackupPolicyResult> {
    pulumi.log.warn("getGeoBackupPolicy is deprecated: azure-native:sql/v20220201preview:GeoBackupPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:GeoBackupPolicy to guarantee forwards compatibility.")
