...
export class ManagedServerDnsAlias extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedServerDnsAlias {
        pulumi.log.warn("ManagedServerDnsAlias is deprecated: azure-native:sql/v20220201preview:ManagedServerDnsAlias is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedServerDnsAlias to guarantee forwards compatibility.")
