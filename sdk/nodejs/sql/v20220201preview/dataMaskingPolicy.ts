...
export class DataMaskingPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataMaskingPolicy {
        pulumi.log.warn("DataMaskingPolicy is deprecated: azure-native:sql/v20220201preview:DataMaskingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:DataMaskingPolicy to guarantee forwards compatibility.")
