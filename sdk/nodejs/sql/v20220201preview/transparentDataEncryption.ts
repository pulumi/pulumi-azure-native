...
export class TransparentDataEncryption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220201preview:TransparentDataEncryption';
...
export interface TransparentDataEncryptionArgs {
     ...
     * Specifies the state of the transparent data encryption.
     */
    state: pulumi.Input<enums.sql.v20220201preview.TransparentDataEncryptionState>;
    /**
