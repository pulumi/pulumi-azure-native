...
export function getLongTermRetentionPolicy(args: GetLongTermRetentionPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetLongTermRetentionPolicyResult> {
    pulumi.log.warn("getLongTermRetentionPolicy is deprecated: azure-native:sql/v20220201preview:LongTermRetentionPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:LongTermRetentionPolicy to guarantee forwards compatibility.")
