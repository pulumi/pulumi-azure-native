 ...
 *
 * @deprecated azure-native:sql/v20220201preview:ManagedDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedDatabase to guarantee forwards compatibility.
 */
export class ManagedDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedDatabase {
        pulumi.log.warn("ManagedDatabase is deprecated: azure-native:sql/v20220201preview:ManagedDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedDatabase to guarantee forwards compatibility.")
