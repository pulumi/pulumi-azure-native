 ...
 *
 * @deprecated azure-native:sql/v20220201preview:Server is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.
 */
export class Server extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Server {
        pulumi.log.warn("Server is deprecated: azure-native:sql/v20220201preview:Server is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.")
