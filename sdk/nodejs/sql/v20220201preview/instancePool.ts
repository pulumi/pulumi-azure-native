 ...
 *
 * @deprecated azure-native:sql/v20220201preview:InstancePool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:InstancePool to guarantee forwards compatibility.
 */
export class InstancePool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstancePool {
        pulumi.log.warn("InstancePool is deprecated: azure-native:sql/v20220201preview:InstancePool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:InstancePool to guarantee forwards compatibility.")
        return new InstancePool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220201preview:InstancePool';
     ...
     */
    public readonly sku!: pulumi.Output<outputs.sql.v20220201preview.SkuResponse | undefined>;
    /**
...
export interface InstancePoolArgs {
     ...
     * The license type. Possible values are 'LicenseIncluded' (price for SQL license is included) and 'BasePrice' (without SQL license price).
     */
    licenseType: pulumi.Input<string | enums.sql.v20220201preview.InstancePoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The name and tier of the SKU.
     */
    sku?: pulumi.Input<inputs.sql.v20220201preview.SkuArgs>;
    /**
     * Resource ID of the subnet to place this instance pool in.
     */
