 ...
 *
 * @deprecated azure-native:sql/v20220201preview:SyncMember is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncMember to guarantee forwards compatibility.
 */
export class SyncMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220201preview:SyncMember';
...
export interface SyncMemberArgs {
     ...
     * Database type of the sync member.
     */
    databaseType?: pulumi.Input<string | enums.sql.v20220201preview.SyncMemberDbType>;
    /**
     ...
     * Sync direction of the sync member.
     */
    syncDirection?: pulumi.Input<string | enums.sql.v20220201preview.SyncDirection>;
    /**
