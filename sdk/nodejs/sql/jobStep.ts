...
export class JobStep extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql:JobStep';
    ...
    constructor(name: string, args: JobStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20170301preview:JobStep" }, { type: "azure-nextgen:sql/v20200202preview:JobStep" }, { type: "azure-nextgen:sql/v20200801preview:JobStep" }] };
...
export interface JobStepArgs {
     ...
     * The action payload of the job step.
     */
    readonly action: pulumi.Input<inputs.sql.JobStepAction>;
    /**
     * The resource ID of the job credential that will be used to connect to the targets.
     */
     ...
     * Execution options for the job step.
     */
    readonly executionOptions?: pulumi.Input<inputs.sql.JobStepExecutionOptions>;
    /**
     ...
     * Output destination properties of the job step.
     */
    readonly output?: pulumi.Input<inputs.sql.JobStepOutput>;
    /**
