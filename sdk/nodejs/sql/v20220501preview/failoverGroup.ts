...
export class FailoverGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:FailoverGroup" }, { type: "azure-native:sql/v20150501preview:FailoverGroup" }, { type: "azure-native:sql/v20200202preview:FailoverGroup" }, { type: "azure-native:sql/v20200801preview:FailoverGroup" }, { type: "azure-native:sql/v20201101preview:FailoverGroup" }, { type: "azure-native:sql/v20210201preview:FailoverGroup" }, { type: "azure-native:sql/v20210501preview:FailoverGroup" }, { type: "azure-native:sql/v20210801preview:FailoverGroup" }, { type: "azure-native:sql/v20211101:FailoverGroup" }, { type: "azure-native:sql/v20211101preview:FailoverGroup" }, { type: "azure-native:sql/v20220201preview:FailoverGroup" }, { type: "azure-native:sql/v20220801preview:FailoverGroup" }, { type: "azure-native:sql/v20221101preview:FailoverGroup" }, { type: "azure-native:sql/v20230201preview:FailoverGroup" }, { type: "azure-native:sql/v20230501preview:FailoverGroup" }, { type: "azure-native:sql/v20230801preview:FailoverGroup" }, { type: "azure-native:sql/v20240501preview:FailoverGroup" }] };
