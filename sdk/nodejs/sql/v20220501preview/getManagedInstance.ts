 ...
 */
/** @deprecated azure-native:sql/v20220501preview:ManagedInstance is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstance to guarantee forwards compatibility. */
export function getManagedInstance(args: GetManagedInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceResult> {
    pulumi.log.warn("getManagedInstance is deprecated: azure-native:sql/v20220501preview:ManagedInstance is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstance to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:sql/v20220501preview:getManagedInstance", {
        "expand": args.expand,
...
export interface GetManagedInstanceResult {
     ...
     */
    readonly administrators?: outputs.sql.v20220501preview.ManagedInstanceExternalAdministratorResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.sql.v20220501preview.ManagedInstancePecPropertyResponse[];
     ...
     */
    readonly servicePrincipal?: outputs.sql.v20220501preview.ServicePrincipalResponse;
    /**
