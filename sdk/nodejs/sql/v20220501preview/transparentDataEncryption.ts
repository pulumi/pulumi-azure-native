 ...
 *
 * @deprecated azure-native:sql/v20220501preview:TransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:TransparentDataEncryption to guarantee forwards compatibility.
 */
export class TransparentDataEncryption extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransparentDataEncryption {
        pulumi.log.warn("TransparentDataEncryption is deprecated: azure-native:sql/v20220501preview:TransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:TransparentDataEncryption to guarantee forwards compatibility.")
        return new TransparentDataEncryption(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220501preview:TransparentDataEncryption';
...
export interface TransparentDataEncryptionArgs {
     ...
     * Specifies the state of the transparent data encryption.
     */
    state: pulumi.Input<enums.sql.v20220501preview.TransparentDataEncryptionState>;
    /**
