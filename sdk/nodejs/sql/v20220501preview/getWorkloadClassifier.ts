...
export function getWorkloadClassifier(args: GetWorkloadClassifierArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkloadClassifierResult> {
    pulumi.log.warn("getWorkloadClassifier is deprecated: azure-native:sql/v20220501preview:WorkloadClassifier is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:WorkloadClassifier to guarantee forwards compatibility.")
