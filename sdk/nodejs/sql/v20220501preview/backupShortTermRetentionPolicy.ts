...
export class BackupShortTermRetentionPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220501preview:BackupShortTermRetentionPolicy';
