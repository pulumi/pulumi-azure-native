...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220501preview:SyncGroup';
     ...
     */
    public readonly schema!: pulumi.Output<outputs.sql.v20220501preview.SyncGroupSchemaResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SyncGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:SyncGroup" }, { type: "azure-native:sql/v20150501preview:SyncGroup" }, { type: "azure-native:sql/v20190601preview:SyncGroup" }, { type: "azure-native:sql/v20200202preview:SyncGroup" }, { type: "azure-native:sql/v20200801preview:SyncGroup" }, { type: "azure-native:sql/v20201101preview:SyncGroup" }, { type: "azure-native:sql/v20210201preview:SyncGroup" }, { type: "azure-native:sql/v20210501preview:SyncGroup" }, { type: "azure-native:sql/v20210801preview:SyncGroup" }, { type: "azure-native:sql/v20211101:SyncGroup" }, { type: "azure-native:sql/v20211101preview:SyncGroup" }, { type: "azure-native:sql/v20220201preview:SyncGroup" }, { type: "azure-native:sql/v20220801preview:SyncGroup" }, { type: "azure-native:sql/v20221101preview:SyncGroup" }, { type: "azure-native:sql/v20230201preview:SyncGroup" }, { type: "azure-native:sql/v20230501preview:SyncGroup" }, { type: "azure-native:sql/v20230801preview:SyncGroup" }, { type: "azure-native:sql/v20240501preview:SyncGroup" }] };
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20220501preview.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    schema?: pulumi.Input<inputs.sql.v20220501preview.SyncGroupSchemaArgs>;
    /**
