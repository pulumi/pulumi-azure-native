 ...
 */
/** @deprecated azure-native:sql/v20220501preview:InstancePool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:InstancePool to guarantee forwards compatibility. */
export function getInstancePool(args: GetInstancePoolArgs, opts?: pulumi.InvokeOptions): Promise<GetInstancePoolResult> {
    pulumi.log.warn("getInstancePool is deprecated: azure-native:sql/v20220501preview:InstancePool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:InstancePool to guarantee forwards compatibility.")
