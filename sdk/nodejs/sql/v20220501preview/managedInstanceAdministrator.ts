...
export class ManagedInstanceAdministrator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstanceAdministrator {
        pulumi.log.warn("ManagedInstanceAdministrator is deprecated: azure-native:sql/v20220501preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.")
        return new ManagedInstanceAdministrator(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220501preview:ManagedInstanceAdministrator';
...
export interface ManagedInstanceAdministratorArgs {
     ...
     * Type of the managed instance administrator.
     */
    administratorType: pulumi.Input<string | enums.sql.v20220501preview.ManagedInstanceAdministratorType>;
    /**
     * Login name of the managed instance administrator.
     */
