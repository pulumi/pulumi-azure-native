...
export class OutboundFirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OutboundFirewallRule {
        pulumi.log.warn("OutboundFirewallRule is deprecated: azure-native:sql/v20220501preview:OutboundFirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:OutboundFirewallRule to guarantee forwards compatibility.")
    ...
    constructor(name: string, args: OutboundFirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:OutboundFirewallRule" }, { type: "azure-native:sql/v20210201preview:OutboundFirewallRule" }, { type: "azure-native:sql/v20210501preview:OutboundFirewallRule" }, { type: "azure-native:sql/v20210801preview:OutboundFirewallRule" }, { type: "azure-native:sql/v20211101:OutboundFirewallRule" }, { type: "azure-native:sql/v20211101preview:OutboundFirewallRule" }, { type: "azure-native:sql/v20220201preview:OutboundFirewallRule" }, { type: "azure-native:sql/v20220801preview:OutboundFirewallRule" }] };
