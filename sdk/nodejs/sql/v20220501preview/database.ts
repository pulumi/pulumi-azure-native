...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220501preview:Database';
     ...
     */
    public /*out*/ readonly currentSku!: pulumi.Output<outputs.sql.v20220501preview.SkuResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20220501preview.DatabaseIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:Database" }, { type: "azure-native:sql/v20140401:Database" }, { type: "azure-native:sql/v20170301preview:Database" }, { type: "azure-native:sql/v20171001preview:Database" }, { type: "azure-native:sql/v20190601preview:Database" }, { type: "azure-native:sql/v20200202preview:Database" }, { type: "azure-native:sql/v20200801preview:Database" }, { type: "azure-native:sql/v20201101preview:Database" }, { type: "azure-native:sql/v20210201preview:Database" }, { type: "azure-native:sql/v20210501preview:Database" }, { type: "azure-native:sql/v20210801preview:Database" }, { type: "azure-native:sql/v20211101:Database" }, { type: "azure-native:sql/v20211101preview:Database" }, { type: "azure-native:sql/v20220201preview:Database" }, { type: "azure-native:sql/v20220801preview:Database" }, { type: "azure-native:sql/v20221101preview:Database" }, { type: "azure-native:sql/v20230201preview:Database" }, { type: "azure-native:sql/v20230501preview:Database" }, { type: "azure-native:sql/v20230801preview:Database" }, { type: "azure-native:sql/v20240501preview:Database" }] };
...
export interface DatabaseArgs {
     ...
     */
    createMode?: pulumi.Input<string | enums.sql.v20220501preview.CreateMode>;
    /**
     ...
     * The Azure Active Directory identity of the database.
     */
    identity?: pulumi.Input<inputs.sql.v20220501preview.DatabaseIdentityArgs>;
    /**
     * Whether or not this database is a ledger database, which means all tables in the database are ledger tables. Note: the value of this property cannot be changed after the database has been created.
     */
     ...
     * The license type to apply for this database. `LicenseIncluded` if you need a license, or `BasePrice` if you have a license and are eligible for the Azure Hybrid Benefit.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20220501preview.DatabaseLicenseType>;
    /**
     * Resource location.
     */
     ...
     * Type of enclave requested on the database i.e. Default or VBS enclaves.
     */
    preferredEnclaveType?: pulumi.Input<string | enums.sql.v20220501preview.AlwaysEncryptedEnclaveType>;
    /**
     * The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region. Not applicable to a Hyperscale database within an elastic pool.
     */
    readScale?: pulumi.Input<string | enums.sql.v20220501preview.DatabaseReadScale>;
    /**
     ...
     */
    sampleName?: pulumi.Input<string | enums.sql.v20220501preview.SampleName>;
    /**
     * The secondary type of the database if it is a secondary.  Valid values are Geo, Named and Standby.
     */
    secondaryType?: pulumi.Input<string | enums.sql.v20220501preview.SecondaryType>;
    /**
