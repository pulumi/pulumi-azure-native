 ...
 *
 * @deprecated azure-native:sql/v20220501preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.
 */
export class Server extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Server {
        pulumi.log.warn("Server is deprecated: azure-native:sql/v20220501preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.")
        return new Server(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220501preview:Server';
     ...
     */
    public readonly administrators!: pulumi.Output<outputs.sql.v20220501preview.ServerExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20220501preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20220501preview.ServerPrivateEndpointConnectionResponse[]>;
    /**
...
export interface ServerArgs {
     ...
     * The Azure Active Directory administrator of the server. This can only be used at server create time. If used for server update, it will be ignored or it will result in an error. For updates individual APIs will need to be used.
     */
    administrators?: pulumi.Input<inputs.sql.v20220501preview.ServerExternalAdministratorArgs>;
    /**
     * The Client id used for cross tenant CMK scenario
     */
     ...
     * The Azure Active Directory identity of the server.
     */
    identity?: pulumi.Input<inputs.sql.v20220501preview.ResourceIdentityArgs>;
    /**
     * A CMK URI of the key to use for encryption.
     */
     ...
     * Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    publicNetworkAccess?: pulumi.Input<string | enums.sql.v20220501preview.ServerNetworkAccessFlag>;
    /**
     ...
     * Whether or not to restrict outbound network access for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    restrictOutboundNetworkAccess?: pulumi.Input<string | enums.sql.v20220501preview.ServerNetworkAccessFlag>;
    /**
