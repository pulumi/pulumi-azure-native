 ...
 *
 * @deprecated azure-native:sql/v20220501preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:IPv6FirewallRule to guarantee forwards compatibility.
 */
export class IPv6FirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IPv6FirewallRule {
        pulumi.log.warn("IPv6FirewallRule is deprecated: azure-native:sql/v20220501preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:IPv6FirewallRule to guarantee forwards compatibility.")
        return new IPv6FirewallRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220501preview:IPv6FirewallRule';
    ...
    constructor(name: string, args: IPv6FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:IPv6FirewallRule" }, { type: "azure-native:sql/v20210801preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20211101:IPv6FirewallRule" }, { type: "azure-native:sql/v20211101preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20220201preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20220801preview:IPv6FirewallRule" }] };
