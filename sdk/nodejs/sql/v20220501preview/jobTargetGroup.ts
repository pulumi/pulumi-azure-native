...
export class JobTargetGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobTargetGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:JobTargetGroup" }, { type: "azure-native:sql/v20170301preview:JobTargetGroup" }, { type: "azure-native:sql/v20200202preview:JobTargetGroup" }, { type: "azure-native:sql/v20200801preview:JobTargetGroup" }, { type: "azure-native:sql/v20201101preview:JobTargetGroup" }, { type: "azure-native:sql/v20210201preview:JobTargetGroup" }, { type: "azure-native:sql/v20210501preview:JobTargetGroup" }, { type: "azure-native:sql/v20210801preview:JobTargetGroup" }, { type: "azure-native:sql/v20211101:JobTargetGroup" }, { type: "azure-native:sql/v20211101preview:JobTargetGroup" }, { type: "azure-native:sql/v20220201preview:JobTargetGroup" }, { type: "azure-native:sql/v20220801preview:JobTargetGroup" }, { type: "azure-native:sql/v20221101preview:JobTargetGroup" }, { type: "azure-native:sql/v20230201preview:JobTargetGroup" }, { type: "azure-native:sql/v20230501preview:JobTargetGroup" }, { type: "azure-native:sql/v20230801preview:JobTargetGroup" }, { type: "azure-native:sql/v20240501preview:JobTargetGroup" }] };
