...
export class ServerTrustGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20220501preview:ServerTrustGroup';
     ...
     */
    public readonly groupMembers!: pulumi.Output<outputs.sql.v20220501preview.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: ServerTrustGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:ServerTrustGroup" }, { type: "azure-native:sql/v20200202preview:ServerTrustGroup" }, { type: "azure-native:sql/v20200801preview:ServerTrustGroup" }, { type: "azure-native:sql/v20201101preview:ServerTrustGroup" }, { type: "azure-native:sql/v20210201preview:ServerTrustGroup" }, { type: "azure-native:sql/v20210501preview:ServerTrustGroup" }, { type: "azure-native:sql/v20210801preview:ServerTrustGroup" }, { type: "azure-native:sql/v20211101:ServerTrustGroup" }, { type: "azure-native:sql/v20211101preview:ServerTrustGroup" }, { type: "azure-native:sql/v20220201preview:ServerTrustGroup" }, { type: "azure-native:sql/v20220801preview:ServerTrustGroup" }, { type: "azure-native:sql/v20221101preview:ServerTrustGroup" }, { type: "azure-native:sql/v20230201preview:ServerTrustGroup" }, { type: "azure-native:sql/v20230501preview:ServerTrustGroup" }, { type: "azure-native:sql/v20230801preview:ServerTrustGroup" }, { type: "azure-native:sql/v20240501preview:ServerTrustGroup" }] };
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<inputs.sql.v20220501preview.ServerInfoArgs>[]>;
    /**
