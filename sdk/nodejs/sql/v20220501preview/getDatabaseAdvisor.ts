 ...
 */
/** @deprecated azure-native:sql/v20220501preview:DatabaseAdvisor is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:DatabaseAdvisor to guarantee forwards compatibility. */
export function getDatabaseAdvisor(args: GetDatabaseAdvisorArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseAdvisorResult> {
    pulumi.log.warn("getDatabaseAdvisor is deprecated: azure-native:sql/v20220501preview:DatabaseAdvisor is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:DatabaseAdvisor to guarantee forwards compatibility.")
