...
export class JobStep extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:JobStep';
     ...
     */
    public readonly action!: pulumi.Output<outputs.sql.preview.JobStepActionResponse>;
    /**
     ...
     */
    public readonly executionOptions!: pulumi.Output<outputs.sql.preview.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly output!: pulumi.Output<outputs.sql.preview.JobStepOutputResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: JobStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20170301preview:JobStep" }] };
...
export interface JobStepArgs {
     ...
     * The action payload of the job step.
     */
    readonly action: pulumi.Input<inputs.sql.preview.JobStepAction>;
    /**
     * The resource ID of the job credential that will be used to connect to the targets.
     */
     ...
     * Execution options for the job step.
     */
    readonly executionOptions?: pulumi.Input<inputs.sql.preview.JobStepExecutionOptions>;
    /**
     ...
     * Output destination properties of the job step.
     */
    readonly output?: pulumi.Input<inputs.sql.preview.JobStepOutput>;
    /**
