...
export class ManagedDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ManagedDatabase';
    ...
    constructor(name: string, argsOrState?: ManagedDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20170301preview:ManagedDatabase" }, { type: "azurerm:sql/v20180601preview:ManagedDatabase" }, { type: "azurerm:sql/v20190601preview:ManagedDatabase" }, { type: "azurerm:sql/v20200202preview:ManagedDatabase" }] };
...
export interface ManagedDatabaseArgs {
     ...
     * Whether to auto complete restore of this managed database.
     */
    readonly autoCompleteRestore?: pulumi.Input<boolean>;
    /**
     * Collation of the metadata catalog.
     */
     ...
     * Last backup file name for restore of this managed database.
     */
    readonly lastBackupName?: pulumi.Input<string>;
    /**
     * Resource location.
     */
