...
export class ElasticPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ElasticPool';
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<outputs.sql.preview.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
     ...
     * ````
     */
    public readonly sku!: pulumi.Output<outputs.sql.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ElasticPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:ElasticPool" }, { type: "azurerm:sql/v20140401:ElasticPool" }, { type: "azurerm:sql/v20171001preview:ElasticPool" }] };
...
export interface ElasticPoolArgs {
     ...
     * The per database settings for the elastic pool.
     */
    readonly perDatabaseSettings?: pulumi.Input<inputs.sql.preview.ElasticPoolPerDatabaseSettings>;
    /**
     ...
     * ````
     */
    readonly sku?: pulumi.Input<inputs.sql.preview.Sku>;
    /**
     * Resource tags.
     */
