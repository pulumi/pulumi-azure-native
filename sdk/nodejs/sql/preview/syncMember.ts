...
export class SyncMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:SyncMember';
    ...
    constructor(name: string, argsOrState?: SyncMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20150501preview:SyncMember" }, { type: "azurerm:sql/v20190601preview:SyncMember" }] };
