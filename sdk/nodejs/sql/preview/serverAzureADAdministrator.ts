...
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ServerAzureADAdministrator';
    ...
    constructor(name: string, args: ServerAzureADAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:ServerAzureADAdministrator" }, { type: "azurerm:sql/v20140401:ServerAzureADAdministrator" }, { type: "azurerm:sql/v20180601preview:ServerAzureADAdministrator" }, { type: "azurerm:sql/v20190601preview:ServerAzureADAdministrator" }] };
