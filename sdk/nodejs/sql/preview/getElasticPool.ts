...
export function getElasticPool(args: GetElasticPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetElasticPoolResult> {
    ...
    return pulumi.runtime.invoke("azurerm:sql/preview:getElasticPool", {
...
export interface GetElasticPoolResult {
     ...
     */
    readonly perDatabaseSettings?: outputs.sql.preview.ElasticPoolPerDatabaseSettingsResponse;
    /**
