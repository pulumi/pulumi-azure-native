...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:SyncGroup';
     ...
     */
    public readonly schema!: pulumi.Output<outputs.sql.preview.SyncGroupSchemaResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SyncGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20150501preview:SyncGroup" }, { type: "azurerm:sql/v20190601preview:SyncGroup" }] };
...
export interface SyncGroupArgs {
     ...
     * Sync schema of the sync group.
     */
    readonly schema?: pulumi.Input<inputs.sql.preview.SyncGroupSchema>;
    /**
