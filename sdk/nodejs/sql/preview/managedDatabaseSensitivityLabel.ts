...
export class ManagedDatabaseSensitivityLabel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ManagedDatabaseSensitivityLabel';
    ...
    constructor(name: string, argsOrState?: ManagedDatabaseSensitivityLabelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20180601preview:ManagedDatabaseSensitivityLabel" }] };
