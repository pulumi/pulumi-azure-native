...
export class ManagedInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstance {
        return new ManagedInstance(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ManagedInstance';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.preview.ResourceIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20150501preview:ManagedInstance" }, { type: "azurerm:sql/v20180601preview:ManagedInstance" }, { type: "azurerm:sql/v20200202preview:ManagedInstance" }] };
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory identity of the managed instance.
     */
    readonly identity?: pulumi.Input<inputs.sql.preview.ResourceIdentity>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
