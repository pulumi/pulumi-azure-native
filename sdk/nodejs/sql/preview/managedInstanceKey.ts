...
export class ManagedInstanceKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstanceKey {
        return new ManagedInstanceKey(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ManagedInstanceKey';
    ...
    constructor(name: string, argsOrState?: ManagedInstanceKeyArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ManagedInstanceKeyArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20171001preview:ManagedInstanceKey" }] };
