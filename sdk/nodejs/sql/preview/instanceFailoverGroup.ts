...
export class InstanceFailoverGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstanceFailoverGroup {
        return new InstanceFailoverGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:InstanceFailoverGroup';
     ...
     */
    public readonly managedInstancePairs!: pulumi.Output<outputs.sql.preview.ManagedInstancePairInfoResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly partnerRegions!: pulumi.Output<outputs.sql.preview.PartnerRegionInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    public readonly readOnlyEndpoint!: pulumi.Output<outputs.sql.preview.InstanceFailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    public readonly readWriteEndpoint!: pulumi.Output<outputs.sql.preview.InstanceFailoverGroupReadWriteEndpointResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: InstanceFailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as InstanceFailoverGroupArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20171001preview:InstanceFailoverGroup" }] };
...
export interface InstanceFailoverGroupArgs {
     ...
     * List of managed instance pairs in the failover group.
     */
    readonly managedInstancePairs: pulumi.Input<pulumi.Input<inputs.sql.preview.ManagedInstancePairInfo>[]>;
    /**
     * Partner region information for the failover group.
     */
    readonly partnerRegions: pulumi.Input<pulumi.Input<inputs.sql.preview.PartnerRegionInfo>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: pulumi.Input<inputs.sql.preview.InstanceFailoverGroupReadOnlyEndpoint>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Input<inputs.sql.preview.InstanceFailoverGroupReadWriteEndpoint>;
    /**
