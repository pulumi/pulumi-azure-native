...
export class ServerAzureADOnlyAuthentication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ServerAzureADOnlyAuthentication';
    ...
    constructor(name: string, args: ServerAzureADOnlyAuthenticationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20200202preview:ServerAzureADOnlyAuthentication" }] };
