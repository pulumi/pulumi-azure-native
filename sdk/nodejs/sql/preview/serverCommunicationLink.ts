...
export class ServerCommunicationLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ServerCommunicationLink';
    ...
    constructor(name: string, argsOrState?: ServerCommunicationLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:ServerCommunicationLink" }, { type: "azurerm:sql/v20140401:ServerCommunicationLink" }] };
