...
export class JobTargetGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:JobTargetGroup';
     ...
     */
    public readonly members!: pulumi.Output<outputs.sql.preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: JobTargetGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20170301preview:JobTargetGroup" }] };
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    readonly members: pulumi.Input<pulumi.Input<inputs.sql.preview.JobTarget>[]>;
    /**
