...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:Job';
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.sql.preview.JobScheduleResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, argsOrState?: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20170301preview:Job" }] };
...
export interface JobArgs {
     ...
     * Schedule properties of the job.
     */
    readonly schedule?: pulumi.Input<inputs.sql.preview.JobSchedule>;
    /**
