...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:Server';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.preview.ServerPrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:Server" }, { type: "azurerm:sql/v20140401:Server" }, { type: "azurerm:sql/v20150501preview:Server" }, { type: "azurerm:sql/v20190601preview:Server" }] };
