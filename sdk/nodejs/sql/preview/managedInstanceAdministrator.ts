...
export class ManagedInstanceAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:ManagedInstanceAdministrator';
    ...
    constructor(name: string, argsOrState?: ManagedInstanceAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20170301preview:ManagedInstanceAdministrator" }] };
