...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/preview:Database';
     ...
     */
    public /*out*/ readonly currentSku!: pulumi.Output<outputs.sql.preview.SkuResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:Database" }, { type: "azurerm:sql/v20140401:Database" }, { type: "azurerm:sql/v20170301preview:Database" }, { type: "azurerm:sql/v20171001preview:Database" }, { type: "azurerm:sql/v20190601preview:Database" }] };
