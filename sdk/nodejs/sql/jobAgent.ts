...
export class JobAgent extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<outputs.sql.JobAgentIdentityResponse | undefined>;
    /**
     * Resource location.
     */
