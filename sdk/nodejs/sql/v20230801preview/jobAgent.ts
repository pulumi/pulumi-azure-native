...
export class JobAgent extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20230801preview.JobAgentIdentityResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface JobAgentArgs {
     ...
     * The identity of the job agent.
     */
    identity?: pulumi.Input<inputs.sql.v20230801preview.JobAgentIdentityArgs>;
    /**
