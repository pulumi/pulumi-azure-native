...
export class ServerTrustGroup extends pulumi.CustomResource {
     ...
     */
    public readonly groupMembers!: pulumi.Output<outputs.sql.v20230801preview.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<inputs.sql.v20230801preview.ServerInfoArgs>[]>;
    /**
