...
export interface GetServerResult {
     ...
     */
    readonly administrators?: outputs.sql.v20230801preview.ServerExternalAdministratorResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.sql.v20230801preview.ServerPrivateEndpointConnectionResponse[];
    /**
...
export function getServerOutput(args: GetServerOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetServerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20230801preview:getServer", {
        "expand": args.expand,
        "resourceGroupName": args.resourceGroupName,
        "serverName": args.serverName,
    }, opts);
