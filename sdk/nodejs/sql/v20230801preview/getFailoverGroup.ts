...
export interface GetFailoverGroupResult {
     ...
     */
    readonly partnerServers: outputs.sql.v20230801preview.PartnerInfoResponse[];
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: outputs.sql.v20230801preview.FailoverGroupReadOnlyEndpointResponse;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: outputs.sql.v20230801preview.FailoverGroupReadWriteEndpointResponse;
    /**
...
export function getFailoverGroupOutput(args: GetFailoverGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFailoverGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20230801preview:getFailoverGroup", {
        "failoverGroupName": args.failoverGroupName,
        "resourceGroupName": args.resourceGroupName,
        "serverName": args.serverName,
    }, opts);
