...
export class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
     ...
     * Schedule list.
     */
    public readonly scheduleList!: pulumi.Output<outputs.sql.v20230801preview.ScheduleItemResponse[]>;
    /**
...
export interface StartStopManagedInstanceScheduleArgs {
     ...
     * Schedule list.
     */
    scheduleList: pulumi.Input<pulumi.Input<inputs.sql.v20230801preview.ScheduleItemArgs>[]>;
    /**
