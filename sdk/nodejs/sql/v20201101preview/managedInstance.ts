...
export class ManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20201101preview:ManagedInstance';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20201101preview.ManagedInstancePecPropertyResponse[]>;
    ...
    constructor(name: string, args: ManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20201101preview:ManagedInstance" }, { type: "azure-native:sql:ManagedInstance" }, { type: "azure-nextgen:sql:ManagedInstance" }, { type: "azure-native:sql/v20150501preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20150501preview:ManagedInstance" }, { type: "azure-native:sql/v20180601preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20180601preview:ManagedInstance" }, { type: "azure-native:sql/v20200202preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20200202preview:ManagedInstance" }, { type: "azure-native:sql/v20200801preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20200801preview:ManagedInstance" }, { type: "azure-native:sql/v20210201preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20210201preview:ManagedInstance" }] };
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory identity of the managed instance.
     */
    readonly identity?: pulumi.Input<inputs.sql.v20201101preview.ResourceIdentityWithUserAssignedIdentitiesArgs>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
