...
export class DatabaseAdvisor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20201101preview:DatabaseAdvisor';
     ...
     */
    public /*out*/ readonly recommendedActions!: pulumi.Output<outputs.sql.v20201101preview.RecommendedActionResponse[]>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: DatabaseAdvisorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20201101preview:DatabaseAdvisor" }, { type: "azure-native:sql:DatabaseAdvisor" }, { type: "azure-nextgen:sql:DatabaseAdvisor" }, { type: "azure-native:sql/v20140401:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20140401:DatabaseAdvisor" }, { type: "azure-native:sql/v20150501preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20150501preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20200202preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20200202preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20200801preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20200801preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20210201preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20210201preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20210501preview:DatabaseAdvisor" }, { type: "azure-nextgen:sql/v20210501preview:DatabaseAdvisor" }] };
...
export interface DatabaseAdvisorArgs {
     ...
     * Gets the auto-execute status (whether to let the system execute the recommendations) of this advisor. Possible values are 'Enabled' and 'Disabled'
     */
    autoExecuteStatus: pulumi.Input<enums.sql.v20201101preview.AutoExecuteStatus>;
    /**
