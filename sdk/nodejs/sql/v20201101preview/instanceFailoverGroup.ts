...
export interface InstanceFailoverGroupArgs {
     ...
     * List of managed instance pairs in the failover group.
     */
    readonly managedInstancePairs: pulumi.Input<pulumi.Input<inputs.sql.v20201101preview.ManagedInstancePairInfo>[]>;
    /**
     * Partner region information for the failover group.
     */
    readonly partnerRegions: pulumi.Input<pulumi.Input<inputs.sql.v20201101preview.PartnerRegionInfo>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: pulumi.Input<inputs.sql.v20201101preview.InstanceFailoverGroupReadOnlyEndpoint>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Input<inputs.sql.v20201101preview.InstanceFailoverGroupReadWriteEndpoint>;
    /**
