...
export class GeoBackupPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GeoBackupPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:GeoBackupPolicy" }, { type: "azure-native:sql/v20140401:GeoBackupPolicy" }, { type: "azure-nextgen:sql/v20140401:GeoBackupPolicy" }] };
