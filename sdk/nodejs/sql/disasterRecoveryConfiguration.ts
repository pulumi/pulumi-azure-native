...
export class DisasterRecoveryConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DisasterRecoveryConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:DisasterRecoveryConfiguration" }, { type: "azure-native:sql/latest:DisasterRecoveryConfiguration" }, { type: "azure-nextgen:sql/latest:DisasterRecoveryConfiguration" }, { type: "azure-native:sql/v20140401:DisasterRecoveryConfiguration" }, { type: "azure-nextgen:sql/v20140401:DisasterRecoveryConfiguration" }] };
