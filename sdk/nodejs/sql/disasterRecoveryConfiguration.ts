...
export class DisasterRecoveryConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql:DisasterRecoveryConfiguration';
    ...
    constructor(name: string, args: DisasterRecoveryConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/latest:DisasterRecoveryConfiguration" }, { type: "azure-nextgen:sql/v20140401:DisasterRecoveryConfiguration" }] };
