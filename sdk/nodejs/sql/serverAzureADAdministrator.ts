...
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql:ServerAzureADAdministrator';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.sql.ServerAdministratorPropertiesResponse>;
    /**
     * Resource type.
     */
...
export interface ServerAzureADAdministratorArgs {
     ...
     * The properties of the resource.
     */
    readonly properties?: pulumi.Input<inputs.sql.ServerAdministratorProperties>;
    /**
