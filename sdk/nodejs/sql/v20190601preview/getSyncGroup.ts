...
export function getSyncGroup(args: GetSyncGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetSyncGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:sql/v20190601preview:getSyncGroup", {
...
export interface GetSyncGroupResult {
     ...
     */
    readonly schema?: outputs.sql.v20190601preview.SyncGroupSchemaInvokeResponse;
    /**
