...
export class WorkloadGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkloadGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:WorkloadGroup" }, { type: "azure-nextgen:sql/v20200202preview:WorkloadGroup" }, { type: "azure-nextgen:sql/v20200801preview:WorkloadGroup" }] };
