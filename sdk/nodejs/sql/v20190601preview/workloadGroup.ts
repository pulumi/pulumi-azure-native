...
export class WorkloadGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadGroup {
        return new WorkloadGroup(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: WorkloadGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:WorkloadGroup" }] };
