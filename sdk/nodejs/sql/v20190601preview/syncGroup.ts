...
export class SyncGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SyncGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20150501preview:SyncGroup" }, { type: "azure-nextgen:sql/v20200202preview:SyncGroup" }, { type: "azure-nextgen:sql/v20200801preview:SyncGroup" }] };
