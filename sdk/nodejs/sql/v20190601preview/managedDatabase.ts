...
export class ManagedDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/v20190601preview:ManagedDatabase';
    ...
    constructor(name: string, argsOrState?: ManagedDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:ManagedDatabase" }, { type: "azurerm:sql/v20170301preview:ManagedDatabase" }, { type: "azurerm:sql/v20180601preview:ManagedDatabase" }, { type: "azurerm:sql/v20200202preview:ManagedDatabase" }] };
