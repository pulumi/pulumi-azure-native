...
export class WorkloadClassifier extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkloadClassifierArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:WorkloadClassifier" }, { type: "azure-nextgen:sql/v20200202preview:WorkloadClassifier" }, { type: "azure-nextgen:sql/v20200801preview:WorkloadClassifier" }] };
