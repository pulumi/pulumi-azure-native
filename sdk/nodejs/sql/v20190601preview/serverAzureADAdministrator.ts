...
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/v20190601preview:ServerAzureADAdministrator';
    ...
    constructor(name: string, argsOrState?: ServerAzureADAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/latest:ServerAzureADAdministrator" }, { type: "azurerm:sql/preview:ServerAzureADAdministrator" }, { type: "azurerm:sql/v20140401:ServerAzureADAdministrator" }, { type: "azurerm:sql/v20180601preview:ServerAzureADAdministrator" }] };
