...
export class FailoverGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:FailoverGroup" }, { type: "azure-native:sql/v20150501preview:FailoverGroup" }, { type: "azure-nextgen:sql/v20150501preview:FailoverGroup" }, { type: "azure-native:sql/v20200202preview:FailoverGroup" }, { type: "azure-nextgen:sql/v20200202preview:FailoverGroup" }, { type: "azure-native:sql/v20200801preview:FailoverGroup" }, { type: "azure-nextgen:sql/v20200801preview:FailoverGroup" }, { type: "azure-native:sql/v20201101preview:FailoverGroup" }, { type: "azure-nextgen:sql/v20201101preview:FailoverGroup" }, { type: "azure-native:sql/v20210201preview:FailoverGroup" }, { type: "azure-nextgen:sql/v20210201preview:FailoverGroup" }] };
...
export interface FailoverGroupArgs {
     ...
     * List of partner server information for the failover group.
     */
    readonly partnerServers: pulumi.Input<pulumi.Input<inputs.sql.PartnerInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: pulumi.Input<inputs.sql.FailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Input<inputs.sql.FailoverGroupReadWriteEndpointArgs>;
    /**
