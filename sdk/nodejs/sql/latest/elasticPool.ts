...
export class ElasticPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/latest:ElasticPool';
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<outputs.sql.latest.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ElasticPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20140401:ElasticPool" }, { type: "azurerm:sql/v20171001preview:ElasticPool" }] };
...
export interface ElasticPoolArgs {
     ...
     * The per database settings for the elastic pool.
     */
    readonly perDatabaseSettings?: pulumi.Input<inputs.sql.latest.ElasticPoolPerDatabaseSettings>;
    /**
