...
export interface ElasticPoolArgs {
     ...
     * The edition of the elastic pool.
     */
    readonly edition?: pulumi.Input<string | enums.sql.latest.ElasticPoolEdition>;
    /**
