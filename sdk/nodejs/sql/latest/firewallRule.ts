...
export class FirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/latest:FirewallRule';
    ...
    constructor(name: string, args: FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:FirewallRule" }, { type: "azurerm:sql/v20140401:FirewallRule" }, { type: "azurerm:sql/v20150501preview:FirewallRule" }] };
