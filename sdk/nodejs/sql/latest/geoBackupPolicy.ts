...
export class GeoBackupPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GeoBackupPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["geoBackupPolicyName"] = args ? args.geoBackupPolicyName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/latest:GeoBackupPolicy" }, { type: "azure-native:sql:GeoBackupPolicy" }, { type: "azure-nextgen:sql:GeoBackupPolicy" }, { type: "azure-native:sql/v20140401:GeoBackupPolicy" }, { type: "azure-nextgen:sql/v20140401:GeoBackupPolicy" }] };
...
export interface GeoBackupPolicyArgs {
     ...
     * The state of the geo backup policy.
     */
    readonly state: pulumi.Input<enums.sql.latest.GeoBackupPolicyState>;
}
