...
export class Server extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:Server" }, { type: "azurerm:sql/v20140401:Server" }, { type: "azurerm:sql/v20150501preview:Server" }, { type: "azurerm:sql/v20190601preview:Server" }] };
