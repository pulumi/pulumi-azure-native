...
export class TransparentDataEncryption extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TransparentDataEncryptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/latest:TransparentDataEncryption" }, { type: "azure-native:sql:TransparentDataEncryption" }, { type: "azure-nextgen:sql:TransparentDataEncryption" }, { type: "azure-native:sql/v20140401:TransparentDataEncryption" }, { type: "azure-nextgen:sql/v20140401:TransparentDataEncryption" }, { type: "azure-native:sql/v20200202preview:TransparentDataEncryption" }, { type: "azure-nextgen:sql/v20200202preview:TransparentDataEncryption" }, { type: "azure-native:sql/v20200801preview:TransparentDataEncryption" }, { type: "azure-nextgen:sql/v20200801preview:TransparentDataEncryption" }] };
...
export interface TransparentDataEncryptionArgs {
     ...
     * The status of the database transparent data encryption.
     */
    readonly status?: pulumi.Input<string | enums.sql.latest.TransparentDataEncryptionStatus>;
    /**
