 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:sql:DataMaskingPolicy'.
 */
export class DataMaskingPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataMaskingPolicy {
        pulumi.log.warn("DataMaskingPolicy is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:sql:DataMaskingPolicy'.")
        return new DataMaskingPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/latest:DataMaskingPolicy';
    ...
    constructor(name: string, args: DataMaskingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/latest:DataMaskingPolicy" }, { type: "azure-native:sql:DataMaskingPolicy" }, { type: "azure-nextgen:sql:DataMaskingPolicy" }, { type: "azure-native:sql/v20140401:DataMaskingPolicy" }, { type: "azure-nextgen:sql/v20140401:DataMaskingPolicy" }] };
...
export interface DataMaskingPolicyArgs {
     ...
     * The state of the data masking policy.
     */
    readonly dataMaskingState: pulumi.Input<enums.sql.latest.DataMaskingState>;
    /**
