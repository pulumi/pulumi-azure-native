 ...
 *
 * @deprecated azure-native:sql/v20211101preview:ServerTrustGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.
 */
export class ServerTrustGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerTrustGroup {
        pulumi.log.warn("ServerTrustGroup is deprecated: azure-native:sql/v20211101preview:ServerTrustGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.")
        return new ServerTrustGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101preview:ServerTrustGroup';
     ...
     */
    public readonly groupMembers!: pulumi.Output<outputs.sql.v20211101preview.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
