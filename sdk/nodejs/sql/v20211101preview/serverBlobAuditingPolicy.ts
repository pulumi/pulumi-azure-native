...
export class ServerBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerBlobAuditingPolicy {
        pulumi.log.warn("ServerBlobAuditingPolicy is deprecated: azure-native:sql/v20211101preview:ServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerBlobAuditingPolicy to guarantee forwards compatibility.")
        return new ServerBlobAuditingPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101preview:ServerBlobAuditingPolicy';
