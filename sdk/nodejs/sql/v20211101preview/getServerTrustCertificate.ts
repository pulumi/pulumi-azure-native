...
export function getServerTrustCertificate(args: GetServerTrustCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetServerTrustCertificateResult> {
    pulumi.log.warn("getServerTrustCertificate is deprecated: azure-native:sql/v20211101preview:ServerTrustCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerTrustCertificate to guarantee forwards compatibility.")
