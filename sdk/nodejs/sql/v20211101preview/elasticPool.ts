 ...
 * An elastic pool.
 *
 * @deprecated azure-native:sql/v20211101preview:ElasticPool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ElasticPool to guarantee forwards compatibility.
 */
export class ElasticPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101preview:ElasticPool';
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<outputs.sql.v20211101preview.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
