...
export class JobStep extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101preview:JobStep';
     ...
     */
    public readonly action!: pulumi.Output<outputs.sql.v20211101preview.JobStepActionResponse>;
    /**
     ...
     */
    public readonly executionOptions!: pulumi.Output<outputs.sql.v20211101preview.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly output!: pulumi.Output<outputs.sql.v20211101preview.JobStepOutputResponse | undefined>;
    /**
    ...
    constructor(name: string, args: JobStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["action"] = args ? (args.action ? pulumi.output(args.action).apply(inputs.sql.v20211101preview.jobStepActionArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["credential"] = args ? args.credential : undefined;
            resourceInputs["executionOptions"] = args ? (args.executionOptions ? pulumi.output(args.executionOptions).apply(inputs.sql.v20211101preview.jobStepExecutionOptionsArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["jobAgentName"] = args ? args.jobAgentName : undefined;
            resourceInputs["jobName"] = args ? args.jobName : undefined;
            resourceInputs["output"] = args ? (args.output ? pulumi.output(args.output).apply(inputs.sql.v20211101preview.jobStepOutputArgsProvideDefaults) : undefined) : undefined;
