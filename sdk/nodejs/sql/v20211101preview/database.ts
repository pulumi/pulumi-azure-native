...
export class Database extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Database {
        pulumi.log.warn("Database is deprecated: azure-native:sql/v20211101preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.")
        return new Database(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101preview:Database';
     ...
     */
    public /*out*/ readonly currentSku!: pulumi.Output<outputs.sql.v20211101preview.SkuResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20211101preview.DatabaseIdentityResponse | undefined>;
    /**
