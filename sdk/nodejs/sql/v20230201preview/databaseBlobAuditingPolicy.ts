...
export class DatabaseBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230201preview:DatabaseBlobAuditingPolicy';
...
export interface DatabaseBlobAuditingPolicyArgs {
     ...
     * Specifies the state of the audit. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
     */
    state: pulumi.Input<enums.sql.v20230201preview.BlobAuditingPolicyState>;
    /**
