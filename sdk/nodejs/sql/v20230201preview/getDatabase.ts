...
export function getDatabase(args: GetDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20230201preview:getDatabase", {
...
export interface GetDatabaseResult {
     ...
     */
    readonly currentSku: outputs.sql.v20230201preview.SkuResponse;
    /**
     ...
     */
    readonly identity?: outputs.sql.v20230201preview.DatabaseIdentityResponse;
    /**
     ...
     */
    readonly keys?: {[key: string]: outputs.sql.v20230201preview.DatabaseKeyResponse};
    /**
...
export function getDatabaseOutput(args: GetDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20230201preview:getDatabase", {
        "databaseName": args.databaseName,
        "expand": args.expand,
        "filter": args.filter,
        "resourceGroupName": args.resourceGroupName,
