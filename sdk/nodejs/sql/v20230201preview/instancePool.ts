...
export class InstancePool extends pulumi.CustomResource {
     ...
     */
    public readonly sku!: pulumi.Output<outputs.sql.v20230201preview.SkuResponse | undefined>;
    /**
...
export interface InstancePoolArgs {
     ...
     * The license type. Possible values are 'LicenseIncluded' (price for SQL license is included) and 'BasePrice' (without SQL license price).
     */
    licenseType: pulumi.Input<string | enums.sql.v20230201preview.InstancePoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The name and tier of the SKU.
     */
    sku?: pulumi.Input<inputs.sql.v20230201preview.SkuArgs>;
    /**
     * Resource ID of the subnet to place this instance pool in.
     */
