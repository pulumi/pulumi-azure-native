...
export function getManagedInstance(args: GetManagedInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20230201preview:getManagedInstance", {
        "expand": args.expand,
...
export interface GetManagedInstanceResult {
     ...
     */
    readonly administrators?: outputs.sql.v20230201preview.ManagedInstanceExternalAdministratorResponse;
    /**
     ...
     */
    readonly identity?: outputs.sql.v20230201preview.ResourceIdentityResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.sql.v20230201preview.ManagedInstancePecPropertyResponse[];
    /**
     ...
     */
    readonly servicePrincipal?: outputs.sql.v20230201preview.ServicePrincipalResponse;
    /**
     * Managed instance SKU. Allowed values for sku.name: GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen5, BC_G8IM, BC_G8IH
     */
    readonly sku?: outputs.sql.v20230201preview.SkuResponse;
    /**
...
export function getManagedInstanceOutput(args: GetManagedInstanceOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetManagedInstanceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20230201preview:getManagedInstance", {
        "expand": args.expand,
        "managedInstanceName": args.managedInstanceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
