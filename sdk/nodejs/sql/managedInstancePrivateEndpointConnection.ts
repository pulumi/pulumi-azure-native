...
export class ManagedInstancePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:sql:ManagedInstancePrivateEndpointConnection';
    ...
    constructor(name: string, args: ManagedInstancePrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:ManagedInstancePrivateEndpointConnection" }, { type: "azure-nextgen:sql/v20200801preview:ManagedInstancePrivateEndpointConnection" }] };
...
export interface ManagedInstancePrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    readonly privateEndpoint?: pulumi.Input<inputs.sql.ManagedInstancePrivateEndpointProperty>;
    readonly privateEndpointConnectionName: pulumi.Input<string>;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    readonly privateLinkServiceConnectionState?: pulumi.Input<inputs.sql.ManagedInstancePrivateLinkServiceConnectionStateProperty>;
    /**
