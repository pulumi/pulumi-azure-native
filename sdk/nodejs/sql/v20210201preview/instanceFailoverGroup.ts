...
export class InstanceFailoverGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstanceFailoverGroup {
        pulumi.log.warn("InstanceFailoverGroup is deprecated: azure-native:sql/v20210201preview:InstanceFailoverGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:InstanceFailoverGroup to guarantee forwards compatibility.")
