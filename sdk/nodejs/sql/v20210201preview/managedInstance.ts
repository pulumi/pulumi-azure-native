...
export class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    public readonly administrators!: pulumi.Output<outputs.sql.v20210201preview.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20210201preview.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20210201preview.ManagedInstancePecPropertyResponse[]>;
    ...
    constructor(name: string, args: ManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20210201preview:ManagedInstance" }, { type: "azure-native:sql:ManagedInstance" }, { type: "azure-nextgen:sql:ManagedInstance" }, { type: "azure-native:sql/v20150501preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20150501preview:ManagedInstance" }, { type: "azure-native:sql/v20180601preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20180601preview:ManagedInstance" }, { type: "azure-native:sql/v20200202preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20200202preview:ManagedInstance" }, { type: "azure-native:sql/v20200801preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20200801preview:ManagedInstance" }, { type: "azure-native:sql/v20201101preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20201101preview:ManagedInstance" }, { type: "azure-native:sql/v20210501preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20210501preview:ManagedInstance" }] };
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory administrator of the server.
     */
    administrators?: pulumi.Input<inputs.sql.v20210201preview.ManagedInstanceExternalAdministratorArgs>;
    /**
     * Collation of the managed instance.
     */
     ...
     * The Azure Active Directory identity of the managed instance.
     */
    identity?: pulumi.Input<inputs.sql.v20210201preview.ResourceIdentityArgs>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    licenseType?: pulumi.Input<string | enums.sql.v20210201preview.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    managedInstanceCreateMode?: pulumi.Input<string | enums.sql.v20210201preview.ManagedServerCreateMode>;
    /**
     ...
     * Connection type used for connecting to the instance.
     */
    proxyOverride?: pulumi.Input<string | enums.sql.v20210201preview.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
     ...
     * The storage account type used to store backups for this instance. The options are LRS (LocallyRedundantStorage), ZRS (ZoneRedundantStorage) and GRS (GeoRedundantStorage)
     */
    storageAccountType?: pulumi.Input<string | enums.sql.v20210201preview.StorageAccountType>;
    /**
     * Storage size in GB. Minimum value: 32. Maximum value: 8192. Increments of 32 GB allowed only.
     */
