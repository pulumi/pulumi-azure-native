...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210201preview:Server';
     ...
     */
    public readonly administrators!: pulumi.Output<outputs.sql.v20210201preview.ServerExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20210201preview.ServerPrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20210201preview:Server" }, { type: "azure-native:sql:Server" }, { type: "azure-nextgen:sql:Server" }, { type: "azure-native:sql/v20140401:Server" }, { type: "azure-nextgen:sql/v20140401:Server" }, { type: "azure-native:sql/v20150501preview:Server" }, { type: "azure-nextgen:sql/v20150501preview:Server" }, { type: "azure-native:sql/v20190601preview:Server" }, { type: "azure-nextgen:sql/v20190601preview:Server" }, { type: "azure-native:sql/v20200202preview:Server" }, { type: "azure-nextgen:sql/v20200202preview:Server" }, { type: "azure-native:sql/v20200801preview:Server" }, { type: "azure-nextgen:sql/v20200801preview:Server" }, { type: "azure-native:sql/v20201101preview:Server" }, { type: "azure-nextgen:sql/v20201101preview:Server" }, { type: "azure-native:sql/v20210501preview:Server" }, { type: "azure-nextgen:sql/v20210501preview:Server" }] };
...
export interface ServerArgs {
     ...
     * The Azure Active Directory identity of the server.
     */
    administrators?: pulumi.Input<inputs.sql.v20210201preview.ServerExternalAdministratorArgs>;
    /**
     * The Client id used for cross tenant CMK scenario
     */
     ...
     * Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    publicNetworkAccess?: pulumi.Input<string | enums.sql.v20210201preview.ServerNetworkAccessFlag>;
    /**
     ...
     * Whether or not to restrict outbound network access for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    restrictOutboundNetworkAccess?: pulumi.Input<string | enums.sql.v20210201preview.ServerNetworkAccessFlag>;
    /**
