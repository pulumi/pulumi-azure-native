...
export interface TransparentDataEncryptionArgs {
     ...
     * Specifies the state of the transparent data encryption.
     */
    readonly state: pulumi.Input<enums.sql.v20210201preview.TransparentDataEncryptionState>;
    /**
