 ...
 * A failover group.
 *
 * @deprecated azure-native:sql/v20210201preview:FailoverGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FailoverGroup to guarantee forwards compatibility.
 */
export class FailoverGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FailoverGroup {
        pulumi.log.warn("FailoverGroup is deprecated: azure-native:sql/v20210201preview:FailoverGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FailoverGroup to guarantee forwards compatibility.")
        return new FailoverGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210201preview:FailoverGroup';
     ...
     */
    public readonly partnerServers!: pulumi.Output<outputs.sql.v20210201preview.PartnerInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    public readonly readOnlyEndpoint!: pulumi.Output<outputs.sql.v20210201preview.FailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    public readonly readWriteEndpoint!: pulumi.Output<outputs.sql.v20210201preview.FailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface FailoverGroupArgs {
     ...
     * List of partner server information for the failover group.
     */
    partnerServers: pulumi.Input<pulumi.Input<inputs.sql.v20210201preview.PartnerInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<inputs.sql.v20210201preview.FailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<inputs.sql.v20210201preview.FailoverGroupReadWriteEndpointArgs>;
    /**
