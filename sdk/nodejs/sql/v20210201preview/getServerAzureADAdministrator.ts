...
export function getServerAzureADAdministrator(args: GetServerAzureADAdministratorArgs, opts?: pulumi.InvokeOptions): Promise<GetServerAzureADAdministratorResult> {
    pulumi.log.warn("getServerAzureADAdministrator is deprecated: azure-native:sql/v20210201preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerAzureADAdministrator to guarantee forwards compatibility.")
