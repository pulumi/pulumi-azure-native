...
export function getManagedInstanceAdministrator(args: GetManagedInstanceAdministratorArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceAdministratorResult> {
    pulumi.log.warn("getManagedInstanceAdministrator is deprecated: azure-native:sql/v20210201preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.")
