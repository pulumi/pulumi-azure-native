...
export class ManagedInstancePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstancePrivateEndpointConnection {
        pulumi.log.warn("ManagedInstancePrivateEndpointConnection is deprecated: azure-native:sql/v20210201preview:ManagedInstancePrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection to guarantee forwards compatibility.")
