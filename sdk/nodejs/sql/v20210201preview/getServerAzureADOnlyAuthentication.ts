...
export function getServerAzureADOnlyAuthentication(args: GetServerAzureADOnlyAuthenticationArgs, opts?: pulumi.InvokeOptions): Promise<GetServerAzureADOnlyAuthenticationResult> {
    pulumi.log.warn("getServerAzureADOnlyAuthentication is deprecated: azure-native:sql/v20210201preview:ServerAzureADOnlyAuthentication is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAzureADOnlyAuthentication to guarantee forwards compatibility.")
