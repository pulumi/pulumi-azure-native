...
export function getServerAzureADOnlyAuthentication(args: GetServerAzureADOnlyAuthenticationArgs, opts?: pulumi.InvokeOptions): Promise<GetServerAzureADOnlyAuthenticationResult> {
    pulumi.log.warn("getServerAzureADOnlyAuthentication is deprecated: azure-native:sql/v20210201preview:ServerAzureADOnlyAuthentication is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerAzureADOnlyAuthentication to guarantee forwards compatibility.")
