...
export class ServerTrustGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerTrustGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:ServerTrustGroup" }, { type: "azure-native:sql/v20200202preview:ServerTrustGroup" }, { type: "azure-nextgen:sql/v20200202preview:ServerTrustGroup" }, { type: "azure-native:sql/v20200801preview:ServerTrustGroup" }, { type: "azure-nextgen:sql/v20200801preview:ServerTrustGroup" }] };
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    readonly groupMembers: pulumi.Input<pulumi.Input<inputs.sql.ServerInfo>[]>;
    /**
