...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateEndpointConnection {
        pulumi.log.warn("PrivateEndpointConnection is deprecated: azure-native:sql/v20180601preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:PrivateEndpointConnection to guarantee forwards compatibility.")
