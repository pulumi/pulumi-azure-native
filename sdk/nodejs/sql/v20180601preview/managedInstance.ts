...
export class ManagedInstance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/preview:ManagedInstance" }, { type: "azurerm:sql/v20150501preview:ManagedInstance" }, { type: "azurerm:sql/v20200202preview:ManagedInstance" }] };
