...
export class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20180601preview.ResourceIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20150501preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20200202preview:ManagedInstance" }, { type: "azure-nextgen:sql/v20200801preview:ManagedInstance" }] };
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory identity of the managed instance.
     */
    readonly identity?: pulumi.Input<inputs.sql.v20180601preview.ResourceIdentity>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    readonly licenseType?: pulumi.Input<string | enums.sql.v20180601preview.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     * Restore: Creates an instance by restoring a set of backups to specific point in time. RestorePointInTime and SourceManagedInstanceId must be specified.
     */
    readonly managedInstanceCreateMode?: pulumi.Input<string | enums.sql.v20180601preview.ManagedServerCreateMode>;
    /**
     ...
     * Connection type used for connecting to the instance.
     */
    readonly proxyOverride?: pulumi.Input<string | enums.sql.v20180601preview.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
