...
export class InstancePool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InstancePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20180601preview:InstancePool" }, { type: "azure-native:sql:InstancePool" }, { type: "azure-nextgen:sql:InstancePool" }, { type: "azure-native:sql/v20200202preview:InstancePool" }, { type: "azure-nextgen:sql/v20200202preview:InstancePool" }, { type: "azure-native:sql/v20200801preview:InstancePool" }, { type: "azure-nextgen:sql/v20200801preview:InstancePool" }, { type: "azure-native:sql/v20201101preview:InstancePool" }, { type: "azure-nextgen:sql/v20201101preview:InstancePool" }, { type: "azure-native:sql/v20210201preview:InstancePool" }, { type: "azure-nextgen:sql/v20210201preview:InstancePool" }] };
...
export interface InstancePoolArgs {
     ...
     * The license type. Possible values are 'LicenseIncluded' (price for SQL license is included) and 'BasePrice' (without SQL license price).
     */
    readonly licenseType: pulumi.Input<string | enums.sql.v20180601preview.InstancePoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The name and tier of the SKU.
     */
    readonly sku?: pulumi.Input<inputs.sql.v20180601preview.SkuArgs>;
    /**
     * Resource ID of the subnet to place this instance pool in.
     */
