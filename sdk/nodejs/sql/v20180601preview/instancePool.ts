...
export class InstancePool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InstancePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:InstancePool" }, { type: "azure-nextgen:sql:InstancePool" }, { type: "azure-native:sql/v20200202preview:InstancePool" }, { type: "azure-nextgen:sql/v20200202preview:InstancePool" }, { type: "azure-native:sql/v20200801preview:InstancePool" }, { type: "azure-nextgen:sql/v20200801preview:InstancePool" }] };
