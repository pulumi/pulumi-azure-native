 ...
 *
 * @deprecated azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ExtendedDatabaseBlobAuditingPolicy to guarantee forwards compatibility.
 */
export class ExtendedDatabaseBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExtendedDatabaseBlobAuditingPolicy {
        pulumi.log.warn("ExtendedDatabaseBlobAuditingPolicy is deprecated: azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ExtendedDatabaseBlobAuditingPolicy to guarantee forwards compatibility.")
        return new ExtendedDatabaseBlobAuditingPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy';
