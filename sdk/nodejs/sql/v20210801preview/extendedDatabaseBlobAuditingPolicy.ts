...
export class ExtendedDatabaseBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ExtendedDatabaseBlobAuditingPolicy {
        pulumi.log.warn("ExtendedDatabaseBlobAuditingPolicy is deprecated: azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ExtendedDatabaseBlobAuditingPolicy to guarantee forwards compatibility.")
