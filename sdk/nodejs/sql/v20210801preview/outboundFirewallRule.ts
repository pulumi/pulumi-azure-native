...
export class OutboundFirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OutboundFirewallRule {
        pulumi.log.warn("OutboundFirewallRule is deprecated: azure-native:sql/v20210801preview:OutboundFirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:OutboundFirewallRule to guarantee forwards compatibility.")
