 ...
 *
 * @deprecated azure-native:sql/v20210801preview:JobTargetGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobTargetGroup to guarantee forwards compatibility.
 */
export class JobTargetGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobTargetGroup {
        pulumi.log.warn("JobTargetGroup is deprecated: azure-native:sql/v20210801preview:JobTargetGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobTargetGroup to guarantee forwards compatibility.")
        return new JobTargetGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210801preview:JobTargetGroup';
     ...
     */
    public readonly members!: pulumi.Output<outputs.sql.v20210801preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
