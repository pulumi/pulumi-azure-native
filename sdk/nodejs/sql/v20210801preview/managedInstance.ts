 ...
 *
 * @deprecated azure-native:sql/v20210801preview:ManagedInstance is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstance to guarantee forwards compatibility.
 */
export class ManagedInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstance {
        pulumi.log.warn("ManagedInstance is deprecated: azure-native:sql/v20210801preview:ManagedInstance is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstance to guarantee forwards compatibility.")
