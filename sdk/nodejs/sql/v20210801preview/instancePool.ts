 ...
 *
 * @deprecated azure-native:sql/v20210801preview:InstancePool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:InstancePool to guarantee forwards compatibility.
 */
export class InstancePool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstancePool {
        pulumi.log.warn("InstancePool is deprecated: azure-native:sql/v20210801preview:InstancePool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:InstancePool to guarantee forwards compatibility.")
        return new InstancePool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210801preview:InstancePool';
