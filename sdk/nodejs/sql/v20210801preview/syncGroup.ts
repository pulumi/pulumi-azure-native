...
export class SyncGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SyncGroup {
        pulumi.log.warn("SyncGroup is deprecated: azure-native:sql/v20210801preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.")
