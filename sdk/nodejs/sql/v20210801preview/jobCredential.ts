...
export class JobCredential extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobCredential {
        pulumi.log.warn("JobCredential is deprecated: azure-native:sql/v20210801preview:JobCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobCredential to guarantee forwards compatibility.")
