 ...
 *
 * @deprecated azure-native:sql/v20210801preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceAdministrator to guarantee forwards compatibility.
 */
export class ManagedInstanceAdministrator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstanceAdministrator {
        pulumi.log.warn("ManagedInstanceAdministrator is deprecated: azure-native:sql/v20210801preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceAdministrator to guarantee forwards compatibility.")
