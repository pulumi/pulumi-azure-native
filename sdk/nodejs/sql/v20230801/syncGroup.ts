...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801:SyncGroup';
     ...
     */
    public readonly schema!: pulumi.Output<outputs.sql.v20230801.SyncGroupSchemaResponse | undefined>;
    /**
     * The name and capacity of the SKU.
     */
    public readonly sku!: pulumi.Output<outputs.sql.v20230801.SkuResponse | undefined>;
    /**
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20230801.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    schema?: pulumi.Input<inputs.sql.v20230801.SyncGroupSchemaArgs>;
    /**
     ...
     * The name and capacity of the SKU.
     */
    sku?: pulumi.Input<inputs.sql.v20230801.SkuArgs>;
    /**
     * ARM resource id of the sync database in the sync group.
     */
