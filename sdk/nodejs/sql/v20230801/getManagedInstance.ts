...
export function getManagedInstance(args: GetManagedInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20230801:getManagedInstance", {
        "expand": args.expand,
...
export interface GetManagedInstanceResult {
     ...
     */
    readonly administrators?: outputs.sql.v20230801.ManagedInstanceExternalAdministratorResponse;
    /**
     ...
     */
    readonly identity?: outputs.sql.v20230801.ResourceIdentityResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: outputs.sql.v20230801.ManagedInstancePecPropertyResponse[];
    /**
     ...
     */
    readonly servicePrincipal?: outputs.sql.v20230801.ServicePrincipalResponse;
    /**
...
export function getManagedInstanceOutput(args: GetManagedInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedInstanceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20230801:getManagedInstance", {
        "expand": args.expand,
        "managedInstanceName": args.managedInstanceName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
