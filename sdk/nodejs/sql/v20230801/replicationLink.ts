...
export class ReplicationLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801:ReplicationLink';
    ...
    constructor(name: string, args: ReplicationLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql/v20230501preview:ReplicationLink" }, { type: "azure-native:sql/v20230801preview:ReplicationLink" }, { type: "azure-native:sql/v20240501preview:ReplicationLink" }, { type: "azure-native:sql:ReplicationLink" }] };
...
export interface ReplicationLinkArgs {
     ...
     * Link type (GEO, NAMED, STANDBY). Update operation does not support NAMED.
     */
    linkType?: pulumi.Input<string | enums.sql.v20230801.ReplicationLinkType>;
    /**
