...
export class SyncMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801:SyncMember';
...
export interface SyncMemberArgs {
     ...
     * Database type of the sync member.
     */
    databaseType?: pulumi.Input<string | enums.sql.v20230801.SyncMemberDbType>;
    /**
     ...
     * Sync direction of the sync member.
     */
    syncDirection?: pulumi.Input<string | enums.sql.v20230801.SyncDirection>;
    /**
