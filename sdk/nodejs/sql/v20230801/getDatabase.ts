...
export function getDatabase(args: GetDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20230801:getDatabase", {
...
export interface GetDatabaseResult {
     ...
     */
    readonly currentSku: outputs.sql.v20230801.SkuResponse;
    /**
     ...
     */
    readonly identity?: outputs.sql.v20230801.DatabaseIdentityResponse;
    /**
     ...
     */
    readonly keys?: {[key: string]: outputs.sql.v20230801.DatabaseKeyResponse};
    /**
     ...
     * ````
     */
    readonly sku?: outputs.sql.v20230801.SkuResponse;
    /**
...
export function getDatabaseOutput(args: GetDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20230801:getDatabase", {
        "databaseName": args.databaseName,
        "expand": args.expand,
        "filter": args.filter,
        "resourceGroupName": args.resourceGroupName,
