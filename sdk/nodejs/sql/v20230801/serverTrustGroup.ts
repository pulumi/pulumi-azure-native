...
export class ServerTrustGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801:ServerTrustGroup';
     ...
     */
    public readonly groupMembers!: pulumi.Output<outputs.sql.v20230801.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<inputs.sql.v20230801.ServerInfoArgs>[]>;
    /**
     ...
     * Trust scope of the server trust group.
     */
    trustScopes: pulumi.Input<pulumi.Input<string | enums.sql.v20230801.TrustScope>[]>;
}
