...
export class ElasticPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801:ElasticPool';
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<outputs.sql.v20230801.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
...
export interface ElasticPoolArgs {
     ...
     * The license type to apply for this elastic pool.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20230801.ElasticPoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The per database settings for the elastic pool.
     */
    perDatabaseSettings?: pulumi.Input<inputs.sql.v20230801.ElasticPoolPerDatabaseSettingsArgs>;
    /**
     * Type of enclave requested on the elastic pool.
     */
