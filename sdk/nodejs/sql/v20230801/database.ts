...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801:Database';
     ...
     */
    public /*out*/ readonly currentSku!: pulumi.Output<outputs.sql.v20230801.SkuResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20230801.DatabaseIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly keys!: pulumi.Output<{[key: string]: outputs.sql.v20230801.DatabaseKeyResponse} | undefined>;
    /**
...
export interface DatabaseArgs {
     ...
     * Specifies the availability zone the database is pinned to.
     */
    availabilityZone?: pulumi.Input<string | enums.sql.v20230801.AvailabilityZoneType>;
    /**
     * Collation of the metadata catalog.
     */
    catalogCollation?: pulumi.Input<string | enums.sql.v20230801.CatalogCollationType>;
    /**
     * The collation of the database.
     */
     ...
     */
    createMode?: pulumi.Input<string | enums.sql.v20230801.CreateMode>;
    /**
     ...
     * BillForUsage: The database will continue to be online upon exhaustion of free limits and any overage will be billed.
     */
    freeLimitExhaustionBehavior?: pulumi.Input<string | enums.sql.v20230801.FreeLimitExhaustionBehavior>;
    /**
     * The number of secondary replicas associated with the Business Critical, Premium, or Hyperscale edition database that are used to provide high availability. Not applicable to a Hyperscale database within an elastic pool.
     */
     ...
     * The Azure Active Directory identity of the database.
     */
    identity?: pulumi.Input<inputs.sql.v20230801.DatabaseIdentityArgs>;
    /**
     * Whether or not this database is a ledger database, which means all tables in the database are ledger tables. Note: the value of this property cannot be changed after the database has been created.
     */
     ...
     * The license type to apply for this database. `LicenseIncluded` if you need a license, or `BasePrice` if you have a license and are eligible for the Azure Hybrid Benefit.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20230801.DatabaseLicenseType>;
    /**
     * Resource location.
     */
     ...
     * Type of enclave requested on the database i.e. Default or VBS enclaves.
     */
    preferredEnclaveType?: pulumi.Input<string | enums.sql.v20230801.AlwaysEncryptedEnclaveType>;
    /**
     * The state of read-only routing. If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica in the same region. Not applicable to a Hyperscale database within an elastic pool.
     */
    readScale?: pulumi.Input<string | enums.sql.v20230801.DatabaseReadScale>;
    /**
     ...
     * The storage account type to be used to store backups for this database.
     */
    requestedBackupStorageRedundancy?: pulumi.Input<string | enums.sql.v20230801.BackupStorageRedundancy>;
    /**
     ...
     */
    sampleName?: pulumi.Input<string | enums.sql.v20230801.SampleName>;
    /**
     * The secondary type of the database if it is a secondary.  Valid values are Geo, Named and Standby.
     */
    secondaryType?: pulumi.Input<string | enums.sql.v20230801.SecondaryType>;
    /**
