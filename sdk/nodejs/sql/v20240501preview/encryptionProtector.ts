...
export class EncryptionProtector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20240501preview:EncryptionProtector';
...
export interface EncryptionProtectorArgs {
     ...
     * The encryption protector type like 'ServiceManaged', 'AzureKeyVault'.
     */
    serverKeyType: pulumi.Input<string | enums.sql.v20240501preview.ServerKeyType>;
    /**
