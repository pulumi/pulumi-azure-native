...
export class ElasticPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20240501preview:ElasticPool';
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<outputs.sql.v20240501preview.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
...
export interface ElasticPoolArgs {
     ...
     * Specifies the availability zone the pool's primary replica is pinned to.
     */
    availabilityZone?: pulumi.Input<string | enums.sql.v20240501preview.AvailabilityZoneType>;
    /**
     ...
     * The license type to apply for this elastic pool.
     */
    licenseType?: pulumi.Input<string | enums.sql.v20240501preview.ElasticPoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The per database settings for the elastic pool.
     */
    perDatabaseSettings?: pulumi.Input<inputs.sql.v20240501preview.ElasticPoolPerDatabaseSettingsArgs>;
    /**
     * Type of enclave requested on the elastic pool.
     */
    preferredEnclaveType?: pulumi.Input<string | enums.sql.v20240501preview.AlwaysEncryptedEnclaveType>;
    /**
