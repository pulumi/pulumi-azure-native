...
export function getJobStep(args: GetJobStepArgs, opts?: pulumi.InvokeOptions): Promise<GetJobStepResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20240501preview:getJobStep", {
...
export interface GetJobStepResult {
     ...
     */
    readonly action: outputs.sql.v20240501preview.JobStepActionResponse;
    /**
     ...
     */
    readonly executionOptions?: outputs.sql.v20240501preview.JobStepExecutionOptionsResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly output?: outputs.sql.v20240501preview.JobStepOutputResponse;
    /**
...
export function getJobStepOutput(args: GetJobStepOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJobStepResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20240501preview:getJobStep", {
        "jobAgentName": args.jobAgentName,
        "jobName": args.jobName,
        "resourceGroupName": args.resourceGroupName,
        "serverName": args.serverName,
