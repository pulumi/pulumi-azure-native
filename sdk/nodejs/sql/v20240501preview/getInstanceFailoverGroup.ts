...
export function getInstanceFailoverGroup(args: GetInstanceFailoverGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceFailoverGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20240501preview:getInstanceFailoverGroup", {
...
export interface GetInstanceFailoverGroupResult {
     ...
     */
    readonly managedInstancePairs: outputs.sql.v20240501preview.ManagedInstancePairInfoResponse[];
    /**
     * Resource name.
     */
     ...
     */
    readonly partnerRegions: outputs.sql.v20240501preview.PartnerRegionInfoResponse[];
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: outputs.sql.v20240501preview.InstanceFailoverGroupReadOnlyEndpointResponse;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: outputs.sql.v20240501preview.InstanceFailoverGroupReadWriteEndpointResponse;
    /**
...
export function getInstanceFailoverGroupOutput(args: GetInstanceFailoverGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInstanceFailoverGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20240501preview:getInstanceFailoverGroup", {
        "failoverGroupName": args.failoverGroupName,
        "locationName": args.locationName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
