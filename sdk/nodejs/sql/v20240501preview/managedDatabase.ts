...
export class ManagedDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20240501preview:ManagedDatabase';
...
export interface ManagedDatabaseArgs {
     ...
     * Collation of the metadata catalog.
     */
    catalogCollation?: pulumi.Input<string | enums.sql.v20240501preview.CatalogCollationType>;
    /**
     * Collation of the managed database.
     */
     ...
     */
    createMode?: pulumi.Input<string | enums.sql.v20240501preview.ManagedDatabaseCreateMode>;
    /**
