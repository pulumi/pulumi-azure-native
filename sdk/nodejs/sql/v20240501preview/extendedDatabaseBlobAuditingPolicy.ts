...
export class ExtendedDatabaseBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20240501preview:ExtendedDatabaseBlobAuditingPolicy';
...
export interface ExtendedDatabaseBlobAuditingPolicyArgs {
     ...
     * Specifies the state of the audit. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
     */
    state: pulumi.Input<enums.sql.v20240501preview.BlobAuditingPolicyState>;
    /**
