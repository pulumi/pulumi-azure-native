...
export class DatabaseAdvisor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20240501preview:DatabaseAdvisor';
     ...
     */
    public /*out*/ readonly recommendedActions!: pulumi.Output<outputs.sql.v20240501preview.RecommendedActionResponse[]>;
    /**
     * Resource type.
     */
...
export interface DatabaseAdvisorArgs {
     ...
     * Gets the auto-execute status (whether to let the system execute the recommendations) of this advisor. Possible values are 'Enabled' and 'Disabled'
     */
    autoExecuteStatus: pulumi.Input<enums.sql.v20240501preview.AutoExecuteStatus>;
    /**
