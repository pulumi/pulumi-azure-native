 ...
 *
 * @deprecated azure-native:sql/v20150501preview:SyncGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.
 */
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20150501preview:SyncGroup';
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20150501preview.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    schema?: pulumi.Input<inputs.sql.v20150501preview.SyncGroupSchemaArgs>;
    /**
