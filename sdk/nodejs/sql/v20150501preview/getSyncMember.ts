...
export function getSyncMember(args: GetSyncMemberArgs, opts?: pulumi.InvokeOptions): Promise<GetSyncMemberResult> {
    pulumi.log.warn("getSyncMember is deprecated: azure-native:sql/v20150501preview:SyncMember is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncMember to guarantee forwards compatibility.")
