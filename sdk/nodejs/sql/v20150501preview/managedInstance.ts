 ...
 *
 * const managedInstance = new azurerm.sql.v20150501preview.ManagedInstance("managedInstance", {
...
export class ManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:sql/v20150501preview:ManagedInstance';
    ...
    constructor(name: string, args: ManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:sql/v20180601preview:ManagedInstance" }, { type: "azurerm:sql/v20200202preview:ManagedInstance" }] };
