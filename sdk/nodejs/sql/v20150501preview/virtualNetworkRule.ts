...
export class VirtualNetworkRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql:VirtualNetworkRule" }, { type: "azure-nextgen:sql/v20200202preview:VirtualNetworkRule" }, { type: "azure-nextgen:sql/v20200801preview:VirtualNetworkRule" }] };
