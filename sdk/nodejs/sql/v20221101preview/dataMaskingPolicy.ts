...
export class DataMaskingPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataMaskingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:DataMaskingPolicy" }, { type: "azure-native:sql/v20140401:DataMaskingPolicy" }, { type: "azure-native:sql/v20220801preview:DataMaskingPolicy" }] };
