...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20221101preview:Job';
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.sql.v20221101preview.JobScheduleResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["schedule"] = args ? (args.schedule ? pulumi.output(args.schedule).apply(inputs.sql.v20221101preview.jobScheduleArgsProvideDefaults) : undefined) : undefined;
...
export interface JobArgs {
     ...
     * Schedule properties of the job.
     */
    schedule?: pulumi.Input<inputs.sql.v20221101preview.JobScheduleArgs>;
    /**
