...
export class ServerTrustGroup extends pulumi.CustomResource {
     ...
     */
    public readonly groupMembers!: pulumi.Output<outputs.sql.v20221101preview.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
