...
export class ExtendedServerBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210501preview:ExtendedServerBlobAuditingPolicy';
