 ...
 */
/** @deprecated azure-native:sql/v20210501preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerSecurityAlertPolicy to guarantee forwards compatibility. */
export function getServerSecurityAlertPolicy(args: GetServerSecurityAlertPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetServerSecurityAlertPolicyResult> {
    pulumi.log.warn("getServerSecurityAlertPolicy is deprecated: azure-native:sql/v20210501preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.")
