...
export class InstanceFailoverGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstanceFailoverGroup {
        pulumi.log.warn("InstanceFailoverGroup is deprecated: azure-native:sql/v20210501preview:InstanceFailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstanceFailoverGroup to guarantee forwards compatibility.")
        return new InstanceFailoverGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210501preview:InstanceFailoverGroup';
     ...
     */
    public readonly managedInstancePairs!: pulumi.Output<outputs.sql.v20210501preview.ManagedInstancePairInfoResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly partnerRegions!: pulumi.Output<outputs.sql.v20210501preview.PartnerRegionInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    public readonly readOnlyEndpoint!: pulumi.Output<outputs.sql.v20210501preview.InstanceFailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    public readonly readWriteEndpoint!: pulumi.Output<outputs.sql.v20210501preview.InstanceFailoverGroupReadWriteEndpointResponse>;
    /**
