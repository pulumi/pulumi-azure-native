...
export class ServerKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerKey {
        pulumi.log.warn("ServerKey is deprecated: azure-native:sql/v20210501preview:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerKey to guarantee forwards compatibility.")
