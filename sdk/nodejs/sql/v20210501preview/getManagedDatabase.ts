...
export function getManagedDatabase(args: GetManagedDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseResult> {
    pulumi.log.warn("getManagedDatabase is deprecated: azure-native:sql/v20210501preview:ManagedDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedDatabase to guarantee forwards compatibility.")
