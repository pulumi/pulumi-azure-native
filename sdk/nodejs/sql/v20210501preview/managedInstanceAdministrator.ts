 ...
 *
 * @deprecated azure-native:sql/v20210501preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.
 */
export class ManagedInstanceAdministrator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstanceAdministrator {
        pulumi.log.warn("ManagedInstanceAdministrator is deprecated: azure-native:sql/v20210501preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.")
        return new ManagedInstanceAdministrator(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210501preview:ManagedInstanceAdministrator';
    ...
    constructor(name: string, args: ManagedInstanceAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20170301preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20200202preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20200801preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20201101preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20210201preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20210801preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20211101:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20211101preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20220201preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20220501preview:ManagedInstanceAdministrator" }, { type: "azure-native:sql/v20220801preview:ManagedInstanceAdministrator" }] };
