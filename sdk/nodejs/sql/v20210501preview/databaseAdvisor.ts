...
export class DatabaseAdvisor extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAdvisor {
        pulumi.log.warn("DatabaseAdvisor is deprecated: azure-native:sql/v20210501preview:DatabaseAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:DatabaseAdvisor to guarantee forwards compatibility.")
        return new DatabaseAdvisor(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210501preview:DatabaseAdvisor';
     ...
     */
    public /*out*/ readonly recommendedActions!: pulumi.Output<outputs.sql.v20210501preview.RecommendedActionResponse[]>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: DatabaseAdvisorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:DatabaseAdvisor" }, { type: "azure-native:sql/v20140401:DatabaseAdvisor" }, { type: "azure-native:sql/v20150501preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20200202preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20200801preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20201101preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20210201preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20210801preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20211101:DatabaseAdvisor" }, { type: "azure-native:sql/v20211101preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20220201preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20220501preview:DatabaseAdvisor" }, { type: "azure-native:sql/v20220801preview:DatabaseAdvisor" }] };
