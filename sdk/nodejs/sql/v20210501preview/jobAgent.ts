...
export class JobAgent extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobAgent {
        pulumi.log.warn("JobAgent is deprecated: azure-native:sql/v20210501preview:JobAgent is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobAgent to guarantee forwards compatibility.")
