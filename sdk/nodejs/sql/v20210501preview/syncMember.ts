 ...
 *
 * @deprecated azure-native:sql/v20210501preview:SyncMember is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncMember to guarantee forwards compatibility.
 */
export class SyncMember extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SyncMember {
        pulumi.log.warn("SyncMember is deprecated: azure-native:sql/v20210501preview:SyncMember is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncMember to guarantee forwards compatibility.")
        return new SyncMember(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210501preview:SyncMember';
    ...
    constructor(name: string, args: SyncMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:SyncMember" }, { type: "azure-native:sql/v20150501preview:SyncMember" }, { type: "azure-native:sql/v20190601preview:SyncMember" }, { type: "azure-native:sql/v20200202preview:SyncMember" }, { type: "azure-native:sql/v20200801preview:SyncMember" }, { type: "azure-native:sql/v20201101preview:SyncMember" }, { type: "azure-native:sql/v20210201preview:SyncMember" }, { type: "azure-native:sql/v20210801preview:SyncMember" }, { type: "azure-native:sql/v20211101:SyncMember" }, { type: "azure-native:sql/v20211101preview:SyncMember" }, { type: "azure-native:sql/v20220201preview:SyncMember" }, { type: "azure-native:sql/v20220501preview:SyncMember" }, { type: "azure-native:sql/v20220801preview:SyncMember" }] };
