...
export class ManagedInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstance {
        pulumi.log.warn("ManagedInstance is deprecated: azure-native:sql/v20210501preview:ManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstance to guarantee forwards compatibility.")
        return new ManagedInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20210501preview:ManagedInstance';
     ...
     */
    public readonly administrators!: pulumi.Output<outputs.sql.v20210501preview.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20210501preview.ManagedInstancePecPropertyResponse[]>;
     ...
     */
    public readonly servicePrincipal!: pulumi.Output<outputs.sql.v20210501preview.ServicePrincipalResponse | undefined>;
    /**
