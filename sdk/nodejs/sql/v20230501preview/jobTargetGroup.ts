...
export class JobTargetGroup extends pulumi.CustomResource {
     ...
     */
    public readonly members!: pulumi.Output<outputs.sql.v20230501preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    members: pulumi.Input<pulumi.Input<inputs.sql.v20230501preview.JobTargetArgs>[]>;
    /**
