...
export class JobPrivateEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql/v20230801preview:JobPrivateEndpoint" }, { type: "azure-native:sql/v20240501preview:JobPrivateEndpoint" }, { type: "azure-native:sql:JobPrivateEndpoint" }] };
