...
export class ServerAdvisor extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly recommendedActions!: pulumi.Output<outputs.sql.v20230501preview.RecommendedActionResponse[]>;
    /**
     * Resource type.
     */
...
export interface ServerAdvisorArgs {
     ...
     * Gets the auto-execute status (whether to let the system execute the recommendations) of this advisor. Possible values are 'Enabled' and 'Disabled'
     */
    autoExecuteStatus: pulumi.Input<enums.sql.v20230501preview.AutoExecuteStatus>;
    /**
