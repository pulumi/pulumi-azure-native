...
export class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
     ...
     * Schedule list.
     */
    public readonly scheduleList!: pulumi.Output<outputs.sql.v20230501preview.ScheduleItemResponse[]>;
    /**
    ...
    constructor(name: string, args: StartStopManagedInstanceScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20220801preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20221101preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20230201preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20230801preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20240501preview:StartStopManagedInstanceSchedule" }] };
