...
export class Job extends pulumi.CustomResource {
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.sql.v20230501preview.JobScheduleResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["schedule"] = args ? (args.schedule ? pulumi.output(args.schedule).apply(inputs.sql.v20230501preview.jobScheduleArgsProvideDefaults) : undefined) : undefined;
...
export interface JobArgs {
     ...
     * Schedule properties of the job.
     */
    schedule?: pulumi.Input<inputs.sql.v20230501preview.JobScheduleArgs>;
    /**
