...
export class JobAgent extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.sql.v20230501preview.JobAgentIdentityResponse | undefined>;
    /**
     * Resource location.
     */
