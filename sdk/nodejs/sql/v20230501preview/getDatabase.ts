...
export interface GetDatabaseResult {
     ...
     */
    readonly currentSku: outputs.sql.v20230501preview.SkuResponse;
    /**
     ...
     */
    readonly identity?: outputs.sql.v20230501preview.DatabaseIdentityResponse;
    /**
     ...
     */
    readonly keys?: {[key: string]: outputs.sql.v20230501preview.DatabaseKeyResponse};
    /**
...
export function getDatabaseOutput(args: GetDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20230501preview:getDatabase", {
        "databaseName": args.databaseName,
        "expand": args.expand,
        "filter": args.filter,
        "resourceGroupName": args.resourceGroupName,
