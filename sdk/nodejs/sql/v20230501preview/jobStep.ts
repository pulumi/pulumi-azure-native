...
export class JobStep extends pulumi.CustomResource {
     ...
     */
    public readonly action!: pulumi.Output<outputs.sql.v20230501preview.JobStepActionResponse>;
    /**
     ...
     */
    public readonly executionOptions!: pulumi.Output<outputs.sql.v20230501preview.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly output!: pulumi.Output<outputs.sql.v20230501preview.JobStepOutputResponse | undefined>;
    /**
...
export interface JobStepArgs {
     ...
     * The action payload of the job step.
     */
    action: pulumi.Input<inputs.sql.v20230501preview.JobStepActionArgs>;
    /**
     * The resource ID of the job credential that will be used to connect to the targets.
     */
     ...
     * Execution options for the job step.
     */
    executionOptions?: pulumi.Input<inputs.sql.v20230501preview.JobStepExecutionOptionsArgs>;
    /**
     ...
     * Output destination properties of the job step.
     */
    output?: pulumi.Input<inputs.sql.v20230501preview.JobStepOutputArgs>;
    /**
