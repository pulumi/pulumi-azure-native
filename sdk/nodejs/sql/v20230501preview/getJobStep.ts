...
export interface GetJobStepResult {
     ...
     */
    readonly action: outputs.sql.v20230501preview.JobStepActionResponse;
    /**
     ...
     */
    readonly executionOptions?: outputs.sql.v20230501preview.JobStepExecutionOptionsResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly output?: outputs.sql.v20230501preview.JobStepOutputResponse;
    /**
...
export function getJobStepOutput(args: GetJobStepOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetJobStepResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:sql/v20230501preview:getJobStep", {
        "jobAgentName": args.jobAgentName,
        "jobName": args.jobName,
        "resourceGroupName": args.resourceGroupName,
        "serverName": args.serverName,
