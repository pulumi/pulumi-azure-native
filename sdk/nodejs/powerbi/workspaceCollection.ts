...
export class WorkspaceCollection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:powerbi:WorkspaceCollection" }, { type: "azure-native:powerbi/latest:WorkspaceCollection" }, { type: "azure-nextgen:powerbi/latest:WorkspaceCollection" }, { type: "azure-native:powerbi/v20160129:WorkspaceCollection" }, { type: "azure-nextgen:powerbi/v20160129:WorkspaceCollection" }] };
