...
export class WorkspaceCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:powerbi/latest:WorkspaceCollection';
    ...
    constructor(name: string, args: WorkspaceCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:powerbi/preview:WorkspaceCollection" }, { type: "azurerm:powerbi/v20160129:WorkspaceCollection" }] };
