...
export class WorkspaceCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:powerbi/latest:WorkspaceCollection';
    ...
    public readonly sku!: pulumi.Output<outputs.powerbi.latest.AzureSkuResponse | undefined>;
    ...
    constructor(name: string, args: WorkspaceCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:powerbi/latest:WorkspaceCollection" }, { type: "azure-native:powerbi:WorkspaceCollection" }, { type: "azure-nextgen:powerbi:WorkspaceCollection" }, { type: "azure-native:powerbi/v20160129:WorkspaceCollection" }, { type: "azure-nextgen:powerbi/v20160129:WorkspaceCollection" }] };
...
export interface WorkspaceCollectionArgs {
    ...
    readonly sku?: pulumi.Input<inputs.powerbi.latest.AzureSku>;
