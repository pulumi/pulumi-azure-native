...
export class WorkspaceCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:powerbi/preview:WorkspaceCollection';
    ...
    public readonly sku!: pulumi.Output<outputs.powerbi.preview.AzureSkuResponse | undefined>;
    ...
    constructor(name: string, args: WorkspaceCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:powerbi/latest:WorkspaceCollection" }, { type: "azurerm:powerbi/v20160129:WorkspaceCollection" }] };
...
export interface WorkspaceCollectionArgs {
    ...
    readonly sku?: pulumi.Input<inputs.powerbi.preview.AzureSku>;
