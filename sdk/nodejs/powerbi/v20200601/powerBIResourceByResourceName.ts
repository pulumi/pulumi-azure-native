...
export class PowerBIResourceByResourceName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:powerbi/v20200601:PowerBIResourceByResourceName';
    ...
    constructor(name: string, args: PowerBIResourceByResourceNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:powerbi/v20200601:PowerBIResourceByResourceName" }, { type: "azure-native:powerbi:PowerBIResourceByResourceName" }, { type: "azure-nextgen:powerbi:PowerBIResourceByResourceName" }] };
