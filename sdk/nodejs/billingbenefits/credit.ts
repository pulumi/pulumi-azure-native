 ...
 */
export class Credit extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Credit {
        return new Credit(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:billingbenefits:Credit';

    /**
     * Returns true if the given object is an instance of Credit.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Credit {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Credit.__pulumiType;
    }
     ...
     */
    declare public readonly breakdown: pulumi.Output<outputs.billingbenefits.CreditBreakdownItemResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly policies: pulumi.Output<outputs.billingbenefits.CreditPoliciesResponse | undefined>;
    /**
     ...
     */
    constructor(name: string, args: CreditArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["breakdown"] = args?.breakdown;
            ...
            resourceInputs["billingProfileResourceId"] = undefined /*out*/;
            resourceInputs["breakdown"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:billingbenefits/v20250501preview:Credit" }, { type: "azure-native:billingbenefits/v20251201preview:Credit" }, { type: "azure-native:billingbenefits/v20260601:Credit" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(Credit.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface CreditArgs {
     ...
     * The reason for the credit. Not required if not applicable.
     */
    reason?: pulumi.Input<inputs.billingbenefits.CreditReasonArgs | undefined>;
    /**
