...
export function getIspCustomer(args: GetIspCustomerArgs, opts?: pulumi.InvokeOptions): Promise<GetIspCustomerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:connectedcache/v20230501preview:getIspCustomer", {
...
export interface GetIspCustomerResult {
     ...
     */
    readonly properties: outputs.connectedcache.v20230501preview.CustomerPropertyResponse;
    /**
