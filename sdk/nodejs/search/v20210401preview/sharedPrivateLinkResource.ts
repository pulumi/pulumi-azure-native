 ...
 *
 * @deprecated azure-native:search/v20210401preview:SharedPrivateLinkResource is being removed in the next major version of this provider. Please upgrade to azure-native:search/v20220901:SharedPrivateLinkResource to guarantee forwards compatibility.
 */
export class SharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:search/v20210401preview:SharedPrivateLinkResource';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.search.v20210401preview.SharedPrivateLinkResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:search:SharedPrivateLinkResource" }, { type: "azure-native:search/v20200801:SharedPrivateLinkResource" }, { type: "azure-native:search/v20200801preview:SharedPrivateLinkResource" }, { type: "azure-native:search/v20220901:SharedPrivateLinkResource" }] };
...
export interface SharedPrivateLinkResourceArgs {
     ...
     * Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
     */
    properties?: pulumi.Input<inputs.search.v20210401preview.SharedPrivateLinkResourcePropertiesArgs>;
    /**
