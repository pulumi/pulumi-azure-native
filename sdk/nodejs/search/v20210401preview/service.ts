...
export class Service extends pulumi.CustomResource {
     ...
     */
    public readonly authOptions!: pulumi.Output<outputs.search.v20210401preview.DataPlaneAuthOptionsResponse | undefined>;
    /**
     ...
     */
    public readonly encryptionWithCmk!: pulumi.Output<outputs.search.v20210401preview.EncryptionWithCmkResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.search.v20210401preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly networkRuleSet!: pulumi.Output<outputs.search.v20210401preview.NetworkRuleSetResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.search.v20210401preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sharedPrivateLinkResources!: pulumi.Output<outputs.search.v20210401preview.SharedPrivateLinkResourceResponse[]>;
    /**
     * The SKU of the Search Service, which determines price tier and capacity limits. This property is required when creating a new Search Service.
     */
    public readonly sku!: pulumi.Output<outputs.search.v20210401preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:search/v20210401preview:Service" }, { type: "azure-native:search:Service" }, { type: "azure-nextgen:search:Service" }, { type: "azure-native:search/v20150819:Service" }, { type: "azure-nextgen:search/v20150819:Service" }, { type: "azure-native:search/v20191001preview:Service" }, { type: "azure-nextgen:search/v20191001preview:Service" }, { type: "azure-native:search/v20200313:Service" }, { type: "azure-nextgen:search/v20200313:Service" }, { type: "azure-native:search/v20200801:Service" }, { type: "azure-nextgen:search/v20200801:Service" }, { type: "azure-native:search/v20200801preview:Service" }, { type: "azure-nextgen:search/v20200801preview:Service" }] };
...
export interface ServiceArgs {
     ...
     * Defines the options for how the data plane API of a search service authenticates requests. This cannot be set if 'disableLocalAuth' is set to true.
     */
    authOptions?: pulumi.Input<inputs.search.v20210401preview.DataPlaneAuthOptionsArgs>;
    /**
     * When set to true, calls to the search service will not be permitted to utilize API keys for authentication. This cannot be set to true if 'dataPlaneAuthOptions' are defined.
     */
     ...
     * Specifies any policy regarding encryption of resources (such as indexes) using customer manager keys within a search service.
     */
    encryptionWithCmk?: pulumi.Input<inputs.search.v20210401preview.EncryptionWithCmkArgs>;
    /**
     * Applicable only for the standard3 SKU. You can set this property to enable up to 3 high density partitions that allow up to 1000 indexes, which is much higher than the maximum indexes allowed for any other SKU. For the standard3 SKU, the value is either 'default' or 'highDensity'. For all other SKUs, this value must be 'default'.
     */
    hostingMode?: pulumi.Input<enums.search.v20210401preview.HostingMode>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.search.v20210401preview.IdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Network specific rules that determine how the Azure Cognitive Search service may be reached.
     */
    networkRuleSet?: pulumi.Input<inputs.search.v20210401preview.NetworkRuleSetArgs>;
    /**
     * The number of partitions in the search service; if specified, it can be 1, 2, 3, 4, 6, or 12. Values greater than 1 are only valid for standard SKUs. For 'standard3' services with hostingMode set to 'highDensity', the allowed values are between 1 and 3.
     */
     ...
     * This value can be set to 'enabled' to avoid breaking changes on existing customer resources and templates. If set to 'disabled', traffic over public interface is not allowed, and private endpoint connections would be the exclusive access method.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.search.v20210401preview.PublicNetworkAccess>;
    /**
     * The number of replicas in the search service. If specified, it must be a value between 1 and 12 inclusive for standard SKUs or between 1 and 3 inclusive for basic SKU.
     */
     ...
     * The SKU of the Search Service, which determines price tier and capacity limits. This property is required when creating a new Search Service.
     */
    sku?: pulumi.Input<inputs.search.v20210401preview.SkuArgs>;
    /**
     * Resource tags.
     */
