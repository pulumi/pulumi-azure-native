...
export class SharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:search/v20210104:SharedPrivateLinkResource';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.search.v20210104.SharedPrivateLinkResourcePropertiesResponse>;
    /**
...
export interface SharedPrivateLinkResourceArgs {
     ...
     * Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
     */
    readonly properties?: pulumi.Input<inputs.search.v20210104.SharedPrivateLinkResourceProperties>;
    /**
