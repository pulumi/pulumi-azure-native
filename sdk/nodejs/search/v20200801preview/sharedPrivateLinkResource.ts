...
export class SharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:search/latest:SharedPrivateLinkResource" }, { type: "azurerm:search/preview:SharedPrivateLinkResource" }, { type: "azurerm:search/v20200801:SharedPrivateLinkResource" }] };
