 ...
 *
 * const sharedPrivateLinkResource = new azurerm.search.v20200801preview.SharedPrivateLinkResource("sharedPrivateLinkResource", {
...
export class SharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:search/v20200801preview:SharedPrivateLinkResource';
    ...
    constructor(name: string, args: SharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:search/latest:SharedPrivateLinkResource" }, { type: "azurerm:search/v20200801:SharedPrivateLinkResource" }] };
