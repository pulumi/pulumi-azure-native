...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.search.v20200801preview.privateEndpointConnectionPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Describes the properties of an existing Private Endpoint connection to the Azure Cognitive Search service.
     */
    properties?: pulumi.Input<inputs.search.v20200801preview.PrivateEndpointConnectionPropertiesArgs>;
    /**
