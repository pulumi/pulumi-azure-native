...
export class SharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:search/preview:SharedPrivateLinkResource';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.search.preview.SharedPrivateLinkResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, argsOrState?: SharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:search/latest:SharedPrivateLinkResource" }, { type: "azurerm:search/v20200801:SharedPrivateLinkResource" }, { type: "azurerm:search/v20200801preview:SharedPrivateLinkResource" }] };
...
export interface SharedPrivateLinkResourceArgs {
     ...
     * Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
     */
    readonly properties?: pulumi.Input<inputs.search.preview.SharedPrivateLinkResourceProperties>;
    /**
