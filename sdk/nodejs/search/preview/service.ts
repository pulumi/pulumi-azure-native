...
export class Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:search/preview:Service';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.search.preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly networkRuleSet!: pulumi.Output<outputs.search.preview.NetworkRuleSetResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.search.preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sharedPrivateLinkResources!: pulumi.Output<outputs.search.preview.SharedPrivateLinkResourceResponse[]>;
    /**
     * The SKU of the Search Service, which determines price tier and capacity limits. This property is required when creating a new Search Service.
     */
    public readonly sku!: pulumi.Output<outputs.search.preview.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:search/latest:Service" }, { type: "azurerm:search/v20150819:Service" }, { type: "azurerm:search/v20191001preview:Service" }, { type: "azurerm:search/v20200313:Service" }, { type: "azurerm:search/v20200801:Service" }, { type: "azurerm:search/v20200801preview:Service" }] };
...
export interface ServiceArgs {
     ...
     * The identity of the resource.
     */
    readonly identity?: pulumi.Input<inputs.search.preview.Identity>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Network specific rules that determine how the Azure Cognitive Search service may be reached.
     */
    readonly networkRuleSet?: pulumi.Input<inputs.search.preview.NetworkRuleSet>;
    /**
     * The number of partitions in the Search service; if specified, it can be 1, 2, 3, 4, 6, or 12. Values greater than 1 are only valid for standard SKUs. For 'standard3' services with hostingMode set to 'highDensity', the allowed values are between 1 and 3.
     */
     ...
     * The SKU of the Search Service, which determines price tier and capacity limits. This property is required when creating a new Search Service.
     */
    readonly sku?: pulumi.Input<inputs.search.preview.Sku>;
    /**
     * Resource tags.
     */
