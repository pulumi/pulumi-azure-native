...
export class Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:search/v20200801:Service';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.search.v20200801.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly networkRuleSet!: pulumi.Output<outputs.search.v20200801.NetworkRuleSetResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.search.v20200801.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sharedPrivateLinkResources!: pulumi.Output<outputs.search.v20200801.SharedPrivateLinkResourceResponse[]>;
    /**
     * The SKU of the Search Service, which determines price tier and capacity limits. This property is required when creating a new Search Service.
     */
    public readonly sku!: pulumi.Output<outputs.search.v20200801.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:search/v20200801:Service" }, { type: "azure-native:search:Service" }, { type: "azure-nextgen:search:Service" }, { type: "azure-native:search/latest:Service" }, { type: "azure-nextgen:search/latest:Service" }, { type: "azure-native:search/v20150819:Service" }, { type: "azure-nextgen:search/v20150819:Service" }, { type: "azure-native:search/v20191001preview:Service" }, { type: "azure-nextgen:search/v20191001preview:Service" }, { type: "azure-native:search/v20200313:Service" }, { type: "azure-nextgen:search/v20200313:Service" }, { type: "azure-native:search/v20200801preview:Service" }, { type: "azure-nextgen:search/v20200801preview:Service" }, { type: "azure-native:search/v20210104:Service" }, { type: "azure-nextgen:search/v20210104:Service" }] };
...
export interface ServiceArgs {
     ...
     * The identity of the resource.
     */
    readonly identity?: pulumi.Input<inputs.search.v20200801.Identity>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Network specific rules that determine how the Azure Cognitive Search service may be reached.
     */
    readonly networkRuleSet?: pulumi.Input<inputs.search.v20200801.NetworkRuleSet>;
    /**
     * The number of partitions in the search service; if specified, it can be 1, 2, 3, 4, 6, or 12. Values greater than 1 are only valid for standard SKUs. For 'standard3' services with hostingMode set to 'highDensity', the allowed values are between 1 and 3.
     */
     ...
     * The SKU of the Search Service, which determines price tier and capacity limits. This property is required when creating a new Search Service.
     */
    readonly sku?: pulumi.Input<inputs.search.v20200801.Sku>;
    /**
     * Resource tags.
     */
