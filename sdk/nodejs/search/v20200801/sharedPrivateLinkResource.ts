 ...
 *
 * const sharedPrivateLinkResource = new azure_native.search.v20200801.SharedPrivateLinkResource("sharedPrivateLinkResource", {
 *     properties: {
 *         groupId: "blob",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:search/v20200801:SharedPrivateLinkResource testResource /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Search/searchServices/mysearchservice/sharedPrivateLinkResources/testResource 
 * ```
 */
export class SharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:search:SharedPrivateLinkResource" }, { type: "azure-native:search/v20200801preview:SharedPrivateLinkResource" }, { type: "azure-native:search/v20210401preview:SharedPrivateLinkResource" }, { type: "azure-native:search/v20220901:SharedPrivateLinkResource" }] };
...
export interface SharedPrivateLinkResourceArgs {
     ...
     * Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
     */
    properties?: pulumi.Input<inputs.search.v20200801.SharedPrivateLinkResourcePropertiesArgs>;
    /**
