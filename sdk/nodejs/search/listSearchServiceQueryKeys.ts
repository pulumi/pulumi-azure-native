...
export function listSearchServiceQueryKeys(args: ListSearchServiceQueryKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListSearchServiceQueryKeysResult> {
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("azurerm:search:listSearchServiceQueryKeys", {
        "resourceGroupName": args.resourceGroupName,
        "searchServiceName": args.searchServiceName,
    }, opts);
}

export interface ListSearchServiceQueryKeysArgs {
    /**
 ...
 */
export interface ListSearchServiceQueryKeysResult {
    /**
