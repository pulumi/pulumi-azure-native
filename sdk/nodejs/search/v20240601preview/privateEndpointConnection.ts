...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:search/v20240601preview:PrivateEndpointConnection';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.search.v20240601preview.PrivateEndpointConnectionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.search.v20240601preview.privateEndpointConnectionPropertiesArgsProvideDefaults) : undefined) : undefined;
