...
export class SharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:search/v20240601preview:SharedPrivateLinkResource';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.search.v20240601preview.SharedPrivateLinkResourcePropertiesResponse>;
    /**
...
export interface SharedPrivateLinkResourceArgs {
     ...
     * Describes the properties of a shared private link resource managed by the Azure AI Search service.
     */
    properties?: pulumi.Input<inputs.search.v20240601preview.SharedPrivateLinkResourcePropertiesArgs>;
    /**
