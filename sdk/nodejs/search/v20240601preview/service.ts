...
export class Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:search/v20240601preview:Service';
     ...
     */
    public readonly authOptions!: pulumi.Output<outputs.search.v20240601preview.DataPlaneAuthOptionsResponse | undefined>;
    /**
     ...
     */
    public readonly encryptionWithCmk!: pulumi.Output<outputs.search.v20240601preview.EncryptionWithCmkResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<outputs.search.v20240601preview.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly networkRuleSet!: pulumi.Output<outputs.search.v20240601preview.NetworkRuleSetResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.search.v20240601preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sharedPrivateLinkResources!: pulumi.Output<outputs.search.v20240601preview.SharedPrivateLinkResourceResponse[]>;
    /**
     * The SKU of the search service, which determines price tier and capacity limits. This property is required when creating a new search service.
     */
    public readonly sku!: pulumi.Output<outputs.search.v20240601preview.SkuResponse | undefined>;
    /**
...
export interface ServiceArgs {
     ...
     * Defines the options for how the data plane API of a search service authenticates requests. This cannot be set if 'disableLocalAuth' is set to true.
     */
    authOptions?: pulumi.Input<inputs.search.v20240601preview.DataPlaneAuthOptionsArgs>;
    /**
     * When set to true, calls to the search service will not be permitted to utilize API keys for authentication. This cannot be set to true if 'dataPlaneAuthOptions' are defined.
     */
     ...
     * A list of data exfiltration scenarios that are explicitly disallowed for the search service. Currently, the only supported value is 'All' to disable all possible data export scenarios with more fine grained controls planned for the future.
     */
    disabledDataExfiltrationOptions?: pulumi.Input<pulumi.Input<string | enums.search.v20240601preview.SearchDisabledDataExfiltrationOption>[]>;
    /**
     * Specifies any policy regarding encryption of resources (such as indexes) using customer manager keys within a search service.
     */
    encryptionWithCmk?: pulumi.Input<inputs.search.v20240601preview.EncryptionWithCmkArgs>;
    /**
     * Applicable only for the standard3 SKU. You can set this property to enable up to 3 high density partitions that allow up to 1000 indexes, which is much higher than the maximum indexes allowed for any other SKU. For the standard3 SKU, the value is either 'default' or 'highDensity'. For all other SKUs, this value must be 'default'.
     */
    hostingMode?: pulumi.Input<enums.search.v20240601preview.HostingMode>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<inputs.search.v20240601preview.IdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Network specific rules that determine how the Azure AI Search service may be reached.
     */
    networkRuleSet?: pulumi.Input<inputs.search.v20240601preview.NetworkRuleSetArgs>;
    /**
     * The number of partitions in the search service; if specified, it can be 1, 2, 3, 4, 6, or 12. Values greater than 1 are only valid for standard SKUs. For 'standard3' services with hostingMode set to 'highDensity', the allowed values are between 1 and 3.
     */
     ...
     * This value can be set to 'enabled' to avoid breaking changes on existing customer resources and templates. If set to 'disabled', traffic over public interface is not allowed, and private endpoint connections would be the exclusive access method.
     */
    publicNetworkAccess?: pulumi.Input<string | enums.search.v20240601preview.PublicNetworkAccess>;
    /**
     * The number of replicas in the search service. If specified, it must be a value between 1 and 12 inclusive for standard SKUs or between 1 and 3 inclusive for basic SKU.
     */
     ...
     * Sets options that control the availability of semantic search. This configuration is only possible for certain Azure AI Search SKUs in certain locations.
     */
    semanticSearch?: pulumi.Input<string | enums.search.v20240601preview.SearchSemanticSearch>;
    /**
     * The SKU of the search service, which determines price tier and capacity limits. This property is required when creating a new search service.
     */
    sku?: pulumi.Input<inputs.search.v20240601preview.SkuArgs>;
    /**
     * Resource tags.
     */
