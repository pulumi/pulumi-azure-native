...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:search/v20200313:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:search/latest:PrivateEndpointConnection" }, { type: "azure-nextgen:search/v20191001preview:PrivateEndpointConnection" }, { type: "azure-nextgen:search/v20200801:PrivateEndpointConnection" }, { type: "azure-nextgen:search/v20200801preview:PrivateEndpointConnection" }] };
