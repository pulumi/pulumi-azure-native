 ...
 *
 * const privateEndpointConnection = new azurerm.search.v20200313.PrivateEndpointConnection("privateEndpointConnection", {
...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:search/v20200313:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:search/latest:PrivateEndpointConnection" }, { type: "azurerm:search/v20191001preview:PrivateEndpointConnection" }, { type: "azurerm:search/v20200801:PrivateEndpointConnection" }, { type: "azurerm:search/v20200801preview:PrivateEndpointConnection" }] };
