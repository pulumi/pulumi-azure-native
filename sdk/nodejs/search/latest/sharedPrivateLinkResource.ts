...
export class SharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:search/latest:SharedPrivateLinkResource';
    ...
    constructor(name: string, argsOrState?: SharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:search/preview:SharedPrivateLinkResource" }, { type: "azurerm:search/v20200801:SharedPrivateLinkResource" }, { type: "azurerm:search/v20200801preview:SharedPrivateLinkResource" }] };
