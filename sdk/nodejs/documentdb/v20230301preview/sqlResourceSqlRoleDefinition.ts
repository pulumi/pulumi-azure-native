...
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230301preview:SqlResourceSqlRoleDefinition';
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.documentdb.v20230301preview.PermissionResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SqlResourceSqlRoleDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20210301preview:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20210401preview:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20210701preview:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20211015preview:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20220815preview:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20221115preview:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20230315:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20230315preview:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20230415:SqlResourceSqlRoleDefinition" }] };
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20230301preview.PermissionArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20230301preview.RoleDefinitionType>;
}
