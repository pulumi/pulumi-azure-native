...
export class MongoCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230301preview:MongoCluster';
     ...
     */
    public readonly nodeGroupSpecs!: pulumi.Output<outputs.documentdb.v20230301preview.NodeGroupSpecResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.documentdb.v20230301preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: MongoClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:MongoCluster" }, { type: "azure-native:documentdb/v20230315preview:MongoCluster" }, { type: "azure-native:documentdb/v20230915preview:MongoCluster" }, { type: "azure-native:documentdb/v20231115preview:MongoCluster" }, { type: "azure-native:documentdb/v20240215preview:MongoCluster" }] };
...
export interface MongoClusterArgs {
     ...
     */
    createMode?: pulumi.Input<string | enums.documentdb.v20230301preview.CreateMode>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The list of node group specs in the cluster.
     */
    nodeGroupSpecs?: pulumi.Input<pulumi.Input<inputs.documentdb.v20230301preview.NodeGroupSpecArgs>[]>;
    /**
     ...
     */
    restoreParameters?: pulumi.Input<inputs.documentdb.v20230301preview.MongoClusterRestoreParametersArgs>;
    /**
     * The Mongo DB server version. Defaults to the latest available version if not specified.
     */
