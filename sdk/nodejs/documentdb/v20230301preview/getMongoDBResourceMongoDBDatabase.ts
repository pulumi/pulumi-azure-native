...
export function getMongoDBResourceMongoDBDatabase(args: GetMongoDBResourceMongoDBDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoDBDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230301preview:getMongoDBResourceMongoDBDatabase", {
...
export interface GetMongoDBResourceMongoDBDatabaseResult {
    ...
    readonly options?: outputs.documentdb.v20230301preview.MongoDBDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20230301preview.MongoDBDatabaseGetPropertiesResponseResource;
    /**
...
export function getMongoDBResourceMongoDBDatabaseOutput(args: GetMongoDBResourceMongoDBDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMongoDBResourceMongoDBDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20230301preview:getMongoDBResourceMongoDBDatabase", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
