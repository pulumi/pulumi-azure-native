 ...
 *
 * const tableResourceTable = new azure_native.documentdb.v20230301preview.TableResourceTable("tableResourceTable", {
 *     accountName: "ddb1",
 *     location: "West US",
 *     options: {},
 *     resource: {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20230301preview:TableResourceTable tableName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/tables/tableName 
 * ```
 */
export class TableResourceTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230301preview:TableResourceTable';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20230301preview.TableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230301preview.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230301preview.TableResourceArgs>;
    /**
