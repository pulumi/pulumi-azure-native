 ...
 *
 * const mongoDBResourceMongoDBDatabase = new azure_native.documentdb.v20230301preview.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase", {
 *     accountName: "ddb1",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20230301preview:MongoDBResourceMongoDBDatabase databaseName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/mongodbDatabases/databaseName 
 * ```
 */
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230301preview:MongoDBResourceMongoDBDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20230301preview.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230301preview.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230301preview.MongoDBDatabaseResourceArgs>;
    /**
