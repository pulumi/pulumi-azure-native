...
export function getGraphResourceGraph(args: GetGraphResourceGraphArgs, opts?: pulumi.InvokeOptions): Promise<GetGraphResourceGraphResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230301preview:getGraphResourceGraph", {
...
export interface GetGraphResourceGraphResult {
    ...
    readonly options?: outputs.documentdb.v20230301preview.GraphResourceGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20230301preview.GraphResourceGetPropertiesResponseResource;
    /**
...
export function getGraphResourceGraphOutput(args: GetGraphResourceGraphOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGraphResourceGraphResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20230301preview:getGraphResourceGraph", {
        "accountName": args.accountName,
        "graphName": args.graphName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
