 ...
 *
 * const mongoDBResourceMongoDBCollection = new azure_native.documentdb.v20230301preview.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection", {
 *     accountName: "ddb1",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20230301preview:MongoDBResourceMongoDBCollection collectionName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/mongodbDatabases/databaseName/mongodbCollections/collectionName 
 * ```
 */
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230301preview:MongoDBResourceMongoDBCollection';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20230301preview.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230301preview.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBCollectionArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230301preview.MongoDBCollectionResourceArgs>;
    /**
