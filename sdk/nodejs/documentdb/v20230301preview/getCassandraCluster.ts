...
export function getCassandraCluster(args: GetCassandraClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230301preview:getCassandraCluster", {
...
export interface GetCassandraClusterResult {
     ...
     */
    readonly identity?: outputs.documentdb.v20230301preview.ManagedCassandraManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.documentdb.v20230301preview.ClusterResourceResponseProperties;
    /**
...
export function getCassandraClusterOutput(args: GetCassandraClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCassandraClusterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20230301preview:getCassandraCluster", {
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
