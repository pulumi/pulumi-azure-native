 ...
 *
 * const sqlResourceSqlTrigger = new azure_native.documentdb.v20230301preview.SqlResourceSqlTrigger("sqlResourceSqlTrigger", {
 *     accountName: "ddb1",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20230301preview:SqlResourceSqlTrigger triggerName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/sqlDatabases/databaseName/sqlContainers/containerName/sqlTriggers/triggerName 
 * ```
 */
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230301preview:SqlResourceSqlTrigger';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230301preview.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230301preview.SqlTriggerResourceArgs>;
    /**
