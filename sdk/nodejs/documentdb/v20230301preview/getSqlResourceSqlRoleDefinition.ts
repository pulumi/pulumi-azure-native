...
export function getSqlResourceSqlRoleDefinition(args: GetSqlResourceSqlRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlRoleDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230301preview:getSqlResourceSqlRoleDefinition", {
...
export interface GetSqlResourceSqlRoleDefinitionResult {
     ...
     */
    readonly permissions?: outputs.documentdb.v20230301preview.PermissionResponse[];
    /**
...
export function getSqlResourceSqlRoleDefinitionOutput(args: GetSqlResourceSqlRoleDefinitionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlResourceSqlRoleDefinitionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20230301preview:getSqlResourceSqlRoleDefinition", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "roleDefinitionId": args.roleDefinitionId,
    }, opts);
