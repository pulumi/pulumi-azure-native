...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb:TableResourceTable';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.TableGetPropertiesResponse>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.TableCreateUpdateProperties>;
    /**
