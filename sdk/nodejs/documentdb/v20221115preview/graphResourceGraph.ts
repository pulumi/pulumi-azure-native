...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20221115preview:GraphResourceGraph';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20221115preview.GraphResourceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20221115preview.GraphResourceGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GraphResourceGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:GraphResourceGraph" }, { type: "azure-native:documentdb/v20210701preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20211015preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20220815preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20230301preview:GraphResourceGraph" }, { type: "azure-native:documentdb/v20230315preview:GraphResourceGraph" }] };
...
export interface GraphResourceGraphArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20221115preview.GraphResourceArgs>;
    /**
