...
export function getCassandraDataCenter(args: GetCassandraDataCenterArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraDataCenterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20221115preview:getCassandraDataCenter", {
...
export interface GetCassandraDataCenterResult {
     ...
     */
    readonly properties: outputs.documentdb.v20221115preview.DataCenterResourceResponseProperties;
    /**
