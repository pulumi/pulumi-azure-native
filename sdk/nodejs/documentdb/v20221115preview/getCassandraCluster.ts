...
export function getCassandraCluster(args: GetCassandraClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20221115preview:getCassandraCluster", {
...
export interface GetCassandraClusterResult {
     ...
     */
    readonly identity?: outputs.documentdb.v20221115preview.ManagedCassandraManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.documentdb.v20221115preview.ClusterResourceResponseProperties;
    /**
