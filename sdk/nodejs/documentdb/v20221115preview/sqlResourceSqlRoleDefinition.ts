 ...
 *
 * const sqlResourceSqlRoleDefinition = new azure_native.documentdb.v20221115preview.SqlResourceSqlRoleDefinition("sqlResourceSqlRoleDefinition", {
 ...
 *     roleName: "myRoleName",
 *     type: azure_native.documentdb.v20221115preview.RoleDefinitionType.CustomRole,
 * });
 *
 * ```
 *
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20221115preview:SqlResourceSqlRoleDefinition myRoleDefinitionId /subscriptions/mySubscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.DocumentDB/databaseAccounts/myAccountName/sqlRoleDefinitions/myRoleDefinitionId 
 * ```
 */
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20221115preview:SqlResourceSqlRoleDefinition';
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.documentdb.v20221115preview.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20221115preview.PermissionArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20221115preview.RoleDefinitionType>;
}
