...
export function getTableResourceTable(args: GetTableResourceTableArgs, opts?: pulumi.InvokeOptions): Promise<GetTableResourceTableResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20221115preview:getTableResourceTable", {
...
export interface GetTableResourceTableResult {
    ...
    readonly options?: outputs.documentdb.v20221115preview.TableGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20221115preview.TableGetPropertiesResponseResource;
    /**
