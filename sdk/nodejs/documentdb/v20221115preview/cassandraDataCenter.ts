 ...
 *
 * const cassandraDataCenter = new azure_native.documentdb.v20221115preview.CassandraDataCenter("cassandraDataCenter", {
...
export class CassandraDataCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20221115preview:CassandraDataCenter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20221115preview.DataCenterResourceResponseProperties>;
    /**
...
export interface CassandraDataCenterArgs {
     ...
     * Properties of a managed Cassandra data center.
     */
    properties?: pulumi.Input<inputs.documentdb.v20221115preview.DataCenterResourcePropertiesArgs>;
    /**
