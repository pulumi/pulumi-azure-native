...
export function getMongoDBResourceMongoDBDatabase(args: GetMongoDBResourceMongoDBDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoDBDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20221115preview:getMongoDBResourceMongoDBDatabase", {
...
export interface GetMongoDBResourceMongoDBDatabaseResult {
    ...
    readonly options?: outputs.documentdb.v20221115preview.MongoDBDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20221115preview.MongoDBDatabaseGetPropertiesResponseResource;
    /**
