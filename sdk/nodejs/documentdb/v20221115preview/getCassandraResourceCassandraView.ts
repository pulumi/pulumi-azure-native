...
export function getCassandraResourceCassandraView(args: GetCassandraResourceCassandraViewArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraResourceCassandraViewResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20221115preview:getCassandraResourceCassandraView", {
...
export interface GetCassandraResourceCassandraViewResult {
    ...
    readonly options?: outputs.documentdb.v20221115preview.CassandraViewGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20221115preview.CassandraViewGetPropertiesResponseResource;
    /**
