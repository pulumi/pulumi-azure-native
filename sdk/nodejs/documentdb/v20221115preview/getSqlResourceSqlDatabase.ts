...
export function getSqlResourceSqlDatabase(args: GetSqlResourceSqlDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20221115preview:getSqlResourceSqlDatabase", {
...
export interface GetSqlResourceSqlDatabaseResult {
    ...
    readonly options?: outputs.documentdb.v20221115preview.SqlDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20221115preview.SqlDatabaseGetPropertiesResponseResource;
    /**
