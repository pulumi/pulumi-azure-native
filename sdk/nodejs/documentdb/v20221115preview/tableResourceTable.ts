...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20221115preview:TableResourceTable';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20221115preview.TableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20221115preview.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20221115preview.TableResourceArgs>;
    /**
