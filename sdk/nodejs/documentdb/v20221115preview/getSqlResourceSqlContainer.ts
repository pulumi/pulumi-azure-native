...
export function getSqlResourceSqlContainer(args: GetSqlResourceSqlContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20221115preview:getSqlResourceSqlContainer", {
...
export interface GetSqlResourceSqlContainerResult {
    ...
    readonly options?: outputs.documentdb.v20221115preview.SqlContainerGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20221115preview.SqlContainerGetPropertiesResponseResource;
    /**
