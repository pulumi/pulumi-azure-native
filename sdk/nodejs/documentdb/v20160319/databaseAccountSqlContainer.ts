 ...
 *
 * const databaseAccountSqlContainer = new azurerm.documentdb.v20160319.DatabaseAccountSqlContainer("databaseAccountSqlContainer", {
 *     accountName: "ddb1",
