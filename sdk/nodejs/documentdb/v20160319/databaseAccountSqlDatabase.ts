 ...
 *
 * const databaseAccountSqlDatabase = new azurerm.documentdb.v20160319.DatabaseAccountSqlDatabase("databaseAccountSqlDatabase", {
 *     accountName: "ddb1",
