...
export class DatabaseAccountMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb:DatabaseAccountMongoDBDatabase';
