...
export class ThroughputPoolAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20240901preview:ThroughputPoolAccount';
