...
export function getMongoDBResourceMongoDBCollection(args: GetMongoDBResourceMongoDBCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoDBCollectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20240901preview:getMongoDBResourceMongoDBCollection", {
...
export interface GetMongoDBResourceMongoDBCollectionResult {
    ...
    readonly options?: outputs.documentdb.v20240901preview.MongoDBCollectionGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20240901preview.MongoDBCollectionGetPropertiesResponseResource;
    /**
...
export function getMongoDBResourceMongoDBCollectionOutput(args: GetMongoDBResourceMongoDBCollectionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMongoDBResourceMongoDBCollectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20240901preview:getMongoDBResourceMongoDBCollection", {
        "accountName": args.accountName,
        "collectionName": args.collectionName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
