...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlTrigger {
        pulumi.log.warn("SqlResourceSqlTrigger is deprecated: Version 2020-09-01 will be removed in v2 of the provider.")
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20200901.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20200901.SqlTriggerCreateUpdatePropertiesArgs>;
    /**
