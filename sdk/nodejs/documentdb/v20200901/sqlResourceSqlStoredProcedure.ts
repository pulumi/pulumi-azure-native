...
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlStoredProcedure {
        pulumi.log.warn("SqlResourceSqlStoredProcedure is deprecated: Version 2020-09-01 will be removed in v2 of the provider.")
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20200901.SqlStoredProcedureGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlStoredProcedureArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20200901.SqlStoredProcedureCreateUpdatePropertiesArgs>;
    /**
