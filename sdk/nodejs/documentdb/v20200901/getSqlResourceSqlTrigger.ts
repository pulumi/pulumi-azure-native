...
azure-native:documentdb/v20200901:SqlResourceSqlTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:SqlResourceSqlTrigger to guarantee forwards compatibility. */
export function getSqlResourceSqlTrigger(args: GetSqlResourceSqlTriggerArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlTriggerResult> {
    pulumi.log.warn("getSqlResourceSqlTrigger is deprecated: Version 2020-09-01 will be removed in v2 of the provider.\nazure-native:documentdb/v20200901:SqlResourceSqlTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:SqlResourceSqlTrigger to guarantee forwards compatibility.")
