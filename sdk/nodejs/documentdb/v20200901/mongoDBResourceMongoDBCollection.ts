...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDBResourceMongoDBCollection {
        pulumi.log.warn("MongoDBResourceMongoDBCollection is deprecated: Version 2020-09-01 will be removed in v2 of the provider.")
        return new MongoDBResourceMongoDBCollection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20200901:MongoDBResourceMongoDBCollection';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20200901.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20200901.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBCollectionArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20200901.MongoDBCollectionCreateUpdatePropertiesArgs>;
    /**
