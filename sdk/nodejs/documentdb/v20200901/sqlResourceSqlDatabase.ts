...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20200901.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20200901.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20200901.SqlDatabaseCreateUpdatePropertiesArgs>;
    /**
