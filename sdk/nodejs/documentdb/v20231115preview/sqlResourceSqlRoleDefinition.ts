...
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20231115preview:SqlResourceSqlRoleDefinition';
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.documentdb.v20231115preview.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20231115preview.PermissionArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20231115preview.RoleDefinitionType>;
}
