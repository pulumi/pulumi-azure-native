...
export interface GetGraphResourceGraphResult {
    ...
    readonly options?: outputs.documentdb.v20231115preview.GraphResourceGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20231115preview.GraphResourceGetPropertiesResponseResource;
    /**
...
export function getGraphResourceGraphOutput(args: GetGraphResourceGraphOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGraphResourceGraphResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20231115preview:getGraphResourceGraph", {
        "accountName": args.accountName,
        "graphName": args.graphName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
