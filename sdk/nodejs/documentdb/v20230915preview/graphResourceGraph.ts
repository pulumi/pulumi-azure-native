...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20230915preview.GraphResourceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230915preview.GraphResourceGetPropertiesResponseResource | undefined>;
    /**
...
export interface GraphResourceGraphArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230915preview.GraphResourceArgs>;
    /**
