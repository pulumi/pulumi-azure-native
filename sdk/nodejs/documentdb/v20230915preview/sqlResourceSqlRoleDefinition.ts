...
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.documentdb.v20230915preview.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20230915preview.PermissionArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20230915preview.RoleDefinitionType>;
}
