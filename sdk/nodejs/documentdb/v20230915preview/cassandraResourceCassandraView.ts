...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20230915preview.CassandraViewGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230915preview.CassandraViewGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: CassandraResourceCassandraViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20210701preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20211015preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20211115preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220215preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220515preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20220815preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20221115preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20230301preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20230315preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20231115preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20240215preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20240515preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20240901preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb/v20241201preview:CassandraResourceCassandraView" }, { type: "azure-native:documentdb:CassandraResourceCassandraView" }] };
...
export interface CassandraResourceCassandraViewArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230915preview.CassandraViewResourceArgs>;
    /**
