...
azure-native:documentdb/v20150408:DatabaseAccountSqlDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20160331:DatabaseAccountSqlDatabase to guarantee forwards compatibility.
 */
export class DatabaseAccountSqlDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccountSqlDatabase {
        pulumi.log.warn("DatabaseAccountSqlDatabase is deprecated: Version 2015-04-08 will be removed in v2 of the provider.\nazure-native:documentdb/v20150408:DatabaseAccountSqlDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20160331:DatabaseAccountSqlDatabase to guarantee forwards compatibility.")
