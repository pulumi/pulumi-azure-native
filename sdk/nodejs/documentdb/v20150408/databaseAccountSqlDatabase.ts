 ...
 *
 * const databaseAccountSqlDatabase = new azurerm.documentdb.v20150408.DatabaseAccountSqlDatabase("databaseAccountSqlDatabase", {
 *     accountName: "ddb1",
...
export class DatabaseAccountSqlDatabase extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DatabaseAccountSqlDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:DatabaseAccountSqlDatabase" }, { type: "azurerm:documentdb/v20150401:DatabaseAccountSqlDatabase" }, { type: "azurerm:documentdb/v20151106:DatabaseAccountSqlDatabase" }, { type: "azurerm:documentdb/v20160319:DatabaseAccountSqlDatabase" }, { type: "azurerm:documentdb/v20160331:DatabaseAccountSqlDatabase" }] };
