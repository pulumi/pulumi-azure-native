...
export class DatabaseAccountSqlContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseAccountSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.documentdb.v20150408.sqlContainerCreateUpdatePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface DatabaseAccountSqlContainerArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20150408.SqlContainerCreateUpdatePropertiesArgs>;
    /**
