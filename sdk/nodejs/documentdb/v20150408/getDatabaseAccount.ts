...
export function getDatabaseAccount(args: GetDatabaseAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseAccountResult> {
    ...
    return pulumi.runtime.invoke("azurerm:documentdb/v20150408:getDatabaseAccount", {
        "name": args.name,
...
export interface GetDatabaseAccountResult {
     ...
     */
    readonly properties: outputs.documentdb.v20150408.DatabaseAccountPropertiesResponse;
    /**
