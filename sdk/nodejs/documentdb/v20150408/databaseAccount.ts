...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccount {
        pulumi.log.warn("DatabaseAccount is deprecated: Version 2015-04-08 will be removed in v2 of the provider.")
        return new DatabaseAccount(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20150408:DatabaseAccount';
     ...
     */
    public /*out*/ readonly capabilities!: pulumi.Output<outputs.documentdb.v20150408.CapabilityResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly consistencyPolicy!: pulumi.Output<outputs.documentdb.v20150408.ConsistencyPolicyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly virtualNetworkRules!: pulumi.Output<outputs.documentdb.v20150408.VirtualNetworkRuleResponse[] | undefined>;
    /**
...
export interface DatabaseAccountArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20150408.DatabaseAccountCreateUpdatePropertiesArgs>;
    /**
