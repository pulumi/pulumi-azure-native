...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.CassandraViewGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.CassandraViewGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraViewArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.CassandraViewCreateUpdatePropertiesArgs>;
    /**
