...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20230315preview.SqlContainerGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20230315preview.SqlContainerGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20230315preview.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface SqlResourceSqlContainerArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20230315preview.SqlContainerResourceArgs>;
    /**
