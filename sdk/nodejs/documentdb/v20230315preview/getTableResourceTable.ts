...
export interface GetTableResourceTableResult {
    ...
    readonly options?: outputs.documentdb.v20230315preview.TableGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20230315preview.TableGetPropertiesResponseResource;
    /**
...
export function getTableResourceTableOutput(args: GetTableResourceTableOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetTableResourceTableResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20230315preview:getTableResourceTable", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "tableName": args.tableName,
    }, opts);
