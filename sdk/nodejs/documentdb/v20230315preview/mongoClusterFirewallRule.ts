...
export class MongoClusterFirewallRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MongoClusterFirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20230301preview:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20230915preview:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20231115preview:MongoClusterFirewallRule" }] };
