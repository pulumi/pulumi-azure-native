...
export class MongoDBResourceMongoUserDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:MongoDBResourceMongoUserDefinition';
     ...
     */
    public readonly roles!: pulumi.Output<outputs.documentdb.v20230315preview.RoleResponse[] | undefined>;
    /**
...
export interface MongoDBResourceMongoUserDefinitionArgs {
     ...
     * The set of roles inherited by the User Definition.
     */
    roles?: pulumi.Input<pulumi.Input<inputs.documentdb.v20230315preview.RoleArgs>[]>;
    /**
     * The user name for User Definition.
     */
