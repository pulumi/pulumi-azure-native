...
export class MongoDBResourceMongoRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:MongoDBResourceMongoRoleDefinition';
     ...
     */
    public readonly privileges!: pulumi.Output<outputs.documentdb.v20230315preview.PrivilegeResponse[] | undefined>;
    /**
...
export interface MongoDBResourceMongoRoleDefinitionArgs {
     ...
     * A set of privileges contained by the Role Definition. This will allow application of this Role Definition on the entire database account or any underlying Database / Collection. Scopes higher than Database are not enforceable as privilege.
     */
    privileges?: pulumi.Input<pulumi.Input<inputs.documentdb.v20230315preview.PrivilegeArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20230315preview.MongoRoleDefinitionType>;
}
