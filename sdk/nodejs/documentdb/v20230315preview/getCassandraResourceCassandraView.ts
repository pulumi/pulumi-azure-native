...
export interface GetCassandraResourceCassandraViewResult {
    ...
    readonly options?: outputs.documentdb.v20230315preview.CassandraViewGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20230315preview.CassandraViewGetPropertiesResponseResource;
    /**
...
export function getCassandraResourceCassandraViewOutput(args: GetCassandraResourceCassandraViewOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCassandraResourceCassandraViewResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20230315preview:getCassandraResourceCassandraView", {
        "accountName": args.accountName,
        "keyspaceName": args.keyspaceName,
        "resourceGroupName": args.resourceGroupName,
        "viewName": args.viewName,
