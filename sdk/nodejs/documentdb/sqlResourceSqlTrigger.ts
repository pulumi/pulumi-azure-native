...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.SqlTriggerCreateUpdatePropertiesArgs>;
    /**
