...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb:SqlResourceSqlTrigger';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.SqlTriggerGetPropertiesResponse>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.SqlTriggerCreateUpdateProperties>;
    /**
