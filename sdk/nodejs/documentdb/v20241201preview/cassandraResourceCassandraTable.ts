...
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20241201preview:CassandraResourceCassandraTable';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20241201preview.CassandraTableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20241201preview.CassandraTableGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20241201preview.CassandraTableResourceArgs>;
    /**
