...
export class TableResourceTableRoleAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20241201preview:TableResourceTableRoleAssignment';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.documentdb.v20241201preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: TableResourceTableRoleAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:TableResourceTableRoleAssignment" }] };
