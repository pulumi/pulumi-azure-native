...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20241201preview:GremlinResourceGremlinGraph';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20241201preview.GremlinGraphGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20241201preview.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20241201preview.gremlinGraphResourceArgsProvideDefaults) : undefined) : undefined;
