...
export class ThroughputPoolAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ThroughputPoolAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20231115preview:ThroughputPoolAccount" }, { type: "azure-native:documentdb/v20240215preview:ThroughputPoolAccount" }, { type: "azure-native:documentdb/v20240515preview:ThroughputPoolAccount" }, { type: "azure-native:documentdb/v20240901preview:ThroughputPoolAccount" }, { type: "azure-native:documentdb:ThroughputPoolAccount" }] };
