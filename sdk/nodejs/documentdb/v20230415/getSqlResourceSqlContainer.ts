...
export interface GetSqlResourceSqlContainerResult {
    ...
    readonly options?: outputs.documentdb.v20230415.SqlContainerGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20230415.SqlContainerGetPropertiesResponseResource;
    /**
...
export function getSqlResourceSqlContainerOutput(args: GetSqlResourceSqlContainerOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSqlResourceSqlContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20230415:getSqlResourceSqlContainer", {
        "accountName": args.accountName,
        "containerName": args.containerName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
