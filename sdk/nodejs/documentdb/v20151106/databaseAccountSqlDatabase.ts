...
export class DatabaseAccountSqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20151106:DatabaseAccountSqlDatabase';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20151106.SqlDatabasePropertiesResponse>;
    /**
...
export interface DatabaseAccountSqlDatabaseArgs {
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20151106.SqlDatabaseCreateUpdateProperties>;
    /**
