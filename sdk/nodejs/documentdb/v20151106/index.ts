...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-nextgen:documentdb/v20151106:DatabaseAccount":
                return new DatabaseAccount(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountCassandraKeyspace":
                return new DatabaseAccountCassandraKeyspace(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountCassandraTable":
                return new DatabaseAccountCassandraTable(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountGremlinDatabase":
                return new DatabaseAccountGremlinDatabase(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountGremlinGraph":
                return new DatabaseAccountGremlinGraph(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountMongoDBCollection":
                return new DatabaseAccountMongoDBCollection(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountMongoDBDatabase":
                return new DatabaseAccountMongoDBDatabase(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountSqlContainer":
                return new DatabaseAccountSqlContainer(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountSqlDatabase":
                return new DatabaseAccountSqlDatabase(name, <any>undefined, { urn })
            case "azure-nextgen:documentdb/v20151106:DatabaseAccountTable":
...
pulumi.runtime.registerResourceModule("azure-nextgen", "documentdb/v20151106", _module)
