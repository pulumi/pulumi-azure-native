 ...
 *
 * const databaseAccountMongoDBDatabase = new azurerm.documentdb.v20151106.DatabaseAccountMongoDBDatabase("databaseAccountMongoDBDatabase", {
 *     accountName: "ddb1",
