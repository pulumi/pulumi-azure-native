 ...
 *
 * const databaseAccountTable = new azurerm.documentdb.v20151106.DatabaseAccountTable("databaseAccountTable", {
 *     accountName: "ddb1",
 *     options: {},
 *     resource: {
 *         id: "tableName",
...
export class DatabaseAccountTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20151106:DatabaseAccountTable';
    ...
    constructor(name: string, argsOrState?: DatabaseAccountTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:DatabaseAccountTable" }, { type: "azurerm:documentdb/v20150401:DatabaseAccountTable" }, { type: "azurerm:documentdb/v20150408:DatabaseAccountTable" }, { type: "azurerm:documentdb/v20160319:DatabaseAccountTable" }, { type: "azurerm:documentdb/v20160331:DatabaseAccountTable" }] };
