...
export function getDatabaseAccount(args: GetDatabaseAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-nextgen:documentdb/v20151106:getDatabaseAccount", {
...
export interface GetDatabaseAccountResult {
     ...
     */
    readonly capabilities?: outputs.documentdb.v20151106.CapabilityInvokeResponse[];
    /**
     ...
     */
    readonly consistencyPolicy?: outputs.documentdb.v20151106.ConsistencyPolicyInvokeResponse;
    /**
     ...
     */
    readonly failoverPolicies: outputs.documentdb.v20151106.FailoverPolicyInvokeResponse[];
    /**
     ...
     */
    readonly readLocations: outputs.documentdb.v20151106.LocationInvokeResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: outputs.documentdb.v20151106.VirtualNetworkRuleInvokeResponse[];
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    readonly writeLocations: outputs.documentdb.v20151106.LocationInvokeResponse[];
}
