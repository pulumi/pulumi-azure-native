 ...
 *
 * const databaseAccountGremlinDatabase = new azurerm.documentdb.v20151106.DatabaseAccountGremlinDatabase("databaseAccountGremlinDatabase", {
 *     accountName: "ddb1",
...
export class DatabaseAccountGremlinDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseAccountGremlinDatabase {
        return new DatabaseAccountGremlinDatabase(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20151106:DatabaseAccountGremlinDatabase';
    ...
    constructor(name: string, argsOrState?: DatabaseAccountGremlinDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:DatabaseAccountGremlinDatabase" }, { type: "azurerm:documentdb/v20150401:DatabaseAccountGremlinDatabase" }, { type: "azurerm:documentdb/v20150408:DatabaseAccountGremlinDatabase" }, { type: "azurerm:documentdb/v20160319:DatabaseAccountGremlinDatabase" }, { type: "azurerm:documentdb/v20160331:DatabaseAccountGremlinDatabase" }] };
