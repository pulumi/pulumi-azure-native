 ...
 *
 * const databaseAccount = new azurerm.documentdb.v20151106.DatabaseAccount("databaseAccount", {
 *     accountName: "ddb1",
 *     consistencyPolicy: {
...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20151106:DatabaseAccount';
