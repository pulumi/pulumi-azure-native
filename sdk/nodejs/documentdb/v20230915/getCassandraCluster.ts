...
export interface GetCassandraClusterResult {
     ...
     */
    readonly identity?: outputs.documentdb.v20230915.ManagedCassandraManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.documentdb.v20230915.ClusterResourceResponseProperties;
    /**
...
export function getCassandraClusterOutput(args: GetCassandraClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCassandraClusterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20230915:getCassandraCluster", {
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
