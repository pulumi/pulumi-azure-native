...
export class MongoDBResourceMongoUserDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly roles!: pulumi.Output<outputs.documentdb.v20230915.RoleResponse[] | undefined>;
    /**
...
export interface MongoDBResourceMongoUserDefinitionArgs {
     ...
     * The set of roles inherited by the User Definition.
     */
    roles?: pulumi.Input<pulumi.Input<inputs.documentdb.v20230915.RoleArgs>[]>;
    /**
     * The user name for User Definition.
     */
