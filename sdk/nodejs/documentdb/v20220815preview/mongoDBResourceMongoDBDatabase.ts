 ...
 *
 * const mongoDBResourceMongoDBDatabase = new azure_native.documentdb.v20220815preview.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase", {
 *     accountName: "ddb1",
...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220815preview.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220815preview.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220815preview.MongoDBDatabaseResourceArgs>;
    /**
