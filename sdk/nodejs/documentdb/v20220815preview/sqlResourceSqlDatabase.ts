...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20220815preview.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20220815preview.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20220815preview.SqlDatabaseCreateUpdatePropertiesArgs>;
    /**
