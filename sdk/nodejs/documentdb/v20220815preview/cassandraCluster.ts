 ...
 *
 * @deprecated azure-native:documentdb/v20220815preview:CassandraCluster is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:CassandraCluster to guarantee forwards compatibility.
 */
export class CassandraCluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraCluster {
        pulumi.log.warn("CassandraCluster is deprecated: azure-native:documentdb/v20220815preview:CassandraCluster is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:CassandraCluster to guarantee forwards compatibility.")
        return new CassandraCluster(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:CassandraCluster';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.documentdb.v20220815preview.ManagedCassandraManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20220815preview.ClusterResourceResponseProperties>;
    /**
...
export interface CassandraClusterArgs {
     ...
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.documentdb.v20220815preview.ManagedCassandraManagedServiceIdentityArgs>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     * Properties of a managed Cassandra cluster.
     */
    properties?: pulumi.Input<inputs.documentdb.v20220815preview.ClusterResourcePropertiesArgs>;
    /**
