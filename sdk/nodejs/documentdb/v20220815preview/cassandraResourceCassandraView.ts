 ...
 *
 * const cassandraResourceCassandraView = new azure_native.documentdb.v20220815preview.CassandraResourceCassandraView("cassandraResourceCassandraView", {
 *     accountName: "ddb1",
...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:CassandraResourceCassandraView';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220815preview.CassandraViewGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220815preview.CassandraViewGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraViewArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220815preview.CassandraViewResourceArgs>;
    /**
