 ...
 *
 * const gremlinResourceGremlinGraph = new azure_native.documentdb.v20220815preview.GremlinResourceGremlinGraph("gremlinResourceGremlinGraph", {
 *     accountName: "ddb1",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph graphName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/gremlinDatabases/databaseName/gremlinGraphs/graphName 
 * ```
 */
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.documentdb.v20220815preview.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220815preview.GremlinGraphGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220815preview.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20220815preview.gremlinGraphResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface GremlinResourceGremlinGraphArgs {
     ...
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.documentdb.v20220815preview.ManagedServiceIdentityArgs>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    options?: pulumi.Input<inputs.documentdb.v20220815preview.CreateUpdateOptionsArgs>;
    /**
     * The standard JSON format of a Gremlin graph
     */
    resource: pulumi.Input<inputs.documentdb.v20220815preview.GremlinGraphResourceArgs>;
    /**
