...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBCollection';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20220815preview.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20220815preview.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBCollectionArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20220815preview.MongoDBCollectionCreateUpdatePropertiesArgs>;
    /**
