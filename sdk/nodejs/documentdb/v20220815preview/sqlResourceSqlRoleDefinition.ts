 ...
 *
 * @deprecated azure-native:documentdb/v20220815preview:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.
 */
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:SqlResourceSqlRoleDefinition';
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.documentdb.v20220815preview.PermissionResponse[] | undefined>;
    /**
...
export interface SqlResourceSqlRoleDefinitionArgs {
     ...
     * The set of operations allowed through this Role Definition.
     */
    permissions?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815preview.PermissionArgs>[]>;
    /**
     ...
     */
    type?: pulumi.Input<enums.documentdb.v20220815preview.RoleDefinitionType>;
}
