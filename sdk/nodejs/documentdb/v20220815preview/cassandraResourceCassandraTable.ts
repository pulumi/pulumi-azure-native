 ...
 *
 * const cassandraResourceCassandraTable = new azure_native.documentdb.v20220815preview.CassandraResourceCassandraTable("cassandraResourceCassandraTable", {
 *     accountName: "ddb1",
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20220815preview:CassandraResourceCassandraTable tableName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/cassandraKeyspaces/keyspaceName/cassandraTables/tableName 
 * ```
 */
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:CassandraResourceCassandraTable';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220815preview.CassandraTableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220815preview.CassandraTableGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220815preview.CassandraTableResourceArgs>;
    /**
