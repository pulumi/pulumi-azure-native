...
export function getSqlResourceSqlRoleDefinition(args: GetSqlResourceSqlRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlRoleDefinitionResult> {
    pulumi.log.warn("getSqlResourceSqlRoleDefinition is deprecated: azure-native:documentdb/v20220815preview:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:documentdb/v20220815preview:getSqlResourceSqlRoleDefinition", {
...
export interface GetSqlResourceSqlRoleDefinitionResult {
     ...
     */
    readonly permissions?: outputs.documentdb.v20220815preview.PermissionResponse[];
    /**
