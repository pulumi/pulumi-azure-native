 ...
 */
/** @deprecated azure-native:documentdb/v20220815preview:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility. */
export function getMongoDBResourceMongoRoleDefinition(args: GetMongoDBResourceMongoRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoRoleDefinitionResult> {
    pulumi.log.warn("getMongoDBResourceMongoRoleDefinition is deprecated: azure-native:documentdb/v20220815preview:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure-native:documentdb/v20220815preview:getMongoDBResourceMongoRoleDefinition", {
...
export interface GetMongoDBResourceMongoRoleDefinitionResult {
     ...
     */
    readonly privileges?: outputs.documentdb.v20220815preview.PrivilegeResponse[];
    /**
