 ...
 *
 * @deprecated azure-native:documentdb/v20220815preview:SqlResourceSqlRoleAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:SqlResourceSqlRoleAssignment to guarantee forwards compatibility.
 */
export class SqlResourceSqlRoleAssignment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlRoleAssignment {
        pulumi.log.warn("SqlResourceSqlRoleAssignment is deprecated: azure-native:documentdb/v20220815preview:SqlResourceSqlRoleAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:SqlResourceSqlRoleAssignment to guarantee forwards compatibility.")
        return new SqlResourceSqlRoleAssignment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:SqlResourceSqlRoleAssignment';
