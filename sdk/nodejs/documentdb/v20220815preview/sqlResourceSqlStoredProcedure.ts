 ...
 *
 * @deprecated azure-native:documentdb/v20220815preview:SqlResourceSqlStoredProcedure is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlStoredProcedure to guarantee forwards compatibility.
 */
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlStoredProcedure {
        pulumi.log.warn("SqlResourceSqlStoredProcedure is deprecated: azure-native:documentdb/v20220815preview:SqlResourceSqlStoredProcedure is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlStoredProcedure to guarantee forwards compatibility.")
        return new SqlResourceSqlStoredProcedure(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815preview:SqlResourceSqlStoredProcedure';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220815preview.SqlStoredProcedureGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlStoredProcedureArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220815preview.SqlStoredProcedureResourceArgs>;
    /**
