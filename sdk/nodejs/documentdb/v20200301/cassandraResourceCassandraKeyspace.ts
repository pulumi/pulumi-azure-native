 ...
 *
 * const cassandraResourceCassandraKeyspace = new azurerm.documentdb.v20200301.CassandraResourceCassandraKeyspace("cassandraResourceCassandraKeyspace", {
 *     accountName: "ddb1",
...
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20200301:CassandraResourceCassandraKeyspace';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20200301.CassandraKeyspaceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20200301.CassandraKeyspaceGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CassandraResourceCassandraKeyspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:CassandraResourceCassandraKeyspace" }, { type: "azurerm:documentdb/v20190801:CassandraResourceCassandraKeyspace" }, { type: "azurerm:documentdb/v20191212:CassandraResourceCassandraKeyspace" }, { type: "azurerm:documentdb/v20200401:CassandraResourceCassandraKeyspace" }] };
...
export interface CassandraResourceCassandraKeyspaceArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.v20200301.CassandraKeyspaceResource>;
    /**
