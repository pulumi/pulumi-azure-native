...
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraKeyspace {
        pulumi.log.warn("CassandraResourceCassandraKeyspace is deprecated: Version 2020-03-01 will be removed in v2 of the provider.")
        return new CassandraResourceCassandraKeyspace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20200301:CassandraResourceCassandraKeyspace';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20200301.CassandraKeyspaceGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20200301.CassandraKeyspaceGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraKeyspaceArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20200301.CassandraKeyspaceCreateUpdatePropertiesArgs>;
    /**
