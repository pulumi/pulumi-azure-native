...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TableResourceTable {
        pulumi.log.warn("TableResourceTable is deprecated: Version 2020-03-01 will be removed in v2 of the provider.")
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20200301.TableGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20200301.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20200301.TableCreateUpdatePropertiesArgs>;
    /**
