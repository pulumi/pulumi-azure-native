 ...
 *
 * const cassandraResourceCassandraTable = new azurerm.documentdb.v20200301.CassandraResourceCassandraTable("cassandraResourceCassandraTable", {
 *     accountName: "ddb1",
...
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20200301:CassandraResourceCassandraTable';
    ...
    constructor(name: string, argsOrState?: CassandraResourceCassandraTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:CassandraResourceCassandraTable" }, { type: "azurerm:documentdb/v20190801:CassandraResourceCassandraTable" }, { type: "azurerm:documentdb/v20191212:CassandraResourceCassandraTable" }, { type: "azurerm:documentdb/v20200401:CassandraResourceCassandraTable" }, { type: "azurerm:documentdb/v20200601preview:CassandraResourceCassandraTable" }] };
