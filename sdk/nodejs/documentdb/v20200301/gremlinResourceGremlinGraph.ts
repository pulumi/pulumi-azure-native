...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GremlinResourceGremlinGraph {
        pulumi.log.warn("GremlinResourceGremlinGraph is deprecated: Version 2020-03-01 will be removed in v2 of the provider.")
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20200301.GremlinGraphGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20200301.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.documentdb.v20200301.gremlinGraphCreateUpdatePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface GremlinResourceGremlinGraphArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20200301.GremlinGraphCreateUpdatePropertiesArgs>;
    /**
