...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/v20190801:GremlinResourceGremlinGraph" }, { type: "azurerm:documentdb/v20191212:GremlinResourceGremlinGraph" }, { type: "azurerm:documentdb/v20200401:GremlinResourceGremlinGraph" }] };
