 ...
 *
 * const sqlResourceSqlTrigger = new azurerm.documentdb.v20200301.SqlResourceSqlTrigger("sqlResourceSqlTrigger", {
 *     accountName: "ddb1",
...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlTrigger {
        return new SqlResourceSqlTrigger(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20200301:SqlResourceSqlTrigger';
    ...
    constructor(name: string, argsOrState?: SqlResourceSqlTriggerArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SqlResourceSqlTriggerArgs | undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:SqlResourceSqlTrigger" }, { type: "azurerm:documentdb/v20190801:SqlResourceSqlTrigger" }, { type: "azurerm:documentdb/v20191212:SqlResourceSqlTrigger" }, { type: "azurerm:documentdb/v20200401:SqlResourceSqlTrigger" }] };
