...
export function getGremlinResourceGremlinDatabase(args: GetGremlinResourceGremlinDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetGremlinResourceGremlinDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20240515:getGremlinResourceGremlinDatabase", {
...
export interface GetGremlinResourceGremlinDatabaseResult {
    ...
    readonly options?: outputs.documentdb.v20240515.GremlinDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20240515.GremlinDatabaseGetPropertiesResponseResource;
    /**
...
export function getGremlinResourceGremlinDatabaseOutput(args: GetGremlinResourceGremlinDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGremlinResourceGremlinDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20240515:getGremlinResourceGremlinDatabase", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
