...
export function getCassandraCluster(args: GetCassandraClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20240515:getCassandraCluster", {
...
export interface GetCassandraClusterResult {
     ...
     */
    readonly identity?: outputs.documentdb.v20240515.ManagedCassandraManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: outputs.documentdb.v20240515.ClusterResourceResponseProperties;
    /**
...
export function getCassandraClusterOutput(args: GetCassandraClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCassandraClusterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20240515:getCassandraCluster", {
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
