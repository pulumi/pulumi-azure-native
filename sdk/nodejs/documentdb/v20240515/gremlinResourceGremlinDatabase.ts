...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20240515:GremlinResourceGremlinDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20240515.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20240515.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20240515.GremlinDatabaseResourceArgs>;
    /**
