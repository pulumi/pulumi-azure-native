...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20210701preview.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20210701preview.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20210701preview.GremlinDatabaseCreateUpdatePropertiesArgs>;
    /**
