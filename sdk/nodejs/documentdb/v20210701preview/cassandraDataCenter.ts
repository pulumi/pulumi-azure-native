...
export class CassandraDataCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20210701preview:CassandraDataCenter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20210701preview.DataCenterResourceResponseProperties>;
    /**
    ...
    constructor(name: string, args: CassandraDataCenterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb/v20210701preview:CassandraDataCenter" }, { type: "azure-native:documentdb:CassandraDataCenter" }, { type: "azure-nextgen:documentdb:CassandraDataCenter" }, { type: "azure-native:documentdb/v20210301preview:CassandraDataCenter" }, { type: "azure-nextgen:documentdb/v20210301preview:CassandraDataCenter" }, { type: "azure-native:documentdb/v20210401preview:CassandraDataCenter" }, { type: "azure-nextgen:documentdb/v20210401preview:CassandraDataCenter" }, { type: "azure-native:documentdb/v20211015:CassandraDataCenter" }, { type: "azure-nextgen:documentdb/v20211015:CassandraDataCenter" }] };
