 ...
 *
 * const cassandraCluster = new azure_native.documentdb.v20210701preview.CassandraCluster("cassandraCluster", {
 ...
 *
 * ```sh
 * $ pulumi import azure-native:documentdb/v20210701preview:CassandraCluster cassandra-prod /subscriptions/subid/resourceGroups/cassandra-prod-rg/providers/Microsoft.DocumentDB/cassandraClusters/cassandra-prod 
 * ```
 */
