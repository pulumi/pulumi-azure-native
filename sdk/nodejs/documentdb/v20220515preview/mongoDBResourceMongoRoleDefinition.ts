 ...
 *
 * @deprecated azure-native:documentdb/v20220515preview:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.
 */
export class MongoDBResourceMongoRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220515preview:MongoDBResourceMongoRoleDefinition';
     ...
     */
    public readonly privileges!: pulumi.Output<outputs.documentdb.v20220515preview.PrivilegeResponse[] | undefined>;
    /**
     ...
     */
    public readonly roles!: pulumi.Output<outputs.documentdb.v20220515preview.RoleResponse[] | undefined>;
    /**
...
export interface MongoDBResourceMongoRoleDefinitionArgs {
     ...
     * A set of privileges contained by the Role Definition. This will allow application of this Role Definition on the entire database account or any underlying Database / Collection. Scopes higher than Database are not enforceable as privilege.
     */
    privileges?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.PrivilegeArgs>[]>;
    /**
     ...
     * The set of roles inherited by this Role Definition.
     */
    roles?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220515preview.RoleArgs>[]>;
    /**
     * Indicates whether the Role Definition was built-in or user created.
     */
    type?: pulumi.Input<enums.documentdb.v20220515preview.MongoRoleDefinitionType>;
}
