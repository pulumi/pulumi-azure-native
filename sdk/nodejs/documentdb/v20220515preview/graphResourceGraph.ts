...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220515preview:GraphResourceGraph';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220515preview.GraphResourceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220515preview.GraphResourceGetPropertiesResponseResource | undefined>;
    /**
...
export interface GraphResourceGraphArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220515preview.GraphResourceArgs>;
    /**
