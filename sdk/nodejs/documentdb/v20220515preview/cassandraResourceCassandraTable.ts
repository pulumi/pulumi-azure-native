 ...
 *
 * @deprecated azure-native:documentdb/v20220515preview:CassandraResourceCassandraTable is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraTable to guarantee forwards compatibility.
 */
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraTable {
        pulumi.log.warn("CassandraResourceCassandraTable is deprecated: azure-native:documentdb/v20220515preview:CassandraResourceCassandraTable is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraTable to guarantee forwards compatibility.")
        return new CassandraResourceCassandraTable(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220515preview:CassandraResourceCassandraTable';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220515preview.CassandraTableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220515preview.CassandraTableGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraTableArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220515preview.CassandraTableResourceArgs>;
    /**
