 ...
 *
 * @deprecated azure-native:documentdb/v20220515preview:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.
 */
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GremlinResourceGremlinDatabase {
        pulumi.log.warn("GremlinResourceGremlinDatabase is deprecated: azure-native:documentdb/v20220515preview:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.")
        return new GremlinResourceGremlinDatabase(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220515preview:GremlinResourceGremlinDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220515preview.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220515preview.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220515preview.GremlinDatabaseResourceArgs>;
    /**
