 ...
 *
 * @deprecated azure-native:documentdb/v20220515preview:CassandraCluster is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:CassandraCluster to guarantee forwards compatibility.
 */
export class CassandraCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220515preview:CassandraCluster';
     ...
     */
    public readonly identity!: pulumi.Output<outputs.documentdb.v20220515preview.ManagedCassandraManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20220515preview.ClusterResourceResponseProperties>;
    /**
...
export interface CassandraClusterArgs {
     ...
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.documentdb.v20220515preview.ManagedCassandraManagedServiceIdentityArgs>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     * Properties of a managed Cassandra cluster.
     */
    properties?: pulumi.Input<inputs.documentdb.v20220515preview.ClusterResourcePropertiesArgs>;
    /**
