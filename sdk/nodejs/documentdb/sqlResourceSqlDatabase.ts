...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.SqlDatabaseCreateUpdatePropertiesArgs>;
    /**
