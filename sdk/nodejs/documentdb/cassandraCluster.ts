...
export class CassandraCluster extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.ClusterResourceResponseProperties>;
    /**
    ...
    constructor(name: string, args: CassandraClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb:CassandraCluster" }, { type: "azure-native:documentdb/v20210301preview:CassandraCluster" }, { type: "azure-nextgen:documentdb/v20210301preview:CassandraCluster" }, { type: "azure-native:documentdb/v20210401preview:CassandraCluster" }, { type: "azure-nextgen:documentdb/v20210401preview:CassandraCluster" }, { type: "azure-native:documentdb/v20210701preview:CassandraCluster" }, { type: "azure-nextgen:documentdb/v20210701preview:CassandraCluster" }, { type: "azure-native:documentdb/v20211015:CassandraCluster" }, { type: "azure-nextgen:documentdb/v20211015:CassandraCluster" }] };
...
export interface CassandraClusterArgs {
     ...
     * Properties of a managed Cassandra cluster.
     */
    properties?: pulumi.Input<inputs.documentdb.ClusterResourcePropertiesArgs>;
    /**
