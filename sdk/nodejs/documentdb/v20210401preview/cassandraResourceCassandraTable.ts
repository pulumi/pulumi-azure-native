 ...
 *
 * @deprecated azure-native:documentdb/v20210401preview:CassandraResourceCassandraTable is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraTable to guarantee forwards compatibility.
 */
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraResourceCassandraTable {
        pulumi.log.warn("CassandraResourceCassandraTable is deprecated: azure-native:documentdb/v20210401preview:CassandraResourceCassandraTable is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraTable to guarantee forwards compatibility.")
