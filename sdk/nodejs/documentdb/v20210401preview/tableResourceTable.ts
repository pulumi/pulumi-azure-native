...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20210401preview.TableGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20210401preview.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20210401preview.TableCreateUpdatePropertiesArgs>;
    /**
