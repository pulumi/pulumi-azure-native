 ...
 *
 * @deprecated azure-native:documentdb/v20210401preview:SqlResourceSqlContainer is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:SqlResourceSqlContainer to guarantee forwards compatibility.
 */
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20210401preview.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface SqlResourceSqlContainerArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20210401preview.SqlContainerResourceArgs>;
    /**
