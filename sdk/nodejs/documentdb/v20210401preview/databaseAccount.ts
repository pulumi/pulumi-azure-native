...
export interface DatabaseAccountArgs {
     ...
     * Indicates the type of database account. This can only be set at database account creation.
     */
    readonly kind?: pulumi.Input<string | enums.documentdb.v20210401preview.DatabaseAccountKind>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    readonly properties: pulumi.Input<inputs.documentdb.v20210401preview.DefaultRequestDatabaseAccountCreateUpdatePropertiesArgs | inputs.documentdb.v20210401preview.RestoreReqeustDatabaseAccountCreateUpdatePropertiesArgs>;
    /**
