...
export class CassandraCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CassandraClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb/v20210401preview:CassandraCluster" }, { type: "azure-native:documentdb:CassandraCluster" }, { type: "azure-nextgen:documentdb:CassandraCluster" }, { type: "azure-native:documentdb/v20210301preview:CassandraCluster" }, { type: "azure-nextgen:documentdb/v20210301preview:CassandraCluster" }] };
...
export interface CassandraClusterArgs {
     ...
     * Properties of a managed Cassandra cluster.
     */
    readonly properties?: pulumi.Input<inputs.documentdb.v20210401preview.ClusterResourcePropertiesArgs>;
    /**
