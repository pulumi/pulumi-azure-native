...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20210401preview.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20210401preview.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20210401preview.MongoDBDatabaseCreateUpdatePropertiesArgs>;
    /**
