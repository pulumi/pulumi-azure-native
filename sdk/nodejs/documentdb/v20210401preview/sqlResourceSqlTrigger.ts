...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20210401preview:SqlResourceSqlTrigger';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.v20210401preview.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20210401preview.SqlTriggerResourceArgs>;
    /**
