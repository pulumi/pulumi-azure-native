...
export class CassandraDataCenter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CassandraDataCenter {
        pulumi.log.warn("CassandraDataCenter is deprecated: azure-native:documentdb/v20220815:CassandraDataCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:CassandraDataCenter to guarantee forwards compatibility.")
        return new CassandraDataCenter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815:CassandraDataCenter';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.documentdb.v20220815.DataCenterResourceResponseProperties>;
    /**
...
export interface CassandraDataCenterArgs {
     ...
     * Properties of a managed Cassandra data center.
     */
    properties?: pulumi.Input<inputs.documentdb.v20220815.DataCenterResourcePropertiesArgs>;
    /**
