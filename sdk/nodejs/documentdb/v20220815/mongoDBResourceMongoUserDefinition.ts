 ...
 *
 * @deprecated azure-native:documentdb/v20220815:MongoDBResourceMongoUserDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:MongoDBResourceMongoUserDefinition to guarantee forwards compatibility.
 */
export class MongoDBResourceMongoUserDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDBResourceMongoUserDefinition {
        pulumi.log.warn("MongoDBResourceMongoUserDefinition is deprecated: azure-native:documentdb/v20220815:MongoDBResourceMongoUserDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:MongoDBResourceMongoUserDefinition to guarantee forwards compatibility.")
        return new MongoDBResourceMongoUserDefinition(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815:MongoDBResourceMongoUserDefinition';
     ...
     */
    public readonly roles!: pulumi.Output<outputs.documentdb.v20220815.RoleResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: MongoDBResourceMongoUserDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:MongoDBResourceMongoUserDefinition" }, { type: "azure-native:documentdb/v20211015preview:MongoDBResourceMongoUserDefinition" }, { type: "azure-native:documentdb/v20211115preview:MongoDBResourceMongoUserDefinition" }, { type: "azure-native:documentdb/v20220215preview:MongoDBResourceMongoUserDefinition" }, { type: "azure-native:documentdb/v20220515preview:MongoDBResourceMongoUserDefinition" }, { type: "azure-native:documentdb/v20220815preview:MongoDBResourceMongoUserDefinition" }, { type: "azure-native:documentdb/v20221115:MongoDBResourceMongoUserDefinition" }, { type: "azure-native:documentdb/v20230315:MongoDBResourceMongoUserDefinition" }] };
...
export interface MongoDBResourceMongoUserDefinitionArgs {
     ...
     * The set of roles inherited by the User Definition.
     */
    roles?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.RoleArgs>[]>;
    /**
     * The user name for User Definition.
     */
