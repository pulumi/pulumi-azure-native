 ...
 *
 * @deprecated azure-native:documentdb/v20220815:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.
 */
export class MongoDBResourceMongoRoleDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDBResourceMongoRoleDefinition {
        pulumi.log.warn("MongoDBResourceMongoRoleDefinition is deprecated: azure-native:documentdb/v20220815:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.")
        return new MongoDBResourceMongoRoleDefinition(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815:MongoDBResourceMongoRoleDefinition';
     ...
     */
    public readonly privileges!: pulumi.Output<outputs.documentdb.v20220815.PrivilegeResponse[] | undefined>;
    /**
...
export interface MongoDBResourceMongoRoleDefinitionArgs {
     ...
     * A set of privileges contained by the Role Definition. This will allow application of this Role Definition on the entire database account or any underlying Database / Collection. Scopes higher than Database are not enforceable as privilege.
     */
    privileges?: pulumi.Input<pulumi.Input<inputs.documentdb.v20220815.PrivilegeArgs>[]>;
    /**
