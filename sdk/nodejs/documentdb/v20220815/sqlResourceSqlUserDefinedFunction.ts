...
export class SqlResourceSqlUserDefinedFunction extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlUserDefinedFunction {
        pulumi.log.warn("SqlResourceSqlUserDefinedFunction is deprecated: azure-native:documentdb/v20220815:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.")
        return new SqlResourceSqlUserDefinedFunction(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815:SqlResourceSqlUserDefinedFunction';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220815.SqlUserDefinedFunctionGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlUserDefinedFunctionArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220815.SqlUserDefinedFunctionResourceArgs>;
    /**
