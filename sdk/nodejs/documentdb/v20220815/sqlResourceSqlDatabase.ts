...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815:SqlResourceSqlDatabase';
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.v20220815.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.v20220815.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.v20220815.SqlDatabaseCreateUpdatePropertiesArgs>;
    /**
