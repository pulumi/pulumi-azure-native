...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220815.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220815.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220815.SqlDatabaseResourceArgs>;
    /**
