 ...
 *
 * @deprecated azure-native:documentdb/v20220815:GremlinResourceGremlinGraph is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph to guarantee forwards compatibility.
 */
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20220815:GremlinResourceGremlinGraph';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20220815.GremlinGraphGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20220815.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20220815.gremlinGraphResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface GremlinResourceGremlinGraphArgs {
     ...
     */
    resource: pulumi.Input<inputs.documentdb.v20220815.GremlinGraphResourceArgs>;
    /**
