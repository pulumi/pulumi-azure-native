...
export class NotebookWorkspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotebookWorkspace {
        pulumi.log.warn("NotebookWorkspace is deprecated: azure-native:documentdb/v20220815:NotebookWorkspace is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:NotebookWorkspace to guarantee forwards compatibility.")
