...
export function getMongoDBResourceMongoDBDatabase(args: GetMongoDBResourceMongoDBDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoDBDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azurerm:documentdb/latest:getMongoDBResourceMongoDBDatabase", {
...
export interface GetMongoDBResourceMongoDBDatabaseResult {
    ...
    readonly options?: outputs.documentdb.latest.MongoDBDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.latest.MongoDBDatabaseGetPropertiesResponseResource;
    /**
