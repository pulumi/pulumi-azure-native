...
export class SqlResourceSqlUserDefinedFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/latest:SqlResourceSqlUserDefinedFunction';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.latest.SqlUserDefinedFunctionGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlUserDefinedFunctionArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.latest.SqlUserDefinedFunctionResource>;
    /**
