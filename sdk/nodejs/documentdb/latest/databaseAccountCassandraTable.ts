...
export class DatabaseAccountCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/latest:DatabaseAccountCassandraTable';
     ...
     */
    public /*out*/ readonly schema!: pulumi.Output<outputs.documentdb.latest.CassandraSchemaResponse | undefined>;
    /**
...
export interface DatabaseAccountCassandraTableArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.latest.CassandraTableResource>;
    /**
