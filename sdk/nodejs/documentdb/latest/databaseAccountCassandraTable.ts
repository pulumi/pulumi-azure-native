...
export class DatabaseAccountCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/latest:DatabaseAccountCassandraTable';
