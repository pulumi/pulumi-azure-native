...
export class NotebookWorkspace extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NotebookWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/v20190801:NotebookWorkspace" }, { type: "azurerm:documentdb/v20191212:NotebookWorkspace" }, { type: "azurerm:documentdb/v20200301:NotebookWorkspace" }, { type: "azurerm:documentdb/v20200401:NotebookWorkspace" }, { type: "azurerm:documentdb/v20200601preview:NotebookWorkspace" }] };
