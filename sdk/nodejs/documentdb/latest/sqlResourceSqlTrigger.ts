...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlResourceSqlTrigger {
        pulumi.log.warn("SqlResourceSqlTrigger is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:documentdb:SqlResourceSqlTrigger'.")
        return new SqlResourceSqlTrigger(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/latest:SqlResourceSqlTrigger';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.latest.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.latest.SqlTriggerResource>;
    /**
