...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/latest:TableResourceTable';
    ...
    constructor(name: string, argsOrState?: TableResourceTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/preview:TableResourceTable" }, { type: "azurerm:documentdb/v20190801:TableResourceTable" }, { type: "azurerm:documentdb/v20191212:TableResourceTable" }, { type: "azurerm:documentdb/v20200301:TableResourceTable" }, { type: "azurerm:documentdb/v20200401:TableResourceTable" }, { type: "azurerm:documentdb/v20200601preview:TableResourceTable" }] };
