...
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/latest:SqlResourceSqlStoredProcedure';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.latest.SqlStoredProcedureGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SqlResourceSqlStoredProcedureArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/v20190801:SqlResourceSqlStoredProcedure" }, { type: "azurerm:documentdb/v20191212:SqlResourceSqlStoredProcedure" }, { type: "azurerm:documentdb/v20200301:SqlResourceSqlStoredProcedure" }, { type: "azurerm:documentdb/v20200401:SqlResourceSqlStoredProcedure" }] };
...
export interface SqlResourceSqlStoredProcedureArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.latest.SqlStoredProcedureResource>;
    /**
