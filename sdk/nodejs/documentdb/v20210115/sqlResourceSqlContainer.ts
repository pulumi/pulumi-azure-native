...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20210115.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
