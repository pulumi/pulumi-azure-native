...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDBResourceMongoDBCollection {
        pulumi.log.warn("MongoDBResourceMongoDBCollection is deprecated: azure-native:documentdb/v20210115:MongoDBResourceMongoDBCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:MongoDBResourceMongoDBCollection to guarantee forwards compatibility.")
        return new MongoDBResourceMongoDBCollection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20210115:MongoDBResourceMongoDBCollection';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20210115.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20210115.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
