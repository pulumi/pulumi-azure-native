...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.GraphResourceGetPropertiesResponseOptions | undefined>;
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.GraphResourceGetPropertiesResponseResource | undefined>;
    /**
...
export interface GraphResourceGraphArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.GraphResourceCreateUpdatePropertiesArgs>;
    /**
