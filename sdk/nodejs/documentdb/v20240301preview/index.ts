...
// Export enums:
export * from "../../types/enums/documentdb/v20240301preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:documentdb/v20240301preview:FirewallRule":
                return new FirewallRule(name, <any>undefined, { urn })
            case "azure-native:documentdb/v20240301preview:MongoCluster":
                return new MongoCluster(name, <any>undefined, { urn })
            case "azure-native:documentdb/v20240301preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "documentdb/v20240301preview", _module)
