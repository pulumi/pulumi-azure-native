...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-nextgen:documentdb/v20200601preview:MongoDBResourceMongoDBCollection';
