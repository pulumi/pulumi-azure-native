...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20200601preview:GremlinResourceGremlinDatabase';
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20200601preview.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20200601preview.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GremlinResourceGremlinDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:GremlinResourceGremlinDatabase" }, { type: "azurerm:documentdb/preview:GremlinResourceGremlinDatabase" }, { type: "azurerm:documentdb/v20190801:GremlinResourceGremlinDatabase" }, { type: "azurerm:documentdb/v20191212:GremlinResourceGremlinDatabase" }, { type: "azurerm:documentdb/v20200301:GremlinResourceGremlinDatabase" }, { type: "azurerm:documentdb/v20200401:GremlinResourceGremlinDatabase" }] };
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    readonly resource: pulumi.Input<inputs.documentdb.v20200601preview.GremlinDatabaseResource>;
    /**
