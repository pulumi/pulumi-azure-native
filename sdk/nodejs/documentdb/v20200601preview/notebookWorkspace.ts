...
export class NotebookWorkspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20200601preview:NotebookWorkspace';
    ...
    constructor(name: string, argsOrState?: NotebookWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:NotebookWorkspace" }, { type: "azurerm:documentdb/preview:NotebookWorkspace" }, { type: "azurerm:documentdb/v20190801:NotebookWorkspace" }, { type: "azurerm:documentdb/v20191212:NotebookWorkspace" }, { type: "azurerm:documentdb/v20200301:NotebookWorkspace" }, { type: "azurerm:documentdb/v20200401:NotebookWorkspace" }] };
