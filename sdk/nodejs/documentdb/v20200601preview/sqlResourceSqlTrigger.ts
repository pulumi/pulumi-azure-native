...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:documentdb/v20200601preview:SqlResourceSqlTrigger';
    ...
    public readonly resource!: pulumi.Output<outputs.documentdb.v20200601preview.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: SqlResourceSqlTriggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azurerm:documentdb/latest:SqlResourceSqlTrigger" }, { type: "azurerm:documentdb/v20190801:SqlResourceSqlTrigger" }, { type: "azurerm:documentdb/v20191212:SqlResourceSqlTrigger" }, { type: "azurerm:documentdb/v20200301:SqlResourceSqlTrigger" }, { type: "azurerm:documentdb/v20200401:SqlResourceSqlTrigger" }] };
