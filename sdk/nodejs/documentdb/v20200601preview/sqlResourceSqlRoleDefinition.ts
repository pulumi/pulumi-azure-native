...
export class SqlResourceSqlRoleDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlResourceSqlRoleDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:documentdb/v20200601preview:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb:SqlResourceSqlRoleDefinition" }, { type: "azure-nextgen:documentdb:SqlResourceSqlRoleDefinition" }, { type: "azure-native:documentdb/v20210301preview:SqlResourceSqlRoleDefinition" }, { type: "azure-nextgen:documentdb/v20210301preview:SqlResourceSqlRoleDefinition" }] };
