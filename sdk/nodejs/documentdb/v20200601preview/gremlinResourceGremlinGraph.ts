...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20200601preview.gremlinGraphResourceArgsProvideDefaults) : undefined) : undefined;
