...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    public /*out*/ readonly options!: pulumi.Output<outputs.documentdb.SqlContainerGetPropertiesResponseOptions | undefined>;
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(inputs.documentdb.sqlContainerCreateUpdatePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface SqlResourceSqlContainerArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.SqlContainerCreateUpdatePropertiesArgs>;
    /**
