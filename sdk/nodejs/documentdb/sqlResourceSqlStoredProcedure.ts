...
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    public /*out*/ readonly resource!: pulumi.Output<outputs.documentdb.SqlStoredProcedureGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlStoredProcedureArgs {
     ...
     */
    properties: pulumi.Input<inputs.documentdb.SqlStoredProcedureCreateUpdatePropertiesArgs>;
    /**
