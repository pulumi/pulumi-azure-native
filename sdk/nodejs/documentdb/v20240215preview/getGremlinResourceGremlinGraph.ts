...
export interface GetGremlinResourceGremlinGraphResult {
    ...
    readonly options?: outputs.documentdb.v20240215preview.GremlinGraphGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20240215preview.GremlinGraphGetPropertiesResponseResource;
    /**
...
export function getGremlinResourceGremlinGraphOutput(args: GetGremlinResourceGremlinGraphOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGremlinResourceGremlinGraphResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20240215preview:getGremlinResourceGremlinGraph", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "graphName": args.graphName,
        "resourceGroupName": args.resourceGroupName,
