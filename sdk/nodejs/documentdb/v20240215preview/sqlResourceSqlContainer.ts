...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.documentdb.v20240215preview.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    public readonly options!: pulumi.Output<outputs.documentdb.v20240215preview.SqlContainerGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<outputs.documentdb.v20240215preview.SqlContainerGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(inputs.documentdb.v20240215preview.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface SqlResourceSqlContainerArgs {
     ...
     * Identity for the resource.
     */
    identity?: pulumi.Input<inputs.documentdb.v20240215preview.ManagedServiceIdentityArgs>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    options?: pulumi.Input<inputs.documentdb.v20240215preview.CreateUpdateOptionsArgs>;
    /**
     * The standard JSON format of a container
     */
    resource: pulumi.Input<inputs.documentdb.v20240215preview.SqlContainerResourceArgs>;
    /**
