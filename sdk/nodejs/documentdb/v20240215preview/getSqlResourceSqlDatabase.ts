...
export interface GetSqlResourceSqlDatabaseResult {
    ...
    readonly options?: outputs.documentdb.v20240215preview.SqlDatabaseGetPropertiesResponseOptions;
    readonly resource?: outputs.documentdb.v20240215preview.SqlDatabaseGetPropertiesResponseResource;
    /**
...
export function getSqlResourceSqlDatabaseOutput(args: GetSqlResourceSqlDatabaseOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSqlResourceSqlDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20240215preview:getSqlResourceSqlDatabase", {
        "accountName": args.accountName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
