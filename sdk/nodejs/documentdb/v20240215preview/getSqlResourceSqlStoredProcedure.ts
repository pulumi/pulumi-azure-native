...
export interface GetSqlResourceSqlStoredProcedureResult {
    ...
    readonly resource?: outputs.documentdb.v20240215preview.SqlStoredProcedureGetPropertiesResponseResource;
    /**
...
export function getSqlResourceSqlStoredProcedureOutput(args: GetSqlResourceSqlStoredProcedureOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSqlResourceSqlStoredProcedureResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:documentdb/v20240215preview:getSqlResourceSqlStoredProcedure", {
        "accountName": args.accountName,
        "containerName": args.containerName,
        "databaseName": args.databaseName,
        "resourceGroupName": args.resourceGroupName,
